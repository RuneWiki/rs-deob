...
public class class477 extends class545 {
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lch;)V", line = 3)
    public class477(class38 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IILec;)V", line = 52)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)Z", line = 66)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(III)V", line = 81)
