...
public class class477 extends class356 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILiaa;I)V")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(II)Lfv;")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILiaa;)V")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Liaa;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Liaa;[II)V")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lwba;FFBIFIIFIF)[B")
