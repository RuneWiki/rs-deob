...
public class class477 implements Runnable {
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 691)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)Lhu;", line = 20)
    public final class141 method2831(int arg0, int arg1) {
        int var3 = -3 / ((arg0 + 64) / 53);
        return this.method2838(null, 3, (byte) 122, arg1, 0);
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BLjava/net/URL;)Lhu;", line = 31)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILjava/awt/Point;[IILjava/awt/Component;B)Lhu;", line = 47)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Lqia;", line = 61)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(B)Lhu;", line = 114)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljava/lang/String;I)Lhu;", line = 124)
    public final class141 method2837(String arg0, int arg1) {
        return arg1 == 65535 ? this.method2838(arg0, 16, (byte) 123, 0, 0) : null;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljava/lang/Object;IBII)Lhu;", line = 137)
    ...
    @OriginalMember(owner = "client!td", name = "run", descriptor = "()V", line = 167)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ZLjava/lang/String;I)Lhu;", line = 463)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljava/awt/Frame;B)Lhu;", line = 482)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)Lhu;", line = 492)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IILjava/lang/String;Z)Lhu;", line = 508)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Z", line = 520)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IZIII)Lhu;", line = 540)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 563)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 573)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILjava/lang/String;)Lqia;", line = 629)
    public static final class23 method2847(int arg0, String arg1) {
        return arg0 == 9 ? method2834(arg1, field6689, field6677, -86) : null;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/Class;Ljava/lang/String;)Lhu;", line = 648)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ZLjava/io/File;[B)Z", line = 668)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lhu;", line = 842)
