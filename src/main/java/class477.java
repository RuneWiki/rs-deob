...
public class class477 {
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(ILjl;)Lfu;")
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(I)Lsca;")
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(ILtia;)[I")
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(Lla;Lla;)V")
