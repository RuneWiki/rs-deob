...
public class class125 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 17)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lkb;IIIIBIIIII)Z", line = 78)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZIZIB)V", line = 327)
