...
public class class125 extends class544 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IB)Lpj;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IZIIBILpf;Lqa;ILlk;)Lr;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Let;Let;I)V")
