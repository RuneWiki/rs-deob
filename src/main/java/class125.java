...
public class class125 extends class179 {
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lbg;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILbg;B)V", line = 55)
    ...
    @OriginalMember(owner = "client!bd", name = "d", descriptor = "(Z)V", line = 75)
