...
public class class125 extends class168 implements class303 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lza;Lpm;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Li;III[Z)Z")
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Llb;IZIBILza;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BZILza;)Luo;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lsv;B)Lqd;")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(II)Lde;")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Lza;I)V")
