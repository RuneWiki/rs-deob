...
public abstract class class125 extends class577 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!qca", name = "d", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!qca", name = "e", descriptor = "(I)I", line = 51)
    public final int method944(int arg0) {
        field1935++;
        return arg0 == 5 ? 1 : -115;
    }

    @OriginalMember(owner = "client!qca", name = "g", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lqfa;)V", line = 76)
    public class125(class106 arg0) {
        this.field1937 = arg0;
    }

    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BIII)Z", line = 95)
