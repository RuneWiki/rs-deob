...
public class class125 extends class359 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lra;)Z")
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lra;II)Ljd;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "([I)Lfp;")
