...
public class class125 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IBLmq;)V", line = 10)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Ljava/lang/String;CILjava/lang/String;)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lwk;Lht;Lmg;IIIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(I)V", line = 123)
