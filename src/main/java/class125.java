...
public abstract class class125 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lir;[I[IB[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ov", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lur;)V", line = 135)
