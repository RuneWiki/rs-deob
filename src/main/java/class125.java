...
public class class125 extends class98 {
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 6)
    public class125() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tg", name = "e", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIIZI)V", line = 23)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIBI)V", line = 172)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILdg;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)[[I", line = 223)
    ...
    @OriginalMember(owner = "client!tg", name = "f", descriptor = "(I)V", line = 314)
