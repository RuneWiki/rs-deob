...
public class class125 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "([BILrg;)V", line = 98)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(III)I", line = 124)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 156)
    public class125() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(I)I", line = 161)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(III)V", line = 178)
