...
public class class125 extends class83 {
    ...
    @OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IBLtq;)V", line = 41)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 167)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIIIII)I", line = 179)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lfd;Lgo;IIIIIII)V", line = 253)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "()V", line = 318)
    public class125() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IILfd;)I", line = 332)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(Z)V", line = 347)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BI)V", line = 359)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)[I", line = 386)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I[II)V", line = 408)
