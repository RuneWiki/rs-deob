...
public class class125 extends class535 implements class583 {
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!bba", name = "m", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lha;Lc;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lha;I)Lcca;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILrn;)V")
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IILha;B)Z")
    ...
    @OriginalMember(owner = "client!bba", name = "n", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(BLha;)Ltf;")
