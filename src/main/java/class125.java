...
public class class125 implements Runnable {
    ...
    @OriginalMember(owner = "client!nd", name = "B", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!nd", name = "t", descriptor = "Lbg;")
    public static class18 field2414;

    @OriginalMember(owner = "client!nd", name = "x", descriptor = "Lda;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lvg;ILlf;)Llf;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II[Llb;[BIIIIII)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZLbg;)V")
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Ljava/net/Socket;Lke;)V")
