...
public class class125 extends class139 implements class247 {
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lbfa;IZ[[I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 69)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lria;I)V", line = 79)
