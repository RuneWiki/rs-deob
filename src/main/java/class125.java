...
public class class125 extends class163 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(IIIIIF)V", line = 53)
    public class125(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IF)V", line = 56)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([Ljava/lang/String;IIB)Ljava/lang/String;", line = 76)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BIII)V", line = 138)
