...
public class class125 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lpe;ZLpe;Lpe;Lpe;)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lhs;B)Z")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IBIIILji;)Lch;")
