...
public class class125 extends class137 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)Lfr;")
