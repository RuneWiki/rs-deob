...
public class class125 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IBIIII)Z", line = 14)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 75)
