...
public class class125 extends Callback {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!mr", name = "callback", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BLjava/awt/Component;Z)V", line = 60)
