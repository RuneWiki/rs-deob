...
public class class125 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(JB)Llda;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "([Lwja;Loia;I)Loca;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Llda;JB)V")
