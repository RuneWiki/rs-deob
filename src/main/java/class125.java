...
public class class125 implements class345 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gm", name = "toString", descriptor = "()Ljava/lang/String;", line = 19)
    public final String toString() {
        field1636++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZII)Z", line = 31)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILji;)Lfq;", line = 48)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIII)I", line = 78)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)Luaa;", line = 95)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 164)
