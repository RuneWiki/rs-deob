...
public class class125 implements Runnable {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Ljava/net/Socket;Ldq;)V", line = 360)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ov", name = "run", descriptor = "()V", line = 86)
    ...
    @OriginalMember(owner = "client!ov", name = "finalize", descriptor = "()V", line = 160)
    protected final void finalize() {
        field1694++;
        this.method855((byte) 18);
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(III[B)V", line = 171)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!ov", name = "c", descriptor = "(I)I", line = 240)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IZ)V", line = 263)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(II[BB)V", line = 309)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(B)V", line = 339)
