...
public abstract class class125 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I[FF[FIIIIZIIIFF)V", line = 20)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(III)Z", line = 133)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)V", line = 145)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lgp;)V", line = 166)
    public class125(class549 arg0) {
        this.field1733 = arg0;
        this.field1732 = this.method158((byte) 79);
    }

    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(ILgp;)V", line = 176)
