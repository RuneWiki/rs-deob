...
public class class125 extends class642 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILgk;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!vh", name = "e", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "()V", line = 125)
    public class125() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)Z", line = 101)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(II)[I", line = 134)
    ...
    @OriginalMember(owner = "client!vh", name = "f", descriptor = "(I)V", line = 253)
