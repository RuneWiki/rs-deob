...
public class class125 extends class167 implements class416 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lw;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[[I[[IIII)Lo;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ln;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[Lni;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lkv;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lka;Lwg;Ln;[Lwc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lkv;Lkv;FLkv;)Lkv;")
    public final class181 method238(class181 arg0, class181 arg1, float arg2, class181 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!c", name = "A", descriptor = "()Ln;")
    ...
    @OriginalMember(owner = "client!c", name = "C", descriptor = "()Lwa;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lch;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!c", name = "u", descriptor = "()Ln;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwg;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIII)Lkv;")
    public final class181 method218(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lka;Ln;[Lwc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lgg;[Lho;Z)Lba;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lho;Z)Laa;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIF)Lni;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwg;Z)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[I[I)Li;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([IIIII)Laa;")
    ...
    @OriginalMember(owner = "client!c", name = "d", descriptor = "(I)Lw;")
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Lul;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIZ)Laa;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIILi;II)V")
