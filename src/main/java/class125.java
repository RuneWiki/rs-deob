...
public class class125 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IBZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(III)I", line = 50)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(II)Lng;", line = 65)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(II)V", line = 127)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lum;Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lpt;ILum;)V", line = 175)
