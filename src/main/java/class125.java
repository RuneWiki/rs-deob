...
public class class125 extends class90 implements class503 {
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!op", name = "h", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lya;IZLij;III)V", line = 29)
    ...
    @OriginalMember(owner = "client!op", name = "i", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(ILya;)V", line = 59)
    ...
    @OriginalMember(owner = "client!op", name = "f", descriptor = "(I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZILya;I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLya;I)Lt;", line = 124)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(B)V", line = 136)
    public static void method866(byte arg0) {
        int var1 = -84 / ((7 - arg0) / 44);
        field1858 = null;
    }

    @OriginalMember(owner = "client!op", name = "b", descriptor = "(ILya;)V", line = 148)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lya;Ljo;IIIIIZIII)V", line = 161)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILya;)V", line = 170)
    ...
    @OriginalMember(owner = "client!op", name = "e", descriptor = "(I)I", line = 186)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lya;B)Lmf;", line = 223)
