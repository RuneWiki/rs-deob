...
public class class125 extends class669 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lpj;I)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IILnq;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lej;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
