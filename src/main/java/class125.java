...
public class class125 extends class14 {
    ...
    @OriginalMember(owner = "client!kk", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 38)
    public static final int method912(String arg0, int arg1) {
        ++field1839;
        return arg1 != 1 ? 31 : 1 + arg0.length();
    }

    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 50)
    public class125() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)[I", line = 95)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IBLmd;)V", line = 158)
