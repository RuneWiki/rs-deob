...
public class class125 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLjg;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILjg;II)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljg;IZ)Ljava/lang/String;")
