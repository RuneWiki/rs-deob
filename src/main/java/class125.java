...
public class class125 {
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(I)V", line = 75)
    public class125(int arg0) {
        this.field2017 = arg0;
    }

    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(IIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lkk;B)V", line = 11)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)I", line = 32)
    public static int method953(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)Lkk;", line = 52)
