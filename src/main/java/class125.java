...
public class class125 extends class169 implements class401 {
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lya;Lpf;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLya;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Lya;I)Lmo;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lya;B)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILya;I)Lt;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILya;II)Z")
