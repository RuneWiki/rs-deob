...
public class class125 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 9)
    ...
    @OriginalMember(owner = "client!fn", name = "exit", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!fn", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!fn", name = "listmodes", descriptor = "()[I", line = 138)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "()V", line = 159)
