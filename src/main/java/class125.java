...
public class class125 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILjava/lang/String;)Ljava/io/File;", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILjava/lang/String;)V", line = 23)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Ljava/io/File;", line = 51)
