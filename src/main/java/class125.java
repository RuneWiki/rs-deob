...
public class class125 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILkk;)V", line = 7)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IBLkk;)V", line = 70)
