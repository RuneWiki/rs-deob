...
public class class402 extends class223 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "([IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III[I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BII)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIB)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIII)Z", line = 65)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(IIIIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIIBII)V", line = 117)
