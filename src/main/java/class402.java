...
public class class402 extends class226 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IB)Llu;", line = 7)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IBII)[B", line = 34)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lee;IBLkk;)V", line = 51)
    ...
    @OriginalMember(owner = "client!sg", name = "f", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BIB)V", line = 180)
