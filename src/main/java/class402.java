...
public class class402 extends class353 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILqda;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(IZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(B)Z", line = 100)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lik;Lmv;Lgb;)V", line = 123)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!bj", name = "f", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 211)
