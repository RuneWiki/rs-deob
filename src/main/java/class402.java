...
public class class402 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lhk;[IJZ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(II)Liaa;")
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(ILgga;Lgga;Lfba;)V")
