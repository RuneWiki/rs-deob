...
public class class402 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZIJII)Ljava/lang/String;", line = 67)
