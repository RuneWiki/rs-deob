...
public class class402 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IB)I", line = 30)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Llu;B)V", line = 60)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "([I)V", line = 81)
