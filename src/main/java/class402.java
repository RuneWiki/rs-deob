...
public class class402 extends class80 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lfw;Ldg;IIIIIIIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)Lhs;", line = 48)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(CII)I", line = 59)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILjava/lang/String;ZLjava/lang/String;)V", line = 86)
