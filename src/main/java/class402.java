...
public class class402 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lqa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lqa;[II)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lqa;[II[I[I)V")
