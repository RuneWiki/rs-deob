...
public class class402 implements class409 {
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Ltu;)V", line = 17)
    public class402(class366 arg0) {
        this.field5693 = arg0;
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZB)V", line = 27)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)Z", line = 52)
