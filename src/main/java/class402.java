...
public class class402 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILp;)V", line = 61)
