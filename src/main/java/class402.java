...
public class class402 extends class409 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BLqa;J)V", line = 9)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(JZILqa;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lqa;Leh;Luh;J)V", line = 390)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIILul;IZ)Ljava/awt/Frame;", line = 308)
