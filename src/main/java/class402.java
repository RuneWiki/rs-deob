...
public class class402 extends class5 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIIIILr;II[[[BII)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BIIIIILr;II)V")
