...
public class class402 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(II)Lat;", line = 54)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(II)I", line = 113)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lal;ILmg;Lmg;)V", line = 156)
