...
public class class402 extends class170 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lgg;Lr;)V", line = 61)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "([B)V", line = 1191)
