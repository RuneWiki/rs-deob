...
public class class402 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILps;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILps;)V", line = 32)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZI)V", line = 67)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)Z", line = 141)
    public final boolean method2412(int arg0) {
        field5760++;
        return arg0 == 0 ? this.field5757.field3998.method3491(108, this.field5763) : false;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZLqa;BI)Lha;", line = 167)
