...
public class class402 extends class119 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLql;Lka;Lha;)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILvs;ZILha;II)V")
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(Lha;B)Lc;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IBLha;I)Z")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLha;II)Lka;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lha;I)Lria;")
