...
public class class402 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 2882)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIILbi;)V", line = 2902)
