...
public class class402 extends class504 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lvj;B)I", line = 15)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)V", line = 114)
