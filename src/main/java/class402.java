...
public class class402 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;ILjagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
