...
public class class402 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lha;[II[I[I)V", line = 51)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lha;[II)V", line = 57)
    public static final void method2508(class59 arg0, int[] arg1, int arg2) {
        method2511(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "()V", line = 60)
    public static void method2509() {
        field5915 = null;
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "([III)V", line = 69)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 123)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "()V", line = 159)
    private static final void method2512() {
        field5913 = 0;
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)V", line = 163)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(II)V", line = 207)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)Z", line = 245)
