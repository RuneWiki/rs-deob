...
public class class402 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(FFFII)F", line = 3)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ZBI)Lls;", line = 32)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Z)V", line = 70)
