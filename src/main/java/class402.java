...
public class class402 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IB)I", line = 8)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I[Llg;IILjava/lang/String;)I", line = 21)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/lang/String;[Llg;[II[Ljava/lang/String;)I", line = 42)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILjava/lang/String;[Llg;)I", line = 283)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "([Llg;Ljava/lang/String;I)I", line = 295)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 402)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 422)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lvm;B)V", line = 435)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 516)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I[Llg;Ljava/lang/String;I)I", line = 534)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)Lwe;", line = 559)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "([B)V", line = 586)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIC)I", line = 709)
