...
public class class402 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)I", line = 41)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 62)
