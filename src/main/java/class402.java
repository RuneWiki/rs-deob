...
public class class402 extends class393 {
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIZIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(I[B)V", line = 71)
