...
public class class402 extends class17 {
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "()V", line = 25)
    public class402() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lwm;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)[I", line = 83)
