...
public class class402 extends class343 {
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IILoi;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!tb", name = "g", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ZIII)[B", line = 196)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BIB)V", line = 211)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIB)Z", line = 230)
