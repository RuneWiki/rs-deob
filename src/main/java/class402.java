...
public class class402 extends class404 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILha;I)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lq;I[[B)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lha;I)Lnb;")
