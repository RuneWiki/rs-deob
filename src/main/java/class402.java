...
public class class402 extends class152 implements class620 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILoa;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(B)I", line = 25)
    public final int method66(byte arg0) {
        ++field5127;
        return arg0 != -42 ? -4 : this.field5132.field7976;
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILoa;ILcq;ZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(B)I", line = 59)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Loa;Lsa;IIIIIZII)V", line = 75)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Loa;II)Lba;", line = 85)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Loa;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)Z", line = 124)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(Loa;I)Lcd;", line = 134)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Z)I", line = 145)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Loa;B)Lpl;", line = 156)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(Loa;I)V", line = 200)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BI)Z", line = 225)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 247)
    public final void method64(byte arg0) {
        ++field5131;
        int var2 = -31 % ((-71 - arg0) / 39);
    }

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(Loa;I)V", line = 261)
