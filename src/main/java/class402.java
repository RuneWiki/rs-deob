...
public class class402 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIIII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)Lgb;", line = 41)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)Ltg;", line = 65)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BI)Lrs;", line = 92)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILqo;IILfb;BLri;)V", line = 165)
