...
public class class402 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)I", line = 80)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lcu;II)V", line = 110)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lcu;I)V", line = 351)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 385)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 412)
