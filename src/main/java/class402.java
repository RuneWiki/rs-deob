...
public class class402 extends class425 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(FI)V", line = 5)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(FB)V", line = 20)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(I)V", line = 34)
