...
public class class402 implements class373 {
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZILjaclib/memory/Source;I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 53)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)I", line = 96)
    public final int method84(int arg0) {
        return arg0 >= -80 ? 100 : this.field5734;
    }

    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(III)Z", line = 108)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Luda;Z)V", line = 145)
