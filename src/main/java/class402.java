...
public class class402 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZLgb;IBLgb;)Lre;", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lae;IIII[Lp;IZ[BI)[I", line = 90)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lgb;IILgb;)Lre;", line = 525)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 538)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(B)Z", line = 572)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZ)V", line = 603)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lqs;Lnh;)V", line = 703)
