...
public class class402 extends class30 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(IB)Lkba;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lqh;B)I")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BI)Lde;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BILac;)V")
