...
public class class402 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 153)
