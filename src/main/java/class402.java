...
public class class402 extends class314 {
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "d", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!rp", name = "h", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIIIIB)V", line = 139)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ler;Z[Ljf;)Lcaa;", line = 192)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "()V", line = 260)
    public class402() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BLie;I)V", line = 265)
