...
public class class402 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)Z", line = 4)
    public final boolean method2524(int arg0, int arg1) {
        return arg1 == -1 ? this.field5709[arg0].method358() : false;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLue;)Z", line = 19)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZB)V", line = 39)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZZII)V", line = 55)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Ltb;)V", line = 100)
