...
public class class402 extends class246 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Ldk;ILza;Ldk;)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILfg;I)V")
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lpg;Lrk;)V")
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(B)[Lde;")
