...
public class class402 extends class54 {
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lhia;)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIILdr;)V")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(ILhia;)V")
