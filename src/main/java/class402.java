...
public class class402 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lla;Lla;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ms", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILhga;Ljava/lang/Object;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lmba;JI)V", line = 58)
    public class402(class643 arg0, long arg1, int arg2) {
        this.field5751 = arg0;
        this.field5752 = arg1;
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 69)
