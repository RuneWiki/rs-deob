...
public class class402 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZI)Lg;")
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(ZI)Lwv;")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lrb;ILpc;Lpc;)V")
