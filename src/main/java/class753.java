...
public class class753 extends class206 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(ILpa;IZ)V", line = 81)
