...
public class class753 extends Callback {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Ljava/awt/Component;ZZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!sda", name = "callback", descriptor = "(IIII)I", line = 65)
