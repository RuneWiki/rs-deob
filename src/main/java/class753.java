...
public class class753 extends class515 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lch;IIZ)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lch;II[III)V")
