...
public class class753 extends class336 {
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(Lha;I)Luh;", line = 3)
    ...
    @OriginalMember(owner = "client!ika", name = "g", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!ika", name = "f", descriptor = "(I)I", line = 219)
    ...
    @OriginalMember(owner = "client!ika", name = "<init>", descriptor = "(IIIII)V", line = 261)
    public class753(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(Z)I", line = 237)
    ...
    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(BLha;)Lmg;", line = 248)
    public final class248 method205(byte arg0, class475 arg1) {
        ++field10471;
        return arg0 != 45 ? null : null;
    }

    @OriginalMember(owner = "client!ika", name = "c", descriptor = "(ILha;)V", line = 264)
    ...
    @OriginalMember(owner = "client!ika", name = "d", descriptor = "(Z)V", line = 274)
    ...
    @OriginalMember(owner = "client!ika", name = "d", descriptor = "(I)Z", line = 285)
    ...
    @OriginalMember(owner = "client!ika", name = "f", descriptor = "(B)Z", line = 296)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(BIILha;)Z", line = 317)
