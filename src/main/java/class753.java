...
public abstract class class753 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(II)J", line = 16)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Les;I)Laea;", line = 29)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Z)Ljava/net/Socket;", line = 80)
