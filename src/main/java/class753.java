...
public class class753 extends class105 {
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "()Loo;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;[Lgi;Z)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;J[Lgi;[Luga;Z)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "([Luga;Z)V")
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "()Loo;")
