...
public abstract class class753 implements class416 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lws;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BI)V", line = 22)
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([BIIIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!rl", name = "finalize", descriptor = "()V", line = 160)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([IIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(I)I", line = 313)
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Loia;ILul;Lso;IZ)V", line = 553)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(II[FII)V", line = 438)
    ...
    @OriginalMember(owner = "client!rl", name = "e", descriptor = "(I)V", line = 538)
