...
public class class753 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BI)Lbh;", line = 30)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILtc;IBII)Lfp;", line = 94)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lkw;ILuq;)V", line = 132)
