...
public class class753 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lou;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ILou;)V", line = 55)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIB)Z", line = 96)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(Leea;)V", line = 508)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIIII)Z", line = 275)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(B)Z", line = 334)
