...
public class class753 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)I", line = 83)
