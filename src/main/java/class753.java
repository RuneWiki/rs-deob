...
public class class753 extends class192 implements class465 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(B)Z", line = 12)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIIII[II)V", line = 22)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lno;Lpd;II[FII)V", line = 44)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B[B)V", line = 59)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIIIII[BLpd;)V", line = 141)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(FI)F", line = 166)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lno;II[III)V", line = 177)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(BF)F", line = 190)
    ...
    @OriginalMember(owner = "client!gfa", name = "d", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)I", line = 214)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(ZBZ)V", line = 225)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I[IIIIII)V", line = 235)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)I", line = 287)
    public final int method1262(byte arg0) {
        ++field10515;
        return arg0 > -37 ? -31 : this.field10528;
    }

    @OriginalMember(owner = "client!gfa", name = "e", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lno;Lpd;II[BII)V", line = 411)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lno;Lpd;Lok;II)V", line = 427)
