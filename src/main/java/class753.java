...
public class class753 extends class513 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(III)I", line = 50)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIIIILha;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(ILvj;)Lte;", line = 83)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(III)Z", line = 94)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 114)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIZ)V", line = 129)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(I)V", line = 163)
    public class753(int arg0) {
        this.field10459 = arg0;
    }

    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 147)
