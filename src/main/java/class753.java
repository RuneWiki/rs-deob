...
public class class753 extends class742 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(I)Luu;", line = 31)
    ...
    @OriginalMember(owner = "client!cja", name = "<init>", descriptor = "(Lrj;Lmq;IIIIIIIII)V", line = 46)
