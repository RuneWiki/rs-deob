...
public class class199 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(II)Ldaa;", line = 9)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 100)
    public class199(class473 arg0, int arg1, class30 arg2) {
        this.field2769 = arg2;
        this.field2765 = this.field2769.method138(0, 4);
    }

    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(II)V", line = 84)
