...
public class class199 extends class154 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(FFFFFFLbe;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IILbe;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lbl;IIII)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lbl;II[III)V")
