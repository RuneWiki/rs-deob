...
public class class199 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ZZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIB)V", line = 42)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(FFIF)F", line = 56)
