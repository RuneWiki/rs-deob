...
public class class199 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(III)V", line = 22)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 71)
    public class199() {
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lmp;IIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(I)I", line = 125)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lnj;)V", line = 135)
