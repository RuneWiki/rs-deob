...
public class class199 extends class328 implements class238 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ZLha;)Loba;")
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lgda;Lha;IIZII)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lha;ZII)Lwv;")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IBILha;)Z")
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lha;I)V")
