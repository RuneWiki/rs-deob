...
public class class199 extends class467 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)I", line = 10)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIIIIIII)V", line = 40)
