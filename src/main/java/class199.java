...
public class class199 extends class521 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Ldl;)Lbv;", line = 4)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
