...
public class class199 implements class234 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z)Loi;", line = 59)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lla;)V", line = 72)
    public class199(class422 arg0) {
        this.field3401 = arg0;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(FFFFIFFZ)F", line = 80)
