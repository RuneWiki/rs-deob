...
public class class199 extends class734 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Ljava/net/Socket;BI)Lss;", line = 31)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 59)
