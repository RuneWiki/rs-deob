...
public class class199 extends class290 implements class130 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lud;)V", line = 5)
    public final void method311(class27 arg0) {
    }

    @OriginalMember(owner = "client!w", name = "m", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!w", name = "x", descriptor = "()Z", line = 21)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(II)I", line = 49)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ldd;Z)Lo;", line = 58)
    ...
    @OriginalMember(owner = "client!w", name = "f", descriptor = "()V", line = 136)
    public final void method303() {
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIILta;II)V", line = 139)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lsj;)V", line = 142)
    ...
    @OriginalMember(owner = "client!w", name = "i", descriptor = "()Z", line = 146)
    public final boolean method317() {
        return false;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "([IIIII)Lo;", line = 150)
    ...
    @OriginalMember(owner = "client!w", name = "e", descriptor = "()Z", line = 186)
    public final boolean method364() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "f", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II[I[I)Lta;", line = 202)
    ...
    @OriginalMember(owner = "client!w", name = "j", descriptor = "()Z", line = 205)
    public final boolean method339() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 210)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II[[I[[IIII)Lya;", line = 230)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 234)
    ...
    @OriginalMember(owner = "client!w", name = "v", descriptor = "()Z", line = 247)
    public final boolean method326() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "h", descriptor = "()Lc;", line = 255)
    public final class125 method368() {
        return this.field2837;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Le;Lsj;Lc;Lwp;I)V", line = 258)
    ...
    @OriginalMember(owner = "client!w", name = "l", descriptor = "()Z", line = 281)
    public final boolean method362() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "z", descriptor = "()Z", line = 284)
    public final boolean method323() {
        return false;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lul;[Ldd;Z)Lla;", line = 290)
    ...
    @OriginalMember(owner = "client!w", name = "h", descriptor = "(I)Ln;", line = 299)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "()Z", line = 304)
    public final boolean method337() {
        return false;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)V", line = 306)
    public final void method385(boolean arg0) {
    }

    @OriginalMember(owner = "client!w", name = "c", descriptor = "(Z)V", line = 311)
    public final void method349(boolean arg0) {
    }

    @OriginalMember(owner = "client!w", name = "b", descriptor = "(I)V", line = 314)
    public final void method389(int arg0) {
        this.field2839[arg0].method2382();
    }

    @OriginalMember(owner = "client!w", name = "w", descriptor = "()Lc;", line = 317)
    public final class125 method358() {
        return new class166();
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIF)Lls;", line = 320)
    ...
    @OriginalMember(owner = "client!w", name = "A", descriptor = "()V", line = 322)
    public final void method374() {
    }

    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Lnt;)V", line = 418)
    ...
    @OriginalMember(owner = "client!w", name = "y", descriptor = "()Z", line = 328)
    public final boolean method308() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "()Z", line = 333)
    public final boolean method363() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "k", descriptor = "()Z", line = 336)
    public final boolean method322() {
        return false;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIII)V", line = 339)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ln;)V", line = 344)
    public final void method356(class15 arg0) {
        this.field2821 = (class109) arg0;
        this.method1256(arg0);
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(FFF)V", line = 348)
    public final void method294(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!w", name = "d", descriptor = "(I)V", line = 352)
    public final void method353(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!w", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 357)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(IIIIII)Lud;", line = 381)
    public final class27 method384(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lud;Lud;FLud;)Lud;", line = 385)
    public final class27 method351(class27 arg0, class27 arg1, float arg2, class27 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!w", name = "b", descriptor = "(Z)V", line = 389)
    public final void method297(boolean arg0) {
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I[Lls;)V", line = 399)
    ...
    @OriginalMember(owner = "client!w", name = "d", descriptor = "()V", line = 459)
    public final void method341() {
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lld;IIII)Le;", line = 462)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lsj;Lc;[Lwp;I)V", line = 465)
    ...
    @OriginalMember(owner = "client!w", name = "u", descriptor = "()Z", line = 507)
    public final boolean method327() {
        return false;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIIIIII)V", line = 510)
    public final void method336(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!w", name = "R", descriptor = "()V", line = 517)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "()V", line = 524)
    ...
    @OriginalMember(owner = "client!w", name = "B", descriptor = "()V", line = 554)
    public final void method354() {
    }

    @OriginalMember(owner = "client!w", name = "X", descriptor = "(S)Z", line = 557)
    ...
    @OriginalMember(owner = "client!w", name = "qa", descriptor = "()Ljava/lang/Object;", line = 568)
    private final Object method1262() {
        return new class253(this);
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lc;[Lwp;I)V", line = 576)
    ...
    @OriginalMember(owner = "client!w", name = "s", descriptor = "()Z", line = 595)
    public final boolean method360() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "C", descriptor = "()Lk;", line = 600)
    ...
    @OriginalMember(owner = "client!w", name = "t", descriptor = "()Z", line = 612)
    public final boolean method372() {
        return false;
    }

    @OriginalMember(owner = "client!w", name = "d", descriptor = "(IIIIII)V", line = 616)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 619)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIIIII)V", line = 629)
    ...
    @OriginalMember(owner = "client!w", name = "m", descriptor = "(S)Z", line = 640)
    ...
    @OriginalMember(owner = "client!w", name = "g", descriptor = "(I)V", line = 667)
    public final void method375(int arg0) {
        this.field2839[arg0].method2384();
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIZ)Lo;", line = 675)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lsj;Z)V", line = 683)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIII)V", line = 715)
    public final void method366(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!w", name = "q", descriptor = "()I", line = 718)
    public final int method371() {
        return 4;
    }

    @OriginalMember(owner = "client!w", name = "g", descriptor = "()V", line = 727)
    public final void method292() {
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II)I", line = 738)
    public final int method302(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!w", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 744)
