...
public class class199 extends class295 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILpe;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!vo", name = "e", descriptor = "(I)V", line = 423)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I[[I)V", line = 438)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "([Ljava/lang/Object;[II)V", line = 455)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIIII)I", line = 477)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lqo;IILcc;Lkk;III)V", line = 506)
