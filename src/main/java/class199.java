...
public class class199 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lbda;I)V")
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(III)Lvp;")
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(ILoca;Loca;I)V")
