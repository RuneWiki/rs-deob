...
public class class199 extends class105 {
    ...
    @OriginalMember(owner = "client!kv", name = "ha", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "k", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!kv", name = "I", descriptor = "(III[I)V", line = 30)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "()Lm;", line = 40)
    ...
    @OriginalMember(owner = "client!kv", name = "XA", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III[I)V", line = 78)
    ...
    @OriginalMember(owner = "client!kv", name = "B", descriptor = "(IIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!kv", name = "EA", descriptor = "(Lm;)V", line = 116)
    ...
    @OriginalMember(owner = "client!kv", name = "ta", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!kv", name = "va", descriptor = "([I)V", line = 141)
    ...
    @OriginalMember(owner = "client!kv", name = "KA", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!kv", name = "oa", descriptor = "(III)V", line = 161)
    ...
    @OriginalMember(owner = "client!kv", name = "ma", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!kv", name = "TA", descriptor = "(III)V", line = 177)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "()V", line = 184)
    public class199() {
        this.method883();
    }
}
