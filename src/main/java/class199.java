...
public class class199 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IJ)Llo;", line = 7)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 36)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)V", line = 119)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "([[B[[II[[BLda;ZLda;I[[B[[BILtj;I)V", line = 142)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)V", line = 431)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)Llo;", line = 443)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZIZIIIII)V", line = 473)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Llo;IJ)V", line = 688)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(I)V", line = 714)
