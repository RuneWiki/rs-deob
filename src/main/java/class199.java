...
public abstract class class199 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/lang/String;IILjava/util/Random;[II[Lrn;II)I")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BIIILjava/lang/String;[Lrn;Loj;[II)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I[Lrn;[IILjava/util/Random;IIII[ILjava/lang/String;ZIII)I")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I[IIIIBILjava/lang/String;Loj;II[Lrn;IIII)I")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "([II[Lrn;I[ILjava/lang/String;[II)V")
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lvc;Lkg;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/lang/String;I[II[Lrn;II)V")
