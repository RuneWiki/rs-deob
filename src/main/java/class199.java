...
public class class199 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(F)F", line = 24)
    private static final float method1227(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "()V", line = 39)
    public static void method1228() {
        field2346 = null;
        field2353 = null;
    }

    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(IIF)F", line = 44)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IF)I", line = 51)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lbg;Lqs;)V", line = 117)
