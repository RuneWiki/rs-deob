...
public class class199 extends class567 {
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lvn;Lmf;IIIIIIIIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)Lkq;", line = 83)
    public class696 method726(int arg0) {
        field3090++;
        return arg0 == -17 ? class584.field8558 : null;
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZZ)I", line = 100)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIII)Lufa;", line = 136)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIB)V", line = 202)
