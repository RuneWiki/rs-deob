...
public class class199 extends class35 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([IILfj;[B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "()V", line = 102)
    public class199() {
    }

    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "([B)V", line = 104)
