...
public class class199 extends InputStream {
    ...
    @OriginalMember(owner = "client!vt", name = "read", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(JB)V", line = 13)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZII)I", line = 46)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILbf;)V", line = 81)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(II)I", line = 115)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILhd;II)V", line = 131)
