...
public class class199 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(FLek;ZLek;)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lqfa;)V", line = 89)
    public class199(class106 arg0) {
        this.field3038 = arg0;
    }

    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)Z", line = 106)
