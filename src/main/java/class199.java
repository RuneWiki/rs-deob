...
public class class199 extends class296 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(II[BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(FI)V", line = 28)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(IIIIIF)V", line = 48)
    public class199(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BIII)V", line = 53)
