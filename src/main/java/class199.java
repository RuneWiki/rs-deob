...
public class class199 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([Ljava/lang/Object;IBI[I)V", line = 586)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)V", line = 641)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BZ)V", line = 655)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IBI)I", line = 673)
