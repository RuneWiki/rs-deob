...
public class class199 extends class266 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IZI)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ida", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "()V", line = 33)
    public class199() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!ida", name = "d", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(IIII)[B", line = 59)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BBI)V", line = 72)
