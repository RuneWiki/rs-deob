...
public class class199 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(B)I", line = 34)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "()V", line = 359)
    private class199() {
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILtq;)V", line = 362)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "([I)V", line = 373)
