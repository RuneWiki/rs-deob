...
public class class199 extends class659 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III[I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 286)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZII)V", line = 151)
    ...
    @OriginalMember(owner = "client!c", name = "d", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIB)Z", line = 179)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[III)Z", line = 212)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[III)Z", line = 250)
