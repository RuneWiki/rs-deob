...
public class class199 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIBI)V", line = 46)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([BIB[BII)I", line = 154)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)Z", line = 305)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IC)Z", line = 326)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "([B)V", line = 363)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([BI[BIII)I", line = 489)
