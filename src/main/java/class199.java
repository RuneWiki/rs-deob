...
public class class199 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lrf;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BII)Z", line = 30)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZLrf;Ljava/lang/Object;)V", line = 41)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZLir;)V", line = 154)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)Z", line = 208)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILjava/lang/Object;ILrf;)V", line = 220)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILrf;)Ljava/lang/Object;", line = 262)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(III)Z", line = 314)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)I", line = 339)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)I", line = 352)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BI)V", line = 363)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(I)V", line = 428)
