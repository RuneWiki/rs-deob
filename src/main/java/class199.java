...
public class class199 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lab;B)Z")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lvt;IZ)V")
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(II)Lpi;")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLvt;)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIILcu;Loj;I)V")
