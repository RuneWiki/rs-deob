...
public class class199 extends class450 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(Z)I", line = 45)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II)I", line = 56)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(ILup;)V", line = 79)
    public class199(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)I", line = 96)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lup;)V", line = 124)
    public class199(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(III)Z", line = 127)
