...
public class class199 extends class89 {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(I)[Lqi;", line = 16)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lkha;Lkha;Lcm;)V", line = 42)
    public class199(class687 arg0, class687 arg1, class642 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(IIIZ)V", line = 53)
