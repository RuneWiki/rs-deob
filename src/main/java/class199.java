...
public class class199 extends class223 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IBLr;)V", line = 30)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 114)
