...
public class class199 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lpaa;BJ)V")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)Lpaa;")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IJ)Lpaa;")
