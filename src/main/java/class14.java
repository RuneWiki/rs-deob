...
public class class14 implements class36 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(III)V", line = 37)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZZ)I", line = 125)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IBI)V", line = 170)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BI)I", line = 198)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(III)V", line = 212)
