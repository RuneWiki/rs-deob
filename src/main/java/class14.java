...
public class class14 {
    ...
    @OriginalMember(owner = "client!EEUUOAGX", name = "e", descriptor = "[LEEUUOAGX;")
    public static class14[] field678;

    @OriginalMember(owner = "client!EEUUOAGX", name = "a", descriptor = "(ILSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!EEUUOAGX", name = "a", descriptor = "(ZLLDILQFVA;I)V")
