...
public class class14 extends class375 {
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lfu;II[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()V", line = 34)
