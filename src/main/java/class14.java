...
public class class14 extends class326 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILbt;I)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Ljg;ILwm;Lnp;BI)Z")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIIBIILdg;IIII)Z")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lbt;I)Ljq;")
