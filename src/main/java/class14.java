...
public class class14 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BLvi;)[I")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)Luw;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Luw;B)V")
