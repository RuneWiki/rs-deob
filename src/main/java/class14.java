...
public class class14 extends class627 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BLlga;)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lkj;I)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljc;I)V")
