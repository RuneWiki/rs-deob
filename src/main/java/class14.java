...
public class class14 extends class134 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BB)C", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(II)I", line = 58)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lkda;)V", line = 76)
    public class14(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(ILkda;)V", line = 84)
    public class14(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(B)I", line = 187)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lha;I)V", line = 198)
    ...
    @OriginalMember(owner = "client!ds", name = "e", descriptor = "(I)Z", line = 220)
