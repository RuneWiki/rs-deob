...
public class class14 extends class418 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIII)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II[II)V", line = 48)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(II)I", line = 73)
    public static final int method102(int arg0, int arg1) {
        return class50.field777 == null ? 0 : class50.field777[arg0][arg1] & 0xFFFFFF;
    }

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IBI)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III[I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(IIIIIIIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Ltj;B)V", line = 145)
