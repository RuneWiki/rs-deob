...
public class class14 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BII)Lwg;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IILr;Z)Lvba;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIII[I[IIIIILwg;ZIIB)I")
