...
public class class14 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ILaf;)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lfp;Lfp;BI)V")
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(ILaf;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Ljava/lang/Object;Laf;II)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Ljava/lang/Object;BLaf;)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lor;I)V")
