...
public class class14 extends class355 {
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsq;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsq;IIII[I)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lsq;[BIIIIIZ)Ll;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IBIILsq;I)Ll;")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsq;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsq;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsq;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsq;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I[IZILsq;I)Ll;")
