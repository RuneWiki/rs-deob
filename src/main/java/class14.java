...
public class class14 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lfq;ILug;B)V", line = 23)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lza;Lot;IIIII)V", line = 146)
