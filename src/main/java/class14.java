...
public class class14 extends class328 {
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZI)V", line = 47)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BILco;)V", line = 60)
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "()V", line = 99)
    public class14() {
        this(0);
    }

    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(I)V", line = 102)
    private class14(int arg0) {
        super(0, false);
        this.method77(false, arg0);
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIII)I", line = 124)
