...
public class class14 {
    ...
    @OriginalMember(owner = "client!DMOAMUBS", name = "f", descriptor = "LIZSDUVJF;")
    private class27 field677 = new class27();

    @OriginalMember(owner = "client!DMOAMUBS", name = "j", descriptor = "LTOAGRHDF;")
    ...
    @OriginalMember(owner = "client!DMOAMUBS", name = "i", descriptor = "LMCCUMEPE;")
    ...
    @OriginalMember(owner = "client!DMOAMUBS", name = "a", descriptor = "(J)LIZSDUVJF;")
    ...
    @OriginalMember(owner = "client!DMOAMUBS", name = "a", descriptor = "(JBLIZSDUVJF;)V")
