...
public class class14 {
    ...
    @OriginalMember(owner = "client!eda", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field144++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IBI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(IBI)I", line = 35)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Z)V", line = 57)
