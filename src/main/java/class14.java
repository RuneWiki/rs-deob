...
public class class14 extends class240 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lqu;)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "()Lsda;")
    public final class240 method156() {
        return (class240) this.field233.method3263((byte) -113);
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lrc;Lqu;)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lsda;)V")
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(Lsda;)V")
    public final synchronized void method164(class240 arg0) {
        arg0.method2797(74);
    }

    @OriginalMember(owner = "client!ds", name = "d", descriptor = "()Lsda;")
