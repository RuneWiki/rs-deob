...
public class class14 extends class251 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIIIZBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IF)V", line = 23)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILib;ILgs;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(IIIIIF)V", line = 413)
    public class14(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Ljava/lang/String;IIIIILha;I)V", line = 423)
