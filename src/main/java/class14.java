...
public class class14 extends class320 {
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "([[BILhu;)V", line = 28)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IZLvr;IZILvr;)I", line = 196)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 235)
