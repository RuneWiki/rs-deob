...
public class class14 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIZI)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(III)Lp;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILon;IZ)V")
