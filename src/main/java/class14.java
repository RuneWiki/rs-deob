...
public class class14 implements Runnable {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lod;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lrt;IB)Ltf;")
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(Lrt;IB)Ltf;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "([BZLrt;I)Ltf;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILtf;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Llu;)V")
