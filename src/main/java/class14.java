...
public class class14 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)I", line = 118)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILei;)V", line = 164)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "([I)V", line = 184)
