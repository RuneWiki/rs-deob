...
@OriginalClass("client!DUFZKGOK")
public class class14 {

    @OriginalMember(owner = "client!DUFZKGOK", name = "i", descriptor = "Z")
    public boolean field800 = false;

    @OriginalMember(owner = "client!DUFZKGOK", name = "j", descriptor = "I")
    public int field801 = -1;

    @OriginalMember(owner = "client!DUFZKGOK", name = "a", descriptor = "I")
    private static int field792 = -302;

    @OriginalMember(owner = "client!DUFZKGOK", name = "b", descriptor = "I")
    private static int field793;

    @OriginalMember(owner = "client!DUFZKGOK", name = "c", descriptor = "I")
    public static int field794;

    @OriginalMember(owner = "client!DUFZKGOK", name = "f", descriptor = "I")
    public int field797;

    @OriginalMember(owner = "client!DUFZKGOK", name = "g", descriptor = "I")
    public int field798;

    @OriginalMember(owner = "client!DUFZKGOK", name = "h", descriptor = "I")
    public int field799;

    @OriginalMember(owner = "client!DUFZKGOK", name = "k", descriptor = "I")
    public int field802;

    @OriginalMember(owner = "client!DUFZKGOK", name = "e", descriptor = "Ljava/lang/String;")
    public String field796;

    @OriginalMember(owner = "client!DUFZKGOK", name = "d", descriptor = "[LDUFZKGOK;")
    public static class14[] field795;

    @OriginalMember(owner = "client!DUFZKGOK", name = "a", descriptor = "(LLYZBHNJP;I)V")
    ...
    @OriginalMember(owner = "client!DUFZKGOK", name = "a", descriptor = "(IILZOMNSJJM;)V")
