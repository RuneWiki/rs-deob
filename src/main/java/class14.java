...
public class class14 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIB)I", line = 5)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IB)V", line = 26)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)Luv;", line = 229)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 263)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)V", line = 292)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)V", line = 319)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Loda;ILdda;Ldda;)V", line = 393)
