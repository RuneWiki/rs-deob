...
public class class14 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 54)
