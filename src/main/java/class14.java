...
public class class14 extends class626 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIII[[Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BS)V", line = 68)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIZIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 265)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Llda;Llda;IIZ)I", line = 338)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(Z)V", line = 436)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lak;I)V", line = 450)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIIIII)V", line = 479)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lgt;Lov;Lbh;[I)V", line = 513)
