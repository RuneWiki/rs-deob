...
public class class14 extends class540 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lwq;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lkia;)V", line = 70)
