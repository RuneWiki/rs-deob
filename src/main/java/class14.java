...
public class class14 {
    ...
    @OriginalMember(owner = "client!DWUJPTWU", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!DWUJPTWU", name = "c", descriptor = "[LDWUJPTWU;")
    public static class14[] field656;

    @OriginalMember(owner = "client!DWUJPTWU", name = "a", descriptor = "(ILTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!DWUJPTWU", name = "a", descriptor = "(LPKHWFJLM;Z)V")
