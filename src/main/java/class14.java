...
public class class14 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILba;IZ)Z")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)Lsj;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILba;II)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IILba;I)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lvd;Lne;)V")
