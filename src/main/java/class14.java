...
public class class14 implements class476 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BII)V", line = 42)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(III)V", line = 177)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IB)I", line = 205)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)I", line = 216)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIZ)V", line = 241)
