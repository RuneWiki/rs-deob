...
@OriginalClass("client!DOBKXCMM")
public class class14 {

    @OriginalMember(owner = "client!DOBKXCMM", name = "a", descriptor = "I")
    private int field724 = 623;

    @OriginalMember(owner = "client!DOBKXCMM", name = "b", descriptor = "I")
    public int field725 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "f", descriptor = "I")
    public int field729 = 32;

    @OriginalMember(owner = "client!DOBKXCMM", name = "g", descriptor = "I")
    public int field730 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "h", descriptor = "I")
    public int field731 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "i", descriptor = "I")
    public int field732 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "j", descriptor = "Z")
    public boolean field733 = true;

    @OriginalMember(owner = "client!DOBKXCMM", name = "m", descriptor = "I")
    public int field736 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "o", descriptor = "J")
    public long field738 = -1L;

    @OriginalMember(owner = "client!DOBKXCMM", name = "p", descriptor = "I")
    public int field739 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "q", descriptor = "I")
    public int field740 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "r", descriptor = "I")
    private int field741 = 411;

    @OriginalMember(owner = "client!DOBKXCMM", name = "u", descriptor = "I")
    private int field744 = 128;

    @OriginalMember(owner = "client!DOBKXCMM", name = "y", descriptor = "Z")
    public boolean field748 = false;

    @OriginalMember(owner = "client!DOBKXCMM", name = "z", descriptor = "I")
    public int field749 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "B", descriptor = "Z")
    private boolean field751 = false;

    @OriginalMember(owner = "client!DOBKXCMM", name = "D", descriptor = "I")
    public int field753 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "G", descriptor = "I")
    private int field756 = 128;

    @OriginalMember(owner = "client!DOBKXCMM", name = "J", descriptor = "I")
    public int field759 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "K", descriptor = "I")
    public int field760 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "L", descriptor = "I")
    public int field761 = -1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "M", descriptor = "B")
    public byte field762 = 1;

    @OriginalMember(owner = "client!DOBKXCMM", name = "x", descriptor = "LQQBOAQZB;")
    public static class50 field747 = new class50(3, 30);

    @OriginalMember(owner = "client!DOBKXCMM", name = "n", descriptor = "I")
    private int field737;

    @OriginalMember(owner = "client!DOBKXCMM", name = "s", descriptor = "I")
    private int field742;

    @OriginalMember(owner = "client!DOBKXCMM", name = "t", descriptor = "I")
    public static int field743;

    @OriginalMember(owner = "client!DOBKXCMM", name = "E", descriptor = "I")
    private static int field754;

    @OriginalMember(owner = "client!DOBKXCMM", name = "C", descriptor = "LINLHDAGO;")
    private static class29 field752;

    @OriginalMember(owner = "client!DOBKXCMM", name = "H", descriptor = "Lclient;")
    public static client field757;

    @OriginalMember(owner = "client!DOBKXCMM", name = "A", descriptor = "Ljava/lang/String;")
    public String field750;

    @OriginalMember(owner = "client!DOBKXCMM", name = "e", descriptor = "[B")
    public byte[] field728;

    @OriginalMember(owner = "client!DOBKXCMM", name = "c", descriptor = "[I")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "v", descriptor = "[I")
    public int[] field745;
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "k", descriptor = "[LDOBKXCMM;")
    private static class14[] field734;

    @OriginalMember(owner = "client!DOBKXCMM", name = "w", descriptor = "[Ljava/lang/String;")
    public String[] field746;

    @OriginalMember(owner = "client!DOBKXCMM", name = "a", descriptor = "(ILINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "a", descriptor = "(I)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "a", descriptor = "(I[III)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "a", descriptor = "(LDYBMLHQM;)V")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "b", descriptor = "(I)LDOBKXCMM;")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "c", descriptor = "(I)LDOBKXCMM;")
    ...
    @OriginalMember(owner = "client!DOBKXCMM", name = "a", descriptor = "(Z)V")
