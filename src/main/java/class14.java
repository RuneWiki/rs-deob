...
public class class14 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Laj;II)Lma;", line = 4)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()I", line = 13)
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "()[B", line = 59)
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "()Lks;", line = 119)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Ljp;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "()V", line = 149)
    private class14() {
    }
}
