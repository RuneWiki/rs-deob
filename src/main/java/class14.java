...
@OriginalClass("client!FIEFABCJ")
public class class14 extends class28 {

    @OriginalMember(owner = "client!FIEFABCJ", name = "x", descriptor = "Z")
    public boolean field653 = false;

    @OriginalMember(owner = "client!FIEFABCJ", name = "G", descriptor = "I")
    private int field662 = -22512;

    @OriginalMember(owner = "client!FIEFABCJ", name = "L", descriptor = "LSNGXEJOJ;")
    private class55 field667;

    @OriginalMember(owner = "client!FIEFABCJ", name = "w", descriptor = "I")
    public int field652;

    @OriginalMember(owner = "client!FIEFABCJ", name = "C", descriptor = "I")
    public int field658;

    @OriginalMember(owner = "client!FIEFABCJ", name = "D", descriptor = "I")
    public int field659;

    @OriginalMember(owner = "client!FIEFABCJ", name = "E", descriptor = "I")
    public int field660;

    @OriginalMember(owner = "client!FIEFABCJ", name = "r", descriptor = "I")
    public int field647;

    @OriginalMember(owner = "client!FIEFABCJ", name = "s", descriptor = "I")
    public int field648;

    @OriginalMember(owner = "client!FIEFABCJ", name = "t", descriptor = "I")
    public int field649;

    @OriginalMember(owner = "client!FIEFABCJ", name = "u", descriptor = "I")
    public int field650;

    @OriginalMember(owner = "client!FIEFABCJ", name = "v", descriptor = "I")
    public int field651;

    @OriginalMember(owner = "client!FIEFABCJ", name = "F", descriptor = "I")
    public int field661;

    @OriginalMember(owner = "client!FIEFABCJ", name = "q", descriptor = "D")
    private double field646;

    @OriginalMember(owner = "client!FIEFABCJ", name = "y", descriptor = "D")
    private double field654;

    @OriginalMember(owner = "client!FIEFABCJ", name = "z", descriptor = "D")
    private double field655;

    @OriginalMember(owner = "client!FIEFABCJ", name = "A", descriptor = "D")
    private double field656;

    @OriginalMember(owner = "client!FIEFABCJ", name = "B", descriptor = "D")
    private double field657;

    @OriginalMember(owner = "client!FIEFABCJ", name = "I", descriptor = "D")
    public double field664;

    @OriginalMember(owner = "client!FIEFABCJ", name = "J", descriptor = "D")
    public double field665;

    @OriginalMember(owner = "client!FIEFABCJ", name = "K", descriptor = "D")
    public double field666;

    @OriginalMember(owner = "client!FIEFABCJ", name = "n", descriptor = "I")
    private int field643;

    @OriginalMember(owner = "client!FIEFABCJ", name = "o", descriptor = "I")
    public int field644;

    @OriginalMember(owner = "client!FIEFABCJ", name = "p", descriptor = "I")
    public int field645;

    @OriginalMember(owner = "client!FIEFABCJ", name = "H", descriptor = "I")
    private int field663;

    @OriginalMember(owner = "client!FIEFABCJ", name = "M", descriptor = "I")
    private int field668;

    @OriginalMember(owner = "client!FIEFABCJ", name = "N", descriptor = "I")
    private int field669;

    @OriginalMember(owner = "client!FIEFABCJ", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!FIEFABCJ", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!FIEFABCJ", name = "a", descriptor = "(I)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!FIEFABCJ", name = "a", descriptor = "(IIZII)V")
