...
public class class14 extends Callback {
    ...
    @OriginalMember(owner = "client!ib", name = "callback", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ljava/awt/Component;BZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IBI)V", line = 93)
