...
public class class14 implements Runnable {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/Runnable;BI)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)La;")
    public final class420 method116(int arg0) {
        int var2 = 92 / ((-arg0 - 70) / 33);
        return this.method119(12, (Object) null, 0, 1, 0);
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/awt/Component;BII)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/Object;III)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IILjava/lang/Object;ZI)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IZIII)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Z)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/lang/String;I)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/net/URL;B)La;")
    public final class420 method127(URL arg0, byte arg1) {
        return arg1 == 105 ? this.method119(4, arg0, 0, 1, 0) : null;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/Class;I)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/awt/Component;BZ)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Ljava/lang/String;I)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IILjava/awt/Component;I[ILjava/awt/Point;)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)Lrj;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/Class;Z)La;")
    public final class420 method136(Class arg0, boolean arg1) {
        return arg1 ? this.method119(11, arg0, 0, 1, 0) : null;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/awt/Frame;I)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(Z)La;")
    public final class420 method139(boolean arg0) {
        return arg0 ? this.method119(18, (Object) null, 0, 1, 0) : null;
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Ljava/lang/Class;I)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/lang/String;)La;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Z)La;")
