...
@OriginalClass("client!ERVJQNCY")
public class class14 {

    @OriginalMember(owner = "client!ERVJQNCY", name = "b", descriptor = "I")
    public int field759;

    @OriginalMember(owner = "client!ERVJQNCY", name = "d", descriptor = "I")
    public int field761;

    @OriginalMember(owner = "client!ERVJQNCY", name = "c", descriptor = "LXVBRPTSM;")
    public class71 field760;

    @OriginalMember(owner = "client!ERVJQNCY", name = "e", descriptor = "[I")
    public int[] field762;

    @OriginalMember(owner = "client!ERVJQNCY", name = "f", descriptor = "[I")
    public int[] field763;

    @OriginalMember(owner = "client!ERVJQNCY", name = "g", descriptor = "[I")
    public int[] field764;

    @OriginalMember(owner = "client!ERVJQNCY", name = "h", descriptor = "[I")
    public int[] field765;

    @OriginalMember(owner = "client!ERVJQNCY", name = "a", descriptor = "[LERVJQNCY;")
    private static class14[] field758;

    @OriginalMember(owner = "client!ERVJQNCY", name = "i", descriptor = "[Z")
    private static boolean[] field766;

    @OriginalMember(owner = "client!ERVJQNCY", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ERVJQNCY", name = "a", descriptor = "([BZ)V")
    ...
    @OriginalMember(owner = "client!ERVJQNCY", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ERVJQNCY", name = "a", descriptor = "(BI)LERVJQNCY;")
    ...
    @OriginalMember(owner = "client!ERVJQNCY", name = "a", descriptor = "(IZ)Z")
