...
public class class14 implements Runnable {
    ...
    @OriginalMember(owner = "client!EUCYOSVT", name = "h", descriptor = "LUNXTKTRJ;")
    ...
    @OriginalMember(owner = "client!EUCYOSVT", name = "<init>", descriptor = "(BLjava/net/Socket;LUNXTKTRJ;)V")
