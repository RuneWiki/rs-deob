...
public class class14 implements class660 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)Lgp;")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)Lcda;")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lpf;Ldg;IIIIIII)V")
