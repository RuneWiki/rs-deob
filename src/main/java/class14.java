...
public class class14 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)V", line = 24)
    public static void method78(int arg0) {
        field170 = null;
        int var1 = -104 % ((arg0 - 66) / 57);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IB)V", line = 39)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIII)V", line = 74)
