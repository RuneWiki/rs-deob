...
public class class14 extends class316 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILso;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lafa;FIIIIIFI[BFFFI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BLmda;)V", line = 114)
