...
public class class14 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)Lmaa;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lcea;I)Lco;")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lsea;Lsea;)V")
