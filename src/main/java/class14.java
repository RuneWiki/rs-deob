...
public abstract class class14 implements class212 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!kv", name = "finalize", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZI)Z", line = 40)
    ...
    @OriginalMember(owner = "client!kv", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIBIILqa;II)V", line = 92)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lbv;IIIZ)V", line = 369)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)V", line = 251)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZZ)V", line = 264)
    ...
    @OriginalMember(owner = "client!kv", name = "e", descriptor = "(I)Z", line = 281)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ICLjava/lang/String;)[Ljava/lang/String;", line = 309)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZB)V", line = 346)
