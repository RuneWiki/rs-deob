...
public class class14 extends class256 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IILsg;II)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(FFFFFFLsg;II)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lig;IIII)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lig;II[III)V")
