...
public class class71 extends class90 {
    ...
    @OriginalMember(owner = "client!pk", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pk", name = "g", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II)I", line = 36)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IB)Lbm;", line = 52)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lam;Lhn;)V", line = 78)
