...
public class class71 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lnaa;B)Z")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BLig;)V")
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lig;)V")
