...
public class class71 {
    ...
    @OriginalMember(owner = "client!ZRDWHMTU", name = "b", descriptor = "[LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!ZRDWHMTU", name = "a", descriptor = "(J)LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!ZRDWHMTU", name = "a", descriptor = "(JLMXUYAYVV;I)V")
