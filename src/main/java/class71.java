...
public class class71 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)[Lsd;", line = 34)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)I", line = 44)
    public static final int method362(int arg0, int arg1) {
        return class419.field6040 == null ? 0 : (class419.field6040[arg0][arg1] & 0xFF) << 3;
    }

    @OriginalMember(owner = "client!le", name = "b", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Loj;IILbd;III[[[B[I[I[I[I[IIBIIZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(I)I", line = 281)
