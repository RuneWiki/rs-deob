...
public abstract class class71 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILlm;Lgk;Len;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lra;Len;Z)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BILbk;)Ljava/lang/String;")
