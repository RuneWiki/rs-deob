...
public class class71 extends class35 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)Lnf;")
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(I)Lqia;")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(ILmi;Lmi;Ltk;Leia;I[BIZ)V")
