...
public class class71 extends class312 implements class164 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lya;I)Lag;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lya;ZI)Lt;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILya;ILor;IZ)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lya;Z)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BLya;II)Z")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZLjava/lang/String;Lkd;I)Lsn;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lya;Ljt;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!eg", name = "i", descriptor = "(I)[Ltr;")
