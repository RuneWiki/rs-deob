...
public class class71 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "()I", line = 6)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "()[B", line = 49)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lti;)V", line = 128)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "()V", line = 148)
    private class71() {
    }

    @OriginalMember(owner = "client!rv", name = "c", descriptor = "()Lbv;", line = 117)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lhh;II)Lrv;", line = 122)
