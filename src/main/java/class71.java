...
public class class71 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)Lhga;")
    ...
    @OriginalMember(owner = "client!wc", name = "e", descriptor = "(I)Lhga;")
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(B)Lhga;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILhga;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)Lhga;")
