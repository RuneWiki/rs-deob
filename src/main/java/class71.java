...
public class class71 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IZLgf;)V")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lrh;BI)Z")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Z[[BLbi;)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lgk;)V")
