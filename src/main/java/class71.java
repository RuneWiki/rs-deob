...
public class class71 extends class578 implements class438 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BILqa;)Lr;", line = 4)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILqa;IB)Z", line = 15)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lqa;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILqa;)Llb;", line = 108)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BLqa;)Led;", line = 153)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(Z)Z", line = 175)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)I", line = 186)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)Z", line = 199)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lqa;Lih;IIIIIZIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(Lqa;B)V", line = 222)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lqa;B)V", line = 233)
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)I", line = 245)
