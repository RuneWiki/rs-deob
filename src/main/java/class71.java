...
public class class71 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([BI[BII)V")
    public static final void method569(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([II[III)V")
