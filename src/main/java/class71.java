...
@OriginalClass("client!YZICXNNP")
public class class71 implements Runnable {

    @OriginalMember(owner = "client!YZICXNNP", name = "a", descriptor = "B")
    private byte field1707 = 2;

    @OriginalMember(owner = "client!YZICXNNP", name = "b", descriptor = "Z")
    private boolean field1708 = true;

    @OriginalMember(owner = "client!YZICXNNP", name = "f", descriptor = "Z")
    private boolean field1712 = false;

    @OriginalMember(owner = "client!YZICXNNP", name = "k", descriptor = "Z")
    private boolean field1717 = false;

    @OriginalMember(owner = "client!YZICXNNP", name = "l", descriptor = "Z")
    private boolean field1718 = false;

    @OriginalMember(owner = "client!YZICXNNP", name = "g", descriptor = "LFDVCDUHZ;")
    public class19 field1713;

    @OriginalMember(owner = "client!YZICXNNP", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field1711;

    @OriginalMember(owner = "client!YZICXNNP", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field1709;

    @OriginalMember(owner = "client!YZICXNNP", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1710;

    @OriginalMember(owner = "client!YZICXNNP", name = "i", descriptor = "I")
    private int field1715;

    @OriginalMember(owner = "client!YZICXNNP", name = "j", descriptor = "I")
    private int field1716;

    @OriginalMember(owner = "client!YZICXNNP", name = "h", descriptor = "[B")
    private byte[] field1714;

    @OriginalMember(owner = "client!YZICXNNP", name = "<init>", descriptor = "(Ljava/net/Socket;LFDVCDUHZ;Z)V")
    ...
    @OriginalMember(owner = "client!YZICXNNP", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!YZICXNNP", name = "b", descriptor = "()I")
    public int method584() throws IOException {
        return this.field1712 ? 0 : this.field1709.read();
    }

    @OriginalMember(owner = "client!YZICXNNP", name = "c", descriptor = "()I")
    public int method585() throws IOException {
        return this.field1712 ? 0 : this.field1709.available();
    }

    @OriginalMember(owner = "client!YZICXNNP", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!YZICXNNP", name = "a", descriptor = "(II[BI)V")
    ...
    @OriginalMember(owner = "client!YZICXNNP", name = "run", descriptor = "()V")
    public void run() {
    ...
    @OriginalMember(owner = "client!YZICXNNP", name = "a", descriptor = "(I)V")
