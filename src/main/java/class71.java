...
public class class71 extends class413 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZFLta;II)V")
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(Lrr;I)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lrr;I)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILrr;)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Ljava/lang/String;IZLok;)Lhp;")
