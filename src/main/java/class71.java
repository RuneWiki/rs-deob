...
public class class71 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)Ls;")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B)Ls;")
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)Ls;")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B[Ls;)I")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(JILs;)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IB)Luf;")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IJ)Ls;")
