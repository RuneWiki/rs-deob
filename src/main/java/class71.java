...
public class class71 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)Lmr;", line = 3)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(I)Lmr;", line = 124)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "()V", line = 152)
    public class71() {
        this.field879.field1681 = this.field879;
        this.field879.field1677 = this.field879;
    }

    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILmr;)V", line = 163)
