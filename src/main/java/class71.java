...
public abstract class class71 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BIII)I", line = 26)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(B)Ljava/net/Socket;", line = 51)
    public final Socket method689(byte arg0) throws IOException {
        field1255++;
        return arg0 == 84 ? new Socket(this.field1256, this.field1257) : null;
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)I", line = 63)
