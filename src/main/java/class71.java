...
public class class71 extends class229 {
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lht;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IILao;)V", line = 68)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(B)Z", line = 78)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZI)V", line = 119)
    ...
    @OriginalMember(owner = "client!rv", name = "d", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(III)V", line = 144)
