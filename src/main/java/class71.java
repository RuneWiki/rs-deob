...
public class class71 extends class55 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!aj", name = "finalize", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!aj", name = "f", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Lii;I)Leb;", line = 82)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILdc;Lii;)V", line = 216)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILii;)V", line = 240)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 268)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BLlm;)V", line = 282)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIZLii;)Z", line = 335)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)I", line = 346)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)V", line = 490)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)V", line = 514)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIBII)V", line = 528)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lii;II)Ldc;", line = 570)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(B)V", line = 583)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(B)V", line = 596)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IZIII)V", line = 615)
    ...
    @OriginalMember(owner = "client!aj", name = "e", descriptor = "(I)Z", line = 637)
