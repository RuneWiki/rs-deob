...
public class class71 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IBLwk;II)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLhi;I)Lj;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Llj;Llj;FB)Z")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lnq;)V")
