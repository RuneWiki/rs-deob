...
public class class71 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IILfd;)I", line = 7)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)V", line = 223)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I)V", line = 233)
