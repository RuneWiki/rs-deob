...
@OriginalClass("client!ZSSCYSIO")
public class class71 {

    @OriginalMember(owner = "client!ZSSCYSIO", name = "f", descriptor = "I")
    public int field1724 = -1;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "h", descriptor = "[I")
    public int[] field1726 = new int[6];

    @OriginalMember(owner = "client!ZSSCYSIO", name = "i", descriptor = "[I")
    public int[] field1727 = new int[6];

    @OriginalMember(owner = "client!ZSSCYSIO", name = "j", descriptor = "I")
    public int field1728 = 128;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "k", descriptor = "I")
    public int field1729 = 128;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "a", descriptor = "I")
    private static int field1719 = -302;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "o", descriptor = "LISXEOURU;")
    public static class21 field1733 = new class21(-15730, 30);

    @OriginalMember(owner = "client!ZSSCYSIO", name = "b", descriptor = "I")
    public static int field1720;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "d", descriptor = "I")
    public int field1722;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "e", descriptor = "I")
    public int field1723;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "l", descriptor = "I")
    public int field1730;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "m", descriptor = "I")
    public int field1731;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "n", descriptor = "I")
    public int field1732;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "g", descriptor = "LISUBRNPG;")
    public class20 field1725;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "c", descriptor = "[LZSSCYSIO;")
    public static class71[] field1721;

    @OriginalMember(owner = "client!ZSSCYSIO", name = "a", descriptor = "(LLYZBHNJP;I)V")
    ...
    @OriginalMember(owner = "client!ZSSCYSIO", name = "a", descriptor = "(LZOMNSJJM;B)V")
    ...
    @OriginalMember(owner = "client!ZSSCYSIO", name = "a", descriptor = "()LCCYECDYX;")
