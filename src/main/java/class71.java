...
@OriginalClass("client!XVBRPTSM")
public class class71 {

    @OriginalMember(owner = "client!XVBRPTSM", name = "a", descriptor = "I")
    public int field1710;

    @OriginalMember(owner = "client!XVBRPTSM", name = "b", descriptor = "[I")
    public int[] field1711;

    @OriginalMember(owner = "client!XVBRPTSM", name = "c", descriptor = "[[I")
    public int[][] field1712;

    @OriginalMember(owner = "client!XVBRPTSM", name = "<init>", descriptor = "(ILCKBTFRZM;)V")
