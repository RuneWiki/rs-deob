...
public class class71 {
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "p", descriptor = "LCZWVRQJW;")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "J", descriptor = "LLDILQFVA;")
    private static class34 field1732;

    @OriginalMember(owner = "client!ZNUYRYPY", name = "i", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "N", descriptor = "[LZNUYRYPY;")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "a", descriptor = "(I[III)LHEQROJXW;")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "a", descriptor = "(LLDILQFVA;I)V")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "a", descriptor = "(LSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "a", descriptor = "(I)LZNUYRYPY;")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "b", descriptor = "(I)LHEQROJXW;")
    ...
    @OriginalMember(owner = "client!ZNUYRYPY", name = "c", descriptor = "(I)LZNUYRYPY;")
