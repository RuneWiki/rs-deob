...
public class class71 implements Runnable {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class71(int arg0, class66 arg1) {
        this.field968 = arg0;
        this.field960 = arg1;
    }

    @OriginalMember(owner = "client!qn", name = "b", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lpj;)V", line = 121)
    ...
    @OriginalMember(owner = "client!qn", name = "d", descriptor = "()Z", line = 130)
    public final boolean method586() {
        return this.field963 == null || !this.field966 && this.field963.method1092(32767);
    }

    @OriginalMember(owner = "client!qn", name = "e", descriptor = "()V", line = 133)
    ...
    @OriginalMember(owner = "client!qn", name = "run", descriptor = "()V", line = 142)
    ...
    @OriginalMember(owner = "client!qn", name = "f", descriptor = "()J", line = 152)
