...
public class class71 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(II[II[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vha", name = "toString", descriptor = "()Ljava/lang/String;", line = 75)
    public final String toString() {
        field965++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)I", line = 83)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "([BIII)I", line = 93)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Lfda;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 171)
