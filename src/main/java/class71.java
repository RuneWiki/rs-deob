...
public class class71 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!hb", name = "l", descriptor = "Llf;")
    public static class109 field1388 = field1387;

    @OriginalMember(owner = "client!hb", name = "m", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIII[Lvg;III)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([Llb;B)V")
