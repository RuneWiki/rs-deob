...
public class class71 {
    ...
    @OriginalMember(owner = "client!ZLISRGEK", name = "e", descriptor = "LDRKSBDQX;")
    public class10 field1746 = new class10();

    @OriginalMember(owner = "client!ZLISRGEK", name = "a", descriptor = "I")
    private int field1742;

    @OriginalMember(owner = "client!ZLISRGEK", name = "f", descriptor = "LDRKSBDQX;")
    ...
    @OriginalMember(owner = "client!ZLISRGEK", name = "a", descriptor = "(LDRKSBDQX;)V")
    ...
    @OriginalMember(owner = "client!ZLISRGEK", name = "a", descriptor = "()LDRKSBDQX;")
    ...
    @OriginalMember(owner = "client!ZLISRGEK", name = "b", descriptor = "()LDRKSBDQX;")
    ...
    @OriginalMember(owner = "client!ZLISRGEK", name = "a", descriptor = "(B)LDRKSBDQX;")
