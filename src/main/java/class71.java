...
public abstract class class71 extends class542 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Luca;[I)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lk;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!pq", name = "X", descriptor = "(IILk;)Lk;")
    ...
    @OriginalMember(owner = "client!pq", name = "ya", descriptor = "(Lk;IIIIZ)V")
    public final void method696(class88 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!pq", name = "F", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lvda;IIII[[I[[II)V")
