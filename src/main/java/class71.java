...
@OriginalClass("client!ZNUJPBQV")
public class class71 {

    @OriginalMember(owner = "client!ZNUJPBQV", name = "b", descriptor = "I")
    public int field1696;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "d", descriptor = "I")
    public int field1698;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "c", descriptor = "LIJWJZMOM;")
    public class30 field1697;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "e", descriptor = "[I")
    public int[] field1699;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "f", descriptor = "[I")
    public int[] field1700;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "g", descriptor = "[I")
    public int[] field1701;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "h", descriptor = "[I")
    public int[] field1702;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "a", descriptor = "[LZNUJPBQV;")
    private static class71[] field1695;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "i", descriptor = "[Z")
    private static boolean[] field1703;

    @OriginalMember(owner = "client!ZNUJPBQV", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ZNUJPBQV", name = "a", descriptor = "([BI)V")
    ...
    @OriginalMember(owner = "client!ZNUJPBQV", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ZNUJPBQV", name = "a", descriptor = "(II)LZNUJPBQV;")
    ...
    @OriginalMember(owner = "client!ZNUJPBQV", name = "b", descriptor = "(II)Z")
