...
@OriginalClass("client!YSAVREBH")
public class class71 extends class18 implements Runnable {

    @OriginalMember(owner = "client!YSAVREBH", name = "b", descriptor = "Z")
    private boolean field1634 = true;

    @OriginalMember(owner = "client!YSAVREBH", name = "e", descriptor = "Z")
    private boolean field1637 = true;

    @OriginalMember(owner = "client!YSAVREBH", name = "g", descriptor = "[[B")
    private byte[][] field1639 = new byte[4][];

    @OriginalMember(owner = "client!YSAVREBH", name = "k", descriptor = "I")
    private int field1643 = -376;

    @OriginalMember(owner = "client!YSAVREBH", name = "l", descriptor = "LFLJWGVEY;")
    private class20 field1644 = new class20(807);

    @OriginalMember(owner = "client!YSAVREBH", name = "o", descriptor = "Z")
    private boolean field1647 = false;

    @OriginalMember(owner = "client!YSAVREBH", name = "s", descriptor = "LFLJWGVEY;")
    private class20 field1651 = new class20(807);

    @OriginalMember(owner = "client!YSAVREBH", name = "u", descriptor = "I")
    private int field1653 = -548;

    @OriginalMember(owner = "client!YSAVREBH", name = "z", descriptor = "Z")
    private boolean field1658 = false;

    @OriginalMember(owner = "client!YSAVREBH", name = "A", descriptor = "[B")
    private byte[] field1659 = new byte[500];

    @OriginalMember(owner = "client!YSAVREBH", name = "B", descriptor = "LFLJWGVEY;")
    private class20 field1660 = new class20(807);

    @OriginalMember(owner = "client!YSAVREBH", name = "F", descriptor = "Ljava/lang/String;")
    public String field1664 = "";

    @OriginalMember(owner = "client!YSAVREBH", name = "G", descriptor = "LFLJWGVEY;")
    private class20 field1665 = new class20(807);

    @OriginalMember(owner = "client!YSAVREBH", name = "H", descriptor = "[[I")
    private int[][] field1666 = new int[4][];

    @OriginalMember(owner = "client!YSAVREBH", name = "I", descriptor = "[[I")
    private int[][] field1667 = new int[4][];

    @OriginalMember(owner = "client!YSAVREBH", name = "J", descriptor = "Z")
    private boolean field1668 = true;

    @OriginalMember(owner = "client!YSAVREBH", name = "K", descriptor = "LUMTLOYSA;")
    private class60 field1669 = new class60((byte) 6);

    @OriginalMember(owner = "client!YSAVREBH", name = "L", descriptor = "[B")
    private byte[] field1670 = new byte[65000];

    @OriginalMember(owner = "client!YSAVREBH", name = "N", descriptor = "Z")
    private boolean field1672 = true;

    @OriginalMember(owner = "client!YSAVREBH", name = "O", descriptor = "I")
    private int field1673 = 6;

    @OriginalMember(owner = "client!YSAVREBH", name = "U", descriptor = "LFLJWGVEY;")
    private class20 field1679 = new class20(807);

    @OriginalMember(owner = "client!YSAVREBH", name = "V", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1680 = new CRC32();

    @OriginalMember(owner = "client!YSAVREBH", name = "c", descriptor = "I")
    private int field1635;

    @OriginalMember(owner = "client!YSAVREBH", name = "d", descriptor = "I")
    private int field1636;

    @OriginalMember(owner = "client!YSAVREBH", name = "f", descriptor = "I")
    public int field1638;

    @OriginalMember(owner = "client!YSAVREBH", name = "i", descriptor = "I")
    private int field1641;

    @OriginalMember(owner = "client!YSAVREBH", name = "q", descriptor = "I")
    private int field1649;

    @OriginalMember(owner = "client!YSAVREBH", name = "r", descriptor = "I")
    private int field1650;

    @OriginalMember(owner = "client!YSAVREBH", name = "w", descriptor = "I")
    private int field1655;

    @OriginalMember(owner = "client!YSAVREBH", name = "C", descriptor = "I")
    private int field1661;

    @OriginalMember(owner = "client!YSAVREBH", name = "M", descriptor = "I")
    public int field1671;

    @OriginalMember(owner = "client!YSAVREBH", name = "P", descriptor = "I")
    private int field1674;

    @OriginalMember(owner = "client!YSAVREBH", name = "R", descriptor = "I")
    private int field1676;

    @OriginalMember(owner = "client!YSAVREBH", name = "S", descriptor = "I")
    private int field1677;

    @OriginalMember(owner = "client!YSAVREBH", name = "m", descriptor = "J")
    private long field1645;

    @OriginalMember(owner = "client!YSAVREBH", name = "n", descriptor = "LCZKZHBFI;")
    private class12 field1646;

    @OriginalMember(owner = "client!YSAVREBH", name = "x", descriptor = "Lclient;")
    private client field1656;

    @OriginalMember(owner = "client!YSAVREBH", name = "y", descriptor = "Ljava/io/InputStream;")
    private InputStream field1657;

    @OriginalMember(owner = "client!YSAVREBH", name = "v", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1654;

    @OriginalMember(owner = "client!YSAVREBH", name = "E", descriptor = "Ljava/net/Socket;")
    private Socket field1663;

    @OriginalMember(owner = "client!YSAVREBH", name = "j", descriptor = "[B")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "t", descriptor = "[I")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(I)V")
    public final void method264(int arg0) {
        this.method585(0, arg0);
    }

    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(IZ)Z")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(ZLCZKZHBFI;)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(BI)Z")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(II[BI)Z")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "c", descriptor = "(II)I")
    public final int method592(int arg0, int arg1) {
        return arg0 == 0 ? this.field1642[arg1] & 0xFF : this.field1674;
    }

    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(LBBMKAXRK;Lclient;)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(BZ)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "c", descriptor = "(I)I")
    public final int method597(int arg0) {
        return arg0 == 0 ? this.field1678.length : this.field1674;
    }

    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(BII)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "b", descriptor = "()LCZKZHBFI;")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "a", descriptor = "(IIIZ)I")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YSAVREBH", name = "c", descriptor = "()V")
