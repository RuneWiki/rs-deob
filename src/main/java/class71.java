...
public class class71 {
    ...
    @OriginalMember(owner = "client!ZGXCNUJM", name = "t", descriptor = "I")
    ...
    @OriginalMember(owner = "client!ZGXCNUJM", name = "d", descriptor = "[LZGXCNUJM;")
    public static class71[] field1727;

    @OriginalMember(owner = "client!ZGXCNUJM", name = "a", descriptor = "(LFNOQZAYQ;I)V")
    ...
    @OriginalMember(owner = "client!ZGXCNUJM", name = "a", descriptor = "(LDNRIFKTO;I)V")
