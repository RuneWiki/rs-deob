...
public class class71 extends class30 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILrg;)V", line = 9)
    ...
    @OriginalMember(owner = "client!jv", name = "d", descriptor = "(I)V", line = 660)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)[I", line = 670)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(BILac;)V", line = 724)
