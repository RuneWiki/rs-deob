...
public class class71 extends class12 {
    ...
    @OriginalMember(owner = "client!YVYOADIW", name = "A", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!YVYOADIW", name = "O", descriptor = "[LSFAIBATY;")
    ...
    @OriginalMember(owner = "client!YVYOADIW", name = "a", descriptor = "(LTXPLZUUI;Z)V")
