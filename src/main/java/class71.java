...
public class class71 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILza;Lnv;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZIIIZ)Lur;", line = 78)
