...
public class class71 extends class409 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IZIB)V", line = 22)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLtba;III)V", line = 36)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lbt;Lbt;Lta;)V", line = 115)
