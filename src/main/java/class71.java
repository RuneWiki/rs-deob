...
public class class71 extends class270 {
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(II)Lrr;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(BLia;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILia;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lia;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILqs;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lia;B[I)V")
