...
public class class71 extends class42 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BLpc;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(B)Lkl;")
    ...
    @OriginalMember(owner = "client!rv", name = "d", descriptor = "(I)[Lfr;")
