...
public class class71 extends class16 implements class103 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILma;II)V", line = 13)
    public final void method95(int arg0, int arg1, class10 arg2, int arg3, int arg4) {
        this.method593(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ra", name = "finalize", descriptor = "()V", line = 23)
    protected final void finalize() {
        class1.method1(this, (byte) -31);
    }

    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lqa;Lna;[IIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lqa;Lna;IIII)V", line = 30)
