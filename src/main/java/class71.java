...
public class class71 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Law;I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lts;Z)V", line = 50)
