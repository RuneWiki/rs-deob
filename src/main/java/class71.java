...
public class class71 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Ljava/awt/Canvas;ILd;I)Lha;", line = 15)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)V", line = 32)
