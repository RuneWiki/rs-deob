...
public class class71 extends class179 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Llt;I)Ljj;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Llt;II)Ljj;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([I)Lgu;")
    ...
    @OriginalMember(owner = "client!jj", name = "f", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Llt;)Z")
