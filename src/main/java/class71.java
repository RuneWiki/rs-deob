...
public class class71 extends class335 implements class579 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIILkp;[BIBII)V")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lrca;Lkp;Lvt;II)V")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lrca;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lrca;Lkp;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Llba;I)V")
    public final void method154(class477 arg0, int arg1) {
        super.method154(arg0, arg1);
    }

    @OriginalMember(owner = "client!haa", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
