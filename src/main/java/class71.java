...
public class class71 extends class54 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILla;)I")
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lhia;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(ILhia;)V")
