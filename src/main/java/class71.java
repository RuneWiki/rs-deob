...
public class class71 {
    ...
    @OriginalMember(owner = "client!ZYLCKQCD", name = "d", descriptor = "LRZDMTEAZ;")
    private class49 field1737 = new class49();

    @OriginalMember(owner = "client!ZYLCKQCD", name = "h", descriptor = "LNAZXUZWI;")
    ...
    @OriginalMember(owner = "client!ZYLCKQCD", name = "g", descriptor = "LWIZYUELH;")
    ...
    @OriginalMember(owner = "client!ZYLCKQCD", name = "a", descriptor = "(J)LRZDMTEAZ;")
    ...
    @OriginalMember(owner = "client!ZYLCKQCD", name = "a", descriptor = "(LRZDMTEAZ;IJ)V")
