...
public class class71 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IFFIIILgi;FIIF[BIF)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IB)Lmf;")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BLpa;)Z")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lvj;Lm;)V")
