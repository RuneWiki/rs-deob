...
public class class71 {
    ...
    @OriginalMember(owner = "client!ZKWMIVTX", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!ZKWMIVTX", name = "c", descriptor = "[LZKWMIVTX;")
    public static class71[] field1705;

    @OriginalMember(owner = "client!ZKWMIVTX", name = "a", descriptor = "(LBYZSQZUF;Z)V")
    ...
    @OriginalMember(owner = "client!ZKWMIVTX", name = "a", descriptor = "(ILIMUIZRAF;)V")
