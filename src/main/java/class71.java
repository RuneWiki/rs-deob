...
public class class71 extends class80 {
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZLms;)V", line = 32)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILnn;)V", line = 128)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "()V", line = 212)
    public class71() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(II)[I", line = 221)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(III)I", line = 326)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(III)Z", line = 355)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(I)V", line = 408)
