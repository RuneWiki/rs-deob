...
public class class71 extends class33 {
    ...
    @OriginalMember(owner = "client!ZHYAQRMA", name = "k", descriptor = "Z")
    public static boolean field1711;

    @OriginalMember(owner = "client!ZHYAQRMA", name = "i", descriptor = "[LCSJSQCOH;")
    ...
    @OriginalMember(owner = "client!ZHYAQRMA", name = "a", descriptor = "(Z)LOQIGXOFQ;")
