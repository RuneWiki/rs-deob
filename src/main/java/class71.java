...
public class class71 {
    ...
    @OriginalMember(owner = "client!qn", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1047++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(B)I", line = 16)
    public final int method630(byte arg0) {
        field1046++;
        return arg0 == -65 ? this.field1045 : -40;
    }

    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 26)
