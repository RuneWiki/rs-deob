...
public class class555 implements class396 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Luq;Lvh;)V", line = 67)
    public class555(class172 arg0, class379 arg1) {
        this.field7653 = arg0;
        this.field7648 = arg1;
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(I)V", line = 103)
