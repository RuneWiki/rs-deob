...
public class class555 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)Lko;", line = 6)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)Lko;", line = 54)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "()V", line = 88)
    public class555() {
    }

    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lrda;)V", line = 90)
