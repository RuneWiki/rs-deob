...
public abstract class class555 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lqq;)V", line = 63)
    public class555(class651 arg0) {
        this.field7580 = arg0;
    }

    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)V", line = 78)
