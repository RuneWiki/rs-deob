...
public class class555 extends class715 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILdu;I)V", line = 4)
    public final void method693(int arg0, class355 arg1, int arg2) {
        ++field7768;
        int var4 = 68 / ((31 - arg0) / 50);
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)I", line = 13)
    public static int method3246(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Leea;Leq;Lwv;)V", line = 44)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIILwr;Lwr;)V", line = 62)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)V", line = 126)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(III)Z", line = 166)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZI)V", line = 177)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZZ)V", line = 190)
