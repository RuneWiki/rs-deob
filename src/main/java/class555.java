...
public class class555 extends class642 {
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "()V", line = 132)
    public class555() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILgk;B)V", line = 24)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(III)Z", line = 109)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(III)Z", line = 135)
    ...
    @OriginalMember(owner = "client!qw", name = "e", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IZ[BI)[B", line = 176)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(II)[I", line = 193)
