...
public class class555 extends class314 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BLie;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ke", name = "h", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)[I", line = 92)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 160)
    public class555() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 180)
