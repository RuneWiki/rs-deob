...
public class class555 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIIILha;II)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZLgga;Llv;)Lsd;")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lha;Lgga;I)V")
