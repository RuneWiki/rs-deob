...
public class class555 extends class67 {
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V")
    public class555(Canvas arg0, class17 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "([Lr;Lm;[Lpr;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/Runnable;)Lrk;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "([Lr;Lrd;Lm;[Lpr;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II[[I[[IIII)Lsa;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lfd;IIII)Lr;")
