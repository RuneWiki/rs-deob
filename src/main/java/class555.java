...
public class class555 extends class38 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IILrg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([Lsca;II)V", line = 85)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(III)Z", line = 156)
    ...
    @OriginalMember(owner = "client!ii", name = "c", descriptor = "(III)Z", line = 175)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "()V", line = 221)
    public class555() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BI)[I", line = 254)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)Z", line = 309)
