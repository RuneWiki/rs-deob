...
public class class555 extends class424 implements class89 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILfa;II)V", line = 4)
    public final void method63(int arg0, int arg1, class185 arg2, int arg3, int arg4) {
        this.method3113(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lda;La;[I[BIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!la", name = "GA", descriptor = "(IIIIII)V", line = 36)
