...
public class class555 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(B)Ldia;", line = 6)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(II)I", line = 18)
    public static int method3251(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Z)Lgw;", line = 28)
    public final class170 method3252(boolean arg0) {
        field7964++;
        return arg0 ? class27.method130(this.field7953, -128) : null;
    }

    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IBI)Z", line = 75)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IC)Z", line = 87)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIII)Lnda;", line = 139)
    ...
    @OriginalMember(owner = "client!nda", name = "c", descriptor = "(I)Z", line = 151)
    ...
    @OriginalMember(owner = "client!nda", name = "d", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(IIIIB)V", line = 329)
