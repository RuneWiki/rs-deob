...
public class class555 implements class234 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Z)Loi;", line = 28)
    public final class696 method1156(boolean arg0) {
        field7914++;
        return arg0 ? class696.field9869 : null;
    }

    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 40)
    public class555(String arg0) {
        this.field7913 = arg0;
    }

    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lht;I)I", line = 48)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lha;IIIIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)Z", line = 218)
