...
public class class555 extends class392 {
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(ILw;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(B)Lw;")
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lw;)V")
    public class555(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(Z)V")
