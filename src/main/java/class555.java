...
public class class555 extends class212 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIIIIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IILat;ZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIZIZII)V", line = 101)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Ldh;)V", line = 127)
    public class555(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(II)I", line = 130)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(ILdh;)V", line = 142)
    public class555(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "(I)I", line = 175)
    public final int method3195(int arg0) {
        ++field7670;
        return arg0 != -32350 ? -127 : super.field3006;
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(III)Z", line = 186)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 200)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)V", line = 222)
