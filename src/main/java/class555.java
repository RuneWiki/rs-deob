...
public class class555 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILiaa;)Ldu;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BIILep;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lap;J[Ldl;)V")
