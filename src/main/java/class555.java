...
public class class555 extends class325 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lvj;IIIIZ[FI)V", line = 28)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lvj;IIIIZ[BIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIBZII[II)V", line = 103)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lvj;IIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IZZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lvj;IIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ZIIII[BIIII)V", line = 204)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIZ)Lsm;", line = 263)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lvj;IIIIZ[IZ)V", line = 278)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)V", line = 328)
