...
public class class555 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([[BILjs;)V", line = 112)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILr;IZ)V", line = 183)
