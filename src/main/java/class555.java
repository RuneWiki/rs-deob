...
public class class555 extends class328 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 273)
    public class555() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BILco;)V", line = 78)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZI)Z", line = 162)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II)[I", line = 180)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Z)V", line = 230)
    ...
    @OriginalMember(owner = "client!hr", name = "f", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIBIIII[[[BIIILqa;I)V", line = 305)
