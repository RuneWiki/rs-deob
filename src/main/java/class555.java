...
public class class555 extends class644 implements class427 {
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(I)Lig;")
    public final class258 method2612(int arg0) {
        ++field7480;
        return arg0 != 21064 ? null : this.field7479;
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lpa;Lig;Z)V")
