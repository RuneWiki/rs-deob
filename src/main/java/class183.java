...
public class class183 extends class656 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(III[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "([IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIBI)Z", line = 41)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(III)Z", line = 76)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ZZ)I", line = 96)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIIB)V", line = 142)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(IIIIIIIII)V", line = 328)
