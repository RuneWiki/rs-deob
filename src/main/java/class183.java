...
public abstract class class183 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)Los;", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)Lgo;", line = 36)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lul;Ljava/lang/String;ZI)Lcu;", line = 53)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Luq;III)V", line = 107)
