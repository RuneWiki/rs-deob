...
public class class183 {
    ...
    @OriginalMember(owner = "client!th", name = "h", descriptor = "Llf;")
    public static class109 field3445 = class35.method275("(U4", 2);

    @OriginalMember(owner = "client!th", name = "f", descriptor = "Llf;")
