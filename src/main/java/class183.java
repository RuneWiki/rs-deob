...
public abstract class class183 extends class78 {
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 51)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLjava/lang/String;)I", line = 64)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(IIIIIII)V", line = 87)
