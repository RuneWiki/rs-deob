...
public class class183 extends class642 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILgk;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!o", name = "f", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)[[I", line = 42)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(BII)V", line = 86)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II[BLjava/io/File;)V", line = 160)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 177)
    public class183() {
        super(1, false);
    }

    @OriginalMember(owner = "client!o", name = "b", descriptor = "(III)Lpo;", line = 181)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(II)[I", line = 188)
