...
public class class183 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZI)Lrk;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lza;IILgh;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lkp;ILph;Lph;)V")
