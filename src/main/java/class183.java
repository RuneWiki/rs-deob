...
public class class183 {
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(II)Lik;", line = 84)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!gb", name = "d", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!gb", name = "e", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 369)
