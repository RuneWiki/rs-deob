...
public class class183 implements class534 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILjp;)Lle;")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Ljn;Ljaa;)V")
