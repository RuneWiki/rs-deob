...
public abstract class class183 extends class47 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ljava/awt/Component;I)Lfg;", line = 5)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILbn;Lnl;Lnl;)V", line = 21)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ZI)Z", line = 44)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!dh", name = "e", descriptor = "(I)V", line = 84)
