...
public class class183 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(I)V", line = 218)
    public class183(int arg0) {
        this.field2351 = arg0;
    }

    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(IIIIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILo;)V", line = 35)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZLjava/lang/String;ZZLufa;)V", line = 52)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 129)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lw;III[Z)Z", line = 159)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)Lo;", line = 201)
