...
public class class183 extends class354 implements class381 {
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(IIILel;)V", line = 14)
    public class183(int arg0, int arg1, int arg2, class354 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field2519 = arg3;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lwm;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lwm;B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(Lwm;B)Lnf;", line = 89)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIILwm;ZLhp;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BLwm;)V", line = 140)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIBLwm;)Z", line = 171)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILwm;I)Lgn;", line = 205)
