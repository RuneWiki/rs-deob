...
public class class183 extends class456 {
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "h", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IBLre;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 135)
    public class183() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(II)[I", line = 138)
    ...
    @OriginalMember(owner = "client!ol", name = "i", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 365)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(II)I", line = 377)
