...
public class class183 implements class153 {
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Ldn;Ldn;B)I", line = 17)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIIIIBIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(III)V", line = 156)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BIIIII)V", line = 185)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IB)I", line = 286)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLum;)Z", line = 307)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I[IZII)V", line = 319)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IZI)V", line = 347)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIB)V", line = 373)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZB)I", line = 401)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 441)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)V", line = 527)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IBI)V", line = 540)
