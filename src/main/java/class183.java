...
public class class183 extends class115 {
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Loa;J)V", line = 25)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(JI)V", line = 209)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lph;IIIIIIIIIIIZZ)V", line = 604)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lph;IIIIIIIIIIIZZ)V", line = 622)
