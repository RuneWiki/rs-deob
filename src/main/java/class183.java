...
public class class183 extends class35 {
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(II)[B", line = 43)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(II)Z", line = 79)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)Lpq;", line = 97)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(ILvm;Lvm;Ldga;Lms;I[BIZ)V", line = 828)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BII)Lhv;", line = 204)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)V", line = 465)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)I", line = 485)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(B)V", line = 497)
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(I)V", line = 679)
    ...
    @OriginalMember(owner = "client!o", name = "e", descriptor = "(I)I", line = 727)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)I", line = 747)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(Z)I", line = 764)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(B)V", line = 792)
