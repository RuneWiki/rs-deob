...
public abstract class class183 extends class408 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "([II[ILwu;IB)Lqp;", line = 117)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(FZFF)F", line = 176)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Z)V", line = 187)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(BI)[[[B", line = 198)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(II)V", line = 975)
