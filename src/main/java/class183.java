...
public class class183 extends class502 {
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Leka;)V", line = 14)
    public class183(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(ILeka;)V", line = 137)
    public class183(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lfca;I)Ljb;", line = 155)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)Z", line = 175)
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(JI)I", line = 202)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)I", line = 214)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Z)V", line = 236)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(II)I", line = 282)
