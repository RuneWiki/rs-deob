...
public class class183 implements class702 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IB)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(BI)I")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(I[I)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Ljava/awt/Component;ZII)V")
