...
public class class183 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(I)Z", line = 245)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Z)V", line = 262)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)I", line = 446)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(BIIIIIILfq;)V", line = 456)
