...
public class class183 implements class209 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(III)Z", line = 56)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)I", line = 110)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 121)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lrca;Z)V", line = 142)
