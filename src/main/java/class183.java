...
public class class183 extends class194 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILbg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lgi;III[Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!th", name = "h", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lpd;Lna;Luo;Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 277)
    public class183() {
        super(1, true);
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)[I", line = 240)
