...
public class class183 extends class239 {
    ...
    @OriginalMember(owner = "client!eb", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eb", name = "g", descriptor = "(I)[B", line = 31)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(B)I", line = 687)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BI)V", line = 709)
    ...
    @OriginalMember(owner = "client!eb", name = "i", descriptor = "(I)V", line = 733)
