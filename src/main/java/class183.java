...
public class class183 extends class251 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BLro;)I", line = 12)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!sb", name = "d", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lma;Ldd;)V", line = 122)
