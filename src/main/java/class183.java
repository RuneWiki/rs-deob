...
public class class183 extends class27 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IILvf;)V")
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Llj;Lud;)V")
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IBIIILlaa;)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(Z)Lrd;")
