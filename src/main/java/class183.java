...
public class class183 extends class322 implements class525 {
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Lvj;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Lvj;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lbu;B)I")
