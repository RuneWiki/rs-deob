...
public class class183 extends class190 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Ljj;)V", line = 65)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZI)V", line = 133)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)V", line = 170)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(I)V", line = 181)
    public static void method1230(int arg0) {
        field2645 = null;
        int var1 = 74 / ((51 - arg0) / 63);
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILaba;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(I)Z", line = 211)
