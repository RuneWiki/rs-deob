...
public class class183 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lqn;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIIIIII)V", line = 60)
