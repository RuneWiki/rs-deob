...
public class class183 extends class335 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IC)C", line = 18)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILio;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "()V", line = 150)
    public class183() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lio;I)Lmc;", line = 118)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZI)[I", line = 153)
