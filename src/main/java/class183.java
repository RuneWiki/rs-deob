...
public class class183 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lgk;)V", line = 64)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "()V", line = 149)
    private class183() {
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lok;II)Lbf;", line = 56)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "()[B", line = 87)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "()Llv;", line = 146)
