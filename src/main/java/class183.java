...
public class class183 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILjava/lang/Object;Lpe;)V", line = 5)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lco;BLjo;Ljo;Ljo;)Z", line = 33)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)V", line = 58)
