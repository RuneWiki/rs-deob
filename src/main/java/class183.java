...
public class class183 extends class384 {
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "f", descriptor = "(I)Lsg;", line = 77)
    ...
    @OriginalMember(owner = "client!ei", name = "g", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lwn;ILkc;BI)V", line = 101)
    ...
    @OriginalMember(owner = "client!ei", name = "h", descriptor = "(I)V", line = 413)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(Z)V", line = 1296)
