...
public class class183 extends class694 {
    ...
    @OriginalMember(owner = "client!oe", name = "d", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "i", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!oe", name = "e", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "()V", line = 175)
    public class183() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILjr;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)[I", line = 87)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(II)[[I", line = 190)
