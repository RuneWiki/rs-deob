...
public class class183 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ZC)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BI)Lgca;", line = 36)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 112)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 142)
