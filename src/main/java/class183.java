...
public class class183 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lec;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)Z", line = 98)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lec;IZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)Leb;", line = 213)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)Leb;", line = 279)
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(I)Z", line = 342)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ldp;B)V", line = 369)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)V", line = 380)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZJ)V", line = 396)
    ...
    @OriginalMember(owner = "client!jq", name = "d", descriptor = "(I)Z", line = 416)
