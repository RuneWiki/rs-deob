...
public abstract class class183 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lea;Lwk;ILqg;)V", line = 161)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BZ)V", line = 314)
