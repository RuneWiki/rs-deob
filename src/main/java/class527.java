...
public class class527 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIILnu;IILks;Lr;BILtq;)Lda;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZLtq;Lnp;Lmp;ILks;Lnu;Lr;IIILnf;)Lda;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILtq;II)V")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIFFFIBILgj;FF)[B")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lvv;[Ltw;)V")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILnp;IILnf;Lnu;[ILmp;IZ[Lmg;IIILtq;Lks;ILks;BLr;Lvaa;)Lda;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BIILmp;)V")
