...
public class class527 extends class522 {
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZII)V", line = 62)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(III)Lhe;", line = 92)
