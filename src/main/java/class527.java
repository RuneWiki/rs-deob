...
public class class527 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IILpu;Lpu;)V", line = 10)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIIII)I", line = 51)
