...
public class class527 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)Lia;")
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)Lia;")
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Loj;)V")
