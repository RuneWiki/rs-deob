...
public abstract class class527 extends class674 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IBZILha;ILig;)V", line = 5)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 17)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(Z)Z", line = 70)
    ...
    @OriginalMember(owner = "client!wp", name = "e", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(IIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I[Lkb;)I", line = 108)
    ...
    @OriginalMember(owner = "client!wp", name = "i", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(B)Z", line = 142)
