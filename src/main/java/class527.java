...
public class class527 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BII)V", line = 15)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/lang/String;I[BI)I", line = 31)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIB)Z", line = 94)
