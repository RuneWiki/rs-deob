...
public class class527 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I[II)Lwq;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z[II)Lwq;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II[II)Lwq;")
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(II[II)Lwq;")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lph;Lph;)V")
