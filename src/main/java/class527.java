...
public class class527 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILgba;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)Lug;", line = 114)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B[[[Lfba;)V", line = 128)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZLug;)V", line = 201)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(I)V", line = 254)
    public class527(int arg0) {
        this.field7019 = arg0;
    }

    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(IIIIII)V", line = 271)
