...
public class class527 implements class317 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIBIIILmk;III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lmt;[IJI)Ljava/lang/String;", line = 282)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)V", line = 311)
