...
public class class527 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ljava/lang/String;B)Z")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Liaa;BLqv;)Lmc;")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Liaa;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
