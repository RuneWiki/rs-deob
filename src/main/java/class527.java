...
public class class527 extends class377 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZLel;I)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZB[[I)Lvq;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZII[BILwd;II)Loq;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljm;Lwd;IBI)Loq;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;I)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZLjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZ[IIBII)Loq;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Luh;I)I")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)Liaa;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILffa;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lkv;Liaa;)Ljj;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lmk;B)I")
    ...
    @OriginalMember(owner = "client!hl", name = "d", descriptor = "(II)Lkv;")
    public final class268 method425(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BZZILpt;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILf;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljj;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "([BILwd;III)Lak;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lpt;ZII)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lkm;Lkm;FLkm;)Lkm;")
    public final class353 method341(class353 arg0, class353 arg1, float arg2, class353 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I[FLwd;IBZII)Loq;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIILuh;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lbga;I)I")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILsba;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILjagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;II)Z")
    ...
    @OriginalMember(owner = "client!hl", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Loh;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "([Ltg;I)Lf;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILdk;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/rh;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lkp;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Loh;I)V")
    ...
    @OriginalMember(owner = "client!hl", name = "g", descriptor = "(ZI)Lel;")
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(ZI)Lkga;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lpt;I)I")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lwd;Ljm;I)I")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILqo;)I")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Luh;ILkga;IIII)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lmca;B)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lwd;ILjm;)Z")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lwd;Ljm;Z)Z")
    ...
    @OriginalMember(owner = "client!hl", name = "g", descriptor = "(II)Lah;")
    ...
    @OriginalMember(owner = "client!hl", name = "r", descriptor = "()Loba;")
