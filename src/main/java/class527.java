...
public class class527 extends class42 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)F", line = 192)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "([BI)V", line = 204)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)[F", line = 209)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "([I)Lcv;", line = 622)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "([B)V", line = 683)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lci;I)Lql;", line = 736)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lci;)Z", line = 750)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "()I", line = 773)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lci;II)Lql;", line = 781)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "([B)V", line = 796)
    private class527(byte[] arg0) {
        this.method3127(arg0);
    }

    @OriginalMember(owner = "client!ql", name = "b", descriptor = "()V", line = 802)
