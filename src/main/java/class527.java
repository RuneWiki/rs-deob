...
public class class527 extends class529 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IBLtn;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IB)[I", line = 36)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(IB)V", line = 89)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIII)V", line = 114)
