...
public class class527 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "([Ljava/lang/Object;I[III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILji;)V", line = 60)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILji;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)V", line = 148)
