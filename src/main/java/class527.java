...
public class class527 extends class551 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(FI)V", line = 6)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIII)I", line = 20)
    ...
    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(I)Lkda;", line = 51)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(IIIIIF)V", line = 108)
    public class527(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!lh", name = "g", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IB)Z", line = 126)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IBII)V", line = 139)
