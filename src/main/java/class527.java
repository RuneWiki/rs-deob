...
public class class527 extends class388 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(J)V", line = 3)
    public final void method3095(long arg0) {
        this.field7792 = arg0;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqa;[Lqm;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "()V", line = 98)
    private final void method3098() {
        this.field7793 = false;
    }

    @OriginalMember(owner = "client!lr", name = "c", descriptor = "()V", line = 101)
    public final void method3099() {
        this.field7793 = true;
    }

    @OriginalMember(owner = "client!lr", name = "d", descriptor = "()Lpm;", line = 104)
    public final class411 method3100() {
        return this.field7804;
    }

    @OriginalMember(owner = "client!lr", name = "e", descriptor = "()V", line = 107)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "()V", line = 128)
    public static void method3102() {
        field7796 = null;
        field7788 = null;
    }

    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqa;J)Z", line = 136)
    ...
    @OriginalMember(owner = "client!lr", name = "g", descriptor = "()V", line = 187)
    public final void method3104() {
        this.field7800 = true;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([Lau;Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(IIIII)V", line = 281)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqa;J[Lqm;[Lau;Z)V", line = 288)
