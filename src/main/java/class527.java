...
public class class527 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(II)[I", line = 58)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IB)Lraa;", line = 119)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I[I[J)V", line = 136)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 146)
