...
public class class527 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lmda;BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lmj;Lws;Lbh;IIIII)V", line = 249)
