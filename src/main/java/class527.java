...
public class class527 extends class392 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lea;I)V")
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(ILw;)V")
    public class527(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Lw;)V")
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IZI)Luh;")
