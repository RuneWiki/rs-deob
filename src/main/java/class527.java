...
public class class527 extends class513 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILgj;ILd;Z)[F")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILgj;DZIZLd;)[I")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZ)Laba;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ld;Lgj;B)Z")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lgj;DIILd;IZ)[I")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lfca;)V")
