...
public class class527 extends class148 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(JIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(III)V", line = 50)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "()V", line = 70)
    public class527() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIILuo;)V", line = 80)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILdh;I)V", line = 223)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)[I", line = 267)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(B)V", line = 384)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIII)V", line = 436)
