...
public class class527 extends class192 implements class459 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lug;ILjaggl/memory/NativeBuffer;IZ)V", line = 21)
    public class527(class395 arg0, int arg1, NativeBuffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7775 = arg1;
    }

    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lug;I[BIZ)V", line = 58)
    public class527(class395 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7775 = arg1;
    }

    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "([BIIB)V", line = 79)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)J", line = 91)
