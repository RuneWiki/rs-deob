...
public class class527 extends class508 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lqj;IIII)Lar;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Les;I)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Les;II)V")
