...
public class class527 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IILg;)V", line = 197)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lkw;Lpr;Leo;IIIII)V", line = 543)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(II[[[Lsk;ZII)Z", line = 222)
