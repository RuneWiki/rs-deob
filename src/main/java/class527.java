...
public class class527 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Lce;", line = 3)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZZIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BII)Z", line = 94)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 109)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 142)
