...
public class class527 implements class372 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILil;IBI)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIILqv;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)Lim;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILps;I)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IILil;I)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqv;IB)V")
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lht;)V")
