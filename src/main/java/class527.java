...
public class class527 extends class379 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "([I)Laia;")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lbt;)Z")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lbt;I)Leaa;")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lbt;II)Leaa;")
