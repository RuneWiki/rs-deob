...
public class class527 extends class214 {
    ...
    @OriginalMember(owner = "client!efa", name = "d", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!efa", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(ZII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "()V", line = 43)
    public class527() {
        super(1, false);
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ILofa;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!efa", name = "c", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!efa", name = "c", descriptor = "(II)[[I", line = 212)
    ...
    @OriginalMember(owner = "client!efa", name = "e", descriptor = "(II)V", line = 264)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Lraa;I)V", line = 515)
