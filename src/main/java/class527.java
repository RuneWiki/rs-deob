...
public class class527 extends class274 {
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(B)I", line = 18)
    public final int method3131(byte arg0) {
        field7800++;
        return arg0 > -53 ? 14 : this.field7801.field490;
    }

    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)Lvg;", line = 29)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lvg;ILvg;F)Z", line = 45)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lef;I)V", line = 180)
