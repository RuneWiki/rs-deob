...
public class class527 extends class297 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIBIII[B[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lcea;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(II)[I", line = 95)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!fd", name = "d", descriptor = "(II)[[I", line = 205)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 343)
    public class527() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(Z)V", line = 348)
