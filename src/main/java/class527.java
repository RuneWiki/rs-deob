...
public class class527 extends class633 {
    ...
    @OriginalMember(owner = "client!kv", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lrf;IIII)Lba;", line = 21)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 31)
    public class527(Canvas arg0, class479 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kv", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 34)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)V", line = 118)
    public final void method1794(int arg0) {
        super.field8608[arg0].method2275((Runnable) null, true);
        ++field7292;
    }

    @OriginalMember(owner = "client!kv", name = "b", descriptor = "()V", line = 126)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "([Lba;Lq;[Lqn;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 232)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 282)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 290)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "([Lba;Lob;Lq;[Lqn;I)V", line = 368)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lpl;IIII)V", line = 388)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "(Z)V", line = 434)
    public final void method1798(boolean arg0) {
        ++field7293;
        this.field7299 = arg0;
    }

    @OriginalMember(owner = "client!kv", name = "m", descriptor = "(I)V", line = 443)
    ...
    @OriginalMember(owner = "client!kv", name = "e", descriptor = "(I)V", line = 465)
    public final void method1797(int arg0) {
        super.field8608[arg0].method2275(Thread.currentThread(), true);
        ++field7289;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIBIII)V", line = 473)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIII)V", line = 818)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(IIIIIIIIII)V", line = 901)
    ...
    @OriginalMember(owner = "client!kv", name = "G", descriptor = "()V", line = 941)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljava/lang/Runnable;)Lhi;", line = 987)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIZILbaa;IIII)V", line = 1006)
    ...
    @OriginalMember(owner = "client!kv", name = "w", descriptor = "()Z", line = 1784)
