...
public class class527 extends class455 implements class141 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BILha;Lgs;ZII)V")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lha;Luw;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lha;Z)Ltb;")
    public final class397 method397(class58 arg0, boolean arg1) {
        ++field7489;
        return arg1 ? null : this.field7494;
    }

    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(BLha;)Lvw;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lha;IZI)Z")
    ...
    @OriginalMember(owner = "client!pt", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "c", descriptor = "(BLha;)V")
