...
public class class527 {
    ...
    @OriginalMember(owner = "client!hr", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!hr", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!hr", name = "movemouse", descriptor = "(II)V")
