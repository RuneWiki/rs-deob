...
public class class527 extends class296 {
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lio;I)Lwl;", line = 17)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BII)V", line = 34)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IZILga;III)V", line = 55)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IBI)V", line = 97)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILci;Z)Z", line = 131)
