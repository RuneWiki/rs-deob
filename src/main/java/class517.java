...
public class class517 extends class297 {
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 5)
    public class517() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lcea;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!dn", name = "e", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dn", name = "f", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(II)[I", line = 79)
