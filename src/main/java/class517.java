...
public class class517 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lps;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZII)Z", line = 84)
