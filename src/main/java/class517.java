...
public class class517 {
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lbv;Lm;)V")
    public class517(class282 arg0, class373 arg1) {
        this.field7670 = arg1;
        this.field7672 = arg0;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)Lpi;")
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(II)Lwg;")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IBLjb;I)V")
