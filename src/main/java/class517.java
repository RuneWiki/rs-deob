...
public class class517 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Liv;ILcb;)V", line = 40)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IB)I", line = 56)
