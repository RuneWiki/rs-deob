...
public class class517 extends class54 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!au", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)I", line = 137)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!au", name = "d", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(ILdh;Ldh;Lgl;Lkp;IIZ)V", line = 788)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BI)[B", line = 373)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(Z)I", line = 396)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(III)Lfr;", line = 407)
    ...
    @OriginalMember(owner = "client!au", name = "e", descriptor = "(I)V", line = 620)
    ...
    @OriginalMember(owner = "client!au", name = "c", descriptor = "(B)I", line = 635)
    ...
    @OriginalMember(owner = "client!au", name = "f", descriptor = "(I)I", line = 660)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)Ljn;", line = 678)
