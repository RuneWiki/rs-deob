...
public class class517 extends class502 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lkm;)V")
    public static final void method2949(class375 arg0) {
        class677.field9437 = arg0;
    }

    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(ILeka;)V")
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(Leka;)V")
