...
public class class517 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Loa;IILq;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BLrs;)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IZLgi;ILgi;)I")
