...
public class class517 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IBIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIIILoa;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZBI)V", line = 37)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(III[BIII)Z", line = 113)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)V", line = 402)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "()V", line = 414)
    protected class517() {
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Loa;Ljr;I)V", line = 424)
