...
public class class517 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(BI)Ldm;")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Lgh;JI[I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(ILwm;Lwm;Lnw;)V")
