...
public class class517 extends class429 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(IIIZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)I", line = 44)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lbi;Lbi;Lkr;)V", line = 76)
    public class517(class449 arg0, class449 arg1, class698 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IFIIFIFI)[F", line = 93)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIZ)V", line = 174)
