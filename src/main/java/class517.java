...
public class class517 extends class176 {
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lpea;IIII[[I[[II)V", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "EA", descriptor = "(III)V", line = 65)
    ...
    @OriginalMember(owner = "client!le", name = "ba", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)V", line = 652)
    public final void method155(int arg0, int arg1) {
        ++field7120;
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIZ[[ZII)V", line = 662)
    ...
    @OriginalMember(owner = "client!le", name = "FA", descriptor = "(Lw;IIIIZ)V", line = 801)
    ...
    @OriginalMember(owner = "client!le", name = "JA", descriptor = "(II)I", line = 822)
    public final int method150(int arg0, int arg1) {
        ++field7109;
        return this.field7099[arg0][arg1];
    }

    @OriginalMember(owner = "client!le", name = "sa", descriptor = "(II)I", line = 832)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 856)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 949)
    ...
    @OriginalMember(owner = "client!le", name = "BA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 961)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZLoa;IB)Lta;", line = 1028)
    ...
    @OriginalMember(owner = "client!le", name = "aa", descriptor = "(Lw;IIIIZ)V", line = 1044)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1065)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lhj;[I)V", line = 1239)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III[[ZZ)V", line = 1252)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lw;IIIIZ)Z", line = 1261)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIILuh;)V", line = 1278)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIII)V", line = 1338)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIIII)V", line = 1363)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILoa;B)Z", line = 1464)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(IILw;)Lw;", line = 1912)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(B)V", line = 1954)
