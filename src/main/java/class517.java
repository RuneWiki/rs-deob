...
public class class517 extends class508 {
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III[[ZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(SB)V", line = 118)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!ni", name = "e", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILeo;)Ljava/lang/String;", line = 331)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lgk;Leh;Lve;[I)V", line = 354)
