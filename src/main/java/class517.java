...
public class class517 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lqa;Lic;Lic;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)V", line = 44)
