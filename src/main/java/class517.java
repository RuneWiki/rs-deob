...
public class class517 extends class440 {
    ...
    @OriginalMember(owner = "client!nda", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ILmo;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "()V", line = 73)
    public class517() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(BI)[I", line = 91)
    ...
    @OriginalMember(owner = "client!nda", name = "h", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "([BBII)Ljava/lang/String;", line = 200)
