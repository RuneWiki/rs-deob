...
public class class517 extends class305 {
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lcs;BIIIIIILha;III)V", line = 16)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(ILhb;)V", line = 91)
    public class517(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(II)V", line = 136)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(I)I", line = 152)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lhb;)V", line = 164)
    public class517(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(B)V", line = 168)
