...
public class class517 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BII)Lir;", line = 4)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lia;ZI)V", line = 43)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)Z", line = 73)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lia;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(III)I", line = 123)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLza;ZI)Lo;", line = 197)
