...
public class class517 extends class42 implements class454 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z)C", line = 30)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lci;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)J", line = 94)
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(B)V", line = 110)
