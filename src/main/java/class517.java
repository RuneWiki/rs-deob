...
public class class517 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IBIJZ)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lsl;B)V", line = 111)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)V", line = 131)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lsl;II)V", line = 178)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILsl;)Lcw;", line = 214)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 233)
