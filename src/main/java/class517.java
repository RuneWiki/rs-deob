...
public class class517 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BLwq;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ZZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILwq;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)V", line = 331)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)V", line = 345)
