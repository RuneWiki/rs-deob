...
public class class517 {
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "()V", line = 6)
    public class517() {
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lfo;)V", line = 8)
    public class517(class517 arg0) {
        this.field7365 = arg0.field7365;
        this.field7364 = arg0.field7364;
        this.field7363 = arg0.field7363;
