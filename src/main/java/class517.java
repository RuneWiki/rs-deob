...
public class class517 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILro;ZLro;)Lkd;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZLro;ILro;)Lkd;")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lgd;Lep;)V")
