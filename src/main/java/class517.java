...
public abstract class class517 implements class482 {
    ...
    @OriginalMember(owner = "client!mw", name = "c", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!mw", name = "finalize", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!mw", name = "d", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(IZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BI)Laha;", line = 79)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(B)I", line = 122)
    ...
    @OriginalMember(owner = "client!mw", name = "c", descriptor = "(I)Z", line = 135)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 184)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(II)V", line = 194)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lffa;IIIZ)V", line = 217)
