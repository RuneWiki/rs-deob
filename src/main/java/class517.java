...
public class class517 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IJLea;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IJ)Lea;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I[Lea;)I")
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(B)Lea;")
