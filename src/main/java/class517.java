...
public class class517 implements class201 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZB)V", line = 7)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)I", line = 96)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(JI)Z", line = 109)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Llaa;Ltda;)V", line = 147)
