...
public class class517 extends class512 {
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILjava/awt/Canvas;ILet;ILga;)Lya;", line = 17)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(JB)V", line = 48)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(III)V", line = 67)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lya;)V", line = 88)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(IIIIIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(III)V", line = 181)
