...
public class class517 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 8)
    public static final void method3085(int arg0) {
        class392.field5265.method2642(arg0 ^ arg0);
        field7488++;
    }

    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(I)V", line = 35)
