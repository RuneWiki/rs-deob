...
public class class517 implements class104 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lpe;I)V")
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(ILffa;Loca;IIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)Lfl;")
