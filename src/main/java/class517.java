...
public class class517 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILsi;)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lsi;IZ)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)Lmr;")
