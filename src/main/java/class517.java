...
public class class517 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)Lbc;", line = 7)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lbt;ILkda;Lkda;)V", line = 143)
