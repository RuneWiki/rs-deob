...
public class class517 extends class107 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BLjava/lang/String;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ZLso;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILso;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIZ)I", line = 100)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lso;I)Lifa;", line = 122)
