...
public class class517 extends class21 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lep;IIZ)V")
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lep;IIII)V")
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lep;II[III)V")
