...
public class class194 extends class390 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IZ)Lqn;", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)S", line = 154)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IILnq;)Lpi;", line = 195)
