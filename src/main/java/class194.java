...
public class class194 extends class438 implements class3 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(BLha;)V", line = 17)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(Lha;B)Lrga;", line = 28)
    ...
    @OriginalMember(owner = "client!qga", name = "e", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!qga", name = "f", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!qga", name = "f", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!qga", name = "g", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(B)I", line = 103)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lha;Ltk;IIIIIZIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!qga", name = "c", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IIILha;)Z", line = 157)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lha;B)Lkv;", line = 176)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)I", line = 206)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)Z", line = 218)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILha;B)Lka;", line = 231)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lha;I)V", line = 254)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILha;IZ)Lvh;", line = 283)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 314)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILha;)V", line = 325)
    ...
    @OriginalMember(owner = "client!qga", name = "c", descriptor = "(Z)V", line = 353)
