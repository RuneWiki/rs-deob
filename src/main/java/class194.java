...
public class class194 extends class348 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IZLes;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Loba;I)Z", line = 195)
