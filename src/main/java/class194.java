...
public class class194 extends class152 {
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 3)
    public class194(Object arg0, int arg1) {
        super(arg1);
        this.field2920 = arg0;
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)Z", line = 13)
    ...
    @OriginalMember(owner = "client!lp", name = "h", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIII)I", line = 41)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 59)
