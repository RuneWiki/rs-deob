...
public abstract class class194 extends class668 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILha;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "([Lvt;I)I", line = 41)
