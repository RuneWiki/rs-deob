...
public class class194 extends class264 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "([Lsf;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(BI)I", line = 42)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(ILmfa;)V", line = 57)
    public class194(int arg0, class640 arg1) {
        super(arg0, arg1);
        class782.method4287(super.field3733, 0);
    }

    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(BI)V", line = 71)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lmfa;)V", line = 99)
    public class194(class640 arg0) {
        super(arg0);
        class782.method4287(super.field3733, 0);
    }

    @OriginalMember(owner = "client!qga", name = "c", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)I", line = 131)
    ...
    @OriginalMember(owner = "client!qga", name = "d", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!qga", name = "c", descriptor = "(B)V", line = 173)
