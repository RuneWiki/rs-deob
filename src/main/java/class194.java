...
public class class194 extends class388 {
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lip;B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lip;I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 148)
