...
public class class194 extends class3 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIBII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "()Lar;", line = 22)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIIB)V", line = 41)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "()I", line = 59)
    public final int method13() {
        field2505++;
        return 0;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIZ[IILld;)V", line = 131)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IILld;)V", line = 192)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "()Lar;", line = 228)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "([III)V", line = 248)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lqa;Lrn;III)V", line = 288)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lli;)V", line = 346)
