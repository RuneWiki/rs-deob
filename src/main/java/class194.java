...
public class class194 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIBIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Laj;II)Leia;", line = 126)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lvda;B)V", line = 145)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Z)Lvda;", line = 166)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(I)V", line = 271)
    public class194(int arg0) {
        this.field2596 = arg0;
    }

    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(IIIIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 193)
