...
public class class194 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)Z", line = 8)
    public static final boolean method1312(int arg0, int arg1, int arg2) {
        field2867++;
        return arg1 != 9;
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILvp;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(I)V", line = 116)
    private class194(int arg0) {
        this.field2870 = arg0;
    }

    @OriginalMember(owner = "client!ui", name = "toString", descriptor = "()Ljava/lang/String;", line = 129)
