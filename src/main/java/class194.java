...
public class class194 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lii;Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 53)
