...
public abstract class class194 extends class626 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)Z", line = 47)
    public final boolean method1355(int arg0) {
        field2784++;
        return arg0 <= 123 ? false : false;
    }

    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!tj", name = "g", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(B)I", line = 119)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Loea;)V", line = 129)
