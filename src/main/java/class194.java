...
public class class194 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)V", line = 51)
