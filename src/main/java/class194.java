...
public class class194 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 173)
    public class194(Throwable arg0, String arg1) {
        this.field2318 = arg0;
        this.field2322 = arg1;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)I", line = 186)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(I)V", line = 198)
