...
public class class194 extends class11 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ILbi;Le;)Z")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Le;ZDIILbi;IZ)[I")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Lbi;DZILe;II)[I")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ZIIILe;Lbi;)[F")
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Leh;)V")
