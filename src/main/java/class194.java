...
public class class194 extends class601 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!ru", name = "d", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "()V", line = 30)
    public class194() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BI)[I", line = 37)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(I)[Lnha;", line = 76)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "([Ljava/lang/String;III[S)V", line = 90)
