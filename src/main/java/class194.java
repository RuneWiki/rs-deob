...
public class class194 implements Runnable {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III[B)I", line = 9)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIBIIIIILwca;III)Z", line = 49)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 483)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BI)Z", line = 507)
    ...
    @OriginalMember(owner = "client!sq", name = "run", descriptor = "()V", line = 540)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)V", line = 600)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 637)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(B)V", line = 620)
