...
public class class194 extends class457 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BJ)I", line = 4)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(I)J", line = 39)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "()V", line = 115)
    public class194() {
        this.field2515 = System.nanoTime();
        this.field2516 = System.nanoTime();
    }

    @OriginalMember(owner = "client!gp", name = "d", descriptor = "(I)J", line = 87)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)J", line = 107)
