...
public class class194 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)Lwk;")
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(B)Lwk;")
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lcja;)V")
