...
public class class194 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(I)V", line = 79)
    public class194(int arg0) {
        this.field2521 = (byte) arg0;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)V", line = 113)
