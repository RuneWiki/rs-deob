...
public class class194 extends class424 {
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZ)[[I", line = 19)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lrg;BI)V", line = 73)
    ...
    @OriginalMember(owner = "client!co", name = "g", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BII[[B[[B[ZLap;[[BIIIILaj;Lea;)V", line = 128)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "()V", line = 595)
    public class194() {
        super(3, false);
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIII)I", line = 600)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 632)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(IB)[I", line = 644)
