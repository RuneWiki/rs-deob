...
public class class194 extends class489 implements class276 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(CIIIZLea;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lh;Lba;Leu;[Lwe;[Lf;)V", line = 12)
    ...
    @OriginalMember(owner = "client!w", name = "finalize", descriptor = "()V", line = 39)
