...
public class class194 extends class513 implements class199 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ll;Ljava/awt/Canvas;)V", line = 72)
