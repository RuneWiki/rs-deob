...
public class class194 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)Ldu;", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 76)
    public class194() {
    }

    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lefa;)V", line = 97)
    public class194(class322 arg0) {
        this.field2603 = arg0;
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)Ldu;", line = 86)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)Lps;", line = 111)
