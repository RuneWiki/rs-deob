...
public abstract class class194 implements class192 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BIZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BI)Z", line = 117)
    ...
    @OriginalMember(owner = "client!ce", name = "finalize", descriptor = "()V", line = 165)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZB)V", line = 199)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Lbl;IIIZ)V", line = 247)
    ...
    @OriginalMember(owner = "client!ce", name = "d", descriptor = "(I)V", line = 226)
