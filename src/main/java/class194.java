...
public class class194 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(FLiq;Liq;I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lda;)V", line = 165)
