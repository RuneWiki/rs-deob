...
public class class194 extends class163 implements class259 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lge;I[BIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "()I", line = 21)
