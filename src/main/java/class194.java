...
public class class194 extends class184 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II[I[IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BLjava/lang/String;Lha;IIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lrg;I)Lhha;", line = 243)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(ILvg;IZ)V", line = 259)
