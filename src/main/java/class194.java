...
public class class194 implements class660 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IZ)I", line = 7)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)Lgp;", line = 158)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(I)V", line = 179)
