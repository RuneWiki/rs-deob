...
public class class194 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)Lu;", line = 8)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Ljava/lang/String;BLqs;Z)Lis;", line = 22)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I[Lec;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLsr;)V", line = 187)
