...
public class class194 extends class490 implements class276 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(CIIIZLea;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!w", name = "finalize", descriptor = "()V", line = 12)
    protected final void finalize() {
        class390.method2237(true, this);
    }

    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lh;Lba;Lgv;[Lmp;[Lf;)V", line = 15)
