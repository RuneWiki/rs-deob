...
public class class194 extends class133 {
    ...
    @OriginalMember(owner = "client!tr", name = "c", descriptor = "()Lvb;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lpe;Lco;)V")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lvb;)V")
    public final synchronized void method1110(class133 arg0) {
        this.field2499.method971(12, arg0);
    }

    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lco;)V")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "()Lvb;")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Lvb;)V")
