...
public class class194 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BLfp;)V", line = 5)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II)Lpn;", line = 429)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 465)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)V", line = 481)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 506)
