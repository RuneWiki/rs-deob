...
public abstract class class194 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)Luq;", line = 98)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIIII)V", line = 234)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)I", line = 260)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IZ)V", line = 341)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(III)V", line = 362)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(III)V", line = 385)
