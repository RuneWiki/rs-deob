...
public class class194 extends class354 {
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(ILwo;)V", line = 3)
    public class194(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!m", name = "b", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lwo;)V", line = 19)
    public class194(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!m", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!m", name = "c", descriptor = "(II)V", line = 78)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)I", line = 89)
