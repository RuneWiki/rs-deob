...
public abstract class class194 extends class43 {
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IILbg;)V", line = 65)
    public void method54(int arg0, int arg1, class242 arg2) {
        int var4 = -71 % ((arg1 - 52) / 61);
        field2280++;
    }

    @OriginalMember(owner = "client!sb", name = "d", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(III)[[I", line = 92)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(II)[I", line = 135)
    ...
    @OriginalMember(owner = "client!sb", name = "e", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(III)V", line = 156)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(III)[I", line = 179)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZIII)Lki;", line = 201)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILbg;)V", line = 267)
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "(I)V", line = 316)
    public void method280(int arg0) {
        int var2 = 13 % ((28 - arg0) / 63);
        field2281++;
    }

    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIZZZ)I", line = 351)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(IZ)V", line = 391)
    public class194(int arg0, boolean arg1) {
        this.field2278 = arg1;
        this.field2284 = new class194[arg0];
    }

    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(II)[[I", line = 404)
