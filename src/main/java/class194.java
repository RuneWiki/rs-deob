...
public class class194 extends class417 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lnq;[Lpb;B)Lsu;", line = 14)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "()V", line = 83)
    public class194() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "([FIB)[F", line = 87)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(IBI)V", line = 103)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BIII)[B", line = 121)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIB)I", line = 134)
    ...
    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIILnq;II[BZ)Lld;", line = 186)
