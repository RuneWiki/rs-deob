...
public class class194 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lie;Z)V")
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lie;)Z")
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Lie;)V")
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lsq;)V")
