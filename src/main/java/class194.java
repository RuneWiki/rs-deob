...
public class class194 extends class232 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILf;)V", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lf;B)V", line = 115)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lf;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Ltf;ZFII)V", line = 173)
    ...
    @OriginalMember(owner = "client!db", name = "e", descriptor = "(I)V", line = 197)
