...
public class class194 extends class264 {
    ...
    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(I)[F", line = 9)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "()I", line = 427)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "([B)V", line = 439)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "([I)Lua;", line = 596)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lct;II)Lbs;", line = 655)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "([B)V", line = 673)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "()V", line = 718)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lct;)Z", line = 739)
    ...
    @OriginalMember(owner = "client!bs", name = "e", descriptor = "(I)I", line = 758)
    ...
    @OriginalMember(owner = "client!bs", name = "f", descriptor = "(I)F", line = 786)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "([BI)V", line = 797)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "([B)V", line = 803)
