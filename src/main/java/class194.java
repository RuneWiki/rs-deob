...
public class class194 extends class337 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lul;I)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lqa;I)Lpj;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Ljava/lang/Object;ILhu;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lqa;II)Z")
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lqv;BLqa;IZII)V")
    ...
    @OriginalMember(owner = "client!rk", name = "n", descriptor = "(I)V")
