...
public class class194 extends class190 {
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Ljj;)V", line = 3)
    public class194(class66 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILaba;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Loh;IZII)V", line = 76)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(III)V", line = 202)
