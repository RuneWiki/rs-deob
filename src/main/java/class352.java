...
public abstract class class352 extends class331 {
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "()V", line = 36)
