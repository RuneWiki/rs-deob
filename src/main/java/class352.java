...
public class class352 implements class381 {
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!b", name = "d", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ljava/lang/Object;BLjava/lang/Class;Ljava/lang/String;)I", line = 57)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ZI)V", line = 87)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)I", line = 277)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BI)I", line = 288)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)I", line = 303)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", line = 318)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Object;Ljava/lang/Class;)Z", line = 336)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)V", line = 358)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)I", line = 369)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(JI)Z", line = 381)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(B)V", line = 410)
