...
public abstract class class352 extends class251 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIILin;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lah;I)V", line = 51)
    public class352(class250 arg0, int arg1) {
        this.field5180 = arg0;
        this.field5176 = arg1;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIIIIIII)V", line = 87)
