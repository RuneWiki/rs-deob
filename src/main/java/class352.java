...
public class class352 extends class293 {
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lsq;II)V")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lsq;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lsq;IIZ[[BI)V")
