...
public class class352 extends class241 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lpe;B)Lca;")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IILpe;I)Z")
