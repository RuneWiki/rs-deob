...
public class class352 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(CI)Z", line = 31)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)Lct;", line = 76)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IBILto;I)V", line = 131)
