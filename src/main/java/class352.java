...
public class class352 extends class390 {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "()V", line = 10)
    public class352() {
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IILms;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(S)V", line = 79)
