...
public class class352 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(B)[I", line = 21)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ZB)V", line = 33)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lgca;)V", line = 259)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IILd;IILha;I)V", line = 104)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)Z", line = 185)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 314)
