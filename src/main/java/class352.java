...
public abstract class class352 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIII)I", line = 18)
    ...
    @OriginalMember(owner = "client!hm", name = "d", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(IIII)V", line = 80)
