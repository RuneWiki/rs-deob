...
public class class352 extends class168 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(B)V", line = 42)
