...
public class class352 extends class728 {
    ...
    @OriginalMember(owner = "client!st", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 6)
    public final Object method828(byte arg0) {
        return arg0 > -105 ? (Object) null : this.field4290.get();
    }

    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lofa;Ljava/lang/Object;I)V", line = 15)
    public class352(class320 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field4290 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)Z", line = 24)
