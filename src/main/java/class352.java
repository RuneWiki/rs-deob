...
public class class352 extends class252 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(I)Lpk;")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II[[[Lls;IIZ)Z")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lpl;Lls;)V")
