...
public class class352 extends class616 implements class211 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILqp;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lpq;ILjaclib/memory/Buffer;IZ)V")
    public class352(class194 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field5109 = arg1;
    }

    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lpq;I[BIZ)V")
