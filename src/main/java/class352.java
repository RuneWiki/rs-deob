...
public class class352 extends class667 {
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "()V", line = 67)
    public class352() {
        super(1, true);
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIB)V", line = 70)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lud;II)V", line = 84)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(I)V", line = 124)
