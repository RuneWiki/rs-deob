...
public class class352 implements class121 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Lqv;", line = 6)
    public class406 method484(int arg0) {
        field4606++;
        return arg0 == 16236 ? null : null;
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(ZLoa;)V", line = 18)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lida;Lce;IIIII)V", line = 88)
