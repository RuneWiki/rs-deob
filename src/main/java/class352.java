...
public class class352 extends class45 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(JLya;I)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILkj;Z)V")
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lfd;Lm;)V")
