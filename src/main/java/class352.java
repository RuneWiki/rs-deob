...
public abstract class class352 {
    ...
    @OriginalMember(owner = "client!is", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!is", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "([BII)V", line = 49)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIII)I", line = 74)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lnq;I[BIZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lnq;ILjaggl/memory/NativeBuffer;IZ)V", line = 134)
