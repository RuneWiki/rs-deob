...
public class class352 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;I[Lha;)I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;[Lha;IZ)I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;[Lha;ZI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "([Lha;IILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B[Lha;[Ljava/lang/String;[ILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;[Lha;III)I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILlp;Lgw;I)V")
