...
public class class352 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZI)Lvf;", line = 18)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIBILqp;I)Lhg;", line = 72)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILlf;)V", line = 140)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 152)
