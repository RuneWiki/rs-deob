...
public class class352 extends class115 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B[B[ILfg;)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 135)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "()V", line = 193)
    public class352() {
    }

    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "([B)V", line = 195)
