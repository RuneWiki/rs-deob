...
public class class352 extends class395 implements class722 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lha;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bo", name = "q", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lha;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BLha;ZILuq;II)V", line = 45)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILha;IB)Z", line = 56)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(I)I", line = 82)
    public final int method794(int arg0) {
        ++field5068;
        return arg0 < 92 ? -6 : this.field5081.field9889;
    }

    @OriginalMember(owner = "client!bo", name = "l", descriptor = "(I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!bo", name = "m", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ZLha;)V", line = 116)
    ...
    @OriginalMember(owner = "client!bo", name = "n", descriptor = "(I)I", line = 137)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lha;Lts;IIIIIZIIIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(Lha;B)Liha;", line = 157)
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lkea;Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)I", line = 190)
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(B)I", line = 201)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lha;I)Lua;", line = 213)
    ...
    @OriginalMember(owner = "client!bo", name = "h", descriptor = "(I)Z", line = 260)
    public final boolean method783(int arg0) {
        ++field5073;
        return arg0 != 0;
    }

    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)I", line = 272)
    ...
    @OriginalMember(owner = "client!bo", name = "d", descriptor = "(I)Z", line = 326)
    public final boolean method781(int arg0) {
        ++field5091;
        return arg0 >= -86 ? false : this.field5081.method3977((byte) -86);
    }

    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(B)Z", line = 345)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(III)Z", line = 358)
