...
public class class352 implements Runnable {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/String;B)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILjava/net/URL;)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BLjava/lang/Class;)Lam;")
    public final class449 method2188(byte arg0, Class arg1) {
        return arg0 == 41 ? this.method2193(0, arg1, 11, 0, 0) : null;
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLjava/awt/datatransfer/Transferable;)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILjava/lang/Object;III)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/String;ZI)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILjava/lang/Runnable;)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILjava/lang/String;I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;Z)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/String;I)Lam;")
    public final class449 method2201(String arg0, int arg1) {
        int var3 = -5 % ((4 - arg1) / 52);
        return this.method2193(0, arg0, 16, 0, 0);
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/awt/Point;[IIBLjava/awt/Component;I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(Ljava/lang/Class;I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/awt/Frame;I)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIILjava/lang/Object;)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BIIII)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIILjava/awt/Component;)Lam;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Z)Lfa;")
