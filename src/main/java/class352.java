...
public class class352 extends class311 {
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(II)Z", line = 10)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lea;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)V", line = 135)
