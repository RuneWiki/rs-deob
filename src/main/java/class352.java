...
public class class352 extends class203 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)Lhda;", line = 8)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lee;Lhaa;IIIIIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lha;B)V", line = 32)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(CI)Z", line = 49)
