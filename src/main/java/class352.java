...
public class class352 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I[Lnd;)I")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)Lnd;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLnd;J)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)Lnd;")
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)Lnd;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IJ)Lnd;")
