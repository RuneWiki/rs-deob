...
public class class352 extends class338 implements class226 {
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lha;ZZI)Liu;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BILha;)Lka;")
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ZLol;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
