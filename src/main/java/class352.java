...
public class class352 extends class370 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILee;)Lab;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
    ...
    @OriginalMember(owner = "client!sc", name = "d", descriptor = "(B)Luw;")
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
