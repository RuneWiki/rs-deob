...
public class class352 {
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "()V", line = 3)
    public static void method2814() {
        field5098 = null;
        field5104 = null;
    }

    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(IIF)F", line = 11)
    ...
    @OriginalMember(owner = "client!lka", name = "b", descriptor = "(IIF)F", line = 26)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(Ljc;Lhk;)V", line = 36)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(IF)I", line = 104)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(F)F", line = 170)
