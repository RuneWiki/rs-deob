...
public class class352 extends class512 {
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZILia;)V", line = 15)
    ...
    @OriginalMember(owner = "client!uf", name = "e", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!uf", name = "f", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BII)V", line = 67)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(II)[[I", line = 92)
