...
public class class352 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lks;Lkd;III)V", line = 51)
