...
public class class352 extends class101 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lct;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)Lct;", line = 34)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lwia;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IID)Lct;", line = 68)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "([III)V", line = 130)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Z)D", line = 196)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "()Lsd;", line = 217)
    public final class101 method191() {
        field4939++;
        return null;
    }

    @OriginalMember(owner = "client!b", name = "c", descriptor = "(B)I", line = 227)
    public static final int method2231(byte arg0) {
        field4931++;
        return arg0 <= 14 ? -79 : class250.field3696++;
    }

    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!b", name = "d", descriptor = "()Lsd;", line = 251)
    public final class101 method176() {
        field4950++;
        return null;
    }

    @OriginalMember(owner = "client!b", name = "d", descriptor = "(B)V", line = 261)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "()I", line = 282)
    public final int method210() {
        field4938++;
        return 1;
    }

    @OriginalMember(owner = "client!b", name = "b", descriptor = "(Z)V", line = 290)
    public final synchronized void method2234(boolean arg0) {
        this.field4947 = arg0;
        field4926++;
    }

    @OriginalMember(owner = "client!b", name = "d", descriptor = "(I)V", line = 298)
    public static final void method2235(int arg0) {
        class730.field10110 = arg0;
    }

    @OriginalMember(owner = "client!b", name = "c", descriptor = "(Z)I", line = 301)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BI)V", line = 313)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III)V", line = 327)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(I)V", line = 359)
