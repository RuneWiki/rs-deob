...
public class class352 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Ljm;Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!rb", name = "toString", descriptor = "()Ljava/lang/String;", line = 80)
