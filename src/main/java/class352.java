...
public abstract class class352 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILrs;IIBZIIILrs;[I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lrs;IIILrs;I[ZIZLrs;Lrs;IZII)V", line = 54)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II)I", line = 117)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I[IBII[IIZII)V", line = 129)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[ZLqb;ZI[ILqb;ILod;ZI)V", line = 230)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIZIILrs;IILrs;)V", line = 435)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIIIIIILd;)V", line = 478)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILrs;Z)V", line = 627)
