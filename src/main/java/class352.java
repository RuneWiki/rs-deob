...
public class class352 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIII[IIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IILco;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IFIIZIII)[I", line = 206)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILco;I)V", line = 235)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIZ)Ljava/lang/String;", line = 257)
