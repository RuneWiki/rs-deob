...
public class class352 extends class377 implements class130 {
    ...
    @OriginalMember(owner = "client!xa", name = "c", descriptor = "()Z", line = 7)
    public final boolean method1619() {
        return true;
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "()[Lsd;", line = 10)
    public final class63[] method1579() {
        return this.field5058;
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(ILc;)V", line = 24)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(IIII)V", line = 78)
    public final void method1578(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!xa", name = "b", descriptor = "()V", line = 80)
    public final void method1587() {
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Le;IIIZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lwp;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(IILc;Z)Z", line = 111)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(BIZ)Le;", line = 122)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lwp;I)V", line = 128)
    ...
    @OriginalMember(owner = "client!xa", name = "finalize", descriptor = "()V", line = 147)
    ...
    @OriginalMember(owner = "client!xa", name = "d", descriptor = "()[Lck;", line = 157)
    public final class462[] method1593() {
        return this.field5056;
    }

    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;Lg;Lld;IIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;)V", line = 231)
