...
public class class352 extends OutputStream {
    ...
    @OriginalMember(owner = "client!lg", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field5023++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 23)
    public static void method2232(int arg0) {
        int var1 = 62 / ((-arg0 - 23) / 48);
        field5024 = null;
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BII)V", line = 32)
