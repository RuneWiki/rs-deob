...
public class class689 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IZLjava/awt/Component;)Lsfa;", line = 11)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 28)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(B)V", line = 40)
