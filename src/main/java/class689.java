...
public class class689 extends class583 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIII)[B", line = 19)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IBI)V", line = 36)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 53)
    public class689() {
