...
public class class689 extends class571 {
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(IIII)[B", line = 5)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "()V", line = 37)
    public class689() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(FLss;IIFIIIFIFF[B)V", line = 55)
