...
public class class689 implements Runnable {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Ljq;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILvp;I)Lg;", line = 98)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILvp;[BI)Lg;", line = 153)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IB)[[[B", line = 187)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IILvp;)Lg;", line = 969)
    ...
    @OriginalMember(owner = "client!qc", name = "run", descriptor = "()V", line = 994)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZLg;)V", line = 1040)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lwd;)V", line = 1067)
