...
public class class689 extends class32 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IIII)Lva;", line = 8)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(II[BIIIII[B)V", line = 69)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IILoa;I)Z", line = 243)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(III)Z", line = 286)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Loa;B)Lac;", line = 300)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "([[BILop;)V", line = 311)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ILoa;)Lwc;", line = 343)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ZLoa;)V", line = 386)
