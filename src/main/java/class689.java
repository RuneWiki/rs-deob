...
public class class689 extends class258 {
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Lk;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(BZI)Lpi;", line = 25)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Lim;B)V", line = 65)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ILwm;)V", line = 84)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IIII[B[BIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(BLmc;)V", line = 153)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I)V", line = 172)
