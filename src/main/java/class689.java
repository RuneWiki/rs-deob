...
public class class689 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IZ[I[II)V", line = 9)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)Z", line = 66)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)V", line = 77)
    public static void method3883(byte arg0) {
        int var1 = 4 % ((-arg0 - 34) / 58);
        field9830 = null;
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lhd;I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "()V", line = 184)
    public class689() {
        this.field9818 = -50;
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lac;)V", line = 200)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lac;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIII[B[BIII)V", line = 129)
