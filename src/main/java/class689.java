...
public class class689 extends class734 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILka;III)Lhw;")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILcea;)Lhc;")
    ...
    @OriginalMember(owner = "client!jm", name = "d", descriptor = "(I)Liha;")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
