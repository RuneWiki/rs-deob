...
public class class689 extends class665 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)I", line = 55)
