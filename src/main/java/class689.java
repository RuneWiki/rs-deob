...
public class class689 extends class165 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Ljava/lang/String;Lep;BI)Lee;")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lep;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IZLhl;)V")
