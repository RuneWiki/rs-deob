...
public class class689 extends class517 {
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lffa;IIIII)V")
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lffa;IIII)V")
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lffa;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lffa;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lffa;IIIIZ[IIIZ)V")
