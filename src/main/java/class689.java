...
public class class689 {
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(ILha;IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(ILfca;)V", line = 29)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(BILfca;)V", line = 69)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IIIZ)V", line = 102)
