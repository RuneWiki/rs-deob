...
public class class689 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILww;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZB)V", line = 98)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Z)V", line = 168)
