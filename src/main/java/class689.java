...
public class class689 extends class529 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(IB)[I", line = 107)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(CZ)Z", line = 128)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 151)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(II)Ljava/lang/String;", line = 178)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "()V", line = 192)
    public class689() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!bg", name = "e", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IB)[I", line = 234)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IBLtn;)V", line = 277)
    ...
    @OriginalMember(owner = "client!bg", name = "f", descriptor = "(I)V", line = 313)
