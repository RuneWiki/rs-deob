...
public class class689 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lee;B)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BILee;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)Lie;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(JB)V")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)Lie;")
