...
public class class689 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IB)V", line = 71)
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IZ)Lui;", line = 114)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IBI)V", line = 148)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lcr;ILla;Lla;)V", line = 170)
