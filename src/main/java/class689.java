...
public class class689 extends class498 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "()V", line = 4)
    public static void method3880() {
        field9586 = null;
        field9582 = null;
    }

    @OriginalMember(owner = "client!nha", name = "b", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;J[Lmv;[Lnba;Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!nha", name = "c", descriptor = "()V", line = 56)
    public final void method3883() {
        this.field9595 = true;
    }

    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IZ)Lnha;", line = 59)
    ...
    @OriginalMember(owner = "client!nha", name = "d", descriptor = "()Lik;", line = 72)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(J)V", line = 91)
    public final void method3886(long arg0) {
        this.field9587 = arg0;
    }

    @OriginalMember(owner = "client!nha", name = "e", descriptor = "()V", line = 94)
    private final void method3887() {
        this.field9581 = false;
    }

    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(IZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;[Lmv;Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class689(int arg0, boolean arg1) {
        this.method3888(arg0, arg1);
    }

    @OriginalMember(owner = "client!nha", name = "a", descriptor = "([Lnba;Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!nha", name = "f", descriptor = "()V", line = 278)
    public final void method3891() {
        this.field9581 = true;
    }

    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIII)V", line = 285)
    public final void method3892(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field9596 = arg0;
    }

    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;J)Z", line = 299)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;)V", line = 347)
    ...
    @OriginalMember(owner = "client!nha", name = "g", descriptor = "()Lik;", line = 359)
