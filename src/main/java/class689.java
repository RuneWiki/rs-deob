...
public class class689 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Z)V", line = 343)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIZBILbt;J)V", line = 354)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(III)Z", line = 367)
