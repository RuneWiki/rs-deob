...
public class class689 extends class147 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIZI[Luf;IIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lhi;B)V", line = 872)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lol;I)V", line = 882)
