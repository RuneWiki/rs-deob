...
public class class410 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ZIZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 325)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)Lca;", line = 339)
