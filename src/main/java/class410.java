...
public class class410 implements class233 {
    ...
    @OriginalMember(owner = "client!ml", name = "toString", descriptor = "()Ljava/lang/String;", line = 17)
    public final String toString() {
        field5908++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)I", line = 34)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 51)
