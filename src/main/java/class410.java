...
public class class410 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIBII[Lkp;II)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lfn;IIII)V")
