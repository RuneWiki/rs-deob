...
public class class410 extends class175 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lvm;Lai;IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lam;ILam;Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(II[I[I)V", line = 159)
