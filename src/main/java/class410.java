...
public class class410 extends class456 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "h", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IBLre;)V", line = 116)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(II)[I", line = 156)
    ...
    @OriginalMember(owner = "client!nl", name = "i", descriptor = "(I)Llk;", line = 217)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "()V", line = 278)
    public class410() {
        super(3, false);
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BI)V", line = 249)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z)V", line = 265)
