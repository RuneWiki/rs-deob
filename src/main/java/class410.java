...
public class class410 extends InputStream {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "read", descriptor = "()I", line = 23)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IB)I", line = 33)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(I)V", line = 65)
