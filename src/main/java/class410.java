...
public class class410 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!wl", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
    public final String toString() {
        field6173++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lbh;B)Z", line = 44)
