...
public class class410 implements class707 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)Llj;", line = 4)
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lwia;Ljava/lang/String;)V", line = 50)
    public class410(class791 arg0, String arg1) {
        this.field5567 = arg0;
        this.field5565 = arg1;
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)V", line = 63)
