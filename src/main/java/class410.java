...
public class class410 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IZZBLha;)Lka;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILka;BIZIILha;Luha;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lha;Lkha;IIIILig;ZI)V")
