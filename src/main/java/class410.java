...
public class class410 extends class362 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljb;Z)V")
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(III)Les;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILcea;)Lum;")
