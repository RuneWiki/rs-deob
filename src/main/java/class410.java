...
public class class410 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Z)Lut;")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BLiaa;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ljo;)V")
    public class410(class303 arg0) {
        this.field5441 = arg0;
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lmc;I)Lwu;")
