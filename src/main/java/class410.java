...
public class class410 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIZLid;Lid;)Lme;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BLid;Lid;I)Lme;")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lrt;Lih;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
