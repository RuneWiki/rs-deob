...
public class class410 extends class259 implements class401 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILya;I)Lt;", line = 33)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)I", line = 44)
    public final int method223(int arg0) {
        ++field6175;
        return arg0 != -19634 ? 45 : this.field6179;
    }

    @OriginalMember(owner = "client!f", name = "f", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(B)I", line = 89)
    public final int method222(byte arg0) {
        ++field6183;
        return arg0 > -99 ? 49 : 22;
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILya;II)Z", line = 100)
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLya;)V", line = 140)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(Lya;I)Lmo;", line = 169)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IZLya;I)Lro;", line = 212)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BILya;)Lt;", line = 242)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Lya;Lpf;IIIIZIZ)V", line = 270)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(I)I", line = 311)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lya;B)V", line = 327)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lya;I)V", line = 353)
