...
public class class410 implements class299 {
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IJ)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZB)V", line = 32)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lcca;Lpfa;)V", line = 147)
