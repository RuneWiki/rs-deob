...
public class class410 extends class34 {
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(III)V", line = 28)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZZ)Z", line = 52)
    public static boolean method2629(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([J[Ljava/lang/Object;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([IIIJ)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(III)V", line = 106)
