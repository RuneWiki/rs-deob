...
public class class410 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILkk;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IILkk;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BLae;)V")
