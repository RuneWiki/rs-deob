...
public class class410 extends class86 {
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLlr;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjava/lang/String;)I", line = 118)
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILuu;)V", line = 178)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lnq;Lhl;)V", line = 219)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZB)V", line = 230)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IBI)V", line = 243)
