...
public abstract class class410 extends class696 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIZ[Lpk;)I", line = 10)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLwga;)I", line = 50)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!mb", name = "h", descriptor = "(I)I", line = 107)
