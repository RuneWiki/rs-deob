...
public class class410 extends class227 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lug;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IZ)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!iu", name = "j", descriptor = "(I)V", line = 137)
