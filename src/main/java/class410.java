...
public class class410 {
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lmw;I)I", line = 41)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lr;IIIIIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(I[Lju;IIII)V", line = 298)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lr;BI)Z", line = 166)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IZ[BLjava/lang/String;)I", line = 257)
