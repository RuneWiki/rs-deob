...
public class class410 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)Lbk;")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILbk;)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)Lbk;")
    ...
    @OriginalMember(owner = "client!ht", name = "d", descriptor = "(I)Lbk;")
    ...
    @OriginalMember(owner = "client!ht", name = "f", descriptor = "(I)Lbk;")
