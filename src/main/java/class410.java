...
public class class410 extends class262 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILoa;B)V", line = 15)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!bn", name = "h", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IZ)V", line = 112)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Ldda;Ljn;Lvt;)V", line = 127)
