...
public class class410 extends class3 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILl;Lza;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lsv;Z)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III)Ltk;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)Llf;")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(ILro;Lro;Lgd;Lep;IIZ)V")
