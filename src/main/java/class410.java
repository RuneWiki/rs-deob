...
public class class410 extends class339 {
    ...
    @OriginalMember(owner = "client!mt", name = "fa", descriptor = "(IILr;)Lr;", line = 3)
    ...
    @OriginalMember(owner = "client!mt", name = "ka", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIIIII[[Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 218)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(III[[ZZII)V", line = 301)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lwh;[I)V", line = 309)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(III[[ZZI)V", line = 322)
    ...
    @OriginalMember(owner = "client!mt", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 331)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lkw;IIII[[I[[II)V", line = 414)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 472)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)V", line = 491)
    public final void method33(int arg0, int arg1) {
        ++field5831;
    }

    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 498)
    ...
    @OriginalMember(owner = "client!mt", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 541)
    ...
    @OriginalMember(owner = "client!mt", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 567)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILeh;II)V", line = 594)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "([[ZIZIIIII)V", line = 654)
    ...
    @OriginalMember(owner = "client!mt", name = "YA", descriptor = "()V", line = 798)
