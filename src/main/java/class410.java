...
public class class410 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)Lge;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)Lge;")
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Ldj;)V")
