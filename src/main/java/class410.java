...
public class class410 extends class333 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIIIIIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "([BLjea;[IB)Z", line = 655)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 712)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III)I", line = 730)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "()V", line = 754)
    public class410() {
    }

    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "([B)V", line = 756)
