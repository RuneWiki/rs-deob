...
public class class410 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ljava/lang/String;Lad;BI)Lni;", line = 61)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lw;III)Z", line = 103)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIII[[ZZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(I)V", line = 392)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BLkr;)V", line = 411)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILw;II)V", line = 484)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Lw;III)V", line = 554)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lad;Lpf;)V", line = 630)
