...
public class class410 extends class238 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lha;Z)Lqda;")
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
