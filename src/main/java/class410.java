...
public class class410 extends class220 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(CIIIZLrn;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([B[I[IIIIIIIIIIILrn;II)V", line = 71)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([B[I[IIIIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([B[IIIIIIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(CIIIZ)V", line = 275)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Ljn;Lbs;[Lhb;[I[I)V", line = 337)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([B[IIIIIIIIIIILrn;II)V", line = 361)
