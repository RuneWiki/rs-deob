...
public class class410 extends class86 {
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(I)V", line = 113)
    public class410(int arg0) {
        this.field6017 = arg0;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILqn;ILjava/lang/String;)Lit;", line = 34)
