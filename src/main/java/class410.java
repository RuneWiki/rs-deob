...
public class class410 extends class514 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II[ILgt;II)V")
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "()Lft;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lgt;BI)V")
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "()Lft;")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lcc;)V")
