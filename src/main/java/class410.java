...
public class class410 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLjf;Len;)V", line = 10)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 35)
