...
public class class410 extends class418 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(III)V", line = 6)
    public final void method1301(int arg0, int arg1, int arg2) {
        int var4 = 50 % ((-67 - arg0) / 57);
        ++field6206;
    }

    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BII)V", line = 17)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BLjava/lang/String;)J", line = 32)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 109)
