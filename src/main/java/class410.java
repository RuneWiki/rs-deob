...
public class class410 extends class393 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 543)
    public class410(String arg0) {
        this.field6137 = arg0;
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(BLjava/lang/String;)I", line = 66)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([Ljava/lang/Object;[JIBI)V", line = 81)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lnr;II)Z", line = 136)
