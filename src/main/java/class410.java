...
public class class410 extends class266 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(JIILet;IIZILpa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IIILlk;IIIILr;BIIIILqa;)Lr;", line = 58)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "()V", line = 276)
    public class410() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BBI)V", line = 284)
    ...
    @OriginalMember(owner = "client!lda", name = "d", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(IIII)[B", line = 312)
