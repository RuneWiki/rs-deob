...
public class class410 extends class581 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(II)Z", line = 8)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "()I", line = 27)
    public final int method49() {
        field5693++;
        return 0;
    }

    @OriginalMember(owner = "client!qba", name = "b", descriptor = "()Lgu;", line = 38)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "([III)V", line = 71)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(BILlv;)V", line = 144)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lft;)V", line = 272)
    public class410(class3 arg0) {
        this.field5692 = arg0;
    }

    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ILlv;BII[I)V", line = 187)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "()Lgu;", line = 250)
