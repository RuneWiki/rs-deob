...
public class class410 extends class446 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lms;B)Lms;")
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(II)Laf;")
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lka;)V")
