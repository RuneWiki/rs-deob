...
public class class410 extends class518 {
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 25)
    public class410() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bj", name = "f", descriptor = "(I)V", line = 30)
