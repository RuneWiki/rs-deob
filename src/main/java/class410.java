...
public class class410 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILfh;)V")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILum;)V")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BILfh;)V")
