...
public class class410 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lat;)V", line = 23)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(Lat;)V", line = 39)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 47)
    public class410() {
        this.field5888[0] = 0;
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "()V", line = 57)
