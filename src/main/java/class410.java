...
public class class410 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lij;Lij;Lij;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IZLea;)V", line = 55)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 338)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 352)
