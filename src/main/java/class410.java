...
public class class410 extends class134 implements class426 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)C", line = 18)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)J", line = 47)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)I", line = 60)
    public final int method2517(int arg0) {
        field5601++;
        return arg0 <= 82 ? 41 : this.field5603;
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Z)I", line = 73)
