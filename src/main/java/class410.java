...
public class class410 extends InputStream {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)Z", line = 4)
    public static final boolean method2404(int arg0) {
        field5686++;
        return ~class221.field3118 == arg0 ? class67.field1000 : true;
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!cn", name = "read", descriptor = "()I", line = 44)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)V", line = 54)
