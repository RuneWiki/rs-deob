...
public class class410 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([Lcaa;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I[Lg;Luca;)Lnba;", line = 88)
