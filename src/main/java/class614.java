...
public class class614 extends class641 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(III)Lcm;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IILgk;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)Lgr;")
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(ILnr;Lnr;Loaa;Ljq;I[BIZ)V")
