...
public class class614 extends class173 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IILjava/lang/String;)Ljm;", line = 18)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!rha", name = "c", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!rha", name = "b", descriptor = "(I)J", line = 67)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 81)
    ...
    @OriginalMember(owner = "client!rha", name = "e", descriptor = "(I)J", line = 181)
    ...
    @OriginalMember(owner = "client!rha", name = "f", descriptor = "(I)I", line = 193)
    ...
    @OriginalMember(owner = "client!rha", name = "<init>", descriptor = "(IJ)V", line = 203)
