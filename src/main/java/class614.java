...
public class class614 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BI)V", line = 188)
