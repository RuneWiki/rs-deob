...
public class class614 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IZILjn;)J", line = 19)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I[FIIIII)V", line = 53)
