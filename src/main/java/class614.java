...
public class class614 extends class190 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZI[F)[F", line = 23)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILnba;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZBZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIB)V", line = 115)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lrs;Lah;)V", line = 153)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BI)V", line = 197)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)Z", line = 212)
