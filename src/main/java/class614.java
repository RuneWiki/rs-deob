...
public class class614 {
    ...
    @OriginalMember(owner = "client!rda", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(III)I", line = 29)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lr;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(I)V", line = 269)
    public static void method3575(int arg0) {
        int var1 = 110 % (arg0 / 47);
        field8723 = null;
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 278)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BC)Z", line = 304)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II)V", line = 315)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(IZ)V", line = 426)
    public class614(int arg0, boolean arg1) {
        this.field8720 = arg0;
        this.field8716 = arg1;
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BI)I", line = 333)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILjava/lang/String;)V", line = 361)
    public final void method3580(int arg0, String arg1) {
        field8718++;
        this.method3583(this.field8724 - arg0, arg1, true);
    }

    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(II)Z", line = 370)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(I)[Ljava/lang/String;", line = 389)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 404)
