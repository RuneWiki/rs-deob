...
public class class614 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIILqa;IZLqa;ZLra;BLrs;I)Lha;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILrs;Lqa;IIIZI)Lha;")
    ...
    @OriginalMember(owner = "client!jn", name = "d", descriptor = "(Z)Ljj;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BI)Lmh;")
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lbt;IZLgb;Lkda;Lkda;)V")
