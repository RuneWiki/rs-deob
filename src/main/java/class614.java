...
public class class614 extends class546 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lr;IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(ZI)I", line = 64)
