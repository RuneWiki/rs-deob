...
public class class614 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(B)Lega;", line = 3)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lbd;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(JJ)J", line = 75)
    public static long method3458(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(II)Lcia;", line = 91)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILjava/lang/String;)I", line = 102)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IIIIIIB)I", line = 202)
    ...
    @OriginalMember(owner = "client!cia", name = "<init>", descriptor = "(II)V", line = 231)
