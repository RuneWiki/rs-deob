...
public class class614 extends class219 {
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 214)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "([IIII)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II[IIZ)Z", line = 85)
    ...
    @OriginalMember(owner = "client!ot", name = "d", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BII[I)Z", line = 182)
