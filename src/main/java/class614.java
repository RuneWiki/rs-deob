...
public class class614 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(ILvfa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(ZB)Z", line = 20)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lfca;III)V", line = 57)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(I)Lvfa;", line = 91)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(I)V", line = 108)
    public class614(int arg0) {
        this.field8385 = arg0;
    }

    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(IIIIII)V", line = 115)
