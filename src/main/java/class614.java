...
public class class614 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Z)Lte;")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BLte;)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)Lte;")
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(B)Lte;")
    ...
    @OriginalMember(owner = "client!eba", name = "c", descriptor = "(B)Lte;")
