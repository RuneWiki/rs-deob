...
public class class614 {
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lr;[II)V", line = 87)
    public static final void method3380(class566 arg0, int[] arg1, int arg2) {
        method3384(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lr;[II[I[I)V", line = 90)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()V", line = 171)
    public static void method3383() {
        field8625 = null;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lr;[IIII[I[I)V", line = 178)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "([III)V", line = 268)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "()V", line = 317)
