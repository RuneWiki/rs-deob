...
public class class614 implements class162 {
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(II)Llm;", line = 17)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(FIZIIZ)[I", line = 61)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)Z", line = 75)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lod;IIIIIIIIILha;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(III)Z", line = 167)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIFIBZ)[I", line = 180)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)I", line = 193)
    public final int method1271(byte arg0) {
        field8557++;
        return arg0 == 63 ? this.field8552 : 64;
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IZ)Ltr;", line = 205)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IBZIFI)[F", line = 226)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIILjava/lang/Class;)Lfe;", line = 238)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lgj;Lgj;Lgj;)V", line = 269)
