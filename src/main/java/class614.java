...
public class class614 {
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(BI)Lqv;")
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lre;ILdn;)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILlk;ZIIZI)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
