...
public class class614 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILd;IILha;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILkn;)I", line = 96)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(III)Z", line = 288)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(II)Lci;", line = 303)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(FIFFFFFI)F", line = 337)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lms;ILwu;)V", line = 403)
