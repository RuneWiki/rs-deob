...
public class class614 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Loa;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Loa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Loa;[II)V")
