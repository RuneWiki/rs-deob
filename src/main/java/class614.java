...
public abstract class class614 extends class168 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "([BZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IIIILhe;)Z", line = 109)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(BIILria;)V", line = 238)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(BIIIIIIIII)V", line = 265)
