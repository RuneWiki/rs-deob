...
public class class614 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lwk;B)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IIZIIIILwca;III)Z")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILw;II)Z")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IBLw;I)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(BILw;I)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lji;Lwo;)V")
