...
public class class614 extends class756 {
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Laj;Laj;Lfl;)V", line = 16)
    public class614(class333 arg0, class333 arg1, class770 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IZIII)V", line = 24)
