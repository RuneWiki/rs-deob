...
public class class614 extends class56 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILha;IZIII)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IZ)[I")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V")
