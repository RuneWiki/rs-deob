...
public class class614 extends class530 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lhg;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IB)Leia;", line = 158)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)V", line = 471)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)I", line = 482)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IZII)Z", line = 493)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)I", line = 539)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(Z)Z", line = 550)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lah;)V", line = 567)
    public class614(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(II)V", line = 572)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(ILah;)V", line = 586)
    public class614(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)I", line = 600)
