...
public class class176 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIILfha;)V", line = 11)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(IIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)Z", line = 58)
    ...
    @OriginalMember(owner = "client!uh", name = "toString", descriptor = "()Ljava/lang/String;", line = 70)
