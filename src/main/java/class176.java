...
public class class176 extends class335 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BFLna;IZ)V")
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZLfl;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lfl;B)V")
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)[Lef;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILfl;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILpe;)V")
