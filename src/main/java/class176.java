...
public class class176 extends class626 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Lwga;", line = 10)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)I", line = 38)
    public static final int method1279(int arg0) {
        field2553++;
        return arg0 == -29035 ? class508.field7250 : -90;
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lgs;ZZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(IIIIIZ)V", line = 85)
