...
public class class176 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IBIIIIILr;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIB)Z", line = 163)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 177)
