...
public class class176 extends class508 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZBZLte;)V", line = 15)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(II)V", line = 87)
