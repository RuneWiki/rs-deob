...
public class class176 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BIIIILec;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIBIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)Z", line = 116)
