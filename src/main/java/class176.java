...
public class class176 extends InputStream {
    ...
    @OriginalMember(owner = "client!rk", name = "read", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lwt;)V", line = 33)
