...
public class class176 extends class748 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIIIZIBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)[I", line = 34)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(II)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IZLvj;)V", line = 122)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZII)V", line = 136)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "()V", line = 212)
    public class176() {
        super(1, false);
    }
}
