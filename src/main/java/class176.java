...
public class class176 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ZZ)Z", line = 6)
    public static boolean method1205(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!hga", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!hga", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(II)Lql;", line = 163)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 189)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(BI)V", line = 219)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Lal;ILnd;)V", line = 239)
