...
public class class176 extends class34 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 101)
    public class176() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lsv;II)V", line = 110)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(Z)V", line = 154)
