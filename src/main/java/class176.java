...
public class class176 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ILjava/lang/String;)J", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III)Lvr;", line = 43)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)Lkv;", line = 66)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BLol;II)Leh;", line = 140)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(IIII)V", line = 213)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZI)V", line = 224)
