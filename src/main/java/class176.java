...
public class class176 extends class724 implements class471 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Leka;B)Leka;", line = 3)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljc;II[III)V", line = 18)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(II)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z[IIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZF)F", line = 66)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljc;Ltn;II[BII)V", line = 78)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILtn;IIBI[BII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IF)F", line = 145)
    ...
    @OriginalMember(owner = "client!ku", name = "f", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZZI)V", line = 187)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)Z", line = 197)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljc;Ltn;II[FII)V", line = 209)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(I)I", line = 226)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(II)Z", line = 238)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljc;Ltn;Lds;II)V", line = 249)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "([IIIIIII)V", line = 261)
