...
public abstract class class176 extends class166 {
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(I)Luca;", line = 19)
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IBII)V", line = 60)
    ...
    @OriginalMember(owner = "client!gg", name = "f", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZ[Lcba;I)I", line = 90)
