...
public class class176 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Luo;Ldb;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "()V", line = 102)
    public static final void method1155() {
        field2403 = null;
        field2404 = null;
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Luo;)V", line = 108)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "()V", line = 188)
    public final void method1157() {
        this.field2400 = null;
    }

    @OriginalMember(owner = "client!db", name = "c", descriptor = "()V", line = 191)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(Luo;Ldb;)Z", line = 201)
    public final boolean method1159(class345 arg0, class176 arg1) {
        return this.field2400 != null || this.method1153(arg0, arg1);
    }

    @OriginalMember(owner = "client!db", name = "b", descriptor = "(Luo;)V", line = 204)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Luo;IIIIII)V", line = 270)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(Luo;Ldb;)V", line = 298)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(Luo;Ldb;)V", line = 391)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
