...
public class class176 extends class503 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIILha;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIBI)V", line = 57)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)Z", line = 115)
