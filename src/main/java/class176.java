...
public class class176 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)Lno;", line = 5)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "()V", line = 44)
    public class176() {
    }

    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lbaa;)V", line = 87)
    public class176(class130 arg0) {
        this.field2410 = arg0;
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)Lno;", line = 50)
