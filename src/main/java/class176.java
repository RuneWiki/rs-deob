...
public class class176 extends class396 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lbk;IB)V", line = 12)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!db", name = "e", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lbk;B)V", line = 124)
