...
public class class176 extends class300 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IIII)[B", line = 22)
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "()V", line = 37)
    public class176() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!pha", name = "c", descriptor = "(I)V", line = 43)
