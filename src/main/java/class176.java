...
public class class176 extends class430 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)[Leda;", line = 78)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIB)V", line = 105)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIIIIIII)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(II)V", line = 175)
