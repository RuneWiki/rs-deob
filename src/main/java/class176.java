...
public class class176 implements class249 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()V", line = 18)
    public final void method1109() {
        this.field2279 = Thread.currentThread();
        this.method1110();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lv;BIZ)Lda;", line = 33)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Ll;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 101)
