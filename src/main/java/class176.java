...
public class class176 {
    ...
    @OriginalMember(owner = "client!kb", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IZIZII)V", line = 32)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(Z)[Lkb;", line = 147)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(IILlc;)V", line = 163)
