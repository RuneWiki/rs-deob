...
public class class176 extends class238 {
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIB)Ljava/lang/String;", line = 37)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(III[BLjava/lang/String;I)I", line = 76)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IBLoa;JZ)V", line = 297)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Loa;Ldg;Lhm;J)V", line = 526)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Loa;JB)V", line = 484)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)V", line = 513)
