...
public class class176 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IILtf;)V", line = 4)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 25)
    public void method180(int arg0) throws Exception {
        field2035++;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZ)Ljp;", line = 37)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "()I", line = 65)
    public int method184() throws Exception {
        field2042++;
        return this.field2063;
    }

    @OriginalMember(owner = "client!uc", name = "b", descriptor = "()V", line = 73)
    public void method179() throws Exception {
        field2037++;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "()V", line = 143)
    public void method182() {
        field2044++;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IB)V", line = 150)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)V", line = 163)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lil;IIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 232)
    public void method185(Component arg0) throws Exception {
        field2049++;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltf;I)V", line = 239)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "([II)V", line = 252)
    ...
    @OriginalMember(owner = "client!uc", name = "d", descriptor = "()V", line = 411)
    public void method183() throws Exception {
        field2052++;
    }

    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(B)V", line = 418)
    ...
    @OriginalMember(owner = "client!uc", name = "d", descriptor = "(B)V", line = 444)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)V", line = 454)
