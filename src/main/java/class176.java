...
public class class176 extends class205 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)Z", line = 92)
    public final boolean method194(byte arg0) {
        ++field2300;
        return arg0 >= -72 ? false : false;
    }

    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 698)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIBII)V", line = 107)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZBLwg;)V", line = 130)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!rn", name = "finalize", descriptor = "()V", line = 339)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZLya;)Llo;", line = 360)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILya;II)Z", line = 393)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILya;I)Lt;", line = 405)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 420)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BLt;Lya;)V", line = 442)
    ...
    @OriginalMember(owner = "client!rn", name = "f", descriptor = "(I)V", line = 467)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)I", line = 479)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(B)V", line = 599)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lya;I)V", line = 618)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(I)I", line = 648)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZI)Z", line = 659)
