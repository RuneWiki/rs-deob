...
public class class176 extends class79 implements class113 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Leq;Z)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLeq;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILmd;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Leq;Lhn;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IILeq;)Lva;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Leq;ZBI)Luq;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIILbp;IZLeq;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILae;)Llk;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILeq;Z)Lva;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Leq;Z)Lgl;")
