...
public class class176 extends class376 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BLfs;Lga;)Z")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lga;IZZLfs;DII)[I")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II[Luu;IIZ)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IBLfs;Lga;IDZ)[I")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZLga;Lfs;IZI)[F")
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Liv;)V")
