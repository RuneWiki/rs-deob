...
public class class176 extends class270 {
    ...
    @OriginalMember(owner = "client!as", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BLec;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "()V", line = 74)
    public class176() {
        super(1, false);
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZI)[[I", line = 85)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIII)V", line = 168)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IB)I", line = 222)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(CZ)Z", line = 245)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(IIII)V", line = 279)
