...
public class class176 extends class400 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(JI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Lha;J)V", line = 400)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "()V", line = 576)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Lcea;IIIIIIIIIIIZZ)V", line = 586)
    ...
    @OriginalMember(owner = "client!pha", name = "b", descriptor = "()V", line = 606)
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(Lcea;IIIIIIIIIIIZZ)V", line = 616)
