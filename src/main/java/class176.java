...
public class class176 extends class325 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lia;I)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lnv;Z)V")
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)Lia;")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lnv;)V")
