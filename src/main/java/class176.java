...
public class class176 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZIIIIII)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[IBI)Lwm;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BII[I)Lwm;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II[I)Lwm;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[II)Lwm;")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lmv;Lmv;)V")
