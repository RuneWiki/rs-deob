...
public class class176 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIIIILlo;IILhc;IIZBILaa;)Lhc;")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Ljava/lang/String;ZZLrj;)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lrg;III)V")
