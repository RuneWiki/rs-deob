...
public class class176 extends class220 {
    ...
    @OriginalMember(owner = "client!go", name = "f", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "()V", line = 217)
    public class176() {
        super(0, true);
    }

    @OriginalMember(owner = "client!go", name = "g", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IBLil;)V", line = 223)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "(I)Z", line = 275)
