...
public class class176 extends class334 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IZLol;)V", line = 66)
    ...
    @OriginalMember(owner = "client!np", name = "g", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IBIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "()V", line = 159)
    public class176() {
        super(0, true);
    }
}
