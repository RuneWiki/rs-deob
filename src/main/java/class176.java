...
public class class176 implements Runnable {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLjava/lang/String;)Lql;", line = 12)
    ...
    @OriginalMember(owner = "client!vp", name = "run", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "()V", line = 78)
    public class176() {
        this.field2701.setDaemon(true);
        this.field2701.start();
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(III)I", line = 96)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLrc;)V", line = 110)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 146)
