...
public class class176 extends class657 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ZB)V", line = 31)
    ...
    @OriginalMember(owner = "client!gg", name = "f", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILdu;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lbfa;Lin;Lur;)V", line = 99)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(I)Z", line = 157)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)V", line = 222)
