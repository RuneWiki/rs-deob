...
public class class448 extends class117 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILcda;I)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lgn;Z)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZBLd;I)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lgn;I)V")
