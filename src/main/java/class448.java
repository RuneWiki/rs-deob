...
public class class448 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "()I", line = 6)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "()[B", line = 49)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Luu;II)Lgb;", line = 108)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "()Lwo;", line = 120)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Ldc;)V", line = 129)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "()V", line = 149)
    private class448() {
    }
}
