...
public class class448 extends class337 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lfe;[I)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lek;II)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILoc;)Loc;")
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(Loc;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Loc;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lih;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(Loc;IIIIZ)Z")
