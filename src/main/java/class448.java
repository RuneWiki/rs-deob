...
public abstract class class448 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([SII)[S", line = 15)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIIZLuu;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BII)I", line = 84)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(CI)C", line = 104)
