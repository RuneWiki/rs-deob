...
public class class448 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(II)Lqg;", line = 90)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lae;ILqn;)V", line = 173)
    public class448(class165 arg0, int arg1, class47 arg2) {
        this.field6404 = arg2;
        this.field6404.method469(30322, 1);
    }

    @OriginalMember(owner = "client!am", name = "b", descriptor = "(II)V", line = 157)
