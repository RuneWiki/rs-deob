...
public class class448 extends class212 {
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(II)Lcs;", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(II)I", line = 90)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(ILdh;)V", line = 105)
    public class448(int arg0, class322 arg1) {
        super(arg0, arg1);
        class646.method3671(super.field3006, -122);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)V", line = 226)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)I", line = 238)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Ldh;)V", line = 255)
    public class448(class322 arg0) {
        super(arg0);
        class646.method3671(super.field3006, -120);
    }

    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)I", line = 265)
    public final int method2679(int arg0) {
        ++field6336;
        return arg0 != -32350 ? -82 : super.field3006;
    }

    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(I)Z", line = 286)
    ...
    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(II)V", line = 312)
