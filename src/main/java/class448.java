...
public class class448 extends class152 {
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "([BILjava/lang/String;I)I", line = 44)
    ...
    @OriginalMember(owner = "client!ika", name = "d", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ika", name = "<init>", descriptor = "(Lpa;)V", line = 128)
