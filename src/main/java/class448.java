...
public class class448 extends class198 {
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILlm;)V", line = 23)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZLol;)V", line = 46)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)V", line = 59)
