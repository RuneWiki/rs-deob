...
public abstract class class448 extends class170 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILij;)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILij;Lea;)V")
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lm;)V")
