...
public class class448 extends class450 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIBI)I", line = 19)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)I", line = 33)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(B)V", line = 45)
    public static void method2565(byte arg0) {
        int var1 = 65 / ((arg0 - -20) / 60);
        field6137 = null;
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Lup;)V", line = 74)
    public class448(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Z)I", line = 77)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BLwu;)V", line = 88)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(ILup;)V", line = 108)
    public class448(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZI)V", line = 114)
