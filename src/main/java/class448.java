...
public class class448 extends class439 {
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)J", line = 5)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "()V", line = 115)
    public class448() {
        this.field6210 = System.nanoTime();
        this.field6211 = System.nanoTime();
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I)J", line = 32)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IJ)I", line = 53)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Z)J", line = 85)
