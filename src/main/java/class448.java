...
public class class448 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([I[IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lcda;ILkea;)V", line = 118)
