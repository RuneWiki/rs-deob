...
public abstract class class448 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BIIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lqa;I)V", line = 80)
