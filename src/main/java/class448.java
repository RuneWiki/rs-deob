...
public class class448 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BLd;Lha;IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IB)V", line = 104)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 128)
