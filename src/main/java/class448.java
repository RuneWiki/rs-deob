...
public abstract class class448 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILen;)Len;")
    public abstract class477 method60(int arg0, class477 arg1);

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BLjava/lang/String;)[B")
    public static final byte[] method2589(byte arg0, String arg1) {
        field6296++;
