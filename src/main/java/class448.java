...
public class class448 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILde;)I", line = 8)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ldi;)V", line = 45)
