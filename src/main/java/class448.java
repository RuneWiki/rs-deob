...
public class class448 extends class381 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIBIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IB)V", line = 25)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 57)
    public class448() {
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 71)
    public class448(String arg0) {
        this.field6492 = arg0;
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IJBI)V", line = 85)
