...
public abstract class class448 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!lr", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 6)
    public final void windowIconified(WindowEvent arg0) {
        field6455++;
    }

    @OriginalMember(owner = "client!lr", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 18)
    ...
    @OriginalMember(owner = "client!lr", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 30)
    ...
    @OriginalMember(owner = "client!lr", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!lr", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 69)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field6458++;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!lr", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 89)
    public final void windowActivated(WindowEvent arg0) {
        field6476++;
    }

    @OriginalMember(owner = "client!lr", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 98)
    ...
    @OriginalMember(owner = "client!lr", name = "providesignlink", descriptor = "(Lkq;)V", line = 113)
    ...
    @OriginalMember(owner = "client!lr", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 124)
    public final void windowDeactivated(WindowEvent arg0) {
        field6487++;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!lr", name = "destroy", descriptor = "()V", line = 176)
    ...
    @OriginalMember(owner = "client!lr", name = "stop", descriptor = "()V", line = 190)
    ...
    @OriginalMember(owner = "client!lr", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 208)
    ...
    @OriginalMember(owner = "client!lr", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 224)
    public final void focusLost(FocusEvent arg0) {
        class30.field467 = false;
        field6489++;
    }

    @OriginalMember(owner = "client!lr", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 235)
    public final void windowDeiconified(WindowEvent arg0) {
        field6463++;
    }

    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BLjava/lang/String;)V", line = 272)
    ...
    @OriginalMember(owner = "client!lr", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 297)
    ...
    @OriginalMember(owner = "client!lr", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 313)
    public final void windowOpened(WindowEvent arg0) {
        field6467++;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIZIIBLjava/lang/String;I)V", line = 323)
    ...
    @OriginalMember(owner = "client!lr", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 363)
    public final void windowClosed(WindowEvent arg0) {
        field6479++;
    }

    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!lr", name = "run", descriptor = "()V", line = 399)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(Z)V", line = 521)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(I)Z", line = 552)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)V", line = 593)
    ...
    @OriginalMember(owner = "client!lr", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 644)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field6454++;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BZ[B)Ljava/lang/Object;", line = 652)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIII)V", line = 684)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZZ)V", line = 730)
    ...
    @OriginalMember(owner = "client!lr", name = "start", descriptor = "()V", line = 809)
