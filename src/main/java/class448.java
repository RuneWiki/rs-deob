...
public class class448 extends class30 {
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IB)[I", line = 35)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "()V", line = 59)
    public class448() {
        this(4096);
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ljg;II)V", line = 64)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(I)V", line = 106)
