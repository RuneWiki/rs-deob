...
public class class448 extends class513 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(SI)V", line = 173)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([[ZIIII)V", line = 408)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lep;Ldn;Lkb;[I)V", line = 485)
