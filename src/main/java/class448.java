...
public class class448 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Lja;", line = 32)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(II)Z", line = 60)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 89)
