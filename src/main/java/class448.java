...
public class class448 extends class335 implements class582 {
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lki;Lofa;III[B)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lcr;Z)V")
    ...
    @OriginalMember(owner = "client!q", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
