...
public class class448 extends class330 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lgga;IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(II)[[I", line = 73)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 228)
    public class448() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)V", line = 171)
