...
public class class448 extends class55 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(Ler;)V")
