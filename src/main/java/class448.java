...
public class class448 implements class17 {
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(II)Lev;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IB)Llba;")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lkda;Lkda;Lkda;)V")
