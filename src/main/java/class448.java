...
public class class448 extends class337 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BILhp;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "i", descriptor = "(I)Lqj;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lug;)V")
