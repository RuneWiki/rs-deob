...
public class class448 implements class130 {
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZB)V", line = 15)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)I", line = 206)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Class;B)Z", line = 228)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)Ljava/lang/Object;", line = 243)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)I", line = 262)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIZIII)V", line = 274)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)V", line = 455)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)V", line = 466)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IJ)Z", line = 478)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)I", line = 489)
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "(I)V", line = 500)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BI)I", line = 515)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/Object;Ljava/lang/String;)I", line = 533)
