...
public class class448 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IJ)V", line = 6)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)J", line = 30)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BI[BI)I", line = 42)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "([BIBI)V", line = 59)
    ...
    @OriginalMember(owner = "client!bi", name = "finalize", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(I)Ljava/io/File;", line = 128)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 151)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIB)B", line = 182)
