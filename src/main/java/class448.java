...
public class class448 extends class45 {
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIILwm;BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(I[B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 110)
