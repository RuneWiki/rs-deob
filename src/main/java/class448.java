...
public class class448 extends class35 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ldp;II)Lms;", line = 6)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lec;)V", line = 126)
