...
public class class448 extends class105 implements class439 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(III[I)V", line = 5)
    public final void method617(int arg0, int arg1, int arg2, int[] arg3) {
        this.method2715(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "()Lm;", line = 9)
    ...
    @OriginalMember(owner = "client!q", name = "finalize", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "()V", line = 34)
    public class448() {
        this.method2716();
    }
