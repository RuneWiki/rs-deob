...
public class class448 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IILr;B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILr;IB)V", line = 77)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IILr;I)V", line = 151)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IBIIZ[[Z)V", line = 221)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(III[IIBII)Z", line = 411)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)V", line = 509)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZIIII)V", line = 538)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)V", line = 582)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Llf;Lbja;)V", line = 595)
