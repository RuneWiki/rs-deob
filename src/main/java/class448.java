...
public class class448 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IBLhb;)Lbi;")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(JB)Ltl;")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BLtl;J)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILwm;)V")
