...
public class class448 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(Z)Z", line = 67)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(Z)Z", line = 78)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(B)Z", line = 170)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(Z)V", line = 447)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "(Z)V", line = 458)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BZIIB)Llba;", line = 473)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I[B)[B", line = 515)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lua;ZB)V", line = 533)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(I)V", line = 608)
