...
public abstract class class448 extends class65 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILofa;)Lfw;", line = 20)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 70)
