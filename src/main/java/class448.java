...
public class class448 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IILk;B)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BILk;I)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBILk;)Z")
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lnd;Lhm;)V")
