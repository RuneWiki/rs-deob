...
public class class448 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ad", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    public final String toString() {
        field6143++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lfl;B)I", line = 28)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(III)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Llia;", line = 73)
