...
public class class448 extends class617 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "([ILpu;ILpu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lok;II[B)V", line = 37)
