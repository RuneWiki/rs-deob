...
public class class448 extends class155 implements class250 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIZ[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lck;I[BIZ)V", line = 20)
    public class448(class733 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field5838 = arg1;
    }

    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(I)I", line = 29)
    public final int method1632(int arg0) {
        ++field5842;
        return arg0 >= -92 ? -127 : this.field5838;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IB)Z", line = 44)
    ...
    @OriginalMember(owner = "client!qq", name = "d", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)J", line = 86)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)I", line = 97)
