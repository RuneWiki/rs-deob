...
public class class448 implements Runnable {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZLga;)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([BIILgb;)Lga;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lgb;II)Lga;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILgb;Z)Lga;")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lrd;)V")
