...
public class class448 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIZZILdn;)V", line = 8)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IZLn;Ljava/awt/Canvas;)Lqa;", line = 27)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 74)
