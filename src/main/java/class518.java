...
public class class518 extends class190 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILnba;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIB)V", line = 45)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZI)V", line = 104)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(III)Z", line = 136)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lrs;Lah;)V", line = 147)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)Z", line = 191)
