...
public class class518 extends class6 implements class392 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lha;B)Lel;")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lha;Lwea;ZIIII)V")
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lib;I)Z")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILha;)Ldfa;")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!np", name = "q", descriptor = "(I)V")
    public static void method3001(int arg0) {
        int var1 = 86 % ((arg0 - 9) / 54);
        field7068 = null;
    }

    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lhj;Z)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lsaa;III)V")
