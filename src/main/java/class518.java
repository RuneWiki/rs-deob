...
public class class518 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IB)V", line = 25)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)Lv;", line = 41)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 130)
