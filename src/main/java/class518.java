...
public class class518 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lr;IZI)Lfu;")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)Ltt;")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lkr;ILpu;)V")
