...
public class class518 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kn", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field7609++;
        return "Cache:" + this.field7607;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IBIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(ILje;Lje;I)V", line = 539)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILtp;)Lmo;", line = 276)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BI)[B", line = 307)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B[BIIZ)Z", line = 389)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II[BI)Z", line = 511)
