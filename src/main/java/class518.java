...
public class class518 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lza;Lur;BIIIII)Lo;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lza;IZILza;IZIIILla;Lur;)Lo;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)Lqt;")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lad;IZLke;Ldk;Ldk;)V")
