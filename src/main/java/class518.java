...
public class class518 implements Runnable {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLjava/lang/String;I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!hv", name = "run", descriptor = "()V", line = 101)
