...
public class class518 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIB)I", line = 4)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B)V", line = 44)
