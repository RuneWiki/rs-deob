...
public class class518 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lnp;B)Z")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ltga;I)Luga;")
