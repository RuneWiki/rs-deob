...
public class class518 extends class159 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(II)I", line = 31)
    public static final int method3016(int arg0, int arg1) {
        return class43.field462 == null ? 0 : class43.field462[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 38)
