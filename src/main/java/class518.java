...
public class class518 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lfh;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lfh;B)V", line = 45)
