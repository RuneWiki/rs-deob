...
public class class518 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(BI)I", line = 44)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "([I)V", line = 75)
