...
public class class518 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/String;ILjava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Z)V", line = 103)
