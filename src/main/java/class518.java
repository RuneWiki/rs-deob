...
public class class518 extends class212 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "d", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!fo", name = "e", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(II)V", line = 128)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(II)I", line = 138)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(ILdh;)V", line = 150)
    public class518(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Ldh;)V", line = 153)
    public class518(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 175)
