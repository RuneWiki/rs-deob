...
public class class518 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lwn;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)[Lvi;", line = 29)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Ltf;IZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)V", line = 132)
    public static void method3012(int arg0) {
        field7503 = null;
        int var1 = 79 % ((arg0 + 48) / 56);
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BLwn;I)V", line = 141)
