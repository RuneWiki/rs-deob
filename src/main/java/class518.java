...
public class class518 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lql;I)Z")
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(II)Lql;")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lee;ILul;Lul;)V")
