...
public class class518 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lr;ILsf;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lwp;I)V", line = 348)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI[Lwp;)V", line = 402)
