...
public class class518 extends class766 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!kka", name = "<init>", descriptor = "(II)V", line = 84)
    public class518(int arg0, int arg1) {
        this.field7112 = arg0;
        this.field7113 = arg1;
    }

    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(III)Z", line = 105)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(BIIII)V", line = 133)
