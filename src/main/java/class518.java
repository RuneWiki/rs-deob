...
public class class518 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILza;Ljk;IILta;IIB)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lug;I)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBLug;)V")
