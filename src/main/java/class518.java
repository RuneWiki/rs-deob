...
public class class518 extends class87 {
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Loea;IIZ[[BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Loea;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Loea;IIZ[[I)V", line = 76)
