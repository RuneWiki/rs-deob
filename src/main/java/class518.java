...
public class class518 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([BZ)[B", line = 5)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IB)Z", line = 109)
