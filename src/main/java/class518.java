...
public class class518 extends class171 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BLsk;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lof;I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(BLsk;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lsk;B)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(FIIZLsa;)V")
