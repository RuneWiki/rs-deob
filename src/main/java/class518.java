...
public class class518 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BI[[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILqa;I[[BIII[[B[[BLwp;Lmv;[ZII)V", line = 42)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIZLlh;IIIIIII)V", line = 525)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lqa;ILna;Lna;)V", line = 651)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(IIIZLdb;Lhn;)V", line = 2485)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIZLlh;[Lid;II)V", line = 836)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIIII)V", line = 914)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lqa;ILna;B[[ILna;Lna;)V", line = 1011)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIII)V", line = 1873)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lna;Lqa;[[ILna;IZLna;)V", line = 1892)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "([[[I[Lid;Lqa;I)V", line = 2213)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIILlh;IIII[Lid;)V", line = 2312)
