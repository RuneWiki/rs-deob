...
public class class518 extends class165 {
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(II)Lwq;")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILmia;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZILts;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lrv;I)V")
