...
public class class518 extends class431 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Liq;B)V")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(FZILna;B)V")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BLiq;)V")
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(BLiq;)V")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lcb;B)V")
