...
public class class518 implements Runnable {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lsd;IB)Lkaa;", line = 4)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(Lsd;IB)Lkaa;", line = 181)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILsd;[BI)Lkaa;", line = 199)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!wb", name = "run", descriptor = "()V", line = 248)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lufa;)V", line = 345)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(B)Lhea;", line = 332)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZLkaa;)V", line = 375)
