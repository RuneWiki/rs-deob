...
public class class518 extends class194 {
    ...
    @OriginalMember(owner = "client!wm", name = "q", descriptor = "(CIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(CIIIZLfa;II)V", line = 29)
    public final void method59(char arg0, int arg1, int arg2, int arg3, boolean arg4, class212 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lgj;Lmj;[Lkq;Z)V", line = 32)
