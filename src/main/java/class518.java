...
public class class518 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lvs;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III)V", line = 37)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(III)I", line = 150)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lhga;B)Lsca;", line = 174)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(II[III)V", line = 193)
