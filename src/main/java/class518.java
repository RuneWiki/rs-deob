...
public class class518 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lgp;I)Lfba;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lgp;II)Lfba;")
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(Lgp;II)[Lfba;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "([B)[Lfba;")
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(Lgp;I)[Lfba;")
