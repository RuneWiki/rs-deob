...
public class class518 extends class362 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "()V", line = 47)
    public class518() {
        super(1, true);
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)[I", line = 51)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "(B)V", line = 90)
