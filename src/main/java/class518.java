...
public abstract class class518 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IZB)V", line = 9)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I[[[BIBII)V", line = 47)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IBI)V", line = 196)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BI)Z", line = 226)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IB)I", line = 245)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 279)
