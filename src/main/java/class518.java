...
public class class518 extends class377 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILji;)V", line = 18)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "()V", line = 107)
    public class518() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILpp;)V", line = 80)
    ...
    @OriginalMember(owner = "client!lq", name = "f", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)[I", line = 123)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IB)[[I", line = 174)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 249)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;I)V", line = 260)
