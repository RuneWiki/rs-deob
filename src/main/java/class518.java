...
public class class518 extends class747 {
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 3)
    public class518() {
        super(0, true);
    }

    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ldc;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)[I", line = 144)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)V", line = 294)
