...
public class class518 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ILgt;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IZZILha;)Lka;")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ILgda;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lgda;[Lkp;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ZIILka;IILnh;ILha;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lha;Ltba;IIIILgda;ZI)V")
