...
public class class518 extends class659 implements class629 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(III)Z", line = 269)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLun;)Lgaa;", line = 283)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!si", name = "h", descriptor = "(I)V", line = 368)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "([BBIIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Ldda;IZ[[I)V", line = 482)
