...
public abstract class class518 extends class538 {
    ...
    @OriginalMember(owner = "client!kga", name = "d", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIBI)I", line = 14)
    ...
    @OriginalMember(owner = "client!kga", name = "e", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I[Ltg;)I", line = 50)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILps;)V", line = 69)
    ...
    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(Z)Z", line = 96)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(IIIIII)V", line = 106)
