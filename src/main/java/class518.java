...
public class class518 extends class634 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Lwp;I)V")
    ...
    @OriginalMember(owner = "client!hha", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILig;Z)V")
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Lefa;I)V")
