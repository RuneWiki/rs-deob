...
public abstract class class169 extends class9 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lav;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILqa;Lwt;Ldi;I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IBI)Z", line = 377)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lada;I)V", line = 394)
