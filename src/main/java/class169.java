...
public class class169 extends class301 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lck;Lwo;)V", line = 108)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILmc;)Liv;", line = 169)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(IZ)V", line = 196)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IZ)V", line = 208)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIBI)V", line = 294)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 311)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZI[B)I", line = 325)
    public static final int method1075(boolean arg0, int arg1, byte[] arg2) {
        ++field2251;
        return !arg0 ? 13 : class71.method425(arg2, 2, arg1, 0);
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lwj;II)V", line = 340)
