...
public class class169 implements class763 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lvo;II)I", line = 4)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)Luw;", line = 15)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BIIILmca;I)V", line = 187)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIII)Z", line = 457)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Llga;Ljava/lang/String;)V", line = 482)
