...
public class class169 extends class261 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZIIIZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLha;)V", line = 55)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(I)V", line = 103)
