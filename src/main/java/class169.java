...
public class class169 extends class393 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IJLjava/lang/String;IILjava/lang/String;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 34)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(II)V", line = 158)
