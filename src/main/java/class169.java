...
public class class169 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)J", line = 44)
    public final long method1045(int arg0) throws IOException {
        return arg0 > -123 ? -41L : this.field2498.length();
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIZ[B)I", line = 55)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)Ljava/io/File;", line = 70)
    public final File method1047(byte arg0) {
        return arg0 <= 16 ? null : this.field2499;
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I[BIZ)V", line = 80)
