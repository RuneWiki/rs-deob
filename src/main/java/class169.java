...
public class class169 extends class377 {
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "()V", line = 7)
    public class169() {
        super(1, true);
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II)[I", line = 10)
    ...
    @OriginalMember(owner = "client!cw", name = "e", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IILji;)V", line = 58)
