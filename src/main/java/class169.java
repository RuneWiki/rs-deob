...
public class class169 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)Lnw;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILvq;)Lku;")
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Luq;Luq;)V")
