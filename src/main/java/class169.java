...
public class class169 extends class437 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 65)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(III)V", line = 78)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(III)V", line = 88)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(BI)V", line = 116)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIZI)V", line = 130)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(III)V", line = 162)
