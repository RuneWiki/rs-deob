...
public class class169 extends class424 {
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IZ)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 83)
    public class169() {
        super(1, false);
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BLrg;)V", line = 86)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/lang/String;Lne;ZZZ)V", line = 324)
    ...
    @OriginalMember(owner = "client!th", name = "g", descriptor = "(I)V", line = 394)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lrg;BI)V", line = 416)
    ...
    @OriginalMember(owner = "client!th", name = "h", descriptor = "(I)V", line = 462)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIZB)I", line = 473)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIZI)V", line = 493)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIII)V", line = 598)
