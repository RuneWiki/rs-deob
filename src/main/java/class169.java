...
public class class169 extends class321 {
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "([III)V", line = 8)
    ...
    @OriginalMember(owner = "client!aj", name = "e", descriptor = "()V", line = 100)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "()I", line = 119)
    public final int method1079() {
        return 0;
    }

    @OriginalMember(owner = "client!aj", name = "c", descriptor = "()Lj;", line = 122)
    public final class321 method1060() {
        return (class321) this.field2347.method514(true);
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lj;)V", line = 127)
    public final synchronized void method1137(class321 arg0) {
        arg0.method2594((byte) -22);
    }

    @OriginalMember(owner = "client!aj", name = "c", descriptor = "([III)V", line = 134)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Lj;)V", line = 146)
    public final synchronized void method1139(class321 arg0) {
        this.field2347.method511(arg0, (byte) -121);
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lqf;Los;)V", line = 152)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Los;)V", line = 162)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "()Lj;", line = 175)
    public final class321 method1078() {
        return (class321) this.field2347.method506((byte) -128);
    }

    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)V", line = 181)
