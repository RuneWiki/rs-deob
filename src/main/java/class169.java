...
public class class169 extends class17 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BI)Lki;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIILza;II)Le;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lhm;I)V")
