...
public class class169 {
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(I)V", line = 14)
    public class169(int arg0) {
        this.field2654 = arg0;
    }

    @OriginalMember(owner = "client!wq", name = "toString", descriptor = "()Ljava/lang/String;", line = 23)
    public final String toString() {
        field2655++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIII[BI)V", line = 31)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "()V", line = 64)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BII)V", line = 157)
