...
public abstract class class169 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)Z", line = 17)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(I)Z", line = 106)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)Z", line = 133)
