...
public class class169 extends class246 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILfg;I)V")
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lpg;)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Ljm;IZI)V")
