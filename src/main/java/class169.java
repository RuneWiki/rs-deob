...
public class class169 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!jh", name = "toString", descriptor = "()Ljava/lang/String;", line = 94)
