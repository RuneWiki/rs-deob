...
public class class169 extends class147 {
    ...
    @OriginalMember(owner = "client!sc", name = "N", descriptor = "Lwg;")
    ...
    @OriginalMember(owner = "client!sc", name = "P", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!sc", name = "db", descriptor = "[[Lvg;")
    public static class200[][] field3146;

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lbg;ILaa;)Z")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(FILaa;Lbg;I)[I")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIILka;J)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lja;ZLlf;)I")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IBLaa;Lbg;)[I")
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lja;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IZI)Llf;")
