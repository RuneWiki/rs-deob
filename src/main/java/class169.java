...
public class class169 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)Lwl;")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BI)Lpd;")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BLmg;)I")
