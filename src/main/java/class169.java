...
public class class169 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III)Lhu;", line = 56)
