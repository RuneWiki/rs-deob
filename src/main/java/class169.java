...
public class class169 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Lqs;", line = 5)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIIB)V", line = 34)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lvn;B)V", line = 134)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(B)Lqs;", line = 171)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(BI)Lgp;", line = 197)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)Lqs;", line = 276)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)Lqs;", line = 296)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lqs;ZLvn;)V", line = 320)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "()V", line = 445)
    public class169() {
        this.field2358.field5243 = this.field2358;
        this.field2358.field5247 = this.field2358;
    }

    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(I)Z", line = 347)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(BLqs;)V", line = 360)
    ...
    @OriginalMember(owner = "client!vn", name = "e", descriptor = "(I)Lqs;", line = 382)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILqs;)V", line = 405)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(B)I", line = 425)
