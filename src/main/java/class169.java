...
public class class169 extends class400 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IBILdj;)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lrg;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(CII)C", line = 51)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILew;IIIB)Ljava/awt/Frame;", line = 182)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)V", line = 259)
