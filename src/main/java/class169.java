...
public class class169 extends class83 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IBLtq;)V", line = 6)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)[I", line = 20)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZI)[[I", line = 91)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(III)V", line = 132)
