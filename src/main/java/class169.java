...
public class class169 extends class496 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I[Lvt;Los;)Ldca;", line = 3)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BLps;)V", line = 76)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZILha;ILwca;ILpa;)V", line = 117)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIIII)Z", line = 167)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(ZLuf;)V", line = 188)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)I", line = 320)
