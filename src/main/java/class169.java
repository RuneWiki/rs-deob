...
public class class169 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lhi;I[IJ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)Ldq;")
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(ILlt;Llt;Lhm;)V")
