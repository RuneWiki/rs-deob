...
public class class169 implements class248 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BI)Lkb;", line = 77)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZBZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIZFII)[I", line = 120)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIZIIF)[F", line = 150)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(II)I", line = 160)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(II)I", line = 174)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIZIF)[I", line = 198)
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(II)I", line = 209)
    ...
    @OriginalMember(owner = "client!ah", name = "e", descriptor = "(II)Luj;", line = 227)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I[BIIII)Z", line = 251)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lnl;Lnl;Lnl;)V", line = 338)
