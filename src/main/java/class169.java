...
public class class169 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZLqa;I)Lha;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ILjj;Ljava/lang/String;I)Lrv;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ILco;)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lco;ZI)V")
