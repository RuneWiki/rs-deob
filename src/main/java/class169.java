...
public class class169 extends class345 {
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lbi;)V", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZII)V", line = 64)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IILcj;)V", line = 137)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 212)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZB)V", line = 226)
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(B)V", line = 250)
