...
public class class169 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILkh;ILlr;I)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)Lqr;")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Ld;ILfo;Lfo;)V")
