...
public class class169 extends class278 {
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "()V", line = 3)
    public class169() {
        super(0, false);
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Llh;II)V", line = 82)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!fc", name = "g", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BII)V", line = 130)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILea;ILss;IIILqa;I)V", line = 150)
