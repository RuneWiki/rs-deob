...
public class class169 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljk;III)V", line = 25)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(B)V", line = 500)
