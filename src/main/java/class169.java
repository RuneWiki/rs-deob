...
public class class169 extends class391 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILjava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!cda", name = "h", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIIBI)V")
    ...
    @OriginalMember(owner = "client!cda", name = "i", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I")
    ...
    @OriginalMember(owner = "client!cda", name = "f", descriptor = "(I)Les;")
    ...
    @OriginalMember(owner = "client!cda", name = "e", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BII)V")
