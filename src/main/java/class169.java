...
public class class169 extends class330 {
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "()V", line = 15)
    public class169() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IZ)[I", line = 25)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lgga;IB)V", line = 112)
