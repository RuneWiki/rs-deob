...
public class class169 extends class71 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIILpia;ZILha;Lwh;ZI)Lka;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIILcea;Lmfa;)V")
