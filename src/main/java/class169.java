...
public class class169 extends class766 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!bs", name = "f", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lol;I)Ldn;", line = 68)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z)Z", line = 79)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)I", line = 95)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)V", line = 111)
    public static void method1256(byte arg0) {
        field2563 = null;
        int var1 = -104 / ((arg0 + 20) / 53);
    }

    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(II)V", line = 123)
