...
public class class169 extends class601 {
    ...
    @OriginalMember(owner = "client!wq", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "()V", line = 383)
    public class169() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIZ)Z", line = 24)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BI)[I", line = 44)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lee;BI)V", line = 97)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(IIZ)Z", line = 175)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "([IIB[II)V", line = 212)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 281)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILkn;I)V", line = 303)
