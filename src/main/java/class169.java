...
public class class169 extends class67 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lbs;Lbq;[Lcr;[I[I)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
