...
public class class169 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)Lnh;", line = 17)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 47)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(II)V", line = 65)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 84)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lwj;ILwu;Lwu;)V", line = 140)
