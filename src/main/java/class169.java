...
public class class169 extends class305 {
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(I)I", line = 3)
    public final int method1226(int arg0) {
        ++field2652;
        return arg0 != 17503 ? -124 : super.field4320;
    }

    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(ILhb;)V", line = 14)
    public class169(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(II)I", line = 68)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Lhb;)V", line = 83)
