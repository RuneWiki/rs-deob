...
public class class169 extends class116 implements class553 {
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lko;Z)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZLfb;)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z")
