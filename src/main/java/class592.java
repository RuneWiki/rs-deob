...
public class class592 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lmj;BI)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIILuj;Luj;)V")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lte;Lku;Lsb;IIIII)V")
