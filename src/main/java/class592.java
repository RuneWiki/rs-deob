...
public class class592 extends class261 {
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "()V", line = 3)
    public final void method1654() {
        field8753.method195(this.field8754, 25333);
    }

    @OriginalMember(owner = "client!ww", name = "a", descriptor = "()I", line = 6)
    public final int method1651() {
        return field8753.method197(this.field8754, (byte) -17);
    }

    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ww", name = "d", descriptor = "()V", line = 19)
    public final void method1663() {
        field8753.method198(this.field8754, (byte) -45);
    }

    @OriginalMember(owner = "client!ww", name = "c", descriptor = "()V", line = 23)
    public final void method1655() {
        field8753.method196(this.field8754, super.field3845);
    }

    @OriginalMember(owner = "client!ww", name = "e", descriptor = "()V", line = 26)
    public static void method3449() {
        field8753 = null;
    }

    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Luf;I)V", line = 28)
