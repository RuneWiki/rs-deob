...
public class class592 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(FBLpfa;Lpfa;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)Z", line = 74)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILfa;Lr;IIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(II)I", line = 185)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILun;)V", line = 197)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IFIIFIFI)[F", line = 227)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lkga;)V", line = 320)
