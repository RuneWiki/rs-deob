...
public class class592 extends class367 {
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lno;IIZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lno;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIIIZ)I", line = 57)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lno;IIZ[[BI)V", line = 126)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIIB)V", line = 145)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Loa;BLgba;)V", line = 172)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 201)
