...
public class class592 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IZLri;)Lf;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILep;I)Z")
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Ler;)V")
