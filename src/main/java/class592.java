...
public class class592 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lqi;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)Lqi;", line = 81)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(I)V", line = 103)
    public class592(int arg0) {
        this.field8336 = arg0;
    }

    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(IIIIII)V", line = 110)
