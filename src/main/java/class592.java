...
public class class592 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BZLha;I)Lli;", line = 19)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([Ljava/lang/String;[SI)V", line = 88)
    ...
    @OriginalMember(owner = "client!mq", name = "toString", descriptor = "()Ljava/lang/String;", line = 100)
