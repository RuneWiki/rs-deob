...
public class class592 extends class44 implements class334 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIIII[BLkt;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lbea;IIZ[III)V", line = 45)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IF)F", line = 112)
    public final float method1688(int arg0, float arg1) {
        return arg0 == -8473 ? arg1 / (float) this.field8256 : 1.9078624F;
    }

    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lbea;Lkt;Lkq;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(I)I", line = 141)
    public final int method1693(int arg0) {
        return arg0 < 109 ? 5 : this.field8256;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(BF)F", line = 152)
    public final float method1692(byte arg0, float arg1) {
        int var3 = -41 % ((arg0 + 5) / 39);
        return arg1 / (float) this.field8253;
    }

    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lbea;Lkt;IIZ[BII)V", line = 159)
    ...
    @OriginalMember(owner = "client!vs", name = "d", descriptor = "(I)Z", line = 219)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)I", line = 230)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(BLnd;)V", line = 240)
    public final void method272(byte arg0, class545 arg1) {
        super.method272(arg0, arg1);
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 248)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIBII[II)V", line = 259)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZZI)V", line = 299)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III[IIIII)V", line = 308)
