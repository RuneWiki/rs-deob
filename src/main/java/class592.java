...
public class class592 extends class337 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IBLuu;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lmh;)V", line = 35)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(BZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZII)V", line = 100)
    ...
    @OriginalMember(owner = "client!ev", name = "c", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(B)Z", line = 157)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILpa;Let;IIIILha;)V", line = 174)
