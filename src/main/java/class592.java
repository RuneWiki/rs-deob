...
public class class592 extends class502 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "c", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(ILeka;)V", line = 34)
    public class592(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!k", name = "c", descriptor = "(B)I", line = 66)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Leka;)V", line = 78)
    public class592(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!k", name = "c", descriptor = "(I)V", line = 131)
