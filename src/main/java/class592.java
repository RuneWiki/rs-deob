...
public class class592 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IB)Lwv;", line = 3)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ZZIILjava/lang/String;ZJIIILjava/lang/String;)V", line = 74)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BLgba;Lga;)V", line = 93)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BFFIF)F", line = 155)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BLjava/lang/String;)V", line = 169)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BII)Lah;", line = 220)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IBI)Z", line = 249)
