...
public class class592 extends class588 implements class639 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Loe;IZ[[I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 67)
    public final IDirect3DBaseTexture method650(boolean arg0) {
        return arg0 ? (IDirect3DBaseTexture) null : this.field8603;
    }

    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(BLtn;)V", line = 79)
