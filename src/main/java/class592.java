...
public class class592 extends class583 {
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)I", line = 29)
    public final int method3347(int arg0) {
        ++field8335;
        return arg0 != 6 ? 5 : (int) super.field2546;
    }

    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(I)J", line = 42)
    public final long method3348(int arg0) {
        ++field8339;
        return arg0 != 0 ? -64L : super.field8207 & Long.MAX_VALUE;
    }

    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!nu", name = "h", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(II)V", line = 129)
    public class592(int arg0, int arg1) {
        super.field2546 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!nu", name = "i", descriptor = "(I)V", line = 140)
