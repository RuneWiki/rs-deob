...
public class class592 extends class293 implements class289 {
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Loa;Luca;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BLoa;)Lvg;")
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ZIILoa;)Ltaa;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Loa;B)Llt;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIILoa;)Z")
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(BLoa;)V")
