...
public class class592 extends class651 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)Z", line = 18)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 40)
