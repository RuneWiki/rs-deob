...
public class class592 extends class298 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(B)Lmo;", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lla;Lla;Lla;Lla;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIIZLha;III)V", line = 43)
