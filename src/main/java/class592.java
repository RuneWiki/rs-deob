...
public class class592 extends class175 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZI)[I", line = 24)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILdt;Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "()V", line = 195)
    public class592() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIIIIIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BII)Z", line = 212)
