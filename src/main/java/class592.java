...
public class class592 extends class651 {
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljp;I)Laia;", line = 15)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lur;Lcf;IIIIIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)Lei;", line = 40)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(B)Lhv;", line = 60)
