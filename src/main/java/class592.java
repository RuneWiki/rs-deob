...
public abstract class class592 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZZLjava/lang/String;Lmr;)V", line = 11)
    ...
    @OriginalMember(owner = "client!ok", name = "finalize", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!ok", name = "e", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II[B)V", line = 99)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lep;I[BIZ)V", line = 123)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lep;ILjaclib/memory/Buffer;IZ)V", line = 142)
