...
public class class592 implements Runnable {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBLwea;)Lve;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BLve;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I[BBLwea;)Lve;")
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(IBLwea;)Lve;")
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lnga;)V")
