...
public class class592 extends class508 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!qba", name = "i", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(B)J", line = 69)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!qba", name = "j", descriptor = "(I)I", line = 99)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IILkp;)Ljava/lang/String;", line = 113)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(II)V", line = 137)
