...
public class class592 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IZ)Leo;", line = 26)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)[I", line = 43)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)Z", line = 163)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 178)
