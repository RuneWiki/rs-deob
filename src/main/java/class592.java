...
public class class592 extends class211 {
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(III)V", line = 15)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BILib;)V", line = 35)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!kj", name = "d", descriptor = "(III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "()V", line = 109)
    public class592() {
        super(0, false);
    }

    @OriginalMember(owner = "client!kj", name = "g", descriptor = "(I)I", line = 112)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(II)[[I", line = 125)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIIZI)V", line = 190)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIIIII)Lol;", line = 296)
