...
public class class592 extends class87 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BI)I", line = 13)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Llba;II[B)V", line = 34)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Llba;II[I)V", line = 46)
