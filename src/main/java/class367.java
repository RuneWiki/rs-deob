...
public class class367 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(J[I[S[S)V", line = 21)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "()V", line = 232)
    protected class367() {
    }
}
