...
public class class367 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)Lpaa;", line = 4)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)Lpaa;", line = 21)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IZ)Z", line = 100)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "()V", line = 247)
    public class367() {
        this.field4937.field8163 = this.field4937;
        this.field4937.field8159 = this.field4937;
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lpaa;B)V", line = 146)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lpaa;I)V", line = 162)
    ...
    @OriginalMember(owner = "client!je", name = "d", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!je", name = "e", descriptor = "(I)Lpaa;", line = 227)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(B)Lpaa;", line = 256)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)I", line = 287)
