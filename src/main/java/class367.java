...
public class class367 {
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lnn;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lph;II)Lum;")
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "()Lwq;")
