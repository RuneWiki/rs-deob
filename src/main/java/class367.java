...
public class class367 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([III)Lhk;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIILip;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([IIBI)Lhk;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I[IB)Lhk;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I[III)Lhk;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Ldp;Ldp;)V")
