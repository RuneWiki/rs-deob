...
public class class367 extends class430 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(I[B)V", line = 95)
