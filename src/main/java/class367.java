...
public class class367 extends class101 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IZIIIIIIII[Lor;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Ldm;)V", line = 956)
    public class367(class57 arg0) {
        this.field5341 = arg0;
    }

    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IILha;)Lvr;", line = 897)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IBI)Z", line = 923)
