...
public class class367 extends class323 implements class231 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lqa;Luh;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lqa;BI)Lr;")
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILqa;J)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IZBLqa;)Lis;")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(BILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(ILqa;)Lin;")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lqa;I)Lpl;")
