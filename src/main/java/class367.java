...
public class class367 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Llf;IZLvh;Lvh;)V", line = 245)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZ)Lpk;", line = 26)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(IZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)V", line = 159)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(II)V", line = 176)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(II)V", line = 200)
