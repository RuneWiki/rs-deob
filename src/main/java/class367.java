...
public class class367 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BLwo;Lwo;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lbg;[BI)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILwo;ZIII)V")
