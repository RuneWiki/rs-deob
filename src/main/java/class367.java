...
public class class367 implements class254 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([IBLqu;J)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILhp;)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lya;B)V", line = 81)
