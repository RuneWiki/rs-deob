...
public abstract class class367 extends class280 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILlk;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(IIIZZ)V", line = 164)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIIII)V", line = 79)
