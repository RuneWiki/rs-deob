...
public abstract class class367 extends class103 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IILgp;IIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)I", line = 25)
    public static final int method2215(int arg0, int arg1) {
        return class103.field1746 == null ? 0 : class103.field1746[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Z)[Lhf;", line = 28)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BZILqa;IILcea;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILjava/lang/String;)V", line = 69)
    ...
    @OriginalMember(owner = "client!ao", name = "f", descriptor = "(I)V", line = 106)
    public static void method2218(int arg0) {
        field5203 = null;
        int var1 = -13 % ((-arg0 - 32) / 45);
    }

    @OriginalMember(owner = "client!ao", name = "e", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(IIIIIII)V", line = 136)
