...
public class class367 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lpn;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III[II)V", line = 29)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)Ljea;", line = 59)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILkb;)V", line = 78)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILkj;)V", line = 116)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(I)Z", line = 126)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 218)
    public class367(String arg0) {
        this.field5748 = arg0;
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILpn;)V", line = 143)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIII)V", line = 166)
