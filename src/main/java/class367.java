...
public abstract class class367 implements class130 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!hf", name = "finalize", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)I", line = 42)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lno;IIIZ)V", line = 196)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Leh;I)Lpn;", line = 145)
    ...
    @OriginalMember(owner = "client!hf", name = "e", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!hf", name = "f", descriptor = "(I)V", line = 180)
