...
public class class367 extends class447 {
    ...
    @OriginalMember(owner = "client!te", name = "e", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!te", name = "d", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!te", name = "finalize", descriptor = "()V", line = 107)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ZLuo;)Laj;", line = 119)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILuo;I)Lmj;", line = 149)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IILuo;I)Z", line = 162)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(Luo;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(B)Z", line = 193)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BI)V", line = 212)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IBIILrr;Luo;Z)V", line = 253)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Luo;BLmj;)V", line = 270)
