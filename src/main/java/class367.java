...
public class class367 extends class111 {
    ...
    @OriginalMember(owner = "client!gb", name = "R", descriptor = "(III[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)[F", line = 13)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BIFFFII)V", line = 36)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZLq;)V", line = 80)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(B)[F", line = 110)
    ...
    @OriginalMember(owner = "client!gb", name = "XA", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!gb", name = "la", descriptor = "(Lq;)V", line = 145)
    ...
    @OriginalMember(owner = "client!gb", name = "GA", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "()Lq;", line = 180)
    ...
    @OriginalMember(owner = "client!gb", name = "O", descriptor = "([I)V", line = 205)
    ...
    @OriginalMember(owner = "client!gb", name = "pa", descriptor = "(IIIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IB)V", line = 270)
    ...
    @OriginalMember(owner = "client!gb", name = "G", descriptor = "(III)V", line = 287)
    ...
    @OriginalMember(owner = "client!gb", name = "P", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)V", line = 329)
    ...
    @OriginalMember(owner = "client!gb", name = "S", descriptor = "(I)V", line = 413)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(II)I", line = 440)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(III[I)V", line = 458)
    ...
    @OriginalMember(owner = "client!gb", name = "ra", descriptor = "(I)V", line = 476)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)V", line = 489)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "()V", line = 504)
    public class367() {
        this.method600();
    }

    @OriginalMember(owner = "client!gb", name = "Y", descriptor = "()V", line = 512)
