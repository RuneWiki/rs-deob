...
public class class367 extends class28 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)J", line = 17)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILjava/lang/String;)I", line = 41)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIZIIIIIZ)Z", line = 53)
    ...
    @OriginalMember(owner = "client!dda", name = "h", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!dda", name = "i", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(II)V", line = 114)
    public class367(int arg0, int arg1) {
        super.field5499 = (long) arg0 << 32 | (long) arg1;
    }

    @OriginalMember(owner = "client!dda", name = "j", descriptor = "(I)V", line = 122)
