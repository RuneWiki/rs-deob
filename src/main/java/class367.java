...
public class class367 extends class338 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([IIZ[II)J", line = 25)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIILol;IZBLvm;ILlb;)Ljn;", line = 100)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)I", line = 336)
