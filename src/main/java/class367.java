...
public class class367 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILkga;ZIILr;BLr;Lla;IIZ)Lf;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIIILr;Lkga;I)Lf;")
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(II)Loc;")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lkr;IZLbs;Lpu;Lpu;)V")
