...
public class class367 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IBI)Ldl;", line = 8)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IZLbk;)V", line = 41)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIILbk;)V", line = 65)
