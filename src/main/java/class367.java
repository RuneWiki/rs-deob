...
public class class367 extends class518 {
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IBI)V", line = 36)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(III)V", line = 63)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(II)I", line = 110)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Lada;Z)Z", line = 133)
