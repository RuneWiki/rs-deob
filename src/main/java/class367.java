...
public class class367 extends class271 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLdh;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILdh;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILvg;)Z")
