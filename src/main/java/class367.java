...
public class class367 extends class354 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BIIIILds;IILoa;Lea;Ltn;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILti;I)V")
