...
public class class367 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(I[B)Lhu;", line = 8)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(I)I", line = 49)
    public static final int method2167(int arg0) {
        field5139++;
        return ~class410.field5681 == arg0 ? class186.field2817 : 0;
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(BIIIIII)Ltea;", line = 61)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(B)V", line = 84)
    public static void method2169(byte arg0) {
        field5142 = null;
        int var1 = 44 % ((arg0 - 67) / 54);
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(Z)V", line = 133)
