...
public class class367 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIILjava/lang/Class;)Lnu;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BILsk;Lsk;)Lbk;")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lvf;Ld;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IZBLsk;Lsk;)Lbk;")
