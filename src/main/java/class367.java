...
public class class367 implements class707 {
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 16)
    public class367(String arg0) {
        this.field5099 = arg0;
    }

    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)Llj;", line = 48)
