...
public class class367 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II)Z", line = 9)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Z[BIBIILag;I)Lck;", line = 21)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(III)I", line = 43)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(II)Z", line = 76)
