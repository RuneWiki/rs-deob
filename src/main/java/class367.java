...
public class class367 extends class161 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIIIIIB)V", line = 33)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II[II)V", line = 227)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(Z)V", line = 245)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I[III)V", line = 258)
    ...
    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)I", line = 277)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(III)Z", line = 324)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(IIIIIIIII)V", line = 350)
