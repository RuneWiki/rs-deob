...
public class class367 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([BI)[B", line = 38)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(II)I", line = 124)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(II)V", line = 138)
