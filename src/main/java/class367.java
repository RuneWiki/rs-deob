...
public class class367 extends class279 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IZLiu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lpj;Lno;)V", line = 16)
    public class367(class38 arg0, class67 arg1) {
        super(arg0);
        this.field5590 = arg1;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIZ)Z", line = 25)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)Z", line = 72)
    public final boolean method438(byte arg0) {
        ++field5588;
        return arg0 > -32 ? false : this.field5590.method646((byte) 75);
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!vi", name = "f", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Z)V", line = 140)
    ...
    @OriginalMember(owner = "client!vi", name = "e", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIIIBLha;)V", line = 179)
