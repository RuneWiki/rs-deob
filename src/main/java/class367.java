...
public class class367 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BI)Lum;", line = 51)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIZZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 369)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(II)V", line = 381)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(FIIILtp;IFBFFF)[B", line = 395)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIILbq;Lbq;)V", line = 410)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZB)Z", line = 419)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(I)V", line = 456)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lre;ILdn;)V", line = 481)
