...
public class class367 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)Lbw;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BLdk;)V")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lad;ILdk;)V")
