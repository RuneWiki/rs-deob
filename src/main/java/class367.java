...
public class class367 extends class260 {
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IILjava/util/Random;)I", line = 18)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/lang/String;ZLmg;I)Llk;", line = 74)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(I[B)V", line = 232)
