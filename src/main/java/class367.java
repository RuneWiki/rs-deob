...
public class class367 extends class165 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lep;)V", line = 83)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IBI)V", line = 125)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZLhl;)V", line = 140)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZI)V", line = 153)
