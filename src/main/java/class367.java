...
public class class367 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZC)V", line = 58)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ldw;I)V", line = 68)
    public class367(class664 arg0, int arg1) {
        this.field5200 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLuv;)V", line = 82)
