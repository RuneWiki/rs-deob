...
public class class367 extends class436 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(III)Z", line = 40)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)[I", line = 61)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "()V", line = 115)
    public class367() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!tl", name = "f", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILeb;)V", line = 155)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(III)Z", line = 254)
