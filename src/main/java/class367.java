...
public class class367 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Let;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILci;IIIILwm;)V")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lnk;ZI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Ldn;ILr;)V")
