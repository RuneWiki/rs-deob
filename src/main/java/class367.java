...
public abstract class class367 {
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lih;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lih;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILii;IIII)V")
