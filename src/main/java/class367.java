...
public class class367 extends class597 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Loa;III)Lba;", line = 7)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZLoa;Lnt;IIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(Loa;B)V", line = 69)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Loa;Lq;ILba;)V", line = 89)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!wj", name = "finalize", descriptor = "()V", line = 193)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 374)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(III)I", line = 215)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(Loa;I)Lqt;", line = 230)
    public final class595 method6(class650 arg0, int arg1) {
        ++field4757;
        return arg1 != -7459 ? null : null;
    }

    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILoa;)Lww;", line = 250)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 286)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(I)Z", line = 299)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!wj", name = "e", descriptor = "(I)I", line = 333)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BILoa;I)Z", line = 347)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(B)V", line = 363)
