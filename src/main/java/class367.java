...
public class class367 implements Runnable {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZZLjava/lang/String;)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/awt/Frame;B)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZBLjava/lang/String;I)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(Z)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;[Ljava/lang/Class;)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)Lav;")
    public final class637 method2285(int arg0, byte arg1) {
        return arg1 >= -57 ? null : this.method2292(arg0, 0, 3, null, (byte) 93);
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Lbt;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLjava/lang/String;)Lbt;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILjava/lang/String;)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/awt/Component;IIILjava/awt/Point;[I)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILjava/net/URL;)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIILjava/lang/Object;B)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBIII)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Z)Lav;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBLjava/lang/Runnable;)Lav;")
