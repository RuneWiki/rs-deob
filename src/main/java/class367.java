...
public class class367 extends class376 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IILga;Lya;IBI)V")
    ...
    @OriginalMember(owner = "client!pt", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILf;)Z")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILfs;I)Lgt;")
