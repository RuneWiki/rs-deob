...
public class class798 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjc;)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjc;I)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lqo;I)V")
