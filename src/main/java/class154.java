...
public class class154 extends class194 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 36)
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)V", line = 85)
    public final void method1039(byte arg0, int arg1, int arg2) {
        int var4 = -64 % ((arg0 - 9) / 39);
        ++field2173;
    }

    @OriginalMember(owner = "client!s", name = "b", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(III)V", line = 115)
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(III)V", line = 125)
