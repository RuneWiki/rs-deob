...
public class class154 extends class264 implements class174 {
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lhj;Ljt;Z)V")
    public class154(class47 arg0, class38 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field2110 = arg1;
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IIIILha;ILd;)V")
    ...
    @OriginalMember(owner = "client!sia", name = "c", descriptor = "(I)Ljt;")
