...
public class class154 extends class399 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZBI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 28)
    public class154() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ld", name = "d", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(IIII)[B", line = 47)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIII)V", line = 77)
