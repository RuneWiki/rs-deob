...
public class class154 extends class264 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BLkk;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILvh;)V", line = 42)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(II)V", line = 218)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 254)
    public class154() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IB)V", line = 257)
    ...
    @OriginalMember(owner = "client!ln", name = "f", descriptor = "(I)V", line = 511)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(BI)[[I", line = 528)
