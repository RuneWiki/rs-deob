...
public class class154 extends class478 {
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(III)Z", line = 141)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 159)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(ILnp;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(II)V", line = 234)
    ...
    @OriginalMember(owner = "client!gfa", name = "d", descriptor = "(III)V", line = 247)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "()V", line = 429)
    public class154() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 417)
