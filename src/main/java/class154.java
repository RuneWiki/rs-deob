...
public class class154 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IILmv;)V")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(II)Lei;")
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Lai;ILic;)V")
