...
public class class154 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(CI)C", line = 16)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)V", line = 419)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(III)Z", line = 442)
