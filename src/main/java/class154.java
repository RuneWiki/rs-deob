...
public class class154 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!wk", name = "e", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IBI)Z", line = 56)
