...
public class class154 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IIIIZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(B)Z", line = 66)
