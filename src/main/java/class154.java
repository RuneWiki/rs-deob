...
public class class154 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I[B)Lxa;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IBILgba;)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lbi;BI)Lkga;")
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Leh;)V")
