...
public class class154 extends class98 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lbc;III)Lct;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "()Leha;")
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "()Leha;")
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lbc;III)V")
