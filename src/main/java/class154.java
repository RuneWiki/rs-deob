...
public class class154 extends class54 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BLmca;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(ILhia;)V")
    public class154(int arg0, class73 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lhia;)V")
