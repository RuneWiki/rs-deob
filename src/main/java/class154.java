...
public class class154 extends class184 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BILfh;)V", line = 8)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(II)[I", line = 96)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B[B)Ljava/lang/String;", line = 212)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "()V", line = 412)
    public class154() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)Ldt;", line = 295)
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "(I)V", line = 333)
