...
public class class154 extends class433 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lae;Lon;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLgh;[[IIZ[[BLae;I[[B[[B[[BLgh;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(II[I[I)V", line = 345)
