...
public class class154 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "()Lqk;")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lkda;II)Lei;")
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lgw;)V")
