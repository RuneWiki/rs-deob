...
public class class154 extends class136 {
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Z)[Leh;", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 27)
    public class154() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tg", name = "f", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lpk;ILya;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IZII)V", line = 100)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILiv;)V", line = 131)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)[I", line = 194)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)V", line = 261)
