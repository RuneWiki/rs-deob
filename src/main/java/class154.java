...
public class class154 extends class7 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZLjava/lang/String;ILum;)Llq;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIILue;)V")
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)Lmd;")
