...
public class class154 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IFIILsh;IBF[BFIFIF)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILjava/lang/String;Lvd;)Lrv;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
