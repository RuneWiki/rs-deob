...
public class class154 extends class558 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILjava/awt/Graphics;B)V", line = 11)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILjava/awt/Graphics;IBI)V", line = 22)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZLjava/awt/Canvas;)V", line = 42)
