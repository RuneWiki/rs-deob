...
public class class154 extends class166 implements Runnable {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ui", name = "run", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Ljv;)V", line = 81)
