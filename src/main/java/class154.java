...
public class class154 extends class461 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "([BIIIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(JJ)J", line = 57)
