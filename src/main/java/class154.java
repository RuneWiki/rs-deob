...
public class class154 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BLti;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILti;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)V", line = 83)
