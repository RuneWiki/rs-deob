...
public abstract class class154 extends class577 {
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)I", line = 14)
    public final int method1052(boolean arg0) {
        field2183++;
        return arg0 ? 122 : this.field2182;
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILha;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(III)Z", line = 61)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(Z)F", line = 77)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(II)I", line = 124)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(IIIIIF)V", line = 175)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 189)
