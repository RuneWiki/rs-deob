...
public class class154 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ZIIIZ[[Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BLtn;)V", line = 207)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIBII)V", line = 236)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ZILr;I)V", line = 279)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Z)V", line = 355)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IBLr;I)V", line = 390)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Lbm;Lup;)V", line = 481)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ILdfa;)V", line = 496)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lr;III)Z", line = 527)
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(I)V", line = 608)
