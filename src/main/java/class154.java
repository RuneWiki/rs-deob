...
public class class154 extends class732 {
    ...
    @OriginalMember(owner = "client!ne", name = "e", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[B)I", line = 38)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(ILla;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ne", name = "f", descriptor = "(I)V", line = 162)
