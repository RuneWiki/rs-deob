...
public class class154 extends class237 {
    ...
    @OriginalMember(owner = "client!tg", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lsl;Ljava/lang/Object;I)V", line = 15)
    public class154(class319 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field2363 = arg1;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIB)I", line = 24)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!tg", name = "f", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)Z", line = 78)
