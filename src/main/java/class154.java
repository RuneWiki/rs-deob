...
public class class154 extends class73 implements class438 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILqa;)Llb;")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(FIF[BIFIIFILjq;IF)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BLqa;)Led;")
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lqa;Lih;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BILqa;)Lr;")
