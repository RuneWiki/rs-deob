...
public class class154 extends class425 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([III)V", line = 7)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "()I", line = 55)
    public final int method103() {
        return 0;
    }

    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "()Lrb;", line = 106)
    public final class425 method105() {
        return (class425) this.field2199.method1165(true);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ltl;)V", line = 109)
    ...
    @OriginalMember(owner = "client!vf", name = "e", descriptor = "()V", line = 123)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lrb;)V", line = 158)
    public final synchronized void method1127(class425 arg0) {
        this.field2199.method1169(arg0, false);
    }

    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(Lrb;)V", line = 162)
    public final synchronized void method1128(class425 arg0) {
        arg0.method1884(false);
    }

    @OriginalMember(owner = "client!vf", name = "c", descriptor = "([III)V", line = 167)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "()Lrb;", line = 176)
    public final class425 method100() {
        return (class425) this.field2199.method1173(0);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lvi;Ltl;)V", line = 184)
