...
public class class154 extends class35 {
    ...
    @OriginalMember(owner = "client!dt", name = "d", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dt", name = "e", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!dt", name = "f", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Llk;)V", line = 183)
    public class154(class290 arg0) {
        this.field2142 = arg0;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 87)
    ...
    @OriginalMember(owner = "client!dt", name = "g", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIZ)Z", line = 191)
