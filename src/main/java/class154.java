...
public class class154 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZLha;)Lpga;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lrg;I)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BLjava/lang/String;)Z")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BLrg;I)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lha;B)Lpga;")
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(ILha;)Lpga;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lha;Z)Lpga;")
