...
public class class154 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIILjava/lang/Class;)Llq;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lya;III)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lod;I)[Lrd;")
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(II)Le;")
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lee;ILul;Lul;)V")
