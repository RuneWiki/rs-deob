...
public class class154 extends class117 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILbc;DILfc;ZI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lfc;BLbc;ZII)[F", line = 140)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(III)V", line = 258)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lfc;ZZIDILbc;B)[I", line = 290)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILjava/lang/String;)V", line = 436)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(B)V", line = 528)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)V", line = 555)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lfc;Lbc;I)Z", line = 569)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BLfc;Lkm;)V", line = 626)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "()V", line = 644)
    public class154() {
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Llk;)V", line = 659)
