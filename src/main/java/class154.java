...
public class class154 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ZII)I", line = 11)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IIIIII)V", line = 95)
