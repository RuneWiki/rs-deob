...
public class class154 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lud;I)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILg;)Z")
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lud;)V")
