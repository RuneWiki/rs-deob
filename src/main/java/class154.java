...
public class class154 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lza;ZILza;IILla;IZIILjl;)Lo;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IILza;IIILjl;I)Lo;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZ)Ljw;")
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lle;IZLka;Loi;Loi;)V")
