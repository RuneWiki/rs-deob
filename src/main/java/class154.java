...
public class class154 extends class161 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 20)
    ...
    @OriginalMember(owner = "client!mi", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 36)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field2378;
    }

    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!mi", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 86)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field2367;
        return this.field2368 == arg0;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!mi", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 111)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 136)
    ...
    @OriginalMember(owner = "client!mi", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 159)
    ...
    @OriginalMember(owner = "client!mi", name = "d", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!mi", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 191)
