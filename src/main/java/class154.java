...
public class class154 extends class145 {
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lrk;Lrk;I)I", line = 19)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "()V", line = 51)
    public class154() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lap;BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)[I", line = 67)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIIIIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBI)I", line = 176)
