...
public class class154 extends class287 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Z)Z", line = 36)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(II)Z", line = 145)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BI)Z", line = 157)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(Z)V", line = 169)
    ...
    @OriginalMember(owner = "client!nea", name = "c", descriptor = "(Z)V", line = 180)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(I)V", line = 193)
