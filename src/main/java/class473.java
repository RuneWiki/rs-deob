...
public class class473 extends class189 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIB)Z")
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(III)Ldha;")
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(III)Z")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II[II)V")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIIB)Z")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lag;ZI)V")
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "([IB)Ljava/lang/String;")
