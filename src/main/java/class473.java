...
public class class473 extends class504 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIBI)V", line = 25)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "([B)V", line = 947)
