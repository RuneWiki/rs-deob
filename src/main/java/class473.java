...
public class class473 extends class11 {
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "()V", line = 3)
    public class473() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lsi;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!pc", name = "d", descriptor = "(II)[I", line = 118)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(Z)V", line = 235)
    ...
    @OriginalMember(owner = "client!pc", name = "f", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(B)V", line = 321)
