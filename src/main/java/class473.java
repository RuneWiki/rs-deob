...
public class class473 extends class540 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "()[I", line = 6)
    public final int[] method2794() {
        return this.field6743;
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "()V", line = 55)
    public static void method2796() {
        field6742 = null;
    }

    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(II[IZ)V", line = 59)
