...
public class class473 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)Z", line = 47)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(III)Z", line = 191)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lvd;III)V", line = 202)
