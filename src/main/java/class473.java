...
public class class473 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lld;III)V", line = 20)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lms;B)V", line = 77)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 123)
