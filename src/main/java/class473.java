...
public class class473 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ILjagdx/IDirect3DSwapChain;)V", line = 14)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 63)
