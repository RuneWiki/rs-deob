...
public class class473 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILes;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Les;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)Laga;", line = 76)
