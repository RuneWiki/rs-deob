...
public class class473 extends class134 {
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lkda;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(ILkda;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lab;)V")
