...
public class class473 implements Runnable {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lia;I)Lgf;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lou;I)V")
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Ljava/net/Socket;Lnv;)V")
