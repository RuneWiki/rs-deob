...
public class class473 extends class598 implements class269 {
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(ILqa;)Lso;", line = 5)
    public final class398 method328(int arg0, class206 arg1) {
        ++field6625;
        return arg0 != 12 ? null : this.field6616;
    }

    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Llp;IIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)I", line = 73)
    public final int method333(byte arg0) {
        ++field6611;
        return arg0 != 70 ? 41 : this.field6621.field9207;
    }

    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(Lqa;Lcn;IIIIIZIIIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BLet;)V", line = 104)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILqa;II)Z", line = 116)
    ...
    @OriginalMember(owner = "client!jw", name = "e", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!jw", name = "i", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lqa;Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ZLqa;)V", line = 172)
    public final void method336(boolean arg0, class206 arg1) {
        this.field6621.method3677(arg0, arg1);
        ++field6631;
    }

    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILqa;)V", line = 195)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Z)I", line = 217)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 228)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(ILqa;)Loj;", line = 253)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILqa;Z)Lr;", line = 296)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)I", line = 309)
    ...
    @OriginalMember(owner = "client!jw", name = "d", descriptor = "(I)Z", line = 326)
