...
public class class473 extends class453 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IZII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(III)Z", line = 13)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "()V", line = 94)
    public class473() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBI)V", line = 113)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILis;IB)V", line = 128)
