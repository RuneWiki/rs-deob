...
public class class473 {
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(BI)Llha;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)Lbj;")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lmja;ILbt;)V")
