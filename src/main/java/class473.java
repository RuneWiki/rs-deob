...
public class class473 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IZLwk;Lwk;I)Lib;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lwk;IBLwk;)Lib;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)Lvl;")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lwd;Lkv;)V")
