...
public class class473 extends class480 implements class691 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILr;ZB)Lfe;")
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(BLr;)Lsr;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lr;B)Llt;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ZIIII)Lqo;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lr;II)Lda;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lr;Lfga;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BLr;)V")
