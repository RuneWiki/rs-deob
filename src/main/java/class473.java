...
public class class473 extends class4 implements class635 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bca", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BII)V", line = 57)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Ldw;III)V", line = 96)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Ldw;IIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!bca", name = "finalize", descriptor = "()V", line = 85)
