...
public class class473 extends class18 implements class65 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Ltb;", line = 11)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()V", line = 69)
    public final void method138() {
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)Lza;", line = 74)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 78)
    public final void method211(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lta;", line = 81)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 87)
    public final void method160(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 90)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkia;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!oa", name = "C", descriptor = "()La;", line = 100)
    ...
    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()V", line = 112)
    public final void method123() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lrha;IIII)Lka;", line = 115)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 123)
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Lcba;", line = 130)
    public final class254 method210() {
        return new class254(0, field6946[1], 1, field6946[0], 0L);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkia;Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 168)
    public final boolean method158() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 171)
    public final void method207(class348 arg0) {
        this.field6923 = (class770) arg0;
        this.method3657(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbha;Lkb;)Ltha;", line = 176)
    public final class296 method134(class545 arg0, class102 arg1) {
        return new class64(this, (class600) arg0, (class661) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lta;)V", line = 187)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqa;)V", line = 205)
    public final void method204(class104 arg0) {
        this.field6941 = arg0;
        this.method3644(((class729) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 240)
    private final Object method3647() {
        return new class68(this);
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()Lqa;", line = 244)
    public final class104 method221() {
        return new class729();
    }

    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Z", line = 247)
    public final boolean method140() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()I", line = 250)
    public final int method198() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 257)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 263)
    public final void method130(int arg0) {
        this.field6943[arg0].method5003();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Z", line = 266)
    public final boolean method166() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()V", line = 269)
    public final void method234() {
        this.method156(this.field6940.field11119);
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()V", line = 271)
    public final void method238() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 274)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 279)
    public final void method218(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 284)
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Z", line = 288)
    public final boolean method133() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Lqa;", line = 292)
    public final class104 method129() {
        return this.field6941;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltha;)V", line = 296)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 300)
    public final void method199(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 303)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Z", line = 317)
    public final boolean method172() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)I", line = 322)
    public final int method194(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()Z", line = 325)
    public final boolean method217() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 328)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lkb;", line = 331)
    public final class102 method191(int arg0, int arg1) {
        return new class661(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 334)
    public final void method146(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 338)
    public final boolean method202() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 341)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 354)
    public final boolean method164() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcd;[Lcu;Z)Lda;", line = 358)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 396)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Z", line = 407)
    public final boolean method186() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkia;)V", line = 410)
    ...
    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()V", line = 417)
    public final void method163() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsn;)V", line = 419)
    public final void method228(class369 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 423)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)Lsn;", line = 431)
    public final class369 method159(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Ltb;", line = 435)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Z", line = 438)
    public final boolean method215() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 442)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Ltb;", line = 446)
    public final class392 method222(int arg0, int arg1, boolean arg2) {
        return new class600(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()V", line = 449)
    public final void method135() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 453)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 456)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcu;Z)Ltb;", line = 471)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsn;Lsn;FLsn;)Lsn;", line = 476)
    public final class369 method155(class369 arg0, class369 arg1, float arg2, class369 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Z", line = 479)
    public final boolean method181() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(IIIIII)V", line = 483)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(II)Lbha;", line = 488)
    public final class545 method179(int arg0, int arg1) {
        return this.method222(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 491)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 506)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 574)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 517)
    public final void method205(int arg0) {
        this.field6943[arg0].method4997();
    }

    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Lqa;", line = 520)
    public final class104 method136() {
        return this.field6942;
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 524)
    public final boolean method125() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)V", line = 527)
    ...
    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)V", line = 546)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 562)
    ...
    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 569)
    public final boolean method216() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 605)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 631)
