...
public class class473 extends class665 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Loa;IIILvu;Ljd;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Ldq;)V", line = 735)
