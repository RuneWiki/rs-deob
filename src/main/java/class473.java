...
public class class473 extends class289 implements class28 {
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lwg;II)V")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lwg;I)V")
    ...
    @OriginalMember(owner = "client!xa", name = "d", descriptor = "()[Lod;")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "()[Lu;")
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;Lg;Lfe;IIII)V")
