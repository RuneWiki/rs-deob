...
public class class473 extends class30 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)[I", line = 13)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IBI)Z", line = 71)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BILac;)V", line = 98)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIIIB)V", line = 188)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(III)Z", line = 205)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!jq", name = "d", descriptor = "(I)V", line = 251)
