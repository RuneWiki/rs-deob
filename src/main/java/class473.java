...
public class class473 extends class720 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(II)[B", line = 190)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(II)Z", line = 253)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)Lrf;", line = 269)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(I)I", line = 366)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(B)I", line = 387)
    ...
    @OriginalMember(owner = "client!maa", name = "d", descriptor = "(I)V", line = 399)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(II)I", line = 412)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ILcc;[I[I[I)V", line = 429)
    ...
    @OriginalMember(owner = "client!maa", name = "e", descriptor = "(I)I", line = 529)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(B)V", line = 554)
    ...
    @OriginalMember(owner = "client!maa", name = "d", descriptor = "(B)I", line = 573)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(ILuj;Luj;Lsw;Lfi;I[BIZ)V", line = 939)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ZII)Luaa;", line = 593)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IZ)V", line = 879)
    ...
    @OriginalMember(owner = "client!maa", name = "f", descriptor = "(I)V", line = 909)
