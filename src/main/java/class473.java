...
public class class473 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIII)Lsm;", line = 22)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)Ltv;", line = 46)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(IIIIB)V", line = 69)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lsm;I)V", line = 83)
