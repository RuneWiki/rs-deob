...
public class class473 implements Runnable {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)Lfl;", line = 29)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(B)I", line = 45)
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(I)J", line = 57)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lie;B)Lrc;", line = 70)
    ...
    @OriginalMember(owner = "client!jq", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!jq", name = "e", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BLvv;)V", line = 140)
    ...
    @OriginalMember(owner = "client!jq", name = "f", descriptor = "(I)Z", line = 153)
    ...
    @OriginalMember(owner = "client!jq", name = "run", descriptor = "()V", line = 165)
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILfl;JILjava/lang/String;)V", line = 273)
    ...
    @OriginalMember(owner = "client!jq", name = "g", descriptor = "(I)I", line = 296)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIZII)V", line = 313)
