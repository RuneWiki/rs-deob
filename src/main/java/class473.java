...
public class class473 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lcda;B)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIIIBILoa;III)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Loa;II)Z")
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(I[Lfm;IIII)V")
