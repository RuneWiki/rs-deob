...
public class class473 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BLza;I)Z")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lza;Lgh;I)V")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lza;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(I[Lmc;IIII)V")
