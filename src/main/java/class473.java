...
public class class473 implements class449 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IZ)I", line = 20)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(ZI)I", line = 60)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BII)V", line = 102)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILqf;)V", line = 130)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 205)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(Z)V", line = 234)
    public static final void method2831(boolean arg0) {
        class240.field3496 = arg0;
        field6974++;
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZI)I", line = 243)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(III)V", line = 265)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILqa;ILm;III)V", line = 289)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILjava/lang/Object;Z)[B", line = 373)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IBI)V", line = 408)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILqa;IZIIIIILdn;IIIILc;)Lc;", line = 434)
