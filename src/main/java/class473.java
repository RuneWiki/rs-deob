...
public class class473 extends class362 {
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 510)
    public class473() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I[Lkh;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!uf", name = "e", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!uf", name = "f", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)[I", line = 206)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lfca;II)V", line = 423)
