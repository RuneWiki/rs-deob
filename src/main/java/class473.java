...
public class class473 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Z)I", line = 47)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 59)
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 103)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II)Z", line = 135)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lpo;B)V", line = 147)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(JI)V", line = 166)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IBIZII)V", line = 179)
    ...
    @OriginalMember(owner = "client!ka", name = "d", descriptor = "(I)I", line = 325)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 335)
    ...
    @OriginalMember(owner = "client!ka", name = "e", descriptor = "(I)I", line = 360)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(B)V", line = 384)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILjava/lang/Object;J)V", line = 398)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILjava/lang/Object;J)V", line = 410)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(II)V", line = 441)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(I)V", line = 515)
