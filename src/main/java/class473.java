...
public class class473 extends class401 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(II[I[I)V", line = 82)
    public class473(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field6629 = arg2;
        this.field6625 = arg3;
    }

    @OriginalMember(owner = "client!c", name = "d", descriptor = "(I)V", line = 106)
