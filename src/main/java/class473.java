...
public class class473 extends class585 {
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "()V", line = 9)
    public class473() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ZI)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IIIZII)V", line = 151)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(II)[I", line = 205)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lso;II)V", line = 296)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(I)V", line = 345)
