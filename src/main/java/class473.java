...
public class class473 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BLmo;)V", line = 7)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILmo;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Z)V", line = 85)
