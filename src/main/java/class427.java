...
public class class427 extends class742 {
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(III[BIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lrj;Lmq;IIIIIIIIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)Luu;", line = 87)
