...
public class class427 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILpq;Le;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BLdga;)Lbk;", line = 25)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lta;)V", line = 72)
    public class427(class301 arg0) {
        this.field5934 = arg0;
    }

    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lta;Lil;)V", line = 79)
    public class427(class301 arg0, class598 arg1) {
        this.field5934 = arg0;
        this.field5931 = arg1;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 46)
    public static void method2460(byte arg0) {
        int var1 = -27 / ((arg0 - 74) / 51);
        field5933 = null;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IBI)Z", line = 58)
