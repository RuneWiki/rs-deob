...
public class class427 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILkea;Loa;)V", line = 7)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(I)V", line = 39)
