...
public abstract class class427 extends class745 {
    ...
    @OriginalMember(owner = "client!mb", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I[Lmfa;)I")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLha;)Z")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
