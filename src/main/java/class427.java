...
public class class427 extends class450 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "([BLjava/lang/String;II)I", line = 20)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(Z)I", line = 75)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lup;)V", line = 86)
    public class427(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)Z", line = 89)
    public final boolean method2465(int arg0) {
        ++field5889;
        return arg0 != 260 ? true : true;
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILee;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ZI)V", line = 134)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(ILup;)V", line = 145)
    public class427(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)I", line = 151)
    public final int method75(int arg0, int arg1) {
        ++field5882;
        return arg0 != arg1 && ~super.field6171.field3900.method1182(true) != -2 ? 2 : 1;
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Z)I", line = 166)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 187)
