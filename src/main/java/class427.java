...
public class class427 extends class11 {
    ...
    @OriginalMember(owner = "client!qs", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lsi;II)V", line = 89)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 138)
    public class427() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qs", name = "d", descriptor = "(II)[I", line = 146)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II)[[I", line = 189)
