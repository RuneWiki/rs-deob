...
public class class427 implements class241 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 9)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Ltb;Lig;Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(I)Lig;", line = 118)
