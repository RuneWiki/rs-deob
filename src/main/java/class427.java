...
public class class427 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(II)[B", line = 52)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(III)Z", line = 106)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(II)Lqba;", line = 119)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lqh;ILtf;Ltf;)V", line = 159)
