...
public class class427 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ZI)I", line = 44)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BI)[B", line = 91)
