...
public class class427 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILkba;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BI)V", line = 169)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)Lsa;", line = 182)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Ldh;ILkha;)V", line = 220)
