...
public class class427 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILrv;)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IILrv;)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIZLha;)Lqda;")
