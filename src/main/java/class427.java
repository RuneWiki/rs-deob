...
public class class427 extends class681 implements class307 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILtda;)V")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lta;Lvea;III[B)V")
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
