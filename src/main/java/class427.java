...
public class class427 {
    ...
    @OriginalMember(owner = "client!lha", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 7)
    ...
    @OriginalMember(owner = "client!lha", name = "movemouse", descriptor = "(II)V", line = 23)
    public final void movemouse(int arg0, int arg1) {
        this.field5971.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!lha", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "()V", line = 58)
