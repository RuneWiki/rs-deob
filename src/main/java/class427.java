...
public class class427 extends class659 implements class103 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Ldda;Lfca;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Ldda;Lfca;Lbv;II)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZIIIIIILfca;[B)V")
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Ldda;Lfca;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Ldda;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "([FZIIIIILfca;I)V")
