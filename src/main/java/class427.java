...
public class class427 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljava/lang/String;IZB)I", line = 6)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lkk;B)Lre;", line = 85)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lae;III)V", line = 118)
