...
public class class427 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "()I", line = 6)
    public final int method2711() {
        return this.field6292;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lii;Ljava/lang/String;[IIIIZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "()V", line = 36)
    public static void method2713() {
        field6297 = null;
    }

    @OriginalMember(owner = "client!h", name = "c", descriptor = "()I", line = 39)
    public final int method2714() {
        return this.field6291 - 1;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ljava/lang/String;)I", line = 44)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lii;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lii;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lii;Ljava/lang/String;IIIZ)V", line = 154)
