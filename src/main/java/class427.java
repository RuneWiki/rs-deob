...
public class class427 extends class555 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IBII)[B", line = 7)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZIB)V", line = 20)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IBLoa;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "()V", line = 57)
    public class427() {
