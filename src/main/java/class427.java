...
public class class427 extends class292 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIZIILjava/awt/Graphics;)V", line = 10)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 27)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 37)
