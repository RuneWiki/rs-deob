...
public class class427 {
    ...
    @OriginalMember(owner = "client!wv", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!wv", name = "exit", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!wv", name = "listmodes", descriptor = "()[I", line = 171)
