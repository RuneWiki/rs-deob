...
public class class427 extends class138 {
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(ILsd;Lec;III)V", line = 3)
    public class427(int arg0, class95 arg1, class236 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field6137 = arg5;
    }

    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)I", line = 12)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lcea;I)Lvr;", line = 23)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)Lad;", line = 47)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 64)
