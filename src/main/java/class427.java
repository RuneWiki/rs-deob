...
public class class427 extends class35 implements class21 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZLza;IZ)Lqr;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lza;Lfu;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(Lza;B)Lkf;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IILza;I)Z")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILza;ILge;IZI)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lza;B)V")
