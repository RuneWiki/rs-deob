...
public class class427 extends class5 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIII)Ljq;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lea;I)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILts;Lea;)V")
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(ILea;)Lms;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lea;BI)Lts;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZILea;I)Z")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IILea;Lac;ZII)V")
