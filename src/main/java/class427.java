...
public class class427 extends class36 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vo", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 14)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field5896 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 21)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)I", line = 32)
