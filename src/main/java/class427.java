...
public class class427 extends class387 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lpt;IIIIIIIIIIIZZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lha;J)V", line = 28)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(JI)V", line = 204)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "()V", line = 598)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "()V", line = 606)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lpt;IIIIIIIIIIIZZ)V", line = 616)
