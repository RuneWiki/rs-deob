...
public abstract class class427 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(JI)I", line = 3)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)V", line = 40)
