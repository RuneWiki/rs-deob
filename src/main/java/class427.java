...
public class class427 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I[Lts;B)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Lvr;")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lci;ILhe;)V")
