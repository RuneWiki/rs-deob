...
public class class427 extends class189 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIIIZIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "()V", line = 101)
    public class427() {
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IBIIZ)Lgp;", line = 105)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 147)
