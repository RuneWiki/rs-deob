...
public class class427 extends class278 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III)Lva;", line = 22)
    ...
    @OriginalMember(owner = "client!pj", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 30)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method2547(arg0, (byte) 82, 0);
        field6149++;
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)Lbm;", line = 41)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!pj", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 77)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method2548(-18169, '\u0000', 0, -1);
        field6165++;
    }

    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZIBIZ)I", line = 143)
    ...
    @OriginalMember(owner = "client!pj", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 184)
    public final void focusGained(FocusEvent arg0) {
        field6159++;
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BI)Z", line = 196)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;BI)V", line = 212)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!pj", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 305)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ICII)V", line = 320)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 409)
    public class427(Component arg0) {
        class352.method2134(-120);
        this.method2545(arg0, 11717);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 346)
    ...
    @OriginalMember(owner = "client!pj", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 402)
