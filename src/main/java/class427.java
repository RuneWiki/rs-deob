...
public class class427 extends class362 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZLlt;)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lfca;II)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILfca;)V")
