...
public class class427 extends class296 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lhj;Lqm;[Lwh;[I[I)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!ie", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(CIIIZLta;II)V")
