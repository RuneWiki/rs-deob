...
public class class427 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(BIII)I", line = 23)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lfda;)V", line = 429)
    public class427(class381 arg0) {
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Ltia;Ljha;IBI)V", line = 60)
