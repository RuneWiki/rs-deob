...
public class class427 extends class175 {
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILdt;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZI)[I", line = 59)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIIIIIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "()V", line = 212)
    public class427() {
        super(1, true);
    }

    @OriginalMember(owner = "client!we", name = "g", descriptor = "(I)V", line = 178)
