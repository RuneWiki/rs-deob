...
public class class427 extends class233 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ldg;)V", line = 25)
    public final void method825(class223 arg0) {
        this.field3283.method2186(arg0);
    }

    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lih;)V", line = 28)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "()Z", line = 64)
    public final boolean method830() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Z)V", line = 72)
