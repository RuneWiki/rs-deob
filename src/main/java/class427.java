...
public class class427 extends class192 implements class458 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)J", line = 42)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lug;I[BIZ)V", line = 72)
    public class427(class395 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field6072 = arg1;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III[B)V", line = 84)
