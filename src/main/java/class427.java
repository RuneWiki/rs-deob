...
public class class427 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lai;IZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lep;Lms;IBILk;Ljava/lang/String;ILai;III)V")
