...
public class class427 extends class396 {
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lfd;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II[Luu;)V")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lfd;IIII)V")
