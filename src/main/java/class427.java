...
public abstract class class427 extends class143 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(JI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lsj;B)V", line = 100)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Z)V", line = 307)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Ljava/lang/String;BII)Ljava/lang/String;", line = 322)
