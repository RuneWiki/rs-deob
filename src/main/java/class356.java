...
public class class356 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(II)Lfia;", line = 14)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 142)
