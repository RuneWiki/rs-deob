...
public class class356 implements class682 {
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 15)
    public final void method449(int arg0) {
        field4615++;
        int var2 = 19 % ((arg0 - 65) / 45);
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BI)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BIIILta;Ljava/lang/String;)I", line = 88)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lbs;Ldq;)V", line = 98)
    public class356(class148 arg0, class517 arg1) {
        this.field4609 = arg0;
        this.field4613 = arg1;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZ)V", line = 108)
