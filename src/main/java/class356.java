...
public class class356 extends class115 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILen;)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILra;)I")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLbk;I)V")
