...
public class class356 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIZ)Z", line = 13)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZIZI)I", line = 35)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 78)
