...
public class class356 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BLre;)V", line = 15)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIILns;I)Lns;", line = 47)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lvc;Lbg;ILh;IIIB)V", line = 167)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIIIIBLns;)Lns;", line = 258)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BIIZ)I", line = 318)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lre;II)V", line = 440)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lvg;Z)V", line = 602)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)Lfo;", line = 690)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 723)
