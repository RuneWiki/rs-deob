...
public class class356 extends class402 {
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(IZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lpc;)V", line = 50)
    public class356(class700 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IZIJ)Ljava/lang/String;", line = 54)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBLfha;)V", line = 88)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(I)V", line = 115)
