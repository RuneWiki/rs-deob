...
public class class356 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Llm;B)V", line = 9)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I[B)V", line = 43)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 221)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II)V", line = 240)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "([BI)V", line = 253)
