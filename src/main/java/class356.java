...
public class class356 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Z)Lke;", line = 4)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 19)
    public static void method2012(byte arg0) {
        int var1 = 94 % ((-arg0 - 53) / 40);
        field4572 = null;
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILha;III)V", line = 31)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(I)V", line = 228)
    public class356(int arg0) {
        this.field4569 = arg0;
    }

    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(IIIIII)V", line = 235)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 61)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lke;B)V", line = 199)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)Z", line = 215)
