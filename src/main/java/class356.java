...
public class class356 {
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "([Lp;BILae;[BZIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IB)I", line = 117)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILrd;ILdg;)V", line = 147)
