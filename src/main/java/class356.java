...
public class class356 extends class436 {
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IILeb;)V", line = 273)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/Class;", line = 311)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BIIII)V", line = 356)
    ...
    @OriginalMember(owner = "client!gl", name = "f", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(I)V", line = 386)
    ...
    @OriginalMember(owner = "client!gl", name = "g", descriptor = "(I)V", line = 401)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(II)[[I", line = 508)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 568)
    public class356() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gl", name = "h", descriptor = "(I)V", line = 571)
