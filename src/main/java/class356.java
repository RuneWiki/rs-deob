...
public class class356 extends class38 {
    ...
    @OriginalMember(owner = "client!jp", name = "f", descriptor = "(B)V")
    public static void method2225(byte arg0) {
        field5173 = null;
        int var1 = 34 % ((arg0 - 44) / 56);
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/lang/String;Lrg;Z)I")
