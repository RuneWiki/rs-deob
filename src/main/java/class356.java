...
public class class356 extends class499 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lpc;Lm;I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dn", name = "f", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IBIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lpc;IZLm;IZBD)[I", line = 714)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 853)
    public class356() {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(DBLpc;IZLm;I)[I", line = 869)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZILpc;ILm;I)[F", line = 1005)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Lmd;)V", line = 1115)
