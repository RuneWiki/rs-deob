...
public class class356 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIBZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lll;I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILms;)V", line = 50)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(IIIIB)V", line = 90)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lqm;I)V", line = 101)
