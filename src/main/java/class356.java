...
public class class356 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lvr;)V")
    public final void method2334(class415 arg0) {
        this.method2335(arg0, true);
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lvr;Z)V")
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(Lvr;)Z")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lih;)V")
