...
public class class356 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(FIZIIIII)[I", line = 11)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLcc;[I[I[I)V", line = 82)
