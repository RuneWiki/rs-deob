...
public class class356 extends class83 {
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!og", name = "d", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)V", line = 51)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BLc;)I", line = 104)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IBLtq;)V", line = 130)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILbl;)V", line = 176)
    public static final void method2170(int arg0, class54 arg1) {
        class98.field1161[arg0] = arg1;
    }

    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "()V", line = 331)
    public class356() {
        super(1, true);
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 182)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II)[I", line = 257)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BIC)C", line = 335)
    ...
    @OriginalMember(owner = "client!og", name = "e", descriptor = "(I)V", line = 424)
