...
public class class356 extends class231 implements class207 {
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lcu;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lbba;I)V")
