...
public class class356 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(BLie;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)Lie;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Z)Lie;")
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(Z)Lie;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lem;BZ)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILoo;III)V")
