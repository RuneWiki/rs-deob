...
public class class356 implements Runnable {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Ljava/lang/String;B)Lha;", line = 6)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILag;)V", line = 115)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)V", line = 302)
