...
public class class356 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lef;Z)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lef;)Z")
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(Lef;)V")
    public final void method2206(class120 arg0) {
        this.method2199(arg0, true);
    }

    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lfu;)V")
