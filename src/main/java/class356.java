...
public class class356 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(Z)I", line = 24)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIB)B", line = 104)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "()V", line = 132)
    private class356() {
    }

    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "([I)V", line = 134)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 156)
