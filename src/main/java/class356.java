...
public class class356 extends Canvas {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IB[B)I", line = 17)
    ...
    @OriginalMember(owner = "client!ce", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 28)
    public final void paint(Graphics arg0) {
        field5172++;
        this.field5176.paint(arg0);
    }

    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 39)
    public class356(Component arg0) {
        this.field5176 = arg0;
    }

    @OriginalMember(owner = "client!ce", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 48)
