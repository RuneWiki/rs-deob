...
public class class356 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILgo;)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILef;)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/Object;Lgo;B)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lgo;IBLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLgo;)Ljava/lang/Object;")
