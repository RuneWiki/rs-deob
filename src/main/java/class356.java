...
public class class356 extends class425 {
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "([B)V", line = 31)
    public class356(byte[] arg0) {
        this.field5149 = arg0;
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lvq;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BLtj;)V", line = 115)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIIIIIIII)V", line = 132)
