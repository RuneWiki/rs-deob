...
public class class356 extends class223 {
    ...
    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BZI)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!nu", name = "f", descriptor = "(I)[B", line = 31)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BI)I", line = 50)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)I", line = 86)
