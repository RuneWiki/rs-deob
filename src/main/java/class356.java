...
public class class356 extends class283 {
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lou;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lkw;Lrb;)V", line = 69)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZII)V", line = 89)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)Z", line = 126)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(IZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IB)V", line = 177)
