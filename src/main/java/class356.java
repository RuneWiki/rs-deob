...
public abstract class class356 extends class429 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!mf", name = "h", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!mf", name = "f", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZZI)V", line = 64)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(IIIIIII)V", line = 98)
