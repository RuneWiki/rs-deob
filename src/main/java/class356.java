...
public class class356 extends class370 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIILuo;)V", line = 588)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(IIIIIII)V", line = 1024)
