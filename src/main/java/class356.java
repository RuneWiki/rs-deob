...
public class class356 extends class398 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Luca;Lal;)V", line = 63)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ILvaa;B)V", line = 148)
    ...
    @OriginalMember(owner = "client!eaa", name = "c", descriptor = "(I)V", line = 165)
