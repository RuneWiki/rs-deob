...
public class class356 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IBILul;)Ltp;", line = 32)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILad;)Ljava/lang/String;", line = 49)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 93)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILah;I)V", line = 113)
