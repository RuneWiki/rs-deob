...
public class class356 extends class270 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "([BIZ)Ljava/lang/Object;", line = 22)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(B)V", line = 64)
