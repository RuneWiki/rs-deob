...
public class class356 implements class46 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)Lsq;", line = 13)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(FB)F", line = 26)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(I)V", line = 63)
