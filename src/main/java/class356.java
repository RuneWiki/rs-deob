...
public class class356 extends class24 {
    ...
    @OriginalMember(owner = "client!on", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ILjp;)V", line = 21)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lnb;Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lke;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(II)I", line = 183)
