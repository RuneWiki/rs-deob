...
public class class356 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B[[[Lvt;)V", line = 9)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 123)
