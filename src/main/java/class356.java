...
public class class356 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZIII)I", line = 33)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZLcaa;)V", line = 75)
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IBZIB)Lpaa;", line = 196)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(B)V", line = 250)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZ)V", line = 280)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(Z)Z", line = 306)
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "(Z)V", line = 584)
    ...
    @OriginalMember(owner = "client!fs", name = "e", descriptor = "(Z)Z", line = 607)
