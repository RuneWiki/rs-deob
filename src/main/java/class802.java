...
public class class802 extends class505 {
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Llga;Lgja;)V", line = 6)
    public class802(class47 arg0, class44 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(III)V", line = 57)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IBI)V", line = 71)
