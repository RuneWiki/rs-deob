...
public class class593 extends OutputStream {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!vv", name = "write", descriptor = "(I)V", line = 17)
    public final void write(int arg0) throws IOException {
        field7517++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 56)
