...
public class class593 implements class486 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II[F[II[FIII[IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)Leo;", line = 92)
    public final class313 method576(byte arg0) {
        field8099++;
        return arg0 == 41 ? class375.field5489 : null;
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(I)V", line = 116)
