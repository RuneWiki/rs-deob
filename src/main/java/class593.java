...
public class class593 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 46)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(IIII)I", line = 71)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(II[II[J)V", line = 97)
