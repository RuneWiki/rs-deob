...
public class class593 extends class609 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(JBLr;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BIJZLr;)V")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lr;Llea;Lmca;J)V")
