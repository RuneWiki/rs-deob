...
public class class593 implements class255 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILjava/awt/Canvas;Ld;I)Lha;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZJLha;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Ldba;Liha;)V")
