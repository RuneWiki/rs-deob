...
public class class593 extends class571 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(IZ)Lcv;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "()Lkd;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([Loq;Z)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lha;[Lgv;Z)V")
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "()Lkd;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lha;J[Lgv;[Loq;Z)V")
