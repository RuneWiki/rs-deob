...
public class class593 {
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIIIIIII)V", line = 100)
