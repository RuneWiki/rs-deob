...
public class class593 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrc;I)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrc;Lgj;B)V")
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "(B)Lrc;")
    ...
    @OriginalMember(owner = "client!gj", name = "e", descriptor = "(B)Lrc;")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrc;B)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLgj;)V")
