...
public class class593 extends class371 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BI)[[I", line = 24)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "()V", line = 215)
    public class593() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(BI)[I", line = 99)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIII)I", line = 155)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IBLps;)V", line = 182)
    ...
    @OriginalMember(owner = "client!rj", name = "g", descriptor = "(I)V", line = 223)
