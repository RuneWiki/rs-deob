...
public class class593 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IB)V", line = 23)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(IB)Lhq;", line = 77)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lci;ILsea;Lsea;)V", line = 123)
