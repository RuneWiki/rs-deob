...
public class class593 extends class297 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lcea;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "e", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(II)[I", line = 58)
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "(II)[[I", line = 91)
    ...
    @OriginalMember(owner = "client!kq", name = "f", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 174)
    public class593() {
        super(1, false);
    }
}
