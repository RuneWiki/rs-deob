...
public class class593 extends class474 {
    ...
    @OriginalMember(owner = "client!g", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLha;ILbg;)V", line = 14)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILjava/lang/String;)V", line = 351)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(II)[[I", line = 371)
