...
public abstract class class593 {
    ...
    @OriginalMember(owner = "client!oo", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!oo", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!oo", name = "f", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!oo", name = "g", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Ljj;)V", line = 79)
