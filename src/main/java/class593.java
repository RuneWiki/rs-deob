...
public class class593 extends class243 {
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "()V", line = 10)
    public class593() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILji;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)[I", line = 126)
