...
public class class593 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([BZ)Lpc;")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lfh;)V")
    public class593(class653 arg0) {
        this.field8285 = arg0;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Z)Ldfa;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILfh;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(I)Ldfa;")
