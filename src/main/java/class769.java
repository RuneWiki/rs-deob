...
public class class769 implements class517 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 8)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)Lon;", line = 85)
    public final class496 method2345(int arg0) {
        int var2 = -35 / ((58 - arg0) / 47);
        return this.field10983;
    }

    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(Z)Z", line = 93)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(I)I", line = 115)
    public final int method2346(int arg0) {
        return arg0 == 34962 ? this.field10977 : 56;
    }

    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Los;Lon;Z)V", line = 127)
