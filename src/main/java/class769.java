...
public class class769 extends class335 implements class320 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lcr;Z)V")
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lki;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
