...
public class class769 extends class54 {
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(Z)I", line = 17)
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lha;I)V", line = 152)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)V", line = 231)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lhia;)V", line = 242)
    public class769(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(IB)I", line = 249)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(Z)I", line = 261)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(ILhia;)V", line = 272)
    public class769(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 276)
