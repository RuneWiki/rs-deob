...
public class class769 extends class406 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZLgca;)V", line = 5)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;)V", line = 26)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lfca;Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!au", name = "c", descriptor = "(B)V", line = 102)
