...
public class class769 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Lit;", line = 105)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)I", line = 180)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)Lit;", line = 196)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZLit;J)V", line = 233)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(JI)Lit;", line = 254)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(B)Lit;", line = 281)
    ...
    @OriginalMember(owner = "client!si", name = "d", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I[Lit;)I", line = 308)
    ...
    @OriginalMember(owner = "client!si", name = "e", descriptor = "(I)I", line = 339)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(I)V", line = 373)
