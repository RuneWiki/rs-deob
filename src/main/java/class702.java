...
public class class702 implements Runnable {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "()J", line = 3)
    public final long method3917() {
        return this.field9482;
    }

    @OriginalMember(owner = "client!waa", name = "run", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lcia;)V", line = 26)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!waa", name = "d", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!waa", name = "e", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class702(int arg0, class59 arg1) {
        this.field9489 = arg0;
        this.field9486 = arg1;
    }

    @OriginalMember(owner = "client!waa", name = "f", descriptor = "()Z", line = 154)
