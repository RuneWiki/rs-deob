...
public class class702 implements class135 {
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(IIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(III)V", line = 35)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IBI)V", line = 122)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(II)I", line = 149)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZI)I", line = 174)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "()V", line = 222)
    public class702() {
        try {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(II)I", line = 232)
