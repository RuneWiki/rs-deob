...
public class class702 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)V", line = 12)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lr;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!bea", name = "c", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(BI)Liv;", line = 111)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Lrf;ILpl;Lpl;)V", line = 172)
