...
public class class702 extends class406 {
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(B)V", line = 8)
    public static void method3970(byte arg0) {
        int var1 = 8 / ((arg0 - 68) / 47);
        field9781 = null;
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lgca;)V", line = 18)
    public static final void method3971(class705 arg0) {
        class539.field7444 = arg0;
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)Lof;", line = 24)
    public final class475 method473(int arg0) {
        field9783++;
        return arg0 == 6 ? class656.field9257 : null;
    }

    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lada;Loe;IIIIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIII)V", line = 53)
