...
public class class702 extends class301 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILha;Z)Lda;")
    ...
    @OriginalMember(owner = "client!gba", name = "A", descriptor = "(I)Leh;")
    ...
    @OriginalMember(owner = "client!gba", name = "m", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILnp;)V")
