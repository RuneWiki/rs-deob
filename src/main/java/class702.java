...
public class class702 extends class529 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lnj;)V", line = 4)
    public final synchronized void method3885(class529 arg0) {
        arg0.method1922(86);
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "([III)V", line = 11)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lgga;Ljf;)V", line = 56)
    ...
    @OriginalMember(owner = "client!bea", name = "d", descriptor = "()Lnj;", line = 64)
    public final class529 method521() {
        return (class529) this.field9860.method3430(true);
    }

    @OriginalMember(owner = "client!bea", name = "e", descriptor = "()I", line = 70)
    public final synchronized int method3887() {
        return this.field9860.method3429((byte) -88);
    }

    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "()Lnj;", line = 84)
    public final class529 method505() {
        return (class529) this.field9860.method3434((byte) 2);
    }

    @OriginalMember(owner = "client!bea", name = "f", descriptor = "()V", line = 88)
    ...
    @OriginalMember(owner = "client!bea", name = "c", descriptor = "([III)V", line = 116)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(Lnj;)V", line = 135)
    public final synchronized void method3891(class529 arg0) {
        this.field9860.method3437((byte) 94, arg0);
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "()I", line = 185)
    public final int method497() {
        return 0;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ljf;)V", line = 198)
