...
public class class702 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)V", line = 4)
    public final void method3943(int arg0) {
        field9905++;
        this.method3946(arg0, this.field9906, this.field9901);
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lch;Llba;Lcj;IIIII)V", line = 274)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILrr;I)V", line = 204)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(B)Lkda;", line = 218)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lhga;ILjava/awt/Frame;)V", line = 235)
