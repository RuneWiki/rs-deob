...
public class class702 extends class350 {
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIIII)V")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIII[I)V")
    public class702(class664 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILkaa;)[I")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIII)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lni;Z)V")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldw;IIIZ[III)V")
