...
public abstract class class702 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIII)V", line = 12)
    public final void method3956(int arg0, int arg1, int arg2, int arg3) {
        this.method1087(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFIILua;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(IIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFLua;II)V", line = 85)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFII)V", line = 88)
