...
public class class702 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILep;)V", line = 19)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 94)
