...
public class class702 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lrg;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IILrg;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 107)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Z)V", line = 137)
