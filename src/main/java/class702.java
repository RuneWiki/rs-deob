...
public class class702 extends class232 {
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(ILwq;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "()V", line = 163)
    public class702() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(II)[[I", line = 182)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IIII)V", line = 268)
