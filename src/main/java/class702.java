...
public abstract class class702 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "([[[BIIIIIIIIIIILr;)V", line = 150)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lna;Z)V", line = 200)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lkga;)V", line = 245)
    public class702(class506 arg0) {
        this.field9912 = arg0;
    }

    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)V", line = 254)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(I)V", line = 269)
