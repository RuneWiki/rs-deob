...
public class class702 extends class452 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Leha;Loea;IIIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)Lhm;", line = 25)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(II)I", line = 36)
