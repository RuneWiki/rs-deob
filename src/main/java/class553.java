...
public class class553 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lgka;Llea;IB)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILlea;)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Llea;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Llea;I)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BLlea;I)V")
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(Llea;I)V")
