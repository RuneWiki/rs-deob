...
public abstract class class553 extends class102 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IZ)Ltda;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lqa;IZIILco;I)V")
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(B)Z")
