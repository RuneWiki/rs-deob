...
public class class553 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)Ljj;", line = 6)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Ljj;)V", line = 18)
    public class553(class103 arg0) {
        this.field7455 = arg0.field1443;
        this.field7459 = 1;
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(III)B", line = 27)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "([Ljj;)V", line = 46)
    public class553(class103[] arg0) {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLjj;)V", line = 61)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BI)I", line = 73)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)I", line = 83)
    public final int method3104(boolean arg0) {
        field7461++;
        return arg0 ? 121 : this.field7459;
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BII)V", line = 99)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BIIII)V", line = 125)
