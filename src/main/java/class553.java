...
public class class553 extends class245 implements class455 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lhl;IZ[[I)V", line = 32)
    ...
    @OriginalMember(owner = "client!lq", name = "d", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BI)V", line = 512)
