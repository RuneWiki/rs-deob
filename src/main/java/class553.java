...
public class class553 implements Runnable {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(III[B)V", line = 16)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!cf", name = "run", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 170)
