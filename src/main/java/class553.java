...
public class class553 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ldd;I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ZLha;B)Lmi;", line = 93)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lha;Z)Lmi;", line = 139)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/String;IB)Ljava/lang/String;", line = 170)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILcea;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIZ)I", line = 399)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lcea;I)V", line = 425)
