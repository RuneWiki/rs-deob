...
public class class553 extends class356 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)[Lhh;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILiaa;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZILiaa;)V")
