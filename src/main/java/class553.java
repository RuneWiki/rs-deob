...
public class class553 extends class514 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILwq;)Lnk;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lrv;I)I")
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lvf;II[B)V")
