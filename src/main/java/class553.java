...
public class class553 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(JILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(II)Lww;", line = 76)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(B)V", line = 106)
    public static void method3138(byte arg0) {
        int var1 = 34 % ((-arg0 - 60) / 62);
        field7842 = null;
    }

    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(FFFI)I", line = 117)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!oea", name = "c", descriptor = "(II)V", line = 195)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lkr;ILpu;)V", line = 213)
