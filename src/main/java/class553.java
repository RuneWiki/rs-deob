...
public class class553 {
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lji;)V", line = 408)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II)V", line = 14)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Loa;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIII)V", line = 261)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/awt/Component;Lufa;III)Ldc;", line = 275)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILjava/lang/String;)Lue;", line = 361)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)V", line = 383)
