...
public class class553 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "toString", descriptor = "()Ljava/lang/String;", line = 103)
    public final String toString() {
        field7715++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 112)
    public class553(String arg0, int arg1) {
        this.field7713 = arg1;
        this.field7714 = arg0;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)V", line = 130)
