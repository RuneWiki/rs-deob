...
public class class553 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lbba;IIBIIIIILbba;)V", line = 25)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lwp;[IIZ)V", line = 74)
