...
public class class553 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lmh;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILet;ILpa;Lqa;III)V", line = 17)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lmh;ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IB)[B", line = 474)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lmh;Lka;B)V", line = 523)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BLmh;)V", line = 805)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Lmh;B)V", line = 829)
