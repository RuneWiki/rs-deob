...
public class class553 extends class159 {
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 5)
    public class553() {
    }

    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 7)
    public class553(String arg0) {
        this.field7630 = arg0;
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 32)
