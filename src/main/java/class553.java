...
public class class553 extends class28 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II[IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IZI)Z", line = 19)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II[IZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(Lfca;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIII)Z", line = 80)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLjava/lang/String;)J", line = 98)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIB)Z", line = 120)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(IIIIIIIII)V", line = 135)
