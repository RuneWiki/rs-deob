...
public class class553 implements class549 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lgda;)V", line = 12)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)Llf;", line = 18)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lps;Lft;IIIIIII)V", line = 73)
