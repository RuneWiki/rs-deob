...
public class class553 extends class447 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 5)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(FIFIFIZ[FIIF)V", line = 81)
