...
public class class553 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIIZIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BI)Lwl;", line = 35)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZI)I", line = 154)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Liv;ILcb;Lcb;)V", line = 217)
