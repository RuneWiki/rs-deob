...
public class class553 extends class211 {
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 250)
    public class553() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fd", name = "g", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(II)[I", line = 256)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZZ)Z", line = 276)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BILib;)V", line = 283)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)[I", line = 314)
