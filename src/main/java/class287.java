...
public abstract class class287 extends class77 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(IIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "()I", line = 19)
    public final int method628() {
        return this.field3899;
    }

    @OriginalMember(owner = "client!io", name = "b", descriptor = "(IIIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!io", name = "d", descriptor = "()I", line = 66)
    public final int method632() {
        return this.field3899 + this.field3883 + this.field3900;
    }

    @OriginalMember(owner = "client!io", name = "c", descriptor = "()I", line = 74)
    public final int method631() {
        return this.field3878;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(FFFFFFIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(FFFFFF)V", line = 164)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(FFFFFFLde;II)V", line = 298)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lsq;II)V", line = 321)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "()I", line = 342)
