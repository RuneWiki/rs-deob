...
public class class287 extends class229 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I[BI)I", line = 9)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IILao;)V", line = 61)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(B)Z", line = 78)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lht;Lgo;)V", line = 90)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lut;Lut;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZI)V", line = 168)
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(III)B", line = 178)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)V", line = 196)
