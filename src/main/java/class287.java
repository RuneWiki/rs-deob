...
public class class287 extends class443 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILco;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BI)V", line = 49)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BLco;)V", line = 61)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 87)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(III)I", line = 126)
