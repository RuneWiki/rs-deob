...
public class class287 extends class446 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III)V", line = 88)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lda;Lai;)V", line = 198)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZB)V", line = 149)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILgh;)Lgh;", line = 181)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IILac;)V", line = 226)
