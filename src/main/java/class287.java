...
public abstract class class287 extends class352 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I[[[BILtq;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lh;ZI)V")
