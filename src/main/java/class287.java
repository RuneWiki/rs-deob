...
public class class287 extends class706 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljga;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lin;Lti;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)Lsaa;")
