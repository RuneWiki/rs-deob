...
public class class287 extends class359 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IBLae;)V", line = 8)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(B)V", line = 236)
