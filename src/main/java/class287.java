...
public class class287 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIILkn;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIZLvg;)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(JBLqa;)V")
