...
public class class287 extends class340 {
    ...
    @OriginalMember(owner = "client!ria", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 13)
    public class287(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ria", name = "f", descriptor = "(I)V", line = 33)
