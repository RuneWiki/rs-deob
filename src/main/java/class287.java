...
public class class287 extends class260 {
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "()V", line = 9)
    public final void method1633() {
        field4298.method1168(this.field4297, -117);
    }

    @OriginalMember(owner = "client!im", name = "d", descriptor = "()V", line = 12)
    public final void method1640() {
        field4298.method1169(this.field4297, 73);
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 16)
    ...
    @OriginalMember(owner = "client!im", name = "e", descriptor = "()V", line = 19)
    public static void method1776() {
        field4298 = null;
    }

    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lec;I)V", line = 21)
    public class287(class109 arg0, int arg1) {
        field4298 = arg0.method839((byte) 88);
        this.field4297 = arg1;
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 26)
