...
public class class287 extends class276 {
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lur;Ljava/lang/Object;I)V", line = 4)
    public class287(class95 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field4212 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(Z)Z", line = 13)
    public final boolean method1882(boolean arg0) {
        return arg0;
    }

    @OriginalMember(owner = "client!ga", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 24)
