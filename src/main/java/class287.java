...
public class class287 extends class366 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILep;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)V", line = 97)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)Z", line = 108)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Ler;)V", line = 152)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)V", line = 204)
