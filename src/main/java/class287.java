...
public class class287 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lha;Lpg;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Lha;Lpg;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(Lha;Lpg;)Z")
    public final boolean method1878(class544 arg0, class287 arg1) {
        return this.field4417 != null || this.method1881(arg0, arg1);
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(Lha;Lpg;)Z")
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Lha;)V")
