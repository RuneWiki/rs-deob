...
public abstract class class287 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(FFIIFFBLsb;FII)[B", line = 9)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)I", line = 36)
    public static final int method1708(int arg0) {
        field3608++;
        return arg0 == 255 ? class14.field273.method1088(-46) : -35;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)[B", line = 53)
