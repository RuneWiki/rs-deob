...
public abstract class class287 extends class525 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)Ljk;", line = 135)
    ...
    @OriginalMember(owner = "client!wl", name = "e", descriptor = "(I)V", line = 207)
