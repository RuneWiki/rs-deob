...
public class class287 extends class190 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)Lg;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lg;BLg;F)V")
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lql;I)V")
