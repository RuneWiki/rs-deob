...
public class class287 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZZLlf;ILlf;)Lpda;", line = 129)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILlf;Llf;B)Lpda;", line = 174)
    ...
    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Luaa;Lth;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 199)
