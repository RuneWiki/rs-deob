...
public class class287 implements class496 {
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(I)Z", line = 6)
    public final boolean method1900(int arg0) {
        field4215++;
        return arg0 <= 74 ? true : this.field4217;
    }

    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I)Ljea;", line = 36)
    ...
    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 53)
