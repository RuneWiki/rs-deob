...
public class class287 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIILpi;Lpi;)V", line = 17)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lkm;IILdr;III[[[B[I[I[I[I[IIBIIZ)V", line = 35)
