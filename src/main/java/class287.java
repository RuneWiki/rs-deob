...
public class class287 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)Lki;")
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)Lki;")
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(I)Lki;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BLki;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(B)Lki;")
