...
public class class287 extends class59 {
    ...
    @OriginalMember(owner = "client!oaa", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(Luj;Lfp;[Lfw;[I[I)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(CIIIZLaa;II)V")
