...
public class class287 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IBII)V", line = 86)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIII)Z", line = 118)
