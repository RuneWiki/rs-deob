...
public class class287 implements Runnable {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!wd", name = "run", descriptor = "()V", line = 65)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lqp;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Llp;IB[B)Lqp;", line = 149)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IBILpda;)V", line = 167)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Llp;II)Lqp;", line = 227)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILlp;I)Lqp;", line = 270)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lmca;)V", line = 300)
