...
public class class287 {
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)Lor;")
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(I)Lor;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLrt;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lrt;BI)V")
