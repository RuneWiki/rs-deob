...
public class class287 extends class460 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IILjava/awt/Canvas;B)V", line = 12)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIIILjava/awt/Graphics;)V", line = 32)
