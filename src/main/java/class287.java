...
public abstract class class287 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLjava/lang/String;Lhh;B)Lfi;", line = 6)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)I", line = 52)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 62)
