...
public abstract class class287 extends class78 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)Z", line = 25)
    ...
    @OriginalMember(owner = "client!il", name = "e", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IZIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 214)
