...
public class class287 {
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(III)V", line = 47)
