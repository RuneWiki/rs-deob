...
public class class287 extends class518 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)Lsi;", line = 20)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZI)V", line = 69)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lsi;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IZ)Z", line = 355)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)Z", line = 370)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILem;ILma;IILdq;ILjava/lang/String;Lla;II)V", line = 386)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BLdr;)V", line = 434)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Ldr;)V", line = 491)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 479)
