...
public class class287 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "([Laj;Lih;I)Leq;", line = 9)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)V", line = 95)
