...
public class class287 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lhk;IIZII)Lvq;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IILta;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "([IZILwda;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lhga;I)V")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lsf;Lcm;Lek;IIIII)V")
