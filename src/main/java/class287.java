...
public class class287 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "finalize", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "([BIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)Ljava/io/File;", line = 44)
    public final File method1874(byte arg0) {
        return arg0 >= -89 ? null : this.field4023;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II[BI)I", line = 57)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)J", line = 73)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 85)
