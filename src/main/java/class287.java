...
public class class287 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(II)Lai;", line = 64)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(III)Lwaa;", line = 106)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!rv", name = "d", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Loda;IZLdda;Ldda;)V", line = 206)
