...
public class class287 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILya;)V", line = 131)
    public static final void method1770(int arg0, class38 arg1) {
        class330.field4818[arg0] = arg1;
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZI)V", line = 138)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "([BIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lih;Lbl;Lus;IIIII)V", line = 284)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lik;II)V", line = 229)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)V", line = 253)
    public static void method1774(byte arg0) {
        field4192 = null;
        int var1 = 49 / ((-arg0 - 23) / 57);
    }

    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)V", line = 273)
