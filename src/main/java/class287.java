...
public class class287 extends class268 {
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lvq;Lju;[Lmn;[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([B[IIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!rm", name = "g", descriptor = "(CIIIZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([B[IIIIIIIIIIILi;II)V", line = 149)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "([B[IIIIIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "([B[IIIIIIIIIIILi;II)V", line = 282)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(CIIIZLi;II)V", line = 365)
