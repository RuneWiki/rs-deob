...
public class class287 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lqa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lqa;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lqa;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lqa;IZLjava/awt/Component;)V")
