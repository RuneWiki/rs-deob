...
public class class287 extends class95 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lkr;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lkr;IIIIIIIIIIIZZ)V")
