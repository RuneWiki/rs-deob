...
public abstract class class287 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIIIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!za", name = "b", descriptor = "(IIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIZIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!za", name = "e", descriptor = "(IIIIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(Lfq;Ljava/awt/Canvas;Ll;IBI)Lza;", line = 160)
    ...
    @OriginalMember(owner = "client!za", name = "<init>", descriptor = "(ILl;)V", line = 205)
    public class287(int arg0, class16 arg1) {
        this.field3766 = arg0;
        this.field3772 = arg1;
    }

    @OriginalMember(owner = "client!za", name = "e", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!za", name = "finalize", descriptor = "()V", line = 282)
