...
public class class287 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Let;Ljava/lang/String;ZZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/lang/String;IIILla;ILuu;IILgt;Lma;)V", line = 89)
