...
public class class155 extends class367 {
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 24)
