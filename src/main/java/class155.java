...
public class class155 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JB)Lvl;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lvl;IJ)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)Lvl;")
