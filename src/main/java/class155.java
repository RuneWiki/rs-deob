...
public abstract class class155 {
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 34)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(III)I", line = 48)
