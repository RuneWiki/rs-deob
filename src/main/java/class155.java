...
public class class155 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)Lwq;", line = 22)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ljava/awt/Component;I)Ljca;", line = 37)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(I)V", line = 103)
    public class155(int arg0) {
        this.field2443 = arg0;
    }

    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(IIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 68)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lwq;B)V", line = 87)
