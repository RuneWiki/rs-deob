...
public class class155 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BLjava/lang/String;Lqn;Ljava/lang/String;I)Leba;", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljp;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZBI)V", line = 154)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljp;I)V", line = 171)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)Leu;", line = 193)
