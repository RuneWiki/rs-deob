...
public class class155 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(III)Z", line = 55)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(III)Z", line = 79)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZLjava/lang/String;B)V", line = 104)
