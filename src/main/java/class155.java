...
public class class155 extends class180 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILdq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BLlk;)V", line = 88)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(II)V", line = 350)
    public class155(int arg0, int arg1) {
        this.field2240 = arg1;
        this.field2233 = arg0;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZLkm;)V", line = 359)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(IIIIIII)V", line = 378)
