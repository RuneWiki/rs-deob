...
public class class155 implements class419 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IZIILtn;)V", line = 464)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ZZ)Z", line = 544)
    public static boolean method1122(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIB)Ltn;", line = 551)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BJ[ILsv;)Ljava/lang/String;", line = 576)
