...
public class class155 implements Runnable {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)J", line = 10)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)I", line = 21)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)Lcaa;", line = 33)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)Z", line = 88)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(JLcaa;ILjava/lang/String;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(B)Ljava/lang/String;", line = 113)
    ...
    @OriginalMember(owner = "client!as", name = "run", descriptor = "()V", line = 124)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Llm;Z)V", line = 252)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!as", name = "e", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!as", name = "f", descriptor = "(I)V", line = 299)
