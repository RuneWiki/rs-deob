...
public class class155 extends class329 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIBIF)V", line = 25)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II[I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(BI)V", line = 254)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(BI)V", line = 273)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 296)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIZI)V", line = 374)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ldga;IIIII)V", line = 387)
