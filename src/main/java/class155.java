...
public class class155 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lqa;IIIILpp;I)Lc;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lmd;B)V")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IBLpp;IILna;Lqa;ZIIILna;II)Lc;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IZILna;IILqa;IILpp;Lna;II)Lc;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lmd;II)V")
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Lqa;IIIILpp;I)Lc;")
