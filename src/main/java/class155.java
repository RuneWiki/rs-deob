...
public class class155 extends class396 {
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lor;Lpl;)V", line = 73)
