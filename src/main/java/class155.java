...
public class class155 extends class95 implements class19 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "()I", line = 5)
    public final int method49() {
        return 0;
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lh;I[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I[BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(III)V", line = 19)
