...
public class class155 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 585)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)[Ldm;", line = 597)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIIILkj;)V", line = 685)
