...
public class class155 implements Runnable {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IBZI)I", line = 8)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIB)V", line = 35)
    ...
    @OriginalMember(owner = "client!jd", name = "run", descriptor = "()V", line = 51)
