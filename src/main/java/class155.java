...
public class class155 extends class338 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ltg;)Lib;", line = 9)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
