...
public abstract class class155 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lsf;)V", line = 27)
    public class155(class551 arg0) {
        this.field2533 = arg0;
    }

    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!mr", name = "d", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!mr", name = "f", descriptor = "(I)V", line = 95)
