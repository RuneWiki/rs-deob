...
public class class155 extends class142 {
    ...
    @OriginalMember(owner = "client!se", name = "ma", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!se", name = "ba", descriptor = "(Lia;)V", line = 13)
    ...
    @OriginalMember(owner = "client!se", name = "O", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "()Lia;", line = 36)
    ...
    @OriginalMember(owner = "client!se", name = "E", descriptor = "(III[I)V", line = 52)
    ...
    @OriginalMember(owner = "client!se", name = "YA", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(III[I)V", line = 70)
    ...
    @OriginalMember(owner = "client!se", name = "HA", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!se", name = "na", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!se", name = "Q", descriptor = "(IIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!se", name = "ZA", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!se", name = "X", descriptor = "([I)V", line = 161)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "()V", line = 175)
    public class155() {
        this.method979();
    }

    @OriginalMember(owner = "client!se", name = "R", descriptor = "(III)V", line = 179)
