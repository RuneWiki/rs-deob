...
public class class155 extends class92 {
    ...
    @OriginalMember(owner = "client!ql", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IILqv;)V", line = 44)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(BII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZB)V", line = 91)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lnd;)V", line = 116)
