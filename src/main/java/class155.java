...
public class class155 extends class189 {
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(CI)I", line = 52)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLnn;)V", line = 79)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(CI)I", line = 100)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILnn;)V", line = 126)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "([ILsf;[I[II)V", line = 196)
