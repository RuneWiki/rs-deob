...
public class class155 extends class349 implements class351 {
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lnr;Lta;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lnr;Z)V")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLnr;IIZLcb;I)V")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BILnr;)Lqc;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lnr;I)V")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILnr;II)Z")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILnr;)V")
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(Lnr;Z)Lg;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIIZIILro;)V")
