...
public class class155 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lee;I)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lvfa;III)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)Luk;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILee;I)V")
