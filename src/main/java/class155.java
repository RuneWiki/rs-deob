...
public class class155 extends class295 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZI)I", line = 27)
    public static final int method1187(boolean arg0, int arg1) {
        field2350++;
        return arg0 ? 95 : arg1 & 0xFF;
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lap;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lap;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III)I", line = 125)
