...
public class class155 extends class311 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IILts;Li;ZZIIILea;IIIII)Lts;", line = 7)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(II)V", line = 244)
