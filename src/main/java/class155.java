...
public class class155 extends class81 implements class161 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Laa;IB)Lhc;")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Laa;Lsk;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Laa;Z)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIILaa;)Z")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Laa;I)Lcn;")
