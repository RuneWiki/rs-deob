...
public class class155 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lac;I)Ldv;", line = 18)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)Lln;", line = 79)
