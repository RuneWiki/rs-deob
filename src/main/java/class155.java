...
public class class155 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lza;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "()V")
    public static void method1116() {
        field2391 = null;
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lza;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lza;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lza;IZLjava/awt/Component;)V")
