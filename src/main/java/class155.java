...
public class class155 extends class96 {
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)J", line = 5)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "()V", line = 81)
    public class155() {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(II)I", line = 46)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(B)J", line = 95)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 113)
