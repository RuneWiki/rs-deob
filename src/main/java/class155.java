...
public class class155 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lha;[II)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lha;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lha;[II[I[I)V")
