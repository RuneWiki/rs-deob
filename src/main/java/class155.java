...
public class class155 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "([Lrs;B)I")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)Lrs;")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)Lrs;")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lrs;IJ)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIILmm;IZ)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IJ)Lrs;")
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(Z)Lrs;")
