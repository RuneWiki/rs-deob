...
public class class155 extends class400 {
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(II)Lna;", line = 5)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIB)V", line = 327)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 362)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZI)Lwp;", line = 374)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(IIIIIIII)V", line = 426)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BLjg;)V", line = 627)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IZ)V", line = 675)
