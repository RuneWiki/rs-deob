...
public class class155 extends class214 {
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "()V", line = 3)
    public class155() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BI)I", line = 6)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILofa;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bp", name = "f", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IB)[I", line = 191)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lraa;I)V", line = 223)
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!bp", name = "g", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "(II)[[I", line = 298)
