...
public class class155 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILqa;)V", line = 25)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 128)
