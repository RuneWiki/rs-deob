...
public class class155 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lfr;BLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lfr;B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILfr;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLhc;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILfr;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(CII)C")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lfo;I)V")
