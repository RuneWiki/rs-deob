...
public class class155 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIBLpea;II)Lmm;", line = 20)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B[B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lqe;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ldga;I)V", line = 147)
