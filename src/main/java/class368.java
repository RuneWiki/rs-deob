...
public class class368 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)Lsi;", line = 43)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)V", line = 109)
