...
public class class368 extends class694 {
    ...
    @OriginalMember(owner = "client!ga", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(II)[[I", line = 36)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "()V", line = 75)
    public class368() {
        this(0);
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILjr;B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(I)V", line = 114)
    private class368(int arg0) {
        super(0, false);
        this.method2166(arg0, (byte) -104);
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IB)V", line = 125)
