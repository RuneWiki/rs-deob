...
public class class368 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZILwn;)V", line = 46)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILwn;)V", line = 74)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BLwn;)V", line = 109)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILqa;IZ)Laa;", line = 157)
