...
public class class368 extends class739 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lrba;Z[[[BIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II)[I", line = 80)
    ...
    @OriginalMember(owner = "client!ll", name = "e", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lsl;II)V", line = 247)
    ...
    @OriginalMember(owner = "client!ll", name = "f", descriptor = "(I)V", line = 336)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "()V", line = 364)
    public class368() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ll", name = "a", descriptor = "([ILrl;[II[I)V", line = 373)
