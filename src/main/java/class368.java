...
public class class368 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([[[Lnt;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lfs;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lfd;)V", line = 140)
    public class368(class365 arg0) {
        this.field5470 = arg0;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(FLcf;ILcf;)Z", line = 154)
