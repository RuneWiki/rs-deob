...
public abstract class class368 extends class329 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(FFIF)F", line = 45)
