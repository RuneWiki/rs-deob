...
public class class368 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IZ)Llk;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(B)Liba;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BI)Lvga;")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Lcr;ILla;Lla;Lla;)V")
