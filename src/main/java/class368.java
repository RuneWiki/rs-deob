...
public class class368 extends class418 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Le;I)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lwb;I)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lbl;IFBZ)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZILvm;Lbl;[Lqs;I)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lor;IIII)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILe;)V")
