...
public class class368 extends class351 {
    ...
    @OriginalMember(owner = "client!wr", name = "e", descriptor = "()V", line = 3)
    public static void method2346() {
        field5232 = null;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wr", name = "d", descriptor = "()V", line = 12)
    public final void method19() {
        field5232.method971((byte) -88, this.field5233);
    }

    @OriginalMember(owner = "client!wr", name = "c", descriptor = "()I", line = 15)
    public final int method17() {
        return field5232.method970(22109, this.field5233);
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "()V", line = 18)
    public final void method21() {
        field5232.method967(this.field5233, super.field4997);
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 23)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lvj;I)V", line = 25)
    public class368(class177 arg0, int arg1) {
        field5232 = arg0.method1392(-1);
        this.field5233 = arg1;
    }

    @OriginalMember(owner = "client!wr", name = "b", descriptor = "()V", line = 30)
