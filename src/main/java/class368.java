...
public class class368 implements class444 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)Lhl;", line = 46)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIIII)I", line = 57)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(II[BB)I", line = 76)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(ILmp;Lfe;IIIIIIIZ)V", line = 207)
