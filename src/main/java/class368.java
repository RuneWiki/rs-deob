...
public class class368 extends class221 {
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lrl;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!gh", name = "d", descriptor = "(I)V", line = 33)
    public static final void method2242(int arg0) {
        ++field5522;
        class142.field1855 = class372.method2265((byte) 80, 4, true, 35, 2048, arg0, 8, 0.4F);
    }

    @OriginalMember(owner = "client!gh", name = "e", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 68)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lrl;IIZ[[BI)V", line = 104)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lso;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lrl;IIZ[[I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)V", line = 157)
