...
public class class368 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ljava/applet/Applet;ZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Object;Ljava/applet/Applet;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;")
