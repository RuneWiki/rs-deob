...
public class class368 extends class496 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II[BLjava/io/File;)V", line = 44)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)V", line = 68)
