...
public class class368 extends class232 {
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IB)[I", line = 13)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IIB)V", line = 25)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "()V", line = 43)
    public class368() {
        super(0, true);
    }
