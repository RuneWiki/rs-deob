...
public class class368 implements Runnable {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 12)
    public static void method2136(byte arg0) {
        int var1 = 61 % ((arg0 - 48) / 40);
        field4965 = null;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(FIFIIIIIIFZI[F)V", line = 24)
    ...
    @OriginalMember(owner = "client!de", name = "run", descriptor = "()V", line = 119)
