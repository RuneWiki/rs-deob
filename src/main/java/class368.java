...
public class class368 extends class184 {
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)[[I", line = 167)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II)[I", line = 252)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 312)
    public class368() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BILfh;)V", line = 316)
