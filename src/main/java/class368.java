...
public class class368 extends class395 {
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lkfa;Lll;[Lfda;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!en", name = "OA", descriptor = "(CIIIZ)V", line = 241)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(CIIIZLua;II)V", line = 262)
