...
public class class368 extends class7 implements class31 {
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lag;IZ[[I)V", line = 10)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(BI)I", line = 61)
