...
public class class368 extends class82 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Llp;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 230)
    public class368() {
        super(1, true);
    }

    @OriginalMember(owner = "client!af", name = "h", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(II)I", line = 107)
    public static final int method2063(int arg0, int arg1) {
        ++field4832;
        return arg1 <= 76 ? 87 : arg0 >>> 7;
    }

    @OriginalMember(owner = "client!af", name = "c", descriptor = "(II)[I", line = 118)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IILos;)V", line = 188)
    ...
    @OriginalMember(owner = "client!af", name = "i", descriptor = "(I)V", line = 234)
