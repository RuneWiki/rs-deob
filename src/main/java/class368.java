...
public class class368 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILab;Z)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILkd;ILjava/awt/Canvas;Leg;I)Loj;", line = 87)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lab;B)Ljava/lang/String;", line = 112)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILkd;)[Lep;", line = 141)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 195)
