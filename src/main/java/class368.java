...
public class class368 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 34)
