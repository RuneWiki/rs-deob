...
public class class368 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lgs;)V")
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)Lqc;")
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ldm;I)V")
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lqc;B)V")
    ...
    @OriginalMember(owner = "client!bfa", name = "c", descriptor = "(I)Lqc;")
    ...
    @OriginalMember(owner = "client!bfa", name = "d", descriptor = "(I)V")
