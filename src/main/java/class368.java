...
public class class368 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(JB)Lwfa;", line = 27)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BIII)I", line = 56)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(JLwfa;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)I", line = 111)
    public static int method2314(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(JI)V", line = 119)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZLjava/lang/String;ZI)V", line = 152)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(I)V", line = 1164)
