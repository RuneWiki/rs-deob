...
public class class368 extends class338 implements class323 {
    ...
    @OriginalMember(owner = "client!wc", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lqa;B)V", line = 92)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lqa;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!wc", name = "e", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLrn;ZIILqa;I)V", line = 138)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(IIILmu;)V", line = 150)
    public class368(int arg0, int arg1, int arg2, class338 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field4729 = arg3;
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IZILqa;)Z", line = 158)
    public final boolean method179(int arg0, boolean arg1, int arg2, class129 arg3) {
        field4734++;
        return arg1;
    }

    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(Lqa;B)Lvs;", line = 169)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)I", line = 179)
    ...
    @OriginalMember(owner = "client!wc", name = "h", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Z)Z", line = 210)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(I)I", line = 221)
    public final int method414(int arg0) {
        field4738++;
        return arg0 == 17350 ? 0 : -51;
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IILqa;)Lc;", line = 246)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLqa;)V", line = 264)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IBIIII)V", line = 274)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILjava/lang/String;)J", line = 328)
