...
public class class368 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lnn;Z[B)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lda;BLjava/lang/String;I)Lhh;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILgh;)Lgh;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lke;III)V")
