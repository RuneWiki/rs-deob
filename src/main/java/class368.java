...
public class class368 extends class443 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)Lio;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "([ILco;Z)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lco;Z)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BLco;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lco;II)V")
