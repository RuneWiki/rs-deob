...
public class class368 extends class305 {
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lhb;)V", line = 69)
    public class368(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(II)I", line = 83)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(ILhb;)V", line = 96)
    public class368(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(II)V", line = 100)
