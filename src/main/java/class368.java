...
public class class368 extends class9 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!a", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 4)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field5246 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Z)I", line = 21)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 34)
