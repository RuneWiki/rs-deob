...
public class class368 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(B)V", line = 11)
    public static void method2317(byte arg0) {
        field5215 = null;
        int var1 = 12 / ((arg0 + 5) / 61);
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 23)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIILcea;)V", line = 117)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 308)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)I", line = 139)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)V", line = 321)
