...
public class class368 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLg;)V", line = 70)
