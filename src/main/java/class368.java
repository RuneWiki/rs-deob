...
public class class368 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIZBZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLbd;)V", line = 38)
