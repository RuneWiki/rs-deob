...
public class class368 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lti;)V", line = 7)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Lti;)V", line = 22)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "()V", line = 49)
    public class368() {
        this.field5513[0] = 0;
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "()V", line = 59)
