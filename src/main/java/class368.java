...
public class class368 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IJ)V", line = 51)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III[B)V", line = 67)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lcs;II)V", line = 722)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BIIIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)J", line = 325)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 340)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Z)Z", line = 419)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II[BI)V", line = 434)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([II)Ljava/lang/String;", line = 622)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([BI)V", line = 694)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)Ljava/io/File;", line = 710)
