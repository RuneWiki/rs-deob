...
public class class368 extends class66 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIFIIZII)[I", line = 4)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(II)V", line = 35)
    public class368(int arg0, int arg1) {
        this.field5764 = arg0;
        this.field5761 = arg1;
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I[B)[B", line = 50)
