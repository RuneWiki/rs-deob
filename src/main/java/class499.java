...
public class class499 extends class356 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Liaa;I)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BILiaa;)V")
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(III)Las;")
