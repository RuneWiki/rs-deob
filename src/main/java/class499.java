...
public class class499 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lug;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lug;Ljaggl/memory/NativeBuffer;)V", line = 21)
