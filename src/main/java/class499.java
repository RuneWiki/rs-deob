...
public class class499 {
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(II)Lgm;")
    ...
    @OriginalMember(owner = "client!ht", name = "d", descriptor = "(II)Ltt;")
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lbt;ILkda;Lkda;Lkda;)V")
