...
public class class499 extends class330 implements class665 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)V", line = 5)
    public final void method702(byte arg0) {
        this.field4686.method2815(25, this);
        int var2 = -66 / ((arg0 + 69) / 43);
    }

    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Luda;Lg;III[B)V", line = 14)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BLag;)V", line = 89)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 100)
