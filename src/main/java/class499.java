...
public class class499 implements class498 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BIZIFI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II)Z", line = 13)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(FIZIII)[I", line = 38)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(II)Lpp;", line = 52)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIFZB)[F", line = 64)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILgj;Loa;BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lbi;Lbi;Lbi;)V", line = 119)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(II)Ldga;", line = 335)
