...
public class class499 extends class392 implements class170 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lur;I[BIZ)V", line = 18)
    public class499(class377 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7280 = arg1;
    }

    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lur;ILjaggl/memory/NativeBuffer;IZ)V", line = 26)
    public class499(class377 arg0, int arg1, NativeBuffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7280 = arg1;
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[BII)V", line = 35)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)I", line = 58)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(I)J", line = 70)
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(I)V", line = 87)
