...
public class class499 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILfca;)I")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IBLun;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILun;II)V")
