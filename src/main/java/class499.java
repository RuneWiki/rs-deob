...
public class class499 {
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(I)V", line = 2)
    public class499(int arg0) {
        this.field7211 = (byte) arg0;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BLnp;)Laea;", line = 24)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIIIBI)V", line = 54)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IILjava/lang/String;IIIILho;Lwp;Lla;Lua;I)V", line = 259)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 310)
