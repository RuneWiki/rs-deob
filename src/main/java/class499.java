...
public class class499 extends class123 {
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(ILlp;Llp;Lcg;Lwd;I[BIZ)V", line = 802)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)Lgj;", line = 26)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(B)I", line = 124)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BI)V", line = 150)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(III)Lgh;", line = 179)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(I)V", line = 440)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IB)I", line = 465)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II)[B", line = 482)
    ...
    @OriginalMember(owner = "client!oga", name = "e", descriptor = "(B)V", line = 501)
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(I)I", line = 516)
    ...
    @OriginalMember(owner = "client!oga", name = "d", descriptor = "(I)I", line = 530)
    ...
    @OriginalMember(owner = "client!oga", name = "e", descriptor = "(I)V", line = 555)
    ...
    @OriginalMember(owner = "client!oga", name = "d", descriptor = "(B)V", line = 599)
