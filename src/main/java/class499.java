...
public class class499 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZLkj;Ljava/lang/String;ZB)V", line = 36)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)Z", line = 105)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIBIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)V", line = 255)
