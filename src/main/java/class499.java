...
public abstract class class499 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIZZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)Lff;", line = 47)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)Lkh;", line = 69)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)Z", line = 80)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(I)D", line = 119)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!va", name = "d", descriptor = "(I)Lrc;", line = 182)
    ...
    @OriginalMember(owner = "client!va", name = "e", descriptor = "(I)Z", line = 302)
    ...
    @OriginalMember(owner = "client!va", name = "f", descriptor = "(I)Llr;", line = 327)
    public final class754 method2923(int arg0) {
        field7040++;
        return arg0 > -91 ? null : this.field7024;
    }

    @OriginalMember(owner = "client!va", name = "g", descriptor = "(I)V", line = 339)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Z)V", line = 368)
    ...
    @OriginalMember(owner = "client!va", name = "h", descriptor = "(I)V", line = 490)
    ...
    @OriginalMember(owner = "client!va", name = "i", descriptor = "(I)V", line = 529)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILjava/lang/String;)V", line = 563)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(I)V", line = 623)
