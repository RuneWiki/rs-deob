...
public class class499 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIII)Loa;", line = 121)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 132)
