...
public class class499 extends class38 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILrg;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BI)[I", line = 106)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "()V", line = 590)
    public class499() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 367)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lrg;I)Lmca;", line = 386)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILjava/util/Random;III[[I)V", line = 398)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ZI)I", line = 609)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 620)
