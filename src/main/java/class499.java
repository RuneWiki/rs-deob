...
public class class499 implements Runnable {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I[B)Lf;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIILkba;B)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljava/lang/String;B)Ltaa;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILjca;)V")
