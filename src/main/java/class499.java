...
public abstract class class499 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 4)
    public void method197(byte arg0) {
        int var2 = 66 / ((arg0 + 69) / 46);
        field6393++;
    }

    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(B)V", line = 39)
    public void method1766(byte arg0) {
        int var2 = 12 / ((-arg0 - 41) / 33);
        field6400++;
    }

    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(B)V", line = 48)
    public void method198(byte arg0) {
        int var2 = 84 % ((-arg0 - 66) / 36);
        field6399++;
    }

    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I[B)[B", line = 98)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILjava/net/Socket;I)Lrga;", line = 117)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lgd;)V", line = 136)
    public class499(class696 arg0) {
        this.field6405 = arg0;
    }

    @OriginalMember(owner = "client!tu", name = "e", descriptor = "(I)V", line = 146)
