...
public class class499 extends class42 {
    ...
    @OriginalMember(owner = "client!ge", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "e", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(B)Z", line = 266)
