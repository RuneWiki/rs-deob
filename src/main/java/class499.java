...
public class class499 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(BLej;)V", line = 6)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([II[III)V", line = 49)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 137)
