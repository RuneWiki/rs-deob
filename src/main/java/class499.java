...
public class class499 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ZIB)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)V", line = 77)
