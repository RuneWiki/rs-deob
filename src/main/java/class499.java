...
public class class499 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(ILcea;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(ILcea;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IIZ)Z", line = 49)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I)V", line = 67)
