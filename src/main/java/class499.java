...
public abstract class class499 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILija;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(III[ZLija;IZIIIILija;ILija;Lija;)V", line = 65)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZIIIILija;Lija;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIIIIII)J", line = 179)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(III[II[IIZII)V", line = 199)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILha;)V", line = 296)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BLfca;I)Ljava/lang/String;", line = 412)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILs;IIIIII)V", line = 456)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILija;II[IIIZLija;IB)V", line = 573)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Luja;[ILg;ZIIILg;[ZIIZ)V", line = 612)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 830)
