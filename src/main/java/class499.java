...
public class class499 extends class145 {
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 4)
    public class499() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cr", name = "i", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILrt;)V", line = 63)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(Z)V", line = 149)
    ...
    @OriginalMember(owner = "client!cr", name = "f", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ZI)[I", line = 179)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 295)
