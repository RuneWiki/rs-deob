...
public class class499 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lpb;BLpb;)V", line = 6)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(I)V", line = 50)
