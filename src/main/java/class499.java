...
public class class499 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ZLpg;I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BLvk;Lpg;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILpg;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BLpg;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lpg;B)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lub;IZI)Lho;")
