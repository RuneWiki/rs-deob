...
public class class499 extends class741 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZILjava/lang/String;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IILml;)V", line = 85)
    ...
    @OriginalMember(owner = "client!bca", name = "d", descriptor = "(I)V", line = 102)
    public final void method434(int arg0) {
        ++field6846;
        int var2 = 98 / ((arg0 - 10) / 44);
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Llba;)V", line = 127)
    public class499(class223 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(B)Z", line = 131)
    ...
    @OriginalMember(owner = "client!bca", name = "e", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III)V", line = 172)
