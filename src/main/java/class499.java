...
public class class499 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZB)V", line = 8)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lp;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 69)
