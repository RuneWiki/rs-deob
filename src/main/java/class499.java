...
public class class499 extends class712 {
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Z)V", line = 3)
    public final void method389(boolean arg0) {
        super.field9945.method1506(16, arg0);
        ++field6971;
    }

    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IILhba;)V", line = 25)
    ...
    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(Z)Z", line = 40)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Lrl;)V", line = 51)
    public class499(class232 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZB)V", line = 54)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(III)V", line = 65)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BZ)V", line = 76)
