...
public class class499 extends InputStream {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(III)Z", line = 11)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!nd", name = "read", descriptor = "()I", line = 35)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 44)
