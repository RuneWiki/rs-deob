...
public class class499 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZIIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)V", line = 167)
