...
public class class499 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIIIILpe;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(J[I[S[S)V", line = 86)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "()V", line = 98)
    protected class499() {
    }
}
