...
public class class499 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ILps;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(BLps;)V", line = 28)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)V", line = 58)
