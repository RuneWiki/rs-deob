...
public class class499 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)Llv;", line = 4)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)Z", line = 88)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BII)Z", line = 103)
