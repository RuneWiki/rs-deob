...
public class class499 extends class567 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z)I", line = 11)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "(I)[B", line = 104)
