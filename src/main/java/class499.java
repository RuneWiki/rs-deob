...
public class class499 extends class260 {
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IB)I", line = 95)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(I)I", line = 110)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(ILfca;)V", line = 134)
    public class499(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(IB)V", line = 160)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lfca;)V", line = 172)
    public class499(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(I)Z", line = 175)
