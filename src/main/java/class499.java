...
public class class499 extends Canvas {
    ...
    @OriginalMember(owner = "client!tp", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void paint(Graphics arg0) {
        field6229++;
        this.field6231.paint(arg0);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IJ)V", line = 12)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZB)V", line = 80)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(III)Z", line = 97)
    ...
    @OriginalMember(owner = "client!tp", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 111)
    public final void update(Graphics arg0) {
        field6230++;
        this.field6231.update(arg0);
    }

    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 118)
