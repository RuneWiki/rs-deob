...
public class class499 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZLjava/lang/String;ILla;)V", line = 12)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IILou;IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 53)
