...
public abstract class class499 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BIIZ)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I[[BLm;)V", line = 56)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(III)V", line = 130)
