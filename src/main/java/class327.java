...
public class class327 extends class435 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "([II[IZI)J", line = 5)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Loj;IIILza;ILoe;IIZ)Le;", line = 47)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I[[BLsv;)V", line = 303)
