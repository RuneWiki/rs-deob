...
public class class327 extends class262 {
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lag;IIZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lag;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lrc;Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(II)V", line = 116)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lag;IIZ[[BI)V", line = 191)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IBIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!d", name = "g", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILr;)V", line = 160)
