...
public class class327 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(DZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Ljava/awt/Component;Lpi;BII)Lcv;", line = 31)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(B)V", line = 125)
