...
public class class327 extends class229 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IILao;)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lof;B)Z")
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lht;Lgo;)V")
