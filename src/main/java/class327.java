...
public class class327 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lec;)V", line = 12)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(III)I", line = 83)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)[I", line = 115)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "()V", line = 439)
