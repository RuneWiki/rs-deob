...
public class class327 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)[Lvfa;", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lpaa;I)Lpaa;", line = 15)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([[BLtp;B)V", line = 54)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 168)
