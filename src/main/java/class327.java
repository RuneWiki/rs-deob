...
public abstract class class327 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IZLkt;IILkt;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Z[ZZZ[ILpb;IIILds;Lpb;I)V", line = 57)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lkt;Lkt;[ZIILkt;IZIIILkt;III)V", line = 268)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "([I[IIIIZIIZI)V", line = 326)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lkt;[IIIIZIIILkt;I)V", line = 438)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)Lgm;", line = 473)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I[B)Lvg;", line = 495)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIIILog;III)V", line = 587)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BIZIIII)V", line = 704)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIBIII)V", line = 730)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILkt;)V", line = 761)
