...
public class class327 extends class38 {
    ...
    @OriginalMember(owner = "client!hs", name = "f", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "()V", line = 97)
    public class327() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILrg;)V", line = 102)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZZLmba;Z)V", line = 150)
