...
public class class327 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BLdc;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILdc;I)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZIILvi;Lvi;ZI)I")
