...
public abstract class class327 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II)Z", line = 52)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(III)Lkl;", line = 68)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lqr;[I[I[II)V", line = 76)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(II)V", line = 216)
