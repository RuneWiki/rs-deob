...
public class class327 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Ljava/lang/Object;Lmb;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lmb;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lec;B)V", line = 76)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILuh;)V", line = 131)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)I", line = 159)
    public static final int method2059(int arg0, int arg1) {
        return class495.field7234 == null ? 0 : class495.field7234[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)I", line = 163)
    public final int method2060(byte arg0) {
        field5141++;
        return arg0 == -117 ? this.field5159 : 100;
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILmb;)Ljava/lang/Object;", line = 174)
    ...
    @OriginalMember(owner = "client!sg", name = "c", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BLmb;Ljava/lang/Object;)V", line = 259)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(II)V", line = 272)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILia;)V", line = 322)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(I)V", line = 376)
