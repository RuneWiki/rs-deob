...
public class class327 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BLjava/lang/String;)V", line = 28)
