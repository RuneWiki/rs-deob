...
public class class327 extends class518 {
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BJ)V", line = 45)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(II)V", line = 138)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)[[I", line = 166)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "()V", line = 243)
    public class327() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIZII)V", line = 246)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILjc;I)V", line = 337)
