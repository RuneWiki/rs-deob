...
public class class327 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)Z", line = 8)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLjava/awt/Component;)Lnk;", line = 23)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 35)
