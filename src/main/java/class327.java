...
public class class327 extends class615 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BILeh;)V", line = 8)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "()V", line = 54)
    public class327() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IB)[I", line = 67)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(I)V", line = 137)
