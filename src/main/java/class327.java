...
public class class327 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)V", line = 7)
    public static void method2042(int arg0) {
        field4834 = null;
        field4831 = null;
        int var1 = -74 / ((arg0 - 35) / 37);
    }

    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(CIZ)C", line = 17)
    public static final char method2043(char arg0, int arg1, boolean arg2) {
        field4833++;
        if (arg0 >= 'À' && arg0 <= 'ÿ') {
            if (arg0 >= 'À' && arg0 <= 'Æ') {
                return 'A';
