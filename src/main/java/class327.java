...
public class class327 extends class56 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lar;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "()V", line = 53)
    public class327() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)[I", line = 60)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BILes;)V", line = 103)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BI)[[I", line = 152)
