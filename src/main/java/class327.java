...
public class class327 implements class243 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZIFII)[I", line = 5)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZFIIII)[I", line = 35)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)Lqg;", line = 46)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BI)Z", line = 57)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZ)Lar;", line = 105)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIFIZI)[F", line = 131)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lok;Lok;Lok;)V", line = 153)
