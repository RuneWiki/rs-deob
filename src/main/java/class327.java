...
public class class327 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIIIZILpfa;)V", line = 19)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 110)
    public class327() {
    }

    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lji;)V", line = 112)
