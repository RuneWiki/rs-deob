...
public class class327 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lwd;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BI)I", line = 192)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)Z", line = 203)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)Ljava/lang/String;", line = 215)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Z)Ldg;", line = 464)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIZ)Z", line = 493)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(B)Ldg;", line = 506)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "()V", line = 531)
    public class327() {
    }

    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Ldr;)V", line = 533)
