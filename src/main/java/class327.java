...
public class class327 extends class74 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(JIIZLpl;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIB)V", line = 51)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Len;)V", line = 62)
    public class327(class478 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ti", name = "f", descriptor = "(I)V", line = 84)
    public static void method1868(int arg0) {
        field4187 = null;
        int var1 = 1 % (-arg0 / 49);
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILhfa;)V", line = 93)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZZ)V", line = 106)
