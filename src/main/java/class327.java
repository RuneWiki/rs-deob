...
public class class327 extends class210 implements class425 {
    ...
    @OriginalMember(owner = "client!bg", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLza;II)Z", line = 48)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lza;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)I", line = 95)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lza;Ljc;IIIIIZIIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLza;)V", line = 126)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILza;I)Le;", line = 148)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)I", line = 159)
    public final int method224(int arg0) {
        ++field4956;
        return arg0 != -10848 ? 119 : this.field4957.field3692;
    }

    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)I", line = 172)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IB)Lmv;", line = 190)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(Lza;I)Lnd;", line = 208)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lza;Z)V", line = 250)
