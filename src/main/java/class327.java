...
public class class327 extends class424 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "()V", line = 106)
    public class327() {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)J", line = 54)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 89)
