...
public class class327 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IBI[B)I", line = 25)
    ...
    @OriginalMember(owner = "client!dq", name = "finalize", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IJ)V", line = 77)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)Ljava/io/File;", line = 89)
    public final File method2112(byte arg0) {
        field4827++;
        return arg0 == 91 ? this.field4820 : null;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)J", line = 101)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 140)
