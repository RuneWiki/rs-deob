...
public class class327 extends class6 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/awt/Component;BZ)La;", line = 8)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IB)Z", line = 32)
    public final boolean method1896(int arg0, byte arg1) {
        field4470++;
        return arg1 == 122 ? this.field4471[arg0].field6987 : false;
    }

    @OriginalMember(owner = "client!cq", name = "f", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIIIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)Z", line = 323)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(I)V", line = 336)
    public class327(int arg0) {
        this.field4468 = arg0;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BI)Z", line = 347)
