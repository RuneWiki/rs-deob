...
public class class327 implements Runnable {
    ...
    @OriginalMember(owner = "client!hp", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZI[BI)V", line = 95)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljava/lang/String;IB)Lbl;", line = 154)
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(CILjava/lang/String;)[Ljava/lang/String;", line = 210)
