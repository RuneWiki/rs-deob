...
public class class327 extends Canvas {
    ...
    @OriginalMember(owner = "client!kka", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(ILha;ZI)Lda;")
    ...
    @OriginalMember(owner = "client!kka", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!kka", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
