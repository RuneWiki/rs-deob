...
public class class327 implements class93 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([ILdc;JZ)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z[BII)[B", line = 48)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 64)
