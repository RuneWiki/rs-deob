...
public class class327 extends class354 {
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(ILwo;)V", line = 17)
    public class327(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(B)I", line = 21)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(II)I", line = 31)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lwo;)V", line = 42)
    public class327(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(B)I", line = 69)
