...
public class class327 extends class199 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([B[IIIIIIIIIIILoj;II)V")
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "([B[IIIIIIIIIIILoj;II)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(CIIIZLoj;II)V")
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Let;Lkg;[Lgm;[I[I)V")
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "([B[IIIIIIII)V")
