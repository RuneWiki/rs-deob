...
public class class327 extends class388 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I[[BLcd;)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILpc;Lqa;)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I[[[Lht;BIIZ)Z")
    ...
    @OriginalMember(owner = "client!so", name = "c", descriptor = "(Z)V")
