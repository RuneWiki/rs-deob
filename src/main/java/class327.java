...
public class class327 extends OutputStream {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IB)I", line = 25)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)I", line = 40)
    ...
    @OriginalMember(owner = "client!gh", name = "write", descriptor = "(I)V", line = 181)
