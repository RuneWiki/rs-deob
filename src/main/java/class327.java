...
public class class327 extends class306 implements class243 {
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lqg;ILjaggl/memory/NativeBuffer;)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZLhh;)V")
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lqg;I[BI)V")
