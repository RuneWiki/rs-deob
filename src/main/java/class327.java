...
public class class327 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)Z", line = 89)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IFLkga;Lkga;)Z", line = 128)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lkv;)V", line = 196)
    public class327(class280 arg0) {
        this.field4887 = arg0;
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZIII)I", line = 213)
