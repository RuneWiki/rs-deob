...
public class class327 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILw;II)V")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILw;B)Z")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lw;BII)V")
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lfo;Low;)V")
