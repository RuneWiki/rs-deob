...
public class class327 extends class305 implements class218 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IILtq;Z)Lri;")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Ltq;Lvc;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ltq;IB)Lns;")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILtq;)V")
