...
public class class327 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BIIILqa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!so", name = "toString", descriptor = "()Ljava/lang/String;", line = 105)
    public final String toString() {
        field4653++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(II)V", line = 118)
