...
public class class327 extends class98 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lpt;BII)V", line = 22)
    ...
    @OriginalMember(owner = "client!bga", name = "b", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!bga", name = "c", descriptor = "(III)I", line = 44)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IB)Z", line = 67)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lga;)V", line = 78)
