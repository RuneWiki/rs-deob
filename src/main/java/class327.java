...
public class class327 extends class159 {
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(BI)Lef;", line = 15)
    ...
    @OriginalMember(owner = "client!qja", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(B)Z", line = 98)
    ...
    @OriginalMember(owner = "client!qja", name = "c", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!qja", name = "f", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(II)Z", line = 138)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(ZI[BIIII)Z", line = 150)
    ...
    @OriginalMember(owner = "client!qja", name = "c", descriptor = "(B)Z", line = 199)
    ...
    @OriginalMember(owner = "client!qja", name = "<init>", descriptor = "(II)V", line = 216)
