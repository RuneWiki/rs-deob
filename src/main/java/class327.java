...
public class class327 extends class248 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "()V", line = 4)
    public final void method1567() {
        field4499.method45(this.field4500, super.field3565);
    }

    @OriginalMember(owner = "client!ml", name = "c", descriptor = "()V", line = 7)
    public final void method1578() {
        field4499.method46(-17078, this.field4500);
    }

    @OriginalMember(owner = "client!ml", name = "e", descriptor = "()V", line = 10)
    public static void method1956() {
        field4499 = null;
    }

    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "()I", line = 20)
    public final int method1579() {
        return field4499.method48(false, this.field4500);
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "()V", line = 23)
    public final void method1576() {
        field4499.method49(this.field4500, 72);
    }

    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Llp;I)V", line = 25)
    public class327(class331 arg0, int arg1) {
        field4499 = arg0.method2008((byte) -127);
        this.field4500 = arg1;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 30)
