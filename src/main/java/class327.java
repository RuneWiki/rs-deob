...
public class class327 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)Z", line = 11)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 28)
    public static void method1904(int arg0) {
        field4020 = null;
        int var1 = 106 % ((32 - arg0) / 51);
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "([IILck;II[I)Lgfa;", line = 50)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(BIIIIIILlq;)V", line = 78)
