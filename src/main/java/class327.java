...
public class class327 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/awt/Canvas;Lfa;B)Lr;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
