...
public class class327 extends class149 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Ltf;[[BI)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IBLtl;)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lbv;BILjava/lang/String;)Lvl;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLjava/lang/String;Ltl;)I")
