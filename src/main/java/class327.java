...
public class class327 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)Llha;", line = 67)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II[BI)[B", line = 97)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BJLlha;)V", line = 136)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)I", line = 157)
    public static int method1956(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(Z)V", line = 166)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IJ)Llha;", line = 186)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(I)V", line = 261)
