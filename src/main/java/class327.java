...
public class class327 implements class104 {
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lsea;Lec;)V", line = 48)
    public class327(class648 arg0, class213 arg1) {
        this.field4434 = arg0;
        this.field4435 = arg1;
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZZ)V", line = 59)
