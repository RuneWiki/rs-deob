...
public class class363 extends class445 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ljava/awt/Canvas;I)Ltr;", line = 39)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lur;ZLjava/lang/String;B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(Z)V", line = 91)
