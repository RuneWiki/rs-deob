...
public class class363 extends class145 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IILrt;)V", line = 12)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(III)Z", line = 145)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZLe;ILjava/awt/Canvas;)Loa;", line = 165)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZI)[I", line = 211)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILad;)V", line = 239)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B[II)V", line = 293)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(Z)V", line = 452)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIIII)I", line = 466)
