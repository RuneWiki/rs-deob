...
public class class363 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Lre;", line = 77)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)I", line = 105)
    public static final int method2169(int arg0, int arg1) {
        field5216++;
        return arg0 == 128 ? arg1 >>> 8 : -78;
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILsv;)V", line = 119)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lsv;II)V", line = 245)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)Z", line = 321)
