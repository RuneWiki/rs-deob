...
public class class363 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lvh;II)Lum;", line = 6)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "()[B", line = 15)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "()I", line = 76)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Llh;)V", line = 129)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "()Lnv;", line = 126)
