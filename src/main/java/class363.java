...
public class class363 extends class393 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILil;)Lke;", line = 4)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lnr;ILqr;IZIIZLtb;I)Lqc;", line = 16)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BII)I", line = 242)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([IZI[II)J", line = 288)
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(B)V", line = 343)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)V", line = 409)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIB)Lhn;", line = 423)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILjava/awt/Canvas;Lfl;Z)Lnr;", line = 443)
