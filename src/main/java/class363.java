...
public class class363 extends class46 {
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 184)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(III)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(III[II)Z", line = 82)
    ...
    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(II[II)Z", line = 115)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(II[II)Z", line = 141)
