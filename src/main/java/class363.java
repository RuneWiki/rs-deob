...
public class class363 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILbi;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)Z", line = 191)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIII)V", line = 306)
