...
public class class363 extends class381 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lob;Z)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILgm;III)V")
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lvj;II[B)V")
