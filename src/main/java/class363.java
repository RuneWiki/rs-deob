...
public class class363 extends class392 {
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(ILw;)V", line = 26)
    public class363(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lw;)V", line = 29)
    public class363(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)I", line = 45)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)I", line = 109)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BI)V", line = 120)
