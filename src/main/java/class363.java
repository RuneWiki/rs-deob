...
public class class363 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)Lok;", line = 53)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZLok;)V", line = 130)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(B)Lok;", line = 157)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "()V", line = 182)
    public class363() {
