...
public class class363 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILjg;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IB)Lji;")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lle;ILoi;)V")
