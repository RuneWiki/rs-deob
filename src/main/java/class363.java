...
public class class363 extends class675 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(ZLrv;)Lrl;")
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lkv;Lb;)V")
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Lfia;IZ)V")
