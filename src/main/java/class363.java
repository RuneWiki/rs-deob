...
public class class363 extends class165 implements class28 {
    ...
    @OriginalMember(owner = "client!q", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(III[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "()Lm;", line = 32)
