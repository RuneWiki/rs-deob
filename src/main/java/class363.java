...
public class class363 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILmi;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)Lsj;")
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(I)Lsj;")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(B)Lsj;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLsj;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(I)Lsj;")
