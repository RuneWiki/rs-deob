...
public class class363 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Les;Laba;)V", line = 19)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(IIF)F", line = 87)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IF)I", line = 92)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(F)F", line = 153)
    private static final float method1996(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "()V", line = 180)
