...
public class class363 extends class149 {
    ...
    @OriginalMember(owner = "client!mo", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)[I", line = 43)
    ...
    @OriginalMember(owner = "client!mo", name = "e", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 79)
    public class363() {
        super(0, true);
    }
}
