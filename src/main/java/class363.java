...
public class class363 extends class31 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lgk;II[BI)V", line = 196)
    ...
    @OriginalMember(owner = "client!jq", name = "g", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Loh;Z)Z", line = 222)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(III)Z", line = 327)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IZ)V", line = 345)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 361)
