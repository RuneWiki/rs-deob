...
public class class363 extends class117 {
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lat;Lkf;)V", line = 35)
    ...
    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(B)V", line = 1154)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lwq;Lrb;)V", line = 1208)
