...
public class class363 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)Ljn;", line = 3)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IJ)Ljn;", line = 62)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Ljn;BJ)V", line = 89)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)V", line = 122)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(I)V", line = 164)
