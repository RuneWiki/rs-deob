...
public class class363 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)Lsn;", line = 6)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lrk;I)I", line = 82)
