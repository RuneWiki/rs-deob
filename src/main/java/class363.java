...
public class class363 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lvo;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZI)I", line = 50)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 91)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 120)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILek;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lek;I)V", line = 198)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZ)Z", line = 224)
