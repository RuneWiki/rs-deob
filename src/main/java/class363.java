...
public class class363 extends class194 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIIZLak;Luo;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILjava/lang/String;IZ)Z", line = 25)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(II)[I", line = 99)
    ...
    @OriginalMember(owner = "client!dk", name = "f", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!dk", name = "h", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!dk", name = "i", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "()V", line = 290)
    public class363() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IILbg;)V", line = 299)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)V", line = 342)
