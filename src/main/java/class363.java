...
public class class363 extends class264 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "([BI)Z", line = 27)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lwt;Z)Z", line = 52)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIIIBIIILvc;I[[[BI)V", line = 157)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZLtq;Lnl;)V", line = 190)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BII)V", line = 217)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "()V", line = 231)
    public class363() {
        this(4096);
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BLjava/lang/String;)I", line = 234)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IBILhq;)Lks;", line = 254)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)V", line = 324)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BLkk;I)V", line = 336)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IC)C", line = 368)
