...
public class class363 extends class477 implements class532 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILoa;B)Lba;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Loa;Lbd;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZLoa;I)Lun;")
