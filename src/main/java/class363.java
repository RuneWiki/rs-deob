...
public class class363 {
    ...
    @OriginalMember(owner = "client!ni", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field4724++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 174)
