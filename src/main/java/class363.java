...
public class class363 extends class37 {
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(Z)[B", line = 5)
    ...
    @OriginalMember(owner = "client!sb", name = "d", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!sb", name = "e", descriptor = "(B)Ldb;", line = 71)
