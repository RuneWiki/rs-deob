...
public class class363 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(CI)V", line = 31)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lbi;I)V", line = 44)
    public class363(class483 arg0, int arg1) {
        this.field4681 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 88)
