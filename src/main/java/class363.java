...
public class class363 implements Runnable {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)I", line = 16)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Ljava/lang/String;JILwj;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(Z)J", line = 87)
    public final long method2264(boolean arg0) {
        field5099++;
        return arg0 ? this.field5106 : 103L;
    }

    @OriginalMember(owner = "client!uv", name = "run", descriptor = "()V", line = 98)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(III)Z", line = 223)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!uv", name = "d", descriptor = "(I)I", line = 250)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(B)Z", line = 264)
    ...
    @OriginalMember(owner = "client!uv", name = "e", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!uv", name = "f", descriptor = "(I)Lwj;", line = 301)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lda;)V", line = 313)
    public static final void method2271(class59 arg0) {
        class21.field268 = arg0;
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Llq;I)V", line = 324)
