...
public class class363 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZLjava/lang/Object;J)V", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 82)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lct;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 122)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(B)I", line = 154)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIJLjava/lang/Object;)V", line = 166)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZLjj;)V", line = 227)
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BJ)Ljava/lang/Object;", line = 256)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(I)I", line = 299)
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "(I)Lcs;", line = 322)
    ...
    @OriginalMember(owner = "client!bt", name = "e", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IJ)V", line = 354)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(I)V", line = 390)
