...
public class class363 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(II)Lon;", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(ILhe;Lhe;Lim;)V", line = 235)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIILpp;)Lvg;", line = 41)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIIILvh;)V", line = 132)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "([IIJLak;)Ljava/lang/String;", line = 184)
