...
public abstract class class363 extends class27 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZIJIILga;I)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILir;ZILr;IB)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "([Lqea;B)I")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z[[[Lse;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lhe;I)V")
