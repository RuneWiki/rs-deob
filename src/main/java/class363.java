...
public class class363 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(BI)I", line = 5)
    public final int method2034(byte arg0, int arg1) {
        return arg0 < 70 ? -103 : this.field4772.Present(arg1);
    }

    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 53)
