...
public class class363 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(II)Lhh;", line = 8)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lgia;ILaj;)V", line = 104)
