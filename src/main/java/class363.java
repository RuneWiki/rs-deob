...
public class class363 extends class601 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IB)I", line = 17)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(II)I", line = 29)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(B)V", line = 40)
    public static void method2305(byte arg0) {
        field5183 = null;
        int var1 = -13 % ((-1 - arg0) / 50);
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILuu;B)Lej;", line = 51)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)V", line = 79)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(ILqea;)V", line = 91)
    public class363(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lqea;)V", line = 94)
    public class363(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)I", line = 102)
    public final int method45(int arg0) {
        ++field5184;
        return arg0 != 8976 ? -115 : 1;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)V", line = 113)
