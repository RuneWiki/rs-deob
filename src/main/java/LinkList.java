...
public class LinkList {
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "Lt;")
    public Linkable field627 = new Linkable();

    @OriginalMember(owner = "client!nb", name = "e", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lt;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "()Lt;")
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "()Lt;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)Lt;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)Lt;")
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(B)Lt;")
