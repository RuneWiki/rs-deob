...
public class LinkList {
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "Lv;")
    public Linkable field749 = new Linkable();

    @OriginalMember(owner = "client!pb", name = "d", descriptor = "Lv;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lv;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILv;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "()Lv;")
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "()Lv;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)Lv;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)Lv;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)Lv;")
