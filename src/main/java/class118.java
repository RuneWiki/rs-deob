...
public class class118 extends class125 {
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILhe;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lur;)V", line = 51)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ZI)V", line = 163)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BI)V", line = 224)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZB)I", line = 319)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)Z", line = 359)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ZIBLjava/lang/String;)I", line = 378)
