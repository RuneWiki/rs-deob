...
public class class118 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lvm;Lai;III)V", line = 36)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IZ)Lhk;", line = 96)
