...
public class class118 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(II)V", line = 49)
