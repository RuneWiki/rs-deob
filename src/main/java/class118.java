...
public class class118 extends class205 {
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)I", line = 26)
    ...
    @OriginalMember(owner = "client!wj", name = "f", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!wj", name = "g", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(II)Z", line = 75)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIIIIIBI)V", line = 133)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(II)V", line = 227)
    public class118(int arg0, int arg1) {
        super.field1039 = (long) arg0 << 32 | (long) arg1;
    }

    @OriginalMember(owner = "client!wj", name = "h", descriptor = "(B)J", line = 241)
