...
public class class118 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)Ldd;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lmp;)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)Lwn;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lbi;I)V")
