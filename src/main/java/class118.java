...
public class class118 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BLff;J)V", line = 15)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!fn", name = "c", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lkj;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 404)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IJ)Lff;", line = 417)
    ...
    @OriginalMember(owner = "client!fn", name = "d", descriptor = "(B)V", line = 453)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(I)V", line = 583)
