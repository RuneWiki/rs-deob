...
public class class118 extends class398 {
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IZIIZII)V", line = 138)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(III)Z", line = 184)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 272)
    public class118() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lnj;II)V", line = 212)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IBLlm;)Lon;", line = 276)
    ...
    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)[I", line = 322)
