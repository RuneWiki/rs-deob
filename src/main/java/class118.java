...
public class class118 extends class759 implements class411 {
    ...
    @OriginalMember(owner = "client!lo", name = "r", descriptor = "J")
    public static long field1568;

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Ltga;B[[B)V", line = 3)
    public static final void method740(class258 arg0, byte arg1, byte[][] arg2) {
        int var3 = 0;
        if (arg1 != 117) {
            method740((class258) null, (byte) 103, (byte[][]) null);
        }
        while (~arg0.field5487 < ~var3) {
            class11.method51(84);
            for (int var4 = 0; class277.field4036 >> 3 > var4; ++var4) {
                for (int var5 = 0; ~var5 > ~(class667.field9202 >> 3); ++var5) {
                    int var6 = class96.field1364[var3][var4][var5];
                    if (~var6 != 0) {
                        int var7 = (54582825 & var6) >> 24;
                        if (!arg0.field5485 || var7 == 0) {
                            int var8 = 3 & var6 >> 1;
                            int var9 = var6 >> 14 & 1023;
                            int var10 = var6 >> 3 & 2047;
                            int var11 = (var9 / 8 << 8) + var10 / 8;
                            for (int var12 = 0; ~class316.field4364.length < ~var12; ++var12) {
                                if (class316.field4364[var12] == var11 && arg2[var12] != null) {
                                    arg0.method1743(var7, var4 * 8, (var9 & 7) * 8, var8, (7 & var10) * 8, class209.field2735, (byte) 91, arg2[var12], class129.field1802, var5 * 8, var3);
                                    break;
                                }
                            }
                        }
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(B)J", line = 81)
    public final long method741(byte arg0) {
        ++field1569;
        return arg0 >= -119 ? 25L : super.field10577.getAddress();
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)I", line = 97)
    public final int method742(int arg0) {
        ++field1562;
        if (arg0 != 27594) {
            this.method745((byte) 64);
        }
        return this.field1567;
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III[B)V", line = 111)
    public final void method743(int arg0, int arg1, int arg2, byte[] arg3) {
        this.method4209(arg3, arg0);
        ++field1557;
        if (arg2 != 29764) {
            field1568 = 90L;
        }
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Ldw;ILjaclib/memory/Buffer;)V", line = 140)
    public class118(class664 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field1567 = arg1;
    }

    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Ldw;I[BI)V", line = 164)
    public class118(class664 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1567 = arg1;
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)I", line = 173)
