...
public class class118 extends class321 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIBLht;)Lbu;", line = 5)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Lr;Low;Lwca;J)V", line = 462)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(JZIILr;)V", line = 133)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(I)V", line = 386)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZLr;J)V", line = 405)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IB)I", line = 424)
