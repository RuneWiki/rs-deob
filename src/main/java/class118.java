...
public class class118 extends class550 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILdw;)I", line = 10)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(B)V", line = 45)
    public static void method724(byte arg0) {
        field1520 = null;
        int var1 = 127 / ((40 - arg0) / 55);
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(B)Ljv;", line = 54)
    public final class606 method472(byte arg0) {
        field1524++;
        return arg0 == -110 ? class428.field5943 : null;
    }

    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(Lrn;Lhv;IIIIIIIIIII)V", line = 67)
