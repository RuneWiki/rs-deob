...
public class class118 extends class328 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(II)Z", line = 37)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "()V", line = 47)
    public class118() {
        super(0, true);
    }
}
