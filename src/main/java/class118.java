...
public class class118 extends class454 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "([IBLol;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(II)Lhk;")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(BLol;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(BLol;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lnfa;Z[[[BIB)Z")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lol;II)V")
