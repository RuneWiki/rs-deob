...
public class class118 extends class440 {
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(Lha;B)Lufa;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIBLha;)Z")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lha;I)Lie;")
