...
public class class118 extends class208 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "()I", line = 3)
    public final int method795() {
        return field1637.method2064(6188, this.field1636);
    }

    @OriginalMember(owner = "client!gw", name = "b", descriptor = "()V", line = 6)
    public final void method796() {
        field1637.method2063(116, this.field1636);
    }

    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "()V", line = 15)
    public final void method798() {
        field1637.method2062(this.field1636, super.field3005);
    }

    @OriginalMember(owner = "client!gw", name = "e", descriptor = "()V", line = 20)
    public static void method799() {
        field1637 = null;
    }

    @OriginalMember(owner = "client!gw", name = "d", descriptor = "()V", line = 23)
    public final void method800() {
        field1637.method2059(-26471, this.field1636);
    }

    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lnt;I)V", line = 25)
    public class118(class151 arg0, int arg1) {
        field1637 = arg0.method963(false);
        this.field1636 = arg1;
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 30)
