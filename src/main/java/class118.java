...
public class class118 extends class194 {
    ...
    @OriginalMember(owner = "client!eea", name = "q", descriptor = "(CIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(Len;Lmj;[Lkq;Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(CIIIZLfa;II)V", line = 264)
