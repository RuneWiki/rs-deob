...
public class class118 extends class491 implements class555 {
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Ler;Lua;III[B)V", line = 16)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 87)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILse;)V", line = 97)
