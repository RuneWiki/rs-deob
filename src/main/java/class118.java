...
public abstract class class118 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Ljava/lang/String;IIBLak;ILfa;ILem;ILaq;I)V")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BLgd;ILjava/awt/Canvas;Lnh;I)Luo;")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IILpo;I)V")
