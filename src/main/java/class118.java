...
public class class118 extends class412 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILoa;[IIII)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILoa;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "()Lkb;")
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lmn;)V")
    public class118(class206 arg0) {
        this.field1593 = arg0;
    }

    @OriginalMember(owner = "client!gb", name = "d", descriptor = "()Lkb;")
