...
public class class118 extends class129 {
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(ILza;)Lsr;", line = 5)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lhd;ZLhd;II)I", line = 48)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(BLza;)V", line = 152)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZI)V", line = 173)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lia;IB)Ljava/lang/String;", line = 211)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lza;III)Z", line = 255)
