...
public class class118 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ZIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)Z", line = 44)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ZII)V", line = 55)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lap;B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lnm;)V", line = 98)
