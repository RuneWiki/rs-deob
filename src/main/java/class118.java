...
public class class118 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ILjava/lang/String;)I", line = 24)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BI)Z", line = 103)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "()V", line = 117)
    public class118() {
    }

    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lfca;)V", line = 119)
