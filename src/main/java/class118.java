...
public class class118 extends class546 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lia;Lia;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lin;IZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(I)V", line = 112)
    public class118(int arg0) {
        this.field1596 = arg0;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)I", line = 120)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 140)
