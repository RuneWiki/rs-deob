...
public class class118 extends class569 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lor;IIII)Lba;", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "E", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([Lba;Lq;[Lsda;I)V", line = 138)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIIZZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 217)
    public class118(Canvas arg0, class462 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 229)
    ...
    @OriginalMember(owner = "client!vr", name = "w", descriptor = "()Z", line = 256)
    public final boolean method370() {
        ++field1465;
        return false;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 264)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 308)
    ...
    @OriginalMember(owner = "client!vr", name = "h", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(I)V", line = 340)
    public final void method345(int arg0) {
        super.field8203[arg0].method3033(8191, Thread.currentThread());
        ++field1463;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIIIIIII)V", line = 350)
    ...
    @OriginalMember(owner = "client!vr", name = "o", descriptor = "(I)V", line = 399)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([Lba;Lbe;Lq;[Lsda;I)V", line = 567)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 593)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(I)V", line = 608)
    public final void method296(int arg0) {
        super.field8203[arg0].method3033(8191, (Runnable) null);
        ++field1478;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/Runnable;)Lnw;", line = 617)
