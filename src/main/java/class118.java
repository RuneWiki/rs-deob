...
public abstract class class118 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIB[J[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIILqn;)V", line = 76)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)Z", line = 114)
