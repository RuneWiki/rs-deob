...
public class class118 extends class140 {
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lte;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IILjl;)V", line = 152)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BLjava/lang/String;)I", line = 166)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIBII)I", line = 200)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 232)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)V", line = 254)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIZ)V", line = 272)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)Z", line = 296)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZB)V", line = 307)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)V", line = 334)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IZ)V", line = 402)
