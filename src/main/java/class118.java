...
public class class118 extends class508 {
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "()V", line = 77)
    public class118() {
    }

    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 79)
