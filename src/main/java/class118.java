...
public class class118 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIILue;)V", line = 16)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Laa;IIILtc;)V", line = 23)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI[[BZ[[ILsm;[[B[[BI[[BILaa;Lsm;)V", line = 68)
