...
public class class118 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([IIJLud;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Luj;", line = 38)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(ILqn;Lqn;Ltp;)V", line = 113)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 94)
