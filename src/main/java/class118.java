...
public abstract class class118 extends class435 {
    ...
    @OriginalMember(owner = "client!qca", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "([Llaa;Z)I")
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(ILha;)Z")
