...
public class class118 extends class337 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)Lup;", line = 35)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 58)
