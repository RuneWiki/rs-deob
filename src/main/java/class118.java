...
public class class118 extends class97 {
    ...
    @OriginalMember(owner = "client!mf", name = "w", descriptor = "Ltf;")
    public class181 field2324 = new class181();

    @OriginalMember(owner = "client!mf", name = "H", descriptor = "Lt;")
    public class175 field2335 = new class175();

    @OriginalMember(owner = "client!mf", name = "r", descriptor = "Lsh;")
    private class174 field2319;

    @OriginalMember(owner = "client!mf", name = "t", descriptor = "[Lkf;")
    ...
    @OriginalMember(owner = "client!mf", name = "F", descriptor = "Lib;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BILvf;)V")
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "()Lkc;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I[ILvf;III)V")
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "()Lkc;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lsh;)V")
