...
public class class118 extends class206 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 37)
    public class118(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 54)
