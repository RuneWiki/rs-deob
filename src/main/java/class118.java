...
public class class118 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)Liq;", line = 7)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 111)
