...
public abstract class class118 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILhca;BILih;IILlk;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Los;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lqa;IILm;III[[[B[I[I[I[I[IIBIIZ)V")
