...
public class class118 implements class4 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lvo;)V", line = 245)
    public class118(class345 arg0) {
        this.field1869 = arg0;
    }

    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)Lsba;", line = 254)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III)V", line = 267)
