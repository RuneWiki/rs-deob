...
public class class118 implements class60 {
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(IB)Lhl;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILac;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(II)Lva;")
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lra;Lra;Lra;)V")
