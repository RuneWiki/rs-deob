...
public class class118 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILbq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lmh;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lbq;I)Ljava/lang/Object;", line = 64)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILfs;BI)Ljq;", line = 133)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)I", line = 152)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(II)V", line = 169)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILjava/lang/Object;Lbq;)V", line = 260)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)I", line = 272)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lbq;Ljava/lang/Object;ZI)V", line = 290)
