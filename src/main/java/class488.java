...
public abstract class class488 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqf;IZ)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Lf;III[IIBILea;ILjava/lang/String;IIIII)I")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;Ljava/util/Random;II[II[IIIIII[Lf;B)I")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III[Lf;Ljava/lang/String;[III)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[IILjava/util/Random;BI[Lf;ILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lqa;Lds;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZI[Lf;Ljava/lang/String;I[ILea;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqf;B)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[I[I[ILjava/lang/String;[Lf;II)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;[I[Lf;IIIIIIILea;IIIII)I")
