...
public class class488 extends class98 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lga;Z)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZLr;II)Z")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLr;)Lqw;")
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(Lr;I)Lcu;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lr;Z)V")
