...
public class class488 extends class577 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILqa;)V", line = 64)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lqa;I)Lpl;", line = 107)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILqa;II)Lr;", line = 118)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILqa;IB)Z", line = 134)
    ...
    @OriginalMember(owner = "client!cv", name = "e", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!cv", name = "finalize", descriptor = "()V", line = 162)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(II)I", line = 174)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lqa;BLr;)V", line = 209)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(ILqa;)Lin;", line = 233)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lfw;IIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!cv", name = "e", descriptor = "(B)I", line = 351)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lqa;IZIILco;I)V", line = 369)
    ...
    @OriginalMember(owner = "client!cv", name = "c", descriptor = "(B)Z", line = 383)
