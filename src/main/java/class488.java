...
public class class488 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BLac;)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BLac;I)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lac;B)Ljava/lang/String;")
