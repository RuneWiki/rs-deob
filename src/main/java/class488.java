...
public class class488 implements class343 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)Ldea;", line = 6)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ltf;Ljava/lang/String;)V", line = 97)
    public class488(class701 arg0, String arg1) {
        this.field7095 = arg0;
        this.field7094 = arg1;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILtf;)Lbn;", line = 106)
