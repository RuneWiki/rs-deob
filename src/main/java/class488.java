...
public class class488 extends class1 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(BLgfa;Ljk;Lha;)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I[[[BIIIIIIIIIILha;)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)[Lrq;")
