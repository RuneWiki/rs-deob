...
public class class488 extends class499 implements class486 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lbo;III)V")
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lbo;IIII)V")
