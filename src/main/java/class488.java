...
public class class488 extends class45 {
    ...
    @OriginalMember(owner = "client!cj", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lng;II)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILbu;ZLjava/lang/String;)Lil;")
