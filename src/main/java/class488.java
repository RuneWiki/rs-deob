...
public class class488 extends class108 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lwq;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "()V", line = 50)
    public class488() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BII)V", line = 64)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(JJ)J", line = 82)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIBI)[B", line = 89)
