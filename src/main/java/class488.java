...
public class class488 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IZ)Z", line = 11)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(II)Lsba;", line = 27)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([BBII)I", line = 86)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IIB)V", line = 115)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Luea;Lha;Lbm;I)V", line = 129)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(ILla;Lla;)V", line = 284)
