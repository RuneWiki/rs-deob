...
public class class488 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "([[II)V", line = 7)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILjava/lang/String;IZ)Z", line = 35)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILjava/lang/String;)V", line = 110)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(Z)V", line = 132)
