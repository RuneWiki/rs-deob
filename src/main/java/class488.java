...
public class class488 extends class208 {
    ...
    @OriginalMember(owner = "client!qg", name = "e", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Llc;ZLbt;)V", line = 21)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lkg;I)V", line = 71)
