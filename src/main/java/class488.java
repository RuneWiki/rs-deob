...
public class class488 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!dk", name = "toString", descriptor = "()Ljava/lang/String;", line = 26)
    public final String toString() {
        field6583++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(II)Z", line = 40)
