...
public abstract class class488 extends class569 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILec;)I", line = 8)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B[Lgga;II)I", line = 50)
    ...
    @OriginalMember(owner = "client!lo", name = "e", descriptor = "(I)V", line = 93)
