...
public class class488 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIZLuk;Lro;Lvs;ILlp;Lin;Lya;Ldu;I)Lt;", line = 8)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZI)V", line = 211)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILin;II)V", line = 223)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lv;Lin;Llp;I[Lnv;Luk;IILlp;BLdu;IILya;Lro;ILvs;IZ)Lt;", line = 243)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 752)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZBII[I[I)V", line = 789)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 816)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Llp;ILdu;IILin;IIILya;II)Lt;", line = 829)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIB)V", line = 985)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;IIZ)Z", line = 999)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BIII[BII)V", line = 1080)
