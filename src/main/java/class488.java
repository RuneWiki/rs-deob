...
public class class488 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZLtl;)V", line = 26)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)Z", line = 46)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(II)I", line = 77)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIIBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILtl;Z)V", line = 234)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lqa;Lns;I)V", line = 294)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 425)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 453)
