...
public class class488 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLsv;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILsv;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 140)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZI)I", line = 197)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 232)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)Z", line = 260)
