...
public class class488 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lwv;I)V")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IB)Lwu;")
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbs;ILpfa;)V")
