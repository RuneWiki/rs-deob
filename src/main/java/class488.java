...
public class class488 extends class232 implements class21 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Loi;III)Lld;", line = 14)
    ...
    @OriginalMember(owner = "client!gi", name = "e", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIIIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!gi", name = "f", descriptor = "(I)Z", line = 242)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)Z", line = 276)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILza;I)Le;", line = 302)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 313)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZIILza;)Lqr;", line = 347)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZII)I", line = 379)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILza;I)Z", line = 405)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZLza;)Le;", line = 428)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lza;Lfu;IIIIZIIZ)V", line = 449)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)I", line = 484)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(Lza;B)Lkf;", line = 494)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILza;)V", line = 519)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(B)V", line = 548)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lza;I)V", line = 563)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(B)Z", line = 578)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)I", line = 589)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lza;B)V", line = 604)
