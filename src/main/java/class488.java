...
public class class488 extends class397 {
    ...
    @OriginalMember(owner = "client!wn", name = "e", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BI)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IBLae;)V", line = 90)
