...
public class class488 extends class435 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Li;III[Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "()V", line = 48)
    public class488() {
    }

    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(I)V", line = 50)
