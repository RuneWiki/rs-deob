...
public class class488 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ZI[Lraa;IBI)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lha;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(BILraa;)Ljava/lang/String;")
