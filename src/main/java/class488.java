...
public class class488 {
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Leka;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(B)Leka;", line = 22)
    ...
    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "(I)V", line = 157)
    public class488(int arg0) {
        this.field6901 = arg0;
    }

    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "(IIIIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(IZ)I", line = 60)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(IIILjd;Ljd;)V", line = 96)
