...
public class class488 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIZ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IZ)Lef;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)Lkp;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lkp;I)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIILeea;II)Lll;")
