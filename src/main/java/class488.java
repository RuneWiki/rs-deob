...
public class class488 extends class529 {
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "()V", line = 4)
    public class488() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBLtn;)V", line = 12)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!rd", name = "e", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IB)[I", line = 100)
