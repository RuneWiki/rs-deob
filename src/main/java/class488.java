...
public class class488 extends class334 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZLol;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "()V", line = 97)
    public class488() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ul", name = "g", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZII)V", line = 124)
    ...
    @OriginalMember(owner = "client!ul", name = "f", descriptor = "(I)I", line = 143)
