...
public class class488 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZZZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Ljava/lang/Object;Lgt;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZIBII)V", line = 70)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(BI)V", line = 101)
