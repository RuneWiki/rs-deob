...
public class class488 extends class338 implements class323 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IZILqa;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lqa;Ljt;IIIIZIZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lqa;B)V", line = 90)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BLqa;)V", line = 130)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(I)I", line = 146)
    ...
    @OriginalMember(owner = "client!pa", name = "e", descriptor = "(I)Z", line = 163)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IZLqa;I)Ldf;", line = 174)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lbt;I)Lrs;", line = 206)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 221)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Lqa;B)Lvs;", line = 236)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBLqa;)Lc;", line = 261)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(B)V", line = 283)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IILqa;)Lc;", line = 316)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BLrn;ZIILqa;I)V", line = 327)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lqa;I)V", line = 356)
