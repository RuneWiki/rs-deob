...
public class class488 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)[Lgia;")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lda;Lcd;)V")
