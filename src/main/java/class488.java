...
public class class488 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(II)I", line = 59)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lhk;Lqq;Loa;IIBLbv;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Z)V", line = 148)
