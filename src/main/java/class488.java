...
public class class488 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IIB[B)I", line = 6)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)Ljava/io/File;", line = 26)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IC)Z", line = 37)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!baa", name = "finalize", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I[BII)V", line = 116)
    ...
    @OriginalMember(owner = "client!baa", name = "c", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)J", line = 160)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IJ)V", line = 171)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 184)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)V", line = 218)
