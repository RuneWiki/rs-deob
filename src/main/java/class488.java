...
public class class488 extends class180 {
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(I)V", line = 472)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I[Lms;I)V", line = 493)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(B)V", line = 582)
