...
public class class488 extends class151 {
    ...
    @OriginalMember(owner = "client!su", name = "O", descriptor = "([I)V", line = 9)
    ...
    @OriginalMember(owner = "client!su", name = "S", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!su", name = "G", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!su", name = "R", descriptor = "(III[I)V", line = 47)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "()Lq;", line = 64)
    ...
    @OriginalMember(owner = "client!su", name = "Y", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(III[I)V", line = 85)
    ...
    @OriginalMember(owner = "client!su", name = "GA", descriptor = "(III)V", line = 91)
    ...
    @OriginalMember(owner = "client!su", name = "ra", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!su", name = "XA", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!su", name = "pa", descriptor = "(IIIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!su", name = "P", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!su", name = "la", descriptor = "(Lq;)V", line = 170)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "()V", line = 184)
    public class488() {
        this.method137();
    }
}
