...
public class class488 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILha;Ls;Ls;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIII[[BII[[BLco;Lha;Lmea;I[[B[Z)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "([[[I[Leq;ZLha;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "([[IIILs;Lha;Ls;Ls;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(III[Leq;IBLdt;III)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIZIIIBIIILdt;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I[Leq;IIIBLdt;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ls;IILs;Lha;Ls;[[I)V")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(IIIZLbm;Lck;)V")
