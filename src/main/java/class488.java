...
public class class488 extends class171 implements class164 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IILya;ILor;IZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lya;Ljt;IIIIIZII)V", line = 31)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!jm", name = "f", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILya;)V", line = 63)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lya;Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BI)V", line = 107)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(BI)Lgf;", line = 119)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lya;ZI)Lt;", line = 147)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BLya;II)Z", line = 159)
    ...
    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(I)I", line = 181)
    public final int method627(int arg0) {
        ++field7029;
        return arg0 != 23326 ? -14 : this.field7021.field427;
    }

    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!jm", name = "d", descriptor = "(I)Z", line = 202)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZLya;)V", line = 213)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lya;I)Lag;", line = 263)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IZIIIIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!jm", name = "h", descriptor = "(I)V", line = 357)
