...
public class class488 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lic;II)Lcj;")
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "()Lnq;")
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Ldh;)V")
