...
public abstract class class488 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!bg", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 82)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)Z", line = 99)
    ...
    @OriginalMember(owner = "client!bg", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 110)
    ...
    @OriginalMember(owner = "client!bg", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 134)
    ...
    @OriginalMember(owner = "client!bg", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 144)
    public final void focusLost(FocusEvent arg0) {
        class311.field4437 = false;
        field6878++;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)Z", line = 155)
    ...
    @OriginalMember(owner = "client!bg", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 192)
    public final void windowDeactivated(WindowEvent arg0) {
        field6905++;
    }

    @OriginalMember(owner = "client!bg", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 199)
    public final void windowClosing(WindowEvent arg0) {
        field6867++;
        this.destroy();
    }

    @OriginalMember(owner = "client!bg", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 208)
    ...
    @OriginalMember(owner = "client!bg", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 227)
    public final void windowActivated(WindowEvent arg0) {
        field6896++;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILjava/lang/String;)V", line = 242)
    ...
    @OriginalMember(owner = "client!bg", name = "stop", descriptor = "()V", line = 273)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ljava/lang/String;ILso;)I", line = 285)
    ...
    @OriginalMember(owner = "client!bg", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 303)
    public final void windowClosed(WindowEvent arg0) {
        field6880++;
    }

    @OriginalMember(owner = "client!bg", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 310)
    ...
    @OriginalMember(owner = "client!bg", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 324)
    public final void windowIconified(WindowEvent arg0) {
        field6866++;
    }

    @OriginalMember(owner = "client!bg", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 331)
    public final void windowDeiconified(WindowEvent arg0) {
        field6882++;
    }

    @OriginalMember(owner = "client!bg", name = "destroy", descriptor = "()V", line = 340)
    ...
    @OriginalMember(owner = "client!bg", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 356)
    public static final void provideLoaderApplet(Applet arg0) {
        field6865++;
        class319.field4527 = arg0;
    }

    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)Ljava/lang/String;", line = 409)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 426)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III)Z", line = 472)
    ...
    @OriginalMember(owner = "client!bg", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 485)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(B)V", line = 503)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(B)Z", line = 526)
    ...
    @OriginalMember(owner = "client!bg", name = "e", descriptor = "(I)V", line = 537)
    ...
    @OriginalMember(owner = "client!bg", name = "e", descriptor = "(B)Z", line = 592)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZIIILjava/lang/String;II)V", line = 603)
    ...
    @OriginalMember(owner = "client!bg", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 652)
    public final void windowOpened(WindowEvent arg0) {
        field6874++;
    }

    @OriginalMember(owner = "client!bg", name = "start", descriptor = "()V", line = 671)
    ...
    @OriginalMember(owner = "client!bg", name = "run", descriptor = "()V", line = 684)
    ...
    @OriginalMember(owner = "client!bg", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 804)
    public final void update(Graphics arg0) {
        field6886++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lwia;BII)Ldba;", line = 815)
    ...
    @OriginalMember(owner = "client!bg", name = "f", descriptor = "(I)V", line = 830)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(Z)V", line = 848)
