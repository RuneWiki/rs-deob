...
public class class488 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIBI)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ef", name = "toString", descriptor = "()Ljava/lang/String;", line = 75)
