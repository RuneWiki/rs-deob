...
public class class772 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(II)Lqm;", line = 80)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lgia;ILaj;Laj;)V", line = 231)
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(B)V", line = 134)
