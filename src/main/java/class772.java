...
public class class772 implements class753 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIIIZZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(IIIIIIZZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lni;Lqda;Ljp;)V", line = 73)
