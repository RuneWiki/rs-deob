...
public class class772 extends class437 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BI)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(I)V", line = 40)
