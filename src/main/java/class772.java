...
public abstract class class772 implements class539 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(FFFFIILaa;II)V")
