...
public class class772 implements class343 {
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!hha", name = "c", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!hha", name = "finalize", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(BI)V", line = 89)
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Lpq;)V", line = 409)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILrq;I)V", line = 114)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILrq;IB)V", line = 124)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IILkk;)V", line = 158)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IILjka;II)V", line = 194)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!hha", name = "c", descriptor = "(I)I", line = 241)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(BI[Lsha;)V", line = 277)
    ...
    @OriginalMember(owner = "client!hha", name = "c", descriptor = "(B)Z", line = 347)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILjka;IB)V", line = 370)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(BI)V", line = 382)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(B)V", line = 396)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IILae;)Lho;", line = 423)
