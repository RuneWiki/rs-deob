...
public class class772 extends class593 {
    ...
    @OriginalMember(owner = "client!sea", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IBLah;)V", line = 33)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Ljj;)V", line = 86)
    public class772(class334 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Ljava/awt/Component;Z)Lrw;", line = 63)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)Z", line = 74)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IIB)V", line = 94)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!sea", name = "h", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IILlga;IBZ)V", line = 150)
