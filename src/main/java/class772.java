...
public class class772 extends class683 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lhr;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ldt;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIILcm;)V", line = 72)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Z)V", line = 89)
