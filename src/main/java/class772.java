...
public class class772 {
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(ILha;)Lfs;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILha;)Lfs;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZII)Ltf;")
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IBLib;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BLib;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IILla;I)Lju;")
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(ILha;)Lfs;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;I)Lfs;")
