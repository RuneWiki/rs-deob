...
public abstract class class444 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIB)Z", line = 32)
