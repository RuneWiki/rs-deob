...
public class class444 extends class154 {
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BF)F", line = 62)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IBI)V", line = 76)
