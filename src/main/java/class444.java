...
public class class444 extends class157 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "()V", line = 53)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lhd;Lcf;)V", line = 69)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvd;)V", line = 101)
    public final void method557(class4 arg0) {
        this.field2366.method207(arg0);
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "()Z", line = 104)
    public final boolean method555() {
        return true;
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z)V", line = 107)
