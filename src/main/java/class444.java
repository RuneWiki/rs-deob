...
public class class444 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(CILjava/lang/String;)[Ljava/lang/String;", line = 61)
