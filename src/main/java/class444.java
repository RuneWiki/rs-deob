...
public class class444 extends class278 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IILjava/awt/event/KeyEvent;)V", line = 22)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IB)Z", line = 83)
    ...
    @OriginalMember(owner = "client!am", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 96)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field6508++;
        this.method2697(0, 2, arg0);
    }

    @OriginalMember(owner = "client!am", name = "c", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 298)
    public class444(Component arg0) {
        class274.method1747(46);
        this.method2698(arg0, -129);
    }

    @OriginalMember(owner = "client!am", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 144)
    public final synchronized void focusLost(FocusEvent arg0) {
        field6507++;
        this.method2700('\u0000', -1, 0, 93);
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I)Lth;", line = 153)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(CIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!am", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 260)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lci;BLjava/lang/Object;)V", line = 275)
    ...
    @OriginalMember(owner = "client!am", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 309)
    public final void focusGained(FocusEvent arg0) {
        field6518++;
    }

    @OriginalMember(owner = "client!am", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 316)
