...
public class class444 extends class396 {
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILbk;)V", line = 22)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lbk;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lam;BILjava/awt/Component;I)Lis;", line = 68)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lra;Lra;I)V", line = 151)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 164)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)I", line = 243)
