...
public class class444 extends class37 {
    ...
    @OriginalMember(owner = "client!jh", name = "t", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lja;Lmb;B)V", line = 53)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIB[B)V", line = 67)
    ...
    @OriginalMember(owner = "client!jh", name = "u", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(JLja;B)V", line = 97)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(I)V", line = 130)
    public class444(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "([IZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!jh", name = "f", descriptor = "(IB)I", line = 145)
    ...
    @OriginalMember(owner = "client!jh", name = "v", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!jh", name = "e", descriptor = "(BI)V", line = 189)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZI)V", line = 201)
    ...
    @OriginalMember(owner = "client!jh", name = "n", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!jh", name = "n", descriptor = "(II)I", line = 232)
    public final int method2783(int arg0, int arg1) {
        ++field6467;
        return arg0 != 0 ? 48 : arg1 * 8 + -this.field6460;
    }

    @OriginalMember(owner = "client!jh", name = "w", descriptor = "(I)I", line = 246)
