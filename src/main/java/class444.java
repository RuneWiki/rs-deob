...
public class class444 extends class147 {
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 3)
    public class444(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ID)V", line = 38)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZLjagtheora/ogg/OggPacket;)V", line = 67)
