...
public abstract class class444 extends class105 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "([Lwi;I)I", line = 63)
    ...
    @OriginalMember(owner = "client!lv", name = "l", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(Z)V", line = 160)
    ...
    @OriginalMember(owner = "client!lv", name = "g", descriptor = "(I)Z", line = 182)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(IIIIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!lv", name = "j", descriptor = "(I)Z", line = 208)
