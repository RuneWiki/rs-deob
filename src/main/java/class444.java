...
public class class444 extends class29 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lat;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!vh", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lat;II)V", line = 74)
