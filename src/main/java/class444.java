...
public class class444 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)Lvl;", line = 43)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(III)Z", line = 66)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "()V", line = 78)
    public class444() {
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;I)V", line = 82)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)Lvl;", line = 134)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Lmn;)V", line = 154)
