...
public class class444 extends class148 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "()V", line = 42)
    public class444() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(III)Lwo;", line = 50)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ZI)[[I", line = 57)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(CI)Z", line = 126)
    ...
    @OriginalMember(owner = "client!mh", name = "e", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILdh;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!mh", name = "e", descriptor = "(B)Z", line = 204)
