...
public class class444 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)Laj;", line = 5)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)Laj;", line = 25)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILoda;)V", line = 70)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILaj;)V", line = 102)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "()V", line = 179)
    public class444() {
        this.field6446.field6020 = this.field6446;
        this.field6446.field6027 = this.field6446;
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 138)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(I)I", line = 191)
