...
public class class444 extends class521 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILhv;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lbda;)V", line = 46)
    public class444(class428 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lav;B)V", line = 49)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)V", line = 95)
