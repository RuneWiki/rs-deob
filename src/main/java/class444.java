...
public class class444 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)I", line = 51)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILuo;IIZZZ)Lge;", line = 63)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Luo;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BIIIZ[[[Lsq;)Z", line = 211)
    ...
    @OriginalMember(owner = "client!lc", name = "finalize", descriptor = "()V", line = 528)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(III)V", line = 540)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILuo;)V", line = 640)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZ)V", line = 652)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)V", line = 776)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Luo;Lnd;IIIIIIZI)V", line = 926)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IBI)V", line = 801)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLuo;Lge;IIZII)V", line = 832)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)Z", line = 875)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIIII)V", line = 890)
