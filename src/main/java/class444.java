...
public class class444 extends class88 {
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III)V", line = 34)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(III)Z", line = 488)
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(Z)V", line = 504)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZI)V", line = 525)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIII)V", line = 557)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lnd;II)V", line = 574)
