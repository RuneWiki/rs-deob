...
public class class444 extends class337 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)[[I", line = 43)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "()V", line = 119)
    public class444() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oo", name = "i", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BILhp;)V", line = 138)
