...
public class class444 extends class458 implements class142 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILfa;II)V", line = 8)
    public final void method410(int arg0, int arg1, class213 arg2, int arg3, int arg4) {
        this.method2458(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!aa", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;IIII)V", line = 35)
