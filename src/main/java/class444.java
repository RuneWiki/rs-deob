...
public abstract class class444 extends class376 {
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(Z)V", line = 7)
    public static final void method2705(boolean arg0) {
        field6573++;
        class4.field60 = class131.method1003(8, arg0, 35, -69, 8, 0.4F, 2048, 4);
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(III)I", line = 30)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lbq;I)V", line = 49)
    public class444(class190 arg0, int arg1) {
        this.field6579 = arg0;
        this.field6574 = arg1;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILbf;)V", line = 63)
