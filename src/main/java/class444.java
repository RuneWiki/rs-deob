...
public class class444 extends class326 {
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "()V", line = 261)
    public class444() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILct;IILwm;Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BI)[I", line = 128)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILbt;I)V", line = 216)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(IB)[[I", line = 264)
