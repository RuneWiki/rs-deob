...
public class class444 extends class233 implements class9 {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILae;II)Z", line = 23)
    ...
    @OriginalMember(owner = "client!qc", name = "h", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BILae;)Lbk;", line = 59)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLae;)Ljg;", line = 92)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lae;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)Z", line = 200)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZBIILna;ILae;)V", line = 211)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lae;ZI)Lbk;", line = 240)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z[I[JII)V", line = 269)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lae;Ljh;IIIIIZIIIIIIZ)V", line = 324)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)Z", line = 358)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILae;)V", line = 369)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILae;IZ)Lsk;", line = 397)
    ...
    @OriginalMember(owner = "client!qc", name = "e", descriptor = "(I)V", line = 429)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(I)I", line = 445)
    public final int method69(int arg0) {
        ++field6363;
        return arg0 != -5944 ? -73 : this.field6376;
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIIIIIII)V", line = 458)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lae;B)V", line = 537)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Z)V", line = 548)
    ...
    @OriginalMember(owner = "client!qc", name = "i", descriptor = "(I)I", line = 560)
