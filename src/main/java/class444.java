...
public class class444 implements class161 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lub;[I[II[I)V")
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(II)Lfb;")
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)Lnl;")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Luq;Luq;Luq;)V")
