...
public class class444 extends class573 {
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Ldw;II[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILtga;[[B)V", line = 28)
