...
public class class444 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIZ)Z", line = 5)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILqs;)V", line = 19)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IJ)V", line = 31)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 68)
