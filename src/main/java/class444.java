...
public class class444 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lr;IIIIIIZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II[B)[B", line = 148)
