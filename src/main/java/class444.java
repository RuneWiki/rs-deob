...
public class class444 extends class258 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lim;B)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(BLmc;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Llq;[Lgu;)V")
