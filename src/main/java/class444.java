...
public class class444 extends class346 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lfb;ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(II)[[I", line = 46)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(II)[I", line = 124)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(IIIIII)V", line = 177)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "()V", line = 284)
    public class444() {
        super(3, false);
    }
}
