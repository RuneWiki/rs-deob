...
public class class444 {
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lhaa;[[BB)V", line = 35)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BI)Lgw;", line = 103)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)V", line = 136)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lto;ILla;)V", line = 166)
