...
public class class444 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lqv;I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZII)V", line = 46)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILgh;)Lsb;", line = 97)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Loh;Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(B)V", line = 140)
