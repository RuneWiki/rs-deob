...
public class class444 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(BC)Z", line = 16)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(II)I", line = 60)
    public static int method2376(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(I)V", line = 68)
