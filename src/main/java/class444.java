...
public class class444 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IILns;I)Lrt;", line = 5)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 54)
