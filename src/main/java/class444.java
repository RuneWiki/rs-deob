...
public class class444 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ZI)Lvr;", line = 17)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(ILtf;Ltf;)V", line = 71)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIIII)V", line = 94)
