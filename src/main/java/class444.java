...
public class class444 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(III)V", line = 171)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(II)[I", line = 78)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 156)
