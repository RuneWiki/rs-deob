...
public class class444 extends class279 {
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!oha", name = "d", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lhb;Lla;)V", line = 132)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(III)V", line = 168)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)Z", line = 177)
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!oha", name = "e", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ZI)V", line = 226)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(BZ)V", line = 279)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IZLiu;)V", line = 291)
