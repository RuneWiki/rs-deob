...
public class class444 extends class460 {
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lrda;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lrda;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILku;)I")
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lrda;II)V")
