...
public class class444 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILaq;)V")
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)Laq;")
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(Z)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(I)Laq;")
