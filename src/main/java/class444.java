...
public class class444 extends class220 {
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 3)
    public class444() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!jh", name = "e", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IB)V", line = 107)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IBLil;)V", line = 124)
    ...
    @OriginalMember(owner = "client!jh", name = "f", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lfg;Lfg;IIIIIIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I[Ljava/lang/String;IB)Ljava/lang/String;", line = 226)
