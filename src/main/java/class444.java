...
public class class444 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BLfh;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lza;IIZ)Lo;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Ljava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lfh;II)V")
