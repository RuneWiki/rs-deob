...
public class class444 extends class227 {
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "()V", line = 4)
    public class444() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)[I", line = 7)
    public final int[] method62(int arg0, int arg1) {
        field6458++;
        return arg0 == 15811 ? class4.field37 : null;
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;I)I", line = 18)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(Z)V", line = 140)
