...
public class class128 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZLnj;)V", line = 17)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([BI)[B", line = 49)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(I)V", line = 67)
