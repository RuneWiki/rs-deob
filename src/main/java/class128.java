...
public class class128 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IILri;Z)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZIILri;)Z")
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lnf;Lkk;)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZLri;II)V")
