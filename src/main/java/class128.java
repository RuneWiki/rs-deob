...
public class class128 extends class237 {
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(JI)V", line = 105)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(JIZILqa;)V", line = 127)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lqa;Lqr;Lrb;J)V", line = 336)
