...
public class class128 implements Runnable {
    ...
    @OriginalMember(owner = "client!wk", name = "run", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)V", line = 67)
