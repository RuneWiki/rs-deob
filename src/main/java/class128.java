...
public class class128 extends class175 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IIZIIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "()V", line = 86)
    public class128() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oda", name = "g", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ILdt;Z)V", line = 169)
    ...
    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(Z)V", line = 262)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(II[I)V", line = 273)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ZI)[I", line = 446)
