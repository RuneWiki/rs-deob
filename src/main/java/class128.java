...
public class class128 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lun;Z)Lvo;", line = 25)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lun;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILun;)V", line = 60)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 135)
