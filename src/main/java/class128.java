...
public class class128 {
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIILn;ILqa;)V", line = 34)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)Ltd;", line = 130)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 162)
