...
public class class128 extends class502 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)Lhp;", line = 10)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLod;)V", line = 59)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BI)V", line = 96)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(II)I", line = 119)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLhp;)V", line = 149)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(II)Z", line = 421)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IZ)V", line = 438)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lod;)V", line = 458)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)V", line = 544)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B[S)[S", line = 555)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(II)Z", line = 573)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZZ)V", line = 588)
