...
public class class128 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IB)V", line = 28)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lpp;ZJ)V", line = 53)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)Lvf;", line = 101)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BJ)Lpp;", line = 122)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)V", line = 144)
