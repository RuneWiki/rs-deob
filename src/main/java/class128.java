...
public class class128 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Llh;B)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)Lwk;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)Lwk;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Llh;IB)V")
