...
public class class128 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(III)Lnea;", line = 4)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Lufa;B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IJ)V", line = 58)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Lvo;III)Lll;", line = 178)
