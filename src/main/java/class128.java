...
public class class128 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBLap;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILpq;)V", line = 201)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)Lpq;", line = 222)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBI)I", line = 259)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(I)V", line = 304)
    public class128(int arg0) {
        this.field2204 = arg0;
    }

    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(IIIIII)V", line = 314)
