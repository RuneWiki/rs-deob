...
public class class128 extends class26 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BF)V", line = 6)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(FI)V", line = 25)
    ...
    @OriginalMember(owner = "client!jga", name = "k", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(I)V", line = 62)
    public class128(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIIIIB)V", line = 65)
