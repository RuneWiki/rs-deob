...
public class class128 extends class147 {
    ...
    @OriginalMember(owner = "client!ng", name = "I", descriptor = "Ljg;")
    ...
    @OriginalMember(owner = "client!ng", name = "db", descriptor = "Ldf;")
    public static class37 field2488;

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)Lie;")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IBILja;)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lja;BI)V")
