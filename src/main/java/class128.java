...
public class class128 extends class409 {
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "OA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(CIIIZLua;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lrfa;Laga;[Ltq;[I[I)V")
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "([B[IIIIIIIIIIILua;II)V")
