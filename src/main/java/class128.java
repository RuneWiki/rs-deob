...
public class class128 extends class444 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "([III)V", line = 12)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lpn;)V", line = 104)
    public final synchronized void method852(class444 arg0) {
        arg0.method2459(198);
    }

    @OriginalMember(owner = "client!fa", name = "e", descriptor = "()V", line = 107)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "([III)V", line = 128)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "()Lpn;", line = 149)
    public final class444 method180() {
        return (class444) this.field1793.method1312((byte) 25);
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lwo;)V", line = 154)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Lpn;)V", line = 170)
    public final synchronized void method857(class444 arg0) {
        this.field1793.method1307(arg0, -4);
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "()I", line = 174)
    public final int method208() {
        return 0;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lmh;Lwo;)V", line = 179)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "()Lpn;", line = 187)
