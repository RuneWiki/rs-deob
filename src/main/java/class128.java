...
public class class128 {
    ...
    @OriginalMember(owner = "client!ru", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIFLge;FF[BIIFIFZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lfd;J[Lwl;)V", line = 95)
    public class128(class365 arg0, long arg1, class280[] arg2) {
        this.field1859 = arg0;
        this.field1860 = arg1;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IZ)Z", line = 109)
