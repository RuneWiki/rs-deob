...
public class class128 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILtn;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZZILha;)Lac;", line = 36)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)Ljava/lang/String;", line = 82)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Ltn;I)V", line = 150)
