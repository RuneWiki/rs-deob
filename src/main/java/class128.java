...
public class class128 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)Lhb;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILec;B)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lec;III)V")
