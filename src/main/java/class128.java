...
public class class128 extends class165 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILvc;J)V", line = 22)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 58)
    ...
    @OriginalMember(owner = "client!qo", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 81)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1745;
    }

    @OriginalMember(owner = "client!qo", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 88)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILjava/awt/Graphics;IIBI)V", line = 112)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!qo", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 147)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field1752;
        return this.field1738 == arg0;
    }

    @OriginalMember(owner = "client!qo", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 155)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 176)
    ...
    @OriginalMember(owner = "client!qo", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 190)
