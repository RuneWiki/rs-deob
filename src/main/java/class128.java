...
public class class128 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "([II[III)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "([BI[BII)V")
    public static final void method958(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
