...
public class class128 extends class136 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIBILjava/awt/Graphics;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILjava/awt/Graphics;IB)V", line = 49)
