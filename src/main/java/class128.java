...
public class class128 extends class11 {
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lad;)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IILpm;)V")
