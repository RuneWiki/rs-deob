...
public class class128 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IILk;I)Z")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ILk;II)V")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BI)Lln;")
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(ILk;II)V")
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Los;Lnba;)V")
