...
public class class128 extends class324 {
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IBI)Z", line = 24)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 40)
