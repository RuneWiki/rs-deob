...
public abstract class class128 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(JJ)J")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lmh;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lmh;ILjaclib/memory/Buffer;IZ)V")
