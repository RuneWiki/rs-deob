...
public class class128 extends class401 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZI[BLlj;IBII)Lnea;", line = 4)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II[B)I", line = 23)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZLac;)Lsu;", line = 45)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILin;II)V", line = 57)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "([B)V", line = 108)
