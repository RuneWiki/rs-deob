...
public class class128 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Loh;IIIIIILqa;Lpa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(I)V", line = 135)
