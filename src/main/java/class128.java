...
public class class128 extends class293 {
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "d", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(B)J", line = 29)
    ...
    @OriginalMember(owner = "client!el", name = "e", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)C", line = 83)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)Z", line = 109)
