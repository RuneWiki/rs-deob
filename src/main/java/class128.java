...
public class class128 extends class667 {
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lud;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 44)
    public class128() {
        super(3, false);
    }

    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BI)[I", line = 49)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ZI)[[I", line = 125)
