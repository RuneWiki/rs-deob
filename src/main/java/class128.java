...
public class class128 extends class311 {
    ...
    @OriginalMember(owner = "client!fa", name = "h", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lvq;B)V", line = 47)
    ...
    @OriginalMember(owner = "client!fa", name = "e", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILlf;)V", line = 165)
    ...
    @OriginalMember(owner = "client!fa", name = "e", descriptor = "(B)I", line = 360)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIZI)V", line = 376)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "(I)Z", line = 387)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 402)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(Z)V", line = 415)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lvq;IIB)Z", line = 473)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ls;IBIILni;ILvq;)V", line = 520)
    ...
    @OriginalMember(owner = "client!fa", name = "g", descriptor = "(I)Z", line = 562)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ltj;I)I", line = 583)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BLvq;I)Z", line = 652)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BLvq;)Lbf;", line = 792)
    ...
    @OriginalMember(owner = "client!fa", name = "h", descriptor = "(I)V", line = 934)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IBII)V", line = 960)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(B)I", line = 976)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(B)V", line = 988)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 999)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ZZ)Ljava/lang/String;", line = 1057)
