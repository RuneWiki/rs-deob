...
public class class128 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)Lfk;", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lwm;III)V", line = 92)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 702)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ldn;IZLr;Lr;)V", line = 767)
