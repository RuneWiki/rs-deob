...
public class class128 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)Ltv;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "([III)Llv;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILig;III)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II[I)Llv;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II[II)Llv;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I[III)Llv;")
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lok;Lok;)V")
