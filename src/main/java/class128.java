...
public class class128 extends class390 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I[Lsg;)V", line = 72)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIIIIIIIIZ)Z", line = 104)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(IIIIIZ)V", line = 126)
