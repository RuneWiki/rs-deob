...
public class class128 implements class181 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILjava/awt/Component;IBLne;)Ldh;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lm;I)Z")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)Ltd;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BIILea;ILgf;I)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZLjq;B)V")
