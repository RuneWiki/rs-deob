...
public class class128 extends class298 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IILvt;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ld", name = "e", descriptor = "(B)V", line = 223)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IZ)[I", line = 236)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 277)
    public class128() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILeg;ILjava/awt/Canvas;)Loj;", line = 343)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IB)Lud;", line = 357)
