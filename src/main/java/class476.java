...
public class class476 extends class263 {
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(Lnj;B)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lkda;Llp;I)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IFLsa;ZI)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lnj;B)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lnj;I)V")
