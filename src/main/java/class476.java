...
public class class476 implements class524 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IB)V", line = 123)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lkr;B)Z", line = 155)
