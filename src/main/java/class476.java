...
public class class476 extends class513 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(I)[F", line = 44)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljn;I)Luca;", line = 456)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljn;)Z", line = 470)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "()V", line = 490)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "([I)Lep;", line = 508)
    ...
    @OriginalMember(owner = "client!uca", name = "e", descriptor = "(I)F", line = 570)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "()I", line = 582)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "([B)V", line = 592)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "([B)V", line = 636)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljn;II)Luca;", line = 791)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "([BI)V", line = 805)
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "([B)V", line = 817)
