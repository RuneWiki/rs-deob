...
public class class476 extends class465 {
    ...
    @OriginalMember(owner = "client!qj", name = "n", descriptor = "Lu;")
    private class68 field6345;
    ...
    private final void method2669(int arg0) {
        this.field6345 = new class68(super.field6268, 2);
        ++field6349;
        this.field6345.method537(0, (byte) 3);
        super.field6268.method3629((byte) -127, 1);
        super.field6268.method3644(260, 23560, 7681);
        super.field6268.method3609((byte) 27, 768, 0, 34168);
        OpenGL.glTexGeni(8192, 9472, 9216);
        OpenGL.glEnable(3168);
        super.field6268.method3629((byte) -118, 0);
        OpenGL.glTexEnvf(8960, 34163, 2.0F);
        if (this.field6341.field2976) {
        ...
        this.field6345.method539(true);
        this.field6345.method537(1, (byte) 3);
        super.field6268.method3629((byte) -100, 1);
    ...
    public final void method215(int arg0, int arg1, int arg2) {
        if (~(arg2 & 1) != -2) {
            if (!this.field6341.field2976) {
                super.field6268.method3630(this.field6341.field2979[0], -2);
            } else {
                super.field6268.method3630(this.field6341.field2975, -2);
                class421.field5833[1] = 0.0F;
                class421.field5833[0] = 0.0F;
                class421.field5833[2] = 0.0F;
                class421.field5833[3] = 0.0F;
                OpenGL.glTexGenfv(8194, 9473, class421.field5833, 0);
            }
        } else if (!this.field6341.field2976) {
            int var4 = super.field6268.field9186 % 4000 * 16 / 4000;
            super.field6268.method3630(this.field6341.field2979[var4], -2);
        } else {
            super.field6268.method3630(this.field6341.field2975, arg1 + -2);
            class421.field5833[2] = 0.0F;
            class421.field5833[3] = (float) (super.field6268.field9186 % 4000) / 4000.0F;
            class421.field5833[0] = 0.0F;
            class421.field5833[1] = 0.0F;
            OpenGL.glTexGenfv(8194, 9473, class421.field5833, 0);
        }
    ...
    public static final void method2670(byte arg0, boolean arg1) {
        class310.method1858(arg1, class251.field3463, class627.field8461, class149.field2387, -127);
        if (arg0 < -18) {
            ++field6350;
        }
    }
    ...
    public static final void method2671(int arg0, int arg1, boolean arg2, String arg3, byte arg4, String arg5, boolean arg6) {
        ++field6347;
        ...
        String var10 = null;
        if (~arg1 != 0) {
            class538 var11 = class282.field4001.method3062((byte) -74, arg1);
            if (var11 == null || !var11.method2974(true) == arg2) {
                return;
            }
            if (!var11.method2974(true)) {
                var9 = var11.field7101;
            } else {
                var10 = var11.field7106;
            }
        }
        int var12 = 0;
        for (int var13 = 0; ~var13 > ~class193.field2826.field2303; ++var13) {
            class577 var16 = class193.field2826.method1047(var13, -1);
            if ((!arg6 || var16.field7690) && ~var16.field7628 == 0 && ~var16.field7653 == 0 && ~var16.field7618 == -1 && ~var16.field7679.toLowerCase().indexOf(var7) != 0) {
                if (arg1 != -1) {
                    if (arg2) {
                        if (!arg3.equals(var16.method3164(true, arg1, var10))) {
                            continue;
                        }
                    } else if (arg0 != var16.method3166(arg1, (byte) 14, var9)) {
                        continue;
                    }
                }
                if (var12 >= 250) {
        ...
        class506.field6748 = var12;
        class629.field8484 = var8;
        if (arg4 <= -7) {
            String[] var14 = new String[class506.field6748];
            for (int var15 = 0; class506.field6748 > var15; ++var15) {
                var14[var15] = class193.field2826.method1047(var8[var15], -1).field7679;
            }
            class651.method3575(var14, class629.field8484, (byte) -6);
    ...
    public final void method213(int arg0) {
        ++field6342;
        this.field6345.method536((byte) 116, '\u0001');
        if (super.field6268.field9332 > 0) {
            super.field6268.method3629((byte) -99, 1);
            super.field6268.method3630((class367) null, -2);
            super.field6268.method3638(0.0F, 1.0F, (byte) 127);
            super.field6268.method3629((byte) -116, 0);
        }
        super.field6268.method3644(8448, 23560, 8448);
    ...
    public final void method210(int arg0, boolean arg1) {
        ++field6343;
        if (super.field6268.field9332 > 0) {
            float var3 = -0.5F / (float) super.field6268.field9332;
            super.field6268.method3629((byte) -111, 1);
            class421.field5833[3] = super.field6268.field9244 * var3 + 0.25F;
            class421.field5833[2] = var3;
            class421.field5833[1] = 0.0F;
            class421.field5833[0] = 0.0F;
            OpenGL.glPushMatrix();
            OpenGL.glLoadIdentity();
            OpenGL.glTexGenfv(8192, 9474, class421.field5833, 0);
            OpenGL.glPopMatrix();
            super.field6268.method3638((float) super.field6268.field9332, 0.5F, (byte) 126);
            super.field6268.method3630(this.field6339, -2);
            super.field6268.method3629((byte) 60, 0);
        }
        int var4 = -27 % ((arg0 - -30) / 38);
        this.field6345.method536((byte) 123, '\u0000');
        OpenGL.glMatrixMode(5890);
        OpenGL.glPushMatrix();
    ...
    public final void method214(byte arg0, boolean arg1) {
        ...
        super.field6268.method3644(8448, 23560, 260);
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILhf;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lno;Lhm;)V")
    public class476(class658 arg0, class207 arg1) {
        super(arg0);
        this.field6341 = arg1;
        this.method2669(124);
        this.field6339 = new class466(super.field6268, 6406, 2, new byte[] { 0, -1 }, 6406);
        this.field6339.method2633(false, (byte) -44);
    }
