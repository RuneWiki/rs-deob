...
public class class476 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(B)I", line = 280)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BZBII)Lae;", line = 292)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(B)I", line = 336)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(III)V", line = 347)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IBI)Z", line = 409)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z)V", line = 420)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)V", line = 433)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lbn;ZZ)V", line = 464)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILfo;)V", line = 533)
    public static final void method2870(int arg0, class343 arg1) {
        class99.field1801[arg0] = arg1;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IZ)V", line = 544)
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(B)Z", line = 575)
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(I)V", line = 586)
    ...
    @OriginalMember(owner = "client!no", name = "e", descriptor = "(I)Z", line = 602)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Z)V", line = 614)
