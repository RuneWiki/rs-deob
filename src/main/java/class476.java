...
public class class476 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IB)Luk;")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Loda;ILdda;)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILlc;)I")
