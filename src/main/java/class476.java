...
public class class476 extends class125 {
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lgp;)V")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Ljava/lang/String;II)Loea;")
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(ILgp;)V")
