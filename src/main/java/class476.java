...
public class class476 extends class744 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I[BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ap", name = "finalize", descriptor = "()V", line = 50)
    protected final void finalize() {
        field6756++;
        this.method2844(Integer.MIN_VALUE);
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BI)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(I[BII)I", line = 77)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BLmq;)Ljava/lang/String;", line = 88)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)V", line = 113)
