...
public class class476 implements Runnable {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)Lcw;", line = 8)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lcw;", line = 18)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZILjava/lang/Runnable;)Lcw;", line = 27)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILjava/awt/Point;Ljava/awt/Component;[IIB)Lcw;", line = 37)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)Leu;", line = 46)
    public final class336 method2872(byte arg0) {
        return arg0 >= -76 ? null : this.field6897;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILjava/lang/Class;)Lcw;", line = 56)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILjava/net/URL;)Lcw;", line = 70)
    public final class121 method2874(int arg0, URL arg1) {
        return arg0 > -84 ? null : this.method2877(0, 4, arg1, false, 0);
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIILjava/awt/Component;)Lcw;", line = 83)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z[Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Lcw;", line = 98)
    ...
    @OriginalMember(owner = "client!pc", name = "run", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILjava/lang/Object;ZI)Lcw;", line = 231)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z)Z", line = 263)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)Lcw;", line = 278)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLjava/lang/String;)Ljava/io/File;", line = 288)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZBLjava/awt/Component;)Lcw;", line = 299)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;ZB)Lcw;", line = 311)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 325)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 699)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 339)
    public final void method2884(int arg0) {
        field6908 = (long) arg0 + class504.method3034((byte) -122);
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/Class;)Lcw;", line = 352)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLjava/lang/Class;)Lcw;", line = 363)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;B)Lcw;", line = 378)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;IB)Lcw;", line = 390)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(I)Lcw;", line = 400)
    ...
    @OriginalMember(owner = "client!pc", name = "d", descriptor = "(I)V", line = 418)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/awt/Frame;I)Lcw;", line = 477)
    public final class121 method2891(Frame arg0, int arg1) {
        int var3 = 127 % ((arg1 + 9) / 51);
        return this.method2877(0, 7, arg0, false, 0);
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;Z)Lcw;", line = 498)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IBLjava/lang/String;Ljava/lang/String;)Ljava/io/File;", line = 509)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIZII)Lcw;", line = 598)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILjava/lang/Object;IBI)Lcw;", line = 619)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(ILjava/lang/Class;)V", line = 655)
