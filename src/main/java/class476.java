...
public class class476 extends class779 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lvl;BLpp;)Lqj;")
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lgj;Lgj;Lhja;)V")
    public class476(class662 arg0, class662 arg1, class429 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILuv;)V")
