...
public class class476 extends class407 {
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(IIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(IIIZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(Lwia;Lwia;Leia;)V", line = 53)
    public class476(class791 arg0, class791 arg1, class253 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!oja", name = "c", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!oja", name = "b", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(IBIZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(B)Z", line = 172)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(I)V", line = 209)
