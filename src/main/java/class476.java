...
public class class476 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lgk;I)Leo;", line = 3)
    ...
    @OriginalMember(owner = "client!vs", name = "toString", descriptor = "()Ljava/lang/String;", line = 43)
    public final String toString() {
        field6822++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIII)Z", line = 52)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I[S)[S", line = 85)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 161)
