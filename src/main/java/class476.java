...
public class class476 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIILya;IIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)Laf;")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lfd;Lga;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
