...
public class class476 extends class237 implements class620 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(Loa;II)Lba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ZLoa;II)Lid;")
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Loa;II)Lba;")
    ...
    @OriginalMember(owner = "client!qn", name = "d", descriptor = "(Loa;I)Lcd;")
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Loa;Lsa;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(Loa;I)V")
