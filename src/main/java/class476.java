...
public class class476 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)Lhr;", line = 35)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(II)V", line = 70)
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lmja;ILbt;Lbt;)V", line = 121)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 103)
