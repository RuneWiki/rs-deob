...
public class class476 implements class212 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILui;ZII)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILud;)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILnt;I)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIZLui;)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILud;I)V")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lvd;)V")
