...
public class class476 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI)V", line = 52)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)Ljs;", line = 76)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(IZ)V", line = 123)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(II)V", line = 140)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(II)V", line = 157)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lci;IZLsea;Lsea;)V", line = 235)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lr;B)V", line = 205)
