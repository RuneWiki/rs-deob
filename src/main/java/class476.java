...
public class class476 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILpj;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lpj;II)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lpj;BI)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lpj;ILmp;Z)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lpj;I)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLpj;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lpj;)V")
