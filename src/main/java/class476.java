...
public class class476 implements class81 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIIZ[Lvfa;IIIII)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)Lmha;")
    public class419 method112(byte arg0) {
        field6527++;
        return arg0 == 62 ? null : null;
    }

    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lle;Lqj;IIIIIII)V")
