...
public class class476 extends class332 {
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(IIIIIF)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIBI)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IF)V")
