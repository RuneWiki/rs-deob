...
public class class476 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Z)Lnp;", line = 7)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILnp;)V", line = 48)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)Lnp;", line = 82)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)Lnp;", line = 103)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)I", line = 150)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "()V", line = 175)
    public class476() {
