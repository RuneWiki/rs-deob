...
public class class476 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IB)V", line = 22)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)Lww;", line = 62)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(I)I", line = 155)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(II)V", line = 203)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 250)
    public class476(class242 arg0, int arg1, class522 arg2) {
        this.field6574 = arg2;
        this.field6574.method2901(0, 31);
    }

    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Z)V", line = 226)
