...
public class class476 extends class471 implements class381 {
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(III)Lgq;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IILwm;)Lgn;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BLwm;)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BZLwm;I)Lij;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILwm;I)Lgn;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIBLwm;)Z")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lwm;Lct;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lwm;I)V")
