...
public class class476 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IJIIZBLjava/lang/String;ILjava/lang/String;ZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 76)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lkfa;J[Lafa;)V", line = 102)
    public class476(class382 arg0, long arg1, class189[] arg2) {
        this.field6821 = arg0;
        this.field6820 = arg1;
    }

    @OriginalMember(owner = "client!qn", name = "finalize", descriptor = "()V", line = 113)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 123)
