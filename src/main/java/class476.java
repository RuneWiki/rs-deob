...
public class class476 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZI)Lwe;", line = 3)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Ljava/awt/Canvas;Le;I)Loa;", line = 69)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III)V", line = 120)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Ljda;ILjo;Ljo;)V", line = 155)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZLoa;)Led;", line = 136)
