...
public abstract class class476 implements class509 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lae;Lae;Ldda;)V", line = 70)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Z)I", line = 80)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IZLha;Z)Lda;", line = 145)
