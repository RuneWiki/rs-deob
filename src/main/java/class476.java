...
public class class476 extends class175 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ZI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "()V", line = 135)
    public class476() {
        super(0, true);
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILdt;Z)V", line = 138)
