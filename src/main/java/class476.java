...
public class class476 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IB)Lai;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B[[BLjda;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lqg;ILvd;)V")
