...
public class class476 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IILwq;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)I", line = 100)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "()V", line = 112)
    public class476() {
    }

    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lhp;)V", line = 114)
