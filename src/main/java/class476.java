...
public class class476 extends class722 {
    ...
    @OriginalMember(owner = "client!ci", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ci", name = "d", descriptor = "(B)[B", line = 18)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!ci", name = "e", descriptor = "(I)I", line = 54)
