...
public class class476 extends class43 {
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(B)Lsa;", line = 33)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ZFIIFFIIII[FII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III[II)V", line = 193)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lur;IIIIII)V", line = 224)
