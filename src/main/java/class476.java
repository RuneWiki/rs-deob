...
public class class476 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ZIIIIIFI)[I", line = 21)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Z)V", line = 44)
