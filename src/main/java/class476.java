...
public class class476 implements Runnable {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)Lbi;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILjava/lang/String;Z)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILjava/lang/String;)Lbi;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIILjava/lang/Object;B)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;BLjava/lang/Class;)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BZLjava/lang/String;)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIII)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ljava/net/URL;B)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BLjava/lang/String;)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILjava/awt/Frame;)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(B)Lue;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([IBLjava/awt/Component;Ljava/awt/Point;II)Lue;")
