...
public class class476 extends class320 {
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLbu;)I", line = 46)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(IIIIIZ)V", line = 120)
