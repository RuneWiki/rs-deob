...
public abstract class class709 extends class626 {
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(I)V", line = 12)
    public static void method3963(int arg0) {
        field9911 = null;
        int var1 = -52 % ((-arg0 - 27) / 57);
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Lkk;B)V", line = 39)
