...
public class class709 extends class68 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)Leo;", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IZIZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!ar", name = "d", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Log;Lgi;IIIIIIIIIIIIII)V", line = 46)
