...
public class class709 extends class454 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IZDLd;Lgga;IZ)[I", line = 17)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgga;BZIILd;)[F", line = 156)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgga;ZLd;IZDII)[I", line = 264)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "()V", line = 409)
    public class709() {
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lol;)V", line = 424)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgga;BLd;)Z", line = 514)
