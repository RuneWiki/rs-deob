...
public class class709 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)Lqea;", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIB)V", line = 90)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(II)V", line = 224)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lms;ILwu;Lwu;)V", line = 253)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)V", line = 241)
