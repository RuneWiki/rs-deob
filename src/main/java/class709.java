...
public class class709 extends class196 {
    ...
    @OriginalMember(owner = "client!nfa", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!nfa", name = "g", descriptor = "(I)V", line = 496)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(III)Z", line = 528)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lpc;II)V", line = 541)
