...
public class class709 extends class518 {
    ...
    @OriginalMember(owner = "client!lha", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "()V", line = 163)
    public class709() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILjc;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Lem;IIILeea;)V", line = 237)
