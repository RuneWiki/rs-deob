...
public class class709 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(BIIIILka;II)Lka;")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ILka;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lee;II)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IIZI)I")
