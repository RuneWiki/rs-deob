...
public class class709 extends class331 {
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIIIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IZI)Z", line = 106)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(B)I", line = 117)
    public final int method3919(byte arg0) {
        ++field9977;
        return arg0 > -119 ? -50 : super.field4202;
    }

    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(ILts;)V", line = 130)
    public class709(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lts;)V", line = 133)
    public class709(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(II)I", line = 136)
    public final int method222(int arg0, int arg1) {
        ++field9974;
        return arg1 != 1 ? 122 : 1;
    }

    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 148)
