...
public class class709 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)[Lcf;", line = 64)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIIB)Z", line = 75)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(BI)V", line = 111)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lgia;ILaj;Laj;)V", line = 171)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(BI)Lht;", line = 140)
