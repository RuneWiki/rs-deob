...
public class class709 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIZJ)V", line = 6)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lib;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lib;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZIZLha;)Lfs;", line = 138)
