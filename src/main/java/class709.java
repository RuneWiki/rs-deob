...
public class class709 extends class681 implements class498 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILtda;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lta;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILvea;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lta;Lvea;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lta;Lvea;Lbja;II)V")
