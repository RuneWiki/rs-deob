...
public class class709 extends class173 implements class457 {
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ru", name = "finalize", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZII)V", line = 31)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lck;III)V", line = 247)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lck;IIII)V", line = 262)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 228)
