...
public class class709 extends class487 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIBII)V", line = 5)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lrs;II[BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BZ)V", line = 53)
