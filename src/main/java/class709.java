...
public class class709 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lfca;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLfca;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IZ)V", line = 98)
