...
public class class608 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!lc", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lem;I)I", line = 89)
