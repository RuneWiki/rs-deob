...
public class class608 extends class159 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(I)I", line = 6)
    public static final int method3383(int arg0) {
        field8224++;
        return ~class206.field2664 == arg0 ? class169.field2222 : class265.field3899;
    }

    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IILjava/net/Socket;)Lqia;", line = 18)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "([Lfq;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IBIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(B[BI)[B", line = 106)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Z)V", line = 120)
