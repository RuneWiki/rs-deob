...
public class class608 extends class223 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lpb;ZLoea;)I", line = 4)
    ...
    @OriginalMember(owner = "client!sga", name = "u", descriptor = "()V", line = 44)
    public final void method205() {
        this.field8564.method2329(false);
        super.method205();
    }

    @OriginalMember(owner = "client!sga", name = "e", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!sga", name = "o", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!sga", name = "A", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILdaa;II)V", line = 89)
    ...
    @OriginalMember(owner = "client!sga", name = "Q", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IIII)V", line = 133)
    public final void method197(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IIZIII[FLpb;)Lbw;", line = 137)
    ...
    @OriginalMember(owner = "client!sga", name = "ya", descriptor = "()V", line = 147)
    public final void method226() {
        this.method1479(true, 7);
        this.field8555.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!sga", name = "l", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!sga", name = "i", descriptor = "(Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!sga", name = "j", descriptor = "()Z", line = 206)
    public final boolean method147() {
        return false;
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ZZ)Lfw;", line = 213)
    public final class716 method1421(boolean arg0, boolean arg1) {
        return arg1 ? new class600(this, arg0) : (class716) null;
    }

    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/dba;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Leja;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lae;I)V", line = 224)
    ...
    @OriginalMember(owner = "client!sga", name = "v", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!sga", name = "i", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ZIZLvq;Z)V", line = 314)
    ...
    @OriginalMember(owner = "client!sga", name = "F", descriptor = "(II)V", line = 360)
    public final void method146(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(BI)V", line = 363)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lvq;I)I", line = 374)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILjagdx/IDirect3DVertexShader;)V", line = 400)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BLfw;I)V", line = 413)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 424)
    public final void method254(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class357 {
        this.method157(arg2, arg3);
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILjagdx/D3DPRESENT_PARAMETERS;BILjagdx/IDirect3D;I)Z", line = 433)
    ...
    @OriginalMember(owner = "client!sga", name = "m", descriptor = "(Z)V", line = 535)
    ...
    @OriginalMember(owner = "client!sga", name = "w", descriptor = "(I)V", line = 553)
    ...
    @OriginalMember(owner = "client!sga", name = "n", descriptor = "(I)V", line = 563)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ZLvq;IZ)V", line = 575)
    ...
    @OriginalMember(owner = "client!sga", name = "f", descriptor = "(B)V", line = 620)
    ...
    @OriginalMember(owner = "client!sga", name = "r", descriptor = "()V", line = 640)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILpb;[BIII)Lat;", line = 664)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lok;Lok;FLok;)Lok;", line = 675)
    public final class255 method209(class255 arg0, class255 arg1, float arg2, class255 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!sga", name = "c", descriptor = "()V", line = 683)
    public final void method167() {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lsi;B)I", line = 687)
    ...
    @OriginalMember(owner = "client!sga", name = "o", descriptor = "()V", line = 713)
    public final void method250() {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BZ)V", line = 723)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 734)
    ...
    @OriginalMember(owner = "client!sga", name = "B", descriptor = "(I)V", line = 763)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(B[Lim;)Lbfa;", line = 798)
    ...
    @OriginalMember(owner = "client!sga", name = "gb", descriptor = "(I)V", line = 810)
    ...
    @OriginalMember(owner = "client!sga", name = "n", descriptor = "(Z)V", line = 820)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BLjava/awt/Canvas;)Ljava/lang/Object;", line = 857)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lbfa;I)V", line = 868)
    ...
    @OriginalMember(owner = "client!sga", name = "c", descriptor = "(I)V", line = 879)
    public final synchronized void method232(int arg0) {
        this.field8564.method2328(true);
        super.method232(arg0);
    }

    @OriginalMember(owner = "client!sga", name = "k", descriptor = "(B)F", line = 887)
    ...
    @OriginalMember(owner = "client!sga", name = "c", descriptor = "(II)Lrca;", line = 897)
    public final class36 method246(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IZ)Lpm;", line = 904)
    ...
    @OriginalMember(owner = "client!sga", name = "d", descriptor = "(II)V", line = 914)
    ...
    @OriginalMember(owner = "client!sga", name = "f", descriptor = "(Z)V", line = 939)
    ...
    @OriginalMember(owner = "client!sga", name = "q", descriptor = "(B)Z", line = 949)
    ...
    @OriginalMember(owner = "client!sga", name = "W", descriptor = "(I)V", line = 990)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lmia;)V", line = 1025)
    public final void method229(class684 arg0) {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BILdaa;Lpm;III)V", line = 1033)
    ...
    @OriginalMember(owner = "client!sga", name = "Y", descriptor = "(I)V", line = 1051)
    ...
    @OriginalMember(owner = "client!sga", name = "w", descriptor = "()Z", line = 1065)
    public final boolean method199() {
        return false;
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(FFF)V", line = 1071)
    public final void method186(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!sga", name = "V", descriptor = "(I)V", line = 1074)
    ...
    @OriginalMember(owner = "client!sga", name = "j", descriptor = "(Z)V", line = 1083)
    ...
    @OriginalMember(owner = "client!sga", name = "g", descriptor = "(B)V", line = 1099)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lcw;B)I", line = 1110)
    ...
    @OriginalMember(owner = "client!sga", name = "E", descriptor = "(I)V", line = 1127)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([BLpb;ZIIIZI)Lbw;", line = 1139)
    ...
    @OriginalMember(owner = "client!sga", name = "GA", descriptor = "(I)V", line = 1150)
    public final void method230(int arg0) {
        this.field8555.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!sga", name = "R", descriptor = "(I)V", line = 1158)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ZLan;)V", line = 1179)
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(IIIID)V", line = 1200)
    public final void method235(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lrh;B)V", line = 1204)
    ...
    @OriginalMember(owner = "client!sga", name = "na", descriptor = "(IIII)[I", line = 1229)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lpb;ILoea;BI)Lbw;", line = 1268)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ldha;Z)V", line = 1278)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Loea;ILpb;)Z", line = 1320)
    ...
    @OriginalMember(owner = "client!sga", name = "z", descriptor = "(I)V", line = 1332)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BLdaa;)I", line = 1342)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ZIB[[I)Lfp;", line = 1376)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;I)V", line = 1386)
    ...
    @OriginalMember(owner = "client!sga", name = "o", descriptor = "(I)V", line = 1398)
    ...
    @OriginalMember(owner = "client!sga", name = "g", descriptor = "(Z)V", line = 1408)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(II)Lcn;", line = 1418)
    public final class621 method236(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;Z)V", line = 1425)
    ...
    @OriginalMember(owner = "client!sga", name = "O", descriptor = "(I)V", line = 1434)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lcn;Lrca;)Lmia;", line = 1444)
    public final class684 method247(class621 arg0, class36 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Z)V", line = 1455)
    public final void method203(boolean arg0) {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IIZIII[I)Lbw;", line = 1458)
    ...
    @OriginalMember(owner = "client!sga", name = "m", descriptor = "()V", line = 1467)
    public final void method145() {
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;B)V", line = 1470)
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(IB)Lqs;", line = 1481)
    ...
    @OriginalMember(owner = "client!sga", name = "I", descriptor = "()I", line = 1526)
    public final int method136() {
        return 0;
    }

    @OriginalMember(owner = "client!sga", name = "b", descriptor = "()Lrb;", line = 1534)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Loja;I)I", line = 1542)
    ...
    @OriginalMember(owner = "client!sga", name = "v", descriptor = "()V", line = 1570)
    public final void method227() {
    }

    @OriginalMember(owner = "client!sga", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lae;Ljava/lang/Integer;)Lha;", line = 1574)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILwca;)V", line = 1672)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Loea;Lpb;B)Z", line = 1696)
