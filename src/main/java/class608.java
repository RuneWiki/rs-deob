...
public abstract class class608 extends class353 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lsn;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ji", name = "e", descriptor = "(I)V", line = 42)
