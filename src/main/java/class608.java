...
public class class608 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IILfd;)V", line = 105)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ZLfd;)V", line = 123)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BII)Z", line = 163)
