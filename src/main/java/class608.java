...
public class class608 extends class54 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lffa;BIII)Lgda;")
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lhia;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(ILhia;)V")
