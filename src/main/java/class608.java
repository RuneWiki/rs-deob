...
public abstract class class608 implements class126 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILjaclib/memory/Source;B)Z")
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Llh;IZ)V")
