...
public class class608 extends class249 implements class289 {
    ...
    @OriginalMember(owner = "client!pfa", name = "b", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "b", descriptor = "(B)V")
    public static void method3353(byte arg0) {
        int var1 = 21 % ((arg0 - 50) / 40);
        field8292 = null;
    }

    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IIILoa;)Z")
    ...
    @OriginalMember(owner = "client!pfa", name = "b", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Loa;B)Llt;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Loa;Luca;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(BLoa;)Lvg;")
