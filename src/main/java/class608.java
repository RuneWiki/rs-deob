...
public class class608 extends class331 {
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(B)I", line = 15)
    public final int method3332(byte arg0) {
        ++field8434;
        return arg0 >= -119 ? -76 : super.field4202;
    }

    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(ILts;)V", line = 74)
    public class608(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(B)I", line = 104)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lts;)V", line = 115)
