...
public abstract class class608 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(II[BIII[BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIBIII)Lka;", line = 52)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IILmaa;B)Luu;", line = 85)
    ...
    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(BI)Z", line = 162)
