...
public class class608 extends class600 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lbp;III)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIFIFFFFLqg;I)[B")
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lin;Lin;Lou;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lat;ZII)V")
