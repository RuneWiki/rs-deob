...
public class class608 extends class646 {
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lek;IB)V", line = 30)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "()V", line = 166)
    public class608() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)[[I", line = 171)
