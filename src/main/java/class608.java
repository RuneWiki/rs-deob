...
public class class608 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lrr;IIILoa;IILfa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)Lfc;", line = 103)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([II[J)V", line = 144)
    public static final void method3380(int[] arg0, int arg1, long[] arg2) {
        class215.method1250(-113, arg0, 0, arg2, arg2.length + arg1);
        field8286++;
    }

    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Z)V", line = 152)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIII[BII)Z", line = 171)
