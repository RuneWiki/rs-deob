...
public class class608 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljp;BI)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(BZIIIIIILuaa;Ls;ILs;Lha;)Lka;")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILuaa;Ls;IILha;IIZIIBLs;I)Lka;")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljp;Z)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IBLha;IILuaa;II)Lka;")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILha;ILuaa;III)Lka;")
