...
public class class608 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZZII)I", line = 34)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(FII[FFIFIBIII[FI)V", line = 56)
