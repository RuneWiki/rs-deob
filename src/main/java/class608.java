...
public abstract class class608 extends class593 {
    ...
    @OriginalMember(owner = "client!iq", name = "d", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lsca;I)Lsca;", line = 32)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILvs;ZILha;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I[Lraa;)I", line = 72)
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Lha;I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(IIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(B)Z", line = 130)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(III)Lma;", line = 142)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIBII)I", line = 149)
