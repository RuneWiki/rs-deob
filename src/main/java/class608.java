...
public class class608 extends class145 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IILrt;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Luj;Luj;B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZI)[I", line = 116)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!ih", name = "f", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "()V", line = 223)
    public class608() {
        super(3, false);
    }
}
