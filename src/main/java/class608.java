...
public class class608 extends class66 {
    ...
    @OriginalMember(owner = "client!kha", name = "fa", descriptor = "(CIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(Lpm;Lie;[Lus;[I[I)V", line = 60)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(CIIIZLaa;II)V", line = 100)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "([B[IIIIIIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 199)
