...
public class class608 implements class415 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)Ljg;")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lega;Ljg;Z)V")
