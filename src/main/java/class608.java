...
public class class608 {
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lha;IZ)Z", line = 196)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(BIIIIII)I", line = 278)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IZ)V", line = 309)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(I[Ltm;IIII)V", line = 465)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II)I", line = 332)
    public static final int method3556(int arg0, int arg1) {
        field8650++;
        return arg1 <= 92 ? -118 : arg0 >> 11 & 0x7F;
    }

    @OriginalMember(owner = "client!iw", name = "c", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lha;IIIIIIIII)V", line = 372)
    ...
    @OriginalMember(owner = "client!iw", name = "d", descriptor = "(I)V", line = 448)
