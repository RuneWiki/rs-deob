...
public class class608 extends class134 {
    ...
    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(B)I", line = 105)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!raa", name = "d", descriptor = "(I)Z", line = 129)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lkda;)V", line = 149)
    public class608(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(B)Lnha;", line = 152)
    ...
    @OriginalMember(owner = "client!raa", name = "e", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(ILkda;)V", line = 202)
