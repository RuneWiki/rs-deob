...
public class class608 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ljava/lang/Object;ILbe;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BLbe;Ljava/lang/Object;)V", line = 32)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILrda;)I", line = 91)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILbe;)Ljava/lang/Object;", line = 118)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)I", line = 183)
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(ILbe;)V", line = 207)
    ...
    @OriginalMember(owner = "client!qp", name = "e", descriptor = "(B)I", line = 239)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BLas;)V", line = 251)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(I)V", line = 349)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IB)V", line = 302)
