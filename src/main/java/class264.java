...
public class class264 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!sb", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    public final String toString() {
        field3633++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILun;)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 64)
