...
public class class264 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(I)Lel;")
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IB)Liia;")
