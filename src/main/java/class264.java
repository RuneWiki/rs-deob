...
public class class264 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIZ)Z", line = 21)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(III)Z", line = 112)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lkba;Lkba;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!rh", name = "d", descriptor = "(I)Z", line = 140)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Z)V", line = 150)
