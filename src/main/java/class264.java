...
public class class264 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I[BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIIIIIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 183)
