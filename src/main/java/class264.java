...
public class class264 extends class261 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILjv;IIILza;ZLe;IIIIII)Le;", line = 4)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "()V", line = 220)
    public class264() {
    }

    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 222)
    public class264(String arg0, int arg1) {
        this.field4028 = arg0;
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II[I[II)V", line = 232)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(B)V", line = 292)
