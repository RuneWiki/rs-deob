...
public class class264 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 11)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZII[Ljava/lang/String;)Ljava/lang/String;", line = 56)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I[II)[I", line = 120)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIB)V", line = 171)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 191)
