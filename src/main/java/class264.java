...
public class class264 extends class111 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BILqr;IIIIIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)V", line = 355)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BII)Lso;", line = 375)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)V", line = 401)
