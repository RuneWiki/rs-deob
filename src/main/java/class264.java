...
public class class264 extends class27 {
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lsb;I)I", line = 33)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(IIII)I", line = 199)
