...
public class class264 extends class332 implements class83 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIZLr;)Z")
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILr;ILcaa;ZII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZILr;)Ldg;")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lr;I)Lhr;")
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(Lr;I)Lifa;")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILr;I)Lda;")
