...
public class class264 extends class263 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 27)
    public class264() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIIIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)V", line = 239)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIB)V", line = 276)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BLjava/lang/String;)V", line = 314)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([I[Ljava/lang/Object;I)V", line = 326)
    public static final void method1654(int[] arg0, Object[] arg1, int arg2) {
        ++field3937;
        class96.method754(arg0.length + -1, arg0, arg1, arg2, (byte) 118);
    }

    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(B)V", line = 337)
