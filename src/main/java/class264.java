...
public class class264 implements class409 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IB)I", line = 109)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BILjava/lang/String;)V", line = 127)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Ljava/lang/Object;", line = 216)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IJ)Z", line = 234)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Object;ILjava/lang/Class;)I", line = 256)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(IB)I", line = 270)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Object;ZLjava/lang/Class;)Z", line = 285)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZI)V", line = 298)
    ...
    @OriginalMember(owner = "client!wba", name = "d", descriptor = "(B)V", line = 498)
