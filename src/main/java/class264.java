...
public abstract class class264 implements class658 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(BLjaggl/MapBuffer;Z)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILmfa;)V")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IBLjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Ljaggl/MapBuffer;Z)Z")
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lhj;IZ)V")
