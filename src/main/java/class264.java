...
public class class264 extends class287 implements class411 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!lf", name = "finalize", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lhg;B)V", line = 65)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lep;III)V", line = 131)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lep;IIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BII)V", line = 100)
    ...
    @OriginalMember(owner = "client!lf", name = "g", descriptor = "(I)V", line = 116)
