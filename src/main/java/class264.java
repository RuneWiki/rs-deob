...
public class class264 extends class337 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILhp;)Lw;", line = 3)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(II)I", line = 14)
    public static int method1763(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!bp", name = "e", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BILhp;)V", line = 44)
    ...
    @OriginalMember(owner = "client!bp", name = "i", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IB)[I", line = 139)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "()V", line = 232)
    public class264() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIB)Z", line = 196)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 239)
