...
public class class264 implements Runnable {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZZ[B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILon;)V", line = 45)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II[I)[I", line = 64)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "()V", line = 145)
    public class264() {
        this.field3972.setDaemon(true);
        this.field3972.start();
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/lang/String;I)Lfk;", line = 126)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!il", name = "run", descriptor = "()V", line = 178)
