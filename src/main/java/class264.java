...
public class class264 extends InputStream {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "read", descriptor = "()I", line = 32)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)[Lco;", line = 53)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I)V", line = 67)
