...
public class class264 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZILoc;Loc;)Lwa;", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZIILoc;Loc;)Lwa;", line = 18)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 58)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Loj;Lfn;)V", line = 203)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZLmd;)Lon;", line = 217)
