...
public class class264 extends class487 {
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(III)V", line = 15)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IBI)V", line = 51)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(III)B", line = 86)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIZ)V", line = 105)
