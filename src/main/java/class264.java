...
public class class264 {
    ...
    @OriginalMember(owner = "client!tf", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    public final String toString() {
        field4006++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(II)V", line = 49)
    public class264(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIZII)V", line = 76)
