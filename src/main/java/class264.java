...
public class class264 extends class40 {
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lef;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lef;IIIII)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lsi;I)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lef;IIII)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lef;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lef;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)Lrm;")
