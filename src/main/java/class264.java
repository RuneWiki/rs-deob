...
public class class264 extends class75 implements class422 {
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lwda;Laq;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lpw;I)V")
    public final void method31(class606 arg0, int arg1) {
        super.method31(arg0, arg1);
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II[BIIILaq;IB)V")
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lwda;Laq;Lui;II)V")
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lwda;IIZ[III)V")
