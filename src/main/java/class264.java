...
public class class264 implements class432 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)Lkt;", line = 10)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Z)I", line = 43)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Luq;)V", line = 59)
