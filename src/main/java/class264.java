...
public class class264 implements Runnable {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!sl", name = "run", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)V", line = 70)
