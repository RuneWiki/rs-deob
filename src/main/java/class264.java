...
public class class264 extends class108 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(JIBI)V", line = 68)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "()V", line = 123)
    public class264() {
    }

    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(I)V", line = 125)
