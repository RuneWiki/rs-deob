...
public class class264 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIIIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IB)V", line = 92)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(IB)Laf;", line = 106)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 160)
