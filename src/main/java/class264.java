...
public class class264 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "()Lhh;", line = 5)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "()I", line = 10)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "()[B", line = 58)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lae;)V", line = 119)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "()V", line = 148)
    private class264() {
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lhe;II)Lje;", line = 141)
