...
public class class264 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILec;)Z")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lec;ZII)V")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILqs;ZIII)V")
