...
public class class264 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Lpl;")
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lec;)V")
    public class264(class129 arg0) {
        this.field3681 = arg0;
    }

    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)Lpl;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIIIIIZIILkh;Z)V")
