...
public class class264 extends class739 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lsl;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(II)[[I", line = 47)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IBIIILfj;)V", line = 124)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "()V", line = 479)
    public class264() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IZZ)V", line = 386)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljw;[Lwh;)V", line = 410)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(I)V", line = 495)
