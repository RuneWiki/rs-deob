...
public class class264 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lah;IBLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLah;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lhl;B)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lah;ILjava/lang/Object;)V")
    public final void method1611(class250 arg0, int arg1, Object arg2) {
        field3987++;
        this.method1604(arg0, arg1, (byte) -33, arg2);
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILah;)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Llt;II)Ljv;")
