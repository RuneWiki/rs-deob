...
public class class264 extends class96 {
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "()V", line = 76)
    public class264() {
        super(1, false);
    }

    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)[I", line = 14)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLmv;)V", line = 46)
    ...
    @OriginalMember(owner = "client!om", name = "e", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IILbt;)V", line = 101)
    ...
    @OriginalMember(owner = "client!om", name = "g", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)[[I", line = 161)
