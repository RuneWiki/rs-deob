...
public class class264 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(JI)Lpea;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I[[[Lhl;ZIIB)Z")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)Lpea;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Lpea;ZJ)V")
