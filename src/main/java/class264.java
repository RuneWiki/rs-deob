...
public abstract class class264 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "([BB)[B", line = 39)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lmfa;)V", line = 118)
    public class264(class640 arg0) {
        this.field3731 = arg0;
        this.field3733 = this.method663((byte) -38);
    }

    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(ILmfa;)V", line = 127)
