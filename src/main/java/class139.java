...
public class class139 extends class330 {
    ...
    @OriginalMember(owner = "client!tl", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "()V", line = 29)
    public class139() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)[[I", line = 44)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IBI)V", line = 141)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lgga;IB)V", line = 168)
