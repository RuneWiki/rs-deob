...
public class class139 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZLqj;)V", line = 14)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(BD)V", line = 55)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(B)Lfga;", line = 113)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lfga;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(B)Lfga;", line = 150)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "()V", line = 256)
    public class139() {
        this.field1803.field7966 = this.field1803;
        this.field1803.field7971 = this.field1803;
    }

    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(I)Lfga;", line = 182)
    ...
    @OriginalMember(owner = "client!fca", name = "d", descriptor = "(I)I", line = 207)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IILqj;ZI[I)Lar;", line = 225)
    ...
    @OriginalMember(owner = "client!fca", name = "e", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Z)Lfga;", line = 265)
