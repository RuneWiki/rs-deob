...
public class class139 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ljk;", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZJ)V", line = 33)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(III)V", line = 130)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Z)V", line = 185)
    public class139(boolean arg0) {
        this.field1981 = arg0;
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Luq;ZZ)V", line = 196)
