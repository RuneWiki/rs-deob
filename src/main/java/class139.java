...
public class class139 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Lwa;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)Lwa;")
    ...
    @OriginalMember(owner = "client!se", name = "d", descriptor = "(I)Lwa;")
