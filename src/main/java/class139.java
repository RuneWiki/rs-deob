...
public class class139 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIB)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILna;)V", line = 80)
    public static final void method1042(int arg0, class35 arg1) {
        class88.field1546[arg0] = arg1;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Ljava/lang/String;IC)[Ljava/lang/String;", line = 83)
