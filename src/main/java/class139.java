...
public class class139 extends class322 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(B)J", line = 25)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lch;)V", line = 38)
    public class139(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hc", name = "c", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(Z)I", line = 63)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILjava/awt/Component;IBLvc;)Ljba;", line = 74)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(ILch;)V", line = 157)
    public class139(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IB)V", line = 161)
