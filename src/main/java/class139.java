...
public class class139 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(CBLjava/lang/String;)[Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!kb", name = "toString", descriptor = "()Ljava/lang/String;", line = 86)
    public final String toString() {
        field2085++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(I)V", line = 95)
