...
public class class139 extends class187 {
    ...
    @OriginalMember(owner = "client!p", name = "Gc", descriptor = "Llf;")
    private static class109 field2700 = class35.method275("Could not complete login)3", 2);

    @OriginalMember(owner = "client!p", name = "Ic", descriptor = "Llf;")
    public static class109 field2702 = class35.method275("me", 2);

    @OriginalMember(owner = "client!p", name = "yc", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!p", name = "Cc", descriptor = "I")
    public static int field2696;

    @OriginalMember(owner = "client!p", name = "Fc", descriptor = "I")
    public static int field2699;

    @OriginalMember(owner = "client!p", name = "Jc", descriptor = "I")
    public static int field2703;

    @OriginalMember(owner = "client!p", name = "Kc", descriptor = "Loh;")
    public static class138 field2704;

    @OriginalMember(owner = "client!p", name = "xc", descriptor = "Lsd;")
    public class170 field2691;

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILja;)Lj;")
