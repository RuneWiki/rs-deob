...
public abstract class class139 extends class673 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILhk;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 31)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)V", line = 46)
    public static void method775(byte arg0) {
        field1593 = null;
        int var1 = 96 / ((arg0 - 38) / 59);
    }

    @OriginalMember(owner = "client!as", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)I", line = 65)
    public static int method776(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!as", name = "d", descriptor = "(B)Z", line = 79)
    public final boolean method449(byte arg0) {
        field1592++;
        return arg0 == -126 ? false : false;
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "([FII)[F", line = 91)
