...
public class class139 extends class651 implements class320 {
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Log;IZ[[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(IIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 69)
