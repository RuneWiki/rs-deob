...
public class class139 extends class390 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)I", line = 7)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIILjava/lang/Class;)Lkr;", line = 36)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Z)Z", line = 62)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!se", name = "d", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIIIBIIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!se", name = "e", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(II)V", line = 135)
    public class139(int arg0, int arg1) {
        this.field1979 = arg1;
        this.field1985 = arg0;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IZ)V", line = 145)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IC)Z", line = 249)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZI)Z", line = 261)
