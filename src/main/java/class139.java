...
public class class139 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)Lwfa;", line = 25)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(I)Lwfa;", line = 53)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "()V", line = 93)
    public class139() {
    }

    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lak;)V", line = 95)
