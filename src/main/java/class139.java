...
public class class139 extends Canvas {
    ...
    @OriginalMember(owner = "client!eq", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 8)
    public final void update(Graphics arg0) {
        field1784++;
        this.field1780.update(arg0);
    }

    @OriginalMember(owner = "client!eq", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 20)
    public final void paint(Graphics arg0) {
        this.field1780.paint(arg0);
        field1786++;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 46)
