...
public class class139 extends class501 {
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lia;Ldea;)V", line = 46)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BII)Z", line = 62)
