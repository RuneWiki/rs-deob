...
public class class139 {
    ...
    @OriginalMember(owner = "client!ofa", name = "toString", descriptor = "()Ljava/lang/String;", line = 7)
    public final String toString() {
        field1658++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 19)
    public class139(String arg0, int arg1) {
        this.field1660 = arg1;
    }

    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Z)I", line = 29)
