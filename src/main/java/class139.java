...
public class class139 extends class91 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(I)V", line = 36)
    public class139(int arg0) {
        this.field2295 = arg0;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILsea;IZ)V", line = 44)
