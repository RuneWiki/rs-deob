...
public class class139 extends class168 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILnd;)I")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lria;I)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IILjava/awt/Canvas;Ld;ILnd;)Lha;")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIZIILvl;I)V")
