...
public class class139 implements class216 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lwu;Lwu;Lkca;)V", line = 61)
