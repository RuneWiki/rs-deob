...
public class class139 extends class589 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Ldt;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZBLha;J)V", line = 45)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIILjava/awt/Canvas;)Llea;", line = 356)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lha;Lvja;Lls;J)V", line = 442)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(JBLha;)V", line = 384)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 403)
