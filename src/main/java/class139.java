...
public class class139 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IIZLr;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BIILr;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lac;Lok;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lr;III)Z")
