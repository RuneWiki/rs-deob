...
public class class139 extends class264 {
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "()V", line = 3)
    public class139() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IBLnl;)Lgn;", line = 6)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ICLjava/lang/String;)I", line = 23)
    ...
    @OriginalMember(owner = "client!oq", name = "h", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BII)I", line = 71)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)[I", line = 88)
