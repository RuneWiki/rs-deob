...
public class class139 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(JLrp;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(BJ)Lrp;", line = 44)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "([Lrp;I)I", line = 81)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IB)V", line = 149)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!faa", name = "d", descriptor = "(I)Lrp;", line = 212)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(B)Lrp;", line = 249)
    ...
    @OriginalMember(owner = "client!faa", name = "e", descriptor = "(I)Lrp;", line = 281)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(I)V", line = 290)
