...
public class class139 extends class332 {
    ...
    @OriginalMember(owner = "client!hu", name = "d", descriptor = "(B)Lcda;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IILha;IIIILuo;IIII)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lmj;II)I")
