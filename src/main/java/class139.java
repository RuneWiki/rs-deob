...
public class class139 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BI)Lur;", line = 19)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 157)
