...
public class class139 extends class294 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILts;BI)V")
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILdg;)V")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Leq;II)Z")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIILbp;IZLeq;)V")
