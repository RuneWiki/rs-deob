...
public class class139 extends InputStream {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ls", name = "read", descriptor = "()I", line = 19)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IBI)Z", line = 29)
