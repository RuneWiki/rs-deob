...
public class class139 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Leb;III)V", line = 16)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILaa;IZ)Llf;", line = 45)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Leb;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)V", line = 114)
