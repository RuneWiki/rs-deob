...
public abstract class class139 {
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(III)Z", line = 59)
