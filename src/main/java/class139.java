...
public class class139 {
    ...
    @OriginalMember(owner = "client!vl", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IC)Z", line = 14)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Ljava/lang/String;IILcr;)Lrp;", line = 51)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lpea;II)V", line = 131)
    public class139(class641 arg0, int arg1, int arg2) {
        this.field1780 = arg2;
        this.field1777 = arg0;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(III)Z", line = 153)
