...
public class class139 extends class362 {
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "([IB[I[ILwda;)V", line = 29)
    ...
    @OriginalMember(owner = "client!qea", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!qea", name = "c", descriptor = "(II)V", line = 149)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IB)[[I", line = 297)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(I)V", line = 336)
    private class139(int arg0) {
        super(0, false);
        this.method1138(-120, arg0);
    }

    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "()V", line = 345)
    public class139() {
        this(0);
    }

    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Lfca;II)V", line = 351)
