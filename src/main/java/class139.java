...
public class class139 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lnq;II)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lqb;B)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "([BIILgf;)Lle;")
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ltu;Lob;Lha;IIIII)V")
