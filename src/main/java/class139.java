...
public class class139 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IBLwn;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)Lpq;")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lwj;ILwu;Lwu;)V")
