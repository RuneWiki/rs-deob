...
public class class139 implements class79 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!faa", name = "finalize", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IILqe;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IIIIFIZI)[I", line = 63)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IILwn;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!faa", name = "d", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Lok;)V", line = 380)
    ...
    @OriginalMember(owner = "client!faa", name = "d", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)V", line = 224)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Lwn;IB)V", line = 251)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IB)V", line = 265)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IIBILqe;)V", line = 290)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IILeaa;)V", line = 326)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Z)V", line = 366)
