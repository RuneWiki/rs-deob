...
public class class139 extends class44 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Llp;)V", line = 3)
    public final void method231(class220 arg0) {
        this.field540.method1003(arg0);
    }

    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lao;)V", line = 35)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(Z)V", line = 12)
    public final void method230(boolean arg0) {
        this.field540.method981(8448, 7681);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 30)
    public final void method228(int arg0) {
    }

    @OriginalMember(owner = "client!pd", name = "b", descriptor = "()Z", line = 32)
    public final boolean method232() {
        return true;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)V", line = 72)
