...
public class class139 extends class252 {
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lur;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lur;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lur;II)V")
