...
public class class139 extends class371 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IJ)V", line = 4)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IB)V", line = 37)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "()V", line = 53)
    public class139() {
        this(4096);
    }

    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(B)J", line = 57)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(BI)[I", line = 71)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IBLps;)V", line = 94)
    ...
    @OriginalMember(owner = "client!tca", name = "g", descriptor = "(I)V", line = 124)
