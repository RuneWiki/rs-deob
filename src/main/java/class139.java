...
public class class139 extends class101 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lbba;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)J", line = 418)
    public static final long method1074(int arg0, int arg1) {
        field2022++;
        return arg1 >= 0 ? 53L : (long) (arg0 + 11745) * 86400000L;
    }

    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 429)
