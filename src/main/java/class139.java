...
public class class139 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)I", line = 21)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Z)V", line = 60)
