...
public class class139 extends class276 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I[[BLdv;)V", line = 6)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 98)
