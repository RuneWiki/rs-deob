...
public class class139 extends class497 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lha;Lrca;II)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BILkja;)V")
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lpj;)V")
    public class139(class156 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILwia;ZIIII)V")
