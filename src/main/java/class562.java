...
public class class562 extends class741 {
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Loaa;Lae;Loca;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILml;)V")
