...
public class class562 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lmfa;B)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I)Lmu;")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lmu;I)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILiaa;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lmu;ILmfa;)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Z)Lmu;")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILmu;)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(I)Lmu;")
    ...
    @OriginalMember(owner = "client!mfa", name = "d", descriptor = "(B)Lmu;")
    ...
    @OriginalMember(owner = "client!mfa", name = "e", descriptor = "(B)Lmu;")
