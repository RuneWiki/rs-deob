...
public class class562 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IILos;)V", line = 8)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIIIIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BLos;)V", line = 163)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)Lei;", line = 186)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIII[Let;IIIII)V", line = 259)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)Z", line = 939)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)Z", line = 965)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BLjava/lang/String;)I", line = 1002)
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(I)V", line = 1023)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)Lei;", line = 1042)
