...
public class class562 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lfea;[[BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IZ)Loga;", line = 122)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ZZIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BCLjava/lang/String;)I", line = 180)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(IIII)V", line = 208)
