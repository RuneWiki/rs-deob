...
public class class562 extends class557 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ltn;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BLdt;)V", line = 31)
