...
public class class562 extends class137 {
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(II)Lhia;", line = 5)
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(I)F", line = 73)
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(B)F", line = 87)
    ...
    @OriginalMember(owner = "client!bka", name = "f", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!bka", name = "g", descriptor = "(I)Ljava/lang/String;", line = 112)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 124)
    ...
    @OriginalMember(owner = "client!bka", name = "h", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(IIB)Z", line = 221)
    ...
    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 231)
    public class562(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!bka", name = "c", descriptor = "(B)Ljava/lang/String;", line = 244)
