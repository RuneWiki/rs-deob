...
public class class562 implements Runnable {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILhd;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(JIBLfc;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "d", descriptor = "(B)Lfc;")
