...
public class class562 extends class42 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIBIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIZI)V", line = 153)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BII)Z", line = 163)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lvo;Lvo;Lcda;)V", line = 173)
