...
public class class562 extends class748 {
    ...
    @OriginalMember(owner = "client!cm", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZLvj;)V", line = 20)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "()V", line = 37)
    public class562() {
        super(0, false);
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(II)[[I", line = 53)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)I", line = 123)
    public final int method3362(byte arg0) {
        ++field7985;
        return arg0 <= 109 ? 15 : this.field7986;
    }

    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(B)Z", line = 139)
