...
public class class562 extends InputStream {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)Lkr;", line = 6)
    ...
    @OriginalMember(owner = "client!tv", name = "read", descriptor = "()I", line = 25)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BIII)I", line = 35)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IILria;BIII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 238)
