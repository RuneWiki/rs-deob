...
public class class562 extends class379 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "()V", line = 22)
    public class562() {
    }

    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 24)
