...
public class class562 extends class260 {
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lgn;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([Lje;II)V")
