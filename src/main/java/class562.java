...
public class class562 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lnh;FILnh;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Ler;)V", line = 124)
    public class562(class92 arg0) {
        this.field8089 = arg0;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BII[BIII)Z", line = 138)
