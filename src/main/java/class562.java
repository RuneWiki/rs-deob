...
public class class562 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IIIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(ZI)Lvea;", line = 232)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 284)
