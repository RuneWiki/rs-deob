...
public class class562 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BJ)Llj;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)Lsaa;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IJLlj;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)Llj;")
