...
public class class562 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lum;B)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lrga;I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILht;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)Lqp;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILrga;)V")
