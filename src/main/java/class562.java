...
public class class562 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lmc;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)Z", line = 107)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lsi;IIIB)Z", line = 139)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(B)Lsu;", line = 265)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lmc;I)V", line = 344)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(II)V", line = 369)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Z)Lsu;", line = 380)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)Z", line = 449)
