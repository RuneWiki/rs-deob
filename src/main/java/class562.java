...
public abstract class class562 {
    ...
    @OriginalMember(owner = "client!r", name = "finalize", descriptor = "()V", line = 21)
    protected void finalize() {
        this.method3127(true);
        field7685++;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIIBI)V", line = 44)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lf;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "(IIIIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(Z)V", line = 262)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILjava/awt/Canvas;Lga;ILfa;)Lr;", line = 274)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lfa;)V", line = 315)
