...
public class class562 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "([BI[B)V", line = 38)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B[B)V", line = 84)
