...
public class class562 extends class277 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lqj;)V", line = 30)
    public class562(class548 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILrg;)V", line = 38)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(IZ)V", line = 86)
