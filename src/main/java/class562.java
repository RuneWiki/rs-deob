...
public class class562 extends class18 implements class532 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Loa;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BILoa;I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(Z)I", line = 55)
    ...
    @OriginalMember(owner = "client!gl", name = "g", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(IIIIILl;)V", line = 79)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Loa;BI)Lba;", line = 87)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Loa;B)V", line = 98)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(Z)I", line = 108)
    public final int method146(boolean arg0) {
        field7446++;
        return arg0 ? 60 : 0;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILoa;)Ldd;", line = 120)
    public final class660 method143(int arg0, class651 arg1) {
        field7448++;
        return arg0 == 31358 ? this.field7454.method143(arg0, arg1) : null;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIII)Z", line = 134)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)I", line = 351)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Loa;Z)V", line = 372)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BLoa;)Lpe;", line = 384)
