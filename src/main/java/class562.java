...
public class class562 extends class322 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II[[[BIILha;IIIIZII)V")
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(ILch;)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lch;)V")
