...
public abstract class class91 extends class318 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "([Ltj;B)I", line = 27)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(Lha;B)Z", line = 107)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(IIIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!pn", name = "k", descriptor = "(I)Z", line = 133)
