...
public class class91 extends class192 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILfd;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "h", descriptor = "(I)[Lfl;")
