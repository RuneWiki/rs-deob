...
public abstract class class91 extends class223 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(III)Z", line = 24)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Z)Z", line = 35)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(Z)I", line = 46)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(Z)I", line = 61)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(III)Z", line = 76)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lfd;)V", line = 109)
