...
public class class91 extends class232 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(IB)[I", line = 10)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(IIIIII[B)V", line = 33)
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "()V", line = 129)
    public class91() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(B)V", line = 132)
