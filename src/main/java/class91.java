...
public class class91 extends class498 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)Lmp;")
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(IIIIIF)V")
    public class91(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BF)V")
