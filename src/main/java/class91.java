...
public abstract class class91 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lij;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(III)V", line = 122)
