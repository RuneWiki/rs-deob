...
public class class91 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Z)[Lfe;", line = 5)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!jda", name = "e", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILfm;)V", line = 80)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(III)V", line = 113)
