...
public class class91 extends class29 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLnr;Lct;Lct;Lct;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lic;Lct;I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLat;)Lpo;", line = 83)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLbf;I)Lrr;", line = 119)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILjava/lang/String;)J", line = 153)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lic;ILct;ZIDI)[I", line = 196)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZIIDLct;ZBLic;)[I", line = 336)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 483)
    public class91() {
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lat;)V", line = 498)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IZILct;Lic;B)[F", line = 587)
