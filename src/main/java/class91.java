...
public class class91 {
    ...
    @OriginalMember(owner = "client!kba", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lva;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Z)V", line = 165)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIIII)V", line = 178)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Len;J[Lhba;)V", line = 254)
