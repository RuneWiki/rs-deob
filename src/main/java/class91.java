...
public class class91 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILio;)V", line = 37)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BI)V", line = 134)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(II)Liv;", line = 169)
    ...
    @OriginalMember(owner = "client!k", name = "c", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!k", name = "d", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IZ)V", line = 255)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lnq;IZLga;Lga;)V", line = 287)
