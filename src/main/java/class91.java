...
public class class91 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZBIZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILnf;)V", line = 48)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 98)
