...
public class class91 extends class305 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lvs;[Lraa;)V")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lhb;)V")
    public class91(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(ILhb;)V")
