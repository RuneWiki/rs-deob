...
public class class91 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lkw;Lsn;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZLqw;)I")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILdq;Ljava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IILnj;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lnj;I)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIBIILka;II)Lka;")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lka;IIIII)Lka;")
