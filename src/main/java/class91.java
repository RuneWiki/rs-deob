...
public class class91 {
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(ILmj;Lmj;I)V", line = 291)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I[BIB)Z", line = 12)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I[BIZB)Z", line = 45)
    ...
    @OriginalMember(owner = "client!wf", name = "toString", descriptor = "()Ljava/lang/String;", line = 169)
    public final String toString() {
        field1460++;
        return "Cache:" + this.field1463;
    }

    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)[B", line = 179)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)V", line = 278)
