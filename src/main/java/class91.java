...
public class class91 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(ILac;I)V")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lrc;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lac;B)V")
