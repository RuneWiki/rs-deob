...
public class class91 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)Lap;", line = 3)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Leb;B)V", line = 62)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IILeb;)V", line = 84)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lkq;ILsr;Ljava/awt/Canvas;II)Laa;", line = 199)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIIII)Z", line = 230)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)Lap;", line = 314)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)Z", line = 379)
