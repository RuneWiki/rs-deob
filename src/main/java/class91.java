...
public class class91 extends class385 {
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "()I", line = 6)
    public final int method389() {
        return this.field1349.field5721 + this.field1356 + this.field1355;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(FFFFFFIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(IIIIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "()V", line = 223)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "()I", line = 232)
    public final int method382() {
        return this.field1349.field5719 + this.field1351 + this.field1352;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIIIII)V", line = 236)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "()I", line = 367)
    public final int method394() {
        return this.field1349.field5721;
    }

    @OriginalMember(owner = "client!bj", name = "d", descriptor = "()I", line = 372)
    public final int method388() {
        return this.field1349.field5719;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(III)V", line = 377)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(FFFFFFLvb;II)V", line = 397)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lqi;IIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lqi;II[III)V", line = 600)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 491)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(IIII)V", line = 519)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILvb;II)V", line = 527)
