...
public class class91 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILbt;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILbt;)V", line = 130)
