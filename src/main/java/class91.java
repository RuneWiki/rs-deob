...
public class class91 extends class98 {
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uh", name = "f", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Z)V", line = 197)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "()V", line = 224)
    public class91() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)[I", line = 228)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(IB)[I", line = 268)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILae;Ltq;Ltq;)V", line = 287)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILdg;I)V", line = 302)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(I)V", line = 327)
