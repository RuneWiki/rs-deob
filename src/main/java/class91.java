...
public class class91 extends class337 implements class240 {
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(II)V", line = 6)
    public final void method704(int arg0, int arg1) {
        this.field1413.method966().method2360(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lqa;Lna;II[[I[[IIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lba;IIIIZ)Z", line = 21)
    public final boolean method710(class502 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III[[ZZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIIII[[Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lwr;[I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 160)
