...
public class class91 implements class553 {
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 21)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(B)I", line = 42)
    public final int method677(byte arg0) {
        return arg0 < 92 ? -66 : this.field1021;
    }

    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIZ)Z", line = 78)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lta;Z)V", line = 143)
    public class91(class224 arg0, boolean arg1) {
        this.field1027 = arg0;
        this.field1025 = arg1;
    }

    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)I", line = 136)
