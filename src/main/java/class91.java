...
public class class91 extends class11 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIB)V", line = 13)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(IZ)Z", line = 23)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)Z", line = 35)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lad;)V", line = 62)
    public class91(class362 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILpm;)V", line = 85)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 97)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IZ)V", line = 121)
