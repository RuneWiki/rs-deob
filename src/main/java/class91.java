...
public abstract class class91 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lcu;II)Ljava/lang/String;", line = 167)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 196)
    public static void method707(int arg0) {
        int var1 = 61 / ((arg0 + 13) / 41);
        field1566 = null;
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljava/lang/String;ZIILmq;Leu;Lea;Loa;IIII)V", line = 205)
