...
public class class91 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Z)V", line = 198)
