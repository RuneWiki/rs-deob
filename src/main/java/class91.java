...
public class class91 extends class237 implements class74 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIIILos;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lht;I[BI)V")
    public class91(class410 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1231 = arg1;
    }

    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lht;ILjaggl/memory/NativeBuffer;)V")
