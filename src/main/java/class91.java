...
public class class91 extends class476 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IBI)I", line = 6)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Z)V", line = 63)
