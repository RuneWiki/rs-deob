...
public class class91 {
    ...
    @OriginalMember(owner = "client!lba", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field1221++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(II)Llba;", line = 35)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(IILkf;)V", line = 111)
