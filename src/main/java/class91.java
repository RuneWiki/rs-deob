...
public class class91 extends class601 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B[[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "()V", line = 58)
    public class91() {
        super(0, true);
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lee;BI)V", line = 76)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(IZ)[[I", line = 153)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I[BB)[B", line = 214)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BI)[I", line = 227)
