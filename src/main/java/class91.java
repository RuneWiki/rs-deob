...
public class class91 extends class28 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lmaa;)V", line = 196)
    public class91(class588 arg0) {
        this.field1111 = arg0;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BII[B[I[[B[[B[I)I", line = 75)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IBI)Z", line = 133)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)V", line = 149)
