...
public class class91 extends class419 {
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ur", name = "e", descriptor = "(I)I", line = 30)
    public final int method76(int arg0) {
        ++field1043;
        return arg0 != 20765 ? 14 : super.field6079;
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lvm;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lam;B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ur", name = "k", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIILvm;)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ur", name = "l", descriptor = "(I)Z", line = 144)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ZIIILai;ILvm;)V", line = 155)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILvm;B)Z", line = 167)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lvm;Z)Ldn;", line = 285)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(B)Z", line = 355)
    public final boolean method345(byte arg0) {
        ++field1045;
        return arg0 != -72;
    }

    @OriginalMember(owner = "client!ur", name = "f", descriptor = "(B)I", line = 367)
    ...
    @OriginalMember(owner = "client!ur", name = "i", descriptor = "(I)I", line = 389)
    ...
    @OriginalMember(owner = "client!ur", name = "g", descriptor = "(B)V", line = 410)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lce;I)V", line = 421)
