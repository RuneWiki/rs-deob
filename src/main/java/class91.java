...
public class class91 extends class80 {
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "()V", line = 4)
    public class91() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIIBIIIILsd;III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILnn;)V", line = 441)
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(II)[[I", line = 484)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)[I", line = 562)
    ...
    @OriginalMember(owner = "client!wf", name = "d", descriptor = "(I)V", line = 607)
