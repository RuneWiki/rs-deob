...
public class class91 extends class71 {
    ...
    @OriginalMember(owner = "client!jf", name = "w", descriptor = "Li;")
    public class78 field1871;

    @OriginalMember(owner = "client!jf", name = "p", descriptor = "Ljb;")
    public class87 field1864;

    @OriginalMember(owner = "client!jf", name = "r", descriptor = "Ljb;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/awt/Color;ILlf;I)V")
