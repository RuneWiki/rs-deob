...
public class class91 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lkh;)V", line = 114)
    public final void method703(class369 arg0) {
        this.method704(arg0, true);
    }

    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lkh;Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lnm;)V", line = 361)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "()V", line = 137)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(Lkh;)Z", line = 214)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "()Z", line = 239)
    private final boolean method707() {
        return this.field1258.method1641() == this.field1263;
    }

    @OriginalMember(owner = "client!jl", name = "c", descriptor = "()V", line = 243)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "()V", line = 274)
