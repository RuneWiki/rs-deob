...
public class class91 extends class459 implements class302 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IBLr;)Lda;")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(ZILr;I)Z")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(BLr;)Lll;")
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(ILr;)Lod;")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(ZILr;B)Lraa;")
