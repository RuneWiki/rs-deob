...
public class class91 extends InputStream {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 71)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IIIIBI)V", line = 110)
    ...
    @OriginalMember(owner = "client!kca", name = "read", descriptor = "()I", line = 213)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 222)
