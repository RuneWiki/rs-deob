...
public class class91 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)Lwba;", line = 21)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 102)
    public class91(class671 arg0, int arg1, class449 arg2) {
        this.field1380 = arg2;
        this.field1380.method2527(0, 26);
    }

    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(B)V", line = 118)
