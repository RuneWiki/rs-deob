...
public class class91 extends class193 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIIIIII[[ZLho;[I[I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lc;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIZLho;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(Lc;IIIIZ)V")
    public final void method733(class308 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ldn;[I)V")
    public final void method734(class16 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILc;)Lc;")
    public final class308 method735(int arg0, int arg1, class308 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Llh;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILho;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(IIIIIII[[ZLho;[I[I)V")
                    ...
                    if (this.field1242[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field3699; ++var23) {
                            ...
                            if (var21.field3697 == null || var21.field3697[var23] == 0 || var21.field3698 != null && (var21.field3698 == null || var21.field3698[var23] != -1)) {
                                if (var21.field3698 != null && var21.field3698[var23] != -1) {
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(Lc;IIIIZ)Z")
