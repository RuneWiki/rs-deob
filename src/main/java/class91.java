...
public class class91 extends class634 {
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(BI)[I", line = 6)
    ...
    @OriginalMember(owner = "client!tt", name = "d", descriptor = "(B)V", line = 64)
    public static void method618(byte arg0) {
        int var1 = -82 % ((arg0 - 44) / 37);
        field942 = null;
    }

    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "()V", line = 73)
    public class91() {
        super(3, false);
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILig;Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BI)[[I", line = 102)
