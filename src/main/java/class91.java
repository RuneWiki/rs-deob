...
public class class91 extends class759 {
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(IIIIIF)V")
    public class91(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILcca;)I")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZF)V")
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(Z)Lsr;")
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(ILgba;)V")
