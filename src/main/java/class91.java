...
public class class91 extends class383 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(III)Lis;", line = 47)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IIZIZ)V", line = 71)
