...
public class class91 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IILnr;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IZI)Ljava/lang/String;", line = 127)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILnr;)V", line = 145)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(I[Lu;IIII)V", line = 503)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILnr;IIIIIIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(B)V", line = 371)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)V", line = 383)
