...
public class class91 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILbg;B)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZLkj;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lbg;B)V")
