...
public class class91 extends class508 {
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BZ)Z", line = 41)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lwh;[B[IB)Z", line = 91)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "()V", line = 158)
    public class91() {
    }

    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "([B)V", line = 160)
