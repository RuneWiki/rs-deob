...
public class class91 implements Runnable {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIILcr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "([BIILoc;)Lrh;", line = 80)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IILoc;)Lrh;", line = 112)
    ...
    @OriginalMember(owner = "client!fn", name = "run", descriptor = "()V", line = 146)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILoc;I)Lrh;", line = 192)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lrh;I)V", line = 209)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)V", line = 228)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Ljs;)V", line = 268)
