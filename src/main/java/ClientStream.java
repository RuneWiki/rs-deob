...
public class ClientStream implements Runnable {
    ...
    @OriginalMember(owner = "client!d", name = "f", descriptor = "La;")
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(La;BLjava/net/Socket;)V")
    ...
    public void method33(byte[] arg0, int arg1, boolean arg2, int arg3) throws IOException {
        if (!arg2 || this.field65) {
            return;
        }
        if (this.field71) {
            this.field71 = false;
        ...
        synchronized (this) {
            for (int var6 = 0; var6 < arg1; var6++) {
                this.field67[this.field69] = arg0[arg3 + var6];
