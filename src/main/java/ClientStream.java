...
public class ClientStream implements Runnable {
    ...
    private int field137 = -323;

    @OriginalMember(owner = "client!e", name = "b", descriptor = "I")
    private int field138 = -20292;
    ...
    @OriginalMember(owner = "client!e", name = "h", descriptor = "La;")
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(ILjava/net/Socket;La;)V")
    ...
    public void method42(int arg0, byte arg1, int arg2, byte[] arg3) throws IOException {
        if (arg1 != 3) {
            this.field138 = 8;
        }
        if (this.field143) {
        ...
        synchronized (this) {
            for (int var6 = 0; var6 < arg0; var6++) {
                this.field145[this.field147] = arg3[arg2 + var6];
