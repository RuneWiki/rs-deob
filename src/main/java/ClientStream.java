...
public class ClientStream implements Runnable {
    ...
    private byte field134 = 4;

    @OriginalMember(owner = "client!e", name = "b", descriptor = "I")
    private int field135 = -32411;
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(BLa;Ljava/net/Socket;)V")
    ...
    public void method42(int arg0, byte[] arg1, int arg2, boolean arg3) throws IOException {
        if (arg3) {
            this.field135 = 69;
        }
        if (this.field140) {
