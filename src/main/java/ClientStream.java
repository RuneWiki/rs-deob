...
public class ClientStream implements Runnable {
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(La;ILjava/net/Socket;)V")
    ...
    public void method32(byte[] arg0, int arg1, boolean arg2, int arg3) throws IOException {
        if (this.field62) {
            return;
        }
        if (this.field68) {
