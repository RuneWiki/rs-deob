...
public class ClientStream implements Runnable {
    ...
    @OriginalMember(owner = "e", name = "i", descriptor = "Z")
    private boolean field143 = false;

    @OriginalMember(owner = "e", name = "j", descriptor = "Z")
    private boolean field144 = false;

    @OriginalMember(owner = "e", name = "e", descriptor = "La;")
    public GameShell field139;

    @OriginalMember(owner = "e", name = "c", descriptor = "Ljava/net/Socket;")
    private Socket field137;

    @OriginalMember(owner = "e", name = "a", descriptor = "Ljava/io/InputStream;")
    private InputStream field135;

    @OriginalMember(owner = "e", name = "b", descriptor = "Ljava/io/OutputStream;")
    ...
    @OriginalMember(owner = "e", name = "f", descriptor = "[B")
    private byte[] field140;

    @OriginalMember(owner = "e", name = "<init>", descriptor = "(Ljava/net/Socket;La;B)V")
    ...
    @OriginalMember(owner = "e", name = "a", descriptor = "(IZI[B)V")
