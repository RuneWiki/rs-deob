...
public class ClientStream implements Runnable {
    ...
    @OriginalMember(owner = "client!e", name = "f", descriptor = "La;")
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Ljava/net/Socket;BLa;)V")
    public ClientStream(Socket arg0, byte arg1, GameShell arg2) throws IOException {
        this.field141 = arg2;
        if (arg1 != 8) {
    ...
    public void method42(boolean arg0, byte[] arg1, int arg2, int arg3) throws IOException {
        ...
        synchronized (this) {
            for (int var6 = 0; var6 < arg2; var6++) {
                this.field142[this.field144] = arg1[arg3 + var6];
