...
public class class193 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZI)I", line = 8)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "([SB)[S", line = 48)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(II)V", line = 118)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I[B)[B", line = 178)
