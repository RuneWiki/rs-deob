...
public class class193 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIZ)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(FFZFIFFF)F", line = 18)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Llea;)V", line = 150)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)V", line = 120)
