...
public class class193 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hi", name = "toString", descriptor = "()Ljava/lang/String;", line = 39)
    public final String toString() {
        field2824++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(I)V", line = 46)
    public class193(int arg0) {
        this.field2828 = arg0;
    }

    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)V", line = 54)
