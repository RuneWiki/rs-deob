...
public class class193 extends class101 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILe;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Le;Z)Lum;", line = 36)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)I", line = 75)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(Le;B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)V", line = 124)
