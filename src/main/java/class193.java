...
public class class193 extends class381 {
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BZ)I", line = 17)
    ...
    @OriginalMember(owner = "client!fc", name = "d", descriptor = "(I)V", line = 55)
    public static void method1384(int arg0) {
        int var1 = 100 / ((arg0 + 15) / 32);
        field2775 = null;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIIBI)V", line = 232)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/lang/String;IZB)Z", line = 315)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(I)V", line = 398)
