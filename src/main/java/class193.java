...
public class class193 extends class187 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IBLtq;)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)Llb;")
