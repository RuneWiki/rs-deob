...
public class class193 extends class149 {
    ...
    @OriginalMember(owner = "client!v", name = "kb", descriptor = "Lrc;")
    public static class160 field3685 = new class160(64);

    @OriginalMember(owner = "client!v", name = "ob", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!v", name = "sb", descriptor = "Ltf;")
    ...
    @OriginalMember(owner = "client!v", name = "wb", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Llf;I)Z")
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(II)Llh;")
