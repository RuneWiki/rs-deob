...
public class class193 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)Lfo;", line = 114)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 178)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIZLtq;Ltq;)V", line = 242)
