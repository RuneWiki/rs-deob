...
public class class193 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III)Lii;", line = 55)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)Leb;", line = 88)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 118)
