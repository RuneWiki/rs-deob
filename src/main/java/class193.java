...
public class class193 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(II)Ltn;")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IB)Lcu;")
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lbs;ILpfa;Lpfa;Lpfa;)V")
