...
public class class193 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILlm;Llm;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 63)
