...
public class class193 extends class305 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIIBIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IB)[[I", line = 36)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILya;)V", line = 168)
    public static final void method1332(int arg0, class11 arg1) {
        class407.field6024[arg0] = arg1;
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)[I", line = 172)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "()V", line = 273)
    public class193() {
        super(1, false);
    }

    @OriginalMember(owner = "client!je", name = "e", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(II)I", line = 291)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILfh;B)V", line = 301)
