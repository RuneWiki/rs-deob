...
public class class193 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIIIBLjava/lang/String;)V", line = 12)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 52)
