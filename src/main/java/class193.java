...
public class class193 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILqa;Lc;ZIII)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZIIILqa;Z)Lc;")
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lqa;Lpk;IIIIIIZI)V")
