...
public class class193 extends class416 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BLd;ILwu;DIZ)[I", line = 8)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZBILd;Lwu;I)[F", line = 144)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Ld;Lwu;Z)Z", line = 255)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIBII)V", line = 317)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IBZDLwu;Ld;IZ)[I", line = 383)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "()V", line = 533)
    public class193() {
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lee;)V", line = 548)
