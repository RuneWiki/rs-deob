...
public class class193 extends class665 implements class198 {
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ll;Ljava/awt/Canvas;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 74)
