...
public class class193 extends class364 {
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lsk;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(FBIZLnc;)V", line = 128)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILsk;)V", line = 148)
    ...
    @OriginalMember(owner = "client!vp", name = "e", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLpe;)I", line = 190)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IB)V", line = 278)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILqp;)V", line = 289)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)V", line = 304)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lsk;I)V", line = 334)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILdp;Ldp;)V", line = 351)
