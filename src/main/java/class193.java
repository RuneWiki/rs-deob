...
public class class193 extends class695 {
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lbi;II)V")
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lbi;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "([IILij;II[I)Lsd;")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IIIZ)Llk;")
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lbi;IIZ[[BI)V")
