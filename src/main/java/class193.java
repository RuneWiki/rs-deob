...
public abstract class class193 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lya;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lug;)V", line = 74)
