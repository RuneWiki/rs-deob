...
public class class193 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Ljava/lang/Object;Luk;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BLuk;)Ljava/lang/Object;", line = 81)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(II)V", line = 133)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Luk;ILjava/lang/Object;)V", line = 192)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)I", line = 203)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILen;)V", line = 214)
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!jda", name = "d", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Luk;I)V", line = 258)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!jda", name = "e", descriptor = "(I)V", line = 303)
