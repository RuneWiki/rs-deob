...
public class class193 extends class416 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IJILr;Z)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(JLr;I)V")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lr;Lti;Liu;J)V")
