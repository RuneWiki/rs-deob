...
public class class193 implements class481 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IFZIII)[F", line = 5)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Lha;", line = 30)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZIIIFZ)[I", line = 47)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IZFIII)[I", line = 58)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(II)Lhb;", line = 70)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lui;Lui;Lui;)V", line = 115)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IB)Z", line = 101)
