...
public class class193 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljk;B)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lbu;Z)Z")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljk;IIB)V")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lhh;II)V")
