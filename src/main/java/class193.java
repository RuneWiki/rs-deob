...
public class class193 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lek;BII)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILek;IB)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILek;II)Z")
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lhj;Ldl;)V")
