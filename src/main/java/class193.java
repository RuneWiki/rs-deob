...
public class class193 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)Lff;", line = 3)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(JLua;IIILn;IBI)V", line = 32)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 114)
