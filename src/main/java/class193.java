...
public class class193 extends class371 {
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 568)
    public class193() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBLps;)V", line = 26)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(BI)[I", line = 126)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(III[[IILjava/util/Random;I)V", line = 375)
