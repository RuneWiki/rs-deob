...
public class class193 extends class759 implements class126 {
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Leea;I[BIZ)V", line = 6)
    public class193(class131 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2578 = arg1;
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III[B)V", line = 62)
    ...
    @OriginalMember(owner = "client!vb", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)J", line = 110)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Leea;ILjaclib/memory/Buffer;IZ)V", line = 137)
    public class193(class131 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2578 = arg1;
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)I", line = 145)
