...
public class class193 extends class359 {
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILam;)V", line = 22)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(IIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IILbo;IIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BII)I", line = 196)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 221)
    public class193() {
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IZ)V", line = 226)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(I)V", line = 276)
