...
public class class193 extends class107 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(JI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lea;Lea;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(II)Luh;", line = 34)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!vda", name = "d", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!vda", name = "e", descriptor = "(I)Ljava/lang/String;", line = 99)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lso;B)Ljava/lang/String;", line = 128)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lso;BI)V", line = 157)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIII[B)V", line = 235)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "([ILso;Z)V", line = 268)
    ...
    @OriginalMember(owner = "client!vda", name = "e", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(III)I", line = 310)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(Lso;B)V", line = 344)
