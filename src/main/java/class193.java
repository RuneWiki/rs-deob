...
public class class193 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(III)Z", line = 69)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIIBI)V", line = 81)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BII)V", line = 199)
