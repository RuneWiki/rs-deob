...
public class class193 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lcu;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILcu;)V", line = 46)
