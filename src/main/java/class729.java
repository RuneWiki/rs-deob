...
public abstract class class729 extends class454 {
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "([[BLqv;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLuf;)V", line = 89)
    ...
    @OriginalMember(owner = "client!jl", name = "h", descriptor = "(I)V", line = 137)
