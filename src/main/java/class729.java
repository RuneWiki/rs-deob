...
public class class729 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)[Lmaa;", line = 8)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IB)V", line = 37)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(IB)V", line = 84)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)Z", line = 101)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(II)Lll;", line = 112)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lgp;ILuu;Luu;)V", line = 224)
