...
public class class729 extends class510 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIIIILpi;)V", line = 18)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lst;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lkv;II[B)V", line = 106)
