...
public class class729 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BILjava/lang/String;)Ldb;")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILtm;Ltm;)V")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILnv;)V")
