...
public class class729 extends class168 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ZIIIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IB)V", line = 255)
