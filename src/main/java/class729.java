...
public class class729 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IILdt;)V", line = 10)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZLdt;)V", line = 28)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BI)Z", line = 48)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(III)Z", line = 62)
