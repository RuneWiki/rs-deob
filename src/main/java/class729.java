...
public class class729 {
    ...
    @OriginalMember(owner = "client!cm", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field10178++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lsba;BI)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)I", line = 64)
