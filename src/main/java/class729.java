...
public class class729 extends class226 {
    ...
    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(BIB)V", line = 50)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(ILbk;BIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IBII)[B", line = 111)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(BLft;)Lft;", line = 127)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "()V", line = 142)
    public class729() {
