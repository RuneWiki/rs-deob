...
public class class729 {
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILjava/io/File;Ljava/lang/String;)V", line = 107)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZI)V", line = 151)
