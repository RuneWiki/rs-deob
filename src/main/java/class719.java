...
public class class719 {
    ...
    public static int field10037 = 0;

    @OriginalMember(owner = "client!hba", name = "t", descriptor = "I")
    public static int field10047 = 0;

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "B")
    public byte field10028;

    @OriginalMember(owner = "client!hba", name = "d", descriptor = "B")
    public byte field10031;

    @OriginalMember(owner = "client!hba", name = "g", descriptor = "B")
    public byte field10034;

    @OriginalMember(owner = "client!hba", name = "i", descriptor = "B")
    public byte field10036;

    @OriginalMember(owner = "client!hba", name = "k", descriptor = "B")
    public byte field10038;

    @OriginalMember(owner = "client!hba", name = "p", descriptor = "B")
    public byte field10043;

    @OriginalMember(owner = "client!hba", name = "s", descriptor = "B")
    public byte field10046;
    ...
    @OriginalMember(owner = "client!hba", name = "n", descriptor = "Lea;")
    public static class21 field10041;

    @OriginalMember(owner = "client!hba", name = "h", descriptor = "S")
    public short field10035;

    @OriginalMember(owner = "client!hba", name = "b", descriptor = "Z")
    public boolean field10029;
    ...
    public boolean field10033;

    @OriginalMember(owner = "client!hba", name = "q", descriptor = "Z")
    public boolean field10044;

    @OriginalMember(owner = "client!hba", name = "r", descriptor = "Z")
    public boolean field10045;

    @OriginalMember(owner = "client!hba", name = "u", descriptor = "Z")
    public boolean field10048;

    @OriginalMember(owner = "client!hba", name = "v", descriptor = "Z")
    public boolean field10049;

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(B)V")
    public static void method4004(byte arg0) {
        field10041 = null;
        int var1 = 46 % ((arg0 + 24) / 37);
    }
}
