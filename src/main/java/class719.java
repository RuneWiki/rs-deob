...
public class class719 implements class150 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IZ)Lnba;")
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(IZ)Log;")
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Loh;Loh;Loh;)V")
