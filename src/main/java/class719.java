...
public class class719 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B[II[[[BI[II[III[IIZZ[IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IB)I", line = 455)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Z)V", line = 476)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lfg;I)V", line = 492)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILsw;)I", line = 536)
