...
public abstract class class719 extends class176 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I[Lcba;)I", line = 4)
    ...
    @OriginalMember(owner = "client!jn", name = "d", descriptor = "(Z)Z", line = 81)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)Z", line = 92)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Loi;B)V", line = 103)
    ...
    @OriginalMember(owner = "client!jn", name = "g", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lha;B)Z", line = 149)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(II)I", line = 160)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIBLca;)V", line = 197)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(IIIIII)V", line = 210)
