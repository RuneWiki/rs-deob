...
public class class719 extends class305 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(ILhb;)V", line = 20)
    public class719(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lhb;)V", line = 41)
    public class719(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)I", line = 55)
    public final int method4081(int arg0) {
        ++field10097;
        return arg0 != 17503 ? 7 : super.field4320;
    }

    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(II)I", line = 66)
