...
public class class719 extends class150 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lbt;Lbt;Lro;)V", line = 22)
    public class719(class48 arg0, class48 arg1, class2 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IZ[B)[B", line = 25)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(B)I", line = 40)
