...
public class class719 extends class502 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(ILeka;)V", line = 30)
    public class719(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)I", line = 35)
    public final int method55(int arg0) {
        ++field9887;
        return arg0 != -2 ? -90 : 0;
    }

    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Leka;)V", line = 47)
    public class719(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)I", line = 53)
    public final int method57(int arg0, int arg1) {
        ++field9885;
        return arg1 != 0 ? 108 : 1;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IZLsm;)V", line = 65)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(B)I", line = 113)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLlu;Ljava/lang/Object;)V", line = 126)
