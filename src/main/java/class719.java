...
public class class719 extends class182 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BZJILha;)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(JZLha;)V")
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lha;Lui;Ltn;J)V")
