...
public class class719 implements class159 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)Z", line = 4)
    public final boolean method49(int arg0) {
        field9978++;
        return arg0 == -32252 ? this.field9979.method3296(-126) : true;
    }

    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IC)C", line = 75)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Liu;Lpj;)V", line = 470)
    public class719(class578 arg0, class145 arg1) {
        this.field9979 = arg0;
        this.field9976 = arg1;
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ICLjava/lang/String;)[Ljava/lang/String;", line = 480)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILjava/lang/String;Lda;II)I", line = 515)
