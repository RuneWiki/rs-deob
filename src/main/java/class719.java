...
public class class719 extends class416 implements class605 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!dw", name = "d", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Lrda;III)V", line = 101)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Lrda;IIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!dw", name = "finalize", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(III)V", line = 143)
