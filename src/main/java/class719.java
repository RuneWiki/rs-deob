...
public abstract class class719 extends class513 {
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
