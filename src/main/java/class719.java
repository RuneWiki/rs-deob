...
public class class719 extends class644 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZLnd;IIZIDLd;)[I")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BZLd;IILnd;)[F")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILd;Lnd;)Z")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IDLd;ZBILnd;)[I")
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lsl;)V")
