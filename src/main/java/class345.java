...
public abstract class class345 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lbi;)V", line = 42)
