...
public class class345 extends class223 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 11)
    ...
    @OriginalMember(owner = "client!mi", name = "d", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "()V", line = 82)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 106)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "()V", line = 130)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "()I", line = 148)
