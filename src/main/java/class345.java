...
public class class345 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I)Lvia;", line = 5)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(II)Lnt;", line = 27)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(B)Z", line = 93)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BLvia;)V", line = 104)
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(B)Lvia;", line = 124)
    ...
    @OriginalMember(owner = "client!saa", name = "d", descriptor = "(B)I", line = 149)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(I)Lvia;", line = 182)
    ...
    @OriginalMember(owner = "client!saa", name = "e", descriptor = "(B)Lvia;", line = 202)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Z)V", line = 221)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "()V", line = 261)
    public class345() {
