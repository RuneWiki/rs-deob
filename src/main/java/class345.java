...
public class class345 extends class421 implements class210 {
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lvc;Lnm;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IZIIIIIII[Lae;)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BILvc;)Ln;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lvc;B)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZILvc;IILuq;I)V")
