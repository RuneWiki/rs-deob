...
public class class345 extends class383 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lya;Lgg;IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILpc;IIII)Ljava/awt/Frame;", line = 95)
