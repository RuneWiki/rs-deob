...
public class class345 extends class530 {
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)I", line = 4)
    public final int method1979(int arg0) {
        ++field4395;
        return arg0 != 0 ? 63 : super.field7419;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIIZIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)V", line = 659)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(ILah;)V", line = 684)
    public class345(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(II)I", line = 689)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lah;)V", line = 700)
    public class345(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(II)V", line = 703)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Z)V", line = 714)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IBIII)V", line = 729)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BII)I", line = 789)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)I", line = 820)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(I)V", line = 831)
