...
public class class345 extends class138 {
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 6)
    public final Object method1051(byte arg0) {
        int var2 = -74 / ((-arg0 - 17) / 45);
        return this.field4981.get();
    }

    @OriginalMember(owner = "client!uo", name = "d", descriptor = "(B)Z", line = 15)
    public final boolean method1050(byte arg0) {
        return arg0 == -40 ? true : true;
    }

    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Laa;Ljava/lang/Object;)V", line = 24)
