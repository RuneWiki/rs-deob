...
public class class345 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "(I)V", line = 16)
    public class345(int arg0) {
        this.field5077 = arg0;
    }

    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IIB)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ofa", name = "toString", descriptor = "()Ljava/lang/String;", line = 90)
