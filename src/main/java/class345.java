...
public class class345 extends class284 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Z)J", line = 5)
    ...
    @OriginalMember(owner = "client!gf", name = "d", descriptor = "(I)J", line = 23)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)J", line = 54)
    public final long method702(int arg0) {
        return arg0 == 3 ? this.field5068 : -58L;
    }

    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "()V", line = 115)
    public class345() {
        this.field5068 = System.nanoTime();
        this.field5069 = System.nanoTime();
    }

    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IJ)I", line = 80)
