...
public class class345 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILre;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BILre;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILre;Z)V")
