...
public class class345 extends class528 implements class276 {
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(IILea;II)V", line = 23)
    public final void method138(int arg0, int arg1, class381 arg2, int arg3, int arg4) {
        this.method2243(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lh;Lba;[I[BIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!xa", name = "finalize", descriptor = "()V", line = 30)
    protected final void finalize() {
        class284.method1787(-24204, this);
    }

    @OriginalMember(owner = "client!xa", name = "W", descriptor = "(IIIIII)V", line = 33)
