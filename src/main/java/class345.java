...
public class class345 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIII)Lgh;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)Lvj;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZILou;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lgh;I)V")
