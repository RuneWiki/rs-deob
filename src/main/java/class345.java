...
public class class345 extends OutputStream {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZLat;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!u", name = "write", descriptor = "(I)V", line = 23)
    public final void write(int arg0) throws IOException {
        field4973++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILat;)Lat;", line = 31)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I[BIIIZII[B)V", line = 83)
