...
public class class345 extends class107 {
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 33)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 70)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "()I", line = 106)
    public final int method870() {
        return this.field5098 - (this.field5099.available() >> (class53.field849 ? 2 : 1));
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "()V", line = 116)
