...
public class class345 extends class599 implements class670 {
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Loa;Lbfa;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILoa;)Lgr;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZBILoa;)Lau;")
    ...
    @OriginalMember(owner = "client!dda", name = "h", descriptor = "(I)[Lgs;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Loa;II)Lba;")
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(Loa;I)Lok;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IILoa;)Lba;")
