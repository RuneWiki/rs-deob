...
public abstract class class345 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BI[I[II[Ljd;Ljava/lang/String;[I)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIII[IILkf;ILjava/lang/String;III[Ljd;II)I")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II[Ljd;Ljava/util/Random;III[ILjava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([I[Ljd;ILjava/lang/String;IIII)V")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lwm;Lvi;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILjava/lang/String;ILjava/util/Random;I[IIIII[Ljd;II[IZ)I")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IILjava/lang/String;Lkf;I[Ljd;Z[II)V")
