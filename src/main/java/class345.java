...
public class class345 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(B)I", line = 51)
