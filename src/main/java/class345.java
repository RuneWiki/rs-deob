...
public class class345 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IJ)V", line = 4)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIIIIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZ)V", line = 79)
