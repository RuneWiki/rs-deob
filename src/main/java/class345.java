...
public class class345 extends class5 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IB[II)V", line = 35)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIB)Z", line = 48)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIII)Z", line = 69)
    ...
    @OriginalMember(owner = "client!mw", name = "f", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "([IIII)V", line = 255)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(IIIIIIIII)V", line = 271)
