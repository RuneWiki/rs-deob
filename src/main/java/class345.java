...
public class class345 extends class192 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I[BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([BIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)Z", line = 30)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIBI)V", line = 41)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!up", name = "finalize", descriptor = "()V", line = 96)
    protected final void finalize() {
        field5024++;
        this.method1247((byte) 124);
    }

    @OriginalMember(owner = "client!up", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 124)
