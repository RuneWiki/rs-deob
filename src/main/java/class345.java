...
public class class345 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(FFFFFIILwfa;III)[B")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILun;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lun;Z)V")
