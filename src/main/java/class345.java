...
public class class345 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILhi;Lvm;Lul;ILbw;ZIIZLhi;ILmi;Lqa;I[Lcg;ILii;Lmm;)Lc;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IZIILii;Lqa;ILhi;ILbw;II)Lc;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILvm;Lbw;ILmm;ILqa;Lmi;ILhi;ILii;)Lc;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILii;II)V")
