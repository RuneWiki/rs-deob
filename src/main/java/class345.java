...
public class class345 implements class288 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZIIFI)[I", line = 5)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILir;)V", line = 21)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIZFII)[F", line = 50)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)Lra;", line = 65)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZ)Ljs;", line = 77)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIZIF)[I", line = 101)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lir;Lir;Lir;)V", line = 131)
