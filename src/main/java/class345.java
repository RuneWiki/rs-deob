...
public class class345 extends class408 {
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "e", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Ltt;)V", line = 80)
    public class345(class93 arg0) {
        this.field4995 = arg0;
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BZI)V", line = 88)
