...
public class class345 extends class687 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lsba;IIILka;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Llga;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!mm", name = "g", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Liia;Lit;)V", line = 93)
