...
public class class345 extends class463 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IILjh;I[I)Z")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZZLia;B)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZLjh;)Z")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ljh;I)I")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()Lmi;")
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "()Lmi;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ljh;B)I")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BZLjh;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lia;ZB)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILfea;Lpfa;Lia;Z)Z")
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(Ljh;I)I")
