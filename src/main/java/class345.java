...
public class class345 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lsd;BIZLsd;)Ldj;", line = 142)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BILsd;Lsd;)Ldj;", line = 189)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lrs;Lwb;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 200)
