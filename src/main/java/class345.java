...
public abstract class class345 {
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZII)V", line = 36)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZLjava/lang/Throwable;)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!ni", name = "g", descriptor = "(I)Z", line = 181)
