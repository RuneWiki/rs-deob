...
public class class345 extends class539 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lvu;B)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 63)
