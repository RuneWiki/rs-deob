...
public class class345 extends class468 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILvf;ZZ)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lej;IIZ)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lej;II[III)V")
