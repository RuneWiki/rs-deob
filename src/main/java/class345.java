...
public class class345 {
    ...
    @OriginalMember(owner = "client!fe", name = "toString", descriptor = "()Ljava/lang/String;", line = 13)
    public final String toString() {
        field4892++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IILida;[I)Lqs;", line = 21)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(III)I", line = 197)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I)V", line = 220)
