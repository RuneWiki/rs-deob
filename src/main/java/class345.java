...
public class class345 extends class258 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lid;Lka;IIIB)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lck;IB[IIZII)Lrc;")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(BLmc;)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lim;B)V")
