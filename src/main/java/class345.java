...
public class class345 extends class440 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIILpu;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!oj", name = "g", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "()V", line = 50)
    public class345() {
        super(0, true);
    }
}
