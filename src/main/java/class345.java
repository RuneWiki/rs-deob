...
public class class345 extends class552 implements class660 {
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lgaa;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lmv;I)V")
