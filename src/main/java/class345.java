...
public class class345 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(JLm;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IJ)Lm;", line = 62)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BLec;)V", line = 85)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)V", line = 135)
