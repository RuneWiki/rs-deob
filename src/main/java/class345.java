...
public class class345 extends class627 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(BII[[ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IIIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IS)V", line = 274)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Lbm;Lup;Lpk;[I)V", line = 290)
