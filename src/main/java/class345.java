...
public class class345 extends class365 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)Lfp;", line = 30)
    ...
    @OriginalMember(owner = "client!uo", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 50)
    public final void focusGained(FocusEvent arg0) {
        field4869++;
    }

    @OriginalMember(owner = "client!uo", name = "f", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!uo", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 118)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field4886++;
        this.method2202(arg0, 0, (byte) -126);
    }

    @OriginalMember(owner = "client!uo", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 128)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method2202(arg0, 1, (byte) -126);
        field4868++;
    }

    @OriginalMember(owner = "client!uo", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 136)
    public final synchronized void focusLost(FocusEvent arg0) {
        field4885++;
        this.method2203(0, -1, 30, '\u0000');
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIC)V", line = 144)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!uo", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 183)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 200)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZZIII)I", line = 227)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(B)V", line = 269)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZI)Z", line = 280)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 440)
    public class345(Component arg0) {
        class267.method1779(false);
        this.method2205(92, arg0);
    }

    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)V", line = 304)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Ldn;B)I", line = 358)
    ...
    @OriginalMember(owner = "client!uo", name = "d", descriptor = "(B)V", line = 409)
