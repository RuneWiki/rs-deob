...
public class class345 extends OutputStream {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B[BI)[B", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IZZ)Ljda;", line = 21)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)Z", line = 61)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ldb;Z)I", line = 73)
    ...
    @OriginalMember(owner = "client!tk", name = "write", descriptor = "(I)V", line = 145)
    public final void write(int arg0) throws IOException {
        field4827++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 153)
