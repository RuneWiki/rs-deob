...
public class class345 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(J[I[S[S)V", line = 27)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "()V", line = 37)
    protected class345() {
    }
