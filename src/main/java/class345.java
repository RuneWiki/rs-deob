...
public class class345 extends class39 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)Lib;", line = 55)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I[B)Lf;", line = 67)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(ILdba;Lpa;III)V", line = 123)
    public class345(int arg0, class240 arg1, class648 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field4640 = arg5;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZB)V", line = 132)
