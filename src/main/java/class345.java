...
public class class345 extends class713 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I[B)I", line = 4)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(ILla;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "([J[Ljava/lang/Object;Z)V", line = 149)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(B)V", line = 161)
