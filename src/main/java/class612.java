...
public class class612 extends class649 {
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lhs;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lom;[BII)Lhe;")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(ILhs;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIIILha;III)V")
