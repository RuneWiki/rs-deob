...
public abstract class class612 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Z)Z", line = 22)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILkba;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)Z", line = 103)
