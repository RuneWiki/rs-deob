...
public class class612 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II)Z", line = 39)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)Lib;", line = 51)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BII)V", line = 73)
