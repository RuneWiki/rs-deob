...
public class class612 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(I)I", line = 132)
    ...
    @OriginalMember(owner = "client!lea", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "()V", line = 160)
    public class612() {
    }

    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Lee;)V", line = 162)
