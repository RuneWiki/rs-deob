...
public class class612 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ZIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(I)V", line = 73)
    private class612(int arg0) {
        this.field8609 = arg0;
    }

    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!oea", name = "toString", descriptor = "()Ljava/lang/String;", line = 101)
    public final String toString() {
        field8612++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ZZLjava/awt/Component;)Lrja;", line = 110)
