...
public class class612 extends class418 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(DI)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "g", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(I)[B", line = 49)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)I", line = 68)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lac;IZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lpfa;B)V", line = 252)
