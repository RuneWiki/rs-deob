...
public class class612 extends class453 {
    ...
    @OriginalMember(owner = "client!kea", name = "f", descriptor = "(B)I", line = 6)
    public final int method1872(byte arg0) {
        int var2 = 92 % ((arg0 + 71) / 41);
        return this.field8697;
    }

    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)I", line = 15)
    public final int method1873(int arg0) {
        int var2 = 118 / ((arg0 + 60) / 33);
        return this.field8698;
    }

    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(B)I", line = 24)
    public final int method1869(byte arg0) {
        int var2 = 127 % ((67 - arg0) / 54);
        return this.field8695;
    }

    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(B)J", line = 35)
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(B)I", line = 46)
