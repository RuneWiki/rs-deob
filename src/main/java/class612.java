...
public class class612 implements class185 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILjava/awt/Component;ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I[I)V", line = 51)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(II)I", line = 84)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "()V", line = 193)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(III)V", line = 130)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZI)V", line = 162)
