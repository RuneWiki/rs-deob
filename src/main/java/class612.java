...
public class class612 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILfd;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)Z", line = 156)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BILjava/lang/String;)V", line = 197)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lfd;I)V", line = 239)
