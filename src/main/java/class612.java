...
public class class612 implements class198 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIIIIZZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILha;I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/io/File;II)[B", line = 485)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(IIIIIIZZ)V", line = 503)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Liw;Lpga;Lqb;)V", line = 515)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 561)
