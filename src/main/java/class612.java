...
public class class612 extends class311 {
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(III)I", line = 19)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BII)Z", line = 46)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILmo;)Lcl;", line = 72)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lpu;Lpu;Lhc;)V", line = 86)
