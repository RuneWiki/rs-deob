...
public class class612 extends class47 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IJ)I", line = 4)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)J", line = 37)
    public final long method250(int arg0) {
        return arg0 >= -33 ? 3L : this.field8488;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)J", line = 61)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)J", line = 96)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "()V", line = 116)
    public class612() {
