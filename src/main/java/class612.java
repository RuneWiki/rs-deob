...
public class class612 extends class747 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILdw;IIII)Lgv;", line = 5)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)[I", line = 29)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IBIZII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZZB)V", line = 147)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "()V", line = 170)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BII)V", line = 341)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)V", line = 356)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Ldc;II)V", line = 373)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "()V", line = 446)
    public class612() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIZ)V", line = 449)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "([[II)V", line = 474)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(II)[[I", line = 524)
