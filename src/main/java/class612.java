...
public abstract class class612 extends class702 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(FFFFFF)Z", line = 16)
    ...
    @OriginalMember(owner = "client!sv", name = "Q", descriptor = "(IIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!sv", name = "E", descriptor = "()I", line = 168)
    public final int method1658() {
        return this.field8483;
    }

    @OriginalMember(owner = "client!sv", name = "qa", descriptor = "(FFFFFFIIII)V", line = 177)
    ...
    @OriginalMember(owner = "client!sv", name = "ca", descriptor = "()I", line = 274)
    public final int method1661() {
        return this.field8505 + this.field8493 + this.field8506;
    }

    @OriginalMember(owner = "client!sv", name = "DA", descriptor = "(IIIIIII)V", line = 293)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lkt;II)V", line = 338)
    ...
    @OriginalMember(owner = "client!sv", name = "A", descriptor = "()I", line = 347)
    public final int method1660() {
        return this.field8492 + this.field8483 + this.field8496;
    }

    @OriginalMember(owner = "client!sv", name = "u", descriptor = "()I", line = 350)
    public final int method1653() {
        return this.field8505;
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(FFFFFFILua;II)V", line = 354)
