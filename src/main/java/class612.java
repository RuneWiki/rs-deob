...
public class class612 extends class694 {
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILjr;B)V", line = 87)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "()V", line = 146)
    public class612() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gba", name = "d", descriptor = "(III)Z", line = 124)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(B)V", line = 135)
