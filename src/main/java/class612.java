...
public class class612 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Z)V", line = 8)
