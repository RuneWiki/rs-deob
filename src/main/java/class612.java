...
public class class612 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILuq;IJZIIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Llf;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILlf;Ltv;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILlf;)V", line = 221)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Llf;I)V", line = 249)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 264)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(Llf;I)V", line = 293)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BLlf;I)V", line = 316)
