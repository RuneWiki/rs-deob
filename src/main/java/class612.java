...
public class class612 extends class312 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I[Lpj;Lnv;)Lct;")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lde;I)Z")
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lwg;IIZ)V")
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lwg;II[III)V")
