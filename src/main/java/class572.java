...
public class class572 extends class29 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(JI)V", line = 13)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 409)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lr;J)V", line = 420)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lwh;IIIIIIIIIIIZZ)V", line = 595)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lwh;IIIIIIIIIIIZZ)V", line = 616)
