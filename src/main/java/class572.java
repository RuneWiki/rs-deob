...
public class class572 implements class422 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(B)Z", line = 28)
    public final boolean method3252(byte arg0) {
        field8057++;
        return arg0 <= 44 ? false : this.field8053;
    }

    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(B)Lvj;", line = 39)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 66)
