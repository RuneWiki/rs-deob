...
public class class572 extends Canvas {
    ...
    @OriginalMember(owner = "client!kga", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 4)
    public final void paint(Graphics arg0) {
        this.field7845.paint(arg0);
        field7843++;
    }

    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 13)
    public class572(Component arg0) {
        this.field7845 = arg0;
    }

    @OriginalMember(owner = "client!kga", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 22)
