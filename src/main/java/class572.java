...
public class class572 extends OutputStream {
    ...
    @OriginalMember(owner = "client!tn", name = "write", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILes;)Lnn;")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lkp;I)V")
