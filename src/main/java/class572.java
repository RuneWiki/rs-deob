...
public class class572 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I)V", line = 16)
    public final void method3156(int arg0) {
        field7779++;
        this.field7777.method2179(false, arg0);
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ZI)Ldga;", line = 24)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II)V", line = 219)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lag;Lfa;)V", line = 234)
