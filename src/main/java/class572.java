...
public class class572 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/lang/String;ZLmv;B)Llp;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I)Loda;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)Lwj;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIIIIIIIIILwg;)Z")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lr;I)V")
