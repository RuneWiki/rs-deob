...
public class class572 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!h", name = "toString", descriptor = "()Ljava/lang/String;", line = 103)
    public final String toString() {
        field8430++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 129)
    public class572(String arg0, String arg1, String arg2, String arg3) {
        this.field8426 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I)V", line = 156)
