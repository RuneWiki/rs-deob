...
public class class572 extends class755 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Llq;Ljava/lang/String;Lcn;Lda;IIIIIILaa;I)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BLib;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILwca;)V")
