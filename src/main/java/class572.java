...
public class class572 implements class307 {
    ...
    @OriginalMember(owner = "client!fj", name = "toString", descriptor = "()Ljava/lang/String;", line = 11)
    public final String toString() {
        field8269++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lvt;I)I", line = 20)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)[Lraa;", line = 66)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILjava/awt/Canvas;Le;)Loa;", line = 83)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 263)
