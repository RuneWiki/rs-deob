...
public class class572 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B[B)V", line = 7)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 222)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "([BI[B)V", line = 335)
