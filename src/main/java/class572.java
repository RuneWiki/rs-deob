...
public class class572 extends class477 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLdga;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IILdga;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)Ljava/lang/String;", line = 103)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Loa;ZJ)V", line = 130)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)I", line = 164)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILdga;)Ljava/lang/String;", line = 186)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 215)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IB)Llp;", line = 233)
    ...
    @OriginalMember(owner = "client!ak", name = "g", descriptor = "(I)I", line = 253)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Ldga;B[I)V", line = 270)
    ...
    @OriginalMember(owner = "client!ak", name = "h", descriptor = "(I)V", line = 300)
