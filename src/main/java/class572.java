...
public class class572 extends class545 {
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Lch;Lur;)V", line = 4)
    public class572(class38 arg0, class617 arg1) {
        super(arg0);
        this.field8244 = arg1;
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "([I[IZ[ILgt;)V", line = 12)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(I)Z", line = 131)
    ...
    @OriginalMember(owner = "client!bfa", name = "e", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!bfa", name = "i", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZIII)I", line = 221)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(Z)V", line = 241)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IILec;)V", line = 258)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZZ)V", line = 272)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(BZ)V", line = 285)
