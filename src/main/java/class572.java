...
public class class572 extends class651 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!gt", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method3319(arg0.getY(), 30, arg0.getX());
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!gt", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 32)
    ...
    @OriginalMember(owner = "client!gt", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 62)
    ...
    @OriginalMember(owner = "client!gt", name = "f", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(B)Z", line = 105)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!gt", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 125)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method3319(arg0.getY(), 46, arg0.getX());
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)I", line = 132)
    ...
    @OriginalMember(owner = "client!gt", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 157)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method3319(arg0.getY(), 115, arg0.getX());
    }

    @OriginalMember(owner = "client!gt", name = "e", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZLjava/awt/Component;)V", line = 186)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(III)V", line = 200)
    ...
    @OriginalMember(owner = "client!gt", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 217)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)Z", line = 227)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Z", line = 239)
    ...
    @OriginalMember(owner = "client!gt", name = "e", descriptor = "(B)I", line = 250)
    public final int method2921(byte arg0) {
        int var2 = -121 % ((arg0 + 71) / 52);
        return this.field8095;
    }

    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 310)
    public class572(Component arg0, boolean arg1) {
        this.method3318(true, arg0);
        this.field8101 = arg1;
    }

    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)I", line = 264)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(B)Lck;", line = 274)
    public final class703 method2925(byte arg0) {
        return arg0 <= 24 ? (class703) null : (class703) this.field8094.method3466(0);
    }

    @OriginalMember(owner = "client!gt", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 285)
    ...
    @OriginalMember(owner = "client!gt", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 299)
