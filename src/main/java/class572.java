...
public class class572 extends class400 {
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lpga;Loq;[Ltba;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!kia", name = "fa", descriptor = "(CIIIZ)V", line = 308)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(CIIIZLaa;II)V", line = 331)
