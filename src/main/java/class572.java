...
public class class572 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "([Lmu;I)I", line = 47)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Z)I", line = 81)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IBII)V", line = 114)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)Lmu;", line = 140)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)Lmu;", line = 156)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BJ)Lmu;", line = 191)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(JILmu;)V", line = 221)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(I)Lmu;", line = 241)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIBI)V", line = 275)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(I)V", line = 289)
