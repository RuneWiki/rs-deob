...
public class class572 extends class615 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "()V", line = 6)
    public class572() {
        super(0, false);
    }
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/String;CB)[Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BILeh;)V", line = 113)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(III)Z", line = 130)
    ...
    @OriginalMember(owner = "client!ji", name = "f", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(III)V", line = 185)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(B)I", line = 205)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIII)V", line = 216)
