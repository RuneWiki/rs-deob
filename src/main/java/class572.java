...
public class class572 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILtn;)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Ltn;II)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZBLkba;)V")
