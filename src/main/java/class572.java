...
public class class572 extends class379 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)Leo;", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Luq;ZLd;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(ILog;Lgi;III)V", line = 47)
