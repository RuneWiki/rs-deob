...
public class class466 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!qp", name = "toString", descriptor = "()Ljava/lang/String;", line = 31)
    public final String toString() {
        field6833++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 85)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 154)
