...
public class class466 extends class361 implements class233 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILnd;[[B)V")
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lih;III)V")
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lih;IIII)V")
