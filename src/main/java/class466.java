...
public class class466 {
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(II)Ldg;")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Ljt;I)I")
    ...
    @OriginalMember(owner = "client!fja", name = "<init>", descriptor = "(Lrl;Ld;)V")
