...
public class class466 extends class297 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "([IIIIILqo;ZB)Leba;")
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(III)Lun;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lcea;II)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BLcea;)Ljava/lang/String;")
