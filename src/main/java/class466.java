...
public class class466 extends class430 implements class462 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 5)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(I)C", line = 155)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(B)I", line = 168)
    ...
    @OriginalMember(owner = "client!taa", name = "d", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)J", line = 193)
    ...
    @OriginalMember(owner = "client!taa", name = "c", descriptor = "(I)I", line = 208)
