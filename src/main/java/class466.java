...
public class class466 extends class390 implements class210 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BILvc;)Ln;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lvc;B)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZILvc;IILuq;I)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lvc;Lnm;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(ZLvc;)V")
