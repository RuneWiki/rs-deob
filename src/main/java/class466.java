...
public class class466 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lct;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILac;B)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIILcba;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lac;I)V")
