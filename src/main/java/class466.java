...
public class class466 {
    ...
    @OriginalMember(owner = "client!lv", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(BLjava/lang/String;ILjava/lang/String;)I", line = 19)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Lkv;JI)V", line = 141)
