...
public class class466 extends class571 implements class675 {
    ...
    @OriginalMember(owner = "client!sja", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(ZLha;)V", line = 15)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(Lha;B)Lsba;", line = 27)
    ...
    @OriginalMember(owner = "client!sja", name = "b", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(ILao;)V", line = 51)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(Lha;III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(Z)I", line = 84)
    ...
    @OriginalMember(owner = "client!sja", name = "d", descriptor = "(Z)Z", line = 95)
    ...
    @OriginalMember(owner = "client!sja", name = "b", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!sja", name = "c", descriptor = "(Z)I", line = 120)
    ...
    @OriginalMember(owner = "client!sja", name = "g", descriptor = "(I)Z", line = 131)
    ...
    @OriginalMember(owner = "client!sja", name = "b", descriptor = "(ZLha;)Lrs;", line = 142)
    ...
    @OriginalMember(owner = "client!sja", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!sja", name = "e", descriptor = "(Z)Z", line = 197)
    ...
    @OriginalMember(owner = "client!sja", name = "h", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(Lha;I)V", line = 219)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(IBILrfa;ZILha;)V", line = 243)
    ...
    @OriginalMember(owner = "client!sja", name = "d", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!sja", name = "c", descriptor = "(B)I", line = 267)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(ILha;)V", line = 281)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(I)Z", line = 306)
