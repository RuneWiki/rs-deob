...
public abstract class class466 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIIIII)Las;", line = 3)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IZC)C", line = 24)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Z)V", line = 113)
