...
public class class466 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lnk;I)Z")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([BI)Lss;")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIII)Ldv;")
