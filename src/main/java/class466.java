...
public class class466 extends class416 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 24)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 45)
