...
public class class466 extends class352 implements class105 {
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Z)J", line = 19)
    ...
    @OriginalMember(owner = "client!og", name = "c", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BI[BI)V", line = 92)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lnq;I[BIZ)V", line = 105)
    public class466(class325 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field6951 = arg1;
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Z)I", line = 113)
    public final int method674(boolean arg0) {
        ++field6943;
        return !arg0 ? 111 : this.field6951;
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)I", line = 130)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIIIZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!og", name = "e", descriptor = "(I)V", line = 265)
