...
public class class466 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBII)V", line = 35)
