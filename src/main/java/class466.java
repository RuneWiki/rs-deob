...
public class class466 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)V", line = 3)
    public static void method2710(byte arg0) {
        int var1 = -51 % ((arg0 - 19) / 35);
        field6716 = null;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 17)
    public final void method2711(int arg0) {
        this.field6722.method2397(arg0, (byte) -99);
        field6717++;
    }

    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)Ldea;", line = 44)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIII)I", line = 83)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lnd;Ln;)V", line = 112)
