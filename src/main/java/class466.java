...
public class class466 extends class339 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IILio;)V", line = 145)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Z)[Ljw;", line = 164)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lio;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IB)V", line = 196)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(Z)V", line = 215)
