...
public class class466 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "()V", line = 33)
    public static final void method2827() {
        class177.field2736 = class177.field2746;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZI)Lmb;", line = 39)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)I", line = 69)
    public static final int method2829(int arg0, int arg1) {
        return class289.field4115 == null ? 0 : class289.field4115[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 119)
