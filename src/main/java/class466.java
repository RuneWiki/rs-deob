...
public class class466 extends class399 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BIILuu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIIIILfd;)Lps;", line = 32)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)V", line = 54)
