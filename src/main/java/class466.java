...
public class class466 extends class530 {
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Lah;)V")
    public class466(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(ILah;)V")
