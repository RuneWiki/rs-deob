...
public abstract class class466 extends class668 {
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ZILha;Lov;IIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!fp", name = "g", descriptor = "(I)Z", line = 49)
    public final boolean method92(int arg0) {
        ++field6795;
        return arg0 != 2 ? false : false;
    }

    @OriginalMember(owner = "client!fp", name = "h", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "([Lvt;I)I", line = 82)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILha;)Z", line = 101)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(IIIIIII)V", line = 111)
