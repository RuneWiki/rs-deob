...
public class class466 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)Ljea;", line = 22)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IBII)V", line = 36)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IZFIIIII)[I", line = 49)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BLdba;)Z", line = 120)
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(B)V", line = 138)
