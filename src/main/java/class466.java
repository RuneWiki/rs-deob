...
public class class466 extends class400 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "()I", line = 52)
    public final int method2322() {
        return this.field6887 - (this.field6888.available() >> (class323.field4619 ? 2 : 1));
    }

    @OriginalMember(owner = "client!qp", name = "d", descriptor = "()V", line = 60)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 74)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 114)
