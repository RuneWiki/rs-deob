...
public class class466 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IB)Lso;", line = 19)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lbs;ILpfa;)V", line = 124)
