...
public class class466 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lcu;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(B)Lnd;", line = 116)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)Z", line = 230)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(Z)Lnd;", line = 343)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lcu;I)V", line = 438)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)Z", line = 459)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)Z", line = 487)
