...
public class class466 extends class417 {
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIBI)V", line = 19)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIFII)V", line = 65)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IB)V", line = 182)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II[I)V", line = 196)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLmba;IFIIFIFFI[BF)V", line = 361)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lih;IIIII)V", line = 389)
