...
public abstract class class466 extends class656 {
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILha;)V", line = 33)
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(B)V", line = 72)
