...
public class class466 extends class434 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lwn;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z[B)[B", line = 49)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(B)V", line = 68)
    public static void method2788(byte arg0) {
        field6553 = null;
        int var1 = 88 % ((arg0 - 37) / 60);
    }

    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(I)V", line = 77)
