...
public class class466 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "()[F", line = 145)
    public final float[] method2831() {
        return this.field6732[this.method2833()];
    }

    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "()V", line = 149)
    public class466() {
        class5.method22(24);
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(II)I", line = 292)
    ...
    @OriginalMember(owner = "client!vaa", name = "c", descriptor = "()I", line = 300)
