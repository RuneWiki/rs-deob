...
public class class466 implements class246 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "([IIJZ)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILge;)V", line = 36)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)I", line = 245)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIII)V", line = 392)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)V", line = 423)
