...
public class class466 extends class338 {
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lfc;Lfc;BLkp;)V", line = 16)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BI)I", line = 45)
