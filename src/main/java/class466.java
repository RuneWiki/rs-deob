...
public class class466 extends class14 {
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(III)Lpe;", line = 12)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IB)[I", line = 20)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)[[I", line = 60)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "()V", line = 128)
    public class466() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qp", name = "e", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZII)I", line = 148)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IBLmd;)V", line = 166)
