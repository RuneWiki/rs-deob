...
public class class466 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILqa;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lgk;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lfs;ZLqa;)I", line = 144)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZLgf;)V", line = 209)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Z)V", line = 242)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IFIFIIIF)[F", line = 257)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(I[Llj;IIII)V", line = 432)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIIIIIILqa;Z)V", line = 352)
