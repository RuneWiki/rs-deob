...
public class class466 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)Lbi;", line = 38)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmja;ILbt;)V", line = 84)
