...
public class class466 extends class234 implements class526 {
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)Leea;", line = 5)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 16)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BILjava/lang/String;)Lot;", line = 67)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)Z", line = 102)
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(B)I", line = 127)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Lmc;Leea;Z)V", line = 139)
    public class466(class381 arg0, class680 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field6351 = arg1;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLcr;)[Lmh;", line = 151)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)V", line = 193)
