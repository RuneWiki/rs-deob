...
public abstract class class456 extends class35 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBLre;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!pa", name = "e", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(II)[I", line = 105)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BII)V", line = 123)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(III)[I", line = 150)
    ...
    @OriginalMember(owner = "client!pa", name = "f", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILtq;ILlk;Lgu;I)Z", line = 188)
    ...
    @OriginalMember(owner = "client!pa", name = "g", descriptor = "(I)V", line = 405)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ZII)[[I", line = 431)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(IZ)V", line = 462)
