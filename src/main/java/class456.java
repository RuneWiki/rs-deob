...
public class class456 extends class505 {
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ck", name = "e", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(III)Z", line = 97)
