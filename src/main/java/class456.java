...
public class class456 extends class540 {
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IIIIIF)V")
    public class456(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(FB)V")
    ...
    @OriginalMember(owner = "client!uba", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IBII)V")
