...
public class class456 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)Lvw;")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lpca;ILbi;)V")
    public class456(class671 arg0, int arg1, class449 arg2) {
        this.field6195 = arg2;
        this.field6195.method2527(0, 31);
    }

    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)Lrba;")
