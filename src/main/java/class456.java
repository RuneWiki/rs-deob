...
public class class456 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)I", line = 84)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)[I", line = 120)
