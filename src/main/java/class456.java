...
public class class456 extends class463 implements class228 {
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lde;Lkl;III[B)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lem;I)V")
