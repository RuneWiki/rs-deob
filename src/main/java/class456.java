...
public abstract class class456 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II[ZIZIIILnt;Lnt;ILnt;Lnt;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lnt;BI)V", line = 112)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IILnt;IIIILnt;ZZ[I)V", line = 159)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILnt;IBZIILnt;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(I)Ljg;", line = 229)
    ...
    @OriginalMember(owner = "client!gn", name = "h", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[Lnk;I)V", line = 410)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBIIILtf;I)V", line = 482)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z[ILib;[ZLnd;IIIZBLnd;I)V", line = 559)
