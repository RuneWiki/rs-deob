...
public class class456 extends class751 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IB)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILrv;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "()V", line = 133)
    public class456() {
        super(1, false);
    }
}
