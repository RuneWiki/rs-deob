...
public class class456 implements class697 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lhb;Z)V")
    public class456(class343 arg0, boolean arg1) {
        this.field5999 = arg1;
        this.field5998 = arg0;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
