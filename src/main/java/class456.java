...
public class class456 extends class431 implements class338 {
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)I", line = 23)
    ...
    @OriginalMember(owner = "client!lc", name = "g", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILqa;I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!lc", name = "d", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lqa;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 139)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILqa;)Lc;", line = 161)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lqa;IZI)Len;", line = 182)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lqa;Lus;IIIIZIZ)V", line = 212)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLqa;I)Lc;", line = 246)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)V", line = 257)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILqa;)V", line = 277)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(ILqa;)Lfm;", line = 305)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lqa;Z)V", line = 336)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(B)V", line = 359)
