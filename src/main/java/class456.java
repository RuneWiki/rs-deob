...
public class class456 extends class96 {
    ...
    @OriginalMember(owner = "client!pc", name = "e", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IC)Z", line = 80)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(III)V", line = 93)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Luk;)V", line = 113)
