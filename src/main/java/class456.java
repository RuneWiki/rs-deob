...
public class class456 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lqa;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lqa;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lqa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lqa;IZLjava/awt/Component;)V")
