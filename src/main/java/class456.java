...
public class class456 extends class513 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(SI)V", line = 4)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIZBI)V", line = 31)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "([[ZIIZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 120)
    public static void method2710(int arg0) {
        field6435 = null;
        int var1 = -78 / ((arg0 + 18) / 39);
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)Z", line = 302)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lkga;Lsm;Lul;[I)V", line = 315)
