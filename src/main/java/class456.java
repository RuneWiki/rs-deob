...
public class class456 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ldj;[IJB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)Lks;")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(ILla;Lla;Lsd;)V")
