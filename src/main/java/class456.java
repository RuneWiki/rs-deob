...
public class class456 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)Lfu;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BLfu;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILfu;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(B)Lfu;")
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(I)Lfu;")
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(B)Lfu;")
