...
public class class456 extends class107 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILdh;)Ldp;", line = 4)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IJ)V", line = 34)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZLmv;)V", line = 133)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLjava/lang/String;)I", line = 154)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(FB)V", line = 164)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(IIIIIF)V", line = 177)
    public class456(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!lc", name = "j", descriptor = "(I)V", line = 184)
