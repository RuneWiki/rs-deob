...
public class class456 extends class86 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lsf;)V", line = 30)
    public class456(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(II)I", line = 34)
    public final int method72(int arg0, int arg1) {
        ++field5979;
        return arg1 != -2 ? -45 : 1;
    }

    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(ILsf;)V", line = 94)
