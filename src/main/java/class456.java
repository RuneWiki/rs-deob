...
public class class456 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)V", line = 22)
    public static void method2599(byte arg0) {
        int var1 = -54 / ((arg0 + 5) / 50);
        field6328 = null;
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(II)Lko;", line = 50)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IZIZIBI)V", line = 102)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIBILr;II)Lda;", line = 145)
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/lang/String;IB)Loj;", line = 208)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 239)
