...
public class class456 extends class333 implements class251 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ll;Ljava/awt/Canvas;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 61)
