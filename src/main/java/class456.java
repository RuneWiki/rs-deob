...
public class class456 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)Le;")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IBILvh;)Lgv;")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BI)Lit;")
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lit;I)V")
