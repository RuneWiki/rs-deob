...
public class class456 extends class83 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)V", line = 41)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZIIIIIII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(IIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(III)V", line = 102)
