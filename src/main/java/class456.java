...
public class class456 extends class134 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIBIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(ILih;IZ)V", line = 145)
