...
public class class456 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILka;ZI)Lka;")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lee;I)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lee;II)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BIIILka;IIB)Lka;")
