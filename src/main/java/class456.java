...
public class class456 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ZIZLs;)V", line = 51)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 115)
    public class456(String arg0, int arg1) {
        this.field6743 = arg1;
    }

    @OriginalMember(owner = "client!og", name = "toString", descriptor = "()Ljava/lang/String;", line = 125)
    public final String toString() {
        field6738++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IZI)V", line = 134)
