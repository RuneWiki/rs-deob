...
public class class456 extends class189 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 41)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZBLkd;)V", line = 79)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IB)Z", line = 235)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "()V", line = 249)
    public class456() {
    }

    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 251)
