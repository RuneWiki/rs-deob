...
public class class456 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lwm;)V", line = 33)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(Lwm;)V", line = 61)
