...
public class class456 extends class459 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ILwq;)V", line = 60)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IBI)I", line = 93)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IILwq;)V", line = 123)
