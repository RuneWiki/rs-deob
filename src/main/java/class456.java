...
public class class456 extends class330 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lgga;IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "()V", line = 75)
    public class456() {
        super(1, true);
    }

    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IZ)[I", line = 82)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(III)V", line = 201)
