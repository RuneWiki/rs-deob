...
public class class456 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BI)Lmw;")
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lpt;ILum;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)[Ljp;")
