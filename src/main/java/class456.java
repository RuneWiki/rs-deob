...
public class class456 extends class96 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ldn;B)I")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljt;IIIB)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IILbt;)V")
