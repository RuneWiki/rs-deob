...
public class class456 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILtd;Lwia;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lfb;BZII)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IZILha;III)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lwia;BLd;)V")
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lha;Lso;I)V")
