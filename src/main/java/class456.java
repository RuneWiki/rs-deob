...
public class class456 extends class205 {
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Llf;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!rba", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Llf;IIII)V")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Llf;IIIII)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lha;IZIIII)V")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Llf;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Llf;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lha;II)Z")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
