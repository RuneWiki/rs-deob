...
public class class397 extends class284 {
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "()Z", line = 3)
    public final boolean method694() {
        return true;
    }

    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 34)
    public final void method696(boolean arg0) {
        this.field3917.method2140(260, 8448);
    }

    @OriginalMember(owner = "client!ua", name = "c", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lnj;)V", line = 117)
    public final void method693(class133 arg0) {
    }

    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lhj;Lqf;)V", line = 119)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "()V", line = 127)
