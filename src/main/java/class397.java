...
public class class397 extends class450 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Z)I", line = 46)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(I)Z", line = 70)
    public final boolean method2333(int arg0) {
        ++field5529;
        return arg0 != 2 ? false : class327.method1975(super.field6170, -120);
    }

    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lup;)V", line = 84)
    public class397(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(II)I", line = 89)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Ljava/io/File;B)[B", line = 119)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(Z)I", line = 130)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BLjava/lang/String;)I", line = 155)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZI)V", line = 171)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(ILup;)V", line = 184)
    public class397(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZBI)Lww;", line = 194)
