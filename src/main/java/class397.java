...
public class class397 extends class149 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(BIII)[B", line = 20)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "()V", line = 38)
    public class397() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "([FZFFIFIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!qi", name = "g", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Z", line = 143)
