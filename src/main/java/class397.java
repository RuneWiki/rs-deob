...
public class class397 extends class214 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 9)
    ...
    @OriginalMember(owner = "client!cp", name = "e", descriptor = "()V", line = 12)
    public static void method2592() {
        field5949 = null;
    }

    @OriginalMember(owner = "client!cp", name = "b", descriptor = "()V", line = 15)
    public final void method379() {
        field5949.method92(this.field5950, 26853);
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "()I", line = 18)
    public final int method377() {
        return field5949.method95(this.field5950, (byte) 60);
    }

    @OriginalMember(owner = "client!cp", name = "d", descriptor = "()V", line = 21)
    public final void method381() {
        field5949.method91(this.field5950, super.field3062);
    }

    @OriginalMember(owner = "client!cp", name = "c", descriptor = "()V", line = 24)
    public final void method378() {
        field5949.method96(93, this.field5950);
    }

    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lud;I)V", line = 28)
