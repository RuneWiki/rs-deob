...
public class class397 extends class497 {
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)Z", line = 7)
    public final boolean method157(int arg0) {
        ++field5831;
        return arg0 == -6808;
    }

    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILil;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(ZZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Ldia;Lmha;)V", line = 87)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(III)V", line = 119)
