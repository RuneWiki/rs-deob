...
public abstract class class397 extends class86 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)S", line = 16)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILfs;ILqg;IILts;)V", line = 55)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(II)[I", line = 100)
    ...
    @OriginalMember(owner = "client!lk", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!lk", name = "d", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IBLae;)V", line = 179)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Z)V", line = 193)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(III)Z", line = 220)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(III)[I", line = 241)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(IZ)V", line = 261)
    public class397(int arg0, boolean arg1) {
        this.field5859 = arg1;
        this.field5861 = new class397[arg0];
    }

    @OriginalMember(owner = "client!lk", name = "d", descriptor = "(III)[[I", line = 271)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BI)[[I", line = 305)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lts;IB)I", line = 325)
    ...
    @OriginalMember(owner = "client!lk", name = "e", descriptor = "(III)V", line = 344)
