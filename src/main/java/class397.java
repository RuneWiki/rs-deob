...
public class class397 {
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)Lpc;")
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)Lpc;")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZLpc;)V")
