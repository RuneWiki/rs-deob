...
public class class397 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lha;ZLsba;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IILjga;Lni;IIZ)V", line = 38)
