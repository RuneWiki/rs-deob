...
public class class397 implements Runnable {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;I)Lgu;", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/String;Ljava/lang/Class;)Lgu;", line = 13)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/awt/Component;Ljava/awt/Point;II[II)Lgu;", line = 24)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZLjava/net/URL;)Lgu;", line = 37)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/Class;I)Lgu;", line = 47)
    public final class409 method2274(Class arg0, int arg1) {
        return arg1 == 0 ? this.method2283(0, 0, arg1 + 4, 20, arg0) : null;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/lang/String;)Lgu;", line = 60)
    public final class409 method2275(int arg0, String arg1) {
        return arg0 <= 87 ? null : this.method2283(0, 0, 4, 21, arg1);
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/awt/Component;III)Lgu;", line = 81)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BLjava/lang/Class;)Lgu;", line = 95)
    public final class409 method2278(byte arg0, Class arg1) {
        return arg0 == 28 ? this.method2283(0, 0, 4, 11, arg1) : null;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Ljava/io/File;", line = 110)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 698)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)Lgu;", line = 203)
    public final class409 method2280(byte arg0) {
        return arg0 == 71 ? this.method2283(0, 0, 4, 18, null) : null;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZILjava/lang/String;)Lgu;", line = 218)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/awt/Frame;B)Lgu;", line = 230)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIILjava/lang/Object;)Lgu;", line = 249)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IILjava/lang/Object;II)Lgu;", line = 280)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(B)Z", line = 317)
    public final boolean method2285(byte arg0) {
        return arg0 >= -14;
    }

    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(B)V", line = 332)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(BLjava/lang/Class;)V", line = 386)
    ...
    @OriginalMember(owner = "client!kj", name = "run", descriptor = "()V", line = 435)
    ...
    @OriginalMember(owner = "client!kj", name = "d", descriptor = "(B)Lpu;", line = 554)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/io/File;", line = 568)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 578)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Z)Lgu;", line = 590)
    public final class409 method2291(boolean arg0) {
        return arg0 ? null : this.method2283(0, 0, 4, 5, null);
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BLjava/lang/String;)Lgu;", line = 602)
    public final class409 method2292(byte arg0, String arg1) {
        return arg0 < 37 ? null : this.method2283(0, 0, 4, 12, arg1);
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/awt/Component;BZ)Lgu;", line = 616)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Lgu;", line = 631)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lgu;", line = 643)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lgu;", line = 658)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(II)Lgu;", line = 668)
    public final class409 method2297(int arg0, int arg1) {
        return arg1 == 0 ? this.method2283(arg0, 0, arg1 + 4, 3, null) : null;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IBIII)Lgu;", line = 683)
