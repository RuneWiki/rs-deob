...
public class class397 extends class28 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLvu;)V", line = 10)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIIIII)V", line = 67)
