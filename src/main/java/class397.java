...
public class class397 extends class305 {
    ...
    @OriginalMember(owner = "client!po", name = "J", descriptor = "Lum;")
    public static class83 field5860;

    @OriginalMember(owner = "client!po", name = "D", descriptor = "[Lo;")
    public static class363[] field5855;

    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "()V", line = 6)
    public class397() {
        super(1, false);
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIZ)V", line = 12)
    private final void method2505(int arg0, int arg1, boolean arg2) {
        ++field5856;
        if (arg2) {
            field5855 = null;
        }
        int var4 = class78.field1298[arg1];
        int var5 = class301.field4614[arg0];
        float var6 = (float) Math.atan2((double) (var4 + -2048), (double) (var5 + -2048));
        if ((double) var6 >= -3.141592653589793D && (double) var6 <= -2.356194490192345D) {
            class111.field1665 = arg0;
            class530.field7748 = arg1;
        } else if ((double) var6 <= -1.5707963267948966D && (double) var6 >= -2.356194490192345D) {
            class111.field1665 = arg1;
            class530.field7748 = arg0;
        } else if ((double) var6 <= -0.7853981633974483D && (double) var6 >= -1.5707963267948966D) {
            class111.field1665 = arg1;
            class530.field7748 = -arg0 + class91.field1471;
        } else if (var6 <= 0.0F && (double) var6 >= -0.7853981633974483D) {
            class111.field1665 = -arg0 + class537.field7884;
            class530.field7748 = arg1;
        } else if (var6 >= 0.0F && (double) var6 <= 0.7853981633974483D) {
            class530.field7748 = -arg1 + class91.field1471;
            class111.field1665 = -arg0 + class537.field7884;
        } else if ((double) var6 >= 0.7853981633974483D && (double) var6 <= 1.5707963267948966D) {
            class111.field1665 = -arg1 + class537.field7884;
            class530.field7748 = -arg0 + class91.field1471;
        } else if ((double) var6 >= 1.5707963267948966D && (double) var6 <= 2.356194490192345D) {
            class530.field7748 = arg0;
            class111.field1665 = -arg1 + class537.field7884;
        } else if ((double) var6 >= 2.356194490192345D && (double) var6 <= 3.141592653589793D) {
            class530.field7748 = class91.field1471 - arg1;
            class111.field1665 = arg0;
        }
        class530.field7748 &= class228.field3447;
        class111.field1665 &= class236.field3551;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IB)[[I", line = 88)
    public final int[][] method72(int arg0, byte arg1) {
        ...
        if (super.field4674.field5110) {
            ...
            for (int var7 = 0; ~class91.field1471 < ~var7; ++var7) {
                this.method2505(arg0, var7, false);
                int[][] var8 = this.method2015(true, 0, class111.field1665);
                var4[var7] = var8[0][class530.field7748];
                var5[var7] = var8[1][class530.field7748];
                var6[var7] = var8[2][class530.field7748];
            }
        }
        if (arg1 >= -59) {
            field5857 = -100;
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)[I", line = 131)
    public final int[] method15(int arg0, int arg1) {
        ++field5862;
        if (arg1 != 4688) {
            this.method2505(-57, -113, true);
        }
        int[] var3 = super.field4677.method2174(arg0, -81);
        if (super.field4677.field5040) {
            for (int var4 = 0; var4 < class91.field1471; ++var4) {
                this.method2505(arg0, var4, false);
                int[] var5 = this.method2021(0, class111.field1665, 0);
                var3[var4] = var5[class530.field7748];
            }
        }
        return var3;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILfh;B)V", line = 165)
    public final void method14(int arg0, class194 arg1, byte arg2) {
        if (~arg0 == -1) {
            super.field4675 = ~arg1.method1337((byte) 3) == -2;
        }
        ++field5858;
        if (arg2 < 76) {
            field5861 = true;
    ...
    @OriginalMember(owner = "client!po", name = "f", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIILes;)V", line = 202)
    public static final void method2507(int arg0, int arg1, int arg2, class481 arg3) {
        class281 var4 = class141.method1018(arg0, arg1, arg2);
        if (var4 != null) {
            var4.field4371 = arg3;
        }
    }
