...
public class class397 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIIIIIII)V", line = 29)
