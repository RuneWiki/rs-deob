...
public class class397 extends class52 {
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II[S)[S", line = 38)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BI)I", line = 50)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 67)
