...
public class class397 extends class363 {
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lod;Lqh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Ljk;IB)V", line = 68)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;", line = 84)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZB)V", line = 103)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)V", line = 128)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(III)V", line = 166)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BII)Z", line = 210)
