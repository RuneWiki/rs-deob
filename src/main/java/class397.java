...
public class class397 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILtt;)Loaa;", line = 4)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILjava/awt/Canvas;)Lkg;", line = 15)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lst;B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lmh;IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lfaa;B)Ljava/lang/String;", line = 183)
