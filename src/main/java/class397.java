...
public class class397 extends class339 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)Llr;", line = 40)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lbv;IIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)V", line = 147)
