...
public class class397 extends class125 {
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lgp;)V")
    public class397(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(ILgp;)V")
    public class397(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILsl;)Lfk;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILkca;)I")
