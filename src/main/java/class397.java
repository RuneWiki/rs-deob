...
public class class397 {
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Z)V", line = 649)
    public class397(boolean arg0) {
        this.field5702 = arg0;
    }

    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZLua;)V", line = 42)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IZIIIIII)V", line = 599)
