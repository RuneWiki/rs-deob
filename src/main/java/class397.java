...
public class class397 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tq", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field5626++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lae;BI)Lhw;", line = 38)
