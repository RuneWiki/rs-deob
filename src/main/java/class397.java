...
public class class397 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IBILsb;III)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLap;I)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lap;III)V")
