...
public class class397 extends class232 {
    ...
    @OriginalMember(owner = "client!oj", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oj", name = "f", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ZI)V", line = 86)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ZB)V", line = 96)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Log;Lcb;)V", line = 351)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILdr;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BLha;Loga;Lor;)V", line = 163)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(I)V", line = 314)
    ...
    @OriginalMember(owner = "client!oj", name = "e", descriptor = "(I)Z", line = 340)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(III)V", line = 389)
