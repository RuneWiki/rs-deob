...
public class class397 extends class299 {
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Les;)V")
