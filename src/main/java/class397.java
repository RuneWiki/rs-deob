...
public class class397 extends class406 {
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILjava/lang/String;)V", line = 85)
