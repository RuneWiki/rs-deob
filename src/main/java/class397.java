...
public class class397 extends class201 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lus;ILus;F)Z", line = 15)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)Lus;", line = 213)
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(I)I", line = 230)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lnq;I)V", line = 244)
