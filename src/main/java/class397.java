...
public class class397 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(IIIILjba;I)Lno;", line = 4)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(II)Laka;", line = 51)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lpl;", line = 123)
    ...
    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 143)
