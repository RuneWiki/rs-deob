...
public class class397 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZLja;IIZBI)Lrc;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILja;ZILrc;ZII)V")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lcj;Ldp;B)V")
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lja;Lfb;IIIIIIZI)V")
