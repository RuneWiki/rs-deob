...
public class class397 extends class601 {
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!sg", name = "c", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Z)Z", line = 75)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ZLlba;)V", line = 88)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(II)I", line = 131)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(ILgn;)V", line = 161)
    public class397(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lgn;)V", line = 197)
    public class397(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(III)Lcaa;", line = 207)
