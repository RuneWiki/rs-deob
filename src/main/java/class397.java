...
public class class397 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IB)Luba;")
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IILbv;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IILrm;I)V")
