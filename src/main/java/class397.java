...
public class class397 extends class555 {
    ...
    @OriginalMember(owner = "client!nba", name = "c", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Lot;BI)V", line = 74)
    ...
    @OriginalMember(owner = "client!nba", name = "e", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ZI)V", line = 111)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ZZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Lhb;Lga;Lln;)V", line = 187)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 204)
