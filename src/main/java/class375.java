...
public class class375 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIZ[[[Lne;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lvp;IIIII)V", line = 320)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIII)Ldg;", line = 385)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 397)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)Lsf;", line = 411)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BLjava/lang/String;)V", line = 441)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(IIIIB)V", line = 506)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Ldg;I)V", line = 517)
