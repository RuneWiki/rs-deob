...
public class class375 extends class665 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILd;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Z)[Lsn;", line = 72)
