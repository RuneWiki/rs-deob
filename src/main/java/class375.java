...
public class class375 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZI)Lfg;", line = 7)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 54)
