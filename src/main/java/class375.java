...
public class class375 extends class339 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lcv;Lcv;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lsl;)V", line = 33)
    public class375(class601 arg0) {
        this.field4968 = arg0;
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(II)V", line = 46)
