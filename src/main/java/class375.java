...
public class class375 extends class646 {
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "()V", line = 7)
    public class375() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lek;IB)V", line = 12)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(CBLjava/lang/String;)I", line = 54)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(IB)[I", line = 81)
