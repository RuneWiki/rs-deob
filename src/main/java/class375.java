...
public class class375 extends class214 {
    ...
    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 43)
    public class375() {
        super(1, true);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lkm;ILfc;)V", line = 51)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Llk;II)V", line = 186)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)V", line = 228)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZI)V", line = 250)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lvb;IILkm;Lms;IIII)V", line = 301)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BI)[I", line = 405)
