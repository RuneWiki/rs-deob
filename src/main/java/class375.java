...
public abstract class class375 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IZIII)Llp;", line = 4)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 49)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILlc;I)Lih;", line = 60)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIII)I", line = 139)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 180)
