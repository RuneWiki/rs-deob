...
public class class375 extends class320 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "()I", line = 26)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lbu;I)Lvi;", line = 33)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([I)Lbq;", line = 48)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([B)V", line = 110)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lbu;II)Lvi;", line = 153)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)F", line = 172)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([BI)V", line = 183)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "([B)V", line = 200)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)I", line = 352)
    ...
    @OriginalMember(owner = "client!vi", name = "e", descriptor = "(I)[F", line = 381)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lbu;)Z", line = 793)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "([B)V", line = 815)
