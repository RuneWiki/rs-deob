...
public class class375 extends class601 {
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lgh;I)[Lvj;")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lgn;)V")
