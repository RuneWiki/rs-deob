...
public class class375 extends class179 {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(Ldp;B)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lbn;IZIILpi;Lja;ILja;ZBI)Lof;")
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Llg;)V")
