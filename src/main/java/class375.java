...
public class class375 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILcea;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II[IB)Lfc;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I[II)Lfc;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II[II)Lfc;")
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I[II)Lfc;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lbi;Lbi;I[I)V")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lbi;Lbi;)V")
