...
public class class375 extends class210 {
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Leea;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lkha;ILkha;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Leea;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIZII)V")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Leea;II)V")
