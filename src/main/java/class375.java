...
public class class375 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(III[BB[B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I[BIII[B)I", line = 74)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILug;I)Ljava/lang/String;", line = 225)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILjava/lang/String;)J", line = 260)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "([B)V", line = 314)
