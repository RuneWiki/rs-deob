...
public abstract class class375 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z[ILrf;IIIIILrf;ZI)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILck;IBII)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIZ[ZZILsh;[IILms;Lsh;I)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([ZIILrf;IILrf;IIIILrf;ILrf;Z)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILrf;IIIILrf;Z)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZILwm;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IBLrf;)V")
