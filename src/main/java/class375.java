...
public class class375 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILwq;Lwq;IZ)Lpi;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lra;I)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lwq;Lwq;IB)Lpi;")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lah;Lsj;)V")
