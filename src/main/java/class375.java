...
public class class375 extends Canvas {
    ...
    @OriginalMember(owner = "client!ti", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
