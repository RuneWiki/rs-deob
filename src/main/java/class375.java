...
public class class375 extends class112 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lha;JB)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZILha;J)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lgda;ZZ)V")
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lha;Lmk;Lsia;J)V")
