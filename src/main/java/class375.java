...
public class class375 extends class136 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IILiv;)V", line = 22)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)[I", line = 39)
    ...
    @OriginalMember(owner = "client!vi", name = "g", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(Z)Z", line = 108)
