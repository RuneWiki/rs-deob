...
public class class375 extends class496 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "()[I", line = 7)
    public final int[] method2293() {
        return this.field5515;
    }

    @OriginalMember(owner = "client!la", name = "b", descriptor = "()V", line = 11)
    public static void method2294() {
        field5513 = null;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)V", line = 14)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(II[IZ)V", line = 59)
