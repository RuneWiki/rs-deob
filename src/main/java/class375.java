...
public class class375 {
    ...
    @OriginalMember(owner = "client!si", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field5603++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(II)V", line = 35)
    public class375(int arg0, int arg1) {
        this.field5608 = arg0;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(JI)V", line = 46)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Luj;", line = 60)
