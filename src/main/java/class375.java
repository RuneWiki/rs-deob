...
public class class375 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I[B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "([BI[B)V", line = 228)
