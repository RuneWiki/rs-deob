...
public class class375 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lsn;I)Z")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljg;B)V")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Ljg;)V")
