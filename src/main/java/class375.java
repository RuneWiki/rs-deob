...
public class class375 extends class207 {
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(ILrd;)V")
    ...
    @OriginalMember(owner = "client!du", name = "d", descriptor = "(I)[Laka;")
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Lrd;)V")
