...
public class class375 extends class529 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IILea;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!vi", name = "qa", descriptor = "()I", line = 65)
    public final int method103() {
        field5726++;
        return this.field5716.field4020;
    }

    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!vi", name = "UA", descriptor = "()I", line = 112)
    public final int method108() {
        field5701++;
        return this.field5716.field4021;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!vi", name = "M", descriptor = "(IIIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!vi", name = "aa", descriptor = "(FFFFFFIII)V", line = 261)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lod;IIII)V", line = 796)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lod;II[III)V", line = 806)
    ...
    @OriginalMember(owner = "client!vi", name = "ka", descriptor = "(IIII)V", line = 334)
    ...
    @OriginalMember(owner = "client!vi", name = "V", descriptor = "(III)V", line = 355)
    ...
    @OriginalMember(owner = "client!vi", name = "D", descriptor = "(IIIIIII)V", line = 381)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 519)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(FFFFFFLea;II)V", line = 545)
    ...
    @OriginalMember(owner = "client!vi", name = "ja", descriptor = "()I", line = 632)
    public final int method105() {
        field5724++;
        return this.field5716.field4021 + this.field5713 + this.field5708;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ljava/lang/String;ZII)I", line = 641)
    ...
    @OriginalMember(owner = "client!vi", name = "W", descriptor = "(IIIIII)V", line = 723)
    ...
    @OriginalMember(owner = "client!vi", name = "YA", descriptor = "(IIIII)V", line = 737)
    ...
    @OriginalMember(owner = "client!vi", name = "JA", descriptor = "()I", line = 818)
