...
public class class375 extends class339 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lkb;[I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Lep;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!dn", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIBLov;)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I[Lcw;)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIIILha;)V")
    ...
    @OriginalMember(owner = "client!dn", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!dn", name = "fa", descriptor = "(IILr;)Lr;")
