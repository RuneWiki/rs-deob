...
public class class375 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)Lbp;")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lbp;I)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)Lbp;")
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(B)Lbp;")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lbl;I[Luh;)Lsj;")
