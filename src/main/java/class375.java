...
public class class375 extends class264 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILrv;)Lje;", line = 15)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(ILmfa;)V", line = 34)
    public class375(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BI)I", line = 48)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(BI)V", line = 64)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)I", line = 76)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 87)
    public final void method660(int arg0) {
        int var2 = -47 / ((arg0 - 1) / 41);
        ++field5409;
    }

    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lmfa;)V", line = 97)
    public class375(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(I)V", line = 102)
