...
public class class375 extends class524 implements class232 {
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIBIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIILqa;)Z", line = 83)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)I", line = 102)
    ...
    @OriginalMember(owner = "client!vi", name = "i", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(Lqa;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILqa;)Lbw;", line = 150)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IILqa;)Lc;", line = 191)
    ...
    @OriginalMember(owner = "client!vi", name = "e", descriptor = "(I)Z", line = 203)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IILqa;IZLha;I)V", line = 214)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(Lqa;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lqa;Lbo;IIIIIZIII)V", line = 282)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)Z", line = 291)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)I", line = 305)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lqa;I)V", line = 316)
