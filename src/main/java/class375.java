...
public class class375 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "()V", line = 6)
    public static final void method2325() {
        class183.method1289(1, class433.field6202);
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(I)V", line = 28)
    public class375(int arg0) {
        this.field5430 = (byte) arg0;
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIILum;Lum;)V", line = 42)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILrq;Lha;BII)V", line = 97)
