...
public class class375 extends class260 {
    ...
    public static final void method2343(int arg0, int arg1) {
        field5218++;
        class26 var2 = class217.method1445(true, arg1, arg0);
        var2.method164(12);
    }

    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(B)I")
    public final int method1678(byte arg0) {
        field5210++;
        return arg0 == 93 ? this.field5203 : -113;
    }

    @OriginalMember(owner = "client!bg", name = "h", descriptor = "(I)V")
    public static final void method2344(int arg0) {
        for (class240 var1 = (class240) class337.field4558.method2480(arg0 - 3134); var1 != null; var1 = (class240) class337.field4558.method2482(50)) {
            var1.method1563();
        }
        if (arg0 == 11038) {
            field5212++;
    ...
    public static final void method2346(int arg0, int arg1, int arg2, int arg3) {
        int var4 = arg3 << 3;
        int var5 = arg0 << 3;
        if (arg1 != -7862) {
            field5213 = 107;
        ...
        int var6 = arg2 << 3;
        field5211++;
        class332.field4483 = (float) var4;
        if (class26.field337 == 2) {
            class103.field1426 = var6;
            class389.field5410 = var5;
            class86.field1208 = var4;
        }
        class356.field4785 = (float) var5;
    ...
    public final long method1673(int arg0) {
        field5219++;
        if (arg0 > -117) {
            this.field5215 = (char) 65526;
        }
        return this.field5214;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIIIII)V")
    public static final void method2347(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        field5205++;
        int var8 = 0;
        int var9 = arg0;
        int var10 = 0;
        ...
        if (arg3 >= class143.field2090 && arg3 <= class42.field543) {
            int[] var39 = class83.field1157[arg3];
            int var40 = class294.method1789(arg5 - arg4, (byte) -5, class430.field6003, class80.field1119);
            int var41 = class294.method1789(arg4 + arg5, (byte) -5, class430.field6003, class80.field1119);
            int var42 = class294.method1789(arg5 - var11, (byte) -5, class430.field6003, class80.field1119);
            int var43 = class294.method1789(arg5 + var11, (byte) -5, class430.field6003, class80.field1119);
            class149.method1112(arg1, var42, 8, var40, var39);
            class149.method1112(arg2, var43, 8, var42, var39);
            class149.method1112(arg1, var41, 8, var43, var39);
        }
        while (var9 > 0) {
            ...
            int var45 = arg3 - var9;
            int var46 = arg3 + var9;
            if (class143.field2090 <= var46 && class42.field543 >= var45) {
                int var47 = class294.method1789(arg5 + var8, (byte) -5, class430.field6003, class80.field1119);
                int var48 = class294.method1789(arg5 - var8, (byte) -5, class430.field6003, class80.field1119);
                if (var44) {
                    int var49 = class294.method1789(arg5 + var10, (byte) -5, class430.field6003, class80.field1119);
                    int var50 = class294.method1789(arg5 - var10, (byte) -5, class430.field6003, class80.field1119);
                    if (var45 >= class143.field2090) {
                        int[] var51 = class83.field1157[var45];
                        class149.method1112(arg1, var50, 8, var48, var51);
                        class149.method1112(arg2, var49, 8, var50, var51);
                        class149.method1112(arg1, var47, 8, var49, var51);
                    }
                    if (var46 <= class42.field543) {
                        int[] var52 = class83.field1157[var46];
                        class149.method1112(arg1, var50, 8, var48, var52);
                        class149.method1112(arg2, var49, 8, var50, var52);
                        class149.method1112(arg1, var47, 8, var49, var52);
                    }
                } else {
                    if (var45 >= class143.field2090) {
                        class149.method1112(arg1, var47, 8, var48, class83.field1157[var45]);
                    }
                    if (class42.field543 >= var46) {
                        class149.method1112(arg1, var47, 8, var48, class83.field1157[var46]);
                    }
                }
            }
        }
    ...
    public static final int method2348(int arg0, int arg1) {
        return class124.field1876 == null ? 0 : class124.field1876[arg0][arg1] & 0xFFFFFF;
    }
    ...
    public final char method1676(int arg0) {
        field5208++;
        return arg0 == -27038 ? this.field5215 : ']';
    }
}
