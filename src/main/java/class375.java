...
public class class375 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(JLvba;Z)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BLqf;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(JZ)Lvba;")
