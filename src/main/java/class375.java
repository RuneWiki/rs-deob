...
public class class375 extends class57 implements class111 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lpe;I)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lpe;II)Lsj;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BLpe;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lpe;B)Lca;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IILpe;I)Z")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lpe;Lkk;IIIIIIIZIIII)V")
