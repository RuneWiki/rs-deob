...
public class class375 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)Lha;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZJ)Lha;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)Lha;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B[Lha;)I")
    ...
    @OriginalMember(owner = "client!hl", name = "d", descriptor = "(B)Lha;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(JLha;B)V")
