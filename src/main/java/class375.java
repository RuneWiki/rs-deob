...
public class class375 extends class417 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIILmb;IIIIII)Z")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lhs;Z)V")
