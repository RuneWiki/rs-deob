...
public class class375 extends class386 {
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIIIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIIIIII[I)V", line = 62)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)[I", line = 172)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "()V", line = 194)
    public class375() {
        this(4096);
    }

    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(IIIIIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IBLun;)V", line = 399)
