...
public class class375 implements class105 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)Lwh;")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZLvf;)V")
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(ILjk;Ltda;IIIIIIIZ)V")
