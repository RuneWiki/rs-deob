...
public class class375 extends class405 implements class189 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIIIZ)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([BIIIII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IBI)V", line = 117)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZIII)I", line = 132)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(III)I", line = 143)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lvd;III)V", line = 270)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lvd;IIII)V", line = 285)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)Z", line = 204)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(Z)V", line = 220)
    ...
    @OriginalMember(owner = "client!nt", name = "finalize", descriptor = "()V", line = 240)
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(B)V", line = 255)
