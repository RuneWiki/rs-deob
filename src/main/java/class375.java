...
public class class375 extends class578 {
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)Lng;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BLmv;Loja;)Ldm;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Ldea;ILqu;BIZLha;)Lka;")
