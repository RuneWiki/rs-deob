...
public class class375 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I[Ljava/lang/String;)V", line = 7)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)J", line = 65)
