...
public class class375 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "()V", line = 100)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "()V", line = 287)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "()[I", line = 357)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ltq;I)Lgo;", line = 422)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)V", line = 430)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "()V", line = 533)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "()V", line = 601)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "([B)[Lgo;", line = 671)
    ...
    @OriginalMember(owner = "client!go", name = "f", descriptor = "()I", line = 880)
    public final int method2399() {
        return this.field5262 + this.field5260 + this.field5268;
    }

    @OriginalMember(owner = "client!go", name = "g", descriptor = "()I", line = 883)
    public final int method2400() {
        return this.field5263 + this.field5261 + this.field5264;
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ltq;II)[Lgo;", line = 887)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Ltq;II)Lgo;", line = 896)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Ltq;I)[Lgo;", line = 905)
