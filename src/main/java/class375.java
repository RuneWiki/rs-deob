...
public abstract class class375 implements class203 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lfu;IIIZ)V")
