...
public class class774 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III)Lww;", line = 7)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ldaa;JI)V", line = 22)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)Ldaa;", line = 42)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(JB)Ldaa;", line = 96)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(I)V", line = 128)
