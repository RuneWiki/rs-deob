...
public class class774 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZFFLkda;FIIIFIF)[B", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lika;III)V", line = 62)
