...
public class class774 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILnda;)Z")
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(I)Lcja;")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lgq;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)Lcja;")
