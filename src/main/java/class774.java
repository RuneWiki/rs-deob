...
public class class774 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)Lpca;", line = 4)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lha;IIIIZIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ZLpca;)V", line = 96)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 123)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIIIZBLha;IIIIIZI)V", line = 194)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(I[Lrga;IIIIII)V", line = 579)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lha;IIIII)V", line = 326)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIILha;IZIIZIIII)V", line = 358)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILha;BI)Z", line = 397)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ZLha;)V", line = 495)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILoba;)I", line = 542)
