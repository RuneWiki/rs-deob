...
public class class774 extends class413 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BID)Lnca;")
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "()Lpp;")
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(I)Lnca;")
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "()Lpp;")
    public final class413 method13() {
        field10653++;
        return null;
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ZLnca;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BI)Lrfa;")
