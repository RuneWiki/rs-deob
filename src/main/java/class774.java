...
public class class774 {
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)Lal;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)Lal;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BILwia;Ld;Ljava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ldha;)V")
