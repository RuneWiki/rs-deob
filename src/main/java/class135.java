...
public class class135 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IZ)Leca;", line = 77)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IB)Z", line = 117)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Lvd;ILpe;Lpe;)V", line = 163)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(B)V", line = 143)
