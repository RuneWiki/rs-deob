...
public class class135 extends class503 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BJLha;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lha;IIJZ)V")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lha;Lcba;Lsp;J)V")
