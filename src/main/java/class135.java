...
public class class135 extends class504 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIB)V", line = 14)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;II)V", line = 157)
