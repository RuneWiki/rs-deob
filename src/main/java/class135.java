...
public abstract class class135 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IB[BIIII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(II[B)V", line = 78)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZLjt;)I", line = 102)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Los;I[BIZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Los;ILjaclib/memory/Buffer;IZ)V", line = 160)
    ...
    @OriginalMember(owner = "client!fca", name = "finalize", descriptor = "()V", line = 180)
