...
public class class135 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ld;Loa;ILir;IIZILd;IIII)Lba;", line = 9)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILiaa;B)V", line = 52)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILiaa;)V", line = 189)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IBLoa;Lir;Ld;IBLd;IZIIII)Lba;", line = 218)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILoa;IILir;II)Lba;", line = 364)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lir;IIILoa;II)Lba;", line = 375)
