...
public class class135 extends class450 {
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lup;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(Z)[Lwm;")
