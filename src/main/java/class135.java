...
public class class135 extends class439 {
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 51)
    public class135() {
    }

    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(S)V", line = 56)
