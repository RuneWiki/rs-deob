...
public class class135 extends class362 {
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IB)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "()V", line = 148)
    public class135() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)[I", line = 155)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I[BIIB[BIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II)V", line = 294)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 307)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lfca;II)V", line = 334)
