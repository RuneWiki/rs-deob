...
public class class135 extends class172 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "([[BLtf;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BLhia;)V", line = 91)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILgga;)V", line = 109)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 135)
