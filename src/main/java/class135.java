...
public class class135 extends class47 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BLjava/lang/String;)V", line = 50)
    ...
    @OriginalMember(owner = "client!nc", name = "e", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(I)V", line = 174)
