...
public class class135 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIII[Lro;IIII)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II)Llf;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)Ls;")
