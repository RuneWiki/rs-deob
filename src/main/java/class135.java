...
public class class135 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(JB)V", line = 3)
    ...
    @OriginalMember(owner = "client!fca", name = "finalize", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "([BIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Ljava/io/File;", line = 45)
    public final File method1035(int arg0) {
        return arg0 == -7763 ? this.field2167 : null;
    }

    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(I)J", line = 73)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "([BIII)I", line = 83)
