...
public class class135 extends class112 {
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(ZII)I")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([JI[Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(I)Lgw;")
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lsr;IIIIII)V")
