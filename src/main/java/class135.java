...
public class class135 extends class578 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I[I[Ljava/lang/Object;IB)V", line = 28)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)Z", line = 86)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)I", line = 98)
    ...
    @OriginalMember(owner = "client!le", name = "d", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(II)V", line = 121)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(B)Z", line = 136)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)I", line = 150)
