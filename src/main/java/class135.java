...
public class class135 extends class100 implements class448 {
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)I", line = 14)
    public final int method48(byte arg0) {
        ++field1790;
        return arg0 != -70 ? 2 : this.field1788;
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLza;)V", line = 25)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Ll;Lfo;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 81)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLza;II)Luu;", line = 121)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILza;BI)Z", line = 165)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILza;)V", line = 186)
    ...
    @OriginalMember(owner = "client!pk", name = "g", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(BLza;)Luc;", line = 225)
    ...
    @OriginalMember(owner = "client!pk", name = "f", descriptor = "(I)I", line = 252)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILza;I)Le;", line = 270)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(BLza;)V", line = 292)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IBLza;)Le;", line = 309)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lza;Ler;IIIIZIIIII)V", line = 322)
