...
public class class135 extends class626 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILeq;)I", line = 16)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 126)
