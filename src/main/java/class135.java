...
public class class135 extends class723 implements class2 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Luha;", line = 40)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 72)
    public class135() {
        this.method869();
    }

    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(III[I)V", line = 76)
    public final void method871(int arg0, int arg1, int arg2, int[] arg3) {
        this.method868(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(III[I)V", line = 80)
    public final void method872(int arg0, int arg1, int arg2, int[] arg3) {
        this.method857(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(I)V", line = 83)
