...
public class class135 extends class430 {
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(B)I", line = 16)
    public final int method992(byte arg0) {
        int var2 = 36 / ((-arg0 - 24) / 56);
        return this.field2039;
    }

    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(B)I", line = 34)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)J", line = 44)
