...
public class class135 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(B)Z", line = 33)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(BI)I", line = 43)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 65)
