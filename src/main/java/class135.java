...
public class class135 extends class332 implements class83 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Lr;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(I)I", line = 28)
    public final int method264(int arg0) {
        ++field1957;
        return arg0 != -5273 ? -40 : this.field1958.field2207;
    }

    @OriginalMember(owner = "client!taa", name = "e", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!taa", name = "d", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(B)I", line = 114)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(BLr;)V", line = 125)
    ...
    @OriginalMember(owner = "client!taa", name = "c", descriptor = "(Lr;I)Lifa;", line = 136)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ZI)V", line = 147)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILr;ILcaa;ZII)V", line = 164)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(Z)I", line = 175)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Lr;I)Lhr;", line = 189)
    ...
    @OriginalMember(owner = "client!taa", name = "c", descriptor = "(I)Z", line = 244)
    ...
    @OriginalMember(owner = "client!taa", name = "f", descriptor = "(I)I", line = 255)
    public final int method258(int arg0) {
        ++field1975;
        return arg0 != -1 ? -13 : this.field1958.method1101((byte) 108);
    }

    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ZIILjava/lang/Object;)[B", line = 267)
    ...
    @OriginalMember(owner = "client!taa", name = "h", descriptor = "(I)Z", line = 301)
    public final boolean method270(int arg0) {
        ++field1964;
        return arg0 >= -42 ? false : false;
    }

    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(Lr;I)V", line = 312)
    ...
    @OriginalMember(owner = "client!taa", name = "e", descriptor = "(I)Z", line = 339)
    public final boolean method274(int arg0) {
        ++field1969;
        return arg0 != -1510217528 ? false : this.field1970;
    }

    @OriginalMember(owner = "client!taa", name = "d", descriptor = "(Z)Z", line = 350)
    public final boolean method309(boolean arg0) {
        ++field1977;
        return !arg0;
    }

    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)V", line = 361)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIZLr;)Z", line = 373)
