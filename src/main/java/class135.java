...
public class class135 implements Runnable {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(II)Luia;", line = 49)
    ...
    @OriginalMember(owner = "client!ju", name = "run", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 127)
