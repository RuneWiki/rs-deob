...
public class class135 implements class89 {
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()V", line = 23)
    public final void method885() {
        this.field1706 = Thread.currentThread();
        this.method881();
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 34)
