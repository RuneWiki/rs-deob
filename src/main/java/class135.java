...
public abstract class class135 extends class179 {
    ...
    @OriginalMember(owner = "client!sr", name = "e", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BI)V", line = 51)
