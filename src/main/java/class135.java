...
public class class135 extends class254 implements class161 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILaa;B)Lhc;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Laa;Z)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IILaa;Z)Lvn;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZIILaa;ILqh;)V")
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Laa;IB)Lhc;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIILaa;)Z")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Laa;I)Lcn;")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Laa;Lsk;IIIIZIIZ)V")
