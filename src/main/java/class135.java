...
public class class135 extends class303 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIFLdh;Z)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lui;B)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lui;I)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BLui;)V")
