...
public class class135 implements class267 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)Lkv;")
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(II)Llg;")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lla;Lla;Lla;)V")
