...
public class class135 extends class391 implements class339 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Lr;I)Lsd;")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZIBLr;Llo;II)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(ZLr;)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZLr;)Log;")
