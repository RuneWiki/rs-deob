...
public class class135 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 38)
    public class135(Throwable arg0, String arg1) {
        this.field1968 = arg0;
        this.field1969 = arg1;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lbe;Z)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 83)
