...
public class class135 extends class305 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(ILhb;)V", line = 14)
    public class135(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(II)I", line = 43)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Lhb;)V", line = 69)
    public class135(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(B)V", line = 94)
