...
public class class135 implements class402 {
    ...
    @OriginalMember(owner = "client!lc", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1635++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)Lku;", line = 22)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 37)
    public class135(String arg0, int arg1) {
        this.field1632 = arg1;
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIIIIB)V", line = 51)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIZZII)V", line = 178)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLjava/lang/String;)V", line = 222)
