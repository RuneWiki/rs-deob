...
public class class135 extends class233 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "()V", line = 17)
    public final void method878() {
    }

    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lh;II[BI)V", line = 21)
