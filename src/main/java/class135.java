...
public class class135 extends class498 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!kc", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 37)
    ...
    @OriginalMember(owner = "client!kc", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 48)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field2267;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!kc", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 78)
    ...
    @OriginalMember(owner = "client!kc", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 90)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field2271;
        return this.field2274 == arg0;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIILjava/awt/Graphics;IIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/awt/Canvas;III)V", line = 116)
    ...
    @OriginalMember(owner = "client!kc", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 141)
