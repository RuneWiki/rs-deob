...
public class class135 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lji;I)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILji;I)V")
