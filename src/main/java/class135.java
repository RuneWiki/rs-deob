...
public class class135 extends class263 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lnj;I)V")
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(Lnj;B)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lga;B)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lnj;B)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IFLsa;ZI)V")
