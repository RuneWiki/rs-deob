...
public class class135 extends class454 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eda", name = "h", descriptor = "(I)[Ljd;", line = 21)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Luf;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Lgfa;Leea;)V", line = 82)
