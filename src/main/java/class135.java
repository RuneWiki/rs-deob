...
public class class135 extends class95 {
    ...
    @OriginalMember(owner = "client!oe", name = "zb", descriptor = "[Lhg;")
    public class76[] field2601;

    @OriginalMember(owner = "client!oe", name = "vb", descriptor = "[Lca;")
    public class22[] field2597;

    @OriginalMember(owner = "client!oe", name = "mb", descriptor = "[Lhg;")
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(IIIII)Lgf;")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIIIZZ)Lue;")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lbg;II)Loe;")
