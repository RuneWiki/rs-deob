...
public class class135 extends class532 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!gm", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lwg;)V", line = 31)
    public class135(class449 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(B)Z", line = 51)
    public final boolean method703(byte arg0) {
        ++field1698;
        return arg0 <= 126 ? true : true;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZILgaa;)V", line = 62)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IBI)V", line = 76)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZB)V", line = 117)
