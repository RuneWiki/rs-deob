...
public class class135 extends class382 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(JI)V", line = 17)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lza;Lfi;Loi;J)V", line = 330)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IZILza;J)V", line = 163)
