...
public class class135 extends class149 implements class559 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILgaa;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lha;I)Lie;")
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Lha;B)Lufa;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIBLha;)Z")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILha;)V")
