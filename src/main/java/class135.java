...
public class class135 extends class130 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)[F", line = 36)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lum;)Z", line = 448)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "()I", line = 468)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "([I)Lrm;", line = 477)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "()V", line = 536)
    ...
    @OriginalMember(owner = "client!uo", name = "f", descriptor = "(I)F", line = 559)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "([B)V", line = 578)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lum;I)Luo;", line = 731)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lum;II)Luo;", line = 746)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "([B)V", line = 763)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "([BI)V", line = 810)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "([B)V", line = 816)
