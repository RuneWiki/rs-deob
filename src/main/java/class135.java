...
public class class135 extends class235 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!tj", name = "e", descriptor = "(I)Lhb;", line = 39)
