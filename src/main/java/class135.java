...
public class class135 extends class313 {
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sr", name = "d", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IBII)I", line = 49)
