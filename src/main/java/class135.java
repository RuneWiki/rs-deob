...
public class class135 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)Lrt;", line = 6)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lns;Lhs;Lbl;Lfd;Lqq;Lrv;Lfb;)V", line = 18)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;)Lvr;", line = 59)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;IIII)Lvr;", line = 71)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;Lps;IIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lm;III)I", line = 87)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(II)Lkn;", line = 144)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;IIIIIII[S[BZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "()V", line = 321)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "()V", line = 349)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIIIIII)V", line = 526)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(Lqa;IIII)V", line = 537)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "()V", line = 880)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;IIII[S[B)V", line = 901)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;Ltl;IIII[I[I)V", line = 962)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "([B[B[SII)V", line = 1098)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lm;II)V", line = 1243)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;II)V", line = 1253)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(Lqa;)V", line = 1432)
