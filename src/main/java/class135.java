...
public class class135 implements Runnable {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Leo;BI)Lio;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILio;)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lod;Lhp;IB)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([BLeo;IZ)Lio;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILeo;B)Lio;")
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lod;)V")
