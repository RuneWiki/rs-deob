...
public class class135 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I[Ljava/lang/String;[S)V", line = 32)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "([[IZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)I", line = 58)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 120)
