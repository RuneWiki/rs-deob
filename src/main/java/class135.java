...
public class class135 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "([BIIIIII[BI)V", line = 47)
