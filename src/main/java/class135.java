...
public class class135 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)[B", line = 4)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(ILno;Lno;I)V", line = 339)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([BIIZI)Z", line = 90)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I[BBI)Z", line = 204)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!oc", name = "toString", descriptor = "()Ljava/lang/String;", line = 268)
    public final String toString() {
        field2060++;
        return "Cache:" + this.field2058;
    }

    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 295)
