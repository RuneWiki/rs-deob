...
public class class667 extends class299 {
    ...
    @OriginalMember(owner = "client!wda", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(Z)I", line = 51)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Les;)V", line = 87)
    public class667(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(ILes;)V", line = 90)
    public class667(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)Z", line = 127)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(II)I", line = 157)
