...
public class class667 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Loh;ILha;)V")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lda;)V")
    public class667(class59 arg0) {
        this.field9491 = arg0;
    }

    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lda;Lur;)V")
