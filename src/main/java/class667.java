...
public class class667 implements class245 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(II)I", line = 25)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IILml;IZ)Lgda;", line = 54)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)Luu;", line = 81)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Ljava/lang/String;Lrj;Lmq;IIIIIIIIII)V", line = 93)
