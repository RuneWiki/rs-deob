...
public class class667 extends class659 {
    ...
    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IILdt;)V", line = 18)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILdt;)Ljava/lang/String;", line = 93)
    ...
    @OriginalMember(owner = "client!rg", name = "e", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ldt;I)V", line = 144)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "([IILdt;)V", line = 167)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "([[[Lvda;B)V", line = 196)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)Ljava/lang/String;", line = 273)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BI)V", line = 306)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)I", line = 332)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IB)Led;", line = 349)
