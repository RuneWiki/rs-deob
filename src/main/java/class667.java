...
public abstract class class667 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I[II[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)V", line = 121)
