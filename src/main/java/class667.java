...
public class class667 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILjr;)V")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Laca;I)Z")
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Ljr;)V")
