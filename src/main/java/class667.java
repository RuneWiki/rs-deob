...
public class class667 extends class379 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(II)V", line = 52)
