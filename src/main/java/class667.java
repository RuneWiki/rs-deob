...
public class class667 {
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(ILjava/lang/Object;BI)[B", line = 30)
