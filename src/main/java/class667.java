...
public class class667 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lgf;IZ)V")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lcw;I)Z")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLcw;)V")
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lok;)V")
