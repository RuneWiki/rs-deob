...
public class class667 extends class437 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lxa;Z)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIIIIIILbe;II)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II[[I[[IIII)Ld;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "([Lba;Lq;[Lot;I)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lpf;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljava/lang/Runnable;)Leo;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ldi;IIII)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "([Lba;Lc;Lq;[Lot;I)V")
