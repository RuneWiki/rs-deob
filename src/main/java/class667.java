...
public class class667 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "()Lso;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lla;II)Lgd;")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lofa;)V")
