...
public abstract class class667 {
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ck", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BI)I", line = 34)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B[BI)V", line = 45)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lffa;I[BIZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lffa;ILjaclib/memory/Buffer;IZ)V", line = 103)
