...
public class class667 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lha;Lav;)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Lha;Lav;)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(Lha;Lav;)Z")
    ...
    @OriginalMember(owner = "client!av", name = "d", descriptor = "(Lha;Lav;)Z")
