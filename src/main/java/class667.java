...
public class class667 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIILjava/lang/Object;)[B", line = 25)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IB)Lqr;", line = 61)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)Luca;", line = 72)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(II)V", line = 82)
