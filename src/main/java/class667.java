...
public class class667 extends class135 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILwv;Lvo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(III)V", line = 110)
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lnh;)V", line = 146)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZI)V", line = 256)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Laj;II)V", line = 299)
    ...
    @OriginalMember(owner = "client!lb", name = "g", descriptor = "(I)Z", line = 311)
