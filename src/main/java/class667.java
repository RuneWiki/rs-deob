...
public class class667 extends class362 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(II)V", line = 102)
    public class667(int arg0, int arg1) {
        this.field9108 = arg1;
        this.field9102 = arg0;
    }

    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(I)V", line = 114)
