...
public class class667 extends class184 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILiga;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()Lega;")
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "()Lega;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILiga;I[III)V")
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Luga;)V")
