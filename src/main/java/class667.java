...
public class class667 implements class205 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)Lww;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IILha;)Lfd;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I[IILvo;)Lhh;")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Ljava/lang/String;Lrg;Lal;IIIIIIIIII)V")
