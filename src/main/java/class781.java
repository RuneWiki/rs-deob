...
public class class781 extends class69 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "([II[ILkf;[I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;ZI)V", line = 118)
