...
public class class781 extends class165 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIZ)I", line = 8)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(ILmia;)V", line = 61)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Lrv;I)V", line = 88)
