...
public class class781 {
    ...
    @OriginalMember(owner = "client!hda", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!hda", name = "listmodes", descriptor = "()[I", line = 74)
    ...
    @OriginalMember(owner = "client!hda", name = "exit", descriptor = "()V", line = 97)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 118)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "()V", line = 161)
