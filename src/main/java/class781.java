...
public class class781 extends class377 implements class238 {
    ...
    @OriginalMember(owner = "client!hda", name = "e", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(Z)Z", line = 32)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(ILha;)Lrk;", line = 47)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IZLha;Z)Lwv;", line = 72)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lha;I)V", line = 144)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(B)Z", line = 171)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)Z", line = 187)
    ...
    @OriginalMember(owner = "client!hda", name = "f", descriptor = "(I)I", line = 201)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)I", line = 211)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lha;IB)Lka;", line = 223)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IBLjava/awt/Canvas;I)Lnda;", line = 247)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IBILha;)Z", line = 270)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(Lha;I)V", line = 293)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)I", line = 306)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ZLha;)Loba;", line = 322)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ILha;)V", line = 337)
