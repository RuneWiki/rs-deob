...
public class class781 extends class326 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!hda", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "()Lqja;", line = 68)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(III[I)V", line = 92)
    ...
    @OriginalMember(owner = "client!hda", name = "e", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(III[I)V", line = 171)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(III)V", line = 184)
    ...
    @OriginalMember(owner = "client!hda", name = "f", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "()V", line = 251)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(III[I)V", line = 262)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lqja;)V", line = 272)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ZIII)I", line = 294)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "([I)V", line = 349)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "()V", line = 369)
    public class781() {
        this.method1873();
    }
}
