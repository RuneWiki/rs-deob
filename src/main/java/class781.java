...
public class class781 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(III)V", line = 22)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(CLjava/lang/String;B)I", line = 51)
