...
public class class781 extends class101 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I[II)V", line = 9)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)Z", line = 164)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(II)V", line = 199)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(II)V", line = 219)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(II)V", line = 234)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lew;IIIII)V", line = 489)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(FIIII)V", line = 370)
