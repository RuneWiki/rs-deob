...
public class class541 extends class223 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!ac", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 3)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field7169;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIILha;IIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ac", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 39)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field7166;
        return this.field7161 == arg0;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/awt/Canvas;III)V", line = 49)
    ...
    @OriginalMember(owner = "client!ac", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 76)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field7167;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZIIIIILjava/awt/Graphics;)V", line = 100)
    ...
    @OriginalMember(owner = "client!ac", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 117)
    ...
    @OriginalMember(owner = "client!ac", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)V", line = 163)
