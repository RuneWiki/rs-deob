...
public class class541 extends class130 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIII)I", line = 207)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IBI)Z", line = 240)
