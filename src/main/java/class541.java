...
public class class541 extends class314 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLie;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "()V", line = 92)
    public class541() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IB)[[I", line = 97)
    ...
    @OriginalMember(owner = "client!pm", name = "h", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(II)V", line = 192)
