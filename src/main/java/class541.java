...
public abstract class class541 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Lqk;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 52)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(I)V", line = 66)
    public static void method3254(int arg0) {
        int var1 = 124 % ((arg0 - 66) / 58);
        field7855 = null;
    }

    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IIIIIIIBZ)Z", line = 75)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IIZ)I", line = 107)
