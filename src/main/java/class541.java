...
public class class541 {
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!iu", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lbs;ILpfa;)V", line = 63)
    public class541(class643 arg0, int arg1, class275 arg2) {
        this.field6822 = arg2;
        this.field6822.method1655(32, (byte) -82);
    }

    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(II)Lgr;", line = 78)
