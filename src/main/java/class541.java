...
public class class541 extends class17 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(CB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "()V", line = 38)
    public class541() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)[I", line = 43)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lwm;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!ms", name = "h", descriptor = "(I)V", line = 175)
