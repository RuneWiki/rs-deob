...
public class class541 extends class88 implements class532 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 7)
    public final int method656() {
        return this.method3132(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 28)
    public final int method670() {
        return this.method3130(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 54)
    public final void method106(boolean arg0) {
        this.method3143(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 60)
    public final int method657() {
        return this.method3136(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 66)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 75)
