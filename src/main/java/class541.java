...
public class class541 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Liaa;IBIB)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILkq;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZLkq;Lkq;)V")
