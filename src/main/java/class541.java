...
public class class541 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIBII)V", line = 16)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZLlj;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILlj;)V", line = 402)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLdk;Llj;I)V", line = 420)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIBIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Llj;I)V", line = 609)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(Llj;I)V", line = 628)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(B)V", line = 643)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Llj;II)V", line = 663)
