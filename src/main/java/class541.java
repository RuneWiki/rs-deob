...
public class class541 extends class747 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ldc;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 147)
    public class541() {
        super(0, false);
    }

    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)[[I", line = 76)
    ...
    @OriginalMember(owner = "client!bh", name = "e", descriptor = "(Z)V", line = 150)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Z)I", line = 204)
