...
public class class541 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)Lqw;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IBLio;)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILio;)V")
