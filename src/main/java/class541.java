...
public class class541 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BI)Llt;", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lcu;IILcu;ZZI)I", line = 40)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(III)V", line = 69)
