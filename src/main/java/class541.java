...
public class class541 implements class121 {
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)Lqv;", line = 23)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Ljava/lang/String;Lida;Lce;IIII)V", line = 38)
