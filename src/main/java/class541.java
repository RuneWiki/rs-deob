...
public class class541 extends class540 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lts;I)I", line = 26)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZBLst;)V", line = 54)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(II)I", line = 104)
