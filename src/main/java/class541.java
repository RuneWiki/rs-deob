...
public class class541 extends class589 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 10)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIILjava/awt/Graphics;BI)V", line = 34)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILjava/awt/Graphics;B)V", line = 50)
