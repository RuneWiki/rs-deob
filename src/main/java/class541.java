...
public class class541 extends class529 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IBLtn;)V", line = 13)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 316)
    public class541() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIZIILufa;)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 144)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIB)V", line = 179)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)[[I", line = 236)
    ...
    @OriginalMember(owner = "client!ei", name = "f", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIZI)V", line = 349)
