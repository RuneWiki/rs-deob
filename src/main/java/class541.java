...
public class class541 implements class105 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(BIIIIII[[[BILha;III)V")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Z)Lwh;")
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(ILjk;Ltda;II)V")
