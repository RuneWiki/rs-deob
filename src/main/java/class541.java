...
public class class541 extends class513 implements class446 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(B)C", line = 4)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(Z)I", line = 29)
    public final int method2638(boolean arg0) {
        field7856++;
        return arg0 ? this.field7864 : -125;
    }

    @OriginalMember(owner = "client!nw", name = "e", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(II)I", line = 86)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Z)J", line = 108)
    public final long method2635(boolean arg0) {
        field7855++;
        return arg0 ? -6L : this.field7868;
    }

    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(III)Z", line = 120)
