...
public class class541 extends class476 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(Lgj;Lgj;Lmea;)V", line = 27)
    public class541(class662 arg0, class662 arg1, class454 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(BIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 46)
