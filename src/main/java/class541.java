...
public class class541 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Luha;B)Lmp;", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)Lgm;", line = 56)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIIII)I", line = 70)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([Lrr;II)V", line = 85)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IBZ)V", line = 139)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Loh;Loh;)V", line = 169)
