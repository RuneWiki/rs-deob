...
public class class541 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ZJ)V", line = 89)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BI)[I", line = 165)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)Lcca;", line = 211)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(B)Z", line = 227)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 245)
