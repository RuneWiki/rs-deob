...
public abstract class class541 extends class168 {
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 28)
    public class541(OggStreamState arg0) {
        this.field7489 = arg0;
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IILvl;)V", line = 37)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 66)
