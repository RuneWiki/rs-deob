...
public class class541 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IB)Lej;")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)Llb;")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lqh;ILtf;Ltf;Ltf;)V")
