...
public class class312 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)Lse;", line = 58)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 117)
    public class312() {
        this.field3985.field2169 = this.field3985;
        this.field3985.field2165 = this.field3985;
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)Z", line = 82)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)Lse;", line = 98)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lse;B)V", line = 141)
