...
public abstract class class312 implements class726 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIII)V", line = 3)
    public final void method1837(int arg0, int arg1, int arg2, int arg3) {
        this.method234(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)V", line = 6)
    public final void method1838(int arg0, int arg1) {
        this.method240(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFIILaa;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFFFFFIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFII)V", line = 20)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFFFIILaa;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(IIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(IIII)V", line = 59)
    public final void method1844(int arg0, int arg1, int arg2, int arg3) {
        this.method1635(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFIIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(FFFFIIIII)V", line = 71)
