...
public class class312 extends class442 {
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lnia;Lhw;[Lfm;[I[I)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(CIIIZLaa;II)V")
