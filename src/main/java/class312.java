...
public class class312 extends class577 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(JII)Lgaa;", line = 30)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIII)V", line = 63)
