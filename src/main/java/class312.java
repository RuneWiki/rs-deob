...
public abstract class class312 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)Z", line = 47)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILgba;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)Z", line = 99)
