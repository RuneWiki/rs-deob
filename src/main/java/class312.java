...
public class class312 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILil;I)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIILjava/lang/Class;)Lme;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILil;II)V")
