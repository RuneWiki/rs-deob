...
public class class312 extends class634 {
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILig;Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!aj", name = "f", descriptor = "(I)Lvg;", line = 169)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IILha;)Z", line = 186)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "()V", line = 895)
    public class312() {
        super(1, false);
    }

    @OriginalMember(owner = "client!aj", name = "g", descriptor = "(I)V", line = 633)
    public static void method1855(int arg0) {
        int var1 = -66 / ((arg0 - -37) / 51);
        field3864 = null;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)V", line = 643)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BI)[[I", line = 900)
