...
public class class312 implements Runnable {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZLnp;I)Lbfa;")
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "([[BBLjda;)V")
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(JLvd;IIIZI)V")
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Lnp;II)Lbfa;")
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Lnp;[BII)Lbfa;")
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ILbfa;)V")
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lge;)V")
