...
public class class312 extends class657 {
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lffa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lkia;I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IBLmw;)V", line = 154)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(B)V", line = 201)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZI)V", line = 280)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIZ)V", line = 313)
