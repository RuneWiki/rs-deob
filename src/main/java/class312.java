...
public class class312 extends class329 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(III)Lev;", line = 4)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIZ)Z", line = 15)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II[IB)V", line = 34)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIIIIB)Z", line = 56)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "([IIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIII)Z", line = 101)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(III)Z", line = 116)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(IIIIIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(CZ)C", line = 146)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILrj;ILjava/awt/Component;I)Lah;", line = 175)
