...
public class class312 extends class225 {
    ...
    @OriginalMember(owner = "client!wh", name = "e", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IBI)V", line = 22)
    ...
    @OriginalMember(owner = "client!wh", name = "f", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIIII)V", line = 70)
