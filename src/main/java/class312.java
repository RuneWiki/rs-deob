...
public class class312 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I[II)Lqq;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II[I)Lqq;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I[III)Lqq;")
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I[III)Lqq;")
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lnl;Lnl;)V")
