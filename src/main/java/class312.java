...
public class class312 extends class650 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "([[FI[[S)[[S", line = 3)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Llga;Llga;Lsm;)V", line = 102)
