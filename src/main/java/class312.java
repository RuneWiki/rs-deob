...
public class class312 extends class381 {
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lda;II[BI)V")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZB)V")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lph;Lza;ILph;)V")
