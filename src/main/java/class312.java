...
public class class312 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)Lfh;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lkm;Z)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lvj;I)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILvj;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ldda;Z)V")
