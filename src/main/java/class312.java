...
public class class312 implements Runnable {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/awt/Frame;Z)Lmg;", line = 10)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIILjava/lang/Object;I)Lmg;", line = 34)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/Class;Ljava/lang/String;)Lmg;", line = 65)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILjava/lang/Class;)Lmg;", line = 76)
    public final class100 method1952(int arg0, Class arg1) {
        int var3 = 99 / ((-arg0 - 55) / 47);
        return this.method1950(0, 33, 0, arg1, 20);
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)Lmg;", line = 85)
    public final class100 method1953(int arg0) {
        return arg0 == 6343 ? this.method1950(0, 33, 0, null, 18) : null;
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/net/URL;I)Lmg;", line = 95)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)Lmg;", line = 106)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II)Lmg;", line = 116)
    public final class100 method1956(int arg0, int arg1) {
        return arg1 == 3 ? this.method1950(arg0, 33, 0, null, 3) : null;
    }

    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 699)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZLjava/awt/Component;I)Lmg;", line = 130)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIII)Lmg;", line = 140)
    ...
    @OriginalMember(owner = "client!ci", name = "run", descriptor = "()V", line = 153)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILjava/lang/Runnable;)Lmg;", line = 274)
    public final class100 method1959(int arg0, int arg1, Runnable arg2) {
        return arg0 > -7 ? null : this.method1950(arg1, 33, 0, arg2, 2);
    }

    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(B)Lql;", line = 289)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(ILjava/lang/Class;)Lmg;", line = 302)
    public final class100 method1961(int arg0, Class arg1) {
        int var3 = 70 / ((arg0 - 6) / 54);
        return this.method1950(0, 33, 0, arg1, 11);
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILjava/lang/String;I)Lmg;", line = 313)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIILjava/awt/Component;)Lmg;", line = 329)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(I)Z", line = 347)
    ...
    @OriginalMember(owner = "client!ci", name = "d", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILjava/lang/String;)Lmg;", line = 418)
    public final class100 method1966(int arg0, String arg1) {
        return arg0 == 33 ? this.method1950(0, 33, 0, arg1, 21) : null;
    }

    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(ILjava/lang/String;)Lmg;", line = 432)
    public final class100 method1967(int arg0, String arg1) {
        return arg0 == 12619 ? this.method1950(0, 33, 0, arg1, 12) : null;
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I[IIILjava/awt/Point;Ljava/awt/Component;)Lmg;", line = 447)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Lmg;", line = 457)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IBLjava/lang/String;Ljava/lang/String;)Ljava/io/File;", line = 469)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;I)Lmg;", line = 560)
    public final class100 method1971(String arg0, int arg1) {
        return arg1 >= -32 ? null : this.method1950(0, 33, 0, arg0, 16);
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lmg;", line = 575)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(ILjava/lang/String;)Ljava/io/File;", line = 590)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 601)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(ILjava/lang/Class;)V", line = 616)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIILjava/lang/Object;)Lmg;", line = 661)
