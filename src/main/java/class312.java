...
public class class312 implements class17 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIFIZI)[F", line = 19)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZFIII)[I", line = 61)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(FIIZII)[I", line = 75)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZ)Lht;", line = 89)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Ldn;Ldn;Ldn;)V", line = 146)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)Luk;", line = 136)
