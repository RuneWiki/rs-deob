...
public class class312 extends class219 {
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IIIIILha;)V", line = 27)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(BI)Z", line = 53)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 64)
