...
public class class312 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIIIIILha;III)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(I[Lhe;IIII)V")
