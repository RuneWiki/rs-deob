...
public class class312 extends class405 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(DB)V", line = 6)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!bb", name = "e", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!bb", name = "f", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Ljp;)V", line = 151)
