...
public class class312 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)Lsr;", line = 16)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 97)
    public class312(class446 arg0, int arg1, class387 arg2) {
        this.field4444 = arg2;
        this.field4444.method2367(1, 28724);
    }

    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(I)V", line = 112)
