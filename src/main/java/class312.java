...
public class class312 extends class519 implements class438 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()[Lon;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lpaa;II)V")
    ...
    @OriginalMember(owner = "client!ma", name = "d", descriptor = "()[Ltf;")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(La;Lc;Lld;IIII)V")
