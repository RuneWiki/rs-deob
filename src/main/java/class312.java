...
public class class312 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lya;II)Z")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILya;IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(I[Lwe;IIII)V")
