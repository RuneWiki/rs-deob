...
public class class312 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZLr;IZIII)Lda;")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZIIILq;BLda;ILr;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lr;Lqp;IIIIIIZI)V")
