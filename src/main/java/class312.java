...
public class class312 extends class56 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "([Ljava/awt/Rectangle;IB)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BLee;)Lpj;")
