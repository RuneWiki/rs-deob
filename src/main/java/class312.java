...
public class class312 {
    ...
    public static int[] field4091 = new int[4];

    @OriginalMember(owner = "client!dja", name = "a", descriptor = "I")
    public static int field4089;

    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IB)[[[B", line = 4)
    public static final byte[][][] method1863(int arg0, byte arg1) {
        field4089++;
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(Z)V", line = 783)
