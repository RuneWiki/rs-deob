...
public class class312 extends class744 implements class722 {
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(Lha;I)Lbd;", line = 4)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILha;)V", line = 57)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!ce", name = "h", descriptor = "(I)I", line = 83)
    ...
    @OriginalMember(owner = "client!ce", name = "g", descriptor = "(I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(Z)I", line = 119)
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(Lha;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!ce", name = "g", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z)Z", line = 180)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lha;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lmg;Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILha;BI)Z", line = 214)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZIIIII)V", line = 234)
    ...
    @OriginalMember(owner = "client!ce", name = "d", descriptor = "(I)Z", line = 247)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IZ)V", line = 257)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(I)I", line = 300)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BLha;)Loia;", line = 315)
