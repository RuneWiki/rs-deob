...
public class class312 extends class98 {
    ...
    @OriginalMember(owner = "client!de", name = "f", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "()V", line = 18)
    public class312() {
        super(0, true);
    }

    @OriginalMember(owner = "client!de", name = "g", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)[I", line = 69)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ltq;Ltq;ZLtq;)V", line = 133)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILdg;I)V", line = 145)
