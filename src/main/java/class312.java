...
public class class312 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILru;I)Z")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IIIIILha;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Llf;)V")
