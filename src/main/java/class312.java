...
public class class312 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lza;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IB)V", line = 71)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "([I)V", line = 84)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILjava/lang/String;)V", line = 121)
