...
public class class312 extends class180 {
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!ci", name = "d", descriptor = "(I)V", line = 48)
