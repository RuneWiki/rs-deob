...
public class class312 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lql;)V")
