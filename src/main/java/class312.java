...
public class class312 extends class425 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "()V", line = 34)
    public class312() {
    }

    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(J)V", line = 36)
    public class312(long arg0) {
        this.field4612 = arg0;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BLtj;)I", line = 87)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 111)
