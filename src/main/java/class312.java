...
public class class312 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Ljava/lang/String;IILuf;Lda;Laa;IIZILrt;I)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIILha;IIII)V")
