...
public class class312 extends class433 implements class324 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ldc;Lhi;II[FII)V", line = 15)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ldc;Lhi;II[BII)V", line = 28)
    ...
    @OriginalMember(owner = "client!rd", name = "e", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(III)Z", line = 58)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBII[BLhi;III)V", line = 180)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BZZ)V", line = 206)
    public final void method947(byte arg0, boolean arg1, boolean arg2) {
        ++field4287;
        int var4 = -69 / ((46 - arg0) / 36);
    }

    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(B)I", line = 215)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ldc;Lhi;Lne;II)V", line = 226)
    ...
    @OriginalMember(owner = "client!rd", name = "f", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIIIIII[I)V", line = 260)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Leh;B)Llr;", line = 284)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ZZ)V", line = 297)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ZZB)V", line = 357)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(FZ)F", line = 379)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)Z", line = 390)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ldc;II[III)V", line = 403)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IF)F", line = 421)
