...
public abstract class class312 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lah;Lap;ILjava/awt/Canvas;II)Le;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILap;ZLjava/lang/String;Z)V")
