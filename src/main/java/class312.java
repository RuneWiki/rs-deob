...
public class class312 extends class251 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)Z", line = 230)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(I)V", line = 244)
    public class312(int arg0) {
        this.field4690 = arg0;
    }

    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(II)V", line = 252)
    ...
    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(II)Z", line = 269)
    ...
    @OriginalMember(owner = "client!cq", name = "d", descriptor = "(B)Z", line = 279)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(Z)V", line = 374)
