...
public class class312 implements Runnable {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IZI)I", line = 104)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)V", line = 124)
    public static void method1861(int arg0) {
        int var1 = -52 / ((-arg0 - 46) / 49);
        field4029 = null;
    }

    @OriginalMember(owner = "client!mc", name = "run", descriptor = "()V", line = 136)
