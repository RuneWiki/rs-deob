...
public class class312 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILiaa;)V", line = 7)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)Laaa;", line = 40)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILiaa;I)V", line = 61)
