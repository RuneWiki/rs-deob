...
public class class93 {
    ...
    public static int method1915(int arg0, int arg1) {
    ...
    public class93() {
        class95.method1931(24);
        this.field1294 = class95.method1931(16);
        this.field1293 = class95.method1931(24);
        this.field1295 = new int[this.field1293];
        boolean var1 = class95.method1943() != 0;
        if (var1) {
            int var2 = 0;
            int var3 = class95.method1931(5) + 1;
            while (var2 < this.field1293) {
                int var4 = class95.method1931(class190.method2864(this.field1293 - var2));
            ...
            boolean var6 = class95.method1943() != 0;
            for (int var7 = 0; var7 < this.field1293; var7++) {
                if (var6 && class95.method1943() == 0) {
                    this.field1295[var7] = 0;
                } else {
                    this.field1295[var7] = class95.method1931(5) + 1;
                }
            }
        }
        this.method1905();
        int var8 = class95.method1931(4);
        if (var8 > 0) {
            float var9 = class95.method1953(class95.method1931(32));
            float var10 = class95.method1953(class95.method1931(32));
            int var11 = class95.method1931(4) + 1;
            boolean var12 = class95.method1943() != 0;
            int var13;
            if (var8 == 1) {
                var13 = method1915(this.field1293, this.field1294);
            } else {
                var13 = this.field1294 * this.field1293;
            }
            this.field1296 = new int[var13];
            for (int var14 = 0; var14 < var13; var14++) {
                this.field1296[var14] = class95.method1931(var11);
            }
            this.field1297 = new float[this.field1293][this.field1294];
            if (var8 == 1) {
                ...
                for (int var21 = 0; var21 < this.field1293; var21++) {
                    float var22 = 0.0F;
                    int var23 = this.field1294 * var21;
    ...
    @ObfuscatedName("cp.m()I")
    public int method1913() {
        int var1;
        for (var1 = 0; this.field1298[var1] >= 0; var1 = class95.method1943() == 0 ? var1 + 1 : this.field1298[var1]) {
        }
        return ~this.field1298[var1];
    }

    @ObfuscatedName("cp.j()[F")
    public float[] method1907() {
        return this.field1297[this.method1913()];
    }
}
