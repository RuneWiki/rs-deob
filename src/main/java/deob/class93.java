...
public class class93 {
    ...
    @ObfuscatedName("ct.s")
    public static class100 field1231 = new class100(260);
        ...
        if (arg0 == null) {
            ...
            for (int var5 = 0; var5 < 7; var5++) {
                for (int var6 = 0; var6 < Statics.field1628; var6++) {
                    class157 var7 = class157.method346(var6);
    ...
    public void method1172(class135 arg0) {
    ...
    public class180 method1174(class155 arg0, int arg1, class155 arg2, int arg3) {
        if (this.field1225 != -1) {
            return class152.method275(this.field1225).method2330(arg0, arg1, arg2, arg3);
        }
        ...
        class180 var9 = (class180) field1231.method1244(var5);
        if (var9 == null) {
            boolean var10 = false;
            for (int var11 = 0; var11 < 12; var11++) {
                int var12 = var7[var11];
                if (var12 >= 256 && var12 < 512 && !class157.method346(var12 - 256).method2461()) {
                    var10 = true;
                }
                if (var12 >= 512 && !class161.method927(var12 - 512).method2547(this.field1222)) {
                    var10 = true;
                }
            }
            if (var10) {
                if (this.field1227 != -1L) {
                    var9 = (class180) field1231.method1244(this.field1227);
                }
                if (var9 == null) {
                    return null;
                }
            ...
            if (var9 == null) {
                ...
                for (int var15 = 0; var15 < 12; var15++) {
                    ...
                    if (var16 >= 256 && var16 < 512) {
                        class179 var17 = class157.method346(var16 - 256).method2465();
                        if (var17 != null) {
                            var13[var14++] = var17;
                        }
                    }
                    if (var16 >= 512) {
                        class179 var18 = class161.method927(var16 - 512).method2525(this.field1222);
                        if (var18 != null) {
                            var13[var14++] = var18;
                        }
                    }
    ...
    public class179 method1192() {
        if (this.field1225 != -1) {
            return class152.method275(this.field1225).method2331();
        }
        boolean var1 = false;
        for (int var2 = 0; var2 < 12; var2++) {
            int var3 = this.field1228[var2];
            if (var3 >= 256 && var3 < 512 && !class157.method346(var3 - 256).method2463()) {
                var1 = true;
            }
            if (var3 >= 512 && !class161.method927(var3 - 512).method2554(this.field1222)) {
                var1 = true;
            }
        }
        if (var1) {
        ...
        for (int var6 = 0; var6 < 12; var6++) {
            ...
            if (var7 >= 256 && var7 < 512) {
                class179 var8 = class157.method346(var7 - 256).method2480();
                if (var8 != null) {
                    var4[var5++] = var8;
                }
            }
            if (var7 >= 512) {
                class179 var9 = class161.method927(var7 - 512).method2527(this.field1222);
                if (var9 != null) {
                    var4[var5++] = var9;
                }
            }
    ...
    public int method1176() {
        return this.field1225 == -1 ? (this.field1228[11] << 5) + (this.field1228[8] << 10) + (this.field1228[0] << 15) + (this.field1223[4] << 20) + (this.field1223[0] << 25) + this.field1228[1] : 305419896 + class152.method275(this.field1225).field2271;
    }
