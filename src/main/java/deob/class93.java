...
public class class93 extends class130 {
    ...
    public class93(class183 arg0, class183 arg1, int arg2, boolean arg3) {
        ...
        int[] var7 = arg0.method2995(arg2);
        for (int var8 = 0; var8 < var7.length; var8++) {
            byte[] var9 = arg0.method2986(arg2, var7[var8]);
            class87 var10 = null;
            int var11 = (var9[0] & 0xFF) << 8 | var9[1] & 0xFF;
            for (class87 var12 = (class87) var5.method2187(); var12 != null; var12 = (class87) var5.method2203()) {
            ...
            if (var10 == null) {
                byte[] var13;
                if (arg3) {
                    var13 = arg1.method3041(0, var11);
                } else {
                    var13 = arg1.method3041(var11, 0);
                }
                var10 = new class87(var11, var13);
                var5.method2190(var10);
            }
            this.field1569[var7[var8]] = new class81(var9, var10);
        }
    }

    @ObfuscatedName("cp.s(II)Z")
    public boolean method1757(int arg0) {
        return this.field1569[arg0].field1330;
    }
}
