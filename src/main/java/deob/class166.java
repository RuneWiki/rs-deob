...
public class class166 {
    ...
    @ObfuscatedName("de.n(CIB)C")
    public static char method2261(char arg0, int arg1) {
    ...
    @ObfuscatedName("er.d(CI)C")
    public static char method2702(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("b.s(CIB)I")
    public static int method142(char arg0, int arg1) {
        int var2 = arg0 << 4;
