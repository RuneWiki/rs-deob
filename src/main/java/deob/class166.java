...
public class class166 {
    ...
    @ObfuscatedName("au.j(CII)C")
    public static char method951(char arg0, int arg1) {
    ...
    @ObfuscatedName("bc.m(CI)C")
    public static char method1211(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("br.f(CIB)I")
    public static int method1489(char arg0, int arg1) {
        int var2 = arg0 << 4;
