...
public class class166 {
    ...
    @ObfuscatedName("v.h(CII)C")
    public static char method43(char arg0, int arg1) {
    ...
    @ObfuscatedName("ag.q(CB)C")
    public static char method646(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ae.v(CIB)I")
    public static int method975(char arg0, int arg1) {
        int var2 = arg0 << 4;
