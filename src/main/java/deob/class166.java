...
public class class166 {
    ...
    @ObfuscatedName("ah.k(CII)C")
    public static char method820(char arg0, int arg1) {
    ...
    @ObfuscatedName("d.h(CB)C")
    public static char method80(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("hx.o(CIB)I")
    public static int method3711(char arg0, int arg1) {
        int var2 = arg0 << 4;
