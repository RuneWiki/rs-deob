...
public class class158 extends class142 {
    ...
    @ObfuscatedName("fb.j")
    public static class100 field2411 = new class100(64);
    ...
    public static class158 method1002(int arg0) {
        class158 var1 = (class158) field2411.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        if (var2 != null) {
            var3.method2499(new class135(var2), arg0);
        }
        var3.method2485();
    ...
    public void method2499(class135 arg0, int arg1) {
        while (true) {
    ...
    public void method2487(class135 arg0, int arg1, int arg2) {
        if (arg1 == 1) {
