...
public class class341 extends RuntimeException {
    ...
    @ObfuscatedName("jg.a(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method4728(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            if (Statics.field4047 == null) {
                return;
            }
            URL var26 = new URL(Statics.field4047.getCodeBase(), "clienterror.ws?c=" + Statics.field4045 + "&u=" + Statics.field4044 + "&v1=" + Statics.field2017 + "&v2=" + Statics.field2013 + "&ct=" + Statics.field1217 + "&e=" + var25);
    ...
    @ObfuscatedName("kz.t(Ljava/lang/Throwable;Ljava/lang/String;)Lmf;")
    public static class341 method5388(Throwable arg0, String arg1) {
        class341 var2;
