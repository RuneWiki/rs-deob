...
public class class150 {
    ...
    @ObfuscatedName("dd.x(CII)C")
    public static char method2166(char arg0, int arg1) {
    ...
    @ObfuscatedName("cx.p(CI)C")
    public static char method1998(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("s.k(CII)I")
    public static int method98(char arg0, int arg1) {
        int var2 = arg0 << 4;
