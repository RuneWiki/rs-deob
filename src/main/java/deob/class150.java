...
public class class150 {
    ...
    @ObfuscatedName("bb.p(CIB)C")
    public static char method1306(char arg0, int arg1) {
    ...
    @ObfuscatedName("dk.i(CI)C")
    public static char method2245(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("l.o(CII)I")
    public static int method46(char arg0, int arg1) {
        int var2 = arg0 << 4;
