...
public class class150 {
    ...
    @ObfuscatedName("a.t(CII)C")
    public static char method233(char arg0, int arg1) {
    ...
    @ObfuscatedName("ei.l(CI)C")
    public static char method2938(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("bn.c(CIS)I")
    public static int method1253(char arg0, int arg1) {
        int var2 = arg0 << 4;
