...
public abstract class class496 {
    ...
    @ObfuscatedName("ti.av")
    public double field4920 = 0.0D;

    @ObfuscatedName("ti.ag")
    public int field4918 = 0;

    public class496(int arg0, int arg1) {
        this.field4922 = arg0;
        this.field4919 = 0;
        this.field4918 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field4920 = method2027(this.field4919, this.field4922, this.field4918);
    }

    @ObfuscatedName("ti.ap(I)V")
    public void method7823() {
        if (this.field4919 < this.field4922) {
            this.field4919++;
            this.field4920 = method2027(this.field4919, this.field4922, this.field4918);
        }
    }

    @ObfuscatedName("ti.ay(I)D")
    public double method7824() {
        return this.field4920;
    }

    @ObfuscatedName("cf.as(IIII)D")
    public static double method2027(int arg0, int arg1, int arg2) {
