...
public final class class231 {
    ...
    public final void method3960(long arg0) throws IOException {
        this.field3261.seek(arg0);
        this.field3262 = arg0;
    }

    @ObfuscatedName("hq.l([BIIB)V")
    public final void method3961(byte[] arg0, int arg1, int arg2) throws IOException {
    ...
    public final void method3962() throws IOException {
    ...
    @ObfuscatedName("hq.h(B)J")
    public final long method3963() throws IOException {
        return this.field3261.length();
    }

    @ObfuscatedName("hq.r([BIII)I")
    public final int method3964(byte[] arg0, int arg1, int arg2) throws IOException {
