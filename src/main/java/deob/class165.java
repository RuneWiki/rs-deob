...
public class class165 {
    ...
    @ObfuscatedName("ao.k(II)I")
    public static int method751(int arg0) {
    ...
    @ObfuscatedName("el.r(IIB)I")
    public static int method2534(int arg0, int arg1) {
        int var2 = arg0 >>> 31;
