...
public class class165 {
    ...
    @ObfuscatedName("cg.i(CII)C")
    public static char method1564(char arg0, int arg1) {
    ...
    @ObfuscatedName("ev.h(CI)C")
    public static char method2730(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("aw.u(CII)I")
    public static int method589(char arg0, int arg1) {
        int var2 = arg0 << 4;
