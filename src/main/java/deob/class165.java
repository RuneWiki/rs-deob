...
public class class165 extends RuntimeException {
    ...
    @ObfuscatedName("es.c(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2883(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2179.getCodeBase(), "clienterror.ws?c=" + Statics.field2180 + "&u=" + Statics.field2177 + "&v1=" + Statics.field2801 + "&v2=" + Statics.field2196 + "&e=" + var25);
    ...
    @ObfuscatedName("an.i(Ljava/lang/Throwable;Ljava/lang/String;)Lff;")
    public static class165 method703(Throwable arg0, String arg1) {
        class165 var2;
        if (arg0 instanceof class165) {
            var2 = (class165) arg0;
            var2.field2185 = var2.field2185 + ' ' + arg1;
        } else {
