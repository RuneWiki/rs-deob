...
public class class165 {
    ...
    @ObfuscatedName("cq.d(CII)C")
    public static char method1706(char arg0, int arg1) {
    ...
    @ObfuscatedName("g.q(CI)C")
    public static char method44(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("fp.x(CII)I")
    public static int method2818(char arg0, int arg1) {
        int var2 = arg0 << 4;
