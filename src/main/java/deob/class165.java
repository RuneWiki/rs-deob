...
public class class165 {
    ...
    @ObfuscatedName("ht.i(CII)C")
    public static char method3710(char arg0, int arg1) {
    ...
    @ObfuscatedName("cw.c(CB)C")
    public static char method1469(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("bn.e(CIB)I")
    public static int method1032(char arg0, int arg1) {
        int var2 = arg0 << 4;
