...
public class class58 {
    ...
    @ObfuscatedName("cp.am([BB)[B")
    public byte[] method1080(byte[] arg0) {
        if (this.field409 != null) {
            int var2 = (int) ((long) this.field408 * (long) arg0.length / (long) this.field410) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field408 + var5;
                int var11 = var10 / this.field410;
                var4 += var11;
                var5 = var10 - this.field410 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1084(int arg0) {
        if (this.field409 != null) {
            arg0 = (int) ((long) this.field408 * (long) arg0 / (long) this.field410);
        }
        return arg0;
    }

    @ObfuscatedName("cp.af(II)I")
    public int method1082(int arg0) {
        if (this.field409 != null) {
            arg0 = (int) ((long) this.field408 * (long) arg0 / (long) this.field410) + 6;
        }
        return arg0;
    }
}
