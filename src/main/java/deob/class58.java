...
public class class58 {
    ...
    public class58(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class320.method7650(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field403 = var4;
            this.field404 = var5;
    ...
    @ObfuscatedName("cn.aq([BB)[B")
    public byte[] method1036(byte[] arg0) {
        if (this.field405 != null) {
            int var2 = (int) ((long) this.field404 * (long) arg0.length / (long) this.field403) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field403;
                var4 += var11;
                var5 = var10 - this.field403 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1028(int arg0) {
        if (this.field405 != null) {
            arg0 = (int) ((long) this.field404 * (long) arg0 / (long) this.field403);
        }
        return arg0;
    }

    @ObfuscatedName("cn.al(II)I")
    public int method1029(int arg0) {
        if (this.field405 != null) {
            arg0 = (int) ((long) this.field404 * (long) arg0 / (long) this.field403) + 6;
        }
        return arg0;
    }
}
