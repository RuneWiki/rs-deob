...
public class class58 {
    ...
    public class58(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field413 = var9;
            this.field412 = var10;
            this.field409 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field409[var11];
    ...
    @ObfuscatedName("cd.ak([BB)[B")
    public byte[] method1052(byte[] arg0) {
        if (this.field409 != null) {
            int var2 = (int) ((long) this.field412 * (long) arg0.length / (long) this.field413) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field409[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field412 + var5;
                int var11 = var10 / this.field413;
                var4 += var11;
                var5 = var10 - this.field413 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("cd.al(IB)I")
    public int method1047(int arg0) {
        if (this.field409 != null) {
            arg0 = (int) ((long) this.field412 * (long) arg0 / (long) this.field413);
        }
        return arg0;
    }

    @ObfuscatedName("cd.aj(IB)I")
    public int method1051(int arg0) {
        if (this.field409 != null) {
            arg0 = (int) ((long) this.field412 * (long) arg0 / (long) this.field413) + 6;
        }
        return arg0;
    }
}
