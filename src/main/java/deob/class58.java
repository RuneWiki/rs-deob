...
public class class58 {
    ...
    public class58(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field399 = var9;
            this.field395 = var10;
            this.field397 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field397[var11];
    ...
    @ObfuscatedName("cj.ac([BI)[B")
    public byte[] method1083(byte[] arg0) {
        if (this.field397 != null) {
            int var2 = (int) ((long) this.field395 * (long) arg0.length / (long) this.field399) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field399;
                var4 += var11;
                var5 = var10 - this.field399 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1086(int arg0) {
        if (this.field397 != null) {
            arg0 = (int) ((long) this.field395 * (long) arg0 / (long) this.field399);
        }
        return arg0;
    }

    @ObfuscatedName("cj.ag(II)I")
    public int method1076(int arg0) {
        if (this.field397 != null) {
            arg0 = (int) ((long) this.field395 * (long) arg0 / (long) this.field399) + 6;
        }
        return arg0;
    }
}
