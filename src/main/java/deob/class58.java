...
public class class58 {
    ...
    public class58(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field433 = var9;
            this.field432 = var10;
            this.field435 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field435[var11];
    ...
    @ObfuscatedName("cj.aw([BI)[B")
    public byte[] method1070(byte[] arg0) {
        if (this.field435 != null) {
            int var2 = (int) ((long) this.field432 * (long) arg0.length / (long) this.field433) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field435[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field432 + var5;
                int var11 = var10 / this.field433;
                var4 += var11;
                var5 = var10 - this.field433 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("cj.ay(II)I")
    public int method1063(int arg0) {
        if (this.field435 != null) {
            arg0 = (int) ((long) this.field432 * (long) arg0 / (long) this.field433);
        }
        return arg0;
    }

    @ObfuscatedName("cj.ar(II)I")
    public int method1066(int arg0) {
        if (this.field435 != null) {
            arg0 = (int) ((long) this.field432 * (long) arg0 / (long) this.field433) + 6;
        }
        return arg0;
    }
}
