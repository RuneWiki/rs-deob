...
public class class58 {
    ...
    public class58(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field425 = var9;
            this.field429 = var10;
            this.field427 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field427[var11];
    ...
    @ObfuscatedName("cx.au([BS)[B")
    public byte[] method1067(byte[] arg0) {
        if (this.field427 != null) {
            int var2 = (int) ((long) this.field429 * (long) arg0.length / (long) this.field425) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field427[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field429 + var5;
                int var11 = var10 / this.field425;
                var4 += var11;
                var5 = var10 - this.field425 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("cx.ae(IB)I")
    public int method1068(int arg0) {
        if (this.field427 != null) {
            arg0 = (int) ((long) this.field429 * (long) arg0 / (long) this.field425);
        }
        return arg0;
    }

    @ObfuscatedName("cx.ao(II)I")
    public int method1066(int arg0) {
        if (this.field427 != null) {
            arg0 = (int) ((long) this.field429 * (long) arg0 / (long) this.field425) + 6;
        }
        return arg0;
    }
}
