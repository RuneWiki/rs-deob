...
public class class425 extends RuntimeException {
    ...
    @ObfuscatedName("eo.i(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2652(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
                String var5;
                if (arg1 instanceof class425) {
                    class425 var4 = (class425) arg1;
                    var5 = var4.field4442 + " | ";
                    var3 = var4.field4441;
                } else {
                    var5 = "";
            ...
            if (Statics.field4443 == null) {
                return;
            }
            URL var26 = new URL(Statics.field4443.getCodeBase(), "clienterror.ws?c=" + Statics.field4440 + "&u=" + Statics.field4439 + "&v1=" + Statics.field1544 + "&v2=" + Statics.field3735 + "&ct=" + Statics.field4438 + "&e=" + var25);
    ...
    @ObfuscatedName("ah.w(Ljava/lang/Throwable;Ljava/lang/String;)Lpg;")
    public static class425 method620(Throwable arg0, String arg1) {
        class425 var2;
        if (arg0 instanceof class425) {
            var2 = (class425) arg0;
            var2.field4442 = var2.field4442 + ' ' + arg1;
        } else {
