...
public final class class436 {
    ...
    @ObfuscatedName("nm.s(Ljava/lang/CharSequence;I)I")
    public static int method6179(CharSequence arg0) {
    ...
    @ObfuscatedName("eu.h([BIII)Ljava/lang/String;")
    public static String method2873(byte[] arg0, int arg1, int arg2) {
