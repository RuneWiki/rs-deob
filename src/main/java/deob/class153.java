...
public class class153 extends class142 {
    ...
    @ObfuscatedName("ey.g")
    public static class100 field2345 = new class100(64);

    @ObfuscatedName("ey.q")
    public static class100 field2305 = new class100(500);

    @ObfuscatedName("ey.i")
    public static class100 field2306 = new class100(30);

    @ObfuscatedName("ey.s")
    public static class100 field2307 = new class100(30);

    @ObfuscatedName("ey.u")
    public static class179[] field2308 = new class179[4];
    ...
    public static void method431(class86 arg0, class86 arg1, boolean arg2) {
    ...
    public static class153 method2564(int arg0) {
        class153 var1 = (class153) field2345.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        var3.field2309 = arg0;
        if (var2 != null) {
            var3.method2360(new class135(var2));
        }
        var3.method2361();
        if (var3.field2347) {
            var3.field2342 = 0;
    ...
    public void method2360(class135 arg0) {
        while (true) {
    ...
    public void method2365(class135 arg0, int arg1) {
        if (arg1 == 1) {
            ...
            if (this.field2328[arg1 - 30].equalsIgnoreCase(class74.field869)) {
    ...
    public final class165 method2364(int arg0, int arg1, int[][] arg2, int arg3, int arg4, int arg5) {
        long var7;
        if (this.field2338 == null) {
        ...
        class165 var9 = (class165) field2306.method1244(var7);
        if (var9 == null) {
            class179 var10 = this.method2367(arg0, arg1);
            if (var10 == null) {
                return null;
            }
            if (this.field2323) {
        ...
        if (this.field2323) {
            var9 = ((class179) var9).method2982();
        }
        if (this.field2322 >= 0) {
            if (var9 instanceof class180) {
                var9 = ((class180) var9).method3054(arg2, arg3, arg4, arg5, true, this.field2322);
            } else if (var9 instanceof class179) {
                var9 = ((class179) var9).method2928(arg2, arg3, arg4, arg5, true, this.field2322);
            }
        }
        return var9;
    }
    ...
    public final class180 method2386(int arg0, int arg1, int[][] arg2, int arg3, int arg4, int arg5) {
        long var7;
        if (this.field2338 == null) {
            var7 = (long) ((this.field2309 << 10) + arg1);
        } else {
        ...
        class180 var9 = (class180) field2307.method1244(var7);
        if (var9 == null) {
            class179 var10 = this.method2367(arg0, arg1);
            if (var10 == null) {
                return null;
    ...
    public final class180 method2376(int arg0, int arg1, int[][] arg2, int arg3, int arg4, int arg5, class155 arg6, int arg7) {
        long var9;
        if (this.field2338 == null) {
        ...
        class180 var11 = (class180) field2307.method1244(var9);
        if (var11 == null) {
            class179 var12 = this.method2367(arg0, arg1);
            if (var12 == null) {
                return null;
            }
    ...
    public final class179 method2367(int arg0, int arg1) {
        class179 var3 = null;
        if (this.field2338 == null) {
            if (arg0 != 10) {
                return null;
            ...
            for (int var6 = 0; var6 < var5; var6++) {
                ...
                var3 = (class179) field2305.method1244((long) var7);
                if (var3 == null) {
                    var3 = class179.method2992(Statics.field2303, var7 & 0xFFFF, 0);
                    if (var3 == null) {
                        return null;
                    }
                    if (var4) {
            ...
            if (var5 > 1) {
                var3 = new class179(field2308, var5);
            }
        } else {
            int var8 = -1;
            ...
            var3 = (class179) field2305.method1244((long) var10);
            if (var3 == null) {
                var3 = class179.method2992(Statics.field2303, var10 & 0xFFFF, 0);
                if (var3 == null) {
                    return null;
                }
                if (var11) {
        ...
        class179 var14 = new class179(var3, arg1 == 0 && !var12 && !var13, this.field2313 == null, this.field2315 == null, true);
        if (arg0 == 4 && arg1 > 3) {
    ...
    public final class153 method2368() {
        int var1 = -1;
        if (this.field2331 != -1) {
            var1 = Statics.method1130(this.field2331);
        } else if (this.field2346 != -1) {
            var1 = class89.field1210[this.field2346];
        }
    ...
    public boolean method2374() {
        ...
        for (int var1 = 0; var1 < this.field2317.length; var1++) {
            if (this.field2317[var1] != -1) {
                class153 var2 = method2564(this.field2317[var1]);
