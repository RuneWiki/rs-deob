...
public class class153 {
    ...
    @ObfuscatedName("w.i(CII)C")
    public static char method150(char arg0, int arg1) {
    ...
    @ObfuscatedName("ex.b(CI)C")
    public static char method2781(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("bw.r(CII)I")
    public static int method1585(char arg0, int arg1) {
        int var2 = arg0 << 4;
