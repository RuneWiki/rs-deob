...
public class class153 extends RuntimeException {
    ...
    @ObfuscatedName("h.d(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method158(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2194.getCodeBase(), "clienterror.ws?c=" + Statics.field2192 + "&u=" + Statics.field2190 + "&v1=" + Statics.field2208 + "&v2=" + Statics.field2210 + "&e=" + var25);
    ...
    @ObfuscatedName("cv.q(Ljava/lang/Throwable;Ljava/lang/String;)Let;")
    public static class153 method1752(Throwable arg0, String arg1) {
        class153 var2;
