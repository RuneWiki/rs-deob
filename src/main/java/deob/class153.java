...
public class class153 extends RuntimeException {
    ...
    @ObfuscatedName("ak.e(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method464(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2209.getCodeBase(), "clienterror.ws?c=" + Statics.field2203 + "&u=" + Statics.field2202 + "&v1=" + Statics.field2222 + "&v2=" + Statics.field2220 + "&e=" + var25);
    ...
    @ObfuscatedName("es.o(Ljava/lang/Throwable;Ljava/lang/String;)Len;")
    public static class153 method2675(Throwable arg0, String arg1) {
        class153 var2;
