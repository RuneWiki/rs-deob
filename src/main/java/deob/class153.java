...
public class class153 implements Runnable {
    ...
    @ObfuscatedName("ey.x")
    public final Thread field1960 = new Thread(this);

    @ObfuscatedName("ey.m")
    public volatile boolean field1959;

    @ObfuscatedName("ey.k")
    public Queue field1962 = new LinkedList();

    public class153() {
        this.field1960.setPriority(1);
        this.field1960.start();
    }

    public void run() {
        while (!this.field1959) {
            try {
                class154 var2;
                synchronized (this) {
                ...
                class351.method3842((String) null, var21);
            }
        }
    }

    @ObfuscatedName("ey.x(Ljava/net/URL;B)Lew;")
