...
public class class153 extends RuntimeException {
    ...
    @ObfuscatedName("hd.i(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method3831(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2202.getCodeBase(), "clienterror.ws?c=" + Statics.field2196 + "&u=" + Statics.field2197 + "&v1=" + Statics.field2216 + "&v2=" + Statics.field2214 + "&e=" + var25);
    ...
    @ObfuscatedName("af.h(Ljava/lang/Throwable;Ljava/lang/String;)Lep;")
    public static class153 method237(Throwable arg0, String arg1) {
        class153 var2;
        if (arg0 instanceof class153) {
            var2 = (class153) arg0;
            var2.field2199 = var2.field2199 + ' ' + arg1;
        } else {
