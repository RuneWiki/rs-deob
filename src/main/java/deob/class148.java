...
public class class148 extends RuntimeException {
    ...
    @ObfuscatedName("di.o(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2604(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2216.getCodeBase(), "clienterror.ws?c=" + Statics.field2211 + "&u=" + Statics.field2038 + "&v1=" + Statics.field2084 + "&v2=" + Statics.field1966 + "&e=" + var25);
    ...
    @ObfuscatedName("l.f(Ljava/lang/Throwable;Ljava/lang/String;)Leb;")
    public static class148 method135(Throwable arg0, String arg1) {
        class148 var2;
