...
public class class148 extends RuntimeException {
    ...
    @ObfuscatedName("es.y(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2701(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            if (Statics.field2210 == null) {
                return;
            }
            URL var26 = new URL(Statics.field2210.getCodeBase(), "clienterror.ws?c=" + Statics.field2204 + "&u=" + Statics.field2205 + "&v1=" + Statics.field2074 + "&v2=" + Statics.field2073 + "&e=" + var25);
    ...
    @ObfuscatedName("i.d(Ljava/lang/Throwable;Ljava/lang/String;)Leo;")
    public static class148 method599(Throwable arg0, String arg1) {
        class148 var2;
        if (arg0 instanceof class148) {
            var2 = (class148) arg0;
            var2.field2206 = var2.field2206 + ' ' + arg1;
        } else {
