...
public class class148 extends RuntimeException {
    ...
    @ObfuscatedName("s.j(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method181(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field3159.getCodeBase(), "clienterror.ws?c=" + Statics.field2233 + "&u=" + Statics.field2236 + "&v1=" + Statics.field2092 + "&v2=" + Statics.field2091 + "&e=" + var25);
    ...
    @ObfuscatedName("dw.l(Ljava/lang/Throwable;Ljava/lang/String;)Lew;")
    public static class148 method2583(Throwable arg0, String arg1) {
        class148 var2;
