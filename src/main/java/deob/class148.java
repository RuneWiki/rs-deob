...
public class class148 extends RuntimeException {
    ...
    @ObfuscatedName("eo.d(Ljava/lang/Throwable;Ljava/lang/String;)Lej;")
    public static class148 method2797(Throwable arg0, String arg1) {
        class148 var2;
    ...
    @ObfuscatedName("de.s(Ljava/lang/Throwable;I)Ljava/lang/String;")
    public static String method2262(Throwable arg0) throws IOException {
        String var2;
        if (arg0 instanceof class148) {
