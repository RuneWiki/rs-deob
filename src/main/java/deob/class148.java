...
public class class148 extends RuntimeException {
    ...
    @ObfuscatedName("z.i(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method145(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2207.getCodeBase(), "clienterror.ws?c=" + Statics.field2205 + "&u=" + Statics.field2204 + "&v1=" + Statics.field2091 + "&v2=" + Statics.field2093 + "&e=" + var25);
    ...
    @ObfuscatedName("cz.v(Ljava/lang/Throwable;Ljava/lang/String;)Leo;")
    public static class148 method2039(Throwable arg0, String arg1) {
        class148 var2;
