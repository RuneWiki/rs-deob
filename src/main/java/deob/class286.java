...
public final class class286 extends class283 {
    ...
    public void method4805() {
        if (this.field3792 == this.field3788 && this.field3790 == this.field3786) {
            return;
        }
        byte[] var1 = new byte[this.field3792 * this.field3790];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field3786; var3++) {
            for (int var4 = 0; var4 < this.field3788; var4++) {
                var1[(this.field3793 + var3) * this.field3792 + this.field3789 + var4] = this.field3791[var2++];
            }
        }
        this.field3791 = var1;
    ...
    @ObfuscatedName("jo.s(III)V")
    public void method4784(int arg0, int arg1, int arg2) {
    ...
    public void method4795(int arg0, int arg1) {
        int var3 = this.field3789 + arg0;
        int var4 = this.field3793 + arg1;
        int var5 = Statics.field3769 * var4 + var3;
        int var6 = 0;
        int var7 = this.field3786;
        ...
        if (var8 > 0 && var7 > 0) {
            method4786(Statics.field3773, this.field3791, this.field3787, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("jo.o([I[B[IIIIIII)V")
    public static void method4786(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
    ...
    public void method4809(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (this.field3789 > 0) {
            int var13 = ((this.field3789 << 16) + var11 - 1) / var11;
            arg0 += var13;
            var7 += var11 * var13 - (this.field3789 << 16);
        }
        if (this.field3793 > 0) {
        ...
        method4787(Statics.field3773, this.field3791, this.field3787, var7, var8, var15, var16, arg2, arg3, var11, var12, var5);
    }

    @ObfuscatedName("jo.v([I[B[IIIIIIIIII)V")
    public static void method4787(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11) {
        int var12 = arg3;
