...
public class class202 {
    ...
    @ObfuscatedName("ex.e(CII)C")
    public static char method2636(char arg0, int arg1) {
    ...
    @ObfuscatedName("ec.o(CI)C")
    public static char method2825(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ct.y(CII)I")
    public static int method1810(char arg0, int arg1) {
        int var2 = arg0 << 4;
