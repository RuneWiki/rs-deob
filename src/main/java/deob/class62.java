...
public class class62 {
    ...
    public class62(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1235 = var9;
            this.field1233 = var10;
            this.field1237 = new int[var9][14];
    ...
    @ObfuscatedName("bm.i([BI)[B")
    public byte[] method1332(byte[] arg0) {
        if (this.field1237 != null) {
            int var2 = (int) ((long) this.field1233 * (long) arg0.length / (long) this.field1235) + 14;
    ...
    @ObfuscatedName("bm.v(II)I")
    public int method1334(int arg0) {
        if (this.field1237 != null) {
            arg0 = (int) ((long) this.field1233 * (long) arg0 / (long) this.field1235);
        }
        return arg0;
    }

    @ObfuscatedName("bm.m(II)I")
    public int method1337(int arg0) {
        if (this.field1237 != null) {
            arg0 = (int) ((long) this.field1233 * (long) arg0 / (long) this.field1235) + 6;
        }
        return arg0;
    }
}
