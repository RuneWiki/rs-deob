...
public class class62 {
    ...
    public class62(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1218 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1218[var11];
    ...
    @ObfuscatedName("bg.y([BI)[B")
    public byte[] method1316(byte[] arg0) {
        if (this.field1218 != null) {
            int var2 = (int) ((long) this.field1217 * (long) arg0.length / (long) this.field1216) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1218[var5];
    ...
    public int method1317(int arg0) {
        if (this.field1218 != null) {
            arg0 = (int) ((long) this.field1217 * (long) arg0 / (long) this.field1216);
        }
        return arg0;
    }
    ...
    public int method1318(int arg0) {
        if (this.field1218 != null) {
            arg0 = (int) ((long) this.field1217 * (long) arg0 / (long) this.field1216) + 6;
        }
        return arg0;
    }
}
