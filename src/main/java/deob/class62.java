...
public class class62 {
    ...
    @ObfuscatedName("bw.t([BI)[B")
    public byte[] method1321(byte[] arg0) {
        if (this.field1266 != null) {
            int var2 = (int) ((long) this.field1265 * (long) arg0.length / (long) this.field1262) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1262;
                var4 += var11;
                var5 = var10 - this.field1262 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1322(int arg0) {
        if (this.field1266 != null) {
            arg0 = (int) ((long) this.field1265 * (long) arg0 / (long) this.field1262);
        }
        return arg0;
    }
    ...
    public int method1336(int arg0) {
        if (this.field1266 != null) {
            arg0 = (int) ((long) this.field1265 * (long) arg0 / (long) this.field1262) + 6;
        }
        return arg0;
    }
}
