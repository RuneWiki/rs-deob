...
public class class62 {
    ...
    public class62(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1217 = new int[var9][14];
    ...
    @ObfuscatedName("br.q([BI)[B")
    public byte[] method1330(byte[] arg0) {
        if (this.field1217 != null) {
            int var2 = (int) ((long) this.field1215 * (long) arg0.length / (long) this.field1220) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1217[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1215 + var5;
                int var11 = var10 / this.field1220;
                var4 += var11;
                var5 = var10 - this.field1220 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1332(int arg0) {
        if (this.field1217 != null) {
            arg0 = (int) ((long) this.field1215 * (long) arg0 / (long) this.field1220);
        }
        return arg0;
    }

    @ObfuscatedName("br.p(II)I")
    public int method1333(int arg0) {
        if (this.field1217 != null) {
            arg0 = (int) ((long) this.field1215 * (long) arg0 / (long) this.field1220) + 6;
        }
        return arg0;
    }
}
