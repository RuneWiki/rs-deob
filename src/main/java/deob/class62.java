...
public class class62 {
    ...
    @ObfuscatedName("by.c([BI)[B")
    public byte[] method1263(byte[] arg0) {
        if (this.field1247 != null) {
            int var2 = (int) ((long) this.field1243 * (long) arg0.length / (long) this.field1245) + 14;
    ...
    public int method1266(int arg0) {
        if (this.field1247 != null) {
            arg0 = (int) ((long) this.field1243 * (long) arg0 / (long) this.field1245);
        }
        return arg0;
    }

    @ObfuscatedName("by.y(II)I")
    public int method1264(int arg0) {
        if (this.field1247 != null) {
            arg0 = (int) ((long) this.field1243 * (long) arg0 / (long) this.field1245) + 6;
        }
        return arg0;
    }
}
