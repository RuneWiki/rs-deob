...
public class class62 {
    ...
    public class62(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1209 = var9;
            this.field1214 = var10;
            this.field1208 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1208[var11];
    ...
    @ObfuscatedName("bx.a([BI)[B")
    public byte[] method1243(byte[] arg0) {
        if (this.field1208 != null) {
            int var2 = (int) ((long) this.field1214 * (long) arg0.length / (long) this.field1209) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1208[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1214 + var5;
                int var11 = var10 / this.field1209;
                var4 += var11;
                var5 = var10 - this.field1209 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bx.r(II)I")
    public int method1244(int arg0) {
        if (this.field1208 != null) {
            arg0 = (int) ((long) this.field1214 * (long) arg0 / (long) this.field1209);
        }
        return arg0;
    }

    @ObfuscatedName("bx.u(II)I")
    public int method1245(int arg0) {
        if (this.field1208 != null) {
            arg0 = (int) ((long) this.field1214 * (long) arg0 / (long) this.field1209) + 6;
        }
        return arg0;
    }
}
