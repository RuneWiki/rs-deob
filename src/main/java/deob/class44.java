...
public class class44 {
    ...
    @ObfuscatedName("ap.j(IIILiu;B)V")
    public void method559(int arg0, int arg1, int arg2, class248 arg3) {
        if (arg3 == null || arg0 + arg2 < 0 || arg1 + arg2 < 0 || arg0 - arg2 > this.field575 || arg1 - arg2 > this.field576) {
            return;
        }
        int var5 = Math.max(0, arg0 - arg2);
        int var6 = Math.min(this.field575, arg0 + arg2);
        int var7 = Math.max(0, arg1 - arg2);
        int var8 = Math.min(this.field576, arg1 + arg2);
        for (int var9 = var5; var9 < var6; var9++) {
            for (int var10 = var7; var10 < var8; var10++) {
                this.field577[var9][var10] += arg3.field3333 * 256 / arg3.field3334;
                this.field585[var9][var10] += arg3.field3328;
                this.field582[var9][var10] += arg3.field3332;
    ...
    public int method556(int arg0, int arg1) {
        if (arg0 < 0 || arg1 < 0 || arg0 >= this.field575 || arg1 >= this.field576) {
            return 0;
        } else if (this.field582[arg0][arg1] == 0) {
            return 0;
        } else {
            int var3 = this.field577[arg0][arg1] / this.field580[arg0][arg1];
            int var4 = this.field585[arg0][arg1] / this.field580[arg0][arg1];
