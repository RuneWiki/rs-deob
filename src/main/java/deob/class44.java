...
public class class44 {
    ...
    public class44(int arg0, int arg1) {
        this.field544 = arg0;
        this.field540 = arg1;
        this.field541 = new int[arg0][arg1];
        this.field542 = new int[arg0][arg1];
        this.field543 = new int[arg0][arg1];
        this.field539 = new int[arg0][arg1];
    }

    @ObfuscatedName("af.d(IIILiy;B)V")
    public void method546(int arg0, int arg1, int arg2, class247 arg3) {
        if (arg3 == null || arg0 + arg2 < 0 || arg1 + arg2 < 0 || arg0 - arg2 > this.field544 || arg1 - arg2 > this.field540) {
            return;
        }
        int var5 = Math.max(0, arg0 - arg2);
        int var6 = Math.min(this.field544, arg0 + arg2);
        int var7 = Math.max(0, arg1 - arg2);
        int var8 = Math.min(this.field540, arg1 + arg2);
        for (int var9 = var5; var9 < var6; var9++) {
            for (int var10 = var7; var10 < var8; var10++) {
                this.field541[var9][var10] += arg3.field3325 * 256 / arg3.field3323;
                this.field542[var9][var10] += arg3.field3326;
                this.field543[var9][var10] += arg3.field3327;
                int var10002 = this.field539[var9][var10]++;
            }
        }
    }
    ...
    public int method537(int arg0, int arg1) {
        if (arg0 < 0 || arg1 < 0 || arg0 >= this.field544 || arg1 >= this.field540) {
            return 0;
        } else if (this.field543[arg0][arg1] == 0) {
            return 0;
        } else {
            int var3 = this.field541[arg0][arg1] / this.field539[arg0][arg1];
            int var4 = this.field542[arg0][arg1] / this.field539[arg0][arg1];
            int var5 = this.field543[arg0][arg1] / this.field539[arg0][arg1];
