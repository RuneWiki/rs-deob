...
public final class class187 {
    ...
    @ObfuscatedName("i.k(Ljava/lang/CharSequence;S)I")
    public static int method458(CharSequence arg0) {
    ...
    @ObfuscatedName("dn.r([BIII)Ljava/lang/String;")
    public static String method2364(byte[] arg0, int arg1, int arg2) {
