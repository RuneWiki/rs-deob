...
public class class53 {
    ...
    public class53(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field398 = var9;
            this.field401 = var10;
            this.field400 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field400[var11];
    ...
    @ObfuscatedName("be.c([BI)[B")
    public byte[] method950(byte[] arg0) {
        if (this.field400 != null) {
            int var2 = (int) ((long) this.field401 * (long) arg0.length / (long) this.field398) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field400[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field401 + var5;
                int var11 = var10 / this.field398;
                var4 += var11;
                var5 = var10 - this.field398 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method936(int arg0) {
        if (this.field400 != null) {
            arg0 = (int) ((long) this.field401 * (long) arg0 / (long) this.field398);
        }
        return arg0;
    }

    @ObfuscatedName("be.q(IB)I")
    public int method943(int arg0) {
        if (this.field400 != null) {
            arg0 = (int) ((long) this.field401 * (long) arg0 / (long) this.field398) + 6;
        }
        return arg0;
    }
}
