...
public final class class53 {
    ...
    @ObfuscatedName("fk.h(Ljava/lang/CharSequence;I)I")
    public static int method3225(CharSequence arg0) {
    ...
    @ObfuscatedName("aa.v([BIII)Ljava/lang/String;")
    public static String method533(byte[] arg0, int arg1, int arg2) {
