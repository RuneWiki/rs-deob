...
public class class53 {
    ...
    public class53(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field413 = var9;
            this.field416 = var10;
            this.field415 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field415[var11];
    ...
    @ObfuscatedName("bg.c([BI)[B")
    public byte[] method1034(byte[] arg0) {
        if (this.field415 != null) {
            int var2 = (int) ((long) this.field416 * (long) arg0.length / (long) this.field413) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field415[var5];
    ...
    @ObfuscatedName("bg.p(IS)I")
    public int method1025(int arg0) {
        if (this.field415 != null) {
            arg0 = (int) ((long) this.field416 * (long) arg0 / (long) this.field413);
        }
        return arg0;
    }
    ...
    public int method1032(int arg0) {
        if (this.field415 != null) {
            arg0 = (int) ((long) this.field416 * (long) arg0 / (long) this.field413) + 6;
        }
        return arg0;
    }
}
