...
public class class53 {
    ...
    public class53(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field411 = var9;
            this.field412 = var10;
            this.field414 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field414[var11];
    ...
    public byte[] method973(byte[] arg0) {
        if (this.field414 != null) {
            int var2 = (int) ((long) this.field412 * (long) arg0.length / (long) this.field411) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field414[var5];
    ...
    @ObfuscatedName("be.l(IB)I")
    public int method971(int arg0) {
        if (this.field414 != null) {
            arg0 = (int) ((long) this.field412 * (long) arg0 / (long) this.field411);
        }
        return arg0;
    }

    @ObfuscatedName("be.s(II)I")
    public int method970(int arg0) {
        if (this.field414 != null) {
            arg0 = (int) ((long) this.field412 * (long) arg0 / (long) this.field411) + 6;
        }
        return arg0;
    }
}
