...
public final class class76 extends class78 implements ImageProducer, ImageObserver {
    ...
    @ObfuscatedName("bv.i(IILjava/awt/Component;B)V")
    ...
    @ObfuscatedName("bv.r(Ljava/awt/Graphics;IIIII)V")
    public final void method1529(Graphics arg0, int arg1, int arg2, int arg3, int arg4) {
        this.method1534(arg1, arg2, arg3, arg4);
    ...
    public synchronized void addConsumer(ImageConsumer arg0) {
        this.field1377 = arg0;
        arg0.setDimensions(this.field1394, this.field1395);
    ...
    public synchronized void method1532() {
        if (this.field1377 != null) {
            this.field1377.setPixels(0, 0, this.field1394, this.field1395, this.field1380, this.field1401, 0, this.field1394);
            this.field1377.imageComplete(2);
        }
    }

    @ObfuscatedName("bv.x(IIIII)V")
    public synchronized void method1534(int arg0, int arg1, int arg2, int arg3) {
        if (this.field1377 != null) {
            this.field1377.setPixels(arg0, arg1, arg2, arg3, this.field1380, this.field1401, this.field1394 * arg1 + arg0, this.field1394);
            this.field1377.imageComplete(2);
        }
    }
