...
public final class class180 {
    ...
    @ObfuscatedName("cm.f(Ljava/lang/CharSequence;B)I")
    public static int method2140(CharSequence arg0) {
    ...
    @ObfuscatedName("cg.t([BIIB)Ljava/lang/String;")
    public static String method2051(byte[] arg0, int arg1, int arg2) {
