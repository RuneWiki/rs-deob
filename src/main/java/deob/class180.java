...
public final class class180 {
    ...
    @ObfuscatedName("y.y(Ljava/lang/CharSequence;B)I")
    public static int method5(CharSequence arg0) {
    ...
    @ObfuscatedName("d.m([BIII)Ljava/lang/String;")
    public static String method24(byte[] arg0, int arg1, int arg2) {
