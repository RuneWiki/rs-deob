...
public final class class180 {
    ...
    @ObfuscatedName("et.j(Ljava/lang/CharSequence;I)I")
    public static int method2845(CharSequence arg0) {
    ...
    @ObfuscatedName("b.f([BIIB)Ljava/lang/String;")
    public static String method121(byte[] arg0, int arg1, int arg2) {
