...
public class class167 {
        ...
        for (int var5 = 0; var5 < var2; var5++) {
            ...
            if (var6 != 0) {
                ...
                for (int var15 = 0; var15 < var6; var15++) {
                    ...
                    if (var14 >= this.field2329.length) {
    ...
    @ObfuscatedName("fg.j([BII[BII)I")
    public int method2827(byte[] arg0, int arg1, int arg2, byte[] arg3, int arg4) {
        int var6 = 0;
        int var7 = arg4 << 3;
        int var8 = arg1 + arg2;
        while (arg1 < var8) {
            int var9 = arg0[arg1] & 0xFF;
            int var10 = this.field2327[var9];
            byte var11 = this.field2325[var9];
            if (var11 == 0) {
    ...
    @ObfuscatedName("fg.h([BI[BIIB)I")
    public int method2828(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg4 == 0) {
            return 0;
        }
        int var6 = 0;
        ...
        while (true) {
            byte var9 = arg0[var8];
            if (var9 < 0) {
                var6 = this.field2329[var6];
            } else {
                var6++;
            }
            int var10;
            if ((var10 = this.field2329[var6]) < 0) {
            ...
            int var11;
            if ((var11 = this.field2329[var6]) < 0) {
            ...
            int var12;
            if ((var12 = this.field2329[var6]) < 0) {
            ...
            int var13;
            if ((var13 = this.field2329[var6]) < 0) {
            ...
            int var14;
            if ((var14 = this.field2329[var6]) < 0) {
            ...
            int var15;
            if ((var15 = this.field2329[var6]) < 0) {
            ...
            int var16;
            if ((var16 = this.field2329[var6]) < 0) {
            ...
            int var17;
            if ((var17 = this.field2329[var6]) < 0) {
