...
public class class157 {
    ...
    @ObfuscatedName("er.n(CII)C")
    public static char method2838(char arg0, int arg1) {
    ...
    @ObfuscatedName("ck.o(CI)C")
    public static char method1966(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("be.a(CII)I")
    public static int method1504(char arg0, int arg1) {
        int var2 = arg0 << 4;
