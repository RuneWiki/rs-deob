...
public final class class493 {
    ...
    @ObfuscatedName("df.at([BILjava/lang/CharSequence;I)I")
    public static int method2144(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("oj.an([BIIB)Ljava/lang/String;")
    public static String method6277(byte[] arg0, int arg1, int arg2) {
