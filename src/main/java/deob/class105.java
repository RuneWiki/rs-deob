...
public class class105 {
    ...
    public class105(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1400 = var9;
            this.field1398 = var10;
            this.field1402 = new int[var9][14];
    ...
    @ObfuscatedName("dt.v([BI)[B")
    public byte[] method2121(byte[] arg0) {
        if (this.field1402 != null) {
            int var2 = (int) ((long) this.field1398 * (long) arg0.length / (long) this.field1400) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1402[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1398 + var5;
                int var11 = var10 / this.field1400;
                var4 += var11;
                var5 = var10 - this.field1400 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method2126(int arg0) {
        if (this.field1402 != null) {
            arg0 = (int) ((long) this.field1398 * (long) arg0 / (long) this.field1400);
        }
        return arg0;
    }

    @ObfuscatedName("dt.o(II)I")
    public int method2122(int arg0) {
        if (this.field1402 != null) {
            arg0 = (int) ((long) this.field1398 * (long) arg0 / (long) this.field1400) + 6;
        }
        return arg0;
    }
}
