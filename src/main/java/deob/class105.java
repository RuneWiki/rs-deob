...
public class class105 {
    ...
    public class105(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1411 = var9;
            this.field1414 = var10;
            this.field1413 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1413[var11];
    ...
    @ObfuscatedName("di.c([BI)[B")
    public byte[] method2069(byte[] arg0) {
        if (this.field1413 != null) {
            int var2 = (int) ((long) this.field1414 * (long) arg0.length / (long) this.field1411) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1414 + var5;
                int var11 = var10 / this.field1411;
                var4 += var11;
                var5 = var10 - this.field1411 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method2070(int arg0) {
        if (this.field1413 != null) {
            arg0 = (int) ((long) this.field1414 * (long) arg0 / (long) this.field1411);
        }
        return arg0;
    }

    @ObfuscatedName("di.m(IB)I")
    public int method2071(int arg0) {
        if (this.field1413 != null) {
            arg0 = (int) ((long) this.field1414 * (long) arg0 / (long) this.field1411) + 6;
        }
        return arg0;
    }
}
