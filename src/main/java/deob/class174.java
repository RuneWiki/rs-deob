...
public final class class174 extends class165 {
    ...
    public class174(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        int var12 = class156.method1133(this.field2568).field2390;
        if (var12 == -1) {
            this.field2588 = null;
        } else {
            this.field2588 = class155.method104(var12);
        }
    }
    ...
    public final class180 method2643() {
        class156 var1 = class156.method1133(this.field2568);
        class180 var2 = var1.method2455(this.field2589);
        if (var2 == null) {
            return null;
        } else {
