...
public class class174 {
    ...
    @ObfuscatedName("hg.w(CII)C")
    public static char method4078(char arg0, int arg1) {
    ...
    @ObfuscatedName("bz.m(CI)C")
    public static char method1721(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("im.q(CII)I")
    public static int method4227(char arg0, int arg1) {
        int var2 = arg0 << 4;
