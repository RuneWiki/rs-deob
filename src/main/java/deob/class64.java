...
public class class64 {
    ...
    @ObfuscatedName("bc.w(F)F")
    public static float method1317(float arg0) {
    ...
    public float method1323(int arg0, int arg1, float arg2) {
        ...
        return method1317(var5);
    }

    @ObfuscatedName("bc.e(IF)I")
    public int method1318(int arg0, float arg1) {
        if (arg0 == 0) {
            ...
            Statics.field1245 = (float) Math.pow(0.1D, (double) (var4 / 20.0F));
            Statics.field1251 = (int) (Statics.field1245 * 65536.0F);
        }
        if (this.field1244[arg0] == 0) {
            return 0;
        }
        float var5 = this.method1316(arg0, 0, arg1);
        field1248[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1323(arg0, 0, arg1));
        field1248[arg0][1] = var5 * var5;
        for (int var6 = 1; var6 < this.field1244[arg0]; var6++) {
            float var7 = this.method1316(arg0, var6, arg1);
            float var8 = var7 * -2.0F * (float) Math.cos((double) this.method1323(arg0, var6, arg1));
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1244[0] * 2; var11++) {
                field1248[0][var11] *= Statics.field1245;
            }
        }
        for (int var12 = 0; var12 < this.field1244[arg0] * 2; var12++) {
            field1243[arg0][var12] = (int) (field1248[arg0][var12] * 65536.0F);
        }
        return this.field1244[arg0] * 2;
    }

    @ObfuscatedName("bc.t(Ldz;Lbj;)V")
    public final void method1319(class127 arg0, class56 arg1) {
        ...
        this.field1247[0] = arg0.method2615();
        this.field1247[1] = arg0.method2615();
        int var4 = arg0.method2472();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1244[var5]; var6++) {
                this.field1249[var5][0][var6] = arg0.method2615();
                this.field1246[var5][0][var6] = arg0.method2615();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1244[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1249[var7][1][var8] = arg0.method2615();
                    this.field1246[var7][1][var8] = arg0.method2615();
                }
            }
        }
