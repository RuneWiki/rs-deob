...
public class class64 {
    ...
    public float method1269(int arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("bs.q(F)F")
    public static float method1268(float arg0) {
        float var1 = 32.703197F * (float) Math.pow(2.0D, (double) arg0);
        return var1 * 3.1415927F / 11025.0F;
    }

    @ObfuscatedName("bs.c(IIF)F")
    public float method1271(int arg0, int arg1, float arg2) {
        float var4 = (float) (this.field1231[arg0][1][arg1] - this.field1231[arg0][0][arg1]) * arg2 + (float) this.field1231[arg0][0][arg1];
        float var5 = var4 * 1.2207031E-4F;
        return method1268(var5);
    }

    @ObfuscatedName("bs.l(IF)I")
    public int method1272(int arg0, float arg1) {
        if (arg0 == 0) {
            ...
            Statics.field1236 = (int) (Statics.field1230 * 65536.0F);
        }
        if (this.field1233[arg0] == 0) {
            return 0;
        }
        float var5 = this.method1269(arg0, 0, arg1);
        field1237[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1271(arg0, 0, arg1));
        field1237[arg0][1] = var5 * var5;
        for (int var6 = 1; var6 < this.field1233[arg0]; var6++) {
            float var7 = this.method1269(arg0, var6, arg1);
            float var8 = var7 * -2.0F * (float) Math.cos((double) this.method1271(arg0, var6, arg1));
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1233[0] * 2; var11++) {
                field1237[0][var11] *= Statics.field1230;
            }
        }
        for (int var12 = 0; var12 < this.field1233[arg0] * 2; var12++) {
            field1234[arg0][var12] = (int) (field1237[arg0][var12] * 65536.0F);
        }
        return this.field1233[arg0] * 2;
    }

    @ObfuscatedName("bs.r(Ldc;Lbc;)V")
    public final void method1273(class119 arg0, class58 arg1) {
        ...
        this.field1232[0] = arg0.method2430();
        this.field1232[1] = arg0.method2430();
        int var4 = arg0.method2360();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1233[var5]; var6++) {
                this.field1231[var5][0][var6] = arg0.method2430();
                this.field1235[var5][0][var6] = arg0.method2430();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1233[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1231[var7][1][var8] = arg0.method2430();
                    this.field1235[var7][1][var8] = arg0.method2430();
                }
            }
        }
        if (var4 != 0 || this.field1232[1] != this.field1232[0]) {
            arg1.method1209(arg0);
        }
    }
}
