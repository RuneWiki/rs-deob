...
public class class64 {
    ...
    @ObfuscatedName("bs.o(IF)I")
    public int method1351(int arg0, float arg1) {
        if (arg0 == 0) {
            ...
            Statics.field1253 = (int) (Statics.field1249 * 65536.0F);
        }
        if (this.field1248[arg0] == 0) {
            return 0;
        }
        float var5 = this.method1340(arg0, 0, arg1);
        field1247[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1342(arg0, 0, arg1));
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1248[0] * 2; var11++) {
                field1247[0][var11] *= Statics.field1249;
            }
        }
    ...
    @ObfuscatedName("bs.p(Ldw;Lbq;)V")
    public final void method1347(class127 arg0, class56 arg1) {
        ...
        this.field1245[0] = arg0.method2501();
        this.field1245[1] = arg0.method2501();
        int var4 = arg0.method2499();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1248[var5]; var6++) {
                this.field1251[var5][0][var6] = arg0.method2501();
                this.field1252[var5][0][var6] = arg0.method2501();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1248[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1251[var7][1][var8] = arg0.method2501();
                    this.field1252[var7][1][var8] = arg0.method2501();
                }
            }
        }
        if (var4 != 0 || this.field1245[1] != this.field1245[0]) {
            arg1.method1261(arg0);
        }
    }
}
