...
public class class64 {
    ...
    @ObfuscatedName("bh.w(IIF)F")
    public float method1260(int arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("bh.x(F)F")
    public static float method1261(float arg0) {
        float var1 = 32.703197F * (float) Math.pow(2.0D, (double) arg0);
        return var1 * 3.1415927F / 11025.0F;
    }

    @ObfuscatedName("bh.t(IIF)F")
    ...
    public int method1263(int arg0, float arg1) {
        if (arg0 == 0) {
            ...
            Statics.field1249 = (float) Math.pow(0.1D, (double) (var4 / 20.0F));
            Statics.field1250 = (int) (Statics.field1249 * 65536.0F);
        }
        if (this.field1243[arg0] == 0) {
            return 0;
        }
        float var5 = this.method1260(arg0, 0, arg1);
        field1253[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1262(arg0, 0, arg1));
        field1253[arg0][1] = var5 * var5;
        for (int var6 = 1; var6 < this.field1243[arg0]; var6++) {
            float var7 = this.method1260(arg0, var6, arg1);
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1243[0] * 2; var11++) {
                field1253[0][var11] *= Statics.field1249;
            }
        }
        for (int var12 = 0; var12 < this.field1243[arg0] * 2; var12++) {
            field1248[arg0][var12] = (int) (field1253[arg0][var12] * 65536.0F);
        }
        return this.field1243[arg0] * 2;
    }

    @ObfuscatedName("bh.e(Lde;Lbn;)V")
    public final void method1269(class120 arg0, class58 arg1) {
        int var3 = arg0.method2363();
        this.field1243[0] = var3 >> 4;
        this.field1243[1] = var3 & 0xF;
        if (var3 == 0) {
        ...
        this.field1246[0] = arg0.method2365();
        this.field1246[1] = arg0.method2365();
        int var4 = arg0.method2363();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1243[var5]; var6++) {
                this.field1244[var5][0][var6] = arg0.method2365();
                this.field1247[var5][0][var6] = arg0.method2365();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1243[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    this.field1244[var7][1][var8] = this.field1244[var7][0][var8];
                    this.field1247[var7][1][var8] = this.field1247[var7][0][var8];
                } else {
                    this.field1244[var7][1][var8] = arg0.method2365();
                    this.field1247[var7][1][var8] = arg0.method2365();
                }
            }
        }
