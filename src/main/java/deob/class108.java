...
public class class108 {
    ...
    public void method2209(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        if (arg2 == 0) {
            if (arg3 == 0) {
                this.method2229(var6, var7, 128);
                this.method2229(var6 - 1, var7, 8);
            }
            if (arg3 == 1) {
                this.method2229(var6, var7, 2);
                this.method2229(var6, var7 + 1, 32);
            }
            if (arg3 == 2) {
                this.method2229(var6, var7, 8);
                this.method2229(var6 + 1, var7, 128);
            }
            if (arg3 == 3) {
                this.method2229(var6, var7, 32);
                this.method2229(var6, var7 - 1, 2);
            }
        }
        if (arg2 == 1 || arg2 == 3) {
            if (arg3 == 0) {
                this.method2229(var6, var7, 1);
                this.method2229(var6 - 1, var7 + 1, 16);
            }
            if (arg3 == 1) {
                this.method2229(var6, var7, 4);
                this.method2229(var6 + 1, var7 + 1, 64);
            }
            if (arg3 == 2) {
                this.method2229(var6, var7, 16);
                this.method2229(var6 + 1, var7 - 1, 1);
            }
            if (arg3 == 3) {
                this.method2229(var6, var7, 64);
                this.method2229(var6 - 1, var7 - 1, 4);
            }
        }
        if (arg2 == 2) {
            if (arg3 == 0) {
                this.method2229(var6, var7, 130);
                this.method2229(var6 - 1, var7, 8);
                this.method2229(var6, var7 + 1, 32);
            }
            if (arg3 == 1) {
                this.method2229(var6, var7, 10);
                this.method2229(var6, var7 + 1, 32);
                this.method2229(var6 + 1, var7, 128);
            }
            if (arg3 == 2) {
                this.method2229(var6, var7, 40);
                this.method2229(var6 + 1, var7, 128);
                this.method2229(var6, var7 - 1, 2);
            }
            if (arg3 == 3) {
                this.method2229(var6, var7, 160);
                this.method2229(var6, var7 - 1, 2);
                this.method2229(var6 - 1, var7, 8);
            }
        }
        ...
        if (arg2 == 0) {
            if (arg3 == 0) {
                this.method2229(var6, var7, 65536);
                this.method2229(var6 - 1, var7, 4096);
            }
            if (arg3 == 1) {
                this.method2229(var6, var7, 1024);
                this.method2229(var6, var7 + 1, 16384);
            }
            if (arg3 == 2) {
                this.method2229(var6, var7, 4096);
                this.method2229(var6 + 1, var7, 65536);
            }
            if (arg3 == 3) {
                this.method2229(var6, var7, 16384);
                this.method2229(var6, var7 - 1, 1024);
            }
        }
        if (arg2 == 1 || arg2 == 3) {
            if (arg3 == 0) {
                this.method2229(var6, var7, 512);
                this.method2229(var6 - 1, var7 + 1, 8192);
            }
            if (arg3 == 1) {
                this.method2229(var6, var7, 2048);
                this.method2229(var6 + 1, var7 + 1, 32768);
            }
            if (arg3 == 2) {
                this.method2229(var6, var7, 8192);
                this.method2229(var6 + 1, var7 - 1, 512);
            }
            if (arg3 == 3) {
                this.method2229(var6, var7, 32768);
                this.method2229(var6 - 1, var7 - 1, 2048);
            }
        }
        if (arg2 != 2) {
            return;
        ...
        if (arg3 == 0) {
            this.method2229(var6, var7, 66560);
            this.method2229(var6 - 1, var7, 4096);
            this.method2229(var6, var7 + 1, 16384);
        }
        if (arg3 == 1) {
            this.method2229(var6, var7, 5120);
            this.method2229(var6, var7 + 1, 16384);
            this.method2229(var6 + 1, var7, 65536);
        }
        if (arg3 == 2) {
            this.method2229(var6, var7, 20480);
            this.method2229(var6 + 1, var7, 65536);
            this.method2229(var6, var7 - 1, 1024);
        }
        if (arg3 == 3) {
            this.method2229(var6, var7, 81920);
            this.method2229(var6, var7 - 1, 1024);
            this.method2229(var6 - 1, var7, 4096);
        }
    }

    @ObfuscatedName("du.g(IIIIZI)V")
            ...
            if (var9 >= 0 && var9 < this.field1890) {
                for (int var10 = var8; var10 < arg3 + var8; var10++) {
                    if (var10 >= 0 && var10 < this.field1891) {
                        this.method2229(var9, var10, var6);
                    }
                }
            }
        }
    ...
    @ObfuscatedName("du.w(IIB)V")
    public void method2207(int arg0, int arg1) {
        int var3 = arg0 - this.field1888;
        int var4 = arg1 - this.field1889;
        this.field1892[var3][var4] |= 0x200000;
    }

    @ObfuscatedName("du.e(III)V")
    ...
    @ObfuscatedName("du.c(IIII)V")
    public void method2229(int arg0, int arg1, int arg2) {
        this.field1892[arg0][arg1] |= arg2;
    }

    @ObfuscatedName("du.a(IIIIZB)V")
    public void method2214(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        int var6 = arg0 - this.field1888;
        int var7 = arg1 - this.field1889;
        if (arg2 == 0) {
            if (arg3 == 0) {
    ...
    @ObfuscatedName("du.q(IIIIIZB)V")
    public void method2215(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        int var7 = 256;
        if (arg5) {
            var7 += 131072;
        }
