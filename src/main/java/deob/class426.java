...
public class class426 {
    ...
    public class426(float[] arg0, int arg1) {
        this.field4711 = arg0;
        this.field4712 = arg1;
    }

    @ObfuscatedName("hv.ak([FIFZFZ[FB)I")
    public static int method3500(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class130.field1542;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class426 var16 = new class426(var10, arg1);
            ...
            int var20 = method3500(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method5448(var10, arg1, arg2);
                ...
                var22 = method5448(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    float var30 = var26;
                    float var31 = var24;
                    float var32 = method5448(var16.field4711, var16.field4712, var26);
                    float var33;
                    if (Math.abs(var32) < class130.field1542) {
                        var33 = var26;
                    } else {
                        float var34 = method5448(var16.field4711, var16.field4712, var24);
                        if (Math.abs(var34) < class130.field1542) {
                            var33 = var24;
                        } else {
                            float var35 = 0.0F;
                            float var36 = 0.0F;
                            ...
                            do {
                                ...
                                float var42 = class130.field1543 * Math.abs(var31) + 0.0F;
                                ...
                                if (var44) {
                                    ...
                                    var34 = method5448(var16.field4711, var16.field4712, var31);
    ...
    @ObfuscatedName("ls.al([FIFI)F")
    public static float method5448(float[] arg0, int arg1, float arg2) {
