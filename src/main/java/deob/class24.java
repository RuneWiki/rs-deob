...
public class class24 {
    ...
    @ObfuscatedName("h.r")
    public int field319 = class130.method1561(16);

    @ObfuscatedName("h.d")
    public int field317 = class130.method1561(24);

    @ObfuscatedName("h.l")
    public int field320 = class130.method1561(24);

    @ObfuscatedName("h.m")
    public int field318 = class130.method1561(24) + 1;

    @ObfuscatedName("h.c")
    public int field316 = class130.method1561(6) + 1;

    @ObfuscatedName("h.n")
    public int field321 = class130.method1561(8);
    ...
    public class24() {
        ...
        for (int var2 = 0; var2 < this.field316; var2++) {
            int var3 = 0;
            int var4 = class130.method1561(3);
            boolean var5 = class130.method1553() != 0;
            if (var5) {
                var3 = class130.method1561(5);
            }
            var1[var2] = var3 << 3 | var4;
        }
        this.field322 = new int[this.field316 * 8];
        for (int var6 = 0; var6 < this.field316 * 8; var6++) {
            this.field322[var6] = (var1[var6 >> 3] & 0x1 << (var6 & 0x7)) == 0 ? -1 : class130.method1561(8);
        }
    }
            ...
            while (var10 < var7) {
                ...
                for (int var13 = 0; var13 < var5; var13++) {
                    ...
                    if (var15 >= 0) {
                        ...
                        class25 var17 = Statics.field1658[var15];
                        if (this.field319 == 0) {
