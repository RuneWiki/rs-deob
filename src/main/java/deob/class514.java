...
public abstract class class514 {
    ...
    public class514(int arg0, int arg1) {
        this.field5140 = arg0;
        this.field5141 = 0;
        this.field5143 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field5142 = method6354(this.field5141, this.field5140, this.field5143);
    }

    @ObfuscatedName("tf.aj(I)V")
    public void method8271() {
        if (this.field5141 < this.field5140) {
            this.field5141++;
            this.field5142 = method6354(this.field5141, this.field5140, this.field5143);
        }
    }

    @ObfuscatedName("tf.as(B)D")
    public double method8272() {
        return this.field5142;
    }

    @ObfuscatedName("nj.aw(IIII)D")
    public static double method6354(int arg0, int arg1, int arg2) {
