...
public class class113 {
    ...
    public static int method1621(int arg0) {
    ...
    @ObfuscatedName("br.h(IB)I")
    public static int method1324(int arg0) {
        int var1 = 0;
