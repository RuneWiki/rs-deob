...
public class class113 {
    ...
    @ObfuscatedName("ad.r(IB)I")
    public static int method841(int arg0) {
    ...
    @ObfuscatedName("l.y(II)I")
    public static int method450(int arg0) {
        int var1 = 0;
    ...
    @ObfuscatedName("j.m(III)I")
    public static int method75(int arg0, int arg1) {
        int var2 = arg0 >>> 31;
