...
public class class113 {
    ...
    public class113(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class189.method260(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1441 = var4;
            this.field1438 = var5;
            this.field1443 = new int[var4][14];
    ...
    @ObfuscatedName("db.s([BB)[B")
    public byte[] method2296(byte[] arg0) {
        if (this.field1443 != null) {
            int var2 = (int) ((long) this.field1438 * (long) arg0.length / (long) this.field1441) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1441;
                var4 += var11;
                var5 = var10 - this.field1441 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method2297(int arg0) {
        if (this.field1443 != null) {
            arg0 = (int) ((long) this.field1438 * (long) arg0 / (long) this.field1441);
        }
        return arg0;
    }

    @ObfuscatedName("db.i(IB)I")
    public int method2298(int arg0) {
        if (this.field1443 != null) {
            arg0 = (int) ((long) this.field1438 * (long) arg0 / (long) this.field1441) + 6;
        }
        return arg0;
    }
}
