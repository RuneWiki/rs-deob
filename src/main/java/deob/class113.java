...
public class class113 {
    ...
    public class113(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1430 = var9;
            this.field1431 = var10;
            this.field1427 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1427[var11];
    ...
    @ObfuscatedName("de.c([BB)[B")
    public byte[] method2315(byte[] arg0) {
        if (this.field1427 != null) {
            int var2 = (int) ((long) this.field1431 * (long) arg0.length / (long) this.field1430) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1427[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1431 + var5;
                int var11 = var10 / this.field1430;
                var4 += var11;
                var5 = var10 - this.field1430 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("de.x(II)I")
    public int method2316(int arg0) {
        if (this.field1427 != null) {
            arg0 = (int) ((long) this.field1431 * (long) arg0 / (long) this.field1430);
        }
        return arg0;
    }

    @ObfuscatedName("de.t(IB)I")
    public int method2327(int arg0) {
        if (this.field1427 != null) {
            arg0 = (int) ((long) this.field1431 * (long) arg0 / (long) this.field1430) + 6;
        }
        return arg0;
    }
}
