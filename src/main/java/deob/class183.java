...
public final class class183 extends class185 {
    ...
    public final void method3378(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg3 > 0 && arg4 > 0) {
            method3408(Statics.field1530, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }

    @ObfuscatedName("gc.l([BIIIIII)V")
    public final void method3379(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        int var8 = Statics.field1524 * arg2 + arg1;
        int var9 = Statics.field1524 - arg3;
        int var10 = 0;
        int var11 = 0;
        if (arg2 < field1527) {
            int var12 = field1527 - arg2;
            arg4 -= var12;
            arg2 = field1527;
            var11 += arg3 * var12;
            var8 += Statics.field1524 * var12;
        }
        if (arg2 + arg4 > field1528) {
            arg4 -= arg2 + arg4 - field1528;
        }
        if (arg1 < field1529) {
            int var13 = field1529 - arg1;
            arg3 -= var13;
            arg1 = field1529;
            var11 += var13;
            var8 += var13;
        ...
        if (arg1 + arg3 > field1525) {
            int var14 = arg1 + arg3 - field1525;
            arg3 -= var14;
            var10 += var14;
            var9 += var14;
        }
        if (arg3 > 0 && arg4 > 0) {
            method3410(Statics.field1530, arg0, arg5, var11, var8, arg3, arg4, var9, var10, arg6);
        }
    }
}
