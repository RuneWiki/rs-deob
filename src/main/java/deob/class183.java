...
public final class class183 extends class185 {
    ...
    public final void method3353(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg3 > 0 && arg4 > 0) {
            method3429(Statics.field1473, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }

    @ObfuscatedName("gm.e([BIIIIII)V")
    public final void method3356(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        int var8 = Statics.field1471 * arg2 + arg1;
        int var9 = Statics.field1471 - arg3;
        int var10 = 0;
        int var11 = 0;
        if (arg2 < field1470) {
            int var12 = field1470 - arg2;
            arg4 -= var12;
            arg2 = field1470;
            var11 += arg3 * var12;
            var8 += Statics.field1471 * var12;
        }
        if (arg2 + arg4 > field1476) {
            arg4 -= arg2 + arg4 - field1476;
        }
        if (arg1 < field1475) {
            int var13 = field1475 - arg1;
            arg3 -= var13;
            arg1 = field1475;
            var11 += var13;
            var8 += var13;
        ...
        if (arg1 + arg3 > field1474) {
            int var14 = arg1 + arg3 - field1474;
            arg3 -= var14;
            var10 += var14;
            var9 += var14;
        }
        if (arg3 > 0 && arg4 > 0) {
            method3390(Statics.field1473, arg0, arg5, var11, var8, arg3, arg4, var9, var10, arg6);
        }
    }
}
