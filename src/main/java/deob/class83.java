...
public class class83 extends class208 {
    ...
    public static void method1782(int[] arg0, int arg1, int arg2) {
        ...
        method1811(0, 0, arg1, arg2);
    }

    @ObfuscatedName("cg.ck()V")
    public static void method1783() {
        field1492 = 0;
        field1493 = 0;
        field1496 = Statics.field1491;
        field1490 = Statics.field1495;
    }

    @ObfuscatedName("cg.cz(IIII)V")
    public static void method1811(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 > Statics.field1495) {
            arg3 = Statics.field1495;
        }
        field1492 = arg0;
        field1493 = arg1;
        field1496 = arg2;
    ...
    @ObfuscatedName("cg.cj()V")
    public static void method1788() {
        int var0 = 0;
        int var1 = Statics.field1495 * Statics.field1491 - 7;
        while (var0 < var1) {
    ...
    @ObfuscatedName("cg.cp(IIIIIIII)V")
    public static void method1791(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        int var8 = 0;
        ...
        int var13 = Statics.field1491 - arg2;
        int var14 = Statics.field1491 * arg1 + arg0;
        for (int var15 = -arg3; var15 < 0; var15++) {
            for (int var16 = -arg2; var16 < 0; var16++) {
                int var17 = Statics.field1494[var14];
                int var18 = var12 + var17;
                int var19 = (var12 & 0xFF00FF) + (var17 & 0xFF00FF);
                int var20 = (var18 - var19 & 0x10000) + (var19 & 0x1000100);
                if (var11 == 0) {
                    Statics.field1494[var14++] = var18 - var20 | var20 - (var20 >>> 8);
                } else {
                    int var21 = var18 - var20 | var20 - (var20 >>> 8);
                    Statics.field1494[var14++] = ((var17 & 0xFF00) * var11 >> 8 & 0xFF00) + ((var17 & 0xFF00FF) * var11 >> 8 & 0xFF00FF) + ((var21 & 0xFF00FF) * var10 >> 8 & 0xFF00FF) + ((var21 & 0xFF00) * var10 >> 8 & 0xFF00);
                }
            }
            if (var9 > 0) {
                var8 += var9;
    ...
    @ObfuscatedName("cg.cx(IIIIIIII)V")
    public static void method1792(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        for (int var17 = 0; var17 < arg3; var17++) {
            for (int var18 = -arg2; var18 < 0; var18++) {
                ...
                Statics.field1494[var16++] = (var23 << 16) + (var24 << 8) + var25;
            }
            if (var9 > 0) {
                var8 += var9;
    ...
    @ObfuscatedName("cg.cn(IIIIIIII)V")
    public static void method1793(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        for (int var20 = 0; var20 < arg3; var20++) {
            for (int var21 = -arg2; var21 < 0; var21++) {
                ...
                Statics.field1494[var19++] = var24 + var26 + var28;
            }
            if (var9 > 0) {
                var8 += var9;
    ...
    @ObfuscatedName("cg.cr(IIIIIIII)V")
    ...
    @ObfuscatedName("cg.cu(IIIIII)V")
    public static void method1795(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var6 = 0;
        int var7 = 65536 / arg3;
        if (arg0 < field1492) {
            arg2 -= field1492 - arg0;
    ...
    @ObfuscatedName("cg.cd(IIIII)V")
    public static void method1796(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method1848(arg0, arg1, arg2, arg4);
        method1848(arg0, arg1 + arg3 - 1, arg2, arg4);
        method1852(arg0, arg1, arg3, arg4);
        method1852(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("cg.cv(IIIIII)V")
    public static void method1815(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1799(arg0, arg1, arg2, arg4, arg5);
        method1799(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
            method1827(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
            method1827(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
        }
    }

    @ObfuscatedName("cg.cq(IIII)V")
    public static void method1848(int arg0, int arg1, int arg2, int arg3) {
        if (arg1 < field1493 || arg1 >= field1490) {
            return;
        }
        if (arg0 < field1492) {
            arg2 -= field1492 - arg0;
    ...
    @ObfuscatedName("cg.cc(IIIII)V")
    public static void method1799(int arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg1 < field1493 || arg1 >= field1490) {
            return;
        }
        if (arg0 < field1492) {
    ...
    @ObfuscatedName("cg.dl(IIIII)V")
    public static void method1801(int arg0, int arg1, int arg2, int arg3, int arg4) {
        int var5 = arg2 - arg0;
        int var6 = arg3 - arg1;
        if (var6 == 0) {
            if (var5 >= 0) {
                method1848(arg0, arg1, var5 + 1, arg4);
            } else {
                method1848(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field1493 && var12 < field1490) {
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1492 && var18 < field1496) {
            ...
            method1852(arg0, arg1, var6 + 1, arg4);
        } else {
            method1852(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("cg.dg(III[I[I)V")
