...
public final class class395 {
    ...
    @ObfuscatedName("iu.l(Ljava/lang/CharSequence;I)I")
    public static int method4253(CharSequence arg0) {
    ...
    @ObfuscatedName("mv.q([BIIB)Ljava/lang/String;")
    public static String method5530(byte[] arg0, int arg1, int arg2) {
