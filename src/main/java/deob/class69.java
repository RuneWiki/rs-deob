...
public class class69 {
    ...
    public class69(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1260 = var9;
            this.field1261 = var10;
            this.field1267 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1267[var11];
    ...
    @ObfuscatedName("bs.p([BI)[B")
    public byte[] method1370(byte[] arg0) {
        if (this.field1267 != null) {
            int var2 = (int) ((long) this.field1261 * (long) arg0.length / (long) this.field1260) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1267[var5];
    ...
    public int method1371(int arg0) {
        if (this.field1267 != null) {
            arg0 = (int) ((long) this.field1261 * (long) arg0 / (long) this.field1260);
        }
        return arg0;
    }
    ...
    public int method1373(int arg0) {
        if (this.field1267 != null) {
            arg0 = (int) ((long) this.field1261 * (long) arg0 / (long) this.field1260) + 6;
        }
        return arg0;
    }
}
