...
public class class69 {
    ...
    public class69(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1268 = var9;
            this.field1273 = var10;
            this.field1275 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1275[var11];
    ...
    @ObfuscatedName("bd.b([BI)[B")
    public byte[] method1321(byte[] arg0) {
        if (this.field1275 != null) {
            int var2 = (int) ((long) this.field1273 * (long) arg0.length / (long) this.field1268) + 14;
    ...
    @ObfuscatedName("bd.e(IB)I")
    public int method1322(int arg0) {
        if (this.field1275 != null) {
            arg0 = (int) ((long) this.field1273 * (long) arg0 / (long) this.field1268);
        }
        return arg0;
    }

    @ObfuscatedName("bd.i(II)I")
    public int method1323(int arg0) {
        if (this.field1275 != null) {
            arg0 = (int) ((long) this.field1273 * (long) arg0 / (long) this.field1268) + 6;
        }
        return arg0;
    }
}
