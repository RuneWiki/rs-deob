...
public class class69 {
    ...
    public class69(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1281 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1281[var11];
    ...
    @ObfuscatedName("bl.f([BI)[B")
    public byte[] method1371(byte[] arg0) {
        if (this.field1281 != null) {
            int var2 = (int) ((long) this.field1278 * (long) arg0.length / (long) this.field1279) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1278 + var5;
                int var11 = var10 / this.field1279;
                var4 += var11;
                var5 = var10 - this.field1279 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1385(int arg0) {
        if (this.field1281 != null) {
            arg0 = (int) ((long) this.field1278 * (long) arg0 / (long) this.field1279);
        }
        return arg0;
    }

    @ObfuscatedName("bl.y(II)I")
    public int method1375(int arg0) {
        if (this.field1281 != null) {
            arg0 = (int) ((long) this.field1278 * (long) arg0 / (long) this.field1279) + 6;
        }
        return arg0;
    }
}
