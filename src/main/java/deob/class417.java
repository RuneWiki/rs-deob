...
public final class class417 {
    ...
    @ObfuscatedName("gd.c(Ljava/lang/CharSequence;I)I")
    public static int method3368(CharSequence arg0) {
    ...
    @ObfuscatedName("cz.l([BILjava/lang/CharSequence;I)I")
    public static int method2296(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("lx.s([BIII)Ljava/lang/String;")
    public static String method5228(byte[] arg0, int arg1, int arg2) {
