...
public class class127 {
    ...
    @ObfuscatedName("ad.g(IB)I")
    public static int method972(int arg0) {
    ...
    @ObfuscatedName("ay.d(II)I")
    public static int method776(int arg0) {
        int var1 = 0;
    ...
    @ObfuscatedName("cx.x(IIB)I")
    public static int method2048(int arg0, int arg1) {
        int var2 = arg0 >>> 31;
