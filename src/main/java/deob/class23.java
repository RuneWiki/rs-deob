...
public class class23 extends class29 {
    ...
    @ObfuscatedName("f.o(Lgc;Lgc;I)V")
    public void method174(class195 arg0, class195 arg1) {
        int var3 = arg1.method3205();
        if (class38.field500.field501 != var3) {
        ...
        if (class37.field495.field497 != var4) {
            throw new IllegalStateException("");
        }
        int var5 = arg0.method3205();
        int var6 = arg0.method3205();
        if (this.field421 != var5 || this.field410 != var6) {
            throw new IllegalStateException("");
        }
        for (int var7 = 0; var7 < 64; var7++) {
            for (int var8 = 0; var8 < 64; var8++) {
                this.method238(var7, var8, arg0);
            }
        }
    }
    ...
    public boolean equals(Object arg0) {
        if ((arg0 instanceof class23)) {
            ...
            return this.field421 == var2.field421 && this.field410 == var2.field410;
        } else {
            return false;
        }
    }
    ...
    public int hashCode() {
        return this.field421 | this.field410 << 8;
    }
}
