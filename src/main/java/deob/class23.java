...
public class class23 extends class29 {
    ...
    @ObfuscatedName("r.t(Lgb;Lgb;I)V")
    public void method164(class195 arg0, class195 arg1) {
        ...
        if (this.field391 != var5 || this.field386 != var6) {
            throw new IllegalStateException("");
        }
    ...
    public boolean equals(Object arg0) {
        if ((arg0 instanceof class23)) {
            ...
            return this.field391 == var2.field391 && this.field386 == var2.field386;
        } else {
            return false;
        }
    }
    ...
    public int hashCode() {
        return this.field391 | this.field386 << 8;
    }
}
