...
public class class23 extends class29 {
    ...
    @ObfuscatedName("o.d(Lfr;Lfr;I)V")
    public void method162(class181 arg0, class181 arg1) {
        int var3 = arg1.method3204();
        if (class37.field486.field481 != var3) {
        ...
        if (class36.field478.field475 != var4) {
            throw new IllegalStateException("");
        }
        int var5 = arg0.method3204();
        int var6 = arg0.method3204();
        if (this.field386 != var5 || this.field382 != var6) {
            throw new IllegalStateException("");
        }
    ...
    public boolean equals(Object arg0) {
        if ((arg0 instanceof class23)) {
            ...
            return this.field386 == var2.field386 && this.field382 == var2.field382;
        } else {
            return false;
        }
    }
    ...
    public int hashCode() {
        return this.field386 | this.field382 << 8;
    }
}
