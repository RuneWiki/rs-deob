...
public class class23 extends class29 {
    ...
    @ObfuscatedName("k.j(Lfb;Lfb;I)V")
    public void method160(class175 arg0, class175 arg1) {
        int var3 = arg1.method2903();
        if (class37.field515.field510 != var3) {
        ...
        if (class36.field507.field504 != var4) {
            throw new IllegalStateException("");
        }
        int var5 = arg0.method2903();
        int var6 = arg0.method2903();
        if (this.field425 != var5 || this.field414 != var6) {
            throw new IllegalStateException("");
        }
    ...
    public boolean equals(Object arg0) {
        if ((arg0 instanceof class23)) {
            ...
            return this.field425 == var2.field425 && this.field414 == var2.field414;
        } else {
            return false;
        }
    }
    ...
    public int hashCode() {
        return this.field425 | this.field414 << 8;
    }
}
