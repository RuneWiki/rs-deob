...
public class class159 extends class142 {
    ...
    @ObfuscatedName("fc.j")
    public static class100 field2417 = new class100(64);
    ...
    public static class159 method98(int arg0) {
        class159 var1 = (class159) field2417.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        if (var2 != null) {
            var3.method2501(new class135(var2));
        }
    ...
    public void method2501(class135 arg0) {
        while (true) {
    ...
    public void method2503(class135 arg0, int arg1) {
        if (arg1 == 1) {
