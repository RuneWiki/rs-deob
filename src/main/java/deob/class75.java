...
public class class75 {
    ...
    @ObfuscatedName("bb.n([BI)[B")
    public byte[] method1499(byte[] arg0) {
        if (this.field1360 != null) {
            int var2 = (int) ((long) this.field1357 * (long) arg0.length / (long) this.field1358) + 14;
    ...
    public int method1498(int arg0) {
        if (this.field1360 != null) {
            arg0 = (int) ((long) this.field1357 * (long) arg0 / (long) this.field1358);
        }
        return arg0;
    }

    @ObfuscatedName("bb.c(IS)I")
    public int method1501(int arg0) {
        if (this.field1360 != null) {
            arg0 = (int) ((long) this.field1357 * (long) arg0 / (long) this.field1358) + 6;
        }
        return arg0;
    }
}
