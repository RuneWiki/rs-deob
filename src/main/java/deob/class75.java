...
public class class75 {
    ...
    public class75(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1369 = var9;
            this.field1377 = var10;
            this.field1371 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1371[var11];
    ...
    @ObfuscatedName("bw.h([BI)[B")
    public byte[] method1505(byte[] arg0) {
        if (this.field1371 != null) {
            int var2 = (int) ((long) this.field1377 * (long) arg0.length / (long) this.field1369) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1377 + var5;
                int var11 = var10 / this.field1369;
                var4 += var11;
                var5 = var10 - this.field1369 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1514(int arg0) {
        if (this.field1371 != null) {
            arg0 = (int) ((long) this.field1377 * (long) arg0 / (long) this.field1369);
        }
        return arg0;
    }

    @ObfuscatedName("bw.v(IB)I")
    public int method1507(int arg0) {
        if (this.field1371 != null) {
            arg0 = (int) ((long) this.field1377 * (long) arg0 / (long) this.field1369) + 6;
        }
        return arg0;
    }
}
