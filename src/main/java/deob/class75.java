...
public class class75 {
    ...
    public class75(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1358 = var9;
            this.field1355 = var10;
            this.field1360 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1360[var11];
    ...
    @ObfuscatedName("bl.c([BB)[B")
    public byte[] method1471(byte[] arg0) {
        if (this.field1360 != null) {
            int var2 = (int) ((long) this.field1355 * (long) arg0.length / (long) this.field1358) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1360[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1355 + var5;
                int var11 = var10 / this.field1358;
                var4 += var11;
                var5 = var10 - this.field1358 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bl.h(II)I")
    public int method1479(int arg0) {
        if (this.field1360 != null) {
            arg0 = (int) ((long) this.field1355 * (long) arg0 / (long) this.field1358);
        }
        return arg0;
    }

    @ObfuscatedName("bl.k(IB)I")
    public int method1476(int arg0) {
        if (this.field1360 != null) {
            arg0 = (int) ((long) this.field1355 * (long) arg0 / (long) this.field1358) + 6;
        }
        return arg0;
    }
}
