...
public class class75 {
    ...
    @ObfuscatedName("bk.n([BI)[B")
    public byte[] method1464(byte[] arg0) {
        if (this.field1361 != null) {
            int var2 = (int) ((long) this.field1356 * (long) arg0.length / (long) this.field1355) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1356 + var5;
                int var11 = var10 / this.field1355;
                var4 += var11;
                var5 = var10 - this.field1355 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1465(int arg0) {
        if (this.field1361 != null) {
            arg0 = (int) ((long) this.field1356 * (long) arg0 / (long) this.field1355);
        }
        return arg0;
    }

    @ObfuscatedName("bk.s(II)I")
    public int method1466(int arg0) {
        if (this.field1361 != null) {
            arg0 = (int) ((long) this.field1356 * (long) arg0 / (long) this.field1355) + 6;
        }
        return arg0;
    }
}
