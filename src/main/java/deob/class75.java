...
public class class75 {
    ...
    public class75(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1373 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1373[var11];
    ...
    @ObfuscatedName("bh.j([BI)[B")
    public byte[] method1492(byte[] arg0) {
        if (this.field1373 != null) {
            int var2 = (int) ((long) this.field1368 * (long) arg0.length / (long) this.field1370) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1370;
                var4 += var11;
                var5 = var10 - this.field1370 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bh.l(IB)I")
    public int method1495(int arg0) {
        if (this.field1373 != null) {
            arg0 = (int) ((long) this.field1368 * (long) arg0 / (long) this.field1370);
        }
        return arg0;
    }

    @ObfuscatedName("bh.a(IS)I")
    public int method1498(int arg0) {
        if (this.field1373 != null) {
            arg0 = (int) ((long) this.field1368 * (long) arg0 / (long) this.field1370) + 6;
        }
        return arg0;
    }
}
