...
public class class75 {
    ...
    public class75(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1374 = var9;
            this.field1368 = var10;
            this.field1376 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1376[var11];
    ...
    @ObfuscatedName("bp.s([BB)[B")
    public byte[] method1474(byte[] arg0) {
        if (this.field1376 != null) {
            int var2 = (int) ((long) this.field1368 * (long) arg0.length / (long) this.field1374) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1368 + var5;
                int var11 = var10 / this.field1374;
                var4 += var11;
                var5 = var10 - this.field1374 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bp.j(IB)I")
    public int method1476(int arg0) {
        if (this.field1376 != null) {
            arg0 = (int) ((long) this.field1368 * (long) arg0 / (long) this.field1374);
        }
        return arg0;
    }

    @ObfuscatedName("bp.p(IB)I")
    public int method1477(int arg0) {
        if (this.field1376 != null) {
            arg0 = (int) ((long) this.field1368 * (long) arg0 / (long) this.field1374) + 6;
        }
        return arg0;
    }
}
