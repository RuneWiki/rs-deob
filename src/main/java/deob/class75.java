...
public class class75 {
    ...
    public class75(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1369 = var9;
            this.field1371 = var10;
            this.field1372 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1372[var11];
    ...
    @ObfuscatedName("be.i([BI)[B")
    public byte[] method1514(byte[] arg0) {
        if (this.field1372 != null) {
            int var2 = (int) ((long) this.field1371 * (long) arg0.length / (long) this.field1369) + 14;
    ...
    @ObfuscatedName("be.v(II)I")
    public int method1515(int arg0) {
        if (this.field1372 != null) {
            arg0 = (int) ((long) this.field1371 * (long) arg0 / (long) this.field1369);
        }
        return arg0;
    }

    @ObfuscatedName("be.r(IB)I")
    public int method1519(int arg0) {
        if (this.field1372 != null) {
            arg0 = (int) ((long) this.field1371 * (long) arg0 / (long) this.field1369) + 6;
        }
        return arg0;
    }
}
