...
public class class75 {
    ...
    @ObfuscatedName("bk.b([BI)[B")
    public byte[] method1505(byte[] arg0) {
        if (this.field1340 != null) {
            int var2 = (int) ((long) this.field1336 * (long) arg0.length / (long) this.field1335) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1336 + var5;
                int var11 = var10 / this.field1335;
                var4 += var11;
                var5 = var10 - this.field1335 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1504(int arg0) {
        if (this.field1340 != null) {
            arg0 = (int) ((long) this.field1336 * (long) arg0 / (long) this.field1335);
        }
        return arg0;
    }

    @ObfuscatedName("bk.j(II)I")
    public int method1512(int arg0) {
        if (this.field1340 != null) {
            arg0 = (int) ((long) this.field1336 * (long) arg0 / (long) this.field1335) + 6;
        }
        return arg0;
    }
}
