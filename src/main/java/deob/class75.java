...
public class class75 {
    ...
    public class75(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1375 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1375[var11];
    ...
    @ObfuscatedName("bw.a([BS)[B")
    public byte[] method1600(byte[] arg0) {
        if (this.field1375 != null) {
            int var2 = (int) ((long) this.field1378 * (long) arg0.length / (long) this.field1374) + 14;
    ...
    public int method1590(int arg0) {
        if (this.field1375 != null) {
            arg0 = (int) ((long) this.field1378 * (long) arg0 / (long) this.field1374);
        }
        return arg0;
    }

    @ObfuscatedName("bw.d(IB)I")
    public int method1591(int arg0) {
        if (this.field1375 != null) {
            arg0 = (int) ((long) this.field1378 * (long) arg0 / (long) this.field1374) + 6;
        }
        return arg0;
    }
}
