...
public abstract class class501 {
    ...
    public int field5007 = 0;

    @ObfuscatedName("ti.ad")
    public int field5011 = 0;

    @ObfuscatedName("ti.al")
    public double field5009 = 0.0D;

    @ObfuscatedName("ti.as")
    public int field5010 = 0;

    public class501(int arg0, int arg1) {
        this.field5007 = arg0;
        this.field5011 = 0;
        this.field5010 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field5009 = method181(this.field5011, this.field5007, this.field5010);
    }

    @ObfuscatedName("ti.al(I)V")
    ...
    @ObfuscatedName("ti.as(I)D")
    public double method7912() {
        return this.field5009;
    }

    @ObfuscatedName("ar.ag(IIII)D")
    public static double method181(int arg0, int arg1, int arg2) {
