...
public class class67 {
    ...
    public class67() {
        class64.method1246(24);
        this.field1257 = class64.method1246(16);
        this.field1258 = class64.method1246(24);
        this.field1256 = new int[this.field1258];
        boolean var1 = class64.method1245() != 0;
        if (var1) {
            int var2 = 0;
            int var3 = class64.method1246(5) + 1;
            while (var2 < this.field1258) {
                int var4 = class64.method1246(class113.method1051(this.field1258 - var2));
            ...
            for (int var7 = 0; var7 < this.field1258; var7++) {
                if (var6 && class64.method1245() == 0) {
                    ...
                    this.field1256[var7] = class64.method1246(5) + 1;
                }
            }
        }
        this.method1289();
        int var8 = class64.method1246(4);
        if (var8 > 0) {
            float var9 = class64.method1252(class64.method1246(32));
            float var10 = class64.method1252(class64.method1246(32));
            int var11 = class64.method1246(4) + 1;
            boolean var12 = class64.method1245() != 0;
            int var13;
            if (var8 == 1) {
                var13 = method1301(this.field1258, this.field1257);
            } else {
                var13 = this.field1258 * this.field1257;
            }
            this.field1255 = new int[var13];
            for (int var14 = 0; var14 < var13; var14++) {
                this.field1255[var14] = class64.method1246(var11);
            }
            this.field1254 = new float[this.field1258][this.field1257];
            if (var8 == 1) {
    ...
    public int method1290() {
        int var1;
        for (var1 = 0; this.field1259[var1] >= 0; var1 = class64.method1245() == 0 ? var1 + 1 : this.field1259[var1]) {
        }
        return ~this.field1259[var1];
    }

    @ObfuscatedName("by.o()[F")
    public float[] method1291() {
        return this.field1254[this.method1290()];
    }
}
