...
public class class67 {
    ...
    public static int method1324(int arg0, int arg1) {
        int var2;
        for (var2 = (int) Math.pow((double) arg0, 1.0D / (double) arg1) + 1; class113.method127(var2, arg1) > arg0; var2--) {
        }
        return var2;
    }

    public class67() {
        class64.method1279(24);
        this.field1256 = class64.method1279(16);
        this.field1258 = class64.method1279(24);
        this.field1254 = new int[this.field1258];
        boolean var1 = class64.method1274() != 0;
        if (var1) {
            int var2 = 0;
            int var3 = class64.method1279(5) + 1;
            while (var2 < this.field1258) {
                int var4 = class64.method1279(class113.method2675(this.field1258 - var2));
            ...
            for (int var7 = 0; var7 < this.field1258; var7++) {
                if (var6 && class64.method1274() == 0) {
                    ...
                    this.field1254[var7] = class64.method1279(5) + 1;
                }
            }
        }
        this.method1317();
        int var8 = class64.method1279(4);
        if (var8 > 0) {
            float var9 = class64.method1276(class64.method1279(32));
            float var10 = class64.method1276(class64.method1279(32));
            int var11 = class64.method1279(4) + 1;
            boolean var12 = class64.method1274() != 0;
            int var13;
            if (var8 == 1) {
                var13 = method1324(this.field1258, this.field1256);
            } else {
                var13 = this.field1258 * this.field1256;
            }
            this.field1257 = new int[var13];
            for (int var14 = 0; var14 < var13; var14++) {
                this.field1257[var14] = class64.method1279(var11);
            }
            this.field1255 = new float[this.field1258][this.field1256];
            if (var8 == 1) {
    ...
    public int method1318() {
        int var1;
        for (var1 = 0; this.field1259[var1] >= 0; var1 = class64.method1274() == 0 ? var1 + 1 : this.field1259[var1]) {
        }
        return ~this.field1259[var1];
    }

    @ObfuscatedName("by.j()[F")
    public float[] method1323() {
        return this.field1255[this.method1318()];
    }
}
