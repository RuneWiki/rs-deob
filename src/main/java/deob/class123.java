...
public class class123 {
    ...
    @ObfuscatedName("cy.j(IIB)I")
    public static int method1555(int arg0, int arg1) {
        if (arg1 > arg0) {
            int var2 = arg0;
            arg0 = arg1;
            arg1 = var2;
    ...
    @ObfuscatedName("ah.f(II)I")
    public static int method847(int arg0) {
