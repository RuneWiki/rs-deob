...
public class class123 {
    ...
    public class123(int[] arg0) {
        ...
        while (var4 < arg0.length) {
            int var5;
            for (var5 = arg0[var4] & var2 - 1; this.field1867[var5 + var5 + 1] != -1; var5 = var5 + 1 & var2 - 1) {
            }
            this.field1867[var5 + var5] = arg0[var4];
            this.field1867[var5 + var5 + 1] = var4++;
        }
    }
    ...
    public int method2209(int arg0) {
        ...
        while (true) {
            ...
            if (this.field1867[var3 + var3] == arg0) {
                return var4;
            }
            var3 = var3 + 1 & var2;
        }
