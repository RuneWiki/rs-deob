...
public final class class123 {
    ...
    public final int method2652() {
        if (0 == --this.field1995 + 1) {
            this.method2644();
            this.field1995 = 255;
        }
        return this.field2005[this.field1995];
    }

    @ObfuscatedName("dg.p(S)V")
    public final void method2644() {
        ...
        for (int var1 = 0; var1 < 256; var1++) {
            ...
            if ((var1 & 0x2) == 0) {
                if ((var1 & 0x1) == 0) {
                    this.field1998 ^= this.field1998 << 13;
                } else {
                    this.field1998 ^= this.field1998 >>> 6;
                }
            } else if ((var1 & 0x1) == 0) {
                this.field1998 ^= this.field1998 << 2;
            } else {
                this.field1998 ^= this.field1998 >>> 16;
            }
            this.field1998 += this.field2003[var1 + 128 & 0xFF];
            int var3;
            this.field2003[var1] = var3 = this.field1999 + this.field1998 + this.field2003[(var2 & 0x3FC) >> 2];
            this.field2005[var1] = this.field1999 = this.field2003[(var3 >> 8 & 0x3FC) >> 2] + var2;
        }
    }
