...
public final class class123 {
    ...
    @ObfuscatedName("dn.g")
    public int[] field2017 = new int[256];
    ...
    @ObfuscatedName("dn.l(I)I")
    public final int method2650() {
        if (0 == --this.field2016 + 1) {
            this.method2645();
            this.field2016 = 255;
        }
    ...
    public final void method2645() {
        this.field2020 += ++this.field2021;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field2018[var1];
            if ((var1 & 0x2) == 0) {
                if ((var1 & 0x1) == 0) {
                    this.field2019 ^= this.field2019 << 13;
                } else {
                    this.field2019 ^= this.field2019 >>> 6;
                }
            } else if ((var1 & 0x1) == 0) {
                this.field2019 ^= this.field2019 << 2;
            } else {
                this.field2019 ^= this.field2019 >>> 16;
            }
            this.field2019 += this.field2018[var1 + 128 & 0xFF];
            int var3;
            this.field2018[var1] = var3 = this.field2020 + this.field2019 + this.field2018[(var2 & 0x3FC) >> 2];
            this.field2017[var1] = this.field2020 = this.field2018[(var3 >> 8 & 0x3FC) >> 2] + var2;
        }
    }

    @ObfuscatedName("dn.q(B)V")
    public final void method2646() {
        int var1 = -1640531527;
        int var2 = -1640531527;
        int var3 = -1640531527;
        int var4 = -1640531527;
        ...
        for (int var26 = 0; var26 < 256; var26 += 8) {
            int var27 = this.field2017[var26] + var8;
            int var28 = this.field2017[var26 + 1] + var7;
            int var29 = this.field2017[var26 + 2] + var6;
            int var30 = this.field2017[var26 + 3] + var5;
            int var31 = this.field2017[var26 + 4] + var4;
            int var32 = this.field2017[var26 + 5] + var3;
            int var33 = this.field2017[var26 + 6] + var2;
            int var34 = this.field2017[var26 + 7] + var1;
