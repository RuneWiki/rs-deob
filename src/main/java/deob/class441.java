...
public class class441 {
    ...
    @ObfuscatedName("qq.at")
    public float[] field4701;

    @ObfuscatedName("qq.an")
    public int field4702;

    public class441(float[] arg0, int arg1) {
        this.field4701 = arg0;
        this.field4702 = arg1;
    }

    @ObfuscatedName("cl.at([FIFZFZ[FI)I")
    public static int method1955(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class126.field1464;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class441 var16 = new class441(var10, arg1);
            ...
            int var20 = method1955(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method7117(var10, arg1, arg2);
                ...
                var22 = method7117(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    arg6[var12++] = method6120(var16, var26, var24, 0.0F);
    ...
    @ObfuscatedName("qf.an([FIFI)F")
    public static float method7117(float[] arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("nq.av(Lqq;FFFI)F")
    public static float method6120(class441 arg0, float arg1, float arg2, float arg3) {
        float var4 = method7117(arg0.field4701, arg0.field4702, arg1);
        if (Math.abs(var4) < class126.field1464) {
            return arg1;
        }
        float var5 = method7117(arg0.field4701, arg0.field4702, arg2);
        if (Math.abs(var5) < class126.field1464) {
            return arg2;
        }
        float var6 = 0.0F;
        float var7 = 0.0F;
        ...
        do {
            ...
            float var13 = class126.field1468 * Math.abs(arg2) + arg3 * 0.5F;
            ...
            if (var15) {
                ...
                var5 = method7117(arg0.field4701, arg0.field4702, arg2);
