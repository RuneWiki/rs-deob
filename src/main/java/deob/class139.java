...
public class class139 extends class193 {
    ...
    public class139(int arg0, byte[] arg1) {
        ...
        this.field2047 = var3.method2891();
        this.field2052 = new int[this.field2047];
        this.field2049 = new int[this.field2047][];
        for (int var4 = 0; var4 < this.field2047; var4++) {
            this.field2052[var4] = var3.method2891();
        }
        for (int var5 = 0; var5 < this.field2047; var5++) {
            this.field2049[var5] = new int[var3.method2891()];
        }
        for (int var6 = 0; var6 < this.field2047; var6++) {
            for (int var7 = 0; var7 < this.field2049[var6].length; var7++) {
                this.field2049[var6][var7] = var3.method2891();
            }
        }
    }
}
