...
public class class139 extends RuntimeException {
    ...
    @ObfuscatedName("do.v(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2439(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2093.getCodeBase(), "clienterror.ws?c=" + Statics.field2086 + "&u=" + Statics.field2085 + "&v1=" + Statics.field1957 + "&v2=" + Statics.field1954 + "&e=" + var25);
    ...
    @ObfuscatedName("ep.t(Ljava/lang/Throwable;Ljava/lang/String;)Leo;")
    public static class139 method2746(Throwable arg0, String arg1) {
        class139 var2;
        if (arg0 instanceof class139) {
            var2 = (class139) arg0;
            var2.field2090 = var2.field2090 + ' ' + arg1;
        } else {
