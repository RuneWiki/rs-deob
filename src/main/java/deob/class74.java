...
public final class class74 extends class73 {
    ...
    public void method1545() {
        if (this.field1328 == this.field1327 && this.field1331 == this.field1325) {
            return;
        }
        byte[] var1 = new byte[this.field1331 * this.field1328];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1325; var3++) {
            for (int var4 = 0; var4 < this.field1327; var4++) {
                var1[(this.field1330 + var3) * this.field1328 + this.field1326 + var4] = this.field1329[var2++];
            }
        }
        this.field1329 = var1;
        this.field1327 = this.field1328;
        this.field1325 = this.field1331;
        this.field1326 = 0;
        this.field1330 = 0;
    }
    ...
    public void method1546(int arg0, int arg1, int arg2) {
        for (int var4 = 0; var4 < this.field1332.length; var4++) {
            int var5 = this.field1332[var4] >> 16 & 0xFF;
            int var6 = arg0 + var5;
            if (var6 < 0) {
                var6 = 0;
            } else if (var6 > 255) {
            ...
            int var7 = this.field1332[var4] >> 8 & 0xFF;
            int var8 = arg1 + var7;
            if (var8 < 0) {
                var8 = 0;
            } else if (var8 > 255) {
            ...
            int var9 = this.field1332[var4] & 0xFF;
            int var10 = arg2 + var9;
            if (var10 < 0) {
                var10 = 0;
            } else if (var10 > 255) {
            ...
            this.field1332[var4] = (var6 << 16) + (var8 << 8) + var10;
        }
    }
    ...
    public void method1547(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1544(Statics.field1324, this.field1329, this.field1332, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("br.e([I[B[IIIIIII)V")
