...
public class class74 {
    ...
    @ObfuscatedName("bf.h(II)I")
    public static int method1496(int arg0, int arg1) {
        int var2;
        for (var2 = (int) Math.pow((double) arg0, 1.0D / (double) arg1) + 1; Statics.method171(var2, arg1) > arg0; var2--) {
        }
        return var2;
    }
    ...
    public class74() {
        ...
        this.field1365 = class71.method1450(16);
        this.field1362 = class71.method1450(24);
        ...
        if (var1) {
            ...
            while (var2 < this.field1362) {
                int var4 = class71.method1450(class126.method3719(this.field1362 - var2));
            ...
            boolean var6 = class71.method1453() != 0;
            for (int var7 = 0; var7 < this.field1362; var7++) {
                if (var6 && class71.method1453() == 0) {
                    this.field1361[var7] = 0;
                } else {
                    this.field1361[var7] = class71.method1450(5) + 1;
                }
            }
        }
        this.method1503();
        ...
        if (var8 > 0) {
            float var9 = class71.method1459(class71.method1450(32));
            float var10 = class71.method1459(class71.method1450(32));
            int var11 = class71.method1450(4) + 1;
            boolean var12 = class71.method1453() != 0;
            int var13;
            if (var8 == 1) {
                var13 = method1496(this.field1362, this.field1365);
            } else {
                var13 = this.field1365 * this.field1362;
            }
            this.field1364 = new int[var13];
            for (int var14 = 0; var14 < var13; var14++) {
                this.field1364[var14] = class71.method1450(var11);
            }
            this.field1363 = new float[this.field1362][this.field1365];
            if (var8 == 1) {
                ...
                for (int var21 = 0; var21 < this.field1362; var21++) {
                    float var22 = 0.0F;
                    int var23 = this.field1365 * var21;
                    for (int var24 = 0; var24 < this.field1365; var24++) {
    ...
    public int method1495() {
        int var1;
        for (var1 = 0; this.field1366[var1] >= 0; var1 = class71.method1453() == 0 ? var1 + 1 : this.field1366[var1]) {
        }
        return ~this.field1366[var1];
    }

    @ObfuscatedName("bf.n()[F")
    public float[] method1494() {
        return this.field1363[this.method1495()];
    }
}
