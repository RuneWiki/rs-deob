...
public final class class74 extends class73 {
    ...
    @ObfuscatedName("by.j()V")
    public void method1576() {
        if (this.field1329 == this.field1324 && this.field1328 == this.field1322) {
            return;
        }
        byte[] var1 = new byte[this.field1329 * this.field1322];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1328; var3++) {
            for (int var4 = 0; var4 < this.field1324; var4++) {
                var1[(this.field1327 + var3) * this.field1329 + this.field1326 + var4] = this.field1325[var2++];
            }
        }
        this.field1325 = var1;
        this.field1324 = this.field1329;
        this.field1328 = this.field1322;
        this.field1326 = 0;
        this.field1327 = 0;
    }

    @ObfuscatedName("by.z(III)V")
    public void method1577(int arg0, int arg1, int arg2) {
    ...
    public void method1586(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1578(Statics.field1318, this.field1325, this.field1323, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("by.h([I[B[IIIIIII)V")
