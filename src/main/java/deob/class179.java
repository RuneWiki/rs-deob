...
public class class179 {
    ...
    @ObfuscatedName("fs.m")
    public static class171 field2826 = new class171();
    ...
    public static void method1002() {
        field2826 = new class171();
    }

    @ObfuscatedName("u.k(Ldj;II)V")
    public static void method122(class107 arg0, int arg1) {
        while (true) {
            class178 var2 = (class178) field2826.method3178();
            if (var2 == null) {
                return;
            }
            arg0.method2372(arg1);
            arg0.method2133(0);
            int var3 = arg0.field1806;
            arg0.method2131(var2.field2820);
            for (int var4 = 0; var4 < var2.field2818; var4++) {
                if (var2.field2821[var4] == 0) {
                    try {
                        int var5 = var2.field2819[var4];
                        if (var5 == 0) {
                            Field var6 = var2.field2822[var4];
                            int var7 = var6.getInt((Object) null);
                            arg0.method2133(0);
                            arg0.method2131(var7);
                        } else if (var5 == 1) {
                            Field var8 = var2.field2822[var4];
                            var8.setInt((Object) null, var2.field2823[var4]);
                            arg0.method2133(0);
                        } else if (var5 == 2) {
                            Field var9 = var2.field2822[var4];
                            int var10 = var9.getModifiers();
                            arg0.method2133(0);
                            arg0.method2131(var10);
                        }
                        if (var5 == 3) {
                            ...
                            if (var16 == null) {
                                ...
                                arg0.method2133(1);
                                arg0.method2120(((Number) var16).longValue());
                            } else if (var16 instanceof String) {
                                arg0.method2133(2);
                                arg0.method2116((String) var16);
                            } else {
                                arg0.method2133(4);
                            }
                        } else if (var5 == 4) {
                    ...
                    arg0.method2133(var2.field2821[var4]);
                }
            }
            arg0.method2149(var3);
            arg0.method2127(arg0.field1806 - var3);
            var2.method3223();
        }
    }

    @ObfuscatedName("ch.y(Ljava/lang/String;I)Ljava/lang/Class;")
    public static Class method1862(String arg0) throws ClassNotFoundException {
        if (arg0.equals("B")) {
            return Byte.TYPE;
