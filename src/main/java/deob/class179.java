...
public final class class179 {
    ...
    @ObfuscatedName("eb.v(Ljava/lang/CharSequence;B)I")
    public static int method2677(CharSequence arg0) {
    ...
    @ObfuscatedName("x.f([BIIB)Ljava/lang/String;")
    public static String method208(byte[] arg0, int arg1, int arg2) {
