...
public class class14 {
    ...
    public int method190(int arg0) {
        int var2 = (this.field207.length >> 1) - 1;
        int var3 = arg0 & var2;
        while (true) {
            int var4 = this.field207[var3 + var3 + 1];
            if (var4 == -1) {
                return -1;
            }
            if (this.field207[var3 + var3] == arg0) {
                return var4;
            }
            var3 = var3 + 1 & var2;
        }
    ...
    public class14(int[] arg0) {
        ...
        while (var4 < arg0.length) {
            int var5;
            for (var5 = arg0[var4] & var2 - 1; this.field207[var5 + var5 + 1] != -1; var5 = var5 + 1 & var2 - 1) {
            }
