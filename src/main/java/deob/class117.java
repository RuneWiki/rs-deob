...
public final class class117 {
    ...
    @ObfuscatedName("dl.i(I)I")
    public final int method2352() {
        if (0 == --this.field1996 + 1) {
            this.method2353();
            this.field1996 = 255;
        }
        return this.field2002[this.field1996];
    }

    @ObfuscatedName("dl.w(I)V")
    public final void method2353() {
        this.field2000 += ++this.field1995;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field1998[var1];
            if ((var1 & 0x2) == 0) {
                if ((var1 & 0x1) == 0) {
                    this.field1999 ^= this.field1999 << 13;
                } else {
                    this.field1999 ^= this.field1999 >>> 6;
                }
            } else if ((var1 & 0x1) == 0) {
                this.field1999 ^= this.field1999 << 2;
            } else {
                this.field1999 ^= this.field1999 >>> 16;
            }
            this.field1999 += this.field1998[var1 + 128 & 0xFF];
            int var3;
            this.field1998[var1] = var3 = this.field2000 + this.field1999 + this.field1998[(var2 & 0x3FC) >> 2];
            this.field2002[var1] = this.field2000 = this.field1998[(var3 >> 8 & 0x3FC) >> 2] + var2;
        }
    }

    @ObfuscatedName("dl.f(B)V")
