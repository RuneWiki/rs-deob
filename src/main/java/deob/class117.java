...
public class class117 {
    ...
    public class117(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1697 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1697[var11];
    ...
    @ObfuscatedName("da.i([BI)[B")
    public byte[] method1936(byte[] arg0) {
        if (this.field1697 != null) {
            int var2 = (int) ((long) this.field1693 * (long) arg0.length / (long) this.field1696) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1693 + var5;
                int var11 = var10 / this.field1696;
                var4 += var11;
                var5 = var10 - this.field1696 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("da.w(II)I")
    public int method1934(int arg0) {
        if (this.field1697 != null) {
            arg0 = (int) ((long) this.field1693 * (long) arg0 / (long) this.field1696);
        }
        return arg0;
    }

    @ObfuscatedName("da.a(II)I")
    public int method1932(int arg0) {
        if (this.field1697 != null) {
            arg0 = (int) ((long) this.field1693 * (long) arg0 / (long) this.field1696) + 6;
        }
        return arg0;
    }
}
