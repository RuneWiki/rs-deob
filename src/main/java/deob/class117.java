...
public class class117 {
    ...
    public class117(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1680 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1680[var11];
    ...
    @ObfuscatedName("dp.s([BI)[B")
    public byte[] method1972(byte[] arg0) {
        if (this.field1680 != null) {
            int var2 = (int) ((long) this.field1686 * (long) arg0.length / (long) this.field1679) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1680[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1686 + var5;
                int var11 = var10 / this.field1679;
                var4 += var11;
                var5 = var10 - this.field1679 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("dp.c(II)I")
    public int method1973(int arg0) {
        if (this.field1680 != null) {
            arg0 = (int) ((long) this.field1686 * (long) arg0 / (long) this.field1679);
        }
        return arg0;
    }

    @ObfuscatedName("dp.f(II)I")
    public int method1974(int arg0) {
        if (this.field1680 != null) {
            arg0 = (int) ((long) this.field1686 * (long) arg0 / (long) this.field1679) + 6;
        }
        return arg0;
    }
}
