...
public class class117 {
    ...
    public class117(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class178.method1609(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1683 = var4;
            this.field1684 = var5;
    ...
    @ObfuscatedName("dw.e([BB)[B")
    public byte[] method1926(byte[] arg0) {
        if (this.field1685 != null) {
            int var2 = (int) ((long) this.field1684 * (long) arg0.length / (long) this.field1683) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1683;
                var4 += var11;
                var5 = var10 - this.field1683 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("dw.o(II)I")
    public int method1923(int arg0) {
        if (this.field1685 != null) {
            arg0 = (int) ((long) this.field1684 * (long) arg0 / (long) this.field1683);
        }
        return arg0;
    }

    @ObfuscatedName("dw.m(IB)I")
    public int method1924(int arg0) {
        if (this.field1685 != null) {
            arg0 = (int) ((long) this.field1684 * (long) arg0 / (long) this.field1683) + 6;
        }
        return arg0;
    }
}
