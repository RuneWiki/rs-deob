...
public class class117 {
    ...
    public class117(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1675 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1675[var11];
    ...
    public byte[] method1964(byte[] arg0) {
        if (this.field1675 != null) {
            int var2 = (int) ((long) this.field1674 * (long) arg0.length / (long) this.field1676) + 14;
    ...
    @ObfuscatedName("dh.h(II)I")
    public int method1965(int arg0) {
        if (this.field1675 != null) {
            arg0 = (int) ((long) this.field1674 * (long) arg0 / (long) this.field1676);
        }
        return arg0;
    }

    @ObfuscatedName("dh.u(II)I")
    public int method1966(int arg0) {
        if (this.field1675 != null) {
            arg0 = (int) ((long) this.field1674 * (long) arg0 / (long) this.field1676) + 6;
        }
        return arg0;
    }
}
