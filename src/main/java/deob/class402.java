...
public class class402 implements class400 {
    ...
    @ObfuscatedName("oj.s(B)[B")
    public byte[] method6380() throws UnsupportedEncodingException {
        return this.method6390().getBytes("UTF-8");
    }

    @ObfuscatedName("oj.w(B)Ljava/lang/String;")
    public String method6390() throws UnsupportedEncodingException {
