...
public class class152 extends RuntimeException {
    ...
    @ObfuscatedName("ee.k(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2817(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2271.getCodeBase(), "clienterror.ws?c=" + Statics.field2272 + "&u=" + Statics.field2035 + "&v1=" + Statics.field2145 + "&v2=" + Statics.field2149 + "&e=" + var25);
    ...
    @ObfuscatedName("bi.q(Ljava/lang/Throwable;Ljava/lang/String;)Len;")
    public static class152 method1235(Throwable arg0, String arg1) {
        class152 var2;
        if (arg0 instanceof class152) {
            var2 = (class152) arg0;
            var2.field2273 = var2.field2273 + ' ' + arg1;
        } else {
