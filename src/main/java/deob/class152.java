...
public class class152 {
    ...
    @ObfuscatedName("ay.l(CII)C")
    public static char method678(char arg0, int arg1) {
    ...
    @ObfuscatedName("dy.b(CI)C")
    public static char method2713(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ei.o(CII)I")
    public static int method2767(char arg0, int arg1) {
        int var2 = arg0 << 4;
