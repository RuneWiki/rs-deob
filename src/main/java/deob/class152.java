...
public class class152 extends RuntimeException {
    ...
    @ObfuscatedName("cf.i(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2021(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2279.getCodeBase(), "clienterror.ws?c=" + Statics.field2274 + "&u=" + Statics.field1957 + "&v1=" + Statics.field1615 + "&v2=" + Statics.field2141 + "&e=" + var25);
    ...
    @ObfuscatedName("dq.h(Ljava/lang/Throwable;Ljava/lang/String;)Lej;")
    public static class152 method2281(Throwable arg0, String arg1) {
        class152 var2;
        if (arg0 instanceof class152) {
            var2 = (class152) arg0;
            var2.field2275 = var2.field2275 + ' ' + arg1;
        } else {
