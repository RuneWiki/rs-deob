...
public class class152 extends RuntimeException {
    ...
    @ObfuscatedName("dr.f(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2194(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2269.getCodeBase(), "clienterror.ws?c=" + Statics.field2270 + "&u=" + Statics.field2090 + "&v1=" + Statics.field2147 + "&v2=" + Statics.field2141 + "&e=" + var25);
    ...
    @ObfuscatedName("w.e(Ljava/lang/Throwable;Ljava/lang/String;)Lez;")
    public static class152 method111(Throwable arg0, String arg1) {
        class152 var2;
        if (arg0 instanceof class152) {
            var2 = (class152) arg0;
            var2.field2271 = var2.field2271 + ' ' + arg1;
        } else {
