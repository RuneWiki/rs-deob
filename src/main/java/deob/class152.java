...
public class class152 extends class142 {
    ...
    @ObfuscatedName("em.z")
    public static class100 field2274 = new class100(64);

    @ObfuscatedName("em.g")
    public static class100 field2288 = new class100(50);
    ...
    public static void method828(class86 arg0, class86 arg1) {
        Statics.field2281 = arg0;
        Statics.field1600 = arg1;
    }

    @ObfuscatedName("f.g(IB)Lem;")
    public static class152 method275(int arg0) {
        class152 var1 = (class152) field2274.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        var3.field2271 = arg0;
        if (var2 != null) {
            var3.method2328(new class135(var2));
        }
        var3.method2327();
    ...
    public void method2328(class135 arg0) {
        while (true) {
    ...
    public void method2334(class135 arg0, int arg1) {
        if (arg1 == 1) {
            ...
            if (this.field2268[arg1 - 30].equalsIgnoreCase(class74.field869)) {
    ...
    public final class180 method2330(class155 arg0, int arg1, class155 arg2, int arg3) {
        if (this.field2273 != null) {
            class152 var5 = this.method2332();
            return var5 == null ? null : var5.method2330(arg0, arg1, arg2, arg3);
        }
        class180 var6 = (class180) field2288.method1244((long) this.field2271);
        if (var6 == null) {
            boolean var7 = false;
            ...
            class179[] var9 = new class179[this.field2292.length];
            for (int var10 = 0; var10 < this.field2292.length; var10++) {
                var9[var10] = class179.method2992(Statics.field1600, this.field2292[var10], 0);
            }
            class179 var11;
            if (var9.length == 1) {
                var11 = var9[0];
    ...
    public final class179 method2331() {
        if (this.field2273 != null) {
            class152 var1 = this.method2332();
            ...
            class179[] var4 = new class179[this.field2275.length];
            for (int var5 = 0; var5 < this.field2275.length; var5++) {
                var4[var5] = class179.method2992(Statics.field1600, this.field2275[var5], 0);
            }
            class179 var6;
            if (var4.length == 1) {
                var6 = var4[0];
    ...
    public final class152 method2332() {
        int var1 = -1;
        if (this.field2297 != -1) {
            var1 = Statics.method1130(this.field2297);
        } else if (this.field2299 != -1) {
            var1 = class89.field1210[this.field2299];
        }
