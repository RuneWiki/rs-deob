...
public class class16 {
    ...
    public class16() {
        int var1 = class130.method1561(16);
        if (var1 != 1) {
            throw new RuntimeException();
        }
        int var2 = class130.method1561(5);
        int var3 = 0;
        this.field228 = new int[var2];
        for (int var4 = 0; var4 < var2; var4++) {
            int var5 = class130.method1561(4);
        ...
        for (int var6 = 0; var6 < var3; var6++) {
            this.field224[var6] = class130.method1561(3) + 1;
            int var7 = this.field225[var6] = class130.method1561(2);
            if (var7 != 0) {
                this.field226[var6] = class130.method1561(8);
            }
            int var8 = 0x1 << var7;
            int[] var9 = new int[var8];
            this.field227[var6] = var9;
            for (int var10 = 0; var10 < var8; var10++) {
                var9[var10] = class130.method1561(8) - 1;
            }
        }
        this.field221 = class130.method1561(2) + 1;
        int var11 = class130.method1561(4);
        int var12 = 2;
        ...
        for (int var15 = 0; var15 < var2; var15++) {
            ...
            for (int var17 = 0; var17 < this.field224[var16]; var17++) {
                this.field222[var14++] = class130.method1561(var11);
            }
        }
    ...
    public boolean method187() {
        ...
        int var5 = class66.method479(var4 - 1);
        Statics.field229[0] = class130.method1561(var5);
        Statics.field229[1] = class130.method1561(var5);
        int var6 = 2;
