...
@ObfuscatedName("lg")
public class class326 implements class327 {

    @ObfuscatedName("lg.f(I)Llu;")
    public class328 method5607() {
        byte var1;
        if (Statics.field2312.startsWith("win")) {
            var1 = 1;
        } else if (Statics.field2312.startsWith("mac")) {
            var1 = 2;
        } else if (Statics.field2312.startsWith("linux")) {
            var1 = 3;
        } else {
            var1 = 4;
        }
        ...
        String var35 = "";
        int[] var36 = new int[3];
        return new class328(var1, var9, var10, var11, var13, var18, var23, false, var27, var28, var29, 0, var30, var31, var32, var33, 0, 0, 0, 0, var34, var35, var36, 0, "");
    }
}
