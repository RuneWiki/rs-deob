...
public class class428 {
    ...
    public class428(float[] arg0, int arg1) {
        this.field4690 = arg0;
        this.field4689 = arg1;
    }

    @ObfuscatedName("da.af([FIFZFZ[FB)I")
    public static int method2572(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class122.field1463;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class428 var16 = new class428(var10, arg1);
            ...
            int var20 = method2572(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method7454(var10, arg1, arg2);
                ...
                var22 = method7454(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    arg6[var12++] = method4354(var16, var26, var24, 0.0F);
    ...
    @ObfuscatedName("qx.an([FIFI)F")
    public static float method7454(float[] arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("io.aw(Lqs;FFFI)F")
    public static float method4354(class428 arg0, float arg1, float arg2, float arg3) {
        float var4 = method7454(arg0.field4690, arg0.field4689, arg1);
        if (Math.abs(var4) < class122.field1463) {
            return arg1;
        }
        float var5 = method7454(arg0.field4690, arg0.field4689, arg2);
        ...
        do {
            ...
            float var13 = class122.field1464 * Math.abs(arg2) + arg3 * 0.5F;
            ...
            if (var15) {
                ...
                var5 = method7454(arg0.field4690, arg0.field4689, arg2);
