...
public class class126 extends class106 {
    ...
    @ObfuscatedName("dl.m")
    public static class103 field1623 = new class103(32);
    ...
    public static int method5(int arg0, int arg1) {
        class126 var2 = (class126) field1623.method1277((long) arg0);
        if (var2 == null) {
            return 0;
    ...
    public static void method2901(int arg0, int arg1, int arg2, int arg3) {
        class126 var4 = (class126) field1623.method1277((long) arg0);
        if (var4 == null) {
            var4 = new class126();
    ...
    public static void method55(int arg0) {
        class126 var1 = (class126) field1623.method1277((long) arg0);
        if (var1 != null) {
            var1.method1325();
        }
    }
