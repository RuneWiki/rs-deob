...
public class class126 {
    ...
    @ObfuscatedName("eq.f(IIB)I")
    public static int method2917(int arg0, int arg1) {
        if (arg1 > arg0) {
            int var2 = arg0;
            arg0 = arg1;
            arg1 = var2;
    ...
    @ObfuscatedName("bk.s(IB)I")
    public static int method1188(int arg0) {
    ...
    @ObfuscatedName("y.q(IB)I")
    public static int method575(int arg0) {
        int var6 = arg0 - 1;
    ...
    @ObfuscatedName("i.g(IB)I")
    public static int method124(int arg0) {
        int var1 = 0;
