...
public abstract class class516 {
    ...
    public class516(int arg0, int arg1) {
        this.field5178 = arg0;
        this.field5179 = 0;
        this.field5181 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field5180 = method3943(this.field5179, this.field5178, this.field5181);
    }

    @ObfuscatedName("tf.ad(I)V")
    ...
    @ObfuscatedName("tf.ah(I)D")
    public double method8410() {
        return this.field5180;
    }

    @ObfuscatedName("ia.ap(IIII)D")
    public static double method3943(int arg0, int arg1, int arg2) {
