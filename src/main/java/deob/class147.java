...
public class class147 {
    ...
    @ObfuscatedName("fz.u(Lgf;I)I")
    public static final int method3142(class185 arg0) {
        if (arg0 == null) {
            return 12;
        } else {
    ...
    @ObfuscatedName("ew.k(Ljava/lang/CharSequence;Lgf;I)Ljava/lang/String;")
    public static String method2681(CharSequence arg0, class185 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
        ...
        int var8 = var3 - var2;
        if (var8 < 1 || var8 > method3142(arg1)) {
            return null;
        }
        ...
        for (int var10 = var2; var10 < var3; var10++) {
            ...
            if (Character.isISOControl(var11)) {
                var12 = false;
            } else if (class146.method1368(var11)) {
                var12 = true;
            } else {
    ...
    @ObfuscatedName("bv.x(CI)C")
    public static char method1406(char arg0) {
        switch(arg0) {
            case ' ':
            case '-':
            case '_':
