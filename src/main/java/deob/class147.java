...
public class class147 implements Runnable {
    ...
    @ObfuscatedName("eh.p")
    public final Thread field2070 = new Thread(this);

    @ObfuscatedName("eh.i")
    public volatile boolean field2066;

    @ObfuscatedName("eh.w")
    public Queue field2068 = new LinkedList();

    public class147() {
        this.field2070.setPriority(1);
        this.field2070.start();
    }

    public void run() {
        while (!this.field2066) {
            try {
                class148 var2;
                synchronized (this) {
                    var2 = (class148) this.field2068.poll();
                    if (var2 == null) {
                        try {
                            this.wait();
                ...
                try {
                    var6 = var2.field2072.openConnection();
                ...
                class155.method1770((String) null, var21);
            }
        }
    }

    @ObfuscatedName("eh.p(Ljava/net/URL;I)Leu;")
    public class148 method2810(URL arg0) {
        class148 var2 = new class148(arg0);
        synchronized (this) {
            this.field2068.add(var2);
            this.notify();
            return var2;
        }
    }
