...
public final class class470 {
    ...
    @ObfuscatedName("rr.aj([BILjava/lang/CharSequence;I)I")
    public static int method7723(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("fr.al([BIIB)Ljava/lang/String;")
    public static String method2889(byte[] arg0, int arg1, int arg2) {
