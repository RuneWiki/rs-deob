...
public class class66 {
    ...
    public class66(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1101 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1101[var11];
    ...
    @ObfuscatedName("br.u([BI)[B")
    public byte[] method1086(byte[] arg0) {
        if (this.field1101 != null) {
            int var2 = (int) ((long) this.field1099 * (long) arg0.length / (long) this.field1106) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1101[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1099 + var5;
                int var11 = var10 / this.field1106;
                var4 += var11;
                var5 = var10 - this.field1106 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1087(int arg0) {
        if (this.field1101 != null) {
            arg0 = (int) ((long) this.field1099 * (long) arg0 / (long) this.field1106);
        }
        return arg0;
    }

    @ObfuscatedName("br.i(IS)I")
    public int method1088(int arg0) {
        if (this.field1101 != null) {
            arg0 = (int) ((long) this.field1099 * (long) arg0 / (long) this.field1106) + 6;
        }
        return arg0;
    }
}
