...
public class class66 {
    ...
    public class66(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1115 = var9;
            this.field1116 = var10;
            this.field1122 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1122[var11];
    ...
    @ObfuscatedName("bp.b([BB)[B")
    public byte[] method1159(byte[] arg0) {
        if (this.field1122 != null) {
            int var2 = (int) ((long) this.field1116 * (long) arg0.length / (long) this.field1115) + 14;
    ...
    @ObfuscatedName("bp.e(IB)I")
    public int method1160(int arg0) {
        if (this.field1122 != null) {
            arg0 = (int) ((long) this.field1116 * (long) arg0 / (long) this.field1115);
        }
        return arg0;
    }

    @ObfuscatedName("bp.c(II)I")
    public int method1161(int arg0) {
        if (this.field1122 != null) {
            arg0 = (int) ((long) this.field1116 * (long) arg0 / (long) this.field1115) + 6;
        }
        return arg0;
    }
}
