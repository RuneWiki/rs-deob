...
public class class66 {
    ...
    @ObfuscatedName("ba.p([BB)[B")
    public byte[] method1093(byte[] arg0) {
        if (this.field1107 != null) {
            int var2 = (int) ((long) this.field1110 * (long) arg0.length / (long) this.field1109) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1109;
                var4 += var11;
                var5 = var10 - this.field1109 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("ba.g(IB)I")
    public int method1092(int arg0) {
        if (this.field1107 != null) {
            arg0 = (int) ((long) this.field1110 * (long) arg0 / (long) this.field1109);
        }
        return arg0;
    }
    ...
    public int method1097(int arg0) {
        if (this.field1107 != null) {
            arg0 = (int) ((long) this.field1110 * (long) arg0 / (long) this.field1109) + 6;
        }
        return arg0;
    }
}
