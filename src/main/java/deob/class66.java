...
public class class66 {
    ...
    @ObfuscatedName("bw.x([BB)[B")
    public byte[] method1189(byte[] arg0) {
        if (this.field1113 != null) {
            int var2 = (int) ((long) this.field1119 * (long) arg0.length / (long) this.field1112) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1119 + var5;
                int var11 = var10 / this.field1112;
                var4 += var11;
                var5 = var10 - this.field1112 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bw.j(IB)I")
    public int method1190(int arg0) {
        if (this.field1113 != null) {
            arg0 = (int) ((long) this.field1119 * (long) arg0 / (long) this.field1112);
        }
        return arg0;
    }

    @ObfuscatedName("bw.c(IB)I")
    public int method1193(int arg0) {
        if (this.field1113 != null) {
            arg0 = (int) ((long) this.field1119 * (long) arg0 / (long) this.field1112) + 6;
        }
        return arg0;
    }
}
