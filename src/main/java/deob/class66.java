...
public class class66 {
    ...
    public class66(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1105 = var9;
            this.field1110 = var10;
            this.field1107 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1107[var11];
    ...
    @ObfuscatedName("ba.s([BI)[B")
    public byte[] method1080(byte[] arg0) {
        if (this.field1107 != null) {
            int var2 = (int) ((long) this.field1110 * (long) arg0.length / (long) this.field1105) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1110 + var5;
                int var11 = var10 / this.field1105;
                var4 += var11;
                var5 = var10 - this.field1105 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1075(int arg0) {
        if (this.field1107 != null) {
            arg0 = (int) ((long) this.field1110 * (long) arg0 / (long) this.field1105);
        }
        return arg0;
    }
    ...
    public int method1078(int arg0) {
        if (this.field1107 != null) {
            arg0 = (int) ((long) this.field1110 * (long) arg0 / (long) this.field1105) + 6;
        }
        return arg0;
    }
}
