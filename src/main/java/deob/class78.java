...
public class class78 {
    ...
    public class78(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1440 = var9;
            this.field1442 = var10;
            this.field1441 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1441[var11];
    ...
    @ObfuscatedName("br.a([BI)[B")
    public byte[] method1547(byte[] arg0) {
        if (this.field1441 != null) {
            int var2 = (int) ((long) this.field1442 * (long) arg0.length / (long) this.field1440) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1442 + var5;
                int var11 = var10 / this.field1440;
                var4 += var11;
                var5 = var10 - this.field1440 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("br.d(IB)I")
    public int method1548(int arg0) {
        if (this.field1441 != null) {
            arg0 = (int) ((long) this.field1442 * (long) arg0 / (long) this.field1440);
        }
        return arg0;
    }

    @ObfuscatedName("br.v(II)I")
    public int method1549(int arg0) {
        if (this.field1441 != null) {
            arg0 = (int) ((long) this.field1442 * (long) arg0 / (long) this.field1440) + 6;
        }
        return arg0;
    }
}
