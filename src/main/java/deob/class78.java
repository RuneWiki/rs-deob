...
public class class78 {
    ...
    public class78(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1407 = var9;
            this.field1408 = var10;
            this.field1409 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1409[var11];
    ...
    public byte[] method1534(byte[] arg0) {
        if (this.field1409 != null) {
            int var2 = (int) ((long) this.field1408 * (long) arg0.length / (long) this.field1407) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1409[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1408 + var5;
    ...
    @ObfuscatedName("br.r(II)I")
    public int method1547(int arg0) {
        if (this.field1409 != null) {
            arg0 = (int) ((long) this.field1408 * (long) arg0 / (long) this.field1407);
        }
        return arg0;
    }
    ...
    public int method1538(int arg0) {
        if (this.field1409 != null) {
            arg0 = (int) ((long) this.field1408 * (long) arg0 / (long) this.field1407) + 6;
        }
        return arg0;
    }
}
