...
public class class78 {
    ...
    public class78(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1444 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1444[var11];
    ...
    @ObfuscatedName("bw.m([BB)[B")
    public byte[] method1585(byte[] arg0) {
        if (this.field1444 != null) {
            int var2 = (int) ((long) this.field1450 * (long) arg0.length / (long) this.field1442) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1450 + var5;
                int var11 = var10 / this.field1442;
                var4 += var11;
                var5 = var10 - this.field1442 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bw.w(II)I")
    public int method1586(int arg0) {
        if (this.field1444 != null) {
            arg0 = (int) ((long) this.field1450 * (long) arg0 / (long) this.field1442);
        }
        return arg0;
    }

    @ObfuscatedName("bw.e(II)I")
    public int method1590(int arg0) {
        if (this.field1444 != null) {
            arg0 = (int) ((long) this.field1450 * (long) arg0 / (long) this.field1442) + 6;
        }
        return arg0;
    }
}
