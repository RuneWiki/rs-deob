...
public class class192 {
    ...
    @ObfuscatedName("fg.m(CII)C")
    public static char method3249(char arg0, int arg1) {
    ...
    @ObfuscatedName("k.k(CB)C")
    public static char method15(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("u.y(CIS)I")
    public static int method123(char arg0, int arg1) {
        int var2 = arg0 << 4;
