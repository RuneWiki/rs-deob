...
public class class192 extends class130 {
    ...
    @ObfuscatedName("gi.d")
    public static class125 field2812 = new class125(64);
    ...
    public void method3292() {
        this.method3288(this.field2814);
    }

    @ObfuscatedName("gi.d(Lfa;IB)V")
    public void method3285(class161 arg0, int arg1) {
        while (true) {
            int var3 = arg0.method2823();
            if (var3 == 0) {
                return;
            }
            this.method3287(arg0, var3, arg1);
        }
    }

    @ObfuscatedName("gi.m(Lfa;III)V")
    public void method3287(class161 arg0, int arg1, int arg2) {
        if (arg1 == 1) {
            this.field2814 = arg0.method2784();
        }
    }

    @ObfuscatedName("gi.h(II)V")
    public void method3288(int arg0) {
        ...
        this.field2815 = (int) ((double) this.field2818 * var18);
    }
}
