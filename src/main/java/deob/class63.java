...
public class class63 {
    ...
    public static float method1316(float arg0) {
    ...
    public float method1315(int arg0, int arg1, float arg2) {
        ...
        return method1316(var5);
    }

    @ObfuscatedName("bz.p(IF)I")
    public int method1319(int arg0, float arg1) {
        if (arg0 == 0) {
        ...
        field1245[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1315(arg0, 0, arg1));
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1248[0] * 2; var11++) {
                field1245[0][var11] *= Statics.field1247;
            }
        }
        for (int var12 = 0; var12 < this.field1248[arg0] * 2; var12++) {
            field1246[arg0][var12] = (int) (field1245[arg0][var12] * 65536.0F);
        }
        return this.field1248[arg0] * 2;
    }

    @ObfuscatedName("bz.i(Ldq;Lbp;)V")
    public final void method1314(class126 arg0, class55 arg1) {
        ...
        this.field1244[0] = arg0.method2627();
        this.field1244[1] = arg0.method2627();
        int var4 = arg0.method2450();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1248[var5]; var6++) {
                this.field1242[var5][0][var6] = arg0.method2627();
                this.field1243[var5][0][var6] = arg0.method2627();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1248[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1242[var7][1][var8] = arg0.method2627();
                    this.field1243[var7][1][var8] = arg0.method2627();
                }
            }
        }
