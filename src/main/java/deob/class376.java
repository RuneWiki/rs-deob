...
public final class class376 {
    ...
    @ObfuscatedName("lo.f(Ljava/lang/CharSequence;I)I")
    public static int method5224(CharSequence arg0) {
    ...
    @ObfuscatedName("lm.o([BILjava/lang/CharSequence;I)I")
    public static int method5250(byte[] arg0, int arg1, CharSequence arg2) {
