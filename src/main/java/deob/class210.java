...
public final class class210 {
    ...
    @ObfuscatedName("av.f(Ljava/lang/CharSequence;B)I")
    public static int method746(CharSequence arg0) {
    ...
    @ObfuscatedName("fv.u([BIII)Ljava/lang/String;")
    public static String method2994(byte[] arg0, int arg1, int arg2) {
