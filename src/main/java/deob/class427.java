...
public class class427 {
    ...
    public float[] field4723;

    @ObfuscatedName("qu.ad")
    public int field4724;

    public class427(float[] arg0, int arg1) {
        this.field4723 = arg0;
        this.field4724 = arg1;
    }

    @ObfuscatedName("nb.aq([FIFZFZ[FI)I")
    public static int method6406(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class132.field1545;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class427 var16 = new class427(var10, arg1);
            ...
            int var20 = method6406(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method4573(var10, arg1, arg2);
                ...
                var22 = method4573(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    arg6[var12++] = method1175(var16, var26, var24, 0.0F);
    ...
    @ObfuscatedName("km.ad([FIFI)F")
    public static float method4573(float[] arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("cy.ag(Lqu;FFFB)F")
    public static float method1175(class427 arg0, float arg1, float arg2, float arg3) {
        float var4 = method4573(arg0.field4723, arg0.field4724, arg1);
        if (Math.abs(var4) < class132.field1545) {
            return arg1;
        }
        float var5 = method4573(arg0.field4723, arg0.field4724, arg2);
        if (Math.abs(var5) < class132.field1545) {
            return arg2;
        }
        float var6 = 0.0F;
        float var7 = 0.0F;
        ...
        do {
            ...
            float var13 = class132.field1540 * Math.abs(arg2) + arg3 * 0.5F;
            ...
            if (var15) {
                ...
                var5 = method4573(arg0.field4723, arg0.field4724, arg2);
