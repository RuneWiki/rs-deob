...
public final class class254 {
    ...
    public static int[] field2799 = new int[6];

    @ObfuscatedName("js.az")
    public static int[] field2785 = new int[6];

    @ObfuscatedName("js.ag")
    public static float[] field2801 = new float[6];

    @ObfuscatedName("js.ad")
    public static int[] field2802 = new int[6];

    @ObfuscatedName("js.ac")
    public static int[] field2800 = new int[6];

    @ObfuscatedName("js.av")
    public static int[] field2804 = new int[6];

    @ObfuscatedName("js.ax")
    public static final int[][] field2788 = new int[][] { { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 2, 6 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 13, 14 } };
    ...
    public class254(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
        ...
        this.field2795 = arg0;
        this.field2796 = arg1;
        this.field2784 = arg17;
        this.field2798 = arg18;
        short var20 = 128;
        int var21 = var20 / 2;
        int var22 = var20 / 4;
        int var23 = var20 * 3 / 4;
        int[] var24 = field2788[arg0];
        int var25 = var24.length;
        this.field2797 = new int[var25];
        this.field2803 = new int[var25];
        this.field2805 = new int[var25];
        ...
        for (int var30 = 0; var30 < var25; var30++) {
            ...
            this.field2797[var30] = var32;
            this.field2803[var30] = var34;
            this.field2805[var30] = var33;
            var26[var30] = var35;
            var27[var30] = var36;
        }
        int[] var37 = field2806[arg0];
        int var38 = var37.length / 4;
        this.field2790 = new int[var38];
        this.field2791 = new int[var38];
        this.field2792 = new int[var38];
        this.field2787 = new int[var38];
        this.field2794 = new int[var38];
        this.field2789 = new int[var38];
        if (arg2 != -1) {
            this.field2793 = new int[var38];
        }
        int var39 = 0;
        for (int var40 = 0; var40 < var38; var40++) {
            ...
            this.field2790[var40] = var42;
            this.field2791[var40] = var43;
            this.field2792[var40] = var44;
            if (var41 == 0) {
                this.field2787[var40] = var26[var42];
                this.field2794[var40] = var26[var43];
                this.field2789[var40] = var26[var44];
                if (this.field2793 != null) {
                    this.field2793[var40] = -1;
                }
            } else {
                this.field2787[var40] = var27[var42];
                this.field2794[var40] = var27[var43];
                this.field2789[var40] = var27[var44];
                if (this.field2793 != null) {
                    this.field2793[var40] = arg2;
                }
            }
        }
        int var45 = arg5;
