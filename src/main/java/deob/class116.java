...
public class class116 {
    ...
    public class116(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1597 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1597[var11];
    ...
    @ObfuscatedName("dc.n([BB)[B")
    public byte[] method1991(byte[] arg0) {
        if (this.field1597 != null) {
            int var2 = (int) ((long) this.field1600 * (long) arg0.length / (long) this.field1595) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1597[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1600 + var5;
                int var11 = var10 / this.field1595;
                var4 += var11;
                var5 = var10 - this.field1595 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("dc.v(II)I")
    public int method1987(int arg0) {
        if (this.field1597 != null) {
            arg0 = (int) ((long) this.field1600 * (long) arg0 / (long) this.field1595);
        }
        return arg0;
    }

    @ObfuscatedName("dc.y(IB)I")
    public int method1986(int arg0) {
        if (this.field1597 != null) {
            arg0 = (int) ((long) this.field1600 * (long) arg0 / (long) this.field1595) + 6;
        }
        return arg0;
    }
}
