...
public class class116 {
    ...
    public class116(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class179.method2715(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1690 = var4;
            this.field1693 = var5;
            this.field1694 = new int[var4][14];
    ...
    @ObfuscatedName("di.i([BI)[B")
    public byte[] method1939(byte[] arg0) {
        if (this.field1694 != null) {
            int var2 = (int) ((long) this.field1693 * (long) arg0.length / (long) this.field1690) + 14;
    ...
    @ObfuscatedName("di.j(II)I")
    public int method1949(int arg0) {
        if (this.field1694 != null) {
            arg0 = (int) ((long) this.field1693 * (long) arg0 / (long) this.field1690);
        }
        return arg0;
    }
    ...
    public int method1941(int arg0) {
        if (this.field1694 != null) {
            arg0 = (int) ((long) this.field1693 * (long) arg0 / (long) this.field1690) + 6;
        }
        return arg0;
    }
}
