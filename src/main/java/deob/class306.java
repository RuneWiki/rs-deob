...
public class class306 {
    ...
    @ObfuscatedName("kb.q")
    public static final char[] field3785 = new char[] { ' ', ' ', '_', '-', 'à', 'á', 'â', 'ä', 'ã', 'À', 'Á', 'Â', 'Ä', 'Ã', 'è', 'é', 'ê', 'ë', 'È', 'É', 'Ê', 'Ë', 'í', 'î', 'ï', 'Í', 'Î', 'Ï', 'ò', 'ó', 'ô', 'ö', 'õ', 'Ò', 'Ó', 'Ô', 'Ö', 'Õ', 'ù', 'ú', 'û', 'ü', 'Ù', 'Ú', 'Û', 'Ü', 'ç', 'Ç', 'ÿ', 'Ÿ', 'ñ', 'Ñ', 'ß' };
    ...
    @ObfuscatedName("bm.m(Ljava/lang/CharSequence;Llx;I)Ljava/lang/String;")
    public static String method1091(CharSequence arg0, class335 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
            ...
            if (var8 <= var10) {
                ...
                for (int var12 = var2; var12 < var3; var12++) {
                    ...
                    if (Character.isISOControl(var13)) {
                        var14 = false;
                    } else if (class309.method4393(var13)) {
                        var14 = true;
                    } else {
                        char[] var15 = field3785;
                        int var16 = 0;
                        label97: while (true) {
                            if (var16 >= var15.length) {
                                char[] var18 = field3786;
