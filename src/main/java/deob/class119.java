...
public class class119 {
    ...
    public class119(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1678 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1678[var11];
    ...
    @ObfuscatedName("de.d([BI)[B")
    public byte[] method1989(byte[] arg0) {
        if (this.field1678 != null) {
            int var2 = (int) ((long) this.field1675 * (long) arg0.length / (long) this.field1676) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1678[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1675 + var5;
                int var11 = var10 / this.field1676;
                var4 += var11;
                var5 = var10 - this.field1676 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("de.q(IB)I")
    public int method1990(int arg0) {
        if (this.field1678 != null) {
            arg0 = (int) ((long) this.field1675 * (long) arg0 / (long) this.field1676);
        }
        return arg0;
    }

    @ObfuscatedName("de.x(IB)I")
    public int method1997(int arg0) {
        if (this.field1678 != null) {
            arg0 = (int) ((long) this.field1675 * (long) arg0 / (long) this.field1676) + 6;
        }
        return arg0;
    }
}
