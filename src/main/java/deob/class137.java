...
public class class137 extends RuntimeException {
    ...
    @ObfuscatedName("z.e(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method101(String arg0, Throwable arg1) {
        try {
            ...
            URL var26 = new URL(Statics.field2084.getCodeBase(), "clienterror.ws?c=" + Statics.field2083 + "&u=" + Statics.field2082 + "&v1=" + Statics.field1944 + "&v2=" + Statics.field1943 + "&e=" + var25);
    ...
    @ObfuscatedName("client.v(Ljava/lang/Throwable;Ljava/lang/String;)Leb;")
    public static class137 method383(Throwable arg0, String arg1) {
        class137 var2;
        if (arg0 instanceof class137) {
            var2 = (class137) arg0;
            var2.field2089 = var2.field2089 + ' ' + arg1;
        } else {
