...
public class class137 extends RuntimeException {
    ...
    @ObfuscatedName("dh.g(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2362(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
                String var5;
                if (arg1 instanceof class137) {
                    class137 var4 = (class137) arg1;
                    var5 = var4.field2066 + " | ";
                    var3 = var4.field2064;
                } else {
                    var5 = "";
            ...
            URL var26 = new URL(Statics.field2068.getCodeBase(), "clienterror.ws?c=" + Statics.field1888 + "&u=" + Statics.field2062 + "&v1=" + Statics.field1937 + "&v2=" + Statics.field1929 + "&e=" + var25);
    ...
    @ObfuscatedName("bc.j(Ljava/lang/Throwable;Ljava/lang/String;)Leq;")
    public static class137 method1351(Throwable arg0, String arg1) {
        class137 var2;
        if (arg0 instanceof class137) {
            var2 = (class137) arg0;
            var2.field2066 = var2.field2066 + ' ' + arg1;
        } else {
