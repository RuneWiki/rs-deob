...
public class class271 {
    ...
    static {
        ...
        for (int var3 = 0; var3 < 26; var3++) {
            field3663[var3] = (char) (var3 + 65);
        }
        for (int var4 = 26; var4 < 52; var4++) {
            field3663[var4] = (char) (var4 + 97 - 26);
        }
        for (int var5 = 52; var5 < 62; var5++) {
            field3663[var5] = (char) (var5 + 48 - 52);
        }
        field3663[62] = '*';
        field3663[63] = '-';
    ...
    @ObfuscatedName("fd.e([BB)Ljava/lang/String;")
    public static String method2902(byte[] arg0) {
        int var1 = arg0.length;
        StringBuilder var2 = new StringBuilder();
        for (int var3 = 0; var3 < var1; var3 += 3) {
            int var4 = arg0[var3] & 0xFF;
            var2.append(field3666[var4 >>> 2]);
            if (var3 < var1 - 1) {
                int var5 = arg0[var3 + 1] & 0xFF;
                var2.append(field3666[(var4 & 0x3) << 4 | var5 >>> 4]);
                if (var3 < var1 - 2) {
                    int var6 = arg0[var3 + 2] & 0xFF;
                    var2.append(field3666[(var5 & 0xF) << 2 | var6 >>> 6]).append(field3666[var6 & 0x3F]);
                } else {
                    var2.append(field3666[(var5 & 0xF) << 2]).append("=");
                }
            } else {
                var2.append(field3666[(var4 & 0x3) << 4]).append("==");
            }
        }
