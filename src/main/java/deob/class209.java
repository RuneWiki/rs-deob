...
public final class class209 {
    ...
    @ObfuscatedName("gw.i(Ljava/lang/CharSequence;I)I")
    public static int method3414(CharSequence arg0) {
    ...
    @ObfuscatedName("q.v([BILjava/lang/CharSequence;B)I")
    public static int method581(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("dy.f([BIII)Ljava/lang/String;")
    public static String method2223(byte[] arg0, int arg1, int arg2) {
