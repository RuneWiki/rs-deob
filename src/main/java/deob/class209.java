...
public final class class209 {
    ...
    @ObfuscatedName("as.k(Ljava/lang/CharSequence;I)I")
    public static int method616(CharSequence arg0) {
    ...
    @ObfuscatedName("ai.h([BIIB)Ljava/lang/String;")
    public static String method908(byte[] arg0, int arg1, int arg2) {
