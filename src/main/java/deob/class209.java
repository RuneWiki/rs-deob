...
public final class class209 {
    ...
    @ObfuscatedName("as.m(Ljava/lang/CharSequence;I)I")
    public static int method1031(CharSequence arg0) {
    ...
    @ObfuscatedName("fi.l([BIII)Ljava/lang/String;")
    public static String method3020(byte[] arg0, int arg1, int arg2) {
