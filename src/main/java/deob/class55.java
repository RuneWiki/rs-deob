...
@ObfuscatedName("cz")
public class class55 extends class506 {
    ...
    @ObfuscatedName("cz.ab(I)F")
    public static float method1009(int arg0) {
    ...
    public void method1015(byte[] arg0) {
        ...
        this.field348 = var2.method8803();
        this.field349 = var2.method8803();
        this.field350 = var2.method8803();
        this.field371 = var2.method8803();
        if (this.field371 < 0) {
            this.field371 = ~this.field371;
            this.field351 = true;
        }
        int var3 = var2.method8803();
        this.field373 = new byte[var3][];
        for (int var4 = 0; var4 < var3; var4++) {
            int var5 = 0;
            int var6;
            do {
                var6 = var2.method9025();
                var5 += var6;
            } while (var6 >= 255);
            byte[] var7 = new byte[var5];
            var2.method8811(var7, 0, var5);
            this.field373[var4] = var7;
        }
    }

    @ObfuscatedName("cz.an([B)V")
    public static void method1004(byte[] arg0) {
        class61 var1 = field353;
        var1.method1084(arg0, 0);
        Statics.field354 = 0x1 << var1.method1091(4);
        Statics.field355 = 0x1 << var1.method1091(4);
        for (int var2 = 0; var2 < 2; var2++) {
            int var3 = var2 == 0 ? Statics.field354 : Statics.field355;
            int var4 = var3 >> 1;
            int var5 = var3 >> 2;
            int var6 = var3 >> 3;
            ...
            int var14 = class331.method3332(var6 - 1);
            for (int var15 = 0; var15 < var6; var15++) {
                var13[var15] = class331.method2472(var15, var14);
            }
            if (var2 == 0) {
                Statics.field352 = var7;
                Statics.field356 = var9;
                Statics.field370 = var11;
                Statics.field374 = var13;
            } else {
                Statics.field347 = var7;
                Statics.field358 = var9;
                Statics.field376 = var11;
                Statics.field368 = var13;
            }
        }
        int var16 = var1.method1091(8) + 1;
        Statics.field378 = new class53[var16];
        for (int var17 = 0; var17 < var16; var17++) {
            Statics.field378[var17] = new class53();
        }
        int var18 = var1.method1091(6) + 1;
        for (int var19 = 0; var19 < var18; var19++) {
            var1.method1091(16);
        }
        int var20 = var1.method1091(6) + 1;
        Statics.field357 = new class42[var20];
        for (int var21 = 0; var21 < var20; var21++) {
            Statics.field357[var21] = new class42();
        }
        int var22 = var1.method1091(6) + 1;
        Statics.field369 = new class47[var22];
        for (int var23 = 0; var23 < var22; var23++) {
            Statics.field369[var23] = new class47();
        }
        int var24 = var1.method1091(6) + 1;
        Statics.field359 = new class51[var24];
        for (int var25 = 0; var25 < var24; var25++) {
            Statics.field359[var25] = new class51();
        }
        int var26 = var1.method1091(6) + 1;
        Statics.field360 = new boolean[var26];
        Statics.field361 = new int[var26];
        for (int var27 = 0; var27 < var26; var27++) {
            Statics.field360[var27] = var1.method1083() != 0;
            var1.method1091(16);
            var1.method1091(16);
            Statics.field361[var27] = var1.method1091(8);
        }
    }

    @ObfuscatedName("cz.au(I)[F")
    public float[] method1011(int arg0) {
        class61 var2 = new class61();
        var2.method1084(this.field373[arg0], 0);
        this.field367 = new float[Statics.field355];
        var2.method1083();
        int var3 = var2.method1091(class331.method3332(Statics.field361.length - 1));
        boolean var4 = Statics.field360[var3];
        int var5 = var4 ? Statics.field355 : Statics.field354;
        boolean var6 = false;
        boolean var7 = false;
        if (var4) {
        ...
        int var11;
        if (var4 && !var6) {
            var9 = (var5 >> 2) - (Statics.field354 >> 2);
            var10 = (Statics.field354 >> 2) + (var5 >> 2);
            var11 = Statics.field354 >> 1;
        } else {
            var9 = 0;
            var10 = var8;
            var11 = var5 >> 1;
        ...
        int var14;
        if (var4 && !var7) {
            var12 = var5 - (var5 >> 2) - (Statics.field354 >> 2);
            var13 = (Statics.field354 >> 2) + (var5 - (var5 >> 2));
            var14 = Statics.field354 >> 1;
        } else {
            var12 = var8;
            var13 = var5;
            var14 = var5 >> 1;
        }
        class51 var15 = Statics.field359[Statics.field361[var3]];
        int var16 = var15.field333;
        int var17 = var15.field335[var16];
        class60 var18 = Statics.field357[var17].method730(var2);
        boolean var19 = !var18.method1075();
        for (int var20 = 0; var20 < var15.field334; var20++) {
            class47 var21 = Statics.field369[var15.field336[var20]];
            float[] var22 = this.field367;
            var21.method820(var22, var5 >> 1, var19, var2);
        }
        if (var18.method1075()) {
            int var23 = var15.field333;
            int var10000 = var15.field335[var23];
            var18.method1063(this.field367, var5 >> 1);
        }
        if (var18.method1075()) {
            int var26 = var5 >> 1;
            int var27 = var5 >> 2;
            int var28 = var5 >> 3;
            float[] var29 = this.field367;
            ...
            float[] var32 = var4 ? Statics.field347 : Statics.field352;
            float[] var33 = var4 ? Statics.field358 : Statics.field356;
            float[] var34 = var4 ? Statics.field376 : Statics.field370;
            int[] var35 = var4 ? Statics.field368 : Statics.field374;
            ...
            int var48 = class331.method3332(var5 - 1);
            ...
            for (int var87 = var9; var87 < var10; var87++) {
                ...
                this.field367[var87] *= (float) Math.sin((double) var88 * 1.5707963267948966D * (double) var88);
            }
            for (int var89 = var12; var89 < var13; var89++) {
                ...
                this.field367[var89] *= (float) Math.sin((double) var90 * 1.5707963267948966D * (double) var90);
            }
        } else {
            for (int var25 = var5 >> 1; var25 < var5; var25++) {
                this.field367[var25] = 0.0F;
            }
        }
        float[] var91 = null;
        if (this.field364 > 0) {
            int var92 = this.field364 + var5 >> 2;
            var91 = new float[var92];
            if (!this.field366) {
                for (int var93 = 0; var93 < this.field375; var93++) {
                    int var94 = (this.field364 >> 1) + var93;
                    var91[var93] += this.field363[var94];
                }
            }
            if (var18.method1075()) {
                for (int var95 = var9; var95 < var5 >> 1; var95++) {
                    int var96 = var91.length - (var5 >> 1) + var95;
                    var91[var96] += this.field367[var95];
                }
            }
        }
        float[] var97 = this.field363;
        this.field363 = this.field367;
        this.field367 = var97;
        this.field364 = var5;
        this.field375 = var13 - (var5 >> 1);
        this.field366 = !var18.method1075();
        return var91;
    }

    @ObfuscatedName("cz.ax(Lob;)Z")
    public static boolean method1002(class389 arg0) {
        if (!field362) {
            byte[] var1 = arg0.method6670(0, 0);
            if (var1 == null) {
                return false;
            }
            method1004(var1);
    ...
    @ObfuscatedName("cz.ao(Lob;II)Lcz;")
    public static class55 method1003(class389 arg0, int arg1, int arg2) {
        if (method1002(arg0)) {
            byte[] var3 = arg0.method6670(arg1, arg2);
            return var3 == null ? null : new class55(var3);
        } else {
            arg0.method6656(arg1, arg2);
            return null;
        }
    }
    ...
    @ObfuscatedName("cz.am([I)Lbq;")
    public class41 method998(int[] arg0) {
        if (arg0 != null && arg0[0] <= 0) {
            return null;
        }
        if (this.field372 == null) {
            this.field364 = 0;
            this.field363 = new float[Statics.field355];
            this.field372 = new byte[this.field349];
            this.field377 = 0;
            this.field365 = 0;
        }
        while (this.field365 < this.field373.length) {
            if (arg0 != null && arg0[0] <= 0) {
                return null;
            }
            float[] var2 = this.method1011(this.field365);
            if (var2 != null) {
                int var3 = this.field377;
                int var4 = var2.length;
                if (var4 > this.field349 - var3) {
                ...
                for (int var5 = 0; var5 < var4; var5++) {
                    ...
                    this.field372[var3++] = (byte) (var6 - 128);
                }
                if (arg0 != null) {
                    arg0[0] -= var3 - this.field377;
                }
                this.field377 = var3;
            }
            this.field365++;
        ...
        this.field363 = null;
        byte[] var7 = this.field372;
        this.field372 = null;
        return new class41(this.field348, var7, this.field350, this.field371, this.field351);
    }
}
