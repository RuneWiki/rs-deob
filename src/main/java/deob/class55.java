...
@ObfuscatedName("cw")
public class class55 extends class488 {
    ...
    @ObfuscatedName("cw.ac(I)F")
    public static float method1033(int arg0) {
    ...
    @ObfuscatedName("cw.al([B)V")
    public void method1019(byte[] arg0) {
        class530 var2 = new class530(arg0);
        this.field389 = var2.method8371();
        this.field390 = var2.method8371();
        this.field403 = var2.method8371();
        this.field392 = var2.method8371();
        if (this.field392 < 0) {
            this.field392 = ~this.field392;
            this.field419 = true;
        }
        int var3 = var2.method8371();
        this.field411 = new byte[var3][];
        for (int var4 = 0; var4 < var3; var4++) {
            int var5 = 0;
            int var6;
            do {
                var6 = var2.method8365();
                var5 += var6;
            } while (var6 >= 255);
            byte[] var7 = new byte[var5];
            var2.method8379(var7, 0, var5);
            this.field411[var4] = var7;
        }
    }

    @ObfuscatedName("cw.ak([B)V")
    public static void method1024(byte[] arg0) {
        class61 var1 = field406;
        var1.method1101(arg0, 0);
        Statics.field395 = 0x1 << var1.method1098(4);
        Statics.field407 = 0x1 << var1.method1098(4);
        for (int var2 = 0; var2 < 2; var2++) {
            int var3 = var2 == 0 ? Statics.field395 : Statics.field407;
            int var4 = var3 >> 1;
            int var5 = var3 >> 2;
            int var6 = var3 >> 3;
            ...
            int var14 = class318.method3183(var6 - 1);
        ...
        int var22 = var1.method1098(8) + 1;
        Statics.field397 = new class53[var22];
        for (int var23 = 0; var23 < var22; var23++) {
            Statics.field397[var23] = new class53();
        }
        int var24 = var1.method1098(6) + 1;
        for (int var25 = 0; var25 < var24; var25++) {
            var1.method1098(16);
        }
        int var26 = var1.method1098(6) + 1;
        Statics.field398 = new class42[var26];
        for (int var27 = 0; var27 < var26; var27++) {
            Statics.field398[var27] = new class42();
        }
        int var28 = var1.method1098(6) + 1;
        Statics.field399 = new class47[var28];
        for (int var29 = 0; var29 < var28; var29++) {
            Statics.field399[var29] = new class47();
        }
        int var30 = var1.method1098(6) + 1;
        Statics.field400 = new class51[var30];
        for (int var31 = 0; var31 < var30; var31++) {
            Statics.field400[var31] = new class51();
        }
        int var32 = var1.method1098(6) + 1;
        Statics.field401 = new boolean[var32];
        Statics.field396 = new int[var32];
        for (int var33 = 0; var33 < var32; var33++) {
            Statics.field401[var33] = var1.method1099() != 0;
            var1.method1098(16);
            var1.method1098(16);
            Statics.field396[var33] = var1.method1098(8);
        }
    }

    @ObfuscatedName("cw.ax(I)[F")
    public float[] method1021(int arg0) {
        class61 var2 = new class61();
        var2.method1101(this.field411[arg0], 0);
        this.field408 = new float[Statics.field407];
        var2.method1099();
        int var3 = var2.method1098(class318.method3183(Statics.field396.length - 1));
        boolean var4 = Statics.field401[var3];
        int var5 = var4 ? Statics.field407 : Statics.field395;
        boolean var6 = false;
        boolean var7 = false;
        if (var4) {
            var6 = var2.method1099() != 0;
            var7 = var2.method1099() != 0;
        }
        int var8 = var5 >> 1;
        int var9;
        int var10;
        ...
        class51 var15 = Statics.field400[Statics.field396[var3]];
        int var16 = var15.field371;
        int var17 = var15.field373[var16];
        class60 var18 = Statics.field398[var17].method762(var2);
        boolean var19 = !var18.method1088();
        for (int var20 = 0; var20 < var15.field372; var20++) {
            class47 var21 = Statics.field399[var15.field370[var20]];
            float[] var22 = this.field408;
            var21.method837(var22, var5 >> 1, var19, var2);
        }
        if (var18.method1088()) {
            int var23 = var15.field371;
            int var10000 = var15.field373[var23];
            var18.method1087(this.field408, var5 >> 1);
        }
        if (var18.method1088()) {
            int var26 = var5 >> 1;
            int var27 = var5 >> 2;
            int var28 = var5 >> 3;
            float[] var29 = this.field408;
            ...
            float[] var32 = var4 ? Statics.field412 : Statics.field402;
            float[] var33 = var4 ? Statics.field413 : Statics.field410;
            float[] var34 = var4 ? Statics.field414 : Statics.field393;
            int[] var35 = var4 ? Statics.field415 : Statics.field394;
            ...
            int var48 = class318.method3183(var5 - 1);
            ...
            for (int var87 = var9; var87 < var10; var87++) {
                ...
                this.field408[var87] *= (float) Math.sin((double) var88 * 1.5707963267948966D * (double) var88);
            }
            for (int var89 = var12; var89 < var13; var89++) {
                ...
                this.field408[var89] *= (float) Math.sin((double) var90 * 1.5707963267948966D * (double) var90);
            }
        } else {
            for (int var25 = var5 >> 1; var25 < var5; var25++) {
                this.field408[var25] = 0.0F;
            }
        }
        float[] var91 = null;
        if (this.field405 > 0) {
            ...
            if (!this.field409) {
                for (int var93 = 0; var93 < this.field391; var93++) {
                    int var94 = (this.field405 >> 1) + var93;
                    var91[var93] += this.field404[var94];
                }
            }
            if (var18.method1088()) {
                for (int var95 = var9; var95 < var5 >> 1; var95++) {
                    int var96 = var91.length - (var5 >> 1) + var95;
                    var91[var96] += this.field408[var95];
                }
            }
        }
        float[] var97 = this.field404;
        this.field404 = this.field408;
        this.field408 = var97;
        this.field405 = var5;
        this.field391 = var13 - (var5 >> 1);
        this.field409 = !var18.method1088();
        return var91;
    }

    @ObfuscatedName("cw.ao(Lom;)Z")
    public static boolean method1018(class374 arg0) {
        if (!field416) {
            byte[] var1 = arg0.method6342(0, 0);
            if (var1 == null) {
                return false;
            }
            method1024(var1);
    ...
    @ObfuscatedName("cw.ah(Lom;II)Lcw;")
    public static class55 method1023(class374 arg0, int arg1, int arg2) {
        if (method1018(arg0)) {
            byte[] var3 = arg0.method6342(arg1, arg2);
            return var3 == null ? null : new class55(var3);
        } else {
            arg0.method6265(arg1, arg2);
            return null;
        }
    }
    ...
    @ObfuscatedName("cw.ar([I)Lbs;")
    public class41 method1025(int[] arg0) {
        if (arg0 != null && arg0[0] <= 0) {
            return null;
        }
        if (this.field417 == null) {
            this.field405 = 0;
            this.field404 = new float[Statics.field407];
            this.field417 = new byte[this.field390];
            this.field418 = 0;
            this.field388 = 0;
        }
        while (this.field388 < this.field411.length) {
            if (arg0 != null && arg0[0] <= 0) {
                return null;
            }
            float[] var2 = this.method1021(this.field388);
            if (var2 != null) {
        ...
        this.field417 = null;
        return new class41(this.field389, var7, this.field403, this.field392, this.field419);
    }
}
