...
@ObfuscatedName("ci")
public class class55 extends class489 {
    ...
    @ObfuscatedName("ci.am(I)F")
    public static float method1063(int arg0) {
    ...
    @ObfuscatedName("ci.ap([B)V")
    public void method1051(byte[] arg0) {
        class531 var2 = new class531(arg0);
        this.field398 = var2.method8566();
        this.field390 = var2.method8566();
        this.field374 = var2.method8566();
        this.field395 = var2.method8566();
        if (this.field395 < 0) {
            this.field395 = ~this.field395;
            this.field376 = true;
        }
        int var3 = var2.method8566();
        this.field373 = new byte[var3][];
        for (int var4 = 0; var4 < var3; var4++) {
            int var5 = 0;
            int var6;
            do {
                var6 = var2.method8561();
                var5 += var6;
            } while (var6 >= 255);
            byte[] var7 = new byte[var5];
            var2.method8659(var7, 0, var5);
            this.field373[var4] = var7;
        }
    }

    @ObfuscatedName("ci.af([B)V")
    public static void method1052(byte[] arg0) {
        class61 var1 = field377;
        var1.method1128(arg0, 0);
        Statics.field378 = 0x1 << var1.method1129(4);
        Statics.field379 = 0x1 << var1.method1129(4);
        for (int var2 = 0; var2 < 2; var2++) {
            int var3 = var2 == 0 ? Statics.field378 : Statics.field379;
            int var4 = var3 >> 1;
            int var5 = var3 >> 2;
            int var6 = var3 >> 3;
            ...
            int var14 = class318.method3466(var6 - 1);
            for (int var15 = 0; var15 < var6; var15++) {
                var13[var15] = class318.method2263(var15, var14);
            }
            if (var2 == 0) {
                Statics.field392 = var7;
                Statics.field372 = var9;
                Statics.field393 = var11;
                Statics.field391 = var13;
            } else {
                Statics.field400 = var7;
                Statics.field396 = var9;
                Statics.field397 = var11;
                Statics.field371 = var13;
            }
        }
        int var16 = var1.method1129(8) + 1;
        Statics.field380 = new class53[var16];
        for (int var17 = 0; var17 < var16; var17++) {
            Statics.field380[var17] = new class53();
        }
        int var18 = var1.method1129(6) + 1;
        for (int var19 = 0; var19 < var18; var19++) {
            var1.method1129(16);
        }
        int var20 = var1.method1129(6) + 1;
        Statics.field381 = new class42[var20];
        for (int var21 = 0; var21 < var20; var21++) {
            Statics.field381[var21] = new class42();
        }
        int var22 = var1.method1129(6) + 1;
        Statics.field382 = new class47[var22];
        for (int var23 = 0; var23 < var22; var23++) {
            Statics.field382[var23] = new class47();
        }
        int var24 = var1.method1129(6) + 1;
        Statics.field399 = new class51[var24];
        for (int var25 = 0; var25 < var24; var25++) {
            Statics.field399[var25] = new class51();
        }
        int var26 = var1.method1129(6) + 1;
        Statics.field384 = new boolean[var26];
        Statics.field385 = new int[var26];
        for (int var27 = 0; var27 < var26; var27++) {
            Statics.field384[var27] = var1.method1130() != 0;
            var1.method1129(16);
            var1.method1129(16);
            Statics.field385[var27] = var1.method1129(8);
        }
    }

    @ObfuscatedName("ci.aj(I)[F")
    public float[] method1053(int arg0) {
        class61 var2 = new class61();
        var2.method1128(this.field373[arg0], 0);
        this.field375 = new float[Statics.field379];
        var2.method1130();
        int var3 = var2.method1129(class318.method3466(Statics.field385.length - 1));
        boolean var4 = Statics.field384[var3];
        int var5 = var4 ? Statics.field379 : Statics.field378;
        boolean var6 = false;
        boolean var7 = false;
        if (var4) {
            var6 = var2.method1130() != 0;
            var7 = var2.method1130() != 0;
        }
        int var8 = var5 >> 1;
        int var9;
        int var10;
        ...
        class51 var15 = Statics.field399[Statics.field385[var3]];
        int var16 = var15.field359;
        int var17 = var15.field360[var16];
        class60 var18 = Statics.field381[var17].method788(var2);
        boolean var19 = !var18.method1110();
        for (int var20 = 0; var20 < var15.field361; var20++) {
            class47 var21 = Statics.field382[var15.field358[var20]];
            float[] var22 = this.field375;
            var21.method880(var22, var5 >> 1, var19, var2);
        }
        if (var18.method1110()) {
            int var23 = var15.field359;
            int var10000 = var15.field360[var23];
            var18.method1109(this.field375, var5 >> 1);
        }
        if (var18.method1110()) {
            int var26 = var5 >> 1;
            int var27 = var5 >> 2;
            int var28 = var5 >> 3;
            float[] var29 = this.field375;
            ...
            float[] var32 = var4 ? Statics.field400 : Statics.field392;
            float[] var33 = var4 ? Statics.field396 : Statics.field372;
            float[] var34 = var4 ? Statics.field397 : Statics.field393;
            int[] var35 = var4 ? Statics.field371 : Statics.field391;
            ...
            int var48 = class318.method3466(var5 - 1);
            ...
            for (int var87 = var9; var87 < var10; var87++) {
                ...
                this.field375[var87] *= (float) Math.sin((double) var88 * 1.5707963267948966D * (double) var88);
            }
            for (int var89 = var12; var89 < var13; var89++) {
                ...
                this.field375[var89] *= (float) Math.sin((double) var90 * 1.5707963267948966D * (double) var90);
            }
        } else {
            for (int var25 = var5 >> 1; var25 < var5; var25++) {
                this.field375[var25] = 0.0F;
            }
        }
        float[] var91 = null;
        if (this.field388 > 0) {
            int var92 = this.field388 + var5 >> 2;
            var91 = new float[var92];
            if (!this.field383) {
                for (int var93 = 0; var93 < this.field389; var93++) {
                    int var94 = (this.field388 >> 1) + var93;
                    var91[var93] += this.field387[var94];
                }
            }
            if (var18.method1110()) {
                for (int var95 = var9; var95 < var5 >> 1; var95++) {
                    int var96 = var91.length - (var5 >> 1) + var95;
                    var91[var96] += this.field375[var95];
                }
            }
        }
        float[] var97 = this.field387;
        this.field387 = this.field375;
        this.field375 = var97;
        this.field388 = var5;
        this.field389 = var13 - (var5 >> 1);
        this.field383 = !var18.method1110();
        return var91;
    }

    @ObfuscatedName("ci.aq(Low;)Z")
    public static boolean method1054(class375 arg0) {
        if (!field386) {
            byte[] var1 = arg0.method6396(0, 0);
            if (var1 == null) {
                return false;
            }
            method1052(var1);
    ...
    @ObfuscatedName("ci.ar(Low;II)Lci;")
    public static class55 method1055(class375 arg0, int arg1, int arg2) {
        if (method1054(arg0)) {
            byte[] var3 = arg0.method6396(arg1, arg2);
            return var3 == null ? null : new class55(var3);
        } else {
            arg0.method6431(arg1, arg2);
            return null;
        }
    }
    ...
    @ObfuscatedName("ci.ag([I)Lbm;")
    public class41 method1056(int[] arg0) {
        if (arg0 != null && arg0[0] <= 0) {
            return null;
        }
        if (this.field394 == null) {
            this.field388 = 0;
            this.field387 = new float[Statics.field379];
            this.field394 = new byte[this.field390];
            this.field401 = 0;
            this.field402 = 0;
        }
        while (this.field402 < this.field373.length) {
            if (arg0 != null && arg0[0] <= 0) {
                return null;
            }
            float[] var2 = this.method1053(this.field402);
            if (var2 != null) {
                int var3 = this.field401;
                int var4 = var2.length;
                if (var4 > this.field390 - var3) {
                    var4 = this.field390 - var3;
                }
        ...
        this.field394 = null;
        return new class41(this.field398, var7, this.field374, this.field395, this.field376);
    }
}
