...
@ObfuscatedName("cf")
public class class55 extends class508 {
    ...
    @ObfuscatedName("cf.ac(I)F")
    public static float method1047(int arg0) {
    ...
    public void method1054(byte[] arg0) {
        class551 var2 = new class551(arg0);
        this.field360 = var2.method9110();
        this.field361 = var2.method9110();
        this.field362 = var2.method9110();
        this.field386 = var2.method9110();
        if (this.field386 < 0) {
            this.field386 = ~this.field386;
            this.field377 = true;
        }
        int var3 = var2.method9110();
        this.field366 = new byte[var3][];
        for (int var4 = 0; var4 < var3; var4++) {
            int var5 = 0;
            int var6;
            do {
                var6 = var2.method8955();
                var5 += var6;
            } while (var6 >= 255);
            byte[] var7 = new byte[var5];
            var2.method9170(var7, 0, var5);
    ...
    public static void method1042(byte[] arg0) {
        class61 var1 = field365;
        var1.method1124(arg0, 0);
        Statics.field371 = 0x1 << var1.method1117(4);
        Statics.field367 = 0x1 << var1.method1117(4);
        for (int var2 = 0; var2 < 2; var2++) {
            int var3 = var2 == 0 ? Statics.field371 : Statics.field367;
            int var4 = var3 >> 1;
            int var5 = var3 >> 2;
            int var6 = var3 >> 3;
            ...
            int var14 = class333.method1821(var6 - 1);
            ...
            if (var2 == 0) {
                Statics.field380 = var7;
                Statics.field381 = var9;
                Statics.field382 = var11;
                Statics.field363 = var13;
            } else {
                Statics.field383 = var7;
                Statics.field384 = var9;
                Statics.field373 = var11;
                Statics.field387 = var13;
            }
        }
        int var22 = var1.method1117(8) + 1;
        Statics.field368 = new class53[var22];
        for (int var23 = 0; var23 < var22; var23++) {
            Statics.field368[var23] = new class53();
        }
        int var24 = var1.method1117(6) + 1;
        for (int var25 = 0; var25 < var24; var25++) {
            var1.method1117(16);
        }
        int var26 = var1.method1117(6) + 1;
        Statics.field369 = new class42[var26];
        for (int var27 = 0; var27 < var26; var27++) {
            Statics.field369[var27] = new class42();
        }
        int var28 = var1.method1117(6) + 1;
        Statics.field370 = new class47[var28];
        for (int var29 = 0; var29 < var28; var29++) {
            Statics.field370[var29] = new class47();
        }
        int var30 = var1.method1117(6) + 1;
        Statics.field379 = new class51[var30];
        for (int var31 = 0; var31 < var30; var31++) {
            Statics.field379[var31] = new class51();
        }
        int var32 = var1.method1117(6) + 1;
        Statics.field372 = new boolean[var32];
        Statics.field364 = new int[var32];
        for (int var33 = 0; var33 < var32; var33++) {
            Statics.field372[var33] = var1.method1118() != 0;
            var1.method1117(16);
            var1.method1117(16);
            Statics.field364[var33] = var1.method1117(8);
        }
    }

    @ObfuscatedName("cf.am(I)[F")
    public float[] method1043(int arg0) {
        class61 var2 = new class61();
        var2.method1124(this.field366[arg0], 0);
        this.field374 = new float[Statics.field367];
        var2.method1118();
        int var3 = var2.method1117(class333.method1821(Statics.field364.length - 1));
        boolean var4 = Statics.field372[var3];
        int var5 = var4 ? Statics.field367 : Statics.field371;
        boolean var6 = false;
        boolean var7 = false;
        if (var4) {
            var6 = var2.method1118() != 0;
            var7 = var2.method1118() != 0;
        }
        int var8 = var5 >> 1;
        int var9;
        int var10;
        int var11;
        if (var4 && !var6) {
            var9 = (var5 >> 2) - (Statics.field371 >> 2);
            var10 = (Statics.field371 >> 2) + (var5 >> 2);
            var11 = Statics.field371 >> 1;
        } else {
            var9 = 0;
            var10 = var8;
            var11 = var5 >> 1;
        ...
        int var14;
        if (var4 && !var7) {
            var12 = var5 - (var5 >> 2) - (Statics.field371 >> 2);
            var13 = (Statics.field371 >> 2) + (var5 - (var5 >> 2));
            var14 = Statics.field371 >> 1;
        } else {
            var12 = var8;
            var13 = var5;
            var14 = var5 >> 1;
        }
        class51 var15 = Statics.field379[Statics.field364[var3]];
        int var16 = var15.field340;
        int var17 = var15.field341[var16];
        class60 var18 = Statics.field369[var17].method771(var2);
        boolean var19 = !var18.method1105();
        for (int var20 = 0; var20 < var15.field339; var20++) {
            class47 var21 = Statics.field370[var15.field342[var20]];
            float[] var22 = this.field374;
            var21.method866(var22, var5 >> 1, var19, var2);
        }
        if (var18.method1105()) {
            int var23 = var15.field340;
            int var10000 = var15.field341[var23];
            var18.method1104(this.field374, var5 >> 1);
        }
        if (var18.method1105()) {
            int var26 = var5 >> 1;
            int var27 = var5 >> 2;
            ...
            float[] var32 = var4 ? Statics.field383 : Statics.field380;
            float[] var33 = var4 ? Statics.field384 : Statics.field381;
            float[] var34 = var4 ? Statics.field373 : Statics.field382;
            int[] var35 = var4 ? Statics.field387 : Statics.field363;
            ...
            int var48 = class333.method1821(var5 - 1);
        ...
        float[] var91 = null;
        if (this.field385 > 0) {
            int var92 = this.field385 + var5 >> 2;
            var91 = new float[var92];
            if (!this.field378) {
                for (int var93 = 0; var93 < this.field389; var93++) {
                    int var94 = (this.field385 >> 1) + var93;
                    var91[var93] += this.field359[var94];
                }
            }
            if (var18.method1105()) {
        ...
        float[] var97 = this.field359;
        this.field359 = this.field374;
        this.field374 = var97;
        this.field385 = var5;
        this.field389 = var13 - (var5 >> 1);
        this.field378 = !var18.method1105();
        return var91;
    }

    @ObfuscatedName("cf.ax(Lpo;)Z")
    public static boolean method1044(class391 arg0) {
        if (!field375) {
            byte[] var1 = arg0.method6782(0, 0);
            if (var1 == null) {
                return false;
            }
            method1042(var1);
    ...
    @ObfuscatedName("cf.aq(Lpo;II)Lcf;")
    public static class55 method1045(class391 arg0, int arg1, int arg2) {
        if (method1044(arg0)) {
            byte[] var3 = arg0.method6782(arg1, arg2);
            return var3 == null ? null : new class55(var3);
        } else {
            arg0.method6784(arg1, arg2);
            return null;
        }
    }
    ...
    @ObfuscatedName("cf.af([I)Lbg;")
    public class41 method1046(int[] arg0) {
        if (arg0 != null && arg0[0] <= 0) {
            return null;
        }
        if (this.field376 == null) {
            this.field385 = 0;
            this.field359 = new float[Statics.field367];
            this.field376 = new byte[this.field361];
            this.field388 = 0;
            this.field390 = 0;
        }
        while (this.field390 < this.field366.length) {
            if (arg0 != null && arg0[0] <= 0) {
                return null;
            }
            float[] var2 = this.method1043(this.field390);
            if (var2 != null) {
                int var3 = this.field388;
                int var4 = var2.length;
                if (var4 > this.field361 - var3) {
                    var4 = this.field361 - var3;
                }
                for (int var5 = 0; var5 < var4; var5++) {
                    ...
                    this.field376[var3++] = (byte) (var6 - 128);
                }
                if (arg0 != null) {
        ...
        this.field359 = null;
        byte[] var7 = this.field376;
        this.field376 = null;
        return new class41(this.field360, var7, this.field362, this.field386, this.field377);
    }
}
