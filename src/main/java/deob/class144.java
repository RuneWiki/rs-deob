...
public class class144 implements Runnable {
    ...
    @ObfuscatedName("eg.s")
    public final Thread field1927 = new Thread(this);

    @ObfuscatedName("eg.j")
    public volatile boolean field1925;

    @ObfuscatedName("eg.i")
    public Queue field1926 = new LinkedList();

    public class144() {
        this.field1927.setPriority(1);
        this.field1927.start();
    }

    public void run() {
        while (!this.field1925) {
            try {
                class145 var2;
                synchronized (this) {
                    var2 = (class145) this.field1926.poll();
                    if (var2 == null) {
                        try {
                            this.wait();
                ...
                try {
                    var6 = var2.field1932.openConnection();
                ...
                class341.method40((String) null, var21);
            }
        }
    }

    @ObfuscatedName("eg.s(Ljava/net/URL;I)Ler;")
    public class145 method3047(URL arg0) {
        class145 var2 = new class145(arg0);
        synchronized (this) {
            this.field1926.add(var2);
            this.notify();
            return var2;
        }
    }

    @ObfuscatedName("eg.j(I)V")
