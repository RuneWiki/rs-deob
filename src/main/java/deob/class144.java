...
public class class144 implements Runnable {
    ...
    @ObfuscatedName("eo.m")
    public final Thread field1919 = new Thread(this);
    ...
    public void run() {
        while (!this.field1920) {
            try {
                ...
                try {
                    var6 = var2.field1928.openConnection();
                ...
                class166.method4746((String) null, var21);
            }
        }
    }

    @ObfuscatedName("eo.m(Ljava/net/URL;I)Ley;")
    public class145 method2989(URL arg0) {
