...
public class class135 extends RuntimeException {
    ...
    @ObfuscatedName("dx.z(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2452(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2068.getCodeBase(), "clienterror.ws?c=" + Statics.field2065 + "&u=" + Statics.field2066 + "&v1=" + Statics.field1927 + "&v2=" + Statics.field1924 + "&e=" + var25);
    ...
    @ObfuscatedName("ce.j(Ljava/lang/Throwable;Ljava/lang/String;)Lei;")
    public static class135 method2072(Throwable arg0, String arg1) {
        class135 var2;
