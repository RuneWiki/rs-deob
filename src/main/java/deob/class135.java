...
public class class135 extends RuntimeException {
    ...
    @ObfuscatedName("ct.k(Ljava/lang/String;Ljava/lang/Throwable;S)V")
    public static void method1963(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2079.getCodeBase(), "clienterror.ws?c=" + Statics.field2074 + "&u=" + Statics.field2073 + "&v1=" + Statics.field1961 + "&v2=" + Statics.field1953 + "&e=" + var25);
    ...
    @ObfuscatedName("ae.r(Ljava/lang/Throwable;Ljava/lang/String;)Lez;")
    public static class135 method810(Throwable arg0, String arg1) {
        class135 var2;
        if (arg0 instanceof class135) {
            var2 = (class135) arg0;
            var2.field2075 = var2.field2075 + ' ' + arg1;
        } else {
