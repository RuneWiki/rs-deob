...
public class class135 extends RuntimeException {
    ...
    @ObfuscatedName("di.i(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2595(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2072.getCodeBase(), "clienterror.ws?c=" + Statics.field2071 + "&u=" + Statics.field2067 + "&v1=" + Statics.field1932 + "&v2=" + Statics.field1939 + "&e=" + var25);
    ...
    @ObfuscatedName("ag.c(Ljava/lang/Throwable;Ljava/lang/String;)Leh;")
    public static class135 method571(Throwable arg0, String arg1) {
        class135 var2;
        if (arg0 instanceof class135) {
            var2 = (class135) arg0;
            var2.field2068 = var2.field2068 + ' ' + arg1;
        } else {
