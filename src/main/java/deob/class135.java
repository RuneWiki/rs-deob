...
public class class135 extends RuntimeException {
    ...
    @ObfuscatedName("cc.g(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method1860(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2061.getCodeBase(), "clienterror.ws?c=" + Statics.field2066 + "&u=" + Statics.field2060 + "&v1=" + Statics.field1942 + "&v2=" + Statics.field1934 + "&e=" + var25);
    ...
    @ObfuscatedName("aa.s(Ljava/lang/Throwable;Ljava/lang/String;)Lec;")
    public static class135 method574(Throwable arg0, String arg1) {
        class135 var2;
