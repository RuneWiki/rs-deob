...
public class class135 extends RuntimeException {
    ...
    @ObfuscatedName("client.e(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method457(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2070.getCodeBase(), "clienterror.ws?c=" + Statics.field2024 + "&u=" + Statics.field2071 + "&v1=" + Statics.field1943 + "&v2=" + Statics.field1936 + "&e=" + var25);
    ...
    @ObfuscatedName("da.v(Ljava/lang/Throwable;Ljava/lang/String;)Lem;")
    public static class135 method2402(Throwable arg0, String arg1) {
        class135 var2;
        if (arg0 instanceof class135) {
            var2 = (class135) arg0;
            var2.field2074 = var2.field2074 + ' ' + arg1;
        } else {
