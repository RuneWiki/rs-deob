...
public class class90 extends class179 {
    ...
    public class90(class127 arg0) {
        this.field1489 = arg0.method2460();
        this.field1490 = arg0.method2458() == 1;
        ...
        for (int var3 = 0; var3 < var2; var3++) {
            this.field1491[var3] = arg0.method2460();
        }
        if (var2 > 1) {
            this.field1496 = new int[var2 - 1];
            for (int var4 = 0; var4 < var2 - 1; var4++) {
                this.field1496[var4] = arg0.method2458();
            }
        }
        if (var2 > 1) {
            this.field1493 = new int[var2 - 1];
            for (int var5 = 0; var5 < var2 - 1; var5++) {
                this.field1493[var5] = arg0.method2458();
            }
        }
        this.field1492 = new int[var2];
        for (int var6 = 0; var6 < var2; var6++) {
            this.field1492[var6] = arg0.method2463();
        }
        this.field1495 = arg0.method2458();
        this.field1494 = arg0.method2458();
        this.field1497 = null;
    }

    @ObfuscatedName("cx.f(DILeo;)Z")
    public boolean method1868(double arg0, int arg1, class153 arg2) {
        for (int var5 = 0; var5 < this.field1491.length; var5++) {
            if (arg2.method3096(this.field1491[var5]) == null) {
                return false;
            }
        }
        int var6 = arg1 * arg1;
        this.field1497 = new int[var6];
        for (int var7 = 0; var7 < this.field1491.length; var7++) {
            class87 var8 = class84.method40(arg2, this.field1491[var7]);
            var8.method1789();
            byte[] var9 = var8.field1470;
            ...
            for (int var17 = 0; var17 < var10.length; var17++) {
                var10[var17] = class104.method2177(var10[var17], arg0);
            }
            int var18;
            if (var7 == 0) {
                var18 = 0;
            } else {
                var18 = this.field1496[var7 - 1];
            }
            if (var7 == 0) {
            }
            if (var18 == 0) {
    ...
    @ObfuscatedName("cx.n(I)V")
    public void method1861(int arg0) {
        if (this.field1497 == null) {
            return;
        }
        if (this.field1495 == 1 || this.field1495 == 3) {
            if (Statics.field1499 == null || Statics.field1499.length < this.field1497.length) {
                Statics.field1499 = new int[this.field1497.length];
            }
            short var2;
            ...
            for (int var6 = 0; var6 < var3; var6++) {
                ...
                Statics.field1499[var6] = this.field1497[var7];
            }
            int[] var8 = this.field1497;
            this.field1497 = Statics.field1499;
        ...
        for (int var13 = 0; var13 < var10; var13 += var9) {
            for (int var14 = 0; var14 < var9; var14++) {
                ...
                Statics.field1499[var15] = this.field1497[var16];
            }
        }
