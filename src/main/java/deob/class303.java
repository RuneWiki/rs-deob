...
public class class303 {
    ...
    static {
        ...
        for (int var3 = 0; var3 < 26; var3++) {
            field3743[var3] = (char) (var3 + 65);
        }
        for (int var4 = 26; var4 < 52; var4++) {
            field3743[var4] = (char) (var4 + 97 - 26);
        }
        for (int var5 = 52; var5 < 62; var5++) {
            field3743[var5] = (char) (var5 + 48 - 52);
        }
        field3743[62] = '*';
        field3743[63] = '-';
        field3745 = new char[64];
        for (int var6 = 0; var6 < 26; var6++) {
            field3745[var6] = (char) (var6 + 65);
        }
        for (int var7 = 26; var7 < 52; var7++) {
            field3745[var7] = (char) (var7 + 97 - 26);
        }
        for (int var8 = 52; var8 < 62; var8++) {
            field3745[var8] = (char) (var8 + 48 - 52);
        }
        field3745[62] = '-';
        field3745[63] = '_';
