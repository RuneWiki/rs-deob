...
public class class176 {
    ...
    @ObfuscatedName("cr.c(CIB)C")
    public static char method1865(char arg0, int arg1) {
    ...
    @ObfuscatedName("as.q(CB)C")
    public static char method947(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ic.m(CII)I")
    public static int method4312(char arg0, int arg1) {
        int var2 = arg0 << 4;
