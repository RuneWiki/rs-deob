...
public class class351 extends RuntimeException {
    ...
    @ObfuscatedName("df.z(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2420(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field4073.getCodeBase(), "clienterror.ws?c=" + Statics.field3372 + "&u=" + Statics.field4072 + "&v1=" + Statics.field2071 + "&v2=" + Statics.field2082 + "&ct=" + Statics.field296 + "&e=" + var25);
    ...
    @ObfuscatedName("e.k(Ljava/lang/Throwable;Ljava/lang/String;)Lme;")
    public static class351 method233(Throwable arg0, String arg1) {
        class351 var2;
        if (arg0 instanceof class351) {
            var2 = (class351) arg0;
            var2.field4074 = var2.field4074 + ' ' + arg1;
        } else {
