...
public class class79 extends RuntimeException {
    ...
    @ObfuscatedName("ah.c(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method848(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2651.getCodeBase(), "clienterror.ws?c=" + Statics.field2763 + "&u=" + Statics.field1388 + "&v1=" + Statics.field1320 + "&v2=" + Statics.field1324 + "&e=" + var25);
    ...
    @ObfuscatedName("cz.j(Ljava/lang/Throwable;Ljava/lang/String;)Lcd;")
    public static class79 method2075(Throwable arg0, String arg1) {
        class79 var2;
        if (arg0 instanceof class79) {
            var2 = (class79) arg0;
            var2.field1387 = var2.field1387 + ' ' + arg1;
        } else {
