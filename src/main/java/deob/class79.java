...
public class class79 extends RuntimeException {
    ...
    @ObfuscatedName("am.p(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method720(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1422.getCodeBase(), "clienterror.ws?c=" + Statics.field1415 + "&u=" + Statics.field1416 + "&v1=" + Statics.field1331 + "&v2=" + Statics.field1322 + "&e=" + var25);
    ...
    @ObfuscatedName("bx.j(Ljava/lang/Throwable;Ljava/lang/String;)Lcj;")
    public static class79 method1367(Throwable arg0, String arg1) {
        class79 var2;
        if (arg0 instanceof class79) {
            var2 = (class79) arg0;
            var2.field1418 = var2.field1418 + ' ' + arg1;
        } else {
