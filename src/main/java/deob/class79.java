...
public class class79 extends RuntimeException {
    ...
    @ObfuscatedName("ai.v(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method811(String arg0, Throwable arg1) {
        try {
            ...
            URL var26 = new URL(Statics.field1399.getCodeBase(), "clienterror.ws?c=" + Statics.field1396 + "&u=" + Statics.field1395 + "&v1=" + Statics.field1308 + "&v2=" + Statics.field1307 + "&e=" + var25);
    ...
    @ObfuscatedName("cy.f(Ljava/lang/Throwable;Ljava/lang/String;)Lcn;")
    public static class79 method2057(Throwable arg0, String arg1) {
        class79 var2;
        if (arg0 instanceof class79) {
            var2 = (class79) arg0;
            var2.field1394 = var2.field1394 + ' ' + arg1;
        } else {
