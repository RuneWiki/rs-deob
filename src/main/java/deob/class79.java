...
public class class79 extends RuntimeException {
    ...
    @ObfuscatedName("r.z(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method218(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1414.getCodeBase(), "clienterror.ws?c=" + Statics.field1412 + "&u=" + Statics.field2407 + "&v1=" + Statics.field2638 + "&v2=" + Statics.field1334 + "&e=" + var25);
    ...
    @ObfuscatedName("bd.h(Ljava/lang/Throwable;Ljava/lang/String;)Lck;")
    public static class79 method1356(Throwable arg0, String arg1) {
        class79 var2;
