...
public final class class82 extends class78 {
    ...
    @ObfuscatedName("cm.y(IILjava/awt/Component;B)V")
    public final void method1510(int arg0, int arg1, Component arg2) {
        ...
        WritableRaster var6 = Raster.createWritableRaster(var5.createCompatibleSampleModel(this.field1396, this.field1398), var4, (Point) null);
        this.field1397 = new BufferedImage(var5, var6, false, new Hashtable());
        this.field1428 = arg2;
        this.method1566();
    }

    @ObfuscatedName("cm.d(Ljava/awt/Graphics;III)V")
    public final void method1511(Graphics arg0, int arg1, int arg2) {
        arg0.drawImage(this.field1397, arg1, arg2, this.field1428);
    }

    @ObfuscatedName("cm.g(Ljava/awt/Graphics;IIIIB)V")
