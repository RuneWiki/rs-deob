...
public final class class59 {
    ...
    @ObfuscatedName("bf.r")
    public int[] field789 = new int[256];
    ...
    public final int method751() {
        if (0 == --this.field790 + 1) {
            this.method753();
            this.field790 = 255;
        }
        return this.field794[this.field790];
    }

    @ObfuscatedName("bf.n(I)V")
    public final void method753() {
        this.field793 += ++this.field786;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field789[var1];
            if ((var1 & 0x2) == 0) {
                if ((var1 & 0x1) == 0) {
                    this.field792 ^= this.field792 << 13;
                } else {
                    this.field792 ^= this.field792 >>> 6;
                }
            } else if ((var1 & 0x1) == 0) {
                this.field792 ^= this.field792 << 2;
            } else {
                this.field792 ^= this.field792 >>> 16;
            }
            this.field792 += this.field789[var1 + 128 & 0xFF];
            int var3;
            this.field789[var1] = var3 = this.field793 + this.field792 + this.field789[(var2 & 0x3FC) >> 2];
            this.field794[var1] = this.field793 = this.field789[(var3 >> 8 & 0x3FC) >> 2] + var2;
        }
    }
    ...
    public final void method752() {
        ...
        for (int var26 = 0; var26 < 256; var26 += 8) {
            ...
            var6 = var1 + var41;
            var8 = var7 + var48;
            this.field789[var26] = var8;
            this.field789[var26 + 1] = var7;
            this.field789[var26 + 2] = var6;
            this.field789[var26 + 3] = var5;
            this.field789[var26 + 4] = var4;
            this.field789[var26 + 5] = var3;
            this.field789[var26 + 6] = var2;
            this.field789[var26 + 7] = var1;
        }
        for (int var51 = 0; var51 < 256; var51 += 8) {
            int var52 = this.field789[var51] + var8;
            int var53 = this.field789[var51 + 1] + var7;
            int var54 = this.field789[var51 + 2] + var6;
            int var55 = this.field789[var51 + 3] + var5;
            int var56 = this.field789[var51 + 4] + var4;
            int var57 = this.field789[var51 + 5] + var3;
            int var58 = this.field789[var51 + 6] + var2;
            int var59 = this.field789[var51 + 7] + var1;
            ...
            var6 = var1 + var66;
            var8 = var7 + var73;
            this.field789[var51] = var8;
            this.field789[var51 + 1] = var7;
            this.field789[var51 + 2] = var6;
            this.field789[var51 + 3] = var5;
            this.field789[var51 + 4] = var4;
            this.field789[var51 + 5] = var3;
            this.field789[var51 + 6] = var2;
            this.field789[var51 + 7] = var1;
        }
        this.method753();
        this.field790 = 256;
    }
