...
public class class329 implements class330 {
    ...
    @ObfuscatedName("lv.n(B)Llz;")
    public class331 method5823() {
        byte var1;
        if (Statics.field1929.startsWith("win")) {
            var1 = 1;
        } else if (Statics.field1929.startsWith("mac")) {
            var1 = 2;
        } else if (Statics.field1929.startsWith("linux")) {
            var1 = 3;
        } else {
            var1 = 4;
        }
        ...
        String var35 = "";
        int[] var36 = new int[3];
        return new class331(var1, var9, var10, var11, var13, var18, var23, false, var27, var28, var29, 0, var30, var31, var32, var33, 0, 0, 0, 0, var34, var35, var36, 0, "");
    }
}
