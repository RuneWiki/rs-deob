...
public class class329 implements class330 {
    ...
    @ObfuscatedName("lb.f(B)Llx;")
    public class331 method5828() {
        byte var1;
        if (Statics.field1130.startsWith("win")) {
            var1 = 1;
        } else if (Statics.field1130.startsWith("mac")) {
            var1 = 2;
        } else if (Statics.field1130.startsWith("linux")) {
            var1 = 3;
        } else {
            var1 = 4;
        }
        ...
        String var20 = "";
        int[] var21 = new int[3];
        return new class331(var1, var9, var10, var11, this.field3898, this.field3897, this.field3900, false, var12, var13, var14, 0, var15, var16, var17, var18, 0, 0, 0, 0, var19, var20, var21, 0, "");
    }

    @ObfuscatedName("lb.i(Ljava/lang/String;B)V")
    public void method5819(String arg0) {
        if (arg0.startsWith("1.")) {
            this.method5818(arg0);
        } else {
            this.method5826(arg0);
        }
    }

    @ObfuscatedName("lb.y(Ljava/lang/String;B)V")
    public void method5818(String arg0) {
    ...
    @ObfuscatedName("lb.w(Ljava/lang/String;I)V")
