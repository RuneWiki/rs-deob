...
public class class160 extends RuntimeException {
    ...
    @ObfuscatedName("bx.n(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method943(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2023.getCodeBase(), "clienterror.ws?c=" + Statics.field2019 + "&u=" + Statics.field2017 + "&v1=" + Statics.field2038 + "&v2=" + Statics.field2035 + "&ct=" + Statics.field420 + "&e=" + var25);
    ...
    @ObfuscatedName("gs.h(Ljava/lang/Throwable;Ljava/lang/String;)Lfx;")
    public static class160 method3800(Throwable arg0, String arg1) {
        class160 var2;
        if (arg0 instanceof class160) {
            var2 = (class160) arg0;
            var2.field2018 = var2.field2018 + ' ' + arg1;
        } else {
