...
public class class156 extends class142 {
    ...
    @ObfuscatedName("eu.z")
    public static class100 field2379 = new class100(64);

    @ObfuscatedName("eu.g")
    public static class100 field2392 = new class100(30);
    ...
    public static class156 method1133(int arg0) {
        class156 var1 = (class156) field2379.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        var3.field2382 = arg0;
        if (var2 != null) {
            var3.method2445(new class135(var2));
        }
    ...
    public void method2445(class135 arg0) {
        while (true) {
    ...
    public void method2446(class135 arg0, int arg1) {
        if (arg1 == 1) {
    ...
    public final class180 method2455(int arg0) {
        class180 var2 = (class180) field2392.method1244((long) this.field2382);
        if (var2 == null) {
            class179 var3 = class179.method2992(Statics.field2385, this.field2383, 0);
            if (var3 == null) {
                return null;
            }
        ...
        if (this.field2390 == -1 || arg0 == -1) {
            ...
            var6 = class155.method104(this.field2390).method2439(var2, arg0);
        }
