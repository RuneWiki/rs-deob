...
@ObfuscatedName("ce")
public class class156 extends RuntimeException {

    @ObfuscatedName("ce.h")
    public String field2340;

    @ObfuscatedName("ce.r")
    public Throwable field2341;

    public class156(Throwable arg0, String arg1) {
        this.field2340 = arg1;
        this.field2341 = arg0;
    }

    @ObfuscatedName("w.p(Ljava/lang/Throwable;Ljava/lang/String;)Lce;")
    public static class156 method1078(Throwable arg0, String arg1) {
        class156 var2;
        if (arg0 instanceof class156) {
            var2 = (class156) arg0;
            var2.field2340 = var2.field2340 + ' ' + arg1;
        } else {
            var2 = new class156(arg0, arg1);
        }
        return var2;
    }

    @ObfuscatedName("cy.j(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2297(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2344.getCodeBase(), "clienterror.ws?c=" + Statics.field2018 + "&u=" + Statics.field2350 + "&v1=" + Statics.field1761 + "&v2=" + Statics.field57 + "&e=" + var25);
