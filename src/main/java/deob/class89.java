...
public class class89 {
    ...
    @ObfuscatedName("ck.p")
    public class103 field1523 = null;
    ...
    public class89(byte[] arg0, class103 arg1) {
        ...
        var3.field1977 = 2;
        int var5 = var3.method2355();
        int var6 = -1;
        int var7 = 0;
        var4.field1977 = var3.field1977 + var5;
        for (int var8 = 0; var8 < var5; var8++) {
            int var9 = var3.method2355();
            if (var9 > 0) {
                if (this.field1523.field1743[var8] != 0) {
                    for (int var10 = var8 - 1; var10 > var6; var10--) {
                        if (this.field1523.field1743[var10] == 0) {
                            field1519[var7] = var10;
                            field1520[var7] = 0;
                            field1521[var7] = 0;
                            field1522[var7] = 0;
                            var7++;
                ...
                field1519[var7] = var8;
                short var11 = 0;
                if (this.field1523.field1743[var8] == 3) {
                    var11 = 128;
                }
                if ((var9 & 0x1) == 0) {
                    field1520[var7] = var11;
                } else {
                    field1520[var7] = var4.method2367();
                }
                if ((var9 & 0x2) == 0) {
                    field1521[var7] = var11;
                } else {
                    field1521[var7] = var4.method2367();
                }
                if ((var9 & 0x4) == 0) {
                    field1522[var7] = var11;
                } else {
                    field1522[var7] = var4.method2367();
                }
                var6 = var8;
                var7++;
                if (this.field1523.field1743[var8] == 5) {
                    this.field1529 = true;
                }
            }
        }
        ...
        for (int var12 = 0; var12 < var7; var12++) {
            this.field1526[var12] = field1519[var12];
            this.field1525[var12] = field1520[var12];
