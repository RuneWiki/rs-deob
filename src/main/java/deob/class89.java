...
public class class89 extends class174 {
    ...
    @ObfuscatedName("cm.cf([III)V")
    public static void method1793(int[] arg0, int arg1, int arg2) {
        Statics.field1480 = arg0;
        Statics.field1481 = arg1;
        Statics.field1486 = arg2;
        method1795(0, 0, arg1, arg2);
    }

    @ObfuscatedName("cm.ci()V")
    public static void method1845() {
        field1485 = 0;
        field1483 = 0;
        field1484 = Statics.field1481;
        field1482 = Statics.field1486;
    }
    ...
    public static void method1795(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 > Statics.field1486) {
            arg3 = Statics.field1486;
        }
        field1485 = arg0;
        field1483 = arg1;
        field1484 = arg2;
    ...
    @ObfuscatedName("cm.dq()V")
    public static void method1799() {
        int var0 = 0;
        int var1 = Statics.field1486 * Statics.field1481 - 7;
        while (var0 < var1) {
    ...
    public static void method1826(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method1805(arg0, arg1, arg2, arg4);
        method1805(arg0, arg1 + arg3 - 1, arg2, arg4);
        method1844(arg0, arg1, arg3, arg4);
        method1844(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("cm.ds(IIIIII)V")
    public static void method1794(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1806(arg0, arg1, arg2, arg4, arg5);
        method1806(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
            method1808(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
            method1808(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
        }
    }

    @ObfuscatedName("cm.dr(IIII)V")
    public static void method1805(int arg0, int arg1, int arg2, int arg3) {
        if (arg1 < field1483 || arg1 >= field1482) {
            return;
        }
        if (arg0 < field1485) {
            arg2 -= field1485 - arg0;
    ...
    public static void method1844(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var4 = Statics.field1481 * arg1 + arg0;
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1480[Statics.field1481 * var5 + var4] = arg3;
        }
    }
    ...
    public static void method1852(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        if (var6 == 0) {
            if (var5 >= 0) {
                method1805(arg0, arg1, var5 + 1, arg4);
            } else {
                method1805(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field1483 && var12 < field1482) {
                        Statics.field1480[Statics.field1481 * var12 + arg0] = arg4;
                    }
                    var8 += var10;
                    arg0++;
                }
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1485 && var18 < field1484) {
                        Statics.field1480[Statics.field1481 * arg1 + var18] = arg4;
                    }
                    var14 += var16;
                    arg1++;
                }
    ...
    @ObfuscatedName("cm.dx(III[I[I)V")
