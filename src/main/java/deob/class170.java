...
public class class170 {
    ...
    @ObfuscatedName("cd.f(CII)C")
    public static char method1648(char arg0, int arg1) {
    ...
    @ObfuscatedName("ds.e(CB)C")
    public static char method2681(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ev.n(CII)I")
    public static int method2813(char arg0, int arg1) {
        int var2 = arg0 << 4;
