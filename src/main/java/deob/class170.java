...
public class class170 {
    ...
    @ObfuscatedName("df.m(CII)C")
    public static char method2329(char arg0, int arg1) {
    ...
    @ObfuscatedName("bb.w(CB)C")
    public static char method1565(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("dl.e(CII)I")
    public static int method2337(char arg0, int arg1) {
        int var2 = arg0 << 4;
