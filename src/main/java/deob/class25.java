...
public class class25 {
    ...
    public class25() {
        class130.method1561(24);
        this.field324 = class130.method1561(16);
        this.field327 = class130.method1561(24);
        this.field325 = new int[this.field327];
        boolean var1 = class130.method1553() != 0;
        if (var1) {
            int var2 = 0;
            int var3 = class130.method1561(5) + 1;
            while (var2 < this.field327) {
                int var4 = class130.method1561(class66.method479(this.field327 - var2));
            ...
            boolean var6 = class130.method1553() != 0;
            for (int var7 = 0; var7 < this.field327; var7++) {
                if (var6 && class130.method1553() == 0) {
                    this.field325[var7] = 0;
                } else {
                    this.field325[var7] = class130.method1561(5) + 1;
                }
            }
        }
        this.method319();
        int var8 = class130.method1561(4);
        if (var8 > 0) {
            float var9 = class130.method1540(class130.method1561(32));
            float var10 = class130.method1540(class130.method1561(32));
            int var11 = class130.method1561(4) + 1;
            boolean var12 = class130.method1553() != 0;
            int var13;
            if (var8 == 1) {
            ...
            for (int var14 = 0; var14 < var13; var14++) {
                this.field326[var14] = class130.method1561(var11);
            }
    ...
    public int method320() {
        int var1;
        for (var1 = 0; this.field323[var1] >= 0; var1 = class130.method1553() == 0 ? var1 + 1 : this.field323[var1]) {
        }
