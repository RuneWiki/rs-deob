...
public class class51 {
    ...
    public class51(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field390 = var9;
            this.field388 = var10;
            this.field387 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field387[var11];
    ...
    @ObfuscatedName("ai.l([BB)[B")
    public byte[] method962(byte[] arg0) {
        if (this.field387 != null) {
            int var2 = (int) ((long) this.field388 * (long) arg0.length / (long) this.field390) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field387[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field388 + var5;
                int var11 = var10 / this.field390;
                var4 += var11;
                var5 = var10 - this.field390 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("ai.q(II)I")
    public int method955(int arg0) {
        if (this.field387 != null) {
            arg0 = (int) ((long) this.field388 * (long) arg0 / (long) this.field390);
        }
        return arg0;
    }

    @ObfuscatedName("ai.f(IB)I")
    public int method956(int arg0) {
        if (this.field387 != null) {
            arg0 = (int) ((long) this.field388 * (long) arg0 / (long) this.field390) + 6;
        }
        return arg0;
    }
}
