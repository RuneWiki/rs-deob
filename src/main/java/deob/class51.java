...
public class class51 {
    ...
    public class51(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field372 = var9;
            this.field370 = var10;
            this.field373 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field373[var11];
    ...
    @ObfuscatedName("aa.i([BI)[B")
    public byte[] method988(byte[] arg0) {
        if (this.field373 != null) {
            int var2 = (int) ((long) this.field370 * (long) arg0.length / (long) this.field372) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field373[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field370 + var5;
                int var11 = var10 / this.field372;
                var4 += var11;
                var5 = var10 - this.field372 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("aa.w(II)I")
    public int method984(int arg0) {
        if (this.field373 != null) {
            arg0 = (int) ((long) this.field370 * (long) arg0 / (long) this.field372);
        }
        return arg0;
    }
    ...
    public int method985(int arg0) {
        if (this.field373 != null) {
            arg0 = (int) ((long) this.field370 * (long) arg0 / (long) this.field372) + 6;
        }
        return arg0;
    }
}
