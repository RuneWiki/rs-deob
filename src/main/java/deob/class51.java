...
public class class51 {
    ...
    @ObfuscatedName("as.v([BI)[B")
    public byte[] method968(byte[] arg0) {
        if (this.field397 != null) {
            int var2 = (int) ((long) this.field396 * (long) arg0.length / (long) this.field401) + 14;
    ...
    @ObfuscatedName("as.c(IB)I")
    public int method969(int arg0) {
        if (this.field397 != null) {
            arg0 = (int) ((long) this.field396 * (long) arg0 / (long) this.field401);
        }
        return arg0;
    }
    ...
    public int method970(int arg0) {
        if (this.field397 != null) {
            arg0 = (int) ((long) this.field396 * (long) arg0 / (long) this.field401) + 6;
        }
        return arg0;
    }
}
