...
public class class168 {
    ...
    @ObfuscatedName("ft.n")
    public static final char[] field2692 = new char[] { ' ', ' ', '_', '-', 'à', 'á', 'â', 'ä', 'ã', 'À', 'Á', 'Â', 'Ä', 'Ã', 'è', 'é', 'ê', 'ë', 'È', 'É', 'Ê', 'Ë', 'í', 'î', 'ï', 'Í', 'Î', 'Ï', 'ò', 'ó', 'ô', 'ö', 'õ', 'Ò', 'Ó', 'Ô', 'Ö', 'Õ', 'ù', 'ú', 'û', 'ü', 'Ù', 'Ú', 'Û', 'Ü', 'ç', 'Ç', 'ÿ', 'Ÿ', 'ñ', 'Ñ', 'ß' };
    ...
    @ObfuscatedName("al.e(Ljava/lang/CharSequence;Lhb;B)Ljava/lang/String;")
    public static String method947(CharSequence arg0, class216 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
    ...
    public static char method664(char arg0) {
        switch(arg0) {
            case ' ':
            case '-':
            case '_':
