...
public class class80 extends RuntimeException {
    ...
    @ObfuscatedName("client.i(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method562(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            if (Statics.field1422 == null) {
                return;
            }
            URL var26 = new URL(Statics.field1422.getCodeBase(), "clienterror.ws?c=" + Statics.field189 + "&u=" + Statics.field1417 + "&v1=" + Statics.field1338 + "&v2=" + Statics.field1331 + "&e=" + var25);
    ...
    @ObfuscatedName("bu.v(Ljava/lang/Throwable;Ljava/lang/String;)Lcq;")
    public static class80 method1419(Throwable arg0, String arg1) {
        class80 var2;
        if (arg0 instanceof class80) {
            var2 = (class80) arg0;
            var2.field1423 = var2.field1423 + ' ' + arg1;
        } else {
