...
public class class80 extends class204 {
    ...
    public static void method1684(int[] arg0, int arg1, int arg2) {
        ...
        method1686(0, 0, arg1, arg2);
    }

    @ObfuscatedName("cy.cp()V")
    public static void method1692() {
        field1404 = 0;
        field1402 = 0;
        field1405 = Statics.field1403;
        field1401 = Statics.field1400;
    }

    @ObfuscatedName("cy.cf(IIII)V")
    public static void method1686(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 > Statics.field1400) {
            arg3 = Statics.field1400;
        }
        field1404 = arg0;
        field1402 = arg1;
        field1405 = arg2;
    ...
    @ObfuscatedName("cy.cr()V")
    public static void method1693() {
        int var0 = 0;
        int var1 = Statics.field1403 * Statics.field1400 - 7;
        while (var0 < var1) {
    ...
    public static void method1694(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        method1698(arg0, arg1, arg3, arg4);
        method1698(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("cy.cd(IIIIII)V")
    public static void method1718(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1721(arg0, arg1, arg2, arg4, arg5);
        method1721(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
            method1683(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
            method1683(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
        }
    }

    @ObfuscatedName("cy.cz(IIII)V")
    public static void method1696(int arg0, int arg1, int arg2, int arg3) {
        if (arg1 < field1402 || arg1 >= field1401) {
            return;
        }
        if (arg0 < field1404) {
            arg2 -= field1404 - arg0;
    ...
    public static void method1698(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var4 = Statics.field1403 * arg1 + arg0;
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1399[Statics.field1403 * var5 + var4] = arg3;
        }
    }

    @ObfuscatedName("cy.dt(IIIII)V")
    ...
    public static void method1685(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        if (var6 == 0) {
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field1402 && var12 < field1401) {
                        Statics.field1399[Statics.field1403 * var12 + arg0] = arg4;
                    }
                    var8 += var10;
                    arg0++;
                }
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1404 && var18 < field1405) {
                        Statics.field1399[Statics.field1403 * arg1 + var18] = arg4;
                    }
                    var14 += var16;
                    arg1++;
                }
            ...
            method1698(arg0, arg1, var6 + 1, arg4);
        } else {
            method1698(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("cy.dz(III[I[I)V")
