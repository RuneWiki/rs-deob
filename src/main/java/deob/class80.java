...
public class class80 extends class205 {
    ...
    @ObfuscatedName("cp.cq([III)V")
    public static void method1665(int[] arg0, int arg1, int arg2) {
        Statics.field1384 = arg0;
        Statics.field1383 = arg1;
        Statics.field1388 = arg2;
        method1667(0, 0, arg1, arg2);
    }

    @ObfuscatedName("cp.cf()V")
    public static void method1701() {
        field1387 = 0;
        field1385 = 0;
        field1382 = Statics.field1383;
        field1386 = Statics.field1388;
    }
    ...
    public static void method1667(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 > Statics.field1388) {
            arg3 = Statics.field1388;
        }
        field1387 = arg0;
        field1385 = arg1;
        field1382 = arg2;
    ...
    public static void method1724() {
        int var0 = 0;
        int var1 = Statics.field1388 * Statics.field1383 - 7;
        while (var0 < var1) {
    ...
    @ObfuscatedName("cp.ca(IIIIII)V")
    public static void method1729(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        if (arg0 < field1387) {
            arg2 -= field1387 - arg0;
            arg0 = field1387;
        }
    ...
    @ObfuscatedName("cp.cx(IIIIIIII)V")
    public static void method1674(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        int var13 = Statics.field1383 - arg2;
        int var14 = Statics.field1383 * arg1 + arg0;
    ...
    @ObfuscatedName("cp.ch(IIIIIIII)V")
    public static void method1675(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        int var8 = 0;
        int var9 = arg4 == arg5 && arg6 == arg7 ? -1 : 65536 / arg3;
        int var10 = arg6;
        int var11 = 256 - arg6;
        ...
        int var14 = arg4 & 0xFF;
        int var15 = Statics.field1383 - arg2;
    ...
    @ObfuscatedName("cp.cw(IIIIIIII)V")
    public static void method1676(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        int var18 = Statics.field1383 - arg2;
    ...
    @ObfuscatedName("cp.cg(IIIIIIII)V")
    public static void method1731(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        int var8 = 0;
        int var9 = 65536 / arg3;
        int var10 = arg6;
        int var11 = 256 - arg6;
    ...
    @ObfuscatedName("cp.co(IIIIII)V")
    public static void method1678(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var6 = 0;
        int var7 = 65536 / arg3;
        if (arg0 < field1387) {
            arg2 -= field1387 - arg0;
    ...
    @ObfuscatedName("cp.dt(IIIII)V")
    public static void method1726(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method1713(arg0, arg1, arg2, arg4);
        method1713(arg0, arg1 + arg3 - 1, arg2, arg4);
        method1683(arg0, arg1, arg3, arg4);
        method1683(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("cp.dd(IIIIII)V")
    public static void method1680(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1682(arg0, arg1, arg2, arg4, arg5);
        method1682(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
    ...
    public static void method1713(int arg0, int arg1, int arg2, int arg3) {
        if (arg1 < field1385 || arg1 >= field1386) {
            return;
        }
        if (arg0 < field1387) {
            arg2 -= field1387 - arg0;
    ...
    public static void method1683(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var4 = Statics.field1383 * arg1 + arg0;
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1384[Statics.field1383 * var5 + var4] = arg3;
        }
    }

    @ObfuscatedName("cp.dn(IIIII)V")
    public static void method1684(int arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 < field1387 || arg0 >= field1382) {
            return;
        }
        if (arg1 < field1385) {
    ...
    @ObfuscatedName("cp.dx(IIIII)V")
    public static void method1677(int arg0, int arg1, int arg2, int arg3, int arg4) {
        int var5 = arg2 - arg0;
        int var6 = arg3 - arg1;
        if (var6 == 0) {
            if (var5 >= 0) {
                method1713(arg0, arg1, var5 + 1, arg4);
            } else {
                method1713(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field1385 && var12 < field1386) {
                        Statics.field1384[Statics.field1383 * var12 + arg0] = arg4;
                    }
                    var8 += var10;
                    arg0++;
                }
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1387 && var18 < field1382) {
                        Statics.field1384[Statics.field1383 * arg1 + var18] = arg4;
                    }
                    var14 += var16;
                    arg1++;
                }
            ...
            method1683(arg0, arg1, var6 + 1, arg4);
        } else {
            method1683(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("cp.dl(III[I[I)V")
