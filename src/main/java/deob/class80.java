...
public class class80 extends RuntimeException {
    ...
    @ObfuscatedName("du.q(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2321(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1420.getCodeBase(), "clienterror.ws?c=" + Statics.field1923 + "&u=" + Statics.field1421 + "&v1=" + Statics.field1340 + "&v2=" + Statics.field1334 + "&e=" + var25);
    ...
    @ObfuscatedName("dy.c(Ljava/lang/Throwable;Ljava/lang/String;)Lcm;")
    public static class80 method2406(Throwable arg0, String arg1) {
        class80 var2;
