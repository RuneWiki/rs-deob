...
public class class80 extends RuntimeException {
    ...
    @ObfuscatedName("cf.p(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2076(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1406.getCodeBase(), "clienterror.ws?c=" + Statics.field1402 + "&u=" + Statics.field2739 + "&v1=" + Statics.field1330 + "&v2=" + Statics.field1321 + "&e=" + var25);
    ...
    @ObfuscatedName("au.l(Ljava/lang/Throwable;Ljava/lang/String;)Lcd;")
    public static class80 method791(Throwable arg0, String arg1) {
        class80 var2;
        if (arg0 instanceof class80) {
            var2 = (class80) arg0;
            var2.field1401 = var2.field1401 + ' ' + arg1;
        } else {
