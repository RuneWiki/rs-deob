...
public class class80 extends RuntimeException {
    ...
    @ObfuscatedName("ee.j(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2830(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1403.getCodeBase(), "clienterror.ws?c=" + Statics.field1398 + "&u=" + Statics.field1396 + "&v1=" + Statics.field1314 + "&v2=" + Statics.field1315 + "&e=" + var25);
    ...
    @ObfuscatedName("dd.r(Ljava/lang/Throwable;Ljava/lang/String;)Lcf;")
    public static class80 method2209(Throwable arg0, String arg1) {
        class80 var2;
        if (arg0 instanceof class80) {
            var2 = (class80) arg0;
            var2.field1397 = var2.field1397 + ' ' + arg1;
        } else {
