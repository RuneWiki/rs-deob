...
public class class80 extends RuntimeException {
    ...
    @ObfuscatedName("g.y(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method210(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1742.getCodeBase(), "clienterror.ws?c=" + Statics.field2015 + "&u=" + Statics.field1414 + "&v1=" + Statics.field1339 + "&v2=" + Statics.field1326 + "&e=" + var25);
    ...
    @ObfuscatedName("bf.m(Ljava/lang/Throwable;Ljava/lang/String;)Lcp;")
    public static class80 method1375(Throwable arg0, String arg1) {
        class80 var2;
        if (arg0 instanceof class80) {
            var2 = (class80) arg0;
            var2.field1415 = var2.field1415 + ' ' + arg1;
        } else {
