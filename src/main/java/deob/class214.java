...
public class class214 {
    ...
    @ObfuscatedName("bc.x(CII)C")
    public static char method1620(char arg0, int arg1) {
    ...
    @ObfuscatedName("am.v(CS)C")
    public static char method604(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ec.m(CII)I")
    public static int method2823(char arg0, int arg1) {
        int var2 = arg0 << 4;
