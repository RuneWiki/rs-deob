...
public class class214 {
    ...
    @ObfuscatedName("client.e(CIB)C")
    public static char method442(char arg0, int arg1) {
    ...
    @ObfuscatedName("gz.v(CB)C")
    public static char method3558(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("z.k(CII)I")
    public static int method96(char arg0, int arg1) {
        int var2 = arg0 << 4;
