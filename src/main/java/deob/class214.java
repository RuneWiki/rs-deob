...
public class class214 {
    ...
    @ObfuscatedName("gc.g(CIB)C")
    public static char method3433(char arg0, int arg1) {
    ...
    @ObfuscatedName("d.j(CI)C")
    public static char method121(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("fr.z(CII)I")
    public static int method3090(char arg0, int arg1) {
        int var2 = arg0 << 4;
