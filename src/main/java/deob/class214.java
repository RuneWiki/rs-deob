...
public class class214 {
    ...
    @ObfuscatedName("ct.y(CI)C")
    public static char method1886(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ad.g(CII)I")
    public static int method576(char arg0, int arg1) {
        int var2 = arg0 << 4;
