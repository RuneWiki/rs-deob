...
public class class6 implements class3 {
    ...
    @ObfuscatedName("n.s")
    public final MessageDigest field9 = this.method22();

    public class6(class9 arg0) {
    }

    @ObfuscatedName("n.s(ILjava/lang/String;J)Z")
    public boolean method19(int arg0, String arg1, long arg2) {
        byte[] var5 = this.method21(arg1, arg2);
        return method26(var5) >= arg0;
    }

    @ObfuscatedName("n.t([B)I")
    public static int method26(byte[] arg0) {
        int var1 = 0;
        byte[] var2 = arg0;
    ...
    @ObfuscatedName("n.l()Ljava/security/MessageDigest;")
