...
public class class6 implements class3 {
    ...
    public final MessageDigest field9 = this.method20();

    public class6(class9 arg0) {
    }

    @ObfuscatedName("as.aq(ILjava/lang/String;J)Z")
    public boolean method21(int arg0, String arg1, long arg2) {
        byte[] var5 = this.method24(arg1, arg2);
        return method25(var5) >= arg0;
    }

    @ObfuscatedName("as.aw([B)I")
    public static int method25(byte[] arg0) {
        int var1 = 0;
        byte[] var2 = arg0;
    ...
    @ObfuscatedName("as.ai(Ljava/lang/String;J)[B")
    ...
    @ObfuscatedName("as.ar()Ljava/security/MessageDigest;")
