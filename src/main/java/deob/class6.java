...
public class class6 implements class3 {
    ...
    public final MessageDigest field16 = this.method22();

    public class6(class9 arg0) {
    }

    @ObfuscatedName("an.aq(ILjava/lang/String;J)Z")
    public boolean method18(int arg0, String arg1, long arg2) {
        byte[] var5 = this.method26(arg1, arg2);
        return method17(var5) >= arg0;
    }

    @ObfuscatedName("an.ad([B)I")
    ...
    @ObfuscatedName("an.ak(Ljava/lang/String;J)[B")
    public byte[] method26(String arg0, long arg1) {
    ...
    @ObfuscatedName("an.ap()Ljava/security/MessageDigest;")
