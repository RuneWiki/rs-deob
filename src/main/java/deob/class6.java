...
public class class6 implements class3 {
    ...
    @ObfuscatedName("ao.at(Ljava/lang/String;J)[B")
    ...
    @ObfuscatedName("ao.an()Ljava/security/MessageDigest;")
