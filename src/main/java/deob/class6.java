...
public class class6 implements class3 {
    ...
    public final MessageDigest field9 = this.method18();

    public class6(class9 arg0) {
    }

    @ObfuscatedName("ao.ab(ILjava/lang/String;J)Z")
    public boolean method14(int arg0, String arg1, long arg2) {
        byte[] var5 = this.method20(arg1, arg2);
        return method15(var5) >= arg0;
    }

    @ObfuscatedName("ao.ay([B)I")
    ...
    @ObfuscatedName("ao.au(Ljava/lang/String;J)[B")
    ...
    @ObfuscatedName("ao.ax()Ljava/security/MessageDigest;")
    public MessageDigest method18() {
        try {
