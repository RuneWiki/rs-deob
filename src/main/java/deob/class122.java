...
public class class122 {
    ...
    @ObfuscatedName("cb.g(Ljava/io/File;I)V")
    public static void method1937(File arg0) {
    ...
    @ObfuscatedName("cp.i(Ljava/lang/String;I)Ljava/io/File;")
    public static File method1855(String arg0) {
        if (!field1937) {
            throw new RuntimeException("");
        }
        ...
        File var2 = new File(Statics.field1933, arg0);
