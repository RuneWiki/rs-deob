...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class113.method2068(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1276 = var4;
            this.field1270 = var5;
    ...
    @ObfuscatedName("bo.j([BI)[B")
    public byte[] method1328(byte[] arg0) {
        if (this.field1275 != null) {
            int var2 = (int) ((long) this.field1270 * (long) arg0.length / (long) this.field1276) + 14;
    ...
    public int method1329(int arg0) {
        if (this.field1275 != null) {
            arg0 = (int) ((long) this.field1270 * (long) arg0 / (long) this.field1276);
        }
        return arg0;
    }
    ...
    public int method1334(int arg0) {
        if (this.field1275 != null) {
            arg0 = (int) ((long) this.field1270 * (long) arg0 / (long) this.field1276) + 6;
        }
        return arg0;
    }
}
