...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1265 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1265[var11];
    ...
    @ObfuscatedName("bo.k([BB)[B")
    public byte[] method1329(byte[] arg0) {
        if (this.field1265 != null) {
            int var2 = (int) ((long) this.field1262 * (long) arg0.length / (long) this.field1272) + 14;
    ...
    @ObfuscatedName("bo.b(IB)I")
    public int method1330(int arg0) {
        if (this.field1265 != null) {
            arg0 = (int) ((long) this.field1262 * (long) arg0 / (long) this.field1272);
        }
        return arg0;
    }
    ...
    public int method1333(int arg0) {
        if (this.field1265 != null) {
            arg0 = (int) ((long) this.field1262 * (long) arg0 / (long) this.field1272) + 6;
        }
        return arg0;
    }
}
