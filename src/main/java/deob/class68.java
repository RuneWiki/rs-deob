...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1240 = new int[var9][14];
    ...
    @ObfuscatedName("ba.z([BI)[B")
    public byte[] method1312(byte[] arg0) {
        if (this.field1240 != null) {
            int var2 = (int) ((long) this.field1238 * (long) arg0.length / (long) this.field1239) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1240[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1238 + var5;
    ...
    public int method1321(int arg0) {
        if (this.field1240 != null) {
            arg0 = (int) ((long) this.field1238 * (long) arg0 / (long) this.field1239);
        }
        return arg0;
    }
    ...
    public int method1310(int arg0) {
        if (this.field1240 != null) {
            arg0 = (int) ((long) this.field1238 * (long) arg0 / (long) this.field1239) + 6;
        }
        return arg0;
    }
}
