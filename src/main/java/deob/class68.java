...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1261 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1261[var11];
    ...
    @ObfuscatedName("bq.p([BI)[B")
    public byte[] method1384(byte[] arg0) {
        if (this.field1261 != null) {
            int var2 = (int) ((long) this.field1259 * (long) arg0.length / (long) this.field1260) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1260;
                var4 += var11;
                var5 = var10 - this.field1260 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bq.g(IS)I")
    public int method1385(int arg0) {
        if (this.field1261 != null) {
            arg0 = (int) ((long) this.field1259 * (long) arg0 / (long) this.field1260);
        }
        return arg0;
    }
    ...
    public int method1391(int arg0) {
        if (this.field1261 != null) {
            arg0 = (int) ((long) this.field1259 * (long) arg0 / (long) this.field1260) + 6;
        }
        return arg0;
    }
}
