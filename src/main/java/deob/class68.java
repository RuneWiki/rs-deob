...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1247 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1247[var11];
    ...
    @ObfuscatedName("ba.k([BI)[B")
    public byte[] method1329(byte[] arg0) {
        if (this.field1247 != null) {
            int var2 = (int) ((long) this.field1241 * (long) arg0.length / (long) this.field1244) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1241 + var5;
                int var11 = var10 / this.field1244;
                var4 += var11;
                var5 = var10 - this.field1244 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("ba.y(IB)I")
    public int method1323(int arg0) {
        if (this.field1247 != null) {
            arg0 = (int) ((long) this.field1241 * (long) arg0 / (long) this.field1244);
        }
        return arg0;
    }
    ...
    public int method1327(int arg0) {
        if (this.field1247 != null) {
            arg0 = (int) ((long) this.field1241 * (long) arg0 / (long) this.field1244) + 6;
        }
        return arg0;
    }
}
