...
public class class68 {
    ...
    public static int method1314(int arg0, int arg1) {
        int var2;
        for (var2 = (int) Math.pow((double) arg0, 1.0D / (double) arg1) + 1; class117.method2407(var2, arg1) > arg0; var2--) {
        }
        return var2;
    }

    public class68() {
        class65.method1257(24);
        this.field1260 = class65.method1257(16);
        this.field1261 = class65.method1257(24);
        this.field1262 = new int[this.field1261];
        boolean var1 = class65.method1256() != 0;
        if (var1) {
            int var2 = 0;
            int var3 = class65.method1257(5) + 1;
            while (var2 < this.field1261) {
                int var4 = class65.method1257(class117.method1849(this.field1261 - var2));
            ...
            boolean var6 = class65.method1256() != 0;
            for (int var7 = 0; var7 < this.field1261; var7++) {
                if (var6 && class65.method1256() == 0) {
                    this.field1262[var7] = 0;
                } else {
                    this.field1262[var7] = class65.method1257(5) + 1;
                }
            }
        }
        this.method1303();
        int var8 = class65.method1257(4);
        if (var8 > 0) {
            float var9 = class65.method1255(class65.method1257(32));
            float var10 = class65.method1255(class65.method1257(32));
            int var11 = class65.method1257(4) + 1;
            boolean var12 = class65.method1256() != 0;
            int var13;
            if (var8 == 1) {
                var13 = method1314(this.field1261, this.field1260);
            } else {
                var13 = this.field1261 * this.field1260;
            }
            this.field1263 = new int[var13];
            for (int var14 = 0; var14 < var13; var14++) {
                this.field1263[var14] = class65.method1257(var11);
            }
            this.field1264 = new float[this.field1261][this.field1260];
            if (var8 == 1) {
                for (int var15 = 0; var15 < this.field1261; var15++) {
                    float var16 = 0.0F;
                    int var17 = 1;
                    for (int var18 = 0; var18 < this.field1260; var18++) {
                ...
                for (int var21 = 0; var21 < this.field1261; var21++) {
                    float var22 = 0.0F;
                    int var23 = this.field1260 * var21;
                    for (int var24 = 0; var24 < this.field1260; var24++) {
    ...
    public int method1304() {
        int var1;
        for (var1 = 0; this.field1265[var1] >= 0; var1 = class65.method1256() == 0 ? var1 + 1 : this.field1265[var1]) {
        }
        return ~this.field1265[var1];
    }

    @ObfuscatedName("br.k()[F")
    public float[] method1311() {
        return this.field1264[this.method1304()];
    }
}
