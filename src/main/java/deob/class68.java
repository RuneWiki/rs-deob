...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1273 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1273[var11];
    ...
    @ObfuscatedName("bp.t([BB)[B")
    public byte[] method1321(byte[] arg0) {
        if (this.field1273 != null) {
            int var2 = (int) ((long) this.field1270 * (long) arg0.length / (long) this.field1267) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1273[var5];
    ...
    @ObfuscatedName("bp.o(II)I")
    public int method1326(int arg0) {
        if (this.field1273 != null) {
            arg0 = (int) ((long) this.field1270 * (long) arg0 / (long) this.field1267);
        }
        return arg0;
    }

    @ObfuscatedName("bp.i(II)I")
    public int method1323(int arg0) {
        if (this.field1273 != null) {
            arg0 = (int) ((long) this.field1270 * (long) arg0 / (long) this.field1267) + 6;
        }
        return arg0;
    }
}
