...
public class class68 {
    ...
    @ObfuscatedName("bw.e([BI)[B")
    public byte[] method1344(byte[] arg0) {
        if (this.field1257 != null) {
            int var2 = (int) ((long) this.field1253 * (long) arg0.length / (long) this.field1255) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1255;
                var4 += var11;
                var5 = var10 - this.field1255 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bw.p(IB)I")
    public int method1342(int arg0) {
        if (this.field1257 != null) {
            arg0 = (int) ((long) this.field1253 * (long) arg0 / (long) this.field1255);
        }
        return arg0;
    }
    ...
    public int method1347(int arg0) {
        if (this.field1257 != null) {
            arg0 = (int) ((long) this.field1253 * (long) arg0 / (long) this.field1255) + 6;
        }
        return arg0;
    }
}
