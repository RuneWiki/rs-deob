...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1263 = var9;
            this.field1264 = var10;
            this.field1266 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1266[var11];
    ...
    public byte[] method1305(byte[] arg0) {
        if (this.field1266 != null) {
            int var2 = (int) ((long) this.field1264 * (long) arg0.length / (long) this.field1263) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1266[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1264 + var5;
    ...
    public int method1306(int arg0) {
        if (this.field1266 != null) {
            arg0 = (int) ((long) this.field1264 * (long) arg0 / (long) this.field1263);
        }
        return arg0;
    }

    @ObfuscatedName("bi.v(IB)I")
    public int method1307(int arg0) {
        if (this.field1266 != null) {
            arg0 = (int) ((long) this.field1264 * (long) arg0 / (long) this.field1263) + 6;
        }
        return arg0;
    }
}
