...
public class class68 {
    ...
    public class68(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1274 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1274[var11];
    ...
    @ObfuscatedName("bj.i([BI)[B")
    public byte[] method1351(byte[] arg0) {
        if (this.field1274 != null) {
            int var2 = (int) ((long) this.field1270 * (long) arg0.length / (long) this.field1277) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1270 + var5;
                int var11 = var10 / this.field1277;
                var4 += var11;
                var5 = var10 - this.field1277 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bj.c(IS)I")
    public int method1344(int arg0) {
        if (this.field1274 != null) {
            arg0 = (int) ((long) this.field1270 * (long) arg0 / (long) this.field1277);
        }
        return arg0;
    }

    @ObfuscatedName("bj.h(II)I")
    public int method1345(int arg0) {
        if (this.field1274 != null) {
            arg0 = (int) ((long) this.field1270 * (long) arg0 / (long) this.field1277) + 6;
        }
        return arg0;
    }
}
