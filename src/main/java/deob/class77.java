...
public class class77 extends class191 {
    ...
    public class77(class110 arg0) {
        this.field1330 = arg0.method2194();
        this.field1328 = arg0.method2257() == 1;
        ...
        for (int var3 = 0; var3 < var2; var3++) {
            this.field1332[var3] = arg0.method2194();
        }
        if (var2 > 1) {
            this.field1331 = new int[var2 - 1];
            for (int var4 = 0; var4 < var2 - 1; var4++) {
                this.field1331[var4] = arg0.method2257();
            }
        }
        if (var2 > 1) {
            this.field1334 = new int[var2 - 1];
            for (int var5 = 0; var5 < var2 - 1; var5++) {
                this.field1334[var5] = arg0.method2257();
            }
        }
        this.field1333 = new int[var2];
        for (int var6 = 0; var6 < var2; var6++) {
            this.field1333[var6] = arg0.method2297();
        }
        this.field1336 = arg0.method2257();
        this.field1337 = arg0.method2257();
        this.field1338 = null;
    }

    @ObfuscatedName("bq.v(DILem;)Z")
    public boolean method1594(double arg0, int arg1, class151 arg2) {
        for (int var5 = 0; var5 < this.field1332.length; var5++) {
            if (arg2.method2791(this.field1332[var5]) == null) {
                return false;
            }
        }
        int var6 = arg1 * arg1;
        ...
        for (int var7 = 0; var7 < this.field1332.length; var7++) {
            class75 var8 = class71.method499(arg2, this.field1332[var7]);
            var8.method1579();
            byte[] var9 = var8.field1318;
            int[] var10 = var8.field1320;
            ...
            for (int var17 = 0; var17 < var10.length; var17++) {
                var10[var17] = class85.method1808(var10[var17], arg0);
            }
            int var18;
            if (var7 == 0) {
                var18 = 0;
            ...
            if (var18 == 0) {
                if (var8.field1321 == arg1) {
                    for (int var19 = 0; var19 < var6; var19++) {
                        this.field1338[var19] = var10[var9[var19] & 0xFF];
                    }
                } else if (var8.field1321 == 64 && arg1 == 128) {
                    int var20 = 0;
                ...
                } else if (var8.field1321 == 128 && arg1 == 64) {
                    int var23 = 0;
    ...
    public void method1600(int arg0) {
        ...
        if (this.field1336 == 1 || this.field1336 == 3) {
            if (Statics.field1329 == null || Statics.field1329.length < this.field1338.length) {
                Statics.field1329 = new int[this.field1338.length];
            }
            short var2;
            ...
            for (int var6 = 0; var6 < var3; var6++) {
                ...
                Statics.field1329[var6] = this.field1338[var7];
            }
            int[] var8 = this.field1338;
            this.field1338 = Statics.field1329;
        ...
        for (int var13 = 0; var13 < var10; var13 += var9) {
            for (int var14 = 0; var14 < var9; var14++) {
                ...
                Statics.field1329[var15] = this.field1338[var16];
            }
        }
