...
public abstract class class481 {
    ...
    @ObfuscatedName("sc.ap")
    public int field4879 = 0;

    @ObfuscatedName("sc.aa")
    public int field4876 = 0;

    @ObfuscatedName("sc.af")
    public double field4875 = 0.0D;

    @ObfuscatedName("sc.ad")
    public int field4878 = 0;

    public class481(int arg0, int arg1) {
        this.field4879 = arg0;
        this.field4876 = 0;
        this.field4878 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field4875 = method5221(this.field4876, this.field4879, this.field4878);
    }

    @ObfuscatedName("sc.ab(I)V")
    public void method7757() {
        if (this.field4876 < this.field4879) {
            this.field4876++;
            this.field4875 = method5221(this.field4876, this.field4879, this.field4878);
        }
    }

    @ObfuscatedName("sc.ag(I)D")
    public double method7751() {
        return this.field4875;
    }

    @ObfuscatedName("lr.am(IIIB)D")
    public static double method5221(int arg0, int arg1, int arg2) {
