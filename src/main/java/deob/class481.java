...
public final class class481 {
    ...
    @ObfuscatedName("gq.af(Ljava/lang/CharSequence;I)I")
    public static int method3306(CharSequence arg0) {
    ...
    @ObfuscatedName("nb.an([BILjava/lang/CharSequence;I)I")
    public static int method6243(byte[] arg0, int arg1, CharSequence arg2) {
