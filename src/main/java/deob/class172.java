...
public class class172 {
    ...
    @ObfuscatedName("do.d(CII)C")
    public static char method1950(char arg0, int arg1) {
    ...
    @ObfuscatedName("ag.x(CI)C")
    public static char method475(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ca.k(CIB)I")
    public static int method1513(char arg0, int arg1) {
        int var2 = arg0 << 4;
