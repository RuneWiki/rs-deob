...
public abstract class class482 {
    ...
    public class482(int arg0, int arg1) {
        this.field4874 = arg0;
        this.field4875 = 0;
        this.field4876 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field4873 = method6019(this.field4875, this.field4874, this.field4876);
    }

    @ObfuscatedName("sk.ap(I)V")
    public void method7704() {
        if (this.field4875 < this.field4874) {
            this.field4875++;
            this.field4873 = method6019(this.field4875, this.field4874, this.field4876);
        }
    }

    @ObfuscatedName("sk.aq(I)D")
    public double method7702() {
        return this.field4873;
    }

    @ObfuscatedName("nf.at(IIIB)D")
    public static double method6019(int arg0, int arg1, int arg2) {
