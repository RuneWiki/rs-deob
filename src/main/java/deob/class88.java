...
public class class88 extends class173 {
    ...
    public static void method1858(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (arg3 > Statics.field1469) {
            arg3 = Statics.field1469;
        }
        field1464 = arg0;
        field1467 = arg1;
        field1470 = arg2;
    ...
    @ObfuscatedName("cu.cq()V")
    public static void method1814() {
        int var0 = 0;
        int var1 = Statics.field1469 * Statics.field1465 - 7;
        while (var0 < var1) {
            Statics.field1468[var0++] = 0;
            Statics.field1468[var0++] = 0;
            Statics.field1468[var0++] = 0;
            Statics.field1468[var0++] = 0;
            Statics.field1468[var0++] = 0;
    ...
    public static void method1815(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        for (int var10 = 0; var10 < arg3; var10++) {
            for (int var11 = -arg2; var11 < 0; var11++) {
                int var12 = Statics.field1468[var9];
                int var13 = ((var12 & 0xFF00FF) * var7 >> 8 & 0xFF00FF) + ((var12 & 0xFF00) * var7 >> 8 & 0xFF00);
                Statics.field1468[var9++] = var6 + var13;
            }
            var9 += var8;
        }
    }

    @ObfuscatedName("cu.cd(IIIII)V")
    public static void method1816(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        for (int var7 = -arg3; var7 < 0; var7++) {
            for (int var8 = -arg2; var8 < 0; var8++) {
                Statics.field1468[var6++] = arg4;
            }
            var6 += var5;
        }
    }

    @ObfuscatedName("cu.cy(IIIIII)V")
    ...
    @ObfuscatedName("cu.cw(IIIII)V")
    public static void method1818(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method1820(arg0, arg1, arg2, arg4);
        method1820(arg0, arg1 + arg3 - 1, arg2, arg4);
        method1836(arg0, arg1, arg3, arg4);
        method1836(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("cu.co(IIIIII)V")
    public static void method1819(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1829(arg0, arg1, arg2, arg4, arg5);
        method1829(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
    ...
    public static void method1820(int arg0, int arg1, int arg2, int arg3) {
        if (arg1 < field1467 || arg1 >= field1466) {
            return;
        }
        if (arg0 < field1464) {
            arg2 -= field1464 - arg0;
        ...
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1468[var4 + var5] = arg3;
        }
    }
    ...
    public static void method1829(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        for (int var10 = 0; var10 < arg2; var10++) {
            int var11 = (Statics.field1468[var9] >> 16 & 0xFF) * var5;
            int var12 = (Statics.field1468[var9] >> 8 & 0xFF) * var5;
            int var13 = (Statics.field1468[var9] & 0xFF) * var5;
            int var14 = (var8 + var13 >> 8) + (var6 + var11 >> 8 << 16) + (var7 + var12 >> 8 << 8);
            Statics.field1468[var9++] = var14;
        }
    }

    @ObfuscatedName("cu.cg(IIII)V")
    public static void method1836(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 < field1464 || arg0 >= field1470) {
            return;
        }
        if (arg1 < field1467) {
            arg2 -= field1467 - arg1;
        ...
        int var4 = Statics.field1465 * arg1 + arg0;
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1468[Statics.field1465 * var5 + var4] = arg3;
        }
    }

    @ObfuscatedName("cu.db(IIIII)V")
    ...
    @ObfuscatedName("cu.dg(IIIII)V")
    public static void method1824(int arg0, int arg1, int arg2, int arg3, int arg4) {
        int var5 = arg2 - arg0;
        int var6 = arg3 - arg1;
        if (var6 == 0) {
            if (var5 >= 0) {
                method1820(arg0, arg1, var5 + 1, arg4);
            } else {
                method1820(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field1467 && var12 < field1466) {
                        Statics.field1468[Statics.field1465 * var12 + arg0] = arg4;
                    }
                    var8 += var10;
                    arg0++;
                }
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1464 && var18 < field1470) {
                        Statics.field1468[Statics.field1465 * arg1 + var18] = arg4;
                    }
                    var14 += var16;
                    arg1++;
                }
            ...
            method1836(arg0, arg1, var6 + 1, arg4);
        } else {
            method1836(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("cu.dy(III[I[I)V")
