...
public class class88 extends class172 {
    ...
    @ObfuscatedName("cr.ci([III)V")
    public static void method1753(int[] arg0, int arg1, int arg2) {
        Statics.field1477 = arg0;
        Statics.field1476 = arg1;
        Statics.field1481 = arg2;
        method1755(0, 0, arg1, arg2);
    }

    @ObfuscatedName("cr.cs()V")
    public static void method1754() {
        field1480 = 0;
        field1478 = 0;
        field1475 = Statics.field1476;
        field1479 = Statics.field1481;
    }

    @ObfuscatedName("cr.cr(IIII)V")
    ...
    @ObfuscatedName("cr.cd()V")
    public static void method1758() {
        int var0 = 0;
        int var1 = Statics.field1481 * Statics.field1476 - 7;
        while (var0 < var1) {
            Statics.field1477[var0++] = 0;
            Statics.field1477[var0++] = 0;
            Statics.field1477[var0++] = 0;
            Statics.field1477[var0++] = 0;
            Statics.field1477[var0++] = 0;
    ...
    public static void method1760(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        for (int var10 = 0; var10 < arg3; var10++) {
            for (int var11 = -arg2; var11 < 0; var11++) {
                int var12 = Statics.field1477[var9];
                int var13 = ((var12 & 0xFF00FF) * var7 >> 8 & 0xFF00FF) + ((var12 & 0xFF00) * var7 >> 8 & 0xFF00);
                Statics.field1477[var9++] = var6 + var13;
            }
            var9 += var8;
        }
    }
    ...
    public static void method1763(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method1770(arg0, arg1, arg2, arg4);
        method1770(arg0, arg1 + arg3 - 1, arg2, arg4);
        method1805(arg0, arg1, arg3, arg4);
        method1805(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("cr.cc(IIIIII)V")
    public static void method1752(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1757(arg0, arg1, arg2, arg4, arg5);
        method1757(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
    ...
    @ObfuscatedName("cr.cv(IIII)V")
    public static void method1770(int arg0, int arg1, int arg2, int arg3) {
        ...
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1477[var4 + var5] = arg3;
        }
    }

    @ObfuscatedName("cr.cg(IIIII)V")
    public static void method1757(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        for (int var10 = 0; var10 < arg2; var10++) {
            int var11 = (Statics.field1477[var9] >> 16 & 0xFF) * var5;
            int var12 = (Statics.field1477[var9] >> 8 & 0xFF) * var5;
            int var13 = (Statics.field1477[var9] & 0xFF) * var5;
            int var14 = (var8 + var13 >> 8) + (var6 + var11 >> 8 << 16) + (var7 + var12 >> 8 << 8);
            Statics.field1477[var9++] = var14;
        }
    }

    @ObfuscatedName("cr.cj(IIII)V")
    public static void method1805(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 < field1480 || arg0 >= field1475) {
            return;
        }
        if (arg1 < field1478) {
            arg2 -= field1478 - arg1;
        ...
        int var4 = Statics.field1476 * arg1 + arg0;
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1477[Statics.field1476 * var5 + var4] = arg3;
        }
    }

    @ObfuscatedName("cr.cz(IIIII)V")
    ...
    @ObfuscatedName("cr.cl(IIIII)V")
    public static void method1769(int arg0, int arg1, int arg2, int arg3, int arg4) {
        int var5 = arg2 - arg0;
        int var6 = arg3 - arg1;
        if (var6 == 0) {
            if (var5 >= 0) {
                method1770(arg0, arg1, var5 + 1, arg4);
            } else {
                method1770(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    ...
                    if (var12 >= field1478 && var12 < field1479) {
                        Statics.field1477[Statics.field1476 * var12 + arg0] = arg4;
                    }
                    var8 += var10;
                    arg0++;
                }
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1480 && var18 < field1475) {
                        Statics.field1477[Statics.field1476 * arg1 + var18] = arg4;
                    }
                    var14 += var16;
                    arg1++;
                }
            ...
            method1805(arg0, arg1, var6 + 1, arg4);
        } else {
            method1805(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("cr.cy(III[I[I)V")
