...
public abstract class class111 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @ObfuscatedName("dj.d")
    public static class111 field1532 = null;
    ...
    public final void method1354(int arg0, int arg1, int arg2) {
        try {
            ...
            if (Statics.field1542 == null) {
                Statics.field1542 = new class34();
            }
            Statics.field1542.method437(this, 1);
        } catch (Exception var5) {
            class169.method1490((String) null, var5);
    ...
    public final synchronized void method1391() {
        ...
        Statics.field54 = new class168(this);
    ...
    public void run() {
        try {
            if (Statics.field380 != null) {
                ...
                if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
                    ...
                    if (var2.startsWith("1.6.0_")) {
                        ...
                        if (class82.method62(var6)) {
                            int var7 = class82.method91(var6, 10, true);
                            if (var7 < 10) {
                                this.method1372("wrongjava");
                                return;
                            }
            ...
            label99: while (true) {
                ...
                Canvas var19;
                do {
                    if (field1550 != 0L && class63.method1135() >= field1550) {
                        break label99;
                    }
            ...
            class169.method1490((String) null, var24);
            this.method1372("crash");
        }
        this.method1382();
    }
    ...
    public void stop() {
        if (field1532 == this && !field1545) {
            field1550 = class63.method1135() + 4000L;
        }
    }

    public void destroy() {
        if (field1532 == this && !field1545) {
            field1550 = class63.method1135();
            class67.method1020(5000L);
            this.method1382();
        }
    }
    ...
    public final synchronized void paint(Graphics arg0) {
        ...
        field1536 = true;
        if (Statics.field375 != null && Statics.field375.startsWith("1.5") && class63.method1135() - field1549 > 1000L) {
