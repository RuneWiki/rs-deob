...
public class class111 {
    ...
    public byte[] method2266(byte[] arg0) {
        if (this.field1414 != null) {
            int var2 = (int) ((long) this.field1416 * (long) arg0.length / (long) this.field1417) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1416 + var5;
                int var11 = var10 / this.field1417;
                var4 += var11;
                var5 = var10 - this.field1417 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method2269(int arg0) {
        if (this.field1414 != null) {
            arg0 = (int) ((long) this.field1416 * (long) arg0 / (long) this.field1417);
        }
        return arg0;
    }

    @ObfuscatedName("dp.q(IB)I")
    public int method2272(int arg0) {
        if (this.field1414 != null) {
            arg0 = (int) ((long) this.field1416 * (long) arg0 / (long) this.field1417) + 6;
        }
        return arg0;
    }
}
