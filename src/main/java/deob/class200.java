...
public final class class200 {
    ...
    @ObfuscatedName("ai.y(Ljava/lang/CharSequence;B)I")
    public static int method930(CharSequence arg0) {
    ...
    @ObfuscatedName("cb.k([BIII)Ljava/lang/String;")
    public static String method1896(byte[] arg0, int arg1, int arg2) {
