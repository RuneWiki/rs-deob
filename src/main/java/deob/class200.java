...
public class class200 {
    ...
    @ObfuscatedName("gr.b(CII)C")
    public static char method3275(char arg0, int arg1) {
    ...
    @ObfuscatedName("ag.u(CI)C")
    public static char method779(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("cd.x(CII)I")
    public static int method1969(char arg0, int arg1) {
        int var2 = arg0 << 4;
