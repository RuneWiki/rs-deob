...
public class class200 {
    ...
    @ObfuscatedName("gq.h")
    public static final char[] field2960 = new char[] { '[', ']', '#' };

    public class200() throws Throwable {
        throw new Error();
    }

    @ObfuscatedName("ge.g(CI)Z")
    public static final boolean method3345(char arg0) {
        return arg0 == 160 || arg0 == ' ' || arg0 == '_' || arg0 == '-';
    }

    @ObfuscatedName("h.v(Ljava/lang/CharSequence;Lgn;I)Ljava/lang/String;")
    public static String method35(CharSequence arg0, class190 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
        int var3 = arg0.length();
        while (var2 < var3 && method3345(arg0.charAt(var2))) {
            var2++;
        }
        while (var3 > var2 && method3345(arg0.charAt(var3 - 1))) {
            var3--;
        }
        int var4 = var3 - var2;
        if (var4 >= 1) {
