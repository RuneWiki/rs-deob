...
public class class154 extends RuntimeException {
    ...
    @ObfuscatedName("eb.i(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2746(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2229.getCodeBase(), "clienterror.ws?c=" + Statics.field36 + "&u=" + Statics.field2228 + "&v1=" + Statics.field2243 + "&v2=" + Statics.field2343 + "&e=" + var25);
    ...
    @ObfuscatedName("do.j(Ljava/lang/Throwable;Ljava/lang/String;)Lek;")
    public static class154 method2292(Throwable arg0, String arg1) {
        class154 var2;
