...
public class class154 extends RuntimeException {
    ...
    @ObfuscatedName("fb.w(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method2730(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2233.getCodeBase(), "clienterror.ws?c=" + Statics.field2234 + "&u=" + Statics.field2232 + "&v1=" + Statics.field2248 + "&v2=" + Statics.field2247 + "&e=" + var25);
    ...
    @ObfuscatedName("dx.o(Ljava/lang/Throwable;Ljava/lang/String;)Lef;")
    public static class154 method1900(Throwable arg0, String arg1) {
        class154 var2;
