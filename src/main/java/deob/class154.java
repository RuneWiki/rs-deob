...
public class class154 extends RuntimeException {
    ...
    @ObfuscatedName("co.e(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method1592(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            if (Statics.field2202 == null) {
                return;
            }
            URL var26 = new URL(Statics.field2202.getCodeBase(), "clienterror.ws?c=" + Statics.field2200 + "&u=" + Statics.field2201 + "&v1=" + Statics.field2225 + "&v2=" + Statics.field3711 + "&e=" + var25);
    ...
    @ObfuscatedName("au.n(Ljava/lang/Throwable;Ljava/lang/String;)Lee;")
    public static class154 method224(Throwable arg0, String arg1) {
        class154 var2;
        if (arg0 instanceof class154) {
            var2 = (class154) arg0;
            var2.field2203 = var2.field2203 + ' ' + arg1;
        } else {
