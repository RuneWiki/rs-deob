...
public class class154 extends class142 {
    ...
    @ObfuscatedName("ec.j")
    public static class100 field2355 = new class100(64);
    ...
    public static void method128(class86 arg0) {
        Statics.field2358 = arg0;
    }

    @ObfuscatedName("bf.g(IB)Lec;")
    public static class154 method840(int arg0) {
        class154 var1 = (class154) field2355.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        if (var2 != null) {
            var3.method2399(new class135(var2), arg0);
        }
        var3.method2398();
    ...
    public void method2399(class135 arg0, int arg1) {
        while (true) {
    ...
    public void method2400(class135 arg0, int arg1, int arg2) {
        if (arg1 == 1) {
