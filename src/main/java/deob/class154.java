...
public class class154 extends RuntimeException {
    ...
    @ObfuscatedName("ex.h(Ljava/lang/Throwable;Ljava/lang/String;)Leg;")
    public static class154 method2677(Throwable arg0, String arg1) {
        class154 var2;
        if (arg0 instanceof class154) {
            var2 = (class154) arg0;
            var2.field2218 = var2.field2218 + ' ' + arg1;
        } else {
    ...
    @ObfuscatedName("cb.f(Ljava/lang/Throwable;I)Ljava/lang/String;")
    public static String method1635(Throwable arg0) throws IOException {
        String var2;
        if (arg0 instanceof class154) {
