...
public final class class230 {
    ...
    public static int[] field2645 = new int[6];

    @ObfuscatedName("il.ae")
    public static int[] field2635 = new int[6];

    @ObfuscatedName("il.au")
    public static int[] field2647 = new int[6];

    @ObfuscatedName("il.ag")
    public static int[] field2648 = new int[6];

    @ObfuscatedName("il.at")
    public static int[] field2649 = new int[6];

    @ObfuscatedName("il.af")
    public static final int[][] field2631 = new int[][] { { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 2, 6 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 13, 14 } };

    @ObfuscatedName("il.ai")
    public static final int[][] field2651 = new int[][] { { 0, 1, 2, 3, 0, 0, 1, 3 }, { 1, 1, 2, 3, 1, 0, 1, 3 }, { 0, 1, 2, 3, 1, 0, 1, 3 }, { 0, 0, 1, 2, 0, 0, 2, 4, 1, 0, 4, 3 }, { 0, 0, 1, 4, 0, 0, 4, 3, 1, 1, 2, 4 }, { 0, 0, 4, 3, 1, 0, 1, 2, 1, 0, 2, 4 }, { 0, 1, 2, 4, 1, 0, 1, 4, 1, 0, 4, 3 }, { 0, 4, 1, 2, 0, 4, 2, 5, 1, 0, 4, 5, 1, 0, 5, 3 }, { 0, 4, 1, 2, 0, 4, 2, 3, 0, 4, 3, 5, 1, 0, 4, 5 }, { 0, 0, 4, 5, 1, 4, 1, 2, 1, 4, 2, 3, 1, 4, 3, 5 }, { 0, 0, 1, 5, 0, 1, 4, 5, 0, 1, 2, 4, 1, 0, 5, 3, 1, 5, 4, 3, 1, 4, 2, 3 }, { 1, 0, 1, 5, 1, 1, 4, 5, 1, 1, 2, 4, 0, 0, 5, 3, 0, 5, 4, 3, 0, 4, 2, 3 }, { 1, 0, 5, 4, 1, 0, 1, 5, 0, 0, 4, 3, 0, 4, 5, 3, 0, 5, 2, 3, 0, 1, 2, 5 } };

    public class230(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
        if (arg5 != arg6 || arg5 != arg7 || arg5 != arg8) {
            this.field2637 = false;
        }
        this.field2641 = arg0;
        this.field2642 = arg1;
        this.field2643 = arg17;
        this.field2644 = arg18;
        short var20 = 128;
        int var21 = var20 / 2;
        int var22 = var20 / 4;
        int var23 = var20 * 3 / 4;
        int[] var24 = field2631[arg0];
        int var25 = var24.length;
        this.field2633 = new int[var25];
        this.field2640 = new int[var25];
        this.field2632 = new int[var25];
        ...
        for (int var30 = 0; var30 < var25; var30++) {
            ...
            this.field2633[var30] = var32;
            this.field2640[var30] = var34;
            this.field2632[var30] = var33;
            var26[var30] = var35;
            var27[var30] = var36;
        }
        int[] var37 = field2651[arg0];
        int var38 = var37.length / 4;
        this.field2646 = new int[var38];
        this.field2636 = new int[var38];
        this.field2639 = new int[var38];
        this.field2630 = new int[var38];
        this.field2634 = new int[var38];
        this.field2638 = new int[var38];
        if (arg2 != -1) {
        ...
        for (int var40 = 0; var40 < var38; var40++) {
            ...
            this.field2646[var40] = var42;
            this.field2636[var40] = var43;
            this.field2639[var40] = var44;
            if (var41 == 0) {
                this.field2630[var40] = var26[var42];
                this.field2634[var40] = var26[var43];
                this.field2638[var40] = var26[var44];
                if (this.field2650 != null) {
                    this.field2650[var40] = -1;
                }
            } else {
                this.field2630[var40] = var27[var42];
                this.field2634[var40] = var27[var43];
                this.field2638[var40] = var27[var44];
                if (this.field2650 != null) {
                    this.field2650[var40] = arg2;
                }
            }
        }
        int var45 = arg5;
