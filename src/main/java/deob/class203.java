...
public class class203 {
    ...
    @ObfuscatedName("bj.s(CIB)C")
    public static char method1068(char arg0, int arg1) {
    ...
    @ObfuscatedName("fz.c(CI)C")
    public static char method2891(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("eb.f(CII)I")
    public static int method2446(char arg0, int arg1) {
        int var2 = arg0 << 4;
