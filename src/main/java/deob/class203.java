...
public class class203 {
    ...
    @ObfuscatedName("cb.k(CII)C")
    public static char method2073(char arg0, int arg1) {
    ...
    @ObfuscatedName("cg.y(CS)C")
    public static char method1798(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("eq.s(CII)I")
    public static int method2845(char arg0, int arg1) {
        int var2 = arg0 << 4;
