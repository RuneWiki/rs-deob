...
public class class203 {
    ...
    @ObfuscatedName("h.k(CII)C")
    public static char method196(char arg0, int arg1) {
    ...
    @ObfuscatedName("n.y(CI)C")
    public static char method117(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("dc.o(CII)I")
    public static int method2039(char arg0, int arg1) {
        int var2 = arg0 << 4;
