...
public class class203 {
    ...
    @ObfuscatedName("co.b(CIB)C")
    public static char method1891(char arg0, int arg1) {
    ...
    @ObfuscatedName("ga.l(CB)C")
    public static char method3365(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("fp.i(CII)I")
    public static int method3071(char arg0, int arg1) {
        int var2 = arg0 << 4;
