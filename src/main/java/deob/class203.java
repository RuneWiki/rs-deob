...
public class class203 {
    ...
    @ObfuscatedName("dp.n(CII)C")
    public static char method2395(char arg0, int arg1) {
    ...
    @ObfuscatedName("dz.x(CI)C")
    public static char method2545(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("q.k(CII)I")
    public static int method85(char arg0, int arg1) {
        int var2 = arg0 << 4;
