...
public class class203 {
    ...
    @ObfuscatedName("bd.g(CII)C")
    public static char method1332(char arg0, int arg1) {
    ...
    @ObfuscatedName("di.s(CI)C")
    public static char method2369(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("aw.v(CII)I")
    public static int method835(char arg0, int arg1) {
        int var2 = arg0 << 4;
