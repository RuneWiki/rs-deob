...
public class class203 {
    ...
    @ObfuscatedName("ay.p(CII)C")
    public static char method695(char arg0, int arg1) {
    ...
    @ObfuscatedName("n.g(CI)C")
    public static char method190(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ht.x(CII)I")
    public static int method3709(char arg0, int arg1) {
        int var2 = arg0 << 4;
