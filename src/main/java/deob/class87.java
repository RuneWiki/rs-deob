...
public final class class87 extends class89 {
    ...
    public void method1806() {
        if (this.field1488 == this.field1486 && this.field1491 == this.field1487) {
            return;
        }
        byte[] var1 = new byte[this.field1491 * this.field1488];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1487; var3++) {
            for (int var4 = 0; var4 < this.field1486; var4++) {
                var1[(this.field1489 + var3) * this.field1488 + this.field1485 + var4] = this.field1490[var2++];
            }
        }
        this.field1490 = var1;
    ...
    public void method1808(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1809(Statics.field1498, this.field1490, this.field1484, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cj.j([I[B[IIIIIII)V")
    public static void method1809(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
