...
public class class87 {
    ...
    @ObfuscatedName("cu.n")
    public static class103 field1187 = new class103(32);

    @ObfuscatedName("cu.j")
    public static int field1188 = 0;

    @ObfuscatedName("cu.z")
    public static class101 field1189 = new class101();

    @ObfuscatedName("cu.g")
    public static class103 field1193 = new class103(4096);

    @ObfuscatedName("cu.q")
    public static int field1191 = 0;

    @ObfuscatedName("cu.i")
    public static class103 field1199 = new class103(4096);

    @ObfuscatedName("cu.s")
    public static int field1197 = 0;

    @ObfuscatedName("cu.w")
    public static class135 field1195 = new class135(8);
    ...
    @ObfuscatedName("cu.k")
    public static class120[] field1200 = new class120[256];
        ...
        if (field1197 == 0 && field1188 == 0 && field1191 == 0 && field1186 == 0) {
            ...
            try {
                ...
                while (field1188 < 20 && field1186 > 0) {
                    class167 var3 = (class167) field1185.method1284();
                    class135 var4 = new class135(4);
                    var4.method1587(1);
                ...
                while (field1197 < 20 && field1191 > 0) {
                    class167 var5 = (class167) field1189.method1259();
                ...
                for (int var7 = 0; var7 < 100; var7++) {
                    ...
                    if (var9 > 0) {
                        ...
                        if (Statics.field812 == null) {
                            ...
                            class167 var18 = (class167) field1187.method1277(var16);
                            Statics.field1194 = true;
                            if (var18 == null) {
                                var18 = (class167) field1199.method1277(var16);
                            ...
                            Statics.field1196 = new class135(var15 + var19 + Statics.field812.field2490);
                        ...
                        if (Statics.field1196.field1729 == var20) {
                            if (Statics.field812.field1506 == 16711935L) {
                                ...
                                for (int var23 = 0; var23 < 256; var23++) {
                                    class120 var24 = field1200[var23];
                                    if (var24 != null) {
    ...
    public static void method96(class31 arg0, boolean arg1) {
        if (Statics.field169 != null) {
            try {
                Statics.field169.method392();
        ...
        field1201 = 0;
        while (true) {
            class167 var3 = (class167) field1187.method1284();
            if (var3 == null) {
                while (true) {
                    class167 var4 = (class167) field1199.method1284();
                    if (var4 == null) {
                        if (field1202 != 0) {
                            try {
                                class135 var5 = new class135(4);
                                var5.method1587(4);
                        ...
                        field1190 = 0;
                        Statics.field825 = class63.method1135();
                        return;
                    }
    ...
    public static void method555(int arg0, int arg1) {
        ...
        class167 var4 = (class167) field1193.method1277(var2);
        if (var4 != null) {
            field1189.method1257(var4);
        }
    }
