...
public final class class87 extends class89 {
    ...
    public void method1770() {
        if (this.field1480 == this.field1476 && this.field1481 == this.field1478) {
            return;
        }
        byte[] var1 = new byte[this.field1481 * this.field1480];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1478; var3++) {
            for (int var4 = 0; var4 < this.field1476; var4++) {
                var1[(this.field1475 + var3) * this.field1480 + this.field1477 + var4] = this.field1479[var2++];
            }
        }
        this.field1479 = var1;
        this.field1476 = this.field1480;
        this.field1478 = this.field1481;
        this.field1477 = 0;
        this.field1475 = 0;
    }
    ...
    public void method1781(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1772(Statics.field1484, this.field1479, this.field1474, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cu.e([I[B[IIIIIII)V")
    public static void method1772(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
