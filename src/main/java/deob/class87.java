...
public final class class87 extends class89 {
    ...
    public void method1768() {
        if (this.field1490 == this.field1489 && this.field1495 == this.field1494) {
            return;
        }
        byte[] var1 = new byte[this.field1495 * this.field1490];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1494; var3++) {
            for (int var4 = 0; var4 < this.field1489; var4++) {
                var1[(this.field1493 + var3) * this.field1490 + this.field1491 + var4] = this.field1492[var2++];
            }
        }
        this.field1492 = var1;
    ...
    public void method1771(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1782(Statics.field1502, this.field1492, this.field1488, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cq.z([I[B[IIIIIII)V")
    public static void method1782(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
