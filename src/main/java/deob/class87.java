...
public final class class87 extends class89 {
    ...
    public void method1819() {
        if (this.field1485 == this.field1483 && this.field1488 == this.field1481) {
            return;
        }
        byte[] var1 = new byte[this.field1488 * this.field1483];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1481; var3++) {
            for (int var4 = 0; var4 < this.field1485; var4++) {
                var1[(this.field1486 + var3) * this.field1483 + this.field1484 + var4] = this.field1487[var2++];
            }
        }
        this.field1487 = var1;
        this.field1485 = this.field1483;
        this.field1481 = this.field1488;
        this.field1484 = 0;
        this.field1486 = 0;
    }
    ...
    public void method1821(int arg0, int arg1, int arg2) {
        for (int var4 = 0; var4 < this.field1482.length; var4++) {
            int var5 = this.field1482[var4] >> 16 & 0xFF;
            int var6 = arg0 + var5;
            if (var6 < 0) {
                var6 = 0;
            } else if (var6 > 255) {
            ...
            int var7 = this.field1482[var4] >> 8 & 0xFF;
            int var8 = arg1 + var7;
            if (var8 < 0) {
                var8 = 0;
            } else if (var8 > 255) {
            ...
            int var9 = this.field1482[var4] & 0xFF;
            int var10 = arg2 + var9;
            if (var10 < 0) {
                var10 = 0;
            } else if (var10 > 255) {
            ...
            this.field1482[var4] = (var6 << 16) + (var8 << 8) + var10;
        }
    }

    @ObfuscatedName("cu.o(II)V")
    public void method1830(int arg0, int arg1) {
        int var3 = this.field1484 + arg0;
        int var4 = this.field1486 + arg1;
        ...
        if (var8 > 0 && var7 > 0) {
            method1823(Statics.field1494, this.field1487, this.field1482, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cu.n([I[B[IIIIIII)V")
