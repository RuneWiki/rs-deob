...
public final class class87 extends class89 {
    ...
    public void method1789() {
        if (this.field1475 == this.field1471 && this.field1472 == this.field1469) {
            return;
        }
        byte[] var1 = new byte[this.field1475 * this.field1469];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1472; var3++) {
            for (int var4 = 0; var4 < this.field1471; var4++) {
                var1[(this.field1476 + var3) * this.field1475 + this.field1473 + var4] = this.field1470[var2++];
            }
        }
        this.field1470 = var1;
        this.field1471 = this.field1475;
        this.field1472 = this.field1469;
        this.field1473 = 0;
        this.field1476 = 0;
    }
    ...
    public void method1788(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1796(Statics.field1479, this.field1470, this.field1474, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cy.e([I[B[IIIIIII)V")
