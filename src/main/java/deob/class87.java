...
public final class class87 extends class89 {
    ...
    public void method1706() {
        if (this.field1494 == this.field1493 && this.field1491 == this.field1490) {
            return;
        }
        byte[] var1 = new byte[this.field1493 * this.field1491];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1490; var3++) {
            for (int var4 = 0; var4 < this.field1494; var4++) {
                var1[(this.field1492 + var3) * this.field1493 + this.field1488 + var4] = this.field1489[var2++];
            }
        }
        this.field1489 = var1;
    ...
    public void method1702(int arg0, int arg1, int arg2) {
        for (int var4 = 0; var4 < this.field1487.length; var4++) {
            int var5 = this.field1487[var4] >> 16 & 0xFF;
            int var6 = arg0 + var5;
            if (var6 < 0) {
                var6 = 0;
            } else if (var6 > 255) {
            ...
            int var7 = this.field1487[var4] >> 8 & 0xFF;
            int var8 = arg1 + var7;
            if (var8 < 0) {
                var8 = 0;
            } else if (var8 > 255) {
            ...
            int var9 = this.field1487[var4] & 0xFF;
            int var10 = arg2 + var9;
            if (var10 < 0) {
                var10 = 0;
            } else if (var10 > 255) {
            ...
            this.field1487[var4] = (var6 << 16) + (var8 << 8) + var10;
        }
    }

    @ObfuscatedName("cn.a(II)V")
    public void method1700(int arg0, int arg1) {
        int var3 = this.field1488 + arg0;
        ...
        if (var8 > 0 && var7 > 0) {
            method1704(Statics.field1496, this.field1489, this.field1487, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cn.l([I[B[IIIIIII)V")
    public static void method1704(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
