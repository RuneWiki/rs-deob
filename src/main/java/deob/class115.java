...
public class class115 {
    ...
    public class115(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class200.method3038(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1597 = var4;
            this.field1595 = var5;
            this.field1596 = new int[var4][14];
    ...
    @ObfuscatedName("dt.t([BB)[B")
    public byte[] method2127(byte[] arg0) {
        if (this.field1596 != null) {
            int var2 = (int) ((long) this.field1595 * (long) arg0.length / (long) this.field1597) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field1595 + var5;
                int var11 = var10 / this.field1597;
                var4 += var11;
                var5 = var10 - this.field1597 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("dt.q(II)I")
    public int method2129(int arg0) {
        if (this.field1596 != null) {
            arg0 = (int) ((long) this.field1595 * (long) arg0 / (long) this.field1597);
        }
        return arg0;
    }
    ...
    public int method2126(int arg0) {
        if (this.field1596 != null) {
            arg0 = (int) ((long) this.field1595 * (long) arg0 / (long) this.field1597) + 6;
        }
        return arg0;
    }
}
