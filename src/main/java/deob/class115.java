...
public class class115 {
    ...
    public class115(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1671 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1671[var11];
    ...
    @ObfuscatedName("dx.w([BB)[B")
    public byte[] method1993(byte[] arg0) {
        if (this.field1671 != null) {
            int var2 = (int) ((long) this.field1668 * (long) arg0.length / (long) this.field1673) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1671[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1668 + var5;
    ...
    @ObfuscatedName("dx.s(IB)I")
    public int method1994(int arg0) {
        if (this.field1671 != null) {
            arg0 = (int) ((long) this.field1668 * (long) arg0 / (long) this.field1673);
        }
        return arg0;
    }
    ...
    public int method1997(int arg0) {
        if (this.field1671 != null) {
            arg0 = (int) ((long) this.field1668 * (long) arg0 / (long) this.field1673) + 6;
        }
        return arg0;
    }
}
