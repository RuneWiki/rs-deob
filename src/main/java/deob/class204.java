...
public final class class204 {
    ...
    @ObfuscatedName("gp.m")
    public static int[] field2419 = new int[6];

    @ObfuscatedName("gp.x")
    public static int[] field2420 = new int[6];

    @ObfuscatedName("gp.z")
    public static final int[][] field2421 = new int[][] { { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 2, 6 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 13, 14 } };

    @ObfuscatedName("gp.w")
    public static final int[][] field2422 = new int[][] { { 0, 1, 2, 3, 0, 0, 1, 3 }, { 1, 1, 2, 3, 1, 0, 1, 3 }, { 0, 1, 2, 3, 1, 0, 1, 3 }, { 0, 0, 1, 2, 0, 0, 2, 4, 1, 0, 4, 3 }, { 0, 0, 1, 4, 0, 0, 4, 3, 1, 1, 2, 4 }, { 0, 0, 4, 3, 1, 0, 1, 2, 1, 0, 2, 4 }, { 0, 1, 2, 4, 1, 0, 1, 4, 1, 0, 4, 3 }, { 0, 4, 1, 2, 0, 4, 2, 5, 1, 0, 4, 5, 1, 0, 5, 3 }, { 0, 4, 1, 2, 0, 4, 2, 3, 0, 4, 3, 5, 1, 0, 4, 5 }, { 0, 0, 4, 5, 1, 4, 1, 2, 1, 4, 2, 3, 1, 4, 3, 5 }, { 0, 0, 1, 5, 0, 1, 4, 5, 0, 1, 2, 4, 1, 0, 5, 3, 1, 5, 4, 3, 1, 4, 2, 3 }, { 1, 0, 1, 5, 1, 1, 4, 5, 1, 1, 2, 4, 0, 0, 5, 3, 0, 5, 4, 3, 0, 4, 2, 3 }, { 1, 0, 5, 4, 1, 0, 1, 5, 0, 0, 4, 3, 0, 4, 5, 3, 0, 5, 2, 3, 0, 1, 2, 5 } };

    public class204(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
        if (arg5 != arg6 || arg5 != arg7 || arg5 != arg8) {
            this.field2412 = false;
        }
        this.field2402 = arg0;
        this.field2413 = arg1;
        this.field2414 = arg17;
        this.field2415 = arg18;
        short var20 = 128;
        int var21 = var20 / 2;
        int var22 = var20 / 4;
        int var23 = var20 * 3 / 4;
        ...
        this.field2411 = new int[var25];
        this.field2410 = new int[var25];
        this.field2409 = new int[var25];
        ...
        for (int var30 = 0; var30 < var25; var30++) {
            ...
            this.field2411[var30] = var32;
            this.field2410[var30] = var34;
            this.field2409[var30] = var33;
            var26[var30] = var35;
            var27[var30] = var36;
        }
        int[] var37 = field2422[arg0];
        ...
        for (int var40 = 0; var40 < var38; var40++) {
            ...
            this.field2407[var40] = var42;
            this.field2408[var40] = var43;
            this.field2416[var40] = var44;
            if (var41 == 0) {
                this.field2404[var40] = var26[var42];
                this.field2405[var40] = var26[var43];
                this.field2406[var40] = var26[var44];
                if (this.field2401 != null) {
                    this.field2401[var40] = -1;
                }
            } else {
                this.field2404[var40] = var27[var42];
                this.field2405[var40] = var27[var43];
                this.field2406[var40] = var27[var44];
                if (this.field2401 != null) {
                    this.field2401[var40] = arg2;
                }
            }
        }
        int var45 = arg5;
