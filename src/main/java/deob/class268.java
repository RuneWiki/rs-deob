...
public class class268 {
    ...
    @ObfuscatedName("ij.p(Lkl;B)I")
    public static final int method4132(class290 arg0) {
        if (arg0 == null) {
            return 12;
        } else {
            switch(arg0.field3860) {
                case 7:
                    return 20;
                default:
                    return 12;
    ...
    @ObfuscatedName("df.m(Ljava/lang/CharSequence;Lkl;I)Ljava/lang/String;")
    public static String method1830(CharSequence arg0, class290 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
        ...
        int var8 = var3 - var2;
        if (var8 < 1 || var8 > method4132(arg1)) {
            return null;
        }
        ...
        for (int var10 = var2; var10 < var3; var10++) {
            ...
            if (Character.isISOControl(var11)) {
                ...
                if (var13) {
                    ...
                    char[] var14 = field3668;
                    int var15 = 0;
                    label99: while (true) {
                        if (var15 >= var14.length) {
                            char[] var17 = field3669;
