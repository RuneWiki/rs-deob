...
public class class109 {
    ...
    public class109(int arg0, int arg1) {
        this.field1867 = arg0;
        this.field1879 = arg1;
        this.field1880 = new int[this.field1867][this.field1879];
        this.method2242();
    }
    ...
    public void method2242() {
        for (int var1 = 0; var1 < this.field1867; var1++) {
            for (int var2 = 0; var2 < this.field1879; var2++) {
                if (var1 == 0 || var2 == 0 || var1 >= this.field1867 - 5 || var2 >= this.field1879 - 5) {
    ...
    public void method2247(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        if (arg2 == 0) {
            if (arg3 == 0) {
                this.method2269(var6, var7, 128);
                this.method2269(var6 - 1, var7, 8);
            }
            if (arg3 == 1) {
                this.method2269(var6, var7, 2);
                this.method2269(var6, var7 + 1, 32);
            }
            if (arg3 == 2) {
                this.method2269(var6, var7, 8);
                this.method2269(var6 + 1, var7, 128);
            }
            if (arg3 == 3) {
                this.method2269(var6, var7, 32);
                this.method2269(var6, var7 - 1, 2);
            }
        }
        if (arg2 == 1 || arg2 == 3) {
            if (arg3 == 0) {
                this.method2269(var6, var7, 1);
                this.method2269(var6 - 1, var7 + 1, 16);
            }
            if (arg3 == 1) {
                this.method2269(var6, var7, 4);
                this.method2269(var6 + 1, var7 + 1, 64);
            }
            if (arg3 == 2) {
                this.method2269(var6, var7, 16);
                this.method2269(var6 + 1, var7 - 1, 1);
            }
            if (arg3 == 3) {
                this.method2269(var6, var7, 64);
                this.method2269(var6 - 1, var7 - 1, 4);
            }
        }
        if (arg2 == 2) {
            if (arg3 == 0) {
                this.method2269(var6, var7, 130);
                this.method2269(var6 - 1, var7, 8);
                this.method2269(var6, var7 + 1, 32);
            }
            if (arg3 == 1) {
                this.method2269(var6, var7, 10);
                this.method2269(var6, var7 + 1, 32);
                this.method2269(var6 + 1, var7, 128);
            }
            if (arg3 == 2) {
                this.method2269(var6, var7, 40);
                this.method2269(var6 + 1, var7, 128);
                this.method2269(var6, var7 - 1, 2);
            }
            if (arg3 == 3) {
                this.method2269(var6, var7, 160);
                this.method2269(var6, var7 - 1, 2);
                this.method2269(var6 - 1, var7, 8);
            }
        }
        ...
        if (arg2 == 0) {
            if (arg3 == 0) {
                this.method2269(var6, var7, 65536);
                this.method2269(var6 - 1, var7, 4096);
            }
            if (arg3 == 1) {
                this.method2269(var6, var7, 1024);
                this.method2269(var6, var7 + 1, 16384);
            }
            if (arg3 == 2) {
                this.method2269(var6, var7, 4096);
                this.method2269(var6 + 1, var7, 65536);
            }
            if (arg3 == 3) {
                this.method2269(var6, var7, 16384);
                this.method2269(var6, var7 - 1, 1024);
            }
        }
        if (arg2 == 1 || arg2 == 3) {
            if (arg3 == 0) {
                this.method2269(var6, var7, 512);
                this.method2269(var6 - 1, var7 + 1, 8192);
            }
            if (arg3 == 1) {
                this.method2269(var6, var7, 2048);
                this.method2269(var6 + 1, var7 + 1, 32768);
            }
            if (arg3 == 2) {
                this.method2269(var6, var7, 8192);
                this.method2269(var6 + 1, var7 - 1, 512);
            }
            if (arg3 == 3) {
                this.method2269(var6, var7, 32768);
                this.method2269(var6 - 1, var7 - 1, 2048);
            }
        }
        if (arg2 != 2) {
            return;
        ...
        if (arg3 == 0) {
            this.method2269(var6, var7, 66560);
            this.method2269(var6 - 1, var7, 4096);
            this.method2269(var6, var7 + 1, 16384);
        }
        if (arg3 == 1) {
            this.method2269(var6, var7, 5120);
            this.method2269(var6, var7 + 1, 16384);
            this.method2269(var6 + 1, var7, 65536);
        }
        if (arg3 == 2) {
            this.method2269(var6, var7, 20480);
            this.method2269(var6 + 1, var7, 65536);
            this.method2269(var6, var7 - 1, 1024);
        }
        if (arg3 == 3) {
            this.method2269(var6, var7, 81920);
            this.method2269(var6, var7 - 1, 1024);
            this.method2269(var6 - 1, var7, 4096);
        }
    }

    @ObfuscatedName("dj.m(IIIIZI)V")
    public void method2243(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        for (int var9 = var7; var9 < arg2 + var7; var9++) {
            if (var9 >= 0 && var9 < this.field1867) {
                for (int var10 = var8; var10 < arg3 + var8; var10++) {
                    if (var10 >= 0 && var10 < this.field1879) {
                        this.method2269(var9, var10, var6);
                    }
                }
            }
        }
    ...
    @ObfuscatedName("dj.e(IIII)V")
    public void method2269(int arg0, int arg1, int arg2) {
    ...
    public void method2249(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        ...
        for (int var11 = var8; var11 < arg2 + var8; var11++) {
            if (var11 >= 0 && var11 < this.field1867) {
                for (int var12 = var9; var12 < arg3 + var9; var12++) {
                    if (var12 >= 0 && var12 < this.field1879) {
                        this.method2250(var11, var12, var7);
                    }
                }
            }
        }
