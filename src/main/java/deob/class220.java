...
public class class220 extends class130 {
    ...
    @ObfuscatedName("hr.cn([III)V")
    public static void method3749(int[] arg0, int arg1, int arg2) {
        Statics.field3171 = arg0;
        Statics.field3175 = arg1;
        Statics.field3170 = arg2;
        method3751(0, 0, arg1, arg2);
    }

    @ObfuscatedName("hr.cz()V")
    public static void method3750() {
        field3172 = 0;
        field3173 = 0;
        field3176 = Statics.field3175;
        field3174 = Statics.field3170;
    }

    @ObfuscatedName("hr.cw(IIII)V")
    public static void method3751(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 < 0) {
            arg0 = 0;
        }
        if (arg1 < 0) {
        ...
        if (arg3 > Statics.field3170) {
            arg3 = Statics.field3170;
        }
        field3172 = arg0;
        field3173 = arg1;
        field3176 = arg2;
    ...
    @ObfuscatedName("hr.ca(IIII)V")
    public static void method3786(int arg0, int arg1, int arg2, int arg3) {
        if (field3172 < arg0) {
            field3172 = arg0;
        }
        if (field3173 < arg1) {
    ...
    @ObfuscatedName("hr.cx()V")
    public static void method3793() {
        int var0 = 0;
        int var1 = Statics.field3175 * Statics.field3170 - 7;
        while (var0 < var1) {
    ...
    @ObfuscatedName("hr.ct(IIIIII)V")
    public static void method3762(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        if (arg0 < field3172) {
            arg2 -= field3172 - arg0;
            arg0 = field3172;
        }
    ...
    @ObfuscatedName("hr.dd(IIIIIIII)V")
    public static void method3830(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        int var8 = 0;
    ...
    @ObfuscatedName("hr.dk(IIIIIIII)V")
    public static void method3801(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        int var8 = 0;
        int var9 = arg4 == arg5 && arg6 == arg7 ? -1 : 65536 / arg3;
        int var10 = arg6;
        int var11 = 256 - arg6;
    ...
    @ObfuscatedName("hr.di(IIIIIIII)V")
    public static void method3828(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        int var8 = 0;
        int var9 = 65536 / arg3;
        int var10 = arg6;
        int var11 = 256 - arg6;
    ...
    @ObfuscatedName("hr.dh(IIIIIIII)V")
    ...
    @ObfuscatedName("hr.du(IIIIII)V")
    public static void method3777(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var6 = 0;
        int var7 = 65536 / arg3;
        if (arg0 < field3172) {
            arg2 -= field3172 - arg0;
    ...
    @ObfuscatedName("hr.dl(IIIII)V")
    public static void method3763(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method3765(arg0, arg1, arg2, arg4);
        method3765(arg0, arg1 + arg3 - 1, arg2, arg4);
        method3767(arg0, arg1, arg3, arg4);
        method3767(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("hr.ds(IIIIII)V")
    public static void method3764(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method3766(arg0, arg1, arg2, arg4, arg5);
        method3766(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
            method3768(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
            method3768(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
        }
    }

    @ObfuscatedName("hr.dj(IIII)V")
    public static void method3765(int arg0, int arg1, int arg2, int arg3) {
        if (arg1 < field3173 || arg1 >= field3174) {
            return;
        }
        if (arg0 < field3172) {
            arg2 -= field3172 - arg0;
    ...
    @ObfuscatedName("hr.dn(IIII)V")
    public static void method3767(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 < field3172 || arg0 >= field3176) {
            return;
        }
        if (arg1 < field3173) {
            arg2 -= field3173 - arg1;
    ...
    @ObfuscatedName("hr.dp(IIIII)V")
    public static void method3768(int arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 < field3172 || arg0 >= field3176) {
            return;
        }
        if (arg1 < field3173) {
    ...
    @ObfuscatedName("hr.do(IIIII)V")
    public static void method3769(int arg0, int arg1, int arg2, int arg3, int arg4) {
        int var5 = arg2 - arg0;
        int var6 = arg3 - arg1;
        if (var6 == 0) {
            if (var5 >= 0) {
                method3765(arg0, arg1, var5 + 1, arg4);
            } else {
                method3765(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field3173 && var12 < field3174) {
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field3172 && var18 < field3176) {
            ...
            method3767(arg0, arg1, var6 + 1, arg4);
        } else {
            method3767(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("hr.dw(III[I[I)V")
