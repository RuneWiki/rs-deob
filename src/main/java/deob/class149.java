...
public class class149 extends RuntimeException {
    ...
    @ObfuscatedName("ak.f(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method957(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
                String var5;
                if (arg1 instanceof class149) {
            ...
            if (Statics.field2223 == null) {
                return;
            }
            URL var26 = new URL(Statics.field2223.getCodeBase(), "clienterror.ws?c=" + Statics.field2229 + "&u=" + Statics.field2222 + "&v1=" + Statics.field2090 + "&v2=" + Statics.field2091 + "&e=" + var25);
    ...
    @ObfuscatedName("bi.u(Ljava/lang/Throwable;Ljava/lang/String;)Len;")
    public static class149 method1615(Throwable arg0, String arg1) {
        class149 var2;
        if (arg0 instanceof class149) {
            var2 = (class149) arg0;
            var2.field2224 = var2.field2224 + ' ' + arg1;
        } else {
