...
public class class149 {
    ...
    @ObfuscatedName("dl.g(CII)C")
    public static char method2394(char arg0, int arg1) {
    ...
    @ObfuscatedName("ax.e(CI)C")
    public static char method822(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("ae.n(CII)I")
    public static int method898(char arg0, int arg1) {
        int var2 = arg0 << 4;
