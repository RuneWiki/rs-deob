...
public class class149 extends RuntimeException {
    ...
    @ObfuscatedName("cr.s(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method1942(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2053.getCodeBase(), "clienterror.ws?c=" + Statics.field2237 + "&u=" + Statics.field2234 + "&v1=" + Statics.field2116 + "&v2=" + Statics.field2047 + "&e=" + var25);
    ...
    @ObfuscatedName("ak.j(Ljava/lang/Throwable;Ljava/lang/String;)Lea;")
    public static class149 method963(Throwable arg0, String arg1) {
        class149 var2;
        if (arg0 instanceof class149) {
            var2 = (class149) arg0;
            var2.field2235 = var2.field2235 + ' ' + arg1;
        } else {
