...
public class class149 implements Runnable {
    ...
    @ObfuscatedName("ef.b")
    public final Thread field2093 = new Thread(this);

    @ObfuscatedName("ef.s")
    public volatile boolean field2097;

    @ObfuscatedName("ef.r")
    public Queue field2094 = new LinkedList();

    public class149() {
        this.field2093.setPriority(1);
        this.field2093.start();
    }
    ...
    public void run() {
        while (!this.field2097) {
            try {
                class150 var2;
                synchronized (this) {
                    var2 = (class150) this.field2094.poll();
                    if (var2 == null) {
                        try {
                            this.wait();
                ...
                class154.method607((String) null, var21);
            }
        }
    }

    @ObfuscatedName("ef.b(Ljava/net/URL;I)Led;")
    public class150 method2679(URL arg0) {
        class150 var2 = new class150(arg0);
        synchronized (this) {
            this.field2094.add(var2);
            this.notify();
            return var2;
        }
    }
