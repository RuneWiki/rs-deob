...
public class class149 extends RuntimeException {
    ...
    @ObfuscatedName("w.w(Ljava/lang/String;Ljava/lang/Throwable;S)V")
    public static void method1(String arg0, Throwable arg1) {
        try {
            ...
            URL var26 = new URL(Statics.field2252.getCodeBase(), "clienterror.ws?c=" + Statics.field2244 + "&u=" + Statics.field2243 + "&v1=" + Statics.field2113 + "&v2=" + Statics.field787 + "&e=" + var25);
    ...
    @ObfuscatedName("i.x(Ljava/lang/Throwable;Ljava/lang/String;)Lew;")
    public static class149 method186(Throwable arg0, String arg1) {
        class149 var2;
        if (arg0 instanceof class149) {
            var2 = (class149) arg0;
            var2.field2245 = var2.field2245 + ' ' + arg1;
        } else {
