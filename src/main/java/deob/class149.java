...
public class class149 {
    ...
    @ObfuscatedName("et.a")
    public static final char[] field2463 = new char[] { ' ', ' ', '_', '-', 'à', 'á', 'â', 'ä', 'ã', 'À', 'Á', 'Â', 'Ä', 'Ã', 'è', 'é', 'ê', 'ë', 'È', 'É', 'Ê', 'Ë', 'í', 'î', 'ï', 'Í', 'Î', 'Ï', 'ò', 'ó', 'ô', 'ö', 'õ', 'Ò', 'Ó', 'Ô', 'Ö', 'Õ', 'ù', 'ú', 'û', 'ü', 'Ù', 'Ú', 'Û', 'Ü', 'ç', 'Ç', 'ÿ', 'Ÿ', 'ñ', 'Ñ', 'ß' };
    ...
    @ObfuscatedName("ej.p(Ljava/lang/CharSequence;Lgg;I)Ljava/lang/String;")
    public static String method2767(CharSequence arg0, class186 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
                ...
                for (int var12 = var2; var12 < var3; var12++) {
                    ...
                    if (Character.isISOControl(var13)) {
                        ...
                        if (var15) {
                            ...
                            char[] var16 = field2463;
                            int var17 = 0;
                            label105: while (true) {
                                if (var17 >= var16.length) {
                                    char[] var19 = field2465;
