...
public class class149 implements Runnable {
    ...
    @ObfuscatedName("ev.i")
    public final Thread field2195 = new Thread(this);
    ...
    public void run() {
        while (!this.field2194) {
            try {
                class150 var2;
                synchronized (this) {
                    var2 = (class150) this.field2196.poll();
                    if (var2 == null) {
                        try {
                            this.wait();
                ...
                try {
                    var6 = var2.field2203.openConnection();
                ...
                class154.method2746((String) null, var21);
            }
        }
    }

    @ObfuscatedName("ev.i(Ljava/net/URL;I)Len;")
    public class150 method2730(URL arg0) {
