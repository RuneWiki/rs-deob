...
public class class465 {
    ...
    public class465(float[] arg0, int arg1) {
        this.field4787 = arg0;
        this.field4788 = arg1;
    }

    @ObfuscatedName("hu.at([FIFZFZ[FI)I")
    public static int method3476(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class128.field1485;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class465 var16 = new class465(var10, arg1);
            ...
            int var20 = method3476(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method4477(var10, arg1, arg2);
                ...
                var22 = method4477(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    arg6[var12++] = method3148(var16, var26, var24, 0.0F);
    ...
    @ObfuscatedName("jd.ah([FIFI)F")
    public static float method4477(float[] arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("fc.ar(Lri;FFFI)F")
    public static float method3148(class465 arg0, float arg1, float arg2, float arg3) {
        float var4 = method4477(arg0.field4787, arg0.field4788, arg1);
        if (Math.abs(var4) < class128.field1485) {
            return arg1;
        }
        float var5 = method4477(arg0.field4787, arg0.field4788, arg2);
        if (Math.abs(var5) < class128.field1485) {
            return arg2;
        }
        float var6 = 0.0F;
        float var7 = 0.0F;
        ...
        do {
            ...
            float var13 = class128.field1486 * Math.abs(arg2) + arg3 * 0.5F;
            ...
            if (var15) {
                ...
                var5 = method4477(arg0.field4787, arg0.field4788, arg2);
