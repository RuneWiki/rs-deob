...
public final class class124 {
    ...
    @ObfuscatedName("dr.j(B)I")
    public final int method2616() {
        if (0 == --this.field2000 + 1) {
            this.method2615();
            this.field2000 = 255;
        }
        return this.field2002[this.field2000];
    }

    @ObfuscatedName("dr.h(B)V")
    public final void method2615() {
        this.field2004 += ++this.field2005;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field2007[var1];
            if ((var1 & 0x2) == 0) {
                if ((var1 & 0x1) == 0) {
            ...
            this.field2003 += this.field2007[var1 + 128 & 0xFF];
            int var3;
            this.field2007[var1] = var3 = this.field2004 + this.field2003 + this.field2007[(var2 & 0x3FC) >> 2];
            this.field2002[var1] = this.field2004 = this.field2007[(var3 >> 8 & 0x3FC) >> 2] + var2;
        }
    }

    @ObfuscatedName("dr.m(B)V")
    public final void method2622() {
        int var1 = -1640531527;
        int var2 = -1640531527;
        int var3 = -1640531527;
        int var4 = -1640531527;
        ...
        for (int var26 = 0; var26 < 256; var26 += 8) {
            ...
            var6 = var1 + var41;
            var8 = var7 + var48;
            this.field2007[var26] = var8;
            this.field2007[var26 + 1] = var7;
            this.field2007[var26 + 2] = var6;
            this.field2007[var26 + 3] = var5;
            this.field2007[var26 + 4] = var4;
            this.field2007[var26 + 5] = var3;
            this.field2007[var26 + 6] = var2;
            this.field2007[var26 + 7] = var1;
        }
        for (int var51 = 0; var51 < 256; var51 += 8) {
            int var52 = this.field2007[var51] + var8;
            int var53 = this.field2007[var51 + 1] + var7;
            int var54 = this.field2007[var51 + 2] + var6;
            int var55 = this.field2007[var51 + 3] + var5;
            int var56 = this.field2007[var51 + 4] + var4;
            int var57 = this.field2007[var51 + 5] + var3;
            int var58 = this.field2007[var51 + 6] + var2;
            int var59 = this.field2007[var51 + 7] + var1;
            ...
            var6 = var1 + var66;
            var8 = var7 + var73;
            this.field2007[var51] = var8;
            this.field2007[var51 + 1] = var7;
            this.field2007[var51 + 2] = var6;
            this.field2007[var51 + 3] = var5;
            this.field2007[var51 + 4] = var4;
            this.field2007[var51 + 5] = var3;
            this.field2007[var51 + 6] = var2;
            this.field2007[var51 + 7] = var1;
        }
        this.method2615();
        this.field2000 = 256;
    }
