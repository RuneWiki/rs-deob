...
public class class124 {
    ...
    @ObfuscatedName("de.j(III)I")
    public static int method2391(int arg0, int arg1) {
        if (arg1 > arg0) {
            int var2 = arg0;
            arg0 = arg1;
            arg1 = var2;
    ...
    @ObfuscatedName("client.f(IB)I")
    public static int method409(int arg0) {
    ...
    @ObfuscatedName("cy.o(IS)I")
    public static int method2058(int arg0) {
        int var6 = arg0 - 1;
    ...
    @ObfuscatedName("u.u(III)I")
    public static int method39(int arg0, int arg1) {
        int var2 = 0;
        while (arg1 > 0) {
