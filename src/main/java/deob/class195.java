...
public class class195 {
    ...
    @ObfuscatedName("bu.a(IIB)I")
    public static int method1655(int arg0, int arg1) {
        if (arg1 > arg0) {
            int var2 = arg0;
            arg0 = arg1;
            arg1 = var2;
    ...
    @ObfuscatedName("q.g(II)I")
    public static int method97(int arg0) {
        int var6 = arg0 - 1;
    ...
    @ObfuscatedName("et.x(II)I")
    public static int method3177(int arg0) {
        int var1 = 0;
    ...
    @ObfuscatedName("gq.h(IIB)I")
    public static int method3429(int arg0, int arg1) {
        int var2 = 0;
        while (arg1 > 0) {
    ...
    @ObfuscatedName("fq.f(III)I")
    public static int method3268(int arg0, int arg1) {
        int var2 = arg0 >>> 31;
