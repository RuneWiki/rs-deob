...
public final class class195 {
    ...
    public final void method3383() throws IOException {
    ...
    @ObfuscatedName("gg.p(I)J")
    public final long method3384() throws IOException {
        return this.field2924.length();
    }

    @ObfuscatedName("gg.c([BIII)I")
    public final int method3388(byte[] arg0, int arg1, int arg2) throws IOException {
