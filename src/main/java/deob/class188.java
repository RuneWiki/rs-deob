...
public final class class188 {
    ...
    @ObfuscatedName("fj.g(Ljava/lang/CharSequence;B)I")
    public static int method2893(CharSequence arg0) {
    ...
    @ObfuscatedName("ai.i([BIII)Ljava/lang/String;")
    public static String method649(byte[] arg0, int arg1, int arg2) {
