...
public final class class188 {
    ...
    @ObfuscatedName("cj.k([BILjava/lang/CharSequence;I)I")
    public static int method2061(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("em.y([BIII)Ljava/lang/String;")
    public static String method2842(byte[] arg0, int arg1, int arg2) {
