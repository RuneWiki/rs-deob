...
public final class class188 {
    ...
    @ObfuscatedName("ea.n(Ljava/lang/CharSequence;I)I")
    public static int method2645(CharSequence arg0) {
    ...
    @ObfuscatedName("bw.x([BIIS)Ljava/lang/String;")
    public static String method1420(byte[] arg0, int arg1, int arg2) {
