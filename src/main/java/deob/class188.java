...
public final class class188 {
    ...
    @ObfuscatedName("bn.g(Ljava/lang/CharSequence;I)I")
    public static int method1365(CharSequence arg0) {
    ...
    @ObfuscatedName("ef.s([BILjava/lang/CharSequence;I)I")
    public static int method2778(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("fb.h([BIII)Ljava/lang/String;")
    public static String method3101(byte[] arg0, int arg1, int arg2) {
