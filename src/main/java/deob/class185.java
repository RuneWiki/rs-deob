...
public class class185 {
    ...
    @ObfuscatedName("r.b(CII)C")
    public static char method39(char arg0, int arg1) {
    ...
    @ObfuscatedName("ak.q(CI)C")
    public static char method472(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("fi.o(CIB)I")
    public static int method3032(char arg0, int arg1) {
        int var2 = arg0 << 4;
