...
public final class class185 {
    ...
    @ObfuscatedName("cz.b(Ljava/lang/CharSequence;I)I")
    public static int method1868(CharSequence arg0) {
    ...
    @ObfuscatedName("w.u([BILjava/lang/CharSequence;I)I")
    public static int method502(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("fk.x([BIII)Ljava/lang/String;")
    public static String method3092(byte[] arg0, int arg1, int arg2) {
