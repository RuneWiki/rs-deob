...
public final class class185 {
    ...
    @ObfuscatedName("dp.z(Ljava/lang/CharSequence;I)I")
    public static int method2579(CharSequence arg0) {
    ...
    @ObfuscatedName("eb.j([BIIB)Ljava/lang/String;")
    public static String method2881(byte[] arg0, int arg1, int arg2) {
