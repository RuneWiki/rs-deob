...
public class class500 {
    ...
    @ObfuscatedName("tv.ao")
    public static int[] field5060 = new int[32768];
    ...
    @ObfuscatedName("tv.ab(I)V")
    public static void method8202() {
        if (Statics.field5056 != null) {
            return;
        }
        Statics.field5056 = new int[65536];
        ...
        for (int var2 = 0; var2 < 65536; var2++) {
            ...
            Statics.field5056[var2] = var34 & 0xFFFFFF;
        }
    }

    @ObfuscatedName("tv.ay(II)I")
    public static int method8203(int arg0) {
