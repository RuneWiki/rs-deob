...
public class class57 {
    ...
    @ObfuscatedName("bi.x(F)F")
    public static float method1096(float arg0) {
        float var1 = 32.703197F * (float) Math.pow(2.0D, (double) arg0);
        return var1 * 3.1415927F / 11025.0F;
    }

    @ObfuscatedName("bi.k(IIF)F")
    public float method1097(int arg0, int arg1, float arg2) {
    ...
    public int method1108(int arg0, float arg1) {
        if (arg0 == 0) {
        ...
        field1136[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1097(arg0, 0, arg1));
        field1136[arg0][1] = var5 * var5;
        for (int var6 = 1; var6 < this.field1141[arg0]; var6++) {
            float var7 = this.method1107(arg0, var6, arg1);
            float var8 = var7 * -2.0F * (float) Math.cos((double) this.method1097(arg0, var6, arg1));
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1141[0] * 2; var11++) {
                field1136[0][var11] *= Statics.field1138;
            }
        }
    ...
    @ObfuscatedName("bi.d(Ldw;Lad;)V")
    public final void method1099(class107 arg0, class51 arg1) {
        ...
        this.field1131[0] = arg0.method2140();
        this.field1131[1] = arg0.method2140();
        int var4 = arg0.method2148();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1141[var5]; var6++) {
                this.field1133[var5][0][var6] = arg0.method2140();
                this.field1134[var5][0][var6] = arg0.method2140();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1141[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1133[var7][1][var8] = arg0.method2140();
                    this.field1134[var7][1][var8] = arg0.method2140();
                }
            }
        }
        if (var4 != 0 || this.field1131[1] != this.field1131[0]) {
            arg1.method1049(arg0);
        }
    }
}
