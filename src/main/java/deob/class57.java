...
public class class57 {
    ...
    public int method1081(int arg0, float arg1) {
        if (arg0 == 0) {
            ...
            Statics.field1143 = (int) (Statics.field1139 * 65536.0F);
        }
        if (this.field1140[arg0] == 0) {
            return 0;
        }
        float var5 = this.method1092(arg0, 0, arg1);
        field1137[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1095(arg0, 0, arg1));
        field1137[arg0][1] = var5 * var5;
        for (int var6 = 1; var6 < this.field1140[arg0]; var6++) {
            float var7 = this.method1092(arg0, var6, arg1);
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1140[0] * 2; var11++) {
                field1137[0][var11] *= Statics.field1139;
            }
        }
    ...
    @ObfuscatedName("by.u(Ldi;Lae;)V")
    public final void method1082(class107 arg0, class51 arg1) {
        ...
        this.field1136[0] = arg0.method2166();
        this.field1136[1] = arg0.method2166();
        int var4 = arg0.method2101();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1140[var5]; var6++) {
                this.field1134[var5][0][var6] = arg0.method2166();
                this.field1135[var5][0][var6] = arg0.method2166();
            }
        }
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1140[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1134[var7][1][var8] = arg0.method2166();
                    this.field1135[var7][1][var8] = arg0.method2166();
                }
            }
        }
