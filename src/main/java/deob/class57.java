...
public class class57 {
    ...
    public static float method1078(float arg0) {
    ...
    public float method1066(int arg0, int arg1, float arg2) {
        ...
        return method1078(var5);
    }

    @ObfuscatedName("bn.o(IF)I")
    public int method1069(int arg0, float arg1) {
        if (arg0 == 0) {
            ...
            Statics.field1137 = (int) (Statics.field1139 * 65536.0F);
        }
        if (this.field1132[arg0] == 0) {
            return 0;
        }
        float var5 = this.method1067(arg0, 0, arg1);
        field1136[arg0][0] = var5 * -2.0F * (float) Math.cos((double) this.method1066(arg0, 0, arg1));
        ...
        if (arg0 == 0) {
            for (int var11 = 0; var11 < this.field1132[0] * 2; var11++) {
                field1136[0][var11] *= Statics.field1139;
            }
        }
        for (int var12 = 0; var12 < this.field1132[arg0] * 2; var12++) {
            field1138[arg0][var12] = (int) (field1136[arg0][var12] * 65536.0F);
        }
        return this.field1132[arg0] * 2;
    }

    @ObfuscatedName("bn.k(Lde;Laf;)V")
    public final void method1071(class107 arg0, class51 arg1) {
        ...
        this.field1140[0] = arg0.method2094();
        this.field1140[1] = arg0.method2094();
        int var4 = arg0.method2116();
        for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field1132[var5]; var6++) {
                this.field1134[var5][0][var6] = arg0.method2094();
        ...
        for (int var7 = 0; var7 < 2; var7++) {
            for (int var8 = 0; var8 < this.field1132[var7]; var8++) {
                if ((var4 & 0x1 << var7 * 4 << var8) == 0) {
                    ...
                    this.field1134[var7][1][var8] = arg0.method2094();
