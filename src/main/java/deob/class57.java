...
public class class57 {
    ...
    public class57(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field440 = var9;
            this.field435 = var10;
            this.field431 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field431[var11];
    ...
    @ObfuscatedName("by.h([BB)[B")
    public byte[] method1059(byte[] arg0) {
        if (this.field431 != null) {
            int var2 = (int) ((long) this.field435 * (long) arg0.length / (long) this.field440) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field431[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field435 + var5;
                int var11 = var10 / this.field440;
                var4 += var11;
                var5 = var10 - this.field440 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1058(int arg0) {
        if (this.field431 != null) {
            arg0 = (int) ((long) this.field435 * (long) arg0 / (long) this.field440);
        }
        return arg0;
    }

    @ObfuscatedName("by.v(IS)I")
    public int method1053(int arg0) {
        if (this.field431 != null) {
            arg0 = (int) ((long) this.field435 * (long) arg0 / (long) this.field440) + 6;
        }
        return arg0;
    }
}
