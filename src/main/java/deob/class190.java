...
public final class class190 {
    ...
    @ObfuscatedName("dz.e(Ljava/lang/CharSequence;I)I")
    public static int method2468(CharSequence arg0) {
    ...
    @ObfuscatedName("m.v([BIIB)Ljava/lang/String;")
    public static String method483(byte[] arg0, int arg1, int arg2) {
