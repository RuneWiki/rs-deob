...
public class class322 {
    ...
    public static final String[] field3734 = new String[] { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };

    @ObfuscatedName("ma.aw")
    public static Calendar field3735;
    ...
    @ObfuscatedName("fo.af(J)Ljava/lang/String;")
    public static String method3026(long arg0) {
        field3735.setTime(new Date(arg0));
