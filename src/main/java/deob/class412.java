...
public final class class412 {
    ...
    @ObfuscatedName("ol.c([BILjava/lang/CharSequence;I)I")
    public static int method6483(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("jq.b([BIII)Ljava/lang/String;")
    public static String method4787(byte[] arg0, int arg1, int arg2) {
