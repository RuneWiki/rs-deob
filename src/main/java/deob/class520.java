...
public final class class520 {
    ...
    @ObfuscatedName("rb.ac([BILjava/lang/CharSequence;B)I")
    public static int method7656(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("qh.al([BIIB)Ljava/lang/String;")
    public static String method7152(byte[] arg0, int arg1, int arg2) {
