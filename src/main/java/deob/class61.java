...
public final class class61 {
    ...
    @ObfuscatedName("hp.i(Ljava/lang/CharSequence;I)I")
    public static int method3752(CharSequence arg0) {
    ...
    @ObfuscatedName("aq.a([BIIB)Ljava/lang/String;")
    public static String method476(byte[] arg0, int arg1, int arg2) {
