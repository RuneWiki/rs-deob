...
public final class class61 {
    ...
    @ObfuscatedName("fx.i(Ljava/lang/CharSequence;S)I")
    public static int method3076(CharSequence arg0) {
    ...
    @ObfuscatedName("cu.c([BIII)Ljava/lang/String;")
    public static String method1608(byte[] arg0, int arg1, int arg2) {
