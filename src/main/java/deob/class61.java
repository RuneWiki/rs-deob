...
public final class class61 {
    ...
    @ObfuscatedName("cp.d(Ljava/lang/CharSequence;I)I")
    public static int method1678(CharSequence arg0) {
    ...
    @ObfuscatedName("fi.e([BIII)Ljava/lang/String;")
    public static String method2813(byte[] arg0, int arg1, int arg2) {
