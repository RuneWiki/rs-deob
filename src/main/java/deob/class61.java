...
public final class class61 {
    ...
    @ObfuscatedName("ck.i(Ljava/lang/CharSequence;I)I")
    public static int method1709(CharSequence arg0) {
    ...
    @ObfuscatedName("h.j([BIII)Ljava/lang/String;")
    public static String method181(byte[] arg0, int arg1, int arg2) {
