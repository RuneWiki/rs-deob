...
public class class61 {
    ...
    public class61(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1211 = var9;
            this.field1212 = var10;
            this.field1213 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1213[var11];
    ...
    @ObfuscatedName("bx.g([BI)[B")
    public byte[] method1294(byte[] arg0) {
        if (this.field1213 != null) {
            int var2 = (int) ((long) this.field1212 * (long) arg0.length / (long) this.field1211) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1213[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1212 + var5;
    ...
    public int method1302(int arg0) {
        if (this.field1213 != null) {
            arg0 = (int) ((long) this.field1212 * (long) arg0 / (long) this.field1211);
        }
        return arg0;
    }

    @ObfuscatedName("bx.n(IB)I")
    public int method1296(int arg0) {
        if (this.field1213 != null) {
            arg0 = (int) ((long) this.field1212 * (long) arg0 / (long) this.field1211) + 6;
        }
        return arg0;
    }
}
