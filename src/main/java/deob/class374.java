...
public class class374 {
    ...
    @ObfuscatedName("nj.c")
    public float[] field4261;

    @ObfuscatedName("nj.l")
    public int field4259;

    public class374(float[] arg0, int arg1) {
        this.field4261 = arg0;
        this.field4259 = arg1;
    }

    @ObfuscatedName("hs.c([FIFZFZ[FB)I")
    public static int method3981(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class113.field1387;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class374 var16 = new class374(var10, arg1);
            ...
            int var20 = method3981(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method2478(var10, arg1, arg2);
                ...
                var22 = method2478(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    arg6[var12++] = method5740(var16, var26, var24, 0.0F);
    ...
    @ObfuscatedName("dm.l([FIFI)F")
    public static float method2478(float[] arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("mu.s(Lnj;FFFI)F")
    public static float method5740(class374 arg0, float arg1, float arg2, float arg3) {
        float var4 = method2478(arg0.field4261, arg0.field4259, arg1);
        if (Math.abs(var4) < class113.field1387) {
            return arg1;
        }
        float var5 = method2478(arg0.field4261, arg0.field4259, arg2);
        if (Math.abs(var5) < class113.field1387) {
            return arg2;
        }
        float var6 = 0.0F;
        float var7 = 0.0F;
        ...
        do {
            ...
            float var13 = class113.field1391 * Math.abs(arg2) + arg3 * 0.5F;
            ...
            if (var15) {
                ...
                var5 = method2478(arg0.field4261, arg0.field4259, arg2);
