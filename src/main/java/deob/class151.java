...
public class class151 {
    ...
    @ObfuscatedName("ew.t(CI)C")
    public static char method2735(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("bw.n(CII)I")
    public static int method1252(char arg0, int arg1) {
        int var2 = arg0 << 4;
