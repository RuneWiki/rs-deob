...
public class class151 {
    ...
    @ObfuscatedName("v.p(CIB)C")
    public static char method145(char arg0, int arg1) {
    ...
    @ObfuscatedName("ca.e(CI)C")
    public static char method1659(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("dh.a(CII)I")
    public static int method2240(char arg0, int arg1) {
        int var2 = arg0 << 4;
