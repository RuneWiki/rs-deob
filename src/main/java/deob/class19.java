...
public class class19 {
    ...
    @ObfuscatedName("t.r")
    public class21 field276;

    @ObfuscatedName("t.d")
    public class21 field265;

    @ObfuscatedName("t.l")
    public class21 field272;
    ...
    public final int[] method269(int arg0, int arg1) {
        class68.method883(field270, 0, arg0);
        if (arg1 < 10) {
            return field270;
        }
            ...
            if (arg0 >= var31 + var32) {
                ...
                while (var33 < var34) {
                    ...
                    for (int var36 = 0; var36 < var31; var36++) {
                        var35 += (int) ((long) field270[var31 + var33 - 1 - var36] * (long) class27.field342[0][var36] >> 16);
                    }
                    for (int var37 = 0; var37 < var33; var37++) {
                        var35 -= (int) ((long) field270[var33 - 1 - var37] * (long) class27.field342[1][var37] >> 16);
                    }
                ...
                while (true) {
                    ...
                    while (var33 < var38) {
                        ...
                        for (int var40 = 0; var40 < var31; var40++) {
                            var39 += (int) ((long) field270[var31 + var33 - 1 - var40] * (long) class27.field342[0][var40] >> 16);
                        }
                        for (int var41 = 0; var41 < var32; var41++) {
                            var39 -= (int) ((long) field270[var33 - 1 - var41] * (long) class27.field342[1][var41] >> 16);
                        }
                    ...
                    if (var33 >= arg0 - var31) {
                        while (var33 < arg0) {
                            ...
                            for (int var43 = var31 + var33 - arg0; var43 < var31; var43++) {
                                var42 += (int) ((long) field270[var31 + var33 - 1 - var43] * (long) class27.field342[0][var43] >> 16);
                            }
                            for (int var44 = 0; var44 < var32; var44++) {
                                var42 -= (int) ((long) field270[var33 - 1 - var44] * (long) class27.field342[1][var44] >> 16);
                            }
    ...
    public final void method263(class135 arg0) {
        this.field276 = new class21();
