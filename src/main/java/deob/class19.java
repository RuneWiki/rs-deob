...
public class class19 extends class179 {
    ...
    @ObfuscatedName("c.i(III)I")
    public static int method251(int arg0, int arg1) {
        class19 var2 = (class19) field293.method3268((long) arg0);
        if (var2 == null) {
            return -1;
    ...
    @ObfuscatedName("fi.p(III)I")
    public static int method3119(int arg0, int arg1) {
        class19 var2 = (class19) field293.method3268((long) arg0);
        if (var2 == null) {
            return 0;
        } else if (arg1 == -1) {
    ...
    @ObfuscatedName("ar.a(IIIII)V")
    public static void method688(int arg0, int arg1, int arg2, int arg3) {
        class19 var4 = (class19) field293.method3268((long) arg0);
        if (var4 == null) {
            var4 = new class19();
            field293.method3269(var4, (long) arg0);
        }
