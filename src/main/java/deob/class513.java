...
public abstract class class513 {
    ...
    @ObfuscatedName("tq.av")
    public int field5139 = 0;

    @ObfuscatedName("tq.ab")
    public int field5141 = 0;

    @ObfuscatedName("tq.ai")
    public double field5140 = 0.0D;
    ...
    public class513(int arg0, int arg1) {
        this.field5139 = arg0;
        this.field5141 = 0;
        this.field5142 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field5140 = method7673(this.field5141, this.field5139, this.field5142);
    }

    @ObfuscatedName("tq.ai(I)V")
    public void method8174() {
        if (this.field5141 < this.field5139) {
            this.field5141++;
            this.field5140 = method7673(this.field5141, this.field5139, this.field5142);
        }
    }

    @ObfuscatedName("tq.ae(I)D")
    public double method8171() {
        return this.field5140;
    }

    @ObfuscatedName("rw.au(IIIB)D")
    public static double method7673(int arg0, int arg1, int arg2) {
