...
public class class136 extends RuntimeException {
    ...
    @ObfuscatedName("t.v(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method1295(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2038.getCodeBase(), "clienterror.ws?c=" + Statics.field535 + "&u=" + Statics.field2035 + "&v1=" + Statics.field1935 + "&v2=" + Statics.field1944 + "&e=" + var25);
    ...
    @ObfuscatedName("an.c(Ljava/lang/Throwable;Ljava/lang/String;)Lcz;")
    public static class136 method3247(Throwable arg0, String arg1) {
        class136 var2;
        if (arg0 instanceof class136) {
            var2 = (class136) arg0;
            var2.field2036 = var2.field2036 + ' ' + arg1;
        } else {
