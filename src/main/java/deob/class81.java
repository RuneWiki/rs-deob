...
public final class class81 extends class80 {
    ...
    public void method1752() {
        if (this.field1436 == this.field1432 && this.field1437 == this.field1430) {
            return;
        }
        byte[] var1 = new byte[this.field1436 * this.field1430];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1437; var3++) {
            for (int var4 = 0; var4 < this.field1432; var4++) {
                var1[(this.field1433 + var3) * this.field1436 + this.field1434 + var4] = this.field1435[var2++];
            }
        }
        this.field1435 = var1;
        this.field1432 = this.field1436;
        this.field1437 = this.field1430;
        this.field1434 = 0;
        this.field1433 = 0;
    }
    ...
    public void method1753(int arg0, int arg1, int arg2) {
        for (int var4 = 0; var4 < this.field1431.length; var4++) {
            int var5 = this.field1431[var4] >> 16 & 0xFF;
            int var6 = arg0 + var5;
            if (var6 < 0) {
                var6 = 0;
            } else if (var6 > 255) {
            ...
            int var7 = this.field1431[var4] >> 8 & 0xFF;
            int var8 = arg1 + var7;
            if (var8 < 0) {
                var8 = 0;
            } else if (var8 > 255) {
            ...
            int var9 = this.field1431[var4] & 0xFF;
            int var10 = arg2 + var9;
            if (var10 < 0) {
                var10 = 0;
            } else if (var10 > 255) {
            ...
            this.field1431[var4] = (var6 << 16) + (var8 << 8) + var10;
        }
    }
    ...
    public void method1759(int arg0, int arg1) {
        ...
        int var4 = this.field1433 + arg1;
        int var5 = Statics.field1424 * var4 + var3;
        int var6 = 0;
        int var7 = this.field1437;
        ...
        if (var8 > 0 && var7 > 0) {
            method1755(Statics.field1426, this.field1435, this.field1431, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cu.g([I[B[IIIIIII)V")
