...
public final class class81 extends class80 {
    ...
    public void method1721() {
        if (this.field1425 == this.field1422 && this.field1427 == this.field1423) {
            return;
        }
        byte[] var1 = new byte[this.field1427 * this.field1425];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1423; var3++) {
            for (int var4 = 0; var4 < this.field1422; var4++) {
                var1[(this.field1420 + var3) * this.field1425 + this.field1424 + var4] = this.field1426[var2++];
            }
        }
        this.field1426 = var1;
        this.field1422 = this.field1425;
        this.field1423 = this.field1427;
        this.field1424 = 0;
        this.field1420 = 0;
    }
    ...
    public void method1724(int arg0, int arg1) {
        int var3 = this.field1424 + arg0;
        int var4 = this.field1420 + arg1;
        int var5 = Statics.field1414 * var4 + var3;
        int var6 = 0;
        int var7 = this.field1423;
        int var8 = this.field1422;
        ...
        if (var8 > 0 && var7 > 0) {
            method1722(Statics.field1417, this.field1426, this.field1421, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cr.w([I[B[IIIIIII)V")
