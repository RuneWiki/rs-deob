...
public class class81 {
    ...
    public class81(byte[] arg0, class95 arg1) {
        ...
        var3.field1837 = 2;
        int var5 = var3.method2151();
        int var6 = -1;
        int var7 = 0;
        var4.field1837 = var3.field1837 + var5;
        for (int var8 = 0; var8 < var5; var8++) {
            int var9 = var3.method2151();
            if (var9 > 0) {
                if (this.field1436.field1656[var8] != 0) {
                    for (int var10 = var8 - 1; var10 > var6; var10--) {
                        if (this.field1436.field1656[var10] == 0) {
                ...
                field1441[var7] = var8;
                short var11 = 0;
                if (this.field1436.field1656[var8] == 3) {
                    var11 = 128;
                }
                if ((var9 & 0x1) == 0) {
                    field1435[var7] = var11;
                } else {
                    field1435[var7] = var4.method2163();
                }
                if ((var9 & 0x2) == 0) {
                    field1434[var7] = var11;
                } else {
                    field1434[var7] = var4.method2163();
                }
                if ((var9 & 0x4) == 0) {
                    field1437[var7] = var11;
                } else {
                    field1437[var7] = var4.method2163();
                }
                var6 = var8;
                var7++;
                if (this.field1436.field1656[var8] == 5) {
                    this.field1444 = true;
                }
            }
        }
        ...
        for (int var12 = 0; var12 < var7; var12++) {
            ...
            this.field1438[var12] = field1435[var12];
            this.field1442[var12] = field1434[var12];
