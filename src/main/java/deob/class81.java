...
public final class class81 extends class80 {
    ...
    public void method1756() {
        if (this.field1414 == this.field1408 && this.field1415 == this.field1411) {
            return;
        }
        byte[] var1 = new byte[this.field1415 * this.field1414];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1411; var3++) {
            for (int var4 = 0; var4 < this.field1408; var4++) {
                var1[(this.field1410 + var3) * this.field1414 + this.field1412 + var4] = this.field1409[var2++];
            }
        }
        this.field1409 = var1;
        this.field1408 = this.field1414;
    ...
    public void method1757(int arg0, int arg1, int arg2) {
    ...
    public void method1758(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1769(Statics.field1407, this.field1409, this.field1413, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cp.l([I[B[IIIIIII)V")
    public static void method1769(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
