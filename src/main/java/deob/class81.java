...
public final class class81 extends class80 {
    ...
    public void method1737() {
        if (this.field1427 == this.field1424 && this.field1429 == this.field1422) {
            return;
        }
        byte[] var1 = new byte[this.field1429 * this.field1427];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field1422; var3++) {
            for (int var4 = 0; var4 < this.field1424; var4++) {
                var1[(this.field1425 + var3) * this.field1427 + this.field1426 + var4] = this.field1428[var2++];
            }
        }
        this.field1428 = var1;
        this.field1424 = this.field1427;
        this.field1422 = this.field1429;
        this.field1426 = 0;
        this.field1425 = 0;
    }
    ...
    public void method1736(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1744(Statics.field1415, this.field1428, this.field1423, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("ca.n([I[B[IIIIIII)V")
