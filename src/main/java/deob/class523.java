...
public abstract class class523 {
    ...
    @ObfuscatedName("ug.ae")
    public int field5230 = 0;

    @ObfuscatedName("ug.am")
    public int field5234 = 0;

    @ObfuscatedName("ug.at")
    public double field5232 = 0.0D;

    @ObfuscatedName("ug.au")
    public int field5233 = 0;

    public class523(int arg0, int arg1) {
        this.field5230 = arg0;
        this.field5234 = 0;
        this.field5233 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field5232 = method3524(this.field5234, this.field5230, this.field5233);
    }

    @ObfuscatedName("ug.at(I)V")
    public void method8707() {
        if (this.field5234 < this.field5230) {
            this.field5234++;
            this.field5232 = method3524(this.field5234, this.field5230, this.field5233);
        }
    }

    @ObfuscatedName("ug.au(I)D")
    public double method8708() {
        return this.field5232;
    }

    @ObfuscatedName("ga.an(IIII)D")
    public static double method3524(int arg0, int arg1, int arg2) {
