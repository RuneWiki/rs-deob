...
public class class282 {
    ...
    @ObfuscatedName("jx.o([BII[BII)I")
    public int method4869(byte[] arg0, int arg1, int arg2, byte[] arg3, int arg4) {
        int var6 = 0;
        int var7 = arg4 << 3;
        int var8 = arg1 + arg2;
        while (arg1 < var8) {
            int var9 = arg0[arg1] & 0xFF;
            int var10 = this.field3325[var9];
            byte var11 = this.field3327[var9];
            if (var11 == 0) {
    ...
    public int method4866(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        ...
        while (true) {
            byte var9 = arg0[var8];
            if (var9 < 0) {
                var6 = this.field3326[var6];
            } else {
                var6++;
            }
            int var10;
            if ((var10 = this.field3326[var6]) < 0) {
            ...
            int var11;
            if ((var11 = this.field3326[var6]) < 0) {
            ...
            int var12;
            if ((var12 = this.field3326[var6]) < 0) {
            ...
            int var13;
            if ((var13 = this.field3326[var6]) < 0) {
            ...
            int var14;
            if ((var14 = this.field3326[var6]) < 0) {
            ...
            int var15;
            if ((var15 = this.field3326[var6]) < 0) {
            ...
            int var16;
            if ((var16 = this.field3326[var6]) < 0) {
            ...
            int var17;
            if ((var17 = this.field3326[var6]) < 0) {
