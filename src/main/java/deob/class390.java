...
public class class390 {
    ...
    @ObfuscatedName("ft.c([FIFZFZ[FI)I")
    public static int method3209(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class115.field1430;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            int var20 = method3209(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method2991(var10, arg1, arg2);
                ...
                var22 = method2991(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    arg6[var12++] = method6794(var16, var26, var24, 0.0F);
    ...
    @ObfuscatedName("fw.v([FIFB)F")
    public static float method2991(float[] arg0, int arg1, float arg2) {
    ...
    @ObfuscatedName("pe.q(Lnk;FFFI)F")
    public static float method6794(class390 arg0, float arg1, float arg2, float arg3) {
        float var4 = method2991(arg0.field4416, arg0.field4415, arg1);
        if (Math.abs(var4) < class115.field1430) {
            return arg1;
        }
        float var5 = method2991(arg0.field4416, arg0.field4415, arg2);
        if (Math.abs(var5) < class115.field1430) {
            return arg2;
        }
        float var6 = 0.0F;
        float var7 = 0.0F;
        ...
        do {
            ...
            float var13 = class115.field1433 * Math.abs(arg2) + arg3 * 0.5F;
            ...
            if (var15) {
                ...
                var5 = method2991(arg0.field4416, arg0.field4415, arg2);
