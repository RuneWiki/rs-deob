...
public final class class129 {
    ...
    @ObfuscatedName("dh.w")
    public static int[] field1858 = new int[6];

    @ObfuscatedName("dh.i")
    public static int[] field1859 = new int[6];

    @ObfuscatedName("dh.g")
    public static final int[][] field1860 = new int[][] { { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 2, 6 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 13, 14 } };
    ...
    public class129(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
        ...
        this.field1843 = arg0;
        this.field1851 = arg1;
        this.field1853 = arg17;
        this.field1854 = arg18;
        short var20 = 128;
        int var21 = var20 / 2;
        int var22 = var20 / 4;
        int var23 = var20 * 3 / 4;
        int[] var24 = field1860[arg0];
        int var25 = var24.length;
        this.field1846 = new int[var25];
        this.field1841 = new int[var25];
        ...
        for (int var30 = 0; var30 < var25; var30++) {
            ...
            this.field1846[var30] = var32;
            this.field1841[var30] = var34;
            this.field1842[var30] = var33;
            var26[var30] = var35;
            var27[var30] = var36;
        }
        int[] var37 = field1861[arg0];
        int var38 = var37.length / 4;
        this.field1848 = new int[var38];
        this.field1847 = new int[var38];
        this.field1852 = new int[var38];
        this.field1849 = new int[var38];
        this.field1844 = new int[var38];
        ...
        for (int var40 = 0; var40 < var38; var40++) {
            ...
            this.field1848[var40] = var42;
            this.field1847[var40] = var43;
            this.field1852[var40] = var44;
            if (var41 == 0) {
                this.field1849[var40] = var26[var42];
                this.field1844[var40] = var26[var43];
                this.field1845[var40] = var26[var44];
                if (this.field1840 != null) {
                    this.field1840[var40] = -1;
                }
            } else {
                this.field1849[var40] = var27[var42];
                this.field1844[var40] = var27[var43];
                this.field1845[var40] = var27[var44];
                if (this.field1840 != null) {
