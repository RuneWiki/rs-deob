...
public final class class182 {
    ...
    public final int method3161() {
        if (0 == --this.field2426 + 1) {
            this.method3169();
            this.field2426 = 255;
        }
        return this.field2427[this.field2426];
    }

    @ObfuscatedName("fs.h(I)V")
    public final void method3169() {
        this.field2424 += ++this.field2432;
        for (int var1 = 0; var1 < 256; var1++) {
            ...
            this.field2431 += this.field2429[var1 + 128 & 0xFF];
            int var3;
            this.field2429[var1] = var3 = this.field2424 + this.field2431 + this.field2429[(var2 & 0x3FC) >> 2];
            this.field2427[var1] = this.field2424 = this.field2429[(var3 >> 8 & 0x3FC) >> 2] + var2;
        }
    }
    ...
    public final void method3171() {
        ...
        for (int var26 = 0; var26 < 256; var26 += 8) {
            ...
            var6 = var1 + var41;
            var8 = var7 + var48;
            this.field2429[var26] = var8;
            this.field2429[var26 + 1] = var7;
            this.field2429[var26 + 2] = var6;
            this.field2429[var26 + 3] = var5;
            this.field2429[var26 + 4] = var4;
            this.field2429[var26 + 5] = var3;
            this.field2429[var26 + 6] = var2;
            this.field2429[var26 + 7] = var1;
        }
        for (int var51 = 0; var51 < 256; var51 += 8) {
            int var52 = this.field2429[var51] + var8;
            int var53 = this.field2429[var51 + 1] + var7;
            int var54 = this.field2429[var51 + 2] + var6;
            int var55 = this.field2429[var51 + 3] + var5;
            int var56 = this.field2429[var51 + 4] + var4;
            int var57 = this.field2429[var51 + 5] + var3;
            int var58 = this.field2429[var51 + 6] + var2;
            int var59 = this.field2429[var51 + 7] + var1;
            ...
            var6 = var1 + var66;
            var8 = var7 + var73;
            this.field2429[var51] = var8;
            this.field2429[var51 + 1] = var7;
            this.field2429[var51 + 2] = var6;
            this.field2429[var51 + 3] = var5;
            this.field2429[var51 + 4] = var4;
            this.field2429[var51 + 5] = var3;
            this.field2429[var51 + 6] = var2;
            this.field2429[var51 + 7] = var1;
        }
        this.method3169();
        this.field2426 = 256;
    }
