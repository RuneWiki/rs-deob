...
public class class182 {
    ...
    @ObfuscatedName("ef.d(Ldc;IB)V")
    public static void method2634(class116 arg0, int arg1) {
        while (true) {
            class181 var2 = (class181) field2830.method3278();
            if (var2 == null) {
                return;
            }
            ...
            arg0.method2389(var2.field2829);
            for (int var4 = 0; var4 < var2.field2822; var4++) {
                if (var2.field2825[var4] == 0) {
                    try {
                        ...
                        if (var5 == 3) {
                            ...
                            if (var16 == null) {
                                ...
                                arg0.method2386(1);
                                arg0.method2390(((Number) var16).longValue());
                            } else if (var16 instanceof String) {
                                arg0.method2386(2);
                                arg0.method2574((String) var16);
                            } else {
                                arg0.method2386(4);
                            }
                        } else if (var5 == 4) {
                    ...
                    arg0.method2386(var2.field2825[var4]);
                }
            }
            arg0.method2579(var3);
            arg0.method2397(arg0.field2042 - var3);
            var2.method3306();
        }
    }

    @ObfuscatedName("de.g(Ljava/lang/String;I)Ljava/lang/Class;")
    public static Class method2618(String arg0) throws ClassNotFoundException {
        if (arg0.equals("B")) {
            return Byte.TYPE;
