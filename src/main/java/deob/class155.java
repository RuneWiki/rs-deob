...
public class class155 extends RuntimeException {
    ...
    @ObfuscatedName("co.p(Ljava/lang/String;Ljava/lang/Throwable;S)V")
    public static void method1770(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2102.getCodeBase(), "clienterror.ws?c=" + Statics.field2100 + "&u=" + Statics.field2099 + "&v1=" + Statics.field2532 + "&v2=" + Statics.field2083 + "&e=" + var25);
    ...
    @ObfuscatedName("ju.i(Ljava/lang/Throwable;Ljava/lang/String;)Lef;")
    public static class155 method4665(Throwable arg0, String arg1) {
        class155 var2;
