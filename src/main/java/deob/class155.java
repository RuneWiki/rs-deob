...
public class class155 extends RuntimeException {
    ...
    @ObfuscatedName("q.s(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method73(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field2123.getCodeBase(), "clienterror.ws?c=" + Statics.field2119 + "&u=" + Statics.field2118 + "&v1=" + Statics.field2534 + "&v2=" + Statics.field2140 + "&e=" + var25);
    ...
    @ObfuscatedName("client.g(Ljava/lang/Throwable;Ljava/lang/String;)Leb;")
    public static class155 method1476(Throwable arg0, String arg1) {
        class155 var2;
