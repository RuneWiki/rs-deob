...
public class class155 extends RuntimeException {
    ...
    @ObfuscatedName("dv.v(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2337(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1984.getCodeBase(), "clienterror.ws?c=" + Statics.field1982 + "&u=" + Statics.field1983 + "&v1=" + Statics.field1998 + "&v2=" + Statics.field1920 + "&ct=" + Statics.field333 + "&e=" + var25);
    ...
    @ObfuscatedName("ai.s(Ljava/lang/Throwable;Ljava/lang/String;)Leh;")
    public static class155 method870(Throwable arg0, String arg1) {
        class155 var2;
