...
public class class155 extends RuntimeException {
    ...
    @ObfuscatedName("et.f(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2919(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1999.getCodeBase(), "clienterror.ws?c=" + Statics.field1996 + "&u=" + Statics.field1995 + "&v1=" + Statics.field4012 + "&v2=" + Statics.field2020 + "&ct=" + Statics.field1994 + "&e=" + var25);
    ...
    @ObfuscatedName("bs.l(Ljava/lang/Throwable;Ljava/lang/String;)Lep;")
    public static class155 method982(Throwable arg0, String arg1) {
        class155 var2;
        if (arg0 instanceof class155) {
            var2 = (class155) arg0;
            var2.field1998 = var2.field1998 + ' ' + arg1;
        } else {
