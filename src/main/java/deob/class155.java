...
public class class155 {
    ...
    @ObfuscatedName("ea.g")
    public static final char[] field2564 = new char[] { ' ', ' ', '_', '-', 'à', 'á', 'â', 'ä', 'ã', 'À', 'Á', 'Â', 'Ä', 'Ã', 'è', 'é', 'ê', 'ë', 'È', 'É', 'Ê', 'Ë', 'í', 'î', 'ï', 'Í', 'Î', 'Ï', 'ò', 'ó', 'ô', 'ö', 'õ', 'Ò', 'Ó', 'Ô', 'Ö', 'Õ', 'ù', 'ú', 'û', 'ü', 'Ù', 'Ú', 'Û', 'Ü', 'ç', 'Ç', 'ÿ', 'Ÿ', 'ñ', 'Ñ', 'ß' };

    @ObfuscatedName("ea.n")
    public static final char[] field2567 = new char[] { '[', ']', '#' };

    public class155() throws Throwable {
        throw new Error();
    }

    @ObfuscatedName("ct.y(Ljava/lang/CharSequence;Lgj;B)Ljava/lang/String;")
    public static String method2081(CharSequence arg0, class203 arg1) {
        if (arg0 == null) {
            return null;
        }
        int var2 = 0;
                ...
                for (int var12 = var2; var12 < var3; var12++) {
                    ...
                    if (Character.isISOControl(var13)) {
                        ...
                        if (var15) {
                            ...
                            char[] var16 = field2564;
                            int var17 = 0;
                            label105: while (true) {
                                if (var17 >= var16.length) {
                                    char[] var19 = field2567;
