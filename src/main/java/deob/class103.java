...
public class class103 extends class204 {
    ...
    @ObfuscatedName("ck.g")
    public class88[] field1757;

    @ObfuscatedName("p.g(Lfc;Lfc;IZS)Lck;")
    public static class103 method108(class167 arg0, class167 arg1, int arg2, boolean arg3) {
        boolean var4 = true;
    ...
    public class103(class167 arg0, class167 arg1, int arg2, boolean arg3) {
        ...
        this.field1757 = new class88[var6];
        int[] var7 = arg0.method3087(arg2);
        for (int var8 = 0; var8 < var7.length; var8++) {
            byte[] var9 = arg0.method3112(arg2, var7[var8]);
            class102 var10 = null;
            int var11 = (var9[0] & 0xFF) << 8 | var9[1] & 0xFF;
            for (class102 var12 = (class102) var5.method3603(); var12 != null; var12 = (class102) var5.method3596()) {
            ...
            if (var10 == null) {
                ...
                var5.method3598(var10);
            }
            this.field1757[var7[var8]] = new class88(var9, var10);
        }
    }

    @ObfuscatedName("ck.b(IB)Z")
    public boolean method2168(int arg0) {
        return this.field1757[arg0].field1534;
    }
}
