...
public class class454 {
    ...
    @ObfuscatedName("rp.aw")
    public float[] field4758;

    @ObfuscatedName("rp.ay")
    public int field4759;

    public class454(float[] arg0, int arg1) {
        this.field4758 = arg0;
        this.field4759 = arg1;
    }

    @ObfuscatedName("tu.aw([FIFZFZ[FI)I")
    public static int method8167(float[] arg0, int arg1, float arg2, boolean arg3, float arg4, boolean arg5, float[] arg6) {
        float var7 = 0.0F;
        for (int var8 = 0; var8 < arg1 + 1; var8++) {
            var7 += Math.abs(arg0[var8]);
        }
        float var9 = (Math.abs(arg2) + Math.abs(arg4)) * (float) (arg1 + 1) * class127.field1495;
        if (var7 <= var9) {
            return -1;
        }
        ...
        if (arg1 == 0) {
            ...
            class454 var16 = new class454(var10, arg1);
            ...
            int var20 = method8167(var17, arg1 - 1, arg2, false, arg4, false, var19);
            if (var20 == -1) {
                return 0;
            }
            boolean var21 = false;
            ...
            for (int var25 = 0; var25 <= var20; var25++) {
                ...
                if (var25 == 0) {
                    var26 = arg2;
                    var27 = method5512(var10, arg1, arg2);
                ...
                var22 = method5512(var10, arg1, var24);
                if (var21) {
                    var21 = false;
                    ...
                    float var30 = var26;
                    float var31 = var24;
                    float var32 = method5512(var16.field4758, var16.field4759, var26);
                    float var33;
                    if (Math.abs(var32) < class127.field1495) {
                        var33 = var26;
                    } else {
                        float var34 = method5512(var16.field4758, var16.field4759, var24);
                        if (Math.abs(var34) < class127.field1495) {
                            var33 = var24;
                        } else {
                            float var35 = 0.0F;
                            float var36 = 0.0F;
                            ...
                            do {
                                ...
                                float var42 = class127.field1497 * Math.abs(var31) + 0.0F;
                                ...
                                if (var44) {
                                    ...
                                    var34 = method5512(var16.field4758, var16.field4759, var31);
    ...
    @ObfuscatedName("mz.ay([FIFI)F")
    public static float method5512(float[] arg0, int arg1, float arg2) {
