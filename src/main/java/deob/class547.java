...
public final class class547 {
    ...
    public class547() throws Throwable {
        throw new Error();
    }

    @ObfuscatedName("fs.ap(Ljava/lang/CharSequence;I)I")
    public static int method3415(CharSequence arg0) {
    ...
    @ObfuscatedName("ni.aw([BIIB)Ljava/lang/String;")
    public static String method6237(byte[] arg0, int arg1, int arg2) {
