...
public final class class199 {
    ...
    @ObfuscatedName("ef.e(Ljava/lang/CharSequence;I)I")
    public static int method2778(CharSequence arg0) {
    ...
    @ObfuscatedName("ef.a([BIIB)Ljava/lang/String;")
    public static String method2777(byte[] arg0, int arg1, int arg2) {
