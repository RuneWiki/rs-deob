...
public class class199 {
    ...
    @ObfuscatedName("ca.p(CII)C")
    public static char method1789(char arg0, int arg1) {
    ...
    @ObfuscatedName("gd.a(CI)C")
    public static char method3432(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
