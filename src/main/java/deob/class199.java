...
public final class class199 {
    ...
    @ObfuscatedName("ev.q([BILjava/lang/CharSequence;I)I")
    public static int method2708(byte[] arg0, int arg1, CharSequence arg2) {
    ...
    @ObfuscatedName("cb.s([BIIB)Ljava/lang/String;")
    public static String method2070(byte[] arg0, int arg1, int arg2) {
