...
public class class120 extends class86 {
    ...
    @ObfuscatedName("dq.f")
    public class32 field1578;

    @ObfuscatedName("dq.k")
    public class32 field1573;
    ...
    public class120(class32 arg0, class32 arg1, int arg2, boolean arg3, boolean arg4, boolean arg5) {
        ...
        if (Statics.field542 == null) {
            Statics.method827((class120) null, 255, 255, 0, (byte) 0, true);
            class87.field1200[var8] = this;
        } else {
    ...
    public int method1483() {
        if (this.field1575) {
            ...
            int var1 = class87.method161(255, this.field1574);
            if (var1 >= 100) {
                var1 = 99;
            }
            return var1;
    ...
    public void method1043(int arg0) {
        class87.method555(this.field1574, arg0);
    }
    ...
    public void method1467(int arg0, byte[] arg1, boolean arg2, boolean arg3) {
        if (!arg2) {
            ...
            if (this.field1578 != null) {
                class32 var12 = this.field1578;
                class139 var13 = new class139();
                var13.field1772 = 0;
                var13.field1506 = (long) arg0;
                var13.field1771 = arg1;
                var13.field1770 = var12;
                class104 var14 = class88.field1208;
                synchronized (class88.field1208) {
                    class88.field1208.method1292(var13);
                }
                Object var16 = class88.field1207;
                synchronized (class88.field1207) {
                    if (class88.field1205 == 0) {
                        Statics.field1542.method437(new class88(), 5);
                    }
                    class88.field1205 = 600;
                }
                this.field1572[arg0] = true;
            }
            if (arg3) {
                this.field1178[arg0] = class61.method1131(arg1, false);
            }
            return;
        }
        if (this.field1575) {
        ...
        if (this.field1573 != null) {
            ...
            class32 var6 = this.field1573;
            class139 var7 = new class139();
            var7.field1772 = 0;
            var7.field1506 = (long) var5;
            var7.field1771 = arg1;
            var7.field1770 = var6;
            class104 var8 = class88.field1208;
            synchronized (class88.field1208) {
                class88.field1208.method1292(var7);
            }
            Object var10 = class88.field1207;
            synchronized (class88.field1207) {
                if (class88.field1205 == 0) {
                    Statics.field1542.method437(new class88(), 5);
                }
    ...
    public void method1468(class32 arg0, int arg1, byte[] arg2, boolean arg3) {
        if (this.field1573 != arg0) {
            ...
            if (arg3) {
                this.field1178[arg1] = class61.method1131(arg2, false);
            }
            return;
        }
        if (this.field1575) {
        ...
        class135 var6 = new class135(class86.method52(arg2));
    ...
    public void method1469() {
        ...
        for (int var2 = 0; var2 < this.field1572.length; var2++) {
            if (this.field1171[var2] > 0) {
                class32 var3 = this.field1578;
                class139 var5 = new class139();
                var5.field1772 = 1;
                var5.field1506 = (long) var2;
                var5.field1770 = var3;
                var5.field1773 = this;
                class104 var6 = class88.field1208;
                synchronized (class88.field1208) {
                    class88.field1208.method1292(var5);
                }
                Object var8 = class88.field1207;
                synchronized (class88.field1207) {
                    if (class88.field1205 == 0) {
                        Statics.field1542.method437(new class88(), 5);
                    }
    ...
    public int method1472(int arg0) {
        if (this.field1178[arg0] == null) {
            return this.field1572[arg0] ? 100 : class87.method161(this.field1574, arg0);
        } else {
            return 100;
        }
    }
