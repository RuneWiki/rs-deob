...
public abstract class class86 {
    ...
    @ObfuscatedName("ch.u")
    public static class64 field1177 = new class64();
    ...
    public void method1042(byte[] arg0) {
        ...
        for (int var4 = 0; var4 < var2; var4++) {
            var3 = var3 >>> 8 ^ class135.field1730[(var3 ^ arg0[var4]) & 0xFF];
        }
        int var5 = ~var3;
        this.field1175 = var5;
        class135 var8 = new class135(method52(arg0));
        ...
        if (var10 != 0) {
            ...
            this.field1168 = new class99(this.field1167);
        }
        ...
        this.field1174 = new class99[var12 + 1];
        for (int var33 = 0; var33 < this.field1181; var33++) {
            ...
            this.field1174[var34] = new class99(this.field1173[var34]);
        }
    }
    ...
    public byte[] method1044(int arg0, int arg1) {
        return this.method1079(arg0, arg1, (int[]) null);
    }
    ...
    public byte[] method1079(int arg0, int arg1, int[] arg2) {
        ...
        byte[] var6 = class61.method108(this.field1170[arg0][arg1], false);
        if (this.field1180) {
    ...
    public byte[] method1050(int arg0, int arg1) {
        ...
        if (this.field1170[arg0][arg1] == null) {
            boolean var3 = this.method1058(arg0, (int[]) null);
            if (!var3) {
                this.method1052(arg0);
                boolean var4 = this.method1058(arg0, (int[]) null);
                if (!var4) {
                    return null;
                }
            }
        }
        return class61.method108(this.field1170[arg0][arg1], false);
    }
    ...
    public boolean method1058(int arg0, int[] arg1) {
        ...
        if (arg1 != null && (arg1[0] != 0 || arg1[1] != 0 || arg1[2] != 0 || arg1[3] != 0)) {
            var8 = class61.method108(this.field1178[arg0], true);
            class135 var9 = new class135(var8);
            var9.method1673(arg1, 5, var9.field1732.length);
        } else {
            var8 = class61.method108(this.field1178[arg0], false);
        }
        byte[] var10;
        try {
            var10 = method52(var8);
            ...
            for (int var16 = 0; var16 < var14; var16++) {
                var15 = var15 >>> 8 ^ class135.field1730[(var15 ^ var8[var16]) & 0xFF];
            }
            int var17 = ~var15;
            ...
            for (int var24 = 0; var24 < var22; var24++) {
                var23 = var23 >>> 8 ^ class135.field1730[(var23 ^ var8[var24]) & 0xFF];
            }
            int var25 = ~var23;
            throw class169.method748(var43, var21 + var25 + "," + this.field1169[arg0] + "," + this.field1175);
        }
        if (this.field1166) {
        ...
        if (var3 > 1) {
            ...
            class135 var31 = new class135(var10);
            ...
            for (int var42 = 0; var42 < var3; var42++) {
                if (this.field1180) {
                    ...
                    var5[var4[var42]] = class61.method1131(var36[var42], false);
                }
            }
        } else if (this.field1180) {
            var5[var4[0]] = var10;
        } else {
            var5[var4[0]] = class61.method1131(var10, false);
        }
        return true;
    }
    ...
    public int method1059(String arg0) {
        ...
        return this.field1168.method1241(class82.method1234(var2));
    }

    @ObfuscatedName("ch.t(ILjava/lang/String;B)I")
    public int method1064(int arg0, String arg1) {
        String var3 = arg1.toLowerCase();
        return this.field1174[arg0].method1241(class82.method1234(var3));
    }
    ...
    public byte[] method1061(String arg0, String arg1) {
        ...
        int var5 = this.field1168.method1241(class82.method1234(var3));
        int var6 = this.field1174[var5].method1241(class82.method1234(var4));
    ...
    public void method1056(String arg0) {
        String var2 = arg0.toLowerCase();
        int var3 = this.field1168.method1241(class82.method1234(var2));
        if (var3 >= 0) {
    ...
    public static final byte[] method52(byte[] arg0) {
        ...
        if (var3 < 0 || !(field1176 == 0 || var3 <= field1176)) {
            ...
            if (var2 == 1) {
                class65.method842(var6, var5, arg0, var3, 9);
            } else {
