...
public final class class86 extends class89 {
    ...
    public class86(int arg0, int arg1) {
        ...
        this.field1461 = this.field1465 = arg1;
        this.field1463 = 0;
        this.field1462 = 0;
    }
    ...
    public class86(byte[] arg0, Component arg1) {
        try {
            ...
            this.field1461 = var3.getHeight(arg1);
            this.field1464 = this.field1460;
            this.field1465 = this.field1461;
            this.field1462 = 0;
            this.field1463 = 0;
            this.field1459 = new int[this.field1461 * this.field1460];
            PixelGrabber var5 = new PixelGrabber(var3, 0, 0, this.field1460, this.field1461, this.field1459, 0, this.field1460);
            var5.grabPixels();
        } catch (InterruptedException var7) {
        }
    }

    @ObfuscatedName("cv.p()Lcv;")
    public class86 method1720() {
        class86 var1 = new class86(this.field1460, this.field1461);
        ...
        for (int var2 = 0; var2 < this.field1461; var2++) {
    ...
    public void method1721() {
        method1840(this.field1459, this.field1460, this.field1461);
    }
    ...
    public void method1723() {
        if (this.field1464 == this.field1460 && this.field1465 == this.field1461) {
            return;
        }
    ...
    public void method1724(int arg0) {
        ...
        int var5 = arg0;
        if (this.field1463 + arg0 + this.field1461 > this.field1465) {
            var5 = this.field1465 - this.field1463 - this.field1461;
        }
        int var6 = this.field1460 + var2 + var3;
        int var7 = this.field1461 + var4 + var5;
        int[] var8 = new int[var6 * var7];
        for (int var9 = 0; var9 < this.field1461; var9++) {
    ...
    public void method1726() {
        int[] var1 = new int[this.field1461 * this.field1460];
        int var2 = 0;
        for (int var3 = this.field1461 - 1; var3 >= 0; var3--) {
            for (int var4 = 0; var4 < this.field1460; var4++) {
                var1[var2++] = this.field1459[this.field1460 * var3 + var4];
            }
        }
        this.field1459 = var1;
        this.field1463 = this.field1465 - this.field1461 - this.field1463;
    }

    @ObfuscatedName("cv.i(I)V")
    public void method1727(int arg0) {
        int[] var2 = new int[this.field1461 * this.field1460];
        int var3 = 0;
            ...
            for (int var5 = 0; var5 < this.field1460; var5++) {
                ...
                if (var6 == 0) {
                    if (var5 > 0 && this.field1459[var3 - 1] != 0) {
                        ...
                        var6 = arg0;
                    } else if (var4 < this.field1461 - 1 && this.field1459[this.field1460 + var3] != 0) {
                        var6 = arg0;
                    }
                }
                var2[var3++] = var6;
    ...
    public void method1728(int arg0) {
        for (int var2 = this.field1461 - 1; var2 > 0; var2--) {
    ...
    public void method1729(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1730(Statics.field1482, this.field1459, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cv.u([I[IIIIIII)V")
    ...
    public void method1763(int arg0, int arg1) {
        int var3 = this.field1462 + arg0;
        int var4 = this.field1463 + arg1;
        int var5 = Statics.field1481 * var4 + var3;
        int var6 = 0;
        ...
        if (var8 > 0 && var7 > 0) {
            method1732(Statics.field1482, this.field1459, 0, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("cv.e([I[IIIIIIII)V")
    ...
    public void method1733(int arg0, int arg1, int arg2, int arg3) {
        ...
        method1793(Statics.field1482, this.field1459, 0, var7, var8, var15, var16, arg2, arg3, var11, var12, var5);
    }

    @ObfuscatedName("cv.n([I[IIIIIIIIIII)V")
    public static void method1793(int[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11) {
        int var12 = arg3;
    ...
    public void method1735(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            method1794(Statics.field1482, this.field1459, 0, var8, var7, var10, var9, var11, var12, arg2, arg3);
        }
    }

    @ObfuscatedName("cv.c([I[IIIIIIIIII)V")
    public static void method1794(int[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        int var11 = 256 - arg9;
    ...
    public void method1809(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            method1738(Statics.field1482, this.field1459, 0, var7, var6, var9, var8, var10, var11, arg2);
        }
    }

    @ObfuscatedName("cv.b([I[IIIIIIIII)V")
    public static void method1738(int[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        int var10 = 256 - arg9;
        for (int var11 = -arg6; var11 < 0; var11++) {
    ...
    public void method1739(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        method1776(Statics.field1482, this.field1459, 0, var8, var9, var16, var17, arg2, arg3, var12, var13, var6, arg4);
    }

    @ObfuscatedName("cv.t([I[IIIIIIIIIIII)V")
    public static void method1776(int[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12) {
        int var13 = 256 - arg12;
        int var14 = arg3;
    ...
    @ObfuscatedName("cv.f(IIIIIIII[I[I)V")
        ...
        try {
            ...
            for (int var20 = 0; var20 < arg3; var20++) {
                ...
                for (int var25 = -arg9[var20]; var25 < 0; var25++) {
                    Statics.field1482[var22++] = this.field1459[(var23 >> 16) + (var24 >> 16) * this.field1460];
                    var23 += var16;
                    var24 -= var15;
                }
                var17 += var15;
    ...
    @ObfuscatedName("cv.h(IIIIIIDI)V")
    public void method1740(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, double arg6, int arg7) {
        try {
            int var10 = -arg2 / 2;
            int var11 = -arg3 / 2;
    ...
    public void method1788(int arg0, int arg1, int arg2, int arg3) {
        this.method1744(this.field1464 << 3, this.field1465 << 3, arg0 << 4, arg1 << 4, arg2, arg3);
    }

    @ObfuscatedName("cv.q(IIIIII)V")
    public void method1744(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        if (arg5 == 0) {
            return;
        }
        ...
        int var17 = ((this.field1461 << 4) - var8) * var11 + -var7 * var12;
        int var18 = ((this.field1461 << 4) - var8) * var12 + -(-var7) * var11;
        int var19 = ((this.field1461 << 4) - var8) * var11 + ((this.field1460 << 4) - var7) * var12;
        int var20 = ((this.field1461 << 4) - var8) * var12 + -((this.field1460 << 4) - var7) * var11;
        int var21;
        int var22;
        if (var13 < var15) {
            var21 = var13;
        ...
        if (var43 == 0) {
            if (var42 == 0) {
                ...
                while (var48 < 0) {
                    ...
                    int var51 = var47;
                    int var52 = var37;
                    if (var46 >= 0 && var47 >= 0 && var46 - (this.field1460 << 12) < 0 && var47 - (this.field1461 << 12) < 0) {
                        while (var52 < 0) {
                            int var53 = this.field1459[(var50 >> 12) + (var51 >> 12) * this.field1460];
                            if (var53 == 0) {
                                var49++;
                            } else {
                                Statics.field1482[var49++] = var53;
                            }
                            var52++;
                        }
                    }
                ...
                while (var54 < 0) {
                    ...
                    if (var46 >= 0 && var46 - (this.field1460 << 12) < 0) {
                        int var59;
                        if ((var59 = var57 - (this.field1461 << 12)) >= 0) {
                ...
                while (var63 < 0) {
                    ...
                    if (var46 >= 0 && var46 - (this.field1460 << 12) < 0) {
                        ...
                        int var69;
                        if ((var69 = (var66 + 1 - (this.field1461 << 12) - var42) / var42) > var67) {
                            var67 = var69;
                        }
                        while (var67 < 0) {
            ...
            if (var42 == 0) {
                ...
                while (var71 < 0) {
                    ...
                    int var74 = var47;
                    int var75 = var37;
                    if (var47 >= 0 && var47 - (this.field1461 << 12) < 0) {
                        int var76;
                ...
                while (var80 < 0) {
                    ...
                    int var88;
                    if ((var88 = var83 - (this.field1461 << 12)) >= 0) {
                ...
                while (var92 < 0) {
                    ...
                    int var101;
                    if ((var101 = (var95 + 1 - (this.field1461 << 12) - var42) / var42) > var96) {
                        var96 = var101;
                    }
                    while (var96 < 0) {
                        ...
                        if (var102 == 0) {
                            ...
                            Statics.field1482[var93++] = var102;
                        }
                        var94 += var43;
                        var95 += var42;
                        var96++;
                ...
                if (var47 >= 0 && var47 - (this.field1461 << 12) < 0) {
                    ...
                    while (var107 < 0) {
                        ...
                        if (var110 == 0) {
                            ...
                            Statics.field1482[var104++] = var110;
                        }
                        var105 += var43;
                        var107++;
                    }
            ...
            while (var111 < 0) {
                ...
                int var118;
                if ((var118 = var114 - (this.field1461 << 12)) >= 0) {
                ...
                while (var115 < 0) {
                    ...
                    if (var121 == 0) {
                        ...
                        Statics.field1482[var112++] = var121;
                    }
                    var113 += var43;
                    var114 += var42;
                    var115++;
            ...
            while (var122 < 0) {
                ...
                int var130;
                if ((var130 = (var125 + 1 - (this.field1461 << 12) - var42) / var42) > var126) {
                    var126 = var130;
                }
                while (var126 < 0) {
                    ...
                    if (var131 == 0) {
                        ...
                        Statics.field1482[var123++] = var131;
                    }
                    var124 += var43;
                    var125 += var42;
                    var126++;
    ...
    @ObfuscatedName("cv.z(Lct;II)V")
    public void method1799(class87 arg0, int arg1, int arg2) {
        if (field1486 - field1480 != arg0.field1474 || field1484 - field1483 != arg0.field1475) {
        ...
        if (var9 > 0 && var8 > 0) {
            int var15 = (var5 - field1483) * arg0.field1474 + (var4 - field1480);
            int var16 = arg0.field1474 - var9;
            method1746(Statics.field1482, this.field1459, 0, var7, var6, var15, var9, var8, var10, var11, var16, arg0.field1476);
        }
    }

    @ObfuscatedName("cv.af([I[IIIIIIIIII[B)V")
