...
public class class70 {
    ...
    public class70(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field1303 = new int[var9][14];
    ...
    @ObfuscatedName("bm.b([BB)[B")
    public byte[] method1329(byte[] arg0) {
        if (this.field1303 != null) {
            int var2 = (int) ((long) this.field1302 * (long) arg0.length / (long) this.field1301) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1303[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1302 + var5;
                int var11 = var10 / this.field1301;
                var4 += var11;
                var5 = var10 - this.field1301 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1336(int arg0) {
        if (this.field1303 != null) {
            arg0 = (int) ((long) this.field1302 * (long) arg0 / (long) this.field1301);
        }
        return arg0;
    }
    ...
    public int method1331(int arg0) {
        if (this.field1303 != null) {
            arg0 = (int) ((long) this.field1302 * (long) arg0 / (long) this.field1301) + 6;
        }
        return arg0;
    }
}
