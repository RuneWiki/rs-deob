...
public class class70 {
    ...
    public class70(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class118.method2834(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1314 = var4;
            this.field1317 = var5;
    ...
    @ObfuscatedName("bi.n([BI)[B")
    public byte[] method1417(byte[] arg0) {
        if (this.field1313 != null) {
            int var2 = (int) ((long) this.field1317 * (long) arg0.length / (long) this.field1314) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1313[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1317 + var5;
                int var11 = var10 / this.field1314;
                var4 += var11;
                var5 = var10 - this.field1314 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1419(int arg0) {
        if (this.field1313 != null) {
            arg0 = (int) ((long) this.field1317 * (long) arg0 / (long) this.field1314);
        }
        return arg0;
    }

    @ObfuscatedName("bi.a(II)I")
    public int method1420(int arg0) {
        if (this.field1313 != null) {
            arg0 = (int) ((long) this.field1317 * (long) arg0 / (long) this.field1314) + 6;
        }
        return arg0;
    }
}
