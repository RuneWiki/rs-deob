...
public class class70 {
    ...
    public class70(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            int var10 = arg1 / var3;
            this.field1290 = var9;
            this.field1292 = var10;
            this.field1289 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field1289[var11];
    ...
    @ObfuscatedName("bq.o([BI)[B")
    public byte[] method1387(byte[] arg0) {
        if (this.field1289 != null) {
            int var2 = (int) ((long) this.field1292 * (long) arg0.length / (long) this.field1290) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field1289[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field1292 + var5;
                int var11 = var10 / this.field1290;
                var4 += var11;
                var5 = var10 - this.field1290 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("bq.l(IB)I")
    public int method1388(int arg0) {
        if (this.field1289 != null) {
            arg0 = (int) ((long) this.field1292 * (long) arg0 / (long) this.field1290);
        }
        return arg0;
    }

    @ObfuscatedName("bq.g(II)I")
    public int method1391(int arg0) {
        if (this.field1289 != null) {
            arg0 = (int) ((long) this.field1292 * (long) arg0 / (long) this.field1290) + 6;
        }
        return arg0;
    }
}
