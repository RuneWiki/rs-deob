...
public class class70 {
    ...
    public class70(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class118.method273(arg0, arg1);
            int var4 = arg0 / var3;
            int var5 = arg1 / var3;
            this.field1307 = var4;
            this.field1303 = var5;
    ...
    @ObfuscatedName("be.p([BI)[B")
    public byte[] method1368(byte[] arg0) {
        if (this.field1304 != null) {
            int var2 = (int) ((long) this.field1303 * (long) arg0.length / (long) this.field1307) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var11 = var10 / this.field1307;
                var4 += var11;
                var5 = var10 - this.field1307 * var11;
            }
            arg0 = new byte[var2];
    ...
    public int method1374(int arg0) {
        if (this.field1304 != null) {
            arg0 = (int) ((long) this.field1303 * (long) arg0 / (long) this.field1307);
        }
        return arg0;
    }

    @ObfuscatedName("be.e(II)I")
    public int method1370(int arg0) {
        if (this.field1304 != null) {
            arg0 = (int) ((long) this.field1303 * (long) arg0 / (long) this.field1307) + 6;
        }
        return arg0;
    }
}
