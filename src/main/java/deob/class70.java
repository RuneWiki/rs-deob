...
public class class70 extends class57 {
    ...
    @ObfuscatedName("bl.i(Ljava/awt/Component;)V")
    public void method1066(Component arg0) {
        this.field1279 = new AudioFormat((float) Statics.field1192, 16, Statics.field1175 ? 2 : 1, true, false);
        this.field1281 = new byte[0x100 << (Statics.field1175 ? 2 : 1)];
    }

    @ObfuscatedName("bl.v(I)V")
    public void method1059(int arg0) throws LineUnavailableException {
        try {
            Info var2 = new Info(SourceDataLine.class, this.field1279, arg0 << (Statics.field1175 ? 2 : 1));
            ...
            int var17 = var16 + 1;
            this.method1059(var17);
        }
    }

    @ObfuscatedName("bl.f()I")
    public int method1060() {
        return this.field1280 - (this.field1278.available() >> (Statics.field1175 ? 2 : 1));
    }
    ...
    public void method1070() {
        ...
        this.field1278.write(this.field1281, 0, var1 << 1);
    }
