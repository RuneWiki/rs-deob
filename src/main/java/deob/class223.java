...
public final class class223 extends class220 {
    ...
    @ObfuscatedName("hj.o()V")
    public void method3773() {
        if (this.field3198 == this.field3194 && this.field3199 == this.field3193) {
            return;
        }
        byte[] var1 = new byte[this.field3198 * this.field3193];
        int var2 = 0;
        for (int var3 = 0; var3 < this.field3199; var3++) {
            for (int var4 = 0; var4 < this.field3194; var4++) {
                var1[(this.field3197 + var3) * this.field3198 + this.field3196 + var4] = this.field3195[var2++];
            }
        }
        this.field3195 = var1;
        this.field3194 = this.field3198;
        this.field3199 = this.field3193;
        this.field3196 = 0;
        this.field3197 = 0;
    }

    @ObfuscatedName("hj.m(III)V")
    ...
    public void method3775(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method3776(Statics.field3171, this.field3195, this.field3192, var6, var5, var8, var7, var9, var10);
        }
    }

    @ObfuscatedName("hj.g([I[B[IIIIIII)V")
    public static void method3776(int[] arg0, byte[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        int var9 = -(arg5 >> 2);
        int var10 = -(arg5 & 0x3);
