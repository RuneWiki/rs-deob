...
public final class class10 {
    ...
    @ObfuscatedName("ab.n(Ljava/lang/CharSequence;I)I")
    public static int method754(CharSequence arg0) {
    ...
    @ObfuscatedName("cr.d([BIII)Ljava/lang/String;")
    public static String method1834(byte[] arg0, int arg1, int arg2) {
