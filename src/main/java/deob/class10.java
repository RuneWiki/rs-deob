...
public class class10 {
    ...
    @ObfuscatedName("bo.c(I)J")
    public static long method1175() {
        try {
            URL var0 = new URL(client.method919("services", false) + "m=accountappeal/login.ws");
            ...
            do {
                int var5 = var3.read(var4.field1956, var4.field1955, 1000 - var4.field1955);
                if (var5 == -1) {
                    var4.field1955 = 0;
                    return var4.method2297();
                }
                var4.field1955 += var5;
            } while (var4.field1955 < 1000);
            return 0L;
    ...
    @ObfuscatedName("dl.h(Ljava/lang/String;I)Z")
