...
public class class10 {
    ...
    @ObfuscatedName("aa.j(I)J")
    public static long method653() {
        try {
            URL var0 = new URL(client.method643("services", false) + "m=accountappeal/login.ws");
            ...
            class114 var4 = new class114(new byte[1000]);
            do {
                int var5 = var3.read(var4.field1891, var4.field1894, 1000 - var4.field1894);
                if (var5 == -1) {
                    var4.field1894 = 0;
                    return var4.method2328();
                }
                var4.field1894 += var5;
    ...
    @ObfuscatedName("df.y(Ljava/lang/String;B)Z")
    public static boolean method2612(String arg0) {
        if (arg0 == null) {
            return false;
        }
        try {
