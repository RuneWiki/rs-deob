...
public class class10 {
    ...
    @ObfuscatedName("y.o")
    public static final BigInteger field158 = new BigInteger("80782894952180643741752986186714059433953886149239752893425047584684715842049");
    ...
    @ObfuscatedName("cq.v(I)J")
    public static long method2152() {
        try {
            URL var0 = new URL(client.method1591("services", false) + "m=accountappeal/login.ws");
            ...
            do {
                ...
                if (var5 == -1) {
                    var4.field1984 = 0;
                    return var4.method2452();
                }
                var4.field1984 += var5;
            } while (var4.field1984 < 1000);
            return 0L;
    ...
    @ObfuscatedName("fj.f(JLjava/lang/String;B)I")
    public static final int method2946(long arg0, String arg1) {
        ...
        for (int var7 = 0; var7 < 4; var7++) {
            var4.method2338(var3.nextInt());
        }
        var4.method2338(var6[0]);
        var4.method2338(var6[1]);
        var4.method2340(arg0);
        var4.method2340(0L);
        for (int var8 = 0; var8 < 4; var8++) {
            var4.method2338(var3.nextInt());
        }
        var4.method2428(field158, field157);
        var5.method2398(10);
        for (int var9 = 0; var9 < 3; var9++) {
            var5.method2338(var3.nextInt());
        }
        var5.method2340(var3.nextLong());
        var5.method2339(var3.nextLong());
        class149.method171(var5);
        var5.method2340(var3.nextLong());
        var5.method2428(field158, field157);
        int var10 = class119.method2931(arg1);
        if (var10 % 8 != 0) {
            var10 += 8 - var10 % 8;
        }
        class119 var11 = new class119(var10);
        var11.method2440(arg1);
        var11.field1984 = var10;
        var11.method2365(var6);
        class119 var12 = new class119(var11.field1984 + var5.field1984 + var4.field1984 + 5);
        var12.method2398(2);
        var12.method2398(var4.field1984);
        var12.method2344(var4.field1988, 0, var4.field1984);
        var12.method2398(var5.field1984);
        var12.method2344(var5.field1988, 0, var5.field1984);
        var12.method2336(var11.field1984);
        var12.method2344(var11.field1988, 0, var11.field1984);
        String var13 = class161.method2933(var12.field1988);
        try {
            URL var14 = new URL(client.method1591("services", false) + "m=accountappeal/login.ws");
            ...
            var16.write("data2=" + class226.method3714(var13) + "&dest=" + class226.method3714("passwordchoice.ws"));
            var16.flush();
            ...
            do {
                ...
                if (var19 == -1) {
                    ...
                    if (var20.startsWith("OFFLINE")) {
                        ...
                        if (var22) {
                            class138.method2051(var21, true, false);
                            return 2;
                        } else {
                            return 5;
                        }
