...
public class class161 extends class142 {
    ...
    @ObfuscatedName("fj.g")
    public static class100 field2432 = new class100(64);

    @ObfuscatedName("fj.q")
    public static class100 field2433 = new class100(50);

    @ObfuscatedName("fj.i")
    public static class100 field2434 = new class100(100);
    ...
    public String[] field2451 = new String[] { null, null, class74.field867, null, null };

    @ObfuscatedName("fj.as")
    public String[] field2452 = new String[] { null, null, null, null, class74.field868 };
    ...
    public static class161 method927(int arg0) {
        class161 var1 = (class161) field2432.method1244((long) arg0);
        if (var1 != null) {
            return var1;
        }
        ...
        var3.field2435 = arg0;
        if (var2 != null) {
            var3.method2516(new class135(var2));
        }
        var3.method2517();
        if (var3.field2450 != -1) {
        ...
        if (!Statics.field1462 && var3.field2457) {
            var3.field2461 = class74.field1077;
            var3.field2451 = null;
            var3.field2452 = null;
            var3.field2437 = 0;
        }
    ...
    public void method2516(class135 arg0) {
        while (true) {
    ...
    public void method2519(class135 arg0, int arg1) {
        if (arg1 == 1) {
            ...
            if (this.field2451[arg1 - 30].equalsIgnoreCase(class74.field869)) {
    ...
    public void method2520(class161 arg0, class161 arg1) {
    ...
    public final class179 method2521(int arg0) {
        ...
        class179 var4 = class179.method2992(Statics.field1111, this.field2436, 0);
        if (var4 == null) {
            return null;
        }
    ...
    public final class180 method2532(int arg0) {
        if (this.field2467 != null && arg0 > 1) {
            int var2 = -1;
            for (int var3 = 0; var3 < 10; var3++) {
                if (arg0 >= this.field2466[var3] && this.field2466[var3] != 0) {
        ...
        class180 var4 = (class180) field2433.method1244((long) this.field2435);
        if (var4 != null) {
            return var4;
        }
        class179 var5 = class179.method2992(Statics.field1111, this.field2436, 0);
        if (var5 == null) {
            return null;
        }
        if (this.field2469 != 128 || this.field2445 != 128 || this.field2456 != 128) {
        ...
        class180 var8 = var5.method2942(this.field2472 + 64, this.field2473 + 768, -50, -10, -50);
        var8.field2744 = true;
    ...
    public class161 method2523(int arg0) {
        if (this.field2467 != null && arg0 > 1) {
            int var2 = -1;
            for (int var3 = 0; var3 < 10; var3++) {
                if (arg0 >= this.field2466[var3] && this.field2466[var3] != 0) {
    ...
    public static final class170 method1837(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        long var5 = ((long) arg3 << 40) + ((long) arg2 << 38) + ((long) arg1 << 16) + (long) arg0;
        if (!arg4) {
            class170 var7 = (class170) field2434.method1244(var5);
            if (var7 != null) {
                return var7;
            }
        }
        class161 var8 = method927(arg0);
        ...
        class180 var11 = var8.method2532(1);
        if (var11 == null) {
            return null;
        }
        class170 var12 = null;
        ...
        int[] var16 = new int[4];
        class164.method2587(var16);
        class170 var17 = new class170(36, 32);
        class164.method2583(var17.field2506, 36, 32);
        class164.method2589();
        class172.method2808();
        class172.method2784(16, 16);
        class172.field2522 = false;
        ...
        int var19 = class172.field2533[var8.field2443] * var18 >> 16;
        int var20 = class172.field2530[var8.field2443] * var18 >> 16;
        var11.method3002();
        ...
        class164.method2583(var13, var14, var15);
        class164.method2612(var16);
        class172.method2808();
        class172.field2522 = true;
        return var17;
    }
    ...
    public static final String method926(int arg0) {
        if (arg0 < 100000) {
            ...
            return "<col=ffffff>" + arg0 / 1000 + class74.field1019 + "</col>";
        } else {
            return "<col=00ff80>" + arg0 / 1000000 + class74.field942 + "</col>";
        }
    }
    ...
    public final class179 method2525(boolean arg0) {
        int var2 = this.field2453;
        int var3 = this.field2454;
        int var4 = this.field2462;
        if (arg0) {
        ...
        class179 var5 = class179.method2992(Statics.field1111, var2, 0);
        if (var3 != -1) {
            class179 var6 = class179.method2992(Statics.field1111, var3, 0);
            if (var4 == -1) {
                class179[] var9 = new class179[] { var5, var6 };
                var5 = new class179(var9, 2);
            } else {
                class179 var7 = class179.method2992(Statics.field1111, var4, 0);
    ...
    public final class179 method2527(boolean arg0) {
        int var2 = this.field2431;
        int var3 = this.field2468;
        if (arg0) {
            var2 = this.field2446;
        ...
        class179 var4 = class179.method2992(Statics.field1111, var2, 0);
        if (var3 != -1) {
            class179 var5 = class179.method2992(Statics.field1111, var3, 0);
