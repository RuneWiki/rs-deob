...
public class class161 {
    ...
    @ObfuscatedName("fw.c")
    public static char[] field2621 = new char[64];
    ...
    static {
        ...
        for (int var1 = 26; var1 < 52; var1++) {
            field2621[var1] = (char) (var1 + 97 - 26);
        }
        for (int var2 = 52; var2 < 62; var2++) {
            field2621[var2] = (char) (var2 + 48 - 52);
        }
        field2621[62] = '+';
        field2621[63] = '/';
    ...
    @ObfuscatedName("fh.c([BIII)Ljava/lang/String;")
    public static String method2903(byte[] arg0, int arg1, int arg2) {
        StringBuilder var3 = new StringBuilder();
        for (int var4 = arg1; var4 < arg1 + arg2; var4 += 3) {
            int var5 = arg0[var4] & 0xFF;
            var3.append(field2621[var5 >>> 2]);
            if (var4 < arg2 - 1) {
                int var6 = arg0[var4 + 1] & 0xFF;
                var3.append(field2621[(var5 & 0x3) << 4 | var6 >>> 4]);
                if (var4 < arg2 - 2) {
                    int var7 = arg0[var4 + 2] & 0xFF;
                    var3.append(field2621[(var6 & 0xF) << 2 | var7 >>> 6]).append(field2621[var7 & 0x3F]);
                } else {
                    var3.append(field2621[(var6 & 0xF) << 2]).append("=");
                }
            } else {
                var3.append(field2621[(var5 & 0x3) << 4]).append("==");
            }
        }
