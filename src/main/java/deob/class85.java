...
public class class85 {
    ...
    @ObfuscatedName("ac.t(CII)C")
    public static char method466(char arg0, int arg1) {
    ...
    @ObfuscatedName("cf.n(CB)C")
    public static char method1204(char arg0) {
        if (arg0 == 198) {
            return 'E';
        } else if (arg0 == 230) {
            return 'e';
    ...
    @ObfuscatedName("bx.q(CIB)I")
    public static int method786(char arg0, int arg1) {
        int var2 = arg0 << 4;
