...
public class class73 extends class183 {
    ...
    public static void method1527() {
        field1305 = 0;
        field1301 = 0;
        field1306 = Statics.field1300;
        field1304 = Statics.field1303;
    }
    ...
    @ObfuscatedName("bk.cz()V")
    public static void method1532() {
        int var0 = 0;
        int var1 = Statics.field1303 * Statics.field1300 - 7;
        while (var0 < var1) {
            Statics.field1302[var0++] = 0;
            Statics.field1302[var0++] = 0;
            Statics.field1302[var0++] = 0;
            Statics.field1302[var0++] = 0;
            Statics.field1302[var0++] = 0;
    ...
    public static void method1533(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        for (int var10 = 0; var10 < arg3; var10++) {
            for (int var11 = -arg2; var11 < 0; var11++) {
                int var12 = Statics.field1302[var9];
                int var13 = ((var12 & 0xFF00FF) * var7 >> 8 & 0xFF00FF) + ((var12 & 0xFF00) * var7 >> 8 & 0xFF00);
                Statics.field1302[var9++] = var6 + var13;
            }
            var9 += var8;
        }
    }

    @ObfuscatedName("bk.cf(IIIII)V")
    public static void method1534(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        for (int var7 = -arg3; var7 < 0; var7++) {
            for (int var8 = -arg2; var8 < 0; var8++) {
                Statics.field1302[var6++] = arg4;
            }
            var6 += var5;
        }
    }

    @ObfuscatedName("bk.ca(IIIIII)V")
    ...
    @ObfuscatedName("bk.ct(IIIII)V")
    public static void method1536(int arg0, int arg1, int arg2, int arg3, int arg4) {
        method1538(arg0, arg1, arg2, arg4);
        method1538(arg0, arg1 + arg3 - 1, arg2, arg4);
        method1537(arg0, arg1, arg3, arg4);
        method1537(arg0 + arg2 - 1, arg1, arg3, arg4);
    }

    @ObfuscatedName("bk.du(IIIIII)V")
    public static void method1561(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        method1539(arg0, arg1, arg2, arg4, arg5);
        method1539(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
        if (arg3 >= 3) {
    ...
    public static void method1538(int arg0, int arg1, int arg2, int arg3) {
        ...
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1302[var4 + var5] = arg3;
        }
    }
    ...
    public static void method1539(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        for (int var10 = 0; var10 < arg2; var10++) {
            int var11 = (Statics.field1302[var9] >> 16 & 0xFF) * var5;
            int var12 = (Statics.field1302[var9] >> 8 & 0xFF) * var5;
            int var13 = (Statics.field1302[var9] & 0xFF) * var5;
            int var14 = (var8 + var13 >> 8) + (var6 + var11 >> 8 << 16) + (var7 + var12 >> 8 << 8);
            Statics.field1302[var9++] = var14;
        }
    }

    @ObfuscatedName("bk.di(IIII)V")
    public static void method1537(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 < field1305 || arg0 >= field1306) {
            return;
        }
        if (arg1 < field1301) {
            arg2 -= field1301 - arg1;
        ...
        int var4 = Statics.field1300 * arg1 + arg0;
        for (int var5 = 0; var5 < arg2; var5++) {
            Statics.field1302[Statics.field1300 * var5 + var4] = arg3;
        }
    }

    @ObfuscatedName("bk.dc(IIIII)V")
    ...
    @ObfuscatedName("bk.dm(IIIII)V")
    public static void method1542(int arg0, int arg1, int arg2, int arg3, int arg4) {
        int var5 = arg2 - arg0;
        int var6 = arg3 - arg1;
        if (var6 == 0) {
            if (var5 >= 0) {
                method1538(arg0, arg1, var5 + 1, arg4);
            } else {
                method1538(arg0 + var5, arg1, -var5 + 1, arg4);
            }
        } else if (var5 != 0) {
            if (var5 + var6 < 0) {
                arg0 += var5;
            ...
            if (var5 > var6) {
                ...
                while (arg0 <= var11) {
                    int var12 = var8 >> 16;
                    if (var12 >= field1301 && var12 < field1304) {
                        Statics.field1302[Statics.field1300 * var12 + arg0] = arg4;
                    }
                    var8 += var10;
                    arg0++;
                }
                ...
                while (arg1 <= var17) {
                    int var18 = var14 >> 16;
                    if (var18 >= field1305 && var18 < field1306) {
                        Statics.field1302[Statics.field1300 * arg1 + var18] = arg4;
                    }
                    var14 += var16;
                    arg1++;
                }
            ...
            method1537(arg0, arg1, var6 + 1, arg4);
        } else {
            method1537(arg0, arg1 + var6, -var6 + 1, arg4);
        }
    }

    @ObfuscatedName("bk.dv(III[I[I)V")
