...
public class class102 extends RuntimeException {
    ...
    @ObfuscatedName("fd.u(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method3043(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1640.getCodeBase(), "clienterror.ws?c=" + Statics.field1531 + "&u=" + Statics.field2107 + "&v1=" + Statics.field1662 + "&v2=" + Statics.field1656 + "&e=" + var25);
    ...
    @ObfuscatedName("ds.x(Ljava/lang/Throwable;Ljava/lang/String;)Lcx;")
    public static class102 method1920(Throwable arg0, String arg1) {
        class102 var2;
        if (arg0 instanceof class102) {
            var2 = (class102) arg0;
            var2.field1641 = var2.field1641 + ' ' + arg1;
        } else {
