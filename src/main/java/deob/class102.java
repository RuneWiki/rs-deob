...
public class class102 extends RuntimeException {
    ...
    @ObfuscatedName("aw.s(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method690(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1653.getCodeBase(), "clienterror.ws?c=" + Statics.field1654 + "&u=" + Statics.field1658 + "&v1=" + Statics.field1671 + "&v2=" + Statics.field1670 + "&e=" + var25);
    ...
    @ObfuscatedName("g.c(Ljava/lang/Throwable;Ljava/lang/String;)Lck;")
    public static class102 method62(Throwable arg0, String arg1) {
        class102 var2;
        if (arg0 instanceof class102) {
            var2 = (class102) arg0;
            var2.field1656 = var2.field1656 + ' ' + arg1;
        } else {
