...
public class class102 extends RuntimeException {
    ...
    @ObfuscatedName("cv.x(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method1916(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1658.getCodeBase(), "clienterror.ws?c=" + Statics.field2139 + "&u=" + Statics.field1659 + "&v1=" + Statics.field1678 + "&v2=" + Statics.field1689 + "&e=" + var25);
    ...
    @ObfuscatedName("an.n(Ljava/lang/Throwable;Ljava/lang/String;)Lcr;")
    public static class102 method805(Throwable arg0, String arg1) {
        class102 var2;
        if (arg0 instanceof class102) {
            var2 = (class102) arg0;
            var2.field1657 = var2.field1657 + ' ' + arg1;
        } else {
