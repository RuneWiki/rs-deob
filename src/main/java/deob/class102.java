...
public class class102 extends RuntimeException {
    ...
    @ObfuscatedName("cr.o(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method1762(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1654.getCodeBase(), "clienterror.ws?c=" + Statics.field1647 + "&u=" + Statics.field1650 + "&v1=" + Statics.field1679 + "&v2=" + Statics.field1667 + "&e=" + var25);
    ...
    @ObfuscatedName("bf.m(Ljava/lang/Throwable;Ljava/lang/String;)Lcj;")
    public static class102 method1007(Throwable arg0, String arg1) {
        class102 var2;
        if (arg0 instanceof class102) {
            var2 = (class102) arg0;
            var2.field1648 = var2.field1648 + ' ' + arg1;
        } else {
