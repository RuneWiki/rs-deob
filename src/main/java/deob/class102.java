...
public class class102 extends RuntimeException {
    ...
    @ObfuscatedName("ah.x(Ljava/lang/String;Ljava/lang/Throwable;B)V")
    public static void method702(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1667.getCodeBase(), "clienterror.ws?c=" + Statics.field1664 + "&u=" + Statics.field1663 + "&v1=" + Statics.field1679 + "&v2=" + Statics.field1688 + "&e=" + var25);
    ...
    @ObfuscatedName("x.j(Ljava/lang/Throwable;Ljava/lang/String;)Lct;")
    public static class102 method9(Throwable arg0, String arg1) {
        class102 var2;
        if (arg0 instanceof class102) {
            var2 = (class102) arg0;
            var2.field1668 = var2.field1668 + ' ' + arg1;
        } else {
