...
public class class102 extends RuntimeException {
    ...
    @ObfuscatedName("ai.k(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method706(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1658.getCodeBase(), "clienterror.ws?c=" + Statics.field1660 + "&u=" + Statics.field1659 + "&v1=" + Statics.field1688 + "&v2=" + Statics.field905 + "&e=" + var25);
    ...
    @ObfuscatedName("q.y(Ljava/lang/Throwable;Ljava/lang/String;)Lcd;")
    public static class102 method88(Throwable arg0, String arg1) {
        class102 var2;
        if (arg0 instanceof class102) {
            var2 = (class102) arg0;
            var2.field1661 = var2.field1661 + ' ' + arg1;
        } else {
