...
public class class222 {
    ...
    static {
        new class220();
        field3178 = new class218();
        field3176 = new class214();
        field3179 = new class217();
    }

    public class222(class120 arg0, boolean arg1) {
        int var3 = arg0.method2387();
        boolean var4 = arg0.method2385() == 1;
        byte var5;
        if (var4) {
            var5 = 1;
        } else {
    ...
    @ObfuscatedName("hw.f(Ljava/util/Comparator;ZI)V")
