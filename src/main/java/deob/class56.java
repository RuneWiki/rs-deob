...
public class class56 {
    ...
    public class56(int arg0, int arg1) {
        if (arg0 != arg1) {
            ...
            this.field418 = var9;
            this.field416 = var10;
            this.field422 = new int[var9][14];
            for (int var11 = 0; var11 < var9; var11++) {
                int[] var12 = this.field422[var11];
    ...
    @ObfuscatedName("cc.af([BI)[B")
    public byte[] method1054(byte[] arg0) {
        if (this.field422 != null) {
            int var2 = (int) ((long) this.field416 * (long) arg0.length / (long) this.field418) + 14;
            int[] var3 = new int[var2];
            int var4 = 0;
            int var5 = 0;
            for (int var6 = 0; var6 < arg0.length; var6++) {
                byte var7 = arg0[var6];
                int[] var8 = this.field422[var5];
                for (int var9 = 0; var9 < 14; var9++) {
                    var3[var4 + var9] += var8[var9] * var7;
                }
                int var10 = this.field416 + var5;
                int var11 = var10 / this.field418;
                var4 += var11;
                var5 = var10 - this.field418 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("cc.an(IB)I")
    public int method1055(int arg0) {
        if (this.field422 != null) {
            arg0 = (int) ((long) this.field416 * (long) arg0 / (long) this.field418);
        }
        return arg0;
    }

    @ObfuscatedName("cc.aw(II)I")
    public int method1063(int arg0) {
        if (this.field422 != null) {
            arg0 = (int) ((long) this.field416 * (long) arg0 / (long) this.field418) + 6;
        }
        return arg0;
    }
}
