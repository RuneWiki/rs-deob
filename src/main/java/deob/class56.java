...
public class class56 {
    ...
    @ObfuscatedName("br.f([BB)[B")
    public byte[] method1045(byte[] arg0) {
        if (this.field422 != null) {
            int var2 = (int) ((long) this.field428 * (long) arg0.length / (long) this.field421) + 14;
            ...
            for (int var6 = 0; var6 < arg0.length; var6++) {
                ...
                int var10 = this.field428 + var5;
                int var11 = var10 / this.field421;
                var4 += var11;
                var5 = var10 - this.field421 * var11;
            }
            arg0 = new byte[var2];
    ...
    @ObfuscatedName("br.w(IB)I")
    public int method1046(int arg0) {
        if (this.field422 != null) {
            arg0 = (int) ((long) this.field428 * (long) arg0 / (long) this.field421);
        }
        return arg0;
    }
    ...
    public int method1047(int arg0) {
        if (this.field422 != null) {
            arg0 = (int) ((long) this.field428 * (long) arg0 / (long) this.field421) + 6;
        }
        return arg0;
    }
}
