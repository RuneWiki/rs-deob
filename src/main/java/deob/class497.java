...
public abstract class class497 {
    ...
    public double field4952 = 0.0D;

    @ObfuscatedName("tf.au")
    public int field4951 = 0;

    public class497(int arg0, int arg1) {
        this.field4953 = arg0;
        this.field4950 = 0;
        this.field4951 = arg1 >= 0 && arg1 <= 27 ? arg1 : 0;
        this.field4952 = method3885(this.field4950, this.field4953, this.field4951);
    }

    @ObfuscatedName("tf.ax(B)V")
    public void method8040() {
        if (this.field4950 < this.field4953) {
            this.field4950++;
            this.field4952 = method3885(this.field4950, this.field4953, this.field4951);
        }
    }

    @ObfuscatedName("tf.aw(I)D")
    public double method8037() {
        return this.field4952;
    }

    @ObfuscatedName("iy.az(IIII)D")
    public static double method3885(int arg0, int arg1, int arg2) {
