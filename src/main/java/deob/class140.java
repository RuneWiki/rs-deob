...
public class class140 extends class179 {
    ...
    @ObfuscatedName("en.g")
    public class175 field2363;

    @ObfuscatedName("en.h")
    public byte[] field2364;

    @ObfuscatedName("en.g(Leu;II)Len;")
    public static class140 method2799(class153 arg0, int arg1, int arg2) {
        byte[] var3 = arg0.method3080(arg1, arg2);
        return var3 == null ? null : new class140(new class127(var3));
    }

    public class140(class127 arg0) {
        arg0.field2027 = arg0.field2030.length - 3;
        ...
        for (int var37 = 0; var37 < var6; var37++) {
            var36 = var36 + arg0.method2499() & 0x7F;
            if (var36 == 0 || var36 == 32) {
                var12++;
            } else if (var36 == 1) {
                var24++;
        ...
        this.field2364 = new byte[var22];
        class127 var60 = new class127(this.field2364);
        var60.method2605(1297377380);
        var60.method2605(6);
        var60.method2484(var2 > 1 ? 1 : 0);
        var60.method2484(var2);
        var60.method2484(var3);
            ...
            while (true) {
                while (true) {
                    ...
                    if (var74 == 7) {
                        ...
                        var60.method2485(47);
                        var60.method2485(0);
                        var60.method2489(var60.field2027 - var71);
                        continue label223;
                    }
                    if (var74 == 23) {
                        if (var75) {
                        ...
                        var60.method2485(81);
                        var60.method2485(3);
                        var60.method2485(arg0.field2030[var59++]);
                        var60.method2485(arg0.field2030[var59++]);
                        var60.method2485(arg0.field2030[var59++]);
                    } else {
                        var61 ^= var74 >> 4;
                        if (var72 == 0) {
                            ...
                            var60.method2485(arg0.field2030[var53++]);
                        } else {
                            throw new RuntimeException();
                        }
                    }
    ...
    public void method2800() {
        ...
        this.field2363 = new class175(16);
        int[] var1 = new int[16];
        int[] var2 = new int[16];
        var2[9] = 128;
        var1[9] = 128;
        class145 var4 = new class145(this.field2364);
        int var5 = var4.method2929();
        for (int var6 = 0; var6 < var5; var6++) {
            var4.method2930(var6);
            var4.method2933(var6);
            var4.method2931(var6);
        }
        label52: do {
            while (true) {
                int var7 = var4.method2979();
                int var8 = var4.field2427[var7];
                while (var4.field2427[var7] == var8) {
                    var4.method2930(var7);
                    int var9 = var4.method2940(var7);
                    if (var9 == 1) {
                        var4.method2932();
                        var4.method2931(var7);
                        continue label52;
                    }
                    int var10 = var9 & 0xF0;
                    if (var10 == 176) {
                    ...
                    if (var10 == 144) {
                        ...
                        if (var18 > 0) {
                            ...
                            class176 var20 = (class176) this.field2363.method3354((long) var19);
                            if (var20 == null) {
                                var20 = new class176(new byte[128]);
                                this.field2363.method3364(var20, (long) var19);
                            }
                            var20.field2817[var17] = 1;
                        }
                    }
                    var4.method2933(var7);
                    var4.method2931(var7);
                }
            }
        } while (!var4.method2926());
    }
