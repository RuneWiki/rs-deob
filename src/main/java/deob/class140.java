...
public class class140 extends RuntimeException {
    ...
    @ObfuscatedName("ei.n(Ljava/lang/String;Ljava/lang/Throwable;I)V")
    public static void method2829(String arg0, Throwable arg1) {
        try {
            String var2 = "";
            if (arg1 != null) {
                Throwable var3 = arg1;
            ...
            URL var26 = new URL(Statics.field1808.getCodeBase(), "clienterror.ws?c=" + Statics.field2136 + "&u=" + Statics.field1951 + "&v1=" + Statics.field2001 + "&v2=" + Statics.field1999 + "&e=" + var25);
    ...
    @ObfuscatedName("fu.g(Ljava/lang/Throwable;Ljava/lang/String;)Les;")
    public static class140 method3088(Throwable arg0, String arg1) {
        class140 var2;
        if (arg0 instanceof class140) {
            var2 = (class140) arg0;
            var2.field2132 = var2.field2132 + ' ' + arg1;
        } else {
