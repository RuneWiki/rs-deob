...
public class class230 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([[BI[[BI[B[II[I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lhl;IIIBIILhl;II)V", line = 121)
