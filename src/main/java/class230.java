...
public class class230 extends class119 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lr;J)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lbt;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lbt;IIIIIIIIIIIZZ)V")
