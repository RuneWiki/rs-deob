...
public class class230 extends class181 {
    ...
    @OriginalMember(owner = "client!aca", name = "c", descriptor = "(B)Lwfa;", line = 8)
    public final class408 method1475(byte arg0) {
        ++field3097;
        return arg0 <= 62 ? null : class397.field5237[super.field2473];
    }

    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(BI)Lfba;", line = 35)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(JBI)Ljava/lang/String;", line = 62)
