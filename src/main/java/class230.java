...
public class class230 extends class409 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZLwo;)Z")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IILqa;I)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/lang/String;Lci;IZ)Lop;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)Lbr;")
