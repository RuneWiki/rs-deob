...
public class class230 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B)Lwf;", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)Lwf;", line = 25)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "()V", line = 187)
    public class230() {
        this.field2931.field1099 = this.field2931;
        this.field2931.field1094 = this.field2931;
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(I)Lwf;", line = 146)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZLwf;)V", line = 167)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZI)I", line = 197)
