...
public class class230 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZLig;J)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IJ)Lig;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Z)Lig;")
