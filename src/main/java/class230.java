...
public class class230 implements class415 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)I", line = 3)
    public static int method1424(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)Z", line = 11)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lpq;Lhp;)V", line = 32)
    public class230(class159 arg0, class448 arg1) {
        this.field3017 = arg1;
        this.field3015 = arg0;
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZB)V", line = 41)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 60)
