...
public class class230 {
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ILjp;I)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Ljp;I)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(BLjp;)V")
