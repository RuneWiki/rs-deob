...
public class class230 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ljava/lang/String;IZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(III)Lnp;", line = 104)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)I", line = 133)
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ltd;[[BB)V", line = 159)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "()V", line = 232)
    public class230() {
    }

    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Ldh;)V", line = 237)
