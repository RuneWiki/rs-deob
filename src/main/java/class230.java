...
public class class230 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(JBIIZ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)V", line = 122)
