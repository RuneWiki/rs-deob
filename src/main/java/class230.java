...
public class class230 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(IIIIB)V", line = 68)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Ljq;I)V", line = 79)
