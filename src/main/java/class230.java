...
public class class230 extends class270 {
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BI)[I", line = 19)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)Leq;", line = 76)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "()V", line = 99)
    public class230() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nn", name = "f", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lja;IIZZIIII[Lc;I[B)[I", line = 117)
    ...
    @OriginalMember(owner = "client!nn", name = "e", descriptor = "(B)V", line = 589)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BLec;I)V", line = 612)
    ...
    @OriginalMember(owner = "client!nn", name = "g", descriptor = "(I)V", line = 667)
