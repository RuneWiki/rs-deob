...
public class class230 extends class298 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)Lgfa;", line = 14)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lkfa;I)V", line = 42)
    public class230(class382 arg0, int arg1) {
        this.field3407 = arg0;
        this.field3405 = new class656(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lgfa;FLgfa;Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(I)I", line = 245)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Z[[[BIB)V", line = 263)
