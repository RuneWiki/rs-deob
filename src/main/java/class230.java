...
public class class230 extends class393 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(III)Lgf;")
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)Lm;")
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(ILlp;Llp;Loh;Lpt;I[BIZ)V")
