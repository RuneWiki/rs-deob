...
public class class230 extends class81 implements class161 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Laa;I)Lcn;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIILaa;)Z")
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILaa;I)Lhc;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Laa;Z)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Laa;IB)Lhc;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ZILaa;Z)Lvn;")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Laa;Lsk;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Laa;B)V")
