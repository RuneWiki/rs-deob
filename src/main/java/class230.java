...
public class class230 extends class634 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!jd", name = "f", descriptor = "(I)Ljava/lang/String;", line = 76)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(BI)[I", line = 91)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "()V", line = 118)
    public class230() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jd", name = "g", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILig;Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!jd", name = "h", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IB[I)V", line = 296)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)V", line = 467)
