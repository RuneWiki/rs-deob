...
public class class230 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILnj;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Llm;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)Lup;", line = 125)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILnj;Z)V", line = 151)
