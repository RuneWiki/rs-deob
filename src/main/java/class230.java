...
public abstract class class230 {
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lvh;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BILae;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!po", name = "e", descriptor = "(I)V", line = 70)
