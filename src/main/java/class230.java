...
public class class230 {
    ...
    @OriginalMember(owner = "client!hm", name = "toString", descriptor = "()Ljava/lang/String;", line = 103)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(II)V", line = 171)
