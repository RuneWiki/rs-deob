...
public class class230 extends class28 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ZI[II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "([IIBII)Z", line = 30)
    ...
    @OriginalMember(owner = "client!dga", name = "c", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 233)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "([IBII)Z", line = 75)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(III)Z", line = 121)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(BII)Z", line = 151)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!dga", name = "d", descriptor = "(B)V", line = 211)
