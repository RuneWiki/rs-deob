...
public class class230 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!nn", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 10)
    public final void focusGained(FocusEvent arg0) {
        field3165++;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIII)Z", line = 19)
    ...
    @OriginalMember(owner = "client!nn", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 44)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BIIIII)Z", line = 113)
    ...
    @OriginalMember(owner = "client!nn", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 146)
    ...
    @OriginalMember(owner = "client!nn", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 177)
    ...
    @OriginalMember(owner = "client!nn", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 189)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILvm;II)V", line = 235)
