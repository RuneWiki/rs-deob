...
public class class230 extends class45 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILiv;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILkj;Z)V")
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lfd;)V")
