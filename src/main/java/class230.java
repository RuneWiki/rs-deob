...
public class class230 extends class656 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(II[I)V", line = 24)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(B[S)[S", line = 146)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BI)V", line = 165)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ZI)V", line = 182)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IIIFI)V", line = 216)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(II)V", line = 341)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(Lmu;IIIII)V", line = 349)
