...
public class class230 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZLmo;ILmo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;", line = 41)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIZ)I", line = 65)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZIBLe;[Lfn;Llf;)V", line = 106)
