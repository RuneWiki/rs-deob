...
public class class230 extends Canvas {
    ...
    @OriginalMember(owner = "client!mv", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void paint(Graphics arg0) {
        this.field4003.paint(arg0);
        field4001++;
    }

    @OriginalMember(owner = "client!mv", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 14)
    public final void update(Graphics arg0) {
        this.field4003.update(arg0);
        field4000++;
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 60)
