...
public abstract class class230 extends class461 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B[Lsca;II)I")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lgga;I)Lgha;")
    ...
    @OriginalMember(owner = "client!oq", name = "f", descriptor = "(I)Lfs;")
