...
public class class230 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IBI)Z", line = 54)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)V", line = 133)
