...
public class class230 extends class335 implements class115 {
    ...
    @OriginalMember(owner = "client!jl", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 4)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Llba;I)V", line = 15)
    public final void method154(class477 arg0, int arg1) {
        super.method154(arg0, arg1);
    }

    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lrca;Lkp;III[B)V", line = 23)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(I)V", line = 95)
