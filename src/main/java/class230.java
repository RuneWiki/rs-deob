...
public class class230 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZIB)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIBI)V", line = 52)
