...
public class class230 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BI)Lga;", line = 50)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)I", line = 95)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(BI)V", line = 131)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lgp;ILui;)V", line = 173)
