...
public class class230 implements Runnable {
    ...
    @OriginalMember(owner = "client!kf", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)I", line = 66)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(II)Z", line = 76)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Z)V", line = 150)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 237)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([BIBI)I", line = 181)
