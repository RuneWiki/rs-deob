...
public class class230 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;II)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;Lbt;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)Lvi;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;IIII)Ltu;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)Lce;")
    public static final class325 method1453(int arg0) {
        return (class325) field2947.method2085((long) arg0, -5423);
    }

    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(II)Lce;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ldn;Ler;Lvn;Lbo;Ldt;Lji;Lmi;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Lqa;IIII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lm;II)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;)Ltu;")
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lqa;Lcc;IIII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lm;III)I")
