...
public class class230 extends class471 {
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(Lwm;B)Lnf;", line = 3)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLwm;Lgn;)V", line = 126)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIILwm;ZLhp;Z)V", line = 156)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIBLwm;)Z", line = 171)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IBLwm;)Lgn;", line = 351)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lwm;B)V", line = 366)
