...
public class class230 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Ltq;Ltq;I)V", line = 59)
