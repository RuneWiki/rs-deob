...
public class class230 extends class363 implements class28 {
    ...
    @OriginalMember(owner = "client!ca", name = "oa", descriptor = "(III)V", line = 8)
    public final void method1214(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFLta;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ca", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILta;II)V", line = 27)
