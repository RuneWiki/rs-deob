...
public class class230 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILdc;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIILha;I)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILdc;B)V")
