...
public class class230 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BI)Lgf;", line = 7)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Ler;ILjn;)V", line = 122)
