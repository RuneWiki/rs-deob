...
public class class230 extends class393 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lqj;II)Loe;", line = 5)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lil;)V", line = 123)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "()V", line = 604)
