...
public class class230 {
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IBLofa;)I")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Lcm;I)V")
