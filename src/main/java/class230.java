...
public class class230 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lhn;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(III)V", line = 227)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)[[[I", line = 75)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)[[I", line = 138)
