...
public class class230 extends class297 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lcea;II)V")
    ...
    @OriginalMember(owner = "client!aia", name = "e", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;")
