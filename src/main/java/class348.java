...
public class class348 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbt;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbt;B)V", line = 259)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIBI)V", line = 284)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 326)
