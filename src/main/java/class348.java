...
public class class348 extends class229 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(CIIIZLus;II)V", line = 59)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "([B[IIIIIIIIIIILus;II)V", line = 122)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "([B[IIIIIIII)V", line = 218)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lwb;Lis;[Lff;[I[I)V", line = 252)
