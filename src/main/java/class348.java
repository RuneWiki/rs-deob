...
public class class348 extends class51 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIILgq;Lgq;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "f", descriptor = "(I)Lkh;")
    public final class13 method2152(int arg0) {
        ++field4790;
        return arg0 != 1343648748 ? null : class94.field1399[super.field672];
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLbt;)V")
