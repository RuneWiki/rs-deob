...
public class class348 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IBLfm;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IBLiaa;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lap;Lmw;Lmh;IIIII)V")
