...
public class class348 extends class373 implements class350 {
    ...
    @OriginalMember(owner = "client!xa", name = "b", descriptor = "()[Lsu;")
    ...
    @OriginalMember(owner = "client!xa", name = "c", descriptor = "()[Lop;")
    public final class127[] method2015() {
        return this.field4636;
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lut;II)V")
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;Lg;Lpq;IIII)V")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lut;I)V")
