...
public class class348 extends class80 {
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "()V", line = 64)
    public class348() {
        super(0, false);
    }

    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(II)[[I", line = 93)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILnn;)V", line = 168)
