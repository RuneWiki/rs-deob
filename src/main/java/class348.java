...
public class class348 {
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lfd;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILfd;)V", line = 211)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ICB)C", line = 243)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIII)V", line = 330)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIBIILba;)Lba;", line = 362)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IBZI)I", line = 502)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BIIIILba;II)Lba;", line = 658)
