...
public class class348 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;I[Ljava/lang/Object;)Ljava/lang/Object;", line = 25)
