...
public class class348 implements Runnable {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIILes;Les;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Ljava/net/Socket;Lko;)V")
