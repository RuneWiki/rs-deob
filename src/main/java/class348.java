...
public abstract class class348 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Ldr;IILhi;[ZB[IIZIZLhi;)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILom;I)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(III[IIILom;ZLom;II)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Llf;IIIIII)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILom;IZLom;BIII)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ZIIIILom;Lom;Lom;Lom;[ZIIIII)V")
