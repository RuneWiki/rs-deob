...
public class class348 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)Lfr;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ldn;I)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ljj;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Z)Lpg;")
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lfr;I)V")
