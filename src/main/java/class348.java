...
public class class348 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Ljava/lang/Object;IBJ)V", line = 8)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BLci;)V", line = 113)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(II)V", line = 133)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(I)V", line = 154)
    public class348(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 158)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 190)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)I", line = 223)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BJLjava/lang/Object;)V", line = 235)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZJ)V", line = 248)
    ...
    @OriginalMember(owner = "client!fba", name = "d", descriptor = "(B)I", line = 261)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 273)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILvo;I)V", line = 317)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(I)I", line = 361)
    ...
    @OriginalMember(owner = "client!fba", name = "d", descriptor = "(I)V", line = 390)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(II)V", line = 430)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Z)V", line = 418)
