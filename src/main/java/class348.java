...
public class class348 extends class695 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IIIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lbi;II[BI)V", line = 85)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IZ)V", line = 100)
    ...
    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(B)V", line = 117)
