...
public class class348 extends class349 {
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "()V", line = 39)
    public class348() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IB)[[I", line = 46)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IILdga;)V", line = 141)
