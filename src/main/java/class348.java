...
public abstract class class348 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILoj;I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!bm", name = "e", descriptor = "(I)V", line = 441)
