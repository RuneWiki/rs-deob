...
public class class348 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lcea;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IIIIIIIBI)V", line = 21)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lcea;Z)V", line = 88)
