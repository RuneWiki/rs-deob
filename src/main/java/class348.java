...
public class class348 extends class758 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIB[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kw", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!kw", name = "finalize", descriptor = "()V", line = 29)
    protected final void finalize() {
        field4946++;
        this.method2226((byte) 95);
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(BI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ZLvi;Lvi;II)I", line = 63)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "([BIIB)I", line = 200)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIB[BLjava/lang/String;I)I", line = 211)
