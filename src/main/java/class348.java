...
public class class348 extends class273 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(CIIIZLud;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lnf;Lcl;[Lup;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(CIIIZ)V", line = 259)
