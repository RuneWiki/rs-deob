...
public class class348 extends class136 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "()V", line = 5)
    public static final void method2101() {
        class171.method1214(1, class308.field4395);
    }

    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 8)
    public class348() {
        super(0, true);
    }

    @OriginalMember(owner = "client!od", name = "f", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)[I", line = 31)
