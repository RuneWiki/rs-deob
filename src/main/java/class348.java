...
public abstract class class348 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILfs;III[Lqg;IIIIILjava/lang/String;[IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILts;II)V", line = 111)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 136)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(III)V", line = 176)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZLjava/lang/String;III)V", line = 196)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILjava/lang/String;IIIIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILjava/lang/String;IIII)V", line = 244)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLjava/lang/String;)V", line = 278)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 356)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ljava/util/Random;[II[Lqg;IILjava/lang/String;III)I", line = 382)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(IILjava/lang/String;IIII)V", line = 416)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lfs;IIIIIIILjava/lang/String;II[Lqg;IIB[I)I", line = 446)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Leq;Lmo;)V", line = 456)
    public class348(class134 arg0, class507 arg1) {
        this.field5028 = arg0;
        this.field5029 = arg1;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ljava/lang/String;ILjava/util/Random;I[IIII[IIIIII[Lqg;)I", line = 472)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILjava/lang/String;I[II[I[I[Lqg;)V", line = 550)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIII)V", line = 709)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 825)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([Lqg;Ljava/lang/String;III[ILfs;II)V", line = 840)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIILjava/lang/String;B)V", line = 998)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIILjava/lang/String;II[Lqg;[I)V", line = 1015)
