...
public class class348 {
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 11)
    public class348() {
        this.field4794[0] = 0;
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lkk;)V", line = 46)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Lkk;)V", line = 54)
