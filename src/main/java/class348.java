...
public class class348 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "()[F", line = 144)
    public final float[] method1989() {
        return this.field4412[this.method1990()];
    }

    @OriginalMember(owner = "client!fba", name = "c", descriptor = "()I", line = 151)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II)I", line = 159)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "()V", line = 165)
    public class348() {
