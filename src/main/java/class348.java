...
public class class348 extends class145 {
    ...
    @OriginalMember(owner = "client!lm", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "()V", line = 27)
    public class348() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!lm", name = "f", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)[I", line = 122)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "()V", line = 223)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 237)
    ...
    @OriginalMember(owner = "client!lm", name = "g", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!lm", name = "h", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lap;BI)V", line = 409)
