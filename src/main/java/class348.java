...
public class class348 extends class270 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lia;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)[Lui;", line = 108)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Lia;B)V", line = 119)
    ...
    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILia;I)V", line = 155)
