...
public class class348 extends class184 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IIZLeq;IZ)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Liia;ZI)V")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Loea;)V")
