...
public class class348 extends class127 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!cc", name = "JA", descriptor = "(IIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!cc", name = "la", descriptor = "()I", line = 400)
    public final int method470() {
        field5371++;
        return this.field5361.field4273;
    }

    @OriginalMember(owner = "client!cc", name = "BA", descriptor = "(III)V", line = 408)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lvd;IIII)V", line = 956)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lvd;II[III)V", line = 966)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(FFFFFFLma;II)V", line = 437)
    ...
    @OriginalMember(owner = "client!cc", name = "ma", descriptor = "()I", line = 526)
    public final int method465() {
        field5350++;
        return this.field5361.field4277;
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)V", line = 539)
    ...
    @OriginalMember(owner = "client!cc", name = "MA", descriptor = "(IIII)V", line = 555)
    ...
    @OriginalMember(owner = "client!cc", name = "T", descriptor = "()I", line = 567)
    public final int method467() {
        field5373++;
        return this.field5361.field4277 + this.field5343 + this.field5345;
    }

    @OriginalMember(owner = "client!cc", name = "j", descriptor = "()I", line = 586)
    public final int method468() {
        field5359++;
        return this.field5361.field4273 + this.field5364 + this.field5363;
    }

    @OriginalMember(owner = "client!cc", name = "s", descriptor = "(IIIIIII)V", line = 596)
    ...
    @OriginalMember(owner = "client!cc", name = "t", descriptor = "(IIIIII)V", line = 711)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(FFFFFFIII)V", line = 722)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IILma;II)V", line = 789)
    ...
    @OriginalMember(owner = "client!cc", name = "r", descriptor = "(IIIII)V", line = 848)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)V", line = 899)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILgf;II)J", line = 924)
