...
public class class348 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ZBLdv;)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)Lcw;")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(ILkha;Lkha;)V")
