...
public class class348 extends class170 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lrg;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(BLrg;)V", line = 54)
    ...
    @OriginalMember(owner = "client!ql", name = "e", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IBI)V", line = 118)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(IB)Lsp;", line = 152)
