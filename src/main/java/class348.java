...
public class class348 {
    ...
    @OriginalMember(owner = "client!afa", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field4626++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(I)[Lmu;", line = 34)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 44)
    public class348(String arg0, int arg1) {
        this.field4623 = arg1;
    }

    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(I)I", line = 70)
