...
public class class348 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIZIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(CB)V", line = 64)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIIBII)V", line = 75)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Z)V", line = 150)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)V", line = 167)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lwca;BII)V", line = 189)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lte;I)V", line = 923)
