...
public class class348 extends class751 {
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pba", name = "c", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IB)[[I", line = 26)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ILrv;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "()V", line = 146)
    public class348() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IZLiw;)V", line = 149)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BLrv;)V", line = 179)
