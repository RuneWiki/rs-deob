...
public class class348 extends class538 {
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lnq;II[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!mi", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BLuu;Lqa;)V", line = 55)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BLjava/awt/Component;)Llv;", line = 86)
