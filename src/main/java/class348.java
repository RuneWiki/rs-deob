...
public class class348 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(JI)Ljn;", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBI)I", line = 31)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIII)Z", line = 97)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ljn;JI)V", line = 159)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z[BI)Ljava/lang/Object;", line = 189)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(I)V", line = 237)
