...
public class class348 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILor;II)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Loh;ZI)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lbba;II)V")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lai;Lnt;Lew;IIIII)V")
