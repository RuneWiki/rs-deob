...
public class class348 extends class179 {
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(II)V", line = 33)
