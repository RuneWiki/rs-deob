...
public class class348 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lm;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ltj;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILao;IIIIIIIII)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 309)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)Lob;", line = 323)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "()V", line = 353)
    public class348() {
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)Lob;", line = 358)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lm;)V", line = 379)
