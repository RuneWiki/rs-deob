...
public abstract class class348 extends class687 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lgu;", line = 6)
    ...
    @OriginalMember(owner = "client!es", name = "h", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(IIIIZZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!es", name = "i", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!es", name = "j", descriptor = "(I)V", line = 85)
