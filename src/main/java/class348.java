...
public class class348 extends class98 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIBI)Lec;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lae;IIILp;III)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "([BI)Lec;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILdg;I)V")
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(II)Ljg;")
