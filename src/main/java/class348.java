...
public class class348 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILji;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lkr;B)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILkr;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILjava/lang/Object;Lkr;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lkr;I)Ljava/lang/Object;")
