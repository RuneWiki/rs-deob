...
public class class36 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 12)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IILya;IIILm;Lqm;Lgu;Lmq;Llc;Lac;)Lt;", line = 23)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IZ)V", line = 217)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lm;Llc;IIILya;IIIILmq;I)Lt;", line = 229)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 386)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "([IBZII[I)V", line = 403)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(B)V", line = 428)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lmq;IBI)V", line = 465)
    ...
    @OriginalMember(owner = "client!fb", name = "c", descriptor = "(B)V", line = 491)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIBILgu;Lqm;Lya;Lmf;Lm;Llc;Llc;[Len;IILac;ILmq;Z)Lt;", line = 509)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIB)V", line = 1029)
