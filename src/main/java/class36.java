...
@OriginalClass("client!MMJBXXXO")
public class class36 {

    @OriginalMember(owner = "client!MMJBXXXO", name = "a", descriptor = "I")
    private int field1153 = 8;

    @OriginalMember(owner = "client!MMJBXXXO", name = "b", descriptor = "LNTGUDCTQ;")
    public class37 field1154 = new class37();

    @OriginalMember(owner = "client!MMJBXXXO", name = "c", descriptor = "LNTGUDCTQ;")
    private class37 field1155;

    @OriginalMember(owner = "client!MMJBXXXO", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!MMJBXXXO", name = "a", descriptor = "(LNTGUDCTQ;)V")
    ...
    @OriginalMember(owner = "client!MMJBXXXO", name = "a", descriptor = "()LNTGUDCTQ;")
    ...
    @OriginalMember(owner = "client!MMJBXXXO", name = "a", descriptor = "(I)LNTGUDCTQ;")
    ...
    @OriginalMember(owner = "client!MMJBXXXO", name = "c", descriptor = "()I")
