...
public class class36 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)Li;", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IB)Lgg;", line = 16)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IBII)I", line = 66)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BLi;)V", line = 79)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(III)Lhu;", line = 96)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(I)V", line = 113)
    public class36(int arg0) {
        this.field431 = arg0;
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(IIIIII)V", line = 120)
