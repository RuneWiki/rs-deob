...
public class class36 {
    ...
    @OriginalMember(owner = "client!LCRVYGCP", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!LCRVYGCP", name = "c", descriptor = "[LLCRVYGCP;")
    public static class36[] field953;

    @OriginalMember(owner = "client!LCRVYGCP", name = "a", descriptor = "(ILHRXSNEYZ;)V")
    ...
    @OriginalMember(owner = "client!LCRVYGCP", name = "a", descriptor = "(LJHKSAGUC;I)V")
