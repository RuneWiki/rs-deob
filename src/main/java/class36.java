...
public class class36 {
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "t", descriptor = "LHGKRJZKS;")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "n", descriptor = "LGLMIQHJI;")
    private static class21 field1025;

    @OriginalMember(owner = "client!LPTCUHOU", name = "s", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "r", descriptor = "[LLPTCUHOU;")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "a", descriptor = "(I)LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "a", descriptor = "(BLGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "b", descriptor = "(I)LLPTCUHOU;")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "a", descriptor = "(LXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "a", descriptor = "([IIII)LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!LPTCUHOU", name = "c", descriptor = "(I)LLPTCUHOU;")
