...
public class class36 extends class436 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(FFFFFFLem;II)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IILem;II)V")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lh;IIII)V")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lh;II[III)V")
