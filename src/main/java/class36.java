...
@OriginalClass("client!MXTMAEWO")
public class class36 {

    @OriginalMember(owner = "client!MXTMAEWO", name = "b", descriptor = "I")
    public int field1115;

    @OriginalMember(owner = "client!MXTMAEWO", name = "a", descriptor = "I")
    private int field1114;

    @OriginalMember(owner = "client!MXTMAEWO", name = "c", descriptor = "[I")
    public int[] field1116;

    @OriginalMember(owner = "client!MXTMAEWO", name = "d", descriptor = "[[I")
    public int[][] field1117;

    @OriginalMember(owner = "client!MXTMAEWO", name = "<init>", descriptor = "(BLEILHLJCE;)V")
