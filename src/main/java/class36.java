...
public class class36 extends class270 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lam;I)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIZ)Lub;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Lqh;")
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(ILqk;Lqk;Lho;Lud;IIZ)V")
