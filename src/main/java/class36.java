...
public class class36 extends class11 {
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "()I", line = 3)
    public final int method54() {
        field382++;
        return 0;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "([III)V", line = 14)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!oi", name = "e", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I[[[BIBII)V", line = 81)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lio;IZ[III)V", line = 223)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "()Loe;", line = 284)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lio;BI)V", line = 304)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lvg;)V", line = 372)
    public class36(class431 arg0) {
        this.field383 = arg0;
    }

    @OriginalMember(owner = "client!oi", name = "d", descriptor = "()Loe;", line = 350)
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "(I)V", line = 380)
