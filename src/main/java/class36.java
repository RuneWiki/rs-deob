...
public class class36 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lya;IILt;ZIII)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lrr;B)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIZLya;BZ)Lt;")
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Lya;Ljt;IIIIIIZI)V")
