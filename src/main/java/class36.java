...
public class class36 extends class42 {
    ...
    public boolean field562;

    @OriginalMember(owner = "client!gp", name = "r", descriptor = "[I")
    private static int[] field565;

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()V", line = 4)
    public static void method282() {
        field565 = null;
    }

    @OriginalMember(owner = "client!gp", name = "b", descriptor = "()[I", line = 11)
    public final int[] method283() {
        return this.field566;
    }

    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(II[IZ)V", line = 14)
    public class36(int arg0, int arg1, int[] arg2, boolean arg3) {
        this.field561 = arg0;
        this.field564 = arg1;
        this.field566 = arg2;
        if (arg3) {
            int[] var5 = new int[this.field564];
            int[] var6 = new int[this.field564];
            int[] var7 = new int[this.field564];
            if (field565 == null || field565.length < this.field566.length) {
                field565 = new int[this.field566.length];
            }
            int var8 = this.field564;
            int var9 = this.field564;
            int var10 = var8 - 1;
            int var11 = var9 - 1;
            int var12 = var8 * var9;
            int var13 = var8;
            ...
            for (int var17 = var11; var17 >= 0; var17--) {
                ...
                for (int var25 = var10; var25 >= 0; var25--) {
                    ...
                    int var31 = var22 / 9;
                    var16--;
                    field565[var16] = var29 << 16 | var30 << 8 | var31;
                ...
                for (int var26 = var10; var26 >= 0; var26--) {
                    var13--;
                    int var27 = this.field566[var13];
                    var14--;
                    int var28 = this.field566[var14];
            ...
            int[] var18 = this.field566;
            this.field566 = field565;
            field565 = var18;
        }
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)V", line = 161)
    public final void method284(int arg0, int arg1) {
        ...
        int var4 = arg0;
        int var5 = this.field564 - 1;
        int var6 = this.field564 * arg1;
        int var7 = var3 - 1;
        for (int var8 = 0; var8 < var3; var8 += this.field564) {
            int var10 = var6 + var8 & var7;
            for (int var11 = 0; var11 < this.field564; var11++) {
                int var12 = var8 + var11;
                int var13 = (var4 + var11 & var5) + var10;
                field565[var12] = this.field566[var13];
            }
        }
