...
public abstract class class36 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILjava/lang/String;[BB)I", line = 76)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(B)V", line = 147)
