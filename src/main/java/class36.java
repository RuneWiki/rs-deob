...
public class class36 implements class396 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Luq;Luq;Ldv;)V", line = 64)
