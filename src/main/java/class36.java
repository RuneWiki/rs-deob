...
public class class36 {
    ...
    @OriginalMember(owner = "client!NAZXUZWI", name = "d", descriptor = "LRZDMTEAZ;")
    public class49 field1098 = new class49();

    @OriginalMember(owner = "client!NAZXUZWI", name = "e", descriptor = "LRZDMTEAZ;")
    ...
    @OriginalMember(owner = "client!NAZXUZWI", name = "a", descriptor = "(LRZDMTEAZ;)V")
    ...
    @OriginalMember(owner = "client!NAZXUZWI", name = "a", descriptor = "()LRZDMTEAZ;")
    ...
    @OriginalMember(owner = "client!NAZXUZWI", name = "b", descriptor = "()LRZDMTEAZ;")
    ...
    @OriginalMember(owner = "client!NAZXUZWI", name = "a", descriptor = "(I)LRZDMTEAZ;")
