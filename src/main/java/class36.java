...
public class class36 {
    ...
    @OriginalMember(owner = "client!KVOIHOSF", name = "c", descriptor = "[LKVOIHOSF;")
    public static class36[] field1041;

    @OriginalMember(owner = "client!KVOIHOSF", name = "a", descriptor = "(ZLMJLXHQTQ;)V")
    ...
    @OriginalMember(owner = "client!KVOIHOSF", name = "a", descriptor = "(IILXGRGMPUQ;)V")
