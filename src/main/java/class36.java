...
public class class36 extends class260 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!tfa", name = "d", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!tfa", name = "d", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lha;Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(II)I", line = 57)
    ...
    @OriginalMember(owner = "client!tfa", name = "e", descriptor = "(I)I", line = 72)
    public final int method287(int arg0) {
        ++field480;
        return arg0 >= -14 ? 39 : super.field3828;
    }

    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lgn;)V", line = 94)
    public class36(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(ILgn;)V", line = 109)
