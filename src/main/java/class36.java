...
public class class36 extends class134 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 26)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZIBLjava/lang/String;)V", line = 48)
