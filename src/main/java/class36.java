...
public class class36 extends class2 {
    ...
    @OriginalMember(owner = "client!NFNHZJTP", name = "h", descriptor = "I")
    public static int field1133;

    @OriginalMember(owner = "client!NFNHZJTP", name = "f", descriptor = "LNFNHZJTP;")
    public class36 field1131;

    @OriginalMember(owner = "client!NFNHZJTP", name = "g", descriptor = "LNFNHZJTP;")
