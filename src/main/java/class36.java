...
public class class36 extends class65 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)[Lql;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lofa;I)V")
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(ZLfc;)V")
