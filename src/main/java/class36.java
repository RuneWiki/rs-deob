...
public class class36 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)Z")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BIZIZ)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Llm;II)V")
