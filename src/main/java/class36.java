...
public class class36 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I[I[IIILeea;)Lsg;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(FFFFFIFI)F")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BC)I")
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lsaa;ILfp;)V")
    public class36(class326 arg0, int arg1, class323 arg2) {
        this.field452 = arg2;
        this.field452.method2084(31, 0);
    }

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)Ldi;")
