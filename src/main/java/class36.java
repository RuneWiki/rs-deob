...
public class class36 extends class30 {
    ...
    @OriginalMember(owner = "client!da", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljd;IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "()V", line = 346)
    public class36() {
        super(1, false);
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljg;II)V", line = 351)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lne;IIILjava/lang/String;IIZLq;Lgh;ILmp;)V", line = 394)
    ...
    @OriginalMember(owner = "client!da", name = "f", descriptor = "(B)V", line = 444)
    ...
    @OriginalMember(owner = "client!da", name = "g", descriptor = "(B)V", line = 455)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BI)[[I", line = 468)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIZIIII)Lma;", line = 546)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIII)V", line = 573)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIBI)V", line = 684)
