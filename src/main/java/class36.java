...
public abstract class class36 extends class604 {
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(IIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!tfa", name = "d", descriptor = "()I", line = 24)
    public final int method214() {
        return this.field600;
    }

    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(FFFFFF)Z", line = 31)
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "()I", line = 169)
    public final int method218() {
        return this.field622 + this.field600 + this.field597;
    }

    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(FFFFFFIIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "()I", line = 273)
    public final int method220() {
        return this.field606;
    }

    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 306)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "()I", line = 321)
    public final int method224() {
        return this.field611 + this.field606 + this.field609;
    }

    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IIIIIII)V", line = 333)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lut;II)V", line = 370)
