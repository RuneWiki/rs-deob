...
public class class36 extends class522 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!vd", name = "g", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIBI)[B", line = 32)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BZ)Z", line = 47)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "()V", line = 70)
    public class36() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "([BIIIIIZI[B)V", line = 73)
    ...
    @OriginalMember(owner = "client!vd", name = "h", descriptor = "(I)V", line = 122)
