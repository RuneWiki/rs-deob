...
public class class36 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IBLqa;)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/Class;", line = 100)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIILrk;Lqa;)V", line = 146)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(I[Lwt;IIII)V", line = 301)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIIIILqa;III)V", line = 196)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 277)
