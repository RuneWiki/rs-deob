...
@OriginalClass("client!JRQJNVRC")
public class class36 {

    @OriginalMember(owner = "client!JRQJNVRC", name = "a", descriptor = "I")
    private int field1201 = 1;

    @OriginalMember(owner = "client!JRQJNVRC", name = "b", descriptor = "I")
    public int field1202;

    @OriginalMember(owner = "client!JRQJNVRC", name = "c", descriptor = "[I")
    public int[] field1203;

    @OriginalMember(owner = "client!JRQJNVRC", name = "d", descriptor = "[[I")
    public int[][] field1204;

    @OriginalMember(owner = "client!JRQJNVRC", name = "<init>", descriptor = "(LINLHDAGO;I)V")
