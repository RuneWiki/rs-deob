...
public abstract class class36 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBI)I", line = 54)
