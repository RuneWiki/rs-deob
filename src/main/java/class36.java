...
public class class36 extends class535 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILwn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "()V", line = 302)
    public class36() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILci;)V", line = 96)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIILcd;II)V", line = 117)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(I)I", line = 247)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IBI)Z", line = 258)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(III)Z", line = 277)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(B)V", line = 359)
    ...
    @OriginalMember(owner = "client!gp", name = "f", descriptor = "(B)V", line = 373)
