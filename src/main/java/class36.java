...
public class class36 implements Runnable {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZLjava/awt/Component;II)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II)Ltj;")
    public final class429 method241(int arg0, int arg1) {
        int var3 = 85 % ((61 - arg0) / 59);
        return this.method255((Object) null, 3, arg1, 0, true);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Runnable;BI)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Class;I)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIBI)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/awt/Frame;B)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;I)Ltj;")
    public final class429 method248(String arg0, int arg1) {
        int var3 = 84 / ((-arg1 - 40) / 47);
        return this.method255(arg0, 16, 0, 0, true);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/net/URL;I)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Lci;")
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(Ljava/lang/String;I)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(Ljava/lang/Class;I)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Object;IIIZ)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(I)Ltj;")
    public final class429 method256(int arg0) {
        return arg0 == 1503 ? this.method255((Object) null, 5, 0, 0, true) : null;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;Z)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Class;B[Ljava/lang/Class;Ljava/lang/String;)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IB[IILjava/awt/Point;Ljava/awt/Component;)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IILjava/lang/String;)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(I)Ltj;")
    public final class429 method262(int arg0) {
        return arg0 == 0 ? this.method255((Object) null, 18, 0, 0, true) : null;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/awt/Component;IZ)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Object;IIII)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(B)Ltj;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BLjava/lang/Class;)Ltj;")
