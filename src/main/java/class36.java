...
@OriginalClass("client!OQGXHJNH")
public class class36 extends class50 {

    @OriginalMember(owner = "client!OQGXHJNH", name = "ob", descriptor = "I")
    private int field964 = 613;

    @OriginalMember(owner = "client!OQGXHJNH", name = "pb", descriptor = "I")
    private int field965;

    @OriginalMember(owner = "client!OQGXHJNH", name = "qb", descriptor = "LCOIHKGSL;")
    public class6 field966;

    @OriginalMember(owner = "client!OQGXHJNH", name = "a", descriptor = "(Z)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!OQGXHJNH", name = "b", descriptor = "(I)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!OQGXHJNH", name = "a", descriptor = "(I)Z")
