...
public class class36 extends class478 {
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "()V", line = 67)
    public class36() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ml", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIIIII)I", line = 73)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II[I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(II)[I", line = 325)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 358)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILnp;I)V", line = 388)
