...
public class class36 extends class71 {
    ...
    @OriginalMember(owner = "client!de", name = "r", descriptor = "Llf;")
    public static class109 field793 = class35.method275("VOLL", 2);

    @OriginalMember(owner = "client!de", name = "p", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!de", name = "y", descriptor = "Llf;")
    private static class109 field800 = class35.method275("Error loading your profile)3", 2);

    @OriginalMember(owner = "client!de", name = "s", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IIIILka;Lka;IIIIJ)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([Llf;I)Llf;")
