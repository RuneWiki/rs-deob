...
public class class36 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I[[[BIBII)V", line = 89)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIIIBIII)Z", line = 230)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 249)
