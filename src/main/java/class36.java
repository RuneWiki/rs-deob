...
public class class36 extends class324 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(II)I", line = 3)
    public static final int method197(int arg0, int arg1) {
        return class136.field1696 == null ? 0 : class136.field1696[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;IZIIZIJ)V", line = 11)
    ...
    @OriginalMember(owner = "client!vba", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!vba", name = "f", descriptor = "(I)Z", line = 50)
