...
public class class36 extends class531 {
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "()V", line = 3)
    public static void method193() {
        field456 = null;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "()V", line = 16)
    public final void method196() {
        field456.method1076(this.field457, true);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 19)
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "()I", line = 23)
    public final int method198() {
        return field456.method1080(this.field457, true);
    }

    @OriginalMember(owner = "client!it", name = "c", descriptor = "()V", line = 26)
    public final void method199() {
        field456.method1077(9380, this.field457);
    }

    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lrp;I)V", line = 28)
