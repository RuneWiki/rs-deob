...
public class class36 extends class506 implements class248 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ZLqa;)Lae;", line = 4)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILqa;II)Z", line = 48)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IBC)I", line = 61)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(IIIIILrl;)V", line = 84)
    ...
    @OriginalMember(owner = "client!gp", name = "d", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BLqa;)V", line = 105)
    public final void method25(byte arg0, class162 arg1) {
        int var3 = 22 / ((arg0 + 45) / 48);
        field694++;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqa;II)Lc;", line = 115)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IB)V", line = 165)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)Z", line = 200)
    public final boolean method8(int arg0) {
        field695++;
        return arg0 <= 94;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILqa;)V", line = 211)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(I)V", line = 223)
    public final void method26(int arg0) {
        int var2 = -47 / ((-arg0 - 46) / 44);
        field681++;
    }

    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(B)I", line = 246)
