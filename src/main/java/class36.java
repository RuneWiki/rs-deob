...
public class class36 extends class778 {
    ...
    @OriginalMember(owner = "client!tfa", name = "j", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!tfa", name = "i", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILsf;Lha;BIIZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILft;)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!tfa", name = "finalize", descriptor = "()V", line = 117)
    ...
    @OriginalMember(owner = "client!tfa", name = "h", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(IIIIIIIIIIIIIZI)V", line = 470)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(III)I", line = 145)
    ...
    @OriginalMember(owner = "client!tfa", name = "g", descriptor = "(I)I", line = 166)
    public final int method246(int arg0) {
        ++field486;
        return arg0 >= -104 ? -119 : this.field493;
    }

    @OriginalMember(owner = "client!tfa", name = "m", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(B)Z", line = 197)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lka;Leh;ILha;)V", line = 220)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lha;ZI)Lka;", line = 258)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IZLha;I)Z", line = 368)
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(B)Z", line = 388)
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(Lha;B)Lpw;", line = 409)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IIZII)V", line = 419)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lha;I)V", line = 497)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lha;B)Lhq;", line = 521)
