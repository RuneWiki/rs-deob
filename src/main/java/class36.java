...
public class class36 extends class125 {
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(Z)I", line = 21)
    public final int method185(boolean arg0) {
        ++field328;
        return arg0 ? 33 : super.field1732;
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)I", line = 32)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BI)V", line = 45)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZI)I", line = 58)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lgp;)V", line = 70)
    public class36(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IBI)Z", line = 94)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(ILgp;)V", line = 164)
