...
public class class36 extends class179 implements class562 {
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lhl;Lkq;Z)V", line = 3)
    public class36(class529 arg0, class594 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field375 = arg1;
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Z)V", line = 11)
    public final void method176(boolean arg0) {
        ++field373;
        super.method176(arg0);
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)Z", line = 36)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 46)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)V", line = 72)
    public final void method180(int arg0, int arg1) {
        ++field374;
        super.method180(this.field375.field8274 * arg0, arg1);
    }

    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)Lkq;", line = 83)
