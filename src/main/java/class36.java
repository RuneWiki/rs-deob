...
public class class36 extends class149 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "()V", line = 49)
    public class36() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBLtl;)V", line = 52)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BI)[[I", line = 97)
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(I)V", line = 186)
