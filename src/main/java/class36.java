...
public class class36 extends class512 {
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "()V", line = 3)
    public class36() {
        super(1, true);
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!hq", name = "d", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLl;Lza;)V", line = 45)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(Z)V", line = 273)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IB)[I", line = 320)
    ...
    @OriginalMember(owner = "client!hq", name = "f", descriptor = "(I)V", line = 391)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZZ)V", line = 407)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lou;B)V", line = 509)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZILia;)V", line = 937)
