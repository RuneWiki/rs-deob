...
public class class36 {
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "f", descriptor = "LIHAIACWA;")
    public class33 field1035 = new class33();

    @OriginalMember(owner = "client!JQSVNFRT", name = "g", descriptor = "LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "a", descriptor = "(LIHAIACWA;)V")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "a", descriptor = "(LIHAIACWA;I)V")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "a", descriptor = "()LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "b", descriptor = "()LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "a", descriptor = "(I)LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "b", descriptor = "(I)LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!JQSVNFRT", name = "a", descriptor = "(B)LIHAIACWA;")
