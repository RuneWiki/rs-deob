...
public class class36 {
    ...
    @OriginalMember(owner = "client!NRLTHETF", name = "f", descriptor = "[LNRLTHETF;")
    public static class36[] field1099;

    @OriginalMember(owner = "client!NRLTHETF", name = "a", descriptor = "(ILRVLWVPJQ;)V")
    ...
    @OriginalMember(owner = "client!NRLTHETF", name = "a", descriptor = "(ILUAWAYCTK;)V")
    ...
    @OriginalMember(owner = "client!NRLTHETF", name = "a", descriptor = "(B)LWEVRTBOZ;")
    ...
    @OriginalMember(owner = "client!NRLTHETF", name = "b", descriptor = "(I)LWEVRTBOZ;")
