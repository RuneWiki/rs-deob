...
public class class36 extends class263 {
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)[Ljd;", line = 21)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "([I[IZIZ)J", line = 32)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILh;Loa;IIIIILcu;Z)Lba;", line = 82)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(III)I", line = 332)
