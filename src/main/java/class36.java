...
public class class36 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lar;Z)Z", line = 25)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)I", line = 153)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "([I)V", line = 183)
