...
public class class36 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 6)
    public static void method225(int arg0) {
        field566 = null;
        int var1 = -30 % (arg0 / 61);
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZLfia;[IJ)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)Lqga;", line = 39)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(II)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(ILnd;Lnd;Lop;)V", line = 112)
