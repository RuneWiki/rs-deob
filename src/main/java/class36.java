...
public class class36 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IB)Lci;", line = 3)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILrba;)V", line = 35)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lvj;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(ZI)V", line = 121)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 169)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lpca;IZLbi;Lbi;)V", line = 289)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(B)V", line = 252)
