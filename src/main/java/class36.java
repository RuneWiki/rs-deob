...
public class class36 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lec;I)Ljava/lang/String;", line = 27)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 68)
