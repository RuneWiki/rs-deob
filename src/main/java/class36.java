...
public class class36 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lfh;II)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)Lrr;")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILfh;)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lpv;[I[IB[I)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILfi;)Lfi;")
