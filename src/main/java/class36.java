...
public class class36 extends class423 {
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 54)
