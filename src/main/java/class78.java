...
public class class78 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IZI)Lbr;")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(BILob;)V")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ZILng;I)V")
