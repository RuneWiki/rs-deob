...
public class class78 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BLtd;)V")
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)Ltd;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Z)Ltd;")
