...
public class class78 extends class337 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IJ)V", line = 6)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIB)V", line = 96)
    ...
    @OriginalMember(owner = "client!co", name = "e", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "()V", line = 125)
    public class78() {
        super(1, false);
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)[[I", line = 129)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BILhp;)V", line = 176)
    ...
    @OriginalMember(owner = "client!co", name = "i", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lya;Lor;IIIII)V", line = 204)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IB)[I", line = 293)
