...
public class class78 implements class87 {
    ...
    private int[] field1427 = null;

    @OriginalMember(owner = "client!pf", name = "d", descriptor = "I")
    private static int field1428 = 96;

    @OriginalMember(owner = "client!pf", name = "e", descriptor = "I")
    private static int field1429 = 36;

    @OriginalMember(owner = "client!pf", name = "f", descriptor = "I")
    private static int field1430 = 12;

    @OriginalMember(owner = "client!pf", name = "c", descriptor = "()I", line = 6)
    public final int method499() {
        return 4;
    }

    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 152)
    public class78() {
        if (class247.field4238 && class247.field4239 >= 2) {
            this.method504();
            GL var1 = class247.field4253;
            var1.glBindTexture(34067, this.field1427[0]);
            ...
            var1.glBindTexture(34067, this.field1427[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field1427[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field1425 = class247.field4239 < 3;
        }
        this.method500();
    }

    @OriginalMember(owner = "client!pf", name = "d", descriptor = "()V", line = 13)
    private final void method500() {
        GL var1 = class247.field4253;
        this.field1426 = var1.glGenLists(2);
        var1.glNewList(this.field1426, 4864);
        if (this.field1427 == null) {
            ...
            if (this.field1425) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class247.field4259);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field1426 + 1, 4864);
        if (this.field1427 == null) {
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "()V", line = 107)
    public final void method501() {
        GL var1 = class247.field4253;
        if (class90.field1536) {
            class247.method1687(1);
            var1.glCallList(this.field1426);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "()V", line = 121)
    public final void method502() {
        GL var1 = class247.field4253;
        if (class90.field1536) {
            var1.glCallList(this.field1426 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 138)
    public final void method503(int arg0) {
        GL var2 = class247.field4253;
        if (class90.field1536 && this.field1427 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field1427[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!pf", name = "e", descriptor = "()V", line = 190)
    private final void method504() {
        GL var1 = class247.field4253;
        if (this.field1427 == null) {
            this.field1427 = new int[3];
            var1.glGenTextures(3, this.field1427, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            for (int var8 = 0; var8 < 64; var8++) {
                for (int var9 = 0; var9 < 64; var9++) {
                    ...
                    int var18;
                    if (var15 > 0.0F) {
                        var16 = (int) (Math.pow((double) var15, (double) field1428) * 255.0D);
                        var17 = (int) (Math.pow((double) var15, (double) field1429) * 255.0D);
                        var18 = (int) (Math.pow((double) var15, (double) field1430) * 255.0D);
                    } else {
                        var18 = 0;
                        var17 = 0;
                        var16 = 0;
