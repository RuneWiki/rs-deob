...
public class class78 extends class375 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lmo;II)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLjava/awt/Canvas;ILfa;)Lr;")
