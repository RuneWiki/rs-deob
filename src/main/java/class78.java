...
public class class78 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BLlo;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lkw;Lcea;Lmt;IIIII)V", line = 275)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BILcs;)V", line = 63)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I[BLmba;I)Lob;", line = 250)
