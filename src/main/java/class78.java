...
public class class78 extends class4 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IILii;Lar;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mn", name = "e", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Llm;Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!mn", name = "f", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!mn", name = "e", descriptor = "(I)[B", line = 222)
