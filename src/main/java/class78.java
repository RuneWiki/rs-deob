...
public class class78 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(II)Lew;", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IB)V", line = 100)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IILda;IBLqa;II)Lf;", line = 168)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(IB)V", line = 207)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ZI)V", line = 221)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lai;IZLkc;Lic;Lic;)V", line = 325)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILda;IIBIILoa;ZZLqa;Lqa;)Lf;", line = 244)
