...
public class class78 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IBI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZIBZI)I", line = 61)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IC)Z", line = 130)
