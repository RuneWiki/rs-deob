...
public class class78 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)J")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IZ)Lwj;")
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lpca;ILbi;)V")
