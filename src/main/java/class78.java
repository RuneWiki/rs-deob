...
public class class78 extends class516 {
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILha;II)Z", line = 27)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(Lha;I)Ltja;", line = 73)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(Lha;I)V", line = 125)
    public final void method76(class473 arg0, int arg1) {
        int var3 = 15 / ((-30 - arg1) / 42);
        ++field883;
    }

    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(IIIII)V", line = 357)
    public class78(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(II)I", line = 137)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILha;)Lrk;", line = 155)
    ...
    @OriginalMember(owner = "client!qv", name = "d", descriptor = "(B)I", line = 332)
    ...
    @OriginalMember(owner = "client!qv", name = "e", descriptor = "(I)Z", line = 346)
    ...
    @OriginalMember(owner = "client!qv", name = "d", descriptor = "(I)Z", line = 369)
