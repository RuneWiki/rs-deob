...
public class class78 extends class425 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIIF[FFIIFF)V", line = 7)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BIIIIIIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(III)V", line = 222)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lya;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(I)V", line = 265)
