...
public class class78 {
    ...
    @OriginalMember(owner = "client!kl", name = "listmodes", descriptor = "()[I", line = 9)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 33)
    ...
    @OriginalMember(owner = "client!kl", name = "exit", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!kl", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 135)
