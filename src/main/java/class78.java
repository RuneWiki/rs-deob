...
public class class78 {
    ...
    @OriginalMember(owner = "client!kq", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1088++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILsm;)I", line = 20)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 108)
    public class78(String arg0, int arg1) {
        this.field1083 = arg1;
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)V", line = 120)
