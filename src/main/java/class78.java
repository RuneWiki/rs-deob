...
public class class78 extends class496 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(CI)Z", line = 185)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([BZLgv;[I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(B)V", line = 256)
    public static void method457(byte arg0) {
        int var1 = 88 % ((arg0 + 18) / 36);
        field903 = null;
    }

    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 270)
    public class78() {
    }

    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "([B)V", line = 272)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IILcd;IIIILcd;II)V", line = 914)
