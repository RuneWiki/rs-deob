...
public class class78 extends class34 {
    ...
    @OriginalMember(owner = "client!kq", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lsv;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 75)
    public class78() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IB)[I", line = 124)
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "(B)V", line = 202)
