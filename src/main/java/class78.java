...
public abstract class class78 extends class181 {
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIII)V", line = 34)
