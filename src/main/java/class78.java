...
public class class78 extends class191 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Loa;B)Laca;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIILva;Loa;ZI)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Loa;BI)Z")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(Loa;I)Lew;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lpl;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLeca;)I")
