...
public class class78 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(ZIFIZIIII)[[I", line = 31)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(I[BILjava/lang/String;)I", line = 104)
