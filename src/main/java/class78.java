...
public abstract class class78 {
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IBIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIBZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)V", line = 77)
    ...
    @OriginalMember(owner = "client!a", name = "f", descriptor = "(I)Z", line = 117)
