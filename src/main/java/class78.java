...
public class class78 extends class665 implements class721 {
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IBLha;I)Z")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(Lha;B)Lc;")
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lfe;B)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lha;I)Lria;")
