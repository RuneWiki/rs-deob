...
public class class78 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)Lum;")
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)Lum;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(JBLum;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IJ)Lum;")
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)Lum;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([Lum;B)I")
