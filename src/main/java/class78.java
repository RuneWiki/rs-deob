...
public class class78 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lnk;B)Lnk;")
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(I)[Loj;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIB)Lnk;")
