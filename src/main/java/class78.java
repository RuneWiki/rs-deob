...
public abstract class class78 extends class508 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(III)Z", line = 11)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BI)V", line = 22)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I[Ljava/lang/Object;I[II)V", line = 211)
