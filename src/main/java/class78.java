...
public class class78 extends class313 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "()V", line = 4)
    private final void method485() {
        this.field970 = false;
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "([Ljc;Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Le;[Lkh;Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Le;J[Lkh;[Ljc;Z)V", line = 170)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "()Ljp;", line = 181)
    public final class198 method489() {
        return this.field981;
    }

    @OriginalMember(owner = "client!pj", name = "c", descriptor = "()V", line = 185)
    public static void method490() {
        field974 = null;
        field975 = null;
    }

    @OriginalMember(owner = "client!pj", name = "d", descriptor = "()V", line = 189)
    public final void method491() {
        this.field984 = true;
    }

    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIII)V", line = 201)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "()V", line = 209)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(J)V", line = 224)
    public final void method494(long arg0) {
        this.field971 = arg0;
    }

    @OriginalMember(owner = "client!pj", name = "f", descriptor = "()V", line = 227)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Le;J)Z", line = 251)
    ...
    @OriginalMember(owner = "client!pj", name = "g", descriptor = "()V", line = 299)
