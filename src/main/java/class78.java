...
public class class78 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIZLkm;)Laq;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILlk;B)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILlk;)V")
