...
public class class78 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILvj;IZLjava/awt/Component;)Lck;", line = 10)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)I", line = 111)
    public final int method611(boolean arg0) {
        field1329++;
        return arg0 ? -65 : this.field1331;
    }

    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lmc;ZLjava/lang/Object;)V", line = 178)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILmc;)V", line = 229)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)I", line = 255)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(III)Z", line = 289)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(III)I", line = 313)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(II)V", line = 334)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lmc;I)Ljava/lang/Object;", line = 381)
