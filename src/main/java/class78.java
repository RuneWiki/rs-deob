...
public class class78 extends class232 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILno;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "()Lwi;", line = 80)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "([III)V", line = 104)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILjava/lang/String;)Z", line = 145)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)[Laj;", line = 195)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "()I", line = 206)
    public final int method332() {
        field974++;
        return 0;
    }

    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "()Lwi;", line = 225)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIILno;[I)V", line = 248)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lwfa;)V", line = 317)
