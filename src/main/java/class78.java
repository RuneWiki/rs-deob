...
public class class78 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lqj;BLjava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lqf;II)Z")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lpp;I)I")
