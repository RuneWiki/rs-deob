...
public class class78 extends class14 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IB)[I", line = 11)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "()V", line = 95)
    public class78() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IBLmd;)V", line = 99)
    ...
    @OriginalMember(owner = "client!ej", name = "e", descriptor = "(I)V", line = 144)
