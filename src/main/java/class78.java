...
public class class78 extends class379 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Les;I)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ZILkq;I)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(BLes;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(ZLlc;)V")
