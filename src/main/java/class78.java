...
public class class78 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)Lkl;", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lkl;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BI)[B", line = 97)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIB)Z", line = 167)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lco;I)Z", line = 182)
    ...
    @OriginalMember(owner = "client!ik", name = "c", descriptor = "(I)Lkl;", line = 224)
    ...
    @OriginalMember(owner = "client!ik", name = "c", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!ik", name = "d", descriptor = "(I)Lkl;", line = 262)
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(I)Lkl;", line = 287)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "()V", line = 315)
    public class78() {
