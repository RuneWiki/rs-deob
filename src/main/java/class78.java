...
public class class78 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)Ljd;", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(JILgh;IILta;III)V", line = 37)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lh;[[BI)V", line = 194)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILta;Lfj;IIIIBLgh;ILla;Ljava/lang/String;)V", line = 268)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 319)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(ILph;Lph;)V", line = 332)
