...
public class class78 extends class397 {
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "()V", line = 15)
    public class78() {
        super(2, false);
    }

    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IBLae;)V", line = 18)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(II)[I", line = 55)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lhe;B)I", line = 302)
    ...
    @OriginalMember(owner = "client!di", name = "f", descriptor = "(I)V", line = 373)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lso;B)V", line = 388)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BI)[[I", line = 415)
