...
public class class78 extends class386 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "()V", line = 38)
    public class78() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tt", name = "e", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 52)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(II)[[I", line = 96)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!tt", name = "e", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!tt", name = "f", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IBLun;)V", line = 283)
