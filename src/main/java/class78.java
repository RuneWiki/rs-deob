...
public class class78 extends class456 {
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "()V", line = 39)
    public class78() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IILat;ILtq;)V", line = 64)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IBLre;)V", line = 101)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!rf", name = "h", descriptor = "(I)V", line = 347)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)[[I", line = 362)
