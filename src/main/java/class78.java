...
public class class78 extends class521 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILhv;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lbda;Llba;)V", line = 18)
    public class78(class428 arg0, class468 arg1) {
        super(arg0);
        this.field904 = arg1;
    }

    @OriginalMember(owner = "client!sd", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(III)Ldg;", line = 83)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 124)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BZ)V", line = 179)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)V", line = 200)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIII)V", line = 246)
