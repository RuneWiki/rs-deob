...
public class class78 extends class85 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
