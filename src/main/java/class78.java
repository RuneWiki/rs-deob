...
public class class78 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIIII)Lkm;", line = 7)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I[BII)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(III)Z", line = 104)
