...
@OriginalClass("client!YTBPTACV")
public class class70 {

    @OriginalMember(owner = "client!YTBPTACV", name = "a", descriptor = "Z")
    private boolean field1690 = true;

    @OriginalMember(owner = "client!YTBPTACV", name = "c", descriptor = "I")
    private int field1692 = 411;

    @OriginalMember(owner = "client!YTBPTACV", name = "h", descriptor = "I")
    public int field1697 = -1;

    @OriginalMember(owner = "client!YTBPTACV", name = "j", descriptor = "[I")
    public int[] field1699 = new int[6];

    @OriginalMember(owner = "client!YTBPTACV", name = "k", descriptor = "[I")
    public int[] field1700 = new int[6];

    @OriginalMember(owner = "client!YTBPTACV", name = "l", descriptor = "I")
    public int field1701 = 128;

    @OriginalMember(owner = "client!YTBPTACV", name = "m", descriptor = "I")
    public int field1702 = 128;

    @OriginalMember(owner = "client!YTBPTACV", name = "b", descriptor = "Z")
    private static boolean field1691 = true;

    @OriginalMember(owner = "client!YTBPTACV", name = "q", descriptor = "LQQBOAQZB;")
    public static class50 field1706 = new class50(3, 30);

    @OriginalMember(owner = "client!YTBPTACV", name = "d", descriptor = "I")
    public static int field1693;

    @OriginalMember(owner = "client!YTBPTACV", name = "f", descriptor = "I")
    public int field1695;

    @OriginalMember(owner = "client!YTBPTACV", name = "g", descriptor = "I")
    public int field1696;

    @OriginalMember(owner = "client!YTBPTACV", name = "n", descriptor = "I")
    public int field1703;

    @OriginalMember(owner = "client!YTBPTACV", name = "o", descriptor = "I")
    public int field1704;

    @OriginalMember(owner = "client!YTBPTACV", name = "p", descriptor = "I")
    public int field1705;

    @OriginalMember(owner = "client!YTBPTACV", name = "i", descriptor = "LHARRRJHW;")
    public class26 field1698;

    @OriginalMember(owner = "client!YTBPTACV", name = "e", descriptor = "[LYTBPTACV;")
    public static class70[] field1694;

    @OriginalMember(owner = "client!YTBPTACV", name = "a", descriptor = "(LDYBMLHQM;Z)V")
    ...
    @OriginalMember(owner = "client!YTBPTACV", name = "a", descriptor = "(ILINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!YTBPTACV", name = "a", descriptor = "()LDHUPIIUL;")
