...
public class class70 {
    ...
    @OriginalMember(owner = "client!ra", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1048++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjava/lang/String;ZIIILjava/lang/String;IJIZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/awt/Canvas;Z)Lci;", line = 53)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(IIII)V", line = 89)
