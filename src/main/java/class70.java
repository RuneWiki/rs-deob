...
@OriginalClass("client!ZJFRIHZL")
public class class70 {

    @OriginalMember(owner = "client!ZJFRIHZL", name = "a", descriptor = "LQCZGLSKF;")
    private static class45 field1696 = new class45();

    @OriginalMember(owner = "client!ZJFRIHZL", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!ZJFRIHZL", name = "a", descriptor = "(LQCZGLSKF;)V")
    ...
    @OriginalMember(owner = "client!ZJFRIHZL", name = "b", descriptor = "(LQCZGLSKF;)V")
    ...
    @OriginalMember(owner = "client!ZJFRIHZL", name = "c", descriptor = "(LQCZGLSKF;)B")
    private static byte method581(class45 arg0) {
        return (byte) method583(8, arg0);
    }

    @OriginalMember(owner = "client!ZJFRIHZL", name = "d", descriptor = "(LQCZGLSKF;)B")
    private static byte method582(class45 arg0) {
        return (byte) method583(1, arg0);
    }

    @OriginalMember(owner = "client!ZJFRIHZL", name = "a", descriptor = "(ILQCZGLSKF;)I")
    ...
    @OriginalMember(owner = "client!ZJFRIHZL", name = "e", descriptor = "(LQCZGLSKF;)V")
    ...
    @OriginalMember(owner = "client!ZJFRIHZL", name = "a", descriptor = "([I[I[I[BIII)V")
