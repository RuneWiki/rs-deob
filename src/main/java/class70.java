...
@OriginalClass("client!XGJADJOY")
public class class70 extends class18 {

    @OriginalMember(owner = "client!XGJADJOY", name = "u", descriptor = "I")
    private int field1708 = -45010;

    @OriginalMember(owner = "client!XGJADJOY", name = "v", descriptor = "Z")
    public boolean field1709 = false;

    @OriginalMember(owner = "client!XGJADJOY", name = "q", descriptor = "LUYLUCQNM;")
    private class63 field1704;

    @OriginalMember(owner = "client!XGJADJOY", name = "m", descriptor = "I")
    public int field1700;

    @OriginalMember(owner = "client!XGJADJOY", name = "n", descriptor = "I")
    public int field1701;

    @OriginalMember(owner = "client!XGJADJOY", name = "o", descriptor = "I")
    public int field1702;

    @OriginalMember(owner = "client!XGJADJOY", name = "p", descriptor = "I")
    public int field1703;

    @OriginalMember(owner = "client!XGJADJOY", name = "r", descriptor = "I")
    public int field1705;

    @OriginalMember(owner = "client!XGJADJOY", name = "s", descriptor = "I")
    private int field1706;

    @OriginalMember(owner = "client!XGJADJOY", name = "t", descriptor = "I")
    private int field1707;

    @OriginalMember(owner = "client!XGJADJOY", name = "a", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!XGJADJOY", name = "<init>", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!XGJADJOY", name = "a", descriptor = "(II)V")
