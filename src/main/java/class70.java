...
public class class70 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IZ)Lco;")
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lmk;BLmk;)V")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lsea;ILmv;)V")
