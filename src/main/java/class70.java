...
public class class70 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IB)Lup;")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILbn;)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lci;ILhe;)V")
