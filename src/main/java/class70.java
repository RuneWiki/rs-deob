...
public class class70 extends class695 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BI)Lcv;", line = 3)
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(Lbi;IIII[BI)V", line = 77)
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(Lbi;IIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I[B)[B", line = 111)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!sga", name = "g", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IIIIIIII)V", line = 163)
