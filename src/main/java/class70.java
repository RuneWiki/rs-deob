...
public class class70 extends class249 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lme;ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lwh;)V", line = 83)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III)V", line = 128)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!sh", name = "e", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZ)V", line = 167)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)V", line = 219)
