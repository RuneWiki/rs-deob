...
public class class70 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(III)V", line = 174)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BI)[I", line = 26)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)[[I", line = 94)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(III)I", line = 121)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 136)
