...
public class class70 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIIILeb;Lya;II)Ll;")
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(BI)Lff;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Leb;Lla;ZLya;IIIIIZLya;I)Ll;")
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lae;IZLtl;Lqn;Lqn;)V")
