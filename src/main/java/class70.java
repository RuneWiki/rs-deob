...
public class class70 extends class363 implements class529 {
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZLya;)V", line = 15)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!eg", name = "e", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(Lya;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(IIILhr;)V", line = 73)
    public class70(int arg0, int arg1, int arg2, class363 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field895 = arg3;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lya;I)V", line = 82)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)I", line = 113)
    public final int method28(boolean arg0) {
        field905++;
        return arg0 ? 0 : -110;
    }

    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(B)Z", line = 125)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(I)V", line = 136)
    public final void method29(int arg0) {
        field900++;
        int var2 = 23 % ((arg0 - 57) / 44);
    }

    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(Lya;I)Lfk;", line = 146)
    public final class462 method38(class38 arg0, int arg1) {
        field908++;
        return arg1 > -87 ? null : null;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)Lah;", line = 158)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILfi;BZLya;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lya;II)Lt;", line = 204)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILya;I)Z", line = 214)
