...
public class class70 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(II)Lsg;", line = 6)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lfn;IIZIIB)V", line = 77)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbl;Lvl;)V", line = 146)
