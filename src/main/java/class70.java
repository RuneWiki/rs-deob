...
public class class70 implements Runnable {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILjava/lang/Object;II)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;I)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIZII)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/net/URL;I)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BI)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLjava/lang/String;Z)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILjava/lang/String;)Lmea;")
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/awt/Frame;I)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/Runnable;II)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;IIZ)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;B[Ljava/lang/Class;Ljava/lang/Class;)Leba;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)Lmea;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IZ[IILjava/awt/Component;Ljava/awt/Point;)Leba;")
