...
public class class70 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ga", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field949++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 41)
