...
public class class70 extends class577 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BIII)Lvn;", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lwia;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(IIIIIZ)V", line = 99)
