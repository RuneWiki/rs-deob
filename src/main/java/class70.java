...
public class class70 {
    ...
    @OriginalMember(owner = "client!YOJCLTLA", name = "d", descriptor = "[LYOJCLTLA;")
    public static class70[] field1711;

    @OriginalMember(owner = "client!YOJCLTLA", name = "a", descriptor = "(LVSUYIIVA;I)V")
    ...
    @OriginalMember(owner = "client!YOJCLTLA", name = "a", descriptor = "(LCFARFRSG;I)V")
