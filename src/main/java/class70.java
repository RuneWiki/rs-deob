...
public class class70 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)V", line = 109)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)V", line = 132)
