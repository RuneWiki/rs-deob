...
public class class70 {
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IB)Lea;", line = 63)
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BI)V", line = 131)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lei;ILri;)V", line = 201)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(III)Z", line = 188)
