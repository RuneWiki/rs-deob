...
public class class70 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(BLsha;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(B)V", line = 123)
