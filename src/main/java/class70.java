...
public abstract class class70 {
    ...
    @OriginalMember(owner = "client!mf", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 14)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I[BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILhn;)V", line = 69)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Ljj;I[BIZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([S[Ljava/lang/String;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Ljj;ILjaclib/memory/Buffer;IZ)V", line = 130)
