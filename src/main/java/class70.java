...
public class class70 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I[BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lba;III)V", line = 70)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILba;II)Z", line = 140)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZZ[[ZIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lkd;Llk;)V", line = 398)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIIII)V", line = 413)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZILba;I)V", line = 452)
