...
public class class70 implements class217 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lis;Ljs;)V")
    public class70(class2 arg0, class269 arg1) {
        this.field943 = arg1;
        this.field948 = arg0;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILla;IILjava/lang/String;Z)I")
