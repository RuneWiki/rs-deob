...
public class class70 extends class162 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II[I[I)Lea;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lqb;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "m", descriptor = "(Lia;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lc;Lia;[Lnh;I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIIZ)Lf;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIIIF)Lpe;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lc;Lqb;Lia;[Lnh;I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lpv;Lpv;FLpv;)Lpv;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ll;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lui;III)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lmp;Z)Lf;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I[Lpe;)V")
    public final void method490(int arg0, class432[] arg1) {
    }

    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(ILm;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "n", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(I)Ll;")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "j", descriptor = "(ILea;II)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II[[I[[IIII)Lna;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lgv;[Lmp;Z)Loa;")
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(IIIIII)Lpv;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/Runnable;)Lur;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lpv;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!ra", name = "l", descriptor = "()Lia;")
    public final class415 method539() {
        class374 var1 = this.method523(Thread.currentThread());
        return var1.field5226;
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lwk;IIII)Lc;")
