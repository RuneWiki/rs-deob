...
public class class70 extends class142 {
    ...
    @OriginalMember(owner = "client!eg", name = "p", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lba;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!eg", name = "k", descriptor = "(IILba;)Lba;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ljd;[I)V")
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILfk;I)V")
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lef;IIII[[I[[II)V")
