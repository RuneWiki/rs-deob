...
public class class70 extends class13 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ZI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)[[I", line = 66)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IZ)I", line = 123)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lkh;BI)V", line = 141)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "()V", line = 182)
    public class70() {
        super(3, false);
    }
}
