...
public class class70 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lhn;III)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IB)Lco;")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lwv;ILqs;Lqs;)V")
