...
public class class70 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)Lsf;", line = 70)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)Lsf;", line = 135)
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)V", line = 328)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IBLjava/awt/Canvas;Le;)Loa;", line = 338)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BLoa;)V", line = 349)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lrh;Z)V", line = 372)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "()V", line = 384)
    public class70() {
    }

    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lrh;)V", line = 388)
