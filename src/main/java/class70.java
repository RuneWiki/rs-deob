...
public class class70 extends class125 {
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZI)I", line = 72)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(Z)I", line = 90)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(ILgp;)V", line = 101)
    public class70(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lgp;)V", line = 106)
    public class70(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lla;B)V", line = 128)
