...
public class class70 {
    ...
    @OriginalMember(owner = "client!ZWNTUTST", name = "b", descriptor = "[LZWNTUTST;")
    public static class70[] field1719;

    @OriginalMember(owner = "client!ZWNTUTST", name = "a", descriptor = "(ILQDHHNYHL;)V")
    ...
    @OriginalMember(owner = "client!ZWNTUTST", name = "a", descriptor = "(BLPGNBHFUF;I)V")
