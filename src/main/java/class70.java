...
public class class70 {
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "e", descriptor = "LAJSSLSFA;")
    public class2 field1722 = new class2();

    @OriginalMember(owner = "client!ZCVCEQHJ", name = "f", descriptor = "LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "a", descriptor = "(LAJSSLSFA;)V")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "a", descriptor = "(LAJSSLSFA;I)V")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "a", descriptor = "()LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "b", descriptor = "()LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "a", descriptor = "(Z)LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "a", descriptor = "(I)LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!ZCVCEQHJ", name = "b", descriptor = "(Z)LAJSSLSFA;")
