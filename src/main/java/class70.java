...
public class class70 extends class483 implements class530 {
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 4)
    public final IDirect3DBaseTexture method388(int arg0) {
        return arg0 == -18414 ? this.field838 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lhb;IZ[[I)V", line = 25)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILng;)V", line = 76)
