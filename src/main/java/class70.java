...
public class class70 extends class13 {
    ...
    @OriginalMember(owner = "client!YZDAHXEQ", name = "<init>", descriptor = "(LMNPBQFWE;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!YZDAHXEQ", name = "a", descriptor = "(IILTKCVVLIT;I)V")
