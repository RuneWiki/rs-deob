...
public class class70 extends class206 {
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(B)F")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "e", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!pv", name = "h", descriptor = "(I)J")
    ...
    @OriginalMember(owner = "client!pv", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILha;)Loia;")
    ...
    @OriginalMember(owner = "client!pv", name = "j", descriptor = "(I)D")
    ...
    @OriginalMember(owner = "client!pv", name = "k", descriptor = "(I)[Lqfa;")
