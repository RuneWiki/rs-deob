...
public class class70 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Laf;BLha;I)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(II)Lok;")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lda;IIZLin;ZIILha;BLha;I)Lkr;")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IIILha;IIBLin;)Lkr;")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lcw;IZLlm;Leq;Leq;)V")
