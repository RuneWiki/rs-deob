...
public class class70 extends class575 {
    ...
    @OriginalMember(owner = "client!mba", name = "n", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljga;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!mba", name = "h", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!mba", name = "E", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!mba", name = "k", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lgga;B)I", line = 148)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I[BIILpw;I)Laq;", line = 178)
    ...
    @OriginalMember(owner = "client!mba", name = "n", descriptor = "()V", line = 187)
    public final void method173() {
    }

    @OriginalMember(owner = "client!mba", name = "s", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLab;)V", line = 202)
    ...
    @OriginalMember(owner = "client!mba", name = "i", descriptor = "(Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(FFF)V", line = 244)
    public final void method201(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!mba", name = "D", descriptor = "()V", line = 249)
    ...
    @OriginalMember(owner = "client!mba", name = "t", descriptor = "()Z", line = 273)
    public final boolean method211() {
        return false;
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/lang/Object;ILjava/awt/Canvas;)V", line = 280)
    ...
    @OriginalMember(owner = "client!mba", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Lpe;Ljava/lang/Integer;)Loa;", line = 305)
    ...
    @OriginalMember(owner = "client!mba", name = "f", descriptor = "(Z)V", line = 409)
    ...
    @OriginalMember(owner = "client!mba", name = "n", descriptor = "(I)V", line = 420)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 431)
    public final void method219(Rectangle[] arg0, int arg1) throws class381 {
        this.method216();
    }

    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(II)V", line = 439)
    ...
    @OriginalMember(owner = "client!mba", name = "P", descriptor = "(I)V", line = 449)
    ...
    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(Z)F", line = 458)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IIILbm;)V", line = 472)
    ...
    @OriginalMember(owner = "client!mba", name = "j", descriptor = "(B)V", line = 485)
    ...
    @OriginalMember(owner = "client!mba", name = "K", descriptor = "(I)V", line = 522)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZZ)Lcu;", line = 540)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lgv;Z)I", line = 553)
    ...
    @OriginalMember(owner = "client!mba", name = "k", descriptor = "(B)V", line = 573)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IILjagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;I)Z", line = 585)
    ...
    @OriginalMember(owner = "client!mba", name = "g", descriptor = "(Z)V", line = 691)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(Z)V", line = 702)
    public final void method167(boolean arg0) {
    }

    @OriginalMember(owner = "client!mba", name = "D", descriptor = "(I)V", line = 706)
    public final void method162(int arg0) {
        this.field958.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(ZZ)Lui;", line = 713)
    ...
    @OriginalMember(owner = "client!mba", name = "l", descriptor = "(Z)V", line = 723)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/awt/Canvas;ZLjava/lang/Object;)V", line = 740)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lxa;Z)V", line = 748)
    public final void method234(class511 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IIZ[FILpw;II)Lqaa;", line = 751)
    ...
    @OriginalMember(owner = "client!mba", name = "f", descriptor = "()V", line = 761)
    public final void method194() {
    }

    @OriginalMember(owner = "client!mba", name = "A", descriptor = "()V", line = 764)
    public final void method205() {
        this.method3083(true, false);
        this.field958.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILbm;IIIILui;)V", line = 773)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLpw;Llj;)Z", line = 793)
    ...
    @OriginalMember(owner = "client!mba", name = "f", descriptor = "(I)V", line = 804)
    public final synchronized void method224(int arg0) {
        this.field938.method1936(-28275);
        super.method224(arg0);
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZLej;ZII)V", line = 814)
    ...
    @OriginalMember(owner = "client!mba", name = "t", descriptor = "(I)V", line = 863)
    ...
    @OriginalMember(owner = "client!mba", name = "p", descriptor = "(I)V", line = 874)
    ...
    @OriginalMember(owner = "client!mba", name = "V", descriptor = "(I)Z", line = 890)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I[IIIIZI)Lqaa;", line = 929)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "()V", line = 938)
    public final void method180() {
    }

    @OriginalMember(owner = "client!mba", name = "o", descriptor = "(I)V", line = 941)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lej;B)I", line = 948)
    ...
    @OriginalMember(owner = "client!mba", name = "l", descriptor = "(B)V", line = 973)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IIILlj;Lpw;)Lqaa;", line = 1004)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILrc;)V", line = 1014)
    ...
    @OriginalMember(owner = "client!mba", name = "J", descriptor = "(I)V", line = 1037)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "()Log;", line = 1048)
    ...
    @OriginalMember(owner = "client!mba", name = "k", descriptor = "(I)V", line = 1057)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IIIIIZ[BLpw;)Lqaa;", line = 1069)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/aaa;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lfn;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Lpe;I)V", line = 1078)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lpw;BLlj;)Z", line = 1128)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lbm;I)I", line = 1139)
    ...
    @OriginalMember(owner = "client!mba", name = "p", descriptor = "()Z", line = 1178)
    public final boolean method231() {
        return false;
    }

    @OriginalMember(owner = "client!mba", name = "E", descriptor = "(I)V", line = 1188)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILhj;)V", line = 1220)
    ...
    @OriginalMember(owner = "client!mba", name = "p", descriptor = "(B)V", line = 1231)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILcu;I)V", line = 1242)
    ...
    @OriginalMember(owner = "client!mba", name = "SA", descriptor = "()I", line = 1253)
    public final int method168() {
        return 0;
    }

    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(Ljava/lang/Object;ILjava/awt/Canvas;)V", line = 1260)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZLwq;)I", line = 1270)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(B)V", line = 1299)
    ...
    @OriginalMember(owner = "client!mba", name = "r", descriptor = "(I)V", line = 1335)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BZ)V", line = 1345)
    public final void method221(byte arg0, boolean arg1) {
        this.field958.method3713(161, arg1);
        int var3 = 67 % ((arg0 - 26) / 63);
    }

    @OriginalMember(owner = "client!mba", name = "l", descriptor = "()V", line = 1353)
    public final void method179() {
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BI[[IZ)Ltda;", line = 1356)
    ...
    @OriginalMember(owner = "client!mba", name = "h", descriptor = "(I)V", line = 1366)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZZILej;)V", line = 1378)
    ...
    @OriginalMember(owner = "client!mba", name = "KA", descriptor = "(IIII)[I", line = 1423)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLol;)V", line = 1465)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B[Led;)Lhj;", line = 1488)
    public final class150 method230(byte arg0, class560[] arg1) {
        return arg0 == -125 ? new dxVertexLayout(this, arg1) : (class150) null;
    }

    @OriginalMember(owner = "client!mba", name = "M", descriptor = "(I)V", line = 1500)
    ...
    @OriginalMember(owner = "client!mba", name = "e", descriptor = "(B)V", line = 1510)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IZ)Lwh;", line = 1521)
    ...
    @OriginalMember(owner = "client!mba", name = "G", descriptor = "(I)V", line = 1561)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lpw;ILlj;)I", line = 1596)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IIII)V", line = 1636)
    public final void method209(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLjava/awt/Canvas;)Ljava/lang/Object;", line = 1640)
    public final Object method170(byte arg0, Canvas arg1) {
        int var3 = 116 % ((arg0 + 7) / 61);
        return null;
    }

    @OriginalMember(owner = "client!mba", name = "o", descriptor = "()V", line = 1649)
    public final void method225() {
        this.field938.method1939(7622);
        super.method225();
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lkn;Lkn;FLkn;)Lkn;", line = 1657)
