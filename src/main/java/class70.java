...
public class class70 extends class104 {
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(III[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)[F", line = 28)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Ljava/util/Random;IB)I", line = 99)
    ...
    @OriginalMember(owner = "client!gj", name = "e", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(FF[FFFI)V", line = 156)
    ...
    @OriginalMember(owner = "client!gj", name = "i", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!gj", name = "h", descriptor = "(I)[F", line = 222)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lqa;B)V", line = 242)
    ...
    @OriginalMember(owner = "client!gj", name = "f", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II[Ljava/awt/Rectangle;)V", line = 278)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IBIFFIF)V", line = 299)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(III[I)V", line = 340)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lqa;)V", line = 355)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Laa;IIILcd;IZLjava/lang/String;IILvo;Lda;)V", line = 384)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "()V", line = 435)
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "()Lqa;", line = 471)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IILjava/lang/String;)V", line = 493)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III)V", line = 567)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III[I)V", line = 579)
    ...
    @OriginalMember(owner = "client!gj", name = "g", descriptor = "(I)V", line = 589)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "()V", line = 620)
    public class70() {
        try {
            this.method735();
        } catch (RuntimeException var2) {
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)V", line = 628)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "([I)V", line = 641)
