...
public class class70 extends class413 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILrr;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(Lrr;I)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZFLta;II)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZLvs;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrr;I)V")
