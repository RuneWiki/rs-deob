...
public class class70 implements class721 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BIII)Z", line = 13)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)Laca;", line = 37)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Leaa;Lcq;IIIIIII)V", line = 68)
