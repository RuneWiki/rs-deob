...
public class class70 extends class404 implements class147 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "e", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!kl", name = "j", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(FIFF)I", line = 48)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Loa;II)Lba;", line = 92)
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!kl", name = "h", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IILoa;)Lba;", line = 153)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Loa;ZBI)Lcda;", line = 168)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BLoa;)V", line = 213)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Loa;Llt;IIIIZIIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!kl", name = "d", descriptor = "(I)I", line = 269)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ILoa;)Lwc;", line = 281)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(BLoa;)V", line = 305)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IILoa;I)Z", line = 332)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Loa;B)Lac;", line = 354)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZLoa;)V", line = 368)
