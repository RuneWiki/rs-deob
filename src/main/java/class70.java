...
public class class70 extends class364 implements class171 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IILuo;)Lge;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILuo;IZ)Lcb;")
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Luo;Lnd;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIZ)Lhr;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Luo;II)Lge;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Luo;IIZ)Z")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lfe;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(Luo;B)Lkj;")
