...
public class class70 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BI)[B", line = 16)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILij;Ljava/lang/String;Z)Lep;", line = 75)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 123)
