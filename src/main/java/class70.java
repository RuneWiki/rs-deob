...
public class class70 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II[BB)Z", line = 21)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(ILpl;Lpl;I)V", line = 278)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I[BIZB)Z", line = 52)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BI)[B", line = 192)
