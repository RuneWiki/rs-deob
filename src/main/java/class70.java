...
public class class70 extends class159 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ZB)V", line = 49)
    ...
    @OriginalMember(owner = "client!lea", name = "c", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Ldw;Lcd;)V", line = 95)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lwu;II)V", line = 106)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIBI)I", line = 116)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ZII)V", line = 178)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(BZ)V", line = 307)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(JI)V", line = 318)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(I)V", line = 340)
