...
public class class70 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "()V", line = 3)
    private static final void method350() {
        field859 = 0;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "([III)V", line = 10)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Loj;[IIII[I[I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)V", line = 100)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Loj;[II)V", line = 184)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Loj;[II[I[I)V", line = 238)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)Z", line = 242)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "()V", line = 317)
