...
public class class70 {
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "g", descriptor = "LWIUIWDML;")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "L", descriptor = "LPKHWFJLM;")
    private static class43 field1688;

    @OriginalMember(owner = "client!YIBRLAQY", name = "f", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "k", descriptor = "[LYIBRLAQY;")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "a", descriptor = "(I)LYIBRLAQY;")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "a", descriptor = "(LPKHWFJLM;Z)V")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "b", descriptor = "(I)LYIBRLAQY;")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "a", descriptor = "(LTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "a", descriptor = "(II[II)LPSGMMDJS;")
    ...
    @OriginalMember(owner = "client!YIBRLAQY", name = "c", descriptor = "(I)LPSGMMDJS;")
