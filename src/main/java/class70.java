...
public class class70 implements Runnable {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILjava/lang/String;)Lh;", line = 9)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "()V", line = 159)
    public class70() {
        this.field1089.setDaemon(true);
        this.field1089.start();
    }

    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILmh;)V", line = 48)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILjava/lang/String;ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 62)
    ...
    @OriginalMember(owner = "client!wf", name = "run", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(I)V", line = 137)
