...
public class class70 implements class20 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)Lvj;", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IBIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lnha;Ljn;IIIIIII)V", line = 218)
