...
public class class70 extends class748 {
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IZI)Ldaa;", line = 33)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "()V", line = 46)
    public class70() {
        super(0, true);
    }

    @OriginalMember(owner = "client!no", name = "b", descriptor = "(II)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(II)[I", line = 111)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B[[I)V", line = 136)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IZLvj;)V", line = 190)
    ...
    @OriginalMember(owner = "client!no", name = "e", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(II)Z", line = 280)
