...
public class class70 extends class148 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILdh;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ra", name = "e", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 65)
    public class70() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)[I", line = 71)
