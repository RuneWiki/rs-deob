...
public class class70 {
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(II)Lvs;", line = 25)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lga;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(II)Lvr;", line = 127)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Liv;ILuu;Luu;Luu;)V", line = 182)
