...
public class class70 extends class337 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IBLuu;)V", line = 14)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(B)Z", line = 35)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(III)Z", line = 49)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(BII)Z", line = 122)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZI)V", line = 204)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(IBI)V", line = 221)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lmh;Lpda;)V", line = 235)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZII)V", line = 246)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BZ)V", line = 292)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILjava/lang/String;)I", line = 326)
