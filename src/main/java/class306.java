...
public class class306 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lcr;Lcr;II)Lww;", line = 4)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lcr;BLcr;ZI)Lww;", line = 41)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)I", line = 125)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(B)Z", line = 146)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lgb;Lqt;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 225)
