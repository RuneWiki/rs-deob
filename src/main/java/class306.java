...
public class class306 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZILaq;)V", line = 41)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 64)
