...
public class class306 extends class397 {
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "()V", line = 311)
    public class306() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I[IB)V", line = 49)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IBLae;)V", line = 209)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 357)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIBII)I", line = 403)
