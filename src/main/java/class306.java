...
public class class306 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "([IIIB)Lbu;", line = 3)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(III)Z", line = 52)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "([IIII)Lbu;", line = 80)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "([III)Lbu;", line = 120)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I[IZ)Lbu;", line = 148)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lsea;Lsea;)V", line = 180)
