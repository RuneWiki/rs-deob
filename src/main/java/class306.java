...
public class class306 implements Runnable {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II[FIIIIFIIF)V", line = 23)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)S", line = 79)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BI)I", line = 104)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IB)Lek;", line = 122)
    ...
    @OriginalMember(owner = "client!uj", name = "run", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lsf;Z)V", line = 236)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Ljava/lang/String;B)Ldi;", line = 251)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "()V", line = 291)
    public class306() {
        this.field4115.setDaemon(true);
        this.field4115.start();
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 280)
