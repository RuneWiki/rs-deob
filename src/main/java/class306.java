...
public class class306 implements class216 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ZB)V", line = 8)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(III)Z", line = 40)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Lsp;Lmf;)V", line = 94)
    public class306(class636 arg0, class423 arg1) {
        this.field4396 = arg0;
        this.field4402 = arg1;
    }

    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Lda;Ljava/lang/String;IIII)I", line = 109)
