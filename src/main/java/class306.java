...
public class class306 extends class45 {
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(I)Lur;", line = 49)
