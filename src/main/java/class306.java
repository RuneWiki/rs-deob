...
public class class306 extends class568 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Lgda;)Z")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Lgda;II)Lgga;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "([I)Ljg;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Lgda;I)Lgga;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "()V")
