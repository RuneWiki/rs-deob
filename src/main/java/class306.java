...
public class class306 extends class90 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lre;Z)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZLso;BLso;I)I")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILre;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILj;)V")
