...
public class class306 implements class316 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(I)V", line = 105)
    public class306(int arg0) {
        this.field4436 = arg0;
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(II)Z", line = 113)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)Lhv;", line = 144)
