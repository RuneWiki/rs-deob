...
public class class306 extends class313 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lkk;III)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILjg;)Lmm;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIILe;)Z")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BLap;)V")
