...
public class class306 extends class67 {
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lsf;Lkc;[Lgs;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(CIIIZLaa;II)V", line = 306)
    public final void method134(char arg0, int arg1, int arg2, int arg3, boolean arg4, class514 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!jfa", name = "fa", descriptor = "(CIIIZ)V", line = 309)
