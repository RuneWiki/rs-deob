...
public class class306 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lsd;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)Ljava/lang/String;", line = 135)
    ...
    @OriginalMember(owner = "client!lo", name = "toString", descriptor = "()Ljava/lang/String;", line = 179)
    public final String toString() {
        field4879++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 204)
