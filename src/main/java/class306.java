...
public class class306 extends class83 {
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Lvj;)V")
    public class306(class422 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pda", name = "a", descriptor = "([Lmc;BLvj;)Ldi;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Ltf;III)Lho;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IILav;)V")
