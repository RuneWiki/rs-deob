...
public abstract class class306 extends class204 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(I[Lam;)I", line = 8)
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "(B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!vea", name = "g", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lvj;IZLr;IIB)V", line = 43)
    ...
    @OriginalMember(owner = "client!vea", name = "f", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!vea", name = "j", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(IIIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!vea", name = "k", descriptor = "(I)V", line = 97)
