...
public class class306 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Lj;IIB)Z")
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IILj;I)V")
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Lj;III)V")
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Lvj;Lsi;)V")
