...
public class class306 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)Lrs;", line = 18)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lmp;ILla;)V", line = 93)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 84)
