...
public class class306 extends class328 {
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "()V", line = 189)
    public class306() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BILco;)V", line = 10)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(II)[[I", line = 77)
    ...
    @OriginalMember(owner = "client!tr", name = "f", descriptor = "(I)V", line = 175)
