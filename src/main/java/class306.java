...
public class class306 extends class47 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!hp", name = "f", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!hp", name = "g", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 114)
