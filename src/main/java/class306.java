...
public class class306 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILvp;II)V", line = 35)
