...
public class class306 extends class85 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZC)I", line = 5)
    ...
    @OriginalMember(owner = "client!nk", name = "d", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lbt;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(CB)I", line = 98)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IBLbt;)V", line = 131)
