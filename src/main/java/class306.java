...
public class class306 implements class268 {
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lhj;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "()V", line = 15)
    public final void method333() {
        this.field4200.field4607.glFramebufferRenderbufferEXT(36160, this.field4202, 36161, 0);
        this.field4202 = -1;
    }

    @OriginalMember(owner = "client!um", name = "b", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!um", name = "finalize", descriptor = "()V", line = 36)
