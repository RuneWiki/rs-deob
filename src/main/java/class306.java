...
public class class306 extends class632 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(IIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIB)V", line = 39)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IBI)V", line = 49)
