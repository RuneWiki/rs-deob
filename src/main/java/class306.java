...
public abstract class class306 extends class538 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILr;ILcaa;ZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I[Ltg;)I", line = 15)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(Z)Z", line = 37)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(Z)Z", line = 62)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(III)Z", line = 79)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(IIIII)V", line = 109)
