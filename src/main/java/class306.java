...
public class class306 extends class13 {
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BLnq;)V", line = 58)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "()V", line = 70)
    public class306() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZI)[I", line = 73)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lkh;BI)V", line = 160)
