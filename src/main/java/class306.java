...
public class class306 extends class634 {
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "()V", line = 164)
    public class306() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bv", name = "f", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(BI)[I", line = 52)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ILig;Z)V", line = 182)
