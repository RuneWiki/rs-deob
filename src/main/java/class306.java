...
public class class306 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)Lsj;", line = 24)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(III)V", line = 85)
