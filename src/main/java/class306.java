...
public class class306 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lvr;BLvg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lvg;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)Lvg;", line = 70)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Lvg;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)Lvg;", line = 110)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IBLtl;)V", line = 129)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)Lvg;", line = 160)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(I)Z", line = 181)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lvr;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(I)I", line = 216)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(I)Lvg;", line = 236)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!vr", name = "f", descriptor = "(I)Lvg;", line = 269)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "()V", line = 316)
    public class306() {
        this.field4498.field6803 = this.field4498;
        this.field4498.field6797 = this.field4498;
    }

    @OriginalMember(owner = "client!vr", name = "g", descriptor = "(I)Lbq;", line = 300)
