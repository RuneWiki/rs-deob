...
public class class306 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lfp;Lls;)Z")
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Lfp;Lls;)Z")
    public final boolean method2040(class9 arg0, class306 arg1) {
        return this.field4521 != null || this.method2038(arg0, arg1);
    }

    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lfp;IIIIII)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lfp;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Lfp;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(Lfp;Lls;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "(Lfp;Lls;)V")
