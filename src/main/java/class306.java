...
public abstract class class306 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[Lo;ILjava/lang/String;[IIILta;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;IZI)V", line = 159)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([II[Lo;ILjava/lang/String;III)V", line = 191)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[I[I[ILjava/lang/String;[Lo;Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[Lo;Ljava/lang/String;III[IIIILta;IIIIII)I", line = 381)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([Lo;I[IILjava/lang/String;ILjava/util/Random;IBI)I", line = 484)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;IIII[Lo;IILjava/util/Random;I[II[I)I", line = 523)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B)V", line = 603)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 617)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIBIIII)V", line = 658)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 716)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 736)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 750)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 776)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 850)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIBLjava/lang/String;III)V", line = 868)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lza;Lkt;)V", line = 902)
    public class306(class295 arg0, class61 arg1) {
        this.field4141 = arg1;
        this.field4148 = arg0;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lta;IIIIIIII[Lo;[IIILjava/lang/String;II)I", line = 913)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BILjava/lang/String;III)V", line = 934)
