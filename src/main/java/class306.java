...
public class class306 extends class337 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BI[II)V", line = 20)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II[II)V", line = 116)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(IIIIIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII)Z", line = 153)
