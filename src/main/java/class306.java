...
public class class306 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIZIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILha;Lhw;I)V", line = 168)
    ...
    @OriginalMember(owner = "client!ip", name = "toString", descriptor = "()Ljava/lang/String;", line = 491)
    public final String toString() {
        field4303++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 499)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZI)V", line = 514)
