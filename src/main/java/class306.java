...
public class class306 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BI)V", line = 10)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IZ)V", line = 48)
