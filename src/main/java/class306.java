...
public class class306 extends class334 {
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "()V", line = 63)
    public class306() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IZLol;)V", line = 18)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IZ)Lis;", line = 66)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ZI)[[I", line = 103)
    ...
    @OriginalMember(owner = "client!wia", name = "g", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(II)[I", line = 241)
