...
public class class306 extends class404 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 6)
    public class306() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!nq", name = "h", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)[I", line = 52)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(III)Z", line = 88)
