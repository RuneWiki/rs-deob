...
public class class24 extends class5 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIIIII[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZII)Z", line = 126)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZIIBZLjava/lang/String;IILjava/lang/String;JI)V", line = 137)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lub;)V", line = 164)
