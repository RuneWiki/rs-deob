...
public class class24 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)Lv;")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Ltq;II)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Ltq;IBI)V")
