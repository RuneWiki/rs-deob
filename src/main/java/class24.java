...
public class class24 implements class413 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lj;III[Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljd;JZ[I)Ljava/lang/String;", line = 264)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 299)
