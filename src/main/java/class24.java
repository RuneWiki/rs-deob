...
public class class24 extends class154 {
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BILjava/lang/String;)Lgd;", line = 21)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lbi;)V", line = 104)
    public class24(class508 arg0) {
        this.field485 = arg0;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 73)
