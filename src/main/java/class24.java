...
public class class24 extends class355 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lje;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lng;IIIBI)Ljava/awt/Frame;")
