...
public class class24 extends class195 {
    ...
    @OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)[Lqe;")
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lwh;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lwh;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lwh;II)V")
