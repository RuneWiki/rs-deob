...
public class class24 extends class260 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lem;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(II)V", line = 46)
    public class24(int arg0, int arg1) {
        this.field319 = arg0;
        this.field317 = arg1;
    }

    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)V", line = 58)
