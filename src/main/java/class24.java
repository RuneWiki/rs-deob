...
@OriginalClass("client!HWTUYSNT")
public class class24 {

    @OriginalMember(owner = "client!HWTUYSNT", name = "a", descriptor = "I")
    private int field857 = 1914;

    @OriginalMember(owner = "client!HWTUYSNT", name = "b", descriptor = "Z")
    private boolean field858 = false;

    @OriginalMember(owner = "client!HWTUYSNT", name = "c", descriptor = "I")
    private int field859;

    @OriginalMember(owner = "client!HWTUYSNT", name = "d", descriptor = "[LJJVWTXNE;")
    private class30[] field860;

    @OriginalMember(owner = "client!HWTUYSNT", name = "<init>", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!HWTUYSNT", name = "a", descriptor = "(J)LJJVWTXNE;")
    ...
    @OriginalMember(owner = "client!HWTUYSNT", name = "a", descriptor = "(IJLJJVWTXNE;)V")
