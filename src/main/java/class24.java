...
public class class24 implements class506 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IBLg;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lbi;IB)V", line = 63)
    ...
    @OriginalMember(owner = "client!wt", name = "e", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILfca;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(B)Lgu;", line = 160)
    ...
    @OriginalMember(owner = "client!wt", name = "finalize", descriptor = "()V", line = 174)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(B)V", line = 201)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lvj;)V", line = 419)
    ...
    @OriginalMember(owner = "client!wt", name = "f", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIILfca;)V", line = 249)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!wt", name = "e", descriptor = "(B)Z", line = 316)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II)V", line = 340)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)V", line = 356)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILg;I)V", line = 369)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(II)V", line = 380)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIII)V", line = 398)
