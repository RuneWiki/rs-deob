...
public class class24 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIZI)I")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BLee;)Led;")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILjb;)V")
