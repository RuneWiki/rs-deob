...
public class class24 extends class76 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "()V", line = 4)
    public final void method175() {
        this.field360 = true;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIII)V", line = 7)
    public final void method176(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field359 = arg0;
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "()Lhea;", line = 20)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;)V", line = 35)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class24(int arg0, boolean arg1) {
        this.method189(arg0, arg1);
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "([Lrf;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;[Lnha;Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "()V", line = 217)
    public static void method181() {
        field350 = null;
        field348 = null;
    }

    @OriginalMember(owner = "client!qo", name = "d", descriptor = "()V", line = 222)
    ...
    @OriginalMember(owner = "client!qo", name = "e", descriptor = "()V", line = 261)
    private final void method183() {
        this.field354 = false;
    }

    @OriginalMember(owner = "client!qo", name = "f", descriptor = "()Lhea;", line = 264)
    public final class443 method184() {
        return this.field362;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IZ)Lqo;", line = 270)
    ...
    @OriginalMember(owner = "client!qo", name = "g", descriptor = "()V", line = 283)
    public final void method186() {
        this.field354 = true;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;J)Z", line = 287)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(J)V", line = 336)
    public final void method188(long arg0) {
        this.field355 = arg0;
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(IZ)V", line = 339)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;J[Lnha;[Lrf;Z)V", line = 347)
