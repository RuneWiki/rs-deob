...
public class class24 extends class416 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILee;)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILvfa;I)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lee;B)V")
