...
public class class24 extends class694 {
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "()V", line = 4)
    public class24() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II[B)[B", line = 7)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II)[I", line = 19)
    ...
    @OriginalMember(owner = "client!fba", name = "i", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lpj;I)V", line = 51)
