...
public class class24 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BII[I)Lcj;", line = 4)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BI[I)Lcj;", line = 49)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "([IBII)Lcj;", line = 78)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Leq;Leq;)V", line = 200)
    public class24(class209 arg0, class209 arg1) {
        this.field306 = arg0;
        this.field305 = arg1;
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IZIILlda;Llda;Z)I", line = 120)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(BI[I)Lcj;", line = 155)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 176)
