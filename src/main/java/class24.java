...
@OriginalClass("client!JVQZOBJO")
public class class24 extends class54 {

    @OriginalMember(owner = "client!JVQZOBJO", name = "l", descriptor = "I")
    private int field955 = 49048;

    @OriginalMember(owner = "client!JVQZOBJO", name = "u", descriptor = "B")
    private byte field964 = -120;

    @OriginalMember(owner = "client!JVQZOBJO", name = "r", descriptor = "I")
    private int field961;

    @OriginalMember(owner = "client!JVQZOBJO", name = "s", descriptor = "I")
    private int field962;

    @OriginalMember(owner = "client!JVQZOBJO", name = "t", descriptor = "I")
    private int field963;

    @OriginalMember(owner = "client!JVQZOBJO", name = "m", descriptor = "I")
    private int field956;

    @OriginalMember(owner = "client!JVQZOBJO", name = "n", descriptor = "I")
    private int field957;

    @OriginalMember(owner = "client!JVQZOBJO", name = "o", descriptor = "I")
    private int field958;

    @OriginalMember(owner = "client!JVQZOBJO", name = "p", descriptor = "I")
    private int field959;

    @OriginalMember(owner = "client!JVQZOBJO", name = "z", descriptor = "LISUBRNPG;")
    private class20 field969;

    @OriginalMember(owner = "client!JVQZOBJO", name = "A", descriptor = "I")
    private int field970;

    @OriginalMember(owner = "client!JVQZOBJO", name = "v", descriptor = "I")
    private int field965;

    @OriginalMember(owner = "client!JVQZOBJO", name = "x", descriptor = "I")
    public int field967;

    @OriginalMember(owner = "client!JVQZOBJO", name = "y", descriptor = "I")
    public int field968;

    @OriginalMember(owner = "client!JVQZOBJO", name = "q", descriptor = "[I")
    public int[] field960;

    @OriginalMember(owner = "client!JVQZOBJO", name = "w", descriptor = "Lclient;")
    public static client field966;

    @OriginalMember(owner = "client!JVQZOBJO", name = "a", descriptor = "(B)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!JVQZOBJO", name = "<init>", descriptor = "(IZIIIIBIII)V")
    ...
    @OriginalMember(owner = "client!JVQZOBJO", name = "a", descriptor = "(I)LNNGZIOFO;")
