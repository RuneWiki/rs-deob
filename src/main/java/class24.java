...
public class class24 implements class233 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lcha;B)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)Lhm;")
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Ljava/lang/String;Leha;Loea;IIIIIIIIII)V")
