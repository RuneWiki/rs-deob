...
public abstract class class24 implements class364 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BILr;)Z")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljaggl/MapBuffer;ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z")
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lad;IZ)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
