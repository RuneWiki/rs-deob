...
public class class24 {
    ...
    @OriginalMember(owner = "client!HGKRJZKS", name = "e", descriptor = "LKTAHMSMP;")
    private class31 field863 = new class31();

    @OriginalMember(owner = "client!HGKRJZKS", name = "i", descriptor = "LLAPJVQGB;")
    ...
    @OriginalMember(owner = "client!HGKRJZKS", name = "h", descriptor = "LFXRMRSFD;")
    ...
    @OriginalMember(owner = "client!HGKRJZKS", name = "a", descriptor = "(J)LKTAHMSMP;")
    ...
    @OriginalMember(owner = "client!HGKRJZKS", name = "a", descriptor = "(IJLKTAHMSMP;)V")
