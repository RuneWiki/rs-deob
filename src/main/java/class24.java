...
public class class24 extends class436 {
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lnf;)V", line = 18)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "()Z", line = 75)
    public final boolean method159() {
        return true;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lme;)V", line = 78)
    public final void method160(class360 arg0) {
        this.field6402.method1669(arg0);
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(Z)V", line = 82)
    public final void method161(boolean arg0) {
        this.field6402.method1627(8448, 7681);
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)V", line = 85)
