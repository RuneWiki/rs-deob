...
public class class24 extends class440 {
    ...
    @OriginalMember(owner = "client!fba", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "()V", line = 31)
    public class24() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILmo;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IBILpu;)Llm;", line = 64)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILpu;B)Loq;", line = 82)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BI)[I", line = 108)
