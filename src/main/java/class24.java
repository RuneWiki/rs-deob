...
public class class24 extends class172 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(BLhia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(I)V", line = 14)
    public static void method101(int arg0) {
        field227 = null;
        int var1 = 97 % ((21 - arg0) / 40);
    }

    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ILgga;)V", line = 24)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(IIIIII)Z", line = 52)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ILns;Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Ljava/lang/String;IC)[Ljava/lang/String;", line = 415)
