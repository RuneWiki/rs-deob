...
public class class24 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lsk;Z)V")
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(B)Lsk;")
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I)Lsk;")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(BLij;)V")
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(I)Lsk;")
