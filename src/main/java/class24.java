...
public class class24 extends class139 implements class26 {
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lria;I)V")
    public final void method376(class287 arg0, int arg1) {
        super.method376(arg0, arg1);
    }

    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lbfa;Lwq;III[B)V")
