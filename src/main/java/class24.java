...
public class class24 extends class666 {
    ...
    @OriginalMember(owner = "client!fba", name = "e", descriptor = "(III)Z", line = 13)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIBII)V", line = 31)
    ...
    @OriginalMember(owner = "client!fba", name = "h", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BI)[I", line = 225)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!fba", name = "i", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "()V", line = 377)
    public class24() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fba", name = "d", descriptor = "(B)V", line = 290)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILiaa;Z)V", line = 305)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II)[I", line = 335)
