...
public class class24 extends class16 {
    ...
    @OriginalMember(owner = "client!LJAXEEYT", name = "sb", descriptor = "LDDJHHGTJ;")
    public class6 field987;

    @OriginalMember(owner = "client!LJAXEEYT", name = "a", descriptor = "(Z)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!LJAXEEYT", name = "a", descriptor = "(B)LOQIGXOFQ;")
