...
public class class24 {
    ...
    private int[] field849 = new int[256];

    @OriginalMember(owner = "client!KAZZDHJI", name = "c", descriptor = "[I")
    private int[] field848 = new int[256];
    ...
    public class24(int[] arg0, boolean arg1) {
        for (int var3 = 0; var3 < arg0.length; var3++) {
            this.field848[var3] = arg0[var3];
        }
        this.method243();
        if (!arg1) {
            this.field846 = 390;
    ...
    public final int method241() {
        ...
        return this.field848[this.field847];
    }

    @OriginalMember(owner = "client!KAZZDHJI", name = "b", descriptor = "()V")
    private final void method242() {
        this.field851 += ++this.field852;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field849[var1];
            if ((var1 & 0x3) == 0) {
                this.field850 ^= this.field850 << 13;
            } else if ((var1 & 0x3) == 1) {
                this.field850 ^= this.field850 >>> 6;
            } else if ((var1 & 0x3) == 2) {
                this.field850 ^= this.field850 << 2;
            } else if ((var1 & 0x3) == 3) {
                this.field850 ^= this.field850 >>> 16;
            }
            this.field850 += this.field849[var1 + 128 & 0xFF];
            int var3;
            this.field849[var1] = var3 = this.field849[var2 >> 2 & 0xFF] + this.field850 + this.field851;
            this.field848[var1] = this.field851 = this.field849[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }

    @OriginalMember(owner = "client!KAZZDHJI", name = "c", descriptor = "()V")
    private final void method243() {
        int var1 = -1640531527;
        int var2 = -1640531527;
        int var3 = -1640531527;
        int var4 = -1640531527;
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field848[var10] + var8;
            int var37 = this.field848[var10 + 1] + var7;
            int var38 = this.field848[var10 + 2] + var6;
            int var39 = this.field848[var10 + 3] + var5;
            int var40 = this.field848[var10 + 4] + var4;
            int var41 = this.field848[var10 + 5] + var3;
            int var42 = this.field848[var10 + 6] + var2;
            int var43 = this.field848[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field849[var10] = var8;
            this.field849[var10 + 1] = var7;
            this.field849[var10 + 2] = var6;
            this.field849[var10 + 3] = var5;
            this.field849[var10 + 4] = var4;
            this.field849[var10 + 5] = var3;
            this.field849[var10 + 6] = var2;
            this.field849[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field849[var11] + var8;
            int var13 = this.field849[var11 + 1] + var7;
            int var14 = this.field849[var11 + 2] + var6;
            int var15 = this.field849[var11 + 3] + var5;
            int var16 = this.field849[var11 + 4] + var4;
            int var17 = this.field849[var11 + 5] + var3;
            int var18 = this.field849[var11 + 6] + var2;
            int var19 = this.field849[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field849[var11] = var8;
            this.field849[var11 + 1] = var7;
            this.field849[var11 + 2] = var6;
            this.field849[var11 + 3] = var5;
            this.field849[var11 + 4] = var4;
            this.field849[var11 + 5] = var3;
            this.field849[var11 + 6] = var2;
            this.field849[var11 + 7] = var1;
        }
        this.method242();
        this.field847 = 256;
    }
