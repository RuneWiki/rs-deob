...
public class class24 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILvo;II)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)Ljc;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIILha;III)Lka;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILbo;)Ljava/lang/String;")
