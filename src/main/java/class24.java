...
public class class24 implements Runnable {
    ...
    @OriginalMember(owner = "client!KPIQNZMJ", name = "g", descriptor = "LDZXWUJSL;")
    ...
    @OriginalMember(owner = "client!KPIQNZMJ", name = "<init>", descriptor = "(BLjava/net/Socket;LDZXWUJSL;)V")
