...
public class class24 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IILtl;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lqa;I)Lf;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BLfb;)Z")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lqa;IZ)Lf;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILtl;)V")
