...
public class class24 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lqa;Lwt;)V", line = 16)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Lqa;Lwt;)Z", line = 100)
    public final boolean method106(class167 arg0, class24 arg1) {
        return this.field218 != null || this.method112(arg0, arg1);
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lqa;)V", line = 103)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "()V", line = 183)
    public static final void method108() {
        field214 = null;
        field220 = null;
    }

    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(Lqa;Lwt;)V", line = 191)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "()V", line = 288)
    public final void method110() {
        this.field218 = null;
    }

    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Lqa;)V", line = 291)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(Lqa;Lwt;)Z", line = 354)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIII)Z", line = 394)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lqa;IIIIII)V", line = 455)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
