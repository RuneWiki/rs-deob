...
public abstract class class24 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 12)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(III)V", line = 62)
