...
public class class24 extends class186 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BF)V", line = 5)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(FB)V", line = 19)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(I)V", line = 32)
