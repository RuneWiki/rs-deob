...
@OriginalClass("client!JCEXAOBP")
public class class24 {

    @OriginalMember(owner = "client!JCEXAOBP", name = "a", descriptor = "I")
    private int field859 = 7;

    @OriginalMember(owner = "client!JCEXAOBP", name = "b", descriptor = "LORGNKIAP;")
    public class40 field860 = new class40();

    @OriginalMember(owner = "client!JCEXAOBP", name = "c", descriptor = "LORGNKIAP;")
    private class40 field861;

    @OriginalMember(owner = "client!JCEXAOBP", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!JCEXAOBP", name = "a", descriptor = "(LORGNKIAP;)V")
    ...
    @OriginalMember(owner = "client!JCEXAOBP", name = "a", descriptor = "()LORGNKIAP;")
    ...
    @OriginalMember(owner = "client!JCEXAOBP", name = "a", descriptor = "(I)LORGNKIAP;")
    ...
    @OriginalMember(owner = "client!JCEXAOBP", name = "c", descriptor = "()I")
