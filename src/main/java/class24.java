...
public class class24 {
    ...
    @OriginalMember(owner = "client!JETHVCIV", name = "e", descriptor = "LHSUOZGYX;")
    private class20 field919 = new class20();

    @OriginalMember(owner = "client!JETHVCIV", name = "i", descriptor = "LXBBVJJRK;")
    ...
    @OriginalMember(owner = "client!JETHVCIV", name = "h", descriptor = "LZRDWHMTU;")
    ...
    @OriginalMember(owner = "client!JETHVCIV", name = "a", descriptor = "(J)LHSUOZGYX;")
    ...
    @OriginalMember(owner = "client!JETHVCIV", name = "a", descriptor = "(ILHSUOZGYX;J)V")
