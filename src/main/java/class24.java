...
public class class24 extends class530 {
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(ILah;)V", line = 7)
    public class24(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lah;)V", line = 10)
    public class24(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(Z)Z", line = 63)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(I)V", line = 100)
