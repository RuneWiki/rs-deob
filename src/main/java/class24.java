...
public class class24 extends class585 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILqfa;Ljava/lang/String;)Lmv;", line = 5)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 69)
    public class24() {
        super(0, true);
    }
}
