...
public class class24 extends class87 implements class278 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIILvk;IIZII[IIII[II)I")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lbn;B)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lkm;Lcj;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(Lkm;I)V")
