...
public class class24 extends class287 {
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(ILoj;)V", line = 11)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(ILoj;)Lmg;", line = 50)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mp", name = "g", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILoj;II)Z", line = 138)
