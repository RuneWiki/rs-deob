...
public class class24 extends class354 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIILqg;[I[I)Lop;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IILm;ILci;Ljava/awt/Canvas;)Lqa;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILti;I)V")
