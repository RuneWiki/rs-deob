...
public class class24 extends class298 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II[B[IIIIIIIILwe;II)I", line = 4)
    ...
    @OriginalMember(owner = "client!we", name = "e", descriptor = "()Z", line = 36)
    public final boolean method166() {
        return this.field362 < 0 || this.field362 >= ((class201) super.field4403).field2936.length << 8;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lhk;III)Lwe;", line = 40)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II[B[IIIIIIIILwe;II)I", line = 46)
    ...
    @OriginalMember(owner = "client!we", name = "f", descriptor = "()I", line = 79)
    public final synchronized int method169() {
        return this.field366 < 0 ? -1 : this.field366;
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II)V", line = 82)
    public final synchronized void method170(int arg0, int arg1) {
        this.method188(arg0, arg1, this.method169());
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II[B[IIIIIIILwe;II)I", line = 85)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II[B[IIIIIIIIIILwe;II)I", line = 111)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(II)I", line = 374)
    private static final int method174(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II[B[IIIIIIILwe;II)I", line = 377)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I[B[IIIIIIIIIILwe;)I", line = 403)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(I)V", line = 456)
    public final synchronized void method177(int arg0) {
        this.method193(arg0 << 6, this.method169());
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I[B[IIIIIIIIIILwe;)I", line = 461)
    ...
    @OriginalMember(owner = "client!we", name = "g", descriptor = "()Z", line = 515)
    public final boolean method179() {
        return this.field364 != 0;
    }

    @OriginalMember(owner = "client!we", name = "d", descriptor = "()I", line = 520)
    ...
    @OriginalMember(owner = "client!we", name = "h", descriptor = "()I", line = 533)
    public final synchronized int method181() {
        return this.field356 == Integer.MIN_VALUE ? 0 : this.field356;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "([IIIII)I", line = 536)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "()Lwm;", line = 591)
    public final class298 method183() {
        return null;
    }

    @OriginalMember(owner = "client!we", name = "e", descriptor = "(I)V", line = 595)
    public final synchronized void method184(int arg0) {
        this.field365 = arg0;
    }

    @OriginalMember(owner = "client!we", name = "c", descriptor = "()I", line = 601)
    public final int method185() {
        return this.field356 == 0 && this.field364 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!we", name = "c", descriptor = "(II[B[IIIIIIIILwe;II)I", line = 608)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "([III)V", line = 642)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(III)V", line = 877)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "([B[IIIIIIILwe;)I", line = 923)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(II[B[IIIIIIIILwe;II)I", line = 948)
    ...
    @OriginalMember(owner = "client!we", name = "i", descriptor = "()I", line = 981)
    public final synchronized int method191() {
        return this.field369 < 0 ? -this.field369 : this.field369;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "([B[IIIIIIIILwe;)I", line = 985)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(II)V", line = 1019)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Z)V", line = 1025)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I[B[IIIIIIIILwe;)I", line = 1035)
    ...
    @OriginalMember(owner = "client!we", name = "f", descriptor = "(I)V", line = 1074)
    ...
    @OriginalMember(owner = "client!we", name = "j", descriptor = "()Z", line = 1086)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II[B[IIIIIIIIIILwe;II)I", line = 1171)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "([IIIII)I", line = 1212)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "([B[IIIIIIILwe;)I", line = 1269)
    ...
    @OriginalMember(owner = "client!we", name = "k", descriptor = "()V", line = 1294)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lhk;II)Lwe;", line = 1306)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "([B[IIIIIIIILwe;)I", line = 1313)
    ...
    @OriginalMember(owner = "client!we", name = "l", descriptor = "()V", line = 1348)
    ...
    @OriginalMember(owner = "client!we", name = "e", descriptor = "(II)I", line = 1353)
    private static final int method205(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "()Lwm;", line = 1356)
    public final class298 method206() {
        return null;
    }

    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lhk;II)V", line = 1360)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lhk;III)V", line = 1371)
    ...
    @OriginalMember(owner = "client!we", name = "g", descriptor = "(I)V", line = 1383)
    ...
    @OriginalMember(owner = "client!we", name = "h", descriptor = "(I)V", line = 1429)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I[B[IIIIIIIILwe;)I", line = 1439)
    ...
    @OriginalMember(owner = "client!we", name = "i", descriptor = "(I)V", line = 1477)
