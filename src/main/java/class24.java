...
public class class24 extends class145 {
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "()V", line = 3)
    public class24() {
        super(0, true);
    }
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILrt;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZI)[I", line = 102)
    ...
    @OriginalMember(owner = "client!ir", name = "f", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)Ltp;", line = 337)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BLjava/lang/String;)Ljava/lang/String;", line = 353)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(B)V", line = 372)
