...
public class class24 {
    ...
    @OriginalMember(owner = "client!GLVFVUWP", name = "c", descriptor = "[LGLVFVUWP;")
    public static class24[] field802;

    @OriginalMember(owner = "client!GLVFVUWP", name = "a", descriptor = "(ILTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!GLVFVUWP", name = "a", descriptor = "(LEGCCHUZS;Z)V")
