...
public class class24 extends class539 implements class302 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZILr;I)Z")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILr;)Lda;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIZLr;)Lraa;")
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(ILr;)Lod;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BLr;)Lll;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILlr;Lsp;IIIBLpba;)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!fba", name = "i", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIZ)V")
