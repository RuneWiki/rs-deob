...
public class class24 extends class85 {
    ...
    @OriginalMember(owner = "client!cc", name = "eb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!cc", name = "gb", descriptor = "Lbg;")
    public static class18 field547;

    @OriginalMember(owner = "client!cc", name = "X", descriptor = "[[I")
    public static int[][] field538;

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lvg;BI)Llf;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILlf;Llf;ZLbg;I)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BILja;)V")
