...
public class class24 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(CILjava/lang/String;)I", line = 130)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 155)
