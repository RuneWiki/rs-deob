...
public class class24 extends class136 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lr;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fba", name = "d", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/Class;", line = 47)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Llj;IIII[BI)V", line = 103)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Llj;IIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IB)I", line = 119)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIIIIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(II)V", line = 168)
