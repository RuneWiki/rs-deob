...
public class class24 {
    ...
    @OriginalMember(owner = "client!JLTMYUOM", name = "e", descriptor = "LLMGYBGQR;")
    private class30 field868 = new class30();

    @OriginalMember(owner = "client!JLTMYUOM", name = "i", descriptor = "LRKSMLTCN;")
    ...
    @OriginalMember(owner = "client!JLTMYUOM", name = "h", descriptor = "LDKRLEWQI;")
    ...
    @OriginalMember(owner = "client!JLTMYUOM", name = "a", descriptor = "(J)LLMGYBGQR;")
    ...
    @OriginalMember(owner = "client!JLTMYUOM", name = "a", descriptor = "(IJLLMGYBGQR;)V")
