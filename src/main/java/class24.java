...
public class class24 extends class86 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(JZ)I", line = 54)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(ILsf;)V", line = 66)
    public class24(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Z)I", line = 70)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(BLlfa;ZZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lsf;)V", line = 159)
    public class24(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(B)V", line = 163)
    public static void method108(byte arg0) {
        int var1 = -110 % ((-56 - arg0) / 43);
        field209 = null;
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Ljava/lang/Object;III)[B", line = 172)
