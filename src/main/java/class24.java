...
public abstract class class24 extends class659 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZB)V", line = 25)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lst;I)V", line = 50)
