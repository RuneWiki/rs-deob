...
@OriginalClass("client!HZCWGKOF")
public class class24 {

    @OriginalMember(owner = "client!HZCWGKOF", name = "a", descriptor = "I")
    private int field811 = -683;

    @OriginalMember(owner = "client!HZCWGKOF", name = "h", descriptor = "I")
    public int field818 = -1;

    @OriginalMember(owner = "client!HZCWGKOF", name = "j", descriptor = "Z")
    public boolean field820 = false;

    @OriginalMember(owner = "client!HZCWGKOF", name = "k", descriptor = "I")
    public int field821 = 5;

    @OriginalMember(owner = "client!HZCWGKOF", name = "l", descriptor = "I")
    public int field822 = -1;

    @OriginalMember(owner = "client!HZCWGKOF", name = "m", descriptor = "I")
    public int field823 = -1;

    @OriginalMember(owner = "client!HZCWGKOF", name = "n", descriptor = "I")
    public int field824 = 99;

    @OriginalMember(owner = "client!HZCWGKOF", name = "o", descriptor = "I")
    public int field825 = -1;

    @OriginalMember(owner = "client!HZCWGKOF", name = "p", descriptor = "I")
    public int field826 = -1;

    @OriginalMember(owner = "client!HZCWGKOF", name = "q", descriptor = "I")
    public int field827 = 2;

    @OriginalMember(owner = "client!HZCWGKOF", name = "b", descriptor = "I")
    public static int field812;

    @OriginalMember(owner = "client!HZCWGKOF", name = "d", descriptor = "I")
    public int field814;

    @OriginalMember(owner = "client!HZCWGKOF", name = "r", descriptor = "I")
    public int field828;

    @OriginalMember(owner = "client!HZCWGKOF", name = "s", descriptor = "I")
    public static int field829;

    @OriginalMember(owner = "client!HZCWGKOF", name = "e", descriptor = "[I")
    public int[] field815;

    @OriginalMember(owner = "client!HZCWGKOF", name = "f", descriptor = "[I")
    public int[] field816;

    @OriginalMember(owner = "client!HZCWGKOF", name = "g", descriptor = "[I")
    private int[] field817;

    @OriginalMember(owner = "client!HZCWGKOF", name = "i", descriptor = "[I")
    public int[] field819;

    @OriginalMember(owner = "client!HZCWGKOF", name = "c", descriptor = "[LHZCWGKOF;")
    public static class24[] field813;

    @OriginalMember(owner = "client!HZCWGKOF", name = "a", descriptor = "(ZLXMRRKSSB;)V")
    ...
    @OriginalMember(owner = "client!HZCWGKOF", name = "a", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!HZCWGKOF", name = "a", descriptor = "(LXQPFGONL;I)V")
