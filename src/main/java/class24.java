...
public class class24 extends class383 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZLup;)V", line = 6)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIILkn;)V", line = 617)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 626)
    public class24() {
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 632)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(J)V", line = 645)
