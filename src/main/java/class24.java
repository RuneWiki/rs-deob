...
public class class24 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II)Lmba;", line = 68)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Lbs;ILpfa;)V", line = 117)
