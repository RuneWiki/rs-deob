...
public class class24 {
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "L", descriptor = "LEOJHVRZF;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "e", descriptor = "LUAWAYCTK;")
    private static class55 field833;

    @OriginalMember(owner = "client!JKAPIYZO", name = "I", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "G", descriptor = "[LJKAPIYZO;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "a", descriptor = "(ZI[II)LWEVRTBOZ;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "a", descriptor = "(I)LWEVRTBOZ;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "b", descriptor = "(I)LJKAPIYZO;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "a", descriptor = "(ILUAWAYCTK;)V")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "c", descriptor = "(I)LJKAPIYZO;")
    ...
    @OriginalMember(owner = "client!JKAPIYZO", name = "a", descriptor = "(LRVLWVPJQ;)V")
