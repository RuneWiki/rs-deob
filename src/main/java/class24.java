...
public class class24 implements class243 {
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)Luv;", line = 3)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(III)I", line = 14)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IZI)Z", line = 68)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ljn;Ljava/lang/String;)V", line = 99)
