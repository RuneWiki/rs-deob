...
public class class24 extends class335 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lge;BII)J", line = 3)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "()V", line = 892)
    public class24() {
        super(2, false);
    }

    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(I)V", line = 895)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZI)[I", line = 911)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IZ)[[I", line = 1155)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILio;I)V", line = 1472)
