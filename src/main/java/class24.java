...
public class class24 implements class30 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 8)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lol;IIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "([IIJI)Ljava/lang/String;", line = 103)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZB)V", line = 137)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 220)
