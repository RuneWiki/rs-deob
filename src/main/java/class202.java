...
public class class202 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLem;)I", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)I", line = 73)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Llr;Z)Z", line = 91)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!oe", name = "toString", descriptor = "()Ljava/lang/String;", line = 229)
    public final String toString() {
        field2396++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(II)V", line = 242)
