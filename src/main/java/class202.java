...
public class class202 implements class221 {
    ...
    @OriginalMember(owner = "client!gg", name = "finalize", descriptor = "()V", line = 10)
    protected final void finalize() throws Throwable {
        this.field3078.method1668(this.field3081);
        super.finalize();
    }

    @OriginalMember(owner = "client!gg", name = "c", descriptor = "()V", line = 16)
    public final void method1373() {
        this.field3078.field3648.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILhi;)V", line = 19)
    public final void method1374(int arg0, class41 arg1) {
        this.method1378(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILcd;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILcd;I)V", line = 44)
    public final void method1376(int arg0, class60 arg1, int arg2) {
        this.method1375(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILkf;)V", line = 48)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILhi;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lnm;)V", line = 104)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "()V", line = 114)
    public final void method1379() {
        this.field3078.field3648.glBindFramebufferEXT(36160, this.field3081);
    }

    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!gg", name = "d", descriptor = "()Z", line = 129)
    public final boolean method1381() {
        int var1 = this.field3078.field3648.glCheckFramebufferStatusEXT(36160);
        return var1 == 36053;
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "()I", line = 140)
