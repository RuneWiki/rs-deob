...
public class class202 extends class322 {
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(II)I", line = 33)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZB)V", line = 48)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)I", line = 112)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(B)Z", line = 133)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lch;)V", line = 149)
    public class202(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(Z)I", line = 152)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(ILch;)V", line = 166)
    public class202(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(II)V", line = 169)
