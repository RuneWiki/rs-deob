...
public class class202 extends class204 {
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(ILfs;)V", line = 6)
    public class202(int arg0, class607 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)I", line = 10)
    public final int method1300(byte arg0) {
        ++field2839;
        return arg0 != -98 ? 77 : super.field2852;
    }

    @OriginalMember(owner = "client!b", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lfs;)V", line = 48)
    public class202(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!b", name = "d", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)I", line = 63)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 91)
