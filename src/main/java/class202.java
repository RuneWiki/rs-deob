...
public class class202 implements Runnable {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!w", name = "e", descriptor = "[Lu;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIILlb;II)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILvg;II)V")
