...
public class class202 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III)Lhd;", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lle;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)Lle;", line = 41)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(I)V", line = 110)
    public class202(int arg0) {
        this.field2621 = arg0;
    }

    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(IIIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZ)V", line = 89)
