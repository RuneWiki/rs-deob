...
public class class202 implements class163 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)Lbaa;", line = 7)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 74)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)I", line = 97)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lbfa;Lbaa;Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)V", line = 112)
