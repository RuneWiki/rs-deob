...
public class class202 extends class331 {
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(ILts;)V")
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lts;)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BLha;)V")
