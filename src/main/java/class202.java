...
public class class202 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(B)V", line = 10)
    public static void method1231(byte arg0) {
        field2438 = null;
        int var1 = -76 / ((20 - arg0) / 45);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 21)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)V", line = 40)
