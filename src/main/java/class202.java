...
public abstract class class202 extends class352 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lwl;I)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILjava/net/Socket;I)Lhg;")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lza;IIILps;IZ)V")
