...
public class class202 extends class449 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I[[BLpg;)V", line = 20)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lae;II)Ljava/lang/String;", line = 187)
