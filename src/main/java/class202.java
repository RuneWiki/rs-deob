...
public class class202 extends class20 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(FFFFFFLgo;II)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IILgo;II)V")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lql;IIII)V")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lql;II[III)V")
