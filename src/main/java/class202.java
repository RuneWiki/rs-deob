...
public class class202 extends class391 implements class83 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lr;I)Lhr;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(Lr;I)Lifa;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIZLr;)Z")
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(Z)V")
