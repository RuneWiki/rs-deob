...
public class class202 extends class238 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IZ)Lhm;", line = 3)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Loa;[Ldg;Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "()V", line = 93)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "()V", line = 132)
    public final void method1232() {
        this.field2483 = true;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Loa;)V", line = 135)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "()Ltg;", line = 147)
    ...
    @OriginalMember(owner = "client!hm", name = "d", descriptor = "()V", line = 163)
    public static void method1235() {
        field2473 = null;
        field2470 = null;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Loa;J[Ldg;[Lhaa;Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(IZ)V", line = 175)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(J)V", line = 183)
    public final void method1238(long arg0) {
        this.field2472 = arg0;
    }

    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(IZ)V", line = 390)
    private class202(int arg0, boolean arg1) {
        this.method1237(arg0, arg1);
    }

    @OriginalMember(owner = "client!hm", name = "e", descriptor = "()V", line = 193)
    private final void method1239() {
        this.field2471 = false;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Loa;J)Z", line = 196)
    ...
    @OriginalMember(owner = "client!hm", name = "f", descriptor = "()Ltg;", line = 250)
    public final class211 method1241() {
        return this.field2482;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIII)V", line = 254)
    ...
    @OriginalMember(owner = "client!hm", name = "g", descriptor = "()V", line = 265)
    public final void method1243() {
        this.field2471 = true;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "([Lhaa;Z)V", line = 270)
