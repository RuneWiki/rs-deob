...
public class class202 extends class106 {
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZB)V", line = 26)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILih;)V", line = 85)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)Z", line = 99)
    public final boolean method348(int arg0) {
        ++field2953;
        return arg0 != -22884 ? true : true;
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!wt", name = "f", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lvj;Lpo;)V", line = 203)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IBI)V", line = 256)
