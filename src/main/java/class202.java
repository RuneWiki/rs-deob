...
public abstract class class202 extends class170 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(I)Z", line = 72)
