...
public class class202 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "()I", line = 4)
    public int method838() throws Exception {
        field2725++;
        return this.field2731;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 118)
    public void method837(Component arg0) throws Exception {
        field2711++;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BLpl;)V", line = 163)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "()V", line = 174)
    public void method840() throws Exception {
        field2724++;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lpl;IZ)V", line = 184)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)Z", line = 209)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(I)V", line = 351)
    public void method836(int arg0) throws Exception {
        field2707++;
    }

    @OriginalMember(owner = "client!po", name = "c", descriptor = "()V", line = 360)
    public void method839() {
        field2709++;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "([II)V", line = 369)
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "()V", line = 527)
    public void method835() throws Exception {
        field2723++;
    }

    @OriginalMember(owner = "client!po", name = "e", descriptor = "(I)V", line = 534)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)V", line = 555)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)V", line = 588)
