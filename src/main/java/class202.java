...
public abstract class class202 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIIII)Z", line = 122)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ZLjava/lang/String;I)V", line = 144)
