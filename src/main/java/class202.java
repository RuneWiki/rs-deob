...
public abstract class class202 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILcr;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lpc;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(B)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wt", name = "e", descriptor = "(B)V", line = 62)
