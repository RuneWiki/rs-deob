...
public class class202 extends class695 {
    ...
    @OriginalMember(owner = "client!iq", name = "f", descriptor = "(I)Lcg;")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lia;Lpe;Lbl;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lnm;ZI)V")
