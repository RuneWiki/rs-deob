...
public class class202 extends class262 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZLha;)V", line = 7)
    ...
    @OriginalMember(owner = "client!oe", name = "g", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(ILwu;I)V", line = 229)
    ...
    @OriginalMember(owner = "client!oe", name = "h", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!oe", name = "i", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "([BI)I", line = 280)
