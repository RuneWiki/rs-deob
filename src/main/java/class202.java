...
public class class202 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 40)
