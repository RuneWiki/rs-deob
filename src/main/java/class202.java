...
public class class202 extends class242 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ue", name = "d", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 62)
    public class202(Object arg0, int arg1) {
        super(arg1);
        this.field2801 = arg0;
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 70)
