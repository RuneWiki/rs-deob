...
public class class202 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILjava/lang/String;)V", line = 17)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Luv;III)V", line = 95)
