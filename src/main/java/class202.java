...
public class class202 extends class206 {
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rfa", name = "d", descriptor = "(I)J", line = 14)
    public final long method70(int arg0) {
        int var2 = -50 / ((30 - arg0) / 63);
        return this.field2711;
    }

    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(JI)I", line = 23)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I)J", line = 72)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)J", line = 90)
