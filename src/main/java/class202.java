...
public class class202 extends class70 implements class140 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)J", line = 3)
    public final long method305(int arg0) {
        ++field2848;
        return arg0 != -21337 ? -71L : 0L;
    }

    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BII[B)V", line = 31)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Ljj;I[BIZ)V", line = 43)
    public class202(class66 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field2847 = arg1;
    }

    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Z)I", line = 71)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(Z)I", line = 82)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BII)Z", line = 94)
