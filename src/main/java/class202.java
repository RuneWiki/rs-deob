...
public class class202 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B[B)[B", line = 51)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IZ)Z", line = 74)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)I", line = 111)
