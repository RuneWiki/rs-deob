...
public abstract class class202 extends class419 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BII)I", line = 5)
    ...
    @OriginalMember(owner = "client!uc", name = "e", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)Lhr;", line = 40)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 89)
