...
public abstract class class202 extends class654 {
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lpn;Z[[[BIB)Z", line = 19)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIII)I", line = 53)
    ...
    @OriginalMember(owner = "client!cu", name = "e", descriptor = "(I)V", line = 86)
