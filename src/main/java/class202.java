...
public class class202 extends class26 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lr;J)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lfp;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lfp;IIIIIIIIIIIZZ)V")
