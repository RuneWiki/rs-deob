...
public class class202 extends class214 {
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 110)
    public class202() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sa", name = "f", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IB)[I", line = 25)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILofa;I)V", line = 96)
