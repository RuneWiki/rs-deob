...
public class class202 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(III)Z", line = 38)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Z)V", line = 69)
