...
public class class202 extends class176 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIIIBI)V", line = 6)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Ldba;Lpa;IIIIIIIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(III)V", line = 229)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)Lib;", line = 255)
