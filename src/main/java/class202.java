...
public class class202 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(II)Ldj;", line = 100)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lnb;ILoh;Loh;)V", line = 195)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IBII[FI[FFIII)V", line = 143)
