...
public class class202 extends class179 {
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIBIIIII[Ltq;)V", line = 17)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "([B)V", line = 674)
