...
public class class202 extends class435 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(II)V", line = 50)
    public class202(int arg0, int arg1) {
        this.field2687 = arg1;
        this.field2684 = arg0;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(I)V", line = 72)
