...
public class class202 extends class21 {
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lnba;Ljava/lang/Object;I)V", line = 5)
    public class202(class314 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field3186 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 14)
    public final Object method139(boolean arg0) {
        return arg0 ? this.field3186.get() : (Object) null;
    }

    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(B)Z", line = 24)
