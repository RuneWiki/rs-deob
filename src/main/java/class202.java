...
public class class202 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Le;III)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILgp;Lwl;ZIILnb;Lta;Le;Lwm;ILio;)Lgn;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IILe;ILnb;IIILgp;Lwm;II)Lgn;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Z)[Lh;")
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(III)Lda;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IZLak;Lgp;Le;Lnb;IIIIZILnb;Lwl;Lio;Lwm;Lta;[Lbg;I)Lgn;")
