...
public class class202 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!hm", name = "toString", descriptor = "()Ljava/lang/String;", line = 37)
    public final String toString() {
        field2853++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 48)
