...
public class class202 extends class365 {
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lbc;Ljava/lang/Object;)V", line = 14)
    public class202(class103 arg0, Object arg1) {
        super(arg0);
        this.field2796 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(B)Z", line = 24)
