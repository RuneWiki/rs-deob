...
public class class202 extends class728 {
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(B)F", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IZ)I", line = 14)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 26)
    public class202(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IC)Z", line = 30)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Z)F", line = 91)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)V", line = 587)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 612)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 624)
    ...
    @OriginalMember(owner = "client!kk", name = "e", descriptor = "(B)Ljava/lang/String;", line = 696)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(I)Ljava/lang/String;", line = 719)
