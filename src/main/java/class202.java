...
public class class202 extends class56 {
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "()V", line = 3)
    public class202() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BILes;)V", line = 113)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLes;)Lin;", line = 157)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 187)
