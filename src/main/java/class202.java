...
public class class202 extends class17 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lwm;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "()V", line = 75)
    public class202() {
        super(0, false);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IB)[[I", line = 81)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!vt", name = "e", descriptor = "(I)I", line = 170)
    ...
    @OriginalMember(owner = "client!vt", name = "h", descriptor = "(I)Z", line = 181)
