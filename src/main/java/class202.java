...
public class class202 extends class117 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Llk;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(CI)I", line = 28)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILlk;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(IIII)I", line = 158)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IC)I", line = 175)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIZLfc;III)V", line = 235)
