...
public class class346 extends class114 {
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(B)[Lpa;")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IILdq;III)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(B)V")
