...
public class class346 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIILpe;)Lsga;", line = 47)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(FFFII)F", line = 72)
