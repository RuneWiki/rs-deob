...
public class class346 extends class45 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZB)V", line = 23)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Liv;B)Lvq;", line = 33)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lfd;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILkj;Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(III)V", line = 165)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(III)V", line = 176)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIII)V", line = 193)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)Z", line = 225)
