...
public class class346 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II[BZ)I", line = 15)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)J", line = 50)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)Ljava/io/File;", line = 60)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([BIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!ve", name = "finalize", descriptor = "()V", line = 90)
