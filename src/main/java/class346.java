...
public class class346 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 3)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILjava/lang/Object;)[B", line = 24)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILmc;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ljd;ZLji;)Llba;", line = 73)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lji;I)V", line = 125)
