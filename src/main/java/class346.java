...
public class class346 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)Lac;", line = 8)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lmj;IILha;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)Lac;", line = 53)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 131)
    public class346() {
    }

    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lqr;)V", line = 137)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IILmj;B)V", line = 101)
