...
public class class346 {
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lpf;Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 250)
