...
public class class346 extends class333 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "()V", line = 21)
    public class346() {
    }

    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(J)V", line = 24)
    public class346(long arg0) {
        this.field4649 = arg0;
    }

    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(II)V", line = 32)
