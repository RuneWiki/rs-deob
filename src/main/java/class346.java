...
public class class346 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILsd;)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "([Ljd;I)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILsd;I)V")
