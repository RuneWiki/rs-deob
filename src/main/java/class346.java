...
public class class346 {
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)Lqt;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILqt;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(I)Lqt;")
