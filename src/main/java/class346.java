...
public class class346 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)Ljga;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZLjga;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljga;B)V")
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)Ljga;")
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)Ljga;")
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(B)Ljga;")
