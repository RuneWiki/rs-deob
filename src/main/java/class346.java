...
public class class346 extends class393 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbv;IIII[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbv;IIIIIZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILic;)V", line = 40)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbv;IIIII[BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbv;IIIIZ[BI)V", line = 105)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILqa;)Z", line = 126)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 535)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbv;IIIIIIZ)V", line = 560)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbv;IIIZ[I)V", line = 576)
