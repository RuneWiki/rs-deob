...
public class class346 extends class456 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "([[[Lke;I)V")
    ...
    @OriginalMember(owner = "client!ue", name = "i", descriptor = "(I)[Lj;")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IBLre;)V")
