...
public class class346 implements class267 {
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(II)Lhia;")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IB)Lhv;")
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Lla;Lla;Lla;)V")
