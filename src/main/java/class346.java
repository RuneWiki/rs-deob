...
public class class346 extends class31 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lgk;IIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lgk;IIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lgk;IIIIZ[IZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "([IIIIIIBZI)V", line = 122)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lmv;[I[I[IB)V", line = 174)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIII[BZIIII)V", line = 271)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIILjava/lang/Class;)Loh;", line = 328)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(Z)V", line = 352)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lgk;IIIIZ[BIZ)V", line = 386)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lgk;IIIIZ[FI)V", line = 445)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZBZ)V", line = 472)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)V", line = 490)
