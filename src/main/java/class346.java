...
public class class346 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIILje;Lje;)V", line = 11)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)Lds;", line = 27)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lds;B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)Lds;", line = 73)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IZIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)Lds;", line = 163)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "()V", line = 233)
    public class346() {
        this.field4982.field2961 = this.field4982;
        this.field4982.field2958 = this.field4982;
    }

    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(B)I", line = 213)
