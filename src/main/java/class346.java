...
public class class346 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(II)I", line = 3)
    public static final int method2236(int arg0, int arg1) {
        field4871++;
        return arg0 == 26922 ? arg1 >>> 7 : -90;
    }

    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lee;IB)V", line = 15)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILee;IB)V", line = 43)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILkba;Lmga;)V", line = 97)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Z)I", line = 169)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)V", line = 366)
