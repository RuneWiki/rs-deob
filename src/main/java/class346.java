...
public class class346 implements Runnable {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II[BLnr;)Lie;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lnr;II)Lie;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lnr;BI)Lie;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZLie;)V")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lew;)V")
