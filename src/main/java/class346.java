...
public class class346 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILjp;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILjp;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lda;)V", line = 84)
