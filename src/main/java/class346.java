...
public class class346 extends class424 {
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(I)V", line = 4)
    private class346(int arg0) {
        super(0, false);
        this.method2097(arg0, 65280);
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lrg;BI)V", line = 13)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZ)[[I", line = 43)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I[BZIILjava/lang/String;)I", line = 81)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(II)V", line = 217)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 231)
    public class346() {
        this(0);
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIB)V", line = 235)
    ...
    @OriginalMember(owner = "client!hb", name = "g", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(Z)V", line = 281)
