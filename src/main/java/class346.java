...
public class class346 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lmu;B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 66)
