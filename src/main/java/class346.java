...
public class class346 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BLsca;[[B)V", line = 45)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)Lsi;", line = 127)
