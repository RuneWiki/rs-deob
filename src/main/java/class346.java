...
public class class346 extends class604 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lhk;IIZ)V")
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lhk;IIII)V")
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lhk;II[III)V")
