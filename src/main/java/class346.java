...
public class class346 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lpd;IBIIILha;I)Lka;", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIIIILha;)V", line = 15)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IILs;IZILpd;IILs;IILha;)Lka;", line = 160)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIILha;IBIILpd;Ls;Ls;IZB)Lka;", line = 173)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)V", line = 298)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lha;ZIIIILpd;)Lka;", line = 308)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILgga;I)V", line = 338)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILgga;)V", line = 461)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 482)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(III)Z", line = 500)
