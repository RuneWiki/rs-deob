...
public abstract class class346 extends class418 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIIZFII)[I", line = 72)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(III)V", line = 125)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(II)[I", line = 179)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(Z)I", line = 197)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(III)[[I", line = 215)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(B)V", line = 255)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lfb;ZI)V", line = 267)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(B)I", line = 278)
    public int method1760(byte arg0) {
        field5158++;
        return arg0 < 19 ? -40 : -1;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BII)[I", line = 290)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(II)[[I", line = 314)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(IZ)V", line = 325)
