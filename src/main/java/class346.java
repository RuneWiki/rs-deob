...
public class class346 extends class206 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "()V", line = 4)
    public final void method2862() {
        this.field5377 = null;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lla;II)Lhp;", line = 10)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lib;)V", line = 20)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "()V", line = 501)
