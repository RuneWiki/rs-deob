...
public abstract class class346 extends class431 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Luq;ILuq;)V", line = 75)
