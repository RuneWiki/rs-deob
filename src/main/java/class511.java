...
public class class511 extends class539 implements class310 {
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Loa;Lpg;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(Loa;I)Lqt;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IILoa;Z)Lm;")
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(Loa;B)V")
