...
public class class511 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lwn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(II)V", line = 211)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IBIIIILme;Lha;)Lcw;", line = 230)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZIIILme;ZLda;Lha;ILha;IZ)Lcw;", line = 250)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)V", line = 325)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IBILjava/awt/Canvas;)Lsfa;", line = 340)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)V", line = 384)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(II)V", line = 399)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BZ)V", line = 412)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IB)Lbj;", line = 430)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)V", line = 515)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lwj;IZLdda;Lwu;Lwu;)V", line = 566)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(I)V", line = 532)
