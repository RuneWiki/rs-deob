...
public class class511 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(FIFF)F", line = 3)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BLjava/lang/String;[Lxa;I)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IZ)I", line = 141)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "([Lxa;Ljava/lang/String;B)I", line = 153)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(II[Lxa;Ljava/lang/String;I)I", line = 276)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Ljava/lang/String;B[Lxa;I)I", line = 297)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z)V", line = 325)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILjava/lang/String;I[Lxa;)I", line = 367)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)Z", line = 379)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ZIC)I", line = 420)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z[I[Ljava/lang/String;[Lxa;Ljava/lang/String;)I", line = 435)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 697)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "([B)V", line = 715)
