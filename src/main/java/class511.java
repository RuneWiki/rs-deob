...
public abstract class class511 extends class295 {
    ...
    @OriginalMember(owner = "client!cba", name = "i", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ZLsea;IIJIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!cba", name = "h", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!cba", name = "f", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "([Ltw;I)I", line = 64)
    ...
    @OriginalMember(owner = "client!cba", name = "g", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lvv;IIZLr;II)V", line = 87)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(IIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)V", line = 129)
