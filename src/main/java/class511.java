...
public class class511 extends class583 {
    ...
    @OriginalMember(owner = "client!jq", name = "d", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIIIII[II[ILuu;IZ)I", line = 51)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIB)Z", line = 227)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lok;Lur;)V", line = 241)
