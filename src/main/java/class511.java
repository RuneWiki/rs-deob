...
public class class511 extends class739 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "([III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 458)
    public class511() {
        super(0, true);
    }
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lsl;IB)V", line = 301)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZI)[I", line = 395)
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)V", line = 419)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BLjava/lang/String;)V", line = 469)
