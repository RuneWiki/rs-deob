...
public class class511 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 143)
