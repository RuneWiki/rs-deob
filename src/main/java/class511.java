...
public class class511 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Ljava/lang/String;ILdt;)I", line = 6)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 25)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IIIBI)V", line = 38)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(B)V", line = 74)
