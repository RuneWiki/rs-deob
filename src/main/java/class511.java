...
public class class511 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lqj;I)Z")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lrg;)V")
