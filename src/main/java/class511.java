...
public class class511 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ldk;B)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)Ldk;")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Loea;ILaa;IILjava/lang/String;ILda;ILat;II)V")
