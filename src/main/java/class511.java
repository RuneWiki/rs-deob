...
public class class511 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Z)Lvu;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)Lvu;")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lib;)V")
