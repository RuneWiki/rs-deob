...
public class class511 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IB)V", line = 25)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZIIZ)I", line = 55)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZI)V", line = 99)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(ZI)V", line = 115)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(II)Ljl;", line = 180)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lcr;IZLla;Lla;)V", line = 304)
