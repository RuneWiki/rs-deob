...
public class class511 extends class17 {
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lu", name = "h", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljd;B)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "()V", line = 70)
    public class511() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)[I", line = 73)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIII)V", line = 95)
