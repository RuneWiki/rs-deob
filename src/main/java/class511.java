...
public class class511 extends class435 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILfo;)V", line = 17)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Z[II)V", line = 47)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BI)V", line = 185)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIFI)V", line = 209)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IB)V", line = 325)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B)V", line = 338)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lsp;IIIII)V", line = 354)
