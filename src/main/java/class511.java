...
public abstract class class511 extends class654 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILr;Lkt;Lvca;)V", line = 23)
    ...
    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(Z)V", line = 192)
