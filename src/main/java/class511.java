...
public class class511 extends class463 implements class55 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lqa;I)Lip;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lqa;Lpk;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lqa;III)Z")
