...
public class class511 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)V", line = 29)
