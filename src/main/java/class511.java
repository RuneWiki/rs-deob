...
public class class511 extends class150 {
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lkp;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Z)V", line = 58)
