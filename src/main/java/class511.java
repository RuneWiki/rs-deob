...
public class class511 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lqa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lgk;)V", line = 94)
