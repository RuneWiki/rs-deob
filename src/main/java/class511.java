...
public class class511 extends class84 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IBB)V", line = 6)
    ...
    @OriginalMember(owner = "client!si", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIII)[B", line = 32)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)V", line = 45)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(IIII)I", line = 60)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "()V", line = 84)
    public class511() {
