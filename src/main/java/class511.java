...
public class class511 extends class120 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BLjava/lang/Object;Z)[B", line = 6)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!uca", name = "e", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)Lhs;", line = 107)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(II)Luw;", line = 118)
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Lkda;Lcu;IIIIIIIIIIIII)V", line = 152)
