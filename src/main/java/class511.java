...
public class class511 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Lsn;", line = 20)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)V", line = 141)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)Z", line = 156)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)[Lck;", line = 179)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 196)
