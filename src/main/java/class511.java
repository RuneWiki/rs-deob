...
public class class511 extends class241 {
    ...
    @OriginalMember(owner = "client!ms", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 7)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIB)V", line = 18)
    ...
    @OriginalMember(owner = "client!ms", name = "i", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lwg;I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ms", name = "h", descriptor = "(I)Z", line = 185)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I[BIIBLjava/lang/String;)I", line = 220)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(B)V", line = 360)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 385)
