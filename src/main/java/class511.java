...
public class class511 {
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "()V", line = 3)
    public class511() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)[Llp;", line = 10)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([SZ)[S", line = 69)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BLdga;[B)V", line = 91)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IZI)I", line = 233)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(III)V", line = 256)
