...
public class class511 extends class354 {
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(BI)[I", line = 23)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "()V", line = 86)
    public class511() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(III)Z", line = 89)
    ...
    @OriginalMember(owner = "client!lu", name = "g", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!lu", name = "h", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lnj;II)V", line = 160)
