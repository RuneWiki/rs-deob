...
public class class511 extends class54 {
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(I)V", line = 44)
    public class511(int arg0) {
        this.field7462 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(B)V", line = 53)
