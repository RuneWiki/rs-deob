...
public abstract class class511 extends class496 {
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IILwca;Lqa;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)I", line = 327)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)Z", line = 339)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "([I[IILlk;[I)V", line = 352)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(III)Z", line = 451)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)Z", line = 465)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Los;)V", line = 474)
    public class511(class468 arg0) {
        this.field7589 = arg0;
    }

    @OriginalMember(owner = "client!hq", name = "g", descriptor = "(I)V", line = 487)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lfba;", line = 504)
