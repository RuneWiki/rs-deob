...
public class class511 extends class512 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IFIFFII)V", line = 5)
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(I)[F", line = 40)
    ...
    @OriginalMember(owner = "client!sh", name = "wa", descriptor = "([I)V", line = 64)
    ...
    @OriginalMember(owner = "client!sh", name = "K", descriptor = "(III[I)V", line = 84)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Z)[F", line = 94)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([BFIFIIILp;IFFIF)V", line = 119)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lza;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!sh", name = "ea", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!sh", name = "ca", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZLc;)V", line = 205)
    ...
    @OriginalMember(owner = "client!sh", name = "YA", descriptor = "(IIIIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!sh", name = "v", descriptor = "()V", line = 280)
    ...
    @OriginalMember(owner = "client!sh", name = "g", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!sh", name = "A", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III[I)V", line = 320)
    ...
    @OriginalMember(owner = "client!sh", name = "W", descriptor = "(III)V", line = 332)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "()Lc;", line = 342)
    ...
    @OriginalMember(owner = "client!sh", name = "EA", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!sh", name = "ha", descriptor = "(Lc;)V", line = 400)
    ...
    @OriginalMember(owner = "client!sh", name = "U", descriptor = "(III)V", line = 421)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 433)
    public class511() {
        this.method954();
    }
}
