...
public class class511 extends class54 {
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lhia;)V", line = 14)
    public class511(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(IB)I", line = 18)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(Z)I", line = 40)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(Z)I", line = 83)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(ILhia;)V", line = 96)
