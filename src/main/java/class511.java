...
public class class511 extends class156 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI)I", line = 8)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)I", line = 20)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)[B", line = 35)
    ...
    @OriginalMember(owner = "client!gq", name = "h", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILha;III)Lka;", line = 67)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(Ljava/lang/String;I)V", line = 115)
