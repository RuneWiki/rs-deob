...
public class class511 implements class637 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)Lhda;")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lfl;B)[Lqca;")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IZLni;Ljava/lang/String;)Lwf;")
    ...
    @OriginalMember(owner = "client!dk", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(ILee;Lhaa;IIIIIIIZ)V")
