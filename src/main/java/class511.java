...
public class class511 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IBI)Z", line = 225)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIIIII)V", line = 250)
