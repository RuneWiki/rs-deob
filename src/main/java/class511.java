...
public class class511 extends class416 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(JI)I", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)J", line = 35)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(I)J", line = 78)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)J", line = 115)
