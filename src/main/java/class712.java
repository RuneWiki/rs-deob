...
public class class712 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(IILmv;ILsba;IBLjava/lang/String;Laa;IILda;)V", line = 4)
    ...
    @OriginalMember(owner = "client!lga", name = "toString", descriptor = "()Ljava/lang/String;", line = 57)
    public final String toString() {
        field9943++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(II)V", line = 81)
