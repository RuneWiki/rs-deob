...
public abstract class class712 extends class241 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIIBI)V", line = 15)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(II)I", line = 160)
    public static int method4000(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(III)Z", line = 173)
