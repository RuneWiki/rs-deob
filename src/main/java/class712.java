...
public class class712 extends class497 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILqo;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lpp;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(ILpp;)V")
