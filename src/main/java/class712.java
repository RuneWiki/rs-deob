...
public abstract class class712 implements class594 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(FFFFIILaa;II)V")
