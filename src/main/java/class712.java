...
public abstract class class712 extends class61 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B[Lkp;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ar", name = "g", descriptor = "(I)Z", line = 176)
    ...
    @OriginalMember(owner = "client!ar", name = "e", descriptor = "(B)V", line = 221)
    ...
    @OriginalMember(owner = "client!ar", name = "f", descriptor = "(B)V", line = 232)
    public static void method4034(byte arg0) {
        int var1 = -127 % ((arg0 - 69) / 46);
        field9996 = null;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lha;B)Z", line = 245)
    ...
    @OriginalMember(owner = "client!ar", name = "h", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 293)
