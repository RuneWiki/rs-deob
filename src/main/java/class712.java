...
public class class712 extends Canvas {
    ...
    @OriginalMember(owner = "client!vha", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 8)
    public final void update(Graphics arg0) {
        this.field9722.update(arg0);
        field9723++;
    }

    @OriginalMember(owner = "client!vha", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 19)
    public final void paint(Graphics arg0) {
        this.field9722.paint(arg0);
        field9721++;
    }

    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 26)
    public class712(Component arg0) {
        this.field9722 = arg0;
    }

    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(I)V", line = 38)
