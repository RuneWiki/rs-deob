...
public class class712 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IFFFZ)F", line = 11)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(III)Lnu;", line = 37)
