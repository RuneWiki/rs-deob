...
public class class712 extends class378 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "()Leh;")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Leh;B)V")
    ...
    @OriginalMember(owner = "client!vha", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Leh;)V")
