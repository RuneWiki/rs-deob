...
public class class712 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lvv;Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ZIIZI)I", line = 140)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 196)
