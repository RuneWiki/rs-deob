...
public class class712 extends class155 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIB)V", line = 88)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(IIIIIII)V", line = 111)
