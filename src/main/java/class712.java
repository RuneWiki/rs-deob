...
public class class712 extends class573 implements class457 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lha;BI)Lka;")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(BILha;I)Z")
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!mga", name = "d", descriptor = "(ILha;)Lwg;")
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(Lha;I)Ljk;")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ZILha;I)Lok;")
