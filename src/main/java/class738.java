...
public class class738 extends class556 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!ge", name = "f", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!ge", name = "g", descriptor = "(I)I", line = 44)
    public final int method2733(int arg0) {
        field10184++;
        return arg0 == 0 ? this.field10191 : 84;
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I[I[[BBI[I[[B[B)I", line = 61)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)J", line = 120)
