...
public class class738 extends class403 {
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(FLmu;Lmu;Z)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljava/lang/String;IILkv;)Liu;", line = 232)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Lkv;I)V", line = 256)
    public class738(class280 arg0, int arg1) {
        this.field10302 = arg0;
        this.field10296 = new class314(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z[Ljava/lang/String;)V", line = 265)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(I)Lmu;", line = 316)
