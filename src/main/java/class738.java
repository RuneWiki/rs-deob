...
public class class738 extends class111 {
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 3)
    public class738(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ltd;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 101)
