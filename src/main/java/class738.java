...
public abstract class class738 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)[Lhe;", line = 4)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lew;Z)I", line = 30)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(III)V", line = 66)
