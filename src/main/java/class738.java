...
public class class738 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)Luaa;", line = 14)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BJ)Lkh;", line = 39)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(JLkh;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)Lkh;", line = 101)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III)V", line = 133)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(I)V", line = 181)
