...
public class class738 extends class122 implements class408 {
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Lqfa;I[BI)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lwn;Z)I")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IIIIBIIII)V")
