...
public class class738 extends class114 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III)I", line = 108)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Ljc;I)V", line = 161)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)Z", line = 184)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILwfa;)V", line = 195)
