...
public abstract class class738 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Loda;Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(B)V", line = 125)
