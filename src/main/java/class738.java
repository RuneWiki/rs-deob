...
public class class738 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(BI)Lic;", line = 36)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IZLin;I)Ldfa;", line = 81)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(I)V", line = 146)
    public static void method4061(int arg0) {
        field9929 = null;
        int var1 = -65 / ((arg0 + 58) / 57);
    }

    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lsj;ILin;Lin;)V", line = 159)
