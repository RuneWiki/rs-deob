...
public class class391 extends class645 implements class60 {
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lmba;Lkca;Lwq;II)V")
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lmba;Lkca;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Lkca;[BIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lmba;Lkca;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lmba;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIILkca;IB[FI)V")
