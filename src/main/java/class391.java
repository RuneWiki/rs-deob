...
public class class391 implements Runnable {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ljb;IB)Lhu;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILjb;B)Lhu;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "([BIBLjb;)Lhu;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lhu;B)V")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lhs;)V")
