...
public class class391 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BLvi;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lii;I)V")
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(B)Lii;")
