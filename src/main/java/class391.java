...
public abstract class class391 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIBI)V", line = 84)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIIZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!pe", name = "h", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(IIIIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIZII)V", line = 220)
    ...
    @OriginalMember(owner = "client!pe", name = "finalize", descriptor = "()V", line = 243)
