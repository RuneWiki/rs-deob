...
public class class391 extends class232 {
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lwk;)V", line = 34)
    public class391(class151 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZB)V", line = 37)
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILdr;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III)V", line = 114)
    public final void method569(int arg0, int arg1, int arg2) {
        ++field5555;
        int var4 = -104 / ((arg0 - 48) / 51);
    }

    @OriginalMember(owner = "client!om", name = "e", descriptor = "(I)Z", line = 129)
    public final boolean method571(int arg0) {
        ++field5559;
        return arg0 == -30998;
    }

    @OriginalMember(owner = "client!om", name = "g", descriptor = "(I)[Lrh;", line = 145)
    ...
    @OriginalMember(owner = "client!om", name = "h", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZI)V", line = 175)
