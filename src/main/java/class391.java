...
public class class391 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BZLjava/lang/String;Loi;)Lku;", line = 17)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IILza;IIII)V", line = 304)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIIII)V", line = 316)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "()V", line = 329)
    protected class391() {
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lza;Lwm;I)V", line = 339)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(III)V", line = 398)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZII)V", line = 416)
