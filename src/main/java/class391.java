...
public abstract class class391 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ljv;III)J")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILbt;I)Ljc;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(III)Lgf;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLvh;)V")
