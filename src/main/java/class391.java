...
public class class391 extends class95 implements class226 {
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lhj;ILjava/nio/ByteBuffer;Z)V")
    public class391(class338 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field5741 = arg1;
    }

    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lhj;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lln;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(Lln;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(Lln;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Lln;)V")
