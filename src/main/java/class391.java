...
public class class391 implements Runnable {
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ljava/net/Socket;Lpq;)V", line = 380)
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!qg", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([BBII)V", line = 104)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)I", line = 137)
    ...
    @OriginalMember(owner = "client!qg", name = "e", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([BIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!qg", name = "run", descriptor = "()V", line = 232)
    ...
    @OriginalMember(owner = "client!qg", name = "finalize", descriptor = "()V", line = 307)
    protected final void finalize() {
        field5164++;
        this.method2245(1);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIIIIII)V", line = 316)
    ...
    @OriginalMember(owner = "client!qg", name = "f", descriptor = "(I)I", line = 335)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIIIIIIILqt;III)Z", line = 393)
