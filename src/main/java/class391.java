...
public abstract class class391 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(JI)I", line = 122)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lts;ZII)V", line = 144)
