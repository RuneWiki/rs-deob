...
public class class391 extends class149 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IZII)I", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIIII)I", line = 25)
    ...
    @OriginalMember(owner = "client!dq", name = "e", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "()V", line = 184)
    public class391() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IBLtl;)V", line = 188)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)[I", line = 281)
