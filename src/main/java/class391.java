...
public class class391 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lza;IZI)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Li;IIB)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BIILi;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIILi;)Z")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lih;Lgk;)V")
