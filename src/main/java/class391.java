...
public class class391 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I)Lol;")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(B)Lol;")
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lke;)V")
