...
public class class391 extends class458 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I[SB)[S", line = 3)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIIII)I", line = 21)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZLqa;)V", line = 38)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "()Lbl;", line = 90)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZILqk;)V", line = 112)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lua;)V", line = 291)
    public class391(class470 arg0) {
        this.field5924 = arg0;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "([III)V", line = 160)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "()I", line = 201)
    public final int method2034() {
        field5923++;
        return 0;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I[IBILqk;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "()Lbl;", line = 273)
