...
public class class391 extends class75 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "()V", line = 89)
    public class391() {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)J", line = 44)
    public final long method399(int arg0) {
        return arg0 == 1 ? this.field5508 : -68L;
    }

    @OriginalMember(owner = "client!fh", name = "e", descriptor = "(I)J", line = 54)
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(I)V", line = 106)
