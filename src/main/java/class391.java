...
public class class391 {
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Z[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Ljc;I)Ljc;", line = 66)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(B)[Lin;", line = 84)
