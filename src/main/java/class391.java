...
public abstract class class391 {
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(I)Loaa;", line = 31)
    ...
    @OriginalMember(owner = "client!lp", name = "g", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZI)I", line = 75)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I[Ljava/lang/Object;[I)V", line = 117)
