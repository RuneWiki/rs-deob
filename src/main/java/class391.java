...
public class class391 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IZLr;)V", line = 26)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IZIII)V", line = 365)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)I", line = 383)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 394)
