...
public class class391 extends class30 {
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "()V", line = 18)
    public class391() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(II)[I", line = 21)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(BILac;)V", line = 81)
