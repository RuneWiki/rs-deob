...
public class class391 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILkc;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)Lkc;")
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)Lkc;")
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)Lkc;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lbr;Lsk;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lja;Z)V")
    ...
    @OriginalMember(owner = "client!jl", name = "f", descriptor = "(I)Lkc;")
