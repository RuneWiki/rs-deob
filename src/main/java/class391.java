...
public class class391 extends class402 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!qo", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 6)
    ...
    @OriginalMember(owner = "client!qo", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 17)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 30)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Ljava/awt/Graphics;BIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!qo", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 88)
    public final void startProduction(ImageConsumer arg0) {
        ++field5754;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!qo", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 96)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field5768;
        return this.field5766 == arg0;
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIBLjava/awt/Graphics;)V", line = 115)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZIIZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!qo", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 172)
