...
public class class391 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z[Ljava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!tm", name = "finalize", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lno;J[Lfk;)V", line = 80)
