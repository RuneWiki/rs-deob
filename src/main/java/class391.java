...
public class class391 extends class228 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lpc;BLga;ILjava/awt/Canvas;)Lya;", line = 49)
    ...
    @OriginalMember(owner = "client!fi", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 60)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field5249;
        return this.field5259 == arg0;
    }

    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIILjava/awt/Graphics;II)V", line = 100)
    ...
    @OriginalMember(owner = "client!fi", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 117)
    ...
    @OriginalMember(owner = "client!fi", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 128)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 143)
    ...
    @OriginalMember(owner = "client!fi", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 170)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field5250;
    }

    @OriginalMember(owner = "client!fi", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 177)
