...
public class class391 extends class394 implements class68 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILqa;)Lou;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(IIILjw;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILa;IIILqa;Z)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lga;III)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZLqa;)V")
