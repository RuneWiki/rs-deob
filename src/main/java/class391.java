...
public class class391 extends class294 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(FFF)V", line = 3)
    public final void method387(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!rca", name = "KA", descriptor = "(IIII)[I", line = 8)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ljava/awt/Canvas;Ljava/lang/Object;B)V", line = 47)
    ...
    @OriginalMember(owner = "client!rca", name = "t", descriptor = "(B)V", line = 56)
    public final void method1538(byte arg0) {
        this.field5990.method2622(174, this.field4381);
        int var2 = -23 % ((56 - arg0) / 60);
    }

    @OriginalMember(owner = "client!rca", name = "r", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!rca", name = "V", descriptor = "(I)V", line = 99)
    public final void method1531(int arg0) {
        int var2 = -19 / ((arg0 - 29) / 48);
        this.field5990.SetTransform(3, this.field4312);
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BLkm;)I", line = 111)
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(IZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Llba;I)I", line = 147)
    ...
    @OriginalMember(owner = "client!rca", name = "o", descriptor = "()V", line = 165)
    public final void method367() {
        this.field5988.method3430(-16501);
        super.method367();
    }

    @OriginalMember(owner = "client!rca", name = "s", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILep;)V", line = 186)
    ...
    @OriginalMember(owner = "client!rca", name = "D", descriptor = "(I)V", line = 199)
    public final void method344(int arg0) {
        this.field5990.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!rca", name = "h", descriptor = "(II)Lic;", line = 208)
    ...
    @OriginalMember(owner = "client!rca", name = "i", descriptor = "(Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ljava/awt/Canvas;I)Ljava/lang/Object;", line = 257)
    ...
    @OriginalMember(owner = "client!rca", name = "R", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!rca", name = "d", descriptor = "(II)V", line = 277)
    ...
    @OriginalMember(owner = "client!rca", name = "j", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lvt;ILkp;)I", line = 308)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IILkp;I[BZBI)Lica;", line = 346)
    ...
    @OriginalMember(owner = "client!rca", name = "p", descriptor = "(B)V", line = 356)
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(Ljava/lang/Object;ILjava/awt/Canvas;)V", line = 394)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lkp;Lvt;III)Lica;", line = 419)
    ...
    @OriginalMember(owner = "client!rca", name = "M", descriptor = "(I)V", line = 429)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILqda;)I", line = 439)
    ...
    @OriginalMember(owner = "client!rca", name = "m", descriptor = "()V", line = 468)
    public final void method349() {
        this.method1905((byte) 22, true);
        this.field5990.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lkp;BLvt;)Z", line = 477)
    ...
    @OriginalMember(owner = "client!rca", name = "n", descriptor = "(Z)V", line = 489)
    ...
    @OriginalMember(owner = "client!rca", name = "d", descriptor = "(B)V", line = 503)
    public final void method1547(byte arg0) {
        int var2 = 117 / ((arg0 - 24) / 58);
        this.field5990.SetRenderState(60, this.field4263);
    }

    @OriginalMember(owner = "client!rca", name = "O", descriptor = "(I)V", line = 511)
    ...
    @OriginalMember(owner = "client!rca", name = "p", descriptor = "(I)V", line = 522)
    ...
    @OriginalMember(owner = "client!rca", name = "f", descriptor = "(Z)V", line = 559)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lcca;II)V", line = 570)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I)V", line = 580)
    public final synchronized void method400(int arg0) {
        this.field5988.method3433((byte) 29);
        super.method400(arg0);
    }

    @OriginalMember(owner = "client!rca", name = "v", descriptor = "(B)V", line = 588)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIIIILfea;Lnq;)V", line = 617)
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "()V", line = 637)
    ...
    @OriginalMember(owner = "client!rca", name = "F", descriptor = "(I)V", line = 661)
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/cv;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Ljd;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Lkea;I)V", line = 697)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIII)V", line = 741)
    public final void method332(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!rca", name = "Y", descriptor = "(I)V", line = 744)
    ...
    @OriginalMember(owner = "client!rca", name = "L", descriptor = "(I)V", line = 755)
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "(Z)V", line = 765)
    public final void method402(boolean arg0) {
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "([Lck;Z)Lep;", line = 768)
    public final class358 method1520(class558[] arg0, boolean arg1) {
        return arg1 ? new dxVertexLayout(this, arg0) : (class358) null;
    }

    @OriginalMember(owner = "client!rca", name = "x", descriptor = "(I)V", line = 778)
    ...
    @OriginalMember(owner = "client!rca", name = "l", descriptor = "()Z", line = 790)
    public final boolean method359() {
        return false;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BLwj;)V", line = 797)
    ...
    @OriginalMember(owner = "client!rca", name = "o", descriptor = "(I)V", line = 836)
    public final void method1517(int arg0) {
        this.field5990.method2622(14, this.field4292 && this.field4325);
        int var2 = -105 % ((-arg0 - 3) / 51);
    }

    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(BZ)Lnq;", line = 845)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ljava/lang/Object;ILjava/awt/Canvas;)V", line = 856)
    ...
    @OriginalMember(owner = "client!rca", name = "g", descriptor = "()V", line = 865)
    public final void method317() {
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 868)
    public final void method383(Rectangle[] arg0, int arg1) throws class27 {
        this.method338();
    }

    @OriginalMember(owner = "client!rca", name = "o", descriptor = "(B)V", line = 875)
    ...
    @OriginalMember(owner = "client!rca", name = "l", descriptor = "(I)F", line = 892)
    public final float method1524(int arg0) {
        return arg0 == 6423 ? -0.5F : -0.67678773F;
    }

    @OriginalMember(owner = "client!rca", name = "Z", descriptor = "(I)Z", line = 903)
    ...
    @OriginalMember(owner = "client!rca", name = "SA", descriptor = "()I", line = 943)
    public final int method375() {
        return 0;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Llk;I)V", line = 952)
    ...
    @OriginalMember(owner = "client!rca", name = "A", descriptor = "()Z", line = 975)
    public final boolean method335() {
        return false;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ldw;Ldw;FLdw;)Ldw;", line = 982)
    public final class622 method371(class622 arg0, class622 arg1, float arg2, class622 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILkp;Lvt;)Z", line = 990)
    ...
    @OriginalMember(owner = "client!rca", name = "h", descriptor = "()Lnl;", line = 1002)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lkm;ZIB)V", line = 1010)
    ...
    @OriginalMember(owner = "client!rca", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Lkea;Ljava/lang/Integer;)Loa;", line = 1059)
    ...
    @OriginalMember(owner = "client!rca", name = "d", descriptor = "(BZ)Lcca;", line = 1156)
    ...
    @OriginalMember(owner = "client!rca", name = "n", descriptor = "(B)V", line = 1169)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Z[FIILkp;IIZ)Lica;", line = 1180)
    ...
    @OriginalMember(owner = "client!rca", name = "j", descriptor = "(B)V", line = 1193)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILjagdx/IDirect3D;IILjagdx/D3DPRESENT_PARAMETERS;I)Z", line = 1204)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lhaa;I)V", line = 1309)
    ...
    @OriginalMember(owner = "client!rca", name = "k", descriptor = "(Z)V", line = 1333)
    ...
    @OriginalMember(owner = "client!rca", name = "t", descriptor = "()V", line = 1369)
    public final void method350() {
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ZIZLkm;Z)V", line = 1384)
    ...
    @OriginalMember(owner = "client!rca", name = "q", descriptor = "()V", line = 1422)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIILfea;)V", line = 1450)
    ...
    @OriginalMember(owner = "client!rca", name = "e", descriptor = "(Z)V", line = 1462)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILjl;)V", line = 1473)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILkp;IIB[B)Lkc;", line = 1499)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ZI[[IZ)Lwn;", line = 1513)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILfea;)I", line = 1524)
    ...
    @OriginalMember(owner = "client!rca", name = "f", descriptor = "(B)V", line = 1558)
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "()V", line = 1568)
    public final void method379() {
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lua;I)I", line = 1576)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IZIII[II)Lica;", line = 1606)
    ...
    @OriginalMember(owner = "client!rca", name = "g", descriptor = "(B)V", line = 1617)
