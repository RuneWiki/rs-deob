...
public class class391 extends class218 {
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(Z)Z", line = 16)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lvl;Ljava/lang/Object;I)V", line = 25)
