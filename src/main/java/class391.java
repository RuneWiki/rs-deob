...
public class class391 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BI)Lps;", line = 9)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lnq;ILga;)V", line = 75)
