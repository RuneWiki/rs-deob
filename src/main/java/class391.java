...
public class class391 extends class739 {
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lha;III)V", line = 370)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)[I", line = 387)
    ...
    @OriginalMember(owner = "client!ml", name = "f", descriptor = "(I)Z", line = 638)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lsl;II)V", line = 736)
