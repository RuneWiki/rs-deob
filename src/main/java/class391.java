...
public class class391 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILic;)V")
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(II)Lbk;")
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lai;ILic;)V")
