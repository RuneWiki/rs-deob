...
public abstract class class391 extends class230 {
    ...
    @OriginalMember(owner = "client!wc", name = "g", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lha;B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Z[Lsca;)I", line = 35)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(IIIIII)V", line = 116)
