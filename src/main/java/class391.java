...
public class class391 extends class367 {
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lno;IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lno;IIII[BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 65)
