...
public abstract class class391 extends class476 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lti;Lza;ILvu;IILfk;Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(I)Ldq;", line = 190)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BII)I", line = 207)
