...
public class class391 {
    ...
    @OriginalMember(owner = "client!ica", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ILjava/lang/String;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lrs;II)V", line = 85)
    public class391(class166 arg0, int arg1, int arg2) {
        this.field5840 = arg2;
        this.field5838 = arg0;
    }

    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Lpe;I)V", line = 97)
