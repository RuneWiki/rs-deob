...
public abstract class class391 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(III)V", line = 58)
