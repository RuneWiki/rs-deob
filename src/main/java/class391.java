...
public class class391 extends class287 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "([IILvj;)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ILvj;)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BI)Lmha;")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ILvj;I)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BLvj;)Ljava/lang/String;")
