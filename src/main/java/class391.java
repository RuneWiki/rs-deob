...
public class class391 extends class170 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lbt;IIZ[II)Lhf;", line = 5)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(IIB)V", line = 44)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BIII)I", line = 54)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZI)V", line = 113)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIB)V", line = 189)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 216)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIILeu;)V", line = 231)
