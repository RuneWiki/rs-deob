...
public class class391 extends class663 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(JI)V", line = 4)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Loa;J)V", line = 404)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "()V", line = 597)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Lru;IIIIIIIIIIIZZ)V", line = 604)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lru;IIIIIIIIIIIZZ)V", line = 625)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "()V", line = 646)
