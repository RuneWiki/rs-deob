...
public abstract class class391 implements class697 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILjaclib/memory/Source;B)Z")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljaggl/MapBuffer;BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Ldga;IZ)V")
