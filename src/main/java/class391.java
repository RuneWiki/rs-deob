...
public class class391 extends class183 {
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IB)I", line = 48)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)J", line = 86)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "()V", line = 100)
    public class391() {
