...
public class class391 extends class543 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 4)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!dda", name = "e", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 94)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 119)
    ...
    @OriginalMember(owner = "client!dda", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 131)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIB)V", line = 156)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 172)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 185)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2332(arg0.getY(), arg0.getX(), (byte) -3);
    }

    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Z)Luk;", line = 192)
    ...
    @OriginalMember(owner = "client!dda", name = "d", descriptor = "(I)Z", line = 203)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIIBI)V", line = 214)
    ...
    @OriginalMember(owner = "client!dda", name = "d", descriptor = "(B)I", line = 230)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 242)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2332(arg0.getY(), arg0.getX(), (byte) -3);
    }

    @OriginalMember(owner = "client!dda", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 250)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2332(arg0.getY(), arg0.getX(), (byte) -3);
    }

    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(I)I", line = 259)
    public final int method2337(int arg0) {
        return arg0 >= -108 ? -32 : this.field5468;
    }

    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 312)
    public class391(Component arg0, boolean arg1) {
        this.method2339(arg0, true);
        this.field5475 = arg1;
    }

    @OriginalMember(owner = "client!dda", name = "e", descriptor = "(B)Z", line = 274)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 286)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 300)
