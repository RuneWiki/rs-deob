...
public class class391 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lig;I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lig;Lrm;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(Lig;)V")
