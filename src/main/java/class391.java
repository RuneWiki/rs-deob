...
public class class391 extends class43 {
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Z[I[IBI)J", line = 21)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BIIIIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BILuo;IZIILbo;ILeq;)Lge;", line = 113)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BIIIZ)V", line = 345)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Z)V", line = 372)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIII)V", line = 382)
