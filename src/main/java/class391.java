...
public class class391 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I[B)[B", line = 4)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ZLpda;)V", line = 75)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)I", line = 108)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I[S)[S", line = 134)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BI)I", line = 202)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(II)V", line = 223)
