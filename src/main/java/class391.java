...
public class class391 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lrg;IZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lrg;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIILjq;I)V", line = 105)
