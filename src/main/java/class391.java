...
public class class391 extends class274 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Leq;[I)V", line = 4)
    public final void method381(class670 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIIIIII[[ZLnw;Ltfa;[I[I)V", line = 10)
                    ...
                    if (this.field5297[var18][var19] != null) {
                        ...
                        for (int var25 = 0; var25 < var23.field3548; ++var25) {
                            ...
                            if (var23.field3547 == null || var23.field3547[var25] == 0 || var23.field3540 != null && (var23.field3540 == null || var23.field3540[var25] != -1)) {
                                if (var23.field3540 != null && var23.field3540[var25] != -1) {
    ...
    @OriginalMember(owner = "client!dfa", name = "BA", descriptor = "()V", line = 145)
    public final void method392() {
        this.field5304 = null;
        this.field5306 = null;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 152)
    public final boolean method389(class120 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II)V", line = 156)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(I)Z", line = 169)
    ...
    @OriginalMember(owner = "client!dfa", name = "c", descriptor = "(II)I", line = 186)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(III[[ZZI)V", line = 216)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIIIIII[[Z)V", line = 264)
    ...
    @OriginalMember(owner = "client!dfa", name = "DA", descriptor = "(Lha;IIIIZ)V", line = 280)
    public final void method385(class120 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILtfa;[I[I[I[I)V", line = 286)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(III[[ZZ)V", line = 787)
    ...
    @OriginalMember(owner = "client!dfa", name = "O", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 835)
    ...
    @OriginalMember(owner = "client!dfa", name = "E", descriptor = "(Lha;IIIIZ)V", line = 1328)
    public final void method390(class120 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIZLnw;Ltfa;[I[I[I[I)V", line = 1332)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Lcc;IIII[[I[[II)V", line = 2174)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(IIIIIII[[ZLnw;Ltfa;[I[I)V", line = 2229)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 2364)
    ...
    @OriginalMember(owner = "client!dfa", name = "v", descriptor = "(IILha;)Lha;", line = 2593)
    public final class120 method388(int arg0, int arg1, class120 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(III)V", line = 2596)
