...
public abstract class class391 extends class488 {
    ...
    @OriginalMember(owner = "client!dfa", name = "i", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!dfa", name = "f", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!dfa", name = "h", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "([Lgga;I)I", line = 42)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(IIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!dfa", name = "f", descriptor = "(B)Z", line = 71)
    ...
    @OriginalMember(owner = "client!dfa", name = "j", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!dfa", name = "i", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II)I", line = 128)
