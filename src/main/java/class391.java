...
public class class391 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILmf;Lhk;I)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILhk;)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lhk;I)V")
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Lhk;I)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILhk;Z)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lhk;IB)V")
