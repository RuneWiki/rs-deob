...
public class class391 extends class42 {
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "()V", line = 18)
    public class391() {
    }

    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 32)
    public class391(String arg0, int arg1) {
        this.field5299 = arg0;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IILm;ILjs;Ljava/awt/Canvas;)Lqa;", line = 42)
