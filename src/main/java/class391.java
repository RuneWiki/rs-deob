...
public class class391 extends class424 implements class89 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!aa", name = "finalize", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILfa;II)V", line = 26)
    public final void method63(int arg0, int arg1, class185 arg2, int arg3, int arg4) {
        this.method2332(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 31)
