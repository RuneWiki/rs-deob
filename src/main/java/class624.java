...
public class class624 extends class165 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ldfa;)V")
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(III)Ljba;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "()Ldfa;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLdfa;)V")
