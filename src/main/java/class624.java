...
public class class624 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([BI)[B", line = 7)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I[S)[S", line = 77)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IZ)I", line = 149)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(II)V", line = 182)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)I", line = 255)
