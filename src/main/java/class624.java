...
public class class624 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(FIIILbn;FIFFIFI[BI)V")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IILmw;IZLha;IZLda;Lha;II)Lqda;")
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(IZ)Llia;")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lmw;IILha;IIII)Lqda;")
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Liv;IZLqb;Lcb;Lcb;)V")
