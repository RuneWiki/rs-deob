...
public class class624 extends class578 implements class87 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IIILrc;)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Llj;III)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Llj;IIII)V")
