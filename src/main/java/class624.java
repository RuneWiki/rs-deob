...
public class class624 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ZLsba;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "(I)V", line = 58)
    public class624(int arg0) {
        this.field8726 = (byte) arg0;
    }

    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(I)V", line = 81)
