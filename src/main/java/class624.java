...
public class class624 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BIII)Loea;", line = 6)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Z)Liea;", line = 26)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IIIIIILjava/lang/String;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(IIIIB)V", line = 89)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ZII)V", line = 102)
