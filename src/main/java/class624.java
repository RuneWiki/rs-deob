...
public class class624 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IILqa;IIII)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILpp;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lqa;Lco;I)V")
