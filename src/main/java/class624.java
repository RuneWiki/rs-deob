...
public class class624 extends class101 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I[FIFIIFII[FII)V", line = 25)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Z)I", line = 83)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(II)V", line = 102)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(IIIIIZ)V", line = 142)
