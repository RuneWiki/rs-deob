...
public class class624 implements class234 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lla;Ljava/lang/String;)V", line = 36)
    public class624(class422 arg0, String arg1) {
        this.field8737 = arg0;
        this.field8740 = arg1;
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)Loi;", line = 50)
