...
public class class624 extends class41 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Loga;I)V")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "([[[Ldq;I)V")
