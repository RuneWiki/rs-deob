...
public class class624 extends class59 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!lha", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "(Leea;Lqm;[Ldga;Z)V")
