...
public class class624 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lha;[II[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 11)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "([III)V", line = 145)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(II)V", line = 194)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lha;[II)V", line = 232)
    public static final void method3593(class473 arg0, int[] arg1, int arg2) {
        method3588(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!via", name = "b", descriptor = "(I)Z", line = 237)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "()V", line = 312)
    public static void method3595() {
        field8746 = null;
    }

    @OriginalMember(owner = "client!via", name = "b", descriptor = "()V", line = 317)
