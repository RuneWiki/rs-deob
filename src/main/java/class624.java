...
public class class624 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Ltga;I)[Lpf;", line = 33)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)V", line = 94)
