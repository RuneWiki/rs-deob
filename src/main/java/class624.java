...
public class class624 extends class627 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lkha;II)Lpaa;", line = 114)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "()V", line = 123)
    public final void method3414() {
        this.field8709 = null;
    }

    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Ltn;)V", line = 126)
