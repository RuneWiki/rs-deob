...
public class class624 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "()I", line = 6)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "()[F", line = 22)
    public final float[] method3520() {
        return this.field8405[this.method3518()];
    }

    @OriginalMember(owner = "client!waa", name = "c", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "()V", line = 165)
    public class624() {
