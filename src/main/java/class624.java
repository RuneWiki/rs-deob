...
public class class624 extends class409 {
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IZ)I", line = 47)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!kaa", name = "d", descriptor = "(III)V", line = 75)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(III)V", line = 125)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(III)V", line = 135)
