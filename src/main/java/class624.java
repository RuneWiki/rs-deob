...
public class class624 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLol;)Lpo;", line = 10)
    ...
    @OriginalMember(owner = "client!jd", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field8860++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 58)
