...
@OriginalClass("VADHJTLJ")
public class Filter {

    @OriginalMember(owner = "VADHJTLJ", name = "a", descriptor = "I")
    private int _flowObfuscator1 = 748;

    @OriginalMember(owner = "VADHJTLJ", name = "b", descriptor = "I")
    private int _flowObfuscator2 = 201;

    @OriginalMember(owner = "VADHJTLJ", name = "c", descriptor = "[I")
    public int[] pairs = new int[2];

    @OriginalMember(owner = "VADHJTLJ", name = "d", descriptor = "[[[I")
    public int[][][] frequencies = new int[2][2][4];

    @OriginalMember(owner = "VADHJTLJ", name = "e", descriptor = "[[[I")
    public int[][][] ranges = new int[2][2][4];

    @OriginalMember(owner = "VADHJTLJ", name = "f", descriptor = "[I")
    public int[] unities = new int[2];

    @OriginalMember(owner = "VADHJTLJ", name = "g", descriptor = "[[F")
    public static float[][] coefficient = new float[2][8];

    @OriginalMember(owner = "VADHJTLJ", name = "h", descriptor = "[[I")
    public static int[][] coefficient16 = new int[2][8];

    @OriginalMember(owner = "VADHJTLJ", name = "i", descriptor = "F")
    public static float unity;

    @OriginalMember(owner = "VADHJTLJ", name = "j", descriptor = "I")
    public static int unity16;

    @OriginalMember(owner = "VADHJTLJ", name = "a", descriptor = "(IIFZ)F")
    ...
    @OriginalMember(owner = "VADHJTLJ", name = "a", descriptor = "(BF)F")
    ...
    @OriginalMember(owner = "VADHJTLJ", name = "a", descriptor = "(BFII)F")
    ...
    @OriginalMember(owner = "VADHJTLJ", name = "a", descriptor = "(IFI)I")
    ...
    @OriginalMember(owner = "VADHJTLJ", name = "a", descriptor = "(LMBMGIXGO;ZLOZKFTHAD;)V")
    ...
    @OriginalMember(owner = "VADHJTLJ", name = "<init>", descriptor = "()V")
    public Filter() {
