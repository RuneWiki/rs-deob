...
public class class355 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILqk;II)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(II)Lhq;")
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lmp;ILla;Lla;)V")
