...
public class class355 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZILjs;)I")
    public static final int method2074(boolean arg0, int arg1, class216 arg2) {
        field4794++;
        return arg0 ? -64 : -1;
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILmk;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZILqa;I)Lf;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILmd;I)V")
