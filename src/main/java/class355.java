...
public class class355 extends class600 {
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIIIBII)V", line = 21)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IILqi;IB)V", line = 69)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(II[I[I)V", line = 128)
