...
public class class355 implements Runnable {
    ...
    @OriginalMember(owner = "client!kd", name = "run", descriptor = "()V", line = 59)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([IIILjava/awt/Component;BLjava/awt/Point;)Lgj;", line = 179)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)Lbn;", line = 191)
    public final class167 method2151(boolean arg0) {
        return arg0 ? null : this.field5096;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZILjava/awt/Component;)Lgj;", line = 216)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)Lgj;", line = 231)
    public final class405 method2154(int arg0) {
        return arg0 >= -55 ? null : this.method2169(0, 12, 2, (Object) null, 0);
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIII)Lgj;", line = 241)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 573)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILjava/lang/Class;)Lgj;", line = 300)
    public final class405 method2160(int arg0, Class arg1) {
        return arg0 == 0 ? this.method2169(0, 10, 2, arg1, 0) : null;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/String;Z)[B", line = 315)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/String;B)Lgj;", line = 328)
    public final class405 method2162(String arg0, byte arg1) {
        return arg1 == -122 ? this.method2169(0, 16, 2, arg0, 0) : null;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)Lgj;", line = 338)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;[Ljava/lang/Class;)Lgj;", line = 353)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIILjava/lang/Object;I)Lgj;", line = 363)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/awt/Component;III)Lgj;", line = 403)
    ...
    @OriginalMember(owner = "client!kd", name = "c", descriptor = "(I)Lgj;", line = 417)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZLjava/lang/String;)Lgj;", line = 429)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(IIILjava/lang/Object;I)Lgj;", line = 443)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lgj;", line = 477)
    public final class405 method2170(int arg0, Transferable arg1) {
        return arg0 == 19 ? this.method2169(0, 19, 2, arg1, 0) : null;
    }

    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(I)Lgj;", line = 491)
    public final class405 method2171(int arg0) {
        int var2 = -104 % ((3 - arg0) / 33);
        return this.method2169(0, 18, 2, (Object) null, 0);
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/awt/Frame;I)Lgj;", line = 505)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Z)Lgj;", line = 529)
    public final class405 method2173(boolean arg0) {
        return arg0 ? null : this.method2169(0, 13, 2, (Object) null, 0);
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/Class;B)Lgj;", line = 546)
    public final class405 method2174(Class arg0, byte arg1) {
        return arg1 == 35 ? this.method2169(0, 20, 2, arg0, 0) : null;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IBLjava/lang/String;)Lgj;", line = 564)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)Lgj;", line = 652)
