...
public class class355 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)Lrd;", line = 5)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(I)V", line = 70)
    public class355(int arg0) {
        this.field5002 = arg0;
    }

    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(IIIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lrd;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IZIIZII)V", line = 78)
