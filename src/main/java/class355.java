...
public abstract class class355 extends class90 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IBI)I", line = 13)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!kp", name = "h", descriptor = "(I)V", line = 42)
