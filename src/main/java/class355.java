...
public class class355 extends class194 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lcn;BLcn;)V", line = 438)
    ...
    @OriginalMember(owner = "client!vu", name = "e", descriptor = "(B)V", line = 466)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(III)Z", line = 478)
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)V", line = 491)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIII)V", line = 550)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lkd;II)V", line = 570)
