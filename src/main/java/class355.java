...
public class class355 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lofa;IZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILofa;I)V", line = 110)
