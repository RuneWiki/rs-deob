...
public class class355 extends class297 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZLra;Lra;)V")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIII)Lbo;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lbo;I)V")
