...
public class class355 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)Ltg;", line = 4)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(I)V", line = 51)
    public static void method2236(int arg0) {
        int var1 = 70 / ((arg0 + 30) / 57);
        field4828 = null;
    }

    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(B)Ltg;", line = 60)
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lqf;IIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Z)V", line = 207)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 236)
    ...
    @OriginalMember(owner = "client!bo", name = "d", descriptor = "(I)Ltg;", line = 274)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILtg;)V", line = 295)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "()V", line = 316)
    public class355() {
