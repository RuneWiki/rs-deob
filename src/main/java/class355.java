...
public class class355 extends class593 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BLdga;[Lfb;)Lhaa;")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IBLah;)V")
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Ldga;Llga;Ljd;)V")
