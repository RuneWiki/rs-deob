...
public class class355 extends class293 {
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lsq;IIII)V")
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lsq;IIIII)V")
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lsq;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lsq;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lsq;IIIIZ[BIZ)V")
