...
public class class355 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IJ[B)V", line = 7)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(III)V", line = 96)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "([BII)V", line = 206)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILvd;B)Lpga;", line = 266)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(I)V", line = 317)
