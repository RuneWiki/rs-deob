...
public class class355 extends class398 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILqs;IZ)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILfp;)Z")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lnj;II)V")
