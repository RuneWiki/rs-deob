...
public class class355 extends class200 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIILza;III)V", line = 10)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(IIZ)Z", line = 590)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(B)V", line = 603)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 657)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZIII)V", line = 667)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II[BB)Ljava/lang/String;", line = 685)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)V", line = 727)
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "(B)V", line = 743)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Ltt;II)V", line = 780)
