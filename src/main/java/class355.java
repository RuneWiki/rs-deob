...
public class class355 extends class323 implements class231 {
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lqa;I)Lpl;", line = 17)
    public final class558 method189(class208 arg0, int arg1) {
        field4842++;
        return arg1 == 31733 ? this.field4836.method189(arg0, arg1) : null;
    }

    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(IIIIILuj;)V", line = 28)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BCLjava/lang/String;)I", line = 38)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLqa;)V", line = 65)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II[B)[B", line = 78)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZLkda;)V", line = 93)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILqa;IB)Z", line = 112)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILqa;)V", line = 124)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!nv", name = "g", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)V", line = 159)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(ILqa;)Lin;", line = 177)
    public final class77 method181(int arg0, class208 arg1) {
        field4835++;
        return arg0 <= 0 ? null : null;
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)I", line = 188)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)Z", line = 199)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)I", line = 210)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BILqa;)Lr;", line = 226)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)I", line = 237)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(BLqa;)V", line = 247)
