...
public class class355 extends class499 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "([I)Lnv;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lvh;)Z")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lvh;II)Lgq;")
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lvh;I)Lgq;")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "([B)V")
