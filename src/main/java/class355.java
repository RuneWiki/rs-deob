...
public class class355 extends class232 implements class21 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lza;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lza;Lfu;IIIIIZIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Lza;B)Lkf;", line = 60)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IILza;I)Z", line = 100)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)I", line = 119)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lza;I)V", line = 132)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 158)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)Z", line = 169)
    ...
    @OriginalMember(owner = "client!ko", name = "f", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)Z", line = 196)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILza;)V", line = 209)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILza;I)Le;", line = 249)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(B)V", line = 260)
