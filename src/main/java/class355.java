...
public class class355 implements class113 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lbi;Lbi;Loq;)V", line = 133)
