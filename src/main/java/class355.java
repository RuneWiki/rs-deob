...
public class class355 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)Llf;", line = 6)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILjava/lang/String;)V", line = 33)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IBI)Z", line = 67)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(III)V", line = 79)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIBIII)V", line = 97)
