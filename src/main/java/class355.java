...
public class class355 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZI)Led;", line = 8)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIIII)Z", line = 61)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BLav;Lqa;)I", line = 120)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(ZI)V", line = 148)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIILuu;IZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 213)
