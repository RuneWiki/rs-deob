...
public class class355 extends class376 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I[IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I[III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)Z", line = 58)
    ...
    @OriginalMember(owner = "client!cn", name = "e", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIB)Z", line = 135)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Z[IIII)Z", line = 146)
    ...
    @OriginalMember(owner = "client!cn", name = "f", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 219)
