...
public abstract class class355 extends class366 {
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BI)V", line = 33)
    ...
    @OriginalMember(owner = "client!th", name = "e", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILuh;)V", line = 163)
