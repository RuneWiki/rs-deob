...
public class class355 extends class424 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIIIIZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLtc;)Ljava/lang/String;", line = 198)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(SB)V", line = 225)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(III)Z", line = 243)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIII[[Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfc;Los;Lpn;[I)V", line = 328)
