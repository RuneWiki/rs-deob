...
public class class355 extends class165 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(JI)V", line = 15)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lwt;IIIIIIIIIIIZZ)V", line = 412)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "()V", line = 432)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lha;J)V", line = 440)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Lwt;IIIIIIIIIIIZZ)V", line = 616)
