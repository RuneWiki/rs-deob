...
public class class355 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BILha;I)Z")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IBLha;I)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lrr;Lhm;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLha;II)V")
