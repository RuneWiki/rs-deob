...
public abstract class class355 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!km", name = "stop", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!km", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)Ljava/lang/String;", line = 35)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILjava/lang/String;)V", line = 46)
    ...
    @OriginalMember(owner = "client!km", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 73)
    public final void windowActivated(WindowEvent arg0) {
        field5003++;
    }

    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Z)Z", line = 83)
    ...
    @OriginalMember(owner = "client!km", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 94)
    ...
    @OriginalMember(owner = "client!km", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 136)
    public final void update(Graphics arg0) {
        field5021++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILin;)V", line = 144)
    ...
    @OriginalMember(owner = "client!km", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 156)
    public final void windowClosing(WindowEvent arg0) {
        field5002++;
        this.destroy();
    }

    @OriginalMember(owner = "client!km", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 164)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 181)
    public static final boolean method2224(String arg0, int arg1) {
        field5000++;
        return arg1 == 0 ? class197.field2895.containsKey(arg0) : true;
    }

    @OriginalMember(owner = "client!km", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 195)
    public final void windowDeactivated(WindowEvent arg0) {
        field4999++;
    }

    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!km", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 256)
    public final void windowOpened(WindowEvent arg0) {
        field5026++;
    }

    @OriginalMember(owner = "client!km", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 264)
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!km", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 338)
    public final void windowDeiconified(WindowEvent arg0) {
        field5022++;
    }

    @OriginalMember(owner = "client!km", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 346)
    ...
    @OriginalMember(owner = "client!km", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 357)
    public final void windowClosed(WindowEvent arg0) {
        field5020++;
    }

    @OriginalMember(owner = "client!km", name = "d", descriptor = "(I)Z", line = 366)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZZ)V", line = 404)
    ...
    @OriginalMember(owner = "client!km", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 481)
    public static final void provideLoaderApplet(Applet arg0) {
        field4998++;
        class675.field9193 = arg0;
    }

    @OriginalMember(owner = "client!km", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 496)
    ...
    @OriginalMember(owner = "client!km", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 512)
    ...
    @OriginalMember(owner = "client!km", name = "destroy", descriptor = "()V", line = 537)
    ...
    @OriginalMember(owner = "client!km", name = "run", descriptor = "()V", line = 552)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(Ljava/lang/String;I)V", line = 673)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 734)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIZIILjava/lang/String;II)V", line = 780)
    ...
    @OriginalMember(owner = "client!km", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 824)
    public final void windowIconified(WindowEvent arg0) {
        field5001++;
    }

    @OriginalMember(owner = "client!km", name = "g", descriptor = "(I)Z", line = 832)
    ...
    @OriginalMember(owner = "client!km", name = "h", descriptor = "(I)V", line = 843)
    ...
    @OriginalMember(owner = "client!km", name = "start", descriptor = "()V", line = 854)
    ...
    @OriginalMember(owner = "client!km", name = "i", descriptor = "(I)Z", line = 877)
