...
public class class355 extends class264 {
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BI)I", line = 18)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lmfa;)V", line = 42)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(ILmfa;)V", line = 67)
    public class355(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)I", line = 96)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)I", line = 116)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(BI)V", line = 130)
