...
public class class355 extends class222 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(IIIB)I", line = 72)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "([BIIBZIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljj;IIIIZ[IZ)V", line = 175)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIIIII)V", line = 226)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IZZ)V", line = 241)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II[IIIIIIZ)V", line = 259)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljj;IIIIZ[FI)V", line = 309)
    ...
    @OriginalMember(owner = "client!hp", name = "e", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljj;IIIII)V", line = 344)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljj;IIII)V", line = 358)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ljj;IIIIZ[BIZ)V", line = 375)
