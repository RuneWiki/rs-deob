...
public class class355 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/String;B)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqn;Lqn;II)Ljf;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BIZLqn;Lqn;)Ljf;")
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lnp;Lsc;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
