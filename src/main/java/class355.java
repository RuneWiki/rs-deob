...
public class class355 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IB)Lut;", line = 34)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BI)Z", line = 67)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(ILhe;Lhe;)V", line = 134)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(B)V", line = 157)
