...
public class class355 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IC)Z", line = 18)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(II)Lgga;", line = 123)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 165)
