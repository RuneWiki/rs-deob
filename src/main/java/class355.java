...
public class class355 extends class346 {
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "()V", line = 5)
    public class355() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(II)[I", line = 12)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lfb;ZI)V", line = 47)
    ...
    @OriginalMember(owner = "client!ck", name = "d", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IBI)V", line = 94)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(II)[[I", line = 171)
