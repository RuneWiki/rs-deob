...
public class class355 extends class337 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(I)V", line = 43)
    public class355(int arg0) {
        this.field5459 = arg0;
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 55)
