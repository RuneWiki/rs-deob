...
public class class355 implements Runnable {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BLir;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lvs;IZ)Lnu;", line = 70)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IB[BLvs;)Lnu;", line = 87)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILvs;)Lnu;", line = 116)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I[Ljk;I)V", line = 149)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lnu;B)V", line = 236)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lfq;)V", line = 319)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!qj", name = "run", descriptor = "()V", line = 273)
