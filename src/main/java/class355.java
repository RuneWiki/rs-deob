...
public class class355 extends class61 implements class74 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lkj;)V", line = 10)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lbf;I[BIZ)V", line = 14)
    public class355(class344 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field4907 = arg1;
    }

    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(Lkj;)V", line = 18)
    ...
    @OriginalMember(owner = "client!gh", name = "d", descriptor = "(Lkj;)V", line = 21)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lbf;ILjava/nio/ByteBuffer;Z)V", line = 28)
    public class355(class344 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field4907 = arg1;
    }

    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(Lkj;)V", line = 32)
