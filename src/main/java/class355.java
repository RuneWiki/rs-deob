...
public class class355 implements class415 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZB)V", line = 10)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lct;Lfba;)V", line = 57)
    public class355(class374 arg0, class667 arg1) {
        this.field5164 = arg0;
        this.field5167 = arg1;
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/String;IILta;II)I", line = 67)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 89)
