...
public class class355 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IZILet;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZBZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)[Lsn;", line = 46)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Z)Z", line = 141)
