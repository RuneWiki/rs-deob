...
public class class355 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)Laq;", line = 73)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(BI)V", line = 104)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(II)Z", line = 141)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Loq;ILbu;Lbu;)V", line = 226)
