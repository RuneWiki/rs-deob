...
public abstract class class355 extends class179 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lsc;Z)Z", line = 20)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(III[J[Ljava/lang/Object;)V", line = 60)
    ...
    @OriginalMember(owner = "client!mm", name = "g", descriptor = "(I)V", line = 117)
