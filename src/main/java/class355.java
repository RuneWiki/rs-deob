...
public class class355 extends class164 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLn;)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/String;)V", line = 71)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lfk;Lau;)V", line = 135)
