...
public class class355 extends class227 implements class7 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lfj;III)Lka;", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)J", line = 86)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lad;I[BIZ)V", line = 100)
    public class355(class362 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field5056 = arg1;
    }

    @OriginalMember(owner = "client!nv", name = "e", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "([BIIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)I", line = 147)
