...
public class class355 extends class214 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Llk;II)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILms;Lms;)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Llk;B)Lip;")
