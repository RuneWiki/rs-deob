...
public class class480 {
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "()I", line = 27)
    public final int method2794() {
        return this.field6652 - 1;
    }

    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Ljava/lang/String;)I", line = 32)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 173)
    ...
    @OriginalMember(owner = "client!oja", name = "b", descriptor = "()V", line = 52)
    public static void method2796() {
        field6654 = null;
    }

    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!oja", name = "c", descriptor = "()I", line = 73)
    public final int method2798() {
        return this.field6650;
    }

    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 78)
