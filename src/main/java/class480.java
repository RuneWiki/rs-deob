...
public class class480 extends class449 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IB)Lol;", line = 4)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)V", line = 327)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ljava/awt/Frame;Lis;I)V", line = 338)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Z", line = 365)
    ...
    @OriginalMember(owner = "client!au", name = "d", descriptor = "(I)V", line = 390)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "([B)V", line = 409)
