...
public class class480 extends class61 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(CIIIZLaa;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Liw;Lhia;[Lfg;[I[I)V", line = 65)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "([B[IIIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 145)
    ...
    @OriginalMember(owner = "client!iea", name = "fa", descriptor = "(CIIIZ)V", line = 241)
