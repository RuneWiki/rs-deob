...
public class class480 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lcq;[IJB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IZ)Lmn;")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(ILmv;Lmv;Ld;)V")
