...
public class class480 extends class134 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(ILkda;)V", line = 19)
    public class480(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ZLac;)V", line = 72)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIIIIIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(II)I", line = 152)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lkda;)V", line = 164)
