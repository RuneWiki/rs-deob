...
public class class480 extends class130 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([I[BLao;I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "()V", line = 116)
    public class480() {
    }

    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "([B)V", line = 118)
