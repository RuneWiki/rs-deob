...
public class class480 extends class589 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIB)Z", line = 39)
