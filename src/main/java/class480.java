...
public class class480 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BII)Z", line = 21)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)V", line = 35)
