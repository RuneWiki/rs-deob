...
public class class480 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)Lwp;", line = 7)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIJ)V", line = 73)
