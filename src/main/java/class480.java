...
public class class480 extends class463 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "([III)V", line = 4)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IIIIIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZLrr;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!nga", name = "d", descriptor = "()I", line = 142)
    public final int method1495() {
        field5976++;
        return 0;
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "()Lmi;", line = 152)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B[IILjh;II)V", line = 182)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(BILjh;)V", line = 277)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "()Lmi;", line = 335)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(II)V", line = 355)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IIIIIIZ)V", line = 369)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(Lhe;)V", line = 559)
