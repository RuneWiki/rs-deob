...
public class class480 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BI)Z", line = 26)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 83)
