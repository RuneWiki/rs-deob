...
public class class480 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(II)Llca;", line = 49)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lms;ILwu;)V", line = 113)
    public class480(class763 arg0, int arg1, class376 arg2) {
        this.field6582 = arg2;
        this.field6582.method2195(30, 0);
    }

    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjava/lang/String;BZ)V", line = 142)
