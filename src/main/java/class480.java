...
public class class480 extends class3 implements class421 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IB)Ldv;", line = 41)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lrda;Lpj;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 84)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Lpj;", line = 106)
