...
public class class480 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILet;III)Ljava/awt/Frame;", line = 24)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 111)
