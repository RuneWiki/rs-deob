...
public class class480 extends class322 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIB)Z", line = 48)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(ILch;)V", line = 61)
    public class480(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)I", line = 103)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IBIZIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lch;)V", line = 154)
    public class480(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(II)V", line = 162)
