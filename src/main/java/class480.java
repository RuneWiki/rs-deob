...
public class class480 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)Lkv;", line = 25)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lkfa;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(III)I", line = 64)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)Z", line = 79)
