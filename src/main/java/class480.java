...
public class class480 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZI)Lol;", line = 47)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIILya;Lub;)V", line = 83)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(IB)Z", line = 118)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(ILqn;Lqn;)V", line = 141)
