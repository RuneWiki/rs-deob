...
public class class480 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZILol;)V")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILol;IZ)V")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lup;Z)I")
