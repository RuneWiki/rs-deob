...
public class class480 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZIBII)V", line = 11)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(BIIIII)V", line = 65)
