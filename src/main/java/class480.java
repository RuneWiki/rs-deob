...
public class class480 extends class204 {
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lfs;)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(ILfs;)V")
    public class480(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lha;I)V")
