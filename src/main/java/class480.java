...
public class class480 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ld;ILwm;)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BI)Lcia;")
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lega;ILwm;Lwm;)V")
