...
public class class480 extends class529 {
    ...
    @OriginalMember(owner = "client!vq", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "()V", line = 14)
    public class480() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IBLtn;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)[[I", line = 65)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IB)[I", line = 138)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIBII)V", line = 207)
