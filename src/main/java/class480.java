...
public class class480 {
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(II)Lmg;", line = 52)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 149)
