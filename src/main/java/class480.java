...
public class class480 extends class569 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Log;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIILev;Lev;)V", line = 31)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(BLes;)Ljq;", line = 82)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(III)Llca;", line = 108)
