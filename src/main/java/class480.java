...
public class class480 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(JI)Luh;")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Luh;IJ)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(BLqa;Lga;)V")
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)Luh;")
