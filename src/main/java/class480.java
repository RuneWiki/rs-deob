...
public class class480 extends class739 {
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "()V", line = 283)
    public class480() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(II)[I", line = 14)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lsl;II)V", line = 153)
    ...
    @OriginalMember(owner = "client!lia", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!lia", name = "d", descriptor = "(Z)V", line = 228)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIIIIBI[[[BLha;IIII)V", line = 239)
