...
public class class480 extends class349 {
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 3)
    public class480() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IILdga;)V", line = 8)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BII)Z", line = 84)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(BI)[I", line = 104)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZI)Z", line = 155)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!kq", name = "f", descriptor = "(I)V", line = 207)
