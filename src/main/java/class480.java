...
public class class480 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lre;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(II)Z", line = 92)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lre;B)V", line = 123)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 145)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I[Ljava/lang/String;[SII)V", line = 229)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZI)I", line = 282)
