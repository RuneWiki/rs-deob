...
public class class480 implements Runnable {
    ...
    @OriginalMember(owner = "client!lt", name = "run", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILjava/lang/Runnable;)Lwp;", line = 127)
    public final class121 method2860(int arg0, int arg1, Runnable arg2) {
        return arg0 >= -77 ? null : this.method2886(0, arg2, 0, 2, arg1);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 138)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z[Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;)Lwp;", line = 150)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/lang/Class;)Lwp;", line = 160)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILjava/lang/Object;II)Lwp;", line = 173)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(Ljava/lang/String;I)Lwp;", line = 265)
    public final class121 method2866(String arg0, int arg1) {
        return arg1 == -25185 ? this.method2886(0, arg0, 0, 16, 0) : null;
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 278)
    public final void method2867(int arg0) {
        field7092 = (long) arg0 + class423.method2578(-19698);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BILjava/lang/String;Ljava/lang/String;)Ljava/io/File;", line = 286)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/lang/String;)Lwp;", line = 373)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)Led;", line = 383)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILjava/awt/Component;ILjava/awt/Point;[I)Lwp;", line = 394)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lwp;", line = 404)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Component;BZ)Lwp;", line = 418)
    ...
    @OriginalMember(owner = "client!lt", name = "d", descriptor = "(I)Z", line = 428)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIIII)Lwp;", line = 445)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)Lwp;", line = 457)
    ...
    @OriginalMember(owner = "client!lt", name = "e", descriptor = "(I)Lwp;", line = 468)
    public final class121 method2877(int arg0) {
        return arg0 == 0 ? this.method2886(0, null, 0, 18, 0) : null;
    }

    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 699)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/String;ZI)Lwp;", line = 482)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lwp;", line = 497)
    public final class121 method2879(Transferable arg0, int arg1) {
        int var3 = -47 % ((47 - arg1) / 47);
        return this.method2886(0, arg0, 0, 19, 0);
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(ILjava/lang/Class;)V", line = 519)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Frame;I)Lwp;", line = 556)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZILjava/lang/String;)Lwp;", line = 567)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Component;IBI)Lwp;", line = 578)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/String;Z)[B", line = 590)
    ...
    @OriginalMember(owner = "client!lt", name = "f", descriptor = "(I)Lwp;", line = 603)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/lang/Object;III)Lwp;", line = 628)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLjava/net/URL;)Lwp;", line = 664)
    public final class121 method2887(byte arg0, URL arg1) {
        int var3 = -36 % ((arg0 - 84) / 35);
        return this.method2886(0, arg1, 0, 4, 0);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZLjava/lang/Class;)Lwp;", line = 676)
