...
public abstract class class480 extends class8 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Len;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(IIIZZ)V", line = 136)
