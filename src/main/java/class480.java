...
public class class480 extends class362 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(II)V", line = 199)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IFIII)V", line = 215)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIIB)V", line = 344)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/awt/Component;B)Lefa;", line = 357)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(BI)V", line = 367)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lqm;IIIII)V", line = 392)
