...
public class class480 extends class577 {
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(Z)Lso;")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IIIIIIIILha;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
