...
public abstract class class480 extends class20 {
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(B)Z", line = 5)
    public final boolean method167(byte arg0) {
        ++field6735;
        return arg0 != 118 ? false : false;
    }

    @OriginalMember(owner = "client!dn", name = "j", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "([Lul;I)I", line = 27)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIZLr;ILub;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(IIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!dn", name = "h", descriptor = "(I)V", line = 79)
