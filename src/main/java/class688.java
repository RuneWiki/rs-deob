...
public class class688 implements class299 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/Class;)I", line = 40)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(FB)F", line = 94)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Z)Ljava/lang/Object;", line = 116)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IJ)Z", line = 174)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZB)V", line = 201)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)I", line = 391)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(B)V", line = 412)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "([Ljava/lang/Object;I[JZI)V", line = 423)
