...
public class class688 implements Runnable {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lat;II)Lbb;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lbb;I)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BILat;[B)Lbb;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IILat;)Lbb;")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lpi;)V")
