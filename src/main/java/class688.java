...
public class class688 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(JI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)[Lub;", line = 30)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BLni;)V", line = 171)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(J[I[S[S)V", line = 230)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "()V", line = 240)
    protected class688() {
    }
}
