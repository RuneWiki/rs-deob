...
public class class688 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)I", line = 3)
    public static final int method3751(int arg0, int arg1) {
        field9412++;
        return arg1 == 255 ? arg0 & 0xFF : -36;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILfd;)V", line = 14)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lfd;BLfl;)Lkr;", line = 52)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(III)Z", line = 105)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(III)Z", line = 116)
