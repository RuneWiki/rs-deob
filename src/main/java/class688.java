...
public class class688 extends class634 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZZIIILjava/lang/String;JLjava/lang/String;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lpfa;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZI)V", line = 66)
