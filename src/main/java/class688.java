...
public class class688 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)I", line = 53)
    public static int method3877(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!mv", name = "toString", descriptor = "()Ljava/lang/String;", line = 81)
    public final String toString() {
        field9765++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IB)I", line = 89)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "()V", line = 104)
