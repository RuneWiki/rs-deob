...
public class class688 extends class601 {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lgn;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(ILgn;)V")
    public class688(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Llga;)V")
