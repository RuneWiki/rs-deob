...
public class class688 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)Lnd;", line = 43)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Z)V", line = 62)
