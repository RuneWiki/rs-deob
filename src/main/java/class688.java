...
public class class688 extends class376 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "()Lwc;")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lwc;B)V")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lwc;)V")
    ...
    @OriginalMember(owner = "client!fw", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IB)V")
