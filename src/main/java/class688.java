...
public class class688 extends class497 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(ILpp;)V", line = 15)
    public class688(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lpp;)V", line = 21)
    public class688(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "([ILqo;IZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)I", line = 120)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(II)V", line = 137)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(I)I", line = 151)
