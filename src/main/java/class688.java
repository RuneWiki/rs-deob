...
public class class688 extends class543 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "f", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IB)V", line = 52)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!bw", name = "g", descriptor = "(B)Z", line = 89)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lac;)V", line = 112)
    public class688(class541 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)Z", line = 119)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)I", line = 130)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZLjava/lang/Object;Z)[B", line = 145)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Laaa;IBLaaa;)V", line = 259)
