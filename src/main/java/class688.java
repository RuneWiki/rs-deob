...
public class class688 extends class182 {
    ...
    @OriginalMember(owner = "client!dv", name = "e", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIIII)V", line = 125)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Z)V", line = 314)
    ...
    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(I)V", line = 330)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 341)
