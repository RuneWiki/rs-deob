...
public class class688 implements class300 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IILip;I)J")
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)Ldn;")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lfp;Ljava/lang/String;)V")
