...
public class class493 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IZ)Lvo;", line = 35)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIIIIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILha;)V", line = 159)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIBI)V", line = 174)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)Lgba;", line = 225)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(B)V", line = 271)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lmp;ILla;Lla;Lla;)V", line = 312)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(IZ)V", line = 297)
