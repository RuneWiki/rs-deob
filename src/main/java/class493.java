...
public class class493 extends class29 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!ac", name = "d", descriptor = "(I)I", line = 4)
    public final int method162(int arg0) {
        return arg0 == -26561 ? this.field7148 : 20;
    }

    @OriginalMember(owner = "client!ac", name = "e", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ac", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ac", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 78)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!ac", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 112)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2841(arg0.getX(), arg0.getY(), -121);
    }

    @OriginalMember(owner = "client!ac", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)I", line = 153)
    public final int method161(int arg0) {
        return arg0 == 31285 ? this.field7145 : -65;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)Z", line = 163)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Z)Lve;", line = 173)
    ...
    @OriginalMember(owner = "client!ac", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 183)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2841(arg0.getX(), arg0.getY(), -103);
    }

    @OriginalMember(owner = "client!ac", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 190)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2841(arg0.getX(), arg0.getY(), -113);
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 198)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)V", line = 216)
    ...
    @OriginalMember(owner = "client!ac", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 230)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method2841(arg0.getX(), arg0.getY(), -112);
    }

    @OriginalMember(owner = "client!ac", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 238)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 263)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)V", line = 291)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 312)
