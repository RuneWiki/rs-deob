...
public class class493 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLmo;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lmo;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZLmo;)Lnaa;", line = 102)
