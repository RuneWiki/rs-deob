...
public abstract class class493 extends class401 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(BLmw;)V", line = 12)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIB)Z", line = 87)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILba;III)V", line = 99)
