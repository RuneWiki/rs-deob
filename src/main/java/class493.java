...
public class class493 extends class418 {
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "()I", line = 19)
    public final int method1673() {
        field7037++;
        return 1;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Z)Lhga;", line = 27)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "([III)V", line = 39)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "()Lep;", line = 106)
    public final class418 method1693() {
        field7015++;
        return null;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "()Lep;", line = 165)
    public final class418 method1696() {
        field7022++;
        return null;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZI)V", line = 173)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(I)V", line = 313)
    public class493(int arg0) {
        this.field7023 = arg0;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI)V", line = 188)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)I", line = 201)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)D", line = 212)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lhga;I)V", line = 242)
    ...
    @OriginalMember(owner = "client!mi", name = "g", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BID)Lhga;", line = 290)
