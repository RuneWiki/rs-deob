...
public class class493 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "toString", descriptor = "()Ljava/lang/String;", line = 21)
    public final String toString() {
        field7174++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(II)V", line = 33)
    public class493(int arg0, int arg1) {
        this.field7176 = arg1;
        this.field7172 = arg0;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 42)
