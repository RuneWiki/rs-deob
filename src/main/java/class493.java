...
public class class493 implements Runnable {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/lang/Class;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLjava/lang/String;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "([Ljava/lang/Class;BLjava/lang/String;Ljava/lang/Class;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/net/URL;)Lln;")
    public final class169 method2877(int arg0, URL arg1) {
        return arg0 == 0 ? this.method2889(0, 4, 0, arg1, -122) : null;
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIIII)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBIILjava/lang/Object;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ljava/awt/Component;I[IILjava/awt/Point;I)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZI)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBLjava/lang/String;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)Lur;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIILjava/lang/Object;I)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZLjava/lang/String;Z)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ljava/lang/String;B)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ljava/awt/Frame;I)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(I)Lln;")
    public final class169 method2894(int arg0) {
        return arg0 >= -65 ? null : this.method2889(0, 18, 0, null, -116);
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ljava/awt/Component;ZZ)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(ILjava/lang/Class;)Lln;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIBLjava/awt/Component;)Lln;")
