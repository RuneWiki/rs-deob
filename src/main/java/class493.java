...
public class class493 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BI)Lfd;", line = 16)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(I)Lcb;", line = 35)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(II)V", line = 61)
    public class493(int arg0, int arg1) {
        this.field6144 = arg0;
        this.field6148 = arg1;
    }

    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lfd;I)V", line = 69)
