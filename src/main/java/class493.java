...
public class class493 extends class657 {
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "([Lit;)V", line = 7)
    public class493(class734[] arg0) {
        this.field6979 = arg0;
    }

    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 27)
