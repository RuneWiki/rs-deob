...
public class class493 extends class767 implements class94 {
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(B)J", line = 8)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "([BZI)[B", line = 34)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lml;I[BIZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II[BB)V", line = 137)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Z)I", line = 152)
    ...
    @OriginalMember(owner = "client!ct", name = "d", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)I", line = 183)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lml;ILjaclib/memory/Buffer;IZ)V", line = 193)
