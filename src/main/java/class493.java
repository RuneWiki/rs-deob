...
public class class493 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)Lrs;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III)Lti;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLpj;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(II)Lct;")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Ldd;ILpj;Lpj;Lpj;)V")
