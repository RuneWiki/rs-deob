...
public class class493 extends class16 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IILma;II)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILem;IZ)V")
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(FFFFFFLma;II)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lef;IIII)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lef;II[III)V")
