...
public class class493 extends class86 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)Lmj;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(FIIIIFIFFI[BFLut;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ltl;I)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLtl;I)V")
