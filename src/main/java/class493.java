...
public class class493 extends class175 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILdt;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZI)[I", line = 109)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IBI[[IILjava/util/Random;I)V", line = 360)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "()V", line = 564)
    public class493() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(I)V", line = 568)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(Z)V", line = 601)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B[I)Ljava/lang/String;", line = 619)
