...
public class class493 implements class727 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IZLjava/awt/Component;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I[I)V", line = 44)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BI)I", line = 110)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)V", line = 152)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZI)V", line = 169)
