...
public class class493 {
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lv;Z)V", line = 62)
