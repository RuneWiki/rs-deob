...
public class class493 {
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIB[BI[B)I", line = 41)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I[B[BIII)I", line = 188)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)V", line = 259)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IZIIII)V", line = 275)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "([B)V", line = 376)
