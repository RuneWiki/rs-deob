...
public class class493 extends class339 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)Z", line = 125)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IZ)Z", line = 140)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(II)Z", line = 195)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(I)V", line = 205)
    public class493(int arg0) {
        this.field6800 = arg0;
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIII)V", line = 214)
