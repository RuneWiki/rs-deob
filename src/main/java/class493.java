...
public abstract class class493 implements class466 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIILev;Z)Z")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lmv;I)V")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llm;ILec;Lbt;IZ)V")
