...
public class class493 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lrg;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lrg;II)V", line = 36)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(II)I", line = 86)
