...
public class class493 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)Lnf;", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lmk;B)Ljava/lang/String;", line = 65)
    ...
    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IB)V", line = 115)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 136)
