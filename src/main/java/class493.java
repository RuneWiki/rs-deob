...
public class class493 extends class80 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!cj", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "()V", line = 55)
    public class493() {
        super(0, false);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lke;IIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZLms;)I", line = 126)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(II)[[I", line = 213)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;Lph;IZ)Ljb;", line = 290)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IILnn;)V", line = 339)
