...
public class class493 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(II)Lje;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ltq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lam;I)V")
