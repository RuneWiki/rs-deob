...
public class class493 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "([I[I[I[[F)V", line = 45)
