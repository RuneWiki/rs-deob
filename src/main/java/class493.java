...
public class class493 extends class657 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!qe", name = "d", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IBLmw;)V", line = 147)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZI)V", line = 185)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lffa;)V", line = 205)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BII)Z", line = 239)
