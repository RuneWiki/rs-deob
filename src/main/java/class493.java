...
public class class493 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILrv;B)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lrv;I)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZLwq;B)V")
