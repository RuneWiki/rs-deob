...
public class class493 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILmd;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(B)Lmd;", line = 23)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(B)Lmd;", line = 62)
    ...
    @OriginalMember(owner = "client!gn", name = "d", descriptor = "(B)Lmd;", line = 90)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)Lmd;", line = 149)
    ...
    @OriginalMember(owner = "client!gn", name = "f", descriptor = "(B)Z", line = 171)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "()V", line = 191)
    public class493() {
