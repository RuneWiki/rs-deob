...
public class class493 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)V", line = 111)
