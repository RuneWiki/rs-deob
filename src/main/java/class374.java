...
public class class374 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 26)
