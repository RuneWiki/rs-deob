...
public class class374 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIILpj;Lpj;)V", line = 7)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lse;III)V", line = 44)
