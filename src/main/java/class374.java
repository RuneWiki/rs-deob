...
public class class374 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)Lcs;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lks;B)V")
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)Lcs;")
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)Lcs;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLcs;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(B)Lcs;")
