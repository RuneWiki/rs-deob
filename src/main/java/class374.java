...
public class class374 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lso;II)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lef;B)I")
