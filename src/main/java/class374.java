...
public class class374 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IB)[B", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "toString", descriptor = "()Ljava/lang/String;", line = 82)
    public final String toString() {
        field4855++;
        return "Cache:" + this.field4866;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BI[BI)Z", line = 90)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([BIZBI)Z", line = 133)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(ILup;Lup;I)V", line = 283)
