...
public class class374 implements Runnable {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BLrq;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IB)Loda;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lcr;IBLdga;)V")
