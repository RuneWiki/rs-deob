...
public class class374 extends class136 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IILiv;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILuu;)Z")
    ...
    @OriginalMember(owner = "client!rc", name = "f", descriptor = "(I)Lkk;")
