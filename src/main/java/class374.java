...
public class class374 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IZ)Ljh;")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)Lwk;")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I[BLdg;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
