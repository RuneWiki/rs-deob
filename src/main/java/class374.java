...
public abstract class class374 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILgga;Lgga;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)Z", line = 37)
