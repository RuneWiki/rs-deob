...
public class class374 extends class751 {
    ...
    @OriginalMember(owner = "client!bga", name = "b", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ILrv;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(II)[I", line = 198)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "()V", line = 241)
    public class374() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IB)[[I", line = 253)
