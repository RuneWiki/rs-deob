...
public class class374 extends class151 {
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lic;IIIIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lic;IIIII[BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lic;IIII[I)V", line = 34)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lic;IIIIZ[BI)V", line = 48)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIILic;I)Llm;", line = 70)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lic;IIIZ[I)V", line = 87)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lic;IIIIIZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIB[BLic;ZII)Llm;", line = 132)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILic;I[IIZ)Llm;", line = 151)
