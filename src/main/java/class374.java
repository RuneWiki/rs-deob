...
public class class374 implements class211 {
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZB)V", line = 47)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lbd;[[BB)V", line = 75)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IJ)Z", line = 147)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z)I", line = 172)
    public final int method700(boolean arg0) {
        field5331++;
        return arg0 ? -3 : this.field5327.field5368;
    }

    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Llg;Lmu;)V", line = 185)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 204)
