...
public abstract class class374 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lnj;ZZZLeb;[II[ZIIILnj;)V", line = 17)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILei;I)V", line = 239)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZIIILei;ILei;II)V", line = 295)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lda;II[IIZ)Lal;", line = 329)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(I[IIIIIIZI[I)V", line = 354)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIILya;IIIII)V", line = 460)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(I[ZLei;IBLei;IIIIZILei;Lei;I)V", line = 574)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lda;IIIIB)Lal;", line = 632)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lei;I[IIIZILei;IZI)V", line = 655)
