...
public class class374 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lrl;)V", line = 209)
    ...
    @OriginalMember(owner = "client!ep", name = "d", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)Z", line = 120)
