...
public class class374 extends class446 {
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lod;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lod;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lod;II)V")
