...
public class class374 extends class476 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(III)Liq;", line = 4)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IZLjava/lang/String;Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIIZII)I", line = 102)
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(B)V", line = 175)
