...
public class class374 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lpo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lpo;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Lpo;)V", line = 358)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(Lpo;)V", line = 368)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lpo;Lbg;)V", line = 390)
