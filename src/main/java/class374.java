...
public abstract class class374 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIILus;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIILdc;ILqa;IILc;IIIIIZ)Lc;")
    ...
    @OriginalMember(owner = "client!rc", name = "providesignlink", descriptor = "(Ljs;)V")
