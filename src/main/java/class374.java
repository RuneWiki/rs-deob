...
public class class374 extends class666 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILiaa;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 142)
    public class374() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fr", name = "h", descriptor = "(I)[Lqv;", line = 59)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)[I", line = 99)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IB)[[I", line = 145)
