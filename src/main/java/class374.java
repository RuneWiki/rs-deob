...
public class class374 extends class498 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "()[I", line = 3)
    public final int[] method2187() {
        return this.field5322;
    }

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "()V", line = 6)
    public static void method2188() {
        field5319 = null;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)V", line = 12)
