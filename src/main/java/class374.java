...
public class class374 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(CZ)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I[Lxa;)V", line = 92)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLjaa;)V", line = 125)
