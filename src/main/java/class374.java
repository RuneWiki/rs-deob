...
public class class374 extends class322 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(Z)I", line = 30)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILd;IBLjava/awt/Canvas;)Lha;", line = 41)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(ILch;)V", line = 67)
    public class374(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILee;)Lju;", line = 70)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lch;)V", line = 96)
    public class374(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)V", line = 101)
