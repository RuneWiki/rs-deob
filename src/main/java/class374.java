...
public class class374 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lir;II)Lnh;", line = 9)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lfb;)V", line = 129)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 149)
    private class374() {
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "()[B", line = 20)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "()Lhh;", line = 79)
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "()I", line = 85)
