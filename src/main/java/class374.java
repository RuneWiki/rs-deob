...
public class class374 extends class438 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILqa;)Lbw;")
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lqa;B)V")
