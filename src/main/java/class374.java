...
public class class374 extends class31 {
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 6)
    public class374(Object arg0, int arg1) {
        super(arg1);
        this.field5295 = arg0;
    }

    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!fd", name = "f", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!fd", name = "h", descriptor = "(I)V", line = 53)
