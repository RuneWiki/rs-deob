...
public class class374 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lae;B)V", line = 13)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 86)
