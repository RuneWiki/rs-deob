...
public class class374 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILsh;II)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIILeb;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILeb;I)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILsm;)V")
    public static final void method2445(int arg0, class156 arg1) {
        class249.field3456[arg0] = arg1;
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BILjj;II)V")
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)Lnc;")
