...
public class class374 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lla;)V", line = 40)
    public class374(class393 arg0) {
        this.field5526 = arg0;
    }

    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lla;Lfo;)V", line = 51)
    public class374(class393 arg0, class606 arg1) {
        this.field5526 = arg0;
        this.field5523 = arg1;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(III)Lfg;", line = 27)
