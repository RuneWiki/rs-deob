...
public class class374 extends class194 {
    ...
    @OriginalMember(owner = "client!fp", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IILbg;)V", line = 122)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "()V", line = 169)
    public class374() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fp", name = "i", descriptor = "(I)V", line = 193)
