...
public class class374 implements class160 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZB)V", line = 32)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Loi;)V", line = 58)
    public class374(class226 arg0) {
        this.field4963 = arg0;
    }

    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)Z", line = 79)
