...
public class class374 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lrs;)V", line = 70)
