...
public class class374 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lvc;I)V")
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(Lvc;I)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lvc;IIIIZLn;B)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IZLae;)I")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ILvc;ZIIIZ)Ln;")
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lvc;Lnm;IIIIIIZI)V")
