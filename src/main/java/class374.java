...
public class class374 extends class211 {
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)V", line = 72)
