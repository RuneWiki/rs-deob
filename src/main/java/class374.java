...
public abstract class class374 extends class435 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lrg;ILrg;)V")
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "([Llaa;Z)I")
