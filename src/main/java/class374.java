...
public class class374 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLjava/lang/String;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I[B)Ldd;", line = 30)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([Loa;Lpe;IIZLsa;)V", line = 117)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLr;)Ljava/lang/String;", line = 359)
