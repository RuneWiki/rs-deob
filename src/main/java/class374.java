...
public class class374 extends class11 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "()V", line = 22)
    public class374() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!ur", name = "f", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lsi;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(II)[I", line = 128)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(III)I", line = 164)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(B)V", line = 293)
