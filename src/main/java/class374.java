...
public class class374 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)Ld;", line = 4)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(III[BZII)V", line = 37)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)Ld;", line = 140)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)I", line = 154)
    public static final int method2037(int arg0, int arg1) {
        field4718++;
        return arg0 > -61 ? -14 : arg1 & 0x7F;
    }

    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "()V", line = 184)
    public class374() {
    }

    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Lil;)V", line = 186)
