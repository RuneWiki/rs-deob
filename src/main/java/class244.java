...
public class class244 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lun;I)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILr;ZI)Lf;")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILun;B)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IILpe;IIZIIIILop;I)V")
