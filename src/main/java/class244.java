...
public class class244 extends class282 implements class2 {
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()[Lqv;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lvea;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lsk;Lnl;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lfu;IIII)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lsk;Lnl;II)V")
