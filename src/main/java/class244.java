...
public class class244 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(Z)Lmg;", line = 24)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(B)I", line = 53)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)Lmg;", line = 73)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lwq;I[I[I[I)V", line = 116)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lmg;I)V", line = 222)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(I)Lmg;", line = 238)
    ...
    @OriginalMember(owner = "client!hca", name = "d", descriptor = "(I)Lmg;", line = 257)
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "()V", line = 287)
    public class244() {
