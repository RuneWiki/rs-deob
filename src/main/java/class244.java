...
public class class244 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)Lqi;", line = 77)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B[B)[B", line = 123)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lal;ILmg;Lmg;)V", line = 207)
