...
public class class244 extends class201 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(I)J", line = 41)
    public final long method236(int arg0) {
        return arg0 >= -123 ? -108L : this.field3509;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "()V", line = 105)
    public class244() {
        this.field3509 = System.nanoTime();
        this.field3510 = System.nanoTime();
    }

    @OriginalMember(owner = "client!at", name = "c", descriptor = "(B)J", line = 74)
