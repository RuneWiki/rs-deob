...
public class class244 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZLda;[Lrs;)Lvo;", line = 43)
