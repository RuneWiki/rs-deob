...
public class class244 extends class398 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IBILii;ILls;II)Lcq;")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lva;)V")
