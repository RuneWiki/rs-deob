...
public class class244 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IBIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BLmi;[[B)V", line = 128)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIII)I", line = 188)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "([Ljava/lang/String;[SI)V", line = 219)
