...
public class class244 {
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(ILjava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "()V", line = 47)
    public class244() {
    }

    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Lib;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILjava/lang/String;)I", line = 68)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(I)V", line = 79)
