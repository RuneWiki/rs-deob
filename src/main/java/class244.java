...
public class class244 extends class407 implements class483 {
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lmc;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lmc;Lkf;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ILpj;)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I[FIIILkf;IIB)V")
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lmc;Lkf;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lmc;Lkf;Lps;II)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "([BIIILkf;ZIII)V")
