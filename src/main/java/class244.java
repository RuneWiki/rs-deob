...
public class class244 extends class282 implements class2 {
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Lou;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILtc;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILtc;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILtc;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ltc;Lqw;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ltc;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ltc;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ltc;Lqw;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lb;IIII)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lsn;")
