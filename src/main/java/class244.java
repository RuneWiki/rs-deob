...
public class class244 extends class281 {
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(III)Z", line = 12)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/lang/String;Laj;IZ)Lhca;", line = 27)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Loba;B)I", line = 84)
