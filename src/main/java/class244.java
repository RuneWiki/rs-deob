...
public class class244 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)Lpb;", line = 16)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lta;Z)I", line = 44)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(II)V", line = 154)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(FIIFIFIFFILgg;)[B", line = 171)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZLqq;)V", line = 282)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 309)
