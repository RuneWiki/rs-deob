...
public class class244 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLkj;I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)Z", line = 32)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IZZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lfd;)V", line = 146)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)I", line = 172)
