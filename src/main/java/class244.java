...
public class class244 implements Runnable {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(ILmi;I[B)Ljk;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(IIIZ[IIILrda;)Lqd;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Lmi;II)Ljk;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(ILjk;)V")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(BILmi;)Ljk;")
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "(Lkk;)V")
