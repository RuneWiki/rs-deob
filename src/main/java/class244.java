...
public class class244 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lji;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Z)Liba;", line = 28)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lji;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIB)V", line = 75)
