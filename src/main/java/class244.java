...
public class class244 extends class349 {
    ...
    @OriginalMember(owner = "client!dfa", name = "f", descriptor = "(I)Lmaa;", line = 3)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IB)[[I", line = 30)
    ...
    @OriginalMember(owner = "client!dfa", name = "g", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILdga;)V", line = 125)
    ...
    @OriginalMember(owner = "client!dfa", name = "d", descriptor = "(III)Z", line = 161)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "()V", line = 1043)
    public class244() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZI)[[[B", line = 178)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lfca;IIZB)V", line = 960)
