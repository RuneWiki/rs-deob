...
public class class244 extends class145 {
    ...
    @OriginalMember(owner = "client!oaa", name = "e", descriptor = "(I)I", line = 4)
    public final int method868(int arg0) {
        ++field3449;
        return arg0 != -1 ? -77 : this.field3455;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(BI)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "()V", line = 84)
    public class244() {
        super(0, false);
    }

    @OriginalMember(owner = "client!oaa", name = "i", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IILrt;)V", line = 104)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(III)V", line = 139)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(I)V", line = 159)
