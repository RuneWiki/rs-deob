...
public class class244 extends Callback {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/awt/Component;ZZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BII)V", line = 54)
    ...
    @OriginalMember(owner = "client!tg", name = "callback", descriptor = "(IIII)I", line = 64)
