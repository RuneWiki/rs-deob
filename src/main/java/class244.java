...
public class class244 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)Z", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lek;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;IBLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 60)
