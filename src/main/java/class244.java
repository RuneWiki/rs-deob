...
public class class244 extends class499 {
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lja;Lmea;IIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)Leu;")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "([ILpba;I[I[I)V")
