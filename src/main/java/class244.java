...
public class class244 extends class443 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lfb;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IILfb;)V", line = 53)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 106)
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 146)
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(II)I", line = 197)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(II)Z", line = 225)
