...
public class class244 extends class30 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(Z)V", line = 248)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZ)Z", line = 272)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IB)[[I", line = 287)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "()V", line = 602)
    public class244() {
        super(2, false);
    }

    @OriginalMember(owner = "client!kv", name = "c", descriptor = "(B)V", line = 606)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BILac;)V", line = 620)
