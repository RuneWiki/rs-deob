...
public class class244 extends class31 {
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lgk;IIZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "g", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lgk;II)V", line = 69)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lgk;IIZ[[BI)V", line = 86)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIIB)V", line = 56)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 105)
