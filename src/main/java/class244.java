...
public class class244 extends class45 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BLio;)Ldt;", line = 37)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIII)Z", line = 63)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(II)V", line = 97)
