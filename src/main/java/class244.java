...
public class class244 extends class310 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!ab", name = "h", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIIIIII)V", line = 74)
