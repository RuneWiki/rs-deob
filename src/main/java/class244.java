...
public class class244 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(III)Lmk;", line = 21)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(II)V", line = 34)
