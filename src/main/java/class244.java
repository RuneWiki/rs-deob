...
public class class244 extends class480 implements class248 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BLqa;)V")
    public final void method25(byte arg0, class162 arg1) {
        int var3 = 105 % ((arg0 + 45) / 48);
        field3506++;
    }

    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZLqa;)Lae;")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILqa;ZLto;III)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(IIILag;)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lqa;II)Lc;")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILqa;II)Z")
