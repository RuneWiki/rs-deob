...
public class class244 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lqa;ILba;IILqi;Lqa;IIZZI)Laa;", line = 25)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III)Z", line = 137)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IILqi;IILqa;II)Laa;", line = 169)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IB)V", line = 205)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Z)V", line = 231)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BI)Lri;", line = 250)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Liv;IZLau;Luu;Luu;)V", line = 350)
