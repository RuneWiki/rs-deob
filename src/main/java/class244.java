...
public class class244 extends class83 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lho;IILrd;BIILwg;)V", line = 8)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(III)V", line = 101)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IBIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(III)V", line = 196)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IZI)V", line = 215)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(IIIIIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)V", line = 242)
