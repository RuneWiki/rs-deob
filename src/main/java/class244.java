...
public class class244 extends class176 {
    ...
    @OriginalMember(owner = "client!sb", name = "X", descriptor = "(IILk;)Lk;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lk;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lte;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILfa;II)V")
    ...
    @OriginalMember(owner = "client!sb", name = "ya", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!sb", name = "F", descriptor = "(Lk;IIIIZ)V")
