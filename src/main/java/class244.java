...
public class class244 extends class577 {
    ...
    @OriginalMember(owner = "client!dia", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!dia", name = "d", descriptor = "(B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(ILcp;IZ)V", line = 43)
