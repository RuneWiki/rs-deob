...
public class class244 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)Lmo;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lmo;Z)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(CZ)C")
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)Lmo;")
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(I)Lmo;")
