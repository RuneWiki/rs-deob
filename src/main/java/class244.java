...
public class class244 extends class529 {
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "()V", line = 4)
    public class244() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IBIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IB)[I", line = 27)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IBLtn;)V", line = 127)
    ...
    @OriginalMember(owner = "client!uc", name = "f", descriptor = "(I)V", line = 171)
