...
public class class244 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Loq;IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILil;)V", line = 69)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lqj;ILqj;Lnr;)V", line = 114)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I[I[Ljava/lang/Object;II)V", line = 151)
