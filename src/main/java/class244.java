...
public class class244 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I[BII[BI)I", line = 6)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "([BIIII[B)I", line = 166)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "([B)V", line = 245)
