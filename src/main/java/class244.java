...
public class class244 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI)V", line = 212)
