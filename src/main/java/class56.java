...
public class class56 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lff;ILff;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)Ltf;")
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Z)Ltf;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BILah;Ljava/awt/Canvas;)Le;")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lbn;)V")
