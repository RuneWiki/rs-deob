...
@OriginalClass("client!SCDBMUNA")
public class class56 {

    @OriginalMember(owner = "client!SCDBMUNA", name = "e", descriptor = "I")
    public int field1415 = -1;

    @OriginalMember(owner = "client!SCDBMUNA", name = "f", descriptor = "Z")
    public boolean field1416 = false;

    @OriginalMember(owner = "client!SCDBMUNA", name = "g", descriptor = "Z")
    public boolean field1417 = true;

    @OriginalMember(owner = "client!SCDBMUNA", name = "a", descriptor = "I")
    public static int field1411;

    @OriginalMember(owner = "client!SCDBMUNA", name = "d", descriptor = "I")
    public int field1414;

    @OriginalMember(owner = "client!SCDBMUNA", name = "h", descriptor = "I")
    public int field1418;

    @OriginalMember(owner = "client!SCDBMUNA", name = "i", descriptor = "I")
    public int field1419;

    @OriginalMember(owner = "client!SCDBMUNA", name = "j", descriptor = "I")
    public int field1420;

    @OriginalMember(owner = "client!SCDBMUNA", name = "k", descriptor = "I")
    public int field1421;

    @OriginalMember(owner = "client!SCDBMUNA", name = "l", descriptor = "I")
    public int field1422;

    @OriginalMember(owner = "client!SCDBMUNA", name = "m", descriptor = "I")
    public int field1423;

    @OriginalMember(owner = "client!SCDBMUNA", name = "c", descriptor = "Ljava/lang/String;")
    public String field1413;

    @OriginalMember(owner = "client!SCDBMUNA", name = "b", descriptor = "[LSCDBMUNA;")
    public static class56[] field1412;

    @OriginalMember(owner = "client!SCDBMUNA", name = "a", descriptor = "(LDYBMLHQM;Z)V")
    ...
    @OriginalMember(owner = "client!SCDBMUNA", name = "a", descriptor = "(ILINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!SCDBMUNA", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!SCDBMUNA", name = "a", descriptor = "(III)I")
