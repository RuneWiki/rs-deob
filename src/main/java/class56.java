...
public class class56 {
    ...
    @OriginalMember(owner = "client!WIZYUELH", name = "c", descriptor = "[LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!WIZYUELH", name = "a", descriptor = "(J)LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!WIZYUELH", name = "a", descriptor = "(LCSUKQTYW;JI)V")
