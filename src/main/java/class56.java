...
public class class56 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lba;III[Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIIIIII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 66)
    public class56(String arg0, int arg1) {
        this.field688 = arg1;
    }

    @OriginalMember(owner = "client!kl", name = "toString", descriptor = "()Ljava/lang/String;", line = 76)
