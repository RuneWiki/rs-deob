...
public class class56 extends class5 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "()V", line = 92)
    public class56() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILes;I)V", line = 105)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIIB)I", line = 134)
