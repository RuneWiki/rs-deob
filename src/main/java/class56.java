...
public abstract class class56 extends class140 {
    ...
    @OriginalMember(owner = "client!gv", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(IIII)V", line = 44)
