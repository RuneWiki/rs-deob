...
public class class56 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lgga;I)Lhga;", line = 16)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(I)V", line = 102)
