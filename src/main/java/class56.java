...
public abstract class class56 extends class189 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I)I", line = 11)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IZ)[I", line = 23)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(II)[[I", line = 35)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(III)[I", line = 129)
    ...
    @OriginalMember(owner = "client!tga", name = "d", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!tga", name = "d", descriptor = "(III)[[I", line = 165)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILee;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(IZ)V", line = 216)
    public class56(int arg0, boolean arg1) {
        this.field674 = arg1;
        this.field667 = new class56[arg0];
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(III[BI[BIII)V", line = 228)
