...
public class class56 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIIB)Lin;", line = 22)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(B)Lou;", line = 34)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZI)Z", line = 45)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZLcu;)V", line = 91)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(IIIIB)V", line = 261)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lin;I)V", line = 273)
