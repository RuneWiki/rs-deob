...
public class class56 extends class140 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lub;[III)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ILdt;)Lea;")
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Llf;IIZ)V")
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Llf;IIII)V")
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Llf;II[III)V")
