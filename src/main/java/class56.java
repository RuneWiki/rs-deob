...
public class class56 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lud;BI)V")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lud;B)V")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I)Lfw;")
