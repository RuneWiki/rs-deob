...
public class class56 extends class328 {
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "()V", line = 4)
    public class56() {
        super(0, false);
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BI)I", line = 7)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(BI)I", line = 38)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BILco;)V", line = 60)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IZC)C", line = 73)
    ...
    @OriginalMember(owner = "client!rq", name = "f", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(III)V", line = 179)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(II)[[I", line = 199)
