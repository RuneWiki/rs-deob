...
public class class56 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "([BB)[B", line = 4)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZI)I", line = 105)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BI)I", line = 124)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(II)V", line = 141)
