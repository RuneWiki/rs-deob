...
public class class56 extends class54 {
    ...
    @OriginalMember(owner = "client!UFGXOLGK", name = "pb", descriptor = "LEOJHVRZF;")
    ...
    @OriginalMember(owner = "client!UFGXOLGK", name = "Bb", descriptor = "LJKAPIYZO;")
    public class24 field1481;

    @OriginalMember(owner = "client!UFGXOLGK", name = "Fb", descriptor = "LWEVRTBOZ;")
    public class66 field1485;

    @OriginalMember(owner = "client!UFGXOLGK", name = "Ib", descriptor = "Ljava/lang/String;")
    public String field1488;

    @OriginalMember(owner = "client!UFGXOLGK", name = "a", descriptor = "(I)LWEVRTBOZ;")
    ...
    @OriginalMember(owner = "client!UFGXOLGK", name = "a", descriptor = "(Z)LWEVRTBOZ;")
    ...
    @OriginalMember(owner = "client!UFGXOLGK", name = "a", descriptor = "(BLUAWAYCTK;)V")
    ...
    @OriginalMember(owner = "client!UFGXOLGK", name = "b", descriptor = "(B)LWEVRTBOZ;")
