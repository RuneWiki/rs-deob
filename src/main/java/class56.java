...
public class class56 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lrh;IIII)Z")
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
