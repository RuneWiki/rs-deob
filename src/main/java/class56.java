...
public class class56 extends class326 {
    ...
    @OriginalMember(owner = "client!sd", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(II)Lbp;", line = 29)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lnn;)V", line = 67)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILbt;I)V", line = 158)
