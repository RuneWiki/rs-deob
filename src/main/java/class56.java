...
public class class56 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)Lsu;", line = 5)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(II)V", line = 238)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BZ)V", line = 264)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lqg;IZLvd;Lvd;)V", line = 384)
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(II)Z", line = 283)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lvs;)V", line = 295)
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(II)V", line = 301)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ZI)V", line = 313)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IZ)V", line = 331)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 350)
