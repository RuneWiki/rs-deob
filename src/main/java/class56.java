...
public class class56 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!TFSZPSRF", name = "p", descriptor = "[LYZDAHXEQ;")
    ...
    @OriginalMember(owner = "client!TFSZPSRF", name = "q", descriptor = "LAPBCEOWT;")
    public class1 field1557;

    @OriginalMember(owner = "client!TFSZPSRF", name = "o", descriptor = "LYOIXICCU;")
