...
public class class56 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Ldd;IJ)V")
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BJ)Ldd;")
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)Ldd;")
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B[Ldd;)I")
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(I)Ldd;")
    ...
    @OriginalMember(owner = "client!vg", name = "e", descriptor = "(I)Ldd;")
    ...
    @OriginalMember(owner = "client!vg", name = "f", descriptor = "(I)[Lnj;")
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lfh;ILgt;I)V")
