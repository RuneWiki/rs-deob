...
public class class56 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBLrg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILrg;)V", line = 38)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 65)
