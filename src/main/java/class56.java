...
public class class56 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILhd;I)I", line = 127)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Len;II)V", line = 580)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)J", line = 147)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(B)Ljava/io/File;", line = 161)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IJ)V", line = 175)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I[B)V", line = 200)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "([BBII)V", line = 215)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(B)V", line = 346)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II[BI)V", line = 359)
