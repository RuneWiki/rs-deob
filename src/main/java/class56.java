...
public class class56 extends class756 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lkp;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIII)Z", line = 39)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(BLib;)V", line = 84)
