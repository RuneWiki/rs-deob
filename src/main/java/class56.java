...
public class class56 extends class101 {
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(B)[I", line = 3)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 33)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Ljp;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!hka", name = "<init>", descriptor = "(Ljp;)V", line = 279)
    public class56(class376 arg0) {
        this.method401(arg0, (byte) 125);
    }

    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(FIZFIIILgv;F[BFIFI)V", line = 146)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(II)V", line = 199)
    ...
    @OriginalMember(owner = "client!hka", name = "b", descriptor = "(III)Lkp;", line = 215)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(I)Ljava/lang/String;", line = 236)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Lwq;I)V", line = 262)
