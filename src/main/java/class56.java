...
public class class56 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILlm;I)Lcl;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLfb;J)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(JZ)Lfb;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B[Lfb;)I")
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!vk", name = "d", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(Z)Lfb;")
