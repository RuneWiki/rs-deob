...
public class class56 extends class435 {
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lfo;)Z")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lfo;I)Lkl;")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lfo;II)Lkl;")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "([I)Ljj;")
