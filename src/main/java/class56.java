...
public class class56 extends class529 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(III)I", line = 36)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLdn;)V", line = 65)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I[[BLbi;)V", line = 90)
