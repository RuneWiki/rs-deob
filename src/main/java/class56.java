...
public class class56 extends class144 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Loa;B)Laca;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lba;ILoa;Lq;)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(Loa;I)Lew;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILoa;II)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIILva;Loa;ZI)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IILoa;I)Z")
