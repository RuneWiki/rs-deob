...
public class class56 extends class377 {
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "()V", line = 148)
    public class56() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILji;)V", line = 90)
