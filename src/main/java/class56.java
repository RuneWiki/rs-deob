...
public abstract class class56 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 200)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 215)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(IIIII)V", line = 378)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 275)
