...
public abstract class class56 {
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lbv;)V", line = 150)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Ljava/awt/Component;Lhu;III)Lfe;", line = 180)
