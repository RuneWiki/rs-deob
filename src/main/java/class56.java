...
public class class56 extends class695 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lnm;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lmba;Lpe;)V", line = 23)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!qb", name = "e", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)Z", line = 122)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZB)V", line = 182)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(B)V", line = 240)
