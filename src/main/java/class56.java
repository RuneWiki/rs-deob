...
public class class56 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BI)Lwfa;", line = 33)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lwga;Ld;)V", line = 86)
