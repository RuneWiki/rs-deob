...
public abstract class class56 extends class379 {
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!aea", name = "c", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(II)[I", line = 55)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(BILes;)V", line = 95)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIB)[I", line = 108)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(B)V", line = 129)
    public void method493(byte arg0) {
        field757++;
        int var2 = 43 / ((37 - arg0) / 62);
    }

    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(BI)[[I", line = 157)
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(III)[[I", line = 170)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIIIZII)V", line = 205)
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(I)I", line = 257)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(IZ)V", line = 269)
