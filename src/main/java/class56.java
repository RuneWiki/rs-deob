...
public class class56 extends class164 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IBZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(IIII)[B", line = 57)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZI)Z", line = 70)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 84)
    public class56() {
