...
public class class56 {
    ...
    @OriginalMember(owner = "client!UEUSJYYO", name = "g", descriptor = "LETJKXQLD;")
    ...
    @OriginalMember(owner = "client!UEUSJYYO", name = "e", descriptor = "[LUEUSJYYO;")
    ...
    @OriginalMember(owner = "client!UEUSJYYO", name = "a", descriptor = "(IB)LUEUSJYYO;")
