...
public class class56 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIILdg;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZIIIB[Lp;IIIILae;[B)[I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ldg;II)V")
