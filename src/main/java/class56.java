...
public class class56 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!am", name = "finalize", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Ldw;II)V", line = 36)
