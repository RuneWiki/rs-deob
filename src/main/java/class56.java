...
public class class56 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIZ)Z", line = 7)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IB)V", line = 94)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(II)Lqca;", line = 148)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lfs;IZLlga;Llga;)V", line = 196)
