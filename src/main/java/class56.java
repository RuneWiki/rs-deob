...
public class class56 extends class34 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!vg", name = "e", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "()V", line = 126)
    public class56() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(IB)Z", line = 131)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lsv;II)V", line = 141)
