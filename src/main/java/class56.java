...
public class class56 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZIIZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)Lmv;", line = 222)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)V", line = 239)
