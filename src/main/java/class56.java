...
public class class56 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IZ)Lgn;", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ldp;Ldp;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)Z", line = 80)
