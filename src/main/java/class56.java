...
public class class56 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lag;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[BIII[B)I", line = 64)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([BIII[BI)I", line = 133)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "([B)V", line = 279)
