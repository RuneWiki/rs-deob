...
public class class56 extends class295 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lsn;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZILba;ILqa;IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(BLui;)V", line = 160)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(B)V", line = 328)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZLsn;)V", line = 350)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(II)V", line = 378)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZFIILo;)V", line = 403)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(I)V", line = 434)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(Lsn;I)V", line = 447)
    ...
    @OriginalMember(owner = "client!jv", name = "d", descriptor = "(II)V", line = 496)
