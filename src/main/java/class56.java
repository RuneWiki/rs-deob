...
public class class56 extends class115 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(II)[I", line = 158)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BLbk;I)V", line = 229)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "()V", line = 361)
    public class56() {
        super(1, true);
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)V", line = 294)
    ...
    @OriginalMember(owner = "client!eg", name = "e", descriptor = "(B)V", line = 307)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(III)B", line = 338)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(I)V", line = 376)
