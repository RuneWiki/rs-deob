...
public class class56 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lih;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lih;Ljaggl/memory/NativeBuffer;)V", line = 21)
