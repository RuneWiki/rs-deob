...
public class class56 extends class635 implements class142 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ltg;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ldga;Ldga;FLdga;)Ldga;")
    ...
    @OriginalMember(owner = "client!da", name = "p", descriptor = "()Lhl;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lba;Ltg;Lq;Lmr;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(I)Li;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIF)Lod;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ltg;Z)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Led;[Laaa;Z)Lta;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Laaa;Z)Lxa;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lod;)V")
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(IIIIII)Ldga;")
    ...
    @OriginalMember(owner = "client!da", name = "u", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lqda;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lq;[Lmr;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ldga;)V")
