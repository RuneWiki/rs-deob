...
@OriginalClass("client!TGBMMCBD")
public class class56 extends class6 {

    @OriginalMember(owner = "client!TGBMMCBD", name = "x", descriptor = "I")
    private int field1468 = 5;

    @OriginalMember(owner = "client!TGBMMCBD", name = "m", descriptor = "I")
    private int field1457;

    @OriginalMember(owner = "client!TGBMMCBD", name = "n", descriptor = "I")
    private int field1458;

    @OriginalMember(owner = "client!TGBMMCBD", name = "o", descriptor = "I")
    private int field1459;

    @OriginalMember(owner = "client!TGBMMCBD", name = "p", descriptor = "I")
    private int field1460;

    @OriginalMember(owner = "client!TGBMMCBD", name = "q", descriptor = "I")
    private int field1461;

    @OriginalMember(owner = "client!TGBMMCBD", name = "r", descriptor = "I")
    private int field1462;

    @OriginalMember(owner = "client!TGBMMCBD", name = "s", descriptor = "I")
    private int field1463;

    @OriginalMember(owner = "client!TGBMMCBD", name = "y", descriptor = "LEJHGNUGE;")
    private class9 field1469;

    @OriginalMember(owner = "client!TGBMMCBD", name = "z", descriptor = "I")
    private int field1470;

    @OriginalMember(owner = "client!TGBMMCBD", name = "l", descriptor = "I")
    private int field1456;

    @OriginalMember(owner = "client!TGBMMCBD", name = "v", descriptor = "I")
    public int field1466;

    @OriginalMember(owner = "client!TGBMMCBD", name = "w", descriptor = "I")
    public int field1467;

    @OriginalMember(owner = "client!TGBMMCBD", name = "t", descriptor = "[I")
    public int[] field1464;

    @OriginalMember(owner = "client!TGBMMCBD", name = "u", descriptor = "Lclient;")
    public static client field1465;

    @OriginalMember(owner = "client!TGBMMCBD", name = "<init>", descriptor = "(IIIIIIZIBI)V")
    ...
    @OriginalMember(owner = "client!TGBMMCBD", name = "a", descriptor = "(I)LRUJAIVBH;")
    ...
    @OriginalMember(owner = "client!TGBMMCBD", name = "a", descriptor = "(B)LGEUHTGZJ;")
