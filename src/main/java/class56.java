...
public class class56 extends class71 {
    ...
    @OriginalMember(owner = "client!fe", name = "o", descriptor = "[Loc;")
    private static class133[] field1119;

    @OriginalMember(owner = "client!fe", name = "u", descriptor = "[Lqc;")
    private static class151[] field1125;

    @OriginalMember(owner = "client!fe", name = "Q", descriptor = "[Lg;")
    private static class61[] field1147;

    @OriginalMember(owner = "client!fe", name = "t", descriptor = "[Lgd;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([I)Lk;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lbg;)Z")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lbg;II)Lfe;")
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)[F")
