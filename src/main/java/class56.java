...
public class class56 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lsl;BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIBILka;)Lka;", line = 246)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILka;BIIIIB)Lka;", line = 385)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 447)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)I", line = 474)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIBZ)I", line = 491)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLsl;)V", line = 648)
