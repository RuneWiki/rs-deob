...
@OriginalClass("client!SWVPDERM")
public class class56 {

    @OriginalMember(owner = "client!SWVPDERM", name = "a", descriptor = "Z")
    private boolean field1435 = true;

    @OriginalMember(owner = "client!SWVPDERM", name = "b", descriptor = "Z")
    private boolean field1436 = true;

    @OriginalMember(owner = "client!SWVPDERM", name = "c", descriptor = "I")
    private int field1437 = 7;

    @OriginalMember(owner = "client!SWVPDERM", name = "d", descriptor = "LOEHUIBBM;")
    public class37 field1438 = new class37();

    @OriginalMember(owner = "client!SWVPDERM", name = "e", descriptor = "LOEHUIBBM;")
    private class37 field1439;

    @OriginalMember(owner = "client!SWVPDERM", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "a", descriptor = "(LOEHUIBBM;)V")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "a", descriptor = "(BLOEHUIBBM;)V")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "a", descriptor = "()LOEHUIBBM;")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "b", descriptor = "()LOEHUIBBM;")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "a", descriptor = "(B)LOEHUIBBM;")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "a", descriptor = "(I)LOEHUIBBM;")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "b", descriptor = "(I)LOEHUIBBM;")
    ...
    @OriginalMember(owner = "client!SWVPDERM", name = "c", descriptor = "()V")
