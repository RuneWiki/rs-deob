...
public class class56 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)V", line = 57)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BI)V", line = 95)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(II)Lda;", line = 113)
    ...
    @OriginalMember(owner = "client!gv", name = "d", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Loq;IZLbu;Lbu;)V", line = 193)
