...
public class class680 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILob;)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)Lob;")
