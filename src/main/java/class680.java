...
public abstract class class680 implements class451 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFFFIIIII)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFII)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFFFFFIII)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(IIII)V")
    public final void method3860(int arg0, int arg1, int arg2, int arg3) {
        this.method671(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFIIIII)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FFFFIILaa;II)V")
