...
public class class680 extends Callback {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!gi", name = "callback", descriptor = "(IIII)I", line = 18)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Ljava/awt/Component;ZI)V", line = 62)
