...
public class class680 extends class443 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(BIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!pea", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pea", name = "e", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IIII)[B", line = 124)
    ...
    @OriginalMember(owner = "client!pea", name = "f", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ILag;I)Lbo;", line = 151)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "()V", line = 178)
    public class680() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(III)Z", line = 181)
