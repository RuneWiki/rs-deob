...
public class class680 extends class60 {
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lhd;)V")
    public class680(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(ILhd;)V")
