...
public class class680 extends class339 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lvt;[I)V")
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(II)Lbu;")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILofa;)Lwda;")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lnj;III)V")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lrs;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BI[Lraa;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IILla;JIIZ)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZLqg;)I")
    ...
    @OriginalMember(owner = "client!ru", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ru", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!ru", name = "wa", descriptor = "(Lr;IIIIZ)V")
