...
public class class680 extends class318 {
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lpq;IIZ)V")
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lpq;IIII)V")
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lpq;II[III)V")
