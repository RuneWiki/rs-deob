...
public class class680 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IILig;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILig;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 81)
