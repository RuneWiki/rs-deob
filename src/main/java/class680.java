...
public class class680 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)[Lkga;", line = 7)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIZ)V", line = 61)
