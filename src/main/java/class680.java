...
public class class680 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBLjava/lang/String;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljp;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(III)I", line = 273)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLii;)Z", line = 299)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILjp;)V", line = 352)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZILha;)Lvr;", line = 376)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lha;B)Lvr;", line = 418)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 516)
