...
public class class680 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILac;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lac;IB)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lac;B)Lnga;")
