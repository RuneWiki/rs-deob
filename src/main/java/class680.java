...
public class class680 extends class314 {
    ...
    @OriginalMember(owner = "client!cc", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)Lkt;", line = 15)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lk;Ljava/lang/String;ZI)Lsw;", line = 45)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLie;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)[[I", line = 169)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 269)
    public class680() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lss;IIFFBIFFFI)[B", line = 255)
