...
public class class680 {
    ...
    @OriginalMember(owner = "client!nfa", name = "finalize", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IB)Z", line = 37)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lrda;J[Lcba;)V", line = 48)
