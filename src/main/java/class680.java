...
public class class680 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIBJ)V", line = 7)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZLfb;)I", line = 71)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I[Ljava/awt/Rectangle;I)V", line = 98)
