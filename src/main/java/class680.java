...
public class class680 extends class458 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lnb;B)I")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lap;IIII)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lap;II[III)V")
