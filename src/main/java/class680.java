...
public class class680 extends class651 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)[Luu;", line = 85)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lha;Lkw;Lit;J)V", line = 407)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lha;IJZZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lha;IJ)V", line = 370)
