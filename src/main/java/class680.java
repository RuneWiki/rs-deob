...
public class class680 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(III[I)Lma;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZLlea;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[IZ)Lma;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[III)Lma;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[II)Lma;")
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lkha;Lkha;)V")
