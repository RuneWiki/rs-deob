...
public class class680 extends class141 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(II)[[I", line = 39)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I[BILjava/lang/String;)I", line = 88)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIB)Z", line = 130)
    ...
    @OriginalMember(owner = "client!ww", name = "f", descriptor = "(I)V", line = 152)
