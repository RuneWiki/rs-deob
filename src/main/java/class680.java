...
public class class680 extends class154 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIIZ)Z", line = 19)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIBI)V", line = 90)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BIFII)V", line = 102)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "([IZI)V", line = 222)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lek;IIIII)V", line = 399)
