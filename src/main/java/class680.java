...
public class class680 extends class605 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIB)Z", line = 57)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lji;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(B)V", line = 576)
