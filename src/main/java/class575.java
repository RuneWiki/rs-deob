...
public class class575 extends class53 implements class28 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IILpa;II)V", line = 12)
    public final void method323(int arg0, int arg1, class311 arg2, int arg3, int arg4) {
        this.method3424(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!t", name = "BA", descriptor = "(III)V", line = 30)
    public final void method321(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(La;Lc;[IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(La;Lc;IIII)V", line = 39)
