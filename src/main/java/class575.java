...
public class class575 extends class340 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pda", name = "f", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIBI)[B", line = 41)
    ...
    @OriginalMember(owner = "client!pda", name = "g", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "()V", line = 101)
    public class575() {
