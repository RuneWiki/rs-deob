...
public class class575 extends class324 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lqn;I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BLjava/lang/String;)I", line = 39)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILfm;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(I[B)V", line = 108)
