...
public class class575 extends class413 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ILew;B)V")
    ...
    @OriginalMember(owner = "client!lba", name = "c", descriptor = "()Lpp;")
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "()Lpp;")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IILew;BI[I)V")
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Ltga;)V")
