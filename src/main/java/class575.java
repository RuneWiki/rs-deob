...
public class class575 extends class283 implements class544 {
    ...
    @OriginalMember(owner = "client!te", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 6)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILju;)V", line = 16)
    public final void method43(int arg0, class115 arg1) {
        super.method43(arg0, arg1);
    }

    @OriginalMember(owner = "client!te", name = "c", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Ltga;Lnh;III[B)V", line = 34)
