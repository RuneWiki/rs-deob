...
public class class575 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Z)[I", line = 3)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 22)
    ...
    @OriginalMember(owner = "client!bha", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 33)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IIIIILjava/awt/Frame;)V", line = 50)
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "()V", line = 67)
    public class575() {
