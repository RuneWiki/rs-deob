...
public class class575 extends class747 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BI)[I", line = 45)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ldc;II)V", line = 295)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "()V", line = 321)
    public class575() {
        super(1, true);
    }
}
