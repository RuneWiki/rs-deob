...
public class class575 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "()I", line = 15)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "()V", line = 162)
    public class575() {
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "()[F", line = 304)
