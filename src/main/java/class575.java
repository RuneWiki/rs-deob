...
public class class575 extends class334 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BLfm;)I", line = 7)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "()V", line = 85)
    public class575() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(II)[I", line = 99)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(II)I", line = 180)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IZLol;)V", line = 200)
