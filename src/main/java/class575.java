...
public class class575 extends class569 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ZLr;IJI)V", line = 5)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILr;J)V", line = 261)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "([[[Lvf;I)V", line = 322)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(B)V", line = 409)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lr;Lhi;Ltq;J)V", line = 451)
