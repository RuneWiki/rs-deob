...
public class class575 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BILgf;I)V", line = 501)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 515)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 531)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkr;ILpu;)V", line = 551)
