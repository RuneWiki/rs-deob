...
public class class575 extends class409 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(CIIIZLua;II)V", line = 137)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lrfa;Laga;[Ltq;[I[I)V", line = 200)
    ...
    @OriginalMember(owner = "client!cm", name = "OA", descriptor = "(CIIIZ)V", line = 240)
