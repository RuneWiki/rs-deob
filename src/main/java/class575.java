...
public class class575 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIIBI)I", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Ljava/awt/Color;Ljava/lang/String;Ljava/awt/Color;ILjava/awt/Color;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 173)
