...
public class class575 extends class578 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lac;I)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "([ILac;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILac;)V", line = 58)
    ...
    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(Lac;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(Z)I", line = 176)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)I", line = 190)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLls;)V", line = 208)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Lgo;", line = 239)
    ...
    @OriginalMember(owner = "client!tl", name = "g", descriptor = "(I)Ljava/lang/String;", line = 259)
