...
public class class575 extends class108 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I[II)V", line = 41)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIB)I", line = 198)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIIFI)V", line = 222)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BI)V", line = 346)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lhm;IIIII)V", line = 360)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)V", line = 375)
