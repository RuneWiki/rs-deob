...
public class class575 extends class458 implements class706 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(ILha;)Lkj;", line = 37)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(B)Z", line = 55)
    public final boolean method867(byte arg0) {
        ++field8134;
        return arg0 <= 82 ? false : this.field8133;
    }

    @OriginalMember(owner = "client!fia", name = "i", descriptor = "(B)I", line = 72)
    ...
    @OriginalMember(owner = "client!fia", name = "i", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;ZIB)Lqha;", line = 108)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Z)Z", line = 138)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(BLha;)Lml;", line = 154)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(BLha;)V", line = 181)
    public final void method753(byte arg0, class58 arg1) {
        ++field8132;
        int var3 = 27 / ((18 - arg0) / 40);
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;II)Lka;", line = 190)
    ...
    @OriginalMember(owner = "client!fia", name = "c", descriptor = "(B)I", line = 212)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(ILha;)V", line = 224)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(B)I", line = 252)
    ...
    @OriginalMember(owner = "client!fia", name = "g", descriptor = "(B)I", line = 263)
    ...
    @OriginalMember(owner = "client!fia", name = "e", descriptor = "(I)Z", line = 275)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;III)Z", line = 290)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;B)V", line = 313)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(Z)V", line = 341)
    ...
    @OriginalMember(owner = "client!fia", name = "d", descriptor = "(B)V", line = 354)
