...
public class class575 implements Runnable {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(JLjava/lang/String;Lpaa;II)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIILps;)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lhs;I)V")
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(B)Lpaa;")
