...
public class class292 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "([BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(I)V", line = 62)
    public static void method1931(int arg0) {
        int var1 = 4 % ((-arg0 - 81) / 45);
        field4287 = null;
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(BJ[B)V", line = 179)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(Z)V", line = 268)
