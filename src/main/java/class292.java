...
public class class292 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ZIIBIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 132)
