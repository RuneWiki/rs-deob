...
public class class292 extends class346 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IILjava/awt/Graphics;III)V", line = 30)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 49)
