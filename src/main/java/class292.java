...
public class class292 extends class47 {
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIZLae;B)V", line = 66)
