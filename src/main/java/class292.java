...
public class class292 extends class397 {
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "()V", line = 5)
    public class292() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(II)[I", line = 10)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BI)[[I", line = 44)
    ...
    @OriginalMember(owner = "client!vj", name = "f", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!vj", name = "e", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IBLae;)V", line = 170)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IC)Z", line = 184)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(II)Z", line = 195)
