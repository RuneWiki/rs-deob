...
public abstract class class292 extends class130 {
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "()I", line = 5)
    public final int method877() {
        return this.field4033 + this.field4018 + this.field4021;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(FFFFFF)V", line = 9)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "()I", line = 146)
    public final int method876() {
        return this.field4033;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "()I", line = 150)
    public final int method874() {
        return this.field4045 + this.field4041 + this.field4015;
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IIIIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(FFFFFFIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "()I", line = 292)
    public final int method880() {
        return this.field4041;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(FFFFFFLtm;II)V", line = 302)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIII)V", line = 333)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lkp;II)V", line = 340)
