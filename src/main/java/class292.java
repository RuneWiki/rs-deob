...
public class class292 implements class479 {
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(II)Ldu;")
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(II)Lof;")
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lpq;Lpq;Lpq;)V")
