...
public class class292 extends class476 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILdc;I)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIILnt;IB)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZLpf;Z)V")
