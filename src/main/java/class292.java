...
public abstract class class292 {
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IB)V", line = 67)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 124)
