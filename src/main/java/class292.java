...
public class class292 extends class299 {
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(B)Ltv;", line = 23)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(I)J", line = 41)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!ij", name = "g", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(I)I", line = 77)
