...
public class class292 extends class446 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(FB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BF)V", line = 19)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(I)V", line = 33)
