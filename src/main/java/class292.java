...
public class class292 implements class206 {
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BLjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;)Z", line = 37)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BI)I", line = 52)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(II)I", line = 68)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ZB)V", line = 170)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Ljava/lang/Object;", line = 357)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)I", line = 379)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(JI)Z", line = 395)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)I", line = 407)
    ...
    @OriginalMember(owner = "client!jfa", name = "d", descriptor = "(B)V", line = 425)
