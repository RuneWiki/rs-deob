...
public class class292 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(III)I", line = 10)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lgj;)V", line = 89)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)V", line = 72)
