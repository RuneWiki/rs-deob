...
public class class292 extends class377 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(III)Z", line = 471)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIIIIII)V", line = 484)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)V", line = 522)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbo;II)V", line = 564)
