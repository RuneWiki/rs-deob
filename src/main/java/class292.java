...
public class class292 extends class126 {
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)I", line = 10)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)Lia;", line = 59)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lmo;BLmo;Lmo;Lmo;)V", line = 82)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(ILug;Lug;Lcq;Lbi;IIZ)V", line = 823)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Lij;", line = 320)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(B)V", line = 425)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZI)Los;", line = 469)
    ...
    @OriginalMember(owner = "client!ko", name = "f", descriptor = "(B)I", line = 683)
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(B)V", line = 706)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)V", line = 725)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZ)[B", line = 751)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(II)I", line = 769)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Z)I", line = 792)
