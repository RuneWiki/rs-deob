...
public class class292 implements Runnable {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Laj;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!up", name = "run", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BI[Ljava/lang/String;I)Ljava/lang/String;", line = 75)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lha;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZI)Lbq;", line = 229)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)Z", line = 247)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZIILkf;I)V", line = 289)
