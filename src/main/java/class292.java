...
public class class292 {
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "()Lkf;")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lrk;II)Les;")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lap;)V")
