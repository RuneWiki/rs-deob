...
public class class292 implements class324 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IZILhp;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IILuk;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Luk;III)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIILhp;I)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BILat;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lbt;)V")
