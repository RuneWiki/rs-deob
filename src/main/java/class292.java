...
public class class292 extends class472 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BLjava/awt/Graphics;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ljava/awt/Graphics;BIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 40)
