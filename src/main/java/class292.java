...
public class class292 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(B)Lea;")
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(I)Lea;")
