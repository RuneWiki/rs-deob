...
public class class292 implements class457 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IILbo;B)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIILbo;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILlk;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IILot;I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lkh;II)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lot;IB)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Luf;ILjava/awt/Component;II)Llr;")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Los;)V")
