...
public class class292 extends class169 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lr;J)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lss;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lss;IIIIIIIIIIIZZ)V")
