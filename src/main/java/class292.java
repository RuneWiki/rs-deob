...
public class class292 extends class53 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[BII)I", line = 19)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)V", line = 45)
    public static void method2055(byte arg0) {
        field4604 = null;
        int var1 = -66 % ((66 - arg0) / 59);
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ne", name = "finalize", descriptor = "()V", line = 70)
    protected final void finalize() {
        this.method588(24331);
        field4605++;
    }

    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "([BIII)V", line = 92)
