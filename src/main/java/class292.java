...
public class class292 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lli;B)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(ZLli;)Z")
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lno;)V")
