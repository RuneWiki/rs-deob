...
public class class292 extends class3 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IILmn;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)Law;", line = 85)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lih;IIIIII)V", line = 146)
