...
public class class292 extends class487 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IZLmq;)V", line = 8)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(IIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IBI)V", line = 77)
