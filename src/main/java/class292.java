...
public class class292 extends class404 {
    ...
    @OriginalMember(owner = "client!ti", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILha;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "()V", line = 151)
    public class292() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(II)[[I", line = 65)
