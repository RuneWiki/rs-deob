...
public class class292 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(II)Ljo;", line = 5)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILwl;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lpt;ILum;Lum;)V", line = 157)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(II)V", line = 173)
