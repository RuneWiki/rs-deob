...
public class class292 extends class74 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IILhfa;)V", line = 26)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIB)V", line = 66)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)Z", line = 108)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lgaa;Lpl;Lbd;)V", line = 187)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZZ)V", line = 234)
