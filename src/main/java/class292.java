...
public class class292 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IILpda;ZLka;Lha;IIZ)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILtd;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ZLha;ZIZ)Lka;")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lrba;I)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lha;Lac;IIIILrba;ZI)V")
