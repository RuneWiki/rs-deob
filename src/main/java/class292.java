...
public abstract class class292 implements class419 {
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!tha", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!tha", name = "finalize", descriptor = "()V", line = 50)
    ...
    @OriginalMember(owner = "client!tha", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ZB)V", line = 85)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(II[BIIB)V", line = 107)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IB)V", line = 139)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(B)Z", line = 156)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ZI)V", line = 179)
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(Lnv;IIIZ)V", line = 201)
