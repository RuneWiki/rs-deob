...
public abstract class class292 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IZI)Z", line = 22)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 72)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 138)
