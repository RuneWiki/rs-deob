...
public class class292 extends class180 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BI)Lms;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lfc;Lln;Lfc;Lfc;B)Z")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(III)Lof;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILlk;)Lcl;")
