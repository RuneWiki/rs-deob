...
public class class292 extends class207 {
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(ILrd;)V")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lrd;)V")
