...
public class class292 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!rga", name = "c", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(B)Z", line = 43)
    public final boolean method1935(byte arg0) {
        field4191++;
        return arg0 == 123 ? this.field4184 : true;
    }

    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Lni;Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!rga", name = "d", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(ZIIZ)V", line = 194)
