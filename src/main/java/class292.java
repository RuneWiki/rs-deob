...
public class class292 extends class192 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "()I", line = 3)
    public final int method1186() {
        return field3950.method2554(97, this.field3949);
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 6)
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "()V", line = 9)
    public final void method1188() {
        field3950.method2556(this.field3949, -97);
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "()V", line = 12)
    public final void method1191() {
        field3950.method2557(this.field3949, -12511);
    }

    @OriginalMember(owner = "client!tc", name = "c", descriptor = "()V", line = 15)
    public final void method1190() {
        field3950.method2555(this.field3949, super.field2778);
    }

    @OriginalMember(owner = "client!tc", name = "f", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lne;I)V", line = 25)
    public class292(class76 arg0, int arg1) {
        field3950 = arg0.method601(33);
        this.field3949 = arg1;
    }

    @OriginalMember(owner = "client!tc", name = "e", descriptor = "()V", line = 30)
