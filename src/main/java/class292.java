...
public class class292 extends class430 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 62)
    public class292() {
    }

    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 64)
