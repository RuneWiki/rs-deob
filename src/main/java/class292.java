...
public class class292 extends class276 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BLqs;)I", line = 9)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(II)V", line = 82)
    public class292(int arg0, int arg1) {
        this.field4738 = arg1;
        this.field4737 = arg0;
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ZB)V", line = 91)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)[Ljc;", line = 135)
