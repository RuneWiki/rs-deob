...
public class class292 extends class452 {
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "()I", line = 72)
    public final int method107() {
        return 0;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lpn;Ldi;)V", line = 76)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "()Ltf;", line = 84)
    public final class452 method114() {
        return (class452) this.field3852.method1690((byte) -107);
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ltf;)V", line = 87)
    public final synchronized void method1866(class452 arg0) {
        arg0.method263(false);
    }

    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ldi;)V", line = 106)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(Ltf;)V", line = 121)
    public final synchronized void method1869(class452 arg0) {
        this.field3852.method1691(-8567, arg0);
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([III)V", line = 130)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "([III)V", line = 176)
    ...
    @OriginalMember(owner = "client!ta", name = "d", descriptor = "()Ltf;", line = 189)
