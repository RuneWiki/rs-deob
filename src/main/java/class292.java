...
public class class292 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lks;[Lqg;)Lwg;", line = 9)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lks;I[Lqg;)V", line = 67)
    private class292(class173 arg0, int arg1, class162[] arg2) {
        this.field4264 = arg0;
        this.field4263 = arg1;
    }

    @OriginalMember(owner = "client!wg", name = "finalize", descriptor = "()V", line = 77)
