...
public class class292 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "()I", line = 19)
    public final int method1784() {
        return this.field4078 - 1;
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "()I", line = 66)
    public final int method1787() {
        return this.field4081;
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "()V", line = 158)
    public static void method1789() {
        field4082 = null;
    }

    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V", line = 172)
