...
public class class292 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILgo;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(ILaf;Laf;I)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIILvd;IZ[B)Lwq;")
