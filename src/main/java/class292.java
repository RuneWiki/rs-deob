...
public class class292 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIBIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(JJ)J", line = 79)
    public static long method1731(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ZI)Ljc;", line = 87)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 125)
