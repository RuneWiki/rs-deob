...
public class class292 {
    ...
    @OriginalMember(owner = "client!cr", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field4488++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I[Ljava/awt/Rectangle;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)Lsr;", line = 65)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 94)
