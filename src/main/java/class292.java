...
public class class292 extends class436 {
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(IIIIIF)V", line = 7)
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB[BIIIII[B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IBB)V", line = 125)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIB)V", line = 136)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(Z)Z", line = 157)
