...
public class class292 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "()V", line = 3)
    public void method1751() {
        field3697++;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "()I", line = 73)
    public int method1754() throws Exception {
        field3708++;
        return this.field3718;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILmi;)V", line = 83)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lji;B)Lqba;", line = 214)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 276)
    public void method1759(Component arg0) throws Exception {
        field3692++;
    }

    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)I", line = 288)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B)V", line = 378)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "()V", line = 391)
    public void method1762() throws Exception {
        field3709++;
    }

    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)V", line = 406)
    public void method1763(int arg0) throws Exception {
        field3695++;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "([II)V", line = 420)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "([IILac;I)V", line = 583)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "()V", line = 669)
    public void method1766() throws Exception {
        field3686++;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 680)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZILmi;)V", line = 704)
