...
public class class590 extends class362 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lfca;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IB)[[I", line = 36)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "()V", line = 115)
    public class590() {
        super(3, false);
    }

    @OriginalMember(owner = "client!via", name = "f", descriptor = "(I)I", line = 120)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II)[I", line = 136)
