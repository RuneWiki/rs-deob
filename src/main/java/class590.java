...
public class class590 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)Lqo;", line = 3)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lnp;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IILnp;)V", line = 64)
