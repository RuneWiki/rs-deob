...
public class class590 implements class437 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)Lad;")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)[Lsd;")
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Ljava/lang/String;Lsd;Lec;IIIIIIIIII)V")
