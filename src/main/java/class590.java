...
public class class590 extends class56 {
    ...
    @OriginalMember(owner = "client!ot", name = "e", descriptor = "(III)Z")
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)Ltga;")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!ot", name = "f", descriptor = "(III)Z")
