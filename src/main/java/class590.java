...
public class class590 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)Lwn;", line = 6)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(II)V", line = 65)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(III)V", line = 108)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lre;ILdn;Ldn;)V", line = 144)
