...
public class class590 implements class346 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lnfa;)V", line = 63)
