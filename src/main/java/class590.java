...
public class class590 implements class345 {
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(IIIIIIZZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IIIIIIZZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Luga;Lvr;Ljo;)V", line = 45)
