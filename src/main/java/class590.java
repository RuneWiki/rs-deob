...
public class class590 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZZIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lbi;III)Lpf;", line = 61)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lno;)V", line = 146)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILhf;I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BI)Z", line = 136)
