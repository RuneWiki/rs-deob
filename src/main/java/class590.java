...
public class class590 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IIILjava/lang/Class;)Llaa;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IB)Lir;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Ljc;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lrfa;[Lta;)V")
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lfs;ILlga;)V")
