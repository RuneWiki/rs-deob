...
public class class590 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(I)Lmc;", line = 32)
