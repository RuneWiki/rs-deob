...
public class class590 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)[B", line = 22)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(ILhga;Lhga;I)V", line = 306)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z[BIII)Z", line = 107)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B[BII)Z", line = 227)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "([BI)Lmq;", line = 267)
    ...
    @OriginalMember(owner = "client!ce", name = "toString", descriptor = "()Ljava/lang/String;", line = 320)
