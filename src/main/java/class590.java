...
public class class590 extends class159 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Luq;II)Lwm;")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "([I)Lpv;")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Luq;)Z")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Luq;I)Lwm;")
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)[F")
