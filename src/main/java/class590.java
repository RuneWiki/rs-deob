...
public class class590 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lgba;Lqca;Lha;B)V", line = 46)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(FBFFFFFI)F", line = 196)
