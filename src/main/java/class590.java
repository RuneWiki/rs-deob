...
public class class590 extends class688 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II[IIIZILii;I[IIIIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lrs;", line = 195)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 226)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IJ)V", line = 330)
