...
public class class590 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLvj;)I", line = 14)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!lc", name = "toString", descriptor = "()Ljava/lang/String;", line = 75)
    public final String toString() {
        field8390++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 89)
