...
public class class590 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZLio;ZIIILio;)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lun;II)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)Lmt;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILun;)V")
