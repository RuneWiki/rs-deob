...
public class class590 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)J", line = 13)
    public final long method3408(int arg0) {
        field8369++;
        return arg0 == -1 ? this.field8374 : 25L;
    }

    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(III[B)V", line = 102)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "([BIIIIB)V", line = 228)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)Ljava/io/File;", line = 258)
    private final File method3412(byte arg0) {
        field8379++;
        return arg0 == 67 ? this.field8372.method2506(-31270) : null;
    }

    @OriginalMember(owner = "client!eba", name = "c", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lkda;II)V", line = 583)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "([BB)V", line = 292)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(B)V", line = 323)
    ...
    @OriginalMember(owner = "client!eba", name = "d", descriptor = "(I)V", line = 333)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IJ)V", line = 378)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I[BII)V", line = 397)
