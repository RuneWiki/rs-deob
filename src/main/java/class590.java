...
public class class590 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lcv;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)Z", line = 35)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIIIIBI)V", line = 52)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 78)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)V", line = 68)
