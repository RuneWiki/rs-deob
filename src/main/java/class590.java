...
public class class590 implements Runnable {
    ...
    @OriginalMember(owner = "client!kj", name = "run", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Z)V", line = 299)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 310)
    public final Object method3413(boolean arg0) {
        return arg0 ? this.field8330 : null;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/Class;)Lrb;", line = 321)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/lang/String;)Lrb;", line = 336)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/awt/Frame;)Lrb;", line = 355)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/lang/Object;IBI)Lrb;", line = 365)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(II)Lrb;", line = 394)
    public final class370 method3418(int arg0, int arg1) {
        return arg1 == 570795760 ? this.method3417(arg0, null, 0, (byte) 1, 3) : null;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZIILjava/lang/String;)Lrb;", line = 405)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([IIILjava/awt/Component;BLjava/awt/Point;)Lrb;", line = 419)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 703)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([BLjava/io/File;I)Z", line = 434)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;IZ)Lrb;", line = 458)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 477)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;B)Lqaa;", line = 537)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)Lqaa;", line = 554)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lrb;", line = 600)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;Z)Lrb;", line = 619)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)Lrb;", line = 634)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/net/URL;B)Lrb;", line = 644)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIII)Lrb;", line = 661)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)Z", line = 683)
