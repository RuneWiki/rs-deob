...
public class class590 extends class521 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIII)[B", line = 21)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 34)
    public class590() {
