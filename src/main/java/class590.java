...
public class class590 extends class289 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(FB)V", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(IIIIIF)V", line = 15)
    public class590(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 31)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIZI)I", line = 72)
    ...
    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(I)V", line = 94)
