...
public class class590 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Luj;BLuj;I)Lmaa;", line = 107)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Luj;IZLuj;I)Lmaa;", line = 118)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)Z", line = 167)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lsw;Lfi;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 247)
