...
public abstract class class590 extends class210 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "([Lgu;I)I")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BLmc;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Lha;I)Z")
