...
public class class590 extends class326 {
    ...
    @OriginalMember(owner = "client!mw", name = "c", descriptor = "(I)Ld;", line = 3)
    ...
    @OriginalMember(owner = "client!mw", name = "e", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(FLd;Ld;Z)Z", line = 26)
    ...
    @OriginalMember(owner = "client!mw", name = "f", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BLr;)V", line = 275)
    ...
    @OriginalMember(owner = "client!mw", name = "c", descriptor = "(B)V", line = 291)
    ...
    @OriginalMember(owner = "client!mw", name = "d", descriptor = "(B)I", line = 307)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lr;Lga;I)V", line = 319)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lag;I)V", line = 453)
