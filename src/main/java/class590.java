...
public class class590 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lst;")
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(BIIIIIILrr;)V")
