...
public class class590 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z)Lgn;")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lgn;I)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)Lfea;")
