...
public class class590 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILpt;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!wm", name = "e", descriptor = "(I)Lpq;")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLpt;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Ljava/lang/Object;IILpt;)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lkv;I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lpt;Z)V")
