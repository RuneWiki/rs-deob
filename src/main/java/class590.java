...
public class class590 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Ljc;ILgp;)V", line = 115)
    public class590(class584 arg0, int arg1, class561 arg2) {
        this.field8387 = arg2;
        this.field8387.method3164(26, true);
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IB)Lwj;", line = 86)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 130)
