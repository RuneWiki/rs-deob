...
public class class504 extends class56 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILee;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "()V", line = 39)
    public class504() {
        this(4096);
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZ)[I", line = 42)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)V", line = 73)
