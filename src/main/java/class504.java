...
public class class504 implements Runnable {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BI)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/awt/Frame;I)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IZLjava/lang/String;)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIILjava/lang/Object;)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "([IILjava/awt/Point;BLjava/awt/Component;I)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(B)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/Class;)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZLjava/awt/Component;I)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/awt/Component;III)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILjava/lang/Object;II)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BLjava/lang/String;)Ljv;")
    public final class56 method2969(byte arg0, String arg1) {
        return arg0 == 29 ? this.method2963(0, 63, arg1, 0, 21) : null;
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIII)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/lang/Runnable;II)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Ljv;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/lang/Class;B)Ljv;")
