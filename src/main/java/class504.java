...
public class class504 extends class545 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Lrg;Lal;IIIIIIIIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ria", name = "b", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Lbe;ILha;)I", line = 71)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Z)Lww;", line = 101)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(BLuv;)V", line = 123)
