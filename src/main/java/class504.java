...
public class class504 extends class457 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BII[B)I", line = 15)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I[BIB)V", line = 26)
    ...
    @OriginalMember(owner = "client!rc", name = "finalize", descriptor = "()V", line = 36)
    protected final void finalize() {
        field6290++;
        this.method2511((byte) -115);
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(II)Z", line = 107)
