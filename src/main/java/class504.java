...
public class class504 extends class525 {
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ap", name = "e", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIZ)Z", line = 127)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(I)Lnaa;", line = 138)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IZZ)I", line = 155)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 191)
