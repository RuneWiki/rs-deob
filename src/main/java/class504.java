...
public class class504 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IBLr;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIILr;IIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(I[Luu;IIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 190)
