...
public class class504 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I[FI)[F", line = 5)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BILjc;)V", line = 66)
