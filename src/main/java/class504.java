...
public class class504 extends class370 implements class232 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IILqa;)Lc;", line = 14)
    public final class121 method381(int arg0, int arg1, class162 arg2) {
        field7386++;
        return arg0 == 1584 ? null : null;
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lqa;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(Lqa;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(III)Z", line = 47)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(IIIIIIIIIILtp;)V", line = 78)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(Z)I", line = 92)
    ...
    @OriginalMember(owner = "client!hn", name = "e", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IILqa;IZLha;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!hn", name = "h", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lhh;BLhh;Lqe;Lhh;)Z", line = 147)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(Lqa;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIILqa;)Z", line = 187)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z)I", line = 200)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILqa;)Lbw;", line = 211)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(III)V", line = 222)
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)Z", line = 276)
