...
public class class504 extends class49 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IILgga;)V", line = 19)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lgga;Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(III)I", line = 58)
