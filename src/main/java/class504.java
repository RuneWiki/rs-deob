...
public class class504 extends class135 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Loe;Lvo;Lob;)V", line = 29)
    ...
    @OriginalMember(owner = "client!br", name = "g", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!br", name = "d", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!br", name = "h", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZI)V", line = 168)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IZ)V", line = 186)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Laj;II)V", line = 214)
