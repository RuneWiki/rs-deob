...
public class class504 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IB)V", line = 30)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II[BI)V", line = 82)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILu;B)V", line = 201)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lvj;Llv;Lsi;IIIII)V", line = 240)
