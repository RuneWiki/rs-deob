...
public class class504 extends class72 {
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!od", name = "e", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(ILcq;)V", line = 27)
    public class504(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!od", name = "f", descriptor = "(I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lcq;)V", line = 124)
    public class504(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)V", line = 161)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II)I", line = 173)
