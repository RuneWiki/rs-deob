...
public class class504 extends class535 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILwn;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "()V", line = 71)
    public class504() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(II)Z", line = 74)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(II)[I", line = 89)
