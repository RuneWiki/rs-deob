...
public class class504 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "([BB)[B", line = 19)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(II)I", line = 92)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(II)I", line = 106)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(II)V", line = 176)
