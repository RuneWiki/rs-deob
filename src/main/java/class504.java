...
public class class504 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;)V", line = 190)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "([BI[BIII)I", line = 228)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIC)I", line = 377)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II[B[BIB)I", line = 402)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "([B)V", line = 475)
