...
public class class504 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BLoc;)Lica;", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lpl;Lpl;)V", line = 76)
    public class504(class612 arg0, class612 arg1) {
        this.field6669 = arg0;
        this.field6668 = arg1;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BII)V", line = 91)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)Lis;", line = 107)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 127)
