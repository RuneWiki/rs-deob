...
public class class504 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IB)I", line = 34)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BLjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V", line = 44)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 65)
