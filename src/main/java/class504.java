...
public class class504 extends class377 {
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Llea;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZLha;II)Leg;")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Llea;IIIII)V")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Llea;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Llea;IIII)V")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Llea;IIIIZ[IIIZ)V")
