...
public class class504 extends class503 {
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lrl;Lha;)V")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lbn;I)V")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IBLtu;)V")
