...
public class class504 extends class461 implements class679 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)I", line = 16)
    public final int method2139(int arg0) {
        int var2 = 58 % ((arg0 + 34) / 42);
        return this.field6918;
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 24)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BF)F", line = 34)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lega;Lpn;Ljg;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(III[IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ldca;B)V", line = 126)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(BF)F", line = 136)
    public final float method2138(byte arg0, float arg1) {
        return arg0 <= 94 ? 0.027227394F : arg1 / (float) this.field6921;
    }

    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lega;Lpn;IIZ[BII)V", line = 145)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)I", line = 204)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIIIZILpn;I[B)V", line = 214)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lega;IIZ[III)V", line = 255)
