...
public abstract class class504 extends class337 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILmc;)Ljava/lang/String;", line = 68)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 98)
