...
public class class504 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZI)V", line = 10)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BII)Z", line = 26)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 38)
