...
public class class504 extends class134 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILji;)Ltu;")
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(ILkda;)V")
    public class504(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lkda;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lru;")
