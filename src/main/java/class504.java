...
public class class504 extends class37 {
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIB)V", line = 16)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(III)V", line = 96)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 117)
