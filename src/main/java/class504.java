...
public class class504 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BI)Ltk;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILiaa;)Loq;")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Ljda;ILjo;Ljo;)V")
