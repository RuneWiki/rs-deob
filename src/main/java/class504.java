...
public class class504 {
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILgba;BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!rc", name = "e", descriptor = "(I)Z", line = 110)
