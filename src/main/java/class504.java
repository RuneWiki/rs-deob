...
public class class504 extends class316 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lua;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IBI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILrv;)V", line = 41)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)Lgq;", line = 60)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "([I[JB)V", line = 88)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)Z", line = 99)
