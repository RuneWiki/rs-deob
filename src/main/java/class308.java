...
public class class308 extends class45 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lir;Z)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lqq;Ljba;Lqea;[I)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZLga;Lga;Lga;Lga;)V")
