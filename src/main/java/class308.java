...
public class class308 extends class499 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IBI)V", line = 6)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(IIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IZ)Z", line = 102)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILjava/awt/Canvas;ILe;Lpq;)Loa;", line = 124)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(Z)V", line = 152)
