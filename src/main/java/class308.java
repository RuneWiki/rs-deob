...
public class class308 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lfd;B)I")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lr;ZILqa;IIII)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IILqa;ZZII)Lr;")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "([Loh;II)V")
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lqa;Ltk;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILqa;)V")
