...
public abstract class class308 extends class126 {
    ...
    public static final boolean method2095(int arg0) {
        field4533++;
        if (arg0 == -22199) {
            return class212.field2844 > 0;
        } else {
            return true;
        }
    }
    ...
    public static final void method2096(int arg0, int arg1, int[] arg2) {
        for (int var3 = 31; var3 > 0; var3--) {
            int var4 = var3 * 36;
            for (int var5 = 35; var5 > 0; var5--) {
                if (arg2[var4 + var5] == 0 && arg2[var4 + var5 - 1 - 36] != 0) {
                    arg2[var4 + var5] = arg0;
                }
            }
        }
        if (arg1 != 0) {
            method2096(7, 109, (int[]) null);
        }
        field4538++;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BLps;)V")
    public static final void method2097(byte arg0, class394 arg1) {
        if (arg0 < 67) {
            method2098(80);
        }
        field4542++;
        int var2 = arg1.field5654;
        if (var2 == 324) {
            if (class145.field1982 == -1) {
                class346.field4980 = arg1.field5711;
                class145.field1982 = arg1.field5693;
            }
            if (class213.field2850.field4256) {
                arg1.field5693 = class145.field1982;
            } else {
                arg1.field5693 = class346.field4980;
            }
        } else if (var2 == 325) {
            if (class145.field1982 == -1) {
                class346.field4980 = arg1.field5711;
            ...
            arg1.field5666 = 150;
            arg1.field5795 = (int) (Math.sin((double) class28.field418 / 40.0D) * 256.0D) & 0x3FFF;
            arg1.field5749 = 5;
            arg1.field5756 = -1;
        } else if (var2 == 328) {
            if (class227.field2988.field340 == null) {
                arg1.field5756 = 0;
                arg1.field5683 = 0;
            } else {
                arg1.field5666 = 150;
                arg1.field5795 = (int) (Math.sin((double) class28.field418 / 40.0D) * 256.0D) & 0x7FF;
                arg1.field5756 = 2047;
                arg1.field5749 = 5;
                arg1.field5683 = class117.method762(class227.field2988.field340, 0);
                arg1.field5645 = 0;
                arg1.field5703 = class227.field2988.field4282;
                arg1.field5643 = class227.field2988.field4298;
                arg1.field5727 = class227.field2988.field4346;
            }
        }
    }
    ...
    public static void method2099(byte arg0) {
        ...
        field4531 = null;
        field4539 = null;
        int var1 = 83 % ((62 - arg0) / 38);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lii;IIIILnc;Z)V")
