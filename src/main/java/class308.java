...
public class class308 extends class666 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)[I", line = 20)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIILfj;Lfj;)V", line = 75)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILiaa;Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "()V", line = 120)
    public class308() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(B)Lob;", line = 109)
