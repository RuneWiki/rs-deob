...
public class class308 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILji;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZLca;)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "()V", line = 72)
    public class308() {
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lji;)V", line = 88)
