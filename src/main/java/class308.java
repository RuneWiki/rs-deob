...
public class class308 extends class194 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Laq;ZI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IILbg;)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BLuo;Lwo;)V")
