...
public class class308 extends class197 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lpu;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lqa;J)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lpu;IIIIIIIIIIIZZ)V")
