...
public class class308 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ltq;)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;II)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;Ldg;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Lae;)Lwq;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lul;III)I")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;IIII)Lwq;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;Lnd;IIII)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lul;II)V")
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Lae;IIII)V")
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)Lgq;")
    public static final class300 method2040(int arg0) {
        return (class300) field4343.method1888((long) arg0, (byte) -30);
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II)Lek;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lae;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(II)Lgq;")
