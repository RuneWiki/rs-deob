...
public class class308 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(CI)Z", line = 41)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(III)V", line = 217)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(B)[[I", line = 89)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)[I", line = 139)
