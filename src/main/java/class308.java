...
public class class308 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lm;ILjava/awt/Canvas;BLji;)Lqa;", line = 6)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lji;BI)I", line = 43)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IIBII)V", line = 79)
