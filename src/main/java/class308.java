...
public class class308 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Laaa;IIZILha;ZBLs;IIILs;I)Lka;", line = 10)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IILaaa;ZBIILha;Ls;ILs;II)Lka;", line = 132)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BLes;)V", line = 143)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BILes;)V", line = 169)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILha;BBLaaa;III)Lka;", line = 292)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILha;Laaa;IIIB)Lka;", line = 322)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 351)
