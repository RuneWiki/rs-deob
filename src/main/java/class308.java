...
public class class308 extends class7 {
    ...
    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZIIII)I", line = 89)
    ...
    @OriginalMember(owner = "client!lh", name = "g", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IBIIII)V", line = 124)
