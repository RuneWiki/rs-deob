...
public class class308 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lya;IILc;III[[[B[I[I[I[I[IIBIIZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBI)Z", line = 210)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 221)
