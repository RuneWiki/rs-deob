...
public class class308 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(F)F", line = 10)
    private static final float method1849(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIF)F", line = 17)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "()V", line = 26)
    public static void method1851() {
        field4062 = null;
        field4063 = null;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lsl;Lnha;)V", line = 33)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(IIF)F", line = 106)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IF)I", line = 115)
