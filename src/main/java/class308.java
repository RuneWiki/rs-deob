...
public class class308 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ILjagdx/IDirect3DSwapChain;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
