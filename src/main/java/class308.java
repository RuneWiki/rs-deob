...
public class class308 {
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BI)Lma;", line = 165)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lra;Lra;Lra;Lra;Z)V", line = 192)
