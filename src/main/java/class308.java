...
public abstract class class308 implements class126 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Ljaggl/MapBuffer;IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "([[BILwca;)V")
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Ltba;IZ)V")
