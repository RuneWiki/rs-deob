...
public class class308 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lr;III[Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLha;IILjava/lang/String;III)V", line = 97)
