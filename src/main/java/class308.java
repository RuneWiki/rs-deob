...
public class class308 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ui", name = "toString", descriptor = "()Ljava/lang/String;", line = 34)
    public final String toString() {
        field4173++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 52)
