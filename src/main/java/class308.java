...
public class class308 extends class52 {
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(III)Lec;", line = 17)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(II)[B", line = 292)
    ...
    @OriginalMember(owner = "client!lv", name = "d", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Z)I", line = 490)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IB)I", line = 515)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(B)V", line = 532)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Lwn;[[BI)V", line = 582)
    ...
    @OriginalMember(owner = "client!lv", name = "e", descriptor = "(I)V", line = 654)
    ...
    @OriginalMember(owner = "client!lv", name = "f", descriptor = "(I)I", line = 670)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(II)V", line = 692)
    ...
    @OriginalMember(owner = "client!lv", name = "d", descriptor = "(B)V", line = 727)
    ...
    @OriginalMember(owner = "client!lv", name = "g", descriptor = "(I)I", line = 751)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(ILst;Lst;Lvn;Lvl;IIZ)V", line = 886)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(B)Lrt;", line = 776)
