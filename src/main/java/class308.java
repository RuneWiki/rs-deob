...
public class class308 {
    ...
    @OriginalMember(owner = "client!pt", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    public final String toString() {
        field4700++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIBIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 55)
