...
public class class308 extends class210 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IB)[I", line = 20)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IZIII)Lih;", line = 267)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 298)
    public class308() {
        super(2, false);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IILat;)V", line = 301)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)[[I", line = 338)
    ...
    @OriginalMember(owner = "client!wm", name = "g", descriptor = "(I)V", line = 651)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "()V", line = 674)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IBI)Ljava/lang/String;", line = 897)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(B)V", line = 967)
