...
public class class308 extends class392 {
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(ILw;)V")
    public class308(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Luf;BI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lw;)V")
