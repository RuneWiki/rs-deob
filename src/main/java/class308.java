...
public class class308 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IB)I", line = 45)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 73)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILps;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILps;)V", line = 191)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IZ)Z", line = 227)
