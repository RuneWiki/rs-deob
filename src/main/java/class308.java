...
public class class308 extends class188 {
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lht;IIIII)V")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILlh;)Ldr;")
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lht;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lht;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lht;IIII)V")
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lht;IIIIZ[FI)V")
