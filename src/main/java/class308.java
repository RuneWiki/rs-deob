...
public class class308 extends class372 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I[III[I[B[[B[[B)I", line = 31)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)Llq;", line = 89)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)V", line = 114)
    public void method1632(int arg0, byte arg1) {
        ++field4498;
        this.field4499[this.field4502++] = (byte) (127 + class35.method254(127, arg1 >> 1));
    }

    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(IIIIIF)V", line = 123)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)V", line = 236)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(IIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(I)V", line = 287)
