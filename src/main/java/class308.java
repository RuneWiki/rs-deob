...
public class class308 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLofa;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IZBLha;)Lit;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILofa;B)V")
