...
public class class308 extends class403 implements class113 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILeq;BI)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILeq;IZ)Luq;", line = 55)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILeq;Z)Lva;", line = 87)
    ...
    @OriginalMember(owner = "client!ch", name = "d", descriptor = "(I)Z", line = 100)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIILbp;IZLeq;)V", line = 126)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Leq;I)V", line = 183)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Leq;II)Lva;", line = 199)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLeq;)V", line = 235)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(B)I", line = 264)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Leq;Lhn;IIIIZIIZ)V", line = 277)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Leq;Z)Lgl;", line = 311)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(B)I", line = 338)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Leq;Z)V", line = 352)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)I", line = 381)
