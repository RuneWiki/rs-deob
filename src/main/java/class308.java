...
public class class308 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lvj;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lvj;Ljaclib/memory/Buffer;)V", line = 21)
