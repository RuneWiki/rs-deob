...
public class class308 extends class159 implements class622 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I[BII)[B", line = 15)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)C", line = 30)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "([BIZ)[B", line = 46)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!gga", name = "f", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!gga", name = "c", descriptor = "(I)I", line = 90)
    public final int method1993(int arg0) {
        field4368++;
        return arg0 == 15733 ? this.field4374 : 87;
    }

    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(I)I", line = 101)
