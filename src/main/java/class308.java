...
public class class308 extends class50 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!jc", name = "i", descriptor = "(I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!jc", name = "j", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lih;)V", line = 156)
    public class308(class503 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lgu;ILgu;I)V", line = 162)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)Z", line = 322)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(IB)Z", line = 361)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IB)V", line = 378)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)I", line = 392)
