...
public class class308 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lfr;JB)V")
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)Lfr;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BJ)Lfr;")
