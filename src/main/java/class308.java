...
public class class308 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILoa;Z)Z")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lkca;I)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIIIIIILoa;II)V")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(I[Lrk;IIII)V")
