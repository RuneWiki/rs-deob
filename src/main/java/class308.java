...
public class class308 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIZI[[ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([BIIIIIB[BI)V", line = 192)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILmc;B)Z", line = 265)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIILmc;)V", line = 336)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIII)V", line = 406)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II[BIIB[BII)V", line = 448)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([BIIIIII)Z", line = 489)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(IIILmc;)V", line = 534)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Ltb;Lfq;)V", line = 602)
