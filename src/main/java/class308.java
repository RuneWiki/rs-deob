...
public class class308 extends class137 implements class339 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lr;I)Lsd;")
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ZLr;)Log;")
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(ZLr;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILwd;IIIIIIIBI)Z")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "j", descriptor = "(I)V")
