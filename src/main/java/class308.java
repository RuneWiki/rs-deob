...
public class class308 extends class281 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IZI)[B", line = 7)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)[B", line = 21)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I[B)V", line = 35)
