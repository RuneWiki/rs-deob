...
public class class308 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(III)I", line = 293)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "()V", line = 321)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lap;)V", line = 346)
