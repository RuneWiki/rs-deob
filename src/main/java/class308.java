...
public class class308 extends class602 implements class361 {
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Ldga;IZ[[I)V", line = 63)
