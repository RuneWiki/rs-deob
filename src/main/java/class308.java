...
public class class308 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZI)I", line = 73)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)I", line = 110)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZLcu;I)V", line = 151)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(II)Ljava/lang/String;", line = 206)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLcu;)V", line = 230)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 250)
