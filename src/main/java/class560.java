...
public class class560 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lha;[II)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lha;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lha;[IIII[I[I)V")
