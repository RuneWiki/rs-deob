...
public class class560 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BLiv;)V", line = 40)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Liv;)V", line = 50)
    public class560(class568 arg0) {
        this.field7309 = arg0.field7416;
        this.field7310 = 1;
    }

    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "([Liv;)V", line = 58)
    public class560(class568[] arg0) {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IB)Liv;", line = 73)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)I", line = 171)
