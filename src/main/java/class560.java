...
public class class560 implements Runnable {
    ...
    @OriginalMember(owner = "client!ac", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZZLih;)V", line = 83)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILwb;)V", line = 260)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 273)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLjava/lang/String;)Lqia;", line = 377)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 399)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 413)
    public class560() {
        try {
