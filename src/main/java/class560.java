...
public class class560 extends class97 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Loq;Lkea;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "([III)V", line = 16)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Loia;)V", line = 26)
    public final synchronized void method3257(class97 arg0) {
        arg0.method2219(13630);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(Loia;)V", line = 85)
    public final synchronized void method3258(class97 arg0) {
        this.field7761.method2727(arg0, -98);
    }

    @OriginalMember(owner = "client!tp", name = "d", descriptor = "()Loia;", line = 88)
    public final class97 method763() {
        return (class97) this.field7761.method2726(-116);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "()I", line = 93)
    public final int method752() {
        return 0;
    }

    @OriginalMember(owner = "client!tp", name = "c", descriptor = "()Loia;", line = 96)
    public final class97 method745() {
        return (class97) this.field7761.method2725(37);
    }

    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!tp", name = "e", descriptor = "()I", line = 112)
    public final synchronized int method3260() {
        return this.field7761.method2736(-12418);
    }

    @OriginalMember(owner = "client!tp", name = "f", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "([III)V", line = 139)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lkea;)V", line = 183)
