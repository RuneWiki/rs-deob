...
public class class560 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ILjava/lang/String;)V", line = 17)
    public static final void method3274(int arg0, String arg1) {
        field7996++;
        System.exit(arg0);
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 48)
