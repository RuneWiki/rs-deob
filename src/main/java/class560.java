...
public class class560 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BI)Lsu;", line = 10)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 69)
