...
public class class560 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)[I", line = 15)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILjava/awt/Frame;III)V", line = 33)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "()V", line = 51)
    public class560() {
        this.field8172.initialize(null);
    }

    @OriginalMember(owner = "client!dr", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 61)
