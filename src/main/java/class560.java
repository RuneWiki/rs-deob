...
public class class560 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lop;Lnc;Ltt;I[Laea;IIIZIILqa;Ltt;Las;Ljn;Lbo;Lht;BI)Lr;")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lte;[Lwe;I)Lgda;")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIILht;ILtt;ILqa;Lbo;III)Lr;")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lop;ILjn;Lqa;Lbo;Lht;Lnc;IIILtt;I)Lr;")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lbo;III)V")
