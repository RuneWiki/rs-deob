...
public class class560 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(F)F", line = 11)
    private static final float method3272(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lrg;Loea;)V", line = 18)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IF)I", line = 83)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(IIF)F", line = 155)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "()V", line = 172)
