...
public class class560 extends class629 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILnea;)V")
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)D")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IBD)Lnea;")
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "()Lpda;")
    public final class629 method1361() {
        field7856++;
        return null;
    }

    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(B)Lnea;")
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "()Lpda;")
