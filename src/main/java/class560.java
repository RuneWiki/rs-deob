...
public class class560 implements class345 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIILd;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIILdga;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BLdga;I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ILmea;I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIILd;I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lag;)V")
