...
public class class560 extends class3 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "()Lua;", line = 18)
    public final class3 method4() {
        field7965++;
        return null;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)I", line = 50)
    public final synchronized int method3350(byte arg0) {
        field7958++;
        return arg0 > -82 ? -59 : this.field7970;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(DII)Lnq;", line = 103)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)V", line = 126)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)Lnq;", line = 138)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "()I", line = 149)
    public final int method5() {
        field7950++;
        return 1;
    }

    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!vp", name = "f", descriptor = "(I)D", line = 171)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "()Lua;", line = 196)
    public final class3 method8() {
        field7962++;
        return null;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lnq;B)V", line = 213)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(I)V", line = 324)
    public class560(int arg0) {
        this.field7959 = arg0;
    }

    @OriginalMember(owner = "client!vp", name = "b", descriptor = "([III)V", line = 255)
