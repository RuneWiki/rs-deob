...
public class class560 extends class137 implements class339 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IILr;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(B)I", line = 42)
    public final int method65(byte arg0) {
        ++field7759;
        return arg0 < 126 ? 94 : this.field7757 & 65535;
    }

    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(BLr;)V", line = 54)
    ...
    @OriginalMember(owner = "client!kga", name = "g", descriptor = "(B)Z", line = 81)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lr;I)Lsd;", line = 93)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(III)Z", line = 108)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ZLr;)Log;", line = 141)
    ...
    @OriginalMember(owner = "client!kga", name = "e", descriptor = "(B)Z", line = 174)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BLr;)V", line = 194)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIZII)V", line = 225)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(ZLr;)V", line = 495)
    ...
    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(B)I", line = 507)
    ...
    @OriginalMember(owner = "client!kga", name = "i", descriptor = "(B)V", line = 517)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lr;IZI)Lkj;", line = 530)
    ...
    @OriginalMember(owner = "client!kga", name = "g", descriptor = "(I)I", line = 560)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)I", line = 571)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZIIII)V", line = 582)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)Z", line = 607)
    ...
    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(I)I", line = 618)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILr;I)Lda;", line = 637)
