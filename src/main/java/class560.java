...
public class class560 implements class186 {
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)Lqia;", line = 16)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lnd;Ljava/lang/String;)V", line = 26)
    public class560(class547 arg0, String arg1) {
        this.field7900 = arg0;
        this.field7901 = arg1;
    }

    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)Z", line = 53)
