...
public class class519 extends class130 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "()V", line = 3)
    public final void method3061() {
        this.field7524 = null;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lum;II)Lsp;", line = 10)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lfh;)V", line = 126)
