...
public class class519 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)[I", line = 19)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)Lfj;", line = 47)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III[BIII)Z", line = 139)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lrga;ILni;Lni;)V", line = 201)
