...
public class class519 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ldc;Z)Lria;", line = 28)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 88)
    public class519(class553 arg0, int arg1, class237 arg2) {
        this.field7241 = arg2;
        this.field7239 = this.field7241.method1597(19, 0);
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IB)Liea;", line = 59)
