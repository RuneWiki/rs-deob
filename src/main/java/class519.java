...
public class class519 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([[BLtp;B)V")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lha;Lvj;I)V")
