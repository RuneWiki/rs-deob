...
public class class519 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILjea;I)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILhb;)V")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lnv;Lg;Lida;IIIII)V")
