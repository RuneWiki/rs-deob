...
public class class519 extends class388 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(JI)V", line = 27)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)J", line = 41)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "([[SD)V", line = 69)
    public class519(short[][] arg0, double arg1) {
        this.field7478 = arg0;
        this.field7475 = arg1;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BI)V", line = 85)
