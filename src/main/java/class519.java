...
public class class519 extends class192 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)V", line = 442)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(III)Z", line = 456)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 467)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(FFIF)F", line = 503)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 520)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BIIII)V", line = 531)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI)I", line = 551)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)V", line = 566)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lkv;II)V", line = 578)
