...
public class class519 extends class634 {
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 9)
    public class519() {
        this(4096);
    }

    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILig;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!cb", name = "f", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(BI)[I", line = 75)
