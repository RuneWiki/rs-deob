...
public class class519 extends class270 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([Ljava/lang/Object;[II)V", line = 3)
    public static final void method2957(Object[] arg0, int[] arg1, int arg2) {
        class372.method2037(arg1, arg0, true, arg1.length - arg2, 0);
        field7410++;
    }

    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZLoa;I)Lba;", line = 12)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BLjava/lang/String;)V", line = 99)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Ljava/io/File;II[B)V", line = 124)
