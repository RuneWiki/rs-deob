...
public class class519 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(III[B)[B", line = 18)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(JZIII)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IZII)I", line = 135)
