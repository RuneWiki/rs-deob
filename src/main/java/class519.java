...
public class class519 {
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BI)Lhe;", line = 50)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lqh;ILtf;Ltf;)V", line = 84)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)V", line = 100)
