...
public class class519 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)Lle;", line = 8)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILck;)V", line = 39)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BJ)Lle;", line = 72)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BJLle;)V", line = 140)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(I)V", line = 161)
