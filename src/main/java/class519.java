...
public class class519 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lha;Ldn;)Z", line = 8)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(Lha;Ldn;)V", line = 42)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(Lha;Ldn;)V", line = 126)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(Lha;Ldn;)Z", line = 212)
    public final boolean method3013(class60 arg0, class519 arg1) {
        return this.field7287 != null || this.method3010(arg0, arg1);
    }

    @OriginalMember(owner = "client!dn", name = "b", descriptor = "()V", line = 216)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lha;IIIIII)V", line = 228)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lha;)V", line = 258)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "()V", line = 323)
    public static final void method3017() {
        field7285 = null;
        field7283 = null;
    }

    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 333)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(Lha;)V", line = 344)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIII)Z", line = 426)
