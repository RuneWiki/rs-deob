...
public class class519 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ldw;Ldw;FI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZBLtf;)V", line = 95)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lht;)V", line = 263)
    public class519(class410 arg0) {
        this.field7650 = arg0;
    }

    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)I", line = 271)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)Z", line = 362)
