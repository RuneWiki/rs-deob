...
public class class519 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIIII)Lkn;", line = 17)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILmd;)Lqk;", line = 118)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 151)
