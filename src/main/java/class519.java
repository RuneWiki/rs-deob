...
public class class519 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IBLwca;)Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 47)
