...
public class class519 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIIII)Z", line = 12)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)I", line = 38)
    public static int method3092(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lga;Z)V", line = 51)
