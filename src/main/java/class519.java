...
public class class519 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)Lri;")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lri;Z)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)Lri;")
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(B)Lri;")
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(I)Lri;")
