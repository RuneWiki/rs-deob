...
public class class519 extends class317 {
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "()I", line = 27)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILkv;BI[II)V", line = 74)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "([III)V", line = 136)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILkv;B)V", line = 174)
    ...
    @OriginalMember(owner = "client!th", name = "e", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "()Lbk;", line = 228)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "()Lbk;", line = 246)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lci;)V", line = 278)
