...
public abstract class class519 {
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lpg;I[BIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!qb", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I[BB)V", line = 41)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILvr;)Z", line = 66)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lpg;ILjaggl/memory/NativeBuffer;IZ)V", line = 91)
