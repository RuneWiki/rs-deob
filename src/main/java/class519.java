...
public class class519 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)Lcp;")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZLcu;)Z")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILgo;ZLla;ZLya;IZLya;II)Ll;")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lgo;ILya;IIIII)Ll;")
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lal;IZLmi;Lmg;Lmg;)V")
