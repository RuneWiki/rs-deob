...
public class class519 extends class9 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lav;I)I", line = 18)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 53)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lkj;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "([B)V", line = 155)
