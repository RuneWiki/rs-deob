...
public class class519 extends class256 {
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Ljg;Ljha;IIIIIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BIIZ)I", line = 18)
    ...
    @OriginalMember(owner = "client!baa", name = "d", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ZLak;)V", line = 92)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)Ljw;", line = 111)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILvk;Ljava/lang/Object;)V", line = 123)
