...
public class class519 implements Runnable {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/String;I)Lbaa;")
    public static final class488 method2890(String arg0, int arg1) {
        return arg1 >= -75 ? null : method2907(0, field6910, arg0, field6927);
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/String;ZZ)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/net/URL;B)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILjava/lang/String;IZ)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIILjava/lang/Object;I)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILjava/lang/String;)Lsa;")
    public final class192 method2900(int arg0, String arg1) {
        int var3 = 119 / ((32 - arg0) / 45);
        return this.method2898(16, -54, 0, arg1, 0);
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Z[Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "e", descriptor = "(I)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/awt/Point;Ljava/awt/Component;ZII[I)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIBII)Lsa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/awt/Frame;I)Lsa;")
    public final class192 method2906(Frame arg0, int arg1) {
        return arg1 == 0 ? this.method2898(7, -114, 0, arg0, 0) : null;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)Lbaa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IB)Lsa;")
