...
public class class519 implements class688 {
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tv", name = "e", descriptor = "(I)Lio;", line = 44)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BJ)Z", line = 96)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", line = 108)
    ...
    @OriginalMember(owner = "client!tv", name = "f", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BI)I", line = 146)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;I)I", line = 160)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(BI)I", line = 175)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)I", line = 198)
    public final int method3081(boolean arg0) {
        field7601++;
        return arg0 ? -45 : 0;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;B)Z", line = 219)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BZ)V", line = 232)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 427)
