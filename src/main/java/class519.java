...
public class class519 extends class62 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "()V", line = 74)
    public class519() {
        super(0, false);
    }

    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljava/awt/Canvas;ILn;)Lqa;", line = 92)
    ...
    @OriginalMember(owner = "client!cf", name = "h", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!cf", name = "i", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lgw;II)V", line = 146)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)Z", line = 161)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(IB)V", line = 193)
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "(I)V", line = 240)
