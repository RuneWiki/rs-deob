...
public class class556 extends class241 implements class269 {
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!fh", name = "f", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILqa;II)Z", line = 64)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 87)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)I", line = 119)
    public final int method337(boolean arg0) {
        ++field8181;
        return !arg0 ? 65 : this.field8179;
    }

    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(ILqa;)Loj;", line = 130)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(ILqa;)Lso;", line = 170)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;ZZI)Ljc;", line = 191)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;IZ)Lr;", line = 220)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(III)Z", line = 238)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;Z)V", line = 250)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZLqa;)V", line = 280)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lqa;Lcn;IIIIZIIZ)V", line = 309)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)I", line = 345)
    ...
    @OriginalMember(owner = "client!fh", name = "g", descriptor = "(I)V", line = 356)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILqa;Z)Lr;", line = 366)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "([BZI)[B", line = 378)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILqa;)V", line = 394)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(B)V", line = 404)
    ...
    @OriginalMember(owner = "client!fh", name = "h", descriptor = "(I)[Llc;", line = 420)
