...
public class class556 extends class601 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lwp;II)Z")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lgn;)V")
