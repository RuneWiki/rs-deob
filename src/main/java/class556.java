...
public class class556 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)Lgr;", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILgr;)V", line = 17)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(I)V", line = 59)
    public class556(int arg0) {
        this.field7079 = arg0;
    }

    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(IIIIII)V", line = 66)
