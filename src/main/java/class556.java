...
public class class556 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)Ltj;", line = 7)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILha;)V", line = 57)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 84)
