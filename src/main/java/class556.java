...
public class class556 extends class742 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lee;Z)Leja;")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLha;)Lck;")
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BILha;)Z")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lha;IIB)Z")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILha;IILro;)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLpha;)V")
