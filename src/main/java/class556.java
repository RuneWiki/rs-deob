...
public class class556 extends class56 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(II)[I", line = 51)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "()V", line = 96)
    public class556() {
        super(1, false);
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BILes;)V", line = 103)
