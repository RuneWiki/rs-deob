...
public class class556 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIII)Let;", line = 33)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)Lrba;", line = 47)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(IIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(IIIIB)V", line = 96)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Let;I)V", line = 107)
