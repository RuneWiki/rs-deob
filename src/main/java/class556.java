...
public class class556 extends class223 {
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "()Lrb;")
    ...
    @OriginalMember(owner = "client!oaa", name = "c", descriptor = "(II)Lrca;")
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(IB)Lqs;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ZZ)Lfw;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "([BLpb;ZIIIZI)Lbw;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(B[Lim;)Lbfa;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lbfa;I)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(II)Lcn;")
    public final class621 method236(int arg0, int arg1) {
        ++field7780;
        return null;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ZIB[[I)Lfp;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Loea;Lpb;B)Z")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ZIZLvq;Z)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lmia;)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lrh;B)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ILdaa;II)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIZIII[I)Lbw;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lcn;Lrca;)Lmia;")
    ...
    @OriginalMember(owner = "client!oaa", name = "ib", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lpb;ILoea;BI)Lbw;")
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLd;Lae;I)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IZ)Lpm;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lok;Lok;FLok;)Lok;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIZIII[FLpb;)Lbw;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ILpb;[BIII)Lat;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ZLvq;IZ)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Loea;ILpb;)Z")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(BILdaa;Lpm;III)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(BLfw;I)V")
