...
public class class556 extends class339 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IIIIIII[[Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!sba", name = "fa", descriptor = "(IILr;)Lr;", line = 203)
    ...
    @OriginalMember(owner = "client!sba", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 230)
    ...
    @OriginalMember(owner = "client!sba", name = "ka", descriptor = "(III)V", line = 245)
    ...
    @OriginalMember(owner = "client!sba", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 259)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 338)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(III[[ZZII)V", line = 352)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Lpga;IIII[[I[[II)V", line = 370)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(III[[ZZI)V", line = 443)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I[[ZIIIIIZ)V", line = 452)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 593)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lkb;[I)V", line = 681)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BLw;II)V", line = 700)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 762)
    ...
    @OriginalMember(owner = "client!sba", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 779)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(II)V", line = 795)
    public final void method511(int arg0, int arg1) {
        ++field7851;
    }

    @OriginalMember(owner = "client!sba", name = "YA", descriptor = "()V", line = 807)
