...
public class class556 extends class83 {
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "([BB)[B", line = 50)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II)Lbu;", line = 156)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IILav;)V", line = 181)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)Z", line = 194)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IZ)V", line = 205)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lvj;Lud;)V", line = 219)
