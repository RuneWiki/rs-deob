...
public class class556 extends class497 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)J", line = 39)
    ...
    @OriginalMember(owner = "client!hr", name = "i", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!hr", name = "j", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)I", line = 194)
