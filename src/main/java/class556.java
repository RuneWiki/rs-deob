...
public class class556 {
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!hl", name = "toString", descriptor = "()Ljava/lang/String;", line = 56)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(II)V", line = 71)
