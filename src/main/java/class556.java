...
public class class556 extends class297 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lcea;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(II)[[I", line = 52)
    ...
    @OriginalMember(owner = "client!fi", name = "f", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Z)V", line = 149)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(II)[I", line = 184)
