...
public class class556 implements class590 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Ljava/lang/String;IIIILla;)I", line = 17)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lsc;Lkda;)V", line = 30)
    public class556(class38 arg0, class441 arg1) {
        this.field8163 = arg1;
        this.field8162 = arg0;
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)Z", line = 72)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)V", line = 83)
