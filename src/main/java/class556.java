...
public class class556 implements class438 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 7)
    public final void method3116() {
        this.field7866 = Thread.currentThread();
        this.method3117();
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lma;BIZ)Lr;", line = 20)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 66)
