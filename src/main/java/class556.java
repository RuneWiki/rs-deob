...
public class class556 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lml;I)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lkia;IILml;)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lml;II)V")
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(Lml;I)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BLml;I)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ILml;)V")
