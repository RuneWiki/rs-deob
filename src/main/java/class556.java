...
public class class556 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IB)I", line = 44)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)Z", line = 55)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ltj;I)V", line = 187)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)Z", line = 207)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Z)V", line = 285)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLtj;)Z", line = 320)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 357)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Loea;)V", line = 531)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)V", line = 476)
