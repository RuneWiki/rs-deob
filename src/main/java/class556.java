...
public class class556 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lwfa;B)V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)Lgk;")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lwea;B)V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lov;I)V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILwea;)V")
