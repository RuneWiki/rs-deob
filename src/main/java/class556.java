...
public class class556 extends Exception {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILuw;Luw;)V", line = 6)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)Z", line = 64)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILraa;IB)V", line = 75)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 102)
