...
public class class556 extends class366 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILep;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ler;Lfj;)V", line = 32)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(III)V", line = 143)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)Z", line = 174)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZI)V", line = 185)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(I)V", line = 214)
