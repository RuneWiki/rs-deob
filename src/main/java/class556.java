...
public class class556 implements class104 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZLjava/lang/String;ZZLlaa;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)Z", line = 117)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(ZZ)Z", line = 129)
    public static boolean method3117(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lpp;)V", line = 150)
