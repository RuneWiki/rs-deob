...
public class class556 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZIII)Lpl;", line = 21)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(FIIFF)F", line = 54)
