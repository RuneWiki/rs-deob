...
public abstract class class556 extends class435 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([Llaa;Z)I")
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)Lbm;")
    ...
    @OriginalMember(owner = "client!ii", name = "c", descriptor = "(ILha;)Z")
