...
public class class556 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIIZZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIILkc;I)Lpfa;", line = 76)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IFIZIIIB)[I", line = 126)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(II)Lna;", line = 150)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILjava/lang/String;ZZLjava/lang/String;)V", line = 179)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 222)
