...
public class class556 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)V", line = 217)
