...
public class class522 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 55)
