...
public class class522 extends class208 {
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)Lkh;", line = 17)
    public final class15 method1201(byte arg0) {
        field7329++;
        return arg0 == 51 ? this.field7326 : null;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lmh;I)V", line = 47)
    public class522(class537 arg0, int arg1) {
        this.field7328 = arg0;
        this.field7326 = new class15(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(FBLkh;Lkh;)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZLjava/lang/String;)J", line = 256)
