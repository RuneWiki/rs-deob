...
public class class522 extends class465 {
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lno;Lhm;)V", line = 86)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IILhf;)V", line = 106)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)V", line = 122)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)V", line = 155)
