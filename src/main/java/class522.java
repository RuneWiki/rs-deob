...
public class class522 extends class618 implements class406 {
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIIIII[FLua;)V", line = 24)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Ltia;Lua;Ldn;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZIZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(FI)F", line = 67)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(FZ)F", line = 89)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Ltia;IIZ[III)V", line = 100)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Ltia;Lua;IIZ[BII)V", line = 122)
    ...
    @OriginalMember(owner = "client!iaa", name = "e", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(III[IIBII)V", line = 153)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIILua;II[BII)V", line = 166)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B)I", line = 182)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I[IIIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Ltia;Lua;IIZ[FII)V", line = 218)
