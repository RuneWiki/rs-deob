...
public class class522 implements class216 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)Lok;")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lfi;Lok;Z)V")
