...
public class class522 extends class337 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILuq;)Luq;", line = 4)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IB)[I", line = 22)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "()V", line = 112)
    public class522() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILul;)I", line = 134)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BILhp;)V", line = 154)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIIZIZI)V", line = 207)
