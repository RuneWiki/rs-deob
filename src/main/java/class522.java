...
public class class522 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BLifa;)V")
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)Loq;")
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(B)Loq;")
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lifa;)V")
