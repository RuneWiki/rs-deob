...
public class class522 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II)Lpa;", line = 9)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIIIILpq;)Lim;", line = 91)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Z[B)[B", line = 123)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IC)Z", line = 154)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Ldh;ILkha;)V", line = 200)
    public class522(class286 arg0, int arg1, class687 arg2) {
        this.field7394 = arg2;
        this.field7394.method3812(0, 29);
    }

    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(II)V", line = 188)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Ld;BLkha;ILjava/awt/Canvas;I)Lha;", line = 215)
