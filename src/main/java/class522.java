...
public class class522 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILqn;ILqa;Loa;Lqa;IZIIIZ)Lf;", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(II)Lrh;", line = 109)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZB)V", line = 204)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIZIBI)V", line = 245)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IZ)V", line = 363)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILqa;IIIBLqn;I)Lf;", line = 383)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIBI)V", line = 402)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lmt;IZLet;Lhh;Lhh;)V", line = 516)
