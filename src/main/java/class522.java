...
public class class522 extends class687 {
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(IIIIIF)V", line = 23)
    public class522(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III[BIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(FB)V", line = 139)
