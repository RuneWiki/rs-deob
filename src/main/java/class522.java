...
public class class522 extends class694 {
    ...
    @OriginalMember(owner = "client!cv", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILjr;B)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIILpj;)Lec;")
