...
public class class522 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lfc;I)Leha;", line = 34)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIIIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLro;)Z", line = 74)
