...
public class class522 extends class667 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I[[I)V", line = 65)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lud;II)V", line = 119)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BI)[I", line = 193)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 216)
    public static void method3095(int arg0) {
        field7394 = null;
        int var1 = -124 % ((1 - arg0) / 59);
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Leq;B)V", line = 226)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 243)
    public class522() {
        super(0, true);
    }
}
