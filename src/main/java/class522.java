...
public class class522 extends class597 implements class310 {
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Loa;I)Lqt;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZLoa;Lnt;IIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Z)[Llh;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Loa;Lpg;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILoa;IZ)Lm;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lrr;III)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Loa;II)Lba;")
