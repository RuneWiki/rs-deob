...
public class class522 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bia", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(II[I)Lbc;", line = 55)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(III[I)Lbc;", line = 79)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(BII[I)Lbc;", line = 125)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Lbg;[[BI)V", line = 172)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Lha;II)Lqda;", line = 204)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I[II)Lbc;", line = 231)
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(Lcb;Lcb;)V", line = 261)
