...
public class class522 extends class497 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lun;I)Leg;", line = 4)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIB)V", line = 51)
    public void method415(int arg0, int arg1, byte arg2) {
        ++field7659;
        this.field7660[this.field7654++] = (byte) ((class435.method2605(arg2, arg0) >> 1) + 127);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(III)V", line = 63)
    ...
    @OriginalMember(owner = "client!wm", name = "f", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(IIIIIF)V", line = 88)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)V", line = 106)
