...
public abstract class class522 extends class419 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!mv", name = "f", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IB)V", line = 71)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 88)
