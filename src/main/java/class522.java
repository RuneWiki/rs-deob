...
public class class522 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lcu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(Lcu;)V", line = 19)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "()V", line = 56)
    public class522() {
        this.field7740[0] = 0;
