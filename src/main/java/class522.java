...
public class class522 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I)Ltq;", line = 5)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(I)Ltq;", line = 63)
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(Z)Ltq;", line = 91)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(ILtq;)V", line = 110)
    ...
    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "()V", line = 193)
    public class522() {
        this.field7324.field7165 = this.field7324;
        this.field7324.field7164 = this.field7324;
    }

    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(B)Ltq;", line = 131)
    ...
    @OriginalMember(owner = "client!fha", name = "c", descriptor = "(B)Ltq;", line = 158)
    ...
    @OriginalMember(owner = "client!fha", name = "c", descriptor = "(Z)V", line = 180)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(ZLfha;Ltq;)V", line = 204)
    ...
    @OriginalMember(owner = "client!fha", name = "d", descriptor = "(B)Z", line = 229)
    ...
    @OriginalMember(owner = "client!fha", name = "c", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lfha;B)V", line = 270)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Ltq;B)V", line = 281)
