...
public class class522 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Ljo;Ljo;Ljo;Ljo;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BI)Z", line = 38)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;IZ)V", line = 68)
