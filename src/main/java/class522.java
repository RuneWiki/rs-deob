...
public class class522 extends class192 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(ZLwk;I)V", line = 106)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(II)Z", line = 446)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(ILfd;I)V", line = 461)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "()V", line = 478)
    public class522() {
        super(1, true);
    }

    @OriginalMember(owner = "client!lv", name = "e", descriptor = "(B)V", line = 485)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IB)[I", line = 496)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IIIII)V", line = 551)
