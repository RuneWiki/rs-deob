...
public class class522 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lqf;B)Lqf;")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)Lem;")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)Lgl;")
