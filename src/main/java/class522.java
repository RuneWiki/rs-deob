...
public abstract class class522 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIZI)I", line = 14)
    ...
    @OriginalMember(owner = "client!wt", name = "h", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!wt", name = "i", descriptor = "(I)V", line = 57)
