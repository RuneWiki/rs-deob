...
public class class522 extends class759 {
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)Llq;", line = 4)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(I)V", line = 20)
    public static final void method3967(int arg0) {
        class440.field6487 = arg0;
    }

    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(B)V", line = 30)
