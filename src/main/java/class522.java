...
public class class522 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)Lki;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lwo;I)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lki;I)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lki;B)V")
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(B)Lki;")
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(B)Lki;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lwo;ILki;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "e", descriptor = "(B)Lki;")
    ...
    @OriginalMember(owner = "client!wo", name = "g", descriptor = "(B)Lki;")
