...
public class class522 implements class318 {
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)Lib;", line = 61)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 72)
    public static void method2960(int arg0) {
        field7397 = null;
        int var1 = 38 % ((-arg0 - 80) / 32);
    }

    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(I)V", line = 87)
    public class522(int arg0) {
        this.field7398 = arg0;
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IILr;IIII)Lda;", line = 98)
