...
public class class522 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BI)Lfb;", line = 19)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lpt;ILum;Lum;)V", line = 190)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 164)
