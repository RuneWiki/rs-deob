...
public class class522 extends class112 {
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(B)Lbo;", line = 6)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Los;IIIIII)V", line = 183)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(B)V", line = 198)
