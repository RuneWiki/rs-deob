...
public class class522 extends class402 implements class437 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lpea;ILjaclib/memory/Buffer;)V", line = 30)
    public class522(class641 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field7233 = arg1;
    }

    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lpea;I[BI)V", line = 51)
    public class522(class641 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field7233 = arg1;
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)J", line = 60)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 71)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I[BIB)V", line = 116)
