...
public class class522 extends class381 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lmv;[ILmv;I)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IZLnc;Z)V")
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Luca;Lvfa;Ltg;[I)V")
