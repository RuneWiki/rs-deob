...
public class class522 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lbq;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)Lmc;", line = 57)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "()V", line = 79)
    public class522() {
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIIIZI)V", line = 83)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)Lmc;", line = 187)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lbq;)V", line = 206)
