...
public abstract class class522 extends class117 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIIIZIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(Z)V", line = 282)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(IIIZZ)V", line = 309)
