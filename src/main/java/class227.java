...
public class class227 extends class322 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lch;)V", line = 39)
    public class227(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(ILch;)V", line = 69)
    public class227(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)I", line = 76)
