...
public class class227 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILrp;Lgca;)V", line = 5)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Z)Lrp;", line = 35)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)I", line = 61)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)Lrp;", line = 97)
    ...
    @OriginalMember(owner = "client!gca", name = "c", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lrp;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BI[BIIIII[B)V", line = 154)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(I)Lrp;", line = 198)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(Lrp;I)V", line = 219)
    ...
    @OriginalMember(owner = "client!gca", name = "c", descriptor = "(I)Lrp;", line = 240)
    ...
    @OriginalMember(owner = "client!gca", name = "d", descriptor = "(B)Lrp;", line = 259)
    ...
    @OriginalMember(owner = "client!gca", name = "d", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "()V", line = 330)
    public class227() {
        this.field3151.field5625 = this.field3151;
        this.field3151.field5621 = this.field3151;
    }

    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILgca;)V", line = 316)
