...
public class class227 extends class210 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IILat;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lct;Z)V")
    ...
    @OriginalMember(owner = "client!ak", name = "g", descriptor = "(I)Leg;")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLkg;II)V")
