...
public class class227 extends class205 implements class41 {
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(ILya;)V", line = 29)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILya;II)Z", line = 59)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lng;", line = 80)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(BII)Z", line = 103)
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZLya;)Llo;", line = 184)
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lya;I)V", line = 222)
    ...
    @OriginalMember(owner = "client!cs", name = "e", descriptor = "(I)I", line = 238)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)Z", line = 252)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lya;IB)Lt;", line = 264)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lya;Lho;IIIIIZIIIIIIZ)V", line = 288)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)I", line = 322)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Z)I", line = 339)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IZLya;I)Ldp;", line = 351)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILya;)V", line = 391)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(Z)I", line = 427)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)I", line = 440)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IILya;)Lt;", line = 452)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)I", line = 464)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 476)
