...
public class class227 extends class34 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 31)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILjava/awt/Graphics;IIII)V", line = 43)
