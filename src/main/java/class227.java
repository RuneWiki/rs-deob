...
public class class227 extends class232 {
    ...
    @OriginalMember(owner = "client!cha", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(CB)Z", line = 47)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(BI)V", line = 94)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IB)[I", line = 116)
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "()V", line = 158)
    public class227() {
        super(1, true);
    }
