...
public class class227 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)Lqu;", line = 22)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 62)
