...
public class class227 extends class367 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIIBI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Llm;ILlm;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZII)V", line = 254)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "()V", line = 352)
    protected class227() {
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lnj;)V", line = 363)
