...
public class class227 extends class211 {
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIB)Z", line = 18)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIILqq;)Z", line = 29)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILod;IILqq;Lll;Lgf;Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)V", line = 137)
