...
public class class227 extends class264 {
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(BI)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 102)
    public class227() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "([BB)Lks;", line = 110)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIJZ)Ljava/lang/String;", line = 220)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BC)Z", line = 311)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 336)
    ...
    @OriginalMember(owner = "client!hp", name = "h", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILml;ZLml;I)I", line = 364)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lfo;IIII)V", line = 461)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLkk;I)V", line = 627)
