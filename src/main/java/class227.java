...
public class class227 extends class9 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Ltea;IIIILha;I)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ZLsca;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "([Ltea;[BILha;IB)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILha;Z)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIILrg;III[IIILha;)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lha;IBILrg;[I)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIZII)Ljn;")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIBIIIIILha;ILtea;)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(II[BIIIIZ[Ltea;Lha;I)V")
