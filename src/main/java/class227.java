...
public class class227 extends class71 implements class176 {
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(III[B)V", line = 15)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)J", line = 26)
    public final long method1268(int arg0) {
        ++field3266;
        return arg0 != 32127 ? -1L : super.field975.method148();
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BC)B", line = 41)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)I", line = 167)
    ...
    @OriginalMember(owner = "client!mv", name = "d", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IILtl;)Ljava/lang/String;", line = 189)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 221)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lbv;I[BI)V", line = 270)
