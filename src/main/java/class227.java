...
public abstract class class227 extends class435 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)[I", line = 9)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!gd", name = "e", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!gd", name = "f", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!gd", name = "g", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!gd", name = "h", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lug;II)V", line = 162)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZ)[[I", line = 173)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(II)I", line = 184)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IB)V", line = 290)
    ...
    @OriginalMember(owner = "client!gd", name = "i", descriptor = "(I)I", line = 303)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)[I", line = 318)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(III)[[I", line = 338)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 370)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIB)V", line = 445)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(IZ)V", line = 469)
