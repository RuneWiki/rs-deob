...
public class class227 extends class498 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vu", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIZ)Ljava/lang/String;", line = 36)
