...
public class class227 extends class32 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(IIIIIF)V", line = 27)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZLdn;I[[BLea;[[B[[BBLdn;I[[I[[BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IILea;B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IB)V", line = 122)
    public void method1422(int arg0, byte arg1) {
        this.field3152[this.field3153++] = (byte) (127 + class187.method1301(arg1 >> 1, 127));
        ++field3145;
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 130)
