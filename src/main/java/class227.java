...
public class class227 extends class436 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IILeb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIBI)V", line = 49)
    ...
    @OriginalMember(owner = "client!tb", name = "e", descriptor = "(B)I", line = 158)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Laa;II[Lie;IIIIZ[BII)[I", line = 293)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(II)[[I", line = 767)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 861)
    public class227() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tb", name = "f", descriptor = "(I)V", line = 847)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IZII)V", line = 867)
