...
public class class227 extends class337 {
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lkfa;II[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!aaa", name = "f", descriptor = "(I)I", line = 38)
    public static final int method1492(int arg0) {
        ++field3382;
        return arg0 != 1 ? -15 : class99.field1482;
    }

    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(B)V", line = 74)
