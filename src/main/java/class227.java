...
public class class227 extends class239 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!in", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 3)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field2822;
        return this.field2823 == arg0;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IBI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILjava/awt/Graphics;IZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!in", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 56)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field2812;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IILjava/awt/Graphics;IBI)V", line = 68)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 85)
    ...
    @OriginalMember(owner = "client!in", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 106)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!in", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 138)
    public final void startProduction(ImageConsumer arg0) {
        ++field2819;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!in", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 146)
