...
public class class227 extends class86 {
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lsf;)V", line = 50)
    public class227(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(ILsf;)V", line = 69)
    public class227(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Z)I", line = 94)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IZ)V", line = 105)
