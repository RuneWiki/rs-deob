...
public class class227 extends class369 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lud;BI)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lej;Lku;I)Lwm;")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lqo;Llc;)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZZLff;)V")
