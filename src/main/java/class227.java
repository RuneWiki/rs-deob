...
public class class227 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IBI)V", line = 17)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIIIIII)V", line = 61)
