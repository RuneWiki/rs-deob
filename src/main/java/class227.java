...
public class class227 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IILjava/lang/Object;Z)[B", line = 7)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 59)
