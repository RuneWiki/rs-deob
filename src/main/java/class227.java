...
public class class227 extends class386 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!gca", name = "e", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "()V", line = 82)
    public class227() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(BII)I", line = 99)
