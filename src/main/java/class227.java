...
public class class227 extends class343 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLha;)Lck;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lvfa;Z)V")
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lha;IIB)Z")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lha;B)V")
