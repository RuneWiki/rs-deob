...
public class class227 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IBI)Z", line = 52)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(III)Z", line = 101)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(III)Z", line = 113)
