...
public class class227 implements class555 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IBI)Z", line = 62)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIIIIZZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BILjava/lang/String;)V", line = 115)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lpm;Ljd;Lnp;)V", line = 126)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(IIIIIIZZ)V", line = 167)
