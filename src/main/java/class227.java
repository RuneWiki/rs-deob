...
public class class227 extends class296 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(III[[ZZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cea", name = "YA", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(III[[ZZII)V", line = 598)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lbt;IBIZI)V", line = 606)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)V", line = 621)
    public final void method1392(int arg0, int arg1) {
        ++field2660;
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZI[[ZIIIII)V", line = 628)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 770)
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "(I)V", line = 856)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIILnfa;)V", line = 872)
    ...
    @OriginalMember(owner = "client!cea", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 936)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(III[Ljava/lang/Object;[I)V", line = 958)
    ...
    @OriginalMember(owner = "client!cea", name = "fa", descriptor = "(IILr;)Lr;", line = 1013)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lkp;[I)V", line = 1042)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(JJ)J", line = 1052)
    public static long method1401(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!cea", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 1063)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 1081)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(B)V", line = 1105)
    ...
    @OriginalMember(owner = "client!cea", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1119)
    ...
    @OriginalMember(owner = "client!cea", name = "ka", descriptor = "(III)V", line = 1201)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1211)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lpc;IIII[[I[[II)V", line = 1382)
