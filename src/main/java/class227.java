...
public class class227 extends class414 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)[F", line = 10)
    ...
    @OriginalMember(owner = "client!dj", name = "ZA", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(I)[F", line = 75)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIBILdu;)V", line = 96)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "()Lia;", line = 150)
    ...
    @OriginalMember(owner = "client!dj", name = "YA", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!dj", name = "E", descriptor = "(III[I)V", line = 188)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(III[I)V", line = 199)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILia;)V", line = 214)
    ...
    @OriginalMember(owner = "client!dj", name = "HA", descriptor = "()V", line = 241)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IFFIIFI)V", line = 250)
    ...
    @OriginalMember(owner = "client!dj", name = "ma", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!dj", name = "Q", descriptor = "(IIIIII)V", line = 297)
    ...
    @OriginalMember(owner = "client!dj", name = "O", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!dj", name = "ba", descriptor = "(Lia;)V", line = 345)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "()V", line = 368)
    public class227() {
        this.method902();
    }

    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(B)V", line = 376)
    ...
    @OriginalMember(owner = "client!dj", name = "X", descriptor = "([I)V", line = 393)
    ...
    @OriginalMember(owner = "client!dj", name = "R", descriptor = "(III)V", line = 409)
    ...
    @OriginalMember(owner = "client!dj", name = "na", descriptor = "(I)V", line = 425)
