...
public abstract class class227 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZLjava/lang/String;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/lang/String;BI)Ltha;", line = 38)
