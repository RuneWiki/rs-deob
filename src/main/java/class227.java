...
public class class227 extends class540 implements class556 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 19)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 45)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)V", line = 75)
