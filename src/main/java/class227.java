...
public class class227 extends class470 {
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIIIZ[BI)V", line = 15)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIIZ[III)V", line = 39)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIIII[BI)V", line = 74)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIIIIZ)V", line = 120)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIIIIIZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpq;IIII[I)V", line = 154)
    public class227(class194 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
