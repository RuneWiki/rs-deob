...
public class class227 extends class37 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lpj;BLe;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)[Ldu;", line = 17)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(I)V", line = 41)
    public class227(int arg0) {
        this.field3260 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ae", name = "f", descriptor = "(I)V", line = 49)
