...
public abstract class class227 extends class263 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)F", line = 19)
    public final float method1368(int arg0) {
        field2921++;
        return arg0 == 128 ? this.field2933 : 0.79889834F;
    }

    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "([[BBLgo;)V", line = 55)
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(IIIIIF)V", line = 179)
