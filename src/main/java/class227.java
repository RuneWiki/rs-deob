...
public class class227 extends class541 {
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Los;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Los;II)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Los;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lqa;Lob;BIIILbj;Lmaa;)V")
