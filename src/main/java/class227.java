...
public class class227 extends class205 {
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!d", name = "h", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IB)[[I", line = 29)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IZIII)I", line = 79)
