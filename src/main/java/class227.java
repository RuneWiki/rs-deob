...
public class class227 extends class359 implements class194 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFLta;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lw;Lg;[IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lw;Lg;IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILta;II)V", line = 43)
