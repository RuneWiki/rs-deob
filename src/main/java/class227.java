...
public class class227 implements class201 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()V", line = 22)
    public final void method1668() {
        this.field3648 = null;
        this.method1664();
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()V", line = 33)
    public final void method1673() {
        this.field3648 = Thread.currentThread();
        this.method1671();
    }

    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lv;BIZ)Lda;", line = 47)
