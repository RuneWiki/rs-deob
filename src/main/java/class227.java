...
public class class227 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lpg;)Z")
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(Lpg;)V")
    public final void method1522(class437 arg0) {
        this.method1523(arg0, true);
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lpg;Z)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lao;)V")
