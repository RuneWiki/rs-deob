...
public class class227 implements Runnable {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!fo", name = "run", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IBI)I", line = 52)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ljava/lang/String;Lqj;BZ)Lsc;", line = 75)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIZIB)V", line = 121)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 136)
