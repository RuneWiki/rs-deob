...
public class class227 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)I", line = 38)
    public static final int method1610(int arg0, int arg1) {
        field3699++;
        return arg1 == 255 ? arg0 & 0xFF : 62;
    }

    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(II)Lgg;", line = 58)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(II)V", line = 128)
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(II)V", line = 144)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lee;ILul;Lul;)V", line = 162)
