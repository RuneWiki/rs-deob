...
public class class227 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIILuf;)V", line = 15)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lmj;)V", line = 169)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 146)
