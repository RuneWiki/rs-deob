...
public class class227 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lre;B)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)[Lrt;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLre;I)V")
