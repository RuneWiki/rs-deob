...
public class class227 extends class73 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lfw;[Lkg;)Lkg;")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lhr;[Lkg;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lhr;)V")
    public class227(class446 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BIZ)Lr;")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lhr;Lei;IIII)V")
