...
public class class227 implements class751 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 197)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLjava/awt/Component;IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I[I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)V", line = 128)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IZ)I", line = 157)
