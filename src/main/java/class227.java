...
public class class227 extends class90 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZIIJLha;)V", line = 6)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lha;Loea;Lf;J)V", line = 385)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(JZLha;)V", line = 343)
