...
public class class227 extends class524 implements class232 {
    ...
    @OriginalMember(owner = "client!dj", name = "i", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IILqa;IZLha;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!dj", name = "e", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Z)I", line = 70)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lqa;Lbo;IIIIZIIZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILqa;)Lbw;", line = 132)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILqa;I)Lc;", line = 157)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZLqa;II)Lrl;", line = 186)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(Lqa;I)V", line = 218)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)I", line = 238)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lqa;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(I)I", line = 300)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIILqa;)Z", line = 312)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IILqa;)Lc;", line = 338)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lqs;B[[B)V", line = 350)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(Lqa;I)V", line = 440)
