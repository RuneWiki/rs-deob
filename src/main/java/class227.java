...
public class class227 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I[Ljava/lang/Object;Ljava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/lang/String;BLjava/applet/Applet;)V", line = 15)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;I)Ljava/lang/Object;", line = 25)
