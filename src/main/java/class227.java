...
public class class227 extends class150 {
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IBB)V", line = 43)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(IIIIIF)V", line = 68)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIII)I", line = 94)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)V", line = 121)
