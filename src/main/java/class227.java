...
public abstract class class227 implements class58 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILraa;ILaa;Lda;IILjava/lang/String;IILpia;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILjava/lang/String;Lha;IIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZZ)V", line = 250)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lla;Lla;Lhc;)V", line = 274)
