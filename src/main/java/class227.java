...
public class class227 extends class113 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILen;I)Lmj;", line = 5)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIZLen;)Z", line = 19)
    ...
    @OriginalMember(owner = "client!tb", name = "g", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!tb", name = "finalize", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Len;Lmj;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!tb", name = "e", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILen;IBLfs;IZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Len;I)V", line = 192)
    ...
    @OriginalMember(owner = "client!tb", name = "f", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 214)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILen;)Lir;", line = 243)
