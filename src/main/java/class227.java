...
public class class227 extends class434 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "([BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IBI)[B", line = 36)
