...
public abstract class class227 {
    ...
    @OriginalMember(owner = "client!ng", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIZIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I[BZ)V", line = 227)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)V", line = 253)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lef;I[BIZ)V", line = 270)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lef;ILjaggl/memory/NativeBuffer;IZ)V", line = 289)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 315)
