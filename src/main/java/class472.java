...
public class class472 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)Lss;")
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)Lss;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILss;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)Lss;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILwm;Lnk;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(B)Lss;")
