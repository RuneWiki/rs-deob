...
public class class472 extends class251 {
    ...
    @OriginalMember(owner = "client!dq", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!dq", name = "g", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(B)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lha;I)Ljava/lang/String;", line = 92)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Lha;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lha;II)V", line = 139)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(III)I", line = 213)
    ...
    @OriginalMember(owner = "client!dq", name = "h", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([ILha;B)V", line = 273)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IB)Lhi;", line = 303)
