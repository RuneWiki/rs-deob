...
public class class472 extends class11 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(CI)I", line = 4)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Leh;Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Leh;IB)V", line = 324)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(II)I", line = 396)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(CB)I", line = 407)
