...
public class class472 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILjava/lang/String;Llea;I)Lck;", line = 25)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lnfa;III)V", line = 63)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IBIIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(JZ)Ljava/lang/String;", line = 220)
