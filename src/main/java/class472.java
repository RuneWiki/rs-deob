...
public class class472 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)Lrg;")
    public static final class465 method2742(int arg0) {
        return (class465) field6806.method1592((byte) -25, (long) arg0);
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;II)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;IIII)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;Lti;IIII)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;)Lmg;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;Lsv;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(Lza;IIII)Lmg;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)Lvv;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ldk;Lrq;Lm;Lpk;Liv;Lhb;Lwn;)V")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ll;III)I")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ll;II)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lza;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II)Lrg;")
