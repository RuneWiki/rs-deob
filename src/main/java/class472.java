...
public class class472 extends class504 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)Lww;", line = 6)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lrg;Lal;IIIIIIIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(I)V", line = 32)
