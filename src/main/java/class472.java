...
public class class472 extends class377 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lsm;III)Ljj;", line = 3)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Lla;Lla;Ldw;)V", line = 83)
    public class472(class423 arg0, class423 arg1, class659 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!via", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(III)I", line = 100)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ZIII)V", line = 183)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IBIZ)V", line = 196)
