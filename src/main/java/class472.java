...
public class class472 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Luaa;Laa;IIILha;III)V", line = 19)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IB)Ltg;", line = 209)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(III)Z", line = 242)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(II)V", line = 255)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 267)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)V", line = 281)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 309)
