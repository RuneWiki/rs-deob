...
public class class472 extends class755 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BLib;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILwca;)V")
