...
public class class472 extends class80 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILnn;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(II)[I", line = 75)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(II)[[I", line = 97)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([[II)V", line = 160)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "()V", line = 244)
    public class472() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(Z)V", line = 249)
