...
public class class472 extends class137 implements class583 {
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I[BII)V", line = 20)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Lnv;I[BI)V", line = 135)
    public class472(class417 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6764 = arg1;
    }

    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)I", line = 150)
    public final int method17(byte arg0) {
        ++field6763;
        return arg0 != 82 ? -10 : 0;
    }

    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)J", line = 161)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ILig;I)Ljava/lang/String;", line = 173)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Lnv;ILjaclib/memory/Buffer;)V", line = 202)
    public class472(class417 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field6764 = arg1;
    }

    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Z)I", line = 216)
