...
public class class472 extends class5 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IZ)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 61)
    public class472() {
        super(1, false);
    }

    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILes;I)V", line = 331)
    ...
    @OriginalMember(owner = "client!sr", name = "i", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(FI[BFLab;FFFIIIII)V", line = 386)
    ...
    @OriginalMember(owner = "client!sr", name = "j", descriptor = "(I)V", line = 409)
