...
public class class472 extends class130 {
    ...
    @OriginalMember(owner = "client!gk", name = "f", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 41)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Luu;IZ)Z", line = 57)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIZ)V", line = 216)
