...
public class class472 extends class449 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILdc;)Z", line = 13)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "(I)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 75)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(B)V", line = 586)
