...
public class class472 extends class337 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BILhp;)V", line = 29)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "()V", line = 104)
    public class472() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z[[I)V", line = 120)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)[[I", line = 176)
