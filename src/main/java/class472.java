...
public class class472 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(FIFFIFFF)F", line = 8)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(III)Z", line = 132)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(BIIIIIILsf;)V", line = 147)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)Z", line = 162)
