...
public class class472 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILufa;Ljava/lang/String;I)Ldn;", line = 25)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIZIII)V", line = 105)
