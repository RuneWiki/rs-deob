...
public class class472 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)[[I", line = 30)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)[[[I", line = 99)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLqa;)V", line = 129)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(III)V", line = 299)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)I", line = 250)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lti;I)Lal;", line = 275)
