...
public class class472 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IBIII[BI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)[[[I", line = 59)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(III)V", line = 250)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IZIIZIIII)Z", line = 119)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II)[[I", line = 154)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 221)
