...
public class class472 extends class270 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIILjo;)Lob;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILoa;ZIIIILam;ZLdea;)Lba;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lap;BZ[III)Lhea;")
