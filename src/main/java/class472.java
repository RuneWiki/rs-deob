...
public class class472 extends class11 {
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ZZLjava/lang/String;)V", line = 91)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "()V", line = 163)
    public class472() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lsi;II)V", line = 173)
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "(II)V", line = 188)
    ...
    @OriginalMember(owner = "client!ab", name = "f", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!ab", name = "g", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)V", line = 286)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(III)V", line = 300)
    ...
    @OriginalMember(owner = "client!ab", name = "h", descriptor = "(I)V", line = 323)
