...
public class class472 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ZLfaa;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BLfaa;)Z")
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lrda;)V")
