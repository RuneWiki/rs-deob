...
public class class472 {
    ...
    @OriginalMember(owner = "client!sh", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field6614++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)I", line = 57)
    public final int method2755(boolean arg0) {
        field6616++;
        return arg0 ? -32 : this.field6621;
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(II)V", line = 75)
