...
public class class472 extends class335 {
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "()V", line = 3)
    public class472() {
        this(0);
    }

    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(I)V", line = 26)
    private class472(int arg0) {
        super(0, false);
        this.method2726(arg0, false);
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IZ)[[I", line = 34)
    ...
    @OriginalMember(owner = "client!vo", name = "d", descriptor = "(III)Z", line = 74)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILio;I)V", line = 91)
