...
public abstract class class472 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "([BZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cba", name = "d", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILjava/lang/String;IIZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lte;I[BIZ)V", line = 168)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIII)Lfaa;", line = 188)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lte;ILjaclib/memory/Buffer;IZ)V", line = 251)
    ...
    @OriginalMember(owner = "client!cba", name = "finalize", descriptor = "()V", line = 271)
