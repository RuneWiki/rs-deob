...
public class class472 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ljava/lang/Object;BIJ)V", line = 49)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 82)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)I", line = 116)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILtca;)V", line = 152)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(I)V", line = 171)
    public class472(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ljava/lang/Object;ZJ)V", line = 179)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(B)I", line = 190)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(JZ)V", line = 216)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 229)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)V", line = 244)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(II)V", line = 297)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(B)V", line = 312)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 338)
