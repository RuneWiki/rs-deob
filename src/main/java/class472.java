...
public abstract class class472 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILjea;Ljea;[ZIIILjea;IIZLjea;II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILjea;IILjea;ZI[III)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lag;Lah;ZLag;[I[ZZBIIII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILjea;ILjea;ZIIII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Ljea;II)V")
