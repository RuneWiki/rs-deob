...
public class class472 extends class541 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 26)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "([Lrba;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!so", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILjava/lang/String;)V", line = 119)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 147)
