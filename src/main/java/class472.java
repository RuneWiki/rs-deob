...
public abstract class class472 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILqa;)V", line = 17)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 38)
