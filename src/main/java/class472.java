...
public class class472 extends class86 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IB)Z", line = 42)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)Z", line = 53)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z)Z", line = 70)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(I)V", line = 163)
