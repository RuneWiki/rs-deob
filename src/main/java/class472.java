...
public class class472 implements class762 {
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Laj;Laj;Ljl;)V", line = 62)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 75)
