...
public class class472 extends class577 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lso;B)Llw;", line = 6)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BILmea;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIIIILvn;)V", line = 99)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "()V", line = 110)
    public class472() {
    }

    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(J)V", line = 121)
