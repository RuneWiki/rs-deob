...
public class WordPack {
    ...
    @OriginalMember(owner = "client!zb", name = "d", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(ILlb;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(Llb;Ljava/lang/String;Z)V")
