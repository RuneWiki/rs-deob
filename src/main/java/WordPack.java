...
public class WordPack {
    ...
    @OriginalMember(owner = "client!zb", name = "e", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(BLlb;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(Ljava/lang/String;Llb;I)V")
