...
public class WordPack {
    ...
    private static boolean field882 = true;

    @OriginalMember(owner = "client!zb", name = "b", descriptor = "[C")
    public static char[] field883 = new char[100];

    @OriginalMember(owner = "client!zb", name = "c", descriptor = "Llb;")
    private static Packet field884 = new Packet(false, new byte[100]);
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(Llb;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(ILlb;Ljava/lang/String;)V")
    public static void method307(int arg0, Packet arg1, String arg2) {
        if (arg2.length() > 80) {
    ...
    public static String method308(byte arg0, String arg1) {
        field884.field716 = 0;
        method307(587, field884, arg1);
        int var2 = field884.field716;
        if (arg0 != 2) {
