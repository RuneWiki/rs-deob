                    ...
                    if (var19 / var13 > -Draw2D.centerY2d) {
                        ...
                        if (var21 / var13 < Draw2D.centerY2d) {
                            ...
                            if (arg8 > 0 && checkHover) {
                                ...
                                int var30 = mouseX - Draw3D.centerX;
                                int var31 = mouseY - Draw3D.centerY;
    ...
    private final void drawNearClippedFace(int arg0) {
        ...
        if ((var26 - var27) * (var31 - var30) - (var28 - var27) * (var29 - var30) > 0) {
            ...
            if (var4 == 3) {
                ...
                if (var32 == 0) {
                    Draw3D.fillGouraudTriangle(var29, var30, var31, var26, var27, var28, clippedColour[0], clippedColour[1], clippedColour[2]);
                } else if (var32 == 1) {
                    Draw3D.fillTriangle(var29, var30, var31, var26, var27, var28, palette[this.faceColourA[arg0]]);
                } else if (var32 == 2) {
            ...
            if (var4 == 4) {
                ...
                if (var41 == 0) {
                    Draw3D.fillGouraudTriangle(var29, var30, var31, var26, var27, var28, clippedColour[0], clippedColour[1], clippedColour[2]);
                    Draw3D.fillGouraudTriangle(var29, var31, clippedY[3], var26, var28, clippedX[3], clippedColour[0], clippedColour[2], clippedColour[3]);
                    return;
                }
                if (var41 == 1) {
                    int var42 = palette[this.faceColourA[arg0]];
                    Draw3D.fillTriangle(var29, var30, var31, var26, var27, var28, var42);
                    Draw3D.fillTriangle(var29, var31, clippedY[3], var26, var28, clippedX[3], var42);
                    return;
                }
                if (var41 == 2) {
                    ...
                    Draw3D.fillTexturedTriangle(var29, var31, clippedY[3], var26, var28, clippedX[3], clippedColour[0], clippedColour[2], clippedColour[3], vertexViewSpaceX[var44], vertexViewSpaceX[var45], vertexViewSpaceX[var46], vertexViewSpaceY[var44], vertexViewSpaceY[var45], vertexViewSpaceY[var46], vertexViewSpaceZ[var44], vertexViewSpaceZ[var45], vertexViewSpaceZ[var46], this.faceColour[arg0]);
                    return;
                }
                if (var41 == 3) {
                    ...
                    Draw3D.fillTexturedTriangle(var29, var31, clippedY[3], var26, var28, clippedX[3], this.faceColourA[arg0], this.faceColourA[arg0], this.faceColourA[arg0], vertexViewSpaceX[var48], vertexViewSpaceX[var49], vertexViewSpaceX[var50], vertexViewSpaceY[var48], vertexViewSpaceY[var49], vertexViewSpaceY[var50], vertexViewSpaceZ[var48], vertexViewSpaceZ[var49], vertexViewSpaceZ[var50], this.faceColour[arg0]);
                }
            }
        }
    }
