...
public class class228 implements class572 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILkja;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)J", line = 178)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lqj;I)Z", line = 227)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIILbv;I)V", line = 269)
