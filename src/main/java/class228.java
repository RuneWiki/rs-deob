...
public class class228 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BI)Lrk;", line = 34)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 83)
    public class228(class320 arg0, int arg1, class701 arg2) {
        this.field2826 = arg2;
        this.field2826.method3883(30, 0);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 98)
