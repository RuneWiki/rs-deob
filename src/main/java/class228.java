...
public class class228 implements class577 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ZI)I", line = 126)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(II)I", line = 176)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BZ)I", line = 188)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 227)
