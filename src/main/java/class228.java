...
public class class228 extends class459 implements class75 {
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lik;Lwu;Lbk;II)V")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lik;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lkk;I)V")
    public final void method1215(class238 arg0, int arg1) {
        super.method1215(arg0, arg1);
    }

    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lik;Lwu;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIIIII[BLwu;I)V")
