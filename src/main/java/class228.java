...
public class class228 extends class337 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 213)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "()V", line = 384)
    public class228() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cs", name = "i", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BILhp;)V", line = 289)
