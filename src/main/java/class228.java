...
public class class228 extends class394 {
    ...
    @OriginalMember(owner = "client!ae", name = "M", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILn;II)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIIB)Leba;")
