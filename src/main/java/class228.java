...
public class class228 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Llba;II)Lmg;", line = 20)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILjda;)V", line = 76)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I[B)Lln;", line = 116)
