...
public class class228 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ZZIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lfp;II)Lqm;", line = 104)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 135)
