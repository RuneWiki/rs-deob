...
public class class228 extends class125 {
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(ILgp;)V")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lgp;)V")
    public class228(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Laj;I)Ljava/lang/String;")
