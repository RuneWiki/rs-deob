...
public class class228 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ltq;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BLvm;)Llg;", line = 207)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIIIB)V", line = 234)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)Z", line = 286)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(Z)V", line = 339)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ltq;I)V", line = 349)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZLvm;I)Llg;", line = 376)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIIII)V", line = 415)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IB)I", line = 433)
