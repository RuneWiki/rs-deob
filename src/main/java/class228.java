...
public class class228 extends class397 {
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "()V", line = 114)
    public class228() {
        super(1, false);
    }

    @OriginalMember(owner = "client!du", name = "e", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(II)[I", line = 19)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IBLae;)V", line = 64)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BI)[[I", line = 120)
