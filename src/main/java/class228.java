...
public class class228 extends class207 {
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lrd;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIILuq;IZ)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(ILrd;)V")
