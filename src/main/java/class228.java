...
public class class228 extends class331 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(II)I", line = 102)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(II)V", line = 116)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(B)Z", line = 155)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lts;)V", line = 170)
    public class228(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)[Lmq;", line = 175)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(B)I", line = 186)
    public final int method1463(byte arg0) {
        ++field2983;
        return arg0 >= -119 ? 51 : super.field4202;
    }

    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(B)I", line = 197)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(ILts;)V", line = 208)
