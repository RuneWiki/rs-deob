...
public class class228 extends class74 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIB)Lni;", line = 4)
    ...
    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)I", line = 94)
    public static final int method1364(int arg0, int arg1) {
        return class319.field4080 != null ? class319.field4080[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "([Llo;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ZZ)V", line = 176)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IILhfa;)V", line = 192)
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Len;)V", line = 270)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIB)V", line = 252)
