...
public class class228 extends class624 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "()V", line = 113)
    public class228() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!wn", name = "d", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IBB)V", line = 130)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(IIII)[B", line = 146)
