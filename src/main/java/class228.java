...
public abstract class class228 extends class184 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lqf;IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILpe;IIIILsj;Lqi;IZIIIII)Lsj;", line = 58)
    ...
    @OriginalMember(owner = "client!fo", name = "e", descriptor = "(B)V", line = 281)
    public void method1108(byte arg0) {
        int var2 = 95 % ((40 - arg0) / 39);
        field3180++;
    }

    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(II)V", line = 296)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lbi;III)V", line = 318)
    ...
    @OriginalMember(owner = "client!fo", name = "h", descriptor = "(I)V", line = 338)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 366)
