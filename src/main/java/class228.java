...
public class class228 extends class42 {
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lvo;Lvo;Lfga;)V", line = 3)
    public class228(class345 arg0, class345 arg1, class340 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIIZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIZI)V", line = 54)
