...
public abstract class class228 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!tk", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIILjava/lang/String;BZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!tk", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 61)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field3400++;
    }

    @OriginalMember(owner = "client!tk", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 70)
    ...
    @OriginalMember(owner = "client!tk", name = "providesignlink", descriptor = "(Lji;)V", line = 87)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!tk", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 139)
    public final void windowDeiconified(WindowEvent arg0) {
        field3380++;
    }

    @OriginalMember(owner = "client!tk", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 146)
    public final void windowActivated(WindowEvent arg0) {
        field3402++;
    }

    @OriginalMember(owner = "client!tk", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 154)
    public final void windowOpened(WindowEvent arg0) {
        field3366++;
    }

    @OriginalMember(owner = "client!tk", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 161)
    public final void windowClosing(WindowEvent arg0) {
        field3397++;
        this.destroy();
    }

    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IZ)V", line = 228)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(B)Ljava/lang/String;", line = 308)
    ...
    @OriginalMember(owner = "client!tk", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 319)
    public final void focusLost(FocusEvent arg0) {
        field3384++;
        class464.field6875 = false;
    }

    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(Z)V", line = 336)
    ...
    @OriginalMember(owner = "client!tk", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 350)
    public final void windowIconified(WindowEvent arg0) {
        field3395++;
    }

    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!tk", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 388)
    public final void windowDeactivated(WindowEvent arg0) {
        field3368++;
    }

    @OriginalMember(owner = "client!tk", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 395)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(JZZII)Ljava/lang/String;", line = 427)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BI)V", line = 507)
    ...
    @OriginalMember(owner = "client!tk", name = "stop", descriptor = "()V", line = 555)
    ...
    @OriginalMember(owner = "client!tk", name = "destroy", descriptor = "()V", line = 566)
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(B)V", line = 581)
    ...
    @OriginalMember(owner = "client!tk", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 627)
    ...
    @OriginalMember(owner = "client!tk", name = "run", descriptor = "()V", line = 644)
    ...
    @OriginalMember(owner = "client!tk", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 761)
    ...
    @OriginalMember(owner = "client!tk", name = "f", descriptor = "(I)V", line = 772)
    ...
    @OriginalMember(owner = "client!tk", name = "start", descriptor = "()V", line = 800)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIIB)V", line = 816)
    ...
    @OriginalMember(owner = "client!tk", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 864)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 878)
    ...
    @OriginalMember(owner = "client!tk", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 921)
