...
public class class228 extends class284 {
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "()Z", line = 72)
    public final boolean method694() {
        return true;
    }

    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lhj;Lqf;)V", line = 76)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)V", line = 106)
    public final void method696(boolean arg0) {
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lnj;)V", line = 108)
