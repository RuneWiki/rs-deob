...
public class class228 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lnn;)V", line = 23)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Lnn;)V", line = 42)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "()V", line = 56)
    public class228() {
        this.field3541[0] = 0;
