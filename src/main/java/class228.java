...
public class class228 extends class715 {
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)V", line = 6)
    public final void method689(int arg0) {
        int var2 = -63 % ((-71 - arg0) / 42);
        ++field3257;
    }

    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lgt;)V", line = 16)
    public class228(class453 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!jd", name = "f", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILdu;I)V", line = 286)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(Z)V", line = 297)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BZ)V", line = 309)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ZI)V", line = 320)
    ...
    @OriginalMember(owner = "client!jd", name = "d", descriptor = "(B)I", line = 333)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)V", line = 348)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BI)Z", line = 359)
