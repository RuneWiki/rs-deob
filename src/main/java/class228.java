...
public class class228 extends class287 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(CZ)B", line = 3)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ljk;I)Z", line = 144)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIB)I", line = 170)
