...
public class class228 extends class418 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lde;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!fh", name = "e", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(II)V", line = 190)
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(Z)V", line = 206)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(IIIIIZ)V", line = 222)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZI)V", line = 239)
