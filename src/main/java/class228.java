...
public abstract class class228 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IB)I", line = 22)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Luu;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(III)V", line = 63)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IZII)I", line = 93)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(II)Z", line = 181)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZII)V", line = 216)
