...
public class class228 extends class260 {
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(B)Lke;", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "d", descriptor = "(B)V", line = 21)
    public static void method1447(byte arg0) {
        int var1 = -94 % ((-10 - arg0) / 35);
        field3166 = null;
    }

    @OriginalMember(owner = "client!sr", name = "d", descriptor = "(I)V", line = 34)
