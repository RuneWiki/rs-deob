...
public class class228 extends class261 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ZB)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IILkk;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lih;)V")
