...
public class class228 extends class287 implements class218 {
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ltq;Lvc;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(B)Lda;")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljava/awt/Component;I)Lmg;")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ltq;III)Z")
