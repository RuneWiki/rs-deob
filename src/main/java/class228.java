...
public class class228 extends class192 {
    ...
    @OriginalMember(owner = "client!ok", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "()V", line = 16)
    public class228() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIB)I", line = 19)
    ...
    @OriginalMember(owner = "client!ok", name = "f", descriptor = "(B)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IB)[I", line = 63)
