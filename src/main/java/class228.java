...
public class class228 extends class176 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lqa;J)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "()V", line = 51)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "()V", line = 73)
    public final void method1526() {
        this.field3231 = true;
    }

    @OriginalMember(owner = "client!jg", name = "c", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "([Lhd;Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "()V", line = 176)
    public final void method1529() {
        this.field3248 = true;
    }

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lqa;J[Llq;[Lhd;Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lqa;[Llq;Z)V", line = 207)
    ...
    @OriginalMember(owner = "client!jg", name = "e", descriptor = "()Lfq;", line = 280)
    public final class137 method1533() {
        return this.field3243;
    }

    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(J)V", line = 286)
    public final void method1534(long arg0) {
        this.field3236 = arg0;
    }

    @OriginalMember(owner = "client!jg", name = "f", descriptor = "()V", line = 293)
    public static void method1535() {
        field3234 = null;
        field3233 = null;
    }

    @OriginalMember(owner = "client!jg", name = "g", descriptor = "()V", line = 297)
