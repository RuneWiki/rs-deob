...
public class class228 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ZIIIZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IIIIIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Leh;I)Llda;", line = 66)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)V", line = 89)
