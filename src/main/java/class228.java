...
public class class228 extends class687 {
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IZIIIZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(ZLem;Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(ILrs;)V", line = 281)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IIZ)Z", line = 311)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IIIIB)V", line = 335)
    ...
    @OriginalMember(owner = "client!jka", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 379)
