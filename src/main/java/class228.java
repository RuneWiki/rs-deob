...
public class class228 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(JI)V", line = 43)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 58)
    public static final boolean method1467(String arg0, int arg1) {
        field3111++;
        return arg1 == -6 ? class256.method1597(arg0, true, 0, 10) : true;
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IILen;III)V", line = 69)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILen;BILjf;)V", line = 165)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IZ)I", line = 232)
