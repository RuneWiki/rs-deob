...
public class class228 extends class438 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(JILea;ZI)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lij;Z)V")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lea;Lkg;Lrs;J)V")
