...
public abstract class class228 implements class603 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLfaa;)V", line = 16)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I[[[BIBII)V", line = 444)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZI)V", line = 581)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)Z", line = 599)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)V", line = 624)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIII)V", line = 641)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)V", line = 674)
    ...
    @OriginalMember(owner = "client!jl", name = "finalize", descriptor = "()V", line = 697)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)V", line = 707)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(I)V", line = 731)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lte;IIIZ)V", line = 841)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BZ)V", line = 770)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(B)I", line = 793)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIIZ)V", line = 808)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(B)I", line = 827)
