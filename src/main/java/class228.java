...
public class class228 extends class42 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILcr;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BIZ)I", line = 68)
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!tk", name = "e", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(III)Z", line = 154)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(I)V", line = 171)
