...
public class class228 extends class43 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIBII)V", line = 9)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "([SZ)[S", line = 166)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(II)V", line = 188)
