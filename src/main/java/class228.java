...
public class class228 extends class726 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILwga;[IB[II)Llp;", line = 6)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "([BI)Ljk;", line = 64)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(III[BIII)Z", line = 147)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IILha;I)Z", line = 199)
