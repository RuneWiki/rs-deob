...
public class class228 extends class607 {
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IBLiu;)V", line = 30)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B[I[Ljava/lang/Object;)V", line = 106)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ltu;)V", line = 139)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZB)V", line = 250)
