...
public class class228 extends class265 implements class145 {
    ...
    @OriginalMember(owner = "client!em", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 4)
    public final IDirect3DBaseTexture method1454(int arg0) {
        return arg0 == -23413 ? this.field3016 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILcg;)V", line = 16)
    public final void method694(int arg0, class140 arg1) {
        super.method694(arg0, arg1);
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BZZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)I", line = 43)
    public final int method806(int arg0) {
        return arg0 <= 116 ? -33 : this.field3013;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(FI)F", line = 53)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILet;III[BIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II[IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lul;Let;IIZ[BII)V", line = 142)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IF)F", line = 202)
    public final float method814(int arg0, float arg1) {
        return arg0 == 20275 ? arg1 / (float) this.field3012 : 0.105937764F;
    }

    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lul;Let;Lwha;II)V", line = 211)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIII[IIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "(I)Z", line = 270)
    public final boolean method803(int arg0) {
        return arg0 < -36;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)V", line = 281)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lul;IIZ[III)V", line = 290)
