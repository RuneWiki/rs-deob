...
public class class228 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BLlk;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IILms;IIIILvb;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILlk;)V", line = 217)
