...
public class class228 extends class216 {
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(II)Lpo;", line = 50)
    ...
    @OriginalMember(owner = "client!pi", name = "d", descriptor = "(II)V", line = 371)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lct;ILfp;)V", line = 396)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(III)Lds;", line = 423)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILqk;)V", line = 435)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(B)V", line = 605)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 618)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IFZILui;)V", line = 645)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Log;I)V", line = 672)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILog;)V", line = 696)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(II)V", line = 725)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Log;B)V", line = 754)
    ...
    @OriginalMember(owner = "client!pi", name = "e", descriptor = "(II)V", line = 777)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 802)
