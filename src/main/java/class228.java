...
public class class228 extends class398 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljava/awt/Canvas;Lcj;II)Lja;", line = 3)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIB)V", line = 16)
    public final void method23(int arg0, int arg1, byte arg2) {
        ++field3336;
        int var4 = 84 % ((arg2 - -62) / 37);
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(III)V", line = 117)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(IIIIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BI)Lgi;", line = 168)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)V", line = 196)
