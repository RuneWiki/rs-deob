...
public class class228 implements class614 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)I", line = 5)
    public final int method1124(int arg0) {
        return arg0 == 22913 ? this.field3448 : -55;
    }

    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 34)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lsga;Loea;Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(I)Loea;", line = 85)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)V", line = 96)
