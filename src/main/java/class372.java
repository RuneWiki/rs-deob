...
public class class372 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Lpd;", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIIIII)Z", line = 36)
