...
public class class372 extends class312 {
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 5)
    public final Object method2137(byte arg0) {
        return arg0 < 27 ? (Object) null : this.field5823.get();
    }

    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lkw;Ljava/lang/Object;I)V", line = 14)
    public class372(class228 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5823 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(I)Z", line = 24)
