...
public class class372 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Z)[Lvq;", line = 5)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ZI)V", line = 126)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lct;B)V", line = 150)
