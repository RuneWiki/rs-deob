...
public class class372 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Laj;Lna;IIIIILna;IZZILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lna;ZILaj;Lna;IZILqa;BIIII)Lc;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ltl;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lqa;IBIIILaj;)Lc;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIILqa;Laj;)Lc;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ltl;I)V")
