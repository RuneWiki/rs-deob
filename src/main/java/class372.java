...
public class class372 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IB)I", line = 20)
    ...
    @OriginalMember(owner = "client!bf", name = "toString", descriptor = "()Ljava/lang/String;", line = 33)
    public final String toString() {
        field5524++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(II)V", line = 88)
    public class372(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 101)
