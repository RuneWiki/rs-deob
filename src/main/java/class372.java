...
public class class372 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lkg;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Lbo;")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(ILnja;Lnja;I)V")
