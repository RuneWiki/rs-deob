...
public class class372 {
    ...
    @OriginalMember(owner = "client!tha", name = "toString", descriptor = "()Ljava/lang/String;", line = 17)
    public final String toString() {
        field5244++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IIIZI)V", line = 58)
