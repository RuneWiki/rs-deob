...
public class class372 extends class569 implements class602 {
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lha;B)Lln;")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZLjca;)V")
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIIIII)V")
