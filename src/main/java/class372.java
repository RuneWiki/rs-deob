...
public class class372 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lbt;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lbt;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLwm;I)Z", line = 85)
