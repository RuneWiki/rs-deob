...
public class class372 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B[[BLpu;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BI)Lum;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIFFFIIFIFLp;)[B")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lad;IZLdk;Ldk;)V")
