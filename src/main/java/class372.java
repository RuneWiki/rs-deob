...
public abstract class class372 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II[Ltf;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILrj;)Z", line = 94)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ltf;I)Ltf;", line = 114)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIZI)V", line = 175)
