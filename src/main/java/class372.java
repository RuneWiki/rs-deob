...
public class class372 extends class224 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "([ILud;B)V")
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(Lud;I)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)Lqca;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILud;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IILud;)V")
