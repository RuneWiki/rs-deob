...
public class class372 extends class371 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BI)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!bn", name = "g", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I[SI)[S", line = 188)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILn;Lqa;)V", line = 202)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(Z)V", line = 436)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(III)V", line = 452)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "()V", line = 472)
    public class372() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)V", line = 482)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBLps;)V", line = 737)
