...
public abstract class class372 implements class218 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ljava/io/File;Z)[B", line = 3)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IILjaclib/memory/Source;)Z", line = 34)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!oh", name = "finalize", descriptor = "()V", line = 117)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILjaggl/MapBuffer;Z)Ljaclib/memory/Buffer;", line = 158)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(I)J", line = 204)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z", line = 222)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Ldda;IZ)V", line = 276)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(B)V", line = 286)
