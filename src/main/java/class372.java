...
public class class372 extends class276 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!lia", name = "c", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIBLlga;)Lrha;", line = 36)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(Lrc;Ljava/lang/Object;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(III)Lvo;", line = 67)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "([II[JII)V", line = 86)
