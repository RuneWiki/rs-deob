...
public class class372 extends class349 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IZLtj;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILsj;)Lsj;", line = 65)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IB)Lqr;", line = 99)
    ...
    @OriginalMember(owner = "client!ri", name = "d", descriptor = "(I)V", line = 153)
