...
public class class372 implements Runnable {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLoh;Lqa;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IBLgg;)Lbq;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I[BLgg;I)Lbq;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILgg;B)Lbq;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lbq;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lae;)V")
