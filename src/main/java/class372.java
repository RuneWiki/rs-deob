...
public class class372 extends class187 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)Ljq;")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(III)Lwr;")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Lwo;")
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(ILjb;Ljb;Lse;Lje;IIZ)V")
