...
public abstract class class372 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILha;Lnh;I)V")
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(B)Len;")
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(I)Lue;")
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(B)Lrl;")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)Ldf;")
