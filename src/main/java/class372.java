...
public class class372 extends class353 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Lmv;B)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILqda;I)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lum;)V")
