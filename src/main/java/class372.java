...
public class class372 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BJLefa;)V", line = 8)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Z)Lefa;", line = 39)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(Z)I", line = 71)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(B)Lefa;", line = 110)
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(Z)Lefa;", line = 142)
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)I", line = 166)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)Z", line = 178)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(JB)Lefa;", line = 202)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "([Lefa;B)I", line = 256)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)V", line = 295)
