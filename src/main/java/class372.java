...
public class class372 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIIIIILup;ZI)Z", line = 13)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 259)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 299)
