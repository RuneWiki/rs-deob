...
public class class372 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)Lpja;", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lgia;ILaj;)V", line = 83)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 99)
