...
public abstract class class372 extends class117 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(II)Z", line = 22)
    ...
    @OriginalMember(owner = "client!e", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!e", name = "f", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 96)
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(IIIIIII)V", line = 106)
