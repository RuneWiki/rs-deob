...
public class class372 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IZI)I", line = 19)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(CZ)Z", line = 42)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILl;ILjava/awt/Canvas;Llt;B)Lza;", line = 279)
