...
public class class372 extends class631 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIZBILwu;)V")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lwu;Lwu;Lml;)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lkf;III)V")
