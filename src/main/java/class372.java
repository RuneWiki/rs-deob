...
public class class372 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILvg;)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I[B)[B", line = 43)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;)V", line = 107)
