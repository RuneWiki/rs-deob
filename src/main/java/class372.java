...
public class class372 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BLffa;ILjw;)V", line = 5)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)Z", line = 173)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILffa;)V", line = 209)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IILffa;)V", line = 229)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(BLffa;)V", line = 246)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 268)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILffa;I)V", line = 279)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BLffa;)V", line = 633)
