...
public class class372 extends class424 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ra", name = "g", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZJIII)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(IB)[I", line = 133)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lea;Lac;IIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lrg;BI)V", line = 258)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(II)V", line = 285)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I[[[BIBII)V", line = 299)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIZIII)I", line = 436)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 468)
    public class372() {
        this(4096);
    }

    @OriginalMember(owner = "client!ra", name = "d", descriptor = "(B)V", line = 472)
