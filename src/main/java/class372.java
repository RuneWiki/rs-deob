...
public class class372 extends class337 {
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!b", name = "d", descriptor = "(B)I", line = 51)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(FFIBF)F", line = 61)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!b", name = "e", descriptor = "(B)Z", line = 89)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(II)V", line = 100)
    public class372(int arg0, int arg1) {
        this.field4547 = arg0;
        this.field4548 = arg1;
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIII)I", line = 109)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)V", line = 123)
