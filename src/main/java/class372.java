...
public abstract class class372 extends class543 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lha;Lcn;IIBZI)V", line = 16)
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!rq", name = "i", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILha;)Z", line = 53)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "([Lbq;Z)I", line = 71)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(IIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!rq", name = "f", descriptor = "(I)Z", line = 93)
