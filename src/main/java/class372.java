...
public class class372 extends class364 implements class351 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILqa;I)Lc;", line = 15)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lqa;Lkn;IIIIIZIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BLqa;)V", line = 101)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IILqa;B)Z", line = 123)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(B)Z", line = 142)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lqa;B)V", line = 153)
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(ILqa;)Lnf;", line = 176)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZIILer;Lqa;IB)V", line = 221)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILqa;)V", line = 235)
