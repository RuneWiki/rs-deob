...
public class class605 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZII[[ZZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIILr;)V", line = 255)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IBLr;I)Z", line = 325)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(BIILr;)V", line = 398)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIIIB)V", line = 474)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lwk;Lmg;)V", line = 516)
