...
public class class605 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IB)I", line = 6)
    public final int method3512(int arg0, byte arg1) {
        return arg1 == -127 ? this.field8550.Present(arg0) : -47;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 45)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 63)
