...
public class class605 extends class470 implements class247 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lbc;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "()[Lfk;", line = 53)
    public final class118[] method628() {
        return this.field8445;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII)V", line = 58)
    public final void method651(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lda;IIIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;ZI)Z", line = 69)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "()Z", line = 72)
    public final boolean method615() {
        return true;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 77)
    public final void method634() {
    }

    @OriginalMember(owner = "client!v", name = "b", descriptor = "()[Lmp;", line = 82)
    public final class140[] method652() {
        return this.field8444;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lbc;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([ILq;)V", line = 102)
    private final void method3369(int[] arg0, class487 arg1) {
        this.field8443.method1086().method1171(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;)V", line = 110)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "()V", line = 168)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;Z)Z", line = 180)
    public final boolean method655(int arg0, int arg1, class487 arg2, boolean arg3) {
        return this.field8443.method1086().method1177(this, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I[IIIIIZ)V", line = 188)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIZ)Lda;", line = 191)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Lcca;IIII)V", line = 197)
