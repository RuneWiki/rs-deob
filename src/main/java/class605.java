...
public class class605 extends class644 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(JJ)J", line = 34)
    public static long method3445(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I[B)[B", line = 42)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIB)[B", line = 59)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "()V", line = 73)
    public class605() {
