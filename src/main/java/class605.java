...
public class class605 extends class384 {
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lcu;Lkha;)V", line = 238)
    ...
    @OriginalMember(owner = "client!wj", name = "e", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZB)V", line = 45)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lbia;BI)V", line = 63)
    ...
    @OriginalMember(owner = "client!wj", name = "f", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!wj", name = "d", descriptor = "(B)Z", line = 126)
    public final boolean method1021(byte arg0) {
        return arg0 <= 78 ? true : this.field8402;
    }

    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Z)V", line = 162)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IBI)V", line = 181)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!wj", name = "d", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IZ)V", line = 311)
