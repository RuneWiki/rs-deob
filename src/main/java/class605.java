...
public class class605 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BZBII)Liba;", line = 311)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(I)I", line = 354)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lvc;B)[Llea;", line = 366)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 409)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lea;ZI)V", line = 422)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(B)Z", line = 490)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(B)V", line = 501)
    ...
    @OriginalMember(owner = "client!iq", name = "d", descriptor = "(B)V", line = 517)
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(B)V", line = 546)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BZ)V", line = 567)
    ...
    @OriginalMember(owner = "client!iq", name = "f", descriptor = "(B)I", line = 594)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(I)V", line = 610)
    ...
    @OriginalMember(owner = "client!iq", name = "g", descriptor = "(B)Z", line = 624)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)I", line = 643)
