...
public class class605 extends class460 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILvo;Lpda;Lvo;Lvo;Lpn;)Z")
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Lkfa;Lul;)V")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILjo;I)V")
