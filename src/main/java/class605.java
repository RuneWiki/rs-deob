...
public class class605 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I[BIII[B)I", line = 10)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I[BI[BII)I", line = 80)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIZ[[[Lwg;II)Z", line = 228)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 547)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIII)I", line = 604)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 636)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "([B)V", line = 650)
