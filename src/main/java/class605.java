...
public class class605 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIBZ)Lkka;", line = 17)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 58)
    public static void method3505(byte arg0) {
        int var1 = 79 % ((-arg0 - 75) / 42);
        field8453 = null;
    }

    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(B)I", line = 68)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(I)Z", line = 163)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZLsv;)V", line = 442)
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(I)Z", line = 514)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZI)V", line = 526)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(B)Z", line = 560)
    ...
    @OriginalMember(owner = "client!gu", name = "f", descriptor = "(I)V", line = 570)
