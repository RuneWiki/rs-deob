...
public class class605 extends class25 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(JIIZLoa;)V", line = 10)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(JBLoa;)V", line = 179)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Loa;Lbh;Lio;J)V", line = 374)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILjava/lang/String;)V", line = 225)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(I)V", line = 289)
