...
public class class605 extends class140 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)Lad;", line = 4)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZIBI)Lin;", line = 25)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lsd;Lec;IIIIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 54)
