...
public class class605 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I[FIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lr;B)V", line = 117)
