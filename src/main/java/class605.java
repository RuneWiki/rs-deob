...
public class class605 implements Runnable {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILmu;I)Luu;", line = 3)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lmu;IZ)Luu;", line = 21)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(III)I", line = 73)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "([BIILmu;)Luu;", line = 91)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lk;)V", line = 217)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Luu;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!rs", name = "run", descriptor = "()V", line = 138)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZBI)Lqi;", line = 183)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)V", line = 197)
