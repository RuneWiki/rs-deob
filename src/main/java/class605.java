...
public class class605 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILos;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZLjj;)I", line = 42)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Los;Z)V", line = 146)
