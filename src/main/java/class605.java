...
public class class605 extends class731 {
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(I)V", line = 32)
    public class605(int arg0) {
        this.field8587 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIII)I", line = 52)
