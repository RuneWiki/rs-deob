...
public class class605 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)Lds;")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lds;Ltg;Z)V")
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)Lds;")
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(B)Lds;")
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)Lds;")
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(I)Lds;")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILtg;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILds;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(ILds;)V")
