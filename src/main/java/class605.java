...
public class class605 implements class231 {
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lbi;Ljava/lang/String;)V", line = 20)
    public class605(class449 arg0, String arg1) {
        this.field8020 = arg1;
        this.field8019 = arg0;
    }

    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)Liaa;", line = 48)
