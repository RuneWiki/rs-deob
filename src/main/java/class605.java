...
public class class605 extends class328 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(II)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "()V", line = 329)
    public class605() {
        super(2, false);
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lra;Lqa;IIIIZ)V", line = 332)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIII)V", line = 364)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BILco;)V", line = 381)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)[I", line = 430)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIFFIZF)[F", line = 684)
