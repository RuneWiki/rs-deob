...
public class class605 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I[B)V", line = 37)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)[B", line = 90)
