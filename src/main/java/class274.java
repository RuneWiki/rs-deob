...
public class class274 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IJ)Lbp;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BJLbp;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lhf;Ljava/awt/Frame;Z)V")
