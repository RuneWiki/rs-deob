...
public class class274 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I[BLfb;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lsj;I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "()V", line = 148)
    public class274() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(III)V", line = 161)
