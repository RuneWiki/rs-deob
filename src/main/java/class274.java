...
public class class274 implements class38 {

    @OriginalMember(owner = "client!id", name = "e", descriptor = "Z")
    private boolean field4494 = false;

    @OriginalMember(owner = "client!id", name = "c", descriptor = "[I")
    private int[] field4492 = null;

    @OriginalMember(owner = "client!id", name = "b", descriptor = "I")
    private int field4491 = -1;

    @OriginalMember(owner = "client!id", name = "a", descriptor = "I")
    private static int field4490 = 36;

    @OriginalMember(owner = "client!id", name = "d", descriptor = "I")
    private static int field4493 = 12;

    @OriginalMember(owner = "client!id", name = "f", descriptor = "I")
    private static int field4495 = 96;

    @OriginalMember(owner = "client!id", name = "c", descriptor = "()I", line = 8)
    public final int method296() {
        return 4;
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 161)
    public class274() {
        if (class264.field4305 && class264.field4308 >= 2) {
            this.method1809();
            GL var1 = class264.field4313;
            var1.glBindTexture(34067, this.field4492[0]);
            ...
            var1.glBindTexture(34067, this.field4492[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field4492[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field4494 = class264.field4308 < 3;
        }
        this.method1810();
    }

    @OriginalMember(owner = "client!id", name = "b", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!id", name = "d", descriptor = "()V", line = 48)
    private final void method1809() {
        GL var1 = class264.field4313;
        if (this.field4492 == null) {
            this.field4492 = new int[3];
            var1.glGenTextures(3, this.field4492, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            for (int var8 = 0; var8 < 64; var8++) {
                for (int var9 = 0; var9 < 64; var9++) {
                    ...
                    int var18;
                    if (var15 > 0.0F) {
                        var16 = (int) (Math.pow((double) var15, (double) field4495) * 255.0D);
                        var17 = (int) (Math.pow((double) var15, (double) field4490) * 255.0D);
                        var18 = (int) (Math.pow((double) var15, (double) field4493) * 255.0D);
                    } else {
                        var18 = 0;
                        var17 = 0;
                        var16 = 0;
            ...
            class143.field2279 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 192)
    public final void method294(int arg0) {
        GL var2 = class264.field4313;
        if (class6.field146 && this.field4492 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field4492[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!id", name = "e", descriptor = "()V", line = 203)
    private final void method1810() {
        GL var1 = class264.field4313;
        ...
        if (this.field4492 == null) {
            ...
            if (this.field4494) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class264.field4298);
                var1.glEnable(3553);
            }
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "()V", line = 298)
