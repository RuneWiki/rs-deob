...
public class class274 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lar;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IC)V", line = 39)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Leea;I)V", line = 68)
    public class274(class131 arg0, int arg1) {
        this.field3906 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IILrb;I)Lbl;", line = 93)
