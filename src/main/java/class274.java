...
public class class274 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(II)Liga;", line = 53)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 124)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(B)V", line = 111)
