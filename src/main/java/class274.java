...
public abstract class class274 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILfs;)V", line = 26)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIB)Luu;", line = 70)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I[BI[BIIIBI)V", line = 91)
