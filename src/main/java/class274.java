...
public class class274 extends class476 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILhi;)V", line = 6)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IB)I", line = 43)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(I[B)V", line = 74)
