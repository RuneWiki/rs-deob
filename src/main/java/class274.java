...
public class class274 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "(I)I", line = 100)
    ...
    @OriginalMember(owner = "client!caa", name = "d", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(BZ)C", line = 123)
