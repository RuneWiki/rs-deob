...
public class class274 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lte;Z)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lvm;IBLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILvm;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lvm;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILvm;)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lrg;B)V")
