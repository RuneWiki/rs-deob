...
public class class274 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I[I[IILqo;I)Lag;", line = 10)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 50)
    public class274(Throwable arg0, String arg1) {
        this.field3848 = arg1;
        this.field3849 = arg0;
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILin;)V", line = 66)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "([BB)V", line = 97)
