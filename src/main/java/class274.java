...
public class class274 {
    ...
    @OriginalMember(owner = "client!il", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field4057++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(II)V", line = 288)
    public class274(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZII)Z", line = 300)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(B)V", line = 315)
