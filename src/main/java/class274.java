...
public class class274 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I[BII[BI)I", line = 6)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(II[BI[BI)I", line = 150)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILum;)I", line = 222)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Z)V", line = 242)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "([B)V", line = 264)
