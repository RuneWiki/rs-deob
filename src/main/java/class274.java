...
public class class274 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "([Ljava/lang/Object;Ljava/applet/Applet;Ljava/lang/String;I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;", line = 25)
