...
public class class274 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lfo;Z)V")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lfo;)V")
    public final void method1961(class226 arg0) {
        this.method1958(arg0, true);
    }

    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(Lfo;)Z")
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lge;)V")
