...
public class class274 extends OutputStream {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lug;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Ljk;B)Ljk;")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILjk;II)V")
