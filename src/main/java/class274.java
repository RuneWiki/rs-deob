...
public class class274 extends class270 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lwb;)V", line = 6)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([III)V", line = 42)
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "([III)V", line = 89)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lhf;)V", line = 101)
    public final synchronized void method1792(class270 arg0) {
        this.field3971.method819((byte) -97, arg0);
    }

    @OriginalMember(owner = "client!df", name = "f", descriptor = "()I", line = 106)
    public final synchronized int method1793() {
        return this.field3971.method810(false);
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(Lhf;)V", line = 159)
    public final synchronized void method1794(class270 arg0) {
        arg0.method2049(-59);
    }

    @OriginalMember(owner = "client!df", name = "c", descriptor = "()Lhf;", line = 162)
    public final class270 method563() {
        return (class270) this.field3971.method816(116);
    }

    @OriginalMember(owner = "client!df", name = "e", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lkp;Lwb;)V", line = 184)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "()Lhf;", line = 191)
    public final class270 method585() {
        return (class270) this.field3971.method812(100);
    }

    @OriginalMember(owner = "client!df", name = "d", descriptor = "()I", line = 195)
