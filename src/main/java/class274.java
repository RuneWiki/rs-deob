...
public class class274 extends class159 implements class295 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "()I", line = 9)
    public final int method85() {
        return 0;
    }

    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lsq;I[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I[BI)V", line = 17)
