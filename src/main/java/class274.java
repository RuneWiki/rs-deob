...
public class class274 extends class50 {
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lr;IJ)V", line = 18)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZJILr;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 297)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lr;Lrca;Lkv;J)V", line = 373)
