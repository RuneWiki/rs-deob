...
public class class274 extends class190 {
    ...
    @OriginalMember(owner = "client!cq", name = "c", descriptor = "()V", line = 3)
    public final void method1288() {
        field3967.method1160(this.field3966, -117);
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "()V", line = 13)
    public final void method1285() {
        field3967.method1159(this.field3966, 10049);
    }

    @OriginalMember(owner = "client!cq", name = "e", descriptor = "()V", line = 16)
    public static void method1864() {
        field3967 = null;
    }

    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lml;I)V", line = 18)
    public class274(class219 arg0, int arg1) {
        field3967 = arg0.method1526(2);
        this.field3966 = arg1;
    }

    @OriginalMember(owner = "client!cq", name = "d", descriptor = "()V", line = 23)
    public final void method1289() {
        field3967.method1157(this.field3966, super.field2727);
    }

    @OriginalMember(owner = "client!cq", name = "b", descriptor = "()I", line = 27)
    public final int method1286() {
        return field3967.method1161(this.field3966, -7945);
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 30)
