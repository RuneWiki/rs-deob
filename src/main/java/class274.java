...
public class class274 extends Canvas {
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ob", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 52)
    public final void update(Graphics arg0) {
        this.field3545.update(arg0);
        field3548++;
    }

    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BI)I", line = 60)
    ...
    @OriginalMember(owner = "client!ob", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 76)
    public final void paint(Graphics arg0) {
        field3544++;
        this.field3545.paint(arg0);
    }

    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 86)
