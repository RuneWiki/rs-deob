...
public class class274 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([FIB)[F", line = 30)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ZLoa;IIIBLqa;)V", line = 45)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(B)V", line = 70)
