...
public class class274 implements class733 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lrn;)V", line = 42)
    public class274(class267 arg0) {
        this.field3902 = arg0;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZI)V", line = 80)
