...
public class class274 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lvn;)V")
