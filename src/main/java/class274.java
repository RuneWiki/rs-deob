...
public class class274 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(I)Lqt;", line = 47)
    ...
    @OriginalMember(owner = "client!te", name = "d", descriptor = "(I)Lqt;", line = 71)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILqt;)V", line = 92)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)I", line = 113)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BLsi;)I", line = 135)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "()V", line = 179)
    public class274() {
