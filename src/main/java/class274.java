...
public class class274 implements class147 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)J", line = 14)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "([Lcn;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lwf;I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)V", line = 142)
