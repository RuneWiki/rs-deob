...
public abstract class class274 extends class396 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lra;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qe", name = "d", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILam;Ljava/lang/String;ZZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILql;ZII)V", line = 110)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)Ljava/lang/String;", line = 162)
    ...
    @OriginalMember(owner = "client!qe", name = "f", descriptor = "(I)V", line = 178)
