...
public class class274 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BZILraa;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ILjava/lang/String;ZBZIIIJZLjava/lang/String;IJ)V", line = 101)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BC)Z", line = 118)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ILla;I)Lcaa;", line = 160)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(II)Lsia;", line = 182)
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 216)
