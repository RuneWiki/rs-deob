...
public class class274 extends class460 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IILtj;)V", line = 17)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIB)V", line = 56)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Ljaa;)V", line = 186)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(CI)Z", line = 299)
