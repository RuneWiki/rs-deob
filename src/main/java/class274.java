...
public class class274 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lr;ZII)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIILr;)Z")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lrda;Lmu;)V")
