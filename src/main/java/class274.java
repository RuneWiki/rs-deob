...
public class class274 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(III)I", line = 124)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)Lne;", line = 154)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IBLbt;)V", line = 175)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BLbt;)V", line = 198)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZZILhs;Ljava/lang/String;)V", line = 234)
