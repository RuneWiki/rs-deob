...
public class class274 extends Canvas {
    ...
    @OriginalMember(owner = "client!ki", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        this.field3817.update(arg0);
        field3814++;
    }

    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
