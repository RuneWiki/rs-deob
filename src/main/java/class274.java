...
public class class274 extends class260 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Ldba;ILdba;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lfca;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(ILfca;)V")
