...
public abstract class class274 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)V", line = 9)
    public static void method1763(int arg0) {
        field4096 = null;
        int var1 = -96 % ((21 - arg0) / 50);
    }

    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(II)Loo;", line = 37)
    public static final class450 method1767(int arg0, int arg1) {
        field4095++;
        return arg0 >= arg1 && arg0 < 100 ? class262.field3960[arg0] : null;
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 50)
