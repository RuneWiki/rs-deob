...
public class class274 extends class504 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)[B", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "f", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rp", name = "e", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BI)V", line = 66)
