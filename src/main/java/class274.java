...
public class class274 extends class551 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lqa;Lse;IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Ljm;)V", line = 140)
