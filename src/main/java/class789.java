...
public class class789 extends class334 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IZLol;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "()V", line = 30)
    public class789() {
        this(4096);
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II)[I", line = 37)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(BI)V", line = 59)
    ...
    @OriginalMember(owner = "client!dfa", name = "c", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(I)V", line = 96)
