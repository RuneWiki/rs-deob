...
public class class789 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ZIIZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!eca", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
