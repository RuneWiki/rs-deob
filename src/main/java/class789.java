...
public class class789 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BC)Z", line = 55)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lvf;JI)V", line = 66)
