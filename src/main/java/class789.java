...
public class class789 extends class394 {
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!eca", name = "c", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(I)J", line = 25)
    public final long method2176(int arg0) {
        return arg0 > -67 ? -7L : this.field11501;
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Z)I", line = 51)
