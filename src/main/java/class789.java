...
public class class789 extends class56 {
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "()V", line = 5)
    public class789() {
        super(3, false);
    }

    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BILes;)V", line = 8)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)[I", line = 25)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BI)[[I", line = 77)
    ...
    @OriginalMember(owner = "client!rw", name = "d", descriptor = "(Z)V", line = 160)
