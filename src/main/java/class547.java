...
public class class547 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(II)Lbe;", line = 59)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIIFIFF)[F", line = 93)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 191)
