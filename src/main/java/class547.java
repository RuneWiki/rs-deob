...
public class class547 extends class308 implements class288 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Ltba;Z)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
