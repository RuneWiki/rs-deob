...
public class class547 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILfca;)V", line = 6)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Lha;B)Lnf;", line = 28)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IZBLjava/lang/String;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Lha;Z)Lnf;", line = 66)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ZLha;)Lnf;", line = 89)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(BILfca;)V", line = 119)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(II)Ljava/lang/String;", line = 187)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(BLha;)V", line = 215)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILha;)Lnf;", line = 280)
