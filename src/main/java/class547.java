...
public class class547 extends class530 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "([III[ILpga;I)Lub;")
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(ILah;)V")
    public class547(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(Lah;)V")
