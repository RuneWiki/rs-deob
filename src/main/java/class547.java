...
public class class547 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)[Lafa;", line = 7)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!ea", name = "toString", descriptor = "()Ljava/lang/String;", line = 34)
    public final String toString() {
        field7723++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)Z", line = 64)
