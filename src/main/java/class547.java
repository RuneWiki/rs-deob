...
public abstract class class547 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hha", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(I)Ljava/net/Socket;", line = 39)
    ...
    @OriginalMember(owner = "client!hha", name = "d", descriptor = "(I)V", line = 64)
