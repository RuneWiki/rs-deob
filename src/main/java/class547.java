...
public class class547 extends class41 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Liaa;BLbn;II)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Loga;I)V")
