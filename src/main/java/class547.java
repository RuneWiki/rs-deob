...
public class class547 extends class774 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(IILjha;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(IIII)[B", line = 15)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lel;[[BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(BLjava/lang/String;)V", line = 98)
    ...
    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "()V", line = 166)
    public class547() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(Z)V", line = 173)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(BIB)V", line = 190)
