...
public class class547 implements class526 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(JI)Z", line = 98)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!dk", name = "d", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(III)Z", line = 161)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(I)I", line = 190)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lraa;Lkda;)V", line = 200)
    ...
    @OriginalMember(owner = "client!dk", name = "c", descriptor = "(I)I", line = 218)
