...
public class class547 extends class301 {
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(I)V", line = 5)
    public class547(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(FI)V", line = 8)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IF)V", line = 24)
    ...
    @OriginalMember(owner = "client!og", name = "m", descriptor = "(B)V", line = 41)
