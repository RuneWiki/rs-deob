...
public abstract class class547 extends class76 {
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "([Ljw;BII)I", line = 35)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lsf;[Ljw;)V", line = 75)
    ...
    @OriginalMember(owner = "client!sf", name = "k", descriptor = "(I)I", line = 149)
