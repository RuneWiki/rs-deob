...
public class class547 extends class450 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILli;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lup;)V")
