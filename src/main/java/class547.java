...
public class class547 extends class386 {
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(II)Llt;", line = 7)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "()V", line = 215)
    public class547() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IBLun;)V", line = 123)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 237)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)[I", line = 273)
