...
public class class547 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lgga;Lgga;BLgga;Lgga;)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field7571++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 52)
