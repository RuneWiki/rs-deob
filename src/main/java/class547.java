...
public abstract class class547 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!oea", name = "d", descriptor = "(I)V", line = 39)
