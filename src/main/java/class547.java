...
public class class547 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILrr;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Ltt;ILrr;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILrr;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZIII)I", line = 598)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZLrr;)V", line = 631)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IILrr;)V", line = 642)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lrr;)V", line = 690)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BLrr;)V", line = 810)
