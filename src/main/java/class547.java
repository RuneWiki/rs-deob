...
public class class547 extends class358 implements class149 {
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Lrja;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hha", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 54)
    public final IDirect3DBaseTexture method2252(int arg0) {
        return arg0 == 15901 ? this.field7405 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ILwga;)V", line = 66)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(I)V", line = 79)
