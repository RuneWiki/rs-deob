...
public class class547 extends class135 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!tca", name = "c", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!tca", name = "i", descriptor = "(I)Lbp;", line = 101)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Laj;II)V", line = 132)
    ...
    @OriginalMember(owner = "client!tca", name = "g", descriptor = "(I)Z", line = 147)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lad;Lvo;Lob;)V", line = 161)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(I)V", line = 177)
