...
public class class547 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lpfa;II)Lid;", line = 4)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "()[B", line = 16)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lji;)V", line = 128)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 149)
    private class547() {
    }

    @OriginalMember(owner = "client!id", name = "b", descriptor = "()Lft;", line = 80)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "()I", line = 87)
