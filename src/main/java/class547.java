...
public class class547 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([Lxa;IILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([Lxa;ILjava/lang/String;Z)I")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IILjava/lang/String;I[Lxa;)I")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/String;[Lxa;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(B[I[Lxa;[Ljava/lang/String;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/String;[Lxa;I)I")
