...
public class class547 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Lqia;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Lns;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(Lns;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(I)Lns;", line = 57)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ILnl;Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!qia", name = "c", descriptor = "(I)Lns;", line = 135)
    ...
    @OriginalMember(owner = "client!qia", name = "d", descriptor = "(I)Lns;", line = 155)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(IBIIIIIIIILrl;)Z", line = 177)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(B)V", line = 426)
    ...
    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "()V", line = 457)
    public class547() {
        this.field7718.field8742 = this.field7718;
        this.field7718.field8744 = this.field7718;
    }

    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(Z)Lns;", line = 468)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(B)Lns;", line = 489)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Lqia;Lns;I)V", line = 511)
    ...
    @OriginalMember(owner = "client!qia", name = "e", descriptor = "(I)I", line = 534)
