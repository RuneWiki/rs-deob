...
public class class547 extends class444 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZLpw;)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZZ)Laf;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lqba;Lqba;FLqba;)Lqba;")
    public final class345 method439(class345 arg0, class345 arg1, float arg2, class345 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZLsk;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIII[IZI)Ljb;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lui;BLaq;)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I[Lwj;)Lsk;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lgf;III)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lgf;B)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZLiw;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLui;Laq;)Z")
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/of;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lul;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ln;Lkda;I)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lfca;I)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IZILhm;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILhm;)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IILui;ILaq;)Ljb;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Laq;IIII[B)Lvi;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lql;IB)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLus;)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIZ[[I)Lwv;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZI)Lql;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lkv;B)I")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "([BLaq;ZIIIIZ)Ljb;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILaq;Lui;)Z")
    ...
    @OriginalMember(owner = "client!wda", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ln;Lkda;Ljava/lang/Integer;)Lqa;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lav;B)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIB[FIIZLaq;)Ljb;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLee;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "f", descriptor = "(II)Lgl;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLgf;IIIILaf;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "y", descriptor = "()Lcr;")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIILjagdx/D3DPRESENT_PARAMETERS;BLjagdx/IDirect3D;)Z")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZIBZLhm;)V")
