...
public class class547 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lbe;IIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lda;)V", line = 77)
    public class547(class60 arg0) {
        this.field7537 = arg0;
    }

    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lda;Loea;)V", line = 85)
