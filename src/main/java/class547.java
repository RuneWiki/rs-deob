...
public class class547 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(II)V", line = 26)
    public class547(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!gl", name = "toString", descriptor = "()Ljava/lang/String;", line = 39)
    public final String toString() {
        field7824++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 47)
