...
public abstract class class547 extends class375 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vs", name = "d", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(I)V", line = 29)
    public class547(int arg0) {
        this.field7688 = arg0;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZIZIZ)I", line = 40)
