...
public class class547 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 40)
