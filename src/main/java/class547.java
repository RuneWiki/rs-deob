...
public class class547 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V", line = 8)
    public static void method3270(int arg0) {
        field7865 = null;
        int var1 = -55 / ((-arg0 - 19) / 36);
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BI)Lvk;", line = 19)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IBII[BI)V", line = 53)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IIIILnu;)V", line = 86)
