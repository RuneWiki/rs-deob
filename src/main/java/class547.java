...
public class class547 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IZLoh;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)Lhba;", line = 42)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(III)Loh;", line = 78)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(II)V", line = 142)
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Ljc;ILgp;)V", line = 172)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(III)Z", line = 189)
