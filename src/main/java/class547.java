...
public class class547 extends class408 implements class373 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lsha;Z)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
