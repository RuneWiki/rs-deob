...
public class class423 extends class481 {
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILza;Lti;Lfk;ZI)Z", line = 124)
    ...
    @OriginalMember(owner = "client!hq", name = "d", descriptor = "(B)V", line = 347)
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(B)V", line = 360)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIIII)V", line = 386)
