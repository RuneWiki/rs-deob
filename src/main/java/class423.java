...
public class class423 extends class657 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lffa;Lbb;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IJB)Ljava/lang/String;", line = 97)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBLmw;)V", line = 194)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Z", line = 206)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BZ)V", line = 226)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIZ)V", line = 237)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBLub;)Z", line = 307)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)V", line = 498)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 508)
