...
public class class423 extends class362 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "()V", line = 32)
    public class423() {
    }

    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZI)I", line = 45)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(J)V", line = 55)
    public class423(long arg0) {
        this.field6099 = arg0;
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIBI)Lwm;", line = 66)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILha;Z)Z", line = 104)
