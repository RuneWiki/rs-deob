...
public class class423 extends class396 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILra;)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZLra;Lra;Lla;Lra;)Z")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Ltb;)V")
