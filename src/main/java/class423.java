...
public abstract class class423 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lac;Ljava/util/Random;Ljava/lang/String;IBIII[II)I", line = 7)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 44)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIB)V", line = 61)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[II[I[Lac;[ILjava/lang/String;)V", line = 82)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IZIILjava/lang/String;II)V", line = 255)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 283)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIILjava/lang/String;I)V", line = 307)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lac;IILjava/lang/String;III[I)V", line = 353)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILqca;)Z", line = 376)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 404)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lac;[IIIIIILjava/lang/String;Laa;)V", line = 477)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;[IIIII[Lac;II[IIIILjava/util/Random;)I", line = 630)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIIII)V", line = 709)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIII[Lac;IIII[IIILaa;IILjava/lang/String;)I", line = 752)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Ltba;)V", line = 853)
    public class423(class454 arg0, class56 arg1) {
        this.field6007 = arg1;
        this.field6022 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZZ)Z", line = 864)
    public static boolean method2519(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BILjava/lang/String;)V", line = 871)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 914)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IILjava/lang/String;III)V", line = 946)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILaa;IILjava/lang/String;[II[Lac;IIIII)I", line = 966)
