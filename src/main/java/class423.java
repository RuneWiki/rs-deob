...
public class class423 extends class44 implements class111 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lpe;B)Lca;", line = 19)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lpe;II)Lsj;", line = 56)
    ...
    @OriginalMember(owner = "client!sp", name = "e", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILpe;)V", line = 91)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IILpe;I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)I", line = 123)
    ...
    @OriginalMember(owner = "client!sp", name = "h", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BLpe;)V", line = 151)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lpe;Lkk;IIIIIIZI)V", line = 174)
    ...
    @OriginalMember(owner = "client!sp", name = "i", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZILhh;Lpe;III)V", line = 202)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(I)Z", line = 212)
    public final boolean method577(int arg0) {
        ++field5913;
        return arg0 != -16528 ? false : this.field5918.method2787(38);
    }

    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(B)I", line = 224)
    ...
    @OriginalMember(owner = "client!sp", name = "g", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lpe;I)V", line = 254)
