...
public class class423 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILnaa;ILnaa;)Lmha;", line = 113)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(III)Z", line = 156)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lff;Lcr;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 168)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILnaa;ZLnaa;I)Lmha;", line = 184)
