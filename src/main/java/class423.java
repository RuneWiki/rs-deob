...
public class class423 {
    ...
    @OriginalMember(owner = "client!rca", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!rca", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field5360.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!rca", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
