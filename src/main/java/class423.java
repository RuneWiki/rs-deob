...
public class class423 extends class82 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "()Lms;")
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "()Lms;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILuu;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IILjs;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "([IIZLjs;II)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ljq;)V")
