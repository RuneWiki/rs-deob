...
public class class423 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IBZI)I", line = 29)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIILkq;)V", line = 63)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 110)
