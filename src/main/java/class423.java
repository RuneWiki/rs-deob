...
public class class423 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 275)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIBI)V", line = 289)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZZ)Z", line = 342)
