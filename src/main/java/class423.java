...
public class class423 extends class18 implements class290 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I[BII)V", line = 7)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(I)V", line = 21)
    public static void method2557(int arg0) {
        int var1 = -47 % ((83 - arg0) / 41);
        field6210 = null;
    }

    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(B)J", line = 42)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Luca;I[BIZ)V", line = 76)
