...
public class class423 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lug;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLug;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)I", line = 79)
