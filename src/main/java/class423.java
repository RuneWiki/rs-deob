...
public class class423 extends class10 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 6)
    public final Object method126(int arg0) {
        int var2 = -3 % ((-arg0 - 21) / 61);
        return this.field5834.get();
    }

    @OriginalMember(owner = "client!td", name = "d", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 24)
