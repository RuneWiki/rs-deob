...
public abstract class class423 extends class215 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I[Lrc;)I", line = 5)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(Z)Z", line = 17)
    ...
    @OriginalMember(owner = "client!sj", name = "f", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!sj", name = "j", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(IIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!sj", name = "k", descriptor = "(I)Z", line = 91)
