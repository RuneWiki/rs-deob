...
public class class423 extends class329 {
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "()V", line = 9)
    public class423() {
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lks;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(S)V", line = 83)
    public class423(short arg0) {
        this.field5313 = arg0;
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIIIIIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 135)
