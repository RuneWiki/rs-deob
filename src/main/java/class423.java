...
public class class423 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IILha;BLga;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IZLwq;I)V", line = 76)
