...
public class class423 implements class331 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)Z", line = 59)
    public final boolean method298(byte arg0) {
        field5791++;
        return arg0 == -98 ? this.field5789.method4349((byte) -102, this.field5787.field9889) : false;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lwia;Lvha;)V", line = 84)
    public class423(class791 arg0, class713 arg1) {
        this.field5787 = arg1;
        this.field5789 = arg0;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BILrn;IIII)Z", line = 93)
