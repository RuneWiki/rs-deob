...
public class class423 extends class270 {
    ...
    @OriginalMember(owner = "client!rb", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Ldp;Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)[I", line = 89)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BIIIIII)I", line = 145)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(CB)Z", line = 220)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "([III)V", line = 239)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLec;I)V", line = 411)
