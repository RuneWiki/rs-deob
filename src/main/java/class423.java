...
public class class423 extends InputStream {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(JZ)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLhg;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!la", name = "read", descriptor = "()I", line = 80)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 91)
