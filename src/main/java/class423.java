...
public class class423 extends class30 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(III)Ljb;")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BILac;)V")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BLac;)V")
