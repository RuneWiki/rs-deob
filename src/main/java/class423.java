...
public abstract class class423 extends class390 {
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lmc;III[Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIII)I", line = 116)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIIZLuo;Lbe;Lco;Lbo;)V", line = 137)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(B)V", line = 194)
