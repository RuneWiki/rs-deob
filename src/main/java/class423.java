...
public class class423 extends class195 {
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "()V", line = 4)
    public class423() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(III)[B", line = 15)
