...
public class class423 extends class46 implements class9 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "h", descriptor = "(I)[Lk;")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZBIILna;ILae;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lae;Ljh;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!ip", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lae;ZI)Lbk;")
