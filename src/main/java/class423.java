...
public class class423 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILhq;I)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IZ)Lbp;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/awt/Frame;ZLjs;)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/lang/String;ILmd;)I")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILpc;)I")
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lrb;ILpc;)V")
