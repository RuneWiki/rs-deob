...
public class class423 extends class45 {
    ...
    @OriginalMember(owner = "client!ai", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lcu;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)[I", line = 75)
    ...
    @OriginalMember(owner = "client!ai", name = "f", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "()V", line = 215)
    public class423() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(I)V", line = 219)
