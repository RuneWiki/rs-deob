...
public class class423 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lpt;IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;)I", line = 103)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)V", line = 158)
