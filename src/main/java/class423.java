...
public class class423 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lbt;IB)Lui;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)Lqea;")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lmja;ILbt;)V")
