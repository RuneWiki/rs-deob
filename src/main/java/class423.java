...
public class class423 extends class649 {
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(ILhs;)V")
    public class423(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(BILd;Ljava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lhs;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lla;III)Lpha;")
