...
public class class423 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)I", line = 35)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(BZLfaa;)V", line = 76)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILiaa;)Z", line = 422)
