...
public class class423 extends class33 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Z)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ke", name = "f", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!ke", name = "e", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lqa;III)Z", line = 142)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(Lqa;III)Lc;", line = 153)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZLc;Lqa;)V", line = 182)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 206)
    ...
    @OriginalMember(owner = "client!ke", name = "finalize", descriptor = "()V", line = 221)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lqa;I)Lip;", line = 233)
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(ILqa;)V", line = 272)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 286)
