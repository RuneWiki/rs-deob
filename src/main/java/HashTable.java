...
public class HashTable {
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "[Lt;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(J)Lt;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(JLt;I)V")
