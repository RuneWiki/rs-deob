...
public class HashTable {
    ...
    @OriginalMember(owner = "client!u", name = "e", descriptor = "[Lv;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(J)Lv;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lv;IJ)V")
