...
@OriginalClass("ARZPHHDH")
public class HashTable {

    @OriginalMember(owner = "ARZPHHDH", name = "a", descriptor = "Z")
    private boolean _flowObfuscator1 = false;

    @OriginalMember(owner = "ARZPHHDH", name = "b", descriptor = "I")
    private int _flowObfuscator2 = -373;

    @OriginalMember(owner = "ARZPHHDH", name = "c", descriptor = "I")
    private int bucketCount;

    @OriginalMember(owner = "ARZPHHDH", name = "d", descriptor = "[LPKVMXVTO;")
    private Linkable[] buckets;

    @OriginalMember(owner = "ARZPHHDH", name = "<init>", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "ARZPHHDH", name = "a", descriptor = "(J)LPKVMXVTO;")
    ...
    @OriginalMember(owner = "ARZPHHDH", name = "a", descriptor = "(LPKVMXVTO;JB)V")
