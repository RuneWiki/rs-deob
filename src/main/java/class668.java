...
public class class668 extends class346 implements class560 {
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lgb;Lvj;III[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 91)
    public final IDirect3DBaseTexture method1900(byte arg0) {
        return arg0 <= 54 ? (IDirect3DBaseTexture) null : this.field9528;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILup;)V", line = 101)
