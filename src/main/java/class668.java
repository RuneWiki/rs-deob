...
public class class668 extends class555 {
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IZIIILga;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!eq", name = "f", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lot;BI)V", line = 101)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(I)Z", line = 117)
    public final boolean method125(int arg0) {
        ++field9495;
        return arg0 != -20112 ? true : this.field9488;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lqi;Lga;Lln;)V", line = 139)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)V", line = 166)
