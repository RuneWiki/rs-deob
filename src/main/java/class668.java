...
public class class668 extends class673 {
    ...
    @OriginalMember(owner = "client!hu", name = "h", descriptor = "(I)[Lbc;", line = 5)
    ...
    @OriginalMember(owner = "client!hu", name = "g", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lmaa;Llb;BLoa;)V", line = 30)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lrl;Ljava/lang/Object;I)V", line = 178)
    public class668(class153 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field9497 = arg1;
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IZ)Z", line = 190)
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 211)
    ...
    @OriginalMember(owner = "client!hu", name = "i", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ljava/lang/String;ILjava/io/File;)V", line = 239)
