...
public class class668 extends class306 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lefa;Lsw;)V")
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "()Lca;")
    public final class306 method1488() {
        return (class306) this.field9351.method1201(2);
    }

    @OriginalMember(owner = "client!aga", name = "a", descriptor = "()Lca;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lsw;)V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lca;)V")
    public final synchronized void method3834(class306 arg0) {
        arg0.method1304((byte) 7);
    }

    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(Lca;)V")
