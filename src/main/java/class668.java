...
public class class668 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(JILjava/lang/Object;)V", line = 17)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZLjda;)V", line = 30)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!me", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 88)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 124)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(I)V", line = 181)
    public class668(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIJLjava/lang/Object;)V", line = 184)
    ...
    @OriginalMember(owner = "client!me", name = "e", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II)V", line = 243)
    ...
    @OriginalMember(owner = "client!me", name = "f", descriptor = "(I)I", line = 292)
    public final int method3660(int arg0) {
        field9261++;
        return arg0 == 1 ? this.field9278 : 126;
    }

    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZJ)V", line = 304)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 322)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(II)V", line = 356)
