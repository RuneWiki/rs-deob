...
public class class668 extends class502 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)V", line = 52)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(ILeka;)V", line = 125)
    public class668(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Leka;)V", line = 142)
    public class668(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(B)I", line = 130)
