...
public class class668 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ZIILuaa;)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IBJIILwm;IZ)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lck;JI)V")
