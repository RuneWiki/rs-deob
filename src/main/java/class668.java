...
public class class668 extends class608 {
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Lofa;", line = 21)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BI)[B", line = 121)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)I", line = 151)
    public final int method3700(int arg0) {
        field9417++;
        return arg0 <= 104 ? -20 : this.field9411;
    }

    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(I)I", line = 162)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Z)I", line = 182)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BII)Led;", line = 430)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IB)V", line = 706)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(ILfo;Lfo;Llba;Lnp;I[BIZ)V", line = 815)
    ...
    @OriginalMember(owner = "client!cm", name = "e", descriptor = "(I)I", line = 761)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(Z)V", line = 786)
