...
public class class668 extends class281 implements class532 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lab;[I)V", line = 170)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 183)
    public final boolean method1154(class184 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 189)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 236)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 249)
