...
public abstract class class668 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IB)I", line = 49)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)Lnw;", line = 100)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)Z", line = 135)
