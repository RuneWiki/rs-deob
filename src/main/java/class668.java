...
public class class668 implements class130 {
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)I", line = 48)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IJ)Z", line = 75)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZ)Z", line = 91)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lkb;Lsb;)V", line = 102)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)I", line = 138)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ZB)V", line = 162)
