...
public class class668 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZILr;ZZ)Lda;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lvj;I)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IILkfa;BI)Lbb;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IZLr;IIILq;ILda;)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lr;Lnf;IIIILvj;ZI)V")
