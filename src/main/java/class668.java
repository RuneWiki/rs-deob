...
public class class668 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)Ljn;", line = 10)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIBIILit;)Lqv;", line = 44)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLin;)V", line = 79)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 108)
    public class668(class414 arg0, int arg1, class648 arg2) {
        this.field9387 = arg2;
        this.field9387.method3653(29, true);
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)V", line = 140)
