...
public class class668 extends class460 {
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ZI)V", line = 46)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIB)V", line = 164)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Ljaa;Ldk;)V", line = 264)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILtj;)V", line = 245)
