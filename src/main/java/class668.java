...
public class class668 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "([BIB)V", line = 168)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BJ[B)V", line = 218)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 323)
