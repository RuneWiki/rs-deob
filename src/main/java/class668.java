...
public class class668 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lsl;Lcq;)V", line = 15)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(F)F", line = 90)
    private static final float method3812(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIF)F", line = 95)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(IIF)F", line = 101)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IF)I", line = 107)
