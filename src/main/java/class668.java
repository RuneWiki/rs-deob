...
public class class668 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILwd;)V")
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(II)Ldd;")
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILvfa;I)V")
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIIIILap;)Llt;")
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lms;ILwu;)V")
