...
public class class668 extends class281 implements class533 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 12)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lcba;[I)V", line = 229)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 250)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 243)
