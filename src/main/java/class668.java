...
public class class668 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Ltn;ILnga;I)V")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BI)Lqa;")
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ldh;ILkha;Lkha;)V")
