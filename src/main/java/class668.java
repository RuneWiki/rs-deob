...
public class class668 extends class207 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IB)V", line = 22)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ph", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lrd;)V", line = 62)
    public class668(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(IB)I", line = 69)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILha;IBIII)Lka;", line = 105)
    ...
    @OriginalMember(owner = "client!ph", name = "d", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I[B)Lnba;", line = 166)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)I", line = 264)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(ILrd;)V", line = 275)
