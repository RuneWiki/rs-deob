...
public class class20 extends class86 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZI)I", line = 20)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 66)
    public class20() {
    }

    @OriginalMember(owner = "client!an", name = "d", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(J)V", line = 82)
