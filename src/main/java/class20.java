...
public class class20 extends class145 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILrt;)V", line = 46)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 85)
    public class20() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZI)[I", line = 95)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II)V", line = 175)
