...
public class class20 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lhs;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 145)
    public class20() {
        this.field228.field3163 = this.field228;
        this.field228.field3155 = this.field228;
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(B)Lhs;", line = 79)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)Lhs;", line = 122)
