...
public class class20 extends class106 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II[Ljf;IIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 194)
