...
public class class20 implements Runnable {
    ...
    @OriginalMember(owner = "client!FKSZIRZG", name = "h", descriptor = "LPXJVLLTT;")
    ...
    @OriginalMember(owner = "client!FKSZIRZG", name = "<init>", descriptor = "(BLjava/net/Socket;LPXJVLLTT;)V")
