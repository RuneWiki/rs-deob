...
public class class20 {
    ...
    @OriginalMember(owner = "client!dg", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field297++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILjj;Ljava/lang/String;Z)Lud;", line = 41)
