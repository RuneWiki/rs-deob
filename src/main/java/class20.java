...
public class class20 extends class298 {
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(B)Lhf;")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
