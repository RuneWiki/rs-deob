...
public class class20 extends class227 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lug;II)V")
    ...
    @OriginalMember(owner = "client!an", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!an", name = "k", descriptor = "(I)V")
