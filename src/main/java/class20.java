...
public class class20 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)Lpl;", line = 16)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IBIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)Luk;", line = 140)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BLik;)V", line = 167)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 223)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(I)V", line = 244)
