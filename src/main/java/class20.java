...
public class class20 extends class417 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILhg;ZZ)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BLko;)I")
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "()Lmq;")
    public final synchronized class417 method156() {
        field350++;
        return null;
    }

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IZLko;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lko;I)I")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILko;)Z")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lhg;BZ)V")
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "(B)Ljn;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lko;II[II)Z")
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(Lko;I)I")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILeb;Lhg;ILir;)Z")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "()Lmq;")
