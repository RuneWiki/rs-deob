...
public class class20 implements class759 {
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lbt;Ljava/lang/String;)V")
    public class20(class48 arg0, String arg1) {
        this.field347 = arg0;
        this.field346 = arg1;
    }

    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)Lsg;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Z)Z")
