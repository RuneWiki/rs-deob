...
public class class20 extends class147 {
    ...
    @OriginalMember(owner = "client!bi", name = "R", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!bi", name = "M", descriptor = "Lda;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lja;B)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lbi;IILue;I)Lue;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IBLja;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lue;II)Lue;")
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Lue;II)Lue;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZLuc;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILue;IB)Lue;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILue;B)Lue;")
