...
@OriginalClass("client!ISUBRNPG")
public class class20 {

    @OriginalMember(owner = "client!ISUBRNPG", name = "h", descriptor = "I")
    public int field880 = -1;

    @OriginalMember(owner = "client!ISUBRNPG", name = "j", descriptor = "Z")
    public boolean field882 = false;

    @OriginalMember(owner = "client!ISUBRNPG", name = "k", descriptor = "I")
    public int field883 = 5;

    @OriginalMember(owner = "client!ISUBRNPG", name = "l", descriptor = "I")
    public int field884 = -1;

    @OriginalMember(owner = "client!ISUBRNPG", name = "m", descriptor = "I")
    public int field885 = -1;

    @OriginalMember(owner = "client!ISUBRNPG", name = "n", descriptor = "I")
    public int field886 = 99;

    @OriginalMember(owner = "client!ISUBRNPG", name = "o", descriptor = "I")
    public int field887 = -1;

    @OriginalMember(owner = "client!ISUBRNPG", name = "p", descriptor = "I")
    public int field888 = -1;

    @OriginalMember(owner = "client!ISUBRNPG", name = "q", descriptor = "I")
    public int field889 = 2;

    @OriginalMember(owner = "client!ISUBRNPG", name = "a", descriptor = "I")
    private static int field873 = -302;

    @OriginalMember(owner = "client!ISUBRNPG", name = "b", descriptor = "I")
    public static int field874;

    @OriginalMember(owner = "client!ISUBRNPG", name = "d", descriptor = "I")
    public int field876;

    @OriginalMember(owner = "client!ISUBRNPG", name = "r", descriptor = "I")
    public int field890;

    @OriginalMember(owner = "client!ISUBRNPG", name = "s", descriptor = "I")
    public static int field891;

    @OriginalMember(owner = "client!ISUBRNPG", name = "e", descriptor = "[I")
    public int[] field877;

    @OriginalMember(owner = "client!ISUBRNPG", name = "f", descriptor = "[I")
    public int[] field878;

    @OriginalMember(owner = "client!ISUBRNPG", name = "g", descriptor = "[I")
    private int[] field879;

    @OriginalMember(owner = "client!ISUBRNPG", name = "i", descriptor = "[I")
    public int[] field881;

    @OriginalMember(owner = "client!ISUBRNPG", name = "c", descriptor = "[LISUBRNPG;")
    public static class20[] field875;

    @OriginalMember(owner = "client!ISUBRNPG", name = "a", descriptor = "(LLYZBHNJP;I)V")
    ...
    @OriginalMember(owner = "client!ISUBRNPG", name = "a", descriptor = "(BI)I")
    ...
    @OriginalMember(owner = "client!ISUBRNPG", name = "a", descriptor = "(LZOMNSJJM;B)V")
