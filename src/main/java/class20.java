...
@OriginalClass("client!GDGWLQOM")
public class class20 {

    @OriginalMember(owner = "client!GDGWLQOM", name = "a", descriptor = "I")
    private static int field867 = -223;

    @OriginalMember(owner = "client!GDGWLQOM", name = "b", descriptor = "Z")
    private static boolean field868 = true;

    @OriginalMember(owner = "client!GDGWLQOM", name = "c", descriptor = "Z")
    private static boolean field869 = true;

    @OriginalMember(owner = "client!GDGWLQOM", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!GDGWLQOM", name = "a", descriptor = "(IIIZ)I")
    ...
    @OriginalMember(owner = "client!GDGWLQOM", name = "a", descriptor = "(IIIIII)I")
    ...
    @OriginalMember(owner = "client!GDGWLQOM", name = "b", descriptor = "(IIIIII)I")
