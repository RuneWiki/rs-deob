...
public class class20 extends class115 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(III)I", line = 19)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZFIFFIII)[F", line = 35)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(I[B)V", line = 121)
