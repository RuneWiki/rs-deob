...
public class class20 extends class591 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Luca;II[B)V", line = 45)
