...
public class class20 extends class376 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILiv;)V", line = 16)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIIIZLlp;Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!an", name = "d", descriptor = "(I)[Lsp;", line = 106)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IBI)I", line = 119)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILiv;)V", line = 155)
