...
public class class20 implements Runnable {
    ...
    @OriginalMember(owner = "client!HHMTQDYM", name = "i", descriptor = "LOFXQYNOM;")
    ...
    @OriginalMember(owner = "client!HHMTQDYM", name = "<init>", descriptor = "(LOFXQYNOM;Ljava/net/Socket;I)V")
