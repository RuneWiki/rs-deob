...
public class class20 extends class430 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIZIZI)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILee;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lfp;B)V")
