...
public class class20 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BLfg;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lfg;I)Z")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)Ljd;")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lgk;)V")
