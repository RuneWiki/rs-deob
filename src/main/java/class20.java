...
public class class20 extends class40 {
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)[I", line = 84)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B[[I)V", line = 151)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "()V", line = 203)
    public class20() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IILlf;)V", line = 209)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIII)V", line = 283)
