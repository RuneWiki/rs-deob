...
public class class20 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lti;[BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 49)
    public class20() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(III)V", line = 82)
