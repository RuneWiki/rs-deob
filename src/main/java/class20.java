...
public abstract class class20 extends class42 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IJZIZZILjava/lang/String;Ljava/lang/String;II)V", line = 44)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BIIZ)Ljava/lang/String;", line = 66)
