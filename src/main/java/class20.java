...
public class class20 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I[I[IIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IB)Lpj;", line = 85)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 436)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(III)I", line = 458)
