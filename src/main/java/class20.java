...
public class class20 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)[Lkn;", line = 6)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lha;IILda;Loo;IZBLha;IZI)Lmi;", line = 43)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lin;Lha;Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BZ)V", line = 240)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IILhw;Lka;ZI)V", line = 258)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)V", line = 279)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IZ)V", line = 291)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)Lrq;", line = 350)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IBIIIILha;Loo;)Lmi;", line = 429)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IB)V", line = 451)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lsj;IZLdc;Lin;Lin;)V", line = 486)
