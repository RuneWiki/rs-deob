...
@OriginalClass("client!FLJWGVEY")
public class class20 {

    @OriginalMember(owner = "client!FLJWGVEY", name = "a", descriptor = "B")
    private byte field806 = 1;

    @OriginalMember(owner = "client!FLJWGVEY", name = "b", descriptor = "LJJVWTXNE;")
    public class30 field807 = new class30();

    @OriginalMember(owner = "client!FLJWGVEY", name = "c", descriptor = "LJJVWTXNE;")
    private class30 field808;

    @OriginalMember(owner = "client!FLJWGVEY", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "a", descriptor = "(LJJVWTXNE;)V")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "a", descriptor = "(ILJJVWTXNE;)V")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "a", descriptor = "()LJJVWTXNE;")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "a", descriptor = "(I)LJJVWTXNE;")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "b", descriptor = "(I)LJJVWTXNE;")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "a", descriptor = "(B)LJJVWTXNE;")
    ...
    @OriginalMember(owner = "client!FLJWGVEY", name = "c", descriptor = "()V")
