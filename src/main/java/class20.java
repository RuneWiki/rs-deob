...
public class class20 implements class116 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIIIIZZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(IIIIIIZZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Luj;Lkr;Lwo;)V", line = 49)
