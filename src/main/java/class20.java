...
@OriginalClass("client!HQETDHHW")
public class class20 extends class23 {

    @OriginalMember(owner = "client!HQETDHHW", name = "w", descriptor = "I")
    private int field741 = 192;

    @OriginalMember(owner = "client!HQETDHHW", name = "x", descriptor = "Z")
    private boolean field742 = false;

    @OriginalMember(owner = "client!HQETDHHW", name = "y", descriptor = "Z")
    private boolean field743 = false;

    @OriginalMember(owner = "client!HQETDHHW", name = "z", descriptor = "I")
    private int field744 = 821;

    @OriginalMember(owner = "client!HQETDHHW", name = "A", descriptor = "I")
    private int field745 = 1519;

    @OriginalMember(owner = "client!HQETDHHW", name = "H", descriptor = "I")
    public int field752;

    @OriginalMember(owner = "client!HQETDHHW", name = "I", descriptor = "I")
    public int field753;

    @OriginalMember(owner = "client!HQETDHHW", name = "C", descriptor = "[I")
    public int[] field747;

    @OriginalMember(owner = "client!HQETDHHW", name = "F", descriptor = "I")
    public int field750;

    @OriginalMember(owner = "client!HQETDHHW", name = "G", descriptor = "I")
    public int field751;

    @OriginalMember(owner = "client!HQETDHHW", name = "D", descriptor = "I")
    public int field748;

    @OriginalMember(owner = "client!HQETDHHW", name = "E", descriptor = "I")
    public int field749;

    @OriginalMember(owner = "client!HQETDHHW", name = "B", descriptor = "[B")
    public byte[] field746;

    @OriginalMember(owner = "client!HQETDHHW", name = "<init>", descriptor = "(LCXFTMSCH;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!HQETDHHW", name = "a", descriptor = "([III[IIIIIZ[B)V")
