...
public class class20 extends class452 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(CIIIZLq;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lsq;Lgh;[Lvp;Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(CIIIZ)V", line = 256)
