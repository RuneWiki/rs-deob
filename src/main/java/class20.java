...
public abstract class class20 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IZI)Z", line = 18)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(BLfd;)Lrk;", line = 48)
