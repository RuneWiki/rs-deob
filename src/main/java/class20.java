...
public class class20 extends class447 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lrc;Lja;B)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IBZIILnf;Lja;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lja;II)Lrc;")
