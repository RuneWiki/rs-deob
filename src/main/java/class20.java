...
public class class20 extends class457 implements class526 {
    ...
    @OriginalMember(owner = "client!ub", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!ub", name = "l", descriptor = "(I)[Lgo;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILr;)Lcr;")
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(Lr;I)Lbca;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lvv;IIZLr;II)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIILr;)Z")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lr;I)V")
