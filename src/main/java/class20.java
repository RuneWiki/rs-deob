...
public class class20 {
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(II)Lvf;")
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(II)Lcq;")
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lal;ILmg;Lmg;Lmg;)V")
