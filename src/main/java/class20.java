...
public class class20 extends class509 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BILin;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Ltt;Lmm;)V")
