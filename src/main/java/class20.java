...
public class class20 extends class535 {
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IF)V", line = 42)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(IIIIIF)V", line = 53)
    public class20(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(B)V", line = 56)
