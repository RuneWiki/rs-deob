...
@OriginalClass("client!FCAOQJWY")
public class class20 {

    @OriginalMember(owner = "client!FCAOQJWY", name = "a", descriptor = "Z")
    private boolean field690 = true;

    @OriginalMember(owner = "client!FCAOQJWY", name = "b", descriptor = "B")
    private byte field691 = 48;

    @OriginalMember(owner = "client!FCAOQJWY", name = "c", descriptor = "I")
    private int field692 = 1;

    @OriginalMember(owner = "client!FCAOQJWY", name = "d", descriptor = "[I")
    public int[] field693 = new int[2];

    @OriginalMember(owner = "client!FCAOQJWY", name = "e", descriptor = "[[[I")
    public int[][][] field694 = new int[2][2][4];

    @OriginalMember(owner = "client!FCAOQJWY", name = "f", descriptor = "[[[I")
    public int[][][] field695 = new int[2][2][4];

    @OriginalMember(owner = "client!FCAOQJWY", name = "g", descriptor = "[I")
    public int[] field696 = new int[2];

    @OriginalMember(owner = "client!FCAOQJWY", name = "h", descriptor = "[[F")
    public static float[][] field697 = new float[2][8];

    @OriginalMember(owner = "client!FCAOQJWY", name = "i", descriptor = "[[I")
    public static int[][] field698 = new int[2][8];

    @OriginalMember(owner = "client!FCAOQJWY", name = "j", descriptor = "F")
    public static float field699;

    @OriginalMember(owner = "client!FCAOQJWY", name = "k", descriptor = "I")
    public static int field700;

    @OriginalMember(owner = "client!FCAOQJWY", name = "a", descriptor = "(BFII)F")
    ...
    @OriginalMember(owner = "client!FCAOQJWY", name = "a", descriptor = "(BF)F")
    ...
    @OriginalMember(owner = "client!FCAOQJWY", name = "a", descriptor = "(IIIF)F")
    ...
    @OriginalMember(owner = "client!FCAOQJWY", name = "a", descriptor = "(FIZ)I")
    ...
    @OriginalMember(owner = "client!FCAOQJWY", name = "a", descriptor = "(LBJPHZZMM;LXOUQUKZW;B)V")
    ...
    @OriginalMember(owner = "client!FCAOQJWY", name = "<init>", descriptor = "()V")
    public class20() {
