...
public class class20 extends class254 implements class161 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Laa;Z)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZIILaa;ILqh;)V")
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Laa;Lsk;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Laa;I)Lcn;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lvk;I)V")
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Laa;IB)Lhc;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIILaa;)Z")
