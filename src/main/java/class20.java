...
public class class20 {
    ...
    @OriginalMember(owner = "client!an", name = "finalize", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lbl;II)V", line = 57)
