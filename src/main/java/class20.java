...
public class class20 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)I", line = 154)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III)Z", line = 190)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(Z)V", line = 207)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)I", line = 254)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "()V", line = 272)
    private class20() {
    }

    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "([I)V", line = 274)
