...
public class class20 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)Lqg;", line = 35)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z[Lqg;)I", line = 47)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)I", line = 86)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)Lqg;", line = 99)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z[BZ)Ljava/lang/Object;", line = 133)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(B)Lqg;", line = 165)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lqg;JI)V", line = 196)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 230)
    ...
    @OriginalMember(owner = "client!an", name = "d", descriptor = "(I)I", line = 279)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(III)Z", line = 308)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BJ)Lqg;", line = 324)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(I)V", line = 352)
