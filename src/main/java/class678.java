...
public class class678 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(B[J[Ljava/lang/Object;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!fea", name = "toString", descriptor = "()Ljava/lang/String;", line = 35)
    public final String toString() {
        field9488++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILae;)I", line = 45)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(FIFFILnh;FIIFI)[B", line = 120)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 136)
