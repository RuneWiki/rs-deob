...
public class class678 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lig;Z[[[BIB)Z")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IZ)Liea;")
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Lwj;IZLwu;Lwu;)V")
