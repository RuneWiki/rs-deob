...
public class class678 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(II)Lvg;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lfp;Lri;Lvu;Lqh;Lpt;Laia;Lte;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(Lha;)Lbg;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(Lha;IIII)Lbg;")
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(II)Llga;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;Lek;IIII)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)Lvg;")
    public static final class52 method3794(int arg0) {
        return (class52) field9267.method1180((byte) 26, (long) arg0);
    }

    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;Lek;Lafa;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;Lee;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
