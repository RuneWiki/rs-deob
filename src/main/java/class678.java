...
public class class678 extends class205 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ILofa;)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lofa;II)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "c", descriptor = "(II)Lsw;")
