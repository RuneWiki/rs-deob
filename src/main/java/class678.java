...
public class class678 extends class493 implements class459 {
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Llm;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Llm;Lec;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Llm;Lec;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lkp;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[BLec;IIIIII)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[FLec;IIIIII)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Llm;Lec;Lbt;II)V")
