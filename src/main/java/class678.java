...
public class class678 extends class305 {
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(ILhb;)V", line = 62)
    public class678(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)I", line = 75)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lhb;)V", line = 106)
