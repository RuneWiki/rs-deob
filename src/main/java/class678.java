...
public class class678 extends class219 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(DI)V", line = 3)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lsf;Z[[[BIB)Z", line = 56)
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Z)J", line = 138)
    ...
    @OriginalMember(owner = "client!fk", name = "e", descriptor = "(B)J", line = 150)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(IJ)V", line = 167)
    public class678(int arg0, long arg1) {
        super.field7577 = (long) arg0 << 56 | arg1;
    }

    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(I)V", line = 175)
