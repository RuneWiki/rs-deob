...
public class class678 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I[BI[BIB)I", line = 4)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I[B[BIBI)I", line = 95)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "([B)V", line = 243)
