...
public class class678 extends class103 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lr;I[Lnea;[BII)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lr;IZ)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ILnea;Lr;IIII)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIIILnea;IIIILr;I)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "([Lnea;IILr;III[BIII)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIIILek;Lr;B[IIII)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ILek;[ILr;II)V")
