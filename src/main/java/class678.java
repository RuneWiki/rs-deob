...
public class class678 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Lha;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ZII)Z", line = 67)
    ...
    @OriginalMember(owner = "client!eja", name = "b", descriptor = "(Lha;B)Lpu;", line = 78)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ILmc;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ILmc;)V", line = 176)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 236)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Lha;I)Lpu;", line = 270)
    ...
    @OriginalMember(owner = "client!eja", name = "b", descriptor = "(Lha;I)Lpu;", line = 305)
    ...
    @OriginalMember(owner = "client!eja", name = "c", descriptor = "(Lha;B)Lpu;", line = 340)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(B)V", line = 362)
