...
public class class678 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIIIIII)Lqaa;", line = 55)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;Z)V", line = 99)
