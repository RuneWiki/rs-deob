...
public class class678 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lqs;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BII)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Z)V", line = 146)
