...
public class class678 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lmca;")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Liaa;IB)V")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Liaa;I)V")
