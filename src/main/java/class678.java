...
public class class678 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 50)
    public static void method3821(int arg0) {
        field9438 = null;
        int var1 = -10 / ((-arg0 - 8) / 41);
    }

    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(III)Z", line = 69)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljava/lang/String;BZLjava/lang/String;)V", line = 80)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lkka;Z)I", line = 121)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(I)V", line = 148)
