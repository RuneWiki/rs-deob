...
public class class678 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I[IB)Laia;", line = 26)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([IIII)Laia;", line = 61)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I[II)Laia;", line = 115)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(III[I)Laia;", line = 135)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Les;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lbt;Lbt;)V", line = 235)
