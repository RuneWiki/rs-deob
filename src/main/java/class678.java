...
public class class678 extends class381 {
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(II)V", line = 8)
    public class678(int arg0, int arg1) {
        this.field9594 = arg0;
        this.field9595 = arg1;
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(III)Z", line = 22)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z)V", line = 48)
