...
public class class678 extends class694 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 39)
    public class678() {
        this(4096);
    }

    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILjr;B)V", line = 84)
