...
public class class678 extends class712 {
    ...
    @OriginalMember(owner = "client!jda", name = "d", descriptor = "(I)I", line = 4)
    public static final int method3816(int arg0) {
        ++field9408;
        return arg0 != 928 ? -75 : class709.field9896;
    }

    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(II)I", line = 16)
    public static int method3817(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ZB)V", line = 24)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!jda", name = "d", descriptor = "(Z)Z", line = 105)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IILhba;)V", line = 116)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lhj;Luu;Lep;)V", line = 148)
