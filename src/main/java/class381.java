...
public class class381 extends class569 implements class45 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(CB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lhp;IZ[[I)V", line = 23)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIIIIII)V", line = 132)
