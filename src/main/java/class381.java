...
public class class381 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lmh;ILjava/lang/String;B)Lnt;", line = 5)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZB)V", line = 60)
