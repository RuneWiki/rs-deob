...
public class class381 extends class329 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lvb;)V", line = 86)
    public class381(class316 arg0) {
        this.field4807 = arg0;
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 68)
