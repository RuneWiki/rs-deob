...
public class class381 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ZLtj;IZIII)Lqb;", line = 16)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Ltj;Lqr;IIIIIIZI)V", line = 519)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILtj;)V", line = 152)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)I", line = 163)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IBI)V", line = 174)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)V", line = 274)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(Z)Z", line = 401)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BI)V", line = 415)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZLtj;Lqb;IIII)V", line = 434)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ltj;I)V", line = 477)
    ...
    @OriginalMember(owner = "client!rg", name = "finalize", descriptor = "()V", line = 509)
