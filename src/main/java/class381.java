...
public class class381 extends class336 {
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLtj;)V", line = 65)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIII)V", line = 84)
