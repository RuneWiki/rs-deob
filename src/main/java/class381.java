...
public class class381 extends class447 implements class395 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(II)V", line = 553)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(B)Z", line = 581)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILja;II)Z", line = 599)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)I", line = 619)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IBZIILnf;Lja;)V", line = 631)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lja;I)V", line = 643)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)Z", line = 653)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILja;)V", line = 664)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLja;)Lkh;", line = 682)
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(I)I", line = 719)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BILja;)Lrc;", line = 730)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)I", line = 743)
    ...
    @OriginalMember(owner = "client!jc", name = "f", descriptor = "(I)V", line = 758)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)V", line = 773)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)I", line = 788)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lja;Lfb;IIIIIIIZIIIII)V", line = 804)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZLja;)V", line = 821)
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(I)V", line = 832)
