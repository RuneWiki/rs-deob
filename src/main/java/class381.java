...
public class class381 extends Callback {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(ZZLjava/awt/Component;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!qha", name = "callback", descriptor = "(IIII)I", line = 63)
