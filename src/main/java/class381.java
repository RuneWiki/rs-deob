...
public class class381 extends class328 {
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(BI)I", line = 7)
    public static final int method2423(byte arg0, int arg1) {
        field5756++;
        return arg0 == -42 ? arg1 & 0xFF : -123;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(II)Ljava/lang/String;", line = 54)
    public static final String method2426(int arg0, int arg1) {
        field5759++;
        return arg1 > arg0 ? Integer.toString(arg0) : "*";
    }

    @OriginalMember(owner = "client!or", name = "g", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 75)
    public class381(Object arg0) {
        this.field5757 = arg0;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lmo;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!or", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 99)
