...
public class class381 extends class533 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!rc", name = "i", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lnq;)V", line = 43)
    public class381(class325 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(B)I", line = 132)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILwv;Lwv;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!rc", name = "f", descriptor = "(I)Z", line = 304)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)Z", line = 317)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(B)Z", line = 355)
    ...
    @OriginalMember(owner = "client!rc", name = "j", descriptor = "(I)V", line = 373)
