...
public class class381 extends class461 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IBLkb;)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "()Lrk;")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([IIIIILkb;)V")
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "()Lrk;")
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lfi;)V")
