...
public class class381 extends class363 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZLpfa;Le;DIII)[I")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lpfa;Le;I)Z")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IILpfa;IZLe;)[F")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZIBLe;DLpfa;IZ)[I")
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lji;)V")
