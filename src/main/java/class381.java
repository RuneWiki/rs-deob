...
public class class381 extends class262 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lfg;Ldd;[Lqr;[I[I)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(CIIIZLpa;II)V")
    ...
    @OriginalMember(owner = "client!ep", name = "HA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([B[I[IIIIIIIIIIILpa;II)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([B[IIIIIIIIIIILpa;II)V")
