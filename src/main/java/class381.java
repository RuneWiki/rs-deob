...
public class class381 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IB)Llc;", line = 3)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(B)Z", line = 73)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(IB)V", line = 151)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lnb;ILoh;Loh;)V", line = 179)
