...
public class class381 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIIIII)I", line = 67)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 101)
