...
public class class381 {
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(ILae;Lae;Ltd;)V", line = 140)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BI)Lpk;", line = 13)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "([IJLo;Z)Ljava/lang/String;", line = 56)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IZII)I", line = 105)
