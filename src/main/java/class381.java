...
public class class381 {
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(I)Lgr;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Llk;B)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Llk;IB)V")
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(B)Lgr;")
