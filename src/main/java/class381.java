...
public class class381 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lvp;ILeq;)I")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Ls;")
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lci;ILhe;)V")
