...
public class class381 extends class111 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(FIFI[FZIFIFI)V", line = 5)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lnd;Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(I)V", line = 759)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(I)V", line = 717)
    public static void method2287(int arg0) {
        field5552 = null;
        int var1 = -124 / ((arg0 + 29) / 34);
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILlt;)V", line = 726)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILtq;Lqq;IB)V", line = 791)
