...
public class class381 extends class297 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lcea;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!oj", name = "f", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "()V", line = 217)
    public class381() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oj", name = "c", descriptor = "(II)[I", line = 220)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!oj", name = "e", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IB)[I", line = 308)
