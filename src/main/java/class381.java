...
public class class381 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IF)I", line = 11)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "()V", line = 71)
    public static void method2215() {
        field5378 = null;
        field5371 = null;
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(F)F", line = 86)
    private static final float method2216(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lwm;Ljk;)V", line = 103)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(IIF)F", line = 178)
