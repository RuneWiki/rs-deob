...
public abstract class class381 {
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(II)V", line = 48)
