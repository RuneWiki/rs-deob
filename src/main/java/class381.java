...
public class class381 extends class13 {
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "()V", line = 315)
    public class381() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lkh;BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)[[I", line = 220)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIIIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Z)V", line = 305)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(IIII)V", line = 323)
