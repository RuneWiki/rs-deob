...
public class class381 extends class666 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILiaa;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!mba", name = "h", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)Z", line = 55)
    ...
    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "()V", line = 235)
    public class381() {
        super(0, false);
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILjava/awt/Component;)Lws;", line = 244)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IB)[[I", line = 260)
