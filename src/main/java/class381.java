...
public class class381 extends class299 {
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Les;)V")
    public class381(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILwq;)Lrj;")
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(ILes;)V")
