...
public class class381 extends class739 {
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 3)
    public class381() {
        this(4096);
    }

    @OriginalMember(owner = "client!ln", name = "e", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)[I", line = 19)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lsl;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BFFF)I", line = 77)
