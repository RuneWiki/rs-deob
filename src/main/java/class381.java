...
public class class381 extends class346 {
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(III)Lan;", line = 229)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZI)I", line = 495)
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(Z)I", line = 516)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(Z)V", line = 531)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)Lkd;", line = 550)
    ...
    @OriginalMember(owner = "client!eh", name = "e", descriptor = "(Z)I", line = 650)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(B)V", line = 677)
    ...
    @OriginalMember(owner = "client!eh", name = "f", descriptor = "(Z)I", line = 689)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)I", line = 711)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)I", line = 734)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BI)[B", line = 756)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(ZI)V", line = 777)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(ILtc;Ltc;Lob;Lrda;I[BIZ)V", line = 830)
