...
public class class381 {
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lod;ZB)V", line = 56)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I[BII)Z", line = 125)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILuo;I)V", line = 208)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 495)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(B)V", line = 523)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(B)Z", line = 538)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZBIZ)Lrb;", line = 550)
    ...
    @OriginalMember(owner = "client!sa", name = "d", descriptor = "(I)V", line = 593)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Z)Z", line = 623)
    ...
    @OriginalMember(owner = "client!sa", name = "e", descriptor = "(I)V", line = 900)
    ...
    @OriginalMember(owner = "client!sa", name = "d", descriptor = "(B)I", line = 915)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZI)V", line = 939)
    ...
    @OriginalMember(owner = "client!sa", name = "e", descriptor = "(B)Z", line = 970)
