...
public class class381 extends class436 {
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lnf;)V", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(Z)V", line = 115)
    public final void method161(boolean arg0) {
        this.field6402.method1627(8448, 7681);
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "()V", line = 152)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "()V", line = 173)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lme;)V", line = 236)
    public final void method160(class360 arg0) {
        this.field6402.method1669(arg0);
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "()Z", line = 239)
