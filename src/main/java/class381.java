...
public class class381 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IBI)Z", line = 41)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIIIZ)Lql;", line = 52)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIZ)I", line = 94)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 129)
