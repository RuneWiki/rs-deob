...
public class class305 extends class33 {
    ...
    @OriginalMember(owner = "client!mf", name = "B", descriptor = "(CIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([B[I[IIIIIIIIIIILea;II)V", line = 66)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([B[I[IIIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(CIIIZLea;II)V", line = 214)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([B[IIIIIIII)V", line = 283)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lrh;Lse;[Lrl;[I[I)V", line = 340)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V", line = 363)
