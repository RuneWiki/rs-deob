...
public class class305 extends class98 {
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(II)Ldk;", line = 5)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIII)I", line = 38)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILdg;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(IIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 80)
    public class305() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)[I", line = 83)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(II)[[I", line = 138)
    ...
    @OriginalMember(owner = "client!ni", name = "e", descriptor = "(I)V", line = 217)
