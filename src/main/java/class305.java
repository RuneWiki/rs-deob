...
public class class305 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)I", line = 50)
    public static final int method1899(int arg0) {
        field4391++;
        return arg0 < 108 ? -123 : 42;
    }

    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 121)
    public class305() {
    }

    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lcb;)V", line = 124)
    public class305(class78 arg0) {
        this.field4398 = arg0;
    }

    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)Lum;", line = 69)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(B)Lum;", line = 81)
