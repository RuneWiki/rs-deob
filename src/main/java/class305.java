...
public class class305 implements class454 {
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(I)Lbja;", line = 7)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IB)I", line = 75)
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(Lcb;Ljava/lang/String;)V", line = 122)
    public class305(class544 arg0, String arg1) {
        this.field4558 = arg1;
        this.field4559 = arg0;
    }

    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Ljava/lang/String;BZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(B)V", line = 215)
