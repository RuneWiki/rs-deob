...
public class class305 extends class748 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IZLvj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(II)[I", line = 44)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "()V", line = 287)
    public class305() {
        super(2, false);
    }

    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IB)Lcj;", line = 291)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(II)[[I", line = 368)
