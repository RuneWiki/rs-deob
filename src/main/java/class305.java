...
public class class305 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BLpe;)Lsba;", line = 4)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILrd;)Z", line = 29)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjava/lang/String;)I", line = 79)
