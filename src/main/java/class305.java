...
public class class305 extends class447 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIILsk;I)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BILeb;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lkq;Ljava/awt/Frame;I)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Leb;B)V")
