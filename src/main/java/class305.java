...
public class class305 {
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lih;[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "([BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lih;Ljava/nio/ByteBuffer;)V", line = 28)
