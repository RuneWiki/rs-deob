...
public class class305 extends class336 {
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lfp;Lje;ZIIII)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lbi;ILfp;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lfp;II)Lbi;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lfp;III)Z")
