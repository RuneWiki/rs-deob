...
public class class305 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ZZ)Z", line = 32)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BIIILgb;)Z", line = 45)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Z)V", line = 168)
