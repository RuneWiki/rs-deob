...
public class class305 {
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BII)B", line = 56)
