...
public class class305 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BII)I", line = 7)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(IIILr;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!vea", name = "toString", descriptor = "()Ljava/lang/String;", line = 127)
    public final String toString() {
        field4520++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(I)V", line = 137)
