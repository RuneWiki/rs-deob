...
public class class305 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)Lfi;", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLfi;)V", line = 26)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)Lfi;", line = 50)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lbi;IIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!os", name = "d", descriptor = "(I)Lfi;", line = 158)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IB)V", line = 183)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(B)Z", line = 197)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(B)Lfi;", line = 211)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "()V", line = 269)
    public class305() {
        this.field4015.field5271 = this.field4015;
        this.field4015.field5274 = this.field4015;
    }

    @OriginalMember(owner = "client!os", name = "d", descriptor = "(B)V", line = 248)
