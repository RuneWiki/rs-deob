...
public class class305 extends class354 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILti;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BI)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lks;Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "()V", line = 154)
    public class305() {
        super(1, false);
    }
}
