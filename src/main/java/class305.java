...
public class class305 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BI)Lvq;", line = 103)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II)V", line = 167)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZII)V", line = 187)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lle;ILoi;Loi;)V", line = 213)
