...
public class class305 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIILgba;)V")
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lta;)V")
    public class305(class200 arg0) {
        this.field4226 = arg0;
    }

    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lta;Lkga;)V")
