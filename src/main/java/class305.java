...
public abstract class class305 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILcs;)V", line = 37)
    ...
    @OriginalMember(owner = "client!vw", name = "d", descriptor = "(II)Lru;", line = 97)
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lhb;)V", line = 138)
    public class305(class728 arg0) {
        this.field4323 = arg0;
        this.field4320 = this.method305((byte) 68);
    }

    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(ILhb;)V", line = 146)
