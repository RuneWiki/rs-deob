...
public class class305 extends class398 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZZ)Z", line = 6)
    public static boolean method1944(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "([III)V", line = 14)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I[ILsi;III)V", line = 54)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILsi;)V", line = 119)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "()I", line = 184)
    public final int method692() {
        field4520++;
        return 0;
    }

    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(I)V", line = 194)
    public static void method1948(int arg0) {
        int var1 = -115 % ((-arg0 - 80) / 44);
        field4517 = null;
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Ldb;)V", line = 368)
    public class305(class217 arg0) {
        this.field4514 = arg0;
    }

    @OriginalMember(owner = "client!gr", name = "b", descriptor = "()Lpo;", line = 241)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BBILki;I)V", line = 299)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "()Lpo;", line = 337)
