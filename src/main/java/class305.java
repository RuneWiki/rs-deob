...
public class class305 extends class49 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(I[III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(IBI)Z", line = 48)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lns;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(II[III)Z", line = 146)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 307)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ZI)I", line = 194)
    ...
    @OriginalMember(owner = "client!wia", name = "g", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(I[III)Z", line = 247)
