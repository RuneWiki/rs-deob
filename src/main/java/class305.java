...
public class class305 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BI)I", line = 28)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILee;)V", line = 86)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILee;)V", line = 133)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)Ljava/lang/String;", line = 186)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(II)Z", line = 225)
