...
public class class305 implements class628 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)I", line = 43)
    public final int method288(int arg0) {
        return arg0 == 247 ? this.field4190 : 69;
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)I", line = 95)
    public final int method1868(byte arg0) {
        return arg0 == -114 ? this.field4188 : -119;
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 105)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lwda;Z)V", line = 143)
