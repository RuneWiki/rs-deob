...
public class class305 extends class298 {
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "e", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lpi;ILpi;ZIIZ)I", line = 46)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIZ)I", line = 88)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IZ)[I", line = 123)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 146)
    public class305() {
        this(4096);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILvt;)V", line = 160)
