...
public class class305 extends class374 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IILb;ZLya;Lcs;)Z")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lvd;Lbt;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ZLew;I)V")
