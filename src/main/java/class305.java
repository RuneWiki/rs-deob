...
public class class305 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IBII)Lqb;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILsu;III)Lll;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BI)Lfu;")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lcda;ILkea;)V")
