...
public class class305 {
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(Z)Lmg;")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)Lmg;")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILqw;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lqw;)V")
