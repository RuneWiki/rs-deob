...
public class class305 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lec;B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 72)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lec;II)V", line = 132)
