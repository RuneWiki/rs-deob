...
public class class305 extends class417 implements class248 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILqa;ZLto;III)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lqa;II)Lc;")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZLqa;)Lae;")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Lqa;Lgm;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lmq;ILqa;)V")
