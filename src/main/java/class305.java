...
public class class305 extends class601 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(B)I", line = 51)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lgn;)V", line = 62)
    public class305(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(ILgn;)V", line = 65)
    public class305(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)I", line = 99)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IZ)V", line = 267)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!ca", name = "d", descriptor = "(B)V", line = 302)
