...
public class class305 extends class238 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!caa", name = "finalize", descriptor = "()V", line = 34)
    protected final void finalize() {
        this.method1439(-17);
        field4130++;
    }

    @OriginalMember(owner = "client!caa", name = "a", descriptor = "([BIII)I", line = 45)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II[BI)V", line = 72)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II)Z", line = 87)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 98)
