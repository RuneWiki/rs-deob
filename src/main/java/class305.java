...
public class class305 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lkr;II)Lem;")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II[IB)Lvj;")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I[II)Lvj;")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IBI[I)Lvj;")
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I[II)Lvj;")
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lnq;Lnq;)V")
