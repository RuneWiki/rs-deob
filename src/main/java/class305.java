...
public class class305 extends class66 {
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lpl;Ljq;)V", line = 3)
    public class305(class612 arg0, class490 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 53)
