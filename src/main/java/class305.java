...
public class class305 extends class180 implements class302 {
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLr;)Lll;", line = 56)
    ...
    @OriginalMember(owner = "client!bb", name = "h", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILr;ZZ)Lraa;", line = 83)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lr;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)I", line = 151)
    public final int method413(byte arg0) {
        ++field4799;
        return arg0 != 11 ? 31 : this.field4819;
    }

    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)I", line = 179)
    ...
    @OriginalMember(owner = "client!bb", name = "k", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(ILr;)Lod;", line = 212)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILr;I)Lda;", line = 242)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lr;Z)V", line = 269)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZILr;I)Z", line = 281)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(B)I", line = 306)
    ...
    @OriginalMember(owner = "client!bb", name = "i", descriptor = "(I)Z", line = 319)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)Z", line = 336)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILr;)V", line = 347)
