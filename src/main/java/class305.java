...
public abstract class class305 extends class352 {
    ...
    @OriginalMember(owner = "client!ug", name = "f", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ug", name = "g", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZ)Lpm;", line = 42)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILh;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 131)
