...
public class class305 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "([JI[Ljava/lang/Object;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIB)I", line = 50)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lme;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "([BII)I", line = 131)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)V", line = 142)
    public static void method1795(byte arg0) {
        int var1 = 94 / ((21 - arg0) / 57);
        field4135 = null;
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)Lng;", line = 151)
