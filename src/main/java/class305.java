...
public abstract class class305 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IILrg;Lrg;BIIZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIILrg;Lrg;[ZLrg;IILrg;IIIIZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIZI[II[IZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZLrg;ILrg;II[IIII)V", line = 218)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIILui;Lud;Lui;[IZIZI[Z)V", line = 267)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lrg;II)V", line = 481)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILuh;IIIII)V", line = 526)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Ljava/awt/Component;BZ)Luq;", line = 602)
