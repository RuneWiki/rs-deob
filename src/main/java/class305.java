...
public class class305 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lwq;BI)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)Luh;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lwq;B)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IILoi;)V")
