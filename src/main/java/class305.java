...
public class class305 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(I)Llda;", line = 4)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Z)Llda;", line = 34)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!oaa", name = "c", descriptor = "(I)Llda;", line = 107)
    ...
    @OriginalMember(owner = "client!oaa", name = "d", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(BLlda;)V", line = 180)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "()V", line = 205)
    public class305() {
        this.field4189.field7004 = this.field4189;
        this.field4189.field7006 = this.field4189;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ZLji;ZB)V", line = 216)
