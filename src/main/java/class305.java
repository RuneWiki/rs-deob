...
public class class305 extends class86 {
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(ILsf;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lmc;I)V")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lsf;)V")
