...
public class class305 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 37)
    public class305(class252 arg0, int arg1, class791 arg2) {
        this.field4389 = arg2;
        this.field4389.method4353(5, true);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BI)Lnb;", line = 56)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 87)
