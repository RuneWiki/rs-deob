...
public class class305 extends class295 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BILap;)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lap;I)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IILbi;I)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILrk;)V")
