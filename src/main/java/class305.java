...
public class class305 implements class613 {
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)I", line = 53)
    public final int method1992(int arg0, int arg1) {
        field4283++;
        return arg0 == -1 ? this.field4275[arg1] : 21;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)V", line = 64)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIB)V", line = 82)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BII)V", line = 138)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZI)I", line = 166)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(IIB)V", line = 203)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(II)V", line = 309)
