...
public class class305 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILrf;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)Lrf;")
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(I)Lrf;")
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(I)Lrf;")
    ...
    @OriginalMember(owner = "client!ks", name = "f", descriptor = "(I)Lrf;")
