...
public class class305 extends class362 {
    ...
    @OriginalMember(owner = "client!qia", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 14)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Ljava/net/Proxy;B)Ljava/net/Socket;", line = 85)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 108)
    ...
    @OriginalMember(owner = "client!qia", name = "c", descriptor = "(I)Ljava/net/Socket;", line = 164)
