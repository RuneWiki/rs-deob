...
public class class741 extends class237 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(CIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qc", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 21)
    public final synchronized void focusLost(FocusEvent arg0) {
        field10307++;
        this.method4135('\u0000', -1, 0, 0);
    }

    @OriginalMember(owner = "client!qc", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 29)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field10304++;
        this.method4139(1, (byte) -71, arg0);
    }

    @OriginalMember(owner = "client!qc", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 38)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field10291++;
        this.method4139(0, (byte) -71, arg0);
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 47)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)[Lgg;", line = 86)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II)Z", line = 97)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IBLjava/awt/event/KeyEvent;)V", line = 112)
    ...
    @OriginalMember(owner = "client!qc", name = "e", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!qc", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 180)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(B)Lkia;", line = 209)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!qc", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 313)
    public final void focusGained(FocusEvent arg0) {
        field10302++;
    }

    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)I", line = 321)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 418)
    public class741(Component arg0) {
        class614.method3437(false);
        this.method4136((byte) -127, arg0);
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIILsl;Lsl;)V", line = 349)
