...
public class class741 implements class536 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(III)Z", line = 22)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILeq;)V", line = 93)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(II)V", line = 118)
