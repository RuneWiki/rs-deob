...
public class class741 extends class634 {
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IFIIIFI[F[FZII)V", line = 17)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ZI)Lfg;", line = 70)
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(BI)[I", line = 107)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "()V", line = 154)
    public class741() {
        super(0, true);
    }
}
