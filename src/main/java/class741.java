...
public class class741 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILrg;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZLrg;)V", line = 87)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 128)
