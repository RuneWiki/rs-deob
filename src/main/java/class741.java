...
public class class741 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lmc;)V", line = 28)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "()V", line = 43)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(Lmc;)V", line = 50)
