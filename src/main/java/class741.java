...
public class class741 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZLjava/lang/String;Lqg;ZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 127)
