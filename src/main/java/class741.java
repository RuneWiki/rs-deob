...
public class class741 extends class44 implements class9 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(BLnd;)V")
    public final void method272(byte arg0, class545 arg1) {
        super.method272(arg0, arg1);
    }

    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lbea;Lkt;III[B)V")
