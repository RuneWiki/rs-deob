...
public class class741 extends class309 {
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(ILfca;)V", line = 37)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Z)V", line = 89)
