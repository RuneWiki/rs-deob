...
public class class741 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IILid;)Lob;", line = 4)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lha;BI)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZI)Lan;", line = 470)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BLob;)V", line = 488)
    ...
    @OriginalMember(owner = "client!ih", name = "run", descriptor = "()V", line = 503)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILid;I)Lob;", line = 548)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZLpe;)V", line = 585)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)V", line = 619)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lfc;)V", line = 677)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I[BLid;I)Lob;", line = 658)
