...
public class class741 extends class450 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BLee;)Loh;")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILwu;)I")
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lup;)V")
