...
public class class741 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILjava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "([I[I[I[[F)V", line = 106)
