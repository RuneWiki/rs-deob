...
public class class761 extends class649 implements class624 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BLha;)Lck;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lha;IZI)Lga;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!eca", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BLha;I)Lka;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lha;IIB)Z")
