...
public class class761 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZII)I", line = 58)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)V", line = 84)
