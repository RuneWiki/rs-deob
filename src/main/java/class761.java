...
public class class761 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)Lof;", line = 10)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZII)I", line = 17)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!gq", name = "toString", descriptor = "()Ljava/lang/String;", line = 56)
