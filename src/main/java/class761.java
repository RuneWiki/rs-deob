...
public class class761 {
    ...
    @OriginalMember(owner = "client!bo", name = "toString", descriptor = "()Ljava/lang/String;", line = 10)
    public final String toString() {
        field10486++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "([BB)[B", line = 37)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Z)I", line = 102)
