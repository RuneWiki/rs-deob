...
public class class761 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIIIILol;ZII)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ls;I[[ILha;Ls;BLs;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "([[BLnaa;Lha;Lhca;II[[BI[[B[ZIIIZ)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ls;ILha;Ls;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BIIILol;I[Lkn;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IILol;IIII[Lkn;II)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "([[[IBLha;[Lkn;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ls;Ls;[[IZILha;Ls;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILuf;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(IIIZLoo;Lui;)V")
