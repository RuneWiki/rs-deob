...
public class class761 extends class392 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILni;Ld;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ld;Lni;BIIZ)[F", line = 53)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IZLd;DZLni;IB)[I", line = 172)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 317)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZDILd;Lni;BI)[I", line = 333)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lji;I)Lwd;", line = 469)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "()V", line = 488)
    public class761() {
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lji;)V", line = 507)
