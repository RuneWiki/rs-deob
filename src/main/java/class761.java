...
public class class761 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IBLiga;II)Z")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lqba;Z)V")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Ldt;Leo;B)Lvq;")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Ldt;Z)V")
