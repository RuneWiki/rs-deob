...
public class class761 extends class758 {
    ...
    @OriginalMember(owner = "client!ww", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ww", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(I)Lod;", line = 62)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IJIIZ)Ljava/lang/String;", line = 122)
    ...
    @OriginalMember(owner = "client!ww", name = "f", descriptor = "(I)Z", line = 206)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIB)Z", line = 221)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(III)I", line = 239)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Lffa;IIIIII)V", line = 252)
