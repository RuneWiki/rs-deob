...
public abstract class class761 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BILjava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ww", name = "finalize", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I[BZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Lkv;I[BIZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Lkv;ILjaclib/memory/Buffer;IZ)V", line = 97)
