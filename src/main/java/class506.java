...
public class class506 extends class397 {
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IBLae;)V", line = 18)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 31)
    public class506() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BI)[[I", line = 37)
    ...
    @OriginalMember(owner = "client!nh", name = "d", descriptor = "(II)I", line = 83)
    public static final int method3041(int arg0, int arg1) {
        return class502.field7676 != null ? class502.field7676[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(II)[I", line = 87)
    ...
    @OriginalMember(owner = "client!nh", name = "e", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!nh", name = "e", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILeq;)Z", line = 180)
