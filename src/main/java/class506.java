...
public class class506 {
    ...
    @OriginalMember(owner = "client!uk", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIJI)V", line = 28)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lml;JI)V", line = 72)
