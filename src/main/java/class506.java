...
public class class506 extends class11 {
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "()V", line = 3)
    public class506() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIIZIIIII)Z", line = 50)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lsi;II)V", line = 87)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILjava/lang/String;)J", line = 135)
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(II)[I", line = 186)
