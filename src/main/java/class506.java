...
public class class506 extends class281 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lha;II)Z")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILrf;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(ILha;)V")
