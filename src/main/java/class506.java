...
public class class506 implements Runnable {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BLdea;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I[BLsaa;I)Ldea;")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lsaa;II)Ldea;")
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(Lsaa;II)Ldea;")
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Luf;)V")
