...
public class class506 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)Llu;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI)Lcu;")
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lwv;ILqs;)V")
