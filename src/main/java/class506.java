...
public class class506 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(JJ)J", line = 24)
    public static long method2889(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BLjava/lang/String;)V", line = 35)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIIII)I", line = 69)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 85)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Z)V", line = 99)
    public class506(boolean arg0) {
        this.field6933 = arg0;
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z)Z", line = 140)
