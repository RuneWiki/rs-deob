...
public class class506 extends class631 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(CI)Z")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Leea;)V")
    public class506(class131 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILta;)V")
