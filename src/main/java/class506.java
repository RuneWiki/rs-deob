...
public class class506 extends class431 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZIII)I", line = 36)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(IIIIIZ)V", line = 86)
