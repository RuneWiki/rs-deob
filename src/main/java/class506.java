...
public class class506 extends class535 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILwn;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IZ)[I", line = 52)
    ...
    @OriginalMember(owner = "client!dd", name = "e", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)Lau;", line = 94)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 377)
    public class506() {
        super(1, true);
    }

    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(II)[I", line = 127)
    ...
    @OriginalMember(owner = "client!dd", name = "f", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!dd", name = "g", descriptor = "(B)V", line = 195)
