...
public class class506 extends class654 {
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(I)J", line = 7)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IJ)I", line = 40)
    ...
    @OriginalMember(owner = "client!iea", name = "c", descriptor = "(B)J", line = 73)
    public final long method3813(byte arg0) {
        return arg0 == -88 ? this.field7563 : -27L;
    }

    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "()V", line = 117)
    public class506() {
        this.field7563 = System.nanoTime();
        this.field7564 = System.nanoTime();
    }

    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Z)J", line = 89)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(B)V", line = 106)
