...
public class class506 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lpf;ILnf;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 345)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)I", line = 495)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Ljava/lang/String;BZI)Z", line = 514)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(B)V", line = 588)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)Lbp;", line = 635)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)I", line = 652)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "()V", line = 668)
    private class506() {
    }

    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "([I)V", line = 670)
