...
public class class506 extends class766 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lia", name = "d", descriptor = "()Lsia;", line = 23)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIIILsq;[I)V", line = 43)
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "()I", line = 105)
    public final int method591() {
        field6997++;
        return 0;
    }

    @OriginalMember(owner = "client!lia", name = "a", descriptor = "([[[Ljd;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "([III)V", line = 182)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "()Lsia;", line = 225)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IILsq;)V", line = 250)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(Ldr;)V", line = 334)
