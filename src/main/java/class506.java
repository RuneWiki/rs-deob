...
public class class506 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BILf;I)J", line = 49)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(II)Lpu;", line = 96)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 145)
