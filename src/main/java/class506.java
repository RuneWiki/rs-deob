...
public class class506 extends class92 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILqv;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lde;Lgp;Lom;)V", line = 12)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZI)V", line = 94)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZB)V", line = 104)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZII)V", line = 124)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)Z", line = 216)
