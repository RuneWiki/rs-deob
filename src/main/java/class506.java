...
public class class506 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLej;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lej;)V", line = 824)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lej;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lc;Lej;I)V", line = 424)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZ)V", line = 696)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILej;)V", line = 721)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 742)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIII)V", line = 758)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Z)Lub;", line = 776)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(ILej;)V", line = 810)
