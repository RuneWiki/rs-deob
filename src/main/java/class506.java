...
public class class506 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)Liq;", line = 3)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lls;Lqa;ILtr;)V", line = 23)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZI)V", line = 185)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BI)Lwp;", line = 198)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZLjava/lang/String;II)I", line = 226)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)V", line = 325)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 359)
    public class506(class157 arg0, int arg1, class240 arg2) {
        this.field7444 = arg2;
        this.field7444.method1397((byte) -128, 1);
    }

    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)V", line = 374)
