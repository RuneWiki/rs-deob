...
public class class506 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "()I", line = 115)
    public final int method2950() {
        return this.field6877 - 1;
    }

    @OriginalMember(owner = "client!ee", name = "b", descriptor = "()V", line = 121)
    public static void method2951() {
        field6883 = null;
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ljava/lang/String;)I", line = 125)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "()I", line = 140)
    public final int method2953() {
        return this.field6882;
    }

    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 153)
