...
public class class506 extends class76 implements class161 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lza;IZ)Le;")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lza;Lii;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lgt;IIILjava/awt/Component;)Lsl;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILza;ZZ)Lhw;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lza;IIILps;IZ)V")
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lza;II)Le;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BLza;)V")
