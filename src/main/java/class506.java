...
public class class506 extends class32 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILql;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLoa;Lnt;IIII)V")
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(Loa;I)Lqt;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLoa;I)Z")
