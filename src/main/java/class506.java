...
public class class506 implements class547 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)Lwea;", line = 6)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(I)V", line = 17)
    public class506(int arg0) {
        this.field6693 = arg0;
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLqj;ILjava/lang/String;)Laf;", line = 30)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IZII)I", line = 83)
