...
public class class506 extends class227 {
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIIZ[III)V", line = 27)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIII[I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIIII)V", line = 64)
    public class506(class287 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIIII[BI)V", line = 79)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIIIIIZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 127)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Luca;IIIIZ[BI)V", line = 145)
