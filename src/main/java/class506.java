...
public class class506 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)Lia;", line = 18)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Z)Lvda;", line = 29)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(II)V", line = 60)
    public class506(int arg0, int arg1) {
        this.field7149 = arg1;
        this.field7154 = arg0;
    }

    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lia;I)V", line = 68)
