...
public class class506 extends class132 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIB)V", line = 28)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(IIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III)V", line = 61)
