...
public class class506 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILnj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZLnj;)V", line = 25)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 104)
