...
public class class506 implements class115 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)Lpda;", line = 5)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILkk;Ljava/lang/String;B)Ltj;", line = 44)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lkf;Z[[[BIB)Z", line = 143)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(II)V", line = 206)
