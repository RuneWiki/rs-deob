...
public class class506 extends class404 {
    ...
    @OriginalMember(owner = "client!nh", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 17)
    public class506() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nh", name = "h", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)[I", line = 52)
    ...
    @OriginalMember(owner = "client!nh", name = "i", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILha;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(III)V", line = 243)
