...
public class class506 extends class748 {
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "()V", line = 39)
    public class506() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ss", name = "g", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZLvj;)V", line = 67)
    ...
    @OriginalMember(owner = "client!ss", name = "h", descriptor = "(I)V", line = 106)
