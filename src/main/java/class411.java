...
public class class411 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZLdh;)V", line = 14)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BILdh;)V", line = 93)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IZ)V", line = 126)
