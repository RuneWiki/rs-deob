...
public class class411 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IB)I", line = 5)
    public static final int method2617(int arg0, byte arg1) {
        field6312++;
        return arg1 <= 35 ? -32 : arg0 >> 11 & 0x7F;
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(CI)C", line = 28)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)[Lja;", line = 58)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IZLsp;[I)V", line = 70)
