...
public abstract class class411 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(II)V", line = 109)
    public class411(int arg0, int arg1) {
        this.field5751 = arg1;
        this.field5745 = arg0;
    }

    @OriginalMember(owner = "client!sa", name = "d", descriptor = "(II)Llk;", line = 135)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)V", line = 158)
