...
public class class411 extends class216 {
    ...
    @OriginalMember(owner = "client!fha", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "(Led;Lcd;[Lcu;[I[I)V")
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
