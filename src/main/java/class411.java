...
public abstract class class411 implements class686 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)V", line = 183)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(III)Z", line = 202)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)V", line = 218)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZI)V", line = 255)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(B)V", line = 272)
    public static void method2434(byte arg0) {
        int var1 = 35 % ((arg0 - 28) / 37);
        field5797 = null;
    }

    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(Z)I", line = 284)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IZ)V", line = 298)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(Z)Z", line = 318)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIIIIIII)V", line = 343)
    ...
    @OriginalMember(owner = "client!kp", name = "d", descriptor = "(Z)I", line = 354)
    ...
    @OriginalMember(owner = "client!kp", name = "finalize", descriptor = "()V", line = 368)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Leq;IIIZ)V", line = 381)
