...
public class class411 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)Ljp;", line = 4)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)Ljp;", line = 24)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z[BZ)Ljava/lang/Object;", line = 83)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)Ljp;", line = 117)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)Ljp;", line = 142)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Ljp;Lpu;I)V", line = 160)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ILjp;)V", line = 186)
    ...
    @OriginalMember(owner = "client!pu", name = "d", descriptor = "(I)I", line = 205)
    ...
    @OriginalMember(owner = "client!pu", name = "e", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)Z", line = 254)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Ljp;I)V", line = 266)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(B)Ljp;", line = 290)
    ...
    @OriginalMember(owner = "client!pu", name = "d", descriptor = "(B)V", line = 311)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "()V", line = 336)
    public class411() {
        this.field6207.field4530 = this.field6207;
        this.field6207.field4535 = this.field6207;
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lpu;I)V", line = 325)
