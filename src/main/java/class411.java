...
public class class411 extends class63 implements class303 {
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lza;Lpm;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lza;BI)Le;")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZILza;I)Luo;")
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IZLat;II)V")
