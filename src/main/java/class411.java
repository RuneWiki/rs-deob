...
public class class411 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Leb;I)Ljb;", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IB)Lrh;", line = 44)
