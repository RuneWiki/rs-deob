...
public class class411 extends class487 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kca", name = "e", descriptor = "()V", line = 51)
    ...
    @OriginalMember(owner = "client!kca", name = "c", descriptor = "()Lqp;", line = 68)
    public final class487 method615() {
        return (class487) this.field5758.method1033(-1);
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lsja;Lmi;)V", line = 75)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lmi;)V", line = 84)
    ...
    @OriginalMember(owner = "client!kca", name = "c", descriptor = "([III)V", line = 99)
    ...
    @OriginalMember(owner = "client!kca", name = "f", descriptor = "()I", line = 108)
    public final synchronized int method2509() {
        return this.field5758.method1036((byte) -67);
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lqp;)V", line = 113)
    public final synchronized void method2510(class487 arg0) {
        this.field5758.method1042(arg0, 1048832);
    }

    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "()Lqp;", line = 136)
    public final class487 method614() {
        return (class487) this.field5758.method1041(1048832);
    }

    @OriginalMember(owner = "client!kca", name = "d", descriptor = "()I", line = 139)
    public final int method613() {
        return 0;
    }

    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(Lqp;)V", line = 145)
    public final synchronized void method2512(class487 arg0) {
        arg0.method527(-11229);
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "([III)V", line = 153)
