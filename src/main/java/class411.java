...
public class class411 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Ldga;B)Lpu;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(II)Lss;")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Luea;ILpq;)V")
