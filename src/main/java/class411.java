...
public class class411 extends class280 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIIIZ)Lrg;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lar;III)V")
    ...
    @OriginalMember(owner = "client!d", name = "q", descriptor = "()Lbd;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lbd;)V")
    public final void method1404(class327 arg0) {
        this.field5850 = (class114) arg0;
    }

    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIIIIILhg;II)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(II[[I[[IIII)Lmi;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Ljava/lang/Runnable;)Lpp;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Laj;)V")
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Ljava/awt/Canvas;Leg;I)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lcd;)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lbg;[Lkm;Z)Lcr;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(II[I[I)Lhg;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lwt;)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I[Lhq;)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lqh;Lcd;Lbd;Lqt;I)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIIIII)Laj;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lkm;Z)Lrg;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lkp;IIII)Lqh;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Laj;Laj;FLaj;)Laj;")
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(I)Lwt;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILhg;II)V")
    ...
    @OriginalMember(owner = "client!d", name = "d", descriptor = "()Lbd;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "([IIIII)Lrg;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "([Lqh;Lbd;[Lqt;I)V")
