...
public class class411 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZI)I", line = 43)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;ILjagdx/IDirect3DSurface;)V", line = 53)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 63)
