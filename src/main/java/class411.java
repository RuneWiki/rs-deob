...
public class class411 implements Runnable {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)Lmt;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BIILjava/lang/Object;I)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/String;II)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/Class;I)Lgm;")
    public final class81 method2443(Class arg0, int arg1) {
        return arg1 == 0 ? this.method2438((byte) 5, 0, 11, arg0, 0) : null;
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLjava/awt/Frame;)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/awt/Component;IBLjava/awt/Point;[II)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IBLjava/awt/Component;I)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLjava/awt/Component;Z)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(ILjava/lang/String;)Lgm;")
    public final class81 method2454(int arg0, String arg1) {
        return arg0 == 16 ? this.method2438((byte) 5, 0, 16, arg1, 0) : null;
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIIII)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/net/URL;I)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Ljava/lang/String;I)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Ljava/lang/Class;I)Lgm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLjava/lang/String;Z)Lgm;")
