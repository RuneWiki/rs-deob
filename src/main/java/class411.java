...
public class class411 extends class456 {
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIII[I)V", line = 31)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIIIZ[BI)V", line = 45)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILha;)V", line = 69)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIIII)V", line = 236)
    public class411(class250 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIIZ[III)V", line = 252)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIIIIIZ)V", line = 276)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 292)
    ...
    @OriginalMember(owner = "client!fu", name = "d", descriptor = "(B)V", line = 387)
    public static void method2468(byte arg0) {
        int var1 = 103 / ((arg0 - -62) / 57);
        field5838 = null;
    }

    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIIII[BI)V", line = 396)
    ...
    @OriginalMember(owner = "client!fu", name = "g", descriptor = "(I)V", line = 411)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIII)V", line = 446)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILjava/lang/String;)I", line = 467)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llf;IIIIIZ)V", line = 489)
