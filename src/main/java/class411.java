...
public class class411 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BI)Liga;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILkp;IBILua;IJI)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lqd;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lrf;ILpl;)V")
