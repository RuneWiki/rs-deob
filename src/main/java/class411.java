...
public class class411 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Z)V", line = 41)
