...
public class class411 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IILkg;Lae;ILtm;II)V", line = 152)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lwc;I)V", line = 239)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(I)I", line = 266)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)Z", line = 299)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lge;II)Z", line = 321)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IB)V", line = 481)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(B)V", line = 498)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(I)I", line = 512)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "()V", line = 529)
    private class411() {
    }

    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "([I)V", line = 531)
