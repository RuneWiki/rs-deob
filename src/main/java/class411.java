...
public class class411 extends class684 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)Z", line = 43)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II[BI)I", line = 53)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(B[BII)V", line = 64)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!taa", name = "finalize", descriptor = "()V", line = 105)
    protected final void finalize() {
        this.method2307(-1884375310);
        field5236++;
    }

    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 112)
