...
public class class411 extends class389 {
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIZII)V", line = 29)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BLya;II)Z", line = 73)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILya;)Lt;", line = 87)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILya;ILor;IZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 214)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "(B)V", line = 225)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lya;I)Lag;", line = 235)
    ...
    @OriginalMember(owner = "client!v", name = "g", descriptor = "(I)I", line = 271)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Z)V", line = 313)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "(I)Z", line = 330)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lya;Z)V", line = 345)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BLya;Lt;)V", line = 381)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "(B)V", line = 406)
