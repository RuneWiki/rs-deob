...
public class class411 extends class324 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IBIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IB)V", line = 88)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 101)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ltt;)V", line = 135)
    public class411(class78 arg0) {
        this.field6254 = arg0;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)V", line = 144)
