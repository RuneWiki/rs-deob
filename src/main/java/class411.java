...
public class class411 extends class260 {
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lor;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lfca;)V")
