...
public class class411 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIZIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILfga;I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(B)Lmha;", line = 110)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BI)Z", line = 123)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Llea;)V", line = 147)
