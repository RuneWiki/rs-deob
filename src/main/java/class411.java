...
public class class411 extends class439 {
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 23)
    public class411() {
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 26)
