...
public class class411 extends class428 {
    ...
    @OriginalMember(owner = "client!lka", name = "b", descriptor = "(Z)Lnq;", line = 5)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(Lln;BI)V", line = 22)
    ...
    @OriginalMember(owner = "client!lka", name = "<init>", descriptor = "(Ltia;Lgda;)V", line = 226)
    ...
    @OriginalMember(owner = "client!lka", name = "f", descriptor = "(I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(ZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!lka", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(III)V", line = 149)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(Z)V", line = 160)
    ...
    @OriginalMember(owner = "client!lka", name = "a", descriptor = "(IZ)V", line = 196)
    ...
    @OriginalMember(owner = "client!lka", name = "h", descriptor = "(I)V", line = 211)
