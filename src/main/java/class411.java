...
public class class411 extends Canvas {
    ...
    @OriginalMember(owner = "client!jm", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        field5896++;
        this.field5889.update(arg0);
    }

    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    public class411(Component arg0) {
        this.field5889 = arg0;
    }

    @OriginalMember(owner = "client!jm", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
