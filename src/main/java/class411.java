...
public abstract class class411 extends class24 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(FFFFFFLta;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!iu", name = "ZA", descriptor = "()I", line = 26)
    public final int method154() {
        return this.field6245;
    }

    @OriginalMember(owner = "client!iu", name = "ha", descriptor = "(IIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!iu", name = "Q", descriptor = "()I", line = 48)
    public final int method165() {
        return this.field6245 + this.field6235 + this.field6229;
    }

    @OriginalMember(owner = "client!iu", name = "YA", descriptor = "()I", line = 51)
    public final int method157() {
        return this.field6238;
    }

    @OriginalMember(owner = "client!iu", name = "H", descriptor = "(FFFFFFIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!iu", name = "RA", descriptor = "()I", line = 162)
    public final int method147() {
        return this.field6243 + this.field6238 + this.field6217;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(FFFFFF)V", line = 178)
    ...
    @OriginalMember(owner = "client!iu", name = "la", descriptor = "(IIIIIII)V", line = 321)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lsr;II)V", line = 364)
