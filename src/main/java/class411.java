...
public class class411 extends class115 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([IZ[III)J", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "c", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lsm;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIB)Z", line = 70)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)Ldc;", line = 81)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 151)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(II)V", line = 190)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lcs;ILb;Lya;)V", line = 210)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIZILya;Llc;IILfb;)Lt;", line = 367)
