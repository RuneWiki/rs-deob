...
public class class411 extends class37 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZLrr;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "()Ldm;", line = 74)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III[ILrr;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILid;IIIIIIIIII)Z", line = 177)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BI)Z", line = 613)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "([III)V", line = 631)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 674)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "()I", line = 711)
    public final int method238() {
        field6018++;
        return 0;
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIZIIII)V", line = 720)
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "()Ldm;", line = 773)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lsf;)V", line = 815)
