...
public class class411 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ICI)I", line = 6)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 21)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjava/lang/String;B[Lo;)I", line = 35)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjava/lang/String;I[Lo;)Ljava/lang/String;", line = 65)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLjava/lang/String;[Lo;)I", line = 192)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BILjava/lang/String;[Lo;)I", line = 295)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/String;Z[Ljava/lang/String;[Lo;[I)I", line = 325)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/String;I[Lo;II)I", line = 572)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)I", line = 594)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "([B)V", line = 605)
