...
public class class411 extends class404 implements class147 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Loa;B)Lac;")
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(IIIIILti;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILoa;)Lwc;")
