...
public class class411 extends class349 {
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "()Lai;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Ltj;J[Ljq;[Lti;Z)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Ltj;[Ljq;Z)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Ltj;J)Z")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "([Lti;Z)V")
