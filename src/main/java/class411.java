...
public class class411 extends class502 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BLod;)I")
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(ILeka;)V")
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Leka;)V")
