...
public class class411 extends class30 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Ljg;II)V", line = 211)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)V", line = 260)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "()V", line = 538)
    public class411() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Ljava/lang/String;BC)I", line = 511)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(B)V", line = 547)
    ...
    @OriginalMember(owner = "client!hg", name = "g", descriptor = "(I)V", line = 563)
