...
public class class411 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILkf;ZLkf;IZB)I", line = 155)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z)V", line = 191)
