...
public abstract class class411 implements class209 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ZB)V", line = 51)
    ...
    @OriginalMember(owner = "client!wl", name = "c", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lbi;I)V", line = 138)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lni;Lni;Lfq;)V", line = 217)
