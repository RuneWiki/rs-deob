...
public class class411 extends class187 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Llh;ILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Ltq;Z)Loq;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)Lmr;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lfm;")
