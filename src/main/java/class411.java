...
public class class411 extends class251 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Llt;ZDILvl;II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IZILlt;Lvl;I)[F", line = 149)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 258)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lvl;ILlt;)Z", line = 276)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(III)Z", line = 335)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 346)
    public class411() {
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lha;)V", line = 361)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILvl;ZIZBLlt;D)[I", line = 453)
