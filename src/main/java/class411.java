...
public class class411 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILkh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZIII)I", line = 25)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lkh;II)V", line = 146)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IBIILmj;BII)Lmj;", line = 303)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)Lks;", line = 363)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIBILmj;)Lmj;", line = 384)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 505)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIII)I", line = 543)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 572)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I[I[III)V", line = 594)
