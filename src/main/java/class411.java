...
public class class411 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lnm;[Lnr;)Ldu;", line = 5)
    ...
    @OriginalMember(owner = "client!du", name = "finalize", descriptor = "()V", line = 63)
    protected final void finalize() throws Throwable {
        this.field5942.method1675(this.field5940);
        super.finalize();
    }

    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Lnm;I[Lnr;)V", line = 74)
