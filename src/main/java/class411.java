...
public class class411 extends class461 implements class388 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 8)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ldca;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lega;IZ[[I)V", line = 28)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 79)
