...
public class class779 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lr;III[Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ob", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ob", name = "e", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Ldm;I)V", line = 134)
