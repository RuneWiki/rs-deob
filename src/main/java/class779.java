...
public abstract class class779 implements class515 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IBLjava/awt/Component;Llu;I)Llv;", line = 138)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Lgj;Lgj;Ldl;)V", line = 226)
