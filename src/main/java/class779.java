...
public class class779 extends class568 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I[[ZIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILjava/lang/String;)V", line = 245)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(II)Z", line = 351)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(SZ)V", line = 363)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lvf;Ldl;Lih;[I)V", line = 386)
