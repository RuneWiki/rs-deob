...
public class class779 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IB)Llea;", line = 32)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(ILcb;Lcb;)V", line = 74)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIBI)V", line = 96)
