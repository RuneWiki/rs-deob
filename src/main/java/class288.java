...
public class class288 extends class329 {
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(B)V", line = 3)
    public static void method1719(byte arg0) {
        field3881 = null;
        int var1 = -78 % ((arg0 - -50) / 59);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IF)V", line = 12)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(IIIIIF)V", line = 23)
    public class288(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)I", line = 49)
