...
public class class288 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lgk;B)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ltm;IJ)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(JI)Ltm;")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lok;I)V")
