...
public class class288 {
    ...
    @OriginalMember(owner = "client!ww", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4127++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(II)V", line = 45)
