...
public class class288 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lbt;I)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILbt;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILwm;Lur;ZIII)V")
