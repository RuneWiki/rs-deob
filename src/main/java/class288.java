...
public class class288 extends class396 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lbm;ILra;)Z")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIZLbm;Lra;)[F")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(DIILbm;BZLra;)[I")
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lbk;)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(DIBIZLbm;Lra;Z)[I")
