...
public class class288 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILsha;Lha;)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLqp;)V")
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)Lts;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lqp;II)V")
