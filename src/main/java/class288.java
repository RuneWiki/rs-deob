...
public class class288 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B[Lqf;)I")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)Lqf;")
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)Lqf;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lqf;JI)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(JB)Lqf;")
    ...
    @OriginalMember(owner = "client!va", name = "d", descriptor = "(I)Lqf;")
