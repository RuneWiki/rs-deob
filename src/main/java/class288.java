...
public class class288 extends class673 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IZZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(IIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Leka;IZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lwm;Lwm;Lbp;)V", line = 95)
    public class288(class30 arg0, class30 arg1, class167 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!il", name = "b", descriptor = "(B)V", line = 98)
