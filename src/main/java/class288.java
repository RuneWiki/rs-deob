...
public class class288 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lvs;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)I", line = 23)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)Lvs;", line = 44)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)Lvs;", line = 64)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)Lvs;", line = 88)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZZ)Z", line = 108)
    public static boolean method1679(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILvs;)V", line = 120)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)Lvs;", line = 137)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 190)
    public class288() {
        this.field3604.field8692 = this.field3604;
        this.field3604.field8698 = this.field3604;
    }

    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)V", line = 162)
