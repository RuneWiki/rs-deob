...
public class class288 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I[BIIBLht;IZ)Lcq;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lmv;Lqa;Z)I")
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Ljo;II)V")
