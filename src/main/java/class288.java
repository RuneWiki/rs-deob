...
public class class288 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI)I", line = 13)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IJLwa;)V", line = 41)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)Lwa;", line = 64)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IJ)Lwa;", line = 112)
