...
public class class288 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lgj;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)Lgj;", line = 21)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)Lgj;", line = 43)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 89)
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(I)Lgj;", line = 122)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILna;)Z", line = 148)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(III)I", line = 178)
    ...
    @OriginalMember(owner = "client!wp", name = "d", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(B)I", line = 204)
    ...
    @OriginalMember(owner = "client!wp", name = "e", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!wp", name = "f", descriptor = "(I)Lgj;", line = 255)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 279)
    public class288() {
