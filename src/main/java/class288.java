...
public class class288 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lgw;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)Lha;", line = 28)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)I", line = 57)
    public static int method1845(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)Lha;", line = 67)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "()V", line = 88)
    public class288() {
    }

    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lgw;)V", line = 90)
