...
public class class288 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)Lnt;")
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(II)Lhca;")
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lnq;ILga;Lga;Lga;)V")
