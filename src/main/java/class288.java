...
public class class288 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I[[[BIBII)V", line = 82)
