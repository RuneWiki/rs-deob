...
public class class288 extends class116 implements class438 {
    ...
    @OriginalMember(owner = "client!ca", name = "P", descriptor = "(IIIIII)V", line = 7)
    public final void method662(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ca", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILpa;II)V", line = 18)
    public final void method663(int arg0, int arg1, class593 arg2, int arg3, int arg4) {
        this.method1825(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ca", name = "BA", descriptor = "(III)V", line = 29)
    public final void method666(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(La;Lc;[I[BIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 36)
