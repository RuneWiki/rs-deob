...
public class class288 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lwm;Z)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(III)Z", line = 38)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Ljq;BJ)V", line = 53)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZJ)Ljq;", line = 122)
