...
public class class288 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lka;IIIBI)Lka;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IBIIILka;II)Lka;")
