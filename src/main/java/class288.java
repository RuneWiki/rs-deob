...
public class class288 implements class212 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)Lkf;")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lrd;Lkf;Z)V")
