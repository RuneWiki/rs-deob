...
public abstract class class288 extends class393 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BI)V", line = 121)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZZI)V", line = 153)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(IIII)V", line = 182)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(II)I", line = 212)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIIIII)V", line = 223)
