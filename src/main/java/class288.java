...
public class class288 extends class145 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lap;BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 165)
    public class288() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qm", name = "e", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!qm", name = "f", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II)[I", line = 202)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IB)Lqi;", line = 340)
