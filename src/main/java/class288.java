...
public class class288 extends class349 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Z)J", line = 5)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ZJ)I", line = 15)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)J", line = 50)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 117)
    public class288() {
        this.field4012 = System.nanoTime();
        this.field4011 = System.nanoTime();
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)J", line = 99)
