...
public class class288 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!vea", name = "toString", descriptor = "()Ljava/lang/String;", line = 45)
    public final String toString() {
        field4229++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(I)V", line = 69)
