...
public class class288 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)Z", line = 36)
