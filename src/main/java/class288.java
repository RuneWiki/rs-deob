...
public class class288 extends class119 {
    ...
    @OriginalMember(owner = "client!nn", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lug;IIZ[[I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BII)Z", line = 49)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lug;IIZ[[BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lug;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BIIII)V", line = 136)
