...
public class class288 extends class30 {
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(II)Lel;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lri;IIIII)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljg;II)V")
