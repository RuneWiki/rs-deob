...
public class class288 {
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(III)I", line = 464)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "([IZ[Ljava/lang/String;)V", line = 481)
    ...
    @OriginalMember(owner = "client!tja", name = "toString", descriptor = "()Ljava/lang/String;", line = 492)
    public final String toString() {
        field4237++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tja", name = "<init>", descriptor = "(II)V", line = 509)
