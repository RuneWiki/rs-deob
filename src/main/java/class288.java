...
public class class288 implements class318 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILha;IIIILaj;IBII)V", line = 25)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILos;)V", line = 78)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)Z", line = 103)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lla;Lbba;)V", line = 114)
