...
public abstract class class288 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 4)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IILsd;Lec;IIIBIIII)V", line = 58)
