...
public class class288 extends class633 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(III)Lfj;")
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)Lng;")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lap;IIIIII)V")
