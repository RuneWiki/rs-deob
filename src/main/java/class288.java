...
public class class288 extends class86 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIILeq;IIBII)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lsq;III)J")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lgb;IIIII)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
