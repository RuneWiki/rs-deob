...
public class class288 extends class203 {
    ...
    @OriginalMember(owner = "client!uu", name = "d", descriptor = "(I)J", line = 16)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)Lhda;", line = 35)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lee;Lhaa;IIIIIIIII)V", line = 46)
