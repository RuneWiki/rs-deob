...
public class class288 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jfa", name = "finalize", descriptor = "()V", line = 52)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lai;J[Let;)V", line = 85)
