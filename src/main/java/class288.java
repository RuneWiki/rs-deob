...
public class class288 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILjava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(II)Lmk;")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BII)Z")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IIZ)V")
