...
public class class288 extends class391 implements class517 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lvo;I)Lvo;", line = 6)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILlga;IZII)V", line = 23)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(Z)Z", line = 57)
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IB)Z", line = 84)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 113)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Ldga;Lon;Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)Lon;", line = 145)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(I)I", line = 156)
