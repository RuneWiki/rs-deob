...
public class class288 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IC)V", line = 28)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lbv;I)V", line = 57)
    public class288(class282 arg0, int arg1) {
        this.field4291 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIILlf;)V", line = 72)
