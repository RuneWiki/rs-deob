...
public class class288 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLcd;)V", line = 23)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IB)Z", line = 83)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(IB)Lfk;", line = 115)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(IB)V", line = 152)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 207)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lad;ILdk;Ldk;)V", line = 262)
