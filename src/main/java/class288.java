...
public class class288 extends class354 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IB)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(BI)[I", line = 98)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lnj;II)V", line = 143)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 190)
    public class288() {
        super(1, false);
    }
}
