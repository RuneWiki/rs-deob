...
public class class288 extends class85 implements class401 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIIBIIIII[[[BLqa;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!hp", name = "finalize", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "([[BLbi;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!hp", name = "f", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lgk;III)V", line = 209)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lgk;IIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIZ)V", line = 191)
