...
public class class288 extends class241 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Z)V", line = 132)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lnq;ILja;)V", line = 153)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(II[I[I)V", line = 169)
