...
public class class288 extends class362 {
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(Lfca;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!tja", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!tja", name = "<init>", descriptor = "()V", line = 114)
    public class288() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(BIII[[IILjava/util/Random;)V", line = 127)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(II)[I", line = 349)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(I[[I)V", line = 619)
