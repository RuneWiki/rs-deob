...
public class class465 extends class757 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ILgfa;ILjk;IILcj;ILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IF)V", line = 45)
    ...
    @OriginalMember(owner = "client!ng", name = "f", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(IIIIIF)V", line = 70)
    public class465(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IBII)V", line = 74)
