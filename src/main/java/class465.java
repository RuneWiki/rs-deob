...
public abstract class class465 extends class189 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z)I", line = 5)
    public final int method2772(boolean arg0) {
        field6587++;
        return arg0 ? 60 : this.field6592;
    }

    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(Z)I", line = 16)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IBI)Z", line = 65)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(I)I", line = 78)
    public final int method2777(int arg0) {
        field6588++;
        return arg0 == -1 ? this.field6590 : 43;
    }

    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "()V", line = 99)
    public static final void method2779() {
        class427.method2602(1, class634.field8744);
    }

    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(I)F", line = 102)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(IIIIIF)V", line = 117)
