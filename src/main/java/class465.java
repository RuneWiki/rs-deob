...
public class class465 extends class223 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lba;III[Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Luu;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(IIIIIZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ZIIILbn;I)V", line = 106)
