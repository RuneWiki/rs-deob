...
public class class465 extends class57 {
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(Z)C", line = 4)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Z)I", line = 20)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILnk;IIFFIFFFZI[B)V", line = 42)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(B)[Lao;", line = 64)
    ...
    @OriginalMember(owner = "client!rs", name = "d", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(I)J", line = 116)
