...
public class class465 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZ)[B", line = 27)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILha;IIBIILjava/lang/String;)V", line = 109)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZIB[BI)Z", line = 155)
    ...
    @OriginalMember(owner = "client!bg", name = "toString", descriptor = "()Ljava/lang/String;", line = 278)
    public final String toString() {
        field6440++;
        return "Cache:" + this.field6434;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIILoi;II)V", line = 286)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(ILofa;Lofa;I)V", line = 354)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZII[B)Z", line = 316)
