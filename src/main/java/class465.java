...
public class class465 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILkp;J)V", line = 3)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)Lkp;", line = 30)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(JZ)Lkp;", line = 42)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)Lkp;", line = 115)
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!lb", name = "d", descriptor = "(I)I", line = 164)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Z[Lkp;)I", line = 193)
    ...
    @OriginalMember(owner = "client!lb", name = "e", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Z)Lkp;", line = 257)
