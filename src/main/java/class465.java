...
public class class465 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIIZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)V", line = 296)
