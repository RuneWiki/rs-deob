...
public class class465 extends class263 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ZZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BLrr;)V", line = 49)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(I[B)V", line = 93)
