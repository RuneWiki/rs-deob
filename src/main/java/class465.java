...
public class class465 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lrt;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIBI)V", line = 26)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BLrt;I)V", line = 58)
