...
public class class465 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)Z", line = 12)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lum;)V", line = 40)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)Z", line = 96)
