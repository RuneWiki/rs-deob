...
public class class465 implements class96 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lgj;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)J", line = 53)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZII)V", line = 103)
