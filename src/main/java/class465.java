...
public class class465 extends class354 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IBIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!lc", name = "h", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "()V", line = 58)
    public class465() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(BI)[I", line = 61)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(III)Z", line = 141)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lnj;II)V", line = 152)
