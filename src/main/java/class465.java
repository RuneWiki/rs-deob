...
public class class465 extends class449 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lvc;Lnl;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!on", name = "d", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(IIIIIZ)V", line = 49)
