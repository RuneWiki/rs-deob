...
public class class465 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)Lpg;")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IJ)Lpg;")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lpg;IJ)V")
