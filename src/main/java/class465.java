...
public class class465 extends class287 {
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I[III)Z", line = 39)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 203)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I[IBI)Z", line = 118)
    ...
    @OriginalMember(owner = "client!rg", name = "f", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIII[I)Z", line = 157)
