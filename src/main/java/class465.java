...
public class class465 extends class694 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IBLbt;)Lub;", line = 4)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "()V", line = 28)
    public class465() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILjr;B)V", line = 37)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II)[I", line = 81)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(II)[[I", line = 131)
