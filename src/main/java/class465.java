...
public class class465 extends class188 implements class281 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IZBLha;)Lbt;")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(ILha;)Llca;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lha;II)Lka;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lha;I)V")
    public final void method990(class58 arg0, int arg1) {
        int var3 = 1 % ((-2 - arg1) / 62);
        ++field6652;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZLha;Lrr;IIII)V")
    ...
    @OriginalMember(owner = "client!cq", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IILha;I)Z")
