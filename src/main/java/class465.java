...
public class class465 extends class54 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILjava/awt/Canvas;II)Lor;", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(BI)Lnf;", line = 25)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(Z)I", line = 64)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(IB)I", line = 75)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(ILhia;)V", line = 131)
    public class465(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(Z)I", line = 137)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lhia;)V", line = 148)
