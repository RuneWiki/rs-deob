...
public abstract class class465 extends class383 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Lsp;IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hfa", name = "d", descriptor = "(B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I[Leq;)I", line = 32)
    ...
    @OriginalMember(owner = "client!hfa", name = "k", descriptor = "(I)Lqs;", line = 115)
    ...
    @OriginalMember(owner = "client!hfa", name = "l", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!hfa", name = "f", descriptor = "(I)Z", line = 154)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(IIIIII)V", line = 168)
