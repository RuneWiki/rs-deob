...
public class class465 extends class33 {
    ...
    @OriginalMember(owner = "client!pb", name = "h", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZ)Ltg;", line = 19)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(ILqa;)V", line = 69)
    ...
    @OriginalMember(owner = "client!pb", name = "f", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!pb", name = "finalize", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZBI)V", line = 122)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILqa;B)Lc;", line = 190)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)Z", line = 214)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)V", line = 225)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(IIBII)V", line = 280)
    ...
    @OriginalMember(owner = "client!pb", name = "e", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lqa;Lc;I)V", line = 347)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lqa;II)Z", line = 374)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)V", line = 783)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 798)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lqa;I)Lip;", line = 809)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 845)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lqa;III)Z", line = 867)
