...
public class class465 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBLhp;)V", line = 6)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILhp;)V", line = 42)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 111)
