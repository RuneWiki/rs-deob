...
public class class465 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IBI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)I", line = 18)
    public static final int method2723(int arg0) {
        field6735++;
        return arg0 < 26 ? 14 : 6;
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILjava/lang/String;)V", line = 29)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lhe;ILeq;)V", line = 89)
