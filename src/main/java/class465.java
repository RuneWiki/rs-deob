...
public class class465 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)Lfj;", line = 10)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)I", line = 22)
    public static final int method2646(int arg0, int arg1) {
        field6421++;
        return arg1 == 32896 ? arg0 & 0x3FF : 40;
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(IIII)V", line = 45)
