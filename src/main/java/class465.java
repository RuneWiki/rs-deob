...
public class class465 extends class669 {
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(IIIIIF)V", line = 13)
    public class465(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IBII)V", line = 16)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(III)I", line = 29)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLvaa;[[B)V", line = 62)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IF)V", line = 146)
