...
public class class465 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()V", line = 9)
    public static final void method2710() {
        field6501 = null;
        field6511 = null;
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lqa;Lea;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lqa;)V", line = 108)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "()V", line = 188)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(Lqa;)V", line = 197)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(Lqa;Lea;)Z", line = 257)
    public final boolean method2715(class206 arg0, class465 arg1) {
        return this.field6507 != null || this.method2718(arg0, arg1);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lqa;IIIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "()V", line = 287)
    public final void method2717() {
        this.field6507 = null;
    }

    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(Lqa;Lea;)Z", line = 299)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIII)Z", line = 338)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 395)
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(Lqa;Lea;)V", line = 407)
