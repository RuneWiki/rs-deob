...
public class class465 extends class238 {
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILmo;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZI)Z", line = 409)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 424)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)V", line = 459)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lft;)V", line = 794)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)V", line = 503)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(II)I", line = 543)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(II)Z", line = 561)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(II)V", line = 581)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BI)I", line = 597)
    ...
    @OriginalMember(owner = "client!ko", name = "f", descriptor = "(II)I", line = 623)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZ)V", line = 670)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(ZI)V", line = 709)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZLft;)V", line = 722)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 767)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Z)I", line = 883)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(BI)V", line = 945)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(B)I", line = 959)
