...
public class class465 extends class222 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(IIIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(III)V", line = 84)
