...
public class class465 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I[B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lmh;III)V", line = 74)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III[IIBII)V", line = 85)
