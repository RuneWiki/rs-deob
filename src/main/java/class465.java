...
public class class465 implements Runnable {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)Ldq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/lang/String;IZ)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/awt/Frame;I)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IB)Lsq;")
    public final class181 method2640(int arg0, byte arg1) {
        return arg1 > -112 ? null : this.method2653(2, 3, null, arg0, 0);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/awt/Component;IZLjava/awt/Point;[II)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)Lsq;")
    public final class181 method2642(int arg0) {
        return arg0 == 5 ? this.method2653(2, 5, null, 0, 0) : null;
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILjava/lang/String;)Ldq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BLjava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ZZLjava/lang/String;I)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/net/URL;I)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/lang/String;B)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/Class;)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILjava/lang/Object;II)Lsq;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IBIII)Lsq;")
