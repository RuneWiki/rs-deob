...
public class class465 extends class271 implements class599 {
    ...
    @OriginalMember(owner = "client!cc", name = "d", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cc", name = "j", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lr;Ltc;IIIIIZIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)I", line = 79)
    public final int method699(byte arg0) {
        ++field6095;
        return arg0 > -32 ? 79 : 22;
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lr;ZII)Lht;", line = 91)
    ...
    @OriginalMember(owner = "client!cc", name = "f", descriptor = "(I)Z", line = 121)
    public final boolean method161(int arg0) {
        ++field6114;
        return arg0 == 28602;
    }

    @OriginalMember(owner = "client!cc", name = "l", descriptor = "(I)I", line = 133)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Lr;I)Lcu;", line = 158)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZLr;II)Z", line = 176)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lr;I)V", line = 197)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lr;B)V", line = 226)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!cc", name = "i", descriptor = "(I)Z", line = 272)
    public final boolean method166(int arg0) {
        ++field6101;
        return arg0 != 0 ? true : this.field6112;
    }

    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)Z", line = 283)
    ...
    @OriginalMember(owner = "client!cc", name = "n", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!cc", name = "e", descriptor = "(B)Z", line = 309)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLr;)Lqw;", line = 329)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILir;ZILr;IB)V", line = 362)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)I", line = 389)
    public final int method706(int arg0) {
        ++field6108;
        return arg0 != 16259 ? 9 : this.field6105;
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lr;Z)V", line = 401)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lr;IZ)Lda;", line = 411)
