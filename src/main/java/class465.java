...
public class class465 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)Lgp;", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)I", line = 56)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)J", line = 89)
