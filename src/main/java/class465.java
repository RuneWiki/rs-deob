...
public class class465 extends class766 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Laf;I)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BLol;)V")
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lol;)V")
