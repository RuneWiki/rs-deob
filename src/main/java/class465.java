...
public class class465 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Ler;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Ler;Ljaclib/memory/Buffer;)V", line = 21)
