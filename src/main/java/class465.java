...
public class class465 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILge;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)Lrc;", line = 36)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lgn;BIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIILkg;)V", line = 117)
