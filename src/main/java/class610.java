...
public class class610 extends class244 implements class670 {
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Loa;Lbfa;IIIIZIIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILoa;)Lba;", line = 44)
    public final class350 method455(int arg0, int arg1, class635 arg2) {
        ++field8616;
        return arg1 >= -20 ? null : this.method3400(arg2, 15484, arg0);
    }

    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(Loa;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Loa;II)Lba;", line = 70)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILoa;I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!gba", name = "d", descriptor = "(B)Z", line = 111)
    public final boolean method449(byte arg0) {
        ++field8626;
        return arg0 != -126 ? true : this.field8631;
    }

    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Loa;B)V", line = 125)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(Loa;I)Lok;", line = 152)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(B)I", line = 176)
    ...
    @OriginalMember(owner = "client!gba", name = "g", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(I)Z", line = 197)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(B)I", line = 212)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Loa;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 253)
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(B)I", line = 285)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZBLoa;)Lau;", line = 299)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILoa;)Lgr;", line = 343)
    ...
    @OriginalMember(owner = "client!gba", name = "d", descriptor = "(I)V", line = 356)
