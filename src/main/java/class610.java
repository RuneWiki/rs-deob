...
public class class610 extends class219 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILd;Lcb;ZDIZI)[I")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILd;ZIILcb;)[F")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZLkj;ZLjava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIIDLd;ZLcb;)[I")
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lrv;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lcb;Ld;I)Z")
