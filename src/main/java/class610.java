...
public class class610 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ICI)C", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIIIIB)V", line = 100)
