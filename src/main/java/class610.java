...
public class class610 extends class38 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILrg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "()V", line = 68)
    public class610() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(B)V", line = 74)
    public static void method3538(byte arg0) {
        int var1 = -41 / ((72 - arg0) / 50);
        field8625 = null;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BI)[I", line = 105)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lvt;I)V", line = 176)
