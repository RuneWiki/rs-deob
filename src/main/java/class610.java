...
public class class610 extends class585 {
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "e", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lso;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 106)
    public class610() {
        this(4096);
    }
}
