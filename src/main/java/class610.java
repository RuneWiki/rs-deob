...
public class class610 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IILha;IIII)V")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Lhk;IIIILaa;Lmj;I)V")
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(Lha;Lwq;I)V")
