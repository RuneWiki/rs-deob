...
public class class610 extends class607 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZB)V", line = 41)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IBLiu;)V", line = 217)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lrca;Lkea;)V", line = 226)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(B)Z", line = 247)
    public final boolean method814(byte arg0) {
        return arg0 == -97 ? this.field8887 : false;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(III)V", line = 257)
