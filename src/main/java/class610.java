...
public class class610 extends class74 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ht", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Llm;Lpl;Lbd;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IILhfa;)V", line = 72)
    ...
    @OriginalMember(owner = "client!ht", name = "f", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ht", name = "g", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)V", line = 112)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIB)V", line = 165)
