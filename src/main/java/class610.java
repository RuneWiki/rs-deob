...
public class class610 implements class673 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IIIZFI)[I", line = 485)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(II)Lqf;", line = 501)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ZIIIZF)[F", line = 512)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(FIIIIZ)[I", line = 523)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Z)I", line = 535)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)Z", line = 547)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BI)Loq;", line = 561)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(I)V", line = 587)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llga;Llga;Llga;)V", line = 608)
