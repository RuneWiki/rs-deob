...
public class class610 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIF)F", line = 4)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Los;Lir;)V", line = 10)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(F)F", line = 76)
    private static final float method3507(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!dw", name = "a", descriptor = "()V", line = 82)
    public static void method3508() {
        field8856 = null;
        field8853 = null;
    }

    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(IIF)F", line = 102)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IF)I", line = 110)
