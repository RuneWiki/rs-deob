...
public class class610 extends class220 {
    ...
    @OriginalMember(owner = "client!qp", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIII)[B", line = 16)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIILjava/lang/Class;)Ltg;", line = 32)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "()V", line = 56)
    public class610() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BIB)V", line = 62)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIIIIIII)V", line = 80)
