...
public class class610 implements class285 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLhaa;[[B)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lwia;Lsa;B)Ltia;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)Lvaa;")
