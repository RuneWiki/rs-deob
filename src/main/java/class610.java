...
public class class610 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IZ)Lqfa;", line = 25)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 96)
