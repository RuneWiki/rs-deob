...
public class class610 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ZLje;)Z")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)Laaa;")
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Luca;Lfa;)V")
