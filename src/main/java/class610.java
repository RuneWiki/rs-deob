...
public class class610 extends class69 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(BII)V", line = 98)
