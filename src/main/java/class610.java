...
public class class610 {
    ...
    @OriginalMember(owner = "client!em", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field8444++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(I)V", line = 19)
    public class610(int arg0) {
        this.field8447 = arg0;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)V", line = 31)
