...
public class class610 extends class638 implements class324 {
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(BLha;)V", line = 15)
    ...
    @OriginalMember(owner = "client!eb", name = "h", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIZLha;)Lmg;", line = 36)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!eb", name = "g", descriptor = "(I)I", line = 85)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLha;)Lqs;", line = 97)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILjw;Lha;BIZI)V", line = 157)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLbm;)Z", line = 190)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(I)Z", line = 219)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIILha;)Z", line = 230)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lha;Z)V", line = 255)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(B)Z", line = 293)
    ...
    @OriginalMember(owner = "client!eb", name = "j", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZIIIIIIZ)V", line = 324)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lha;I)V", line = 357)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)I", line = 383)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)I", line = 395)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZLha;I)Lka;", line = 406)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)I", line = 425)
    ...
    @OriginalMember(owner = "client!eb", name = "g", descriptor = "(B)Z", line = 436)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(BLha;)Lro;", line = 451)
