...
public class class610 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)Z", line = 21)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(Z)I", line = 32)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lqa;Lco;IIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!lu", name = "toString", descriptor = "()Ljava/lang/String;", line = 142)
    public final String toString() {
        field9048++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(II)V", line = 155)
