...
public class class55 extends class180 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IZZI)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(III)I", line = 149)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IB)V", line = 163)
    public void method398(int arg0, byte arg1) {
        this.field769[arg0] = arg1;
        field772++;
    }

    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(IIIIIFFF)V", line = 171)
