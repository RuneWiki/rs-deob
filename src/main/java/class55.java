...
public class class55 extends class24 {
    ...
    @OriginalMember(owner = "client!PDMJJHOP", name = "<init>", descriptor = "(LMJLXHQTQ;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!PDMJJHOP", name = "a", descriptor = "(ILVSJQVIFL;II)V")
