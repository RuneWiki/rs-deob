...
public class class55 implements Runnable {
    ...
    @OriginalMember(owner = "client!QLBHZVFC", name = "f", descriptor = "LBTXFPMEV;")
    ...
    @OriginalMember(owner = "client!QLBHZVFC", name = "<init>", descriptor = "(LBTXFPMEV;ILjava/net/Socket;)V")
