...
public class class55 extends class324 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIII[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 37)
    public static void method408(int arg0) {
        field635 = null;
        int var1 = -17 / ((arg0 - 38) / 62);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IB)Z", line = 48)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(III)Z", line = 62)
