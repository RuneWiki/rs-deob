...
public abstract class class55 implements class90 {
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(B)V", line = 22)
    public static void method601(byte arg0) {
        field870 = null;
        int var1 = -119 % ((arg0 - 47) / 63);
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZILjaggl/MapBuffer;)Ljaclib/memory/Buffer;", line = 62)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BLjaggl/MapBuffer;)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(I)Ljava/lang/String;", line = 142)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(B)J", line = 164)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lfc;IZ)V", line = 259)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)I", line = 183)
    ...
    @OriginalMember(owner = "client!ms", name = "finalize", descriptor = "()V", line = 194)
    ...
    @OriginalMember(owner = "client!ms", name = "e", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!ms", name = "f", descriptor = "(B)V", line = 271)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILjaclib/memory/Source;)Z", line = 285)
