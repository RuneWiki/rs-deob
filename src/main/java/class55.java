...
@OriginalClass("client!TGIKVGNH")
public class class55 {

    @OriginalMember(owner = "client!TGIKVGNH", name = "a", descriptor = "Z")
    private boolean field1364 = true;

    @OriginalMember(owner = "client!TGIKVGNH", name = "g", descriptor = "I")
    public int field1370 = -1;

    @OriginalMember(owner = "client!TGIKVGNH", name = "i", descriptor = "[I")
    public int[] field1372 = new int[6];

    @OriginalMember(owner = "client!TGIKVGNH", name = "j", descriptor = "[I")
    public int[] field1373 = new int[6];

    @OriginalMember(owner = "client!TGIKVGNH", name = "k", descriptor = "I")
    public int field1374 = 128;

    @OriginalMember(owner = "client!TGIKVGNH", name = "l", descriptor = "I")
    public int field1375 = 128;

    @OriginalMember(owner = "client!TGIKVGNH", name = "b", descriptor = "I")
    private static int field1365 = 868;

    @OriginalMember(owner = "client!TGIKVGNH", name = "p", descriptor = "LDSMCVRKW;")
    public static class15 field1379 = new class15((byte) 7, 30);

    @OriginalMember(owner = "client!TGIKVGNH", name = "c", descriptor = "I")
    public static int field1366;

    @OriginalMember(owner = "client!TGIKVGNH", name = "e", descriptor = "I")
    public int field1368;

    @OriginalMember(owner = "client!TGIKVGNH", name = "f", descriptor = "I")
    public int field1369;

    @OriginalMember(owner = "client!TGIKVGNH", name = "m", descriptor = "I")
    public int field1376;

    @OriginalMember(owner = "client!TGIKVGNH", name = "n", descriptor = "I")
    public int field1377;

    @OriginalMember(owner = "client!TGIKVGNH", name = "o", descriptor = "I")
    public int field1378;

    @OriginalMember(owner = "client!TGIKVGNH", name = "h", descriptor = "LODMBIHRM;")
    public class41 field1371;

    @OriginalMember(owner = "client!TGIKVGNH", name = "d", descriptor = "[LTGIKVGNH;")
    public static class55[] field1367;

    @OriginalMember(owner = "client!TGIKVGNH", name = "a", descriptor = "(ILBBMKAXRK;)V")
    ...
    @OriginalMember(owner = "client!TGIKVGNH", name = "a", descriptor = "(LEILHLJCE;B)V")
    ...
    @OriginalMember(owner = "client!TGIKVGNH", name = "a", descriptor = "()LKBEXSZSN;")
