...
public class class55 extends class295 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BLap;)V", line = 34)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILap;)V", line = 57)
    ...
    @OriginalMember(owner = "client!va", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!va", name = "f", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!va", name = "e", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BII)I", line = 196)
