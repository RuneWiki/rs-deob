...
@OriginalClass("client!SNGXEJOJ")
public class class55 {

    @OriginalMember(owner = "client!SNGXEJOJ", name = "c", descriptor = "I")
    private int field1420 = 734;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "h", descriptor = "I")
    public int field1425 = -1;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "j", descriptor = "[I")
    public int[] field1427 = new int[6];

    @OriginalMember(owner = "client!SNGXEJOJ", name = "k", descriptor = "[I")
    public int[] field1428 = new int[6];

    @OriginalMember(owner = "client!SNGXEJOJ", name = "l", descriptor = "I")
    public int field1429 = 128;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "m", descriptor = "I")
    public int field1430 = 128;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "a", descriptor = "I")
    private static int field1418 = 8;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "b", descriptor = "Z")
    private static boolean field1419 = true;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "q", descriptor = "LRUNMBJUO;")
    public static class51 field1434 = new class51(30, false);

    @OriginalMember(owner = "client!SNGXEJOJ", name = "d", descriptor = "I")
    public static int field1421;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "f", descriptor = "I")
    public int field1423;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "g", descriptor = "I")
    public int field1424;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "n", descriptor = "I")
    public int field1431;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "o", descriptor = "I")
    public int field1432;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "p", descriptor = "I")
    public int field1433;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "i", descriptor = "LTLXFHCOO;")
    public class58 field1426;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "e", descriptor = "[LSNGXEJOJ;")
    public static class55[] field1422;

    @OriginalMember(owner = "client!SNGXEJOJ", name = "a", descriptor = "(LFIGUVTWB;Z)V")
    ...
    @OriginalMember(owner = "client!SNGXEJOJ", name = "a", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!SNGXEJOJ", name = "a", descriptor = "()LNJPATAFL;")
