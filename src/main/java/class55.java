...
public class class55 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIII)Ldl;", line = 4)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)Lol;", line = 33)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(IIIIB)V", line = 65)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Ldl;I)V", line = 76)
