...
public class class55 extends class512 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZI)V", line = 45)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(II[I[I)V", line = 79)
