...
public class class55 {
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!gda", name = "d", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "([BZZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIB)Z", line = 98)
