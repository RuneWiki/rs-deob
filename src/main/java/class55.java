...
public class class55 extends class328 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "()V", line = 138)
    public class55() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BILco;)V", line = 26)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)[I", line = 81)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(B)Z", line = 149)
