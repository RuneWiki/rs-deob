...
public abstract class class55 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BLut;ZIIILut;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([II[IIIIIZII)V", line = 76)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZLkaa;IIIZILvb;[ILvb;[ZI)V", line = 174)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZIIIBIILut;[IILut;)V", line = 394)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIBLi;)V", line = 437)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IZLut;[ZILut;Lut;ILut;IIIIBI)V", line = 577)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)I", line = 639)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZLut;I)V", line = 688)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 746)
