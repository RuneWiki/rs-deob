...
public abstract class class55 extends class140 {
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(B)Z", line = 864)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 880)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 893)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Z)V", line = 906)
