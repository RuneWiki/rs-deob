...
public class class55 {
    ...
    @OriginalMember(owner = "client!gda", name = "d", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIIIILfe;)V", line = 27)
    ...
    @OriginalMember(owner = "client!gda", name = "c", descriptor = "(I)V", line = 70)
