...
public abstract class class55 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbba;III[IIILbba;ZII)V", line = 6)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILbba;IIZIILbba;)V", line = 45)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZILdf;ZLdf;I[IZI[ZLna;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[IIZIIII)V", line = 306)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIII)V", line = 404)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)V", line = 450)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILbba;)V", line = 462)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIZIIILi;II)V", line = 514)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZIIIIILbba;[ZLbba;Lbba;IIILbba;I)V", line = 639)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III)Z", line = 705)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 721)
