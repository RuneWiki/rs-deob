...
public class class55 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIIIIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lfa;III)I", line = 217)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lmv;Lsf;Lll;Lqp;Lwf;Llm;Luaa;)V", line = 302)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)Lida;", line = 332)
    public static final class604 method333(int arg0) {
        return (class604) field838.method2002((byte) -124, (long) arg0);
    }

    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(II)Lida;", line = 339)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;IIII)Ldc;", line = 353)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;IIII[S[B)V", line = 365)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;)V", line = 424)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(Lr;IIII)V", line = 436)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "()V", line = 781)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(Lr;)Ldc;", line = 938)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "([B[B[SII)V", line = 949)
    ...
    @OriginalMember(owner = "client!rv", name = "d", descriptor = "()V", line = 1092)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;IIIIIII[S[BZ)V", line = 1102)
    ...
    @OriginalMember(owner = "client!rv", name = "e", descriptor = "()V", line = 1264)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(II)Loga;", line = 1278)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lfa;II)V", line = 1296)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 1305)
    public static final void method347(int arg0) {
        field833 = (class604) field838.method2002((byte) -122, (long) arg0);
    }

    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;Lhi;IIII)V", line = 1308)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lr;Lgk;IIII[I[I)V", line = 1315)
