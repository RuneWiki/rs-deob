...
public class class55 extends class337 {
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III)I", line = 44)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "()V", line = 69)
    public class55() {
    }

    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 71)
