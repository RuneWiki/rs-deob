...
@OriginalClass("client!UXVWESOT")
public class class55 {

    @OriginalMember(owner = "client!UXVWESOT", name = "a", descriptor = "I")
    private static int field1364;

    @OriginalMember(owner = "client!UXVWESOT", name = "e", descriptor = "I")
    public int field1368;

    @OriginalMember(owner = "client!UXVWESOT", name = "g", descriptor = "I")
    public int field1370;

    @OriginalMember(owner = "client!UXVWESOT", name = "f", descriptor = "LAZLXGPCM;")
    public class6 field1369;

    @OriginalMember(owner = "client!UXVWESOT", name = "b", descriptor = "Z")
    private static boolean field1365;

    @OriginalMember(owner = "client!UXVWESOT", name = "c", descriptor = "Z")
    private static boolean field1366;

    @OriginalMember(owner = "client!UXVWESOT", name = "h", descriptor = "[I")
    public int[] field1371;

    @OriginalMember(owner = "client!UXVWESOT", name = "i", descriptor = "[I")
    public int[] field1372;

    @OriginalMember(owner = "client!UXVWESOT", name = "j", descriptor = "[I")
    public int[] field1373;

    @OriginalMember(owner = "client!UXVWESOT", name = "k", descriptor = "[I")
    public int[] field1374;

    @OriginalMember(owner = "client!UXVWESOT", name = "d", descriptor = "[LUXVWESOT;")
    private static class55[] field1367;

    @OriginalMember(owner = "client!UXVWESOT", name = "l", descriptor = "[Z")
    private static boolean[] field1375;

    @OriginalMember(owner = "client!UXVWESOT", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!UXVWESOT", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!UXVWESOT", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!UXVWESOT", name = "a", descriptor = "(ZI)LUXVWESOT;")
    ...
    @OriginalMember(owner = "client!UXVWESOT", name = "b", descriptor = "(ZI)Z")
