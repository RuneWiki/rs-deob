...
public class class55 extends class264 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II)Lvh;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Ljava/awt/Canvas;ZLic;I)Lfp;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lct;ILct;)V")
