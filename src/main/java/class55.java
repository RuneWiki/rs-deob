...
@OriginalClass("client!TKXONZKI")
public class class55 extends class61 {

    @OriginalMember(owner = "client!TKXONZKI", name = "qb", descriptor = "Z")
    private boolean field1394 = false;

    @OriginalMember(owner = "client!TKXONZKI", name = "rb", descriptor = "I")
    private int field1395 = 1;

    @OriginalMember(owner = "client!TKXONZKI", name = "sb", descriptor = "Z")
    private boolean field1396 = false;

    @OriginalMember(owner = "client!TKXONZKI", name = "tb", descriptor = "I")
    private int field1397 = -130;

    @OriginalMember(owner = "client!TKXONZKI", name = "ub", descriptor = "LBXXPAJNW;")
    public class4 field1398;

    @OriginalMember(owner = "client!TKXONZKI", name = "a", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!TKXONZKI", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!TKXONZKI", name = "d", descriptor = "(I)LGFYXEFQY;")
