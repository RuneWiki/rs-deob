...
public class class55 extends class638 implements class141 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lld;)V", line = 7)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(IIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(Z)V", line = 31)
    public final void method387(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "c", descriptor = "()Lq;", line = 34)
    public final class391 method401() {
        return this.field781;
    }

    @OriginalMember(owner = "client!da", name = "HA", descriptor = "()Ljava/lang/Object;", line = 39)
    private final Object method403() {
        return new class337(this);
    }

    @OriginalMember(owner = "client!da", name = "t", descriptor = "()V", line = 44)
    public final void method296() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lmj;[Lkq;Z)Lta;", line = 48)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lq;[Lrc;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!da", name = "D", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!da", name = "r", descriptor = "()Z", line = 134)
    public final boolean method407() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "q", descriptor = "()Z", line = 137)
    public final boolean method408() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 143)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "()Z", line = 153)
    public final boolean method411() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 157)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lkq;Z)Lxa;", line = 167)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(Z)V", line = 240)
    public final void method352(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 244)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(FFF)V", line = 262)
    public final void method322(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IIIIII)V", line = 266)
    ...
    @OriginalMember(owner = "client!da", name = "z", descriptor = "()Z", line = 270)
    public final boolean method417() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 273)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lhfa;)V", line = 289)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIZ)Lxa;", line = 295)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Li;)V", line = 302)
    public final void method421(class37 arg0) {
        this.field764 = (class566) arg0;
        this.method467(arg0);
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Z)V", line = 306)
    public final void method422(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "e", descriptor = "()Z", line = 309)
    public final boolean method423() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "g", descriptor = "()Z", line = 312)
    public final boolean method424() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "f", descriptor = "(I)V", line = 315)
    public final void method382(int arg0) {
        this.field784[arg0].method3379();
    }

    @OriginalMember(owner = "client!da", name = "i", descriptor = "()Z", line = 319)
    public final boolean method297() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "w", descriptor = "()Z", line = 323)
    public final boolean method426() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lhfa;Z)V", line = 327)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "()Lfea;", line = 357)
    public final class127 method340() {
        return new class127(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!da", name = "G", descriptor = "()Lt;", line = 363)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lhn;IIII)Lba;", line = 377)
    ...
    @OriginalMember(owner = "client!da", name = "e", descriptor = "(I)V", line = 380)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(II)I", line = 394)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lka;)V", line = 399)
    public final void method432(class434 arg0) {
    }

    @OriginalMember(owner = "client!da", name = "f", descriptor = "()V", line = 403)
    public final void method358() {
    }

    @OriginalMember(owner = "client!da", name = "y", descriptor = "()V", line = 406)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lba;Lhfa;Lq;Lrc;I)V", line = 416)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIII)V", line = 436)
    ...
    @OriginalMember(owner = "client!da", name = "l", descriptor = "()Z", line = 439)
    public final boolean method436() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "o", descriptor = "()Z", line = 442)
    public final boolean method308() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 446)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)Li;", line = 460)
    ...
    @OriginalMember(owner = "client!da", name = "p", descriptor = "()Z", line = 467)
    public final boolean method440() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIILfa;II)V", line = 470)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)I", line = 475)
    public final int method444(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!da", name = "finalize", descriptor = "()V", line = 479)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(I)V", line = 485)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 499)
    public final void method394(int arg0) {
        this.field784[arg0].method3383();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lq;)V", line = 502)
    public final void method446(class391 arg0) {
        this.field767 = arg0;
        this.method439(arg0);
    }

    @OriginalMember(owner = "client!da", name = "x", descriptor = "()Z", line = 506)
    public final boolean method447() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "g", descriptor = "(I)V", line = 509)
    public final void method448(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lhfa;Lq;[Lrc;I)V", line = 517)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIIII)V", line = 561)
    public final void method384(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIIII)Lxa;", line = 568)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIII)Lka;", line = 604)
    public final class434 method454(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIF)Lld;", line = 610)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 690)
    ...
    @OriginalMember(owner = "client!da", name = "B", descriptor = "()Lq;", line = 617)
    public final class391 method459() {
        return new class560();
    }

    @OriginalMember(owner = "client!da", name = "m", descriptor = "()V", line = 620)
    public final void method460() {
    }

    @OriginalMember(owner = "client!da", name = "u", descriptor = "()Z", line = 623)
    public final boolean method461() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 628)
    ...
    @OriginalMember(owner = "client!da", name = "qa", descriptor = "(S)Z", line = 632)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(S)Z", line = 648)
    ...
    @OriginalMember(owner = "client!da", name = "j", descriptor = "()Z", line = 672)
    public final boolean method385() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "C", descriptor = "()V", line = 674)
    public final void method344() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lka;Lka;FLka;)Lka;", line = 718)
    public final class434 method317(class434 arg0, class434 arg1, float arg2, class434 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[I)Lfa;", line = 722)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "()I", line = 757)
    public final int method473() {
        return 4;
    }

    @OriginalMember(owner = "client!da", name = "s", descriptor = "()V", line = 763)
    ...
    @OriginalMember(owner = "client!da", name = "n", descriptor = "()Z", line = 769)
    public final boolean method476() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "A", descriptor = "()V", line = 789)
    public final void method327() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII)V", line = 791)
    public final void method342(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!da", name = "h", descriptor = "()V", line = 804)
