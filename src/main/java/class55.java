...
public class class55 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;Lbt;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lr;Lfl;Lvq;Lrh;Lki;Lii;Lwl;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)Lvj;")
    public static final class281 method389(int arg0) {
        return (class281) field732.method1528((long) arg0, 71);
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lci;III)I")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)Lwc;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;IIII)Lld;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;II)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(Lwm;)Lld;")
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(Lwm;IIII)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(II)Lvj;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lci;II)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lwm;Ljg;IIII)V")
