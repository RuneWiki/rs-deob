...
public class class55 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lni;IIILni;IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lfh;B)V", line = 75)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZLjava/lang/String;II)V", line = 723)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 738)
