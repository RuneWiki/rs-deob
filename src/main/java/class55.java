...
public class class55 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)J", line = 21)
    public final long method283(int arg0) throws IOException {
        return arg0 == -1 ? this.field560.length() : -33L;
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "([BIIB)I", line = 34)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(JB)V", line = 66)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)Ljava/io/File;", line = 77)
    ...
    @OriginalMember(owner = "client!vk", name = "finalize", descriptor = "()V", line = 88)
