...
public class class55 extends class362 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IB)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "()V", line = 91)
    public class55() {
        super(0, false);
    }

    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lfca;II)V", line = 108)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lha;ILgka;ILbi;I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!wba", name = "f", descriptor = "(I)Z", line = 335)
