...
public class class55 {
    ...
    @OriginalMember(owner = "client!RYVJCVCB", name = "e", descriptor = "LANHDGPPA;")
    ...
    @OriginalMember(owner = "client!RYVJCVCB", name = "c", descriptor = "[LRYVJCVCB;")
    ...
    @OriginalMember(owner = "client!RYVJCVCB", name = "a", descriptor = "(ZI)LRYVJCVCB;")
