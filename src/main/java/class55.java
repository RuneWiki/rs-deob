...
public class class55 extends class129 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(CIIIZLsf;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Llh;Lvn;[Lok;[I[I)V", line = 129)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([B[IIIIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([B[I[IIIIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([B[IIIIIIIIIIILsf;II)V", line = 273)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([B[I[IIIIIIIIIIILsf;II)V", line = 362)
