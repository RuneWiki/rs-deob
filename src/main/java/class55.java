...
public class class55 extends class16 implements Runnable {
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "o", descriptor = "LOCPYCLUF;")
    private class38 field1510 = new class38((byte) 118);

    @OriginalMember(owner = "client!VNVHYJAS", name = "q", descriptor = "LOCPYCLUF;")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "v", descriptor = "LOCPYCLUF;")
    private class38 field1517 = new class38((byte) 118);

    @OriginalMember(owner = "client!VNVHYJAS", name = "A", descriptor = "LOCPYCLUF;")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "E", descriptor = "LOCPYCLUF;")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "K", descriptor = "LYGUBUIIU;")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "w", descriptor = "LZRGWPKYE;")
    private class70 field1518;

    @OriginalMember(owner = "client!VNVHYJAS", name = "O", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "a", descriptor = "(LINOFEYKQ;Lclient;)V")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "a", descriptor = "(LZRGWPKYE;B)V")
    ...
    @OriginalMember(owner = "client!VNVHYJAS", name = "a", descriptor = "()LZRGWPKYE;")
