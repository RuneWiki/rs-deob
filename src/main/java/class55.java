...
public abstract class class55 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILpea;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([ZIBILno;IZZI[ILsda;Lsda;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lpea;IIIILpea;Lpea;ILpea;I[ZIIZI)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIBII[IIZLpea;ILpea;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILi;ZIII)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZIBLpea;IIIILpea;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lpca;ILpca;)V")
