...
public class class55 extends class584 {
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Lha;I)Ljl;", line = 6)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IBZILha;ILig;)V", line = 133)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ZII)V", line = 146)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIZIII)V", line = 244)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lha;II)Z", line = 329)
    ...
    @OriginalMember(owner = "client!am", name = "n", descriptor = "(I)V", line = 607)
    ...
    @OriginalMember(owner = "client!am", name = "o", descriptor = "(I)Z", line = 617)
    ...
    @OriginalMember(owner = "client!am", name = "l", descriptor = "(I)I", line = 631)
    ...
    @OriginalMember(owner = "client!am", name = "p", descriptor = "(I)Z", line = 657)
    private final boolean method372(int arg0) {
        ++field780;
        return arg0 != 0 ? false : this.field771.field139;
    }

    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)Z", line = 674)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)I", line = 688)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIZ)I", line = 710)
    ...
    @OriginalMember(owner = "client!am", name = "h", descriptor = "(I)I", line = 732)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)I", line = 747)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(ILha;)V", line = 768)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B[B)[B", line = 795)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lha;III)Z", line = 810)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Liea;I)V", line = 867)
    ...
    @OriginalMember(owner = "client!am", name = "e", descriptor = "(B)V", line = 881)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(ILha;)Lgp;", line = 892)
