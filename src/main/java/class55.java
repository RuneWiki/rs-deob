...
@OriginalClass("client!TXSWXFHQ")
public class class55 extends class60 implements Runnable {

    @OriginalMember(owner = "client!TXSWXFHQ", name = "b", descriptor = "[[I")
    private int[][] field1474 = new int[4][];

    @OriginalMember(owner = "client!TXSWXFHQ", name = "d", descriptor = "[B")
    private byte[] field1476 = new byte[65000];

    @OriginalMember(owner = "client!TXSWXFHQ", name = "e", descriptor = "Z")
    private boolean field1477 = false;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "f", descriptor = "LILVDIPQT;")
    private class31 field1478 = new class31(-33684);

    @OriginalMember(owner = "client!TXSWXFHQ", name = "g", descriptor = "[[B")
    private byte[][] field1479 = new byte[4][];

    @OriginalMember(owner = "client!TXSWXFHQ", name = "h", descriptor = "LILVDIPQT;")
    private class31 field1480 = new class31(-33684);

    @OriginalMember(owner = "client!TXSWXFHQ", name = "j", descriptor = "LILVDIPQT;")
    private class31 field1482 = new class31(-33684);

    @OriginalMember(owner = "client!TXSWXFHQ", name = "l", descriptor = "[[I")
    private int[][] field1484 = new int[4][];

    @OriginalMember(owner = "client!TXSWXFHQ", name = "m", descriptor = "LEOXICPMP;")
    private class16 field1485 = new class16(true);

    @OriginalMember(owner = "client!TXSWXFHQ", name = "p", descriptor = "B")
    private byte field1488 = 111;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "r", descriptor = "B")
    private byte field1490 = -7;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "t", descriptor = "I")
    private int field1492 = 1;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "w", descriptor = "Z")
    private boolean field1495 = true;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "x", descriptor = "LILVDIPQT;")
    private class31 field1496 = new class31(-33684);

    @OriginalMember(owner = "client!TXSWXFHQ", name = "y", descriptor = "I")
    private int field1497 = 5;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "D", descriptor = "LILVDIPQT;")
    private class31 field1502 = new class31(-33684);

    @OriginalMember(owner = "client!TXSWXFHQ", name = "G", descriptor = "[B")
    private byte[] field1505 = new byte[500];

    @OriginalMember(owner = "client!TXSWXFHQ", name = "K", descriptor = "Ljava/lang/String;")
    public String field1509 = "";

    @OriginalMember(owner = "client!TXSWXFHQ", name = "M", descriptor = "Z")
    private boolean field1511 = true;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "N", descriptor = "I")
    private int field1512 = -838;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "P", descriptor = "Z")
    private boolean field1514 = true;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "R", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1516 = new CRC32();

    @OriginalMember(owner = "client!TXSWXFHQ", name = "k", descriptor = "I")
    private int field1483;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "n", descriptor = "I")
    private int field1486;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "u", descriptor = "I")
    private int field1493;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "v", descriptor = "I")
    private int field1494;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "z", descriptor = "I")
    private int field1498;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "A", descriptor = "I")
    private int field1499;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "C", descriptor = "I")
    public int field1501;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "H", descriptor = "I")
    private int field1506;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "I", descriptor = "I")
    private int field1507;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "J", descriptor = "I")
    public int field1508;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "L", descriptor = "I")
    private int field1510;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "O", descriptor = "I")
    private int field1513;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "B", descriptor = "J")
    private long field1500;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "c", descriptor = "LEWBEDHEW;")
    private class18 field1475;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "E", descriptor = "Lclient;")
    private client field1503;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "i", descriptor = "Ljava/io/InputStream;")
    private InputStream field1481;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "U", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1519;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "o", descriptor = "Ljava/net/Socket;")
    private Socket field1487;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "[B")
    private byte[] field1473;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "q", descriptor = "[I")
    private int[] field1489;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "s", descriptor = "[I")
    private int[] field1491;

    @OriginalMember(owner = "client!TXSWXFHQ", name = "F", descriptor = "[I")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(BBII)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(BIII)I")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(ZI)I")
    public final int method479(boolean arg0, int arg1) {
        return arg0 ? 3 : this.field1473[arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(LCVNWKEAW;Lclient;)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "b", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "()V")
    public final void method482() {
        this.field1514 = false;
    }

    @OriginalMember(owner = "client!TXSWXFHQ", name = "b", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "b", descriptor = "()LEWBEDHEW;")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "c", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "c", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(I)V")
    public final void method489(int arg0) {
        this.method478(0, arg0);
    }

    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(LEWBEDHEW;Z)V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "a", descriptor = "(I[BII)Z")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "d", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!TXSWXFHQ", name = "c", descriptor = "(I)V")
