...
public class class55 {
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "Llf;")
    public static class109 field1097 = class35.method275("p12_full", 2);

    @OriginalMember(owner = "client!fd", name = "f", descriptor = "Llf;")
    public static class109 field1101 = class35.method275(":duelfriend:", 2);

    @OriginalMember(owner = "client!fd", name = "n", descriptor = "Llf;")
    private static class109 field1109 = class35.method275("Examine", 2);

    @OriginalMember(owner = "client!fd", name = "h", descriptor = "Llf;")
    public static class109 field1103 = field1109;

    @OriginalMember(owner = "client!fd", name = "g", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!fd", name = "e", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "Llf;")
    public class109 field1098;

    @OriginalMember(owner = "client!fd", name = "s", descriptor = "Lnd;")
    public static class125 field1114;

    @OriginalMember(owner = "client!fd", name = "j", descriptor = "Lbg;")
    public static class18 field1105;

    @OriginalMember(owner = "client!fd", name = "l", descriptor = "Lda;")
    public static class32 field1107;

    @OriginalMember(owner = "client!fd", name = "p", descriptor = "Z")
    public boolean field1111;

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIZI)Lfi;")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II)Lcg;")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IILvg;IB)V")
