...
public class class55 extends class331 {
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(ILts;)V", line = 19)
    public class55(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIB)V", line = 38)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(II)I", line = 88)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lts;)V", line = 101)
    public class55(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(B)I", line = 116)
