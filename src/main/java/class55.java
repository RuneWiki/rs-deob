...
public class class55 extends class604 implements class675 {
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(ZLha;)Lrs;", line = 14)
    ...
    @OriginalMember(owner = "client!lu", name = "d", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lao;Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(Z)I", line = 82)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!lu", name = "h", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(B)I", line = 120)
    ...
    @OriginalMember(owner = "client!lu", name = "d", descriptor = "(Z)Z", line = 131)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lha;III)Z", line = 146)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILha;)V", line = 169)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZIIIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!lu", name = "g", descriptor = "(I)Z", line = 198)
    ...
    @OriginalMember(owner = "client!lu", name = "e", descriptor = "(Z)Z", line = 209)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "()V", line = 221)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Z)I", line = 304)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IBILrfa;ZILha;)V", line = 315)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(I)I", line = 326)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lha;I)V", line = 340)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lha;B)Lsba;", line = 361)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(Lha;I)V", line = 374)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ZLha;)V", line = 395)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)Z", line = 408)
