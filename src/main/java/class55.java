...
public class class55 {
    ...
    @OriginalMember(owner = "client!UECXVCCS", name = "d", descriptor = "LDRKSBDQX;")
    private class10 field1545 = new class10();

    @OriginalMember(owner = "client!UECXVCCS", name = "h", descriptor = "LZLISRGEK;")
    ...
    @OriginalMember(owner = "client!UECXVCCS", name = "g", descriptor = "LOYARMXQN;")
    ...
    @OriginalMember(owner = "client!UECXVCCS", name = "a", descriptor = "(J)LDRKSBDQX;")
    ...
    @OriginalMember(owner = "client!UECXVCCS", name = "a", descriptor = "(LDRKSBDQX;IJ)V")
