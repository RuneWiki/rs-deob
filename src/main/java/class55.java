...
public class class55 extends class235 {
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)Lhfa;")
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lpc;I)V")
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(FLhfa;Lhfa;I)Z")
