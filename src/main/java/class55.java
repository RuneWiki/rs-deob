...
public class class55 {
    ...
    @OriginalMember(owner = "client!kl", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field658++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZILef;IB[BII)Ltq;", line = 31)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(IIII)V", line = 55)
