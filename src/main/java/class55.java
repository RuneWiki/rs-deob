...
public class class55 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Lir;IIIII)V")
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Lio;IZ)V")
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ZILr;I)Lf;")
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Lio;Z)V")
