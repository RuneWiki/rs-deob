...
public class class55 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II)[I", line = 72)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(III)V", line = 184)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IZII)I", line = 143)
