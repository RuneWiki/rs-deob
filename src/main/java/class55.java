...
public class class55 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILza;)Z", line = 28)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lsv;B)V", line = 441)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 464)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIB)V", line = 557)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILe;IIIIBB)Le;", line = 582)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 656)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)I", line = 692)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 695)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lsv;II)V", line = 718)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIIILe;)Le;", line = 890)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IBZI)I", line = 1051)
