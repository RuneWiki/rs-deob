...
public class class55 extends class478 {
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lih;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lih;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lih;II)V")
