...
public class class55 extends class171 {
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "([Llm;)V", line = 67)
