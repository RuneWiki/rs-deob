...
@OriginalClass("client!WFTRMPWZ")
public class class55 {

    @OriginalMember(owner = "client!WFTRMPWZ", name = "c", descriptor = "I")
    private int field1486 = 10280;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "i", descriptor = "[LEBTORROD;")
    private class15[] field1492 = new class15[10];

    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "I")
    private static int field1484 = -302;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "d", descriptor = "I")
    private static int field1487 = 777;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "e", descriptor = "[LWFTRMPWZ;")
    private static class55[] field1488 = new class55[5000];

    @OriginalMember(owner = "client!WFTRMPWZ", name = "f", descriptor = "[I")
    public static int[] field1489 = new int[5000];

    @OriginalMember(owner = "client!WFTRMPWZ", name = "b", descriptor = "I")
    private static int field1485;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "j", descriptor = "I")
    private int field1493;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "k", descriptor = "I")
    private int field1494;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "h", descriptor = "LZOMNSJJM;")
    private static class69 field1491;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "g", descriptor = "[B")
    private static byte[] field1490;

    @OriginalMember(owner = "client!WFTRMPWZ", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "(LZOMNSJJM;I)V")
    ...
    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "(IBI)LZOMNSJJM;")
    ...
    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "(LZOMNSJJM;B)V")
    ...
    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "(II)LZOMNSJJM;")
    ...
    @OriginalMember(owner = "client!WFTRMPWZ", name = "a", descriptor = "(I)I")
