...
@OriginalClass("client!SYUGXMZF")
public class class55 {

    @OriginalMember(owner = "client!SYUGXMZF", name = "a", descriptor = "I")
    private int field1446 = 531;

    @OriginalMember(owner = "client!SYUGXMZF", name = "b", descriptor = "I")
    private int field1447 = 531;

    @OriginalMember(owner = "client!SYUGXMZF", name = "c", descriptor = "I")
    private int field1448 = 23626;

    @OriginalMember(owner = "client!SYUGXMZF", name = "e", descriptor = "I")
    public int field1450;

    @OriginalMember(owner = "client!SYUGXMZF", name = "j", descriptor = "Z")
    private boolean field1455;

    @OriginalMember(owner = "client!SYUGXMZF", name = "d", descriptor = "[B")
    public byte[] field1449;

    @OriginalMember(owner = "client!SYUGXMZF", name = "f", descriptor = "[I")
    public int[] field1451;

    @OriginalMember(owner = "client!SYUGXMZF", name = "g", descriptor = "[I")
    public int[] field1452;

    @OriginalMember(owner = "client!SYUGXMZF", name = "h", descriptor = "[I")
    public int[] field1453;

    @OriginalMember(owner = "client!SYUGXMZF", name = "i", descriptor = "[I")
    public int[] field1454;

    @OriginalMember(owner = "client!SYUGXMZF", name = "<init>", descriptor = "([BB)V")
    ...
    @OriginalMember(owner = "client!SYUGXMZF", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!SYUGXMZF", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
