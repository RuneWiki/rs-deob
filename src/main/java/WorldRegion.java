...
@OriginalClass("CDEJWOSB")
public class WorldRegion {

    @OriginalMember(owner = "CDEJWOSB", name = "a", descriptor = "I")
    private static int _flowObfuscator1 = -12499;

    @OriginalMember(owner = "CDEJWOSB", name = "b", descriptor = "I")
    private static int _flowObfuscator2 = -192;

    @OriginalMember(owner = "CDEJWOSB", name = "a", descriptor = "(IIIZ)I")
    ...
    @OriginalMember(owner = "CDEJWOSB", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "CDEJWOSB", name = "a", descriptor = "(IIIBII)I")
    ...
    @OriginalMember(owner = "CDEJWOSB", name = "a", descriptor = "(IIIIII)I")
