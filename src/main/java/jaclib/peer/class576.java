...
public class class576 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/pe", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pe", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 26)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pe", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 52)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pe", name = "b", descriptor = "(I)V", line = 70)
    public final void method3359(int arg0) {
        int var2 = -68 % ((-arg0 - 47) / 34);
        this.method3356(-88);
    }

    @OriginalMember(owner = "client!jaclib/peer/pe", name = "c", descriptor = "(I)V", line = 78)
