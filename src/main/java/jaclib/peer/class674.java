...
public class class674 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/gca", name = "a", descriptor = "(ZLjaclib/peer/PeerReference;)V", line = 6)
    ...
    @OriginalMember(owner = "client!jaclib/peer/gca", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V", line = 23)
    ...
    @OriginalMember(owner = "client!jaclib/peer/gca", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!jaclib/peer/gca", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!jaclib/peer/gca", name = "b", descriptor = "(I)V", line = 81)
