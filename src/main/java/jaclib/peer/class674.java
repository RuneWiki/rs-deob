...
public class class674 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/qr", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qr", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qr", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qr", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qr", name = "c", descriptor = "(I)V", line = 86)
