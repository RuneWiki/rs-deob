...
public class class674 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/uca", name = "a", descriptor = "(I)V", line = 6)
    public final void method3752(int arg0) {
        this.method3753((byte) -71);
        int var2 = -23 % ((-arg0) / 36);
    }

    @OriginalMember(owner = "client!jaclib/peer/uca", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!jaclib/peer/uca", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!jaclib/peer/uca", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V", line = 65)
    ...
    @OriginalMember(owner = "client!jaclib/peer/uca", name = "b", descriptor = "(I)V", line = 86)
