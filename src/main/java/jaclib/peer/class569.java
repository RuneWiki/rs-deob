...
public class class569 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/wn", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/wn", name = "a", descriptor = "(ZLjaclib/peer/PeerReference;)V")
