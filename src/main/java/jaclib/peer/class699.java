...
public class class699 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/in", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/in", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
