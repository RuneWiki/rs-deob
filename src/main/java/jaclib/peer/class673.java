...
public class class673 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/hb", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hb", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hb", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hb", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hb", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 73)
