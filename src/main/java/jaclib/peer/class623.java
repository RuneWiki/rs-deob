...
public class class623 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/naa", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/naa", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!jaclib/peer/naa", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!jaclib/peer/naa", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jaclib/peer/naa", name = "c", descriptor = "(I)V", line = 85)
