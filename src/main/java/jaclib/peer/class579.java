...
public class class579 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/of", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/of", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
