...
public class class570 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/pb", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pb", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 20)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pb", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pb", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pb", name = "a", descriptor = "(I)V", line = 83)
