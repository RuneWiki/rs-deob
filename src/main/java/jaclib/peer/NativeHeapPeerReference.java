...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/ii;Ljaclib/peer/of;)V", line = 4)
    public NativeHeapPeerReference(class578 arg0, class579 arg1) {
        super(arg0, arg1);
    }
