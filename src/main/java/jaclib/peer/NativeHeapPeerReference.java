...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/gd;Ljaclib/peer/dj;)V", line = 5)
    public NativeHeapPeerReference(class629 arg0, class630 arg1) {
        super(arg0, arg1);
    }
