...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/pd;Ljaclib/peer/wn;)V", line = 4)
    public NativeHeapPeerReference(class570 arg0, class569 arg1) {
        super(arg0, arg1);
    }
