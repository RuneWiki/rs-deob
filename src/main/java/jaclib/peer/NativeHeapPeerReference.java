...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/md;Ljaclib/peer/mba;)V", line = 5)
    public NativeHeapPeerReference(class702 arg0, class701 arg1) {
        super(arg0, arg1);
    }
