...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/uo;Ljaclib/peer/ep;)V", line = 5)
    public NativeHeapPeerReference(class420 arg0, class421 arg1) {
        super(arg0, arg1);
    }
