...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/nn;Ljaclib/peer/iw;)V", line = 5)
    public NativeHeapPeerReference(class440 arg0, class441 arg1) {
        super(arg0, arg1);
    }
