...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/uca;Ljaclib/peer/wf;)V", line = 4)
    public NativeHeapPeerReference(class670 arg0, class669 arg1) {
        super(arg0, arg1);
    }
