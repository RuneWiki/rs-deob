...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/um;Ljaclib/peer/mk;)V", line = 4)
    public NativeHeapPeerReference(class376 arg0, class375 arg1) {
        super(arg0, arg1);
    }
