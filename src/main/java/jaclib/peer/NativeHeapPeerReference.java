...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/bb;Ljaclib/peer/pb;)V", line = 4)
    public NativeHeapPeerReference(class571 arg0, class570 arg1) {
        super(arg0, arg1);
    }
