...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/kn;Ljaclib/peer/faa;)V", line = 5)
    public NativeHeapPeerReference(class672 arg0, class671 arg1) {
        super(arg0, arg1);
    }
