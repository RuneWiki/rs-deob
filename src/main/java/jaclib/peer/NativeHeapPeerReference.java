...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/fe;Ljaclib/peer/ca;)V", line = 4)
    public NativeHeapPeerReference(class618 arg0, class617 arg1) {
        super(arg0, arg1);
    }
