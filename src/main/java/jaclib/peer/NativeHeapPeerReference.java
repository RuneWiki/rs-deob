...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/ad;Ljaclib/peer/hea;)V", line = 5)
    public NativeHeapPeerReference(class423 arg0, class422 arg1) {
        super(arg0, arg1);
    }
