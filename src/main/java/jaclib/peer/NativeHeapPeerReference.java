...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/qu;Ljaclib/peer/naa;)V", line = 4)
    public NativeHeapPeerReference(class624 arg0, class623 arg1) {
        super(arg0, arg1);
    }
