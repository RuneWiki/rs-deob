...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/mf;Ljaclib/peer/io;)V", line = 4)
    public NativeHeapPeerReference(class407 arg0, class406 arg1) {
        super(arg0, arg1);
    }
