...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/dea;Ljaclib/peer/aaa;)V", line = 4)
    public NativeHeapPeerReference(class339 arg0, class338 arg1) {
        super(arg0, arg1);
    }
