...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/mh;Ljaclib/peer/rh;)V", line = 5)
    public NativeHeapPeerReference(class671 arg0, class670 arg1) {
        super(arg0, arg1);
    }
