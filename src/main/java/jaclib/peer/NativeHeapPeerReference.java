...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/pr;Ljaclib/peer/uca;)V", line = 4)
    public NativeHeapPeerReference(class673 arg0, class674 arg1) {
        super(arg0, arg1);
    }
