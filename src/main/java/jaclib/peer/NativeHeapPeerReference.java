...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/pn;Ljaclib/peer/k;)V", line = 4)
    public NativeHeapPeerReference(class420 arg0, class419 arg1) {
        super(arg0, arg1);
    }
