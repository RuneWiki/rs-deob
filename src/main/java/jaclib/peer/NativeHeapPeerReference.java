...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/gs;Ljaclib/peer/pe;)V", line = 4)
    public NativeHeapPeerReference(class575 arg0, class576 arg1) {
        super(arg0, arg1);
    }
