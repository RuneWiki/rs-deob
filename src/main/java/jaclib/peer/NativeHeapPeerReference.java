...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/dh;Ljaclib/peer/hk;)V", line = 4)
    public NativeHeapPeerReference(class700 arg0, class699 arg1) {
        super(arg0, arg1);
    }
