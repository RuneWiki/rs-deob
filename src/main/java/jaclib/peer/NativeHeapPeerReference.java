...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/jd;Ljaclib/peer/fl;)V", line = 5)
    public NativeHeapPeerReference(class625 arg0, class626 arg1) {
        super(arg0, arg1);
    }
