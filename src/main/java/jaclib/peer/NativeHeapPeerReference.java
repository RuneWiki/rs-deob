...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/ik;Ljaclib/peer/jv;)V", line = 4)
    public NativeHeapPeerReference(class625 arg0, class624 arg1) {
        super(arg0, arg1);
    }
