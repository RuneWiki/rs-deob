...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/rn;Ljaclib/peer/pba;)V", line = 5)
    public NativeHeapPeerReference(class702 arg0, class703 arg1) {
        super(arg0, arg1);
    }
