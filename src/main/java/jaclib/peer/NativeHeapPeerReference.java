...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/ih;Ljaclib/peer/er;)V", line = 4)
    public NativeHeapPeerReference(class421 arg0, class420 arg1) {
        super(arg0, arg1);
    }
