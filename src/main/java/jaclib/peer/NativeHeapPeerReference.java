...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/eb;Ljaclib/peer/ow;)V", line = 5)
    public NativeHeapPeerReference(class620 arg0, class621 arg1) {
        super(arg0, arg1);
    }
