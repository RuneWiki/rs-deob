...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/tk;Ljaclib/peer/cv;)V", line = 5)
    public NativeHeapPeerReference(class586 arg0, class587 arg1) {
        super(arg0, arg1);
    }
