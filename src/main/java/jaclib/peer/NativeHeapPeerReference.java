...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/hm;Ljaclib/peer/bd;)V", line = 5)
    public NativeHeapPeerReference(class701 arg0, class700 arg1) {
        super(arg0, arg1);
    }
