...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/jc;Ljaclib/peer/jd;)V", line = 4)
    public NativeHeapPeerReference(class338 arg0, class339 arg1) {
        super(arg0, arg1);
    }
