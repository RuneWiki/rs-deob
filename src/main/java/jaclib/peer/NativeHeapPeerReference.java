...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/tja;Ljaclib/peer/bw;)V", line = 5)
    public NativeHeapPeerReference(class700 arg0, class701 arg1) {
        super(arg0, arg1);
    }
