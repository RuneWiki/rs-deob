...
public class NativeHeapPeerReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Ljaclib/peer/pa;Ljaclib/peer/am;)V", line = 4)
    public NativeHeapPeerReference(class624 arg0, class625 arg1) {
        super(arg0, arg1);
    }
