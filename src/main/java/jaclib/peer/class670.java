...
public class class670 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/rh", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/rh", name = "b", descriptor = "(Ljaclib/peer/PeerReference;B)V")
