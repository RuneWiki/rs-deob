...
public class class630 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/dj", name = "a", descriptor = "(ZLjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/dj", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V")
