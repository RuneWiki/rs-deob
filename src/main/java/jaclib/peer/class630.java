...
public class class630 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/bea", name = "a", descriptor = "(ZLjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/bea", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
