...
public class class622 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/tc", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/tc", name = "a", descriptor = "(ZLjaclib/peer/PeerReference;)V")
