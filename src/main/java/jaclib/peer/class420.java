...
public class class420 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/er", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/er", name = "b", descriptor = "(Ljaclib/peer/PeerReference;I)V")
