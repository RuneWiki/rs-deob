...
public class class624 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/pi", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pi", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pi", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pi", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!jaclib/peer/pi", name = "a", descriptor = "(I)V", line = 83)
