...
public class class624 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/jv", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jv", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 16)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jv", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jv", name = "c", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jv", name = "b", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 78)
