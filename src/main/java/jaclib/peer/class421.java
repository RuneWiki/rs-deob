...
public class class421 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/ep", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ep", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ep", name = "a", descriptor = "(B)V", line = 47)
    public final void method2580(byte arg0) {
        int var2 = -6 % ((arg0 - 76) / 36);
        this.method2582((byte) -58);
    }

    @OriginalMember(owner = "client!jaclib/peer/ep", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 55)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ep", name = "b", descriptor = "(B)V", line = 78)
