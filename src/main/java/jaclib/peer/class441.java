...
public class class441 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/iw", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/iw", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V")
