...
public class class700 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/bd", name = "a", descriptor = "(Ljaclib/peer/PeerReference;Z)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/bd", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
