...
public class class406 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/io", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jaclib/peer/io", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 21)
    ...
    @OriginalMember(owner = "client!jaclib/peer/io", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!jaclib/peer/io", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!jaclib/peer/io", name = "c", descriptor = "(I)V", line = 80)
