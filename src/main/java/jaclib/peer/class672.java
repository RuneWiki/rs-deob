...
public class class672 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/jaa", name = "a", descriptor = "(B)V", line = 5)
    public final void method3802(byte arg0) {
        this.method3806(-16615);
        int var2 = 110 % ((64 - arg0) / 60);
    }

    @OriginalMember(owner = "client!jaclib/peer/jaa", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jaa", name = "b", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jaa", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!jaclib/peer/jaa", name = "a", descriptor = "(I)V", line = 79)
