...
public class class703 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/pba", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/pba", name = "b", descriptor = "(ILjaclib/peer/PeerReference;)V")
