...
public class class703 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/ge", name = "a", descriptor = "(Ljaclib/peer/PeerReference;Z)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/ge", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
