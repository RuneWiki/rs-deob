...
public class class617 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/ca", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ca", name = "b", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ca", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ca", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ca", name = "b", descriptor = "(B)V", line = 81)
