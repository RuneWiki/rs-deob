...
public class class621 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/ow", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ow", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ow", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ow", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ow", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V", line = 86)
