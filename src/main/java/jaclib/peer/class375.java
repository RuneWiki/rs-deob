...
public class class375 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/dba", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/dba", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jaclib/peer/dba", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!jaclib/peer/dba", name = "b", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!jaclib/peer/dba", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 79)
