...
public class class375 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/mk", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jaclib/peer/mk", name = "b", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jaclib/peer/mk", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!jaclib/peer/mk", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!jaclib/peer/mk", name = "b", descriptor = "(I)V", line = 86)
