...
public class IUnknown extends Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/ow;)V", line = 3)
    protected IUnknown(class621 arg0) {
    ...
    public final long method3454(byte arg0) {
        if (arg0 < 120) {
            this.AddRef();
        }
