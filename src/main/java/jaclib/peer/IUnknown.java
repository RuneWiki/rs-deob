...
public class IUnknown extends Peer {
    ...
    public final long method3435(int arg0) {
        if (arg0 != 6168) {
            this.AddRef();
        }
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/am;)V", line = 14)
    protected IUnknown(class625 arg0) {
