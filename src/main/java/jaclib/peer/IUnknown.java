...
public class IUnknown extends Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "b", descriptor = "(I)J", line = 5)
    public final long method3494(int arg0) {
        return arg0 > -38 ? -86L : super.method2585();
    }

    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/bea;)V", line = 13)
