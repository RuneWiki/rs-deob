...
public class IUnknown extends Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/uca;)V", line = 3)
    ...
    public final long method3757(byte arg0) {
        int var2 = -119 % ((16 - arg0) / 50);
