...
public class IUnknown extends Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "a", descriptor = "(Z)J", line = 6)
    public final long method3973(boolean arg0) {
        return arg0 ? 14L : super.method2973();
    }

    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/in;)V", line = 14)
