...
public class IUnknown extends Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "a", descriptor = "(B)J", line = 5)
    public final long method3883(byte arg0) {
        return arg0 <= 66 ? 100L : super.method2919();
    }

    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/qr;)V", line = 14)
