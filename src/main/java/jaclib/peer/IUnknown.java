...
public class IUnknown extends Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "b", descriptor = "(B)J", line = 6)
    public final long method3809(byte arg0) {
        return arg0 == -36 ? super.method2886() : -22L;
    }

    @OriginalMember(owner = "client!jaclib/peer/IUnknown", name = "<init>", descriptor = "(Ljaclib/peer/gca;)V", line = 14)
