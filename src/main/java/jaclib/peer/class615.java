...
public class class615 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/hr", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hr", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hr", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hr", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!jaclib/peer/hr", name = "b", descriptor = "(BLjaclib/peer/PeerReference;)V", line = 85)
