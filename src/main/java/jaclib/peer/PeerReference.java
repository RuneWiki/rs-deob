...
public abstract class PeerReference extends WeakReference {
    ...
    public PeerReference field8549;

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "Ljaclib/peer/PeerReference;")
    public PeerReference field8550;

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(B)J", line = 7)
    public final long method3438(byte arg0) {
        long var2;
        if (this.peer == 0L) {
            var2 = 0L;
        } else {
        ...
        return arg0 >= -51 ? -44L : var2;
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(I)Z", line = 25)
    ...
    public final void setPeer(long arg0) {
        this.method3438((byte) -102);
        this.peer = arg0;
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/ca;)V", line = 44)
    public PeerReference(Peer arg0, class617 arg1) {
        super(arg0, arg1.field8548);
        arg1.method3434(this, 4220);
    }
