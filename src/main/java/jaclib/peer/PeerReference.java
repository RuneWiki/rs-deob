...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "(I)J", line = 28)
    public final long method3972(int arg0) {
        if (arg0 != 0) {
            this.method3971(-53);
        }
        long var2;
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/in;)V", line = 45)
    public PeerReference(Peer arg0, class699 arg1) {
        super(arg0, arg1.field9887);
        arg1.method3968(14262, this);
    }
