...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(B)J", line = 16)
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/pi;)V", line = 32)
    public PeerReference(Peer arg0, class624 arg1) {
        super(arg0, arg1.field8815);
        arg1.method3638(20054, this);
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(I)Z", line = 42)
