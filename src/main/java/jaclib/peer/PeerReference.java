...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/wl;)V", line = 7)
    public PeerReference(Peer arg0, class336 arg1) {
        super(arg0, arg1.field4887);
        arg1.method2062(-26734, this);
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(B)J", line = 18)
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(Z)Z", line = 35)
