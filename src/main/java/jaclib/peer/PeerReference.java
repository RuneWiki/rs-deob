...
public abstract class PeerReference extends WeakReference {
    ...
    public final void setPeer(long arg0) {
        this.method3177((byte) 125);
        this.peer = arg0;
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/io;)V", line = 13)
    public PeerReference(Peer arg0, class406 arg1) {
        super(arg0, arg1.field5888);
        arg1.method3185(this, -4755);
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(B)J", line = 24)
    public final long method3177(byte arg0) {
        if (arg0 <= 95) {
            return -89L;
        }
        long var2;
