...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/ep;)V", line = 4)
    public PeerReference(Peer arg0, class421 arg1) {
        super(arg0, arg1.field6012);
        arg1.method2581(-10286, this);
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "setPeer", descriptor = "(J)V", line = 14)
    public final void setPeer(long arg0) {
        this.method2574((byte) -94);
        this.peer = arg0;
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(B)Z", line = 25)
    public final boolean method2573(byte arg0) {
        int var2 = -17 / ((45 - arg0) / 43);
        return this.peer != 0L;
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "(B)J", line = 35)
