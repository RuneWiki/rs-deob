...
public abstract class PeerReference extends WeakReference {
    ...
    public final void setPeer(long arg0) {
        this.method3535(30808);
        this.peer = arg0;
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(I)J", line = 14)
    public final long method3535(int arg0) {
        if (arg0 != 30808) {
            this.field8549 = null;
        }
        long var2;
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "(I)Z", line = 36)
    public final boolean method3536(int arg0) {
        if (arg0 != 0) {
            this.peer = 19L;
        }
        return this.peer != 0L;
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/dj;)V", line = 45)
    public PeerReference(Peer arg0, class630 arg1) {
        super(arg0, arg1.field8553);
        arg1.method3540(false, this);
    }
