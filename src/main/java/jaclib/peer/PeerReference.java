...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/ik;)V")
    public PeerReference(Peer arg0, class571 arg1) {
        super(arg0, arg1.field7972);
        arg1.method3216(this, 20378);
    }
    ...
    public final boolean method3214(int arg0) {
        if (arg0 != 18783) {
            this.peer = -75L;
        }
        return this.peer != 0L;
