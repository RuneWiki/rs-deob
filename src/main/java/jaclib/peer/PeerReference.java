...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "a", descriptor = "(I)Z", line = 17)
    public final boolean method3918(int arg0) {
        if (arg0 >= -96) {
            this.setPeer(-40L);
        }
        return this.peer != 0L;
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/mba;)V", line = 26)
    public PeerReference(Peer arg0, class701 arg1) {
        super(arg0, arg1.field9671);
        arg1.method3922(this, (byte) -40);
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "(I)J", line = 35)
    public final long method3919(int arg0) {
        if (arg0 != 0) {
            this.setPeer(28L);
        }
        long var2;
