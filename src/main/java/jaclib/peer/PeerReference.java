...
public abstract class PeerReference extends WeakReference {
    ...
    public final boolean method3304(int arg0) {
        if (arg0 <= 54) {
            this.field7952 = null;
        }
        return this.peer != 0L;
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/fk;)V")
    public PeerReference(Peer arg0, class578 arg1) {
        super(arg0, arg1.field7954);
        arg1.method3310(this, -5239);
    }

    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "(I)J")
    public final long method3305(int arg0) {
        long var2;
