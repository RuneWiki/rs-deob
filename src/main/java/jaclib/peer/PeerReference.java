...
public abstract class PeerReference extends WeakReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Ljaclib/peer/Peer;Ljaclib/peer/hea;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "b", descriptor = "(Z)Z")
