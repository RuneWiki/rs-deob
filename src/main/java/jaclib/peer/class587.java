...
public class class587 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/cv", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/cv", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V")
