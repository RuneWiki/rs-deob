...
public class class671 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/faa", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/faa", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/faa", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/faa", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/faa", name = "b", descriptor = "(Z)V")
