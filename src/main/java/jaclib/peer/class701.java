...
public class class701 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/mba", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/mba", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V")
