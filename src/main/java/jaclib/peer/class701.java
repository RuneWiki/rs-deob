...
public class class701 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/bw", name = "a", descriptor = "(B)V", line = 8)
    public final void method5122(byte arg0) {
        this.method5124(-32045);
        int var2 = 64 / ((74 - arg0) / 35);
    }

    @OriginalMember(owner = "client!jaclib/peer/bw", name = "b", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 17)
    ...
    @OriginalMember(owner = "client!jaclib/peer/bw", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!jaclib/peer/bw", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V", line = 55)
    ...
    @OriginalMember(owner = "client!jaclib/peer/bw", name = "b", descriptor = "(I)V", line = 80)
