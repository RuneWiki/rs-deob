...
public abstract class Peer {
    ...
    public static Class method3594(String arg0) {
        try {
    ...
    static {
        init(field8971 == null ? (field8971 = method3594("jaclib.peer.PeerReference")) : field8971);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(I)Z", line = 9)
    public final boolean method3593(int arg0) {
        if (arg0 != 31665) {
            this.reference = null;
        }
        return this.reference.method3596((byte) 125);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 19)
    protected long method2669() {
        return this.reference.method3595(true);
    }
