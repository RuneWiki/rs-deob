...
public abstract class Peer {
    ...
    protected long method2439() {
        return this.reference.method3459((byte) 100);
    }
    ...
    public static Class method3457(String arg0) {
        try {
    ...
    static {
        init(field8528 == null ? (field8528 = method3457("jaclib.peer.PeerReference")) : field8528);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(Z)Z", line = 19)
    public final boolean method3456(boolean arg0) {
        if (!arg0) {
            this.reference = null;
        }
        return this.reference.method3458((byte) -10);
    }
