...
public abstract class Peer {
    ...
    public final boolean method3210(byte arg0) {
        if (arg0 != 107) {
            this.method3210((byte) 64);
        }
        return this.reference.method3214(18783);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J")
    protected long method2380() {
        return this.reference.method3213(0);
    }

    // $FF: synthetic method
    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
    public static Class method3211(String arg0) {
        try {
    ...
    static {
        init(field7968 == null ? (field7968 = method3211("jaclib.peer.PeerReference")) : field7968);
    }
}
