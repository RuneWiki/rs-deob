...
public abstract class Peer {
    ...
    public static Class method3339(String arg0) {
        try {
    ...
    static {
        init(field8445 == null ? (field8445 = method3339("jaclib.peer.PeerReference")) : field8445);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(I)Z", line = 9)
    public final boolean method3338(int arg0) {
        if (arg0 != -31968) {
            this.reference = null;
        }
        return this.reference.method3346(arg0 + 37178);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 20)
    protected long method2385() {
        return this.reference.method3347((byte) -35);
    }
