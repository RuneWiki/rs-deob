...
public abstract class Peer {
    ...
    public final boolean method2064(byte arg0) {
        if (arg0 != 51) {
            this.reference = null;
        }
        return this.reference.method2068(false);
    }
    ...
    static {
        init(field4888 == null ? (field4888 = method2066("jaclib.peer.PeerReference")) : field4888);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 20)
    protected long method2065() {
        return this.reference.method2067((byte) -128);
    }
