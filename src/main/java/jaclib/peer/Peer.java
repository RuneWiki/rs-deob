...
public abstract class Peer {
    ...
    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(B)Z", line = 10)
    public final boolean method3179(byte arg0) {
        int var2 = 37 % ((23 - arg0) / 51);
        return this.reference.method3178(0);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "<init>", descriptor = "()V", line = 17)
    protected Peer() {
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 21)
