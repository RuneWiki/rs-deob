...
public abstract class Peer {
    ...
    public final boolean method3969(int arg0) {
        if (arg0 != 280) {
            this.reference = null;
        }
        return this.reference.method3971(-72);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 15)
    protected long method2973() {
        return this.reference.method3972(0);
    }

    // $FF: synthetic method
    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 23)
    public static Class method3970(String arg0) {
        try {
    ...
    static {
        init(field9888 == null ? (field9888 = method3970("jaclib.peer.PeerReference")) : field9888);
    }
