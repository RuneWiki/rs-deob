...
public abstract class Peer {
    ...
    public final boolean method3491(int arg0) {
        int var2 = 118 % ((20 - arg0) / 34);
        return this.reference.method3494((byte) 126);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "<init>", descriptor = "()V", line = 13)
    protected Peer() {
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 18)
    protected long method2549() {
        return this.reference.method3493(-94);
    }

    // $FF: synthetic method
    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 24)
    ...
    static {
        init(field8681 == null ? (field8681 = method3492("jaclib.peer.PeerReference")) : field8681);
    }
