...
public abstract class Peer {
    ...
    protected long method3070() {
        return this.reference.method3997(-8405);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(I)Z")
    public final boolean method3994(int arg0) {
        if (arg0 != -16912) {
            this.reference = null;
        }
        return this.reference.method3996(-41);
    }
    ...
    public static Class method3995(String arg0) {
        try {
    ...
    static {
        init(field9896 == null ? (field9896 = method3995("jaclib.peer.PeerReference")) : field9896);
    }
}
