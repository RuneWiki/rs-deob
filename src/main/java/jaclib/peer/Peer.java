...
public abstract class Peer {
    ...
    public final boolean method2565(int arg0) {
        if (arg0 != -14296) {
            this.reference = null;
        }
        return this.reference.method2563((byte) -127);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J")
    protected long method2566() {
        return this.reference.method2564(true);
    }
    ...
    public static Class method2567(String arg0) {
        try {
    ...
    static {
        init(field5834 == null ? (field5834 = method2567("jaclib.peer.PeerReference")) : field5834);
    }
}
