...
public abstract class Peer {
    ...
    public static Class method3493(String arg0) {
        try {
    ...
    static {
        init(field8764 == null ? (field8764 = method3493("jaclib.peer.PeerReference")) : field8764);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "()J", line = 10)
    protected long method2662() {
        return this.reference.method3494(-14186);
    }

    @OriginalMember(owner = "client!jaclib/peer/Peer", name = "a", descriptor = "(I)Z", line = 17)
    public final boolean method3492(int arg0) {
        return arg0 == -16960 ? this.reference.method3495((byte) -50) : true;
    }
