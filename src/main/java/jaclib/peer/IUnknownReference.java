...
public class IUnknownReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Ljaclib/peer/IUnknown;Ljaclib/peer/jaa;)V", line = 5)
    public IUnknownReference(IUnknown arg0, class672 arg1) {
        super(arg0, arg1);
    }
