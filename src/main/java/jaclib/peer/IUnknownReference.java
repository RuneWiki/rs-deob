...
public class IUnknownReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Ljaclib/peer/IUnknown;Ljaclib/peer/k;)V", line = 4)
    public IUnknownReference(IUnknown arg0, class419 arg1) {
        super(arg0, arg1);
    }
