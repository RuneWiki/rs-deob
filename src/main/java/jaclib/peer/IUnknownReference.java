...
public class IUnknownReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Ljaclib/peer/IUnknown;Ljaclib/peer/fk;)V")
    public IUnknownReference(IUnknown arg0, class578 arg1) {
        super(arg0, arg1);
    }
