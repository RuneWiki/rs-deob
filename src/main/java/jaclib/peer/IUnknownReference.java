...
public class IUnknownReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Ljaclib/peer/IUnknown;Ljaclib/peer/qd;)V", line = 4)
    public IUnknownReference(IUnknown arg0, class704 arg1) {
        super(arg0, arg1);
    }
