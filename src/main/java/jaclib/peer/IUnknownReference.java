...
public class IUnknownReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Ljaclib/peer/IUnknown;Ljaclib/peer/jv;)V", line = 4)
    public IUnknownReference(IUnknown arg0, class624 arg1) {
        super(arg0, arg1);
    }
