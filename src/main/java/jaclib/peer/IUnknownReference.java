...
public class IUnknownReference extends PeerReference {
    ...
    @OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Ljaclib/peer/IUnknown;Ljaclib/peer/tc;)V", line = 5)
    public IUnknownReference(IUnknown arg0, class622 arg1) {
        super(arg0, arg1);
    }
