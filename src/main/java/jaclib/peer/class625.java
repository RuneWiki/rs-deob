...
public class class625 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/am", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/am", name = "b", descriptor = "(Ljaclib/peer/PeerReference;B)V")
