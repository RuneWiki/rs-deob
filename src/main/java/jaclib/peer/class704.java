...
public class class704 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/qd", name = "b", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qd", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qd", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qd", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!jaclib/peer/qd", name = "a", descriptor = "(Ljaclib/peer/PeerReference;B)V", line = 79)
