...
public class class360 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/ku", name = "a", descriptor = "(BLjaclib/peer/PeerReference;)V", line = 5)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ku", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ku", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ku", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!jaclib/peer/ku", name = "a", descriptor = "(Ljaclib/peer/PeerReference;I)V", line = 71)
