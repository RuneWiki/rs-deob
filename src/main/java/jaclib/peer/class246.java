...
public class class246 {
    ...
    @OriginalMember(owner = "client!jaclib/peer/vo", name = "a", descriptor = "(ILjaclib/peer/PeerReference;)V")
    ...
    @OriginalMember(owner = "client!jaclib/peer/vo", name = "a", descriptor = "(ZLjaclib/peer/PeerReference;)V")
