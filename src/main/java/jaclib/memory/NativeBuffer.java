...
public class NativeBuffer implements Buffer, Source {
    ...
    private int field6159 = -1;

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "b", descriptor = "J")
    private long field6160;

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 4)
    public void method2587(byte[] arg0, int arg1, int arg2, int arg3) {
        if (arg2 < 0 | arg1 < 0 | this.field6160 == 0L | arg0 == null | arg0.length < (arg1 + arg3) | this.field6159 < (arg2 + arg3)) {
            throw new RuntimeException();
        }
        this.put(this.field6160, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "(JI)V", line = 21)
    protected final void method2588(long arg0, int arg1) {
        this.field6160 = arg0;
        this.field6159 = arg1;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getAddress", descriptor = "()J", line = 30)
    public final long getAddress() {
        return this.field6160;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 37)
