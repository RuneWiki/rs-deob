...
public class NativeBuffer implements Buffer, Source {
    ...
    private int field9267 = -1;

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "b", descriptor = "J")
    private long field9268;

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 6)
    public void method2976(byte[] arg0, int arg1, int arg2, int arg3) {
        if (this.field9267 < (arg2 + arg3) | arg2 < 0 | this.field9268 == 0L | arg0 == null | arg1 < 0 | arg1 + arg3 > arg0.length) {
            throw new RuntimeException();
        }
        this.put(this.field9268, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "(JI)V", line = 17)
    protected final void method3810(long arg0, int arg1) {
        this.field9268 = arg0;
        this.field9267 = arg1;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getAddress", descriptor = "()J", line = 29)
    public final long getAddress() {
        return this.field9268;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 39)
