...
public class NativeBuffer implements Buffer, Source {
    ...
    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 17)
    public final int getSize() {
        return this.field9345;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "(JI)V", line = 24)
    protected final void method3747(long arg0, int arg1) {
        this.field9346 = arg0;
        this.field9345 = arg1;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getAddress", descriptor = "()J", line = 41)
