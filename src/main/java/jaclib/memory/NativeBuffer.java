...
public class NativeBuffer implements Buffer, Source {
    ...
    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 18)
    public final int getSize() {
        return this.field8547;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "(JI)V", line = 28)
    protected final void method3532(long arg0, int arg1) {
        this.field8547 = arg1;
        this.field8546 = arg0;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 37)
    public void method2480(byte[] arg0, int arg1, int arg2, int arg3) {
        if (arg2 < 0 | this.field8546 == 0L | arg0 == null | arg1 < 0 | arg1 + arg3 > arg0.length | this.field8547 < arg2 + arg3) {
            throw new RuntimeException();
        }
        this.put(this.field8546, arg0, arg1, arg2, arg3);
    }
