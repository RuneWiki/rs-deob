...
public class NativeBuffer implements Buffer, Source {
    ...
    private long field9393;

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "(JI)V", line = 5)
    protected final void method3776(long arg0, int arg1) {
        this.field9394 = arg1;
        this.field9393 = arg0;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getAddress", descriptor = "()J", line = 14)
    public final long getAddress() {
        return this.field9393;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 21)
    public final int getSize() {
        return this.field9394;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 30)
    public void method2905(byte[] arg0, int arg1, int arg2, int arg3) {
        if (arg2 + arg3 > this.field9394 | (arg1 + arg3) > arg0.length | arg1 < 0 | this.field9393 == 0L | arg0 == null | arg2 < 0) {
            throw new RuntimeException();
        }
        this.put(this.field9393, arg0, arg1, arg2, arg3);
    }
