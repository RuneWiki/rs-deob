...
public class NativeBuffer implements Buffer, Source {
    ...
    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getAddress", descriptor = "()J", line = 27)
    public final long getAddress() {
        return this.field5272;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 34)
