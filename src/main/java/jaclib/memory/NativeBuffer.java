...
public class NativeBuffer implements Buffer, Source {
    ...
    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getAddress", descriptor = "()J", line = 15)
    public final long getAddress() {
        return this.field8672;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 29)
    public final int getSize() {
        return this.field8671;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 36)
