...
public class NativeBuffer implements Buffer, Source {
    ...
    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "([BIII)V", line = 14)
    public void method2739(byte[] arg0, int arg1, int arg2, int arg3) {
        if (arg1 + arg3 > arg0.length | arg1 < 0 | arg0 == null | this.field9338 == 0L | arg2 < 0 | this.field9339 < arg2 + arg3) {
            throw new RuntimeException();
        }
        this.put(this.field9338, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "getSize", descriptor = "()I", line = 26)
    public final int getSize() {
        return this.field9339;
    }

    @OriginalMember(owner = "client!jaclib/memory/NativeBuffer", name = "a", descriptor = "(JI)V", line = 33)
    protected final void method3796(long arg0, int arg1) {
        this.field9338 = arg0;
        this.field9339 = arg1;
    }
