...
public class NativeHeapBuffer implements Buffer, Source {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeapBuffer", name = "b", descriptor = "()Z", line = 24)
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeapBuffer", name = "getAddress", descriptor = "()J", line = 44)
    public final long getAddress() {
        return this.field10095.getBufferAddress(this.field10096);
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeapBuffer", name = "a", descriptor = "()V", line = 51)
