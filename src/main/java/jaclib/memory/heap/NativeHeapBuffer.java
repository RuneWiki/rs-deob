...
public class NativeHeapBuffer implements Buffer, Source {
    ...
    private boolean field5780 = true;
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeapBuffer", name = "a", descriptor = "()V", line = 20)
    private final synchronized void method2534() {
        if (this.method2535()) {
            this.field5781.deallocateBuffer(this.field5783);
        }
        this.field5780 = false;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeapBuffer", name = "b", descriptor = "()Z", line = 33)
    private final synchronized boolean method2535() {
        return this.field5781.method2533() && this.field5780;
    }
    ...
    public final long getAddress() {
        return this.field5781.getBufferAddress(this.field5783);
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeapBuffer", name = "a", descriptor = "([BIII)V", line = 52)
    public final synchronized void method2529(byte[] arg0, int arg1, int arg2, int arg3) {
        if (arg2 < 0 | !this.method2535() | arg0 == null | arg1 < 0 | arg0.length < arg1 + arg3 | arg2 + arg3 > this.field5782) {
            throw new RuntimeException();
        }
        this.field5781.put(this.field5783, arg0, arg1, arg2, arg3);
    }
}
