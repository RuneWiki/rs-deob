...
public class NativeHeap {
    ...
    public final NativeHeapBuffer method3939(int arg0, boolean arg1) {
        if (!this.field9734) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 16)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method3940();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()V", line = 25)
    public final synchronized void method3940() {
        if (this.field9734) {
            this.deallocateHeap();
        }
        this.field9734 = false;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 40)
    public final synchronized boolean method3941() {
    ...
    public NativeHeap(int arg0) {
        this.field9733 = arg0;
        this.allocateHeap(this.field9733);
        this.field9734 = true;
    }
