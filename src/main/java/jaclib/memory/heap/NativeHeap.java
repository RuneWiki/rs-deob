...
public class NativeHeap {
    ...
    public final synchronized boolean method2622() {
    ...
    public final NativeHeapBuffer method2623(int arg0, boolean arg1) {
        if (!this.field5935) {
    ...
    public NativeHeap(int arg0) {
        this.field5934 = arg0;
        this.allocateHeap(this.field5934);
        this.field5935 = true;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 41)
