...
public class NativeHeap {
    ...
    public synchronized void method94() {
        if (this.field417) {
            this.deallocateHeap();
        }
        this.field417 = false;
