...
public class NativeHeap {
    ...
    public final NativeHeapBuffer method3320(int arg0, boolean arg1) {
        if (!this.field8435) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 17)
    public final synchronized boolean method3321() {
