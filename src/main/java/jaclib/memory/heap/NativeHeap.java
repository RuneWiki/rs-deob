...
public class NativeHeap {
   ...
   public final synchronized boolean method5235() {
   ...
   public final NativeHeapBuffer method5236(int arg0, boolean arg1) {
      if (!this.field10675) {
   ...
   public NativeHeap(int arg0) {
      ...
      this.allocateHeap(this.field10674);
   ...
   public final synchronized void method5237() {
      if (this.field10675) {
         this.deallocateHeap();
      }
