...
public class NativeHeap {
    ...
    public final NativeHeapBuffer method3778(int arg0, boolean arg1) {
        if (!this.field9332) {
    ...
    public final synchronized boolean method3779() {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "<init>", descriptor = "(I)V", line = 36)
    public NativeHeap(int arg0) {
        this.field9331 = arg0;
        this.allocateHeap(this.field9331);
        this.field9332 = true;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 47)
    public final synchronized void method3780() {
        if (this.field9332) {
            this.deallocateHeap();
        }
