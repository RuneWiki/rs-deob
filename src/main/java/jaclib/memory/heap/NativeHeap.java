...
public class NativeHeap {
    ...
    public final NativeHeapBuffer method3468(int arg0, boolean arg1) {
        if (!this.field8753) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 27)
    public final synchronized boolean method3469() {
        return this.field8753;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 34)
    public final synchronized void method3470() {
        if (this.field8753) {
            this.deallocateHeap();
        }
        this.field8753 = false;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "<init>", descriptor = "(I)V", line = 50)
    public NativeHeap(int arg0) {
        this.field8752 = arg0;
        this.allocateHeap(this.field8752);
        this.field8753 = true;
    }
