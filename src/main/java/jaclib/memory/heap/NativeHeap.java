...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 4)
    public final synchronized boolean method3897() {
        return this.field9657;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 14)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method3899();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 24)
    public final NativeHeapBuffer method3898(int arg0, boolean arg1) {
        if (!this.field9657) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 40)
    ...
    public NativeHeap(int arg0) {
        this.field9658 = arg0;
        this.allocateHeap(this.field9658);
        this.field9657 = true;
    }
