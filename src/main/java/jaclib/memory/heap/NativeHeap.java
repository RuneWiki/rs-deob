...
public class NativeHeap {
    ...
    public final synchronized boolean method3776() {
        return this.field9173;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 12)
    public final NativeHeapBuffer method3777(int arg0, boolean arg1) {
        if (!this.field9173) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 23)
    ...
    public final synchronized void method3778() {
        if (this.field9173) {
            this.deallocateHeap();
        }
    ...
    public NativeHeap(int arg0) {
        this.field9174 = arg0;
        this.allocateHeap(this.field9174);
        this.field9173 = true;
    }
