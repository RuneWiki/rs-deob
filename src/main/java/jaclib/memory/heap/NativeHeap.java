...
public class NativeHeap {
    ...
    public final synchronized void method5093() {
        if (this.field10098) {
            this.deallocateHeap();
        }
    ...
    public final synchronized boolean method5094() {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 35)
    public final NativeHeapBuffer method5095(int arg0, boolean arg1) {
        if (!this.field10098) {
    ...
    public NativeHeap(int arg0) {
        ...
        this.allocateHeap(this.field10097);
