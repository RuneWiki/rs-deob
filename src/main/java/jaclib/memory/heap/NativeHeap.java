...
public class NativeHeap {
    ...
    public final synchronized void method3472() {
        if (this.field8673) {
            this.deallocateHeap();
        }
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "<init>", descriptor = "(I)V", line = 31)
    public NativeHeap(int arg0) {
        this.field8672 = arg0;
        this.allocateHeap(this.field8672);
        this.field8673 = true;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 41)
    public final synchronized boolean method3473() {
        return this.field8673;
    }
    ...
    public final NativeHeapBuffer method3474(int arg0, boolean arg1) {
        if (!this.field8673) {
