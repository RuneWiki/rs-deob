...
public class NativeHeap {
   ...
   public final synchronized void method2986() {
      if (this.field5259) {
         this.deallocateHeap();
      }
   ...
   public final NativeHeapBuffer method2987(int arg0, boolean arg1) {
      if (!this.field5259) {
   ...
   public final synchronized boolean method2988() {
   ...
   public NativeHeap(int arg0) {
      this.field5260 = arg0;
      this.allocateHeap(this.field5260);
      this.field5259 = true;
   }
}
