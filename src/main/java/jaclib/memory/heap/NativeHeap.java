...
public class NativeHeap {
    ...
    public final synchronized boolean method2071() {
    ...
    public final synchronized void method2072() {
        if (this.field4895) {
            this.deallocateHeap();
        }
    ...
    public final NativeHeapBuffer method2073(int arg0, boolean arg1) {
        if (!this.field4895) {
    ...
    public NativeHeap(int arg0) {
        this.field4896 = arg0;
        this.allocateHeap(this.field4896);
        this.field4895 = true;
    }
