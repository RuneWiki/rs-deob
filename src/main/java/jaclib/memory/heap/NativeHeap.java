...
public class NativeHeap {
    ...
    private boolean field4374;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "peer", descriptor = "J")
    public long peer;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 6)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method1949();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()V", line = 18)
    public final synchronized void method1949() {
        if (this.field4374) {
            this.deallocateHeap();
        }
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 29)
    public final NativeHeapBuffer method1950(int arg0, boolean arg1) {
        if (!this.field4374) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 41)
    public final synchronized boolean method1951() {
    ...
    public NativeHeap(int arg0) {
        this.field4375 = arg0;
        this.allocateHeap(this.field4375);
        this.field4374 = true;
    }
