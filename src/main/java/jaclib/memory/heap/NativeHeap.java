...
public class NativeHeap {
    ...
    public final synchronized void method3192() {
        if (this.field7957) {
            this.deallocateHeap();
        }
    ...
    public final synchronized boolean method3193() {
    ...
    public final NativeHeapBuffer method3194(int arg0, boolean arg1) {
        if (!this.field7957) {
    ...
    public NativeHeap(int arg0) {
        this.field7958 = arg0;
        this.allocateHeap(this.field7958);
        this.field7957 = true;
    }
