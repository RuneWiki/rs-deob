...
public class NativeHeap {
    ...
    private boolean field6162;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "peer", descriptor = "J")
    public long peer;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 8)
    public final synchronized boolean method2589() {
        return this.field6162;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 28)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method2590();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 37)
    public final NativeHeapBuffer method2591(int arg0, boolean arg1) {
        if (!this.field6162) {
    ...
    public NativeHeap(int arg0) {
        this.field6161 = arg0;
        this.allocateHeap(this.field6161);
        this.field6162 = true;
    }
