...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()V", line = 5)
    public final synchronized void method3427() {
        if (this.field8603) {
            this.deallocateHeap();
        }
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 15)
    public final NativeHeapBuffer method3428(int arg0, boolean arg1) {
        if (!this.field8603) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 38)
    public final synchronized boolean method3429() {
    ...
    public NativeHeap(int arg0) {
        this.field8604 = arg0;
        this.allocateHeap(this.field8604);
        this.field8603 = true;
    }
