...
public class NativeHeap {
   ...
   public final NativeHeapBuffer method5098(int arg0, boolean arg1) {
      if (!this.field10221) {
   ...
   public final synchronized boolean method5099() {
   ...
   public final synchronized void method5100() {
      if (this.field10221) {
         this.deallocateHeap();
      }

      this.field10221 = false;
   }
   ...
   public NativeHeap(int arg0) {
      ...
      this.allocateHeap(this.field10222);
      this.field10221 = true;
   }
