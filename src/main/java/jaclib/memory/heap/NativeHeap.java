...
public class NativeHeap {
    ...
    public final synchronized void method3855() {
        if (this.field9395) {
            this.deallocateHeap();
        }
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 21)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method3855();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 30)
    public final synchronized boolean method3856() {
        return this.field9395;
    }
    ...
    public final NativeHeapBuffer method3857(int arg0, boolean arg1) {
        if (!this.field9395) {
    ...
    public NativeHeap(int arg0) {
        this.field9394 = arg0;
        this.allocateHeap(this.field9394);
        this.field9395 = true;
    }
