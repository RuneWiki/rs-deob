...
public class NativeHeap {
    ...
    public final NativeHeapBuffer method3781(int arg0, boolean arg1) {
        if (!this.field9425) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 23)
    public final synchronized boolean method3782() {
        return this.field9425;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 31)
    public final synchronized void method3783() {
        if (this.field9425) {
            this.deallocateHeap();
        }
    ...
    public NativeHeap(int arg0) {
        this.field9424 = arg0;
        this.allocateHeap(this.field9424);
        this.field9425 = true;
    }
