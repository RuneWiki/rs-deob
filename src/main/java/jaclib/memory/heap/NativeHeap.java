...
public class NativeHeap {
    ...
    public final synchronized void method3615() {
        if (this.field8803) {
            this.deallocateHeap();
        }
        this.field8803 = false;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 17)
    public final synchronized boolean method3616() {
        return this.field8803;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "<init>", descriptor = "(I)V", line = 29)
    public NativeHeap(int arg0) {
        this.field8802 = arg0;
        this.allocateHeap(this.field8802);
        this.field8803 = true;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 41)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method3615();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 49)
    public final NativeHeapBuffer method3617(int arg0, boolean arg1) {
        if (!this.field8803) {
