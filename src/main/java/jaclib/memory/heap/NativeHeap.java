...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 10)
    public final NativeHeapBuffer method2568(int arg0, boolean arg1) {
        if (!this.field6002) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()V", line = 23)
    public final synchronized void method2569() {
        if (this.field6002) {
            this.deallocateHeap();
        }
        this.field6002 = false;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 35)
    ...
    public NativeHeap(int arg0) {
        this.field6001 = arg0;
        this.allocateHeap(this.field6001);
        this.field6002 = true;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 52)
    public final synchronized boolean method2570() {
