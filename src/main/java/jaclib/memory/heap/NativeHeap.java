...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 6)
    public final NativeHeapBuffer method3758(int arg0, boolean arg1) {
        if (!this.field9387) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()V", line = 26)
    public final synchronized void method3759() {
        if (this.field9387) {
            this.deallocateHeap();
        }
        this.field9387 = false;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "<init>", descriptor = "(I)V", line = 43)
    public NativeHeap(int arg0) {
        this.field9386 = arg0;
        this.allocateHeap(this.field9386);
        this.field9387 = true;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()Z", line = 53)
    public final synchronized boolean method3760() {
