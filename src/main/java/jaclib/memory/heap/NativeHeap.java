...
public class NativeHeap {
    ...
    private boolean field8537;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "peer", descriptor = "J")
    public long peer;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 7)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method3414();
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 19)
    public final synchronized boolean method3412() {
        return this.field8537;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 26)
    public final NativeHeapBuffer method3413(int arg0, boolean arg1) {
        if (!this.field8537) {
    ...
    public final synchronized void method3414() {
        if (this.field8537) {
            this.deallocateHeap();
        }
    ...
    public NativeHeap(int arg0) {
        this.field8536 = arg0;
        this.allocateHeap(this.field8536);
        this.field8537 = true;
    }
