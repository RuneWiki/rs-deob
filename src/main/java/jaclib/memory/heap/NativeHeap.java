...
public class NativeHeap {
    ...
    private boolean field5892;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "peer", descriptor = "J")
    public long peer;

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 5)
    public final synchronized void method3188() {
        if (this.field5892) {
            this.deallocateHeap();
        }
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "(IZ)Ljaclib/memory/heap/NativeHeapBuffer;", line = 17)
    public final NativeHeapBuffer method3189(int arg0, boolean arg1) {
        if (!this.field5892) {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 30)
    public final synchronized boolean method3190() {
        return this.field5892;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "finalize", descriptor = "()V", line = 42)
    ...
    public NativeHeap(int arg0) {
        this.field5891 = arg0;
        this.allocateHeap(this.field5891);
        this.field5892 = true;
    }
