...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "a", descriptor = "()Z", line = 15)
    public final synchronized boolean method3514() {
        return this.field8539;
    }

    @OriginalMember(owner = "client!jaclib/memory/heap/NativeHeap", name = "b", descriptor = "()V", line = 22)
    public final synchronized void method3515() {
        if (this.field8539) {
            this.deallocateHeap();
        }
        this.field8539 = false;
    }
    ...
    public final NativeHeapBuffer method3516(int arg0, boolean arg1) {
        if (!this.field8539) {
    ...
    public NativeHeap(int arg0) {
        this.field8540 = arg0;
        this.allocateHeap(this.field8540);
        this.field8539 = true;
    }
