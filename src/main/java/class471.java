...
public class class471 extends class235 {
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lpc;IIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)Lhfa;", line = 45)
