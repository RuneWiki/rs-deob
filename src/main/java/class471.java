...
public class class471 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lfi;I)V")
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)Lfi;")
    ...
    @OriginalMember(owner = "client!uj", name = "d", descriptor = "(I)Lfi;")
