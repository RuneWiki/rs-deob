...
public abstract class class471 extends class467 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIJI)V", line = 4)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(I)F", line = 137)
    ...
    @OriginalMember(owner = "client!dd", name = "d", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[Ljava/lang/Object;[I)V", line = 164)
    ...
    @OriginalMember(owner = "client!dd", name = "e", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!dd", name = "f", descriptor = "(I)I", line = 199)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IF)F", line = 213)
    ...
    @OriginalMember(owner = "client!dd", name = "g", descriptor = "(I)I", line = 226)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)I", line = 237)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(IIIIIF)V", line = 248)
