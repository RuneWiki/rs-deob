...
public class class471 {
    ...
    @OriginalMember(owner = "client!lba", name = "i", descriptor = "Lus;")
    public static class1 field6648 = new class1();

    @OriginalMember(owner = "client!lba", name = "w", descriptor = "[I")
    public static int[] field6662 = new int[1000];

    @OriginalMember(owner = "client!lba", name = "g", descriptor = "B")
    public byte field6646;
    ...
    @OriginalMember(owner = "client!lba", name = "r", descriptor = "B")
    public byte field6657;

    @OriginalMember(owner = "client!lba", name = "u", descriptor = "B")
    ...
    @OriginalMember(owner = "client!lba", name = "t", descriptor = "Liaa;")
    public static class423 field6659;

    @OriginalMember(owner = "client!lba", name = "c", descriptor = "S")
    public short field6642;
    ...
    public boolean field6655;

    @OriginalMember(owner = "client!lba", name = "s", descriptor = "Z")
    public boolean field6658;

    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 29)
    public static void method2841(int arg0) {
        field6662 = null;
        int var1 = 66 / ((19 - arg0) / 54);
        field6659 = null;
        field6648 = null;
    }
}
