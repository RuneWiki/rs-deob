...
public class class471 extends class73 {
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(BLza;)V", line = 16)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(III[IIBII)V", line = 28)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([BIIBILjava/lang/String;)I", line = 137)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(BLza;)Luc;", line = 275)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILza;BI)Z", line = 317)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIBILer;Lir;ILlr;)V", line = 368)
