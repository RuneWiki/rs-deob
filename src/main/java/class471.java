...
public abstract class class471 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IZLjava/awt/Component;)Ljn;", line = 10)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIZIILpt;Lpt;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIILta;III)V", line = 54)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I[IIIIZI[III)V", line = 187)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IILpt;)V", line = 297)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIIIIII)V", line = 343)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lgr;[ZLnk;IZIILgr;ZII[I)V", line = 371)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILpt;[IZIIIILpt;II)V", line = 581)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)V", line = 622)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IILpt;ZIIILpt;Lpt;I[ZLpt;III)V", line = 645)
