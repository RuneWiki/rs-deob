...
public class class471 extends class313 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILgn;)V", line = 81)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(II[I[I)V", line = 142)
