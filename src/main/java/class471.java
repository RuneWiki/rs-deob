...
public class class471 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)Lhf;", line = 3)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)Ldv;", line = 30)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILjt;BILwq;IILcl;)V", line = 45)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(II)V", line = 143)
    public class471(int arg0, int arg1) {
        this.field6813 = arg1;
        this.field6804 = arg0;
    }

    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Ldv;I)V", line = 151)
