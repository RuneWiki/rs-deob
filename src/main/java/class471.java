...
public class class471 extends class131 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Ltp;ILtp;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lln;IIZ)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lln;II[III)V")
