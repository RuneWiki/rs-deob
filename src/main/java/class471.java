...
public class class471 extends class577 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IIIIIIB[Lmea;ZII)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILvn;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lmf;IIIII)V")
