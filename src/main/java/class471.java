...
public class class471 extends class14 {
    ...
    @OriginalMember(owner = "client!t", name = "e", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lwv;I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BLcr;IILqa;)V", line = 32)
    ...
    @OriginalMember(owner = "client!t", name = "f", descriptor = "(I)V", line = 330)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IB[F)[F", line = 344)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BZ)V", line = 361)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "()V", line = 394)
    public class471() {
        super(0, true);
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IB)[I", line = 400)
