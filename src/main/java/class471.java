...
public class class471 extends class349 {
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 19)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "()I", line = 32)
    public final int method2233() {
        return this.field6685 - (this.field6688.available() >> (class147.field2155 ? 2 : 1));
    }

    @OriginalMember(owner = "client!sp", name = "d", descriptor = "()V", line = 43)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 80)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "()V", line = 140)
