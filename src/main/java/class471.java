...
public class class471 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZLqf;I)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(II)Laca;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BI)Lcs;")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lad;Le;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B[[BLfda;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIILkea;)Lor;")
