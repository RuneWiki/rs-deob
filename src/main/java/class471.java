...
public class class471 extends class249 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!qj", name = "h", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Loga;Ljava/lang/Object;I)V", line = 25)
