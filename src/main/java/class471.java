...
public class class471 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 32)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lia;BI)V", line = 92)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILia;)V", line = 224)
