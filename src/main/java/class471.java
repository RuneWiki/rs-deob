...
public class class471 extends class7 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(III)Lcl;", line = 6)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(II)I", line = 14)
    public static int method2773(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Ldia;II[BI)V", line = 35)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(BZ)V", line = 63)
