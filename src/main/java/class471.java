...
public class class471 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(III)Lms;", line = 46)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBIILr;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BZI)V", line = 72)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "()V", line = 351)
    protected class471() {
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lr;Lgk;I)V", line = 365)
