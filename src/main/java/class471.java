...
public class class471 extends class203 {
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(BZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IZLwha;)V", line = 65)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Lpq;)V", line = 86)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IIZ)V", line = 128)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ZB)V", line = 153)
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(I)Z", line = 164)
