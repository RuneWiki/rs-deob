...
public class class471 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IILnb;I)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lrl;III)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lrl;ZLoc;Lqu;Lwh;BILqu;Lcq;Lhq;Lnb;Ldaa;[Lqu;Lha;I[I)Lka;")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lqu;Lnb;ILdaa;Lhq;Lha;Lcq;ZLrl;)Lka;")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IILdaa;Lqu;IILha;ILrl;)Lka;")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "([Lvq;[IZBII[I)V")
