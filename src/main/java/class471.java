...
public class class471 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)Lcca;", line = 8)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lio;BI)V", line = 163)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)Lcca;", line = 253)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)Z", line = 331)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIIIII)V", line = 357)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IB)Z", line = 374)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lio;Z)V", line = 384)
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(I)Z", line = 404)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)V", line = 442)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II[BB)[B", line = 457)
