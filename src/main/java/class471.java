...
public class class471 extends class481 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lza;J)Z", line = 5)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lza;[Lmf;Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "()Lvk;", line = 152)
    public final class334 method2731() {
        return this.field6792;
    }

    @OriginalMember(owner = "client!bv", name = "c", descriptor = "()V", line = 156)
    public final void method2732() {
        this.field6789 = true;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(J)V", line = 159)
    public final void method2733(long arg0) {
        this.field6786 = arg0;
    }

    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!bv", name = "d", descriptor = "()V", line = 172)
    public final void method2735() {
        this.field6795 = true;
    }

    @OriginalMember(owner = "client!bv", name = "e", descriptor = "()V", line = 176)
    public static void method2736() {
        field6781 = null;
        field6787 = null;
    }

    @OriginalMember(owner = "client!bv", name = "f", descriptor = "()V", line = 181)
    private final void method2737() {
        this.field6789 = false;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lza;J[Lmf;[Lqe;Z)V", line = 194)
    ...
    @OriginalMember(owner = "client!bv", name = "g", descriptor = "()V", line = 202)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "([Lqe;Z)V", line = 219)
