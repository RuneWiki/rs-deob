...
public class class471 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BI)Lut;", line = 26)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "([BBIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "([ILgo;BJ)Ljava/lang/String;", line = 127)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(ILic;Lic;Lhn;)V", line = 234)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Ljava/lang/String;Lod;IB)Llv;", line = 174)
