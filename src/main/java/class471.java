...
public class class471 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IILj;I)V")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIILj;)V")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lqg;Lpp;)V")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lj;IZI)Z")
