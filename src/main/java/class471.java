...
public class class471 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(II)I", line = 34)
    public static final int method2727(int arg0, int arg1) {
        return class261.field3858 == null ? 0 : class261.field3858[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Z)V", line = 43)
