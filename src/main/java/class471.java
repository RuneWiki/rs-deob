...
public class class471 extends class478 {
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILnp;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 173)
    public class471() {
        super(1, false);
    }

    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZI)[[I", line = 184)
