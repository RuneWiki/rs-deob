...
public class class471 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)[[[I", line = 6)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(III)V", line = 222)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IFFF)I", line = 91)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZI)[[I", line = 142)
