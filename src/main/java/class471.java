...
public class class471 extends class362 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!qv", name = "d", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "()V", line = 257)
    public class471() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!qv", name = "d", descriptor = "(III)Ldm;", line = 173)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IIIIIII)I", line = 182)
    ...
    @OriginalMember(owner = "client!qv", name = "f", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([III)V", line = 348)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 527)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lfca;II)V", line = 559)
