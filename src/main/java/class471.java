...
public class class471 extends class573 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lvfa;IIIIILaa;ILha;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lwc;IB)V")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lrv;)V")
