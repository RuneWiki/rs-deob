...
public class class471 implements class601 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Llj;Z)V")
