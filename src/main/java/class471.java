...
public class class471 extends class354 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIBIIII)V", line = 77)
