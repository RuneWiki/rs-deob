...
public class class471 implements class749 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLrl;)Z")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)Lmk;")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IIIILeda;)V")
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lni;Ljava/lang/String;)V")
