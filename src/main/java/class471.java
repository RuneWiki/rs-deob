...
public class class471 extends class175 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(CB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 16)
    public class471() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZI)[I", line = 30)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILdt;Z)V", line = 65)
