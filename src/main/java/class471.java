...
public class class471 extends class243 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ZLne;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Ld;IZI)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILne;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIILas;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(ILne;)V")
