...
public abstract class class471 extends class206 {
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(B)F", line = 7)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(B)I", line = 57)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZIIIIIIII)Z", line = 83)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(IIIIIF)V", line = 114)
