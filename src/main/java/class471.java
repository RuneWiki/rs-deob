...
public abstract class class471 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIII[II[IBII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Liaa;IIIZIILiaa;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lee;B)Ltb;", line = 163)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIIILlv;)Z", line = 177)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BLpda;)V", line = 304)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIII[ZLiaa;IIILiaa;IZLiaa;Liaa;)V", line = 337)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILiaa;)V", line = 403)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 448)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BI[Z[IIZIILjv;Lae;Lae;Z)V", line = 470)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILs;IIIIIII)V", line = 688)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)I", line = 808)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZIIBLiaa;IIILiaa;[I)V", line = 988)
