...
public abstract class class471 extends class693 {
    ...
    @OriginalMember(owner = "client!lv", name = "e", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lv", name = "d", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(ZILha;ILrda;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IILmk;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(I)V", line = 904)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I)Lwq;", line = 914)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IC)Z", line = 934)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(ILha;)Z", line = 946)
    ...
    @OriginalMember(owner = "client!lv", name = "d", descriptor = "(I)Z", line = 964)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "([Lih;Z)I", line = 978)
