...
public class class471 extends class86 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!rs", name = "i", descriptor = "(I)[Lfh;", line = 5)
    ...
    @OriginalMember(owner = "client!rs", name = "g", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!rs", name = "h", descriptor = "(I)Lsm;", line = 43)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!rs", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 76)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lqa;BLtf;)V", line = 106)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!rs", name = "e", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!rs", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 161)
    ...
    @OriginalMember(owner = "client!rs", name = "f", descriptor = "(I)Z", line = 191)
    ...
    @OriginalMember(owner = "client!rs", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 203)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field6848++;
        this.method2792(arg0, true);
    }

    @OriginalMember(owner = "client!rs", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 212)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)I", line = 245)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)Z", line = 260)
    ...
    @OriginalMember(owner = "client!rs", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 270)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2792(arg0, true);
        field6831++;
    }

    @OriginalMember(owner = "client!rs", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 278)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 291)
    ...
    @OriginalMember(owner = "client!rs", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 327)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field6843++;
        this.method2792(arg0, true);
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Z)V", line = 335)
    ...
    @OriginalMember(owner = "client!rs", name = "d", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 397)
    public class471(Component arg0, boolean arg1) {
        this.method2795(0, arg0);
        this.field6862 = arg1;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 377)
