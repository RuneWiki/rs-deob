...
public class class764 extends class407 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IBIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "(Lwia;Lwia;Lno;)V", line = 59)
    public class764(class791 arg0, class791 arg1, class730 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!eja", name = "c", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(JJ)J", line = 78)
