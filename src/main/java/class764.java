...
public class class764 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IBIIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IIILjava/lang/Class;)Lar;", line = 21)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(III)I", line = 47)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(BLjava/lang/Throwable;)Ljava/lang/String;", line = 104)
