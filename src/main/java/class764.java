...
public class class764 extends class202 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "()I", line = 7)
    public final int method1418() {
        return 0;
    }

    @OriginalMember(owner = "client!pj", name = "b", descriptor = "([III)V", line = 14)
    ...
    @OriginalMember(owner = "client!pj", name = "d", descriptor = "()Lfja;", line = 59)
    public final class202 method1423() {
        return (class202) this.field10575.method3731((byte) -73);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lfja;)V", line = 63)
    public final synchronized void method4220(class202 arg0) {
        arg0.method4237(-1);
    }

    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(Lfja;)V", line = 68)
    public final synchronized void method4221(class202 arg0) {
        this.field10575.method3725(arg0, (byte) -57);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lit;Ljh;)V", line = 73)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "()Lfja;", line = 93)
    public final class202 method1420() {
        return (class202) this.field10575.method3729((byte) 67);
    }

    @OriginalMember(owner = "client!pj", name = "e", descriptor = "()I", line = 97)
    public final synchronized int method4224() {
        return this.field10575.method3732(256);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljh;)V", line = 100)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "([III)V", line = 168)
    ...
    @OriginalMember(owner = "client!pj", name = "f", descriptor = "()V", line = 183)
