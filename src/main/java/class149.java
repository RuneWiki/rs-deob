...
public class class149 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lmd;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lem;B)Z")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lmd;)V")
