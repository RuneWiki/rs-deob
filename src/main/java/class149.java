...
public class class149 extends class748 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljl;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lvj;B)Lwt;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IZLvj;)V")
