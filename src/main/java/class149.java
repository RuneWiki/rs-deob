...
public class class149 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)Ljava/io/File;", line = 51)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(JI)V", line = 144)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "([[B[II[BI[[BI[I)I", line = 160)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IZI)V", line = 223)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "([BI)V", line = 241)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)V", line = 255)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I[BII)V", line = 268)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IZ)V", line = 455)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Loh;II)V", line = 686)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I[BII)V", line = 502)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lgk;ZZIIILgk;)I", line = 631)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)J", line = 673)
