...
public class class149 extends class109 {
    ...
    @OriginalMember(owner = "client!fn", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fn", name = "c", descriptor = "(III[I)V", line = 21)
    ...
    @OriginalMember(owner = "client!fn", name = "f", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(CI)Z", line = 59)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(III[I)V", line = 136)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "([I)V", line = 146)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lal;)V", line = 162)
    ...
    @OriginalMember(owner = "client!fn", name = "c", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(III)V", line = 215)
    ...
    @OriginalMember(owner = "client!fn", name = "g", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z)Z", line = 243)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(III)V", line = 253)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(Z)V", line = 295)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "()V", line = 307)
    public class149() {
        this.method822();
    }

    @OriginalMember(owner = "client!fn", name = "b", descriptor = "()V", line = 321)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "()Lal;", line = 332)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIIIII)V", line = 354)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(III[I)V", line = 389)
