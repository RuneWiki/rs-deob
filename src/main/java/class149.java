...
public class class149 extends class513 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lfca;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BLfca;)V", line = 54)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(III)I", line = 76)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)V", line = 122)
