...
public class class149 extends class97 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIBLjava/awt/Graphics;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 52)
