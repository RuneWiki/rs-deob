...
public class class149 extends class230 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(IIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIIIILza;I[[[BIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZLla;Ljava/lang/String;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(III)V", line = 138)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(III)V", line = 158)
