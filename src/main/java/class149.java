...
public class class149 extends class167 {
    ...
    @OriginalMember(owner = "client!iq", name = "B", descriptor = "(CIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lgk;Lov;[Lne;Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(CIIIZLea;II)V", line = 231)
