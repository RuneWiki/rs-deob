...
public class class149 extends class86 {
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "()V", line = 22)
    public class149() {
    }

    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 49)
    public class149(String arg0) {
        this.field1930 = arg0;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IB)V", line = 58)
