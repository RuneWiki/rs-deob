...
public class class149 extends class172 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILul;)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lwn;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Z)Lwn;")
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lul;)V")
