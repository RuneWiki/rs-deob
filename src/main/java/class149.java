...
public abstract class class149 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIBIIII)V", line = 67)
