...
public class class149 extends class398 {
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnj;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)[I", line = 90)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 240)
