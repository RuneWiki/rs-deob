...
public class class149 extends class424 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "([Lkk;Lji;B)Lhq;", line = 5)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "()V", line = 73)
    public class149() {
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)I", line = 87)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(J)V", line = 118)
