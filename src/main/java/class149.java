...
public class class149 extends class318 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(IIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "([I)V", line = 38)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IILaa;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Llba;IIZ)V", line = 719)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Llba;II[III)V", line = 734)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 138)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIII)V", line = 193)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)V", line = 223)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "()I", line = 235)
    public final int method736() {
        field1972++;
        return this.field1970 + this.field1951 + this.field1961;
    }

    @OriginalMember(owner = "client!vc", name = "c", descriptor = "()I", line = 244)
    public final int method749() {
        field1960++;
        return this.field1952 + this.field1945 + this.field1974;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "()I", line = 259)
    public final int method738() {
        field1958++;
        return this.field1970;
    }

    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(IIIIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(FFFFFFIIII)V", line = 476)
    ...
    @OriginalMember(owner = "client!vc", name = "d", descriptor = "()I", line = 546)
    public final int method737() {
        field1969++;
        return this.field1952;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIII[III)V", line = 554)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(III)V", line = 570)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(III)V", line = 611)
