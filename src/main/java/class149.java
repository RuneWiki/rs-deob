...
public class class149 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILvs;Lvs;IZ)Lft;")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lza;IILc;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lsn;Lqj;)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILvs;ILvs;)Lft;")
