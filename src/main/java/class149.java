...
public class class149 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(I)V", line = 54)
