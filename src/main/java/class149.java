...
public class class149 extends class98 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 83)
    public class149() {
        super(0, true);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZBLrd;ZLjava/lang/String;)V", line = 101)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILdg;I)V", line = 192)
