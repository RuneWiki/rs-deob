...
public class class149 extends class405 {
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 1168)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IZII[I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III[I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIII)I", line = 131)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BII[I)Z", line = 155)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljava/lang/String;IZZ)V", line = 217)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lsr;ZZ)V", line = 997)
