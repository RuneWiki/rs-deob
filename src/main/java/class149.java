...
public class class149 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(I)I", line = 119)
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BZLqg;)V", line = 203)
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(B)Z", line = 271)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BII[B)Ljava/lang/String;", line = 284)
    ...
    @OriginalMember(owner = "client!uh", name = "f", descriptor = "(I)I", line = 326)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIIIIII)V", line = 340)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(B)V", line = 369)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIZBB)Lcga;", line = 395)
    ...
    @OriginalMember(owner = "client!uh", name = "g", descriptor = "(I)Z", line = 444)
    ...
    @OriginalMember(owner = "client!uh", name = "h", descriptor = "(I)V", line = 717)
