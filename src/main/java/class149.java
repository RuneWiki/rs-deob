...
public class class149 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Luu;II)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILtf;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ltf;Z)Z")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Ltt;)V")
