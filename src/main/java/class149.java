...
public class class149 extends class408 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(III)[B", line = 11)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 17)
    public class149() {
