...
public class class149 {
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IILcu;)V", line = 48)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLcu;)V", line = 69)
