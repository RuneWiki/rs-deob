...
public class class149 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IBZLjava/lang/String;)I", line = 17)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(III)Z", line = 96)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!cda", name = "toString", descriptor = "()Ljava/lang/String;", line = 123)
    public final String toString() {
        field1839++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 143)
