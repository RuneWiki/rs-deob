...
public class class149 extends class85 {
    ...
    @OriginalMember(owner = "client!qa", name = "U", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!qa", name = "cb", descriptor = "Leh;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BILja;)V")
