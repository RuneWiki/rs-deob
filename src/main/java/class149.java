...
public class class149 extends class601 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IZI)Leca;")
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lgn;)V")
