...
public class class149 extends class83 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IILav;)V")
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lvj;Lud;)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIIZILpi;)Ljava/awt/Frame;")
