...
public class class149 extends class377 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIII)I", line = 15)
    ...
    @OriginalMember(owner = "client!hm", name = "i", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IB)[[I", line = 50)
