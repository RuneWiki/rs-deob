...
public class class149 extends class220 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(CIIIZLrn;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(CIIIZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lge;Lbs;[Lhb;Z)V", line = 74)
