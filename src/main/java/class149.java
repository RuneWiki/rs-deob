...
public class class149 extends class448 {
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 4)
    public class149(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)F", line = 7)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILha;)V", line = 23)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(B)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)F", line = 52)
    public final float method1131(int arg0) {
        ++field2325;
        return arg0 != 14615 ? 1.0217617F : this.field2321;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 64)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)Ljava/lang/String;", line = 139)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BI)Z", line = 167)
