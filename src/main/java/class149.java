...
public abstract class class149 extends class410 {
    ...
    @OriginalMember(owner = "client!pda", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ZILmb;Lha;III)V", line = 15)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 26)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I[Lpk;)I", line = 59)
    ...
    @OriginalMember(owner = "client!pda", name = "j", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(ILha;)Z", line = 94)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(IIIIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(B)Z", line = 121)
    ...
    @OriginalMember(owner = "client!pda", name = "i", descriptor = "(I)Z", line = 136)
