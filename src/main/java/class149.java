...
public class class149 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)I", line = 45)
