...
public class class149 extends class62 {
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIBLvp;)V", line = 30)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I[[I)V", line = 44)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lgw;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "()V", line = 172)
    public class149() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IB)[[I", line = 188)
