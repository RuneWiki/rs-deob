...
public class class149 extends class86 {
    ...
    @OriginalMember(owner = "client!dfa", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILda;ZI)Lnu;", line = 19)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(III)Lkg;", line = 37)
