...
public class class149 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(III)Llr;")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lvd;IILvd;)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILdh;[II)Lbn;")
