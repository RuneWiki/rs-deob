...
public class class149 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)Lfa;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lqq;ILpb;)I")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lfa;I)V")
