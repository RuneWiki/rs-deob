...
public class class149 extends class644 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIB)[B", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BBI)V", line = 16)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 37)
    public class149() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(B)V", line = 56)
