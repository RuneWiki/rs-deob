...
public class class149 extends class275 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BBI)V", line = 29)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!qb", name = "e", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I[FI)[F", line = 157)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(IIIIIF)V", line = 175)
    ...
    @OriginalMember(owner = "client!qb", name = "f", descriptor = "(I)V", line = 192)
