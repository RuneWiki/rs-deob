...
public class class149 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "()V", line = 36)
    public void method1057() {
        field2046++;
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "()V", line = 205)
    public void method1060() throws Exception {
        field2043++;
    }

    @OriginalMember(owner = "client!ue", name = "c", descriptor = "()V", line = 212)
    public void method1061() throws Exception {
        field2050++;
    }

    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)Z", line = 221)
    ...
    @OriginalMember(owner = "client!ue", name = "d", descriptor = "()I", line = 232)
    public int method1063() throws Exception {
        field2052++;
        return this.field2061;
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 241)
    public void method1064(Component arg0) throws Exception {
        field2049++;
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Loe;IB)V", line = 249)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(B)V", line = 273)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(I)V", line = 303)
    public void method1068(int arg0) throws Exception {
        field2044++;
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Loe;B)V", line = 318)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(II)V", line = 331)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "([II)V", line = 358)
