...
public class class149 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(II)Ljp;")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ZLjr;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Ldd;ILpj;)V")
