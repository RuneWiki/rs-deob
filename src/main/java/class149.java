...
public class class149 implements class126 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IZIFBI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II)Len;", line = 25)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BI)Lvg;", line = 51)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(IB)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IB)Z", line = 97)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZIIIIF)[I", line = 113)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(FZIBII)[F", line = 125)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZI)Lqg;", line = 136)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lic;Lic;Lic;)V", line = 151)
