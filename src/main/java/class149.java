...
public class class149 {
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(I)Lng;")
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(I)Lng;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lng;Z)V")
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(B)Lng;")
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(B)Lng;")
