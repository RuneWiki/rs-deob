...
public class class149 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILo;II)V")
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(ILo;II)Z")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lo;III)V")
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lig;Ler;)V")
