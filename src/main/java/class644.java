...
public class class644 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILek;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "([ILvo;Lvo;B)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILek;I)V")
