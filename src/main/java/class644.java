...
public class class644 extends class443 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIIB[I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!bea", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 231)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I[IIB)Z", line = 119)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(III[I)Z", line = 151)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ZII)Z", line = 192)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ZLui;)V", line = 251)
