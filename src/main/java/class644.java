...
public class class644 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILir;B)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IILfca;)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILjava/awt/Component;)Lpr;")
