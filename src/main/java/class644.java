...
public class class644 extends class277 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(FFIFBIII)[F", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I[SI)[S", line = 97)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILrg;)V", line = 135)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lqj;Lpea;)V", line = 168)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(IZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(III)V", line = 221)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 250)
