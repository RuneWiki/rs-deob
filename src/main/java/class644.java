...
public class class644 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lwq;I)V", line = 295)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Z)Leg;", line = 320)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "([[II)V", line = 333)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IZLwq;)V", line = 344)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILwq;)Lnga;", line = 378)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(JI)I", line = 406)
