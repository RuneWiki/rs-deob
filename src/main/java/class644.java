...
public abstract class class644 extends class280 {
    ...
    @OriginalMember(owner = "client!hf", name = "i", descriptor = "(I)Lg;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I[Lwh;)I")
    ...
    @OriginalMember(owner = "client!hf", name = "h", descriptor = "(B)V")
