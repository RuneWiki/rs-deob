...
public class class644 extends class86 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZLmc;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lsf;)V", line = 65)
    public class644(class551 arg0) {
        super(arg0);
        class61.method360(false, super.field1200);
    }

    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(II)I", line = 94)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Z)I", line = 112)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(ILsf;)V", line = 190)
