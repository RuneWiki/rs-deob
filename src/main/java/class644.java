...
public class class644 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BI)V", line = 15)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Z)I", line = 34)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(II)Lfs;", line = 48)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IB)Lne;", line = 104)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lmja;ILbt;Lbt;Lbt;)V", line = 150)
