...
public class class644 extends class322 {
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Lch;)V", line = 8)
    public class644(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(B)Z", line = 11)
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(ILch;)V", line = 31)
    public class644(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(B)I", line = 90)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(Z)I", line = 100)
