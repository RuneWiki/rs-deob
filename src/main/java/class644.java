...
public class class644 extends class372 {
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lkb;)V", line = 4)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(II[BB)[B", line = 43)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BII)Z", line = 62)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(II)I", line = 98)
