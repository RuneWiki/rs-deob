...
public abstract class class644 extends class139 {
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lqe;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lw;IIIIZ)Z")
    public final boolean method203(class276 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!bs", name = "aa", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bs", name = "FA", descriptor = "(Lw;IIIIZ)V")
    public final void method208(class276 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lpv;[I)V")
    ...
    @OriginalMember(owner = "client!bs", name = "c", descriptor = "(IILw;)Lw;")
