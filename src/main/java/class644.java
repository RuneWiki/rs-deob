...
public class class644 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIZ)Z")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BILvi;)V")
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lep;Lem;Ldn;IIIII)V")
