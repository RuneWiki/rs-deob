...
public abstract class class644 implements class435 {
    ...
    @OriginalMember(owner = "client!aaa", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!aaa", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(B)I", line = 45)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILjaclib/memory/Source;Z)Z", line = 76)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IB)V", line = 142)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Ljaggl/MapBuffer;ZI)Ljaclib/memory/Buffer;", line = 171)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZLjaggl/MapBuffer;)Z", line = 220)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lpa;IZ)V", line = 314)
    ...
    @OriginalMember(owner = "client!aaa", name = "finalize", descriptor = "()V", line = 256)
    ...
    @OriginalMember(owner = "client!aaa", name = "f", descriptor = "(I)J", line = 302)
