...
public class class644 extends class666 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 50)
    public class644() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lba;ILgr;BII)V", line = 22)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)I", line = 53)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILfp;Z)V", line = 171)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILiaa;Z)V", line = 511)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IB)[[I", line = 576)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 693)
