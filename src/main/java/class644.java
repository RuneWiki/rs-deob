...
public class class644 implements class419 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)Ldda;", line = 78)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lpfa;Ljava/lang/String;)V", line = 110)
