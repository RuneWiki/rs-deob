...
public class class644 extends class212 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILjr;)Laq;", line = 19)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lgj;II[B)V", line = 52)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(CI)Z", line = 65)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lgj;II[I)V", line = 80)
    public class644(class580 arg0, int arg1, int arg2, int[] arg3) {
        this.field9144 = arg0.method3214(arg1, arg2, -17318, arg3, false);
        this.field9144.method786(false, 27469, false);
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Le;Ljava/awt/Canvas;I)Loa;", line = 93)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIIIIIIZI)V", line = 104)
