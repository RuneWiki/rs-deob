...
public class class644 {
    ...
    @OriginalMember(owner = "client!cj", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field9051++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILoo;)V", line = 12)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)I", line = 194)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)V", line = 228)
