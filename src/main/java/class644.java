...
public class class644 implements class558 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILqq;)V", line = 13)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lqq;[III)V", line = 18)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 25)
    public final void method4726() {
        this.field9343 = Thread.currentThread();
        this.method4738();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 36)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 83)
    private final void method4731() {
        this.method4721(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lqq;[II)V", line = 87)
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 93)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 109)
    private final void method4738() {
        this.method4722(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 112)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 116)
    public final void method4741() {
        this.field9343 = null;
        this.method4731();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 120)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILqq;ZI)Z", line = 123)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILqq;Z)Z", line = 129)
