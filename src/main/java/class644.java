...
public class class644 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lkea;III)Lcq;")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZI)Llw;")
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lcda;ILkea;Lkea;)V")
