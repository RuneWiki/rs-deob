...
public class class644 extends class212 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILkda;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)I", line = 60)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(ILdh;)V", line = 71)
    public class644(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)I", line = 91)
    public final int method422(int arg0) {
        ++field8864;
        return arg0 != 20014 ? 70 : 1;
    }

    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Ldh;)V", line = 102)
