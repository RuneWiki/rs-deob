...
public class class644 {
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILqf;Z)V", line = 46)
