...
public class class644 extends class231 implements class620 {
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lcu;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lcu;Lem;Lew;II)V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "([BIBIIILem;II)V")
    ...
    @OriginalMember(owner = "client!aga", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method1465(int arg0) {
        return arg0 == 13367 ? this.field8884 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lcu;Lem;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lbba;I)V")
