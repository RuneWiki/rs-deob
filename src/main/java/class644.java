...
public class class644 implements class558 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILal;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lal;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILal;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lal;[III)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILal;Z)Z")
