...
public class class487 extends class207 {
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)I", line = 3)
    public final int method36(int arg0) {
        ++field6778;
        return arg0 >= -14 ? 101 : 1;
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Lrd;)V", line = 39)
    public class487(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(IB)Z", line = 42)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(IB)I", line = 54)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lub;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(ILrd;)V", line = 107)
    public class487(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([BIIIIII[BI)V", line = 110)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IB)V", line = 151)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(I)I", line = 186)
