...
public class class487 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IB)I", line = 56)
    public final int method2861(int arg0, byte arg1) {
        return arg1 > -22 ? 100 : this.field6701.Present(arg0);
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 65)
