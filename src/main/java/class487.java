...
public class class487 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILml;)V", line = 20)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 32)
