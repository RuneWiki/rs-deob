...
public class class487 extends class26 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(B)Z", line = 36)
    ...
    @OriginalMember(owner = "client!hg", name = "h", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!hg", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 59)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lcg;Ljava/lang/Object;I)V", line = 71)
    public class487(class90 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field7116 = arg1;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZZIII)V", line = 81)
