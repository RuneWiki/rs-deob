...
public class class487 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILvg;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILdh;B)V", line = 121)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIIBI)Z", line = 161)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILdh;)V", line = 198)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 227)
