...
public class class487 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 6)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)Z", line = 18)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BI)I", line = 28)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 65)
