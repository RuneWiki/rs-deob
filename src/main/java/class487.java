...
public class class487 {
    ...
    @OriginalMember(owner = "client!ifa", name = "d", descriptor = "(I)Llj;")
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ILlj;)V")
    ...
    @OriginalMember(owner = "client!ifa", name = "e", descriptor = "(I)Llj;")
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)Llj;")
