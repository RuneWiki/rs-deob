...
public class class487 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Loba;Z)Z")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLoba;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lkfa;)V")
