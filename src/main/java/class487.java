...
public class class487 extends class498 {
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(IIIIIF)V", line = 33)
    public class487(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lsf;", line = 50)
    ...
    @OriginalMember(owner = "client!fd", name = "d", descriptor = "(B)[Lff;", line = 73)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BF)V", line = 86)
