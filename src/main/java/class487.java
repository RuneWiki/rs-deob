...
public class class487 extends class136 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lya;Lfi;IIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!ev", name = "f", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "()V", line = 427)
    public class487() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(II)[I", line = 174)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIII[[IILjava/util/Random;)V", line = 434)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IILiv;)V", line = 637)
