...
public class class487 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "([[BILqq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)V", line = 81)
    public static void method2914(byte arg0) {
        int var1 = -72 % ((-arg0 - 55) / 50);
        field7212 = null;
    }

    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Luh;JI)V", line = 115)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IJ)Luh;", line = 152)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZLnj;)Lmm;", line = 200)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(I)V", line = 225)
