...
public class class487 extends class475 implements class411 {
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Ldw;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Ldw;ILjaclib/memory/Buffer;IZ)V")
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IILha;ILjava/lang/String;III)V")
