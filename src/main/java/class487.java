...
public class class487 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lfca;)V", line = 157)
    public class487(class93 arg0) {
        this.method2779(arg0, -5);
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lfca;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lgca;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IJILkh;IILaa;II)V", line = 99)
