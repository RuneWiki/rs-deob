...
public class class487 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z[B)[B", line = 18)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)V", line = 35)
