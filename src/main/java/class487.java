...
public class class487 extends class406 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III[Lmja;[BLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(IIIZ)V", line = 77)
    public class487(int arg0, int arg1, int arg2, boolean arg3) {
        super(arg0, arg1, arg2, arg3, class483.field6864, class32.field438);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([BIIIIIII[Lmja;ILha;)V", line = 80)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIII)Lija;", line = 154)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLha;I)V", line = 184)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIII[ILrv;ILha;III)V", line = 321)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lha;ILrv;I[II)V", line = 618)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILmja;Lha;IIII)V", line = 987)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIILmja;IIILha;I)V", line = 1080)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 1712)
