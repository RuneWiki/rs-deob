...
public class class487 extends class471 {
    ...
    @OriginalMember(owner = "client!qg", name = "d", descriptor = "(B)Lsi;", line = 3)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(FB)V", line = 22)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(IIIIIF)V", line = 48)
    public class487(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IBI)Z", line = 57)
