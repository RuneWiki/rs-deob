...
public class class487 extends class371 implements class445 {
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 5)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLqt;)V", line = 29)
    public final void method774(byte arg0, class525 arg1) {
        int var3 = -85 % ((-arg0 - 66) / 35);
        super.method774((byte) -110, arg1);
    }

    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lcka;IZ[[I)V", line = 36)
