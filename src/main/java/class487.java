...
public class class487 extends class238 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)Ldm;")
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)Lit;")
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(ILmu;Lmu;Lgq;Lrs;I[BIZ)V")
