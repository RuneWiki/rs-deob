...
public class class487 extends class105 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILjava/lang/String;)V", line = 54)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "()V", line = 78)
    public class487() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIIB)[B", line = 81)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lin;IIIILqq;)V", line = 101)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(ILjava/lang/String;)J", line = 165)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BIIII)V", line = 188)
