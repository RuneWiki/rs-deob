...
public class class487 extends class305 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILfh;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "()V", line = 251)
    public class487() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Ljava/lang/String;IIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!ri", name = "e", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)[I", line = 168)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZZB)V", line = 256)
