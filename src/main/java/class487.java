...
public class class487 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(III)Z", line = 74)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLwm;)V", line = 85)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lwm;I)Lwq;", line = 118)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)Ldd;", line = 129)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lwm;II)V", line = 149)
