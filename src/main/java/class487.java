...
public abstract class class487 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Ljava/awt/Canvas;ILdq;IILbc;)Lkm;", line = 27)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IBIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(IIIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIBI)V", line = 113)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIIIZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(IIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIILqr;)V", line = 171)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IZIIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!km", name = "finalize", descriptor = "()V", line = 281)
    protected final void finalize() {
        this.method2867(-8615);
        field6875++;
    }

    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(ILbc;)V", line = 295)
    public class487(int arg0, class187 arg1) {
        this.field6863 = arg1;
        this.field6871 = arg0;
    }

    @OriginalMember(owner = "client!km", name = "h", descriptor = "(I)V", line = 310)
