...
public class class487 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIZIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 86)
    public class487(String arg0, String arg1, String arg2, String arg3) {
        this.field7379 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!nj", name = "toString", descriptor = "()Ljava/lang/String;", line = 162)
