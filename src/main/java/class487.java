...
public class class487 extends class271 {
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lvd;IIZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lvd;IIZ[[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lvd;II)V", line = 93)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIZII)V", line = 127)
