...
public class class487 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Lmi;", line = 3)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(II)I", line = 45)
    public static final int method2916(int arg0, int arg1) {
        return class557.field8282 == null ? 0 : class557.field8282[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIIB)I", line = 48)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 112)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZII)Lvo;", line = 123)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 147)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIILqa;I)V", line = 171)
