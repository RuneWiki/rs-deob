...
public class class487 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IIBIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BLida;)[I", line = 21)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)Lnk;", line = 57)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BI)Z", line = 100)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IIIII)V", line = 128)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Ldh;ILkha;)V", line = 244)
    public class487(class286 arg0, int arg1, class687 arg2) {
        this.field6927 = arg2;
        this.field6927.method3812(0, 32);
    }

    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(III)Z", line = 234)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(BI)V", line = 259)
