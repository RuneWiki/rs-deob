...
public class class487 extends class386 {
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 4)
    public class487() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!ke", name = "e", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BIZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIII)[B", line = 111)
