...
public class class487 extends class126 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lsr;Lsr;II)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ldn;IZ)Lfk;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IILgf;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lgk;)V")
