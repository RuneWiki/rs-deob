...
public class class487 extends class386 {
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "()V", line = 9)
    public class487() {
        super(0, true);
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)[I", line = 12)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(Z)V", line = 223)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IBLun;)V", line = 251)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 329)
    ...
    @OriginalMember(owner = "client!um", name = "e", descriptor = "(I)V", line = 344)
