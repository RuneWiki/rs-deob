...
public class class487 extends class404 implements class147 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Loa;B)Lac;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Loa;Llt;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILoa;)Lwc;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Loa;ZLjp;)I")
