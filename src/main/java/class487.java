...
public class class487 extends class687 implements class377 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jt", name = "finalize", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!jt", name = "g", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lml;III)V", line = 93)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lml;IIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIZ)V", line = 109)
