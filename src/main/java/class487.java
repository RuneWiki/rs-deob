...
public class class487 extends class188 {
    ...
    @OriginalMember(owner = "client!sj", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IBLbm;)V", line = 19)
    ...
    @OriginalMember(owner = "client!sj", name = "f", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lai;Llja;)V", line = 60)
    public class487(class626 arg0, class745 arg1) {
        super(arg0);
        this.field6735 = arg1;
    }

    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(IIZ)Z", line = 71)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)Z", line = 84)
    public final boolean method956(int arg0) {
        ++field6743;
        return arg0 <= 53 ? true : this.field6735.method4123(29925);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B[B)[B", line = 98)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ZI)V", line = 116)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!sj", name = "e", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(B)V", line = 193)
