...
public class class487 extends class545 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(III)Z", line = 25)
    ...
    @OriginalMember(owner = "client!cia", name = "<init>", descriptor = "(Lch;)V", line = 40)
    public class487(class38 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(BZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ZZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IILec;)V", line = 90)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(I)V", line = 115)
