...
public class class669 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(II)Lbw;")
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Llba;Ld;)V")
