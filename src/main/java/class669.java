...
public class class669 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)Llm;", line = 5)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IILmo;)V", line = 90)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILmo;)V", line = 170)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)Llm;", line = 190)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)Z", line = 264)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)Z", line = 292)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BILjava/lang/String;)Z", line = 330)
