...
public class class669 extends class571 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lep;II[B)V", line = 106)
