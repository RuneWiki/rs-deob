...
public class class669 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IIIIIZ)V", line = 135)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 230)
