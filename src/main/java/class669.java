...
public class class669 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ZII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(IBI)Z", line = 97)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BLni;)V", line = 333)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIIBI)V", line = 367)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BLha;IIIII)V", line = 382)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "()V", line = 404)
    protected class669() {
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lha;Lji;I)V", line = 415)
