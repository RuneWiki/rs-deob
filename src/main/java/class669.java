...
public class class669 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BI)Lvl;")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljw;ZZ)V")
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lmp;ILla;)V")
