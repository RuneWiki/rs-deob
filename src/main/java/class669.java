...
public class class669 extends class192 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIB)Z", line = 26)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIIZII)V", line = 81)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lvf;II)V", line = 526)
