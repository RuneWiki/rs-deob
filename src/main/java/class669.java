...
public class class669 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILfj;Lfj;F)Z", line = 47)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(II)Z", line = 116)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Ldw;)V", line = 133)
