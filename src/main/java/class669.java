...
public class class669 extends class358 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIBLha;Ljava/lang/String;II)V")
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Llk;Lvea;IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)Lvaa;")
