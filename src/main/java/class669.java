...
public abstract class class669 extends class362 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "(I)F", line = 58)
    ...
    @OriginalMember(owner = "client!ab", name = "f", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!ab", name = "g", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!ab", name = "h", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(IIIIIF)V", line = 127)
