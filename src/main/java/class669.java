...
public class class669 extends class445 implements class310 {
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Loa;Lpg;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(Loa;I)Lqt;")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Loa;BIZ)Lm;")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ZLoa;Lnt;IIII)V")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ILoa;I)Lba;")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Loa;BI)Lba;")
