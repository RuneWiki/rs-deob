...
public class class669 extends class601 {
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "()V", line = 4)
    public class669() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILha;ILjava/lang/String;IBII)V", line = 9)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IB)[I", line = 53)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IIILha;BIII)V", line = 94)
