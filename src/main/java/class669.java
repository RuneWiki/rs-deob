...
public class class669 extends class659 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(CI)I", line = 4)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILdt;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!lca", name = "d", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IZ)Z", line = 114)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(BLdt;)V", line = 129)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IC)I", line = 154)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Z)V", line = 180)
    ...
    @OriginalMember(owner = "client!lca", name = "e", descriptor = "(B)V", line = 195)
