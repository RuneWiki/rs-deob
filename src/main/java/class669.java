...
public class class669 extends class434 {
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lql;)V", line = 53)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIII)Lcg;", line = 83)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 117)
