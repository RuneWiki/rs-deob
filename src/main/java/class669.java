...
public class class669 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(III)I", line = 18)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lku;)V", line = 101)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(III)Z", line = 213)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)J", line = 225)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)V", line = 250)
