...
public class class669 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "()V", line = 4)
    public static void method3798() {
        field9509 = null;
        field9511 = null;
    }

    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lig;Lwda;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IIF)F", line = 86)
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(IIF)F", line = 94)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IF)I", line = 114)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(F)F", line = 180)
