...
public class class669 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILjp;)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Ljp;II)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
