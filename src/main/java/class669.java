...
public class class669 extends class610 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(III)Lhd;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IILit;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Len;)V")
