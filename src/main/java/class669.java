...
public class class669 extends class325 {
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 34)
    public class669(Object arg0, int arg1) {
        super(arg1);
        this.field9181 = arg0;
    }

    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IILwj;IIIIIIII)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 415)
