...
public class class669 extends class358 {
    ...
    @OriginalMember(owner = "client!ph", name = "G", descriptor = "Lla;")
    public static class476 field9714;

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 5)
    public static void method4921(byte arg0) {
        try {
            field9715 = null;
            field9714 = null;
            field9713 = null;
            ...
            throw class759.method5498(var2, field9723[4] + arg0 + ')');
        }
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIBLha;Ljava/lang/String;II)V", line = 21)
    public static final void method4922(int arg0, int arg1, int arg2, byte arg3, class66 arg4, String arg5, int arg6, int arg7) {
        try {
            if (class217.field3328 == null || class710.field10296 == null) {
                if (class383.field5798.method3618(class240.field3631, 119) && class383.field5798.method3618(class502.field7257, 115)) {
                    class217.field3328 = arg4.method487(class481.method3675(class383.field5798, class240.field3631, 0), true);
                    class481 var8 = class481.method3675(class383.field5798, class502.field7257, 0);
                    class710.field10296 = arg4.method487(var8, true);
                    var8.method3672();
                    class753.field10959 = arg4.method487(var8, true);
                } else {
                    arg4.method556(arg7, arg1, arg2, arg6, class255.field3950 | 255 - class655.field9470 << 24, 1);
                }
            }
            field9712++;
            if (arg3 >= -124) {
            ...
            if (class217.field3328 != null && class710.field10296 != null) {
                int var9 = (arg2 - (class710.field10296.method991() * 2)) / class217.field3328.method991();
                for (int var10 = 0; var10 < var9; var10++) {
                    class217.field3328.method4347(arg7 - (-class710.field10296.method991() - var10 * class217.field3328.method991()), arg1);
                }
                class710.field10296.method4347(arg7, arg1);
                class753.field10959.method4347(arg7 + arg2 - class753.field10959.method991(), arg1);
            }
            class269.field4100.method596(-1, 31, arg5, arg1 + 14, class376.field5737 | 0xFF000000, arg7 + 3);
            arg4.method556(arg7, arg1 + arg6, arg2, arg0 - arg6, class255.field3950 | -class655.field9470 + 255 << 24, 1);
        } catch (RuntimeException var12) {
            throw class759.method5498(var12, field9723[2] + arg0 + ',' + arg1 + ',' + arg2 + ',' + arg3 + ',' + (arg4 == null ? field9723[0] : field9723[1]) + ',' + (arg5 == null ? field9723[0] : field9723[1]) + ',' + arg6 + ',' + arg7 + ')');
        }
    }

    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Llk;Lvea;IIIIIIIIIIIIII)V", line = 66)
    public class669(class613 arg0, class288 arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15) {
        super(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14);
        try {
            this.field9719 = arg15;
        } catch (RuntimeException var18) {
            throw class759.method5498(var18, field9723[5] + (arg0 == null ? field9723[0] : field9723[1]) + ',' + (arg1 == null ? field9723[0] : field9723[1]) + ',' + arg2 + ',' + arg3 + ',' + arg4 + ',' + arg5 + ',' + arg6 + ',' + arg7 + ',' + arg8 + ',' + arg9 + ',' + arg10 + ',' + arg11 + ',' + arg12 + ',' + arg13 + ',' + arg14 + ',' + arg15 + ')');
        }
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)Lvaa;", line = 77)
    public final class494 method1226(int arg0) {
        try {
            field9711++;
            int var2 = -108 / ((arg0 - 57) / 61);
            return class544.field8132;
        } catch (RuntimeException var4) {
            throw class759.method5498(var4, field9723[3] + arg0 + ')');
        }
    }
