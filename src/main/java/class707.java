...
public class class707 extends class682 {
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IBI)V", line = 42)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)Z", line = 98)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZ)V", line = 237)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BZ)V", line = 250)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lnv;Lpr;)V", line = 285)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ltha;II)V", line = 318)
