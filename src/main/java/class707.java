...
public class class707 {
    ...
    @OriginalMember(owner = "client!wca", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!wca", name = "listmodes", descriptor = "()[I", line = 71)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "()V", line = 92)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 129)
    ...
    @OriginalMember(owner = "client!wca", name = "exit", descriptor = "()V", line = 174)
