...
public class class707 extends class50 implements class649 {
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(ILha;)Lgp;")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lha;BZI)Lws;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IBZILha;ILig;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(Lha;I)Ljl;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lha;II)Lka;")
    ...
    @OriginalMember(owner = "client!ma", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(II)Leaa;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(ILha;)V")
