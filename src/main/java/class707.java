...
public class class707 extends class362 {
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lfca;II)V", line = 115)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(III)V", line = 141)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "()V", line = 176)
    public class707() {
        super(0, false);
    }
}
