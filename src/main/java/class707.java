...
public class class707 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;Lki;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIII)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "()V", line = 170)
    public final void method3938() {
        this.field9577 = null;
    }

    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Lha;Lki;)V", line = 182)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(Lha;Lki;)Z", line = 266)
    public final boolean method3940(class59 arg0, class707 arg1) {
        return this.field9577 != null || this.method3934(arg0, arg1);
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;IIIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Lha;)V", line = 293)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "()V", line = 380)
    public static final void method3943() {
        field9583 = null;
        field9584 = null;
    }

    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 388)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(Lha;Lki;)V", line = 400)
