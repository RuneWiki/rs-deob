...
public class class707 extends class112 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IIIIZ[Lkq;)V", line = 6)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(II)Lpn;", line = 58)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)V", line = 97)
