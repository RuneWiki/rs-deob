...
public class class707 implements class498 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(I)Llj;")
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lmba;Llj;Z)V")
