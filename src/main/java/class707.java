...
public class class707 extends class282 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILuu;BI)V")
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lbi;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Llaa;[I)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILria;II)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BLsl;)Ljg;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BILria;)I")
