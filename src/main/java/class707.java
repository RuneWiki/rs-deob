...
public class class707 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lsga;Z)I", line = 19)
    ...
    @OriginalMember(owner = "client!jfa", name = "finalize", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lhj;II)V", line = 57)
