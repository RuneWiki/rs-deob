...
public class class707 extends class619 {
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class707(Object arg0, int arg1) {
        super(arg1);
        this.field9898 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!mga", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)Z", line = 24)
