...
public class class207 extends class184 {
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIIII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIII[I)V")
    public class207(class246 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIIZ[III)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ldia;IIIIIIZ)V")
