...
public class class207 extends class424 {
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lee;Lhaa;IIIIIIIIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIZII)V", line = 16)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)Lhda;", line = 75)
    public final class750 method333(int arg0) {
        field2487++;
        return arg0 == 30778 ? class360.field4762 : null;
    }

    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIZIII)V", line = 86)
