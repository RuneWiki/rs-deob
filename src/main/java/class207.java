...
public class class207 extends class216 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIB[ILgfa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "()Laca;", line = 64)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "()Laca;", line = 86)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "()I", line = 105)
    public final int method552() {
        field3466++;
        return 0;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([III)V", line = 115)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BLgfa;I)V", line = 252)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lul;)V", line = 297)
