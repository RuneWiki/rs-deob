...
public class class207 extends class512 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILlo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!lm", name = "e", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "([Lig;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lpga;)V", line = 117)
    public class207(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZ)V", line = 123)
