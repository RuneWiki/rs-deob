...
public class class207 extends class134 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lmk;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lsca;I)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILwq;)V")
