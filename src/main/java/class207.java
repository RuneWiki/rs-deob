...
public class class207 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lqn;II)Lcd;")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lfh;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "()Ljc;")
