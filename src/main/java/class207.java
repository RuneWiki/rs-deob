...
public class class207 extends class315 {
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "(I)Lcj;", line = 121)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IJ)V", line = 150)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lvc;Lof;Lan;J)V", line = 370)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lvc;BJIZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)V", line = 354)
