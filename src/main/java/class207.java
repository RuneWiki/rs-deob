...
public class class207 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!jda", name = "toString", descriptor = "()Ljava/lang/String;", line = 58)
    public final String toString() {
        field2512++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 79)
