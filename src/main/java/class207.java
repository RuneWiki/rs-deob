...
public class class207 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IILcda;)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZLrm;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lifa;Lqs;Ljda;IIIII)V")
