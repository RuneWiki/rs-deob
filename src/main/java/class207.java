...
public class class207 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)[Lad;", line = 54)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BLwea;)[Lb;", line = 70)
