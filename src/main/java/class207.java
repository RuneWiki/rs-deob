...
public class class207 extends class544 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lqa;IILn;III)V", line = 28)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(II)Lhba;", line = 113)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(IIIIIZ)V", line = 153)
