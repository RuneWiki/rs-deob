...
public class class207 extends class172 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wt", name = "e", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IZIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!wt", name = "g", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)[B", line = 121)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IFIIIFI[FFIIII)V", line = 144)
