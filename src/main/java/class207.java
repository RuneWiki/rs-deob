...
public class class207 extends class430 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BLsl;)Lcba;")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILsl;)V")
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(ZLhga;)V")
