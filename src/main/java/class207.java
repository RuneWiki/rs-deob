...
public abstract class class207 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BLlm;)Z", line = 11)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)V", line = 63)
