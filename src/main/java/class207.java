...
public class class207 extends class491 implements class465 {
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(BLej;)V", line = 16)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I[IIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lfi;Lpd;Lok;II)V", line = 66)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lfi;IIZ[III)V", line = 85)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(B)I", line = 142)
    public final int method1262(byte arg0) {
        return arg0 >= -37 ? 36 : this.field3044;
    }

    @OriginalMember(owner = "client!dga", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 152)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIIIII[II)V", line = 162)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lfi;Lpd;IIZ[BII)V", line = 199)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ZBZ)V", line = 257)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(FI)F", line = 268)
    public final float method1273(float arg0, int arg1) {
        return arg1 >= -72 ? -2.938902F : arg0 / (float) this.field3046;
    }

    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIIIIII[BLpd;)V", line = 288)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(BF)F", line = 331)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(B)Z", line = 342)
