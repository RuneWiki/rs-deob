...
public class class207 extends class145 {
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(FB)F", line = 16)
    ...
    @OriginalMember(owner = "client!nj", name = "i", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IILrt;)V", line = 62)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "()V", line = 109)
    public class207() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 117)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZI)[I", line = 182)
    ...
    @OriginalMember(owner = "client!nj", name = "f", descriptor = "(I)V", line = 261)
