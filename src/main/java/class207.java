...
public class class207 {
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(II)Lpw;")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(CI)Z")
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lci;ILsea;)V")
