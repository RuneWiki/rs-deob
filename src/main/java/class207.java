...
public class class207 extends class189 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIZLl;DILph;Z)[I", line = 20)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lph;Ll;B)Z", line = 220)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 286)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZIDLl;Lph;II)[I", line = 363)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IILph;Ll;IZ)[F", line = 509)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "()V", line = 620)
    public class207() {
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lnn;)V", line = 635)
