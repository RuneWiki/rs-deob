...
public abstract class class207 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IB)I", line = 48)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILdp;)V", line = 151)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)V", line = 162)
