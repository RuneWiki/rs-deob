...
public class class207 extends class202 {
    ...
    @OriginalMember(owner = "client!em", name = "d", descriptor = "(I)Lqn;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILqn;Lqn;F)Z")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Ler;I)V")
