...
public class class207 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(II)Lhi;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lnba;Z)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lpaa;B)Z")
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)Lse;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ZLjba;Lha;)I")
