...
public class class207 extends class601 {
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(ILqea;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lqea;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(B)Lnk;")
