...
public class class207 extends class409 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lmi;)V", line = 8)
    public final synchronized void method1428(class409 arg0) {
        this.field2884.method1244(true, arg0);
    }

    @OriginalMember(owner = "client!np", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "([III)V", line = 63)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "()Lmi;", line = 75)
    public final class409 method690() {
        return (class409) this.field2884.method1245(1);
    }

    @OriginalMember(owner = "client!np", name = "e", descriptor = "()V", line = 78)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "()I", line = 95)
    public final int method687() {
        return 0;
    }

    @OriginalMember(owner = "client!np", name = "b", descriptor = "([III)V", line = 105)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "()Lmi;", line = 152)
    public final class409 method708() {
        return (class409) this.field2884.method1240((byte) -120);
    }

    @OriginalMember(owner = "client!np", name = "b", descriptor = "(Lmi;)V", line = 155)
    public final synchronized void method1431(class409 arg0) {
        arg0.method2367(5);
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ls;Lrm;)V", line = 158)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lrm;)V", line = 178)
