...
public class class207 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lpc;J[Lqba;)V", line = 22)
    public class207(class700 arg0, long arg1, class426[] arg2) {
        this.field2457 = arg1;
        this.field2455 = arg0;
    }

    @OriginalMember(owner = "client!pq", name = "finalize", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(III)Z", line = 62)
