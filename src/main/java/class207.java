...
public class class207 extends class320 {
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BI)I", line = 94)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)I", line = 116)
    public static int method1405(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(I)V", line = 129)
