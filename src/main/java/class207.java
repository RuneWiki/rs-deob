...
public class class207 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILji;)V")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIBILba;B)Lba;")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZILba;II)Lba;")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBLji;)V")
