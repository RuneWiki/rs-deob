...
public class class207 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ZIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)Z", line = 121)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lvt;B)V", line = 218)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lqh;IIIII)Lqh;", line = 252)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BILqh;IIIII)Lqh;", line = 387)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IILvt;)V", line = 477)
