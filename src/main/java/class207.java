...
public class class207 extends class83 {
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "()V", line = 5)
    public class207() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IBLtq;)V", line = 26)
    ...
    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)[I", line = 117)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(I)V", line = 343)
