...
public class class207 implements class463 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(B)Ldr;")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Llj;Ldr;Z)V")
