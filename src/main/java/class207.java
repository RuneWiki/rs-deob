...
public abstract class class207 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lpia;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IZIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZB)C", line = 70)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lrd;)V", line = 101)
    public class207(class355 arg0) {
        this.field2668 = arg0;
        this.field2669 = this.method36(-88);
    }

    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(ILrd;)V", line = 110)
