...
public class class207 {
    ...
    @OriginalMember(owner = "client!sb", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() throws Throwable {
        this.field3127.method1667(this.field3126);
        super.finalize();
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lnm;ILjava/lang/String;)Lsb;", line = 11)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lnm;II)V", line = 31)
