...
public class class207 extends class101 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIILeu;I[I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "d", descriptor = "()Lsd;")
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "()Lsd;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IILeu;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Ljc;)V")
