...
public class class207 extends class376 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)Lue;", line = 5)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "([Lie;I[BZLaa;IIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BI)I", line = 166)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 183)
