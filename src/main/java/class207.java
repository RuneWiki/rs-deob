...
public class class207 extends class424 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ZI)Lpl;", line = 18)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 82)
