...
public class class207 extends class321 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIIII)Z", line = 237)
