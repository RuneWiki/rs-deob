...
public class class207 extends class378 {
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lks;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IILqh;)Lqh;")
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(Lqh;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(Lqh;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lqh;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lap;[I)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lck;II)V")
