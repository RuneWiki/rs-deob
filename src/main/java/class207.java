...
public class class207 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lvd;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lvd;Ljaggl/memory/NativeBuffer;)V", line = 21)
