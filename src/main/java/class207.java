...
public class class207 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lco;IIIII)V")
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(I)Ljn;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BJ)Ljn;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(JBLjn;)V")
