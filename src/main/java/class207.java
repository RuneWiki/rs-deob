...
public class class207 extends class216 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 13)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "()I", line = 102)
    public final int method1457() {
        return this.field3327 - (this.field3324.available() >> (class29.field339 ? 2 : 1));
    }

    @OriginalMember(owner = "client!pa", name = "c", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 117)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(I)V", line = 134)
