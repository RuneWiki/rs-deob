...
public class class207 implements class211 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(FIIIIZ)[I", line = 5)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(II)Lkj;", line = 32)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IZFIBI)[I", line = 70)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(II)Ljb;", line = 81)
    public final class287 method1475(int arg0, int arg1) {
        field2981++;
        return arg1 == 17673 ? this.field2973[arg0] : null;
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IFIBZI)[F", line = 103)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(J[IBI)Ljava/lang/String;", line = 115)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLao;IILao;)I", line = 136)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Ltj;Ltj;Ltj;)V", line = 244)
