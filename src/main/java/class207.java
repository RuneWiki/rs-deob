...
public class class207 extends class278 {
    ...
    @OriginalMember(owner = "client!ne", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "()V", line = 20)
    public class207() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Llh;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(II)[I", line = 73)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)[[I", line = 172)
