...
public class class207 extends class89 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B)Lgm;", line = 3)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IBIC)V", line = 38)
    ...
    @OriginalMember(owner = "client!rt", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 56)
    public final void focusGained(FocusEvent arg0) {
        field3058++;
    }

    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(B)I", line = 66)
    public static final int method1369(byte arg0) {
        field3052++;
        return arg0 > -103 ? -110 : 46;
    }

    @OriginalMember(owner = "client!rt", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 77)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z)I", line = 96)
    ...
    @OriginalMember(owner = "client!rt", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 120)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3061++;
        this.method1373(1, true, arg0);
    }

    @OriginalMember(owner = "client!rt", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 128)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method1368(0, (byte) -113, -1, '\u0000');
        field3057++;
    }

    @OriginalMember(owner = "client!rt", name = "e", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!rt", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 178)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field3064++;
        this.method1373(0, true, arg0);
    }

    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 352)
    public class207(Component arg0) {
        class189.method1259(-9381);
        this.method1367(arg0, (byte) 39);
    }

    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)Z", line = 282)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZLjava/awt/event/KeyEvent;)V", line = 300)
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(B)V", line = 338)
