...
public class class714 implements class718 {
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)Lej;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILha;II)V")
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Ljr;Lhh;Llo;)V")
