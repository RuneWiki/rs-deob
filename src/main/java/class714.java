...
public class class714 extends class152 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(B)J", line = 21)
    public final long method4041(byte arg0) {
        ++field10025;
        return arg0 > -26 ? -94L : super.field1894 & Long.MAX_VALUE;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(III)Lbga;", line = 33)
    ...
    @OriginalMember(owner = "client!jca", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(IJ)V", line = 69)
    public class714(int arg0, long arg1) {
        super.field4809 = arg1 | (long) arg0 << 56;
    }

    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(Z)I", line = 77)
