...
public class class714 extends class313 {
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "()I", line = 11)
    public final int method1391() {
        return this.field10056 - (this.field10057.available() >> (class266.field3798 ? 2 : 1));
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 21)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 61)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!lga", name = "d", descriptor = "()V", line = 122)
