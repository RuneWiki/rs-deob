...
public class class714 implements class444 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)Lhl;", line = 14)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lmp;Lfe;IIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BI)V", line = 72)
