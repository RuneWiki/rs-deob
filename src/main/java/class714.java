...
public class class714 extends class44 implements class455 {
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Lbea;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BLnd;)V")
    public final void method272(byte arg0, class545 arg1) {
        super.method272(arg0, arg1);
    }

    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
