...
public class class714 extends class735 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Llu;BZZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Lbl;B)I")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Lrh;Z)V")
