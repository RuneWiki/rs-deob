...
public class class714 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/awt/Frame;Lfc;Z)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BI)Lwo;")
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lrs;Ld;)V")
