...
public class class714 extends class667 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lud;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lbba;Z)Z", line = 102)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IILjava/util/Random;[[IBII)V", line = 223)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "()V", line = 694)
    public class714() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BI)[I", line = 423)
    ...
    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(B)V", line = 678)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(Z)V", line = 719)
