...
public class class714 extends class577 {
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Z[ILgm;[B)Z", line = 96)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 183)
    public class714() {
    }

    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "([B)V", line = 185)
