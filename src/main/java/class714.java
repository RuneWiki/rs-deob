...
public class class714 extends class260 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIZLpu;I)V")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Lfca;)V")
