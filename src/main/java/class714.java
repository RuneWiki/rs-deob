...
public class class714 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(III)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IBI[BZIILeq;)Lmba;", line = 59)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIIBI)V", line = 79)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lha;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ILjb;B)V", line = 118)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I[BII)V", line = 134)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIII)I", line = 152)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Leq;Ljia;Lqh;IIIII)V", line = 362)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!nfa", name = "c", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(JZILaa;IILgaa;II)V", line = 308)
