...
public class class714 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!lu", name = "toString", descriptor = "()Ljava/lang/String;", line = 488)
    public final String toString() {
        field9858++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 498)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(I)V", line = 510)
