...
public class class714 extends class592 implements class227 {
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lep;ILjaclib/memory/Buffer;IZ)V", line = 5)
    public class714(class371 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field10124 = arg1;
    }

    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)J", line = 35)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIII)I", line = 47)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BC)Z", line = 64)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lep;I[BIZ)V", line = 75)
    public class714(class371 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field10124 = arg1;
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "([IBILkda;)Liha;", line = 85)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BII[B)V", line = 264)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)I", line = 276)
    public final int method1470(int arg0) {
        ++field10127;
        return arg0 != 10059 ? 0 : super.field8534;
    }

    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)V", line = 304)
