...
public class class714 extends class687 {
    ...
    @OriginalMember(owner = "client!ud", name = "i", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IILjc;)V", line = 32)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljc;B)Ljava/lang/String;", line = 106)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I[S[Ljava/lang/String;)V", line = 173)
    ...
    @OriginalMember(owner = "client!ud", name = "g", descriptor = "(I)Ljava/lang/String;", line = 184)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(III)I", line = 231)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B[ILjc;)V", line = 259)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILjc;)V", line = 287)
    ...
    @OriginalMember(owner = "client!ud", name = "j", descriptor = "(I)V", line = 310)
    ...
    @OriginalMember(owner = "client!ud", name = "h", descriptor = "(I)I", line = 382)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(II)Lhj;", line = 404)
