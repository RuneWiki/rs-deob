...
public class class714 extends class486 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLjava/lang/Throwable;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "f", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ag", name = "g", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(III[I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III[I)V", line = 203)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III)V", line = 255)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(III)V", line = 270)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ld;BILjava/awt/Canvas;I)Lha;", line = 280)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(III[I)V", line = 322)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "()Lsj;", line = 339)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([I)V", line = 361)
    ...
    @OriginalMember(owner = "client!ag", name = "h", descriptor = "(I)V", line = 377)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lsj;)V", line = 388)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 416)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "()V", line = 430)
    public class714() {
        try {
            this.method2471();
        } catch (RuntimeException var2) {
