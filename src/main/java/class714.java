...
public class class714 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILei;)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IJ)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IB)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BLjava/lang/Object;J)V")
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(Z)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(JB)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IJLjava/lang/Object;I)V")
