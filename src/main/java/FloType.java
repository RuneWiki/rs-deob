...
@OriginalClass("MNHKFPQO")
public class FloType {

    @OriginalMember(owner = "MNHKFPQO", name = "a", descriptor = "Z")
    private boolean _flowObfuscator1 = true;

    @OriginalMember(owner = "MNHKFPQO", name = "g", descriptor = "I")
    public int texture = -1;

    @OriginalMember(owner = "MNHKFPQO", name = "h", descriptor = "Z")
    public boolean overlay = false;

    @OriginalMember(owner = "MNHKFPQO", name = "i", descriptor = "Z")
    public boolean occlude = true;

    @OriginalMember(owner = "MNHKFPQO", name = "b", descriptor = "I")
    private static int _flowObfuscator2;

    @OriginalMember(owner = "MNHKFPQO", name = "m", descriptor = "I")
    public int chroma;

    @OriginalMember(owner = "MNHKFPQO", name = "c", descriptor = "I")
    public static int count;

    @OriginalMember(owner = "MNHKFPQO", name = "o", descriptor = "I")
    public int hsl;

    @OriginalMember(owner = "MNHKFPQO", name = "j", descriptor = "I")
    public int hue;

    @OriginalMember(owner = "MNHKFPQO", name = "l", descriptor = "I")
    public int lightness;

    @OriginalMember(owner = "MNHKFPQO", name = "n", descriptor = "I")
    public int luminance;

    @OriginalMember(owner = "MNHKFPQO", name = "f", descriptor = "I")
    public int rgb;

    @OriginalMember(owner = "MNHKFPQO", name = "k", descriptor = "I")
    public int saturation;

    @OriginalMember(owner = "MNHKFPQO", name = "e", descriptor = "Ljava/lang/String;")
    public String debugname;

    @OriginalMember(owner = "MNHKFPQO", name = "d", descriptor = "[LMNHKFPQO;")
    public static FloType[] instances;

    @OriginalMember(owner = "MNHKFPQO", name = "a", descriptor = "(ILXTGLDHGX;)V")
    ...
    @OriginalMember(owner = "MNHKFPQO", name = "a", descriptor = "(ZLMBMGIXGO;)V")
    ...
    @OriginalMember(owner = "MNHKFPQO", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "MNHKFPQO", name = "a", descriptor = "(III)I")
