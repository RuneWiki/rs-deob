...
public class class166 extends class254 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(I)V", line = 60)
