...
public class class166 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lnp;I)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IBLnp;)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lwp;I)Ljava/lang/String;")
