...
public class class166 extends class341 {
    ...
    @OriginalMember(owner = "client!eha", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Loca;III)V")
    ...
    @OriginalMember(owner = "client!eha", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Ltj;[I)V")
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!eha", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(Lrl;IIII[[I[[II)V")
