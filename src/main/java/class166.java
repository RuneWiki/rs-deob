...
public class class166 extends class225 {
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lmp;Lgk;)V", line = 64)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(B)V", line = 1190)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILnj;)V", line = 1211)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lnj;II)V", line = 1239)
