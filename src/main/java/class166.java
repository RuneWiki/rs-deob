...
public class class166 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IB)Lnca;", line = 16)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(BII)V", line = 66)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(II)V", line = 127)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Ljava/io/File;ZI)[B", line = 143)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lnq;ILga;Lga;)V", line = 176)
