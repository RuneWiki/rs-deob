...
public class class166 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lm;IILha;Laia;I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!uh", name = "toString", descriptor = "()Ljava/lang/String;", line = 213)
