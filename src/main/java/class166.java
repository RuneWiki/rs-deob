...
public class class166 {
    ...
    @OriginalMember(owner = "client!pha", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!pha", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!pha", name = "c", descriptor = "(B)V", line = 73)
