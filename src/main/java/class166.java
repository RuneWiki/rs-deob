...
public class class166 extends class443 {
    ...
    @OriginalMember(owner = "client!kl", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lia;)V", line = 25)
    public class166(class81 arg0) {
        this.field2246 = arg0;
    }

    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIJ)V", line = 38)
