...
public class class166 extends class148 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lmt;Lmt;B)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILdh;I)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BIILqa;IILm;)V")
