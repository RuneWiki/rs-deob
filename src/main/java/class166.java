...
public class class166 implements class2 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILuha;Z)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILuha;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Luha;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Luha;[III)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILuha;)V")
