...
public class class166 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IZZIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BI)I", line = 185)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)Z", line = 245)
