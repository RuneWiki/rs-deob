...
public class class166 extends class314 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Ldn;I)V")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BLsl;)Z")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Ldn;B)V")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILdn;)V")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IFLac;ZI)V")
