...
public class class166 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(III)V", line = 276)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lda;IIII)Lll;", line = 121)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(B)[[[I", line = 141)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIBLri;)Lba;", line = 166)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II)[[I", line = 193)
