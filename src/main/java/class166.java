...
public class class166 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)I", line = 6)
    public static final int method1195(int arg0, int arg1) {
        return class25.field314 == null ? 0 : class25.field314[arg0][arg1] >>> 21 & 0x7F8;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BLlf;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BILlf;)V", line = 38)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)Lk;", line = 146)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IZ)Lrb;", line = 195)
