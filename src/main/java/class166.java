...
public class class166 extends class69 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIBI[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(III)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Ltb;II)V", line = 93)
    public class166(class227 arg0, int arg1, int arg2) {
        this.field2300 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIIIIB)V", line = 106)
