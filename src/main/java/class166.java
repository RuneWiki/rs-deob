...
public class class166 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BI[Lha;Ljava/lang/String;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Ljava/lang/String;[Lha;B)I", line = 133)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "([Ljava/lang/String;B[Lha;[ILjava/lang/String;)I", line = 248)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLjava/lang/String;)I", line = 505)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(CII)I", line = 515)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "([Lha;BLjava/lang/String;I)I", line = 529)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIILos;)Lgg;", line = 561)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(II)I", line = 579)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILjava/lang/String;[Lha;I)I", line = 593)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 611)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(II[Lha;Ljava/lang/String;I)I", line = 622)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "([B)V", line = 638)
