...
public class class166 extends class385 {
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "()V", line = 22)
    public class166() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIII)[B", line = 28)
    ...
    @OriginalMember(owner = "client!ok", name = "h", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "()V", line = 60)
