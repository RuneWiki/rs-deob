...
public class class166 extends class38 implements class105 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lkp;Lc;[Lju;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()Z", line = 55)
    public final boolean method283() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "sa", descriptor = "(S)Z", line = 63)
    ...
    @OriginalMember(owner = "client!qa", name = "j", descriptor = "()Z", line = 87)
    public final boolean method307() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;Lod;)V", line = 91)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I)V", line = 132)
    public final void method265(int arg0) {
        this.field2457[arg0].method103();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I[Lqp;)V", line = 138)
    ...
    @OriginalMember(owner = "client!qa", name = "m", descriptor = "()Z", line = 156)
    public final boolean method323() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 161)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpc;Lpc;FLpc;)Lpc;", line = 176)
    public final class477 method338(class477 arg0, class477 arg1, float arg2, class477 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIF)Lqp;", line = 179)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(IIIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!qa", name = "z", descriptor = "()V", line = 204)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(II)I", line = 224)
    public final int method317(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIILma;II)V", line = 229)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(I)V", line = 232)
    public final void method318(int arg0) {
        this.field2457[arg0].method115();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!qa", name = "x", descriptor = "()Z", line = 243)
    public final boolean method354() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[[I[[IIII)Lta;", line = 252)
    ...
    @OriginalMember(owner = "client!qa", name = "k", descriptor = "()V", line = 255)
    public final void method320() {
    }

    @OriginalMember(owner = "client!qa", name = "q", descriptor = "()Z", line = 263)
    public final boolean method340() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lt;Lkp;Lc;Lju;I)V", line = 266)
    ...
    @OriginalMember(owner = "client!qa", name = "SA", descriptor = "()Ljava/lang/Object;", line = 286)
    private final Object method1110() {
        return new class148();
    }

    @OriginalMember(owner = "client!qa", name = "d", descriptor = "()Z", line = 293)
    public final boolean method295() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIZ)Ll;", line = 299)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "()Lc;", line = 307)
    public final class125 method291() {
        return new class31();
    }

    @OriginalMember(owner = "client!qa", name = "t", descriptor = "()Z", line = 317)
    public final boolean method347() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "g", descriptor = "()V", line = 322)
    public final void method297() {
    }

    @OriginalMember(owner = "client!qa", name = "v", descriptor = "()V", line = 325)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lu;)V", line = 351)
    public final void method281(class54 arg0) {
        this.field2443 = (class35) arg0;
        this.method1108(arg0);
    }

    @OriginalMember(owner = "client!qa", name = "D", descriptor = "()Ln;", line = 357)
    ...
    @OriginalMember(owner = "client!qa", name = "R", descriptor = "(S)Z", line = 370)
    ...
    @OriginalMember(owner = "client!qa", name = "o", descriptor = "()Z", line = 381)
    public final boolean method328() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "f", descriptor = "(I)V", line = 386)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lkp;Z)V", line = 400)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lkp;)V", line = 430)
    ...
    @OriginalMember(owner = "client!qa", name = "A", descriptor = "()Z", line = 434)
    public final boolean method358() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpc;)V", line = 440)
    public final void method370(class477 arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "ha", descriptor = "()V", line = 443)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[I[I)Lma;", line = 451)
    ...
    @OriginalMember(owner = "client!qa", name = "i", descriptor = "()V", line = 454)
    public final void method306() {
    }

    @OriginalMember(owner = "client!qa", name = "s", descriptor = "()Z", line = 458)
    public final boolean method346() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Llm;[Ldi;Z)Lla;", line = 461)
    ...
    @OriginalMember(owner = "client!qa", name = "n", descriptor = "()Z", line = 469)
    public final boolean method327() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lc;[Lju;I)V", line = 472)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(II)I", line = 493)
    ...
    @OriginalMember(owner = "client!qa", name = "C", descriptor = "()Z", line = 499)
    public final boolean method372() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "u", descriptor = "()Z", line = 502)
    public final boolean method348() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(IIIIII)Lpc;", line = 508)
    public final class477 method298(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Z)V", line = 515)
    public final void method289(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([IIIII)Ll;", line = 521)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 559)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 606)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 626)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Z)V", line = 644)
    public final void method329(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ldi;Z)Ll;", line = 650)
    ...
    @OriginalMember(owner = "client!qa", name = "g", descriptor = "(I)Lu;", line = 728)
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 733)
    protected final void finalize() {
        this.method119();
    }

    @OriginalMember(owner = "client!qa", name = "r", descriptor = "()V", line = 737)
    public final void method343() {
    }

    @OriginalMember(owner = "client!qa", name = "h", descriptor = "()I", line = 744)
    public final int method301() {
        return 4;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Z)V", line = 754)
    public final void method282(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(FFF)V", line = 756)
    public final void method339(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ltp;IIII)Lt;", line = 763)
    ...
    @OriginalMember(owner = "client!qa", name = "f", descriptor = "()Lc;", line = 766)
    public final class125 method296() {
        return this.field2452;
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIIII)V", line = 769)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 777)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)V", line = 798)
    public final void method290(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qa", name = "B", descriptor = "()V", line = 801)
    public final void method367() {
    }

    @OriginalMember(owner = "client!qa", name = "p", descriptor = "()Z", line = 807)
    public final boolean method333() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "y", descriptor = "()Z", line = 813)
