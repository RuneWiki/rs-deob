...
public class class166 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lvf;Lpt;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)Lpt;", line = 27)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lpt;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)Lpt;", line = 91)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)Lpt;", line = 120)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(I)Lpt;", line = 146)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILvf;)V", line = 181)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(I)Lpt;", line = 195)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILpt;)V", line = 214)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(B)Z", line = 231)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "()V", line = 271)
    public class166() {
        this.field1985.field1779 = this.field1985;
        this.field1985.field1777 = this.field1985;
    }

    @OriginalMember(owner = "client!vf", name = "e", descriptor = "(I)V", line = 244)
