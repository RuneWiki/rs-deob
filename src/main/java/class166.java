...
public class class166 extends class71 {
    ...
    @OriginalMember(owner = "client!s", name = "n", descriptor = "[B")
    public byte[] field3106;

    @OriginalMember(owner = "client!s", name = "o", descriptor = "Leh;")
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Lja;)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lbg;II)Ls;")
