...
public class class166 implements Runnable {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Lr;III[Z)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ILjava/lang/String;)Lmj;")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ILeh;)V")
