...
public abstract class class166 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B)Ldn;")
    ...
    @OriginalMember(owner = "client!dfa", name = "d", descriptor = "(I)Lku;")
    ...
    @OriginalMember(owner = "client!dfa", name = "f", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!dfa", name = "h", descriptor = "(I)Lhq;")
