...
public class class166 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZIBII)V", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lfi;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLfi;Ls;)V", line = 64)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)Ls;", line = 112)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)Ls;", line = 137)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIBIIIIIILoa;I)Z", line = 159)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 413)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)Ls;", line = 432)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZLs;)V", line = 452)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)Ls;", line = 472)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/lang/String;)I", line = 494)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(B)Z", line = 518)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIILoa;IIILpe;)V", line = 541)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ls;B)V", line = 622)
    ...
    @OriginalMember(owner = "client!fi", name = "e", descriptor = "(I)V", line = 643)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(B)V", line = 666)
    ...
    @OriginalMember(owner = "client!fi", name = "f", descriptor = "(I)Ls;", line = 679)
    ...
    @OriginalMember(owner = "client!fi", name = "g", descriptor = "(I)V", line = 702)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "()V", line = 725)
    public class166() {
        this.field2454.field5348 = this.field2454;
        this.field2454.field5346 = this.field2454;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BI)Lok;", line = 737)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)V", line = 765)
