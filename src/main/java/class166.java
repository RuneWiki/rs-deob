...
public class class166 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lma;IIILhd;IJII)V", line = 23)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIBI)V", line = 85)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)I", line = 100)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(Z)I", line = 111)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 137)
    public class166() {
    }

    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lfh;)V", line = 139)
