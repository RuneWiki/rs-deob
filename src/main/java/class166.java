...
public class class166 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILtq;IZIIIZIIZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 157)
