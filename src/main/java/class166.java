...
public class class166 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Luq;IIIBJZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!g", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field2200++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(I)V", line = 60)
