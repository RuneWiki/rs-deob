...
public class class166 extends class319 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Laa;I)Lcn;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Laa;ZIILne;Lu;)Z")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Laa;Z)V")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIILaa;)Z")
