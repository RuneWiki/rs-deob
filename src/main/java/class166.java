...
public class class166 extends class125 implements class130 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III[I)V", line = 9)
    public final void method819(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1049(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 19)
    public class166() {
        this.method1048();
    }

    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()Lc;", line = 35)
