...
public class class166 extends class540 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)I", line = 4)
    public final int method941(int arg0) {
        return arg0 < 90 ? 54 : this.field2179;
    }

    @OriginalMember(owner = "client!pe", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 18)
    ...
    @OriginalMember(owner = "client!pe", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 42)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method946(arg0.getX(), arg0.getY(), true);
    }

    @OriginalMember(owner = "client!pe", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 50)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Z)Lew;", line = 59)
    public final class368 method942(boolean arg0) {
        return arg0 ? (class368) this.field2177.method244(arg0) : (class368) null;
    }

    @OriginalMember(owner = "client!pe", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 69)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method946(arg0.getX(), arg0.getY(), true);
    }

    @OriginalMember(owner = "client!pe", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 76)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method946(arg0.getX(), arg0.getY(), true);
    }

    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "(I)I", line = 94)
    public final int method944(int arg0) {
        return arg0 == 2000 ? this.field2178 : -88;
    }

    @OriginalMember(owner = "client!pe", name = "f", descriptor = "(I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!pe", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 115)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method946(arg0.getX(), arg0.getY(), true);
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!pe", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 151)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 164)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!pe", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 210)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 243)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 308)
