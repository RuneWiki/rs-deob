...
public class class166 extends class57 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Le;Z)Lum;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BILe;)Lid;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIILe;)Z")
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILe;IIZLhm;I)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Le;ILid;)V")
