...
public class class206 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)Lbf;", line = 19)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILjava/lang/String;IIBIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lgp;ILui;)V", line = 146)
