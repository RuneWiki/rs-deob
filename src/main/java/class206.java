...
public abstract class class206 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!p", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!p", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 22)
    public static final void provideLoaderApplet(Applet arg0) {
        field2390++;
        class95.field1241 = arg0;
    }

    @OriginalMember(owner = "client!p", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 31)
    ...
    @OriginalMember(owner = "client!p", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 53)
    ...
    @OriginalMember(owner = "client!p", name = "stop", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BLjava/lang/String;)V", line = 78)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BIIIIILjava/lang/String;)V", line = 106)
    ...
    @OriginalMember(owner = "client!p", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 153)
    public final void windowActivated(WindowEvent arg0) {
        field2393++;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(I)Z", line = 161)
    ...
    @OriginalMember(owner = "client!p", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 202)
    public final void windowDeactivated(WindowEvent arg0) {
        field2385++;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!p", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 245)
    public final void windowClosed(WindowEvent arg0) {
        field2382++;
    }

    @OriginalMember(owner = "client!p", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 252)
    public final void update(Graphics arg0) {
        field2394++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!p", name = "destroy", descriptor = "()V", line = 264)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Z)Z", line = 281)
    ...
    @OriginalMember(owner = "client!p", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 293)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(B)Z", line = 310)
    ...
    @OriginalMember(owner = "client!p", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 321)
    public final void focusLost(FocusEvent arg0) {
        class560.field6993 = false;
        field2384++;
    }

    @OriginalMember(owner = "client!p", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 330)
    public final void windowIconified(WindowEvent arg0) {
        field2389++;
    }

    @OriginalMember(owner = "client!p", name = "c", descriptor = "(B)V", line = 338)
    ...
    @OriginalMember(owner = "client!p", name = "start", descriptor = "()V", line = 381)
    ...
    @OriginalMember(owner = "client!p", name = "run", descriptor = "()V", line = 393)
    ...
    @OriginalMember(owner = "client!p", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 515)
    public final void windowDeiconified(WindowEvent arg0) {
        field2374++;
    }

    @OriginalMember(owner = "client!p", name = "d", descriptor = "(B)V", line = 523)
    ...
    @OriginalMember(owner = "client!p", name = "f", descriptor = "(I)Ljava/lang/String;", line = 584)
    ...
    @OriginalMember(owner = "client!p", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 595)
    public final void windowClosing(WindowEvent arg0) {
        field2401++;
        this.destroy();
    }

    @OriginalMember(owner = "client!p", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 605)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/String;IBIZIII)V", line = 622)
    ...
    @OriginalMember(owner = "client!p", name = "g", descriptor = "(I)V", line = 668)
    ...
    @OriginalMember(owner = "client!p", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 679)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ZI)V", line = 699)
    ...
    @OriginalMember(owner = "client!p", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 777)
