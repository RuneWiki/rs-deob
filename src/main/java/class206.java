...
public abstract class class206 extends class189 {
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
