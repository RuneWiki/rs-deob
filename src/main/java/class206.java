...
public class class206 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IBI)Z", line = 155)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IB)I", line = 316)
