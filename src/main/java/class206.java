...
public class class206 extends class611 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ru", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 15)
    public final Object method788(int arg0) {
        return arg0 == 14 ? this.field2453.get() : (Object) null;
    }

    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lwe;Ljava/lang/Object;I)V", line = 24)
