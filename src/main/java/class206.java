...
public class class206 extends class220 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "()V", line = 11)
    public final void method44() {
        this.field3101.field1927.glFramebufferTexture2DEXT(36160, this.field2935, 3553, 0, 0);
        this.field2935 = -1;
    }

    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lao;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lao;IIZ[[I)V", line = 36)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lao;IIZ[[BI)V", line = 65)
