...
public class class206 extends class627 {
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIII[BI)V", line = 72)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIII[F[FI[I[III)V", line = 106)
