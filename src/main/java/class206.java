...
public class class206 extends class85 {
    ...
    @OriginalMember(owner = "client!wd", name = "jb", descriptor = "Ltf;")
    public static class181 field4048 = new class181();

    @OriginalMember(owner = "client!wd", name = "kb", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(II)Llf;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIIIILka;IJ)Z")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "([BIIZ)Llf;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BILja;)V")
