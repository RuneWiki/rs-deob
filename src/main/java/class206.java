...
public abstract class class206 extends class128 {
    ...
    @OriginalMember(owner = "client!nk", name = "f", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!nk", name = "g", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)Lik;", line = 43)
    ...
    @OriginalMember(owner = "client!nk", name = "h", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(IIIZZ)V", line = 114)
