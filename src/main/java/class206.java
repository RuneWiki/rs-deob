...
public class class206 extends class260 {
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IB)V", line = 45)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(II)I", line = 59)
    public final int method129(int arg0, int arg1) {
        ++field3186;
        return ~arg1 != arg0 && super.field3829.field10089.method124(-124) != 1 ? 2 : 1;
    }

    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lgn;)V", line = 72)
    public class206(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!me", name = "d", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!me", name = "e", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(ILgn;)V", line = 106)
