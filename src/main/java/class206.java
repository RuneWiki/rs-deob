...
public class class206 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIILdw;I)Lgv;", line = 8)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(Z)V", line = 67)
