...
public abstract class class206 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lsi;Z)Lkc;", line = 49)
