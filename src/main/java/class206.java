...
public class class206 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(III[BII)V", line = 61)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BI)Ljd;", line = 90)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(III)V", line = 125)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IB)V", line = 156)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Lle;ILoi;Loi;)V", line = 208)
