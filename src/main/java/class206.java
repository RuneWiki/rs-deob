...
public class class206 extends class366 {
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(B)Z", line = 98)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lpj;Lks;)V", line = 131)
    public class206(class132 arg0, class402 arg1) {
        super(arg1);
        this.field3032 = arg0;
    }

    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIZB)V", line = 140)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIIII)V", line = 182)
