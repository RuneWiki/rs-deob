...
public class class206 extends class38 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lvt;I)V")
