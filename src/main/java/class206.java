...
public class class206 extends class508 {
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "()V", line = 7)
    public class206() {
    }

    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(III)Z", line = 25)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(I)V", line = 34)
    public class206(int arg0) {
        this.field2681 = arg0;
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lgk;IILjava/lang/String;)Lgo;", line = 42)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(III)V", line = 84)
