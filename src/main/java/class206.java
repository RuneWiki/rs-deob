...
public class class206 extends class502 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILkh;IZ)V")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Leka;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(ILeka;)V")
