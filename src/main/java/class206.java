...
public class class206 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lk;BII)V")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILk;II)Z")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIBLk;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Ljj;Lvh;)V")
