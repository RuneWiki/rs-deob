...
public class class206 extends class629 implements class89 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()[Lpp;")
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()[Ljq;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lqn;II)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lqn;I)V")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lrf;IIII)V")
