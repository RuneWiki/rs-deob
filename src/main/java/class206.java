...
public class class206 extends class340 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pb", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 18)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field2905 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 40)
