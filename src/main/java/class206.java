...
public class class206 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I[Ljava/lang/Object;I[II)V", line = 20)
    ...
    @OriginalMember(owner = "client!em", name = "toString", descriptor = "()Ljava/lang/String;", line = 77)
    public final String toString() {
        field2879++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)I", line = 100)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lin;II)Ljava/lang/String;", line = 139)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(II)V", line = 176)
