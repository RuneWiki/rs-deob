...
public class class206 extends class626 implements class31 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Ljaclib/memory/Source;IBI)Z", line = 19)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lnfa;Z)V", line = 36)
    public class206(class621 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!em", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)I", line = 53)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 66)
    public final Buffer method167(int arg0, boolean arg1) {
        field2508++;
        return arg0 == 18829 ? super.method167(18829, arg1) : null;
    }

    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)Z", line = 93)
