...
public class class206 extends class260 {
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IB)I", line = 56)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(IB)V", line = 70)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(ILfca;)V", line = 99)
    public class206(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lfca;)V", line = 123)
