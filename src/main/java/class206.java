...
public class class206 implements class11 {
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(II)Lqs;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Llt;III)Lpm;")
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(B)Loa;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)Lsh;")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Llt;Llt;Llt;)V")
