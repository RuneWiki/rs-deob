...
public class class206 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)Lml;")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lm;ILm;)V")
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)Lm;")
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(II)Lnq;")
    ...
    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(I)Lm;")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLm;)V")
    ...
    @OriginalMember(owner = "client!nk", name = "d", descriptor = "(I)Lm;")
