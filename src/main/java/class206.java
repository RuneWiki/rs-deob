...
public class class206 {
    ...
    @OriginalMember(owner = "client!cu", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    public final String toString() {
        field2969++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 17)
    public static void method1336(int arg0) {
        field2972 = null;
        int var1 = -102 % ((-arg0 - 78) / 46);
    }

    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(II)V", line = 39)
