...
public class class206 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLps;)V", line = 25)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILps;B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(I)V", line = 193)
