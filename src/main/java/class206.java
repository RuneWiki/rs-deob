...
public class class206 extends class346 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZLya;)V", line = 19)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(Z)V", line = 231)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(I)V", line = 295)
