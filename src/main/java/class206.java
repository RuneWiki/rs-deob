...
public abstract class class206 extends class28 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Lgj;I)V", line = 140)
