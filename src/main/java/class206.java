...
public class class206 extends class478 {
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IBI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)V", line = 212)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(III)V", line = 231)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lde;[I[I[IB)V", line = 250)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(IIIIII)V", line = 344)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lmo;B)Lul;", line = 359)
