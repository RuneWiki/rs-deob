...
public class class206 extends class448 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "()V", line = 4)
    public final void method1248() {
        this.field2920 = true;
    }

    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lqa;J[Lvj;[Lit;Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lqa;J)Z", line = 19)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!vc", name = "d", descriptor = "()V", line = 102)
    public static void method1253() {
        field2919 = null;
        field2915 = null;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lqa;[Lvj;Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!vc", name = "e", descriptor = "()V", line = 190)
    private final void method1256() {
        this.field2920 = false;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(J)V", line = 201)
    public final void method1257(long arg0) {
        this.field2914 = arg0;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "([Lit;Z)V", line = 206)
    ...
    @OriginalMember(owner = "client!vc", name = "f", descriptor = "()V", line = 291)
    public final void method1259() {
        this.field2929 = true;
    }

    @OriginalMember(owner = "client!vc", name = "g", descriptor = "()Lqb;", line = 301)
