...
public class class206 extends class478 {
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "()V", line = 71)
    public class206() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(II)[I", line = 165)
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILnp;I)V", line = 301)
