...
public class class206 extends class690 {
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "()V", line = 3)
    public class206() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BIII)[B", line = 19)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIB)V", line = 32)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IC)Z", line = 51)
