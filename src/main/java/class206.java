...
public class class206 extends class621 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!li", name = "d", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lgga;Llu;)V", line = 46)
