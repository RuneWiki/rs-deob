...
public class class206 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)Lem;", line = 4)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 34)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Loq;ILbu;)V", line = 94)
