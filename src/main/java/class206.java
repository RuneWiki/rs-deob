...
public class class206 extends class125 {
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(ILgp;)V")
    public class206(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lsb;")
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lgp;)V")
