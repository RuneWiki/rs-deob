...
public class class206 extends class287 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lqa;J)Z")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "()Lrd;")
    ...
    @OriginalMember(owner = "client!dea", name = "b", descriptor = "(I)Ldea;")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "([Lia;Z)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!dea", name = "c", descriptor = "()V")
    public static void method1363() {
        field3057 = null;
        field3062 = null;
    }

    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lqa;[Llh;Z)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lqa;J[Llh;[Lia;Z)V")
