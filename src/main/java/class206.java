...
public class class206 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BI)Lpv;", line = 28)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([Ljava/lang/Object;II[II)V", line = 71)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B[Lmj;I)V", line = 164)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZI)V", line = 261)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I[[[Lgf;)V", line = 278)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lpo;ILgda;Lgda;)V", line = 355)
