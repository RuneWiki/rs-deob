...
public class class206 implements class152 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IILsq;)V", line = 4)
    public final void method1406(int arg0, int arg1, class120 arg2) {
        this.method1411(arg2, arg1, arg0, (byte) -115);
        field3310++;
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IILwa;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vn", name = "e", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!vn", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ldl;IIZI)V", line = 114)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lsq;IIB)V", line = 148)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!vn", name = "g", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)Z", line = 233)
    ...
    @OriginalMember(owner = "client!vn", name = "h", descriptor = "(I)I", line = 254)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!vn", name = "i", descriptor = "(I)I", line = 290)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!vn", name = "finalize", descriptor = "()V", line = 315)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lda;)V", line = 367)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(II)V", line = 332)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IILdl;Z)V", line = 344)
    public final void method1417(int arg0, int arg1, class46 arg2, boolean arg3) {
        field3304++;
        this.method1410(arg2, arg0, arg1, arg3, 0);
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 358)
