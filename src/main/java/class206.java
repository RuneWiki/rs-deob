...
public class class206 extends class376 {
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)V", line = 21)
    public static void method1346(byte arg0) {
        int var1 = -64 / ((86 - arg0) / 38);
        field2793 = null;
    }

    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lne;)V", line = 326)
    public class206(class173 arg0) {
        this.field2781 = arg0;
    }

    @OriginalMember(owner = "client!mn", name = "d", descriptor = "(I)J", line = 41)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IBI)Z", line = 52)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Laa;Lsr;B)V", line = 71)
