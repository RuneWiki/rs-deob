...
public class class94 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lqn;I)I")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILht;ILht;)Lwc;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILht;ILht;Z)Lwc;")
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Ldn;Lsu;)V")
