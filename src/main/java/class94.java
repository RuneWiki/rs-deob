...
public abstract class class94 extends class383 {
    ...
    @OriginalMember(owner = "client!tq", name = "f", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I[Leq;)I", line = 221)
    ...
    @OriginalMember(owner = "client!tq", name = "g", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!tq", name = "f", descriptor = "(I)Z", line = 244)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)Z", line = 255)
    ...
    @OriginalMember(owner = "client!tq", name = "j", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIILrb;Lr;Z)V", line = 279)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZBLpi;Ljava/lang/String;Z)V", line = 293)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(B)Z", line = 360)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(IIIIIII)V", line = 376)
