...
public class class94 extends class380 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)Lbu;", line = 5)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)Leo;", line = 148)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(II)V", line = 174)
