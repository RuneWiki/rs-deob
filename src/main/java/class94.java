...
public class class94 extends OutputStream {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZLjava/awt/Color;ZLjava/awt/Color;Ljava/lang/String;ILjava/awt/Color;)V", line = 87)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!km", name = "write", descriptor = "(I)V", line = 180)
