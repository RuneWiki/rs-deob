...
public class class94 extends class471 implements class381 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BLwm;)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILwm;I)Lgn;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(IIIIIIIIIILhb;)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lwm;I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIBLwm;)Z")
