...
public class class94 extends class551 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ln", name = "g", descriptor = "(I)V", line = 41)
