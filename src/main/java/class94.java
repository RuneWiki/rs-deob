...
public class class94 extends class392 implements class200 {
    ...
    @OriginalMember(owner = "client!ra", name = "finalize", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()Lq;", line = 19)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III[I)V", line = 24)
