...
public class class94 extends class111 implements class57 {
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(Loa;I)Lew;")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Leca;Lkr;IZI)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lkea;I)V")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Loa;Lqd;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IZLoa;)Lba;")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIILva;Loa;ZI)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Loa;B)Laca;")
