...
public class class94 extends class130 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(II)V", line = 47)
    public class94(int arg0, int arg1) {
        this.field1503 = arg0;
        this.field1498 = arg1;
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Z)I", line = 58)
    ...
    @OriginalMember(owner = "client!ud", name = "f", descriptor = "(I)I", line = 73)
    public final int method797(int arg0) {
        field1496++;
        return arg0 >= -59 ? -67 : class438.method2717(261784, this.field1503);
    }

    @OriginalMember(owner = "client!ud", name = "g", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)Z", line = 94)
