...
public class class94 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljava/lang/String;ZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lha;BLha;)V", line = 93)
