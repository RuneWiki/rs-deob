...
public class class94 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "(Loea;Luea;)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIILr;)Z")
