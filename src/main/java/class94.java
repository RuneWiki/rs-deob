...
public class class94 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Z)I", line = 19)
    public final int method784(boolean arg0) {
        field1330++;
        return arg0 ? this.field1322 & 0x7 : 23;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(JI)V", line = 73)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIIIZI)V", line = 108)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "()V", line = 205)
    public class94() {
    }

    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lkk;)V", line = 207)
