...
public class class94 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)[Leha;", line = 6)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)[Lcha;", line = 41)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lrg;ZLrg;)V", line = 130)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 146)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIBIILha;II)V", line = 167)
