...
public class class94 extends OutputStream {
    ...
    @OriginalMember(owner = "client!gg", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field1128++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIZIIIIIZIILdg;)V", line = 15)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BILqm;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(III)V", line = 212)
