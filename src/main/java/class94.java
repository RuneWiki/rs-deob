...
public class class94 extends class189 implements class620 {
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(I)J")
    ...
    @OriginalMember(owner = "client!pia", name = "e", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!pia", name = "c", descriptor = "(I)C")
    ...
    @OriginalMember(owner = "client!pia", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)I")
