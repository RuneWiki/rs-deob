...
public class class94 extends class212 {
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Ldh;)V")
    public class94(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dba", name = "d", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lha;IIB)V")
    ...
    @OriginalMember(owner = "client!dba", name = "e", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(ILdh;)V")
