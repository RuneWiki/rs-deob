...
public class class94 extends class513 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Leo;)V", line = 6)
    public static final void method642(class321 arg0) {
        class365.field4690 = arg0;
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)Z", line = 11)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)Lsc;", line = 33)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(B)I", line = 71)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(II)V", line = 101)
    public class94(int arg0, int arg1) {
        this.field1376 = arg1;
        this.field1372 = arg0;
    }

    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)Z", line = 112)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IB)Z", line = 124)
