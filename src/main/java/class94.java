...
public class class94 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(II)I", line = 143)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "()[F", line = 153)
    public final float[] method669() {
        return this.field1220[this.method670()];
    }

    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "()V", line = 157)
    public class94() {
    ...
    @OriginalMember(owner = "client!vga", name = "c", descriptor = "()I", line = 301)
