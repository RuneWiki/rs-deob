...
public class class94 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIILuq;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILhp;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lhp;II)V")
