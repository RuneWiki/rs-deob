...
public class class94 extends class434 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lha;I)Ltd;")
