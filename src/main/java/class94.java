...
public class class94 extends class124 {
    ...
    @OriginalMember(owner = "client!hc", name = "f", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(IIIIIF)V", line = 15)
    public class94(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BLr;)I", line = 33)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IF)V", line = 110)
