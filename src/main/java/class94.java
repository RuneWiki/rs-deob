...
public class class94 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILil;IZ)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILil;B)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILnr;IIII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lil;Ljava/lang/String;I)I")
