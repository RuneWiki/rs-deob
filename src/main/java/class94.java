...
public class class94 extends class204 {
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lfs;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(ILfs;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lae;IIIIZB)V")
