...
public class class94 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lec;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Lec;)V", line = 10)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "()V", line = 56)
    public class94() {
        this.field1480[0] = 0;
