...
public class class94 implements Runnable {
    ...
    @OriginalMember(owner = "client!sb", name = "run", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "()Z", line = 22)
    public final boolean method632() {
        return this.field1298 == null || !this.field1292 && this.field1298.method3953(0);
    }

    @OriginalMember(owner = "client!sb", name = "c", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!sb", name = "d", descriptor = "()J", line = 34)
    public final long method634() {
        return this.field1291;
    }

    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class94(int arg0, class548 arg1) {
        this.field1293 = arg0;
        this.field1290 = arg1;
    }

    @OriginalMember(owner = "client!sb", name = "e", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Loi;)V", line = 138)
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "()V", line = 150)
