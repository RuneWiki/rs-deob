...
public class class94 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)Ltl;", line = 20)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IB)V", line = 69)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Ler;ILjn;)V", line = 108)
    public class94(class90 arg0, int arg1, class668 arg2) {
        this.field1302 = arg2;
        this.field1302.method3805(32, false);
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIIIIIIIII)V", line = 90)
