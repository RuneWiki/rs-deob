...
public class class94 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lnfa;ZIZLnfa;)I")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)Lgu;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILofa;)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IILofa;)V")
