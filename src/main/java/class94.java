...
public class class94 extends class766 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "([I[BILria;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "()V", line = 123)
    public class94() {
    }

    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "([B)V", line = 126)
