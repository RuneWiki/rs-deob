...
public class class94 extends class271 {
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lvd;IIIII)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lvd;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lvd;IIII)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lga;Lok;Z)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lvd;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lvd;IIIIZ[BIZ)V")
