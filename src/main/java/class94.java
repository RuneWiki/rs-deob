...
public class class94 extends class34 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "()V", line = 3)
    public final void method717() {
        this.field1595 = true;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "()V", line = 25)
    public final void method720() {
        this.field1587 = true;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lqa;J[Lwv;[Lnk;Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "()V", line = 36)
    private final void method722() {
        this.field1587 = false;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(J)V", line = 39)
    public final void method723(long arg0) {
        this.field1588 = arg0;
    }

    @OriginalMember(owner = "client!wk", name = "e", descriptor = "()Lsh;", line = 46)
    public final class49 method724() {
        return this.field1596;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lqa;J)Z", line = 49)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "([Lnk;Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!wk", name = "f", descriptor = "()V", line = 185)
    public static void method727() {
        field1583 = null;
        field1592 = null;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lqa;[Lwv;Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!wk", name = "g", descriptor = "()V", line = 283)
