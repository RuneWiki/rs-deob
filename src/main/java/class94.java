...
public class class94 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BILns;)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IZ)Lra;")
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Lqg;ILvd;)V")
