...
public class class94 extends class470 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BII)Ldn;", line = 8)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IB)V", line = 223)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)V", line = 432)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)I", line = 473)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BI)I", line = 487)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)Lma;", line = 503)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZIIII[[[Lut;)Z", line = 603)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)V", line = 931)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)V", line = 977)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(III)V", line = 998)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(ILpd;Lpd;Llq;Ldk;IIZ)V", line = 1100)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(I)I", line = 1020)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(BI)[B", line = 1045)
    ...
    @OriginalMember(owner = "client!hs", name = "f", descriptor = "(I)I", line = 1067)
