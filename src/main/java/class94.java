...
public class class94 extends class7 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)Lse;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Ljd;Z)I")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lmd;)V")
    public class94(class321 arg0) {
        this.field1143 = arg0;
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Le;[[BLlf;[[B[[B[[BII[[IZILlf;I)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lmo;I)V")
