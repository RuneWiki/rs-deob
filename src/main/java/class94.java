...
public class class94 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILha;IILvga;BBI)Lka;")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lha;IIIZIBIILvga;Ls;BLs;I)Lka;")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILs;ILvga;ILha;Ls;IIIIZZ)Lka;")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lha;IIIILvga;I)Lka;")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BILee;)V")
