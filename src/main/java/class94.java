...
public class class94 extends class115 {
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 35)
    public class94() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!ld", name = "h", descriptor = "(I)V", line = 90)
