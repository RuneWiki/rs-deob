...
public class class94 extends class393 implements class201 {
    ...
    @OriginalMember(owner = "client!ra", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()Lq;", line = 28)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 32)
    public class94() {
        this.method905();
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III[I)V", line = 37)
