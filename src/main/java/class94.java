...
public class class94 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIZII)V", line = 6)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIII[BZI[BI)V", line = 32)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZIIII)Lhr;", line = 76)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLcm;)I", line = 118)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)V", line = 142)
