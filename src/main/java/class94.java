...
public class class94 extends class189 implements class201 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)I", line = 18)
    public final int method755(int arg0) {
        ++field1544;
        return arg0 != -20843 ? -79 : this.field1542;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILm;Lci;ILjava/awt/Canvas;)Lqa;", line = 29)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)J", line = 40)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)I", line = 61)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "([BIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lqg;I[BIZ)V", line = 94)
    public class94(class321 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field1542 = arg1;
    }

    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(B)V", line = 104)
