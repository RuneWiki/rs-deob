...
public abstract class class94 {
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Lno;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Lno;ILjaclib/memory/Buffer;IZ)V")
