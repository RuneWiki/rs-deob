...
public class class94 extends class694 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjr;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILql;)V", line = 41)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 245)
    public class94() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)[I", line = 248)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IB)V", line = 350)
