...
public class class94 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZI)V", line = 27)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)Lcw;", line = 58)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 163)
    public class94(class331 arg0, int arg1, class438 arg2) {
        this.field1357 = arg2;
        this.field1362 = this.field1357.method2645(1, 4);
    }

    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)V", line = 145)
