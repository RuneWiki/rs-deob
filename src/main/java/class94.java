...
public class class94 extends class760 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lwea;IIIII)V")
    ...
    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(III)Lkp;")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIJ)Lds;")
