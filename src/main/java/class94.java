...
public abstract class class94 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIIIIIZII)Z", line = 11)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)Z", line = 83)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lfe;Z)Z", line = 102)
