...
public class class94 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Ljk;I)V", line = 207)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIBIFIIZI)[[I", line = 253)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(III)V", line = 285)
