...
public class class94 extends class167 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "()V", line = 6)
    public final void method599() {
        field1365.method220(this.field1364, super.field2476);
    }

    @OriginalMember(owner = "client!il", name = "d", descriptor = "()V", line = 10)
    public final void method601() {
        field1365.method223(24068, this.field1364);
    }

    @OriginalMember(owner = "client!il", name = "b", descriptor = "()V", line = 13)
    public final void method603() {
        field1365.method221(1871, this.field1364);
    }

    @OriginalMember(owner = "client!il", name = "e", descriptor = "()V", line = 16)
    public static void method617() {
        field1365 = null;
    }

    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Ldq;I)V", line = 19)
    public class94(class14 arg0, int arg1) {
        field1365 = arg0.method135((byte) 27);
        this.field1364 = arg1;
    }

    @OriginalMember(owner = "client!il", name = "c", descriptor = "()I", line = 24)
    public final int method602() {
        return field1365.method225(false, this.field1364);
    }

    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 27)
