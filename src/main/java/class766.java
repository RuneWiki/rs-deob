...
public class class766 extends class620 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)J", line = 15)
    ...
    @OriginalMember(owner = "client!it", name = "h", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!it", name = "g", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Z)I", line = 68)
