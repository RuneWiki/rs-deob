...
public class class766 extends class518 {
    ...
    @OriginalMember(owner = "client!iba", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(II)[[I", line = 20)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILjc;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "()V", line = 101)
    public class766() {
        this(0);
    }

    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(I)V", line = 105)
