...
public class class766 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(BLe;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 27)
    public static final synchronized void method4211(byte arg0) {
        int var1 = 15 % ((arg0 - 59) / 42);
        field10519++;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZI)V", line = 67)
    public static final synchronized void method4213(boolean arg0, int arg1) {
        field10520 = arg0;
        int var2 = -100 / ((-arg1 - 54) / 53);
    }

    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)V", line = 76)
