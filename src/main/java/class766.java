...
public class class766 extends class112 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IIIII)V", line = 3)
    public final void method4240(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field10553 = arg0;
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "()V", line = 14)
    public static void method4241() {
        field10542 = null;
        field10548 = null;
    }

    @OriginalMember(owner = "client!sia", name = "b", descriptor = "()V", line = 18)
    private final void method4242() {
        this.field10545 = false;
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "([Lir;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!sia", name = "c", descriptor = "()Laf;", line = 112)
    public final class460 method4244() {
        return this.field10554;
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(J)V", line = 115)
    public final void method4245(long arg0) {
        this.field10546 = arg0;
    }

    @OriginalMember(owner = "client!sia", name = "d", descriptor = "()V", line = 118)
    public final void method4246() {
        this.field10552 = true;
    }

    @OriginalMember(owner = "client!sia", name = "e", descriptor = "()V", line = 121)
    public final void method4247() {
        this.field10545 = true;
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lha;J)Z", line = 132)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lha;J[Lmk;[Lir;Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!sia", name = "f", descriptor = "()V", line = 190)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lha;)V", line = 226)
    ...
    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(IZ)Lsia;", line = 238)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class766(int arg0, boolean arg1) {
        this.method4248(arg0, arg1);
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lha;[Lmk;Z)V", line = 261)
    ...
    @OriginalMember(owner = "client!sia", name = "g", descriptor = "()Laf;", line = 340)
