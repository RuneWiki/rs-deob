...
public class class766 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZZ)V", line = 288)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZIBBI)Lte;", line = 317)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lwq;II)Ljava/lang/String;", line = 360)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lqm;ZB)V", line = 386)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)V", line = 462)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)V", line = 490)
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(I)Z", line = 507)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 523)
    ...
    @OriginalMember(owner = "client!ql", name = "e", descriptor = "(I)I", line = 537)
    public final int method4222(int arg0) {
        field10552++;
        return arg0 <= 123 ? 57 : this.field10553.method2479(true) + this.field10561.method2479(true);
    }

    @OriginalMember(owner = "client!ql", name = "f", descriptor = "(I)Z", line = 549)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(B)V", line = 560)
    ...
    @OriginalMember(owner = "client!ql", name = "g", descriptor = "(I)I", line = 576)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(B)V", line = 586)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)V", line = 617)
