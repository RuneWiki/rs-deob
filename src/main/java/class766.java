...
public class class766 extends class319 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(III[B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I[BII)V", line = 14)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lvv;Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!ql", name = "finalize", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)Z", line = 118)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 127)
