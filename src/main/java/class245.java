...
public class class245 extends class636 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "([BIILjava/lang/String;IB)I", line = 15)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)Leg;", line = 161)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!te", name = "d", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Luca;IIIIII)V", line = 330)
