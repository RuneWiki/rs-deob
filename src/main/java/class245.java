...
public class class245 extends class334 {
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 15)
    public class245() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIBIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II)[I", line = 223)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZLol;)V", line = 250)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BIIIIII)V", line = 322)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I[[I)V", line = 337)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZI)[[I", line = 387)
