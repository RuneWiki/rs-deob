...
public class class245 extends class12 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(JILen;IZ)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IILjf;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Len;Lnr;Lpl;J)V")
