...
public class class245 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lg;II)Lfo;")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "()Ljk;")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lvt;)V")
