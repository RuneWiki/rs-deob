...
public class class245 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIZ)I", line = 48)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZI)Lgr;", line = 99)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 160)
