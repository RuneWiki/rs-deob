...
public class class245 {
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(II)Liv;")
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIILfe;IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(Lsj;IZLin;Lin;)V")
