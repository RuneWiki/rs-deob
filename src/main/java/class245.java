...
public abstract class class245 {
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(II)Z", line = 17)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(II)Z", line = 33)
    ...
    @OriginalMember(owner = "client!uha", name = "c", descriptor = "(II)Z", line = 96)
    ...
    @OriginalMember(owner = "client!uha", name = "d", descriptor = "(III)Lica;", line = 109)
    ...
    @OriginalMember(owner = "client!uha", name = "f", descriptor = "(III)I", line = 120)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "([[II)V", line = 135)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(III)V", line = 156)
