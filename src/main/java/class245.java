...
public class class245 extends class377 {
    ...
    @OriginalMember(owner = "client!oba", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(II)[I", line = 23)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IILji;)V", line = 73)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(CB)I", line = 100)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!oba", name = "f", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "()V", line = 319)
    public class245() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ZI)[I", line = 326)
    ...
    @OriginalMember(owner = "client!oba", name = "g", descriptor = "(I)V", line = 350)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(II)Z", line = 361)
