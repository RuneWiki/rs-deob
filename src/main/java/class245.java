...
public class class245 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;)V", line = 13)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljava/applet/Applet;BLjava/lang/String;)Ljava/lang/Object;", line = 22)
