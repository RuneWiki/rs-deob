...
public class class245 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Lsb;", line = 102)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 139)
    public static void method1474(byte arg0) {
        int var1 = -63 % ((-arg0 - 20) / 38);
        field2886 = null;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)Z", line = 148)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)V", line = 159)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IB)V", line = 196)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZIIILpc;I[II)Lqt;", line = 226)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lmja;ILbt;Lbt;)V", line = 268)
