...
public class class245 extends class260 {
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lwia;B)V")
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lgn;)V")
