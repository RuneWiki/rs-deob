...
public class class245 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)V", line = 23)
    public void method680(int arg0) throws Exception {
        field3357++;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "()V", line = 30)
    public void method682() throws Exception {
        field3351++;
    }

    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "()V", line = 158)
    public void method681() throws Exception {
        field3361++;
    }

    @OriginalMember(owner = "client!kv", name = "c", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)V", line = 210)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIB)V", line = 363)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BI)V", line = 385)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lmi;I)V", line = 403)
    ...
    @OriginalMember(owner = "client!kv", name = "c", descriptor = "()I", line = 414)
    public int method677() throws Exception {
        field3348++;
        return this.field3374;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "([II)V", line = 424)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "()V", line = 582)
    public void method679() {
        field3356++;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BC)Z", line = 595)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BZIII)V", line = 606)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 882)
    public void method678(Component arg0) throws Exception {
        field3350++;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZLmi;)V", line = 889)
