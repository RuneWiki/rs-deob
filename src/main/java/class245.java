...
public class class245 extends class70 implements class423 {
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)J", line = 33)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Ljj;ILjaclib/memory/Buffer;IZ)V", line = 45)
    public class245(class66 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field3541 = arg1;
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I[BBI)V", line = 55)
    ...
    @OriginalMember(owner = "client!je", name = "d", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Ljj;I[BIZ)V", line = 80)
    public class245(class66 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field3541 = arg1;
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIB)Z", line = 99)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(I)I", line = 120)
