...
public class class245 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZLnk;I)I")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILkk;)Z")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Liu;ZI)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZIBBI)Ljj;")
