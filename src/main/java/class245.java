...
public class class245 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lbt;B)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILbt;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Leo;III)V")
