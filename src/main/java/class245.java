...
public class class245 extends class214 {
    ...
    @OriginalMember(owner = "client!mo", name = "f", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BI)[I", line = 45)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 103)
    public class245() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(III)Lwe;", line = 307)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Llk;II)V", line = 319)
    ...
    @OriginalMember(owner = "client!mo", name = "g", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B[[I)V", line = 398)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZZ)V", line = 421)
