...
public abstract class class245 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIIB)V", line = 18)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZZIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "([BIZLjava/lang/String;)I", line = 75)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIII[IIIZLvba;III[II)I", line = 120)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(III)V", line = 296)
