...
public class class245 extends class127 implements class161 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Laa;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!wg", name = "e", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Laa;Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IZIILaa;ILqh;)V", line = 66)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Laa;I)Lcn;", line = 87)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(Laa;B)V", line = 125)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Laa;IZI)Lvn;", line = 156)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)I", line = 205)
    public final int method126(int arg0) {
        ++field3406;
        return arg0 != -13482 ? 85 : this.field3390 & 65535;
    }

    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Laa;IB)Lhc;", line = 277)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIILaa;)Z", line = 292)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(B)Z", line = 314)
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "(I)Z", line = 328)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Laa;II)Lhc;", line = 343)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Laa;Lsk;IIIIZIZ)V", line = 366)
