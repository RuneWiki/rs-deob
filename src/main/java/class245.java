...
public class class245 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BI)Lrc;", line = 3)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZII)I", line = 55)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 84)
    public class245(class292 arg0, int arg1, class422 arg2) {
        this.field3935 = arg2;
        this.field3935.method2615(0, 1);
    }

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)V", line = 129)
