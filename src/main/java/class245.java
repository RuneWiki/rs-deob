...
public class class245 extends class242 {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(I)V", line = 4)
    public class245(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(FI)V", line = 9)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(FI)V", line = 24)
