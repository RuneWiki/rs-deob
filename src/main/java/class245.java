...
public class class245 extends class281 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ld;Laj;B)Z")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ZZILaj;Ld;I)[F")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Laj;IZDLd;ZIZ)[I")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IDZLaj;Ld;II)[I")
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ljp;)V")
