...
public class class245 extends class262 implements class226 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 5)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Loia;Lso;Z)V", line = 24)
    public class245(class97 arg0, class497 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field3472 = arg1;
    }

    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)Lso;", line = 32)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)Z", line = 72)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZLsm;)V", line = 91)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILgj;II)Ldc;", line = 137)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(B)I", line = 169)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)V", line = 179)
