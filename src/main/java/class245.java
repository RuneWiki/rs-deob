...
public class class245 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lih;Llc;)V")
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lih;I)V")
