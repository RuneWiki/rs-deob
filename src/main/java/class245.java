...
public class class245 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I[I[J)V", line = 28)
    public static final void method1663(int arg0, int[] arg1, long[] arg2) {
        class444.method2766(true, arg1, arg2, arg2.length - 1, arg0);
        field3469++;
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(CI)Z", line = 53)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)V", line = 78)
