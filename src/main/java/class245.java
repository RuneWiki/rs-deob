...
public abstract class class245 implements class117 {
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIZ[FI)V", line = 17)
    ...
    @OriginalMember(owner = "client!jg", name = "finalize", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I[BIII)V", line = 240)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II[III)V", line = 336)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lww;ILww;)V", line = 445)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILjava/lang/String;)V", line = 463)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLtb;)V", line = 515)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 540)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)V", line = 576)
    ...
    @OriginalMember(owner = "client!jg", name = "e", descriptor = "(I)I", line = 588)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lsb;ILkea;Lkf;IZ)V", line = 643)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)V", line = 616)
