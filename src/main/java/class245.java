...
public class class245 extends class529 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IBLtn;)V", line = 9)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "()V", line = 73)
    public class245() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dga", name = "f", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(II)[[I", line = 104)
