...
public class class245 extends class447 implements class395 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZILja;Z)Lob;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BILja;)Lrc;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IBZIILnf;Lja;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZLja;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lja;Lfb;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILja;B)Lrc;")
