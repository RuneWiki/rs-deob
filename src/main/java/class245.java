...
public class class245 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lrl;III)V", line = 72)
