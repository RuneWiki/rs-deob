...
public class class245 {
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(II)Lev;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II[Lvg;IIBIIII)V")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lai;ILic;)V")
