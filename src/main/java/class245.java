...
public class class245 extends class258 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(BLmc;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(Lim;B)V", line = 35)
