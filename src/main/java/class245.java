...
public class class245 extends class319 {
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lqj;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lla;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lpm;ZILpm;)V")
