...
public abstract class class245 extends class5 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!oq", name = "i", descriptor = "(I)V", line = 61)
