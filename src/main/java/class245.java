...
public class class245 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lre;BI)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BLre;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lje;I)V")
