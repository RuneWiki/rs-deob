...
public class class245 extends class460 implements class161 {
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lfha;Z)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILwm;I)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Ljaclib/memory/Source;BII)Z")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
