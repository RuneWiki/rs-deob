...
public abstract class class245 implements class649 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BLnd;)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lf;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)Lega;")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lhl;ILkt;Lkq;IZ)V")
