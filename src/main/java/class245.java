...
public class class245 extends class205 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!wd", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 124)
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(B)I", line = 138)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 345)
    public class245(Component arg0) {
        class238.method1620(61);
        this.method1658(-117, arg0);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BCII)V", line = 165)
    ...
    @OriginalMember(owner = "client!wd", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 183)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field3805++;
        this.method1657(0, -102, arg0);
    }

    @OriginalMember(owner = "client!wd", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 192)
    public final synchronized void focusLost(FocusEvent arg0) {
        field3802++;
        this.method1655((byte) -110, '\u0000', -1, 0);
    }

    @OriginalMember(owner = "client!wd", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 200)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method1657(1, -93, arg0);
        field3807++;
    }

    @OriginalMember(owner = "client!wd", name = "e", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IILjava/awt/event/KeyEvent;)V", line = 237)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 273)
    ...
    @OriginalMember(owner = "client!wd", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 306)
    public final void focusGained(FocusEvent arg0) {
        field3803++;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)Lvr;", line = 316)
