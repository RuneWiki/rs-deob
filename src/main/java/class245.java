...
public class class245 extends class429 {
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfu;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfu;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfu;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfu;IIII[I)V")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfu;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BILfu;III)Lwc;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZIBI[BIILfu;)Lwc;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([IBZLfu;II)Lwc;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lfu;IIIZ[I)V")
