...
public class class245 extends class535 {
    ...
    @OriginalMember(owner = "client!ws", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILwn;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "()V", line = 59)
    public class245() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(II)I", line = 62)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(II)[I", line = 73)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIB)I", line = 194)
    ...
    @OriginalMember(owner = "client!ws", name = "f", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Z)V", line = 251)
