...
public class class245 extends class80 {
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILnn;)V", line = 118)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "()V", line = 176)
    public class245() {
        super(1, true);
    }

    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(Z)V", line = 183)
