...
public class class245 extends class11 implements class338 {
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "(B)[Lff;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IILqa;Z)Len;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BLqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IILqa;I)Z")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZLqa;)Lc;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lqa;Lus;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(ILqa;)Lfm;")
