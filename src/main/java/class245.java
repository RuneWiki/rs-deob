...
public class class245 extends class311 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(CI)C", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIIIII[[[BIILea;II)V", line = 399)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "([[B[[BI[[B[[I[[BLea;IBZLdn;Ldn;I)V", line = 436)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(Z)V", line = 1240)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I[J[I)V", line = 1250)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZ)V", line = 1269)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "()V", line = 1352)
    public class245() {
    }

    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 1354)
