...
public class class245 extends class634 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "()V", line = 69)
    public class245() {
        super(0, false);
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILig;Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IILdia;IZLoh;I)V", line = 128)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BLwha;)Z", line = 143)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIB)V", line = 166)
