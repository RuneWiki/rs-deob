...
public class class343 extends class623 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILig;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lig;I[I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lig;B)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IBLig;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)Lsq;")
