...
public class class343 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZLgt;)[Lkw;", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 63)
