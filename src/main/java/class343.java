...
public class class343 {
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!mv", name = "d", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BIII)I", line = 178)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lei;ILri;)V", line = 210)
