...
public class class343 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BIII)Z", line = 13)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)V", line = 152)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 164)
    public final void method2126(int arg0) {
        field5074++;
        this.field5078 &= arg0;
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(III)Z", line = 173)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BLgk;)V", line = 184)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(Z)I", line = 229)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "([SBI)[S", line = 248)
