...
public class class343 extends class603 {
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "()V", line = 14)
    public class343() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIB)V", line = 33)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BII)V", line = 46)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIBI)[B", line = 77)
