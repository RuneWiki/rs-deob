...
public class class343 {
    ...
    @OriginalMember(owner = "client!vt", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4917++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(III)Z", line = 13)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(I)V", line = 62)
    private class343(int arg0) {
        this.field4916 = arg0;
    }

    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(III)Lnba;", line = 71)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIB)Z", line = 78)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(FFFI)I", line = 90)
