...
public abstract class class343 extends class593 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I[Lraa;)I")
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(Lha;I)Z")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lvs;ZZ)V")
