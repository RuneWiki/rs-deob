...
public class class343 extends class31 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(CIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lh;Lfa;[Liq;Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(CIIIZLem;II)V", line = 231)
