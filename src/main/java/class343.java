...
public class class343 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)Lea;", line = 39)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)Lea;", line = 75)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(ILea;)V", line = 93)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "()V", line = 154)
    public class343() {
        this.field4783.field8064 = this.field4783;
        this.field4783.field8061 = this.field4783;
    }

    @OriginalMember(owner = "client!vv", name = "d", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!vv", name = "e", descriptor = "(I)Lea;", line = 166)
    ...
    @OriginalMember(owner = "client!vv", name = "f", descriptor = "(I)Lea;", line = 193)
