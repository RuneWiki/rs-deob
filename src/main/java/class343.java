...
public class class343 extends class371 {
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "()V", line = 81)
    public class343() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IBLps;)V", line = 12)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([BIIIII)Z", line = 88)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BI)[[I", line = 180)
    ...
    @OriginalMember(owner = "client!bg", name = "g", descriptor = "(I)V", line = 276)
