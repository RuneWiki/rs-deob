...
public class class343 extends class93 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)J", line = 14)
    public final long method573(boolean arg0) {
        field4976++;
        return arg0 ? this.field4973 : 31L;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BI)I", line = 57)
    ...
    @OriginalMember(owner = "client!hv", name = "d", descriptor = "(I)C", line = 84)
