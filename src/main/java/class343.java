...
public class class343 extends class17 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BILjp;)Z")
    ...
    @OriginalMember(owner = "client!kp", name = "d", descriptor = "(III)Lhm;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lwm;II)V")
