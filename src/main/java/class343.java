...
public class class343 extends class432 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lbu;II)Lui;", line = 17)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)J", line = 46)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)I", line = 113)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(B)I", line = 130)
    public final int method2187(byte arg0) {
        field5154++;
        return arg0 == 11 ? this.field5160 : -56;
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIBI)I", line = 144)
