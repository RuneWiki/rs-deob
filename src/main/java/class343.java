...
public class class343 extends class137 implements class497 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Ltk;Lwha;Z)V")
    public class343(class347 arg0, class285 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field4333 = arg1;
    }

    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)Lwha;")
