...
public abstract class class343 extends class381 {
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "()I", line = 6)
    public int method1736() {
        return 0;
    }

    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(B)Z", line = 16)
    public final boolean method2171(byte arg0) {
        return arg0 <= 57 ? false : false;
    }

    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!pq", name = "e", descriptor = "(I)I", line = 37)
    public final int method2173(int arg0) {
        return arg0 == 1 ? 1 : 24;
    }

    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lhd;)V", line = 48)
