...
public class class343 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILdh;B)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ZILmv;Loq;I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ZLdh;)V")
