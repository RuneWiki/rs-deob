...
public class class343 extends class601 {
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lqea;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLha;Ld;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Ldc;I)Lgr;")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(ILqea;)V")
