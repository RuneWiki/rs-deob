...
public class class343 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)[[[I", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lqk;II)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lqt;Lha;Lda;BZLjava/lang/String;)V", line = 103)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(III)V", line = 327)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZ)[[I", line = 223)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IILsl;)Ljava/lang/String;", line = 291)
