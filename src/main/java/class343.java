...
public class class343 extends class508 {
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IBILeo;)V", line = 17)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(I)V", line = 104)
