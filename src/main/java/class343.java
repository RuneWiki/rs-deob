...
public class class343 extends class424 {
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "()V", line = 3)
    public class343() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pa", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lrg;BI)V", line = 28)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(IB)[I", line = 85)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IZ)[[I", line = 132)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(B)V", line = 182)
