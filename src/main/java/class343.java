...
public class class343 extends class424 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IILfa;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!gm", name = "QA", descriptor = "()I", line = 119)
    public final int method1159() {
        field5034++;
        return this.field5037.field6239;
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "()I", line = 190)
    public final int method1154() {
        field5044++;
        return this.field5037.field6241;
    }

    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lpea;IIII)V", line = 743)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lpea;II[III)V", line = 753)
    ...
    @OriginalMember(owner = "client!gm", name = "ba", descriptor = "(IIIIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!gm", name = "sa", descriptor = "(FFFFFFIII)V", line = 345)
    ...
    @OriginalMember(owner = "client!gm", name = "t", descriptor = "(III)V", line = 414)
    ...
    @OriginalMember(owner = "client!gm", name = "EA", descriptor = "(IIII)V", line = 446)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 466)
    ...
    @OriginalMember(owner = "client!gm", name = "AA", descriptor = "()I", line = 565)
    public final int method1160() {
        field5052++;
        return this.field5037.field6239 + this.field5056 + this.field5031;
    }

    @OriginalMember(owner = "client!gm", name = "GA", descriptor = "(IIIIII)V", line = 573)
    ...
    @OriginalMember(owner = "client!gm", name = "I", descriptor = "(IIIII)V", line = 589)
    ...
    @OriginalMember(owner = "client!gm", name = "KA", descriptor = "(IIIIIII)V", line = 640)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "()I", line = 764)
