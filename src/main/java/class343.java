...
public class class343 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IB)Leka;", line = 10)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lgia;ILaj;)V", line = 89)
