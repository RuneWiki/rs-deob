...
public class class343 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Z)[I", line = 15)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BILjava/awt/Frame;III)V", line = 34)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "()V", line = 55)
    public class343() {
        this.field5071.initialize(null);
    }

    @OriginalMember(owner = "client!saa", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 64)
