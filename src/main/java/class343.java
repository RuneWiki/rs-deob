...
public abstract class class343 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFIILi;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIII)V", line = 29)
    public final void method2169(int arg0, int arg1, int arg2, int arg3) {
        this.method372(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFIILi;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(IIII)V", line = 68)
    public final void method2172(int arg0, int arg1, int arg2, int arg3) {
        this.method380(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFII)V", line = 77)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)V", line = 84)
