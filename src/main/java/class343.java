...
public class class343 extends class488 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BLdf;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 169)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILut;)V", line = 196)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(ILut;)V", line = 220)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(II)V", line = 244)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(IB)V", line = 266)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lya;IZFI)V", line = 295)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(II)V", line = 320)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lut;I)V", line = 342)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)V", line = 367)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)V", line = 390)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IB)V", line = 417)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z)V", line = 478)
