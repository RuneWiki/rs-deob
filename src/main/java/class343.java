...
public class class343 extends class23 {
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Llh;[III)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IILsf;II)V")
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Llh;[IIIII)V")
