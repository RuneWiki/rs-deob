...
public abstract class class343 extends class420 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "([Luf;Z)I")
    ...
    @OriginalMember(owner = "client!vv", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!vv", name = "d", descriptor = "(ILha;)Z")
