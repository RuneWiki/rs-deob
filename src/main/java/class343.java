...
public class class343 extends class601 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lmc;II)V")
    ...
    @OriginalMember(owner = "client!as", name = "e", descriptor = "(B)Ldj;")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIILha;III)V")
