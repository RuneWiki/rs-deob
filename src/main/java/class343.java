...
public class class343 extends class483 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!qba", name = "e", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(III)Z", line = 166)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIIIIII)V", line = 178)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "(III)Z", line = 614)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIIII)V", line = 631)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lmca;ZIBZILmca;)I", line = 649)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lmh;II)V", line = 682)
