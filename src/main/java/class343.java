...
public class class343 extends class377 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljava/lang/Object;ZI)[B", line = 45)
    ...
    @OriginalMember(owner = "client!bfa", name = "e", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IILji;)V", line = 95)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "()V", line = 109)
    public class343() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IB)[[I", line = 113)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IZI)V", line = 153)
