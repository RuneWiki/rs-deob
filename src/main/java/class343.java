...
public class class343 extends class210 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lbf;)Luq;", line = 3)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
