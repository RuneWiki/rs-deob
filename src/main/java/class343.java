...
public class class343 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIILra;ZII)V", line = 14)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIZ[[[Ldn;II)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 354)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)I", line = 366)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(CII)I", line = 378)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)I", line = 408)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 430)
    public class343() {
    }

    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lbk;)V", line = 432)
