...
public class class343 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)V", line = 6)
    public static void method2163(byte arg0) {
        int var1 = -38 % ((arg0 - 57) / 62);
        field4817 = null;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZ)I", line = 21)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lha;IBIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIIIII)Z", line = 90)
