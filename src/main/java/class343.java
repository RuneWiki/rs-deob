...
public class class343 implements class351 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IFFLmfa;IIFIFFI)[B")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)Lgb;")
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lgj;Ljava/lang/String;)V")
