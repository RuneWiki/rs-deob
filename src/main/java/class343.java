...
public class class343 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IILjava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILlm;Lii;Llm;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIBI)V", line = 60)
