...
public class class343 extends class271 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!gd", name = "f", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(IIIIIF)V", line = 75)
