...
public class class343 extends class293 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III)B", line = 28)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIZLmi;F)V", line = 47)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!t", name = "d", descriptor = "(II)V", line = 121)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILqa;)V", line = 202)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(Lqa;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lia;B)V", line = 251)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lqa;I)V", line = 422)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(B)V", line = 447)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)V", line = 460)
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "(II)V", line = 489)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BLkt;[[B)V", line = 512)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Z)Ldf;", line = 593)
