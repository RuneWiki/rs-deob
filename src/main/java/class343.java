...
public class class343 extends class322 {
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(ILch;)V", line = 3)
    public class343(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(Z)I", line = 34)
    public final int method2217(boolean arg0) {
        ++field4792;
        return arg0 ? 98 : super.field4451;
    }

    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(B)Z", line = 45)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B)I", line = 62)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 73)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I[[[BI[IB[I[IIIIZIII[I[IZI)V", line = 97)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(II)V", line = 540)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)I", line = 560)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BLpr;III)V", line = 575)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lch;)V", line = 627)
