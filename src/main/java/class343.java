...
public class class343 extends class208 {
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lge;IIIIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILge;IIII)Lef;", line = 16)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lge;IIIZ[I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZII[BLge;III)Lef;", line = 56)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lge;IIIII[BI)V", line = 76)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lge;IIIIZ[BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lge;IIIIIZ)V", line = 112)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lge;IIII[I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II[IBZLge;)Lef;", line = 149)
