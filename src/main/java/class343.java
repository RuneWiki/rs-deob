...
public class class343 extends class231 implements class375 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lbba;I)V")
    ...
    @OriginalMember(owner = "client!eca", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lcu;Lem;III[B)V")
