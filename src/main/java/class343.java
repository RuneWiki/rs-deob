...
public class class343 extends class220 {
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "()V", line = 61)
    public class343() {
        super(3, false);
    }

    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(II)[I", line = 65)
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(I)V", line = 118)
    public final void method440(int arg0) {
        class261.method1638(arg0);
        ++field5030;
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBLil;)V", line = 126)
    ...
    @OriginalMember(owner = "client!pq", name = "e", descriptor = "(I)V", line = 166)
