...
public class class343 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)Ljk;", line = 8)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(III)V", line = 92)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lwj;ILwu;Lwu;)V", line = 110)
