...
public abstract class class343 extends class256 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(Lha;B)Z")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "([Ltn;B)I")
