...
public class class343 extends class189 implements class243 {
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lqg;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lqg;ILjaggl/memory/NativeBuffer;IZ)V")
