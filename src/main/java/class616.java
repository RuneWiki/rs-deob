...
public class class616 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "([BI[B)V", line = 226)
