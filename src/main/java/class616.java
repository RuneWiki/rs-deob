...
public class class616 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BI)I", line = 50)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Ltu;)V", line = 99)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BIIII)V", line = 75)
