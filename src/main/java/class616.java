...
public class class616 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lie;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZLjava/lang/String;ZLnga;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Z)V", line = 238)
    public class616(boolean arg0) {
        this.field8628 = arg0;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BIIII)V", line = 207)
