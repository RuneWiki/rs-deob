...
public class class616 implements class107 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "()V", line = 197)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IB)I", line = 53)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IZZLjava/awt/Component;)V", line = 86)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I[I)V", line = 135)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)V", line = 167)
