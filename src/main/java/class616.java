...
public class class616 {
    ...
    @OriginalMember(owner = "client!hn", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field9109++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)Z", line = 36)
