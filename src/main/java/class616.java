...
public class class616 {
    ...
    @OriginalMember(owner = "client!mfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(IZ)V", line = 422)
    public class616(int arg0, boolean arg1) {
        this.field8231 = arg1;
        this.field8240 = arg0;
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(II)I", line = 70)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 110)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IZIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 406)
