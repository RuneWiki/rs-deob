...
public class class616 extends class125 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILoca;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(ILgp;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Lgp;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIIIBILha;)Lka;")
