...
public class class616 extends OutputStream {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Loea;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "write", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lrc;Z)Z")
