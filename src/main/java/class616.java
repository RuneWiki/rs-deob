...
public class class616 extends class420 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "([Lf;B)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILek;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ZLwv;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lwv;)V")
