...
public class class616 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(II[IIIBII)V", line = 149)
