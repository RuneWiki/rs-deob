...
public abstract class class616 implements class138 {
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!dv", name = "finalize", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)V", line = 119)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lel;IZ)V", line = 275)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)I", line = 151)
    public int method503(int arg0) {
        field8352++;
        return arg0 == -3267 ? this.field8359 : 44;
    }

    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(I)J", line = 162)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)Z", line = 176)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 209)
    ...
    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(B)V", line = 257)
