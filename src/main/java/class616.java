...
public class class616 extends class210 implements class615 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Llf;ILjaclib/memory/Buffer;IZ)V", line = 5)
    public class616(class250 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field8312 = arg1;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([BIZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Llf;I[BIZ)V", line = 52)
    public class616(class250 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field8312 = arg1;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIB)Z", line = 60)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(Z)J", line = 88)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIII)Z", line = 114)
