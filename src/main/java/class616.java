...
public class class616 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILpc;)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lpc;I)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lpc;IILaf;)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lpc;II)V")
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Lpc;I)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILpc;I)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIIIBLha;I)Lka;")
