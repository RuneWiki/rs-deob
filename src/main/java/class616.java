...
public class class616 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIBIBILba;)Lba;")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(BLeh;)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IBIIILba;)Lba;")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Leh;II)V")
