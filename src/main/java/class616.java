...
public class class616 implements class716 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILd;Ljava/awt/Canvas;ILnd;)Lha;", line = 7)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILjava/lang/String;ILda;II)I", line = 45)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(BLbi;[Lpf;)Lit;", line = 56)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ZB)V", line = 126)
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(I)Z", line = 164)
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Lwda;Ljg;)V", line = 174)
