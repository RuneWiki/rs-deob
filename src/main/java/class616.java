...
public abstract class class616 {
    ...
    @OriginalMember(owner = "client!uj", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 31)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([BBI)V", line = 62)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lpq;I[BIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lpq;ILjaclib/memory/Buffer;IZ)V", line = 106)
