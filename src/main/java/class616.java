...
public class class616 extends class221 {
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lac;IIII)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lac;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lac;IIIII)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IILha;IIIII)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lac;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lac;IIIIZ[IIIZ)V")
