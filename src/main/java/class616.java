...
public class class616 extends class334 {
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(Lgh;Lea;IILsea;BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(JB)V", line = 105)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(II)[I", line = 185)
    ...
    @OriginalMember(owner = "client!hja", name = "<init>", descriptor = "()V", line = 256)
    public class616() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hja", name = "c", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!hja", name = "b", descriptor = "(B)V", line = 273)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(IZLol;)V", line = 285)
