...
public class class616 extends class674 {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lpj;Ljava/lang/Object;I)V", line = 5)
    public class616(class157 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field8324 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 24)
