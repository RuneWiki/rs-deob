...
public class class616 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(BLmfa;)V", line = 9)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIILida;)V", line = 47)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 111)
