...
public class class616 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(B)Lds;", line = 5)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ZJ)Lds;", line = 76)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)Lds;", line = 111)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([Lds;I)I", line = 152)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IJLds;)V", line = 182)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([BIZ)[B", line = 237)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IB)I", line = 273)
    ...
    @OriginalMember(owner = "client!pl", name = "e", descriptor = "(I)Lds;", line = 379)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Ljava/lang/String;Lrs;BI)Lwaa;", line = 415)
