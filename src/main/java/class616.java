...
public class class616 extends class212 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lmf;Lmf;ZIB)I", line = 6)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!mfa", name = "d", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!mfa", name = "d", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Ldh;)V", line = 139)
    public class616(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(ILdh;)V", line = 142)
    public class616(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II)V", line = 147)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(II)I", line = 157)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(III)V", line = 171)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILat;)Ljava/lang/String;", line = 208)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Z)V", line = 232)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ZIII)I", line = 246)
    ...
    @OriginalMember(owner = "client!mfa", name = "e", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "([BIII[[B[[B[I[I)I", line = 307)
