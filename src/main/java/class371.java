...
public class class371 extends class234 {
    ...
    @OriginalMember(owner = "client!ra", name = "d", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 17)
    ...
    @OriginalMember(owner = "client!ra", name = "d", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ra", name = "c", descriptor = "()I", line = 57)
    public final int method1557() {
        return this.field5133 - (this.field5137.available() >> (class373.field5246 ? 2 : 1));
    }

    @OriginalMember(owner = "client!ra", name = "b", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()V", line = 100)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 114)
