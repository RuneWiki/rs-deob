...
public class class371 extends class109 implements class193 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IILuo;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Luo;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILuo;)V", line = 52)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZLuo;)Laj;", line = 63)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)Z", line = 110)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IBIILrr;Luo;Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(Luo;I)V", line = 146)
    ...
    @OriginalMember(owner = "client!sk", name = "e", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILuo;I)Lmj;", line = 175)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)I", line = 198)
    ...
    @OriginalMember(owner = "client!sk", name = "g", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Luo;Lgm;IIIIIIZI)V", line = 220)
    ...
    @OriginalMember(owner = "client!sk", name = "d", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(B)Z", line = 256)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IZC)I", line = 266)
