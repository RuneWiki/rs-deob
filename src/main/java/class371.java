...
public abstract class class371 extends class316 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZILvc;IILuq;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIIIIIIILvc;)V", line = 172)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "()V", line = 310)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(IIIIIII)V", line = 451)
