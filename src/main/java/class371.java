...
public class class371 extends class192 implements class518 {
    ...
    @OriginalMember(owner = "client!up", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([Lo;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lza;III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)I", line = 66)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(BLza;)V", line = 77)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILza;)V", line = 109)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 123)
    public final void method31(int arg0) {
        ++field5725;
        int var2 = 98 % ((arg0 - 57) / 48);
    }

    @OriginalMember(owner = "client!up", name = "c", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(ILza;)Lsr;", line = 147)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILza;I)Le;", line = 188)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)I", line = 199)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)I", line = 211)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)I", line = 222)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lza;Lp;IIIIIZIIIIII)V", line = 233)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BLza;)V", line = 243)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(B)V", line = 254)
