...
public class class371 implements class37 {
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(I)Lqea;", line = 4)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Luh;)V", line = 94)
    public class371(class415 arg0) {
        this.field5236 = arg0;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(B)Z", line = 115)
