...
public abstract class class371 extends class496 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lwca;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BII)[I", line = 39)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IBLps;)V", line = 62)
    public void method81(int arg0, byte arg1, class428 arg2) {
        field5358++;
        int var4 = -56 / ((arg1 + 15) / 39);
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIB)Z", line = 92)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BI)[[I", line = 103)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(BI)[I", line = 130)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)V", line = 145)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(BII)[[I", line = 171)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Z)V", line = 206)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIZ)V", line = 257)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(Z)I", line = 274)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(IZ)V", line = 287)
