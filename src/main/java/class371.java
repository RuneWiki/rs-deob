...
public class class371 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lni;", line = 3)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([IIZ)Lhh;", line = 16)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I[III)Lhh;", line = 72)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lhe;Lhe;)V", line = 194)
    public class371(class239 arg0, class239 arg1) {
        this.field5568 = arg0;
        this.field5562 = arg1;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(III[I)Lhh;", line = 125)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([III)Lhh;", line = 169)
