...
public class class371 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljava/lang/String;BLjava/applet/Applet;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;[Ljava/lang/Object;I)Ljava/lang/Object;", line = 12)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZLjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 22)
