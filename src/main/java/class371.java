...
public class class371 extends OutputStream {
    ...
    @OriginalMember(owner = "client!jba", name = "write", descriptor = "(I)V", line = 14)
    public final void write(int arg0) throws IOException {
        field4788++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IIB[B)[B", line = 38)
