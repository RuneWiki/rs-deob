...
public class class371 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lcea;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IILcea;)V", line = 47)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(III)Z", line = 70)
