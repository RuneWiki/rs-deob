...
public abstract class class371 extends class510 {
    ...
    @OriginalMember(owner = "client!hr", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(B)Z", line = 28)
    public final boolean method118(byte arg0) {
        field5281++;
        return arg0 == 102 ? false : false;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZIII)Lqf;", line = 69)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 111)
