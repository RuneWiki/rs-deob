...
public class class371 extends class626 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILrca;)I")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)Lnd;")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lnd;)V")
