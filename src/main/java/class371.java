...
public class class371 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Les;IB)V", line = 9)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Les;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(B)Ltha;", line = 140)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(B)V", line = 169)
