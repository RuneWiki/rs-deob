...
public class class371 extends class468 {
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lte;IIIIZ[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!rp", name = "e", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lte;IIIZ[I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lte;IIIIIIZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lte;IIII[I)V", line = 73)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lte;IIIII[BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lsj;", line = 107)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lte;IIIIIZ)V", line = 129)
