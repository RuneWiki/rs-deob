...
public class class371 implements Runnable {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IILwf;)Lvg;", line = 22)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lvg;B)V", line = 64)
    ...
    @OriginalMember(owner = "client!um", name = "run", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lwf;II)Lvg;", line = 163)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lwf;II[B)Lvg;", line = 181)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lul;)V", line = 210)
