...
public class class371 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIZ)Z", line = 60)
