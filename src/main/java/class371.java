...
public class class371 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BI)Lrc;", line = 15)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I[[BLjs;)V", line = 60)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIBI)I", line = 132)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ZIZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(ILul;Lul;)V", line = 715)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(I)V", line = 704)
