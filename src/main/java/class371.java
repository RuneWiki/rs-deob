...
public class class371 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lqia;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)Lns;", line = 32)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(B)Lns;", line = 54)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "()V", line = 80)
    public class371() {
    }

    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Lqia;)V", line = 83)
