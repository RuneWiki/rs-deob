...
public class class371 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)Luu;", line = 7)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(Z)Lab;", line = 69)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IBLfd;Ljava/lang/String;)Ltd;", line = 95)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZLab;)V", line = 122)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)Lab;", line = 139)
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "()V", line = 219)
    public class371() {
