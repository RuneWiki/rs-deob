...
public class class371 extends class8 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!te", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 5)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIIZIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)I", line = 147)
    ...
    @OriginalMember(owner = "client!te", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 182)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field5311++;
        this.method2214(true, arg0);
    }

    @OriginalMember(owner = "client!te", name = "d", descriptor = "(I)Z", line = 193)
    ...
    @OriginalMember(owner = "client!te", name = "f", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(B)I", line = 226)
    public final int method55(byte arg0) {
        field5309++;
        return arg0 == -37 ? this.field5296 : -69;
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Z)Ldw;", line = 238)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ZLjava/awt/event/MouseEvent;)V", line = 249)
    ...
    @OriginalMember(owner = "client!te", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 268)
    ...
    @OriginalMember(owner = "client!te", name = "d", descriptor = "(B)I", line = 278)
    ...
    @OriginalMember(owner = "client!te", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 289)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILjm;Z)V", line = 316)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IBII)V", line = 483)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 807)
    public class371(Component arg0, boolean arg1) {
        this.method2217((byte) 80, arg0);
        this.field5324 = arg1;
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 505)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(I)Z", line = 519)
    ...
    @OriginalMember(owner = "client!te", name = "e", descriptor = "(B)V", line = 530)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)Z", line = 556)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lza;Lti;BLfk;)V", line = 567)
    ...
    @OriginalMember(owner = "client!te", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 714)
    ...
    @OriginalMember(owner = "client!te", name = "e", descriptor = "(I)V", line = 746)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 762)
    ...
    @OriginalMember(owner = "client!te", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 784)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2214(true, arg0);
        field5297++;
    }

    @OriginalMember(owner = "client!te", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 795)
