...
public class class371 extends Canvas {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILed;)V", line = 3)
    ...
    @OriginalMember(owner = "client!or", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 30)
    public final void update(Graphics arg0) {
        field5243++;
        this.field5245.update(arg0);
    }

    @OriginalMember(owner = "client!or", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 38)
    public final void paint(Graphics arg0) {
        field5247++;
        this.field5245.paint(arg0);
    }

    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 50)
