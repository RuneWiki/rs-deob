...
public class class371 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILtq;Z)Lds;", line = 3)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lwl;Z)Z", line = 41)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 142)
