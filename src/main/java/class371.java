...
public class class371 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(IIIIIII)I", line = 26)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(III)I", line = 62)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZIIIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIIILlf;ZIZIII)V", line = 267)
