...
public class class371 extends class184 implements class679 {
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Ltba;Lpn;Ljg;II)V")
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIIIZILpn;I[B)V")
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Ltba;II[III)V")
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Ltba;Lpn;II[FII)V")
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Ltba;Lpn;II[BII)V")
