...
public class class371 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lod;[[BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILjava/lang/String;)I", line = 152)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 174)
