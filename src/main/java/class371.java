...
public class class371 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(B)Lfi;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)Lfi;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III)Lt;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I[Lfi;)I")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(JB)Lfi;")
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(B)Lfi;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(JLfi;B)V")
