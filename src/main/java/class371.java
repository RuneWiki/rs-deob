...
public class class371 {
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Ldia;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Ldia;Ljaclib/memory/Buffer;)V", line = 21)
