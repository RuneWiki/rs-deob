...
public class class371 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIIB[ILvi;[IZIIIIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lkea;ILkea;)I", line = 184)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZLjava/lang/String;I)Z", line = 226)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lbo;III)V", line = 275)
