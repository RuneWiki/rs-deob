...
public abstract class class371 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(III)Z", line = 64)
