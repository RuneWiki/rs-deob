...
public class class486 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "([BB)[B", line = 16)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIILoi;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZIB)I", line = 128)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BIII)I", line = 161)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)I", line = 174)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "()V", line = 200)
    public class486() {
    }

    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lsv;)V", line = 211)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)I", line = 224)
