...
public class class486 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B[S)[S", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIIIIIIIIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BII)I", line = 131)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)V", line = 155)
    public static void method2864(byte arg0) {
        int var1 = 127 % ((-arg0 - 81) / 36);
        field7047 = null;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(III)V", line = 166)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIII)I", line = 182)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(FIFIFIIIII[FII)V", line = 207)
