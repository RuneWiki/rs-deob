...
public class class486 extends class329 {
    ...
    @OriginalMember(owner = "client!jp", name = "e", descriptor = "(B)V", line = 4)
    public static void method2707(byte arg0) {
        field6568 = null;
        int var1 = 122 / ((arg0 - 31) / 45);
    }

    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(IIIIIF)V", line = 19)
    public class486(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BIIIII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IF)V", line = 66)
