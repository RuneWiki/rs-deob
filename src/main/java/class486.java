...
public class class486 {
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(I)J", line = 50)
    public static final long method2857(int arg0) {
        field7096++;
        return arg0 == 47 ? class141.field2029.method705((byte) 63) : -115L;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIZII)Lq;", line = 94)
