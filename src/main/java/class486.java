...
public class class486 extends class498 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I[Lhm;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/lang/String;)V", line = 110)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(II)V", line = 153)
