...
public class class486 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lcaa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lgq;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lrh;B)V", line = 36)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIIFIII[FI)V", line = 70)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)Z", line = 120)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)Lmm;", line = 134)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 198)
    public class486(String arg0) {
        this.field6920 = arg0;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lcaa;Z)V", line = 177)
