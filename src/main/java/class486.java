...
public class class486 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BLae;)V", line = 7)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILpl;IIJZII)V", line = 18)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Ld;", line = 48)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)Ld;", line = 70)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 91)
    public class486() {
    }

    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lae;)V", line = 93)
