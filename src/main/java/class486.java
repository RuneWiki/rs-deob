...
public class class486 extends class80 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(III[B)I", line = 44)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)Z", line = 58)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IJ)V", line = 85)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lw;III[Z)Z", line = 104)
    ...
    @OriginalMember(owner = "client!cb", name = "finalize", descriptor = "()V", line = 141)
    protected final void finalize() {
        this.method633(9);
        field6578++;
    }

    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([BZII)V", line = 164)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(B)V", line = 175)
    public static void method2724(byte arg0) {
        field6574 = null;
        int var1 = 13 / ((arg0 + 12) / 43);
    }

    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 184)
