...
public class class486 extends class65 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(III)Luw;")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lla;IIZIII)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lqv;")
