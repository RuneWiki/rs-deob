...
public class class486 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B[I[[B[B[[B[III)I", line = 15)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)I", line = 93)
    public static int method2826(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZI)V", line = 103)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lrga;III)V", line = 121)
