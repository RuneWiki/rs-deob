...
public class class486 extends class141 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lhaa;IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIII)V", line = 83)
