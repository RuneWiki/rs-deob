...
public class class486 extends class359 {
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "()I", line = 28)
    public final int method1992() {
        return this.field7111 - (this.field7113.available() >> (class149.field2109 ? 2 : 1));
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 36)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 112)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "()V", line = 134)
