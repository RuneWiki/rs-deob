...
public class class486 extends class145 {
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "([BI[Lrl;Lha;II)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IILrl;IBLha;I)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IIIII)Lop;")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ILtn;ILha;I[IIIIII)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ZLha;I)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(Lha;IIIIIIIILrl;I)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ILha;I[BIII[Lrl;III)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(Ltn;II[ILha;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
