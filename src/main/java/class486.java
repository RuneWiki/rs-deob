...
public class class486 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(II)Lrca;")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IZLis;)V")
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lgn;ILvo;Lvo;)V")
