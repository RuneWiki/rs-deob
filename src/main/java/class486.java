...
public class class486 extends class739 {
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZI)[I", line = 37)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lsl;IB)V", line = 249)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "()V", line = 330)
    public class486() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rt", name = "a", descriptor = "([[[Ldn;I)V", line = 342)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(B)V", line = 442)
    ...
    @OriginalMember(owner = "client!rt", name = "e", descriptor = "(B)V", line = 473)
