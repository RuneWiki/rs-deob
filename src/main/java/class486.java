...
public class class486 extends class72 {
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(ILcq;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lcq;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILwq;[[B)V")
