...
public class class486 extends class327 implements class381 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lwm;I)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BLwm;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IILwm;)Lgn;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIBLwm;)Z")
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lwm;Lct;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IZLwm;Z)Lij;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILwm;I)Lgn;")
