...
public abstract class class486 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!gda", name = "c", descriptor = "(B)Z", line = 479)
    ...
    @OriginalMember(owner = "client!gda", name = "d", descriptor = "(B)V", line = 492)
