...
public class class486 {
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)I", line = 71)
