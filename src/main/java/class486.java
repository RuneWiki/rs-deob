...
public class class486 extends class298 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(I)V", line = 49)
    private class486(int arg0) {
        super(0, false);
        this.method2875(0, arg0);
    }

    @OriginalMember(owner = "client!vs", name = "e", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IILvt;)V", line = 75)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(II)[[I", line = 102)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IC)Z", line = 149)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "()V", line = 159)
    public class486() {
        this(0);
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILvt;)Lcq;", line = 162)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(II)V", line = 176)
