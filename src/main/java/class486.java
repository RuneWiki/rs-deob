...
public class class486 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!rs", name = "finalize", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lbv;J[Lfk;)V", line = 89)
