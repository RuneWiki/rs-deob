...
public class class486 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IILji;)V", line = 8)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lji;B)V", line = 133)
