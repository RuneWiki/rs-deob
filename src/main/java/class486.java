...
public class class486 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lga;II)Ljq;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lio;)V")
