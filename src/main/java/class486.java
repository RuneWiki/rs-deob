...
public class class486 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIIIZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lcf;ZZI)V", line = 74)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILee;)Z", line = 127)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lnj;B)V", line = 139)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 170)
    public class486() {
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lnj;)V", line = 186)
