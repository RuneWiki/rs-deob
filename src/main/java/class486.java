...
public class class486 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)Lip;", line = 6)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILs;)V", line = 85)
    public static final void method2838(int arg0, class292 arg1) {
        class622.field8777[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(I)V", line = 93)
