...
public abstract class class490 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIILha;IIBLli;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "([Ljava/lang/Object;I[JIB)V", line = 94)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(III)Z", line = 154)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIILjava/lang/Class;)Lfb;", line = 183)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 209)
