...
public class class490 extends class521 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILhv;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "e", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lhg;Ldn;)V", line = 89)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ul", name = "g", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ul", name = "f", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)Z", line = 199)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III)V", line = 210)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)V", line = 227)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 243)
