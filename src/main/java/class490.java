...
public class class490 extends class659 {
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "([B)V", line = 39)
