...
public class class490 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lnk;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "([B[BIIII)I", line = 120)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I[BIII[B)I", line = 243)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "([B)V", line = 394)
