...
public class class490 extends class632 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lbia;)Lnp;", line = 6)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
