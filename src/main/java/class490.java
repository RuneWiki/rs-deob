...
public class class490 extends class28 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "([[BILm;)V", line = 3)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "()V", line = 52)
    public class490() {
    }

    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(J)V", line = 55)
    public class490(long arg0) {
        this.field6607 = arg0;
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIII)V", line = 67)
