...
public class class490 extends class637 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IBI)Lsda;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)Luo;")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(ILcw;Lcw;Lhca;Lje;I[BIZ)V")
