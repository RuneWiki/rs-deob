...
public class class490 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B[S)[S", line = 24)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(II)I", line = 93)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B[B)[B", line = 121)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lqm;", line = 194)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(II)V", line = 217)
