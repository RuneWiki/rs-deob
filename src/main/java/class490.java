...
public class class490 implements Runnable {
    ...
    @OriginalMember(owner = "client!um", name = "run", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)Lai;", line = 89)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 106)
