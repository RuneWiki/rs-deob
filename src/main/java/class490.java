...
public class class490 extends class251 {
    ...
    @OriginalMember(owner = "client!hb", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)Lwt;", line = 17)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lmq;)V", line = 53)
