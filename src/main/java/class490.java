...
public class class490 extends class682 {
    ...
    @OriginalMember(owner = "client!wq", name = "E", descriptor = "(Lha;IIIIZ)V", line = 2)
    public final void method2173(class425 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IILwh;[I[I[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(II)I", line = 506)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III[[ZZ)V", line = 536)
    ...
    @OriginalMember(owner = "client!wq", name = "BA", descriptor = "()V", line = 583)
    public final void method2175() {
        this.field6958 = null;
        this.field6973 = null;
    }

    @OriginalMember(owner = "client!wq", name = "DA", descriptor = "(Lha;IIIIZ)V", line = 587)
    public final void method2181(class425 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!wq", name = "O", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 590)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)Z", line = 1084)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIZLqb;Lwh;[I[I[I[I)V", line = 1100)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III[[ZZI)V", line = 1943)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lst;IIII[[I[[II)V", line = 1988)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIIIIII[[ZLqb;Lwh;[I[I)V", line = 2038)
                ...
                if (arg7[var18 - arg3][var19 - arg4]) {
                    if (this.field6967[var18][var19] != null) {
                        ...
                        for (int var25 = 0; var25 < var23.field9315; ++var25) {
                            ...
                            } else if (var23.field9310 != null && var23.field9310[var25] != -1) {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)V", line = 2171)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIIIIII[[Z)V", line = 2177)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ltg;[I)V", line = 2191)
    public final void method2185(class334 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)V", line = 2196)
    ...
    @OriginalMember(owner = "client!wq", name = "v", descriptor = "(IILha;)Lha;", line = 2211)
    public final class425 method2171(int arg0, int arg1, class425 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 2225)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 2460)
    public final boolean method2176(class425 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(IIIIIII[[ZLqb;Lwh;[I[I)V", line = 2464)
