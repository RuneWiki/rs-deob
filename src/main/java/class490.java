...
public class class490 extends class503 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBI)V", line = 18)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIB)V", line = 37)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(IIIIIII)V", line = 83)
