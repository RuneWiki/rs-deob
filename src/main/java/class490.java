...
public class class490 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)Loo;", line = 4)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)Loo;", line = 25)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lko;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)[Lne;", line = 101)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "()V", line = 193)
    public class490() {
    }

    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lko;)V", line = 195)
