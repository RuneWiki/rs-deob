...
public class class490 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)V", line = 8)
    public static void method2854(byte arg0) {
        int var1 = -95 % ((79 - arg0) / 44);
        field6845 = null;
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILun;)V", line = 37)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILdc;)V", line = 57)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IILun;)V", line = 121)
