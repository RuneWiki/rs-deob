...
public class class490 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lco;Z)Lle;", line = 16)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "()V", line = 155)
    public class490() {
        this.field6889.field4714 = this.field6889;
        this.field6889.field4709 = this.field6889;
    }

    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)I", line = 36)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IB)V", line = 60)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)Lkr;", line = 75)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lkr;B)V", line = 95)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)Lkr;", line = 112)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)V", line = 133)
