...
public class class490 implements class444 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Ldaa;Ldaa;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BIJ)Leq;", line = 40)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(III)I", line = 64)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)Lhl;", line = 115)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Ljava/lang/String;Lmp;Lfe;IIIIIIIIII)V", line = 132)
