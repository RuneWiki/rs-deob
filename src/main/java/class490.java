...
public class class490 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I[Lf;ILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZZBLjava/lang/String;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "([Lf;[Ljava/lang/String;[ILjava/lang/String;I)I", line = 1035)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIC)I", line = 1284)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II)I", line = 1300)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Ljava/lang/String;II[Lf;)I", line = 1319)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)V", line = 1330)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILjava/lang/String;I[Lf;)Ljava/lang/String;", line = 1342)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 1463)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZI)Z", line = 1481)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIILjava/lang/String;[Lf;)I", line = 1496)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILjava/lang/String;[Lf;)I", line = 1513)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "([B)V", line = 1614)
