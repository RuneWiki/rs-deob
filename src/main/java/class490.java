...
public class class490 extends OutputStream {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(III)I", line = 86)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!jp", name = "write", descriptor = "(I)V", line = 183)
    public final void write(int arg0) throws IOException {
        field6295++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZ[B)V", line = 199)
