...
public class class490 extends class551 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([ILhca;I[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLps;)V", line = 133)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZLps;)V", line = 153)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(III)Z", line = 201)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II[BIIIII[B)V", line = 215)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZI)I", line = 260)
