...
public class class490 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "()V", line = 89)
    public static void method2825() {
        field6845 = null;
    }

    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "()V", line = 137)
    private static final void method2827() {
        field6847 = 0;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lza;[II[I[I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lza;[IIII[I[I)V", line = 227)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "([III)V", line = 268)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lza;[II)V", line = 317)
