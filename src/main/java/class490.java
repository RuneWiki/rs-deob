...
public class class490 extends class602 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(B)[B", line = 19)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(III)[B", line = 34)
