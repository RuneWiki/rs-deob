...
public class class490 extends class405 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(FII[FIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!gl", name = "e", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Ldh;Lli;)V", line = 126)
