...
public class class490 extends class35 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(III[[ZB)V", line = 10)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIBIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BS)V", line = 241)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lnm;Llg;Lma;[I)V", line = 254)
