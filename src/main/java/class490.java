...
public class class490 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIIIIIII[Lcr;)V", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 666)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 724)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 740)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lmd;B)V", line = 772)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)Ljava/lang/String;", line = 794)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZILmd;)V", line = 838)
