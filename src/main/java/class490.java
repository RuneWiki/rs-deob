...
public class class490 extends class281 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)J", line = 19)
    ...
    @OriginalMember(owner = "client!qg", name = "e", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "([[SD)V", line = 43)
