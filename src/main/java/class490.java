...
public class class490 implements Runnable {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I[Ljava/lang/String;II)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIIILha;)V", line = 71)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!kp", name = "run", descriptor = "()V", line = 184)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 219)
