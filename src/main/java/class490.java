...
public class class490 extends class128 {
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lpg;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZLdc;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lpg;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lpg;II)V")
