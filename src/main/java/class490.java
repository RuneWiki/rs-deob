...
public class class490 extends class623 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lig;ZI)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lig;I)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BLjava/lang/String;I)V")
