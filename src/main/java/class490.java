...
public class class490 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILofa;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIZIIIII)Z", line = 63)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lfc;Ljava/awt/Component;III)Len;", line = 94)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lofa;I)V", line = 191)
