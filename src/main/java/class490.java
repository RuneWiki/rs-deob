...
public class class490 extends class682 implements class484 {
    ...
    @OriginalMember(owner = "client!wi", name = "h", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILha;)V", line = 18)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!wi", name = "f", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIILha;)Z", line = 106)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(Z)I", line = 129)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lha;I)Lmaa;", line = 141)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lha;IB)Lka;", line = 169)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BILka;II)Lrn;", line = 194)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BII)V", line = 211)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(ILha;)V", line = 230)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IBLha;Z)Lbaa;", line = 242)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(Lha;I)Lrn;", line = 274)
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(Z)Z", line = 290)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IZI)V", line = 305)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lit;Z)Z", line = 320)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)I", line = 446)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z)I", line = 458)
    ...
    @OriginalMember(owner = "client!wi", name = "e", descriptor = "(I)I", line = 476)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)I", line = 487)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BLha;)V", line = 502)
