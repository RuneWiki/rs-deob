...
public class class490 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([SZ)[S", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II[Ll;Ljava/lang/String;)I", line = 23)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I[Ll;BILjava/lang/String;)I", line = 53)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 72)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)I", line = 83)
    public final int method2868(int arg0, int arg1) {
        field7150++;
        return arg0 >= -80 ? -2 : this.field7146[arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILem;)V", line = 95)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(II[Ll;Ljava/lang/String;)I", line = 123)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(II[Ll;Ljava/lang/String;)Ljava/lang/String;", line = 152)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(CZI)I", line = 297)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([Ljava/lang/String;I[Ll;Ljava/lang/String;[I)I", line = 315)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/String;I[Ll;)I", line = 559)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "([B)V", line = 674)
