...
public class class490 extends class272 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZLkm;Lkm;I)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IILfo;I)Lpq;")
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lur;)V")
