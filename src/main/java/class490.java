...
public class class490 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILkc;[II)Lnn;", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BII)Z", line = 185)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIILmha;Lmha;)V", line = 197)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)Luu;", line = 256)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(II)Z", line = 287)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 363)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(II)V", line = 337)
