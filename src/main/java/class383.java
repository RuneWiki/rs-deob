...
public class class383 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ltj;II)Lor;", line = 7)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "()[B", line = 20)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Llf;)V", line = 129)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "()V", line = 149)
    private class383() {
    }

    @OriginalMember(owner = "client!or", name = "b", descriptor = "()Lbg;", line = 83)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "()I", line = 88)
