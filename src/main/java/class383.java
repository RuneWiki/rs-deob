...
public class class383 implements Runnable {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!qf", name = "run", descriptor = "()V", line = 32)
