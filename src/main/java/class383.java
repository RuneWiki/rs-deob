...
public class class383 {
    ...
    @OriginalMember(owner = "client!uw", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 6)
    ...
    @OriginalMember(owner = "client!uw", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!uw", name = "movemouse", descriptor = "(II)V", line = 54)
    public final void movemouse(int arg0, int arg1) {
        this.field5114.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "()V", line = 59)
