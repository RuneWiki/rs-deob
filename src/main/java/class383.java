...
public class class383 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BIZLes;Les;)Lqc;")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILes;ILes;)Lqc;")
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lgq;Lbj;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
