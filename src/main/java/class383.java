...
public class class383 extends class119 implements class721 {
    ...
    @OriginalMember(owner = "client!dda", name = "e", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lha;I)Lria;", line = 15)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(Lha;B)Lc;", line = 57)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lha;B)V", line = 88)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILvs;ZILha;II)V", line = 136)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 168)
    ...
    @OriginalMember(owner = "client!dda", name = "f", descriptor = "(I)I", line = 179)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIIIIIIZ)V", line = 190)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lha;Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!dda", name = "h", descriptor = "(B)I", line = 233)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILha;)V", line = 246)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)Z", line = 274)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(B)I", line = 285)
    public final int method309(byte arg0) {
        ++field5768;
        return arg0 > -16 ? -18 : this.field5793;
    }

    @OriginalMember(owner = "client!dda", name = "i", descriptor = "(B)Z", line = 297)
    ...
    @OriginalMember(owner = "client!dda", name = "j", descriptor = "(B)I", line = 312)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lha;ZI)Lka;", line = 328)
    ...
    @OriginalMember(owner = "client!dda", name = "e", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lha;BIZ)Lqw;", line = 368)
    ...
    @OriginalMember(owner = "client!dda", name = "k", descriptor = "(B)Z", line = 402)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IBLha;I)Z", line = 417)
