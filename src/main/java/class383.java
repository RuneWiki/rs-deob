...
public class class383 extends class86 {
    ...
    @OriginalMember(owner = "client!lk", name = "e", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(CI)I", line = 13)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(III)V", line = 28)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILqa;)Llb;", line = 129)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Z)Z", line = 203)
    public final boolean method167(boolean arg0) {
        ++field5597;
        return !arg0;
    }

    @OriginalMember(owner = "client!lk", name = "f", descriptor = "(B)I", line = 220)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BLqa;)Led;", line = 242)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILqa;)Z", line = 272)
    ...
    @OriginalMember(owner = "client!lk", name = "i", descriptor = "(I)Z", line = 464)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIIIZ)V", line = 481)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lai;I)V", line = 554)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lqa;Z)V", line = 573)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 595)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(I)I", line = 622)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 656)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)I", line = 682)
    ...
    @OriginalMember(owner = "client!lk", name = "j", descriptor = "(I)V", line = 703)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(Z)Z", line = 716)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILqa;IB)Z", line = 730)
