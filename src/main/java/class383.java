...
public class class383 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Z)V", line = 45)
