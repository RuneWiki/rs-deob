...
public class class383 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)Lmg;", line = 7)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)Lqp;", line = 43)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZJ)Lmg;", line = 54)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BJLmg;)V", line = 106)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(I)V", line = 127)
