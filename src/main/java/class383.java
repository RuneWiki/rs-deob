...
public class class383 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(CI)C", line = 4)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ldfa;IB)V", line = 29)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)V", line = 358)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)I", line = 383)
