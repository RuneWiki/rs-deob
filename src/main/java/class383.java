...
public class class383 {
    ...
    @OriginalMember(owner = "client!nv", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field5928.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!nv", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!nv", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
