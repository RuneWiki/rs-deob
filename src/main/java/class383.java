...
public class class383 extends class467 implements class278 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILkm;IZILkj;B)V")
    ...
    @OriginalMember(owner = "client!dd", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(Lkm;I)V")
    public final void method197(class487 arg0, int arg1) {
        field5434++;
        int var3 = -76 / ((64 - arg1) / 59);
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(IIIIILpi;)V")
