...
public class class383 extends class5 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLjava/awt/Color;Ljava/awt/Color;Ljava/lang/String;Ljava/awt/Color;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 109)
    public class383() {
    }

    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 111)
