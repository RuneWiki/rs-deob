...
public class class383 extends class246 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIILdc;IIIZILdc;)V", line = 32)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILfg;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILat;II)V", line = 102)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)Z", line = 181)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZI)V", line = 192)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lpg;Lrk;)V", line = 224)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZB)V", line = 254)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 288)
