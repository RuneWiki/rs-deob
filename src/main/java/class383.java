...
public class class383 implements class287 {
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(II)Lqm;")
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lr;Lr;Lr;)V")
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(II)Luc;")
