...
public class class383 extends class431 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILjava/awt/Component;)Lqb;", line = 8)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BLya;I)Lt;", line = 37)
