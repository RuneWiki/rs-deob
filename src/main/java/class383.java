...
public class class383 extends class429 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Len;ZI)V")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lfc;Lgga;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lit;ILit;)V")
