...
public class class383 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lho;B[IJ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IB)Lau;")
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(ILfs;Lfs;Llo;)V")
