...
public class class383 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ZI)I", line = 4)
    public final int method2248(boolean arg0, int arg1) {
        return arg0 ? this.field5398.Present(arg1) : 100;
    }

    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;BLjagdx/IDirect3DSwapChain;)V", line = 14)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 64)
