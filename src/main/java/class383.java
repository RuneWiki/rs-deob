...
public class class383 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(II)Lwr;", line = 49)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ld", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Luea;ILpq;)V", line = 114)
