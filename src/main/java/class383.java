...
public class class383 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Li;BII)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIILi;)Z")
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(IIILi;)V")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Ltt;Ljk;)V")
