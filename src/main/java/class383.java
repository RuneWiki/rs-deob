...
public class class383 extends class337 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lic;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "([BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)F", line = 50)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "([B)V", line = 67)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "([I)Lnq;", line = 219)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "()I", line = 281)
    ...
    @OriginalMember(owner = "client!gh", name = "e", descriptor = "(I)I", line = 298)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lic;I)Lgh;", line = 325)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "([B)V", line = 340)
    ...
    @OriginalMember(owner = "client!gh", name = "f", descriptor = "(I)[F", line = 382)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lic;II)Lgh;", line = 798)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "([B)V", line = 814)
