...
public class class383 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 3)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIIBLjava/awt/Frame;)V", line = 15)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "()V", line = 35)
    public class383() {
        this.field4899.initialize(null);
    }

    @OriginalMember(owner = "client!du", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 44)
