...
public class class383 extends class532 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!uia", name = "e", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IBI)V", line = 23)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(ZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(Lwg;)V", line = 44)
    public class383(class449 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(ZB)V", line = 48)
    ...
    @OriginalMember(owner = "client!uia", name = "d", descriptor = "(B)Z", line = 66)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(ZILgaa;)V", line = 77)
