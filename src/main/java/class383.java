...
public class class383 extends class422 {
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLrk;)V", line = 36)
