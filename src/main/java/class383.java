...
public class class383 extends class207 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lrd;)V", line = 63)
    public class383(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(IB)I", line = 66)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(ILrd;)V", line = 84)
    public class383(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(B)V", line = 88)
    public static void method2378(byte arg0) {
        int var1 = 53 / ((68 - arg0) / 51);
        field5567 = null;
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!uv", name = "d", descriptor = "(I)V", line = 113)
