...
public class class383 extends class361 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIBIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "([B)V", line = 115)
    public class383(byte[] arg0) {
        this.field5391 = arg0;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "()V", line = 139)
    public static final void method2224() {
        class212.method1336(1, class409.field5785);
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIBIIIIIII)V", line = 142)
