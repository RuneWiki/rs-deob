...
public class class383 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lwea;Z[[[BIB)Z", line = 10)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIII)Lkf;", line = 81)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Loba;Z)Ljava/lang/String;", line = 115)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 145)
