...
public class class383 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Ljava/lang/String;IIIBIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(B)V", line = 74)
