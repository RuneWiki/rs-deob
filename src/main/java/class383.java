...
public class class383 extends class5 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIFIFFFIILab;F)[B")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZIIBI[[[Lvf;)Z")
