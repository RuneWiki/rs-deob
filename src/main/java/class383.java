...
public class class383 extends class106 {
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lvj;Lpo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(II)I", line = 46)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IBI)V", line = 71)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIIIIZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IILih;)V", line = 133)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZB)V", line = 150)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZI)V", line = 161)
