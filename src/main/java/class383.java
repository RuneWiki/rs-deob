...
public class class383 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILio;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BIILio;)V", line = 61)
