...
public abstract class class383 extends class49 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIBILap;ILap;)V", line = 7)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(IIIZZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!lf", name = "f", descriptor = "(I)V", line = 99)
