...
public class class383 {
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!nd", name = "c", descriptor = "(I)Z", line = 175)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IFI[BLhs;IIFFIFIFI)V", line = 189)
    ...
    @OriginalMember(owner = "client!nd", name = "d", descriptor = "(I)V", line = 241)
