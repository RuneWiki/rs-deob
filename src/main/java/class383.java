...
public class class383 extends class516 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BZ)V", line = 3)
    public final void method199(byte arg0, boolean arg1) {
        ++field5278;
        int var3 = 79 / ((arg0 - 63) / 38);
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lcb;)V", line = 32)
    public class383(class444 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lpb;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(III)V", line = 67)
    public final void method200(int arg0, int arg1, int arg2) {
        ++field5273;
        int var4 = -38 / ((-41 - arg0) / 57);
    }

    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IFFF)F", line = 93)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(B)Z", line = 105)
