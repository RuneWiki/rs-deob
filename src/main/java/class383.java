...
public class class383 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IZIBI)Lem;")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)[Ltn;")
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lvk;II)V")
