...
public class browsercontrol {
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "attach", descriptor = "(Ljava/awt/Canvas;)V", line = 16)
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "detach", descriptor = "()V", line = 25)
    public void detach() {
        this.detach0();
    }
