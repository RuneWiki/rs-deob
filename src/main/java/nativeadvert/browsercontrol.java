...
public class browsercontrol {
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "create", descriptor = "(Ljava/lang/String;)Z", line = 8)
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "iscreated", descriptor = "()Z", line = 23)
    public static boolean iscreated() {
        return iscreated;
    }

    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "set_position", descriptor = "(IIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "hide", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "navigate", descriptor = "(Ljava/lang/String;)V", line = 38)
    ...
    @OriginalMember(owner = "client!nativeadvert/browsercontrol", name = "destroy", descriptor = "()V", line = 44)
