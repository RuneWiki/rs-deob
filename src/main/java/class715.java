...
public abstract class class715 extends class577 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lcea;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "([FII)[F", line = 81)
