...
public class class715 extends class649 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILvp;)Lqi;")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lhs;)V")
    public class715(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(ILhs;)V")
