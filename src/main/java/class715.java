...
public class class715 extends class687 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(III[I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "([IIIBI)Z", line = 151)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 276)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "([IZII)Z", line = 188)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(III)Z", line = 230)
