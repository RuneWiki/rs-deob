...
public class class715 extends class66 {
    ...
    @OriginalMember(owner = "client!vha", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Luga;Leia;[Leu;[I[I)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "([B[I[IIIIIII)V")
