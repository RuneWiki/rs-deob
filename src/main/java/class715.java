...
public abstract class class715 {
    ...
    @OriginalMember(owner = "client!kha", name = "c", descriptor = "(B)Lni;")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Z)Lik;")
    ...
    @OriginalMember(owner = "client!kha", name = "d", descriptor = "(B)Lbka;")
    ...
    @OriginalMember(owner = "client!kha", name = "h", descriptor = "(I)Lqa;")
