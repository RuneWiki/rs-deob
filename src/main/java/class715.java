...
public class class715 extends class127 {
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BLvv;)Lpb;", line = 15)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lla;Z)V", line = 38)
