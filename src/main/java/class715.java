...
public class class715 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "([Lqm;I)I")
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)Lqm;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(JB)Lqm;")
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(B)Lqm;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lqm;IJ)V")
    ...
    @OriginalMember(owner = "client!qp", name = "e", descriptor = "(B)Lqm;")
