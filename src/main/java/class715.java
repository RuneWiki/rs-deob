...
public class class715 extends class682 implements class484 {
    ...
    @OriginalMember(owner = "client!bs", name = "f", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bs", name = "j", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BLha;)V", line = 57)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILha;)V", line = 67)
    ...
    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(Z)Z", line = 77)
    ...
    @OriginalMember(owner = "client!bs", name = "k", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)I", line = 107)
    public final int method1478(byte arg0) {
        ++field9925;
        return arg0 < 108 ? -75 : this.field9918.field9334;
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lha;I)Lmaa;", line = 118)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(Z)I", line = 166)
    public final int method916(boolean arg0) {
        ++field9909;
        return !arg0 ? 125 : this.field9918.method3811((byte) 110);
    }

    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIIIII)V", line = 178)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lal;Lal;B)V", line = 187)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(Lha;I)Lrn;", line = 205)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ldba;II[I)Luu;", line = 217)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BLmi;)V", line = 393)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)I", line = 405)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)V", line = 416)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIILha;)Z", line = 426)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)Z", line = 446)
    ...
    @OriginalMember(owner = "client!bs", name = "e", descriptor = "(I)I", line = 462)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z)I", line = 473)
    ...
    @OriginalMember(owner = "client!bs", name = "c", descriptor = "(ILha;)V", line = 496)
