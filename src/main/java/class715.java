...
public class class715 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lee;)V", line = 12)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(Lee;)V", line = 41)
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "()V", line = 56)
    public class715() {
        this.field9940[0] = 0;
