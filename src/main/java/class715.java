...
public class class715 extends class170 {
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIBLkba;III)V", line = 13)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IB)I", line = 26)
    public static final int method3967(int arg0, byte arg1) {
        field10068++;
        return arg1 == 122 ? arg0 >>> 8 : -17;
    }

    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(III)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lha;Ljo;IIIIIIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BLjo;)Ljava/lang/String;", line = 102)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 116)
