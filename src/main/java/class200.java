...
public abstract class class200 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lrs;IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)I", line = 60)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lph;III[Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZILcj;)V", line = 133)
