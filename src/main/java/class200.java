...
public class class200 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Leo;IIIII)V")
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(BLsi;[B)V")
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I[Lem;IIZI)V")
