...
public class class200 extends class208 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(IIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Let;IIBIIIIIII)Z", line = 58)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZII)V", line = 428)
