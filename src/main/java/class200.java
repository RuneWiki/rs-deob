...
public class class200 implements class167 {
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Lks;)V", line = 3)
    public class200(class463 arg0) {
        this.field2400 = arg0;
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IJ)V", line = 24)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIZII)V", line = 49)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)Z", line = 134)
