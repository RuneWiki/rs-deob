...
public class class200 {
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BLjo;[ILjo;)V", line = 41)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)Lcw;", line = 58)
