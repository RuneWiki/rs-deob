...
public class class200 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILug;)V", line = 52)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BILug;)V", line = 99)
