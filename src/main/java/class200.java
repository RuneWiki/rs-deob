...
public class class200 extends class42 implements Runnable {
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "([BIILuo;ZB[Lg;)V", line = 35)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lgh;)V", line = 127)
    public class200(class51 arg0) {
        this.field2361 = arg0;
    }

    @OriginalMember(owner = "client!wj", name = "run", descriptor = "()V", line = 112)
