...
public class class200 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lpn;)V")
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(JB)Lu;")
    ...
    @OriginalMember(owner = "client!sba", name = "c", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "([Lu;I)I")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(JLu;B)V")
    ...
    @OriginalMember(owner = "client!sba", name = "d", descriptor = "(B)Lu;")
