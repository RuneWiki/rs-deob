...
public class class200 extends class453 {
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "()V", line = 76)
    public class200() {
    ...
    @OriginalMember(owner = "client!rfa", name = "c", descriptor = "(I)J", line = 7)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I)J", line = 51)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(I)J", line = 64)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(JZ)I", line = 92)
