...
public class class200 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!lia", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(BLjava/lang/String;)V", line = 47)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "(BI)I", line = 82)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "(I)[Ljava/lang/String;", line = 126)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(IZ)V", line = 157)
