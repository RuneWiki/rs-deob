...
public class class200 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IBSLoq;)I")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILra;)V")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "([Loq;I)V")
