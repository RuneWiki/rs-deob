...
public class class200 extends class278 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Llh;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "()V", line = 96)
    public class200() {
        super(1, false);
    }

    @OriginalMember(owner = "client!le", name = "b", descriptor = "(II)[I", line = 100)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!le", name = "d", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(III)Z", line = 172)
