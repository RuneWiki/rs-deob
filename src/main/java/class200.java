...
public class class200 extends class216 {
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Lbia;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!fja", name = "<init>", descriptor = "(Lbia;IIIIIIIIIIIZZ)V")
