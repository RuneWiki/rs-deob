...
public class class200 extends class305 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIIBLsk;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ltq;ILns;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BZLtq;Lhm;III)V")
