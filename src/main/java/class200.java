...
public class class200 extends class134 {
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lkda;)V")
    public class200(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Lha;Ld;IIIBI)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(ILkda;)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IIILni;IZB)V")
