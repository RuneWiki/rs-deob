...
public class class200 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z[[[BIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILha;II)V", line = 322)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIII)V", line = 394)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 434)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZIILha;)Z", line = 478)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(ILha;II)V", line = 555)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZ[[ZZII)V", line = 627)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lkga;Lsm;)V", line = 806)
