...
public class class200 {
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(II)Lrfa;")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Luv;Luv;I)V")
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lgp;ILuu;)V")
