...
public class class200 extends class596 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BILrca;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lqq;II[B)V", line = 54)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Z)Llv;", line = 67)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lqq;II[I)V", line = 94)
