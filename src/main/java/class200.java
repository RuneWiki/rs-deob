...
public class class200 extends class322 {
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(FIFIIFF[BIIIFBLts;)V", line = 31)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(ILch;)V", line = 97)
    public class200(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lch;)V", line = 100)
    public class200(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)I", line = 142)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(B)Z", line = 160)
