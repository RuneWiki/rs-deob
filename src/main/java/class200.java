...
public class class200 extends class390 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IILmj;IIIILuo;III)Lmj;", line = 7)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(III)Lhh;", line = 64)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "()V", line = 87)
    public class200() {
    }

    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 91)
