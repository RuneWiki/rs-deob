...
public class class200 extends class513 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lei;IIZLei;)I", line = 8)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BIIIIIII)V", line = 153)
