...
public class class200 extends class235 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 21)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 61)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "()V", line = 139)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "()I", line = 152)
