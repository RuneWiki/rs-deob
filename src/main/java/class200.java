...
public class class200 extends class261 {
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lih;Ljq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZ)V", line = 49)
    public final void method1022(int arg0, boolean arg1) {
        int var3 = -125 % ((87 - arg0) / 37);
        ++field3182;
    }

    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZB)V", line = 62)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILkk;)V", line = 137)
    ...
    @OriginalMember(owner = "client!uk", name = "d", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "([BI)Ljava/lang/String;", line = 181)
