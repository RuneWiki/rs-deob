...
public class class200 extends class176 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I[B)Lhk;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lbr;I)Z")
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(II)Lt;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ltj;BLtj;ZI)V")
