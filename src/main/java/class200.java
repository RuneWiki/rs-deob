...
public class class200 extends class232 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILf;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lwd;I)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lf;B)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ltf;ZFII)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lf;I)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILjava/awt/Component;)Lnj;")
