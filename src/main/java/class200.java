...
public class class200 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(II)Lmia;", line = 10)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(ILla;Lla;Luf;)V", line = 135)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "([IBLln;J)Ljava/lang/String;", line = 71)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(B)V", line = 113)
