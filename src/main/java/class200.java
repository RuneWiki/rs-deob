...
public abstract class class200 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILjava/lang/String;I[Lxa;I[IILfa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BIIILjava/lang/String;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Z", line = 171)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZI)Z", line = 240)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([II[I[Lxa;I[ILjava/lang/String;I)V", line = 254)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 417)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 493)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Lxa;ILjava/lang/String;[IBIII[IIIIIILjava/util/Random;)I", line = 510)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III)V", line = 587)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II[ILjava/util/Random;IILjava/lang/String;II[Lxa;)I", line = 608)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILeh;)Lsd;", line = 650)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIILjava/lang/String;II[III[Lxa;IBIILfa;II)I", line = 667)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BI)Z", line = 772)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III[Lxa;I[ILjava/lang/String;I)V", line = 795)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIBIIILjava/lang/String;I[I[Lxa;IIIILfa;)I", line = 809)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 822)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 865)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;IZIII)V", line = 880)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Loa;Lkga;)V", line = 911)
    public class200(class651 arg0, class511 arg1) {
        this.field2908 = arg1;
        this.field2907 = arg0;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILjava/lang/String;IIII)V", line = 927)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;IIBIII)V", line = 954)
