...
public class class200 implements class343 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(II)Lv;")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BI)Lwm;")
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Ltq;Ltq;Ltq;)V")
