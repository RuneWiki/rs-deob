...
public class class200 extends IOException {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(Z)Z", line = 57)
