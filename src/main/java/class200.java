...
public class class200 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lr;BLvg;)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)Lbg;")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lkr;ILpu;Lpu;)V")
