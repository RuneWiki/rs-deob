...
public class class200 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILqa;ILc;IZIB)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZIIIIZLqa;)Lc;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lqa;Ljt;IIIIIIZI)V")
