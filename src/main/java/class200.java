...
public class class200 extends class340 implements Runnable {
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "run", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)V", line = 142)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Lqc;)V", line = 231)
    public class200(class126 arg0) {
        this.field2963 = arg0;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(Z)V", line = 187)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILnm;ILvc;B)V", line = 253)
