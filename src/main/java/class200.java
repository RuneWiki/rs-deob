...
public class class200 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IB)I", line = 63)
