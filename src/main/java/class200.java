...
public class class200 extends class18 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IILqa;B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 37)
    public static void method1359(byte arg0) {
        field2889 = null;
        int var1 = -87 / ((22 - arg0) / 58);
    }

    @OriginalMember(owner = "client!le", name = "b", descriptor = "(ILqa;)Lnf;", line = 55)
    ...
    @OriginalMember(owner = "client!le", name = "d", descriptor = "(I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BLqa;)V", line = 117)
