...
public abstract class class200 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BII[Ljava/lang/String;[S)V", line = 188)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)V", line = 244)
