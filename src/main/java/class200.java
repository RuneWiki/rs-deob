...
public class class200 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)Lto;", line = 34)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IILcd;)V", line = 46)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIB)Z", line = 110)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)Lkv;", line = 122)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lhca;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZLjava/lang/String;Ljava/awt/Color;ILjava/awt/Color;Ljava/awt/Color;)V", line = 156)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(II)V", line = 238)
    public class200(int arg0, int arg1) {
        this.field3005 = arg0;
        this.field2991 = arg1;
    }

    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lkv;I)V", line = 246)
