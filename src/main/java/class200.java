...
public class class200 extends class675 {
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lkv;)V", line = 110)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)Z", line = 204)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lfia;IZ)V", line = 215)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZZ)V", line = 252)
