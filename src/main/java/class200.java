...
public class class200 extends class470 {
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lfk;I)V")
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ILcw;IILlh;)V")
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(Lya;I)Lfk;")
