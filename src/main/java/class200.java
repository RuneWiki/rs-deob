...
public class class200 extends class185 {
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(Z)[Lcb;", line = 3)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lpea;II[B)V", line = 27)
