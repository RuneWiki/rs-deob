...
public class class200 extends class320 {
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIB)Z", line = 17)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZZ)Z", line = 28)
    public static boolean method1381(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!le", name = "d", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 65)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BLjava/lang/String;)V", line = 80)
