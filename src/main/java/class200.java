...
public class class200 extends class431 implements class185 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lqq;Lin;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lqq;ZI)Lcd;")
    public final class198 method167(class318 arg0, boolean arg1, int arg2) {
        ++field3182;
        return arg1 ? null : this.method1247(arg0, arg2, -36);
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILqq;ZI)Ldi;")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lqq;II)Lcd;")
