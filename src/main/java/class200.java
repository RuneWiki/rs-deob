...
public class class200 extends class539 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 140)
