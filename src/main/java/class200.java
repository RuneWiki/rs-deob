...
public class class200 extends class617 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BIIII)I", line = 108)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "([B)V", line = 127)
    public class200(byte[] arg0) {
        this.field2356 = arg0;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 140)
