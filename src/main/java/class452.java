...
public class class452 implements class233 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILha;III)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)Lhm;")
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Leha;Loea;IIIIIII)V")
