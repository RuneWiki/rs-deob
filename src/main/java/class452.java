...
public abstract class class452 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lc;ZIILc;IZ)I", line = 8)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILqj;)V", line = 57)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(III)V", line = 89)
