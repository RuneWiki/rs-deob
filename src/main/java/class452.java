...
public class class452 extends class46 {
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIZILlca;)V", line = 15)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(IIIIIF)V", line = 69)
    ...
    @OriginalMember(owner = "client!oaa", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(I[JIB[I)V", line = 115)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(III)V", line = 173)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IBI)V", line = 184)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(I)V", line = 201)
