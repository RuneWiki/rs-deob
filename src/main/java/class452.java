...
public class class452 implements class196 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)V", line = 14)
    public static void method2568(byte arg0) {
        int var1 = 68 % ((-arg0 - 37) / 55);
        field6221 = null;
    }

    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(ILor;Lma;IIIIIIIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)Loh;", line = 50)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 61)
