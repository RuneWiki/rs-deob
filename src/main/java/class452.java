...
public class class452 extends class17 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lwe;Lvh;B)Lph;", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lla;)V", line = 38)
    public static final void method2631(class395 arg0) {
        class662.field9307 = arg0;
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILjava/lang/String;)V", line = 51)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IIZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III)V", line = 166)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(III)V", line = 185)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(IIIIIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IB)Z", line = 217)
