...
public class class452 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILja;I)Z")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIILja;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(I[Lla;IIII)V")
