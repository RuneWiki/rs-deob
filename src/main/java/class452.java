...
public class class452 extends class145 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ck", name = "q", descriptor = "(B)[Lpf;", line = 14)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IILmq;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(IZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!ck", name = "q", descriptor = "(I)Let;", line = 56)
    ...
    @OriginalMember(owner = "client!ck", name = "e", descriptor = "(IB)I", line = 71)
    ...
    @OriginalMember(owner = "client!ck", name = "r", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(I)V", line = 103)
    public class452(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(I[BII)V", line = 106)
    ...
    @OriginalMember(owner = "client!ck", name = "r", descriptor = "(B)I", line = 130)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(BI)I", line = 149)
    ...
    @OriginalMember(owner = "client!ck", name = "s", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!ck", name = "t", descriptor = "(I)V", line = 197)
