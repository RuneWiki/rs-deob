...
public class class452 {
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZIBI)V", line = 43)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Z)V", line = 69)
