...
public class class452 extends class324 implements class65 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILie;)V")
    public final void method1272(int arg0, class6 arg1) {
        super.method1272(arg0, arg1);
    }

    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lhg;Lg;III[B)V")
