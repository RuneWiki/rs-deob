...
public class class452 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)Lul;", line = 7)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(III)Loa;", line = 39)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lgk;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lgk;IZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lgk;Ljava/lang/String;I)I", line = 113)
