...
public class class452 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIII)V", line = 32)
