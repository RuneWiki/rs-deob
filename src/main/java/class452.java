...
public class class452 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIF)F", line = 7)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Ljr;Ltca;)V", line = 13)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(IIF)F", line = 88)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(F)F", line = 108)
    private static final float method2595(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!mw", name = "a", descriptor = "()V", line = 115)
    public static void method2596() {
        field6311 = null;
        field6309 = null;
    }

    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IF)I", line = 119)
