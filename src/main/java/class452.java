...
public class class452 extends class297 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZII)V", line = 57)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIZZ)Lpc;", line = 93)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lnk;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lbo;Lri;)V", line = 183)
