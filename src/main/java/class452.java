...
public class class452 extends class142 implements class289 {
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(BLoa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;B)Llt;", line = 62)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)I", line = 109)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIILoa;)Z", line = 122)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BLoa;)Lvg;", line = 142)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(ILoa;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V", line = 164)
    ...
    @OriginalMember(owner = "client!ou", name = "f", descriptor = "(I)I", line = 177)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Z)Z", line = 192)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Loa;Luca;IIIIIZIII)V", line = 203)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILoa;)V", line = 213)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)I", line = 237)
    ...
    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(I)Z", line = 250)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IILoa;)Lba;", line = 263)
