...
public class class452 extends class418 {
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(DB)V", line = 124)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BZ)V", line = 156)
