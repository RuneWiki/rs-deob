...
public class class452 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "([BI)[B", line = 5)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lba;III[Z)Z", line = 73)
