...
public class class452 extends class129 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ILib;)Lkc;")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IILrca;)V")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lrda;Lla;Lcda;)V")
