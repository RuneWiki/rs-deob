...
public class class452 extends class431 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lvg;B)Lvg;", line = 4)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(II)Lgd;", line = 39)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IZ)[[I", line = 72)
    ...
    @OriginalMember(owner = "client!lh", name = "j", descriptor = "(I)V", line = 121)
