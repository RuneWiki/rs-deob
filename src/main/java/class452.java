...
public class class452 extends class333 {
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lpha;Ljava/lang/Object;I)V", line = 4)
    public class452(class172 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6509 = arg1;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lcb;IZIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!ss", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 118)
