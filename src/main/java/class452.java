...
public class class452 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IILhca;Lhca;Z)Lat;", line = 3)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BILhca;Lhca;)Lat;", line = 151)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(II)I", line = 161)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIIZI)V", line = 175)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Lfd;Lwm;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 194)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(I)V", line = 253)
