...
public class class452 extends class425 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I[BLij;[I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "(B)V", line = 61)
    public static void method2814(byte arg0) {
        int var1 = 111 / ((7 - arg0) / 47);
        field6482 = null;
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIIZBIII)Z", line = 73)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIZZI)Ltj;", line = 113)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIII)Lhl;", line = 134)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BI)I", line = 193)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIZI)I", line = 215)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILtj;)V", line = 330)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "([B)V", line = 345)
