...
public class class452 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IZ)Lio;", line = 17)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BI)V", line = 60)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B[I[I)V", line = 74)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Ler;ILjn;)V", line = 120)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(II)Laga;", line = 144)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 176)
