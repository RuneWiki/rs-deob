...
public class class452 extends class130 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)Lwea;", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lct;Lrc;IIIIIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BLks;)V", line = 31)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)V", line = 246)
