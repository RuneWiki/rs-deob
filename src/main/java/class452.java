...
public class class452 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILsba;IIIIIIIIILha;)V", line = 19)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)V", line = 93)
