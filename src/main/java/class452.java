...
public class class452 implements class762 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(III)Lor;", line = 6)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Laj;Ljfa;)V", line = 94)
    public class452(class333 arg0, class306 arg1) {
        this.field6289 = arg0;
        this.field6288 = arg1;
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(I)V", line = 105)
