...
public class class452 extends class221 implements class50 {
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "()V", line = 5)
    public final void method1289() {
        this.field2910.method1711(this);
    }

    @OriginalMember(owner = "client!li", name = "d", descriptor = "(Lgm;)V", line = 8)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(Lgm;)V", line = 11)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lgm;)V", line = 14)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Lgm;)V", line = 17)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lnf;ILjava/nio/ByteBuffer;Z)V", line = 20)
    public class452(class256 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field6588 = arg1;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "()I", line = 24)
    public final int method139() {
        return super.method139();
    }

    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lnf;I[BIZ)V", line = 28)
    public class452(class256 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field6588 = arg1;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I[BI)V", line = 32)
