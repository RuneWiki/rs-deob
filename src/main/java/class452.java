...
public class class452 implements Runnable {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ev", name = "run", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(II[BI)V", line = 136)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!ev", name = "c", descriptor = "(I)V", line = 212)
