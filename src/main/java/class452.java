...
public class class452 extends class354 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILti;I)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lqa;BJ)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILsq;Lsq;)V")
