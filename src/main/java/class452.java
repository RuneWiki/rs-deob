...
public class class452 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lrt;BI)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BII)V", line = 55)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(II)Lica;", line = 144)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Ltu;Le;)V", line = 204)
