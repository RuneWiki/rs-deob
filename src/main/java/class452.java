...
public class class452 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIII)Z", line = 30)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!sk", name = "toString", descriptor = "()Ljava/lang/String;", line = 91)
