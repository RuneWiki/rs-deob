...
public class class452 extends class314 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IBLie;Lk;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "()V", line = 427)
    public class452() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BLie;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!ef", name = "h", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)[I", line = 302)
    ...
    @OriginalMember(owner = "client!ef", name = "i", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 443)
