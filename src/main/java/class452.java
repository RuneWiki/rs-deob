...
public class class452 extends class737 {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIII[I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIIII)V")
    public class452(class663 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIIZ[III)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIII)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lrda;IIIIIIZ)V")
