...
public class class452 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILuo;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 949)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIZ)B", line = 973)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)Lcq;", line = 992)
