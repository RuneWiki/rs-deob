...
public class class452 extends class431 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(III)Len;", line = 5)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)Lqu;", line = 25)
    ...
    @OriginalMember(owner = "client!sp", name = "g", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!sp", name = "h", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(III)Z", line = 77)
    ...
    @OriginalMember(owner = "client!sp", name = "i", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B[I[J)V", line = 130)
