...
public class class452 extends class142 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lia;I)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!sf", name = "ba", descriptor = "(Lia;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "(I)Lbn;")
