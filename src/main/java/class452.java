...
public class class452 extends class38 {
    ...
    @OriginalMember(owner = "client!sp", name = "ua", descriptor = "(II)I", line = 4)
    public final int method217(int arg0, int arg1) {
        ++field6746;
        return this.field6759[arg0][arg1];
    }

    @OriginalMember(owner = "client!sp", name = "OA", descriptor = "(IILi;)Li;", line = 15)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIIIII[[Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lur;IIII[[I[[II)V", line = 215)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(III)Z", line = 282)
    ...
    @OriginalMember(owner = "client!sp", name = "ca", descriptor = "(II)I", line = 294)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "([[ZZIIIII)V", line = 317)
    ...
    @OriginalMember(owner = "client!sp", name = "H", descriptor = "(Li;IIIIZ)V", line = 469)
    ...
    @OriginalMember(owner = "client!sp", name = "ba", descriptor = "(Li;IIIIZ)V", line = 501)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 519)
    ...
    @OriginalMember(owner = "client!sp", name = "pa", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 610)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(I)V", line = 678)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(III[[ZZ)V", line = 690)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Li;IIIIZ)Z", line = 702)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lre;III)V", line = 721)
    ...
    @OriginalMember(owner = "client!sp", name = "aa", descriptor = "()V", line = 782)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lbn;[I)V", line = 1363)
    public final void method215(class309 arg0, int[] arg1) {
        ++field6752;
        this.field6739.method975(0, new class270(this.field6765, this, arg0, arg1));
    }

    @OriginalMember(owner = "client!sp", name = "qa", descriptor = "(III)V", line = 1373)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)V", line = 1384)
