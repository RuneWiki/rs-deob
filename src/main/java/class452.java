...
public class class452 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)I", line = 8)
    public static final int method2805(int arg0, int arg1) {
        field6667++;
        return arg0 <= 108 ? -34 : arg1 & 0xFF;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIBIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 162)
