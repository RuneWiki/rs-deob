...
public class class452 extends class179 {
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lqi;IIZ[[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "()V", line = 41)
    public final void method1050() {
        this.field2602.field6330.glFramebufferTexture2DEXT(36160, this.field6249, 3553, 0, 0);
        this.field6249 = -1;
    }

    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lqi;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lqi;IIZ[[BI)V", line = 63)
