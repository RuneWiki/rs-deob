...
public class class452 extends class392 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(II[BIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IZ)Z", line = 208)
    public final boolean method2525(int arg0, boolean arg1) {
        field6308++;
        return arg1 ? true : this.field6301[arg0].field9495;
    }

    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ZI)Z", line = 232)
    public final boolean method2527(boolean arg0, int arg1) {
        field6306++;
        return arg0 ? true : this.field6301[arg1].field9502;
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IB)V", line = 244)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(I)V", line = 265)
    public class452(int arg0) {
        this.field6305 = arg0;
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(II)Z", line = 273)
