...
public abstract class class452 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I[Lgl;III[ILjava/util/Random;Ljava/lang/String;II)I", line = 6)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIZLjava/lang/String;)V", line = 43)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BII)V", line = 95)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILjava/lang/String;[IIIIB[Lgl;)V", line = 138)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([I[Lgl;IZLjava/lang/String;I[I[I)V", line = 153)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II[Lgl;I[ILq;IIIIIILjava/lang/String;III)I", line = 316)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IILjava/lang/String;[Lgl;ZLq;[III)V", line = 402)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BLjava/util/Random;III[III[Lgl;ILjava/lang/String;I[III)I", line = 552)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILjava/lang/String;IBIII)V", line = 633)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILjava/lang/String;)V", line = 663)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Le;Lgh;)V", line = 744)
    public class452(class312 arg0, class325 arg1) {
        this.field6582 = arg1;
        this.field6568 = arg0;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ljava/lang/String;IIZII)V", line = 753)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 768)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([IIIILjava/lang/String;[Lgl;ZI)V", line = 801)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ljava/lang/String;IIIZI)V", line = 823)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IILjava/lang/String;IIII)V", line = 839)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)Lom;", line = 872)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ljava/lang/String;II[II[Lgl;II)V", line = 900)
