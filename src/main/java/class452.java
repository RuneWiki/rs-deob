...
public class class452 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(IBIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(ILea;IBI)V", line = 70)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(Lkn;IIIIIIIIII)Z", line = 109)
