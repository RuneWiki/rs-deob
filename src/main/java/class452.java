...
public class class452 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Ldt;II)V", line = 913)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(B)V", line = 986)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(II)I", line = 998)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IIIIIIIII)Z", line = 1017)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 1038)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)V", line = 1092)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Ldt;Z)V", line = 1131)
