...
public class class339 extends class426 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/awt/Graphics;ZII)V", line = 52)
