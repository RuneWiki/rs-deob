...
public class class339 extends class763 implements class248 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lsw;IIII[BIII)V")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lpa;Lsw;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lpa;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lpa;Lsw;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I[FIILsw;IIII)V")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lpa;Lsw;Lig;II)V")
