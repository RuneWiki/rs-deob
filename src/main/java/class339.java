...
public class class339 extends class179 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 5)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lec;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!lf", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!lf", name = "e", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BI)V", line = 116)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIII)I", line = 130)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lec;I)V", line = 150)
