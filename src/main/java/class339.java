...
public class class339 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZB)V", line = 15)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIII)I", line = 111)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIIIIIIIIILnr;[[[B)V", line = 170)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)I", line = 210)
