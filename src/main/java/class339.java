...
public class class339 extends class45 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I[B)[B", line = 56)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZII)Z", line = 92)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)Z", line = 111)
