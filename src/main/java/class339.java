...
public class class339 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIIIIZIIILfp;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIZILct;I)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILfp;I)Z")
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(I[Lls;IIII)V")
