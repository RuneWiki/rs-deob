...
public class class339 implements Runnable {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)Lal;", line = 6)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IILri;IIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 46)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIZLr;)Lla;", line = 133)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lac;B)Z", line = 151)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)Z", line = 162)
    ...
    @OriginalMember(owner = "client!pa", name = "run", descriptor = "()V", line = 205)
