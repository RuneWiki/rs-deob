...
public class class339 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;IIII[S[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;Ljj;IIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)Llo;", line = 70)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;IIII)Lbu;", line = 85)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Ln;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)Llo;", line = 109)
    public static final class642 method2065(int arg0) {
        return (class642) field4668.method2799((long) arg0, true);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Ln;III)I", line = 114)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;IIIIIII[S[BZ)V", line = 171)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;)Lbu;", line = 335)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(Lqa;)V", line = 346)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "()V", line = 356)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "()V", line = 368)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(II)Lvm;", line = 395)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "()V", line = 412)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;Lgw;IIII[I[I)V", line = 569)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqa;II)V", line = 704)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIIIIII)V", line = 882)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "([B[B[SII)V", line = 894)
    ...
    @OriginalMember(owner = "client!tb", name = "d", descriptor = "()V", line = 1039)
    ...
    @OriginalMember(owner = "client!tb", name = "e", descriptor = "()V", line = 1050)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(Lqa;IIII)V", line = 1073)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lkda;Ler;Lcaa;Lmm;Lre;Lkl;Lnc;)V", line = 1421)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)V", line = 1464)
