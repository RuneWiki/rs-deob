...
public class class339 extends class447 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Leb;I)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BILeb;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BLqj;)V")
