...
public class class339 extends class376 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IILya;)Z")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Liv;II)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Liv;I)V")
