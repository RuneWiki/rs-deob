...
public abstract class class339 extends class184 {
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(IIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!gl", name = "g", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!gl", name = "h", descriptor = "(I)V", line = 62)
