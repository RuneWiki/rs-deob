...
public class class339 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILtq;)V")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IZLvm;B)Llg;")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILtq;II)V")
