...
public class class339 extends class276 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BIII[ILgi;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "()Lvw;", line = 62)
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "()Lvw;", line = 81)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "()I", line = 135)
    public final int method1674() {
        field4917++;
        return 0;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ZIIIIIZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)V", line = 193)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILgi;I)V", line = 243)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lso;)V", line = 378)
    public class339(class432 arg0) {
        this.field4918 = arg0;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "([III)V", line = 336)
