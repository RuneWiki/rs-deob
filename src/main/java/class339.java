...
public class class339 extends class321 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IIIII)V", line = 16)
    public final void method1949(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field4280 = arg0;
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IZ)Lwca;", line = 27)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lr;[Low;Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "()Lqw;", line = 119)
    public final class332 method1952() {
        return this.field4283;
    }

    @OriginalMember(owner = "client!wca", name = "b", descriptor = "()V", line = 122)
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "()V", line = 161)
    public final void method1954() {
        this.field4275 = true;
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lr;J)Z", line = 164)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class339(int arg0, boolean arg1) {
        this.method1957(arg0, arg1);
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "([Lqr;Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(IZ)V", line = 305)
    ...
    @OriginalMember(owner = "client!wca", name = "d", descriptor = "()V", line = 313)
    public final void method1958() {
        this.field4284 = true;
    }

    @OriginalMember(owner = "client!wca", name = "e", descriptor = "()V", line = 316)
    private final void method1959() {
        this.field4275 = false;
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lr;J[Low;[Lqr;Z)V", line = 320)
    ...
    @OriginalMember(owner = "client!wca", name = "f", descriptor = "()V", line = 329)
    public static void method1961() {
        field4274 = null;
        field4269 = null;
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(J)V", line = 333)
    public final void method1962(long arg0) {
        this.field4273 = arg0;
    }

    @OriginalMember(owner = "client!wca", name = "g", descriptor = "()Lqw;", line = 351)
