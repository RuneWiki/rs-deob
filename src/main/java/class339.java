...
public class class339 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ZLjava/util/Random;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(B[Lf;)V", line = 52)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 86)
