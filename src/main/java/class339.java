...
public class class339 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IB)S", line = 29)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIB[BI)Z", line = 62)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 147)
