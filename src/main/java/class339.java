...
public class class339 extends class367 implements class231 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lqa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZLqa;)V", line = 24)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!rp", name = "d", descriptor = "(B)V", line = 63)
    public static void method2081(byte arg0) {
        int var1 = -40 % ((-3 - arg0) / 52);
        field4884 = null;
    }

    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BILqa;)Lr;", line = 106)
    ...
    @OriginalMember(owner = "client!rp", name = "d", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lqa;I)Lbi;", line = 142)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(ILqa;)Lkm;", line = 168)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lqa;ZII)Lep;", line = 183)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BLqa;II)Z", line = 211)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lqa;Ltk;IIIIZIIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)I", line = 269)
    public final int method264(int arg0) {
        ++field4873;
        return arg0 != -25792 ? 52 : this.field4861 & 65535;
    }

    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(II)Z", line = 289)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILqa;)V", line = 300)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILqa;Z)Lr;", line = 327)
