...
public class class339 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(ZI)V", line = 16)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIZ)I", line = 27)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IILjava/awt/Canvas;Lbm;)Len;", line = 66)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIIIII)V", line = 102)
