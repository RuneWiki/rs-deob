...
public class class339 extends class265 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BILig;I)J", line = 14)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lsp;Lsp;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIIZII)V", line = 87)
    ...
    @OriginalMember(owner = "client!aa", name = "j", descriptor = "(I)V", line = 536)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(III)Z", line = 565)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lkd;II)V", line = 576)
    public class339(class188 arg0, int arg1, int arg2) {
        this.field5050 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIII)V", line = 586)
