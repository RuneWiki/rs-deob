...
public class class339 extends class305 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)I", line = 6)
    public final int method305(byte arg0) {
        ++field4931;
        return arg0 != 68 ? -124 : 2;
    }

    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lhb;)V", line = 90)
    public class339(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(ILhb;)V", line = 104)
    public class339(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(I)V", line = 107)
