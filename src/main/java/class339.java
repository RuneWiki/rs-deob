...
public class class339 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(F)F", line = 7)
    private static final float method2056(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IF)I", line = 12)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Leh;Lfd;)V", line = 73)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIF)F", line = 145)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "()V", line = 153)
    public static void method2060() {
        field4692 = null;
        field4689 = null;
    }

    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(IIF)F", line = 158)
