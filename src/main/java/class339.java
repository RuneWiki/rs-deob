...
public class class339 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(JILrg;)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)Lrg;")
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(JI)Lrg;")
