...
public class class339 extends class30 {
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IB)[[I", line = 70)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "()V", line = 221)
    public class339() {
        super(3, false);
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BILac;)V", line = 142)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILjava/lang/String;[BZ)I", line = 178)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZZI)V", line = 229)
