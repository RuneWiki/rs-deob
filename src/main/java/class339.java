...
public class class339 extends class212 {
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)I", line = 3)
    public final int method422(int arg0) {
        ++field4771;
        return arg0 != 20014 ? -81 : 1;
    }

    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)I", line = 101)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(II)V", line = 226)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(II)I", line = 242)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Ldh;)V", line = 257)
    public class339(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(ILdh;)V", line = 277)
    public class339(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vu", name = "e", descriptor = "(I)I", line = 281)
    ...
    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(II)Z", line = 295)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 316)
