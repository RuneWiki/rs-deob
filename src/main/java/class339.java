...
public class class339 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)Ldj;", line = 7)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)Lgq;", line = 31)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)Z", line = 47)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(II)I", line = 63)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(II)V", line = 67)
    public class339(int arg0, int arg1) {
        this.field4933 = arg1;
        this.field4932 = arg0;
    }

    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lgq;I)V", line = 78)
