...
public class class339 extends class311 implements class232 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lqa;Lbo;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ZIBLqa;)Lrl;")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IILqa;IZLha;I)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILir;)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lqa;BI)Lc;")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILqa;)Lbw;")
