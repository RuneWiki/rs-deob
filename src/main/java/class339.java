...
public class class339 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILjba;)V", line = 66)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(B)Ljba;", line = 87)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(I)V", line = 125)
    public class339(int arg0) {
        this.field4847 = arg0;
    }

    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(IIIIII)V", line = 132)
