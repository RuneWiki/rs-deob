...
public class class339 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILph;Lrv;Lph;Lph;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lms;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIB)B", line = 107)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lkp;ILph;Lph;)V", line = 225)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IB)Laq;", line = 186)
