...
public class class339 extends class751 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)[I", line = 63)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "()V", line = 178)
    public class339() {
        super(0, true);
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILrv;I)V", line = 182)
    ...
    @OriginalMember(owner = "client!db", name = "e", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIZ)Z", line = 249)
    ...
    @OriginalMember(owner = "client!db", name = "f", descriptor = "(B)V", line = 274)
