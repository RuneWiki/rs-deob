...
public class class339 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILci;ZZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lwn;B)V", line = 45)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILwn;I)V", line = 70)
