...
public class class339 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILii;ILwl;Lls;Lii;ZZIII)Lcq;", line = 16)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 246)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)V", line = 278)
