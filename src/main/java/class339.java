...
public class class339 extends class264 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(III)I", line = 42)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILnl;)I", line = 78)
    ...
    @OriginalMember(owner = "client!ti", name = "h", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "()V", line = 120)
    public class339() {
        super(1, true);
    }
}
