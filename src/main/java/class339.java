...
public class class339 extends class371 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lhba;I)I")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I[Lwca;I)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IBLps;)V")
