...
public class class339 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!on", name = "finalize", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lhl;JI)V", line = 141)
