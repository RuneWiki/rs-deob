...
public class class339 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lbf;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIILya;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lem;I)Ljava/lang/String;", line = 197)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)V", line = 220)
