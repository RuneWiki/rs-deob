...
public class class339 implements class212 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!bga", name = "b", descriptor = "(II)I", line = 28)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!bga", name = "b", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!bga", name = "c", descriptor = "(III)V", line = 139)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IBI)V", line = 171)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ZZ)I", line = 203)
