...
public class class339 extends class519 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)[B", line = 28)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)I", line = 58)
