...
public class class339 extends class506 implements class248 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(III)I", line = 40)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IZILqa;)Lmr;", line = 55)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZLqa;)Lae;", line = 87)
    ...
    @OriginalMember(owner = "client!jb", name = "f", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BLqa;)V", line = 3203)
    public final void method25(byte arg0, class162 arg1) {
        int var3 = -60 % ((-45 - arg0) / 48);
        ++field5106;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lqa;II)Lc;", line = 3212)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lqa;I)V", line = 3223)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILqa;II)Z", line = 3253)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILqa;)V", line = 3273)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IB)V", line = 3300)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)I", line = 3315)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([I[IIBI)V", line = 3326)
    ...
    @OriginalMember(owner = "client!jb", name = "g", descriptor = "(I)V", line = 3383)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(I)V", line = 3405)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lqa;Lgm;IIIIZIIIII)V", line = 3419)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)I", line = 3450)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILqa;I)Lc;", line = 3462)
