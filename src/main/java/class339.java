...
public class class339 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIILea;ILi;IIII)Lts;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIILea;Li;I)Lts;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I[Lub;BIILi;ZIIILea;ILi;)Lts;")
