...
public class class339 extends class573 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lwc;IB)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lvfa;III)V")
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lrv;Lwda;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "f", descriptor = "(I)Lav;")
