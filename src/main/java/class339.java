...
public class class339 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 82)
