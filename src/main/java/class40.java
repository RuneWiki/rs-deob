...
public class class40 extends class424 implements class409 {
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)J", line = 19)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)I", line = 36)
    ...
    @OriginalMember(owner = "client!lm", name = "h", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!lm", name = "i", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)C", line = 84)
    public final char method316(byte arg0) {
        field560++;
        return arg0 == -83 ? this.field562 : '-';
    }

    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)I", line = 95)
