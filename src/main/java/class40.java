...
public class class40 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IZLdt;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILdt;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "([Lmja;BLlf;)Lgw;")
