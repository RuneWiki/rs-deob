...
public class class40 {
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILlh;I)Ljava/lang/String;", line = 51)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(III)V", line = 199)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II)[I", line = 106)
