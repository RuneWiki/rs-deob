...
public class class40 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BI)Lcg;")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lmw;Lhb;IBI)V")
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Lci;ILsea;Lsea;)V")
