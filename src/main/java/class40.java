...
public abstract class class40 extends class452 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIIIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(B)[Lie;", line = 36)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lcp;I)V", line = 69)
