...
public class class40 extends class531 {
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lqfa;Lgo;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IZLdca;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lko;IZ[B)Lhka;")
