...
@OriginalClass("client!MGISFZUH")
public class class40 {

    @OriginalMember(owner = "client!MGISFZUH", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!MGISFZUH", name = "a", descriptor = "(IBII)I")
    ...
    @OriginalMember(owner = "client!MGISFZUH", name = "a", descriptor = "(IIIIIZ)I")
    ...
    @OriginalMember(owner = "client!MGISFZUH", name = "a", descriptor = "(IIBIII)I")
