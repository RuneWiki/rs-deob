...
public class class40 extends class499 {
    ...
    @OriginalMember(owner = "client!aka", name = "<init>", descriptor = "(Ljc;Lwm;Ljga;)V")
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(ILsfa;I)V")
    ...
    @OriginalMember(owner = "client!aka", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(Ltia;Z)V")
