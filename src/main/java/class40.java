...
public abstract class class40 extends class264 {
    ...
    @OriginalMember(owner = "client!gh", name = "d", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "()I", line = 18)
    public int method350() {
        return 0;
    }

    @OriginalMember(owner = "client!gh", name = "e", descriptor = "(I)I", line = 28)
    public final int method352(int arg0) {
        int var2 = 51 % ((arg0 + 3) / 42);
        return 1;
    }

    @OriginalMember(owner = "client!gh", name = "f", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lks;)V", line = 45)
