...
public class class40 extends class85 {
    ...
    @OriginalMember(owner = "client!di", name = "Q", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!di", name = "Y", descriptor = "Llf;")
    public static class109 field848 = class35.method275("Ung-Ultiger Benutzername", 2);

    @OriginalMember(owner = "client!di", name = "cb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLuc;I)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILbg;)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BILja;)V")
