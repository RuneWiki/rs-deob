...
public class class40 extends class472 implements class532 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILbca;ZII)Z", line = 19)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lnn;", line = 23)
    public final class417[] method494() {
        return this.field964;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lbca;Liw;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()Z", line = 46)
    public final boolean method500() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "e", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILbca;ZI)Z", line = 60)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 63)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()V", line = 71)
    public final void method507() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 85)
    public final void method516(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lbca;IZ)V", line = 95)
    public final void method519(class661 arg0, int arg1, boolean arg2) {
        this.method529(((class279) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "f", descriptor = "()V", line = 98)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lbca;Liw;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lbca;)V", line = 132)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Leca;", line = 189)
    public final class755[] method525() {
        return this.field963;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILbca;)V", line = 192)
    private final void method526(int[] arg0, class661 arg1) {
        this.field962.method3882().method3522(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lbh;IIII)V", line = 199)
