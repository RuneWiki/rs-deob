...
public class class40 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)Lod;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lmv;II)Lfo;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BI)Lnb;")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lsea;ILmv;Lmv;)V")
