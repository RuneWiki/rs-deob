...
public class class40 extends class55 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLfh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IFFFIIII)[F", line = 60)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lhd;III)V", line = 143)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILjava/lang/Object;I)[B", line = 181)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 213)
