...
public class class40 extends class503 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lya;IIZF)V", line = 21)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lvt;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(II)Llv;", line = 206)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILvt;)V", line = 234)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Z[B)[B", line = 255)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(ILvt;)V", line = 274)
