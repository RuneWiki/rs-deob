...
@OriginalClass("client!PUAKDUFP")
public class class40 {

    @OriginalMember(owner = "client!PUAKDUFP", name = "a", descriptor = "LJPBRSBFI;")
    private static class28 field1051 = new class28();

    @OriginalMember(owner = "client!PUAKDUFP", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!PUAKDUFP", name = "a", descriptor = "(LJPBRSBFI;)V")
    ...
    @OriginalMember(owner = "client!PUAKDUFP", name = "b", descriptor = "(LJPBRSBFI;)V")
    ...
    @OriginalMember(owner = "client!PUAKDUFP", name = "c", descriptor = "(LJPBRSBFI;)B")
    private static byte method390(class28 arg0) {
        return (byte) method392(8, arg0);
    }

    @OriginalMember(owner = "client!PUAKDUFP", name = "d", descriptor = "(LJPBRSBFI;)B")
    private static byte method391(class28 arg0) {
        return (byte) method392(1, arg0);
    }

    @OriginalMember(owner = "client!PUAKDUFP", name = "a", descriptor = "(ILJPBRSBFI;)I")
    ...
    @OriginalMember(owner = "client!PUAKDUFP", name = "e", descriptor = "(LJPBRSBFI;)V")
    ...
    @OriginalMember(owner = "client!PUAKDUFP", name = "a", descriptor = "([I[I[I[BIII)V")
