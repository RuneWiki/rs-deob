...
public class class40 {
    ...
    @OriginalMember(owner = "client!OKDOXVFL", name = "b", descriptor = "LOKDOXVFL;")
    public class40 field1191;

    @OriginalMember(owner = "client!OKDOXVFL", name = "c", descriptor = "LOKDOXVFL;")
    public class40 field1192;

    @OriginalMember(owner = "client!OKDOXVFL", name = "d", descriptor = "Z")
