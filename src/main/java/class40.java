...
public class class40 extends class554 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(III)B", line = 4)
    ...
    @OriginalMember(owner = "client!efa", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!efa", name = "e", descriptor = "(I)Lus;", line = 37)
    public final class566 method246(int arg0) {
        ++field531;
        return arg0 != 1 ? null : class667.field9494[super.field7584];
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(II)V", line = 49)
