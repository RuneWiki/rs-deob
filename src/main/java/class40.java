...
public class class40 extends class270 {
    ...
    @OriginalMember(owner = "client!gs", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BI)[I", line = 73)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "([[[Lsk;B)V", line = 109)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 182)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZI)[[I", line = 195)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 238)
    public class40() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BLec;I)V", line = 246)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BII)V", line = 273)
