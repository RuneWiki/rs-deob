...
public class class40 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILjava/lang/String;)V", line = 7)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lig;I)V", line = 144)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lig;II)V", line = 208)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(B)V", line = 266)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(IZ)V", line = 311)
