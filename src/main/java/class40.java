...
public class class40 extends class80 {
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(II)Z", line = 15)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(II)[I", line = 32)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "()V", line = 55)
    public class40() {
        super(0, true);
    }
}
