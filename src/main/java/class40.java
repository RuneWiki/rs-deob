...
public class class40 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lr;Lte;IB)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BLuf;)I")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILun;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILun;)V")
