...
public class class40 extends class581 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(III)[B", line = 7)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)[B", line = 18)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I[B)V", line = 28)
