...
public class class40 extends class30 {
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(IIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIB)V", line = 37)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lbk;I)Lik;", line = 157)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)I", line = 195)
