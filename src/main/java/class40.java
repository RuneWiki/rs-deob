...
public class class40 extends class62 {
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 37)
    public class40() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gs", name = "h", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(II)[I", line = 50)
