...
public class class40 extends class212 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLjava/lang/String;)J", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILot;)Lot;", line = 28)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIB)V", line = 66)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLjava/awt/Canvas;)V", line = 93)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(IIIIIF)V", line = 115)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(III)V", line = 136)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(Z)V", line = 182)
