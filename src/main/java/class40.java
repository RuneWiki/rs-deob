...
public class class40 extends class320 {
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)I", line = 15)
    public final int method238(int arg0) {
        field576++;
        return arg0 <= 33 ? 110 : this.field577;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!nr", name = "g", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!nr", name = "h", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(B)J", line = 92)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)I", line = 103)
