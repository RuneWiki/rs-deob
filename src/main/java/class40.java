...
public class class40 extends class108 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)I", line = 3)
    public final int method304(byte arg0) {
        field605++;
        return arg0 >= -121 ? -120 : this.field609;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BI)V", line = 207)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(II)Z", line = 236)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(III)Lt;", line = 249)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(B)I", line = 468)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II)I", line = 489)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(Z)V", line = 514)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(Z)I", line = 559)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(ILkn;Lkn;Lml;Lik;IIZ)V", line = 767)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)Llb;", line = 583)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)I", line = 682)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(I)V", line = 698)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IB)[B", line = 720)
