...
public abstract class class40 extends class90 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILui;)I", line = 8)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(JI)V", line = 28)
    ...
    @OriginalMember(owner = "client!mn", name = "f", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lvk;I)V", line = 101)
