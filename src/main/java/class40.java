...
public class class40 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BI)I", line = 6)
    private final int method218(byte arg0, int arg1) {
        field497++;
        return arg0 >= -17 ? -95 : (int) (this.field494 >> class385.field5529 * arg1) & 0xF;
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lqf;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)Lqf;", line = 42)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lqf;)V", line = 58)
    public class40(class385 arg0) {
        this.field494 = arg0.field5519;
        this.field493 = 1;
    }

    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "([Lqf;)V", line = 68)
    public class40(class385[] arg0) {
