...
public class class40 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lgga;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(Lgga;)V", line = 21)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "()V", line = 56)
    public class40() {
        this.field404[0] = 0;
