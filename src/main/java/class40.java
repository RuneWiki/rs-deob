...
public abstract class class40 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IB)I", line = 43)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lfu;IB)Lqr;", line = 58)
