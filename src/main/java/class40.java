...
public class class40 extends class472 implements class533 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILhba;ZII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILhba;)V", line = 10)
    private final void method198(int[] arg0, class10 arg1) {
        this.field410.method3918().method3494(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "b", descriptor = "()[Lcia;", line = 17)
    public final class614[] method201() {
        return this.field412;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILhba;ZI)Z", line = 25)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lhba;IZ)V", line = 29)
    public final void method208(class10 arg0, int arg1, boolean arg2) {
        this.method210(((class279) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lhba;)V", line = 41)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lfk;", line = 97)
    public final class653[] method218() {
        return this.field411;
    }

    @OriginalMember(owner = "client!i", name = "g", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()Z", line = 128)
    public final boolean method226() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lhba;Llda;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 159)
    public final void method233(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 167)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()V", line = 169)
    public final void method240() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 172)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "()V", line = 175)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lhba;Llda;II)V", line = 185)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Llv;IIII)V", line = 203)
