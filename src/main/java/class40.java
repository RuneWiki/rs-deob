...
public class class40 extends class473 implements class534 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lql;Leda;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILql;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lql;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lql;Leda;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lwr;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lql;IZ)V")
    public final void method276(class738 arg0, int arg1, boolean arg2) {
        this.method274(((class278) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILql;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILql;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lol;")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Ldh;IIII)V")
