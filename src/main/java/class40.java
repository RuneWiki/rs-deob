...
public class class40 extends class593 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IBLah;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BIZI)I", line = 17)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!sa", name = "g", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Ljj;Ljd;)V", line = 138)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLjc;)Lgca;", line = 159)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIJ)Ljava/lang/String;", line = 185)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIB)V", line = 231)
