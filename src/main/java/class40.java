...
public class class40 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "()Lrea;", line = 48)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "()[B", line = 60)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lgj;II)Lbh;", line = 119)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lfca;)V", line = 129)
