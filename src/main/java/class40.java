...
public class class40 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(II)Lhca;", line = 63)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!sca", name = "d", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lre;ILdn;)V", line = 159)
    public class40(class515 arg0, int arg1, class438 arg2) {
        this.field315 = arg2;
        this.field315.method2554(1, 126);
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)V", line = 174)
