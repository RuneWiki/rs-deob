...
public class class40 extends class459 {
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pja", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 207)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(IIB[I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(IIII[I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!pja", name = "c", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(I[III)Z", line = 161)
