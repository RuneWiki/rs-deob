...
public class class40 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IF)I", line = 4)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIF)F", line = 80)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(IIF)F", line = 87)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lee;Ljga;)V", line = 100)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(F)F", line = 166)
    private static final float method273(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "()V", line = 175)
