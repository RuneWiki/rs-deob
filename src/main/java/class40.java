...
public class class40 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(FFBF)I", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIIII)Z", line = 63)
