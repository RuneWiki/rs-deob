...
public class class40 extends class441 implements class56 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILtj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(ILtj;)V", line = 26)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BLtj;)V", line = 37)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILtj;II)Z", line = 93)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ltj;I)Lri;", line = 112)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILtj;BIZLkm;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ltj;IB)Lqb;", line = 184)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ltj;BILsj;I)V", line = 204)
    ...
    @OriginalMember(owner = "client!rn", name = "f", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(B)Z", line = 278)
    public final boolean method107(byte arg0) {
        ++field612;
        return arg0 <= 119;
    }

    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ltj;Lqr;IIIIIIZI)V", line = 290)
