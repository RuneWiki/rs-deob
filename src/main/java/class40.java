...
public class class40 {
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lrl;)V", line = 151)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLrl;[Lmt;)Ljh;", line = 32)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[[BLuo;)V", line = 215)
