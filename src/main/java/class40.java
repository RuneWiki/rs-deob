...
@OriginalClass("client!OSKYDPYJ")
public class class40 {

    @OriginalMember(owner = "client!OSKYDPYJ", name = "a", descriptor = "Z")
    private boolean field1213 = false;

    @OriginalMember(owner = "client!OSKYDPYJ", name = "b", descriptor = "I")
    public int field1214;

    @OriginalMember(owner = "client!OSKYDPYJ", name = "c", descriptor = "[I")
    public int[] field1215;

    @OriginalMember(owner = "client!OSKYDPYJ", name = "d", descriptor = "[[I")
    public int[][] field1216;

    @OriginalMember(owner = "client!OSKYDPYJ", name = "<init>", descriptor = "(LKHOMSBHW;B)V")
