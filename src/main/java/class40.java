...
public class class40 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Lds;", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 43)
    public class40() {
    }

    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)Lds;", line = 48)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ltg;Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Ltg;)V", line = 81)
