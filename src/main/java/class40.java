...
public class class40 extends class95 implements class649 {
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!wh", name = "f", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZIIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lha;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(ILha;)V", line = 76)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILha;)V", line = 100)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lha;III)Z", line = 111)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(ILha;)Lgp;", line = 132)
    public final class551 method274(int arg0, class545 arg1) {
        ++field555;
        return arg0 != 0 ? null : this.field572;
    }

    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!wh", name = "j", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(Lha;I)Ljl;", line = 181)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "([IBLwu;Lwu;)V", line = 256)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Z)Z", line = 272)
    public final boolean method281(boolean arg0) {
        ++field566;
        return !arg0 ? true : this.field562.method2508(true);
    }

    @OriginalMember(owner = "client!wh", name = "g", descriptor = "(I)I", line = 284)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(B)Z", line = 299)
