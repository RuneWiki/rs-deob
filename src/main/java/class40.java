...
public class class40 extends class36 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(FI)V", line = 16)
    ...
    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(IIIIIF)V", line = 48)
