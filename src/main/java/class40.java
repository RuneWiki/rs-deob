...
public class class40 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)Lmi;")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IZ)Lcha;")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lgia;ILaj;)V")
    public class40(class285 arg0, int arg1, class333 arg2) {
        this.field633 = arg2;
        this.field632 = this.field633.method2090(19, false);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lor;B)V")
