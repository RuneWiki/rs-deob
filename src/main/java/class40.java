...
public abstract class class40 extends class425 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(III)[[I", line = 57)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)[[I", line = 89)
    ...
    @OriginalMember(owner = "client!qn", name = "d", descriptor = "(B)I", line = 105)
    ...
    @OriginalMember(owner = "client!qn", name = "e", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILlf;)V", line = 205)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BI)[I", line = 224)
    ...
    @OriginalMember(owner = "client!qn", name = "f", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!qn", name = "g", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BII)[I", line = 288)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)I", line = 310)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(IZ)V", line = 322)
    public class40(int arg0, boolean arg1) {
        this.field550 = arg1;
        this.field553 = new class40[arg0];
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ZII)V", line = 340)
