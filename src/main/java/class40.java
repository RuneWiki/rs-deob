...
public class class40 implements Runnable {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILjava/lang/String;)Lei;", line = 17)
    public final class329 method346(int arg0, String arg1) {
        return arg0 == -7113 ? this.method367(true, 21, 0, 0, arg1) : null;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILjava/lang/String;I)Lei;", line = 27)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILjava/net/URL;)Lei;", line = 38)
    public final class329 method348(int arg0, URL arg1) {
        return arg0 == 17746 ? this.method367(true, 4, 0, 0, arg1) : null;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IILjava/lang/Object;II)Lei;", line = 48)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIBII)Lei;", line = 97)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/Class;I[Ljava/lang/Class;Ljava/lang/String;)Lei;", line = 107)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/Runnable;IZ)Lei;", line = 117)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)Lei;", line = 129)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I[ILjava/awt/Point;Ljava/awt/Component;II)Lei;", line = 139)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(ILjava/lang/String;)Lei;", line = 149)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)Lei;", line = 159)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IB)Ljava/io/File;", line = 169)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/awt/Frame;I)Lei;", line = 257)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lei;", line = 330)
    ...
    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(I)Lei;", line = 345)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/io/File;I[B)Z", line = 355)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZLjava/lang/String;B)Lei;", line = 381)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/awt/Component;IBI)Lei;", line = 398)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 694)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;Z)Lei;", line = 422)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZIIILjava/lang/Object;)Lei;", line = 433)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Lei;", line = 467)
    ...
    @OriginalMember(owner = "client!ae", name = "e", descriptor = "(I)Ltba;", line = 479)
    public final class647 method369(int arg0) {
        int var2 = -62 / ((25 - arg0) / 40);
        return this.field559;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/Class;B)V", line = 497)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 534)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZLjava/lang/String;)[B", line = 543)
    ...
    @OriginalMember(owner = "client!ae", name = "run", descriptor = "()V", line = 574)
