...
public class class40 {
    ...
    @OriginalMember(owner = "client!NPCMYHWE", name = "d", descriptor = "[LNPCMYHWE;")
    public static class40[] field1074;

    @OriginalMember(owner = "client!NPCMYHWE", name = "a", descriptor = "(ZLXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!NPCMYHWE", name = "a", descriptor = "(BLGLMIQHJI;)V")
