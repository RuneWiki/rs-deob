...
public class class40 {
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(II)V", line = 22)
    public static final void method204(int arg0, int arg1) {
        class470.field6610 = arg1 / arg0;
        field480++;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 144)
    public class40(String arg0, String arg1, String arg2, String arg3) {
        this.field478 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!ec", name = "toString", descriptor = "()Ljava/lang/String;", line = 158)
