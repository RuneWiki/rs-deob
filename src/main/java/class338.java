...
public class class338 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(III)Lbk;")
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)Llh;")
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIII)Lnha;")
