...
public class class338 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lui;Ltq;I)V", line = 49)
