...
public class class338 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BI)Lfd;", line = 31)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)Z", line = 112)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBI)I", line = 142)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 183)
