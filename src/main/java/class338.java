...
public class class338 extends class540 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!lm", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 45)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILjava/awt/event/KeyEvent;Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!lm", name = "e", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!lm", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 219)
    public final void focusGained(FocusEvent arg0) {
        field4256++;
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIII)V", line = 226)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)Lkk;", line = 246)
    ...
    @OriginalMember(owner = "client!lm", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 257)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method1946('\u0000', 0, -1, 0);
        field4262++;
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 265)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZ)Z", line = 293)
    ...
    @OriginalMember(owner = "client!lm", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 308)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1940(0, arg0, false);
        field4248++;
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(CIII)V", line = 317)
    ...
    @OriginalMember(owner = "client!lm", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 335)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method1940(1, arg0, false);
        field4260++;
    }

    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 369)
    public class338(Component arg0) {
        class324.method1828((byte) 12);
        this.method1944(arg0, true);
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 346)
