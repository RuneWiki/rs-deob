...
public class class338 extends class181 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lfk;Lcq;[Laf;[I[I)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(CIIIZLfa;II)V")
