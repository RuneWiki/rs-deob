...
public class class338 extends class601 {
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Lqea;)V", line = 3)
    public class338(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(ILqea;)V", line = 44)
    public class338(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jia", name = "a", descriptor = "()V", line = 49)
    public static final void method2149() {
        class269.field3931 = class269.field3929;
    }

    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IB)I", line = 52)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(I)I", line = 111)
    public final int method2151(int arg0) {
        ++field4743;
        return arg0 != 0 ? -57 : super.field8131;
    }

    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(B)V", line = 134)
