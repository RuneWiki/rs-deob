...
public class class338 extends class593 {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Los;Llga;Ljd;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ia", name = "g", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!ia", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IBLah;)V", line = 108)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIB)V", line = 156)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IZ)V", line = 213)
