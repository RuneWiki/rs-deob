...
public abstract class class338 extends class13 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lwe;I)V", line = 29)
