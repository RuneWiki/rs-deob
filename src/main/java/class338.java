...
public class class338 extends class366 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILbk;Ltj;)Z")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIBZLtj;Lbk;)[F")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IZZZDILtj;Lbk;)[I")
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Llf;)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IZDLtj;ILbk;I)[I")
