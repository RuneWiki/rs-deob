...
public class class338 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLih;Ld;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILih;I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)[Lud;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLih;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lih;Z)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLou;)V")
