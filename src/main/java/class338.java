...
public class class338 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IBI)Z", line = 22)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 35)
