...
public class class338 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLtf;[[B)V", line = 18)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIB)I", line = 102)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLjb;)V", line = 149)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(I)V", line = 171)
