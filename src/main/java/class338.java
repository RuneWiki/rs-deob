...
public class class338 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "([BI)Lpga;", line = 6)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILsca;Lsca;)V", line = 49)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BILk;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 137)
