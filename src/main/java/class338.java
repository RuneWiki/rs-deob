...
public class class338 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uv", name = "toString", descriptor = "()Ljava/lang/String;", line = 17)
    public final String toString() {
        field4321++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)V", line = 32)
