...
public class class338 extends class403 {
    ...
    @OriginalMember(owner = "client!hl", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lbt;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILbt;I)V", line = 44)
