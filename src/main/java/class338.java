...
public class class338 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(FLsga;Lsga;Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lbi;)V", line = 119)
