...
public class class338 extends class509 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IC)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILs;)V", line = 27)
    public static final void method2146(int arg0, class296 arg1) {
        class528.field7227[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lbba;I)I", line = 30)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lgaa;I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IZ)V", line = 299)
