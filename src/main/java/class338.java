...
public class class338 extends class6 implements class302 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IBLsf;II)V")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lda;I[BI)V")
    public class338(class44 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5091 = arg1;
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lwi;B)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILol;Lol;)V")
