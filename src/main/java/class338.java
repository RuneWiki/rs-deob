...
public class class338 extends class561 {

    @OriginalMember(owner = "client!nm", name = "o", descriptor = "Lpc;")
    public class35 field4724;
    ...
    public static final byte[][][] method2137(int arg0, int arg1) {
        field4726++;
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(III)Ltm;")
    public static final class486 method2138(int arg0, int arg1, int arg2) {
        class563 var3 = class199.field2605[arg0][arg1][arg2];
        return var3 == null ? null : var3.field7889;
    }

    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lpc;)V")
    public class338(class35 arg0) {
        this.field4724 = arg0;
    }

    static {
        new class344("Unable to add name - system busy.", "Der Name konnte nicht hinzugefügt werden, das System ist derzeit ausgelastet.", "Impossible d'ajouter un nom - système occupé.", "Não foi possível adicionar o nome. O sistema está ocupado.");
    }
}
