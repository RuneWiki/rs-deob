...
public class class338 extends class271 {
    ...
    @OriginalMember(owner = "client!np", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!np", name = "g", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!np", name = "h", descriptor = "(I)I", line = 57)
    public final int method2054(int arg0) {
        ++field4755;
        return arg0 != 0 ? -128 : (int) super.field4736;
    }

    @OriginalMember(owner = "client!np", name = "i", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Z)J", line = 83)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(II)V", line = 103)
