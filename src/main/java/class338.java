...
public class class338 extends class152 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IZ)Z", line = 3)
    public final boolean method1997(int arg0, boolean arg1) {
        field4180++;
        return arg1 ? this.field4186[arg0].field8857 : false;
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IB)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Z)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(II)Z", line = 150)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Liaa;[I[II[I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;B)V", line = 270)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(I)V", line = 282)
