...
public class class338 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lofa;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(ILofa;B)V", line = 308)
    ...
    @OriginalMember(owner = "client!tda", name = "c", descriptor = "(I)V", line = 368)
