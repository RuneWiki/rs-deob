...
public class class338 extends class539 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lpj;II)Lhe;", line = 7)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()V", line = 15)
    public final void method2029() {
        this.field4913 = null;
    }

    @OriginalMember(owner = "client!he", name = "b", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Ljr;)V", line = 126)
