...
public class class338 extends class327 {
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "()Lij;")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lbd;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILbd;)V")
