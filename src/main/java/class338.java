...
public class class338 extends class522 implements class401 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BLya;)V", line = 6)
    ...
    @OriginalMember(owner = "client!fw", name = "d", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lya;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!fw", name = "g", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(CI)Z", line = 104)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lya;I)V", line = 128)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Z)Z", line = 148)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(ILya;I)Lt;", line = 159)
    ...
    @OriginalMember(owner = "client!fw", name = "e", descriptor = "(I)Z", line = 175)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 187)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)I", line = 198)
    public final int method240(int arg0) {
        ++field5220;
        return arg0 != -15578 ? -53 : this.field5223.field5492;
    }

    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(ILya;II)Z", line = 210)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lya;Lpf;IIIIIZIIIIIII)V", line = 230)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(Lya;I)Lmo;", line = 240)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(B)I", line = 277)
