...
public class class338 extends class476 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Z)Lpt;")
    ...
    @OriginalMember(owner = "client!iia", name = "d", descriptor = "()Lkm;")
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "()Lkm;")
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IDI)Lpt;")
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lpt;I)V")
