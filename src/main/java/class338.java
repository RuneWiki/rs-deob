...
public class class338 extends class106 {
    ...
    @OriginalMember(owner = "client!ew", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lvj;Lpo;)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IILih;)V")
