...
public class class338 extends class13 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lkh;BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!kj", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "()V", line = 656)
    public class338() {
        super(2, false);
    }

    @OriginalMember(owner = "client!kj", name = "e", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZI)[I", line = 86)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(II)[[I", line = 337)
