...
public class class338 extends class739 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lha;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lhga;ILjava/lang/String;I)Lsca;")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lsl;IB)V")
