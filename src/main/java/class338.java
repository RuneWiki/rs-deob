...
public class class338 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)Len;", line = 7)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILen;)V", line = 18)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(I)V", line = 144)
    public class338(int arg0) {
        this.field4749 = arg0;
    }

    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(IIIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Ltq;III)Lnba;", line = 58)
