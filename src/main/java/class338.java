...
public abstract class class338 extends class745 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(II)Lbn;")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BLha;)Z")
    ...
    @OriginalMember(owner = "client!ww", name = "j", descriptor = "(I)[Lhl;")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I[Lmfa;)I")
