...
public class class338 extends class96 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!jq", name = "e", descriptor = "(I)J", line = 48)
    ...
    @OriginalMember(owner = "client!jq", name = "e", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!jq", name = "f", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(Z)I", line = 94)
    public final int method2054(boolean arg0) {
        ++field4922;
        return arg0 ? -111 : (int) (super.field1177 >>> 32 & 255L);
    }

    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(II)V", line = 105)
    public class338(int arg0, int arg1) {
        super.field1177 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!jq", name = "f", descriptor = "(I)V", line = 113)
