...
public class class338 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(II)Lnq;", line = 43)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 109)
