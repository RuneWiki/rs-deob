...
public class class338 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(II)[B", line = 32)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Z[B)V", line = 87)
