...
public abstract class class338 extends class242 {
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I[S)[S", line = 26)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z[Ljava/lang/String;[S)V", line = 45)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(IIIZZ)V", line = 216)
