...
public class class459 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(II)Lpfa;", line = 29)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lpfa;B)V", line = 53)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lpfa;)V", line = 68)
    public class459(class295 arg0) {
        this.field6471 = arg0.field4147;
        this.field6473 = 1;
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IB)I", line = 77)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "([Lpfa;)V", line = 87)
    public class459(class295[] arg0) {
