...
public class class459 extends class463 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ltn;I)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZLoe;ILqa;III)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(ILqa;)Loj;")
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(ILqa;)Lso;")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BILqa;)Z")
