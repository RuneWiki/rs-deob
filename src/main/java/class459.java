...
public class class459 extends class254 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lhda;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!af", name = "k", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II[BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!af", name = "l", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!af", name = "m", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!af", name = "l", descriptor = "(II)I", line = 122)
    ...
    @OriginalMember(owner = "client!af", name = "z", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!af", name = "f", descriptor = "(BI)V", line = 175)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IBLjava/lang/String;IZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!af", name = "n", descriptor = "(B)Z", line = 203)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(I)V", line = 222)
    public class459(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!af", name = "m", descriptor = "(II)I", line = 225)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "([II)V", line = 235)
