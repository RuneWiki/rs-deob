...
public class class459 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(III)Lef;", line = 177)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(II)V", line = 196)
