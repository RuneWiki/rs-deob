...
public class class459 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ILbg;)V", line = 7)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Ljaa;)V", line = 499)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lbg;B)Z", line = 326)
    ...
    @OriginalMember(owner = "client!mw", name = "c", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIIII)Z", line = 401)
    ...
    @OriginalMember(owner = "client!mw", name = "d", descriptor = "(I)Z", line = 448)
