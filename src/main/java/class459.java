...
public class class459 extends class424 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lfd;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IZIIILpe;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "()V", line = 105)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(ZLufa;)V", line = 247)
