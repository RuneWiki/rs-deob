...
public class class459 extends class403 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III)Lmja;")
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(I)Lmu;")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lkv;IIIIII)V")
