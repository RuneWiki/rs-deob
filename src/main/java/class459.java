...
public abstract class class459 extends class623 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 37)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)I", line = 73)
