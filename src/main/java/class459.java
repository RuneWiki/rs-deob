...
public class class459 extends class69 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILaaa;)Ldja;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLgga;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIIII)Lok;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lifa;I)V")
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lgga;)V")
