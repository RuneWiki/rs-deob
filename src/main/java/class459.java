...
public class class459 extends class83 {
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(ILoj;)Lmg;")
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(BLoj;Lqh;)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IILoj;)Lqh;")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIZLa;IBLoj;)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILoj;II)Z")
    public final boolean method28(int arg0, class280 arg1, int arg2, int arg3) {
        ++field6479;
        return arg3 != -6085;
    }

    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)Lpi;")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILkd;BIII)Ljava/awt/Frame;")
