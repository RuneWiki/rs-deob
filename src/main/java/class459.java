...
public class class459 extends class72 {
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(ILcq;)V", line = 7)
    public class459(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/util/Random;IB)I", line = 216)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 247)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lcq;)V", line = 259)
    public class459(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(II)I", line = 262)
    public final int method58(int arg0, int arg1) {
        ++field6623;
        return arg1 != 11260 ? 9 : 1;
    }

    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)I", line = 273)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)I", line = 284)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIIII)Lsfa;", line = 295)
    ...
    @OriginalMember(owner = "client!vq", name = "f", descriptor = "(I)V", line = 319)
