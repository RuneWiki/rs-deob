...
public class class459 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZB)V", line = 63)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IB)Ldm;", line = 79)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIIBI)Z", line = 161)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lee;IZLul;Lul;)V", line = 239)
