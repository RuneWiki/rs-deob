...
public class class459 extends class504 {
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lub;)V", line = 67)
    public class459(class20 arg0) {
        this.field6224 = arg0;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IBI)Z", line = 9)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(IBI)Z", line = 41)
