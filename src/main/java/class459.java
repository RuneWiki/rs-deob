...
public class class459 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILu;Lu;ZB)I")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILug;I)V")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILfo;Lfo;)I")
