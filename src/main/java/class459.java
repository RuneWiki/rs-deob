...
public class class459 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)[I", line = 119)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "()V", line = 444)
