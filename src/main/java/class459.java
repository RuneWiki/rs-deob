...
public class class459 extends class180 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/awt/Component;IIILdq;)Ldc;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILqg;Lkm;ZIILwh;IB)Lab;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILjava/awt/Component;)Lwp;")
