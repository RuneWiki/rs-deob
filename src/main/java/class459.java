...
public class class459 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([BIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([BI)V", line = 277)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)J", line = 294)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([BIBI)V", line = 310)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lri;II)V", line = 869)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(I)Ljava/io/File;", line = 451)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IBLge;)V", line = 467)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(JZ)V", line = 784)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(B)V", line = 802)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ZB)V", line = 848)
