...
public class class459 extends class354 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILti;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIIBIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "()V", line = 328)
    public class459() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BI)[[I", line = 177)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZZ)V", line = 258)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BIII)V", line = 337)
