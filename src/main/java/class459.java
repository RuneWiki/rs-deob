...
public class class459 extends class435 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([I)Ltk;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lvo;I)Lee;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lvo;)Z")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lvo;II)Lee;")
