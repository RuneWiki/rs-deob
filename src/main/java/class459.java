...
public class class459 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lar;ILya;BI)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ZLmk;I)Z")
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lef;)V")
