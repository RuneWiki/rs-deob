...
public class class459 extends class523 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIILqa;)Z", line = 21)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lqa;I)Lpj;", line = 62)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(BLqa;)V", line = 102)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)V", line = 117)
