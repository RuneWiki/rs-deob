...
public class class459 extends class379 {
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lpea;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lpea;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lpea;IIII[I)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lpea;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lpea;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lpea;IIIIIIZ)V")
