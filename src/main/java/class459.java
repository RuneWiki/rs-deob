...
public class class459 extends class601 {
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lqea;)V")
    public class459(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(ILqea;)V")
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IIILuv;)V")
