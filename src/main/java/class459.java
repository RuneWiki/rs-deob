...
public class class459 extends class11 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIIILvi;IIIIII)Z", line = 14)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIB)V", line = 451)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 520)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZZ)V", line = 542)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IZ)V", line = 556)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(I)V", line = 603)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZI)Z", line = 618)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IILpm;)V", line = 629)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(B)V", line = 648)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Lad;Lme;)V", line = 680)
