...
public class class459 extends class146 implements class633 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 17)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(IZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(B)I", line = 157)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(III)Z", line = 169)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Llaa;Z)V", line = 184)
    public class459(class122 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 209)
