...
public class class459 extends class516 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!bf", name = "f", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(II)V", line = 73)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lag;Lkda;Ljq;)V", line = 106)
    ...
    @OriginalMember(owner = "client!bf", name = "g", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BIII)I", line = 212)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(III)V", line = 234)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZZ)V", line = 260)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(B)Z", line = 271)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lpb;II)V", line = 282)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(III)V", line = 293)
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(I)[Lada;", line = 307)
