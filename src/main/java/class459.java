...
public class class459 extends class749 implements class583 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BLha;)Ltf;")
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IILha;B)Z")
    ...
    @OriginalMember(owner = "client!af", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lha;I)Lcca;")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lha;Lc;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lha;IZZ)Llg;")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ldf;IZIIILha;)V")
