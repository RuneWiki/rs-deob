...
public class class459 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Liv;)V", line = 8)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(II)[I", line = 80)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(III)I", line = 380)
