...
public class class459 extends class568 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)V", line = 43)
