...
public class class459 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lnj;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lnj;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 191)
