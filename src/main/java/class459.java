...
public class class459 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(JI)Lgda;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lsba;II)I")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "([Lgda;B)I")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)Lgda;")
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(I)Lgda;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lgda;JI)V")
    ...
    @OriginalMember(owner = "client!wr", name = "d", descriptor = "(I)Lgda;")
