...
public class class459 extends class297 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "()V", line = 81)
    public class459() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sl", name = "f", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lcea;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(II)[I", line = 196)
    ...
    @OriginalMember(owner = "client!sl", name = "e", descriptor = "(II)V", line = 298)
    ...
    @OriginalMember(owner = "client!sl", name = "e", descriptor = "(I)V", line = 339)
