...
public abstract class class459 extends class692 {
    ...
    @OriginalMember(owner = "client!iaa", name = "j", descriptor = "(I)V", line = 18)
    public static void method2877(int arg0) {
        field6863 = null;
        int var1 = -117 % ((arg0 - -57) / 53);
    }

    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B[Lcp;)I", line = 28)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILie;)Lpg;", line = 198)
    ...
    @OriginalMember(owner = "client!iaa", name = "f", descriptor = "(I)Z", line = 220)
    ...
    @OriginalMember(owner = "client!iaa", name = "e", descriptor = "(I)Z", line = 232)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 275)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Z)V", line = 293)
