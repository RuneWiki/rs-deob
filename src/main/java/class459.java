...
public class class459 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)Lis;", line = 11)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(I)V", line = 107)
    public class459(int arg0) {
        this.field6390 = arg0;
    }

    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(IIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "([B[BIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ZIILjava/lang/String;IZIJLjava/lang/String;II)V", line = 71)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lis;B)V", line = 115)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BI)I", line = 143)
