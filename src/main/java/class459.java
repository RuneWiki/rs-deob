...
public class class459 implements class612 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)I", line = 10)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 40)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(III)Z", line = 61)
    ...
    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(I)I", line = 97)
    public final int method2715(int arg0) {
        return arg0 >= -19 ? -111 : this.field6360;
    }

    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z", line = 129)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lrja;Z)V", line = 147)
