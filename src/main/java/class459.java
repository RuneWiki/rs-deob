...
public class class459 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILnp;)V", line = 9)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILnp;I)V", line = 48)
