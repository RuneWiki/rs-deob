...
public class class459 extends class328 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BILco;)V", line = 26)
    ...
    @OriginalMember(owner = "client!td", name = "f", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lqa;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I[[I)V", line = 153)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II)[[I", line = 208)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)[I", line = 279)
