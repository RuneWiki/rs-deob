...
public class class140 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lha;B)V", line = 38)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)Lhc;", line = 58)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BLhc;)V", line = 73)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(I)V", line = 140)
    public class140(int arg0) {
        this.field1577 = arg0;
    }

    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(IIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)V", line = 121)
