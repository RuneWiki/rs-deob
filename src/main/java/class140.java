...
public class class140 extends class391 {
    ...
    @OriginalMember(owner = "client!g", name = "w", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!g", name = "na", descriptor = "(IIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!g", name = "wa", descriptor = "(III[I)V", line = 75)
    ...
    @OriginalMember(owner = "client!g", name = "ZA", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!g", name = "Y", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lla;ZLuq;Lr;BLjava/lang/String;)V", line = 134)
    ...
    @OriginalMember(owner = "client!g", name = "U", descriptor = "(III)V", line = 216)
    ...
    @OriginalMember(owner = "client!g", name = "AA", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "()Lq;", line = 263)
    ...
    @OriginalMember(owner = "client!g", name = "o", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(III[I)V", line = 299)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!g", name = "J", descriptor = "(I)V", line = 327)
    ...
    @OriginalMember(owner = "client!g", name = "YA", descriptor = "([I)V", line = 342)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(I)V", line = 359)
    ...
    @OriginalMember(owner = "client!g", name = "oa", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!g", name = "M", descriptor = "(Lq;)V", line = 388)
    ...
    @OriginalMember(owner = "client!g", name = "NA", descriptor = "(III)V", line = 413)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "()V", line = 432)
    public class140() {
        this.method271();
    }
}
