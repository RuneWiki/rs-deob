...
public class class140 implements class532 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Z)I", line = 38)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 49)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(Z)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Lik;Lbk;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(Z)Lbk;", line = 115)
