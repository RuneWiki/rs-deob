...
public abstract class class140 implements class461 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(FFFFFFLaa;II)V")
