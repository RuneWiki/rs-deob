...
public class class140 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "([I[JB)V", line = 20)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)Lbr;", line = 31)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILji;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lji;I)V", line = 83)
