...
public class class140 extends class83 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "([Lfd;IZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IBLtq;)V", line = 134)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZI)[[I", line = 181)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIIIII)V", line = 260)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)[I", line = 288)
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "(B)V", line = 334)
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "(I)V", line = 344)
