...
public class class140 implements class437 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 12)
    public static void method1120(int arg0) {
        field2316 = null;
        int var1 = 105 % ((-arg0 - 15) / 36);
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lha;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)Lad;", line = 61)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lsd;Lec;IIIIIII)V", line = 75)
