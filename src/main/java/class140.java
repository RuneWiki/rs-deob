...
public class class140 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLam;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)Lev;", line = 21)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IILjava/lang/String;II[B)I", line = 68)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(B)Lev;", line = 215)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLl;Loi;)V", line = 245)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 257)
    public class140() {
    }

    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lam;)V", line = 260)
