...
public class class140 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lha;III)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILha;IB)V")
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lrp;Lrp;I)V")
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lnv;Lida;)V")
