...
public class class140 {
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "Llf;")
    public static class109 field2706 = class35.method275("Weiter", 2);

    @OriginalMember(owner = "client!pa", name = "c", descriptor = "Llf;")
    public static class109 field2707 = class35.method275("blaugr-Un:", 2);

    @OriginalMember(owner = "client!pa", name = "r", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!pa", name = "t", descriptor = "Llf;")
    public static class109 field2724 = field2722;

    @OriginalMember(owner = "client!pa", name = "p", descriptor = "Llf;")
    private static class109 field2720 = class35.method275("Please use a different world)3", 2);

    @OriginalMember(owner = "client!pa", name = "w", descriptor = "Llf;")
    public static class109 field2727 = field2720;

    @OriginalMember(owner = "client!pa", name = "m", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!pa", name = "l", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "[Lkf;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)Li;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIIILka;IJIIII)Z")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBLu;I)V")
