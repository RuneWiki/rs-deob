...
public class class140 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILfg;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 94)
    public class140() {
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Les;)V", line = 111)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILes;)V", line = 77)
