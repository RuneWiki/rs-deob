...
public class class140 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lsq;IIIII)Lvq;", line = 85)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I[[I)V", line = 117)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 162)
    public class140(class453 arg0, int arg1, class320 arg2) {
        this.field2167 = arg2;
        this.field2167.method2030(-10914, 29);
    }

    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(II)Lep;", line = 134)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)V", line = 177)
