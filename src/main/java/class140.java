...
public class class140 extends class36 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(III)I", line = 81)
    ...
    @OriginalMember(owner = "client!jh", name = "g", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "([B)V", line = 110)
