...
public class class140 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIBLnj;)V", line = 44)
