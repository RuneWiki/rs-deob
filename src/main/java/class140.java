...
public class class140 extends class540 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)Lib;", line = 49)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(III)I", line = 62)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)V", line = 92)
