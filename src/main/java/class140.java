...
public class class140 extends class325 {
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lvj;II)V")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lr;IBIII)V")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lwl;ILkca;Lr;BILfg;I)V")
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lvj;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lvj;IIZ[[BI)V")
