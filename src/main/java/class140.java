...
public class class140 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(IIIIB)V", line = 50)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)I", line = 62)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lpd;I)V", line = 89)
