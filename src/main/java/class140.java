...
public class class140 extends class401 implements class293 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Ltm;Z)V")
    public class140(class327 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
