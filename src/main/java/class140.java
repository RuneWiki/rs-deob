...
public class class140 extends class371 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IBLps;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IIIIBII)V", line = 45)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(BI)[I", line = 624)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "()V", line = 704)
    public class140() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 708)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(B)V", line = 719)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ILwca;)V", line = 750)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Ldda;I)I", line = 790)
