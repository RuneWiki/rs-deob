...
public class class140 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lvh;Lvh;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILlh;I)V", line = 61)
