...
public class class140 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IB)Lc;", line = 16)
    ...
    @OriginalMember(owner = "client!ss", name = "toString", descriptor = "()Ljava/lang/String;", line = 60)
    public final String toString() {
        field1687++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(II)V", line = 80)
