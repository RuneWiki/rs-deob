...
public class class140 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)Liu;")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/awt/Component;Z)Lpea;")
    public static final class457 method994(Component arg0, boolean arg1) {
        field1908++;
        return arg1 ? null : new class606(arg0);
    }

    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lmp;ILla;)V")
