...
public class class140 extends class205 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IZLla;IIDLd;)[I", line = 3)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIILjava/lang/Class;)Lvp;", line = 143)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILd;ZLla;ZZDI)[I", line = 167)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(II)I", line = 332)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lla;IIZLd;I)[F", line = 348)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ld;ILla;)Z", line = 457)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lofa;I)Lge;", line = 518)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILjava/lang/String;IIZ)V", line = 544)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "()V", line = 554)
    public class140() {
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lofa;)V", line = 587)
