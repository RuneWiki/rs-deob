...
public class class140 implements Runnable {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lvg;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljava/lang/String;I)Lcb;", line = 17)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljb;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "()V", line = 122)
    public class140() {
        this.field2029.setDaemon(true);
        this.field2029.start();
    }

    @OriginalMember(owner = "client!vn", name = "run", descriptor = "()V", line = 134)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)V", line = 174)
