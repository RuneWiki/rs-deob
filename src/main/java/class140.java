...
public class class140 implements Runnable {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/awt/Point;ILjava/awt/Component;II[I)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/String;BZ)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ZLjava/awt/Frame;)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILjava/lang/String;)Ldn;")
    public final class548 method1051(int arg0, String arg1) {
        int var3 = 10 / ((arg0 - 77) / 48);
        return this.method1050(0, 24002, 16, arg1, 0);
    }

    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/net/URL;B)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IZLjava/lang/String;I)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Lhr;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIIII)Ldn;")
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(ILjava/lang/String;)Lhr;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
