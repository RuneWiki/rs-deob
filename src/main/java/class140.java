...
public class class140 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIIIILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BI)Lfg;", line = 25)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)Lde;", line = 96)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(ILuu;Luu;)V", line = 111)
