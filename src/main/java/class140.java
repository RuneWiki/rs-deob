...
public class class140 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/applet/Applet;BLjava/lang/String;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;I[Ljava/lang/Object;)Ljava/lang/Object;", line = 12)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B)V", line = 22)
