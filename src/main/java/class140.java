...
public class class140 extends class223 {
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lih;IIIIZ[FI)V", line = 6)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lih;IIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIII[BIIIZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "()V", line = 88)
    public final void method570() {
        this.field3152.field4741.glFramebufferTexture2DEXT(36160, this.field1865, this.field3156, 0, 0);
        this.field1865 = -1;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lih;IIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lih;IIIIZ[BIZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZZ)V", line = 167)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lih;IIIIZ[IZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIII[IIIZ)V", line = 227)
