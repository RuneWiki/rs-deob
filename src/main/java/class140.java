...
public class class140 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BI)Lbd;", line = 17)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IZ)Z", line = 52)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IB)V", line = 64)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILjava/lang/String;IBI)V", line = 109)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 277)
