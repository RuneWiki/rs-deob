...
public class class140 extends class175 {
    ...
    @OriginalMember(owner = "client!g", name = "finalize", descriptor = "()V", line = 7)
    protected final void finalize() {
        field1667++;
        this.method872(-1);
    }

    @OriginalMember(owner = "client!g", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIZBIIIII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II[BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIIBI)V", line = 91)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II[BZ)I", line = 109)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IB)Z", line = 149)
