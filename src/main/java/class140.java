...
public class class140 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)Lpa;")
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(III)Le;")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lae;ILqn;Lqn;)V")
