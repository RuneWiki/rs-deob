...
public class class140 extends class442 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II)I", line = 84)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Luu;IZ)V", line = 132)
