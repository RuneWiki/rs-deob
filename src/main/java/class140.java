...
public class class140 extends class667 {
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "()V", line = 43)
    public class140() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lud;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!fea", name = "c", descriptor = "(III)Lrc;", line = 127)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(BI)[I", line = 145)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(Z)V", line = 368)
