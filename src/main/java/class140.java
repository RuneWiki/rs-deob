...
public class class140 extends class11 {
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(II)I", line = 6)
    public static final int method937(int arg0, int arg1) {
        return class391.field5739 != null ? class391.field5739[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!su", name = "d", descriptor = "(II)[I", line = 10)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lju;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "()V", line = 64)
    public class140() {
        super(0, true);
    }

    @OriginalMember(owner = "client!su", name = "c", descriptor = "(III)I", line = 70)
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(I)V", line = 90)
