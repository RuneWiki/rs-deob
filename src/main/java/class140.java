...
public class class140 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BI)I", line = 107)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(BI)Lr;", line = 159)
