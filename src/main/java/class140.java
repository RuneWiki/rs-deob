...
public class class140 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lje;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/lang/String;Lng;BI)Liu;")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lgp;ILui;)V")
