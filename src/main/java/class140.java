...
public class class140 extends class138 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIILml;II)Ljava/awt/Frame;", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 72)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILtj;)V", line = 86)
    ...
    @OriginalMember(owner = "client!pd", name = "f", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "(B)Z", line = 150)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Laa;Ljava/lang/Object;)V", line = 162)
