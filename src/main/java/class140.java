...
public class class140 extends class187 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "([S[Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BII)V", line = 13)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(IIIIIF)V", line = 25)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IBB)V", line = 44)
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)I", line = 74)
    public static int method1023(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(I)V", line = 100)
