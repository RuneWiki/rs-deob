...
public class class140 extends class179 {
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(JI)V", line = 16)
    ...
    @OriginalMember(owner = "client!eq", name = "f", descriptor = "(I)V", line = 103)
