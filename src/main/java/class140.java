...
public class class140 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lic;ILub;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;ZLmca;Z)V", line = 369)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 438)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 472)
