...
public class class140 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)Z", line = 47)
