...
public abstract class class140 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 9)
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(I)V", line = 57)
