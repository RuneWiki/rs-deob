...
public class class140 extends class179 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lwo;ILtn;Lwo;)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lbg;ILnh;I)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ZZIIZ)Lwo;")
