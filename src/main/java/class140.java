...
public class class140 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)Lqc;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILdh;)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ldh;Z)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(B)Lqc;")
