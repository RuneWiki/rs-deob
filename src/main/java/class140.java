...
public class class140 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)Lefa;")
    public final class153 method787(byte arg0) {
        field1901++;
        return arg0 == -12 ? class35.method204((byte) -75, this.field1902) : null;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BIII)Lmp;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
