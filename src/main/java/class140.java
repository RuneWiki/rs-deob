...
public class class140 extends class317 implements class659 {
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lap;I[BI)V", line = 16)
    public class140(class435 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1601 = arg1;
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lap;ILjaclib/memory/Buffer;)V", line = 35)
    public class140(class435 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field1601 = arg1;
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BLjava/lang/String;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)J", line = 60)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BI[BI)V", line = 80)
