...
public class class114 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIIIIIIIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 29)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(I)V", line = 49)
