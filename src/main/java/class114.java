...
public class class114 {
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(II)Lsk;", line = 36)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 81)
