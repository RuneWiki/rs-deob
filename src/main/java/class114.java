...
public class class114 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Luu;IIILya;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IZ)I", line = 297)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIIIII)V", line = 326)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)I", line = 349)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(BIIIII)V", line = 368)
