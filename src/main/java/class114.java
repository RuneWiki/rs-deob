...
public class class114 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Lqba;)V", line = 131)
    public class114(class425 arg0) {
    }

    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)V", line = 36)
