...
public class class114 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BLjava/lang/String;Ljava/applet/Applet;)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;")
