...
public class class114 extends class164 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIII[I)Z", line = 12)
    ...
    @OriginalMember(owner = "client!hw", name = "e", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 568)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)I", line = 87)
    ...
    @OriginalMember(owner = "client!hw", name = "f", descriptor = "(I)V", line = 98)
    public static void method818(int arg0) {
        int var1 = 116 / ((83 - arg0) / 43);
        field1482 = null;
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(BI[II)Z", line = 110)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IBI)Z", line = 140)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I[[[Lcq;ZIII)Z", line = 174)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "([IIII)Z", line = 544)
