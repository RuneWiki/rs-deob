...
public class class114 extends class98 {
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BII)I", line = 44)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILdg;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)[I", line = 101)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "()V", line = 140)
    public class114() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(IIII)I", line = 143)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BLon;Lon;)V", line = 175)
    ...
    @OriginalMember(owner = "client!ik", name = "f", descriptor = "(I)V", line = 195)
