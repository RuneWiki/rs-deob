...
public class class114 extends class425 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IILjava/lang/String;)V", line = 15)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lpn;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(IIIIIZ)V", line = 270)
