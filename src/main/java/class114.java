...
public class class114 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(II)Lhi;", line = 6)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lnm;Lcp;)V", line = 63)
