...
public class class114 extends class401 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BILjava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "()V", line = 35)
    public class114() {
    }

    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 37)
    public class114(String arg0, int arg1) {
        this.field1573 = arg0;
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(B)V", line = 81)
