...
public class class114 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lqj;II)Lhi;", line = 4)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "()[B", line = 13)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "()I", line = 77)
    ...
    @OriginalMember(owner = "client!hi", name = "c", descriptor = "()Leg;", line = 120)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Leb;)V", line = 129)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "()V", line = 149)
    private class114() {
    }
}
