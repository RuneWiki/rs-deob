...
public class class114 extends class130 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BILza;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IZI)I", line = 101)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "([B)V", line = 120)
    public class114(byte[] arg0) {
        this.field1749 = arg0;
    }

    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II)V", line = 139)
