...
public class class114 extends class67 implements class259 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "()I", line = 7)
    public final int method978() {
        return 0;
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I[BI)V", line = 10)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lge;I[BI)V", line = 15)
