...
public class class114 extends class102 implements class118 {
    ...
    @OriginalMember(owner = "client!uq", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ILlt;ILjava/awt/Canvas;Ll;)Lza;", line = 17)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IBIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BLsb;Lza;)I", line = 133)
    ...
    @OriginalMember(owner = "client!uq", name = "f", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)J", line = 169)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lda;ILjaggl/memory/NativeBuffer;IZ)V", line = 182)
    public class114(class44 arg0, int arg1, NativeBuffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2055 = arg1;
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "([BIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lda;I[BIZ)V", line = 203)
    public class114(class44 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2055 = arg1;
    }

    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)I", line = 211)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)I", line = 224)
