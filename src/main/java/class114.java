...
public class class114 extends class219 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lnc;IIIIIIIIIIIZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(J)V", line = 23)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(JI)V", line = 154)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "()V", line = 550)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "()V", line = 560)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lnc;IIIIIIIIIIIZZ)V", line = 571)
