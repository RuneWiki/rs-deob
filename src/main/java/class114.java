...
public class class114 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Luj;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Luj;ZLeea;)V", line = 61)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "()V", line = 284)
    public class114() {
        this.field1413.field4681 = this.field1413;
        this.field1413.field4677 = this.field1413;
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Luj;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(I)Luj;", line = 107)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(B)Luj;", line = 128)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Leea;B)V", line = 152)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Z)Luj;", line = 170)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(Z)Z", line = 184)
    ...
    @OriginalMember(owner = "client!eea", name = "c", descriptor = "(I)Luj;", line = 195)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(BI)I", line = 220)
    ...
    @OriginalMember(owner = "client!eea", name = "d", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!eea", name = "c", descriptor = "(Z)Luj;", line = 264)
