...
public class class114 {
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!hi", name = "c", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lnq;Lnq;Lnq;ILnq;)V", line = 98)
