...
public class class114 {
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "Lnfa;")
    public class665 field1481;

    @OriginalMember(owner = "client!we", name = "f", descriptor = "Ljava/awt/Frame;")
    public static Frame field1483;
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lfd;I)V", line = 15)
    public final void method861(class418 arg0, int arg1) {
        field1478++;
        if (arg1 != -1) {
            this.field1486 = -109;
        }
        while (true) {
            int var3 = arg0.method2396(arg1 + 96);
            if (var3 == 0) {
                return;
            }
            this.method865(arg0, arg1 - 2, var3);
        }
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(B)Law;", line = 39)
    public final synchronized class506 method862(byte arg0) {
        field1485++;
        if (arg0 != 83) {
            return null;
        }
        class506 var2 = (class506) this.field1481.field9235.method3655(26, (long) this.field1484);
        if (var2 != null) {
            return var2;
        }
        class506 var3 = class506.method2732(this.field1481.field9226, this.field1484, 0);
        if (var3 != null) {
            this.field1481.field9235.method3650((long) this.field1484, -123, var3);
        }
        return var3;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(III)V", line = 60)
    public static final void method863(int arg0, int arg1, int arg2) {
        if (arg1 != -11243) {
            field1480 = null;
        }
        field1479++;
        class367 var3 = class573.method3057(7, arg0, arg1 ^ 0xFFFFD417);
        var3.method2115(1);
        var3.field4735 = arg2;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)V", line = 74)
    public static final void method864(int arg0) {
        field1489++;
        class384.field4912.method2085((byte) 9);
        class211.field2722 = arg0;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lfd;II)V", line = 91)
    private final void method865(class418 arg0, int arg1, int arg2) {
        if (arg1 != -3) {
            this.field1484 = 11;
        }
        field1488++;
        if (arg2 == 1) {
            this.field1484 = arg0.method2393(-30727);
        } else if (arg2 == 2) {
            this.field1486 = arg0.method2396(-122);
            this.field1487 = arg0.method2396(arg1 ^ 0xFFFFFFC6);
        }
    }
}
