...
public class class114 extends class449 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IC)C", line = 3)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIIII)V", line = 403)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IZII)V", line = 423)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(II)V", line = 448)
    public class114(int arg0, int arg1) {
        this.field1597 = arg0;
        this.field1603 = arg1;
    }

    @OriginalMember(owner = "client!al", name = "d", descriptor = "(I)V", line = 462)
