...
public class class114 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Lnp;")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(JI)Lnp;")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IJLnp;)V")
