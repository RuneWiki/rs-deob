...
public class class114 extends class366 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZLvp;)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILhh;II)Lds;")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BLtn;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lqg;)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILgo;B)V")
