...
public class class114 extends class56 {
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "()V", line = 20)
    public class114() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II)[I", line = 40)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIFIZIII)[[I", line = 140)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BILes;)V", line = 173)
    ...
    @OriginalMember(owner = "client!jt", name = "d", descriptor = "(Z)V", line = 273)
