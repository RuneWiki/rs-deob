...
public abstract class class114 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIIIIII)Lk;", line = 104)
