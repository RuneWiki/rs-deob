...
public class class114 extends class60 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lnr;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(Lnr;Z)Lg;", line = 13)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILnr;II)Z", line = 84)
