...
public class class114 extends class71 {
    ...
    @OriginalMember(owner = "client!mb", name = "s", descriptor = "[Lne;")
    public class126[] field2259;

    @OriginalMember(owner = "client!mb", name = "v", descriptor = "[Lk;")
    ...
    @OriginalMember(owner = "client!mb", name = "y", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I[BLcb;[I)Z")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IB)Llf;")
