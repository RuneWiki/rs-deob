...
public class class114 extends class249 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lwh;Ljga;)V", line = 48)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ZZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!bm", name = "d", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lme;ZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Ldv;IIBI)V", line = 153)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(I)V", line = 230)
