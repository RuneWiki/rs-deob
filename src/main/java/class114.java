...
public class class114 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 30)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)I", line = 110)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 115)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(JI)V", line = 150)
    ...
    @OriginalMember(owner = "client!ph", name = "c", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!ph", name = "d", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)V", line = 217)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BJLjava/lang/Object;)V", line = 275)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 303)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!ph", name = "e", descriptor = "(I)I", line = 372)
