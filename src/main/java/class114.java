...
public class class114 extends class623 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Lig;I)Lor;", line = 29)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Lcs;Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 97)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Ltca;)V", line = 112)
