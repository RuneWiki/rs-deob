...
public class class114 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lsq;Z)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Ljd;IIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILvg;I)I", line = 213)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIII)Z", line = 230)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IB)V", line = 368)
