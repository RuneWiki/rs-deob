...
public class class114 extends class747 implements class200 {
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbga;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(BIILat;)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbga;Lwq;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IB[FLwq;IIIII)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIBIIII[BLwq;)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbga;Lwq;Lbaa;II)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbga;Lwq;IIZ[FII)V")
