...
public class class114 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IZIIIIZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(CI)Z", line = 80)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIIIII)I", line = 98)
