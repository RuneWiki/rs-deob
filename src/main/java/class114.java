...
public class class114 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(II[I)Lbq;")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "([IIIB)Lbq;")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(III[I)Lbq;")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "([III)Lbq;")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILcu;)Lut;")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lbu;Lbu;)V")
