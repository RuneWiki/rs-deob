...
public class class114 extends class673 implements class199 {
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lvj;ILjaclib/memory/Buffer;IZ)V", line = 3)
    public class114(class422 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1201 = arg1;
    }

    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lvj;I[BIZ)V", line = 39)
    public class114(class422 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1201 = arg1;
    }

    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILnp;)Lcba;", line = 59)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(I)J", line = 87)
    ...
    @OriginalMember(owner = "client!vp", name = "e", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II[BI)V", line = 136)
