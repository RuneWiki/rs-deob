...
public class class114 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)Lge;", line = 13)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIB)V", line = 50)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lge;B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 176)
    public class114() {
        this.field1619.field6900 = this.field1619;
        this.field1619.field6903 = this.field1619;
    }

    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(I)Lge;", line = 131)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(B)Lge;", line = 158)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lqa;Leq;IIIII)V", line = 187)
