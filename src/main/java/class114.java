...
public class class114 extends class115 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILjf;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(II)[I", line = 29)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "()V", line = 116)
    public class114() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hi", name = "h", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BLbk;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(II)[[I", line = 195)
