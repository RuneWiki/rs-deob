...
public class class114 {
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILrja;)Z")
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(IIBI)V")
    ...
    @OriginalMember(owner = "client!rja", name = "<init>", descriptor = "(Lso;)V")
