...
public class class114 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BIIIILtj;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIII)I", line = 84)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IZLtj;)Z", line = 99)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)V", line = 191)
    public static void method840(byte arg0) {
        int var1 = -17 / ((11 - arg0) / 39);
        field1489 = null;
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(II)Ljava/lang/String;", line = 201)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IILjava/lang/String;)V", line = 231)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(I[Lrp;IIII)V", line = 318)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ZILjava/lang/Object;)[B", line = 248)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IC)Z", line = 341)
