...
public class class114 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IB)[[I", line = 12)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(III)V", line = 201)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Z)[[[I", line = 86)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(CZ)Z", line = 139)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II)V", line = 150)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)V", line = 181)
