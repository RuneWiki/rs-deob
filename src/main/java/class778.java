...
public class class778 {
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(II)Lis;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZI)Ljba;")
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lega;ILwm;Lwm;Lwm;)V")
