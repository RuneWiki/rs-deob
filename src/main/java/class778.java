...
public class class778 extends class742 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)Luu;", line = 14)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lrj;Lmq;IIIIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IILjava/lang/String;)Z", line = 45)
