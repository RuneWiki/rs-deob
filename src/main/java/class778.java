...
public abstract class class778 extends class547 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Z[Ljw;)I")
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Liw;B)V")
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(ILha;)Z")
