...
public class class778 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILpca;)V", line = 28)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)Lpca;", line = 73)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(I)Lpca;", line = 104)
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "(I)I", line = 133)
