...
public class class778 extends class659 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IBII)I", line = 28)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!wga", name = "d", descriptor = "(B)I", line = 69)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!wga", name = "e", descriptor = "(B)J", line = 98)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(IJ)V", line = 112)
