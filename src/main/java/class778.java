...
public class class778 extends class476 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZILha;B)Lqm;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Lld;")
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(Z)Lkj;")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lae;Lae;Lht;)V")
