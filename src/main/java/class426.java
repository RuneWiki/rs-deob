...
public class class426 implements class440 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIZLjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lkfa;Z)V")
