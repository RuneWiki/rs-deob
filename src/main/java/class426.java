...
public class class426 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(CI)V", line = 32)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lih;I)V", line = 59)
