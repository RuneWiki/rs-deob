...
public class class426 extends class499 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IZLha;ZJ)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(JILha;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lha;Lcm;Ll;J)V")
