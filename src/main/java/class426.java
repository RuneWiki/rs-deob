...
public class class426 extends class371 implements class74 {
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(Lkj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lbf;ILjava/nio/ByteBuffer;)V", line = 10)
    public class426(class344 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field5778 = arg1;
    }

    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(Lkj;)V", line = 14)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lbf;I[BI)V", line = 19)
    public class426(class344 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5778 = arg1;
    }

    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lkj;)V", line = 23)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(Lkj;)V", line = 26)
