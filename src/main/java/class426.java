...
public class class426 extends class570 implements class2 {
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Loha;")
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Loha;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Lfga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Loha;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsu;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)Ltea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvi;Z)Lpu;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwq;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Loha;")
    public final class465 method948() {
        return this.field5613;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lod;Lic;)Lmd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lgu;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lne;[Lvi;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmd;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltea;)V")
    public final void method910(class589 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)Lic;")
    public final class537 method938(int arg0, int arg1) {
        return new class626(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lgu;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Lod;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwq;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltea;Ltea;FLtea;)Ltea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lpu;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lpu;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwq;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lpu;")
