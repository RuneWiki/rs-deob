...
public class class426 extends class77 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZLha;I)Z")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZILha;ILrda;II)V")
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(Lha;B)Lrga;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILfaa;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lha;B)Lkv;")
