...
public class class426 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lve;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)Lve;", line = 53)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(I)V", line = 118)
    public class426(int arg0) {
        this.field5482 = arg0;
    }

    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(IIIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIII)I", line = 72)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILqa;II)V", line = 97)
