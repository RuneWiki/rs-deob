...
public class class426 extends class615 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IIILno;IB)Lmn;")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(BILeh;)V")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(BLbi;)V")
