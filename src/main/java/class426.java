...
public class class426 extends class383 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLtf;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILya;I)Lt;", line = 79)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lya;IIIIIIIB)V", line = 161)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 299)
