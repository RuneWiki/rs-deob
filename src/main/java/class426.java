...
public class class426 extends class66 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)Luda;", line = 18)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lr;Lob;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 440)
    public class426() {
    }

    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(S)V", line = 446)
