...
public class class426 extends class502 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(B)I", line = 123)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Ljava/awt/Canvas;IIB)Lhf;", line = 134)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Leka;)V", line = 180)
    public class426(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(ILeka;)V", line = 186)
