...
public class class426 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILbr;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(III)V", line = 49)
