...
public class class426 extends class190 {
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Ljj;)V", line = 41)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZI)V", line = 79)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!cc", name = "d", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZB)V", line = 138)
    ...
    @OriginalMember(owner = "client!cc", name = "e", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILaba;I)V", line = 161)
