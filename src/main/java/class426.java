...
public class class426 {
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZLjava/lang/String;)Z", line = 27)
    ...
    @OriginalMember(owner = "client!sj", name = "e", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(III)Z", line = 90)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lte;BI)Z", line = 102)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IBI)I", line = 134)
