...
public class class426 extends class225 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZLnj;)V", line = 6)
    ...
    @OriginalMember(owner = "client!rk", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(BI)Lpr;", line = 59)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILnj;B)V", line = 94)
    ...
    @OriginalMember(owner = "client!rk", name = "f", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!rk", name = "g", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZII)V", line = 171)
