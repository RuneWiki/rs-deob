...
public class class426 extends class472 {
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!hq", name = "d", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lko;)V", line = 3179)
    public class426(class190 arg0) {
        this.field6345 = arg0;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)Z", line = 3187)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)V", line = 3202)
