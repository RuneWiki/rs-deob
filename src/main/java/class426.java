...
public class class426 {
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ILjagdx/IDirect3DSwapChain;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!hja", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 53)
    public class426(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method2572(arg1, 0, arg0);
    }

    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(IB)I", line = 63)
