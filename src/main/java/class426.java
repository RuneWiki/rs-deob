...
public class class426 extends class530 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(ILah;)V", line = 17)
    public class426(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lah;)V", line = 21)
    public class426(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)I", line = 57)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIIII)I", line = 82)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(Z)V", line = 121)
