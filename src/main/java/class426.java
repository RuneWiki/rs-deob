...
public class class426 extends class56 {
    ...
    @OriginalMember(owner = "client!ifa", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IZ)[I", line = 18)
    ...
    @OriginalMember(owner = "client!ifa", name = "d", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "()V", line = 82)
    public class426() {
        super(1, true);
    }
}
