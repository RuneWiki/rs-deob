...
public class class426 extends class294 {
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(I)Lsg;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILsg;Lsg;F)V")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lih;I)V")
