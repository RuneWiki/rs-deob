...
public class class426 {
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(IC)Z", line = 10)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(B)Ldn;", line = 45)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(IB)Lhja;", line = 63)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!hja", name = "<init>", descriptor = "(II)V", line = 94)
