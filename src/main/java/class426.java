...
public class class426 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(II)Lmb;", line = 14)
    public final class426 method2570(int arg0, int arg1) {
        field5942++;
        return arg0 == 19870 ? new class426(this.field5949, arg1) : null;
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)Lfa;", line = 25)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(II)V", line = 39)
    public class426(int arg0, int arg1) {
        this.field5944 = arg1;
        this.field5949 = arg0;
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 49)
