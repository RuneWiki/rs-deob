...
public class class426 extends class465 implements class49 {
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIIILrb;Lr;Z)V")
    ...
    @OriginalMember(owner = "client!vm", name = "d", descriptor = "(Lr;I)Llf;")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(Lr;I)Lwj;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BILr;)Lda;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IB)Lfg;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lr;IIZ)Lhi;")
