...
public class class426 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Lli;)V", line = 130)
    public class426(class449 arg0) {
    }

    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 59)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(I)V", line = 133)
