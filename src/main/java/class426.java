...
public abstract class class426 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(FFFI)F", line = 5)
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!vn", name = "finalize", descriptor = "()V", line = 308)
    ...
    @OriginalMember(owner = "client!vn", name = "f", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "([BII)V", line = 477)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lkw;I[BIZ)V", line = 501)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lkw;ILjaclib/memory/Buffer;IZ)V", line = 520)
