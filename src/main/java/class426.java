...
public class class426 implements Runnable {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;I)Luq;", line = 4)
    ...
    @OriginalMember(owner = "client!ek", name = "run", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLeo;)Leo;", line = 80)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "()V", line = 147)
    public class426() {
        this.field5842.setDaemon(true);
        this.field5842.start();
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLlf;)V", line = 134)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 161)
