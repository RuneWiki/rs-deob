...
public class class426 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)Z", line = 40)
    public static final boolean method2553(int arg0, int arg1, int arg2) {
        field6232++;
        return (class456.field6661[arg2][arg1][arg0] & 0x2) != 0;
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(IIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(III)Z", line = 109)
