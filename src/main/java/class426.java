...
public class class426 extends class646 {
    ...
    @OriginalMember(owner = "client!ug", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lek;IB)V", line = 41)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "()V", line = 87)
    public class426() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ug", name = "f", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(IB)[I", line = 148)
