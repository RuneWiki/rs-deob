...
public abstract class class426 extends class476 {
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B[[BLpu;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(B)Z", line = 131)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BI)V", line = 158)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lpg;)V", line = 175)
    public class426(class333 arg0) {
        this.field6193 = arg0;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BLdk;)I", line = 183)
