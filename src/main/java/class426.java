...
public class class426 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIZILia;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "([BIBI)I", line = 137)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)V", line = 161)
