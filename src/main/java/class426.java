...
public class class426 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZIBII[[[Lhg;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)Ljava/lang/String;", line = 322)
    ...
    @OriginalMember(owner = "client!tq", name = "toString", descriptor = "()Ljava/lang/String;", line = 355)
    public final String toString() {
        field6285++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(II)V", line = 366)
