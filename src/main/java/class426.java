...
public class class426 extends class107 {
    ...
    @OriginalMember(owner = "client!dp", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "()V", line = 29)
    public class426() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIB)[B", line = 33)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BZI)V", line = 45)
    ...
    @OriginalMember(owner = "client!dp", name = "f", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(B)V", line = 81)
