...
public class class426 extends class298 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 56)
    public class426() {
        super(1, false);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IILvt;)V", line = 60)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZ)[I", line = 163)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIIIILgn;)V", line = 198)
