...
public class class426 extends class384 {
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(III)[B", line = 3)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 8)
    public class426() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IB)V", line = 12)
