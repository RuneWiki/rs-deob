...
public class class426 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILba;III)Lgr;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILjo;Ljava/awt/Canvas;BLe;)Loa;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIIILoa;ILba;IILam;IIII)Lba;")
