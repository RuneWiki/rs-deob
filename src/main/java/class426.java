...
public class class426 extends class349 {
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "()V", line = 4)
    public class426() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(BI)[I", line = 7)
    ...
    @OriginalMember(owner = "client!bp", name = "f", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIZI)V", line = 69)
