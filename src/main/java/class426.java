...
public class class426 extends class329 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ZZZLtt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BI)I", line = 60)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLes;)Ltl;", line = 71)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIIIIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 109)
