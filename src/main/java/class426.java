...
public abstract class class426 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILaca;)V", line = 18)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)Z", line = 66)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)Z", line = 102)
