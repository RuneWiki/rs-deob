...
public class class215 extends class240 {
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lt;Ljava/lang/Object;)V", line = 4)
    public class215(class400 arg0, Object arg1) {
        super(arg0);
        this.field2994 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 24)
