...
public class class215 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!ida", name = "toString", descriptor = "()Ljava/lang/String;", line = 44)
    public final String toString() {
        field2607++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(I)V", line = 117)
