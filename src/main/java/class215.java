...
public class class215 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Ltl;B)V", line = 38)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IZI[BIILbv;I)Log;", line = 90)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 109)
