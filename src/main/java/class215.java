...
public class class215 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILfh;IIIIILha;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Loh;ZLjava/lang/String;Z)Laga;", line = 80)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)Lmc;", line = 133)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(I)Lmc;", line = 153)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "()V", line = 194)
    public class215() {
    }

    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lpfa;)V", line = 197)
