...
public class class215 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IB)I", line = 9)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lrg;ZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILrg;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILea;ZZ)Lwn;", line = 84)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)Z", line = 142)
    public final boolean method1436(byte arg0) {
        field3004++;
        return arg0 == 69 ? class159.field2257.method1930((byte) -128, this.field3006) : true;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lrg;III)V", line = 159)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BLij;)I", line = 188)
