...
public class class215 extends class376 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZC)B", line = 77)
    ...
    @OriginalMember(owner = "client!hp", name = "e", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(I)J", line = 212)
    ...
    @OriginalMember(owner = "client!hp", name = "f", descriptor = "(B)V", line = 224)
    ...
    @OriginalMember(owner = "client!hp", name = "g", descriptor = "(B)I", line = 243)
    public final int method1470(byte arg0) {
        ++field3085;
        return arg0 != -10 ? -105 : (int) super.field3271;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IB)V", line = 254)
    ...
    @OriginalMember(owner = "client!hp", name = "e", descriptor = "(I)J", line = 302)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(II)V", line = 315)
    public class215(int arg0, int arg1) {
        super.field3271 = (long) arg0 << 32 | (long) arg1;
    }

    @OriginalMember(owner = "client!hp", name = "h", descriptor = "(B)V", line = 327)
