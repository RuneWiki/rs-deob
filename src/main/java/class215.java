...
public class class215 extends class333 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Log;Lgi;IIIIIIIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ZJ)V", line = 128)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)Leo;", line = 143)
