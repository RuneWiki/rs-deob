...
public abstract class class215 extends class419 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!vv", name = "f", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(IIIIZZ)V", line = 52)
