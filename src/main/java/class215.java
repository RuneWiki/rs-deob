...
public class class215 {
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)Ljo;")
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)Ljo;")
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(B)Ljo;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLjo;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(I)Ljo;")
