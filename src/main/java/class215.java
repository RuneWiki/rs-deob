...
public class class215 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(III)V", line = 72)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lc;III[Z)Z", line = 104)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIFIZIII)[[I", line = 141)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B)[[I", line = 172)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(III)V", line = 237)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)V", line = 210)
