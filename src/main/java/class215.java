...
public class class215 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(IB)I", line = 141)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Ljava/lang/String;BC)I", line = 155)
