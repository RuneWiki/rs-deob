...
public abstract class class215 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!qi", name = "stop", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!qi", name = "start", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!qi", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 55)
    public final void windowOpened(WindowEvent arg0) {
        field3051++;
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(III)I", line = 64)
    ...
    @OriginalMember(owner = "client!qi", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 80)
    public final void windowActivated(WindowEvent arg0) {
        field3063++;
    }

    @OriginalMember(owner = "client!qi", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 91)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!qi", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 139)
    public final void windowIconified(WindowEvent arg0) {
        field3065++;
    }

    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!qi", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 192)
    public final void windowClosing(WindowEvent arg0) {
        field3034++;
        this.destroy();
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BZ)V", line = 200)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(B)V", line = 284)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 316)
    ...
    @OriginalMember(owner = "client!qi", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 362)
    public final void windowDeiconified(WindowEvent arg0) {
        field3052++;
    }

    @OriginalMember(owner = "client!qi", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 372)
    ...
    @OriginalMember(owner = "client!qi", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 389)
    public final void windowClosed(WindowEvent arg0) {
        field3054++;
    }

    @OriginalMember(owner = "client!qi", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 397)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(I)Z", line = 418)
    ...
    @OriginalMember(owner = "client!qi", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 455)
    ...
    @OriginalMember(owner = "client!qi", name = "destroy", descriptor = "()V", line = 464)
    ...
    @OriginalMember(owner = "client!qi", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 481)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IBZLjava/lang/String;IIII)V", line = 495)
    ...
    @OriginalMember(owner = "client!qi", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 536)
    ...
    @OriginalMember(owner = "client!qi", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 550)
    public final void update(Graphics arg0) {
        field3045++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!qi", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 559)
    public final void windowDeactivated(WindowEvent arg0) {
        field3060++;
    }

    @OriginalMember(owner = "client!qi", name = "run", descriptor = "()V", line = 568)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIII)V", line = 687)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 735)
    ...
    @OriginalMember(owner = "client!qi", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 759)
    public final void focusLost(FocusEvent arg0) {
        class451.field6662 = false;
        field3040++;
    }

    @OriginalMember(owner = "client!qi", name = "providesignlink", descriptor = "(Lgt;)V", line = 770)
