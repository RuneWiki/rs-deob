...
public class class215 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IILlf;I)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IBLlf;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZILml;ILjava/awt/Component;)Lng;")
