...
public class class215 extends class429 {
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ZZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!lw", name = "d", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lmj;)V", line = 95)
    public class215(class114 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lw", name = "e", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Len;ZI)V", line = 141)
