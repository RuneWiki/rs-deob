...
public class class215 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IZ)Lii;")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lgi;FIFIFIFIFIB[B)V")
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Loq;ILbu;Lbu;)V")
