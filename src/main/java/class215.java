...
public class class215 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(II)Lpfa;", line = 18)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BILraa;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(II)V", line = 132)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 169)
