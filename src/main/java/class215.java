...
public class class215 extends class513 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)Leba;", line = 38)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(III)Z", line = 67)
    public static final boolean method1316(int arg0, int arg1, int arg2) {
        field2732++;
        return arg1 == 25782 ? (arg0 & 0x220) == 544 | (arg0 & 0x18) != 0 : true;
    }

    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "()V", line = 90)
    public class215() {
    }

    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 92)
