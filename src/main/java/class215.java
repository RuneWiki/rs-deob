...
public class class215 extends class121 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BIJLqa;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Z)V", line = 259)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lqa;JI)V", line = 290)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lqa;Lmm;Lqv;J)V", line = 341)
