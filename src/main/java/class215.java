...
public class class215 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IBI)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(JJ)J", line = 61)
    public static long method1368(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lag;)V", line = 197)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(IIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 184)
