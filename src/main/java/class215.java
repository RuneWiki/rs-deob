...
public class class215 implements class19 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lfg;ZJ[I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)[Lla;")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILwj;B)V")
