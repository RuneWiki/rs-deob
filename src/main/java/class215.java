...
public class class215 implements Runnable {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([BIII)I", line = 62)
    ...
    @OriginalMember(owner = "client!ec", name = "run", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 215)
