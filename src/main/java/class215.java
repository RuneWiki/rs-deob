...
public class class215 extends class467 implements class493 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILkha;)V", line = 14)
    public final void method340(int arg0, class584 arg1) {
        super.method340(arg0, arg1);
    }

    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 21)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lmh;IZ[[I)V", line = 32)
