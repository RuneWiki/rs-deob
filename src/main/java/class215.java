...
public class class215 extends class424 implements class89 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 38)
