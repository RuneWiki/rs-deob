...
public abstract class class215 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(CI)Z", line = 21)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIBIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IZ)V", line = 121)
