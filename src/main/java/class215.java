...
public class class215 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 32)
    public class215(Throwable arg0, String arg1) {
        this.field3037 = arg1;
        this.field3038 = arg0;
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Ljava/lang/Object;Lrd;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)V", line = 70)
