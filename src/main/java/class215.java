...
public class class215 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIIIII)Lrc;", line = 3)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLmr;)V", line = 103)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IB)Lok;", line = 146)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 188)
