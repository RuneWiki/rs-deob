...
public class class215 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BI)V", line = 106)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIB)V", line = 236)
