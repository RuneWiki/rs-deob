...
public class class215 extends class74 {
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "(Lha;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lha;II)Z", line = 36)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIZBII)V", line = 314)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(III)V", line = 397)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Z)I", line = 489)
    ...
    @OriginalMember(owner = "client!cea", name = "l", descriptor = "(I)Z", line = 511)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lgg;BZILha;II)V", line = 526)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILha;BI)Z", line = 537)
    ...
    @OriginalMember(owner = "client!cea", name = "j", descriptor = "(I)I", line = 595)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(BLha;)Loia;", line = 619)
    ...
    @OriginalMember(owner = "client!cea", name = "g", descriptor = "(B)Z", line = 638)
    ...
    @OriginalMember(owner = "client!cea", name = "e", descriptor = "(Z)V", line = 654)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljl;I)V", line = 666)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(B)I", line = 685)
    ...
    @OriginalMember(owner = "client!cea", name = "d", descriptor = "(B)Z", line = 705)
    ...
    @OriginalMember(owner = "client!cea", name = "f", descriptor = "(I)I", line = 719)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(Lha;I)Lbd;", line = 735)
    ...
    @OriginalMember(owner = "client!cea", name = "f", descriptor = "(B)V", line = 879)
