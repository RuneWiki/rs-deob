...
public class class215 extends class55 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lni;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BLpc;)V", line = 110)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lqa;Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IILqa;I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(ILqa;)Lfm;", line = 172)
