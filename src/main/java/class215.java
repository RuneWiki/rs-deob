...
public class class215 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/String;)I", line = 117)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "()I", line = 133)
    public final int method1382() {
        return this.field3042;
    }

    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V", line = 176)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "()V", line = 146)
    public static void method1383() {
        field3045 = null;
    }

    @OriginalMember(owner = "client!lf", name = "c", descriptor = "()I", line = 149)
    public final int method1384() {
        return this.field3040 - 1;
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V", line = 156)
