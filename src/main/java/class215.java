...
public class class215 implements Runnable {
    ...
    @OriginalMember(owner = "client!tg", name = "run", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IB)V", line = 96)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III[B)I", line = 112)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Z", line = 159)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 201)
