...
public class class215 extends class667 {
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "()V", line = 3)
    public class215() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(BI)[I", line = 7)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Lud;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!cha", name = "c", descriptor = "(B)Lvr;", line = 114)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ZI)[[I", line = 131)
