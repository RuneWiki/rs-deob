...
public class class215 extends class460 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILbt;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I[II[JI)V", line = 98)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Ljaa;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILtj;)V", line = 194)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)Z", line = 292)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZI)V", line = 303)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIB)V", line = 330)
