...
public class class215 extends class381 {
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(I[B)V", line = 51)
