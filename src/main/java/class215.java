...
public class class215 extends class42 implements class320 {
    ...
    @OriginalMember(owner = "client!cha", name = "b", descriptor = "(B)I")
    public final int method1316(byte arg0) {
        ++field2827;
        return arg0 >= -2 ? -23 : this.field2821;
    }

    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IZZ)V")
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "(Lfha;Lbda;II[FII)V")
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "(Lfha;Lbda;II[BII)V")
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "(Lfha;Lbda;Lwt;II)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ZF)F")
    ...
    @OriginalMember(owner = "client!cha", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(II[IIZIII)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(BF)F")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ILbda;III[BZII)V")
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "(Lfha;II[III)V")
