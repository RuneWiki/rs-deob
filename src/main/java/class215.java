...
public class class215 implements class351 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)Lgb;", line = 3)
    public final class228 method1499(int arg0) {
        field3191++;
        return arg0 == 27291 ? class228.field3320 : null;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lgj;)V", line = 57)
