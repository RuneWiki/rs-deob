...
public class class215 extends class210 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IILza;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)V", line = 416)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(I)V", line = 428)
