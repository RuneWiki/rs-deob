...
public class class215 implements Runnable {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBLls;)Lmd;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Laj;Z)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IZLls;)Lmd;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([BILls;I)Lmd;")
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(I)[Lig;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILmd;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Ltq;)V")
