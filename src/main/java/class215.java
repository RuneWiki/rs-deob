...
public class class215 extends class415 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I[Luaa;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 101)
    public static void method1420(byte arg0) {
        field2935 = null;
        int var1 = -29 % ((-arg0 - 48) / 43);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lha;I)V", line = 117)
