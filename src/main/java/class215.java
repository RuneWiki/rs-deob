...
public abstract class class215 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IBI)Z", line = 89)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)V", line = 110)
