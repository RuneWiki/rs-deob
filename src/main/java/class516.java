...
public class class516 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IB)Lau;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)Lbp;")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lau;I)V")
