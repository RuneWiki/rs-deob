...
public class class516 extends class251 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lra;IIIIIIIIIIIZZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Loa;J)V", line = 46)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lra;IIIIIIIIIIIZZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(JI)V", line = 262)
