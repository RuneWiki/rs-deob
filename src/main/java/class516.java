...
public class class516 extends class270 implements class323 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLrn;ZIILqa;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZILqa;)Z")
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(IIIIILnm;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLqa;)V")
