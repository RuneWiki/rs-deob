...
public class class516 extends class128 implements class332 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIII[B)V", line = 80)
    ...
    @OriginalMember(owner = "client!qs", name = "d", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(I)J", line = 138)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(JZIII)Ljava/lang/String;", line = 152)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)I", line = 239)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lmh;I[BIZ)V", line = 250)
    public class516(class537 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field7282 = arg1;
    }

    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)I", line = 258)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II[BI)V", line = 269)
