...
public class class516 extends class257 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILjava/lang/String;IIB)V", line = 17)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IB)I", line = 178)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(I)V", line = 189)
