...
public class class516 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/String;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I[BI[BII)I", line = 201)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([I[ILhw;I[I)V", line = 354)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "([B)V", line = 455)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I[BI[BIB)I", line = 577)
