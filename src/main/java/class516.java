...
public class class516 implements class283 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(B)Ltj;")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z[Lcb;Llm;)Ldl;")
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lpl;Ljava/lang/String;)V")
