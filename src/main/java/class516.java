...
public class class516 extends class314 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILi;)V", line = 3)
    public static final void method3123(int arg0, class37 arg1) {
        class587.field8346[arg0] = arg1;
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)[I", line = 26)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 51)
    public class516() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILjava/lang/String;)I", line = 55)
