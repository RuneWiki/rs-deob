...
public class class516 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lwc;I)V")
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "(I)Lwc;")
    ...
    @OriginalMember(owner = "client!vt", name = "d", descriptor = "(I)Lwc;")
    ...
    @OriginalMember(owner = "client!vt", name = "f", descriptor = "(I)Lwc;")
