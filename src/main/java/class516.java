...
public class class516 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IC)V", line = 32)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IB)V", line = 58)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lck;I)V", line = 69)
