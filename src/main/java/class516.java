...
public class class516 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)Loj;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BZI)Ldu;")
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lee;ILul;)V")
