...
public class class516 extends class749 implements class635 {
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Loea;I[BIZ)V", line = 4)
    public class516(class594 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7348 = arg1;
    }

    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Loea;ILjaclib/memory/Buffer;IZ)V", line = 12)
    public class516(class594 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7348 = arg1;
    }

    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(B)J", line = 20)
    ...
    @OriginalMember(owner = "client!hha", name = "e", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "([[BILwq;)V", line = 49)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Z)I", line = 86)
    public final int method2162(boolean arg0) {
        ++field7344;
        return !arg0 ? 12 : this.field7348;
    }

    @OriginalMember(owner = "client!hha", name = "d", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(B)I", line = 109)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IIB[B)V", line = 120)
