...
public class class516 implements Runnable {
    ...
    @OriginalMember(owner = "client!np", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILme;)V", line = 43)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZLjava/lang/String;)Lca;", line = 98)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "()V", line = 120)
    public class516() {
        try {
