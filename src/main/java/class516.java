...
public class class516 {
    ...
    @OriginalMember(owner = "client!kp", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BIIII)Z", line = 167)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BI)V", line = 255)
    ...
    @OriginalMember(owner = "client!kp", name = "e", descriptor = "(I)Z", line = 306)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lvaa;Z)V", line = 320)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lvf;)V", line = 565)
    ...
    @OriginalMember(owner = "client!kp", name = "f", descriptor = "(I)Z", line = 346)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lvaa;I)Z", line = 484)
