...
public class class516 extends class529 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IZI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!fb", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "()V", line = 52)
    public class516() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fb", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IB)[I", line = 66)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(II)[B", line = 116)
    ...
    @OriginalMember(owner = "client!fb", name = "e", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!fb", name = "f", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IBLtn;)V", line = 261)
    ...
    @OriginalMember(owner = "client!fb", name = "c", descriptor = "(III)Z", line = 344)
    ...
    @OriginalMember(owner = "client!fb", name = "g", descriptor = "(I)V", line = 362)
