...
public class class516 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLva;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(BI)Lvu;")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Ldd;ILpj;Lpj;)V")
