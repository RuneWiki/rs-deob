...
public class class516 extends class35 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lpu;Lon;)V", line = 40)
    public class516(class522 arg0, class304 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)I", line = 47)
