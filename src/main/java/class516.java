...
public class class516 extends class234 implements class489 {
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(Lus;Lpe;III[B)V")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lko;I)V")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
