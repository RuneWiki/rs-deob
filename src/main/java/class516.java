...
public class class516 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IZLba;II)Ldd;", line = 13)
    ...
    @OriginalMember(owner = "client!cba", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    public final String toString() {
        field6889++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(B)V", line = 38)
