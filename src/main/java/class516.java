...
public class class516 extends class107 implements class372 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!mw", name = "d", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lje;IIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!mw", name = "finalize", descriptor = "()V", line = 129)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIB)V", line = 139)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lqfa;III)V", line = 167)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lqfa;IIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!mw", name = "e", descriptor = "(I)V", line = 196)
