...
public class class516 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIZIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIIB)I", line = 23)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(III)Z", line = 40)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZLag;)V", line = 57)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!dn", name = "toString", descriptor = "()Ljava/lang/String;", line = 260)
