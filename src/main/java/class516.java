...
public abstract class class516 {
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(III)Z", line = 26)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lcb;)V", line = 63)
    public class516(class444 arg0) {
        this.field7353 = arg0;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(B)V", line = 99)
    public void method1200(byte arg0) {
        field7360++;
        int var2 = 26 / ((-arg0 - 31) / 61);
    }

    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 109)
