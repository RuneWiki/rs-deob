...
public class class516 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B[B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "([BI[B)V", line = 262)
