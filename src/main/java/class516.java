...
public class class516 extends class386 {
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!ql", name = "f", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IZ)I", line = 28)
    public static final int method3029(int arg0, boolean arg1) {
        field7573++;
        return arg1 ? arg0 & 0x7F : -30;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ljava/lang/String;Lht;IB)Llo;", line = 62)
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!ql", name = "e", descriptor = "(I)I", line = 126)
