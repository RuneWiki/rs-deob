...
public class class516 extends class535 {
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "()V", line = 150)
    public class516() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dr", name = "e", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILwn;I)V", line = 105)
