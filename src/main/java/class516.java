...
public class class516 implements class251 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 23)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lrd;Z)V", line = 146)
    public class516(class549 arg0, boolean arg1) {
        this.field7194 = arg1;
        this.field7199 = arg0;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(III)Z", line = 70)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)I", line = 107)
    public final int method3072(byte arg0) {
        return arg0 >= -44 ? -23 : this.field7197;
    }

    @OriginalMember(owner = "client!td", name = "c", descriptor = "(Z)I", line = 119)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 129)
