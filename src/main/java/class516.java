...
public class class516 extends class467 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I[IB)V", line = 43)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(II)V", line = 182)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IFIIB)V", line = 214)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Llh;IIIII)V", line = 332)
