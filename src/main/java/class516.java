...
public abstract class class516 extends class230 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Z[Lsca;)I")
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Loq;IZILha;II)V")
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Lha;B)Z")
