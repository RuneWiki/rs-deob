...
public class class516 extends class184 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BILfh;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lya;IIIILho;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILpc;Ljava/awt/Component;BI)Lvl;")
