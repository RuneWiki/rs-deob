...
public class class516 extends class376 {
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(II)Lho;", line = 3)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IZI)I", line = 18)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!au", name = "d", descriptor = "(I)Ljava/lang/String;", line = 72)
    ...
    @OriginalMember(owner = "client!au", name = "e", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B[ILiv;)V", line = 111)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Liv;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!au", name = "f", descriptor = "(I)I", line = 161)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(Liv;I)Ljava/lang/String;", line = 176)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Liv;IZ)V", line = 204)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(III)I", line = 283)
