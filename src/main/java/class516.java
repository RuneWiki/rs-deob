...
public class class516 extends class543 {
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lkw;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!eo", name = "F", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lat;[I)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lk;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!eo", name = "X", descriptor = "(IILk;)Lk;")
    ...
    @OriginalMember(owner = "client!eo", name = "ya", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIILvh;)V")
