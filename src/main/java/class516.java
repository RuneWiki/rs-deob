...
public class class516 extends class446 {
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lda;Lai;)V", line = 74)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(III)V", line = 93)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ZB)V", line = 123)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IILac;)V", line = 149)
