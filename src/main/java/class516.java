...
public class class516 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIIIII)Z", line = 105)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZZBIIIII)V", line = 483)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IZIIZBI)V", line = 535)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIZZII)V", line = 853)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(IIIIIIII)Z", line = 1164)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIIIIIBI)Z", line = 1354)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIBIIII)Z", line = 1456)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(III)V", line = 1505)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIZ)V", line = 1517)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIB)V", line = 1529)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZIIIIIZ)V", line = 1546)
