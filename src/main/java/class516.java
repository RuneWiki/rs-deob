...
public class class516 extends class596 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)Z", line = 41)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IB)Z", line = 56)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lag;II[B)V", line = 78)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lhe;ZI)V", line = 106)
