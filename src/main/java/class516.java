...
public class class516 extends class426 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIZ)Lmb;")
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(II)Luo;")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)Lkm;")
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(ILvc;Lvc;Lpq;Lqc;IIZ)V")
