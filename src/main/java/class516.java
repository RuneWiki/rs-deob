...
public class class516 extends class387 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BILiga;)V", line = 35)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lrda;)V", line = 110)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)V", line = 64)
    public final void method643(int arg0, int arg1, int arg2) {
        ++field6834;
        int var4 = 111 % ((arg2 - 74) / 36);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZB)V", line = 74)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 100)
