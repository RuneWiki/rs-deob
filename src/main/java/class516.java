...
public class class516 extends class354 {
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(ILwo;)V", line = 41)
    public class516(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ILs;)V", line = 80)
    public static final void method3002(int arg0, class282 arg1) {
        class195.field2669[arg0] = arg1;
    }

    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(B)I", line = 96)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(Lwo;)V", line = 111)
    public class516(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B)I", line = 114)
