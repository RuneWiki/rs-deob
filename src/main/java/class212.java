...
public class class212 extends class279 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(BZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lpj;)V", line = 29)
    public class212(class38 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Z)V", line = 55)
    public final void method442(boolean arg0) {
        super.field4267.method413(arg0, !arg0);
        ++field3518;
    }

    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)V", line = 63)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZLiu;)V", line = 74)
