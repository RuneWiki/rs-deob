...
public class class212 extends class337 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILuaa;IIILha;)V", line = 27)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lkj;)V", line = 130)
    public class212(class307 arg0) {
        this.field2909 = arg0;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I[BB)[B", line = 110)
