...
public class class212 extends class497 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILil;I)V")
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Ldia;)V")
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILdia;IIII)Lme;")
