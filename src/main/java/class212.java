...
public class class212 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IB)V", line = 59)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)Z", line = 98)
