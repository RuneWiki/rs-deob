...
public class class212 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IC)Z", line = 47)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(I[Loo;IIII)V", line = 226)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(ILqa;IIIIBIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(BLqa;I)Z", line = 147)
