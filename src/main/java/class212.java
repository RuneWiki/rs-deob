...
public class class212 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILmd;)V", line = 86)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lbg;I)Lb;", line = 129)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "()V", line = 330)
    private class212() {
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IB)Lkn;", line = 333)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "([I)V", line = 362)
