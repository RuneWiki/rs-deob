...
public class class212 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ln", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lhj;Lsg;III)V", line = 52)
