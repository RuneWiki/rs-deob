...
public class class212 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "()V", line = 51)
    private static final void method1290() {
        field2702 = 0;
    }

    @OriginalMember(owner = "client!vu", name = "b", descriptor = "()V", line = 54)
    public static void method1291() {
        field2706 = null;
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 61)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lha;[II[I[I)V", line = 97)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "([III)V", line = 149)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lha;[II)V", line = 202)
    public static final void method1296(class454 arg0, int[] arg1, int arg2) {
        method1292(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)Z", line = 207)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(II)V", line = 282)
