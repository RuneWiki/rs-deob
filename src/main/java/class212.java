...
public class class212 extends class379 {
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)I", line = 17)
    public final int method700(byte arg0) {
        int var2 = -21 / ((-arg0 - 63) / 59);
        return this.field2584;
    }

    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(I)I", line = 27)
    public final int method703(int arg0) {
        int var2 = 21 / ((arg0 - 61) / 47);
        return this.field2582;
    }

    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)J", line = 35)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)I", line = 46)
