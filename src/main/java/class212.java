...
public class class212 extends class264 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(ILmfa;)V", line = 14)
    public class212(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(BI)V", line = 28)
    ...
    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BI)I", line = 54)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(II)Lmha;", line = 70)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lmfa;)V", line = 102)
    public class212(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(I)Z", line = 111)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)V", line = 134)
