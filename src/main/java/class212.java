...
public class class212 extends class191 implements class149 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILe;IIZLhm;I)V")
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Le;Z)Lum;")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIILe;)Z")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Le;I)V")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Le;Lfa;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Le;IB)Lid;")
