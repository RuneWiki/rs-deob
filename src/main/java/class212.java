...
public class class212 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I[IILug;[II)Leo;", line = 11)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIILjava/lang/Class;)Lvn;", line = 60)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(BIIIII)V", line = 85)
