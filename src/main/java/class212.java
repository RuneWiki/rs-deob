...
public class class212 {
    ...
    @OriginalMember(owner = "client!rt", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field3043++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZIIZ)V", line = 37)
