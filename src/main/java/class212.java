...
public class class212 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZIILab;IIILhg;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IB[Ljava/lang/Object;I[I)V", line = 57)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ILvt;)V", line = 113)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IBLvt;)V", line = 136)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)Lkm;", line = 165)
