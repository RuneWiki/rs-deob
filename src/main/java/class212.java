...
public class class212 extends class48 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljca;Lep;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Leg;)V", line = 13)
    public final synchronized void method1341(class48 arg0) {
        this.field2811.method2501(10020, arg0);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lep;)V", line = 18)
    ...
    @OriginalMember(owner = "client!qg", name = "e", descriptor = "()I", line = 31)
    public final synchronized int method1343() {
        return this.field2811.method2503(-82);
    }

    @OriginalMember(owner = "client!qg", name = "c", descriptor = "([III)V", line = 36)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(Leg;)V", line = 45)
    public final synchronized void method1345(class48 arg0) {
        arg0.method242(true);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "()I", line = 100)
    public final int method252() {
        return 0;
    }

    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([III)V", line = 120)
    ...
    @OriginalMember(owner = "client!qg", name = "d", descriptor = "()Leg;", line = 170)
    public final class48 method257() {
        return (class48) this.field2811.method2506(68);
    }

    @OriginalMember(owner = "client!qg", name = "b", descriptor = "()Leg;", line = 174)
    public final class48 method254() {
        return (class48) this.field2811.method2505(-119);
    }

    @OriginalMember(owner = "client!qg", name = "f", descriptor = "()V", line = 177)
