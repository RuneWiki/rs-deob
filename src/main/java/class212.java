...
public class class212 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II)Lrg;", line = 110)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(III)V", line = 143)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lsn;ILci;Lci;)V", line = 165)
