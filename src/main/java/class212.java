...
public class class212 extends class465 implements class49 {
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!uea", name = "d", descriptor = "(Lr;I)Llf;", line = 31)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IIIILrb;Lr;Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Z)I", line = 53)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lr;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!uea", name = "h", descriptor = "(I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(BI)V", line = 87)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(I)I", line = 104)
    ...
    @OriginalMember(owner = "client!uea", name = "i", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!uea", name = "c", descriptor = "(Lr;I)Lwj;", line = 127)
    ...
    @OriginalMember(owner = "client!uea", name = "g", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lr;Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lr;III)Z", line = 220)
    ...
    @OriginalMember(owner = "client!uea", name = "f", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!uea", name = "c", descriptor = "(B)Z", line = 252)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(Lr;I)V", line = 262)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!uea", name = "j", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(B)I", line = 305)
    ...
    @OriginalMember(owner = "client!uea", name = "c", descriptor = "(Z)V", line = 323)
    ...
    @OriginalMember(owner = "client!uea", name = "e", descriptor = "(B)I", line = 335)
