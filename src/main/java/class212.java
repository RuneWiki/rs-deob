...
public class class212 extends class321 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IILgk;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IB)Lcq;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BLgk;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lgk;[IB)V")
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(BLgk;)V")
