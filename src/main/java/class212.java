...
public class class212 extends class751 {
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lgda;Leda;)V", line = 4)
    public class212(class58 arg0, class106 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ZZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIZII)V", line = 38)
