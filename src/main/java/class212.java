...
public class class212 {
    ...
    @OriginalMember(owner = "client!dd", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BI)Ldd;", line = 50)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(IILon;)V", line = 132)
