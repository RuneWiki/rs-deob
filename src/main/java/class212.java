...
public class class212 extends class48 implements class297 {
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Llaa;Lqda;Lns;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)I", line = 28)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIII[IIB)V", line = 41)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II[IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILqda;IBIIII[B)V", line = 88)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Llaa;Lqda;II[BII)V", line = 113)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IF)F", line = 128)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(B)Z", line = 139)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Llaa;Lqda;II[FII)V", line = 149)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)I", line = 166)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(FI)F", line = 176)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Llaa;II[III)V", line = 186)
