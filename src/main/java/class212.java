...
public class class212 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BLee;I)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lee;I)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZILha;Z)Loia;")
