...
public abstract class class212 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)[Lsk;", line = 3)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILin;ILin;)V", line = 15)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Ldh;)V", line = 69)
    public class212(class322 arg0) {
        this.field3004 = arg0;
        this.field3006 = this.method422(20014);
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(ILdh;)V", line = 89)
    public class212(int arg0, class322 arg1) {
        this.field3004 = arg1;
        this.field3006 = arg0;
    }

    @OriginalMember(owner = "client!su", name = "c", descriptor = "(II)V", line = 99)
