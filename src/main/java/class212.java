...
public class class212 extends class300 {
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lge;Lmk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lmo;)V", line = 10)
    public final void method9(class195 arg0) {
    }

    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(Z)V", line = 14)
    public final void method7(boolean arg0) {
        this.field4409.method870(260, 8448);
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "()Z", line = 20)
    public final boolean method4() {
        return true;
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "()V", line = 61)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "()V", line = 82)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)V", line = 119)
