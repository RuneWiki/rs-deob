...
public class class212 extends class479 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ag", name = "A", descriptor = "(I)V", line = 43)
    public static void method1499(int arg0) {
        field3174 = null;
        int var1 = -78 / ((38 - arg0) / 53);
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Laa;IIJLqk;IIBI)V", line = 52)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(I)V", line = 106)
    public class212(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(FB)V", line = 112)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(FB)V", line = 137)
