...
public class class212 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILik;)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([Lrba;II)V")
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)Lik;")
