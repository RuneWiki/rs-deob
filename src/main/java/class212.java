...
public class class212 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIII)Z", line = 272)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)Z", line = 334)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Z)V", line = 345)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZZ)Z", line = 406)
    public static boolean method1466(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLhp;)V", line = 415)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILhp;)Z", line = 429)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Llea;)V", line = 568)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lcea;I)[Lpda;", line = 478)
