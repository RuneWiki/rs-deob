...
public class class212 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(II)Lan;", line = 8)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 78)
