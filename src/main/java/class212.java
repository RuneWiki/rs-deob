...
public class class212 extends class512 {
    ...
    @OriginalMember(owner = "client!qt", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ZILia;)V", line = 26)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(II)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!qt", name = "f", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IB)[I", line = 169)
