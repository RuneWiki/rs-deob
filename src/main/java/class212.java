...
public class class212 extends class45 {
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IB)I", line = 27)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZLnj;)V", line = 41)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 107)
