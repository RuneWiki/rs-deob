...
public class class212 extends class13 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIB)B", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 22)
    public class212() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZI)[I", line = 26)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Luo;IILnj;BIII)Lsg;", line = 137)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 156)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lkh;BI)V", line = 191)
