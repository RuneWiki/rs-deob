...
public class class212 extends class577 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III[[ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(SI)V", line = 66)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BILaa;IIIILmea;Lha;)V", line = 89)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)Z", line = 276)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILmea;Lmea;)V", line = 461)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 484)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lqfa;Lre;Lqm;[I)V", line = 565)
