...
public class class212 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)[[I", line = 23)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(IB)[I", line = 67)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(III)V", line = 169)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(I)V", line = 150)
