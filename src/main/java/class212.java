...
public class class212 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIIZIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIIIIBIII)V", line = 37)
