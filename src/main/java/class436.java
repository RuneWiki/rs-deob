...
public class class436 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIIILjava/awt/Frame;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)[I", line = 37)
    ...
    @OriginalMember(owner = "client!lg", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 55)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "()V", line = 71)
    public class436() {
