...
public abstract class class436 extends class235 {
    ...
    @OriginalMember(owner = "client!km", name = "d", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!km", name = "f", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lbp;)V", line = 39)
    public class436(class46 arg0) {
        this.field6399 = arg0;
    }

    @OriginalMember(owner = "client!km", name = "b", descriptor = "(II)Lg;", line = 47)
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(II)I", line = 87)
