...
public class class436 extends class648 {
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lfi;Lvd;Lpba;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BII)V", line = 34)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZI)V", line = 94)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lbca;II)V", line = 101)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "(Z)V", line = 162)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(Z)V", line = 189)
