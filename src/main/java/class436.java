...
public abstract class class436 extends class543 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILha;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lg", name = "f", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(IIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "([Lbq;Z)I", line = 43)
    ...
    @OriginalMember(owner = "client!lg", name = "k", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIJ)Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!lg", name = "l", descriptor = "(I)V", line = 94)
