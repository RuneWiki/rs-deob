...
public class class436 extends class424 {
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(IB)[I", line = 7)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lrg;BI)V", line = 135)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IZ)[[I", line = 150)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "()V", line = 225)
    public class436() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(II)I", line = 228)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(IB)V", line = 253)
    ...
    @OriginalMember(owner = "client!ah", name = "g", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BI)V", line = 303)
