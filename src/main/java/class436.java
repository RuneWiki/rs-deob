...
public class class436 extends class422 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IZLta;FB)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lnt;B)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLnt;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lnt;I)V")
