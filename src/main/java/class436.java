...
public class class436 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BZIII)Llja;", line = 11)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(II)V", line = 128)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)Lln;", line = 152)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIIIII)I", line = 195)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 235)
