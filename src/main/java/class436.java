...
public class class436 extends class449 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILvc;I)Ln;", line = 17)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILgf;BI)V", line = 99)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILkk;)Lol;", line = 149)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lvc;)V", line = 188)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BI)V", line = 265)
    ...
    @OriginalMember(owner = "client!vd", name = "e", descriptor = "(I)V", line = 281)
