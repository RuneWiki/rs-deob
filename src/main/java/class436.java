...
public class class436 extends class30 {
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(ZI)V", line = 45)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(ZI)Lwca;", line = 65)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Luf;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(II)I", line = 161)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(BLdda;)V", line = 208)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(Z)V", line = 220)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)I", line = 256)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(I)V", line = 422)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(B)I", line = 453)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(Z)V", line = 516)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Luf;)V", line = 1487)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(III)I", line = 544)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(JIIIZBLjava/lang/String;ILjava/lang/String;IZ)V", line = 593)
    ...
    @OriginalMember(owner = "client!en", name = "d", descriptor = "(ZI)Z", line = 615)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IZ)Lwu;", line = 632)
    ...
    @OriginalMember(owner = "client!en", name = "g", descriptor = "(I)V", line = 658)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(B)I", line = 672)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(II)Z", line = 688)
    public final boolean method2675(int arg0, int arg1) {
        ++field6418;
        return arg0 == arg1 && !this.field6402 ? super.field279 : true;
    }

    @OriginalMember(owner = "client!en", name = "d", descriptor = "(II)I", line = 704)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lps;I)V", line = 722)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lcd;I)V", line = 1004)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 1431)
