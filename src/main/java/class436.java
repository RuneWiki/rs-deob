...
public class class436 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(II)Lij;", line = 4)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BI)I", line = 19)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Lij;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(B)I", line = 68)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lij;)V", line = 89)
    public class436(class615 arg0) {
        this.field6150 = 1;
        this.field6156 = arg0.field8660;
    }

    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "([Lij;)V", line = 97)
    public class436(class615[] arg0) {
