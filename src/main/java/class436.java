...
public class class436 {
    ...
    @OriginalMember(owner = "client!pd", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field6514++;
        return "Cache:" + this.field6516;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II)[B", line = 11)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I[[[BIBII)V", line = 100)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III[B)Z", line = 238)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z[BZII)Z", line = 266)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(ILok;Lok;I)V", line = 420)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 406)
