...
public class class436 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZIII)Ltba;")
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IIIZB)Lnf;")
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IZLrfa;)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZLefa;)V")
