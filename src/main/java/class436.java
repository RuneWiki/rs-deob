...
public abstract class class436 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(CI)C", line = 37)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)V", line = 432)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)Z", line = 447)
