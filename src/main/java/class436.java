...
public class class436 extends class115 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BII)Lqc;", line = 6)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(II)V", line = 216)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(I)I", line = 252)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)I", line = 264)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)I", line = 281)
    ...
    @OriginalMember(owner = "client!kc", name = "e", descriptor = "(I)I", line = 310)
    ...
    @OriginalMember(owner = "client!kc", name = "f", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!kc", name = "g", descriptor = "(I)V", line = 380)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IZ)[B", line = 563)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILbi;)I", line = 595)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)Llr;", line = 805)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(ILan;Lan;Lp;Lps;IIZ)V", line = 976)
    ...
    @OriginalMember(owner = "client!kc", name = "h", descriptor = "(I)I", line = 910)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IB)V", line = 925)
