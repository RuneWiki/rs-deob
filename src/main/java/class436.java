...
public abstract class class436 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)V", line = 5)
    public final void method2659(int arg0, int arg1) {
        this.method167(arg0, arg1, 0, 0, 1);
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(FFIILem;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(FFII)V", line = 13)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(FFFFIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(FFFFIILem;II)V", line = 46)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIII)V", line = 71)
    public final void method2664(int arg0, int arg1, int arg2, int arg3) {
        this.method163(arg0, arg1, arg2, arg3, 0, 0, 1);
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(FFIIIII)V", line = 81)
