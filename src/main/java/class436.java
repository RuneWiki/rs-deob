...
public class class436 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BI)I", line = 32)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)Llk;", line = 84)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)Z", line = 155)
