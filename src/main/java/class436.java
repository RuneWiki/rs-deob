...
public class class436 extends class338 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IC)Z", line = 262)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 327)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(Z)V", line = 341)
