...
public class class436 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)Lsf;", line = 5)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I[Lsf;)I", line = 19)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjava/lang/String;Lpea;Z)Lvl;", line = 51)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IZIILuca;)V", line = 80)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)Lsf;", line = 119)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(JILsf;)V", line = 149)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)I", line = 168)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IJ)Lsf;", line = 205)
    ...
    @OriginalMember(owner = "client!nj", name = "d", descriptor = "(I)Lsf;", line = 238)
    ...
    @OriginalMember(owner = "client!nj", name = "e", descriptor = "(I)I", line = 266)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 278)
    ...
    @OriginalMember(owner = "client!nj", name = "f", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 328)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(JIIIZ)Ljava/lang/String;", line = 409)
