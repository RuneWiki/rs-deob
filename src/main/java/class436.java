...
public class class436 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIIIII)V", line = 69)
