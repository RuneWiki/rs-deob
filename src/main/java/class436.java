...
public class class436 implements Runnable {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!st", name = "run", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IBILem;)V", line = 82)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II[BI)V", line = 892)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 935)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILjava/lang/String;)I", line = 956)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 975)
