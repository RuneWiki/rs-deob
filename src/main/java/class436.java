...
public class class436 extends class27 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILvf;)V", line = 40)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZI)V", line = 52)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Llj;)V", line = 107)
    public class436(class565 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(II)I", line = 148)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Z)Z", line = 163)
