...
public class class436 {
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 33)
    public class436(class326 arg0, int arg1, class323 arg2) {
        this.field6186 = arg2;
        this.field6188 = this.field6186.method2084(19, 0);
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IZ)Lgt;", line = 48)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZIZ)V", line = 125)
