...
public class class436 extends class85 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILgk;I[IB[I)Lio;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BI)Lsu;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lqa;IILia;III[[[B[I[I[I[I[IIBIIZ)V")
