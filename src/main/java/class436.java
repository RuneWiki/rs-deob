...
public class class436 extends class634 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILig;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BI)[[I", line = 47)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(BI)[I", line = 124)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "()V", line = 211)
    public class436() {
        super(1, false);
    }

    @OriginalMember(owner = "client!io", name = "f", descriptor = "(I)Lfea;", line = 171)
    ...
    @OriginalMember(owner = "client!io", name = "d", descriptor = "(B)V", line = 190)
