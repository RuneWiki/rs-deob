...
public class class436 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)Lnn;", line = 6)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)C", line = 76)
