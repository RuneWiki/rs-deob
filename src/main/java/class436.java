...
public class class436 extends class563 implements class302 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ZILr;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(ILr;)Lod;", line = 20)
    ...
    @OriginalMember(owner = "client!maa", name = "j", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lmg;I)I", line = 86)
    ...
    @OriginalMember(owner = "client!maa", name = "h", descriptor = "(I)Z", line = 132)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!maa", name = "e", descriptor = "(B)Z", line = 156)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!maa", name = "i", descriptor = "(I)Z", line = 177)
    public final boolean method402(int arg0) {
        ++field6645;
        return arg0 != 623404585 ? false : this.field6639;
    }

    @OriginalMember(owner = "client!maa", name = "f", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!maa", name = "g", descriptor = "(B)I", line = 200)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lr;Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(B)I", line = 235)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IIILr;ZILpn;)V", line = 250)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIII)V", line = 732)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IILr;)Z", line = 264)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(B)I", line = 710)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ILr;)V", line = 721)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLr;)Lll;", line = 748)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)Z", line = 760)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lr;I)V", line = 771)
    ...
    @OriginalMember(owner = "client!maa", name = "g", descriptor = "(I)I", line = 790)
