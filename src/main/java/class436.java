...
public class class436 extends class106 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLbu;II)Leu;", line = 3)
    ...
    @OriginalMember(owner = "client!tl", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILih;)V", line = 47)
    ...
    @OriginalMember(owner = "client!tl", name = "g", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!tl", name = "h", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(II)I", line = 100)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZB)V", line = 112)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Lvj;)V", line = 149)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IBI)V", line = 170)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZI)V", line = 183)
