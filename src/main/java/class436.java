...
public class class436 extends class739 {
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(II)Lwaa;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lkm;IIBII)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IILha;Lcu;)V")
