...
public class class436 extends class378 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lj;)Ljk;", line = 9)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
