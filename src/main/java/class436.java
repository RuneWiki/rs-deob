...
public class class436 extends class224 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(III)B", line = 21)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)Laga;", line = 42)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lrca;B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ks", name = "h", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Luga;Lf;)V", line = 154)
