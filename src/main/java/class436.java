...
public class class436 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IIBIIIIILoa;)V", line = 148)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(JJ)J", line = 292)
    public static long method2409(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Z)V", line = 300)
