...
public class class436 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)V", line = 186)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(II)Lus;", line = 226)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIII)I", line = 258)
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(IIII)I", line = 286)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Ljk;ILae;Lae;)V", line = 308)
