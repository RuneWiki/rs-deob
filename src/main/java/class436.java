...
public class class436 extends class682 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(ILuu;IB)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "v", descriptor = "(IILha;)Lha;")
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Ltg;[I)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lps;IBI)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Luca;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
