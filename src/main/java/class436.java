...
public class class436 extends class233 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ji", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ji", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 56)
    public final synchronized void focusLost(FocusEvent arg0) {
        field6374++;
        this.method2682(-1, 0, '\u0000', (byte) 39);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IBI)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BCLjava/lang/String;)[Ljava/lang/String;", line = 76)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!ji", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 127)
    public final void focusGained(FocusEvent arg0) {
        field6369++;
    }

    @OriginalMember(owner = "client!ji", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 136)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field6372++;
        this.method2680(-23339, arg0, 1);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)Z", line = 144)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILjava/awt/event/KeyEvent;I)V", line = 159)
    ...
    @OriginalMember(owner = "client!ji", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 196)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field6357++;
        this.method2680(-23339, arg0, 0);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)Ljv;", line = 208)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IICB)V", line = 260)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 348)
