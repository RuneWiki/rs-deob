...
public class class436 extends class256 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIBII)V", line = 23)
    ...
    @OriginalMember(owner = "client!hm", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 41)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field5721;
        return this.field5729 == arg0;
    }

    @OriginalMember(owner = "client!hm", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 51)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIILjava/awt/Canvas;)V", line = 63)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IILjava/awt/Graphics;IIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!hm", name = "e", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!hm", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 123)
    ...
    @OriginalMember(owner = "client!hm", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 135)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field5735;
    }

    @OriginalMember(owner = "client!hm", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 143)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field5723;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IBI[FIII)V", line = 156)
