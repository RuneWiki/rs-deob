...
public abstract class class436 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IZI)Z", line = 12)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(IIIII)V", line = 217)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IF)F", line = 118)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIIIIIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIII)V", line = 231)
