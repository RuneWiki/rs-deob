...
public abstract class class436 extends class264 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIIZLct;B)V", line = 38)
    ...
    @OriginalMember(owner = "client!rb", name = "f", descriptor = "(I)V", line = 68)
