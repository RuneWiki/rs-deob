...
public class class436 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)Z", line = 16)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(III)Z", line = 31)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(I)V", line = 50)
