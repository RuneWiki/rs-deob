...
public abstract class class436 extends class376 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILeb;)V", line = 9)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(III)[I", line = 216)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBI)V", line = 275)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(B)I", line = 299)
    public int method2682(byte arg0) {
        field6268++;
        return arg0 == 98 ? -1 : 75;
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIBII)V", line = 313)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IZI)[[I", line = 327)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IILeb;)V", line = 366)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)[I", line = 396)
    ...
    @OriginalMember(owner = "client!fm", name = "e", descriptor = "(I)I", line = 407)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(IZ)V", line = 422)
    public class436(int arg0, boolean arg1) {
        this.field6270 = new class436[arg0];
        this.field6256 = arg1;
    }

    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(II)[[I", line = 434)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(B)V", line = 456)
