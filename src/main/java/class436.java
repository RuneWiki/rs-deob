...
public class class436 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ZB)I", line = 6)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IIIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ILjava/lang/String;ZLjava/lang/String;I)V", line = 73)
