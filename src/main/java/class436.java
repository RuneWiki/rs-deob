...
public class class436 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILwe;Lwe;B)Lhs;")
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Las;Lef;)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lwe;IIZLwe;)Lhs;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIBLbr;)V")
