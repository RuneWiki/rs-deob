...
public class class436 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILcfa;FLcfa;)Z")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILus;ZI)V")
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Llea;)V")
