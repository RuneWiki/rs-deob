...
public class class436 extends class665 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IZ)Lsn;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILmo;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lvfa;IIIII)V")
