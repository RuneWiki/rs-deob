...
public abstract class class436 extends class330 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!fm", name = "g", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IB)Z", line = 40)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILra;II)Lgg;", line = 51)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(IIII)V", line = 103)
