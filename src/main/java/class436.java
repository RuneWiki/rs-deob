...
public class class436 extends class5 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZLjava/awt/Component;Z)Leb;", line = 5)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIIIIIB)V", line = 30)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 202)
