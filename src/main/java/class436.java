...
public class class436 extends class435 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(III)Z", line = 11)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lfu;)V", line = 81)
    public class436(class66 arg0) {
        this.field6280 = arg0;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 35)
