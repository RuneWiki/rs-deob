...
public class class436 extends InputStream {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)[Ldh;", line = 3)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(III)I", line = 19)
    ...
    @OriginalMember(owner = "client!qs", name = "read", descriptor = "()I", line = 43)
