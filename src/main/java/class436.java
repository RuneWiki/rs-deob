...
public class class436 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lom;IIIBI)Lwl;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(II)Lmp;")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Ldk;ILfc;)V")
