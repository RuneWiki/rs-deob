...
public class class436 extends class324 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lts;B[B[I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "()V", line = 130)
    public class436() {
    }

    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "([B)V", line = 132)
