...
public class class436 extends class293 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)Lefa;", line = 22)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZB)V", line = 82)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Ldia;IIIIII)V", line = 135)
