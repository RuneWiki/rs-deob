...
public class class524 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)I", line = 226)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)V", line = 272)
