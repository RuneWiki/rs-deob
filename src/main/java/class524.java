...
public class class524 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 40)
