...
public class class524 extends class715 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)J", line = 39)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(IJ)I", line = 74)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(B)J", line = 114)
