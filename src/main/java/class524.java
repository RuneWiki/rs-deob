...
public class class524 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IILd;ILjava/awt/Canvas;Lwu;)Lha;", line = 19)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(II)[[[B", line = 50)
