...
public class class524 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lha;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)V", line = 54)
