...
public class class524 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)V", line = 15)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IB)Lhc;", line = 28)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lqw;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 769)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(BI)V", line = 784)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 801)
