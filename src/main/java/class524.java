...
public class class524 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)Lofa;", line = 5)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(II)Lhq;", line = 79)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lsea;ILmv;Lmv;Lmv;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 134)
