...
public class class524 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lwb;ILtf;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)Lwb;")
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)Lwb;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILtf;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)Lwb;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILwb;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lwb;I)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lft;IILjava/lang/String;)Lvn;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z)Lwb;")
    ...
    @OriginalMember(owner = "client!tf", name = "f", descriptor = "(I)Lwb;")
