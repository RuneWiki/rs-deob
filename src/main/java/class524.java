...
public abstract class class524 extends class105 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIIBI)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "([Lwi;I)I")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Z")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIIIB)V")
    ...
    @OriginalMember(owner = "client!um", name = "j", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(IIIIIIIIIZB)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
