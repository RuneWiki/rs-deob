...
public class class524 extends class391 {
    ...
    @OriginalMember(owner = "client!im", name = "pa", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!im", name = "S", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIZIIIIII)Z", line = 82)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(FIIIFFI)V", line = 112)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!im", name = "la", descriptor = "(Lq;)V", line = 170)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIB)V", line = 192)
    ...
    @OriginalMember(owner = "client!im", name = "GA", descriptor = "(III)V", line = 207)
    ...
    @OriginalMember(owner = "client!im", name = "ra", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(III[I)V", line = 240)
    ...
    @OriginalMember(owner = "client!im", name = "O", descriptor = "([I)V", line = 250)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BLq;)V", line = 269)
    ...
    @OriginalMember(owner = "client!im", name = "P", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!im", name = "XA", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!im", name = "d", descriptor = "(I)[F", line = 337)
    ...
    @OriginalMember(owner = "client!im", name = "G", descriptor = "(III)V", line = 357)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)[F", line = 367)
    ...
    @OriginalMember(owner = "client!im", name = "R", descriptor = "(III[I)V", line = 390)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "()Lq;", line = 403)
    ...
    @OriginalMember(owner = "client!im", name = "Y", descriptor = "()V", line = 426)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "()V", line = 465)
    public class524() {
        this.method1296();
    }
}
