...
public class class524 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 89)
