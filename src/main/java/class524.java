...
public class class524 extends class17 {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)Lfp;", line = 4)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "()V", line = 32)
    public class524() {
        this(0);
    }

    @OriginalMember(owner = "client!pg", name = "h", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(I)V", line = 49)
    private class524(int arg0) {
        super(0, false);
        this.method3095((byte) -121, arg0);
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BI)V", line = 60)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)Lrv;", line = 139)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IB)[[I", line = 165)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lwm;II)V", line = 203)
