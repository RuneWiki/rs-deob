...
public abstract class class524 extends class543 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "([Lbq;Z)I")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lha;Lcn;IIBZI)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIILtc;Ltc;)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILha;)Z")
