...
public class class524 extends class148 {
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([Lba;Ltg;Lq;[Lmr;I)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/Runnable;)Luea;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Laca;IIII)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([Lba;Lq;[Lmr;I)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II[[I[[IIII)Ld;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lqda;IIII)Lba;")
