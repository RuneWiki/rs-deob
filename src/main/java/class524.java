...
public class class524 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "([BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BJ)V", line = 29)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Z)J", line = 46)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(III)V", line = 59)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lqq;II)V", line = 668)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ZII[B)V", line = 91)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)Ljava/io/File;", line = 213)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLol;)V", line = 235)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(B)V", line = 364)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BII[B)V", line = 441)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(B)V", line = 626)
