...
public class class524 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Lel;[[BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ria", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(B)V", line = 75)
