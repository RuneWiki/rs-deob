...
public class class524 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lur;II)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Leu;Lur;I)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILur;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([Ljava/lang/Object;[IB)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BLur;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lur;I)V")
