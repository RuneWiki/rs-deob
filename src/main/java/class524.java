...
public class class524 extends class540 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IBIIF)V", line = 4)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IB[I)V", line = 130)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BILsf;Lco;)V", line = 289)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)V", line = 359)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(II)V", line = 374)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IZII)V", line = 383)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Ljava/lang/String;ZIII)V", line = 395)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Z)V", line = 444)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IZ)V", line = 457)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lmg;IIIII)V", line = 474)
