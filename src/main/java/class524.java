...
public class class524 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILos;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(II)Z", line = 32)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILos;)V", line = 54)
