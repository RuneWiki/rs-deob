...
public class class524 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Ljava/lang/String;II)I", line = 10)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lie;BJ)V", line = 26)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(B)V", line = 69)
    public static void method3115(byte arg0) {
        field7755 = null;
        int var1 = -22 / ((18 - arg0) / 36);
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(JI)Lie;", line = 118)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(I)V", line = 158)
