...
public class class524 extends class265 {
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)Lim;", line = 49)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lfd;IIIIII)V", line = 130)
