...
public class class524 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILqc;)Z")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lfh;B)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lkv;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II[Lhd;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lfh;)V")
