...
public class class524 extends class486 {
    ...
    @OriginalMember(owner = "client!nja", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 5)
    public class524(Object arg0, int arg1) {
        super(arg1);
        this.field7332 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 14)
    public final Object method2642(byte arg0) {
        return arg0 < 86 ? (Object) null : this.field7332.get();
    }

    @OriginalMember(owner = "client!nja", name = "h", descriptor = "(I)Z", line = 25)
