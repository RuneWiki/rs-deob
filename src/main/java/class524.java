...
public class class524 extends class28 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IZII)V", line = 14)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIB)Z", line = 43)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)I", line = 73)
