...
public class class524 extends class19 {
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "()Lnr;")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lnr;)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "()Lnr;")
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(Lnr;)V")
    public final synchronized void method3092(class19 arg0) {
        arg0.method2549((byte) 36);
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ltv;Lih;)V")
