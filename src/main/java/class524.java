...
public abstract class class524 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(B)Z", line = 52)
