...
public class class524 extends class140 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)Lad;", line = 4)
    public class426 method119(byte arg0) {
        field7257++;
        return arg0 <= 116 ? null : class681.field9229;
    }

    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lsd;Lec;IIIIIIIIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)V", line = 48)
