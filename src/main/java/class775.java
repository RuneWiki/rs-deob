...
public abstract class class775 extends class101 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lsja;)V", line = 53)
