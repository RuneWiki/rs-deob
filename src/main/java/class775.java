...
public class class775 extends class673 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IBB)V", line = 16)
    ...
    @OriginalMember(owner = "client!qda", name = "e", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIIB)[B", line = 79)
