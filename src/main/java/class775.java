...
public class class775 extends class206 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZS)V", line = 5)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III[[ZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lffa;Laq;Luf;[I)V", line = 271)
