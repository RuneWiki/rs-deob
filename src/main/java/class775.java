...
public class class775 extends class330 {
    ...
    @OriginalMember(owner = "client!qda", name = "e", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "()V", line = 620)
    public class775() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lgga;IB)V", line = 63)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IZ)[I", line = 165)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I[[IIIBLjava/util/Random;I)V", line = 413)
    ...
    @OriginalMember(owner = "client!qda", name = "d", descriptor = "(B)V", line = 610)
    public final void method653(byte arg0) {
        ++field10671;
        int var2 = 38 / ((arg0 - 50) / 41);
    }

    @OriginalMember(owner = "client!qda", name = "f", descriptor = "(B)V", line = 652)
