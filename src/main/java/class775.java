...
public class class775 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)Lsu;", line = 6)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)Lsu;", line = 29)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 65)
    public class775() {
    }

    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lhf;)V", line = 67)
