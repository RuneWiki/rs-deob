...
public class class775 implements Runnable {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIIII)Ltba;", line = 25)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/Class;ILjava/lang/String;)Ltba;", line = 36)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/String;B)Lvm;", line = 46)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/String;ZI)Ltba;", line = 64)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/io/File;[B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)Ltba;", line = 101)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 113)
    public final void method4237(byte arg0) {
        field10573 = class502.method2786(-7114) + 5000L;
        int var2 = 20 % ((-arg0 - 48) / 41);
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLjava/awt/Component;[IIILjava/awt/Point;)Ltba;", line = 123)
    ...
    @OriginalMember(owner = "client!oq", name = "run", descriptor = "()V", line = 138)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZIILjava/lang/String;)Ltba;", line = 441)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Lvm;", line = 456)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 703)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/awt/Frame;)Ltba;", line = 498)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/net/URL;)Ltba;", line = 508)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 521)
    public final Object method4243(boolean arg0) {
        return arg0 ? this.field10584 : null;
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Ltba;", line = 537)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/String;I)Ltba;", line = 552)
    public final class339 method4245(String arg0, int arg1) {
        return arg1 == 65535 ? this.method4249(0, arg0, 16, 0, (byte) -101) : null;
    }

    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)Ltba;", line = 563)
    public final class339 method4246(int arg0) {
        return arg0 == 5 ? this.method4249(0, null, 5, 0, (byte) -101) : null;
    }

    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(B)V", line = 573)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/Runnable;II)Ltba;", line = 639)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/lang/Object;IIB)Ltba;", line = 653)
