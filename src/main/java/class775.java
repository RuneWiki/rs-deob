...
public class class775 implements Runnable {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Ljava/net/Socket;Llc;I)V", line = 297)
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!wo", name = "finalize", descriptor = "()V", line = 132)
    protected final void finalize() {
        field10708++;
        this.method4304(false);
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "([BIBI)V", line = 141)
    ...
    @OriginalMember(owner = "client!wo", name = "run", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIZ[B)V", line = 270)
