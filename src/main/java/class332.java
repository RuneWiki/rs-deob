...
public class class332 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "()[F", line = 161)
    public final float[] method2203() {
        return this.field5197[this.method2200()];
    }

    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "()V", line = 165)
    public class332() {
