...
public class class332 extends class357 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([B[IIIIIIIIIIILep;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(CIIIZLep;II)V", line = 104)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(CIIIZ)V", line = 166)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([B[IIIIIIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lma;Lk;[Llg;[I[I)V", line = 256)
