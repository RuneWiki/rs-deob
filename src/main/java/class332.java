...
public abstract class class332 extends class538 {
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!po", name = "i", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I[Ltg;)I", line = 41)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(IIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(Z)Z", line = 141)
