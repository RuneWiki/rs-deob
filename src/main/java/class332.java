...
public class class332 extends class669 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IILnq;)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lee;B)Z")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Ldc;Lbi;)V")
