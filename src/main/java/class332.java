...
public class class332 implements Runnable {
    ...
    @OriginalMember(owner = "client!ul", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lza;IIIIII)Le;", line = 41)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLjg;)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)I", line = 113)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(CI)C", line = 139)
