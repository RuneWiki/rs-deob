...
public class class332 implements class549 {
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(ILps;Lft;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Llf;", line = 39)
