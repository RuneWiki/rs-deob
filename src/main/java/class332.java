...
public abstract class class332 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILri;)I", line = 144)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Z)I", line = 183)
