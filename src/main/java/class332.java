...
public class class332 extends class54 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!rr", name = "g", descriptor = "(I)V", line = 484)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 499)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZIIII)V", line = 528)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lifa;II)V", line = 550)
