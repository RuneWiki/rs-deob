...
public abstract class class332 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(B)Z", line = 51)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)Z", line = 66)
