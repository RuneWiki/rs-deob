...
public class class332 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BILwn;)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lqa;IILn;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILka;III)Lem;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIILsg;IILku;Lki;)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lth;[[BI)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lwn;I)V")
