...
public class class332 extends class112 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lcb;JIZIIII)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IILha;ILwq;)V")
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lwk;IIZ)V")
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lwk;II[III)V")
