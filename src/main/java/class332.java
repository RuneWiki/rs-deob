...
public class class332 extends class236 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Leq;[Lin;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Leq;J[Lin;[Lgq;Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "()V", line = 99)
    public final void method2004() {
        this.field4833 = true;
    }

    @OriginalMember(owner = "client!ko", name = "c", descriptor = "()Lbv;", line = 102)
    public final class191 method2005() {
        return this.field4831;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(J)V", line = 107)
    public final void method2006(long arg0) {
        this.field4819 = arg0;
    }

    @OriginalMember(owner = "client!ko", name = "d", descriptor = "()V", line = 110)
    public final void method2007() {
        this.field4821 = true;
    }

    @OriginalMember(owner = "client!ko", name = "e", descriptor = "()V", line = 114)
    public static void method2008() {
        field4825 = null;
        field4823 = null;
    }

    @OriginalMember(owner = "client!ko", name = "f", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "()V", line = 160)
    private final void method2011() {
        this.field4821 = false;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([Lgq;Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Leq;J)Z", line = 259)
