...
public class class332 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IBILpi;I)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)Lbda;")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Ljda;ILjo;)V")
