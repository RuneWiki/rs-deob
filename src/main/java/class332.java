...
public class class332 extends class306 implements class143 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILlf;)Lva;", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILvq;)V", line = 30)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IILvq;)Lni;", line = 59)
    ...
    @OriginalMember(owner = "client!fi", name = "e", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lvq;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)I", line = 111)
    public static int method2176(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lvq;IIB)Z", line = 133)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lvq;IB)Lni;", line = 155)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 182)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IILvq;Z)Lsl;", line = 210)
    ...
    @OriginalMember(owner = "client!fi", name = "f", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lvq;Lbi;IIIIIZIIIIIIZ)V", line = 253)
    ...
    @OriginalMember(owner = "client!fi", name = "g", descriptor = "(I)I", line = 288)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLvq;)Lbf;", line = 315)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)Z", line = 340)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)Z", line = 351)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)I", line = 376)
    ...
    @OriginalMember(owner = "client!fi", name = "e", descriptor = "(I)I", line = 392)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lvq;B)V", line = 404)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 415)
