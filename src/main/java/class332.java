...
public class class332 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIILma;Lma;)V", line = 23)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZILha;)Lci;", line = 90)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/lang/String;ZII)Z", line = 163)
