...
public class class332 implements Runnable {
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lwe;Lid;ILvc;)V", line = 38)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(I)I", line = 186)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Z)I", line = 206)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I[BBI)V", line = 221)
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIB)Ljava/lang/String;", line = 290)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)I", line = 331)
    ...
    @OriginalMember(owner = "client!tc", name = "finalize", descriptor = "()V", line = 467)
    protected final void finalize() {
        this.method2095(false);
        field4609++;
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(III[B)V", line = 476)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Ljava/net/Socket;Lis;)V", line = 629)
    ...
    @OriginalMember(owner = "client!tc", name = "run", descriptor = "()V", line = 504)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(Z)V", line = 592)
