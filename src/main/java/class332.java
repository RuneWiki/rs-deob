...
public class class332 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(F)F", line = 4)
    private static final float method2062(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIF)F", line = 11)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IF)I", line = 28)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Leb;Lgh;)V", line = 89)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "()V", line = 160)
    public static void method2066() {
        field4495 = null;
        field4498 = null;
    }

    @OriginalMember(owner = "client!si", name = "b", descriptor = "(IIF)F", line = 179)
