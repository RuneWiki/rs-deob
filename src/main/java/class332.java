...
public class class332 extends class451 implements class381 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lwm;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lwm;B)V", line = 49)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BLwm;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lml;ILjava/lang/String;I)Lcc;", line = 114)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lwm;II)Lgn;", line = 219)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIBLwm;)Z", line = 239)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IBZLwm;)Lij;", line = 260)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILwm;I)Lgn;", line = 293)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(Lwm;B)Lnf;", line = 305)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lwm;Lct;IIIIZIIIII)V", line = 346)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 370)
