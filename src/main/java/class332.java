...
public class class332 extends class144 implements class394 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(BLr;I)Lda;", line = 5)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lr;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(Z)Z", line = 60)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(B)I", line = 74)
    ...
    @OriginalMember(owner = "client!kh", name = "l", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZIBLr;)Lfj;", line = 98)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(Z)Z", line = 128)
    public final boolean method633(boolean arg0) {
        ++field4605;
        return !arg0 ? true : true;
    }

    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lr;Lnf;IIIIIZIIIIIIZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIIII[BZ)V", line = 173)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(ILr;)V", line = 270)
    ...
    @OriginalMember(owner = "client!kh", name = "h", descriptor = "(I)Z", line = 280)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILr;)V", line = 294)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)I", line = 323)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(I)I", line = 334)
    public final int method904(int arg0) {
        ++field4623;
        return arg0 != -15140 ? 49 : this.field4592;
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)I", line = 346)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lvj;IZLr;IIB)V", line = 361)
    ...
    @OriginalMember(owner = "client!kh", name = "i", descriptor = "(I)I", line = 394)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lr;I)Lej;", line = 405)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIZJI)Ljava/lang/String;", line = 436)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(I)V", line = 522)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(Z)V", line = 545)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZIIZ)V", line = 557)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IILr;B)Z", line = 574)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(ILr;)Leh;", line = 596)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)I", line = 611)
    ...
    @OriginalMember(owner = "client!kh", name = "g", descriptor = "(I)Z", line = 622)
    ...
    @OriginalMember(owner = "client!kh", name = "j", descriptor = "(I)V", line = 633)
