...
public class class332 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)Lfk;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIILd;Ljava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lfk;B)V")
