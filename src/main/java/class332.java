...
public class class332 extends class30 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BILac;)V", line = 5)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "()V", line = 71)
    public class332() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lls;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)[[I", line = 206)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IILjs;II)V", line = 309)
