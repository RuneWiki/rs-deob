...
public abstract class class332 extends class329 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I[BII[BIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)I", line = 52)
    public final int method1881(int arg0) {
        field4243++;
        return arg0 <= 30 ? 44 : this.field4245;
    }

    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(I)F", line = 69)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)I", line = 85)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(B)I", line = 116)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Z)I", line = 129)
    ...
    @OriginalMember(owner = "client!gga", name = "c", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!gga", name = "i", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(IIIIIF)V", line = 166)
