...
public class class332 extends class514 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lft;)V", line = 5)
    public final synchronized void method2083(class514 arg0) {
        this.field4912.method2489(true, arg0);
    }

    @OriginalMember(owner = "client!ei", name = "b", descriptor = "()Lft;", line = 9)
    public final class514 method1437() {
        return (class514) this.field4912.method2496((byte) 35);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lov;)V", line = 13)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "()Lft;", line = 26)
    public final class514 method1397() {
        return (class514) this.field4912.method2494(33);
    }

    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(Lft;)V", line = 30)
    public final synchronized void method2085(class514 arg0) {
        arg0.method2997(1);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljd;Lov;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "()I", line = 41)
    public final synchronized int method2087() {
        return this.field4912.method2491(-18626);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([III)V", line = 101)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "()I", line = 145)
    public final int method1419() {
        return 0;
    }

    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "([III)V", line = 164)
    ...
    @OriginalMember(owner = "client!ei", name = "f", descriptor = "()V", line = 180)
