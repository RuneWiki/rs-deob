...
public class class332 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IB)V", line = 63)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 75)
