...
public class class332 extends class80 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIIIIZLvh;)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Llh;B)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILlh;B)V")
