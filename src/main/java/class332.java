...
public class class332 implements class708 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(JI)Z")
    public final boolean method185(long arg0, int arg1) {
        field4639++;
        return arg1 == 14320;
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(ZI)I")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/Object;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/Object;BLjava/lang/String;)Z")
