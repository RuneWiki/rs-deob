...
public class class332 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILfq;Lfq;I)Ljl;")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILfq;ZZLfq;)Ljl;")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lph;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Lhf;Lrm;)V")
