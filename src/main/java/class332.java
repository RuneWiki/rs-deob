...
public class class332 extends class56 {
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lbv;Lre;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZI[Ljb;IIZ)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILkv;)V")
