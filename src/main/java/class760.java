...
public class class760 extends class766 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILhia;Ljg;ILll;IIILha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Ljava/lang/String;IZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(I[B)V", line = 147)
