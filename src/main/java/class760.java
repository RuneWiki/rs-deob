...
public class class760 extends class316 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BLmda;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILje;Lpf;I)V")
