...
public class class760 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lgga;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IBLgga;)V", line = 51)
