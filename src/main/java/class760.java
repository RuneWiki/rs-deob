...
public class class760 implements Runnable {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILrv;I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(II[B)[B", line = 230)
    ...
    @OriginalMember(owner = "client!aca", name = "run", descriptor = "()V", line = 251)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(B)Lpja;", line = 284)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Lwq;B)Lfca;", line = 302)
