...
public class class760 implements class126 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I)Lgj;", line = 75)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(B)I", line = 98)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Luf;IIIBI)V", line = 113)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lvd;Ljava/lang/String;)V", line = 392)
