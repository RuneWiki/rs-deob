...
public class class760 implements class81 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)Lmha;", line = 4)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(B)[Lel;", line = 15)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(ILle;Lqj;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(III)Lju;", line = 63)
