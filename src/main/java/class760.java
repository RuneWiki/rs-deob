...
public class class760 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([[ZIIZBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IBILr;)Z", line = 202)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(JILha;)V", line = 275)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIII)V", line = 309)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLr;II)V", line = 350)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 421)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 457)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)Z", line = 469)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILr;II)V", line = 546)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lsf;Lek;)V", line = 621)
