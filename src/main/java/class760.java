...
public class class760 extends class739 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lqg;IILjava/awt/Component;I)Lbl;", line = 4)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(II)Lwf;", line = 88)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "()V", line = 105)
    public class760() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lsl;II)V", line = 116)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(BI)[[I", line = 175)
