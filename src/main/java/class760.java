...
public class class760 extends class285 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIILha;Lji;[I)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIII)Lrl;")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "([Lpfa;II[BIIIIILha;I)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II[IIILji;Lha;IZII)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIZILha;IIILpfa;)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZBLha;)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILha;Lpfa;III)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "([Lpfa;IB[BLha;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
