...
public class class760 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIIIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZLtba;Lha;Lda;ZLjava/lang/String;)V", line = 119)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "([I[I[I[[F)V", line = 222)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(FI)F", line = 234)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/String;ZLjava/io/File;)V", line = 245)
