...
public class SeqType {
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "[Ljc;")
    public static SeqType[] field1028;

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lub;I)V")
    public static void method326(Jagfile arg0, int arg1) {
        Packet var2 = new Packet(363, arg0.method257("seq.dat", null, (byte) 2));
        if (arg1 <= 0) {
            field1025 = !field1025;
        }
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZLkb;)V")
                ...
                if (var4 == 1) {
                    ...
                    for (int var5 = 0; var5 < this.field1029; var5++) {
                        ...
                        if (this.field1032[var5] == 0) {
                            this.field1032[var5] = AnimFrame.field88[this.field1030[var5]].field89;
                        }
                        if (this.field1032[var5] == 0) {
