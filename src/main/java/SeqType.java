...
public class SeqType {
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "[Ljc;")
    public static SeqType[] field1026;

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILub;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLkb;)V")
