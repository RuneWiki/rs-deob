...
public class class752 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Les;B)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lqh;BII)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lha;ZII)Ltf;")
