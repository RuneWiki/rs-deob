...
public class class752 extends class618 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B[Ljava/lang/String;)V", line = 13)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "([Lwk;)V", line = 71)
    public class752(class152[] arg0) {
        this.field10399 = arg0;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIIIIIII)V", line = 80)
