...
public class class752 extends class134 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(Z)I", line = 13)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)I", line = 476)
