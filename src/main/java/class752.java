...
public class class752 extends class597 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([Leo;IILha;I[B)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIII)Laia;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I[IIILha;Lmc;)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IBI)Luaa;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lmc;ILha;[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIILeo;IIIILha;II)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZLha;[BIII[Leo;IIII)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILha;ILeo;III)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lha;IZ)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lwm;IB)Lpu;")
