...
public class class752 extends class122 {
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ZII)V", line = 23)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIB)V", line = 50)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(I)Z", line = 89)
