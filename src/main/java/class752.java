...
public class class752 extends class330 {
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IZ)[I", line = 12)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILha;I)Lho;", line = 50)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "()V", line = 87)
    public class752() {
        this(4096);
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lgga;IB)V", line = 91)
