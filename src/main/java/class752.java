...
public abstract class class752 extends class176 {
    ...
    @OriginalMember(owner = "client!lr", name = "i", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILlga;Lhj;)Leda;", line = 14)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lji;Z)Ltga;", line = 54)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[Lcba;)I", line = 92)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lha;B)Z", line = 267)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(Z)Z", line = 280)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 322)
