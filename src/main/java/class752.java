...
public class class752 {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "([IIII)Lwo;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Z[III)Lwo;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(IB[I)Lwo;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "([IIB)Lwo;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Lida;Z)V")
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "(Luu;Luu;)V")
