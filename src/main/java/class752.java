...
public class class752 extends class137 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 7)
    public final void method1080(OggPacket arg0, int arg1) {
        int var3 = -102 % ((-arg1 - 48) / 43);
        field10458++;
    }

    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IB)I", line = 29)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 66)
    public class752(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 69)
