...
public class class752 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILjk;Lha;IIIB)Lka;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B[[BLql;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lee;IZ)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIIBILha;IZILjk;Ls;ILs;)Lka;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lha;BIIIILjk;)Lka;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Ls;IBIILha;IZLjk;ILs;II)Lka;")
