...
public class class536 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/String;ZLba;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BIIII)V", line = 77)
