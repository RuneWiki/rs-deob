...
public class class536 extends class416 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "()V", line = 39)
    private final void method3247() {
        this.field7840 = false;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "([Lrea;Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(IZ)Liu;", line = 137)
    ...
    @OriginalMember(owner = "client!iu", name = "c", descriptor = "()Ltt;", line = 150)
    public final class79 method3250() {
        return this.field7852;
    }

    @OriginalMember(owner = "client!iu", name = "d", descriptor = "()V", line = 153)
    public final void method3251() {
        this.field7840 = true;
    }

    @OriginalMember(owner = "client!iu", name = "c", descriptor = "(IZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class536(int arg0, boolean arg1) {
        this.method3252(arg0, arg1);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lr;)V", line = 173)
    ...
    @OriginalMember(owner = "client!iu", name = "e", descriptor = "()Ltt;", line = 185)
    ...
    @OriginalMember(owner = "client!iu", name = "f", descriptor = "()V", line = 201)
    public static void method3255() {
        field7837 = null;
        field7838 = null;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lr;J)Z", line = 205)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lr;J[Lti;[Lrea;Z)V", line = 253)
    ...
    @OriginalMember(owner = "client!iu", name = "g", descriptor = "()V", line = 261)
    public final void method3258() {
        this.field7849 = true;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIII)V", line = 265)
    public final void method3259(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field7851 = arg0;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lr;[Lti;Z)V", line = 278)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(J)V", line = 359)
