...
public class class536 extends Callback {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!bf", name = "callback", descriptor = "(IIII)I", line = 20)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ljava/awt/Component;ZI)V", line = 59)
