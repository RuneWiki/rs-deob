...
public class class536 implements Runnable {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIB[B)I", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "run", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZI)V", line = 103)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 152)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 244)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)Z", line = 203)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 259)
