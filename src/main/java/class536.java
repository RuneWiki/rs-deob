...
public class class536 extends class101 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)Lor;", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)Z", line = 33)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "()V", line = 45)
    public class536() {
    }

    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(J)V", line = 47)
