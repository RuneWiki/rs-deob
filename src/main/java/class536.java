...
public class class536 extends class321 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILr;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 454)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 489)
