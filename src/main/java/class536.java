...
public class class536 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IBI)I", line = 101)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BI)V", line = 151)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(II)Ltk;", line = 176)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lpo;IZLgda;Lgda;)V", line = 280)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)V", line = 224)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZB)V", line = 238)
