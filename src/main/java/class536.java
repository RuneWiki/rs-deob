...
public class class536 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Ldd;ILdd;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)V", line = 276)
