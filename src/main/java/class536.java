...
public abstract class class536 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFIILua;II)V", line = 46)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFII)V", line = 59)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(IIII)V", line = 89)
