...
public class class536 implements Runnable {
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(ILr;)V", line = 168)
    public class536(int arg0, class165 arg1) {
        this.field7813 = arg0;
        this.field7809 = arg1;
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lgp;)V", line = 12)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "()V", line = 126)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "()V", line = 134)
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "()J", line = 143)
    public final long method3153() {
        return this.field7810;
    }

    @OriginalMember(owner = "client!gu", name = "run", descriptor = "()V", line = 146)
    ...
    @OriginalMember(owner = "client!gu", name = "f", descriptor = "()Z", line = 166)
