...
public class class536 extends class108 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZLqa;I)Lr;", line = 26)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Ljba;Lbr;)V", line = 117)
