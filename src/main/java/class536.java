...
public class class536 extends class165 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILmia;)V")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BIIIIZLcb;)V")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Lrv;I)V")
