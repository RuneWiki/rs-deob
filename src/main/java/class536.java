...
public class class536 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lrba;I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "([[II)V", line = 50)
