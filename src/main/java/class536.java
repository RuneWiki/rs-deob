...
public class class536 implements class486 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIII[[[BIIILha;IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 41)
    public static void method3115(int arg0) {
        int var1 = -117 / ((arg0 + 18) / 38);
        field7436 = null;
    }

    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)Leo;", line = 58)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(ILog;Lgi;IIIIIIIZ)V", line = 79)
