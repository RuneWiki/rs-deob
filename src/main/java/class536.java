...
public class class536 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(ILic;)V", line = 29)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lmc;II)V", line = 61)
