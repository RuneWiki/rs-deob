...
public class class536 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IZII)Lae;")
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Ljk;ILae;)V")
    public class536(class788 arg0, int arg1, class283 arg2) {
        this.field7410 = arg2;
        this.field7410.method1867(31, (byte) 49);
    }

    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IB)Lsv;")
