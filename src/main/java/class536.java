...
public class class536 extends class513 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IILnf;Laa;BIILkh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Las;)V", line = 51)
    public class536(class164 arg0) {
        this.field7289 = arg0;
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 66)
