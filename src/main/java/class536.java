...
public class class536 extends class184 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIIIFIII[FIF)V", line = 5)
    ...
    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lpj;Lmu;)V", line = 68)
    public class536(class132 arg0, class272 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(JZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IZ)V", line = 171)
