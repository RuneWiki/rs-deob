...
public class class536 extends class390 {
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "([BIIILjava/lang/String;I)I", line = 22)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Leda;Lcga;IIIIIIIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)Lhr;", line = 177)
