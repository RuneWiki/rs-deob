...
public class class536 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "()I", line = 25)
    public final int method3147() {
        return this.field7744 - 1;
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;)I", line = 53)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "()V", line = 68)
    public static void method3150() {
        field7750 = null;
    }

    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 83)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "()I", line = 74)
    public final int method3151() {
        return this.field7746;
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 127)
