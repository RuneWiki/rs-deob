...
public class class536 extends class339 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(III)Ldq;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "([ILkha;ILkha;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)Loba;")
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(ILwea;Lwea;Ldm;Lhe;I[BIZ)V")
