...
public class class536 extends class60 {
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(ILhd;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lhd;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIILiaa;)V")
