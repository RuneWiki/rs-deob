...
public class class536 extends class55 implements class198 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lkd;II)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lkd;I)V")
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "()[Llea;")
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()[Lin;")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Llm;IIII)V")
