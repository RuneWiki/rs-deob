...
public class class536 extends class418 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(IIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BII)V", line = 59)
