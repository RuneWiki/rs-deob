...
public class class536 extends class37 {
    ...
    @OriginalMember(owner = "client!iu", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lkt;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!iu", name = "E", descriptor = "(Lha;IIIIZ)V")
    public final void method330(class54 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!iu", name = "v", descriptor = "(IILha;)Lha;")
    public final class54 method324(int arg0, int arg1, class54 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IILmea;[I[I[I[I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIIIII[[ZLlw;Lmea;[I[I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ltw;[I)V")
    public final void method333(class186 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(IIIIIII[[ZLlw;Lmea;[I[I)V")
                    ...
                    if (this.field7238[var18][var19] != null) {
                        ...
                        for (int var25 = 0; var25 < var23.field4647; ++var25) {
                            ...
                            if (var23.field4643 == null || var23.field4643[var25] == 0 || var23.field4645 != null && (var23.field4645 == null || var23.field4645[var25] != -1)) {
                                if (var23.field4645 != null && var23.field4645[var25] != -1) {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIZLlw;Lmea;[I[I[I[I)V")
