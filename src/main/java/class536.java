...
public abstract class class536 implements class482 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFFFFFIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(II)V", line = 10)
    public final void method3142(int arg0, int arg1) {
        this.method133(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFFFIILaa;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFFFIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFII)V", line = 84)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(FFIILaa;II)V", line = 89)
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "(IIII)V", line = 92)
    public final void method3149(int arg0, int arg1, int arg2, int arg3) {
        this.method132(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!pga", name = "c", descriptor = "(IIII)V", line = 96)
