...
public class class536 extends class187 {
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lih;IIII[I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lih;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lih;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lih;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lih;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lih;IIIIIIZ)V")
