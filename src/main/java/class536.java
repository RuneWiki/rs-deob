...
public class class536 extends class377 {
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "()V", line = 115)
    public class536() {
        super(0, true);
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZBZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)[I", line = 31)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(III)I", line = 118)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IILji;)V", line = 134)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILpfa;)I", line = 168)
    ...
    @OriginalMember(owner = "client!im", name = "f", descriptor = "(I)V", line = 239)
