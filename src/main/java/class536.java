...
public class class536 extends class322 implements class614 {
    ...
    @OriginalMember(owner = "client!eba", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lnfa;IZ[[I)V")
