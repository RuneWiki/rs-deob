...
public class class536 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Lwca;BLwca;)V", line = 23)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)V", line = 46)
