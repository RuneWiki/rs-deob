...
public class class254 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)Lgr;", line = 22)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BI)V", line = 90)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 119)
    public class254(class104 arg0, int arg1, class361 arg2) {
        this.field3377 = arg2;
        this.field3377.method2136(-92, 26);
    }

    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lmh;III)J", line = 134)
