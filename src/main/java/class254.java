...
public class class254 extends class295 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lqba;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lqba;IIIIIIIIIIIZZ)V")
