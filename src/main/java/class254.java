...
public class class254 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lj;III[Z)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)Lgs;", line = 45)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z)I", line = 63)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILgs;)V", line = 85)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)Lgs;", line = 128)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 148)
    public static void method1639(byte arg0) {
        field3645 = null;
        int var1 = 68 % ((arg0 + 20) / 50);
    }

    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(Z)Lgs;", line = 159)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(Z)Lgs;", line = 181)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 214)
    public class254() {
        this.field3646.field667 = this.field3646;
        this.field3646.field670 = this.field3646;
    }

    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(B)Z", line = 223)
