...
public class class254 extends class687 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(FB)V", line = 3)
    ...
    @OriginalMember(owner = "client!iaa", name = "f", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(IIIIIF)V", line = 101)
    public class254(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIII)V", line = 113)
