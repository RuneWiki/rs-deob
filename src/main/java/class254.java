...
public class class254 extends class329 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
