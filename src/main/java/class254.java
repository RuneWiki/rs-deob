...
public class class254 extends class260 {
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(ILgn;)V", line = 4)
    public class254(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lgn;)V", line = 19)
    public class254(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lha;ZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)I", line = 146)
    public final int method123(int arg0) {
        ++field3739;
        return arg0 != 4377 ? -95 : 0;
    }

    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(II)I", line = 177)
    ...
    @OriginalMember(owner = "client!bj", name = "f", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Leba;IIII)Z", line = 217)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 348)
