...
public class class254 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Z)J", line = 6)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BLpi;I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lvo;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(Z)V", line = 65)
