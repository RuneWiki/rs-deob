...
public class class254 implements class666 {
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Lbt;", line = 25)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(B)Z", line = 36)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 61)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lgaa;Lbt;Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)I", line = 118)
