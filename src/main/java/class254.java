...
public class class254 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ljava/awt/Canvas;IILga;)Lya;")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)Lki;")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BI)Ldh;")
