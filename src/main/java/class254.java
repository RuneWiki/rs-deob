...
public class class254 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "([I[Ljava/lang/Object;III)V", line = 6)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z[B)[B", line = 63)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIIII)I", line = 128)
