...
public class class254 extends class63 implements class221 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I[Lma;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "H", descriptor = "()Lmu;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lbl;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II[I[I)Lus;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILjava/nio/ByteBuffer;Z)Lec;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lis;[Lff;Z)Ltr;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II[[I[[IIII)Lcl;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lns;Lim;Lmu;Lro;I)V")
    public final void method552(class57 arg0, class268 arg1, class315 arg2, class117 arg3, int arg4) {
        arg0.method404(arg2, arg3, arg4);
        this.method502(arg1);
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lmu;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lku;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "([IIIII)Ldp;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILus;II)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)Lku;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "([Lns;Lmu;[Lro;I)V")
    ...
    @OriginalMember(owner = "client!nm", name = "cb", descriptor = "()Lbl;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lff;Z)Ldp;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lvn;IIII)Lns;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I[BIZ)Lec;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lvp;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lap;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lgs;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lcp;IILng;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(Lbl;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lec;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lim;)V")
    public final void method502(class268 arg0) {
        this.field3651.method1794(this, arg0);
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lgs;III)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Las;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I[BIZ)Lgs;")
    ...
    @OriginalMember(owner = "client!nm", name = "nb", descriptor = "()Lcd;")
    public final class60 method1671() {
        return this.field3727 == null ? null : this.field3727.method399((byte) -95);
    }

    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(IIIIII)Las;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Ljt;Ljt;Ljt;Ljt;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIIIILus;II)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIIZ)Ldp;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Las;Las;FLas;)Las;")
