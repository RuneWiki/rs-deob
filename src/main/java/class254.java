...
public class class254 extends class394 implements class9 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZBIILna;ILae;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Ltq;ZLtq;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIZIILtq;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lae;ZI)Lbk;")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lae;Ljh;IIIIIIIZI)V")
