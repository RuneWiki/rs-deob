...
public class class254 {
    ...
    @OriginalMember(owner = "client!ln", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() throws Throwable {
        this.field3430.method132(this.field3431);
        super.finalize();
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lhd;ILjava/lang/String;)Lln;", line = 10)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lhd;II)V", line = 48)
