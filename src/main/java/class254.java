...
public class class254 extends class145 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILfa;Lcq;ILjava/lang/String;IILta;IIILqf;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!nb", name = "i", descriptor = "(I)Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!nb", name = "f", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 123)
    public class254() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILrt;)V", line = 126)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IBLkea;IZI)V", line = 177)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ZI)[I", line = 196)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BI)[[I", line = 236)
