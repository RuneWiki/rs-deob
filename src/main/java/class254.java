...
public class class254 {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(JI)V", line = 15)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Lcn;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "(IIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(III)V", line = 63)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(II)Leia;", line = 81)
