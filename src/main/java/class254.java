...
public abstract class class254 implements class387 {
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!wq", name = "finalize", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lpea;IIIZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!wq", name = "d", descriptor = "(B)I", line = 145)
    ...
    @OriginalMember(owner = "client!wq", name = "e", descriptor = "(B)Z", line = 180)
