...
public class class254 extends class233 {
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lh;IIZ[[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(III)V", line = 35)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "()V", line = 39)
    public final void method878() {
        this.field3052.field4363.glFramebufferTexture2DEXT(36160, this.field3309, 3553, 0, 0);
        this.field3309 = -1;
    }

    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lh;IIZ[[BI)V", line = 47)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lh;II)V", line = 64)
