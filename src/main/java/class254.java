...
public class class254 extends class601 {
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lgn;)V", line = 31)
    public class254(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZILdia;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(II)I", line = 77)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(ILgn;)V", line = 94)
    public class254(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)V", line = 108)
    public static void method1514(byte arg0) {
        int var1 = -21 / ((61 - arg0) / 45);
        field3055 = null;
    }

    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)Z", line = 119)
    public final boolean method1515(int arg0) {
        ++field3056;
        return arg0 != 0 ? true : this.field3066;
    }

    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)I", line = 130)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(B)V", line = 147)
