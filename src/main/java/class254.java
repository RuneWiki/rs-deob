...
public class class254 {
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(B)Lol;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lft;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)Lol;")
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lft;)V")
