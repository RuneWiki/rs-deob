...
public abstract class class254 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lvm;Lal;B)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIBLio;)J")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lvm;IILib;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ILtq;)V")
