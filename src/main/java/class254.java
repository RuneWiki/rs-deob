...
public class class254 implements class159 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IIIIIIZ)I")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BI)Lbl;")
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(BI)I")
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lfp;Lfp;Ldj;)V")
