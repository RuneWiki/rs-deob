...
public abstract class class254 extends class65 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(III)Z", line = 57)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(ILrw;)V", line = 68)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIIZI)V", line = 110)
