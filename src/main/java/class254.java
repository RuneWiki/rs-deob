...
public class class254 extends class37 implements class199 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III[[ZZI)V", line = 6)
    public final void method435(int arg0, int arg1, int arg2, boolean[][] arg3, boolean arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIIIIII[[Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III[[ZZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!s", name = "finalize", descriptor = "()V", line = 170)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Ll;Lm;II[[I[[IIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lul;[I)V", line = 179)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 187)
    public final boolean method427(class54 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II)V", line = 194)
