...
public abstract class class254 extends class85 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I[IZIII[ILbm;IIIIIII)I")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lqa;ZI)Z")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lbt;Z)V")
