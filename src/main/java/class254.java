...
public class class254 extends class192 {
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(BII)Z", line = 26)
    ...
    @OriginalMember(owner = "client!uha", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIB)I", line = 506)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(B)V", line = 522)
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(Lgca;II)V", line = 535)
