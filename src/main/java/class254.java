...
public class class254 extends class499 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILsfa;I)V")
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lgd;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BLuc;II)V")
