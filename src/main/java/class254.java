...
public class class254 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BIIIIZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Z)V", line = 43)
