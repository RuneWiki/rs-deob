...
public class class254 extends class152 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(CZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IC)I", line = 28)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Lpt;IILha;)V", line = 59)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(BLes;I)V", line = 387)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(I)V", line = 453)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Les;B)V", line = 471)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(Z)V", line = 500)
