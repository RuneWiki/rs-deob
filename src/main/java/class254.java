...
public class class254 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ZIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(B)Ljava/lang/String;", line = 45)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BLoa;Lgr;)I", line = 67)
