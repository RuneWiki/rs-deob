...
public class class254 extends class397 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(I)V", line = 137)
