...
public class class254 extends class52 implements class28 {
    ...
    @OriginalMember(owner = "client!ca", name = "BA", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(La;Lc;[I[BIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILpa;II)V", line = 17)
    public final void method7(int arg0, int arg1, class309 arg2, int arg3, int arg4) {
        this.method1440(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!ca", name = "P", descriptor = "(IIIIII)V", line = 29)
