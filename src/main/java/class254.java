...
public class class254 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II[[BI[[BILvd;Lhk;[ZI[[BIILha;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Ls;Ls;ILs;[[ILha;I)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II)Lsk;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Ls;BLs;Lha;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lcea;I[Lfe;IIIB)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZIIILcea;IIIIII)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lha;Ls;IB[[ILs;Ls;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIILcea;III[Lfe;II)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lha;[[[II[Lfe;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lat;I)Lat;")
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(IIIZLcb;Lqe;)V")
