...
public class class254 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BI)Ljc;", line = 7)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BII)Z", line = 135)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lci;ILhe;Lhe;)V", line = 161)
