...
public class class2 extends class214 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IZILfc;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "f", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(III)I", line = 38)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "()V", line = 76)
    public class2() {
        super(3, false);
    }

    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)[[I", line = 79)
    ...
    @OriginalMember(owner = "client!pa", name = "e", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!pa", name = "g", descriptor = "(I)Lba;", line = 149)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BI)[I", line = 195)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Llk;II)V", line = 250)
