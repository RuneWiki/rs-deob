...
public class class2 {
    ...
    @OriginalMember(owner = "client!BELQMOFW", name = "c", descriptor = "[LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!BELQMOFW", name = "a", descriptor = "(J)LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!BELQMOFW", name = "a", descriptor = "(JLCDEGFOQA;B)V")
