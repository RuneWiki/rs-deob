...
public class class2 {
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "b", descriptor = "LAKUDQPZE;")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "y", descriptor = "LEGCCHUZS;")
    private static class15 field34;

    @OriginalMember(owner = "client!AUWOQLEO", name = "x", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "J", descriptor = "[LAUWOQLEO;")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "a", descriptor = "(LEGCCHUZS;Z)V")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "a", descriptor = "(B)LAUWOQLEO;")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "a", descriptor = "(BII[I)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "a", descriptor = "(LTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "b", descriptor = "(I)LAUWOQLEO;")
    ...
    @OriginalMember(owner = "client!AUWOQLEO", name = "c", descriptor = "(B)LIGXVZOHI;")
