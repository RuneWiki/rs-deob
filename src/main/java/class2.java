...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZ)I", line = 39)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "([I)V", line = 65)
