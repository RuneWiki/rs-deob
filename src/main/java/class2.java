...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IBLua;)Z")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILha;IIIII)V")
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Lha;Lcea;I)V")
