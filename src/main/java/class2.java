...
public class class2 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILbt;)V", line = 23)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIIIII)I", line = 43)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IILbt;)V", line = 105)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(II)V", line = 151)
