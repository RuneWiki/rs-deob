...
@OriginalClass("client!ACLAPANL")
public class class2 {

    @OriginalMember(owner = "client!ACLAPANL", name = "j", descriptor = "[I")
    private int[] field22 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "k", descriptor = "[I")
    private int[] field23 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "l", descriptor = "[I")
    private int[] field24 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "n", descriptor = "I")
    private int field26 = 100;

    @OriginalMember(owner = "client!ACLAPANL", name = "q", descriptor = "I")
    public int field29 = 500;

    @OriginalMember(owner = "client!ACLAPANL", name = "v", descriptor = "[I")
    private static int[] field34 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "w", descriptor = "[I")
    private static int[] field35 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "x", descriptor = "[I")
    private static int[] field36 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "y", descriptor = "[I")
    private static int[] field37 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "z", descriptor = "[I")
    private static int[] field38 = new int[5];

    @OriginalMember(owner = "client!ACLAPANL", name = "a", descriptor = "I")
    private static int field13;

    @OriginalMember(owner = "client!ACLAPANL", name = "m", descriptor = "I")
    private int field25;

    @OriginalMember(owner = "client!ACLAPANL", name = "r", descriptor = "I")
    public int field30;

    @OriginalMember(owner = "client!ACLAPANL", name = "o", descriptor = "LFCAOQJWY;")
    private class20 field27;

    @OriginalMember(owner = "client!ACLAPANL", name = "b", descriptor = "LBJPHZZMM;")
    private class5 field14;

    @OriginalMember(owner = "client!ACLAPANL", name = "c", descriptor = "LBJPHZZMM;")
    private class5 field15;

    @OriginalMember(owner = "client!ACLAPANL", name = "d", descriptor = "LBJPHZZMM;")
    private class5 field16;

    @OriginalMember(owner = "client!ACLAPANL", name = "e", descriptor = "LBJPHZZMM;")
    private class5 field17;

    @OriginalMember(owner = "client!ACLAPANL", name = "f", descriptor = "LBJPHZZMM;")
    private class5 field18;

    @OriginalMember(owner = "client!ACLAPANL", name = "g", descriptor = "LBJPHZZMM;")
    private class5 field19;

    @OriginalMember(owner = "client!ACLAPANL", name = "h", descriptor = "LBJPHZZMM;")
    private class5 field20;

    @OriginalMember(owner = "client!ACLAPANL", name = "i", descriptor = "LBJPHZZMM;")
    private class5 field21;

    @OriginalMember(owner = "client!ACLAPANL", name = "p", descriptor = "LBJPHZZMM;")
    private class5 field28;

    @OriginalMember(owner = "client!ACLAPANL", name = "s", descriptor = "[I")
    private static int[] field31;

    @OriginalMember(owner = "client!ACLAPANL", name = "t", descriptor = "[I")
    private static int[] field32;

    @OriginalMember(owner = "client!ACLAPANL", name = "u", descriptor = "[I")
    private static int[] field33;

    @OriginalMember(owner = "client!ACLAPANL", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!ACLAPANL", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!ACLAPANL", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!ACLAPANL", name = "a", descriptor = "(BLXOUQUKZW;)V")
