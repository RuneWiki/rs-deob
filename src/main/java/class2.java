...
public class class2 {
    ...
    @OriginalMember(owner = "client!BSYFPVLV", name = "h", descriptor = "[LRLHOXRLU;")
    private class44[] field11 = new class44[10];

    @OriginalMember(owner = "client!BSYFPVLV", name = "d", descriptor = "[LBSYFPVLV;")
    ...
    @OriginalMember(owner = "client!BSYFPVLV", name = "g", descriptor = "LMLYYHULT;")
    ...
    @OriginalMember(owner = "client!BSYFPVLV", name = "a", descriptor = "(LMLYYHULT;B)V")
    ...
    @OriginalMember(owner = "client!BSYFPVLV", name = "a", descriptor = "(BII)LMLYYHULT;")
    ...
    @OriginalMember(owner = "client!BSYFPVLV", name = "b", descriptor = "(LMLYYHULT;B)V")
    ...
    @OriginalMember(owner = "client!BSYFPVLV", name = "a", descriptor = "(II)LMLYYHULT;")
