...
public class class2 extends class480 implements class248 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lqa;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IBLqa;)Lc;", line = 48)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZLqa;)Lae;", line = 110)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqa;II)Z", line = 138)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqa;)V", line = 156)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lqa;IIZ)Lmr;", line = 185)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(B)I", line = 218)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqa;ZLto;III)V", line = 228)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)I", line = 255)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Lqa;Lgm;IIIIZIZ)V", line = 266)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)Z", line = 300)
    ...
    @OriginalMember(owner = "client!ro", name = "f", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lqa;II)Lc;", line = 342)
    public final class121 method23(class162 arg0, int arg1, int arg2) {
        ++field89;
        return arg1 != 17793 ? null : this.method10(arg2, (byte) 108, arg0);
    }

    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(Z)Z", line = 353)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLqa;)V", line = 364)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(II)Z", line = 387)
