...
public class class2 extends class184 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BILfh;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lya;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "(III)Le;")
