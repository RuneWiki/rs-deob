...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)Lpb;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Z)Lpb;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lpb;I)V")
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)Lpb;")
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(Lpb;I)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lro;I)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lpb;ILro;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "e", descriptor = "(I)Lpb;")
    ...
    @OriginalMember(owner = "client!ro", name = "f", descriptor = "(I)Lpb;")
