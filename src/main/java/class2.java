...
public class class2 extends class634 {
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "()V", line = 4)
    public class2() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILig;Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!ro", name = "f", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lha;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZ)Z", line = 239)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BI)[[I", line = 258)
