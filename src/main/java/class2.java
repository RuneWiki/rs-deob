...
public class class2 extends class35 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lsk;I)I", line = 77)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(CILjava/lang/String;)I", line = 183)
