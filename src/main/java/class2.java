...
public class class2 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIC)C", line = 8)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lkh;BI)V", line = 143)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILnq;Lnq;)V", line = 166)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIILmk;Lmk;)V", line = 181)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 189)
