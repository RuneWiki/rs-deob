...
public class class2 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILjava/lang/Object;Ldt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIII)I", line = 16)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ldt;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZ)V", line = 101)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIILgl;)Lci;", line = 150)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lck;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)I", line = 246)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIIIIZ)V", line = 257)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BLdt;Ljava/lang/Object;I)V", line = 310)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZLdt;)Ljava/lang/Object;", line = 340)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(I)V", line = 394)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BII)I", line = 420)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(I)V", line = 436)
