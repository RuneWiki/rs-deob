...
public class class2 extends class65 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lhm;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(I)V", line = 32)
    public class2(int arg0) {
        this.field10 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 69)
