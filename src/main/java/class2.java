...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIIZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IC)Z", line = 78)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIILjw;)V", line = 127)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III)Lsn;", line = 152)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)[Lfg;", line = 165)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IB)Z", line = 185)
