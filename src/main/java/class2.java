...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLeq;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ro", name = "finalize", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIIBI)V", line = 170)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Leq;Lhn;IIIIIIZI)V", line = 627)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Leq;B)V", line = 199)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZI)V", line = 209)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)V", line = 226)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III)V", line = 276)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(B)I", line = 380)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lva;IIIZILeq;I)V", line = 390)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(B)Z", line = 431)
    public final boolean method14(byte arg0) {
        field14++;
        return arg0 <= 79 ? true : this.field25;
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BIZI)Ljava/lang/String;", line = 442)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIILeq;ZIZ)Lva;", line = 494)
