...
public class class2 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B[[I)V", line = 53)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)[I", line = 67)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)[[I", line = 134)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BI)V", line = 174)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(III)V", line = 357)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lnj;I[I[I[I)V", line = 241)
