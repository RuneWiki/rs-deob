...
@OriginalClass("client!AQBPXQWT")
public class class2 {

    @OriginalMember(owner = "client!AQBPXQWT", name = "i", descriptor = "[I")
    private int[] field14 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "j", descriptor = "[I")
    private int[] field15 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "k", descriptor = "[I")
    private int[] field16 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "m", descriptor = "I")
    private int field18 = 100;

    @OriginalMember(owner = "client!AQBPXQWT", name = "p", descriptor = "I")
    public int field21 = 500;

    @OriginalMember(owner = "client!AQBPXQWT", name = "u", descriptor = "[I")
    private static int[] field26 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "v", descriptor = "[I")
    private static int[] field27 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "w", descriptor = "[I")
    private static int[] field28 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "x", descriptor = "[I")
    private static int[] field29 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "y", descriptor = "[I")
    private static int[] field30 = new int[5];

    @OriginalMember(owner = "client!AQBPXQWT", name = "l", descriptor = "I")
    private int field17;

    @OriginalMember(owner = "client!AQBPXQWT", name = "q", descriptor = "I")
    public int field22;

    @OriginalMember(owner = "client!AQBPXQWT", name = "e", descriptor = "LQOBPOZUC;")
    private class46 field10;

    @OriginalMember(owner = "client!AQBPXQWT", name = "f", descriptor = "LQOBPOZUC;")
    private class46 field11;

    @OriginalMember(owner = "client!AQBPXQWT", name = "g", descriptor = "LQOBPOZUC;")
    private class46 field12;

    @OriginalMember(owner = "client!AQBPXQWT", name = "h", descriptor = "LQOBPOZUC;")
    private class46 field13;

    @OriginalMember(owner = "client!AQBPXQWT", name = "o", descriptor = "LQOBPOZUC;")
    private class46 field20;

    @OriginalMember(owner = "client!AQBPXQWT", name = "a", descriptor = "LQOBPOZUC;")
    private class46 field6;

    @OriginalMember(owner = "client!AQBPXQWT", name = "b", descriptor = "LQOBPOZUC;")
    private class46 field7;

    @OriginalMember(owner = "client!AQBPXQWT", name = "c", descriptor = "LQOBPOZUC;")
    private class46 field8;

    @OriginalMember(owner = "client!AQBPXQWT", name = "d", descriptor = "LQOBPOZUC;")
    private class46 field9;

    @OriginalMember(owner = "client!AQBPXQWT", name = "n", descriptor = "LCGCAZMIE;")
    private class7 field19;

    @OriginalMember(owner = "client!AQBPXQWT", name = "r", descriptor = "[I")
    private static int[] field23;

    @OriginalMember(owner = "client!AQBPXQWT", name = "s", descriptor = "[I")
    private static int[] field24;

    @OriginalMember(owner = "client!AQBPXQWT", name = "t", descriptor = "[I")
    private static int[] field25;

    @OriginalMember(owner = "client!AQBPXQWT", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!AQBPXQWT", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!AQBPXQWT", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!AQBPXQWT", name = "a", descriptor = "(LXQPFGONL;I)V")
