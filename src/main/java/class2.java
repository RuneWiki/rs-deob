...
public class class2 {
    ...
    @OriginalMember(owner = "client!AFWJXAMU", name = "c", descriptor = "[LAFWJXAMU;")
    public static class2[] field12;

    @OriginalMember(owner = "client!AFWJXAMU", name = "a", descriptor = "(LBYZSQZUF;Z)V")
    ...
    @OriginalMember(owner = "client!AFWJXAMU", name = "a", descriptor = "(LIMUIZRAF;II)V")
