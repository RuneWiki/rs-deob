...
public class class2 implements Runnable {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lpd;I)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZLqk;I)Lpd;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lam;I)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BILqk;)Lpd;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I[BLqk;Z)Lpd;")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Llh;)V")
