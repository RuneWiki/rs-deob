...
public class class2 extends class20 {
    ...
    @OriginalMember(owner = "client!BBIXHJOC", name = "l", descriptor = "Z")
    public static boolean field7;

    @OriginalMember(owner = "client!BBIXHJOC", name = "j", descriptor = "[LSWCSHRND;")
    ...
    @OriginalMember(owner = "client!BBIXHJOC", name = "a", descriptor = "(I)LJLNSJQDR;")
