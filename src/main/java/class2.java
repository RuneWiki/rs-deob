...
public class class2 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I[Lkg;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZIIILdf;ILfp;)V", line = 141)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(I)V", line = 176)
