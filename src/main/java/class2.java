...
public class class2 implements Runnable {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/Class;I)Lor;")
    public final class296 method5(Class arg0, int arg1) {
        return arg1 == 10 ? this.method8(1774773648, 0, arg0, 10, 0) : null;
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "([IILjava/awt/Point;ILjava/awt/Component;I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IILjava/lang/Object;II)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLjava/net/URL;)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILjava/lang/Object;III)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)Lmf;")
    public final class14 method12(int arg0) {
        return arg0 == -2 ? this.field16 : null;
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;ILjava/lang/Class;)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/String;BI)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/awt/Frame;I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/String;I)Lor;")
    public final class296 method17(String arg0, int arg1) {
        return arg1 < 80 ? null : this.method8(1774773648, 0, arg0, 16, 0);
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BI)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLjava/lang/String;)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(Ljava/lang/Class;I)Lor;")
    public final class296 method21(Class arg0, int arg1) {
        return arg1 < 56 ? null : this.method8(1774773648, 0, arg0, 11, 0);
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIBII)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "d", descriptor = "(I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZLjava/awt/Component;I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLjava/lang/Runnable;I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIILjava/awt/Component;)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILjava/lang/Class;)Lor;")
    public final class296 method27(int arg0, Class arg1) {
        int var3 = -125 / ((arg0 + 13) / 51);
        return this.method8(1774773648, 0, arg1, 20, 0);
    }

    @OriginalMember(owner = "client!ud", name = "e", descriptor = "(I)Lor;")
    ...
    @OriginalMember(owner = "client!ud", name = "h", descriptor = "(I)Lor;")
