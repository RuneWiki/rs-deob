...
public class class2 extends class364 implements class351 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lqa;IZI)Llp;", line = 5)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!ro", name = "f", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IILqa;B)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqa;I)Lc;", line = 92)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Lqa;Lkn;IIIIZIIZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLqa;)V", line = 145)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqa;)V", line = 159)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(ILqa;)Lnf;", line = 187)
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lqa;B)V", line = 234)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)V", line = 263)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLqa;I)Lc;", line = 277)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)I", line = 299)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)Z", line = 313)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZIILer;Lqa;IB)V", line = 325)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)I", line = 364)
