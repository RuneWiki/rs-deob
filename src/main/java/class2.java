...
public class class2 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIILor;IB)Ljava/awt/Frame;", line = 71)
