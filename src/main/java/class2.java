...
public class class2 extends class447 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lrg;B)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILeb;B)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZLaa;)V")
    ...
    @OriginalMember(owner = "client!dp", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILeb;)V")
