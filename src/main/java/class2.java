...
public class class2 {
    ...
    @OriginalMember(owner = "client!APJPJMYV", name = "c", descriptor = "LMOLQXLMB;")
    ...
    @OriginalMember(owner = "client!APJPJMYV", name = "a", descriptor = "[LAPJPJMYV;")
    ...
    @OriginalMember(owner = "client!APJPJMYV", name = "b", descriptor = "(I)LAPJPJMYV;")
