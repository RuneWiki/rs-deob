...
@OriginalClass("client!BXKOBEWK")
public class class2 {

    @OriginalMember(owner = "client!BXKOBEWK", name = "a", descriptor = "I")
    private int field4 = -261;

    @OriginalMember(owner = "client!BXKOBEWK", name = "b", descriptor = "Z")
    private boolean field5 = true;

    @OriginalMember(owner = "client!BXKOBEWK", name = "g", descriptor = "I")
    public int field10 = -1;

    @OriginalMember(owner = "client!BXKOBEWK", name = "h", descriptor = "Z")
    public boolean field11 = false;

    @OriginalMember(owner = "client!BXKOBEWK", name = "i", descriptor = "Z")
    public boolean field12 = true;

    @OriginalMember(owner = "client!BXKOBEWK", name = "j", descriptor = "I")
    public int field13;

    @OriginalMember(owner = "client!BXKOBEWK", name = "k", descriptor = "I")
    public int field14;

    @OriginalMember(owner = "client!BXKOBEWK", name = "l", descriptor = "I")
    public int field15;

    @OriginalMember(owner = "client!BXKOBEWK", name = "m", descriptor = "I")
    public int field16;

    @OriginalMember(owner = "client!BXKOBEWK", name = "n", descriptor = "I")
    public int field17;

    @OriginalMember(owner = "client!BXKOBEWK", name = "o", descriptor = "I")
    public int field18;

    @OriginalMember(owner = "client!BXKOBEWK", name = "c", descriptor = "I")
    public static int field6;

    @OriginalMember(owner = "client!BXKOBEWK", name = "f", descriptor = "I")
    public int field9;

    @OriginalMember(owner = "client!BXKOBEWK", name = "e", descriptor = "Ljava/lang/String;")
    public String field8;

    @OriginalMember(owner = "client!BXKOBEWK", name = "d", descriptor = "[LBXKOBEWK;")
    public static class2[] field7;

    @OriginalMember(owner = "client!BXKOBEWK", name = "a", descriptor = "(LCXFTMSCH;B)V")
    ...
    @OriginalMember(owner = "client!BXKOBEWK", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!BXKOBEWK", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!BXKOBEWK", name = "a", descriptor = "(III)I")
