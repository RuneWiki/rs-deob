...
public class class2 extends class349 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IILdga;)V", line = 9)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "()V", line = 57)
    public class2() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)Z", line = 64)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIIILoa;)V", line = 79)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IZ)V", line = 173)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IB)[[I", line = 425)
    ...
    @OriginalMember(owner = "client!gv", name = "d", descriptor = "(B)V", line = 474)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(B)V", line = 577)
    ...
    @OriginalMember(owner = "client!gv", name = "f", descriptor = "(I)V", line = 591)
