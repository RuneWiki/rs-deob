...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BI)V", line = 31)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIBII)V", line = 58)
