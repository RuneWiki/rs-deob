...
public class class2 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II[BI)V", line = 46)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLfp;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(B)V", line = 183)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Ltt;Lhm;Ljk;IIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIIII[BI)Z", line = 204)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(III)Z", line = 256)
