...
public class class2 {
    ...
    @OriginalMember(owner = "client!AIRUOZLB", name = "b", descriptor = "[LAIRUOZLB;")
    public static class2[] field6;

    @OriginalMember(owner = "client!AIRUOZLB", name = "a", descriptor = "(ILHRXSNEYZ;)V")
    ...
    @OriginalMember(owner = "client!AIRUOZLB", name = "a", descriptor = "(IILJHKSAGUC;)V")
