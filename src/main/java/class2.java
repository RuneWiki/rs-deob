...
public class class2 extends class615 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(II)[I", line = 48)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "()V", line = 95)
    public class2() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(IIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!ro", name = "f", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BILeh;)V", line = 337)
