...
public class class2 implements Runnable {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLtd;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IBLrq;)Ltd;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILrq;Z)Ltd;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "([BILrq;I)Ltd;")
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Lml;)V")
