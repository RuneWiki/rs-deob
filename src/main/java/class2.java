...
public class class2 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BI)I", line = 9)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!ud", name = "toString", descriptor = "()Ljava/lang/String;", line = 41)
    public final String toString() {
        field11++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 62)
