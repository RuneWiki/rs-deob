...
public class class2 extends class427 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lpd;Lna;ZIILuo;)Z")
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)Loo;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILaq;II)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lbg;B)Lrl;")
