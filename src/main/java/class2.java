...
public class class2 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "([[BLtf;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!pb", name = "toString", descriptor = "()Ljava/lang/String;", line = 98)
    public final String toString() {
        field12++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIZ)Z", line = 111)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(I)V", line = 122)
