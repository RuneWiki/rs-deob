...
public class class2 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZLcj;Lla;IILya;ZIIIZLya;)Ll;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lya;IILcj;IIII)Ll;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)Lrv;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Llh;B)V")
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Ljk;IZLph;Lfs;Lfs;)V")
