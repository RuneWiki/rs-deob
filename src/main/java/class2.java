...
public class class2 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(II)[B", line = 16)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIIIIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "([BI)V", line = 126)
