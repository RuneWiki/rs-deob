...
public class class2 {
    ...
    @OriginalMember(owner = "client!pb", name = "toString", descriptor = "()Ljava/lang/String;", line = 19)
    public final String toString() {
        field19++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 47)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(II)V", line = 126)
