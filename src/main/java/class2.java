...
public class class2 extends class542 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "([Lsj;)V", line = 72)
