...
public class class324 extends class406 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILtq;)V", line = 16)
    ...
    @OriginalMember(owner = "client!nd", name = "c", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(I)V", line = 66)
