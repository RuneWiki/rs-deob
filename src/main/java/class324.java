...
public class class324 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lhd;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lhd;)V", line = 350)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(Lhd;)V", line = 356)
    ...
    @OriginalMember(owner = "client!bm", name = "c", descriptor = "(Lhd;)V", line = 371)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lhd;Lbg;)V", line = 382)
