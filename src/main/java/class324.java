...
public class class324 extends class392 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIB[B)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIBII)V", line = 71)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IILha;)Lmv;", line = 105)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lcia;Llba;)V", line = 127)
