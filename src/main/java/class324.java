...
public class class324 {
    ...
    @OriginalMember(owner = "client!efa", name = "toString", descriptor = "()Ljava/lang/String;", line = 10)
    public final String toString() {
        field4504++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IB)Lefa;", line = 20)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(IILqda;)V", line = 118)
