...
public class class324 extends class69 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLsha;Z)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILgga;)Lvj;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/awt/Canvas;BII)Lfb;")
