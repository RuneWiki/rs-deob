...
public class class324 extends class218 implements class518 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLza;)V", line = 14)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(ILza;)Lsr;", line = 25)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILza;)V", line = 71)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lza;III)Z", line = 96)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(B)Z", line = 127)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(BLza;)V", line = 137)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(III)I", line = 176)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILza;IILvl;Z)V", line = 205)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILza;I)Le;", line = 219)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)I", line = 229)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(I)V", line = 243)
    public final void method31(int arg0) {
        ++field5074;
        int var2 = 62 % ((arg0 - 57) / 48);
    }

    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lza;Lp;IIIIIZIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)Z", line = 265)
