...
public class class324 extends class529 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILea;II)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(FFFFFFLea;II)V")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lbo;IIII)V")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lbo;II[III)V")
