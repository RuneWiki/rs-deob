...
public class class324 implements class654 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Lgj;I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)V", line = 79)
