...
public class class324 extends class578 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 39)
    public class324() {
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)[Lsb;", line = 44)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 53)
