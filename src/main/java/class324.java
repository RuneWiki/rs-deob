...
public class class324 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II[SI[Ljava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "([I[[BB[I[B[[BII)I", line = 60)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BZII)Lri;", line = 118)
