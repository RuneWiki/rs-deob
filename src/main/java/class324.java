...
public class class324 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[BZIIIII[B)V", line = 177)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II)V", line = 303)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(III)B", line = 315)
