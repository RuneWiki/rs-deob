...
public class class324 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(III)Z", line = 12)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "([BIBI)Ljava/lang/String;", line = 39)
