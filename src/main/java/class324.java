...
public class class324 extends class573 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ZB)I", line = 10)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IBI)V", line = 52)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(IIIIIFFF)V", line = 81)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BII)V", line = 136)
