...
public class class324 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IB)I", line = 9)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lqq;III)V", line = 44)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILha;)V", line = 501)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)Z", line = 522)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)Ljava/lang/String;", line = 546)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;II)V", line = 571)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)V", line = 629)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 651)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 680)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(I)V", line = 819)
