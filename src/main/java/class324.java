...
public class class324 extends class64 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "()Lle;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "([IIILfa;II)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILfa;B)V")
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "()Lle;")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Ls;)V")
