...
public class class324 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "()V", line = 28)
    public class324() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(III)V", line = 31)
    private class324(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ldh;I[B)V", line = 44)
