...
public class class324 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)Lbh;", line = 17)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIZLiw;Liw;)I", line = 79)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lrf;ILpl;)V", line = 213)
