...
public class class324 extends class439 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)J", line = 38)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IJ)I", line = 48)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)J", line = 93)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "()V", line = 115)
    public class324() {
