...
public abstract class class324 extends class107 {
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(ILmea;ILha;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IBII)I", line = 321)
    ...
    @OriginalMember(owner = "client!dja", name = "<init>", descriptor = "(I)V", line = 335)
