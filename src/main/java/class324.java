...
public class class324 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!du", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field4785++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Ljr;B)Lks;", line = 28)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 89)
