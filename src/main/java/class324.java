...
public class class324 extends class649 {
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(ILhs;)V", line = 4)
    public class324(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IB)V", line = 46)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!as", name = "e", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lhs;)V", line = 107)
