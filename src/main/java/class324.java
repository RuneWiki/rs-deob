...
public class class324 extends class436 {
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbp;Ljava/lang/Object;)V")
    public class324(class46 arg0, Object arg1) {
        super(arg0);
        this.field4654 = arg1;
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lnr;[[BILgm;[[B[[BIBLgm;[[IZI[[B)V")
    ...
    @OriginalMember(owner = "client!bm", name = "h", descriptor = "(I)Lkn;")
