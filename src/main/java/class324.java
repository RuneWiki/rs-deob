...
public class class324 extends class35 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLec;)Ldb;", line = 6)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IILja;BIIIIII[[[BII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIILim;Lim;)V", line = 68)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BZIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIIIIIILja;ILrc;)Lrc;", line = 118)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(I)V", line = 167)
