...
public class class324 extends class175 implements class560 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lqq;I)V")
    public final void method379(class599 arg0, int arg1) {
        super.method379(arg0, arg1);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lnca;Ljt;III[B)V")
