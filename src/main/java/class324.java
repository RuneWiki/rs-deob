...
public class class324 extends class225 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ZLiaa;)V")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!bga", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lpe;)V")
