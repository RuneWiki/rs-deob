...
public class class324 extends class159 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(III[I)V", line = 33)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIB)Z", line = 51)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BII)Z", line = 67)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BIII)Z", line = 104)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(IIIIIIIII)V", line = 119)
