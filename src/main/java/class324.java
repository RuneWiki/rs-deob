...
public class class324 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "()V", line = 4)
    public static void method1916() {
        field4436 = null;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lol;)B", line = 8)
    private static final byte method1917(class195 arg0) {
        return (byte) method1921(8, arg0);
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Lol;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "([I[I[I[BIII)V", line = 171)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(Lol;)B", line = 242)
    private static final byte method1920(class195 arg0) {
        return (byte) method1921(1, arg0);
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILol;)I", line = 253)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(Lol;)V", line = 279)
    ...
    @OriginalMember(owner = "client!ss", name = "e", descriptor = "(Lol;)V", line = 789)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "([BI[BII)I", line = 806)
