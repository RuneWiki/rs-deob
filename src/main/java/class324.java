...
public class class324 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)Loa;", line = 66)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IB)V", line = 90)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLjg;I)V", line = 114)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLe;Z)Lgl;", line = 245)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ljg;I)V", line = 354)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLe;)Lgl;", line = 401)
