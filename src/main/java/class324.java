...
public class class324 extends class130 implements class334 {
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lef;ILjaggl/memory/NativeBuffer;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ldn;B)Z")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lef;I[BI)V")
    public class324(class338 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4407 = arg1;
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIILco;ZII)V")
