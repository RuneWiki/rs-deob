...
public class class324 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)V", line = 171)
