...
public class class324 extends class456 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ltq;Lhm;IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ag", name = "h", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(III)I", line = 161)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(III)I", line = 178)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(IIIII)I", line = 204)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lre;I)Lcm;", line = 221)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(II)[I", line = 234)
    ...
    @OriginalMember(owner = "client!ag", name = "i", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "()V", line = 290)
    public class324() {
        super(0, true);
    }
}
