...
public class class324 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(FFFZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I[II[II)V", line = 75)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIIBI)V", line = 132)
