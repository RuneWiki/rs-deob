...
public class class324 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V")
