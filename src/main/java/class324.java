...
public class class324 extends class435 {
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "([B)V", line = 10)
    public class324(byte[] arg0) {
        this.field4303 = arg0;
    }

    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!qg", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIBIII)V", line = 43)
