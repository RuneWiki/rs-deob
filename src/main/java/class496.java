...
public class class496 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FIFIF)F", line = 6)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IB)Lgi;", line = 19)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILfm;)V", line = 80)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 456)
