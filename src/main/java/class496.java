...
public class class496 implements class214 {
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(II)Lfv;", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(II)Lkd;", line = 31)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IB)V", line = 45)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 58)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(FZIBII)[I", line = 90)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIZIF)[I", line = 103)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)Z", line = 114)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIFIZZ)[F", line = 128)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BII)Z", line = 155)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lri;Lri;Lri;)V", line = 170)
