...
public class class496 extends class642 {
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 166)
    public class496() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)[[I", line = 64)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILgk;B)V", line = 180)
