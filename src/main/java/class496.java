...
public class class496 extends class136 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ed", name = "f", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IILiv;)V", line = 126)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "()V", line = 164)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IB)V", line = 319)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BI)[[I", line = 574)
    ...
    @OriginalMember(owner = "client!ed", name = "g", descriptor = "(I)V", line = 626)
