...
public class class496 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lqa;Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)I", line = 87)
