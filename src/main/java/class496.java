...
public class class496 extends class555 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILjava/lang/String;)V", line = 13)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lqi;Lga;)V", line = 157)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lot;BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!ru", name = "f", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IBII)I", line = 106)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZI)V", line = 134)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(I)Z", line = 144)
    ...
    @OriginalMember(owner = "client!ru", name = "d", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 213)
