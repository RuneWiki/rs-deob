...
public class class496 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILjaa;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(ILjaa;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljaa;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljaa;BLig;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljaa;II)V")
