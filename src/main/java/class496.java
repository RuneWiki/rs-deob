...
public abstract class class496 implements class372 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(FFIILaa;II)V")
