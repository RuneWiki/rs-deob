...
public class class496 extends class115 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)Z", line = 48)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(II)V", line = 80)
