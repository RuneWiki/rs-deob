...
public class class496 extends class78 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IBLjava/awt/Graphics;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 39)
