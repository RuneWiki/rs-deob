...
public class class496 extends class180 implements class55 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILvh;)I")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILco;ILqa;ZZ)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lqa;Lpk;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lqa;I)Lip;")
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lqa;III)Z")
