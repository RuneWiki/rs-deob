...
public class class496 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lwh;I)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lwh;B)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IBLwh;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(BLwh;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lof;IILwh;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILwh;I)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILjava/net/Socket;I)Lbba;")
