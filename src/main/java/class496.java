...
public class class496 extends class366 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILgo;B)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IILtn;I)V")
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lqg;Lpe;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BLti;)V")
