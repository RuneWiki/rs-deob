...
public class class496 {
    ...
    @OriginalMember(owner = "client!jd", name = "d", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IBI)V", line = 24)
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!jd", name = "f", descriptor = "(I)V", line = 50)
