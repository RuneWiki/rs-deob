...
public class class496 extends class397 {
    ...
    @OriginalMember(owner = "client!pt", name = "S", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pt", name = "la", descriptor = "(Lq;)V", line = 27)
    ...
    @OriginalMember(owner = "client!pt", name = "G", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!pt", name = "R", descriptor = "(III[I)V", line = 50)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(III[I)V", line = 55)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!pt", name = "Y", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!pt", name = "O", descriptor = "([I)V", line = 83)
    ...
    @OriginalMember(owner = "client!pt", name = "GA", descriptor = "(III)V", line = 94)
    ...
    @OriginalMember(owner = "client!pt", name = "ra", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!pt", name = "XA", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!pt", name = "pa", descriptor = "(IIIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "()V", line = 145)
    public class496() {
        this.method580();
    }

    @OriginalMember(owner = "client!pt", name = "a", descriptor = "()Lq;", line = 150)
    ...
    @OriginalMember(owner = "client!pt", name = "P", descriptor = "(I)V", line = 167)
