...
public class class496 implements class339 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(IIIIIIZZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIIIIZZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lrea;Loia;Ltba;)V", line = 69)
