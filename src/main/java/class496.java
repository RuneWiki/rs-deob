...
public class class496 extends class101 implements class313 {
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I[B)[B", line = 30)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(Z)I", line = 88)
    ...
    @OriginalMember(owner = "client!qe", name = "d", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)I", line = 118)
    ...
    @OriginalMember(owner = "client!qe", name = "e", descriptor = "(I)[Ljw;", line = 131)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)C", line = 142)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)I", line = 154)
