...
public class class496 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IZZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)V", line = 62)
