...
public class class496 {
   ...
   private Robot field6814 = new Robot();
   @OriginalMember(
      owner = "client!cq",
      name = "b",
      descriptor = "Ljava/awt/Component;"
   )
   private Component field6815;
   ...
   public final void movemouse(int arg0, int arg1) {
      this.field6814.mouseMove(arg0, arg1);
   }
   ...
   public class496() throws Exception {
   }
   ...
   public final void showcursor(Component arg0, boolean arg1) {
      ...
      if (this.field6815 != arg0) {
         if (this.field6815 != null) {
            this.field6815.setCursor((Cursor)null);
            this.field6815 = null;
         }
