...
public class class496 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)Lca;", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILtn;)V", line = 22)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ltn;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BLew;)I", line = 125)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(B)V", line = 168)
