...
public abstract class class496 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(III)B", line = 31)
    ...
    @OriginalMember(owner = "client!ql", name = "f", descriptor = "(I)[Lba;", line = 50)
