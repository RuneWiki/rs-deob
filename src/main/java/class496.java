...
public class class496 {
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(II)V", line = 10)
    public class496(int arg0, int arg1) {
        this.field6750 = arg0;
    }

    @OriginalMember(owner = "client!ts", name = "toString", descriptor = "()Ljava/lang/String;", line = 26)
    public final String toString() {
        field6753++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 35)
