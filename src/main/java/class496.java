...
public class class496 extends class305 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(ZII)V", line = 112)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(II)V", line = 126)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 380)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILfh;B)V", line = 394)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "()V", line = 433)
    public class496() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 437)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(B)V", line = 512)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IB)[[I", line = 527)
