...
public class class496 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)Lld;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lco;B)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ZIZI[Loh;I)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)Lld;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIZIZ)Lgp;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lco;BI)V")
