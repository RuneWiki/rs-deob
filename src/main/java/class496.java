...
public class class496 extends class243 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLsl;)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ld;IZI)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILne;)V")
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(ILne;)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLne;)V")
