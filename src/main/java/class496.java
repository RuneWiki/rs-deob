...
public class class496 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Lpu;B)V")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(BLdm;Lha;II)V")
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(Lud;)V")
