...
public class class496 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILig;)Lgo;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILha;IILtp;IIILaa;)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lnv;II)V")
