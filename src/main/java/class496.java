...
public class class496 extends class46 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 22)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field7330;
    }

    @OriginalMember(owner = "client!ed", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 37)
    public final void startProduction(ImageConsumer arg0) {
        ++field7317;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIBI)V", line = 45)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!ed", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 72)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field7326;
        return this.field7324 == arg0;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 80)
    ...
    @OriginalMember(owner = "client!ed", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 97)
    ...
    @OriginalMember(owner = "client!ed", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 113)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 126)
