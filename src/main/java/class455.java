...
public class class455 extends class275 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(III)Lel;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)Ltb;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BII)Z")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(ILsd;Lsd;Lrs;Lwb;I[BIZ)V")
