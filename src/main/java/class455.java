...
public class class455 implements class653 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)Lrw;", line = 14)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ZII)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(ILut;Lgi;II)V", line = 67)
