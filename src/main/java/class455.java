...
public class class455 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Loa;IILq;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZBLjava/awt/Component;)Lds;")
