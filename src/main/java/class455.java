...
public class class455 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)Lpc;", line = 37)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lms;ILwu;)V", line = 100)
