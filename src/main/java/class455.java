...
public class class455 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BLjava/awt/Component;)Ltda;", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ljm;I)V", line = 29)
