...
public class class455 extends class34 {
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 3)
    public class455() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IILjava/lang/String;)V", line = 11)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZI)I", line = 88)
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IB)[I", line = 118)
