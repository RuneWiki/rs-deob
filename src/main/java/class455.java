...
public class class455 extends class106 {
    ...
    @OriginalMember(owner = "client!it", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIII[FII)V", line = 103)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZLqa;)V", line = 198)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IILih;)V", line = 397)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IBI)V", line = 410)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lvj;)V", line = 430)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 546)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)Z", line = 580)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZI)V", line = 596)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZB)V", line = 627)
    ...
    @OriginalMember(owner = "client!it", name = "g", descriptor = "(I)V", line = 639)
