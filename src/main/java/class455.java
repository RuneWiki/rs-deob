...
public class class455 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILee;)V", line = 6)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILha;)Loia;", line = 3260)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(B)V", line = 3294)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZLee;I)V", line = 3316)
