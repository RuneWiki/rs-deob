...
public class class455 extends class141 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lad;IZLjava/lang/String;)Ljm;", line = 276)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Z)Z", line = 302)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZI)V", line = 313)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(B)I", line = 331)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(B)Z", line = 345)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(III)Z", line = 355)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 372)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZILcs;Lcs;)V", line = 396)
    ...
    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(B)V", line = 548)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)Z", line = 585)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lad;)V", line = 621)
