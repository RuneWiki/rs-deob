...
public class class455 extends class715 {
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(I)Lifa;", line = 7)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(Ldw;IIIIII)V", line = 105)
