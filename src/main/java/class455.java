...
public class class455 implements class342 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 45)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)I", line = 72)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 106)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Lde;Z)V", line = 142)
    public class455(class15 arg0, boolean arg1) {
        this.field6576 = arg0;
        this.field6578 = arg1;
    }

    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 127)
