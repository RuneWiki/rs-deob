...
public class class455 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "()V", line = 8)
    public static final void method2768() {
        class129.method875(1, class141.field1892);
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 163)
