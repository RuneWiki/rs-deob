...
public class class455 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lqa;IZLjava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lqa;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lqa;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lqa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
