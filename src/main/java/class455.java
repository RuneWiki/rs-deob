...
public class class455 extends class336 implements class438 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ILfp;)Luq;", line = 5)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lfp;II)Lbi;", line = 42)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lfp;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(ILfp;)V", line = 77)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([BI)[B", line = 93)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)I", line = 120)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lfp;Lje;ZIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lfp;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Z)Z", line = 167)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lfp;Lgn;IIIIIIIZIIIII)V", line = 182)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(B)Z", line = 192)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(I)I", line = 204)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IIILcl;)V", line = 217)
    ...
    @OriginalMember(owner = "client!rf", name = "e", descriptor = "(B)I", line = 223)
    public final int method268(byte arg0) {
        ++field6709;
        return arg0 >= -101 ? 109 : this.field6722.method2728(25997);
    }

    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!rf", name = "h", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lfp;III)Z", line = 284)
