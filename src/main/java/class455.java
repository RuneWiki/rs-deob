...
public class class455 extends class126 {
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILml;ILml;)V", line = 83)
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Z)Z", line = 251)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)Z", line = 270)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lef;)V", line = 307)
    public class455(class338 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!it", name = "d", descriptor = "(I)Z", line = 313)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)V", line = 323)
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "(B)I", line = 401)
