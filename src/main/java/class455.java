...
public class class455 implements Runnable {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!de", name = "run", descriptor = "()V", line = 61)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Z)I", line = 133)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III[B)V", line = 170)
    ...
    @OriginalMember(owner = "client!de", name = "c", descriptor = "(B)V", line = 225)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IBI)V", line = 255)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I[BII)V", line = 269)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Ljava/net/Socket;Llp;)V", line = 321)
    ...
    @OriginalMember(owner = "client!de", name = "finalize", descriptor = "()V", line = 307)
    protected final void finalize() {
        this.method2761((byte) 51);
        field6424++;
    }

    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Z)V", line = 334)
