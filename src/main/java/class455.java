...
public class class455 extends class107 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lha;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IIII)I", line = 30)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "([B)V", line = 81)
