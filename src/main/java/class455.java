...
public abstract class class455 extends class250 {
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIZI)I", line = 30)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BII)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIILbp;IZLeq;)V", line = 91)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(IIIIIII)V", line = 105)
