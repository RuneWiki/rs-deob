...
public class class455 extends class391 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILsd;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BLge;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZLsd;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZLna;FII)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lsd;B)V")
