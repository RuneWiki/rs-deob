...
public class class455 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLqq;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I[IBII)V", line = 77)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BIIIIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IB)Lrga;", line = 160)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(ILbt;Lbt;)V", line = 206)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILtf;ILaa;BIILkq;)V", line = 230)
