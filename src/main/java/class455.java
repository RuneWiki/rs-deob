...
public class class455 extends class501 {
    ...
    @OriginalMember(owner = "client!mw", name = "h", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!mw", name = "i", descriptor = "(Z)Z", line = 24)
    ...
    @OriginalMember(owner = "client!mw", name = "m", descriptor = "(II)V", line = 45)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BLni;)V", line = 59)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(I)V", line = 75)
    public class455(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mw", name = "n", descriptor = "(II)I", line = 78)
    ...
    @OriginalMember(owner = "client!mw", name = "q", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(BI)I", line = 113)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ILls;III)V", line = 142)
    ...
    @OriginalMember(owner = "client!mw", name = "j", descriptor = "(Z)V", line = 310)
    ...
    @OriginalMember(owner = "client!mw", name = "r", descriptor = "(I)V", line = 327)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(B[I)V", line = 338)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(II[BZ)V", line = 349)
