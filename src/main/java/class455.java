...
public class class455 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lbs;I)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lme;II)Z")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIIIIIZ[Lsca;II)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lgda;BLgda;)V")
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lwh;)V")
