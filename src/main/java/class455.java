...
public class class455 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(JI)Lgk;", line = 30)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILgk;J)V", line = 62)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)Lgk;", line = 89)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(I)V", line = 124)
