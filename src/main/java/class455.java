...
public class class455 extends class35 implements class295 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BLei;)V", line = 5)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lom;IZ[[I)V", line = 56)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILofa;B)V", line = 91)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(II)Z", line = 111)
