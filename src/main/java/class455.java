...
public class class455 implements class416 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(III)V", line = 102)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BI)I", line = 130)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZI)I", line = 151)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IZI)Ljh;", line = 206)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IBI)V", line = 219)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)I", line = 255)
