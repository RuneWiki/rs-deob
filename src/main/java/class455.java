...
public class class455 extends class281 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/awt/Graphics;IBIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/awt/Graphics;BII)V", line = 51)
