...
public class class455 extends class184 {
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(II)[[I", line = 19)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "()V", line = 66)
    public class455() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ck", name = "e", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II)[I", line = 95)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BILfh;)V", line = 128)
