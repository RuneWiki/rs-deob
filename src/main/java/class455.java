...
public class class455 extends class91 {
    ...
    @OriginalMember(owner = "client!rp", name = "e", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IF)V", line = 22)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILps;Lbo;Lwk;Lqa;IBI)V", line = 39)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(I)V", line = 79)
    public class455(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ltq;BIIIIILc;IIIILqa;ZI)Lc;", line = 89)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILjava/util/Random;I)I", line = 302)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(IF)V", line = 333)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIBLjava/lang/String;)V", line = 350)
