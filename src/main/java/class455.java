...
public class class455 extends class101 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "()Lka;")
    public final class400 method2650() {
        return this.field6274;
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([Lfr;Z)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)Lts;")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqa;[Ldl;Z)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqa;J)Z")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqa;J[Ldl;[Lfr;Z)V")
