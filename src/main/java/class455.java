...
public class class455 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IB[II)Laaa;", line = 6)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[III)Laaa;", line = 49)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[II)Laaa;", line = 107)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BI[I)Laaa;", line = 128)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIZLfw;I)Z", line = 156)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lwu;Lwu;)V", line = 303)
