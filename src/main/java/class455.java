...
public class class455 extends class344 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lvf;Lpia;)V", line = 19)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(BII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Lgb;II)V", line = 69)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Z)Z", line = 148)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(BZ)V", line = 185)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(B)V", line = 195)
