...
public class class455 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I)Lev;", line = 12)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)Lev;", line = 36)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILev;)V", line = 78)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lev;Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lam;B)V", line = 113)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)Lev;", line = 124)
    ...
    @OriginalMember(owner = "client!am", name = "d", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)Lev;", line = 157)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIFIIIZI)[I", line = 176)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IB)V", line = 203)
    ...
    @OriginalMember(owner = "client!am", name = "e", descriptor = "(I)I", line = 224)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(B)V", line = 244)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "()V", line = 270)
    public class455() {
        this.field6378.field7056 = this.field6378;
        this.field6378.field7055 = this.field6378;
    }

    @OriginalMember(owner = "client!am", name = "f", descriptor = "(I)Lev;", line = 282)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILam;Lev;)V", line = 303)
