...
public class class50 implements class15 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lmu;IZII)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lho;II)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ILgba;Z)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lmu;III)V")
    public final void method342(class314 arg0, int arg1, int arg2, int arg3) {
        field717++;
        this.method335(arg0, arg1, false, arg3, arg2);
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IILho;I)V")
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lkv;)V")
