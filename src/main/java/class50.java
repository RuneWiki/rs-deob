...
public class class50 extends class124 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lmo;ILmo;)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILe;I)Z")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILe;IIZLhm;I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ltb;I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIILe;)Z")
    ...
    @OriginalMember(owner = "client!sd", name = "n", descriptor = "(I)Lok;")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Le;Z)Lum;")
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(Le;B)V")
