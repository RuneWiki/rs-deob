...
public class class50 extends class454 implements class752 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()V", line = 39)
    public final void method62() {
        this.method95(this.field747.field827);
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 47)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 58)
    public final void method163(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Z", line = 63)
    public final boolean method88() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()V", line = 65)
    public final void method142() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcd;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 79)
    public final boolean method107() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 97)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 106)
    public final void method82(int arg0) {
        this.field749[arg0].method3539();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 109)
    public final void method112(int arg0) {
        this.field749[arg0].method3557();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpea;Lst;)Lmk;", line = 114)
    public final class344 method154(class594 arg0, class675 arg1) {
        return new class342(this, (class319) arg0, (class544) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 118)
    public final boolean method57() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmk;)V", line = 122)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 133)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltba;[Lbe;Z)Lda;", line = 145)
    ...
    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 185)
    public final boolean method73() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()Z", line = 192)
    public final boolean method123() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 195)
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Z", line = 219)
    public final boolean method149() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Z", line = 224)
    public final boolean method113() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 227)
    public final void method145(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)I", line = 230)
    public final int method100(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(Z)V", line = 233)
    public final void method169(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcd;)V", line = 236)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbe;Z)Lac;", line = 244)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lst;", line = 249)
    public final class675 method148(int arg0, int arg1) {
        return new class544(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)V", line = 254)
    public final void method68(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lac;", line = 257)
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()I", line = 261)
    public final int method115() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltj;Ltj;FLtj;)Ltj;", line = 268)
    public final class662 method119(class662 arg0, class662 arg1, float arg2, class662 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 271)
    public final void method96(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwc;)V", line = 274)
    public final void method77(class376 arg0) {
        this.field734 = arg0;
        this.method409(((class640) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 278)
    private final Object method415() {
        return new class119(this);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lpk;)V", line = 284)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)Lza;", line = 303)
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()V", line = 310)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 341)
    public final void method133(class702 arg0) {
        this.field730 = (class305) arg0;
        this.method405(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()Lwc;", line = 345)
    public final class376 method94() {
        return this.field734;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 349)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltj;)V", line = 371)
    public final void method170(class662 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()V", line = 373)
    public final void method172() {
    }

    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 376)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 381)
    ...
    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Z", line = 385)
    public final boolean method176() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 389)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Lpea;", line = 404)
    public final class594 method174(int arg0, int arg1) {
        return this.method70(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 407)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()V", line = 413)
    public final void method175() {
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 416)
    public final boolean method171() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 419)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Ltj;", line = 430)
    public final class662 method137(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 433)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 447)
    ...
    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Z", line = 457)
    public final boolean method91() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 461)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcd;Z)V", line = 476)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)V", line = 506)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()V", line = 508)
    public final void method116() {
    }

    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 519)
    public final boolean method86() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lid;IIII)Lka;", line = 522)
    ...
    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Lwc;", line = 527)
    public final class376 method114() {
        return this.field740;
    }

    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 530)
    public final boolean method152() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)V", line = 534)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 541)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 548)
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 551)
    public final boolean method66() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()V", line = 553)
    public final void method93() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 556)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 559)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lac;", line = 562)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)V", line = 571)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lac;", line = 582)
    public final class712 method70(int arg0, int arg1, boolean arg2) {
        return new class319(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Lwc;", line = 594)
    public final class376 method125() {
        return new class640();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lpk;", line = 598)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 611)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 619)
    public final void method65(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Loj;", line = 631)
