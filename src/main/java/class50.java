...
public class class50 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ILsba;)Lsba;")
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BI)Lkc;")
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lni;Lfl;I)V")
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lrga;ILni;)V")
