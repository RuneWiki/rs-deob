...
public class class50 {
    ...
    @OriginalMember(owner = "client!REROLFNU", name = "e", descriptor = "LDNRIFKTO;")
    ...
    @OriginalMember(owner = "client!REROLFNU", name = "a", descriptor = "(BILDNRIFKTO;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!REROLFNU", name = "a", descriptor = "(Ljava/lang/String;ZLDNRIFKTO;)V")
