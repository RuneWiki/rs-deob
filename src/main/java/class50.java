...
public class class50 extends class444 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(III)[B", line = 9)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B[B)V", line = 19)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)[B", line = 32)
