...
public class class50 extends class432 {
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lts;Ljava/lang/Object;I)V", line = 15)
    public class50(class23 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field734 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!kt", name = "f", descriptor = "(I)Z", line = 24)
