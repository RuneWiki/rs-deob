...
public class class50 {
    ...
    @OriginalMember(owner = "client!NVLIPBUR", name = "e", descriptor = "[LNVLIPBUR;")
    public static class50[] field1267;

    @OriginalMember(owner = "client!NVLIPBUR", name = "a", descriptor = "(ZLMJLXHQTQ;)V")
    ...
    @OriginalMember(owner = "client!NVLIPBUR", name = "a", descriptor = "(ZLXGRGMPUQ;)V")
