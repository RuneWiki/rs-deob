...
public class class50 extends class499 {
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IBLuu;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IFIIFIFFII[F)V", line = 35)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III[BII)Z", line = 130)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 249)
