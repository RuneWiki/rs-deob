...
public class class50 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Ljava/lang/String;IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIIIZ)I", line = 152)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I)V", line = 175)
