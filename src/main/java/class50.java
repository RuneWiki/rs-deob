...
@OriginalClass("client!RRWCTNMK")
public class class50 {

    @OriginalMember(owner = "client!RRWCTNMK", name = "a", descriptor = "I")
    private int field1313;

    @OriginalMember(owner = "client!RRWCTNMK", name = "b", descriptor = "I")
    private int field1314;

    @OriginalMember(owner = "client!RRWCTNMK", name = "e", descriptor = "I")
    public int field1317;

    @OriginalMember(owner = "client!RRWCTNMK", name = "f", descriptor = "I")
    public int field1318;

    @OriginalMember(owner = "client!RRWCTNMK", name = "g", descriptor = "I")
    public int field1319;

    @OriginalMember(owner = "client!RRWCTNMK", name = "h", descriptor = "I")
    private int field1320;

    @OriginalMember(owner = "client!RRWCTNMK", name = "i", descriptor = "I")
    private int field1321;

    @OriginalMember(owner = "client!RRWCTNMK", name = "j", descriptor = "I")
    private int field1322;

    @OriginalMember(owner = "client!RRWCTNMK", name = "k", descriptor = "I")
    private int field1323;

    @OriginalMember(owner = "client!RRWCTNMK", name = "l", descriptor = "I")
    private int field1324;

    @OriginalMember(owner = "client!RRWCTNMK", name = "m", descriptor = "I")
    public static int field1325;

    @OriginalMember(owner = "client!RRWCTNMK", name = "c", descriptor = "[I")
    private int[] field1315;

    @OriginalMember(owner = "client!RRWCTNMK", name = "d", descriptor = "[I")
    private int[] field1316;

    @OriginalMember(owner = "client!RRWCTNMK", name = "a", descriptor = "(LEILHLJCE;B)V")
    ...
    @OriginalMember(owner = "client!RRWCTNMK", name = "a", descriptor = "(LEILHLJCE;I)V")
    ...
    @OriginalMember(owner = "client!RRWCTNMK", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!RRWCTNMK", name = "a", descriptor = "(II)I")
