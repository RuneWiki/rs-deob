...
public class class50 extends class446 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(II[[I[[IIII)Lsa;", line = 46)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 145)
    ...
    @OriginalMember(owner = "client!fw", name = "F", descriptor = "()V", line = 174)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "([Lr;Lka;Lm;[Lcf;I)V", line = 218)
    ...
    @OriginalMember(owner = "client!fw", name = "k", descriptor = "()Z", line = 243)
    public final boolean method271() {
        ++field422;
        return false;
    }

    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "([Lr;Lm;[Lcf;I)V", line = 271)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V", line = 293)
    public class50(Canvas arg0, class17 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 297)
    ...
    @OriginalMember(owner = "client!fw", name = "f", descriptor = "(I)V", line = 338)
    public final void method275(int arg0) {
        super.field6153[arg0].method1470(true, (Runnable) null);
        ++field414;
    }

    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Ljava/lang/Runnable;)Lvc;", line = 349)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lei;IIII)Lr;", line = 371)
    ...
    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(I)V", line = 379)
