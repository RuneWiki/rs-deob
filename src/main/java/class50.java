...
public class class50 extends class725 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lno;Lfc;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "()Lco;")
    public final class725 method357() {
        return (class725) this.field741.method3619(0);
    }

    @OriginalMember(owner = "client!gh", name = "b", descriptor = "()Lco;")
    public final class725 method358() {
        return (class725) this.field741.method3618(-104);
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lco;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(Lco;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lfc;)V")
