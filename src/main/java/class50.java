...
@OriginalClass("client!SXQCXZWK")
public class class50 {

    @OriginalMember(owner = "client!SXQCXZWK", name = "g", descriptor = "Z")
    public boolean field1305 = false;

    @OriginalMember(owner = "client!SXQCXZWK", name = "h", descriptor = "I")
    public int field1306 = -1;

    @OriginalMember(owner = "client!SXQCXZWK", name = "a", descriptor = "I")
    public static int field1299;

    @OriginalMember(owner = "client!SXQCXZWK", name = "d", descriptor = "I")
    public int field1302;

    @OriginalMember(owner = "client!SXQCXZWK", name = "e", descriptor = "I")
    public int field1303;

    @OriginalMember(owner = "client!SXQCXZWK", name = "f", descriptor = "I")
    public int field1304;

    @OriginalMember(owner = "client!SXQCXZWK", name = "i", descriptor = "I")
    public int field1307;

    @OriginalMember(owner = "client!SXQCXZWK", name = "c", descriptor = "Ljava/lang/String;")
    public String field1301;

    @OriginalMember(owner = "client!SXQCXZWK", name = "b", descriptor = "[LSXQCXZWK;")
    public static class50[] field1300;

    @OriginalMember(owner = "client!SXQCXZWK", name = "a", descriptor = "(LOTSGNSQM;Z)V")
    ...
    @OriginalMember(owner = "client!SXQCXZWK", name = "a", descriptor = "(BLYOXDZEVD;I)V")
