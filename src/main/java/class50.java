...
public class class50 extends class42 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIZIZ)I", line = 14)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILiu;)V", line = 61)
