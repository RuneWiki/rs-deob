...
public class class50 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZIIIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(III)V", line = 57)
