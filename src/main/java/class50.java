...
public class class50 implements class682 {
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(IZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BI)V", line = 73)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(III)Z", line = 91)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 117)
    public final void method449(int arg0) {
        int var2 = 56 % ((65 - arg0) / 45);
        field696++;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)I", line = 127)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIIII)V", line = 161)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILut;II)J", line = 187)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lrk;)V", line = 228)
