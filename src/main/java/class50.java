...
public class class50 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BILmc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BIILwm;)Lsu;", line = 32)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILha;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lwm;Lwm;Lwm;Lwm;B)V", line = 138)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZLwm;IIJII)V", line = 155)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lmc;B)V", line = 166)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BLjf;)I", line = 188)
