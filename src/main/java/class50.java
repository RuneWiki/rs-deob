...
public class class50 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLub;)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)Lnd;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)Lpp;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)Lnd;")
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lub;)V")
