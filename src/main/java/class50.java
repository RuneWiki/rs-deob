...
public class class50 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILjava/io/File;)[B", line = 8)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IILmk;III)V", line = 21)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)Llt;", line = 217)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)I", line = 236)
    public static int method268(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lio;I)Lob;", line = 247)
