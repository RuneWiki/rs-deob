...
public abstract class class50 implements class402 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IBI[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLtn;)V", line = 111)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILct;)I", line = 128)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II[BZI)V", line = 154)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)I", line = 253)
    ...
    @OriginalMember(owner = "client!mm", name = "e", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIII[F)V", line = 359)
    ...
    @OriginalMember(owner = "client!mm", name = "f", descriptor = "(I)I", line = 459)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lad;ILjb;Lqda;IZ)V", line = 599)
    ...
    @OriginalMember(owner = "client!mm", name = "g", descriptor = "(I)V", line = 477)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 499)
    ...
    @OriginalMember(owner = "client!mm", name = "finalize", descriptor = "()V", line = 518)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(B)V", line = 527)
    ...
    @OriginalMember(owner = "client!mm", name = "h", descriptor = "(I)V", line = 549)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 562)
