...
public abstract class class50 extends class421 {
    ...
    @OriginalMember(owner = "client!qh", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(JI)V", line = 20)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IBI)I", line = 44)
    ...
    @OriginalMember(owner = "client!qh", name = "i", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(IIII)V", line = 526)
