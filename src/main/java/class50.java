...
public class class50 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(II)Lri;", line = 23)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I[SZ)[S", line = 59)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(III)V", line = 79)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lkr;ILpu;)V", line = 186)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IILjava/awt/Component;ILft;)Ljp;", line = 96)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(B)V", line = 177)
