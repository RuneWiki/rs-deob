...
public class class50 extends class125 {
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(ILgp;)V", line = 6)
    public class50(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BI)V", line = 10)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)I", line = 21)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Lgp;)V", line = 31)
    public class50(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZI)I", line = 47)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(Z)V", line = 127)
