...
public class class50 implements Runnable {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(BIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(BI)Lcv;", line = 81)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IILcn;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!sca", name = "run", descriptor = "()V", line = 125)
