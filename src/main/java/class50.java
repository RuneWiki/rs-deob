...
@OriginalClass("client!TGFFTNFO")
public class class50 {

    @OriginalMember(owner = "client!TGFFTNFO", name = "b", descriptor = "I")
    private int field1443 = 511;

    @OriginalMember(owner = "client!TGFFTNFO", name = "c", descriptor = "Z")
    private boolean field1444 = true;

    @OriginalMember(owner = "client!TGFFTNFO", name = "h", descriptor = "I")
    public int field1449 = 65000;

    @OriginalMember(owner = "client!TGFFTNFO", name = "g", descriptor = "I")
    public int field1448;

    @OriginalMember(owner = "client!TGFFTNFO", name = "e", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1446;

    @OriginalMember(owner = "client!TGFFTNFO", name = "f", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1447;

    @OriginalMember(owner = "client!TGFFTNFO", name = "d", descriptor = "[B")
    public static byte[] field1445 = new byte[520];

    @OriginalMember(owner = "client!TGFFTNFO", name = "a", descriptor = "I")
    private int field1442;

    @OriginalMember(owner = "client!TGFFTNFO", name = "<init>", descriptor = "(IILjava/io/RandomAccessFile;ILjava/io/RandomAccessFile;)V")
    ...
    @OriginalMember(owner = "client!TGFFTNFO", name = "a", descriptor = "(IB)[B")
    ...
    @OriginalMember(owner = "client!TGFFTNFO", name = "a", descriptor = "(I[BII)Z")
    ...
    @OriginalMember(owner = "client!TGFFTNFO", name = "a", descriptor = "(IIZ[BI)Z")
    ...
    @OriginalMember(owner = "client!TGFFTNFO", name = "a", descriptor = "(Ljava/io/RandomAccessFile;II)V")
