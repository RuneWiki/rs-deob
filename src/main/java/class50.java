...
public class class50 extends class73 implements class438 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BILqa;)Lr;", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqa;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILqa;IB)Z", line = 25)
    public final boolean method164(int arg0, class167 arg1, int arg2, byte arg3) {
        field594++;
        return arg3 != 77;
    }

    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!ak", name = "f", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Ljava/lang/String;JIZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(IIIIILvf;)V", line = 147)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqa;B)V", line = 161)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)I", line = 191)
    public final int method171(boolean arg0) {
        field586++;
        return arg0 ? 0 : -103;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILqa;)Llb;", line = 203)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLqa;)Led;", line = 226)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(Lqa;B)V", line = 238)
