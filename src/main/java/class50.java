...
public class class50 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(JLpe;I)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(JI)Lpe;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B[[[BILza;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(B)Lpe;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I[Lpe;)I")
    ...
    @OriginalMember(owner = "client!qh", name = "d", descriptor = "(B)Lpe;")
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(I)Lpe;")
