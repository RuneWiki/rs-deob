...
public class class50 extends class54 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lag;I)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IB)Z")
    ...
    @OriginalMember(owner = "client!qga", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lgga;B)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IIIIIII)J")
