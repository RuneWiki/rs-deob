...
public class class50 extends class147 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(JIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lvt;IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lfg;)V", line = 239)
    public class50(class21 arg0) {
        this.field640 = arg0;
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(III)Z", line = 83)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II[Lab;)V", line = 107)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(III)I", line = 180)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(Z)V", line = 247)
