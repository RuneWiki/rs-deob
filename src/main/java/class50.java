...
public class class50 extends class793 implements class339 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IIIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(III)Z", line = 80)
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lpc;ILjaclib/memory/Buffer;IZ)V", line = 104)
    public class50(class700 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field698 = arg1;
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(B)J", line = 113)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(III[B)V", line = 123)
    ...
    @OriginalMember(owner = "client!sca", name = "d", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)I", line = 151)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lpc;I[BIZ)V", line = 165)
    public class50(class700 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field698 = arg1;
    }

    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)I", line = 173)
    public final int method470(int arg0) {
        ++field699;
        return arg0 > -85 ? -13 : this.field698;
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(B[B)[B", line = 186)
