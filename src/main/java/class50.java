...
public class class50 extends class11 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B[[BLod;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(III)Z", line = 93)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lsi;II)V", line = 111)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLjava/awt/Canvas;)Ldj;", line = 203)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 727)
    public class50() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([[IIIIIILjava/util/Random;)V", line = 231)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(II)[I", line = 423)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Z)V", line = 678)
    ...
    @OriginalMember(owner = "client!sh", name = "f", descriptor = "(I)V", line = 704)
    ...
    @OriginalMember(owner = "client!sh", name = "g", descriptor = "(I)V", line = 730)
    ...
    @OriginalMember(owner = "client!sh", name = "h", descriptor = "(I)I", line = 765)
