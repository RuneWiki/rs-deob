...
public class class50 extends class484 {
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Loq;)V", line = 115)
    public class50(class326 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IZZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BZII)V", line = 146)
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 176)
