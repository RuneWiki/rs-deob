...
public class class50 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!in", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 12)
    ...
    @OriginalMember(owner = "client!in", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 69)
    ...
    @OriginalMember(owner = "client!in", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 81)
    public final void focusGained(FocusEvent arg0) {
        field578++;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!in", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 121)
    ...
    @OriginalMember(owner = "client!in", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 150)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)V", line = 181)
