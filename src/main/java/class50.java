...
public class class50 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(JII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 51)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IJLjava/lang/String;)V", line = 71)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(BI)V", line = 104)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)I", line = 148)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILjava/lang/String;J)V", line = 168)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(JII)Ljava/lang/String;", line = 209)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIII)Z", line = 229)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(IIIII)I", line = 285)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(II)Ljava/lang/Integer;", line = 314)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(II)V", line = 336)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 366)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(II)Ljava/lang/Long;", line = 379)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IBI)I", line = 400)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 426)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(BI)V", line = 475)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lol;)V", line = 866)
    public class50(class431 arg0) {
        this.method408((byte) 18, arg0);
    }

    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "()V", line = 874)
    private class50() {
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIBI)I", line = 534)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)Z", line = 548)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)V", line = 585)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIII)Ljava/lang/Integer;", line = 637)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BLol;)V", line = 663)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZ)V", line = 823)
