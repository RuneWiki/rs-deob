...
public class class50 {
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "e", descriptor = "LMXUYAYVV;")
    public class38 field1443 = new class38();

    @OriginalMember(owner = "client!RGZIHLRP", name = "f", descriptor = "LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "a", descriptor = "(LMXUYAYVV;)V")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "a", descriptor = "(ILMXUYAYVV;)V")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "a", descriptor = "()LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "b", descriptor = "()LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "a", descriptor = "(I)LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "a", descriptor = "(B)LMXUYAYVV;")
    ...
    @OriginalMember(owner = "client!RGZIHLRP", name = "b", descriptor = "(B)LMXUYAYVV;")
