...
public class class50 {
    ...
    @OriginalMember(owner = "client!PWXXEHUE", name = "h", descriptor = "[LQCXYCZNF;")
    private class53[] field1114 = new class53[10];

    @OriginalMember(owner = "client!PWXXEHUE", name = "d", descriptor = "[LPWXXEHUE;")
    ...
    @OriginalMember(owner = "client!PWXXEHUE", name = "g", descriptor = "LJHKSAGUC;")
    ...
    @OriginalMember(owner = "client!PWXXEHUE", name = "a", descriptor = "(ILJHKSAGUC;)V")
    ...
    @OriginalMember(owner = "client!PWXXEHUE", name = "a", descriptor = "(III)LJHKSAGUC;")
    ...
    @OriginalMember(owner = "client!PWXXEHUE", name = "a", descriptor = "(LJHKSAGUC;I)V")
    ...
    @OriginalMember(owner = "client!PWXXEHUE", name = "a", descriptor = "(II)LJHKSAGUC;")
