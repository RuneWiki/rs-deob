...
public class class50 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILdg;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)Lw;", line = 116)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)Lgo;", line = 195)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IILdg;)V", line = 216)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 237)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BIIIZIIZ)V", line = 256)
