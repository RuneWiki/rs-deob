...
public class class50 extends class682 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(IBI)Z", line = 31)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)Z", line = 137)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lnv;)V", line = 192)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IBI)V", line = 218)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZI)Z", line = 233)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ltha;II)V", line = 278)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(B)I", line = 316)
