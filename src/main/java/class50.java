...
public class class50 extends class430 implements class69 {
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lto;Los;III[B)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Ldca;B)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
