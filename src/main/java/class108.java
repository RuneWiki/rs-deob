...
public class class108 extends class175 {
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "()V", line = 165)
    public class108() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ZI)[I", line = 12)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ILdt;Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(FIFFI)F", line = 152)
