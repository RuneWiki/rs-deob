...
public class class108 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Leh;Z)Lvn;", line = 7)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIILwda;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 266)
