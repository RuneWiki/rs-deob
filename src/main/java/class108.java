...
public abstract class class108 extends class319 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(FFFFFF)V", line = 6)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "()I", line = 150)
    public final int method789() {
        return this.field1516 + this.field1493 + this.field1491;
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(FFFFFFIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "()I", line = 233)
    public final int method791() {
        return this.field1513 + this.field1501 + this.field1499;
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIIIIII)V", line = 250)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "()I", line = 309)
    public final int method796() {
        return this.field1493;
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIII)V", line = 312)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "()I", line = 318)
    public final int method798() {
        return this.field1501;
    }

    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lwb;II)V", line = 327)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(FFFFFFLus;II)V", line = 339)
