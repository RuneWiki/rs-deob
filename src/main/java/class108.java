...
public class class108 extends class330 {
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "()V", line = 4)
    public class108() {
        super(0, false);
    }

    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lgga;IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(II)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(B)I", line = 133)
    ...
    @OriginalMember(owner = "client!lca", name = "e", descriptor = "(B)V", line = 152)
