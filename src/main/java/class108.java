...
public class class108 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(B)V", line = 66)
