...
public class class108 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(ILrga;)Z", line = 30)
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIBII)Z", line = 77)
    ...
    @OriginalMember(owner = "client!kba", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!kba", name = "d", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIIIZ)V", line = 295)
    ...
    @OriginalMember(owner = "client!kba", name = "e", descriptor = "(I)Z", line = 319)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Lbi;)V", line = 581)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lrga;I)V", line = 336)
    ...
    @OriginalMember(owner = "client!kba", name = "f", descriptor = "(I)Z", line = 359)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IZIII)V", line = 494)
