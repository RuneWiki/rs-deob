...
public abstract class class108 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ju", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 35)
    public static final void provideLoaderApplet(Applet arg0) {
        class635.field9135 = arg0;
        field1286++;
    }

    @OriginalMember(owner = "client!ju", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 44)
    ...
    @OriginalMember(owner = "client!ju", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 59)
    public final void windowDeiconified(WindowEvent arg0) {
        field1291++;
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!ju", name = "start", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ju", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 131)
    public final void windowDeactivated(WindowEvent arg0) {
        field1303++;
    }

    @OriginalMember(owner = "client!ju", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 139)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field1287++;
    }

    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)V", line = 148)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ju", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 249)
    public final void windowOpened(WindowEvent arg0) {
        field1314++;
    }

    @OriginalMember(owner = "client!ju", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 257)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIILjava/lang/String;IB)V", line = 272)
    ...
    @OriginalMember(owner = "client!ju", name = "run", descriptor = "()V", line = 325)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 447)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(B)Ljava/lang/String;", line = 472)
    ...
    @OriginalMember(owner = "client!ju", name = "stop", descriptor = "()V", line = 482)
    ...
    @OriginalMember(owner = "client!ju", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 493)
    ...
    @OriginalMember(owner = "client!ju", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 509)
    ...
    @OriginalMember(owner = "client!ju", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 531)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIIIZLjava/lang/String;I)V", line = 546)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)V", line = 585)
    ...
    @OriginalMember(owner = "client!ju", name = "destroy", descriptor = "()V", line = 600)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZB)V", line = 615)
    ...
    @OriginalMember(owner = "client!ju", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 689)
    public final void windowActivated(WindowEvent arg0) {
        field1315++;
    }

    @OriginalMember(owner = "client!ju", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 699)
    ...
    @OriginalMember(owner = "client!ju", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 714)
    public final void windowClosed(WindowEvent arg0) {
        field1292++;
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(Z)Z", line = 723)
    public final boolean method675(boolean arg0) {
        field1319++;
        return arg0 ? class636.method3630(104, "jagmisc") : true;
    }

    @OriginalMember(owner = "client!ju", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 740)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field1285++;
    }

    @OriginalMember(owner = "client!ju", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 748)
    public final void focusLost(FocusEvent arg0) {
        class509.field7405 = false;
        field1308++;
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lkr;Z)V", line = 758)
    ...
    @OriginalMember(owner = "client!ju", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 791)
    public final void windowIconified(WindowEvent arg0) {
        field1296++;
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lad;[BIIIIIZ)Lah;", line = 800)
