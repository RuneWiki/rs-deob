...
public class class108 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)Lhi;", line = 8)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(I)V", line = 48)
    public static void method818(int arg0) {
        field1609 = null;
        int var1 = -28 / ((-arg0 - 56) / 50);
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IB)Lkq;", line = 58)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IILje;I)J", line = 95)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II)Lab;", line = 130)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(ILmv;Lmv;)V", line = 169)
