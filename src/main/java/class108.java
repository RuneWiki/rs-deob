...
public class class108 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(BII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZC)V", line = 32)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Ltt;I)V", line = 185)
