...
public class class108 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(JLra;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IZZZI)V", line = 146)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IJ)Lra;", line = 198)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(I)V", line = 253)
