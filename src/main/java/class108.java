...
public class class108 extends class344 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lcb;)V", line = 5)
    public final synchronized void method640(class344 arg0) {
        this.field1437.method2092(-118, arg0);
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lcg;Lod;)V", line = 8)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "()Lcb;", line = 15)
    public final class344 method642() {
        return (class344) this.field1437.method2096(-21400);
    }

    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Lcb;)V", line = 22)
    public final synchronized void method643(class344 arg0) {
        arg0.method536(false);
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "()I", line = 25)
    public final int method644() {
        return 0;
    }

    @OriginalMember(owner = "client!uh", name = "b", descriptor = "()Lcb;", line = 28)
    public final class344 method645() {
        return (class344) this.field1437.method2084((byte) 19);
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lod;)V", line = 31)
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "()I", line = 45)
    public final synchronized int method647() {
        return this.field1437.method2085(-18021);
    }

    @OriginalMember(owner = "client!uh", name = "c", descriptor = "([III)V", line = 58)
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([III)V", line = 135)
    ...
    @OriginalMember(owner = "client!uh", name = "f", descriptor = "()V", line = 189)
