...
public class class108 extends class116 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIILya;)Lt;", line = 4)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!kt", name = "finalize", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lt;BLya;)V", line = 45)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(Z)I", line = 70)
    ...
    @OriginalMember(owner = "client!kt", name = "h", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lya;B)Lmf;", line = 124)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIILef;BI)Ltq;", line = 159)
    ...
    @OriginalMember(owner = "client!kt", name = "f", descriptor = "(I)Z", line = 188)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lya;IZLij;III)V", line = 200)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZILya;I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II)V", line = 227)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BLmg;)V", line = 260)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(ILya;)V", line = 287)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(Z)V", line = 308)
