...
public abstract class class108 extends class115 {
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 78)
