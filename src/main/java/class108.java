...
public class class108 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)Lpi;", line = 7)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lai;ILic;)V", line = 133)
