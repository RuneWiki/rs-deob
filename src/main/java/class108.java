...
public class class108 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IILbt;)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lwt;B)V", line = 68)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IB)V", line = 101)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Leo;ILqa;)V", line = 116)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lgt;ILdn;)V", line = 184)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II)Lqp;", line = 144)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 170)
