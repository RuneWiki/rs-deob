...
public class class108 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(B)I", line = 16)
    public final int method1019(byte arg0) {
        field1758++;
        return arg0 == 67 ? this.field1761 : 28;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILje;)V", line = 30)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(BI)I", line = 42)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(II)Lje;", line = 56)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lje;)V", line = 66)
    public class108(class369 arg0) {
        this.field1761 = 1;
        this.field1757 = arg0.field5773;
    }

    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "([Lje;)V", line = 74)
    public class108(class369[] arg0) {
