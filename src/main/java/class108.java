...
public class class108 extends class255 {
    ...
    @OriginalMember(owner = "client!pk", name = "d", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!pk", name = "f", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lel;Lwd;ZLe;IILbr;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!pk", name = "g", descriptor = "(I)[B", line = 100)
