...
public class class108 extends class305 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lqa;III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(ILqa;)V", line = 40)
    public final void method400(int arg0, class162 arg1) {
        int var3 = -85 / ((arg0 - -29) / 33);
        ++field1468;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lqa;I)Lip;", line = 56)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "([IZ[ILuo;[I)V", line = 96)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILqa;)V", line = 198)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(Z)V", line = 398)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IZ)I", line = 421)
