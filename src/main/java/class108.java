...
public class class108 extends class38 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILrg;)V", line = 6)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 163)
    public class108() {
        super(0, true);
    }

    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BI)[I", line = 78)
