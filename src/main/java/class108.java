...
public class class108 extends class362 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IB)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "()V", line = 72)
    public class108() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qfa", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(II)[I", line = 97)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lfca;II)V", line = 139)
