...
public class class108 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Z)Lva;")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IZLla;Ljava/lang/String;)Liga;")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BIII)Lqv;")
