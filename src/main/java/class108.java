...
public class class108 extends class268 {
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!al", name = "d", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(IIIIIF)V", line = 39)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IBB)V", line = 110)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(III)V", line = 123)
    ...
    @OriginalMember(owner = "client!al", name = "e", descriptor = "(I)V", line = 140)
