...
public class class108 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILvn;)V", line = 15)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)Lqs;", line = 26)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(B)Lqs;", line = 303)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 328)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(II)Lqg;", line = 341)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "()V", line = 368)
    public class108() {
    }

    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lvn;)V", line = 393)
