...
public class class108 extends class192 implements class518 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IILza;)Le;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lza;Lp;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lza;ZBI)Ljl;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(ILza;)Lsr;")
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(BLza;)V")
