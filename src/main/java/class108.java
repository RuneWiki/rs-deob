...
public class class108 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)Lfr;")
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(B)Lfr;")
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(B)Lfr;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lfr;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZLfr;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "e", descriptor = "(B)Lfr;")
