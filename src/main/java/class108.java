...
public class class108 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lhc;IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)[Ls;", line = 320)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lnh;I)V", line = 374)
