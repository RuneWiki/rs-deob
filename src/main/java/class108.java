...
public class class108 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)[Lhk;", line = 14)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ILol;)V", line = 27)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IIBIIIIIILkn;I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(I)Lde;", line = 416)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Z)V", line = 442)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Lol;BI)V", line = 457)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 482)
