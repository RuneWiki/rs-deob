...
public class class108 extends class582 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!um", name = "h", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(B)Lwi;", line = 20)
    ...
    @OriginalMember(owner = "client!um", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 34)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method639(arg0.getX(), arg0.getY(), 25844);
        field1347++;
    }

    @OriginalMember(owner = "client!um", name = "c", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!um", name = "e", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!um", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 77)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method639(arg0.getX(), arg0.getY(), 25844);
        field1348++;
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!um", name = "g", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!um", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 115)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field1350++;
        this.method639(arg0.getX(), arg0.getY(), 25844);
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)Z", line = 124)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)V", line = 136)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)I", line = 195)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "([[BBLvc;)V", line = 232)
    ...
    @OriginalMember(owner = "client!um", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 305)
    ...
    @OriginalMember(owner = "client!um", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 335)
    ...
    @OriginalMember(owner = "client!um", name = "i", descriptor = "(B)V", line = 349)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 437)
    public class108(Component arg0, boolean arg1) {
        this.method636(arg0, 4);
        this.field1374 = arg1;
    }

    @OriginalMember(owner = "client!um", name = "f", descriptor = "(B)Z", line = 381)
    ...
    @OriginalMember(owner = "client!um", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 404)
    ...
    @OriginalMember(owner = "client!um", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 430)
