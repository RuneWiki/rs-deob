...
public class class108 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIIIIBI)V", line = 21)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lvj;JI)V", line = 72)
    public class108(class303 arg0, long arg1, int arg2) {
        this.field1788 = arg0;
        this.field1787 = arg1;
    }

    @OriginalMember(owner = "client!hq", name = "finalize", descriptor = "()V", line = 84)
