...
public class class108 extends class328 implements class380 {
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Lrda;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IILdja;IIIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IIIIIIIILsg;ILha;I)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IIBLic;I)V")
