...
public class class108 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIILph;)Lao;", line = 152)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)I", line = 185)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lcd;IIZ)Lmd;", line = 254)
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(B)I", line = 344)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "()V", line = 361)
    private class108() {
    }

    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "([I)V", line = 367)
