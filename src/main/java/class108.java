...
public class class108 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILqj;ZLqj;)V", line = 11)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZZLqj;III)V", line = 27)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILke;)V", line = 46)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)V", line = 77)
