...
public abstract class class108 extends class623 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILgaa;)V")
    ...
    @OriginalMember(owner = "client!r", name = "e", descriptor = "(B)Lng;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lida;I)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Ltn;I)Lfm;")
