...
public class class108 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIILet;)V", line = 8)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 91)
