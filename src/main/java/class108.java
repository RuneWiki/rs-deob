...
public abstract class class108 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I[I[Ljava/lang/Object;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)Z", line = 76)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIII)I", line = 100)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IZ)V", line = 141)
