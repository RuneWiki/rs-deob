...
public class class286 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 174)
