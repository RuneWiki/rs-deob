...
public class class286 extends class170 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IZLmd;II[I)V")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IILmd;)V")
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "()Los;")
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "()Los;")
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Leg;)V")
