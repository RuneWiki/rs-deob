...
public class class286 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BIIIILni;I)V")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lsba;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ZI)Lor;")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lgp;ILuu;)V")
