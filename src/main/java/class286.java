...
public class class286 extends class336 implements class438 {
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lfp;Lgn;IIIIIZIIIIIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lfp;Lje;ZIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILfp;)Luq;", line = 71)
    ...
    @OriginalMember(owner = "client!no", name = "e", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BI)Lg;", line = 108)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!no", name = "f", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILfp;Z)Lbi;", line = 168)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)I", line = 193)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lfp;Z)V", line = 204)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lfp;I)V", line = 231)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lfp;II)Lbi;", line = 260)
    public final class143 method11(class9 arg0, int arg1, int arg2) {
        ++field4196;
        return arg2 != -23109 ? null : this.method1925(arg1, arg0, true);
    }

    @OriginalMember(owner = "client!no", name = "d", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z)Z", line = 289)
    public final boolean method15(boolean arg0) {
        ++field4199;
        return !arg0 ? false : this.field4198;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lfp;III)Z", line = 303)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)I", line = 326)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(ILfp;)V", line = 337)
    ...
    @OriginalMember(owner = "client!no", name = "e", descriptor = "(B)I", line = 347)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lsq;BLsq;)V", line = 362)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)I", line = 380)
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(B)Z", line = 406)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILfp;ZI)Lwk;", line = 417)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Z)V", line = 447)
