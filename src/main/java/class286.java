...
public class class286 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lgu;B)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lms;ILwu;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)Lls;")
