...
public class class286 extends class165 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(ILmia;)V")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(III[BIFLbn;FFIIFF)V")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lrv;I)V")
