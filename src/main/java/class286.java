...
public class class286 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILtc;Ltc;IZ)Leh;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Ltc;Ltc;II)Leh;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Ljava/lang/String;Lbt;ZI)Lmc;")
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lob;Lrda;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
