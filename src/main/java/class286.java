...
public class class286 extends class377 {
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "()V", line = 4)
    public class286() {
        super(0, false);
    }

    @OriginalMember(owner = "client!bv", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILji;)V", line = 17)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IB)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!bv", name = "f", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(I)I", line = 145)
    ...
    @OriginalMember(owner = "client!bv", name = "e", descriptor = "(B)V", line = 167)
