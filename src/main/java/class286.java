...
public class class286 extends class232 {
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "()V", line = 119)
    public class286() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILwq;I)V", line = 124)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(II)[[I", line = 413)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 464)
