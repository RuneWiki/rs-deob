...
public class class286 implements Runnable {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILda;II)Lsd;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLkf;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILlf;)Lkf;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "([BZLlf;I)Lkf;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILlf;I)Lkf;")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lrj;)V")
