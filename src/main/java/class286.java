...
public class class286 extends class429 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ltp;)Lnv;", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
