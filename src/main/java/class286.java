...
public class class286 extends class88 implements class128 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(II)V", line = 4)
    public final void method659(int arg0, int arg1) {
        this.field3703.method2251().method3286(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!ya", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lw;IIIIZ)Z", line = 13)
    public final boolean method665(class605 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(Lda;La;II[[I[[IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(III[[ZZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIIIII[[Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lpn;[I)V", line = 56)
