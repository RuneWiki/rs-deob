...
public class class286 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZLqj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI)[[I", line = 31)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(III)V", line = 190)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)[[[I", line = 135)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(B)V", line = 167)
