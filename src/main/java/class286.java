...
public class class286 extends class386 {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lbf;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lbf;IIZ[[BI)V", line = 28)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lbf;IIZ[[I)V", line = 50)
