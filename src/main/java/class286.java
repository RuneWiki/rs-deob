...
public class class286 extends class140 {
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lte;)V", line = 8)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IILjl;)V", line = 85)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(III)Z", line = 103)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZB)V", line = 123)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)V", line = 161)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lvp;BLvp;)V", line = 172)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IB)Lvda;", line = 190)
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZ)V", line = 296)
