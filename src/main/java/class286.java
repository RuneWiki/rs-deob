...
public class class286 extends Canvas {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Ltq;Ltq;Z)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lce;ZZB)V")
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
