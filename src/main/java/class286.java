...
public class class286 extends class56 implements class338 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILqa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lqa;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 36)
    public final void method342(int arg0) {
        field3735++;
        int var2 = 72 / ((56 - arg0) / 52);
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)Z", line = 61)
    public final boolean method126(byte arg0) {
        field3745++;
        return arg0 != 54;
    }

    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)I", line = 83)
    public final int method344(int arg0) {
        field3738++;
        return arg0 == -4534 ? 0 : -21;
    }

    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(IIIIILgv;)V", line = 95)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(ILqa;)Lfm;", line = 109)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IILqa;I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLqa;I)Lc;", line = 131)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 142)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 206)
    ...
    @OriginalMember(owner = "client!nv", name = "g", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(III)V", line = 229)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lqa;I)V", line = 243)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)I", line = 253)
