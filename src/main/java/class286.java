...
public class class286 extends class512 {
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "()V", line = 3)
    public class286() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(II)[[I", line = 8)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;BLia;)I", line = 98)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZILia;)V", line = 117)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!gt", name = "f", descriptor = "(I)V", line = 217)
