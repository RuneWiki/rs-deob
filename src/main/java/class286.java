...
public class class286 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(IB)Lai;", line = 45)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lgp;ILui;)V", line = 116)
