...
public class class286 extends class396 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lbk;Z[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILbk;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(III)I", line = 103)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)I", line = 129)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILbk;)V", line = 147)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BLbk;)Ljava/lang/String;", line = 168)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I[Lkh;)V", line = 209)
    ...
    @OriginalMember(owner = "client!jb", name = "e", descriptor = "(I)I", line = 239)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZILjava/awt/Color;Ljava/awt/Color;Ljava/lang/String;BLjava/awt/Color;)V", line = 280)
    ...
    @OriginalMember(owner = "client!jb", name = "f", descriptor = "(I)Ljava/lang/String;", line = 389)
