...
public class class286 extends class492 {
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lvj;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lvj;IIIIZ[FI)V", line = 20)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZBZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIBIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lvj;IIIIZ[IZ)V", line = 184)
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lvj;IIIIZ[BIZ)V", line = 391)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lvj;IIIII)V", line = 459)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZIIIIII[BII)V", line = 252)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([IIIIIIZII)V", line = 313)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIIIIII)V", line = 363)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIII)V", line = 378)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)V", line = 446)
