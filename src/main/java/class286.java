...
public class class286 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Ltu;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lbe;ILtu;)V", line = 33)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZLtu;)V", line = 303)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IILtu;)V", line = 314)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Z)V", line = 686)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Ltu;)V", line = 1014)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IZ)V", line = 701)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILtu;)V", line = 782)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lkr;Z)V", line = 806)
