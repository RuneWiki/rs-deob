...
public class class286 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "([BBJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "([BII)V", line = 95)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(FFBIIIIF)[F", line = 192)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IBIIIII)V", line = 402)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)V", line = 452)
