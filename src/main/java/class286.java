...
public class class286 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZIZIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BI)Z", line = 78)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)V", line = 97)
