...
public class class286 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljava/lang/String;ZLdn;I)Ltq;", line = 7)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLjava/awt/Component;Z)Lmd;", line = 58)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILbt;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lbt;B)V", line = 189)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZIIIIIIII)V", line = 212)
