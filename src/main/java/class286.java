...
public class class286 extends class383 implements class196 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lqv;BLqa;IZII)V")
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(IIILlf;)V")
    public class286(int arg0, int arg1, int arg2, class383 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field4270 = arg3;
    }

    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILqa;B)Lc;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lqa;I)Lpj;")
