...
public class class286 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lrd;B)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)Lgr;")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lae;ILqn;)V")
