...
public class class286 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(I)V", line = 66)
    public class286(int arg0) {
        this.field3665 = arg0;
    }

    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(IIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BLvc;)V", line = 33)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)Lvc;", line = 50)
