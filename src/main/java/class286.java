...
public class class286 extends class51 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)V", line = 57)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lcu;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(IIIIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(III)V", line = 129)
