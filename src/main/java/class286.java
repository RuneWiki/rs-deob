...
public class class286 extends class328 {
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 3)
    public class286() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!nb", name = "f", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)[I", line = 195)
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(B)V", line = 315)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BILco;)V", line = 331)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 387)
