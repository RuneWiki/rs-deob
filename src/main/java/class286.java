...
public class class286 extends class373 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BLpq;)V", line = 22)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BLqe;)V", line = 40)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZIIII)V", line = 253)
