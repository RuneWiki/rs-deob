...
public class class286 extends class214 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)Lfl;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IBIIIII)Lop;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILes;)I")
