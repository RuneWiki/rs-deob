...
public class class286 extends class179 {
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!gr", name = "g", descriptor = "(I)V", line = 61)
