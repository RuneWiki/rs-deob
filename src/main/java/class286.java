...
public class class286 extends class35 {
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lon;Lon;B)V", line = 21)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(II)V", line = 124)
