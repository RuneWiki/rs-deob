...
public class class286 extends class131 {
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()I", line = 5)
    public final int method510() {
        field3493++;
        return this.field3513 + this.field3505 + this.field3502.field2836;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(FFFFFFIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lnv;IIZ)V", line = 726)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lnv;IIII)V", line = 736)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lnv;II[III)V", line = 760)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "()I", line = 151)
    public final int method503() {
        field3512++;
        return this.field3502.field2834;
    }

    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(IIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIII)V", line = 178)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "()I", line = 230)
    public final int method509() {
        field3498++;
        return this.field3502.field2836;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIII)V", line = 240)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIIII)V", line = 380)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IILaa;II)V", line = 487)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 551)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(II)V", line = 642)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(IIII)V", line = 680)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "()I", line = 696)
    public final int method501() {
        field3489++;
        return this.field3502.field2834 + this.field3509 + this.field3510;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)V", line = 713)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)V", line = 747)
