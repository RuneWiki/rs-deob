...
public class class286 extends class531 {
    ...
    @OriginalMember(owner = "client!tja", name = "<init>", descriptor = "(Lqfa;Lgo;)V")
    ...
    @OriginalMember(owner = "client!tja", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(IZLdca;)V")
