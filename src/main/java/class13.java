...
public class class13 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(II)Lnh;", line = 55)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BI)V", line = 85)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ltl;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 142)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILof;Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lgo;ILns;Lns;)V", line = 223)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(II)V", line = 197)
