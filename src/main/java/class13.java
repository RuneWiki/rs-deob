...
public class class13 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIILlda;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II)V", line = 148)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 216)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IB)Lav;", line = 186)
