...
public class class13 extends class313 {
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIII)I", line = 22)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(CB)Z", line = 40)
