...
public class class13 implements Runnable {
    ...
    @OriginalMember(owner = "client!EDOAEAIN", name = "h", descriptor = "LHXQNMAEJ;")
    ...
    @OriginalMember(owner = "client!EDOAEAIN", name = "<init>", descriptor = "(Ljava/net/Socket;LHXQNMAEJ;B)V")
