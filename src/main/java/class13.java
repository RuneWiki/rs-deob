...
public class class13 extends class298 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([B[I[IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(CIIIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([B[IIIIIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lhm;Ljp;[Lv;[I[I)V", line = 179)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([B[I[IIIIIIIIIIILgo;II)V", line = 203)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(CIIIZLgo;II)V", line = 292)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([B[IIIIIIIIIIILgo;II)V", line = 363)
