...
public class class13 extends class425 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Z)V", line = 129)
