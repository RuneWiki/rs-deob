...
public class class13 extends class15 {
    ...
    @OriginalMember(owner = "client!DLMOHDFX", name = "tb", descriptor = "LKFUEEJVZ;")
    public class33 field671;

    @OriginalMember(owner = "client!DLMOHDFX", name = "a", descriptor = "(I)LVYUQHOMO;")
    ...
    @OriginalMember(owner = "client!DLMOHDFX", name = "b", descriptor = "(Z)LVYUQHOMO;")
