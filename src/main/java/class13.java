...
public class class13 extends class214 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILofa;I)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILraa;BILaa;IIJI)V")
