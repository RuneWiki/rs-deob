...
public class class13 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIIZIILr;)V")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILbt;)V")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lr;Lr;Lr;Lod;I)Z")
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)[Lvr;")
