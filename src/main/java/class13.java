...
public class class13 extends class601 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "()V", line = 184)
    public class13() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lee;BI)V", line = 189)
