...
@OriginalClass("client!EEDCHWRL")
public class class13 extends class23 implements Runnable {

    @OriginalMember(owner = "client!EEDCHWRL", name = "c", descriptor = "Z")
    private boolean field713 = true;

    @OriginalMember(owner = "client!EEDCHWRL", name = "e", descriptor = "Z")
    private boolean field715 = true;

    @OriginalMember(owner = "client!EEDCHWRL", name = "h", descriptor = "Z")
    private boolean field718 = false;

    @OriginalMember(owner = "client!EEDCHWRL", name = "i", descriptor = "[[B")
    private byte[][] field719 = new byte[4][];

    @OriginalMember(owner = "client!EEDCHWRL", name = "j", descriptor = "LWUVIEXOA;")
    private class69 field720 = new class69((byte) 7);

    @OriginalMember(owner = "client!EEDCHWRL", name = "l", descriptor = "LHASAJOKP;")
    private class25 field722 = new class25(176);

    @OriginalMember(owner = "client!EEDCHWRL", name = "m", descriptor = "Z")
    private boolean field723 = false;

    @OriginalMember(owner = "client!EEDCHWRL", name = "n", descriptor = "LWUVIEXOA;")
    private class69 field724 = new class69((byte) 7);

    @OriginalMember(owner = "client!EEDCHWRL", name = "p", descriptor = "[[I")
    private int[][] field726 = new int[4][];

    @OriginalMember(owner = "client!EEDCHWRL", name = "q", descriptor = "LWUVIEXOA;")
    private class69 field727 = new class69((byte) 7);

    @OriginalMember(owner = "client!EEDCHWRL", name = "s", descriptor = "[[I")
    private int[][] field729 = new int[4][];

    @OriginalMember(owner = "client!EEDCHWRL", name = "v", descriptor = "LWUVIEXOA;")
    private class69 field732 = new class69((byte) 7);

    @OriginalMember(owner = "client!EEDCHWRL", name = "w", descriptor = "LWUVIEXOA;")
    private class69 field733 = new class69((byte) 7);

    @OriginalMember(owner = "client!EEDCHWRL", name = "y", descriptor = "I")
    private int field735 = -32232;

    @OriginalMember(owner = "client!EEDCHWRL", name = "z", descriptor = "[B")
    private byte[] field736 = new byte[65000];

    @OriginalMember(owner = "client!EEDCHWRL", name = "B", descriptor = "Z")
    private boolean field738 = false;

    @OriginalMember(owner = "client!EEDCHWRL", name = "D", descriptor = "Ljava/lang/String;")
    public String field740 = "";

    @OriginalMember(owner = "client!EEDCHWRL", name = "E", descriptor = "B")
    private byte field741 = -70;

    @OriginalMember(owner = "client!EEDCHWRL", name = "F", descriptor = "[B")
    private byte[] field742 = new byte[500];

    @OriginalMember(owner = "client!EEDCHWRL", name = "L", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field748 = new CRC32();

    @OriginalMember(owner = "client!EEDCHWRL", name = "R", descriptor = "I")
    private int field754 = -45573;

    @OriginalMember(owner = "client!EEDCHWRL", name = "S", descriptor = "Z")
    private boolean field755 = true;

    @OriginalMember(owner = "client!EEDCHWRL", name = "d", descriptor = "I")
    private int field714;

    @OriginalMember(owner = "client!EEDCHWRL", name = "u", descriptor = "I")
    public int field731;

    @OriginalMember(owner = "client!EEDCHWRL", name = "x", descriptor = "I")
    public int field734;

    @OriginalMember(owner = "client!EEDCHWRL", name = "A", descriptor = "I")
    private int field737;

    @OriginalMember(owner = "client!EEDCHWRL", name = "C", descriptor = "I")
    private int field739;

    @OriginalMember(owner = "client!EEDCHWRL", name = "G", descriptor = "I")
    private int field743;

    @OriginalMember(owner = "client!EEDCHWRL", name = "H", descriptor = "I")
    private int field744;

    @OriginalMember(owner = "client!EEDCHWRL", name = "I", descriptor = "I")
    private int field745;

    @OriginalMember(owner = "client!EEDCHWRL", name = "P", descriptor = "I")
    private int field752;

    @OriginalMember(owner = "client!EEDCHWRL", name = "Q", descriptor = "I")
    private int field753;

    @OriginalMember(owner = "client!EEDCHWRL", name = "T", descriptor = "I")
    private int field756;

    @OriginalMember(owner = "client!EEDCHWRL", name = "t", descriptor = "J")
    private long field730;

    @OriginalMember(owner = "client!EEDCHWRL", name = "o", descriptor = "LGVYJCWHX;")
    private class24 field725;

    @OriginalMember(owner = "client!EEDCHWRL", name = "f", descriptor = "Lclient;")
    private client field716;

    @OriginalMember(owner = "client!EEDCHWRL", name = "N", descriptor = "Ljava/io/InputStream;")
    private InputStream field750;

    @OriginalMember(owner = "client!EEDCHWRL", name = "b", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field712;

    @OriginalMember(owner = "client!EEDCHWRL", name = "J", descriptor = "Ljava/net/Socket;")
    private Socket field746;

    @OriginalMember(owner = "client!EEDCHWRL", name = "r", descriptor = "[B")
    private byte[] field728;

    @OriginalMember(owner = "client!EEDCHWRL", name = "g", descriptor = "[I")
    private int[] field717;

    @OriginalMember(owner = "client!EEDCHWRL", name = "k", descriptor = "[I")
    private int[] field721;

    @OriginalMember(owner = "client!EEDCHWRL", name = "K", descriptor = "[I")
    private int[] field747;

    @OriginalMember(owner = "client!EEDCHWRL", name = "M", descriptor = "[I")
    private int[] field749;

    @OriginalMember(owner = "client!EEDCHWRL", name = "O", descriptor = "[I")
    private int[] field751;

    @OriginalMember(owner = "client!EEDCHWRL", name = "U", descriptor = "[I")
    private int[] field757;

    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "()LGVYJCWHX;")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(ZI)I")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(IZII)I")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "b", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(ZZ)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(LGVYJCWHX;I)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(LEAXVDNXA;Lclient;)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "b", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "c", descriptor = "()V")
    public final void method270() {
        this.field713 = false;
    }

    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "d", descriptor = "(I)I")
    public final int method272(int arg0) {
        return arg0 >= 6 && arg0 <= 6 ? this.field749.length : this.field754;
    }

    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(I)V")
    public final void method273(int arg0) {
        this.method259(0, arg0);
    }

    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(Z[BII)Z")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(BI)Z")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!EEDCHWRL", name = "a", descriptor = "(BII)V")
