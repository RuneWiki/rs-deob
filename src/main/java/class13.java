...
public class class13 extends class182 {
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lag;)V", line = 4)
    public class13(class469 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(B)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(I)[Lwn;", line = 20)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(II)V", line = 121)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(III)V", line = 134)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILvfa;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ZZ)V", line = 173)
    public final void method84(boolean arg0, boolean arg1) {
        super.field2540.method2685(3359, arg0);
        ++field169;
    }

    @OriginalMember(owner = "client!vca", name = "c", descriptor = "(B)V", line = 181)
