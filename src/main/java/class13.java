...
public class class13 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIIII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIILha;IIILbj;IIB)V", line = 88)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I[IZZIIILoea;)Lm;", line = 103)
