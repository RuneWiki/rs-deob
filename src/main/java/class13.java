...
public abstract class class13 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILtp;IZIILaa;Lhu;)V", line = 14)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "([IIIZIZILnv;)Ltea;", line = 175)
