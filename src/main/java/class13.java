...
public class class13 extends class170 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIB)V", line = 33)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(IIB)V", line = 77)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIILtf;Li;Lqa;III)V", line = 87)
