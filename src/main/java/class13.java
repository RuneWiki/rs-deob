...
public class class13 extends class117 {
    ...
    @OriginalMember(owner = "client!aa", name = "f", descriptor = "(I)Z", line = 12)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BLfc;)V", line = 106)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)Z", line = 133)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(IIII)I", line = 145)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IB)I", line = 167)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ZI)Z", line = 178)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(I)V", line = 195)
