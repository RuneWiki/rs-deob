...
public class class13 extends class22 {
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILqa;I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 210)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(IIII)I", line = 243)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IILqa;IZLha;I)V", line = 257)
    ...
    @OriginalMember(owner = "client!kh", name = "k", descriptor = "(I)Z", line = 271)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)I", line = 282)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILqa;)Lbw;", line = 303)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(Z)V", line = 381)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(I)I", line = 396)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(I)V", line = 418)
    ...
    @OriginalMember(owner = "client!kh", name = "l", descriptor = "(I)Z", line = 429)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lqb;I)V", line = 444)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(BZIIII)V", line = 459)
    ...
    @OriginalMember(owner = "client!kh", name = "e", descriptor = "(I)Z", line = 537)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIILqa;)Z", line = 552)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(III)V", line = 591)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)I", line = 685)
    ...
    @OriginalMember(owner = "client!kh", name = "m", descriptor = "(I)V", line = 716)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(Lqa;I)V", line = 741)
