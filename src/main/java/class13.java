...
public class class13 extends class35 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lmb;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(B)Lho;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lja;Lnf;III)V")
