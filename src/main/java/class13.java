...
public class class13 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIILtn;)V", line = 39)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BILtn;)V", line = 91)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 118)
