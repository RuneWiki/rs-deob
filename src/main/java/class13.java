...
public class class13 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IB)Lan;", line = 23)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 98)
