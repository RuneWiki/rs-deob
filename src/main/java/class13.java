...
public class class13 extends class125 {
    ...
    @OriginalMember(owner = "client!dka", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!dka", name = "b", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!dka", name = "c", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(Z)Z", line = 68)
    ...
    @OriginalMember(owner = "client!dka", name = "b", descriptor = "(I)I", line = 84)
    public final int method142(int arg0) {
        ++field256;
        return arg0 <= 73 ? -94 : 1;
    }

    @OriginalMember(owner = "client!dka", name = "c", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!dka", name = "c", descriptor = "(B)Z", line = 122)
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lqfa;)V", line = 167)
    public class13(class106 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(III)V", line = 173)
    ...
    @OriginalMember(owner = "client!dka", name = "d", descriptor = "(B)Z", line = 252)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(ZILkm;Lkm;)V", line = 263)
