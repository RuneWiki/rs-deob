...
public class class13 extends class145 {
    ...
    @OriginalMember(owner = "client!vl", name = "g", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BI)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIILhi;IILba;IIIIILoa;)Lba;", line = 96)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(BI)V", line = 307)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IILrt;)V", line = 324)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "()V", line = 340)
    public class13() {
        super(0, false);
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(B)V", line = 349)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)Z", line = 368)
