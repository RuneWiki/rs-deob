...
public class class13 extends class113 {
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(ZLqa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILqa;)Lou;", line = 32)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IZIBLga;)V", line = 72)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BIILqa;)Z", line = 152)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 190)
