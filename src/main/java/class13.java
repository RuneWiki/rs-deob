...
public class class13 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(BI)Lkb;", line = 23)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IB)Lfc;", line = 77)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lgp;ILui;Lui;)V", line = 244)
