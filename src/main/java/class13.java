...
public class class13 {
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([BI[BIII)I", line = 30)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([B[BIIII)I", line = 105)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "([B)V", line = 257)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 382)
