...
@OriginalClass("client!FJJCITCO")
public class class13 extends class60 {

    @OriginalMember(owner = "client!FJJCITCO", name = "qb", descriptor = "LUGDYQAXI;")
    public class59 field736;

    @OriginalMember(owner = "client!FJJCITCO", name = "a", descriptor = "(B)LGEUHTGZJ;")
    ...
    @OriginalMember(owner = "client!FJJCITCO", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!FJJCITCO", name = "c", descriptor = "(I)LGEUHTGZJ;")
