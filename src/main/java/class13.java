...
public class class13 extends class398 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)Z", line = 16)
    public final boolean method87(int arg0) {
        ++field303;
        return arg0 != 3 ? true : true;
    }

    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Luca;)V", line = 27)
    public class13(class287 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lcaa;Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIILkga;)V", line = 64)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZI)V", line = 100)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILvaa;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IZ)V", line = 142)
