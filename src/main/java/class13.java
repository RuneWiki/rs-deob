...
public class class13 {
    ...
    @OriginalMember(owner = "client!DQSOHZWU", name = "f", descriptor = "[LDQSOHZWU;")
    public static class13[] field632;

    @OriginalMember(owner = "client!DQSOHZWU", name = "a", descriptor = "(ILHRXSNEYZ;)V")
    ...
    @OriginalMember(owner = "client!DQSOHZWU", name = "a", descriptor = "(LJHKSAGUC;I)V")
    ...
    @OriginalMember(owner = "client!DQSOHZWU", name = "a", descriptor = "(I)LRTQSBWRH;")
    ...
    @OriginalMember(owner = "client!DQSOHZWU", name = "b", descriptor = "(Z)LRTQSBWRH;")
