...
public class class13 extends class49 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ltk;)Lig;", line = 5)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
