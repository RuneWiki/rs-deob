...
public class class13 extends class28 implements class89 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 13)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lda;Ljava/awt/Canvas;)V", line = 76)
