...
public class class13 extends class513 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(FIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!vl", name = "d", descriptor = "(II)V", line = 182)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I[II)V", line = 227)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIB)V", line = 388)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Ljda;IIIII)V", line = 407)
