...
@OriginalClass("client!FCKTYQCQ")
public class class13 {

    @OriginalMember(owner = "client!FCKTYQCQ", name = "b", descriptor = "Z")
    private static boolean field641 = true;

    @OriginalMember(owner = "client!FCKTYQCQ", name = "c", descriptor = "B")
    private static byte field642 = -48;

    @OriginalMember(owner = "client!FCKTYQCQ", name = "a", descriptor = "I")
    private static int field640;

    @OriginalMember(owner = "client!FCKTYQCQ", name = "a", descriptor = "(IBII)I")
    ...
    @OriginalMember(owner = "client!FCKTYQCQ", name = "a", descriptor = "(IIBI)I")
    ...
    @OriginalMember(owner = "client!FCKTYQCQ", name = "a", descriptor = "(IIBIII)I")
    ...
    @OriginalMember(owner = "client!FCKTYQCQ", name = "a", descriptor = "(IIIIII)I")
