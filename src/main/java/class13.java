...
public class class13 {
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)Lhg;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ZI)Lul;")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lci;ILsea;)V")
