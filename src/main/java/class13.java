...
public class class13 extends class530 {
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lah;)V", line = 3)
    public class13(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "([J[II)V", line = 42)
    public static final void method71(long[] arg0, int[] arg1, int arg2) {
        class23.method129(arg0, arg1, arg0.length + arg2, 0, (byte) -3);
        ++field183;
    }

    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)I", line = 87)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(ILah;)V", line = 100)
