...
public class class13 extends class19 {
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 48)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 89)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "()I", line = 126)
    public final int method98() {
        return this.field175 - (this.field174.available() >> (class217.field3062 ? 2 : 1));
    }

    @OriginalMember(owner = "client!n", name = "d", descriptor = "()V", line = 137)
