...
public class class13 extends class618 implements class532 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(IIILlw;)V")
    public class13(int arg0, int arg1, int arg2, class618 arg3) {
        super(arg0, arg1, arg2, arg3.field8195, false, false);
        this.field216 = arg3;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BILoa;I)Z")
