...
@OriginalClass("client!ECSVNCGM")
public class class13 {

    @OriginalMember(owner = "client!ECSVNCGM", name = "e", descriptor = "I")
    public int field644 = -1;

    @OriginalMember(owner = "client!ECSVNCGM", name = "f", descriptor = "Z")
    public boolean field645 = false;

    @OriginalMember(owner = "client!ECSVNCGM", name = "g", descriptor = "Z")
    public boolean field646 = true;

    @OriginalMember(owner = "client!ECSVNCGM", name = "a", descriptor = "I")
    public static int field640;

    @OriginalMember(owner = "client!ECSVNCGM", name = "d", descriptor = "I")
    public int field643;

    @OriginalMember(owner = "client!ECSVNCGM", name = "h", descriptor = "I")
    public int field647;

    @OriginalMember(owner = "client!ECSVNCGM", name = "i", descriptor = "I")
    public int field648;

    @OriginalMember(owner = "client!ECSVNCGM", name = "j", descriptor = "I")
    public int field649;

    @OriginalMember(owner = "client!ECSVNCGM", name = "k", descriptor = "I")
    public int field650;

    @OriginalMember(owner = "client!ECSVNCGM", name = "l", descriptor = "I")
    public int field651;

    @OriginalMember(owner = "client!ECSVNCGM", name = "m", descriptor = "I")
    public int field652;

    @OriginalMember(owner = "client!ECSVNCGM", name = "c", descriptor = "Ljava/lang/String;")
    public String field642;

    @OriginalMember(owner = "client!ECSVNCGM", name = "b", descriptor = "[LECSVNCGM;")
    public static class13[] field641;

    @OriginalMember(owner = "client!ECSVNCGM", name = "a", descriptor = "(ILCVNWKEAW;)V")
    ...
    @OriginalMember(owner = "client!ECSVNCGM", name = "a", descriptor = "(BLXOUQUKZW;)V")
    ...
    @OriginalMember(owner = "client!ECSVNCGM", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!ECSVNCGM", name = "a", descriptor = "(III)I")
