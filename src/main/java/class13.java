...
public class class13 extends InputStream {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!kh", name = "read", descriptor = "()I", line = 23)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZIIIILhe;)V", line = 33)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lis;III)V", line = 56)
