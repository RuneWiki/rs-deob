...
public class class13 extends class495 {
    ...
    @OriginalMember(owner = "client!oe", name = "C", descriptor = "()V", line = 3)
    public final void method67() {
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lf;Z)V", line = 6)
    public final void method68(class257 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!oe", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Lfa;Lvo;Ljava/lang/Integer;)Lr;", line = 11)
    ...
    @OriginalMember(owner = "client!oe", name = "q", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!oe", name = "x", descriptor = "(B)V", line = 122)
    public final void method70(byte arg0) {
        int var2 = 45 % ((arg0 - 34) / 36);
        this.field154.SetRenderState(60, this.field7375);
    }

    @OriginalMember(owner = "client!oe", name = "i", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!oe", name = "D", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZILct;Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BIILgca;)V", line = 240)
    ...
    @OriginalMember(owner = "client!oe", name = "Q", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!oe", name = "u", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!oe", name = "m", descriptor = "()Lsr;", line = 281)
    ...
    @OriginalMember(owner = "client!oe", name = "s", descriptor = "(B)V", line = 290)
    ...
    @OriginalMember(owner = "client!oe", name = "g", descriptor = "(II)Lcf;", line = 318)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(FFF)V", line = 360)
    public final void method80(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/jd;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Llg;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Lfa;Lvo;I)V", line = 363)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 405)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ltn;B)I", line = 415)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lpa;Lpa;FLpa;)Lpa;", line = 433)
    public final class587 method83(class587 arg0, class587 arg1, float arg2, class587 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!oe", name = "A", descriptor = "(I)F", line = 441)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lct;Z)I", line = 451)
    ...
    @OriginalMember(owner = "client!oe", name = "N", descriptor = "(I)V", line = 479)
    ...
    @OriginalMember(owner = "client!oe", name = "q", descriptor = "()V", line = 514)
    ...
    @OriginalMember(owner = "client!oe", name = "x", descriptor = "()V", line = 537)
    public final void method88() {
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLjava/awt/Canvas;Ljava/lang/Object;)V", line = 540)
    ...
    @OriginalMember(owner = "client!oe", name = "p", descriptor = "(I)V", line = 549)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljb;ILqda;)Z", line = 560)
    ...
    @OriginalMember(owner = "client!oe", name = "q", descriptor = "(I)V", line = 572)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 608)
    public final void method93(Rectangle[] arg0, int arg1) throws class300 {
        this.method87();
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z[[IIB)Lhba;", line = 616)
    ...
    @OriginalMember(owner = "client!oe", name = "B", descriptor = "()Z", line = 628)
    public final boolean method95() {
        return false;
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILjb;I[BZI)Lwca;", line = 637)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 647)
    public final void method97(boolean arg0) {
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLdt;)V", line = 652)
    ...
    @OriginalMember(owner = "client!oe", name = "y", descriptor = "(I)V", line = 661)
    ...
    @OriginalMember(owner = "client!oe", name = "i", descriptor = "()Z", line = 692)
    public final boolean method100() {
        return false;
    }

    @OriginalMember(owner = "client!oe", name = "w", descriptor = "(B)V", line = 699)
    ...
    @OriginalMember(owner = "client!oe", name = "A", descriptor = "()V", line = 710)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljb;Lqda;IIB)Ldca;", line = 738)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 748)
    ...
    @OriginalMember(owner = "client!oe", name = "p", descriptor = "()V", line = 759)
    public final void method105() {
        this.field166.method2022(14821);
        super.method105();
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljb;Lqda;I)Z", line = 769)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II[BZIILjb;I)Ldca;", line = 780)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIII)V", line = 789)
    public final void method108(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/awt/Canvas;Ljava/lang/Object;Z)V", line = 792)
    ...
    @OriginalMember(owner = "client!oe", name = "E", descriptor = "(B)V", line = 818)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lir;Z)V", line = 837)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lqda;ZLjb;)I", line = 864)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(Ltw;B)I", line = 908)
    ...
    @OriginalMember(owner = "client!oe", name = "j", descriptor = "(Z)V", line = 936)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BZ)Leu;", line = 947)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIILeu;Lgca;BI)V", line = 957)
    ...
    @OriginalMember(owner = "client!oe", name = "u", descriptor = "(B)V", line = 976)
    public final void method117(byte arg0) {
        this.field154.method3805(15, this.field7295);
        int var2 = -112 % ((-arg0 - 81) / 32);
    }

    @OriginalMember(owner = "client!oe", name = "ja", descriptor = "(I)V", line = 985)
    public final void method118(int arg0) {
        this.field154.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZI)Lwf;", line = 993)
    ...
    @OriginalMember(owner = "client!oe", name = "D", descriptor = "(B)V", line = 1006)
    ...
    @OriginalMember(owner = "client!oe", name = "l", descriptor = "(Z)Z", line = 1017)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZZ)V", line = 1057)
    ...
    @OriginalMember(owner = "client!oe", name = "B", descriptor = "(B)V", line = 1067)
    ...
    @OriginalMember(owner = "client!oe", name = "E", descriptor = "(I)V", line = 1077)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lhp;I)V", line = 1089)
    ...
    @OriginalMember(owner = "client!oe", name = "g", descriptor = "(Z)V", line = 1114)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILjagdx/D3DPRESENT_PARAMETERS;Ljagdx/IDirect3D;ZII)Z", line = 1126)
    ...
    @OriginalMember(owner = "client!oe", name = "r", descriptor = "()V", line = 1234)
    public final void method128() {
    }

    @OriginalMember(owner = "client!oe", name = "x", descriptor = "(I)V", line = 1237)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IZBILjb;I[FI)Ldca;", line = 1249)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILwf;I)V", line = 1260)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZLvf;)V", line = 1271)
    ...
    @OriginalMember(owner = "client!oe", name = "h", descriptor = "(IIII)[I", line = 1295)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIIZB[I)Ldca;", line = 1337)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lgca;I)I", line = 1345)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lel;I)I", line = 1378)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "()V", line = 1406)
    public final void method137() {
    }

    @OriginalMember(owner = "client!oe", name = "ya", descriptor = "()V", line = 1412)
    public final void method138() {
        this.method2931(-8193, true);
        this.field154.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!oe", name = "H", descriptor = "(I)V", line = 1420)
    ...
    @OriginalMember(owner = "client!oe", name = "p", descriptor = "(B)V", line = 1431)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "([Lls;Z)Ldt;", line = 1441)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Loj;I)V", line = 1451)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZLct;IZI)V", line = 1493)
    ...
    @OriginalMember(owner = "client!oe", name = "DA", descriptor = "()I", line = 1540)
    public final int method144() {
        return 0;
    }

    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(Z)V", line = 1547)
    ...
    @OriginalMember(owner = "client!oe", name = "m", descriptor = "(B)V", line = 1558)
    ...
    @OriginalMember(owner = "client!oe", name = "h", descriptor = "(I)V", line = 1572)
    public final synchronized void method147(int arg0) {
        this.field166.method2019(15977);
        super.method147(arg0);
    }

    @OriginalMember(owner = "client!oe", name = "K", descriptor = "(I)V", line = 1580)
    ...
    @OriginalMember(owner = "client!oe", name = "I", descriptor = "(I)V", line = 1618)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(B)V", line = 1629)
    ...
    @OriginalMember(owner = "client!oe", name = "d", descriptor = "(II)V", line = 1644)
