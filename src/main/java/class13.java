...
public class class13 extends class421 implements class210 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lnl;Lnl;Lnl;Lnl;B)V")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lvc;Lnm;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZILvc;IILuq;I)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZZILvc;)Lco;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILvc;I)Ln;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BILvc;)Ln;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILae;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lvc;B)V")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(ZLvc;)V")
