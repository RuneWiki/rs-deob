...
public abstract class class13 extends class390 {
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(I)V", line = 47)
    public void method33(int arg0) {
        field255++;
        int var2 = 119 / ((arg0 - 2) / 51);
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(II)[[I", line = 60)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(III)[I", line = 81)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lkh;BI)V", line = 103)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZII)V", line = 113)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZLms;)Ljava/lang/String;", line = 136)
    ...
    @OriginalMember(owner = "client!n", name = "d", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(IZ)V", line = 171)
    public class13(int arg0, boolean arg1) {
        this.field259 = arg1;
        this.field250 = new class13[arg0];
    }

    @OriginalMember(owner = "client!n", name = "b", descriptor = "(ZII)[[I", line = 189)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZI)[I", line = 231)
