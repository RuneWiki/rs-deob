...
public class class13 extends class544 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(BILjava/awt/event/KeyEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dka", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 41)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(ZI)Z", line = 49)
    ...
    @OriginalMember(owner = "client!dka", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 65)
    ...
    @OriginalMember(owner = "client!dka", name = "e", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!dka", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(ICBI)V", line = 131)
    ...
    @OriginalMember(owner = "client!dka", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 148)
    ...
    @OriginalMember(owner = "client!dka", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 155)
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 381)
    ...
    @OriginalMember(owner = "client!dka", name = "d", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!dka", name = "c", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!dka", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 285)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 299)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!dka", name = "b", descriptor = "(I)Lks;", line = 337)
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(Z)I", line = 348)
