...
public class class13 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZII)I", line = 6)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(CB)V", line = 44)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Lml;I)V", line = 76)
