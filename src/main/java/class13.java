...
public class class13 {
    ...
    @OriginalMember(owner = "client!DDXRHBHP", name = "c", descriptor = "[LDDXRHBHP;")
    public static class13[] field586;

    @OriginalMember(owner = "client!DDXRHBHP", name = "a", descriptor = "(LVSUYIIVA;I)V")
    ...
    @OriginalMember(owner = "client!DDXRHBHP", name = "a", descriptor = "(IBLCFARFRSG;)V")
