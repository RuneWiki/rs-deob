...
public class class13 extends class301 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "()V", line = 11)
    public class13() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!n", name = "b", descriptor = "(III)[B", line = 14)
