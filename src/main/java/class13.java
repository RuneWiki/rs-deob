...
public class class13 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lfh;Lnm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(F)F", line = 71)
    private static final float method101(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IF)I", line = 81)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIF)F", line = 144)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(IIF)F", line = 153)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "()V", line = 164)
