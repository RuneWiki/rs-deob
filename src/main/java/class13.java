...
@OriginalClass("client!ETTRSMMZ")
public class class13 {

    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "I")
    private int field663 = -261;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "c", descriptor = "I")
    private int field665 = 30484;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "d", descriptor = "I")
    private int field666 = 9;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "j", descriptor = "[LQGBENKJV;")
    private class43[] field672 = new class43[10];

    @OriginalMember(owner = "client!ETTRSMMZ", name = "e", descriptor = "B")
    private static byte field667 = -107;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "f", descriptor = "[LETTRSMMZ;")
    private static class13[] field668 = new class13[5000];

    @OriginalMember(owner = "client!ETTRSMMZ", name = "g", descriptor = "[I")
    public static int[] field669 = new int[5000];

    @OriginalMember(owner = "client!ETTRSMMZ", name = "k", descriptor = "I")
    private int field673;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "l", descriptor = "I")
    private int field674;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "i", descriptor = "LMQZHAILV;")
    private static class33 field671;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "b", descriptor = "Z")
    private static boolean field664;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "h", descriptor = "[B")
    private static byte[] field670;

    @OriginalMember(owner = "client!ETTRSMMZ", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "(LMQZHAILV;B)V")
    ...
    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "(BII)LMQZHAILV;")
    ...
    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "(II)LMQZHAILV;")
    ...
    @OriginalMember(owner = "client!ETTRSMMZ", name = "a", descriptor = "(I)I")
