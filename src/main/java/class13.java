...
public class class13 extends class601 {
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IB)I", line = 46)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)I", line = 83)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(ILqea;)V", line = 94)
    public class13(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lqea;)V", line = 121)
    public class13(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(I)I", line = 152)
