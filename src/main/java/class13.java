...
public class class13 extends class305 implements class182 {
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lih;ILjava/nio/ByteBuffer;)V")
    public class13(class330 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field145 = arg1;
    }

    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lih;I[BI)V")
    public class13(class330 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field145 = arg1;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(Lam;)V")
