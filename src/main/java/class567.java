...
public class class567 extends class233 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!fa", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 6)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!fa", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 33)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(B)I", line = 55)
    public final int method1553(byte arg0) {
        return arg0 <= 59 ? -73 : this.field7850;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)Lq;", line = 65)
    public final class674 method1552(boolean arg0) {
        return arg0 ? (class674) this.field7852.method3623(0) : (class674) null;
    }

    @OriginalMember(owner = "client!fa", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 75)
    ...
    @OriginalMember(owner = "client!fa", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 84)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method3326(arg0.getY(), arg0.getX(), 87);
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 91)
    ...
    @OriginalMember(owner = "client!fa", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 117)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method3326(arg0.getY(), arg0.getX(), 125);
    }

    @OriginalMember(owner = "client!fa", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 124)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method3326(arg0.getY(), arg0.getX(), 105);
    }

    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIIB)V", line = 152)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(Z)Z", line = 168)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(I)Z", line = 189)
    ...
    @OriginalMember(owner = "client!fa", name = "f", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III)V", line = 223)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Z)Z", line = 243)
    ...
    @OriginalMember(owner = "client!fa", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 255)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(I)I", line = 284)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 313)
    public class567(Component arg0, boolean arg1) {
        this.method3322(arg0, (byte) -69);
        this.field7858 = arg1;
    }

    @OriginalMember(owner = "client!fa", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 299)
