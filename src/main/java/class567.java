...
public class class567 extends class56 {
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILee;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IZ)[I", line = 83)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "()V", line = 499)
    public class567() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qi", name = "e", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IILuu;IIIIIIII)Z", line = 239)
