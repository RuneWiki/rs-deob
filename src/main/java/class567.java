...
public class class567 {
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(II)Ljq;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIII)Lwk;")
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(II)Lga;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lw;III[Z)V")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lvd;ILpe;Lpe;Lpe;)V")
