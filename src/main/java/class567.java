...
public class class567 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lac;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lac;Ljaclib/memory/Buffer;)V", line = 21)
