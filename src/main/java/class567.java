...
public class class567 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIILtd;I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 159)
