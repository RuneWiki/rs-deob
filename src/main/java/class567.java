...
public class class567 extends class408 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lcs;I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILcs;)Z", line = 78)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 102)
