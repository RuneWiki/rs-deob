...
public class class567 implements Runnable {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "()J", line = 120)
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "()V", line = 128)
    ...
    @OriginalMember(owner = "client!ls", name = "e", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lvca;)V", line = 146)
    ...
    @OriginalMember(owner = "client!ls", name = "f", descriptor = "()Z", line = 162)
