...
public class class567 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BII)Z", line = 15)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lgj;Lgj;IF)Z", line = 28)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILin;I)Ljf;", line = 178)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lqo;)V", line = 201)
