...
public class class567 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;Lub;IIII)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;Leh;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;IIII)Lgj;")
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(Loa;IIII)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Le;III)I")
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(Loa;)Lgj;")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;II)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lbi;Lrg;Lik;Lrea;Luk;Lkd;Laba;)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)Lrda;")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Le;II)V")
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)Lo;")
    public static final class28 method3123(int arg0) {
        return (class28) field7491.method2918((long) arg0, (byte) -11);
    }

    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(II)Lo;")
