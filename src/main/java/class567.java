...
public class class567 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lrh;II)V", line = 186)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lrv;Lqw;Lvia;IIIII)V", line = 236)
