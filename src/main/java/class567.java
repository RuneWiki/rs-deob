...
public class class567 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILr;ILhv;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lda;ILr;IZIIILq;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ZILr;ZZII)Lda;")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lr;Lbda;IIIIIIZI)V")
