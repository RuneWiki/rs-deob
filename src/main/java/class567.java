...
public class class567 extends class232 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lsf;Lnw;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lnw;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lwi;)V")
    public final synchronized void method3203(class232 arg0) {
        arg0.method175(30604);
    }

    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(Lwi;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "()Lwi;")
    public final class232 method304() {
        return (class232) this.field7847.method374((byte) 86);
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "()Lwi;")
