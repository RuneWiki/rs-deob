...
public class class567 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILtia;I)V")
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
