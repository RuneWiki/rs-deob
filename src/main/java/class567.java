...
public class class567 extends class581 implements class558 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 35)
    public final int method986() {
        return this.method4240(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIIIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 58)
    public class567(class721 arg0, int arg1, int arg2) {
        this.method4238(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 68)
    public final void method130(boolean arg0) {
        this.method4239(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 72)
