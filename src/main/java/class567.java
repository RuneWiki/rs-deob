...
public class class567 extends class514 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lwd;IIILjava/awt/Component;)Lkv;")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(B)Lsq;")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IILjava/lang/String;Lkga;)Lqb;")
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Lpe;Lop;IIIIIIIIIIIII)V")
