...
public class class567 implements class169 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLej;)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)Lkq;")
    public class696 method726(int arg0) {
        field8296++;
        return arg0 == -17 ? null : null;
    }

    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lvn;Lmf;IIIIIII)V")
