...
public class class567 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "([[BI[[B[II[II[B)I", line = 36)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)Lkb;", line = 91)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lkb;B)V", line = 131)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)Lkb;", line = 148)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(B)Lkb;", line = 200)
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(B)Lkb;", line = 221)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "()V", line = 251)
    public class567() {
