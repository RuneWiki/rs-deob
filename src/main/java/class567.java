...
public class class567 extends class90 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILuv;)V", line = 38)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)Ljava/lang/String;", line = 108)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IZI)V", line = 139)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(I)V", line = 163)
