...
public class class567 extends class751 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "()V", line = 86)
    public class567() {
        super(0, false);
    }

    @OriginalMember(owner = "client!md", name = "b", descriptor = "(II)Lpb;", line = 89)
    ...
    @OriginalMember(owner = "client!md", name = "d", descriptor = "(B)I", line = 114)
    ...
    @OriginalMember(owner = "client!md", name = "e", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILrv;I)V", line = 152)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)Z", line = 176)
