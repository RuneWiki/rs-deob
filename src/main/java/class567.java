...
public class class567 extends class158 {
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lkw;II[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!lda", name = "d", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ZI)V", line = 59)
