...
public class class567 extends class172 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILgga;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BLhia;)V")
