...
public class class655 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)I", line = 15)
    public final int method3679(byte arg0) {
        field9114++;
        return arg0 > -14 ? 47 : this.field9107;
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)Lvt;", line = 26)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(II)I", line = 88)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lvt;)V", line = 100)
    public class655(class307 arg0) {
        this.field9111 = arg0.field4047;
        this.field9107 = 1;
    }

    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "([Lvt;)V", line = 108)
    public class655(class307[] arg0) {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BLvt;)V", line = 125)
