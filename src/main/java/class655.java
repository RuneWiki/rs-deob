...
public class class655 extends class340 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(FLsa;BLsa;)Z")
    ...
    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(I)Lsa;")
    public final class187 method1959(int arg0) {
        field9302++;
        return arg0 == -1199488062 ? this.field9298 : null;
    }

    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Lkga;I)V")
