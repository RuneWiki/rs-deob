...
public class class655 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)I", line = 160)
    public final int method3585(int arg0) {
        field8872++;
        return arg0 <= 99 ? 10 : this.field8875 & 0x3FFF;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(II)V", line = 171)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 185)
