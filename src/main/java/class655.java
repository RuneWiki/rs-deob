...
public class class655 extends class46 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lsg;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIIIIB)V", line = 27)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IZIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 100)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(Lsg;I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Ljava/io/File;B)[B", line = 150)
