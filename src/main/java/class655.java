...
public class class655 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Ljava/lang/String;IC)I")
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lda;)V")
    public class655(class59 arg0) {
        this.field8991 = arg0;
    }

    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lda;Lqm;)V")
