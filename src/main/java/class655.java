...
public abstract class class655 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IBIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)Lcga;", line = 27)
    public final class482 method3695(byte arg0) {
        field9142++;
        return arg0 == -79 ? this.field9133 : null;
    }

    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(B)D", line = 42)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)Z", line = 62)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!pb", name = "e", descriptor = "(I)Lsb;", line = 310)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 324)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(B)V", line = 374)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZB)V", line = 410)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(B)Z", line = 442)
    ...
    @OriginalMember(owner = "client!pb", name = "f", descriptor = "(I)Lwda;", line = 468)
    ...
    @OriginalMember(owner = "client!pb", name = "g", descriptor = "(I)Lrd;", line = 482)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(I)V", line = 601)
