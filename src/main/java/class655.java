...
public class class655 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lr;I)Lf;")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ILnp;)V")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ILks;)Z")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZZLr;)Lf;")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lnp;IB)V")
