...
public class class655 extends class415 {
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)Lgp;")
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(B)Llt;")
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lhea;IIIIII)V")
