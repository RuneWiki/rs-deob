...
public class class655 extends class325 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IB)[[I", line = 57)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljp;IB)V", line = 125)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "()V", line = 175)
    public class655() {
        super(1, false);
    }
}
