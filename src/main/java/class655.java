...
public abstract class class655 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IZIIILjava/lang/String;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!nv", name = "destroy", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!nv", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 93)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field9107++;
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!nv", name = "run", descriptor = "()V", line = 133)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BZ)V", line = 255)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)V", line = 327)
    ...
    @OriginalMember(owner = "client!nv", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 384)
    public final void windowActivated(WindowEvent arg0) {
        field9135++;
    }

    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)Z", line = 391)
    ...
    @OriginalMember(owner = "client!nv", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 403)
    public final void windowOpened(WindowEvent arg0) {
        field9137++;
    }

    @OriginalMember(owner = "client!nv", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 411)
    public final void windowDeactivated(WindowEvent arg0) {
        field9128++;
    }

    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(I)Z", line = 418)
    ...
    @OriginalMember(owner = "client!nv", name = "start", descriptor = "()V", line = 457)
    ...
    @OriginalMember(owner = "client!nv", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 470)
    public final void windowClosed(WindowEvent arg0) {
        field9129++;
    }

    @OriginalMember(owner = "client!nv", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 483)
    public static final void provideLoaderApplet(Applet arg0) {
        class348.field4462 = arg0;
        field9104++;
    }

    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(Z)V", line = 491)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBILjava/lang/String;III)V", line = 523)
    ...
    @OriginalMember(owner = "client!nv", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 570)
    ...
    @OriginalMember(owner = "client!nv", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 586)
    public final void focusLost(FocusEvent arg0) {
        class681.field9383 = false;
        field9118++;
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lmea;)V", line = 595)
    ...
    @OriginalMember(owner = "client!nv", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 687)
    ...
    @OriginalMember(owner = "client!nv", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 708)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(B)Ljava/lang/String;", line = 722)
    ...
    @OriginalMember(owner = "client!nv", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 733)
    public final void windowDeiconified(WindowEvent arg0) {
        field9123++;
    }

    @OriginalMember(owner = "client!nv", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 740)
    ...
    @OriginalMember(owner = "client!nv", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 763)
    ...
    @OriginalMember(owner = "client!nv", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 779)
    public final void windowIconified(WindowEvent arg0) {
        field9130++;
    }

    @OriginalMember(owner = "client!nv", name = "stop", descriptor = "()V", line = 788)
    ...
    @OriginalMember(owner = "client!nv", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 803)
    ...
    @OriginalMember(owner = "client!nv", name = "e", descriptor = "(I)V", line = 820)
    ...
    @OriginalMember(owner = "client!nv", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 868)
