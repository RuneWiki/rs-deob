...
public class class655 implements Runnable {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;I)Leea;", line = 6)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!oo", name = "run", descriptor = "()V", line = 43)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILac;)V", line = 95)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "()V", line = 112)
    public class655() {
        try {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZI[Ljava/awt/Rectangle;)V", line = 124)
