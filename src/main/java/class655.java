...
public class class655 extends class362 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 43)
    public class655(String arg0) {
        this.field8994 = arg0;
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BI)V", line = 26)
