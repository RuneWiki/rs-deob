...
public class class655 extends class539 {
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!sn", name = "e", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILka;Lal;Lha;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILfq;BIILha;Z)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IBLha;I)Lka;")
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "(Lha;B)Lln;")
