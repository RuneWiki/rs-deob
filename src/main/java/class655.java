...
public class class655 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lhm;I)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ler;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ler;Ljava/lang/Object;II)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ler;BLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ler;B)V")
