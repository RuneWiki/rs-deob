...
public class class655 implements class752 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lwc;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILwc;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILwc;Z)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILwc;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lwc;[III)V")
