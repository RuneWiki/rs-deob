...
public class class655 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIILwr;)V", line = 20)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)V", line = 48)
