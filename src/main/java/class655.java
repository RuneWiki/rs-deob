...
public class class655 implements class167 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lbt;ILbt;I)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IBLda;ILjava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lqia;Lfd;)V")
