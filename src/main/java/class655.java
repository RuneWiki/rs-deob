...
public class class655 extends class46 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IFIBIFIFFI[F)V", line = 3)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZIILjava/lang/String;)I", line = 111)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(B)Z", line = 200)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(I)V", line = 300)
