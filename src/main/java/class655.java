...
public class class655 extends class547 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lkl;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lkl;IIIIIIIIIIIZZ)V")
