...
public class class655 extends class241 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I[IIIILsia;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lsia;BI)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "()Leia;")
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "()Leia;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lig;IILgh;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Ldia;)V")
