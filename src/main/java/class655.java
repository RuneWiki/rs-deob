...
public class class655 implements class104 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[FIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)Z", line = 111)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)V", line = 132)
    public static void method3692(byte arg0) {
        field9114 = null;
        int var1 = 14 / ((55 - arg0) / 35);
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lsea;Lsea;Lcca;)V", line = 154)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZZ)V", line = 166)
