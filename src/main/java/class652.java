...
public class class652 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)Ldj;")
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(Lcda;ILkea;)V")
    public class652(class149 arg0, int arg1, class203 arg2) {
        this.field9395 = arg2;
        this.field9395.method1309(1675886592, 5);
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II)Lkda;")
