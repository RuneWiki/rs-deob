...
public class class652 implements Runnable {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)Lmc;", line = 3)
    ...
    @OriginalMember(owner = "client!pb", name = "run", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lvg;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)Z", line = 160)
