...
public abstract class class652 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IBZI)I", line = 63)
