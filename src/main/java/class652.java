...
public class class652 extends class401 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBLin;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIFII)V", line = 44)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lr;ILko;)I", line = 185)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[II)V", line = 208)
    ...
    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(II)V", line = 336)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 352)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BIII)V", line = 378)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIB[BII)V", line = 398)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lhca;IIIII)V", line = 429)
