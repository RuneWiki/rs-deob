...
public class class652 extends class325 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Ljp;Z)Lpaa;")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Ljp;IB)V")
    ...
    @OriginalMember(owner = "client!lha", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ZLwp;B)V")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILha;)V")
