...
public class class652 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)J", line = 79)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I[Ljava/lang/String;BI[S)V", line = 101)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZII)Llba;", line = 161)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 202)
