...
public class class652 extends class204 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BLgs;)V")
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(ILfs;)V")
    public class652(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lfs;)V")
