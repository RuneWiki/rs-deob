...
public class class652 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Lgj;Llu;Z)V")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILvi;)V")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(B)Lwaa;")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILwl;)V")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILcn;)V")
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(ILcn;)V")
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(B)Lgv;")
