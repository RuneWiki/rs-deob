...
public class class652 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILpt;Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(ILes;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lfia;", line = 93)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Les;Z)V", line = 115)
