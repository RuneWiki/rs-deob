...
public class class652 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)Lii;")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(JLii;B)V")
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(B)Lii;")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "([Lii;I)I")
    ...
    @OriginalMember(owner = "client!waa", name = "e", descriptor = "(B)Lii;")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(JI)Lii;")
