...
public class class652 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Llo;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZLlo;)V", line = 32)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(I)Lfga;", line = 67)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(BLwu;)V", line = 84)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILwda;)V", line = 110)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(I)Z", line = 124)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 140)
