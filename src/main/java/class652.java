...
public class class652 extends class573 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!fh", name = "f", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!fh", name = "e", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lwc;IB)V", line = 114)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZI)V", line = 149)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)Z", line = 204)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lmh;Lwu;)V", line = 243)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)V", line = 279)
