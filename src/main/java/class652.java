...
public class class652 extends class518 {
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)[I", line = 9)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 127)
    public class652() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ILvo;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ILjc;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II)[[I", line = 173)
