...
public class class652 {
    ...
    @OriginalMember(owner = "client!go", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field9182++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)Lot;", line = 16)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)Lgo;", line = 51)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(IILkn;)V", line = 123)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILha;IB)V", line = 138)
