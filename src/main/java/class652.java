...
public class class652 {
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I)Ldaa;", line = 5)
    ...
    @OriginalMember(owner = "client!gja", name = "<init>", descriptor = "()V", line = 30)
    public class652() {
    }

    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(I)Ldaa;", line = 33)
    ...
    @OriginalMember(owner = "client!gja", name = "<init>", descriptor = "(Lpf;)V", line = 52)
