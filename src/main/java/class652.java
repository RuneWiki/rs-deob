...
public class class652 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lfo;B)V", line = 45)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)Lfo;", line = 73)
    ...
    @OriginalMember(owner = "client!fo", name = "c", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(I)V", line = 116)
    public class652(int arg0) {
        this.field8970 = arg0;
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(IIIIII)V", line = 123)
