...
public class class652 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(III[BIIII[B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([I[I[IBLkw;)V", line = 66)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILfaa;)V", line = 182)
