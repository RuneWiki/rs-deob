...
public class class652 extends class19 {
    ...
    @OriginalMember(owner = "client!lc", name = "d", descriptor = "()Lnr;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ltk;III)Llc;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "()Lnr;")
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Ltk;III)V")
