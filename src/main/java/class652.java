...
public class class652 extends class559 {
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "(Ldw;II[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!eja", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IZLuv;ZI)V", line = 105)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ZB)V", line = 187)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Z)V", line = 209)
