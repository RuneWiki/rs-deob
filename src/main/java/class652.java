...
public class class652 extends class530 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(ILah;)V", line = 38)
    public class652(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)I", line = 57)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(Z)Z", line = 139)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lah;)V", line = 159)
    public class652(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)Z", line = 167)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)I", line = 199)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)I", line = 210)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)I", line = 223)
