...
public class class652 extends class349 {
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(BI)[I", line = 5)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IIZZI)Lpq;", line = 36)
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "()V", line = 59)
    public class652() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jaa", name = "f", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(CI)Z", line = 80)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IBI)I", line = 118)
