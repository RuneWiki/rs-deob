...
public class signlink implements Runnable {
    ...
    @OriginalMember(owner = "sign/signlink", name = "jinglelen", descriptor = "I")
    ...
    @OriginalMember(owner = "sign/signlink", name = "startpriv", descriptor = "(Ljava/net/InetAddress;)V", line = 47)
    ...
    @OriginalMember(owner = "sign/signlink", name = "run", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "sign/signlink", name = "findcachedir", descriptor = "()Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "sign/signlink", name = "gethash", descriptor = "(Ljava/lang/String;)J", line = 129)
    ...
    @OriginalMember(owner = "sign/signlink", name = "looprate", descriptor = "(I)V", line = 145)
    public static final void looprate(int arg0) {
        looprate = arg0;
    }

    @OriginalMember(owner = "sign/signlink", name = "cacheload", descriptor = "(Ljava/lang/String;)[B", line = 149)
    ...
    @OriginalMember(owner = "sign/signlink", name = "cachesave", descriptor = "(Ljava/lang/String;[B)V", line = 159)
    ...
    @OriginalMember(owner = "sign/signlink", name = "opensocket", descriptor = "(I)Ljava/net/Socket;", line = 169)
    ...
    @OriginalMember(owner = "sign/signlink", name = "dnslookup", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 178)
    public static final String dnslookup(String arg0) {
        return "unknown";
    }

    @OriginalMember(owner = "sign/signlink", name = "startthread", descriptor = "(Ljava/lang/Runnable;I)V", line = 182)
    public static final void startthread(Runnable arg0, int arg1) {
        threadreqpri = arg1;
        threadreq = arg0;
    }

    @OriginalMember(owner = "sign/signlink", name = "openurl", descriptor = "(Ljava/lang/String;)Ljava/io/DataInputStream;", line = 186)
    ...
    @OriginalMember(owner = "sign/signlink", name = "reporterror", descriptor = "(Ljava/lang/String;)V", line = 202)
    public static final void reporterror(String arg0) {
        ...
        try {
            ...
            DataInputStream var4 = openurl("reporterror" + 194 + ".cgi?error=" + errorname + " " + var3);
            var4.readLine();
            var4.close();
