...
public class signlink implements Runnable {
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "startpriv", descriptor = "(Ljava/net/InetAddress;)V", line = 47)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "run", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "findcachedir", descriptor = "()Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "gethash", descriptor = "(Ljava/lang/String;)J", line = 129)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "looprate", descriptor = "(I)V", line = 145)
    public static final void looprate(int arg0) {
        looprate = arg0;
    }

    @OriginalMember(owner = "client!sign/signlink", name = "cacheload", descriptor = "(Ljava/lang/String;)[B", line = 149)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "cachesave", descriptor = "(Ljava/lang/String;[B)V", line = 159)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "opensocket", descriptor = "(I)Ljava/net/Socket;", line = 169)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "dnslookup", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 178)
    public static final String dnslookup(String arg0) {
        return "unknown";
    }

    @OriginalMember(owner = "client!sign/signlink", name = "startthread", descriptor = "(Ljava/lang/Runnable;I)V", line = 182)
    public static final void startthread(Runnable arg0, int arg1) {
        threadreqpri = arg1;
        threadreq = arg0;
    }

    @OriginalMember(owner = "client!sign/signlink", name = "openurl", descriptor = "(Ljava/lang/String;)Ljava/io/DataInputStream;", line = 186)
    ...
    @OriginalMember(owner = "client!sign/signlink", name = "reporterror", descriptor = "(Ljava/lang/String;)V", line = 202)
