...
public class class387 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILcea;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lbp;B)Z")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BLii;Llga;ILha;I)Z")
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lcea;)V")
