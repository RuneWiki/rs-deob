...
public class class387 extends class404 implements class241 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(FFFFFFLea;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 15)
    protected final void finalize() {
        class313.method1863(this, -50);
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IILea;II)V", line = 25)
    public final void method351(int arg0, int arg1, class113 arg2, int arg3, int arg4) {
        this.method2308(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lh;Lba;[IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lh;Lba;IIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!n", name = "V", descriptor = "(III)V", line = 36)
