...
public class class387 extends class627 {
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(IILha;IIIIIB)V")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(Lkj;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
