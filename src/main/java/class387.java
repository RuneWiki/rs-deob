...
public class class387 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lgf;B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IJ)V", line = 47)
