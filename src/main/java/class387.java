...
public class class387 extends class86 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(ILsf;)V", line = 45)
    public class387(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lsf;)V", line = 54)
    public class387(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)I", line = 68)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 111)
