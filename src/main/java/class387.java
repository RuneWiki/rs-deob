...
public class class387 extends class42 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(JI)V", line = 10)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 115)
    public class387() {
    }

    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(I)V", line = 117)
    public class387(int arg0) {
        this.field5264 = arg0;
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIZIFIIII)[[I", line = 125)
