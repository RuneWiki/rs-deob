...
public class class387 extends class348 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lkg;Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)V", line = 118)
