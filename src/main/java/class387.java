...
public abstract class class387 extends class209 {
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLoa;Lnt;IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZZ)Z", line = 61)
