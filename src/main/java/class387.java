...
public abstract class class387 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BLqj;)V", line = 13)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)I", line = 24)
    public static final int method2527(int arg0) {
        field5784++;
        return arg0 == -1 ? class368.field5476 : 10;
    }

    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "(I)V", line = 90)
