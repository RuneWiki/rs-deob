...
public class class387 implements Runnable {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I[Ljava/lang/String;II)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZII[B)I", line = 82)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BI)Z", line = 126)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 311)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ILjava/io/File;Z[B)V", line = 230)
    ...
    @OriginalMember(owner = "client!dfa", name = "run", descriptor = "()V", line = 248)
