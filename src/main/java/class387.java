...
public class class387 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lig;ILjava/lang/String;)Llc;", line = 4)
    ...
    @OriginalMember(owner = "client!lc", name = "finalize", descriptor = "()V", line = 27)
    protected final void finalize() throws Throwable {
        this.field5471.method981(this.field5470);
        super.finalize();
    }

    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lig;II)V", line = 31)
