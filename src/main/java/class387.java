...
public class class387 extends class16 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IILma;II)V")
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(FFFFFFLma;II)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lug;IIII)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lug;II[III)V")
