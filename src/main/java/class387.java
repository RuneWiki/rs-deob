...
public class class387 extends class345 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "([Ldh;Z)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lya;J)Z")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "()Lpv;")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lya;J[Lng;[Ldh;Z)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lya;[Lng;Z)V")
