...
public class class387 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IBLre;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([[[Lke;ZIIII)Z", line = 36)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lre;Z)V", line = 354)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILe;II)V", line = 395)
