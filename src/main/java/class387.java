...
public class class387 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lq;I)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ldj;)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ldj;I)V")
