...
public class class387 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)Loa;", line = 4)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "([IZ)Ljava/lang/String;", line = 29)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(II)I", line = 96)
    public static int method2454(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 113)
