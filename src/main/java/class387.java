...
public class class387 extends class356 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "()I", line = 3)
    public final int method2315() {
        return this.field5842.field199 + this.field5844 + this.field5846;
    }

    @OriginalMember(owner = "client!bl", name = "d", descriptor = "()I", line = 7)
    public final int method2325() {
        return this.field5842.field199;
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(FFFFFFIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(FFFFFFLq;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "()I", line = 306)
    public final int method2318() {
        return this.field5842.field196 + this.field5843 + this.field5840;
    }

    @OriginalMember(owner = "client!bl", name = "e", descriptor = "()V", line = 309)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lsq;IIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lsq;II[III)V", line = 600)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(IIIIIII)V", line = 323)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 463)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IILq;II)V", line = 490)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(III)V", line = 546)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "()I", line = 565)
    public final int method2324() {
        return this.field5842.field196;
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIIII)V", line = 571)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(IIII)V", line = 588)
