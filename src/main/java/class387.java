...
public class class387 extends class432 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 17)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(IIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BII)V", line = 96)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BI)I", line = 119)
