...
public class class387 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/lang/Object;IJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(JB)V", line = 15)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 43)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ldha;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(I)V", line = 149)
    public class387(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ZJILjava/lang/Object;)V", line = 153)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(B)I", line = 214)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(I)I", line = 319)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 331)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIII)I", line = 375)
    ...
    @OriginalMember(owner = "client!pa", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 387)
    ...
    @OriginalMember(owner = "client!pa", name = "f", descriptor = "(I)V", line = 418)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(II)V", line = 430)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(B)I", line = 446)
