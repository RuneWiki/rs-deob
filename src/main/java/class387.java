...
public class class387 implements Runnable {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IILkv;)Ldd;", line = 26)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IILuv;IBLej;Laa;ILjava/lang/String;Lda;II)V", line = 44)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILkv;B)Ldd;", line = 103)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Ldd;I)V", line = 138)
    ...
    @OriginalMember(owner = "client!qw", name = "run", descriptor = "()V", line = 156)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "([BLkv;II)Ldd;", line = 201)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lrp;)V", line = 258)
