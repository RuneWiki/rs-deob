...
public class class387 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!vk", name = "toString", descriptor = "()Ljava/lang/String;", line = 26)
    public final String toString() {
        field5363++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "([IB[Ljava/lang/Object;)V", line = 41)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(I)V", line = 60)
