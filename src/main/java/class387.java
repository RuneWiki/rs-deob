...
public class class387 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZ)[B", line = 16)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z[B)V", line = 122)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ljp;Z)Lwf;", line = 170)
