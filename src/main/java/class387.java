...
public class class387 extends class189 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lsv;IB)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIIIIILjg;)V")
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lih;Lpq;)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLjg;)I")
