...
public class class387 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lgh;III)V")
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(I)Lmv;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIILse;)V")
