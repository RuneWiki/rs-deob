...
public class class387 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Lwg;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z[BILap;IIII)Lhea;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lwd;)V")
