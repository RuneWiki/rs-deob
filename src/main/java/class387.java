...
public class class387 extends class145 {
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 188)
    public class387() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(II)Lac;", line = 35)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lap;BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILoo;)Z", line = 152)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IB)V", line = 204)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZI)[[I", line = 456)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "(I)V", line = 509)
