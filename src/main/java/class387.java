...
public class class387 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZIZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lqg;)V", line = 130)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIB)V", line = 84)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLgo;I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IB)Z", line = 156)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(III)I", line = 172)
