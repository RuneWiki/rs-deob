...
public class class387 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(I)V", line = 57)
