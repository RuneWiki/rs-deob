...
public class class387 implements class410 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZII)V", line = 27)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIIILhw;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Lla;Lkc;)V", line = 331)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Z)V", line = 340)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZB)V", line = 359)
