...
public class class387 extends class286 {
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!tc", name = "i", descriptor = "(I)V", line = 65)
