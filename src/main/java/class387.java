...
public class class387 extends class210 implements class113 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Leq;Z)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIILbp;IZLeq;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIII)Lbn;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILeq;Z)Lva;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLeq;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(IIIIIIIIIILjo;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Leq;Z)Lgl;")
