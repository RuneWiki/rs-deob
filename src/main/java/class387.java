...
public class class387 extends class512 {
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IB)[I", line = 44)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 82)
    public class387() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 89)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(ZII)Ljava/lang/String;", line = 175)
