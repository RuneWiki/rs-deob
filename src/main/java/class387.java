...
public class class387 extends class418 {
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILrj;ILtj;ZIIIILmd;)Lqb;", line = 39)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)I", line = 287)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Ltj;Lkm;III)V", line = 420)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I[I[IZB)J", line = 466)
