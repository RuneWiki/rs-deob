...
public class class387 extends class191 implements class47 {
    ...
    @OriginalMember(owner = "client!xa", name = "W", descriptor = "(IIIIII)V", line = 4)
    public final void method31(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!xa", name = "finalize", descriptor = "()V", line = 10)
    protected final void finalize() {
        class342.method2198(this, (byte) -50);
    }

    @OriginalMember(owner = "client!xa", name = "V", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lh;Lba;[I[BIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFFFFFLea;II)V", line = 35)
