...
public class class387 extends class407 implements class300 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILoa;Ljd;Lvu;)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lmc;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IILen;Ljava/lang/String;)Lhba;")
