...
public class class387 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Z)V", line = 38)
