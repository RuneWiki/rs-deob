...
public class class387 implements class33 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)[Lsda;", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Z)Z", line = 86)
    public final boolean method157(boolean arg0) {
        field5218++;
        return arg0 ? false : this.field5217.method3849(this.field5214.field397, arg0);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILsp;)V", line = 98)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZI)V", line = 161)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Ltf;Laea;)V", line = 186)
