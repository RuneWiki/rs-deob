...
public class class387 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(II)V", line = 14)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ILuu;I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lmh;)V", line = 155)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IBZIIZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)V", line = 136)
