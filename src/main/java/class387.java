...
public class class387 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IB)Lim;")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILrm;Lr;IIIIB)Lf;")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILla;BZIILrm;ZLr;ILr;I)Lf;")
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lsea;IZLke;Lmv;Lmv;)V")
