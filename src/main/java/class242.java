...
public class class242 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lqk;I)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)V", line = 48)
