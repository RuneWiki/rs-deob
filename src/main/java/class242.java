...
public class class242 extends class93 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILli;Lcu;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Z)Lrd;", line = 113)
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lqa;)V", line = 192)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lvj;IIIIII)V", line = 273)
