...
public class class242 extends class354 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lrf;I)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(FLdn;ZII)V")
