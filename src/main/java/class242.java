...
public class class242 {
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "()Lqq;")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lnl;II)Lju;")
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lkk;)V")
