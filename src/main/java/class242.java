...
public class class242 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILob;)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!m", name = "c", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILm;Lob;)V")
    ...
    @OriginalMember(owner = "client!m", name = "e", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lm;I)V")
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(B)Lob;")
    ...
    @OriginalMember(owner = "client!m", name = "h", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZLob;)V")
