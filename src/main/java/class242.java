...
public class class242 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "([IBI)Lbg;", line = 3)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IZI[I)Lbg;", line = 54)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BI[II)Lbg;", line = 90)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB[I)Lbg;", line = 146)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III[Lbr;IIIIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(I)V", line = 843)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 861)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Ltj;Ltj;)V", line = 884)
