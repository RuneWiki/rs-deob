...
public class class242 extends class481 implements class483 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIII[III)V", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 43)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLqaa;)V", line = 54)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(FB)F", line = 64)
    public final float method787(float arg0, byte arg1) {
        return arg1 < 24 ? -0.14824681F : arg0 / (float) this.field3461;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "([BIIILkf;ZIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)I", line = 126)
    public final int method785(int arg0) {
        return arg0 > -55 ? -73 : this.field3461;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)Z", line = 136)
    public final boolean method788(boolean arg0) {
        return arg0 ? true : true;
    }

    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lvg;IIZ[III)V", line = 147)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZIZ)V", line = 204)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(FI)F", line = 215)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)I", line = 225)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lvg;Lkf;IIZ[BII)V", line = 235)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lvg;Lkf;Lps;II)V", line = 292)
