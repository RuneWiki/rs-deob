...
public class class242 extends class338 {
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III)I", line = 29)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BJ)V", line = 45)
