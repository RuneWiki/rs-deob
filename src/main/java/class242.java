...
public class class242 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILjava/lang/String;)V", line = 17)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I[BI)I", line = 44)
