...
public class class242 extends class220 {
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(Ldp;Lfv;IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Z)Lg;", line = 15)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(ILs;)V", line = 28)
    public static final void method1547(int arg0, class278 arg1) {
        class459.field6474[arg0] = arg1;
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IILha;)V", line = 39)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(I)[Lbd;", line = 139)
