...
public class class242 extends class604 {
    ...
    @OriginalMember(owner = "client!dr", name = "g", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!dr", name = "e", descriptor = "(Z)Z", line = 22)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lha;B)Lsba;", line = 33)
    ...
    @OriginalMember(owner = "client!dr", name = "d", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IBILrfa;ZILha;)V", line = 55)
    ...
    @OriginalMember(owner = "client!dr", name = "finalize", descriptor = "()V", line = 65)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lha;III)Z", line = 76)
    ...
    @OriginalMember(owner = "client!dr", name = "g", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(Z)I", line = 101)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lha;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!dr", name = "d", descriptor = "(Z)Z", line = 148)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(IIIIIIIIIIIIZ)V", line = 192)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)Ljava/lang/String;", line = 169)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILha;Lqa;Lka;)V", line = 231)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(ZLha;)Lrs;", line = 267)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILha;I)Lka;", line = 312)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(B)I", line = 332)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BI)V", line = 344)
