...
public class class242 extends class260 {
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lav;ZI)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lgn;)V")
