...
public class class242 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILrt;B)V", line = 21)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IBI)I", line = 100)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIZIIIIBI)Z", line = 125)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BI)Z", line = 166)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILrt;)V", line = 209)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 230)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II)I", line = 260)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(BI)Ljava/lang/String;", line = 287)
