...
public class class242 extends class598 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lwp;)Laia;", line = 3)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
