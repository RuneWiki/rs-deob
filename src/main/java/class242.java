...
public class class242 extends OutputStream {
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(I[BII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!bja", name = "write", descriptor = "(I)V", line = 23)
    public final void write(int arg0) throws IOException {
        field3913++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(ILofa;)Lhca;", line = 62)
    ...
    @OriginalMember(owner = "client!bja", name = "b", descriptor = "(I)V", line = 76)
