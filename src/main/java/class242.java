...
public class class242 extends class229 {
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lnm;Lis;[Lff;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(CIIIZ)V", line = 212)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(CIIIZLus;II)V", line = 234)
