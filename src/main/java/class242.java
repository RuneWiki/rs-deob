...
public class class242 extends class496 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "()V", line = 42)
    public class242() {
    }

    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(J)V", line = 44)
