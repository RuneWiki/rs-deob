...
public abstract class class242 extends class662 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "([B[I[I[[BBI[[BI)I", line = 214)
