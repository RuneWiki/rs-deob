...
public abstract class class242 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILap;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lqa;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lrk;IBILeu;ILbp;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I[J[III)V", line = 193)
