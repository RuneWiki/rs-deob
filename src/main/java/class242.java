...
public class class242 {
    ...
    @OriginalMember(owner = "client!rga", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field3145++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 32)
    public class242(String arg0, int arg1) {
        this.field3144 = arg0;
        this.field3141 = arg1;
    }

    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Lgda;Lgda;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(II)[B", line = 63)
