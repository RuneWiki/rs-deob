...
public class class242 extends class423 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ue", name = "d", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IILha;)Lkaa;", line = 39)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lha;I)Lhk;", line = 55)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 78)
    ...
    @OriginalMember(owner = "client!ue", name = "d", descriptor = "(I)D", line = 133)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 150)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)F", line = 224)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 255)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)J", line = 336)
