...
public class class242 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "([ILnd;Lnd;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IILsl;)V", line = 57)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lsl;B)V", line = 87)
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(I)Z", line = 108)
