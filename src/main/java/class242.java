...
public class class242 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IB)Lee;", line = 33)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)V", line = 121)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lpca;ILbi;Lbi;)V", line = 143)
