...
public abstract class class242 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIILsc;)J", line = 6)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IZI)I", line = 39)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BI)V", line = 71)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(II)V", line = 153)
