...
public class class242 extends class98 {
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "()V", line = 4)
    public class242() {
        super(1, false);
    }

    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!un", name = "f", descriptor = "(B)Lgq;", line = 79)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILdg;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)[I", line = 136)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IZ)V", line = 189)
