...
public abstract class class242 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lva;II)Lel;", line = 14)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ZI)I", line = 176)
