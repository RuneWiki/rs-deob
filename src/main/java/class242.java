...
public class class242 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lr;Lqi;ILgs;Lwfa;IILhq;IILuaa;Lar;)Lda;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIILqi;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IBLgs;I)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIILmba;Lqi;ZILar;ILr;IIILuaa;[Ltf;Lhq;[IILhq;Lwfa;Lgs;)Lda;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lr;IIIILar;IIILhq;Lqi;I)Lda;")
