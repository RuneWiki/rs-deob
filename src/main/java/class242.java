...
public class class242 extends class551 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lgh;Loq;)Lel;")
    public final class574 method546(class575 arg0, class380 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IILso;ZLul;)Lgl;")
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/mba;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lsb;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lgj;I)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILmp;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I[Lug;)Lwp;")
    public final class193 method844(int arg0, class588[] arg1) {
        int var3 = 85 % ((arg0 - 49) / 32);
        return new dxVertexLayout(this, arg1);
    }

    @OriginalMember(owner = "client!aia", name = "c", descriptor = "(ZI)Lta;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Ljda;IIZ)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lel;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IIILjagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;)Z")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLwp;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILbo;)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILafa;)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ZLjda;)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILta;Lbo;BIII)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Len;Len;FLen;)Len;")
    public final class339 method535(class339 arg0, class339 arg1, float arg2, class339 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IBZ[[I)Lpj;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lbl;B)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IZIBII[I)Lgl;")
    ...
    @OriginalMember(owner = "client!aia", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lgj;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(III[FZIILul;)Lgl;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Ljda;ZIZI)V")
    ...
    @OriginalMember(owner = "client!aia", name = "h", descriptor = "(II)Lmr;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lul;Lso;I)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lso;ZLul;)Z")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lul;BLso;)Z")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IILbo;I)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLam;)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLww;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "d", descriptor = "(II)Lgh;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;B)V")
    ...
    @OriginalMember(owner = "client!aia", name = "c", descriptor = "(IZ)Lmha;")
    public final class438 method818(int arg0, boolean arg1) {
        return arg0 == 0 ? new class266(this, arg1) : (class438) null;
    }

    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I[BILul;II)Lvga;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLdj;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(II)Loq;")
    public final class380 method540(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!aia", name = "x", descriptor = "()Laja;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IBLmha;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lws;I)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "([BZILul;IIII)Lgl;")
