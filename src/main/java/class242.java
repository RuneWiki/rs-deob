...
public abstract class class242 extends class20 {
    ...
    @OriginalMember(owner = "client!rh", name = "j", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)I", line = 17)
    public static int method1474(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "([Lul;I)I", line = 24)
    ...
    @OriginalMember(owner = "client!rh", name = "d", descriptor = "(B)Z", line = 107)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(II)V", line = 118)
    ...
    @OriginalMember(owner = "client!rh", name = "g", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(IIIIII)V", line = 245)
