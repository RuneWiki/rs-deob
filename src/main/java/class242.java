...
public class class242 extends class624 {
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 114)
    public class242() {
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(B)J", line = 28)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(JB)I", line = 63)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)J", line = 96)
