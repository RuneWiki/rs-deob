...
public class class242 implements class182 {
    ...
    @OriginalMember(owner = "client!oq", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field3205++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIIIBIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(III)Z", line = 66)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/Object;ZII)[B", line = 229)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 267)
    public class242(String arg0, int arg1) {
        this.field3203 = arg1;
    }

    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 278)
