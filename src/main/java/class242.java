...
public class class242 extends class60 {
    ...
    @OriginalMember(owner = "client!rga", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(Lgf;Lrc;[Ljn;[I[I)V")
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
