...
public class class242 extends class452 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "([B[IIIIIIIIIIILq;II)V")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lkd;Lgh;[Lvp;[I[I)V")
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "([B[IIIIIIIIIIILq;II)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(CIIIZLq;II)V")
