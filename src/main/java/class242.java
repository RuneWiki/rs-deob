...
public class class242 extends class6 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIII)I", line = 13)
    ...
    @OriginalMember(owner = "client!eh", name = "f", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 67)
