...
public class class242 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 5)
    public static void method1524(int arg0) {
        int var1 = -123 / ((-arg0 - 18) / 59);
        field3520 = null;
    }

    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lkf;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(II)V", line = 47)
    public class242(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!du", name = "toString", descriptor = "()Ljava/lang/String;", line = 59)
    public final String toString() {
        field3517++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!du", name = "a", descriptor = "(II)V", line = 68)
