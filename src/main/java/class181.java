...
public class class181 extends class260 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(II)I", line = 42)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(ILgn;)V", line = 58)
    public class181(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gw", name = "d", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lgn;)V", line = 74)
    public class181(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(B)V", line = 78)
