...
public class class181 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljf;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIII)Z", line = 57)
