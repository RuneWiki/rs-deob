...
public abstract class class181 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ZB)V", line = 14)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)Z", line = 45)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(B)Z", line = 57)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(I)Z", line = 103)
