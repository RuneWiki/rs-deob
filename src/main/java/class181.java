...
public abstract class class181 extends class101 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILaj;II)Lwr;", line = 7)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z)V", line = 340)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 350)
    public class181(OggStreamState arg0) {
        this.field2400 = arg0;
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZLjagtheora/ogg/OggPacket;)V", line = 358)
