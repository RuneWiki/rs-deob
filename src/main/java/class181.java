...
public class class181 extends class20 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ZBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!efa", name = "g", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IIIZ)[B", line = 35)
