...
public class class181 extends class134 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(JJ)J", line = 3)
    public static long method1122(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Llha;Llha;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(II)V", line = 42)
