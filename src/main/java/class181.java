...
public class class181 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIZILza;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ZII)Z", line = 90)
    public static final boolean method1269(boolean arg0, int arg1, int arg2) {
        field2765++;
        return arg0 ? false : (arg2 & 0x220) == 544 | (arg2 & 0x18) != 0;
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIBI)V", line = 346)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lza;Lfh;I)V", line = 374)
