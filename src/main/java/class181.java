...
public class class181 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BLfd;IIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(CB)C", line = 88)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IILam;)Lnl;", line = 493)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lam;B)V", line = 517)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 528)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZI)V", line = 552)
