...
public class class181 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lgn;IZIII)Lgn;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IBIIIIBLgn;)Lgn;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lbt;II)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lbt;I)V")
