...
public class class181 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ILib;)V")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lib;ZI)V")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IIIBILrn;)V")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Ldf;III)V")
