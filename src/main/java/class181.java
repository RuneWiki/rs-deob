...
public class class181 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILrt;BILgn;Lpe;Lza;Leb;ILcf;ILvk;)Le;", line = 101)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IZ)V", line = 296)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZI)Z", line = 308)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I[IZZ[II)V", line = 320)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lpe;Lza;Lgn;ZLvk;II[Lah;Leb;ILpi;Lcf;IILeb;IILrt;I)Le;", line = 343)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Leb;Lgn;Lza;IIIIIIIBLcf;)Le;", line = 848)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lgn;III)V", line = 1013)
