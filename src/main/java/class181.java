...
public class class181 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BLpf;)I")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lag;ILvj;)Lvb;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lvj;I)V")
