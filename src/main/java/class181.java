...
public class class181 extends class115 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IS)V", line = 199)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "([[ZIZII)V", line = 280)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lvd;Lne;Lwr;[I)V", line = 341)
