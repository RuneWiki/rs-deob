...
public class class181 extends class404 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ljava/util/Random;[[IIIBII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILha;I)V", line = 207)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "()V", line = 621)
    public class181() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)[I", line = 307)
    ...
    @OriginalMember(owner = "client!ao", name = "h", descriptor = "(I)V", line = 561)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(I)V", line = 571)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IB)V", line = 600)
