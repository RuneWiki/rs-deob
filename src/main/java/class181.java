...
public class class181 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!up", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field2393++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(II)V", line = 37)
