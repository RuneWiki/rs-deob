...
public class class181 extends class398 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Llm;I)I", line = 9)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lnj;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lcd;I)I", line = 127)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "()V", line = 167)
    public class181() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)[I", line = 182)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(II)[[I", line = 211)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([[IB)V", line = 272)
