...
public abstract class class181 extends class544 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILvk;[[B)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Los;Z)V")
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IZB)V")
