...
public class class181 {
    ...
    @OriginalMember(owner = "client!tf", name = "n", descriptor = "Lhb;")
    public class71 field3417 = new class71();

    @OriginalMember(owner = "client!tf", name = "b", descriptor = "Llf;")
    public static class109 field3405 = class35.method275("und Ihr Passwort ein)3", 2);

    @OriginalMember(owner = "client!tf", name = "f", descriptor = "Llf;")
    public static class109 field3409 = class35.method275("Okay", 2);

    @OriginalMember(owner = "client!tf", name = "r", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!tf", name = "t", descriptor = "Lhb;")
    private class71 field3423;

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lhb;B)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)Lhb;")
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lhb;I)V")
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)Lhb;")
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lvg;II)I")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILhb;Lhb;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Llf;ILbg;Llf;BZI)V")
