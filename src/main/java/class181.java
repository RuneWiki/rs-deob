...
public class class181 extends class70 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILnfa;ZLnfa;IZI)I")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lnha;Ljn;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)Lvj;")
