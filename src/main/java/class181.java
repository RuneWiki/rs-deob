...
public class class181 extends class4 {
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lhd;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lhd;II)V")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lhd;IIZ[[BI)V")
