...
public class class181 extends class56 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BILes;)V", line = 9)
    ...
    @OriginalMember(owner = "client!cfa", name = "d", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "()V", line = 86)
    public class181() {
        super(1, true);
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(II)[I", line = 89)
