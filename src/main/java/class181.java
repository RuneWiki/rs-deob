...
public class class181 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)J", line = 38)
    public final long method1244(int arg0) throws IOException {
        field2613++;
        return arg0 == 0 ? this.field2621.length() : -23L;
    }

    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I[BII)I", line = 49)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLsea;)I", line = 67)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BJ)V", line = 133)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!pk", name = "finalize", descriptor = "()V", line = 171)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 186)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)Ljava/io/File;", line = 217)
