...
public class class181 extends InputStream {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!bb", name = "read", descriptor = "()I", line = 37)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(II)Lor;", line = 103)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)V", line = 127)
