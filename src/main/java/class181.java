...
public abstract class class181 extends class224 {
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(Lud;I)Lrt;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILbj;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IZLdm;I)V")
