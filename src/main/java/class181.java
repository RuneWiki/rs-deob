...
public class class181 extends class10 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IB)I", line = 5)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILjava/lang/String;)I", line = 47)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZLhp;)V", line = 84)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(III)Luq;", line = 134)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(II[I[I)V", line = 153)
