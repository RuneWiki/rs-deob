...
public class class181 extends class175 {
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 3)
    public class181() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(II)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILdt;Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZB)V", line = 75)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IB)[[I", line = 118)
