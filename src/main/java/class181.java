...
public class class181 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZB)V", line = 20)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BC)V", line = 95)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lgk;I)V", line = 129)
    public class181(class463 arg0, int arg1) {
        this.field2361 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 158)
