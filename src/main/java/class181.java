...
public class class181 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lhj;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([IIIIIIIIIIII)V")
