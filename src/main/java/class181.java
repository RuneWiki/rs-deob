...
public class class181 extends class478 {
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "()V", line = 4)
    public class181() {
        this(0);
    }

    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lce;BI)Z", line = 26)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIIIIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lsq;B)I", line = 208)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(I)V", line = 242)
    private class181(int arg0) {
        super(0, false);
        this.method1103(-123, arg0);
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILnp;I)V", line = 250)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZI)[[I", line = 281)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(II)V", line = 322)
