...
public class class181 implements Runnable {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ZI)Z")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ZLia;)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Ljava/lang/String;B)Lfu;")
