...
public abstract class class181 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIII)Lkv;")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lvb;")
