...
public class class181 extends class83 implements class116 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILoj;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(ILoj;)Lmg;", line = 49)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)I", line = 77)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 87)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Loj;IB)Lqh;", line = 117)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I[I[J)V", line = 149)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Loj;Lcu;IIIIIZIIIIIIZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)I", line = 204)
    public final int method26(byte arg0) {
        ++field2325;
        return arg0 != 73 ? 108 : this.field2317;
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILoj;II)Z", line = 231)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(ILoj;)V", line = 257)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)I", line = 284)
    public final int method16(boolean arg0) {
        ++field2339;
        return arg0 ? 76 : this.field2307 & 65535;
    }

    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)Z", line = 296)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(ILoj;)V", line = 307)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IBLg;I)Lob;", line = 317)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZBILoj;)Lpr;", line = 346)
    ...
    @OriginalMember(owner = "client!ju", name = "e", descriptor = "(I)V", line = 378)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILoj;B)Lqh;", line = 393)
    ...
    @OriginalMember(owner = "client!ju", name = "g", descriptor = "(I)I", line = 407)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(B)I", line = 424)
