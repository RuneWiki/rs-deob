...
public class class181 extends class430 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lla;II)Ltd;", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([BIBII[BIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 162)
    public class181() {
    }

    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(J)V", line = 164)
