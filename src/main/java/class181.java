...
public class class181 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)Lrc;", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(DI)V", line = 42)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!gf", name = "d", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "()V", line = 100)
    public class181() {
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lsi;)V", line = 130)
