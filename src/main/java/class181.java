...
public class class181 extends class89 implements class149 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Le;Z)Lum;")
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Le;Lfa;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILe;IIZLhm;I)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIILe;)Z")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ltm;B)V")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Le;IB)Lid;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Le;I)V")
