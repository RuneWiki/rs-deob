...
public class class181 implements class37 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BIILbda;)J", line = 7)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I[BILhj;)Lws;", line = 38)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(III)I", line = 81)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)Z", line = 134)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Luu;Luu;Lar;)V", line = 156)
