...
public class class181 extends class547 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!wfa", name = "f", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IILqaa;)V", line = 28)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IIIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(III[BI[BIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!wfa", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 218)
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 232)
