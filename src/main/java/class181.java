...
public class class181 extends class214 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IB)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILbc;BLdq;Ljava/awt/Canvas;)Lkm;", line = 313)
    ...
    @OriginalMember(owner = "client!nh", name = "f", descriptor = "(I)V", line = 339)
    ...
    @OriginalMember(owner = "client!nh", name = "g", descriptor = "(I)V", line = 443)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Llk;II)V", line = 483)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(B)V", line = 530)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(CI)Z", line = 552)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Throwable;)V", line = 568)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 650)
    public class181() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nh", name = "e", descriptor = "(I)V", line = 636)
    ...
    @OriginalMember(owner = "client!nh", name = "h", descriptor = "(I)V", line = 653)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(IB)V", line = 667)
