...
public class class181 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "()[F", line = 4)
    public final float[] method1205() {
        return this.field2752[this.method1207()];
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "()I", line = 19)
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "()V", line = 165)
    public class181() {
