...
public class class181 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(JLol;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Lol;", line = 44)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIIIII)Lqg;", line = 77)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(JI)Lol;", line = 121)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(I)V", line = 158)
