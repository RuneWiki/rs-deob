...
public class class181 extends class12 {
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(IIIIIFFF)V", line = 66)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IB)V", line = 132)
