...
public class class181 extends class125 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(ZI)V", line = 23)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILhe;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;)V", line = 50)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(III)V", line = 74)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lur;Lqf;)V", line = 154)
