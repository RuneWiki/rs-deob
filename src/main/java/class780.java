...
public class class780 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)I", line = 12)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)I", line = 180)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "()V", line = 256)
    private class780() {
    }

    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "([I)V", line = 265)
