...
public class class780 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([BB)[B", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Les;[BB)V", line = 26)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 71)
    public class780() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(III)V", line = 78)
