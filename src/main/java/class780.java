...
public class class780 extends class129 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lib;I)Lgca;", line = 3)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lcn;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ZB)V", line = 84)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lkd;)V", line = 97)
    public class780(class296 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ZI)V", line = 100)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Z)Z", line = 133)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIB)V", line = 150)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IILrca;)V", line = 161)
