...
public class class780 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILwq;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IZLwq;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
