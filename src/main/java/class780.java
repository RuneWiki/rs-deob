...
public class class780 implements class175 {
    ...
    @OriginalMember(owner = "client!mo", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field10745++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 41)
