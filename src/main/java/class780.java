...
public class class780 implements class316 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)Lhv;", line = 4)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(ILur;Lcf;II)V", line = 32)
