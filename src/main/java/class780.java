...
public class class780 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILaa;Luf;Lha;IIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lm;I)V", line = 192)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Ljg;Lha;Lll;I)V", line = 253)
