...
public class class492 extends class478 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lka;Lqa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lqa;II)Lka;", line = 111)
    ...
    @OriginalMember(owner = "client!vm", name = "finalize", descriptor = "()V", line = 127)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(Z)V", line = 140)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BI)V", line = 154)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILqa;)Lnj;", line = 214)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILtf;B)I", line = 253)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(Z)I", line = 287)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IBIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIILqa;)Z", line = 346)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 359)
    ...
    @OriginalMember(owner = "client!vm", name = "d", descriptor = "(I)Z", line = 396)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILdb;Lci;Lci;Lci;)Z", line = 407)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lqa;B)V", line = 426)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(Lqa;B)Lem;", line = 450)
