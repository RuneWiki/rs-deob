...
public class class492 extends class478 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILqn;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lqn;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(I)Lae;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Leq;ILts;)V")
