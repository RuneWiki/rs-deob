...
public class class492 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!pg", name = "toString", descriptor = "()Ljava/lang/String;", line = 42)
    public final String toString() {
        field7185++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(II)V", line = 99)
