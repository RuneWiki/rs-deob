...
public class class492 extends OutputStream {
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!k", name = "write", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIIIII)V", line = 70)
