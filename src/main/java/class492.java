...
public class class492 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)V", line = 261)
    public static void method2872(int arg0) {
        field6753 = null;
        int var1 = -59 % ((arg0 - 78) / 46);
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I[[ZZIII)V", line = 275)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lr;III)V", line = 476)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IILr;I)V", line = 553)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BIILr;)Z", line = 623)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIIII)V", line = 700)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lmj;Lsl;)V", line = 746)
