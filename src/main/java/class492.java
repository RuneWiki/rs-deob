...
public class class492 extends class434 {
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Llb;IZIBILza;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lza;IB)Le;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILe;Lza;)V")
