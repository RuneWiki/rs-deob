...
public class class492 extends class544 {
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "()V", line = 7)
    public class492() {
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(S)V", line = 22)
    public class492(short arg0) {
        this.field6867 = arg0;
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)V", line = 30)
