...
public class class492 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
