...
public class class492 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BI)V", line = 23)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)Lve;", line = 41)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lmw;ILhda;)Lpja;", line = 113)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lkw;ILuq;Luq;)V", line = 174)
