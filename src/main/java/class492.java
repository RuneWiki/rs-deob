...
public class class492 extends class140 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBB)V", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "()V", line = 20)
    public class492() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(IIII)[B", line = 31)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Z)V", line = 45)
