...
public class class492 extends class83 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ZI)V", line = 48)
    ...
    @OriginalMember(owner = "client!fu", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(III)V", line = 74)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)Z", line = 121)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IILav;)V", line = 136)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ZJ)Ljava/lang/String;", line = 149)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lhga;)V", line = 175)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BZ)V", line = 269)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lvj;Lud;)V", line = 309)
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(I)V", line = 320)
