...
public class class492 extends class38 {
    ...
    @OriginalMember(owner = "client!cj", name = "OA", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lpc;Lpc;FLpc;)Lpc;", line = 23)
    public final class477 method338(class477 arg0, class477 arg1, float arg2, class477 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!cj", name = "d", descriptor = "()Z", line = 26)
    public final boolean method295() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "i", descriptor = "(I)I", line = 29)
    public final int method2924(int arg0) {
        return super.field524.method584(true, arg0).field4263 & 65535;
    }

    @OriginalMember(owner = "client!cj", name = "DA", descriptor = "(IIIIII[BII)V", line = 32)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(II)I", line = 207)
    public final int method314(int arg0, int arg1) {
        int var3 = arg0 | 133120;
        return var3 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lu;)V", line = 210)
    public final void method281(class54 arg0) {
    }

    @OriginalMember(owner = "client!cj", name = "AA", descriptor = "(IIII)V", line = 213)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIILma;II)V", line = 221)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I[Lqp;)V", line = 458)
    public final void method359(int arg0, class470[] arg1) {
    }

    @OriginalMember(owner = "client!cj", name = "MA", descriptor = "(I)V", line = 460)
    public final void method321(int arg0) {
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 463)
    ...
    @OriginalMember(owner = "client!cj", name = "B", descriptor = "(F)V", line = 497)
    public final void method271(float arg0) {
        this.field7087 = (int) (arg0 * 65535.0F);
    }

    @OriginalMember(owner = "client!cj", name = "j", descriptor = "(I)[I", line = 501)
    ...
    @OriginalMember(owner = "client!cj", name = "ia", descriptor = "(II)V", line = 521)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 528)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIF)Lqp;", line = 559)
    public final class470 method322(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!cj", name = "o", descriptor = "()Z", line = 562)
    public final boolean method328() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "IA", descriptor = "()I", line = 565)
    public final int method353() {
        return 0;
    }

    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(IIIIII)Lpc;", line = 568)
    public final class477 method298(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lpc;)V", line = 570)
    public final void method370(class477 arg0) {
    }

    @OriginalMember(owner = "client!cj", name = "g", descriptor = "(I)Lu;", line = 573)
    public final class54 method337(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIZ)Ll;", line = 577)
    ...
    @OriginalMember(owner = "client!cj", name = "e", descriptor = "()V", line = 609)
    ...
    @OriginalMember(owner = "client!cj", name = "f", descriptor = "(I)V", line = 616)
    ...
    @OriginalMember(owner = "client!cj", name = "r", descriptor = "()V", line = 631)
    public final void method343() {
    }

    @OriginalMember(owner = "client!cj", name = "p", descriptor = "(I)V", line = 634)
    public final void method360(int arg0) {
        this.method284(0, 0, this.field7112, this.field7103, arg0, 0);
    }

    @OriginalMember(owner = "client!cj", name = "m", descriptor = "()Z", line = 637)
    public final boolean method323() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "C", descriptor = "()Z", line = 641)
    public final boolean method372() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "JA", descriptor = "(IIIIII)Z", line = 645)
    ...
    @OriginalMember(owner = "client!cj", name = "f", descriptor = "()Lc;", line = 675)
    public final class125 method296() {
        class64 var1 = this.method2927(Thread.currentThread());
        return var1.field786;
    }

    @OriginalMember(owner = "client!cj", name = "X", descriptor = "(III[I)V", line = 680)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIII)V", line = 703)
    public final void method287(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!cj", name = "TA", descriptor = "(IIIII)V", line = 706)
    ...
    @OriginalMember(owner = "client!cj", name = "w", descriptor = "()I", line = 783)
    ...
    @OriginalMember(owner = "client!cj", name = "g", descriptor = "(FF)V", line = 788)
    ...
    @OriginalMember(owner = "client!cj", name = "B", descriptor = "()V", line = 793)
    public final void method367() {
    }

    @OriginalMember(owner = "client!cj", name = "t", descriptor = "()Z", line = 796)
    public final boolean method347() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "p", descriptor = "()Z", line = 799)
    public final boolean method333() {
        return true;
    }

    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(II)I", line = 803)
    public final int method317(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 805)
    public final void method290(int arg0) {
    }

    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;)V", line = 808)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "()I", line = 813)
    public final int method308() {
        return this.field7109;
    }

    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 817)
    ...
    @OriginalMember(owner = "client!cj", name = "l", descriptor = "()V", line = 836)
    public final void method331() {
        this.field7092 = this.field7079;
        this.field7077 = false;
    }

    @OriginalMember(owner = "client!cj", name = "ZA", descriptor = "()I", line = 841)
    ...
    @OriginalMember(owner = "client!cj", name = "GA", descriptor = "(IIII)V", line = 846)
    ...
    @OriginalMember(owner = "client!cj", name = "i", descriptor = "()V", line = 850)
    public final void method306() {
    }

    @OriginalMember(owner = "client!cj", name = "A", descriptor = "()Z", line = 853)
    public final boolean method358() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "k", descriptor = "(I)[I", line = 858)
    ...
    @OriginalMember(owner = "client!cj", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 879)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([Lt;Lc;[Lju;I)V", line = 890)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([Lt;Lkp;Lc;[Lju;I)V", line = 906)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/Runnable;)Lps;", line = 923)
    ...
    @OriginalMember(owner = "client!cj", name = "n", descriptor = "()Z", line = 936)
    public final boolean method327() {
        return true;
    }

    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(Z)V", line = 939)
    public final void method289(boolean arg0) {
        this.field7076 = arg0;
        this.field7108.method93((byte) 115);
    }

    @OriginalMember(owner = "client!cj", name = "l", descriptor = "(I)Z", line = 943)
    public final boolean method2928(int arg0) {
        return super.field524.method579(arg0, true);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lt;Lkp;Lc;Lju;I)V", line = 946)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 949)
    ...
    @OriginalMember(owner = "client!cj", name = "y", descriptor = "()Z", line = 978)
    public final boolean method355() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "h", descriptor = "()I", line = 982)
    public final int method301() {
        return 0;
    }

    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(ILga;)V", line = 1691)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "()Lc;", line = 989)
    public final class125 method291() {
        return new class451();
    }

    @OriginalMember(owner = "client!cj", name = "D", descriptor = "()V", line = 994)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 1016)
    ...
    @OriginalMember(owner = "client!cj", name = "k", descriptor = "()V", line = 1027)
    public final void method320() {
        this.field7108.method93((byte) 87);
    }

    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(Z)V", line = 1029)
    public final void method329(boolean arg0) {
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 1032)
    public final void method265(int arg0) {
        this.field7111[arg0].method553(false, (Runnable) null);
    }

    @OriginalMember(owner = "client!cj", name = "x", descriptor = "()Z", line = 1035)
    public final boolean method354() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "UA", descriptor = "(III)V", line = 1038)
    ...
    @OriginalMember(owner = "client!cj", name = "E", descriptor = "()V", line = 1062)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIII)V", line = 1101)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIIIII)V", line = 1171)
    ...
    @OriginalMember(owner = "client!cj", name = "z", descriptor = "()V", line = 1290)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lkp;)V", line = 1308)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "()Z", line = 1344)
    public final boolean method283() {
        return true;
    }

    @OriginalMember(owner = "client!cj", name = "F", descriptor = "()Z", line = 1347)
    public final boolean method2932() {
        return this.field7074;
    }

    @OriginalMember(owner = "client!cj", name = "g", descriptor = "()V", line = 1349)
    public final void method297() {
    }

    @OriginalMember(owner = "client!cj", name = "G", descriptor = "()V", line = 1354)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II[[I[[IIII)Lta;", line = 1362)
    ...
    @OriginalMember(owner = "client!cj", name = "da", descriptor = "([I)V", line = 1365)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(FFF)V", line = 1370)
    public final void method339(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!cj", name = "xa", descriptor = "()F", line = 1373)
    public final float method275() {
        return this.field7086;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([IIIII)Ll;", line = 1377)
    ...
    @OriginalMember(owner = "client!cj", name = "q", descriptor = "()Z", line = 1412)
    public final boolean method340() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "H", descriptor = "(IIII)V", line = 1415)
    ...
    @OriginalMember(owner = "client!cj", name = "ea", descriptor = "(Lc;)V", line = 1423)
    public final void method362(class125 arg0) {
        this.field7105 = (class451) arg0;
    }

    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(IIIIII)V", line = 1426)
    ...
    @OriginalMember(owner = "client!cj", name = "fa", descriptor = "(IIII)V", line = 1432)
    ...
    @OriginalMember(owner = "client!cj", name = "v", descriptor = "()V", line = 1447)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIIII)V", line = 1459)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II[I[I)Lma;", line = 1492)
    public final class10 method325(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class181(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lck;III)V", line = 1496)
    ...
    @OriginalMember(owner = "client!cj", name = "T", descriptor = "(IFFFFF)V", line = 1538)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Llm;[Ldi;Z)Lla;", line = 1548)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)V", line = 1576)
    public final void method282(boolean arg0) {
    }

    @OriginalMember(owner = "client!cj", name = "s", descriptor = "()Z", line = 1580)
    public final boolean method346() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "W", descriptor = "()F", line = 1584)
    public final float method335() {
        return this.field7114;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ldi;Z)Ll;", line = 1589)
    ...
    @OriginalMember(owner = "client!cj", name = "YA", descriptor = "()I", line = 1700)
    public final int method299() {
        return this.field7091;
    }

    @OriginalMember(owner = "client!cj", name = "j", descriptor = "()Z", line = 1703)
    public final boolean method307() {
        return true;
    }

    @OriginalMember(owner = "client!cj", name = "n", descriptor = "(I)Z", line = 1706)
    public final boolean method2936(int arg0) {
        return super.field524.method584(true, arg0).field4274;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ltp;IIII)Lt;", line = 1709)
    ...
    @OriginalMember(owner = "client!cj", name = "NA", descriptor = "(IIIII)V", line = 1712)
    ...
    @OriginalMember(owner = "client!cj", name = "e", descriptor = "(IIIIII)V", line = 2002)
    ...
    @OriginalMember(owner = "client!cj", name = "F", descriptor = "(IIII)[I", line = 2216)
    ...
    @OriginalMember(owner = "client!cj", name = "u", descriptor = "()Z", line = 2242)
    public final boolean method348() {
        return false;
    }

    @OriginalMember(owner = "client!cj", name = "O", descriptor = "(IIIIII)V", line = 2245)
    ...
    @OriginalMember(owner = "client!cj", name = "ca", descriptor = "(ILma;II)V", line = 2382)
