...
public class class492 extends class35 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)J", line = 56)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "()V", line = 103)
    public class492() {
        this.field7181 = System.nanoTime();
        this.field7180 = System.nanoTime();
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)J", line = 92)
