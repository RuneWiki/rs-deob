...
public class class492 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)Z", line = 21)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 71)
