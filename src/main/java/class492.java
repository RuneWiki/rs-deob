...
public class class492 extends class80 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IILnn;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ev", name = "d", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IILza;Ll;III)V", line = 71)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "()V", line = 233)
    public class492() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;II)V", line = 160)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(II)[I", line = 175)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIIIIII)V", line = 236)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(BIIII)V", line = 365)
