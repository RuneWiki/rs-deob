...
public class class492 extends class72 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IZIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lcq;)V", line = 42)
    public class492(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iaa", name = "d", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(I)I", line = 84)
    public final int method60(int arg0) {
        ++field7009;
        return arg0 != -3271 ? 8 : 0;
    }

    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(ILcq;)V", line = 97)
    public class492(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(II)V", line = 100)
    ...
    @OriginalMember(owner = "client!iaa", name = "e", descriptor = "(I)I", line = 113)
