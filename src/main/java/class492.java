...
public class class492 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/awt/Component;B)Lhv;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BILraa;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lffa;Lpc;Laq;IIIII)V")
