...
public class class492 extends class78 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!em", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 4)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field7181;
        return this.field7186 == arg0;
    }

    @OriginalMember(owner = "client!em", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 14)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IBLjava/awt/Graphics;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 42)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lsc;III)V", line = 65)
    ...
    @OriginalMember(owner = "client!em", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 98)
    public final void startProduction(ImageConsumer arg0) {
        ++field7187;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!em", name = "d", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!em", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 118)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!em", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 160)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field7185;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIII)V", line = 171)
