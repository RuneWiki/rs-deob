...
public class class492 extends class642 {
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lr;Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "()V", line = 583)
    public class492() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILgk;B)V", line = 504)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "()V", line = 589)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lf;IIILps;Lua;BI)V", line = 600)
    ...
    @OriginalMember(owner = "client!rfa", name = "e", descriptor = "(I)V", line = 646)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ZII)I", line = 658)
    ...
    @OriginalMember(owner = "client!rfa", name = "f", descriptor = "(I)V", line = 678)
