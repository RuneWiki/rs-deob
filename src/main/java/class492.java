...
public class class492 extends class577 {
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIII)I", line = 15)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(I)V", line = 40)
