...
public class class492 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lkfa;)V", line = 131)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IB)Z", line = 26)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZZIIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZILjo;)Z", line = 107)
