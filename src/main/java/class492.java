...
public class class492 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIB)I", line = 15)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)V", line = 56)
