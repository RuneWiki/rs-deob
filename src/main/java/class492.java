...
public class class492 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)Les;", line = 11)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IILqa;Lra;ZII)V", line = 66)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)Lnp;", line = 124)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 145)
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 208)
