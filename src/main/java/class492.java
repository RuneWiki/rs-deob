...
public class class492 extends class632 {
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILs;)V", line = 19)
    public static final void method2905(int arg0, class418 arg1) {
        class661.field9303[arg0] = arg1;
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IBI)V", line = 30)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 61)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIB)V", line = 72)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BII)V", line = 94)
