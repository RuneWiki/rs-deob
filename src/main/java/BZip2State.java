...
public class BZip2State {
    ...
    @OriginalMember(owner = "sb", name = "D", descriptor = "[I")
    public int[] field785 = new int[256];
    ...
    public boolean[] field791 = new boolean[256];

    @OriginalMember(owner = "sb", name = "K", descriptor = "[Z")
    public boolean[] field792 = new boolean[16];

    @OriginalMember(owner = "sb", name = "L", descriptor = "[B")
    public byte[] field793 = new byte[256];

    @OriginalMember(owner = "sb", name = "M", descriptor = "[B")
    public byte[] field794 = new byte[4096];

    @OriginalMember(owner = "sb", name = "N", descriptor = "[I")
    public int[] field795 = new int[16];
    ...
    public byte[][] field798 = new byte[6][258];
