...
public class BZip2State {
    ...
    public byte[][] field799 = new byte[6][258];

    @OriginalMember(owner = "sb", name = "R", descriptor = "[[I")
    public int[][] field800 = new int[6][258];
