...
public class BZip2State {
    ...
    public byte[] field801 = new byte[18002];

    @OriginalMember(owner = "sb", name = "Q", descriptor = "[[B")
    public byte[][] field802 = new byte[6][258];
    ...
    public int[][] field805 = new int[6][258];

    @OriginalMember(owner = "sb", name = "U", descriptor = "[I")
    public int[] field806 = new int[6];
