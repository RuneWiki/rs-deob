...
public class PathingEntity extends Entity {
    ...
    private int field396 = 35839;

    @OriginalMember(owner = "y", name = "t", descriptor = "Z")
    ...
    @OriginalMember(owner = "y", name = "qb", descriptor = "[Z")
    ...
    @OriginalMember(owner = "y", name = "C", descriptor = "Ljava/lang/String;")
    public String field409;

    @OriginalMember(owner = "y", name = "a", descriptor = "(IZIZ)V")
    public final void method110(int arg0, boolean arg1, int arg2, boolean arg3) {
        if (this.field425 != -1 && SeqType.field1126[this.field425].field1139 == 1) {
            this.field425 = -1;
        }
        if (!arg1) {
            int var5 = arg0 - this.field447[0];
            int var6 = arg2 - this.field448[0];
    ...
    @OriginalMember(owner = "y", name = "a", descriptor = "(BIZ)V")
    public final void method111(byte arg0, int arg1, boolean arg2) {
    ...
    @OriginalMember(owner = "y", name = "a", descriptor = "(B)V")
