...
public class PathingEntity extends Entity {
    ...
    @OriginalMember(owner = "x", name = "e", descriptor = "Z")
    private boolean field304 = false;

    @OriginalMember(owner = "x", name = "i", descriptor = "Z")
    ...
    @OriginalMember(owner = "x", name = "a", descriptor = "(IZIZ)V")
    ...
    @OriginalMember(owner = "x", name = "a", descriptor = "(IZB)V")
