...
public class PathingEntity extends Entity {
    ...
    @OriginalMember(owner = "client!y", name = "a", descriptor = "(IIZI)V")
    public final void method110(int arg0, int arg1, boolean arg2, int arg3) {
        if (this.field425 != -1 && SeqType.field1135[this.field425].field1148 == 1) {
            this.field425 = -1;
        }
        if (!arg2) {
            int var5 = arg3 - this.field447[0];
            int var6 = arg1 - this.field448[0];
    ...
    @OriginalMember(owner = "client!y", name = "a", descriptor = "(BIII)V")
    public final void method114(byte arg0, int arg1, int arg2, int arg3) {
        for (int var5 = 0; var5 < 4; var5++) {
            if (this.field415[var5] <= arg2) {
                this.field413[var5] = arg3;
                this.field414[var5] = arg1;
                this.field415[var5] = arg2 + 70;
                return;
            }
        }
        if (arg0 == 2) {
