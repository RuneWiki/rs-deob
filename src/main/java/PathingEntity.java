...
public class PathingEntity extends Entity {
    ...
    @OriginalMember(owner = "y", name = "a", descriptor = "(ZIIZ)V")
    public final void method110(boolean arg0, int arg1, int arg2, boolean arg3) {
        if (this.field425 != -1 && SeqType.field1134[this.field425].field1147 == 1) {
            this.field425 = -1;
        }
        if (!arg0) {
    ...
    public final void method114(int arg0, int arg1, int arg2, int arg3) {
        ...
        for (int var5 = 0; var5 < 4; var5++) {
            if (this.field415[var5] <= arg3) {
                this.field413[var5] = arg1;
                this.field414[var5] = arg2;
                this.field415[var5] = arg3 + 70;
                return;
            }
        }
    }
