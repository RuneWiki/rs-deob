...
public class PathingEntity extends Entity {
    ...
    private int field407 = -751;

    @OriginalMember(owner = "z", name = "n", descriptor = "I")
    private int field408 = 37435;
    ...
    @OriginalMember(owner = "z", name = "A", descriptor = "Ljava/lang/String;")
    public String field421;

    @OriginalMember(owner = "z", name = "a", descriptor = "(IZII)V")
    public final void method124(int arg0, boolean arg1, int arg2, int arg3) {
        if (arg2 != 0) {
            this.field407 = -464;
        }
        if (this.field437 != -1 && SeqType.field1110[this.field437].field1123 == 1) {
            this.field437 = -1;
        }
        if (!arg1) {
            int var5 = arg0 - this.field458[0];
            int var6 = arg3 - this.field459[0];
            if (var5 >= -8 && var5 <= 8 && var6 >= -8 && var6 <= 8) {
                if (this.field457 < 9) {
                    this.field457++;
                }
                for (int var7 = this.field457; var7 > 0; var7--) {
                    this.field458[var7] = this.field458[var7 - 1];
                    this.field459[var7] = this.field459[var7 - 1];
                    this.field460[var7] = this.field460[var7 - 1];
                }
                this.field458[0] = arg0;
                this.field459[0] = arg3;
        ...
        this.field458[0] = arg0;
        this.field459[0] = arg3;
        this.field409 = this.field458[0] * 128 + this.field413 * 64;
        this.field410 = this.field459[0] * 128 + this.field413 * 64;
    }

    @OriginalMember(owner = "z", name = "a", descriptor = "(IZI)V")
    public final void method125(int arg0, boolean arg1, int arg2) {
        int var4 = this.field458[0];
        int var5 = this.field459[0];
        if (arg0 == 0) {
            var4--;
            var5++;
        }
        ...
        if (this.field408 == arg2) {
            this.field458[0] = var4;
            this.field459[0] = var5;
    ...
    public boolean method127(boolean arg0) {
        if (arg0) {
    ...
    public final void method128(int arg0, int arg1, int arg2) {
        for (int var4 = 0; var4 < 4; var4++) {
            if (this.field427[var4] <= client.field1633) {
                this.field425[var4] = arg0;
                this.field426[var4] = arg1;
                this.field427[var4] = client.field1633 + 70;
                return;
            }
        }
        while (arg2 >= 0) {
