...
public class class153 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "()[F", line = 162)
