...
public class class153 implements Runnable {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLjava/lang/Class;)Liu;", line = 8)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLjava/net/URL;)Liu;", line = 19)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)Liu;", line = 43)
    public final class397 method1027(int arg0) {
        return arg0 < 13 ? null : this.method1049((Object) null, 13, 0, 0, -4016);
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ILjava/lang/Object;III)Liu;", line = 53)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ILjava/lang/Class;)Liu;", line = 92)
    public final class397 method1029(int arg0, Class arg1) {
        return arg0 < 76 ? null : this.method1049(arg1, 20, 0, 0, -4016);
    }

    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)Liu;", line = 102)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLjava/awt/datatransfer/Transferable;)Liu;", line = 113)
    public final class397 method1031(byte arg0, Transferable arg1) {
        return arg0 < 45 ? null : this.method1049(arg1, 19, 0, 0, -4016);
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;Z)Liu;", line = 126)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III[ILjava/awt/Point;Ljava/awt/Component;)Liu;", line = 136)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Z)Z", line = 149)
    public final boolean method1034(boolean arg0) {
        return arg0;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/awt/Component;III)Liu;", line = 163)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/Class;Z)Liu;", line = 175)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLjava/lang/String;)Liu;", line = 187)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)Liu;", line = 197)
    public final class397 method1038(byte arg0) {
        int var2 = -9 / ((-arg0 - 10) / 52);
        return this.method1049((Object) null, 5, 0, 0, -4016);
    }

    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 595)
    ...
    @OriginalMember(owner = "client!ng", name = "d", descriptor = "(I)Liu;", line = 216)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IILjava/lang/Runnable;)Liu;", line = 228)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Liu;", line = 239)
    ...
    @OriginalMember(owner = "client!ng", name = "e", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!ng", name = "f", descriptor = "(I)Lrb;", line = 307)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ZLjava/lang/String;)[B", line = 321)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZIII)Liu;", line = 334)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/String;I)Liu;", line = 354)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)Liu;", line = 374)
    ...
    @OriginalMember(owner = "client!ng", name = "run", descriptor = "()V", line = 384)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ILjava/awt/Frame;)Liu;", line = 516)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/Object;IIII)Liu;", line = 526)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/awt/Component;ZB)Liu;", line = 557)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IILjava/lang/String;)Liu;", line = 575)
