...
public class class153 implements class134 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(JI)Z", line = 7)
    public final boolean method779(long arg0, int arg1) {
        field1983++;
        return arg1 == 21336;
    }

    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I[FI)[F", line = 111)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!gfa", name = "d", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(ZZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;I)I", line = 353)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IB)I", line = 367)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/Object;ZLjava/lang/String;)Z", line = 382)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;", line = 405)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(B)I", line = 431)
