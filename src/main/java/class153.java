...
public class class153 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(B)I", line = 53)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIILkg;IILtm;)V", line = 64)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lat;I)Lbb;", line = 121)
