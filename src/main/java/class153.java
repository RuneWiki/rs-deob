...
public class class153 extends class478 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLoi;I)Lul;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Ll;BILjava/awt/Canvas;Lnt;I)Lza;")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lih;IIII)V")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lih;IIII[BI)V")
