...
public class class153 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([[[BIZZI[I[IIIBI[II[IIII[I)V", line = 59)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Ldh;ILkha;)V", line = 536)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(II)Ljc;", line = 507)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZJ)V", line = 556)
