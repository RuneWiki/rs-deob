...
public class class153 extends class136 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZI)Lqf;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II)Lgba;")
