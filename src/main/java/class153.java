...
public class class153 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I[B)V", line = 14)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "([BI[B)V", line = 239)
