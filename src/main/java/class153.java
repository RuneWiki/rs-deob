...
public class class153 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILii;ILfh;IIZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 156)
