...
public class class153 extends class89 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLtf;)I", line = 40)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)I", line = 67)
    public final int method1000(int arg0) {
        ++field1938;
        return arg0 >= -65 ? 112 : (int) (255L & super.field5043 >>> 32);
    }

    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)J", line = 92)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(II)V", line = 137)
    public class153(int arg0, int arg1) {
        super.field5043 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lrd;I)I", line = 146)
    ...
    @OriginalMember(owner = "client!ui", name = "e", descriptor = "(B)I", line = 174)
