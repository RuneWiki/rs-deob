...
public class class153 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lga;BLga;F)Z")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lbe;Lig;ZIIILtq;I)V")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lbl;)V")
