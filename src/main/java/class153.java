...
public class class153 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lqo;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILjava/lang/Object;Lqo;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lqo;Ljava/lang/Object;II)V")
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Lqo;I)Ljava/lang/Object;")
