...
public class class153 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lte;IZ[BIZII)Lrp;", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IFIBIF[FIIIIIF)V", line = 26)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(FI)F", line = 112)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(II)Lvp;", line = 123)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 171)
