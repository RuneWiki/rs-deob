...
public class class153 extends class181 {
    ...
    @OriginalMember(owner = "client!dca", name = "q", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Ltu;Lcq;[Laf;Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(CIIIZLfa;II)V", line = 332)
