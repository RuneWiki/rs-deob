...
public class class153 implements class733 {
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IIBZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ILud;)Lpd;", line = 122)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)Z", line = 156)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ILvg;)V", line = 177)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Leq;Leq;Lcn;)V", line = 207)
