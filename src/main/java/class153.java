...
public class class153 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z[I)Ljava/lang/String;", line = 64)
