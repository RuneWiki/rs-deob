...
public class class153 extends class348 implements class147 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IILoa;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 27)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ZLoa;)V", line = 64)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(Z[B)Z", line = 75)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Loa;Llt;IIIIZIZ)V", line = 100)
    ...
    @OriginalMember(owner = "client!cfa", name = "e", descriptor = "(I)I", line = 138)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IILoa;)Lba;", line = 149)
    public final class352 method548(int arg0, int arg1, class638 arg2) {
        ++field2306;
        return arg0 != -585 ? null : this.method1070(131072, arg2, arg1);
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IZLoa;I)Lcda;", line = 161)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(I)I", line = 192)
    ...
    @OriginalMember(owner = "client!cfa", name = "d", descriptor = "(I)I", line = 205)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IZ)Lrv;", line = 219)
    public static final class95 method1069(int arg0, boolean arg1) {
        ++field2289;
        return !arg1 ? null : new class95(arg0, false);
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Loa;B)Lac;", line = 232)
    ...
    @OriginalMember(owner = "client!cfa", name = "g", descriptor = "(I)Z", line = 247)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILoa;)Lwc;", line = 261)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(BLoa;)V", line = 291)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Z)V", line = 320)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILoa;I)Lba;", line = 331)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(I)Z", line = 355)
    public final boolean method562(int arg0) {
        ++field2291;
        return arg0 != 29008 ? false : this.field2298;
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BLoa;)V", line = 366)
