...
public class class153 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ZB)V", line = 11)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IZ)Lrda;", line = 115)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(II)V", line = 189)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(II)V", line = 205)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IZLr;Llt;II)V", line = 230)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ZZ)V", line = 289)
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lsea;IZLmv;Lmv;)V", line = 331)
    ...
    @OriginalMember(owner = "client!wfa", name = "c", descriptor = "(I)V", line = 311)
