...
public class class153 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BIFFIIFI)[F", line = 33)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BLgg;ILgaa;)V", line = 115)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZIIIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III)Z", line = 243)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BC)B", line = 254)
