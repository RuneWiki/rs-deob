...
public class class153 extends class37 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III[BIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(I)V", line = 111)
    public class153(int arg0) {
        this.field1731 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z)V", line = 124)
