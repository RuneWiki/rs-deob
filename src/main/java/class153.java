...
public class class153 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lbo;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lbo;Lpm;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILbo;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILbo;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLbo;IIII)Lgk;")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([[BLcd;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Lbo;I)V")
