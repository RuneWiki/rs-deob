...
public class class153 extends class214 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BLfr;)Z")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIIB)Les;")
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(B)Lwj;")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Llk;II)V")
