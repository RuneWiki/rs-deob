...
public class class153 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IILjc;)V", line = 5)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Ljc;B)V", line = 70)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)V", line = 98)
