...
public class class153 extends class200 {
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(IIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lcu;B)V", line = 37)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Ljava/lang/String;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BILjava/lang/String;)Ljava/lang/String;", line = 72)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lcu;II)V", line = 91)
