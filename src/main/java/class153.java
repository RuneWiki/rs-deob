...
public class class153 implements class234 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)Loi;", line = 5)
    public final class696 method1156(boolean arg0) {
        field2385++;
        return arg0 ? class696.field9867 : null;
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)I", line = 41)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Loj;I)V", line = 177)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)I", line = 236)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lla;Ljava/lang/String;)V", line = 251)
