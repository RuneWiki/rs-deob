...
public class class153 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)Lov;", line = 4)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLtf;)V", line = 78)
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 113)
