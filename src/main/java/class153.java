...
public class class153 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IILwm;Lwm;IIIBII)V", line = 34)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "([Lkba;II)V", line = 102)
    ...
    @OriginalMember(owner = "client!g", name = "toString", descriptor = "()Ljava/lang/String;", line = 143)
    public final String toString() {
        field2150++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(II)V", line = 150)
    public class153(int arg0, int arg1) {
        this.field2158 = arg1;
    }

    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLvaa;)I", line = 160)
