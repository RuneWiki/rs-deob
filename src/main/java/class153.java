...
public class class153 extends class498 {
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    public class153(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BF)V", line = 8)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIIIII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "([BI)[B", line = 102)
    ...
    @OriginalMember(owner = "client!ld", name = "f", descriptor = "(I)V", line = 120)
