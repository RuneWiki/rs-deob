...
public abstract class class153 extends class260 {
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)F", line = 33)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!jd", name = "d", descriptor = "(I)I", line = 72)
    public final int method1027(int arg0) {
        field2348++;
        return arg0 == -601 ? this.field2347 : -113;
    }

    @OriginalMember(owner = "client!jd", name = "d", descriptor = "(B)I", line = 85)
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(IIIIIF)V", line = 115)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lef;IILjava/lang/String;)Lji;", line = 128)
