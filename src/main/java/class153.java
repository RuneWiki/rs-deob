...
public class class153 extends class211 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BILib;)V", line = 36)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(II)[I", line = 84)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)V", line = 187)
