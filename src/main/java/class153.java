...
public class class153 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!qe", name = "f", descriptor = "Ljava/lang/Throwable;")
    public Throwable field2916;

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "Llf;")
    public static class109 field2911 = class35.method275("<col=80ff00>", 2);

    @OriginalMember(owner = "client!qe", name = "h", descriptor = "Llf;")
    public static class109 field2918 = class35.method275("mn", 2);

    @OriginalMember(owner = "client!qe", name = "i", descriptor = "Llf;")
    public static class109 field2919 = class35.method275("p11_full", 2);

    @OriginalMember(owner = "client!qe", name = "d", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
    public class153(Throwable arg0, String arg1) {
        this.field2915 = arg1;
        this.field2916 = arg0;
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I[S[Llf;)V")
