...
public abstract class class153 extends class174 {
    ...
    @OriginalMember(owner = "client!sq", name = "F", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!sq", name = "ya", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lcba;[I)V")
    public final void method850(class469 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lk;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!sq", name = "X", descriptor = "(IILk;)Lk;")
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lhr;IIII[[I[[II)V")
