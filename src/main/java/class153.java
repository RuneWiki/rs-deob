...
public class class153 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIII)V", line = 43)
