...
public abstract class class153 extends class49 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIIIILjava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IB)V", line = 52)
    ...
    @OriginalMember(owner = "client!vj", name = "f", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ltf;B[[B)V", line = 92)
    ...
    @OriginalMember(owner = "client!vj", name = "g", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 179)
