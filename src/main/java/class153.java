...
public class class153 extends class271 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILor;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLjava/awt/Component;Z)Lqk;")
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)Lsv;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILsv;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lor;)V")
