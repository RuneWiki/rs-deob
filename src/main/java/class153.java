...
public class class153 extends class337 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "()V", line = 19)
    public class153() {
        super(0, true);
    }

    @OriginalMember(owner = "client!em", name = "e", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II[BB)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IB)[I", line = 87)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BILhp;)V", line = 169)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIILad;)V", line = 246)
