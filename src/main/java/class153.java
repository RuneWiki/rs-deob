...
public class class153 {
    ...
    @OriginalMember(owner = "client!hk", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field2443++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIII)I", line = 24)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(III)Luf;", line = 62)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(IIII)V", line = 77)
