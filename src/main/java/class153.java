...
public class class153 extends class108 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lod;Z[[B)V", line = 19)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(II)S", line = 93)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 121)
    public static void method1090(int arg0) {
        field2296 = null;
        int var1 = 73 % ((arg0 - 7) / 54);
    }

    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lae;Ljava/lang/Object;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(I)V", line = 169)
