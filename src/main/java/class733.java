...
public class class733 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ZILjava/io/File;)[B", line = 18)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIIIZB)V", line = 36)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIBIIIIIIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(II)V", line = 166)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIBI)Z", line = 184)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 225)
