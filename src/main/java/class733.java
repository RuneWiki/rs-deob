...
public class class733 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ILcr;)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ILmha;)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lcr;Ljava/lang/Object;B)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lcr;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IILjava/lang/Object;Lcr;)V")
