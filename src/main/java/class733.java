...
public class class733 extends class491 implements class568 {
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lfi;Lpd;III[B)V")
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLej;)V")
