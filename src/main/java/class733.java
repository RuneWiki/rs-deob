...
public abstract class class733 extends class668 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)[Lwk;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZILha;Lov;IIZ)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([Lvt;I)I")
