...
public class class733 extends class499 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IILha;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIZI[[[Lih;I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lrda;[III[II)Lew;", line = 371)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(II)I", line = 404)
