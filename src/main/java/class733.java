...
public class class733 extends class13 {
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Lha;I)Ljk;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lfg;I)V")
    ...
    @OriginalMember(owner = "client!cc", name = "m", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cc", name = "d", descriptor = "(ILha;)Lwg;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IILrba;Lha;ZII)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BILha;I)Z")
