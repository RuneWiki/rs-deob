...
public class class733 extends class515 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lcda;Lcda;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lkw;IIZ)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lkw;IIII)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lkw;II[III)V")
