...
public class class733 implements class103 {
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(II)Lhba;")
    ...
    @OriginalMember(owner = "client!dka", name = "b", descriptor = "(IZ)Lnl;")
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lgga;Lgga;Lgga;)V")
