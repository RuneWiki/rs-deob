...
public class class733 extends class782 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lgj;B)V", line = 98)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(III)V", line = 115)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(IBI)V", line = 134)
    public final void method1941(int arg0, byte arg1, int arg2) {
        ++field10116;
        int var4 = 121 / ((-62 - arg1) / 56);
    }

    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(IIIIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IBI)V", line = 180)
