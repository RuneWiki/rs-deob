...
public class class733 extends class95 implements class649 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZI)Lpaa;")
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(Lha;I)Ljl;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILha;IZ)Lws;")
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(ILha;)Lgp;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lha;III)Z")
