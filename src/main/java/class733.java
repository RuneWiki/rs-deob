...
public class class733 {
    ...
    @OriginalMember(owner = "client!ff", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)V", line = 33)
