...
public class class733 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(III)Z", line = 40)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)V", line = 70)
