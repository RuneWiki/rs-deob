...
public class class733 {
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lha;[II[I[I)V", line = 49)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "()V", line = 53)
    public static void method5322() {
        field10750 = null;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lha;[II)V", line = 56)
    public static final void method5323(class63 arg0, int[] arg1, int arg2) {
        method5324(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 62)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "([III)V", line = 101)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "()V", line = 151)
    private static final void method5326() {
        field10749 = 0;
    }

    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)Z", line = 201)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(II)V", line = 281)
