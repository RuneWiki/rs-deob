...
public class class733 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(I)I", line = 216)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ZLpw;)Z", line = 227)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ILofa;)Lofa;", line = 255)
