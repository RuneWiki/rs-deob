...
public class class578 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(F)F", line = 6)
    private static final float method3340(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "()V", line = 11)
    public static void method3341() {
        field8190 = null;
        field8183 = null;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIF)F", line = 25)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lofa;Lsc;)V", line = 32)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(IIF)F", line = 98)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IF)I", line = 113)
