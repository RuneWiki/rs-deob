...
public abstract class class578 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ILqo;Ljava/lang/String;Z)Lpl;", line = 22)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(III)V", line = 52)
