...
public abstract class class578 extends class43 {
    ...
    @OriginalMember(owner = "client!ht", name = "e", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILha;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "([Lbh;I)I", line = 185)
    ...
    @OriginalMember(owner = "client!ht", name = "g", descriptor = "(I)Z", line = 195)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(IIIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 220)
