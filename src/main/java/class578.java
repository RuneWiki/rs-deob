...
public class class578 implements class759 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILuea;)V", line = 106)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BII)Z", line = 131)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)Lsg;", line = 142)
    public final class418 method231(int arg0) {
        field7877++;
        return arg0 == -27990 ? class418.field5447 : null;
    }

    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lbt;)V", line = 153)
