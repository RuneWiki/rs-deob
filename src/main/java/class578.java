...
public class class578 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([BI)[B", line = 31)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Z)[Lwl;", line = 128)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(II)I", line = 212)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(II)V", line = 227)
