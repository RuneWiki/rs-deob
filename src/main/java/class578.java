...
public abstract class class578 extends class416 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IILjava/awt/Component;BLkk;)Luu;", line = 5)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIZI)Ljava/lang/String;", line = 113)
