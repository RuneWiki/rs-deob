...
public abstract class class578 extends class540 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)F", line = 16)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(B)I", line = 78)
    public final int method3358(byte arg0) {
        field8173++;
        return arg0 == 22 ? this.field8177 : -71;
    }

    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIIIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!jw", name = "g", descriptor = "(I)I", line = 160)
    public final int method3362(int arg0) {
        field8170++;
        return arg0 == 0 ? this.field8179 : -69;
    }

    @OriginalMember(owner = "client!jw", name = "h", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(IIIIIF)V", line = 191)
