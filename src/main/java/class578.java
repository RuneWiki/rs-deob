...
public class class578 extends class204 {
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lfs;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIILvt;II)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(ILfs;)V")
