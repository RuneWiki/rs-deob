...
public class class578 extends class159 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZLcga;[I[B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)V", line = 84)
    public static void method3276(int arg0) {
        int var1 = -92 / ((-arg0 - 31) / 42);
        field7882 = null;
    }

    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "()V", line = 104)
    public class578() {
    }

    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "([B)V", line = 106)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZII)Z", line = 743)
