...
public class class578 extends class521 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 17)
    public final Object method3108(byte arg0) {
        int var2 = 80 % ((arg0 - 32) / 47);
        return this.field7935.get();
    }

    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 24)
