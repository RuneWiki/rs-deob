...
public abstract class class578 extends class198 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(IIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIIIIII)V", line = 213)
