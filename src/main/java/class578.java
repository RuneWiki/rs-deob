...
public class class578 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "([IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(Lfk;)V")
