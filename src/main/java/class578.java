...
public class class578 extends class665 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljr;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIB)I", line = 44)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;IB)Ljava/lang/String;", line = 65)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BLjr;I)V", line = 85)
