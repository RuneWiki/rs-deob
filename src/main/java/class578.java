...
public class class578 extends class445 implements class75 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljava/lang/String;ILew;I)Lae;", line = 7)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IF)F", line = 86)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II[IIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZZB)V", line = 120)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)I", line = 132)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lkd;Lwu;II[FII)V", line = 144)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lkd;Lwu;II[BII)V", line = 157)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIIII[BLwu;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(FI)F", line = 199)
    public final float method429(float arg0, int arg1) {
        ++field8392;
        return arg1 > -35 ? -0.37359115F : arg0;
    }

    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lkd;II[III)V", line = 210)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lkd;Lwu;Lbk;II)V", line = 223)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)Z", line = 234)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)I", line = 245)
