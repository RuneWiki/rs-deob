...
public class class578 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILjb;IILi;Li;BZILr;III)Lda;")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILr;IIILjb;I)Lda;")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILjb;ILr;III)Lda;")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BLie;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lie;II)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IBILr;IZLi;ILjb;Li;IIBI)Lda;")
