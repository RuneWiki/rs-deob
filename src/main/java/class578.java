...
public class class578 {
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(B)Z", line = 45)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(BIIIII)V", line = 81)
