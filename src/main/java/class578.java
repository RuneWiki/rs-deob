...
public class class578 extends class340 implements class281 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZLha;Lrr;IIII)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(ILha;)Llca;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZLha;I)Lka;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lha;IZB)Lbt;")
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIIIIIIZ)V")
