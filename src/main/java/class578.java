...
public class class578 extends class283 {
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lac;)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Lcu;ZI)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Lsba;Lsba;I)V")
