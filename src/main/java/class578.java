...
public class class578 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Z)Lus;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lso;IB)V")
