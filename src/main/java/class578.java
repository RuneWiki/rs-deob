...
public class class578 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgda;B)I")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Loi;Z)I")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BIILtk;I)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lvf;II)V")
