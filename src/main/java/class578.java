...
public class class578 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I[Lfs;BLjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/lang/String;[Lfs;B)I")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([Lfs;IZILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/lang/String;[Lfs;B[Ljava/lang/String;[I)I")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([Lfs;Ljava/lang/String;IB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I[Lfs;Ljava/lang/String;I)I")
