...
public class class722 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)Ldfa;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)Ldfa;")
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Ltba;)V")
