...
public class class722 extends class392 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lw;)V", line = 39)
    public class722(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "([II)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(II)I", line = 91)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I[FB)[F", line = 127)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!eo", name = "d", descriptor = "(I)Z", line = 152)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(ILw;)V", line = 169)
    public class722(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)I", line = 175)
    public final int method292(boolean arg0) {
        ++field10079;
        return !arg0 ? -67 : 1;
    }

    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(Z)V", line = 187)
