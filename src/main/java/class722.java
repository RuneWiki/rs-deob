...
public class class722 extends OutputStream {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!eo", name = "write", descriptor = "(I)V", line = 33)
