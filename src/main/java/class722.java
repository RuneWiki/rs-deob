...
public class class722 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lfca;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lfca;II)V", line = 77)
