...
public class class722 extends class65 implements class557 {
    ...
    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Lqja;")
    public final class326 method514() {
        return this.field10003;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Ljd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpt;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqja;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lqm;")
    ...
    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()Lcq;")
    ...
    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Lqja;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Ljd;")
    public final class241 method517(int arg0, int arg1, boolean arg2) {
        return new class566(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lus;Z)Ljd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkd;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqaa;Lqaa;FLqaa;)Lqaa;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkfa;Lts;)Lpt;")
    public final class555 method443(class627 arg0, class560 arg1) {
        return new class636(this, (class566) arg0, (class526) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldba;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqaa;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lie;[Lus;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Ljd;")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Lqja;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkd;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)Lkfa;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lqm;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lts;")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Lqaa;")
