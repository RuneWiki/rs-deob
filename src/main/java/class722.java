...
public class class722 extends class227 {
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(FFIIIIIFI[FF)V", line = 20)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(I)V", line = 110)
