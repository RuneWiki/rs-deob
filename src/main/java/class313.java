...
public class class313 implements class409 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)Lhr;", line = 6)
    public final class57 method478(int arg0) {
        field4235++;
        return arg0 < 30 ? null : class758.field10545;
    }

    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(I)V", line = 36)
