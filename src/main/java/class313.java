...
public class class313 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vv", name = "toString", descriptor = "()Ljava/lang/String;", line = 14)
    public final String toString() {
        field4931++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(BI)Lhd;", line = 51)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(II)V", line = 73)
