...
public class class313 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(BLca;)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IILca;)V")
