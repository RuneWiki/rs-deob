...
public class class313 extends class667 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lud;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(III)Z", line = 103)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "()V", line = 403)
    public class313() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(BI)[I", line = 126)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(B)V", line = 187)
    public static void method2025(byte arg0) {
        field4417 = null;
        int var1 = 66 % ((34 - arg0) / 38);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I[II)V", line = 200)
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(B)V", line = 363)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBIIIII)I", line = 411)
