...
public class class313 extends class669 implements class369 {
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 16)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltg;Lbda;III[B)V", line = 25)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Llda;I)V", line = 96)
