...
public class class313 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)Z", line = 219)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZILti;)V", line = 282)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(B)Z", line = 348)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)Z", line = 626)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBZIB)Lpp;", line = 640)
    ...
    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(I)I", line = 685)
    private final int method2007(int arg0) {
        field4721++;
        return arg0 == -2 ? this.field4723.method1023(arg0 + 108) + this.field4724.method1023(114) : 71;
    }

    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(I)I", line = 697)
    ...
    @OriginalMember(owner = "client!pr", name = "g", descriptor = "(I)V", line = 709)
    ...
    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(B)V", line = 722)
