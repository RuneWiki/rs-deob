...
public class class313 extends class42 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "()V", line = 3)
    public final void method1811() {
        this.method1814();
        this.nativeid = 0L;
    }

    @OriginalMember(owner = "client!la", name = "finalize", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lh;Ljava/awt/Canvas;)V", line = 15)
