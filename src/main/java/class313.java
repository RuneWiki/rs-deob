...
public class class313 extends class77 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILfi;Lfi;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIII)Z", line = 71)
