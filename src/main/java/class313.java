...
public class class313 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIF)F")
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(IIF)F")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lfb;Lfs;)V")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IF)I")
