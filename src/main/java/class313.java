...
public class class313 extends class610 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)Lti;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILit;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Len;Lh;)V")
