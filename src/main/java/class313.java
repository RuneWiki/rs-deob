...
public class class313 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lwl;B)Z")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BLwm;)Ljd;")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ljg;Lnp;Lwm;I)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IILbt;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lwm;ZZ)Ljd;")
