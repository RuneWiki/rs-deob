...
public class class313 extends class42 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lwn;I)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lpg;ILpg;)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILsh;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
