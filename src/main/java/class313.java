...
public abstract class class313 extends class692 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIILnc;IIBIIII)Z")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B[Lcp;)I")
