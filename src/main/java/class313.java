...
public class class313 extends class551 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILps;)V", line = 126)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)I", line = 145)
    public static int method1926(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!tt", name = "g", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lps;I)Ljava/lang/String;", line = 176)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(II)Lrb;", line = 210)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "([IZLps;)V", line = 230)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BII)I", line = 258)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IZ)V", line = 279)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lft;I)V", line = 300)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lps;IB)V", line = 322)
    ...
    @OriginalMember(owner = "client!tt", name = "h", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!tt", name = "i", descriptor = "(I)Ljava/lang/String;", line = 420)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)I", line = 445)
