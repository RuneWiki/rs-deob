...
public class class313 extends class472 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(I)V", line = 130)
    public class313(int arg0) {
        this.field4761 = arg0;
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IB)Z", line = 138)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "(B)V", line = 148)
