...
public class class313 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)I", line = 45)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljava/net/Socket;II)Ldn;", line = 170)
