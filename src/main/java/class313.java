...
public class class313 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lup;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)I", line = 48)
    public final int method1892(int arg0) {
        field4320++;
        return arg0 <= 70 ? 21 : this.field4325;
    }

    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Ljava/lang/Object;BLoga;)V", line = 63)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILoga;)V", line = 74)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Loga;B)Ljava/lang/Object;", line = 126)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Ltg;I)Lbda;", line = 207)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Z)I", line = 248)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Loga;Ljava/lang/Object;II)V", line = 270)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BI)V", line = 298)
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(I)V", line = 346)
