...
public class class313 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)V", line = 88)
