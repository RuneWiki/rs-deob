...
public class class313 extends class190 {
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "()Lmr;")
    public final class77 method2017() {
        return this.field4291;
    }

    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Luo;[Lrf;Z)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "([Lwg;Z)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Luo;J)Z")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Luo;J[Lrf;[Lwg;Z)V")
