...
public class class313 extends class210 implements class454 {
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(Lwi;)V")
    ...
    @OriginalMember(owner = "client!e", name = "d", descriptor = "(Lwi;)V")
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Lig;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Lig;ILjava/nio/ByteBuffer;Z)V")
    public class313(class132 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field4618 = arg1;
    }

    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lwi;)V")
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(Lwi;)V")
