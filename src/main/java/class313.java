...
public class class313 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIZLjava/lang/String;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)V", line = 99)
