...
public class class313 extends class392 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIILjava/awt/Graphics;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Ljava/awt/Graphics;IBI)V", line = 29)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 40)
