...
public class class313 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIIZII)V", line = 9)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IZ)Lcu;", line = 44)
