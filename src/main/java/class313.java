...
public class class313 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(BII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!lfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field4338++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(II)V", line = 51)
