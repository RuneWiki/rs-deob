...
public class class313 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Lfd;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)[Luaa;", line = 27)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(BIILfd;)V", line = 69)
