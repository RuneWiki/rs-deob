...
public abstract class class313 {
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(I)Lce;")
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(I)Loga;")
    ...
    @OriginalMember(owner = "client!ko", name = "i", descriptor = "(I)Lbi;")
    ...
    @OriginalMember(owner = "client!ko", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "l", descriptor = "(I)Lqea;")
