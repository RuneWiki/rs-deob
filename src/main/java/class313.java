...
public class class313 implements class232 {
    ...
    @OriginalMember(owner = "client!cl", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lge;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "()V", line = 35)
