...
public class class313 extends class50 implements class649 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IBZILha;ILig;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(ILha;)V", line = 29)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)I", line = 84)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(ILha;)Lgp;", line = 95)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZII)V", line = 125)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILha;)V", line = 113)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lha;III)Z", line = 134)
    ...
    @OriginalMember(owner = "client!fk", name = "e", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!fk", name = "f", descriptor = "(I)I", line = 168)
    ...
    @OriginalMember(owner = "client!fk", name = "g", descriptor = "(I)I", line = 179)
    ...
    @OriginalMember(owner = "client!fk", name = "j", descriptor = "(I)Z", line = 190)
    public final boolean method277(int arg0) {
        ++field4020;
        return arg0 != 3;
    }

    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(B)Z", line = 207)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)I", line = 219)
    ...
    @OriginalMember(owner = "client!fk", name = "f", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Lha;I)Ljl;", line = 242)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lha;I)V", line = 294)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 306)
