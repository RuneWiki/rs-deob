...
public class class313 extends class235 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILfl;ZDILqj;B)[I", line = 11)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lro;ZII)V", line = 155)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lqj;IILfl;IZ)[F", line = 170)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(II)V", line = 284)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILfl;Lqj;)Z", line = 296)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(Z)V", line = 349)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ZIDILqj;Lfl;ZZ)[I", line = 364)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "()V", line = 505)
    public class313() {
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lil;)V", line = 520)
