...
public class class313 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II)Lsf;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lbh;IB)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIII)Lcl;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Laa;Lqh;III)V")
