...
public class class313 extends class712 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(Z)Z", line = 19)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ZB)V", line = 45)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IILhba;)V", line = 62)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(III)V", line = 72)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BI)V", line = 97)
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lhj;Luu;Lep;)V", line = 121)
