...
public class class313 extends class210 {
    ...
    @OriginalMember(owner = "client!bd", name = "g", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "()V", line = 39)
    public class313() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IB)[I", line = 42)
