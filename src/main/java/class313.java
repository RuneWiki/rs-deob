...
public class class313 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ILjava/awt/Component;)Lat;")
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)Leu;")
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lgo;IZLns;Lns;)V")
