...
public class class787 extends class596 {
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lck;II[B)V", line = 153)
