...
public class class787 extends class165 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILmia;)V", line = 13)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lrv;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)Lnh;", line = 68)
