...
public class class787 extends class299 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)[Lhl;", line = 19)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(ILes;)V", line = 52)
    public class787(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(Z)I", line = 71)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)I", line = 99)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Les;)V", line = 113)
