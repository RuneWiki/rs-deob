...
public abstract class class787 extends class214 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(B[Luaa;)I")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILfq;BIILha;Z)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;Z)Z")
