...
public class class787 {
    ...
    @OriginalMember(owner = "client!sw", name = "toString", descriptor = "()Ljava/lang/String;", line = 7)
    public final String toString() {
        field10835++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(I)V", line = 29)
