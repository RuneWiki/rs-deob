...
public class class732 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILai;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lai;)V", line = 671)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 54)
    public static final boolean method4062(String arg0, int arg1) {
        field10153++;
        return arg1 == 0 ? class369.method2297(arg0, -91, 10, true) : false;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILef;Lai;B)V", line = 68)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lai;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZLai;I)V", line = 244)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BLai;)V", line = 626)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lai;B)V", line = 653)
