...
public abstract class class732 {
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Z)Lrga;")
    ...
    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(Z)Lnr;")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lhw;I)V")
    ...
    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(B)Lml;")
    ...
    @OriginalMember(owner = "client!dha", name = "e", descriptor = "(I)Lwt;")
