...
public class class732 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ed", name = "toString", descriptor = "()Ljava/lang/String;", line = 51)
    public final String toString() {
        field9906++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljava/awt/Color;Ljava/awt/Color;Ljava/lang/String;Ljava/awt/Color;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(IIII)V", line = 152)
