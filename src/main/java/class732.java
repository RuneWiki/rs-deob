...
public class class732 implements class151 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIIIFZ)[F", line = 17)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BI)Ltha;", line = 29)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ZIBFII)[I", line = 39)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BFZIII)[I", line = 52)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(II)Z", line = 63)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IB)Ldq;", line = 80)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)I", line = 107)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lvd;Lvd;Lvd;)V", line = 129)
