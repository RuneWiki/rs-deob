...
public class class732 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IIIIIIBIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 53)
