...
public class class732 implements class192 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BI[B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(JLfia;I[I)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIII)V", line = 268)
