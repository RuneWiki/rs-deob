...
public class class732 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IILsl;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILsl;)V", line = 37)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIILla;BZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIII)I", line = 82)
