...
public class class732 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BLji;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILji;I)V", line = 46)
