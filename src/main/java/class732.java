...
public class class732 extends class298 {
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(B)F", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(B)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)F", line = 25)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IC)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 69)
    public class732(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)Ljava/lang/String;", line = 169)
