...
public class class732 extends class585 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZI)[[I", line = 8)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 325)
    public class732() {
        super(2, false);
    }

    @OriginalMember(owner = "client!dd", name = "e", descriptor = "(B)V", line = 328)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lso;II)V", line = 346)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(II)[I", line = 381)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lha;I)V", line = 630)
