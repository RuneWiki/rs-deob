...
public class class732 {
    ...
    @OriginalMember(owner = "client!ed", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!ed", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!ed", name = "movemouse", descriptor = "(II)V")
