...
public class class732 extends class601 {
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gba", name = "f", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lmc;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IB)[I", line = 52)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIIILck;I)Lrc;", line = 132)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "()V", line = 158)
    public class732() {
        super(0, true);
    }
}
