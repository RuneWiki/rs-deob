...
public class class732 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Z)Ltb;", line = 5)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ZII)Z", line = 45)
