...
public class class732 extends class147 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lhi;B)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lol;I)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZII)Z")
