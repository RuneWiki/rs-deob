...
public class BZip2 {
    ...
    private static void BZ2_decompress(BZip2State arg0) {
        boolean var1 = false;
        boolean var2 = false;
        boolean var3 = false;
        boolean var4 = false;
        ...
        while (true) {
            while (var24) {
                byte var25 = GET_UCHAR(arg0);
                if (var25 == 23) {
                    return;
                }
                byte var26 = GET_UCHAR(arg0);
                byte var27 = GET_UCHAR(arg0);
                byte var28 = GET_UCHAR(arg0);
                byte var29 = GET_UCHAR(arg0);
                byte var30 = GET_UCHAR(arg0);
                arg0.currBlockNo++;
                byte var31 = GET_UCHAR(arg0);
                byte var32 = GET_UCHAR(arg0);
                byte var33 = GET_UCHAR(arg0);
                byte var34 = GET_UCHAR(arg0);
                byte var35 = GET_BIT(arg0);
                if (var35 == 0) {
                ...
                for (int var49 = 0; var49 < var43; var49++) {
                    ...
                    for (int var94 = 0; var94 < var42; var94++) {
                        while (true) {
                            byte var95 = GET_BIT(arg0);
                            if (var95 == 0) {
                                arg0.len[var49][var94] = (byte) var93;
                                break;
                            }
                            byte var96 = GET_BIT(arg0);
                            if (var96 == 0) {
                                var93++;
                            } else {
                                var93--;
                ...
                for (int var50 = 0; var50 < var43; var50++) {
                    ...
                    hbCreateDecodeTables(arg0.limit[var50], arg0.base[var50], arg0.perm[var50], arg0.len[var50], var90, var91, var42);
    ...
    private static byte GET_UCHAR(BZip2State arg0) {
        return (byte) method250(8, arg0);
    }

    @OriginalMember(owner = "rb", name = "d", descriptor = "(Lsb;)B")
    private static byte GET_BIT(BZip2State arg0) {
    ...
    private static void hbCreateDecodeTables(int[] arg0, int[] arg1, int[] arg2, byte[] arg3, int arg4, int arg5, int arg6) {
        int var7 = 0;
