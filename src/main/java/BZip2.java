...
@OriginalClass("HZTFWEML")
public class BZip2 {

    @OriginalMember(owner = "HZTFWEML", name = "a", descriptor = "LQPNUVGRI;")
    private static BZip2State state = new BZip2State();

    @OriginalMember(owner = "HZTFWEML", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "HZTFWEML", name = "a", descriptor = "(LQPNUVGRI;)V")
    ...
    @OriginalMember(owner = "HZTFWEML", name = "b", descriptor = "(LQPNUVGRI;)V")
    ...
    @OriginalMember(owner = "HZTFWEML", name = "c", descriptor = "(LQPNUVGRI;)B")
    private static byte getUnsignedChar(BZip2State arg0) {
        return (byte) getBits(8, arg0);
    }

    @OriginalMember(owner = "HZTFWEML", name = "d", descriptor = "(LQPNUVGRI;)B")
    private static byte getBit(BZip2State arg0) {
        return (byte) getBits(1, arg0);
    }

    @OriginalMember(owner = "HZTFWEML", name = "a", descriptor = "(ILQPNUVGRI;)I")
    ...
    @OriginalMember(owner = "HZTFWEML", name = "e", descriptor = "(LQPNUVGRI;)V")
    ...
    @OriginalMember(owner = "HZTFWEML", name = "a", descriptor = "([I[I[I[BIII)V")
