...
public class class163 extends class548 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Llf;Ltf;)V", line = 67)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)Z", line = 86)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lru;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Ljava/awt/Frame;Lec;I)V", line = 154)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILpp;)V", line = 186)
