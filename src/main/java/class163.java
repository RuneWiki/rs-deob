...
public class class163 extends class456 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIIZ)Lqr;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lui;Lui;Lom;I)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIILsl;)Lbu;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBLre;)V")
