...
public abstract class class163 {
    ...
    @OriginalMember(owner = "client!de", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() throws Throwable {
        this.field2460.method858(this.field2458, this.field2455);
        super.finalize();
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "([BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "()I", line = 34)
    public int method978() {
        return this.field2458;
    }

    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lge;I[BIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lge;ILjava/nio/ByteBuffer;Z)V", line = 57)
