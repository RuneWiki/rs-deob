...
public class class163 extends class285 {
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Luq;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Liaa;ZI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Liaa;B)Lmn;")
