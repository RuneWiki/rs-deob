...
public class class163 extends class394 implements class68 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III)Lbb;")
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(B)Lot;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILqa;)Lou;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILqa;)Lka;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILa;IIILqa;Z)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLqa;IB)Lkj;")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lqa;Lcd;IIIIZIZ)V")
