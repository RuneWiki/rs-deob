...
public class class163 extends class556 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lha;Lka;ILpda;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BILha;I)Z")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILrba;Lha;ZII)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lda;Lha;IZLjl;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(Lha;I)Ljk;")
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "(ILha;)Lwg;")
