...
public abstract class class163 implements class96 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lem;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qda", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!qda", name = "e", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIII[B)V", line = 73)
    ...
    @OriginalMember(owner = "client!qda", name = "f", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(B)I", line = 192)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIII[I)V", line = 287)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(B)I", line = 397)
    ...
    @OriginalMember(owner = "client!qda", name = "g", descriptor = "(I)V", line = 416)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIII[F)V", line = 426)
    ...
    @OriginalMember(owner = "client!qda", name = "d", descriptor = "(I)V", line = 523)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Llh;ILkl;Lvt;IZ)V", line = 558)
