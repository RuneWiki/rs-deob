...
public class class163 extends class737 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIILjava/awt/Graphics;III)V", line = 13)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljava/awt/Canvas;III)V", line = 30)
