...
public class class163 implements class759 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(ILsca;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I[ILfa;J)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 54)
