...
public abstract class class163 {
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V", line = 42)
