...
public class class163 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([IIILpba;)V", line = 83)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "([I)V", line = 166)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)I", line = 202)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 234)
