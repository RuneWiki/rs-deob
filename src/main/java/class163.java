...
public class class163 extends class5 implements class223 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lea;IBZ)Lto;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lea;I)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lea;IILve;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IILea;Lac;ZII)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BLea;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lea;IB)Lts;")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lea;Lp;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lea;BI)Lts;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(ILea;)Lms;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZILea;I)Z")
