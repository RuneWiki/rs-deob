...
public abstract class class163 extends class446 {
    ...
    @OriginalMember(owner = "client!eo", name = "e", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!eo", name = "d", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)Lco;", line = 66)
