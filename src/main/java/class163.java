...
public class class163 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)Lah;", line = 38)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lih;Ll;)V", line = 113)
