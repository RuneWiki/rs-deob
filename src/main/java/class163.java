...
public class class163 extends class210 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILeq;I)Lva;")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Leq;ILva;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIILbp;IZLeq;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(BLhe;Lhe;Lhe;Lhe;)V")
