...
public class class163 extends class38 implements class103 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lmc;Z)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lbb;Z)Ll;")
    ...
    @OriginalMember(owner = "client!qa", name = "s", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lmc;Lc;[Lmi;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIII)Ltb;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I[Lvp;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lc;[Lmi;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIF)Lvp;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ltb;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljq;IIII)Lt;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lgt;[Lbb;Z)Lla;")
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;Let;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ltb;Ltb;FLtb;)Ltb;")
