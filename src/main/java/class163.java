...
public class class163 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ZLjava/lang/String;B)V", line = 177)
