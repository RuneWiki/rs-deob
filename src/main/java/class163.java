...
public class class163 extends class264 {
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "()V", line = 3)
    public class163() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLkk;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!rm", name = "h", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!rm", name = "f", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(BI)Lep;", line = 238)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(B)V", line = 287)
