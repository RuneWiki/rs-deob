...
public class class163 extends class452 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILjava/lang/String;Lro;)Ljava/lang/String;", line = 32)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIB)V", line = 121)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(IIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IZI)V", line = 150)
