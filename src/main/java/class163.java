...
public class class163 extends class435 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIZIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lwk;I)V", line = 72)
