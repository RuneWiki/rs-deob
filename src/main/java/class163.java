...
public class class163 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIB)I", line = 6)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(I)V", line = 90)
