...
public class class163 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZLjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)Ljj;")
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Ldt;ILwia;Lwia;)V")
