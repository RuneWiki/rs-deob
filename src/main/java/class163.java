...
public abstract class class163 extends class117 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(FFFZ)F", line = 11)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lqo;I)V", line = 72)
    public class163(class19 arg0, int arg1) {
        this.field2458 = arg1;
        this.field2459 = arg0;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IILtn;I)V", line = 88)
