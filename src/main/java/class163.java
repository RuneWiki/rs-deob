...
public class class163 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BILtl;)V", line = 29)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Ltl;B)V", line = 92)
