...
public class class163 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)Lija;", line = 46)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(BI)Lc;", line = 87)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lim;ILgj;Lgj;Lgj;)V", line = 128)
