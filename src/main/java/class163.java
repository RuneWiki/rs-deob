...
public class class163 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILha;IB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(ILha;IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IZ[[ZIII)V", line = 248)
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(I)V", line = 445)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lhea;Lni;)V", line = 463)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lha;III)V", line = 478)
