...
public class class163 extends class80 {
    ...
    @OriginalMember(owner = "client!ae", name = "g", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIB)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!ae", name = "h", descriptor = "(I)J", line = 59)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lvh;ILvh;Lvh;Lvh;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ae", name = "i", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ae", name = "j", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(II)V", line = 118)
