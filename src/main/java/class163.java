...
public class class163 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Ljc;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IBI)Z", line = 236)
