...
public class class163 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;)V", line = 35)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)V", line = 97)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 110)
