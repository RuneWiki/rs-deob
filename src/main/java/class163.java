...
public class class163 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lmd;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IILmd;)V", line = 82)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(III)B", line = 175)
