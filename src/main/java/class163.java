...
public class class163 extends class324 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IZII)I", line = 90)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(IIIIIZ)V", line = 121)
