...
public class class163 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 22)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BI)V", line = 46)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZI)V", line = 64)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IZ)Lqda;", line = 82)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILtt;ZIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Z)V", line = 194)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lbt;IZLkda;Lkda;)V", line = 278)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)[Lfp;", line = 247)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 262)
