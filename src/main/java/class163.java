...
public class class163 extends class513 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)I", line = 20)
    public static final int method1015(int arg0, int arg1) {
        field2247++;
        return arg0 == -6816 ? arg1 >>> 8 : 74;
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lep;[Lee;I)Lwaa;", line = 31)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "([B)V", line = 122)
