...
public class class163 extends class189 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lfp;I)Ldfa;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)F")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lfp;)Z")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lfp;II)Ldfa;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "([I)Lnp;")
