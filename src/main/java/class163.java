...
public class class163 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Loa;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Loa;[II)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Loa;[IIII[I[I)V")
