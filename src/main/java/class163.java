...
public class class163 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IILps;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ZILps;)V", line = 69)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(B)V", line = 105)
