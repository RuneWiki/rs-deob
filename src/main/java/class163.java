...
public class class163 extends class38 implements class103 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIF)Ljd;")
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;Ldr;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lmh;Lmh;FLmh;)Lmh;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ldq;[Lft;Z)Lla;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lt;Lpn;Lc;Lii;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpn;Z)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpn;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I[Ljd;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lc;[Lii;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "y", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!qa", name = "o", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lft;Z)Ll;")
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(IIIIII)Lmh;")
    public final class444 method303(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lkq;IIII)Lt;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lmh;)V")
