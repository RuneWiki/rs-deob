...
public class class163 extends class761 implements class65 {
    ...
    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqa;Lwha;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "()[B", line = 37)
    public final byte[] method407() {
        throw new RuntimeException();
    }

    @OriginalMember(owner = "client!i", name = "g", descriptor = "()[Lkw;", line = 40)
    public final class510[] method426() {
        return this.field2112;
    }

    @OriginalMember(owner = "client!i", name = "f", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 64)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILqa;ZII)Z", line = 69)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILqa;)V", line = 89)
    private final void method1390(int[] arg0, class104 arg1) {
        this.field2113.method3641().method5000(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILqa;ZI)Z", line = 94)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()V", line = 102)
    public final void method403() {
    }

    @OriginalMember(owner = "client!i", name = "b", descriptor = "()Z", line = 106)
    public final boolean method431() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqa;)V", line = 120)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B[B)V", line = 177)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqa;Lwha;I)V", line = 182)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqa;IZ)V", line = 199)
    public final void method389(class104 arg0, int arg1, boolean arg2) {
        this.method1394(((class729) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lrha;IIII)V", line = 203)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 275)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;)V", line = 277)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Liia;", line = 284)
