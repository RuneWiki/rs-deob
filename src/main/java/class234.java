...
public abstract class class234 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lke;", line = 34)
