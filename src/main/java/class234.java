...
public class class234 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(II)Lwda;")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIILao;II)V")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lfs;ILlga;)V")
