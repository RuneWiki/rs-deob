...
public class class234 extends class220 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(I[BZLno;)Ldw;", line = 3)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Z)[B", line = 32)
    ...
    @OriginalMember(owner = "client!dia", name = "b", descriptor = "(II)Lgq;", line = 55)
    ...
    @OriginalMember(owner = "client!dia", name = "e", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(I)I", line = 97)
