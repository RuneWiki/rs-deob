...
public class class234 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "([[BILsca;)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZILrca;)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IB)Ltn;")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lnq;ILga;)V")
