...
public class class234 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(FZFF)I", line = 6)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!dia", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!dia", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(B[SI)[S", line = 106)
