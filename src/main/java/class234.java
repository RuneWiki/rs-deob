...
public class class234 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(II)Lqk;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lro;I)V")
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lcm;ILlt;)V")
