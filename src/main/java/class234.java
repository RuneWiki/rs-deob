...
public class class234 extends class398 {
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIB)I", line = 4)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "()V", line = 20)
    public class234() {
        super(0, true);
    }

    @OriginalMember(owner = "client!w", name = "f", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II)[I", line = 35)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(III)V", line = 67)
