...
public class class234 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lqj;I)Lue;")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lji;Z)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lgca;B)Z")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ZI)Lfl;")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILmn;)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "([Lhr;ILjaa;)Lsh;")
