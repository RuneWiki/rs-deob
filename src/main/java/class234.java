...
public class class234 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lbi;ZLjava/lang/String;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILmi;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lmi;I)V")
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(II)Lml;")
