...
public class class234 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqi;Z)Z", line = 199)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(III)V", line = 300)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIIII)V", line = 316)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILjava/lang/Object;)[B", line = 465)
