...
public class class234 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILpm;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 26)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IBILha;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 288)
    public final void method1604(int arg0) {
        this.method1599(this.field3512, this.field3517, arg0);
        field3523++;
    }

    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Llba;Lbha;Laga;IIIII)V", line = 359)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIIIII[B)Z", line = 304)
