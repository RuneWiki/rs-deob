...
public class class234 extends class298 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILab;)I", line = 123)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)Z", line = 139)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "()V", line = 357)
    public class234() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILvt;)V", line = 276)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(II)V", line = 313)
    ...
    @OriginalMember(owner = "client!ir", name = "e", descriptor = "(B)V", line = 324)
    ...
    @OriginalMember(owner = "client!ir", name = "d", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IZ)[I", line = 367)
