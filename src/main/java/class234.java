...
public class class234 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZLff;J)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILmo;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IJ)Lff;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Le;IILpg;III[[[B[I[I[I[I[IIBIIZ)V")
