...
public class class234 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I[III)Lcv;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I[II)Lcv;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "([IIB)Lcv;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "([IIII)Lcv;")
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lci;Lci;)V")
