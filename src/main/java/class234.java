...
public class class234 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IB)Laga;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(JJ)J")
    public static long method1616(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "([IJLrh;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(ILcb;Lcb;Luj;)V")
