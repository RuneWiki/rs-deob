...
public class class234 extends class496 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(III)Z", line = 26)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Llk;)V", line = 39)
