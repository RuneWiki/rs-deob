...
public class class234 extends class546 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IZLwq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fga", name = "f", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!fga", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lbea;Lri;)V", line = 405)
    ...
    @OriginalMember(owner = "client!fga", name = "h", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ZIIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IZ)V", line = 395)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(B)Z", line = 433)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ZI)V", line = 456)
    ...
    @OriginalMember(owner = "client!fga", name = "i", descriptor = "(I)V", line = 475)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(III)V", line = 490)
