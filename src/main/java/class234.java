...
public class class234 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BLat;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILat;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIILik;Lik;)V", line = 105)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)V", line = 130)
