...
public class class234 extends class660 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;CI)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(B)V", line = 90)
