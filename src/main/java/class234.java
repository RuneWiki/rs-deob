...
public class class234 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)Lsl;")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLop;)Z")
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Loq;ILbu;)V")
