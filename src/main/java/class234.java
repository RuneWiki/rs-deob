...
public class class234 extends class71 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(I)Lsw;", line = 5)
    ...
    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "(Lwq;)V", line = 20)
    public class234(class679 arg0) {
        this.field3471 = arg0;
    }

    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(I)V", line = 28)
