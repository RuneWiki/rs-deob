...
public class class234 extends class637 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IIILjava/awt/Canvas;)V", line = 20)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IIIIILjava/awt/Graphics;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!rha", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 58)
    ...
    @OriginalMember(owner = "client!rha", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 70)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field3115;
    }

    @OriginalMember(owner = "client!rha", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 79)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field3120;
        return this.field3108 == arg0;
    }

    @OriginalMember(owner = "client!rha", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 92)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field3111;
    }

    @OriginalMember(owner = "client!rha", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!rha", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 114)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IIIII)V", line = 127)
