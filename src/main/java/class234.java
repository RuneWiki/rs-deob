...
public class class234 extends class56 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lbv;)V", line = 48)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIILjb;)V", line = 90)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(III)V", line = 121)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(B)Z", line = 132)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(ZI)V", line = 146)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IILkv;)V", line = 182)
