...
public class class234 {
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 16)
    public class234(String arg0, int arg1) {
        this.field3146 = arg1;
        this.field3144 = arg0;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(III)Lgv;", line = 40)
