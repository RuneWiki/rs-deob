...
public class class234 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IB)Lsk;", line = 24)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "([ILsd;JB)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(ILfo;Lfo;Lh;)V", line = 105)
