...
public class class234 extends class388 implements class171 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Luo;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Luo;II)Lge;", line = 31)
    public final class386 method419(class118 arg0, int arg1, int arg2) {
        ++field3089;
        return arg1 != -20264 ? null : this.method1512(arg2, arg0, 126);
    }

    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(B)I", line = 54)
    public final int method417(byte arg0) {
        ++field3065;
        return arg0 != -116 ? 112 : this.field3090;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(Luo;B)V", line = 95)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Luo;IIIZBLpc;)V", line = 122)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(Luo;B)Lkj;", line = 144)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BI)V", line = 169)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Luo;IIZ)Z", line = 191)
    ...
    @OriginalMember(owner = "client!om", name = "h", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!om", name = "d", descriptor = "(I)Z", line = 227)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Luo;Lnd;IIIIZIZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)I", line = 289)
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!om", name = "i", descriptor = "(I)Loo;", line = 318)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILuo;I)Lge;", line = 333)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Luo;ZBI)Lcb;", line = 355)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLuo;)V", line = 396)
