...
public class class234 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IBIII)Z", line = 55)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)Lsp;", line = 88)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Z)V", line = 191)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lnb;ILoh;)V", line = 237)
