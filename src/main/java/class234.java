...
public class class234 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILfaa;I)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lqa;ILkda;Lkda;)V")
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)Luh;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILbc;)Z")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lbt;IZLkda;Lkda;)V")
