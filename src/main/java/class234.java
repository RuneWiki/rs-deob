...
public abstract class class234 extends class179 {
    ...
    @OriginalMember(owner = "client!w", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lmc;)V", line = 32)
    public class234(class316 arg0) {
        this.field3390 = arg0;
    }

    @OriginalMember(owner = "client!w", name = "b", descriptor = "(III)I", line = 41)
