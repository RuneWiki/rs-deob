...
public abstract class class234 implements class534 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!qk", name = "finalize", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjaclib/memory/Source;B)Z", line = 70)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)Z", line = 111)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(B)I", line = 157)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZLoa;)V", line = 169)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lmc;IZ)V", line = 300)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)J", line = 230)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 245)
