...
public class class234 extends class84 implements class418 {
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BIILha;Lfh;)V", line = 115)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Ltk;IZ[[I)V", line = 152)
