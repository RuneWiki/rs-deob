...
public class class234 extends class452 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZI)V", line = 27)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIB)V", line = 43)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III)V", line = 64)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(IIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 97)
