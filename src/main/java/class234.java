...
public class class234 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BI)Z", line = 25)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(B)V", line = 475)
