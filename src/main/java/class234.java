...
public class class234 extends class237 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lqa;[Lqr;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lqa;J[Lqr;[Lwq;Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "()Lgn;", line = 87)
    public final class492 method1519() {
        return this.field3412;
    }

    @OriginalMember(owner = "client!rb", name = "b", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "([Lwq;Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "()V", line = 190)
    public final void method1522() {
        this.field3411 = true;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lqa;J)Z", line = 195)
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "()V", line = 243)
    public static void method1524() {
        field3404 = null;
        field3397 = null;
    }

    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(J)V", line = 250)
    public final void method1525(long arg0) {
        this.field3399 = arg0;
    }

    @OriginalMember(owner = "client!rb", name = "e", descriptor = "()V", line = 253)
    ...
    @OriginalMember(owner = "client!rb", name = "f", descriptor = "()V", line = 280)
    private final void method1527() {
        this.field3401 = false;
    }

    @OriginalMember(owner = "client!rb", name = "g", descriptor = "()V", line = 283)
    public final void method1528() {
        this.field3401 = true;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIII)V", line = 291)
