...
public class class234 extends class656 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lwu;II)Lue;", line = 113)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "()V", line = 122)
    public final void method1479() {
        this.field3307 = null;
    }

    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Lee;)V", line = 126)
