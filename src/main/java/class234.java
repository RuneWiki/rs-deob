...
public class class234 extends class58 {
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lbf;IIII[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZILbf;[III)Lln;", line = 20)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lbf;IIIIIIZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lbf;IIIZ[I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lbf;IIIIIZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lbf;IIIIZ[BI)V", line = 93)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZILbf;[BIIII)Lln;", line = 119)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIIBLbf;)Lln;", line = 137)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lbf;IIIII[BI)V", line = 155)
