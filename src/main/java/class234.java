...
public class class234 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILec;)V", line = 8)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIZIIZI)V", line = 373)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 417)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lib;I)V", line = 433)
