...
public class class234 extends class424 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(III[IIII[IIZLwca;IIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lpca;)V", line = 219)
