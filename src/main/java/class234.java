...
public class class234 extends class472 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!av", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 3)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1483(0, false, arg0);
        field3033++;
    }

    @OriginalMember(owner = "client!av", name = "d", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)Lkc;", line = 64)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)V", line = 88)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZLjava/awt/event/KeyEvent;)V", line = 110)
    ...
    @OriginalMember(owner = "client!av", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 146)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BIILib;I)V", line = 165)
    ...
    @OriginalMember(owner = "client!av", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 218)
    public final synchronized void focusLost(FocusEvent arg0) {
        field3030++;
        this.method1491('\u0000', 0, -31828, -1);
    }

    @OriginalMember(owner = "client!av", name = "e", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!av", name = "f", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BI)Z", line = 279)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(B)V", line = 295)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 329)
    ...
    @OriginalMember(owner = "client!av", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 354)
    public final void focusGained(FocusEvent arg0) {
        field3049++;
    }

    @OriginalMember(owner = "client!av", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 363)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3031++;
        this.method1483(1, false, arg0);
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(CIII)V", line = 371)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 405)
