...
public abstract class class234 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIIBI[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILsl;)V", line = 43)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I)V", line = 99)
