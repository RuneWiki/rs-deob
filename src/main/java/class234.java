...
public class class234 {
    ...
    @OriginalMember(owner = "client!bea", name = "toString", descriptor = "()Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 93)
    public final void method1569(String arg0, int arg1) {
        field3514++;
        this.method1570((byte) -99, arg0, this.field3523 + arg1);
    }

    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(IZ)V", line = 179)
    public class234(int arg0, boolean arg1) {
        this.field3519 = arg0;
        this.field3527 = arg1;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(BI)I", line = 143)
