...
public class class234 extends class122 {
    ...
    @OriginalMember(owner = "client!tc", name = "o", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!tc", name = "m", descriptor = "([I)V", line = 16)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(FIIFIIF)V", line = 32)
    ...
    @OriginalMember(owner = "client!tc", name = "p", descriptor = "(III[I)V", line = 67)
    ...
    @OriginalMember(owner = "client!tc", name = "N", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!tc", name = "xa", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(III[I)V", line = 105)
    ...
    @OriginalMember(owner = "client!tc", name = "za", descriptor = "(Lc;)V", line = 116)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)[F", line = 138)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIB)Z", line = 161)
    ...
    @OriginalMember(owner = "client!tc", name = "O", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!tc", name = "ka", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!tc", name = "ja", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!tc", name = "s", descriptor = "(IIIIII)V", line = 259)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILc;)V", line = 305)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)[F", line = 329)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIBILsk;)V", line = 354)
    ...
    @OriginalMember(owner = "client!tc", name = "j", descriptor = "(III)V", line = 394)
    ...
    @OriginalMember(owner = "client!tc", name = "ra", descriptor = "(I)V", line = 408)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIIIIZII)V", line = 420)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "()Lc;", line = 445)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 472)
    public class234() {
        this.method179();
    }
}
