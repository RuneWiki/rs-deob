...
public class class234 extends class404 {
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lig;IIZ[[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lig;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lig;IIZ[[I)V", line = 47)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "()V", line = 77)
