...
public class class554 extends class427 {
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(JI)I", line = 5)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)J", line = 37)
    ...
    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(I)J", line = 59)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)J", line = 100)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 116)
