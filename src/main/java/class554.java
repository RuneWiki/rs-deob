...
public class class554 extends class69 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IBLhb;)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "()Lpn;")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "([ILhb;IIII)V")
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "()Lpn;")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Ldt;)V")
