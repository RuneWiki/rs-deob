...
public class class554 extends class30 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(I)V", line = 41)
    private class554(int arg0) {
        super(0, false);
        this.method3109(arg0, -106);
    }

    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IIJZB)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(II)V", line = 141)
    ...
    @OriginalMember(owner = "client!oea", name = "d", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BILac;)V", line = 170)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "()V", line = 204)
    public class554() {
        this(0);
    }

    @OriginalMember(owner = "client!oea", name = "g", descriptor = "(I)Lsc;", line = 210)
