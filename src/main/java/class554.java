...
public class class554 extends class369 {

    @OriginalMember(owner = "client!hq", name = "t", descriptor = "Ljd;")
    public static class539 field7918 = new class539();
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BILlc;)V", line = 16)
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(B)V", line = 30)
    public static final void method3144(byte arg0) {
        ++field7920;
        int var1 = (int) ((double) class142.field1574 * 34.46D);
        int var2 = var1 << 2;
        if (arg0 > -117) {
            field7917 = 12;
        }
        ...
        class701.field9813.method1016(200, var2);
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IZ)V", line = 47)
    public final void method5(int arg0, boolean arg1) {
        if (arg0 != 382) {
            this.method10(false, -44);
        }
        ++field7911;
    }

    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 57)
    public final void method3(byte arg0) {
        int var2 = 69 % ((54 - arg0) / 47);
        super.field5047.method2050(false, 95);
        ++field7915;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZI)V", line = 72)
    public final void method10(boolean arg0, int arg1) {
        if (arg1 != -14330) {
            field7917 = 38;
        }
        super.field5047.method2050(true, arg1 + 14402);
        ++field7913;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lmj;)V", line = 95)
    public class554(class344 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)Z", line = 98)
    public final boolean method8(int arg0) {
        int var2 = -57 / ((37 - arg0) / 36);
        ++field7912;
        return true;
    }
}
