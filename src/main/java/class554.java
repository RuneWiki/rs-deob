...
public class class554 extends class623 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)I", line = 4)
    public final int method2600(int arg0) {
        return arg0 == 25 ? this.field8022 : -52;
    }

    @OriginalMember(owner = "client!oea", name = "d", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Z)I", line = 24)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(I)J", line = 36)
    public final long method2598(int arg0) {
        return arg0 == 16209 ? this.field8019 : -114L;
    }

    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(Z)I", line = 46)
