...
public class class554 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILkda;)V")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IBZLqa;)Lha;")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lkda;ILqa;)V")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lgw;I)V")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lgw;II)V")
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "(B)V")
