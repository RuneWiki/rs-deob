...
public class class554 extends class539 {
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lpq;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lpq;IIII[BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIIIIIZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIIIIII)Z", line = 51)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 136)
