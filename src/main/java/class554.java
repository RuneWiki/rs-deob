...
public class class554 extends class268 implements class355 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Z)J", line = 5)
    public final long method2110(boolean arg0) {
        ++field7782;
        return !arg0 ? -23L : 0L;
    }

    @OriginalMember(owner = "client!vaa", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IBZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "([BBII)V", line = 60)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Leq;ILjaclib/memory/Buffer;IZ)V", line = 86)
    public class554(class357 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7779 = arg1;
    }

    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)I", line = 98)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Leq;I[BIZ)V", line = 109)
    public class554(class357 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7779 = arg1;
    }

    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Let;Z)Ljava/lang/String;", line = 118)
