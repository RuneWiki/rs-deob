...
public class class554 extends class329 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B[[[Llha;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 137)
