...
public class class554 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)Lat;", line = 28)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "()V", line = 116)
    public class554() {
        this.field7894.field4440 = this.field7894;
        this.field7894.field4441 = this.field7894;
    }

    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Z)Lat;", line = 75)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILat;)V", line = 129)
