...
public class class554 extends class201 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([B[I[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(CIIIZLfa;II)V")
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Llea;Lub;[Liba;[I[I)V")
