...
public class class554 extends class454 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lth;II)Z")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V")
