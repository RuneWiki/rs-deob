...
public class class554 extends class748 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!pha", name = "d", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!pha", name = "b", descriptor = "(II)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "()V", line = 126)
    public class554() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IZLvj;)V", line = 134)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(I[BLjava/lang/String;I)I", line = 176)
