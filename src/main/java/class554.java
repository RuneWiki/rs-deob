...
public class class554 extends class676 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lha;J)V", line = 15)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lco;IIIIIIIIIIIZZ)V", line = 189)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "()V", line = 209)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(JI)V", line = 219)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lco;IIIIIIIIIIIZZ)V", line = 616)
