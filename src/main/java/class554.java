...
public class class554 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "([BBII)[B", line = 28)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I[BIIILjava/lang/String;)I", line = 62)
