...
public class class554 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)Ldi;", line = 82)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lre;ILdn;Ldn;)V", line = 172)
