...
public class class554 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)[Lec;", line = 4)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(I)J", line = 51)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BII)I", line = 72)
