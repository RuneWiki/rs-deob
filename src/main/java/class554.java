...
public class class554 extends class214 {
    ...
    @OriginalMember(owner = "client!rg", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IB)[I", line = 14)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILofa;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ljava/lang/String;Z)[B", line = 110)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(II)[[I", line = 141)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIIIIIII)V", line = 218)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "()V", line = 238)
    public class554() {
        super(1, false);
    }
}
