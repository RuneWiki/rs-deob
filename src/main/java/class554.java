...
public class class554 extends class502 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILgj;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(ILeka;)V")
    public class554(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Leka;)V")
