...
public class class554 extends class388 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lsl;BI)V")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lsl;B)V")
