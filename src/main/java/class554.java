...
public class class554 extends class408 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILrg;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lrg;I[I)V")
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(II)Lfa;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lrg;BI)V")
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "e", descriptor = "(B)V")
