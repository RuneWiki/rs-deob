...
public class class554 implements Runnable {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILcr;I[B)Lpq;", line = 3)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILcr;I)Lpq;", line = 22)
    ...
    @OriginalMember(owner = "client!hh", name = "run", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)Z", line = 124)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IILcr;)Lpq;", line = 135)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLpq;)V", line = 151)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Loq;)V", line = 177)
