...
public class class554 extends class298 {
    ...
    @OriginalMember(owner = "client!jw", name = "k", descriptor = "(I)Ltl;", line = 3)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(ILfp;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILag;)V", line = 33)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B[B)I", line = 104)
    ...
    @OriginalMember(owner = "client!jw", name = "l", descriptor = "(I)V", line = 201)
