...
public class class554 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)V", line = 32)
    public final void method2971(int arg0, int arg1) {
        OpenGL.glNewList(this.field7250 + arg0, arg1);
        field7254++;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BII)Z", line = 41)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lji;I)V", line = 52)
    public class554(class622 arg0, int arg1) {
        this.field7250 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IC)V", line = 66)
