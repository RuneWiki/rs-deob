...
public class class554 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([BI)[B", line = 31)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "()V", line = 52)
    public class554() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lee;[BI)V", line = 59)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(III)V", line = 87)
