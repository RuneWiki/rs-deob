...
public class class396 extends class43 implements class128 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lpn;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lkn;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lfca;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIF)Lpn;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lq;[Lht;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lqu;Lq;[Lht;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Law;Z)Lxa;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lkn;Lkn;FLkn;)Lkn;")
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(IIIIII)Lkn;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lqu;)V")
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "()Log;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lqu;Z)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lsga;[Law;Z)Lta;")
