...
public class class396 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IILjw;IIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "([[BILuk;)V")
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)Lvf;")
