...
public class class396 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!wj", name = "finalize", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lwh;JI)V", line = 74)
