...
public abstract class class396 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILjava/util/Random;)I", line = 75)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIIII)Z", line = 120)
    ...
    @OriginalMember(owner = "client!q", name = "c", descriptor = "(I)Ljava/lang/String;", line = 179)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 200)
