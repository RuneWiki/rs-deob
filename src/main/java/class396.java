...
public class class396 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Ljp;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lke;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Ljp;)V", line = 149)
