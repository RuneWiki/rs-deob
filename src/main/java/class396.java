...
public class class396 extends class346 {
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 3)
    public class396() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIIB)Lbq;", line = 49)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(II)[[I", line = 81)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZI)V", line = 146)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lfb;ZI)V", line = 297)
