...
public class class396 extends class17 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Z)V", line = 136)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 146)
    public class396() {
        super(0, true);
    }
}
