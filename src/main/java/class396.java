...
public class class396 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lgr;IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BIIJ)V", line = 68)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ZIILms;)V", line = 146)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)Lnn;", line = 161)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B[B)[B", line = 201)
