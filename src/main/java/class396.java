...
public class class396 extends class620 implements class274 {
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lmea;I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Lha;Lih;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(ILha;)Lid;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILha;)V")
