...
public class class396 extends class618 implements class532 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)Z", line = 183)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Loa;B)V", line = 194)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Z)V", line = 209)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Loa;Lbd;IIIIIZII)V", line = 219)
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(II)V", line = 228)
    ...
    @OriginalMember(owner = "client!ifa", name = "c", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(Z)I", line = 255)
    public final int method146(boolean arg0) {
        ++field5262;
        return arg0 ? -78 : this.field5261.field947;
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Loa;I)V", line = 267)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(BLoa;)Lpe;", line = 282)
    ...
    @OriginalMember(owner = "client!ifa", name = "c", descriptor = "(Z)I", line = 327)
    public final int method152(boolean arg0) {
        ++field5268;
        return !arg0 ? 42 : this.field5261.field952;
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Loa;BI)Lba;", line = 339)
    ...
    @OriginalMember(owner = "client!ifa", name = "c", descriptor = "(B)V", line = 350)
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(B)I", line = 363)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(I)Z", line = 374)
    public final boolean method139(int arg0) {
        ++field5260;
        return arg0 != 2;
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(III)Lfr;", line = 385)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(JJ)J", line = 405)
    public static long method2277(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ILoa;ILni;ZZI)V", line = 412)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ILoa;)Ldd;", line = 424)
    public final class660 method143(int arg0, class651 arg1) {
        ++field5259;
        return arg0 != 31358 ? null : this.field5271;
    }

    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Loa;Z)V", line = 438)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(BILoa;I)Z", line = 464)
