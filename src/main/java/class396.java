...
public class class396 extends class253 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lgu;)Lwm;", line = 4)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
