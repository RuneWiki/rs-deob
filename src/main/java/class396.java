...
public class class396 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljr;IB)V", line = 39)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljr;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 91)
