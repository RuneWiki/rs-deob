...
public class class396 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lya;IZ)Z", line = 41)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BIIIIIIIILya;)V", line = 132)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(I[Lil;IIII)V", line = 222)
