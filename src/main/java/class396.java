...
public class class396 extends class214 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIJI)V", line = 5)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Luq;B[[B)V", line = 49)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "()V", line = 140)
    public class396() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BI)[I", line = 155)
