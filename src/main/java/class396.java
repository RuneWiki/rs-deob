...
public class class396 extends class166 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IBI)V", line = 22)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILmv;Lda;ZLha;Ljava/lang/String;)V", line = 35)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIB)Z", line = 136)
