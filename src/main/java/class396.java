...
public class class396 extends class702 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Ljf;II)V")
    ...
    @OriginalMember(owner = "client!mea", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(I)Lio;")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lkga;)V")
