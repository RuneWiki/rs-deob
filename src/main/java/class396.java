...
public class class396 extends class96 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZII)V", line = 8)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lml;Lau;)V", line = 46)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZB)V", line = 106)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IZLica;)V", line = 173)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Z)Z", line = 191)
