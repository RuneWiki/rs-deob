...
public class class396 extends class751 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I[ILkv;IZIII)Lbo;", line = 3)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "()V", line = 53)
    public class396() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(BIIIIII)I", line = 56)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(ILrv;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I[IB)V", line = 240)
    ...
    @OriginalMember(owner = "client!fha", name = "e", descriptor = "(B)V", line = 397)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(II)[I", line = 437)
