...
public class class396 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Loq;IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(I)V", line = 72)
