...
public class class396 extends class529 implements class276 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(FFFFFFLea;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!k", name = "finalize", descriptor = "()V", line = 15)
    protected final void finalize() {
        class390.method2237(true, this);
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IILea;II)V", line = 27)
    public final void method122(int arg0, int arg1, class382 arg2, int arg3, int arg4) {
        this.method2269(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lh;Lba;[IIIII)V", line = 31)
