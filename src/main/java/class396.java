...
public class class396 extends class485 {
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(II)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ch", name = "d", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILjava/awt/Canvas;ZLn;)Lqa;", line = 82)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lqa;Ljj;IILbc;B)Z", line = 97)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIIII)V", line = 316)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIII)V", line = 750)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lcb;II)V", line = 768)
    public class396(class444 arg0, int arg1, int arg2) {
        this.field5444 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lica;I)V", line = 781)
