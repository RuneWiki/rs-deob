...
public class class396 extends class149 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "()V", line = 3)
    public final void method1057() {
        field5449.method2035(this.field5448, -12428);
    }

    @OriginalMember(owner = "client!gl", name = "d", descriptor = "()I", line = 6)
    public final int method1063() {
        return field5449.method2036(this.field5448, false);
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 9)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "()V", line = 12)
    public final void method1060() {
        field5449.method2038(this.field5448, true);
    }

    @OriginalMember(owner = "client!gl", name = "e", descriptor = "()V", line = 17)
    public static void method2388() {
        field5449 = null;
    }

    @OriginalMember(owner = "client!gl", name = "c", descriptor = "()V", line = 20)
    public final void method1061() {
        field5449.method2037(this.field5448, super.field2040);
    }

    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lis;I)V", line = 22)
    public class396(class65 arg0, int arg1) {
        field5449 = arg0.method614(-77);
        this.field5448 = arg1;
    }

    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 27)
