...
public class class396 extends class687 implements class90 {
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lhb;Llw;IIZ[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lhb;Llw;Lal;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lhb;IIZ[III)V", line = 81)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lgca;I)V", line = 139)
    public final void method204(class206 arg0, int arg1) {
        int var3 = -36 % ((-arg1 - 2) / 39);
        super.method204(arg0, -127);
    }

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(B)Z", line = 147)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)I", line = 158)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 168)
    public final IDirect3DBaseTexture method1860(byte arg0) {
        return arg0 == -66 ? this.field5903 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)I", line = 178)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILlw;IIIIII[B)V", line = 189)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZZ)V", line = 232)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I[IIIIIII)V", line = 308)
