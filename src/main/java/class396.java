...
public class class396 extends class383 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lqn;II)Lpu;")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lqn;I)Lpu;")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lqn;)Z")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "([I)Ljc;")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)[F")
