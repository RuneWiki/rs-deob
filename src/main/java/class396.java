...
public class class396 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BI)C", line = 178)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)V", line = 206)
