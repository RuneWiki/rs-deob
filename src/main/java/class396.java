...
public class class396 extends class252 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)Ljc;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BII)Lg;")
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(ILjb;Ljb;Lph;Lau;IIZ)V")
