...
public class class396 extends Canvas {
    ...
    @OriginalMember(owner = "client!uba", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Lri;Z)V")
    ...
    @OriginalMember(owner = "client!uba", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
