...
public class class396 extends class187 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IBLqk;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lhk;)V")
    public class396(class111 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lcn;Z[[[BIB)Z")
