...
public class class396 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(III)Lne;", line = 52)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BIIIIIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIILjava/lang/Class;)Lfu;", line = 89)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lep;III)V", line = 202)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)V", line = 215)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIBI)Z", line = 250)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIBLep;)V", line = 275)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 314)
