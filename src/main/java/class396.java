...
public class class396 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IILek;)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lek;B)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)Lfda;")
