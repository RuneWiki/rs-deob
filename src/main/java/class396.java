...
public abstract class class396 implements class249 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Luu;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZZ)V", line = 128)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Z)I", line = 149)
    public final int method2426(boolean arg0) {
        field5803++;
        return arg0 ? this.field5811 : -27;
    }

    @OriginalMember(owner = "client!kj", name = "d", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!kj", name = "finalize", descriptor = "()V", line = 176)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(Z)Z", line = 188)
    ...
    @OriginalMember(owner = "client!kj", name = "e", descriptor = "(I)Z", line = 225)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lfd;IIIZ)V", line = 265)
