...
public class class396 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z[Lig;Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIZI)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([Lig;ILjava/lang/String;I)Ljava/lang/String;", line = 93)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 215)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BZ[Ltq;III)V", line = 231)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([Lig;IBLjava/lang/String;)I", line = 278)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BIC)I", line = 288)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZI)I", line = 307)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I[Lig;IILjava/lang/String;)I", line = 321)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([Ljava/lang/String;B[ILjava/lang/String;[Lig;)I", line = 340)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "([B)V", line = 594)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIZLtq;)V", line = 717)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I[Lig;Ljava/lang/String;)I", line = 730)
