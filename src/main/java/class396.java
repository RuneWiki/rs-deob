...
public class class396 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILsl;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IBLla;I)Lqt;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILsl;I)V")
