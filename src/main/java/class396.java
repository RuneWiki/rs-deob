...
public class class396 extends class64 {
    ...
    @OriginalMember(owner = "client!qe", name = "e", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(I)V", line = 33)
    public class396(int arg0) {
        this.field5225 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!qe", name = "f", descriptor = "(B)V", line = 47)
