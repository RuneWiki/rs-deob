...
public abstract class class396 implements class410 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ZB)V", line = 27)
    ...
    @OriginalMember(owner = "client!at", name = "c", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lec;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lla;Lla;Lbc;)V", line = 180)
