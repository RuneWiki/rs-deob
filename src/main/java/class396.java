...
public class class396 extends class16 implements class103 {
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lqa;Lna;[I[BIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!k", name = "BA", descriptor = "(III)V", line = 21)
    public final void method89(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!k", name = "t", descriptor = "(IIIIII)V", line = 26)
    public final void method88(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!k", name = "b", descriptor = "(FFFFFFLma;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IILma;II)V", line = 33)
