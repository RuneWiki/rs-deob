...
public class class396 extends class156 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;)V", line = 58)
    ...
    @OriginalMember(owner = "client!jba", name = "h", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(B)[B", line = 98)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Z)I", line = 118)
