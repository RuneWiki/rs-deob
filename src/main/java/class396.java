...
public class class396 extends class497 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III)Lbda;")
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lor;Lma;IIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)Lhg;")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)Loh;")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILsea;II)Lqea;")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lsea;Lsea;ILsea;Lsea;)V")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZLjava/awt/Canvas;Lfa;Lsea;)Lr;")
