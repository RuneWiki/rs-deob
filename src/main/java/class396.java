...
public class class396 extends class512 {
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(I)V", line = 20)
    public static void method2474(int arg0) {
        field6051 = null;
        int var1 = -33 / ((58 - arg0) / 40);
    }

    @OriginalMember(owner = "client!wg", name = "g", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lec;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "()V", line = 151)
    public class396() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIB)I", line = 156)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(II)[[I", line = 183)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(II)V", line = 232)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lwc;Lwc;I)V", line = 485)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZILia;)V", line = 511)
