...
public class class396 extends class381 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(III[II)V", line = 6)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)V", line = 52)
