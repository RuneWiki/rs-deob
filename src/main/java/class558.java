...
public class class558 extends class264 {
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(ILmfa;)V")
    public class558(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lmfa;)V")
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "(II)V")
