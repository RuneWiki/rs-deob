...
public class class558 implements Runnable {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILme;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lqg;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IILuj;)Lme;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Luj;II)Lme;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BI[BLuj;)Lme;")
