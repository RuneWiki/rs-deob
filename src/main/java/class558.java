...
public class class558 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lub;[Lul;)V", line = 211)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II[[ZIZI)V", line = 300)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lha;ZII)V", line = 499)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)V", line = 580)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILha;II)V", line = 592)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIIB)V", line = 665)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lifa;Ljda;)V", line = 710)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILha;I)Z", line = 725)
