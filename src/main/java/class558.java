...
public class class558 extends class244 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Luo;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLhga;Lhga;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BIIILffa;I)V")
