...
public class class558 extends class18 implements class532 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Loa;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BILoa;I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(Z)I", line = 50)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Loa;B)V", line = 61)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(Z)I", line = 73)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILoa;)Ldd;", line = 95)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)Z", line = 120)
    ...
    @OriginalMember(owner = "client!th", name = "g", descriptor = "(B)I", line = 136)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Loa;Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BLoa;)Lpe;", line = 176)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Loa;Lbd;IIIIIZIIIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Loa;BI)Lba;", line = 232)
