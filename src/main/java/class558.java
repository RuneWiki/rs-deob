...
public class class558 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILmc;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lmc;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(III)Lsi;", line = 172)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)Z", line = 181)
