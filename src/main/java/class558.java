...
public class class558 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIII[BI)Z", line = 10)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIZ)Z", line = 57)
    public static final boolean method3121(int arg0, int arg1, boolean arg2) {
        field7605++;
        return arg2 ? (arg1 & 0x18) != 0 | (arg1 & 0x220) == 544 : true;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 72)
