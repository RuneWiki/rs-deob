...
public class class558 extends class585 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lwia;B)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II[Lmea;)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lso;II)V")
