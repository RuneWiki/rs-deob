...
public class class558 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!de", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field7749++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 49)
    public class558(String arg0, String arg1, String arg2, int arg3) {
        this.field7756 = arg3;
    }

    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)I", line = 63)
    public static final int method3253(int arg0) {
        field7750++;
        return arg0 > -112 ? -38 : class89.field1190;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IBIIZIZ)V", line = 83)
