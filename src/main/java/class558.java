...
public class class558 extends class419 {
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 4)
    public class558() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!fs", name = "g", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(IIII)[B", line = 21)
    ...
    @OriginalMember(owner = "client!fs", name = "h", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIB)V", line = 50)
