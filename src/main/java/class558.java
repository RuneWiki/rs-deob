...
public class class558 extends class511 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIILr;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(Lr;I)Lbca;", line = 42)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(IIIII)V", line = 204)
    public class558(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!re", name = "e", descriptor = "(B)Z", line = 212)
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(I)I", line = 222)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lr;Z)V", line = 234)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILr;)Lcr;", line = 250)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lsea;ILsea;Ljca;Lsea;Ljba;)Z", line = 290)
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(I)I", line = 317)
    public final int method217(int arg0) {
        ++field7517;
        return arg0 <= 29 ? 54 : -10;
    }

    @OriginalMember(owner = "client!re", name = "b", descriptor = "(Z)Z", line = 330)
