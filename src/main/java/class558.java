...
public abstract class class558 extends class108 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ILaj;)V")
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lco;I)V")
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "([ILjk;[I[IB)V")
