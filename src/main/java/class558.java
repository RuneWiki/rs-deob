...
public class class558 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ln;IILoa;IIII)Lxa;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lta;IIIILn;Loa;ILoa;ZZZ)Lxa;")
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "(II)Lol;")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Ldd;IZLqba;Lpj;Lpj;)V")
