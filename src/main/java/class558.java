...
public class class558 {
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lqo;IB)V", line = 46)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILml;Ljava/lang/String;I)Luk;", line = 98)
