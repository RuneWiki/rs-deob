...
public class class558 extends class4 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!sba", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 67)
