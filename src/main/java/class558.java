...
public class class558 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Ljca;Z)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IB)Ljca;")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Ljca;)V")
