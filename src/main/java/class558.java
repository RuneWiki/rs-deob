...
public class class558 extends class203 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!hb", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZLwha;)V", line = 114)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZB)V", line = 127)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)Z", line = 139)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lpq;)V", line = 250)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 206)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lsha;III)V", line = 225)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BZ)V", line = 364)
