...
public class class558 extends class254 {
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(III)Lmj;", line = 7)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(I)V", line = 27)
