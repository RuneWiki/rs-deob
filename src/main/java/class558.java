...
public class class558 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BLso;Ljava/lang/Object;)V", line = 54)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BII)Z", line = 81)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Len;B)V", line = 92)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lso;B)V", line = 109)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(B)I", line = 181)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILso;)Ljava/lang/Object;", line = 196)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lso;ILjava/lang/Object;Z)V", line = 265)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(I)V", line = 301)
