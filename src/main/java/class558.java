...
public class class558 extends class373 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZII[III)Lch;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z[FIILpd;III)Lch;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lsr;B)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IBLll;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Llf;B)I")
    ...
    @OriginalMember(owner = "client!fi", name = "i", descriptor = "(II)Lnia;")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "()Lkaa;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZIIII[BLpd;I)Lch;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lej;I)I")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILwl;)I")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lcc;I)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Llf;ZIZZ)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ljagdx/IDirect3D;Ljagdx/D3DPRESENT_PARAMETERS;IIII)Z")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lhca;I)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lvd;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lok;ILpd;ZI)Lch;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Llf;IZZ)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)Ldk;")
    public final class512 method454(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lom;Lom;FLom;)Lom;")
    public final class374 method499(class374 arg0, class374 arg1, float arg2, class374 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/qr;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lqs;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lvd;I)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLpd;Lok;)I")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([[IIZZ)Lpf;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lbi;Ldk;)Lpk;")
    public final class198 method517(class482 arg0, class512 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILok;Lpd;)Z")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([Lbq;I)Lsr;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLok;Lpd;)Z")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lpk;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(IZ)Ljf;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lef;Z)I")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZLpha;)I")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lef;BII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([BIIZILpd;)Lkj;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;I)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILdga;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLde;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIILjf;ILef;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(II)Lbi;")
    public final class482 method473(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(ZI)Lll;")
