...
public class class558 implements class733 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)Z", line = 69)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIII[B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Leq;Lrp;)V", line = 133)
