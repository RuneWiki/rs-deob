...
public class class558 extends class283 {
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lkw;)V", line = 30)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZI)V", line = 83)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lou;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZII)V", line = 138)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)Z", line = 151)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 171)
