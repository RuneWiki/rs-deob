...
public class class558 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lqa;Ljj;BLbc;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIII)Z", line = 174)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIIIIIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 392)
