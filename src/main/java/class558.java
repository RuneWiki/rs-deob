...
public class class558 extends class529 {
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "()V", line = 352)
    public class558() {
        super(0, true);
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IB)[I", line = 12)
    ...
    @OriginalMember(owner = "client!va", name = "f", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IBLtn;)V", line = 255)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(I)V", line = 340)
