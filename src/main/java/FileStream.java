...
@OriginalClass("IGSLDTHC")
public class FileStream {

    @OriginalMember(owner = "IGSLDTHC", name = "a", descriptor = "I")
    private int _flowObfuscator1 = 923;

    @OriginalMember(owner = "IGSLDTHC", name = "b", descriptor = "Z")
    private boolean _flowObfuscator2 = true;

    @OriginalMember(owner = "IGSLDTHC", name = "g", descriptor = "I")
    public int maxFileSize = 65000;

    @OriginalMember(owner = "IGSLDTHC", name = "f", descriptor = "I")
    public int archive;

    @OriginalMember(owner = "IGSLDTHC", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile dat;

    @OriginalMember(owner = "IGSLDTHC", name = "e", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile idx;

    @OriginalMember(owner = "IGSLDTHC", name = "c", descriptor = "[B")
    public static byte[] temp = new byte[520];

    @OriginalMember(owner = "IGSLDTHC", name = "<init>", descriptor = "(ILjava/io/RandomAccessFile;Ljava/io/RandomAccessFile;IZ)V")
    ...
    @OriginalMember(owner = "IGSLDTHC", name = "a", descriptor = "(ZI)[B")
    ...
    @OriginalMember(owner = "IGSLDTHC", name = "a", descriptor = "(I[BBI)Z")
    ...
    @OriginalMember(owner = "IGSLDTHC", name = "a", descriptor = "(ZIII[B)Z")
    ...
    @OriginalMember(owner = "IGSLDTHC", name = "a", descriptor = "(Ljava/io/RandomAccessFile;II)V")
