...
public class class484 extends class281 implements class373 {
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lji;I[BI)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILoi;)I")
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lji;ILjaclib/memory/Buffer;)V")
