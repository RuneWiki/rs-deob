...
public class class484 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Loq;ZZ)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(BI)Lwl;")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Ljk;ILae;Llo;)V")
