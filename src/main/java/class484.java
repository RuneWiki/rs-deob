...
public class class484 extends class485 {
    ...
    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!jm", name = "d", descriptor = "(I)J", line = 26)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)I", line = 58)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "()V", line = 101)
    public class484() {
