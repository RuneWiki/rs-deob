...
public class class484 extends class71 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIILpn;Lpn;)V", line = 5)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I[[[Lve;)V", line = 65)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Luu;Luu;Luu;Lefa;ZLaea;)Z", line = 142)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "([B)V", line = 167)
    public class484(byte[] arg0) {
        this.field6744 = arg0;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZB)V", line = 176)
