...
public abstract class class484 extends class543 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lat;[I)V")
    public final void method1328(class535 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!hu", name = "ya", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!hu", name = "X", descriptor = "(IILk;)Lk;")
    ...
    @OriginalMember(owner = "client!hu", name = "F", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lk;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lfg;IIII[[I[[II)V")
