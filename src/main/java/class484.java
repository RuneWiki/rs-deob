...
public class class484 extends class603 implements class209 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 14)
    public final void method650(boolean arg0) {
        field7089++;
        super.method650(arg0);
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/lang/String;)I", line = 23)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lgf;Z)V", line = 55)
    public class484(class234 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 88)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)Z", line = 101)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)Z", line = 130)
