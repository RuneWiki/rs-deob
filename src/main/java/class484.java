...
public class class484 extends class625 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLfba;ILha;)V", line = 20)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II)[[I", line = 361)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I[[I)V", line = 411)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(BII)Z", line = 422)
