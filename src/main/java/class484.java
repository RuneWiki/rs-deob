...
public class class484 extends class597 implements class310 {
    ...
    @OriginalMember(owner = "client!fo", name = "c", descriptor = "(B)V", line = 4)
    public final void method140(byte arg0) {
        field6013++;
        int var2 = 17 % ((-arg0 - 16) / 40);
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([JIII[Ljava/lang/Object;)V", line = 13)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)Z", line = 67)
    ...
    @OriginalMember(owner = "client!fo", name = "c", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Loa;B)V", line = 89)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(IIIIIIIIIILwda;)V", line = 101)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIIIIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(Loa;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Loa;I)V", line = 165)
    public final void method136(class650 arg0, int arg1) {
        field6023++;
        int var3 = 113 % ((-arg1 - 78) / 37);
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZLoa;Lnt;IIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BILoa;I)Z", line = 185)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILoa;)Lww;", line = 195)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([[BILgo;)V", line = 207)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(Loa;I)Lqt;", line = 236)
    public final class595 method6(class650 arg0, int arg1) {
        field6008++;
        return arg1 == -7459 ? this.field6007.method6(arg0, arg1) : null;
    }

    @OriginalMember(owner = "client!fo", name = "e", descriptor = "(I)I", line = 247)
    ...
    @OriginalMember(owner = "client!fo", name = "g", descriptor = "(I)V", line = 258)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Loa;BI)Lba;", line = 269)
    public final class359 method134(class650 arg0, byte arg1, int arg2) {
        field6002++;
        return arg1 <= 80 ? null : null;
    }

    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(B)I", line = 280)
    public final int method139(byte arg0) {
        field6014++;
        return arg0 <= 13 ? -6 : 0;
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)I", line = 295)
