...
public class class484 extends class96 {
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "()V", line = 5)
    public class484() {
        super(0, true);
    }

    @OriginalMember(owner = "client!va", name = "e", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(II)[I", line = 19)
