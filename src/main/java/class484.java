...
public class class484 extends class125 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IIILhf;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(ILgp;)V", line = 29)
    public class484(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IIZZI)V", line = 59)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ZI)I", line = 69)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(BI)V", line = 84)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(Z)I", line = 96)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Lgp;)V", line = 112)
    public class484(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(Z)V", line = 115)
