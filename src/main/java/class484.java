...
public class class484 extends class242 {
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(Lkm;I)Lto;", line = 94)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(Lkm;I)V", line = 151)
    public final void method197(class487 arg0, int arg1) {
        int var3 = -98 % ((64 - arg1) / 59);
        ++field6815;
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lkm;BII)Z", line = 163)
