...
public class class484 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V")
