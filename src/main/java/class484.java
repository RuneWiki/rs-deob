...
public class class484 extends class108 {
    ...
    public final void method2735(int arg0, int arg1) {
        ...
        if (field6764 == null || field6764.length < this.field6766.length) {
            field6764 = new int[this.field6766.length];
        }
        int var3 = this.field6766.length;
        int var4 = arg0;
        int var5 = this.field6767 - 1;
        int var6 = this.field6767 * arg1;
        int var7 = var3 - 1;
        for (int var8 = 0; var8 < var3; var8 += this.field6767) {
            int var10 = var6 + var8 & var7;
            for (int var11 = 0; var11 < this.field6767; var11++) {
                int var12 = var8 + var11;
                int var13 = (var4 + var11 & var5) + var10;
                field6764[var12] = this.field6766[var13];
            }
        }
        int[] var9 = this.field6766;
        this.field6766 = field6764;
        field6764 = var9;
    }
    ...
    public class484(int arg0, int arg1, int[] arg2, boolean arg3) {
        this.field6768 = arg0;
        this.field6767 = arg1;
        this.field6766 = arg2;
        if (arg3) {
            int[] var5 = new int[this.field6767];
            int[] var6 = new int[this.field6767];
            int[] var7 = new int[this.field6767];
            if (field6764 == null || field6764.length < this.field6766.length) {
                field6764 = new int[this.field6766.length];
            }
            int var8 = this.field6767;
            int var9 = this.field6767;
            int var10 = var8 - 1;
            int var11 = var9 - 1;
            int var12 = var8 * var9;
            int var13 = var8;
            ...
            for (int var15 = 2; var15 >= 0; var15--) {
                for (int var32 = var10; var32 >= 0; var32--) {
                    var13--;
                    int var33 = this.field6766[var13];
            ...
            for (int var17 = var11; var17 >= 0; var17--) {
                ...
                for (int var25 = var10; var25 >= 0; var25--) {
                    ...
                    int var31 = var22 / 9;
                    var16--;
                    field6764[var16] = var29 << 16 | var30 << 8 | var31;
                ...
                for (int var26 = var10; var26 >= 0; var26--) {
                    var13--;
                    int var27 = this.field6766[var13];
                    var14--;
                    int var28 = this.field6766[var14];
