...
public class class484 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/Object;Lts;II)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZLae;)Z")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BLts;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lhu;B)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lts;B)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lts;Ljava/lang/Object;B)V")
