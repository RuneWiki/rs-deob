...
public class class484 extends class374 {
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(I)V", line = 3)
    public class484(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kj", name = "m", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!kj", name = "u", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!kj", name = "v", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([IB)V", line = 62)
    ...
    @OriginalMember(owner = "client!kj", name = "n", descriptor = "(II)I", line = 73)
    ...
    @OriginalMember(owner = "client!kj", name = "j", descriptor = "(B)Z", line = 84)
    ...
    @OriginalMember(owner = "client!kj", name = "j", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!kj", name = "o", descriptor = "(II)I", line = 119)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIB[B)V", line = 135)
    ...
    @OriginalMember(owner = "client!kj", name = "p", descriptor = "(II)I", line = 154)
    ...
    @OriginalMember(owner = "client!kj", name = "k", descriptor = "(B)V", line = 187)
