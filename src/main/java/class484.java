...
public class class484 extends class42 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLci;)I", line = 6)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IB)V", line = 31)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)V", line = 60)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIIB)Luc;", line = 77)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BJ)V", line = 138)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(IIIIIZ)V", line = 212)
