...
public abstract class class484 implements class338 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lkda;)V", line = 231)
    public class484(class352 arg0) {
        this.field7055 = arg0;
    }

    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I[IIIIBII)V", line = 239)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ZI)V", line = 345)
