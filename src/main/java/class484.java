...
public class class484 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(IIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IB)Lgda;", line = 36)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(I)I", line = 47)
