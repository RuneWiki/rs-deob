...
public class class484 extends class261 implements class116 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Z)I", line = 5)
    public final int method16(boolean arg0) {
        ++field6858;
        return arg0 ? 58 : this.field6861.field1346;
    }

    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Loj;Lcu;IIIIIZIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(ILoj;)V", line = 109)
    ...
    @OriginalMember(owner = "client!pl", name = "e", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Ljava/lang/String;ZC)I", line = 132)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILoj;II)Z", line = 169)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILoj;B)Lqh;", line = 192)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 204)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(B)I", line = 215)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(ILoj;)Lmg;", line = 229)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILoj;)V", line = 266)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(B)I", line = 277)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(I)Z", line = 290)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(ILoj;)V", line = 303)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(B)V", line = 320)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIILoj;IBII)V", line = 332)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)Z", line = 483)
