...
public class class484 extends class193 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lsq;II)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lug;Lpl;)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILjava/lang/String;I)I")
