...
public class class484 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILev;IIII)Lho;", line = 3)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)Lnl;", line = 34)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lss;III[Z)Z", line = 75)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IBI)I", line = 110)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(II)V", line = 326)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZI)I", line = 345)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)V", line = 356)
    ...
    @OriginalMember(owner = "client!jn", name = "c", descriptor = "(B)V", line = 383)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lci;ILhe;)V", line = 405)
