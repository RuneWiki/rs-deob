...
public class class484 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!uea", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field6544++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uea", name = "a", descriptor = "([BBILjava/lang/String;)I", line = 38)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(II[S)[S", line = 82)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "()V", line = 99)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 272)
