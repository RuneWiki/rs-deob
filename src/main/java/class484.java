...
public class class484 extends class307 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([B[IIIIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "([B[IIIIIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!jc", name = "OA", descriptor = "(CIIIZ)V", line = 193)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "([B[IIIIIIIIIIILma;II)V", line = 256)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(CIIIZLma;II)V", line = 341)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Ldg;Ldu;[Lul;[I[I)V", line = 410)
