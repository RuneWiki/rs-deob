...
public class class484 extends class24 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pc", name = "W", descriptor = "(IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!pc", name = "RA", descriptor = "()I", line = 95)
    public final int method145() {
        field6741++;
        return this.field6758.field1350 + this.field6743 + this.field6750;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(FFFFFFLta;II)V", line = 104)
    ...
    @OriginalMember(owner = "client!pc", name = "YA", descriptor = "()I", line = 191)
    public final int method146() {
        field6738++;
        return this.field6758.field1350;
    }

    @OriginalMember(owner = "client!pc", name = "ya", descriptor = "(IIIIIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!pc", name = "oa", descriptor = "(III)V", line = 303)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILta;II)V", line = 328)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!pc", name = "ZA", descriptor = "()I", line = 413)
    public final int method155() {
        field6756++;
        return this.field6758.field1349;
    }

    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lih;IIII)V", line = 692)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lih;II[III)V", line = 702)
    ...
    @OriginalMember(owner = "client!pc", name = "H", descriptor = "(FFFFFFIII)V", line = 438)
    ...
    @OriginalMember(owner = "client!pc", name = "ha", descriptor = "(IIII)V", line = 506)
    ...
    @OriginalMember(owner = "client!pc", name = "XA", descriptor = "(IIIIII)V", line = 519)
    ...
    @OriginalMember(owner = "client!pc", name = "la", descriptor = "(IIIIIII)V", line = 530)
    ...
    @OriginalMember(owner = "client!pc", name = "Q", descriptor = "()I", line = 666)
