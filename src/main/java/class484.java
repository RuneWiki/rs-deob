...
public class class484 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)Lll;", line = 31)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Ljc;ILgp;)V", line = 66)
