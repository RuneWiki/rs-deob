...
public class class484 extends class387 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(JJ)J", line = 4)
    public static long method2734(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IB)V", line = 13)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lrda;)V", line = 30)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BILiga;)V", line = 143)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)Z", line = 173)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BZ)V", line = 188)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZB)V", line = 232)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 259)
