...
public class class484 extends class396 {
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lla;Lla;Lsr;)V")
    public class484(class476 arg0, class476 arg1, class265 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lffa;BILjava/lang/String;)Lwj;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIILcn;)V")
