...
public class class484 extends class277 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZIIBI)Ltt;")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lqj;Lpea;)V")
