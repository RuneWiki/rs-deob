...
public class class484 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILre;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILjava/lang/String;JZZILjava/lang/String;IZBI)V", line = 23)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILnd;)Z", line = 100)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "()V", line = 168)
    public class484() {
        this.field6789 = -60;
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lre;)V", line = 184)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II)I", line = 123)
    public static final int method2832(int arg0, int arg1) {
        field6800++;
        return arg1 == -1951 ? arg0 >>> 8 : -93;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIII)I", line = 134)
