...
public class class484 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IBIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 111)
