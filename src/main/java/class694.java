...
public class class694 extends class416 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(CIIIZLua;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Ltea;Luq;[Lfg;[I[I)V")
    ...
    @OriginalMember(owner = "client!nh", name = "OA", descriptor = "(CIIIZ)V")
