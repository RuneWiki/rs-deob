...
public class class694 extends class219 implements class670 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILwq;IZ)V")
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lkv;III)V")
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lkv;IIII)V")
