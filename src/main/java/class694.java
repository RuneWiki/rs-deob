...
public class class694 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Lee;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(BI[BIIII)Z", line = 37)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Lee;B)V", line = 85)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IIIIIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Z)V", line = 288)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)V", line = 307)
