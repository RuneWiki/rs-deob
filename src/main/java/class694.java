...
public class class694 extends class272 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III[[ZZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!eu", name = "DA", descriptor = "(Lha;IIIIZ)V", line = 54)
    public final void method1274(class119 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lgga;[I)V", line = 63)
    public final void method1289(class332 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lnga;IIII[[I[[II)V", line = 98)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 71)
    public final boolean method1286(class119 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!eu", name = "E", descriptor = "(Lha;IIIIZ)V", line = 73)
    public final void method1284(class119 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!eu", name = "BA", descriptor = "()V", line = 76)
    public final void method1288() {
        this.field9848 = null;
        this.field9839 = null;
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIIIIII[[Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!eu", name = "O", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 644)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IILjea;[I[I[I[I)V", line = 656)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(II)I", line = 1158)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 1187)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIIIIII[[ZLlfa;Ljea;[I[I)V", line = 1419)
                ...
                if (arg7[var18 - arg3][var19 - arg4]) {
                    if (this.field9838[var18][var19] != null) {
                        ...
                        for (int var25 = 0; var25 < var23.field518; ++var25) {
                            ...
                            } else if (var23.field512 != null && var23.field512[var25] != -1) {
    ...
    @OriginalMember(owner = "client!eu", name = "v", descriptor = "(IILha;)Lha;", line = 1552)
    public final class119 method1285(int arg0, int arg1, class119 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III[[ZZ)V", line = 1558)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(IIIIIII[[ZLlfa;Ljea;[I[I)V", line = 1607)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)Z", line = 1742)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIZLlfa;Ljea;[I[I[I[I)V", line = 1758)
