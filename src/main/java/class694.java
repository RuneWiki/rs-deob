...
public class class694 extends Canvas {
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    public class694(Component arg0) {
        this.field9729 = arg0;
    }

    @OriginalMember(owner = "client!eu", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lhl;B)V")
    ...
    @OriginalMember(owner = "client!eu", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
