...
public class class694 extends class60 implements class533 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 4)
    public final void method345(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()Z", line = 8)
    public final boolean method381() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()V", line = 10)
    public final void method458() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lcba;", line = 14)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lcba;)V", line = 18)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 40)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Z", line = 43)
    public final boolean method375() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 46)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lku;", line = 74)
    public final class379 method343(int arg0, int arg1) {
        return new class502(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpf;Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 108)
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Leca;", line = 118)
    public final class758 method418() {
        return new class758(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)I", line = 127)
    public final int method389(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Lhba;", line = 130)
    public final class10 method410() {
        return this.field9701;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltw;Z)Lufa;", line = 136)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lufa;", line = 146)
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 152)
    public final boolean method392() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhba;)V", line = 155)
    public final void method367(class10 arg0) {
        this.field9697 = arg0;
        this.method3917(((class279) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpf;)V", line = 159)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldi;Ldi;FLdi;)Ldi;", line = 167)
    public final class128 method378(class128 arg0, class128 arg1, float arg2, class128 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Z", line = 170)
    public final boolean method450() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)Lza;", line = 177)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 184)
    public final void method390(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()V", line = 186)
    public final void method439() {
    }

    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmv;[Ltw;Z)Lda;", line = 224)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 261)
    ...
    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 278)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Z", line = 306)
    public final boolean method376() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 310)
    public final void method384(int arg0) {
        this.field9704[arg0].method3486();
    }

    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 313)
    public final boolean method435() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()V", line = 316)
    public final void method388() {
        this.method353(this.field9694.field2841);
    }

    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()I", line = 319)
    public final int method455() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 324)
    public final void method408(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)Lci;", line = 327)
    public final class451 method440(int arg0, int arg1) {
        return this.method338(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 330)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 350)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpf;I)V", line = 357)
    public final void method397(class583 arg0, int arg1) {
        this.method3904(arg0, false);
        this.method3918().method3490(this, field9688, field9691, field9696, field9692, arg0.field8165.method1882(true));
    }

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 363)
    public final boolean method457() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 366)
    ...
    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Lhba;", line = 372)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lufa;", line = 382)
    public final class680 method338(int arg0, int arg1, boolean arg2) {
        return new class542(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 388)
    ...
    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 391)
    public final boolean method456() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 395)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 402)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 408)
    public final void method432(class416 arg0) {
        this.field9683 = (class53) arg0;
        this.method3915(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 413)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)V", line = 426)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 438)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 451)
    public final void method352(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Z", line = 454)
    public final boolean method377() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()V", line = 462)
    public final void method362() {
    }

    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Z", line = 466)
    public final boolean method404() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Ldi;", line = 470)
    public final class128 method424(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 475)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 488)
    public final boolean method346() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "j", descriptor = "(I)V", line = 492)
    public final void method431(int arg0) {
        this.field9704[arg0].method3489();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Lhba;", line = 503)
    public final class10 method357() {
        return this.field9697;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Llv;IIII)Lka;", line = 506)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lci;Lku;)Lqp;", line = 510)
    public final class657 method443(class451 arg0, class379 arg1) {
        return new class612(this, (class542) arg0, (class502) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 513)
    private final Object method3919() {
        return new class390(this);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 519)
    public final void method437(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldi;)V", line = 527)
    public final void method387(class128 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()Z", line = 530)
    public final boolean method419() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqp;)V", line = 534)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 546)
    ...
    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()V", line = 572)
    public final void method448() {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 576)
    ...
    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Z", line = 592)
    public final boolean method423() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 613)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)I", line = 617)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 623)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lufa;", line = 632)
    ...
    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)V", line = 640)
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()V", line = 652)
    public final void method441() {
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 658)
