...
public class class694 extends class626 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 118)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(Z)I", line = 189)
