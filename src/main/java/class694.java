...
public class class694 extends class395 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lha;I)Lua;")
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Lha;B)Liha;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILjava/lang/String;ILdw;)Lie;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lka;Lha;ILih;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILha;IB)Z")
