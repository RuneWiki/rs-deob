...
public class class694 extends class759 {
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Llga;Llga;Llga;Llga;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZLlq;Llq;IIZI)I", line = 36)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)V", line = 69)
