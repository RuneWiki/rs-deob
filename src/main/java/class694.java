...
public class class694 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(JB)Lkd;", line = 7)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)Lkd;", line = 37)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)Lkd;", line = 72)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIZB)V", line = 88)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lkd;JI)V", line = 149)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)I", line = 170)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(JB)V", line = 217)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([Lkd;B)I", line = 305)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(B)Lkd;", line = 351)
    ...
    @OriginalMember(owner = "client!hd", name = "e", descriptor = "(B)V", line = 383)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(I)V", line = 417)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(B)I", line = 449)
