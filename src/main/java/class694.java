...
public abstract class class694 extends class256 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lkf;Lha;IIIZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cj", name = "i", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!cj", name = "e", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(Lha;B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!cj", name = "g", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!cj", name = "d", descriptor = "(I)Z", line = 149)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III)Lnl;", line = 160)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([Ltn;B)I", line = 170)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(IIIIIII)V", line = 182)
