...
public class class694 extends class59 implements class532 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Lwh;", line = 11)
    public final class149 method253(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 14)
    public final void method270(class415 arg0) {
        this.field9376 = (class52) arg0;
        this.method3890(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()V", line = 20)
    public final void method337() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 23)
    ...
    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 33)
    public final boolean method364() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmda;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()V", line = 41)
    public final void method307() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lrh;Z)Lmi;", line = 45)
    ...
    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()V", line = 50)
    public final void method257() {
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 54)
    public final void method227(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 63)
    public final void method244(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Loea;[Lrh;Z)Lda;", line = 67)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Z", line = 105)
    ...
    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Lbca;", line = 124)
    public final class661 method322() {
        return this.field9386;
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 127)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmda;Z)V", line = 152)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 182)
    public final void method249(int arg0) {
        this.field9398[arg0].method3527();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 186)
    ...
    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)Lza;", line = 195)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 210)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 217)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 230)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 234)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmda;)V", line = 244)
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()I", line = 251)
    public final int method318() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()V", line = 255)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 286)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 293)
    ...
    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Z", line = 304)
    public final boolean method328() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lmi;", line = 308)
    public final class496 method311(int arg0, int arg1, boolean arg2) {
        return new class541(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(II)I", line = 330)
    public final int method219(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 339)
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 343)
    public final boolean method247() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 484)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbh;IIII)Lka;", line = 350)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Lfia;", line = 353)
    public final class575 method298() {
        return new class575(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 355)
    public final void method258(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIZ)Lmi;", line = 359)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 378)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwh;Lwh;FLwh;)Lwh;", line = 401)
    public final class149 method340(class149 arg0, class149 arg1, float arg2, class149 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Z", line = 405)
    public final boolean method272() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)V", line = 408)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lhe;", line = 418)
    public final class372 method353(int arg0, int arg1) {
        return this.method311(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lab;)V", line = 424)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 445)
    public final void method325(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lab;", line = 448)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 451)
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 466)
    public final boolean method263() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwh;)V", line = 468)
    public final void method177(class149 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Lbca;", line = 471)
    public final class661 method290() {
        return new class279();
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 474)
    public final void method312(int arg0) {
        this.field9398[arg0].method3533();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()V", line = 478)
    public final void method355() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 480)
    public final void method350(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Z", line = 513)
    public final boolean method238() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhe;Lvm;)Lis;", line = 522)
    public final class503 method319(class372 arg0, class686 arg1) {
        return new class611(this, (class541) arg0, (class502) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lis;)V", line = 526)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 533)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Lbca;", line = 540)
    public final class661 method320() {
        return this.field9380;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(IIIIII)V", line = 543)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lvm;", line = 548)
    public final class686 method273(int arg0, int arg1) {
        return new class502(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Z", line = 551)
    public final boolean method327() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lmi;", line = 558)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 561)
    public final void method330(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 569)
    public final boolean method204() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 572)
    private final Object method3893() {
        return new class388(this);
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 575)
    public final boolean method199() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 577)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbca;)V", line = 580)
    public final void method210(class661 arg0) {
        this.field9380 = arg0;
        this.method3878(((class279) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()V", line = 584)
    public final void method213() {
        this.method341(this.field9392.field3172);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 590)
    ...
    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 599)
    public final boolean method310() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()V", line = 602)
    public final void method252() {
    }

    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Z", line = 608)
    public final boolean method291() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 612)
