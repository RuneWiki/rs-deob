...
public class class694 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)I", line = 9)
    public static int method3895(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)J", line = 17)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "([BBII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ji", name = "finalize", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(JB)V", line = 82)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIIZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)Ljava/io/File;", line = 391)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 402)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(I)V", line = 434)
    public static void method3903(int arg0) {
        field9779 = null;
        int var1 = 67 / ((arg0 - 43) / 40);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II[BI)I", line = 448)
