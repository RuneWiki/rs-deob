...
public class class694 extends class330 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "()V", line = 3)
    public class694() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lgga;IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!ji", name = "e", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IZ)[I", line = 84)
