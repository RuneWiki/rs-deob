...
public class class66 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILwo;Lwo;)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lbg;III)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IZILuo;)Lc;")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lil;IIIII)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILbg;I)V")
