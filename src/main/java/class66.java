...
@OriginalClass("client!VJJXMLOH")
public class class66 extends class18 {

    @OriginalMember(owner = "client!VJJXMLOH", name = "J", descriptor = "Z")
    public boolean field1676 = false;

    @OriginalMember(owner = "client!VJJXMLOH", name = "x", descriptor = "LUYLUCQNM;")
    private class63 field1664;

    @OriginalMember(owner = "client!VJJXMLOH", name = "I", descriptor = "I")
    public int field1675;

    @OriginalMember(owner = "client!VJJXMLOH", name = "m", descriptor = "I")
    public int field1653;

    @OriginalMember(owner = "client!VJJXMLOH", name = "n", descriptor = "I")
    public int field1654;

    @OriginalMember(owner = "client!VJJXMLOH", name = "o", descriptor = "I")
    public int field1655;

    @OriginalMember(owner = "client!VJJXMLOH", name = "s", descriptor = "I")
    public int field1659;

    @OriginalMember(owner = "client!VJJXMLOH", name = "t", descriptor = "I")
    public int field1660;

    @OriginalMember(owner = "client!VJJXMLOH", name = "u", descriptor = "I")
    public int field1661;

    @OriginalMember(owner = "client!VJJXMLOH", name = "v", descriptor = "I")
    public int field1662;

    @OriginalMember(owner = "client!VJJXMLOH", name = "w", descriptor = "I")
    public int field1663;

    @OriginalMember(owner = "client!VJJXMLOH", name = "p", descriptor = "I")
    public int field1656;

    @OriginalMember(owner = "client!VJJXMLOH", name = "y", descriptor = "D")
    private double field1665;

    @OriginalMember(owner = "client!VJJXMLOH", name = "z", descriptor = "D")
    private double field1666;

    @OriginalMember(owner = "client!VJJXMLOH", name = "A", descriptor = "D")
    private double field1667;

    @OriginalMember(owner = "client!VJJXMLOH", name = "B", descriptor = "D")
    private double field1668;

    @OriginalMember(owner = "client!VJJXMLOH", name = "C", descriptor = "D")
    private double field1669;

    @OriginalMember(owner = "client!VJJXMLOH", name = "D", descriptor = "D")
    public double field1670;

    @OriginalMember(owner = "client!VJJXMLOH", name = "E", descriptor = "D")
    public double field1671;

    @OriginalMember(owner = "client!VJJXMLOH", name = "F", descriptor = "D")
    public double field1672;

    @OriginalMember(owner = "client!VJJXMLOH", name = "q", descriptor = "I")
    private int field1657;

    @OriginalMember(owner = "client!VJJXMLOH", name = "r", descriptor = "I")
    private int field1658;

    @OriginalMember(owner = "client!VJJXMLOH", name = "G", descriptor = "I")
    public int field1673;

    @OriginalMember(owner = "client!VJJXMLOH", name = "H", descriptor = "I")
    public int field1674;

    @OriginalMember(owner = "client!VJJXMLOH", name = "a", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!VJJXMLOH", name = "a", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!VJJXMLOH", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!VJJXMLOH", name = "a", descriptor = "(IB)V")
