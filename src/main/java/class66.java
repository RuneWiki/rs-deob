...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ld;IIIIILla;Ljava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[IBII)Lfs;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lla;Lla;Lla;ILjq;Lot;)Z")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lec;I)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILfs;)V")
