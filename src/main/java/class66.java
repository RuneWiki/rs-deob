...
public class class66 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(B)V", line = 8)
    public static void method509(byte arg0) {
        int var1 = 4 % ((arg0 - 20) / 40);
        field726 = null;
    }

    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(B[BI[BII)I", line = 23)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "([B)V", line = 169)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIIBII)V", line = 293)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "([BII[BII)I", line = 428)
