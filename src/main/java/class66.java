...
public class class66 extends class354 implements class381 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IILwm;)Lgn;")
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(BLwm;)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILwm;I)Lgn;")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lwm;Lct;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIILel;)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lwm;I)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IZLwm;I)Lij;")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIBLwm;)Z")
