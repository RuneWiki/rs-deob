...
public class class66 extends class137 implements class591 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Ltk;Z)V")
