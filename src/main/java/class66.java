...
public class class66 extends class28 {
    ...
    @OriginalMember(owner = "client!ZJNSWWFY", name = "k", descriptor = "Z")
    public static boolean field1686;

    @OriginalMember(owner = "client!ZJNSWWFY", name = "i", descriptor = "[LDZBHNAUV;")
    ...
    @OriginalMember(owner = "client!ZJNSWWFY", name = "a", descriptor = "(Z)LCSGBDGDY;")
