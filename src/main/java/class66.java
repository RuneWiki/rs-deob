...
public class class66 extends class584 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILld;B)V")
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lfo;)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lvp;III)V")
