...
public class class66 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lwm;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I[J[I)V", line = 52)
    public static final void method523(int arg0, long[] arg1, int[] arg2) {
        field831++;
        class113.method761(arg2, arg0, arg1.length - 1, (byte) 20, arg1);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILwm;)V", line = 87)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 318)
