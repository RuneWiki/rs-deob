...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIZIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZB)V", line = 54)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILdh;)V", line = 86)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(III)I", line = 170)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)Z", line = 211)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(II)I", line = 249)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIB)V", line = 282)
