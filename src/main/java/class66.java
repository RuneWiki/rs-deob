...
@OriginalClass("client!WEYNEKNM")
public class class66 {

    @OriginalMember(owner = "client!WEYNEKNM", name = "a", descriptor = "LRSOOLPKM;")
    private static class50 field1659 = new class50();

    @OriginalMember(owner = "client!WEYNEKNM", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!WEYNEKNM", name = "a", descriptor = "(LRSOOLPKM;)V")
    ...
    @OriginalMember(owner = "client!WEYNEKNM", name = "b", descriptor = "(LRSOOLPKM;)V")
    ...
    @OriginalMember(owner = "client!WEYNEKNM", name = "c", descriptor = "(LRSOOLPKM;)B")
    private static byte method563(class50 arg0) {
        return (byte) method565(8, arg0);
    }

    @OriginalMember(owner = "client!WEYNEKNM", name = "d", descriptor = "(LRSOOLPKM;)B")
    private static byte method564(class50 arg0) {
        return (byte) method565(1, arg0);
    }

    @OriginalMember(owner = "client!WEYNEKNM", name = "a", descriptor = "(ILRSOOLPKM;)I")
    ...
    @OriginalMember(owner = "client!WEYNEKNM", name = "e", descriptor = "(LRSOOLPKM;)V")
    ...
    @OriginalMember(owner = "client!WEYNEKNM", name = "a", descriptor = "([I[I[I[BIII)V")
