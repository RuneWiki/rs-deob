...
public class class66 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lsv;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILsv;)V", line = 26)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)V", line = 104)
