...
public class class66 extends class435 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(I)V", line = 83)
    public class66(int arg0) {
        this.field954 = arg0;
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIIIIII)V", line = 64)
