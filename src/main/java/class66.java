...
public class class66 extends class241 implements class248 {
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lqa;II)Lc;", line = 17)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lqa;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILqa;II)Z", line = 53)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lat;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZLqa;)Lae;", line = 125)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)V", line = 163)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLqa;)V", line = 195)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(I)V", line = 220)
    public final void method26(int arg0) {
        ++field1130;
        int var2 = -25 / ((-46 - arg0) / 44);
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILqa;)V", line = 231)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(Z)Z", line = 242)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILqa;ZLto;III)V", line = 254)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lqa;Lgm;IIIIIZIII)V", line = 265)
    ...
    @OriginalMember(owner = "client!hk", name = "e", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)I", line = 292)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)Z", line = 305)
