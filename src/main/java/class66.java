...
public class class66 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BLqj;Lqj;Lqj;)V", line = 30)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II[I[II)V", line = 62)
