...
public class class66 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lct;)V", line = 13)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;Lat;IIII[I[I)V", line = 35)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I)V", line = 169)
    public static final void method479(int arg0) {
        field848 = (class239) field847.method609((long) arg0, 92);
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)Ljr;", line = 174)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "()V", line = 188)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;IIIIIII[S[BZ)V", line = 344)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;)Leb;", line = 507)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lic;II)V", line = 519)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;IIII)Leb;", line = 531)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;Leg;IIII)V", line = 541)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(II)Lig;", line = 548)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "()V", line = 563)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;II)V", line = 584)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(Lfp;IIII)V", line = 763)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "()V", line = 1107)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(I)Ljr;", line = 1128)
    public static final class239 method492(int arg0) {
        return (class239) field847.method609((long) arg0, 103);
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lfp;IIII[S[B)V", line = 1131)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "([B[B[SII)V", line = 1190)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "()V", line = 1333)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lic;III)I", line = 1345)
    ...
    @OriginalMember(owner = "client!r", name = "e", descriptor = "()V", line = 1401)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(Lfp;)V", line = 1415)
