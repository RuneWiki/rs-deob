...
public class class66 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lgs;IB)V", line = 108)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II[BZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lnm;Lmk;Llg;IIIII)V", line = 164)
