...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;[II[II[I[Ljd;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/util/Random;[Ljd;[IZILjava/lang/String;III)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;I[Ljd;I[ILjava/util/Random;IIIII[II)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Ljd;[IILjava/lang/String;ILaa;IBI)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIILaa;I[Ljd;Ljava/lang/String;II[IIII)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILda;ZLha;Ljava/lang/String;Lie;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[I[Ljd;IIILjava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Ljd;IIIIIILjava/lang/String;I[IIIILaa;I)I")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lie;)V")
