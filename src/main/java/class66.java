...
public class class66 extends class478 {
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "()V", line = 4)
    public class66() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pv", name = "c", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(II)[I", line = 97)
