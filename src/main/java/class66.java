...
@OriginalClass("client!WXMXSJQQ")
public class class66 {

    @OriginalMember(owner = "client!WXMXSJQQ", name = "b", descriptor = "I")
    private static int field1626 = 564;

    @OriginalMember(owner = "client!WXMXSJQQ", name = "a", descriptor = "Z")
    private static boolean field1625;

    @OriginalMember(owner = "client!WXMXSJQQ", name = "a", descriptor = "(IIIB)I")
    ...
    @OriginalMember(owner = "client!WXMXSJQQ", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!WXMXSJQQ", name = "a", descriptor = "(BIIIII)I")
    ...
    @OriginalMember(owner = "client!WXMXSJQQ", name = "a", descriptor = "(IIIIII)I")
