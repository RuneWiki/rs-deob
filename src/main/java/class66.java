...
public class class66 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIZI)I", line = 68)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)[Ldn;", line = 102)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 113)
    public class66(String arg0, int arg1) {
        this.field907 = arg1;
        this.field904 = arg0;
    }

    @OriginalMember(owner = "client!al", name = "toString", descriptor = "()Ljava/lang/String;", line = 123)
