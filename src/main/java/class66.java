...
public class class66 extends class558 implements class90 {
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lqba;Z)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
