...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;[Lvr;ILjava/util/Random;III[I)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;II[Lvr;IIIIIIIIILaa;[II)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIILjava/lang/String;I[Lvr;ILaa;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III[I[Lvr;ILjava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BII[Lvr;III[ILjava/util/Random;Ljava/lang/String;III[II)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIILjava/lang/String;Laa;I[Lvr;III[II)I")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Leia;)V")
    public class66(class65 arg0, class255 arg1) {
        this.field944 = arg0;
        this.field950 = arg1;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I[II[I[Lvr;[II)V")
