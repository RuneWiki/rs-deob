...
public class class66 extends class278 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "()V", line = 39)
    public class66() {
        super(0, false);
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Llh;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)[[I", line = 59)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZZIIILvh;)V", line = 140)
    ...
    @OriginalMember(owner = "client!hk", name = "e", descriptor = "(I)I", line = 162)
    ...
    @OriginalMember(owner = "client!hk", name = "g", descriptor = "(I)Z", line = 172)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLss;)Lss;", line = 196)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLjava/lang/String;)V", line = 214)
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "(B)V", line = 226)
