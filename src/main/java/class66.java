...
public class class66 extends class228 implements class111 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BLpe;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZILhh;Lpe;III)V", line = 14)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lpe;B)Lca;", line = 77)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lpe;Lkk;IIIIIIIZIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lpe;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)I", line = 150)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(I)Z", line = 161)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lpe;II)Lsj;", line = 177)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(I)Z", line = 191)
    public final boolean method577(int arg0) {
        ++field999;
        return arg0 != -16528 ? false : this.field985.method2787(104);
    }

    @OriginalMember(owner = "client!pn", name = "f", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!pn", name = "g", descriptor = "(I)I", line = 222)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)I", line = 240)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILpe;)V", line = 251)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)I", line = 263)
    public final int method582(byte arg0) {
        ++field1001;
        return arg0 != 22 ? 7 : this.field985.field6458;
    }

    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILpe;I)Z", line = 289)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)V", line = 311)
