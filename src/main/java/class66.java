...
@OriginalClass("client!YSGENUJE")
public class class66 {

    @OriginalMember(owner = "client!YSGENUJE", name = "a", descriptor = "I")
    private int field1627 = 611;

    @OriginalMember(owner = "client!YSGENUJE", name = "b", descriptor = "Z")
    private boolean field1628 = false;

    @OriginalMember(owner = "client!YSGENUJE", name = "c", descriptor = "I")
    private int field1629 = 8;

    @OriginalMember(owner = "client!YSGENUJE", name = "d", descriptor = "I")
    private int field1630 = 6;

    @OriginalMember(owner = "client!YSGENUJE", name = "e", descriptor = "LZZBPVHZB;")
    public class72 field1631 = new class72();

    @OriginalMember(owner = "client!YSGENUJE", name = "f", descriptor = "LZZBPVHZB;")
    private class72 field1632;

    @OriginalMember(owner = "client!YSGENUJE", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "a", descriptor = "(LZZBPVHZB;)V")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "a", descriptor = "(LZZBPVHZB;B)V")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "a", descriptor = "()LZZBPVHZB;")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "b", descriptor = "()LZZBPVHZB;")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "a", descriptor = "(I)LZZBPVHZB;")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "b", descriptor = "(I)LZZBPVHZB;")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "c", descriptor = "(I)LZZBPVHZB;")
    ...
    @OriginalMember(owner = "client!YSGENUJE", name = "c", descriptor = "()V")
