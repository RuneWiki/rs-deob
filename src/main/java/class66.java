...
@OriginalClass("client!XWXMLCDO")
public class class66 {

    @OriginalMember(owner = "client!XWXMLCDO", name = "a", descriptor = "I")
    private int field1491 = -261;

    @OriginalMember(owner = "client!XWXMLCDO", name = "b", descriptor = "Z")
    private boolean field1492 = false;

    @OriginalMember(owner = "client!XWXMLCDO", name = "g", descriptor = "I")
    public int field1497 = 65000;

    @OriginalMember(owner = "client!XWXMLCDO", name = "f", descriptor = "I")
    public int field1496;

    @OriginalMember(owner = "client!XWXMLCDO", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1494;

    @OriginalMember(owner = "client!XWXMLCDO", name = "e", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1495;

    @OriginalMember(owner = "client!XWXMLCDO", name = "c", descriptor = "[B")
    public static byte[] field1493 = new byte[520];

    @OriginalMember(owner = "client!XWXMLCDO", name = "<init>", descriptor = "(Ljava/io/RandomAccessFile;IBILjava/io/RandomAccessFile;)V")
    ...
    @OriginalMember(owner = "client!XWXMLCDO", name = "a", descriptor = "(II)[B")
    ...
    @OriginalMember(owner = "client!XWXMLCDO", name = "a", descriptor = "(II[BI)Z")
    ...
    @OriginalMember(owner = "client!XWXMLCDO", name = "a", descriptor = "(I[BZII)Z")
    ...
    @OriginalMember(owner = "client!XWXMLCDO", name = "a", descriptor = "(Ljava/io/RandomAccessFile;IZ)V")
