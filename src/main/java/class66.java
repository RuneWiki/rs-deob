...
public class class66 extends class33 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIIBI)V", line = 83)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(B)V", line = 303)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 336)
    protected class66() {
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lbk;)V", line = 346)
