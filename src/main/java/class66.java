...
public class class66 extends class224 {
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IB)Llda;", line = 46)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IZBLha;)Lda;", line = 72)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 95)
