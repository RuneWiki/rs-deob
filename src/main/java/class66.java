...
public class class66 {
    ...
    @OriginalMember(owner = "client!WIUIWDML", name = "e", descriptor = "LOBKNBIRU;")
    private class40 field1556 = new class40();

    @OriginalMember(owner = "client!WIUIWDML", name = "i", descriptor = "LHIGYXWXY;")
    ...
    @OriginalMember(owner = "client!WIUIWDML", name = "h", descriptor = "LLIHJZCBF;")
    ...
    @OriginalMember(owner = "client!WIUIWDML", name = "a", descriptor = "(J)LOBKNBIRU;")
    ...
    @OriginalMember(owner = "client!WIUIWDML", name = "a", descriptor = "(IJLOBKNBIRU;)V")
