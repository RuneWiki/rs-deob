...
public class class66 extends class44 {
    ...
    @OriginalMember(owner = "client!XWNQXFLX", name = "y", descriptor = "LWLHKAARP;")
    ...
    @OriginalMember(owner = "client!XWNQXFLX", name = "x", descriptor = "Lclient;")
    public static client field1654;

    @OriginalMember(owner = "client!XWNQXFLX", name = "b", descriptor = "(I)LRFUKTMBK;")
    ...
    @OriginalMember(owner = "client!XWNQXFLX", name = "a", descriptor = "(I)LVHYCWIPJ;")
