...
public class class66 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(III)B", line = 8)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILkk;ZI)V", line = 27)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 192)
