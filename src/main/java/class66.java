...
public class class66 {
    ...
    @OriginalMember(owner = "client!XMKPAVXA", name = "d", descriptor = "LBJPWOXRJ;")
    ...
    @OriginalMember(owner = "client!XMKPAVXA", name = "a", descriptor = "(LBJPWOXRJ;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!XMKPAVXA", name = "a", descriptor = "(BLBJPWOXRJ;Ljava/lang/String;)V")
