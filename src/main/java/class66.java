...
public class class66 extends class243 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(IIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IILjava/lang/String;BZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIB)V", line = 84)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(III)V", line = 94)
