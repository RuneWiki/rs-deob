...
public class class66 extends class459 {
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I)J", line = 5)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IZLeg;IIBLgda;)V", line = 21)
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "([[SD)V", line = 31)
