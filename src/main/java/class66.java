...
public class class66 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)Z", line = 108)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZLcr;B)V", line = 122)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(B)Z", line = 565)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(B)V", line = 845)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(B)I", line = 857)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(I)I", line = 868)
    ...
    @OriginalMember(owner = "client!pn", name = "f", descriptor = "(I)V", line = 1000)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BZIII)Ln;", line = 1027)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZI)V", line = 1069)
