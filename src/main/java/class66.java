...
@OriginalClass("client!XHDBBLMT")
public class class66 extends class8 {

    @OriginalMember(owner = "client!XHDBBLMT", name = "i", descriptor = "I")
    public int field1489 = 1000;

    @OriginalMember(owner = "client!XHDBBLMT", name = "j", descriptor = "Z")
    public static boolean field1490;

    @OriginalMember(owner = "client!XHDBBLMT", name = "h", descriptor = "[LTOHSQGHN;")
    public class56[] field1488;

    @OriginalMember(owner = "client!XHDBBLMT", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!XHDBBLMT", name = "a", descriptor = "(I)LKBEXSZSN;")
