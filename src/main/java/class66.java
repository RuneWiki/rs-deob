...
public class class66 extends class382 {
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Ldh;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 674)
