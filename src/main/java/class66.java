...
public class class66 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "([BLmo;B)V", line = 81)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 111)
    public static void method671(byte arg0) {
        field1223 = null;
        int var1 = 55 / ((arg0 - 64) / 51);
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(III)Z", line = 120)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I[B)[B", line = 133)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "()V", line = 157)
    public class66() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(III)V", line = 167)
