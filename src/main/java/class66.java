...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIILjava/awt/Canvas;ILcb;ZLd;)Lha;", line = 17)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIBI)V", line = 89)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIBIII)V", line = 182)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 197)
    protected void finalize() {
        field882++;
        this.method450(1);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIZI[I)Lqda;", line = 211)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IZIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 271)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLqda;)V", line = 300)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 321)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIZ)V", line = 349)
