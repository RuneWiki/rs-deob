...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(IIIII)V", line = 315)
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILjava/awt/Canvas;)Lpl;", line = 281)
