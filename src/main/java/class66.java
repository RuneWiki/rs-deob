...
@OriginalClass("client!XPILULJC")
public class class66 {

    @OriginalMember(owner = "client!XPILULJC", name = "a", descriptor = "I")
    private int field1588 = 4;

    @OriginalMember(owner = "client!XPILULJC", name = "j", descriptor = "[I")
    private int[] field1597 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "k", descriptor = "[I")
    private int[] field1598 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "l", descriptor = "[I")
    private int[] field1599 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "n", descriptor = "I")
    private int field1601 = 100;

    @OriginalMember(owner = "client!XPILULJC", name = "q", descriptor = "I")
    public int field1604 = 500;

    @OriginalMember(owner = "client!XPILULJC", name = "v", descriptor = "[I")
    private static int[] field1609 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "w", descriptor = "[I")
    private static int[] field1610 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "x", descriptor = "[I")
    private static int[] field1611 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "y", descriptor = "[I")
    private static int[] field1612 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "z", descriptor = "[I")
    private static int[] field1613 = new int[5];

    @OriginalMember(owner = "client!XPILULJC", name = "m", descriptor = "I")
    private int field1600;

    @OriginalMember(owner = "client!XPILULJC", name = "r", descriptor = "I")
    public int field1605;

    @OriginalMember(owner = "client!XPILULJC", name = "o", descriptor = "LDQYHQSPL;")
    private class15 field1602;

    @OriginalMember(owner = "client!XPILULJC", name = "b", descriptor = "LRSNWTZPO;")
    private class54 field1589;

    @OriginalMember(owner = "client!XPILULJC", name = "c", descriptor = "LRSNWTZPO;")
    private class54 field1590;

    @OriginalMember(owner = "client!XPILULJC", name = "d", descriptor = "LRSNWTZPO;")
    private class54 field1591;

    @OriginalMember(owner = "client!XPILULJC", name = "e", descriptor = "LRSNWTZPO;")
    private class54 field1592;

    @OriginalMember(owner = "client!XPILULJC", name = "f", descriptor = "LRSNWTZPO;")
    private class54 field1593;

    @OriginalMember(owner = "client!XPILULJC", name = "g", descriptor = "LRSNWTZPO;")
    private class54 field1594;

    @OriginalMember(owner = "client!XPILULJC", name = "h", descriptor = "LRSNWTZPO;")
    private class54 field1595;

    @OriginalMember(owner = "client!XPILULJC", name = "i", descriptor = "LRSNWTZPO;")
    private class54 field1596;

    @OriginalMember(owner = "client!XPILULJC", name = "p", descriptor = "LRSNWTZPO;")
    private class54 field1603;

    @OriginalMember(owner = "client!XPILULJC", name = "s", descriptor = "[I")
    private static int[] field1606;

    @OriginalMember(owner = "client!XPILULJC", name = "t", descriptor = "[I")
    private static int[] field1607;

    @OriginalMember(owner = "client!XPILULJC", name = "u", descriptor = "[I")
    private static int[] field1608;

    @OriginalMember(owner = "client!XPILULJC", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!XPILULJC", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!XPILULJC", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!XPILULJC", name = "a", descriptor = "(ILINLHDAGO;)V")
