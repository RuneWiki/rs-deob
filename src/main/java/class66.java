...
public class class66 implements Runnable {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IB)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/Component;III)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/net/URL;I)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lwk;")
    public final class329 method448(int arg0, Runnable arg1, byte arg2) {
        return arg2 < 71 ? null : this.method455((byte) -21, 2, 0, arg0, arg1);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/Class;)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Z)Lik;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;I)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/Frame;B)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BIIILjava/lang/Object;)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(Ljava/lang/String;I)Lwk;")
    public final class329 method456(String arg0, int arg1) {
        return arg1 == 0 ? this.method455((byte) -86, 16, 0, 0, arg0) : null;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lwk;")
    public final class329 method457(Transferable arg0, int arg1) {
        return arg1 == -10606 ? this.method455((byte) -79, 19, 0, 0, arg0) : null;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIII)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILjava/lang/String;)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZLjava/awt/Component;I)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I[IILjava/awt/Component;ILjava/awt/Point;)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;ILjava/lang/Class;)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIILjava/lang/Object;Z)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(ILjava/lang/Class;)Lwk;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;ZB)Lwk;")
