...
public class class66 {
    ...
    @OriginalMember(owner = "client!XKEHWKFH", name = "t", descriptor = "I")
    ...
    @OriginalMember(owner = "client!XKEHWKFH", name = "d", descriptor = "[LXKEHWKFH;")
    public static class66[] field1608;

    @OriginalMember(owner = "client!XKEHWKFH", name = "a", descriptor = "(ILSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!XKEHWKFH", name = "a", descriptor = "(LLDILQFVA;I)V")
