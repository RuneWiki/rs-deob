...
public class class66 {
    ...
    @OriginalMember(owner = "client!VSBOWDVL", name = "p", descriptor = "LJLTMYUOM;")
    ...
    @OriginalMember(owner = "client!VSBOWDVL", name = "h", descriptor = "LGMRGYXFL;")
    public class21 field1609;

    @OriginalMember(owner = "client!VSBOWDVL", name = "b", descriptor = "Z")
    private static boolean field1603;

    @OriginalMember(owner = "client!VSBOWDVL", name = "d", descriptor = "[LVSBOWDVL;")
    public static class66[] field1605;

    @OriginalMember(owner = "client!VSBOWDVL", name = "a", descriptor = "(ILQKFGLETG;)V")
    ...
    @OriginalMember(owner = "client!VSBOWDVL", name = "a", descriptor = "(BLXJCNBMKS;)V")
    ...
    @OriginalMember(owner = "client!VSBOWDVL", name = "a", descriptor = "()LFUTAQMCE;")
