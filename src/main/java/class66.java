...
public class class66 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "([BBIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ldga;Ljava/lang/String;Z)I", line = 52)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ZILefa;ZLefa;)I", line = 84)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljava/lang/String;ZZ)V", line = 182)
