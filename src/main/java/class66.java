...
public class class66 extends class154 {
    ...
    @OriginalMember(owner = "client!fu", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IBILtc;)V", line = 26)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIZBLtc;)V", line = 52)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILfd;)Lrr;", line = 131)
    ...
    @OriginalMember(owner = "client!fu", name = "e", descriptor = "(I)V", line = 153)
