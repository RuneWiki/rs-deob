...
public class class66 extends class352 implements class541 {
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lnq;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lnq;I[BIZ)V")
