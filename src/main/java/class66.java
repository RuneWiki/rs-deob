...
public class class66 extends class46 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLee;)Lvea;", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZII)V", line = 20)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lha;IBLjt;)V", line = 34)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)V", line = 370)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(IIIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(III)V", line = 397)
    public final void method300(int arg0, int arg1, int arg2) {
        int var4 = 59 % ((-7 - arg1) / 42);
        ++field803;
    }

    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(III)V", line = 409)
