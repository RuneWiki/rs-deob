...
public class class66 extends class57 {
    ...
    @OriginalMember(owner = "client!YRZVGTOF", name = "t", descriptor = "LKIZBPSHZ;")
    ...
    @OriginalMember(owner = "client!YRZVGTOF", name = "C", descriptor = "Lclient;")
    public static client field1664;

    @OriginalMember(owner = "client!YRZVGTOF", name = "a", descriptor = "(Z)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!YRZVGTOF", name = "b", descriptor = "(Z)LCSTFGNEK;")
