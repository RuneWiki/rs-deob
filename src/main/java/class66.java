...
public class class66 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)Ldda;", line = 21)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IILmd;)V", line = 68)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lvk;[[BI)V", line = 133)
