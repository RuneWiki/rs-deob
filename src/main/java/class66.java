...
@OriginalClass("client!YPWLUGYN")
public class class66 extends class36 {

    @OriginalMember(owner = "client!YPWLUGYN", name = "z", descriptor = "I")
    private int field1592 = -334;

    @OriginalMember(owner = "client!YPWLUGYN", name = "A", descriptor = "I")
    private int field1593 = -515;

    @OriginalMember(owner = "client!YPWLUGYN", name = "B", descriptor = "Z")
    private boolean field1594 = true;

    @OriginalMember(owner = "client!YPWLUGYN", name = "C", descriptor = "Z")
    private boolean field1595 = true;

    @OriginalMember(owner = "client!YPWLUGYN", name = "D", descriptor = "I")
    private int field1596 = 628;

    @OriginalMember(owner = "client!YPWLUGYN", name = "K", descriptor = "I")
    public int field1603;

    @OriginalMember(owner = "client!YPWLUGYN", name = "L", descriptor = "I")
    public int field1604;

    @OriginalMember(owner = "client!YPWLUGYN", name = "F", descriptor = "[I")
    public int[] field1598;

    @OriginalMember(owner = "client!YPWLUGYN", name = "I", descriptor = "I")
    public int field1601;

    @OriginalMember(owner = "client!YPWLUGYN", name = "J", descriptor = "I")
    public int field1602;

    @OriginalMember(owner = "client!YPWLUGYN", name = "G", descriptor = "I")
    public int field1599;

    @OriginalMember(owner = "client!YPWLUGYN", name = "H", descriptor = "I")
    public int field1600;

    @OriginalMember(owner = "client!YPWLUGYN", name = "E", descriptor = "[B")
    public byte[] field1597;

    @OriginalMember(owner = "client!YPWLUGYN", name = "<init>", descriptor = "(LXMRRKSSB;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!YPWLUGYN", name = "a", descriptor = "(I[I[BBII[IIII)V")
