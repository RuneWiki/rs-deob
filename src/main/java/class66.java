...
public class class66 extends class601 {
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "()V", line = 554)
    public class66() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Lee;BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!hia", name = "d", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(BI)[I", line = 313)
    ...
    @OriginalMember(owner = "client!hia", name = "e", descriptor = "(I)V", line = 527)
