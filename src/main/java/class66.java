...
@OriginalClass("client!YAQQZUCW")
public class class66 {

    @OriginalMember(owner = "client!YAQQZUCW", name = "a", descriptor = "I")
    private int field1621 = -356;

    @OriginalMember(owner = "client!YAQQZUCW", name = "g", descriptor = "I")
    public int field1627 = 65000;

    @OriginalMember(owner = "client!YAQQZUCW", name = "f", descriptor = "I")
    public int field1626;

    @OriginalMember(owner = "client!YAQQZUCW", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1624;

    @OriginalMember(owner = "client!YAQQZUCW", name = "e", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1625;

    @OriginalMember(owner = "client!YAQQZUCW", name = "c", descriptor = "[B")
    public static byte[] field1623 = new byte[520];

    @OriginalMember(owner = "client!YAQQZUCW", name = "b", descriptor = "I")
    private int field1622;

    @OriginalMember(owner = "client!YAQQZUCW", name = "<init>", descriptor = "(Ljava/io/RandomAccessFile;IILjava/io/RandomAccessFile;Z)V")
    ...
    @OriginalMember(owner = "client!YAQQZUCW", name = "a", descriptor = "(BI)[B")
    ...
    @OriginalMember(owner = "client!YAQQZUCW", name = "a", descriptor = "(I[BII)Z")
    ...
    @OriginalMember(owner = "client!YAQQZUCW", name = "a", descriptor = "(I[BIIZ)Z")
    ...
    @OriginalMember(owner = "client!YAQQZUCW", name = "a", descriptor = "(IILjava/io/RandomAccessFile;)V")
