...
public class class66 extends class493 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IIZ[B)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IIILkb;Lff;Lvc;ILr;)V", line = 100)
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(I)V", line = 146)
    public class66(int arg0) {
        this.field1029 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!gea", name = "c", descriptor = "(B)V", line = 164)
