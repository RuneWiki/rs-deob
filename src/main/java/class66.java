...
public class class66 extends class623 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLgh;Ljava/awt/Frame;)V", line = 129)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IZ)Z", line = 155)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(B)V", line = 169)
    public static void method493(byte arg0) {
        field669 = null;
        int var1 = -24 / ((arg0 + 3) / 33);
    }

    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(II)Z", line = 179)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(I)V", line = 199)
