...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[IIIZ)Lnf;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILd;Lgj;IILjava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILnf;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILd;ILjava/awt/Canvas;I)Lha;")
