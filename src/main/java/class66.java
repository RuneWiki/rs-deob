...
public class class66 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IIILlw;)V", line = 52)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lrba;IIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(III)Z", line = 90)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BI)Lmd;", line = 101)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lpca;ILbi;Lbi;)V", line = 135)
