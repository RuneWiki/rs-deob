...
public class class66 extends class36 {
    ...
    @OriginalMember(owner = "client!XEUTUWWF", name = "k", descriptor = "Z")
    public static boolean field1629;

    @OriginalMember(owner = "client!XEUTUWWF", name = "i", descriptor = "[LNLCFOCQC;")
    ...
    @OriginalMember(owner = "client!XEUTUWWF", name = "a", descriptor = "(B)LSNMMQNPZ;")
