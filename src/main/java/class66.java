...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILd;Lbt;IIILjava/awt/Canvas;B)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([IIIIII)Ltf;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ltf;B)V")
