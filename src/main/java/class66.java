...
public abstract class class66 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([IIIIII)Lhh;", line = 30)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILhh;)V", line = 47)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 136)
    protected void finalize() {
        this.method464((byte) -90);
        field912++;
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(JB)V", line = 196)
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "(Z)V", line = 279)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILjava/awt/Canvas;IIILuq;ILd;)Lha;", line = 298)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 334)
    public final void method523(int arg0, int arg1, int arg2, int arg3, int arg4) {
        field893++;
        this.method465(arg4, arg3, arg2, arg0, arg1);
    }

    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(IIIIII)V", line = 350)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIB)V", line = 376)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[Ljava/awt/Rectangle;I)V", line = 390)
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(IIIIII)V", line = 407)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 417)
