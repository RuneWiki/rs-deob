...
public class LocEntity extends Entity {
    ...
    @OriginalMember(owner = "client!bb", name = "v", descriptor = "Lnc;")
    ...
    @OriginalMember(owner = "client!bb", name = "n", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)Leb;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)Lec;")
