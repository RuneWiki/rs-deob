...
public class LocEntity extends Entity {
    ...
    @OriginalMember(owner = "client!bb", name = "w", descriptor = "Lnc;")
    ...
    @OriginalMember(owner = "client!bb", name = "o", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)Lec;")
