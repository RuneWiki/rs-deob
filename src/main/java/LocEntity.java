...
public class LocEntity extends Entity {
    ...
    @OriginalMember(owner = "client!bb", name = "u", descriptor = "Lnc;")
    ...
    @OriginalMember(owner = "client!bb", name = "m", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)Lec;")
