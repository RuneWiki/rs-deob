...
public class LocEntity extends Entity {
    ...
    @OriginalMember(owner = "client!bb", name = "x", descriptor = "Lnc;")
    ...
    @OriginalMember(owner = "client!bb", name = "p", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)Lec;")
