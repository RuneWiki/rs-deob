...
public class class180 implements Runnable {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lefa;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljava/lang/String;I)Lfga;", line = 44)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BLcs;)Ljava/lang/String;", line = 66)
    ...
    @OriginalMember(owner = "client!wp", name = "run", descriptor = "()V", line = 98)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 140)
    public class180() {
