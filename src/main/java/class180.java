...
public class class180 implements class182 {

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "I")
    private int field2823 = -1;

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "[I")
    private int[] field2824 = null;

    @OriginalMember(owner = "client!pn", name = "c", descriptor = "Z")
    private boolean field2825 = false;

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "()V", line = 6)
    public final void method232() {
        GL var1 = class240.field3771;
        if (class59.field927) {
            var1.glCallList(this.field2823 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!pn", name = "d", descriptor = "()V", line = 22)
    private final void method1399() {
        GL var1 = class240.field3771;
        if (this.field2824 == null) {
            this.field2824 = new int[3];
            var1.glGenTextures(3, this.field2824, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field2824[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field2824[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field2824[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class28.field459 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!pn", name = "e", descriptor = "()V", line = 138)
    private final void method1400() {
        GL var1 = class240.field3771;
        this.field2823 = var1.glGenLists(2);
        var1.glNewList(this.field2823, 4864);
        if (this.field2824 == null) {
            ...
            if (this.field2825) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class240.field3744);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field2823 + 1, 4864);
        if (this.field2824 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "()V", line = 230)
    public final void method231() {
        GL var1 = class240.field3771;
        class240.method1806(1);
        if (class59.field927) {
            var1.glCallList(this.field2823);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 269)
    public class180() {
        if (class240.field3724 && class240.field3741 >= 2) {
            this.method1399();
            GL var1 = class240.field3771;
            var1.glBindTexture(34067, this.field2824[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field2825 = class240.field3741 < 3;
        }
        this.method1400();
    }

    @OriginalMember(owner = "client!pn", name = "c", descriptor = "()I", line = 249)
    public final int method230() {
        return 4;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 257)
    public final void method229(int arg0) {
        GL var2 = class240.field3771;
        if (class59.field927 && this.field2824 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field2824[arg0 - 1]);
