...
public class class180 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lst;III)V", line = 52)
