...
public class class180 extends class390 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lgr;Ljd;)V", line = 11)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(II)V", line = 1140)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(I[B)V", line = 1161)
