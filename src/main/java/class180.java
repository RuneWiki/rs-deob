...
public abstract class class180 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(ILgga;)Lhu;", line = 7)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(I)Z", line = 121)
