...
public abstract class class180 extends class692 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIZLcca;Lcca;)I")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B[Lcp;)I")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Loo;BI)Z")
