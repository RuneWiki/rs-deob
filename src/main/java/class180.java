...
public class class180 extends class205 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Loj;I)Z")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Loj;Z)Z")
