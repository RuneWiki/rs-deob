...
public class class180 extends class431 implements class338 {
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lqa;Lus;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IILqa;I)Z")
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(ILqa;)Lfm;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IILqa;Leq;IIZ)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BLqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILqa;)V")
