...
public class class180 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IB)Le;", line = 42)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lj;III)V", line = 79)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILj;IB)Z", line = 149)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZI[[ZIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 418)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIILj;)V", line = 440)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIII)V", line = 512)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lod;Lon;)V", line = 552)
