...
public class class180 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BLjava/lang/String;)Ljava/io/File;", line = 33)
    public static File method1201(byte arg0, String arg1) {
        return arg0 == -87 ? method1202(1755, field2226, arg1, field2227) : null;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)Ljava/io/File;", line = 43)
