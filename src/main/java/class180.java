...
public class class180 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILla;ZIILza;B)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IZ)Lfq;")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lad;ILdk;)V")
