...
public class class180 {
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(III)I", line = 39)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILjava/lang/String;)V", line = 71)
    public static final void method1053(int arg0, String arg1) {
        field2348++;
        class119.method714(arg1, "", 0, (byte) 102, "", arg0);
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)Lfg;", line = 85)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 124)
