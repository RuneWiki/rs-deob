...
public class class180 extends class147 {
    ...
    @OriginalMember(owner = "client!te", name = "N", descriptor = "Llf;")
    private static class109 field3400 = class35.method275("Please enter your username)3", 2);

    @OriginalMember(owner = "client!te", name = "P", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!te", name = "G", descriptor = "Loh;")
    public class138 field3393;

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lua;B)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILuc;)V")
