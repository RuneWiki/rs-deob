...
public class class180 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ldg;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljs;B)Z", line = 40)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "()V", line = 155)
    public class180() {
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Ldg;)V", line = 171)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lon;BII)V", line = 88)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 101)
