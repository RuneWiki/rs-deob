...
public class class180 extends class194 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZIIZIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "()V", line = 307)
    public class180() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sn", name = "h", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIB)V", line = 327)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lwo;B)V", line = 338)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)[I", line = 351)
