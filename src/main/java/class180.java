...
public class class180 extends class383 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IB)V", line = 12)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 43)
    public static void method1148(int arg0) {
        int var1 = 55 / ((arg0 - 66) / 47);
        field2375 = null;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II[I)V", line = 57)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(IB)V", line = 179)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IBFII)V", line = 206)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZ)V", line = 314)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lul;IIIII)V", line = 331)
