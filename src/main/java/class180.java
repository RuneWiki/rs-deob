...
public abstract class class180 extends class115 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!id", name = "e", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!id", name = "f", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Z)Z", line = 59)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(B)I", line = 71)
    public final int method1231(byte arg0) {
        field2658++;
        return arg0 == -27 ? 1 : -125;
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lvd;)V", line = 95)
