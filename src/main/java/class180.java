...
public class class180 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(III)Luo;", line = 20)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(FFF[BFIILkda;FBIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 50)
