...
public class class180 extends class359 {
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IBI)I", line = 18)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "()V", line = 50)
    public class180() {
    }

    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 52)
