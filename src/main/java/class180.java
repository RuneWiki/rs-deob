...
public class class180 extends class681 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILrga;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Z)Z", line = 18)
    public final boolean method751(boolean arg0) {
        ++field2605;
        return arg0;
    }

    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lnv;)V", line = 29)
    public class180(class382 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(ZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIB)V", line = 46)
    public final void method742(int arg0, int arg1, byte arg2) {
        int var4 = -116 / ((arg2 - -38) / 35);
        ++field2606;
    }

    @OriginalMember(owner = "client!tj", name = "d", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(II)I", line = 91)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(II)V", line = 115)
