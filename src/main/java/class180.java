...
public class class180 extends class86 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Z)Lqi;", line = 7)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lil;Lli;)V", line = 284)
