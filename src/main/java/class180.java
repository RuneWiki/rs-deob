...
public class class180 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILcu;)V", line = 28)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lcu;II)V", line = 65)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 162)
