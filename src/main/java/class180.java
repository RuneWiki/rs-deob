...
public class class180 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/lang/String;ZILjava/lang/String;)I", line = 17)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZLvg;Ldp;Ldp;)V", line = 138)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)I", line = 159)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/awt/Color;Ljava/awt/Color;Ljava/lang/String;BILjava/awt/Color;Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lnc;II[[BZ[[B[[B[[IILnc;Z[[BLja;)V", line = 262)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIII)I", line = 281)
