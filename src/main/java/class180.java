...
public class class180 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ZI)I", line = 22)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!cfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 72)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(IZ)V", line = 185)
    public class180(int arg0, boolean arg1) {
        this.field2367 = arg1;
        this.field2371 = arg0;
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIIIIIZIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILuq;IZ)Lgl;", line = 125)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BLjava/lang/String;)V", line = 194)
