...
public class class180 extends class461 {
    ...
    @OriginalMember(owner = "client!ei", name = "u", descriptor = "(I)Lcs;")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lsh;I)V")
    ...
    @OriginalMember(owner = "client!ei", name = "q", descriptor = "(B)V")
