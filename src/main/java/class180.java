...
public class class180 extends class114 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BIIILqa;II)Lka;", line = 20)
    ...
    @OriginalMember(owner = "client!jl", name = "f", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Luu;ZBILl;I)[F", line = 84)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)Z", line = 199)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Luu;ILl;)Z", line = 210)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Ll;ZLuu;BIIDZ)[I", line = 271)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "()V", line = 409)
    public class180() {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILl;BLuu;IZD)[I", line = 425)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lnj;)V", line = 568)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIIIII)V", line = 661)
