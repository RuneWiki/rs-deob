...
public class class180 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IB)Lbk;", line = 70)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Ldd;ILpj;Lpj;)V", line = 128)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)V", line = 108)
