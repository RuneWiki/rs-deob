...
public class class180 implements Runnable {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIBIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ILwk;I)Lep;", line = 216)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lep;I)V", line = 251)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lwk;I[BI)Lep;", line = 290)
    ...
    @OriginalMember(owner = "client!kv", name = "run", descriptor = "()V", line = 307)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lwk;ZI)Lep;", line = 353)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)V", line = 371)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lnt;)V", line = 400)
