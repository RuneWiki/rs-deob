...
public class class180 extends class280 {
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "()V", line = 6)
    public static void method1142() {
        field2585 = null;
    }

    @OriginalMember(owner = "client!ao", name = "d", descriptor = "()V", line = 9)
    public final void method1143() {
        field2585.method1229(this.field2586, (byte) -109);
    }

    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()V", line = 12)
    public final void method1144() {
        field2585.method1231(this.field2586, super.field3981);
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "()I", line = 21)
    public final int method1146() {
        return field2585.method1227(this.field2586, (byte) 107);
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 26)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lqn;I)V", line = 28)
