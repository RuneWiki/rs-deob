...
public class class180 extends class411 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIBZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lni;Lni;Ltu;)V", line = 66)
    public class180(class522 arg0, class522 arg1, class352 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIB)Z", line = 102)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(Z)V", line = 113)
