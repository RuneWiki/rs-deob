...
public class class180 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(III)Lne;")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIIIILlea;)Luk;")
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Lfc;II)V")
