...
public class class180 {
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)I", line = 23)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Leea;Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 163)
    public class180() {
    }

    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Ljc;)V", line = 165)
