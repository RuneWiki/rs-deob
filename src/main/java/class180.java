...
public class class180 extends class294 {
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)I", line = 251)
    public final int method452(boolean arg0) {
        field2518++;
        return arg0 ? -110 : this.field2528;
    }

    @OriginalMember(owner = "client!el", name = "c", descriptor = "(B)J", line = 262)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IB)Z", line = 274)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)I", line = 290)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(CI)C", line = 306)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)I", line = 699)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([IIBI[J)V", line = 710)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILfa;Lr;)V", line = 770)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IZII)I", line = 1006)
