...
public class class180 extends class321 {
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lmm;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()V", line = 21)
    public final void method377() {
        this.field4370.field4794.glFramebufferTexture2DEXT(36160, this.field2554, 3553, 0, 0);
        this.field2554 = -1;
    }

    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lmm;IIZ[[I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lmm;IIZ[[BI)V", line = 64)
