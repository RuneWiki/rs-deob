...
public class class180 {
    ...
    @OriginalMember(owner = "client!cea", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field2160++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 51)
    public class180(String arg0, String arg1, String arg2, String arg3) {
        this.field2159 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)Ljava/lang/String;", line = 75)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(I)V", line = 120)
