...
public class class180 extends class411 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ZIIIJ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 111)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ldm;II)I", line = 135)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(I)V", line = 160)
