...
public class class180 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)I", line = 36)
