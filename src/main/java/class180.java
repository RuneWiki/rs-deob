...
public class class180 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Z)V", line = 74)
