...
public class class180 {
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 20)
    public class180(String arg0, String arg1, String arg2, String arg3) {
        this.field2730 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!gf", name = "toString", descriptor = "()Ljava/lang/String;", line = 61)
    public final String toString() {
        field2735++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 139)
