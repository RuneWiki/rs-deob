...
public class class180 extends class199 {
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Let;Lkg;[Lgm;[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "([B[IIIIIIIIIIILoj;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "([B[IIIIIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(CIIIZ)V", line = 160)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(CIIIZLoj;II)V", line = 217)
