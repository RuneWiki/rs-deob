...
public class class180 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZIIB)I", line = 5)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lws;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 123)
