...
public class class180 extends class400 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ljba;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "()Ljba;")
    public final class400 method103() {
        return (class400) this.field2743.method1269(4);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Leh;Lom;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lom;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(Ljba;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "()Ljba;")
