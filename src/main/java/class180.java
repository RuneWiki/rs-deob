...
public class class180 extends class7 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([IBLjg;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BLjg;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjg;I)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)Lll;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILmo;)V")
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(BLjg;)Ljava/lang/String;")
