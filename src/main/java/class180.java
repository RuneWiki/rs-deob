...
public abstract class class180 extends class76 {
    ...
    @OriginalMember(owner = "client!gf", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ICI)I", line = 16)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(IIIZZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IBI)Z", line = 57)
