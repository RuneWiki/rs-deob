...
public class class205 extends class252 {
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lur;IIII[BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lur;IIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!wt", name = "f", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIIIIIBI)V", line = 62)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Z)V", line = 93)
