...
public class class205 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lha;JI)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)Lhm;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILrv;I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lrv;I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "d", descriptor = "(B)Lhm;")
