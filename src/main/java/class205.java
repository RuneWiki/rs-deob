...
public class class205 extends class353 {
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lkd;Lmv;Lgb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILqda;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(IZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!oq", name = "g", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!oq", name = "h", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IZI)V", line = 129)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZB)V", line = 158)
