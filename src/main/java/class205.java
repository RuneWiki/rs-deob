...
public class class205 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "()I", line = 34)
    public final int method1851() {
        return this.field3209 - 1;
    }

    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Ljava/lang/String;)I", line = 41)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "()V", line = 167)
