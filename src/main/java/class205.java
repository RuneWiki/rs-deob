...
public class class205 {
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "()Lte;")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lkea;II)Lbj;")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lrt;)V")
