...
public class class205 extends class349 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IB)[[I", line = 8)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "()V", line = 69)
    public class205() {
        super(3, false);
    }

    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IILdga;)V", line = 72)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(BI)[I", line = 124)
