...
public abstract class class205 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IFFIIIIIIFI[FI)V", line = 21)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)V", line = 104)
