...
public class class205 extends class415 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)Lto;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIZ)Ltt;")
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(ILht;Lht;Liu;Ltc;IIZ)V")
