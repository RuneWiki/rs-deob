...
public class class205 extends class47 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)J", line = 37)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 103)
    public class205() {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IZ)I", line = 68)
