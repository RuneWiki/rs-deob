...
public class class205 extends class45 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lfd;Lm;)V", line = 15)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)Z", line = 37)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILkj;Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)Loc;", line = 138)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIIIIIIBI)V", line = 457)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)V", line = 491)
