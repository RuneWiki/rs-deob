...
public class class205 extends class45 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!gp", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 30)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(B)Z", line = 75)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 89)
    ...
    @OriginalMember(owner = "client!gp", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 124)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1311(arg0.getX(), arg0.getY(), 1);
        field2877++;
    }

    @OriginalMember(owner = "client!gp", name = "d", descriptor = "(I)Lpea;", line = 132)
    public final class620 method359(int arg0) {
        field2859++;
        return arg0 == 0 ? (class620) this.field2871.method1034(arg0 + 20791) : null;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)I", line = 150)
    public final int method351(int arg0) {
        field2860++;
        return arg0 == -25269 ? this.field2858 : -90;
    }

    @OriginalMember(owner = "client!gp", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 162)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field2869++;
        this.method1311(arg0.getX(), arg0.getY(), 1);
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!gp", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 225)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1311(arg0.getX(), arg0.getY(), 1);
        field2878++;
    }

    @OriginalMember(owner = "client!gp", name = "f", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(B)Z", line = 260)
    ...
    @OriginalMember(owner = "client!gp", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 273)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!gp", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 295)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field2862++;
        this.method1311(arg0.getX(), arg0.getY(), 1);
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)Z", line = 303)
    ...
    @OriginalMember(owner = "client!gp", name = "g", descriptor = "(B)V", line = 317)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(B)I", line = 330)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 359)
