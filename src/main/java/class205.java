...
public class class205 extends class88 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(FB)V", line = 3)
    ...
    @OriginalMember(owner = "client!aj", name = "l", descriptor = "(B)V", line = 23)
    public static void method1339(byte arg0) {
        field2676 = null;
        int var1 = -121 % ((arg0 - -50) / 40);
    }

    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(I)V", line = 32)
    public class205(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aj", name = "s", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIB)V", line = 50)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)Lmu;", line = 198)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(FI)V", line = 205)
