...
public class class205 extends class372 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IILuv;IIIILuv;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(Z)Z", line = 53)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(IIIII)V", line = 326)
    public class205(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!m", name = "d", descriptor = "(B)I", line = 85)
    ...
    @OriginalMember(owner = "client!m", name = "h", descriptor = "(I)I", line = 123)
    ...
    @OriginalMember(owner = "client!m", name = "g", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(BLha;)Lhga;", line = 153)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(Lha;B)Ldg;", line = 331)
    public final class435 method894(class66 arg0, byte arg1) {
        ++field3084;
        return arg1 >= -38 ? null : null;
    }

    @OriginalMember(owner = "client!m", name = "j", descriptor = "(I)Z", line = 342)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lha;III)Z", line = 363)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BLha;)V", line = 403)
