...
public abstract class class205 implements class745 {
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!ru", name = "d", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)I", line = 145)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Llf;IIIZ)V", line = 187)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(B)I", line = 159)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(I)V", line = 173)
