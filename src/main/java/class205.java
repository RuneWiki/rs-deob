...
public class class205 extends class278 {
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "()V", line = 9)
    public class205() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cd", name = "g", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lpp;III)V", line = 55)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Llh;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)[I", line = 182)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IILqa;ILtr;Lls;)Z", line = 273)
    ...
    @OriginalMember(owner = "client!cd", name = "e", descriptor = "(B)V", line = 490)
