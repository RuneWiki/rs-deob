...
public class class205 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIII[IZI[IIIIIIILbi;)I")
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(Z)Ln;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZLil;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lil;IZI)V")
