...
public class class205 extends class439 {
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lpo;II)V")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lpo;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lpo;IIZ[[BI)V")
