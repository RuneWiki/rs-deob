...
public class class205 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)Ljd;")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(JZ)Ljd;")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "([Ljd;I)I")
    ...
    @OriginalMember(owner = "client!ica", name = "f", descriptor = "(I)Ljd;")
    ...
    @OriginalMember(owner = "client!ica", name = "g", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)Ljd;")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Ljd;BJ)V")
