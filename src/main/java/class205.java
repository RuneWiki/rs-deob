...
public abstract class class205 extends class117 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(BII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!vn", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 55)
