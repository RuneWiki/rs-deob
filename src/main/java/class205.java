...
public class class205 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILgr;BIII)Leh;")
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(II)Lng;")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Ljc;ILgp;)V")
