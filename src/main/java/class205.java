...
public class class205 extends class134 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(ILkda;)V", line = 60)
    public class205(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(B)Z", line = 259)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 272)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(I)Z", line = 304)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lkda;)V", line = 317)
    public class205(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(II)I", line = 320)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(B)I", line = 351)
    ...
    @OriginalMember(owner = "client!oc", name = "e", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!oc", name = "f", descriptor = "(I)V", line = 469)
