...
public class class205 {
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIB)V", line = 30)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IB)Lfp;", line = 46)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lci;ILhe;Lhe;)V", line = 210)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)Lih;", line = 112)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BI)V", line = 185)
