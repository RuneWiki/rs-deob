...
public class class205 extends class313 {
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "()I", line = 3)
    public final int method1391() {
        return field3035.method658((byte) 122, this.field3034);
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "()V", line = 12)
    public final void method1393() {
        field3035.method659(30546, this.field3034);
    }

    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lge;I)V", line = 15)
    public class205(class711 arg0, int arg1) {
        field3035 = (class292) arg0.method4050(16879);
        this.field3034 = arg1;
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "()V", line = 20)
    public final void method1394() {
        field3035.method662(this.field3034, (byte) -118);
    }

    @OriginalMember(owner = "client!sa", name = "d", descriptor = "()V", line = 23)
    public final void method1395() {
        field3035.method657(this.field3034, super.field4432);
    }

    @OriginalMember(owner = "client!sa", name = "e", descriptor = "()V", line = 26)
    public static void method1396() {
        field3035 = null;
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 29)
