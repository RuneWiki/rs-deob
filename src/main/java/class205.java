...
public class class205 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lud;II)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILud;II)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(II)Lpc;")
