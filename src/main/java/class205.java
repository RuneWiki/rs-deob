...
public abstract class class205 extends class59 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I[S[Ljava/lang/String;)V", line = 10)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 52)
