...
public class class205 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILha;)V", line = 8)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!lm", name = "finalize", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BLjw;)V", line = 77)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILka;ZLha;IIILsk;)V", line = 176)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)I", line = 220)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lha;I)V", line = 237)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lha;Lrq;IIIILjw;ZI)V", line = 554)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(II)V", line = 274)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)Z", line = 399)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIZZLha;)Lka;", line = 417)
