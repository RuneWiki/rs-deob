...
public class class205 extends class85 {
    ...
    @OriginalMember(owner = "client!wc", name = "Q", descriptor = "Lia;")
    public static class79 field4019 = new class79();

    @OriginalMember(owner = "client!wc", name = "X", descriptor = "Llf;")
    private static class109 field4026 = class35.method275("Please try again)3", 2);

    @OriginalMember(owner = "client!wc", name = "W", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BILja;)V")
