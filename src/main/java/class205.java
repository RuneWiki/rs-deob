...
public class class205 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IBI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIILbda;Lbda;)V", line = 49)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)Lfo;", line = 94)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lgn;ILvo;Lvo;Lvo;)V", line = 205)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IB)V", line = 162)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BI)Lhea;", line = 181)
