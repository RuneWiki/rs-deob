...
public class class205 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILjava/lang/String;BZ)I", line = 185)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)Lgs;", line = 262)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 292)
