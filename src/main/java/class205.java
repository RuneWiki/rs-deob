...
public class class205 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lh;Lva;III)V", line = 52)
