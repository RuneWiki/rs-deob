...
public class class205 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(C)V", line = 12)
    public final void method1427(char arg0) {
        this.field2878.field198.glCallList(this.field2879 + arg0);
    }

    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lhd;I)V", line = 15)
