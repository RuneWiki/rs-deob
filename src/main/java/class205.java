...
public class class205 extends class617 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lnp;I)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lnp;BI)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)Lwl;")
