...
public class class205 extends class130 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Li;III[Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lsg;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 62)
    public class205(String arg0) {
        this.field3156 = arg0;
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 70)
