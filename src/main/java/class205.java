...
public class class205 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)I", line = 17)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)Z", line = 141)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIIIII)I", line = 201)
