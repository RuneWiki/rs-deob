...
public class class205 extends class377 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIZIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBIIIIIII)V", line = 445)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(B)V", line = 458)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIBII)V", line = 471)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIIIIIII)V", line = 491)
    ...
    @OriginalMember(owner = "client!cd", name = "h", descriptor = "(I)V", line = 508)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBI)Z", line = 538)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lqg;II)V", line = 556)
