...
public class class205 extends class214 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 4)
    public class205() {
        super(0, false);
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Llk;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IB)[[I", line = 25)
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!nq", name = "g", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Z)I", line = 167)
