...
public abstract class class205 implements class351 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lks;IIIZ)V")
