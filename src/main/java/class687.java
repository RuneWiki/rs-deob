...
public class class687 extends class430 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "()V", line = 35)
    public class687() {
    }

    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 40)
