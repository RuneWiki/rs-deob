...
public class class687 implements Runnable {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(JI)V", line = 207)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)[Lpb;", line = 228)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(III[B)V", line = 243)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!jv", name = "d", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 420)
    ...
    @OriginalMember(owner = "client!jv", name = "run", descriptor = "()V", line = 339)
    ...
    @OriginalMember(owner = "client!jv", name = "e", descriptor = "(I)[Lqf;", line = 400)
