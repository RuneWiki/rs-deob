...
public class class687 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(IB)Lfg;", line = 24)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Leha;IIIIIIIBLoea;II)V", line = 79)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ZB)V", line = 108)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(IB)V", line = 126)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ZI)V", line = 164)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Lal;IZLnd;Lnd;)V", line = 206)
