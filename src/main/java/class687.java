...
public class class687 extends class735 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(CB)B")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lrh;Z)V")
