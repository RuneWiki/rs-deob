...
public class class687 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Loh;Lnc;Loh;Loh;BLdia;)Z", line = 23)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)I", line = 51)
    ...
    @OriginalMember(owner = "client!jm", name = "toString", descriptor = "()Ljava/lang/String;", line = 70)
    public final String toString() {
        field9689++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIIIBII)V", line = 101)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(I)V", line = 147)
