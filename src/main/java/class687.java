...
public class class687 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)Lva;", line = 37)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Z)Lva;", line = 63)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lva;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(Z)Z", line = 104)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(Z)Lva;", line = 141)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 188)
    public class687() {
        this.field9579.field6716 = this.field9579;
        this.field9579.field6720 = this.field9579;
    }

    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)Lva;", line = 163)
