...
public abstract class class687 {
    ...
    @OriginalMember(owner = "client!gfa", name = "f", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IILba;II)Lac;", line = 67)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Z[B)V", line = 86)
