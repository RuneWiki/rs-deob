...
public class class687 extends class524 implements class691 {
    ...
    @OriginalMember(owner = "client!kn", name = "k", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "f", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!kn", name = "g", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lr;III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!kn", name = "h", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)Z", line = 124)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BLr;)V", line = 136)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 164)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lr;Lfga;IIIIIZIZ)V", line = 193)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)I", line = 227)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIZLr;ILub;I)V", line = 239)
    ...
    @OriginalMember(owner = "client!kn", name = "f", descriptor = "(I)I", line = 260)
    ...
    @OriginalMember(owner = "client!kn", name = "l", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILr;Z)Lfe;", line = 285)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(BLr;)Lsr;", line = 319)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lr;Z)V", line = 333)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILr;)V", line = 349)
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(B)I", line = 379)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BLr;I)Lda;", line = 391)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lr;B)Llt;", line = 411)
