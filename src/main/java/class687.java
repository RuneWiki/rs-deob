...
public class class687 extends class396 {
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(II)I", line = 29)
    public static final int method3916(int arg0, int arg1) {
        ++field9631;
        return arg1 >= -49 ? 49 : arg0 >>> 10;
    }

    @OriginalMember(owner = "client!gw", name = "f", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lep;II[BI)V", line = 54)
