...
public class class687 {
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)Lcr;")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lek;B)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lek;II)V")
    ...
    @OriginalMember(owner = "client!jv", name = "d", descriptor = "(I)Lcr;")
