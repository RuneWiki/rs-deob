...
public class class687 extends class578 {
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lha;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;)V", line = 59)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILjava/lang/String;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIBIFFF[FII[FI)V", line = 208)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)Z", line = 294)
