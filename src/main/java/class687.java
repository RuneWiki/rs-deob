...
public class class687 extends class181 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)F", line = 7)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)D", line = 23)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(Z)Z", line = 64)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 77)
    public class687(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 92)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILha;)Lvr;", line = 171)
    ...
    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(Z)J", line = 191)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(I)V", line = 238)
