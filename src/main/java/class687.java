...
public class class687 {
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)Lpb;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILjava/lang/String;Lud;)I")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)Lrea;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILci;)Lql;")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Leq;Leq;)V")
