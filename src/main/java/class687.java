...
public class class687 extends class282 {
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(ILor;Lma;III)V", line = 3)
    public class687(int arg0, class594 arg1, class12 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field9805 = arg5;
    }

    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IZI)Ltaa;", line = 22)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)Loh;", line = 37)
