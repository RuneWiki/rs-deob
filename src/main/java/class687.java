...
public class class687 extends class175 {
    ...
    @OriginalMember(owner = "client!jka", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IB)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IILofa;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jka", name = "h", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(Lha;Z)V", line = 169)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(II)V", line = 187)
    ...
    @OriginalMember(owner = "client!jka", name = "i", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!jka", name = "<init>", descriptor = "()V", line = 817)
    public class687() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(Lnga;I)Llda;", line = 820)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(Lgt;B)V", line = 846)
    ...
    @OriginalMember(owner = "client!jka", name = "c", descriptor = "(B)Ljava/lang/String;", line = 866)
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(ILdt;Z)V", line = 900)
