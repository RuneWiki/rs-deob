...
public class class687 extends class756 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BLib;)V", line = 10)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lkp;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ID)V", line = 48)
