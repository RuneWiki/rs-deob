...
public class class687 extends class461 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BII)V", line = 20)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIB)V", line = 42)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(IIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 76)
