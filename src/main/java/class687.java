...
public class class687 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILig;)I")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lig;)B")
    private static final byte method3839(class246 arg0) {
        return (byte) method3836(8, arg0);
    }

    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!bs", name = "c", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!bs", name = "e", descriptor = "(Lig;)B")
