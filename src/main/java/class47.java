...
public class class47 extends class649 {
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lhs;)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIII)Lpe;")
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(ILhs;)V")
