...
public class class47 extends Canvas {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lnq;Lnq;BLnq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(II)I", line = 23)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 29)
    public class47(Component arg0) {
        this.field654 = arg0;
    }

    @OriginalMember(owner = "client!kl", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 37)
    public final void update(Graphics arg0) {
        field652++;
        this.field654.update(arg0);
    }

    @OriginalMember(owner = "client!kl", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 45)
    public final void paint(Graphics arg0) {
        this.field654.paint(arg0);
        field651++;
    }

    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)V", line = 55)
