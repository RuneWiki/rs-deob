...
public class class47 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)Lkn;", line = 4)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLgk;)V", line = 73)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIBILda;II)Lda;", line = 107)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IILda;III)Lda;", line = 193)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZIBI)I", line = 328)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BILgk;)V", line = 461)
