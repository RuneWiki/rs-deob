...
public class class47 extends class60 implements class116 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IBII)I", line = 7)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!dt", name = "e", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lve;B)V", line = 55)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILoj;)V", line = 123)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILoj;II)Z", line = 134)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lph;III[Z)Z", line = 155)
    ...
    @OriginalMember(owner = "client!dt", name = "d", descriptor = "(ILoj;)V", line = 190)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Loj;Lcu;IIIIIZII)V", line = 215)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 224)
    ...
    @OriginalMember(owner = "client!dt", name = "c", descriptor = "(ILoj;)Lmg;", line = 236)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(ILoj;)V", line = 274)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILoj;B)Lqh;", line = 292)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(B)I", line = 304)
    ...
    @OriginalMember(owner = "client!dt", name = "d", descriptor = "(I)Z", line = 316)
    ...
    @OriginalMember(owner = "client!dt", name = "c", descriptor = "(B)V", line = 327)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(I)Z", line = 347)
    ...
    @OriginalMember(owner = "client!dt", name = "h", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)I", line = 368)
