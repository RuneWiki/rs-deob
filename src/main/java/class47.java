...
public class class47 {
    ...
    @OriginalMember(owner = "client!RIUJHZLL", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!RIUJHZLL", name = "c", descriptor = "[LRIUJHZLL;")
    public static class47[] field1280;

    @OriginalMember(owner = "client!RIUJHZLL", name = "a", descriptor = "(ILRVLWVPJQ;)V")
    ...
    @OriginalMember(owner = "client!RIUJHZLL", name = "a", descriptor = "(ILUAWAYCTK;)V")
