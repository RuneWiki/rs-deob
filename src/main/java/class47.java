...
@OriginalClass("client!QEWPNZTS")
public class class47 {

    @OriginalMember(owner = "client!QEWPNZTS", name = "a", descriptor = "Z")
    private boolean field1290 = true;

    @OriginalMember(owner = "client!QEWPNZTS", name = "b", descriptor = "I")
    private int field1291 = 6;

    @OriginalMember(owner = "client!QEWPNZTS", name = "c", descriptor = "[I")
    public int[] field1292 = new int[2];

    @OriginalMember(owner = "client!QEWPNZTS", name = "d", descriptor = "[[[I")
    public int[][][] field1293 = new int[2][2][4];

    @OriginalMember(owner = "client!QEWPNZTS", name = "e", descriptor = "[[[I")
    public int[][][] field1294 = new int[2][2][4];

    @OriginalMember(owner = "client!QEWPNZTS", name = "f", descriptor = "[I")
    public int[] field1295 = new int[2];

    @OriginalMember(owner = "client!QEWPNZTS", name = "g", descriptor = "[[F")
    public static float[][] field1296 = new float[2][8];

    @OriginalMember(owner = "client!QEWPNZTS", name = "h", descriptor = "[[I")
    public static int[][] field1297 = new int[2][8];

    @OriginalMember(owner = "client!QEWPNZTS", name = "i", descriptor = "F")
    public static float field1298;

    @OriginalMember(owner = "client!QEWPNZTS", name = "j", descriptor = "I")
    public static int field1299;

    @OriginalMember(owner = "client!QEWPNZTS", name = "a", descriptor = "(IZFI)F")
    ...
    @OriginalMember(owner = "client!QEWPNZTS", name = "a", descriptor = "(IF)F")
    ...
    @OriginalMember(owner = "client!QEWPNZTS", name = "a", descriptor = "(ZFII)F")
    ...
    @OriginalMember(owner = "client!QEWPNZTS", name = "a", descriptor = "(FII)I")
    ...
    @OriginalMember(owner = "client!QEWPNZTS", name = "a", descriptor = "(LKMZLAUEV;LKHOMSBHW;B)V")
