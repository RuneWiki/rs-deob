...
@OriginalClass("client!QGPCEBJK")
public class class47 extends class66 {

    @OriginalMember(owner = "client!QGPCEBJK", name = "v", descriptor = "Z")
    private boolean field1283 = false;

    @OriginalMember(owner = "client!QGPCEBJK", name = "w", descriptor = "B")
    private byte field1284 = 29;

    @OriginalMember(owner = "client!QGPCEBJK", name = "x", descriptor = "Z")
    public boolean field1285 = false;

    @OriginalMember(owner = "client!QGPCEBJK", name = "H", descriptor = "LTGIKVGNH;")
    private class55 field1295;

    @OriginalMember(owner = "client!QGPCEBJK", name = "t", descriptor = "I")
    public int field1281;

    @OriginalMember(owner = "client!QGPCEBJK", name = "m", descriptor = "I")
    public int field1274;

    @OriginalMember(owner = "client!QGPCEBJK", name = "n", descriptor = "I")
    public int field1275;

    @OriginalMember(owner = "client!QGPCEBJK", name = "o", descriptor = "I")
    public int field1276;

    @OriginalMember(owner = "client!QGPCEBJK", name = "I", descriptor = "I")
    public int field1296;

    @OriginalMember(owner = "client!QGPCEBJK", name = "J", descriptor = "I")
    public int field1297;

    @OriginalMember(owner = "client!QGPCEBJK", name = "y", descriptor = "I")
    public int field1286;

    @OriginalMember(owner = "client!QGPCEBJK", name = "z", descriptor = "I")
    public int field1287;

    @OriginalMember(owner = "client!QGPCEBJK", name = "A", descriptor = "I")
    public int field1288;

    @OriginalMember(owner = "client!QGPCEBJK", name = "p", descriptor = "I")
    public int field1277;

    @OriginalMember(owner = "client!QGPCEBJK", name = "q", descriptor = "D")
    public double field1278;

    @OriginalMember(owner = "client!QGPCEBJK", name = "r", descriptor = "D")
    public double field1279;

    @OriginalMember(owner = "client!QGPCEBJK", name = "s", descriptor = "D")
    public double field1280;

    @OriginalMember(owner = "client!QGPCEBJK", name = "u", descriptor = "D")
    private double field1282;

    @OriginalMember(owner = "client!QGPCEBJK", name = "B", descriptor = "D")
    private double field1289;

    @OriginalMember(owner = "client!QGPCEBJK", name = "C", descriptor = "D")
    private double field1290;

    @OriginalMember(owner = "client!QGPCEBJK", name = "D", descriptor = "D")
    private double field1291;

    @OriginalMember(owner = "client!QGPCEBJK", name = "E", descriptor = "D")
    private double field1292;

    @OriginalMember(owner = "client!QGPCEBJK", name = "k", descriptor = "I")
    private int field1272;

    @OriginalMember(owner = "client!QGPCEBJK", name = "l", descriptor = "I")
    private int field1273;

    @OriginalMember(owner = "client!QGPCEBJK", name = "F", descriptor = "I")
    public int field1293;

    @OriginalMember(owner = "client!QGPCEBJK", name = "G", descriptor = "I")
    public int field1294;

    @OriginalMember(owner = "client!QGPCEBJK", name = "a", descriptor = "(I)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!QGPCEBJK", name = "a", descriptor = "(IIZII)V")
    ...
    @OriginalMember(owner = "client!QGPCEBJK", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!QGPCEBJK", name = "a", descriptor = "(II)V")
