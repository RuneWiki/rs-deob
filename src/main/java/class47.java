...
public class class47 {
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "Llf;")
    public static class109 field969 = class35.method275("Ausw-=hlen", 2);

    @OriginalMember(owner = "client!ef", name = "i", descriptor = "Ltf;")
    public static class181 field976 = new class181();

    @OriginalMember(owner = "client!ef", name = "p", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "Lva;")
    ...
    @OriginalMember(owner = "client!ef", name = "g", descriptor = "[Llf;")
    public class109[] field974;

    @OriginalMember(owner = "client!ef", name = "o", descriptor = "[Ldf;")
    public static class37[] field982;

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILbg;II)[Lkf;")
