...
public class class47 implements class410 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BLjava/lang/String;IILda;I)I", line = 25)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZB)V", line = 35)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lsca;Llr;)V", line = 80)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 89)
