...
public class class47 extends class696 implements class636 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "([IIIBIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IF)F", line = 27)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I[FILkca;IIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Ljava/lang/Object;BZ)[B", line = 56)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Z)I", line = 92)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ZBZ)V", line = 104)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IZILdm;)V", line = 143)
    ...
    @OriginalMember(owner = "client!gp", name = "h", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(FI)F", line = 229)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIIILkca;Z[BI)V", line = 241)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Leea;Lkca;IIZ[FII)V", line = 254)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Leea;IIZ[III)V", line = 273)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIZII[II)V", line = 292)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Leea;Lkca;Lti;II)V", line = 308)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Leea;Lkca;IIZ[BII)V", line = 319)
