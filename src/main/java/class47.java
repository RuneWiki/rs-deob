...
public class class47 extends class475 {
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIZ[Lis;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!hq", name = "f", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 78)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 89)
    public class47(Object arg0, int arg1) {
        super(arg1);
        this.field627 = arg0;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)Z", line = 97)
