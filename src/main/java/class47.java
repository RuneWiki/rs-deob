...
@OriginalClass("client!TAIXVIBM")
public class class47 extends class29 {

    @OriginalMember(owner = "client!TAIXVIBM", name = "A", descriptor = "I")
    private int field1428 = 3;

    @OriginalMember(owner = "client!TAIXVIBM", name = "B", descriptor = "Z")
    private boolean field1429 = false;

    @OriginalMember(owner = "client!TAIXVIBM", name = "C", descriptor = "Z")
    private boolean field1430 = true;

    @OriginalMember(owner = "client!TAIXVIBM", name = "D", descriptor = "I")
    private int field1431 = 3;

    @OriginalMember(owner = "client!TAIXVIBM", name = "K", descriptor = "I")
    public int field1438;

    @OriginalMember(owner = "client!TAIXVIBM", name = "L", descriptor = "I")
    public int field1439;

    @OriginalMember(owner = "client!TAIXVIBM", name = "F", descriptor = "[I")
    public int[] field1433;

    @OriginalMember(owner = "client!TAIXVIBM", name = "I", descriptor = "I")
    public int field1436;

    @OriginalMember(owner = "client!TAIXVIBM", name = "J", descriptor = "I")
    public int field1437;

    @OriginalMember(owner = "client!TAIXVIBM", name = "G", descriptor = "I")
    public int field1434;

    @OriginalMember(owner = "client!TAIXVIBM", name = "H", descriptor = "I")
    public int field1435;

    @OriginalMember(owner = "client!TAIXVIBM", name = "E", descriptor = "[B")
    public byte[] field1432;

    @OriginalMember(owner = "client!TAIXVIBM", name = "z", descriptor = "I")
    private static int field1427 = -302;

    @OriginalMember(owner = "client!TAIXVIBM", name = "<init>", descriptor = "(LLYZBHNJP;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "a", descriptor = "(IZII)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!TAIXVIBM", name = "a", descriptor = "(I[IIB[III[BII)V")
