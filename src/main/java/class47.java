...
public class class47 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lqa;IIIIZIII)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ldh;B)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IBLdh;)V")
