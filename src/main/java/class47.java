...
public class class47 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)Lhs;", line = 200)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 226)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lhs;Z)V", line = 250)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I[Lbm;IIIILea;[BZIBI)V", line = 268)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "()V", line = 409)
    public class47() {
        this.field598.field5847 = this.field598;
        this.field598.field5837 = this.field598;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lof;Z)I", line = 355)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)Lhs;", line = 382)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 423)
