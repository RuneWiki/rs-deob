...
public class class47 extends class601 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I[II)V", line = 5)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "()V", line = 164)
    public class47() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bq", name = "d", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IB)[I", line = 199)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIIIIIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIIIB)I", line = 358)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lmc;II)V", line = 433)
    ...
    @OriginalMember(owner = "client!bq", name = "f", descriptor = "(I)V", line = 530)
