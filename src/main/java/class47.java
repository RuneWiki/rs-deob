...
@OriginalClass("client!ONADPAJP")
public class class47 {

    @OriginalMember(owner = "client!ONADPAJP", name = "b", descriptor = "I")
    private int field1276 = -30411;

    @OriginalMember(owner = "client!ONADPAJP", name = "c", descriptor = "Z")
    private boolean field1277 = true;

    @OriginalMember(owner = "client!ONADPAJP", name = "d", descriptor = "Z")
    private boolean field1278 = true;

    @OriginalMember(owner = "client!ONADPAJP", name = "e", descriptor = "B")
    private byte field1279 = 4;

    @OriginalMember(owner = "client!ONADPAJP", name = "f", descriptor = "Z")
    private boolean field1280 = true;

    @OriginalMember(owner = "client!ONADPAJP", name = "g", descriptor = "I")
    private int field1281 = 4;

    @OriginalMember(owner = "client!ONADPAJP", name = "h", descriptor = "I")
    public int field1282 = 0;

    @OriginalMember(owner = "client!ONADPAJP", name = "i", descriptor = "I")
    public int field1283 = 0;

    @OriginalMember(owner = "client!ONADPAJP", name = "j", descriptor = "I")
    public int field1284;

    @OriginalMember(owner = "client!ONADPAJP", name = "k", descriptor = "I")
    public int field1285;

    @OriginalMember(owner = "client!ONADPAJP", name = "l", descriptor = "[[I")
    public int[][] field1286;

    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "I")
    private int field1275;

    @OriginalMember(owner = "client!ONADPAJP", name = "<init>", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(IZIIII)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(IIZIIII)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(IBI)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(III)V")
    private void method455(int arg0, int arg1, int arg2) {
        this.field1286[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(IIIIZZ)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(ZIIIIII)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "b", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "b", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!ONADPAJP", name = "a", descriptor = "(ZIIIIIII)Z")
