...
public class class47 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILtn;)V", line = 18)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZBI)V", line = 38)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILda;IILjava/lang/String;ILtba;Laa;ILgaa;II)V", line = 55)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ltn;ZI)V", line = 119)
