...
public class class47 {
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "L", descriptor = "LLSQNLJTA;")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "x", descriptor = "LCFARFRSG;")
    private static class8 field1195;

    @OriginalMember(owner = "client!OMIIKHIV", name = "y", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "n", descriptor = "[LOMIIKHIV;")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "a", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "a", descriptor = "(I)LOMIIKHIV;")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "a", descriptor = "([IZII)LLFTMDGKK;")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "b", descriptor = "(I)LOMIIKHIV;")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "a", descriptor = "(LVSUYIIVA;)V")
    ...
    @OriginalMember(owner = "client!OMIIKHIV", name = "a", descriptor = "(B)LLFTMDGKK;")
