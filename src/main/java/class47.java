...
public class class47 extends class481 implements class522 {
    ...
    @OriginalMember(owner = "client!kaa", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "([BIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)I", line = 58)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(II[III)V", line = 70)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)J", line = 127)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lqo;I[BIZ)V", line = 143)
    public class47(class22 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field990 = arg1;
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(III)Z", line = 151)
