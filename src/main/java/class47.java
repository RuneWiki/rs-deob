...
public class class47 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIIIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILkka;)V", line = 37)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BI)I", line = 241)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lgj;ILjava/lang/String;Z)Lfh;", line = 251)
