...
public class class47 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(III)I", line = 22)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lae;)V", line = 56)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)[I", line = 159)
