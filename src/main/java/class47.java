...
public class class47 {
    ...
    @OriginalMember(owner = "client!aea", name = "c", descriptor = "(I)Lbf;")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lbf;Z)V")
    ...
    @OriginalMember(owner = "client!aea", name = "d", descriptor = "(I)Lbf;")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(B)Lbf;")
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(B)Lbf;")
