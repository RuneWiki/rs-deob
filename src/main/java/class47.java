...
public class class47 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(JBLtm;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)I", line = 50)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IBZ)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(JI)Ltm;", line = 97)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(I)V", line = 173)
