...
public class class47 extends Canvas {
    ...
    @OriginalMember(owner = "client!jj", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void paint(Graphics arg0) {
        this.field605.paint(arg0);
        field602++;
    }

    @OriginalMember(owner = "client!jj", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 11)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 35)
