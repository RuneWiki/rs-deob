...
public class class47 {
    ...
    @OriginalMember(owner = "client!vo", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field481.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!vo", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!vo", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
