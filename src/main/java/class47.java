...
public class class47 extends class545 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!jea", name = "h", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ZZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lmba;Lla;)V", line = 157)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IILec;)V", line = 95)
    ...
    @OriginalMember(owner = "client!jea", name = "d", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(BZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)Z", line = 217)
