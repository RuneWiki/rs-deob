...
@OriginalClass("client!QRKWRHKJ")
public class class47 extends class28 {

    @OriginalMember(owner = "client!QRKWRHKJ", name = "o", descriptor = "Z")
    private boolean field1262 = false;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "w", descriptor = "Z")
    public boolean field1270 = false;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "x", descriptor = "I")
    private int field1271 = 101;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "z", descriptor = "Z")
    private boolean field1273 = true;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "y", descriptor = "LSNGXEJOJ;")
    private class55 field1272;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "p", descriptor = "I")
    public int field1263;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "q", descriptor = "I")
    public int field1264;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "r", descriptor = "I")
    public int field1265;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "s", descriptor = "I")
    public int field1266;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "n", descriptor = "I")
    public int field1261;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "t", descriptor = "I")
    private int field1267;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "u", descriptor = "I")
    private int field1268;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "v", descriptor = "I")
    private int field1269;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "A", descriptor = "I")
    private int field1274;

    @OriginalMember(owner = "client!QRKWRHKJ", name = "a", descriptor = "(I)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!QRKWRHKJ", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!QRKWRHKJ", name = "<init>", descriptor = "(IIBIIIII)V")
