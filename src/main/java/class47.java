...
public class class47 extends class45 {
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lfd;)V", line = 115)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)V", line = 202)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZB)V", line = 218)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILkj;Z)V", line = 257)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)Z", line = 270)
