...
@OriginalClass("client!SFXLZPAR")
public class class47 implements Runnable {

    @OriginalMember(owner = "client!SFXLZPAR", name = "a", descriptor = "Z")
    private boolean field1233 = true;

    @OriginalMember(owner = "client!SFXLZPAR", name = "e", descriptor = "Z")
    private boolean field1237 = false;

    @OriginalMember(owner = "client!SFXLZPAR", name = "j", descriptor = "Z")
    private boolean field1242 = false;

    @OriginalMember(owner = "client!SFXLZPAR", name = "k", descriptor = "Z")
    private boolean field1243 = false;

    @OriginalMember(owner = "client!SFXLZPAR", name = "f", descriptor = "LMUZNSFEY;")
    public class35 field1238;

    @OriginalMember(owner = "client!SFXLZPAR", name = "d", descriptor = "Ljava/net/Socket;")
    private Socket field1236;

    @OriginalMember(owner = "client!SFXLZPAR", name = "b", descriptor = "Ljava/io/InputStream;")
    private InputStream field1234;

    @OriginalMember(owner = "client!SFXLZPAR", name = "c", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1235;

    @OriginalMember(owner = "client!SFXLZPAR", name = "h", descriptor = "I")
    private int field1240;

    @OriginalMember(owner = "client!SFXLZPAR", name = "i", descriptor = "I")
    private int field1241;

    @OriginalMember(owner = "client!SFXLZPAR", name = "g", descriptor = "[B")
    private byte[] field1239;

    @OriginalMember(owner = "client!SFXLZPAR", name = "<init>", descriptor = "(ZLMUZNSFEY;Ljava/net/Socket;)V")
    ...
    @OriginalMember(owner = "client!SFXLZPAR", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!SFXLZPAR", name = "b", descriptor = "()I")
    public int method398() throws IOException {
        return this.field1237 ? 0 : this.field1234.read();
    }

    @OriginalMember(owner = "client!SFXLZPAR", name = "c", descriptor = "()I")
    public int method399() throws IOException {
        return this.field1237 ? 0 : this.field1234.available();
    }

    @OriginalMember(owner = "client!SFXLZPAR", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!SFXLZPAR", name = "a", descriptor = "(III[B)V")
    ...
    @OriginalMember(owner = "client!SFXLZPAR", name = "run", descriptor = "()V")
    public void run() {
    ...
    @OriginalMember(owner = "client!SFXLZPAR", name = "a", descriptor = "(I)V")
