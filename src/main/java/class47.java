...
public class class47 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lwi;I)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lub;II)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lwi;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lho;I)V")
