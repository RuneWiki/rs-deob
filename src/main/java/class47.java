...
public class class47 extends class154 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ljava/lang/String;ILlh;)I", line = 4)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(IIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(IBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIII)I", line = 50)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IBI)V", line = 71)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(III)V", line = 101)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([JI[Ljava/lang/Object;)V", line = 121)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 132)
