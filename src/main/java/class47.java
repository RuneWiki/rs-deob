...
public class class47 extends class28 {
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Ldga;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IIIIBIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(ZLcr;)V", line = 316)
