...
public class class47 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lhf;[[BB)V", line = 20)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(III)Z", line = 92)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)V", line = 103)
