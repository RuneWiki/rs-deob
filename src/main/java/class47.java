...
public class class47 extends class16 {
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(I)V", line = 20)
    public class47(int arg0) {
        this.field718 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!wc", name = "f", descriptor = "(I)V", line = 46)
