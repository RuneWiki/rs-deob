...
public class class47 extends InputStream {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ICI)C", line = 7)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(II)Z", line = 83)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!aea", name = "read", descriptor = "()I", line = 107)
