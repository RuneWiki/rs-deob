...
public class class47 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!PXJVLLTT", name = "o", descriptor = "[LTTFRDWZK;")
    ...
    @OriginalMember(owner = "client!PXJVLLTT", name = "p", descriptor = "LRBKIQEVU;")
    public class51 field1245;

    @OriginalMember(owner = "client!PXJVLLTT", name = "n", descriptor = "LBEVLZSVU;")
