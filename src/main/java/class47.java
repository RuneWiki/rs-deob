...
public abstract class class47 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 10)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIIIIZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIIIIII)I", line = 126)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)V", line = 168)
