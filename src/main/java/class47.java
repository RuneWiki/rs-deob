...
public class class47 extends class535 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BLci;)V")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILwn;)Ljm;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILwn;I)V")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lci;Lci;I)V")
