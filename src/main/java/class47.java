...
public class class47 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)Ljg;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BI)Lsea;")
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lmca;IZLgga;Lgga;)V")
