...
public class class47 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lao;ILjava/lang/String;)Lrf;", line = 4)
    ...
    @OriginalMember(owner = "client!rf", name = "finalize", descriptor = "()V", line = 23)
    protected final void finalize() throws Throwable {
        this.field563.method961(this.field564);
        super.finalize();
    }

    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lao;II)V", line = 32)
