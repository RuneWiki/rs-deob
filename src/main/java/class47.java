...
public class class47 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lfb;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lfb;Lar;B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)Lfb;", line = 49)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)Lfb;", line = 69)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILar;)V", line = 93)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BLfb;)V", line = 145)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(III)Lrl;", line = 167)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)Z", line = 187)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "()V", line = 305)
    public class47() {
        this.field663.field641 = this.field663;
        this.field663.field636 = this.field663;
    }

    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(I)I", line = 207)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)Lfb;", line = 231)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(Z)Lfb;", line = 264)
    ...
    @OriginalMember(owner = "client!ar", name = "d", descriptor = "(B)Lfb;", line = 285)
