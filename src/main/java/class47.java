...
public class class47 extends class654 {
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)Ljs;", line = 25)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lgj;IIIIII)V", line = 87)
