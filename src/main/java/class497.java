...
public class class497 extends class546 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIII[BII[B)V", line = 20)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(III)V", line = 78)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!bf", name = "f", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IZLwq;)V", line = 196)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lrr;Ltj;)V", line = 210)
