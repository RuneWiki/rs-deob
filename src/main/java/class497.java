...
public class class497 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILvg;IIIII)V")
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IB)Ldn;")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lcw;ILeq;)V")
