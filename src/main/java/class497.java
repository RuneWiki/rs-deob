...
public class class497 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIILya;Luq;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lul;I)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(III[Luq;IBIIII)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
    public class497(Throwable arg0, String arg1) {
        this.field7146 = arg0;
        this.field7150 = arg1;
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IILjava/awt/Canvas;Lga;)Lya;")
