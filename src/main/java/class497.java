...
public abstract class class497 {
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(IIIII)V", line = 326)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lr;I)V", line = 192)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(III)V", line = 255)
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(I)V", line = 290)
