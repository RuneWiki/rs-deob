...
public class class497 extends class363 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Ljk;IB)V")
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lod;Lqh;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILse;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(III)Lwo;")
