...
public class class497 extends class721 implements class274 {
    ...
    @OriginalMember(owner = "client!m", name = "j", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!m", name = "c", descriptor = "(ILha;)Lid;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIJ)Lrha;")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lha;Lih;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Ldaa;ILha;)I")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lha;IB)Lka;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IZLha;I)Lsa;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lha;I)V")
