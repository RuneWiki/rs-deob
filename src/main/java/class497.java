...
public class class497 extends class352 implements class141 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "()Z", line = 59)
    public final boolean method209() {
        return true;
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lrc;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIII)V", line = 97)
    public final void method186(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lrc;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()V", line = 120)
    public final void method228() {
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "()[Lbh;", line = 124)
    public final class34[] method221() {
        return this.field6842;
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lba;IIIZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 136)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BIZ)Lba;", line = 144)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()[Lvp;", line = 148)
    public final class171[] method206() {
        return this.field6839;
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "([ILq;)V", line = 156)
    private final void method2780(int[] arg0, class391 arg1) {
        this.field6840.method429().method3389(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lhn;IIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;)V", line = 231)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILq;Z)Z", line = 237)
