...
public class class497 extends class92 {
    ...
    @OriginalMember(owner = "client!wi", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZB)V", line = 14)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILqv;)V", line = 86)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lnd;)V", line = 116)
    public class497(class632 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZLn;BLjava/awt/Canvas;)Lqa;", line = 120)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZII)V", line = 136)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZI)V", line = 149)
