...
public class class497 extends class747 {
    ...
    @OriginalMember(owner = "client!iga", name = "c", descriptor = "(II)Ldf;", line = 5)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(II)[[I", line = 38)
    ...
    @OriginalMember(owner = "client!iga", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "()V", line = 115)
    public class497() {
        super(1, false);
    }

    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Ldc;II)V", line = 124)
