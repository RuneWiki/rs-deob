...
public class class497 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 5)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)Ler;", line = 244)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 300)
