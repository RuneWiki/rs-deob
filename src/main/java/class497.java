...
public class class497 extends class404 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILha;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "()V", line = 47)
    public class497() {
        super(1, false);
    }

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIB)V", line = 171)
    ...
    @OriginalMember(owner = "client!au", name = "h", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(II)[[I", line = 237)
