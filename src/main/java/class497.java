...
public abstract class class497 {
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(ZB)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lkl;ZIILkl;Lkl;I[ZLkl;IIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZLkl;)V", line = 106)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILqk;Z[ZLpfa;ZILqk;IZ[II)V", line = 171)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[IIIZILkl;ILkl;I)V", line = 380)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "([IIIII[IZZII)V", line = 446)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IBIIIIILs;I)V", line = 544)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZB)V", line = 676)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILkl;ILkl;ZIIII)V", line = 759)
