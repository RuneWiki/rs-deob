...
public class class497 extends class34 {
    ...
    @OriginalMember(owner = "client!em", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BI)[[I", line = 19)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(IB)I", line = 81)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IB)[I", line = 92)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lsv;II)V", line = 124)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "()V", line = 199)
    public class497() {
        super(0, true);
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "([[II)V", line = 202)
