...
public class class497 extends class9 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZILdn;ZLn;I)[F", line = 5)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ln;Ldn;DBIZI)[I", line = 119)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(III)Z", line = 260)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZZDILn;BILdn;)[I", line = 381)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(I)V", line = 525)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ldn;ILn;)Z", line = 542)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "()V", line = 591)
    public class497() {
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(II)Z", line = 607)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Los;)V", line = 617)
