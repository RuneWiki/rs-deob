...
public class class497 extends class208 implements class226 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZILha;B)Liu;")
    ...
    @OriginalMember(owner = "client!kb", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lha;BI)Lka;")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILha;)V")
