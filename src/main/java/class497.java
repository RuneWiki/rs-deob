...
public class class497 extends class83 implements class596 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Laaa;Z)Z")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B[[[Lug;)V")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Loaa;IZ[[I)V")
