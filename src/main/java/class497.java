...
public abstract class class497 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZLvg;ZLcea;II[ZIZLvg;I[I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lha;I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIZ[II[IIIII)V", line = 253)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIIIIIIB)V", line = 351)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIILbea;ZILbea;I)V", line = 390)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIILbea;ILbea;[ZIBILbea;Lbea;ZI)V", line = 438)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lbea;IB)V", line = 502)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIILs;IIIII)V", line = 560)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIILbea;[IIILbea;ZI)V", line = 680)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 729)
