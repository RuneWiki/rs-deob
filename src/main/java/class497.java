...
public class class497 extends class601 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(ILgn;)V", line = 20)
    public class497(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bia", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "([BI)Lvga;", line = 59)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IIIIII)Z", line = 136)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IZ)V", line = 171)
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(Lgn;)V", line = 184)
    public class497(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bia", name = "b", descriptor = "(II)I", line = 189)
    ...
    @OriginalMember(owner = "client!bia", name = "b", descriptor = "(B)I", line = 209)
