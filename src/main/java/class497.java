...
public class class497 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(JI)V", line = 13)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIB[B)I", line = 25)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(B)Ljava/io/File;", line = 42)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZI[BI)V", line = 68)
    ...
    @OriginalMember(owner = "client!me", name = "finalize", descriptor = "()V", line = 91)
