...
public class class497 extends class300 {
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lwu;Lgga;)V", line = 4)
    public class497(class376 arg0, class295 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILnt;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZB)V", line = 19)
    ...
    @OriginalMember(owner = "client!iaa", name = "c", descriptor = "(I)V", line = 39)
