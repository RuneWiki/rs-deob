...
public class class497 extends class276 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIFI)V", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)V", line = 116)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BI)V", line = 125)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(BI)V", line = 138)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(IIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I[II)V", line = 165)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lgk;IIIII)V", line = 319)
