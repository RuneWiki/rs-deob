...
public class class497 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Z)V", line = 49)
    public class497(boolean arg0) {
        this.field6224 = arg0;
    }

    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!de", name = "c", descriptor = "(I)V", line = 68)
