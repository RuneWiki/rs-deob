...
public class class497 implements Runnable {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILcc;I)Llba;")
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(ILcc;I)Llba;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILlba;)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lcc;I[BI)Llba;")
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lii;)V")
