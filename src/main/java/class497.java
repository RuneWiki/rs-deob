...
public class class497 extends class283 {
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lkw;Lrb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Lou;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(ZII)V", line = 61)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IIIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(ZI)V", line = 154)
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(IZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(I)Z", line = 201)
