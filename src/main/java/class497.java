...
public class class497 extends class629 {
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IBI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "()V", line = 48)
    public class497() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BIII)[B", line = 51)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)V", line = 66)
