...
public class class497 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gha", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field6967++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(I)V", line = 47)
