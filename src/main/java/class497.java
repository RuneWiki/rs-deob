...
public class class497 extends class369 {
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIIB)I", line = 20)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lmr;Ltf;Ltt;)V", line = 97)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BILlc;)V", line = 118)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IZ)V", line = 128)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZI)V", line = 140)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(III)V", line = 157)
