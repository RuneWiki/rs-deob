...
public class class497 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IZ)Lvb;", line = 4)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Loi;)V", line = 206)
    public class497(class77 arg0) {
    }

    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 181)
