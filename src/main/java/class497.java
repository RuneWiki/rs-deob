...
public class class497 extends class200 implements class143 {
    ...
    @OriginalMember(owner = "client!ip", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ip", name = "f", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ip", name = "g", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BII)V", line = 101)
    ...
    @OriginalMember(owner = "client!ip", name = "finalize", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIIIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lvj;III)V", line = 338)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lvj;IIII)V", line = 353)
