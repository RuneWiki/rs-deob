...
public class class497 extends class179 implements class241 {
    ...
    @OriginalMember(owner = "client!va", name = "g", descriptor = "(I)Ljha;")
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lhl;Z)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
