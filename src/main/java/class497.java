...
public class class497 extends class478 implements class534 {
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "f", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLqa;)V", line = 154)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lqa;I)V", line = 198)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILqa;I)Lka;", line = 225)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)I", line = 238)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(Lqa;B)Lem;", line = 249)
    ...
    @OriginalMember(owner = "client!hg", name = "g", descriptor = "(I)Z", line = 265)
    public static final boolean method2913(int arg0) {
        ++field7178;
        return class92.field1478 != arg0 ? true : class336.field4972.method1442(20845);
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IILqa;)Lka;", line = 280)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lqa;Lku;IIIIIZIIIIIIZ)V", line = 302)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(Z)I", line = 335)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 349)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILqa;)Lnj;", line = 381)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(B)I", line = 408)
    ...
    @OriginalMember(owner = "client!hg", name = "f", descriptor = "(B)I", line = 420)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIILqa;)Z", line = 433)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I)I", line = 457)
    public final int method560(int arg0) {
        ++field7191;
        return arg0 != -29863 ? -68 : this.field7206;
    }

    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(I)Z", line = 469)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lqa;B)V", line = 481)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZZILqa;)Lso;", line = 502)
