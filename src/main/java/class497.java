...
public class class497 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)Lea;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lea;B)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lfr;ILea;)V")
    ...
    @OriginalMember(owner = "client!fr", name = "f", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Lea;B)V")
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(B)Lea;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lfr;B)V")
