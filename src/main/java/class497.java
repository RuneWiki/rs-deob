...
public class class497 extends class80 {
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IILnn;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "()V", line = 364)
    public class497() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(II)[I", line = 75)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(IZ)Lnd;", line = 117)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!ih", name = "e", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(II)[I", line = 369)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(III)I", line = 387)
    ...
    @OriginalMember(owner = "client!ih", name = "f", descriptor = "(I)V", line = 409)
