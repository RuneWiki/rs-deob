...
public class class739 extends class515 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLmia;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZID)Lmia;")
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "()Lef;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "()Lef;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(I)Lmia;")
