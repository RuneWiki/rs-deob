...
public class class739 implements class401 {
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "([BII)[B", line = 26)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)Lio;", line = 41)
    ...
    @OriginalMember(owner = "client!au", name = "c", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Log;Lega;IIIIIII)V", line = 81)
