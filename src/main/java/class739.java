...
public class class739 extends class510 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(IBIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lwk;II[B)V", line = 68)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(ILha;)V", line = 81)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lwk;II[I)V", line = 131)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "([Ljava/lang/Object;[JI)V", line = 146)
