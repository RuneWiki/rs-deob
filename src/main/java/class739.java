...
public class class739 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Lak;", line = 6)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IZIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "([J[IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(ILgga;Lgga;)V", line = 100)
