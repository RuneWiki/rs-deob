...
public class class739 extends class54 {
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lhia;)V")
    public class739(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(ILhia;)V")
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(IILha;Lco;BLsb;)Z")
