...
public class class739 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!oba", name = "toString", descriptor = "()Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ILao;IIBI)V", line = 74)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Z)V", line = 113)
