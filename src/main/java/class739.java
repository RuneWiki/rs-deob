...
public class class739 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIILha;III)V", line = 311)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 330)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "()V", line = 350)
    protected class739() {
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lha;Lmc;I)V", line = 361)
