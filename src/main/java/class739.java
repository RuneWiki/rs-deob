...
public class class739 extends class59 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(CIIIZLaa;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!hd", name = "fa", descriptor = "(CIIIZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([B[IIIIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Llr;Lur;[Lg;[I[I)V", line = 159)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 201)
