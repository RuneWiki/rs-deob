...
public class class739 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Ldc;)V", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(Ldc;)V", line = 33)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "()V", line = 56)
    public class739() {
        this.field10203[0] = 0;
