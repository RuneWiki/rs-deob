...
public class class739 extends class85 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ZIII)I")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IIIIII[B)V")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "([BIII)[B")
