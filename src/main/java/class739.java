...
public class class739 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 6)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(CBI)C", line = 37)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(B)I", line = 121)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Ljava/lang/String;ZZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!mga", name = "toString", descriptor = "()Ljava/lang/String;", line = 1135)
    public final String toString() {
        field10207++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)V", line = 1147)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(II)V", line = 1156)
