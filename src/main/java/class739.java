...
public abstract class class739 extends class168 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lsl;II)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lrba;IIIII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IILnd;I)Ljl;")
