...
public class class739 extends class667 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IBLvr;II)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Leq;BLeq;Leq;Leq;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lud;II)V")
