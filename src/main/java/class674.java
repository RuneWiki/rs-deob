...
public abstract class class674 extends class381 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(II)Z", line = 95)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IZ)I", line = 166)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ILgk;)V", line = 213)
