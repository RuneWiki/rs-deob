...
public class class674 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILdv;J[I)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ldf;IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II)Lbe;", line = 122)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(ILla;Lla;Ljaa;)V", line = 200)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 184)
