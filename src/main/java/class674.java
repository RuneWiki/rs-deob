...
public class class674 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BI)Lwca;")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lbba;B)Lcu;")
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(IILti;)V")
