...
public class class674 extends class392 {
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)I", line = 34)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(ILw;)V", line = 70)
    public class674(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lw;)V", line = 78)
    public class674(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BI)V", line = 83)
