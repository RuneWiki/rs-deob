...
public class class674 extends class427 {
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "([FFIIFIIIFIF)V", line = 21)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(I)V", line = 121)
