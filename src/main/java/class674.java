...
public class class674 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!wq", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(I)V", line = 67)
