...
public class class674 extends class634 {
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 4)
    public class674() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILig;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ee", name = "f", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ee", name = "g", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ee", name = "h", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(BI)[I", line = 125)
