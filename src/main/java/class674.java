...
public class class674 extends class173 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILd;IIZLwm;)[F")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILd;Lwm;IIZD)[I")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ld;Lwm;B)Z")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lmc;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILd;ZLwm;ZZD)[I")
