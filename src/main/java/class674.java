...
public class class674 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)V", line = 491)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 519)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)Lkha;", line = 538)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "()V", line = 559)
    public class674() {
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)Lkha;", line = 562)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILfp;I)Loia;", line = 585)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Llga;)V", line = 609)
    public class674(class711 arg0) {
        this.field9133 = arg0;
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(II)Z", line = 617)
