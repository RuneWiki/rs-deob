...
public class class674 extends class616 implements class13 {
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)Ljr;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lpv;IIIII)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lel;Ljr;Z)V")
