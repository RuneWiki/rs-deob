...
public class class674 extends class418 implements class784 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 68)
    public final boolean method1365(class113 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 74)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 240)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lsca;[I)V", line = 251)
