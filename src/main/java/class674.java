...
public abstract class class674 extends class1 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I[FB)[F", line = 5)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I[Lkb;II)I", line = 21)
    ...
    @OriginalMember(owner = "client!ig", name = "h", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ig", name = "k", descriptor = "(I)V", line = 670)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIILcea;Lcea;)V", line = 690)
