...
public class class674 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IIIIIZIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IIB)V", line = 68)
