...
public class class674 extends class96 {
    ...
    @OriginalMember(owner = "client!ql", name = "t", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ql", name = "n", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!ql", name = "u", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(I)V", line = 85)
    public class674(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "([IZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!ql", name = "v", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "([BIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!ql", name = "k", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!ql", name = "e", descriptor = "(IB)I", line = 175)
    ...
    @OriginalMember(owner = "client!ql", name = "w", descriptor = "(I)V", line = 188)
