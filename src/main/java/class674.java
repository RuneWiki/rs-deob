...
public class class674 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lha;B)Ljd;", line = 8)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BLha;)Ljd;", line = 31)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILha;)Ljd;", line = 57)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BLso;)V", line = 81)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Lha;B)Ljd;", line = 130)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lav;B)V", line = 162)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ZLha;)V", line = 204)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(ILha;)V", line = 230)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II)Ljava/lang/String;", line = 298)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILso;I)V", line = 336)
