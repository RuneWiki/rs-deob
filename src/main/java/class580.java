...
public class class580 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lgh;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lol;II)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BLol;)V")
