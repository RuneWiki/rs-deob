...
public class class580 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)V", line = 208)
    public static void method3380(int arg0) {
        field8461 = null;
        int var1 = -5 / ((2 - arg0) / 33);
    }

    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(I)Lwda;", line = 217)
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)Lwda;", line = 246)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lui;I)V", line = 267)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "()V", line = 279)
    public class580() {
    }

    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lui;)V", line = 282)
