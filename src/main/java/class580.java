...
public class class580 extends class56 {
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "()V", line = 104)
    public class580() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(III)I", line = 40)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILee;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZ)[I", line = 190)
