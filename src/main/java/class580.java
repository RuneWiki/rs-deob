...
public class class580 extends class555 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lkba;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lqq;)V", line = 32)
    public class580(class651 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(III)V", line = 41)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IZIIIZI)V", line = 51)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZZ)V", line = 84)
    public final void method124(boolean arg0, boolean arg1) {
        super.field7580.method3630(86, arg0);
        ++field7923;
    }

    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lot;BI)V", line = 93)
    ...
    @OriginalMember(owner = "client!kfa", name = "f", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!kfa", name = "c", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZI)V", line = 196)
