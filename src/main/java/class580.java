...
public class class580 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILha;II)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIILha;)V")
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lmj;Lbh;)V")
