...
public class class580 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIB)I", line = 24)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 64)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lac;JI)V", line = 86)
