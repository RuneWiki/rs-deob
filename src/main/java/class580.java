...
public class class580 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILkga;)V")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ZBILae;IILlp;)V")
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(I)Lkga;")
