...
public class class580 implements class549 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILkq;)Lkq;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([Lgda;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)Llf;")
    public final class251 method94(int arg0) {
        field7896++;
        return arg0 == 1024 ? class198.field2358 : null;
    }

    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Ljava/lang/String;Lps;Lft;IIIIIIIIII)V")
