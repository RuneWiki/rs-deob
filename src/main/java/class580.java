...
public class class580 extends class669 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBII)V", line = 6)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IF)V", line = 20)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(IIIIIF)V", line = 31)
    public class580(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIZILin;I)V", line = 38)
