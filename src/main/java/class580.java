...
public class class580 extends class45 implements class579 {
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lgf;II[III)V", line = 45)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIII[II)V", line = 59)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ZF)F", line = 82)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIILkp;[BIBII)V", line = 94)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ZZB)V", line = 120)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 130)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lgf;Lkp;II[BII)V", line = 159)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lgf;Lkp;Lvt;II)V", line = 174)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IF)F", line = 186)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(I)I", line = 198)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lgf;Lkp;II[FII)V", line = 209)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(I)Z", line = 222)
