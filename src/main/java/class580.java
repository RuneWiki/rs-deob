...
public class class580 extends Canvas {
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    public class580(Component arg0) {
        this.field8246 = arg0;
    }

    @OriginalMember(owner = "client!iu", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        field8245++;
        this.field8246.update(arg0);
    }

    @OriginalMember(owner = "client!iu", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        field8244++;
        this.field8246.paint(arg0);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lha;ILsca;II)V")
