...
public class class580 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZLoa;Ld;BIILd;ILuc;IIII)Lba;", line = 13)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Leh;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Luc;ILoa;IIII)Lba;", line = 49)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILuc;IIIILoa;)Lba;", line = 61)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILeh;)V", line = 79)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILd;IZLuc;IIILoa;Ld;IBII)Lba;", line = 203)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILjava/lang/String;)I", line = 321)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)I", line = 347)
