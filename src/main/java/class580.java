...
public abstract class class580 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IBII)I", line = 7)
    ...
    @OriginalMember(owner = "client!fi", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 34)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)Ljava/lang/String;", line = 79)
    ...
    @OriginalMember(owner = "client!fi", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 90)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)Z", line = 114)
    public final boolean method3368(int arg0) {
        field8187++;
        return arg0 == 15324 ? class291.method1971("jaclib", 0) : false;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ljava/lang/String;IIZIIII)V", line = 125)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!fi", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 211)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field8215++;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 225)
    ...
    @OriginalMember(owner = "client!fi", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 237)
    public final void windowClosed(WindowEvent arg0) {
        field8214++;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/lang/String;)V", line = 244)
    ...
    @OriginalMember(owner = "client!fi", name = "destroy", descriptor = "()V", line = 269)
    ...
    @OriginalMember(owner = "client!fi", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 297)
    ...
    @OriginalMember(owner = "client!fi", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 313)
    public final void windowActivated(WindowEvent arg0) {
        field8199++;
    }

    @OriginalMember(owner = "client!fi", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 320)
    public static final void provideLoaderApplet(Applet arg0) {
        class535.field7544 = arg0;
        field8191++;
    }

    @OriginalMember(owner = "client!fi", name = "start", descriptor = "()V", line = 328)
    ...
    @OriginalMember(owner = "client!fi", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 344)
    public final void windowIconified(WindowEvent arg0) {
        field8192++;
    }

    @OriginalMember(owner = "client!fi", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 351)
    public final void focusLost(FocusEvent arg0) {
        class405.field5711 = false;
        field8223++;
    }

    @OriginalMember(owner = "client!fi", name = "h", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!fi", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 408)
    public final void windowOpened(WindowEvent arg0) {
        field8208++;
    }

    @OriginalMember(owner = "client!fi", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 415)
    public final void windowDeiconified(WindowEvent arg0) {
        field8189++;
    }

    @OriginalMember(owner = "client!fi", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 425)
    ...
    @OriginalMember(owner = "client!fi", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 441)
    public final void windowDeactivated(WindowEvent arg0) {
        field8209++;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZ)V", line = 448)
    ...
    @OriginalMember(owner = "client!fi", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 526)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(B)Z", line = 543)
    public final boolean method3375(byte arg0) {
        field8203++;
        return arg0 == 119 ? class291.method1971("jagtheora", 0) : true;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Ljava/lang/String;IBIIII)V", line = 554)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)Z", line = 599)
    ...
    @OriginalMember(owner = "client!fi", name = "i", descriptor = "(I)V", line = 611)
    ...
    @OriginalMember(owner = "client!fi", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 663)
    ...
    @OriginalMember(owner = "client!fi", name = "run", descriptor = "()V", line = 672)
    ...
    @OriginalMember(owner = "client!fi", name = "stop", descriptor = "()V", line = 797)
    ...
    @OriginalMember(owner = "client!fi", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 808)
