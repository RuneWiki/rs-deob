...
public class class580 extends class496 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZB[II[I)J", line = 3)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IILjk;Lqa;IIIILaba;Z)Lr;", line = 77)
