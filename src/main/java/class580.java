...
public class class580 extends class6 {
    ...
    @OriginalMember(owner = "client!oo", name = "n", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oo", name = "o", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!oo", name = "f", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZLwba;)V", line = 54)
    ...
    @OriginalMember(owner = "client!oo", name = "d", descriptor = "(IB)I", line = 67)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIIIII)Z", line = 78)
    ...
    @OriginalMember(owner = "client!oo", name = "l", descriptor = "(II)I", line = 96)
    ...
    @OriginalMember(owner = "client!oo", name = "g", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([BIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B[I)V", line = 163)
    ...
    @OriginalMember(owner = "client!oo", name = "p", descriptor = "(B)Z", line = 174)
    ...
    @OriginalMember(owner = "client!oo", name = "e", descriptor = "(BI)V", line = 191)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(I)V", line = 206)
