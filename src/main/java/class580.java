...
public class class580 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!tl", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field7772++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Ljava/awt/Canvas;BLe;)Loa;", line = 38)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lji;Z)Lio;", line = 49)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)V", line = 96)
