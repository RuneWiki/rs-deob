...
public class class580 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(ILud;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Lqw;ZB)V")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(BIIIZ)Lgq;")
