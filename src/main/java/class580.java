...
public class class580 extends class192 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILfd;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(IB)[[I", line = 39)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IB)[I", line = 353)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "()V", line = 603)
    public class580() {
        super(2, false);
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BI)Ljk;", line = 614)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 642)
    ...
    @OriginalMember(owner = "client!pk", name = "e", descriptor = "(B)V", line = 709)
