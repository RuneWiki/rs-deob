...
public class class580 extends class199 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(B[B)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(B[Lis;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lvn;Lmf;IIIIIIIIIIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IZIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lkfa;[III[II)Ldb;", line = 155)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(I)Lkq;", line = 189)
    ...
    @OriginalMember(owner = "client!paa", name = "d", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BLhi;III)V", line = 339)
