...
public class class580 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(II)Lij;", line = 6)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(BI)V", line = 42)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(Lfs;ILlga;)V", line = 101)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)V", line = 87)
