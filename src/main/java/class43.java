...
public class class43 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 7)
    public static void method333(int arg0) {
        field559 = null;
        int var1 = 91 / ((-arg0 - 59) / 38);
    }

    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(I)V", line = 123)
    public class43(int arg0) {
        this.field560 = arg0;
    }

    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(IIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lmn;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)Lmn;", line = 43)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZLvj;ZZ)V", line = 57)
