...
public abstract class class43 extends class443 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIILlq;Llq;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lmk;I)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BI)Llc;")
