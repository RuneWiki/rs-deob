...
public class class43 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Object;Ljava/applet/Applet;B)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BLjava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 25)
