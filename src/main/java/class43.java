...
public class class43 extends class466 {
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 65)
    public class43() {
        this.field647 = System.nanoTime();
        this.field646 = System.nanoTime();
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)J", line = 8)
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "(I)J", line = 19)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)I", line = 92)
