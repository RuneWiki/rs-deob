...
public class class43 extends class400 {
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lii;Loq;[Ltba;[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([B[I[IIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(CIIIZLaa;II)V", line = 87)
    ...
    @OriginalMember(owner = "client!mv", name = "fa", descriptor = "(CIIIZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 218)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([B[IIIIIIII)V", line = 306)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V", line = 362)
