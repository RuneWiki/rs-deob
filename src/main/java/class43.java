...
public class class43 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IBIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIII[Lvg;Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIIIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)I", line = 170)
    ...
    @OriginalMember(owner = "client!bd", name = "d", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!bd", name = "e", descriptor = "(I)Z", line = 201)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 481)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(B)V", line = 503)
    ...
    @OriginalMember(owner = "client!bd", name = "d", descriptor = "(B)V", line = 531)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BZIII)Ltf;", line = 545)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BLac;Z)V", line = 587)
    ...
    @OriginalMember(owner = "client!bd", name = "f", descriptor = "(I)V", line = 658)
    ...
    @OriginalMember(owner = "client!bd", name = "e", descriptor = "(B)Z", line = 686)
    ...
    @OriginalMember(owner = "client!bd", name = "f", descriptor = "(B)V", line = 698)
