...
@OriginalClass("client!PNBDNSXO")
public class class43 extends class23 {

    @OriginalMember(owner = "client!PNBDNSXO", name = "sb", descriptor = "Z")
    private boolean field1176 = true;

    @OriginalMember(owner = "client!PNBDNSXO", name = "rb", descriptor = "I")
    private int field1175;

    @OriginalMember(owner = "client!PNBDNSXO", name = "tb", descriptor = "LBYABUZFP;")
    public class5 field1177;

    @OriginalMember(owner = "client!PNBDNSXO", name = "a", descriptor = "(I)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!PNBDNSXO", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!PNBDNSXO", name = "c", descriptor = "(I)LNJPATAFL;")
