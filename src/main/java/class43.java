...
public class class43 extends class471 implements class103 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII)V", line = 7)
    public final void method434(int arg0, int arg1, int arg2, int arg3) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lt;IIIZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "()V", line = 19)
    public final void method441() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILc;Z)Z", line = 23)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "()[Lpf;", line = 26)
    public final class410[] method444() {
        return this.field493;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "()[Lbu;", line = 41)
    public final class17[] method454() {
        return this.field494;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lmi;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIZ)Lt;", line = 64)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "()Z", line = 69)
    public final boolean method461() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lmi;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!da", name = "finalize", descriptor = "()V", line = 93)
    protected final void finalize() {
        class260.method1672((byte) 50, this);
    }

    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lqa;Lna;Ljq;IIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lqa;)V", line = 175)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILc;)V", line = 183)
