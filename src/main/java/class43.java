...
@OriginalClass("client!NRGHMRLX")
public class class43 {

    @OriginalMember(owner = "client!NRGHMRLX", name = "a", descriptor = "I")
    private int field1175 = 558;

    @OriginalMember(owner = "client!NRGHMRLX", name = "d", descriptor = "I")
    public int field1178 = -1;

    @OriginalMember(owner = "client!NRGHMRLX", name = "f", descriptor = "[I")
    public int[] field1180 = new int[6];

    @OriginalMember(owner = "client!NRGHMRLX", name = "g", descriptor = "[I")
    public int[] field1181 = new int[6];

    @OriginalMember(owner = "client!NRGHMRLX", name = "h", descriptor = "[I")
    public int[] field1182 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!NRGHMRLX", name = "i", descriptor = "Z")
    public boolean field1183 = false;

    @OriginalMember(owner = "client!NRGHMRLX", name = "b", descriptor = "I")
    public static int field1176;

    @OriginalMember(owner = "client!NRGHMRLX", name = "e", descriptor = "[I")
    public int[] field1179;

    @OriginalMember(owner = "client!NRGHMRLX", name = "c", descriptor = "[LNRGHMRLX;")
    public static class43[] field1177;

    @OriginalMember(owner = "client!NRGHMRLX", name = "a", descriptor = "(ILCVNWKEAW;)V")
    ...
    @OriginalMember(owner = "client!NRGHMRLX", name = "a", descriptor = "(BLXOUQUKZW;)V")
    ...
    @OriginalMember(owner = "client!NRGHMRLX", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!NRGHMRLX", name = "b", descriptor = "(I)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!NRGHMRLX", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!NRGHMRLX", name = "c", descriptor = "(I)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!NRGHMRLX", name = "<init>", descriptor = "()V")
    public class43() {
