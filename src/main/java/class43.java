...
public class class43 extends class440 {
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIIIIIB)V", line = 16)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lqg;IIII[BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lqg;IIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BLqa;)V", line = 92)
