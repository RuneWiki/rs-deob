...
public class class43 extends class430 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([III)V", line = 9)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IB)V", line = 164)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(II)V", line = 184)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(IB)V", line = 195)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([BII)I", line = 212)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IIIIF)V", line = 239)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IIII)V", line = 361)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lcj;IIIII)V", line = 375)
