...
public class class43 {
    ...
    @OriginalMember(owner = "client!NEDSEYSI", name = "d", descriptor = "[LNEDSEYSI;")
    public static class43[] field1064;

    @OriginalMember(owner = "client!NEDSEYSI", name = "a", descriptor = "(ILHRXSNEYZ;)V")
    ...
    @OriginalMember(owner = "client!NEDSEYSI", name = "a", descriptor = "(LJHKSAGUC;I)V")
