...
public class class43 extends class401 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Lvv;)V", line = 4)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIILsea;)Lvn;", line = 12)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(III[[ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(SI)V", line = 120)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ILtba;[BB)Lwda;", line = 148)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIIIIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(Lnv;Lida;Ltw;[I)V", line = 358)
