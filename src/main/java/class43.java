...
public class class43 extends class192 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)J", line = 39)
    public final long method458(int arg0) {
        int var2 = -82 % ((77 - arg0) / 35);
        return this.field694;
    }

    @OriginalMember(owner = "client!qh", name = "d", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "()V", line = 103)
    public class43() {
