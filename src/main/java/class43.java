...
@OriginalClass("client!NLSYPUNJ")
public class class43 extends class53 {

    @OriginalMember(owner = "client!NLSYPUNJ", name = "p", descriptor = "Z")
    public boolean field1143 = false;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "s", descriptor = "Z")
    private boolean field1146 = false;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "r", descriptor = "LFPSNPMMW;")
    private class17 field1145;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "l", descriptor = "I")
    public int field1139;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "m", descriptor = "I")
    public int field1140;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "n", descriptor = "I")
    public int field1141;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "o", descriptor = "I")
    public int field1142;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "q", descriptor = "I")
    public int field1144;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "t", descriptor = "I")
    private int field1147;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "u", descriptor = "I")
    private int field1148;

    @OriginalMember(owner = "client!NLSYPUNJ", name = "a", descriptor = "(Z)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!NLSYPUNJ", name = "<init>", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!NLSYPUNJ", name = "a", descriptor = "(II)V")
