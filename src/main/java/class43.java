...
@OriginalClass("client!LLGCDMZG")
public class class43 {

    @OriginalMember(owner = "client!LLGCDMZG", name = "a", descriptor = "I")
    private int field1241 = -39808;

    @OriginalMember(owner = "client!LLGCDMZG", name = "b", descriptor = "Z")
    private boolean field1242 = true;

    @OriginalMember(owner = "client!LLGCDMZG", name = "c", descriptor = "I")
    private int field1243 = 46945;

    @OriginalMember(owner = "client!LLGCDMZG", name = "d", descriptor = "I")
    private int field1244;

    @OriginalMember(owner = "client!LLGCDMZG", name = "e", descriptor = "[LOGKECTLC;")
    private class45[] field1245;

    @OriginalMember(owner = "client!LLGCDMZG", name = "<init>", descriptor = "(BI)V")
    ...
    @OriginalMember(owner = "client!LLGCDMZG", name = "a", descriptor = "(J)LOGKECTLC;")
    ...
    @OriginalMember(owner = "client!LLGCDMZG", name = "a", descriptor = "(LOGKECTLC;BJ)V")
