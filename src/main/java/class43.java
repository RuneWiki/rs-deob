...
public class class43 extends class345 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IILcj;)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILka;III)Lwg;")
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lbi;Llha;)V")
