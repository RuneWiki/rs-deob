...
public abstract class class43 extends class105 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IILdm;Lkr;BIILaa;)V", line = 10)
    ...
    @OriginalMember(owner = "client!gs", name = "e", descriptor = "(B)I", line = 55)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "([Lbh;BII)I", line = 100)
