...
public class class43 extends class471 implements class103 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "()[Lpd;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lii;II)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lii;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "()[Lqc;")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lqa;Lna;Lkq;IIII)V")
