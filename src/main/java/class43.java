...
public class class43 extends class35 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(I)Lso;", line = 151)
