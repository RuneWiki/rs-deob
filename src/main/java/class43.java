...
public class class43 extends class345 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lbo;I)V")
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "()Lnf;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Len;Lfs;IIIII)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLmi;I)V")
    ...
    @OriginalMember(owner = "client!qh", name = "d", descriptor = "()Lnf;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "([ILmi;IIII)V")
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lla;)V")
