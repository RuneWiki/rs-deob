...
@OriginalClass("client!PJCTWSQI")
public class class43 {

    @OriginalMember(owner = "client!PJCTWSQI", name = "a", descriptor = "Z")
    private boolean field1240 = false;

    @OriginalMember(owner = "client!PJCTWSQI", name = "e", descriptor = "I")
    public int field1244 = -1;

    @OriginalMember(owner = "client!PJCTWSQI", name = "g", descriptor = "[I")
    public int[] field1246 = new int[6];

    @OriginalMember(owner = "client!PJCTWSQI", name = "h", descriptor = "[I")
    public int[] field1247 = new int[6];

    @OriginalMember(owner = "client!PJCTWSQI", name = "i", descriptor = "[I")
    public int[] field1248 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!PJCTWSQI", name = "j", descriptor = "Z")
    public boolean field1249 = false;

    @OriginalMember(owner = "client!PJCTWSQI", name = "b", descriptor = "I")
    private static int field1241 = 162;

    @OriginalMember(owner = "client!PJCTWSQI", name = "c", descriptor = "I")
    public static int field1242;

    @OriginalMember(owner = "client!PJCTWSQI", name = "f", descriptor = "[I")
    public int[] field1245;

    @OriginalMember(owner = "client!PJCTWSQI", name = "d", descriptor = "[LPJCTWSQI;")
    public static class43[] field1243;

    @OriginalMember(owner = "client!PJCTWSQI", name = "a", descriptor = "(ILSYUGXMZF;)V")
    ...
    @OriginalMember(owner = "client!PJCTWSQI", name = "a", descriptor = "(LKHOMSBHW;I)V")
    ...
    @OriginalMember(owner = "client!PJCTWSQI", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!PJCTWSQI", name = "a", descriptor = "(B)LGEUHTGZJ;")
    ...
    @OriginalMember(owner = "client!PJCTWSQI", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!PJCTWSQI", name = "b", descriptor = "(Z)LGEUHTGZJ;")
    ...
    @OriginalMember(owner = "client!PJCTWSQI", name = "<init>", descriptor = "()V")
    public class43() {
        if (class1.field4) {
        }
    }
