...
public class class43 extends class159 {
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(IB)V", line = 22)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(Ljava/awt/Canvas;ILd;IB)Lha;", line = 36)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(I)V", line = 48)
