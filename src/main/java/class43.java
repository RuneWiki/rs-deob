...
public abstract class class43 extends class20 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ILkga;III)Leb;", line = 3)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([Lul;I)I", line = 23)
    ...
    @OriginalMember(owner = "client!na", name = "j", descriptor = "(I)Z", line = 189)
    ...
    @OriginalMember(owner = "client!na", name = "d", descriptor = "(B)Z", line = 230)
    ...
    @OriginalMember(owner = "client!na", name = "k", descriptor = "(I)V", line = 241)
    public void method164(int arg0) {
        ++field773;
        int var2 = -30 / ((arg0 - 9) / 43);
    }

    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 257)
