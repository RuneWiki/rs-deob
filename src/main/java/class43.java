...
public class class43 extends class289 {
    ...
    @OriginalMember(owner = "client!ha", name = "l", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ha", name = "l", descriptor = "(II)I", line = 25)
    ...
    @OriginalMember(owner = "client!ha", name = "m", descriptor = "(II)I", line = 52)
    ...
    @OriginalMember(owner = "client!ha", name = "m", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!ha", name = "x", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([BIZI)V", line = 90)
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "(BI)V", line = 114)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(I)V", line = 125)
    public class43(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ha", name = "y", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ha", name = "n", descriptor = "(B)I", line = 164)
