...
public class class43 {
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "([B[LBXNXROZD;IIIIILKYNTOGBR;III)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "(IIIIIIILEGCCHUZS;)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "(IIIIII[B[LBXNXROZD;II)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "([LBXNXROZD;BII[BII)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "([LBXNXROZD;LKYNTOGBR;Z)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "(LEGCCHUZS;LDHNAQSHE;I)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "(LKYNTOGBR;[[[IIIILBXNXROZD;IIIII)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "(ILKYNTOGBR;LBXNXROZD;IIIBII)V")
    ...
    @OriginalMember(owner = "client!LVLPWFEX", name = "a", descriptor = "(ILKYNTOGBR;I[B[LBXNXROZD;I)V")
