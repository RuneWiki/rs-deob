...
public class class43 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)Z", line = 40)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)V", line = 60)
