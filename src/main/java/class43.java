...
public abstract class class43 extends class521 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILza;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIII)Lwk;", line = 32)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIIII)V", line = 95)
