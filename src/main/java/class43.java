...
public class class43 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lmr;I[BI)Lsi;", line = 45)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(CB)V", line = 81)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lvj;I)V", line = 105)
