...
public class class43 extends class329 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILsha;)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lha;I)Lho;")
