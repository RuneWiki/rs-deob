...
public class class43 extends class665 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(JJ)J", line = 38)
    public static long method467(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(I[B)V", line = 56)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(B)V", line = 119)
