...
@OriginalClass("client!ONCZAQCQ")
public class class43 extends class3 {

    @OriginalMember(owner = "client!ONCZAQCQ", name = "qb", descriptor = "Z")
    private boolean field1209 = false;

    @OriginalMember(owner = "client!ONCZAQCQ", name = "rb", descriptor = "B")
    private byte field1210 = 29;

    @OriginalMember(owner = "client!ONCZAQCQ", name = "sb", descriptor = "Z")
    private boolean field1211 = true;

    @OriginalMember(owner = "client!ONCZAQCQ", name = "tb", descriptor = "I")
    private int field1212 = 947;

    @OriginalMember(owner = "client!ONCZAQCQ", name = "ub", descriptor = "LNPWLDXJE;")
    public class37 field1213;

    @OriginalMember(owner = "client!ONCZAQCQ", name = "a", descriptor = "(I)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!ONCZAQCQ", name = "b", descriptor = "(B)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!ONCZAQCQ", name = "a", descriptor = "(Z)Z")
