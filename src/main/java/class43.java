...
public class class43 extends class322 {
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)I", line = 83)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lch;)V", line = 95)
    public class43(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(ILch;)V", line = 98)
    public class43(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!gs", name = "d", descriptor = "(Z)I", line = 153)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BIIIIII)V", line = 165)
