...
public class class43 extends class31 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Luj;Lnj;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Loo;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lnj;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "d", descriptor = "()Loo;")
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "()Loo;")
    public final class31 method226() {
        return (class31) this.field627.method3137(0);
    }

    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(Loo;)V")
