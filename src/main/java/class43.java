...
public class class43 extends class458 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)I", line = 4)
    public final int method227(int arg0) {
        return arg0 == -4915 ? this.field460 : -55;
    }

    @OriginalMember(owner = "client!gp", name = "g", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(I)J", line = 28)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)I", line = 39)
    public final int method230(byte arg0) {
        return arg0 == 54 ? this.field462 : -124;
    }

    @OriginalMember(owner = "client!gp", name = "f", descriptor = "(I)I", line = 51)
