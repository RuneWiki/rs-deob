...
@OriginalClass("client!QGBENKJV")
public class class43 {

    @OriginalMember(owner = "client!QGBENKJV", name = "a", descriptor = "I")
    private int field1019 = -261;

    @OriginalMember(owner = "client!QGBENKJV", name = "b", descriptor = "I")
    private int field1020 = 1;

    @OriginalMember(owner = "client!QGBENKJV", name = "k", descriptor = "[I")
    private int[] field1029 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "l", descriptor = "[I")
    private int[] field1030 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "m", descriptor = "[I")
    private int[] field1031 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "o", descriptor = "I")
    private int field1033 = 100;

    @OriginalMember(owner = "client!QGBENKJV", name = "r", descriptor = "I")
    public int field1036 = 500;

    @OriginalMember(owner = "client!QGBENKJV", name = "w", descriptor = "[I")
    private static int[] field1041 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "x", descriptor = "[I")
    private static int[] field1042 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "y", descriptor = "[I")
    private static int[] field1043 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "z", descriptor = "[I")
    private static int[] field1044 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "A", descriptor = "[I")
    private static int[] field1045 = new int[5];

    @OriginalMember(owner = "client!QGBENKJV", name = "n", descriptor = "I")
    private int field1032;

    @OriginalMember(owner = "client!QGBENKJV", name = "s", descriptor = "I")
    public int field1037;

    @OriginalMember(owner = "client!QGBENKJV", name = "p", descriptor = "LKVKPXLHS;")
    private class28 field1034;

    @OriginalMember(owner = "client!QGBENKJV", name = "c", descriptor = "LRPKBYPNF;")
    private class48 field1021;

    @OriginalMember(owner = "client!QGBENKJV", name = "d", descriptor = "LRPKBYPNF;")
    private class48 field1022;

    @OriginalMember(owner = "client!QGBENKJV", name = "e", descriptor = "LRPKBYPNF;")
    private class48 field1023;

    @OriginalMember(owner = "client!QGBENKJV", name = "f", descriptor = "LRPKBYPNF;")
    private class48 field1024;

    @OriginalMember(owner = "client!QGBENKJV", name = "g", descriptor = "LRPKBYPNF;")
    private class48 field1025;

    @OriginalMember(owner = "client!QGBENKJV", name = "h", descriptor = "LRPKBYPNF;")
    private class48 field1026;

    @OriginalMember(owner = "client!QGBENKJV", name = "i", descriptor = "LRPKBYPNF;")
    private class48 field1027;

    @OriginalMember(owner = "client!QGBENKJV", name = "j", descriptor = "LRPKBYPNF;")
    private class48 field1028;

    @OriginalMember(owner = "client!QGBENKJV", name = "q", descriptor = "LRPKBYPNF;")
    private class48 field1035;

    @OriginalMember(owner = "client!QGBENKJV", name = "t", descriptor = "[I")
    private static int[] field1038;

    @OriginalMember(owner = "client!QGBENKJV", name = "u", descriptor = "[I")
    private static int[] field1039;

    @OriginalMember(owner = "client!QGBENKJV", name = "v", descriptor = "[I")
    private static int[] field1040;

    @OriginalMember(owner = "client!QGBENKJV", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!QGBENKJV", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!QGBENKJV", name = "a", descriptor = "(IBII)I")
    ...
    @OriginalMember(owner = "client!QGBENKJV", name = "a", descriptor = "(LMQZHAILV;I)V")
