...
public class class43 extends class113 implements class231 {
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lqa;IZIILco;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(BLqa;)V", line = 31)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IIIIB[B[BII)V", line = 44)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(BLqa;)V", line = 87)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(BILqa;)Lr;", line = 99)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(ILqa;)Lin;", line = 110)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!kaa", name = "e", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILqa;)V", line = 182)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "([BZI)V", line = 209)
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(B)Z", line = 249)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lqa;I)Lpl;", line = 260)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILqa;IB)Z", line = 272)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(B)I", line = 292)
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)Z", line = 318)
    public final boolean method192(byte arg0) {
        ++field502;
        return arg0 != -41 ? true : this.field516.method2831((byte) 126);
    }

    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lqa;Luh;IIIIIZIII)V", line = 329)
