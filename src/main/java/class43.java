...
public class class43 extends class601 {
    ...
    @OriginalMember(owner = "client!ch", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lmc;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(II)I", line = 81)
    public static final int method260(int arg0, int arg1) {
        ++field487;
        return arg1 <= 73 ? 16 : 127 & arg0;
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IB)[I", line = 98)
