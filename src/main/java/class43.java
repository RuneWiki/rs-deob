...
public class class43 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lff;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([[[Lms;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILff;)Z")
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Luca;)V")
