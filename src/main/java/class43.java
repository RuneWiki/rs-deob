...
public class class43 extends class298 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILen;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIZLii;)Z")
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(Lii;I)Leb;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lii;II)Z")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lii;IIIILnc;Z)V")
    ...
    @OriginalMember(owner = "client!cd", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILii;)V")
