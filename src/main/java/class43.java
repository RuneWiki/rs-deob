...
public class class43 extends class500 implements class559 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILuu;ZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luu;Ltaa;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 23)
    public final void method293(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luu;)V", line = 29)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 87)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luu;Ltaa;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 107)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()V", line = 112)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILuu;)V", line = 129)
    private final void method302(int[] arg0, class303 arg1) {
        this.field670.method4037().method3597(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "f", descriptor = "()[Lkw;", line = 138)
    public final class263[] method308() {
        return this.field667;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILuu;ZII)Z", line = 144)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luu;IZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()Z", line = 189)
    public final boolean method333() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "c", descriptor = "()V", line = 194)
    public final void method337() {
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lgfa;IIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;)V", line = 268)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lcba;", line = 276)
