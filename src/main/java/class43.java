...
public class class43 extends class710 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lcea;BI[I)V", line = 28)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Luu;Lrf;)V", line = 125)
    public class43(class237 arg0, class754 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BZ)V", line = 129)
