...
public class class43 extends class161 {
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!sh", name = "e", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IILjd;IIBI)V", line = 287)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIB)V", line = 300)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Z)V", line = 315)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 342)
    public class43() {
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(S)V", line = 348)
