...
public class class43 extends class58 {
    ...
    @OriginalMember(owner = "client!PASMQFXV", name = "Rb", descriptor = "LHGKRJZKS;")
    ...
    @OriginalMember(owner = "client!PASMQFXV", name = "Fb", descriptor = "LLPTCUHOU;")
    public class36 field1110;

    @OriginalMember(owner = "client!PASMQFXV", name = "Lb", descriptor = "LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!PASMQFXV", name = "a", descriptor = "(I)LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!PASMQFXV", name = "a", descriptor = "(ILGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!PASMQFXV", name = "b", descriptor = "(I)LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!PASMQFXV", name = "c", descriptor = "(I)LVHYCWIPJ;")
