...
public class class43 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILria;)Z")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)[Log;")
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(I)Lkv;")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ltb;Z)Lqd;")
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lvd;Lvd;)V")
