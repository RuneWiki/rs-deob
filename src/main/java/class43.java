...
public class class43 extends class14 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IB)[I", line = 14)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IBLmd;)V", line = 74)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "()V", line = 115)
    public class43() {
        super(3, false);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)[[I", line = 124)
