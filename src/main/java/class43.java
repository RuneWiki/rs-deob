...
public class class43 {
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I[B)Lue;", line = 18)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IB)[B", line = 118)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I[B)V", line = 178)
