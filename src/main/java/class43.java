...
public class class43 {
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(ILjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!pja", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
