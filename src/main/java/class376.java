...
public class class376 extends class446 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lkh;I)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Luo;BI)Z")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IILkh;)V")
