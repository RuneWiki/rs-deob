...
public class class376 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;B)V")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;Ljava/applet/Applet;Z)Ljava/lang/Object;")
