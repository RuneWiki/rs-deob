...
public class class376 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IILbk;)V", line = 42)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILbk;)V", line = 275)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)V", line = 313)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIIII)V", line = 354)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIII)V", line = 398)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(II)Z", line = 418)
