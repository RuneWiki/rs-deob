...
public class class376 extends class266 {
    ...
    @OriginalMember(owner = "client!vba", name = "d", descriptor = "(Loa;I)Lcd;")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IILoa;I)Z")
