...
public class class376 extends class61 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!om", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Laha;Ljl;[Lhb;[I[I)V")
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
