...
public class class376 extends class260 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lgs;Z[[[BIB)Z", line = 27)
    ...
    @OriginalMember(owner = "client!fha", name = "d", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(III)I", line = 124)
