...
public class class376 extends class11 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lsi;II)V")
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(III)Lid;")
    ...
    @OriginalMember(owner = "client!vi", name = "f", descriptor = "(I)Lhj;")
