...
public class class376 extends class157 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lvd;)V", line = 3)
    public final void method557(class4 arg0) {
        this.field2366.method207(arg0);
    }

    @OriginalMember(owner = "client!dc", name = "b", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)V", line = 21)
    public final void method556(boolean arg0) {
        this.field2366.method145(8448, 7681);
    }

    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "()Z", line = 46)
    public final boolean method555() {
        return true;
    }

    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lhd;)V", line = 56)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 54)
