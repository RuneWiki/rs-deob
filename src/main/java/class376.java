...
public class class376 extends class577 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IBB)V", line = 4)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIII)[B", line = 22)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)Ljava/lang/String;", line = 35)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 55)
    public class376() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!up", name = "d", descriptor = "(B)V", line = 67)
