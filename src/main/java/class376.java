...
public class class376 implements class420 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 162)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IZ)I", line = 50)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IBLjava/awt/Component;Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I[I)V", line = 186)
