...
public class class376 extends class323 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILxa;BIIILfa;Lrr;)V", line = 10)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lpfa;Lpfa;Lio;)V", line = 55)
    public class376(class275 arg0, class275 arg1, class406 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZBII)V", line = 82)
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIZZ)V", line = 109)
