...
public class class376 extends class747 {
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "()V", line = 77)
    public class376() {
        super(1, true);
    }
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Ldc;II)V", line = 141)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lmfa;B)I", line = 185)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(III)Lpn;", line = 214)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(I)V", line = 225)
