...
public class class376 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "([BZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!bga", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(II)[B", line = 94)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(B)V", line = 152)
