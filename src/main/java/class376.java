...
public abstract class class376 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BC)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)Lkj;", line = 84)
