...
public class class376 {
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lbt;)V", line = 89)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "([SI[Ljava/lang/String;)V", line = 11)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IBIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLqa;Lci;)V", line = 68)
