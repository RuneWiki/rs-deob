...
public class class376 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ZI)Ljm;")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIIIIIIIIILnea;)Z")
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lgn;ILvo;Lvo;)V")
