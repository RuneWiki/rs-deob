...
public class class376 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)Lvk;", line = 29)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lf;B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 171)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lrfa;B)V", line = 72)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILs;)V", line = 93)
    public static final void method2979(int arg0, class751 arg1) {
        class107.field1413[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILrfa;)V", line = 102)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLjia;)V", line = 125)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIII)V", line = 147)
