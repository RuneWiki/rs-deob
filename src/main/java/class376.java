...
public class class376 extends class270 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "e", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 26)
    public class376() {
        super(1, false);
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BI)[I", line = 29)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLec;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZI)[[I", line = 113)
