...
public class class376 extends class214 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Llk;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "()V", line = 19)
    public class376() {
        super(3, false);
    }

    @OriginalMember(owner = "client!le", name = "c", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)I", line = 55)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IB)[[I", line = 179)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BI)[I", line = 257)
