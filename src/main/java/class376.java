...
public class class376 extends class133 {
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "()Lvb;", line = 17)
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "()Lvb;", line = 286)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "()I", line = 309)
    public final int method594() {
        field5096++;
        return 0;
    }

    @OriginalMember(owner = "client!bf", name = "b", descriptor = "([III)V", line = 319)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IBII)I", line = 359)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)V", line = 384)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILig;[IIII)V", line = 417)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lig;II)V", line = 480)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIILza;)V", line = 517)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIII)V", line = 977)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lqm;)V", line = 1018)
    public class376(class98 arg0) {
        this.field5093 = arg0;
    }

    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(I)V", line = 1026)
