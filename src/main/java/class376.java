...
public class class376 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IB)Lrl;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "([[[Lcq;I)V")
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Ler;ILjn;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
