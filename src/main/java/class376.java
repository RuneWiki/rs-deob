...
public class class376 extends class657 {
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lwga;)V", line = 9)
    ...
    @OriginalMember(owner = "client!bk", name = "e", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILdu;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I[[[Les;IIIZ)Z", line = 246)
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(B)V", line = 565)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lcea;ILjava/lang/String;)I", line = 577)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZB)V", line = 608)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(III)V", line = 627)
