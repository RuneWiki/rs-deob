...
public class class376 extends class397 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lhe;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZI[Lts;IB)V", line = 14)
    ...
    @OriginalMember(owner = "client!ug", name = "e", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "()V", line = 71)
    public class376() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZI)Z", line = 74)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IBLae;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIZ)Z", line = 203)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(II)Z", line = 227)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lis;Lhg;)V", line = 246)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(II)[I", line = 1368)
