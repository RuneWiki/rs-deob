...
public class class376 extends class264 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIIIIIIIIIIIBI)V", line = 10)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(I)V", line = 316)
    public class376(int arg0) {
        this.field5483 = arg0;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lat;I)Lch;", line = 115)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)Ljava/lang/String;", line = 171)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIZIZIBLat;IIII)V", line = 183)
