...
public class class376 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZLmc;)V")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lmc;IB)V")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lhd;Z)Z")
