...
public class class376 extends class243 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lf;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!om", name = "e", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILji;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILf;ZI)V", line = 88)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "()V", line = 148)
    public class376() {
        super(0, false);
    }

    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)[[I", line = 151)
