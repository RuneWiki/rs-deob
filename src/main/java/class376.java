...
public class class376 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IBZIZ)Lph;", line = 190)
