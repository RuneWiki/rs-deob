...
public class class376 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)V", line = 35)
