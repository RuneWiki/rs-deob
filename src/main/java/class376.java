...
public class class376 extends class217 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lej;II[B)V", line = 134)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lej;II[I)V", line = 147)
