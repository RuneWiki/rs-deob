...
public class class376 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IB)Lha;", line = 7)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 154)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIJIIBIZLjava/lang/String;Ljava/lang/String;Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BB)C", line = 117)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)V", line = 174)
