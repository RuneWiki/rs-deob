...
public class class376 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)Lc;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "([Ldf;II)V")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lto;IZLla;Lla;)V")
