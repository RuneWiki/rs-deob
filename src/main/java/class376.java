...
public class class376 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Ljava/lang/String;CI)I", line = 16)
    ...
    @OriginalMember(owner = "client!dg", name = "toString", descriptor = "()Ljava/lang/String;", line = 43)
    public final String toString() {
        field5356++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;BLjava/lang/String;Ljava/lang/String;)V", line = 62)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(II)V", line = 89)
