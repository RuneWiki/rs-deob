...
public class class376 extends class664 implements class595 {
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lmc;Lnl;II[FII)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lmc;II[III)V", line = 19)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IF)F", line = 32)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lmc;Lnl;Leea;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(FI)F", line = 69)
    ...
    @OriginalMember(owner = "client!pd", name = "h", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ZBZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lmc;Lnl;II[BII)V", line = 109)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIII[IIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lnl;IB[BIIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)Z", line = 184)
