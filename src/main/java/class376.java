...
public abstract class class376 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "([BLtia;IB)Lwja;", line = 14)
    ...
    @OriginalMember(owner = "client!bga", name = "d", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!bga", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "([BII)V", line = 129)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lvf;I[BIZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lvf;ILjaclib/memory/Buffer;IZ)V", line = 173)
