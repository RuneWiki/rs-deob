...
public class class376 extends class499 {
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lsu;)V")
    public class376(class139 arg0) {
        this.field5099 = arg0;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)Ljv;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZILtk;Lqa;Lfh;I)Z")
