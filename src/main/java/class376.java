...
public class class376 extends class658 {
    ...
    @OriginalMember(owner = "client!fga", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "([BI)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lae;Lvj;)V", line = 58)
    public class376(class283 arg0, class229 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IZ)V", line = 41)
