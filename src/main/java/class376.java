...
public class class376 extends class488 {
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lqg;Lds;[Ldt;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ac", name = "B", descriptor = "(CIIIZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(CIIIZLea;II)V", line = 231)
