...
public class class376 extends class430 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIB)Lin;")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BLvj;)Lsi;")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)Lsia;")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(ILhca;Lhca;Lfd;Lwm;I[BIZ)V")
