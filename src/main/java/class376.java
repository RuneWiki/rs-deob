...
public class class376 {
    ...
    @OriginalMember(owner = "client!fs", name = "finalize", descriptor = "()V", line = 4)
    protected final void finalize() throws Throwable {
        this.field5190.method361(this.field5188);
        super.finalize();
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lfu;ILjava/lang/String;)Lfs;", line = 11)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lfu;II)V", line = 48)
