...
public class class376 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(CI)B", line = 8)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZLia;)V", line = 136)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILia;B)V", line = 157)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 183)
