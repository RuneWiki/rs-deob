...
public class class376 extends class40 {
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 87)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IILlf;)V", line = 99)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 112)
    public class376() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)[[I", line = 115)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIBIIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BI)[I", line = 374)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Z[Ljava/lang/String;[S)V", line = 407)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILpn;ILbi;ZLfa;II)V", line = 420)
