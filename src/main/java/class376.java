...
public class class376 extends class670 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IBII)I")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(JLha;Z)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(CIB)I")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lha;BZJI)V")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lha;Lde;Lur;J)V")
