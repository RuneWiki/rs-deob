...
public class class376 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "([Ljava/lang/String;III)Ljava/lang/String;", line = 27)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 93)
