...
public abstract class class376 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IILeq;IZ)Lmba;", line = 17)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIFIF[FIII[FBIIF)V", line = 63)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIILha;IIZLjava/lang/String;)V", line = 151)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(III)Z", line = 198)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 215)
