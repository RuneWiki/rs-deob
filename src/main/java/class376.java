...
public class class376 extends class130 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IB)V", line = 67)
