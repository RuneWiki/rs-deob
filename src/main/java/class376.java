...
public class class376 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)Ljd;")
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(II)Lhca;")
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Ljc;ILgp;Lgp;)V")
