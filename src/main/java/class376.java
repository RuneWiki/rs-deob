...
public class class376 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)Lbd;")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "([[BZLjda;)V")
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lqg;ILvd;)V")
