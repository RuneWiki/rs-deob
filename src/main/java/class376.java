...
public class class376 extends class682 implements class52 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ltg;[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Ll;Lm;II[[I[[IIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III[[ZZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIIIIII[[Z)V", line = 194)
