...
public class class376 extends class167 {
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Lmh;)V")
    ...
    @OriginalMember(owner = "client!lv", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(ZLrr;ILrr;)V")
