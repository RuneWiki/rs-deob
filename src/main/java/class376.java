...
public class class376 extends class361 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;B)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BLwm;I)V")
