...
public class class195 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "()V", line = 10)
    public final void method1224() {
        this.field2799.field4741.glEndList();
    }

    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lih;I)V", line = 12)
    public class195(class330 arg0, int arg1) {
        this.field2799 = arg0;
        this.field2798 = this.field2799.field4741.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(C)V", line = 21)
