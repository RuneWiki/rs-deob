...
public class class195 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "()I", line = 7)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "()[F", line = 14)
    public final float[] method1360() {
        return this.field2899[this.method1359()];
    }

    @OriginalMember(owner = "client!hc", name = "c", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(II)I", line = 159)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "()V", line = 165)
    public class195() {
