...
public class class195 extends class184 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Luo;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IILuo;I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZLuo;)Laj;", line = 111)
    ...
    @OriginalMember(owner = "client!rq", name = "e", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!rq", name = "e", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II[Lms;)V", line = 232)
