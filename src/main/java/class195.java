...
public class class195 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIZI)Z", line = 39)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "([BI)V", line = 86)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "([BI)V", line = 270)
