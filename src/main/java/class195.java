...
public class class195 {
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLwp;)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)V", line = 54)
