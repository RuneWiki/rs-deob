...
public class class195 extends class42 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BI)Z", line = 18)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lmd;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(II)V", line = 84)
    public class195(int arg0, int arg1) {
        this.field2717 = arg0;
        this.field2718 = arg1;
    }

    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(B)V", line = 94)
