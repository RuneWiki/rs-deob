...
public class class195 extends class145 {
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZI)[[I", line = 115)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lap;BI)V", line = 157)
