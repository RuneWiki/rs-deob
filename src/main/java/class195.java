...
public class class195 extends class82 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(II)[I", line = 22)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[I[ILbda;II)Ldea;", line = 159)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 341)
    public class195() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)Z", line = 228)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILos;)V", line = 269)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)V", line = 329)
