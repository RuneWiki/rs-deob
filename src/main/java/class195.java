...
public class class195 extends class271 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILjava/lang/String;)I", line = 110)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(II)I", line = 137)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)V", line = 164)
