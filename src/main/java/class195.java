...
public class class195 {
    ...
    @OriginalMember(owner = "client!vb", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field2277.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!vb", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
