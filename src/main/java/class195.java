...
public class class195 extends class413 {
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ZI)I", line = 18)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 103)
    public class195() {
        this.field3163 = System.nanoTime();
        this.field3164 = System.nanoTime();
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)J", line = 64)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)J", line = 95)
