...
public class class195 extends class518 {
    ...
    @OriginalMember(owner = "client!we", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "()V", line = 13)
    public class195() {
        super(3, false);
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IZIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(II)I", line = 70)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II)[[I", line = 83)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILjc;I)V", line = 164)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(II)Z", line = 179)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II)[I", line = 195)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IBI)Z", line = 246)
