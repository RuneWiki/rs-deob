...
public class class195 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IIILjava/lang/Class;)Lwga;")
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(II)Lgd;")
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Liv;ILcb;Lcb;)V")
