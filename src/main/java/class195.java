...
public class class195 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IB)V", line = 28)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(II)Lic;", line = 58)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BI)Lmk;", line = 82)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lal;ILnd;Lnd;Lnd;)V", line = 147)
