...
public class class195 extends class251 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILtq;)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!wt", name = "f", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILqq;)V", line = 116)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(BI)Z", line = 173)
