...
public class class195 extends class401 implements class200 {
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 35)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ll;Ljava/awt/Canvas;)V", line = 55)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 80)
