...
public class class195 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)Lce;", line = 21)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ldk;ILfc;Lfc;)V", line = 113)
