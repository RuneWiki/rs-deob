...
public class class195 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BI)Lgn;", line = 24)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIIILha;Lqha;I)Lnf;", line = 103)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BLkh;)Ljava/lang/String;", line = 144)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(II)V", line = 211)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ZZIILda;Lha;Lqha;ILha;BII)Lnf;", line = 230)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lim;IZLhu;Lgj;Lgj;)V", line = 362)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IZ)V", line = 336)
