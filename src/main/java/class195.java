...
public class class195 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IB)Lcj;")
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)Lem;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BIIIIII)Lmf;")
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lsaa;ILfp;)V")
