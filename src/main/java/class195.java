...
public class class195 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lvba;Lvba;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILrt;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILrt;)V", line = 143)
