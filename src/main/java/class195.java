...
public class class195 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)Ltm;")
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lns;)V")
