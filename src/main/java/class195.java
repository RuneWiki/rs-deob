...
public class class195 extends class424 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I[B)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 130)
    public class195() {
    }

    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(I)V", line = 132)
