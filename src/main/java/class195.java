...
public class class195 extends class263 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIB)B", line = 6)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILgo;IB)V", line = 37)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(IB)[[I", line = 70)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZLgk;)V", line = 162)
    ...
    @OriginalMember(owner = "client!js", name = "d", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IB)[I", line = 208)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "()V", line = 258)
    public class195() {
        super(3, false);
    }
}
