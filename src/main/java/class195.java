...
public class class195 extends class440 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BFFIF)F", line = 4)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILmo;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIZIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "()V", line = 87)
    public class195() {
        this(4096);
    }

    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BILpu;)Lf;", line = 90)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI)[I", line = 113)
