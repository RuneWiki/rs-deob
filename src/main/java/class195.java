...
public class class195 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "([BIBI)Z", line = 33)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIBII)I", line = 61)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BI)[B", line = 78)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(ILbda;Lbda;I)V", line = 319)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "([BIBIZ)Z", line = 176)
    ...
    @OriginalMember(owner = "client!pk", name = "toString", descriptor = "()Ljava/lang/String;", line = 305)
