...
public class class195 extends class206 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(II[B)I", line = 18)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "()V", line = 31)
    public class195() {
    }

    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(J)V", line = 39)
