...
public abstract class class195 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I[Lth;Lfp;[BZIIIIZ)[I", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 439)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lbf;)V", line = 453)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)V", line = 505)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IBIIII)V", line = 536)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILkg;I)I", line = 627)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IILwc;I)V", line = 644)
