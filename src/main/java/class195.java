...
public class class195 extends class512 {
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 3)
    public class195() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IB)[I", line = 33)
    ...
    @OriginalMember(owner = "client!rk", name = "d", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(III)Z", line = 267)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZILia;)V", line = 292)
