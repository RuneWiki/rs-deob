...
public class class195 extends class10 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIILjava/lang/String;III)V", line = 8)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)[Lbe;", line = 35)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lya;ILdt;BIILrp;Lgp;)V", line = 47)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lug;II[B)V", line = 92)
