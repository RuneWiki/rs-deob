...
public class class195 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 86)
