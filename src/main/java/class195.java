...
public class class195 implements class530 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IILvw;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vda", name = "finalize", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lhfa;III)V", line = 45)
    public final void method1268(class331 arg0, int arg1, int arg2, int arg3) {
        field2330++;
        this.method1280(arg1, arg3, arg2, arg0, false);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lld;III)V", line = 76)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II)V", line = 122)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(CII)C", line = 138)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IILld;)V", line = 219)
    public final void method1274(int arg0, int arg1, class182 arg2) {
        field2333++;
        this.method1270(arg2, 5540, arg1, arg0);
    }

    @OriginalMember(owner = "client!vda", name = "e", descriptor = "(I)I", line = 227)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(B)Z", line = 247)
    ...
    @OriginalMember(owner = "client!vda", name = "d", descriptor = "(B)V", line = 267)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(II)V", line = 281)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIILhfa;Z)V", line = 310)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)V", line = 346)
    ...
    @OriginalMember(owner = "client!vda", name = "d", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lpc;)V", line = 420)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(I)V", line = 386)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(II)V", line = 399)
