...
public class class195 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lba;III[Z)Z")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILmg;Lmg;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IZ)Lfo;")
