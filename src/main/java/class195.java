...
public class class195 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lsl;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILsl;I)V", line = 51)
