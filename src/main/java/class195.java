...
public class class195 extends class338 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lup;", line = 6)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 57)
    public class195() {
    }

    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 65)
