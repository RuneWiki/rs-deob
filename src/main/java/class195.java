...
public class class195 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILwe;)V")
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(ILwe;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/Object;Lwe;II)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lrd;B)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILat;II)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/lang/Object;Lwe;)V")
