...
public abstract class class195 implements class232 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lge;IIIZ)V")
