...
public class class195 extends class17 {
    ...
    @OriginalMember(owner = "client!sb", name = "h", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "()V", line = 30)
    public class195() {
        this(4096);
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(II)[I", line = 113)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lwm;II)V", line = 137)
