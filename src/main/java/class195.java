...
public class class195 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(F)F", line = 5)
    private static final float method1389(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Llf;Ldl;)V", line = 12)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IF)I", line = 77)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "()V", line = 143)
    public static void method1392() {
        field2807 = null;
        field2809 = null;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIF)F", line = 150)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(IIF)F", line = 166)
