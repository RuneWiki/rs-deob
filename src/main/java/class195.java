...
public class class195 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILvb;Lr;ILww;I)Z")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZI)Ldf;")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lrf;ILpl;)V")
