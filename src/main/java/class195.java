...
public abstract class class195 extends class281 {
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "(B)V", line = 416)
