...
public class class195 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIII)Lvj;")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IB)Lbd;")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILoa;I)Z")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lpca;IZLbi;Lbi;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
