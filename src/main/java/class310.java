...
public class class310 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLtq;)V", line = 131)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 147)
