...
public abstract class class310 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[Lo;[ILjava/lang/String;IIILta;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[II[Lo;IILjava/lang/String;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 193)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(ILjava/lang/String;IIII)V", line = 217)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;IBII)V", line = 232)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IZII)V", line = 260)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IBIII)V", line = 276)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 336)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;IZIIII[Lo;IILjava/util/Random;[I[I)I", line = 369)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ZI[Lo;Ljava/lang/String;I[IIILjava/util/Random;I)I", line = 457)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 491)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lta;IIIII[Lo;I[IIIILjava/lang/String;III)I", line = 535)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILta;Ljava/lang/String;[IBIIIII[Lo;II)I", line = 546)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;[I[I[Lo;IZ[I)V", line = 652)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lza;Lap;)V", line = 816)
    public class310(class299 arg0, class29 arg1) {
        this.field4731 = arg1;
        this.field4726 = arg0;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 829)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B)V", line = 907)
