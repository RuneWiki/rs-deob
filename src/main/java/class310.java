...
public class class310 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Z)I", line = 21)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "()V", line = 51)
    public class310() {
    }

    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lgw;)V", line = 79)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBI)I", line = 104)
