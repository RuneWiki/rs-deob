...
public class class310 extends class311 {
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vc", name = "d", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!vc", name = "e", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(II)Z", line = 60)
    ...
    @OriginalMember(owner = "client!vc", name = "f", descriptor = "(I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!vc", name = "g", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(II)V", line = 122)
