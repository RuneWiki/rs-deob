...
public class class310 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 68)
