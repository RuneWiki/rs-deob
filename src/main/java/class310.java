...
public class class310 extends class116 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(FFFFFFLpa;II)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILpa;II)V")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lnd;IIZ)V")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lnd;II[III)V")
