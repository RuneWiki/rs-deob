...
public class class310 extends class83 {
    ...
    @OriginalMember(owner = "client!wi", name = "f", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)[B", line = 15)
    ...
    @OriginalMember(owner = "client!wi", name = "e", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIB)I", line = 56)
