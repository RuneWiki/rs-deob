...
public class class310 implements Runnable {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILro;[BB)Lmu;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILro;I)Lmu;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILmu;)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IILro;)Lmu;")
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lor;)V")
