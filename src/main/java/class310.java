...
public class class310 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILsv;Ljava/lang/Object;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIIZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/Object;BLsv;)V", line = 116)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)V", line = 126)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIZII)Lcf;", line = 177)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BLcb;)V", line = 221)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BLsv;)Ljava/lang/Object;", line = 240)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILsv;)V", line = 292)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(B)V", line = 317)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(I)I", line = 335)
