...
public class class310 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Los;B)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ldn;I)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lhe;B)Z")
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Los;)V")
