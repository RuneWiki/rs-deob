...
public abstract class class310 {
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(BJ)I", line = 6)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IIBII[III)Z", line = 39)
