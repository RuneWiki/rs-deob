...
public class class310 {
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!bg", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lwi;", line = 490)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(II)V", line = 506)
