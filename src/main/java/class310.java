...
public class class310 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILmd;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BLmd;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIILgv;Lgv;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILtk;IILqa;Lfh;Ldf;)V")
