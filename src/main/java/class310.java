...
public class class310 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILrt;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lrt;B)V", line = 70)
