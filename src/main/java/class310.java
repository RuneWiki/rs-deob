...
public class class310 extends class113 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIIIIBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I[B)Ltd;", line = 182)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)V", line = 234)
