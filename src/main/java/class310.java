...
public class class310 extends class324 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIILjava/lang/Class;)Lsa;")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lsa;Z)Z")
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lgl;Ljava/lang/Object;)V")
