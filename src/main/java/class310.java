...
public class class310 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZLjava/lang/String;Lhia;Lda;BLha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z)[Lhc;", line = 101)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IB)Z", line = 189)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BII)Z", line = 203)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILs;)V", line = 218)
