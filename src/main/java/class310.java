...
public class class310 {
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lse;)V", line = 361)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "()Z", line = 116)
    private final boolean method2047() {
        return this.field4584.method1909() == this.field4585;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lnm;)V", line = 126)
    public final void method2048(class61 arg0) {
        this.method2053(arg0, true);
    }

    @OriginalMember(owner = "client!sp", name = "b", descriptor = "()V", line = 129)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(Lnm;)Z", line = 210)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "()V", line = 235)
    ...
    @OriginalMember(owner = "client!sp", name = "d", descriptor = "()V", line = 263)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lnm;Z)V", line = 320)
