...
public class class310 extends class210 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 15)
    public class310() {
        super(0, false);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)[[I", line = 20)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!pr", name = "g", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IILat;)V", line = 156)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)I", line = 169)
