...
public class class310 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)Lps;", line = 8)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILgk;[Lgo;)Lss;", line = 42)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lgt;ILdn;)V", line = 127)
