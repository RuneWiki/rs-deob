...
public class class310 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IBLrl;[I[II)Lqn;", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)I", line = 70)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)Lpn;", line = 115)
