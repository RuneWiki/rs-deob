...
public class class310 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILlk;)V", line = 47)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)I", line = 68)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 88)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(II)V", line = 112)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(II)Z", line = 133)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILlk;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(I)V", line = 282)
