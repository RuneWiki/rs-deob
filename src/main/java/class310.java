...
public class class310 extends class412 {
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lap;II)V")
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lap;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lap;IIZ[[I)V")
