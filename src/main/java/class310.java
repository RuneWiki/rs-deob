...
public class class310 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(ILho;Lho;I)V", line = 471)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)[B", line = 32)
    ...
    @OriginalMember(owner = "client!cr", name = "toString", descriptor = "()Ljava/lang/String;", line = 117)
    public final String toString() {
        field3888++;
        return "Cache:" + this.field3880;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(III[B)Z", line = 125)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIZILuaa;)V", line = 158)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ZII[BB)Z", line = 243)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([BI)Lfba;", line = 362)
