...
public class class310 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZLbe;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(III)Z", line = 83)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)V", line = 122)
