...
public class class310 {
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(B)Lsga;")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BLsga;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)Lsga;")
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)Lsga;")
    ...
    @OriginalMember(owner = "client!eo", name = "d", descriptor = "(I)Lsga;")
