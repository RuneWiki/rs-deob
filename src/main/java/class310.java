...
public class class310 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BB)V", line = 19)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 60)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILmg;IB)Ldq;", line = 71)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZI)Ltt;", line = 92)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(B)Lcd;", line = 125)
