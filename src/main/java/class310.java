...
public class class310 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(I)Ltq;")
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)Ltq;")
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lmp;)V")
