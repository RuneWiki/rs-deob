...
public abstract class class310 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIIIZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I[Ljava/lang/String;[S)V", line = 39)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII)I", line = 52)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I[I[I[ILcl;)V", line = 117)
