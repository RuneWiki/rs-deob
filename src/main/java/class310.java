...
public class class310 extends class483 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILcr;)V")
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Ldga;B)V")
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lcr;)V")
