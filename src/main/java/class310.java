...
public class class310 extends class751 implements class65 {
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 240)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 25)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 73)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 235)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lta;[I)V", line = 251)
