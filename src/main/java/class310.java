...
public class class310 extends class635 {
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(B)I", line = 9)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IBI)Lfm;", line = 20)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(B)V", line = 285)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(ILdca;Ldca;Lmo;Lqh;I[BIZ)V", line = 859)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(JB)V", line = 306)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(I)V", line = 319)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)I", line = 501)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IZ)[B", line = 525)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Leg;Lgda;Lgda;BLgda;Leca;)Z", line = 543)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(Z)V", line = 570)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IB)V", line = 618)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)Lia;", line = 648)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II)I", line = 760)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)V", line = 776)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)I", line = 795)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)I", line = 814)
