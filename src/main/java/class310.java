...
public class class310 extends class260 {
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IB)I", line = 39)
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(ILfca;)V", line = 49)
    public class310(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(Lfca;)V", line = 101)
    public class310(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tha", name = "c", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(Z)V", line = 120)
