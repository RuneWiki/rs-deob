...
public class class310 extends class194 {
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "()V", line = 8)
    public class310() {
        super(0, true);
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!en", name = "f", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IZLuo;I[[I)V", line = 105)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IILaq;B)V", line = 182)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIILqc;Lqc;)V", line = 206)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(B)V", line = 215)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(Z)Z", line = 231)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(CB)Z", line = 246)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IILbg;)V", line = 282)
