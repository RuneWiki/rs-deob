...
public class class310 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IB)I", line = 14)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(IB)V", line = 71)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLii;)V", line = 88)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIIILps;III)V", line = 536)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)V", line = 604)
    ...
    @OriginalMember(owner = "client!so", name = "c", descriptor = "(IB)V", line = 614)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)Lrk;", line = 627)
