...
public class class727 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lwh;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lwh;I)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lnba;I)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Ltq;II)V")
