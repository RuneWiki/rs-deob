...
public class class727 extends class381 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lha;II)Z")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lgj;I)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(ILha;)Lid;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IILha;I)Z")
