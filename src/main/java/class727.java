...
public class class727 implements class331 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IILoh;IZ)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIILwi;)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IILwi;)V")
    public final void method4033(int arg0, int arg1, class504 arg2) {
        field10136++;
        this.method4030(arg0, 4074, arg1, arg2);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lra;II)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Loh;III)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Llea;)V")
