...
public class class727 extends class793 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sfa", name = "e", descriptor = "()V", line = 26)
    public static void method5278() {
        field10654 = null;
    }

    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Ltga;I)V", line = 28)
