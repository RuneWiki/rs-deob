...
public abstract class class727 extends class230 {
    ...
    @OriginalMember(owner = "client!bq", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lha;B)Z")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z[Lsca;)I")
