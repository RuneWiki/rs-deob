...
public class class727 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljava/awt/Component;Z)Lpg;", line = 54)
