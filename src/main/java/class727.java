...
public class class727 extends Canvas {
    ...
    @OriginalMember(owner = "client!dq", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!dq", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        this.field9992.update(arg0);
        field9983++;
    }

    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
