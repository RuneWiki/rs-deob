...
public class class727 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(II[I)Lut;", line = 4)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(I[III)Lut;", line = 40)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(B[II)Lut;", line = 97)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ILog;IIIIIIILega;II)V", line = 118)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ILge;IILjava/awt/Component;)Lvn;", line = 145)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "([IIZI)Lut;", line = 227)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ILrg;)Lmm;", line = 274)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lvd;Lvd;)V", line = 300)
