...
public class class727 extends class400 implements class2 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(CIIIZLaa;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Loa;Lya;Loq;[Ltba;[Lcw;)V", line = 17)
