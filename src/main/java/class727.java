...
public class class727 {
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(I)V", line = 4)
    public class727(int arg0) {
        this.field10186 = (byte) arg0;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 25)
