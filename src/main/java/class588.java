...
public abstract class class588 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILlj;III)Lnea;", line = 33)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLhw;)I", line = 54)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)Z", line = 89)
