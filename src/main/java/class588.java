...
public class class588 extends class56 {
    ...
    @OriginalMember(owner = "client!eba", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "()V", line = 62)
    public class588() {
        super(1, true);
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILee;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!eba", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IB)[I", line = 113)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILql;[[B)V", line = 130)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IZ)[I", line = 243)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Z)V", line = 283)
