...
public class class588 extends class299 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILgda;II)Lkaa;")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Les;)V")
    public class588(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(I)Leb;")
