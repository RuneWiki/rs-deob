...
public class class588 extends class232 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ldg;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ldg;B)V", line = 81)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lsa;IIZF)V", line = 217)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II)V", line = 239)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IB)Z", line = 258)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILdg;)V", line = 271)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IZ)V", line = 311)
