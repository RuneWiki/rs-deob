...
public class class588 extends class533 {
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIII)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIIII)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILjava/lang/String;ZI)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIIZ[III)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIII[I)V")
    public class588(class22 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lqo;IIIIZ[BI)V")
