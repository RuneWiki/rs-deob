...
public class class588 extends class497 {
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lpp;)V")
    public class588(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(ILpp;)V")
    public class588(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZILjava/lang/String;II)V")
