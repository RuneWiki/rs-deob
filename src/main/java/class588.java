...
public class class588 extends class686 {
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(I)V", line = 20)
    public class588(int arg0) {
        this.field7987 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BLfd;Lufa;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!saa", name = "h", descriptor = "(I)V", line = 146)
