...
public class class588 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BILr;)Z")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIIIBIIIILr;)V")
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(I[Lraa;IIII)V")
