...
public class class588 extends class739 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "()V", line = 15)
    public class588() {
        super(0, false);
    }

    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BI)[[I", line = 24)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lria;I)Lria;", line = 92)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BII)V", line = 112)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lsl;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!nw", name = "d", descriptor = "(III)V", line = 159)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIIIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IB)V", line = 207)
    ...
    @OriginalMember(owner = "client!nw", name = "e", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!nw", name = "e", descriptor = "(III)Z", line = 235)
