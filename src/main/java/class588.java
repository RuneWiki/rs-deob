...
public class class588 extends class560 implements class290 {
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Luca;I[BI)V", line = 6)
    public class588(class287 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field8524 = arg1;
    }

    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)J", line = 21)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I[BII)V", line = 54)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(FIFF)I", line = 65)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lho;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)I", line = 154)
