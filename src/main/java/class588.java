...
public class class588 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lrr;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILgv;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZLeha;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZI)V", line = 83)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)Ltm;", line = 101)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILrr;)V", line = 118)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 145)
