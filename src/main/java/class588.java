...
public class class588 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIIILha;III)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILha;)Z")
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(I[Lcm;IIII)V")
