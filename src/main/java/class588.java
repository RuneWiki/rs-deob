...
public class class588 extends class282 {
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(IIII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!nda", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nda", name = "e", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IBB)V", line = 112)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "()V", line = 128)
    public class588() {
