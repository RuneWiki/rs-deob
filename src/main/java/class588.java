...
public class class588 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILwca;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lkw;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I[BFIBIIFFLjq;FFII)V", line = 50)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Z)Z", line = 112)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 124)
