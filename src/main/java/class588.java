...
public class class588 extends class116 implements class438 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILpa;II)V", line = 6)
    public final void method663(int arg0, int arg1, class593 arg2, int arg3, int arg4) {
        this.method3366(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 29)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(La;Lc;[IIIII)V", line = 35)
