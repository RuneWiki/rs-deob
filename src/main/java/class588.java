...
public class class588 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Lofa;)V", line = 290)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "()V", line = 360)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(III)I", line = 386)
