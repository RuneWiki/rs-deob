...
public class class588 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IB)Ltn;", line = 149)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 231)
