...
public class class588 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lub;III)V")
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lkga;I)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BI)Lad;")
