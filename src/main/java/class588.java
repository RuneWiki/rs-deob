...
public class class588 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lcba;I)Z")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IILlt;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILcba;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Lap;)V")
