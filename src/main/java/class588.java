...
public class class588 extends class328 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!lk", name = "f", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(IZ)[[I", line = 151)
    ...
    @OriginalMember(owner = "client!lk", name = "g", descriptor = "(I)V", line = 201)
