...
public class class588 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lvf;[IIJ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(II)Ldw;")
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(ILpfa;Lpfa;Ldea;)V")
