...
public class class267 extends class323 implements class438 {
    ...
    @OriginalMember(owner = "client!oj", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lfp;Lje;ZIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lfp;II)Lbi;", line = 26)
    ...
    @OriginalMember(owner = "client!oj", name = "d", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!oj", name = "d", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!oj", name = "c", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lfp;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILfp;)Luq;", line = 92)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(ILfp;)V", line = 129)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Z)Z", line = 164)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)I", line = 178)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lfp;Z)V", line = 197)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIZLct;)Le;", line = 209)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lfp;III)Z", line = 228)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lfp;Lgn;IIIIIIZI)V", line = 249)
