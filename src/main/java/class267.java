...
public class class267 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III)Leh;", line = 6)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(FIFFIIIFLgi;FI)[B", line = 48)
