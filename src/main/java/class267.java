...
public class class267 extends class584 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILep;Lep;)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lnfa;Ljo;)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILld;B)V")
