...
public abstract class class267 extends class5 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILi;IIJLga;II)V", line = 43)
