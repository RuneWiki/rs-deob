...
public class class267 implements class18 {

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "I")
    private int field3851 = -1;

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "Z")
    private boolean field3852 = false;

    @OriginalMember(owner = "client!hl", name = "c", descriptor = "[I")
    private int[] field3853 = null;

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "()V", line = 7)
    public final void method126() {
        GL var1 = class47.field592;
        if (class67.field856) {
            var1.glCallList(this.field3851 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)V", line = 17)
    public final void method129(int arg0) {
        GL var2 = class47.field592;
        if (class67.field856 && this.field3853 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field3853[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!hl", name = "d", descriptor = "()V", line = 28)
    private final void method1828() {
        GL var1 = class47.field592;
        this.field3851 = var1.glGenLists(2);
        var1.glNewList(this.field3851, 4864);
        if (this.field3853 == null) {
            ...
            if (this.field3852) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class47.field590);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field3851 + 1, 4864);
        if (this.field3853 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "()V", line = 271)
    public class267() {
        if (class47.field597 && class47.field609 >= 2) {
            this.method1829();
            GL var1 = class47.field592;
            var1.glBindTexture(34067, this.field3853[0]);
            ...
            var1.glBindTexture(34067, this.field3853[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field3853[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field3852 = class47.field609 < 3;
        }
        this.method1828();
    }

    @OriginalMember(owner = "client!hl", name = "c", descriptor = "()I", line = 122)
    public final int method128() {
        return 4;
    }

    @OriginalMember(owner = "client!hl", name = "e", descriptor = "()V", line = 133)
    private final void method1829() {
        GL var1 = class47.field592;
        if (this.field3853 == null) {
            this.field3853 = new int[3];
            var1.glGenTextures(3, this.field3853, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            class298.field4318 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "()V", line = 249)
    public final void method127() {
        GL var1 = class47.field592;
        class47.method364(1);
        if (class67.field856) {
            var1.glCallList(this.field3851);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }
