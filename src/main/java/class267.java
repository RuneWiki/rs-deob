...
public class class267 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILba;BI)V")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILdt;BLya;ILgp;)Z")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Z)[Lpp;")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lba;III)V")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIILba;)Z")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lug;Lul;)V")
