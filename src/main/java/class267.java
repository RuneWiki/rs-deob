...
public class class267 extends class557 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Ltn;I)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BLdt;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BILha;Loq;)V")
