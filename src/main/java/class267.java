...
public class class267 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IC)V", line = 63)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lda;I)V", line = 76)
