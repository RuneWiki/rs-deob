...
public abstract class class267 implements class440 {
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(III[FI)V", line = 32)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(B)I", line = 128)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIB[II)V", line = 141)
    ...
    @OriginalMember(owner = "client!dh", name = "e", descriptor = "(B)I", line = 249)
    ...
    @OriginalMember(owner = "client!dh", name = "f", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!dh", name = "finalize", descriptor = "()V", line = 277)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(III[BI)V", line = 287)
    ...
    @OriginalMember(owner = "client!dh", name = "g", descriptor = "(B)I", line = 393)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILie;)V", line = 491)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(B)V", line = 510)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Ltm;ILg;Lvp;IZ)V", line = 581)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(I)V", line = 558)
