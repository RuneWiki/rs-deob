...
public class class267 extends class237 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lqa;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!jm", name = "d", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lqa;Lr;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILqa;IB)Z", line = 92)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(Z)Z", line = 103)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILqa;I)Lr;", line = 173)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 238)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILqa;)Llb;", line = 204)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "([BI)[B", line = 269)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIBII)V", line = 309)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BLqa;)Led;", line = 350)
    ...
    @OriginalMember(owner = "client!jm", name = "finalize", descriptor = "()V", line = 362)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BI)V", line = 379)
    ...
    @OriginalMember(owner = "client!jm", name = "e", descriptor = "(I)I", line = 424)
