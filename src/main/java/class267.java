...
public class class267 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ZIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIFIZIII)[I", line = 69)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)Lcs;", line = 99)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 136)
    public class267(Throwable arg0, String arg1) {
        this.field3978 = arg0;
        this.field3973 = arg1;
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(Z)V", line = 159)
