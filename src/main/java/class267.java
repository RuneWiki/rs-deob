...
public class class267 extends class73 {
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!rn", name = "g", descriptor = "(I)J", line = 75)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILgh;Ljava/awt/Component;II)Lnc;", line = 88)
    ...
    @OriginalMember(owner = "client!rn", name = "f", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)I", line = 193)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)I", line = 203)
