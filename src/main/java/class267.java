...
public class class267 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IB)Ldc;", line = 15)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(III)Z", line = 57)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(II)V", line = 68)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(II)Ldr;", line = 105)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(II)Lfr;", line = 131)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lrb;ILpc;Lpc;Lpc;)V", line = 197)
