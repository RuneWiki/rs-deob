...
public class class267 extends class409 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "()Lmi;", line = 34)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lw;[IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "()Lmi;", line = 118)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 136)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(III)V", line = 179)
    ...
    @OriginalMember(owner = "client!ek", name = "d", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILw;B)V", line = 216)
    ...
    @OriginalMember(owner = "client!ek", name = "e", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 324)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lka;)V", line = 464)
    public class267(class407 arg0) {
        this.field3583 = arg0;
    }

    @OriginalMember(owner = "client!ek", name = "d", descriptor = "()I", line = 346)
    public final int method687() {
        field3600++;
        return 0;
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lrk;ILpg;)V", line = 354)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BI)[B", line = 368)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "([III)V", line = 417)
