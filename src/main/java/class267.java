...
public class class267 extends class343 implements class721 {
    ...
    @OriginalMember(owner = "client!rh", name = "h", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BLha;I)Lka;", line = 38)
    ...
    @OriginalMember(owner = "client!rh", name = "j", descriptor = "(B)I", line = 61)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lha;B)V", line = 74)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lha;Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILvs;ZILha;II)V", line = 129)
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(B)Z", line = 153)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lha;I)Lria;", line = 164)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IBLha;I)Z", line = 178)
    ...
    @OriginalMember(owner = "client!rh", name = "l", descriptor = "(B)Z", line = 208)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIZ)V", line = 219)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZILha;I)Lqw;", line = 253)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(B)I", line = 285)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILha;)V", line = 296)
    ...
    @OriginalMember(owner = "client!rh", name = "k", descriptor = "(B)Z", line = 324)
    ...
    @OriginalMember(owner = "client!rh", name = "i", descriptor = "(B)Z", line = 338)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(Lha;B)Lc;", line = 357)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)I", line = 383)
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(I)V", line = 398)
