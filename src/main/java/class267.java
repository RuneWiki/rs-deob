...
public class class267 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ILe;I)Z")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BILe;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIILne;IILq;I)V")
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(I[Lfl;IIII)V")
