...
public class class267 extends class321 implements class113 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!dh", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!dh", name = "e", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!dh", name = "f", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Luca;III)V", line = 109)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Luca;IIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 82)
