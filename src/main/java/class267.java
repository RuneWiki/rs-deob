...
public class class267 extends class497 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!nca", name = "d", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(ILpp;)V", line = 76)
    public class267(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(BI)I", line = 79)
    ...
    @OriginalMember(owner = "client!nca", name = "c", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(Lpp;)V", line = 114)
