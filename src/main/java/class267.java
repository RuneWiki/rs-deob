...
public class class267 implements Runnable {
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!dj", name = "run", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BIII)I", line = 71)
