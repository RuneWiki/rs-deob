...
public class class267 extends class675 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IF)V", line = 3)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FI)V", line = 20)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FFFB)I", line = 36)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(I)V", line = 83)
    public class267(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rn", name = "A", descriptor = "(I)V", line = 89)
