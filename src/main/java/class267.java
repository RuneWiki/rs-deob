...
public class class267 extends class181 {
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lad;Lcq;[Laf;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vc", name = "q", descriptor = "(CIIIZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(CIIIZLfa;II)V", line = 262)
