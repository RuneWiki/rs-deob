...
public class class267 extends class435 {
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "()V", line = 12)
    public class267() {
    }

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(S)V", line = 27)
