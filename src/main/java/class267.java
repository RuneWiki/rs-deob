...
public class class267 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(JI)Ldaa;", line = 3)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(JLdaa;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)Ldaa;", line = 66)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(I)V", line = 114)
