...
public class class267 extends class192 {
    ...
    @OriginalMember(owner = "client!c", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IB)[I", line = 184)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BC)Z", line = 224)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILfd;I)V", line = 241)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(B)V", line = 285)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "()V", line = 311)
    public class267() {
        super(1, true);
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)[I", line = 318)
