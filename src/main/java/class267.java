...
public class class267 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)Lju;")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BLwu;Ld;Ljava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILjava/lang/Runnable;)V")
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lgf;)V")
