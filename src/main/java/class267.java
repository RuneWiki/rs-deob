...
public class class267 extends class436 implements class265 {
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Len;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Len;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILen;IBLfs;IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IBLen;)Lmj;", line = 94)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILen;)Lir;", line = 131)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)I", line = 172)
    public final int method225(int arg0) {
        ++field3740;
        return arg0 < 66 ? 120 : 65535 & this.field3762;
    }

    @OriginalMember(owner = "client!nq", name = "d", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Len;Lnl;IIIIZIIZ)V", line = 195)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BILen;)Lmj;", line = 233)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Len;I)V", line = 267)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIZLen;)Z", line = 351)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Len;IZB)Lgi;", line = 373)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(I)Z", line = 410)
    ...
    @OriginalMember(owner = "client!nq", name = "e", descriptor = "(I)Z", line = 423)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BLen;)V", line = 438)
