...
public class class267 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lza;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lza;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lza;[II)V")
