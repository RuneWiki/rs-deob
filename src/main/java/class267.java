...
public class class267 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "()I", line = 6)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "()V", line = 162)
    public class267() {
    ...
    @OriginalMember(owner = "client!iaa", name = "c", descriptor = "()[F", line = 304)
