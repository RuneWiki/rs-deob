...
public class class267 extends class117 implements class503 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lya;IZLij;III)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLya;I)Lt;")
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lya;Ljo;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lya;B)Lmf;")
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(ILya;)V")
