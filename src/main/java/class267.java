...
public abstract class class267 {
    ...
    @OriginalMember(owner = "client!kk", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I[BB)V", line = 31)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Llea;I[BIZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Llea;ILjaclib/memory/Buffer;IZ)V", line = 100)
