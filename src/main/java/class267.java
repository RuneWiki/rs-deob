...
public class class267 extends class34 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IB)[I", line = 131)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(Z)V", line = 173)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 204)
    public class267() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lsv;II)V", line = 207)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(III)Z", line = 254)
