...
public abstract class class267 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZB)V", line = 81)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)Z", line = 147)
