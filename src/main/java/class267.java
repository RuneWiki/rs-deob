...
public class class267 extends class60 {
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lhd;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)Ldq;")
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(ILhd;)V")
