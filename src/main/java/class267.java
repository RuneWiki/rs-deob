...
public class class267 extends class144 implements class145 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([[IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)J", line = 17)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([BIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IZ)Z", line = 51)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)I", line = 84)
    public final int method939(int arg0) {
        ++field3663;
        return arg0 != 32726 ? -43 : this.field3661;
    }

    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lkga;I[BI)V", line = 100)
