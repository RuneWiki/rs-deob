...
public class class267 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIIIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 76)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)V", line = 118)
    public static void method1642(int arg0) {
        field3625 = null;
        int var1 = -113 % ((arg0 - 63) / 34);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 148)
    public class267(class121 arg0, int arg1, class557 arg2) {
        this.field3628 = arg2;
        this.field3628.method3333(32, 3443);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IB)Ltf;", line = 163)
