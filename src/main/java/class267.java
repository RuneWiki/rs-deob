...
public class class267 extends class61 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZIILps;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!eo", name = "e", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(B)V", line = 269)
