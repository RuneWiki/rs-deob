...
public class class267 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lsj;IIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(III)V", line = 70)
