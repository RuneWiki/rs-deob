...
public class class267 implements Runnable {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIILlo;IIIILlo;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIIBLqs;IIIII)Z")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lam;ZILam;)V")
