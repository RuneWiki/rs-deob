...
public class class267 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)Lvv;", line = 49)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLah;)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IB)Z", line = 107)
