...
public class class267 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)Lpm;", line = 112)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lmj;Lfa;)V", line = 157)
