...
public class class267 extends class35 {
    ...
    @OriginalMember(owner = "client!e", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(II)V", line = 51)
