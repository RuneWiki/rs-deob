...
public class class791 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lkw;ILuq;)V", line = 134)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BI)Lno;", line = 54)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIB)Z", line = 107)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(I)V", line = 122)
