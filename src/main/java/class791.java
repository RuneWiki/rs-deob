...
public class class791 extends class766 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lol;Z)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(ZLcea;)V")
