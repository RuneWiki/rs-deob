...
public class class791 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(II)Lkha;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(B)Lbi;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IILkh;)I")
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lim;ILgj;)V")
