...
public class class791 implements Runnable {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!kb", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)Z", line = 118)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIILeo;IIIIIII)Z", line = 148)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IB[BI)I", line = 504)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 557)
