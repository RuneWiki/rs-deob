...
public class class791 extends class67 {
    ...
    @OriginalMember(owner = "client!ms", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lffa;Llq;[Liga;Z)V")
