...
public class class791 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(BLha;J)V", line = 28)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ILtea;)Z", line = 68)
