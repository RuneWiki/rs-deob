...
public class class434 extends class375 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLvg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!maa", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lii;)V", line = 35)
