...
public class class434 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "([IIJLra;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BI)Lrn;", line = 42)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(ILpc;Lpc;Llu;)V", line = 97)
