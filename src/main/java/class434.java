...
public abstract class class434 extends class430 {
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 232)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)V", line = 288)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 300)
