...
public class class434 extends class480 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lab;IIIIIIIIIIIZZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(JI)V", line = 35)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lqa;J)V", line = 430)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "()V", line = 627)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lab;IIIIIIIIIIIZZ)V", line = 636)
