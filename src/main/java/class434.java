...
public class class434 extends class413 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZI)I", line = 9)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)J", line = 50)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Z)J", line = 84)
