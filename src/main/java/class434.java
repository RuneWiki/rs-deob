...
public class class434 extends class544 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IBLqa;)Lr;", line = 42)
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(B)V", line = 133)
