...
public class class434 extends class227 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BII)I", line = 14)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!lj", name = "j", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "()V", line = 93)
    public class434() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(III)Lvv;", line = 86)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lug;II)V", line = 108)
    ...
    @OriginalMember(owner = "client!lj", name = "k", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)[I", line = 203)
    ...
    @OriginalMember(owner = "client!lj", name = "e", descriptor = "(I)V", line = 415)
