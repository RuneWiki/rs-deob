...
public class class434 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lve;III[Z)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lam;Lam;ILam;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IILfd;IIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lam;ILam;)V")
