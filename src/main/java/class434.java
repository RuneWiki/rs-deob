...
public class class434 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "()V", line = 293)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Llh;)V", line = 353)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(III)I", line = 415)
