...
public class class434 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lgh;)Z")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lgh;Z)V")
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(Lgh;)V")
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lks;)V")
