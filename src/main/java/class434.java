...
public class class434 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lgk;B)Llf;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILgk;I)V")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lgk;I)V")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIILjava/lang/Class;)Lwo;")
