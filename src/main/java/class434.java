...
public class class434 extends class86 {
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(III)I", line = 27)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Llq;)V", line = 41)
