...
public class class434 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ZLms;)V", line = 26)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLaq;)V", line = 49)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "()V", line = 61)
    public class434() {
    }

    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)Lpl;", line = 64)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lnq;ILnq;)I", line = 86)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BC)C", line = 129)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Lpl;", line = 158)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Laq;)V", line = 179)
    public class434(class90 arg0) {
        this.field6117 = arg0;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)V", line = 187)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)V", line = 202)
