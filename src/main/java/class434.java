...
public class class434 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BLic;Lic;Ls;Lic;)Z")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ZLdh;)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BLdh;)Lqb;")
