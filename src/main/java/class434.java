...
public class class434 {
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "([[[Lnaa;ZIIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Lha;I)V", line = 352)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "(J[I[S[S)V", line = 445)
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "()V", line = 455)
    protected class434() {
    }
