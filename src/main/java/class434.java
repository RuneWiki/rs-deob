...
public class class434 extends class381 {
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lda;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lph;Lza;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lda;IIII[BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 100)
