...
public class class434 implements class447 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)Ljw;", line = 6)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIB)Ldm;", line = 29)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IILkg;I)Lwga;", line = 53)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(I)V", line = 157)
