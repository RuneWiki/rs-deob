...
public class class434 extends class726 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IILha;IIZII)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lin;Lma;Lin;ZLcba;Lin;)Z")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZLha;J)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ld;Lha;I)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lha;IJIZ)V")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lha;Lnn;Luj;J)V")
