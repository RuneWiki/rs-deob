...
public abstract class class434 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZIIZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ILuk;)Z", line = 48)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ZC)C", line = 88)
