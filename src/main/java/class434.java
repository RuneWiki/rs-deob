...
public class class434 extends class225 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ah", name = "e", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Laj;)V", line = 125)
    public class434(class71 arg0) {
        this.field6381 = arg0;
    }

    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Z)V", line = 133)
