...
public class class434 extends class204 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IZLae;IZIIJ)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(ILfs;)V")
    public class434(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lfs;)V")
