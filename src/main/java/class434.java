...
public class class434 extends class712 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ILjava/util/Random;B)I", line = 3)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(BZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!sca", name = "d", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IILhba;)V", line = 132)
    ...
    @OriginalMember(owner = "client!sca", name = "d", descriptor = "(Z)Z", line = 149)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lrl;)V", line = 199)
    public class434(class232 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ZI)I", line = 166)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ZB)V", line = 203)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IIII)V", line = 234)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(Z)V", line = 256)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(III)V", line = 282)
    ...
    @OriginalMember(owner = "client!sca", name = "f", descriptor = "(Z)V", line = 295)
