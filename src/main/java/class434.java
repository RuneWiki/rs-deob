...
public class class434 extends class648 {
    ...
    @OriginalMember(owner = "client!rba", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lbca;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(BII)V", line = 41)
    ...
    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZI)V", line = 84)
    public final void method1448(boolean arg0, int arg1) {
        ++field6454;
        super.field9139.method2300(class661.field9242, class499.field7099, arg1);
    }

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!rba", name = "e", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lno;Lvd;Lpba;)V", line = 159)
