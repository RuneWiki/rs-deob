...
public class class434 extends class262 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZLya;)Llo;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILya;II)Z")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ltg;Z)V")
