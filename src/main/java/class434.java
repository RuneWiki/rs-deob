...
public class class434 {
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "()I", line = 9)
    public final int method2315() {
        return this.field5718;
    }

    @OriginalMember(owner = "client!qq", name = "c", descriptor = "()V", line = 13)
    public static void method2316() {
        field5720 = null;
    }

    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Loa;IZLjava/awt/Component;)V", line = 176)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Loa;Ljava/lang/String;[IIIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ljava/lang/String;)I", line = 44)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Loa;Ljava/lang/String;IIIZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Loa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 81)
