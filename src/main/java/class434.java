...
public class class434 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BLia;)I", line = 56)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lha;B)V", line = 84)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IBLha;)V", line = 114)
