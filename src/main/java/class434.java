...
public class class434 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Ljn;)V")
