...
public class class434 extends class6 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Llt;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Llg;)V", line = 32)
