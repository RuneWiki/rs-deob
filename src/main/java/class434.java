...
public class class434 extends class385 {
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IB)V", line = 33)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(I)V", line = 50)
