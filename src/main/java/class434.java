...
public class class434 extends class221 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IILet;ILjava/awt/Component;)Lln;")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lfs;ILjava/lang/String;Z)Lqk;")
