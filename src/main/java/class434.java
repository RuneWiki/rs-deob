...
public class class434 implements class284 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(FIIIZI)[F", line = 6)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BI)Lgk;", line = 29)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZIIIF)[I", line = 40)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(II)Lhf;", line = 51)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)Z", line = 75)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIFZIB)[I", line = 88)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILuaa;II)V", line = 104)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z)I", line = 139)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lwm;Lwm;Lwm;)V", line = 152)
