...
public abstract class class434 extends class98 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "([BI)Luda;", line = 21)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(I)V", line = 99)
    public class434(int arg0) {
        this.field6596 = arg0;
    }

    @OriginalMember(owner = "client!vaa", name = "d", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIBI)V", line = 140)
