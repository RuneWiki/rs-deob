...
public class class434 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(III)Llh;", line = 197)
