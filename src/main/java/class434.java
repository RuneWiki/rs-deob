...
public class class434 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIILuo;ILbo;II)Lge;", line = 4)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)V", line = 147)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(III)V", line = 165)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BIIILuo;Lbo;Lbo;ZII[Lrr;II)Lge;", line = 187)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILwo;)V", line = 675)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 688)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lgi;III[Z)Z", line = 726)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZI[I[III)V", line = 761)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BII)V", line = 816)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIILuo;Lbo;II)Lge;", line = 838)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/lang/String;ILnh;I)Lph;", line = 1025)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZB)V", line = 1099)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 1113)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BI)V", line = 1126)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(III)V", line = 1150)
