...
public class class434 extends class337 {
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "()V", line = 5)
    public class434() {
        super(3, false);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IB)[I", line = 8)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BILhp;)V", line = 57)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IJ)V", line = 98)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)[[I", line = 144)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lgn;", line = 199)
