...
public class class273 extends class220 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BLwm;)V")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(IZ[B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Ldp;Lfv;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Z)Lg;")
