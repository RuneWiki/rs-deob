...
public class class273 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILre;I)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIILpp;Lei;Lg;Ltq;I)Lns;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ltq;Lei;IIILg;I[Lhs;Lpp;IILpp;IILnk;)Lns;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lg;Z)Ldr;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BLre;)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ltd;B)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BLg;)Z")
