...
public class class273 implements class397 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILai;I)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILai;)V")
    public final void method1715(int arg0, class201 arg1) {
        this.method1709(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILmn;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILqh;II)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILqh;I)V")
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lqi;)V")
