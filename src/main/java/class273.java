...
public class class273 extends class301 implements class223 {
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lea;Lp;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IILea;Lac;ZII)V")
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(ILea;)Lms;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLea;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ZILea;I)Z")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lea;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lea;BI)Lts;")
