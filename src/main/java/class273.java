...
public class class273 extends class168 {
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ILjava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "()V", line = 86)
    public class273() {
    }

    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ZZI)V", line = 89)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "(S)V", line = 114)
