...
public class class273 extends class683 {
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ldt;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lhr;B)V", line = 36)
