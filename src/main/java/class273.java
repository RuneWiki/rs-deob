...
public class class273 extends class154 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(FB)V", line = 25)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIII)V", line = 38)
