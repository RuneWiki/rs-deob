...
public class class273 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BI)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(III)V", line = 166)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)[[[I", line = 135)
