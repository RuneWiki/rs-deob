...
public class class273 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILfb;I)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IILfb;B)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILqc;IBILqr;ILkg;)V")
