...
public class class273 extends class667 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(ILud;)Liha;", line = 8)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "()V", line = 133)
    public class273() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(ZI)[[I", line = 24)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lud;II)V", line = 90)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lsp;Lqaa;I)Lvr;", line = 136)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BI)[I", line = 171)
