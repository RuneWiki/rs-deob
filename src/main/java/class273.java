...
public abstract class class273 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IILjava/lang/String;[IIII[Lcq;IILud;IIBII)I", line = 53)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIILjava/lang/String;BI)V", line = 140)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 155)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljava/lang/String;BI[III[Lcq;I)V", line = 180)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BII[Lcq;I[IILjava/lang/String;)V", line = 209)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(III)V", line = 224)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 242)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILjava/lang/String;[I[I[Lcq;[IZI)V", line = 289)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I[Lcq;Lud;I[IZLjava/lang/String;II)V", line = 455)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIILwm;IIIILwm;I)V", line = 605)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IB)Lfk;", line = 657)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIII[ILjava/lang/String;[Lcq;I)V", line = 686)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILjava/lang/String;)V", line = 702)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljava/lang/String;IIZIII)V", line = 779)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 810)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIILjava/util/Random;[Lcq;Ljava/lang/String;Z[III)I", line = 828)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lii;Lcl;)V", line = 867)
    public class273(class405 arg0, class313 arg1) {
        this.field3963 = arg0;
        this.field3976 = arg1;
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "([Lcq;I[IIILjava/lang/String;IIILjava/util/Random;IIII[I)I", line = 877)
