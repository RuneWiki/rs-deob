...
public class class273 extends class184 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BILfh;)V", line = 120)
    ...
    @OriginalMember(owner = "client!mt", name = "e", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!mt", name = "e", descriptor = "(Z)Lmv;", line = 182)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "()V", line = 197)
    public class273() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(II)[[I", line = 213)
