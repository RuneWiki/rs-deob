...
public class class273 extends class310 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(CIIIZLta;II)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!hk", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lqf;Lap;[Lrr;[I[I)V")
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "([B[IIIIIIIIIIILta;II)V")
