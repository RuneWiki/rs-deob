...
public abstract class class273 extends class285 {
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "()I", line = 8)
    public final int method1860() {
        return this.field4053 + this.field4030 + this.field4046;
    }

    @OriginalMember(owner = "client!rl", name = "b", descriptor = "()I", line = 12)
    public final int method1861() {
        return this.field4043 + this.field4023 + this.field4052;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "()I", line = 15)
    public final int method1862() {
        return this.field4030;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(FFFFFFLtm;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(FFFFFFIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(FFFFFF)V", line = 125)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIIIIII)V", line = 259)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(IIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "()I", line = 321)
    public final int method1868() {
        return this.field4023;
    }

    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lpm;II)V", line = 344)
