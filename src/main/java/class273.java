...
public class class273 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "()Lcba;", line = 5)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Loh;II)Lvea;", line = 12)
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "()I", line = 23)
    ...
    @OriginalMember(owner = "client!vea", name = "c", descriptor = "()[B", line = 68)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lig;)V", line = 129)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "()V", line = 149)
    private class273() {
    }
}
