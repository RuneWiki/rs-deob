...
public class class273 extends class383 implements class196 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IBLqa;)Lc;", line = 30)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BLqa;)V", line = 50)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIILqa;)Z", line = 78)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!jp", name = "e", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lqa;I)Lpj;", line = 142)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)I", line = 174)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lqa;ZZI)Lfo;", line = 197)
    ...
    @OriginalMember(owner = "client!jp", name = "d", descriptor = "(I)Z", line = 227)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(BLqa;)V", line = 244)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(B)Z", line = 256)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILqa;B)Lc;", line = 267)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lqa;Leu;IIIIZIZ)V", line = 278)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILqa;)V", line = 312)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lqv;BLqa;IZII)V", line = 340)
