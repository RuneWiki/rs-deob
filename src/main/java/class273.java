...
public class class273 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(B)Lum;", line = 3)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILqo;)Lut;", line = 17)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Ljava/lang/String;II)I", line = 93)
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Lbi;Lbi;)V", line = 103)
