...
public class class273 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IZ)Lal;")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)Loa;")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIILqq;IZ)V")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lcm;ILlt;)V")
