...
public class class273 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IZIIB[[[Llo;)Z")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ILla;I)Lpia;")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IIILpe;BIILpe;II)V")
