...
public class class273 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "()[F", line = 5)
    public final float[] method1759() {
        return this.field4088[this.method1760()];
    }

    @OriginalMember(owner = "client!lp", name = "b", descriptor = "()I", line = 9)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)I", line = 158)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "()V", line = 165)
    public class273() {
