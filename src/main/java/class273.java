...
public class class273 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)I", line = 8)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lbg;)V", line = 74)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(II)[I", line = 168)
