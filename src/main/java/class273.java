...
public class class273 extends class210 {
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Los;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Los;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Los;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Los;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Los;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIILwaa;)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Los;IIII[I)V")
