...
public class class273 extends class86 {
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lnq;Lhl;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZLuu;)I")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZLlr;I)V")
