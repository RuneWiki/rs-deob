...
public class class273 extends class48 {
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "()Z", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lna;)V", line = 9)
    public final void method71(class50 arg0) {
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lql;Lbo;)V", line = 28)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!wl", name = "c", descriptor = "()V", line = 109)
