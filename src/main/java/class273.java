...
public class class273 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZI)Liw;", line = 4)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIII)I", line = 44)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 89)
