...
public class class273 extends class144 implements class458 {
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lkga;ILjaclib/memory/Buffer;)V")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lkga;I[BI)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLjn;I)Lf;")
