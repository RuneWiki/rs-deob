...
public class class273 extends class416 {
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ILee;)V", line = 8)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ILee;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IBLjava/lang/String;)Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(III)V", line = 131)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!gia", name = "d", descriptor = "(Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(III)I", line = 177)
