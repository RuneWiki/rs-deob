...
public class class273 implements class160 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IZ)Lvc;", line = 6)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BI)Llv;", line = 29)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(II)Z", line = 72)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "([BB)Lfi;", line = 87)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BIIZIF)[I", line = 186)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIFIIZ)[F", line = 198)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BZIIIF)[I", line = 210)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIILwn;)V", line = 221)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Lwia;Lwia;Lwia;)V", line = 280)
