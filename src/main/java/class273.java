...
public class class273 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILw;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lw;III)Z", line = 76)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(Lw;III)V", line = 165)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIBZ[[Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILjava/lang/String;)I", line = 432)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 466)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(I)Lmaa;", line = 507)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lsv;Lua;)V", line = 535)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIZII)V", line = 550)
