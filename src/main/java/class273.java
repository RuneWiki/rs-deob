...
public class class273 implements class5 {
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(IIIIIIZZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIIZZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Luq;IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lfga;Lfd;Liu;)V", line = 141)
