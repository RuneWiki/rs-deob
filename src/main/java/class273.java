...
public class class273 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)V", line = 39)
    public static void method1623(byte arg0) {
        int var1 = -32 % ((arg0 - 33) / 49);
        field3443 = null;
    }

    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BII)Z", line = 83)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IB)Loi;", line = 114)
    ...
    @OriginalMember(owner = "client!tr", name = "c", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Z)V", line = 219)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZILoa;Loa;ILta;ZIIIILh;)Lxa;", line = 241)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IBIIILh;ILoa;)Lxa;", line = 308)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lbs;IZLkw;Lpfa;Lpfa;)V", line = 348)
