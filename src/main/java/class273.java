...
public class class273 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIIIB)I", line = 14)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIII)Z", line = 28)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IB)V", line = 216)
