...
public class class273 extends class498 {
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(IIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(III)V", line = 55)
