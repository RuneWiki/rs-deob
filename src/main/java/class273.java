...
public class class273 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IILr;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!bha", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Lr;III)Z", line = 144)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Z)V", line = 225)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IIILr;)V", line = 243)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Z[[ZIIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IIIII)V", line = 511)
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(Llba;Laga;)V", line = 559)
