...
public class class273 extends class349 implements class351 {
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lnr;Z)Lg;", line = 4)
    ...
    @OriginalMember(owner = "client!to", name = "f", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)I", line = 151)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lnr;Lta;IIIIZIIZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 204)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIZIII)V", line = 216)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILnr;II)Z", line = 247)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 268)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BZLnr;I)Lbc;", line = 299)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 330)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BILnr;)Lqc;", line = 341)
    ...
    @OriginalMember(owner = "client!to", name = "g", descriptor = "(B)V", line = 351)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(B)V", line = 363)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lnr;Z)V", line = 377)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(B)I", line = 407)
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "(B)Z", line = 419)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILnr;)V", line = 431)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLnr;I)Lqc;", line = 471)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)Z", line = 494)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(B)I", line = 508)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lnr;I)V", line = 519)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)V", line = 529)
