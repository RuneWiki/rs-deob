...
public class class586 extends class96 {
    ...
    @OriginalMember(owner = "client!lja", name = "<init>", descriptor = "(Lml;Lau;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lja", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IZLica;)V", line = 72)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ZI)V", line = 98)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(Z)Z", line = 115)
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(B)Z", line = 135)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ZII)V", line = 153)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ZB)V", line = 209)
