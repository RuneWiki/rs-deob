...
public class class586 extends class168 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILjava/lang/String;)V", line = 18)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(III)Lhe;", line = 31)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lcs;)V", line = 190)
    public class586(class344 arg0) {
        this.field8189 = arg0;
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I[BIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IBI)Z", line = 167)
