...
public class class586 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IB)V", line = 150)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(B)V", line = 163)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lwea;[Luca;)V", line = 176)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lwea;ILvq;I)V", line = 261)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BI)Lv;", line = 330)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lgia;ILaj;)V", line = 367)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)Z", line = 391)
