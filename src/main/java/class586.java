...
public class class586 extends class362 {
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "f", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lfca;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIB)Z", line = 99)
    ...
    @OriginalMember(owner = "client!si", name = "g", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)[I", line = 147)
