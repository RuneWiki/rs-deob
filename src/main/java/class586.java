...
public class class586 extends class444 implements class706 {
    ...
    @OriginalMember(owner = "client!nw", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "([Loia;I)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!nw", name = "i", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!nw", name = "e", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!nw", name = "d", descriptor = "(I)Z")
    public final boolean method621(int arg0) {
        ++field8255;
        return arg0 >= -103 ? false : false;
    }

    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lha;III)Z")
