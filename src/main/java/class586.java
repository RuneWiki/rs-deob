...
public class class586 extends class168 {
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)Lqba;")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lqfa;I)V")
    public class586(class106 arg0, int arg1) {
        this.field8278 = arg0;
        this.field8274 = new class425(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lqba;Lqba;FI)Z")
