...
public class class586 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "()I", line = 6)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "()[B", line = 52)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "()Lmda;", line = 113)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Ldga;)V", line = 129)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 149)
    private class586() {
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lpq;II)Ltq;", line = 121)
