...
public class class586 extends class516 {
    ...
    @OriginalMember(owner = "client!ar", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILlp;ILjava/lang/String;)Lqo;", line = 13)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIZ)I", line = 90)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZBI)V", line = 144)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZZ)V", line = 223)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lpb;II)V", line = 259)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(III)V", line = 270)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lcb;Ljq;)V", line = 372)
    public class586(class444 arg0, class438 arg1) {
        super(arg0);
        this.field8599 = arg1;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lvp;III)V", line = 319)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)Z", line = 335)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BZ)V", line = 349)
