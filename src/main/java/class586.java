...
public class class586 extends class337 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lkfa;IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIZIII[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!il", name = "f", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lkfa;IIIIZ[FI)V", line = 91)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lkfa;IIIIZ[IIIZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BZZ)V", line = 168)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lkfa;IIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lkfa;IIIIZ[BIZ)V", line = 338)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIBIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IB)Z", line = 238)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIBZLjava/lang/String;)V", line = 256)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IZ[BIIIIIII)V", line = 268)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 391)
