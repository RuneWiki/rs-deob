...
public class class586 extends class582 implements class134 {
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Leda;Lsq;Lrt;II)V")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(II[BIIIILsq;I)V")
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Leda;Lsq;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!tw", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method2075(int arg0) {
        return arg0 == -8780 ? this.field8311 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Leda;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Ldj;B)V")
