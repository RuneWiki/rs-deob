...
public class class586 {
    ...
    @OriginalMember(owner = "client!si", name = "toString", descriptor = "()Ljava/lang/String;", line = 7)
    public final String toString() {
        field7986++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)[Ltu;", line = 17)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II[BB)[B", line = 29)
