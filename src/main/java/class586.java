...
public class class586 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;Ljava/applet/Applet;Z)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)V", line = 15)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 25)
