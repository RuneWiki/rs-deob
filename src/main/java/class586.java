...
public class class586 extends class237 {
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ljava/awt/Canvas;ILd;II)Lha;", line = 16)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IZII)V", line = 42)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IBII)V", line = 53)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lgda;Lgda;Lvha;)V", line = 153)
