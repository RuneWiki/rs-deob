...
public class class586 extends class82 {
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ldn;III)Loda;", line = 45)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IBZI)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 125)
    public class586() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vm", name = "h", descriptor = "(I)V", line = 128)
