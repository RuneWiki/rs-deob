...
public class class586 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IBLr;)Z")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIIIIILr;III)V")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(I[Laba;IIII)V")
