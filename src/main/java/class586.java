...
public class class586 extends class626 {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "()V", line = 4)
    public class586() {
    }

    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(J)V", line = 6)
    public class586(long arg0) {
        this.field8246 = arg0;
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)V", line = 23)
