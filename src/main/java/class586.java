...
public class class586 extends class692 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILfga;I)V")
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Llea;)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([Luf;IZ)V")
