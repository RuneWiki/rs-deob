...
public class class586 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljr;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IILjr;)V", line = 29)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZILur;IILoa;IILd;ILd;BII)Lba;", line = 151)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIILur;BLoa;I)Lba;", line = 265)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZIIIILur;ILoa;IBLd;ILd;)Lba;", line = 338)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILoa;ILur;III)Lba;", line = 348)
