...
public abstract class class586 extends class255 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 33)
