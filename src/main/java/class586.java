...
public class class586 {
    ...
    @OriginalMember(owner = "client!qp", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field8708++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)I", line = 16)
    public final int method3421(int arg0) {
        field8706++;
        return arg0 == 28888 ? this.field8704 : 19;
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILdda;)V", line = 27)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(II)V", line = 51)
