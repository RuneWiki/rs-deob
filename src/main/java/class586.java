...
public class class586 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)Lkq;", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)Lil;", line = 16)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(II)V", line = 53)
