...
public class class585 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILie;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ler;IIIB)Lcea;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IBLie;)V")
