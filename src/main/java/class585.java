...
public class class585 extends class476 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "([Ltf;Z)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lqa;J[Lon;[Ltf;Z)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)Lqp;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lqa;J)Z")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lqa;[Lon;Z)V")
