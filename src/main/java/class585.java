...
public class class585 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)Lco;", line = 9)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZIZII)Lkea;", line = 55)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(JLdb;[II)Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)Z", line = 135)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(ILkea;Lkea;Lsi;)V", line = 159)
