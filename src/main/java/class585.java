...
public class class585 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 10)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(I)V", line = 55)
