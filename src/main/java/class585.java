...
public class class585 extends class192 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "()V", line = 139)
    public class585() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ILfd;I)V", line = 143)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(B)V", line = 206)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "([I[Ljava/lang/Object;Z)V", line = 228)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ILjba;ZILjba;)I", line = 239)
