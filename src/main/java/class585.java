...
public class class585 implements class353 {
    ...
    @OriginalMember(owner = "client!wn", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field7973++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 37)
