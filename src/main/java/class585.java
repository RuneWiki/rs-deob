...
public class class585 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lso;[IBI)Lcg;", line = 5)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)I", line = 182)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(II)Llia;", line = 197)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BLlia;)V", line = 210)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Llia;)V", line = 236)
    public class585(class504 arg0) {
        this.field7981 = arg0.field7131;
        this.field7978 = 1;
    }

    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "([Llia;)V", line = 245)
    public class585(class504[] arg0) {
