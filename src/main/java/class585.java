...
public class class585 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "([B[[BI[I[[BI[IZ)I", line = 51)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "([I)V", line = 106)
