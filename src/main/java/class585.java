...
public class class585 extends class216 {
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Ler;Ljava/lang/Object;I)V", line = 4)
    public class585(class209 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field8561 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!saa", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 24)
