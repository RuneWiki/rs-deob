...
public class class585 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIZI[B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "([BBII)Z", line = 130)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)V", line = 160)
    ...
    @OriginalMember(owner = "client!at", name = "toString", descriptor = "()Ljava/lang/String;", line = 308)
    public final String toString() {
        field8305++;
        return "Cache:" + this.field8301;
    }

    @OriginalMember(owner = "client!at", name = "b", descriptor = "(II)[B", line = 319)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)V", line = 401)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(ILnh;Lnh;I)V", line = 431)
