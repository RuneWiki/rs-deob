...
public class class585 extends class38 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lhu;Lwm;)Lpea;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILlw;I[BIIZ)Lrm;")
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(ZI)Lfb;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILlw;Lal;)Z")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILwe;)I")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lht;Z)I")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lri;I)I")
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(II)Lhu;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILmq;)I")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I[Lbl;)Lfk;")
    public final class313 method219(int arg0, class468[] arg1) {
        return arg0 == 2 ? new dxVertexLayout(this, arg1) : (class313) null;
    }

    @OriginalMember(owner = "client!hb", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lla;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lhl;I)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([BBLlw;III)Luc;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILri;ZI)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILal;Llw;)Z")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([[IBIZ)Lqn;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lfb;II)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lmq;ZII)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;Z)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIILoq;ILri;I)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lpea;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lgca;B)I")
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/k;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Llga;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lla;I)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILmq;ZZI)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Llw;IILal;I)Lrm;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILfk;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lvm;Lvm;FLvm;)Lvm;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([FIZILlw;III)Lrm;")
    ...
    @OriginalMember(owner = "client!hb", name = "g", descriptor = "(II)Lwm;")
    public final class28 method1276(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLqg;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILtfa;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Llw;BLal;)I")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILjagdx/D3DPRESENT_PARAMETERS;IILjagdx/IDirect3D;)Z")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(III[IIIZ)Lrm;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLgw;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "d", descriptor = "(IZ)Loq;")
    ...
    @OriginalMember(owner = "client!hb", name = "q", descriptor = "()Lqm;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IB)Loca;")
