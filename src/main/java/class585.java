...
public class class585 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lha;Lid;)Z")
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Lha;Lid;)V")
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(Lha;Lid;)Z")
    ...
    @OriginalMember(owner = "client!id", name = "d", descriptor = "(Lha;Lid;)V")
