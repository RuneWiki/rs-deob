...
public class class585 implements class320 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIILha;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IILvba;IIIIIIIILha;)V", line = 27)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLofa;)Z", line = 103)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)J", line = 159)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lha;IIILfca;)V", line = 191)
