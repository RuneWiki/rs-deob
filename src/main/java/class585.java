...
public abstract class class585 extends class577 {
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IBI)V", line = 35)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III)[I", line = 66)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(II)[I", line = 87)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(B)I", line = 137)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lso;II)V", line = 148)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(IZ)V", line = 163)
    public class585(int arg0, boolean arg1) {
        this.field8267 = new class585[arg0];
        this.field8266 = arg1;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIB)[[I", line = 175)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZI)[[I", line = 214)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BI)Luh;", line = 234)
