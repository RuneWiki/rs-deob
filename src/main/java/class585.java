...
public abstract class class585 extends class483 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)Z", line = 22)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lgba;III)V", line = 83)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "(I)V", line = 115)
