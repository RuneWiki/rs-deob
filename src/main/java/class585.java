...
public class class585 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!eba", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "()V", line = 19)
    public class585() {
        this.field8243.initialize(null);
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IIIIILjava/awt/Frame;)V", line = 29)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)[I", line = 58)
