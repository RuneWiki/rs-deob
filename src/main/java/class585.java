...
public class class585 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I[FIIFIIFBIIF[FI)V", line = 3)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(II)Lkt;", line = 99)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(II)V", line = 130)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Ltd;B)I", line = 161)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 191)
