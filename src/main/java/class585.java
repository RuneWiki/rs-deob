...
public class class585 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II[II)Lmr;")
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(II[II)Lmr;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(BI[I)Lmr;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "([III)Lmr;")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Ldn;Ldn;)V")
