...
public class class585 extends class125 {
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(ILgp;)V", line = 4)
    public class585(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lgp;)V", line = 32)
    public class585(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(ILqk;B)I", line = 49)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BI)V", line = 97)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IZZII)I", line = 108)
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(Z)I", line = 149)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(Z)V", line = 165)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(ZI)I", line = 179)
