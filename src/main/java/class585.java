...
public class class585 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)[I", line = 30)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Ldga;)V", line = 312)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "()V", line = 385)
