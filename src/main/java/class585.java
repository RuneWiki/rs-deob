...
public class class585 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BI)Ldh;", line = 8)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IBI)V", line = 40)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILfha;B[I)V", line = 52)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lms;ILwu;Lwu;)V", line = 203)
