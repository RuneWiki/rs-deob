...
public class class585 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIIII[Lwca;IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(BIIIII)V", line = 725)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IZI)Lcv;", line = 738)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(III)V", line = 754)
