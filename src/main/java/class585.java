...
public class class585 extends class627 {

    @OriginalMember(owner = "client!tca", name = "j", descriptor = "Lqia;")
    public class547 field8118 = new class547();

    @OriginalMember(owner = "client!tca", name = "m", descriptor = "Lgg;")
    public static class114 field8121 = new class114(64);

    @OriginalMember(owner = "client!tca", name = "k", descriptor = "I")
    public static int field8119;

    @OriginalMember(owner = "client!tca", name = "l", descriptor = "[Lbe;")
    public static class196[] field8120;

    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(B)V", line = 3)
    public static void method3259(byte arg0) {
        field8121 = null;
        field8120 = null;
        int var1 = 18 % ((77 - arg0) / 44);
    }

    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ZB)V", line = 14)
    public static final void method3260(boolean arg0, byte arg1) {
        field8119++;
        if (arg1 != -103) {
            return;
        }
        class223.field2944.method346(class223.field2944.field637, 0, false);
        class223.field2944.method346(class223.field2944.field619, 0, false);
        ...
        class223.field2944.method346(class223.field2944.field610, 0, false);
        class223.field2944.method346(class223.field2944.field585, 0, false);
        class223.field2944.method346(class223.field2944.field591, 0, false);
        ...
        class223.field2944.method346(class223.field2944.field609, 1, false);
        class681.method3687((byte) 90);
