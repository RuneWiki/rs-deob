...
public class class585 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZLts;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IBI)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLjava/io/File;)[B", line = 89)
