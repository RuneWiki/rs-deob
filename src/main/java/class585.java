...
public class class585 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V")
