...
public class class585 extends class38 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!kha", name = "f", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "()V", line = 210)
    public class585() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kha", name = "b", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(BI)[I", line = 251)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IBI)Z", line = 294)
    ...
    @OriginalMember(owner = "client!kha", name = "c", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!kha", name = "b", descriptor = "(II)[I", line = 328)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IILrg;)V", line = 347)
