...
public class class585 extends class354 {
    ...
    @OriginalMember(owner = "client!kha", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kha", name = "c", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(Lwo;)V", line = 38)
    public class585(class746 arg0) {
        super(arg0);
        class236.method1479(super.field4545, true);
    }

    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!kha", name = "b", descriptor = "(B)I", line = 66)
    ...
    @OriginalMember(owner = "client!kha", name = "b", descriptor = "(II)I", line = 76)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Lsl;Z)Lkd;", line = 91)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(B)I", line = 105)
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(ILwo;)V", line = 118)
    public class585(int arg0, class746 arg1) {
        super(arg0, arg1);
        class236.method1479(super.field4545, true);
    }

    @OriginalMember(owner = "client!kha", name = "d", descriptor = "(I)Z", line = 129)
