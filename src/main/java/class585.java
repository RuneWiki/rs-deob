...
public class class585 extends class393 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!saa", name = "OA", descriptor = "(CIIIZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(CIIIZLua;II)V", line = 155)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lst;Lfo;[Lut;[I[I)V", line = 218)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "([B[IIIIIIII)V", line = 262)
