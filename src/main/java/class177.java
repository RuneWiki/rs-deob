...
public class class177 extends class747 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ldc;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(II)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 128)
    public class177() {
        super(1, false);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IILuv;I)V", line = 131)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)[I", line = 157)
