...
public class class177 {
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(III)V", line = 204)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)V", line = 10)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)[[[I", line = 60)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BI)[[I", line = 133)
