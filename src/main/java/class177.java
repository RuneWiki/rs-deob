...
public class class177 extends class287 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lvj;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(III)I", line = 46)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILvj;I)V", line = 89)
