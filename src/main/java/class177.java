...
public class class177 extends class92 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IILqv;)V")
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Llh;Lgp;Lom;)V")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILco;Ljava/lang/String;)I")
