...
public class class177 {
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!kg", name = "d", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(I)I", line = 241)
    ...
    @OriginalMember(owner = "client!kg", name = "f", descriptor = "(I)Z", line = 268)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "()V", line = 285)
    private class177() {
    }

    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "([I)V", line = 295)
