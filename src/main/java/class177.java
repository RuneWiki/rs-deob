...
public class class177 extends class601 {
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "()V", line = 3)
    public class177() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wda", name = "f", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IB)[I", line = 21)
    ...
    @OriginalMember(owner = "client!wda", name = "g", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lqf;I)I", line = 69)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(II)[[I", line = 82)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIZI)Lfda;", line = 128)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lmc;II)V", line = 196)
