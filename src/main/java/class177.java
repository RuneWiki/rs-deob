...
public class class177 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)[Lwb;", line = 9)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I[FI)[F", line = 108)
