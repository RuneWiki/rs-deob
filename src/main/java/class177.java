...
public class class177 extends class251 implements class192 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lbl;III)V", line = 226)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lbl;IIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)Lll;", line = 63)
    ...
    @OriginalMember(owner = "client!kd", name = "finalize", descriptor = "()V", line = 140)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(II)V", line = 150)
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lha;IZ)V", line = 197)
