...
public class class177 extends class168 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)J", line = 5)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)J", line = 39)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 104)
    public class177() {
        this.field2280 = System.nanoTime();
        this.field2279 = System.nanoTime();
    }

    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)I", line = 67)
