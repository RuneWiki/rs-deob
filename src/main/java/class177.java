...
public abstract class class177 extends class41 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IILqa;IZLha;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kg", name = "h", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!kg", name = "i", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!kg", name = "d", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(IIIIIII)V", line = 104)
