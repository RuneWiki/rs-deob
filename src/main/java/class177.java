...
public class class177 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lqa;IIIIILm;)V", line = 5)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BII)Ljava/lang/String;", line = 90)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILjava/lang/String;)I", line = 132)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 155)
