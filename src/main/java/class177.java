...
public class class177 extends class13 {
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZII)Lec;", line = 26)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)I", line = 243)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 268)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(BI)[B", line = 284)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)I", line = 303)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(II)V", line = 321)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(B)I", line = 353)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "(II)Lo;", line = 368)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)I", line = 392)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)I", line = 517)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)Ljp;", line = 535)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Z)I", line = 633)
    public final int method1257(boolean arg0) {
        field2514++;
        return arg0 ? this.field2523 : 108;
    }

    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(ILnf;Lnf;Lpn;Lee;IIZ)V", line = 1016)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BIII)V", line = 656)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "(I)V", line = 737)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(Z)V", line = 782)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "(I)V", line = 965)
