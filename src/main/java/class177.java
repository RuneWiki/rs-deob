...
public class class177 extends class381 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IILmv;I)Lak;", line = 66)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lu;)V", line = 85)
