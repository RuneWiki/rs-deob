...
public class class177 {
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(I)V", line = 106)
