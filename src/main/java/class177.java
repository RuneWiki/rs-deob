...
public class class177 extends class430 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ZLcs;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "()V", line = 485)
    public class177() {
    }

    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(I)V", line = 487)
