...
public class class177 extends class147 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(II)V", line = 40)
    public final void method871(int arg0, int arg1) {
        int var3 = -125 % ((arg0 - 61) / 42);
        this.field2139 = ByteBuffer.allocateDirect(arg1 * 4);
    }

    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIIFI)V", line = 48)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(B[II)V", line = 163)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lto;IIIII)V", line = 288)
