...
public class class177 extends class238 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIZLgj;)Lkc;")
    ...
    @OriginalMember(owner = "client!dfa", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
