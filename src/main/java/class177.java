...
public class class177 extends class623 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILjava/awt/Component;Z)Leda;", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILfh;)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(ILfh;)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "()V", line = 128)
    public static final void method1093() {
        class36.field387 = class36.field383;
    }

    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(Z)I", line = 133)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 149)
    public class177(String arg0) {
        this.field2080 = arg0;
        this.field2081 = new class347();
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 158)
