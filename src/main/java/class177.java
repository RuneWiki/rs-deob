...
public class class177 extends class299 {
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILoi;)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Les;)V")
