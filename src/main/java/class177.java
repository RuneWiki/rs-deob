...
public class class177 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILsi;B)V", line = 73)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)Z", line = 104)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lsi;I)V", line = 129)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)V", line = 148)
