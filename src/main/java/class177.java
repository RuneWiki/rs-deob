...
public class class177 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(CLjava/lang/String;I)[Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lih;)V", line = 172)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BILsv;)Z", line = 64)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IB)Z", line = 85)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZZIIII)V", line = 101)
