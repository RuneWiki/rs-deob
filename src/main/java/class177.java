...
public class class177 implements class251 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lv;BIZ)Lda;", line = 6)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()V", line = 54)
    public final void method1073() {
        this.field1980 = Thread.currentThread();
        this.method1070();
    }

    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 62)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()V", line = 76)
