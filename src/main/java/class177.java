...
public class class177 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLofa;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILul;ZILla;I)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lofa;BI)V")
