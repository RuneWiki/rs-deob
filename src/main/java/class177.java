...
public class class177 extends class85 {
    ...
    @OriginalMember(owner = "client!tb", name = "eb", descriptor = "Llf;")
    private static class109 field3346 = class35.method275("Connection lost)3", 2);

    @OriginalMember(owner = "client!tb", name = "Z", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!tb", name = "ab", descriptor = "Lbg;")
    public static class18 field3342;

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(II)Lhe;")
