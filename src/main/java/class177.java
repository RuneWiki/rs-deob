...
public class class177 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Loa;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIILq;ILoa;ILba;Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(FFFZ)I", line = 82)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Loa;Lbfa;IIIIIIZI)V", line = 646)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BI)V", line = 213)
    ...
    @OriginalMember(owner = "client!pq", name = "finalize", descriptor = "()V", line = 224)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILoa;)V", line = 238)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IZLoa;ZIIZ)Lba;", line = 247)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBIII)Z", line = 386)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(III)V", line = 413)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II)V", line = 523)
