...
public class class177 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILoa;B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILoa;IIIIIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(I[Ltda;IIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BI)Z", line = 256)
