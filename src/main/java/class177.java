...
public class class177 extends class66 {
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(CIIIZLaa;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(Lqfa;Lie;[Lus;Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!bka", name = "fa", descriptor = "(CIIIZ)V", line = 290)
