...
public class class177 extends class557 {
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(II)V", line = 73)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Ler;)V", line = 89)
    public class177(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(III)V", line = 125)
    ...
    @OriginalMember(owner = "client!ru", name = "g", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(B)Z", line = 218)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILwh;Lwh;I)V", line = 236)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 392)
