...
public class class177 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ILd;)I")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lek;Z)V")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lek;II)V")
