...
public class class177 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Llo;Z[[[BIB)Z")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Les;II)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Les;III)V")
