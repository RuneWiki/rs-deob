...
public class class177 implements Runnable {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)Lue;", line = 3)
    public final class131 method1366(byte arg0) {
        return arg0 == 41 ? this.method1385(5, 24336, 0, 0, (Object) null) : null;
    }

    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(B)Lue;", line = 15)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;B)Lue;", line = 31)
    public final class131 method1368(String arg0, byte arg1) {
        int var3 = 120 % ((19 - arg1) / 51);
        return this.method1385(16, 24336, 0, 0, arg0);
    }

    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 587)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/Class;B)Lue;", line = 49)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILjava/awt/Frame;)Lue;", line = 114)
    public final class131 method1371(int arg0, Frame arg1) {
        return arg0 == 1 ? this.method1385(7, 24336, 0, 0, arg1) : null;
    }

    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)Lue;", line = 125)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)Lue;", line = 141)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;I)Lue;", line = 151)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(B)Lue;", line = 161)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ZLjava/net/URL;)Lue;", line = 171)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/Class;I)Lue;", line = 181)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lue;", line = 191)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIILjava/lang/Object;I)Lue;", line = 201)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILjava/awt/Point;[IBILjava/awt/Component;)Lue;", line = 241)
    ...
    @OriginalMember(owner = "client!vj", name = "run", descriptor = "()V", line = 252)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILjava/awt/Component;Z)Lue;", line = 375)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(Ljava/lang/String;I)[B", line = 393)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IZLjava/lang/String;)Lue;", line = 404)
    public final class131 method1383(int arg0, boolean arg1, String arg2) {
        return arg1 ? this.method1385(1, 24336, 0, arg0, arg2) : null;
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/Runnable;ZI)Lue;", line = 414)
    public final class131 method1384(Runnable arg0, boolean arg1, int arg2) {
        return arg1 ? this.method1385(2, 24336, 0, arg2, arg0) : null;
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIILjava/lang/Object;)Lue;", line = 426)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/awt/Component;III)Lue;", line = 457)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;[Ljava/lang/Class;)Lue;", line = 469)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lue;", line = 479)
    ...
    @OriginalMember(owner = "client!vj", name = "d", descriptor = "(B)Z", line = 493)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(I)V", line = 527)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BLjava/lang/Class;)Lue;", line = 538)
    public final class131 method1391(byte arg0, Class arg1) {
        int var3 = -11 % ((40 - arg0) / 53);
        return this.method1385(11, 24336, 0, 0, arg1);
    }

    @OriginalMember(owner = "client!vj", name = "d", descriptor = "(I)Lpg;", line = 547)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIBII)Lue;", line = 564)
