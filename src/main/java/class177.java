...
public class class177 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZI)Lpb;", line = 20)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)V", line = 65)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lai;ILic;Lic;)V", line = 156)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BIII)I", line = 127)
