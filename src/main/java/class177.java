...
public class class177 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(III)I", line = 17)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)I", line = 39)
