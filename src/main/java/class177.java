...
public class class177 extends class477 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lrh;II)V", line = 82)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IILjava/lang/String;)V", line = 92)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BII)V", line = 109)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIIIIII)V", line = 120)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lsc;Ltg;)V", line = 147)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZI[Leo;III)V", line = 1265)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(B)V", line = 1317)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(B)V", line = 1331)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lgk;)V", line = 1344)
