...
public class class177 extends class235 {
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lro;B)Lro;", line = 21)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIII[I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZI)V", line = 241)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIB)Z", line = 144)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I[III)Z", line = 166)
    ...
    @OriginalMember(owner = "client!as", name = "e", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I[IIB)Z", line = 259)
