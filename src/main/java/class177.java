...
public class class177 extends class134 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZLge;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(I)V", line = 80)
    public static void method1228(int arg0) {
        int var1 = 92 % ((arg0 - -15) / 49);
        field2450 = null;
    }

    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(Z)Lqe;", line = 97)
