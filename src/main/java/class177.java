...
public class class177 extends class304 {
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "()Lti;", line = 37)
    public final class304 method151() {
        return (class304) this.field2505.method1018(114);
    }

    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lwr;)V", line = 41)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lvu;Lwr;)V", line = 55)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!jl", name = "f", descriptor = "()V", line = 86)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "()I", line = 104)
    public final int method143() {
        return 0;
    }

    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "([III)V", line = 162)
