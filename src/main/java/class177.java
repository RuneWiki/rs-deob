...
public class class177 extends class218 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Les;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lho;)V", line = 19)
    public final synchronized void method1272(class218 arg0) {
        this.field2523.method1961(arg0, 26413);
    }

    @OriginalMember(owner = "client!jj", name = "c", descriptor = "([III)V", line = 24)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(Lho;)V", line = 33)
    public final synchronized void method1274(class218 arg0) {
        arg0.method2785((byte) -120);
    }

    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lvg;Les;)V", line = 98)
    ...
    @OriginalMember(owner = "client!jj", name = "e", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "()Lho;", line = 124)
    public final class218 method1251() {
        return (class218) this.field2523.method1970(64);
    }

    @OriginalMember(owner = "client!jj", name = "d", descriptor = "()I", line = 129)
    public final int method1237() {
        return 0;
    }

    @OriginalMember(owner = "client!jj", name = "b", descriptor = "()Lho;", line = 136)
    public final class218 method1260() {
        return (class218) this.field2523.method1960(24);
    }

    @OriginalMember(owner = "client!jj", name = "b", descriptor = "([III)V", line = 149)
    ...
    @OriginalMember(owner = "client!jj", name = "f", descriptor = "()I", line = 194)
