...
public class class177 extends class253 implements class371 {
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(Lqd;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(Lqd;)V", line = 8)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lsq;I[BIZ)V", line = 12)
    public class177(class96 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2915 = arg1;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "()I", line = 16)
    public final int method85() {
        return super.method85();
    }

    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lsq;ILjava/nio/ByteBuffer;Z)V", line = 19)
    public class177(class96 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field2915 = arg1;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I[BI)V", line = 23)
    public final void method83(int arg0, byte[] arg1, int arg2) {
        this.method1754(arg1, arg2);
        this.field2915 = arg0;
    }

    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Lqd;)V", line = 27)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "()V", line = 30)
    public final void method1224() {
        this.field4117.method627(this);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lqd;)V", line = 33)
