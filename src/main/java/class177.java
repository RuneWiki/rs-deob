...
public class class177 extends class512 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ljava/lang/Object;ILnv;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lqs;B)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lol;Z)Z")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZILia;)V")
