...
public class class177 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;BLjagdx/IDirect3DSwapChain;)V", line = 15)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IZ)I", line = 58)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 66)
