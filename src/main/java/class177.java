...
public class class177 extends class59 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(CIIIZLaa;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([B[IIIIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!sq", name = "fa", descriptor = "(CIIIZ)V", line = 192)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 256)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "([B[IIIIIIII)V", line = 353)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Luj;Lfp;[Lfw;[I[I)V", line = 408)
