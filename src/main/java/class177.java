...
public class class177 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)Lpca;")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IB)Lba;")
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(I)Lpca;")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILwba;)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lwba;)V")
