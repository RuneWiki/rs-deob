...
public class class177 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Z)V", line = 62)
