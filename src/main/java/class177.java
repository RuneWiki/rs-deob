...
public class class177 extends class377 {
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "()V", line = 21)
    public class177() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)[I", line = 25)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Loa;Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IILji;)V", line = 181)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lqj;B)[Ldm;", line = 202)
