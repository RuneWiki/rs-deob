...
public class class59 extends class14 {
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "()V", line = 4)
    public class59() {
        super(0, true);
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IBLmd;)V", line = 8)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZIIIIZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IB)[I", line = 106)
    ...
    @OriginalMember(owner = "client!in", name = "d", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!in", name = "e", descriptor = "(I)V", line = 286)
