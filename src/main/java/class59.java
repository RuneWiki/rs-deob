...
public class class59 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!VZUGTFOW", name = "o", descriptor = "[LYHASUFYG;")
    ...
    @OriginalMember(owner = "client!VZUGTFOW", name = "p", descriptor = "LPNNSUEUM;")
    public class39 field1505;

    @OriginalMember(owner = "client!VZUGTFOW", name = "n", descriptor = "LSKZHQGHX;")
