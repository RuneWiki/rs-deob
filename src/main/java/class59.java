...
public class class59 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)Lbh;", line = 4)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIIIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIIILep;IIIIII)Z", line = 139)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)V", line = 577)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lkr;ILok;Lok;)V", line = 596)
