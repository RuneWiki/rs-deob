...
public class class59 extends class31 implements class269 {
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(ILqa;)Lso;", line = 6)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILqa;)V", line = 17)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILqa;Z)Lr;", line = 40)
    ...
    @OriginalMember(owner = "client!qh", name = "e", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lqa;Lcn;IIIIIZII)V", line = 78)
    ...
    @OriginalMember(owner = "client!qh", name = "f", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILqa;II)Z", line = 99)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZLqa;)V", line = 132)
    public final void method336(boolean arg0, class206 arg1) {
        this.field578.method3677(arg0, arg1);
        ++field561;
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 142)
    ...
    @OriginalMember(owner = "client!qh", name = "d", descriptor = "(I)Z", line = 154)
    public final boolean method317(int arg0) {
        ++field580;
        return arg0 != 64 ? false : false;
    }

    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(ILqa;)Loj;", line = 165)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)I", line = 215)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)Z", line = 226)
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lqa;Z)V", line = 250)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Z)I", line = 261)
