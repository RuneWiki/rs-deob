...
public class class59 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILr;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "([[ZZIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lr;IIB)V", line = 279)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIBI)V", line = 354)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 392)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIILr;)V", line = 423)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lbi;Led;)V", line = 508)
