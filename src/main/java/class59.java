...
@OriginalClass("client!UGDYQAXI")
public class class59 {

    @OriginalMember(owner = "client!UGDYQAXI", name = "a", descriptor = "I")
    public int field1497 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "b", descriptor = "Z")
    public boolean field1498 = true;

    @OriginalMember(owner = "client!UGDYQAXI", name = "f", descriptor = "I")
    public int field1502 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "h", descriptor = "I")
    public int field1504 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "i", descriptor = "I")
    public int field1505 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "j", descriptor = "I")
    public int field1506 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "l", descriptor = "B")
    public byte field1508 = 1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "m", descriptor = "I")
    public int field1509 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "p", descriptor = "Z")
    public boolean field1512 = true;

    @OriginalMember(owner = "client!UGDYQAXI", name = "q", descriptor = "I")
    public int field1513 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "r", descriptor = "I")
    private int field1514 = 128;

    @OriginalMember(owner = "client!UGDYQAXI", name = "s", descriptor = "I")
    public int field1515 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "t", descriptor = "I")
    private int field1516 = 543;

    @OriginalMember(owner = "client!UGDYQAXI", name = "u", descriptor = "I")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "D", descriptor = "I")
    public int field1526 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "E", descriptor = "I")
    private int field1527 = 128;

    @OriginalMember(owner = "client!UGDYQAXI", name = "F", descriptor = "I")
    public int field1528 = -1;

    @OriginalMember(owner = "client!UGDYQAXI", name = "G", descriptor = "I")
    public int field1529 = 32;

    @OriginalMember(owner = "client!UGDYQAXI", name = "J", descriptor = "J")
    public long field1532 = -1L;

    @OriginalMember(owner = "client!UGDYQAXI", name = "L", descriptor = "Z")
    private boolean field1534 = false;

    @OriginalMember(owner = "client!UGDYQAXI", name = "I", descriptor = "LTUCAQTOR;")
    public static class58 field1531 = new class58(-37, 30);

    @OriginalMember(owner = "client!UGDYQAXI", name = "c", descriptor = "I")
    private int field1499;

    @OriginalMember(owner = "client!UGDYQAXI", name = "k", descriptor = "I")
    public static int field1507;

    @OriginalMember(owner = "client!UGDYQAXI", name = "o", descriptor = "I")
    private static int field1511;

    @OriginalMember(owner = "client!UGDYQAXI", name = "v", descriptor = "I")
    private int field1518;

    @OriginalMember(owner = "client!UGDYQAXI", name = "H", descriptor = "I")
    private int field1530;

    @OriginalMember(owner = "client!UGDYQAXI", name = "K", descriptor = "LKHOMSBHW;")
    private static class30 field1533;

    @OriginalMember(owner = "client!UGDYQAXI", name = "z", descriptor = "Lclient;")
    public static client field1522;

    @OriginalMember(owner = "client!UGDYQAXI", name = "d", descriptor = "Ljava/lang/String;")
    public String field1500;

    @OriginalMember(owner = "client!UGDYQAXI", name = "C", descriptor = "[B")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "n", descriptor = "[I")
    public int[] field1510;

    @OriginalMember(owner = "client!UGDYQAXI", name = "w", descriptor = "[I")
    private int[] field1519;

    @OriginalMember(owner = "client!UGDYQAXI", name = "y", descriptor = "[I")
    private static int[] field1521;

    @OriginalMember(owner = "client!UGDYQAXI", name = "M", descriptor = "[I")
    private int[] field1535;

    @OriginalMember(owner = "client!UGDYQAXI", name = "x", descriptor = "[LUGDYQAXI;")
    private static class59[] field1520;

    @OriginalMember(owner = "client!UGDYQAXI", name = "N", descriptor = "[Ljava/lang/String;")
    public String[] field1536;

    @OriginalMember(owner = "client!UGDYQAXI", name = "a", descriptor = "(LSYUGXMZF;)V")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "a", descriptor = "(I)LUGDYQAXI;")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "b", descriptor = "(I)LGEUHTGZJ;")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "a", descriptor = "(LKHOMSBHW;I)V")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "a", descriptor = "(B)LUGDYQAXI;")
    ...
    @OriginalMember(owner = "client!UGDYQAXI", name = "a", descriptor = "(IIB[I)LGEUHTGZJ;")
