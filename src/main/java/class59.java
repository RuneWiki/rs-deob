...
public class class59 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)Lrq;", line = 7)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lhj;Lsr;)V", line = 63)
