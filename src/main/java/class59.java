...
public class class59 extends class459 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIILjava/lang/Class;)Laba;", line = 7)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lip;IZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 220)
