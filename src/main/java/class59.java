...
public class class59 extends class604 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lcm;)Lqr;", line = 8)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
