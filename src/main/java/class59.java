...
@OriginalClass("client!XBHMGKWV")
public class class59 {

    @OriginalMember(owner = "client!XBHMGKWV", name = "h", descriptor = "Z")
    public boolean field1550 = false;

    @OriginalMember(owner = "client!XBHMGKWV", name = "i", descriptor = "I")
    public int field1551 = -1;

    @OriginalMember(owner = "client!XBHMGKWV", name = "a", descriptor = "I")
    private static int field1543;

    @OriginalMember(owner = "client!XBHMGKWV", name = "b", descriptor = "I")
    public static int field1544;

    @OriginalMember(owner = "client!XBHMGKWV", name = "e", descriptor = "I")
    public int field1547;

    @OriginalMember(owner = "client!XBHMGKWV", name = "f", descriptor = "I")
    public int field1548;

    @OriginalMember(owner = "client!XBHMGKWV", name = "g", descriptor = "I")
    public int field1549;

    @OriginalMember(owner = "client!XBHMGKWV", name = "j", descriptor = "I")
    public int field1552;

    @OriginalMember(owner = "client!XBHMGKWV", name = "d", descriptor = "Ljava/lang/String;")
    public String field1546;

    @OriginalMember(owner = "client!XBHMGKWV", name = "c", descriptor = "[LXBHMGKWV;")
    public static class59[] field1545;

    @OriginalMember(owner = "client!XBHMGKWV", name = "a", descriptor = "(ILCVNWKEAW;)V")
    ...
    @OriginalMember(owner = "client!XBHMGKWV", name = "a", descriptor = "(ILXOUQUKZW;B)V")
