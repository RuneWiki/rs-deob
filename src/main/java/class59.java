...
public abstract class class59 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Loca;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIILsp;Lsp;III)V")
