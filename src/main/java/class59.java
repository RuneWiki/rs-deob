...
public class class59 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILpu;)V")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BI)Lef;")
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lkr;ILpu;)V")
