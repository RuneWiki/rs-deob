...
public class class59 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 5)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lqa;Ldda;BLdda;)V", line = 164)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IB)V", line = 182)
