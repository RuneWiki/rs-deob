...
public class class59 extends class298 {
    ...
    @OriginalMember(owner = "client!lh", name = "B", descriptor = "()Z", line = 5)
    public final boolean method424() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "()Z", line = 8)
    public final boolean method425() {
        return this.field914;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIII[BII)V", line = 14)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "()V", line = 189)
    ...
    @OriginalMember(owner = "client!lh", name = "F", descriptor = "()F", line = 228)
    public final float method428() {
        return this.field905;
    }

    @OriginalMember(owner = "client!lh", name = "r", descriptor = "()Lug;", line = 231)
    public final class118 method429() {
        return new class367();
    }

    @OriginalMember(owner = "client!lh", name = "h", descriptor = "(I)Z", line = 235)
    public final boolean method430(int arg0) {
        return this.field909.method1962(arg0, -11999).field48;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 241)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIII)Z", line = 267)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(Z)V", line = 296)
    public final void method433(boolean arg0) {
        this.field900 = arg0;
        this.field890.method372(114);
    }

    @OriginalMember(owner = "client!lh", name = "L", descriptor = "()Z", line = 300)
    public final boolean method434() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(IIIIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lwh;I)V", line = 2419)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(II)I", line = 441)
    public final int method436(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lin;III)V", line = 446)
    ...
    @OriginalMember(owner = "client!lh", name = "e", descriptor = "(IIII)V", line = 484)
    public final void method438(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIIIIIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(IIIII)V", line = 522)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lke;)V", line = 598)
    public final void method441(class295 arg0) {
    }

    @OriginalMember(owner = "client!lh", name = "G", descriptor = "()Z", line = 601)
    public final boolean method442() {
        return true;
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(IIIII)V", line = 605)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIIII)V", line = 893)
    ...
    @OriginalMember(owner = "client!lh", name = "i", descriptor = "(I)Z", line = 962)
    public final boolean method445(int arg0) {
        return this.field909.method1960(false, arg0);
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lvn;[Lok;Z)Los;", line = 966)
    ...
    @OriginalMember(owner = "client!lh", name = "E", descriptor = "()V", line = 995)
    public final void method447() {
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II[[I[[IIII)Lda;", line = 1000)
    ...
    @OriginalMember(owner = "client!lh", name = "l", descriptor = "()V", line = 1002)
    public final void method449() {
    }

    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(III)V", line = 1005)
    ...
    @OriginalMember(owner = "client!lh", name = "I", descriptor = "()I", line = 1010)
    public final int method451() {
        return this.field893;
    }

    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(I)Ldc;", line = 1013)
    public final class247 method452(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lqb;Lai;Lug;Laj;I)V", line = 1016)
    ...
    @OriginalMember(owner = "client!lh", name = "K", descriptor = "()V", line = 1019)
    ...
    @OriginalMember(owner = "client!lh", name = "q", descriptor = "()V", line = 1033)
    ...
    @OriginalMember(owner = "client!lh", name = "z", descriptor = "()V", line = 1045)
    public final void method456() {
        this.field890.method372(115);
    }

    @OriginalMember(owner = "client!lh", name = "D", descriptor = "()I", line = 1048)
    public final int method457() {
        return this.field907;
    }

    @OriginalMember(owner = "client!lh", name = "j", descriptor = "()F", line = 1052)
    public final float method458() {
        return this.field906;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/Runnable;)Lmb;", line = 1057)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIII)V", line = 1069)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ldc;)V", line = 1084)
    public final void method461(class247 arg0) {
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(IIII)V", line = 1087)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lok;Z)Ll;", line = 1107)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "([Lqb;Lai;Lug;[Laj;I)V", line = 1210)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(II)I", line = 1225)
    public final int method465(int arg0, int arg1) {
        int var3 = arg0 | 66560;
        return var3 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!lh", name = "d", descriptor = "()I", line = 1234)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lke;Lke;FLke;)Lke;", line = 1241)
    public final class295 method467(class295 arg0, class295 arg1, float arg2, class295 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ld;IIII)Lqb;", line = 1244)
    ...
    @OriginalMember(owner = "client!lh", name = "g", descriptor = "()Z", line = 1248)
    public final boolean method469() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "f", descriptor = "()I", line = 1255)
    ...
    @OriginalMember(owner = "client!lh", name = "H", descriptor = "()V", line = 1260)
    ...
    @OriginalMember(owner = "client!lh", name = "m", descriptor = "()V", line = 1272)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(F)V", line = 1281)
    public final void method473(float arg0) {
        this.field915 = (int) (arg0 * 65535.0F);
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "([I)V", line = 1286)
    ...
    @OriginalMember(owner = "client!lh", name = "j", descriptor = "(I)[I", line = 1293)
    ...
    @OriginalMember(owner = "client!lh", name = "x", descriptor = "()V", line = 1318)
    public final void method476() {
        this.field897 = this.field913;
        this.field901 = false;
    }

    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(IIII)V", line = 1323)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lug;)V", line = 1334)
    public final void method478(class118 arg0) {
        this.field908 = (class367) arg0;
    }

    @OriginalMember(owner = "client!lh", name = "t", descriptor = "()Z", line = 1337)
    public final boolean method479() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "([Lqb;Lug;[Laj;I)V", line = 1341)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(FF)V", line = 1357)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 1362)
    public final void method482(Canvas arg0) {
        this.field903 = arg0;
        this.method454();
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)V", line = 1367)
    ...
    @OriginalMember(owner = "client!lh", name = "k", descriptor = "(I)Z", line = 1391)
    public final boolean method484(int arg0) {
        return this.field900 || this.field909.method1962(arg0, -11999).field34;
    }

    @OriginalMember(owner = "client!lh", name = "A", descriptor = "()Z", line = 1397)
    public final boolean method485() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)V", line = 1402)
    public final void method486(int arg0) {
        this.method435(0, 0, this.field889, this.field917, arg0, 0);
    }

    @OriginalMember(owner = "client!lh", name = "l", descriptor = "(I)I", line = 1406)
    public final int method487(int arg0) {
        return this.field909.method1962(arg0, -11999).field37 & 65535;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IFFFFF)V", line = 1410)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(II)V", line = 1419)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(IIII)[I", line = 1427)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(FFF)V", line = 1454)
    public final void method491(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)V", line = 1462)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(IIIIII)V", line = 1479)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 1696)
    public final void method494(int arg0) {
        this.field878[arg0].method2183((Runnable) null, 4096);
    }

    @OriginalMember(owner = "client!lh", name = "J", descriptor = "()I", line = 1699)
    public final int method495() {
        return 0;
    }

    @OriginalMember(owner = "client!lh", name = "i", descriptor = "()Z", line = 1702)
    public final boolean method496() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "h", descriptor = "()Z", line = 1705)
    public final boolean method497() {
        return true;
    }

    @OriginalMember(owner = "client!lh", name = "C", descriptor = "()Z", line = 1708)
    public final boolean method498() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)V", line = 1718)
    public final void method499(boolean arg0) {
    }

    @OriginalMember(owner = "client!lh", name = "e", descriptor = "()I", line = 1721)
    public final int method500() {
        return 0;
    }

    @OriginalMember(owner = "client!lh", name = "w", descriptor = "()Z", line = 1724)
    public final boolean method501() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(Z)V", line = 1735)
    public final void method502(boolean arg0) {
    }

    @OriginalMember(owner = "client!lh", name = "v", descriptor = "()Z", line = 1738)
    public final boolean method503() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II[I[I)Lsf;", line = 1741)
    public final class421 method504(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class158(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I[Ldn;)V", line = 1743)
    public final void method505(int arg0, class16[] arg1) {
    }

    @OriginalMember(owner = "client!lh", name = "n", descriptor = "()V", line = 1746)
    public final void method506() {
    }

    @OriginalMember(owner = "client!lh", name = "y", descriptor = "()Z", line = 1749)
    public final boolean method507() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "()V", line = 1755)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lai;)V", line = 1768)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(IIIII)V", line = 1804)
    ...
    @OriginalMember(owner = "client!lh", name = "e", descriptor = "(IIIIII)V", line = 1876)
    ...
    @OriginalMember(owner = "client!lh", name = "M", descriptor = "()V", line = 1882)
    ...
    @OriginalMember(owner = "client!lh", name = "m", descriptor = "(I)[I", line = 1906)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "([IIIII)Ll;", line = 1929)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILsf;II)V", line = 1966)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(IIIIII)Lke;", line = 2029)
    public final class295 method516(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!lh", name = "u", descriptor = "()Z", line = 2032)
    public final boolean method517() {
        return true;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III[I)V", line = 2037)
    ...
    @OriginalMember(owner = "client!lh", name = "p", descriptor = "()Lug;", line = 2069)
    public final class118 method519() {
        class334 var1 = this.method459(Thread.currentThread());
        return var1.field4906;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 2074)
    ...
    @OriginalMember(owner = "client!lh", name = "k", descriptor = "()Z", line = 2111)
    public final boolean method521() {
        return true;
    }

    @OriginalMember(owner = "client!lh", name = "o", descriptor = "()V", line = 2116)
    public final void method522() {
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIZ)Ll;", line = 2122)
    ...
    @OriginalMember(owner = "client!lh", name = "s", descriptor = "()Z", line = 2158)
    public final boolean method524() {
        return false;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)V", line = 2161)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIIILsf;II)V", line = 2169)
    ...
    @OriginalMember(owner = "client!lh", name = "g", descriptor = "(I)V", line = 2410)
