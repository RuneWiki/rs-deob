...
public class class59 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([I[IIIIFFFFFFFFFFFFFFFF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFFFFIII)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFFFFI)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([I[IIIIFFFFFFFFFFFFFFFFFFFF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([I[FIIIIIFF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFFFFFFF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([I[FIIIIIFFFF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFFFFFFFFFFIIIIIIIIFIFIF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFFFFFFFFFFIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([I[FIIIIIFFFFFFFF)V")
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lfga;Lrd;)V")
