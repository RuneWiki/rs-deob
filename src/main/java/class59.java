...
public class class59 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILac;)V", line = 53)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(B)Lac;", line = 78)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(B)Lac;", line = 244)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(Z)Lac;", line = 264)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "()V", line = 312)
    public class59() {
        this.field677.field5565 = this.field677;
        this.field677.field5564 = this.field677;
    }

    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(Z)I", line = 290)
