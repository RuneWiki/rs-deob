...
public class class59 extends class22 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)Lll;", line = 8)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lig;Ljava/lang/Object;I)V", line = 34)
    public class59(class281 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field923 = arg1;
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ds", name = "g", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(B)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ds", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 91)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IILfc;I)Lgr;", line = 109)
