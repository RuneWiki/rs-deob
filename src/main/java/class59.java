...
public class class59 extends class294 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "([Lam;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "()V", line = 90)
    public final void method456() {
        this.field812 = true;
    }

    @OriginalMember(owner = "client!hn", name = "b", descriptor = "()V", line = 93)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "()V", line = 105)
    public final void method458() {
        this.field826 = true;
    }

    @OriginalMember(owner = "client!hn", name = "d", descriptor = "()Lim;", line = 108)
    public final class268 method459() {
        return this.field825;
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Ltq;J)Z", line = 113)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!hn", name = "e", descriptor = "()V", line = 168)
    public static void method461() {
        field813 = null;
        field815 = null;
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Ltq;[Lqt;Z)V", line = 175)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(IIIII)V", line = 248)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(J)V", line = 255)
    public final void method464(long arg0) {
        this.field820 = arg0;
    }

    @OriginalMember(owner = "client!hn", name = "f", descriptor = "()V", line = 262)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Ltq;J[Lqt;[Lam;Z)V", line = 289)
    ...
    @OriginalMember(owner = "client!hn", name = "g", descriptor = "()V", line = 301)
