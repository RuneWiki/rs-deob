...
public class class59 extends class45 {
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(II)Las;")
    ...
    @OriginalMember(owner = "client!in", name = "g", descriptor = "(I)[Lop;")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lcu;II)V")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZZLli;Ljava/lang/String;)V")
