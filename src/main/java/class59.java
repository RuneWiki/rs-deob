...
public class class59 extends class65 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lgh;B)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lla;ILla;Z)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lha;I)V")
