...
public class class59 {
    ...
    @OriginalMember(owner = "client!WLHKAARP", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!WLHKAARP", name = "c", descriptor = "[LWLHKAARP;")
    public static class59[] field1538;

    @OriginalMember(owner = "client!WLHKAARP", name = "a", descriptor = "(ZLXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!WLHKAARP", name = "a", descriptor = "(BLGLMIQHJI;)V")
