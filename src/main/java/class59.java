...
public class class59 implements class13 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(B)Ljr;")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Ltga;Ljr;Z)V")
