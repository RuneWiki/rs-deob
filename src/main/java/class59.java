...
public class class59 extends class319 {
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lwc;Lul;[Ldd;[I[I)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(CIIIZLta;II)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "([B[IIIIIIIIIIILta;II)V")
