...
public class class59 extends class184 {
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "()V", line = 8)
    public class59() {
        super(0, false);
    }

    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!tn", name = "f", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(II)[[I", line = 51)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lfh;Ljava/lang/String;B)I", line = 127)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BILfh;)V", line = 161)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 178)
