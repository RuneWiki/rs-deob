...
public class class59 {
    ...
    @OriginalMember(owner = "client!VJXKRAVR", name = "o", descriptor = "I")
    ...
    @OriginalMember(owner = "client!VJXKRAVR", name = "a", descriptor = "(LMLYYHULT;B)V")
    ...
    @OriginalMember(owner = "client!VJXKRAVR", name = "a", descriptor = "(LMLYYHULT;I)V")
