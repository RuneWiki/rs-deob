...
public class class59 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILg;IZLg;)I")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BI)Lhb;")
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lmp;ILla;)V")
