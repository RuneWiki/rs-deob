...
public abstract class class59 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[Loia;IIIIIIIII[IILjava/lang/String;ILaa;)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/util/Random;ILjava/lang/String;IIIB[I[Loia;)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;Laa;[Loia;IIIII[I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;II[II[II[Loia;ILjava/util/Random;IIII)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII[Loia;Ljava/lang/String;[II)V")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lqm;)V")
    public class59(class58 arg0, class143 arg1) {
        this.field718 = arg1;
        this.field726 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZI[ILjava/lang/String;[Loia;[II[I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III[Loia;IILaa;IIIIII[ILjava/lang/String;B)I")
