...
public class class59 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)Lwi;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lr;BLpi;I)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lgn;ILvo;)V")
