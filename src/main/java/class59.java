...
public class class59 extends class358 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lbt;)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ILuk;Luk;Z)V")
