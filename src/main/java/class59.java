...
public class class59 {
    ...
    @OriginalMember(owner = "client!UIZESDZR", name = "d", descriptor = "LKLNBCMBU;")
    ...
    @OriginalMember(owner = "client!UIZESDZR", name = "b", descriptor = "[LUIZESDZR;")
    ...
    @OriginalMember(owner = "client!UIZESDZR", name = "a", descriptor = "(II)LUIZESDZR;")
