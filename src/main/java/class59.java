...
public class class59 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)Lke;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZLco;)Lbd;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lvk;I)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)Lke;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lke;Z)V")
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(I)Lke;")
