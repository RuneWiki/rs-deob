...
public abstract class class59 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIBLd;Lwu;ILjava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IBI[III)Lhu;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lhu;I)V")
