...
public abstract class class59 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)B", line = 5)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 35)
