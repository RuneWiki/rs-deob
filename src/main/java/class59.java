...
public class class59 {
    ...
    @OriginalMember(owner = "client!TOAGRHDF", name = "d", descriptor = "LIZSDUVJF;")
    public class27 field1334 = new class27();

    @OriginalMember(owner = "client!TOAGRHDF", name = "e", descriptor = "LIZSDUVJF;")
    ...
    @OriginalMember(owner = "client!TOAGRHDF", name = "a", descriptor = "(LIZSDUVJF;)V")
    ...
    @OriginalMember(owner = "client!TOAGRHDF", name = "a", descriptor = "()LIZSDUVJF;")
    ...
    @OriginalMember(owner = "client!TOAGRHDF", name = "b", descriptor = "()LIZSDUVJF;")
    ...
    @OriginalMember(owner = "client!TOAGRHDF", name = "a", descriptor = "(I)LIZSDUVJF;")
