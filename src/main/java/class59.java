...
public class class59 extends class42 {
    ...
    @OriginalMember(owner = "client!rf", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lrk;B)Z", line = 33)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IILms;IBIIIILms;)V", line = 69)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!rf", name = "e", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!rf", name = "e", descriptor = "(I)[B", line = 151)
