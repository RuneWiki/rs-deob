...
public class class59 extends class11 {
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lms;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!mq", name = "OA", descriptor = "(IILi;)Li;")
    public final class197 method86(int arg0, int arg1, class197 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!mq", name = "ba", descriptor = "(Li;IIIIZ)V")
    public final void method73(class197 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIZLhp;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!mq", name = "H", descriptor = "(Li;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIIIII[[ZLhp;[I[I)V")
                    ...
                    if (this.field849[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field6370; ++var23) {
                            ...
                            if (var21.field6365 == null || var21.field6365[var23] == 0 || var21.field6373 != null && (var21.field6373 == null || var21.field6373[var23] != -1)) {
                                if (var21.field6373 != null && var21.field6373[var23] != -1) {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lsa;[I)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Li;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IILhp;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(IIIIIII[[ZLhp;[I[I)V")
