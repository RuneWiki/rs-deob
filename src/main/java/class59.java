...
public class class59 extends class366 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BII)B", line = 7)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Llf;B[I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IZ)I", line = 53)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Llf;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(BII)I", line = 110)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ri", name = "d", descriptor = "(B)Ljava/lang/String;", line = 152)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(Z)I", line = 189)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BLbr;)Lbr;", line = 204)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IILbk;Lml;Ljava/awt/Canvas;I)Lvq;", line = 225)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Llf;II)V", line = 251)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(Llf;I)Ljava/lang/String;", line = 317)
