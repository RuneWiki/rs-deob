...
@OriginalClass("client!XCOYGYOS")
public class class59 {

    @OriginalMember(owner = "client!XCOYGYOS", name = "a", descriptor = "I")
    private int field1535 = -752;

    @OriginalMember(owner = "client!XCOYGYOS", name = "b", descriptor = "I")
    private int field1536;

    @OriginalMember(owner = "client!XCOYGYOS", name = "e", descriptor = "I")
    public int field1539;

    @OriginalMember(owner = "client!XCOYGYOS", name = "f", descriptor = "I")
    public int field1540;

    @OriginalMember(owner = "client!XCOYGYOS", name = "g", descriptor = "I")
    public int field1541;

    @OriginalMember(owner = "client!XCOYGYOS", name = "h", descriptor = "I")
    private int field1542;

    @OriginalMember(owner = "client!XCOYGYOS", name = "i", descriptor = "I")
    private int field1543;

    @OriginalMember(owner = "client!XCOYGYOS", name = "j", descriptor = "I")
    private int field1544;

    @OriginalMember(owner = "client!XCOYGYOS", name = "k", descriptor = "I")
    private int field1545;

    @OriginalMember(owner = "client!XCOYGYOS", name = "l", descriptor = "I")
    private int field1546;

    @OriginalMember(owner = "client!XCOYGYOS", name = "m", descriptor = "I")
    public static int field1547;

    @OriginalMember(owner = "client!XCOYGYOS", name = "c", descriptor = "[I")
    private int[] field1537;

    @OriginalMember(owner = "client!XCOYGYOS", name = "d", descriptor = "[I")
    private int[] field1538;

    @OriginalMember(owner = "client!XCOYGYOS", name = "a", descriptor = "(LZOMNSJJM;B)V")
    ...
    @OriginalMember(owner = "client!XCOYGYOS", name = "a", descriptor = "(LZOMNSJJM;I)V")
    ...
    @OriginalMember(owner = "client!XCOYGYOS", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!XCOYGYOS", name = "a", descriptor = "(II)I")
