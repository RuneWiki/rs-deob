...
public class class59 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IZI)Z", line = 11)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 34)
    public static void method506(int arg0) {
        int var1 = -70 / ((-arg0 - 71) / 48);
        field802 = null;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BII)Z", line = 53)
