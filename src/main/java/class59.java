...
public class class59 extends class677 {
    ...
    @OriginalMember(owner = "client!lj", name = "i", descriptor = "(I)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
