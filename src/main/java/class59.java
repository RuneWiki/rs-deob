...
public class class59 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLjava/lang/String;ZIZILjava/lang/String;IIIJ)V", line = 34)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLfp;Lic;)V", line = 98)
