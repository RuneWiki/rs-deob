...
public abstract class class59 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/awt/Component;ZZ)Lml;", line = 12)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(B)Z", line = 82)
