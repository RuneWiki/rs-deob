...
@OriginalClass("client!TOROBAKX")
public class class59 extends class1 {

    @OriginalMember(owner = "client!TOROBAKX", name = "D", descriptor = "Z")
    private boolean field1471 = true;

    @OriginalMember(owner = "client!TOROBAKX", name = "E", descriptor = "B")
    private byte field1472 = 5;

    @OriginalMember(owner = "client!TOROBAKX", name = "F", descriptor = "Z")
    private boolean field1473 = false;

    @OriginalMember(owner = "client!TOROBAKX", name = "M", descriptor = "I")
    public int field1480;

    @OriginalMember(owner = "client!TOROBAKX", name = "N", descriptor = "I")
    public int field1481;

    @OriginalMember(owner = "client!TOROBAKX", name = "H", descriptor = "[I")
    public int[] field1475;

    @OriginalMember(owner = "client!TOROBAKX", name = "K", descriptor = "I")
    public int field1478;

    @OriginalMember(owner = "client!TOROBAKX", name = "L", descriptor = "I")
    public int field1479;

    @OriginalMember(owner = "client!TOROBAKX", name = "I", descriptor = "I")
    public int field1476;

    @OriginalMember(owner = "client!TOROBAKX", name = "J", descriptor = "I")
    public int field1477;

    @OriginalMember(owner = "client!TOROBAKX", name = "G", descriptor = "[B")
    public byte[] field1474;

    @OriginalMember(owner = "client!TOROBAKX", name = "C", descriptor = "I")
    private static int field1470 = 8;

    @OriginalMember(owner = "client!TOROBAKX", name = "<init>", descriptor = "(LFIGUVTWB;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "a", descriptor = "(IIZI)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!TOROBAKX", name = "a", descriptor = "(IIII[II[I[BBI)V")
