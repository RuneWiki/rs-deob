...
public abstract class class59 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;IIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIILjava/lang/String;III)V", line = 36)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/util/Random;ILjava/lang/String;IIIIII[I[Lhu;[III)I", line = 115)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[Lhu;Ljava/lang/String;[I[I[IZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IZI[Lhu;IILjava/lang/String;IIIIILaa;I[III)I", line = 356)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lur;)V", line = 455)
    public class59(class58 arg0, class535 arg1) {
        this.field598 = arg0;
        this.field600 = arg1;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 466)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 480)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[IILjava/lang/String;I[Lhu;BI)V", line = 555)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;ILjava/util/Random;II[IIII[Lhu;)I", line = 573)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 613)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BI)Z", line = 648)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 665)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lhu;I[ILjava/lang/String;IIILaa;)V", line = 706)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZIIIIIILjava/lang/String;)V", line = 856)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[Lhu;[IILaa;IIIIIILjava/lang/String;III)I", line = 897)
