...
@OriginalClass("client!VGUAJUPX")
public class class59 extends class1 {

    @OriginalMember(owner = "client!VGUAJUPX", name = "x", descriptor = "I")
    private int field1400 = -723;

    @OriginalMember(owner = "client!VGUAJUPX", name = "E", descriptor = "Z")
    public boolean field1407 = false;

    @OriginalMember(owner = "client!VGUAJUPX", name = "J", descriptor = "Z")
    private boolean field1412 = false;

    @OriginalMember(owner = "client!VGUAJUPX", name = "p", descriptor = "LOQOGSGFM;")
    private class37 field1392;

    @OriginalMember(owner = "client!VGUAJUPX", name = "u", descriptor = "I")
    public int field1397;

    @OriginalMember(owner = "client!VGUAJUPX", name = "q", descriptor = "I")
    public int field1393;

    @OriginalMember(owner = "client!VGUAJUPX", name = "r", descriptor = "I")
    public int field1394;

    @OriginalMember(owner = "client!VGUAJUPX", name = "s", descriptor = "I")
    public int field1395;

    @OriginalMember(owner = "client!VGUAJUPX", name = "z", descriptor = "I")
    public int field1402;

    @OriginalMember(owner = "client!VGUAJUPX", name = "A", descriptor = "I")
    public int field1403;

    @OriginalMember(owner = "client!VGUAJUPX", name = "B", descriptor = "I")
    public int field1404;

    @OriginalMember(owner = "client!VGUAJUPX", name = "C", descriptor = "I")
    public int field1405;

    @OriginalMember(owner = "client!VGUAJUPX", name = "D", descriptor = "I")
    public int field1406;

    @OriginalMember(owner = "client!VGUAJUPX", name = "t", descriptor = "I")
    public int field1396;

    @OriginalMember(owner = "client!VGUAJUPX", name = "k", descriptor = "D")
    public double field1387;

    @OriginalMember(owner = "client!VGUAJUPX", name = "l", descriptor = "D")
    public double field1388;

    @OriginalMember(owner = "client!VGUAJUPX", name = "m", descriptor = "D")
    public double field1389;

    @OriginalMember(owner = "client!VGUAJUPX", name = "y", descriptor = "D")
    private double field1401;

    @OriginalMember(owner = "client!VGUAJUPX", name = "F", descriptor = "D")
    private double field1408;

    @OriginalMember(owner = "client!VGUAJUPX", name = "G", descriptor = "D")
    private double field1409;

    @OriginalMember(owner = "client!VGUAJUPX", name = "H", descriptor = "D")
    private double field1410;

    @OriginalMember(owner = "client!VGUAJUPX", name = "I", descriptor = "D")
    private double field1411;

    @OriginalMember(owner = "client!VGUAJUPX", name = "n", descriptor = "I")
    public int field1390;

    @OriginalMember(owner = "client!VGUAJUPX", name = "o", descriptor = "I")
    public int field1391;

    @OriginalMember(owner = "client!VGUAJUPX", name = "v", descriptor = "I")
    private int field1398;

    @OriginalMember(owner = "client!VGUAJUPX", name = "w", descriptor = "I")
    private int field1399;

    @OriginalMember(owner = "client!VGUAJUPX", name = "K", descriptor = "I")
    private int field1413;

    @OriginalMember(owner = "client!VGUAJUPX", name = "a", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!VGUAJUPX", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!VGUAJUPX", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!VGUAJUPX", name = "a", descriptor = "(Z)LYYHPBDED;")
