...
public class class171 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lji;I)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lgg;ZZ)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILji;I)V")
