...
public class class171 extends class478 {
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILnp;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "()V", line = 48)
    public class171() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZI)[[I", line = 128)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 210)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIILtq;Ltq;)V", line = 241)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIBI)Lsp;", line = 293)
