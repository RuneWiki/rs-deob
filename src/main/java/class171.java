...
public class class171 extends class457 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lmk;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZB)V", line = 118)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)V", line = 141)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lef;Lmc;)V", line = 153)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILod;[[B)V", line = 180)
