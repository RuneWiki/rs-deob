...
public class class171 extends class90 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I[B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILjava/lang/String;)V", line = 195)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lgq;)V", line = 213)
    public class171(class226 arg0) {
        this.field2432 = arg0;
    }

    @OriginalMember(owner = "client!ve", name = "f", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILje;)V", line = 236)
