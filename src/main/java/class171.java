...
public class class171 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILea;ZIIIZ)Lts;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BLea;ZIIIILts;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lea;Lp;IIIIIIZI)V")
