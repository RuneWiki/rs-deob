...
public class class171 extends class49 {
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(IILha;)Lhw;", line = 9)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!pja", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 63)
