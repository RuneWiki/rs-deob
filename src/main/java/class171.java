...
public class class171 extends class415 {
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 43)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!wk", name = "e", descriptor = "(I)V", line = 98)
