...
public class class171 extends class13 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lkh;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)Llb;", line = 30)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ZI)[I", line = 56)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 80)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIBLhh;IIIIIII)Z", line = 157)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIBIII)V", line = 406)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "()V", line = 442)
    public class171() {
        this(4096);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IZ)Lph;", line = 445)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Z)V", line = 469)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(I)V", line = 479)
    ...
    @OriginalMember(owner = "client!cd", name = "e", descriptor = "(B)V", line = 493)
