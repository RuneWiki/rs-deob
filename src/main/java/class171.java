...
public class class171 extends class63 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lwe;Z)I")
