...
public class class171 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILrk;BII)V", line = 13)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IB[Ljava/lang/Object;[JI)V", line = 69)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(III)V", line = 125)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lle;ILoi;)V", line = 147)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 164)
