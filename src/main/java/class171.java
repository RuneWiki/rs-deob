...
public class class171 extends class96 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IZLica;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZB)V", line = 46)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lml;Lau;)V", line = 92)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZII)V", line = 63)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZI)V", line = 115)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Z)Z", line = 144)
