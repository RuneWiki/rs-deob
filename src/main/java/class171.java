...
public class class171 extends class242 implements Runnable {
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)V", line = 60)
    public final void method1164(boolean arg0) {
        this.field2112 = arg0;
        field2115++;
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ZLdg;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIIII)I", line = 234)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lio;)V", line = 293)
    public class171(class692 arg0) {
        this.field2119 = arg0;
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!pq", name = "run", descriptor = "()V", line = 282)
