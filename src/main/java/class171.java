...
public abstract class class171 extends class455 {
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!se", name = "g", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(IIIZZ)V", line = 133)
