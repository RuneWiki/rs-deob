...
public class class171 extends class747 {
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BII)Luv;", line = 46)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II)[I", line = 155)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 191)
    public class171() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(B)Z", line = 194)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(IIB)V", line = 210)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ldc;II)V", line = 222)
