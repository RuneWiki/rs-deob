...
public class class171 extends class263 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ZZI)Lkd;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lya;IILgo;B)V")
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "(I)[Lkq;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IZLgk;)V")
