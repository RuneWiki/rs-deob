...
public class class171 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lok;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lok;Ljaclib/memory/Buffer;)V", line = 21)
