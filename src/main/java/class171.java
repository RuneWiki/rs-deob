...
public class class171 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)Lkp;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)Lkp;")
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Llb;)V")
