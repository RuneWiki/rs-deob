...
public class class171 extends class38 {
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)Lnf;", line = 164)
