...
public class class171 extends class195 {
    ...
    @OriginalMember(owner = "client!ov", name = "q", descriptor = "(CIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(CIIIZLfa;II)V", line = 26)
    public final void method17(char arg0, int arg1, int arg2, int arg3, boolean arg4, class213 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lfo;Led;[Laaa;Z)V", line = 30)
