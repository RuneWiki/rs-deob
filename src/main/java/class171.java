...
public class class171 extends class576 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B[BII)I", line = 8)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!dq", name = "finalize", descriptor = "()V", line = 68)
    protected final void finalize() {
        this.method1164(62);
        field2431++;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IBI[B)V", line = 107)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)V", line = 117)
