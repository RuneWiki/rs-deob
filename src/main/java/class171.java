...
public abstract class class171 {
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIII)I", line = 43)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ZI[I)V", line = 113)
