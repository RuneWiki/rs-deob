...
public class class171 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IBI)Lhp;")
    ...
    @OriginalMember(owner = "client!uk", name = "d", descriptor = "(II)Lwh;")
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Ljk;IZLfs;Lfs;)V")
