...
public class class171 extends class123 {
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(IIIIIF)V", line = 8)
    public class171(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIBI)V", line = 12)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BII)Z", line = 25)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(FI)V", line = 36)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Z)V", line = 48)
