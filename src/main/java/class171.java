...
public class class171 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(III)Lal;", line = 10)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BI)Lvp;", line = 24)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZIZLpd;Lpd;II)I", line = 35)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)Lrp;", line = 67)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(II)V", line = 80)
    public class171(int arg0, int arg1) {
        this.field2568 = arg0;
        this.field2569 = arg1;
    }

    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lvp;I)V", line = 88)
