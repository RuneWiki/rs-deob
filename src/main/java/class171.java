...
public class class171 extends class21 implements Runnable {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IBI)I", line = 14)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ua", name = "d", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lnl;)V", line = 302)
    public class171(class143 arg0) {
        this.field2294 = arg0;
    }

    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIILwl;Lcl;IIIILjava/lang/String;Lps;Lud;)V", line = 214)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ZILlm;Llm;)V", line = 271)
    ...
    @OriginalMember(owner = "client!ua", name = "run", descriptor = "()V", line = 284)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIB)V", line = 313)
