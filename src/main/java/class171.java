...
public class class171 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lov;B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lr;IIZ)Lla;", line = 25)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "([BIII)[B", line = 41)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Llaa;I)Lkl;", line = 76)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIIBIIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)V", line = 111)
    public static void method1208(byte arg0) {
        int var1 = -88 % ((arg0 - 16) / 63);
        field2478 = null;
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 147)
