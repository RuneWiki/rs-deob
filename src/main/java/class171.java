...
public class class171 {
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(ILhca;Lhca;I)V", line = 146)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([BIII)Z", line = 12)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)[B", line = 42)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I[BZII)Z", line = 159)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!vp", name = "toString", descriptor = "()Ljava/lang/String;", line = 295)
