...
public class class171 extends class278 {
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Llh;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "()V", line = 57)
    public class171() {
        this(4096);
    }

    @OriginalMember(owner = "client!mb", name = "h", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(II)[I", line = 84)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(CB)C", line = 108)
    ...
    @OriginalMember(owner = "client!mb", name = "i", descriptor = "(I)V", line = 149)
