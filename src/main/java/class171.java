...
public class class171 {
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lod;[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lod;Ljaggl/memory/NativeBuffer;)V", line = 13)
    public class171(class349 arg0, NativeBuffer arg1) {
        this.field2532 = arg0;
        this.field2533 = arg1;
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "([BI)V", line = 22)
