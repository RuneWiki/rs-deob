...
public class class171 extends class115 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljava/awt/Canvas;IZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljava/awt/Graphics;IIIIIII)V", line = 35)
