...
public class class171 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBI)V", line = 76)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(III)V", line = 154)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)[[I", line = 127)
