...
public class class171 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lofa;B)Lofa;", line = 19)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(JZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IZLkha;)V", line = 119)
