...
public class class171 extends class45 {
    ...
    @OriginalMember(owner = "client!mb", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "()V", line = 30)
    public class171() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lcu;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(II)[[I", line = 82)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(II)[I", line = 221)
