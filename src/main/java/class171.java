...
public class class171 extends class60 implements class1 {
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lbt;ILjaggl/memory/NativeBuffer;)V", line = 4)
    public class171(class33 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field2540 = arg1;
    }

    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lbt;I[BI)V", line = 15)
    public class171(class33 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field2540 = arg1;
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(III[B)V", line = 23)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Z)I", line = 38)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BLjava/lang/String;)V", line = 49)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILl;Ljava/awt/Canvas;I)Lqa;", line = 62)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)Z", line = 88)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Z)J", line = 100)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 121)
