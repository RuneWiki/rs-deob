...
public class class785 implements class381 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIIILln;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIII)V", line = 78)
