...
public class class785 {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 58)
