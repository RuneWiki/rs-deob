...
public class class785 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(BIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIILtda;IIIIIILjk;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(IIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(II)Lgfa;", line = 156)
