...
public class class785 extends class617 {
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(IIIII)V", line = 3)
    public class785(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!nca", name = "d", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(Lha;I)Lrn;", line = 18)
    ...
    @OriginalMember(owner = "client!nca", name = "f", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!nca", name = "c", descriptor = "(ILha;)V", line = 62)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(BI)Ljba;", line = 74)
    ...
    @OriginalMember(owner = "client!nca", name = "e", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IIILha;)Z", line = 105)
    ...
    @OriginalMember(owner = "client!nca", name = "f", descriptor = "(B)I", line = 148)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Lha;I)Lmaa;", line = 183)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(Z)I", line = 361)
