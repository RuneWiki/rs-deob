...
public class class785 extends class578 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IBI)V", line = 35)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I[III)V", line = 61)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IZI)Z", line = 76)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I[III)V", line = 94)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(IIIIIIIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(III)Z", line = 125)
