...
public class class785 extends class417 implements class274 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lha;Lih;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(ILha;)Lid;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lha;IIZ)Lsa;")
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IILuaa;B)V")
    ...
    @OriginalMember(owner = "client!uv", name = "i", descriptor = "(B)V")
