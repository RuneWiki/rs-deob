...
public class class268 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILqh;II)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILqh;Z)Z")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIBLqh;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lks;Ldl;)V")
