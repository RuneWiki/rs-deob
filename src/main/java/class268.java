...
public class class268 extends class338 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IZIIILvm;)V", line = 3)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!j", name = "e", descriptor = "(I)V", line = 243)
