...
public class class268 extends class210 {
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IBI)Z", line = 20)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Leea;IIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Leea;IIII[BI)V", line = 72)
    ...
    @OriginalMember(owner = "client!kv", name = "f", descriptor = "(I)V", line = 92)
