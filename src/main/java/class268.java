...
public abstract class class268 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 5)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(IIIII)V", line = 307)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BIII)V", line = 129)
