...
public class class268 extends class525 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILwn;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lwn;I[I)V")
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(ILwn;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II)Lvr;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILwn;)V")
