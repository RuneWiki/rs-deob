...
public class class268 extends class62 {
    ...
    @OriginalMember(owner = "client!fda", name = "h", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IB)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "()V", line = 141)
    public class268() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fda", name = "g", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZLjava/awt/Component;)Ldj;", line = 81)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lgw;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(II)[I", line = 147)
