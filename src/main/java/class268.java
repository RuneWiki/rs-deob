...
public class class268 extends class97 implements class425 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIZLii;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!j", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(Lii;I)Leb;", line = 32)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lii;Lge;IIIIIIIZI)V", line = 71)
    ...
    @OriginalMember(owner = "client!j", name = "e", descriptor = "(I)Z", line = 80)
    public final boolean method166(int arg0) {
        ++field3869;
        return arg0 != -17506;
    }

    @OriginalMember(owner = "client!j", name = "g", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ILii;)V", line = 120)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BLii;)V", line = 135)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lii;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I)I", line = 160)
    public final int method121(int arg0) {
        ++field3879;
        return arg0 != -15123 ? 87 : this.field3880.field5038;
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(I)I", line = 172)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!j", name = "h", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ILii;I)Ldc;", line = 239)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)V", line = 250)
