...
public class class268 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZBIIZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BI)V", line = 256)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)V", line = 292)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(III)V", line = 316)
    private class268(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "()V", line = 330)
    public class268() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B[BLiv;)V", line = 336)
