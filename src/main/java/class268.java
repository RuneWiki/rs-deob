...
public class class268 extends class165 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILmia;)V", line = 5)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Lrv;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IZ[B)[B", line = 88)
