...
public class class268 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IBII)V", line = 137)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIIIIIIIII)V", line = 169)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)V", line = 252)
