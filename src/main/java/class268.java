...
public class class268 extends class125 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ZI)I", line = 17)
    public final int method155(boolean arg0, int arg1) {
        ++field3816;
        return !arg0 ? -82 : 1;
    }

    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!nda", name = "c", descriptor = "(Z)I", line = 54)
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lgp;)V", line = 77)
    public class268(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(ILgp;)V", line = 81)
    public class268(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(III)Z", line = 84)
