...
public class class268 extends class793 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)I", line = 31)
    public final int method1592(int arg0) {
        field3542++;
        return arg0 == -19898 ? this.field3540 : 56;
    }

    @OriginalMember(owner = "client!wb", name = "g", descriptor = "(I)J", line = 44)
    ...
    @OriginalMember(owner = "client!wb", name = "e", descriptor = "(I)I", line = 57)
    public final int method1593(int arg0) {
        field3545++;
        return arg0 == 20259 ? this.field3546 : 51;
    }

    @OriginalMember(owner = "client!wb", name = "h", descriptor = "(I)V", line = 75)
