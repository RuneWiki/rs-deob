...
public class class268 extends class261 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(B)V", line = 20)
    public static void method1704(byte arg0) {
        int var1 = -87 % ((-arg0 - 34) / 47);
        field4060 = null;
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BLsf;)I", line = 31)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 60)
    public class268() {
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 233)
