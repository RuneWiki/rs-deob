...
public class class268 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lsv;)V", line = 17)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)[I", line = 81)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(III)I", line = 363)
