...
public class class268 {
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)Lag;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)Lag;")
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(B)Lag;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "([Lag;I)I")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIILml;II)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLag;J)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILqg;I)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(JI)Lag;")
