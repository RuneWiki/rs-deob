...
public class class268 extends class346 {
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!kd", name = "c", descriptor = "(II)[[I", line = 73)
    ...
    @OriginalMember(owner = "client!kd", name = "e", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!kd", name = "f", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lfb;ZI)V", line = 172)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "()V", line = 246)
    public class268() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(Z)V", line = 259)
