...
public class class268 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)[Ljk;")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lwq;I)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BLwt;)V")
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lwq;)V")
