...
public class class268 extends class345 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IBII)I", line = 18)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZB[B)V", line = 57)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BILya;I)Z", line = 102)
