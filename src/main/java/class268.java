...
public class class268 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lae;)V", line = 43)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIIIIBI)V", line = 119)
