...
public class class268 extends class321 {
    ...
    @OriginalMember(owner = "client!ne", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(IIIIIF)V", line = 32)
    public class268(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ne", name = "h", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(FI)V", line = 73)
