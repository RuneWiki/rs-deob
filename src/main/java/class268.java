...
public class class268 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B[ILfv;J)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(II)Llc;")
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(II)Lbaa;")
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(ILjo;Ljo;Loo;)V")
