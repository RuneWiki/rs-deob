...
public abstract class class268 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lla;Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(IIIII)V", line = 343)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 269)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BI)V", line = 320)
