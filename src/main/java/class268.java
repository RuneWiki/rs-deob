...
public class class268 extends class402 {
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lpc;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZLlc;Ljava/lang/String;ZLjava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBLfha;)V")
