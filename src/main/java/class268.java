...
public class class268 extends class148 {
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(II)[[I", line = 8)
    ...
    @OriginalMember(owner = "client!cl", name = "f", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!cl", name = "g", descriptor = "(I)V", line = 68)
