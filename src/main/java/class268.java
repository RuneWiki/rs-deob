...
public class class268 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(II)Lot;", line = 33)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lnp;I)Liq;", line = 71)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 123)
