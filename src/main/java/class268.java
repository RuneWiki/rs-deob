...
public class class268 extends class105 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(IIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(III)Z", line = 85)
