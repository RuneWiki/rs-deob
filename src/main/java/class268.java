...
public class class268 extends class27 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ILjc;)V", line = 4)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)Z", line = 25)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Llj;)V", line = 72)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILvf;)V", line = 165)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(III)V", line = 191)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I[Ljava/lang/Object;[I)V", line = 201)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lrs;B)V", line = 237)
