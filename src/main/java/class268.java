...
public class class268 extends class318 {
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(III)Lqv;")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lav;IB)V")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lkd;Luo;)V")
