...
public class class268 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lem;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)Lgj;", line = 87)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(ILni;Lni;Laia;)V", line = 519)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lvea;[IBJ)Ljava/lang/String;", line = 130)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILgaa;B)V", line = 150)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIIILqfa;)V", line = 193)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 483)
