...
public class class268 extends class184 {
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "()V", line = 19)
    public class268() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)[I", line = 35)
