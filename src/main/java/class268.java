...
public class class268 extends class72 {
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I[BIIII[BII)V", line = 32)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I[BII)Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(ILcq;)V", line = 117)
    public class268(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "(I)I", line = 133)
    public final int method1792(int arg0) {
        ++field3872;
        return arg0 != 27669 ? -4 : super.field1282;
    }

    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lcq;)V", line = 148)
    public class268(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lha;BI)Lfp;", line = 151)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)I", line = 167)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III)V", line = 179)
