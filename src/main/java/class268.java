...
public class class268 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIII)Leo;", line = 6)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)V", line = 54)
