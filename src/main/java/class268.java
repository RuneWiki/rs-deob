...
public class class268 extends class641 implements class532 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ZILoa;I)Lun;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Loa;Lbd;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Loa;IB)Lba;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Loa;BI)Lba;")
