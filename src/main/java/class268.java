...
public abstract class class268 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BILet;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!pc", name = "finalize", descriptor = "()V", line = 808)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I[BI)V", line = 819)
    ...
    @OriginalMember(owner = "client!pc", name = "d", descriptor = "(I)V", line = 846)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Leq;I[BIZ)V", line = 858)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Leq;ILjaclib/memory/Buffer;IZ)V", line = 877)
