...
public class class268 extends class134 implements class55 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lqa;Lpk;IIIIIZIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lqa;I)Lip;", line = 28)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)V", line = 70)
    public final void method361(int arg0) {
        int var2 = -17 / ((-36 - arg0) / 36);
        ++field3671;
    }

    @OriginalMember(owner = "client!br", name = "b", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lqa;III)Z", line = 118)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILqa;)Lc;", line = 137)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)I", line = 148)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILqa;)V", line = 173)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(ILqa;)V", line = 186)
    ...
    @OriginalMember(owner = "client!br", name = "e", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(ILqa;)V", line = 225)
