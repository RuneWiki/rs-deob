...
public class class268 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!nba", name = "toString", descriptor = "()Ljava/lang/String;", line = 48)
    public final String toString() {
        field4038++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(III)V", line = 126)
