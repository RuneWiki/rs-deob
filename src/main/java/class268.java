...
public class class268 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "()V", line = 31)
    public class268() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "([BLkk;Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILnl;I)Lkg;", line = 82)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(III)V", line = 99)
