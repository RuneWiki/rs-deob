...
public class class268 extends class194 {
    ...
    @OriginalMember(owner = "client!sd", name = "j", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZF)V", line = 177)
    ...
    @OriginalMember(owner = "client!sd", name = "f", descriptor = "(IB)I", line = 193)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FI)V", line = 208)
    ...
    @OriginalMember(owner = "client!sd", name = "v", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(I)V", line = 237)
