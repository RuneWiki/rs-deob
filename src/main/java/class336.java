...
public abstract class class336 extends class745 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLha;)Z")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I[Lmfa;)I")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
