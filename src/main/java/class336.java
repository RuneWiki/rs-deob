...
public class class336 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ltia;I)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lkh;JI)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(JB)Lkh;")
