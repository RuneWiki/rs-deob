...
public class class336 implements class515 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IIIBLjava/lang/String;Lda;)I")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IZ)Lom;")
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lnt;Llp;)V")
