...
public abstract class class336 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)Z", line = 52)
    public static final boolean method2050(boolean arg0) {
        field4901++;
        return arg0 ? class250.field3408 : false;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(B)V", line = 63)
