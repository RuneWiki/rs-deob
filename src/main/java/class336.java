...
public class class336 extends class401 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "([B[IILon;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "()V", line = 101)
    public class336() {
    }

    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "([B)V", line = 103)
