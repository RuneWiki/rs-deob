...
public class class336 extends class379 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(ZZLkaa;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(II)Z", line = 63)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(B)V", line = 84)
