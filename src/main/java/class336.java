...
public class class336 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ILjava/lang/String;)I", line = 11)
    ...
    @OriginalMember(owner = "client!fda", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field4996++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(III)I", line = 49)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)V", line = 76)
