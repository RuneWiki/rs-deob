...
public class class336 extends class501 {
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lbo;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lbo;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lbo;II)V")
