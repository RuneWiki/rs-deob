...
public class class336 extends class37 {
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lcga;Ltu;B)Lmc;", line = 32)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(I)V", line = 67)
