...
public class class336 implements class215 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "([IJBLjn;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Luq;Z[[[BIB)Z", line = 35)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 98)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 109)
