...
public abstract class class336 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(FIIFFILcq;IIFIF[B)V")
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(Lrda;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(Lrda;ILjaclib/memory/Buffer;IZ)V")
