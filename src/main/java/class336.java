...
public class class336 extends class220 {
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 3)
    public class336() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lqj;ILqj;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lqj;ILqj;Lfj;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ol", name = "f", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(BI)V", line = 97)
    ...
    @OriginalMember(owner = "client!ol", name = "e", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(II)[I", line = 145)
