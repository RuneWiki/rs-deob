...
public class class336 extends class541 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIIIIII[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "e", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(ZI)V", line = 123)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(II)V", line = 155)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Los;II[BI)V", line = 182)
