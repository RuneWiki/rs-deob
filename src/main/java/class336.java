...
public class class336 implements Runnable {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 39)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(B)I", line = 72)
    ...
    @OriginalMember(owner = "client!tg", name = "run", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!tg", name = "finalize", descriptor = "()V", line = 161)
    protected final void finalize() {
        this.method1923((byte) 8);
        field4333++;
    }

    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Ljava/net/Socket;Lufa;)V", line = 340)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 198)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II[BI)V", line = 212)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[BIB)V", line = 267)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)I", line = 291)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 307)
