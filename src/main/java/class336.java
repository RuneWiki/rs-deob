...
public class class336 extends class13 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(BLha;)V", line = 39)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Leca;Luj;)V", line = 82)
    ...
    @OriginalMember(owner = "client!jo", name = "e", descriptor = "(I)V", line = 94)
