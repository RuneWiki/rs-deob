...
public class class336 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)Lbi;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILbi;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)Leh;")
