...
public abstract class class336 extends class309 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZI)V", line = 6)
    public static final void method2176(boolean arg0, int arg1) {
        class160.field2138.method2300(arg1, arg0);
        field4955++;
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "([Ljava/lang/String;Z)[Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIII[Lkg;III)V", line = 49)
    ...
    @OriginalMember(owner = "client!bf", name = "f", descriptor = "(B)V", line = 697)
    ...
    @OriginalMember(owner = "client!bf", name = "g", descriptor = "(B)V", line = 709)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 727)
