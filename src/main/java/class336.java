...
public class class336 extends class52 implements class89 {
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lse;ILjava/nio/ByteBuffer;)V")
    public class336(class282 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field4975 = arg1;
    }

    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lse;I[BI)V")
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(Lkr;)V")
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Lkr;)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lkr;)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILkr;)V")
