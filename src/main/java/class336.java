...
public class class336 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II[B[BII)I", line = 8)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "([BI[BBII)I", line = 79)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 244)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "([B)V", line = 256)
