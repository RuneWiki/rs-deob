...
public class class336 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lnf;Lna;III)V", line = 41)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(B)V", line = 54)
