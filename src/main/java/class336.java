...
public class class336 extends class86 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 67)
