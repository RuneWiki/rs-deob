...
public class class336 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "()V")
    public static void method2075() {
        field4654 = null;
    }

    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V")
