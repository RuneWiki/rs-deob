...
public class class336 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BIIIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)Lmr;", line = 163)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)Z", line = 225)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)Z", line = 251)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)Lmr;", line = 290)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lap;BI)V", line = 346)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lap;I)V", line = 423)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I[Lbi;I)V", line = 444)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(B)V", line = 525)
