...
public class class336 implements class398 {
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!wm", name = "finalize", descriptor = "()V", line = 17)
    protected final void finalize() throws Throwable {
        this.method2150();
        super.finalize();
    }

    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Ltb;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "()V", line = 27)
