...
public class class336 extends class311 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIIII)I", line = 9)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IBI)Z", line = 71)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lqg;)V", line = 218)
    public class336(class157 arg0) {
        this.field4539 = arg0;
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIIBIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 197)
