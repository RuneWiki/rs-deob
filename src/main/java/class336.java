...
public class class336 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(I)Lib;", line = 5)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Z)Lib;", line = 25)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILib;)V", line = 47)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILrea;)[I", line = 87)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(Z)Lib;", line = 121)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!jia", name = "d", descriptor = "(I)Lib;", line = 176)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "()V", line = 228)
    public class336() {
        this.field4313.field3 = this.field4313;
        this.field4313.field4 = this.field4313;
    }

    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(II)V", line = 214)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(Z)V", line = 237)
