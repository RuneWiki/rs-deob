...
public class class336 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljk;BII)V", line = 33)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 127)
