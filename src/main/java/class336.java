...
public class class336 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILtf;)V", line = 24)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIIIZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIIII)Z", line = 55)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)Z", line = 91)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "()V", line = 102)
    public class336() {
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIBIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)Lwb;", line = 158)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Ltf;)V", line = 179)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)Lwb;", line = 187)
