...
public class class336 extends class468 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lha;J)V", line = 20)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(JI)V", line = 203)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lut;IIIIIIIIIIIZZ)V", line = 597)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lut;IIIIIIIIIIIZZ)V", line = 617)
