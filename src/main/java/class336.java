...
public class class336 extends class64 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I[B[IIIIIIIILgm;)I", line = 4)
    ...
    @OriginalMember(owner = "client!gm", name = "e", descriptor = "()Z", line = 42)
    public final boolean method1921() {
        return this.field4480 != 0;
    }

    @OriginalMember(owner = "client!gm", name = "f", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)V", line = 57)
    public final synchronized void method1923(int arg0, int arg1) {
        this.method1934(arg0, arg1, this.method1929());
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II[B[IIIIIIIILgm;II)I", line = 60)
    ...
    @OriginalMember(owner = "client!gm", name = "g", descriptor = "()I", line = 93)
    public final synchronized int method1925() {
        return this.field4483 == Integer.MIN_VALUE ? 0 : this.field4483;
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I[B[IIIIIIIILgm;)I", line = 97)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([IIIII)I", line = 135)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "()Lle;", line = 190)
    public final class64 method361() {
        return null;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([III)V", line = 195)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lwo;III)Lgm;", line = 430)
    ...
    @OriginalMember(owner = "client!gm", name = "h", descriptor = "()I", line = 436)
    public final synchronized int method1929() {
        return this.field4485 < 0 ? -1 : this.field4485;
    }

    @OriginalMember(owner = "client!gm", name = "e", descriptor = "(I)V", line = 440)
    private final synchronized void method1930(int arg0) {
        this.method1953(arg0, this.method1929());
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "([IIIII)I", line = 445)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "()I", line = 500)
    public final int method365() {
        return this.field4483 == 0 && this.field4480 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II[B[IIIIIIIIIILgm;II)I", line = 507)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II)I", line = 550)
    private static final int method1933(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(III)V", line = 553)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([B[IIIIIIILgm;)I", line = 600)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II[B[IIIIIIIILgm;II)I", line = 625)
    ...
    @OriginalMember(owner = "client!gm", name = "f", descriptor = "(I)V", line = 659)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lwo;II)Lgm;", line = 666)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II[B[IIIIIIIIIILgm;II)I", line = 673)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([B[IIIIIIIILgm;)I", line = 714)
    ...
    @OriginalMember(owner = "client!gm", name = "g", descriptor = "(I)V", line = 750)
    ...
    @OriginalMember(owner = "client!gm", name = "h", descriptor = "(I)V", line = 762)
    ...
    @OriginalMember(owner = "client!gm", name = "i", descriptor = "(I)V", line = 808)
    public final synchronized void method1943(int arg0) {
        this.field4482 = arg0;
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "()I", line = 812)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II[B[IIIIIIILgm;II)I", line = 825)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I[B[IIIIIIIIIILgm;)I", line = 851)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "([B[IIIIIIIILgm;)I", line = 904)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)V", line = 939)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(II)I", line = 946)
    private static final int method1948(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(II[B[IIIIIIIILgm;II)I", line = 949)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "([B[IIIIIIILgm;)I", line = 982)
    ...
    @OriginalMember(owner = "client!gm", name = "i", descriptor = "()I", line = 1008)
    public final synchronized int method1951() {
        return this.field4475 < 0 ? -this.field4475 : this.field4475;
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II[B[IIIIIIILgm;II)I", line = 1011)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(II)V", line = 1037)
    ...
    @OriginalMember(owner = "client!gm", name = "j", descriptor = "()Z", line = 1049)
    public final boolean method1954() {
        return this.field4472 < 0 || this.field4472 >= ((class52) super.field667).field504.length << 8;
    }

    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(II[B[IIIIIIIILgm;II)I", line = 1052)
    ...
    @OriginalMember(owner = "client!gm", name = "k", descriptor = "()V", line = 1087)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "()Lle;", line = 1093)
    public final class64 method363() {
        return null;
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I[B[IIIIIIIIIILgm;)I", line = 1096)
    ...
    @OriginalMember(owner = "client!gm", name = "l", descriptor = "()Z", line = 1150)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lwo;II)V", line = 1237)
    ...
    @OriginalMember(owner = "client!gm", name = "j", descriptor = "(I)V", line = 1249)
    public final synchronized void method1959(int arg0) {
        this.method1953(arg0 << 6, this.method1929());
    }

    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lwo;III)V", line = 1251)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(I)V", line = 1263)
