...
public class class336 extends class181 {
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lfk;Lcq;[Laf;[I[I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "([B[I[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(CIIIZLfa;II)V")
    ...
    @OriginalMember(owner = "client!hf", name = "q", descriptor = "(CIIIZ)V")
