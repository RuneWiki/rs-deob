...
public class class336 {
    ...
    @OriginalMember(owner = "client!mt", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4645++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IZ)Z", line = 14)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 61)
