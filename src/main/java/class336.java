...
public class class336 {
    ...
    @OriginalMember(owner = "client!rd", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lfha;J[Lpl;)V", line = 16)
    public class336(class378 arg0, long arg1, class649[] arg2) {
        this.field4677 = arg0;
        this.field4675 = arg1;
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B[Ljb;IIZI)V", line = 58)
