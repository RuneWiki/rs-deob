...
public class class336 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(CI)V", line = 3)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lri;BLoi;Loi;Loi;)Z", line = 28)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Let;B)V", line = 59)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(I)[Leh;", line = 92)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(II)V", line = 106)
    public final void method2012(int arg0, int arg1) {
        field4864++;
        OpenGL.glNewList(this.field4858 + arg1, arg0);
    }

    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lih;I)V", line = 114)
    public class336(class503 arg0, int arg1) {
        this.field4858 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!gk", name = "c", descriptor = "(I)V", line = 129)
