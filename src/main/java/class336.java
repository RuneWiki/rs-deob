...
public class class336 extends class330 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lgga;IB)V")
    ...
    @OriginalMember(owner = "client!dea", name = "e", descriptor = "(B)V")
