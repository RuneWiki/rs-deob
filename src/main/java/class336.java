...
public class class336 extends InputStream {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!gg", name = "read", descriptor = "()I", line = 45)
    ...
    @OriginalMember(owner = "client!gg", name = "c", descriptor = "(B)[Lnn;", line = 57)
