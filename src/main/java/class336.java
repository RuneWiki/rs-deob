...
public class class336 {
    ...
    @OriginalMember(owner = "client!ef", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4731++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(II)V", line = 20)
    public class336(int arg0, int arg1) {
        this.field4730 = arg0;
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIII)Z", line = 32)
