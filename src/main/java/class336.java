...
public class class336 extends class376 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lwc;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "()Lwc;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZLeq;)V")
