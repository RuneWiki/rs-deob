...
public class class120 extends class747 {
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIFFFIFIILkt;F)[B", line = 16)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(II)[I", line = 36)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "()V", line = 105)
    public class120() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Ldc;II)V", line = 112)
