...
public abstract class class120 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BI)I", line = 10)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Las;III[Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!hm", name = "d", descriptor = "(B)V", line = 180)
