...
public abstract class class120 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BB)C", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Leq;Z)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Z", line = 138)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([BII)V", line = 196)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lih;I[BIZ)V", line = 225)
    ...
    @OriginalMember(owner = "client!ei", name = "finalize", descriptor = "()V", line = 245)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILdh;)Ljava/lang/String;", line = 256)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lih;ILjaggl/memory/NativeBuffer;IZ)V", line = 270)
