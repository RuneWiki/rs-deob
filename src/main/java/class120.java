...
public class class120 extends class672 {
    ...
    @OriginalMember(owner = "client!jr", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(Lha;I)Lrn;", line = 89)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIILha;)Z", line = 101)
    ...
    @OriginalMember(owner = "client!jr", name = "g", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZLje;IIILha;I)V", line = 169)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(IIIIIIIIIIIIIZI)V", line = 184)
    ...
    @OriginalMember(owner = "client!jr", name = "f", descriptor = "(I)Z", line = 210)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lha;ILqja;Lka;)V", line = 222)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!jr", name = "d", descriptor = "(Z)Z", line = 264)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(Z)Z", line = 285)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)V", line = 300)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(ILha;)V", line = 400)
    ...
    @OriginalMember(owner = "client!jr", name = "j", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Z)V", line = 459)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILha;)Lka;", line = 472)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(Z)I", line = 485)
    public final int method916(boolean arg0) {
        ++field1851;
        return !arg0 ? -2 : this.field1842;
    }

    @OriginalMember(owner = "client!jr", name = "e", descriptor = "(I)I", line = 499)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lha;I)Lmaa;", line = 511)
