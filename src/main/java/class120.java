...
public class class120 extends class381 {
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lda;IIIIZ[IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lda;IIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IZZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lda;IIIIZ[FI)V", line = 101)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lda;IIIIZ[BIZ)V", line = 123)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([Ljava/lang/Object;III[I)V", line = 176)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIZIIII[BII)V", line = 234)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I[IIIZIIIZ)V", line = 294)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lda;IIII)V", line = 347)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIII)V", line = 388)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILha;I)V", line = 406)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)V", line = 720)
