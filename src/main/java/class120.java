...
public class class120 {
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "[Lvc;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lbg;II)Lmh;")
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "()Lk;")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lja;)V")
