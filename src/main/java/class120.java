...
public class class120 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lza;[II)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lza;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lza;[IIII[I[I)V")
