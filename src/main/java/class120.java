...
public class class120 extends class390 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BLsc;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(II)V", line = 75)
