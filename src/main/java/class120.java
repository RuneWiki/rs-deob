...
public class class120 extends class548 {
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)Z", line = 142)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lru;II)V", line = 160)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Llf;Ltf;)V", line = 196)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZI)V", line = 208)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IJ)V", line = 223)
