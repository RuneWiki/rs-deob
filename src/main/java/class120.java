...
public class class120 extends class486 {
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)Llm;", line = 17)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(FLlm;Llm;I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)V", line = 160)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)Llk;", line = 175)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIB)V", line = 191)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(I)I", line = 204)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lgk;I)V", line = 214)
