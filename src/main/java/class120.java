...
public class class120 extends class29 implements class599 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILir;ZILr;IB)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLr;)Lqw;")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lr;Ltc;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!ud", name = "o", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(Lr;I)Lcu;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLr;I)Lda;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lr;IZI)Lht;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZLr;II)Z")
