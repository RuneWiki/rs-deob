...
public class class120 extends class35 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lvj;IILcj;Ljava/awt/Canvas;I)Lja;", line = 11)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BB)V", line = 40)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)V", line = 194)
