...
public class class120 extends class665 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(BLvh;Lr;I)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(ZLft;)V")
