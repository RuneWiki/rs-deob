...
public class class120 extends class214 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BI)[I", line = 13)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Llk;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IB)[[I", line = 122)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B[[I)V", line = 183)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "()V", line = 238)
    public class120() {
        super(0, true);
    }
}
