...
public class class120 extends class184 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 4)
    public class120() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(II)[I", line = 25)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BILfh;)V", line = 69)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIII)Z", line = 113)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(II)[[I", line = 144)
