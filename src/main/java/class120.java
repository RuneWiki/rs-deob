...
public class class120 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(B[I[III)V", line = 35)
