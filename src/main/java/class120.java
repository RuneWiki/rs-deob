...
public class class120 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 5)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILkd;)V", line = 44)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 84)
