...
public class class120 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lya;Lor;III)V", line = 12)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Lnl;", line = 65)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lee;ILul;)V", line = 120)
