...
public class class120 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(III[Ljava/lang/String;)Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)S", line = 141)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Leda;[[BZ)V", line = 172)
