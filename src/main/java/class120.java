...
public class class120 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BI)[B", line = 13)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "([BI)V", line = 80)
