...
public class class120 extends class601 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lmc;II)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IILgd;[I[II)Llm;")
