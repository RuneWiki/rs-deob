...
public class class120 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIIIIIIII)Z", line = 29)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(CB)Z", line = 79)
