...
public class class120 {
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(Lfca;B[B)V", line = 7)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "()V", line = 53)
    public class120() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!jja", name = "a", descriptor = "([BI)[B", line = 57)
    ...
    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "(III)V", line = 81)
