...
public class class120 {
    ...
    @OriginalMember(owner = "client!fv", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    public final String toString() {
        field1451++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ZIB)V", line = 56)
