...
public class class120 extends class23 {
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rc", name = "R", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!rc", name = "Q", descriptor = "(IIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!rc", name = "O", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)[F", line = 117)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BZLrk;)V", line = 137)
    ...
    @OriginalMember(owner = "client!rc", name = "na", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!rc", name = "X", descriptor = "([I)V", line = 335)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lia;I)V", line = 353)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(B)[F", line = 377)
    ...
    @OriginalMember(owner = "client!rc", name = "ZA", descriptor = "(III)V", line = 402)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIFFIIF)V", line = 415)
    ...
    @OriginalMember(owner = "client!rc", name = "YA", descriptor = "(I)V", line = 449)
    ...
    @OriginalMember(owner = "client!rc", name = "ma", descriptor = "(I)V", line = 464)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lmu;", line = 479)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(III[I)V", line = 501)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "()Lia;", line = 511)
    ...
    @OriginalMember(owner = "client!rc", name = "HA", descriptor = "()V", line = 536)
    ...
    @OriginalMember(owner = "client!rc", name = "E", descriptor = "(III[I)V", line = 545)
    ...
    @OriginalMember(owner = "client!rc", name = "ba", descriptor = "(Lia;)V", line = 573)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(I)V", line = 597)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "()V", line = 627)
    public class120() {
        this.method189();
    }
}
