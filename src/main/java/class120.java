...
public class class120 extends class65 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!cw", name = "m", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!cw", name = "t", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(I)V", line = 110)
    public class120(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cw", name = "n", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!cw", name = "u", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!cw", name = "n", descriptor = "(II)I", line = 144)
    ...
    @OriginalMember(owner = "client!cw", name = "d", descriptor = "(Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "([II)V", line = 173)
    ...
    @OriginalMember(owner = "client!cw", name = "v", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!cw", name = "w", descriptor = "(I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Luu;B)V", line = 217)
    ...
    @OriginalMember(owner = "client!cw", name = "o", descriptor = "(II)I", line = 246)
