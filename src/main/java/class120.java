...
public class class120 extends class348 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IILjava/awt/Graphics;III)V", line = 10)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 27)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILjava/awt/Graphics;BI)V", line = 50)
