...
public class class120 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([III)Lct;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II[II)Lct;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([IBII)Lct;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([IBI)Lct;")
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lwu;Lwu;)V")
