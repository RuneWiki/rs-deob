...
public class class120 extends class513 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)V", line = 37)
