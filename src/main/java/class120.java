...
public class class120 extends class29 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BILat;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Ler;)V", line = 42)
