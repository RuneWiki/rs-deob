...
public class class120 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IB)Lpr;", line = 8)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Loq;ILbu;)V", line = 72)
