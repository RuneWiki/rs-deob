...
public class class120 extends class304 {
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "()Z", line = 17)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)V", line = 24)
    public final void method624(boolean arg0) {
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lgd;)V", line = 26)
    ...
    @OriginalMember(owner = "client!df", name = "d", descriptor = "()Z", line = 36)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lse;)V", line = 57)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "()Z", line = 97)
