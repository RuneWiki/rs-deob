...
public class class120 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IILfc;[B)Lfo;", line = 8)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILjava/lang/String;C)I", line = 67)
