...
public class class120 extends class741 {
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Llba;Loca;)V", line = 25)
    public class120(class223 arg0, class639 arg1) {
        super(arg0);
        this.field1606 = arg1;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(III)V", line = 75)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IILml;)V", line = 139)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)Z", line = 154)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IZ)V", line = 165)
