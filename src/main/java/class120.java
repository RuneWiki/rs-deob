...
public class class120 {
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)Lb;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lofa;I)V")
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(I)Lb;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lofa;II)V")
