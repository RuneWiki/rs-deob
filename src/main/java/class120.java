...
public class class120 extends class43 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIILr;)Lda;")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lr;B)Llt;")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lq;ILr;Lda;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIILkj;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIZLr;ILub;I)V")
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(BLr;)Lsr;")
