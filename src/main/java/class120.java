...
public abstract class class120 extends class198 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIIIIII)I", line = 20)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BLak;Lvq;Lmq;)V", line = 67)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lvq;Lkm;III)V", line = 215)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(B)V", line = 261)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(IIII)V", line = 278)
