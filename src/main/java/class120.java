...
public abstract class class120 implements class205 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)V", line = 113)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ZII)I", line = 128)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)I", line = 151)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lbt;IIIZ)V", line = 170)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!ei", name = "finalize", descriptor = "()V", line = 224)
