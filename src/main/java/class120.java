...
public class class120 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lvp;BII)V")
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(IB)Lgt;")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lbt;ILkda;Lkda;)V")
