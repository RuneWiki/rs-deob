...
public class class120 implements class121 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IZLjava/io/File;)[B", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)Lqv;", line = 46)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(ILida;Lce;II)V", line = 61)
