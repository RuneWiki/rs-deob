...
public class class120 {
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)Loq;", line = 10)
    ...
    @OriginalMember(owner = "client!jja", name = "b", descriptor = "(I)Loq;", line = 42)
    ...
    @OriginalMember(owner = "client!jja", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "()V", line = 112)
    public class120() {
    }

    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "(Ldj;)V", line = 118)
    public class120(class362 arg0) {
        this.field1536 = arg0;
    }

    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(B)V", line = 79)
