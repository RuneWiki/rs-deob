...
public class class120 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "()Lqr;", line = 48)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "()[B", line = 57)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lri;II)Lmc;", line = 116)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Lie;)V", line = 129)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "()V", line = 149)
    private class120() {
    }
}
