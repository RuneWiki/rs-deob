...
public class class120 extends class512 {
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "()V", line = 5)
    public class120() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(II)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!rc", name = "f", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZILia;)V", line = 141)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IB)[I", line = 190)
