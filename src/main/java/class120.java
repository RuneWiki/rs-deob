...
public class class120 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZIILss;)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lss;III)Z")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZLss;II)V")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lrl;Lgb;)V")
