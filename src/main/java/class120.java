...
public class class120 extends class381 {
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(FFFFFFIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IILhb;II)V", line = 198)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIII)V", line = 255)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(FFFFFFLhb;II)V", line = 303)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIIII)V", line = 386)
    ...
    @OriginalMember(owner = "client!hm", name = "d", descriptor = "()I", line = 389)
    public final int method759() {
        return this.field1480.field1785;
    }

    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lao;IIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lao;II[III)V", line = 600)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIIIII)V", line = 399)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "()I", line = 535)
    public final int method761() {
        return this.field1480.field1785 + this.field1482 + this.field1476;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "()I", line = 540)
    public final int method762() {
        return this.field1480.field1786 + this.field1478 + this.field1477;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIII)V", line = 544)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III)V", line = 553)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "()I", line = 572)
    public final int method765() {
        return this.field1480.field1786;
    }

    @OriginalMember(owner = "client!hm", name = "e", descriptor = "()V", line = 583)
