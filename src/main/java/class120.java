...
public class class120 {
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(ILva;I)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ljava/awt/Frame;Lwea;Z)V")
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(ILva;Lva;II)V")
    private class120(int arg0, class497 arg1, class497 arg2, int arg3, int arg4) {
        this(arg0, arg1, arg2, arg3, arg4, true, false);
    }

    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)[Ljj;")
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(ILva;Lva;IIZZ)V")
