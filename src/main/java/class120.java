...
public class class120 implements class57 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lqw;BI)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILcn;II)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILcn;II)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILga;I)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILqw;II)V")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lpea;)V")
