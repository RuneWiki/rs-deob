...
public class class113 extends class270 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IB)Lbq;")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLec;I)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIILbs;ILpi;ZLjava/lang/String;Lrn;ILmb;)V")
