...
public class class113 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lad;I)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BLad;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BLad;I)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lbe;ILad;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(BLad;)V")
