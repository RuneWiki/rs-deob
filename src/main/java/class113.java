...
public class class113 {
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "Ltf;")
    ...
    @OriginalMember(owner = "client!ma", name = "p", descriptor = "[Lhd;")
    ...
    @OriginalMember(owner = "client!ma", name = "g", descriptor = "Llf;")
    private static class109 field2238 = class35.method275("shake:", 2);

    @OriginalMember(owner = "client!ma", name = "d", descriptor = "Llf;")
    public static class109 field2235 = field2238;

    @OriginalMember(owner = "client!ma", name = "l", descriptor = "Llf;")
    public static class109 field2243 = field2238;

    @OriginalMember(owner = "client!ma", name = "e", descriptor = "Leh;")
    public static class49 field2236 = new class49(8);

    @OriginalMember(owner = "client!ma", name = "r", descriptor = "Llf;")
    public static class109 field2249 = class35.method275("Wordpack geladen)3", 2);

    @OriginalMember(owner = "client!ma", name = "t", descriptor = "Llf;")
    private static class109 field2251 = class35.method275("Please contact customer support)3", 2);

    @OriginalMember(owner = "client!ma", name = "s", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ma", name = "q", descriptor = "Laa;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BLvg;)Z")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lvg;B)Z")
