...
public abstract class class113 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B[Ljava/lang/String;II[S)V", line = 26)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIII)Z", line = 103)
