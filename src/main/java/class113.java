...
public class class113 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)V")
    public static final void method796(String arg0, Applet arg1, int arg2) throws Throwable {
        JSObject.getWindow(arg1).eval(arg0);
        int var3 = 65 / ((45 - arg2) / 37);
    }

    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;")
