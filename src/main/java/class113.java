...
public class class113 extends class73 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Z)Z", line = 21)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BZII)V", line = 58)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lga;Lga;Ljp;)V", line = 123)
    public class113(class332 arg0, class332 arg1, class77 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)Z", line = 137)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZIBI)V", line = 149)
