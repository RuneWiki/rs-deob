...
public class class113 implements class620 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)Lvt;", line = 5)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 53)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lde;Lvt;Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)I", line = 96)
    public final int method248(int arg0) {
        return arg0 == -920 ? this.field1869 : -127;
    }

    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)V", line = 116)
