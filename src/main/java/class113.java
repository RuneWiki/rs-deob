...
public class class113 extends class315 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lvc;[Lof;Z)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lvc;J[Lof;[Llh;Z)V")
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!an", name = "d", descriptor = "()Lpa;")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lvc;J)Z")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([Llh;Z)V")
