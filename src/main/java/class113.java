...
public class class113 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lpu;II)Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lpu;I)[Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Lpu;II)[Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Lpu;I)Lfg;")
