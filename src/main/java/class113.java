...
public class class113 extends class244 implements class670 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Loa;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!di", name = "g", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IILoa;I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Loa;Lbfa;IIIIIZIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(B)I", line = 124)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(Loa;I)Lok;", line = 135)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Loa;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 196)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILoa;)Lgr;", line = 214)
    ...
    @OriginalMember(owner = "client!di", name = "h", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(Loa;I)V", line = 253)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(B)Z", line = 277)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IILoa;)Lba;", line = 288)
