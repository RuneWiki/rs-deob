...
public class class113 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ljava/lang/String;IILur;)Lpi;")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lah;B)V")
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lur;J[Lpi;)V")
