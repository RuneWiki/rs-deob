...
public class class113 extends class601 {
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "()V", line = 4)
    public class113() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BI)[I", line = 7)
    ...
    @OriginalMember(owner = "client!ri", name = "e", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lee;BI)V", line = 95)
