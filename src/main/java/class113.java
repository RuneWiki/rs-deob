...
public class class113 extends class572 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Ljava/awt/Component;B)Luda;", line = 6)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(I)V", line = 71)
    public class113(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IF)V", line = 77)
    ...
    @OriginalMember(owner = "client!gm", name = "t", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(IF)V", line = 106)
