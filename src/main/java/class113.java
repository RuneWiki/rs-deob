...
public abstract class class113 extends class623 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IB)I", line = 20)
    public static final int method765(int arg0, byte arg1) {
        field1391++;
        return arg1 < 77 ? -94 : arg0 & 0x3FF;
    }

    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lqq;I)V", line = 56)
