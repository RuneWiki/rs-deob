...
public class class113 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IILwq;IILha;Laa;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II[B)V", line = 288)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILeha;)V", line = 346)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 367)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 395)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)V", line = 427)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(J[BI)V", line = 457)
