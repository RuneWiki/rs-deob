...
public class class113 extends class404 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II[BI[BIIIB)V", line = 24)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(II)Z", line = 68)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(CI)Z", line = 91)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(III[B)I", line = 135)
    ...
    @OriginalMember(owner = "client!dv", name = "finalize", descriptor = "()V", line = 148)
    protected final void finalize() {
        this.method913(-10406);
        field1814++;
    }

    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Z)[Lmf;", line = 164)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)Z", line = 207)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([BIIB)V", line = 219)
