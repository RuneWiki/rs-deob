...
public class class113 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Liv;B)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)Laq;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BILiv;)V")
