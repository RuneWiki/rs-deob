...
public class class113 extends class115 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lgo;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "([B)V", line = 33)
