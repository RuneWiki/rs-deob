...
public class class113 {
    ...
    @OriginalMember(owner = "client!ng", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() throws Throwable {
        this.field1602.method1644(this.field1601);
        super.finalize();
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lnf;[Lbf;)Lng;", line = 13)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lnf;I[Lbf;)V", line = 74)
