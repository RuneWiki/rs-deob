...
public class class113 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(B[BILjc;)Lvia;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)Lw;")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lgd;Ld;)V")
