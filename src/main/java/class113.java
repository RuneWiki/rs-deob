...
public class class113 implements Runnable {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ZLqf;)V", line = 10)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I[IB)[I", line = 24)
    ...
    @OriginalMember(owner = "client!hi", name = "run", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Ljava/lang/String;B)Lo;", line = 142)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "()V", line = 226)
    public class113() {
        this.field1382.setDaemon(true);
        this.field1382.start();
    }

    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)V", line = 205)
