...
public class class113 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lpc;II)Lwq;")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "()Luo;")
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lmd;)V")
