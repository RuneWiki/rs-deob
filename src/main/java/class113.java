...
public class class113 {
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Z)V", line = 39)
