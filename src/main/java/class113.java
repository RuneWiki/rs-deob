...
public class class113 extends class43 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZILoo;ILoo;)I", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lwo;IIZLwo;)V", line = 104)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIII)I", line = 146)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "()V", line = 161)
    public class113() {
    }

    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(J)V", line = 164)
    public class113(long arg0) {
        this.field1320 = arg0;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZI)Z", line = 175)
