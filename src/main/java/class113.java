...
public class class113 extends class190 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ILnba;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lrs;Lah;)V", line = 62)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 112)
    ...
    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIB)V", line = 172)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZI)V", line = 243)
