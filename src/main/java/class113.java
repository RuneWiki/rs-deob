...
public abstract class class113 extends class539 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(Z)V", line = 42)
