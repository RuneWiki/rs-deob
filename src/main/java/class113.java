...
public class class113 extends class263 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIBIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)Lod;", line = 104)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lce;IZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)V", line = 170)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lbl;)V", line = 195)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Z", line = 249)
    public final boolean method675(int arg0) {
        ++field1917;
        return arg0 <= -112;
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(FIFF)I", line = 262)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZB)V", line = 311)
