...
public class class113 extends class338 {
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lon;Ljava/lang/Object;I)V", line = 4)
    public class113(class335 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field1191 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!bba", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)Z", line = 23)
