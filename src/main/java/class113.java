...
public class class113 extends class298 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lbi;Z)V")
    ...
    @OriginalMember(owner = "client!ge", name = "f", descriptor = "(B)Lob;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IILvt;)V")
