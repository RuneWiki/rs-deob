...
public class class113 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B[S[Ljava/lang/String;)V", line = 17)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IZ)Lwq;", line = 44)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)I", line = 79)
    public static int method838(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(B)Law;", line = 88)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(II)V", line = 98)
    public class113(int arg0, int arg1) {
        this.field1795 = arg0;
        this.field1792 = arg1;
    }

    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lwq;I)V", line = 111)
