...
public abstract class class113 extends class330 {
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILen;ILgk;Llm;Lgp;ZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(JZ)Ljava/lang/String;", line = 98)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(II)V", line = 127)
    ...
    @OriginalMember(owner = "client!sa", name = "h", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 161)
