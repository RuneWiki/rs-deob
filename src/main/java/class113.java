...
public class class113 extends class128 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/lang/String;BLir;Z)Lnr;", line = 26)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IB)Lrm;", line = 97)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)V", line = 124)
