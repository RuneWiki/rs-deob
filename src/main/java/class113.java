...
public class class113 extends class362 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "()V", line = 41)
    public class113() {
    }

    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(I)V", line = 43)
