...
public class class113 extends class130 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(JI)I", line = 3)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)J", line = 36)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)J", line = 46)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)J", line = 76)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "()V", line = 117)
    public class113() {
