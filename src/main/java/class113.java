...
public class class113 extends class424 {
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lrg;BI)V", line = 140)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 241)
    public class113() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ng", name = "d", descriptor = "(B)V", line = 220)
