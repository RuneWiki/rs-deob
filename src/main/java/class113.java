...
public class class113 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)V", line = 3)
    public static void method851(byte arg0) {
        field1820 = null;
        int var1 = -59 % ((63 - arg0) / 52);
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIZIII)I", line = 13)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II)V", line = 78)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILpf;IB)V", line = 92)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IB)Z", line = 140)
