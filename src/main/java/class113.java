...
public abstract class class113 implements class716 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZB)V", line = 44)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lnd;Lnd;Lci;)V", line = 71)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Z)I", line = 102)
