...
public class class113 extends class747 {
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "()V", line = 67)
    public class113() {
        super(0, false);
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ldc;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIB)V", line = 85)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(B)I", line = 110)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 132)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V", line = 162)
