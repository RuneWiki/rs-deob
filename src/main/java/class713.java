...
public class class713 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!vha", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(IJIZ)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(III[BII[BII)V", line = 68)
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(II)V", line = 111)
