...
public class class713 extends class97 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "()Loia;", line = 57)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([IZLqm;III)V", line = 81)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqm;IB)V", line = 144)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lqq;)V", line = 191)
    public class713(class502 arg0) {
        this.field10006 = arg0;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "()I", line = 200)
    public final int method752() {
        field10013++;
        return 0;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "([III)V", line = 246)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "()Loia;", line = 285)
