...
public class class713 extends class299 {
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(ILes;)V")
    public class713(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lip;I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Les;)V")
