...
public class class713 extends class126 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lfg;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lfg;IIIIIIIIIIIZZ)V")
