...
public class class713 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lrv;B)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lvm;B)Z")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BILha;)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lrv;)V")
