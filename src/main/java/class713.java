...
public class class713 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)J", line = 111)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZB)V", line = 138)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(I)Z", line = 199)
    public final boolean method3988(int arg0) {
        field9968++;
        return arg0 == 0 ? this.field9970 : false;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(I)I", line = 228)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z[Ljava/lang/String;)[Ljava/lang/String;", line = 239)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(B)Z", line = 264)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(ZIIZ)V", line = 279)
