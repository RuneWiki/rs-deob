...
public class class713 implements class540 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(IIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(I)Lsaa;", line = 26)
    public final class345 method1656(int arg0) {
        field9886++;
        return arg0 == 0 ? class668.field9298 : null;
    }

    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(I)V", line = 36)
    public class713(int arg0) {
        this.field9889 = arg0;
    }

    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(I)V", line = 45)
