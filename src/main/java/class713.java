...
public class class713 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BILrj;)V")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)Lnq;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BIIIILvea;ILha;)Lac;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IILvea;Lda;IIIIZLha;Lha;Z)Lac;")
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Ldh;IZLco;Lkha;Lkha;)V")
