...
public abstract class class713 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)Lwm;", line = 3)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Z)D", line = 191)
    ...
    @OriginalMember(owner = "client!fv", name = "d", descriptor = "(I)Lqb;", line = 213)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILjava/lang/String;)V", line = 227)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)V", line = 283)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(B)V", line = 313)
    ...
    @OriginalMember(owner = "client!fv", name = "e", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(B)V", line = 381)
    ...
    @OriginalMember(owner = "client!fv", name = "f", descriptor = "(I)Lbs;", line = 393)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IZ)V", line = 510)
    ...
    @OriginalMember(owner = "client!fv", name = "g", descriptor = "(I)Lgq;", line = 534)
    ...
    @OriginalMember(owner = "client!fv", name = "h", descriptor = "(I)Z", line = 545)
    ...
    @OriginalMember(owner = "client!fv", name = "i", descriptor = "(I)Z", line = 565)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(I)V", line = 589)
