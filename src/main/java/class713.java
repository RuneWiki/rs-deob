...
public class class713 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IZLjava/awt/Component;)Lwn;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BIILac;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
