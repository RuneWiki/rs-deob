...
public abstract class class713 extends class668 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lha;Lre;Liba;I)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([Lvt;I)I")
