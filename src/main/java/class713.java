...
public class class713 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I[I[Ljava/lang/Object;)V", line = 33)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I[BI)[B", line = 78)
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)Ljd;", line = 102)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 152)
    public class713(class121 arg0, int arg1, class557 arg2) {
        this.field10105 = arg2;
        this.field10105.method3333(30, 3443);
    }

    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(II)V", line = 140)
