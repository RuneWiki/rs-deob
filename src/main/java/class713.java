...
public class class713 extends class70 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B[IIII[[[BII[I[IIZ[IIB[IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(BLkh;)V", line = 449)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(I)V", line = 490)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)Laca;", line = 534)
    public final class758 method228(int arg0) {
        field9808++;
        return arg0 == 1 ? class538.field7311 : null;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIILha;III)V", line = 545)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Leaa;Lcq;IIIIIIIII)V", line = 607)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)Lpt;", line = 619)
