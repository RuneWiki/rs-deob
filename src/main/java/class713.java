...
public class class713 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lji;III)V", line = 13)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lac;[Lv;Z)Luj;", line = 62)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BLji;I)V", line = 160)
