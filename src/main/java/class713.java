...
public class class713 extends class59 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(CIIIZLaa;II)V", line = 3)
    public final void method106(char arg0, int arg1, int arg2, int arg3, boolean arg4, class484 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!jga", name = "fa", descriptor = "(CIIIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Lgt;Lfp;[Lfw;Z)V", line = 32)
