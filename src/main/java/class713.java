...
public class class713 extends class583 {
    ...
    @OriginalMember(owner = "client!nea", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Ljb;I)Ljava/lang/String;", line = 13)
    ...
    @OriginalMember(owner = "client!nea", name = "d", descriptor = "(B)J", line = 37)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IIIIILha;ILka;IIIILmga;I)Lka;", line = 49)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "([[SD)V", line = 226)
