...
public class class713 extends class406 {
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lada;Loe;IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lkf;Lro;IILib;IIZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lae;ILd;IILjava/awt/Canvas;)Lha;", line = 120)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)Lof;", line = 144)
    public final class475 method473(int arg0) {
        field9920++;
        return arg0 == 6 ? class227.field3443 : null;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Z)V", line = 157)
