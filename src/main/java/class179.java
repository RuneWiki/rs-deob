...
public class class179 extends class192 implements class465 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BF)F", line = 16)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIIII[BLpd;)V", line = 42)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)Z", line = 59)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lno;IIZ[III)V", line = 459)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIII[II)V", line = 478)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)V", line = 493)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIILpd;ZIII[F)V", line = 504)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I[IIIIII)V", line = 518)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZBZ)V", line = 542)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(FI)F", line = 556)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lno;Lpd;IIZ[BII)V", line = 570)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lno;Lpd;IIZ[FII)V", line = 594)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lno;Lpd;Lok;II)V", line = 614)
