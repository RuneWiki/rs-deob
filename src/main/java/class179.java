...
public class class179 extends class147 {
    ...
    @OriginalMember(owner = "client!td", name = "L", descriptor = "[Lvb;")
    public class195[] field3382;

    @OriginalMember(owner = "client!td", name = "H", descriptor = "Llf;")
    public static class109 field3378 = class35.method275("60 Sekunden noch einmal)3)3)3", 2);

    @OriginalMember(owner = "client!td", name = "Q", descriptor = "Llf;")
    private static class109 field3386 = class35.method275("skill)2", 2);

    @OriginalMember(owner = "client!td", name = "K", descriptor = "Llf;")
    public static class109 field3381 = field3386;

    @OriginalMember(owner = "client!td", name = "R", descriptor = "Llf;")
    private static class109 field3387 = class35.method275("Username: ", 2);

    @OriginalMember(owner = "client!td", name = "O", descriptor = "Llf;")
    public static class109 field3385 = field3387;

    @OriginalMember(owner = "client!td", name = "U", descriptor = "Llf;")
    public static class109 field3390 = class35.method275("sl_flags", 2);

    @OriginalMember(owner = "client!td", name = "W", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!td", name = "S", descriptor = "Lhf;")
    public static class75 field3388;

    @OriginalMember(owner = "client!td", name = "V", descriptor = "[Ldf;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lbg;ILbg;Lbg;)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II[Lvg;)V")
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lbg;Lbg;IZ)V")
