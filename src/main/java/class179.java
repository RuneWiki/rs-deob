...
public class class179 extends class459 implements class447 {
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 16)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lik;IZ[[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lkk;I)V", line = 78)
