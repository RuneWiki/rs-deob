...
public class class179 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIBI)V", line = 33)
