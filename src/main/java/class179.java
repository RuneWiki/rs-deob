...
public class class179 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIZ[BLpq;II)Liq;", line = 13)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Llm;", line = 33)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(I)Llm;", line = 57)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BLlm;)V", line = 83)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(I)Llm;", line = 114)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(B)I", line = 136)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "()V", line = 183)
    public class179() {
        this.field2266.field591 = this.field2266;
        this.field2266.field586 = this.field2266;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II)I", line = 165)
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(I)V", line = 192)
