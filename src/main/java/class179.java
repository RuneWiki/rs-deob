...
public class class179 extends class329 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(II)V", line = 104)
