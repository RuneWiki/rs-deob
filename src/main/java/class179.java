...
public class class179 extends class42 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIIIIB)I", line = 4)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)V", line = 45)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(II)V", line = 67)
