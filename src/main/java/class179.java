...
public class class179 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ZIZLbo;Lbo;)I")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Loh;IZI)V")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lgb;Lfm;ILqa;)V")
