...
public class class179 extends class338 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 108)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIII)Z", line = 121)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(III)Z", line = 136)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BI[II)V", line = 153)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(III)Z", line = 167)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IBIIIII)I", line = 194)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(II[II)V", line = 226)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(IIIIIIIII)V", line = 243)
