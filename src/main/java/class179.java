...
public class class179 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIIIILta;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)Z", line = 73)
