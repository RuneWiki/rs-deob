...
public class class179 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)Lgp;", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(II)V", line = 100)
    public class179(int arg0, int arg1) {
        this.field2507 = arg1;
        this.field2512 = arg0;
    }

    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lhp;I)V", line = 108)
