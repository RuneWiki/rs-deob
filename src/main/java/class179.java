...
public class class179 extends class370 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lwu;Lwu;[IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(B)F", line = 19)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(B)D", line = 35)
    public final double method1238(byte arg0) {
        field2705++;
        return arg0 == -121 ? this.field2696 : -0.3000760850863135D;
    }

    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 62)
    public class179(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IC)Z", line = 82)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lha;B)Lhu;", line = 118)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(B)Z", line = 188)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)J", line = 199)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 219)
