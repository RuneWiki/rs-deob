...
public class class179 extends class374 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(II)I", line = 37)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)Z", line = 52)
    public final boolean method21(byte arg0) {
        ++field2650;
        return arg0 <= 85 ? true : this.field2644;
    }

    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lya;Lok;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lvd;Lbt;)V", line = 190)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIIBII)V", line = 212)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZI)V", line = 250)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BI)V", line = 260)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(III)V", line = 275)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IBII)V", line = 320)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIZ)I", line = 347)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZLew;I)V", line = 382)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(B)V", line = 399)
