...
public class class179 {
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(II)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIZIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(II)V", line = 199)
