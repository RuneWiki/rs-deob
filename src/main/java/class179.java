...
public class class179 implements class39 {
    ...
    private int[] field3078 = null;

    @OriginalMember(owner = "client!vc", name = "b", descriptor = "I")
    private static int field3074 = 36;

    @OriginalMember(owner = "client!vc", name = "c", descriptor = "I")
    private static int field3075 = 96;

    @OriginalMember(owner = "client!vc", name = "e", descriptor = "I")
    private static int field3077 = 12;

    @OriginalMember(owner = "client!vc", name = "b", descriptor = "()V", line = 7)
    public final void method245() {
        GL var1 = class167.field2806;
        if (class44.field601) {
            var1.glCallList(this.field3073 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "()V", line = 281)
    public class179() {
        if (class167.field2804 && class167.field2782 >= 2) {
            this.method1177();
            GL var1 = class167.field2806;
            var1.glBindTexture(34067, this.field3078[0]);
            ...
            var1.glBindTexture(34067, this.field3078[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field3078[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field3076 = class167.field2782 < 3;
        }
        this.method1176();
    }

    @OriginalMember(owner = "client!vc", name = "c", descriptor = "()V", line = 19)
    public final void method247() {
        GL var1 = class167.field2806;
        if (class44.field601) {
            class167.method1055(1);
            var1.glCallList(this.field3073);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!vc", name = "d", descriptor = "()V", line = 32)
    private final void method1176() {
        GL var1 = class167.field2806;
        this.field3073 = var1.glGenLists(2);
        var1.glNewList(this.field3073, 4864);
        if (this.field3078 == null) {
            ...
            if (this.field3076) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class167.field2781);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field3073 + 1, 4864);
        if (this.field3078 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)V", line = 125)
    public final void method246(int arg0) {
        GL var2 = class167.field2806;
        if (class44.field601 && this.field3078 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field3078[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!vc", name = "e", descriptor = "()V", line = 144)
    private final void method1177() {
        GL var1 = class167.field2806;
        if (this.field3078 == null) {
            this.field3078 = new int[3];
            var1.glGenTextures(3, this.field3078, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            for (int var8 = 0; var8 < 64; var8++) {
                for (int var9 = 0; var9 < 64; var9++) {
                    ...
                    int var18;
                    if (var15 > 0.0F) {
                        var16 = (int) (Math.pow((double) var15, (double) field3075) * 255.0D);
                        var17 = (int) (Math.pow((double) var15, (double) field3074) * 255.0D);
                        var18 = (int) (Math.pow((double) var15, (double) field3077) * 255.0D);
                    } else {
                        var18 = 0;
                        var17 = 0;
                        var16 = 0;
            ...
            class101.field1720 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "()I", line = 258)
