...
public class class179 extends class257 {
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmm;IIIZ[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmm;IIIIIIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmm;IIII[I)V", line = 39)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I[IILmm;ZI)Lvj;", line = 54)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIIILmm;)Lvj;", line = 73)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmm;IIIIZ[BI)V", line = 90)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmm;IIIII[BI)V", line = 113)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IZI[BIIILmm;)Lvj;", line = 128)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Lmm;IIIIIZ)V", line = 146)
