...
public class class179 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ILsp;)V", line = 5)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(I)V", line = 39)
    private class179(int arg0) {
        this.field2003 = arg0;
    }

    @OriginalMember(owner = "client!rt", name = "toString", descriptor = "()Ljava/lang/String;", line = 55)
    public final String toString() {
        field2002++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 66)
