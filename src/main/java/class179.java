...
public class class179 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)Lfb;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lar;I)V")
    ...
    @OriginalMember(owner = "client!m", name = "c", descriptor = "(B)Lfb;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Llm;BLlm;)V")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lar;)V")
