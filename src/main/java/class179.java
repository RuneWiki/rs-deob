...
public class class179 extends class235 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZJ[II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "([Lro;ZI)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lil;I)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BILil;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lnr;I)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILnr;I[Lbi;IZIII[BIZ)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIIBLnr;ILbi;I)V")
