...
public class class179 extends class306 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(CIIIZLta;II)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lms;Lkt;[Lau;[I[I)V")
