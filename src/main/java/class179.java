...
public class class179 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ZLbt;)Lsd;")
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(II)Ljt;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILdn;Lm;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lgt;IZLdn;Ldn;)V")
