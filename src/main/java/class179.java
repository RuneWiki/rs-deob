...
public class class179 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IB)Lvr;", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 90)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(Z)V", line = 110)
