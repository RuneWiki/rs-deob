...
public class class179 extends class417 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFLoj;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "()I", line = 85)
    public final int method1287() {
        return this.field2715.field3551;
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(IIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIII)V", line = 211)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIII)V", line = 261)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFFFFFIII)V", line = 267)
    ...
    @OriginalMember(owner = "client!sd", name = "e", descriptor = "()V", line = 330)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 340)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIII)V", line = 366)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lfu;IIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lfu;II[III)V", line = 600)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IILoj;II)V", line = 377)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIII)V", line = 438)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "()I", line = 574)
    public final int method1293() {
        return this.field2715.field3553;
    }

    @OriginalMember(owner = "client!sd", name = "c", descriptor = "()I", line = 581)
    public final int method1294() {
        return this.field2715.field3553 + this.field2713 + this.field2714;
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "()I", line = 588)
