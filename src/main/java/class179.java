...
public class class179 {
    ...
    @OriginalMember(owner = "client!li", name = "exit", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!li", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!li", name = "listmodes", descriptor = "()[I", line = 92)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/awt/Frame;Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "()V", line = 154)
