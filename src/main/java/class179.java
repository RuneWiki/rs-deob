...
public abstract class class179 implements class271 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lqi;IIIZ)V")
