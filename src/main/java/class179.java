...
public class class179 {
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(Lmja;ILbt;)V", line = 56)
