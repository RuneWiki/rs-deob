...
public class class179 extends class461 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(IB)I", line = 214)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZLjava/awt/Canvas;)Lwl;", line = 232)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)Lea;", line = 257)
    ...
    @OriginalMember(owner = "client!jl", name = "e", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!jl", name = "f", descriptor = "(I)V", line = 403)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IB)[B", line = 434)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)V", line = 456)
    ...
    @OriginalMember(owner = "client!jl", name = "g", descriptor = "(I)I", line = 497)
    public final int method1232(int arg0) {
        field2894++;
        return arg0 >= -74 ? 0 : this.field2884;
    }

    @OriginalMember(owner = "client!jl", name = "h", descriptor = "(I)I", line = 513)
    ...
    @OriginalMember(owner = "client!jl", name = "i", descriptor = "(I)I", line = 535)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIB)Lnr;", line = 554)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(ILfq;Lfq;Lhf;Lrm;IIZ)V", line = 827)
    ...
    @OriginalMember(owner = "client!jl", name = "j", descriptor = "(I)I", line = 775)
