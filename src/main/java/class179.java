...
public class class179 extends class675 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lfia;IZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lkv;Lb;)V", line = 119)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(III)V", line = 147)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ILiw;IBLts;)V", line = 178)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(B)V", line = 548)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZI)V", line = 568)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZLkia;)V", line = 607)
