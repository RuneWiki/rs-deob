...
public class class179 extends class22 {
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(BLhg;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILts;II)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BLhg;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lwh;B)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Log;IIFZ)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lhg;I)V")
