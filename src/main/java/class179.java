...
public class class179 extends class11 {
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lqg;)V")
    public class179(class321 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Ljp;ILjp;I)V")
    ...
    @OriginalMember(owner = "client!up", name = "d", descriptor = "(Z)V")
