...
public class class179 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)Llu;", line = 9)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZBI)I", line = 68)
