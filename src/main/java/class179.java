...
public class class179 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "([BI)[B", line = 5)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIIILjea;)V", line = 28)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Ljc;[BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "()V", line = 103)
    public class179() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(III)V", line = 126)
