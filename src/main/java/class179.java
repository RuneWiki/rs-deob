...
public class class179 extends class43 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III)I", line = 35)
    ...
    @OriginalMember(owner = "client!ra", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BI)Lfh;", line = 79)
