...
public class class179 extends class440 {
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "()V", line = 5)
    public class179() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(II)Lrca;", line = 8)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(II)[[I", line = 48)
    ...
    @OriginalMember(owner = "client!tj", name = "g", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BI)[I", line = 122)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILmo;I)V", line = 146)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([[IZ)V", line = 228)
