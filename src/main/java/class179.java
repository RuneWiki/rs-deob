...
public class class179 extends class377 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)Z", line = 77)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lla;Lla;Lnaa;)V", line = 115)
    public class179(class423 arg0, class423 arg1, class629 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I[FIIIIFFII[FI)V", line = 119)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IBIZ)V", line = 176)
