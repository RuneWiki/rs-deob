...
public class class179 extends Canvas {
    ...
    @OriginalMember(owner = "client!kv", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        field2694++;
        this.field2693.update(arg0);
    }

    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!kv", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
