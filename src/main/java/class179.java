...
public class class179 extends class56 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(ZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IILkv;)V", line = 57)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lbv;)V", line = 69)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IIIIIII)Lmc;", line = 183)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZLcm;)V", line = 205)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(FFFB)F", line = 219)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 230)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZI)V", line = 352)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)Z", line = 367)
