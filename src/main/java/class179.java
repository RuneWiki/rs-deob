...
public class class179 extends class226 {
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IILep;II)V")
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(FFFFFFLep;II)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(FFFFFFIII)V")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ltb;IIII)V")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ltb;II[III)V")
