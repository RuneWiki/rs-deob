...
public abstract class class179 implements class632 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ZLjaggl/MapBuffer;I)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lhl;IZ)V")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BLjaggl/MapBuffer;)Z")
