...
public class class179 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLvb;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lza;Z)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lvb;II)V")
