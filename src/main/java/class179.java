...
public class class179 {
    ...
    @OriginalMember(owner = "client!pu", name = "toString", descriptor = "()Ljava/lang/String;", line = 50)
    public final String toString() {
        field2757++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)Ljava/lang/String;", line = 100)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 125)
    public class179(String arg0, String arg1, String arg2, String arg3) {
        this.field2759 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 140)
