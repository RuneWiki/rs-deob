...
public class class179 extends class461 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lgj;)Lua;", line = 3)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
