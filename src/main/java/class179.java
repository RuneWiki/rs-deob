...
public class class179 extends class396 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IC)Z", line = 7)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)Ljf;", line = 40)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "([B)V", line = 76)
    public class179(byte[] arg0) {
        this.field2466 = arg0;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IJII)V", line = 104)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)I", line = 149)
