...
public class class179 extends class190 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "()I", line = 24)
    public final int method1286() {
        return this.field2540 - (this.field2537.available() >> (class46.field615 ? 2 : 1));
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 32)
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 75)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 129)
