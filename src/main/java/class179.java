...
public class class179 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II[Lje;)V", line = 7)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BZ[B)Ljava/lang/Object;", line = 115)
