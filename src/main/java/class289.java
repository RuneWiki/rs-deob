...
public class class289 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IZLr;)Lf;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lri;B)Z")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILr;)Lf;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lun;Z)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lun;ZI)V")
