...
public class class289 extends class334 {
    ...
    @OriginalMember(owner = "client!sh", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZLol;)V", line = 13)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZI)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 134)
    public class289() {
        super(1, false);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILfm;)V", line = 139)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)[I", line = 244)
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(III)Z", line = 296)
