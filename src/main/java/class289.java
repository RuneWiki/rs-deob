...
public class class289 extends class461 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lsha;Lha;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIBIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II)Lpu;", line = 93)
    public static final class598 method1920(int arg0, int arg1) {
        field4253++;
        return arg1 <= arg0 && arg0 < 100 ? class501.field6855[arg0] : null;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IBILha;)Z", line = 158)
