...
public class class289 extends class59 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIILaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[I[I)Laa;")
    public final class487 method268(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class301(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lmda;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I[Lab;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lza;)V")
    public final void method270(class415 arg0) {
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ljc;IIII)V")
    ...
    @OriginalMember(owner = "client!ao", name = "y", descriptor = "()Lbca;")
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(IIIIII)Lwh;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lbca;)V")
    public final void method210(class661 arg0) {
        this.field4035 = (class515) arg0;
    }

    @OriginalMember(owner = "client!ao", name = "A", descriptor = "(ILaa;II)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lmda;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(IIIIZ)Lmi;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Loea;[Lrh;Z)Lda;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lhe;Lvm;)Lis;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "()Lbca;")
    public final class661 method320() {
        return this.field4035;
    }

    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[[I[[IIII)Ls;")
    ...
    @OriginalMember(owner = "client!ao", name = "j", descriptor = "()Lbca;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lbh;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)Lvm;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lis;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lwh;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([IIIIIZ)Lmi;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lrh;Z)Lmi;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIZ)Lmi;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIF)Lab;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lwh;Lwh;FLwh;)Lwh;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ljava/lang/Runnable;)Lpga;")
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "i", descriptor = "(I)Lza;")
    public final class415 method261(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(II)Lhe;")
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()Lfia;")
