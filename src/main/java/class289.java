...
public class class289 extends class264 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!oc", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lvc;II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!oc", name = "i", descriptor = "(I)V", line = 426)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B[[[Lwr;)V", line = 439)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 515)
    public class289() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)Lvb;", line = 518)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)[I", line = 535)
    ...
    @OriginalMember(owner = "client!oc", name = "j", descriptor = "(I)Lkk;", line = 570)
