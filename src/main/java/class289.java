...
public class class289 extends class207 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)Luk;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IBI)Lvp;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljava/lang/String;Ltc;ZB)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(ILwq;Lwq;Lah;Lsj;IIZ)V")
