...
public class class289 extends class432 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BII)V", line = 116)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZII)V", line = 149)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IB)I", line = 163)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIILkm;IIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(B)V", line = 327)
