...
public class class289 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lta;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIB)I", line = 83)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BI)V", line = 114)
