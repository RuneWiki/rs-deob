...
public class class289 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)V", line = 158)
