...
public class class289 extends class10 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lad;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lkd;II[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lcl;Z)I", line = 45)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(I)V", line = 71)
