...
public class class289 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([I[I[I[BIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "()V", line = 74)
    public static void method1970() {
        field4160 = null;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILvn;)I", line = 81)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lvn;)V", line = 107)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(Lvn;)V", line = 266)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([BI[BII)I", line = 284)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(Lvn;)V", line = 315)
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(Lvn;)B", line = 817)
    private static final byte method1976(class424 arg0) {
        return (byte) method1971(1, arg0);
    }

    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(Lvn;)B", line = 824)
