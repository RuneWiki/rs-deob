...
public class class289 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lya;Lqj;III)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ZILum;)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILgo;)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIZB)Lrp;")
