...
public class class289 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)V", line = 53)
