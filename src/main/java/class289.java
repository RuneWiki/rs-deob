...
public class class289 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIII[B)V", line = 101)
