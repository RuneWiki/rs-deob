...
public class class289 extends class371 {
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(BI)[I", line = 31)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IBLps;)V", line = 66)
