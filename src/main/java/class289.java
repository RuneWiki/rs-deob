...
public class class289 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IZI)Lle;", line = 4)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IB)Loda;", line = 27)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ILoa;IILfa;Lep;IIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(CB)B", line = 168)
