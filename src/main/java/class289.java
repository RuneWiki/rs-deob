...
public class class289 extends class185 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIIZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(B)V", line = 442)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II[BZ)[B", line = 471)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(III)Z", line = 514)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lbi;II)V", line = 532)
    public class289(class483 arg0, int arg1, int arg2) {
        this.field3791 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIIII)V", line = 542)
