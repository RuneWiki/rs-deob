...
public abstract class class289 extends class435 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILr;IILnf;I)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ldq;Z)V")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(IB)Ldj;")
