...
public class class289 extends class187 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lha;Lkc;Lda;Ljava/lang/String;ZB)V", line = 54)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lhk;Lol;)V", line = 153)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZ)V", line = 200)
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZI)V", line = 233)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 303)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 336)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IBLqk;)V", line = 350)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Z)V", line = 364)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)Z", line = 394)
