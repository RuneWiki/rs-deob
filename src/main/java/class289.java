...
public class class289 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lpia;ILub;)Lkw;", line = 8)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(B)Z", line = 104)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)Lmc;", line = 115)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)Lmc;", line = 135)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IILwi;Lha;)V", line = 157)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BLmc;)V", line = 489)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IBI)Z", line = 507)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)Lmc;", line = 519)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lbq;I)V", line = 542)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lbq;ILmc;)V", line = 554)
    ...
    @OriginalMember(owner = "client!bq", name = "d", descriptor = "(I)V", line = 585)
    ...
    @OriginalMember(owner = "client!bq", name = "e", descriptor = "(I)I", line = 602)
    ...
    @OriginalMember(owner = "client!bq", name = "f", descriptor = "(I)V", line = 623)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "()V", line = 703)
    public class289() {
        this.field3563.field1520 = this.field3563;
        this.field3563.field1521 = this.field3563;
    }

    @OriginalMember(owner = "client!bq", name = "g", descriptor = "(I)Lmc;", line = 654)
    ...
    @OriginalMember(owner = "client!bq", name = "h", descriptor = "(I)Lmc;", line = 681)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lmc;B)V", line = 712)
