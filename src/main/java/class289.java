...
public class class289 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BI)Lco;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lwq;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(II)Lva;")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Liv;ILcb;Lcb;Lcb;)V")
