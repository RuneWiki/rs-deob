...
public class class289 extends class69 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IB)V", line = 3)
    public void method1893(int arg0, byte arg1) {
        this.field4054[arg0] = arg1;
        field4055++;
    }

    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 93)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(IIIIIFFF)V", line = 115)
