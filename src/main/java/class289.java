...
public class class289 implements class272 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILhf;)Z", line = 38)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)J", line = 79)
