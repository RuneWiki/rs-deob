...
public class class289 implements Runnable {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLc;)V", line = 184)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)Ljava/lang/String;", line = 203)
    ...
    @OriginalMember(owner = "client!hg", name = "run", descriptor = "()V", line = 233)
