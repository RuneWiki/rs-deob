...
public class class289 extends class107 {
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)Lwm;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BLnt;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILnt;IIII)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lwm;Z)V")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lnt;)V")
