...
public class class289 extends class354 {
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "()V", line = 101)
    public class289() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BI)[[I", line = 104)
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILti;I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)[I", line = 174)
