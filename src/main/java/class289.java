...
public class class289 extends class438 implements class233 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IBILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(Ljc;Z)V")
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Luaa;B)V")
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Loq;Ljava/lang/String;ZI)Ltba;")
