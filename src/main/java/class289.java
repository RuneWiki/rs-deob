...
public class class289 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IB)V", line = 23)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIILor;)V", line = 89)
