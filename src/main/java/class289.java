...
public class class289 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)Lok;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILfb;IB)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lfb;II)V")
