...
public class class289 extends class82 {
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILos;)V", line = 74)
    ...
    @OriginalMember(owner = "client!ow", name = "e", descriptor = "(III)I", line = 117)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "()V", line = 188)
    public class289() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 139)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)V", line = 202)
