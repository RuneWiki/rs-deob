...
public class class289 implements class4 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ZB)V", line = 62)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)V", line = 104)
    public static void method1717(int arg0) {
        field3742 = null;
        int var1 = 14 % ((-arg0 - 92) / 34);
    }

    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(II)I", line = 145)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IZ)I", line = 156)
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(III)V", line = 199)
    ...
    @OriginalMember(owner = "client!uca", name = "d", descriptor = "(III)V", line = 227)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ZLoa;IIIIIII)V", line = 254)
