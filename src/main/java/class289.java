...
public class class289 extends class69 {
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(ILjava/awt/Canvas;IILd;Lla;)Lha;")
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Ltw;)V")
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Lha;I)Lcca;")
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IILha;B)Z")
    ...
    @OriginalMember(owner = "client!vja", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(BLha;)Ltf;")
