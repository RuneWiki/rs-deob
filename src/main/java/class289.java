...
public class class289 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(III)I", line = 20)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIILfq;Lfq;)V", line = 56)
