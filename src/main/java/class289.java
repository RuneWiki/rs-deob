...
public class class289 extends class404 {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lh;)V", line = 23)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "()V", line = 195)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "()Z", line = 215)
    public final boolean method350() {
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lsd;)V", line = 221)
    public final void method353(class233 arg0) {
        this.field5606.method2088(arg0);
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)V", line = 233)
