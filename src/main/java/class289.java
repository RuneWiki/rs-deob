...
public class class289 extends class114 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "()Z", line = 4)
    public final boolean method309() {
        return true;
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lmm;Lgk;)V", line = 8)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "()V", line = 99)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 105)
    public final void method304(boolean arg0) {
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lt;)V", line = 109)
