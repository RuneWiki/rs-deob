...
public class class289 extends class507 {
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lad;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZIZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lad;IIIIZ[IZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lad;IIIIZ[BIZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIIIBZI[I)V", line = 166)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IBII)V", line = 225)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lad;IIIIZ[FI)V", line = 239)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lad;IIIII)V", line = 466)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIII[BIIZII)V", line = 371)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIIIII)V", line = 439)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IZI)Z", line = 451)
