...
public class class289 extends class434 implements class407 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "()I", line = 4)
    public final int method114() {
        return 0;
    }

    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lnm;I[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I[BI)V", line = 17)
