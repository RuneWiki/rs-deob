...
public class class289 extends class254 {
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lvc;II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIIBZ)V", line = 185)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BLya;II)Z", line = 212)
