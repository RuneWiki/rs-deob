...
public class class289 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)Lgga;", line = 6)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lwp;Lwp;B)V", line = 46)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)Lgga;", line = 73)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "()V", line = 88)
    public class289() {
    }

    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lwa;)V", line = 90)
