...
public class class34 extends class94 {
    ...
    @OriginalMember(owner = "client!gs", name = "XA", descriptor = "(IIIIII)V")
    ...
    @OriginalMember(owner = "client!gs", name = "oa", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!gs", name = "ya", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lwc;[III)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IILta;II)V")
    ...
    @OriginalMember(owner = "client!gs", name = "W", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lwc;[IIIII)V")
