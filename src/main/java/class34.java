...
public class class34 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lrg;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)I", line = 70)
