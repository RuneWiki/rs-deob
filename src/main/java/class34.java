...
public class class34 extends class149 {
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "()V", line = 5)
    public class34() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)I", line = 32)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ms", name = "e", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)[I", line = 208)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IBLtl;)V", line = 282)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ljava/lang/String;ZZIJIIILjava/lang/String;ZB)V", line = 328)
