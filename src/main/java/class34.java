...
public class class34 extends class304 implements class375 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILtn;I)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(III)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "([II[III)V", line = 69)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ltn;B)Lqs;", line = 126)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIB)Z", line = 140)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lck;Lem;III[B)V", line = 161)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lda;)V", line = 176)
