...
public class class34 extends class148 {
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 3)
    public class34() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILdh;I)V", line = 259)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZI)[[I", line = 298)
    ...
    @OriginalMember(owner = "client!gs", name = "e", descriptor = "(B)V", line = 353)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(ZI)I", line = 364)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 420)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIILoq;)V", line = 543)
    ...
    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(B)V", line = 593)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 633)
