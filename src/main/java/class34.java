...
public class class34 extends class613 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lr;Lq;Lda;I)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lr;IIB)Lda;")
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "(Lr;I)Lwj;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIIILrb;Lr;Z)V")
    ...
    @OriginalMember(owner = "client!rca", name = "d", descriptor = "(Lr;I)Llf;")
