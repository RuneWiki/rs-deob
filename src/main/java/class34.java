...
public class class34 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BLrca;)Z")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILio;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Lio;)V")
