...
public class class34 implements Runnable {
    ...
    @OriginalMember(owner = "client!LJVKCVYD", name = "e", descriptor = "LAYIVJZQQ;")
    ...
    @OriginalMember(owner = "client!LJVKCVYD", name = "<init>", descriptor = "(LAYIVJZQQ;Ljava/net/Socket;I)V")
