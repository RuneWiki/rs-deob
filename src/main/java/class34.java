...
public class class34 extends class13 {
    ...
    @OriginalMember(owner = "client!MQTIFFLX", name = "k", descriptor = "Z")
    public static boolean field1086;

    @OriginalMember(owner = "client!MQTIFFLX", name = "i", descriptor = "[LVCPFYTXG;")
    ...
    @OriginalMember(owner = "client!MQTIFFLX", name = "a", descriptor = "(Z)LWEVRTBOZ;")
