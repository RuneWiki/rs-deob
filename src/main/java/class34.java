...
public abstract class class34 implements class224 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(FFII)V", line = 8)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(FFFFFFIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)V", line = 22)
    public final void method182(int arg0, int arg1) {
        this.method48(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(FFFFIILaa;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(FFFFIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(IIIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(FFIILaa;II)V", line = 96)
