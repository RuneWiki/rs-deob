...
public class class34 extends class199 {
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lad;II[B)V", line = 11)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIILmf;Lmf;)V", line = 23)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IFLqp;FIZIFIFF)[B", line = 62)
