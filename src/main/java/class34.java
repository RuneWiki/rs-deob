...
public class class34 extends class283 implements class105 {
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILju;)V", line = 14)
    public final void method43(int arg0, class115 arg1) {
        super.method43(arg0, arg1);
    }

    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 22)
    public final IDirect3DBaseTexture method33(int arg0) {
        return arg0 > -49 ? (IDirect3DBaseTexture) null : this.field521;
    }

    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Ltga;IZ[[I)V", line = 32)
