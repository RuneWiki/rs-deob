...
public class class34 implements class180 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIILsj;)V", line = 20)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 82)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)Z", line = 140)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 191)
    public class34(String arg0, int arg1) {
        this.field411 = arg1;
    }

    @OriginalMember(owner = "client!eg", name = "toString", descriptor = "()Ljava/lang/String;", line = 202)
    public final String toString() {
        field403++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 211)
