...
public class class34 extends class295 {
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(ILkea;II)V")
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(Llf;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(ILdt;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(Ldt;B)V")
    ...
    @OriginalMember(owner = "client!bja", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!bja", name = "CA", descriptor = "(Lr;IIIIZ)V")
