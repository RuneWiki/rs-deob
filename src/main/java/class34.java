...
public class class34 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "()Lwb;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljo;II)Lbh;")
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Liaa;)V")
