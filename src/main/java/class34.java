...
public class class34 extends class518 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILjc;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 89)
    public class34() {
        super(0, false);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)I", line = 99)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(III)V", line = 123)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIII[BII[BI)V", line = 142)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZBII)Ljava/lang/String;", line = 186)
