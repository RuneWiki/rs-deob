...
public class class34 implements class758 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)Z", line = 99)
    public final boolean method9(byte arg0) {
        field363++;
        return arg0 == 119 ? true : true;
    }

    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lua;)V", line = 139)
