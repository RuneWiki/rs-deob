...
public class class34 extends class136 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 55)
    public class34() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(I)V", line = 58)
    public static void method271(int arg0) {
        field394 = null;
        int var1 = -1 % ((arg0 - -53) / 54);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BI)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IILiv;)V", line = 111)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIB)V", line = 125)
