...
public class class34 {
    ...
    @OriginalMember(owner = "client!OIEBXCSN", name = "c", descriptor = "[LOIEBXCSN;")
    public static class34[] field1182;

    @OriginalMember(owner = "client!OIEBXCSN", name = "a", descriptor = "(LDTIATKJO;I)V")
    ...
    @OriginalMember(owner = "client!OIEBXCSN", name = "a", descriptor = "(IILGHHPHSRU;)V")
