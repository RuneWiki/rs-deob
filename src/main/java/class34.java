...
public class class34 {
    ...
    @OriginalMember(owner = "client!MQVXAZFZ", name = "d", descriptor = "[LMQVXAZFZ;")
    public static class34[] field1045;

    @OriginalMember(owner = "client!MQVXAZFZ", name = "a", descriptor = "(ILQKFGLETG;)V")
    ...
    @OriginalMember(owner = "client!MQVXAZFZ", name = "a", descriptor = "(BLXJCNBMKS;)V")
