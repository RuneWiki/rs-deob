...
@OriginalClass("client!JBNVYUNE")
public class class34 {

    @OriginalMember(owner = "client!JBNVYUNE", name = "a", descriptor = "LHLXTSVEJ;")
    private static class26 field1123 = new class26();

    @OriginalMember(owner = "client!JBNVYUNE", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!JBNVYUNE", name = "a", descriptor = "(LHLXTSVEJ;)V")
    ...
    @OriginalMember(owner = "client!JBNVYUNE", name = "b", descriptor = "(LHLXTSVEJ;)V")
    ...
    @OriginalMember(owner = "client!JBNVYUNE", name = "c", descriptor = "(LHLXTSVEJ;)B")
    private static byte method407(class26 arg0) {
        return (byte) method409(8, arg0);
    }

    @OriginalMember(owner = "client!JBNVYUNE", name = "d", descriptor = "(LHLXTSVEJ;)B")
    private static byte method408(class26 arg0) {
        return (byte) method409(1, arg0);
    }

    @OriginalMember(owner = "client!JBNVYUNE", name = "a", descriptor = "(ILHLXTSVEJ;)I")
    ...
    @OriginalMember(owner = "client!JBNVYUNE", name = "e", descriptor = "(LHLXTSVEJ;)V")
    ...
    @OriginalMember(owner = "client!JBNVYUNE", name = "a", descriptor = "([I[I[I[BIII)V")
