...
public class class34 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ZB)I", line = 46)
    ...
    @OriginalMember(owner = "client!rca", name = "toString", descriptor = "()Ljava/lang/String;", line = 87)
