...
public class class34 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IB)Ljv;")
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(II)Lei;")
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lkp;ILph;Lph;Lph;)V")
