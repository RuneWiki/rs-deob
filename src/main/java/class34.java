...
public abstract class class34 extends class476 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ldk;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IB)[I", line = 15)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IBI)V", line = 30)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)I", line = 84)
    public int method250(boolean arg0) {
        field534++;
        return arg0 ? -1 : -89;
    }

    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lsv;II)V", line = 113)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BI)[[I", line = 125)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZII)[I", line = 136)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(III)[[I", line = 182)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(IZ)V", line = 234)
