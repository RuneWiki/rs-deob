...
public class class34 extends class85 {
    ...
    @OriginalMember(owner = "client!dc", name = "Y", descriptor = "Llf;")
    public static class109 field760 = class35.method275("null", 2);

    @OriginalMember(owner = "client!dc", name = "hb", descriptor = "Llf;")
    private static class109 field769 = class35.method275(" ", 2);

    @OriginalMember(owner = "client!dc", name = "R", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!dc", name = "gb", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([BIIIII[Llb;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BILja;)V")
