...
public class class34 {
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)J")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BIII)Lbh;")
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)Lsda;")
