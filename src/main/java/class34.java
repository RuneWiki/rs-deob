...
public class class34 extends class18 {
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(Lhk;IIZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bja", name = "d", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(Lhk;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!bja", name = "e", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(Lhk;IIZ[[BI)V", line = 95)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(IIIII)V", line = 135)
