...
public class class34 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(BILfga;Lnh;Lha;ILcj;Lgaa;Lsha;ILme;I)Lka;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILgaa;IIIIIILfga;Lha;ILme;)Lka;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lqb;Lgaa;Lgaa;Lme;ILfga;[ILnh;ZI[Loga;Lsha;Lcj;ZIIIIIILha;)Lka;")
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(I)[Lea;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)Ldt;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IILfga;I)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IILnh;I)V")
