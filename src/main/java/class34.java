...
public class class34 extends class76 implements class140 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Z)I", line = 6)
    public final int method302(boolean arg0) {
        ++field456;
        return arg0 ? -23 : 0;
    }

    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Ljj;I[BI)V", line = 19)
    public class34(class66 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field452 = arg1;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I)J", line = 51)
    public final long method305(int arg0) {
        ++field455;
        return arg0 != -21337 ? 105L : super.field1392.getAddress();
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIIB)I", line = 62)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIZI)I", line = 74)
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(Z)I", line = 147)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BII[B)V", line = 159)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lgp;I)I", line = 174)
