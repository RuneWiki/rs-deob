...
public class class34 extends class264 {
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bk", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "()V", line = 49)
    public class34() {
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Loq;[II[B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "([B)V", line = 110)
    ...
    @OriginalMember(owner = "client!bk", name = "f", descriptor = "(I)V", line = 765)
