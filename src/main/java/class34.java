...
@OriginalClass("client!JFFVPFLB")
public class class34 {

    @OriginalMember(owner = "client!JFFVPFLB", name = "f", descriptor = "I")
    public int field1183 = 65000;

    @OriginalMember(owner = "client!JFFVPFLB", name = "e", descriptor = "I")
    public int field1182;

    @OriginalMember(owner = "client!JFFVPFLB", name = "a", descriptor = "I")
    private int field1178;

    @OriginalMember(owner = "client!JFFVPFLB", name = "c", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1180;

    @OriginalMember(owner = "client!JFFVPFLB", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1181;

    @OriginalMember(owner = "client!JFFVPFLB", name = "b", descriptor = "[B")
    public static byte[] field1179 = new byte[520];

    @OriginalMember(owner = "client!JFFVPFLB", name = "<init>", descriptor = "(ILjava/io/RandomAccessFile;ZLjava/io/RandomAccessFile;I)V")
    ...
    @OriginalMember(owner = "client!JFFVPFLB", name = "a", descriptor = "(II)[B")
    ...
    @OriginalMember(owner = "client!JFFVPFLB", name = "a", descriptor = "(IIB[B)Z")
    ...
    @OriginalMember(owner = "client!JFFVPFLB", name = "a", descriptor = "(IZIB[B)Z")
    ...
    @OriginalMember(owner = "client!JFFVPFLB", name = "a", descriptor = "(Ljava/io/RandomAccessFile;II)V")
