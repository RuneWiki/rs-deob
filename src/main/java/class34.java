...
public class class34 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZI)Lmh;", line = 23)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 87)
    public class34(class271 arg0, int arg1, class84 arg2) {
        this.field524 = arg2;
        this.field524.method656((byte) 122, 1);
    }

    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 102)
