...
public class class34 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIFFIIFIFLqi;F)[B", line = 32)
