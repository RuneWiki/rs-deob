...
public class class34 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZI)Lrd;", line = 56)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IB)V", line = 91)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 125)
