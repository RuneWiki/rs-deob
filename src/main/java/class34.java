...
public class class34 {
    ...
    @OriginalMember(owner = "client!bja", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field528++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(IIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "()V", line = 49)
