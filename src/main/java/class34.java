...
public class class34 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIIIIZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lgr;FBLgr;)Z", line = 32)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lrda;)V", line = 166)
