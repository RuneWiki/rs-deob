...
public class class34 extends class101 {
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(Ljp;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!bja", name = "b", descriptor = "(Ljp;I)Ljfa;", line = 58)
    ...
    @OriginalMember(owner = "client!bja", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "()V", line = 118)
    public class34() {
    }

    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(ZLqn;)V", line = 137)
