...
public class class34 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILti;)I", line = 5)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lgt;)V", line = 184)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)Lae;", line = 71)
    ...
    @OriginalMember(owner = "client!wv", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)Z", line = 108)
