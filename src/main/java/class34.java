...
public class class34 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BII)I", line = 23)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLac;)Lob;", line = 43)
