...
public class class65 implements Runnable {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILnp;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILur;B)Lnp;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lur;[BIB)Lnp;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IILla;ILya;IZ)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lur;BI)Lnp;")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lec;)V")
