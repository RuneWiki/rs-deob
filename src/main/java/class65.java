...
public class class65 extends class417 implements class248 {
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(IIIIIIIIIILnu;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILqa;ZLto;III)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;II)Lc;")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;Lto;III)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lpa;III)J")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZLqa;)Lae;")
    public final class163 method13(boolean arg0, class162 arg1) {
        field1105++;
        return arg0 ? null : null;
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BLqa;)V")
