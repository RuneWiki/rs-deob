...
public class class65 extends class715 {
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Leea;Leq;Lwv;)V")
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ILdu;I)V")
