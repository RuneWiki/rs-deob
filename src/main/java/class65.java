...
public abstract class class65 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILjava/awt/Canvas;BILd;ILaj;)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZLvr;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[IZIII)Lvr;")
