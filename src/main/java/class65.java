...
public class class65 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BJ)V", line = 5)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILie;BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIBLug;)V", line = 139)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lug;II)V", line = 203)
