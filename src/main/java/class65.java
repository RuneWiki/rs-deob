...
public class class65 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)[Lg;", line = 20)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(B)Z", line = 51)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Z)V", line = 77)
