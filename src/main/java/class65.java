...
public class class65 extends class631 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILpda;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lpda;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "()Lpda;")
