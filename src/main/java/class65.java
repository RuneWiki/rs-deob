...
public class class65 extends class83 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)[I", line = 33)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IBLtq;)V", line = 86)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 120)
    public class65() {
        super(3, false);
    }

    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(II)Lnq;", line = 123)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lvm;IBIILqs;II)V", line = 172)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(II)Lqf;", line = 253)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZZ)V", line = 298)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZI)[[I", line = 408)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(I)V", line = 491)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 504)
