...
public class class65 extends class623 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IBLjava/lang/String;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(ILtn;)V", line = 47)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(III)I", line = 70)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Ltn;II)V", line = 114)
