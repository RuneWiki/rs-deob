...
public class class65 extends class169 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltt;IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ZBZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!cd", name = "e", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltt;IIIIZ[FI)V", line = 70)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 96)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIB[IIIZ)V", line = 129)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltt;IIII)V", line = 182)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltt;IIIIZ[BIZ)V", line = 202)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltt;IIIIZ[IZ)V", line = 258)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIII[BIIZI)V", line = 309)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lgt;IIBII)Ljava/awt/Frame;", line = 368)
