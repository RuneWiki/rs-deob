...
public abstract class class65 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILvda;)Z", line = 11)
    ...
    @OriginalMember(owner = "client!pv", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B[BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!pv", name = "finalize", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lqj;I[BIZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lqj;ILjaclib/memory/Buffer;IZ)V", line = 118)
