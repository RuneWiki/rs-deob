...
public class class65 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)V", line = 40)
    public void method496(int arg0) throws Exception {
        field720++;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILmha;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILmha;)V", line = 71)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 83)
    public void method499(Component arg0) throws Exception {
        field734++;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lr;III[Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "([II)V", line = 121)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "()V", line = 326)
    public void method503() throws Exception {
        field714++;
    }

    @OriginalMember(owner = "client!qn", name = "b", descriptor = "()I", line = 334)
    public int method504() throws Exception {
        field704++;
        return this.field724;
    }

    @OriginalMember(owner = "client!qn", name = "c", descriptor = "()V", line = 353)
    public void method505() throws Exception {
        field709++;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)V", line = 363)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!qn", name = "d", descriptor = "()V", line = 499)
