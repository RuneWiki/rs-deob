...
public class class65 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZZ)Z", line = 8)
    public static boolean method550(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 47)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 139)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lha;IIIILqfa;)V", line = 173)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BJLjava/lang/Object;)V", line = 231)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(I)I", line = 244)
    ...
    @OriginalMember(owner = "client!qr", name = "d", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)I", line = 280)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(JI)V", line = 293)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 306)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(I)V", line = 319)
    public class65(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BIJLjava/lang/Object;)V", line = 323)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BLrk;)V", line = 358)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(Z)I", line = 378)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(II)V", line = 405)
