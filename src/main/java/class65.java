...
public class class65 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(IIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!qu", name = "toString", descriptor = "()Ljava/lang/String;", line = 101)
