...
public class class65 extends class384 {
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lkd;[IIIII)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IILq;II)V")
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lkd;[III)V")
