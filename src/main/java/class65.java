...
public class class65 extends class85 {
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lpm;Lhi;[Ltr;[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "([B[IIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "([B[IIIIIIIIIIILtm;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(CIIIZLtm;II)V", line = 155)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(CIIIZ)V", line = 221)
