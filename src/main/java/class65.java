...
public class class65 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BLol;)Lci;", line = 39)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "([BIIB)[B", line = 52)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(II)Lff;", line = 101)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lmca;ILgga;Lgga;)V", line = 170)
