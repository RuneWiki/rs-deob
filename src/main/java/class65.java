...
public class class65 implements Runnable {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IBLjava/lang/String;)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)Lor;")
    public final class275 method596(int arg0) {
        return arg0 == 0 ? this.method609(13, true, 0, 0, (Object) null) : null;
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/awt/Frame;)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Z)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;B)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/lang/Class;)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/Class;B)Lor;")
    public final class275 method601(Class arg0, byte arg1) {
        int var3 = 36 % ((-arg1 - 90) / 35);
        return this.method609(20, true, 0, 0, arg0);
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/lang/String;)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLjava/awt/datatransfer/Transferable;)Lor;")
    public final class275 method604(byte arg0, Transferable arg1) {
        int var3 = 69 % ((arg0 + 41) / 54);
        return this.method609(19, true, 0, 0, arg1);
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;I)Lor;")
    public final class275 method605(String arg0, int arg1) {
        return arg1 == 21 ? this.method609(21, true, 0, 0, arg0) : null;
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/awt/Component;BI)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/net/URL;B)Lor;")
    public final class275 method608(URL arg0, byte arg1) {
        return arg1 <= 22 ? null : this.method609(4, true, 0, 0, arg0);
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IZIILjava/lang/Object;)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIII)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(Z)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/Class;Z)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/awt/Component;ILjava/awt/Point;[III)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "e", descriptor = "(I)Luf;")
    public final class322 method614(int arg0) {
        int var2 = -64 % ((49 - arg0) / 47);
        return this.field957;
    }

    @OriginalMember(owner = "client!is", name = "f", descriptor = "(I)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lor;")
    public final class275 method616(Runnable arg0, int arg1, int arg2) {
        return arg1 == 1 ? this.method609(2, true, arg2, 0, arg0) : null;
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/lang/Object;III)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(II)Lor;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lor;")
