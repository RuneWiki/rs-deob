...
public class class65 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZI)[B", line = 10)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Luq;ILha;)V", line = 68)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "([BB)V", line = 198)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Z)V", line = 249)
