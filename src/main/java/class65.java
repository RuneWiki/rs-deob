...
public class class65 extends class476 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(BLqa;JZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lqa;Lon;Lqp;J)V", line = 327)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(JLqa;B)V", line = 290)
