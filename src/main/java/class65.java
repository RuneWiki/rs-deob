...
public abstract class class65 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIC)C", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(III)Lqo;", line = 98)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIB)I", line = 122)
