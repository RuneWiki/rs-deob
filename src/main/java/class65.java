...
public class class65 extends class179 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 57)
    public class65() {
    }

    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 59)
    public class65(String arg0) {
        this.field1073 = arg0;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(FZ)F", line = 67)
