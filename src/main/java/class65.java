...
public class class65 extends class359 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IB)V", line = 30)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIBIF)V", line = 40)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([III)V", line = 152)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(II)V", line = 288)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lwa;IIII)V", line = 300)
