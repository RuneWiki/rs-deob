...
public abstract class class65 extends class539 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II[I[IB)V", line = 23)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(Z)I", line = 97)
    ...
    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!oi", name = "g", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)Z", line = 204)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Len;)V", line = 216)
    public class65(class289 arg0) {
        this.field852 = arg0;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIIIB)V", line = 226)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(B)Z", line = 308)
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "(Z)[I", line = 318)
