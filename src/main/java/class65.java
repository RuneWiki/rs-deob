...
public class class65 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IILil;)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIILro;)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILil;)V")
