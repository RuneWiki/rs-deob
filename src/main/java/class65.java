...
public class class65 extends class24 implements class483 {
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lad;Z)V")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILjaclib/memory/Source;IB)Z")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILwv;)[Ldm;")
