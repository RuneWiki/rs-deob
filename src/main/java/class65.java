...
public class class65 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lck;I)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lck;Z)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILck;I)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLck;I)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lck;IBLwq;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILck;)V")
