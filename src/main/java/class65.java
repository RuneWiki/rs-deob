...
public class class65 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lqi;[Lfg;)Lnn;", line = 10)
    ...
    @OriginalMember(owner = "client!nn", name = "finalize", descriptor = "()V", line = 69)
    protected final void finalize() throws Throwable {
        this.field979.method2703(this.field977);
        super.finalize();
    }

    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lqi;I[Lfg;)V", line = 74)
