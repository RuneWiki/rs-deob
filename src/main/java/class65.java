...
public class class65 extends class285 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IB)Z", line = 10)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLpc;)V", line = 25)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(IB)Z", line = 74)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(II)I", line = 115)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(IZ)Lh;", line = 132)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lpc;)V", line = 485)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lfh;B)V", line = 165)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)Lfh;", line = 436)
