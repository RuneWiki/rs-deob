...
public class class65 {
    ...
    @OriginalMember(owner = "client!VMVYFNTB", name = "o", descriptor = "I")
    ...
    @OriginalMember(owner = "client!VMVYFNTB", name = "a", descriptor = "(BLXJCNBMKS;)V")
    ...
    @OriginalMember(owner = "client!VMVYFNTB", name = "a", descriptor = "(LXJCNBMKS;B)V")
