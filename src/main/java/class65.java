...
public class class65 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "Llf;")
    public static class109 field1243 = class35.method275("http:)4)4www)3runescape)3com", 2);

    @OriginalMember(owner = "client!ge", name = "f", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lua;I)V")
