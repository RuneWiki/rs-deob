...
public class class65 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IBLea;)Z", line = 12)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IJ)Lsk;", line = 423)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIIIIIIIILbm;)Z", line = 458)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 815)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)V", line = 830)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(JZLsk;)V", line = 840)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIBIII)V", line = 872)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 896)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(I)V", line = 927)
