...
public class class65 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;)V", line = 22)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 39)
    public class65(String arg0, int arg1) {
        this.field933 = arg0;
        this.field930 = arg1;
    }

    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!iv", name = "toString", descriptor = "()Ljava/lang/String;", line = 86)
