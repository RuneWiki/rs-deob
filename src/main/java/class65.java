...
public class class65 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILwea;Ljava/awt/Component;II)Lcba;", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "finalize", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lbga;II)V", line = 107)
    public class65(class358 arg0, int arg1, int arg2) {
        this.field1247 = arg0;
        this.field1246 = arg2;
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 118)
