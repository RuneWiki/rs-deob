...
public abstract class class65 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZLjd;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BII[III)Ljd;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZLjava/awt/Canvas;IILwia;IILd;)Lha;")
