...
public class class65 extends class457 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ZB)V", line = 14)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIILvr;Lvr;)V", line = 46)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lmk;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lef;)V", line = 72)
    public class65(class338 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lmg;Lya;Lmg;B)V", line = 76)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)Z", line = 93)
    public final boolean method429(int arg0) {
        ++field895;
        return arg0 == 0;
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lds;I)V", line = 104)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IB)Ldn;", line = 169)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 212)
