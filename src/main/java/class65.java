...
public class class65 extends class227 implements class632 {
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lad;I[BIZ)V", line = 3)
    public class65(class362 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field723 = arg1;
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I[BIB)V", line = 11)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!u", name = "e", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lad;ILjaclib/memory/Buffer;IZ)V", line = 47)
    public class65(class362 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field723 = arg1;
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)J", line = 60)
    ...
    @OriginalMember(owner = "client!u", name = "d", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)I", line = 87)
