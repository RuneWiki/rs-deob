...
public class class65 extends class512 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZILia;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "()V", line = 403)
    public class65() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIIIZI)I", line = 133)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IB)[I", line = 208)
    ...
    @OriginalMember(owner = "client!vf", name = "f", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([III)V", line = 244)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIZZI)I", line = 411)
    ...
    @OriginalMember(owner = "client!vf", name = "g", descriptor = "(I)V", line = 452)
