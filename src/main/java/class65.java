...
public class class65 extends class55 {
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "()I", line = 3)
    public final int method451() {
        field965++;
        return 0;
    }

    @OriginalMember(owner = "client!di", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(II)Z", line = 23)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILvi;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "()Ler;", line = 73)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lnq;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLvi;[IIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "()Ler;", line = 202)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lom;)V", line = 283)
    public class65(class210 arg0) {
        this.field961 = arg0;
    }

    @OriginalMember(owner = "client!di", name = "b", descriptor = "([III)V", line = 235)
