...
public class class65 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(II)Ldga;")
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(ZI)Laja;")
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(III)Lfe;")
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lgp;ILuu;)V")
