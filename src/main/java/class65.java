...
public class class65 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IFLfb;Lfb;)Z")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)Lqk;")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lbo;)V")
