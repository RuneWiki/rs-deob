...
public class class65 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!XHFSQKPU", name = "p", descriptor = "[LCUKAGIIJ;")
    ...
    @OriginalMember(owner = "client!XHFSQKPU", name = "o", descriptor = "LEDCVNWGU;")
    public class17 field1623;

    @OriginalMember(owner = "client!XHFSQKPU", name = "q", descriptor = "LHCBLGNPC;")
