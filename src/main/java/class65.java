...
public class class65 extends class352 {
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(IIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IBI)V", line = 48)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lbo;ILps;BLqa;I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(IBI)V", line = 275)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(III)V", line = 291)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lhu;I)[Lmg;", line = 301)
