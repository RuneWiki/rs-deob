...
public class class65 extends class62 {
    ...
    @OriginalMember(owner = "client!XANVNPIN", name = "<init>", descriptor = "(LFNOQZAYQ;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!XANVNPIN", name = "a", descriptor = "(LPQKEJITK;III)V")
