...
public class class65 extends class326 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BI)[I", line = 9)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(IB)[[I", line = 255)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILbt;I)V", line = 573)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "()V", line = 670)
    public class65() {
        super(2, false);
    }

    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 691)
