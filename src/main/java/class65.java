...
public class class65 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([Llf;Ljava/lang/String;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZI)I", line = 109)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([Llf;ILjava/lang/String;B)I", line = 120)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILjava/lang/String;[Llf;II)I", line = 149)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([Llf;ZILjava/lang/String;)I", line = 166)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I[I[Llf;[Ljava/lang/String;Ljava/lang/String;)I", line = 207)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZCI)I", line = 459)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLjava/lang/String;)I", line = 481)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLjava/lang/String;C)[Ljava/lang/String;", line = 500)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "([B)V", line = 544)
