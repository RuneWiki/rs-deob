...
@OriginalClass("client!YLURZVWU")
public class class65 {

    @OriginalMember(owner = "client!YLURZVWU", name = "a", descriptor = "Z")
    private boolean field1530 = false;

    @OriginalMember(owner = "client!YLURZVWU", name = "c", descriptor = "LZSZDCWXM;")
    public class72 field1532 = new class72();

    @OriginalMember(owner = "client!YLURZVWU", name = "b", descriptor = "I")
    private int field1531;

    @OriginalMember(owner = "client!YLURZVWU", name = "d", descriptor = "LZSZDCWXM;")
    private class72 field1533;

    @OriginalMember(owner = "client!YLURZVWU", name = "<init>", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "a", descriptor = "(LZSZDCWXM;)V")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "a", descriptor = "(LZSZDCWXM;I)V")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "a", descriptor = "()LZSZDCWXM;")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "b", descriptor = "()LZSZDCWXM;")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "a", descriptor = "(I)LZSZDCWXM;")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "a", descriptor = "(Z)LZSZDCWXM;")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "b", descriptor = "(I)LZSZDCWXM;")
    ...
    @OriginalMember(owner = "client!YLURZVWU", name = "c", descriptor = "()V")
