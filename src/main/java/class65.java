...
public class class65 extends class222 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(IIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(I)V", line = 42)
    public static void method571(int arg0) {
        int var1 = 0 / ((70 - arg0) / 46);
        field1143 = null;
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIZ)V", line = 67)
