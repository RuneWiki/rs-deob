...
public class class65 extends class319 {
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Lih;Lul;[Ldd;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(CIIIZLta;II)V", line = 209)
    ...
    @OriginalMember(owner = "client!qu", name = "B", descriptor = "(CIIIZ)V", line = 253)
