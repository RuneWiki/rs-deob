...
public class class65 extends class189 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ZII)Lml;")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I[Ljava/lang/Object;[IZI)V")
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(S)V")
