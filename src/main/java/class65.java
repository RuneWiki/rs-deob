...
public class class65 {
    ...
    @OriginalMember(owner = "client!XJOITHUI", name = "n", descriptor = "I")
    ...
    @OriginalMember(owner = "client!XJOITHUI", name = "a", descriptor = "(ILBJPWOXRJ;)V")
    ...
    @OriginalMember(owner = "client!XJOITHUI", name = "a", descriptor = "(LBJPWOXRJ;B)V")
