...
public class class65 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I[BII)I", line = 24)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILoh;)V", line = 54)
