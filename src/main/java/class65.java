...
public class class65 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(CI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lhk;)V", line = 566)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZLrp;)V", line = 69)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBIII)Z", line = 88)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)Z", line = 301)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(I)Z", line = 430)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLrp;)Z", line = 441)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)V", line = 481)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BII)V", line = 510)
