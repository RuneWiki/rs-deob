...
public class class505 extends class219 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "([BBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lwm;BLjava/lang/String;)I", line = 17)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IB[BI)I", line = 62)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(II)Z", line = 140)
    ...
    @OriginalMember(owner = "client!no", name = "finalize", descriptor = "()V", line = 153)
    protected final void finalize() {
        this.method1360((byte) 49);
        field7482++;
    }

    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 164)
