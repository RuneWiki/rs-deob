...
public class class505 extends class404 {
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "()V", line = 160)
    public class505() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILha;I)V", line = 165)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)[I", line = 209)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(Z)V", line = 297)
