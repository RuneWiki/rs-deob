...
public class class505 extends class478 {
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ZI)[[I", line = 29)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(B)V", line = 346)
    public static void method2897(byte arg0) {
        int var1 = -38 % ((arg0 - 28) / 47);
        field7272 = null;
    }

    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "()V", line = 357)
    public class505() {
        super(2, false);
    }

    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(II)[I", line = 360)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILnp;I)V", line = 607)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILsp;)V", line = 643)
    ...
    @OriginalMember(owner = "client!mk", name = "f", descriptor = "(I)V", line = 717)
