...
public class class505 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lpu;I)V")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lga;ILqj;ILud;ILrk;Ldh;IILr;Lln;)Lda;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lrk;ILga;Lqj;[Lpba;IILr;IILln;ZLsh;Ldh;Lrk;IBILud;)Lda;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIILdh;)V")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIBIILln;Lrk;ILdh;Lr;II)Lda;")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IILga;I)V")
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "([Lkfa;ILok;)Lhca;")
