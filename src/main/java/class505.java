...
public class class505 extends class657 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIZ)Ljava/lang/String;", line = 58)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILdu;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZB)V", line = 138)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lbga;Lin;Lur;)V", line = 151)
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZ)V", line = 184)
