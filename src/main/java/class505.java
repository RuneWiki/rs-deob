...
public class class505 extends class778 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IZLha;I)Z")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Lha;IIB)Lka;")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Lha;B)Lhq;")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Leh;Lka;Lha;B)V")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ILsf;Lha;BIIZ)V")
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(Lha;B)Lpw;")
