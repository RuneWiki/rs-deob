...
public class class505 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(I)V", line = 16)
    public class505(int arg0) {
        this.field7239 = arg0;
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lum;Z)Z", line = 25)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Ljb;II)I", line = 175)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 191)
    public static void method2992(byte arg0) {
        field7241 = null;
        int var1 = 41 % ((-arg0 - 1) / 50);
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "()V", line = 202)
    ...
    @OriginalMember(owner = "client!bda", name = "toString", descriptor = "()Ljava/lang/String;", line = 373)
