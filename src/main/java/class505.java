...
public class class505 extends class656 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I[B[BIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lvfa;BZII)V", line = 89)
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "([B)V", line = 198)
