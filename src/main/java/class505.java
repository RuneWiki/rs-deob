...
public class class505 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(II)Lmw;", line = 30)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILk;ILha;IIIIIIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!ve", name = "d", descriptor = "(II)V", line = 160)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 185)
