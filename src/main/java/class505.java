...
public class class505 implements class81 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)Z", line = 13)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IBIZZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lha;ILvo;IZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Llga;Lqj;)V", line = 413)
