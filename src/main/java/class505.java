...
public class class505 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lsl;BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLsl;)V", line = 41)
