...
public class class505 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLrr;Lrr;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLji;I)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLji;)V")
