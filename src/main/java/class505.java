...
public class class505 extends class417 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ZLcu;Lcu;II)I")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Ljava/lang/String;Llp;ZZI)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lica;)V")
