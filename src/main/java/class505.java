...
public class class505 extends class607 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IBLiu;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZB)V", line = 79)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(B)Z", line = 98)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IZ)V", line = 173)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(III)V", line = 183)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lrca;Lkea;Lki;)V", line = 208)
