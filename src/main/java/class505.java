...
public class class505 extends class297 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lnk;II)V", line = 40)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZI)V", line = 56)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZII)V", line = 67)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lbo;)V", line = 79)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 151)
