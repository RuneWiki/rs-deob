...
public abstract class class505 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "([II[Ljava/lang/Object;)V", line = 123)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ILs;)V", line = 146)
