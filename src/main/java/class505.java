...
public class class505 extends class270 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II)Lep;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B[B)Lxa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lok;B)V")
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Low;IIIII)V")
