...
public class class505 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(JB)Lgk;")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(JLgk;I)V")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZLmo;)V")
