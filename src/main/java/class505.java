...
public class class505 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILka;III)Lcca;", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([IIIZ[IIIIIIIZ[I[IIB[I[[[B)V", line = 22)
    ...
    @OriginalMember(owner = "client!eu", name = "toString", descriptor = "()Ljava/lang/String;", line = 463)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 471)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILnda;II)J", line = 490)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(I)V", line = 518)
