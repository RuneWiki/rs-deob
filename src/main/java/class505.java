...
public class class505 extends class149 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BI)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(BI)V", line = 79)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "()V", line = 337)
    public class505() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ak", name = "e", descriptor = "(B)V", line = 344)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBLtl;)V", line = 455)
