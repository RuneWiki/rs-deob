...
public class class505 extends class154 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIIIII)Lpv;", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 26)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZIIIB)V", line = 80)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IBI)V", line = 94)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(III)V", line = 114)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(IIIIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IBIF[FIIIFIIIF)V", line = 161)
