...
public class class505 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BZ)V", line = 74)
