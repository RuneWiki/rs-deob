...
public class class505 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!cba", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 3)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IILjava/awt/Frame;IBI)V", line = 19)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)[I", line = 42)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "()V", line = 56)
    public class505() {
        this.field6912.initialize(null);
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 65)
