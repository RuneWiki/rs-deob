...
public class class505 extends class497 {
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lko;Lwia;)V", line = 155)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZB)V", line = 14)
    public final void method928(boolean arg0, byte arg1) {
        int var3 = -36 / ((24 - arg1) / 46);
        ++field7169;
    }

    @OriginalMember(owner = "client!bi", name = "e", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IZ)V", line = 104)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)Z", line = 214)
    ...
    @OriginalMember(owner = "client!bi", name = "f", descriptor = "(Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BILkja;)V", line = 235)
    ...
    @OriginalMember(owner = "client!bi", name = "d", descriptor = "(Z)V", line = 288)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IBI)V", line = 313)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(II)I", line = 323)
