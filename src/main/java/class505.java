...
public class class505 extends class349 {
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "()V", line = 164)
    public class505() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!qh", name = "f", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IILdga;)V", line = 178)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIIBIII)V", line = 238)
