...
public class class505 extends class283 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLd;IZ)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lno;IIII)Lmn;")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lfba;I)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILfba;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lfba;B)V")
