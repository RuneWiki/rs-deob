...
public class class505 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Les;B)V", line = 24)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IIIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(B)Z", line = 253)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Les;II)V", line = 265)
