...
public class class505 extends class340 implements class281 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLha;Lrr;IIII)V")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(ILha;)Llca;")
