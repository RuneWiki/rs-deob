...
public class class505 extends class164 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILun;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BC)I", line = 97)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(FFIZIFILwfa;IFI[BIF)V", line = 124)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(CB)I", line = 177)
    ...
    @OriginalMember(owner = "client!nd", name = "e", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IBIFIIII[FIFFI)V", line = 219)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BLun;)V", line = 310)
