...
public class class505 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILsv;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)Lau;", line = 26)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lmb;III)V", line = 65)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lsv;Z)V", line = 95)
