...
public class class505 extends class85 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lm;ILdn;IIZ)[F", line = 3)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lm;Ldn;B)Z", line = 114)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZBLm;Ldn;DII)[I", line = 166)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZILdn;Lm;DIZI)[I", line = 325)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BB)V", line = 464)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BIIIII)V", line = 506)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "()V", line = 612)
    public class505() {
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lbt;)V", line = 627)
