...
public class class505 extends class649 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)I", line = 10)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lhs;)V", line = 67)
    public class505(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ss", name = "e", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Laia;I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ss", name = "f", descriptor = "(I)Z", line = 139)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IB)V", line = 151)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIB)Z", line = 162)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(ILhs;)V", line = 173)
    public class505(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IBI)Z", line = 177)
