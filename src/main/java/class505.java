...
public class class505 {
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IZ)I", line = 56)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIZI)Z", line = 73)
