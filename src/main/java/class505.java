...
public class class505 extends class30 {
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IB)[[I", line = 19)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZII)V", line = 85)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BILac;)V", line = 119)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lor;IIIIIIIIIILma;)V", line = 133)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "()V", line = 160)
    public class505() {
        super(0, false);
    }
}
