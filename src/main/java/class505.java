...
public class class505 implements class655 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZIILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)Lmh;", line = 20)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/awt/Canvas;IILfa;)Lr;", line = 59)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILps;IB)V", line = 70)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(I)V", line = 94)
