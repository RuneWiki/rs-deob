...
public class class505 extends class329 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 26)
    public class505(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lda;)V", line = 30)
    public static final void method2947(class442 arg0) {
        class221.field3032 = arg0;
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 51)
