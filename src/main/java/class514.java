...
public class class514 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ljava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lza;Ljava/lang/String;[IIIIZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lza;Ljava/lang/String;IIIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lza;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "()V", line = 150)
    public static void method3043() {
        field7622 = null;
    }

    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lza;IZLjava/awt/Component;)V", line = 169)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "()I", line = 158)
    public final int method3044() {
        return this.field7616;
    }

    @OriginalMember(owner = "client!it", name = "c", descriptor = "()I", line = 167)
