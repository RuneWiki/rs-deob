...
public class class514 extends class589 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(JJ)J", line = 7)
    public static long method3068(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "()V", line = 25)
    public class514() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BII)V", line = 28)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(IIII)[B", line = 48)
