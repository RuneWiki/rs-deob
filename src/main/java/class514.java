...
public class class514 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)Lig;", line = 125)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(B)Z", line = 158)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!dp", name = "d", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZLig;)V", line = 214)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(B)Lig;", line = 234)
    ...
    @OriginalMember(owner = "client!dp", name = "e", descriptor = "(B)Lig;", line = 251)
    ...
    @OriginalMember(owner = "client!dp", name = "f", descriptor = "(B)Z", line = 280)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "()V", line = 309)
    public class514() {
        try {
