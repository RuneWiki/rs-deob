...
public class class514 extends class477 {
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lgk;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lrh;II)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lwk;I)Z")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IILqt;I)V")
