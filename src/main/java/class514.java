...
public class class514 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II)Lgr;", line = 11)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IILri;)Lfm;", line = 72)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(I)V", line = 104)
    public static void method3119(int arg0) {
        int var1 = -73 / ((9 - arg0) / 55);
        field7472 = null;
    }

    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lei;ILri;)V", line = 116)
