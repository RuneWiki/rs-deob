...
public class class514 implements class46 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)Lsq;", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZII)Z", line = 45)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lpe;Lop;IIIIIII)V", line = 61)
