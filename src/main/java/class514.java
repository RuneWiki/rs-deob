...
public class class514 extends class631 {
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IILta;)V", line = 411)
    public final void method1508(int arg0, int arg1, class210 arg2) {
        ++field7330;
        int var4 = 36 % ((arg1 - 52) / 62);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IZ)V", line = 420)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)V", line = 433)
    ...
    @OriginalMember(owner = "client!gq", name = "f", descriptor = "(I)V", line = 478)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IBIII)V", line = 525)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)Z", line = 567)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Leea;Lrc;)V", line = 577)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 590)
