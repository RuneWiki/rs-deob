...
public class class514 extends class209 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([BIZFFILqi;FIFIFI)V", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 24)
    public class514() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "(IIII)[B", line = 27)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILla;)I", line = 46)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IBI)V", line = 112)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(III)Z", line = 129)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(B)V", line = 140)
