...
public class class514 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IBLah;)V", line = 6)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Z", line = 323)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 357)
