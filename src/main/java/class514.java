...
public class class514 extends class217 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIB)V", line = 111)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIZ)V", line = 149)
