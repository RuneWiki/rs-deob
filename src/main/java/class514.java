...
public class class514 implements class338 {
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Ljo;Lsv;)V", line = 87)
