...
public class class514 extends class631 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lr;J)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIII)V", line = 51)
    public final void method2906(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field7157 = arg0;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lr;J[Lmp;[Lfk;Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IZ)Lii;", line = 76)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([Lfk;Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class514(int arg0, boolean arg1) {
        this.method2920(arg0, arg1);
    }

    @OriginalMember(owner = "client!ii", name = "b", descriptor = "()V", line = 183)
    public final void method2911() {
        this.field7159 = true;
    }

    @OriginalMember(owner = "client!ii", name = "c", descriptor = "()V", line = 192)
    public final void method2912() {
        this.field7150 = true;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lr;)V", line = 195)
    ...
    @OriginalMember(owner = "client!ii", name = "d", descriptor = "()Lec;", line = 211)
    ...
    @OriginalMember(owner = "client!ii", name = "e", descriptor = "()Lec;", line = 227)
    public final class144 method2915() {
        return this.field7161;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lr;[Lmp;Z)V", line = 235)
    ...
    @OriginalMember(owner = "client!ii", name = "f", descriptor = "()V", line = 310)
    public static void method2917() {
        field7153 = null;
        field7151 = null;
    }

    @OriginalMember(owner = "client!ii", name = "g", descriptor = "()V", line = 317)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(J)V", line = 356)
    public final void method2919(long arg0) {
        this.field7147 = arg0;
    }

    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(IZ)V", line = 364)
