...
public class class514 extends class345 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Lns;", line = 37)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIILnu;)V", line = 63)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IFIIIII[FIFIFI)V", line = 75)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLkh;)V", line = 174)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIII)Z", line = 231)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[I[IZI)V", line = 448)
