...
public class class514 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IB)[I", line = 42)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 66)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(IB)Z", line = 108)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ljava/net/Socket;IB)Lhb;", line = 119)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 130)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(II)Lwq;", line = 238)
