...
public class class514 extends class439 {
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILav;BLkj;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III)V", line = 349)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 370)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)V", line = 381)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lqa;ILet;)V", line = 402)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BII)V", line = 428)
    public final void method500(byte arg0, int arg1, int arg2) {
        int var4 = 81 % ((-75 - arg0) / 49);
        ++field7267;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IBI)V", line = 437)
