...
public class class514 extends class87 {
    ...
    @OriginalMember(owner = "client!jn", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "()V", line = 24)
    public class514() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BIII)[B", line = 27)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IBB)V", line = 40)
