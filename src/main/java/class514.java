...
public class class514 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIZII)V", line = 19)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BI)Llh;", line = 266)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 312)
