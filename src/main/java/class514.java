...
public class class514 extends class274 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lta;IIFZ)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lnt;B)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lev;I)V")
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(ILev;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILev;)V")
