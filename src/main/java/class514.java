...
public class class514 extends class331 {
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!wf", name = "d", descriptor = "(B)I", line = 34)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lts;)V", line = 103)
    public class514(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(ILts;)V", line = 121)
    public class514(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(I)V", line = 125)
