...
public class class514 extends class148 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!fm", name = "e", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!fm", name = "f", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILdh;I)V", line = 170)
