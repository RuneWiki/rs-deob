...
public class class514 extends class379 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IILfs;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIII)I", line = 62)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(IIIIIZ)V", line = 91)
