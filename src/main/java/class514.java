...
public class class514 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIZ)I", line = 17)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lla;ILkf;Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)V", line = 136)
