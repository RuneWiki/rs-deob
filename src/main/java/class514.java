...
public class class514 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZI[II)Lhe;")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II[I)Lhe;")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "([III)Lhe;")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I[III)Lhe;")
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Ldk;Ldk;)V")
