...
public class class514 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Lha;ZLvd;)V", line = 43)
