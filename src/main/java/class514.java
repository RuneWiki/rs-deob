...
public class class514 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lup;Lcs;Lha;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)Z", line = 154)
    ...
    @OriginalMember(owner = "client!jq", name = "finalize", descriptor = "()V", line = 165)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILsh;Lhg;)Llk;", line = 202)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lbi;II)V", line = 247)
