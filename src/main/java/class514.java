...
public class class514 extends class260 {
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Ltd;ZLjava/lang/String;Ljava/lang/String;I)Lhu;")
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(Lgn;)V")
    public class514(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(II)I")
