...
public class class514 extends class214 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lraa;IIBILaa;ILha;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 179)
    public class514() {
        super(2, false);
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(JI)V", line = 182)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(II)[[I", line = 265)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IB)[I", line = 586)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILofa;I)V", line = 836)
