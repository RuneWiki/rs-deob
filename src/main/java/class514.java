...
public class class514 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IBLsha;I)V")
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(II)Lro;")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Ljk;IZLae;Lae;)V")
