...
public class class514 extends class232 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)V", line = 3)
    public final void method569(int arg0, int arg1, int arg2) {
        int var4 = 5 / ((48 - arg0) / 51);
        ++field7340;
    }

    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lwk;)V", line = 15)
    public class514(class151 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!np", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!np", name = "g", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZB)V", line = 57)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILdr;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILha;I)Lkf;", line = 104)
