...
public class class514 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILsi;)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)Lmq;")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(JLwi;[II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(ILns;Lns;Lgk;)V")
