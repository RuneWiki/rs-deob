...
public class class514 extends class170 {
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(Lza;I)Lnd;", line = 7)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BILza;Lrk;ILwk;)Z", line = 51)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLza;)V", line = 291)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLza;II)Z", line = 326)
