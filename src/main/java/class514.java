...
public class class514 extends class245 implements class51 {
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lsb;Lkea;II[BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIBII[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lsb;Lkea;Lkf;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BF)F", line = 54)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)I", line = 65)
    public final int method351(boolean arg0) {
        ++field7174;
        return arg0 ? -76 : this.field7180;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)Z", line = 76)
    public final boolean method348(byte arg0) {
        ++field7173;
        return arg0 != 117;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "([BILkea;IIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lsb;Lkea;II[FII)V", line = 113)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIIIII[II)V", line = 126)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IF)F", line = 149)
    public final float method354(int arg0, float arg1) {
        ++field7177;
        return arg0 != -23477 ? -0.7342964F : arg1;
    }

    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lsb;II[III)V", line = 163)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZBZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(B)V", line = 202)
