...
public class class514 extends class388 {
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBLqa;I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIB)Z", line = 61)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIIIBI)V", line = 73)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IZIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIIIII)V", line = 257)
