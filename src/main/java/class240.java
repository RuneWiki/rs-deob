...
public class class240 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)Z", line = 13)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lpj;)V", line = 205)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIB)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)Z", line = 118)
