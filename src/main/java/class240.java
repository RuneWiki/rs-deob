...
public class class240 extends class215 {
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BLza;)V", line = 225)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)V", line = 247)
