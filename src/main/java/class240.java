...
public class class240 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(II)Lig;", line = 5)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(II)Lpa;", line = 37)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(II)V", line = 363)
    public class240(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!j", name = "toString", descriptor = "()Ljava/lang/String;", line = 375)
