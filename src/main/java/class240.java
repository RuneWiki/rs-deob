...
public class class240 extends class398 {
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "()Lpo;", line = 61)
    public final class398 method700() {
        return (class398) this.field3608.method865(-1);
    }

    @OriginalMember(owner = "client!tc", name = "c", descriptor = "([III)V", line = 69)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmg;)V", line = 80)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lpo;)V", line = 97)
    public final synchronized void method1586(class398 arg0) {
        this.field3608.method853(-12691, arg0);
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(Lpo;)V", line = 101)
    public final synchronized void method1587(class398 arg0) {
        arg0.method421(22071);
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "()I", line = 105)
    public final int method692() {
        return 0;
    }

    @OriginalMember(owner = "client!tc", name = "e", descriptor = "()V", line = 109)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([III)V", line = 131)
    ...
    @OriginalMember(owner = "client!tc", name = "f", descriptor = "()I", line = 175)
    public final synchronized int method1589() {
        return this.field3608.method852(true);
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "()Lpo;", line = 183)
    public final class398 method693() {
        return (class398) this.field3608.method863(-1);
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lha;Lmg;)V", line = 186)
