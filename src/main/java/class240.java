...
public class class240 implements Runnable {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I[BILuf;)Lrl;", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "run", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BLpe;Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IILuf;)Lrl;", line = 389)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lvj;)V", line = 517)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lrl;I)V", line = 411)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)V", line = 431)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(IILuf;)Lrl;", line = 450)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BC)Z", line = 484)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IB)V", line = 496)
