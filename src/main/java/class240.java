...
public abstract class class240 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZZBLdp;)V", line = 27)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BLat;)Lit;", line = 86)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILct;)Lbk;", line = 114)
