...
public class class240 extends class441 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIZLof;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(Lss;IIIIZ)Z")
    public final boolean method858(class283 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIIIII[[ZLof;[I[I)V")
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field3393[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field1210; ++var23) {
                            ...
                            } else if (var21.field1209 != null && var21.field1209[var23] != -1) {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IILof;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lss;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(Lss;IIIIZ)V")
    public final void method849(class283 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ldq;[I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IILss;)Lss;")
    public final class283 method860(int arg0, int arg1, class283 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(IIIIIII[[ZLof;[I[I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Llg;IIII[[I[[II)V")
