...
public class class240 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIF)F", line = 4)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "()V", line = 12)
    public static void method1384() {
        field3033 = null;
        field3031 = null;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IF)I", line = 16)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(IIF)F", line = 76)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Liaa;Lwn;)V", line = 98)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(F)F", line = 174)
