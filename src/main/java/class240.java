...
public class class240 extends class316 implements class601 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Lbea;Z)V")
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
