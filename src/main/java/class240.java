...
public class class240 implements class146 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "()V", line = 190)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Ljava/awt/Component;ZII)V", line = 45)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BI)V", line = 119)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IZI)V", line = 163)
