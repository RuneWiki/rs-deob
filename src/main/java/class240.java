...
public class class240 extends OutputStream {
    ...
    @OriginalMember(owner = "client!mda", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field3450++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)[Lfc;", line = 14)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(Z)V", line = 33)
