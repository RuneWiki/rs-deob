...
public class class240 implements Runnable {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(IZ)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ti", name = "run", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(II[BI)I", line = 177)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 280)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)V", line = 265)
