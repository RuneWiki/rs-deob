...
public class class240 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIZ)Lwca;", line = 8)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lwca;II)I", line = 26)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)Lsk;", line = 46)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I[BIIBIII[B)V", line = 59)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 103)
