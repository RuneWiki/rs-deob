...
public class class240 extends class142 {
    ...
    @OriginalMember(owner = "client!oq", name = "p", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!oq", name = "k", descriptor = "(IILba;)Lba;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lvp;[I)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lba;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lgm;IBI)V")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lfd;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLya;)V")
