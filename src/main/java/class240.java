...
public class class240 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZI[B)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 38)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)V", line = 70)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)Ljb;", line = 83)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 166)
