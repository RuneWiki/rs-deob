...
public class class240 extends class192 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IIIBIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!ada", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "([IBI)V", line = 102)
    ...
    @OriginalMember(owner = "client!ada", name = "h", descriptor = "(I)Z", line = 260)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ILfd;I)V", line = 298)
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "()V", line = 437)
    public class240() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IIIIIII[[[BILoa;III)V", line = 399)
    ...
    @OriginalMember(owner = "client!ada", name = "c", descriptor = "(B)V", line = 441)
    ...
    @OriginalMember(owner = "client!ada", name = "e", descriptor = "(B)V", line = 484)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ILba;III)Lcd;", line = 527)
    ...
    @OriginalMember(owner = "client!ada", name = "f", descriptor = "(B)V", line = 543)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IB)[I", line = 582)
