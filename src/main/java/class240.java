...
public class class240 extends class287 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ll;Ldk;B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLoo;)V", line = 90)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ldk;ZIIILl;D)[I", line = 121)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZIILl;ILdk;)[F", line = 258)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZLl;IDLdk;IZI)[I", line = 369)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 512)
    public class240() {
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lsv;)V", line = 527)
