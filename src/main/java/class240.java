...
public class class240 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ILvd;)V")
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ILka;IZLria;I)V")
