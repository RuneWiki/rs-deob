...
public class class240 extends class82 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!oaa", name = "c", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!oaa", name = "d", descriptor = "(II)Z", line = 99)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(II)[[I", line = 120)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IILos;)V", line = 189)
    ...
    @OriginalMember(owner = "client!oaa", name = "c", descriptor = "(II)[I", line = 225)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "()V", line = 295)
    public class240() {
        super(1, false);
    }
}
