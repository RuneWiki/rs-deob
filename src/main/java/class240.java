...
public class class240 {
    ...
    @OriginalMember(owner = "client!ew", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field3089++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(I)V", line = 133)
