...
public class class240 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)[Llg;")
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)[Lnq;")
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lkl;ZI)V")
