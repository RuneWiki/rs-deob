...
public class class240 extends Callback {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(III)V", line = 7)
    public final void method1446(int arg0, int arg1, int arg2) {
        int var4 = -90 % ((arg0 + 63) / 48);
        User32.SetCursorPos(arg2, arg1);
    }

    @OriginalMember(owner = "client!kea", name = "callback", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ZLjava/awt/Component;B)V", line = 63)
