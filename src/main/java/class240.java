...
public class class240 extends class7 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lpk;IIIIIIIIIIIZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!du", name = "c", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(J)V", line = 48)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(JI)V", line = 176)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Lpk;IIIIIIIIIIIZZ)V", line = 571)
