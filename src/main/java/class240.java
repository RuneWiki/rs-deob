...
public class class240 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I[Laq;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ic", name = "write", descriptor = "(I)V", line = 93)
    public final void write(int arg0) throws IOException {
        field3155++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 130)
