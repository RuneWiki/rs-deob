...
public class class240 extends class624 {
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "()V", line = 97)
    public class240() {
        this.field3174 = System.nanoTime();
        this.field3175 = System.nanoTime();
    }

    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(JB)I", line = 8)
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(B)J", line = 41)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z)J", line = 65)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)J", line = 108)
