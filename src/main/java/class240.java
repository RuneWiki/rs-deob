...
public class class240 extends class492 implements class281 {
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(ILha;)Llca;")
    ...
    @OriginalMember(owner = "client!dt", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZLha;Lrr;IIII)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lha;B)V")
