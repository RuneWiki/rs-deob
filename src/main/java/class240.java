...
public class class240 {
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(Lwga;)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lwga;I)V")
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(II)Lwga;")
