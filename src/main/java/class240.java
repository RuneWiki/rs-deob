...
public class class240 extends class375 {
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lfu;IIZ[[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "()V", line = 24)
    public final void method88() {
        this.field5186.field557.glFramebufferTexture2DEXT(36160, this.field3508, 3553, 0, 0);
        this.field3508 = -1;
    }

    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lfu;IIZ[[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lfu;II)V", line = 65)
