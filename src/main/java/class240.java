...
public class class240 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILco;)V", line = 11)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIIIZIZ)V", line = 430)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/lang/String;)V", line = 474)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 499)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(III)I", line = 515)
