...
public class class240 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(B[[BLct;)V", line = 5)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!jda", name = "toString", descriptor = "()Ljava/lang/String;", line = 105)
