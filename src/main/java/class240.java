...
public class class240 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IC)Z", line = 7)
    ...
    @OriginalMember(owner = "client!uu", name = "toString", descriptor = "()Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IBIILha;III)V", line = 54)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILjava/io/File;I)[B", line = 78)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(II)V", line = 96)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)[Lmq;", line = 107)
