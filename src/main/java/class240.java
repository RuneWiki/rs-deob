...
public class class240 extends class40 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lhl;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLjava/awt/Component;)Lio;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IILlf;)V")
