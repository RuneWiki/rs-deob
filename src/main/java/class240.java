...
public class class240 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IBIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IIIILjg;)V", line = 50)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ZIILog;I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 211)
