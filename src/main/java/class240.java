...
public class class240 {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(ILud;)V")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(IB)Lki;")
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "(Lcw;ILeq;)V")
