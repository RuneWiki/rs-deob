...
public class class240 extends class431 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 5)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Led;ILsm;IIILya;IZI)Lt;", line = 33)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I[Luq;I)V", line = 273)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIII)I", line = 349)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lul;Lul;I)I", line = 400)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z[III[I)J", line = 432)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 477)
