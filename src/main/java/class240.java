...
public class class240 extends class657 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ILdu;I)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lwga;)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IIIIIIIIIZ)V")
