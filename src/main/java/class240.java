...
public class class240 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IB)V", line = 21)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)[Lbf;", line = 38)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)Lgw;", line = 49)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lvea;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lal;ILnd;)V", line = 172)
