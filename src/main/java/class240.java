...
public class class240 extends class55 implements class463 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)I", line = 3)
    public final int method35(byte arg0) {
        ++field3463;
        return arg0 <= 71 ? 34 : super.method35((byte) 95);
    }

    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lfc;Ldr;Z)V", line = 14)
    public class240(class642 arg0, class629 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field3468 = arg1;
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)V", line = 22)
    public final void method602(int arg0, int arg1) {
        super.method602(arg0, this.field3468.field8914 * arg1);
        ++field3466;
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 32)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/awt/Canvas;ILd;II)Lha;", line = 43)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)Ldr;", line = 90)
