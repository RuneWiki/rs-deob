...
public class class240 extends class438 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "()Lns;", line = 3)
    public final class174 method1552() {
        return this.field3398;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "([Lod;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "()V", line = 96)
    public final void method1554() {
        this.field3387 = true;
    }

    @OriginalMember(owner = "client!rs", name = "c", descriptor = "()V", line = 99)
    private final void method1555() {
        this.field3387 = false;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!rs", name = "d", descriptor = "()V", line = 112)
    public final void method1557() {
        this.field3401 = true;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lea;[Lkg;Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!rs", name = "e", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lea;J[Lkg;[Lod;Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(J)V", line = 221)
    public final void method1561(long arg0) {
        this.field3389 = arg0;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lea;J)Z", line = 224)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!rs", name = "f", descriptor = "()V", line = 279)
    ...
    @OriginalMember(owner = "client!rs", name = "g", descriptor = "()V", line = 298)
