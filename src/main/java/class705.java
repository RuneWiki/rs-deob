...
public class class705 implements Runnable {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/String;IZ)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILjava/net/URL;)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Lwc;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILjava/awt/Frame;)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B[Ljava/lang/Class;)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/String;I)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "([ILjava/awt/Point;IZILjava/awt/Component;)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIILjava/lang/Object;)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(BZLjava/lang/String;I)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(BLjava/lang/String;)Lwc;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(II)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIBII)Ltj;")
    ...
    @OriginalMember(owner = "client!wv", name = "d", descriptor = "(I)Ltj;")
    public final class614 method3967(int arg0) {
        int var2 = -33 / ((arg0 - 85) / 32);
        return this.method3962(5, 0, 0, 0, null);
    }

    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Ltj;")
