...
public class class705 extends class305 {
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(ILhb;)V", line = 6)
    public class705(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(II)I", line = 34)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(ILns;)I", line = 72)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lhb;)V", line = 151)
    public class705(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(II)V", line = 164)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIIILha;III)V", line = 204)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(I)Z", line = 229)
