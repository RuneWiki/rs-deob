...
public class class705 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLee;)Luc;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILee;Z)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILee;)V")
