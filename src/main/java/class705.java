...
public class class705 extends class297 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BLjava/lang/String;)I", line = 41)
