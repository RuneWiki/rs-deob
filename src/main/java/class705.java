...
public class class705 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IIZZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(II)Z", line = 59)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(ILav;I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lvj;)V", line = 127)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Z)V", line = 153)
