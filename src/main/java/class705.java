...
public class class705 extends class224 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILud;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lud;B)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lwq;[[BI)V")
