...
public class class705 {
    ...
    @OriginalMember(owner = "client!pw", name = "toString", descriptor = "()Ljava/lang/String;", line = 15)
    public final String toString() {
        field9807++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)Lch;", line = 38)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Lha;ZLfp;)V", line = 145)
