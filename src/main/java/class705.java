...
public class class705 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "()V", line = 3)
    private static final void method3930() {
        field9689 = 0;
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;[II)V", line = 166)
    public static final void method3934(class66 arg0, int[] arg1, int arg2) {
        method3938(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "()V", line = 217)
    public static void method3936() {
        field9687 = null;
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([III)V", line = 228)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 280)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;[II[I[I)V", line = 317)
