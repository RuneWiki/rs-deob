...
public class class705 extends class206 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILqt;)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lib;I)V")
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lib;)V")
