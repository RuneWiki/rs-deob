...
public class class705 extends class492 {
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ms", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(I)V", line = 53)
