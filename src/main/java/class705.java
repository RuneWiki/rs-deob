...
public class class705 extends class81 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B)Lau;", line = 4)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "([BIIIII[BBI)V", line = 66)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(III)Z", line = 172)
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ZZI)V", line = 201)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lch;IIIIII)V", line = 234)
