...
public class class705 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLha;I)Z")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILha;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(I[Lui;IIII)V")
