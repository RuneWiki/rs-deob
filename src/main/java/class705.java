...
public class class705 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Lda;)V", line = 514)
    public class705(class67 arg0) {
        this.field9922 = arg0;
    }

    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Lda;Lbq;)V", line = 521)
    public class705(class67 arg0, class307 arg1) {
        this.field9917 = arg1;
        this.field9922 = arg0;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "([IZII[I[II[[[BIIIIB[I[IIZI)V", line = 67)
