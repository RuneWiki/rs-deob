...
public class class705 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)Lih;", line = 3)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Llba;I)Les;", line = 29)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BI)Z", line = 100)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lpfa;Lpfa;)V", line = 115)
