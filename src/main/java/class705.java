...
public class class705 {
    ...
    @OriginalMember(owner = "client!waa", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field9770++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Let;I)I", line = 36)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 74)
