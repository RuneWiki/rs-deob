...
public class class705 extends class424 implements class258 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(ILha;)Ljda;")
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(Lha;I)Lhw;")
    ...
    @OriginalMember(owner = "client!pw", name = "p", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Lqo;I[Ltba;)Ldw;")
