...
public class class705 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lek;B)Z")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lek;Z)V")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lkv;)V")
