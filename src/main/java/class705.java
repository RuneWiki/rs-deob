...
public class class705 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lrk;B)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IILjava/net/Socket;)Liv;")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BLsha;)V")
