...
public class class705 extends class615 {
    ...
    @OriginalMember(owner = "client!lo", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lo", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "()V", line = 33)
    public class705() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIB)I", line = 160)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIII[FII)V", line = 173)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IB)[I", line = 271)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IZIIILii;)Ljava/awt/Frame;", line = 307)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 375)
