...
public class class777 extends class204 {
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lfs;)V")
    public class777(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(ILfs;)V")
    public class777(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILgs;)V")
