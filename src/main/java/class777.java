...
public class class777 implements class763 {
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)Luw;", line = 20)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Llga;Ljava/lang/String;)V", line = 47)
