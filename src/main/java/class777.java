...
public class class777 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IBII)Luv;", line = 42)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(II)Llfa;", line = 103)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 155)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 177)
