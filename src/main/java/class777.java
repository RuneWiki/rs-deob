...
public class class777 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILjava/lang/String;)V", line = 23)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)Ljava/lang/String;", line = 124)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)V", line = 155)
