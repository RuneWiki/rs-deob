...
public class class777 extends class601 {
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "()V", line = 23)
    public class777() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lmc;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IB)[I", line = 137)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZ)[B", line = 243)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(B)V", line = 362)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 374)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZLjava/awt/Component;Z)Ltb;", line = 409)
