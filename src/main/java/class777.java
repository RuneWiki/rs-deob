...
public class class777 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)[Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([BII[BIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!nh", name = "toString", descriptor = "()Ljava/lang/String;", line = 142)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 180)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(IZ)V", line = 248)
    public class777(int arg0, boolean arg1) {
        this.field10726 = arg0;
        this.field10719 = arg1;
    }

    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(II)I", line = 205)
