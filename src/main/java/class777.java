...
public class class777 extends class215 {
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 49)
