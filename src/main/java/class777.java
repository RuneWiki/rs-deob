...
public class class777 extends class590 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lha;J)V", line = 7)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "()V", line = 180)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lbw;IIIIIIIIIIIZZ)V", line = 188)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "()V", line = 211)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(JI)V", line = 223)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lbw;IIIIIIIIIIIZZ)V", line = 616)
