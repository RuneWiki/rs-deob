...
public class class777 extends Canvas {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!kr", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 37)
    public final void paint(Graphics arg0) {
        this.field10677.paint(arg0);
        field10673++;
    }

    @OriginalMember(owner = "client!kr", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 47)
    public final void update(Graphics arg0) {
        field10672++;
        this.field10677.update(arg0);
    }

    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 54)
