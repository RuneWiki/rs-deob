...
public class class445 extends class125 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljn;Ljn;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILhe;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IBI)Z", line = 74)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(ZI)V", line = 88)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lur;Lqf;)V", line = 100)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(JB)V", line = 120)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(III)V", line = 138)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZI)V", line = 177)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(ZI)V", line = 208)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)Z", line = 242)
