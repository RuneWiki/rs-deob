...
public class class445 extends class11 {
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)Z", line = 18)
    public final boolean method68(byte arg0) {
        ++field6662;
        return arg0 != 95 ? true : true;
    }

    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lad;Lme;)V", line = 31)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IILpm;)V", line = 97)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IBI)Z", line = 123)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIB)V", line = 134)
