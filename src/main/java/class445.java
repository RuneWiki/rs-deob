...
public class class445 extends class192 {
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!sk", name = "e", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(ZI)V", line = 52)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(IBI)I", line = 115)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IB)[I", line = 132)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "()V", line = 170)
    public class445() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sk", name = "h", descriptor = "(I)V", line = 177)
