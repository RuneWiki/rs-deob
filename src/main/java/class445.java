...
public class class445 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILap;)Liq;", line = 30)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIILbi;III)V", line = 73)
