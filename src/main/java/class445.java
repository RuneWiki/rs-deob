...
public class class445 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Luu;Luu;Luu;Luu;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!cj", name = "toString", descriptor = "()Ljava/lang/String;", line = 133)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BI)I", line = 160)
