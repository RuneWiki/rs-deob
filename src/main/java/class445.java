...
public class class445 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lge;)V")
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(Lge;)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lge;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lge;Lhe;)V")
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(Lge;)V")
