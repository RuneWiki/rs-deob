...
public class class445 extends class92 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "([B[IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ni", name = "HA", descriptor = "(CIIIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "([B[IIIIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Law;Llg;[Lqm;[I[I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "([B[IIIIIIIIIIILpa;II)V", line = 183)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(CIIIZLpa;II)V", line = 268)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "([B[IIIIIIIIIIILpa;II)V", line = 336)
