...
public class class445 extends class374 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZLew;I)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lsh;FFIIIBFIFF)[B")
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lvd;Lbt;)V")
