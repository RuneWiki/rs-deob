...
public class class445 extends class19 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "()V", line = 6)
    public final void method96() {
        field6391.method1635(this.field6390, -27096);
    }

    @OriginalMember(owner = "client!wo", name = "c", descriptor = "()V", line = 9)
    public final void method94() {
        field6391.method1637(this.field6390, super.field219);
    }

    @OriginalMember(owner = "client!wo", name = "b", descriptor = "()I", line = 12)
    public final int method98() {
        return field6391.method1636(this.field6390, (byte) -39);
    }

    @OriginalMember(owner = "client!wo", name = "e", descriptor = "()V", line = 16)
    public static void method2771() {
        field6391 = null;
    }

    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lrd;I)V", line = 18)
    public class445(class185 arg0, int arg1) {
        field6391 = arg0.method1259(-59);
        this.field6390 = arg1;
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "()V", line = 30)
