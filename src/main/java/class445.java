...
public class class445 extends class281 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILjp;)V")
    ...
    @OriginalMember(owner = "client!ep", name = "d", descriptor = "(B)Lds;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IILhj;III)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Ljp;II)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIIBIILha;)Lka;")
