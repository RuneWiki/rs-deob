...
public class class445 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lnv;)V", line = 91)
