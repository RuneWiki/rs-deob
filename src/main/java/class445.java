...
public class class445 extends class243 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ZLjava/awt/Component;)V", line = 10)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(II)Z", line = 34)
    ...
    @OriginalMember(owner = "client!am", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 48)
    public final void focusGained(FocusEvent arg0) {
        field6641++;
    }

    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!am", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 69)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field6633++;
        this.method2660(89, arg0, 0);
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IZCI)V", line = 77)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!am", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 160)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method2658(0, false, '\u0000', -1);
        field6632++;
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(III)Z", line = 170)
    ...
    @OriginalMember(owner = "client!am", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 182)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field6635++;
        this.method2660(98, arg0, 1);
    }

    @OriginalMember(owner = "client!am", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 195)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/awt/event/KeyEvent;I)V", line = 209)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)Lec;", line = 245)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 304)
    public class445(Component arg0) {
        class393.method2435((byte) 126);
        this.method2656(false, arg0);
    }

    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)V", line = 314)
