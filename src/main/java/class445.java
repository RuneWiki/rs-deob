...
public class class445 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)Lqb;", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lks;Lic;)V", line = 62)
