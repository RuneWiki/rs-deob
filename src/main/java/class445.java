...
public class class445 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZIILtq;IBI)V")
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(II)Ljr;")
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lgo;ILns;)V")
