...
public class class445 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(JI)Ljs;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)Ljs;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Ljs;JI)V")
