...
public class class445 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIIBIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)Z", line = 257)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 274)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 297)
