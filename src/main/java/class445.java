...
public class class445 extends class61 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZI)I", line = 23)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)Z", line = 42)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BII)Z", line = 58)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)V", line = 69)
