...
public class class445 extends Canvas {
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!bn", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        field6178++;
        this.field6183.paint(arg0);
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILuv;I[II[I)Lhu;")
    ...
    @OriginalMember(owner = "client!bn", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
