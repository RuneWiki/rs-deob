...
public class class445 extends class223 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZBZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IBII)[B", line = 58)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 70)
    public class445() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IBI)Z", line = 78)
