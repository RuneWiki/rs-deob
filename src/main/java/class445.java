...
public class class445 extends class386 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IILr;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILec;)I", line = 457)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "()V", line = 538)
    public class445() {
        super(1, true);
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)[I", line = 549)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIILr;Ln;)V", line = 587)
    ...
    @OriginalMember(owner = "client!eu", name = "e", descriptor = "(I)V", line = 909)
