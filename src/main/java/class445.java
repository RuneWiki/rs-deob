...
public class class445 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIILd;BLha;)V", line = 17)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII)I", line = 161)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "([I[I[I[[F)V", line = 191)
