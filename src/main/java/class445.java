...
public class class445 extends class13 {
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(I)V", line = 3)
    private class445(int arg0) {
        super(0, false);
        this.method2776(arg0, true);
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!wo", name = "e", descriptor = "(B)V", line = 87)
    public static void method2778(byte arg0) {
        int var1 = 38 % ((arg0 - -46) / 36);
        field6244 = null;
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lkh;BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "()V", line = 126)
    public class445() {
        this(0);
    }
}
