...
public class class445 extends class330 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BI)I", line = 13)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 105)
    public class445() {
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)J", line = 55)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(B)V", line = 92)
