...
public class class445 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ZI)Llu;", line = 33)
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lto;ILla;)V", line = 94)
