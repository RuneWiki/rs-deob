...
public class class445 extends class449 {
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hf", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 42)
