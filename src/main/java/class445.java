...
public class class445 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!oha", name = "finalize", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IZLpaa;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lsb;II)V", line = 70)
