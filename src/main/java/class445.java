...
public class class445 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(III)Llv;", line = 4)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Z)V", line = 28)
