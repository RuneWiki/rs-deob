...
public class class445 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)Lhq;", line = 4)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILjava/lang/String;)I", line = 136)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)V", line = 147)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lmja;ILbt;)V", line = 166)
