...
public class class445 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ldg;IIIIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqg;II)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lnk;B)Lnk;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IB)Lac;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lbh;IZ)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lnk;I)Z")
