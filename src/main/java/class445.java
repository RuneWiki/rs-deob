...
public class class445 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Ljea;I)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lnha;II)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lwba;)V")
