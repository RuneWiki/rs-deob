...
public class class445 extends class227 implements class151 {
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I[BIB)V", line = 13)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lef;I[BIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I)J", line = 63)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Z)I", line = 81)
