...
public class class445 extends class420 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lvc;)Lkr;", line = 7)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
