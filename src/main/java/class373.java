...
public class class373 extends class147 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lve;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILgn;)V", line = 162)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(III)V", line = 484)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 499)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "()V", line = 570)
    public class373() {
    }

    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 572)
    public class373(String arg0) {
        this.field5332 = arg0;
    }

    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)V", line = 581)
