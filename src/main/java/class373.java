...
public class class373 extends class116 {
    ...
    @OriginalMember(owner = "client!rr", name = "i", descriptor = "(IIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!rr", name = "P", descriptor = "(IIIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILpa;II)V", line = 165)
    ...
    @OriginalMember(owner = "client!rr", name = "DA", descriptor = "(IIIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "()I", line = 291)
    public final int method962() {
        field5389++;
        return this.field5393.field1704;
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 299)
    ...
    @OriginalMember(owner = "client!rr", name = "KA", descriptor = "(IIII)V", line = 387)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIIBI)V", line = 402)
    ...
    @OriginalMember(owner = "client!rr", name = "ma", descriptor = "()I", line = 423)
    public final int method960() {
        field5396++;
        return this.field5405 + this.field5404 + this.field5393.field1701;
    }

    @OriginalMember(owner = "client!rr", name = "CA", descriptor = "(FFFFFFIII)V", line = 435)
    ...
    @OriginalMember(owner = "client!rr", name = "BA", descriptor = "(III)V", line = 503)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Ljj;IIII)V", line = 777)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Ljj;II[III)V", line = 787)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BIILid;)Lah;", line = 529)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(II)V", line = 599)
    ...
    @OriginalMember(owner = "client!rr", name = "ra", descriptor = "(IIIIIII)V", line = 633)
    ...
    @OriginalMember(owner = "client!rr", name = "EA", descriptor = "()I", line = 749)
    public final int method955() {
        field5385++;
        return this.field5393.field1704 + this.field5402 + this.field5390;
    }

    @OriginalMember(owner = "client!rr", name = "la", descriptor = "()I", line = 770)
