...
public class class373 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BLjp;)V", line = 49)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILjp;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Ljava/lang/String;", line = 139)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(II)Z", line = 161)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 218)
