...
public class class373 extends class465 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZLvj;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IILhf;)V")
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lno;Lhm;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIBIILdv;Z)V")
