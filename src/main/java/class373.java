...
public class class373 extends class188 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lqfa;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!km", name = "d", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lqfa;IIIIZ[BIZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIBI)V", line = 130)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[BIIZIIIIB)V", line = 142)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lqfa;IIIIZ[FI)V", line = 201)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZZI)V", line = 224)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[IIIIIIIZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lqfa;IIIII)V", line = 293)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lqfa;IIIIZ[IIIZ)V", line = 339)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIIBII)V", line = 317)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(II)V", line = 391)
