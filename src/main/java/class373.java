...
public class class373 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;[II)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;[IIII[I[I)V")
