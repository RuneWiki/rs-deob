...
public class class373 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lkk;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lkk;B)V", line = 92)
