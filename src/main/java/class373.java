...
public class class373 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)Lwu;", line = 7)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 91)
    public class373(class320 arg0, int arg1, class701 arg2) {
        this.field5083 = arg2;
        this.field5083.method3883(32, 0);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)V", line = 110)
