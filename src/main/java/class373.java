...
public abstract class class373 extends class543 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([Lbq;Z)I")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZ)Lrha;")
