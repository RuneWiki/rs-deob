...
public class class373 extends class69 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIII)I", line = 9)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIIILkka;)V", line = 36)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(I[B)V", line = 116)
