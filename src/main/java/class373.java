...
public class class373 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lha;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIILnd;ZII)V", line = 99)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Llk;I)[I", line = 130)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I[BLsb;FFFFIIZIFI)V", line = 164)
