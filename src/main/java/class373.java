...
public class class373 extends class366 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Ler;Lfj;)V", line = 47)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Z)Z", line = 58)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(ZI)V", line = 69)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(III)V", line = 154)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIIBIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(B)V", line = 254)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ILep;I)V", line = 271)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IILpca;)Ljava/lang/String;", line = 327)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ZZ)V", line = 348)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lk;I)[Lica;", line = 365)
