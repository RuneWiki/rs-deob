...
public class class373 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lsi;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILbf;)Z", line = 65)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "()V", line = 108)
    public class373() {
        this.field5471 = -50;
        this.field5473 = -60;
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lsi;)V", line = 128)
