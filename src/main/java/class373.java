...
public class class373 implements class181 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IB)Lgf;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)Lba;")
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(II)Laf;")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Ldp;Ldp;Ldp;)V")
