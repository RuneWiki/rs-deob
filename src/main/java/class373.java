...
public class class373 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lqm;Lr;Z)I", line = 54)
