...
public class class373 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field4902++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIBI[BIII[B)V", line = 29)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)I", line = 99)
