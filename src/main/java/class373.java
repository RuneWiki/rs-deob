...
public class class373 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Llga;II)Lwi;")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Ljc;)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "()Lvfa;")
