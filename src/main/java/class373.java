...
public class class373 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)Lku;", line = 22)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III)Lua;", line = 71)
