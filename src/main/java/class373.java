...
public class class373 extends class386 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!gj", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 12)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILqo;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 96)
    ...
    @OriginalMember(owner = "client!gj", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 107)
    ...
    @OriginalMember(owner = "client!gj", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 119)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field5235;
        return this.field5239 == arg0;
    }

    @OriginalMember(owner = "client!gj", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 127)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field5236;
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILjava/awt/Graphics;IIIB)V", line = 136)
    ...
    @OriginalMember(owner = "client!gj", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 152)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field5241;
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 183)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(B)V", line = 211)
