...
public class class373 extends class37 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IILqa;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ur", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILqa;II)Lc;", line = 160)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(ILqa;)Lfm;", line = 178)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLc;Lqa;)V", line = 247)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 271)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(B)I", line = 282)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(II)I", line = 330)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lqa;Z)V", line = 352)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(B)Z", line = 368)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Z)V", line = 379)
