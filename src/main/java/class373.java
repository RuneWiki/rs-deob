...
public class class373 extends class45 {
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Lwu;Lwu;Luc;)V", line = 3)
    public class373(class376 arg0, class376 arg1, class27 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILee;)V", line = 6)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lrda;[Lcba;I)Lnfa;", line = 54)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "([Lkf;II)V", line = 134)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIZI)V", line = 187)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)Z", line = 201)
