...
public class class373 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lfq;III[Z)Z", line = 9)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(I)V", line = 66)
