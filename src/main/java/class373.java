...
public class class373 implements class556 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)Lvea;")
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lhb;Lvea;Z)V")
