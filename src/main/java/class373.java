...
public class class373 extends class45 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 78)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "()V", line = 100)
    public class373() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)[I", line = 103)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lcu;II)V", line = 165)
    ...
    @OriginalMember(owner = "client!ur", name = "f", descriptor = "(B)V", line = 205)
