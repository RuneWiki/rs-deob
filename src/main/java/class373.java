...
public class class373 extends class129 implements class241 {
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Lhs;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Luu;IIII)Lc;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lc;Liv;Lia;Laq;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lvh;Lvh;FLvh;)Lvh;")
    public final class191 method860(class191 arg0, class191 arg1, float arg2, class191 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Laq;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Liv;Z)V")
    ...
    @OriginalMember(owner = "client!h", name = "z", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lvh;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Lve;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lne;Z)Lf;")
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(I)Ll;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Liv;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lov;[Lne;Z)Loa;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIII)Lvh;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Lve;)V")
