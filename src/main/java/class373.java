...
public class class373 extends InputStream {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIZIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!wc", name = "read", descriptor = "()I", line = 47)
