...
public class class373 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IILya;Z)Ll;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILhp;)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILhp;I)V")
