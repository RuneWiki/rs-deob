...
public class class373 extends class310 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)J", line = 21)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(JI)I", line = 31)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "()V", line = 116)
    public class373() {
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)J", line = 67)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)V", line = 103)
