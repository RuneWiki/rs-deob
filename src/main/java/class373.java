...
public abstract class class373 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILcc;ZLcc;ILcc;Lcc;IIIIIIB[Z)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "([Z[IIILvg;ZIILr;Lvg;IZ)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIIZIIII[ILcc;Lcc;)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lcc;IIIIIIZLcc;)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IILcc;)V")
