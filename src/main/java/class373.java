...
public class class373 extends class261 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lih;Ljq;)V", line = 51)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IZLbl;)V", line = 63)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(III)Lhh;", line = 291)
    ...
    @OriginalMember(owner = "client!wq", name = "d", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZB)V", line = 324)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIILhc;Lhc;)V", line = 361)
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(I)Z", line = 370)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IILkk;)V", line = 381)
    public final void method1024(int arg0, int arg1, class179 arg2) {
        ++field5738;
        int var4 = -81 % ((arg1 - 21) / 36);
    }

    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(B)V", line = 390)
