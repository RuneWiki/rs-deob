...
public class class373 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)Luk;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lig;II)V")
    ...
    @OriginalMember(owner = "client!mv", name = "e", descriptor = "(I)Luk;")
