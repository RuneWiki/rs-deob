...
public class class373 extends class65 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lraa;III)V", line = 16)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIJ)V", line = 32)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "([B)V", line = 76)
