...
public class class373 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(JB)Lvl;", line = 3)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IJ)V", line = 49)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(JLvl;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(I)V", line = 140)
