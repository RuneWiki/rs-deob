...
public class class373 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BI)Lwda;", line = 42)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)V", line = 110)
    public static final void method2351(int arg0) {
        class702.field9857 = arg0;
    }

    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lgt;Ld;)V", line = 128)
