...
public class class373 extends class40 {
    ...
    @OriginalMember(owner = "client!eb", name = "h", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "()V", line = 31)
    public class373() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(II)I", line = 43)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!eb", name = "g", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;)V", line = 98)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BI)[I", line = 130)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(Z)V", line = 350)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILlf;)V", line = 361)
