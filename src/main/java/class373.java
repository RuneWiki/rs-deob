...
public abstract class class373 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BLkm;Lbc;)V", line = 29)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lpf;BI)V", line = 260)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)V", line = 280)
