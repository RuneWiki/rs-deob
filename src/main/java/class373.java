...
public class class373 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BI)Lmg;", line = 6)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BILjava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIBII)V", line = 54)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Liaa;I)Lcc;", line = 107)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(III)Z", line = 181)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(II)V", line = 210)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Ljda;ILjo;Ljo;)V", line = 250)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 230)
