...
public class class704 {
    ...
    @OriginalMember(owner = "client!fb", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field9865++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 78)
