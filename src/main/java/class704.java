...
public class class704 extends class72 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)Lnd;", line = 3)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(II)I", line = 78)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(ILcq;)V", line = 89)
    public class704(int arg0, class464 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lcq;)V", line = 98)
    public class704(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(II)V", line = 101)
