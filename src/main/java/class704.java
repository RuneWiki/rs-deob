...
public class class704 extends class196 {
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(ILdp;Lfv;III)V")
    public class704(int arg0, class3 arg1, class120 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field9801 = arg5;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)Lg;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IFFF)F")
