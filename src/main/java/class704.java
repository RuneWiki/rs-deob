...
public class class704 extends class264 {
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(ILmfa;)V", line = 30)
    public class704(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I[BIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IIIIIIIIIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)I", line = 149)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BI)I", line = 160)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(BI)V", line = 176)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lmfa;)V", line = 187)
    public class704(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(B)I", line = 190)
