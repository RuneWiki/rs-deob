...
public class class704 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(JZLha;)V", line = 27)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 61)
