...
public class class704 extends class529 {
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBLtn;)V", line = 14)
    ...
    @OriginalMember(owner = "client!nv", name = "f", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLtn;)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "()V", line = 236)
    public class704() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IB)[I", line = 131)
    ...
    @OriginalMember(owner = "client!nv", name = "e", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(II)I", line = 225)
