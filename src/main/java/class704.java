...
public class class704 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 12)
    public class704(Throwable arg0, String arg1) {
        this.field9800 = arg0;
        this.field9797 = arg1;
    }

    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ILgf;I)V", line = 33)
