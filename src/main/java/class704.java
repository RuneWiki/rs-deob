...
public class class704 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lla;ILla;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLfj;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([Laga;Lmd;Lha;Lhs;Lsp;IILgm;Lhs;Lfj;IZLsn;[IIILsda;IIII)Lka;", line = 86)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILha;BLgm;Lfj;Lsn;Lsda;ILhs;Lmd;II)Lka;", line = 656)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 867)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BZ[II[II[Lrja;)V", line = 991)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIILsn;ILha;IILsda;Lhs;II)Lka;", line = 1013)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)V", line = 1167)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IILsn;I)V", line = 1178)
