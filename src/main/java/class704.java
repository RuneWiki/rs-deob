...
public class class704 extends class504 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "()V", line = 16)
    public class704() {
    }

    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(I)V", line = 23)
