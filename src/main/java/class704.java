...
public class class704 extends class396 {
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!ee", name = "e", descriptor = "(III)Lcja;", line = 47)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(IIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILso;)Lht;", line = 95)
