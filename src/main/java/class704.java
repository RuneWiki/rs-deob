...
public class class704 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "()I", line = 5)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "()[F", line = 13)
    public final float[] method3970() {
        return this.field9906[this.method3969()];
    }

    @OriginalMember(owner = "client!eca", name = "c", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(II)I", line = 156)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "()V", line = 165)
    public class704() {
