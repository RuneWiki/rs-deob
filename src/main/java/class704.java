...
public class class704 extends class281 {
    ...
    @OriginalMember(owner = "client!ed", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!ed", name = "YA", descriptor = "()V", line = 113)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BIILuc;)V", line = 692)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)V", line = 754)
    public final void method1150(int arg0, int arg1) {
        ++field9496;
    }

    @OriginalMember(owner = "client!ed", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 761)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lqo;IIII[[I[[II)V", line = 778)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 838)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)Z", line = 857)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III[[ZZI)V", line = 869)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 877)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIII[[Z)V", line = 897)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lga;)V", line = 1068)
    ...
    @OriginalMember(owner = "client!ed", name = "fa", descriptor = "(IILr;)Lr;", line = 1074)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lcea;B)V", line = 1104)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III[[ZZII)V", line = 1150)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lab;[I)V", line = 1160)
    ...
    @OriginalMember(owner = "client!ed", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1171)
    ...
    @OriginalMember(owner = "client!ed", name = "ka", descriptor = "(III)V", line = 1258)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIZIII[[ZI)V", line = 1274)
