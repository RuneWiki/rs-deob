...
public class class704 {
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lbaa;I)Lg;", line = 246)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lbt;Lbt;)V", line = 303)
    public class704(class48 arg0, class48 arg1) {
        this.field9909 = arg0;
        this.field9912 = arg1;
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)Lqia;", line = 315)
