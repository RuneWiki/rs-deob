...
public abstract class class704 extends class4 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(Lcea;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(Lcr;I)V", line = 56)
