...
public class class704 extends class401 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lsea;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(II)V", line = 42)
    public class704(int arg0, int arg1) {
        this.field9956 = arg1;
        this.field9957 = arg0;
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 56)
