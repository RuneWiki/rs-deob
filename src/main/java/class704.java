...
public class class704 extends class270 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 18)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!jba", name = "v", descriptor = "(IILha;)Lha;", line = 48)
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(Lqq;IIII[[I[[II)V", line = 213)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lio;Z)Lnj;", line = 284)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(II)V", line = 295)
    public final void method1364(int arg0, int arg1) {
        ++field9899;
    }

    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILdi;II)V", line = 302)
    ...
    @OriginalMember(owner = "client!jba", name = "O", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 369)
    ...
    @OriginalMember(owner = "client!jba", name = "E", descriptor = "(Lha;IIIIZ)V", line = 436)
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(I)Z", line = 454)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(III[[ZZI)V", line = 496)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IIBI[[ZIZ)V", line = 504)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lqea;[I)V", line = 646)
    ...
    @OriginalMember(owner = "client!jba", name = "DA", descriptor = "(Lha;IIIIZ)V", line = 655)
    ...
    @OriginalMember(owner = "client!jba", name = "BA", descriptor = "()V", line = 672)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(III[[ZZ)V", line = 1274)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(II)[B", line = 1291)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1353)
