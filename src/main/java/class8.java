...
public class class8 extends class28 {
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 27)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 49)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "()I", line = 88)
    public final int method43() {
        return this.field65 - (this.field67.available() >> (class325.field4696 ? 2 : 1));
    }

    @OriginalMember(owner = "client!to", name = "c", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "()V", line = 138)
