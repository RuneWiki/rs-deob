...
public class class8 {
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ag", name = "i", descriptor = "Llf;")
    public static class109 field117 = class35.method275("Verbinde mit Server)3)3)3", 2);

    @OriginalMember(owner = "client!ag", name = "j", descriptor = "Llf;")
    public static class109 field118 = class35.method275("headicons_hint", 2);

    @OriginalMember(owner = "client!ag", name = "c", descriptor = "Lrc;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILvg;)Llf;")
