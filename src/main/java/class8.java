...
public class class8 extends class396 {
    ...
    @OriginalMember(owner = "client!ma", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IILbk;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lbk;B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(III)I", line = 96)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 117)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILjf;Z)I", line = 261)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 280)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IZII)I", line = 300)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IZLra;III)V", line = 341)
