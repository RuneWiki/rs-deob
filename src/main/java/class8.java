...
public class class8 {
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    public class8(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method30(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;I)V")
