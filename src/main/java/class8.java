...
public class class8 extends class601 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(ILqea;)V", line = 23)
    public class8(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IJI)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ZIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)I", line = 294)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)V", line = 305)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(I)Z", line = 321)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(II)V", line = 336)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lqea;)V", line = 346)
    public class8(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ZII)Z", line = 354)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)I", line = 365)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(B)V", line = 377)
