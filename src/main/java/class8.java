...
@OriginalClass("client!CXFTMSCH")
public class class8 {

    @OriginalMember(owner = "client!CXFTMSCH", name = "b", descriptor = "I")
    private int field614 = 1;

    @OriginalMember(owner = "client!CXFTMSCH", name = "a", descriptor = "I")
    private int field613;

    @OriginalMember(owner = "client!CXFTMSCH", name = "d", descriptor = "I")
    public int field616;

    @OriginalMember(owner = "client!CXFTMSCH", name = "i", descriptor = "Z")
    private boolean field621;

    @OriginalMember(owner = "client!CXFTMSCH", name = "c", descriptor = "[B")
    public byte[] field615;

    @OriginalMember(owner = "client!CXFTMSCH", name = "e", descriptor = "[I")
    public int[] field617;

    @OriginalMember(owner = "client!CXFTMSCH", name = "f", descriptor = "[I")
    public int[] field618;

    @OriginalMember(owner = "client!CXFTMSCH", name = "g", descriptor = "[I")
    public int[] field619;

    @OriginalMember(owner = "client!CXFTMSCH", name = "h", descriptor = "[I")
    public int[] field620;

    @OriginalMember(owner = "client!CXFTMSCH", name = "<init>", descriptor = "([BI)V")
    ...
    @OriginalMember(owner = "client!CXFTMSCH", name = "a", descriptor = "(B[B)V")
    ...
    @OriginalMember(owner = "client!CXFTMSCH", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
