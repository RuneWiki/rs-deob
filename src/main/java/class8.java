...
public class class8 extends class502 {
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lcn;[Lbq;)V", line = 49)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)I", line = 119)
    public final int method57(int arg0, int arg1) {
        ++field158;
        return arg1 != 0 ? 115 : 1;
    }

    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(ILeka;)V", line = 131)
    public class8(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Leka;)V", line = 134)
    public class8(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)V", line = 137)
