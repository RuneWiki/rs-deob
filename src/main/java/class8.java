...
public class class8 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BILr;I)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIILr;)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lr;IIB)Z")
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lpj;Lvha;)V")
