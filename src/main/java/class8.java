...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IB)[I", line = 57)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 133)
