...
public class class8 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BZ[B)Ljava/lang/Object;", line = 18)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIILr;III)V", line = 52)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILwv;ILjava/awt/Component;I)Lpda;", line = 373)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(FBIFF)F", line = 459)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BZI)V", line = 473)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BI[II[Ljava/lang/Object;)V", line = 554)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)V", line = 619)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "()V", line = 731)
    protected class8() {
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lr;Lek;I)V", line = 742)
