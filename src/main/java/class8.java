...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lcb;Z)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)Lcu;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILrd;Lcb;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lcb;B)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILcb;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILcb;Z)V")
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lcb;)V")
