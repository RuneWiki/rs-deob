...
public class class8 extends class40 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Ljava/awt/Canvas;Lbk;II)Lvq;", line = 3)
    ...
    @OriginalMember(owner = "client!ma", name = "g", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ma", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "()V", line = 276)
    public class8() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IILlf;)V", line = 106)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BI)[I", line = 151)
    ...
    @OriginalMember(owner = "client!ma", name = "e", descriptor = "(I)V", line = 279)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 292)
