...
public class class8 extends class424 {
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 4)
    public class8() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(IB)[I", line = 11)
    ...
    @OriginalMember(owner = "client!kp", name = "g", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!kp", name = "h", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lrg;BI)V", line = 103)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ljq;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lij;Lea;B)V", line = 195)
