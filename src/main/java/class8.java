...
public class class8 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BLjava/lang/Object;Lwd;)V", line = 6)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B[[[Lgk;)V", line = 55)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 131)
    public class8() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IB)V", line = 134)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "([BILnj;)V", line = 147)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 171)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(III)V", line = 182)
    private class8(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)V", line = 203)
