...
public class class8 extends class441 {
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIII[I)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIIII)V")
    public class8(class469 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lag;IIII)V")
