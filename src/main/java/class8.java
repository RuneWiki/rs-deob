...
public class class8 extends class451 implements class381 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIBLwm;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lwm;Lct;IIIIIZIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!to", name = "j", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIZIIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILwm;I)Lgn;", line = 195)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lwm;I)V", line = 214)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lwm;B)Lnf;", line = 226)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Z)V", line = 264)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLwm;)V", line = 285)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lwm;B)V", line = 298)
