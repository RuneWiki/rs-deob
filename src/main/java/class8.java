...
@OriginalClass("client!CWPTWZXW")
public class class8 implements Runnable {

    @OriginalMember(owner = "client!CWPTWZXW", name = "a", descriptor = "Z")
    private boolean field635 = true;

    @OriginalMember(owner = "client!CWPTWZXW", name = "e", descriptor = "Z")
    private boolean field639 = false;

    @OriginalMember(owner = "client!CWPTWZXW", name = "j", descriptor = "Z")
    private boolean field644 = false;

    @OriginalMember(owner = "client!CWPTWZXW", name = "k", descriptor = "Z")
    private boolean field645 = false;

    @OriginalMember(owner = "client!CWPTWZXW", name = "f", descriptor = "LIVVPRVRY;")
    public class33 field640;

    @OriginalMember(owner = "client!CWPTWZXW", name = "d", descriptor = "Ljava/net/Socket;")
    private Socket field638;

    @OriginalMember(owner = "client!CWPTWZXW", name = "b", descriptor = "Ljava/io/InputStream;")
    private InputStream field636;

    @OriginalMember(owner = "client!CWPTWZXW", name = "c", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field637;

    @OriginalMember(owner = "client!CWPTWZXW", name = "h", descriptor = "I")
    private int field642;

    @OriginalMember(owner = "client!CWPTWZXW", name = "i", descriptor = "I")
    private int field643;

    @OriginalMember(owner = "client!CWPTWZXW", name = "g", descriptor = "[B")
    private byte[] field641;

    @OriginalMember(owner = "client!CWPTWZXW", name = "<init>", descriptor = "(LIVVPRVRY;Ljava/net/Socket;I)V")
    ...
    @OriginalMember(owner = "client!CWPTWZXW", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!CWPTWZXW", name = "b", descriptor = "()I")
    public int method230() throws IOException {
        return this.field639 ? 0 : this.field636.read();
    }

    @OriginalMember(owner = "client!CWPTWZXW", name = "c", descriptor = "()I")
    public int method231() throws IOException {
        return this.field639 ? 0 : this.field636.available();
    }

    @OriginalMember(owner = "client!CWPTWZXW", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!CWPTWZXW", name = "a", descriptor = "(I[BII)V")
    ...
    @OriginalMember(owner = "client!CWPTWZXW", name = "run", descriptor = "()V")
    public void run() {
        while (this.field644) {
            int var2;
            int var3;
    ...
    @OriginalMember(owner = "client!CWPTWZXW", name = "a", descriptor = "(I)V")
