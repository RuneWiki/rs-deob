...
public class class8 extends class180 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 251)
    ...
    @OriginalMember(owner = "client!tr", name = "c", descriptor = "(I)V", line = 350)
    ...
    @OriginalMember(owner = "client!tr", name = "c", descriptor = "(B)V", line = 367)
