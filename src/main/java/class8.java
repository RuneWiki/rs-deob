...
public class class8 extends class175 {
    ...
    @OriginalMember(owner = "client!to", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IILjja;III)V", line = 20)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "()V", line = 493)
    public class8() {
        super(0, true);
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILdt;Z)V", line = 295)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)I", line = 340)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 359)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZI)[I", line = 372)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(B)V", line = 496)
