...
public class class8 extends class179 {
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "()V", line = 3)
    public static void method51() {
        field101 = null;
    }

    @OriginalMember(owner = "client!to", name = "c", descriptor = "()V", line = 6)
    public final void method52() {
        field101.method2935(this.field102, 27521);
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 9)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "()V", line = 18)
    public final void method55() {
        field101.method2933(this.field102, (byte) -77);
    }

    @OriginalMember(owner = "client!to", name = "b", descriptor = "()I", line = 22)
    public final int method56() {
        return field101.method2934((byte) 2, this.field102);
    }

    @OriginalMember(owner = "client!to", name = "d", descriptor = "()V", line = 25)
    public final void method57() {
        field101.method2931(this.field102, super.field2328);
    }

    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lfq;I)V", line = 28)
