...
public class class8 extends class605 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILip;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(ZB)V", line = 16)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZB)V", line = 77)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IZI)V", line = 89)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)Z", line = 161)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIILft;)Ljava/awt/Frame;", line = 175)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lok;Lsda;)V", line = 262)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZI)V", line = 310)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)V", line = 357)
