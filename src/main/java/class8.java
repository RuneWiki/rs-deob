...
public class class8 extends class494 {
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(Lha;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 76)
    ...
    @OriginalMember(owner = "client!to", name = "finalize", descriptor = "()V", line = 87)
    ...
    @OriginalMember(owner = "client!to", name = "j", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(IIIIIIIIIIIIIZI)V", line = 432)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lbca;Lka;Lha;I)V", line = 139)
    ...
    @OriginalMember(owner = "client!to", name = "i", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(Z)I", line = 176)
    public final int method38(boolean arg0) {
        ++field70;
        return !arg0 ? 99 : this.field108;
    }

    @OriginalMember(owner = "client!to", name = "f", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lha;I)Lhw;", line = 293)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(ILha;)Ljda;", line = 304)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lha;III)Z", line = 346)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BI)V", line = 357)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Z)V", line = 417)
    ...
    @OriginalMember(owner = "client!to", name = "g", descriptor = "(I)Z", line = 458)
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "(B)V", line = 471)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILha;B)Lka;", line = 483)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BILjava/lang/String;Ljava/lang/String;IILjava/lang/String;)V", line = 530)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(B)Z", line = 562)
