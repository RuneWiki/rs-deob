...
public abstract class class8 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)Lja;", line = 132)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(B)Z", line = 159)
