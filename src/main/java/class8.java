...
public class class8 extends class585 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BII)I", line = 15)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lso;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(II)[I", line = 69)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIZI)V", line = 119)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "()V", line = 343)
    public class8() {
        super(3, false);
    }

    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZI)[[I", line = 356)
