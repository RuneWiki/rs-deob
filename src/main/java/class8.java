...
public class class8 extends class516 implements class392 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lha;Lwea;ZIIII)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IILgga;II)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lha;B)Lel;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILhj;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIIIILha;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILha;)Ldfa;")
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lha;I)V")
