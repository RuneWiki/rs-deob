...
public class class8 extends class332 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lbg;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B[Lej;)Lqf;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILaa;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lpw;I)I")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIBLpw;)V")
    ...
    @OriginalMember(owner = "client!to", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Lfa;Lri;Ljava/lang/Integer;)Lr;")
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(ZI)Lbo;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IZIILos;[BII)Lmca;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lko;ZII)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILos;I[BII)Lqw;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ldd;Ldd;FLdd;)Ldd;")
    public final class654 method119(class654 arg0, class654 arg1, float arg2, class654 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lpw;ILbo;IIII)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IILmg;ILos;)Lmca;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZLqaa;)I")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I[FIIIILos;Z)Lmca;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILqf;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lgda;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILjagdx/IDirect3D;ZIILjagdx/D3DPRESENT_PARAMETERS;)Z")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "([IIZIIII)Lmca;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ldca;B)I")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lko;B)I")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lf;Z)V")
    ...
    @OriginalMember(owner = "client!to", name = "m", descriptor = "()Lfe;")
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(II)Lia;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZLqs;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lmg;Los;I)Z")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLmg;Los;)I")
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/pi;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lgm;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Lfa;Lri;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZZ[[II)Lpfa;")
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(ZI)Log;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Log;II)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLcf;)I")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lko;IZZB)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Los;Lmg;B)Z")
