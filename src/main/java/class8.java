...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)Lww;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILud;)V")
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)Lww;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lud;BI)V")
