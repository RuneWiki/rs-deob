...
public class class8 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)Lvg;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BLvr;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)Lvg;")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lvr;)V")
