...
public class class8 extends class233 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BILae;)Lbk;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lae;ILbk;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ZBIILna;ILae;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "d", descriptor = "(II)Lgf;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IZ)Lci;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lae;B)V")
