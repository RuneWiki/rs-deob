...
public class class8 extends class345 {
    ...
    @OriginalMember(owner = "client!ma", name = "d", descriptor = "(IIIIII)Lqe;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(II[I[I)Lep;")
    public final class241 method61(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class288(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lbr;IIII)Lmj;")
    ...
    @OriginalMember(owner = "client!ma", name = "f", descriptor = "(I)Lip;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lmj;Lmr;Lic;Lvf;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lk;[Llg;Z)Lai;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lip;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "([Lmj;Lic;[Lvf;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lqe;Lqe;FLqe;)Lqe;")
    public final class275 method82(class275 arg0, class275 arg1, float arg2, class275 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lmr;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "x", descriptor = "()Lic;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILep;II)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(II[[I[[IIII)Lij;")
    ...
    @OriginalMember(owner = "client!ma", name = "A", descriptor = "()Lic;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Ljava/lang/Runnable;)Lsp;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Llg;Z)Lsg;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(I[Lbh;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIIIZ)Lsg;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lua;III)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lic;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "([IIIII)Lsg;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lqe;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIIIIILep;II)V")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lja;I)V")
