...
public class class8 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)Z", line = 25)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lgp;B)V", line = 93)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(B)Lgp;", line = 144)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "()V", line = 250)
    public class8() {
        this.field118.field5193 = this.field118;
        this.field118.field5194 = this.field118;
    }

    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(B)Lgp;", line = 168)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)Lgp;", line = 189)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)Ljr;", line = 210)
    ...
    @OriginalMember(owner = "client!fi", name = "e", descriptor = "(I)Lgp;", line = 259)
