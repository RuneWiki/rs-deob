...
public class class8 extends class30 {
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BILac;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lqh;I)V")
