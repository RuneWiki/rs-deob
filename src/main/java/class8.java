...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IZI)B", line = 4)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(III)Z", line = 25)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BZIIIFIII)[[I", line = 53)
