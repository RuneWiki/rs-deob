...
public class class8 extends class232 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILwq;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILjava/util/Random;[[IIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "()V", line = 610)
    public class8() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ZIJI)Ljava/lang/String;", line = 313)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IB)[I", line = 357)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 614)
