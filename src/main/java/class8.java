...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IJIIIILjava/lang/String;IZLjava/lang/String;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IB)I", line = 30)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "([I)V", line = 134)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 172)
