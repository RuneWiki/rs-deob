...
public class class8 extends class265 implements Runnable {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLvo;)V", line = 28)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lae;)V", line = 89)
    public class8(class29 arg0) {
        this.field80 = arg0;
    }

    @OriginalMember(owner = "client!qk", name = "run", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)Lce;", line = 99)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 110)
