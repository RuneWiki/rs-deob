...
public class class8 extends class260 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IBI)V", line = 37)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZII)V", line = 58)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(IIIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIB)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(I)V", line = 100)
