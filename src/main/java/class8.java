...
public class class8 extends class270 implements class597 {
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)J", line = 50)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)C", line = 75)
