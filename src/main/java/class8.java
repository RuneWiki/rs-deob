...
public class class8 extends class73 {
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lsn;Ljava/lang/Object;I)V", line = 60)
