...
public class class8 extends class592 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZB)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZII)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILgq;)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lji;)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lhga;")
