...
public abstract class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILht;Ljava/lang/String;I)Lmc;", line = 19)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lem;I)V", line = 55)
