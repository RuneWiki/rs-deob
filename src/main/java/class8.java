...
public class class8 extends class256 {
    ...
    @OriginalMember(owner = "client!eb", name = "ca", descriptor = "()I", line = 3)
    public final int method43() {
        field236++;
        return this.field241 + this.field222 + this.field239;
    }

    @OriginalMember(owner = "client!eb", name = "da", descriptor = "(IIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILps;)V", line = 35)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!eb", name = "E", descriptor = "()I", line = 109)
    public final int method48() {
        field238++;
        return this.field232;
    }

    @OriginalMember(owner = "client!eb", name = "V", descriptor = "(IIIII)V", line = 120)
    ...
    @OriginalMember(owner = "client!eb", name = "A", descriptor = "()I", line = 154)
    public final int method50() {
        field229++;
        return this.field237 + this.field232 + this.field245;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILua;II)V", line = 162)
    ...
    @OriginalMember(owner = "client!eb", name = "YA", descriptor = "(IIIIIIII)V", line = 209)
    ...
    @OriginalMember(owner = "client!eb", name = "DA", descriptor = "(IIIIIII)V", line = 248)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 458)
    ...
    @OriginalMember(owner = "client!eb", name = "xa", descriptor = "(III)V", line = 469)
    public final void method55(int arg0, int arg1, int arg2) {
        field233++;
    }

    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lum;IIZ)V", line = 655)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lum;II[III)V", line = 670)
    ...
    @OriginalMember(owner = "client!eb", name = "u", descriptor = "()I", line = 482)
    public final int method56() {
        field234++;
        return this.field222;
    }

    @OriginalMember(owner = "client!eb", name = "qa", descriptor = "(FFFFFFIIII)V", line = 497)
    ...
    @OriginalMember(owner = "client!eb", name = "Q", descriptor = "(IIII)V", line = 574)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIII[III)V", line = 586)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(FFFFFFILua;II)V", line = 596)
