...
public class class8 {
    ...
    @OriginalMember(owner = "client!bc", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(CB)Z", line = 31)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(II)V", line = 103)
    public class8(int arg0, int arg1) {
        this.field60 = arg0;
    }

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BI)V", line = 117)
