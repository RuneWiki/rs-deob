...
public class class8 {
    ...
    @OriginalMember(owner = "client!BVBAURNI", name = "b", descriptor = "[LICYTWAKR;")
    ...
    @OriginalMember(owner = "client!BVBAURNI", name = "a", descriptor = "(J)LICYTWAKR;")
    ...
    @OriginalMember(owner = "client!BVBAURNI", name = "a", descriptor = "(LICYTWAKR;JZ)V")
