...
public class class8 extends class164 {
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lfp;Lfp;Loq;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZIBI)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIZB)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIZ)V")
