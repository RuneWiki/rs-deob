...
public class class8 {
    ...
    @OriginalMember(owner = "client!DFGNFGZH", name = "c", descriptor = "LBIWBGZXL;")
    ...
    @OriginalMember(owner = "client!DFGNFGZH", name = "a", descriptor = "[LDFGNFGZH;")
    ...
    @OriginalMember(owner = "client!DFGNFGZH", name = "c", descriptor = "(I)LDFGNFGZH;")
