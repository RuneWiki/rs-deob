...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)I", line = 19)
    public final int method45(int arg0) {
        field84++;
        return arg0 == 15937 ? this.field95 : -20;
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lhh;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IILjava/lang/Object;Lhh;)V", line = 81)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lhh;I)Ljava/lang/Object;", line = 108)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILhh;Ljava/lang/Object;)V", line = 164)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)V", line = 176)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILni;)V", line = 256)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(I)V", line = 287)
