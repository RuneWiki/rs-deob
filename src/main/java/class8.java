...
public class class8 implements class532 {
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(B)Lkn;", line = 6)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 34)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZI)V", line = 78)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(B)I", line = 115)
    public final int method51(byte arg0) {
        return arg0 == -105 ? this.field84 : -3;
    }

    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lki;Lkn;Z)V", line = 129)
