...
@OriginalClass("client!CAXQGHNZ")
public class class8 extends class64 {

    @OriginalMember(owner = "client!CAXQGHNZ", name = "t", descriptor = "I")
    private int field152 = -712;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "v", descriptor = "I")
    private int field154;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "w", descriptor = "I")
    private int field155;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "x", descriptor = "I")
    private int field156;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "n", descriptor = "I")
    private int field146;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "o", descriptor = "I")
    private int field147;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "p", descriptor = "I")
    private int field148;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "q", descriptor = "I")
    private int field149;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "z", descriptor = "LCGWBYVFN;")
    private class9 field158;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "u", descriptor = "I")
    private int field153;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "y", descriptor = "I")
    private int field157;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "l", descriptor = "I")
    public int field144;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "m", descriptor = "I")
    public int field145;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "r", descriptor = "[I")
    public int[] field150;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "s", descriptor = "Lclient;")
    public static client field151;

    @OriginalMember(owner = "client!CAXQGHNZ", name = "a", descriptor = "(Z)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!CAXQGHNZ", name = "<init>", descriptor = "(IIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!CAXQGHNZ", name = "a", descriptor = "(I)LSHDUUMNW;")
