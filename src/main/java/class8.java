...
public class class8 extends class512 {
    ...
    @OriginalMember(owner = "client!vda", name = "g", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lpga;)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IILlo;)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILpaa;)V")
