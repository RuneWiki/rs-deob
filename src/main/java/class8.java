...
public class class8 extends class656 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILjava/lang/String;CLjava/lang/String;)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(Z)V", line = 77)
