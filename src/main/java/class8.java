...
public abstract class class8 extends class28 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIBII)V", line = 58)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIIIILsl;ZIIII)Z", line = 98)
