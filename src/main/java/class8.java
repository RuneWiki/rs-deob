...
public class class8 extends class114 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Llf;Ljk;)Lrs;", line = 4)
    public final class730 method53(class567 arg0, class788 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!lj", name = "Q", descriptor = "(I)F", line = 11)
    public final float method54(int arg0) {
        return arg0 == -457 ? -0.5F : -0.833212F;
    }

    @OriginalMember(owner = "client!lj", name = "q", descriptor = "(B)V", line = 22)
    public final void method55(byte arg0) {
        int var2 = 11 % ((-arg0 - 53) / 59);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lcr;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(FFF)V", line = 51)
    public final void method57(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIILjagdx/D3DPRESENT_PARAMETERS;ILjagdx/IDirect3D;)Z", line = 57)
    ...
    @OriginalMember(owner = "client!lj", name = "B", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!lj", name = "I", descriptor = "()I", line = 194)
    public final int method60() {
        return 0;
    }

    @OriginalMember(owner = "client!lj", name = "g", descriptor = "(II)Lsba;", line = 201)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(IZ)V", line = 245)
    public final void method62(int arg0, boolean arg1) {
        this.field100.method4177(161, arg1);
        int var3 = 13 % ((26 - arg0) / 61);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IBLnea;Ldr;I)Llba;", line = 255)
    ...
    @OriginalMember(owner = "client!lj", name = "R", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lrha;I)I", line = 287)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;I)V", line = 307)
    ...
    @OriginalMember(owner = "client!lj", name = "j", descriptor = "(Z)V", line = 319)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLnea;Ldr;)Z", line = 338)
    ...
    @OriginalMember(owner = "client!lj", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lgga;Ljava/lang/Integer;)Lha;", line = 349)
    ...
    @OriginalMember(owner = "client!lj", name = "h", descriptor = "(B)V", line = 450)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BILwba;)V", line = 461)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;Z)V", line = 472)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLvt;)I", line = 481)
    ...
    @OriginalMember(owner = "client!lj", name = "g", descriptor = "(I)V", line = 510)
    public final synchronized void method74(int arg0) {
        this.field112.method2238(-9377);
        super.method74(arg0);
    }

    @OriginalMember(owner = "client!lj", name = "F", descriptor = "(II)V", line = 518)
    public final void method75(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(II)Llf;", line = 521)
    public final class567 method76(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(Z)V", line = 528)
    ...
    @OriginalMember(owner = "client!lj", name = "ab", descriptor = "(I)V", line = 539)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(IIIID)V", line = 574)
    public final void method79(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!lj", name = "o", descriptor = "(B)V", line = 579)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z[[IIZ)Lwf;", line = 592)
    ...
    @OriginalMember(owner = "client!lj", name = "na", descriptor = "(IIII)[I", line = 603)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "()Z", line = 643)
    public final boolean method83() {
        return false;
    }

    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/mk;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lqm;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lgga;I)V", line = 650)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(IZ)Lvv;", line = 698)
    ...
    @OriginalMember(owner = "client!lj", name = "H", descriptor = "(I)V", line = 709)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 720)
    public final void method86(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class684 {
        this.method109(arg2, arg3);
    }

    @OriginalMember(owner = "client!lj", name = "t", descriptor = "()V", line = 726)
    public final void method87() {
    }

    @OriginalMember(owner = "client!lj", name = "e", descriptor = "(II)Ljk;", line = 730)
    public final class788 method88(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lija;I)V", line = 737)
    ...
    @OriginalMember(owner = "client!lj", name = "t", descriptor = "(I)V", line = 751)
    ...
    @OriginalMember(owner = "client!lj", name = "ya", descriptor = "()V", line = 761)
    public final void method91() {
        this.method960(true, 0);
        this.field100.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lnea;Ldr;I)Z", line = 769)
    ...
    @OriginalMember(owner = "client!lj", name = "w", descriptor = "(I)V", line = 782)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lvr;Lvr;FLvr;)Lvr;", line = 793)
    public final class458 method94(class458 arg0, class458 arg1, float arg2, class458 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILgca;)I", line = 801)
    ...
    @OriginalMember(owner = "client!lj", name = "hb", descriptor = "(I)V", line = 828)
    ...
    @OriginalMember(owner = "client!lj", name = "GA", descriptor = "(I)V", line = 838)
    public final void method97(int arg0) {
        this.field100.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lup;B)V", line = 846)
    ...
    @OriginalMember(owner = "client!lj", name = "h", descriptor = "()Z", line = 868)
    public final boolean method99() {
        return false;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lnea;Ldr;B)I", line = 875)
    ...
    @OriginalMember(owner = "client!lj", name = "p", descriptor = "(I)V", line = 915)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(IB)V", line = 933)
    ...
    @OriginalMember(owner = "client!lj", name = "cb", descriptor = "(I)V", line = 943)
    ...
    @OriginalMember(owner = "client!lj", name = "y", descriptor = "(I)V", line = 954)
    ...
    @OriginalMember(owner = "client!lj", name = "n", descriptor = "(I)V", line = 966)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(B)V", line = 978)
    ...
    @OriginalMember(owner = "client!lj", name = "n", descriptor = "(B)V", line = 1000)
    ...
    @OriginalMember(owner = "client!lj", name = "f", descriptor = "()Lev;", line = 1039)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)V", line = 1047)
    ...
    @OriginalMember(owner = "client!lj", name = "t", descriptor = "(B)Z", line = 1074)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(B)V", line = 1112)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILnea;I[BI)Loq;", line = 1122)
    ...
    @OriginalMember(owner = "client!lj", name = "A", descriptor = "(I)V", line = 1132)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lnr;I)V", line = 1142)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "()V", line = 1187)
    public final void method115() {
    }

    @OriginalMember(owner = "client!lj", name = "P", descriptor = "(I)V", line = 1191)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILcw;)V", line = 1219)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILnea;[FIZIB)Llba;", line = 1241)
    ...
    @OriginalMember(owner = "client!lj", name = "p", descriptor = "()V", line = 1252)
    public final void method119() {
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lrs;)V", line = 1257)
    public final void method120(class730 arg0) {
    }

    @OriginalMember(owner = "client!lj", name = "k", descriptor = "()V", line = 1261)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZLrl;)I", line = 1284)
    ...
    @OriginalMember(owner = "client!lj", name = "e", descriptor = "(Z)V", line = 1318)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILrl;II)V", line = 1358)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([IIIIIIZ)Llba;", line = 1370)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I[Lpfa;)Lija;", line = 1382)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIII)V", line = 1391)
    public final void method127(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLjagdx/IDirect3DPixelShader;)V", line = 1394)
    ...
    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(B)V", line = 1407)
    ...
    @OriginalMember(owner = "client!lj", name = "E", descriptor = "(I)V", line = 1438)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/awt/Canvas;B)Ljava/lang/Object;", line = 1450)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 1460)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IZLgca;B)V", line = 1474)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 1517)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZI)Lwba;", line = 1542)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIZ[BIILnea;I)Llba;", line = 1552)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)V", line = 1561)
    public final void method137(boolean arg0) {
    }

    @OriginalMember(owner = "client!lj", name = "A", descriptor = "()V", line = 1566)
    public final void method138() {
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IZZLgca;I)V", line = 1581)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILvv;Lrl;III)V", line = 1615)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(ILsaa;)I", line = 1631)
    ...
    @OriginalMember(owner = "client!lj", name = "s", descriptor = "()V", line = 1668)
    public final void method142() {
        this.field112.method2239(-3147);
        super.method142();
    }

    @OriginalMember(owner = "client!lj", name = "i", descriptor = "(Z)V", line = 1680)
    ...
    @OriginalMember(owner = "client!lj", name = "N", descriptor = "(I)V", line = 1690)
