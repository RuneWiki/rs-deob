...
@OriginalClass("client!DQPGJUSB")
public class class8 {

    @OriginalMember(owner = "client!DQPGJUSB", name = "f", descriptor = "I")
    public int field606 = 65000;

    @OriginalMember(owner = "client!DQPGJUSB", name = "e", descriptor = "I")
    public int field605;

    @OriginalMember(owner = "client!DQPGJUSB", name = "c", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field603;

    @OriginalMember(owner = "client!DQPGJUSB", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field604;

    @OriginalMember(owner = "client!DQPGJUSB", name = "b", descriptor = "[B")
    public static byte[] field602 = new byte[520];

    @OriginalMember(owner = "client!DQPGJUSB", name = "a", descriptor = "I")
    private int field601;

    @OriginalMember(owner = "client!DQPGJUSB", name = "<init>", descriptor = "(BILjava/io/RandomAccessFile;Ljava/io/RandomAccessFile;I)V")
    ...
    @OriginalMember(owner = "client!DQPGJUSB", name = "a", descriptor = "(IZ)[B")
    ...
    @OriginalMember(owner = "client!DQPGJUSB", name = "a", descriptor = "(II[BI)Z")
    ...
    @OriginalMember(owner = "client!DQPGJUSB", name = "a", descriptor = "(IZI[BI)Z")
    ...
    @OriginalMember(owner = "client!DQPGJUSB", name = "a", descriptor = "(ILjava/io/RandomAccessFile;Z)V")
