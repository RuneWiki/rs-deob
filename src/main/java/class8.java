...
@OriginalClass("client!CXEZIPRQ")
public class class8 extends class23 {

    @OriginalMember(owner = "client!CXEZIPRQ", name = "vb", descriptor = "[I")
    public int[] field537 = new int[5];

    @OriginalMember(owner = "client!CXEZIPRQ", name = "zb", descriptor = "[I")
    public int[] field541 = new int[12];

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Bb", descriptor = "I")
    private int field543 = -7539;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Fb", descriptor = "Z")
    public boolean field547 = false;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Gb", descriptor = "Z")
    public boolean field548 = false;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Ib", descriptor = "Z")
    private boolean field550 = true;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Jb", descriptor = "J")
    public long field551 = -1L;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "xb", descriptor = "LQQBOAQZB;")
    public static class50 field539 = new class50(3, 260);

    @OriginalMember(owner = "client!CXEZIPRQ", name = "tb", descriptor = "I")
    public int field535;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "ub", descriptor = "I")
    public int field536;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "wb", descriptor = "I")
    private int field538;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "yb", descriptor = "I")
    public int field540;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Ab", descriptor = "I")
    public int field542;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Cb", descriptor = "I")
    public int field544;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Db", descriptor = "I")
    public int field545;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Eb", descriptor = "I")
    public int field546;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Hb", descriptor = "I")
    public int field549;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Kb", descriptor = "I")
    public int field552;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Lb", descriptor = "I")
    public int field553;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Mb", descriptor = "I")
    public int field554;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Nb", descriptor = "I")
    public int field555;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Ob", descriptor = "I")
    public int field556;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Pb", descriptor = "I")
    public int field557;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Qb", descriptor = "I")
    public int field558;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "sb", descriptor = "J")
    public long field534;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "Rb", descriptor = "LDHUPIIUL;")
    public class10 field559;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "rb", descriptor = "LDOBKXCMM;")
    public class14 field533;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "qb", descriptor = "Ljava/lang/String;")
    public String field532;

    @OriginalMember(owner = "client!CXEZIPRQ", name = "b", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!CXEZIPRQ", name = "a", descriptor = "(I)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!CXEZIPRQ", name = "a", descriptor = "(LINLHDAGO;Z)V")
    ...
    @OriginalMember(owner = "client!CXEZIPRQ", name = "b", descriptor = "(I)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!CXEZIPRQ", name = "a", descriptor = "(B)LDHUPIIUL;")
