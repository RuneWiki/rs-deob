...
public class class8 {
    ...
    @OriginalMember(owner = "client!CMHYVIXN", name = "i", descriptor = "[LWLTAOGXS;")
    private class60[] field658 = new class60[10];

    @OriginalMember(owner = "client!CMHYVIXN", name = "e", descriptor = "[LCMHYVIXN;")
    ...
    @OriginalMember(owner = "client!CMHYVIXN", name = "h", descriptor = "LGLMIQHJI;")
    ...
    @OriginalMember(owner = "client!CMHYVIXN", name = "a", descriptor = "(ZLGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!CMHYVIXN", name = "a", descriptor = "(III)LGLMIQHJI;")
    ...
    @OriginalMember(owner = "client!CMHYVIXN", name = "a", descriptor = "(BLGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!CMHYVIXN", name = "a", descriptor = "(BI)LGLMIQHJI;")
