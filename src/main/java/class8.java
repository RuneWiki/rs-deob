...
public class class8 extends class309 {
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lic;Lja;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lvd;)V", line = 11)
    public final void method51(class5 arg0) {
    }

    @OriginalMember(owner = "client!kr", name = "c", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "()Z", line = 139)
    public final boolean method56() {
        return true;
    }

    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(Z)V", line = 142)
