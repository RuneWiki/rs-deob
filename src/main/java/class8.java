...
public class class8 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLmr;)V", line = 79)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(B)Z", line = 95)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lbl;)V", line = 528)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "(I)Z", line = 273)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZIIII)Z", line = 402)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lmr;I)Z", line = 446)
