...
public class class8 extends class378 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BLke;)V", line = 15)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILcl;ZIF)V", line = 40)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(BLke;)V", line = 162)
    ...
    @OriginalMember(owner = "client!de", name = "c", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Z)[Les;", line = 189)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([[BLjb;I)V", line = 212)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)V", line = 285)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IB)V", line = 301)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lke;I)V", line = 322)
