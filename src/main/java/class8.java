...
public class class8 extends class457 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lks;Lle;)V", line = 94)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Z)V", line = 154)
    public final void method62(boolean arg0) {
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lvo;)V", line = 157)
    public final void method63(class205 arg0) {
        this.field6752.method1160(arg0);
    }

    @OriginalMember(owner = "client!kr", name = "b", descriptor = "()V", line = 160)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "()Z", line = 169)
    public final boolean method65() {
        return true;
    }

    @OriginalMember(owner = "client!kr", name = "c", descriptor = "()V", line = 178)
