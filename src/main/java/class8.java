...
public class class8 extends class189 {
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZI)V", line = 75)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lih;B)V", line = 115)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lsv;IB)V", line = 739)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BII)V", line = 757)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)Z", line = 775)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lih;)V", line = 785)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 899)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(ZI)V", line = 919)
