...
public class class182 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)[Lfq;", line = 6)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!an", name = "toString", descriptor = "()Ljava/lang/String;", line = 58)
    public final String toString() {
        field2383++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(II)V", line = 65)
