...
public class class182 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "()V", line = 49)
    public static void method1099() {
        field2552 = null;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lqa;[IIII[I[I)V", line = 55)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lqa;[II[I[I)V", line = 138)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "()V", line = 141)
    private static final void method1103() {
        field2553 = 0;
    }

    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "([III)V", line = 186)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lqa;[II)V", line = 239)
    public static final void method1106(class162 arg0, int[] arg1, int arg2) {
        method1100(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)Z", line = 243)
