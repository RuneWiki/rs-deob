...
public class class182 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IB[BI)I", line = 7)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIZLjava/lang/String;ZZIIJLjava/lang/String;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lr;I)V", line = 97)
