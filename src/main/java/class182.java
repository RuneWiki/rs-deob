...
public class class182 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIILjava/awt/Frame;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 25)
    public class182() {
        this.field2503.initialize(null);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/awt/Frame;Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)[I", line = 45)
    ...
    @OriginalMember(owner = "client!be", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 61)
