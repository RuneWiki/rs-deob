...
public class class182 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II)V", line = 79)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lci;ILg;)V", line = 197)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(II)Lwq;", line = 169)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Loj;BLg;Lg;)V", line = 235)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(II)V", line = 252)
