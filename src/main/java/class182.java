...
public class class182 extends class87 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ZIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Loea;IIII[BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I[Ldm;ZIZI)V", line = 44)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Loea;IIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(JJ)J", line = 99)
    public static long method1304(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!efa", name = "e", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!efa", name = "f", descriptor = "(I)Leo;", line = 126)
