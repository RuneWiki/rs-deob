...
public class class182 extends class80 {
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 186)
    public class182() {
        super(1, true);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IILnn;)V", line = 195)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(II)[I", line = 228)
