...
public class class182 extends class715 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lifa;FILifa;)Z")
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Ldw;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)Lifa;")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIIIIIILnfa;II)Z")
