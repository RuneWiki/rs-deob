...
public class class182 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILmj;IBIIII)Lmj;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljf;Len;III)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IILbk;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)Luh;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIZLmj;II)Lmj;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZLbk;)V")
