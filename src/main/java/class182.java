...
public class class182 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)Ljp;")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)Ljp;")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lpu;)V")
    public class182(class411 arg0) {
        this.field2880 = arg0;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BLpu;)V")
