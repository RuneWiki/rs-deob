...
public class class182 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(II[ILhm;)Lrj;", line = 3)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!hga", name = "b", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(III)Z", line = 322)
    ...
    @OriginalMember(owner = "client!hga", name = "finalize", descriptor = "()V", line = 333)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Log;II)V", line = 353)
