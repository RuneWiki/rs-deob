...
public abstract class class182 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIILqv;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIIIB)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lag;)V", line = 83)
