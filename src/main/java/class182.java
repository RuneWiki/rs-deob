...
public class class182 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIIIIBI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BLjava/lang/String;I)I", line = 38)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BII)I", line = 48)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)V", line = 71)
