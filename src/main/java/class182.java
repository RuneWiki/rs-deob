...
public class class182 extends class418 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BS)V", line = 15)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III[[ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lse;Lsb;Ldn;[I)V", line = 258)
