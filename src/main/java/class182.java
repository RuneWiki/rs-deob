...
public abstract class class182 extends class508 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIB)I", line = 35)
    ...
    @OriginalMember(owner = "client!ve", name = "d", descriptor = "(B)I", line = 59)
    ...
    @OriginalMember(owner = "client!ve", name = "e", descriptor = "(B)I", line = 70)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([BI)[B", line = 86)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)F", line = 104)
    ...
    @OriginalMember(owner = "client!ve", name = "f", descriptor = "(B)I", line = 115)
    ...
    @OriginalMember(owner = "client!ve", name = "g", descriptor = "(B)I", line = 129)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILsj;II)V", line = 141)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(IIIIIF)V", line = 854)
