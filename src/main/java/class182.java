...
public class class182 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)Lvj;", line = 14)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BI)V", line = 52)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Ldk;ILfc;)V", line = 80)
    public class182(class328 arg0, int arg1, class343 arg2) {
        this.field2645 = arg2;
        this.field2645.method2054(0, 31);
    }

    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 101)
