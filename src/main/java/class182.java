...
public class class182 extends class135 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Laj;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Loe;Lvo;)V", line = 85)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!be", name = "h", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!be", name = "g", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!be", name = "i", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZI)V", line = 214)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)V", line = 232)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 284)
