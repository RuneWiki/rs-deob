...
public class class182 extends class400 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIZI[IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IZI[BIBIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lpc;IIIIZ[FI)V", line = 135)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lpc;IIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lpc;IIIIZ[IIIZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIBIIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lpc;IIIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZIZ)V", line = 273)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lpc;IIIIZ[BIZ)V", line = 294)
