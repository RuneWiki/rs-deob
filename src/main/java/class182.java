...
public class class182 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Ljava/lang/String;IBLap;)Ldl;", line = 17)
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 62)
