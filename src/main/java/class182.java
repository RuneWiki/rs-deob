...
public class class182 extends class408 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Z)I", line = 4)
    public final int method1136(boolean arg0) {
        return arg0 ? this.field2116.field3308 : 82;
    }

    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)Lhp;", line = 15)
    public final class254 method1137(int arg0) {
        int var2 = -32 % ((arg0 + 81) / 40);
        return this.field2116;
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(FILhp;Lhp;)V", line = 25)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lh;I)V", line = 114)
