...
public class class182 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(CBLjava/lang/String;)[Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IILwp;ZB)V", line = 59)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(I)V", line = 141)
