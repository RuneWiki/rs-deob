...
public class class182 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(II)Lqaa;", line = 4)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 94)
    public class182(class414 arg0, int arg1, class648 arg2) {
        this.field2627 = arg2;
        this.field2627.method3653(26, true);
    }

    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IB)V", line = 70)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(II)Z", line = 84)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Z)V", line = 109)
