...
public abstract class class182 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lgs;B)Lsu;", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Z)Lah;", line = 67)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(IIIII)V", line = 403)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)V", line = 365)
