...
public class class182 extends class270 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZILvj;Ljava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIII)Lpe;")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLec;I)V")
