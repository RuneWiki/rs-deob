...
public class class182 extends class365 implements class366 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 5)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Z)V", line = 19)
    public final void method1284(boolean arg0) {
        ++field2794;
        super.method1284(arg0);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 28)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(B)I", line = 45)
    ...
    @OriginalMember(owner = "client!vda", name = "d", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)Z", line = 81)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(III)Z", line = 92)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II)V", line = 113)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lno;Z)V", line = 162)
    public class182(class704 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)I", line = 169)
