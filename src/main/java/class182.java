...
public class class182 extends class85 {
    ...
    @OriginalMember(owner = "client!tg", name = "W", descriptor = "Lvg;")
    public static class200 field3431 = null;

    @OriginalMember(owner = "client!tg", name = "Y", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!tg", name = "cb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BILja;)V")
