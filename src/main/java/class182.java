...
public class class182 extends class577 implements class490 {
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lqo;I[BI)V", line = 5)
    public class182(class22 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field2752 = arg1;
    }

    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lqo;ILjaclib/memory/Buffer;)V", line = 13)
    public class182(class22 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field2752 = arg1;
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)J", line = 25)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lha;B)V", line = 39)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(B)I", line = 147)
    public final int method959(byte arg0) {
        ++field2754;
        return arg0 != -97 ? -87 : this.field2752;
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II[BI)V", line = 159)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Z)I", line = 172)
