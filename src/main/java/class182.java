...
public abstract class class182 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lha;III[Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIIIIIIIII)V", line = 92)
