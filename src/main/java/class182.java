...
public class class182 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;IIII[S[B)V", line = 13)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;IIII)Leea;", line = 78)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;Llq;IIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)Ldj;", line = 119)
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "([B[B[SII)V", line = 158)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;II)V", line = 304)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(I)V", line = 482)
    public static final void method1057(int arg0) {
        field2250 = (class291) field2244.method524((byte) 98, (long) arg0);
    }

    @OriginalMember(owner = "client!cea", name = "d", descriptor = "()V", line = 486)
    ...
    @OriginalMember(owner = "client!cea", name = "e", descriptor = "()V", line = 509)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(II)Ltf;", line = 667)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lkea;Lpp;Ldba;Lup;Lik;Ln;Lsp;)V", line = 682)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;)Leea;", line = 715)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(Loa;IIII)V", line = 726)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Le;II)V", line = 1070)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;IIIIIII[S[BZ)V", line = 1080)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(Loa;)V", line = 1244)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(I)Ldj;", line = 1255)
    public static final class291 method1067(int arg0) {
        return (class291) field2244.method524((byte) 83, (long) arg0);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Le;III)I", line = 1265)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Loa;Lrt;IIII[I[I)V", line = 1329)
