...
public class class182 extends class114 {
    ...
    @OriginalMember(owner = "client!wd", name = "f", descriptor = "(I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "g", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BLnj;)V", line = 45)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B[ILnj;)V", line = 73)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(III)I", line = 101)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II)Lfg;", line = 120)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZLnj;)Ljava/lang/String;", line = 135)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILnj;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!wd", name = "h", descriptor = "(I)I", line = 252)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(B)V", line = 266)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(III)Z", line = 288)
