...
public class class182 extends class263 {
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lck;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lha;Luaa;B)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILgha;ZLgha;)V")
