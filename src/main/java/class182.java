...
public abstract class class182 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!hh", name = "providesignlink", descriptor = "(Llh;)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "([BI)Lml;")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)Lwc;")
