...
public class class182 extends class278 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIZIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIBI)[B", line = 103)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(BII)V", line = 117)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIZ)Z", line = 161)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "()V", line = 172)
    public class182() {
