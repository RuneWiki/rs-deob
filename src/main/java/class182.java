...
public class class182 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lbka;", line = 93)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 131)
