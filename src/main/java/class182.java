...
public class class182 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BIII)Lsk;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([[BLjb;B)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lbg;I)I")
