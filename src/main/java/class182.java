...
public class class182 extends class498 {
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(IJ)I", line = 4)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(B)J", line = 45)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(B)J", line = 77)
    public final long method1361(byte arg0) {
        int var2 = -50 / ((arg0 - 35) / 48);
        return this.field2840;
    }

    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)J", line = 90)
