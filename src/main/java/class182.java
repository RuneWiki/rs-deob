...
public class class182 extends class504 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "()[I", line = 53)
    public final int[] method1210() {
        return this.field2760;
    }

    @OriginalMember(owner = "client!me", name = "b", descriptor = "()V", line = 56)
    public static void method1211() {
        field2756 = null;
    }

    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(II[IZ)V", line = 59)
