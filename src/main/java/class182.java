...
public class class182 extends class98 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lrea;Liu;)V", line = 65)
