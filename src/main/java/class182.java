...
public class class182 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)Lsj;", line = 88)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 141)
    public class182(class271 arg0, int arg1, class84 arg2) {
        this.field2741 = arg2;
        this.field2741.method656((byte) 122, 31);
    }

    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)V", line = 129)
