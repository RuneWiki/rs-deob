...
public class VarpType {
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "[Lrc;")
    public static VarpType[] field1183;

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lxb;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILlb;I)V")
