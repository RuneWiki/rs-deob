...
public class VarpType {
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "[Lic;")
    public static VarpType[] field962;

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZLub;)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILkb;Z)V")
