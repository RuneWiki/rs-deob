...
public class VarpType {
    ...
    @OriginalMember(owner = "client!sc", name = "e", descriptor = "[Lsc;")
    public static VarpType[] field1184;

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILyb;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lmb;IZ)V")
