...
public class class263 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljb;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljb;IZ)Ljava/lang/String;", line = 54)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)Z", line = 85)
