...
public class class263 extends class111 {
    ...
    @OriginalMember(owner = "client!bt", name = "R", descriptor = "(III[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bt", name = "la", descriptor = "(Lq;)V", line = 11)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "()Lq;", line = 27)
    ...
    @OriginalMember(owner = "client!bt", name = "XA", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!bt", name = "GA", descriptor = "(III)V", line = 52)
    ...
    @OriginalMember(owner = "client!bt", name = "pa", descriptor = "(IIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!bt", name = "P", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!bt", name = "O", descriptor = "([I)V", line = 116)
    ...
    @OriginalMember(owner = "client!bt", name = "S", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!bt", name = "G", descriptor = "(III)V", line = 149)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(III[I)V", line = 154)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!bt", name = "ra", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!bt", name = "Y", descriptor = "()V", line = 176)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 184)
    public class263() {
        this.method600();
    }
}
