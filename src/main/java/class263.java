...
public class class263 extends class453 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "()V", line = 45)
    public class263() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!js", name = "d", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZII)[B", line = 66)
