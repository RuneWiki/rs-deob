...
public class class263 extends class509 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZB)V", line = 31)
    public final void method35(boolean arg0, byte arg1) {
        int var3 = -104 / ((40 - arg1) / 36);
        ++field3894;
    }

    @OriginalMember(owner = "client!sn", name = "e", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lkw;)V", line = 52)
    public class263(class174 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)Z", line = 65)
    public final boolean method40(int arg0) {
        ++field3892;
        return arg0 < 44;
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZILmn;)V", line = 76)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 101)
