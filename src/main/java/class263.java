...
public class class263 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lio;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lio;I)V", line = 197)
