...
public class class263 extends class386 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIIZI)I", line = 5)
    ...
    @OriginalMember(owner = "client!bq", name = "e", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "()V", line = 465)
    public class263() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z[II)V", line = 130)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 291)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(II)[I", line = 312)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 342)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IBLun;)V", line = 372)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(Z)V", line = 471)
