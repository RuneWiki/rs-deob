...
public class class263 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IB)Lkw;", line = 31)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)Lcha;", line = 43)
    public final class230 method1737(int arg0) {
        field3901++;
        return arg0 == 1 ? class40.method277(this.field3904, true) : null;
    }

    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(II)V", line = 60)
