...
public class class263 extends class373 implements class237 {
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(BLha;)Lhga;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILdja;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lha;Lcn;IIBZI)V")
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Lha;B)Ldg;")
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Lha;Lij;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lha;III)Z")
