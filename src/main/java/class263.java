...
public class class263 extends class278 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLlh;)Lth;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BZLss;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Llh;II)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lpp;Lsd;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIBIIZIILqp;Lqa;ILc;II)Lc;")
