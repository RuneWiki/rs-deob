...
public class class263 implements class470 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)I", line = 41)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZZ)I", line = 63)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IBI)V", line = 154)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZI)I", line = 210)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(III)V", line = 244)
