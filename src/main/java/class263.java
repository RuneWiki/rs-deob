...
public class class263 extends class354 {
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "()V", line = 26)
    public class263() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IBIZ)Ljava/lang/String;", line = 32)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I[[I)V", line = 83)
    ...
    @OriginalMember(owner = "client!oj", name = "h", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IB)[[I", line = 156)
    ...
    @OriginalMember(owner = "client!oj", name = "i", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lnj;II)V", line = 248)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)I", line = 327)
