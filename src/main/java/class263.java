...
public class class263 extends class138 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lih;IILjava/lang/String;)Lbh;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lia;I)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IILta;II)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(FFFFFFLta;II)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILec;I)I")
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lih;IIII)V")
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lih;II[III)V")
