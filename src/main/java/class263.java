...
public abstract class class263 extends class337 {
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lck;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lwm;ILoq;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILuaa;BILaa;IJI)V")
