...
public abstract class class263 extends class115 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(III)[I", line = 15)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IB)[I", line = 74)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lya;JI)V", line = 85)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(IB)[[I", line = 115)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(III)[[I", line = 138)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(Z)I", line = 174)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IZLgk;)V", line = 187)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IBI)V", line = 220)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)I", line = 244)
    public static final int method1648(int arg0, int arg1) {
        field3922++;
        return arg1 == 0 ? arg0 >>> 10 : -6;
    }

    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(IZ)V", line = 255)
