...
public class class263 extends class30 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "()V", line = 99)
    public class263() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIB[[ILjava/util/Random;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IB)[I", line = 319)
    ...
    @OriginalMember(owner = "client!wr", name = "f", descriptor = "(I)V", line = 569)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ljg;II)V", line = 630)
    ...
    @OriginalMember(owner = "client!wr", name = "g", descriptor = "(I)V", line = 733)
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(B)V", line = 754)
    ...
    @OriginalMember(owner = "client!wr", name = "e", descriptor = "(B)V", line = 764)
