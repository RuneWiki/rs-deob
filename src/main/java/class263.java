...
public class class263 extends class124 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)J", line = 53)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)J", line = 63)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 104)
    public class263() {
