...
public class class263 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "([IBII[J)V", line = 5)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILln;Z)V", line = 111)
