...
public class class263 extends class509 {
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 19)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "()I", line = 98)
    public final int method956() {
        return this.field3536 - (this.field3534.available() >> (class163.field2472 ? 2 : 1));
    }

    @OriginalMember(owner = "client!ei", name = "d", descriptor = "()V", line = 109)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "()V", line = 142)
