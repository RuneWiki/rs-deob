...
public class class263 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZI[BII)Z")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(III[B)Z")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(II)[B")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIIIBII)Z")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIIIILuu;IIIII)Z")
    ...
    @OriginalMember(owner = "client!mda", name = "toString", descriptor = "()Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(ILij;Lij;I)V")
