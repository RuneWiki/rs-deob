...
public class class263 extends class456 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(FIZLya;I)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lak;I)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILak;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLau;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLak;)V")
