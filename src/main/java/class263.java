...
public class class263 extends class346 {
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "()V", line = 211)
    public class263() {
        super(0, false);
    }

    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "(Z)Z", line = 50)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lfb;ZI)V", line = 81)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(II)[[I", line = 109)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IZ)Laa;", line = 185)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 214)
