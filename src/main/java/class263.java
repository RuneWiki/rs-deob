...
public class class263 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Liaa;[BB)V", line = 9)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "()V", line = 43)
    public class263() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(III)V", line = 67)
