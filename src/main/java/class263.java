...
public class class263 extends class367 {
    ...
    @OriginalMember(owner = "client!cf", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ltq;III)Z", line = 110)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(Ltq;I)Lcj;", line = 154)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILtq;)V", line = 204)
