...
public class class263 {
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "([I)V", line = 130)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)I", line = 221)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLhe;Lhe;)V", line = 254)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIIIII)Z", line = 266)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)V", line = 330)
