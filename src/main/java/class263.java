...
public class class263 extends class355 {
    ...
    @OriginalMember(owner = "client!rl", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rl", name = "e", descriptor = "(I)[B", line = 33)
    ...
    @OriginalMember(owner = "client!rl", name = "f", descriptor = "(I)I", line = 61)
