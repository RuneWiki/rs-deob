...
public class class263 implements class302 {
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 14)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(I)I", line = 40)
    public final int method1491(int arg0) {
        int var2 = -52 % ((-arg0 - 42) / 46);
        return this.field3838;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Llt;Z)V", line = 143)
    public class263(class672 arg0, boolean arg1) {
        this.field3840 = arg1;
        this.field3839 = arg0;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Ljaclib/memory/Source;IIB)Z", line = 132)
