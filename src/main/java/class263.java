...
public class class263 extends class413 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIILbo;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)Z", line = 131)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 2889)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)V", line = 2908)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)V", line = 2932)
