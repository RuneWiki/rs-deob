...
public class class263 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IZI[[[Luaa;IB)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lkea;I)V", line = 332)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 347)
    public static void method1740(int arg0) {
        int var1 = 114 / ((arg0 + 24) / 37);
        field3734 = null;
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIZ)V", line = 357)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lkr;II)V", line = 372)
