...
public class class263 extends class113 {
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(B)J", line = 35)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)I", line = 63)
