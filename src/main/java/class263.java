...
public class class263 extends class384 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lbia;BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZB)V", line = 29)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 60)
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(B)V", line = 107)
    public static void method1588(byte arg0) {
        int var1 = -110 / ((22 - arg0) / 53);
        field3336 = null;
    }

    @OriginalMember(owner = "client!os", name = "d", descriptor = "(B)Z", line = 116)
    public final boolean method1021(byte arg0) {
        ++field3338;
        return arg0 > 78;
    }

    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Lbm;)V", line = 172)
    public class263(class684 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IBI)V", line = 157)
