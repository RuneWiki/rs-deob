...
public class class602 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "()Ljg;")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lgda;II)Lfia;")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lwq;)V")
