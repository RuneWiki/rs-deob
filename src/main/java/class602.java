...
public class class602 implements Runnable {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Ljava/lang/String;Lvc;IJI)V")
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(I)Lvc;")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(ILwo;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Ld;BLha;)V")
