...
public class class602 extends class148 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZILjava/lang/Object;)[B", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lba;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "()V", line = 56)
    public class602() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BII)V", line = 59)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(BII)I", line = 99)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIII)[B", line = 112)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(B)[Loh;", line = 127)
