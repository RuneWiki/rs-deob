...
public abstract class class602 implements class764 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BI[BII)V", line = 16)
    ...
    @OriginalMember(owner = "client!oh", name = "f", descriptor = "(I)I", line = 116)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!oh", name = "finalize", descriptor = "()V", line = 156)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B[IIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ltd;I)V", line = 274)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "([FIIII)V", line = 293)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IZ)I", line = 389)
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(Z)I", line = 436)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(I)V", line = 531)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 559)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Ldga;ILhh;Lon;IZ)V", line = 594)
