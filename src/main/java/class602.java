...
public class class602 extends class1 {
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)I", line = 45)
    public static int method3336(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(IIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 78)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZIIZB)Lpj;", line = 97)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(III)Z", line = 118)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(III)V", line = 130)
