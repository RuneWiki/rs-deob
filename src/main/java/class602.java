...
public class class602 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIB)I", line = 16)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(BI)V", line = 43)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)Lqe;", line = 133)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lcda;ILkea;)V", line = 205)
