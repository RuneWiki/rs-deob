...
public class class602 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BIIIIII[B[B)V", line = 19)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!iu", name = "finalize", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lkv;II)V", line = 102)
