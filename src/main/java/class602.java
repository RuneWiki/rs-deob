...
public class class602 implements class121 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILe;Ljo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)Lqv;", line = 36)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(I)V", line = 62)
