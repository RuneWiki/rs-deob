...
public class class602 extends class502 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Loa;JB)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(JIIZLoa;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Loa;Ljt;Lhv;J)V")
