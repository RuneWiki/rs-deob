...
public class class602 extends class739 {
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "()V", line = 93)
    public class602() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ZI)[I", line = 12)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lsl;IB)V", line = 66)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IB)V", line = 80)
