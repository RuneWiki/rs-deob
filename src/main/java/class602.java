...
public class class602 extends class272 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)Leu;", line = 6)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lja;Lmea;IIIIIIIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IZIIIII)V", line = 52)
