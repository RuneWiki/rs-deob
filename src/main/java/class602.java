...
public class class602 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 109)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIIIZ)V", line = 186)
