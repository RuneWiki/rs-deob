...
public class class602 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZLsu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)Lcv;", line = 41)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lir;B)V", line = 59)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(II)Llm;", line = 81)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BLui;)V", line = 401)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(B)Z", line = 414)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BLir;)V", line = 427)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 458)
