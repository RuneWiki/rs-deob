...
public class class602 extends class212 {
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Ldh;)V")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lua;B)V")
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(ILdh;)V")
    public class602(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(ZI)Lmf;")
