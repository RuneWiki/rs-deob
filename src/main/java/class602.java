...
public abstract class class602 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZI)V", line = 11)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(III)I", line = 23)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(III)V", line = 38)
