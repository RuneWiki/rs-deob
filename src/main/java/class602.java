...
public class class602 extends class649 {
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lhs;)V", line = 79)
    public class602(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(IZ)I", line = 82)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IB)V", line = 100)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(ILhs;)V", line = 112)
    public class602(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)I", line = 125)
