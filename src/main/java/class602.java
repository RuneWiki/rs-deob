...
public class class602 extends class702 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 46)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lkga;)V", line = 74)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Z)Z", line = 187)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljf;II)V", line = 200)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)V", line = 227)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZI)V", line = 296)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(I)I", line = 326)
