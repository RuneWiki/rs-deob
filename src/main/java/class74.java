...
public class class74 extends class511 implements class128 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILfa;II)V", line = 4)
    public final void method594(int arg0, int arg1, class619 arg2, int arg3, int arg4) {
        this.method605(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;II)V", line = 12)
    public class74(class396 arg0, class613 arg1, int arg2, int arg3) {
        this.method593(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!aa", name = "finalize", descriptor = "()V", line = 36)
