...
public class class74 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IF[BFIFLqg;FIBIFI)V", line = 5)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BLcea;)V", line = 54)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IILcea;)V", line = 94)
