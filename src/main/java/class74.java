...
public class class74 extends class35 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lui;II)Lm;", line = 28)
    ...
    @OriginalMember(owner = "client!m", name = "d", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "([BI)V", line = 75)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "([B)V", line = 86)
    ...
    @OriginalMember(owner = "client!m", name = "e", descriptor = "(I)F", line = 131)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lui;)Z", line = 143)
    ...
    @OriginalMember(owner = "client!m", name = "f", descriptor = "(I)[F", line = 159)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "([I)Luk;", line = 571)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "([B)V", line = 633)
    private class74(byte[] arg0) {
        this.method637(arg0);
    }

    @OriginalMember(owner = "client!m", name = "b", descriptor = "()I", line = 642)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "([B)V", line = 649)
