...
public class class74 extends class418 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Ltj;Lir;BLir;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IB)I", line = 37)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)V", line = 65)
