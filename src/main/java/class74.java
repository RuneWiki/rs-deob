...
public class class74 extends class381 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIIIB[B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(IIIIIZ)V", line = 86)
