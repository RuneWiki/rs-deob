...
public class class74 extends class56 {
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)[I", line = 47)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "()V", line = 132)
    public class74() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(CB)C", line = 139)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BILes;)V", line = 537)
