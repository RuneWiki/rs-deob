...
public class class74 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ILri;Ljava/lang/String;Z)Lck;", line = 7)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(BI)V", line = 79)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IB)Lega;", line = 95)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Lei;ILri;)V", line = 159)
