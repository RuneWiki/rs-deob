...
public class class74 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!kca", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Lpn;III)V", line = 55)
