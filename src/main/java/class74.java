...
public class class74 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ZZILwf;IZLwf;)I", line = 340)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 371)
