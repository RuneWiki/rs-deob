...
public class class74 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILu;ZIZLu;Z)I")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)Lpe;")
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)Lpe;")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lqh;)V")
