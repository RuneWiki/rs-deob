...
public class class74 extends class402 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lpk;[I)V")
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Leq;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lkw;IIB)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!qh", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qh", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qh", name = "fa", descriptor = "(IILr;)Lr;")
