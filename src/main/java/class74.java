...
public class class74 extends class59 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)[B", line = 8)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "([BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!kca", name = "c", descriptor = "(III)[B", line = 36)
