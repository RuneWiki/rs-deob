...
public abstract class class74 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 4)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljs;B)V", line = 37)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 89)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Z)V", line = 126)
