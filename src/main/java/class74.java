...
public abstract class class74 {
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Len;)V", line = 70)
    public class74(class478 arg0) {
        this.field1011 = arg0;
    }

    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)V", line = 82)
    public void method345(int arg0) {
        field1005++;
        int var2 = -100 / ((54 - arg0) / 37);
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILr;)V", line = 91)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 189)
    public static final void method442(int arg0, boolean arg1, String arg2) {
        field1013++;
        class55.method353(arg0, arg1, arg2, -1, 1986811992);
    }

    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(I)V", line = 197)
