...
public class class74 extends class337 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)F", line = 14)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lwm;I)Llea;", line = 25)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "([B)V", line = 39)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "()I", line = 192)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(I)I", line = 201)
    ...
    @OriginalMember(owner = "client!lea", name = "e", descriptor = "(I)[F", line = 245)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lwm;II)Llea;", line = 657)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lwm;)Z", line = 671)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "([B)V", line = 692)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "([BI)V", line = 734)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "([I)Lnga;", line = 740)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "()V", line = 799)
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "([B)V", line = 817)
