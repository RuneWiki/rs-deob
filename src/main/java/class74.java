...
public class class74 implements Runnable {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 298)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZB)I", line = 117)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(III)Z", line = 162)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)Z", line = 178)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIIBI)V", line = 210)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II[BB)I", line = 226)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I[IZIILdia;IB)Lme;", line = 277)
