...
public class class74 extends class416 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II[BIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIIIZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIB)Z", line = 491)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lh;II)V", line = 499)
    public class74(class327 arg0, int arg1, int arg2) {
        this.field903 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!um", name = "d", descriptor = "(I)V", line = 512)
