...
public class class74 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(FIIFIIFI)[F", line = 6)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)I", line = 150)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BI)V", line = 161)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(B)I", line = 190)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "()V", line = 200)
    public class74() {
    }

    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lfh;)V", line = 203)
