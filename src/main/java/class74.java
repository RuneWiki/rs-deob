...
public class class74 extends class75 implements class31 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lpw;I)V")
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lwda;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
