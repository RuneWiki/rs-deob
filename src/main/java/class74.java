...
public class class74 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIBLja;)V")
    public static final void method551(int arg0, int arg1, byte arg2, class174 arg3) {
        field1315++;
        int var4 = 35 / ((arg2 + 1) / 42);
        class152.field2427[arg0][arg1] = arg3;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(II)V")
    public static final void method552(int arg0, int arg1) {
        field1319++;
        class64 var2 = class230.method1387(arg1, (byte) 40, arg0);
        var2.method446(-20033);
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lhs;)V")
    public static final void method553(class205 arg0) {
        for (int var1 = arg0.field3225; var1 <= arg0.field3227; var1++) {
            for (int var2 = arg0.field3219; var2 <= arg0.field3220; var2++) {
                class268 var3 = class321.field4830[arg0.field3217][var1][var2];
                if (var3 != null) {
                    class297 var4 = var3.field4045;
                    class297 var5 = null;
                    while (var4 != null) {
                        if (var4.field4505 == arg0) {
                            if (var5 == null) {
                                var3.field4045 = var4.field4500;
                            } else {
                                var5.field4500 = var4.field4500;
                            }
                            var4.method1801(-29240);
                            break;
                        }
                        var5 = var4;
                        var4 = var4.field4500;
                    ...
                    var3.field4038 = 0;
                    for (class297 var6 = var3.field4045; var6 != null; var6 = var6.field4500) {
                        var3.field4038 = (byte) (var3.field4038 | var6.field4506);
                    }
                }
            }
        }
    ...
    public class74(int[] arg0) {
        ...
        this.field1317 = new int[var2 + var2];
        for (int var3 = 0; var3 < var2 + var2; var3++) {
            this.field1317[var3] = -1;
        }
        int var4 = 0;
        while (var4 < arg0.length) {
            int var5;
            for (var5 = arg0[var4] & var2 - 1; this.field1317[var5 + var5 + 1] != -1; var5 = var2 - 1 & var5 + 1) {
            }
            this.field1317[var5 + var5] = arg0[var4];
            this.field1317[var5 + var5 + 1] = var4++;
        }
    }
    ...
    public final int method554(int arg0, int arg1) {
        field1316++;
        int var3 = (this.field1317.length >> 1) - 1;
        if (arg1 != 7116) {
            field1314 = null;
        }
        int var4 = var3 & arg0;
        while (true) {
            int var5 = this.field1317[var4 + var4 + 1];
            if (var5 == -1) {
                return -1;
            }
            if (this.field1317[var4 + var4] == arg0) {
                return var5;
            }
            var4 = var3 & var4 + 1;
        }
    ...
    public static void method555(int arg0) {
        ...
        field1321 = null;
        if (arg0 >= -107) {
            method551(25, -7, (byte) -30, null);
        }
    }

    static {
        new class423("Login to a members' server to use this object.", "Du musst auf einer Mitglieder-Welt sein, um diesen Gegenstand zu benutzen.", "Connectez-vous à un serveur d'abonnés pour utiliser cet objet.", "Acesse um servidor para membros para usar este objeto.");
        field1321 = new class407(8);
        field1322 = new short[] { 6798, 8741, 25238, 4626, 4550 };
    }
}
