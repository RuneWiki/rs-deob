...
public class class74 implements class250 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)Lud;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lla;Ljava/lang/String;)V")
