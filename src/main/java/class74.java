...
public class class74 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lqa;Ldq;I)I")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lcr;III)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lcl;IIIIIIIIIB)Z")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lbo;II)V")
