...
public class class74 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)Lib;", line = 69)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(II)V", line = 100)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lqg;ILvd;Lvd;)V", line = 169)
