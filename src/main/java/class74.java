...
public class class74 extends class56 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IZI)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "([BZII)I")
    ...
    @OriginalMember(owner = "client!gea", name = "e", descriptor = "(I)[Lrq;")
