...
public class class74 extends class467 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIB)B", line = 20)
    ...
    @OriginalMember(owner = "client!gg", name = "c", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "()V", line = 122)
    public class74() {
    }

    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(I)V", line = 125)
    public class74(int arg0) {
        this.field998 = arg0;
    }

    @OriginalMember(owner = "client!gg", name = "c", descriptor = "(I)Ljava/lang/String;", line = 133)
