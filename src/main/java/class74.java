...
public class class74 extends class197 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IBI)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IBIIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lpg;II)V", line = 548)
