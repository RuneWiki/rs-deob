...
public class class74 extends class263 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lfea;[B[II)Z", line = 38)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 93)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "()V", line = 116)
    public class74() {
    }

    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "([B)V", line = 120)
