...
public class class74 extends class401 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)Z", line = 5)
    public final boolean method645(byte arg0) {
        return arg0 == 6 ? true : true;
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 15)
    public final Object method646(int arg0) {
        return arg0 == -17718 ? this.field948.get() : (Object) null;
    }

    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
