...
public class class74 implements class409 {
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "()I", line = 5)
    public final int method541() {
        return this.field1061;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILvm;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!ej", name = "d", descriptor = "()Z", line = 31)
    public final boolean method543() {
        int var1 = this.field1055.field3634.glCheckFramebufferStatusEXT(36160);
        return var1 == 36053;
    }

    @OriginalMember(owner = "client!ej", name = "finalize", descriptor = "()V", line = 42)
    protected final void finalize() throws Throwable {
        this.field1055.method1656(this.field1059);
        super.finalize();
    }

    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lnf;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILir;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILvm;I)V", line = 92)
    public final void method547(int arg0, class322 arg1, int arg2) {
        this.method542(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!ej", name = "b", descriptor = "()V", line = 98)
    public final void method548() {
        this.field1055.field3634.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILtm;)V", line = 105)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "()V", line = 127)
    public final void method550() {
        this.field1055.field3634.glBindFramebufferEXT(36160, this.field1059);
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILir;)V", line = 140)
