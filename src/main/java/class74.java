...
public class class74 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILec;B)V")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lpf;Z)Z")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lec;B)V")
