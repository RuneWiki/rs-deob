...
public class class74 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)Liq;", line = 25)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BILci;)Lgg;", line = 70)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lsn;ILci;Lci;)V", line = 101)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IB)V", line = 89)
