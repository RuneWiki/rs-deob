...
public abstract class class74 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "([[IB)V", line = 69)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZJIII)Ljava/lang/String;", line = 82)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)V", line = 165)
