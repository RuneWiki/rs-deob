...
public class class74 extends class147 {
    ...
    @OriginalMember(owner = "client!he", name = "I", descriptor = "Llf;")
    public static class109 field1418 = class35.method275("Diese Welt ist voll)3", 2);

    @OriginalMember(owner = "client!he", name = "M", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!he", name = "Q", descriptor = "Ldb;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BLja;I)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILja;)V")
