...
public class class74 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Loa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Loa;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Loa;[II)V")
