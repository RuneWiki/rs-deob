...
public class class603 extends class35 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "([BB)Lxa;", line = 4)
    ...
    @OriginalMember(owner = "client!aga", name = "e", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(II)Z", line = 62)
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!aga", name = "finalize", descriptor = "()V", line = 90)
    protected final void finalize() {
        this.method281(0);
        field8110++;
    }

    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I[BII)I", line = 107)
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(II[BI)V", line = 134)
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 144)
