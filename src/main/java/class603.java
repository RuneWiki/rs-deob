...
public class class603 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(II[[[BII[IZ[IBZII[II[II[IZ)V", line = 32)
