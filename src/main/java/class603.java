...
public class class603 extends class337 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(I)[Lcu;", line = 55)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Lmh;Lpda;)V", line = 69)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IBLuu;)V", line = 89)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(B)Z", line = 118)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ZI)V", line = 136)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ZII)V", line = 147)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(III)B", line = 186)
