...
public class class603 extends class201 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(CI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lrd;", line = 30)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIII)I", line = 73)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)[B", line = 115)
