...
public abstract class class603 implements class542 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(BLjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lqb;I)I")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lgf;IZ)V")
