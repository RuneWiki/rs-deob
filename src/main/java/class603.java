...
public class class603 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IBI)I", line = 13)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "()V", line = 115)
    public class603() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLps;[B)V", line = 118)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(III)V", line = 142)
