...
public class class603 extends class481 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lbi;IIZ)V")
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lbi;IIII)V")
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lbi;II[III)V")
