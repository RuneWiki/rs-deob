...
public class class603 extends class674 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BLgk;)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lew;I)V")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lew;)V")
