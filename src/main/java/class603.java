...
public class class603 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lfp;Lfp;Lfp;Lfp;I)V")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V")
