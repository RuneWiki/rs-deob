...
public class class603 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)I", line = 69)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IBLdga;)V", line = 95)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BLdga;)V", line = 147)
