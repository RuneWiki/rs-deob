...
public class class603 extends class205 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIIIBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IB)V", line = 67)
