...
public class class603 extends class379 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "()V", line = 93)
    public class603() {
    }

    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(J)V", line = 111)
