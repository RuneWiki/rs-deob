...
public class class603 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILjr;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B[I[Ljava/lang/Object;)V", line = 327)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILjr;)V", line = 340)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)V", line = 385)
