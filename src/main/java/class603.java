...
public class class603 extends class260 {
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lfca;)V", line = 15)
    public class603(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IB)I", line = 33)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(ILfca;)V", line = 61)
    public class603(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(IB)V", line = 79)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(Z)I", line = 91)
