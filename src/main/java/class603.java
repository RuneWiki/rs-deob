...
public abstract class class603 implements class134 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(III)Lrfa;", line = 45)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(IZII)V", line = 173)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Ljn;Ljn;Lfs;)V", line = 196)
