...
public class class603 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II)Z", line = 13)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lrk;IIZIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(BIIIII)V", line = 137)
