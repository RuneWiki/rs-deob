...
public class class603 extends class5 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZ)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(IBI)V", line = 54)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IILjava/lang/String;)V", line = 68)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "()V", line = 160)
    public class603() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILes;I)V", line = 165)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)[I", line = 228)
    ...
    @OriginalMember(owner = "client!ge", name = "i", descriptor = "(I)V", line = 259)
