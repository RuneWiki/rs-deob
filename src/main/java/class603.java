...
public class class603 extends class757 {
    ...
    @OriginalMember(owner = "client!qj", name = "f", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([BI)Z", line = 33)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)Z", line = 58)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IF)V", line = 77)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(IIIIIF)V", line = 89)
