...
public class class603 extends class450 {
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZLfs;Z)V")
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lup;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
