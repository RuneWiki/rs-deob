...
public class class603 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lmia;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILrv;)V", line = 75)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lrv;)V", line = 161)
