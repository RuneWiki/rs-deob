...
public class class603 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IILr;I)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILtp;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILr;BI)Z")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III)Lv;")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lnv;Leo;)V")
