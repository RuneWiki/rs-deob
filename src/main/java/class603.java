...
public class class603 extends class476 {
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lwia;Lwia;Lht;)V", line = 3)
    public class603(class791 arg0, class791 arg1, class606 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!iu", name = "d", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ljs;Z)V", line = 38)
