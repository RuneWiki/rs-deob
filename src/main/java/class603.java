...
public class class603 implements class721 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)Laca;", line = 4)
    public final class758 method228(int arg0) {
        field8442++;
        return arg0 == 1 ? class325.field4443 : null;
    }

    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(I)V", line = 22)
    public class603(int arg0) {
        this.field8437 = arg0;
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)V", line = 32)
