...
public class class603 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lwe;I)V")
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(I)Lwe;")
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(I)Lwe;")
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(I)Lwe;")
