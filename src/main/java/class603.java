...
public class class603 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)V", line = 96)
