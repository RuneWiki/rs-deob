...
public class class603 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I[II[JI)V", line = 34)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "()V", line = 193)
