...
public class class35 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lvd;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(I)V", line = 32)
    public class35(int arg0) {
        this.field414 = arg0;
    }

    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(IIIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)Lvd;", line = 40)
