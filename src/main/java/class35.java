...
public class class35 extends class1 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lrp;[III)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lrp;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lrp;II)V")
