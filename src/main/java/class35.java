...
public class class35 extends class45 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIIILge;)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "([BLcp;B[I)Z")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lwd;Lnj;ZI)V")
