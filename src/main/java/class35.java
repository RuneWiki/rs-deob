...
public class class35 extends class328 {
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(IIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILct;)V", line = 67)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BII)V", line = 92)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIIIZIIIIII)Z", line = 112)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(III)V", line = 137)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(B)V", line = 158)
