...
public class class35 extends OutputStream {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIIIZIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!be", name = "write", descriptor = "(I)V", line = 649)
    public final void write(int arg0) throws IOException {
        field424++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "([BZ)V", line = 658)
