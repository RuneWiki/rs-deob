...
public class class35 extends class10 {
    ...
    @OriginalMember(owner = "client!JOVUNXBE", name = "j", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!JOVUNXBE", name = "i", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!JOVUNXBE", name = "y", descriptor = "Z")
