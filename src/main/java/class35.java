...
public class class35 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lr;Lr;Z)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILwm;)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)Lnt;")
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(II)Lnb;")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Ldn;ILr;Lr;Lr;)V")
