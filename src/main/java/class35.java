...
public class class35 extends class85 {
    ...
    @OriginalMember(owner = "client!dd", name = "Q", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Ljava/lang/String;I)Llf;")
