...
public class class35 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IILnq;III)Lld;", line = 34)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILuu;Luu;Luu;Luu;)V", line = 56)
