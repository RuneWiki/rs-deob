...
public class class35 extends class82 {
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IILos;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IZIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "()V", line = 210)
    public class35() {
        this(4096);
    }

    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(II)[I", line = 214)
