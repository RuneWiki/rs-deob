...
public abstract class class35 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IZI)I", line = 17)
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(II)I", line = 107)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIIIII)V", line = 121)
