...
public class class35 extends class30 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lmo;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Ltm;I)I", line = 16)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IB)[I", line = 43)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II)I", line = 96)
    public static int method227(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIZIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Ljg;II)V", line = 135)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IZLne;II)V", line = 155)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "()V", line = 286)
    public class35() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIB)V", line = 263)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Le;Lbr;ZLel;)V", line = 299)
