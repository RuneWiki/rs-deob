...
public class class35 extends class409 {
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 250)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(III)V", line = 280)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(IIIIIII)V", line = 300)
