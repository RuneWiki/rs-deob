...
public class class35 extends class29 implements Runnable {
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "g", descriptor = "LVLLJSJTJ;")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "n", descriptor = "LVLLJSJTJ;")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "G", descriptor = "LLAPJVQGB;")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "M", descriptor = "LVLLJSJTJ;")
    private class54 field1006 = new class54((byte) 3);

    @OriginalMember(owner = "client!LNOSHUMO", name = "N", descriptor = "LVLLJSJTJ;")
    private class54 field1007 = new class54((byte) 3);

    @OriginalMember(owner = "client!LNOSHUMO", name = "P", descriptor = "LVLLJSJTJ;")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "p", descriptor = "LMFGDOVSO;")
    private class38 field983;

    @OriginalMember(owner = "client!LNOSHUMO", name = "I", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "a", descriptor = "(LXRWUKRPO;Lclient;)V")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "c", descriptor = "()LMFGDOVSO;")
    ...
    @OriginalMember(owner = "client!LNOSHUMO", name = "a", descriptor = "(ILMFGDOVSO;)V")
