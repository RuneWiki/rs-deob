...
public class class35 extends class5 {
    ...
    @OriginalMember(owner = "client!pc", name = "i", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)[I", line = 54)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILes;I)V", line = 264)
    ...
    @OriginalMember(owner = "client!pc", name = "j", descriptor = "(I)V", line = 346)
