...
public class class35 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)Lefa;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lag;II)V")
