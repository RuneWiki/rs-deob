...
public class class35 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIZIZII)V", line = 11)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(IIIIB)V", line = 250)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lnr;I)V", line = 261)
