...
public class class35 extends class147 {
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(CB)Z", line = 165)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ldb;I)Z", line = 190)
