...
public abstract class class35 {
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Lgj;BLjq;Lqa;)V", line = 68)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(III)V", line = 217)
