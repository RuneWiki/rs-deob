...
public class class35 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIZ)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "([BI)V", line = 42)
