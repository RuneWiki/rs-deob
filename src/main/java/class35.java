...
public class class35 extends class48 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lna;)V", line = 54)
    public final void method71(class50 arg0) {
        this.field480.method2032(arg0);
    }

    @OriginalMember(owner = "client!on", name = "b", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)V", line = 72)
    public final void method70(boolean arg0) {
    }

    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lql;Lbo;)V", line = 74)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "()Z", line = 112)
