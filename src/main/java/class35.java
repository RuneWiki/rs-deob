...
public abstract class class35 implements class506 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lvp;Z)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lgca;I)V")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lom;ILlw;Lal;IZ)V")
