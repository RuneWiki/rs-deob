...
public class class35 extends class377 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BI)Z", line = 58)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 69)
    public class35() {
        super(1, false);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILji;)V", line = 74)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(I)V", line = 107)
    public static final void method234(int arg0) {
        class347.field4463 = class98.method720(0.4F, 4, arg0 + -7, true, 35, arg0, 8, 2048);
        ++field526;
    }

    @OriginalMember(owner = "client!be", name = "e", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IB)[[I", line = 185)
