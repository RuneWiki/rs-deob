...
public class class35 extends class376 {
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILeb;)Lpp;", line = 21)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "([B)V", line = 62)
