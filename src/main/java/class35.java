...
public class class35 extends class112 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILha;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(II)I", line = 42)
    public static final int method315(int arg0, int arg1) {
        return class406.field5335 == null ? 0 : class406.field5335[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 68)
    public static void method317(int arg0) {
        int var1 = 45 % ((-arg0 - 14) / 45);
        field530 = null;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILbt;)V", line = 82)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(B)V", line = 109)
