...
public class class35 {
    ...
    @OriginalMember(owner = "client!uja", name = "b", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!uja", name = "c", descriptor = "(Lha;Luja;)V", line = 14)
    ...
    @OriginalMember(owner = "client!uja", name = "d", descriptor = "(Lha;Luja;)Z", line = 100)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Lha;IIIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "()V", line = 159)
    public static final void method351() {
        field407 = null;
        field416 = null;
    }

    @OriginalMember(owner = "client!uja", name = "c", descriptor = "()V", line = 163)
    public final void method352() {
        this.field402 = null;
    }

    @OriginalMember(owner = "client!uja", name = "b", descriptor = "(Lha;Luja;)Z", line = 172)
    public final boolean method353(class63 arg0, class35 arg1) {
        return this.field402 != null || this.method349(arg0, arg1);
    }

    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Lha;)V", line = 179)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Lha;Luja;)V", line = 244)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(IIII)Z", line = 332)
    ...
    @OriginalMember(owner = "client!uja", name = "b", descriptor = "(Lha;)V", line = 393)
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 472)
