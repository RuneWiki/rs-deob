...
public abstract class class35 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIIZ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(III)V", line = 85)
