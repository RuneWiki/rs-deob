...
public class class35 extends class739 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lsl;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(BI)[[I", line = 48)
    ...
    @OriginalMember(owner = "client!wv", name = "e", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "()V", line = 144)
    public class35() {
        super(1, false);
    }
}
