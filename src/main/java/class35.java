...
public class class35 extends class154 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BII[I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II[II)V", line = 24)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IBII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)Z", line = 54)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BII)Z", line = 74)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 89)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(IIIIIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(III)Z", line = 120)
