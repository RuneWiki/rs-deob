...
public class class35 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lbd;Ljava/awt/Frame;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "([BB)Z", line = 71)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZLtg;J)V", line = 96)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(JB)Ltg;", line = 129)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(I)V", line = 177)
