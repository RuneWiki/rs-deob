...
public class class35 extends class185 {
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLjava/lang/String;)V", line = 32)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLat;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I[FFIZFIIFFI)V", line = 87)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBI)V", line = 178)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 193)
