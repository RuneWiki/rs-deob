...
public class class35 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLvc;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Lro;", line = 116)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)V", line = 127)
