...
@OriginalClass("client!NXLHMSCV")
public class class35 {

    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "Z")
    private boolean field1172 = false;

    @OriginalMember(owner = "client!NXLHMSCV", name = "d", descriptor = "I")
    private int field1175 = 732;

    @OriginalMember(owner = "client!NXLHMSCV", name = "e", descriptor = "B")
    private byte field1176 = -31;

    @OriginalMember(owner = "client!NXLHMSCV", name = "f", descriptor = "Z")
    private boolean field1177 = true;

    @OriginalMember(owner = "client!NXLHMSCV", name = "g", descriptor = "I")
    public int field1178 = 0;

    @OriginalMember(owner = "client!NXLHMSCV", name = "h", descriptor = "I")
    public int field1179 = 0;

    @OriginalMember(owner = "client!NXLHMSCV", name = "i", descriptor = "I")
    public int field1180;

    @OriginalMember(owner = "client!NXLHMSCV", name = "j", descriptor = "I")
    public int field1181;

    @OriginalMember(owner = "client!NXLHMSCV", name = "k", descriptor = "[[I")
    public int[][] field1182;

    @OriginalMember(owner = "client!NXLHMSCV", name = "b", descriptor = "I")
    private int field1173;

    @OriginalMember(owner = "client!NXLHMSCV", name = "c", descriptor = "I")
    private int field1174;

    @OriginalMember(owner = "client!NXLHMSCV", name = "<init>", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IIIIZI)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "b", descriptor = "(III)V")
    private void method358(int arg0, int arg1, int arg2) {
        this.field1182[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IZIZII)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IIIZIII)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IZI)V")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "b", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!NXLHMSCV", name = "a", descriptor = "(IIIIIZII)Z")
