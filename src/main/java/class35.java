...
public class class35 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BII)I", line = 21)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZII)Z", line = 37)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(III)Z", line = 215)
