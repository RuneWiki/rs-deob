...
public class class35 extends class212 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lae;B)V")
