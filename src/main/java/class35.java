...
public class class35 extends class14 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!be", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 9)
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!be", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 36)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field441++;
        this.method166(119, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!be", name = "d", descriptor = "(I)Lqea;", line = 46)
    public final class113 method72(int arg0) {
        field430++;
        return arg0 == -49 ? (class113) this.field435.method1272(0) : null;
    }

    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)Z", line = 57)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IB)V", line = 70)
    ...
    @OriginalMember(owner = "client!be", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 89)
    ...
    @OriginalMember(owner = "client!be", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 124)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field425++;
        this.method166(61, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!be", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 134)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(I)I", line = 162)
    public final int method66(int arg0) {
        field442++;
        return arg0 == 74 ? this.field429 : 120;
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 173)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(B)I", line = 198)
    ...
    @OriginalMember(owner = "client!be", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 208)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method166(40, arg0.getX(), arg0.getY());
        field423++;
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)Z", line = 217)
    ...
    @OriginalMember(owner = "client!be", name = "g", descriptor = "(B)V", line = 229)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BIII)V", line = 274)
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!be", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 304)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field432++;
        this.method166(92, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(III)V", line = 312)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 330)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 378)
