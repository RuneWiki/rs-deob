...
public class class35 extends class634 {
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lig;B)Laca;", line = 247)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZZLjava/lang/String;I)Z", line = 269)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILig;Z)V", line = 345)
    ...
    @OriginalMember(owner = "client!ud", name = "f", descriptor = "(I)V", line = 384)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lrr;Z[[[BIB)Z", line = 399)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "()V", line = 783)
    public class35() {
        super(2, false);
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BI)[[I", line = 465)
