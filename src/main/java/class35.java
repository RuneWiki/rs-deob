...
public class class35 implements class336 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lui;IJ[I)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZLie;)Ljava/lang/String;", line = 60)
