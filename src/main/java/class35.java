...
public class class35 extends class577 implements class522 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "([SII)[S", line = 3)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)J", line = 29)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIII)I", line = 42)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "([BIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lqo;I[BI)V", line = 93)
