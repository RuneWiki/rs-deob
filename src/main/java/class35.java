...
public class class35 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lof;B)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZLof;)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lvi;Lvi;Z)V")
