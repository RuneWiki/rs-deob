...
public class class35 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lbb;I)V")
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)Lpn;")
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(I)Lpn;")
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lbb;)V")
