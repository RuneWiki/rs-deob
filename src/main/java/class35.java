...
public class class35 {
    ...
    @OriginalMember(owner = "client!MKJLFPRH", name = "n", descriptor = "LJETHVCIV;")
    ...
    @OriginalMember(owner = "client!MKJLFPRH", name = "f", descriptor = "LOXBPHQKK;")
    public class42 field1202;

    @OriginalMember(owner = "client!MKJLFPRH", name = "b", descriptor = "[LMKJLFPRH;")
    public static class35[] field1198;

    @OriginalMember(owner = "client!MKJLFPRH", name = "a", descriptor = "(LMNPBQFWE;B)V")
    ...
    @OriginalMember(owner = "client!MKJLFPRH", name = "a", descriptor = "(ILBJPWOXRJ;)V")
    ...
    @OriginalMember(owner = "client!MKJLFPRH", name = "a", descriptor = "()LJLNSJQDR;")
