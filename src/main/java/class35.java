...
public class class35 extends class397 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IBLts;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IBLae;)V", line = 37)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(II)[I", line = 50)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "()V", line = 111)
    public class35() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 121)
