...
public abstract class class35 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lpe;BILpe;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(I)V", line = 78)
