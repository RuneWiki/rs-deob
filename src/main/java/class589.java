...
public class class589 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILfd;)V", line = 8)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IBI)Z", line = 31)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lfd;IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(B)V", line = 103)
