...
public abstract class class589 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(DI)V", line = 76)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(B)V", line = 90)
