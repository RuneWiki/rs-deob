...
public class class589 extends class528 {
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BII)V", line = 52)
    ...
    @OriginalMember(owner = "client!saa", name = "d", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!saa", name = "e", descriptor = "(B)Lis;", line = 79)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(III)V", line = 102)
