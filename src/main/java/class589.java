...
public class class589 {
    ...
    @OriginalMember(owner = "client!via", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!via", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(I[BLjava/io/File;I)V", line = 68)
