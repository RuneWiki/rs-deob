...
public class class589 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lha;Z)Lmi;", line = 7)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lha;I)Lmi;", line = 32)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lha;B)Lmi;", line = 82)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lcea;II)V", line = 117)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Lha;I)V", line = 195)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Lha;B)Lmi;", line = 278)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILcea;)V", line = 313)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)Ljava/lang/String;", line = 343)
