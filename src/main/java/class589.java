...
public class class589 implements class483 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILjaclib/memory/Source;IB)Z")
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Loe;Z)V")
