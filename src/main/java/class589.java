...
public class class589 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B[S)[S", line = 61)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZI)I", line = 131)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "([BZ)[B", line = 167)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(II)V", line = 233)
