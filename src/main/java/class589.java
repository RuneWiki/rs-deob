...
public class class589 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILgw;)Lpca;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lpm;Z)V")
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(B)Lpm;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)Lpm;")
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)Lpm;")
