...
public class class589 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BLji;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lji;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILni;Ld;ILjava/awt/Canvas;)Lha;", line = 365)
