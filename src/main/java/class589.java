...
public class class589 implements class318 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ljava/lang/String;IIILda;I)I")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lwfa;Lwfa;I)V")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lul;Lqa;)V")
