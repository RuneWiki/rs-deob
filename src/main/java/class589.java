...
public class class589 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)Liu;", line = 3)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZI)[I", line = 24)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)[Lpr;", line = 54)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 68)
