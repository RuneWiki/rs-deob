...
public class class589 extends class529 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/lang/String;Z)[B", line = 4)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIIZIILrl;I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!pm", name = "f", descriptor = "(I)V", line = 499)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(II)V", line = 515)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "()V", line = 561)
    public class589() {
        super(1, true);
    }

    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(IB)Z", line = 567)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IB)[I", line = 585)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z)V", line = 622)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZII)Z", line = 920)
