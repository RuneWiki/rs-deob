...
public class class589 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lrt;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lrt;IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)Laf;", line = 60)
