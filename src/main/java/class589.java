...
public class class589 extends class260 {
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!sp", name = "l", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IILr;)V", line = 119)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(IIIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(ILr;)Lod;", line = 247)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IBZIII)V", line = 377)
    ...
    @OriginalMember(owner = "client!sp", name = "f", descriptor = "(B)V", line = 460)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZILr;I)Z", line = 471)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BLr;)Lll;", line = 527)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIILr;ZILpn;)V", line = 538)
    ...
    @OriginalMember(owner = "client!sp", name = "e", descriptor = "(B)Z", line = 552)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B)I", line = 567)
    ...
    @OriginalMember(owner = "client!sp", name = "p", descriptor = "(I)Z", line = 592)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BLms;)V", line = 604)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lr;II)Z", line = 624)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lr;Z)V", line = 798)
    ...
    @OriginalMember(owner = "client!sp", name = "i", descriptor = "(B)V", line = 829)
    ...
    @OriginalMember(owner = "client!sp", name = "q", descriptor = "(I)V", line = 845)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(B)I", line = 872)
    ...
    @OriginalMember(owner = "client!sp", name = "r", descriptor = "(I)Z", line = 892)
