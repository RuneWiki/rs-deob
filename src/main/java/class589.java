...
public class class589 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IILee;)V", line = 4)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lee;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lfha;ILwd;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "()V", line = 426)
