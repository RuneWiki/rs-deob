...
public class class589 extends class56 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILee;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IZ)[I", line = 39)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "()V", line = 111)
    public class589() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IB)V", line = 97)
