...
public class class589 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IBLvj;)V")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IIIILad;)V")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Lvj;B)V")
    ...
    @OriginalMember(owner = "client!rha", name = "b", descriptor = "(I)Lkda;")
    ...
    @OriginalMember(owner = "client!rha", name = "c", descriptor = "(I)Lkda;")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IZI)Ljl;")
