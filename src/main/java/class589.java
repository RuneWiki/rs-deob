...
public class class589 extends class116 implements class439 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(La;Lc;[IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILpa;II)V", line = 34)
    public final void method236(int arg0, int arg1, class594 arg2, int arg3, int arg4) {
        this.method3434(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(La;Lc;IIII)V", line = 37)
