...
public class class589 extends class263 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILoa;IILws;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZLoa;BI)Lta;", line = 49)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILvw;B)V", line = 80)
