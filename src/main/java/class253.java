...
public class class253 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IBLji;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLpfa;Lpfa;[I)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lji;I)V")
