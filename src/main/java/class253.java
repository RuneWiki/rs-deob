...
public class class253 extends class232 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(II)[[I", line = 25)
    ...
    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IB)[I", line = 202)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILwq;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B[B)V", line = 272)
