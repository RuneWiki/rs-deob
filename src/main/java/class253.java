...
public class class253 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)Lds;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILza;IIZZLza;ILla;Lfd;II)Lo;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lfd;IIILza;III)Lo;")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lkp;IZLqr;Lph;Lph;)V")
