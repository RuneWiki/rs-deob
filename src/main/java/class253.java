...
public class class253 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILdf;)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILhm;)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Ltq;B)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)Lte;")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Ldf;B)V")
