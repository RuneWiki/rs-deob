...
public class class253 extends class136 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IILiv;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)[I", line = 91)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "()V", line = 214)
    public class253() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(FFFFILge;IBFII)[B", line = 199)
    ...
    @OriginalMember(owner = "client!mv", name = "f", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!mv", name = "g", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z)V", line = 301)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZZII)I", line = 316)
