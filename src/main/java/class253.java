...
public class class253 extends class233 {
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lih;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "()V", line = 148)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "()V", line = 212)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Ldg;)V", line = 232)
    public final void method825(class223 arg0) {
        this.field3283.method2186(arg0);
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 236)
    public final void method827(boolean arg0) {
        this.field3283.method2109(8448, 7681);
    }

    @OriginalMember(owner = "client!ln", name = "b", descriptor = "()Z", line = 239)
