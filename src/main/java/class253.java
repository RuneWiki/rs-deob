...
public class class253 extends class271 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILqn;IIIB)Ljava/awt/Frame;", line = 7)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILgh;Lgh;F)Z", line = 75)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)I", line = 209)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)Lgh;", line = 221)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lrl;I)V", line = 251)
