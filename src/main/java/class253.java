...
public class class253 extends class666 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILlt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "h", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IB)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(FIZBIIIII)[[I", line = 134)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILiaa;Z)V", line = 166)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "()V", line = 232)
    public class253() {
        super(1, false);
    }

    @OriginalMember(owner = "client!s", name = "i", descriptor = "(I)Lss;", line = 212)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILjava/lang/String;ZZ)Z", line = 235)
