...
public class class253 extends class179 {
    ...
    @OriginalMember(owner = "client!gi", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IBIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Ljava/lang/String;ZI)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IBI)V", line = 64)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(III)I", line = 91)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZILec;)V", line = 109)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILec;)V", line = 171)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(III)V", line = 193)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIZII)V", line = 214)
