...
public class class253 extends class446 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Luo;Lrr;IIIII)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BIZIZ)Lnq;")
