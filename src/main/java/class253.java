...
public class class253 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)Ljava/io/File;", line = 5)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)J", line = 16)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II[BB)V", line = 26)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([BIII)I", line = 43)
    ...
    @OriginalMember(owner = "client!jc", name = "finalize", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IJ)V", line = 88)
