...
public class class253 implements Runnable {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!gca", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!gca", name = "run", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "([BZII)I", line = 127)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)Z", line = 176)
