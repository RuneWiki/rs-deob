...
public class class253 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZLoa;IZIIZ)Lba;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILq;Loa;IIIIZLba;)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Loa;Llt;IIIIIIZI)V")
