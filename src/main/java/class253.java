...
public class class253 extends class296 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IBII)Lta;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/awt/Graphics;III)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/awt/Canvas;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lqh;I)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/awt/Graphics;IIBI)V")
