...
public class class253 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIB)I", line = 44)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLuba;)V", line = 73)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IB)Luba;", line = 91)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Luba;)V", line = 103)
    public class253(class397 arg0) {
        this.field3456 = arg0.field5600;
        this.field3454 = 1;
    }

    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(IB)I", line = 112)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "([Luba;)V", line = 122)
    public class253(class397[] arg0) {
