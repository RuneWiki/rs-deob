...
public class class253 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIBIIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)Z", line = 169)
