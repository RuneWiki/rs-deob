...
public class class253 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILdc;)V", line = 15)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(III)V", line = 62)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 98)
