...
public class class253 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(III)Let;", line = 6)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IILjava/lang/String;Lpc;)Lqba;", line = 29)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Les;BI)V", line = 68)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ILes;)V", line = 95)
