...
public class class253 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Llk;)V", line = 16)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(Llk;)V", line = 42)
