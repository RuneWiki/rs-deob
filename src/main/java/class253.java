...
public class class253 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lwm;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lwm;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lwm;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lwm;IZLjava/awt/Component;)V")
