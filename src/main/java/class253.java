...
public class class253 extends class154 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lgj;I)Ltea;")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lgj;II)Ltea;")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lgj;)Z")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "([I)Lrea;")
