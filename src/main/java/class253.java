...
public class class253 extends class334 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILlc;)V", line = 5)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZILoba;Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!os", name = "U", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lbha;Lkb;)Ltha;", line = 107)
    public final class296 method134(class545 arg0, class102 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/awt/Canvas;I)Ljava/lang/Object;", line = 114)
    public final Object method2065(Canvas arg0, int arg1) {
        return arg1 == 0 ? null : (Object) null;
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILcb;)I", line = 149)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Loba;I)I", line = 183)
    ...
    @OriginalMember(owner = "client!os", name = "O", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!os", name = "db", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZI)Luba;", line = 255)
    ...
    @OriginalMember(owner = "client!os", name = "g", descriptor = "(II)Lbha;", line = 268)
    public final class545 method179(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!os", name = "w", descriptor = "()V", line = 274)
    public final void method163() {
    }

    @OriginalMember(owner = "client!os", name = "A", descriptor = "()Z", line = 277)
    public final boolean method217() {
        return false;
    }

    @OriginalMember(owner = "client!os", name = "x", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!os", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Llga;Ljava/lang/Integer;)Lha;", line = 323)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[FIIIZILhh;)Lcf;", line = 422)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lsn;Lsn;FLsn;)Lsn;", line = 432)
    public final class369 method155(class369 arg0, class369 arg1, float arg2, class369 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lcb;IILuba;III)V", line = 442)
    ...
    @OriginalMember(owner = "client!os", name = "w", descriptor = "(I)V", line = 459)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 470)
    ...
    @OriginalMember(owner = "client!os", name = "v", descriptor = "()Lcba;", line = 480)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZLtk;)V", line = 488)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIZ[III)Lcf;", line = 513)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lhh;Lon;Z)Z", line = 524)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[Luc;)Lot;", line = 535)
    public final class218 method2080(int arg0, class121[] arg1) {
        return arg0 <= 57 ? (class218) null : new dxVertexLayout(this, arg1);
    }

    @OriginalMember(owner = "client!os", name = "r", descriptor = "(B)V", line = 545)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILon;Lhh;)Z", line = 564)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II[[IZ)Lnm;", line = 575)
    ...
    @OriginalMember(owner = "client!os", name = "K", descriptor = "(I)V", line = 585)
    ...
    @OriginalMember(owner = "client!os", name = "g", descriptor = "(B)V", line = 596)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILkl;)I", line = 611)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ltd;Z)I", line = 641)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lbl;IZ)V", line = 659)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;I)V", line = 671)
    ...
    @OriginalMember(owner = "client!os", name = "m", descriptor = "(B)V", line = 684)
    ...
    @OriginalMember(owner = "client!os", name = "x", descriptor = "()V", line = 695)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIII)V", line = 718)
    public final void method151(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!os", name = "F", descriptor = "(I)V", line = 722)
    ...
    @OriginalMember(owner = "client!os", name = "s", descriptor = "(I)V", line = 733)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILhh;III[B)Ljca;", line = 748)
    ...
    @OriginalMember(owner = "client!os", name = "n", descriptor = "(Z)V", line = 758)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(B)F", line = 779)
    public final float method2095(byte arg0) {
        return arg0 == -111 ? -0.5F : -0.40783522F;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZZBLoba;I)V", line = 791)
    ...
    @OriginalMember(owner = "client!os", name = "u", descriptor = "()V", line = 835)
    public final void method135() {
    }

    @OriginalMember(owner = "client!os", name = "d", descriptor = "(I)V", line = 838)
    ...
    @OriginalMember(owner = "client!os", name = "V", descriptor = "(I)V", line = 848)
    ...
    @OriginalMember(owner = "client!os", name = "na", descriptor = "(IIII)[I", line = 879)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLon;Lhh;)I", line = 919)
    ...
    @OriginalMember(owner = "client!os", name = "gb", descriptor = "(I)V", line = 956)
    ...
    @OriginalMember(owner = "client!os", name = "I", descriptor = "()I", line = 967)
    public final int method139() {
        return 0;
    }

    @OriginalMember(owner = "client!os", name = "r", descriptor = "()V", line = 974)
    public final void method234() {
    }

    @OriginalMember(owner = "client!os", name = "F", descriptor = "(II)V", line = 976)
    public final void method149(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!os", name = "e", descriptor = "()V", line = 979)
    public final void method238() {
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BZ)V", line = 982)
    ...
    @OriginalMember(owner = "client!os", name = "t", descriptor = "(I)V", line = 992)
    ...
    @OriginalMember(owner = "client!os", name = "ya", descriptor = "()V", line = 1004)
    public final void method225() {
        this.method2628(1, true);
        this.field3618.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lcb;III)V", line = 1013)
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(B)V", line = 1028)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLjl;)V", line = 1069)
    ...
    @OriginalMember(owner = "client!os", name = "d", descriptor = "(II)Lkb;", line = 1093)
    public final class102 method191(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!os", name = "h", descriptor = "()V", line = 1102)
    public final void method167() {
        this.field3621.method3183(-128);
        super.method167();
    }

    @OriginalMember(owner = "client!os", name = "h", descriptor = "(B)V", line = 1111)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(II)V", line = 1123)
    ...
    @OriginalMember(owner = "client!os", name = "i", descriptor = "(I)V", line = 1149)
    public final synchronized void method175(int arg0) {
        this.field3621.method3186(-15351);
        super.method175(arg0);
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIILjagdx/D3DPRESENT_PARAMETERS;Ljagdx/IDirect3D;Z)Z", line = 1158)
    ...
    @OriginalMember(owner = "client!os", name = "j", descriptor = "(B)V", line = 1262)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(FFF)V", line = 1271)
    public final void method160(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!os", name = "L", descriptor = "(I)V", line = 1276)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "()Z", line = 1287)
    public final boolean method164() {
        return false;
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(IIIID)V", line = 1293)
    public final void method174(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!os", name = "q", descriptor = "(I)V", line = 1296)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Z)V", line = 1308)
    public final void method146(boolean arg0) {
    }

    @OriginalMember(owner = "client!os", name = "t", descriptor = "(B)Z", line = 1311)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILpda;)V", line = 1352)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 1390)
    ...
    @OriginalMember(owner = "client!os", name = "y", descriptor = "(I)V", line = 1400)
    ...
    @OriginalMember(owner = "client!os", name = "p", descriptor = "(B)V", line = 1412)
    public final void method2115(byte arg0) {
        this.field3618.method3143(15, this.field4766);
        int var2 = 90 / ((29 - arg0) / 56);
    }

    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/io;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lod;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Llga;I)V", line = 1534)
    ...
    @OriginalMember(owner = "client!os", name = "G", descriptor = "(I)V", line = 1424)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 1439)
    public final void method224(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class142 {
        this.method132(arg2, arg3);
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(ZI)Lbl;", line = 1446)
    public final class719 method2117(boolean arg0, int arg1) {
        return arg1 == 16 ? new class300(this, arg0) : (class719) null;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V", line = 1456)
    ...
    @OriginalMember(owner = "client!os", name = "B", descriptor = "(I)V", line = 1469)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lot;I)V", line = 1484)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lhh;IIILon;)Lcf;", line = 1495)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILtka;)I", line = 1506)
    ...
    @OriginalMember(owner = "client!os", name = "E", descriptor = "(I)V", line = 1583)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ltha;)V", line = 1621)
    public final void method165(class296 arg0) {
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BI)V", line = 1624)
    ...
    @OriginalMember(owner = "client!os", name = "H", descriptor = "(I)V", line = 1637)
    public final void method2125(int arg0) {
        this.field3618.SetTransform(3, this.field4792);
        int var2 = -75 / ((30 - arg0) / 53);
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZIB[BILhh;II)Lcf;", line = 1648)
    ...
    @OriginalMember(owner = "client!os", name = "GA", descriptor = "(I)V", line = 1658)
    public final void method243(int arg0) {
        this.field3618.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(BI)Loo;", line = 1665)
