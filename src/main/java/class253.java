...
public abstract class class253 {
    ...
    @OriginalMember(owner = "client!ti", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() throws Throwable {
        this.field4117.method662(this.field4115, this.field4120);
        super.finalize();
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "()I", line = 16)
    public int method85() {
        return this.field4115;
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "([BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lsq;I[BIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lsq;ILjava/nio/ByteBuffer;Z)V", line = 56)
