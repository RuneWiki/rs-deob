...
public class class253 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "([BII[BIB)I", line = 17)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III[BI[B)I", line = 108)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIZ)Ljava/lang/String;", line = 258)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "([B)V", line = 275)
