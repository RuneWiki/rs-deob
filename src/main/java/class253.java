...
public class class253 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLdh;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IB)Z", line = 72)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 97)
    public static void method1702(byte arg0) {
        field3769 = null;
        int var1 = 74 % ((arg0 + 30) / 43);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLdh;)V", line = 108)
