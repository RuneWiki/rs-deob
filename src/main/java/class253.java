...
public class class253 extends class5 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I[ILen;[IIB)Lao;", line = 7)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(II)[I", line = 67)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IZ)[[I", line = 98)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(II)Z", line = 144)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "()V", line = 156)
    public class253() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(IIII)I", line = 160)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IB)[B", line = 211)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ILes;I)V", line = 259)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(IZ)V", line = 273)
