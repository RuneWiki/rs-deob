...
public class class253 extends class83 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III)V", line = 89)
