...
public class class253 extends class695 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZB)V", line = 15)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lfc;)V", line = 36)
    public class253(class575 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lnm;ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)V", line = 65)
    ...
    @OriginalMember(owner = "client!av", name = "e", descriptor = "(I)V", line = 77)
