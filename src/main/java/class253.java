...
public class class253 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I[BII)V", line = 51)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)Ljava/io/File;", line = 178)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IZ)V", line = 193)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lwr;II)V", line = 590)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(III[B)V", line = 351)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)J", line = 536)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I[B)V", line = 552)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IJ)V", line = 608)
