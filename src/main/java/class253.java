...
public class class253 extends class683 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Ldt;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Lhr;B)V", line = 51)
