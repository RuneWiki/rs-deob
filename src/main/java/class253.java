...
public class class253 implements Runnable {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljj;Ljava/lang/String;IJZ)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILdca;)V")
    ...
    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(I)Ljj;")
