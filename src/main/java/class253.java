...
public class class253 extends class46 implements class9 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lae;IZ)Lbk;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lae;ZI)Lbk;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZBIILna;ILae;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lae;Ljh;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lae;BZI)Lsk;")
