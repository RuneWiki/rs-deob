...
public class class253 extends class496 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IBIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IB)V", line = 122)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIB)V", line = 131)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(IB)V", line = 146)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)V", line = 159)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IFIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lk;III[Z)Z", line = 297)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "([III)V", line = 333)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)Z", line = 492)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Leo;IIIII)V", line = 514)
