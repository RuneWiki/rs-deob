...
public class class253 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)Lqp;")
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(II)Ld;")
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Llf;ILvh;Lvh;Lvh;)V")
