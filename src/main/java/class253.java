...
public class class253 extends class120 {
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lfu;)V", line = 3)
    public class253(class42 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eg", name = "d", descriptor = "()I", line = 10)
    public final int method934() {
        return 1;
    }

    @OriginalMember(owner = "client!eg", name = "c", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "()Z", line = 108)
    public final boolean method927() {
        return this.field3634 != null;
    }

    @OriginalMember(owner = "client!eg", name = "e", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ILuo;Luo;)V", line = 123)
    ...
    @OriginalMember(owner = "client!eg", name = "e", descriptor = "()Z", line = 270)
    public final boolean method1721() {
        return this.field1657.field693 && this.field1657.field677 && this.field1657.field676;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "()Z", line = 274)
