...
public class class253 extends class168 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(II)V", line = 196)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(II[I)V", line = 209)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(BI)V", line = 332)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIIF)V", line = 345)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIII)V", line = 454)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(II)V", line = 468)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Led;IIIII)V", line = 485)
