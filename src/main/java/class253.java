...
public class class253 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)Loq;", line = 16)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 63)
    public final void method1508(int arg0) {
        field3047++;
        this.field3048.method3539((byte) 123, arg0);
    }

    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lln;Ld;)V", line = 97)
