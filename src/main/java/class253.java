...
public class class253 extends class416 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILpba;ZI)V", line = 35)
