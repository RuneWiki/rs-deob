...
public abstract class class253 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)Z", line = 12)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIILje;)V", line = 141)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(Z)Z", line = 157)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 268)
