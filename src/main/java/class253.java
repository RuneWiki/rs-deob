...
public class class253 extends class196 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IBI)Lnn;")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)Lfv;")
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(ILsk;Lsk;Lvf;Ld;IIZ)V")
