...
public class class253 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILek;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z)Z", line = 29)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZILr;)Lf;", line = 56)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lek;B)V", line = 104)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lr;B)V", line = 134)
