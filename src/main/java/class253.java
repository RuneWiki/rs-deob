...
public class class253 extends class116 implements class503 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I[Ll;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lya;B)Lmf;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BLsk;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lya;IZLij;III)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BLya;I)Lt;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lya;Ljo;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(ILya;)V")
