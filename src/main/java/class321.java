...
public class class321 extends class682 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IILoga;[I[I[I[I)V")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lam;[I)V")
    public final void method1367(class289 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!wa", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!wa", name = "v", descriptor = "(IILha;)Lha;")
    ...
    @OriginalMember(owner = "client!wa", name = "DA", descriptor = "(Lha;IIIIZ)V")
    public final void method1376(class427 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIIIII[[ZLqm;Loga;[I[I)V")
                    ...
                    if (this.field4455[var18][var19] != null) {
                        ...
                        for (int var25 = 0; var25 < var23.field6803; ++var25) {
                            ...
                            if (var23.field6806 == null || var23.field6806[var25] == 0 || var23.field6798 != null && (var23.field6798 == null || var23.field6798[var25] != -1)) {
                                if (var23.field6798 != null && var23.field6798[var25] != -1) {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIZLqm;Loga;[I[I[I[I)V")
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(IIIIIII[[ZLqm;Loga;[I[I)V")
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lve;IIII[[I[[II)V")
