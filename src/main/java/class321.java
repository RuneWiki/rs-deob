...
public class class321 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IBI[B)I", line = 24)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I[BIII[BIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)Lnc;", line = 98)
