...
public abstract class class321 implements class184 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lmm;IIIZ)V")
