...
public class class321 extends class184 {
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 352)
    public class321() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BILfh;)V", line = 45)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(II)[I", line = 88)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILjava/lang/String;III)V", line = 227)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(Z)V", line = 358)
