...
public class class321 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Laa;Z)Z", line = 181)
