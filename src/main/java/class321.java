...
public class class321 {
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)V", line = 104)
