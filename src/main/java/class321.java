...
public class class321 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIB)Z", line = 32)
