...
public class class321 extends class34 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BIII)Lep;", line = 19)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(III)V", line = 101)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILlm;)V", line = 134)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(III)V", line = 573)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(IIII)I", line = 588)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(I)V", line = 614)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(III)V", line = 639)
