...
public abstract class class321 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!si", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "destroy", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!si", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 35)
    public final void windowActivated(WindowEvent arg0) {
        field4320++;
    }

    @OriginalMember(owner = "client!si", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 45)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!si", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 100)
    public final void update(Graphics arg0) {
        field4321++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!si", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 163)
    public final void windowOpened(WindowEvent arg0) {
        field4318++;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZZ)V", line = 172)
    ...
    @OriginalMember(owner = "client!si", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 249)
    public final void windowClosed(WindowEvent arg0) {
        field4317++;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)Lth;", line = 260)
    ...
    @OriginalMember(owner = "client!si", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 289)
    ...
    @OriginalMember(owner = "client!si", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 306)
    ...
    @OriginalMember(owner = "client!si", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 315)
    public final void windowDeiconified(WindowEvent arg0) {
        field4341++;
    }

    @OriginalMember(owner = "client!si", name = "b", descriptor = "(B)V", line = 324)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIZ)Lsb;", line = 342)
    ...
    @OriginalMember(owner = "client!si", name = "start", descriptor = "()V", line = 403)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIZI)V", line = 414)
    ...
    @OriginalMember(owner = "client!si", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 462)
    ...
    @OriginalMember(owner = "client!si", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 480)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Z)V", line = 496)
    ...
    @OriginalMember(owner = "client!si", name = "stop", descriptor = "()V", line = 542)
    ...
    @OriginalMember(owner = "client!si", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 555)
    public final void focusLost(FocusEvent arg0) {
        class426.field6025 = false;
        field4351++;
    }

    @OriginalMember(owner = "client!si", name = "run", descriptor = "()V", line = 563)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIILjava/lang/String;ZIII)V", line = 679)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)V", line = 721)
    ...
    @OriginalMember(owner = "client!si", name = "e", descriptor = "(I)Z", line = 771)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(Z)V", line = 813)
    ...
    @OriginalMember(owner = "client!si", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 846)
    public final void windowDeactivated(WindowEvent arg0) {
        field4329++;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lrk;ILrk;Lrk;)V", line = 853)
    ...
    @OriginalMember(owner = "client!si", name = "providesignlink", descriptor = "(Lbd;)V", line = 865)
    ...
    @OriginalMember(owner = "client!si", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 878)
    public final void windowIconified(WindowEvent arg0) {
        field4343++;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 887)
    ...
    @OriginalMember(owner = "client!si", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 914)
