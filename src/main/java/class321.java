...
public class class321 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(JB)V", line = 4)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IB)Lnb;", line = 119)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(I)V", line = 146)
