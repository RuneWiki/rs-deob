...
public class class321 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/Class;", line = 25)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "([Lje;II)V", line = 68)
