...
public class class321 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 164)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(CII)C", line = 220)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lde;ILjava/lang/Object;)V", line = 308)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 339)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)V", line = 353)
