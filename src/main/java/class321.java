...
public class class321 extends class91 {
    ...
    @OriginalMember(owner = "client!of", name = "s", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "t", descriptor = "(I)V", line = 19)
    public final void method2077(int arg0) {
        this.field4926 = super.field1292 * arg0;
        ++field4927;
    }

    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(I)V", line = 35)
    public class321(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I[I)V", line = 40)
    ...
    @OriginalMember(owner = "client!of", name = "m", descriptor = "(B)I", line = 51)
    ...
    @OriginalMember(owner = "client!of", name = "d", descriptor = "(BI)I", line = 74)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "([BIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!of", name = "n", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!of", name = "n", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!of", name = "e", descriptor = "(BI)I", line = 139)
    ...
    @OriginalMember(owner = "client!of", name = "u", descriptor = "(I)V", line = 169)
