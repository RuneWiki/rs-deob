...
public class class321 extends class591 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILfaa;BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIZIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Len;IIII[BI)V", line = 112)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Len;IIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lbt;)V", line = 61)
