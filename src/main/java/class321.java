...
public class class321 extends class62 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lgw;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!dda", name = "g", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZLbq;BZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(II)[I", line = 118)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "()V", line = 191)
    public class321() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Z)V", line = 196)
