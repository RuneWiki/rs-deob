...
public class class321 extends class394 implements class175 {
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lnv;IIZ[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIII[BILpe;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lnv;Lpe;IIZ[FII)V", line = 41)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BF)F", line = 61)
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lkg;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZZB)V", line = 145)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lnv;Lpe;IIZ[BII)V", line = 157)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lnv;Lpe;Ldw;II)V", line = 178)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIII[IBI)V", line = 189)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILpe;IIIBI[FI)V", line = 216)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIII[IIBI)V", line = 235)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(II)V", line = 249)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)Z", line = 262)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IF)F", line = 274)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)I", line = 286)
    public final int method1197(int arg0) {
        ++field3980;
        return arg0 != 7676 ? -72 : this.field3983;
    }

    @OriginalMember(owner = "client!vt", name = "h", descriptor = "(I)V", line = 297)
