...
public class class321 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Lw;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IJ)Lw;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IZILro;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)Lc;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZJLw;)V")
