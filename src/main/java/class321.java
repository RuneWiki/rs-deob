...
public class class321 extends class57 {
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(Le;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lkk;IIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!md", name = "d", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILe;IIZLhm;I)V", line = 168)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)V", line = 179)
    ...
    @OriginalMember(owner = "client!md", name = "f", descriptor = "(I)I", line = 202)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IILe;)Lid;", line = 216)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ljd;I)V", line = 229)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIILe;)Z", line = 263)
    public final boolean method188(int arg0, int arg1, int arg2, class312 arg3) {
        ++field5010;
        return arg1 != 65536 ? false : false;
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Le;Z)Lum;", line = 277)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 343)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)Z", line = 331)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(III)V", line = 386)
    ...
    @OriginalMember(owner = "client!md", name = "finalize", descriptor = "()V", line = 411)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lid;Le;B)V", line = 425)
