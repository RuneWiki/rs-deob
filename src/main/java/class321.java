...
public class class321 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(II)[I", line = 20)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)I", line = 316)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lkh;)V", line = 339)
