...
public class class321 extends class428 {
    ...
    @OriginalMember(owner = "client!ca", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lln;BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!ca", name = "f", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Ltia;Lgda;Lb;)V", line = 107)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZI)V", line = 146)
