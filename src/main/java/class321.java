...
public class class321 extends class334 {
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IZLol;)V", line = 42)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IZI)Z", line = 123)
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "()V", line = 220)
    public class321() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(II)[I", line = 152)
    ...
    @OriginalMember(owner = "client!uca", name = "g", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(II)I", line = 226)
