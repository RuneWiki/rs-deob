...
public class class321 extends class469 {
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(II)[[I", line = 14)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 64)
