...
public class class321 extends class642 {
    ...
    @OriginalMember(owner = "client!uj", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BJ)I", line = 51)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)J", line = 84)
    public final long method1772(byte arg0) {
        return arg0 < 119 ? -89L : this.field4083;
    }

    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "()V", line = 117)
    public class321() {
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)J", line = 97)
