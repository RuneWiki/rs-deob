...
public class class321 extends class319 {
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(IIIIIF)V", line = 48)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIB)V", line = 86)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lp;IILza;BI)V", line = 97)
