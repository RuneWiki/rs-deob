...
public class class321 extends class183 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IB)Lbk;", line = 4)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILvm;II)Z", line = 31)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)V", line = 68)
