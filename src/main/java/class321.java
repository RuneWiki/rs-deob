...
public class class321 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Ltfa;Leu;IIIIILhca;ILr;II)Lda;")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIILoa;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILeu;II)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Ltfa;Lhca;Lr;ILhca;I[Ltk;IILml;ILsba;Lk;IZBILeu;Loa;)Lda;")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILk;ILhca;Ltfa;ILoa;Lr;Lml;Leu;ZI)Lda;")
