...
public class class321 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIII[III)V", line = 5)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I[Ljava/lang/Object;I[JI)V", line = 111)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 193)
