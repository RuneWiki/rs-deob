...
public class class321 extends class354 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IB)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(BII)I", line = 108)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(BI)V", line = 122)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)I", line = 155)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lnj;II)V", line = 175)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "()V", line = 240)
    public class321() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gt", name = "h", descriptor = "(I)V", line = 248)
