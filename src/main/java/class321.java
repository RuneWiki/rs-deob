...
public abstract class class321 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IB)V", line = 9)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(B)I", line = 64)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(B)V", line = 83)
