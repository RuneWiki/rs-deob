...
public class class321 extends class194 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILbg;)V", line = 7)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "()V", line = 41)
    public class321() {
        super(1, false);
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Luo;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(II)[[I", line = 79)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(B)V", line = 166)
