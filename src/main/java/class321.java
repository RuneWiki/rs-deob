...
public class class321 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZIIIILs;IIILha;Ls;Lwg;I)Lka;")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lha;Lwg;IIIII)Lka;")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IIILha;ILwg;I)Lka;")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lrg;IB)V")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZIILs;BIIILha;Ls;ILwg;IZ)Lka;")
