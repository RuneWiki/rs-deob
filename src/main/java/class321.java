...
public class class321 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lrda;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lrda;Ljaclib/memory/Buffer;)V", line = 21)
