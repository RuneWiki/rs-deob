...
public class class321 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lfo;ZLjava/lang/String;I)Lhl;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)Lkf;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lwt;ILwt;F)Z")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILug;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lur;)V")
