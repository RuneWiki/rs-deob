...
public class class321 extends class739 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(III)Z", line = 39)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 60)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZI)[I", line = 71)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "()V", line = 128)
    public class321() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/io/File;B)[B", line = 132)
    public static final byte[] method1994(File arg0, byte arg1) {
        ++field4372;
        return arg1 < 99 ? null : class637.method3676(113, (int) arg0.length(), arg0);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lsl;IB)V", line = 157)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!eo", name = "d", descriptor = "(I)Lai;", line = 248)
