...
public class class321 extends class583 implements class264 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!nha", name = "c", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!nha", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIIII)I", line = 68)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Leea;III)V", line = 134)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Leea;IIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!nha", name = "d", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIIIIB)V", line = 166)
