...
public class class321 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIIIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BLic;Lic;)I", line = 114)
