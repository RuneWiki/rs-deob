...
public class class321 extends class525 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IBLpc;I)Lre;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljs;B)V")
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(B)Lmd;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lmd;I)V")
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ljs;)V")
