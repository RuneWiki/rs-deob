...
public class class321 extends class696 implements class636 {
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Leea;II[III)V")
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIIILkca;Z[BI)V")
    ...
    @OriginalMember(owner = "client!nha", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Leea;Lkca;Lti;II)V")
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Leea;Lkca;II[FII)V")
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Leea;Lkca;II[BII)V")
