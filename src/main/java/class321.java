...
public class class321 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZLp;Lkm;IIII)Lab;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IBLlk;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILms;I)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I[Laq;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Llk;I)V")
