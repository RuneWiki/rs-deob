...
public class class321 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)V", line = 3514)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILka;III)Lel;", line = 3529)
