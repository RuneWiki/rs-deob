...
public class class321 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lee;BI)V")
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILee;ILtv;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lee;)V")
