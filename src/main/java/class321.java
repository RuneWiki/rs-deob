...
public class class321 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjha;ZILjha;)I")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IILha;IBI)V")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lac;II)V")
