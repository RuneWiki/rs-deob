...
public class class321 implements class209 {
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(II)Laba;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BI)Lrr;")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lpu;Lpu;Lpu;)V")
