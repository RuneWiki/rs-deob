...
public class class321 {
    ...
    public static long field3996 = -1L;
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "Lub;")
    public static class20 field3994;

    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(I)J", line = 3)
    public static final synchronized long method1854(int arg0) {
        field3995++;
        long var1 = System.currentTimeMillis();
        if (arg0 >= -12) {
            field3994 = null;
        }
        if (class126.field1541 > var1) {
            class197.field2319 += class126.field1541 - var1;
        }
        class126.field1541 = var1;
        return var1 + class197.field2319;
    }

    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IB)[[[B", line = 24)
    public static final byte[][][] method1855(int arg0, byte arg1) {
        field3997++;
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)V", line = 802)
