...
public class class321 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(JI[ILgfa;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)Ljc;")
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(ILjn;Ljn;Lfo;)V")
