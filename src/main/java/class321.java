...
public class class321 extends class139 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(IIII)[B", line = 18)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IILya;Lql;ILkn;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "()V", line = 258)
    public class321() {
