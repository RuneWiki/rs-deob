...
public class class510 extends class394 {
    ...
    @OriginalMember(owner = "client!cba", name = "M", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lhea;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lq;I)V")
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "(B)V")
