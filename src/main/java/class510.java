...
public class class510 extends class305 {
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lhb;)V", line = 15)
    public class510(class728 arg0) {
        super(arg0);
        class59.method414(super.field4320, (byte) -65);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([BI)[B", line = 25)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)Lcha;", line = 43)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(III)Z", line = 58)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)I", line = 69)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(II)I", line = 144)
    ...
    @OriginalMember(owner = "client!mq", name = "e", descriptor = "(I)I", line = 159)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([[SI[[F)[[S", line = 172)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lrg;I)Lkg;", line = 216)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(ILhb;)V", line = 228)
