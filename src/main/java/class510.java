...
public class class510 extends class677 {
    ...
    @OriginalMember(owner = "client!li", name = "i", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IB)Lwl;", line = 18)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIIIBI)I", line = 56)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 343)
