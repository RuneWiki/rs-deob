...
public class class510 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(II)Lqea;")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lfa;III)I")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;IIII)Lgca;")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lfa;II)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(Lr;)Lgca;")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;Lac;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;II)V")
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(Lr;IIII)V")
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(II)Lje;")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lsea;Lew;Lfb;Lgq;Lge;Lbt;Lnf;)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lr;Lwp;IIII)V")
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)Lqea;")
