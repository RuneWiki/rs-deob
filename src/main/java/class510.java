...
public class class510 extends class278 {
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!hb", name = "g", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILss;BLqa;)V", line = 41)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIIII)I", line = 339)
    ...
    @OriginalMember(owner = "client!hb", name = "h", descriptor = "(I)V", line = 418)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 455)
    public class510() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Llh;II)V", line = 463)
    ...
    @OriginalMember(owner = "client!hb", name = "d", descriptor = "(I)V", line = 566)
    ...
    @OriginalMember(owner = "client!hb", name = "d", descriptor = "(B)V", line = 596)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I[II)V", line = 661)
