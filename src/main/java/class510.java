...
public class class510 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(III)Lcj;", line = 48)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)I", line = 135)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lkw;I)V", line = 175)
