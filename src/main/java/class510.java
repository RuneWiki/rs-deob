...
public class class510 extends class452 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)Lhm;", line = 5)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZII)Ljk;", line = 21)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Leha;Loea;IIIIIIIIIIIII)V", line = 75)
