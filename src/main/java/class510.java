...
public class class510 extends class711 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "([Ljava/lang/Object;III[I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mn", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 81)
    ...
    @OriginalMember(owner = "client!mn", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 93)
    public final void startProduction(ImageConsumer arg0) {
        ++field7389;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!mn", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 118)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field7385;
        return this.field7383 == arg0;
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Ljava/awt/Graphics;IIIIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!mn", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 145)
    ...
    @OriginalMember(owner = "client!mn", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 163)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field7394;
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILjava/awt/Canvas;II)V", line = 171)
