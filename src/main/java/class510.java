...
public class class510 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IZII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IILgh;I)V", line = 118)
