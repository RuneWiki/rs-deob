...
public class class510 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(B)Luj;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ILjava/lang/String;Lpg;B)Lbc;")
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)Luj;")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lew;)V")
