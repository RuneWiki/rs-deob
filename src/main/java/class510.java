...
public class class510 extends class346 implements class614 {
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lgb;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
