...
public class class510 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(III)V", line = 177)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(IIIII)V", line = 192)
