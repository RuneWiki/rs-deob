...
public class class510 extends class5 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "()V", line = 37)
    public class510() {
    }

    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(S)V", line = 39)
    public class510(short arg0) {
        this.field7492 = arg0;
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)I", line = 47)
