...
public class class510 extends class435 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II[I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IFBII)V", line = 170)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)Loda;", line = 292)
    public static final class653 method3035(int arg0) {
        field7584++;
        return arg0 == 1 ? class105.method882(arg0 + 1, 1) : null;
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(III)Z", line = 306)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZI)V", line = 318)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(IB)V", line = 334)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)V", line = 350)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lsq;IIIII)V", line = 370)
