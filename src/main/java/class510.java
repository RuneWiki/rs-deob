...
public class class510 {
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Ler;Lmi;Ltv;IIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IILlga;)V", line = 61)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I[BIZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Z)V", line = 215)
