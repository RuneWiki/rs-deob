...
public class class510 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 42)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(I)V", line = 73)
    public class510(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IILjava/lang/Object;J)V", line = 78)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(JZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZLjava/lang/Object;J)V", line = 123)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IB)V", line = 154)
    ...
    @OriginalMember(owner = "client!nga", name = "d", descriptor = "(Z)V", line = 202)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 231)
    ...
    @OriginalMember(owner = "client!nga", name = "d", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Lof;I)V", line = 294)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(BJ)Ljava/lang/Object;", line = 315)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(II)V", line = 367)
