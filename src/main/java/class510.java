...
public class class510 extends class592 {
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lji;Lpm;)V")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BILji;II)Lch;")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IILgq;)V")
