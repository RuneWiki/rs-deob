...
public class class510 extends class598 {
    ...
    @OriginalMember(owner = "client!rj", name = "finalize", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILqa;II)Z", line = 148)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lqa;ILr;)V", line = 163)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(ILqa;)Loj;", line = 190)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 264)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)V", line = 276)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(I)I", line = 308)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(I)Z", line = 322)
    public final boolean method317(int arg0) {
        ++field7215;
        return arg0 != 64;
    }

    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(ILqa;II)Lr;", line = 341)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILqa;)V", line = 357)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(B)V", line = 372)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(ILqa;)Lso;", line = 386)
