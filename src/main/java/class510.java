...
public class class510 extends class130 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIZZI)I", line = 19)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIB)V", line = 74)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILfh;I)V", line = 91)
