...
public class class510 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILcea;B)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILcea;B)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIIIIIIILfe;II)Z")
