...
public class class510 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lfd;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLmc;Lfd;)V", line = 406)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLfd;)V", line = 688)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III)Lii;", line = 707)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILfd;)V", line = 714)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(ILfd;)V", line = 729)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 760)
