...
public abstract class class510 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)Lfr;", line = 41)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)D", line = 173)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(B)Z", line = 206)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ZB)V", line = 224)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Z)V", line = 246)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILjava/lang/String;)V", line = 276)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(Z)V", line = 334)
    ...
    @OriginalMember(owner = "client!lda", name = "d", descriptor = "(B)V", line = 377)
    ...
    @OriginalMember(owner = "client!lda", name = "e", descriptor = "(B)V", line = 419)
    ...
    @OriginalMember(owner = "client!lda", name = "f", descriptor = "(B)V", line = 541)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "([BII)I", line = 576)
    public static final int method2969(byte[] arg0, int arg1, int arg2) {
        field6917++;
        return arg1 == 0 ? class226.method1521(arg2, arg0, 0, -96) : -45;
    }

    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(I)Lk;", line = 587)
    ...
    @OriginalMember(owner = "client!lda", name = "d", descriptor = "(I)Ldi;", line = 598)
    ...
    @OriginalMember(owner = "client!lda", name = "e", descriptor = "(I)Z", line = 627)
    ...
    @OriginalMember(owner = "client!lda", name = "f", descriptor = "(I)Lwk;", line = 647)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(I)V", line = 657)
