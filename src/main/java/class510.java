...
public class class510 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(BLmc;I)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Laa;Luaa;Lpu;IBIII)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lha;IZB)Lpu;")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILmc;)V")
