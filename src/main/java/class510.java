...
public class class510 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Lqg;", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)Lqg;", line = 30)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILug;)V", line = 67)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "()V", line = 81)
    public class510() {
    }

    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lug;)V", line = 94)
