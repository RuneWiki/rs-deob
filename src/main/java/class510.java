...
public class class510 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ldga;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(Ldga;)V", line = 19)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "()V", line = 56)
    public class510() {
        this.field6878[0] = 0;
