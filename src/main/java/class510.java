...
public class class510 extends class714 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lol;I)Llca;", line = 10)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(B)Lhl;", line = 35)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lmp;Lfe;IIIIIIIIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(III)I", line = 62)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(I)V", line = 79)
