...
public class class510 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BI)I", line = 25)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIII)V", line = 45)
