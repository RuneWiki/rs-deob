...
public class class510 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IILso;)V", line = 141)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Lso;I)V", line = 223)
