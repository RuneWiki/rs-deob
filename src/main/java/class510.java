...
public class class510 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ILhi;)V", line = 32)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIII)Lkw;", line = 43)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)Lpf;", line = 58)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(IIIIB)V", line = 71)
