...
public class class280 extends class610 {
    ...
    @OriginalMember(owner = "client!cha", name = "b", descriptor = "(B)V", line = 7)
    public static void method1870(byte arg0) {
        field4069 = null;
        int var1 = -124 % ((-arg0 - 52) / 41);
    }

    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(I)V", line = 39)
