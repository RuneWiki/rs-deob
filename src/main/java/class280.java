...
public class class280 extends class631 implements class535 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lpda;", line = 6)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lpda;)V", line = 13)
    public final void method604(class631 arg0) {
        this.method1662(this.nativeid, ((class280) arg0).nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "f", descriptor = "(I)V", line = 16)
    public final void method610(int arg0) {
        this.method1665(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "([I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(III[I)V", line = 44)
    public final void method599(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1664(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 49)
    public class280() {
        this.method1653();
    }

    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(III[I)V", line = 53)
    public final void method593(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1655(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "()V", line = 60)
    public final void method595() {
        this.method1663(this.nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)V", line = 63)
    public final void method594(int arg0) {
        this.method1660(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "g", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(III)V", line = 83)
    public final void method600(int arg0, int arg1, int arg2) {
        this.method1661(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III)V", line = 87)
