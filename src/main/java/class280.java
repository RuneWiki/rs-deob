...
public class class280 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Ltt;II)V", line = 101)
