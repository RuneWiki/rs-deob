...
public class class280 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)Lnja;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)Lnja;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLnja;)V")
