...
public class class280 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lya;IIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "()V", line = 92)
    public final void method1663() {
        this.field3826 = null;
    }

    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lya;Lwe;)V", line = 95)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lya;)V", line = 187)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "()V", line = 247)
    public static final void method1666() {
        field3832 = null;
        field3839 = null;
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(Lya;Lwe;)Z", line = 255)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "()V", line = 290)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(Lya;Lwe;)V", line = 298)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(Lya;Lwe;)Z", line = 390)
    public final boolean method1670(class38 arg0, class280 arg1) {
        return this.field3826 != null || this.method1667(arg0, arg1);
    }

    @OriginalMember(owner = "client!we", name = "b", descriptor = "(Lya;)V", line = 396)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
