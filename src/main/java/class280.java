...
public class class280 extends class198 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILlm;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lgga;B)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ZLol;)V")
