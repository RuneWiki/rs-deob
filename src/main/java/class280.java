...
public class class280 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)[[[I", line = 5)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(II)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!pba", name = "c", descriptor = "(I)V", line = 133)
