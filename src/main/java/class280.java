...
public class class280 extends class518 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)[[I", line = 66)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILjc;I)V", line = 142)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ZZLtl;)V", line = 184)
    ...
    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(I)I", line = 235)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 252)
    public class280() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIBI)V", line = 263)
