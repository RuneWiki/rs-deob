...
public class class280 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(I)Liw;", line = 4)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Lpl;IB)Lsa;", line = 19)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "([Ljava/lang/String;III)Ljava/lang/String;", line = 35)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!rga", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!rga", name = "toString", descriptor = "()Ljava/lang/String;", line = 136)
    public final String toString() {
        field3514++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(II)V", line = 162)
