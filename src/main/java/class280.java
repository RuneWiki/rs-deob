...
public class class280 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "()V", line = 4)
    public final void method1843() {
        this.field3966 = null;
    }

    @OriginalMember(owner = "client!ap", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lae;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(Lae;)V", line = 96)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lae;Lap;)V", line = 165)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "()V", line = 250)
    public static final void method1848() {
        field3970 = null;
        field3959 = null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIII)Z", line = 260)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(Lae;Lap;)V", line = 318)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(Lae;Lap;)Z", line = 408)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lae;IIIIII)V", line = 442)
    ...
    @OriginalMember(owner = "client!ap", name = "d", descriptor = "(Lae;Lap;)Z", line = 470)
    public final boolean method1853(class134 arg0, class280 arg1) {
        return this.field3966 != null || this.method1851(arg0, arg1);
    }

    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
