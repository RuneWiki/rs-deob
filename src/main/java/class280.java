...
public class class280 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILfd;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILfd;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)V", line = 163)
