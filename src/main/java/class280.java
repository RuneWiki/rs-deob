...
public class class280 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)I", line = 4)
    public final int method1593(int arg0) {
        field3531++;
        return arg0 >= -119 ? 1 : this.field3532 & 0x3FFF;
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(BLiaa;)V", line = 27)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIBI)Z", line = 158)
