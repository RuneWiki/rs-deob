...
public class class280 extends class17 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lwm;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "()V", line = 29)
    public class280() {
        super(1, true);
    }

    @OriginalMember(owner = "client!je", name = "h", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)[I", line = 214)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Ljq;ILjq;)V", line = 256)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)V", line = 283)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(II)I", line = 298)
    ...
    @OriginalMember(owner = "client!je", name = "g", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "([Lhm;IZ)V", line = 339)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)V", line = 432)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(II)[I", line = 455)
