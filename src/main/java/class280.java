...
public class class280 extends class367 implements class231 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(IIIIILao;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;I)Lbi;")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BLqa;II)Z")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(ILqa;)Lkm;")
