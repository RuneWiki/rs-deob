...
public class class280 extends class417 implements class28 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 39)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 61)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(La;Ljava/awt/Canvas;)V", line = 77)
