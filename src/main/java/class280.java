...
public class class280 implements class472 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIFBIZ)[I", line = 19)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IBIII[BI[BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IB)Lns;", line = 87)
    public final class83 method1762(int arg0, byte arg1) {
        field4153++;
        return arg1 == 45 ? this.field4155[arg0] : null;
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(FIIIZI)[I", line = 117)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(II)Lqd;", line = 130)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIFIZ)[F", line = 158)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)I", line = 170)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(II)I", line = 181)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Ldda;Ldda;Ldda;)V", line = 198)
