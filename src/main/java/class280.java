...
public class class280 extends class418 implements class201 {
    ...
    @OriginalMember(owner = "client!ca", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(CIIIZLua;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Ll;Lm;Lufa;[Lwt;[Lf;)V", line = 12)
