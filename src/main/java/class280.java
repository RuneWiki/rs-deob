...
public class class280 extends class64 {
    ...
    @OriginalMember(owner = "client!rn", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lfba;Lkaa;[Luh;[I[I)V")
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "([B[IIIIIIII)V")
