...
public class class280 extends class210 implements class425 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BLza;I)Le;")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lza;Ljc;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BIZLza;)Lrn;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lza;Z)V")
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(Lza;I)Lnd;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZLza;II)Z")
