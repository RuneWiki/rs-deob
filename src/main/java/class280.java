...
public class class280 extends class539 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(III)Z", line = 49)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(II)V", line = 63)
