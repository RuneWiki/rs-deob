...
public class class280 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Llq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(II)Lva;", line = 65)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 97)
