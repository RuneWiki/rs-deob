...
public class class280 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II[I[II)V", line = 20)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZC)Z", line = 75)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIII)V", line = 127)
