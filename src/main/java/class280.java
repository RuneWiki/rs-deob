...
public class class280 extends class220 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lvp;IILai;ZILta;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 95)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IBLil;)V", line = 148)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(B)I", line = 191)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 203)
    public class280() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!ei", name = "f", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)[[I", line = 245)
