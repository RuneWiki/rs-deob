...
public class class280 implements Runnable {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILug;I)Lpk;", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lpk;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lap;)V", line = 203)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lug;II)Lpk;", line = 134)
    ...
    @OriginalMember(owner = "client!bi", name = "run", descriptor = "()V", line = 152)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "([BLug;IZ)Lpk;", line = 225)
