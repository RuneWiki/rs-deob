...
public class class280 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Let;BLjava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lfd;JI)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BII)Lsd;")
