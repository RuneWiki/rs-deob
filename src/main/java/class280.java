...
public class class280 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B)Llr;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BI)Ltb;")
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Ltb;I)V")
