...
public class class280 extends class333 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B[II)V", line = 8)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BI)V", line = 168)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(II)V", line = 189)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IFIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IBII)V", line = 345)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZI)V", line = 364)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Lbh;IIIII)V", line = 379)
