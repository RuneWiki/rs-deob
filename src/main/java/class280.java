...
public abstract class class280 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(B)Ljo;", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ljo;I)Ljo;", line = 14)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IBI)I", line = 67)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(III)I", line = 97)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILsca;Lha;IIIILaa;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(FFFFFIFI)F", line = 292)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIZ)Z", line = 368)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 378)
