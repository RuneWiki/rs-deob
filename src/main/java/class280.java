...
public class class280 extends class333 implements class533 {
    ...
    @OriginalMember(owner = "client!ja", name = "e", descriptor = "(I)V", line = 5)
    public final void method1700(int arg0) {
        this.method1701(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lofa;", line = 11)
    ...
    @OriginalMember(owner = "client!ja", name = "f", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "()V", line = 70)
    public final void method1725() {
        this.method1699(this.nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 73)
