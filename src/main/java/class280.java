...
public class class280 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLoa;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B[BII)V", line = 450)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 469)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 578)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 601)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IBLwb;)V", line = 612)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Ljaa;Lk;Lrk;IIIII)V", line = 633)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lba;IIII)Lqt;", line = 760)
