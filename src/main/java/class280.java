...
public class class280 extends class214 implements class193 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Luo;BI)Lmj;")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILuo;)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IZI[Lms;IIIIII)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILuo;I)Lmj;")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Luo;BZI)Lvg;")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZLuo;)Laj;")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IILuo;I)Z")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIIBLuo;Lgm;)V")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Luo;Lgm;IIIIZIIIII)V")
