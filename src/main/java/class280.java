...
public class class280 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(IIF)F", line = 14)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IF)I", line = 19)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "()V", line = 80)
    public static void method1828() {
        field4018 = null;
        field4022 = null;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(F)F", line = 92)
    private static final float method1829(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lgga;Lmca;)V", line = 99)
