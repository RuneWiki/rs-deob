...
public class class280 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)Ltj;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BILcb;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lcb;I)V")
