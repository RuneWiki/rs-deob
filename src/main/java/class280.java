...
public abstract class class280 extends class167 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lha;Lwea;ZIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "n", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(ILha;)Z", line = 28)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B[Luca;)I", line = 45)
    ...
    @OriginalMember(owner = "client!cl", name = "j", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!cl", name = "g", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!cl", name = "o", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(IIIIIII)V", line = 98)
