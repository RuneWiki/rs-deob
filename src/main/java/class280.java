...
public abstract class class280 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZIIB)I", line = 19)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([Lgs;II)V", line = 103)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III[FB[FIIIFI)V", line = 141)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)V", line = 197)
