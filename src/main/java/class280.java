...
public class class280 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZLe;)V", line = 34)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(I)V", line = 71)
