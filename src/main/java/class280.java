...
public class class280 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IBLug;)V", line = 3)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BZLwk;)V", line = 31)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 374)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(B)V", line = 413)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lug;I)V", line = 425)
