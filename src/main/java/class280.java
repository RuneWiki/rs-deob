...
public class class280 extends class331 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lck;[BIB)Lju;")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lts;)V")
    public class280(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(ILts;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "c", descriptor = "(II)V")
