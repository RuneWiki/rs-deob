...
public class class595 extends class237 implements class620 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Loa;II)Lba;")
    ...
    @OriginalMember(owner = "client!ua", name = "d", descriptor = "(Loa;I)Lcd;")
    public final class564 method72(class43 arg0, int arg1) {
        ++field8036;
        return arg1 != 21098 ? null : this.field8043;
    }

    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Loa;Lsa;IIIIIZIIIIII)V")
