...
public class class595 extends class118 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Los;)V", line = 15)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(ZB)V", line = 56)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IIZIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lbaa;IB)V", line = 277)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)Z", line = 289)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BZ)V", line = 300)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 331)
