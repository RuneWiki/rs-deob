...
public class class595 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(BLs;Lqu;Ls;ZIILha;IIB)Lka;", line = 39)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ZLeea;)V", line = 155)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILqu;Lha;BI)Lka;", line = 417)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Ljc;I)V", line = 431)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 456)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(IIIIIBILka;Lqu;ILha;II)Lka;", line = 579)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Ljc;II)V", line = 758)
