...
public class class595 extends class501 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(DBLkda;ILn;ZI)[I")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lkda;Ln;B)Z")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lui;B)I")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIILkda;Ln;ZZD)[I")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIZLkda;Ln;)[F")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lgw;)V")
