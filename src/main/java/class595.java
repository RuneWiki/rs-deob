...
public class class595 extends class552 implements class624 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lha;IIB)Z")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ld;Lwu;B)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lha;BI)Lka;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IZLha;I)Lga;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLha;)Lck;")
