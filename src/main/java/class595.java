...
public class class595 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLjava/lang/String;)I", line = 16)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B[Lf;Ljava/lang/String;I)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "([Lf;Ljava/lang/String;I)I", line = 151)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/String;I[I[Lf;)I", line = 256)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Ljava/lang/String;[Lf;II)I", line = 502)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 530)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIIIII[II)V", line = 544)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IILjava/io/File;[B)V", line = 655)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILjava/lang/String;[Lf;I)I", line = 672)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IILjava/lang/String;B[Lf;)I", line = 684)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ICI)I", line = 707)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "([B)V", line = 721)
