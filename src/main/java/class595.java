...
public class class595 implements class695 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([BIBI)I", line = 30)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)Lhs;", line = 54)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(I)V", line = 68)
