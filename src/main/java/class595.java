...
public class class595 extends class322 {
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(ILch;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lch;)V")
