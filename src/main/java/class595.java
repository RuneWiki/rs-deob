...
public class class595 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILjava/lang/String;)J", line = 44)
