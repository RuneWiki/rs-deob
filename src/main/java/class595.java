...
public class class595 extends class642 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!qt", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 4)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method3279(arg0, 0, -102);
        field7866++;
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ICII)V", line = 12)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)Z", line = 30)
    public final boolean method3271(int arg0, int arg1) {
        field7868++;
        return arg1 <= arg0 && arg0 < 112 ? this.field7873[arg0] : false;
    }

    @OriginalMember(owner = "client!qt", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 43)
    public final synchronized void focusLost(FocusEvent arg0) {
        field7856++;
        this.method3270(0, '\u0000', -1, 81);
    }

    @OriginalMember(owner = "client!qt", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 52)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!qt", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 160)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method3279(arg0, 1, -84);
        field7867++;
    }

    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)Lvc;", line = 183)
    public final class293 method3274(byte arg0) {
        field7863++;
        return arg0 == -30 ? (class293) this.field7855.method3262(arg0 - 93) : null;
    }

    @OriginalMember(owner = "client!qt", name = "d", descriptor = "(I)I", line = 194)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 219)
    ...
    @OriginalMember(owner = "client!qt", name = "e", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!qt", name = "f", descriptor = "(I)V", line = 258)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V", line = 287)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IZLdv;)V", line = 322)
    ...
    @OriginalMember(owner = "client!qt", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 362)
    public final void focusGained(FocusEvent arg0) {
        field7871++;
    }

    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 429)
    public class595(Component arg0) {
        class252.method1534(true);
        this.method3276(930374533, arg0);
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BIIIZILno;[B)Lmn;", line = 399)
