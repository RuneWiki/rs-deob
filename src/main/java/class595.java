...
public class class595 extends class323 {
    ...
    @OriginalMember(owner = "client!ck", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() {
        field8316++;
        this.method1935(0);
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II)Z", line = 11)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BIII)I", line = 26)
    ...
    @OriginalMember(owner = "client!ck", name = "d", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II[BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(III)V", line = 111)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II[BB)I", line = 137)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 200)
