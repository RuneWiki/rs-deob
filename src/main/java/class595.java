...
public class class595 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)Lsc;")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ILhh;ILhi;ZLr;)Z")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ILnda;)Ljt;")
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lmv;Lmv;)V")
