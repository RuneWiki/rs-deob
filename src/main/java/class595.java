...
public class class595 extends class60 {
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lao;Loea;[Lrh;[I[I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(CIIIZLaa;II)V")
