...
public class class595 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(B)Laca;", line = 23)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IIFII[FIIIF[FIFI)V", line = 38)
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Ljc;J[Lkga;)V", line = 162)
    public class595(class179 arg0, long arg1, class578[] arg2) {
        this.field7559 = arg1;
        this.field7554 = arg0;
    }

    @OriginalMember(owner = "client!hia", name = "finalize", descriptor = "()V", line = 176)
