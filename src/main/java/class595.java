...
public class class595 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIBIIILha;)Lka;", line = 68)
