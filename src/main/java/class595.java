...
public class class595 extends class739 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lsl;IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "()V", line = 725)
    public class595() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ZI)[I", line = 141)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIIIBI)V", line = 384)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(III[[IBILjava/util/Random;)V", line = 512)
