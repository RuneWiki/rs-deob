...
public class class595 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IZIIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IILek;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ILek;)V", line = 90)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(BI)V", line = 112)
