...
public class class595 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Ltf;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILnp;)Ltr;", line = 34)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZII)Z", line = 63)
