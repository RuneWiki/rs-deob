...
public class class595 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZLjava/lang/String;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)Z", line = 308)
