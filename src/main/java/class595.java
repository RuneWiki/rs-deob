...
public class class595 extends class330 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "([Loq;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(II)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lgga;IB)V", line = 82)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)V", line = 94)
    public static void method3469(int arg0) {
        field8361 = null;
        int var1 = 107 / ((arg0 - -78) / 38);
    }

    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(Z)I", line = 104)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "()V", line = 147)
    public class595() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IZ)[I", line = 151)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IBI)V", line = 185)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(III)I", line = 259)
