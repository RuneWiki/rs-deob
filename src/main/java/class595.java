...
public class class595 implements Runnable {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IILce;)Lnq;", line = 25)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BLce;[BI)Lnq;", line = 45)
    ...
    @OriginalMember(owner = "client!cda", name = "run", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Lcea;)V", line = 202)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lce;BI)Lnq;", line = 139)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lnq;I)V", line = 177)
