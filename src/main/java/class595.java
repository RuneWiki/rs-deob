...
public class class595 extends class199 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)Lgk;", line = 37)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(II[I[I)V", line = 59)
