...
public class class595 extends class494 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)I", line = 49)
