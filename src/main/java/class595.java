...
public class class595 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BLqa;IILoh;)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)Leg;")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIII)Lon;")
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lon;I)V")
