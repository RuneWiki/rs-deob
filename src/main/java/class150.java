...
public class class150 extends class574 {
    ...
    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(Z)V", line = 2)
    public final void method455(boolean arg0) {
    }

    @OriginalMember(owner = "client!aq", name = "G", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "([Lba;Lq;[Lpo;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "([Lba;Lig;Lq;[Lpo;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)V", line = 75)
    public final void method476(int arg0) {
        super.field7366[arg0].method3775(108, (Runnable) null);
    }

    @OriginalMember(owner = "client!aq", name = "r", descriptor = "()V", line = 78)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lnj;IIII)Lba;", line = 95)
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "(I)V", line = 100)
    public final void method494(int arg0) {
        super.field7366[arg0].method3775(101, Thread.currentThread());
    }

    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(IIIIIIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lxa;Z)V", line = 136)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 162)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 166)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIIIIIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 227)
    public class150(Canvas arg0, class498 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 230)
    ...
    @OriginalMember(owner = "client!aq", name = "g", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lfm;IIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIIIII)V", line = 317)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Ljava/lang/Runnable;)Lcm;", line = 390)
    ...
    @OriginalMember(owner = "client!aq", name = "u", descriptor = "()Z", line = 402)
