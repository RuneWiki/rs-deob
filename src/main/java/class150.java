...
public class class150 extends class326 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILbt;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(BI)Lnk;", line = 52)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lnk;III)V", line = 127)
