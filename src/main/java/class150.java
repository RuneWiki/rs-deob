...
public class class150 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lre;B)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILtq;ZI)Ldp;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ljava/lang/String;IZLui;)Lgn;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILre;I)V")
