...
public abstract class class150 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIILwg;BII)Z", line = 50)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIB)V", line = 112)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 278)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(IIIII)V", line = 356)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)V", line = 314)
