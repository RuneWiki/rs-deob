...
public class class150 extends class774 {
    ...
    @OriginalMember(owner = "client!kl", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 14)
    public class150(Object arg0, int arg1) {
        super(arg1);
        this.field1976 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!kl", name = "g", descriptor = "(I)Z", line = 24)
