...
public class class150 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IB)V", line = 75)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(III)V", line = 182)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lmv;I)V", line = 124)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)V", line = 138)
    public static void method1072(int arg0) {
        int var1 = -120 / ((-arg0 - 31) / 35);
        field2118 = null;
    }

    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)[[[I", line = 157)
