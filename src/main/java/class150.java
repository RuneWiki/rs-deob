...
public class class150 extends class404 {
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "()V", line = 495)
    public class150() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILha;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZLkm;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)[I", line = 100)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lvl;Lqq;I)V", line = 247)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;B)V", line = 484)
    ...
    @OriginalMember(owner = "client!ec", name = "h", descriptor = "(I)V", line = 505)
