...
public class class150 implements class172 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)Lal;", line = 6)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIZ)I", line = 31)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IB)Loj;", line = 68)
    public final class358 method960(int arg0, byte arg1) {
        field1740++;
        return arg1 == -40 ? this.field1759[arg0] : null;
    }

    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IZ)Z", line = 126)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIFIZ)[I", line = 140)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(IIIFIZ)[I", line = 152)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IILjava/lang/String;)V", line = 162)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZIIILwo;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BI)Loa;", line = 200)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(II)I", line = 226)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)Z", line = 244)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(FZIIIZ)[F", line = 257)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lwo;Lwo;Lwo;)V", line = 275)
