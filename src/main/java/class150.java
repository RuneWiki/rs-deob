...
public class class150 extends class161 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIZIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)V", line = 44)
    public static void method1062(byte arg0) {
        field2335 = null;
        int var1 = -71 % ((-arg0 - 73) / 53);
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IB)I", line = 55)
