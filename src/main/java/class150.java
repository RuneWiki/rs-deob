...
public class class150 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILjava/lang/String;)V", line = 31)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ljava/lang/String;ZZI)V", line = 139)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)V", line = 1151)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lwm;B)I", line = 1168)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(I)V", line = 1252)
