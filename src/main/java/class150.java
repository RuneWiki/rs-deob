...
public class class150 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I[IB)Lnq;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I[III)Lnq;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B[II)Lnq;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZ[II)Lnq;")
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lic;Lic;)V")
