...
public abstract class class150 implements class37 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Luu;Luu;Lcv;)V", line = 64)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)I", line = 100)
