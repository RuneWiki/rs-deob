...
public class class150 extends class232 {
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "()V", line = 266)
    public class150() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILwq;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lha;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IB)[I", line = 269)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZI)V", line = 405)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 422)
