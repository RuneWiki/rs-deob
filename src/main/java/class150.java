...
public class class150 extends class125 {
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lgp;)V", line = 42)
    public class150(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZI)I", line = 95)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(Z)I", line = 123)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(ILgp;)V", line = 134)
