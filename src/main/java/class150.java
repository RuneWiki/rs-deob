...
public class class150 implements class131 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILqo;)V", line = 8)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)J", line = 177)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(II)V", line = 211)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILrc;)Z", line = 240)
