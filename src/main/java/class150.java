...
public class class150 extends class478 {
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!ifa", name = "c", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ILnp;I)V", line = 258)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "()V", line = 339)
    public class150() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ifa", name = "f", descriptor = "(I)V", line = 369)
