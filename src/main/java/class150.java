...
public class class150 extends class350 {
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "()V", line = 3)
    public class150() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IBI)V", line = 12)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lso;I)Lem;", line = 27)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(FIIIIFIF)[F", line = 39)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(IIII)[B", line = 118)
