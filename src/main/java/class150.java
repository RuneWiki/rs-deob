...
public abstract class class150 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "()V", line = 34)
