...
public class class150 extends class115 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BLbk;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 104)
    public class150() {
        this(0);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(II)V", line = 121)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(I)V", line = 134)
    private class150(int arg0) {
        super(0, false);
        this.method894(-93, arg0);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lbo;B)V", line = 147)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZBIII)Lvh;", line = 182)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIZI)V", line = 222)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIIIII)Z", line = 244)
