...
public class class150 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)Luq;", line = 3)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Luq;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Z)Luq;", line = 45)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(BLuq;)V", line = 66)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)Luq;", line = 87)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Lwv;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!gfa", name = "d", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(B)Luq;", line = 213)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "()V", line = 266)
    public class150() {
        this.field2057.field4562 = this.field2057;
        this.field2057.field4567 = this.field2057;
    }

    @OriginalMember(owner = "client!gfa", name = "e", descriptor = "(I)I", line = 245)
