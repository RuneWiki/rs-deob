...
public class class150 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)Lnp;")
    public final class115 method1071(boolean arg0) {
        field2414++;
        return arg0 ? null : class69.method485(this.field2411, -71);
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)Lhv;")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lhv;I)V")
