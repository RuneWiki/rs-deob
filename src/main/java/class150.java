...
public class class150 extends class129 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[[I[[IIII)Lna;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ll;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "i", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIIF)Lve;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I[Lve;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lvh;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIZ)Lf;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[I[I)Lea;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lc;Liv;Lia;Laq;I)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lov;[Lne;Z)Loa;")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(ILm;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "m", descriptor = "(Lia;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lo;III)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lne;Z)Lf;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Luu;IIII)Lc;")
    ...
    @OriginalMember(owner = "client!fe", name = "z", descriptor = "()Lia;")
    public final class142 method916() {
        return new class155();
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIII)Lvh;")
    public final class191 method859(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Liv;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([Lc;Lia;[Laq;I)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lvh;Lvh;FLvh;)Lvh;")
    ...
    @OriginalMember(owner = "client!fe", name = "d", descriptor = "(I)Ll;")
    public final class125 method849(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ljava/lang/Runnable;)Ldb;")
    ...
    @OriginalMember(owner = "client!fe", name = "j", descriptor = "(ILea;II)V")
