...
public class class150 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lli;Lvq;B)I")
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(B)Lta;")
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lhd;II)V")
