...
public class class150 extends class424 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(II)I", line = 145)
    public static final int method1115(int arg0, int arg1) {
        ++field2177;
        return arg1 != -16465 ? -46 : 255 & arg0;
    }

    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "()V", line = 158)
    public class150() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lrg;BI)V", line = 167)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(IB)[I", line = 182)
    ...
    @OriginalMember(owner = "client!uk", name = "g", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!uk", name = "h", descriptor = "(I)V", line = 261)
