...
public class class150 implements class200 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(I)V", line = 28)
    public final void method1139(int arg0) {
        field2529++;
        int var2 = -1 / ((-arg0 - 82) / 43);
    }

    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BB)V", line = 80)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IBLvj;Lfo;)V", line = 144)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Z)I", line = 215)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(JB)Z", line = 231)
    ...
    @OriginalMember(owner = "client!wu", name = "d", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IF)F", line = 269)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lgh;Lsf;)V", line = 284)
