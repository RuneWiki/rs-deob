...
public class class150 extends class331 {
    ...
    @OriginalMember(owner = "client!gf", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BI)I", line = 25)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 48)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Ldg;BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(Ldg;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(JB)V", line = 158)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B[Ljava/lang/String;II)Ljava/lang/String;", line = 179)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(BI)Z", line = 243)
    ...
    @OriginalMember(owner = "client!gf", name = "f", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(III)V", line = 289)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 341)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(Z)V", line = 364)
