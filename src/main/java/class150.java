...
public class class150 extends class189 {
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)[B", line = 21)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(JZIII)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!uh", name = "f", descriptor = "(I)V", line = 124)
