...
public class class150 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(JILpn;)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)Lpn;", line = 29)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(JZ)Lpn;", line = 119)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IILja;ILuo;IZ)V", line = 151)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(I)V", line = 234)
