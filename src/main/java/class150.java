...
public class class150 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)Lvu;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)Lvu;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)Lhp;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lpk;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lpk;)V")
