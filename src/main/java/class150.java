...
public class class150 extends class615 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BILeh;)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lcea;Z)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ILcea;)I")
