...
public class class150 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Object;Ljava/applet/Applet;B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Ljava/lang/String;BLjava/applet/Applet;)V", line = 25)
