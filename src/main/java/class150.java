...
public class class150 extends class374 {
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZLew;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lvd;Lbt;)V", line = 41)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(III)V", line = 104)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)Z", line = 210)
