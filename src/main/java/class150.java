...
public class class150 extends class328 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "([Loh;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BILco;)V", line = 73)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;ILjava/lang/String;I)V", line = 117)
    ...
    @OriginalMember(owner = "client!db", name = "f", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "()V", line = 153)
    public class150() {
        super(0, true);
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)[I", line = 156)
