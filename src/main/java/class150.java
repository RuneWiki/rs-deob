...
public class class150 extends class409 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lbt;Lbt;Lin;)V", line = 37)
    public class150(class48 arg0, class48 arg1, class99 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILjava/lang/String;)J", line = 92)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IZIB)V", line = 127)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(Z)V", line = 171)
