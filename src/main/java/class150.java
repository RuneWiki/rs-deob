...
public class class150 extends class589 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lha;[Lvja;Z)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lha;J[Lvja;[Lrea;Z)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IZ)Lls;")
    ...
    @OriginalMember(owner = "client!ls", name = "e", descriptor = "()Ltv;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "([Lrea;Z)V")
    ...
    @OriginalMember(owner = "client!ls", name = "g", descriptor = "()Ltv;")
