...
public class class150 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BLnc;Lnc;[[II[[B[[BIZ[[BLja;I[[B)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvj;Ljava/awt/Canvas;Lcj;III)Lja;")
