...
public class class150 extends class85 {
    ...
    @OriginalMember(owner = "client!qb", name = "T", descriptor = "Lbg;")
    public static class18 field2886;

    @OriginalMember(owner = "client!qb", name = "cb", descriptor = "Lja;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BILja;)V")
