...
public class class150 extends class284 {
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(II)I", line = 36)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "()V", line = 102)
    public class150() {
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)J", line = 90)
