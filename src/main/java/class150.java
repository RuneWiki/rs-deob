...
public class class150 implements Runnable {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!aba", name = "run", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(III)Z", line = 65)
