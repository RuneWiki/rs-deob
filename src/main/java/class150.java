...
public class class150 extends class80 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([[BLh;I)V")
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(ZI)Llb;")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IILnn;)V")
