...
public class class150 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Ljava/awt/Color;Ljava/awt/Color;Ljava/lang/String;ZLjava/awt/Color;IZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BLss;)V", line = 191)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)V", line = 205)
