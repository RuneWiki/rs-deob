...
public class class150 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Lai;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ILjava/lang/Throwable;Ljava/lang/String;)V", line = 99)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(II)Lai;", line = 151)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(BI)I", line = 166)
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(I)I", line = 180)
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Lai;)V", line = 199)
    public class150(class546 arg0) {
        this.field1716 = 1;
        this.field1713 = arg0.field7806;
    }

    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "([Lai;)V", line = 207)
    public class150(class546[] arg0) {
