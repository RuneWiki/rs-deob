...
public class class150 extends class461 {
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Lgj;IIZ)V", line = 801)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Lgj;II[III)V", line = 817)
    ...
    @OriginalMember(owner = "client!dfa", name = "EA", descriptor = "(IIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "()I", line = 38)
    public final int method26() {
        field2248++;
        return this.field2250;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILfa;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!dfa", name = "KA", descriptor = "(IIIIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!dfa", name = "AA", descriptor = "()I", line = 130)
    public final int method33() {
        field2261++;
        return this.field2243 + this.field2238 + this.field2228;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIII[III)V", line = 139)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lkda;I)I", line = 147)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IBLtfa;FIFFIFFI)[B", line = 169)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 183)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZIB)Ljava/lang/String;", line = 241)
    ...
    @OriginalMember(owner = "client!dfa", name = "t", descriptor = "(III)V", line = 259)
    public final void method182(int arg0, int arg1, int arg2) {
        field2260++;
    }

    @OriginalMember(owner = "client!dfa", name = "GA", descriptor = "(IIIIII)V", line = 267)
    ...
    @OriginalMember(owner = "client!dfa", name = "sa", descriptor = "(FFFFFFIII)V", line = 296)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIZ)Z", line = 362)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IZLuea;)V", line = 395)
    ...
    @OriginalMember(owner = "client!dfa", name = "ba", descriptor = "(IIIIIII)V", line = 547)
    ...
    @OriginalMember(owner = "client!dfa", name = "QA", descriptor = "()I", line = 755)
    public final int method31() {
        field2242++;
        return this.field2238;
    }

    @OriginalMember(owner = "client!dfa", name = "I", descriptor = "(IIIII)V", line = 764)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "()I", line = 794)
