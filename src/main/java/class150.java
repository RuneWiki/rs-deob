...
public class class150 extends class316 {
    ...
    @OriginalMember(owner = "client!nt", name = "B", descriptor = "(CIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(CIIIZLta;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lcd;Lgf;[Lev;[I[I)V", line = 125)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([B[IIIIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 181)
