...
public class class150 extends class29 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILat;)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Z[ILat;)V", line = 82)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lat;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!la", name = "c", descriptor = "(B)I", line = 130)
    ...
    @OriginalMember(owner = "client!la", name = "f", descriptor = "(I)Ljava/lang/String;", line = 148)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IB)I", line = 172)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILat;B)V", line = 191)
    ...
    @OriginalMember(owner = "client!la", name = "d", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!la", name = "e", descriptor = "(B)V", line = 288)
