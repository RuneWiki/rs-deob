...
public class class150 extends class366 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Ler;Lfj;)V", line = 23)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IZIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(III)V", line = 92)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Z)Z", line = 175)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ILep;I)V", line = 190)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(B)V", line = 202)
