...
public class class150 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)Lnk;", line = 8)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)Lnk;", line = 29)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(Z)I", line = 61)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)Lnk;", line = 83)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)Lnk;", line = 108)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lpv;Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "()V", line = 257)
    public class150() {
        this.field2246.field4753 = this.field2246;
        this.field2246.field4750 = this.field2246;
    }

    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLpv;)I", line = 203)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lnk;I)V", line = 241)
