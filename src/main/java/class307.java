...
public class class307 extends class305 implements class218 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(IIIIIIIIIILug;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lgu;Ltq;Llk;B)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BZLtq;Lhm;III)V")
