...
public class class307 extends class439 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IIIIIZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "()V", line = 95)
    public class307() {
    }

    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(J)V", line = 97)
