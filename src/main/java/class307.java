...
public class class307 extends class601 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(ILqea;)V", line = 17)
    public class307(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Lqea;)V", line = 31)
    public class307(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIIII[B)V", line = 64)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BII)Z", line = 95)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IB)I", line = 108)
    ...
    @OriginalMember(owner = "client!oba", name = "c", descriptor = "(I)I", line = 119)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(B)V", line = 133)
