...
public class class307 extends class34 implements class2 {
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 4)
    public final int method184() {
        return this.method2033(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 8)
    public final int method177() {
        return this.method2028(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 24)
    public final void method5(boolean arg0) {
        this.method2022(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 56)
    public class307(class406 arg0, int arg1, int arg2) {
        this.method2018(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 60)
    public final void method186(int[] arg0) {
        this.method2025(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 66)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 72)
    public final void method51(int arg0, int arg1, int arg2) {
        this.method2035(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 75)
