...
public class class307 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "()Lfk;")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lae;II)Lhaa;")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lgga;)V")
