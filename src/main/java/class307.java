...
public class class307 extends class337 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(I)V", line = 32)
    public class307(int arg0) {
        this.field3860 = arg0;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 40)
