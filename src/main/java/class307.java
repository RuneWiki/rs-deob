...
public class class307 extends class327 implements class381 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILwm;I)Lgn;", line = 43)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BLwm;)V", line = 54)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lwm;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lwm;Lct;IIIIIZIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIBLwm;)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIILwm;ZLhp;Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lwm;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(Lwm;B)Lnf;", line = 194)
