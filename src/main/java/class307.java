...
public class class307 extends class457 {
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Lef;Lmc;)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lmk;II)V")
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(III)Lhg;")
    ...
    @OriginalMember(owner = "client!os", name = "g", descriptor = "(I)Lrd;")
