...
public class class307 extends class418 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILem;[IZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "()I", line = 134)
    public final int method1673() {
        field4345++;
        return 0;
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lvr;I)[I", line = 146)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([III)V", line = 185)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "()Lep;", line = 230)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(B)[Lqca;", line = 261)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lem;II)V", line = 272)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "()Lep;", line = 314)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZ)V", line = 334)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lae;)V", line = 360)
