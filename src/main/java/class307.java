...
public class class307 extends class339 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BI)Llg;")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "([IILio;)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILio;)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lto;I)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZILio;)V")
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(ILio;)Ljava/lang/String;")
