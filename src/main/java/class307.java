...
public class class307 extends class35 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II[Ljava/lang/String;[SI)V", line = 85)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lrr;)V", line = 221)
    public class307(class198 arg0) {
        this.field4487 = arg0;
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIIIIB)V", line = 159)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(III)Z", line = 193)
