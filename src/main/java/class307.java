...
public class class307 extends class371 {
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "()V", line = 6)
    public class307() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IBLps;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I[[I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ga", name = "g", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BI)[[I", line = 143)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIIIIB)V", line = 206)
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(BI)[I", line = 227)
