...
public class class307 extends class381 {
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "([JIIZ[Ljava/lang/Object;)V", line = 99)
