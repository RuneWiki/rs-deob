...
public class class307 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(II)Lvt;", line = 25)
    ...
    @OriginalMember(owner = "client!vt", name = "toString", descriptor = "()Ljava/lang/String;", line = 96)
    public final String toString() {
        field4044++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)Z", line = 110)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(IILwha;)V", line = 134)
