...
public class class307 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(CI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lra;ILra;)V", line = 124)
