...
public class class307 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IB)I", line = 35)
    public static final int method1943(int arg0, byte arg1) {
        field4446++;
        return arg1 <= 104 ? 81 : arg0 & 0xFF;
    }

    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 45)
