...
public class class307 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILvt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(III)B", line = 24)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lvt;II)V", line = 122)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)Z", line = 155)
