...
public class class307 extends class515 implements class2 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 9)
    public final int method777() {
        return this.method1912(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 22)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 32)
    public final int method780() {
        return this.method1922(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 40)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 57)
    public final void method808(int arg0, int arg1, int arg2) {
        this.method1913(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 60)
    public final void method9(boolean arg0) {
        this.method1908(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIII)V", line = 68)
    public final void method783(int arg0, int arg1, int arg2, int arg3) {
        this.method1906(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[IIIIIZ)V", line = 77)
