...
public class class307 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!al", name = "toString", descriptor = "()Ljava/lang/String;", line = 100)
    public final String toString() {
        field3795++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 112)
