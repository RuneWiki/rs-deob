...
public abstract class class307 extends class187 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILfd;II)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lve;III[Z)Z")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lam;Lam;I)V")
