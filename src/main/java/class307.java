...
public class class307 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BI)Lgf;", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(III)Lab;", line = 50)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IBIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(III)V", line = 221)
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lcm;ILlt;Llt;)V", line = 253)
