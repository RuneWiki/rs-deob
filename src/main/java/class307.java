...
public class class307 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(III)I", line = 11)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(B[B)V", line = 56)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "([BI[B)V", line = 257)
