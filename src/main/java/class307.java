...
public class class307 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(CZ)Z", line = 10)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(IIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(BI)Llv;", line = 59)
