...
public class class307 extends class21 implements class2 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 11)
    public final int method116() {
        return this.method1802(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 14)
    public final int method117() {
        return this.method1805(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 18)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 47)
    public final int method108() {
        return this.method1803(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 60)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 65)
