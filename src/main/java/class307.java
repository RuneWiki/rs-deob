...
public class class307 implements Runnable {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIB[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ljava/net/Socket;Lod;)V", line = 281)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(B)I", line = 109)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "([BIBI)V", line = 129)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)I", line = 189)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIIZIII[FFI)V", line = 227)
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!ti", name = "run", descriptor = "()V", line = 311)
