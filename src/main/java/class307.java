...
public abstract class class307 extends class154 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lfca;B)Lbp;", line = 67)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z)I", line = 126)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BI)Lfr;", line = 138)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)I", line = 197)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BC)Z", line = 207)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(IIIIIF)V", line = 257)
    ...
    @OriginalMember(owner = "client!bq", name = "f", descriptor = "(I)I", line = 274)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(B)F", line = 285)
