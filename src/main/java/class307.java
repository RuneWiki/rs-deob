...
public class class307 extends class195 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(I)V", line = 109)
    public class307(int arg0) {
        this.field4508 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(I)V", line = 117)
