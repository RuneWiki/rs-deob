...
public class class307 extends class175 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZI)[I", line = 5)
    ...
    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lec;I)[Lre;", line = 38)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIIIIZIIZ)Z", line = 81)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "()V", line = 113)
    public class307() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)I", line = 118)
