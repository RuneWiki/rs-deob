...
public abstract class class307 extends class390 {
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(B)V", line = 130)
    public static void method1976(byte arg0) {
        int var1 = -112 / ((arg0 + 9) / 58);
        field4236 = null;
    }

    @OriginalMember(owner = "client!um", name = "f", descriptor = "(I)V", line = 140)
