...
public class class307 extends class687 {
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(ZLr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Z)I", line = 33)
    ...
    @OriginalMember(owner = "client!ac", name = "i", descriptor = "(B)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lr;I)Lsd;", line = 66)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZIBLr;Llo;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!ac", name = "h", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZIBIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(II)Z", line = 180)
    ...
    @OriginalMember(owner = "client!ac", name = "l", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)I", line = 205)
    ...
    @OriginalMember(owner = "client!ac", name = "m", descriptor = "(I)Z", line = 233)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIB)V", line = 248)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I[FIIIIB)V", line = 345)
    ...
    @OriginalMember(owner = "client!ac", name = "j", descriptor = "(I)I", line = 441)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILr;I)Z", line = 463)
    ...
    @OriginalMember(owner = "client!ac", name = "d", descriptor = "(I)V", line = 634)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLr;)Log;", line = 649)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ldu;I)V", line = 786)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IILr;I)Z", line = 805)
