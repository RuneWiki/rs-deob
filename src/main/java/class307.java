...
public class class307 extends class446 {
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "([III)V", line = 8)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IILdd;ZI[I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ve", name = "d", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "()Lpl;", line = 128)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "()Lpl;", line = 146)
    ...
    @OriginalMember(owner = "client!ve", name = "e", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)Lrf;", line = 205)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZLdd;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lrh;)V", line = 328)
    public class307(class70 arg0) {
        this.field4516 = arg0;
    }

    @OriginalMember(owner = "client!ve", name = "d", descriptor = "()I", line = 336)
