...
public class class307 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)Lcp;", line = 31)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Llo;ILnl;)V", line = 132)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIIILfo;)V", line = 152)
