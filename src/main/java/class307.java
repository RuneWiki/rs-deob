...
public class class307 extends class376 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILwr;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lwr;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IB)V", line = 52)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lya;IZZF)V", line = 155)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BI)V", line = 172)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BLwr;)V", line = 188)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(III)Lwr;", line = 208)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 234)
