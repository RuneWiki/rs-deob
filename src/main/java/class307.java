...
public class class307 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BCI)I", line = 12)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "([Ltf;Ljava/lang/String;IZ)Ljava/lang/String;", line = 27)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "([Ltf;Ljava/lang/String;II)I", line = 177)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IZ)I", line = 318)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z[Ltf;Ljava/lang/String;I)I", line = 329)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "([Ltf;IIBLjava/lang/String;)I", line = 357)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ZLjava/lang/String;[Ltf;)I", line = 375)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I[ILjava/lang/String;[Ljava/lang/String;[Ltf;)I", line = 482)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 730)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "([B)V", line = 760)
