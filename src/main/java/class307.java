...
public class class307 extends class270 {
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IBLnl;)V", line = 50)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BII)Z", line = 103)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "()Lvv;", line = 114)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lnl;[IIBII)V", line = 168)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIIIIIIII)V", line = 228)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "()Lvv;", line = 247)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "([III)V", line = 270)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lwb;)V", line = 351)
    public class307(class274 arg0) {
        this.field3911 = arg0;
    }

    @OriginalMember(owner = "client!mn", name = "d", descriptor = "()I", line = 318)
    public final int method800() {
        field3916++;
        return 0;
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IZI)Z", line = 332)
