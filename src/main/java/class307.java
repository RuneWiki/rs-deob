...
public class class307 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BLwj;)I")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IB)Ljs;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(III)Lbb;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lqa;La;III)V")
