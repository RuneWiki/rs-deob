...
public class class307 extends class76 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lqj;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(III)V", line = 68)
