...
public class class307 extends class37 implements class89 {
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lse;I[BIZ)V", line = 4)
    public class307(class282 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field4571 = arg1;
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "()I", line = 8)
    public final int method282() {
        return super.method282();
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I[BI)V", line = 12)
    public final void method714(int arg0, byte[] arg1, int arg2) {
        this.method284(arg1, arg2);
        this.field4571 = arg0;
    }

    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lse;ILjava/nio/ByteBuffer;Z)V", line = 16)
    public class307(class282 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field4571 = arg1;
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILkr;)V", line = 20)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lkr;)V", line = 24)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "()V", line = 27)
    public final void method283() {
        this.field560.method1913(this);
    }

    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lkr;)V", line = 30)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(Lkr;)V", line = 33)
