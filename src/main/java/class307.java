...
public class class307 extends class227 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "()V", line = 94)
    public class307() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lug;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 60)
    public static void method1832(byte arg0) {
        field4120 = null;
        int var1 = 57 % ((arg0 - 3) / 50);
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IILjk;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lug;B)Lfu;", line = 103)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)[I", line = 114)
