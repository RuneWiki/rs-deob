...
public class class596 extends class422 implements class498 {
    ...
    @OriginalMember(owner = "client!ow", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ow", name = "c", descriptor = "(I)Llj;")
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Lia;Llj;Z)V")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILcw;)V")
