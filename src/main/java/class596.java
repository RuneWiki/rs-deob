...
public class class596 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(J[I[S[S)V", line = 63)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "()V", line = 73)
    protected class596() {
    }
}
