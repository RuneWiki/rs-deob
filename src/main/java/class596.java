...
public class class596 extends class527 {
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!im", name = "d", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IB)V", line = 91)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(III)Laka;", line = 122)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(B)V", line = 387)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)Lel;", line = 399)
    ...
    @OriginalMember(owner = "client!im", name = "e", descriptor = "(I)I", line = 501)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z)V", line = 512)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)I", line = 694)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lmea;I)Lmea;", line = 714)
    ...
    @OriginalMember(owner = "client!im", name = "f", descriptor = "(I)I", line = 748)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IZ)[B", line = 764)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(ILuaa;Luaa;Lgu;Lrf;I[BIZ)V", line = 838)
    ...
    @OriginalMember(owner = "client!im", name = "d", descriptor = "(B)I", line = 796)
