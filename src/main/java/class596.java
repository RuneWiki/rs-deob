...
public class class596 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BILoi;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)Lie;")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lrga;ILni;)V")
