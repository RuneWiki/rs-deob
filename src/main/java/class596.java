...
public class class596 extends Canvas {
    ...
    @OriginalMember(owner = "client!jq", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void paint(Graphics arg0) {
        this.field8471.paint(arg0);
        field8474++;
    }

    @OriginalMember(owner = "client!jq", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 11)
    public final void update(Graphics arg0) {
        field8473++;
        this.field8471.update(arg0);
    }

    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 93)
