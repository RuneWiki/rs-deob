...
public class class596 extends class440 {
    ...
    @OriginalMember(owner = "client!ph", name = "g", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BI)[I", line = 75)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILmo;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "()V", line = 175)
    public class596() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ph", name = "h", descriptor = "(I)V", line = 180)
