...
public class class596 extends class637 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIIZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IF)V", line = 94)
    ...
    @OriginalMember(owner = "client!dda", name = "h", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIIB)V", line = 121)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(IIIIIF)V", line = 134)
