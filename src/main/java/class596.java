...
public class class596 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)I", line = 48)
    ...
    @OriginalMember(owner = "client!rg", name = "toString", descriptor = "()Ljava/lang/String;", line = 60)
    public final String toString() {
        field8332++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lui;IZLr;)V", line = 68)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(II)V", line = 409)
