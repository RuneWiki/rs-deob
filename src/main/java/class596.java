...
public class class596 extends class469 {
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    public class596(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ic", name = "f", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IF)V", line = 26)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIII)V", line = 37)
