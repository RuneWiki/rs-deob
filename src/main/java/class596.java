...
public class class596 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILjc;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IILjc;)V", line = 40)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IZLha;I)Ltb;", line = 88)
