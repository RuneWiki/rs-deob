...
public class class596 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IZ)[I", line = 3)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(III)V", line = 159)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Z)[[I", line = 117)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 144)
