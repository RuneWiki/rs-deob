...
public abstract class class596 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILs;)V", line = 5)
    public static final void method3211(int arg0, class358 arg1) {
        class116.field1542[arg0] = arg1;
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IB)Lvb;", line = 36)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)I", line = 79)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILjava/awt/Component;ILoq;)Lnr;", line = 82)
