...
public class class596 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILha;BI)V", line = 34)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIIIIII)V", line = 581)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Ld;Luu;I)V", line = 598)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)V", line = 611)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)V", line = 628)
