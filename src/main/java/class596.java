...
public class class596 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)[Lpv;", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjava/util/Random;I)I", line = 116)
    ...
    @OriginalMember(owner = "client!et", name = "toString", descriptor = "()Ljava/lang/String;", line = 146)
    public final String toString() {
        field8311++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lha;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(B)V", line = 263)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(I)V", line = 275)
