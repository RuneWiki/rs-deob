...
public class class596 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)[Ljca;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Loa;IIIILqd;)V")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(IILvt;)V")
