...
public class class596 extends class270 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "([IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I[III)V", line = 79)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIII)Z", line = 98)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I[Ldl;Lap;)Llj;", line = 116)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(IIIIIIIII)V", line = 184)
