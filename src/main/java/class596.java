...
public class class596 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!on", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lqba;II)V", line = 28)
