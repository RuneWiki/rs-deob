...
public class class596 extends class60 {
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lqo;Loea;[Lrh;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(CIIIZLaa;II)V", line = 243)
    ...
    @OriginalMember(owner = "client!th", name = "fa", descriptor = "(CIIIZ)V", line = 289)
