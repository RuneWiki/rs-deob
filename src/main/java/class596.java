...
public class class596 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BI)Ljq;", line = 6)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I[B)Lvfa;", line = 38)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIB)Z", line = 152)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 170)
