...
public class class596 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILun;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILi;ZILr;BIIIBILi;ILcf;)Lda;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILun;B)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IILr;ILcf;II)Lda;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIIZILi;Lcf;ILr;ZILi;I)Lda;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IILcf;ILr;II)Lda;")
