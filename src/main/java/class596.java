...
public class class596 extends class1 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BIILha;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)V", line = 55)
