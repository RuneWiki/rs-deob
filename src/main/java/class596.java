...
public class class596 extends class683 {
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(BLwv;)V", line = 20)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Llea;)V", line = 255)
    ...
    @OriginalMember(owner = "client!tda", name = "c", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(I)V", line = 243)
