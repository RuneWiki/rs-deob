...
public class class596 extends class719 implements class362 {
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lha;Ldja;IIIIIZIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ul", name = "j", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lha;ZII)Luf;", line = 96)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Lha;B)Lpw;", line = 128)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lha;B)Lhq;", line = 142)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(ILha;)V", line = 182)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lha;I)V", line = 209)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)I", line = 221)
    ...
    @OriginalMember(owner = "client!ul", name = "h", descriptor = "(I)Z", line = 232)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)I", line = 244)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILha;I)Lka;", line = 256)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILsf;Lha;BIIZ)V", line = 278)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILha;)V", line = 313)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZLha;I)Z", line = 344)
    ...
    @OriginalMember(owner = "client!ul", name = "g", descriptor = "(I)I", line = 366)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)I", line = 380)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(B)Z", line = 390)
    ...
    @OriginalMember(owner = "client!ul", name = "i", descriptor = "(I)V", line = 408)
