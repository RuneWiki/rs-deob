...
public class class790 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(II)Llr;", line = 151)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ILha;II)V", line = 184)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Ldt;ILwia;Lwia;)V", line = 742)
