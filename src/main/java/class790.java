...
public class class790 extends class24 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ILjp;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lke;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lhe;I)Z", line = 29)
