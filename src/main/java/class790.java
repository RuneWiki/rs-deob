...
public class class790 extends class334 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IZLol;)V", line = 8)
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "()V", line = 311)
    public class790() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tea", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(II)[I", line = 125)
    ...
    @OriginalMember(owner = "client!tea", name = "f", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IZI)V", line = 326)
