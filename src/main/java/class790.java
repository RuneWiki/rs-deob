...
public class class790 extends class394 {
    ...
    @OriginalMember(owner = "client!wia", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wia", name = "c", descriptor = "(I)Lbv;", line = 44)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lcb;ZLhk;ZIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lwk;IIIIII)V", line = 120)
