...
public class class362 extends class333 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIILjava/lang/Class;)Let;", line = 12)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(IIIIIZ)V", line = 288)
