...
public class class362 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIF)F")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IF)I")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lsv;Lpv;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(IIF)F")
