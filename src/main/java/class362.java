...
public class class362 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ltl;IB)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ltl;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lco;IIIII)V")
