...
public class class362 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILrs;)V", line = 8)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lrs;IB)V", line = 23)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lrs;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lrs;II)V", line = 73)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLrs;)V", line = 429)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lrs;IILmp;)V", line = 459)
