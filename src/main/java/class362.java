...
public class class362 extends class584 {
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILfp;)V", line = 21)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ZZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(Lnfa;Ljo;Lie;)V", line = 66)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILld;B)V", line = 86)
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(B)Z", line = 100)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILoa;)V", line = 112)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(BLpi;)V", line = 161)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(III)V", line = 194)
    ...
    @OriginalMember(owner = "client!jba", name = "f", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!jba", name = "d", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(BII)I", line = 250)
