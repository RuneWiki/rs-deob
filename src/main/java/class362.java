...
public class class362 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIIIIIILen;)V", line = 8)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 156)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)V", line = 222)
