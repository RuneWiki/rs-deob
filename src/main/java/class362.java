...
public class class362 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIZ)I", line = 54)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILtq;)Ljava/lang/String;", line = 265)
