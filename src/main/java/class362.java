...
public abstract class class362 extends class510 {
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IZ[IBILih;)Lwh;", line = 59)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(IIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)Z", line = 99)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIILih;I)Lwh;", line = 133)
