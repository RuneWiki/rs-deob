...
public class class362 {
    ...
    @OriginalMember(owner = "client!vh", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field5263.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!vh", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!vh", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
