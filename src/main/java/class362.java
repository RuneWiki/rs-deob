...
public class class362 extends class265 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(FB)V", line = 6)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(FB)V", line = 21)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(I)V", line = 34)
