...
public class class362 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IB)V", line = 33)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)Z", line = 96)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(IB)Luq;", line = 107)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lal;ILnd;Lnd;)V", line = 194)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)Lbh;", line = 147)
