...
public class class362 extends class314 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILpca;)V")
    ...
    @OriginalMember(owner = "client!wj", name = "h", descriptor = "(I)Lkt;")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BLie;I)V")
