...
public abstract class class362 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(III)Lkn;", line = 77)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!df", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 106)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 126)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIILjava/lang/String;IZII)V", line = 152)
    ...
    @OriginalMember(owner = "client!df", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 194)
    public final void windowDeactivated(WindowEvent arg0) {
        field5129++;
    }

    @OriginalMember(owner = "client!df", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 201)
    public static final void provideLoaderApplet(Applet arg0) {
        class343.field4881 = arg0;
        field5112++;
    }

    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)Z", line = 209)
    ...
    @OriginalMember(owner = "client!df", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 246)
    public final void update(Graphics arg0) {
        field5123++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 256)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)Z", line = 305)
    ...
    @OriginalMember(owner = "client!df", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 318)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(B)Z", line = 334)
    ...
    @OriginalMember(owner = "client!df", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 346)
    ...
    @OriginalMember(owner = "client!df", name = "stop", descriptor = "()V", line = 357)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(Z)V", line = 371)
    ...
    @OriginalMember(owner = "client!df", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 421)
    public final void windowOpened(WindowEvent arg0) {
        field5119++;
    }

    @OriginalMember(owner = "client!df", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 429)
    ...
    @OriginalMember(owner = "client!df", name = "d", descriptor = "(I)V", line = 446)
    ...
    @OriginalMember(owner = "client!df", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 480)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)Z", line = 507)
    ...
    @OriginalMember(owner = "client!df", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 522)
    public final void windowActivated(WindowEvent arg0) {
        field5101++;
    }

    @OriginalMember(owner = "client!df", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 531)
    public final void windowIconified(WindowEvent arg0) {
        field5128++;
    }

    @OriginalMember(owner = "client!df", name = "d", descriptor = "(Z)Z", line = 542)
    ...
    @OriginalMember(owner = "client!df", name = "run", descriptor = "()V", line = 553)
    ...
    @OriginalMember(owner = "client!df", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 672)
    ...
    @OriginalMember(owner = "client!df", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 690)
    public final void windowDeiconified(WindowEvent arg0) {
        field5100++;
    }

    @OriginalMember(owner = "client!df", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 697)
    public final void focusLost(FocusEvent arg0) {
        class366.field5185 = false;
        field5122++;
    }

    @OriginalMember(owner = "client!df", name = "destroy", descriptor = "()V", line = 714)
    ...
    @OriginalMember(owner = "client!df", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 728)
    public final void windowClosing(WindowEvent arg0) {
        field5108++;
        this.destroy();
    }

    @OriginalMember(owner = "client!df", name = "g", descriptor = "(I)V", line = 736)
    ...
    @OriginalMember(owner = "client!df", name = "start", descriptor = "()V", line = 780)
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "(B)Ljava/lang/String;", line = 798)
    ...
    @OriginalMember(owner = "client!df", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 809)
