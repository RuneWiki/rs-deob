...
public class class362 extends class276 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(IIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lwu;I)I", line = 172)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(B)Z", line = 207)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)Z", line = 249)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Laaa;Laaa;II)V", line = 265)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Luca;)V", line = 421)
    public class362(class287 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BI)V", line = 426)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(I)I", line = 444)
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(B)Z", line = 456)
