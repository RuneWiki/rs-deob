...
public class class362 extends class42 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "([III)V", line = 4)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZZ)Z", line = 127)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)V", line = 163)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIF)V", line = 190)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(I)V", line = 310)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(II)V", line = 321)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIB)V", line = 335)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(II)V", line = 348)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lui;IIIII)V", line = 374)
