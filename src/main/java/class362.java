...
public class class362 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lvk;)V", line = 101)
    public class362(class56 arg0) {
        this.field5225 = arg0;
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IBI)I", line = 25)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)Lfb;", line = 55)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)Lfb;", line = 70)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)V", line = 118)
