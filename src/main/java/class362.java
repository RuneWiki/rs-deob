...
public class class362 extends class215 implements class448 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(BLza;)Luc;")
    ...
    @OriginalMember(owner = "client!hv", name = "e", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lza;Ler;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIZILot;Lza;)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lza;IB)Le;")
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLza;ZI)Luu;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILza;BI)Z")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IBLza;)Le;")
