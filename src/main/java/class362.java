...
public class class362 extends class576 implements class716 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Loaa;Z)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BILjaclib/memory/Source;I)Z")
