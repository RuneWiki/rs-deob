...
public abstract class class362 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III[[[Lve;IZ)Z", line = 406)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)Z", line = 737)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(B)V", line = 761)
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(I)V", line = 791)
