...
public class class362 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)Luu;")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I[I[ILst;[I)V")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lpca;ILbi;)V")
