...
public class class362 extends class337 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IBLuu;)V", line = 5)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(B)Z", line = 20)
    public final boolean method257(byte arg0) {
        ++field4770;
        return arg0 >= 115;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZII)V", line = 36)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZI)V", line = 46)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(II)Z", line = 58)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lmh;)V", line = 70)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BZ)V", line = 155)
