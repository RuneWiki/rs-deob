...
public class class362 extends class128 {
    ...
    @OriginalMember(owner = "client!kq", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lck;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lck;IIII)V")
