...
public class class362 extends class418 {
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILir;)V", line = 32)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILa;Ltj;)I", line = 84)
