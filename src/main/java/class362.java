...
public class class362 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZILfd;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lfd;I)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ldt;Loa;BLkq;)V")
