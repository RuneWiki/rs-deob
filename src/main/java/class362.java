...
public class class362 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Luh;II)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Luh;I)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BLsk;)V")
