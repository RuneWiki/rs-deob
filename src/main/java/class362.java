...
public class class362 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lji;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 96)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)Z", line = 115)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILhs;)I", line = 126)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II[Ljava/lang/String;B)Ljava/lang/String;", line = 154)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILji;Z)V", line = 215)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Loa;I)V", line = 251)
