...
public class class362 extends class37 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IILrr;[II)Z")
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "()Ldm;")
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "()Ldm;")
    public final synchronized class37 method244() {
        field4966++;
        return null;
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IZLtv;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZLss;)Z")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BLrr;)I")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lrr;B)Z")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IZLrr;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILrr;)I")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZZILtv;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lrr;I)I")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BILtm;Ltv;Lvh;)Z")
