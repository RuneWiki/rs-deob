...
public class class362 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLjava/lang/String;Lag;I)Lvk;", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IB)V", line = 44)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)V", line = 60)
