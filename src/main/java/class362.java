...
public class class362 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IBIZLdn;I)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)Lff;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)Lff;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lff;I)V")
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)Lff;")
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(I)Lff;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILas;B)V")
