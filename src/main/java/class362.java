...
public class class362 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZILdg;)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 130)
    public class362(String arg0, String arg1, String arg2, String arg3) {
        this.field5172 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ltq;Ltq;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!iq", name = "toString", descriptor = "()Ljava/lang/String;", line = 194)
