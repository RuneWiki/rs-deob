...
public class class362 extends class659 implements class103 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IF)F", line = 101)
    public final float method758(int arg0, float arg1) {
        ++field4816;
        return arg0 != 12943 ? -0.03880803F : arg1;
    }

    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BI)I", line = 113)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Z)I", line = 124)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIII[IIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZZI)V", line = 162)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ldda;Lfca;II[FII)V", line = 172)
    ...
    @OriginalMember(owner = "client!wj", name = "h", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ldda;Lfca;Lbv;II)V", line = 197)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)Z", line = 210)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZIIIIIILfca;[B)V", line = 222)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(FI)F", line = 248)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ldda;Lfca;II[BII)V", line = 262)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ldda;II[III)V", line = 278)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)I", line = 291)
