...
public class class362 extends class6 implements class313 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!sf", name = "finalize", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lef;III)V", line = 165)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lef;IIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lem;III)V", line = 69)
    ...
    @OriginalMember(owner = "client!sf", name = "f", descriptor = "(I)V", line = 145)
