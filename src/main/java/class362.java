...
public class class362 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II)Lsl;", line = 35)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Llo;ILnl;Lnl;)V", line = 86)
