...
public class class362 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Ljava/lang/String;I)[B")
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(ILuia;)Z")
