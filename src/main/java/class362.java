...
public abstract class class362 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lwk;", line = 29)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)V", line = 61)
