...
public class class362 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)Loq;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Loq;BJ)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "([Loq;I)I")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IBIILbt;Lqq;Z)V")
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)Loq;")
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(I)Loq;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IJ)Loq;")
