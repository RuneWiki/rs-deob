...
public class class362 extends class647 {
    ...
    @OriginalMember(owner = "client!ng", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 16)
    public class362() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ng", name = "h", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIII)[B", line = 47)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ZIB)V", line = 60)
