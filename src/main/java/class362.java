...
public class class362 extends class109 implements class193 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lko;Ljava/lang/String;IB)Laa;", line = 11)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Luo;Lgm;IIIIZIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILuo;I)Lmj;", line = 134)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Luo;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BZLuo;I)Lvg;", line = 176)
    ...
    @OriginalMember(owner = "client!iq", name = "d", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(B)Z", line = 224)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IBIILrr;Luo;Z)V", line = 238)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!iq", name = "g", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Luo;IZ)Lmj;", line = 390)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILuo;)V", line = 409)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)I", line = 437)
    public final int method689(byte arg0) {
        ++field5010;
        return arg0 != -83 ? -31 : 65535 & this.field5013;
    }

    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(I)I", line = 448)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZLuo;)Laj;", line = 459)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IILuo;I)Z", line = 486)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)I", line = 509)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Luo;I)V", line = 528)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(B)Z", line = 541)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IBI)V", line = 551)
