...
public class class362 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(II)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IILud;)V", line = 82)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(JJ)J", line = 180)
    public static long method2256(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(ILud;)V", line = 191)
    ...
    @OriginalMember(owner = "client!uia", name = "c", descriptor = "(II)Z", line = 211)
