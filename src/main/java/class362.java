...
public class class362 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lfs;II)Lum;")
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "()Ljs;")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Liv;)V")
