...
public class class362 extends class447 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IILeb;)V", line = 6)
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILeb;)V", line = 65)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(BLqj;)I", line = 92)
    ...
    @OriginalMember(owner = "client!pe", name = "f", descriptor = "(I)V", line = 129)
