...
public class class362 extends class64 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lgl;Lka;)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lle;)V")
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "()Lle;")
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Lle;)V")
    public final synchronized void method2213(class64 arg0) {
        arg0.method1967(-1);
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "()Lle;")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lka;)V")
