...
public class class362 extends class43 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lnh;B)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILwo;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Luo;ILip;[[I[[BILip;I[[B[[B[[BZI)V")
