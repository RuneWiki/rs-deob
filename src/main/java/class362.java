...
public class class362 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lr;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I[B)[B", line = 113)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BI)Llf;", line = 195)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(II)V", line = 259)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IB)I", line = 323)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)I", line = 336)
