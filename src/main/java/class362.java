...
public class class362 {
    ...
    @OriginalMember(owner = "client!pca", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field5144++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(JJ)J", line = 13)
    public static long method2185(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Ljava/lang/String;IZI)I", line = 89)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IZ)Li;", line = 167)
