...
public class class362 extends class423 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!fga", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lcg;Ltba;[Lbe;[I[I)V")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(CIIIZLaa;II)V")
