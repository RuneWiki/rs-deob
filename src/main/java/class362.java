...
public class class362 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILka;IZIIIILha;IIILhg;)Lka;", line = 35)
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(B)Z", line = 206)
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(II)Z", line = 245)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(B)V", line = 257)
