...
public class class362 implements class155 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lja;IIIII)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BLqa;)Z")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lhe;ZI)Lrp;")
