...
public class class362 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)V", line = 5)
    public static void method2271(byte arg0) {
        field5363 = null;
        int var1 = 103 % ((-arg0 - 89) / 33);
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lst;ILya;)I", line = 23)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III)Z", line = 47)
