...
public class class168 extends class37 {
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(I)V", line = 3)
    public class168(int arg0) {
        this.field2534 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ffa", name = "f", descriptor = "(I)V", line = 25)
