...
public class class168 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "([B)[Lqga;")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lsea;II)[Lqga;")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lsea;I)Lqga;")
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(Lsea;I)[Lqga;")
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(Lsea;II)Lqga;")
