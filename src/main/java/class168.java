...
public class class168 extends class9 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIB)Z", line = 14)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILjava/lang/String;Los;)I", line = 28)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lfr;Lts;)V", line = 70)
