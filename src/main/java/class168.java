...
public class class168 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILol;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IILol;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIJZ)Ljava/lang/String;", line = 83)
