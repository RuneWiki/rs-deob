...
public class class168 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIZ)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)Lwb;", line = 21)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)Lwb;", line = 32)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "()V", line = 89)
    public class168() {
    }

    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Ldfa;)V", line = 91)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IILlga;JIZII)V", line = 68)
