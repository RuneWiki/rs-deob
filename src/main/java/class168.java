...
public class class168 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Z)V", line = 185)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(B)I", line = 233)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "()V", line = 256)
    private class168() {
    }

    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "([I)V", line = 260)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZLjava/lang/String;ZI)I", line = 279)
