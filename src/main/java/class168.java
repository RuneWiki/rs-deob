...
public class class168 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)Lo;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)Lo;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lmi;B)V")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lmi;)V")
