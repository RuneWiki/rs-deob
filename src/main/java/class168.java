...
public class class168 {
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILic;)V")
