...
public class class168 extends class298 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "e", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "()V", line = 150)
    public class168() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILvt;)V", line = 63)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(CI)Z", line = 108)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lrs;III)V", line = 121)
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IZ)[I", line = 177)
