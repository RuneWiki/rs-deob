...
public class class168 extends class56 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(BILes;)V", line = 8)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(II)[I", line = 82)
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "()V", line = 236)
    public class168() {
        super(0, true);
    }
}
