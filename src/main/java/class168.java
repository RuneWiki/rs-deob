...
public class class168 extends class96 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIILjava/util/Random;I[[II)V", line = 8)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "()V", line = 205)
    public class168() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ju", name = "e", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!ju", name = "e", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IILbt;)V", line = 232)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIB)V", line = 344)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIIIII)V", line = 365)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(II)[I", line = 972)
