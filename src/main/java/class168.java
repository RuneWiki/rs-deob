...
public class class168 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lpfa;III)Lek;", line = 45)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIII[FIIIFIF)V", line = 92)
