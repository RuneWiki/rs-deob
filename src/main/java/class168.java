...
public class class168 implements class283 {
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I[I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(III)V", line = 79)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IZ)I", line = 106)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILjava/awt/Component;Z)V", line = 140)
