...
public abstract class class168 extends class186 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([[IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)[Lsn;", line = 27)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(IIII)V", line = 79)
