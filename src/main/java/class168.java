...
public class class168 extends class134 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "([[ZIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(SB)V", line = 95)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Lln;Lum;Lada;[I)V", line = 286)
