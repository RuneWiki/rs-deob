...
public class class168 extends class401 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II[JI[Ljava/lang/Object;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 83)
    public class168(Object arg0, int arg1) {
        super(arg1);
        this.field2159 = arg0;
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)Z", line = 93)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 117)
