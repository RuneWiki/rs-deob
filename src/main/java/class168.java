...
public class class168 extends InputStream {
    ...
    @OriginalMember(owner = "client!pca", name = "read", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BLds;)I", line = 27)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIB)Z", line = 74)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)Lap;", line = 102)
