...
public class class168 extends class311 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lij;II)Lrm;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([I)Ldg;")
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lij;)Z")
