...
public class class168 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lva;IIIII)Lva;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLae;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IILae;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IBIIIIBLva;)Lva;")
