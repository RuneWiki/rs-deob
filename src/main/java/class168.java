...
public class class168 {
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "()V", line = 15)
    public class168() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "([BILek;)V", line = 67)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "([BB)[B", line = 92)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(III)V", line = 128)
