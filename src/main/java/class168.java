...
public class class168 {
    ...
    @OriginalMember(owner = "client!wea", name = "finalize", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Luv;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lhk;II)V", line = 59)
