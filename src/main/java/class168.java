...
public class class168 implements Runnable {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Z)Z", line = 15)
    ...
    @OriginalMember(owner = "client!bga", name = "run", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(II)Lat;", line = 99)
