...
public class class168 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Ljs;Ljava/lang/Object;B)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Ljava/lang/String;Lpc;ZB)Lqi;")
