...
public class class168 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ILd;)V", line = 32)
    public static final void method1005(int arg0, class137 arg1) {
        class628.field8912[arg0] = arg1;
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Z)V", line = 39)
