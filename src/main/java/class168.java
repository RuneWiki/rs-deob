...
public class class168 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILbl;)V", line = 6)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZC)Z", line = 59)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)V", line = 74)
