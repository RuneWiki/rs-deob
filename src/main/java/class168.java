...
public class class168 {
    ...
    @OriginalMember(owner = "client!ud", name = "finalize", descriptor = "()V", line = 9)
    protected final void finalize() throws Throwable {
        this.field2273.method1917(this.field2274);
        super.finalize();
    }

    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lse;II)V", line = 12)
    private class168(class282 arg0, int arg1, int arg2) {
        this.field2273 = arg0;
        this.field2274 = arg2;
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lse;ILjava/lang/String;)Lud;", line = 20)
