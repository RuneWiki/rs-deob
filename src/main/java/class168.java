...
public class class168 extends class547 {
    ...
    @OriginalMember(owner = "client!qga", name = "f", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 14)
    public class168(Object arg0, int arg1) {
        super(arg1);
        this.field2427 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!qga", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 23)
