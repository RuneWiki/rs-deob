...
public class class168 extends class474 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lsn;)Lmg;", line = 8)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
