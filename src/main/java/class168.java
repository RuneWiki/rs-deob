...
public class class168 extends class30 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lap;)V", line = 16)
    public final void method266(class26 arg0) {
        this.field405.method1653(arg0);
    }

    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "()Z", line = 110)
    public final boolean method262() {
        return true;
    }

    @OriginalMember(owner = "client!bo", name = "c", descriptor = "()V", line = 114)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lnm;Lvq;)V", line = 141)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Z)V", line = 203)
