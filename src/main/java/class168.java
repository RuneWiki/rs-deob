...
public class class168 {
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lad;)V", line = 187)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "([IZLad;BII)Lah;", line = 11)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(III)V", line = 175)
