...
public class class168 extends class304 {
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "()Lti;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILlm;I)V")
    ...
    @OriginalMember(owner = "client!se", name = "d", descriptor = "()Lti;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "([IIILlm;II)V")
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Ldv;)V")
