...
public class class168 extends class386 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!ffa", name = "c", descriptor = "(III)Ldn;", line = 39)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ZILjn;)Ltea;", line = 57)
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "()V", line = 73)
    public class168() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(BZ)V", line = 76)
