...
public class class168 extends class562 implements class247 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II[[I[[IIII)Li;", line = 3)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIZ)Lf;", line = 20)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lit;)V", line = 38)
    public final void method1048(class513 arg0) {
    }

    @OriginalMember(owner = "client!l", name = "q", descriptor = "()V", line = 41)
    public final void method1050() {
    }

    @OriginalMember(owner = "client!l", name = "WA", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 50)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIILua;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Z)V", line = 85)
    public final void method1058(boolean arg0) {
    }

    @OriginalMember(owner = "client!l", name = "m", descriptor = "()V", line = 91)
    public final void method1061() {
    }

    @OriginalMember(owner = "client!l", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!l", name = "C", descriptor = "()Z", line = 109)
    public final boolean method1065() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "fa", descriptor = "()Ljava/lang/Object;", line = 114)
    private final Object method1067() {
        return new class497(this);
    }

    @OriginalMember(owner = "client!l", name = "s", descriptor = "()Z", line = 118)
    public final boolean method1069() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!l", name = "u", descriptor = "()Z", line = 124)
    public final boolean method1071() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "d", descriptor = "()Z", line = 133)
    public final boolean method1074() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "e", descriptor = "()Lq;", line = 136)
    public final class487 method1075() {
        return new class280();
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIZ)Lf;", line = 139)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(I)Le;", line = 149)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(FFF)V", line = 153)
    public final void method1079(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)I", line = 156)
    public final int method1080(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!l", name = "f", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!l", name = "B", descriptor = "()Z", line = 167)
    public final boolean method1084() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "D", descriptor = "()Lqa;", line = 173)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "()Z", line = 188)
    public final boolean method1087() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lcca;IIII)Lda;", line = 193)
    ...
    @OriginalMember(owner = "client!l", name = "z", descriptor = "()V", line = 200)
    public final void method1092() {
    }

    @OriginalMember(owner = "client!l", name = "b", descriptor = "(Z)V", line = 204)
    public final void method1093(boolean arg0) {
    }

    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lfa;)V", line = 355)
    ...
    @OriginalMember(owner = "client!l", name = "y", descriptor = "()Z", line = 212)
    public final boolean method1094() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lec;)V", line = 217)
    ...
    @OriginalMember(owner = "client!l", name = "t", descriptor = "()Z", line = 223)
    public final boolean method1098() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "i", descriptor = "()Z", line = 226)
    public final boolean method1099() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "finalize", descriptor = "()V", line = 229)
    ...
    @OriginalMember(owner = "client!l", name = "p", descriptor = "()Z", line = 235)
    public final boolean method1100() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "e", descriptor = "(IIIIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!l", name = "A", descriptor = "(S)Z", line = 242)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "()Z", line = 255)
    public final boolean method1106() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lf;Z)V", line = 259)
    ...
    @OriginalMember(owner = "client!l", name = "g", descriptor = "(I)V", line = 271)
    public final void method1109(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I[Lqea;)V", line = 280)
    ...
    @OriginalMember(owner = "client!l", name = "n", descriptor = "()Z", line = 298)
    public final boolean method1112() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "o", descriptor = "()V", line = 301)
    public final void method1114() {
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lec;Z)V", line = 306)
    ...
    @OriginalMember(owner = "client!l", name = "w", descriptor = "()Z", line = 336)
    public final boolean method1117() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lec;I)V", line = 345)
    public final void method1120(class144 arg0, int arg1) {
        this.method1116(arg0, false);
        this.method1086().method1183(this, field2412, field2398, field2400, field2413, arg0.field1942.method1880(39));
    }

    @OriginalMember(owner = "client!l", name = "b", descriptor = "(IIIIII)V", line = 349)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([IIIII)Lf;", line = 382)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lq;)V", line = 417)
    public final void method1123(class487 arg0) {
        this.field2405 = arg0;
        this.method1105(arg0);
    }

    @OriginalMember(owner = "client!l", name = "A", descriptor = "()V", line = 423)
    public final void method1125() {
    }

    @OriginalMember(owner = "client!l", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 427)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([I)V", line = 441)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II[I[I)Lua;", line = 447)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Le;)V", line = 453)
    public final void method1129(class381 arg0) {
        this.field2402 = (class106) arg0;
        this.method1047(arg0);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Laga;[Ltq;Z)Lla;", line = 458)
    ...
    @OriginalMember(owner = "client!l", name = "W", descriptor = "(S)Z", line = 495)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 524)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "()I", line = 543)
    public final int method1133() {
        return 4;
    }

    @OriginalMember(owner = "client!l", name = "g", descriptor = "()Z", line = 548)
    public final boolean method1135() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "k", descriptor = "()Lq;", line = 551)
    public final class487 method1136() {
        return this.field2405;
    }

    @OriginalMember(owner = "client!l", name = "c", descriptor = "(IIIIII)Lit;", line = 556)
    public final class513 method1138(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ltq;Z)Lf;", line = 561)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIII)V", line = 642)
    public final void method1140(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!l", name = "l", descriptor = "()Laa;", line = 646)
    public final class102 method1141() {
        return new class102(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!l", name = "h", descriptor = "()V", line = 654)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 685)
    ...
    @OriginalMember(owner = "client!l", name = "x", descriptor = "()V", line = 717)
    public final void method1150() {
        this.method1143(this.field2410.field5973);
    }

    @OriginalMember(owner = "client!l", name = "j", descriptor = "()V", line = 726)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIF)Lqea;", line = 740)
    ...
    @OriginalMember(owner = "client!l", name = "r", descriptor = "()Lq;", line = 743)
    public final class487 method1153() {
        return this.field2407;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lit;Lit;FLit;)Lit;", line = 746)
