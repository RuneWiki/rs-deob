...
public abstract class class209 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILbf;III)V", line = 77)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Z)V", line = 238)
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)Z", line = 262)
