...
public class class209 extends class211 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IZLcn;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "()V", line = 36)
    public class209() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pk", name = "g", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BILib;)V", line = 52)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "([II[FIIII[F[IIZII)V", line = 102)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B[BII)Ljava/lang/String;", line = 184)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(II)[I", line = 224)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)Lhia;", line = 292)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lha;Lap;Z)I", line = 363)
