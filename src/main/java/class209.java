...
public class class209 implements class17 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lqm;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)Lg;")
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(II)Lae;")
