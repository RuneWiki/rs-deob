...
public class class209 implements class2 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!vc", name = "d", descriptor = "(III)V", line = 141)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIII)V", line = 167)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)I", line = 183)
    ...
    @OriginalMember(owner = "client!vc", name = "e", descriptor = "(III)V", line = 198)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(II)I", line = 229)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BZ)I", line = 258)
