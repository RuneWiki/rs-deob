...
public class class209 extends class94 implements class525 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III[B)V", line = 25)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lqh;I)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lpc;I[BI)V", line = 84)
    public class209(class700 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field2478 = arg1;
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BI)Lat;", line = 96)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)J", line = 124)
