...
public class class209 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lgba;ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Led;", line = 48)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 155)
