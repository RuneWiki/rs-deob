...
public class class209 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)V", line = 23)
