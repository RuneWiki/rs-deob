...
public class class209 extends class457 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lmk;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I[J[I)V", line = 50)
    public static final void method1291(int arg0, long[] arg1, int[] arg2) {
        class299.method1751(arg1, arg2, (byte) 125, arg0, arg1.length - 1);
        ++field2920;
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!en", name = "e", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZB)V", line = 170)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lef;)V", line = 181)
    ...
    @OriginalMember(owner = "client!en", name = "f", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IZ)V", line = 305)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "([Lji;BLef;)Lbt;", line = 332)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(III)Z", line = 408)
