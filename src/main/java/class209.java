...
public class class209 extends class174 {
    ...
    @OriginalMember(owner = "client!ae", name = "ya", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IILqba;I)V")
    ...
    @OriginalMember(owner = "client!ae", name = "F", descriptor = "(Lk;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ae", name = "X", descriptor = "(IILk;)Lk;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lcba;[I)V")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lmh;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lk;IIIIZ)Z")
