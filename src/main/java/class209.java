...
public class class209 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)Lnh;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILnm;III)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Llo;ILnl;)V")
