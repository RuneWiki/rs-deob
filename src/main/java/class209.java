...
public class class209 extends InputStream {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lek;III[Z)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lrg;BIILlf;IILtm;)V")
    ...
    @OriginalMember(owner = "client!he", name = "read", descriptor = "()I")
