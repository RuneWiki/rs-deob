...
public class class209 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "([I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZIB)V", line = 57)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)I", line = 127)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLat;)V", line = 155)
