...
public class class209 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)Ldn;", line = 6)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)Ldn;", line = 39)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ZBZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "()V", line = 93)
    public class209() {
    }

    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Ltga;)V", line = 96)
