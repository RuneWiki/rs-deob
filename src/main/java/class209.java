...
public class class209 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I[Lvfa;ZIBI)V", line = 18)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IB[B)I", line = 97)
