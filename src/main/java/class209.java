...
public class class209 extends class763 implements class654 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)I", line = 35)
    public static final int method1393(int arg0) {
        ++field2774;
        return arg0 != 64 ? 34 : class500.field6909;
    }

    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lpa;Lsw;III[B)V", line = 48)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)V", line = 64)
