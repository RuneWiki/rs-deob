...
public class class209 extends class260 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(IIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZLjava/awt/Component;)Laq;", line = 47)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IB)I", line = 61)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZII)V", line = 173)
