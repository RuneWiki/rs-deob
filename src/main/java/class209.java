...
public class class209 extends class386 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIZII)Lcaa;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Ljava/awt/Canvas;ILfa;)Lr;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IBLun;)V")
