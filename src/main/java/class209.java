...
public class class209 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BLie;)V", line = 4)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIBZ)I", line = 29)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ILie;I)V", line = 60)
