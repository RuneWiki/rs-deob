...
public class class209 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)Lmp;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lcga;IIIII)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Luea;ILpq;)V")
