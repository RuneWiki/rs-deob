...
public class class209 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "Lj;")
    private class85 field4063;

    @OriginalMember(owner = "client!wg", name = "f", descriptor = "Lj;")
    private class85 field4068;

    @OriginalMember(owner = "client!wg", name = "l", descriptor = "[Lj;")
    private class85[] field4074;

    @OriginalMember(owner = "client!wg", name = "m", descriptor = "Llf;")
    private static class109 field4075 = class35.method275("Checking for updates )2 ", 2);

    @OriginalMember(owner = "client!wg", name = "n", descriptor = "I")
    public static int field4076 = 0;

    @OriginalMember(owner = "client!wg", name = "e", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!wg", name = "g", descriptor = "Lvg;")
    public static class200 field4069;

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILaa;Lbg;)Z")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I[Lvg;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(DIIIZLbg;Laa;)[I")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lja;)V")
