...
public class class209 extends class66 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lqj;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Loa;J)V")
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lqj;IIIIIIIIIIIZZ)V")
