...
public class class209 extends class213 {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lih;Lfi;[Ln;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(CIIIZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(CIIIZLsn;II)V", line = 233)
