...
public class class209 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IB)Lkp;", line = 80)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lap;Le;)V", line = 135)
