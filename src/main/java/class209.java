...
public class class209 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILap;I)V")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BIIIIIILsj;)Lsj;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIBILsj;I)Lsj;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lap;I)V")
