...
public class class209 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILnu;Lnu;F)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)Z", line = 81)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lml;)V", line = 108)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I)V", line = 116)
