...
public class class209 extends class531 {
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lqfa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(ZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZI)V", line = 89)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BII)V", line = 134)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lwia;Ld;IBLjava/awt/Canvas;)Lha;", line = 145)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IZLdca;)V", line = 175)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(B)Ljava/lang/String;", line = 219)
    ...
    @OriginalMember(owner = "client!pk", name = "d", descriptor = "(I)V", line = 237)
    public static void method1445(int arg0) {
        int var1 = -71 / ((arg0 - -54) / 58);
        field3245 = null;
    }

    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(I)V", line = 246)
