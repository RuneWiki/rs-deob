...
public class class209 extends class427 implements class226 {
    ...
    @OriginalMember(owner = "client!be", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIZIBII)V", line = 21)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 47)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)I", line = 81)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(BLha;)Lmg;", line = 92)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILha;BZ)Liu;", line = 142)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(ILha;)V", line = 174)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(B)Z", line = 213)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILha;)V", line = 233)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(Z)I", line = 262)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIIII)V", line = 273)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lha;I)Luh;", line = 301)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(I)Z", line = 329)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)I", line = 349)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BIILha;)Z", line = 359)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)Z", line = 383)
    public final boolean method1164(byte arg0) {
        ++field3062;
        return arg0 != 4 ? true : this.field3044;
    }

    @OriginalMember(owner = "client!be", name = "c", descriptor = "(ILha;)V", line = 397)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILha;I)Lka;", line = 407)
