...
public class class209 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lav;IB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)Z", line = 26)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ZZZI)V", line = 44)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(IB)Z", line = 87)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(III)V", line = 102)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lkd;)V", line = 147)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)V", line = 132)
