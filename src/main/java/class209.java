...
public class class209 extends class311 {
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIBFI)V", line = 169)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Leb;IIII)V", line = 286)
