...
public class class209 extends class413 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lae;J[Lqh;[Ldj;Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "([Ldj;Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "()V", line = 123)
    public final void method1364() {
        this.field2973 = true;
    }

    @OriginalMember(owner = "client!om", name = "c", descriptor = "()V", line = 126)
    private final void method1365() {
        this.field2967 = false;
    }

    @OriginalMember(owner = "client!om", name = "d", descriptor = "()V", line = 129)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(J)V", line = 146)
    public final void method1367(long arg0) {
        this.field2966 = arg0;
    }

    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lae;J)Z", line = 156)
    ...
    @OriginalMember(owner = "client!om", name = "e", descriptor = "()V", line = 204)
    public final void method1369() {
        this.field2967 = true;
    }

    @OriginalMember(owner = "client!om", name = "f", descriptor = "()V", line = 212)
    public static void method1370() {
        field2964 = null;
        field2962 = null;
    }

    @OriginalMember(owner = "client!om", name = "g", descriptor = "()Lgm;", line = 217)
    public final class63 method1371() {
        return this.field2974;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIII)V", line = 226)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lae;[Lqh;Z)V", line = 236)
