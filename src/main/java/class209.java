...
public class class209 extends class593 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BILbe;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)V", line = 807)
    ...
    @OriginalMember(owner = "client!eq", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 822)
    public final void startProduction(ImageConsumer arg0) {
        ++field2747;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)V", line = 831)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIIIILjava/awt/Graphics;)V", line = 847)
    ...
    @OriginalMember(owner = "client!eq", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 864)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field2738;
        return this.field2748 == arg0;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIZLjava/awt/Canvas;)V", line = 872)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIII)V", line = 895)
    ...
    @OriginalMember(owner = "client!eq", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 910)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lhba;IILkd;IIILvaa;)V", line = 924)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lkba;Z[[[BIB)Z", line = 1021)
    ...
    @OriginalMember(owner = "client!eq", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 1084)
    ...
    @OriginalMember(owner = "client!eq", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 1099)
