...
public class class209 extends class348 {
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "()Lgh;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lgh;)V")
    public final synchronized void method1313(class348 arg0) {
        arg0.method1182(28818);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lag;Ljl;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(Lgh;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "()Lgh;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljl;)V")
