...
public class class209 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)Loo;", line = 47)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lae;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ILjava/lang/String;)V", line = 125)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(III)Z", line = 193)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(II)V", line = 203)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lci;ILhe;Lhe;)V", line = 230)
