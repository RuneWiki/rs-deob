...
public abstract class class209 extends class359 {
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "()I", line = 11)
    public int method1324() {
        return 0;
    }

    @OriginalMember(owner = "client!he", name = "c", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lpo;)V", line = 28)
    public class209(class332 arg0) {
        this.field2828 = arg0;
    }

    @OriginalMember(owner = "client!he", name = "c", descriptor = "(B)Z", line = 38)
    public final boolean method1328(byte arg0) {
        int var2 = 81 % ((38 - arg0) / 57);
        return false;
    }

    @OriginalMember(owner = "client!he", name = "d", descriptor = "(I)Z", line = 46)
