...
public class class399 extends class739 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lsl;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ZI)[I", line = 48)
    ...
    @OriginalMember(owner = "client!rfa", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", line = 208)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "()V", line = 246)
    public class399() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILha;)V", line = 251)
