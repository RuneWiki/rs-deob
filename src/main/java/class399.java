...
public class class399 extends class61 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(CIIIZLaa;II)V", line = 7)
    public final void method120(char arg0, int arg1, int arg2, int arg3, boolean arg4, class489 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!hf", name = "fa", descriptor = "(CIIIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lij;Ljl;[Lhb;Z)V", line = 33)
