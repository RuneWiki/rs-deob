...
public class class399 extends class264 {
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 51)
    public class399(String arg0) {
        this.field5773 = arg0;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IB)Lvg;", line = 11)
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)V", line = 33)
