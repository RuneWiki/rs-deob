...
public class class399 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILku;)V", line = 33)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)Lku;", line = 44)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B[FI)[F", line = 57)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)I", line = 84)
    public final int method2449(int arg0) {
        field5901++;
        return arg0 == 0 ? this.field5902 : 73;
    }

    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lku;)V", line = 105)
    public class399(class342 arg0) {
        this.field5898 = arg0.field5010;
        this.field5902 = 1;
    }

    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "([Lku;)V", line = 113)
    public class399(class342[] arg0) {
