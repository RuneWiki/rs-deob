...
public class class399 extends class34 implements class620 {
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(Loa;I)Lcd;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Loa;ZII)Lid;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILoa;I)Lba;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IILoa;ILcq;ZI)V")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Loa;Lsa;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Loa;II)Lba;")
    public final class107 method63(class43 arg0, int arg1, int arg2) {
        ++field5102;
        return arg2 != 25871 ? null : this.method2281(arg1, arg0, 0);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lcp;Lgn;)V")
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(Loa;I)V")
