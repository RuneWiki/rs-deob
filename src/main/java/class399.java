...
public class class399 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lrv;III)V", line = 76)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(BILrv;)V", line = 135)
