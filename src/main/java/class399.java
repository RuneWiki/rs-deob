...
public class class399 extends class46 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Z)Ljava/lang/String;")
