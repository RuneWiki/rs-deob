...
public class class399 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(III)I", line = 82)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lew;III)V", line = 198)
