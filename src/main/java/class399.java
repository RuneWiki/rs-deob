...
public class class399 extends class101 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(III)[B", line = 12)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 17)
    public class399() {
