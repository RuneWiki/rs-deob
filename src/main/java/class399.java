...
public class class399 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ljava/awt/Canvas;ZLe;)Loa;", line = 3)
    public static final class605 method2544(Canvas arg0, boolean arg1, class462 arg2) {
        field6054++;
        return arg1 ? new class54(arg0, arg2) : null;
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIIII[I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIBI)I", line = 138)
