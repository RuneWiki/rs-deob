...
public class class399 extends class109 {
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIIBLhl;II)V", line = 69)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)J", line = 94)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIIIIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!ua", name = "d", descriptor = "(I)I", line = 151)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILtj;)V", line = 165)
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(I)Z", line = 183)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)C", line = 198)
