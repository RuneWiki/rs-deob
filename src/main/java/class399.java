...
public class class399 extends class147 {
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)Lab;", line = 104)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lg;I)V", line = 163)
