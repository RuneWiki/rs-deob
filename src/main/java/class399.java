...
public class class399 extends class601 {
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lgn;)V", line = 16)
    public class399(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BJ)V", line = 47)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)I", line = 133)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(ILgn;)V", line = 145)
    public class399(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lbda;B)V", line = 185)
