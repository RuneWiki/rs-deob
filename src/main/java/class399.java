...
public class class399 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IBLjava/lang/Object;J)V", line = 29)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BI)V", line = 73)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILjava/lang/Object;J)V", line = 122)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ZLba;)V", line = 135)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IJ)V", line = 155)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)I", line = 185)
    public static final int method2476(int arg0, int arg1) {
        return class214.field3393 == null ? 0 : class214.field3393[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(IJ)Ljava/lang/Object;", line = 216)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 260)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 291)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)I", line = 337)
