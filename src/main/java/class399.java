...
public class class399 extends class45 {
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BII)V", line = 77)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "()V", line = 102)
    public class399() {
        super(0, false);
    }

    @OriginalMember(owner = "client!hj", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)I", line = 123)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lcu;II)V", line = 135)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIIII)V", line = 160)
