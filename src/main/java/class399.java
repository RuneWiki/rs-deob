...
public class class399 implements class350 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "()V", line = 57)
    public final void method2461() {
        this.field5797 = null;
        this.method2458();
    }

    @OriginalMember(owner = "client!k", name = "finalize", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lw;II)V", line = 90)
