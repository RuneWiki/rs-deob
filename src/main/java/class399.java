...
public class class399 extends class729 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IBC)I", line = 3)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(JJ)J", line = 141)
