...
public class class399 extends class56 {
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 7)
    public class399() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)[I", line = 32)
