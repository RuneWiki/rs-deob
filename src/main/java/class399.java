...
public class class399 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IBIIIII)I", line = 24)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILjava/lang/String;)V", line = 71)
