...
public class class399 extends class98 {
    ...
    @OriginalMember(owner = "client!ua", name = "f", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ZII)V", line = 20)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ZLae;I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "()V", line = 504)
    public class399() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(II)V", line = 507)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIZII[ILp;IIIIIII[I)I", line = 520)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(II)[[I", line = 695)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ltq;I)I", line = 738)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)[I", line = 804)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(Z)V", line = 850)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILdg;I)V", line = 895)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(BII)V", line = 914)
