...
public class class399 extends class449 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZLfo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILwt;I)Ldg;", line = 65)
    ...
    @OriginalMember(owner = "client!ve", name = "d", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lae;Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!ve", name = "e", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIIIZZ)V", line = 194)
