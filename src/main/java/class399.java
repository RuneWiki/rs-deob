...
public class class399 implements Runnable {
    ...
    @OriginalMember(owner = "client!qt", name = "run", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lga;B)V", line = 93)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IILcr;)Lmq;", line = 120)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ZILcr;)Lmq;", line = 161)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lmq;B)V", line = 185)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IBLcr;[B)Lmq;", line = 201)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lgba;)V", line = 257)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)I", line = 230)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)V", line = 247)
