...
public class class399 extends class577 implements class231 {

    @OriginalMember(owner = "client!cq", name = "N", descriptor = "Lpc;")
    public class577 field5483;
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(B)I", line = 5)
    public final int method173(byte arg0) {
        field5478++;
        int var2 = -39 / ((arg0 + 43) / 49);
        return 0;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BLqa;)V", line = 15)
    public final void method174(byte arg0, class208 arg1) {
        field5473++;
        if (arg0 >= -36) {
            this.method194(-116, null);
        }
    }

    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(IIIIIIIIIILpc;)V", line = 25)
    public class399(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, class577 arg10) {
        super(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, false, class416.method2452(arg0, 1, arg1));
        this.field5483 = arg10;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lqa;IZIILco;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BILqa;)Lr;", line = 74)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(ILqa;)Lin;", line = 87)
    public final class77 method181(int arg0, class208 arg1) {
        field5479++;
        return arg0 <= 0 ? null : null;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lqa;I)Lpl;", line = 98)
    public final class558 method189(class208 arg0, int arg1) {
        if (arg1 != 31733) {
            this.method174((byte) 68, null);
        }
        field5488++;
        return this.field5483.method189(arg0, 31733);
    }

    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(B)Z", line = 110)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILqa;IB)Z", line = 121)
    ...
    @OriginalMember(owner = "client!cq", name = "e", descriptor = "(B)I", line = 133)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILqa;)V", line = 144)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(BLqa;)V", line = 154)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(I)I", line = 170)
    ...
    @OriginalMember(owner = "client!cq", name = "e", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)I", line = 191)
