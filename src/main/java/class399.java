...
public class class399 extends class281 {
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(IIIIIFFF)V", line = 6)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IZII)V", line = 18)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(Z)V", line = 229)
