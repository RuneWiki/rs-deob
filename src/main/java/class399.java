...
public abstract class class399 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BLbn;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(B)V", line = 135)
