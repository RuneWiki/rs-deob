...
public class class399 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Z)V", line = 29)
