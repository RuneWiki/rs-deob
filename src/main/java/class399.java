...
public class class399 extends class38 {
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIZ)Ll;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Ljava/lang/Runnable;)Ldc;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II[I[I)Lma;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lu;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIIF)Ljd;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lkq;IIII)Lt;")
    ...
    @OriginalMember(owner = "client!cv", name = "o", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!cv", name = "y", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lb;III)V")
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(ILga;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([Lt;Lpn;Lc;[Lii;I)V")
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([IIIII)Ll;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([Lt;Lc;[Lii;I)V")
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(IIIIII)Lmh;")
    public final class444 method303(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lpn;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lmh;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "ea", descriptor = "(Lc;)V")
    public final void method299(class122 arg0) {
        this.field5862 = (class394) arg0;
    }

    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II[[I[[IIII)Lta;")
    ...
    @OriginalMember(owner = "client!cv", name = "ca", descriptor = "(ILma;II)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I[Ljd;)V")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lft;Z)Ll;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lmh;Lmh;FLmh;)Lmh;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Ldq;[Lft;Z)Lla;")
