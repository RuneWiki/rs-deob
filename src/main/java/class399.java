...
public class class399 extends class40 {
    ...
    @OriginalMember(owner = "client!ia", name = "s", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(IZ)I", line = 21)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I[BII)V", line = 63)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(I)V", line = 83)
    public class399(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ia", name = "t", descriptor = "(I)V", line = 86)
    public final void method2367(int arg0) {
        ++field5815;
        this.field5818 = super.field585 * arg0;
    }

    @OriginalMember(owner = "client!ia", name = "o", descriptor = "(II)I", line = 96)
    ...
    @OriginalMember(owner = "client!ia", name = "l", descriptor = "(B)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ia", name = "p", descriptor = "(II)I", line = 129)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!ia", name = "u", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ia", name = "i", descriptor = "(Z)V", line = 173)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([IB)V", line = 188)
