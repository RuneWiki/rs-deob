...
public abstract class class399 extends class421 {
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I[Lqm;)I")
    ...
    @OriginalMember(owner = "client!fha", name = "j", descriptor = "(I)V")
