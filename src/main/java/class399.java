...
public class class399 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)Lcv;")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lan;B)Lgs;")
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lvo;Lvo;)V")
