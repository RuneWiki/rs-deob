...
public class class399 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Object;ILjava/applet/Applet;)Ljava/lang/Object;", line = 25)
