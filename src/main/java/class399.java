...
public class class399 extends class139 {
    ...
    @OriginalMember(owner = "client!uba", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Ltga;Lpfa;)V", line = 40)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(BILgl;)V", line = 60)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!uba", name = "d", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(III)V", line = 105)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Z)V", line = 148)
    ...
    @OriginalMember(owner = "client!uba", name = "e", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(I)Z", line = 195)
    public final boolean method152(int arg0) {
        int var2 = 127 / ((arg0 - 50) / 48);
        return this.field5070;
    }

    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ZI)V", line = 203)
    ...
    @OriginalMember(owner = "client!uba", name = "c", descriptor = "(B)V", line = 215)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IZ)V", line = 252)
