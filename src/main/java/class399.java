...
public class class399 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIII[I)V", line = 24)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIIIIIIII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)V", line = 702)
