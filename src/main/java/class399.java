...
public class class399 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IZZLea;Lea;ILcc;Lok;IIZI)Lwn;")
    ...
    @OriginalMember(owner = "client!cp", name = "f", descriptor = "(B)Lkm;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)Lkm;")
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)Lkm;")
    ...
    @OriginalMember(owner = "client!cp", name = "d", descriptor = "(I)Lkm;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lkm;I)V")
