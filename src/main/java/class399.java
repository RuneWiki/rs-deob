...
public class class399 extends class454 implements class200 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILgga;ILjava/awt/Canvas;ILd;)Lha;", line = 3)
    ...
    @OriginalMember(owner = "client!ra", name = "h", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ra", name = "i", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Llea;III)V", line = 115)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Llea;IIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BII)V", line = 102)
