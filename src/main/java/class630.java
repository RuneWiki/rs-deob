...
public class class630 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IJ)Llda;")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Llda;IJ)V")
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)Llda;")
