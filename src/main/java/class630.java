...
public class class630 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IBI)I", line = 5)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIII)I", line = 29)
    ...
    @OriginalMember(owner = "client!gi", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
    public final String toString() {
        field8808++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Z[B)[B", line = 62)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIIIII)V", line = 96)
