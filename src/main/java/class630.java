...
public class class630 extends class412 {
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lap;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILjava/lang/String;)Z")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lap;IIII)V")
    ...
    @OriginalMember(owner = "client!jm", name = "e", descriptor = "(B)V")
