...
public class class630 extends class192 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Loa;Lcq;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IB)[I", line = 52)
    ...
    @OriginalMember(owner = "client!st", name = "e", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "([[II)V", line = 88)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "()V", line = 138)
    public class630() {
        super(0, true);
    }

    @OriginalMember(owner = "client!st", name = "b", descriptor = "(IB)[[I", line = 142)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(BI)V", line = 210)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILfd;I)V", line = 230)
