...
public class class630 extends class168 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(II)Lee;", line = 70)
