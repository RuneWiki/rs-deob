...
public class class630 extends class172 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ILgga;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(BLhia;)V", line = 25)
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "(I)V", line = 36)
