...
public class class630 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BII)Z", line = 26)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lpd;FZLpd;)Z", line = 62)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "([IIIILqq;[I)Llda;", line = 145)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lag;)V", line = 201)
    public class630(class469 arg0) {
        this.field8718 = arg0;
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Ljava/awt/Canvas;Lfa;I)Lr;", line = 209)
