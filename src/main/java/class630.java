...
public class class630 extends OutputStream {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIIBI)V", line = 13)
    ...
    @OriginalMember(owner = "client!cb", name = "write", descriptor = "(I)V", line = 33)
    public final void write(int arg0) throws IOException {
        field8921++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BZI)Ljava/lang/String;", line = 42)
