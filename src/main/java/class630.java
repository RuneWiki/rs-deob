...
public class class630 extends class499 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qs", name = "d", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!qs", name = "f", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lcka;Lwm;)V", line = 99)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILsfa;I)V", line = 128)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!qs", name = "e", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IZ)V", line = 227)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Z)Z", line = 280)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 294)
