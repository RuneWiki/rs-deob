...
public class class630 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(CZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZZ)Z", line = 17)
    public static boolean method3671(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Los;I)V", line = 54)
    public class630(class468 arg0, int arg1) {
        this.field9218 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)V", line = 69)
