...
public class class630 extends class499 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IBI)V", line = 16)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(III)Lfca;", line = 59)
