...
public class class630 extends class145 {
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Lvaa;", line = 17)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(JIIIZLla;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(ILlk;Lvea;III)V", line = 54)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILjava/awt/Canvas;Lla;Ld;I)Lha;", line = 67)
