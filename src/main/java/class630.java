...
public class class630 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIJ)Lfk;", line = 7)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 48)
