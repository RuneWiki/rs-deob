...
public class class630 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lha;BILs;Ls;[[ILs;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lrq;[[BIII[ZI[[BLoaa;III[[BLha;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILig;BII[Lcaa;I)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IILs;Lha;[[ILs;Ls;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IB[Lcaa;IILig;IIII)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ls;Lha;Ls;Z)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B[Lcaa;Lha;[[[I)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIZIIIIIIILig;)V")
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(IIIZLwea;Lfs;)V")
