...
public class class630 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IB)I", line = 32)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)I", line = 61)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "([I)V", line = 86)
