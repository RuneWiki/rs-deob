...
public class class630 extends class601 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILjava/lang/Throwable;Ljava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIIIBII)V", line = 63)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Loa;III)Z", line = 80)
    ...
    @OriginalMember(owner = "client!aca", name = "b", descriptor = "(Z)V", line = 107)
