...
public class class630 extends class334 {
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)Lmha;", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(BLol;)Lwca;", line = 18)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lkm;Z)Z", line = 32)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(II)[I", line = 157)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "()V", line = 189)
    public class630() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(IBI)Z", line = 197)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(III)I", line = 208)
