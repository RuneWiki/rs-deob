...
public class class1 extends class228 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lwm;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wf", name = "k", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IZ)I", line = 172)
    ...
    @OriginalMember(owner = "client!wf", name = "e", descriptor = "(IB)I", line = 185)
    ...
    @OriginalMember(owner = "client!wf", name = "m", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!wf", name = "l", descriptor = "(B)I", line = 237)
    ...
    @OriginalMember(owner = "client!wf", name = "w", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!wf", name = "x", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lii;BLrc;)I", line = 300)
    ...
    @OriginalMember(owner = "client!wf", name = "y", descriptor = "(I)V", line = 327)
    ...
    @OriginalMember(owner = "client!wf", name = "m", descriptor = "(B)V", line = 342)
    ...
    @OriginalMember(owner = "client!wf", name = "n", descriptor = "(B)V", line = 370)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIB[B)V", line = 381)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(Z)V", line = 398)
    ...
    @OriginalMember(owner = "client!wf", name = "z", descriptor = "(I)V", line = 412)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(I)V", line = 437)
