...
public class class1 extends class332 {
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(IIIIIF)V", line = 7)
    public class1(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IF)V", line = 10)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIBI)V", line = 22)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;)V", line = 36)
    ...
    @OriginalMember(owner = "client!oba", name = "j", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIZIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(FIIFBIFI)[F", line = 187)
