...
public class class1 extends class197 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lm;BLns;)V", line = 101)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLjava/lang/Object;Z)[B", line = 129)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZLuf;ZIILuf;I)I", line = 166)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(IIII)V", line = 215)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IBI)V", line = 247)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(IIIIIFFF)V", line = 260)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 289)
