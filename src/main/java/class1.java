...
@OriginalClass("client!ABEJMBLI")
public class class1 implements Runnable {

    @OriginalMember(owner = "client!ABEJMBLI", name = "a", descriptor = "Z")
    private boolean field1 = true;

    @OriginalMember(owner = "client!ABEJMBLI", name = "b", descriptor = "Z")
    private boolean field2 = false;

    @OriginalMember(owner = "client!ABEJMBLI", name = "f", descriptor = "Z")
    private boolean field6 = false;

    @OriginalMember(owner = "client!ABEJMBLI", name = "k", descriptor = "Z")
    private boolean field11 = false;

    @OriginalMember(owner = "client!ABEJMBLI", name = "l", descriptor = "Z")
    private boolean field12 = false;

    @OriginalMember(owner = "client!ABEJMBLI", name = "g", descriptor = "LGYSHSTYO;")
    public class23 field7;

    @OriginalMember(owner = "client!ABEJMBLI", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field5;

    @OriginalMember(owner = "client!ABEJMBLI", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field3;

    @OriginalMember(owner = "client!ABEJMBLI", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field4;

    @OriginalMember(owner = "client!ABEJMBLI", name = "j", descriptor = "I")
    private int field10;

    @OriginalMember(owner = "client!ABEJMBLI", name = "i", descriptor = "I")
    private int field9;

    @OriginalMember(owner = "client!ABEJMBLI", name = "h", descriptor = "[B")
    private byte[] field8;

    @OriginalMember(owner = "client!ABEJMBLI", name = "<init>", descriptor = "(Ljava/net/Socket;LGYSHSTYO;Z)V")
    ...
    @OriginalMember(owner = "client!ABEJMBLI", name = "a", descriptor = "()V")
    public void method1() {
        this.field6 = true;
        try {
            if (this.field3 != null) {
    ...
    @OriginalMember(owner = "client!ABEJMBLI", name = "b", descriptor = "()I")
    public int method2() throws IOException {
        return this.field6 ? 0 : this.field3.read();
    }

    @OriginalMember(owner = "client!ABEJMBLI", name = "c", descriptor = "()I")
    public int method3() throws IOException {
        return this.field6 ? 0 : this.field3.available();
    }

    @OriginalMember(owner = "client!ABEJMBLI", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!ABEJMBLI", name = "a", descriptor = "(I[BII)V")
    ...
    @OriginalMember(owner = "client!ABEJMBLI", name = "run", descriptor = "()V")
    public void run() {
        while (this.field11) {
            int var2;
            int var3;
    ...
    @OriginalMember(owner = "client!ABEJMBLI", name = "a", descriptor = "(B)V")
