...
public class class1 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IF[FIIFIIIIIFI)V", line = 7)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)Z", line = 128)
