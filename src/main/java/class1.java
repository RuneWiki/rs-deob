...
public class class1 extends class594 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIZ)I", line = 22)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Los;II[B)V", line = 38)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(III)Z", line = 99)
