...
public class class1 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;I[Ldp;I)I", line = 16)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;[Ldp;I)I", line = 42)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 147)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;I[Ldp;[Ljava/lang/String;[I)I", line = 162)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I[Ldp;ILjava/lang/String;)I", line = 409)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 420)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;I[Ldp;II)I", line = 432)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)V", line = 448)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(II)I", line = 461)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(CII)I", line = 473)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "([B)V", line = 496)
