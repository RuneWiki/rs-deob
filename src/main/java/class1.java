...
public class class1 extends class429 {
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(I)Liv;", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Liv;ILiv;F)Z", line = 29)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I[B)V", line = 228)
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(I)Z", line = 312)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Llf;I)V", line = 322)
