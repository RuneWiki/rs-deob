...
public class class1 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(II)Lst;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lqn;IIZII)V")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lae;ILqn;)V")
