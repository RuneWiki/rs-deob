...
public class class1 extends class623 {
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IILjava/lang/Object;B)[B", line = 17)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Laq;)V", line = 67)
