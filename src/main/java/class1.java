...
public class class1 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(III[IIIBI)Z", line = 25)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 129)
