...
public class class1 extends class61 {
    ...
    @OriginalMember(owner = "client!ADGLALPC", name = "sb", descriptor = "LOMIIKHIV;")
    public class47 field2;

    @OriginalMember(owner = "client!ADGLALPC", name = "a", descriptor = "(I)LLFTMDGKK;")
    ...
    @OriginalMember(owner = "client!ADGLALPC", name = "c", descriptor = "(Z)LLFTMDGKK;")
