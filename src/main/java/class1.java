...
public class class1 extends class243 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILji;B)V", line = 9)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(II)[[I", line = 82)
    ...
    @OriginalMember(owner = "client!us", name = "e", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Z[[I)V", line = 161)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(II)[I", line = 214)
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "()V", line = 267)
    public class1() {
        super(0, true);
    }
}
