...
public class class1 {
    ...
    @OriginalMember(owner = "client!AUPOWMGG", name = "n", descriptor = "I")
    ...
    @OriginalMember(owner = "client!AUPOWMGG", name = "a", descriptor = "(ZLNHEPCMLW;)V")
    ...
    @OriginalMember(owner = "client!AUPOWMGG", name = "a", descriptor = "(LNHEPCMLW;B)V")
