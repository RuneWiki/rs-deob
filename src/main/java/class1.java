...
@OriginalClass("client!AVUWZCYT")
public class class1 extends class68 {

    @OriginalMember(owner = "client!AVUWZCYT", name = "i", descriptor = "I")
    public int field2 = 1000;

    @OriginalMember(owner = "client!AVUWZCYT", name = "j", descriptor = "Z")
    public static boolean field3;

    @OriginalMember(owner = "client!AVUWZCYT", name = "h", descriptor = "[LOPJQDGMI;")
    public class35[] field1;

    @OriginalMember(owner = "client!AVUWZCYT", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!AVUWZCYT", name = "a", descriptor = "(Z)LYYHPBDED;")
