...
public class class1 extends class145 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILap;)V", line = 5)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lap;BI)V", line = 53)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "()V", line = 145)
    public class1() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ZI)[[I", line = 148)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lpe;I)V", line = 224)
    ...
    @OriginalMember(owner = "client!wf", name = "e", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "([Ljava/lang/String;I[S)V", line = 287)
