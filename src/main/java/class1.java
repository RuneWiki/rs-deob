...
public class class1 extends class38 {
    ...
    @OriginalMember(owner = "client!us", name = "H", descriptor = "(Li;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lih;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!us", name = "ba", descriptor = "(Li;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!us", name = "OA", descriptor = "(IILi;)Li;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Li;IIIIZ)Z")
