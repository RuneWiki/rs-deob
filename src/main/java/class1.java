...
public class class1 implements Runnable {
    ...
    @OriginalMember(owner = "client!AAVSEYUK", name = "f", descriptor = "LEUDZGBGU;")
    ...
    @OriginalMember(owner = "client!AAVSEYUK", name = "<init>", descriptor = "(LEUDZGBGU;Ljava/net/Socket;B)V")
