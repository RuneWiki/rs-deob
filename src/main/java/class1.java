...
public class class1 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BI)Lpm;", line = 14)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IB)Z", line = 61)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BJLtk;[I)Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(ILvh;Lvh;Leg;)V", line = 133)
