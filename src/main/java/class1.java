...
public class class1 extends class335 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IZ)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ILio;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "()V", line = 73)
    public class1() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ZI)[I", line = 78)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(Z)V", line = 111)
