...
public class class1 extends class147 implements class241 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lhp;Lig;Z)V", line = 15)
    public class1(class296 arg0, class218 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field9 = arg1;
    }

    @OriginalMember(owner = "client!us", name = "c", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(I)Lig;", line = 34)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 61)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLvg;)Lvg;", line = 80)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)V", line = 95)
