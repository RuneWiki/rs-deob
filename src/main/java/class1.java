...
public class class1 extends class314 {
    ...
    @OriginalMember(owner = "client!us", name = "h", descriptor = "(I)Lcw;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLie;I)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Ljea;BLjea;)V")
