...
public class class1 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lr;IZI)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIILr;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lml;Lqd;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILr;II)Z")
