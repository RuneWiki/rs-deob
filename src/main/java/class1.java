...
public class class1 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lha;IIZLuv;)V", line = 31)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZII)V", line = 357)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Luq;)V", line = 390)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lgp;ILuu;Luu;)V", line = 521)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "([ILdw;III[I)Lnw;", line = 400)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BLjava/lang/String;)V", line = 430)
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(II)Ljo;", line = 482)
