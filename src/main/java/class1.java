...
public class class1 extends class179 {
    ...
    @OriginalMember(owner = "client!us", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "e", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(II)V", line = 36)
