...
@OriginalClass("client!AGFDLNBY")
public class class1 extends class67 {

    @OriginalMember(owner = "client!AGFDLNBY", name = "pb", descriptor = "Z")
    private boolean field1 = true;

    @OriginalMember(owner = "client!AGFDLNBY", name = "tb", descriptor = "[I")
    public int[] field5 = new int[12];

    @OriginalMember(owner = "client!AGFDLNBY", name = "ub", descriptor = "[I")
    public int[] field6 = new int[5];

    @OriginalMember(owner = "client!AGFDLNBY", name = "vb", descriptor = "B")
    private byte field7 = 6;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Cb", descriptor = "I")
    private int field14 = -489;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Gb", descriptor = "Z")
    public boolean field18 = false;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Nb", descriptor = "I")
    private int field25 = -131;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Ob", descriptor = "J")
    public long field26 = -1L;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Rb", descriptor = "Z")
    public boolean field29 = false;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Fb", descriptor = "LGOHJFVWE;")
    public static class23 field17 = new class23((byte) -54, 260);

    @OriginalMember(owner = "client!AGFDLNBY", name = "yb", descriptor = "I")
    public int field10;

    @OriginalMember(owner = "client!AGFDLNBY", name = "zb", descriptor = "I")
    public int field11;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Db", descriptor = "I")
    public int field15;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Eb", descriptor = "I")
    public int field16;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Hb", descriptor = "I")
    public int field19;

    @OriginalMember(owner = "client!AGFDLNBY", name = "qb", descriptor = "I")
    public int field2;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Ib", descriptor = "I")
    public int field20;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Jb", descriptor = "I")
    public int field21;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Kb", descriptor = "I")
    public int field22;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Lb", descriptor = "I")
    public int field23;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Mb", descriptor = "I")
    public int field24;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Qb", descriptor = "I")
    public int field28;

    @OriginalMember(owner = "client!AGFDLNBY", name = "sb", descriptor = "I")
    public int field4;

    @OriginalMember(owner = "client!AGFDLNBY", name = "wb", descriptor = "I")
    public int field8;

    @OriginalMember(owner = "client!AGFDLNBY", name = "xb", descriptor = "I")
    public int field9;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Pb", descriptor = "J")
    public long field27;

    @OriginalMember(owner = "client!AGFDLNBY", name = "rb", descriptor = "LFKIKYVJJ;")
    public class19 field3;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Ab", descriptor = "LOIBEFFXI;")
    public class39 field12;

    @OriginalMember(owner = "client!AGFDLNBY", name = "Bb", descriptor = "Ljava/lang/String;")
    public String field13;

    @OriginalMember(owner = "client!AGFDLNBY", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!AGFDLNBY", name = "a", descriptor = "(Z)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!AGFDLNBY", name = "b", descriptor = "(I)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!AGFDLNBY", name = "a", descriptor = "(ILYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!AGFDLNBY", name = "c", descriptor = "(I)LOIBEFFXI;")
