...
public class class1 {
    ...
    @OriginalMember(owner = "client!a", name = "g", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!a", name = "i", descriptor = "Leh;")
