...
public class class1 extends class669 {
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(I)Z", line = 3)
    public final boolean method1(int arg0) {
        ++field9;
        return arg0 != 9567;
    }

    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lej;)V", line = 15)
    public class1(class111 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BII)V", line = 19)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lkca;IIILoa;Lub;Lee;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZI)V", line = 73)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!us", name = "d", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IILnq;)V", line = 113)
