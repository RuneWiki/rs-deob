...
public class class1 {
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZIIIII)I")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIII)I")
