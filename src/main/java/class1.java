...
public class class1 extends class238 {
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 14)
    ...
    @OriginalMember(owner = "client!us", name = "g", descriptor = "(I)Ljava/lang/String;", line = 90)
    public final String method3(int arg0) {
        ++field12;
        return arg0 < 27 ? null : this.field6;
    }

    @OriginalMember(owner = "client!us", name = "h", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Z)F", line = 124)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 146)
    public class1(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!us", name = "b", descriptor = "(B)F", line = 155)
    ...
    @OriginalMember(owner = "client!us", name = "d", descriptor = "(B)Ljava/lang/String;", line = 168)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "()V", line = 179)
    ...
    @OriginalMember(owner = "client!us", name = "e", descriptor = "(B)Ldd;", line = 350)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)V", line = 369)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IBIIIIII)V", line = 379)
