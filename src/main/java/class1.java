...
public class class1 extends class573 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lve;", line = 50)
