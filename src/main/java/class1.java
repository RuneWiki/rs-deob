...
public class class1 extends class402 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!us", name = "finalize", descriptor = "()V", line = 88)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BILza;)Z", line = 103)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)V", line = 506)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IILza;)Le;", line = 519)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Le;Lza;I)V", line = 541)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lqi;)V", line = 574)
    ...
    @OriginalMember(owner = "client!us", name = "h", descriptor = "(I)I", line = 630)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLza;)V", line = 641)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Li;III[Z)Z", line = 665)
    ...
    @OriginalMember(owner = "client!us", name = "i", descriptor = "(I)V", line = 702)
    ...
    @OriginalMember(owner = "client!us", name = "f", descriptor = "(I)V", line = 724)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I[BII)I", line = 735)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZLza;II)Z", line = 758)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(Lza;I)Lnd;", line = 769)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(II)Z", line = 802)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(II)V", line = 864)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IBILvs;Lza;ZI)V", line = 933)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(B)Z", line = 944)
