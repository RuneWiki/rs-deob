...
public class class1 extends class237 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Z)J", line = 42)
    public final long method2(boolean arg0) {
        return arg0 ? this.field2 : -68L;
    }

    @OriginalMember(owner = "client!is", name = "c", descriptor = "(I)J", line = 53)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "()V", line = 91)
    public class1() {
        this.field2 = System.nanoTime();
        this.field1 = System.nanoTime();
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 114)
