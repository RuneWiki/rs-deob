...
public class class1 extends class264 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!qk", name = "h", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZIIZLnl;II)V", line = 29)
    ...
    @OriginalMember(owner = "client!qk", name = "i", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 59)
    public class1() {
        this(0);
    }

    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(BI)[[I", line = 66)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLkk;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZILvc;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(I)V", line = 611)
