...
public class class1 extends class390 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(III)B", line = 39)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "([IIB)[I", line = 74)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILms;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lwk;BI)V", line = 218)
