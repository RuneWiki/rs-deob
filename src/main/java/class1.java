...
public class class1 implements MouseListener, MouseMotionListener, FocusListener {
    ...
    @OriginalMember(owner = "client!ro", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ro", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ro", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ro", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 83)
    ...
    @OriginalMember(owner = "client!ro", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 101)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!ro", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 157)
    public final void focusGained(FocusEvent arg0) {
        field15++;
    }

    @OriginalMember(owner = "client!ro", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 165)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZC)Z", line = 207)
    ...
    @OriginalMember(owner = "client!ro", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 228)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IBILrg;IIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 349)
