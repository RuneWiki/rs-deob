...
@OriginalClass("client!AHIOLHWV")
public class class1 extends class12 {

    @OriginalMember(owner = "client!AHIOLHWV", name = "qb", descriptor = "B")
    private byte field1 = -125;

    @OriginalMember(owner = "client!AHIOLHWV", name = "rb", descriptor = "Z")
    private boolean field2 = false;

    @OriginalMember(owner = "client!AHIOLHWV", name = "sb", descriptor = "I")
    private int field3 = 123;

    @OriginalMember(owner = "client!AHIOLHWV", name = "tb", descriptor = "Z")
    private boolean field4 = true;

    @OriginalMember(owner = "client!AHIOLHWV", name = "ub", descriptor = "LFWGUGZKU;")
    public class19 field5;

    @OriginalMember(owner = "client!AHIOLHWV", name = "b", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!AHIOLHWV", name = "a", descriptor = "(Z)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!AHIOLHWV", name = "b", descriptor = "(I)LITSMSHJO;")
