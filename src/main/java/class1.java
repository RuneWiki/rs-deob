...
public class class1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!AMZQHNGA", name = "p", descriptor = "[LNUXITFPR;")
    ...
    @OriginalMember(owner = "client!AMZQHNGA", name = "o", descriptor = "LTZRNBMTC;")
    public class50 field15;

    @OriginalMember(owner = "client!AMZQHNGA", name = "q", descriptor = "LUUMODXDR;")
