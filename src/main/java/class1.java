...
public class class1 extends class538 {
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lnq;II)V")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lnq;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lnq;IIZ[[I)V")
