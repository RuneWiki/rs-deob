...
public class class1 extends class471 implements class381 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIILwm;ZLhp;Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(Lwm;B)Lnf;", line = 25)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lwm;B)V", line = 139)
    ...
    @OriginalMember(owner = "client!us", name = "i", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLwm;)V", line = 172)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIBLwm;)Z", line = 195)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILwm;I)Lgn;", line = 214)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lwm;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lwm;Lct;IIIIIZIIIIIII)V", line = 241)
