...
public class class1 extends class373 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILbg;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(Z)I", line = 16)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(B)J", line = 28)
    ...
    @OriginalMember(owner = "client!is", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(Z)I", line = 67)
