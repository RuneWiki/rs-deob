...
public class class1 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)Lqp;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqp;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lra;ZLra;)V")
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "(I)Lqp;")
    ...
    @OriginalMember(owner = "client!ro", name = "e", descriptor = "(I)Lqp;")
