...
@OriginalClass("client!ABBBHPCA")
public class class1 implements Runnable {

    @OriginalMember(owner = "client!ABBBHPCA", name = "a", descriptor = "B")
    private byte field1 = 1;

    @OriginalMember(owner = "client!ABBBHPCA", name = "b", descriptor = "Z")
    private boolean field2 = false;

    @OriginalMember(owner = "client!ABBBHPCA", name = "f", descriptor = "Z")
    private boolean field6 = false;

    @OriginalMember(owner = "client!ABBBHPCA", name = "k", descriptor = "Z")
    private boolean field11 = false;

    @OriginalMember(owner = "client!ABBBHPCA", name = "l", descriptor = "Z")
    private boolean field12 = false;

    @OriginalMember(owner = "client!ABBBHPCA", name = "g", descriptor = "LAUOBNYCU;")
    public class4 field7;

    @OriginalMember(owner = "client!ABBBHPCA", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field5;

    @OriginalMember(owner = "client!ABBBHPCA", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field3;

    @OriginalMember(owner = "client!ABBBHPCA", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field4;

    @OriginalMember(owner = "client!ABBBHPCA", name = "j", descriptor = "I")
    private int field10;

    @OriginalMember(owner = "client!ABBBHPCA", name = "i", descriptor = "I")
    private int field9;

    @OriginalMember(owner = "client!ABBBHPCA", name = "h", descriptor = "[B")
    private byte[] field8;

    @OriginalMember(owner = "client!ABBBHPCA", name = "<init>", descriptor = "(ILAUOBNYCU;Ljava/net/Socket;)V")
    ...
    @OriginalMember(owner = "client!ABBBHPCA", name = "a", descriptor = "()V")
    public void method1() {
        this.field6 = true;
        try {
            if (this.field3 != null) {
    ...
    @OriginalMember(owner = "client!ABBBHPCA", name = "b", descriptor = "()I")
    public int method2() throws IOException {
        return this.field6 ? 0 : this.field3.read();
    }

    @OriginalMember(owner = "client!ABBBHPCA", name = "c", descriptor = "()I")
    public int method3() throws IOException {
        return this.field6 ? 0 : this.field3.available();
    }

    @OriginalMember(owner = "client!ABBBHPCA", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!ABBBHPCA", name = "a", descriptor = "(I[BIB)V")
    ...
    @OriginalMember(owner = "client!ABBBHPCA", name = "run", descriptor = "()V")
    public void run() {
        while (this.field11) {
            int var2;
            int var3;
    ...
    @OriginalMember(owner = "client!ABBBHPCA", name = "a", descriptor = "(B)V")
