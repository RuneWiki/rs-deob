...
public class class1 implements class660 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IZLsv;II)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)Lgp;")
    public class576 method3(byte arg0) {
        field8++;
        return arg0 >= -15 ? null : class448.field5845;
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILkh;Lkh;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(ILpf;Ldg;II)V")
