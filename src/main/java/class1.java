...
public class class1 extends class505 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIIBFIF[FFIF)V", line = 7)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(I)V", line = 155)
