...
public class class1 extends class369 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!oba", name = "d", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!oba", name = "c", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!oba", name = "c", descriptor = "(I)Z", line = 146)
    public final boolean method8(int arg0) {
        int var2 = 42 % ((arg0 - 37) / 36);
        return this.field7;
    }

    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BILlc;)V", line = 154)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ZI)V", line = 165)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Leda;Ltf;Ltt;)V", line = 195)
    ...
    @OriginalMember(owner = "client!oba", name = "d", descriptor = "(I)V", line = 218)
