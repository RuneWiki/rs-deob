...
public class class1 {
    ...
    @OriginalMember(owner = "client!AKUDQPZE", name = "e", descriptor = "LCYIKEZWP;")
    private class10 field5 = new class10();

    @OriginalMember(owner = "client!AKUDQPZE", name = "i", descriptor = "LFEBLELGD;")
    ...
    @OriginalMember(owner = "client!AKUDQPZE", name = "h", descriptor = "LHSZHZJQR;")
    ...
    @OriginalMember(owner = "client!AKUDQPZE", name = "a", descriptor = "(J)LCYIKEZWP;")
    ...
    @OriginalMember(owner = "client!AKUDQPZE", name = "a", descriptor = "(LCYIKEZWP;ZJ)V")
