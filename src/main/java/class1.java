...
public class class1 extends class29 {
    ...
    @OriginalMember(owner = "client!AGCGSOQI", name = "h", descriptor = "I")
    public static int field4;

    @OriginalMember(owner = "client!AGCGSOQI", name = "f", descriptor = "LAGCGSOQI;")
    public class1 field2;

    @OriginalMember(owner = "client!AGCGSOQI", name = "g", descriptor = "LAGCGSOQI;")
