...
public class class1 extends class449 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lje;BILkja;III)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Ldw;ILpe;BI)Lada;")
    ...
    @OriginalMember(owner = "client!us", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lbt;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lmga;ZBZI)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I[BIIZLpe;II)Lada;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZZ)Lje;")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/pba;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Ldfa;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lbt;I)V")
    ...
    @OriginalMember(owner = "client!us", name = "g", descriptor = "(II)Lbda;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIBLjagdx/D3DPRESENT_PARAMETERS;Ljagdx/IDirect3D;I)Z")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLkja;II)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lmm;I)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "([BIIIBLpe;)Lch;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lpe;Ldw;I)I")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lhm;B)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILhca;)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Ldw;Lpe;I)Z")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(II)Lsea;")
    public final class726 method44(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lmga;Z)I")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZI[[II)Lmia;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lsi;I)I")
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(II)Lup;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IZ)Loda;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lgha;I)V")
    ...
    @OriginalMember(owner = "client!us", name = "o", descriptor = "()Lub;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lpe;ILdw;)Z")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIZI[FBLpe;I)Lada;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILoda;I)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Ljia;Ljia;FLjia;)Ljia;")
    public final class645 method65(class645 arg0, class645 arg1, float arg2, class645 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLjagdx/IDirect3DVertexShader;)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lnm;)V")
    public final void method67(class499 arg0) {
    }

    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I[Lpo;)Lnca;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lsea;Lup;)Lnm;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lei;I)I")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILko;)I")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIIIZZ[I)Lada;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lkja;I)I")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(BLnca;)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIZLmga;)V")
