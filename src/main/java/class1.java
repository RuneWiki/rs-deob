...
public class class1 extends class366 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!us", name = "d", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZI)V", line = 72)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILgo;B)V", line = 91)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIB)V", line = 112)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lqg;Lpe;)V", line = 175)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)Z", line = 211)
