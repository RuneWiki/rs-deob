...
public class class1 extends class39 {
    ...
    @OriginalMember(owner = "client!ACEWFDYF", name = "D", descriptor = "LGMRGYXFL;")
    ...
    @OriginalMember(owner = "client!ACEWFDYF", name = "z", descriptor = "Lclient;")
    public static client field14;

    @OriginalMember(owner = "client!ACEWFDYF", name = "a", descriptor = "(B)LSIUJJQHQ;")
    ...
    @OriginalMember(owner = "client!ACEWFDYF", name = "a", descriptor = "(I)LFUTAQMCE;")
