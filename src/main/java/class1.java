...
public class class1 extends class220 {
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "()V", line = 90)
    public class1() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IBLil;)V", line = 93)
    ...
    @OriginalMember(owner = "client!wf", name = "e", descriptor = "(I)V", line = 147)
