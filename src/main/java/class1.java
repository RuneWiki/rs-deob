...
public class class1 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)V", line = 101)
