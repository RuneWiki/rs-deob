...
public class class1 {
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(B)Ldd;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)Ldd;")
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lvg;)V")
