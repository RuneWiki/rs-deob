...
public class class1 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lrba;ZZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)V", line = 71)
