...
public class class175 extends class432 {
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(IIIIIF)V", line = 10)
    public class175(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!kv", name = "f", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BF)V", line = 40)
