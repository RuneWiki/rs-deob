...
public class class175 extends class47 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIILae;BILoj;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lkk;Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILkk;B)V", line = 89)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILis;)[Lvt;", line = 135)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 185)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BII)I", line = 211)
