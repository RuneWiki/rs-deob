...
public class class175 extends class370 {
    ...
    @OriginalMember(owner = "client!hga", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
