...
public class class175 extends class337 {
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "()V", line = 22)
    public class175() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(II)[[I", line = 28)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BILhp;)V", line = 73)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IB)[I", line = 119)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lcg;III)V", line = 153)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIIIII)Z", line = 188)
    ...
    @OriginalMember(owner = "client!mb", name = "i", descriptor = "(I)V", line = 247)
