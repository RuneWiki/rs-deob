...
public class class175 extends class31 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Z)Lkq;", line = 33)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ltc;B)V", line = 78)
