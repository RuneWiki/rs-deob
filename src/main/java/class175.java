...
public class class175 implements class180 {
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(I)Lnb;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lgb;Lnb;Z)V")
