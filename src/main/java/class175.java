...
public class class175 implements class2 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Loha;[III)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILoha;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Loha;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILoha;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILoha;Z)Z")
