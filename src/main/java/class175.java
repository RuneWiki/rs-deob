...
public class class175 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ltq;Lvr;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ltq;IIIIII)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ltq;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Ltq;Lvr;)Z")
    public final boolean method1201(class63 arg0, class175 arg1) {
        return this.field2482 != null || this.method1202(arg0, arg1);
    }

    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(Ltq;Lvr;)Z")
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(Ltq;Lvr;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Ltq;)V")
