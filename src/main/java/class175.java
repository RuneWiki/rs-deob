...
public class class175 extends class593 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tga", name = "g", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIB)V", line = 43)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IBLah;)V", line = 69)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!tga", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BZ)V", line = 135)
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(Los;Llga;Ljd;)V", line = 147)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!tga", name = "f", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(I)V", line = 210)
