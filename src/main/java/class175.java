...
public class class175 extends class577 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lwia;)Z")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "([I)Ldga;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lwia;I)Ldfa;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lwia;II)Ldfa;")
