...
public class class175 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "()[F", line = 14)
    public final float[] method1074() {
        return this.field2330[this.method1076()];
    }

    @OriginalMember(owner = "client!go", name = "b", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "()I", line = 157)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "()V", line = 165)
    public class175() {
