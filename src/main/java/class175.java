...
public class class175 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IB)V", line = 21)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)Lhi;", line = 36)
