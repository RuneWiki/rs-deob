...
public class class175 extends class409 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(I)J", line = 22)
    public final long method491(int arg0) {
        return arg0 == -30419 ? this.field2474 : 34L;
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BI)I", line = 35)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Z)J", line = 76)
