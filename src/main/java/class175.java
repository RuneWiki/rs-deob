...
public class class175 extends class98 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZILie;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Luf;", line = 20)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLie;)V", line = 62)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(B)V", line = 89)
