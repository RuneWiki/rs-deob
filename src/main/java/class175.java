...
public class class175 extends class94 {
    ...
    @OriginalMember(owner = "client!uk", name = "XA", descriptor = "(IIIIII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "W", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lwc;[IIIII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILta;II)V")
    ...
    @OriginalMember(owner = "client!uk", name = "oa", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!uk", name = "ya", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lwc;[III)V")
