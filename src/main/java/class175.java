...
public class class175 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BILvp;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 375)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 430)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILjava/lang/String;)V", line = 441)
