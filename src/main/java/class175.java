...
public class class175 extends class97 {
    ...
    @OriginalMember(owner = "client!t", name = "r", descriptor = "Ltf;")
    private class181 field3317 = new class181();

    @OriginalMember(owner = "client!t", name = "s", descriptor = "Ltf;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lkc;)V")
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(Lkc;)V")
    public final synchronized void method1198(class97 arg0) {
        arg0.method452(true);
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lkg;)V")
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "()Lkc;")
    public final class97 method630() {
        return (class97) this.field3317.method1234(-1);
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()Lkc;")
    public final class97 method613() {
        return (class97) this.field3317.method1230(63);
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lhb;Lkg;)V")
