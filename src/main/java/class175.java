...
public class class175 extends class448 {
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)D", line = 4)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 91)
    public class175(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(Z)I", line = 117)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)Lsfa;", line = 134)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 146)
