...
public class class175 extends class184 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(SB)V", line = 181)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II[[ZII)V", line = 209)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)V", line = 275)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IILjava/awt/Canvas;I)Lkf;", line = 294)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lwh;Lmh;Lraa;[I)V", line = 389)
