...
public class class175 extends class297 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Lcea;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ZII)V", line = 39)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "()V", line = 56)
    public class175() {
        super(1, true);
    }

    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ILwq;)I", line = 59)
    ...
    @OriginalMember(owner = "client!hga", name = "c", descriptor = "(II)[I", line = 94)
    ...
    @OriginalMember(owner = "client!hga", name = "d", descriptor = "(III)Z", line = 128)
