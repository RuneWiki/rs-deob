...
public class class175 extends class778 implements class362 {
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(ILsf;Lha;BIIZ)V")
    ...
    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(Lha;Ldja;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(IZLha;I)Z")
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(Lha;II)Lka;")
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(Lha;B)Lhq;")
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(ZLha;II)Luf;")
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(Lha;B)Lpw;")
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!bka", name = "f", descriptor = "(B)V")
