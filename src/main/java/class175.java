...
public class class175 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Z)Z", line = 89)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(BIIIII)V", line = 212)
