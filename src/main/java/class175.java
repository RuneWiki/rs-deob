...
public abstract class class175 extends class159 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IB)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(I)I", line = 17)
    public int method1201(int arg0) {
        field2320++;
        return arg0 <= 118 ? 96 : -1;
    }

    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(III)[I", line = 29)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IIB)V", line = 77)
    ...
    @OriginalMember(owner = "client!pha", name = "b", descriptor = "(III)[[I", line = 102)
    ...
    @OriginalMember(owner = "client!pha", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!pha", name = "c", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Z)I", line = 159)
    ...
    @OriginalMember(owner = "client!pha", name = "f", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ZI)[I", line = 655)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ILdt;Z)V", line = 668)
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(IZ)V", line = 697)
