...
public class class175 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BZII)I", line = 8)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIZIZBI)V", line = 54)
