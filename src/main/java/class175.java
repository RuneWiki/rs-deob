...
public class class175 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)[B", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
    public final String toString() {
        field2576++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/lang/String;)V", line = 64)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLpb;II)V", line = 132)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;)V", line = 143)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 151)
