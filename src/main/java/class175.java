...
public class class175 extends class478 {
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILnp;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(II)[I", line = 75)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "()V", line = 151)
    public class175() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)I", line = 137)
