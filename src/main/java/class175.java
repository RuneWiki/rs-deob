...
public class class175 extends class429 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lbi;Lbi;Lcf;)V", line = 65)
    public class175(class449 arg0, class449 arg1, class566 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(IIIZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!ov", name = "c", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(II)Z", line = 163)
