...
public class class175 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II[BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BI)Laj;", line = 67)
