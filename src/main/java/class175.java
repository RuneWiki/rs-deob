...
public class class175 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BILjava/lang/String;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 86)
