...
public class class175 extends class5 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZIIIIII)Z", line = 15)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 84)
    public class175() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dd", name = "i", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(B)V", line = 98)
