...
public class class175 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILiaa;B)V", line = 26)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(B)V", line = 207)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lbda;Lrt;Lml;IIIII)V", line = 437)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIII)V", line = 390)
    ...
    @OriginalMember(owner = "client!hi", name = "c", descriptor = "(B)V", line = 411)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 422)
