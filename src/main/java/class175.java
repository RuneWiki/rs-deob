...
public class class175 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Lmq;ILvq;IBLak;)Z", line = 15)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIBI)I", line = 231)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 253)
