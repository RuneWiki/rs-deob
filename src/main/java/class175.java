...
public class class175 extends class509 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BILin;)V", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Ltt;)V", line = 18)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)Z", line = 201)
    public final boolean method124(int arg0) {
        ++field2697;
        return arg0 == -32170;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIZ)V", line = 228)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IB)V", line = 250)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Z)V", line = 294)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)V", line = 310)
