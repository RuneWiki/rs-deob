...
public class class175 extends class204 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lsd;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ILqa;I)Z", line = 63)
