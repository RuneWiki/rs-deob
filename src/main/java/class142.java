...
public class class142 extends class392 {
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Lw;)V")
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(ILw;)V")
