...
public class class142 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lpk;ILpk;IZ)Lrfa;", line = 21)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZLpk;ILpk;)Lrfa;", line = 62)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)Z", line = 117)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lkha;Ltl;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 203)
