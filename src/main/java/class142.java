...
public class class142 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Loq;ILbu;)V", line = 64)
