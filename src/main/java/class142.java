...
public class class142 extends class4 {
    ...
    @OriginalMember(owner = "client!sf", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIILe;Le;)V", line = 14)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lri;III[Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(II)I", line = 114)
    public static final int method905(int arg0, int arg1) {
        ++field1925;
        return arg0 < 41 ? 30 : arg1 >>> 8;
    }

    @OriginalMember(owner = "client!sf", name = "e", descriptor = "(I)[B", line = 125)
    ...
    @OriginalMember(owner = "client!sf", name = "e", descriptor = "(B)I", line = 145)
