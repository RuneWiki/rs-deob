...
public abstract class class142 extends class176 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I[Lcba;)I", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lha;B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!hc", name = "i", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIBI)V", line = 40)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(IIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!hc", name = "d", descriptor = "(Z)Z", line = 88)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIILwo;Lwo;)V", line = 100)
