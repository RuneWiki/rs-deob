...
public class class142 extends class232 {
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "([[IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IB)[I", line = 124)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "()V", line = 164)
    public class142() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILwq;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(B)V", line = 245)
