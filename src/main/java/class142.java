...
public abstract class class142 {
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(IIIII)V", line = 336)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)Lue;", line = 238)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZIZIIII)V", line = 281)
