...
public class class142 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZILr;)Z", line = 52)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BII)Z", line = 129)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIBIIIILr;II)V", line = 153)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(I[Lhe;IIII)V", line = 261)
