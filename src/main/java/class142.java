...
public class class142 implements class288 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)J", line = 7)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIZBI)V", line = 45)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILmb;)Z", line = 66)
