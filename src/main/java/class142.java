...
public class class142 extends class456 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IBLre;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IILje;I)V")
