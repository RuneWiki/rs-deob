...
public class class142 implements Runnable {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!cf", name = "run", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)I", line = 91)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Z)V", line = 105)
