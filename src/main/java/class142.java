...
public class class142 extends class335 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILwca;)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BI)[[I", line = 55)
