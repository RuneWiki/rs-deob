...
public class class142 extends class465 implements class2 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Loha;)V", line = 34)
    public final void method468(class465 arg0) {
        this.method810(this.nativeid, ((class142) arg0).nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)V", line = 47)
    public final void method454(int arg0) {
        this.method820(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Loha;", line = 61)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III[I)V", line = 73)
    public final void method457(int arg0, int arg1, int arg2, int[] arg3) {
        this.method814(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "()V", line = 77)
    public final void method462() {
        this.method818(this.nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 79)
    public class142() {
        this.method816();
    }

    @OriginalMember(owner = "client!ja", name = "w", descriptor = "(Z)V", line = 87)
