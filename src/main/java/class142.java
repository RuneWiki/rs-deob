...
public class class142 extends class264 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I[[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLkk;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 130)
    public class142() {
        super(0, true);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)[I", line = 142)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)I", line = 167)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(BI)[[I", line = 183)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(II)I", line = 247)
    public static int method1024(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)V", line = 254)
