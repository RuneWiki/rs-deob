...
public class class142 extends class108 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!bd", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 9)
    ...
    @OriginalMember(owner = "client!bd", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 20)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 50)
    ...
    @OriginalMember(owner = "client!bd", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 72)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field2136;
    }

    @OriginalMember(owner = "client!bd", name = "d", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IILjava/awt/Graphics;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!bd", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 112)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field2132;
    }

    @OriginalMember(owner = "client!bd", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 120)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field2143;
        return this.field2141 == arg0;
    }

    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 145)
