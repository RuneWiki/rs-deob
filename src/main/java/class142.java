...
public class class142 extends class179 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZLqq;I)Lcd;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Llt;I)I")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
