...
public class class142 implements class81 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)Lmha;", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(I)V", line = 74)
