...
public class class142 extends class163 implements class628 {
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Llh;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBI)Z", line = 41)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(B)V", line = 57)
