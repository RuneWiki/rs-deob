...
public class class142 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)Lsha;", line = 3)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IIZZIILwia;)V", line = 82)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 122)
