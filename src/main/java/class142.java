...
public class class142 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIIILoa;IIIIII[[[B)V", line = 50)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 86)
