...
public class class142 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)Lpia;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lal;ILnd;)V")
