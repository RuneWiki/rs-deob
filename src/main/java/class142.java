...
public class class142 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lqa;III)V", line = 23)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)V", line = 73)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZIB)I", line = 111)
