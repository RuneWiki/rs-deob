...
public class class142 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIBI)Lsu;")
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)Lct;")
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)Lew;")
