...
public abstract class class142 extends class631 {
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wda", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(IIII)V", line = 46)
