...
public abstract class class142 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I[B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lmb;)V", line = 34)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 211)
