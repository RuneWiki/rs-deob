...
public class class142 extends class404 {
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lh;)V", line = 38)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "()Z", line = 35)
    public final boolean method350() {
        return true;
    }

    @OriginalMember(owner = "client!ch", name = "b", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lsd;)V", line = 88)
