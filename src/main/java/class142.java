...
public class class142 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(B[B)V", line = 10)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)V", line = 254)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "([BI)V", line = 273)
