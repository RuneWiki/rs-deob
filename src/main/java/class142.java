...
public class class142 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lis;I)V")
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lbo;I)V")
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Loh;II)V")
