...
public class class142 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(I)V", line = 301)
