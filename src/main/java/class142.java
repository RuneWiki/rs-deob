...
public class class142 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(III)Lfd;", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIII)Z", line = 40)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IBIZII)V", line = 224)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lvm;Lir;Lnj;III)Z", line = 321)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 536)
