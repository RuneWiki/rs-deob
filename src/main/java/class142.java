...
public class class142 extends class659 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIIILgi;IIIIILog;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lqba;I)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ldt;BI)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ldt;B)V")
