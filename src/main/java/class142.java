...
public abstract class class142 extends class261 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IZIZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(I)I", line = 42)
    public int method1056(int arg0) {
        field2345++;
        return arg0 == 0 ? 0 : 78;
    }

    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lda;)V", line = 84)
    public class142(class44 arg0) {
        this.field2349 = arg0;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIII)I", line = 93)
    ...
    @OriginalMember(owner = "client!su", name = "g", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!su", name = "h", descriptor = "(I)Z", line = 130)
