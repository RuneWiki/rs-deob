...
public class class142 extends class97 implements class220 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lqi;ILjava/nio/ByteBuffer;Z)V")
    public class142(class458 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field2005 = arg1;
    }

    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lqi;I[BIZ)V")
