...
public class class142 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lsj;Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BLir;)V", line = 43)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BI)V", line = 70)
