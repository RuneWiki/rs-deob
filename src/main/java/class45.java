...
public class class45 {
    ...
    @OriginalMember(owner = "client!ed", name = "w", descriptor = "J")
    public long field949 = 0L;

    @OriginalMember(owner = "client!ed", name = "l", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ed", name = "x", descriptor = "Llf;")
    public static class109 field950 = class35.method275("mod_icons", 2);

    @OriginalMember(owner = "client!ed", name = "B", descriptor = "Llf;")
    private static class109 field954 = class35.method275("Create a free account", 2);

    @OriginalMember(owner = "client!ed", name = "y", descriptor = "Llf;")
    public static class109 field951 = field954;

    @OriginalMember(owner = "client!ed", name = "A", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ed", name = "z", descriptor = "Lnd;")
    public static class125 field952;

    @OriginalMember(owner = "client!ed", name = "s", descriptor = "Lka;")
    public class95 field945;

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Loe;IIIII)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lbg;II)Z")
