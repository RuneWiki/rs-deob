...
public class class45 extends class70 {
    ...
    @OriginalMember(owner = "client!OTTYZSZE", name = "Hb", descriptor = "LJLTMYUOM;")
    ...
    @OriginalMember(owner = "client!OTTYZSZE", name = "wb", descriptor = "LFUTAQMCE;")
    public class19 field1181;

    @OriginalMember(owner = "client!OTTYZSZE", name = "xb", descriptor = "LNHTDEVDA;")
    ...
    @OriginalMember(owner = "client!OTTYZSZE", name = "d", descriptor = "(I)LFUTAQMCE;")
    ...
    @OriginalMember(owner = "client!OTTYZSZE", name = "a", descriptor = "(ZLXJCNBMKS;)V")
    ...
    @OriginalMember(owner = "client!OTTYZSZE", name = "a", descriptor = "(Z)LFUTAQMCE;")
    ...
    @OriginalMember(owner = "client!OTTYZSZE", name = "a", descriptor = "(I)LFUTAQMCE;")
