...
public class class45 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 55)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "()V", line = 85)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 229)
