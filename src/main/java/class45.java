...
public class class45 implements class184 {
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "()V", line = 23)
    public final void method377() {
        this.field581.field4794.glFramebufferRenderbufferEXT(36160, this.field579, 36161, 0);
        this.field579 = -1;
    }

    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lmm;III)V", line = 35)
