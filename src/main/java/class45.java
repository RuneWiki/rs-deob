...
public class class45 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)Z", line = 24)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I[Ljava/lang/String;[SII)V", line = 46)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(CB)Z", line = 99)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)V", line = 144)
