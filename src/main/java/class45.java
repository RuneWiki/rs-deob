...
public class class45 implements class489 {
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)Lmh;", line = 18)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lje;JB[I)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BLnn;)Lmp;", line = 76)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIZII)V", line = 87)
