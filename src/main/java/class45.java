...
public class class45 extends class502 {
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Leka;)V", line = 49)
    public class45(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 54)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(II)I", line = 120)
    public final int method57(int arg0, int arg1) {
        ++field706;
        return arg0 != arg1 && ~super.field6863.field6754.method3467((byte) 110) != -2 ? 2 : 1;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lri;Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(ILeka;)V", line = 156)
    public class45(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIIIIZ)V", line = 160)
