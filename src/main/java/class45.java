...
public class class45 extends class329 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "()V", line = 7)
    public static void method272() {
        field596 = null;
    }

    @OriginalMember(owner = "client!jca", name = "b", descriptor = "()[I", line = 10)
    public final int[] method273() {
        return this.field599;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(II[IZ)V", line = 59)
