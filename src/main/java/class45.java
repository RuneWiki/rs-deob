...
public class class45 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(Laj;IZIJIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!cja", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!cja", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 64)
