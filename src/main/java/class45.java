...
public class class45 extends class86 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZIILm;ZDZLns;)[I")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(DILm;ILns;ZI)[I")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILns;Lm;IIZ)[F")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lm;BLns;)Z")
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Ltl;)V")
