...
public class class45 extends class411 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Leq;IIZ[[I)V", line = 30)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Leq;IIZ[[BI)V", line = 62)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Leq;II)V", line = 82)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIIBI)V", line = 134)
