...
public class class45 implements class415 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)Z", line = 74)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lpq;Lpu;)V", line = 87)
    public class45(class159 arg0, class422 arg1) {
        this.field602 = arg0;
        this.field597 = arg1;
    }

    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZB)V", line = 116)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ldda;I)Z", line = 140)
