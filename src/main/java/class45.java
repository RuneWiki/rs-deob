...
public class class45 extends class112 {
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!dja", name = "h", descriptor = "(I)Z", line = 16)
    public final boolean method340(int arg0) {
        field595++;
        return arg0 != -32365;
    }

    @OriginalMember(owner = "client!dja", name = "a", descriptor = "([IIILea;)V", line = 27)
    ...
    @OriginalMember(owner = "client!dja", name = "<init>", descriptor = "(Lqj;Ljava/lang/Object;I)V", line = 117)
    public class45(class572 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field597 = arg1;
    }

    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(Z)I", line = 128)
