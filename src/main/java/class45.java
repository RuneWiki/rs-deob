...
public class class45 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILoi;)V", line = 11)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III)Ljava/lang/String;", line = 115)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILbi;I)V", line = 158)
