...
public class class45 extends class394 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 5)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)Lmr;", line = 31)
    ...
    @OriginalMember(owner = "client!wh", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 42)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method272(-1, (byte) 112, '\u0000', 0);
        field516++;
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BI)Z", line = 56)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IBCI)V", line = 72)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lda;)V", line = 89)
    public static final void method273(class420 arg0) {
        class28.field243 = arg0;
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!wh", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 185)
    public final void focusGained(FocusEvent arg0) {
        field522++;
    }

    @OriginalMember(owner = "client!wh", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 192)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method280(arg0, -1, 0);
        field515++;
    }

    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(BI)Llia;", line = 200)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!wh", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 227)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(I)V", line = 272)
    public static final void method278(int arg0) {
        field511++;
        class311.field3893.method2919(arg0 ^ arg0);
    }

    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 377)
    public class45(Component arg0) {
        class67.method390(-21079);
        this.method269(21024, arg0);
    }

    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!wh", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 296)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field519++;
        this.method280(arg0, -1, 1);
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V", line = 305)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(B)I", line = 341)
