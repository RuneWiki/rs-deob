...
public class class45 implements class20 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)Lvj;", line = 12)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(ILnha;Ljn;IIIIIIIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)V", line = 69)
