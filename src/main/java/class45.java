...
public class class45 extends class47 {
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lco;[IIIII)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lco;[III)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IILem;II)V")
