...
public class class45 extends class60 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(II)I", line = 15)
    public final int method406(int arg0, int arg1) {
        ++field604;
        return !class32.method301(super.field798.field10665.method1903(arg0), false) ? 3 : 1;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lhd;)V", line = 60)
    public class45(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(ILhd;)V", line = 82)
    public class45(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!vba", name = "d", descriptor = "(B)V", line = 100)
