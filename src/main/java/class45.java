...
public class class45 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lkb;Lnr;ILlo;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZII)I", line = 221)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BI)Lcr;", line = 237)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "([SI)[S", line = 269)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 291)
