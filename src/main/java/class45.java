...
public class class45 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BII)V", line = 49)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(FIFF)I", line = 191)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIB[B)Ljava/lang/String;", line = 253)
