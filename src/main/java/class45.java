...
public class class45 extends class30 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILin;)Lin;", line = 6)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BILac;)V", line = 26)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "()V", line = 40)
    public class45() {
        super(3, false);
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IB)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)[I", line = 123)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIILcu;)Z", line = 180)
