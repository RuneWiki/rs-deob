...
public class class45 extends class570 implements class49 {
    ...
    @OriginalMember(owner = "client!jca", name = "h", descriptor = "(I)Z", line = 4)
    public final boolean method180(int arg0) {
        ++field443;
        return arg0 == -1;
    }

    @OriginalMember(owner = "client!jca", name = "i", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!jca", name = "k", descriptor = "(I)J", line = 39)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(Lr;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lr;Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!jca", name = "l", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIIILrb;Lr;Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lr;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lr;III)Z", line = 152)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(Lr;I)Lwj;", line = 174)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ILr;I)Lda;", line = 204)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(B)Z", line = 240)
    ...
    @OriginalMember(owner = "client!jca", name = "m", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(B)Z", line = 261)
    ...
    @OriginalMember(owner = "client!jca", name = "g", descriptor = "(I)I", line = 274)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Z)I", line = 288)
    ...
    @OriginalMember(owner = "client!jca", name = "e", descriptor = "(B)I", line = 300)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(I)I", line = 313)
    public final int method238(int arg0) {
        ++field446;
        return arg0 != 6518 ? -3 : 65535 & this.field447;
    }

    @OriginalMember(owner = "client!jca", name = "j", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZIZ)V", line = 338)
    ...
    @OriginalMember(owner = "client!jca", name = "f", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lr;IIZ)Lhi;", line = 387)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)I", line = 420)
    ...
    @OriginalMember(owner = "client!jca", name = "d", descriptor = "(Lr;I)Llf;", line = 438)
