...
public abstract class class45 implements class502 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IZI)I", line = 9)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Llba;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!aea", name = "e", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!aea", name = "d", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!aea", name = "f", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ILhb;)V", line = 187)
    ...
    @OriginalMember(owner = "client!aea", name = "finalize", descriptor = "()V", line = 875)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I[FZII)V", line = 884)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "([BIIII)V", line = 980)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(II)V", line = 1079)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIII[I)V", line = 1092)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(B)I", line = 1199)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Lgf;ILkp;Lvt;IZ)V", line = 1220)
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(B)I", line = 1240)
