...
public class class45 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZLoi;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)Lfaa;")
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(I)Lfaa;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIILpga;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lbc;)V")
