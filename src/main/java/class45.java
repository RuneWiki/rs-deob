...
public class class45 {
    ...
    @OriginalMember(owner = "client!MJVHTYCA", name = "u", descriptor = "I")
    ...
    @OriginalMember(owner = "client!MJVHTYCA", name = "e", descriptor = "[LMJVHTYCA;")
    public static class45[] field1187;

    @OriginalMember(owner = "client!MJVHTYCA", name = "a", descriptor = "(ZLMJLXHQTQ;)V")
    ...
    @OriginalMember(owner = "client!MJVHTYCA", name = "a", descriptor = "(ZLXGRGMPUQ;)V")
