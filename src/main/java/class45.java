...
public class class45 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 4)
    public static void method428(byte arg0) {
        int var1 = -30 / ((arg0 - 76) / 36);
        field883 = null;
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(CI)C", line = 14)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 408)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IB)Lnc;", line = 423)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZI)V", line = 451)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(I)V", line = 472)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 489)
