...
public class class45 extends class194 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IZLjava/awt/Component;)Lul;", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "e", descriptor = "(B)Leo;", line = 27)
    ...
    @OriginalMember(owner = "client!vba", name = "f", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!vba", name = "g", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIIIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIIII)V", line = 534)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(III)Z", line = 552)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)V", line = 566)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lqfa;II)V", line = 581)
