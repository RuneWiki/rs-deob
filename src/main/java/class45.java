...
public class class45 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lya;IILya;Led;IIZZLla;II)Ll;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BI)Llo;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILed;IIIIILya;)Ll;")
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lee;IZLcc;Lul;Lul;)V")
