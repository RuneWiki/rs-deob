...
public class class45 extends class309 {
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/lang/Runnable;)Lkw;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "([Lr;Lsh;Lm;[Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lld;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II[[I[[IIII)Lsa;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "([Lr;Lm;[Lpaa;I)V")
