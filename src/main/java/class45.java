...
public class class45 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lio;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILrq;BI)J", line = 23)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IZII[I[I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BII)V", line = 92)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILqa;ILdn;ILio;IILcl;Lbk;Lav;Lpn;)Lc;", line = 131)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "([Ltk;IILav;ILqa;ILfc;Lpn;ZIILdn;ILcl;ILdn;Lio;Lbk;)Lc;", line = 330)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILqa;Ldn;IILio;ILcl;IIII)Lc;", line = 823)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 987)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)V", line = 998)
