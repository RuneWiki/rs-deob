...
public class class45 extends class394 implements class340 {
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(Lpa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lpa;)V", line = 7)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lks;I[BI)V", line = 10)
    public class45(class173 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field590 = arg1;
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I[BI)V", line = 14)
    public final void method373(int arg0, byte[] arg1, int arg2) {
        this.method2472(arg1, arg2);
        this.field590 = arg0;
    }

    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(Lpa;)V", line = 18)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lks;ILjava/nio/ByteBuffer;)V", line = 21)
    public class45(class173 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field590 = arg1;
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "()I", line = 25)
    public final int method49() {
        return 0;
    }

    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(Lpa;)V", line = 30)
