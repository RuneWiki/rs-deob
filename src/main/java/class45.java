...
public class class45 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lit;ZI)V", line = 16)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lit;I)V", line = 352)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lqa;Leq;III)V", line = 382)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lqn;I)V", line = 431)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(Z)Lqn;", line = 447)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIBIIIIILqa;)V", line = 463)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(I)V", line = 612)
    public class45(int arg0) {
        this.field672 = arg0;
    }

    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(IIIIII)V", line = 619)
