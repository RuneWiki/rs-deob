...
public abstract class class45 implements class216 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lwu;Lwu;Lnm;)V", line = 124)
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ZB)V", line = 145)
