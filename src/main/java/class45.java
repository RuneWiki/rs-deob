...
public class class45 extends class50 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "()V", line = 17)
    public final void method119() {
    }

    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lql;II[BI)V", line = 20)
