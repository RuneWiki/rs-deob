...
public class class45 extends class739 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lha;Ld;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZI)[I", line = 236)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lsl;IB)V", line = 293)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "()V", line = 459)
    public class45() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)V", line = 340)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BLgt;)V", line = 350)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(II)[[I", line = 391)
