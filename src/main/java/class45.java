...
public class class45 extends class525 implements class370 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)Lui;")
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lag;Lui;Z)V")
