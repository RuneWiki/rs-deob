...
public class class45 extends class665 implements class721 {
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lha;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BLha;)V", line = 43)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IBLha;I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!gs", name = "j", descriptor = "(B)I", line = 116)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lha;Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!gs", name = "h", descriptor = "(B)I", line = 141)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)I", line = 166)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILha;)V", line = 177)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Lha;B)Lc;", line = 204)
    ...
    @OriginalMember(owner = "client!gs", name = "i", descriptor = "(B)Z", line = 229)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)Z", line = 244)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILvt;)I", line = 287)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILrg;)Lkn;", line = 314)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lha;IIZ)Lqw;", line = 326)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lha;I)Lria;", line = 360)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILha;I)Lka;", line = 376)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)I", line = 398)
    public final int method327(int arg0) {
        ++field493;
        return arg0 >= -116 ? 60 : this.field488;
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lha;IB)Lhia;", line = 412)
    ...
    @OriginalMember(owner = "client!gs", name = "k", descriptor = "(B)Z", line = 428)
    ...
    @OriginalMember(owner = "client!gs", name = "g", descriptor = "(I)V", line = 446)
