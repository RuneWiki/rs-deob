...
public class class45 extends class66 {
    ...
    @OriginalMember(owner = "client!OXCIEWBY", name = "z", descriptor = "LZGXCNUJM;")
    ...
    @OriginalMember(owner = "client!OXCIEWBY", name = "r", descriptor = "Lclient;")
    public static client field1252;

    @OriginalMember(owner = "client!OXCIEWBY", name = "b", descriptor = "(B)LSRQVPDWQ;")
    ...
    @OriginalMember(owner = "client!OXCIEWBY", name = "a", descriptor = "(B)LSNMMQNPZ;")
