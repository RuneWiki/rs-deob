...
public class class45 extends class427 {
    ...
    @OriginalMember(owner = "client!uda", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)V", line = 478)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIIIIIIIII)V", line = 508)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(IIIIIIIIII)Z", line = 541)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BI)I", line = 569)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(III)Z", line = 587)
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lnh;II)V", line = 602)
