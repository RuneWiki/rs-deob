...
public class class45 extends class9 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IILos;)V", line = 3)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IC)I", line = 66)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ILos;)V", line = 122)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(CB)I", line = 173)
    ...
    @OriginalMember(owner = "client!aea", name = "c", descriptor = "(I)V", line = 198)
