...
public abstract class class45 {
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(IIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IBII)V", line = 104)
