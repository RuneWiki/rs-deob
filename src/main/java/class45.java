...
public class class45 extends class436 {
    ...
    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIII)Z", line = 27)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IBIIIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 54)
    public class45() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)[I", line = 57)
