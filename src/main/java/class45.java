...
public class class45 {
    ...
    @OriginalMember(owner = "client!SAEPCADT", name = "e", descriptor = "[LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!SAEPCADT", name = "a", descriptor = "(J)LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!SAEPCADT", name = "a", descriptor = "(IJLWYQNTERC;)V")
