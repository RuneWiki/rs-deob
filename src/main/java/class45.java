...
public class class45 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILur;Lur;IZ)Lws;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIII)Lkh;")
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Liv;Lcd;)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lur;ILur;I)Lws;")
