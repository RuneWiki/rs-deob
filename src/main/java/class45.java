...
public class class45 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ZLuq;)V")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Laf;I)V")
    ...
    @OriginalMember(owner = "client!vba", name = "toString", descriptor = "()Ljava/lang/String;")
