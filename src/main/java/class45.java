...
public class class45 implements Runnable {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!u", name = "run", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 54)
