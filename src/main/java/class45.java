...
public class class45 extends class289 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(FI)V", line = 6)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(I)V", line = 17)
    public class45(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(FZ)V", line = 21)
