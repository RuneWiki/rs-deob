...
public class class485 extends class413 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(CIIIZLua;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lqj;Lsa;[Laga;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!ph", name = "OA", descriptor = "(CIIIZ)V", line = 289)
