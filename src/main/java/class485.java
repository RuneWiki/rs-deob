...
public class class485 {
    ...
    @OriginalMember(owner = "client!lda", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field6813++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(I)V", line = 130)
