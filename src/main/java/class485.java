...
public class class485 extends class307 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(CIIIZLma;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!qp", name = "OA", descriptor = "(CIIIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lvd;Ldu;[Lul;Z)V", line = 67)
