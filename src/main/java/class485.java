...
public class class485 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ZB)V", line = 9)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 92)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IIIIIIIIBI)V", line = 143)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lgn;IZLvo;Lvo;)V", line = 299)
    ...
    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(II)Lnf;", line = 195)
    ...
    @OriginalMember(owner = "client!rw", name = "d", descriptor = "(II)V", line = 241)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Z)V", line = 270)
