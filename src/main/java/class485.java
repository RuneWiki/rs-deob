...
public class class485 extends class244 {
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(IIII)[B", line = 4)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(III)Lao;", line = 22)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZIII)I", line = 29)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "()V", line = 54)
    public class485() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)V", line = 75)
