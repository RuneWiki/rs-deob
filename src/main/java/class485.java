...
public class class485 extends class42 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILqa;I)Lc;", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIIJZ)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)V", line = 176)
