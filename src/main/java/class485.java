...
public abstract class class485 implements class104 {
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(B)Lwp;", line = 108)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIIIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lsea;Lsea;Lbf;)V", line = 186)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZ)I", line = 196)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)I", line = 208)
