...
public class class485 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILgaa;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZI[BI)V", line = 106)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)J", line = 291)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II[BI)V", line = 304)
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(I)Ljava/io/File;", line = 425)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lha;BLwm;)I", line = 441)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lan;B)V", line = 467)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILufa;)Z", line = 1059)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lis;II)V", line = 1233)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)V", line = 1094)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BIIZIIFI)[I", line = 1170)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(JB)V", line = 1194)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([BI)V", line = 1215)
