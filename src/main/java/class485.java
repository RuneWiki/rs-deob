...
public class class485 extends class16 {
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(FFFFFFLma;II)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lkd;IIII)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lkd;II[III)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IILma;II)V")
