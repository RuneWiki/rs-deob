...
public class class485 {
    ...
    @OriginalMember(owner = "client!sl", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field7351.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!sl", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!sl", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
