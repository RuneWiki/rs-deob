...
public abstract class class485 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILjava/lang/String;IIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 20)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 93)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(III)V", line = 146)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIB)Lms;", line = 157)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IILjava/lang/String;IIIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIIIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIIIIILvb;IIILjava/lang/String;III[I[Laq;)I", line = 260)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 346)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BII)V", line = 379)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IBI)I", line = 399)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIII[IBILjava/util/Random;IIILjava/lang/String;I[Laq;[I)I", line = 419)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BIIILjava/lang/String;I)V", line = 496)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "([Laq;[III[IILjava/lang/String;[I)V", line = 514)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "([ILjava/lang/String;IIII[Laq;I)V", line = 680)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IBILms;)V", line = 697)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IILjava/lang/String;IIII)V", line = 783)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I[I[Laq;BLjava/lang/String;ILvb;II)V", line = 813)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIIII[I[Laq;Ljava/lang/String;Ljava/util/Random;I)I", line = 963)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lkm;Lss;)V", line = 999)
