...
public class class485 extends class175 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(FFIF)I", line = 47)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILna;)V", line = 88)
    public static final void method2898(int arg0, class35 arg1) {
        class529.field7807[arg0] = arg1;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Ltn;IBI)V", line = 96)
