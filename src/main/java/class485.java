...
public class class485 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILjava/lang/String;)J", line = 16)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILun;)V", line = 37)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)Lpga;", line = 58)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILun;I)V", line = 110)
