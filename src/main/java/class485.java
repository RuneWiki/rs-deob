...
public class class485 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!cga", name = "toString", descriptor = "()Ljava/lang/String;", line = 232)
    public final String toString() {
        field6623++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ZI[B)[B", line = 289)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(ZI[B)V", line = 303)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 354)
