...
public class class485 extends class126 implements class614 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lrda;B)Z")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZZILr;)Lpa;")
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Lr;Z)Lkq;")
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lr;Let;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(ILr;)Lnu;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLr;I)Lda;")
