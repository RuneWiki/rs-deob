...
public class class485 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(II)Lqg;", line = 22)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIZILjava/lang/String;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIIII)I", line = 109)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)[Lmg;", line = 141)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BCI)I", line = 169)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lle;ILoi;)V", line = 227)
