...
public class class485 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)Loj;", line = 127)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 161)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(II)Lcc;", line = 181)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Ld;ILfo;Lfo;Lfo;)V", line = 255)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(ZI)V", line = 236)
