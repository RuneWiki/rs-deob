...
public class class485 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIIIIIILha;II)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BLha;I)Z")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(I[Lep;IIII)V")
