...
public class class485 implements Runnable {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IZ)Lfi;", line = 51)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BLva;)I", line = 83)
    ...
    @OriginalMember(owner = "client!fd", name = "run", descriptor = "()V", line = 159)
