...
public class class485 extends class502 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "()Lc;", line = 4)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "()V", line = 27)
    public final void method2707() {
        this.field6569 = true;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "([Lefa;Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "()V", line = 124)
    private final void method2709() {
        this.field6556 = false;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Loa;)V", line = 127)
    ...
    @OriginalMember(owner = "client!hv", name = "d", descriptor = "()Lc;", line = 139)
    public final class174 method2711() {
        return this.field6568;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Loa;J[Ljt;[Lefa;Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IZ)Lhv;", line = 150)
    ...
    @OriginalMember(owner = "client!hv", name = "e", descriptor = "()V", line = 165)
    public final void method2714() {
        this.field6556 = true;
    }

    @OriginalMember(owner = "client!hv", name = "f", descriptor = "()V", line = 168)
    public static void method2715() {
        field6550 = null;
        field6557 = null;
    }

    @OriginalMember(owner = "client!hv", name = "g", descriptor = "()V", line = 172)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Loa;J)Z", line = 209)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(J)V", line = 257)
    public final void method2718(long arg0) {
        this.field6555 = arg0;
    }

    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(IZ)V", line = 263)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Loa;[Ljt;Z)V", line = 272)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(IZ)V", line = 390)
