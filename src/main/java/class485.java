...
public class class485 extends class11 {
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BI[B)[B", line = 92)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lsi;II)V", line = 106)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(III)V", line = 152)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IZII)I", line = 169)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;)V", line = 196)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "()V", line = 239)
    public class485() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lya;)V", line = 245)
    ...
    @OriginalMember(owner = "client!kb", name = "f", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)[[I", line = 343)
