...
public class class485 extends class456 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IBLre;)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([BI)Lbu;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IILjava/lang/String;Ltr;Lje;Lis;ILus;IIII)V")
