...
public class class485 extends class672 {
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IZILha;)Lka;")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lha;I)Lmaa;")
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(Lha;I)Lrn;")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZLje;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lha;ILka;Lqja;)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lwia;Ljc;Lwia;Lwia;Lhp;I)Z")
