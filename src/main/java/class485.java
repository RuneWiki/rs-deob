...
public class class485 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIB)Ljava/lang/String;", line = 13)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ldk;IIZLdk;IZ)I", line = 52)
