...
public class class485 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)Lrj;", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BII)V", line = 27)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(I)Lrj;", line = 100)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lrj;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)I", line = 139)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)I", line = 165)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)Lrj;", line = 187)
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 238)
    public class485() {
