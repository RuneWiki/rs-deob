...
public class class485 extends class666 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "()V", line = 53)
    public class485() {
        super(1, true);
    }
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILiaa;Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 145)
