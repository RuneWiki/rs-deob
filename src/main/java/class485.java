...
public class class485 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(III[B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILjava/net/Socket;)Lgs;", line = 75)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(ILpm;Lpm;I)V", line = 339)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I[BIIZ)Z", line = 94)
    ...
    @OriginalMember(owner = "client!cr", name = "toString", descriptor = "()Ljava/lang/String;", line = 233)
    public final String toString() {
        field6733++;
        return "Cache:" + this.field6742;
    }

    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BI)[B", line = 251)
