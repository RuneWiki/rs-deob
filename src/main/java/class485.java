...
public class class485 extends class145 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BI)I", line = 240)
    public static final int method2906(byte arg0, int arg1) {
        field7133++;
        return arg0 == -25 ? arg1 & 0x3FF : -17;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIZBII)V", line = 261)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BIII)I", line = 287)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 309)
