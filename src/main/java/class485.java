...
public class class485 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIILjava/lang/Class;)Laaa;")
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lda;)V")
    public class485(class442 arg0) {
        this.field6708 = arg0;
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lda;Lhw;)V")
