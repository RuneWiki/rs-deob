...
public class class485 extends class708 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)Ldm;")
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lkw;I)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ldm;Ldm;FB)Z")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZZILg;BLg;I)I")
