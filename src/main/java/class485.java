...
public class class485 extends class113 implements class141 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!ef", name = "g", descriptor = "(B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lha;IZI)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lha;ZI)Lka;", line = 90)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BILha;Lgs;ZII)V", line = 112)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(BLha;)Lvw;", line = 143)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BLha;)V", line = 170)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(BLha;)V", line = 199)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lha;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!ef", name = "i", descriptor = "(B)V", line = 238)
    public static void method2916(byte arg0) {
        field6851 = null;
        int var1 = 114 / ((57 - arg0) / 50);
    }

    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(B)I", line = 248)
    ...
    @OriginalMember(owner = "client!ef", name = "f", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)Z", line = 273)
    public final boolean method1113(int arg0) {
        ++field6858;
        return arg0 != -24333 ? true : this.field6865;
    }

    @OriginalMember(owner = "client!ef", name = "f", descriptor = "(B)Z", line = 286)
    ...
    @OriginalMember(owner = "client!ef", name = "h", descriptor = "(I)I", line = 301)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)I", line = 313)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZLha;II)Lnj;", line = 331)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lha;Z)Ltb;", line = 362)
    ...
    @OriginalMember(owner = "client!ef", name = "j", descriptor = "(I)I", line = 377)
    ...
    @OriginalMember(owner = "client!ef", name = "h", descriptor = "(B)Z", line = 388)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lha;Luw;IIIIIZIIIIIIZ)V", line = 399)
