...
public class class485 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZIIBI)Lvea;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZILwha;)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lofa;I)Leba;")
