...
public class class261 implements class246 {

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "I")
    private int field4083 = -1;

    @OriginalMember(owner = "client!dn", name = "c", descriptor = "[I")
    private int[] field4085 = null;

    @OriginalMember(owner = "client!dn", name = "b", descriptor = "Z")
    private boolean field4084 = false;

    @OriginalMember(owner = "client!dn", name = "c", descriptor = "()V", line = 7)
    public final void method454() {
        GL var1 = class94.field1473;
        if (class208.field3191) {
            var1.glCallList(this.field4083 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!dn", name = "d", descriptor = "()V", line = 16)
    private final void method1782() {
        GL var1 = class94.field1473;
        this.field4083 = var1.glGenLists(2);
        var1.glNewList(this.field4083, 4864);
        if (this.field4085 == null) {
            ...
            if (this.field4084) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class94.field1485);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field4083 + 1, 4864);
        if (this.field4085 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "()V", line = 108)
    public final void method458() {
        GL var1 = class94.field1473;
        class94.method675(1);
        if (class208.field3191) {
            var1.glCallList(this.field4083);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!dn", name = "b", descriptor = "()I", line = 120)
    public final int method452() {
        return 4;
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 126)
    public final void method457(int arg0) {
        GL var2 = class94.field1473;
        if (class208.field3191 && this.field4085 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field4085[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!dn", name = "e", descriptor = "()V", line = 144)
    private final void method1783() {
        GL var1 = class94.field1473;
        if (this.field4085 == null) {
            this.field4085 = new int[3];
            var1.glGenTextures(3, this.field4085, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field4085[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field4085[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field4085[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class198.field2961 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 271)
    public class261() {
        if (class94.field1515 && class94.field1477 >= 2) {
            this.method1783();
            GL var1 = class94.field1473;
            var1.glBindTexture(34067, this.field4085[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field4084 = class94.field1477 < 3;
        }
        this.method1782();
    }
}
