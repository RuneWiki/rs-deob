...
public class class261 extends class753 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 22)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILjava/net/Proxy;)Ljava/net/Socket;", line = 91)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 111)
    ...
    @OriginalMember(owner = "client!dea", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 168)
