...
public class class261 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ILjf;I)V")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BILkk;)V")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lkk;B)V")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lnl;B)V")
