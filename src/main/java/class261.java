...
public abstract class class261 extends class420 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIILjava/lang/Class;)Lvv;", line = 4)
    ...
    @OriginalMember(owner = "client!qa", name = "l", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!qa", name = "k", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(ILha;)Z", line = 52)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Luf;Z)I", line = 64)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(IIIIII)V", line = 145)
