...
public class class261 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IZILjava/awt/Component;Lrd;)Lir;", line = 28)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(III)Z", line = 161)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IB)S", line = 194)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILdg;)V", line = 222)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILdg;)V", line = 262)
