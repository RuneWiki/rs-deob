...
public class class261 extends class138 {
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(B)Lca;")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(FBLca;Lca;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lge;I)V")
