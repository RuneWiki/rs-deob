...
public class class261 extends class725 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ZZLaha;)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIILafa;[I)Z")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lafa;Z)I")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(BZLaha;Z)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lafa;I)I")
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "()Lco;")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ILafa;Z)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ZLaha;JZB)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Laha;Luu;BLeia;I)Z")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "()Lco;")
    public final synchronized class725 method357() {
        field3796++;
        return null;
    }

    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(Lafa;I)Z")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ILafa;)I")
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Laea;)V")
