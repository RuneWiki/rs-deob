...
public abstract class class261 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BII)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lih;)V", line = 73)
