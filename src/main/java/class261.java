...
public class class261 extends class95 {
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIII)I", line = 46)
    ...
    @OriginalMember(owner = "client!ln", name = "g", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(IIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(IIIIIF)V", line = 84)
    public class261(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILoi;I)Lbr;", line = 87)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(FI)V", line = 126)
