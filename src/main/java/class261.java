...
public class class261 extends class440 {
    ...
    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "()V", line = 25)
    public class261() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(B)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BI)[I", line = 66)
