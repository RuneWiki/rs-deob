...
public class class261 extends class194 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IILbg;)V", line = 369)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(JIBI)V", line = 405)
    ...
    @OriginalMember(owner = "client!dm", name = "h", descriptor = "(I)V", line = 449)
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(II)I", line = 478)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(II)[[I", line = 483)
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(III)I", line = 535)
    ...
    @OriginalMember(owner = "client!dm", name = "f", descriptor = "(I)V", line = 560)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(B)V", line = 574)
