...
public class class261 extends class30 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ILuu;II)Lnd;", line = 7)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIFFIIFIF[BFLag;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lnq;II[B)V", line = 94)
