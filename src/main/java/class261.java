...
public class class261 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljg;[BZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "()V", line = 80)
    public class261() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(III)V", line = 85)
