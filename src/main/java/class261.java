...
public class class261 extends class13 {
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lkh;BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "()V", line = 72)
    public class261() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qd", name = "e", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)[[I", line = 122)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZI)[I", line = 185)
    ...
    @OriginalMember(owner = "client!qd", name = "e", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!qd", name = "f", descriptor = "(I)V", line = 246)
