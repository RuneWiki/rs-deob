...
public class class261 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIIII)Lvh;")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)Luv;")
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lgt;ILdn;)V")
