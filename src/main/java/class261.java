...
public class class261 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Lio;)V", line = 6)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(Lio;)V", line = 46)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "()V", line = 56)
    public class261() {
        this.field3396[0] = 0;
