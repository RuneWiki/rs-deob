...
public class class261 {
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(IB)Lbn;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Loa;IILq;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lpca;ILbi;Lbi;)V")
