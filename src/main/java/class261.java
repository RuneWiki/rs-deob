...
public class class261 extends class226 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(CB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Z)V", line = 30)
    public static final void method1597(boolean arg0) {
        class134.field1897 = arg0;
        field3716++;
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Loa;BLsu;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 89)
