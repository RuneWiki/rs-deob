...
public class class261 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lbl;)V", line = 136)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BIII)I", line = 108)
