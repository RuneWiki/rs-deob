...
public class class261 extends class86 {
    ...
    @OriginalMember(owner = "client!sg", name = "d", descriptor = "(B)V", line = 20)
    public static void method1616(byte arg0) {
        int var1 = 75 % ((36 - arg0) / 38);
        field3725 = null;
    }

    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "([B)V", line = 31)
    public class261(byte[] arg0) {
        this.field3726 = arg0;
    }

    @OriginalMember(owner = "client!sg", name = "c", descriptor = "(I)V", line = 41)
