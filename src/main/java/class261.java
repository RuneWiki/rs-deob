...
public class class261 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILpq;B)Lil;", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ldga;Ljv;I)Lgca;", line = 53)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(III)V", line = 94)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLdga;)V", line = 147)
