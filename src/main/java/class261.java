...
public class class261 extends class184 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!fc", name = "e", descriptor = "(B)V", line = 467)
    ...
    @OriginalMember(owner = "client!fc", name = "d", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!fc", name = "e", descriptor = "(I)V", line = 515)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIB)Z", line = 534)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lwga;II)V", line = 551)
