...
public class class261 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BIZIZ)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BI)Lkk;")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lpt;ILum;)V")
