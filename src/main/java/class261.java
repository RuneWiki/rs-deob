...
public class class261 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lmd;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lqa;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZLch;)V", line = 237)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "([JB[I)V", line = 284)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lmd;IB)V", line = 313)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 369)
