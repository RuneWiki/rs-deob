...
public class class261 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILmk;J)V", line = 22)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BJ)Lmk;", line = 43)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "([BII)I", line = 74)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)Lmk;", line = 85)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILrg;)V", line = 116)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIIIII)I", line = 234)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(FFIFB)F", line = 265)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)V", line = 291)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(I)V", line = 322)
