...
public class class261 {
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)Lpp;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(JB)Lpp;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(JLpp;I)V")
