...
public class class261 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(JB)V", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIII)I", line = 40)
    ...
    @OriginalMember(owner = "client!sb", name = "toString", descriptor = "()Ljava/lang/String;", line = 59)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(II)V", line = 81)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZIII)Llga;", line = 95)
