...
public class class261 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lsa;)V", line = 274)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILjava/io/File;I[B)V", line = 88)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Ljava/lang/Runnable;B)V", line = 147)
