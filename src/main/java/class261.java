...
public abstract class class261 extends class408 {
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(I)V", line = 14)
    public class261(int arg0) {
        this.field3712 = arg0;
    }

    @OriginalMember(owner = "client!fc", name = "e", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIII)V", line = 35)
