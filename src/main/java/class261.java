...
public class class261 extends class86 implements class49 {
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lql;ILjava/nio/ByteBuffer;Z)V")
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(Lbb;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(Lbb;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILbb;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lql;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lbb;)V")
