...
public class class261 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BI)Lkc;", line = 25)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Ld;ILfo;Lfo;)V", line = 120)
