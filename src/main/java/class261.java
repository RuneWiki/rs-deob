...
public class class261 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I)Z", line = 69)
