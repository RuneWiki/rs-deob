...
public class class261 extends class203 {
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lpq;Lsa;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IZLwha;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lgga;I)Luba;")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I[Lsu;Loaa;)Lpt;")
