...
public class class261 extends class454 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ILol;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Lol;IB)V", line = 27)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIZ)I", line = 94)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Ljava/lang/String;ZI)Ljava/lang/String;", line = 113)
