...
public class class261 extends class108 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IB)[B", line = 23)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)I", line = 86)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(ILqia;Lqia;Lql;Lcca;I[BIZ)V", line = 805)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(III)Lne;", line = 117)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(B)V", line = 378)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZ)V", line = 561)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(I)V", line = 593)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)Lew;", line = 637)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(Z)I", line = 740)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(B)V", line = 751)
