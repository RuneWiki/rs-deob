...
public class class261 extends class265 implements class418 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILcg;)V", line = 6)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lul;IZ[[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sda", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 79)
