...
public class class261 extends class89 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lfh;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)Lud;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILfh;I)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lfh;Z)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLqn;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lfh;[II)V")
