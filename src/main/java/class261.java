...
public class class261 extends class164 implements class694 {
    ...
    @OriginalMember(owner = "client!oaa", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIB)V", line = 60)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(Lkga;III)V", line = 96)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(Lkga;IIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(IIB)V", line = 78)
    ...
    @OriginalMember(owner = "client!oaa", name = "finalize", descriptor = "()V", line = 112)
