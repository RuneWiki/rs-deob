...
public class class261 extends class71 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)J", line = 6)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(I)J", line = 40)
    public final long method153(int arg0) {
        return arg0 == 10 ? this.field3527 : 90L;
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BI)I", line = 51)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 97)
