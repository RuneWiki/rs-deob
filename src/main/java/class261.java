...
public class class261 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IBII)I", line = 11)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(II)I", line = 34)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILmda;Lmda;ZB)Lcp;", line = 47)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(III)I", line = 88)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Liq;Lbc;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 227)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILmda;Lmda;)Lcp;", line = 242)
