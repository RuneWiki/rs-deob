...
public class class261 extends class48 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Z)[B", line = 37)
