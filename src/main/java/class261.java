...
public class class261 extends class268 {
    ...
    @OriginalMember(owner = "client!aj", name = "x", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!aj", name = "y", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I[I)V", line = 35)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZJIII)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!aj", name = "h", descriptor = "(B)Z", line = 137)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIIZIII)I", line = 155)
    ...
    @OriginalMember(owner = "client!aj", name = "k", descriptor = "(II)I", line = 185)
    ...
    @OriginalMember(owner = "client!aj", name = "l", descriptor = "(II)I", line = 217)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IZ[BI)V", line = 228)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(IB)V", line = 245)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZIIIII)V", line = 261)
    ...
    @OriginalMember(owner = "client!aj", name = "i", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(I)V", line = 306)
    public class261(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IBI)Z", line = 312)
    ...
    @OriginalMember(owner = "client!aj", name = "j", descriptor = "(B)I", line = 324)
    ...
    @OriginalMember(owner = "client!aj", name = "k", descriptor = "(B)V", line = 341)
