...
public class class261 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ZBII)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Ljp;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ILrs;Ldm;IILha;)Z", line = 78)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IILor;I)V", line = 268)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)V", line = 292)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ZB)V", line = 304)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Ljp;Z)V", line = 351)
