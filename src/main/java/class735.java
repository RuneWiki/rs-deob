...
public class class735 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ld;BIILha;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)V", line = 112)
