...
public class class735 extends class476 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Lck;ILka;III)V", line = 6)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(B)Lmha;", line = 21)
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "(Lle;Lqj;IIIIIIIIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ZI)Z", line = 60)
