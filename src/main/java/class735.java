...
public class class735 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZI)Loia;", line = 4)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLjava/lang/String;ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IZ)I", line = 167)
    public static final int method4080(int arg0, boolean arg1) {
        field10286++;
        return arg1 ? arg0 & 0x7F : -104;
    }

    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lpga;Ld;)V", line = 227)
