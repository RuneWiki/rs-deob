...
public class class735 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIZ[BILnv;I)Ltea;")
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(II)Lmw;")
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lnb;ILoh;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
