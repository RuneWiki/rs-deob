...
public class class735 extends class610 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lpe;)Lob;", line = 5)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
