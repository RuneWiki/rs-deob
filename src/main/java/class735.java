...
public class class735 extends class175 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILdt;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "()V", line = 22)
    public class735() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(B)Lai;", line = 25)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(ZI)I", line = 50)
    ...
    @OriginalMember(owner = "client!ki", name = "g", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZI)[I", line = 123)
    ...
    @OriginalMember(owner = "client!ki", name = "h", descriptor = "(I)V", line = 180)
