...
public class class735 extends class649 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(ILhs;)V", line = 16)
    public class735(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lhs;)V", line = 19)
    public class735(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 26)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IB)V", line = 81)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(I)I", line = 131)
