...
public class class735 extends class151 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lnea;Lvu;)Lcp;")
    public final class753 method456(class742 arg0, class354 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZB)Lmq;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lofa;ILkn;II)Lkt;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILet;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lcp;)V")
    public final void method485(class753 arg0) {
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I[Lqe;)Lbw;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILpg;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "x", descriptor = "()Lrda;")
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/in;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lpja;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lcb;I)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILsi;)I")
    ...
    @OriginalMember(owner = "client!ki", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lcb;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(IZ)Lfka;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BIILjagdx/D3DPRESENT_PARAMETERS;Ljagdx/IDirect3D;I)Z")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lada;B)I")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IZLeca;ZB)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;I)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lofa;ILkn;)I")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([BILofa;III)Lpo;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IZI[IIII)Lkt;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIZLeca;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZLjagdx/IDirect3DVertexShader;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BILfka;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILofa;[BIIZI)Lkt;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lkn;Lofa;I)Z")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILofa;Lkn;)Z")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lq;B)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZLpd;)I")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILsi;II)V")
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(II)Lvu;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILofa;ZII[FI)Lkt;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILbw;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILeca;)I")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILcr;)I")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([[IZII)Lbv;")
    ...
    @OriginalMember(owner = "client!ki", name = "g", descriptor = "(II)Lbea;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lsi;ILmq;IIII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(II)Lnea;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lag;Lag;FLag;)Lag;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILen;)V")
