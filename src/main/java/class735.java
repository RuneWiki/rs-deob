...
public class class735 extends class219 implements class752 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILwc;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lwc;Lfda;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILwc;)V")
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()[Lal;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lwc;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lwc;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lwc;Lfda;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Lmi;")
    public final class27[] method1335() {
        return this.field10282;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILwc;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lid;IIII)V")
