...
public class class735 implements class422 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Z)Ldw;")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Lus;Ldw;Z)V")
