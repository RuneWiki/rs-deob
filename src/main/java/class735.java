...
public abstract class class735 extends class154 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(II)I", line = 9)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "([BIII)[B", line = 35)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIIIIIIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIIIB)V", line = 94)
