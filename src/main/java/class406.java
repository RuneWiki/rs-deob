...
public class class406 {
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(III)V", line = 65)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)I", line = 139)
