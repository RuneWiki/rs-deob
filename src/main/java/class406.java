...
public class class406 extends class179 {
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 18)
    public class406() {
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 23)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(S)V", line = 45)
