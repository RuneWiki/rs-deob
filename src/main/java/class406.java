...
public class class406 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Le;II)Z")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ljg;I)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Le;Z[[B[[B[[IBLlf;[[B[[BILlf;II)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILjg;)V")
