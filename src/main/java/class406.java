...
public class class406 extends class615 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IB)[I", line = 6)
    ...
    @OriginalMember(owner = "client!rp", name = "f", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "()V", line = 83)
    public class406() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BILeh;)V", line = 86)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIII)V", line = 147)
