...
public class class406 implements class117 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)Lof;", line = 20)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IBIZII)V", line = 43)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lada;Loe;IIIIIII)V", line = 96)
