...
public class class406 extends class614 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILfo;)V", line = 45)
    ...
    @OriginalMember(owner = "client!dea", name = "g", descriptor = "(I)[B", line = 695)
