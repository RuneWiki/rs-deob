...
public class class406 extends class569 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILwp;IB)V", line = 35)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)Z", line = 60)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Ltf;Ltf;Lmd;)V", line = 72)
    public class406(class701 arg0, class701 arg1, class291 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ltf;I[ILtf;)V", line = 80)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZIZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 108)
