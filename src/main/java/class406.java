...
public class class406 extends IOException {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 58)
    public class406(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)V", line = 62)
