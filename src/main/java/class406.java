...
public class class406 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(JI)Lev;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "([Lev;B)I")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)Lev;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(JLev;I)V")
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)Lev;")
    ...
    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(I)Lev;")
