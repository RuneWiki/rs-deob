...
public class class406 extends class652 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lmq;III)V")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lpe;Ljava/lang/Object;I)V")
    public class406(class611 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6065 = arg1;
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BLgk;)Liaa;")
