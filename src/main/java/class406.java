...
public class class406 extends class543 implements class2 {
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Lsk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lss;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Ltd;")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Lup;")
    public final class239 method1253(int arg0, int arg1) {
        return this.method377(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lwh;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Lsk;")
    public final class121 method348() {
        return new class134();
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Lsk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lup;Lrga;)Ldv;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Ltd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lfu;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lrga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leea;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lss;Lss;FLss;)Lss;")
    public final class506 method1251(class506 arg0, class506 arg1, float arg2, class506 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldv;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqt;[Lffa;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lwh;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leea;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Ltd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lffa;Z)Ltd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leea;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)Lss;")
