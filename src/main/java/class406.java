...
public abstract class class406 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!cv", name = "c", descriptor = "(B)Z", line = 56)
