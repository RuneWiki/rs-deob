...
public class class406 extends class305 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(ILhb;)V", line = 34)
    public class406(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lhb;)V", line = 48)
    public class406(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(I)I", line = 81)
