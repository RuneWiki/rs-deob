...
public class class406 implements class695 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)Lhs;", line = 5)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IILfa;BILfaa;IJI)V", line = 18)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(I)V", line = 99)
