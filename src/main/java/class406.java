...
public class class406 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Lad;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILo;)V")
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lsn;ILci;)V")
