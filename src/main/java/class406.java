...
public class class406 extends class376 {
    ...
    @OriginalMember(owner = "client!uj", name = "v", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!uj", name = "o", descriptor = "(B)Lip;", line = 20)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(I)V", line = 39)
    public class406(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IF)V", line = 42)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(IF)V", line = 65)
