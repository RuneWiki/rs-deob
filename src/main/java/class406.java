...
public class class406 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIII)Lti;", line = 6)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIILr;)V", line = 26)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)Lwg;", line = 63)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIZ)Z", line = 74)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(IIIIB)V", line = 86)
