...
public class class406 extends OutputStream {
    ...
    @OriginalMember(owner = "client!sh", name = "write", descriptor = "(I)V", line = 3)
    public final void write(int arg0) throws IOException {
        field5797++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)I", line = 11)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)[[[B", line = 74)
