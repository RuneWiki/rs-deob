...
public class class406 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ZIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lod;)V", line = 114)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BI)Z", line = 79)
    public final boolean method2441(byte arg0, int arg1) {
        field6122++;
        return arg0 == -54 ? this.field6130[arg1].method126(-33) : true;
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIII)I", line = 90)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ILjk;B)Z", line = 139)
