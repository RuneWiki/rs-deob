...
public class class406 extends class45 {
    ...
    @OriginalMember(owner = "client!iu", name = "e", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)[I", line = 71)
    ...
    @OriginalMember(owner = "client!iu", name = "f", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "()V", line = 1088)
    public class406() {
        super(0, true);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lcu;II)V", line = 202)
    ...
    @OriginalMember(owner = "client!iu", name = "d", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IB)[[[B", line = 312)
