...
public class class406 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Ltm;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)Ltm;", line = 57)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!ns", name = "d", descriptor = "(I)Ltm;", line = 105)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIII)I", line = 123)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(I)Ltm;", line = 178)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 206)
    public class406() {
