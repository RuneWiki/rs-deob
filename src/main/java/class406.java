...
public class class406 extends class18 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Z)I", line = 44)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BII)Lgo;", line = 56)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIZI)V", line = 82)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIBIIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)C", line = 118)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)I", line = 130)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(I)J", line = 155)
