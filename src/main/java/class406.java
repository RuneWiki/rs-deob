...
public class class406 extends class573 {
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lmh;Lwu;Lwda;)V", line = 3)
    ...
    @OriginalMember(owner = "client!je", name = "e", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZI)V", line = 88)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lwc;IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZZ)V", line = 171)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(Z)V", line = 186)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 202)
