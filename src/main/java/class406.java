...
public class class406 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILdm;Lha;)V", line = 26)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lud;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lud;B)V", line = 196)
