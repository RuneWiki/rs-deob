...
public class class406 extends class43 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILpi;)I", line = 21)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIBI)Z", line = 58)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II[II)V", line = 78)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I[III)V", line = 91)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLwo;Lgd;)V", line = 102)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIB)Z", line = 115)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IZI)Z", line = 137)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IJ)V", line = 154)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(IIIIIIIII)V", line = 219)
