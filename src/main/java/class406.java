...
public class class406 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lda;)V", line = 258)
    public class406(class443 arg0) {
        this.field5587 = arg0;
    }

    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lda;Lrt;)V", line = 265)
    public class406(class443 arg0, class470 arg1) {
        this.field5587 = arg0;
        this.field5593 = arg1;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Luf;IBLaa;IIILmq;)V", line = 44)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(CZ)B", line = 91)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZB)I", line = 221)
