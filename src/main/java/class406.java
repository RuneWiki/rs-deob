...
public class class406 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILqf;IS)I")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Ltj;B)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "([Lqf;I)V")
