...
public class class406 extends class436 {
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIB)I", line = 32)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "()V", line = 463)
    public class406() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ag", name = "f", descriptor = "(I)Lne;", line = 56)
    ...
    @OriginalMember(owner = "client!ag", name = "f", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IB)V", line = 324)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILeb;)V", line = 364)
    ...
    @OriginalMember(owner = "client!ag", name = "g", descriptor = "(B)V", line = 447)
