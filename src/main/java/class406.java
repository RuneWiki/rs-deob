...
public class class406 extends class270 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZZLqs;BIDLl;)[I")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)Lut;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lqs;Ll;IZIZ)[F")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BLl;Lqs;)Z")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(DILqs;IIZLl;)[I")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lia;)V")
