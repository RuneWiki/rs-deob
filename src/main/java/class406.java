...
public class class406 implements class487 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IIIZLqb;)V", line = 16)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Ldb;[IIJ)Ljava/lang/String;", line = 177)
