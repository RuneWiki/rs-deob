...
public class class406 extends class164 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lun;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(Lun;I)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I[ILun;)V", line = 93)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BI)Lgfa;", line = 122)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BII)I", line = 140)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BILun;)V", line = 161)
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IILrda;Ldc;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!jc", name = "f", descriptor = "(I)V", line = 570)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 586)
