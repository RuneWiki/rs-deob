...
public class class406 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([Lrg;Ljava/lang/String;III)I", line = 4)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IBC)I", line = 23)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([Lrg;Ljava/lang/String;II)I", line = 38)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 50)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZ)I", line = 64)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lg;Lg;ILg;Lg;)V", line = 75)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([Lrg;ZLjava/lang/String;)I", line = 111)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([I[Ljava/lang/String;Ljava/lang/String;I[Lrg;)I", line = 217)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BI[Lrg;Ljava/lang/String;)I", line = 477)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "([B)V", line = 508)
