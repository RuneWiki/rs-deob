...
public class class406 extends class140 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "e", descriptor = "(I)[B", line = 18)
    ...
    @OriginalMember(owner = "client!ul", name = "f", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILmh;)Z", line = 49)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)Ljk;", line = 71)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZII)I", line = 96)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III)V", line = 110)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BD)V", line = 156)
