...
public class class406 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(I)Lke;", line = 29)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(JLke;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IIIIIIIZII)V", line = 86)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(JI)Lke;", line = 136)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(I)V", line = 180)
