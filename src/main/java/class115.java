...
public class class115 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)V", line = 3)
    public static void method760(byte arg0) {
        field1518 = null;
        int var1 = 79 % ((arg0 + 87) / 32);
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(II)I", line = 12)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(B)V", line = 50)
