...
public class class115 extends class515 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(BIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!kba", name = "d", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(IIIIIF)V", line = 36)
    public class115(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IF)V", line = 44)
