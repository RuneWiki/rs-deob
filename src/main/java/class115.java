...
public class class115 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)Lpo;", line = 145)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)Z", line = 165)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(B)Lpo;", line = 213)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(Z)Lpo;", line = 236)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(Z)I", line = 259)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(I)Lpo;", line = 285)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "()V", line = 344)
    public class115() {
        this.field1892.field6804 = this.field1892;
        this.field1892.field6806 = this.field1892;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BLpo;)V", line = 327)
