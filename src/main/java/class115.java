...
public class class115 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Llm;J[Lcb;)V", line = 22)
    public class115(class337 arg0, long arg1, class80[] arg2) {
        this.field1486 = arg1;
        this.field1489 = arg0;
    }

    @OriginalMember(owner = "client!dl", name = "finalize", descriptor = "()V", line = 33)
