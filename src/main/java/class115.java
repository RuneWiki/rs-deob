...
public class class115 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lr;IIII)Lpl;", line = 13)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lqa;IILm;III[[[B[I[I[I[I[IIBIIZ)V", line = 152)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 310)
