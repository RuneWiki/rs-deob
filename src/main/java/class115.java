...
public class class115 extends class299 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLmj;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Les;)V")
    public class115(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;Ltga;ZBZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(ILes;)V")
