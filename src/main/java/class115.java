...
public class class115 extends class626 {
    ...
    @OriginalMember(owner = "client!rja", name = "c", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!rja", name = "F", descriptor = "(II)V", line = 40)
    public final void method492(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILwga;)I", line = 44)
    ...
    @OriginalMember(owner = "client!rja", name = "na", descriptor = "(IIII)[I", line = 62)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lwt;IIB)V", line = 101)
    ...
    @OriginalMember(owner = "client!rja", name = "v", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(I[IIIZII)Lec;", line = 154)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lbfa;Ltq;)Lvv;", line = 164)
    public final class345 method566(class390 arg0, class656 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!rja", name = "ya", descriptor = "()V", line = 171)
    public final void method483() {
        this.method3500((byte) 126, true);
        this.field1565.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(I[FLsw;IIIIZ)Lec;", line = 179)
    ...
    @OriginalMember(owner = "client!rja", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Laj;Ljava/lang/Integer;)Lha;", line = 190)
    ...
    @OriginalMember(owner = "client!rja", name = "C", descriptor = "(I)F", line = 289)
    public final float method859(int arg0) {
        int var2 = 19 % ((-arg0 - 7) / 56);
        return -0.5F;
    }

    @OriginalMember(owner = "client!rja", name = "U", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!rja", name = "o", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!rja", name = "p", descriptor = "()V", line = 330)
    public final void method511() {
    }

    @OriginalMember(owner = "client!rja", name = "h", descriptor = "(B)V", line = 333)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lsw;ILig;)Z", line = 350)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(IILoh;IIZLwt;)V", line = 365)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILjagdx/IDirect3DVertexShader;)V", line = 382)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(BLjagdx/IDirect3DPixelShader;)V", line = 396)
    ...
    @OriginalMember(owner = "client!rja", name = "o", descriptor = "()V", line = 405)
    public final void method503() {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILln;)I", line = 408)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Leo;Z)I", line = 438)
    ...
    @OriginalMember(owner = "client!rja", name = "e", descriptor = "(II)Ltq;", line = 468)
    public final class656 method536(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(BZI[[I)Lfn;", line = 475)
    ...
    @OriginalMember(owner = "client!rja", name = "y", descriptor = "()Z", line = 485)
    public final boolean method560() {
        return false;
    }

    @OriginalMember(owner = "client!rja", name = "x", descriptor = "()Lcja;", line = 494)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILaga;)V", line = 505)
    ...
    @OriginalMember(owner = "client!rja", name = "b", descriptor = "(II)V", line = 528)
    ...
    @OriginalMember(owner = "client!rja", name = "u", descriptor = "(I)V", line = 552)
    ...
    @OriginalMember(owner = "client!rja", name = "e", descriptor = "(B)V", line = 563)
    ...
    @OriginalMember(owner = "client!rja", name = "d", descriptor = "(II)Lbfa;", line = 595)
    public final class390 method528(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!rja", name = "A", descriptor = "()V", line = 601)
    public final void method568() {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ZLsw;II[BIII)Lec;", line = 605)
    ...
    @OriginalMember(owner = "client!rja", name = "j", descriptor = "(Z)V", line = 616)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(BLjava/awt/Canvas;)Ljava/lang/Object;", line = 626)
    public final Object method875(byte arg0, Canvas arg1) {
        return arg0 <= 61 ? (Object) null : null;
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILss;)I", line = 636)
    ...
    @OriginalMember(owner = "client!rja", name = "b", descriptor = "(IIIID)V", line = 660)
    public final void method447(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lvu;I)V", line = 664)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ILjava/awt/Canvas;Ljava/lang/Object;)V", line = 707)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(IIII)V", line = 715)
    public final void method516(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!rja", name = "L", descriptor = "(I)V", line = 721)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lnn;I)V", line = 733)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lwt;I)I", line = 757)
    ...
    @OriginalMember(owner = "client!rja", name = "n", descriptor = "(B)V", line = 791)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lid;II)V", line = 820)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lsw;Lig;B)I", line = 830)
    ...
    @OriginalMember(owner = "client!rja", name = "r", descriptor = "(B)V", line = 867)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Ljagdx/D3DPRESENT_PARAMETERS;IBLjagdx/IDirect3D;II)Z", line = 877)
    ...
    @OriginalMember(owner = "client!rja", name = "z", descriptor = "(I)V", line = 982)
    public final void method887(int arg0) {
        this.field1565.method2978(174, this.field8767);
        int var2 = -36 % ((arg0 + 54) / 38);
    }

    @OriginalMember(owner = "client!rja", name = "b", descriptor = "(Z)V", line = 991)
    public final void method541(boolean arg0) {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 994)
    public final void method487(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class566 {
        this.method504(arg2, arg3);
    }

    @OriginalMember(owner = "client!rja", name = "I", descriptor = "()I", line = 1001)
    public final int method490() {
        return 0;
    }

    @OriginalMember(owner = "client!rja", name = "ib", descriptor = "(I)Z", line = 1009)
    ...
    @OriginalMember(owner = "client!rja", name = "R", descriptor = "(I)V", line = 1052)
    ...
    @OriginalMember(owner = "client!rja", name = "P", descriptor = "(I)V", line = 1065)
    ...
    @OriginalMember(owner = "client!rja", name = "c", descriptor = "()Z", line = 1076)
    public final boolean method461() {
        return false;
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Ljava/awt/Canvas;BLjava/lang/Object;)V", line = 1083)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(IILig;Lsw;I)Lec;", line = 1094)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "([Lrd;B)Lnc;", line = 1107)
    public final class26 method893(class357[] arg0, byte arg1) {
        int var3 = 8 % ((arg1 + 87) / 37);
        return new dxVertexLayout(this, arg0);
    }

    @OriginalMember(owner = "client!rja", name = "k", descriptor = "(I)V", line = 1116)
    ...
    @OriginalMember(owner = "client!rja", name = "d", descriptor = "(IZ)V", line = 1127)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lsw;III[BI)Loo;", line = 1137)
    ...
    @OriginalMember(owner = "client!rja", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/ge;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lsg;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Laj;I)V", line = 1146)
    ...
    @OriginalMember(owner = "client!rja", name = "m", descriptor = "(I)V", line = 1196)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(BLjava/awt/Canvas;Ljava/lang/Object;)V", line = 1207)
    ...
    @OriginalMember(owner = "client!rja", name = "j", descriptor = "(II)Laba;", line = 1232)
    ...
    @OriginalMember(owner = "client!rja", name = "fb", descriptor = "(I)V", line = 1280)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Llba;I)V", line = 1316)
    ...
    @OriginalMember(owner = "client!rja", name = "f", descriptor = "(IZ)Lid;", line = 1339)
    ...
    @OriginalMember(owner = "client!rja", name = "o", descriptor = "(B)V", line = 1349)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(FFF)V", line = 1360)
    public final void method512(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lvv;)V", line = 1362)
    public final void method549(class345 arg0) {
    }

    @OriginalMember(owner = "client!rja", name = "d", descriptor = "()V", line = 1367)
    public final void method465() {
        this.field1567.method3938((byte) 83);
        super.method465();
    }

    @OriginalMember(owner = "client!rja", name = "q", descriptor = "(I)V", line = 1376)
    ...
    @OriginalMember(owner = "client!rja", name = "GA", descriptor = "(I)V", line = 1386)
    public final void method458(int arg0) {
        this.field1565.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!rja", name = "e", descriptor = "()V", line = 1394)
    ...
    @OriginalMember(owner = "client!rja", name = "h", descriptor = "(II)V", line = 1418)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Ldn;Ldn;FLdn;)Ldn;", line = 1428)
    public final class544 method497(class544 arg0, class544 arg1, float arg2, class544 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!rja", name = "f", descriptor = "(Z)V", line = 1435)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ZZBILss;)V", line = 1458)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(IZ)Loh;", line = 1494)
    ...
    @OriginalMember(owner = "client!rja", name = "w", descriptor = "(I)V", line = 1506)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lsw;Lig;Z)Z", line = 1547)
    ...
    @OriginalMember(owner = "client!rja", name = "l", descriptor = "(B)V", line = 1559)
    ...
    @OriginalMember(owner = "client!rja", name = "q", descriptor = "(B)V", line = 1568)
    ...
    @OriginalMember(owner = "client!rja", name = "g", descriptor = "(I)V", line = 1588)
    public final synchronized void method546(int arg0) {
        this.field1567.method3939(true);
        super.method546(arg0);
    }

    @OriginalMember(owner = "client!rja", name = "m", descriptor = "()V", line = 1599)
    public final void method500() {
    }

    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lnc;B)V", line = 1611)
    ...
    @OriginalMember(owner = "client!rja", name = "j", descriptor = "(I)V", line = 1622)
    ...
    @OriginalMember(owner = "client!rja", name = "s", descriptor = "(I)V", line = 1633)
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Lss;ZZI)V", line = 1655)
    ...
    @OriginalMember(owner = "client!rja", name = "m", descriptor = "(B)V", line = 1689)
    ...
    @OriginalMember(owner = "client!rja", name = "y", descriptor = "(I)V", line = 1707)
