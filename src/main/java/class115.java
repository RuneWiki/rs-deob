...
public class class115 {
    ...
    @OriginalMember(owner = "client!r", name = "i", descriptor = "Loe;")
    public static class127 field1950 = new class127(43, 6);

    @OriginalMember(owner = "client!r", name = "j", descriptor = "I")
    public static int field1951 = 0;

    @OriginalMember(owner = "client!r", name = "l", descriptor = "Loe;")
    public static class127 field1953;
    ...
    static {
        new class423("You appear to be telling someone your password - please don't!", "Willst du jemandem dein Passwort verraten? Das darfst du nicht! Falls das", "Il semble que vous révéliez votre mot de passe à quelqu'un - ne faites jamais ça !", "Parece que você está revelando sua senha a alguém. Não faça isso!");
        field1953 = new class127(16, 10);
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)V", line = 6)
    public static void method820(byte arg0) {
        field1953 = null;
        int var1 = -25 / ((-arg0 - 2) / 40);
        field1950 = null;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IB)I", line = 17)
    public final int method821(int arg0, byte arg1) {
        field1952++;
        if (this.field1947 != null) {
            arg0 = (int) ((long) this.field1943 * (long) arg0 / (long) this.field1949) + 6;
        }
        if (arg1 != 87) {
            this.method825(false, -36);
        }
        return arg0;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Z)V", line = 34)
    public static final void method822(boolean arg0) {
        field1948++;
        if (class345.field5116.method1926()) {
            class345.field5116.method1970(class257.field3919);
            class427.method2507(26062);
            class345.field5116.method1904(class257.field3919);
            class345.field5116.method1937(class257.field3919);
        } else {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILqi;)Z", line = 55)
    public static final boolean method823(int arg0, class382 arg1) {
        field1945++;
        int var2 = -125 % ((-arg0 - 68) / 57);
        return class372.field5448 == arg1 || class504.field7623 == arg1 || class8.field98 == arg1 || class292.field4454 == arg1;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I[B)[B", line = 66)
    public final byte[] method824(int arg0, byte[] arg1) {
        field1942++;
        if (arg0 < 10) {
            method822(true);
        }
        if (this.field1947 != null) {
            int var3 = (int) ((long) arg1.length * (long) this.field1943 / (long) this.field1949) + 14;
            int[] var4 = new int[var3];
            int var5 = 0;
            int var6 = 0;
            for (int var7 = 0; var7 < arg1.length; var7++) {
                byte var10 = arg1[var7];
                int[] var11 = this.field1947[var6];
                for (int var12 = 0; var12 < 14; var12++) {
                    var4[var5 + var12] += var11[var12] * var10;
                }
                int var13 = this.field1943 + var6;
                int var14 = var13 / this.field1949;
                var6 = var13 - this.field1949 * var14;
                var5 += var14;
            }
            arg1 = new byte[var3];
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZI)I", line = 133)
    public final int method825(boolean arg0, int arg1) {
        if (!arg0) {
            this.method824(5, null);
        }
        if (this.field1947 != null) {
            arg1 = (int) ((long) this.field1943 * (long) arg1 / (long) this.field1949);
        }
        field1946++;
        return arg1;
    }

    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(II)V", line = 149)
    public class115(int arg0, int arg1) {
        if (arg0 != arg1) {
            int var3 = class211.method1299(arg0, -125, arg1);
            int var4 = arg1 / var3;
            int var5 = arg0 / var3;
            this.field1949 = var5;
            this.field1947 = new int[var5][14];
            this.field1943 = var4;
            for (int var6 = 0; var6 < var5; var6++) {
                int[] var7 = this.field1947[var6];
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)[[[B", line = 215)
    public static final byte[][][] method826(int arg0, int arg1) {
        field1944++;
        ...
        int var93 = 0;
        for (int var94 = arg0 + var4; var94 >= 0; var94--) {
