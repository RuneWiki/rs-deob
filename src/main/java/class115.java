...
public class class115 extends class539 implements class353 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILcea;)Lfu;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljaclib/memory/Source;IIB)Z")
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lbga;Z)V")
