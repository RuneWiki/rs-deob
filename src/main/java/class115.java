...
public class class115 extends class397 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II[IZILrl;)Loc;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILqn;)[Lil;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IBLae;)V")
