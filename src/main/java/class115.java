...
public class class115 extends class48 implements ImageProducer, ImageObserver {
    ...
    @OriginalMember(owner = "client!mc", name = "y", descriptor = "Llf;")
    public static class109 field2281 = class35.method275(" )2> ", 2);

    @OriginalMember(owner = "client!mc", name = "z", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Llf;Llf;ILlf;I)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lvg;I)V")
