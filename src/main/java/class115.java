...
public class class115 extends class400 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([B[IIIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(CIIIZLaa;II)V", line = 134)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lii;Loq;[Ltba;[I[I)V", line = 198)
    ...
    @OriginalMember(owner = "client!nu", name = "fa", descriptor = "(CIIIZ)V", line = 241)
