...
public class class115 extends class80 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II[BIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)V", line = 137)
    public static void method862(int arg0) {
        int var1 = -30 % ((arg0 - 8) / 46);
        field1750 = null;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B[BII)V", line = 146)
    ...
    @OriginalMember(owner = "client!er", name = "finalize", descriptor = "()V", line = 156)
    protected final void finalize() {
        field1760++;
        this.method612((byte) 107);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II[BI)I", line = 165)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(I)Z", line = 208)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 3707)
