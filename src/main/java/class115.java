...
public class class115 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(JI)Lcja;", line = 22)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(ZLcn;)V", line = 51)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lsg;Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IJLcja;)V", line = 133)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)Lcja;", line = 190)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Z)V", line = 231)
