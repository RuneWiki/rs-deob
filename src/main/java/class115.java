...
public class class115 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIZIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIII)Z", line = 49)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lps;I)Lhg;", line = 79)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 97)
