...
public class class115 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(II[BB)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIILmf;)V", line = 47)
    ...
    @OriginalMember(owner = "client!ju", name = "toString", descriptor = "()Ljava/lang/String;", line = 91)
