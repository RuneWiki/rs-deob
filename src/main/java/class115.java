...
public class class115 extends class14 {
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gg", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IB)[I", line = 51)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "()V", line = 87)
    public class115() {
        this(4096);
    }

    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IBLmd;)V", line = 107)
