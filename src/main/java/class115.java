...
public class class115 implements class647 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!hu", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    public final String toString() {
        field1491++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IBII)V", line = 40)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 57)
