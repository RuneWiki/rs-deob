...
public class class115 extends class335 {
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 4)
    public class115() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILio;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lhe;IB)V", line = 49)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B[B)Ljava/lang/String;", line = 79)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IZ)[[I", line = 156)
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "(I)V", line = 242)
