...
public class class115 extends class90 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILza;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIB)V", line = 13)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILza;Lum;)V", line = 60)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(ILza;)Lhp;", line = 82)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lza;III)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)V", line = 164)
