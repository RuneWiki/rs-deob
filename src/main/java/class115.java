...
public class class115 {
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(II)Lpp;")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(III)Lup;")
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(II)Liba;")
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lei;ILri;)V")
