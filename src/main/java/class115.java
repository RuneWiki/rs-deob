...
public class class115 extends class317 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(CIIIZLma;II)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!uh", name = "OA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lcj;Llm;[Ldi;[I[I)V")
