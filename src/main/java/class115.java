...
public class class115 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BI)Lgj;", line = 6)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I[IB)Lkr;", line = 36)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 74)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "([IIBI)Lkr;", line = 112)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lmo;Lmo;)V", line = 235)
    public class115(class447 arg0, class447 arg1) {
        this.field1589 = arg0;
        this.field1587 = arg1;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II[II)Lkr;", line = 170)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "([III)Lkr;", line = 216)
