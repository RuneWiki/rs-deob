...
public class class115 extends class409 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lqa;[Leh;Z)V")
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(I)Luh;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lqa;J)Z")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([Ltb;Z)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lqa;J[Leh;[Ltb;Z)V")
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "()Lwg;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lqa;)V")
