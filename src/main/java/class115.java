...
public class class115 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILfo;)I")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)Lew;")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZIZLdn;)V")
