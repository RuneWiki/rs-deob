...
public abstract class class115 extends class359 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZII)[I", line = 101)
    ...
    @OriginalMember(owner = "client!ik", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([Ljava/lang/Object;ZII[I)V", line = 139)
    ...
    @OriginalMember(owner = "client!ik", name = "d", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIB)V", line = 211)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BLbk;I)V", line = 235)
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(I)I", line = 245)
    ...
    @OriginalMember(owner = "client!ik", name = "f", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!ik", name = "g", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!ik", name = "c", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BII)[[I", line = 313)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BIII)I", line = 358)
    ...
    @OriginalMember(owner = "client!ik", name = "d", descriptor = "(B)Z", line = 369)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(IZ)V", line = 387)
    public class115(int arg0, boolean arg1) {
        this.field1347 = arg1;
        this.field1339 = new class115[arg0];
    }

    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(II)[I", line = 399)
