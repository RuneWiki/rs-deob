...
public class class115 extends class387 {
    ...
    @OriginalMember(owner = "client!pg", name = "i", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pg", name = "h", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lct;ZLct;)V", line = 72)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(II)I", line = 87)
    public static final int method804(int arg0, int arg1) {
        ++field1566;
        return arg1 != 255 ? 23 : arg0 & 255;
    }

    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)[B", line = 99)
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "(B)V", line = 120)
