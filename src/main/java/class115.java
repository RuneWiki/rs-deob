...
public class class115 extends class181 {
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(III)[B", line = 3)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "()V", line = 9)
    public class115() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IB)V", line = 13)
