...
public class class115 extends class90 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lre;B)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BILre;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(III)Lgo;")
