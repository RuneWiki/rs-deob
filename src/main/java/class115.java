...
public class class115 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IZILnd;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Laq;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Laq;III)V")
