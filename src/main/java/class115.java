...
public class class115 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIIIIIIIII)Z", line = 19)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 656)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ILko;Lko;)V", line = 706)
