...
public class class115 implements class58 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)Z", line = 42)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lla;Lla;Lwv;)V", line = 79)
