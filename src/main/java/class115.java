...
public class class115 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lqa;JB)V", line = 39)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II[ILbv;IZ)Log;", line = 71)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 106)
