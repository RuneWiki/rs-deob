...
public class class115 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "([BIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(JZ[B)V", line = 103)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)V", line = 318)
