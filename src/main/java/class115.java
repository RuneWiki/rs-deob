...
public class class115 {
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(B)Z", line = 13)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IB)Lnr;", line = 40)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lne;Lrg;ZI)V", line = 65)
