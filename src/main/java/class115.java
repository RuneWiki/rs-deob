...
public class class115 extends class444 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!di", name = "e", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 66)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(III)V", line = 119)
