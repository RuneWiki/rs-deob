...
public class class115 extends class322 {
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(ILch;)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lch;)V")
    public class115(class463 arg0) {
        super(arg0);
        class597.method3365((byte) -19, super.field4451);
    }

    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(B)Z")
