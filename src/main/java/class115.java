...
public class class115 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BI)Lsb;", line = 3)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(B)V", line = 53)
