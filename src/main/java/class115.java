...
public class class115 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lbm;Ld;)V", line = 95)
    public class115(class684 arg0, class96 arg1) {
        this.field1422 = arg0;
        this.field1417 = arg1;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)Lbaa;", line = 48)
