...
public class class754 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BIIILke;)V")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BILcea;)V")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IZILha;)Lmi;")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BLcea;)V")
