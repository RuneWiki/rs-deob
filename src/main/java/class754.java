...
public class class754 extends class54 {
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(Z)I", line = 9)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(BII)I", line = 34)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(IB)I", line = 76)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lhia;)V", line = 91)
    public class754(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pea", name = "c", descriptor = "(Z)I", line = 99)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(ILhia;)V", line = 117)
    public class754(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(FI)F", line = 120)
    ...
    @OriginalMember(owner = "client!pea", name = "d", descriptor = "(I)Z", line = 131)
