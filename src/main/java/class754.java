...
public class class754 extends class601 {
    ...
    @OriginalMember(owner = "client!uha", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Lmc;II)V")
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIIBILmea;)V")
