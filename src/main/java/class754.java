...
public class class754 extends class541 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 6)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 75)
    public class754(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)Lgo;", line = 86)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IILsl;)V", line = 124)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(Z)I", line = 144)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(III)Z", line = 164)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILnd;)V", line = 175)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(I)D", line = 187)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(Z)I", line = 213)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)V", line = 251)
