...
public class class754 extends class549 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Z)Lww;", line = 17)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(ILrg;Lal;III)V", line = 44)
    public class754(int arg0, class557 arg1, class125 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field10382 = arg5;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Z", line = 52)
