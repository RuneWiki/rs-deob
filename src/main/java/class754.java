...
public class class754 extends class391 implements class466 {
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(Lha;I)Ltja;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(Lha;I)V")
    public final void method76(class473 arg0, int arg1) {
        ++field10401;
        int var3 = -59 % ((-30 - arg1) / 42);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lha;Lro;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLha;I)Lka;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILha;ZI)Luaa;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Loq;IZILha;II)V")
