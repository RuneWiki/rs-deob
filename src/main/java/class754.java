...
public class class754 extends class303 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Luu;I)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILuu;)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Luu;B)V")
    ...
    @OriginalMember(owner = "client!wn", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Luu;)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Luu;Luu;)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILjava/net/Socket;I)Lsea;")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "()Luu;")
