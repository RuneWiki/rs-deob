...
public class class754 extends class303 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "([BZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!cp", name = "h", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIIIIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(ILwia;I)V", line = 154)
    ...
    @OriginalMember(owner = "client!cp", name = "e", descriptor = "(B)V", line = 173)
