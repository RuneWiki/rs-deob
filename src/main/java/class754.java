...
public class class754 extends class232 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!pea", name = "f", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!pea", name = "e", descriptor = "(I)Z", line = 189)
    ...
    @OriginalMember(owner = "client!pea", name = "g", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ILdr;I)V", line = 217)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ZB)V", line = 233)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(III)V", line = 264)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Log;Lcb;Llo;)V", line = 296)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(B)V", line = 316)
