...
public class class754 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILol;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)Z", line = 92)
    public final boolean method4162(int arg0) {
        field10493++;
        return arg0 == -65536 ? this.field10489 : false;
    }

    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(ZIIZ)V", line = 104)
