...
public class class754 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)Ltba;", line = 8)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILvj;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lvj;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZZ)Z", line = 115)
