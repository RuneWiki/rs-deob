...
public class class754 extends class528 {
    ...
    @OriginalMember(owner = "client!tfa", name = "g", descriptor = "(I)Lgt;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "()Ljn;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILgt;)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(DBI)Lgt;")
