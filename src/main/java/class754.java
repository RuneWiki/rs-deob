...
public class class754 extends class142 implements class722 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILac;ZLjava/lang/String;)Lv;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)Lmu;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZLha;ZI)Lsfa;")
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILha;BI)Z")
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(Lha;I)V")
    public final void method136(class60 arg0, int arg1) {
        int var3 = 121 / ((53 - arg1) / 46);
        ++field10475;
    }

    @OriginalMember(owner = "client!lo", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BLha;)Loia;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lgg;BZILha;II)V")
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(Lha;I)Lbd;")
