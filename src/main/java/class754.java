...
public class class754 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lwg;Lvo;Lll;IIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IILje;)V", line = 201)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lda;)V", line = 233)
