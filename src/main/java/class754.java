...
public class class754 {
    ...
    @OriginalMember(owner = "client!f", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!f", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field10498.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!f", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
