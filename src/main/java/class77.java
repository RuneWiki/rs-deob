...
public class class77 extends class116 implements class535 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(I)I", line = 217)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(B)V", line = 239)
    public final void method602(byte arg0) {
        super.method602(arg0);
        ++field882;
    }

    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lko;Lbja;Z)V", line = 249)
    public class77(class529 arg0, class34 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field875 = arg1;
    }

    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)Lbja;", line = 258)
    public final class34 method603(byte arg0) {
        ++field876;
        return arg0 >= -65 ? null : this.field875;
    }

    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)V", line = 270)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 284)
