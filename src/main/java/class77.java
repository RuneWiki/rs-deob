...
public class class77 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lcp;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZLmk;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lcp;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ljava/lang/Object;IILcp;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lcp;B)V")
