...
public class class77 extends class601 {
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(ILgn;)V", line = 6)
    public class77(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(II)I", line = 9)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(BZLpk;)V", line = 38)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Lgn;)V", line = 223)
    public class77(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(B)I", line = 230)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Z)V", line = 245)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(I)I", line = 289)
