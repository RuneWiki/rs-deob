...
public class class77 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(II)I", line = 6)
    public static int method473(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILfc;IIFIIFIIFF[BF)V", line = 26)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IILka;II)Lid;", line = 77)
