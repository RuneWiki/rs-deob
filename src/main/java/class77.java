...
public class class77 extends class651 implements class166 {
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Log;Lofa;Lkn;II)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIILofa;[BIZI)V")
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Log;Lofa;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Log;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I[FILofa;IIIII)V")
    ...
    @OriginalMember(owner = "client!sh", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Log;Lofa;IIZ[FII)V")
