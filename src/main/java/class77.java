...
public class class77 extends class362 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 9)
    public static final void method714(int arg0) {
        class340.field4790 = arg0;
    }

    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IIIIIBI)V", line = 26)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BLsia;)I", line = 215)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BS)V", line = 247)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "([[ZIIII)V", line = 262)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lqo;Led;Lab;[I)V", line = 317)
