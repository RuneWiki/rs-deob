...
public class class77 extends class392 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ILji;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IC)I", line = 71)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(CB)I", line = 99)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lji;Z)V", line = 181)
