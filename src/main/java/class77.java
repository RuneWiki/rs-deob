...
public class class77 extends class185 {
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIIII)V")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lde;")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIIZ[III)V")
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Leq;BILjava/lang/String;)Lci;")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIII[I)V")
    public class77(class357 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Leq;IIII)V")
