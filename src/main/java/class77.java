...
public abstract class class77 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIILbe;)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lrk;I)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IB)Ljn;")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IBLrk;I)Lvm;")
