...
public class class77 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lvj;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "([BB)V", line = 46)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Z)V", line = 221)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BI)Z", line = 245)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIII)V", line = 257)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "([BI)V", line = 295)
