...
public class class77 implements class160 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILrc;IZI)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILrc;II)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILve;I)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lah;IB)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lah;IIB)V")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lod;)V")
