...
public class class77 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "([[I[[B[[BILda;[[BZIZILtj;Lda;[[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 322)
