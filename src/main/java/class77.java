...
public class class77 extends class37 implements class338 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!fv", name = "g", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!fv", name = "d", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ZLqa;II)Len;", line = 92)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lqa;Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lqa;II)Lc;", line = 136)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)I", line = 157)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(B)I", line = 169)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lqa;Lus;IIIIIZIIIIIIZ)V", line = 180)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BLqa;I)Lc;", line = 213)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lqa;I)V", line = 224)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)I", line = 255)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(I)I", line = 269)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILqa;)V", line = 280)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IILqa;I)Z", line = 317)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(B)Z", line = 339)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILhq;)V", line = 351)
    ...
    @OriginalMember(owner = "client!fv", name = "e", descriptor = "(B)V", line = 561)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(ILqa;)Lfm;", line = 574)
