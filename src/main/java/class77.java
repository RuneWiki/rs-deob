...
public class class77 extends class239 implements class669 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 3)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ZII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)I", line = 68)
    public final int method695(byte arg0) {
        ++field1139;
        return arg0 < 37 ? 95 : super.method695((byte) 45);
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 107)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)I", line = 123)
    ...
    @OriginalMember(owner = "client!jca", name = "e", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Lom;Z)V", line = 185)
    public class77(class642 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(III)Z", line = 192)
    ...
    @OriginalMember(owner = "client!jca", name = "f", descriptor = "(I)I", line = 205)
