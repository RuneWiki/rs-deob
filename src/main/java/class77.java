...
public class class77 extends class452 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "([IIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I[B[IIIIIIIILnp;)I", line = 58)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "()Ltf;", line = 97)
    public final class452 method109() {
        return null;
    }

    @OriginalMember(owner = "client!np", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "()I", line = 113)
    public final synchronized int method461() {
        return this.field956 < 0 ? -1 : this.field956;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "()Ltf;", line = 116)
    public final class452 method114() {
        return null;
    }

    @OriginalMember(owner = "client!np", name = "f", descriptor = "()V", line = 119)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "([III)V", line = 126)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II[B[IIIIIIIILnp;II)I", line = 361)
    ...
    @OriginalMember(owner = "client!np", name = "g", descriptor = "()Z", line = 394)
    public final boolean method464() {
        return this.field947 != 0;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II[B[IIIIIIIIIILnp;II)I", line = 401)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II[B[IIIIIIILnp;II)I", line = 444)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)V", line = 472)
    public final synchronized void method467(int arg0, int arg1) {
        this.method481(arg0, arg1, this.method461());
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "([B[IIIIIIIILnp;)I", line = 476)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(I)V", line = 510)
    private final synchronized void method469(int arg0) {
        this.method494(arg0, this.method461());
    }

    @OriginalMember(owner = "client!np", name = "e", descriptor = "(I)V", line = 513)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "([B[IIIIIIIILnp;)I", line = 560)
    ...
    @OriginalMember(owner = "client!np", name = "h", descriptor = "()Z", line = 596)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)V", line = 681)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(II)I", line = 899)
    private static final int method473(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!np", name = "c", descriptor = "(II)I", line = 903)
    private static final int method474(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!np", name = "b", descriptor = "(Z)V", line = 906)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(II[B[IIIIIIIILnp;II)I", line = 912)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lve;III)Lnp;", line = 945)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I[B[IIIIIIIIIILnp;)I", line = 953)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(II[B[IIIIIIIILnp;II)I", line = 1006)
    ...
    @OriginalMember(owner = "client!np", name = "i", descriptor = "()V", line = 1040)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)V", line = 1051)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "()I", line = 1098)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(II[B[IIIIIIIIIILnp;II)I", line = 1110)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(II[B[IIIIIIIILnp;II)I", line = 1151)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I[B[IIIIIIIILnp;)I", line = 1183)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "()I", line = 1222)
    public final int method107() {
        return this.field958 == 0 && this.field947 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!np", name = "b", descriptor = "(II[B[IIIIIIILnp;II)I", line = 1229)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "([IIIII)I", line = 1255)
    ...
    @OriginalMember(owner = "client!np", name = "f", descriptor = "(I)V", line = 1313)
    public final synchronized void method488(int arg0) {
        this.field951 = arg0;
    }

    @OriginalMember(owner = "client!np", name = "g", descriptor = "(I)V", line = 1316)
    public final synchronized void method489(int arg0) {
        this.method494(arg0 << 6, this.method461());
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "([B[IIIIIIILnp;)I", line = 1320)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "([B[IIIIIIILnp;)I", line = 1345)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I[B[IIIIIIIIIILnp;)I", line = 1370)
    ...
    @OriginalMember(owner = "client!np", name = "j", descriptor = "()Z", line = 1424)
    public final boolean method493() {
        return this.field944 < 0 || this.field944 >= ((class159) super.field6310).field1859.length << 8;
    }

    @OriginalMember(owner = "client!np", name = "d", descriptor = "(II)V", line = 1427)
    ...
    @OriginalMember(owner = "client!np", name = "k", descriptor = "()I", line = 1433)
    public final synchronized int method495() {
        return this.field955 < 0 ? -this.field955 : this.field955;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lve;II)Lnp;", line = 1437)
    ...
    @OriginalMember(owner = "client!np", name = "l", descriptor = "()I", line = 1445)
    public final synchronized int method497() {
        return this.field958 == Integer.MIN_VALUE ? 0 : this.field958;
    }

    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lve;II)V", line = 1447)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lve;III)V", line = 1458)
    ...
    @OriginalMember(owner = "client!np", name = "h", descriptor = "(I)V", line = 1471)
