...
public class class77 extends class689 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I[BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)Ltca;", line = 18)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lga;IB)Laga;", line = 32)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Ltl;Lfn;IIIIIIIIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)V", line = 68)
