...
public class class77 extends class338 {
    ...
    @OriginalMember(owner = "client!mn", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I[[[Le;)V", line = 20)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 119)
