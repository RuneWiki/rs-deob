...
public class class77 extends class264 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLgf;)I")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(III)Lae;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLkk;I)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lis;B)V")
