...
public class class77 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(BIILdga;)V", line = 49)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ldga;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(B)V", line = 148)
