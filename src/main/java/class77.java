...
public class class77 extends class440 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(JI)V", line = 28)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lr;J)V", line = 424)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lik;IIIIIIIIIIIZZ)V", line = 597)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lik;IIIIIIIIIIIZZ)V", line = 616)
