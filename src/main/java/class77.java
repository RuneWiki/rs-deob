...
public class class77 {
    ...
    @OriginalMember(owner = "client!in", name = "exit", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!in", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILjava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!in", name = "listmodes", descriptor = "()[I")
