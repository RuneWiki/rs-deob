...
public class class77 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BILr;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "([[ZIIIZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILr;II)V", line = 276)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BII)Z", line = 353)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)V", line = 365)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lha;IIILjava/lang/String;ZII)V", line = 382)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IIILr;)V", line = 425)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IIIII)V", line = 501)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(B)V", line = 545)
    ...
    @OriginalMember(owner = "client!qw", name = "c", descriptor = "(B)V", line = 561)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lrv;Lvia;)V", line = 598)
