...
public class class77 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 49)
