...
public class class77 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IB)V", line = 34)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ZZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(II)Llba;", line = 148)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(B)V", line = 183)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIIIIII)V", line = 242)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(III)Z", line = 296)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Ljc;ILgp;)V", line = 309)
