...
public abstract class class77 extends class105 {
    ...
    @OriginalMember(owner = "client!dha", name = "g", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IIIBIIII)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ILjb;)V")
    ...
    @OriginalMember(owner = "client!dha", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Ljava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!dha", name = "j", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "([Lwi;I)I")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lfp;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(IIIII)V")
