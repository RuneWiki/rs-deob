...
public class class77 extends class396 {
    ...
    @OriginalMember(owner = "client!qm", name = "h", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lae;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)Z", line = 52)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)I", line = 91)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZBIILna;ILae;)V", line = 111)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BILae;)Z", line = 125)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BLae;)Ljg;", line = 241)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)I", line = 316)
    ...
    @OriginalMember(owner = "client!qm", name = "j", descriptor = "(I)Z", line = 340)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IBI)V", line = 354)
    ...
    @OriginalMember(owner = "client!qm", name = "e", descriptor = "(B)Z", line = 440)
    ...
    @OriginalMember(owner = "client!qm", name = "e", descriptor = "(I)V", line = 451)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILae;II)Z", line = 466)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lsr;I)V", line = 504)
