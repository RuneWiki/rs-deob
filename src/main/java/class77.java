...
public class class77 extends class123 {
    ...
    @OriginalMember(owner = "client!co", name = "ja", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!co", name = "j", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!co", name = "ka", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!co", name = "xa", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!co", name = "N", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III[I)V", line = 71)
    ...
    @OriginalMember(owner = "client!co", name = "ra", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!co", name = "za", descriptor = "(Lc;)V", line = 86)
    ...
    @OriginalMember(owner = "client!co", name = "p", descriptor = "(III[I)V", line = 101)
    ...
    @OriginalMember(owner = "client!co", name = "m", descriptor = "([I)V", line = 108)
    ...
    @OriginalMember(owner = "client!co", name = "o", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!co", name = "O", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "()Lc;", line = 136)
    ...
    @OriginalMember(owner = "client!co", name = "s", descriptor = "(IIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "()V", line = 182)
    public class77() {
        this.method223();
    }
}
