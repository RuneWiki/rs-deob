...
public class class77 implements class648 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BLhg;)Z", line = 13)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)J", line = 60)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 92)
