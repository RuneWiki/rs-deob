...
public class class77 implements class70 {

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "[I")
    private int[] field973 = null;
    ...
    public final void method14(int arg0) {
        ...
        if (class162.field2241 && this.field973 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field973[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!tm", name = "c", descriptor = "()I", line = 28)
    public final int method16() {
        return 4;
    }

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "()V", line = 36)
    public final void method15() {
        GL var1 = class250.field3818;
        if (class162.field2241) {
            var1.glCallList(this.field974 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "()V", line = 271)
    public class77() {
        if (class250.field3788 && class250.field3801 >= 2) {
            this.method459();
            GL var1 = class250.field3818;
            var1.glBindTexture(34067, this.field973[0]);
            ...
            var1.glBindTexture(34067, this.field973[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field973[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field975 = class250.field3801 < 3;
        }
        this.method458();
    }

    @OriginalMember(owner = "client!tm", name = "d", descriptor = "()V", line = 51)
    private final void method458() {
        GL var1 = class250.field3818;
        this.field974 = var1.glGenLists(2);
        var1.glNewList(this.field974, 4864);
        if (this.field973 == null) {
            ...
            if (this.field975) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class250.field3792);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field974 + 1, 4864);
        if (this.field973 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "()V", line = 153)
    private final void method459() {
        GL var1 = class250.field3818;
        if (this.field973 == null) {
            this.field973 = new int[3];
            var1.glGenTextures(3, this.field973, 0);
        }
        short var2 = 4096;
