...
public class class77 extends class739 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BII)I", line = 6)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZI)[I", line = 19)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "()V", line = 77)
    public class77() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B[Ltd;)V", line = 98)
