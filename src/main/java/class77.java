...
public class class77 extends class451 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIILjava/awt/Graphics;III)V", line = 10)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/awt/Canvas;III)V", line = 28)
