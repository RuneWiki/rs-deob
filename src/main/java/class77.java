...
public class class77 implements Runnable {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(La;I)V")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILrb;I)La;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "([BIILrb;)La;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IILaa;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(ILrb;I)La;")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lkq;)V")
