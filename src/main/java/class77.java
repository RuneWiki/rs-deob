...
public class class77 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Z[[BLbd;)V")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Z)Lcfa;")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IB)Lin;")
