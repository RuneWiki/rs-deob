...
public class class77 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZLya;II)Ll;")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Liv;I)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILiv;I)V")
