...
public class class77 extends class488 {
    ...
    @OriginalMember(owner = "client!fv", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lin;Lds;[Ldt;[I[I)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(CIIIZLea;II)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "([B[I[IIIIIIIIIIILea;II)V")
