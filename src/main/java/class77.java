...
public class class77 implements class293 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Lhg;Z)V")
