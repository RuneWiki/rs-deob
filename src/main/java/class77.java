...
public class class77 extends class446 {
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lke;IIII)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IILac;)V")
