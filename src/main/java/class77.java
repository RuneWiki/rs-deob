...
public class class77 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 7)
    public class77(Throwable arg0, String arg1) {
        this.field864 = arg0;
        this.field862 = arg1;
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)Z", line = 300)
