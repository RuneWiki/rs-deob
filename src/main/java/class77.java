...
public class class77 extends class88 implements class678 {
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lsha;Lg;II[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(FZ)F", line = 20)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lsha;Lg;II[FII)V", line = 31)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIII[BLg;IB)V", line = 45)
    ...
    @OriginalMember(owner = "client!sh", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIII[III)V", line = 84)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IF)F", line = 108)
    public final float method621(int arg0, float arg1) {
        ++field1071;
        return arg0 != 20490 ? -0.2936516F : arg1;
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lsha;Lg;Lwj;II)V", line = 119)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZZZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)I", line = 141)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lsha;II[III)V", line = 153)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BZ[B)V", line = 168)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZZIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Z", line = 229)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)I", line = 299)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)Z", line = 310)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I[IIIIII)V", line = 321)
