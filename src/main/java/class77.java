...
public class class77 extends class504 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lvp;)Ljj;", line = 8)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
