...
public class class77 extends class518 implements class83 {
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(Lr;I)Lifa;")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIZLr;)Z")
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lr;Llt;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILr;ILcaa;ZII)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lr;I)Lhr;")
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BLr;)V")
