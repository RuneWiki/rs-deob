...
public class class77 extends class352 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ILlt;)I", line = 4)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lida;Lce;IIIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Lqv;", line = 60)
