...
public class class77 extends class255 implements class196 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IILqa;)Lc;", line = 19)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BZLqa;I)Lfo;", line = 40)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILqa;)V", line = 101)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lqa;I)Lpj;", line = 127)
    ...
    @OriginalMember(owner = "client!bk", name = "g", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lqa;Leu;IIIIZIIIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(BLqa;)V", line = 196)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(B)Z", line = 207)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)I", line = 221)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLqa;)V", line = 232)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILqa;B)Lc;", line = 260)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIILqa;)Z", line = 271)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(III)V", line = 294)
    ...
    @OriginalMember(owner = "client!bk", name = "e", descriptor = "(B)V", line = 303)
