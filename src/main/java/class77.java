...
public class class77 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ZLkj;)[Lnq;")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Llf;ILvh;)V")
    public class77(class157 arg0, int arg1, class240 arg2) {
        this.field1116 = arg2;
        this.field1116.method1397((byte) -32, 26);
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BI)Lap;")
