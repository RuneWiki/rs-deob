...
public class class77 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)Luu;")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BI)Ldv;")
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Ldd;ILpj;)V")
