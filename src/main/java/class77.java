...
public class class77 extends class287 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lqa;III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lfw;IIII)V", line = 91)
