...
public class class389 extends class383 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(IIIIIZ)V", line = 112)
    ...
    @OriginalMember(owner = "client!ii", name = "e", descriptor = "(I)V", line = 126)
