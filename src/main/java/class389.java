...
public class class389 extends class272 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(JBLwm;IZ)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILlo;)V")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lwm;Ljf;Loh;J)V")
