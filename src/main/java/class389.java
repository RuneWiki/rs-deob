...
public class class389 extends class49 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(JI)V", line = 4)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lnn;IIIIIIIIIIIZZ)V", line = 402)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "()V", line = 422)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "()V", line = 430)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lqa;J)V", line = 443)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lnn;IIIIIIIIIIIZZ)V", line = 636)
