...
public class class389 extends class328 {
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "()V", line = 259)
    public class389() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)[I", line = 20)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Laj;I)I", line = 233)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IB)V", line = 272)
    ...
    @OriginalMember(owner = "client!sv", name = "f", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!sv", name = "g", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BILco;)V", line = 321)
