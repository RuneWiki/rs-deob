...
public abstract class class389 extends class455 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(B)V", line = 22)
    public void method958(byte arg0) {
        int var2 = 97 / ((arg0 + 15) / 44);
        field5832++;
    }

    @OriginalMember(owner = "client!lq", name = "d", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 52)
