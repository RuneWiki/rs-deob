...
public class class389 extends class591 {
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Len;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Len;II)V")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Len;IIZ[[BI)V")
