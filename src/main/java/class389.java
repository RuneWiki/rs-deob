...
public class class389 extends class269 {
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IJ)V", line = 57)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lgk;I)Lhg;", line = 103)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(III)Llf;", line = 115)
