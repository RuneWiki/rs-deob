...
public class class389 extends class446 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lcc;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lpl;)V")
    public final synchronized void method2502(class446 arg0) {
        arg0.method322(11);
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lfb;Lcc;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "()Lpl;")
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "()Lpl;")
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(Lpl;)V")
