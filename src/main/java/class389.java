...
public class class389 extends class618 implements class406 {
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Ltia;II[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(FZ)F", line = 39)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Ltia;Lua;II[BII)V", line = 50)
    ...
    @OriginalMember(owner = "client!bfa", name = "g", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZIZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!bfa", name = "e", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(III[IIBII)V", line = 162)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Ltia;Lua;Ldn;II)V", line = 185)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I[IIIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIILua;II[BII)V", line = 225)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(B)I", line = 256)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(FI)F", line = 267)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Ltia;Lua;II[FII)V", line = 285)
