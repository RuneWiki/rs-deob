...
public class class389 extends class337 {
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZII)V", line = 636)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BZ)V", line = 693)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)V", line = 713)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lmh;Lpda;)V", line = 730)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IBLuu;)V", line = 769)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Z)V", line = 781)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)V", line = 818)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)Z", line = 837)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZI)V", line = 848)
