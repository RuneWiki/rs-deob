...
public class class389 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lgw;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIILsa;Lht;IIZLsa;ILqa;BZI)Lr;", line = 51)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I[[BLhf;)V", line = 170)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILht;IIIBLqa;)Lr;", line = 209)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IBIIIIIIIIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lgw;II)V", line = 341)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIII)V", line = 473)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZILqa;ILsa;IILht;IILsa;II)Lr;", line = 506)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lht;Lqa;IIIII)Lr;", line = 521)
