...
public class class389 extends class499 {
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 72)
    public static void method2433(byte arg0) {
        int var1 = 61 / ((27 - arg0) / 44);
        field5972 = null;
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIILhh;)V", line = 82)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z[[BLdv;)V", line = 95)
