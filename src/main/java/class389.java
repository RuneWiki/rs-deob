...
public class class389 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([Lwn;ILjava/lang/String;)I", line = 17)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;[Lwn;BI)I", line = 121)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I[Lwn;Ljava/lang/String;I)I", line = 152)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([Lwn;[Ljava/lang/String;BLjava/lang/String;[I)I", line = 169)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I[Lwn;Ljava/lang/String;IB)I", line = 423)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(CI)Z", line = 441)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)V", line = 452)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "([B)V", line = 480)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ICI)I", line = 603)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IB)I", line = 626)
