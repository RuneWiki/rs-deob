...
public class class389 extends class648 {
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lbca;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)I", line = 66)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lno;Lvd;)V", line = 147)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZZ)V", line = 202)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BII)V", line = 218)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)V", line = 239)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)Z", line = 269)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZI)V", line = 285)
