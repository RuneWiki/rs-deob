...
public class class389 extends class223 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIBII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "()V", line = 54)
    public class389() {
    }

    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(I)V", line = 57)
