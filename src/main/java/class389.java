...
public class class389 extends class508 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILks;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lfa;IZLpl;IDI)[I", line = 194)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILpl;Lfa;)Z", line = 335)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZIILfa;Lpl;I)[F", line = 387)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLpl;DIZZILfa;)[I", line = 498)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(B)V", line = 648)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 670)
    public class389() {
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Les;)V", line = 685)
