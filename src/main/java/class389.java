...
public class class389 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I)Lmg;", line = 94)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BLmg;)V", line = 134)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)I", line = 155)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(I)Lmg;", line = 176)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(II)V", line = 194)
    ...
    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(B)Lmg;", line = 222)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "()V", line = 276)
    public class389() {
        this.field5775.field1287 = this.field5775;
        this.field5775.field1286 = this.field5775;
    }

    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(Z)V", line = 254)
