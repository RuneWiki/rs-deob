...
public abstract class class389 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ll;ZILgt;Ljava/awt/Canvas;)Lza;", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lum;II)Lap;", line = 31)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILeg;II)Ltr;", line = 49)
