...
public abstract class class389 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(IIIII)V", line = 286)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(B)V", line = 300)
