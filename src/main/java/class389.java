...
public class class389 extends class530 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIILhg;I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(ILah;)V")
    public class389(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lah;)V")
