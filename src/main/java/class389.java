...
public class class389 extends class207 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IJI)Lwga;", line = 5)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(IB)I", line = 57)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(ILrd;)V", line = 72)
    public class389(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)V", line = 76)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lrd;)V", line = 107)
    public class389(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(I)I", line = 110)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)Z", line = 133)
    ...
    @OriginalMember(owner = "client!pa", name = "d", descriptor = "(I)V", line = 151)
