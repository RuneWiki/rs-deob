...
public class class389 extends class66 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(II)I", line = 186)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IIII[[Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(III)V", line = 260)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(BS)V", line = 396)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(B)V", line = 413)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lrr;Lhm;Lcp;[I)V", line = 427)
