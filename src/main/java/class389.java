...
public class class389 extends class627 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BFIFF)F", line = 6)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lgaa;I)Lgaa;", line = 148)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BZ)V", line = 205)
