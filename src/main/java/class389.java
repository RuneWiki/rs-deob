...
public class class389 extends class530 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(BLjj;)V", line = 5)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lrq;IIIILrq;IIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IB)[[I", line = 73)
