...
public class class389 extends class189 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(FIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I[II)V", line = 177)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Laca;IIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIII)V", line = 335)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BI)V", line = 347)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(II)V", line = 359)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)V", line = 371)
