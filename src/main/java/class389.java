...
public class class389 {
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IB)Lwi;", line = 49)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(IB)V", line = 268)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lal;ILmg;)V", line = 283)
