...
public class class389 extends class11 {
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IILbi;IIZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 39)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lnh;)V", line = 85)
