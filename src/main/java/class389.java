...
public class class389 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)Lwp;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lug;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lgp;ILui;)V")
