...
public class class389 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)Lqf;", line = 67)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIILtq;)Lgq;", line = 101)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)Lqf;", line = 127)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lva;)V", line = 169)
