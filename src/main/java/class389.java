...
public class class389 extends class392 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 79)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BI)V", line = 90)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(ILw;)V", line = 101)
    public class389(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)I", line = 106)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lw;)V", line = 121)
    public class389(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)V", line = 153)
