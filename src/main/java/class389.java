...
public class class389 extends class433 implements class137 {
    ...
    @OriginalMember(owner = "client!la", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!la", name = "GA", descriptor = "(IIIIII)V", line = 18)
    public final void method1581(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lda;La;[I[BIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!la", name = "t", descriptor = "(III)V", line = 26)
    public final void method1569(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILfa;II)V", line = 34)
