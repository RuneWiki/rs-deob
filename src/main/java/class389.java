...
public class class389 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIIIIII)Lbi;", line = 16)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lvj;)V", line = 692)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)Z", line = 42)
    public static final boolean method2400(int arg0, int arg1, int arg2) {
        field5852++;
        return (class260.field3784[1][arg0][arg1] & arg2) != 0;
    }

    @OriginalMember(owner = "client!po", name = "b", descriptor = "(IIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lqa;III)V", line = 69)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILvr;Lvr;IZ)I", line = 537)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IILjava/lang/String;)V", line = 641)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 678)
