...
public class class389 extends class425 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "()[I", line = 6)
    public final int[] method2457() {
        return this.field5477;
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "()V", line = 57)
    public static void method2459() {
        field5474 = null;
    }

    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(II[IZ)V", line = 59)
