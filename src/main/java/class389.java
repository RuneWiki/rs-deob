...
public class class389 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILdc;)Ljava/lang/Object;", line = 47)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/Object;Ldc;B)V", line = 101)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ldc;B)V", line = 128)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLwca;)V", line = 154)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/Object;ZILdc;)V", line = 174)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)V", line = 205)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(I)I", line = 275)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(I)V", line = 309)
