...
public class class389 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "([BZI)Ljava/lang/Object;", line = 9)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IB)[[[B", line = 41)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)I", line = 815)
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "(B)V", line = 830)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(Z)V", line = 854)
