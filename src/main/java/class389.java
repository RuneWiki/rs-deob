...
public class class389 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BIZ)Lg;", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZB)V", line = 102)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)Lvw;", line = 119)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IZLbca;IILda;Lha;ZIILha;I)Lvr;", line = 233)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Z)V", line = 301)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(B)V", line = 317)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)V", line = 335)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lgia;IZLvfa;Laj;Laj;)V", line = 397)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIBLbca;IILha;I)Lvr;", line = 352)
