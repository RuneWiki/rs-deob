...
public class class389 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILja;I[Lc;IZ[BII)[I")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lec;II)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILec;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lja;IIIII)Lrc;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLtd;)V")
