...
public class class389 extends class333 implements class159 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(B)V", line = 107)
    public static void method2216(byte arg0) {
        field5262 = null;
        int var1 = 21 / ((arg0 + 32) / 61);
    }

    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(B)J", line = 118)
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(I)C", line = 131)
