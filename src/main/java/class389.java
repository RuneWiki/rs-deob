...
public class class389 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIBI)V", line = 85)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)V", line = 108)
