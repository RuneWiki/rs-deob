...
public class class389 extends class189 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BILnn;)V", line = 27)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lnn;[II)V", line = 102)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)Ljava/lang/String;", line = 134)
    ...
    @OriginalMember(owner = "client!nl", name = "e", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(II)Lje;", line = 190)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BLjava/lang/String;)V", line = 220)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZLnn;)Ljava/lang/String;", line = 283)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILnn;)V", line = 312)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IB)V", line = 333)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(I)I", line = 352)
