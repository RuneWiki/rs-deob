...
public class class389 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BLbg;I)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lbg;ZII)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIIILjg;B)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Laq;I)Laq;")
