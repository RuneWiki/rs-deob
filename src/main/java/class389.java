...
public class class389 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "([BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lhd;[BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lhd;Ljava/nio/ByteBuffer;)V", line = 28)
