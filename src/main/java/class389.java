...
public class class389 extends Canvas {
    ...
    @OriginalMember(owner = "client!fi", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 26)
    public final void update(Graphics arg0) {
        this.field5460.update(arg0);
        field5458++;
    }

    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 44)
