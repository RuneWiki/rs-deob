...
public class class389 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)Lak;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lgk;Z)V")
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(B)Lak;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lgk;II)V")
