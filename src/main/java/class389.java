...
public class class389 extends class42 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(II)V", line = 44)
    public class389(int arg0, int arg1) {
        this.field5524 = arg0;
        this.field5522 = arg1;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lqa;I)V", line = 62)
