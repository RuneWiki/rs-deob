...
public class class389 extends class514 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lha;II)Lnf;", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lsf;II[B)V", line = 47)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lsf;II[I)V", line = 63)
