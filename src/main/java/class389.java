...
public class class389 implements class117 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLvs;I)Z")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)Lof;")
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(ILada;Loe;IIIIIIIZ)V")
