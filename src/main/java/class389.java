...
public class class389 extends class12 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Len;[Lnr;Z)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Len;J[Lnr;[Lor;Z)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Len;J)Z")
    ...
    @OriginalMember(owner = "client!pl", name = "f", descriptor = "()Lbg;")
