...
public class class389 extends class117 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Llk;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!md", name = "f", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!md", name = "g", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IBI)I", line = 60)
    ...
    @OriginalMember(owner = "client!md", name = "h", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILlk;)Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lhc;BLkm;)I", line = 126)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BLlk;I)V", line = 151)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILlk;[I)V", line = 218)
    ...
    @OriginalMember(owner = "client!md", name = "i", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([Lms;IZBII)V", line = 268)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)I", line = 317)
    ...
    @OriginalMember(owner = "client!md", name = "j", descriptor = "(I)Ljava/lang/String;", line = 331)
