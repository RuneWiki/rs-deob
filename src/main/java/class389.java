...
public class class389 extends class675 implements class624 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLha;)Lck;", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IZLha;I)Lga;", line = 32)
    ...
    @OriginalMember(owner = "client!ah", name = "h", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Z)Z", line = 74)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lha;IIB)Z", line = 93)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(B)I", line = 217)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)I", line = 228)
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(I)Z", line = 239)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lkf;Lha;IIIZI)V", line = 249)
    ...
    @OriginalMember(owner = "client!ah", name = "j", descriptor = "(I)I", line = 284)
    ...
    @OriginalMember(owner = "client!ah", name = "g", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)I", line = 317)
    public final int method1752(byte arg0) {
        ++field5419;
        return arg0 != -111 ? -9 : this.field5432;
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILha;)V", line = 328)
    ...
    @OriginalMember(owner = "client!ah", name = "g", descriptor = "(B)Z", line = 357)
    ...
    @OriginalMember(owner = "client!ah", name = "e", descriptor = "(B)I", line = 376)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIIIIIIZ)V", line = 389)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZLha;)V", line = 422)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lha;B)V", line = 451)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lha;II)Lka;", line = 461)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(ILha;)Lww;", line = 483)
