...
public class class463 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ZI)Z", line = 9)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lug;B)Lth;", line = 47)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIIII)V", line = 62)
