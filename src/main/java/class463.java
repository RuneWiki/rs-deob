...
public class class463 extends OutputStream {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!bd", name = "write", descriptor = "(I)V", line = 62)
    public final void write(int arg0) throws IOException {
        field6708++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 70)
