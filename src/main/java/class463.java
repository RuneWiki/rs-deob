...
public class class463 extends class147 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILgea;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZJIII)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(IIII)V", line = 142)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!rp", name = "d", descriptor = "()I", line = 168)
    public final int method1110() {
        field6424++;
        return this.field6422.field2704;
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IB)V", line = 186)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIIIII)V", line = 221)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 344)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Ldia;IIZ)V", line = 921)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Ldia;IIII)V", line = 931)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Ldia;II[III)V", line = 941)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(III)V", line = 436)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIII[III)V", line = 459)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I[SI)[S", line = 471)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "()I", line = 482)
    public final int method1106() {
        field6404++;
        return this.field6422.field2704 + this.field6430 + this.field6410;
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IILaa;II)V", line = 490)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIIII)V", line = 550)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIII)V", line = 686)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(FFFFFFIIII)V", line = 748)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIII)V", line = 878)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "([I)V", line = 911)
