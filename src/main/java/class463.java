...
public class class463 extends class725 {
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(I)Lhha;")
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "()Lco;")
    public final class725 method358() {
        field6436++;
        return null;
    }

    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IDB)Lhha;")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "()Lco;")
    public final class725 method357() {
        field6432++;
        return null;
    }

    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lkaa;B)V")
    ...
    @OriginalMember(owner = "client!fea", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lhha;B)V")
