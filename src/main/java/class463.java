...
public class class463 extends class550 {
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Z)[Lrb;", line = 38)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IZBII)V", line = 55)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ZII)V", line = 231)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(IBI)V", line = 269)
    public final void method646(int arg0, byte arg1, int arg2) {
        int var4 = 78 % ((arg1 - 62) / 38);
        ++field6692;
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IBI)V", line = 283)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(II)Lae;", line = 293)
