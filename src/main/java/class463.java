...
public class class463 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IB)I", line = 25)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "([I)V", line = 67)
