...
public class class463 implements Runnable {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!mj", name = "run", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "()V", line = 196)
    public class463() {
        this.field6930.setDaemon(true);
        this.field6930.start();
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljava/lang/String;B)Lab;", line = 85)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BLqg;)V", line = 161)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILjava/lang/String;)I", line = 175)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILbu;)V", line = 186)
