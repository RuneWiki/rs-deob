...
public class class463 extends class542 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(IIIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIB)V", line = 45)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 80)
