...
public class class463 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lwn;B)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ljc;B)Z")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IILwn;)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lqa;BZ)Laa;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lqa;I)Laa;")
