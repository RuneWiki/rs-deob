...
public class class463 extends class499 {
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lgd;)V", line = 3)
    public class463(class696 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([[[Lmf;ZIIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)Z", line = 331)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 349)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILsfa;I)V", line = 377)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IZ)V", line = 389)
    ...
    @OriginalMember(owner = "client!cj", name = "f", descriptor = "(I)V", line = 420)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BII)V", line = 433)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZZ)V", line = 449)
    ...
    @OriginalMember(owner = "client!cj", name = "e", descriptor = "(B)V", line = 457)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 470)
