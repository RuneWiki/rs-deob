...
public class class463 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(III)V", line = 510)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 534)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "([[[Lrr;Z)V", line = 556)
