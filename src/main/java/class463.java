...
public class class463 extends class386 implements class529 {
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(Lya;I)Lfk;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZLya;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lvu;Lvu;I)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lya;II)Lt;")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lya;Lrd;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(Lya;I)V")
