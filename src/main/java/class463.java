...
public class class463 extends class69 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "()V", line = 17)
    public class463() {
    }

    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(S)V", line = 19)
