...
public class class463 extends class753 implements class627 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "([BIIILul;IIII)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II[FLul;IIIIB)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Loia;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Loia;Lul;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Loia;Lul;Lso;II)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Loia;Lul;IIZ[BII)V")
