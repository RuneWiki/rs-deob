...
public class class463 extends class407 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(FIF[FIFIIIIF)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BI)[[[B", line = 92)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 870)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(III)Lvl;", line = 882)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(I)V", line = 892)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIBI)V", line = 925)
