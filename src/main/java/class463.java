...
public class class463 {
    ...
    @OriginalMember(owner = "client!gga", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!gga", name = "movemouse", descriptor = "(II)V", line = 36)
    public final void movemouse(int arg0, int arg1) {
        this.field6642.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!gga", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 43)
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "()V", line = 59)
