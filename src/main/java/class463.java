...
public class class463 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)I", line = 30)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljn;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "([I)V", line = 97)
