...
public class class463 {
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 11)
    public class463() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljr;[BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(III)V", line = 65)
