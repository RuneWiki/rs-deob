...
public class class463 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(II[BZI)Z", line = 17)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "([BIIB)Z", line = 136)
    ...
    @OriginalMember(owner = "client!id", name = "toString", descriptor = "()Ljava/lang/String;", line = 165)
    public final String toString() {
        field6744++;
        return "Cache:" + this.field6746;
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(ILvh;Lvh;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IZI)I", line = 185)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(II)[B", line = 221)
