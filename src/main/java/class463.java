...
public class class463 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IZBLba;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIILsl;IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ldga;II)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BLba;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ldga;Z)V")
