...
public class class463 extends class211 {
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IILjava/io/File;)[B", line = 31)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 66)
    public class463() {
        super(0, true);
    }
