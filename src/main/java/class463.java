...
public class class463 extends class261 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lza;Lvs;IIIII)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Llt;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lwk;)V")
