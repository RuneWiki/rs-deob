...
public class class463 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIB)I", line = 47)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ZIILpe;)Lfca;", line = 92)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 111)
