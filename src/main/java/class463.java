...
public abstract class class463 extends class270 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)F", line = 38)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(I)I", line = 108)
    public final int method2637(int arg0) {
        field6432++;
        return arg0 <= 56 ? -4 : this.field6442;
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)I", line = 119)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IZ)Lsf;", line = 132)
    ...
    @OriginalMember(owner = "client!od", name = "h", descriptor = "(I)I", line = 159)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(B)I", line = 170)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(IIIIIF)V", line = 192)
