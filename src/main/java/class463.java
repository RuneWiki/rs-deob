...
public class class463 extends class397 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIZFII[FFFIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIZIB)V", line = 127)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(I)V", line = 149)
