...
public class class638 extends class696 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/Object;Z)[B", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IBIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lha;IJ)V", line = 163)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BI)I", line = 183)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)Z", line = 196)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lha;Lal;Laj;J)V", line = 550)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZJLha;I)V", line = 224)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 485)
