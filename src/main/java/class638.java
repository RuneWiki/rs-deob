...
public class class638 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZLfp;BLjava/lang/String;)Lvd;", line = 3)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIIIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 133)
