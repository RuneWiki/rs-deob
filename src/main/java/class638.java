...
public class class638 extends class72 {
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lcq;)V", line = 24)
    public class638(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(ILcq;)V", line = 97)
    public class638(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)I", line = 124)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BIIIII)V", line = 137)
