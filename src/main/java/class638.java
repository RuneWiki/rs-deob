...
public class class638 extends class320 {
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Lffa;)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILbca;ILbca;)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILla;IZII)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILib;)V")
