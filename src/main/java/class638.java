...
public class class638 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "([Lsja;Z)I")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BJLsja;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)Lsja;")
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(I)Lsja;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZJ)Lsja;")
    ...
    @OriginalMember(owner = "client!lk", name = "e", descriptor = "(I)Lsja;")
