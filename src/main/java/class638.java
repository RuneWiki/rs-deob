...
public class class638 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jv", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field8943++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)Ljv;", line = 30)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(III)Z", line = 119)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(IILbt;)V", line = 136)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lpl;IIIIZI)V", line = 151)
