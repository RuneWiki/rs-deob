...
public class class638 extends class598 implements class269 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqa;BI)Lr;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZLoe;ILqa;III)V")
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(ILqa;)Loj;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BILmh;IZI[BI)Lwo;")
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(ILqa;)Lso;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lqa;Lcn;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IBLqa;Z)Ljc;")
