...
public class class638 implements class152 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIFIZI)[I", line = 10)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IZ)Llr;", line = 42)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(II)Lhd;", line = 68)
    public final class739 method1180(int arg0, int arg1) {
        field8773++;
        return arg1 == -6662 ? this.field8763[arg0] : null;
    }

    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(ZIFIII)[I", line = 80)
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(II)Z", line = 90)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IFZIII)[F", line = 105)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Lin;Lin;Lin;)V", line = 139)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Z)I", line = 129)
