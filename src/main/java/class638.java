...
public class class638 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILka;IZILoha;Lha;II)V", line = 152)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lha;I)V", line = 192)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIZLha;Z)Lka;", line = 209)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(Lha;I)V", line = 355)
    ...
    @OriginalMember(owner = "client!hw", name = "finalize", descriptor = "()V", line = 374)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lha;Lih;IIIILlq;ZI)V", line = 659)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lmea;B)V", line = 393)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)I", line = 408)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)Z", line = 422)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IZILjava/lang/String;Ljava/lang/String;)V", line = 433)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILlq;)V", line = 486)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(B)V", line = 610)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ZI)V", line = 634)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(CI)Z", line = 647)
