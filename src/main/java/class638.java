...
public class class638 extends class29 {
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(B)J", line = 35)
    public final long method284(byte arg0) {
        return arg0 < 31 ? -79L : this.field8847;
    }

    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BJ)I", line = 59)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 113)
    public class638() {
        this.field8847 = System.nanoTime();
        this.field8848 = System.nanoTime();
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)J", line = 95)
