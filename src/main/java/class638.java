...
public class class638 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Ldt;BI)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(I)Lvf;")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILqba;)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ZLdt;)V")
