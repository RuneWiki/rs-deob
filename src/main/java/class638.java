...
public abstract class class638 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZII)V", line = 51)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IBLjava/awt/Canvas;ILpj;Le;)Loa;", line = 82)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZIIIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BIIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 186)
    protected void finalize() {
        field9053++;
        this.method3554(true);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IBI)Z", line = 235)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)V", line = 254)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Le;)V", line = 292)
