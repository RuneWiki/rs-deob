...
public class class638 extends class334 {
    ...
    @OriginalMember(owner = "client!te", name = "h", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(JJ)J", line = 32)
    public static long method3630(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!te", name = "i", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!te", name = "g", descriptor = "(I)[B", line = 57)
