...
public class class638 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILjava/awt/Component;ILk;I)Lcl;", line = 7)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IILie;)V", line = 88)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lie;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)Z", line = 151)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZI)I", line = 162)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(III)Z", line = 180)
