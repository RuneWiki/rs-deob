...
public class class638 extends class216 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IBI)V", line = 15)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(IIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 111)
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IILul;I)V", line = 230)
