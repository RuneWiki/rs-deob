...
public class class638 extends class572 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLtu;)V", line = 8)
    ...
    @OriginalMember(owner = "client!qf", name = "t", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qf", name = "u", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I[I)V", line = 45)
    ...
    @OriginalMember(owner = "client!qf", name = "q", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B[BII)V", line = 79)
    ...
    @OriginalMember(owner = "client!qf", name = "l", descriptor = "(II)I", line = 102)
    ...
    @OriginalMember(owner = "client!qf", name = "d", descriptor = "(IB)Lvf;", line = 129)
    ...
    @OriginalMember(owner = "client!qf", name = "f", descriptor = "(BI)V", line = 154)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(I)V", line = 166)
    public class638(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qf", name = "e", descriptor = "(IB)I", line = 169)
    ...
    @OriginalMember(owner = "client!qf", name = "v", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZII)Z", line = 192)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)Z", line = 207)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIZII)V", line = 222)
    ...
    @OriginalMember(owner = "client!qf", name = "w", descriptor = "(I)Z", line = 248)
