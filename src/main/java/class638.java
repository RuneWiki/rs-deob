...
public class class638 extends class592 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ZB)V", line = 9)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lji;Lpm;)V", line = 190)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 56)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ZII)V", line = 109)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)Z", line = 175)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IILgq;)V", line = 212)
