...
public abstract class class770 extends class230 {
    ...
    @OriginalMember(owner = "client!jg", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Z[Lsca;)I", line = 13)
    ...
    @OriginalMember(owner = "client!jg", name = "g", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Loq;IZILha;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!jg", name = "e", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!jg", name = "i", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(IIIIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lha;B)Z", line = 106)
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(Z)Z", line = 118)
