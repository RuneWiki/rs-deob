...
public class class770 extends class207 {
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)I", line = 3)
    public final int method36(int arg0) {
        ++field10597;
        return arg0 >= -14 ? -35 : 0;
    }

    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lrd;)V", line = 25)
    public class770(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(IB)I", line = 41)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BIIILqba;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IB)V", line = 81)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(ILrd;)V", line = 95)
