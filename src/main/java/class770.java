...
public class class770 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(FFIIIFZI)[F", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "toString", descriptor = "()Ljava/lang/String;", line = 89)
    public final String toString() {
        field10609++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(I)V", line = 124)
    private class770(int arg0) {
        this.field10608 = arg0;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 132)
