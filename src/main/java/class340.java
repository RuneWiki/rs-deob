...
public class class340 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lph;I)[Lef;")
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(Lph;I)Lef;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lph;II)Lef;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([B)[Lef;")
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(Lph;II)[Lef;")
