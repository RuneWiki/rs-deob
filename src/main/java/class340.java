...
public class class340 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IBILha;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(II)Lrea;")
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Liv;ILcb;)V")
