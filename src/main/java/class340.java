...
public class class340 implements Runnable {
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IILjl;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(III[B)V", line = 79)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!wha", name = "finalize", descriptor = "()V", line = 142)
    protected final void finalize() {
        field4979++;
        this.method2165(false);
    }

    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IIIIIIIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Ljava/net/Socket;Lfc;I)V", line = 526)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(I[BII)V", line = 243)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IIIIIII)V", line = 296)
    ...
    @OriginalMember(owner = "client!wha", name = "c", descriptor = "(I)I", line = 336)
    ...
    @OriginalMember(owner = "client!wha", name = "run", descriptor = "()V", line = 357)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)V", line = 428)
    ...
    @OriginalMember(owner = "client!wha", name = "d", descriptor = "(I)I", line = 456)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ILla;Lla;Lla;Lla;)V", line = 482)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(BIII)I", line = 540)
