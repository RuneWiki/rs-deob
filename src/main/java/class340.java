...
public class class340 extends class34 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBILat;)V", line = 5)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lsv;II)V", line = 18)
    ...
    @OriginalMember(owner = "client!rd", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(JZ)Ljava/lang/String;", line = 125)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "()V", line = 176)
    public class340() {
        super(0, false);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBI)V", line = 184)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BI)[[I", line = 207)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIIIIIII)V", line = 283)
