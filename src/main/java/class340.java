...
public class class340 extends class40 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IILlf;)V", line = 16)
    ...
    @OriginalMember(owner = "client!hj", name = "g", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BI)[I", line = 70)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!hj", name = "d", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!hj", name = "h", descriptor = "(B)V", line = 188)
