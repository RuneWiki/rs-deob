...
public class class340 extends class117 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BLvb;IIILjava/lang/String;IILss;Lms;ILoj;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILlk;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Llk;II)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ln;")
