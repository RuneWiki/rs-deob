...
public class class340 extends class83 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILlh;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILjp;ILgo;Lfd;ILjava/lang/String;ILwm;IBI)V", line = 41)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 95)
    public class340() {
        super(1, false);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZI)[[I", line = 158)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IBLtq;)V", line = 231)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(IIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(I)V", line = 395)
