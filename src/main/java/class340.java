...
public class class340 extends class530 {
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(III)Lc;")
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ILqc;)Lqc;")
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(ILah;)V")
    public class340(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Lah;)V")
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ILwu;)V")
