...
public class class340 implements Runnable {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lpt;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!mc", name = "run", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZBZ)V", line = 298)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILjava/lang/String;)Ljt;", line = 364)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "()V", line = 387)
    public class340() {
