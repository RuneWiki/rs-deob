...
public class class340 extends class28 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(IIIIIF)V", line = 34)
    public class340(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BF)V", line = 41)
    ...
    @OriginalMember(owner = "client!bi", name = "h", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lwk;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIIIII)V", line = 120)
