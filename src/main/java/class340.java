...
public class class340 {
    ...
    @OriginalMember(owner = "client!bg", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field4891++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLqa;)V", line = 34)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lod;[[BI)V", line = 141)
