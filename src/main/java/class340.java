...
public class class340 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Z)Lcp;")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lsa;I)Lvd;")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(ZZ)Z")
    public static boolean method2167(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Luu;Luu;)V")
