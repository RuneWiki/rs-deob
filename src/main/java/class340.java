...
public class class340 extends class144 implements class21 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILza;ILge;IZI)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILza;I)Z")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lza;II)Le;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILza;BZ)Lqr;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Lza;B)Lkf;")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lza;Lfu;IIIIIZIIIIIIZ)V")
