...
public class class340 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III)Z", line = 56)
