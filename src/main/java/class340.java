...
public class class340 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(II)Lon;", line = 34)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 106)
    public class340(class271 arg0, int arg1, class84 arg2) {
        this.field5193 = arg2;
        this.field5196 = this.field5193.method656((byte) 122, 4);
    }

    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Z)V", line = 89)
