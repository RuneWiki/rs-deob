...
public class class340 extends class228 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Let;B)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Liv;I)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)Liv;")
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Let;)V")
