...
public abstract class class340 extends class55 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILcea;I[I)V", line = 27)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(I)[Loe;", line = 118)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 128)
    public class340(OggStreamState arg0) {
        this.field4580 = arg0;
    }

    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 155)
