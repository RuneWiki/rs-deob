...
public class class340 extends class54 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IILtu;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(ILhia;)V", line = 23)
    public class340(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIIIIILpda;ILha;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(II)V", line = 45)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Lhia;)V", line = 56)
    public class340(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(Z)I", line = 64)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;IIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!nha", name = "c", descriptor = "(Z)I", line = 119)
    ...
    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(IB)I", line = 133)
