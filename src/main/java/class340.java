...
public class class340 extends class170 {
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!qea", name = "c", descriptor = "(I)D", line = 20)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 45)
    public class340(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 54)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 152)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IIIIIIIIII)V", line = 217)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(Z)V", line = 292)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(B)Lcf;", line = 325)
    ...
    @OriginalMember(owner = "client!qea", name = "e", descriptor = "(I)V", line = 343)
