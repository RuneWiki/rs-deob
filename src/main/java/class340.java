...
public class class340 extends class350 implements class3 {
    ...
    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(ZILha;ILrda;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIILha;)Z", line = 29)
    ...
    @OriginalMember(owner = "client!nha", name = "d", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(BLha;)V", line = 68)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)Z", line = 92)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(ILmj;BI)V", line = 103)
    ...
    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(Lha;B)Lrga;", line = 116)
    ...
    @OriginalMember(owner = "client!nha", name = "e", descriptor = "(B)I", line = 130)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(ILha;)V", line = 142)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Lha;Ltk;IIIIIZIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;B)Lkv;", line = 163)
    ...
    @OriginalMember(owner = "client!nha", name = "f", descriptor = "(I)Z", line = 218)
    ...
    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(B)I", line = 229)
    ...
    @OriginalMember(owner = "client!nha", name = "f", descriptor = "(B)Z", line = 241)
    ...
    @OriginalMember(owner = "client!nha", name = "g", descriptor = "(I)I", line = 259)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Ldq;Z)V", line = 274)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(Lha;I)V", line = 285)
    ...
    @OriginalMember(owner = "client!nha", name = "e", descriptor = "(I)Z", line = 295)
    ...
    @OriginalMember(owner = "client!nha", name = "c", descriptor = "(B)I", line = 312)
