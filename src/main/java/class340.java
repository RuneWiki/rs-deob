...
public class class340 {
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(I)Lao;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IZLgga;)V")
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(I)Lao;")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lgga;Z)V")
