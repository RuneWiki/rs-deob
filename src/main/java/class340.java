...
public class class340 extends class145 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lao;II)V")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BZILrk;III)V")
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(II)Lca;")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BLsb;ILsb;IIIIII)V")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILcc;)I")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lap;BI)V")
