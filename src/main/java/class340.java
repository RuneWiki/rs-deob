...
public class class340 extends class270 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II[IIILsd;)V", line = 7)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILoq;Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "()Lhf;", line = 224)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([III)V", line = 244)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)V", line = 285)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIII)V", line = 331)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lvg;Lvg;I)V", line = 347)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "()I", line = 369)
    public final int method576() {
        field4844++;
        return 0;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILsd;Z)V", line = 377)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Ls;)V", line = 440)
    public class340(class183 arg0) {
        this.field4852 = arg0;
    }

    @OriginalMember(owner = "client!jb", name = "c", descriptor = "()Lhf;", line = 420)
