...
public class class340 extends class281 {
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "()I", line = 5)
    public final synchronized int method2095() {
        return this.field5073.method6(18328);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lfp;)V", line = 8)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lwg;)V", line = 25)
    public final synchronized void method2097(class281 arg0) {
        this.field5073.method11(-118, arg0);
    }

    @OriginalMember(owner = "client!gq", name = "c", descriptor = "([III)V", line = 33)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(Lwg;)V", line = 42)
    public final synchronized void method2099(class281 arg0) {
        arg0.method1121(false);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lol;Lfp;)V", line = 45)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "()Lwg;", line = 65)
    public final class281 method652() {
        return (class281) this.field5073.method8((byte) -98);
    }

    @OriginalMember(owner = "client!gq", name = "b", descriptor = "([III)V", line = 75)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "()Lwg;", line = 167)
    public final class281 method650() {
        return (class281) this.field5073.method17((byte) 44);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "()I", line = 171)
    public final int method639() {
        return 0;
    }

    @OriginalMember(owner = "client!gq", name = "f", descriptor = "()V", line = 179)
