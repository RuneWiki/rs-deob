...
public class class340 {
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lae;IZLqn;Lqn;)V", line = 233)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IB)V", line = 50)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZI)V", line = 69)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)Lho;", line = 107)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(II)V", line = 184)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 203)
