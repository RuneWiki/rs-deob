...
public class class340 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIILjava/awt/Canvas;Ld;)Lha;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLge;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLha;)V")
