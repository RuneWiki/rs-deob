...
public class class340 extends class501 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Z[Lin;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(FI)V", line = 81)
    ...
    @OriginalMember(owner = "client!wu", name = "h", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(I)V", line = 112)
    public class340(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIBIIIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(III)Z", line = 165)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(BLjava/lang/String;)[B", line = 176)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(FI)V", line = 207)
