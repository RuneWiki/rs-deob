...
public class class340 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IILqa;IIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IBI)I", line = 18)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIIIB)V", line = 251)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZIII)V", line = 272)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)V", line = 300)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZIZ)V", line = 323)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "()V", line = 402)
    protected class340() {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lqa;Llh;I)V", line = 412)
