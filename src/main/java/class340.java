...
public class class340 extends class211 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(FI)V", line = 4)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(I)V", line = 18)
    public class340(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(FI)V", line = 23)
