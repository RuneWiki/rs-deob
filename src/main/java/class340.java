...
public class class340 extends class28 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(Le;IZLpe;BI)[F")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ILe;Lpe;)Z")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(Le;DILpe;IIZZ)[I")
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IZLe;IILpe;D)[I")
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lfd;)V")
