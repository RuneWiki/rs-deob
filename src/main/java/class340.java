...
public class class340 extends class567 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)Lkq;", line = 6)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lvn;Lmf;IIIIIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ZZI)I", line = 46)
    ...
    @OriginalMember(owner = "client!fga", name = "c", descriptor = "(I)V", line = 86)
