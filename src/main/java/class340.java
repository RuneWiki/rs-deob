...
public class class340 extends class346 implements class228 {
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lgb;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lgb;Lvj;Lnb;II)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IIII[BLvj;III)V")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lgb;Lvj;IIZ[BII)V")
