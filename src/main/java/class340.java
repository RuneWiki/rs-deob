...
public class class340 extends class4 {
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(IIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(JJ)J", line = 60)
    public static long method2328(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIB)V", line = 79)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)V", line = 90)
