...
public class class340 extends class413 {
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(I)V", line = 47)
