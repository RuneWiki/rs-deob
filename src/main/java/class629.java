...
public class class629 extends class253 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILha;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Loq;IZILha;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!cd", name = "e", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lha;Loo;Lka;B)V", line = 55)
    ...
    @OriginalMember(owner = "client!cd", name = "e", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(Lha;I)Ltja;", line = 135)
    ...
    @OriginalMember(owner = "client!cd", name = "finalize", descriptor = "()V", line = 150)
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(Z)Z", line = 163)
    public final boolean method83(boolean arg0) {
        ++field8795;
        return arg0;
    }

    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 631)
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(B)I", line = 181)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(Lha;I)V", line = 202)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IILgs;)V", line = 221)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Z)V", line = 549)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILha;)Lrk;", line = 566)
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(I)Z", line = 613)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 656)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIILha;)Lka;", line = 725)
