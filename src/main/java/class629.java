...
public class class629 extends class600 {
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(I)Llga;")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lin;Lin;Lkh;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILdb;)V")
