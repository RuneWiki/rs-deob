...
public class class629 extends class613 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "([III)V", line = 16)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "()Llea;", line = 83)
    public final class613 method327() {
        field8684++;
        return null;
    }

    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "()Llea;", line = 112)
    public final class613 method317() {
        field8678++;
        return null;
    }

    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)D", line = 120)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IDI)Ltv;", line = 144)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "()I", line = 167)
    public final int method349() {
        field8677++;
        return 1;
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZB)V", line = 179)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "(B)Ltv;", line = 235)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ltv;I)V", line = 400)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Z)V", line = 420)
    public final synchronized void method3535(boolean arg0) {
        field8668++;
        this.field8686 = arg0;
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)V", line = 429)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(Z)V", line = 442)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljava/lang/String;ZIZ)Z", line = 456)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(I)V", line = 550)
