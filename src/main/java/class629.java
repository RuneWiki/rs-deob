...
public class class629 extends class29 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!bw", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 3)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field8932++;
        this.method3528(arg0.getX(), (byte) 94, arg0.getY());
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)Lve;", line = 13)
    ...
    @OriginalMember(owner = "client!bw", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 24)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field8934++;
        this.method3528(arg0.getX(), (byte) 124, arg0.getY());
    }

    @OriginalMember(owner = "client!bw", name = "e", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!bw", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 80)
    ...
    @OriginalMember(owner = "client!bw", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 108)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method3528(arg0.getX(), (byte) 115, arg0.getY());
        field8918++;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 116)
    ...
    @OriginalMember(owner = "client!bw", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 152)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field8914++;
        this.method3528(arg0.getX(), (byte) 60, arg0.getY());
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIIIIIIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!bw", name = "f", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)Z", line = 227)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(I)I", line = 254)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(I)I", line = 267)
    ...
    @OriginalMember(owner = "client!bw", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 280)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZLjava/awt/Component;)V", line = 308)
    ...
    @OriginalMember(owner = "client!bw", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 322)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 400)
    public class629(Component arg0, boolean arg1) {
        this.method3527(true, arg0);
        this.field8945 = arg1;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IBI)V", line = 358)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIII)V", line = 376)
