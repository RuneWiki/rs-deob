...
public class class629 extends class428 {
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!kfa", name = "f", descriptor = "(I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Ler;Lgda;Lb;)V", line = 62)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!kfa", name = "e", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!kfa", name = "d", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lln;BI)V", line = 186)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(III)V", line = 195)
