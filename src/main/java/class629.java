...
public class class629 extends class508 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLes;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)Lbaa;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([IILes;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILes;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILes;B)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILr;)V")
