...
public class class629 extends class390 {
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IB)V", line = 21)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Leda;Lcga;IIIIIIIIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IIIBI)V", line = 57)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)Lhr;", line = 82)
