...
public class class629 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 8)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)Z", line = 104)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(BIIIII)V", line = 125)
