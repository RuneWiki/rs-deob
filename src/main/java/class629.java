...
public class class629 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "([BB)V", line = 35)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)Z", line = 230)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "([BI[B)V", line = 240)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 284)
