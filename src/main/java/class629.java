...
public class class629 extends class435 {
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I[IZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(II)V", line = 140)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIII)V", line = 173)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILr;Lfo;IIIILda;IIZII)Lda;", line = 189)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILek;)Lnga;", line = 364)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIBFI)V", line = 376)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(II)V", line = 490)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lfw;IIIII)V", line = 503)
