...
public class class629 extends class440 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lde;I)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BIII)Ld;")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILmo;I)V")
