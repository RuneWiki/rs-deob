...
public class class629 implements class161 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IIIFIZ)[I", line = 3)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(IZ)Lue;", line = 19)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(BIZFII)[F", line = 45)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IZIFIB)[I", line = 61)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Laj;Laj;Laj;)V", line = 96)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZI)Z", line = 77)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)I", line = 87)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IZ)Lgj;", line = 300)
