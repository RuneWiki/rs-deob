...
public class class629 extends class216 {
    ...
    @OriginalMember(owner = "client!mga", name = "fa", descriptor = "(CIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Lml;Lcd;[Lcu;Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(CIIIZLaa;II)V", line = 263)
