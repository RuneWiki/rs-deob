...
public class class629 extends class709 {
    ...
    @OriginalMember(owner = "client!mh", name = "g", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(I)I", line = 16)
    public final int method2007(int arg0) {
        return arg0 == -24956 ? this.field9030 : 87;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Z)J", line = 39)
    public final long method2006(boolean arg0) {
        return arg0 ? 101L : this.field9033;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)I", line = 51)
