...
public abstract class class629 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(IIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IZII)V", line = 88)
