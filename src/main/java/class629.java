...
public class class629 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZIIIIFI)[I", line = 9)
    ...
    @OriginalMember(owner = "client!lc", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(I)V", line = 56)
    private class629(int arg0) {
        this.field9202 = arg0;
    }

    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)V", line = 64)
