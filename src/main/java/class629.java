...
public abstract class class629 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lqb;B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(B)V", line = 49)
