...
public class class629 extends class30 {
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lac;Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIBIII)I", line = 101)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BILac;)V", line = 186)
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)[I", line = 321)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIZLjava/lang/String;IIII)V", line = 347)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([III)V", line = 383)
