...
public class class629 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(I)[Lbn;", line = 64)
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(I)V", line = 83)
