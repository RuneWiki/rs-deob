...
public class class629 extends class687 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Lsaa;", line = 31)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(ILin;Lti;III)V", line = 44)
    public class629(int arg0, class97 arg1, class463 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field8821 = arg5;
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILjava/lang/String;)V", line = 97)
