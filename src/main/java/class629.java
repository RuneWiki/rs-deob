...
public class class629 extends class601 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BJLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 41)
    public class629() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(IZ)[[I", line = 46)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lee;BI)V", line = 124)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BI)[I", line = 168)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)Lrs;", line = 228)
