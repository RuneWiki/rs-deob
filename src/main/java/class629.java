...
public class class629 extends class55 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIIIBII)V", line = 5)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)V", line = 1155)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "()V", line = 1171)
    public class629() {
    }

    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(I)V", line = 1173)
