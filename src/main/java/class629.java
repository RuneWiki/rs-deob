...
public class class629 extends class411 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Leq;IIII[BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Leq;IIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I)Z", line = 69)
