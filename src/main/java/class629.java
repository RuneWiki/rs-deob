...
public class class629 extends class228 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(CZ)Z", line = 37)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lte;IIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lte;IIII[BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!au", name = "e", descriptor = "(B)V", line = 64)
