...
public class class629 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "([Let;IIZII)V")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)Luw;")
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lre;ILdn;)V")
