...
public class class446 extends class486 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 6)
    public final Object method2642(byte arg0) {
        field6161++;
        return arg0 < 86 ? null : this.field6163;
    }

    @OriginalMember(owner = "client!or", name = "h", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!or", name = "i", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 51)
    public static final void method2645(String arg0, int arg1, int arg2) {
        field6165++;
        class437.method2608("", arg0, arg2, "", (byte) 120, "", arg1);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIII)Z", line = 59)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 91)
