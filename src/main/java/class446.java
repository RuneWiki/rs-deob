...
public class class446 extends class220 {
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "()V", line = 6)
    public class446() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(II)[[I", line = 12)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIILnr;ZIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!pl", name = "e", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IBLil;)V", line = 302)
    ...
    @OriginalMember(owner = "client!pl", name = "f", descriptor = "(I)V", line = 355)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IB)Lle;", line = 367)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(II)[I", line = 408)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(CB)Z", line = 446)
