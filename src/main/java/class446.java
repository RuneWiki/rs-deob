...
public class class446 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BI)V", line = 52)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILde;)V", line = 102)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "()V", line = 119)
    public class446() {
    }

    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Llk;)V", line = 149)
