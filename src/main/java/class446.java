...
public class class446 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZI)Lbja;", line = 22)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Ljk;ILae;)V", line = 116)
    public class446(class788 arg0, int arg1, class283 arg2) {
        this.field6248 = arg2;
        this.field6249 = this.field6248.method1867(4, (byte) 49);
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)Lsha;", line = 73)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIB)V", line = 99)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IZ)V", line = 148)
