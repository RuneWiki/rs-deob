...
public class class446 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(B)Lpr;", line = 16)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BI)V", line = 72)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILjava/lang/String;)V", line = 96)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Z)Z", line = 117)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BZIIB)Luj;", line = 130)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(I)I", line = 173)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(B)I", line = 214)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IZ)V", line = 224)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(Z)V", line = 257)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(I)Z", line = 278)
    ...
    @OriginalMember(owner = "client!p", name = "e", descriptor = "(I)V", line = 553)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IZLee;)V", line = 578)
    ...
    @OriginalMember(owner = "client!p", name = "e", descriptor = "(B)Z", line = 649)
