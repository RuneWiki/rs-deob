...
public class class446 extends class53 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IFFF)I", line = 8)
    ...
    @OriginalMember(owner = "client!baa", name = "c", descriptor = "()I", line = 52)
    public final int method325() {
        field6229++;
        return this.field6227;
    }

    @OriginalMember(owner = "client!baa", name = "ma", descriptor = "()I", line = 60)
    public final int method322() {
        field6237++;
        return this.field6254 + this.field6234 + this.field6238;
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IB)I", line = 69)
    ...
    @OriginalMember(owner = "client!baa", name = "EA", descriptor = "()I", line = 82)
    public final int method326() {
        field6230++;
        return this.field6240 + this.field6227 + this.field6248;
    }

    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lcb;IIZ)V", line = 692)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lcb;II[III)V", line = 706)
    ...
    @OriginalMember(owner = "client!baa", name = "KA", descriptor = "(IIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!baa", name = "P", descriptor = "(IIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!baa", name = "i", descriptor = "(IIIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!baa", name = "DA", descriptor = "(IIIII)V", line = 342)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 372)
    ...
    @OriginalMember(owner = "client!baa", name = "CA", descriptor = "(FFFFFFIII)V", line = 427)
    ...
    @OriginalMember(owner = "client!baa", name = "BA", descriptor = "(III)V", line = 498)
    public final void method321(int arg0, int arg1, int arg2) {
        field6244++;
    }

    @OriginalMember(owner = "client!baa", name = "ra", descriptor = "(IIIIIII)V", line = 505)
    ...
    @OriginalMember(owner = "client!baa", name = "la", descriptor = "()I", line = 545)
    public final int method318() {
        field6258++;
        return this.field6238;
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IILpa;II)V", line = 553)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IIII[III)V", line = 597)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)Z", line = 611)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lqa;Luh;IIBI)V", line = 624)
