...
public class class446 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)Lst;", line = 92)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B[[[Lhg;)V", line = 121)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lal;ILmg;)V", line = 216)
