...
public class class446 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IB)I", line = 15)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "([BB)[B", line = 47)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(II)V", line = 192)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILjava/lang/Object;Z)[B", line = 251)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I[Lbm;ZIIIIILea;[B)[I", line = 287)
