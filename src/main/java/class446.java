...
public class class446 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILee;)Lnm;", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)I", line = 35)
    public static int method2556(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIZIII)Z", line = 55)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 88)
