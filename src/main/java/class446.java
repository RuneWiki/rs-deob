...
public class class446 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IB[Ljava/awt/Rectangle;)V", line = 42)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIBII)V", line = 57)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II[BI)[B", line = 107)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 132)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 152)
