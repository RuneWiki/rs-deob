...
public class class446 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)Liu;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLib;I)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)Liga;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLib;)V")
