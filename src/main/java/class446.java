...
public class class446 {
    ...
    @OriginalMember(owner = "client!ad", name = "toString", descriptor = "()Ljava/lang/String;", line = 41)
    public final String toString() {
        field6086++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(II)I", line = 51)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 73)
