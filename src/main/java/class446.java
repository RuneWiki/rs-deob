...
public class class446 extends class778 {
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "()Lnh;")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILnh;)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Lnh;)V")
