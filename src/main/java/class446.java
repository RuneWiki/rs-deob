...
public class class446 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IILps;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IBI)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Z)V", line = 96)
