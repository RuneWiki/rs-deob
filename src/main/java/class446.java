...
public class class446 extends class558 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IBLgp;I)Lrl;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lco;B)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BLae;)V")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lae;)V")
