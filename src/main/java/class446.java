...
public abstract class class446 implements class574 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ldc;IZ)V")
