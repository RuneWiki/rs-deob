...
public class class446 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILvn;B)Lur;", line = 9)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BI)Z", line = 86)
