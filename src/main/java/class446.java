...
public class class446 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nn", name = "toString", descriptor = "()Ljava/lang/String;", line = 23)
    public final String toString() {
        field6128++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(II)V", line = 30)
