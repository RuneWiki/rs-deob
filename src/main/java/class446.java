...
public class class446 {
    ...
    @OriginalMember(owner = "client!nh", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() throws Throwable {
        this.field6488.method700(this.field6487);
        super.finalize();
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lsq;ILjava/lang/String;)Lnh;", line = 13)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lsq;II)V", line = 31)
