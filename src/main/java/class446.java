...
public class class446 extends class507 implements class383 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lza;Lfo;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)Lgd;", line = 37)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(B)V", line = 369)
    ...
    @OriginalMember(owner = "client!tq", name = "e", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(III)V", line = 395)
    ...
    @OriginalMember(owner = "client!tq", name = "finalize", descriptor = "()V", line = 411)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lur;III)V", line = 434)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lur;IIII)V", line = 449)
