...
public class class446 extends class311 {
    ...
    @OriginalMember(owner = "client!pn", name = "i", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)V", line = 120)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(B)I", line = 207)
    ...
    @OriginalMember(owner = "client!pn", name = "f", descriptor = "(B)I", line = 228)
    ...
    @OriginalMember(owner = "client!pn", name = "g", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(II)I", line = 260)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)I", line = 273)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(I)Z", line = 293)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lnf;B)V", line = 305)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lvq;B)V", line = 321)
    ...
    @OriginalMember(owner = "client!pn", name = "h", descriptor = "(I)Z", line = 345)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 360)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BLvq;)Lbf;", line = 370)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(III)V", line = 445)
    ...
    @OriginalMember(owner = "client!pn", name = "i", descriptor = "(I)Z", line = 472)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(I)I", line = 489)
    public final int method775(int arg0) {
        ++field6364;
        return arg0 != 3 ? -77 : super.field4543;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIB)V", line = 502)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILvq;)Z", line = 521)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lvq;IIB)Z", line = 634)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(B)V", line = 672)
