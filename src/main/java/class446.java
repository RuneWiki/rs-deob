...
public abstract class class446 extends class206 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II[I[I)Lpa;", line = 6)
    public final class309 method1148(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class300(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!hr", name = "f", descriptor = "()V", line = 8)
    public final void method1109() {
    }

    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 11)
    ...
    @OriginalMember(owner = "client!hr", name = "B", descriptor = "(IIIIII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "()Z", line = 51)
    public final boolean method1100() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "h", descriptor = "(I)Z", line = 54)
    public final boolean method2606(int arg0) {
        return super.field2481.method119(-110, arg0).field2650;
    }

    @OriginalMember(owner = "client!hr", name = "xa", descriptor = "()V", line = 57)
    public final void method1146() {
        this.field6176 = this.field6156;
        this.field6177 = false;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lmv;)V", line = 62)
    public final void method1189(class313 arg0) {
    }

    @OriginalMember(owner = "client!hr", name = "f", descriptor = "(IIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Ln;)V", line = 200)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lu;)V", line = 208)
    public final void method1176(class64 arg0) {
    }

    @OriginalMember(owner = "client!hr", name = "D", descriptor = "()Z", line = 211)
    public final boolean method1194() {
        return true;
    }

    @OriginalMember(owner = "client!hr", name = "v", descriptor = "()V", line = 213)
    public void method1166() {
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I[Lcba;)V", line = 216)
    public final void method1193(int arg0, class469[] arg1) {
    }

    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(I)V", line = 220)
    public void method278(int arg0) {
        this.field6153[arg0].method1470(true, Thread.currentThread());
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIIILpa;II)V", line = 224)
    ...
    @OriginalMember(owner = "client!hr", name = "P", descriptor = "()F", line = 462)
    public final float method1167() {
        return this.field6162;
    }

    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(I)V", line = 465)
    public final void method1163(int arg0) {
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lm;)V", line = 469)
    public final void method1160(class163 arg0) {
        this.field6151 = (class487) arg0;
    }

    @OriginalMember(owner = "client!hr", name = "y", descriptor = "()Lfd;", line = 472)
    public final class448 method1172() {
        return new class448(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lsaa;III)V", line = 477)
    ...
    @OriginalMember(owner = "client!hr", name = "i", descriptor = "(I)Z", line = 515)
    public final boolean method2608(int arg0) {
        return super.field2481.method118(arg0, (byte) 121);
    }

    @OriginalMember(owner = "client!hr", name = "G", descriptor = "(ILpa;II)V", line = 520)
    ...
    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 578)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIII)Lmv;", line = 587)
    public final class313 method1136(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ldp;Z)Lha;", line = 591)
    ...
    @OriginalMember(owner = "client!hr", name = "w", descriptor = "()Z", line = 697)
    public final boolean method2609() {
        return this.field6143;
    }

    @OriginalMember(owner = "client!hr", name = "e", descriptor = "()Z", line = 700)
    public final boolean method1108() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "j", descriptor = "(I)[I", line = 704)
    ...
    @OriginalMember(owner = "client!hr", name = "k", descriptor = "(I)Z", line = 725)
    public final boolean method2611(int arg0) {
        return this.field6179 || super.field2481.method119(-111, arg0).field2642;
    }

    @OriginalMember(owner = "client!hr", name = "x", descriptor = "()Z", line = 731)
    public final boolean method1169() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIIIIII)V", line = 734)
    ...
    @OriginalMember(owner = "client!hr", name = "l", descriptor = "(I)[I", line = 768)
    ...
    @OriginalMember(owner = "client!hr", name = "CA", descriptor = "()I", line = 788)
    public final int method1129() {
        return this.field6185;
    }

    @OriginalMember(owner = "client!hr", name = "v", descriptor = "(IIII)[I", line = 792)
    ...
    @OriginalMember(owner = "client!hr", name = "ra", descriptor = "()F", line = 817)
    public final float method1186() {
        return this.field6182;
    }

    @OriginalMember(owner = "client!hr", name = "s", descriptor = "()Lm;", line = 820)
    public final class163 method1150() {
        return new class487();
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIIF)Lcba;", line = 823)
    public final class469 method1134(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Z)V", line = 826)
    public final void method1116(boolean arg0) {
        this.field6179 = arg0;
        this.field6170.method3687(1402);
    }

    @OriginalMember(owner = "client!hr", name = "E", descriptor = "(III)V", line = 830)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(II)I", line = 854)
    public final int method1145(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(IIII)V", line = 857)
    ...
    @OriginalMember(owner = "client!hr", name = "IA", descriptor = "(III[I)V", line = 865)
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "()V", line = 889)
    public final void method1117() {
    }

    @OriginalMember(owner = "client!hr", name = "d", descriptor = "()Z", line = 893)
    public final boolean method1105() {
        return true;
    }

    @OriginalMember(owner = "client!hr", name = "N", descriptor = "(IIII)V", line = 898)
    ...
    @OriginalMember(owner = "client!hr", name = "UA", descriptor = "(IIIII)V", line = 917)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([IIIII)Lha;", line = 990)
    ...
    @OriginalMember(owner = "client!hr", name = "E", descriptor = "()V", line = 1027)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lr;Lka;Lm;Lcf;I)V", line = 1035)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(IIIIII)V", line = 1038)
    ...
    @OriginalMember(owner = "client!hr", name = "q", descriptor = "(IIII)V", line = 1044)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lmv;Lmv;FLmv;)Lmv;", line = 1051)
    public final class313 method1162(class313 arg0, class313 arg1, float arg2, class313 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!hr", name = "ta", descriptor = "(II)V", line = 1055)
    ...
    @OriginalMember(owner = "client!hr", name = "JA", descriptor = "(IIII)V", line = 1061)
    ...
    @OriginalMember(owner = "client!hr", name = "B", descriptor = "()Z", line = 1066)
    public final boolean method1190() {
        return true;
    }

    @OriginalMember(owner = "client!hr", name = "F", descriptor = "(IIII)V", line = 1069)
    ...
    @OriginalMember(owner = "client!hr", name = "YA", descriptor = "()I", line = 1086)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 1092)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lka;)V", line = 1123)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(IIIIZ)Lha;", line = 1160)
    ...
    @OriginalMember(owner = "client!hr", name = "j", descriptor = "()Lm;", line = 1194)
    public final class163 method1126() {
        class263 var1 = this.method276(Thread.currentThread());
        return var1.field3386;
    }

    @OriginalMember(owner = "client!hr", name = "C", descriptor = "()V", line = 1198)
    public final void method1192() {
    }

    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(IIIIII)V", line = 1201)
    ...
    @OriginalMember(owner = "client!hr", name = "t", descriptor = "()Z", line = 1415)
    public final boolean method1155() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "m", descriptor = "(IFFFFF)V", line = 1418)
    ...
    @OriginalMember(owner = "client!hr", name = "za", descriptor = "(IIIIII[BII)V", line = 1429)
    ...
    @OriginalMember(owner = "client!hr", name = "ba", descriptor = "()I", line = 1605)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 1615)
    ...
    @OriginalMember(owner = "client!hr", name = "la", descriptor = "(FF)V", line = 1646)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(Z)V", line = 1650)
    public final void method1185(boolean arg0) {
    }

    @OriginalMember(owner = "client!hr", name = "A", descriptor = "()Z", line = 1653)
    public final boolean method1174() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "p", descriptor = "()Z", line = 1656)
    public final boolean method1141() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II)I", line = 1659)
    public final int method1128(int arg0, int arg1) {
        int var3 = arg0 | 133120;
        return var3 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!hr", name = "u", descriptor = "()V", line = 1664)
    ...
    @OriginalMember(owner = "client!hr", name = "Z", descriptor = "(I)V", line = 1676)
    public final void method1156(int arg0) {
        this.method1133(0, 0, this.field6171, this.field6155, arg0, 0);
    }

    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Z)V", line = 1680)
    public final void method1181(boolean arg0) {
    }

    @OriginalMember(owner = "client!hr", name = "A", descriptor = "(IIIII)V", line = 1683)
    ...
    @OriginalMember(owner = "client!hr", name = "M", descriptor = "(F)V", line = 1973)
    public final void method1165(float arg0) {
        this.field6163 = (int) (arg0 * 65535.0F);
    }

    @OriginalMember(owner = "client!hr", name = "i", descriptor = "()V", line = 1976)
    ...
    @OriginalMember(owner = "client!hr", name = "L", descriptor = "(I)V", line = 1992)
    public final void method1121(int arg0) {
    }

    @OriginalMember(owner = "client!hr", name = "q", descriptor = "()Z", line = 1995)
    public final boolean method1143() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIII)V", line = 1997)
    public final void method1132(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!hr", name = "n", descriptor = "()V", line = 2000)
    ...
    @OriginalMember(owner = "client!hr", name = "m", descriptor = "()Z", line = 2008)
    public final boolean method1135() {
        return true;
    }

    @OriginalMember(owner = "client!hr", name = "d", descriptor = "([I)V", line = 2011)
    ...
    @OriginalMember(owner = "client!hr", name = "o", descriptor = "()V", line = 2017)
    public final void method1137() {
        this.field6170.method3687(1402);
    }

    @OriginalMember(owner = "client!hr", name = "b", descriptor = "()Z", line = 2020)
    public final boolean method1104() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(FFF)V", line = 2022)
    public final void method1171(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!hr", name = "e", descriptor = "(IIIII)V", line = 2025)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lfc;[Ldp;Z)Lra;", line = 2102)
    ...
    @OriginalMember(owner = "client!hr", name = "h", descriptor = "()I", line = 2140)
    public final int method1122() {
        return 0;
    }

    @OriginalMember(owner = "client!hr", name = "G", descriptor = "()V", line = 2143)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "()I", line = 2166)
    public final int method1175() {
        return this.field6149;
    }

    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V", line = 2169)
    ...
    @OriginalMember(owner = "client!hr", name = "z", descriptor = "()Z", line = 2175)
    public final boolean method1173() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "r", descriptor = "()Z", line = 2178)
    public final boolean method1144() {
        return false;
    }

    @OriginalMember(owner = "client!hr", name = "U", descriptor = "()I", line = 2181)
    public final int method1127() {
        return 0;
    }

    @OriginalMember(owner = "client!hr", name = "l", descriptor = "()V", line = 2188)
    public final void method1131() {
    }

    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)Lu;", line = 2203)
    public final class64 method1191(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!hr", name = "m", descriptor = "(I)I", line = 2244)
