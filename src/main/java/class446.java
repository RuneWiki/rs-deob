...
public class class446 extends class49 implements class395 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lja;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IBZIILnf;Lja;)V", line = 16)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIILc;IIZIII[I[III)I", line = 43)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ZLja;)V", line = 219)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(BLja;)Lkh;", line = 257)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILja;II)Z", line = 296)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(Z)V", line = 327)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(B)Z", line = 449)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILja;)V", line = 461)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)I", line = 477)
    public final int method1024(int arg0) {
        ++field6487;
        return arg0 != 20691 ? -79 : this.field6483.field5827;
    }

    @OriginalMember(owner = "client!pl", name = "h", descriptor = "(I)V", line = 488)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lja;Lfb;IIIIIIZI)V", line = 509)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(BILja;)Lrc;", line = 520)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)V", line = 531)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(B)Z", line = 541)
