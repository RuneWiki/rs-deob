...
public class class446 implements class104 {
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(I)V", line = 15)
    public class446(int arg0) {
        this.field5732 = arg0;
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)Lfl;", line = 26)
