...
public class class446 extends class276 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BI)I", line = 14)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lia;ILnv;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(III)Z", line = 142)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(IIIIIZ)V", line = 186)
