...
public class class446 extends class437 {
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "()Z", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "()Z", line = 32)
    public final boolean method2772() {
        return this.field6280.field2016 && this.field6280.field1983 && this.field6280.field1993;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "()I", line = 115)
    public final int method2736() {
        return 1;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILrj;Lrj;)V", line = 119)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "()Z", line = 267)
    public final boolean method2741() {
        return this.field6405 != null;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "()V", line = 270)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lao;)V", line = 295)
