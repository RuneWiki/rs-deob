...
public class class446 extends class545 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!gb", name = "g", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!gb", name = "f", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!gb", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!gb", name = "h", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILec;)V", line = 181)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lad;Lla;Lur;)V", line = 194)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZZ)V", line = 212)
