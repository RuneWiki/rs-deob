...
public abstract class class446 implements class410 {
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(B)J", line = 110)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Leea;IZ)V", line = 441)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([JI[Ljava/lang/Object;II)V", line = 126)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)V", line = 183)
    ...
    @OriginalMember(owner = "client!qd", name = "finalize", descriptor = "()V", line = 211)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)I", line = 222)
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(B)V", line = 271)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZILjaggl/MapBuffer;)Ljaclib/memory/Buffer;", line = 298)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BIII)Lvg;", line = 345)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(B)V", line = 405)
