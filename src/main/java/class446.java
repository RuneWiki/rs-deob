...
public class class446 extends class65 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(III)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(II)V", line = 47)
    public class446(int arg0, int arg1) {
        this.field6474 = arg0;
        this.field6473 = arg1;
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIZ)Loc;", line = 58)
