...
public class class446 extends class45 {
    ...
    @OriginalMember(owner = "client!jk", name = "d", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIIIBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(II)[[I", line = 85)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIBI)I", line = 135)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "()V", line = 170)
    public class446() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Z)V", line = 175)
    ...
    @OriginalMember(owner = "client!jk", name = "c", descriptor = "(II)V", line = 187)
    ...
    @OriginalMember(owner = "client!jk", name = "f", descriptor = "(B)V", line = 441)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lcu;II)V", line = 544)
