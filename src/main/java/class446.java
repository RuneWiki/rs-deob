...
public abstract class class446 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IZIIII)I", line = 19)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIIIIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lda;)V", line = 131)
