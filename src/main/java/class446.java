...
public class class446 extends class412 {
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lap;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lap;IIIII)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lap;IIII)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lap;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lap;IIIIZ[BIZ)V")
