...
public class class446 extends class260 {
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(ILfca;)V")
    public class446(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lfca;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZIBLlda;Llda;)I")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IZLor;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IILjava/lang/String;)Lob;")
