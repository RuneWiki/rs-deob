...
public class class446 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ljava/lang/Object;Ls;II)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ls;I)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ls;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILs;)Ljava/lang/Object;")
