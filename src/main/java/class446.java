...
public class class446 extends class478 implements class534 {
    ...
    @OriginalMember(owner = "client!tl", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILqa;)Lnj;", line = 17)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lqa;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILjava/lang/String;C)[Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!tl", name = "g", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLqa;)V", line = 86)
    public final void method557(byte arg0, class167 arg1) {
        field6363++;
        int var3 = -65 % ((arg0 - 13) / 59);
    }

    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(B)I", line = 96)
    public final int method561(byte arg0) {
        field6352++;
        return arg0 == -85 ? 0 : -126;
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(I)Z", line = 126)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(Lqa;B)Lem;", line = 137)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Z)V", line = 151)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(Z)I", line = 161)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)V", line = 175)
    public final void method548(int arg0) {
        int var2 = -122 / ((arg0 + 37) / 34);
        field6357++;
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILqa;I)Lka;", line = 186)
    public final class336 method550(int arg0, class167 arg1, int arg2) {
        field6351++;
        return arg0 == -14322 ? null : null;
    }

    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(IIIIIIIIIILsv;)V", line = 197)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIILqa;)Z", line = 208)
    public final boolean method553(int arg0, int arg1, int arg2, class167 arg3) {
        field6364++;
        return arg2 <= 42;
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)I", line = 222)
    ...
    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)Z", line = 233)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)I", line = 248)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lqa;I)V", line = 260)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 270)
