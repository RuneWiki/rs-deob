...
public class class446 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ZLjava/lang/String;)[B", line = 21)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IIII[Lwp;IIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!dea", name = "toString", descriptor = "()Ljava/lang/String;", line = 787)
