...
public class class446 extends class37 implements class460 {
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lai;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)Ljb;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ltp;III)V")
