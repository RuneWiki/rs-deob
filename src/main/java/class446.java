...
public class class446 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IB)V", line = 14)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIII)Z", line = 28)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)I", line = 191)
