...
public class class446 extends class511 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "()Lc;", line = 5)
    ...
    @OriginalMember(owner = "client!hs", name = "p", descriptor = "(III[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lfe;Lfe;ZIZ)I", line = 39)
    ...
    @OriginalMember(owner = "client!hs", name = "xa", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(III[I)V", line = 150)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(FIIIFFI)V", line = 160)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)[F", line = 208)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILc;)V", line = 231)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIFF[FIIIIII)V", line = 255)
    ...
    @OriginalMember(owner = "client!hs", name = "ja", descriptor = "(I)V", line = 308)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)V", line = 337)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)[F", line = 349)
    ...
    @OriginalMember(owner = "client!hs", name = "m", descriptor = "([I)V", line = 379)
    ...
    @OriginalMember(owner = "client!hs", name = "ra", descriptor = "(I)V", line = 397)
    ...
    @OriginalMember(owner = "client!hs", name = "j", descriptor = "(III)V", line = 409)
    ...
    @OriginalMember(owner = "client!hs", name = "s", descriptor = "(IIIIII)V", line = 424)
    ...
    @OriginalMember(owner = "client!hs", name = "ka", descriptor = "(I)V", line = 459)
    ...
    @OriginalMember(owner = "client!hs", name = "za", descriptor = "(Lc;)V", line = 486)
    ...
    @OriginalMember(owner = "client!hs", name = "O", descriptor = "(I)V", line = 507)
    ...
    @OriginalMember(owner = "client!hs", name = "o", descriptor = "(III)V", line = 531)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "()V", line = 550)
    public class446() {
        this.method1311();
    }
}
