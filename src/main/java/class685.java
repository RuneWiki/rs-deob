...
public class class685 extends class130 {
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)J", line = 42)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)J", line = 54)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(JI)I", line = 77)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 115)
