...
public class class685 extends class60 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(ILhd;)V", line = 42)
    public class685(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(CI)Z", line = 45)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(II)I", line = 71)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lhd;)V", line = 85)
