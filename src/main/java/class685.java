...
public class class685 extends class67 {
    ...
    @OriginalMember(owner = "client!kja", name = "<init>", descriptor = "(Lut;Lkc;[Lgs;[I[I)V")
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
