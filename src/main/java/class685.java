...
public class class685 extends class597 {
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lql;Lsga;[Law;[I[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(CIIIZLfa;II)V", line = 143)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "([B[IIIIIIII)V", line = 208)
    ...
    @OriginalMember(owner = "client!it", name = "q", descriptor = "(CIIIZ)V", line = 240)
