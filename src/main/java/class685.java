...
public class class685 {
    ...
    @OriginalMember(owner = "client!cc", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field9634++;
        return "Cache:" + this.field9639;
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Z[BIIZ)Z", line = 13)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III[B)Z", line = 131)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(ILck;Lck;I)V", line = 307)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)V", line = 171)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZI)[B", line = 200)
