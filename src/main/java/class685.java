...
public class class685 extends class540 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lco;Lmw;IIIZLha;III)Lka;", line = 25)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 274)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)Z", line = 305)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZZ[I[II)J", line = 331)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILcb;Ljava/awt/Canvas;Ld;II)Lha;", line = 383)
