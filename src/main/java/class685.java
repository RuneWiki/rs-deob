...
public class class685 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Lvha;Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)Lca;", line = 81)
