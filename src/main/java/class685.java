...
public class class685 extends class159 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIIB)V", line = 70)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZIILjava/lang/String;Ljava/lang/String;)V", line = 152)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "([III)V", line = 205)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IZ)V", line = 331)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Ldt;I)Lbd;", line = 348)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZFIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lbja;IIIII)V", line = 489)
