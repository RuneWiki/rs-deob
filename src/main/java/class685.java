...
public class class685 implements class365 {
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 190)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)I", line = 23)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IILjava/awt/Component;Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I[I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BII)V", line = 141)
