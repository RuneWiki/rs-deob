...
public class class685 extends class293 implements class83 {
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(Z)Z", line = 18)
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(Lr;I)Lifa;", line = 30)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIZLr;)Z", line = 54)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lr;Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIIIIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!jg", name = "d", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(Lr;I)V", line = 117)
    ...
    @OriginalMember(owner = "client!jg", name = "f", descriptor = "(B)V", line = 139)
    public static void method3840(byte arg0) {
        int var1 = -114 % ((-4 - arg0) / 57);
        field9675 = null;
    }

    @OriginalMember(owner = "client!jg", name = "f", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLr;)V", line = 164)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!jg", name = "h", descriptor = "(I)Z", line = 184)
    public final boolean method270(int arg0) {
        ++field9662;
        return arg0 > -42;
    }

    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(II)V", line = 198)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lr;I)Lhr;", line = 227)
    ...
    @OriginalMember(owner = "client!jg", name = "g", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)I", line = 935)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "([BB)[B", line = 946)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)I", line = 1006)
    ...
    @OriginalMember(owner = "client!jg", name = "e", descriptor = "(I)Z", line = 1018)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILr;ILcaa;ZII)V", line = 1032)
