...
public class class685 implements class517 {
    ...
    @OriginalMember(owner = "client!ew", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field9687++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(JJ)J", line = 30)
    public static long method3821(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 38)
    public class685(String arg0, int arg1) {
        this.field9682 = arg1;
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 48)
