...
public class class685 extends class391 {
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Z)J", line = 18)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 115)
    public class685() {
        this.field9356 = System.nanoTime();
        this.field9355 = System.nanoTime();
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Z)J", line = 55)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(JI)I", line = 75)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)J", line = 107)
