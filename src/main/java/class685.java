...
public class class685 extends class404 {
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IBI)V", line = 45)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IILjava/lang/String;)Lqc;", line = 59)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(III)V", line = 81)
