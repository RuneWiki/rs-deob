...
public class class685 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lrh;B)Lol;")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "([[BLel;I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(B)Lbba;")
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lwm;Lwm;)V")
