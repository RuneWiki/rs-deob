...
public class class685 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IB)Ljava/io/File;", line = 3)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 126)
