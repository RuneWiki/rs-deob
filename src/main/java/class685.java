...
public class class685 extends class591 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lnh;II[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lnh;II[I)V", line = 47)
