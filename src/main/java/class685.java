...
public class class685 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Lmga;", line = 15)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IFIFZIFI)[F", line = 51)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(ILpu;Lpu;)V", line = 147)
