...
public class class685 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZ)Lfia;")
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lbi;Ld;)V")
    public class685(class483 arg0, class153 arg1) {
        this.field9548 = arg1;
        this.field9539 = arg0;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)Lbq;")
