...
public class class685 extends class103 implements class414 {
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIZ)Z", line = 13)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)Ldn;", line = 25)
    ...
    @OriginalMember(owner = "client!fj", name = "f", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)I", line = 59)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Ltia;Ldn;Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIB)V", line = 103)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)Z", line = 130)
