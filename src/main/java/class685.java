...
public class class685 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZI)[I", line = 7)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Lab;", line = 64)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIB)I", line = 84)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lol;I)V", line = 180)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lei;ILri;)V", line = 243)
