...
public class class544 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Z)Z", line = 18)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(II)V", line = 124)
