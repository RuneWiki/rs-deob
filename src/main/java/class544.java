...
public class class544 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZLel;)Z", line = 33)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([BFFFIILse;IIFFZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 93)
