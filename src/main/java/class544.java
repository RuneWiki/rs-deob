...
public class class544 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIII)Lkaa;", line = 16)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(FBFF)I", line = 47)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(B)V", line = 100)
