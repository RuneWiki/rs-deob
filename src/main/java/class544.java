...
public class class544 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!dn", name = "toString", descriptor = "()Ljava/lang/String;", line = 64)
