...
public class class544 extends class19 implements class324 {
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ILjc;)V", line = 650)
    ...
    @OriginalMember(owner = "client!dca", name = "g", descriptor = "(I)I", line = 683)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lha;I)V", line = 695)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZIII)V", line = 705)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIILha;)Z", line = 716)
    ...
    @OriginalMember(owner = "client!dca", name = "g", descriptor = "(B)Z", line = 736)
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(BLha;)V", line = 750)
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(I)I", line = 777)
    public final int method606(int arg0) {
        ++field7902;
        return arg0 >= -32 ? 17 : this.field7916.field3091;
    }

    @OriginalMember(owner = "client!dca", name = "e", descriptor = "(B)Z", line = 789)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BLha;)Lqs;", line = 801)
    ...
    @OriginalMember(owner = "client!dca", name = "d", descriptor = "(Z)V", line = 853)
    ...
    @OriginalMember(owner = "client!dca", name = "d", descriptor = "(B)I", line = 873)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lha;Z)V", line = 887)
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(BLha;)Lro;", line = 899)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)I", line = 915)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ILjw;Lha;BIZI)V", line = 926)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "([IIII[ILch;)Lvb;", line = 943)
    ...
    @OriginalMember(owner = "client!dca", name = "e", descriptor = "(I)V", line = 997)
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(B)V", line = 1008)
    ...
    @OriginalMember(owner = "client!dca", name = "d", descriptor = "(I)Z", line = 1018)
    public final boolean method715(int arg0) {
        ++field7895;
        return arg0 != -12888;
    }

    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BI)V", line = 1029)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)Z", line = 1048)
