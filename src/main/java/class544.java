...
public class class544 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(II)V", line = 149)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IB)Ljn;", line = 164)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(III)I", line = 218)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 255)
