...
public class class544 extends class751 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lta;[I)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILug;I)V")
    ...
    @OriginalMember(owner = "client!eh", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!eh", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eh", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Ljj;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lr;IIIIZ)Z")
