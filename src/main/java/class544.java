...
public class class544 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lji;Lnj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IF)I", line = 73)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "()V", line = 132)
    public static void method3089() {
        field7697 = null;
        field7700 = null;
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIF)F", line = 144)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(F)F", line = 153)
    private static final float method3091(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!md", name = "b", descriptor = "(IIF)F", line = 177)
