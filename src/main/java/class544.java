...
public abstract class class544 extends class149 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(DI)V", line = 24)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZLco;I)Ljava/lang/String;", line = 60)
