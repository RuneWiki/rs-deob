...
public class class544 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ILnfa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ZLnfa;)V", line = 25)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lca;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lrh;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I[B)V", line = 84)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(BCLjava/lang/String;)[Ljava/lang/String;", line = 160)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIIIIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)Ljda;", line = 217)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Z)Z", line = 236)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 255)
