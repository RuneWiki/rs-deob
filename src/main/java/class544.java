...
public class class544 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(II)I", line = 5)
    public static final int method2938(int arg0, int arg1) {
        field7261++;
        return arg1 == 766538279 ? arg0 >>> 7 : 105;
    }

    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(II[J[Ljava/lang/Object;B)V", line = 39)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)V", line = 94)
