...
public class class544 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)Lqda;", line = 17)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)Z", line = 109)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLiaa;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)Lqda;", line = 225)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BLiaa;)V", line = 305)
