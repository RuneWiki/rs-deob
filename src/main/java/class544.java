...
public class class544 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(IZ)V", line = 230)
    public class544(int arg0, boolean arg1) {
        this.field7461 = arg0;
        this.field7453 = arg1;
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IC)Z", line = 76)
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BI)I", line = 134)
    ...
    @OriginalMember(owner = "client!df", name = "toString", descriptor = "()Ljava/lang/String;", line = 162)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 186)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IB)V", line = 198)
    ...
    @OriginalMember(owner = "client!df", name = "d", descriptor = "(I)V", line = 219)
