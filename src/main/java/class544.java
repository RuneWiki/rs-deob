...
public class class544 extends class356 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(B)I", line = 15)
    public final int method1029(byte arg0) {
        field7650++;
        return arg0 < 16 ? 0 : this.field7657;
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lr;IIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!eba", name = "d", descriptor = "(B)I", line = 181)
    public final int method1032(byte arg0) {
        field7649++;
        return arg0 == 15 ? this.field7654 : 43;
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)I", line = 192)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(Z)J", line = 203)
    public final long method1028(boolean arg0) {
        field7658++;
        return arg0 ? 22L : this.field7648;
    }

    @OriginalMember(owner = "client!eba", name = "e", descriptor = "(B)I", line = 214)
    ...
    @OriginalMember(owner = "client!eba", name = "f", descriptor = "(B)I", line = 224)
