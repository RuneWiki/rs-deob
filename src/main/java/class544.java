...
public class class544 implements class563 {
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lga;)V", line = 19)
    public class544(class332 arg0) {
        this.field7441 = arg0;
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)Lrba;", line = 42)
