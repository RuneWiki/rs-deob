...
public class class544 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!su", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Loaa;JI)V", line = 96)
