...
public class class544 extends class289 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(FFIFIFILgl;FII[BII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(III)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ms", name = "f", descriptor = "(I)[Lqv;", line = 192)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BIB)V", line = 206)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIIIBIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "()V", line = 265)
    public class544() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIIZZ)V", line = 270)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(III)V", line = 327)
    ...
    @OriginalMember(owner = "client!ms", name = "g", descriptor = "(I)V", line = 351)
