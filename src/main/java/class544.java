...
public class class544 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(II)Lmv;")
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)[Lsn;")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lnb;ILoh;Loh;)V")
