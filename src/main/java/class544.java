...
public class class544 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lcea;II)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILcea;)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lin;B)V")
