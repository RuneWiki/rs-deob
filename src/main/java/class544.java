...
public class class544 implements class95 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZII)V", line = 13)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IB)I", line = 41)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Throwable;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZI)I", line = 130)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILdc;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(III)V", line = 199)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)V", line = 234)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)I", line = 244)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(III)V", line = 265)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Z)V", line = 293)
