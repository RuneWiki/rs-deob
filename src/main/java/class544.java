...
public class class544 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(B)[Lbv;", line = 38)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I[[[BIBII)V", line = 53)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(III)Z", line = 192)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!wda", name = "d", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!wda", name = "e", descriptor = "(I)Z", line = 255)
