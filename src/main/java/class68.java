...
public class class68 extends class633 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!aw", name = "h", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!aw", name = "g", descriptor = "(I)[B", line = 106)
