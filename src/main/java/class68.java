...
public class class68 extends class39 implements class147 {
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(IIIIIIIIIILbt;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IILgfa;IIZLoa;)V")
    public final void method143(int arg0, int arg1, class687 arg2, int arg3, int arg4, boolean arg5, class638 arg6) {
        field939++;
        int var8 = -7 / (-arg3 / 54);
    }

    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Loa;B)Lac;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ILoa;)Lwc;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(BLoa;)V")
