...
public class class68 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIIII)Z", line = 154)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lht;)V", line = 528)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)Z", line = 212)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(B)Z", line = 222)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLfh;)V", line = 361)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(B)V", line = 375)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILfh;)Z", line = 446)
