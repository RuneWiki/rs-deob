...
public class class68 extends class712 {
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lrl;Lep;)V", line = 53)
    public class68(class232 arg0, class374 arg1) {
        super(arg0);
        this.field1052 = arg1;
    }

    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IILhba;)V", line = 64)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BLbda;)Z", line = 81)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!nm", name = "d", descriptor = "(Z)Z", line = 145)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZB)V", line = 157)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BZ)V", line = 178)
