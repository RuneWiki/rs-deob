...
public class class68 extends class298 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lon;Ltb;)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lwm;)V")
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(Lwm;)V")
    public final synchronized void method513(class298 arg0) {
        this.field1119.method151(arg0, 2);
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "()Lwm;")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ltb;)V")
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "()Lwm;")
