...
public class class68 extends class152 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ZLqj;)V", line = 23)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLeb;)V", line = 101)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)Lfe;", line = 147)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 171)
