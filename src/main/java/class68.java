...
public class class68 implements class279 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZIIIF)[I", line = 100)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZFIII)[F", line = 110)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIFBZ)[I", line = 126)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZI)Loh;", line = 137)
    public final class281 method584(boolean arg0, int arg1) {
        field885++;
        return arg0 ? this.field879[arg1] : null;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)Lrb;", line = 159)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLlq;I)Lbg;", line = 189)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lul;Lul;Lul;)V", line = 226)
