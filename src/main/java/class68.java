...
public class class68 extends class92 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILqv;)V")
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lnd;)V")
    public class68(class632 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lco;I)Lvn;")
