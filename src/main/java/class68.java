...
public class class68 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IBIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILea;I)Z")
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(I[Lvp;IIII)V")
