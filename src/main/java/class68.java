...
public class class68 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lji;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZILji;)V", line = 27)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)V", line = 65)
