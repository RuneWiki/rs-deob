...
public class class68 extends class11 {
    ...
    @OriginalMember(owner = "client!YHASUFYG", name = "<init>", descriptor = "(LBYZSQZUF;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!YHASUFYG", name = "a", descriptor = "(ILAGTHLVTI;IB)V")
