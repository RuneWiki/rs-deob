...
@OriginalClass("client!YRWSITPW")
public class class68 {

    @OriginalMember(owner = "client!YRWSITPW", name = "b", descriptor = "I")
    public int field1633;

    @OriginalMember(owner = "client!YRWSITPW", name = "c", descriptor = "[I")
    public int[] field1634;

    @OriginalMember(owner = "client!YRWSITPW", name = "d", descriptor = "[[I")
    public int[][] field1635;

    @OriginalMember(owner = "client!YRWSITPW", name = "a", descriptor = "I")
    private int field1632;

    @OriginalMember(owner = "client!YRWSITPW", name = "<init>", descriptor = "(LXQPFGONL;B)V")
