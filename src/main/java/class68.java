...
public class class68 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIB)V", line = 12)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!hk", name = "toString", descriptor = "()Ljava/lang/String;", line = 44)
    public final String toString() {
        field780++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(II)V", line = 84)
