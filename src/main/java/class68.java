...
public class class68 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)I", line = 50)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IILr;I)V", line = 74)
