...
public class class68 extends class63 implements class303 {
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BLza;)Lql;", line = 23)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lza;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(Lza;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILza;B)Le;", line = 100)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lza;Lpm;IIIIIZIIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IBILza;)Z", line = 120)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Lza;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!tq", name = "f", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)I", line = 167)
    ...
    @OriginalMember(owner = "client!tq", name = "g", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)Z", line = 187)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)I", line = 216)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(III)I", line = 226)
