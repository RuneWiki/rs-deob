...
public class class68 extends class264 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lwg;IIIIILgf;Lnm;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BLkk;I)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lkk;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "([Lae;IB)V")
