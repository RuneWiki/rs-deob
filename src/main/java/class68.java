...
public class class68 extends class21 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lpga;IIZ)V")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lpga;II[III)V")
