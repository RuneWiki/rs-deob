...
public class class68 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILrg;)Lfq;", line = 3)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIZB)I", line = 47)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 66)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILvt;)V", line = 80)
