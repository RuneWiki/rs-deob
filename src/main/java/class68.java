...
public class class68 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(BIIIIIILub;)V", line = 39)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)Z", line = 54)
