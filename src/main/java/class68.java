...
public class class68 {
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lho;Lud;)V")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IBZLqk;Lqk;)Lwd;")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lqk;Lqk;II)Lwd;")
