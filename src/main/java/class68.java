...
public class class68 extends class435 {
    ...
    @OriginalMember(owner = "client!qq", name = "e", descriptor = "(B)Lfu;", line = 18)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lha;III[Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "([B)V", line = 80)
