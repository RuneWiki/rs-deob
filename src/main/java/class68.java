...
public class class68 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BC)V", line = 6)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lno;I)V", line = 64)
