...
public class class68 extends class314 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "()V", line = 336)
    public class68() {
        super(1, true);
    }

    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(IB)V", line = 94)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BLie;I)V", line = 245)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(B)V", line = 290)
    ...
    @OriginalMember(owner = "client!aw", name = "h", descriptor = "(I)V", line = 305)
