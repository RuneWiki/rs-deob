...
public class class68 extends class418 {
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lso;IB)V", line = 59)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "([B)V", line = 98)
