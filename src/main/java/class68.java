...
public class class68 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 28)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILti;)V", line = 106)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)I", line = 143)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLqa;Ltn;)V", line = 164)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILti;I)V", line = 180)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILjava/lang/Object;I)[B", line = 233)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(II)Z", line = 266)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(II)Ljava/lang/String;", line = 299)
