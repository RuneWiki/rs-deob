...
@OriginalClass("client!YCPCXCIN")
public class class68 {

    @OriginalMember(owner = "client!YCPCXCIN", name = "a", descriptor = "I")
    private int field1685 = -28737;

    @OriginalMember(owner = "client!YCPCXCIN", name = "b", descriptor = "I")
    private int field1686;

    @OriginalMember(owner = "client!YCPCXCIN", name = "c", descriptor = "[LDLMMHADP;")
    private class13[] field1687;

    @OriginalMember(owner = "client!YCPCXCIN", name = "<init>", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!YCPCXCIN", name = "a", descriptor = "(J)LDLMMHADP;")
    ...
    @OriginalMember(owner = "client!YCPCXCIN", name = "a", descriptor = "(LDLMMHADP;JB)V")
