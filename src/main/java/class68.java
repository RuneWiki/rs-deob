...
public abstract class class68 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lra;Lra;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)Z", line = 62)
