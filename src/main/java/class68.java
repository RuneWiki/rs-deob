...
public class class68 extends class496 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lql;)V", line = 9)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(III[I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!jr", name = "d", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!jr", name = "e", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(III[I)V", line = 128)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "()Lql;", line = 151)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "([I)V", line = 172)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "()V", line = 182)
    public class68() {
        this.method195();
    }
}
