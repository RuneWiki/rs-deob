...
public class class68 extends class272 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lwe;IIIIIIIIIIIZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lqa;J)V", line = 28)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "()V", line = 221)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(JI)V", line = 228)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "()V", line = 626)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lwe;IIIIIIIIIIIZZ)V", line = 636)
