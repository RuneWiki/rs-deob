...
public class class68 extends class129 implements class324 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIILha;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "g", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lha;Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(B)I", line = 72)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIIIIZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)I", line = 99)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(BLha;)Lro;", line = 115)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(III)I", line = 127)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(B)I", line = 147)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)I", line = 159)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(I)I", line = 169)
    public final int method606(int arg0) {
        ++field1046;
        return arg0 > -32 ? 26 : this.field1056.field3091;
    }

    @OriginalMember(owner = "client!ds", name = "e", descriptor = "(B)Z", line = 181)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lha;I)V", line = 192)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IB)I", line = 203)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(BLha;)V", line = 221)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)Z", line = 247)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IZILla;Ljava/awt/Canvas;Ld;)Lha;", line = 258)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZIIIII)V", line = 282)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BLha;)Lqs;", line = 295)
    ...
    @OriginalMember(owner = "client!ds", name = "g", descriptor = "(B)Z", line = 351)
