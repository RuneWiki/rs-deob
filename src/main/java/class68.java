...
public class class68 extends class17 {
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!hk", name = "h", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!hk", name = "g", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "()V", line = 47)
    public class68() {
        super(3, false);
    }

    @OriginalMember(owner = "client!hk", name = "e", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lwm;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)[[I", line = 105)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)[I", line = 164)
