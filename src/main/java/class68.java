...
public class class68 extends class238 {
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(B)F", line = 5)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)J", line = 34)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lha;I)Lnf;", line = 50)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 96)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(I)Z", line = 170)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 182)
    public class68(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bd", name = "f", descriptor = "(I)D", line = 193)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BIIIIIIII)V", line = 204)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 219)
