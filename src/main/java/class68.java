...
public class class68 {
    ...
    @OriginalMember(owner = "client!YMQGRGSI", name = "g", descriptor = "[LYMQGRGSI;")
    public static class68[] field1633;

    @OriginalMember(owner = "client!YMQGRGSI", name = "a", descriptor = "(ILSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!YMQGRGSI", name = "a", descriptor = "(LLDILQFVA;I)V")
    ...
    @OriginalMember(owner = "client!YMQGRGSI", name = "b", descriptor = "(I)LHEQROJXW;")
    ...
    @OriginalMember(owner = "client!YMQGRGSI", name = "b", descriptor = "(Z)LHEQROJXW;")
