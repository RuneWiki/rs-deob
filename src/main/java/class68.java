...
@OriginalClass("client!ZDMOUFDZ")
public class class68 {

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "a", descriptor = "I")
    public int field1644 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "b", descriptor = "I")
    public int field1645 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "c", descriptor = "Z")
    public boolean field1646 = false;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "e", descriptor = "I")
    public int field1648 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "g", descriptor = "I")
    public int field1650 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "i", descriptor = "I")
    private int field1652 = 128;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "k", descriptor = "Z")
    public boolean field1654 = true;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "l", descriptor = "I")
    public int field1655 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "n", descriptor = "I")
    public int field1657 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "q", descriptor = "I")
    public int field1660 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "t", descriptor = "I")
    public int field1663 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "u", descriptor = "I")
    public int field1664 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "x", descriptor = "J")
    public long field1667 = -1L;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "y", descriptor = "I")
    public int field1668 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "z", descriptor = "B")
    public byte field1669 = 1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "A", descriptor = "I")
    public int field1670 = 32;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "F", descriptor = "I")
    private int field1675 = 128;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "G", descriptor = "I")
    public int field1676 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "H", descriptor = "I")
    public int field1677 = -1;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "K", descriptor = "Z")
    private boolean field1680 = false;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "L", descriptor = "Z")
    public boolean field1681 = true;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "w", descriptor = "I")
    private static int field1666 = -302;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "I", descriptor = "LISXEOURU;")
    public static class21 field1678 = new class21(-15730, 30);

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "f", descriptor = "I")
    private int field1649;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "j", descriptor = "I")
    private int field1653;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "s", descriptor = "I")
    public static int field1662;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "D", descriptor = "I")
    private static int field1673;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "r", descriptor = "LZOMNSJJM;")
    private static class69 field1661;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "m", descriptor = "Lclient;")
    public static client field1656;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "E", descriptor = "Ljava/lang/String;")
    public String field1674;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "C", descriptor = "[B")
    public byte[] field1672;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "h", descriptor = "[I")
    private static int[] field1651;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "p", descriptor = "[I")
    private int[] field1659;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "v", descriptor = "[I")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "M", descriptor = "[I")
    public int[] field1682;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "d", descriptor = "[LZDMOUFDZ;")
    private static class68[] field1647;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "o", descriptor = "[Ljava/lang/String;")
    public String[] field1658;

    @OriginalMember(owner = "client!ZDMOUFDZ", name = "a", descriptor = "(I)LZDMOUFDZ;")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "b", descriptor = "(I)LZDMOUFDZ;")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "a", descriptor = "(II[II)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "a", descriptor = "(LZOMNSJJM;B)V")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "a", descriptor = "(LLYZBHNJP;)V")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "c", descriptor = "(I)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!ZDMOUFDZ", name = "a", descriptor = "(B)V")
