...
public class class68 {
    ...
    @OriginalMember(owner = "client!XZZTWOGF", name = "d", descriptor = "LTJOELOUM;")
    ...
    @OriginalMember(owner = "client!XZZTWOGF", name = "b", descriptor = "[LXZZTWOGF;")
    ...
    @OriginalMember(owner = "client!XZZTWOGF", name = "c", descriptor = "(I)LXZZTWOGF;")
