...
public class class68 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IJ)Ld;")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "([Ld;B)I")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ld;BJ)V")
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)Ld;")
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(B)Ld;")
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(B)Ld;")
