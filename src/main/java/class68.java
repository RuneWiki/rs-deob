...
public class class68 extends class509 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BILin;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lgk;ILgk;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BIIIILza;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Ltt;Lmm;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lbs;I)Z")
