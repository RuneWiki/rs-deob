...
public class class68 extends class461 {
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IZIB)V", line = 37)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(IZ)I", line = 53)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lpe;Lpe;Lqo;)V", line = 64)
