...
public class class68 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIILnq;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILoi;)V", line = 83)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 130)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(II)Lhb;", line = 160)
