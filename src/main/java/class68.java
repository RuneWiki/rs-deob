...
public class class68 {
    ...
    @OriginalMember(owner = "client!pn", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field778++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 30)
