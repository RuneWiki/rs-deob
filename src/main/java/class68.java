...
public class class68 extends class333 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)Leo;", line = 20)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Log;Lgi;IIIIIIIIIIIII)V", line = 53)
