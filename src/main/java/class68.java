...
public class class68 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(II)Llo;", line = 80)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(II)V", line = 142)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lkp;ILph;Lph;)V", line = 188)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(B)V", line = 165)
