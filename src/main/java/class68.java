...
public class class68 extends class72 {
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(Lcq;)V")
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(ILcq;)V")
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(II)I")
