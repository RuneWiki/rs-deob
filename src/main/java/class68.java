...
public class class68 extends class405 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IBI)I", line = 72)
