...
public class class68 extends class187 {
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!qh", name = "e", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!qh", name = "e", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILeh;Leh;)V", line = 44)
    ...
    @OriginalMember(owner = "client!qh", name = "f", descriptor = "(I)[B", line = 64)
