...
public class class68 extends class35 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!ok", name = "e", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "()V", line = 154)
