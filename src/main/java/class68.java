...
public class class68 extends class406 {
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(B)Lnd;", line = 7)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I[[I)V", line = 33)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "([IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIIB)V", line = 104)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(BII)Z", line = 117)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)I", line = 133)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "([IIII)V", line = 229)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZI)I", line = 246)
    ...
    @OriginalMember(owner = "client!mc", name = "e", descriptor = "(B)Lnd;", line = 257)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(BIII)Z", line = 288)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(IIIIIIIII)V", line = 306)
