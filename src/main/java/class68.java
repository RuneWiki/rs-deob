...
@OriginalClass("client!YMCKWFGH")
public class class68 {

    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "Z")
    private boolean field1633 = false;

    @OriginalMember(owner = "client!YMCKWFGH", name = "b", descriptor = "Z")
    private boolean field1634 = true;

    @OriginalMember(owner = "client!YMCKWFGH", name = "d", descriptor = "B")
    private byte field1636 = -53;

    @OriginalMember(owner = "client!YMCKWFGH", name = "e", descriptor = "I")
    private int field1637 = -479;

    @OriginalMember(owner = "client!YMCKWFGH", name = "f", descriptor = "B")
    private byte field1638 = 71;

    @OriginalMember(owner = "client!YMCKWFGH", name = "g", descriptor = "Z")
    private boolean field1639 = false;

    @OriginalMember(owner = "client!YMCKWFGH", name = "h", descriptor = "I")
    public int field1640 = 0;

    @OriginalMember(owner = "client!YMCKWFGH", name = "i", descriptor = "I")
    public int field1641 = 0;

    @OriginalMember(owner = "client!YMCKWFGH", name = "j", descriptor = "I")
    public int field1642;

    @OriginalMember(owner = "client!YMCKWFGH", name = "k", descriptor = "I")
    public int field1643;

    @OriginalMember(owner = "client!YMCKWFGH", name = "l", descriptor = "[[I")
    public int[][] field1644;

    @OriginalMember(owner = "client!YMCKWFGH", name = "c", descriptor = "I")
    private int field1635;

    @OriginalMember(owner = "client!YMCKWFGH", name = "<init>", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(IIZIII)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(IZIIIII)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "b", descriptor = "(III)V")
    private void method573(int arg0, int arg1, int arg2) {
        this.field1644[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(ZIIIIB)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(IIIZIII)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(ZIII)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "c", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "b", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!YMCKWFGH", name = "a", descriptor = "(IIIIBIII)Z")
