...
public class class68 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIZIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BLwp;)V", line = 21)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IB)Lg;", line = 82)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lvj;Lfa;)V", line = 149)
    public class68(class422 arg0, class524 arg1) {
        this.field687 = arg0;
        this.field680 = arg1;
    }

    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILwn;)I", line = 158)
