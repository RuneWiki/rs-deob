...
public abstract class class296 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IBI)I", line = 16)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IZIZLjava/lang/String;)V", line = 30)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 38)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I[III[IIII[FBI[FI)V", line = 79)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IZJI)V", line = 162)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(II)I", line = 207)
    public static int method1733(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!s", name = "b", descriptor = "(I)Ljava/lang/String;", line = 216)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 246)
