...
public class class296 extends class297 {
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lbo;)V", line = 14)
    public class296(class511 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lnk;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)I", line = 52)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZII)V", line = 89)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)Z", line = 121)
