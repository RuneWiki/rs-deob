...
public class class296 {
    ...
    @OriginalMember(owner = "client!fd", name = "exit", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!fd", name = "listmodes", descriptor = "()[I", line = 33)
    ...
    @OriginalMember(owner = "client!fd", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 118)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 160)
