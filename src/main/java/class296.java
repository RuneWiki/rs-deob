...
public class class296 extends class278 {
    ...
    @OriginalMember(owner = "client!eo", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(III[[ZZII)V", line = 91)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(III[[ZZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIIIIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 219)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIII)V", line = 240)
    ...
    @OriginalMember(owner = "client!eo", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 322)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lada;[I)V", line = 342)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZ)V", line = 353)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)V", line = 364)
    ...
    @OriginalMember(owner = "client!eo", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 377)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(II)V", line = 396)
    public final void method1672(int arg0, int arg1) {
        ++field3665;
    }

    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lnv;IIII[[I[[II)V", line = 403)
    ...
    @OriginalMember(owner = "client!eo", name = "ka", descriptor = "(III)V", line = 460)
    ...
    @OriginalMember(owner = "client!eo", name = "fa", descriptor = "(IILr;)Lr;", line = 472)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIIIII[[Z)V", line = 503)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BILmt;I)V", line = 672)
    ...
    @OriginalMember(owner = "client!eo", name = "YA", descriptor = "()V", line = 740)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIBZIII[[Z)V", line = 1320)
