...
public abstract class class296 {
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(III)Llv;", line = 43)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IC)Z", line = 78)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(IIIII)V", line = 327)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)V", line = 279)
