...
public class class296 extends class316 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lua;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILrv;)V", line = 65)
