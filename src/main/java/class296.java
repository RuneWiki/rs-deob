...
public class class296 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lii;IILrj;IIZ[Lmc;ILrj;III)Ldc;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lrj;IIIIIIILii;I)Ldc;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIILii;ILrj;I)Ldc;")
