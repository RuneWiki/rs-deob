...
public class class296 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IILjava/lang/String;Lji;)Lrm;", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)Lts;", line = 82)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)Lts;", line = 101)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)Lts;", line = 122)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(I)Z", line = 175)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILts;)V", line = 188)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)I", line = 206)
    ...
    @OriginalMember(owner = "client!st", name = "d", descriptor = "(I)Lts;", line = 234)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "()V", line = 284)
    public class296() {
        this.field4211.field5663 = this.field4211;
        this.field4211.field5665 = this.field4211;
    }

    @OriginalMember(owner = "client!st", name = "e", descriptor = "(I)V", line = 263)
