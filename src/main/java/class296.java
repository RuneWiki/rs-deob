...
public class class296 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZILat;)V", line = 15)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!tr", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field4152++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BI)Z", line = 61)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILat;)V", line = 72)
