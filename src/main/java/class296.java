...
public class class296 extends class443 {
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lph;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lkl;II)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lph;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lhq;[I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IILph;)Lph;")
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lic;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(Lph;IIIIZ)Z")
