...
public class class296 extends class449 implements class285 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZLvm;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lvm;Z)Ldn;", line = 39)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lvm;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)Z", line = 97)
    public final boolean method358(byte arg0) {
        ++field4029;
        return arg0 != 24 ? true : this.field4023.method256(15842);
    }

    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lvm;Lds;IIIIIIIZI)V", line = 112)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BLvm;)V", line = 124)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(B)I", line = 135)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lvm;II)Ljn;", line = 146)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!ls", name = "f", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZIIILai;ILvm;)V", line = 209)
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "(B)Z", line = 220)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIILvm;)Z", line = 231)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)V", line = 251)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I[IBII)V", line = 262)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILam;)V", line = 291)
