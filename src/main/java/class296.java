...
public class class296 extends class748 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qn", name = "g", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IZLvj;)V", line = 48)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "()V", line = 78)
    public class296() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)[I", line = 85)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(IBI)Z", line = 167)
