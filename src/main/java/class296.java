...
public class class296 extends class468 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lkea;IIZ)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lkea;II[III)V")
