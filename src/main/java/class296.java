...
public class class296 extends class419 {
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(Lkga;Lgda;[Lpga;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!vv", name = "OA", descriptor = "(CIIIZ)V", line = 245)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(CIIIZLua;II)V", line = 265)
