...
public class class296 extends InputStream {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "([Ljava/lang/Object;BII[J)V", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)I", line = 59)
    public static final int method1840(byte arg0) {
        field4186++;
        return arg0 >= -48 ? 19 : class580.field8501++;
    }

    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!mv", name = "read", descriptor = "()I", line = 88)
