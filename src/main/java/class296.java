...
public class class296 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IB)[[I", line = 47)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)[[[I", line = 128)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BII)V", line = 153)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILjava/lang/String;)V", line = 205)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(III)V", line = 365)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IBI)I", line = 228)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(CI)Z", line = 268)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLjava/lang/Throwable;)Ljava/lang/String;", line = 279)
