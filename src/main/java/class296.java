...
public class class296 extends class413 {
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lya;B)Lmf;")
