...
public class class296 extends class539 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(II)Z", line = 10)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BLoa;)V", line = 27)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IILoa;)Lba;", line = 67)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(B)V", line = 162)
