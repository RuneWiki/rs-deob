...
public class class296 extends class384 {
    ...
    @OriginalMember(owner = "client!q", name = "c", descriptor = "(B)Lnn;")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(ILnn;FLnn;)Z")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BLhd;)Lhd;")
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lug;I)V")
