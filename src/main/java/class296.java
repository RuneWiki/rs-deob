...
public class class296 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lji;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIILhc;)V")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILgv;)V")
