...
public class class296 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lrt;I[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(III)V", line = 120)
