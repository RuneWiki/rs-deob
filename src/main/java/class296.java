...
public class class296 extends InputStream {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)B", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!st", name = "read", descriptor = "()I", line = 60)
