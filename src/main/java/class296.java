...
public class class296 extends class279 implements class9 {
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Los;ILjaclib/memory/Buffer;)V", line = 3)
    public class296(class468 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field4334 = arg1;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZILjava/util/Random;)I", line = 14)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Los;I[BI)V", line = 44)
    public class296(class468 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4334 = arg1;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BI[BI)V", line = 52)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIB)V", line = 90)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIFI[FIIIFIIFI)V", line = 113)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)I", line = 197)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)J", line = 208)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Z)V", line = 222)
