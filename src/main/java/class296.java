...
public abstract class class296 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 11)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLia;)Lvs;", line = 43)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III[Lo;Ljava/lang/String;Lta;II[I)V", line = 54)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIB)B", line = 206)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 227)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[I[Lo;I[IZLjava/lang/String;[I)V", line = 243)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZI)V", line = 406)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 426)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 465)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 538)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;)V", line = 558)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[Lo;I[IILjava/lang/String;IB)V", line = 573)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 596)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 624)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;[IIBIIII[Lo;IIILjava/util/Random;[II)I", line = 635)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 712)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/util/Random;IIII[Lo;ILjava/lang/String;[II)I", line = 748)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([IILjava/lang/String;IIIIIIII[Lo;IIIILta;)I", line = 785)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZLjava/lang/String;III[Lo;IILta;[IIIIII)I", line = 885)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lza;Lqm;)V", line = 911)
