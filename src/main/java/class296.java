...
public class class296 extends class472 implements class513 {
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!dr", name = "g", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!dr", name = "finalize", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZLum;)V", line = 91)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II)I", line = 103)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(DB)V", line = 122)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Ltt;III)V", line = 176)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Ltt;IIII)V", line = 191)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BII)V", line = 163)
