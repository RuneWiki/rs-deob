...
public class class296 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IZLat;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lat;B)V")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)[Lil;")
