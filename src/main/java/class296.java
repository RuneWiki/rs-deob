...
public class class296 extends class450 {
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(Lup;)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(BLee;)Lrw;")
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(BLvfa;)V")
