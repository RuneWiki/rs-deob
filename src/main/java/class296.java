...
public class class296 extends class238 implements class231 {
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(ILqa;)Lin;", line = 5)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(IIILsm;)V", line = 21)
    public class296(int arg0, int arg1, int arg2, class238 arg3) {
        super(arg0, arg1, arg2, arg3.field3428, false, false);
        this.field4056 = arg3;
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BILqa;)Lr;", line = 41)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(BLqa;)V", line = 52)
    ...
    @OriginalMember(owner = "client!tc", name = "e", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lqa;IZIILco;I)V", line = 77)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILqa;)V", line = 88)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BLqa;)V", line = 114)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILqa;IB)Z", line = 124)
    public final boolean method171(int arg0, class208 arg1, int arg2, byte arg3) {
        field4060++;
        return arg3 <= 44;
    }

    @OriginalMember(owner = "client!tc", name = "e", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(B)Z", line = 160)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)I", line = 173)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)I", line = 184)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lqa;I)Lpl;", line = 194)
