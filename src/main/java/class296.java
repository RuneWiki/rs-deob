...
public class class296 extends class136 {
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "()V", line = 60)
    public class296() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IILiv;)V", line = 21)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BI)[[I", line = 63)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)[I", line = 136)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(B)V", line = 191)
