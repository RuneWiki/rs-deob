...
public class class296 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqi;ILjava/lang/String;)Lut;", line = 12)
    ...
    @OriginalMember(owner = "client!ut", name = "finalize", descriptor = "()V", line = 31)
    protected final void finalize() throws Throwable {
        this.field4090.method2667(this.field4092);
        super.finalize();
    }

    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lqi;II)V", line = 35)
