...
public class class296 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([BZII)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILwn;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BI)I", line = 177)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BII[Ljava/lang/Object;[J)V", line = 200)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lwn;I)V", line = 260)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)V", line = 280)
