...
public class class296 extends class90 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(CIIIZLpa;II)V")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lhr;Lfc;[Ldp;[I[I)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "([B[IIIIIIIIIIILpa;II)V")
    ...
    @OriginalMember(owner = "client!km", name = "HA", descriptor = "(CIIIZ)V")
