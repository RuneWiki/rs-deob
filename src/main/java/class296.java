...
public class class296 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lhp;ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IBLhp;)V", line = 53)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "([BI)Ljava/lang/String;", line = 122)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lhp;BLjava/lang/String;)I", line = 216)
