...
public class class296 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lwo;Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 85)
