...
public class class296 extends class115 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!za", name = "finalize", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!za", name = "<init>", descriptor = "(Lqa;Ljava/awt/Canvas;)V", line = 45)
    ...
    @OriginalMember(owner = "client!za", name = "b", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 65)
