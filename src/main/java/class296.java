...
public class class296 extends class366 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "([Ltn;IIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II)I", line = 661)
    public static final int method1826(int arg0, int arg1) {
        ++field4222;
        return arg1 != 2 ? -24 : arg0 >>> 7;
    }

    @OriginalMember(owner = "client!st", name = "c", descriptor = "(I)V", line = 674)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(B)V", line = 692)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILgo;B)V", line = 718)
    public final void method6(int arg0, class440 arg1, byte arg2) {
        ++field4227;
        int var4 = 4 % ((arg2 - 31) / 59);
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)Z", line = 734)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIB)V", line = 745)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lqg;)V", line = 755)
    ...
    @OriginalMember(owner = "client!st", name = "d", descriptor = "(I)V", line = 774)
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(B)V", line = 788)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZZ)V", line = 803)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZI)V", line = 813)
