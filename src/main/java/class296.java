...
public class class296 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lqm;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II[III)V", line = 165)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 200)
