...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!ub", name = "z", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!ub", name = "C", descriptor = "Lob;")
    private LinkList field833 = new LinkList(0);

    @OriginalMember(owner = "client!ub", name = "D", descriptor = "Lob;")
    private LinkList field834 = new LinkList(0);

    @OriginalMember(owner = "client!ub", name = "E", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!ub", name = "M", descriptor = "Lmb;")
    private OnDemandRequest field843;

    @OriginalMember(owner = "client!ub", name = "u", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lmb;I)V")
