...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!vb", name = "y", descriptor = "Lqb;")
    private DoublyLinkList field834 = new DoublyLinkList(2);

    @OriginalMember(owner = "client!vb", name = "z", descriptor = "Lpb;")
    private LinkList field835 = new LinkList((byte) -118);

    @OriginalMember(owner = "client!vb", name = "A", descriptor = "Lpb;")
    private LinkList field836 = new LinkList((byte) -118);

    @OriginalMember(owner = "client!vb", name = "B", descriptor = "Lpb;")
    private LinkList field837 = new LinkList((byte) -118);

    @OriginalMember(owner = "client!vb", name = "C", descriptor = "Lpb;")
    private LinkList field838 = new LinkList((byte) -118);

    @OriginalMember(owner = "client!vb", name = "D", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!vb", name = "K", descriptor = "Lnb;")
    private OnDemandRequest field846;

    @OriginalMember(owner = "client!vb", name = "t", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lyb;Lclient;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "()Lnb;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lnb;B)V")
