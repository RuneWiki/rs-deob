...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!vb", name = "w", descriptor = "Lqb;")
    private DoublyLinkList field832 = new DoublyLinkList(956);

    @OriginalMember(owner = "client!vb", name = "x", descriptor = "Lpb;")
    private LinkList field833 = new LinkList((byte) 9);

    @OriginalMember(owner = "client!vb", name = "y", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!vb", name = "I", descriptor = "Lnb;")
    private OnDemandRequest field844;

    @OriginalMember(owner = "client!vb", name = "r", descriptor = "Lclient;")
