...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!ub", name = "v", descriptor = "Lpb;")
    private DoublyLinkList field824 = new DoublyLinkList(9);

    @OriginalMember(owner = "client!ub", name = "w", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!ub", name = "I", descriptor = "Lmb;")
    private OnDemandRequest field837;

    @OriginalMember(owner = "client!ub", name = "q", descriptor = "Lclient;")
