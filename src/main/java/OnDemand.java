...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!vb", name = "r", descriptor = "Lqb;")
    private DoublyLinkList field803 = new DoublyLinkList(309);

    @OriginalMember(owner = "client!vb", name = "s", descriptor = "Lpb;")
    private LinkList field804 = new LinkList(-740);

    @OriginalMember(owner = "client!vb", name = "t", descriptor = "Lpb;")
    private LinkList field805 = new LinkList(-740);

    @OriginalMember(owner = "client!vb", name = "u", descriptor = "Lpb;")
    private LinkList field806 = new LinkList(-740);

    @OriginalMember(owner = "client!vb", name = "v", descriptor = "Lpb;")
    private LinkList field807 = new LinkList(-740);

    @OriginalMember(owner = "client!vb", name = "w", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!vb", name = "D", descriptor = "Lnb;")
    private OnDemandRequest field815;

    @OriginalMember(owner = "client!vb", name = "p", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lnb;Z)V")
