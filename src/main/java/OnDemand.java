...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!vb", name = "v", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!vb", name = "H", descriptor = "Lnb;")
    private OnDemandRequest field825;

    @OriginalMember(owner = "client!vb", name = "q", descriptor = "Lclient;")
