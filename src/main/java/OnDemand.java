...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!vb", name = "x", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!vb", name = "J", descriptor = "Lnb;")
    private OnDemandRequest field839;

    @OriginalMember(owner = "client!vb", name = "s", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lnb;I)V")
