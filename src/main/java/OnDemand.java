...
public class OnDemand extends OnDemandProvider implements Runnable {
    ...
    @OriginalMember(owner = "client!ub", name = "y", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!ub", name = "L", descriptor = "Lmb;")
    private OnDemandRequest field839;

    @OriginalMember(owner = "client!ub", name = "t", descriptor = "Lclient;")
