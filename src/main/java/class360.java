...
public class class360 extends class501 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lhg;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BFILta;Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Z)[Lrm;", line = 67)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lhg;Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IZI)Z", line = 99)
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILhg;)V", line = 240)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BI)V", line = 257)
