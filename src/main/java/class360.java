...
public class class360 extends class224 {
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "()Lll;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lag;Lqa;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lll;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "()Lll;")
    public final class224 method56() {
        return (class224) this.field4966.method653(73);
    }

    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Lll;)V")
