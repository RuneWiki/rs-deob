...
public class class360 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IBLbk;)V", line = 6)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)La;", line = 82)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Z", line = 108)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "(I)Loq;", line = 168)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILbk;)V", line = 229)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BIIIIII)V", line = 249)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)V", line = 283)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIZLjf;)V", line = 301)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)Lnn;", line = 324)
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "(I)Loq;", line = 343)
    ...
    @OriginalMember(owner = "client!cf", name = "e", descriptor = "(I)V", line = 407)
