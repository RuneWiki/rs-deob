...
public class class360 extends class467 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lns;II)Lvs;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lns;I)Lvs;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lns;)Z")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([I)Luq;")
    ...
    @OriginalMember(owner = "client!vs", name = "d", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "([B)V")
