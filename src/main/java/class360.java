...
public class class360 extends class266 {
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)Llk;")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ILng;)V")
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)Lre;")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lre;I)V")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lng;)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lje;III)V")
