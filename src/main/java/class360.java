...
public class class360 implements class160 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Z)J", line = 5)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)I", line = 35)
    public static final int method2117(int arg0) {
        field4652++;
        return arg0 == 0 ? 2 : -68;
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILs;)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/Object;BZ)[B", line = 103)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 148)
