...
public class class360 extends class791 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!hka", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hka", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 11)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!hka", name = "d", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Ljava/lang/String;IIILha;IBI)V", line = 67)
    ...
    @OriginalMember(owner = "client!hka", name = "e", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!hka", name = "c", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IIZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!hka", name = "b", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!hka", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 194)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 221)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(B)I", line = 235)
    ...
    @OriginalMember(owner = "client!hka", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 246)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Z)Z", line = 254)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IIBII)V", line = 271)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 293)
    ...
    @OriginalMember(owner = "client!hka", name = "d", descriptor = "(B)V", line = 328)
    ...
    @OriginalMember(owner = "client!hka", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 339)
    ...
    @OriginalMember(owner = "client!hka", name = "f", descriptor = "(I)Z", line = 369)
    ...
    @OriginalMember(owner = "client!hka", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 380)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(I)Lvha;", line = 390)
    ...
    @OriginalMember(owner = "client!hka", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 401)
    ...
    @OriginalMember(owner = "client!hka", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 441)
    ...
    @OriginalMember(owner = "client!hka", name = "b", descriptor = "(B)V", line = 420)
