...
public class class360 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILgh;IB)V", line = 30)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 47)
