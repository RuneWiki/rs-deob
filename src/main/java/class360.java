...
public class class360 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIILha;II)Lka;")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;ILtga;)Luga;")
