...
public abstract class class360 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(DI)V", line = 3)
    public static final void method2214(double arg0, int arg1) {
        field4917++;
        if (arg1 != -12327) {
            field4914 = null;
        }
        if (class155.field2540 == arg0) {
            return;
        }
        for (int var3 = 0; var3 < 256; var3++) {
            int var4 = (int) (Math.pow((double) var3 / 255.0D, arg0) * 255.0D);
            class198.field2999[var3] = var4 > 255 ? 255 : var4;
        }
        class155.field2540 = arg0;
    }
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(B)Ljava/net/Socket;", line = 47)
    public final Socket method2216(byte arg0) throws IOException {
        if (arg0 != 97) {
            this.field4918 = null;
        }
        field4916++;
        return new Socket(this.field4918, this.field4915);
    }

    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)Ljava/net/Socket;")
    public abstract Socket method912(byte arg0) throws IOException;
}
