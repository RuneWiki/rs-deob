...
public class class360 extends class5 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(B)Lega;", line = 63)
    ...
    @OriginalMember(owner = "client!vn", name = "i", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILes;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!vn", name = "j", descriptor = "(I)Z", line = 122)
