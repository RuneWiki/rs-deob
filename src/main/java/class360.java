...
public class class360 extends class488 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljp;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Ljp;IIIIIIIIIIIZZ)V")
