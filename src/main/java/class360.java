...
public abstract class class360 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(FIFI[BFFFLvaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)[Lwd;")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)Lqg;")
