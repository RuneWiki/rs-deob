...
public class class360 extends class388 {
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)Ljava/net/Socket;", line = 14)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZLjava/net/Proxy;)Ljava/net/Socket;", line = 86)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 109)
    ...
    @OriginalMember(owner = "client!nn", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 173)
