...
public class class360 extends class220 {
    ...
    @OriginalMember(owner = "client!ho", name = "d", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(II)[I", line = 43)
    ...
    @OriginalMember(owner = "client!ho", name = "f", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!ho", name = "g", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "()V", line = 149)
    public class360() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IBLil;)V", line = 155)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lro;B)Ljava/lang/String;", line = 244)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I[II)V", line = 276)
    ...
    @OriginalMember(owner = "client!ho", name = "h", descriptor = "(B)V", line = 438)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lg;Z)V", line = 451)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIBIIII)I", line = 486)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIII)V", line = 566)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIBIIII)V", line = 651)
