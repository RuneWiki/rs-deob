...
public class class360 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "()Lua;", line = 50)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "()[B", line = 57)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lct;II)Lfs;", line = 117)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lat;)V", line = 127)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 147)
    private class360() {
    }
}
