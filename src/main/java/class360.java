...
public class class360 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)Lgj;", line = 25)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 57)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BJ)Lgj;", line = 92)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(II)Z", line = 133)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(JILgj;)V", line = 148)
