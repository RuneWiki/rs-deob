...
public class class360 extends class298 {
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IZ)[I", line = 94)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 251)
    public class360() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIB)V", line = 187)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IILvt;)V", line = 200)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "(B)V", line = 254)
    ...
    @OriginalMember(owner = "client!qk", name = "f", descriptor = "(B)V", line = 272)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "([[II)V", line = 384)
