...
public class class360 extends class642 {
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(II)[I", line = 12)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILgk;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)[Lcw;", line = 87)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "()V", line = 101)
    public class360() {
        this(4096);
    }

    @OriginalMember(owner = "client!sb", name = "h", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZILjava/lang/Object;)[B", line = 121)
