...
public class class360 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILon;BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)Z", line = 316)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILrr;Z)V", line = 328)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Ltq;B)V", line = 399)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(B)I", line = 412)
    private final int method2318(byte arg0) {
        field5148++;
        return arg0 <= 19 ? 50 : this.field5150.method1947(0) + this.field5152.method1947(0);
    }

    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(Z)V", line = 423)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)V", line = 452)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(I)V", line = 468)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ZI)V", line = 485)
    ...
    @OriginalMember(owner = "client!qs", name = "d", descriptor = "(I)V", line = 515)
    ...
    @OriginalMember(owner = "client!qs", name = "e", descriptor = "(I)I", line = 547)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(B)V", line = 567)
    public static void method2325(byte arg0) {
        int var1 = 19 / ((arg0 - 18) / 54);
        field5138 = null;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IBZZI)Lqb;", line = 576)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(Z)Z", line = 618)
    ...
    @OriginalMember(owner = "client!qs", name = "f", descriptor = "(I)V", line = 629)
