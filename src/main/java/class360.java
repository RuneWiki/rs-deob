...
public class class360 extends Exception {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ldu;[[BI)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lla;Ld;B)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZBII)Lla;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIILjava/lang/Class;)Ljf;")
