...
public class class360 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLbj;)I", line = 73)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 87)
    public static void method2245(int arg0) {
        field5050 = null;
        int var1 = -38 / ((arg0 - 24) / 40);
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)I", line = 101)
