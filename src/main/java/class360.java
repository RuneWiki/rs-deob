...
public class class360 extends class263 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lri;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lwh;ILir;)V", line = 37)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZLde;Ljava/lang/String;ZB)V", line = 53)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(II)[[I", line = 117)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IC)Z", line = 163)
    ...
    @OriginalMember(owner = "client!fk", name = "e", descriptor = "(B)V", line = 197)
