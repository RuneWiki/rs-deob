...
public class class360 extends class264 {
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(ILmfa;)V", line = 5)
    public class360(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lmfa;)V", line = 66)
    public class360(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B)I", line = 50)
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BI)I", line = 84)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Liw;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BZ)V", line = 170)
