...
public class class360 extends class38 implements class511 {
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lrl;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lrl;I[BIZ)V")
