...
public class class360 extends class381 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IBII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(III[I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IZI)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(III[I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(IIIIIIIII)V", line = 144)
