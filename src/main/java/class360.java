...
public abstract class class360 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILjava/lang/String;)I", line = 8)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(FIIIIIZII)[[I", line = 54)
