...
public class class360 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lpd;I)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lpd;)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lwt;II)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lmo;I)V")
