...
public class class360 extends class180 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lfc;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!k", name = "c", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "([B)V", line = 49)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "([B)V", line = 204)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "()I", line = 249)
    ...
    @OriginalMember(owner = "client!k", name = "d", descriptor = "(I)F", line = 261)
    ...
    @OriginalMember(owner = "client!k", name = "e", descriptor = "(I)[F", line = 272)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "([BI)V", line = 685)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lfc;II)Lk;", line = 695)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "([I)Lcu;", line = 713)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "()V", line = 777)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "([B)V", line = 803)
