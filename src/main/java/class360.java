...
public class class360 extends class315 {
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(III)Lwr;", line = 40)
