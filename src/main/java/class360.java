...
public class class360 extends class330 {
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "()V", line = 3)
    public class360() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IB)[I", line = 26)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IZ)[I", line = 45)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ZB)V", line = 98)
    ...
    @OriginalMember(owner = "client!oba", name = "e", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Lgga;IB)V", line = 345)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIIII[BI)V", line = 378)
    ...
    @OriginalMember(owner = "client!oba", name = "d", descriptor = "(B)V", line = 479)
