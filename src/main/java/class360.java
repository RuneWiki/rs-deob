...
public class class360 extends class747 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZI)V", line = 11)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 55)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(Z)V", line = 165)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(II)[[I", line = 180)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "()V", line = 278)
    public class360() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ldc;II)V", line = 228)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)[I", line = 284)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZB)V", line = 319)
