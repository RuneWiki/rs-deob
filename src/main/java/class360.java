...
public class class360 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(JB)Lpb;", line = 7)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BII)I", line = 70)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(I)I", line = 125)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(II)Z", line = 136)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(B)Lpb;", line = 160)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "([Lpb;Z)I", line = 199)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ILpb;J)V", line = 232)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)Lpb;", line = 251)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ILkn;)V", line = 265)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(Z)Lpb;", line = 370)
    ...
    @OriginalMember(owner = "client!du", name = "c", descriptor = "(B)I", line = 405)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "([II[ILfha;[I)V", line = 441)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(I)V", line = 540)
