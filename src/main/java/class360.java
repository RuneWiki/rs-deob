...
public class class360 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lad;B)I", line = 24)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "([I[I[BI[[BII[[B)I", line = 138)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II[IZILkd;)Loi;", line = 195)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIZI)Ldn;", line = 216)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 232)
