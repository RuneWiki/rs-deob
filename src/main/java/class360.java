...
public class class360 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZI)Lwj;", line = 5)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IBLgj;IIFII[BFFFFI)V", line = 24)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZZLjava/lang/String;)V", line = 75)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(IIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BII)V", line = 117)
