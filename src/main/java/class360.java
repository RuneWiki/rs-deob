...
public class class360 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IZ)Lit;", line = 9)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIBII)V", line = 91)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIB)B", line = 106)
