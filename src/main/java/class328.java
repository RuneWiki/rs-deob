...
public class class328 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(CLjava/lang/String;Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IZII)V", line = 31)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IIIIB)V", line = 75)
