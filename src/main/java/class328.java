...
public class class328 extends class568 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILwq;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILwl;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lwq;)V")
