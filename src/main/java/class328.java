...
public class class328 extends class261 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BILlt;)I", line = 6)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lph;IIZIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 64)
