...
public class class328 extends class201 {
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(B)J", line = 23)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BJ)I", line = 55)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)J", line = 89)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 117)
    public class328() {
