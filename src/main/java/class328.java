...
public class class328 implements class221 {
    ...
    @OriginalMember(owner = "client!cq", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4140++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(JIBI)V", line = 14)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIII)Lbf;", line = 59)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZIIILma;ILhd;Lya;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)V", line = 228)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 260)
