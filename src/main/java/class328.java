...
public class class328 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lnd;Lli;IIZLae;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)I", line = 240)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "([I)V", line = 257)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(II)I", line = 292)
