...
public class class328 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(Z)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B[BII)[B", line = 56)
