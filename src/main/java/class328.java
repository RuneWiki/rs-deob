...
public class class328 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lla;BLd;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lbfa;B)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILraa;)Lraa;")
