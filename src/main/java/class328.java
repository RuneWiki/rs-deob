...
public class class328 extends class361 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IJ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIBI)I", line = 70)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 113)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lsd;Llm;)V", line = 149)
