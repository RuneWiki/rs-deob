...
public abstract class class328 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZI)Z", line = 21)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)Z", line = 78)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Z)Z", line = 100)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIII)V", line = 111)
