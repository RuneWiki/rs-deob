...
public class class328 implements class681 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZ)Lra;", line = 3)
    public static final class757 method2017(int arg0, boolean arg1) {
        field4450++;
        return new class757(arg0, arg1);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)Lwea;", line = 24)
    public final class115 method2019(int arg0) {
        field4447++;
        return arg0 == 10251 ? class115.field1600 : null;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)I", line = 35)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lla;Ljava/lang/String;)V", line = 68)
