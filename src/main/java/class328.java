...
public class class328 extends class111 {
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lvq;[Lhq;Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "()Lrm;", line = 86)
    public final class235 method2152() {
        return this.field4763;
    }

    @OriginalMember(owner = "client!nl", name = "b", descriptor = "()V", line = 89)
    public final void method2153() {
        this.field4762 = true;
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lvq;J[Lhq;[Lrl;Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "()V", line = 105)
    public final void method2155() {
        this.field4754 = true;
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(J)V", line = 115)
    public final void method2156(long arg0) {
        this.field4752 = arg0;
    }

    @OriginalMember(owner = "client!nl", name = "d", descriptor = "()V", line = 119)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!nl", name = "e", descriptor = "()V", line = 148)
    public static void method2158() {
        field4751 = null;
        field4750 = null;
    }

    @OriginalMember(owner = "client!nl", name = "f", descriptor = "()V", line = 152)
    private final void method2159() {
        this.field4754 = false;
    }

    @OriginalMember(owner = "client!nl", name = "g", descriptor = "()V", line = 158)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lvq;J)Z", line = 174)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "([Lrl;Z)V", line = 224)
