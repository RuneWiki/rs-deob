...
public class class328 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([BI)Z", line = 53)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)V", line = 101)
