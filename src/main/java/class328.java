...
public abstract class class328 extends class674 {
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oq", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!oq", name = "e", descriptor = "(I)[Lhm;", line = 46)
