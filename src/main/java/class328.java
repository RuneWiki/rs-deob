...
public class class328 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lvg;ZIILr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIIIIIII)Z", line = 311)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(III)Z", line = 332)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 356)
