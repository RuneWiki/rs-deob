...
public class class328 extends class588 implements class612 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(FZ)F", line = 25)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IF)F", line = 36)
    ...
    @OriginalMember(owner = "client!ir", name = "d", descriptor = "(I)I", line = 46)
    public final int method417(int arg0) {
        return arg0 == 7782 ? this.field4556 : 38;
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BLtn;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Loe;Ljb;IIZ[BII)V", line = 65)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)Z", line = 125)
    public final boolean method419(int arg0) {
        int var2 = -92 / ((19 - arg0) / 40);
        return true;
    }

    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Loe;Ljb;Lqda;II)V", line = 132)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "([BIIIIIIILjb;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Loe;IIZ[III)V", line = 194)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIIII[III)V", line = 253)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)I", line = 303)
