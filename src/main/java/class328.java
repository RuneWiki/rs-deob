...
public class class328 implements class231 {
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)Liaa;", line = 31)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lbi;)V", line = 52)
