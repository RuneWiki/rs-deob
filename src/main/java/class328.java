...
public class class328 extends class252 {
    ...
    @OriginalMember(owner = "client!ir", name = "i", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!ir", name = "h", descriptor = "(I)J", line = 58)
    ...
    @OriginalMember(owner = "client!ir", name = "j", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(Z)I", line = 186)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "([BIBI)Ljava/lang/String;", line = 233)
