...
public class class328 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ld;IILwm;IZLd;Loa;IIBZII)Lba;", line = 13)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BLdga;)V", line = 133)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIIILoa;Lwm;I)Lba;", line = 184)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ZLdga;)Ljava/lang/String;", line = 195)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIBLwm;ILoa;I)Lba;", line = 206)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILwm;ZIIILd;IILd;Loa;II)Lba;", line = 218)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILdga;I)V", line = 230)
