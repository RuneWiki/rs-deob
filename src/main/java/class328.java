...
public abstract class class328 extends class108 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(III)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)[I", line = 36)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lgp;Lgp;I)I", line = 95)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIB)[I", line = 136)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(IZ)V", line = 196)
    public class328(int arg0, boolean arg1) {
        this.field4728 = arg1;
        this.field4727 = new class328[arg0];
    }

    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(II)[[I", line = 209)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(BILco;)V", line = 220)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)I", line = 232)
