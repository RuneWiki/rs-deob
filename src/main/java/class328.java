...
public class class328 extends class177 implements class258 {
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!saa", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(ILha;)Ljda;")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lha;IZLga;IBI)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lha;Liv;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(Lha;I)Lhw;")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(ILha;)V")
