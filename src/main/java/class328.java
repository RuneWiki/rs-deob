...
public class class328 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Lha;ZIILvp;Lda;IIZLha;II)Lhh;", line = 18)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(II)Lak;", line = 85)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(ZZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(II)V", line = 185)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!kka", name = "c", descriptor = "(II)V", line = 225)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 239)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(B)V", line = 288)
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Z)V", line = 331)
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(III)Z", line = 352)
    ...
    @OriginalMember(owner = "client!kka", name = "<init>", descriptor = "(Lkw;IZLte;Luq;Luq;)V", line = 416)
    ...
    @OriginalMember(owner = "client!kka", name = "c", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(IIIBLha;IILvp;)Lhh;", line = 391)
