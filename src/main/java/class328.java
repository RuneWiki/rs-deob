...
public class class328 extends class56 {
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lbv;Lre;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lbp;B)I")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIIIIZIIILwq;)Z")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILkv;)V")
