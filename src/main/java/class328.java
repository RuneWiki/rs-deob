...
public class class328 {
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lhj;II)V", line = 14)
    private class328(class338 arg0, int arg1, int arg2) {
        this.field4477 = arg0;
        this.field4476 = arg2;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lhj;ILjava/lang/String;)Lii;", line = 22)
