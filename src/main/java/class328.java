...
public class class328 extends class372 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I[BII)I", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 247)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)Z", line = 259)
    ...
    @OriginalMember(owner = "client!ss", name = "finalize", descriptor = "()V", line = 270)
    protected final void finalize() {
        this.method2155(false);
        field4968++;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III[B)V", line = 281)
