...
public abstract class class328 extends class61 {
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(Llc;ILjava/awt/Frame;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(BILjava/awt/Canvas;Ld;Lbt;)Lha;", line = 31)
    ...
    @OriginalMember(owner = "client!qja", name = "g", descriptor = "(I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(Lha;B)Z", line = 78)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(ILha;ILkq;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(B[Lkp;)I", line = 401)
    ...
    @OriginalMember(owner = "client!qja", name = "<init>", descriptor = "(IIIIII)V", line = 413)
    ...
    @OriginalMember(owner = "client!qja", name = "e", descriptor = "(B)Z", line = 426)
