...
public class class328 extends class386 {
    ...
    @OriginalMember(owner = "client!ws", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IBLun;)V", line = 31)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "()V", line = 46)
    public class328() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(FFBF)I", line = 51)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)[I", line = 96)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lub;)V", line = 150)
    ...
    @OriginalMember(owner = "client!ws", name = "f", descriptor = "(I)V", line = 212)
