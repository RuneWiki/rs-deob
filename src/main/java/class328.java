...
public class class328 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIIILqa;III)V", line = 21)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(I[Lkk;IIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lqa;IB)Z", line = 136)
