...
public class class328 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(ILwca;)V")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(II)Lwca;")
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "(Lwca;)V")
