...
public abstract class class328 implements class479 {
    ...
    @OriginalMember(owner = "client!wt", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I[FIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(I)I", line = 161)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 258)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "([IIBII)V", line = 287)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZLli;)V", line = 397)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IZ)V", line = 416)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZZILjava/lang/String;)V", line = 429)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(B)I", line = 1424)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "([BIIBI)V", line = 1437)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lrda;ILeu;Lpj;IZ)V", line = 1536)
