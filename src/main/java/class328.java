...
public class class328 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IILtq;)V", line = 47)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILtq;)V", line = 286)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)Z", line = 310)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIIIII)V", line = 434)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 575)
