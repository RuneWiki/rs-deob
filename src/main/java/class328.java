...
public class class328 extends class152 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lqq;)Luk;", line = 5)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
