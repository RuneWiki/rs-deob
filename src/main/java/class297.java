...
public class class297 extends class435 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lwm;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I[Ljava/lang/String;BI)Ljava/lang/String;", line = 68)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 130)
