...
public class class297 extends class651 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIZZI)I", line = 13)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lha;III)Z", line = 55)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILlga;ILd;Ljava/awt/Canvas;)Lha;", line = 91)
