...
public class class297 implements Runnable {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIIZLqj;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZLmb;)V", line = 152)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(III)I", line = 169)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Z)V", line = 190)
