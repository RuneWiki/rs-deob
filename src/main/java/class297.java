...
public class class297 extends class371 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IBLps;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BI)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lqa;ILch;)I", line = 61)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILqa;)V", line = 86)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "()V", line = 101)
    public class297() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(BI)[I", line = 112)
    ...
    @OriginalMember(owner = "client!hl", name = "g", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(III)V", line = 168)
