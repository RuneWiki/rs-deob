...
public class class297 extends class183 implements class116 {
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Z)I", line = 35)
    public final int method16(boolean arg0) {
        ++field4408;
        return arg0 ? 20 : 65535 & this.field4420;
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILoj;II)Z", line = 47)
    ...
    @OriginalMember(owner = "client!wl", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!wl", name = "g", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILoj;B)Lqh;", line = 100)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)I", line = 111)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILoj;I)Lqh;", line = 122)
    ...
    @OriginalMember(owner = "client!wl", name = "d", descriptor = "(ILoj;)V", line = 143)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ZLoj;ZI)Lpr;", line = 153)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILoj;)V", line = 185)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)Z", line = 213)
    ...
    @OriginalMember(owner = "client!wl", name = "c", descriptor = "(ILoj;)Lmg;", line = 225)
    ...
    @OriginalMember(owner = "client!wl", name = "h", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(ILoj;)V", line = 409)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Loj;Lcu;IIIIZIIIII)V", line = 436)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILgn;)V", line = 467)
