...
public abstract class class297 {
    ...
    @OriginalMember(owner = "client!ho", name = "finalize", descriptor = "()V", line = 12)
    protected final void finalize() throws Throwable {
        this.field3955.method2050(this.field3957, this.field3954);
        super.finalize();
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "()I", line = 35)
    public int method49() {
        return this.field3957;
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lh;I[BIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lh;ILjava/nio/ByteBuffer;Z)V", line = 57)
