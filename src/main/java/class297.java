...
public class class297 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BI)Lol;", line = 7)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IILwq;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(IIII)V", line = 98)
