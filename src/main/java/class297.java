...
public class class297 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIILeb;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)Ldb;")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lmt;ILhh;Lhh;)V")
