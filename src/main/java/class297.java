...
public class class297 {
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(II)Lwba;")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILwba;)V")
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lwba;)V")
