...
public class class297 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BI)Lhe;", line = 4)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lwv;ILqs;Lqs;)V", line = 104)
