...
public class class297 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILnh;Z)Z")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILwq;I)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIILwq;)V")
