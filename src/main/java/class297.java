...
public class class297 extends class538 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILjava/lang/String;Ljava/io/File;)V")
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Lcb;IIIIII)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)Lwv;")
