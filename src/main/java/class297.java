...
public class class297 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIILuj;Luj;)V", line = 7)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIZLas;IIIIII)Z", line = 27)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILfo;B)Lgf;", line = 274)
