...
public class class297 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(CI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZI)V", line = 46)
