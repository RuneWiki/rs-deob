...
public class class297 extends class96 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IILbt;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "()V", line = 157)
    public class297() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(II)[I", line = 86)
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!ao", name = "g", descriptor = "(I)V", line = 229)
