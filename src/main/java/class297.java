...
public class class297 extends class270 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Ljo;)Z")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Ljo;II)Lofa;")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Ljo;I)Lofa;")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "([I)Lwb;")
