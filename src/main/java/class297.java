...
public class class297 extends class664 implements class595 {
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Lmc;Lnl;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Lnl;IB[BIIIII)V")
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Lmc;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Lmc;Lnl;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([FIIIIIILnl;Z)V")
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Lmc;Lnl;Leea;II)V")
