...
public class class297 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(II)Lch;", line = 48)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lsca;ILaa;IIILjava/lang/String;Lda;ILhia;BI)V", line = 96)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lwu;Ld;)V", line = 148)
