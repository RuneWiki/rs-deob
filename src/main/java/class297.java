...
public class class297 extends class499 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B[BI)[B", line = 12)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(B)V", line = 36)
    public static void method1705(byte arg0) {
        field4104 = null;
        int var1 = 101 % ((32 - arg0) / 62);
    }

    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(I[B)V", line = 44)
