...
public class class297 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I[Ll;Ljava/lang/String;II)I", line = 10)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BLjava/lang/String;I[Ll;)Ljava/lang/String;", line = 29)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/lang/String;BI[Ll;)I", line = 156)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(CI)C", line = 171)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/lang/String;[Ll;I[I[Ljava/lang/String;)I", line = 575)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)I", line = 827)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ICI)I", line = 838)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZLjava/lang/String;[Ll;)I", line = 853)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 957)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZZ)Z", line = 967)
    public static boolean method1753(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIIII)V", line = 976)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILjava/lang/String;[Ll;)I", line = 1059)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 1087)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BLjava/lang/String;)I", line = 1163)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "([B)V", line = 1172)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(II)I", line = 1295)
