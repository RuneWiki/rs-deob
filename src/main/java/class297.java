...
public class class297 extends class113 {
    ...
    @OriginalMember(owner = "client!kd", name = "f", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!kd", name = "g", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 46)
