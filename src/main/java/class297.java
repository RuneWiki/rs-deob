...
public class class297 extends class513 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "()V", line = 86)
    public class297() {
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lvda;BLvda;)V", line = 97)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(J)V", line = 112)
    public class297(long arg0) {
        this.field3998 = arg0;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)V", line = 121)
