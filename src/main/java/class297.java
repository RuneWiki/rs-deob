...
public class class297 extends class466 {
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "()V", line = 101)
    public class297() {
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(II)I", line = 52)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)J", line = 92)
