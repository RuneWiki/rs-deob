...
public class class297 extends class753 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIILjava/awt/Canvas;)V", line = 11)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ljava/awt/Graphics;IBIIIII)V", line = 33)
