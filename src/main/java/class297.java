...
public class class297 {
    ...
    @OriginalMember(owner = "client!st", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field4259++;
        return "Cache:" + this.field4265;
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(ILlq;Llq;I)V", line = 315)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(CI)C", line = 44)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II)[B", line = 72)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "([BZII)Z", line = 159)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II[BIZ)Z", line = 192)
