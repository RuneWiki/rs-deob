...
public class class297 extends class46 {
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZII)V", line = 27)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)V", line = 89)
