...
public abstract class class297 extends class86 {
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(B)I", line = 9)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILqs;Leq;Lwd;)V", line = 36)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 193)
