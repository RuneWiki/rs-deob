...
public class class297 extends class115 {
    ...
    @OriginalMember(owner = "client!qj", name = "e", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!qj", name = "h", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BLbk;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!qj", name = "f", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lbk;I)Ljava/lang/String;", line = 90)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)[[I", line = 101)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "()V", line = 191)
    public class297() {
        super(0, false);
    }
}
