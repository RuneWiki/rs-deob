...
public class class297 implements class281 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lig;I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([II[III)V", line = 80)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)Lcd;", line = 141)
