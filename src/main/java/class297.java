...
public abstract class class297 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lvm;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljava/lang/String;IZI)I", line = 23)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIII)V", line = 118)
