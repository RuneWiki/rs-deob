...
public class class297 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lfp;Ljava/lang/String;IIIZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "()I", line = 29)
    public final int method1975() {
        return this.field4325 - 1;
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lfp;IZLjava/awt/Component;)V", line = 173)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lfp;Ljava/lang/String;[IIIIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lfp;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljava/lang/String;)I", line = 156)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "()I", line = 216)
