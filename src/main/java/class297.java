...
public class class297 {
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lda;)V", line = 158)
    public class297(class400 arg0) {
        this.field4059 = arg0;
    }

    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lda;Lqt;)V", line = 165)
    public class297(class400 arg0, class502 arg1) {
        this.field4059 = arg0;
        this.field4061 = arg1;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)[B", line = 28)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ljw;Z[[[BIB)Z", line = 76)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)Z", line = 139)
