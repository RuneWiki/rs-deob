...
public class class297 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lnq;IIBII)Lre;")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(II)Lvs;")
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lpt;ILum;)V")
