...
public class class297 extends class6 {
    ...
    @OriginalMember(owner = "client!ss", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLsi;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILsi;)V", line = 82)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III)I", line = 102)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IBI)I", line = 124)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 143)
