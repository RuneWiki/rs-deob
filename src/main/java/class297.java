...
public class class297 extends class346 {
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZIIBI)Lnn;", line = 119)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "()V", line = 178)
    public class297() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lfb;ZI)V", line = 204)
