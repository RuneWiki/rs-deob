...
public class class297 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I[BIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BLes;)Lew;", line = 49)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)V", line = 66)
