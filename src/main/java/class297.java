...
public class class297 extends class296 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIZIIIIII)Z", line = 21)
    ...
    @OriginalMember(owner = "client!vca", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIIIIII[[Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(III[[ZZII)V", line = 243)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 255)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIII[[ZBZI)V", line = 354)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(III[[ZZI)V", line = 499)
    ...
    @OriginalMember(owner = "client!vca", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 508)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(II)V", line = 588)
    public final void method1903(int arg0, int arg1) {
        ++field4065;
    }

    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIILvg;)V", line = 599)
    ...
    @OriginalMember(owner = "client!vca", name = "fa", descriptor = "(IILr;)Lr;", line = 659)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 690)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lbq;[I)V", line = 709)
    ...
    @OriginalMember(owner = "client!vca", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 724)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lhk;IIII[[I[[II)V", line = 744)
    ...
    @OriginalMember(owner = "client!vca", name = "YA", descriptor = "()V", line = 800)
    ...
    @OriginalMember(owner = "client!vca", name = "ka", descriptor = "(III)V", line = 1392)
