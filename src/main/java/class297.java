...
public class class297 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Ljp;)V", line = 7)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(Ljp;)V", line = 23)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "()V", line = 48)
    public class297() {
        this.field4306[0] = 0;
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "()V", line = 59)
