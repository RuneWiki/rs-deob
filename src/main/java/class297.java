...
public class class297 extends class24 implements class294 {
    ...
    @OriginalMember(owner = "client!q", name = "oa", descriptor = "(III)V", line = 4)
    public final void method153(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILta;II)V", line = 12)
    public final void method166(int arg0, int arg1, class144 arg2, int arg3, int arg4) {
        this.method1916(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!q", name = "finalize", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!q", name = "XA", descriptor = "(IIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(FFFFFFLta;II)V", line = 36)
