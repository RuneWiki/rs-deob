...
public class class297 {
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IIIIILkp;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(III)Z", line = 276)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(BI)V", line = 287)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(B)V", line = 315)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 332)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ZI)Lnl;", line = 347)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IIIIILnn;)Liaa;", line = 382)
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 416)
