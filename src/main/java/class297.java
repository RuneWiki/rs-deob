...
public class class297 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "([I)V", line = 18)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(II)I", line = 58)
