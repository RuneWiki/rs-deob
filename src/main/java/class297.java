...
public class class297 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)[B", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BII)I", line = 52)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 70)
    public static void method1884(byte arg0) {
        int var1 = 115 / ((arg0 - 4) / 49);
        field4228 = null;
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIIBI)V", line = 85)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lqa;B)V", line = 169)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(BIIIII)V", line = 193)
