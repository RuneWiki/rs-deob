...
public class class297 extends class573 {
    ...
    @OriginalMember(owner = "client!qn", name = "e", descriptor = "(I)[Ljn;", line = 6)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lrl;II[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lrl;II[I)V", line = 42)
