...
public class class297 extends class48 implements class9 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lae;ZI)Lbk;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILfi;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lae;BI)Lbk;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lae;Ljh;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lae;IZI)Lsk;")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ltq;ILjava/lang/String;Z)Lns;")
