...
@OriginalClass("client!FRNMNGGN")
public class class17 extends class20 implements Runnable {

    @OriginalMember(owner = "client!FRNMNGGN", name = "b", descriptor = "[B")
    private byte[] field693 = new byte[500];

    @OriginalMember(owner = "client!FRNMNGGN", name = "e", descriptor = "LSWVPDERM;")
    private class56 field696 = new class56(306);

    @OriginalMember(owner = "client!FRNMNGGN", name = "f", descriptor = "I")
    private int field697 = 2;

    @OriginalMember(owner = "client!FRNMNGGN", name = "i", descriptor = "Z")
    private boolean field700 = true;

    @OriginalMember(owner = "client!FRNMNGGN", name = "j", descriptor = "Z")
    private boolean field701 = false;

    @OriginalMember(owner = "client!FRNMNGGN", name = "k", descriptor = "[B")
    private byte[] field702 = new byte[65000];

    @OriginalMember(owner = "client!FRNMNGGN", name = "n", descriptor = "[[I")
    private int[][] field705 = new int[4][];

    @OriginalMember(owner = "client!FRNMNGGN", name = "p", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field707 = new CRC32();

    @OriginalMember(owner = "client!FRNMNGGN", name = "q", descriptor = "Ljava/lang/String;")
    public String field708 = "";

    @OriginalMember(owner = "client!FRNMNGGN", name = "s", descriptor = "LSWVPDERM;")
    private class56 field710 = new class56(306);

    @OriginalMember(owner = "client!FRNMNGGN", name = "t", descriptor = "Z")
    private boolean field711 = true;

    @OriginalMember(owner = "client!FRNMNGGN", name = "A", descriptor = "Z")
    private boolean field718 = true;

    @OriginalMember(owner = "client!FRNMNGGN", name = "B", descriptor = "LJCEXAOBP;")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "I", descriptor = "I")
    private int field726 = -777;

    @OriginalMember(owner = "client!FRNMNGGN", name = "N", descriptor = "LSWVPDERM;")
    private class56 field731 = new class56(306);

    @OriginalMember(owner = "client!FRNMNGGN", name = "O", descriptor = "[[B")
    private byte[][] field732 = new byte[4][];

    @OriginalMember(owner = "client!FRNMNGGN", name = "R", descriptor = "LSWVPDERM;")
    private class56 field735 = new class56(306);

    @OriginalMember(owner = "client!FRNMNGGN", name = "T", descriptor = "Z")
    private boolean field737 = true;

    @OriginalMember(owner = "client!FRNMNGGN", name = "h", descriptor = "I")
    private static int field699 = 8;

    @OriginalMember(owner = "client!FRNMNGGN", name = "g", descriptor = "I")
    private int field698;

    @OriginalMember(owner = "client!FRNMNGGN", name = "m", descriptor = "I")
    private int field704;

    @OriginalMember(owner = "client!FRNMNGGN", name = "u", descriptor = "I")
    private int field712;

    @OriginalMember(owner = "client!FRNMNGGN", name = "v", descriptor = "I")
    private int field713;

    @OriginalMember(owner = "client!FRNMNGGN", name = "C", descriptor = "I")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "K", descriptor = "I")
    public int field728;

    @OriginalMember(owner = "client!FRNMNGGN", name = "L", descriptor = "I")
    private int field729;

    @OriginalMember(owner = "client!FRNMNGGN", name = "P", descriptor = "I")
    private int field733;

    @OriginalMember(owner = "client!FRNMNGGN", name = "Q", descriptor = "I")
    private int field734;

    @OriginalMember(owner = "client!FRNMNGGN", name = "w", descriptor = "J")
    private long field714;

    @OriginalMember(owner = "client!FRNMNGGN", name = "z", descriptor = "LEGGOGKSD;")
    private class9 field717;

    @OriginalMember(owner = "client!FRNMNGGN", name = "S", descriptor = "Lclient;")
    private client field736;

    @OriginalMember(owner = "client!FRNMNGGN", name = "r", descriptor = "Ljava/io/InputStream;")
    private InputStream field709;

    @OriginalMember(owner = "client!FRNMNGGN", name = "y", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field716;

    @OriginalMember(owner = "client!FRNMNGGN", name = "x", descriptor = "Ljava/net/Socket;")
    private Socket field715;

    @OriginalMember(owner = "client!FRNMNGGN", name = "c", descriptor = "[B")
    private byte[] field694;

    @OriginalMember(owner = "client!FRNMNGGN", name = "d", descriptor = "[I")
    private int[] field695;

    @OriginalMember(owner = "client!FRNMNGGN", name = "l", descriptor = "[I")
    private int[] field703;

    @OriginalMember(owner = "client!FRNMNGGN", name = "o", descriptor = "[I")
    private int[] field706;

    @OriginalMember(owner = "client!FRNMNGGN", name = "D", descriptor = "[I")
    private int[] field721;

    @OriginalMember(owner = "client!FRNMNGGN", name = "J", descriptor = "[I")
    private int[] field727;

    @OriginalMember(owner = "client!FRNMNGGN", name = "M", descriptor = "[I")
    private int[] field730;

    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(II)I")
    public final int method216(int arg0, int arg1) {
        int var3 = 97 / arg0;
        return this.field705[arg1].length;
    }

    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(IBII)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(ZI)Z")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(BI[BI)Z")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(LFIGUVTWB;Lclient;)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "b", descriptor = "(Z)I")
    public final int method226(boolean arg0) {
        return arg0 ? field699 : this.field695.length;
    }

    @OriginalMember(owner = "client!FRNMNGGN", name = "b", descriptor = "()V")
    public final void method227() {
        this.field718 = false;
    }

    @OriginalMember(owner = "client!FRNMNGGN", name = "c", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "d", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(BLEGGOGKSD;)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "c", descriptor = "()LEGGOGKSD;")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(ZZ)V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(I)V")
    public final void method235(int arg0) {
        this.method229(0, arg0);
    }

    @OriginalMember(owner = "client!FRNMNGGN", name = "a", descriptor = "(IIZI)I")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!FRNMNGGN", name = "c", descriptor = "(I)V")
