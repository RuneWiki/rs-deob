...
public class class17 extends class567 {
    ...
    @OriginalMember(owner = "client!kh", name = "g", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 22)
    ...
    @OriginalMember(owner = "client!kh", name = "f", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(III)Z", line = 140)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IB)[[I", line = 150)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)V", line = 198)
