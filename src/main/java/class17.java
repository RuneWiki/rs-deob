...
@OriginalClass("client!FPSNPMMW")
public class class17 {

    @OriginalMember(owner = "client!FPSNPMMW", name = "a", descriptor = "B")
    private byte field723 = 55;

    @OriginalMember(owner = "client!FPSNPMMW", name = "f", descriptor = "I")
    public int field728 = -1;

    @OriginalMember(owner = "client!FPSNPMMW", name = "h", descriptor = "[I")
    public int[] field730 = new int[6];

    @OriginalMember(owner = "client!FPSNPMMW", name = "i", descriptor = "[I")
    public int[] field731 = new int[6];

    @OriginalMember(owner = "client!FPSNPMMW", name = "j", descriptor = "I")
    public int field732 = 128;

    @OriginalMember(owner = "client!FPSNPMMW", name = "k", descriptor = "I")
    public int field733 = 128;

    @OriginalMember(owner = "client!FPSNPMMW", name = "o", descriptor = "LGOPFMRDJ;")
    public static class22 field737 = new class22(639, 30);

    @OriginalMember(owner = "client!FPSNPMMW", name = "b", descriptor = "I")
    public static int field724;

    @OriginalMember(owner = "client!FPSNPMMW", name = "d", descriptor = "I")
    public int field726;

    @OriginalMember(owner = "client!FPSNPMMW", name = "e", descriptor = "I")
    public int field727;

    @OriginalMember(owner = "client!FPSNPMMW", name = "l", descriptor = "I")
    public int field734;

    @OriginalMember(owner = "client!FPSNPMMW", name = "m", descriptor = "I")
    public int field735;

    @OriginalMember(owner = "client!FPSNPMMW", name = "n", descriptor = "I")
    public int field736;

    @OriginalMember(owner = "client!FPSNPMMW", name = "g", descriptor = "LHZCWGKOF;")
    public class24 field729;

    @OriginalMember(owner = "client!FPSNPMMW", name = "c", descriptor = "[LFPSNPMMW;")
    public static class17[] field725;

    @OriginalMember(owner = "client!FPSNPMMW", name = "a", descriptor = "(ZLXMRRKSSB;)V")
    ...
    @OriginalMember(owner = "client!FPSNPMMW", name = "a", descriptor = "(LXQPFGONL;I)V")
    ...
    @OriginalMember(owner = "client!FPSNPMMW", name = "a", descriptor = "()LITSMSHJO;")
