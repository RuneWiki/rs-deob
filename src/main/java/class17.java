...
public class class17 implements Runnable {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Ljj;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BILwo;)Ljj;", line = 40)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IILwo;)Ljj;", line = 122)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lft;)V", line = 199)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(II[BLwo;)Ljj;", line = 175)
