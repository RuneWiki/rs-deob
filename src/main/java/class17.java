...
public class class17 extends class249 {
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(II)I", line = 6)
    public static int method121(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BLjava/lang/String;)I", line = 27)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 69)
