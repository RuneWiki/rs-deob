...
public class class17 extends class76 implements class161 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lza;Lii;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lza;IIILps;IZ)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lza;IZ)Le;")
