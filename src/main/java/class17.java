...
public class class17 extends class439 {
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)Lsv;", line = 92)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(ILcc;Lcc;Llfa;Lde;I[BIZ)V", line = 815)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Z)I", line = 438)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(II)[B", line = 455)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(B)V", line = 471)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IZI)Lgq;", line = 493)
    ...
    @OriginalMember(owner = "client!n", name = "d", descriptor = "(B)I", line = 758)
    ...
    @OriginalMember(owner = "client!n", name = "d", descriptor = "(I)I", line = 774)
