...
public class class17 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IB)Lki;", line = 22)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IBI)V", line = 55)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZI)V", line = 104)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BLpfa;Le;Ljava/awt/Canvas;I)Loa;", line = 121)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lbs;ILpfa;Lpfa;)V", line = 233)
