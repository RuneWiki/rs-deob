...
public class class17 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)V", line = 76)
