...
public class class17 extends class275 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILa;IIILqa;Z)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILmv;)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILqa;I)Z")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILqa;)Lou;")
