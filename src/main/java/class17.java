...
public class class17 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Loa;Lur;IIILct;Lpb;Lct;ILpe;II[Lid;Loba;IBLai;ZLqh;)Lba;", line = 8)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 509)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BZ)V", line = 547)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IILct;Lpb;ILoa;BLur;IIII)Lba;", line = 561)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IZI)V", line = 714)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(II)Z", line = 726)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BIILpb;)V", line = 737)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZII[B)[B", line = 774)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lqh;IILoa;Lur;IILpe;ILoba;Lct;Lpb;)Lba;", line = 789)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I[I[IZII)V", line = 987)
