...
public class class17 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIII)Lbu;")
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(B)Ljv;")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lya;Lfs;ILfs;)V")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILuu;II)V")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lbu;I)V")
