...
public class class17 extends class451 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BLmd;)Lam;", line = 9)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(IIIIIF)V", line = 24)
    public class17(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IF)V", line = 42)
    ...
    @OriginalMember(owner = "client!bu", name = "g", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!bu", name = "h", descriptor = "(I)V", line = 68)
