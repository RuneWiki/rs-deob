...
public abstract class class17 extends class128 {
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(I)Ltq;", line = 47)
    ...
    @OriginalMember(owner = "client!hd", name = "g", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 127)
