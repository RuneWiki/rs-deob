...
public class class17 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)Llo;")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILti;I)V")
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(B)Llo;")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lti;I)V")
