...
public abstract class class17 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(IIIII)V", line = 320)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Leo;B)[I", line = 193)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)V", line = 284)
