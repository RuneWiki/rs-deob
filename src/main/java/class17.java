...
public class class17 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZLql;IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lpaa;Lpaa;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Llj;JI)V", line = 165)
