...
public class class17 extends class49 {
    ...
    @OriginalMember(owner = "client!tia", name = "b", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(I)V", line = 14)
    public static void method65(int arg0) {
        field100 = null;
        int var1 = -69 / ((arg0 - -55) / 62);
    }

    @OriginalMember(owner = "client!tia", name = "d", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!tia", name = "e", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!tia", name = "f", descriptor = "(B)J", line = 51)
    public final long method68(byte arg0) {
        ++field110;
        return arg0 > -105 ? 87L : 72057594037927935L & super.field762;
    }

    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(IJ)V", line = 68)
    public class17(int arg0, long arg1) {
        super.field762 = (long) arg0 << 56 | arg1;
    }

    @OriginalMember(owner = "client!tia", name = "g", descriptor = "(I)V", line = 81)
