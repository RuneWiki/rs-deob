...
public class class17 extends class141 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILpo;I[BIZI)Lan;", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lpo;IIIIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lpo;IIII[I)V", line = 42)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([IIILpo;BZ)Lan;", line = 57)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lpo;IIIZ[I)V", line = 75)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lpo;IIIIZ[BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lpo;IIIII[BI)V", line = 119)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lpo;IIIIIIZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILpo;III)Lan;", line = 152)
