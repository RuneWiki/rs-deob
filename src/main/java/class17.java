...
public class class17 extends class170 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIB)V", line = 10)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(IIB)V", line = 60)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Liu;IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(IIIIIII)V", line = 394)
