...
public class class17 extends class418 {
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 25)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(I)V", line = 87)
