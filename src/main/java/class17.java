...
public class class17 extends class86 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(ILsf;)V")
    public class17(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)Lkj;")
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lsf;)V")
