...
public class class17 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Las;Z)Z")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lbt;)V")
