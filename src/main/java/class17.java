...
public class class17 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)Ltaa;", line = 22)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)I", line = 130)
    public static final int method210(int arg0) {
        field240++;
        return arg0 == 16 ? 16 : -91;
    }

    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Ldh;ILkha;Lkha;)V", line = 161)
