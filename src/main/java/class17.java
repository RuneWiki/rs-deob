...
public class class17 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I[BII)V", line = 138)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(JB)V", line = 259)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lac;II)V", line = 579)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(I)Ljava/io/File;", line = 280)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I[BZI)V", line = 295)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 477)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "([BI)V", line = 521)
    ...
    @OriginalMember(owner = "client!sg", name = "c", descriptor = "(I)J", line = 541)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 562)
