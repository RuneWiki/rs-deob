...
public class class17 {
    ...
    @OriginalMember(owner = "client!EINNWKRR", name = "b", descriptor = "[LEINNWKRR;")
    public static class17[] field654;

    @OriginalMember(owner = "client!EINNWKRR", name = "a", descriptor = "(ILHRXSNEYZ;)V")
    ...
    @OriginalMember(owner = "client!EINNWKRR", name = "a", descriptor = "(IILJHKSAGUC;)V")
