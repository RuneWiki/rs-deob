...
public class class17 extends class58 {
    ...
    @OriginalMember(owner = "client!HDYGEGXY", name = "xb", descriptor = "LZPNSJLZE;")
    ...
    @OriginalMember(owner = "client!HDYGEGXY", name = "Ab", descriptor = "LGALAVQEJ;")
    public class12 field815;

    @OriginalMember(owner = "client!HDYGEGXY", name = "Kb", descriptor = "LCSGBDGDY;")
    public class4 field825;

    @OriginalMember(owner = "client!HDYGEGXY", name = "Pb", descriptor = "Ljava/lang/String;")
    public String field830;

    @OriginalMember(owner = "client!HDYGEGXY", name = "c", descriptor = "(I)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!HDYGEGXY", name = "a", descriptor = "(Z)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!HDYGEGXY", name = "d", descriptor = "(I)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!HDYGEGXY", name = "a", descriptor = "(LNHEPCMLW;Z)V")
