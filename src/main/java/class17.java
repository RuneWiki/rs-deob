...
public class class17 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!sg", name = "c", descriptor = "(B)V", line = 155)
