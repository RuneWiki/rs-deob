...
public abstract class class17 implements class152 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Ldca;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!n", name = "d", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!n", name = "e", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IB)V", line = 148)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(B)I", line = 161)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "([IIIIB)V", line = 181)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIII)V", line = 289)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "([FIIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(III[BI)V", line = 407)
    ...
    @OriginalMember(owner = "client!n", name = "f", descriptor = "(I)V", line = 504)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 516)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lbea;ILos;Lmg;IZ)V", line = 583)
    ...
    @OriginalMember(owner = "client!n", name = "g", descriptor = "(I)V", line = 546)
    ...
    @OriginalMember(owner = "client!n", name = "h", descriptor = "(I)V", line = 568)
