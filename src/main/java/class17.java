...
public class class17 extends class376 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)I", line = 10)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!an", name = "d", descriptor = "(I)[F", line = 63)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lqj;II)Lan;", line = 476)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([B)V", line = 492)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "([B)V", line = 653)
    ...
    @OriginalMember(owner = "client!an", name = "e", descriptor = "(I)F", line = 699)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "()I", line = 722)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lqj;)Z", line = 731)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "([B)V", line = 744)
    private class17(byte[] arg0) {
        this.method101(arg0);
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "([I)Leg;", line = 748)
