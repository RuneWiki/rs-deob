...
public class class17 extends class537 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "()I", line = 13)
    public final int method118() {
        return this.field205 - (this.field204.available() >> (class247.field3844 ? 2 : 1));
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 23)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "()V", line = 62)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 102)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "()V", line = 141)
