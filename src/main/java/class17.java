...
public class class17 extends class71 {
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(B)J", line = 19)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)J", line = 53)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)I", line = 64)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "()V", line = 105)
    public class17() {
