...
public class class17 extends class488 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "([IIILwm;Lbt;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lbt;IIIIILwm;[IIII)V", line = 364)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)V", line = 653)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILwm;)V", line = 675)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIIIIIILwm;Ldg;II)V", line = 969)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIII[BBILwm;[Ldg;II)V", line = 1712)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IILdg;IIILwm;)V", line = 1795)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "([Ldg;II[BILwm;)V", line = 1911)
