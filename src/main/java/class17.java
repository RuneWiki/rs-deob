...
@OriginalClass("client!FAQFGVMF")
public class class17 {

    @OriginalMember(owner = "client!FAQFGVMF", name = "b", descriptor = "I")
    private int field839 = 6;

    @OriginalMember(owner = "client!FAQFGVMF", name = "c", descriptor = "B")
    private byte field840 = 6;

    @OriginalMember(owner = "client!FAQFGVMF", name = "d", descriptor = "Z")
    private boolean field841 = true;

    @OriginalMember(owner = "client!FAQFGVMF", name = "e", descriptor = "Z")
    private boolean field842 = false;

    @OriginalMember(owner = "client!FAQFGVMF", name = "h", descriptor = "I")
    public int field845 = -1;

    @OriginalMember(owner = "client!FAQFGVMF", name = "j", descriptor = "[I")
    public int[] field847 = new int[6];

    @OriginalMember(owner = "client!FAQFGVMF", name = "k", descriptor = "[I")
    public int[] field848 = new int[6];

    @OriginalMember(owner = "client!FAQFGVMF", name = "l", descriptor = "[I")
    public int[] field849 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!FAQFGVMF", name = "m", descriptor = "Z")
    public boolean field850 = false;

    @OriginalMember(owner = "client!FAQFGVMF", name = "a", descriptor = "I")
    private static int field838 = -302;

    @OriginalMember(owner = "client!FAQFGVMF", name = "f", descriptor = "I")
    public static int field843;

    @OriginalMember(owner = "client!FAQFGVMF", name = "i", descriptor = "[I")
    public int[] field846;

    @OriginalMember(owner = "client!FAQFGVMF", name = "g", descriptor = "[LFAQFGVMF;")
    public static class17[] field844;

    @OriginalMember(owner = "client!FAQFGVMF", name = "a", descriptor = "(LLYZBHNJP;I)V")
    ...
    @OriginalMember(owner = "client!FAQFGVMF", name = "a", descriptor = "(LZOMNSJJM;B)V")
    ...
    @OriginalMember(owner = "client!FAQFGVMF", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!FAQFGVMF", name = "a", descriptor = "(I)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!FAQFGVMF", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!FAQFGVMF", name = "b", descriptor = "(B)LCCYECDYX;")
