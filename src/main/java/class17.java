...
public class class17 extends OutputStream {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!n", name = "write", descriptor = "(I)V", line = 19)
    public final void write(int arg0) throws IOException {
        field144++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IC)Z", line = 41)
