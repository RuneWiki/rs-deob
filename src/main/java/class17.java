...
public class class17 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Loo;I)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lkh;II)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILkh;I)V")
