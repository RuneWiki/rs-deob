...
public class class17 extends class425 {
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lrg;ILjava/lang/String;)I", line = 32)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIII[ILil;)V", line = 57)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lil;BI)V", line = 151)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "()Lrb;", line = 248)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lfl;)V", line = 377)
    public class17(class387 arg0) {
        this.field221 = arg0;
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZLea;Lvg;)V", line = 282)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "()I", line = 299)
    public final int method103() {
        field222++;
        return 0;
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIII)V", line = 307)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "()Lrb;", line = 319)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([III)V", line = 338)
