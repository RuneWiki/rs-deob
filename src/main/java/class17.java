...
public class class17 extends class299 implements class425 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BLii;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILii;)V", line = 36)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lii;ZII)Lcb;", line = 46)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(II)V", line = 87)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(ILii;I)Z", line = 131)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B[BI)I", line = 543)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lii;Lge;IIIIZIIIII)V", line = 559)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(I)I", line = 584)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILii;I)Ldc;", line = 602)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)V", line = 613)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lii;)V", line = 632)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)Z", line = 714)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILii;Z)Ldc;", line = 726)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIII)V", line = 747)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Lii;I)Leb;", line = 798)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lii;I)V", line = 828)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIZLii;)Z", line = 856)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)I", line = 877)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)I", line = 895)
