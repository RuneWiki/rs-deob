...
public class class17 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lgf;I)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lgf;)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lic;I)V")
