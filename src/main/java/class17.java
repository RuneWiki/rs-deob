...
public class class17 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IB)Lsc;", line = 8)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIIIIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZIB)V", line = 87)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 114)
    public class17(class12 arg0, int arg1, class421 arg2) {
        this.field274 = arg2;
        this.field274.method2509(0, 5);
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIIII)I", line = 136)
