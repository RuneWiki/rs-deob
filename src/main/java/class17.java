...
public class class17 extends class499 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lha;[Lcm;Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "()V", line = 104)
    public final void method123() {
        this.field222 = true;
    }

    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class17(int arg0, boolean arg1) {
        this.method121(arg0, arg1);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lha;)V", line = 110)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "()V", line = 122)
    private final void method125() {
        this.field222 = false;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lha;J)Z", line = 128)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([Lhi;Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "()Luj;", line = 274)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lha;J[Lcm;[Lhi;Z)V", line = 289)
    ...
    @OriginalMember(owner = "client!l", name = "e", descriptor = "()V", line = 297)
    public final void method130() {
        this.field227 = true;
    }

    @OriginalMember(owner = "client!l", name = "f", descriptor = "()Luj;", line = 301)
    public final class388 method131() {
        return this.field228;
    }

    @OriginalMember(owner = "client!l", name = "g", descriptor = "()V", line = 307)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(IZ)Ll;", line = 348)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(J)V", line = 372)
