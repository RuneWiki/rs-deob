...
public class class17 extends class12 {
    ...
    @OriginalMember(owner = "client!GBGUDIMT", name = "sb", descriptor = "LWZSDIPBR;")
    ...
    @OriginalMember(owner = "client!GBGUDIMT", name = "c", descriptor = "(Z)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!GBGUDIMT", name = "a", descriptor = "(Z)LPOJFANDE;")
