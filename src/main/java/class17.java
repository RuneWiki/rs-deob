...
public class class17 {
    ...
    @OriginalMember(owner = "client!ENGZWEMK", name = "o", descriptor = "I")
    ...
    @OriginalMember(owner = "client!ENGZWEMK", name = "a", descriptor = "(LPKHWFJLM;Z)V")
    ...
    @OriginalMember(owner = "client!ENGZWEMK", name = "b", descriptor = "(LPKHWFJLM;Z)V")
