...
public class class17 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(CI)V", line = 3)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lug;I)V", line = 54)
