...
public class class17 extends class45 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(II)Z", line = 14)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "([B)V", line = 54)
