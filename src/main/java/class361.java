...
public class class361 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Ltn;I)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Ldt;B)V")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Ldt;)V")
