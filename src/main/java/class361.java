...
public class class361 extends class69 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLns;)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIILbq;)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lhv;)V")
