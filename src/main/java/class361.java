...
public abstract class class361 extends class433 {
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "()I", line = 8)
    public final int method1576() {
        return this.field5124;
    }

    @OriginalMember(owner = "client!hea", name = "QA", descriptor = "()I", line = 16)
    public final int method1570() {
        return this.field5140;
    }

    @OriginalMember(owner = "client!hea", name = "sa", descriptor = "(FFFFFFIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(FFFFFF)Z", line = 133)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 276)
    ...
    @OriginalMember(owner = "client!hea", name = "ba", descriptor = "(IIIIIII)V", line = 288)
    ...
    @OriginalMember(owner = "client!hea", name = "EA", descriptor = "(IIII)V", line = 334)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "()I", line = 346)
    public final int method1568() {
        return this.field5124 + this.field5108 + this.field5127;
    }

    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lfk;II)V", line = 360)
    ...
    @OriginalMember(owner = "client!hea", name = "AA", descriptor = "()I", line = 366)
