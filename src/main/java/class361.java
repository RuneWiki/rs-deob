...
public class class361 extends class645 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!qu", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 3)
    public final void focusGained(FocusEvent arg0) {
        field5137++;
    }

    @OriginalMember(owner = "client!qu", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 11)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field5130++;
        this.method2180(arg0, 1, true);
    }

    @OriginalMember(owner = "client!qu", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 20)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field5123++;
        this.method2180(arg0, 0, true);
    }

    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!qu", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 59)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)Lbs;", line = 75)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IBCI)V", line = 98)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!qu", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 206)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method2178(0, (byte) 107, '\u0000', -1);
        field5136++;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;IZ)V", line = 217)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 257)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(B)I", line = 284)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IZ)Z", line = 307)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 346)
