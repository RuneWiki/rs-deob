...
public class class361 extends class263 {
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 19)
    public class361() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ZIZIILjava/lang/String;JIZZLjava/lang/String;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IZLgk;)V", line = 108)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(IB)[[I", line = 152)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IB)[I", line = 199)
