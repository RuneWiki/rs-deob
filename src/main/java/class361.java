...
public class class361 extends class418 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Lae;")
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZILvc;IILuq;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BLkk;)Lns;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILvc;I)Z")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BLkc;)V")
