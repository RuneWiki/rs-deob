...
public class class361 implements class743 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)Lal;")
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(Lhb;Lal;Z)V")
