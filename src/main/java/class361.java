...
public class class361 extends OutputStream {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!dj", name = "write", descriptor = "(I)V", line = 45)
