...
public class class361 extends class290 implements class518 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lza;Lp;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lza;IB)Le;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(ILza;)Lsr;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILza;ZB)Ljl;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILza;IILvl;Z)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lco;ILmo;ILza;I)Z")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lza;III)Z")
