...
public class class361 extends Canvas {
    ...
    @OriginalMember(owner = "client!sf", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 13)
    public final void update(Graphics arg0) {
        this.field5547.update(arg0);
        field5546++;
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Ljava/lang/String;BIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!sf", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 159)
    public final void paint(Graphics arg0) {
        field5548++;
        this.field5547.paint(arg0);
    }

    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILqa;IZ)V", line = 182)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 644)
