...
public class class361 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZIILkh;)V", line = 5)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)V", line = 128)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILkh;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(II)V", line = 215)
