...
public class class361 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILuv;)V")
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)Luv;")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)Luv;")
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)Luv;")
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(B)Luv;")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)Lbg;")
