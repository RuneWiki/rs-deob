...
public class class361 extends class6 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lsi;I)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lsi;II)V")
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(II)Lkl;")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lsi;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lsi;I[I)V")
