...
public class class361 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lwq;B)Lqu;", line = 89)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BIII)Loi;", line = 104)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)V", line = 165)
