...
public class class361 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lnj;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIBI)V", line = 31)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 87)
