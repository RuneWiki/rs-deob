...
public class class361 extends class80 {
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BZLla;Ljava/lang/String;)V", line = 9)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 46)
    public class361() {
        this(4096);
    }

    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(II)[I", line = 50)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IILnn;)V", line = 74)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!dn", name = "e", descriptor = "(I)V", line = 115)
