...
public class class361 extends class222 implements class68 {
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILqa;)Lou;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lqa;ZBI)Lkj;")
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lqa;Lcd;IIIIZIIIII)V")
