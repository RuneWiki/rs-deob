...
public class class361 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z[[[Luk;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lke;IIB)V", line = 104)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BI)V", line = 453)
