...
public class class361 {
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 6)
    public class361(String arg0, int arg1) {
        this.field4781 = arg1;
    }

    @OriginalMember(owner = "client!mo", name = "toString", descriptor = "()Ljava/lang/String;", line = 19)
    public final String toString() {
        field4784++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIFFFZII)[F", line = 67)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 149)
