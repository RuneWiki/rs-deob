...
public class class361 extends class194 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BI)I", line = 22)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 54)
    public class361() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bh", name = "h", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)[[I", line = 66)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)V", line = 145)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(II)[I", line = 298)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(III)Z", line = 340)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILbg;)V", line = 367)
