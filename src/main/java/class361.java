...
public class class361 extends class129 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILrca;)V", line = 16)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lrda;Lla;Lcda;)V", line = 27)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZB)V", line = 43)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)I", line = 55)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Z)Z", line = 84)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!tk", name = "e", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!tk", name = "f", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 183)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIB)V", line = 209)
