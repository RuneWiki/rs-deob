...
public class class361 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lag;[I[II[I)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IB)Lth;")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Ljda;ILjo;Ljo;)V")
