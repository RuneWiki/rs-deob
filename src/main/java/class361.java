...
public abstract class class361 extends class387 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!me", name = "f", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!me", name = "h", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 124)
