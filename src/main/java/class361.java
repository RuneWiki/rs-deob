...
public class class361 extends class454 {
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lkd;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lkd;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lkd;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(BI)V")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lkd;IIII)V")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lkd;IIIII)V")
