...
public class class361 extends Canvas {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Ljava/lang/String;ZB)V", line = 44)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lh;I)Ljava/lang/String;", line = 143)
    ...
    @OriginalMember(owner = "client!ho", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 158)
    public final void paint(Graphics arg0) {
        this.field4979.paint(arg0);
        field4978++;
    }

    @OriginalMember(owner = "client!ho", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 166)
    public final void update(Graphics arg0) {
        this.field4979.update(arg0);
        field4984++;
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 216)
