...
public class class361 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(II)V", line = 66)
    public class361(int arg0, int arg1) {
        this.field4670 = arg0;
        this.field4665 = arg1;
    }

    @OriginalMember(owner = "client!ra", name = "toString", descriptor = "()Ljava/lang/String;", line = 81)
    public final String toString() {
        field4675++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)V", line = 91)
