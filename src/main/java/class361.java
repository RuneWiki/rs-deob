...
public class class361 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lnf;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(Lnf;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lnf;Lop;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lnf;I)V")
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(Lnf;)V")
