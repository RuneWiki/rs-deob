...
public class class361 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)[B", line = 87)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIII)V", line = 156)
