...
public class class361 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lac;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)V", line = 49)
