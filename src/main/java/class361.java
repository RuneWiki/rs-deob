...
public class class361 extends class513 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lvj;B)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lwn;I)V")
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(ZLmr;)V")
