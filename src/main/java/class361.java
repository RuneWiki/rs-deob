...
public class class361 extends class283 {
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lac;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ws", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZLjava/lang/String;IZ)V", line = 215)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lcu;ZI)V", line = 250)
