...
public class class361 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Z)V", line = 67)
