...
public class class361 {
    ...
    @OriginalMember(owner = "client!hf", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!hf", name = "movemouse", descriptor = "(II)V")
