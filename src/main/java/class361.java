...
public class class361 implements class69 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lqa;Lco;IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(JLtk;I[I)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BIIII)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZI)V", line = 158)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 200)
