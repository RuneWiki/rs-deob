...
public class class361 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILlf;)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Llf;B)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IILlf;)V")
