...
public class class361 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lec;III)V", line = 18)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILec;I)V", line = 167)
