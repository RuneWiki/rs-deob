...
public class class361 extends class15 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZLvt;)V")
    ...
    @OriginalMember(owner = "client!ol", name = "f", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILvt;I)V")
