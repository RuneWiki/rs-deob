...
public class class686 extends class5 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLes;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIILr;)V")
