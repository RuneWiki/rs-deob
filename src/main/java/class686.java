...
public class class686 extends class219 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lpw;I)Z")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lrv;II)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lrv;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILwq;)Lwq;")
