...
public class class686 implements Runnable {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(B)I", line = 95)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Ljava/net/Socket;Ltd;I)V", line = 487)
    ...
    @OriginalMember(owner = "client!sv", name = "finalize", descriptor = "()V", line = 123)
    protected final void finalize() {
        this.method3871((byte) 115);
        field9539++;
    }

    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(B)I", line = 131)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BILjs;)Z", line = 155)
    ...
    @OriginalMember(owner = "client!sv", name = "run", descriptor = "()V", line = 325)
    ...
    @OriginalMember(owner = "client!sv", name = "d", descriptor = "(B)V", line = 395)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IZI[B)V", line = 435)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(III)Z", line = 460)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z)V", line = 475)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II[BI)V", line = 502)
