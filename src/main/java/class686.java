...
public class class686 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Llj;J[II)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(ILbi;Lbi;Lrj;)V", line = 84)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IZ)Ltfa;", line = 42)
