...
public class class686 extends class272 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IILoa;I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(III)Z", line = 51)
