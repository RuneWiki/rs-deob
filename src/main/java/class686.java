...
public class class686 {
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!kja", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
    public final String toString() {
        field9362++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(B)V", line = 61)
