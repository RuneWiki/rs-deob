...
public class class686 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(III)B", line = 20)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)Z", line = 47)
