...
public class class686 extends class22 {
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 12)
    ...
    @OriginalMember(owner = "client!sp", name = "d", descriptor = "()I", line = 34)
    public final int method148() {
        return this.field9691 - (this.field9688.available() >> (class550.field8108 ? 2 : 1));
    }

    @OriginalMember(owner = "client!sp", name = "c", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 81)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "()V", line = 120)
