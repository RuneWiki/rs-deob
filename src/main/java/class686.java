...
public class class686 extends class298 {
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(I)Lib;", line = 40)
    ...
    @OriginalMember(owner = "client!sv", name = "g", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(B)J", line = 75)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(III)Z", line = 89)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 101)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 175)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IB)V", line = 186)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z)Z", line = 209)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lha;B)Lfs;", line = 227)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)D", line = 247)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)F", line = 260)
