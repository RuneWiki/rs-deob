...
public class class686 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BLjr;)Lmu;")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Len;IIIII)Lan;")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BLhda;)V")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IILpd;Lpd;Z)I")
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(Z)Lhda;")
