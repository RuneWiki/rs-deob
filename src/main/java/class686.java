...
public class class686 extends class71 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIZIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BI[[ZII)V", line = 186)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Luu;Lha;B)V", line = 247)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BS)V", line = 383)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 398)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Ldw;Lrq;Ltj;[I)V", line = 409)
