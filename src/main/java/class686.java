...
public class class686 extends class387 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(BILiga;)V")
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Lrda;Llba;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
