...
public class class686 extends class327 implements class225 {
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "(Lfc;Lnea;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "([FIIIIIIILnea;)V")
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(IZLnea;I[BIIII)V")
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "(Lfc;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "(Lfc;Lnea;Ldr;II)V")
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "(Lfc;Lnea;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Lol;I)Lraa;")
