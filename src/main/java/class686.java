...
public class class686 extends class96 {
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lml;)V")
    public class686(class194 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BLsba;)Z")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZLica;)V")
