...
public class class686 implements class436 {
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Lad;Z)V", line = 83)
    public class686(class173 arg0, boolean arg1) {
        this.field9749 = arg0;
        this.field9752 = arg1;
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 10)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Z)I", line = 93)
    public final int method1105(boolean arg0) {
        return arg0 ? 23 : this.field9750;
    }

    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 113)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(B)Z", line = 134)
