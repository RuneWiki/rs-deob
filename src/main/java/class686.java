...
public class class686 {
    ...
    public static int field9778 = 1;

    @OriginalMember(owner = "client!au", name = "d", descriptor = "B")
    public byte field9780;

    @OriginalMember(owner = "client!au", name = "g", descriptor = "B")
    public byte field9783;

    @OriginalMember(owner = "client!au", name = "i", descriptor = "B")
    public byte field9785;

    @OriginalMember(owner = "client!au", name = "k", descriptor = "B")
    public byte field9787;

    @OriginalMember(owner = "client!au", name = "l", descriptor = "B")
    public byte field9788;

    @OriginalMember(owner = "client!au", name = "o", descriptor = "B")
    public byte field9791;

    @OriginalMember(owner = "client!au", name = "u", descriptor = "B")
    public byte field9797;
    ...
    public boolean field9796;

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZI)V")
    public static final void method3875(boolean arg0, int arg1) {
        field9782++;
        class51 var2 = class703.method3938(-1989279584, arg1, 10);
        var2.method404(69);
        if (arg0) {
            method3875(true, -108);
        }
