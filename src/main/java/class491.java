...
public class class491 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILpt;)Z")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLie;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lie;)V")
