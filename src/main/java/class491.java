...
public class class491 {
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(III)V", line = 2)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lmc;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(I)V", line = 533)
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)V", line = 558)
