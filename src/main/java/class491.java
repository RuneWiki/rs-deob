...
public class class491 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III)Lab;", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIIILea;IIIZI)Z", line = 13)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 367)
    ...
    @OriginalMember(owner = "client!cm", name = "toString", descriptor = "()Ljava/lang/String;", line = 387)
    public final String toString() {
        field7460++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 400)
    public class491(String arg0, int arg1) {
        this.field7461 = arg0;
        this.field7456 = arg1;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 409)
