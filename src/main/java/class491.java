...
public class class491 extends class307 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BI)V", line = 47)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 64)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)V", line = 104)
