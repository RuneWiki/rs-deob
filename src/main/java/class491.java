...
public class class491 extends class96 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIZZDLps;Lhe;I)[I", line = 6)
    ...
    @OriginalMember(owner = "client!cm", name = "e", descriptor = "(B)V", line = 144)
    public static void method2949(byte arg0) {
        int var1 = 78 / ((arg0 + 2) / 37);
        field7501 = null;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILhe;Lps;ZDIB)[I", line = 153)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILqo;IIIIIIII[II[IIZ)I", line = 287)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lps;ILhe;)Z", line = 465)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lhe;Lps;IIIZ)[F", line = 518)
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(B)[Ltq;", line = 637)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(III)I", line = 658)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "()V", line = 681)
    public class491() {
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lae;)V", line = 696)
