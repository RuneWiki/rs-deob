...
public class class491 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)Law;", line = 27)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(ILni;Lni;)V", line = 81)
