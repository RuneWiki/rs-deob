...
public class class491 extends class168 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(CB)C", line = 14)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BLjava/awt/Canvas;II)Lpca;", line = 147)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)Z", line = 181)
