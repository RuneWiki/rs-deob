...
public class class491 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IB)Lcb;", line = 112)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lsn;ILci;Lci;)V", line = 163)
