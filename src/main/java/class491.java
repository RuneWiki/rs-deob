...
public class class491 extends class114 {
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILwfa;)V", line = 16)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(ILjava/lang/String;)[B", line = 31)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Ljc;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)Z", line = 104)
