...
public class class491 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 25)
    public static void method2666(int arg0) {
        int var1 = 17 % ((53 - arg0) / 55);
        field6123 = null;
    }

    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Ljaa;JI)V", line = 42)
    public class491(class576 arg0, long arg1, int arg2) {
        this.field6127 = arg1;
        this.field6126 = arg0;
    }

    @OriginalMember(owner = "client!hr", name = "finalize", descriptor = "()V", line = 54)
