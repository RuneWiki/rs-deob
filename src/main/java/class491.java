...
public class class491 extends class739 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IZII)V", line = 9)
    ...
    @OriginalMember(owner = "client!tt", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(IIII)V", line = 128)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(II)[[I", line = 182)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ldu;B[[B)V", line = 257)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLgt;)I", line = 330)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILaj;)I", line = 391)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lsl;IB)V", line = 404)
