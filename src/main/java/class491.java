...
public class class491 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 16)
    public static void method2877(int arg0) {
        int var1 = 72 / ((arg0 - 55) / 38);
        field7167 = null;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BLdi;)V", line = 25)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZBILjava/lang/String;)I", line = 37)
