...
public abstract class class491 extends class85 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lwt;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(III)I", line = 35)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IILjava/lang/String;IZIZJILjava/lang/String;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Ls;I)V", line = 136)
    public class491(class160 arg0, int arg1) {
        this.field7175 = arg1;
        this.field7170 = arg0;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIIIIBI)V", line = 145)
