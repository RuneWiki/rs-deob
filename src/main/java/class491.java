...
public class class491 extends class260 {
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lfca;)V")
    public class491(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ZLjava/awt/Component;I)Lji;")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(ILfca;)V")
