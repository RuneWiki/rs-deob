...
public class class491 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILfca;)V", line = 16)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lvf;IIILha;BI)Lka;", line = 147)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILs;IILs;ZBIIILha;Lvf;I)Lka;", line = 183)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ls;IIILvf;Lha;BBIILs;IIZ)Lka;", line = 209)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIIBLvf;Lha;)Lka;", line = 326)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BILfca;)V", line = 340)
