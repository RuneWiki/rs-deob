...
public class class491 extends class371 {
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "()V", line = 25)
    public class491() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(III)Llaa;", line = 29)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(BI)[I", line = 36)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IBLps;)V", line = 101)
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "(B)V", line = 157)
