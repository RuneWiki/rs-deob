...
public class class491 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Lis;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)Lks;", line = 65)
    ...
    @OriginalMember(owner = "client!sda", name = "c", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 122)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(III)Z", line = 142)
