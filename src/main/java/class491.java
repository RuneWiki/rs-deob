...
public abstract class class491 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(Ljava/awt/Canvas;Lnv;ILl;II)Lza;")
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIILjava/lang/Class;)Lol;")
