...
public class class491 implements Runnable {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILbf;IIIII)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZLjava/lang/String;)Lhn;")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BLnd;)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILpc;BLfh;)V")
