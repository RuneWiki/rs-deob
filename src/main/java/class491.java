...
public class class491 {
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(IIIIIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(IIIB)Z", line = 45)
    ...
    @OriginalMember(owner = "client!tja", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(BI)V", line = 98)
