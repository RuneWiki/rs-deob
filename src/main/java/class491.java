...
public class class491 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IIILka;I)Liha;")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IB)Lnba;")
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(I)Lgca;")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([Luq;II)V")
