...
public class class491 extends class379 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IJ)V", line = 79)
