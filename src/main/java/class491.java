...
public class class491 extends class347 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)J", line = 51)
    public final long method1960(int arg0) {
        int var2 = 117 / (-arg0 / 33);
        return this.field6931;
    }

    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "()V", line = 95)
    public class491() {
    ...
    @OriginalMember(owner = "client!li", name = "f", descriptor = "(I)J", line = 63)
