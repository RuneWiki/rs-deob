...
public abstract class class491 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILbaa;)I", line = 29)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)V", line = 73)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lr;III[Z)Z", line = 89)
