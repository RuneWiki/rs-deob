...
public class class491 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIIBII)V", line = 24)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 207)
