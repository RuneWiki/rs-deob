...
public class class491 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lbi;III)Lo;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IBLoa;IILe;I)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLeh;)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILeh;I)V")
