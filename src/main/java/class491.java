...
public class class491 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BLgo;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(II)Lgo;")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lgo;)V")
