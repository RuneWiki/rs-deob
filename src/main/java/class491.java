...
public class class491 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lr;[IIII[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lr;[II[I[I)V", line = 91)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "()V", line = 139)
    private static final void method2847() {
        field7131 = 0;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lr;[II)V", line = 143)
    public static final void method2848(class564 arg0, int[] arg1, int arg2) {
        method2843(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(II)V", line = 148)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "()V", line = 185)
    public static void method2850() {
        field7128 = null;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([III)V", line = 192)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(I)Z", line = 244)
