...
public class class491 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lib;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lib;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)Z", line = 82)
