...
public class class491 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BLoea;)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lkca;Z)I")
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(II)Ldh;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lum;IIIIB)Laj;")
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lcw;ILeq;)V")
