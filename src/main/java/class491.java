...
public class class491 extends class621 implements class238 {
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(IBILha;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!eka", name = "b", descriptor = "(Lha;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Lha;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Lgt;Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!eka", name = "d", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!eka", name = "b", descriptor = "(ILha;)Lrk;", line = 88)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!eka", name = "d", descriptor = "(B)Z", line = 153)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(B)I", line = 164)
    ...
    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIII)V", line = 177)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(ILha;)V", line = 186)
    ...
    @OriginalMember(owner = "client!eka", name = "c", descriptor = "(I)Z", line = 198)
    ...
    @OriginalMember(owner = "client!eka", name = "e", descriptor = "(Z)Z", line = 210)
    ...
    @OriginalMember(owner = "client!eka", name = "e", descriptor = "(I)I", line = 228)
    ...
    @OriginalMember(owner = "client!eka", name = "f", descriptor = "(I)I", line = 239)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Lgda;Lha;IIZII)V", line = 250)
    ...
    @OriginalMember(owner = "client!eka", name = "c", descriptor = "(Z)Z", line = 261)
    ...
    @OriginalMember(owner = "client!eka", name = "i", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(ZLha;)Loba;", line = 288)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(I)I", line = 301)
    ...
    @OriginalMember(owner = "client!eka", name = "b", descriptor = "(I)I", line = 316)
    ...
    @OriginalMember(owner = "client!eka", name = "c", descriptor = "(III)Lab;", line = 333)
