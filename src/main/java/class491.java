...
public class class491 implements Runnable {
    ...
    @OriginalMember(owner = "client!mw", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(II[BI)V")
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V")
