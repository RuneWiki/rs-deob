...
public class SoundTone {
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "Lbc;")
    private SoundEnvelope field923;

    @OriginalMember(owner = "client!ec", name = "d", descriptor = "Lbc;")
    private SoundEnvelope field924;

    @OriginalMember(owner = "client!ec", name = "e", descriptor = "Lbc;")
    private SoundEnvelope field925;

    @OriginalMember(owner = "client!ec", name = "f", descriptor = "Lbc;")
    private SoundEnvelope field926;

    @OriginalMember(owner = "client!ec", name = "g", descriptor = "Lbc;")
    private SoundEnvelope field927;

    @OriginalMember(owner = "client!ec", name = "h", descriptor = "Lbc;")
    private SoundEnvelope field928;

    @OriginalMember(owner = "client!ec", name = "i", descriptor = "Lbc;")
    private SoundEnvelope field929;

    @OriginalMember(owner = "client!ec", name = "j", descriptor = "Lbc;")
    private SoundEnvelope field930;

    @OriginalMember(owner = "client!ec", name = "q", descriptor = "Lbc;")
    private SoundEnvelope field937;

    @OriginalMember(owner = "client!ec", name = "p", descriptor = "Lcc;")
    ...
    public final int[] method324(int arg0, int arg1) {
        ...
        if (this.field936.field904[0] > 0 || this.field936.field904[1] > 0) {
            ...
            if (arg0 >= var24 + var25) {
                ...
                while (var26 < var27) {
                    int var37 = (int) ((long) field940[var24 + var26] * (long) SoundFilter.field911 >> 16);
                    for (int var38 = 0; var38 < var24; var38++) {
                        var37 += (int) ((long) field940[var24 + var26 - var38 - 1] * (long) SoundFilter.field909[0][var38] >> 16);
                    }
                    for (int var39 = 0; var39 < var26; var39++) {
                        var37 -= (int) ((long) field940[var26 - var39 - 1] * (long) SoundFilter.field909[1][var39] >> 16);
                    }
                ...
                while (true) {
                    ...
                    while (var26 < var29) {
                        int var34 = (int) ((long) field940[var24 + var26] * (long) SoundFilter.field911 >> 16);
                        for (int var35 = 0; var35 < var24; var35++) {
                            var34 += (int) ((long) field940[var24 + var26 - var35 - 1] * (long) SoundFilter.field909[0][var35] >> 16);
                        }
                        for (int var36 = 0; var36 < var25; var36++) {
                            var34 -= (int) ((long) field940[var26 - var36 - 1] * (long) SoundFilter.field909[1][var36] >> 16);
                        }
                    ...
                    if (var26 >= arg0 - var24) {
                        while (var26 < arg0) {
                            ...
                            for (int var31 = var24 + var26 - arg0; var31 < var24; var31++) {
                                var30 += (int) ((long) field940[var24 + var26 - var31 - 1] * (long) SoundFilter.field909[0][var31] >> 16);
                            }
                            for (int var32 = 0; var32 < var25; var32++) {
                                var30 -= (int) ((long) field940[var26 - var32 - 1] * (long) SoundFilter.field909[1][var32] >> 16);
                            }
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLmb;)V")
