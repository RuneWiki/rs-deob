...
public class SoundTone {
    ...
    private SoundEnvelope field938;
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lmb;B)V")
    public final void method331(Packet arg0, byte arg1) {
        ...
        if (var3 != 0) {
            ...
            this.field938 = new SoundEnvelope();
