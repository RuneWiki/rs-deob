...
public class SoundTone {
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "Lac;")
    private SoundEnvelope field916;

    @OriginalMember(owner = "client!dc", name = "d", descriptor = "Lac;")
    private SoundEnvelope field917;

    @OriginalMember(owner = "client!dc", name = "e", descriptor = "Lac;")
    private SoundEnvelope field918;

    @OriginalMember(owner = "client!dc", name = "f", descriptor = "Lac;")
    private SoundEnvelope field919;

    @OriginalMember(owner = "client!dc", name = "g", descriptor = "Lac;")
    private SoundEnvelope field920;

    @OriginalMember(owner = "client!dc", name = "h", descriptor = "Lac;")
    private SoundEnvelope field921;

    @OriginalMember(owner = "client!dc", name = "i", descriptor = "Lac;")
    private SoundEnvelope field922;

    @OriginalMember(owner = "client!dc", name = "j", descriptor = "Lac;")
    private SoundEnvelope field923;

    @OriginalMember(owner = "client!dc", name = "q", descriptor = "Lac;")
    private SoundEnvelope field930;

    @OriginalMember(owner = "client!dc", name = "p", descriptor = "Lbc;")
    private SoundFilter field929;
    ...
    public final int[] method325(int arg0, int arg1) {
        ...
        if (this.field929.field896[0] > 0 || this.field929.field896[1] > 0) {
            ...
            if (arg0 >= var24 + var25) {
                ...
                while (var26 < var27) {
                    int var37 = (int) ((long) field933[var24 + var26] * (long) SoundFilter.field903 >> 16);
                    for (int var38 = 0; var38 < var24; var38++) {
                        var37 += (int) ((long) field933[var24 + var26 - var38 - 1] * (long) SoundFilter.field901[0][var38] >> 16);
                    }
                    for (int var39 = 0; var39 < var26; var39++) {
                        var37 -= (int) ((long) field933[var26 - var39 - 1] * (long) SoundFilter.field901[1][var39] >> 16);
                    }
                ...
                while (true) {
                    ...
                    while (var26 < var29) {
                        int var34 = (int) ((long) field933[var24 + var26] * (long) SoundFilter.field903 >> 16);
                        for (int var35 = 0; var35 < var24; var35++) {
                            var34 += (int) ((long) field933[var24 + var26 - var35 - 1] * (long) SoundFilter.field901[0][var35] >> 16);
                        }
                        for (int var36 = 0; var36 < var25; var36++) {
                            var34 -= (int) ((long) field933[var26 - var36 - 1] * (long) SoundFilter.field901[1][var36] >> 16);
                        }
                    ...
                    if (var26 >= arg0 - var24) {
                        while (var26 < arg0) {
                            ...
                            for (int var31 = var24 + var26 - arg0; var31 < var24; var31++) {
                                var30 += (int) ((long) field933[var24 + var26 - var31 - 1] * (long) SoundFilter.field901[0][var31] >> 16);
                            }
                            for (int var32 = 0; var32 < var25; var32++) {
                                var30 -= (int) ((long) field933[var26 - var32 - 1] * (long) SoundFilter.field901[1][var32] >> 16);
                            }
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIIZ)I")
    ...
    public final void method327(Packet arg0, int arg1) {
        ...
        this.field929 = new SoundFilter();
        this.field930 = new SoundEnvelope();
