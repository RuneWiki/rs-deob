...
public class SoundTone {
    ...
    @OriginalMember(owner = "client!dc", name = "j", descriptor = "Lbc;")
    private SoundEnvelope field916;

    @OriginalMember(owner = "client!dc", name = "k", descriptor = "Lbc;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZLmb;)V")
