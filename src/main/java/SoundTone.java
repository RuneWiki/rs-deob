...
public class SoundTone {
    ...
    public final int[] method320(int arg0, int arg1) {
        ...
        if (this.field926.field893[0] > 0 || this.field926.field893[1] > 0) {
            ...
            if (arg0 >= var24 + var25) {
                ...
                while (var26 < var27) {
                    int var37 = (int) ((long) field930[var24 + var26] * (long) SoundFilter.field900 >> 16);
                    for (int var38 = 0; var38 < var24; var38++) {
                        var37 += (int) ((long) field930[var24 + var26 - var38 - 1] * (long) SoundFilter.field898[0][var38] >> 16);
                    }
                    for (int var39 = 0; var39 < var26; var39++) {
                        var37 -= (int) ((long) field930[var26 - var39 - 1] * (long) SoundFilter.field898[1][var39] >> 16);
                    }
                ...
                while (true) {
                    ...
                    while (var26 < var29) {
                        int var34 = (int) ((long) field930[var24 + var26] * (long) SoundFilter.field900 >> 16);
                        for (int var35 = 0; var35 < var24; var35++) {
                            var34 += (int) ((long) field930[var24 + var26 - var35 - 1] * (long) SoundFilter.field898[0][var35] >> 16);
                        }
                        for (int var36 = 0; var36 < var25; var36++) {
                            var34 -= (int) ((long) field930[var26 - var36 - 1] * (long) SoundFilter.field898[1][var36] >> 16);
                        }
                    ...
                    if (var26 >= arg0 - var24) {
                        while (var26 < arg0) {
                            ...
                            for (int var31 = var24 + var26 - arg0; var31 < var24; var31++) {
                                var30 += (int) ((long) field930[var24 + var26 - var31 - 1] * (long) SoundFilter.field898[0][var31] >> 16);
                            }
                            for (int var32 = 0; var32 < var25; var32++) {
                                var30 -= (int) ((long) field930[var26 - var32 - 1] * (long) SoundFilter.field898[1][var32] >> 16);
                            }
    ...
    public final void method322(Packet arg0, int arg1) {
        this.field913 = new SoundEnvelope();
        this.field913.method304(arg0, -32477);
        this.field914 = new SoundEnvelope();
        this.field914.method304(arg0, -32477);
        int var3 = arg0.method224();
        if (var3 != 0) {
            arg0.field702--;
            this.field915 = new SoundEnvelope();
