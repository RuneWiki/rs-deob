...
public class SoundTone {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "Lbc;")
    private SoundEnvelope field902;

    @OriginalMember(owner = "client!dc", name = "c", descriptor = "Lbc;")
    private SoundEnvelope field903;

    @OriginalMember(owner = "client!dc", name = "d", descriptor = "Lbc;")
    private SoundEnvelope field904;

    @OriginalMember(owner = "client!dc", name = "e", descriptor = "Lbc;")
    private SoundEnvelope field905;

    @OriginalMember(owner = "client!dc", name = "f", descriptor = "Lbc;")
    private SoundEnvelope field906;

    @OriginalMember(owner = "client!dc", name = "g", descriptor = "Lbc;")
    private SoundEnvelope field907;

    @OriginalMember(owner = "client!dc", name = "h", descriptor = "Lbc;")
    private SoundEnvelope field908;

    @OriginalMember(owner = "client!dc", name = "i", descriptor = "Lbc;")
    private SoundEnvelope field909;
    ...
    public final int[] method329(int arg0, int arg1) {
        ...
        this.field902.method320(false);
        this.field903.method320(false);
        int var6 = 0;
        int var7 = 0;
        int var8 = 0;
        if (this.field904 != null) {
            this.field904.method320(false);
            this.field905.method320(false);
        ...
        if (this.field906 != null) {
            this.field906.method320(false);
            this.field907.method320(false);
        ...
        for (int var13 = 0; var13 < arg0; var13++) {
            int var24 = this.field902.method321(-406, arg0);
            int var25 = this.field903.method321(-406, arg0);
            if (this.field904 != null) {
                int var26 = this.field904.method321(-406, arg0);
                int var27 = this.field905.method321(-406, arg0);
                var24 += this.method330(var8, var27, (byte) 52, this.field904.field886) >> 1;
                var8 += (var6 * var26 >> 16) + var7;
            }
            if (this.field906 != null) {
                int var28 = this.field906.method321(-406, arg0);
                int var29 = this.field907.method321(-406, arg0);
                var25 = var25 * ((this.method330(var11, var29, (byte) 52, this.field906.field886) >> 1) + 32768) >> 15;
            ...
            for (int var30 = 0; var30 < 5; var30++) {
                if (this.field910[var30] != 0) {
                    ...
                    if (var31 < arg0) {
                        field917[var31] += this.method330(field920[var30], field922[var30] * var25 >> 15, (byte) 52, this.field902.field886);
        ...
        if (this.field908 != null) {
            this.field908.method320(false);
            this.field909.method320(false);
            int var14 = 0;
            boolean var15 = false;
            boolean var16 = true;
            for (int var17 = 0; var17 < arg0; var17++) {
                int var18 = this.field908.method321(-406, arg0);
                int var19 = this.field909.method321(-406, arg0);
                int var20;
                if (var16) {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIBI)I")
    private final int method330(int arg0, int arg1, byte arg2, int arg3) {
        if (arg2 != 52) {
        ...
        if (arg3 == 1) {
            ...
            return field919[arg0 & 0x7FFF] * arg1 >> 14;
        } else if (arg3 == 3) {
            return ((arg0 & 0x7FFF) * arg1 >> 14) - arg1;
        } else if (arg3 == 4) {
            return field918[arg0 / 2607 & 0x7FFF] * arg1;
        } else {
            return 0;
        }
    }
    ...
    public final void method331(int arg0, Packet arg1) {
        this.field902 = new SoundEnvelope();
        this.field902.method319(0, arg1);
        this.field903 = new SoundEnvelope();
        this.field903.method319(0, arg1);
        int var3 = arg1.method239();
        if (var3 != 0) {
            arg1.field710--;
            this.field904 = new SoundEnvelope();
            this.field904.method319(0, arg1);
            this.field905 = new SoundEnvelope();
            this.field905.method319(0, arg1);
        }
        int var4 = arg1.method239();
        if (var4 != 0) {
            arg1.field710--;
            this.field906 = new SoundEnvelope();
            this.field906.method319(0, arg1);
            this.field907 = new SoundEnvelope();
            this.field907.method319(0, arg1);
        }
        ...
        if (var5 != 0) {
            arg1.field710--;
            this.field908 = new SoundEnvelope();
            this.field908.method319(0, arg1);
            this.field909 = new SoundEnvelope();
            this.field909.method319(0, arg1);
        }
