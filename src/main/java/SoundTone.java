    ...
    public final int[] generate(int arg0, int arg1) {
        ...
        if (this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) {
            ...
            if (arg0 >= var24 + var25) {
                ...
                while (var26 < var27) {
                    int var37 = (int) ((long) buffer[var24 + var26] * (long) SoundFilter.unity16 >> 16);
                    for (int var38 = 0; var38 < var24; var38++) {
                        var37 += (int) ((long) buffer[var24 + var26 - var38 - 1] * (long) SoundFilter.coefficient16[0][var38] >> 16);
                    }
                    for (int var39 = 0; var39 < var26; var39++) {
                        var37 -= (int) ((long) buffer[var26 - var39 - 1] * (long) SoundFilter.coefficient16[1][var39] >> 16);
                    }
                    buffer[var26] = var37;
                ...
                while (true) {
                    ...
                    while (var26 < var29) {
                        int var34 = (int) ((long) buffer[var24 + var26] * (long) SoundFilter.unity16 >> 16);
                        for (int var35 = 0; var35 < var24; var35++) {
                            var34 += (int) ((long) buffer[var24 + var26 - var35 - 1] * (long) SoundFilter.coefficient16[0][var35] >> 16);
                        }
                        for (int var36 = 0; var36 < var25; var36++) {
                            var34 -= (int) ((long) buffer[var26 - var36 - 1] * (long) SoundFilter.coefficient16[1][var36] >> 16);
                        }
                        buffer[var26] = var34;
                        var23 = this.filterRange.evaluate(true, arg0 + 1);
                        var26++;
                    ...
                    if (var26 >= arg0 - var24) {
                        while (var26 < arg0) {
                            ...
                            for (int var31 = var24 + var26 - arg0; var31 < var24; var31++) {
                                var30 += (int) ((long) buffer[var24 + var26 - var31 - 1] * (long) SoundFilter.coefficient16[0][var31] >> 16);
                            }
                            for (int var32 = 0; var32 < var25; var32++) {
                                var30 -= (int) ((long) buffer[var26 - var32 - 1] * (long) SoundFilter.coefficient16[1][var32] >> 16);
                            }
                            buffer[var26] = var30;
