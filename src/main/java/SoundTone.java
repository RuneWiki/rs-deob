...
public class SoundTone {
    ...
    @OriginalMember(owner = "client!zb", name = "b", descriptor = "Lxb;")
    private SoundEnvelope field772;

    @OriginalMember(owner = "client!zb", name = "c", descriptor = "Lxb;")
    private SoundEnvelope field773;

    @OriginalMember(owner = "client!zb", name = "d", descriptor = "Lxb;")
    private SoundEnvelope field774;
    ...
    @OriginalMember(owner = "client!zb", name = "y", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(Lkb;Z)V")
    public final void method279(Packet arg0, boolean arg1) {
        this.field772 = new SoundEnvelope();
        this.field772.method267(arg0, true);
        this.field773 = new SoundEnvelope();
        ...
        if (var3 != 0) {
            arg0.field624--;
            this.field774 = new SoundEnvelope();
