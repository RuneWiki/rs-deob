...
public class SoundTone {
    ...
    @OriginalMember(owner = "client!dc", name = "n", descriptor = "Lbc;")
    private SoundFilter field921;
    ...
    public final int[] method325(int arg0, int arg1) {
        ...
        if (this.field921.field889[0] > 0 || this.field921.field889[1] > 0) {
            ...
            if (arg0 >= var24 + var25) {
                ...
                while (var26 < var27) {
                    int var37 = (int) ((long) field925[var24 + var26] * (long) SoundFilter.field896 >> 16);
                    for (int var38 = 0; var38 < var24; var38++) {
                        var37 += (int) ((long) field925[var24 + var26 - var38 - 1] * (long) SoundFilter.field894[0][var38] >> 16);
                    }
                    for (int var39 = 0; var39 < var26; var39++) {
                        var37 -= (int) ((long) field925[var26 - var39 - 1] * (long) SoundFilter.field894[1][var39] >> 16);
                    }
                ...
                while (true) {
                    ...
                    while (var26 < var29) {
                        int var34 = (int) ((long) field925[var24 + var26] * (long) SoundFilter.field896 >> 16);
                        for (int var35 = 0; var35 < var24; var35++) {
                            var34 += (int) ((long) field925[var24 + var26 - var35 - 1] * (long) SoundFilter.field894[0][var35] >> 16);
                        }
                        for (int var36 = 0; var36 < var25; var36++) {
                            var34 -= (int) ((long) field925[var26 - var36 - 1] * (long) SoundFilter.field894[1][var36] >> 16);
                        }
                    ...
                    if (var26 >= arg0 - var24) {
                        while (var26 < arg0) {
                            ...
                            for (int var31 = var24 + var26 - arg0; var31 < var24; var31++) {
                                var30 += (int) ((long) field925[var24 + var26 - var31 - 1] * (long) SoundFilter.field894[0][var31] >> 16);
                            }
                            for (int var32 = 0; var32 < var25; var32++) {
                                var30 -= (int) ((long) field925[var26 - var32 - 1] * (long) SoundFilter.field894[1][var32] >> 16);
                            }
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIZI)I")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILlb;)V")
    public final void method327(int arg0, Packet arg1) {
        ...
        if (var3 != 0) {
            arg1.field703--;
            this.field910 = new SoundEnvelope();
            this.field910.method309(8, arg1);
            this.field911 = new SoundEnvelope();
            this.field911.method309(8, arg1);
        }
        int var4 = arg1.method229();
        if (var4 != 0) {
            arg1.field703--;
            this.field912 = new SoundEnvelope();
