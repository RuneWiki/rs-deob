...
public class class19 extends class14 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II[II[I)V", line = 58)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 116)
    public class19() {
        super(3, false);
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(IB)I", line = 127)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IBLmd;)V", line = 181)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II)[[I", line = 193)
