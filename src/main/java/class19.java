...
public class class19 extends class187 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([ILur;B[I[I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lal;IZLam;ZIID)[I")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lal;ILam;)Z")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lam;IZIILal;)[F")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lam;IZBILal;D)[I")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Ltq;)V")
