...
public class class19 {
    ...
    public class19(int[] arg0, boolean arg1) {
        if (arg1) {
            this.field776 = !this.field776;
        }
        this.field779 = new int[256];
        this.field778 = new int[256];
        for (int var3 = 0; var3 < arg0.length; var3++) {
            this.field778[var3] = arg0[var3];
        }
        this.method203();
    }
    ...
    public final int method201() {
        ...
        return this.field778[this.field777];
    }
    ...
    private final void method202() {
        ...
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field779[var1];
            if ((var1 & 0x3) == 0) {
                this.field780 ^= this.field780 << 13;
            } else if ((var1 & 0x3) == 1) {
                this.field780 ^= this.field780 >>> 6;
            } else if ((var1 & 0x3) == 2) {
                this.field780 ^= this.field780 << 2;
            } else if ((var1 & 0x3) == 3) {
                this.field780 ^= this.field780 >>> 16;
            }
            this.field780 += this.field779[var1 + 128 & 0xFF];
            int var3;
            this.field779[var1] = var3 = this.field779[var2 >> 2 & 0xFF] + this.field780 + this.field781;
            this.field778[var1] = this.field781 = this.field779[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }

    @OriginalMember(owner = "client!FKXPJREN", name = "c", descriptor = "()V")
    private final void method203() {
        int var1 = -1640531527;
        int var2 = -1640531527;
        int var3 = -1640531527;
        int var4 = -1640531527;
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field778[var10] + var8;
            int var37 = this.field778[var10 + 1] + var7;
            int var38 = this.field778[var10 + 2] + var6;
            int var39 = this.field778[var10 + 3] + var5;
            int var40 = this.field778[var10 + 4] + var4;
            int var41 = this.field778[var10 + 5] + var3;
            int var42 = this.field778[var10 + 6] + var2;
            int var43 = this.field778[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field779[var10] = var8;
            this.field779[var10 + 1] = var7;
            this.field779[var10 + 2] = var6;
            this.field779[var10 + 3] = var5;
            this.field779[var10 + 4] = var4;
            this.field779[var10 + 5] = var3;
            this.field779[var10 + 6] = var2;
            this.field779[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field779[var11] + var8;
            int var13 = this.field779[var11 + 1] + var7;
            int var14 = this.field779[var11 + 2] + var6;
            int var15 = this.field779[var11 + 3] + var5;
            int var16 = this.field779[var11 + 4] + var4;
            int var17 = this.field779[var11 + 5] + var3;
            int var18 = this.field779[var11 + 6] + var2;
            int var19 = this.field779[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field779[var11] = var8;
            this.field779[var11 + 1] = var7;
            this.field779[var11 + 2] = var6;
            this.field779[var11 + 3] = var5;
            this.field779[var11 + 4] = var4;
            this.field779[var11 + 5] = var3;
            this.field779[var11 + 6] = var2;
            this.field779[var11 + 7] = var1;
        }
        this.method202();
        this.field777 = 256;
    }
