...
public class class19 extends class67 implements class558 {
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Loa;Lya;Llq;[Liga;[Lfs;)V", line = 4)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(CIIIZLaa;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 35)
