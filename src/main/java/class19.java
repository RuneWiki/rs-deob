...
public class class19 {
    ...
    @OriginalMember(owner = "client!FEBLELGD", name = "c", descriptor = "LCYIKEZWP;")
    public class10 field747 = new class10();

    @OriginalMember(owner = "client!FEBLELGD", name = "a", descriptor = "I")
    private int field745;

    @OriginalMember(owner = "client!FEBLELGD", name = "d", descriptor = "LCYIKEZWP;")
    ...
    @OriginalMember(owner = "client!FEBLELGD", name = "a", descriptor = "(LCYIKEZWP;)V")
    ...
    @OriginalMember(owner = "client!FEBLELGD", name = "a", descriptor = "()LCYIKEZWP;")
    ...
    @OriginalMember(owner = "client!FEBLELGD", name = "b", descriptor = "()LCYIKEZWP;")
    ...
    @OriginalMember(owner = "client!FEBLELGD", name = "a", descriptor = "(I)LCYIKEZWP;")
