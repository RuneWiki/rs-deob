...
public class class19 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILjk;)I")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lco;ZI)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ln;Lgp;I)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lco;B)V")
