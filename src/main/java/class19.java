...
public class class19 extends class243 {
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(II)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "()V", line = 80)
    public class19() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILji;B)V", line = 97)
