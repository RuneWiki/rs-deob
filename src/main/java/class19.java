...
public class class19 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILtf;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lci;I)I", line = 29)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 97)
