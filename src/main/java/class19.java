...
public class class19 extends class95 {
    ...
    @OriginalMember(owner = "client!bh", name = "ab", descriptor = "Lbi;")
    ...
    @OriginalMember(owner = "client!bh", name = "cb", descriptor = "Llf;")
    public static class109 field414 = class35.method275("oder benutzen Sie eine andere Welt)3", 2);

    @OriginalMember(owner = "client!bh", name = "ib", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!bh", name = "fb", descriptor = "Lad;")
    public static class5 field417;

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)Lue;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZLbg;Lbg;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(IIIIIIIZLka;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(III)Llf;")
