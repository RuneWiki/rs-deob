...
public class class19 extends class539 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "([B)V", line = 39)
