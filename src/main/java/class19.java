...
public class class19 extends class214 {
    ...
    @OriginalMember(owner = "client!un", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "()V", line = 85)
    public class19() {
        super(0, true);
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BI)[I", line = 34)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BII)V", line = 102)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(III)Z", line = 138)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Llk;II)V", line = 176)
