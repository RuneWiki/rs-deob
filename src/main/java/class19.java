...
public class class19 extends class295 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BLrk;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lsf;)V", line = 48)
