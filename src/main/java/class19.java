...
public class class19 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Ljava/awt/Color;ZLjava/awt/Color;Ljava/lang/String;ILjava/awt/Color;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IILjava/lang/String;)V", line = 108)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILja;)V", line = 122)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)V", line = 140)
