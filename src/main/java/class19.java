...
public class class19 {
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Ltt;)V", line = 384)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)I", line = 20)
    public static int method118(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BJ)V", line = 29)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)Lub;", line = 50)
