...
public class class19 extends class67 implements class558 {
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(CIIIZLaa;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Loa;Lya;Leb;[Lvf;[Lhh;)V", line = 17)
