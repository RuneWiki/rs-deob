...
@OriginalClass("client!FWGUGZKU")
public class class19 {

    @OriginalMember(owner = "client!FWGUGZKU", name = "a", descriptor = "B")
    private byte field746 = 55;

    @OriginalMember(owner = "client!FWGUGZKU", name = "c", descriptor = "I")
    public int field748 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "e", descriptor = "I")
    public int field750 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "h", descriptor = "I")
    public int field753 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "j", descriptor = "Z")
    public boolean field755 = false;

    @OriginalMember(owner = "client!FWGUGZKU", name = "p", descriptor = "I")
    private int field761 = -37665;

    @OriginalMember(owner = "client!FWGUGZKU", name = "s", descriptor = "B")
    private byte field764 = -125;

    @OriginalMember(owner = "client!FWGUGZKU", name = "u", descriptor = "I")
    public int field766 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "v", descriptor = "I")
    public int field767 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "w", descriptor = "B")
    public byte field768 = 1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "x", descriptor = "Z")
    public boolean field769 = true;

    @OriginalMember(owner = "client!FWGUGZKU", name = "z", descriptor = "I")
    private int field771 = 128;

    @OriginalMember(owner = "client!FWGUGZKU", name = "B", descriptor = "I")
    public int field773 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "C", descriptor = "I")
    public int field774 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "D", descriptor = "I")
    public int field775 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "E", descriptor = "I")
    public int field776 = 32;

    @OriginalMember(owner = "client!FWGUGZKU", name = "F", descriptor = "Z")
    private boolean field777 = false;

    @OriginalMember(owner = "client!FWGUGZKU", name = "G", descriptor = "I")
    public int field778 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "H", descriptor = "I")
    private int field779 = 128;

    @OriginalMember(owner = "client!FWGUGZKU", name = "I", descriptor = "I")
    public int field780 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "K", descriptor = "Z")
    public boolean field782 = true;

    @OriginalMember(owner = "client!FWGUGZKU", name = "L", descriptor = "I")
    public int field783 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "M", descriptor = "J")
    public long field784 = -1L;

    @OriginalMember(owner = "client!FWGUGZKU", name = "N", descriptor = "I")
    public int field785 = -1;

    @OriginalMember(owner = "client!FWGUGZKU", name = "f", descriptor = "LGOPFMRDJ;")
    public static class22 field751 = new class22(639, 30);

    @OriginalMember(owner = "client!FWGUGZKU", name = "d", descriptor = "I")
    private int field749;

    @OriginalMember(owner = "client!FWGUGZKU", name = "k", descriptor = "I")
    public static int field756;

    @OriginalMember(owner = "client!FWGUGZKU", name = "t", descriptor = "I")
    private int field765;

    @OriginalMember(owner = "client!FWGUGZKU", name = "A", descriptor = "I")
    private int field772;

    @OriginalMember(owner = "client!FWGUGZKU", name = "O", descriptor = "I")
    private static int field786;

    @OriginalMember(owner = "client!FWGUGZKU", name = "m", descriptor = "LXQPFGONL;")
    private static class62 field758;

    @OriginalMember(owner = "client!FWGUGZKU", name = "q", descriptor = "Lclient;")
    public static client field762;

    @OriginalMember(owner = "client!FWGUGZKU", name = "P", descriptor = "Ljava/lang/String;")
    public String field787;

    @OriginalMember(owner = "client!FWGUGZKU", name = "i", descriptor = "[B")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "r", descriptor = "[I")
    private int[] field763;

    @OriginalMember(owner = "client!FWGUGZKU", name = "y", descriptor = "[I")
    private int[] field770;

    @OriginalMember(owner = "client!FWGUGZKU", name = "J", descriptor = "[I")
    private static int[] field781;

    @OriginalMember(owner = "client!FWGUGZKU", name = "g", descriptor = "[LFWGUGZKU;")
    private static class19[] field752;

    @OriginalMember(owner = "client!FWGUGZKU", name = "n", descriptor = "[Ljava/lang/String;")
    public String[] field759;

    @OriginalMember(owner = "client!FWGUGZKU", name = "a", descriptor = "(LXQPFGONL;I)V")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "a", descriptor = "(Z)LFWGUGZKU;")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "b", descriptor = "(I)LFWGUGZKU;")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "a", descriptor = "(LXMRRKSSB;)V")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "a", descriptor = "(BI[II)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!FWGUGZKU", name = "c", descriptor = "(I)LITSMSHJO;")
