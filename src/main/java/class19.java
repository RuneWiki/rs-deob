...
public class class19 extends class381 implements class351 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lnr;II)Lqc;", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Lnr;Z)Lg;", line = 28)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BILnr;)Lqc;", line = 65)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(B)I", line = 75)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lqj;Lfl;B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(B)Z", line = 108)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BI)V", line = 124)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILnr;)V", line = 165)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZLnr;IB)Lbc;", line = 201)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lnr;Lta;IIIIZIZ)V", line = 231)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lnr;Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(CI)C", line = 293)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(B)V", line = 691)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILnr;II)Z", line = 704)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)I", line = 729)
    public final int method160(int arg0) {
        ++field328;
        return arg0 != -22056 ? -106 : 22;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lnr;I)V", line = 747)
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(I)V", line = 757)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(I)V", line = 768)
