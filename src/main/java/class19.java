...
public class class19 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILbh;IB)V", line = 61)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 93)
