...
@OriginalClass("client!GLPEJJEY")
public class class19 extends class39 {

    @OriginalMember(owner = "client!GLPEJJEY", name = "w", descriptor = "Z")
    private boolean field885 = false;

    @OriginalMember(owner = "client!GLPEJJEY", name = "x", descriptor = "Z")
    private boolean field886 = false;

    @OriginalMember(owner = "client!GLPEJJEY", name = "y", descriptor = "Z")
    private boolean field887 = false;

    @OriginalMember(owner = "client!GLPEJJEY", name = "z", descriptor = "I")
    private int field888 = 432;

    @OriginalMember(owner = "client!GLPEJJEY", name = "A", descriptor = "I")
    private int field889 = -906;

    @OriginalMember(owner = "client!GLPEJJEY", name = "B", descriptor = "Z")
    private boolean field890 = true;

    @OriginalMember(owner = "client!GLPEJJEY", name = "C", descriptor = "I")
    private int field891 = -630;

    @OriginalMember(owner = "client!GLPEJJEY", name = "D", descriptor = "I")
    private int field892 = 23626;

    @OriginalMember(owner = "client!GLPEJJEY", name = "K", descriptor = "I")
    public int field899;

    @OriginalMember(owner = "client!GLPEJJEY", name = "L", descriptor = "I")
    public int field900;

    @OriginalMember(owner = "client!GLPEJJEY", name = "F", descriptor = "[I")
    public int[] field894;

    @OriginalMember(owner = "client!GLPEJJEY", name = "I", descriptor = "I")
    public int field897;

    @OriginalMember(owner = "client!GLPEJJEY", name = "J", descriptor = "I")
    public int field898;

    @OriginalMember(owner = "client!GLPEJJEY", name = "G", descriptor = "I")
    public int field895;

    @OriginalMember(owner = "client!GLPEJJEY", name = "H", descriptor = "I")
    public int field896;

    @OriginalMember(owner = "client!GLPEJJEY", name = "E", descriptor = "[B")
    public byte[] field893;

    @OriginalMember(owner = "client!GLPEJJEY", name = "<init>", descriptor = "(LSYUGXMZF;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "a", descriptor = "(IIBI)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "a", descriptor = "(IIB)V")
    ...
    @OriginalMember(owner = "client!GLPEJJEY", name = "a", descriptor = "(I[I[IIII[BIIZ)V")
