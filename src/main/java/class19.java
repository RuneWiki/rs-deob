...
public class class19 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 4)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(I)[I", line = 17)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "()V", line = 34)
    public class19() {
        this.field254.initialize(null);
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(ILjava/awt/Frame;ZIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!lga", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 64)
