...
public class class19 {
    ...
    @OriginalMember(owner = "client!GQFZPMGS", name = "d", descriptor = "[LGQFZPMGS;")
    public static class19[] field742;

    @OriginalMember(owner = "client!GQFZPMGS", name = "a", descriptor = "(LBYZSQZUF;Z)V")
    ...
    @OriginalMember(owner = "client!GQFZPMGS", name = "a", descriptor = "(ILIMUIZRAF;)V")
