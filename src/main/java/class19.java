...
public class class19 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lpi;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZILjava/awt/Component;)Liq;", line = 76)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BI)V", line = 87)
