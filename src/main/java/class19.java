...
public class class19 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)Lkp;", line = 15)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILbu;Lkp;)V", line = 40)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILkp;)V", line = 84)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(B)Lkp;", line = 101)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)Lkp;", line = 127)
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(I)Lkp;", line = 154)
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(I)I", line = 175)
    ...
    @OriginalMember(owner = "client!bu", name = "e", descriptor = "(I)Lkp;", line = 194)
    ...
    @OriginalMember(owner = "client!bu", name = "f", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "()V", line = 262)
    public class19() {
        this.field179.field5645 = this.field179;
        this.field179.field5648 = this.field179;
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lbu;I)V", line = 235)
    public final void method130(class19 arg0, int arg1) {
        field187++;
        this.method121(arg1 ^ arg1, arg0, this.field179.field5645);
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lkp;I)V", line = 245)
