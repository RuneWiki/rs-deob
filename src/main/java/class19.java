...
public class class19 extends class30 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Le;Lah;I)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljg;II)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lel;Lbr;IBILe;)Z")
