...
public class class19 extends class424 {
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "()V", line = 136)
    public class19() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IB)[I", line = 42)
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lrg;BI)V", line = 160)
    ...
    @OriginalMember(owner = "client!ko", name = "h", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIIIBIII)V", line = 241)
