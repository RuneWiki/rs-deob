...
public class class19 extends class525 implements class463 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIB[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lkd;I[BIZ)V", line = 14)
    public class19(class188 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field240 = arg1;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!qo", name = "e", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qo", name = "f", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)J", line = 56)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIIIIZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)V", line = 117)
