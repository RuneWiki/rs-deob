...
public class class19 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 8)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(I)V", line = 89)
    public class19(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljava/lang/Object;JII)V", line = 93)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI)V", line = 136)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILmga;)V", line = 186)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 204)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 226)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)I", line = 260)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(I)I", line = 290)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(II)V", line = 381)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 322)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(JI)V", line = 356)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IJLjava/lang/Object;)V", line = 369)
