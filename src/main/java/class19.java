...
public class class19 extends class53 {
    ...
    @OriginalMember(owner = "client!IBHVCUAH", name = "<init>", descriptor = "(LRVLWVPJQ;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!IBHVCUAH", name = "a", descriptor = "(ZILXHDQQNIR;I)V")
