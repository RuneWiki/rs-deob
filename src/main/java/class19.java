...
@OriginalClass("client!FCRLGSQA")
public class class19 extends class26 {

    @OriginalMember(owner = "client!FCRLGSQA", name = "x", descriptor = "Z")
    private boolean field793 = false;

    @OriginalMember(owner = "client!FCRLGSQA", name = "y", descriptor = "I")
    private int field794 = 1914;

    @OriginalMember(owner = "client!FCRLGSQA", name = "z", descriptor = "I")
    private int field795 = 9;

    @OriginalMember(owner = "client!FCRLGSQA", name = "A", descriptor = "I")
    private int field796 = 9;

    @OriginalMember(owner = "client!FCRLGSQA", name = "B", descriptor = "Z")
    private boolean field797 = true;

    @OriginalMember(owner = "client!FCRLGSQA", name = "I", descriptor = "I")
    public int field804;

    @OriginalMember(owner = "client!FCRLGSQA", name = "J", descriptor = "I")
    public int field805;

    @OriginalMember(owner = "client!FCRLGSQA", name = "D", descriptor = "[I")
    public int[] field799;

    @OriginalMember(owner = "client!FCRLGSQA", name = "G", descriptor = "I")
    public int field802;

    @OriginalMember(owner = "client!FCRLGSQA", name = "H", descriptor = "I")
    public int field803;

    @OriginalMember(owner = "client!FCRLGSQA", name = "E", descriptor = "I")
    public int field800;

    @OriginalMember(owner = "client!FCRLGSQA", name = "F", descriptor = "I")
    public int field801;

    @OriginalMember(owner = "client!FCRLGSQA", name = "C", descriptor = "[B")
    public byte[] field798;

    @OriginalMember(owner = "client!FCRLGSQA", name = "<init>", descriptor = "(LBBMKAXRK;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!FCRLGSQA", name = "a", descriptor = "(I[III[BIII[II)V")
