...
public class class19 {
            ...
            if (var6 != 0) {
                ...
                for (int var9 = 0; var9 < var6; var9++) {
                    ...
                    if ((var7 & var10) == 0) {
                        ...
                        if (this.field311[var8] == 0) {
                            this.field311[var8] = var4;
                        }
                        var8 = this.field311[var8];
                    }
                    if (var8 >= this.field311.length) {
                        int[] var11 = new int[this.field311.length * 2];
                        for (int var12 = 0; var12 < this.field311.length; var12++) {
                            var11[var12] = this.field311[var12];
                        }
                        this.field311 = var11;
                    }
                    int var13 = var10 >>> 1;
                }
                this.field311[var8] = ~var5;
                if (var8 >= var4) {
                    var4 = var8 + 1;
                }
            }
    ...
    public final int method95() {
        int var1;
        for (var1 = 0; this.field311[var1] >= 0; var1 = class195.method1350() == 0 ? var1 + 1 : this.field311[var1]) {
        }
    ...
    private static final int method96(int arg0, int arg1) {
        int var2;
        for (var2 = (int) Math.pow((double) arg0, 1.0D / (double) arg1) + 1; class80.method534(var2, (byte) 7, arg1) > arg0; var2--) {
        }
        return var2;
    }
    ...
    public class19() {
        class195.method1355(24);
        this.field308 = class195.method1355(16);
        this.field309 = class195.method1355(24);
        this.field307 = new int[this.field309];
        boolean var1 = class195.method1350() != 0;
        if (var1) {
            int var2 = 0;
            int var3 = class195.method1355(5) + 1;
            while (var2 < this.field309) {
                int var4 = class195.method1355(class55.method407(this.field309 - var2, -13816));
            ...
            for (int var7 = 0; var7 < this.field309; var7++) {
                if (var6 && class195.method1350() == 0) {
                    this.field307[var7] = 0;
                } else {
                    this.field307[var7] = class195.method1355(5) + 1;
                }
            }
        }
        this.method93();
        int var8 = class195.method1355(4);
        if (var8 > 0) {
            float var9 = class195.method1353(class195.method1355(32));
            float var10 = class195.method1353(class195.method1355(32));
            int var11 = class195.method1355(4) + 1;
            boolean var12 = class195.method1350() != 0;
            int var13;
            if (var8 == 1) {
            ...
            for (int var14 = 0; var14 < var13; var14++) {
                this.field310[var14] = class195.method1355(var11);
            }
