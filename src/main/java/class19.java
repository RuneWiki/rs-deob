...
public class class19 {
    ...
    @OriginalMember(owner = "client!HCUFYAUI", name = "c", descriptor = "[LHCUFYAUI;")
    public static class19[] field721;

    @OriginalMember(owner = "client!HCUFYAUI", name = "a", descriptor = "(LFNOQZAYQ;I)V")
    ...
    @OriginalMember(owner = "client!HCUFYAUI", name = "a", descriptor = "(LDNRIFKTO;I)V")
