...
public class class19 extends class12 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/awt/Frame;Lam;B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILen;B)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIB)I", line = 85)
