...
public class class19 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(III)Lpk;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BLer;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ler;IB)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lg;I)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lnq;BI)Lk;")
