...
public class class19 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lug;B)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZII)Ljk;")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lug;ZI)V")
