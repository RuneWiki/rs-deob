...
public abstract class class19 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(III)Lbq;", line = 18)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Ldn;Ldn;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Z)Z", line = 129)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)Z", line = 140)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BI)V", line = 151)
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 193)
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(I)Z", line = 236)
