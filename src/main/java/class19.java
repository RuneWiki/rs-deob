...
public class class19 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZZB)V")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BLjava/lang/String;IZ)Z")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIIII)Z")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Leea;JI)V")
