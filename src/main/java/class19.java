...
public class class19 {
    ...
    @OriginalMember(owner = "client!nf", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field201++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ZZ)Z", line = 14)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Lofa;I)V", line = 76)
