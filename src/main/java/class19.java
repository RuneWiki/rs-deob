...
public class class19 extends class361 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILoi;Ll;ZIZ)[F", line = 16)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIILl;DLoi;Z)[I", line = 136)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILoi;IIZLl;DZ)[I", line = 271)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILih;[Lkt;)Lre;", line = 407)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Ll;BLoi;)Z", line = 486)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 538)
    public class19() {
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lwm;)V", line = 553)
