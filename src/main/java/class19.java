...
public class class19 extends class634 {
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(BI)[I", line = 127)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "()V", line = 359)
    public class19() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILig;Z)V", line = 270)
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(B)V", line = 332)
