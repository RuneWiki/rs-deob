...
public class class19 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IBZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZLwg;)I", line = 85)
