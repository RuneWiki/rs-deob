...
public class class19 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpl;IIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)V", line = 96)
