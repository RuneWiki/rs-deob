...
public class class19 extends class395 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lmt;)Lbu;", line = 3)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
