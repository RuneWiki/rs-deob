...
public class class19 extends class657 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZLjava/awt/Component;)Lrt;")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lok;II[BI)V")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Ld;I)V")
