...
@OriginalClass("client!IMXTJGZE")
public class class19 {

    @OriginalMember(owner = "client!IMXTJGZE", name = "c", descriptor = "I")
    private int field859 = 956;

    @OriginalMember(owner = "client!IMXTJGZE", name = "h", descriptor = "I")
    public int field864 = -1;

    @OriginalMember(owner = "client!IMXTJGZE", name = "i", descriptor = "Z")
    public boolean field865 = false;

    @OriginalMember(owner = "client!IMXTJGZE", name = "j", descriptor = "Z")
    public boolean field866 = true;

    @OriginalMember(owner = "client!IMXTJGZE", name = "a", descriptor = "I")
    private static int field857 = -302;

    @OriginalMember(owner = "client!IMXTJGZE", name = "b", descriptor = "I")
    private static int field858;

    @OriginalMember(owner = "client!IMXTJGZE", name = "d", descriptor = "I")
    public static int field860;

    @OriginalMember(owner = "client!IMXTJGZE", name = "g", descriptor = "I")
    public int field863;

    @OriginalMember(owner = "client!IMXTJGZE", name = "k", descriptor = "I")
    public int field867;

    @OriginalMember(owner = "client!IMXTJGZE", name = "l", descriptor = "I")
    public int field868;

    @OriginalMember(owner = "client!IMXTJGZE", name = "m", descriptor = "I")
    public int field869;

    @OriginalMember(owner = "client!IMXTJGZE", name = "n", descriptor = "I")
    public int field870;

    @OriginalMember(owner = "client!IMXTJGZE", name = "o", descriptor = "I")
    public int field871;

    @OriginalMember(owner = "client!IMXTJGZE", name = "p", descriptor = "I")
    public int field872;

    @OriginalMember(owner = "client!IMXTJGZE", name = "f", descriptor = "Ljava/lang/String;")
    public String field862;

    @OriginalMember(owner = "client!IMXTJGZE", name = "e", descriptor = "[LIMXTJGZE;")
    public static class19[] field861;

    @OriginalMember(owner = "client!IMXTJGZE", name = "a", descriptor = "(LLYZBHNJP;I)V")
    ...
    @OriginalMember(owner = "client!IMXTJGZE", name = "a", descriptor = "(LZOMNSJJM;B)V")
    ...
    @OriginalMember(owner = "client!IMXTJGZE", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!IMXTJGZE", name = "a", descriptor = "(III)I")
