...
public class class19 extends class477 {
    ...
    @OriginalMember(owner = "client!ch", name = "g", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z)V", line = 31)
    public static final void method105(boolean arg0) {
        ++field178;
        class73.field938 = class170.method1135(8, 35, 4, arg0, 8, (byte) 23, 2048, 0.4F);
    }

    @OriginalMember(owner = "client!ch", name = "h", descriptor = "(I)J", line = 48)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Z)I", line = 59)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(B)I", line = 71)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I[Lxa;)V", line = 88)
    ...
    @OriginalMember(owner = "client!ch", name = "i", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(II)V", line = 131)
