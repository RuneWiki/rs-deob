...
public abstract class class749 extends class420 {
    ...
    @OriginalMember(owner = "client!dr", name = "d", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "([Luf;Z)I")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lha;ZIZ)Lda;")
