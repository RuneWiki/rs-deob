...
public class class749 extends class13 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ld;IIZDLin;B)[I", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ld;Lin;I)Z", line = 150)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILd;IZDZLin;I)[I", line = 205)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILd;ZILin;I)[F", line = 338)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(B)V", line = 450)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "()V", line = 466)
    public class749() {
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lcea;)V", line = 482)
