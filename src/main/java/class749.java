...
public class class749 extends class601 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(ILqea;)V", line = 44)
    public class749(int arg0, class339 arg1) {
        super(arg0, arg1);
        class232.method1497(super.field8131, 0);
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(II)V", line = 170)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)I", line = 182)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(I)Z", line = 213)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lqea;)V", line = 234)
