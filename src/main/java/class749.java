...
public class class749 implements Runnable {
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)Z", line = 33)
    ...
    @OriginalMember(owner = "client!jn", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([IILfb;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILal;Lal;)V", line = 189)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 325)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([BZII)I", line = 213)
    ...
    @OriginalMember(owner = "client!jn", name = "run", descriptor = "()V", line = 256)
    ...
    @OriginalMember(owner = "client!jn", name = "d", descriptor = "(I)V", line = 313)
