...
public class class749 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Z)V", line = 49)
