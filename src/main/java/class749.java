...
public class class749 implements class666 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lsia;III)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ldw;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILsia;)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljc;III)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljc;IIII)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILma;II)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lrda;)V")
