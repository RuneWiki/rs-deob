...
public class class749 extends class58 {
    ...
    @OriginalMember(owner = "client!lr", name = "r", descriptor = "()Loba;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "g", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[I[I)Laa;")
    public final class485 method345(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class303(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIZ)Lhu;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIII)Lkm;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lpca;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ljava/lang/Runnable;)Lij;")
    ...
    @OriginalMember(owner = "client!lr", name = "A", descriptor = "(ILaa;II)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lkm;Lkm;FLkm;)Lkm;")
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Luk;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lkv;Liaa;)Ljj;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([IIIIIZ)Lhu;")
    ...
    @OriginalMember(owner = "client!lr", name = "u", descriptor = "()Ldfa;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)Liaa;")
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(II)Lkv;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lgi;IIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lur;[Lg;Z)Lda;")
    ...
    @OriginalMember(owner = "client!lr", name = "x", descriptor = "()Ldfa;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[[I[[IIII)Ls;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[Lada;)V")
    public final void method321(int arg0, class163[] arg1) {
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ldfa;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIILaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIF)Lada;")
    public final class163 method368(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lpca;I)V")
    ...
    @OriginalMember(owner = "client!lr", name = "j", descriptor = "()Ldfa;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lkm;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ljj;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIZ)Lhu;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lg;Z)Lhu;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIIIILaa;II)V")
