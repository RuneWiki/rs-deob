...
public abstract class class749 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IBLhn;Lgs;)V", line = 8)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)V", line = 77)
    public static void method4166(byte arg0) {
        int var1 = 126 % ((arg0 + 6) / 61);
        field10472 = null;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BI)I", line = 87)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([BII)V", line = 113)
    ...
    @OriginalMember(owner = "client!lr", name = "finalize", descriptor = "()V", line = 139)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[Ldm;IIIZIIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Loea;I[BIZ)V", line = 1000)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Loea;ILjaclib/memory/Buffer;IZ)V", line = 1019)
