...
public class class749 extends class659 {
    ...
    @OriginalMember(owner = "client!dr", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Leha;)V", line = 51)
    public class749(class98 arg0) {
        this.field10087 = arg0;
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILha;Lmu;IIIIIILka;IIII)Lka;", line = 59)
