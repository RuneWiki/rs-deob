...
public class class749 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!rf", name = "toString", descriptor = "()Ljava/lang/String;", line = 244)
    public final String toString() {
        field10444++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)Z", line = 260)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IIII)I", line = 272)
