...
public class class749 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(B)Ldw;", line = 16)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Ldw;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(I)V", line = 102)
    public class749(int arg0) {
        this.field10344 = arg0;
    }

    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(IIIIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lfca;I)Lgha;", line = 86)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 122)
