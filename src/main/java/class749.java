...
public class class749 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ZI)I", line = 19)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILhg;Z)V", line = 62)
