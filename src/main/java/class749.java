...
public class class749 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(II)Lbp;", line = 28)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lml;Ld;)V", line = 85)
