...
public class DoublyLinkList {
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "Lw;")
    public DoublyLinkable field752 = new DoublyLinkable();

    @OriginalMember(owner = "client!qb", name = "d", descriptor = "Lw;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lw;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "()Lw;")
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "()Lw;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)Lw;")
