...
public class DoublyLinkList {
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "Lw;")
    public DoublyLinkable field739 = new DoublyLinkable();

    @OriginalMember(owner = "client!pb", name = "d", descriptor = "Lw;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lw;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "()Lw;")
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "()Lw;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)Lw;")
