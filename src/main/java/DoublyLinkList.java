...
public class DoublyLinkList {
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "Lx;")
    public DoublyLinkable field748 = new DoublyLinkable();

    @OriginalMember(owner = "client!qb", name = "e", descriptor = "Lx;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lx;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "()Lx;")
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "()Lx;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)Lx;")
