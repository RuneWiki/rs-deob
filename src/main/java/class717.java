...
public class class717 extends class163 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B[Ljava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IBII)V", line = 55)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IF)V", line = 65)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(IIIIIF)V", line = 79)
    public class717(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I[BLjava/io/File;I)V", line = 100)
