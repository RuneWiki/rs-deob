...
public abstract class class717 extends class168 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "([Ljava/lang/Object;IIB[J)V", line = 3)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)Z", line = 66)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILlea;)V", line = 105)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BI)I", line = 126)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 137)
