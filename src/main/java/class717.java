...
public class class717 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILng;)V")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lda;)V")
    public class717(class66 arg0) {
        this.field9941 = arg0;
    }

    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lda;Lie;)V")
