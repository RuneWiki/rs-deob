...
public class class717 extends class170 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IBILrfa;ZILha;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lqca;I)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lha;B)Lsba;")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(ZLha;)Lrs;")
