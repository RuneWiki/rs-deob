...
public class class717 extends class281 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IBI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)Z", line = 22)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BI)Z", line = 35)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZI)Z", line = 49)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lgea;I)Ljava/lang/String;", line = 67)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(I)V", line = 77)
    public class717(int arg0) {
        this.field10006 = arg0;
    }

    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(B)Z", line = 85)
