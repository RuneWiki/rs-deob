...
public class class717 implements Runnable {
    ...
    @OriginalMember(owner = "client!bda", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BLjava/lang/String;)Lov;", line = 85)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "()V", line = 113)
    public class717() {
        this.field10115.setDaemon(true);
        this.field10115.start();
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILqm;)V", line = 126)
