...
public class class717 extends class524 implements class237 {
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(BLha;)Lhga;")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ldja;I)V")
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(Lha;B)Ldg;")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lha;Lij;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BLha;)V")
