...
public class class717 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(III[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIB)I", line = 33)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(I)V", line = 79)
