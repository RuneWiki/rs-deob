...
public class class717 implements Runnable {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lmba;I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILme;Lme;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZIILot;ILla;I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(I)Lgl;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(JZLgl;ILjava/lang/String;)V")
