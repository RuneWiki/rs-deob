...
public class class717 extends class748 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZLvj;)V", line = 56)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lha;B)V", line = 69)
    ...
    @OriginalMember(owner = "client!qp", name = "g", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(II)[[I", line = 100)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "()V", line = 178)
    public class717() {
        super(3, false);
    }
}
