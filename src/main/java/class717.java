...
public class class717 extends class69 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLpfa;ILgf;ZIIILha;I)Lka;", line = 7)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II[I[IZ)J", line = 250)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([Loq;II)V", line = 291)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)V", line = 331)
