...
public class class717 implements class187 {
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!nk", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IJ)Z", line = 77)
    ...
    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lie;Lvu;)V", line = 132)
    ...
    @OriginalMember(owner = "client!nk", name = "e", descriptor = "(I)V", line = 150)
