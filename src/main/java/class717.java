...
public class class717 extends class227 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IBIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZIZI)V", line = 206)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZB)I", line = 245)
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(I)V", line = 287)
    public static void method3959(int arg0) {
        int var1 = 7 / ((52 - arg0) / 52);
        field10055 = null;
    }

    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lla;Lla;Lor;)V", line = 296)
    public class717(class422 arg0, class422 arg1, class325 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lraa;B)V", line = 301)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)Z", line = 316)
