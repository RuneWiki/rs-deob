...
public class class717 extends class610 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "()V", line = 23)
    public class717() {
        this.field9411 = System.nanoTime();
        this.field9412 = System.nanoTime();
    }

    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(B)J", line = 33)
    ...
    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(I)J", line = 50)
    public final long method839(int arg0) {
        int var2 = -16 % ((44 - arg0) / 37);
        return this.field9411;
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IJ)I", line = 58)
    ...
    @OriginalMember(owner = "client!oda", name = "d", descriptor = "(I)J", line = 98)
