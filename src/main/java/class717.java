...
public class class717 extends IOException {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLkja;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 87)
    public class717(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III)Z", line = 95)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BI)I", line = 118)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 131)
