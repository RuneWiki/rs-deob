...
public class class783 extends class325 {
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(IB)[[I", line = 252)
    ...
    @OriginalMember(owner = "client!fja", name = "e", descriptor = "(B)V", line = 568)
    ...
    @OriginalMember(owner = "client!fja", name = "<init>", descriptor = "()V", line = 675)
    public class783() {
        super(2, false);
    }

    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Ljp;IB)V", line = 585)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(IIII)I", line = 647)
