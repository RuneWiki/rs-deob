...
public class class783 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IB)Lih;")
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IZII[Luaa;I)V")
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lega;IZLwm;Lwm;)V")
