...
public class class783 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILgga;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILqf;)Z", line = 19)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Laaa;Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "()V", line = 113)
    public class783() {
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lgga;)V", line = 129)
