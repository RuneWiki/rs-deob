...
public class class783 {
    ...
    @OriginalMember(owner = "client!fja", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field10754++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!fja", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fja", name = "<init>", descriptor = "(II)V", line = 40)
