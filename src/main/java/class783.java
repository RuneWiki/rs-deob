...
public class class783 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IZLgl;)V", line = 35)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIBIZ)Lsv;", line = 167)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!mo", name = "h", descriptor = "(I)Z", line = 224)
    ...
    @OriginalMember(owner = "client!mo", name = "j", descriptor = "(I)V", line = 498)
    ...
    @OriginalMember(owner = "client!mo", name = "d", descriptor = "(I)I", line = 509)
    ...
    @OriginalMember(owner = "client!mo", name = "g", descriptor = "(I)V", line = 524)
    ...
    @OriginalMember(owner = "client!mo", name = "f", descriptor = "(I)V", line = 552)
    ...
    @OriginalMember(owner = "client!mo", name = "k", descriptor = "(I)Z", line = 568)
    ...
    @OriginalMember(owner = "client!mo", name = "e", descriptor = "(I)Z", line = 583)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(I)I", line = 596)
    ...
    @OriginalMember(owner = "client!mo", name = "i", descriptor = "(I)V", line = 608)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 636)
