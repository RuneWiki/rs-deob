...
public class class783 extends class114 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILwfa;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljc;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 51)
