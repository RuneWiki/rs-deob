...
public class class783 implements class385 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILjava/lang/String;ILda;B)I", line = 17)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lmt;Lkh;)V", line = 41)
    public class783(class469 arg0, class368 arg1) {
        this.field10722 = arg1;
        this.field10723 = arg0;
    }

    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZI)V", line = 61)
