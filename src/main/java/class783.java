...
public class class783 implements class167 {
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(IIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Lbn;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 143)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(IB)I", line = 169)
    ...
    @OriginalMember(owner = "client!fja", name = "<init>", descriptor = "(Lbt;Lvn;)V", line = 186)
    public class783(class48 arg0, class332 arg1) {
        this.field10799 = arg1;
        this.field10802 = arg0;
    }

    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!fja", name = "b", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(IZ)V", line = 220)
    ...
    @OriginalMember(owner = "client!fja", name = "b", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(II)Z", line = 260)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(I)Z", line = 274)
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(BI)Z", line = 293)
