...
public class class731 extends class667 {
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZI)[[I", line = 55)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 119)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 154)
    public class731() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(III)Z", line = 143)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lud;II)V", line = 160)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lud;B)Lrn;", line = 204)
