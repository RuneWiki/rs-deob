...
public class class731 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I[BIII[B)I", line = 5)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IZB)V", line = 79)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(II)Lvha;", line = 121)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "([BIII[BB)I", line = 155)
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "([B)V", line = 310)
