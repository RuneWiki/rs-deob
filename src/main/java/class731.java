...
public class class731 extends class651 {
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lur;Lcf;IIIIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BLha;)V", line = 35)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(B)Lhv;", line = 73)
    public class546 method1557(byte arg0) {
        field10139++;
        return arg0 >= -35 ? null : class10.field159;
    }

    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(I)Lkf;", line = 91)
