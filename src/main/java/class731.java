...
public class class731 extends class728 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Z)Lb;")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
