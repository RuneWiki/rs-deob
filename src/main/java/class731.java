...
public class class731 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Leea;Lgk;Lio;IIIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IBI[B)V", line = 125)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BLjava/io/File;Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IBLsn;)V", line = 170)
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(I)V", line = 196)
