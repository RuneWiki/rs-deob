...
public abstract class class731 extends class69 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIB)I", line = 127)
