...
public class class731 extends class249 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ZZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lme;ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lwh;)V", line = 77)
    public class731(class148 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZ)V", line = 93)
