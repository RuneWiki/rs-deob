...
public class class731 implements Runnable {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILjava/lang/String;IZ)Leha;", line = 5)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 706)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIII)Leha;", line = 34)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BZLjava/lang/String;)Leha;", line = 43)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)Leha;", line = 57)
    public final class162 method4057(int arg0, int arg1) {
        return arg0 == 31358 ? this.method4058(arg0 - 58878, 0, null, arg1, 3) : null;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILjava/lang/Object;II)Leha;", line = 71)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZLjava/net/URL;)Leha;", line = 100)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!fc", name = "run", descriptor = "()V", line = 173)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)Z", line = 471)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(I)Leha;", line = 493)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[BLjava/io/File;)Z", line = 507)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Leha;", line = 527)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/lang/String;Z)Ldq;", line = 552)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILjava/lang/Runnable;I)Leha;", line = 563)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Ldq;", line = 592)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/Class;Ljava/lang/String;)Leha;", line = 634)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 644)
    public final Object method4069(boolean arg0) {
        return arg0 ? this.field10267 : null;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/awt/Point;I[IBILjava/awt/Component;)Leha;", line = 657)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Ljava/awt/Frame;I)Leha;", line = 667)
    public final class162 method4071(Frame arg0, int arg1) {
        int var3 = 53 % ((arg1 - 47) / 44);
        return this.method4058(-27520, 0, arg0, 0, 7);
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILjava/lang/String;)Leha;", line = 686)
