...
public class class731 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Lsp;", line = 33)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIBIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 251)
