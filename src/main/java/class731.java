...
public abstract class class731 extends class568 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(Z)I", line = 38)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(I)F", line = 73)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIJ)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(IIIIIF)V", line = 125)
