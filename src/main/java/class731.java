...
public class class731 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILsl;)Lkn;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I[IBI)Lct;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([IIB)Lct;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I[IB)Lct;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILd;Lnd;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([IIBI)Lct;")
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lnd;Lnd;)V")
