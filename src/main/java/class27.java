...
@OriginalClass("client!IDQQUVDL")
public class class27 {

    @OriginalMember(owner = "client!IDQQUVDL", name = "a", descriptor = "B")
    private byte field845 = 44;

    @OriginalMember(owner = "client!IDQQUVDL", name = "f", descriptor = "I")
    public int field850 = -1;

    @OriginalMember(owner = "client!IDQQUVDL", name = "h", descriptor = "[I")
    public int[] field852 = new int[6];

    @OriginalMember(owner = "client!IDQQUVDL", name = "i", descriptor = "[I")
    public int[] field853 = new int[6];

    @OriginalMember(owner = "client!IDQQUVDL", name = "j", descriptor = "I")
    public int field854 = 128;

    @OriginalMember(owner = "client!IDQQUVDL", name = "k", descriptor = "I")
    public int field855 = 128;

    @OriginalMember(owner = "client!IDQQUVDL", name = "o", descriptor = "LGOHJFVWE;")
    public static class23 field859 = new class23((byte) -54, 30);

    @OriginalMember(owner = "client!IDQQUVDL", name = "b", descriptor = "I")
    public static int field846;

    @OriginalMember(owner = "client!IDQQUVDL", name = "d", descriptor = "I")
    public int field848;

    @OriginalMember(owner = "client!IDQQUVDL", name = "e", descriptor = "I")
    public int field849;

    @OriginalMember(owner = "client!IDQQUVDL", name = "l", descriptor = "I")
    public int field856;

    @OriginalMember(owner = "client!IDQQUVDL", name = "m", descriptor = "I")
    public int field857;

    @OriginalMember(owner = "client!IDQQUVDL", name = "n", descriptor = "I")
    public int field858;

    @OriginalMember(owner = "client!IDQQUVDL", name = "g", descriptor = "LCGWBYVFN;")
    public class9 field851;

    @OriginalMember(owner = "client!IDQQUVDL", name = "c", descriptor = "[LIDQQUVDL;")
    public static class27[] field847;

    @OriginalMember(owner = "client!IDQQUVDL", name = "a", descriptor = "(LOTSGNSQM;Z)V")
    ...
    @OriginalMember(owner = "client!IDQQUVDL", name = "a", descriptor = "(BLYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!IDQQUVDL", name = "a", descriptor = "()LOIBEFFXI;")
