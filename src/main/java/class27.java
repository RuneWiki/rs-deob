...
public class class27 extends class766 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Ltd;Z)V", line = 35)
