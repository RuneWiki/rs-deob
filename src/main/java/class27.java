...
public class class27 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(II)Lgw;", line = 43)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(I)[[[I", line = 75)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(II)[[I", line = 99)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BI)Z", line = 176)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(III)V", line = 222)
