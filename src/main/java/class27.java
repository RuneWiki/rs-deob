...
public class class27 extends class270 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BLec;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZI)[[I", line = 59)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 159)
    public class27() {
        super(0, false);
    }

    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(B)I", line = 127)
    ...
    @OriginalMember(owner = "client!sq", name = "e", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!sq", name = "f", descriptor = "(B)V", line = 167)
