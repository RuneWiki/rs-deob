...
public class class27 extends class31 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ldp;)Lvo;", line = 9)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
