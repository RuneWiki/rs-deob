...
public class class27 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Z)V", line = 50)
