...
public class class27 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIB)V", line = 38)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IZ)[B", line = 56)
