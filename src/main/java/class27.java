...
public class class27 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZIZII)Lrk;", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lpe;IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)Loa;", line = 126)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)Z", line = 186)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 217)
