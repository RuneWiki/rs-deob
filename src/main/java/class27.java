...
public class class27 implements class82 {
    ...
    @OriginalMember(owner = "client!uc", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    public final String toString() {
        field398++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 48)
