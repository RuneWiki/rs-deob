...
public abstract class class27 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIB)Z", line = 9)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)I", line = 33)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Llj;)V", line = 62)
