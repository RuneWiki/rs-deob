...
public class class27 {
    ...
    @OriginalMember(owner = "client!JUIUBOIF", name = "q", descriptor = "LEQHIVIBA;")
    private class13 field907;

    @OriginalMember(owner = "client!JUIUBOIF", name = "d", descriptor = "LVMVYFNTB;")
    private class65 field894;

    @OriginalMember(owner = "client!JUIUBOIF", name = "e", descriptor = "LVMVYFNTB;")
    private class65 field895;

    @OriginalMember(owner = "client!JUIUBOIF", name = "f", descriptor = "LVMVYFNTB;")
    private class65 field896;

    @OriginalMember(owner = "client!JUIUBOIF", name = "g", descriptor = "LVMVYFNTB;")
    private class65 field897;

    @OriginalMember(owner = "client!JUIUBOIF", name = "h", descriptor = "LVMVYFNTB;")
    private class65 field898;

    @OriginalMember(owner = "client!JUIUBOIF", name = "i", descriptor = "LVMVYFNTB;")
    private class65 field899;

    @OriginalMember(owner = "client!JUIUBOIF", name = "j", descriptor = "LVMVYFNTB;")
    private class65 field900;

    @OriginalMember(owner = "client!JUIUBOIF", name = "k", descriptor = "LVMVYFNTB;")
    private class65 field901;

    @OriginalMember(owner = "client!JUIUBOIF", name = "r", descriptor = "LVMVYFNTB;")
    ...
    @OriginalMember(owner = "client!JUIUBOIF", name = "a", descriptor = "(BLXJCNBMKS;)V")
