...
public class class27 extends class405 implements class170 {
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lur;I[BI)V", line = 4)
    public class27(class377 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field261 = arg1;
    }

    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)J", line = 12)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lur;ILjaggl/memory/NativeBuffer;)V", line = 65)
    public class27(class377 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field261 = arg1;
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Z)I", line = 73)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I[BII)V", line = 85)
