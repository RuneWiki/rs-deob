...
public class class27 extends class152 implements class26 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Z[BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!fba", name = "d", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!fba", name = "f", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)J", line = 62)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(II)I", line = 86)
    public static final int method179(int arg0, int arg1) {
        return class603.field8438 != null ? class603.field8438[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Lhk;I[BIZ)V", line = 96)
