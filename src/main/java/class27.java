...
public class class27 implements Runnable {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lsv;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I[BII)V", line = 146)
    ...
    @OriginalMember(owner = "client!ml", name = "run", descriptor = "()V", line = 174)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Ljava/net/Socket;Lor;)V", line = 541)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(B)V", line = 266)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(III[B)V", line = 300)
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(I)I", line = 353)
    ...
    @OriginalMember(owner = "client!ml", name = "f", descriptor = "(I)V", line = 367)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;I[BI)I", line = 389)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "([Lat;II)V", line = 437)
    ...
    @OriginalMember(owner = "client!ml", name = "finalize", descriptor = "()V", line = 529)
