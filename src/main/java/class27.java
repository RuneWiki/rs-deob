...
public class class27 extends class315 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)Lnf;", line = 3)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BLkk;)Lta;", line = 60)
