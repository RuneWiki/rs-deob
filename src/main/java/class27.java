...
public class class27 extends class243 {
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILaa;IILsba;IJII)V", line = 71)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "()V", line = 127)
    public class27() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILji;B)V", line = 130)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZLeda;)V", line = 166)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(II)[I", line = 180)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(IIB)Z", line = 239)
