...
public class class27 {
    ...
    @OriginalMember(owner = "client!KDXWZDUJ", name = "c", descriptor = "LPGNBHFUF;")
    ...
    @OriginalMember(owner = "client!KDXWZDUJ", name = "a", descriptor = "(BILPGNBHFUF;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!KDXWZDUJ", name = "a", descriptor = "(LPGNBHFUF;Ljava/lang/String;Z)V")
