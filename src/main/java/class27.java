...
public class class27 {
    ...
    @OriginalMember(owner = "client!JBHJGXME", name = "b", descriptor = "LJBHJGXME;")
    public class27 field920;

    @OriginalMember(owner = "client!JBHJGXME", name = "c", descriptor = "LJBHJGXME;")
    public class27 field921;

    @OriginalMember(owner = "client!JBHJGXME", name = "d", descriptor = "Z")
