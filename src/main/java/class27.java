...
public class class27 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!KISFBCOP", name = "p", descriptor = "[LXANVNPIN;")
    ...
    @OriginalMember(owner = "client!KISFBCOP", name = "o", descriptor = "LTRQPVNER;")
    public class57 field906;

    @OriginalMember(owner = "client!KISFBCOP", name = "q", descriptor = "LUNSEVWCI;")
