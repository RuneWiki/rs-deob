...
public class class27 extends class50 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lar;)V", line = 8)
    public final synchronized void method276(class50 arg0) {
        this.field385.method2474(-11725, arg0);
    }

    @OriginalMember(owner = "client!n", name = "b", descriptor = "([III)V", line = 15)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Lar;)V", line = 59)
    public final synchronized void method278(class50 arg0) {
        arg0.method1820(-25246);
    }

    @OriginalMember(owner = "client!n", name = "e", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!n", name = "e", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "()Lar;", line = 94)
    public final class50 method281() {
        return (class50) this.field385.method2486((byte) -82);
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lps;)V", line = 102)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "()Lar;", line = 115)
    public final class50 method283() {
        return (class50) this.field385.method2478(1603);
    }

    @OriginalMember(owner = "client!n", name = "d", descriptor = "()I", line = 119)
    public final int method284() {
        return 0;
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lgk;Lps;)V", line = 124)
    ...
    @OriginalMember(owner = "client!n", name = "d", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "([III)V", line = 191)
