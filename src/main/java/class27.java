...
public class class27 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(II)Lsba;", line = 17)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZII)V", line = 61)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 215)
