...
public class class27 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lrl;Lms;III)V", line = 45)
