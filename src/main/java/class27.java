...
public abstract class class27 extends class631 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILwv;Lua;BIILf;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!ir", name = "g", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ir", name = "k", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I[Lqea;II)I", line = 191)
