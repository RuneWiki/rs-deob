...
public class class27 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILbt;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILnk;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IBI)Ldg;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLbh;)Z")
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lbt;)V")
