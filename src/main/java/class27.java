...
@OriginalClass("client!ICYHAEVI")
public class class27 {

    @OriginalMember(owner = "client!ICYHAEVI", name = "a", descriptor = "B")
    private byte field1037 = -128;

    @OriginalMember(owner = "client!ICYHAEVI", name = "b", descriptor = "B")
    private byte field1038 = 1;

    @OriginalMember(owner = "client!ICYHAEVI", name = "h", descriptor = "I")
    public int field1044 = 65000;

    @OriginalMember(owner = "client!ICYHAEVI", name = "g", descriptor = "I")
    public int field1043;

    @OriginalMember(owner = "client!ICYHAEVI", name = "e", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1041;

    @OriginalMember(owner = "client!ICYHAEVI", name = "f", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field1042;

    @OriginalMember(owner = "client!ICYHAEVI", name = "d", descriptor = "[B")
    public static byte[] field1040 = new byte[520];

    @OriginalMember(owner = "client!ICYHAEVI", name = "c", descriptor = "I")
    private int field1039;

    @OriginalMember(owner = "client!ICYHAEVI", name = "<init>", descriptor = "(BIILjava/io/RandomAccessFile;Ljava/io/RandomAccessFile;)V")
    ...
    @OriginalMember(owner = "client!ICYHAEVI", name = "a", descriptor = "(BI)[B")
    ...
    @OriginalMember(owner = "client!ICYHAEVI", name = "a", descriptor = "(II[BI)Z")
    ...
    @OriginalMember(owner = "client!ICYHAEVI", name = "a", descriptor = "(II[BBZ)Z")
    ...
    @OriginalMember(owner = "client!ICYHAEVI", name = "a", descriptor = "(IZLjava/io/RandomAccessFile;)V")
