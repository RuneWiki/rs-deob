...
public class class27 extends class498 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BII)V", line = 137)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(III)V", line = 156)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(III)V", line = 176)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(III)V", line = 197)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(IIIIIII)V", line = 222)
