...
public class class27 extends class390 {
    ...
    @OriginalMember(owner = "client!oo", name = "e", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)Leb;", line = 22)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)V", line = 39)
