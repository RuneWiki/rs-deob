...
public class class27 extends class221 implements class595 {
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lui;Lnl;Leea;II)V")
    ...
    @OriginalMember(owner = "client!vn", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lui;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lui;Lnl;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ltd;B)V")
    public final void method172(class691 arg0, byte arg1) {
        int var3 = -31 / ((arg1 - 2) / 53);
        super.method172(arg0, (byte) -86);
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lnl;IB[BIIIII)V")
