...
public class class27 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ljg;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(II)I", line = 97)
