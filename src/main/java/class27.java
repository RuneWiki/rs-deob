...
public class class27 extends class608 implements class620 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)Lvt;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljba;IIIII)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Llh;Lvt;Z)V")
