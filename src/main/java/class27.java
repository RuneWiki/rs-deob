...
public class class27 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)I", line = 11)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(B)V", line = 24)
    public static void method116(byte arg0) {
        field230 = null;
        int var1 = 11 % ((arg0 - 49) / 34);
    }

    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "()V", line = 35)
    public class27() {
    }

    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lmc;)V", line = 48)
