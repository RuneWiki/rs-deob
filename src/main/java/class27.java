...
public class class27 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!uc", name = "toString", descriptor = "()Ljava/lang/String;", line = 68)
    public final String toString() {
        field316++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(II)V", line = 76)
    public class27(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIILld;IIIBIII)Z", line = 87)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 519)
