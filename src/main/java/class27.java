...
public class class27 extends class83 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IBLtq;)V", line = 21)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZI)[[I", line = 147)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 288)
    public class27() {
        super(1, false);
    }
}
