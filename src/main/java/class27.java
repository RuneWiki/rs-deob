...
public class class27 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lnj;Z)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLub;Z)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILnj;B)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lik;I)V")
