...
public class class27 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIBI)V", line = 104)
