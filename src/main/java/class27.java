...
public class class27 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lvq;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lvq;[II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lvq;[IIII[I[I)V")
