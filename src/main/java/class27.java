...
public class class27 extends class436 {
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ZBLlo;III)V", line = 71)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "()V", line = 196)
    public class27() {
        super(0, true);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILeb;)V", line = 141)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(II)[I", line = 202)
