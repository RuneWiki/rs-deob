...
public class class27 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(I)V", line = 83)
