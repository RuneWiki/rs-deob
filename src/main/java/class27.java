...
public class class27 extends class243 {
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(I)Z", line = 12)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILbq;ILbq;)V", line = 57)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(I)Z", line = 215)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lbi;)V", line = 227)
    public class27(class483 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qaa", name = "f", descriptor = "(I)Z", line = 231)
    ...
    @OriginalMember(owner = "client!qaa", name = "e", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!qaa", name = "e", descriptor = "(B)I", line = 270)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IB)V", line = 281)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(III)V", line = 296)
