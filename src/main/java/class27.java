...
public abstract class class27 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZ[S)[S", line = 21)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 44)
