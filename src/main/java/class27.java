...
public class class27 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)Lwo;", line = 5)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(II)Ldv;", line = 48)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IB)V", line = 121)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(II)Lhea;", line = 138)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lpca;ILbi;Lbi;Lbi;)V", line = 219)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lgba;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZIIIZ)V", line = 244)
