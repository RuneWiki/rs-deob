...
public class class27 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(JILje;[I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)Lnl;")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(ILph;Lph;Ljm;)V")
