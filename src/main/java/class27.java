...
public class class27 extends class476 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)Lmha;", line = 4)
    public final class419 method112(byte arg0) {
        field429++;
        return arg0 == 62 ? class555.field7295 : null;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)Z", line = 16)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lkf;)V", line = 83)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lle;Lqj;IIIIIIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)V", line = 113)
