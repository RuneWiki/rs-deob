...
public class class27 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLoa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BII)Z", line = 21)
    ...
    @OriginalMember(owner = "client!uc", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field342++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZI)I", line = 62)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)I", line = 116)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(JILjava/lang/String;Z)V", line = 127)
