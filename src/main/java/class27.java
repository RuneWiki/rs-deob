...
public abstract class class27 extends class138 {
    ...
    @OriginalMember(owner = "client!ts", name = "Q", descriptor = "()I", line = 12)
    public final int method198() {
        return this.field425 + this.field416 + this.field445;
    }

    @OriginalMember(owner = "client!ts", name = "RA", descriptor = "()I", line = 21)
    public final int method200() {
        return this.field436 + this.field434 + this.field441;
    }

    @OriginalMember(owner = "client!ts", name = "H", descriptor = "(FFFFFFIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ts", name = "YA", descriptor = "()I", line = 127)
    public final int method204() {
        return this.field434;
    }

    @OriginalMember(owner = "client!ts", name = "la", descriptor = "(IIIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(FFFFFF)V", line = 184)
    ...
    @OriginalMember(owner = "client!ts", name = "ha", descriptor = "(IIII)V", line = 317)
    ...
    @OriginalMember(owner = "client!ts", name = "ZA", descriptor = "()I", line = 340)
    public final int method210() {
        return this.field425;
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(FFFFFFLta;II)V", line = 352)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lhj;II)V", line = 364)
