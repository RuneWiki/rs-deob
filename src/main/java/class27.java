...
@OriginalClass("client!HSOVOELH")
public class class27 {

    @OriginalMember(owner = "client!HSOVOELH", name = "a", descriptor = "I")
    private static int field927 = 3461;

    @OriginalMember(owner = "client!HSOVOELH", name = "b", descriptor = "Z")
    private static boolean field928;

    @OriginalMember(owner = "client!HSOVOELH", name = "a", descriptor = "(IIIB)I")
    ...
    @OriginalMember(owner = "client!HSOVOELH", name = "b", descriptor = "(IIIB)I")
    ...
    @OriginalMember(owner = "client!HSOVOELH", name = "a", descriptor = "(IIIIII)I")
    ...
    @OriginalMember(owner = "client!HSOVOELH", name = "b", descriptor = "(IIIIII)I")
