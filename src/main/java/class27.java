...
public class class27 extends class113 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lha;J)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class27(int arg0, boolean arg1) {
        this.method131(arg0, arg1);
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(J)V", line = 56)
    public final void method122(long arg0) {
        this.field247 = arg0;
    }

    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()Leea;", line = 60)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "()V", line = 75)
    public final void method124() {
        this.field245 = true;
    }

    @OriginalMember(owner = "client!ta", name = "d", descriptor = "()V", line = 79)
    public final void method125() {
        this.field258 = true;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lha;J[Lqv;[Lvea;Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "()Leea;", line = 92)
    public final class458 method127() {
        return this.field256;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZ)Lta;", line = 95)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Lvea;Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIII)V", line = 201)
    public final void method130(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field254 = arg0;
    }

    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(IZ)V", line = 212)
    ...
    @OriginalMember(owner = "client!ta", name = "f", descriptor = "()V", line = 219)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lha;)V", line = 255)
    ...
    @OriginalMember(owner = "client!ta", name = "g", descriptor = "()V", line = 268)
    private final void method134() {
        this.field245 = false;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lha;[Lqv;Z)V", line = 277)
    ...
    @OriginalMember(owner = "client!ta", name = "h", descriptor = "()V", line = 356)
