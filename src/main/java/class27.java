...
public class class27 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!qaa", name = "toString", descriptor = "()Ljava/lang/String;", line = 68)
    public final String toString() {
        field385++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IB)C", line = 90)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BLjava/awt/Canvas;)V", line = 118)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(II)V", line = 136)
