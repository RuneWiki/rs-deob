...
public class class27 {
    ...
    @OriginalMember(owner = "client!JMEOMLFD", name = "b", descriptor = "[LJMEOMLFD;")
    public static class27[] field1016;

    @OriginalMember(owner = "client!JMEOMLFD", name = "a", descriptor = "(LMNPBQFWE;B)V")
    ...
    @OriginalMember(owner = "client!JMEOMLFD", name = "a", descriptor = "(LBJPWOXRJ;II)V")
