...
public class class27 {
    ...
    @OriginalMember(owner = "client!cf", name = "O", descriptor = "[B")
    ...
    @OriginalMember(owner = "client!cf", name = "i", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!cf", name = "y", descriptor = "Llf;")
    public static class109 field584 = class35.method275("<col=ff3000>", 2);

    @OriginalMember(owner = "client!cf", name = "Q", descriptor = "Llf;")
    private static class109 field601 = class35.method275("Walk here", 2);

    @OriginalMember(owner = "client!cf", name = "K", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!cf", name = "u", descriptor = "[B")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lke;Lja;II)V")
