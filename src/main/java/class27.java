...
public class class27 extends class331 {
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(B)Z", line = 6)
    public final boolean method121(byte arg0) {
        int var2 = 42 / ((arg0 + 56) / 57);
        return true;
    }

    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 14)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lws;Ljava/lang/Object;I)V", line = 24)
