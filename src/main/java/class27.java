...
public class class27 extends class316 implements class679 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIIILol;I)V")
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lbea;Lmg;Z)V")
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)Lmg;")
    public final class134 method427(int arg0) {
        ++field427;
        return arg0 != 31337 ? null : this.field419;
    }

    @OriginalMember(owner = "client!uc", name = "h", descriptor = "(I)[Lica;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
