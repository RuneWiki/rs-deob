...
public class class27 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([BJZ)V", line = 152)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lmv;Lr;B)V", line = 260)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IZ[B)V", line = 389)
