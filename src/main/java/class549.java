...
public class class549 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([IILnv;I[II)Lk;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)Lut;")
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(II)Lks;")
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lci;ILsea;Lsea;Lsea;)V")
