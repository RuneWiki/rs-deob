...
public class class549 extends class450 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lup;)V", line = 17)
    public class549(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(Z)I", line = 48)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZI)V", line = 61)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(ILup;)V", line = 72)
    public class549(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIIILka;)Lck;", line = 91)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II)I", line = 111)
