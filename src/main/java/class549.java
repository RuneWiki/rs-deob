...
public class class549 implements class205 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIZBI)Lab;")
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIILki;Lki;)V")
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Z)Lww;")
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(ILrg;Lal;II)V")
