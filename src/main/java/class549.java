...
public class class549 extends class492 {
    ...
    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!rd", name = "w", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!rd", name = "W", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(II)Lmp;", line = 89)
    public final class315 method628(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!rd", name = "y", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lbfa;I)I", line = 117)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIII)V", line = 150)
    public final void method574(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!rd", name = "M", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!rd", name = "P", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 206)
    public final void method558(Object arg0, Canvas arg1, int arg2) {
        int var4 = 108 % ((6 - arg2) / 39);
    }

    @OriginalMember(owner = "client!rd", name = "z", descriptor = "()Lgba;", line = 214)
    ...
    @OriginalMember(owner = "client!rd", name = "ya", descriptor = "()V", line = 222)
    public final void method610() {
        this.method2885(true, 92);
        this.field7746.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BLbha;)V", line = 233)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ZZ)Lho;", line = 256)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lbfa;IIZILho;I)V", line = 268)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILqs;)I", line = 287)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lcu;I)V", line = 312)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lkf;Lkea;I)Z", line = 337)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(BZ)Llk;", line = 349)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Z[BILkea;II)Lco;", line = 360)
    ...
    @OriginalMember(owner = "client!rd", name = "Z", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(FFF)V", line = 400)
    public final void method570(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!rd", name = "g", descriptor = "(Z)V", line = 404)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ljagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;III)Z", line = 415)
    ...
    @OriginalMember(owner = "client!rd", name = "x", descriptor = "(I)V", line = 520)
    ...
    @OriginalMember(owner = "client!rd", name = "w", descriptor = "()V", line = 529)
    public final void method635() {
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIILbfa;)V", line = 533)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Z)V", line = 546)
    public final void method559(boolean arg0) {
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IB)Lni;", line = 549)
    ...
    @OriginalMember(owner = "client!rd", name = "A", descriptor = "()V", line = 591)
    public final void method625() {
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 594)
    ...
    @OriginalMember(owner = "client!rd", name = "h", descriptor = "()Z", line = 604)
    public final boolean method569() {
        return false;
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IILkf;Lkea;I)Loia;", line = 611)
    ...
    @OriginalMember(owner = "client!rd", name = "F", descriptor = "(II)V", line = 620)
    public final void method572(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Lkf;Lkea;I)I", line = 623)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IZ[BLkea;IZII)Loia;", line = 660)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lpf;B)V", line = 674)
    ...
    @OriginalMember(owner = "client!rd", name = "na", descriptor = "(IIII)[I", line = 698)
    ...
    @OriginalMember(owner = "client!rd", name = "A", descriptor = "(I)V", line = 739)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BLqs;ZI)V", line = 776)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lcd;Lcd;FLcd;)Lcd;", line = 820)
    public final class22 method631(class22 arg0, class22 arg1, float arg2, class22 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!rd", name = "B", descriptor = "(I)V", line = 829)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lvga;I)V", line = 843)
    ...
    @OriginalMember(owner = "client!rd", name = "z", descriptor = "(I)V", line = 885)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBZLqs;Z)V", line = 907)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/er;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lsaa;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lwu;I)V", line = 946)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V", line = 987)
    ...
    @OriginalMember(owner = "client!rd", name = "f", descriptor = "()Z", line = 999)
    public final boolean method608() {
        return false;
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 1006)
    public final synchronized void method639(int arg0) {
        this.field7735.method2571((byte) -78);
        super.method639(arg0);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILlk;Z)V", line = 1015)
    ...
    @OriginalMember(owner = "client!rd", name = "q", descriptor = "()V", line = 1026)
    public final void method556() {
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I[[IIZ)Luia;", line = 1030)
    ...
    @OriginalMember(owner = "client!rd", name = "N", descriptor = "(I)V", line = 1044)
    ...
    @OriginalMember(owner = "client!rd", name = "ab", descriptor = "(I)V", line = 1053)
    public final void method629(int arg0) {
        this.field7746.method4116(137, this.field6890 && !this.field6900);
        int var2 = -95 / ((-arg0 - 13) / 60);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ZLtb;)I", line = 1062)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(IIIID)V", line = 1078)
    public final void method614(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 1081)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lhs;Lmp;)Lcha;", line = 1091)
    public final class279 method584(class358 arg0, class315 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I[Lot;)Ldha;", line = 1098)
    public final class732 method573(int arg0, class378[] arg1) {
        return arg0 == 0 ? new dxVertexLayout(this, arg1) : (class732) null;
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lefa;I)I", line = 1108)
    ...
    @OriginalMember(owner = "client!rd", name = "J", descriptor = "(I)V", line = 1142)
    ...
    @OriginalMember(owner = "client!rd", name = "r", descriptor = "()V", line = 1152)
    public final void method617() {
    }

    @OriginalMember(owner = "client!rd", name = "o", descriptor = "()V", line = 1157)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lhd;Z)I", line = 1180)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;B)V", line = 1217)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIIIIZ[I)Loia;", line = 1229)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lcha;)V", line = 1239)
    public final void method595(class279 arg0) {
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BI)V", line = 1242)
    ...
    @OriginalMember(owner = "client!rd", name = "u", descriptor = "(I)V", line = 1254)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)V", line = 1261)
    ...
    @OriginalMember(owner = "client!rd", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lwu;Ljava/lang/Integer;)Lha;", line = 1282)
    ...
    @OriginalMember(owner = "client!rd", name = "p", descriptor = "(I)V", line = 1382)
    ...
    @OriginalMember(owner = "client!rd", name = "j", descriptor = "(B)V", line = 1393)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BLjava/awt/Canvas;Ljava/lang/Object;)V", line = 1405)
    ...
    @OriginalMember(owner = "client!rd", name = "e", descriptor = "(Z)V", line = 1430)
    ...
    @OriginalMember(owner = "client!rd", name = "L", descriptor = "(I)V", line = 1440)
    ...
    @OriginalMember(owner = "client!rd", name = "D", descriptor = "(I)V", line = 1457)
    ...
    @OriginalMember(owner = "client!rd", name = "I", descriptor = "()I", line = 1467)
    public final int method593() {
        return 0;
    }

    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(II)V", line = 1474)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ZLdha;)V", line = 1499)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 1511)
    public final void method622(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class425 {
        this.method632(arg2, arg3);
    }

    @OriginalMember(owner = "client!rd", name = "V", descriptor = "(I)V", line = 1518)
    ...
    @OriginalMember(owner = "client!rd", name = "i", descriptor = "(B)V", line = 1530)
    ...
    @OriginalMember(owner = "client!rd", name = "B", descriptor = "(B)Z", line = 1546)
    ...
    @OriginalMember(owner = "client!rd", name = "z", descriptor = "(B)V", line = 1586)
    ...
    @OriginalMember(owner = "client!rd", name = "m", descriptor = "()V", line = 1597)
    public final void method587() {
        this.field7735.method2572(true);
        super.method587();
    }

    @OriginalMember(owner = "client!rd", name = "k", descriptor = "(B)V", line = 1609)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(II)Lhs;", line = 1638)
    public final class358 method600(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!rd", name = "v", descriptor = "(I)F", line = 1646)
    ...
    @OriginalMember(owner = "client!rd", name = "u", descriptor = "(B)V", line = 1656)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(II[FIZILkea;I)Loia;", line = 1666)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lkea;Lkf;B)Z", line = 1677)
    ...
    @OriginalMember(owner = "client!rd", name = "g", descriptor = "(B)V", line = 1688)
    ...
    @OriginalMember(owner = "client!rd", name = "GA", descriptor = "(I)V", line = 1702)
