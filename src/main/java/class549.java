...
public class class549 extends class214 {
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IB)[I", line = 68)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILofa;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "()V", line = 197)
    public class549() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(BIILbfa;I)V", line = 204)
    ...
    @OriginalMember(owner = "client!bba", name = "e", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!bba", name = "f", descriptor = "(B)V", line = 256)
