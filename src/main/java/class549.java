...
public class class549 extends class462 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILcm;)V", line = 24)
    ...
    @OriginalMember(owner = "client!sf", name = "e", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(II)I", line = 56)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIII)[B", line = 67)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "()V", line = 81)
    public class549() {
