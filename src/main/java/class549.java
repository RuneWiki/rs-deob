...
public class class549 extends class497 {
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(I)Ljq;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILvn;Z)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BILkja;)V")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lpj;)V")
