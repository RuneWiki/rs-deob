...
public class class549 extends class467 {
    ...
    @OriginalMember(owner = "client!el", name = "e", descriptor = "(B)I", line = 5)
    public final int method1795(byte arg0) {
        int var2 = 114 % ((27 - arg0) / 59);
        return this.field7848;
    }

    @OriginalMember(owner = "client!el", name = "g", descriptor = "(B)I", line = 13)
    public final int method1792(byte arg0) {
        return arg0 > -35 ? 43 : this.field7847;
    }

    @OriginalMember(owner = "client!el", name = "f", descriptor = "(B)I", line = 24)
    public final int method1793(byte arg0) {
        int var2 = 121 / ((arg0 - 51) / 49);
        return this.field7851;
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)J", line = 35)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)I", line = 46)
