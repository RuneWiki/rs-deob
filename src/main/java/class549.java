...
public class class549 extends class568 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "([B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 60)
