...
public class class549 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BI)Ljca;")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lr;III[Z)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lal;ILnd;)V")
