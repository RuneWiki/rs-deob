...
public class class549 extends class188 {
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class549(Object arg0, int arg1) {
        super(arg1);
        this.field8068 = arg0;
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IB)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIB)I", line = 29)
    ...
    @OriginalMember(owner = "client!ph", name = "e", descriptor = "(B)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 73)
