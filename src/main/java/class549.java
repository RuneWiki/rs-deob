...
public class class549 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)[Ldg;", line = 48)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IB)V", line = 62)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lmc;)V", line = 379)
    public class549(class234 arg0) {
        this.method2976(-15, arg0);
    }

    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Lha;B)V", line = 98)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ILmc;)V", line = 269)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BLqc;)V", line = 313)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "([Llq;II)V", line = 343)
