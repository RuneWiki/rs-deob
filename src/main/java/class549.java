...
public class class549 extends class180 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!lba", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!lba", name = "e", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIIIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Leea;II)V", line = 534)
