...
public class class549 extends class439 implements class361 {
    ...
    @OriginalMember(owner = "client!mka", name = "<init>", descriptor = "(Los;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!mka", name = "a", descriptor = "(Ltd;I)V")
    ...
    @OriginalMember(owner = "client!mka", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
