...
public class class549 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lte;B)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lrd;ILte;)V")
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(Lte;B)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BLte;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILte;I)V")
