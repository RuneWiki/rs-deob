...
public class class549 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)Ljg;", line = 119)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "([II[J)V", line = 175)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 196)
