...
public class class549 implements class480 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(JI)V", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lri;Ljava/lang/String;)V", line = 51)
    public class549(class97 arg0, String arg1) {
        this.field7987 = arg1;
        this.field7983 = arg0;
    }

    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(I)Lcj;", line = 60)
