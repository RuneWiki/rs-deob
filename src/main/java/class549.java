...
public class class549 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ZJ)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II[B)I", line = 62)
