...
public class class549 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!kfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 41)
    public final String toString() {
        field7842++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(II)V", line = 65)
