...
public class class549 extends class303 {
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(III[I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ni", name = "h", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILjava/awt/Component;ILqn;I)Lgw;", line = 52)
    ...
    @OriginalMember(owner = "client!ni", name = "e", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "()Luu;", line = 169)
    ...
    @OriginalMember(owner = "client!ni", name = "g", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!ni", name = "f", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III[I)V", line = 283)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(III[I)V", line = 297)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIIII)V", line = 328)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "()V", line = 364)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III)V", line = 391)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 402)
    public class549() {
        this.method967();
    }

    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(III)V", line = 411)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Luu;)V", line = 423)
