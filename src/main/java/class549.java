...
public class class549 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIIIILr;II[[[BIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!uda", name = "toString", descriptor = "()Ljava/lang/String;", line = 62)
    public final String toString() {
        field7507++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(III)Lse;", line = 89)
