...
public class class549 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Ljava/lang/String;ZZB)V", line = 24)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(III)Lqfa;", line = 1018)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BJ)V", line = 1025)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Lsj;ILin;)V", line = 1113)
