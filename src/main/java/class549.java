...
public class class549 {
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(III)V", line = 240)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)[[I", line = 11)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(III)I", line = 33)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)[I", line = 107)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 175)
