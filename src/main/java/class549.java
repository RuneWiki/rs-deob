...
public class class549 extends class609 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lr;Lwba;III)V", line = 46)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lr;B)V", line = 80)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILr;BI)Z", line = 184)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 216)
