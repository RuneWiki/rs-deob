...
public class class565 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BLg;Lee;)Lsda;", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BI)Z", line = 88)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILee;)V", line = 99)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "([Lkba;II)V", line = 127)
