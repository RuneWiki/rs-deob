...
public class class565 extends class615 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IB)[I", line = 19)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 61)
    public class565() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BILeh;)V", line = 64)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BII)Z", line = 98)
    ...
    @OriginalMember(owner = "client!qs", name = "d", descriptor = "(B)V", line = 109)
