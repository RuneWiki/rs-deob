...
public class class565 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILla;II)Lfu;", line = 8)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)[Lnca;", line = 37)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILsl;)V", line = 49)
