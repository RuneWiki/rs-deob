...
public class class565 extends class243 {
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(II)[[I", line = 19)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 66)
    public class565() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lrl;BII)J", line = 70)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLha;IIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILji;B)V", line = 157)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 173)
