...
public class class565 extends class424 {
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(II[Ljava/awt/Rectangle;)V", line = 19)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 35)
    public class565(String arg0, int arg1) {
        this.field7564 = arg0;
        this.field7566 = (short) arg1;
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZB)V", line = 53)
