...
public class class565 extends class666 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "([BZII)V", line = 64)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IIB[B)I", line = 121)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lpj;Lpj;Lpj;Lpj;B)V", line = 131)
    ...
    @OriginalMember(owner = "client!aaa", name = "finalize", descriptor = "()V", line = 147)
