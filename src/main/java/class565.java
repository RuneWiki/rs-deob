...
public class class565 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IZLrt;)V", line = 15)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZLoa;II)Lxa;", line = 47)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lrt;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)V", line = 127)
