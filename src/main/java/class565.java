...
public class class565 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lie;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z[IIILer;III)Lcea;", line = 46)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILie;)V", line = 67)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 194)
