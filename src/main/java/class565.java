...
public class class565 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Z", line = 8)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(II)Ltu;", line = 19)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "([Ljava/lang/Object;II[JZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "([[[Lne;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)I", line = 183)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 223)
