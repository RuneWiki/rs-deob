...
public class class565 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IB)V", line = 89)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILu;)V", line = 124)
