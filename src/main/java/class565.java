...
public class class565 extends class762 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IFFIIFBI[FIF)V", line = 5)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 100)
    public static void method3055(int arg0) {
        int var1 = -124 / ((-arg0 - 34) / 61);
        field7168 = null;
    }

    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(I)V", line = 112)
