...
public class class565 implements class255 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(III)I", line = 9)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z)Lqi;", line = 26)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)Lbt;", line = 54)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(ILgq;Lkfa;II)V", line = 90)
