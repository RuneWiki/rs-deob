...
public class class573 extends class396 implements class145 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(III[I)V", line = 4)
    public final void method582(int arg0, int arg1, int arg2, int[] arg3) {
        this.method3101(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "()Lq;", line = 11)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 27)
    public class573() {
        this.method3100();
    }

    @OriginalMember(owner = "client!wa", name = "finalize", descriptor = "()V", line = 34)
