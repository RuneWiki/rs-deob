...
public class class573 extends class66 {
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "()V", line = 5)
    public class573() {
    }

    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(J)V", line = 9)
    public class573(long arg0) {
        this.field8181 = arg0;
    }

    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 20)
