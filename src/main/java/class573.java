...
public class class573 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLuca;)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILuo;ILuca;)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILuca;)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Luca;II)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILuca;I)V")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZLuca;)V")
