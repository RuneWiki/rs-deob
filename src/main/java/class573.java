...
public class class573 extends class610 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIB)V", line = 55)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Len;Lh;)V", line = 123)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IILit;)V", line = 171)
