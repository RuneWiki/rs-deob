...
public class class573 extends class465 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(FI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I[IILkd;)V", line = 32)
    ...
    @OriginalMember(owner = "client!cr", name = "e", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(IIIIIF)V", line = 138)
