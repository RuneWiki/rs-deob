...
public class class573 extends class401 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "()V", line = 49)
    public static void method3273() {
        field8113 = null;
    }

    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "()[I", line = 53)
    public final int[] method3274() {
        return this.field8109;
    }

    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(II[IZ)V", line = 59)
