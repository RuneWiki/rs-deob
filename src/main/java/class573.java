...
public class class573 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lpja;I)V")
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(II)Lpv;")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Ljk;ILae;)V")
