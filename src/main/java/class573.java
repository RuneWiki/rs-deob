...
public abstract class class573 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lcs;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lha;Lrca;I)I", line = 95)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IBIII)Z", line = 123)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(IIIII)V", line = 408)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIB)V", line = 160)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(B)V", line = 373)
