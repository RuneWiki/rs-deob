...
public class class573 extends class115 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BLwq;)Ljava/lang/String;", line = 10)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(III)I", line = 37)
    ...
    @OriginalMember(owner = "client!lba", name = "c", descriptor = "(I)V", line = 68)
