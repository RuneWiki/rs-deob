...
public class class573 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILrl;IIBLra;IILjava/lang/String;ILoh;Lpa;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIIIIIILqa;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IB)Lim;")
