...
public class class573 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ldt;Z)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLll;ILha;Ls;Ls;IIBIIZII)Lka;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BIIIBILll;Lha;)Lka;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lha;IILll;IIIIZILs;Ls;I)Lka;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BIILll;IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ldt;ZI)V")
