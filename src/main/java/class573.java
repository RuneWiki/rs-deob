...
public class class573 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljc;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljc;I)V", line = 79)
