...
public class class573 {
    ...
    @OriginalMember(owner = "client!el", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)I", line = 27)
