...
public class class573 extends class173 {
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IB)Z", line = 50)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lnja;)V", line = 60)
