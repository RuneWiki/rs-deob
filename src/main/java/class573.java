...
public class class573 extends class325 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljp;IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(IIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BI)[I", line = 128)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "()V", line = 152)
    public class573() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([[II)V", line = 167)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IB)[[I", line = 217)
