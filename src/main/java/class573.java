...
public class class573 extends class280 {
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(I)J", line = 3)
    public final long method1520(int arg0) {
        return arg0 == 0 ? this.field8089 : -22L;
    }

    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(B)J", line = 13)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(I)J", line = 44)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(IJ)I", line = 96)
