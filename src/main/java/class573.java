...
public class class573 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II[I)Lrea;")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZI[I)Lrea;")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I[II)Lrea;")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIB[I)Lrea;")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lgj;Lgj;)V")
