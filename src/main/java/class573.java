...
public abstract class class573 extends class435 {
    ...
    @OriginalMember(owner = "client!im", name = "e", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IZ)I", line = 14)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "([Llaa;Z)I", line = 29)
    ...
    @OriginalMember(owner = "client!im", name = "f", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(II)Z", line = 53)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(ILha;)Z", line = 63)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 75)
    ...
    @OriginalMember(owner = "client!im", name = "f", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIIIILjava/lang/String;B)V", line = 102)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(IIIIIII)V", line = 129)
