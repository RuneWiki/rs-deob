...
public class class573 extends class397 implements class144 {
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 20)
    public class573() {
        this.method3148();
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "()Lq;", line = 26)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(III[I)V", line = 34)
