...
public class class573 extends class478 {
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILnp;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "()V", line = 101)
    public class573() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fp", name = "f", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lr;Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!fp", name = "g", descriptor = "(I)I", line = 203)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(II)[I", line = 219)
