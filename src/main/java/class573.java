...
public class class573 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IJ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)J", line = 51)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II[BI)I", line = 63)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I[BZI)V", line = 83)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)Ljava/io/File;", line = 103)
    ...
    @OriginalMember(owner = "client!ea", name = "finalize", descriptor = "()V", line = 114)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZIII)Luea;", line = 153)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 186)
