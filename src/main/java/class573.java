...
public class class573 extends class748 {
    ...
    @OriginalMember(owner = "client!gt", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/Component;ZI)Ltfa;", line = 42)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "()V", line = 162)
    public class573() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gt", name = "h", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IZLvj;)V", line = 82)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)[I", line = 193)
