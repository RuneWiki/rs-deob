...
public class class677 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLkga;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lkga;I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZLkga;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lkga;ILso;I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILkga;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(IZLkga;)V")
