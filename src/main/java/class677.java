...
public class class677 implements Runnable {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!lt", name = "run", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II[BZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "([I[IILbi;ZI)Lkia;", line = 169)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)V", line = 199)
