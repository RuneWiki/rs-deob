...
public class class677 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIILfp;IIZ)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILek;ILafa;Lha;B)Z")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(II)Lgha;")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lsaa;ILfp;)V")
