...
public class class677 extends class13 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)[B", line = 9)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIB)Ljl;", line = 44)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lol;I)Lhda;", line = 316)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(B)I", line = 350)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(B)I", line = 366)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(II)V", line = 390)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)Lwu;", line = 428)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(I)I", line = 529)
    public final int method3795(int arg0) {
        field9505++;
        return arg0 > -7 ? 65 : this.field9524;
    }

    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(I)I", line = 542)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BI)I", line = 562)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(B)V", line = 582)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(I)V", line = 625)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(ILce;Lce;Ll;Lcda;I[BIZ)V", line = 849)
    ...
    @OriginalMember(owner = "client!rn", name = "f", descriptor = "(I)V", line = 649)
