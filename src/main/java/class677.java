...
public class class677 extends class38 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILrg;)V", line = 53)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "()V", line = 89)
    public class677() {
        super(3, false);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)V", line = 129)
    public static void method3890(int arg0) {
        int var1 = -65 % ((-67 - arg0) / 51);
        field9417 = null;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljo;BLvd;Lvd;Lvd;Lvn;)Z", line = 140)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)[[I", line = 183)
