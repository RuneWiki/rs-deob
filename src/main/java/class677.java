...
public class class677 extends class331 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!hca", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 36)
    ...
    @OriginalMember(owner = "client!hca", name = "d", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!hca", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 78)
    ...
    @OriginalMember(owner = "client!hca", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 86)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILqo;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 180)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)Lm;", line = 206)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(III)Z", line = 217)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(B)V", line = 229)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)V", line = 258)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!hca", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 439)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IZ)Z", line = 447)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V", line = 464)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(B)V", line = 497)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(CBII)V", line = 508)
    ...
    @OriginalMember(owner = "client!hca", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 526)
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 554)
