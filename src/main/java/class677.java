...
public class class677 extends class491 implements class125 {
    ...
    @OriginalMember(owner = "client!og", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 4)
    public final IDirect3DBaseTexture method1169(int arg0) {
        return arg0 == -15770 ? this.field9609 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ler;IZ[[I)V", line = 25)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILse;)V", line = 78)
