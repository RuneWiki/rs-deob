...
public class class677 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BZLoa;I)Lxa;", line = 17)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IILdga;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BLdga;)V", line = 92)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)V", line = 112)
