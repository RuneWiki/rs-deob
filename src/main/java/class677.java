...
public class class677 extends class77 {
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Ltl;Lfn;IIIIIIIIIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)Ltca;", line = 44)
