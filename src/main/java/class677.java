...
public class class677 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lud;B)V", line = 35)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FLse;IIFFFFIII)[B", line = 60)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLjw;Lud;)Lci;", line = 90)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 142)
