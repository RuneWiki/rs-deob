...
public class class677 extends class55 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IBIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "()V", line = 43)
    public class677() {
    }

    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(J)V", line = 102)
