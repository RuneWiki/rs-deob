...
public class class677 extends class498 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(JLha;Z)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IJZLha;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lha;Lmv;Lnha;J)V")
