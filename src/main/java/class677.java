...
public abstract class class677 extends class508 {
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Z[[[BIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(I)V", line = 306)
