...
public class class677 extends class74 {
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)Ljava/net/Socket;", line = 14)
    ...
    @OriginalMember(owner = "client!fh", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 89)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BLjava/net/Proxy;)Ljava/net/Socket;", line = 163)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 193)
