...
public class class677 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)Lle;", line = 3)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IB)I", line = 20)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Z)Llh;", line = 40)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lom;I[BB)Lkea;", line = 84)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)Llh;", line = 130)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(B)V", line = 150)
    public static void method3776(byte arg0) {
        int var1 = -42 / ((arg0 + 36) / 59);
        field9549 = null;
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILrf;)V", line = 163)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Ljava/lang/String;CLjava/lang/String;I)Ljava/lang/String;", line = 177)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILlh;)V", line = 234)
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)Llh;", line = 251)
    ...
    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(I)I", line = 272)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "()V", line = 295)
    public class677() {
