...
public class class677 extends class619 {
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(Z)Ljba;", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIILtc;)V", line = 30)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lfc;II[B)V", line = 118)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lfc;II[I)V", line = 130)
