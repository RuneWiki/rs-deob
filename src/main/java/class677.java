...
public class class677 extends class343 implements class583 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BLrn;)V", line = 3)
    ...
    @OriginalMember(owner = "client!fh", name = "h", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lha;Lc;IIIIIZIIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILha;)V", line = 36)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ldf;IZIIILha;)V", line = 50)
    ...
    @OriginalMember(owner = "client!fh", name = "n", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)I", line = 83)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(ILha;)V", line = 94)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(ILha;)V", line = 120)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lha;I)Lcca;", line = 140)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)Z", line = 151)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IILha;B)Z", line = 162)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Z)Z", line = 184)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BLha;)Ltf;", line = 196)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)I", line = 245)
    ...
    @OriginalMember(owner = "client!fh", name = "e", descriptor = "(B)V", line = 255)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)I", line = 268)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)Z", line = 281)
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(B)Z", line = 294)
    ...
    @OriginalMember(owner = "client!fh", name = "i", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!fh", name = "j", descriptor = "(I)I", line = 323)
