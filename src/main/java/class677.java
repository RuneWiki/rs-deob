...
public class class677 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(III)V", line = 45)
