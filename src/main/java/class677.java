...
public class class677 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IILvj;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(B)V", line = 361)
