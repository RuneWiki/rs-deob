...
public class class548 extends class659 implements class593 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZII)V", line = 21)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Ldda;Lfca;III[B)V", line = 42)
