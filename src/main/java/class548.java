...
public class class548 extends class381 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "i", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILoa;Ljo;)V", line = 79)
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(B)Z", line = 209)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ZBLjava/lang/Object;)[B", line = 243)
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IBI)Z", line = 291)
