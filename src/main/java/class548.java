...
public class class548 extends class518 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)F", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)J", line = 18)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ea", name = "e", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIB)I", line = 159)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIIIIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILns;)V", line = 238)
    ...
    @OriginalMember(owner = "client!ea", name = "f", descriptor = "(I)D", line = 301)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 314)
    public class548(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BLha;)Lpga;", line = 326)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)Z", line = 346)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)V", line = 363)
