...
public class class548 extends class465 {
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)Lai;", line = 33)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(III)V", line = 87)
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZBZLoq;Ljava/lang/String;)V", line = 131)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "([I)V", line = 199)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIBI)V", line = 219)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "()Loha;", line = 276)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(III[I)V", line = 303)
    ...
    @OriginalMember(owner = "client!ro", name = "e", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!ro", name = "h", descriptor = "(I)V", line = 336)
    public static final void method2969(int arg0) {
        class456.field5972.method2919(arg0);
        field6869++;
    }

    @OriginalMember(owner = "client!ro", name = "g", descriptor = "(I)V", line = 350)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Loha;)V", line = 406)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIII)V", line = 428)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 463)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(III[I)V", line = 477)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "()V", line = 487)
    public class548() {
        this.method462();
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III[I)V", line = 495)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III)V", line = 509)
