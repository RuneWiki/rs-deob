...
public class class548 implements class630 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ljava/awt/Component;IILmr;I)Lhh;")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)Lag;")
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljava/lang/String;Lvfa;Lrq;IIIIIIIIII)V")
