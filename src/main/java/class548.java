...
public class class548 extends class215 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IF)V", line = 311)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(I)V", line = 327)
    public class548(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(FB)V", line = 332)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIB)I", line = 348)
    ...
    @OriginalMember(owner = "client!gh", name = "p", descriptor = "(B)V", line = 371)
    ...
    @OriginalMember(owner = "client!gh", name = "w", descriptor = "(I)V", line = 425)
