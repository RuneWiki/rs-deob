...
public class class548 {
    ...
    @OriginalMember(owner = "client!rg", name = "toString", descriptor = "()Ljava/lang/String;", line = 15)
    public final String toString() {
        field8055++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(II)V", line = 76)
