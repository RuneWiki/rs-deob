...
public class class548 extends class205 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lra;)V", line = 117)
