...
public class class548 extends class4 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIB)V", line = 72)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Ldh;IIB)V", line = 95)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(IIIIIII)V", line = 903)
