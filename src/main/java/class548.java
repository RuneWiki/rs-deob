...
public class class548 extends class130 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lgfa;)Lcba;", line = 6)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
