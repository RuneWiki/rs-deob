...
public class class548 extends class75 implements class462 {
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(B)V", line = 5)
    public final void method22(byte arg0) {
        int var2 = 19 / ((-arg0 - 72) / 49);
        this.field1005.method3328(this, (byte) 81);
    }

    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 17)
    public final IDirect3DBaseTexture method588(int arg0) {
        return arg0 == 281 ? this.field8186 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lwda;Laq;III[B)V", line = 26)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lpw;I)V", line = 100)
