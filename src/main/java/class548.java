...
public class class548 extends class552 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILjava/awt/Graphics;IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 21)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILjava/awt/Graphics;III)V", line = 42)
