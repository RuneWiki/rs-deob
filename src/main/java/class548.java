...
public class class548 extends class724 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BIIIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!baa", name = "d", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lib;B)Lrg;", line = 201)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Ljh;I)I", line = 215)
    ...
    @OriginalMember(owner = "client!baa", name = "c", descriptor = "(I)Lrr;", line = 245)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 306)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lkd;IIIIII)V", line = 352)
