...
public class class548 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lio;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILlv;Lr;ILkt;)Z", line = 23)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lio;I)V", line = 239)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZI)V", line = 260)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 326)
