...
public class class548 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lji;ZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lji;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II)V", line = 86)
