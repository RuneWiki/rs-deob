...
public class class548 extends class631 {
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Leea;Lrc;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZZ)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IILta;)V")
