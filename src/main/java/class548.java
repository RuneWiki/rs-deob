...
public class class548 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ldg;Ldg;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BZI)I", line = 49)
    ...
    @OriginalMember(owner = "client!el", name = "toString", descriptor = "()Ljava/lang/String;", line = 88)
    public final String toString() {
        field7245++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLva;Lva;)V", line = 101)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILha;BIIII)Lka;", line = 119)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 182)
