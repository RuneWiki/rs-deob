...
public class class548 implements class409 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I[IBIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)Lhr;", line = 122)
    public class57 method478(int arg0) {
        field7954++;
        return arg0 < 30 ? null : class153.field2228;
    }

    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIIIIIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(ILeda;Lcga;II)V", line = 219)
