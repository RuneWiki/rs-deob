...
public class class548 extends class354 {
    ...
    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(II)I", line = 96)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(ILwo;)V", line = 107)
    public class548(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Lwo;)V", line = 162)
    public class548(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(B)I", line = 182)
    ...
    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)I", line = 202)
