...
public class class548 extends class276 {
    ...
    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!nw", name = "f", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(B)[I", line = 94)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IZIIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lno;II)V", line = 545)
    public class548(class658 arg0, int arg1, int arg2) {
        this.field7312 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(III)Z", line = 558)
