...
public class class548 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)Llq;", line = 4)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "()V", line = 76)
    public class548() {
    }

    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Ljo;)V", line = 85)
    public class548(class353 arg0) {
        this.field7873 = arg0;
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(CB)Z", line = 29)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(Z)Llq;", line = 41)
