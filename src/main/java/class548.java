...
public class class548 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Loi;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Z)Z", line = 126)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(Z)I", line = 137)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IB)V", line = 155)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BIII)Z", line = 180)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BLega;)I", line = 320)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 348)
