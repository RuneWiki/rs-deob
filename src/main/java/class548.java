...
public abstract class class548 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[IBIII)Lfd;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILha;Z)Lda;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILfd;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILjava/awt/Canvas;Luu;IIIILd;)Lha;")
