...
public class class548 extends class496 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 66)
