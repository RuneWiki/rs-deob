...
public class class548 extends class143 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Lqda;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!kea", name = "e", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!kea", name = "finalize", descriptor = "()V", line = 61)
    ...
    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(III)Lbda;", line = 77)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!kea", name = "f", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(III)Z", line = 116)
    ...
    @OriginalMember(owner = "client!kea", name = "g", descriptor = "(B)J", line = 138)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Lkfa;II)V", line = 148)
