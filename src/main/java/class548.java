...
public class class548 extends class203 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIBIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)V", line = 77)
