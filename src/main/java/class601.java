...
public class class601 {
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(II[II)Lps;")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(I[IB)Lps;")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(I[II)Lps;")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lla;Lla;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(II[II)Lps;")
