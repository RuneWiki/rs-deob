...
public class class601 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lrg;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lrg;II)V", line = 52)
