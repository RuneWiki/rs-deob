...
public class class601 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(FZII[FFIIFIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 130)
