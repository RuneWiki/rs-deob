...
public class class601 {
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(BI)Lrea;", line = 4)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(II)V", line = 230)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!bha", name = "c", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(BZ)V", line = 286)
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(Lgia;IZLaj;Laj;)V", line = 370)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Z)I", line = 311)
