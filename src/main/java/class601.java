...
public class class601 implements Runnable {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "([BIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Ljava/net/Socket;Lwea;I)V", line = 366)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!re", name = "run", descriptor = "()V", line = 191)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "([BIBI)V", line = 268)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BII)Z", line = 295)
    ...
    @OriginalMember(owner = "client!re", name = "finalize", descriptor = "()V", line = 307)
    protected final void finalize() {
        field8235++;
        this.method3425((byte) -126);
    }

    @OriginalMember(owner = "client!re", name = "c", descriptor = "(B)V", line = 326)
