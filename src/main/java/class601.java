...
public class class601 extends class478 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)Laca;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lji;I)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIB)Lci;")
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(ILkf;Lkf;Ljt;Lcs;I[BIZ)V")
