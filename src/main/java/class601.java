...
public class class601 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZI)Laba;")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(II)Lvq;")
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Loda;ILdda;Ldda;Ldda;)V")
