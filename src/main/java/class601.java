...
public abstract class class601 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lgn;)V", line = 26)
    public class601(class699 arg0) {
        this.field8563 = arg0;
        this.field8565 = this.method39((byte) -17);
    }

    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(ILgn;)V", line = 35)
