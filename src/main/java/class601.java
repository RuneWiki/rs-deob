...
public class class601 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IB)Z", line = 44)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(I[Lea;IIII)V", line = 246)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lqa;BI)Z", line = 91)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIILqa;IIII)V", line = 171)
