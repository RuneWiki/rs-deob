...
public class class601 extends class665 implements class521 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)Z", line = 36)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lfaa;BII)V", line = 48)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IBII)V", line = 100)
    ...
    @OriginalMember(owner = "client!fj", name = "finalize", descriptor = "()V", line = 128)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Len;III)V", line = 151)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Len;IIII)V", line = 166)
