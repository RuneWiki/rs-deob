...
public class class601 extends class114 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ljc;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILwfa;)V", line = 63)
