...
public class class601 {
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZ)Lkb;", line = 98)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(Z)[Lcp;", line = 130)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 148)
