...
public class class601 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IBLac;)V", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BLac;)V", line = 66)
