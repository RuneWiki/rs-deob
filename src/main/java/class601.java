...
public class class601 extends class184 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 23)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIIIBI)V", line = 64)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 503)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IBI)Z", line = 535)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([Lgg;II)V", line = 546)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I[BIIIII[BI)V", line = 585)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Luv;II)V", line = 634)
