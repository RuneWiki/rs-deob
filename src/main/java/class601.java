...
public class class601 extends class455 implements class141 {
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lha;Luw;IIIIIZIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(BLha;)Lvw;", line = 38)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BLha;)V", line = 64)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!cf", name = "h", descriptor = "(B)Z", line = 104)
    public final boolean method402(byte arg0) {
        ++field8751;
        return arg0 <= 28 ? true : this.field8730;
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lha;Z)Ltb;", line = 115)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BILha;Lgs;ZII)V", line = 131)
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "(BLha;)V", line = 165)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lha;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!cf", name = "j", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILdm;II)V", line = 223)
    ...
    @OriginalMember(owner = "client!cf", name = "h", descriptor = "(I)I", line = 253)
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "(B)I", line = 270)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Z", line = 283)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)V", line = 298)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lha;IZI)Z", line = 311)
    ...
    @OriginalMember(owner = "client!cf", name = "g", descriptor = "(B)Z", line = 340)
    ...
    @OriginalMember(owner = "client!cf", name = "f", descriptor = "(B)Z", line = 355)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILha;IZ)Lnj;", line = 371)
    ...
    @OriginalMember(owner = "client!cf", name = "f", descriptor = "(I)V", line = 401)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILha;B)Lka;", line = 416)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Z)I", line = 451)
