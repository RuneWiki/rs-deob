...
public class class601 {
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bha", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field8395++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(II)Lbha;", line = 44)
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(IILso;)V", line = 115)
