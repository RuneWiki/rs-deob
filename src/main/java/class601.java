...
public class class601 extends class199 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "([SII)[S", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZLei;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 77)
