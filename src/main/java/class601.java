...
public class class601 implements class117 {
    ...
    @OriginalMember(owner = "client!eha", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(I)Lof;", line = 50)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(I)V", line = 71)
