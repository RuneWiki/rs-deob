...
public class class322 implements Runnable {
    ...
    @OriginalMember(owner = "client!nd", name = "run", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIIIIII)V", line = 66)
