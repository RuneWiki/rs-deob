...
public class class322 extends class72 {
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lcq;)V", line = 4)
    public class322(class464 arg0) {
        super(arg0);
        class483.method2912(super.field1282, 0);
    }

    @OriginalMember(owner = "client!db", name = "d", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(ILcq;)V", line = 28)
    public class322(int arg0, class464 arg1) {
        super(arg0, arg1);
        class483.method2912(super.field1282, 0);
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!db", name = "e", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!db", name = "f", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(II)I", line = 114)
