...
public class class322 extends class756 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;B)V", line = 21)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIZ)I", line = 88)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIB)V", line = 168)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BII)V", line = 187)
    public final void method1903(byte arg0, int arg1, int arg2) {
        int var4 = 18 % ((arg0 - 82) / 40);
        ++field4111;
    }

    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(IIIIIII)V", line = 196)
