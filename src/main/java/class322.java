...
public class class322 extends class222 implements class68 {
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(IIIIILbb;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "h", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!wr", name = "e", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILqa;)Lou;")
    public final class437 method136(int arg0, class165 arg1) {
        field4656++;
        return arg0 == 0 ? null : null;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(ZLqa;)V")
