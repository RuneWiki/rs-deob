...
public class class322 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ne", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field4587++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 123)
