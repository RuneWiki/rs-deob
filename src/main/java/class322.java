...
public class class322 extends class80 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IILjava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIZI)V", line = 120)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "([B)V", line = 169)
