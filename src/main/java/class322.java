...
public class class322 extends class326 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(III[B)I", line = 10)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILbt;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZLjava/lang/String;)J", line = 51)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLjava/lang/String;)J", line = 207)
