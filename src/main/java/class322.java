...
public class class322 extends class265 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lug;IIIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lug;IIIIIIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lug;IIII[I)V", line = 44)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lug;IIIII[BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lug;IIIIZ[BI)V", line = 75)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lug;IIIZ[I)V", line = 98)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(IIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!nq", name = "d", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!nq", name = "e", descriptor = "(I)V", line = 162)
