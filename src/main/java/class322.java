...
public class class322 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "()V", line = 6)
    public void method1398() throws Exception {
        field4731++;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILpda;B)V", line = 13)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "()I", line = 35)
    public int method1396() throws Exception {
        field4735++;
        return this.field4752;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILpda;)V", line = 133)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "()V", line = 150)
    public void method1395() throws Exception {
        field4732++;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZ)Z", line = 158)
    ...
    @OriginalMember(owner = "client!jp", name = "d", descriptor = "()V", line = 185)
    public void method1397() {
        field4734++;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 192)
    public void method1399(Component arg0) throws Exception {
        field4730++;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IB)V", line = 199)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(III)Ljava/lang/String;", line = 225)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)V", line = 280)
    public void method1400(int arg0) throws Exception {
        field4747++;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "([II)V", line = 288)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(B)V", line = 486)
