...
public class class322 extends class254 {
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lpea;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lpea;II)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lpea;IIZ[[I)V")
