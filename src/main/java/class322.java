...
public class class322 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(III)Z", line = 14)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(III)Z", line = 36)
    ...
    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!hg", name = "f", descriptor = "(III)Z", line = 57)
    public static final boolean method2009(int arg0, int arg1, int arg2) {
        int var3 = -122 % ((-arg2 - 19) / 49);
        return false;
    }

    @OriginalMember(owner = "client!hg", name = "g", descriptor = "(III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!hg", name = "j", descriptor = "(III)Z", line = 104)
    public static final boolean method2014(int arg0, int arg1, int arg2) {
        int var3 = -2 % ((-arg0 - 19) / 61);
        return (arg1 & 0x34) != 0;
    }

    @OriginalMember(owner = "client!hg", name = "k", descriptor = "(III)Z", line = 112)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBI)Z", line = 122)
    ...
    @OriginalMember(owner = "client!hg", name = "l", descriptor = "(III)Z", line = 132)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IZI)Z", line = 142)
    ...
    @OriginalMember(owner = "client!hg", name = "m", descriptor = "(III)Z", line = 152)
    ...
    @OriginalMember(owner = "client!hg", name = "n", descriptor = "(III)Z", line = 168)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(IZI)Z", line = 178)
    ...
    @OriginalMember(owner = "client!hg", name = "o", descriptor = "(III)Z", line = 188)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIB)Z", line = 198)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(IIB)Z", line = 208)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(IIB)Z", line = 218)
    public static final boolean method2025(int arg0, int arg1, byte arg2) {
        return arg2 == -77 ? (arg1 & 0x18) != 0 | (arg1 & 0x220) == 544 : false;
    }

    @OriginalMember(owner = "client!hg", name = "p", descriptor = "(III)Z", line = 228)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(BII)Z", line = 241)
    public static final boolean method2027(byte arg0, int arg1, int arg2) {
        int var3 = -123 / ((arg0 + 1) / 38);
        return (arg1 & 0x20) != 0;
    }

    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(IIB)Z", line = 249)
    ...
    @OriginalMember(owner = "client!hg", name = "q", descriptor = "(III)Z", line = 259)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(IZI)Z", line = 269)
    ...
    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(IIB)Z", line = 279)
    ...
    @OriginalMember(owner = "client!hg", name = "r", descriptor = "(III)Z", line = 289)
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(IZI)Z", line = 299)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(IBI)Z", line = 310)
