...
public class class322 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lqc;B)V", line = 204)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lnb;III)V", line = 241)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)I", line = 269)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 281)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)V", line = 317)
