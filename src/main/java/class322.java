...
public class class322 extends class360 {
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lnf;II)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lnf;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lnf;IIZ[[I)V")
