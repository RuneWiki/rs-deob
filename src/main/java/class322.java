...
public class class322 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BLfd;I)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IIIIIILd;Lie;Ld;ZIBILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IILoa;IIILie;)Lba;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lie;Loa;IBLd;IZIIILd;II)Lba;")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BLfd;)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IILie;IBILoa;)Lba;")
