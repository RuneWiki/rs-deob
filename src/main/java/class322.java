...
public class class322 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 59)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(II)Lwa;", line = 87)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(II)Ldr;", line = 119)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Les;I)V", line = 153)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lrf;ILpl;Lpl;Lpl;)V", line = 189)
