...
public class class322 extends class172 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLhia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILgga;)V", line = 92)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIII)Z", line = 145)
