...
public class class322 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lpe;Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([Ll;I)V", line = 160)
