...
public class class322 extends class328 {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(II)[[I", line = 30)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "()V", line = 96)
    public class322() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lke;Lke;B)V", line = 100)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BILco;)V", line = 119)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II)[I", line = 166)
