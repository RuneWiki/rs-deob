...
public class class322 extends class337 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IFIZIIII)[I", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IB)[I", line = 28)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(II)[[I", line = 95)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 175)
    public class322() {
        super(3, false);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BILhp;)V", line = 183)
