...
public class class322 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ltq;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(I)Lqf;", line = 37)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)Lqf;", line = 72)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lwq;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "()V", line = 109)
    public class322() {
    }

    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lwq;)V", line = 113)
