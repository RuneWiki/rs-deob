...
public class class322 implements class318 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)Lib;", line = 10)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Ljava/lang/String;Ldba;Lpa;IIIIIIIIII)V", line = 57)
