...
public class class322 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(I)Lmq;")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Lkv;I)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Llq;B)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ZLeh;)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(BLlq;)V")
