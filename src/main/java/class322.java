...
public class class322 extends class271 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "([BIB)[B", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IILdh;)V", line = 21)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILdt;Lqa;IILcn;)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z)V", line = 282)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IZI)I", line = 324)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILdh;)V", line = 359)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 385)
