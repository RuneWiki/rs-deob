...
public class class322 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIB[BIII[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ss", name = "finalize", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lgk;J[Lgo;)V", line = 76)
    public class322(class463 arg0, long arg1, class307[] arg2) {
        this.field4145 = arg0;
        this.field4140 = arg1;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Loa;ZLjava/lang/String;I)V", line = 87)
