...
public class class322 implements class438 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Loga;B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)J", line = 99)
