...
public abstract class class322 implements class155 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIII[I)V", line = 54)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lnfa;ILvj;Lnb;IZ)V", line = 531)
    ...
    @OriginalMember(owner = "client!jp", name = "finalize", descriptor = "()V", line = 264)
    ...
    @OriginalMember(owner = "client!jp", name = "e", descriptor = "(I)I", line = 274)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "([BIIBI)V", line = 291)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(B)V", line = 391)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIB[F)V", line = 413)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILup;)V", line = 515)
    ...
    @OriginalMember(owner = "client!jp", name = "d", descriptor = "(I)V", line = 550)
