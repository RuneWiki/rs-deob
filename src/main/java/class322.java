...
public abstract class class322 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIIIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BI)V", line = 158)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lch;)V", line = 173)
    public class322(class463 arg0) {
        this.field4450 = arg0;
        this.field4451 = this.method17((byte) -96);
    }

    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(ILch;)V", line = 183)
