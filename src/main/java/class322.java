...
public class class322 extends class130 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IF)V", line = 5)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BF)V", line = 21)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(I)V", line = 34)
