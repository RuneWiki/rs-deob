...
public class class322 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)Ldu;")
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "([Ldu;B)I")
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(I)Ldu;")
    ...
    @OriginalMember(owner = "client!efa", name = "d", descriptor = "(I)Ldu;")
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ILdu;J)V")
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(BJ)Ldu;")
