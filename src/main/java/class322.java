...
public class class322 extends class152 implements class545 {
    ...
    @OriginalMember(owner = "client!vw", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vw", name = "g", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ZBZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(BII)V", line = 66)
    ...
    @OriginalMember(owner = "client!vw", name = "finalize", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IILgt;III)V", line = 101)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lpc;III)V", line = 176)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lpc;IIII)V", line = 191)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)V", line = 161)
