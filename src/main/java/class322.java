...
public class class322 extends class184 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!en", name = "e", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IBI)Z", line = 107)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lac;II)V", line = 126)
    public class322(class541 arg0, int arg1, int arg2) {
        this.field4328 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIIIII)V", line = 136)
