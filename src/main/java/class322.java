...
public class class322 {
    ...
    @OriginalMember(owner = "client!jn", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)J", line = 17)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIB)V", line = 27)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IJ)V", line = 49)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)Ljava/io/File;", line = 93)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZI[B)V", line = 104)
    ...
    @OriginalMember(owner = "client!jn", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(III[B)I", line = 140)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 155)
