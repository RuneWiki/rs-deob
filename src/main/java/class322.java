...
public class class322 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BI)Lec;", line = 41)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIIILha;III)V", line = 75)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(II)Lnea;", line = 88)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)V", line = 128)
    public static void method1885(byte arg0) {
        int var1 = -76 / ((arg0 - 13) / 61);
        field4147 = null;
    }

    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lwj;ILwu;Lwu;Lwu;)V", line = 151)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIIBII[F)V", line = 177)
