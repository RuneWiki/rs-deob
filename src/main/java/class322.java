...
public class class322 extends class535 {
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II)[I", line = 39)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 63)
    public class322() {
        super(0, true);
    }
}
