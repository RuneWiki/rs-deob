...
public class class322 extends class517 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "([Ljava/lang/String;IZ[SI)V", line = 17)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(CB)C", line = 74)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lffa;IIII[BI)V", line = 472)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lffa;IIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIIIIBI)V", line = 502)
    ...
    @OriginalMember(owner = "client!bv", name = "g", descriptor = "(I)I", line = 519)
    ...
    @OriginalMember(owner = "client!bv", name = "f", descriptor = "(I)V", line = 704)
    ...
    @OriginalMember(owner = "client!bv", name = "e", descriptor = "(I)V", line = 1187)
