...
public class class322 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILqo;)V", line = 49)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIII)Z", line = 86)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)V", line = 228)
