...
public class class322 extends class402 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!tba", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lfga;Lej;[Loia;[I[I)V")
