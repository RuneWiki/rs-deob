...
public class class322 extends class539 implements class310 {
    ...
    @OriginalMember(owner = "client!ow", name = "e", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ow", name = "d", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILqf;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(I)I", line = 219)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Loa;B)V", line = 234)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(BILoa;I)Z", line = 245)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILoa;)Lww;", line = 255)
    public final class686 method11(int arg0, class650 arg1) {
        field4000++;
        return arg0 >= -89 ? null : null;
    }

    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(Loa;B)V", line = 266)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(Loa;I)Lqt;", line = 278)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Loa;I)V", line = 291)
    public final void method136(class650 arg0, int arg1) {
        int var3 = -4 % ((-arg1 - 78) / 37);
        field4006++;
    }

    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)I", line = 300)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Loa;BI)Lba;", line = 313)
    public final class359 method134(class650 arg0, byte arg1, int arg2) {
        field4008++;
        return arg1 < 80 ? null : null;
    }

    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Z)Z", line = 324)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(B)I", line = 353)
    public final int method139(byte arg0) {
        field4010++;
        return arg0 < 13 ? -36 : 0;
    }

    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(IIIIILuo;)V", line = 365)
