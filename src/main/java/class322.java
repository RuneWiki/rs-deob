...
public class class322 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIZII)Luaa;", line = 26)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ltc;I)Z", line = 70)
