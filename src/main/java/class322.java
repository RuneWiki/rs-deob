...
public abstract class class322 {
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lvj;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lvj;ILjaggl/memory/NativeBuffer;IZ)V")
