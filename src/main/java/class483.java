...
public class class483 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIZII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 120)
