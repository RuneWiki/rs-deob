...
public class class483 extends class428 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "([BILqba;I)Lon;", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "p", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZI[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!no", name = "i", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 87)
    ...
    @OriginalMember(owner = "client!no", name = "w", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!no", name = "f", descriptor = "(Z)I", line = 133)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B[I)V", line = 152)
    ...
    @OriginalMember(owner = "client!no", name = "x", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!no", name = "e", descriptor = "(IB)I", line = 174)
    public final int method2934(int arg0, byte arg1) {
        ++field7329;
        return arg1 < 31 ? -75 : arg0 * 8 - this.field7320;
    }

    @OriginalMember(owner = "client!no", name = "q", descriptor = "(II)Lcr;", line = 190)
    ...
    @OriginalMember(owner = "client!no", name = "y", descriptor = "(I)Z", line = 220)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(I)V", line = 235)
    public class483(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!no", name = "r", descriptor = "(II)I", line = 241)
