...
public class class483 {
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(III)V", line = 203)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)[[I", line = 12)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(II)I", line = 87)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)[[[I", line = 149)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)V", line = 172)
