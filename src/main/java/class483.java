...
public class class483 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BLbs;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I[JI[II)V", line = 18)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 135)
    public class483() {
        this.field7085 = -50;
        this.field7098 = 1.2F;
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Llh;)V", line = 155)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILlh;)V", line = 95)
