...
public class class483 extends class152 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lda;IIILaa;Lbq;IILkq;Ljava/lang/String;II)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILes;I)V")
