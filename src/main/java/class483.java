...
public class class483 extends class651 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ZLjava/awt/event/MouseEvent;)I", line = 3)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(I)I", line = 41)
    public final int method2915(int arg0) {
        field6978++;
        return arg0 == -8463 ? this.field6974 : 21;
    }

    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!wga", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 102)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2917(0, arg0.getY(), arg0.getX());
        field6960++;
    }

    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!wga", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 144)
    ...
    @OriginalMember(owner = "client!wga", name = "e", descriptor = "(B)I", line = 173)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(B)Z", line = 185)
    ...
    @OriginalMember(owner = "client!wga", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 196)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2917(0, arg0.getY(), arg0.getX());
        field6979++;
    }

    @OriginalMember(owner = "client!wga", name = "e", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(III)Z", line = 231)
    ...
    @OriginalMember(owner = "client!wga", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 243)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(B)Lck;", line = 254)
    ...
    @OriginalMember(owner = "client!wga", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 265)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!wga", name = "f", descriptor = "(I)Lwj;", line = 306)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IZBI)Lla;", line = 350)
    ...
    @OriginalMember(owner = "client!wga", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 369)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field6962++;
        this.method2917(0, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 436)
    public class483(Component arg0, boolean arg1) {
        this.method2926(arg0, true);
        this.field6989 = arg1;
    }

    @OriginalMember(owner = "client!wga", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 384)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2917(0, arg0.getY(), arg0.getX());
        field6980++;
    }

    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(B)Z", line = 396)
    ...
    @OriginalMember(owner = "client!wga", name = "f", descriptor = "(B)V", line = 408)
