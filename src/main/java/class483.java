...
public class class483 {
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lrp;)V", line = 230)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BLjava/lang/Runnable;)V", line = 23)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "([BIILjava/io/File;)V", line = 35)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIIIBIIII)V", line = 72)
