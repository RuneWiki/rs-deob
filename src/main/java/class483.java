...
public class class483 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILbt;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)I", line = 55)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lbt;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BZ)V", line = 122)
