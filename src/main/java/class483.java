...
public class class483 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II)Lae;", line = 6)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIBI[B[B)I", line = 40)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(II)V", line = 279)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I[BIBI[B)I", line = 293)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "([B)V", line = 448)
