...
public class class483 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILjf;)Z")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILkk;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lkk;)V")
