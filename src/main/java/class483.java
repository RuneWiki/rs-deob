...
public class class483 extends class329 {
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(I)Les;", line = 20)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 35)
    public class483(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!di", name = "g", descriptor = "(I)D", line = 112)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lgga;I)Lht;", line = 140)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Z)V", line = 166)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Llaa;I)I", line = 191)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)V", line = 209)
