...
public class class483 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLjava/lang/String;Lae;)I")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IZLae;)V")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)[Lsi;")
