...
public class class483 extends class130 {
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "([ILsj;[I[II)V", line = 30)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(BI)Z", line = 130)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IC)Z", line = 141)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 156)
    public class483() {
    }

    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(S)V", line = 162)
