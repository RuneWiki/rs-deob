...
public class class483 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IILmc;)V")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lmc;I)V")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "([BI)Lpu;")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)Lvi;")
