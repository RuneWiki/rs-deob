...
public class class483 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IB)Lsq;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I[[[BIIIIIIIILza;II)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lda;Ll;)V")
