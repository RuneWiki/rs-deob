...
public class class483 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "()Lma;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lkha;II)Ldj;")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Ltn;)V")
