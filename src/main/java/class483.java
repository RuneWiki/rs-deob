...
public class class483 extends class456 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IBLre;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IB)V", line = 56)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 304)
    public class483() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)[[I", line = 418)
    ...
    @OriginalMember(owner = "client!ni", name = "h", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)V", line = 487)
