...
public class class483 extends class5 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Luu;II)Lpc;", line = 4)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "()V", line = 12)
    public final void method2900() {
        this.field7123 = null;
    }

    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lnj;)V", line = 20)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "()V", line = 501)
