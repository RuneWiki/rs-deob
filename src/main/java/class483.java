...
public class class483 extends class260 {
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lfca;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILor;I)V")
