...
public class class483 extends class223 {
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(IIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "([Lcr;IZIZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(III)V", line = 69)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(III)V", line = 91)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)Ltk;", line = 117)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(III)V", line = 149)
