...
public class class483 extends class255 {
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IB[BI)I", line = 36)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!jr", name = "e", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)Z", line = 73)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)[I", line = 85)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;)V", line = 109)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(III[B)V", line = 142)
    ...
    @OriginalMember(owner = "client!jr", name = "finalize", descriptor = "()V", line = 153)
