...
public class class483 extends class497 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "([BI)Ltb;")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lpp;)V")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(ILpp;)V")
