...
public class class483 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)Lof;", line = 19)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lfs;B)I", line = 76)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IC)Z", line = 138)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lms;ILwu;Lwu;)V", line = 202)
