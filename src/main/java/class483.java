...
public class class483 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZC)V", line = 4)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILmq;II)J", line = 15)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILic;II)Lje;", line = 46)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZZ)Z", line = 70)
    public static boolean method2866(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZIIIZ)V", line = 100)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lod;I)V", line = 146)
