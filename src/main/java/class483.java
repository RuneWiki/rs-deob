...
public class class483 extends Canvas {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!nk", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 17)
    public final void update(Graphics arg0) {
        this.field7372.update(arg0);
        field7375++;
    }

    @OriginalMember(owner = "client!nk", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 33)
    public final void paint(Graphics arg0) {
        field7369++;
        this.field7372.paint(arg0);
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 51)
    public class483(Component arg0) {
        this.field7372 = arg0;
    }

    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)V", line = 59)
