...
public class class483 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IILnw;IILic;ILc;)V", line = 52)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III)Liia;", line = 159)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)V", line = 174)
