...
public class class483 extends class154 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(III[[ZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IIIIIIB)V", line = 74)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IS)V", line = 257)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ILjava/awt/Color;Ljava/awt/Color;Ljava/lang/String;Ljava/awt/Color;I)V", line = 279)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(Lhk;Lvca;Lbq;[I)V", line = 387)
