...
public class class483 extends class548 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)J", line = 33)
    public final long method1607(byte arg0) {
        return arg0 > -71 ? -19L : this.field7081;
    }

    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 112)
    public class483() {
        this.field7081 = System.nanoTime();
        this.field7080 = System.nanoTime();
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(JI)I", line = 46)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)J", line = 84)
