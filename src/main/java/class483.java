...
public class class483 extends class165 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Ljava/lang/Runnable;)Lqr;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIII)Lcaa;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lfa;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "s", descriptor = "()Lq;")
    public final class394 method238() {
        return this.field6757;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II[[I[[IIII)Li;")
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)Le;")
    ...
    @OriginalMember(owner = "client!cb", name = "FA", descriptor = "(ILua;II)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Le;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lso;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lfa;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIIF)Lul;")
    public final class530 method243(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!cb", name = "u", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I[Lul;)V")
    public final void method284(int arg0, class530[] arg1) {
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II[I[I)Lua;")
    ...
    @OriginalMember(owner = "client!cb", name = "h", descriptor = "()Lik;")
    public final class191 method314() {
        return new class191(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lmca;IIII)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIZ)Lf;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lkk;IIII)Lda;")
    ...
    @OriginalMember(owner = "client!cb", name = "n", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lpga;Z)Lf;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIZ)Lf;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lgda;[Lpga;Z)Lla;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lf;Z)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lcaa;)V")
    public final void method277(class275 arg0) {
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lcaa;Lcaa;FLcaa;)Lcaa;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lq;)V")
