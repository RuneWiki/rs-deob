...
public class class483 implements Runnable {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!bw", name = "finalize", descriptor = "()V", line = 43)
    protected final void finalize() {
        this.method2839(-20828);
        field7057++;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I[BIB)V", line = 51)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(III)Z", line = 76)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BI[BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Ljava/net/Socket;Ldr;)V", line = 513)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(III)Z", line = 142)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II[B[BIIIBI)V", line = 152)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!bw", name = "run", descriptor = "()V", line = 249)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IILjava/lang/String;)V", line = 321)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(B)V", line = 400)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(I)I", line = 421)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljava/lang/Object;III)[B", line = 440)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(I)I", line = 475)
    ...
    @OriginalMember(owner = "client!bw", name = "e", descriptor = "(I)V", line = 490)
