...
public class class483 extends class530 {
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(ILah;)V")
    public class483(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lah;)V")
