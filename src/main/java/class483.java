...
public class class483 extends class157 {
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(ILhc;Lhc;Lua;Ltt;IIZ)V", line = 811)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(I)I", line = 290)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(B)Lup;", line = 314)
    ...
    @OriginalMember(owner = "client!p", name = "e", descriptor = "(I)I", line = 416)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(II)[B", line = 427)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)I", line = 458)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(II)V", line = 474)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(II)I", line = 507)
    public static final int method2853(int arg0, int arg1) {
        return class3.field24 == null ? 0 : class3.field24[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!p", name = "e", descriptor = "(B)V", line = 511)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lmt;)V", line = 535)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BII)Lsi;", line = 592)
