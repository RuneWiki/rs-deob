...
public class class483 extends class346 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!ar", name = "g", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ar", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 30)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field6946;
        return this.field6949 == arg0;
    }

    @OriginalMember(owner = "client!ar", name = "h", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IILjava/awt/Graphics;III)V", line = 61)
    ...
    @OriginalMember(owner = "client!ar", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 80)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 115)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IBIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!ar", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 145)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field6943;
    }

    @OriginalMember(owner = "client!ar", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 157)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field6938;
    }

    @OriginalMember(owner = "client!ar", name = "i", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!ar", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 188)
