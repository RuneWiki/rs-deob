...
public class class483 extends class657 {
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "d", descriptor = "(B)Llv;", line = 19)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(II)V", line = 32)
