...
public class class451 {
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(B)Lno;")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lmba;I)V")
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)Lno;")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lmba;)V")
