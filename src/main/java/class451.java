...
public abstract class class451 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lbs;IZI)V", line = 47)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 61)
