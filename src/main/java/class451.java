...
public class class451 extends class299 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(II)I", line = 68)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(ILes;)V", line = 80)
    public class451(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Les;)V", line = 83)
    public class451(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(Z)I", line = 110)
