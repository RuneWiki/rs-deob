...
public class class451 extends class313 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BI)I", line = 29)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!tq", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 277)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field6766++;
        this.method2752(0, -1, arg0);
    }

    @OriginalMember(owner = "client!tq", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 285)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)Liq;", line = 299)
    ...
    @OriginalMember(owner = "client!tq", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 311)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method2752(1, -1, arg0);
        field6776++;
    }

    @OriginalMember(owner = "client!tq", name = "e", descriptor = "(I)V", line = 319)
    ...
    @OriginalMember(owner = "client!tq", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 330)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method2753(0, '\u0000', -1, 0);
        field6773++;
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IILjava/awt/event/KeyEvent;)V", line = 339)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ICII)V", line = 379)
    ...
    @OriginalMember(owner = "client!tq", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 396)
    public final void focusGained(FocusEvent arg0) {
        field6768++;
    }

    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 436)
    public class451(Component arg0) {
        class485.method2903(101);
        this.method2749(arg0, -4982);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZI)Z", line = 412)
