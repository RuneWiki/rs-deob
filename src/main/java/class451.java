...
public class class451 extends class320 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lln;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZJ)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IB)V", line = 81)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIIB)V", line = 98)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "()V", line = 173)
    public class451() {
    }

    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(I)V", line = 175)
