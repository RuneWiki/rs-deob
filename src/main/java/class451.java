...
public class class451 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B)V", line = 700)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZI)V", line = 711)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 725)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIIIIII)V", line = 750)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 796)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lag;JI)V", line = 819)
