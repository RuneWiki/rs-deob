...
public class class451 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(III)Lsl;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IB)Lul;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILbe;II)V")
