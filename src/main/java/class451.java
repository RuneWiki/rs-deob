...
public class class451 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)I", line = 9)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "()V", line = 44)
    public class451() {
    }

    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lgk;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(B)I", line = 59)
