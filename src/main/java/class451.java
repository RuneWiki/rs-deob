...
public class class451 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "([Lrg;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BIIIIII)Lvm;", line = 152)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 745)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIILj;)V", line = 762)
