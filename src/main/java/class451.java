...
public class class451 extends class371 {
    ...
    @OriginalMember(owner = "client!te", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(BI)[I", line = 21)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BI)[[I", line = 76)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(FFFI)I", line = 156)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "()V", line = 201)
    public class451() {
        super(3, false);
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IBLps;)V", line = 213)
