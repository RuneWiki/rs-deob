...
public class class451 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(DI)V", line = 15)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 77)
