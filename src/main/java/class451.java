...
public class class451 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(ILtj;FLtj;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)Z", line = 115)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lpc;)V", line = 132)
