...
public abstract class class451 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lcq;)V", line = 7)
    public static final void method2695(class466 arg0) {
        class471.field6690 = arg0;
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(III)Z", line = 23)
