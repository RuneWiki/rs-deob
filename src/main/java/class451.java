...
public class class451 extends class582 implements class219 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Leda;IZ[[I)V", line = 15)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 66)
    public final IDirect3DBaseTexture method2075(int arg0) {
        return arg0 == -8780 ? this.field6315 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ldj;B)V", line = 78)
