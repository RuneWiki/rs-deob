...
public abstract class class451 extends class197 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIILwm;ZLhp;Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!cj", name = "i", descriptor = "(I)V", line = 89)
