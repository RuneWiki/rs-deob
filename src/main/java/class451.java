...
public class class451 extends class597 implements class339 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZLr;)Log;")
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(ZLr;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZZ)Z")
    public static boolean method2420(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lr;I)Lsd;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZIBLr;Llo;II)V")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IILr;I)Z")
