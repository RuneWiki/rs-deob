...
public class class451 extends class345 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lnf;)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lcq;)V")
