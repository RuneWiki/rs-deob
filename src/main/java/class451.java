...
public class class451 extends class187 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)Lom;", line = 11)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILfd;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(B)V", line = 362)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IB)V", line = 379)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILtq;)Ljava/lang/String;", line = 392)
