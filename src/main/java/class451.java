...
public class class451 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIIII)V", line = 33)
