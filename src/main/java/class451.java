...
public class class451 extends class76 implements class161 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Z)I", line = 3)
    public final int method101(boolean arg0) {
        field6705++;
        return arg0 ? 110 : 0;
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILza;)V", line = 15)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLza;)V", line = 51)
    ...
    @OriginalMember(owner = "client!sa", name = "g", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(B)Z", line = 75)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(IIIIIIIIIILaa;)V", line = 86)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lza;B)V", line = 108)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIIILza;Lfi;ZILta;)V", line = 118)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lza;III)Z", line = 224)
    ...
    @OriginalMember(owner = "client!sa", name = "d", descriptor = "(I)V", line = 235)
    public final void method108(int arg0) {
        field6707++;
        int var2 = 4 % ((48 - arg0) / 37);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I)I", line = 245)
    public final int method97(int arg0) {
        field6700++;
        return arg0 < 82 ? -37 : 0;
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(ILza;)Lhp;", line = 261)
    public final class293 method110(int arg0, class299 arg1) {
        field6710++;
        return arg0 == 0 ? null : null;
    }

    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(B)Z", line = 273)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lza;IZ)Le;", line = 284)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)I", line = 296)
