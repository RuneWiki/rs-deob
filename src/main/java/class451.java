...
public class class451 implements Runnable {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILfo;[BI)Lifa;", line = 23)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IBLfo;)Lifa;", line = 260)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILifa;)V", line = 284)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lfo;IB)Lifa;", line = 300)
    ...
    @OriginalMember(owner = "client!np", name = "run", descriptor = "()V", line = 337)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Ltt;)V", line = 401)
