...
public class class451 extends class535 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILwn;I)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lul;II)I")
    public static final int method2686(class411 arg0, int arg1, int arg2) {
        ++field6580;
        return arg2;
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Liu;B)V")
