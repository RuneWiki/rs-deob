...
public class class451 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ck", name = "toString", descriptor = "()Ljava/lang/String;", line = 40)
    public final String toString() {
        field6591++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(II)V", line = 61)
