...
public class class451 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILw;Lw;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLnr;Ltc;)I", line = 28)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIIZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 125)
