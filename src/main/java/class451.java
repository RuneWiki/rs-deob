...
public class class451 {
    ...
    @OriginalMember(owner = "client!ni", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lrt;Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lad;JI)V", line = 77)
    public class451(class362 arg0, long arg1, int arg2) {
        this.field6727 = arg1;
        this.field6728 = arg0;
    }

    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(JB)V", line = 88)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)V", line = 107)
