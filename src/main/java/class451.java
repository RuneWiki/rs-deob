...
public class class451 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILta;II)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)Lat;")
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lcm;IZLlt;Llt;)V")
