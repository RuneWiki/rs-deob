...
public class class451 extends class184 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BILfh;)V")
    ...
    @OriginalMember(owner = "client!sp", name = "f", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lga;IILjava/awt/Canvas;)Lya;")
