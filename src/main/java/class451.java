...
public class class451 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/lang/String;IZ)Z", line = 36)
