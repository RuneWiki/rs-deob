...
public class class451 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Z)Lwda;", line = 8)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IJLwda;)V", line = 52)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(I)Lwda;", line = 71)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!pt", name = "c", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "([Lwda;I)I", line = 150)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(JB)Lwda;", line = 205)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)Lwda;", line = 240)
