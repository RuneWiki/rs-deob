...
public class class451 extends class88 implements class165 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IBII)I", line = 5)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lsha;IZ[[I)V", line = 43)
    ...
    @OriginalMember(owner = "client!li", name = "e", descriptor = "(B)V", line = 80)
