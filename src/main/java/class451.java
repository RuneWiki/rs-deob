...
public class class451 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lbt;IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BLbt;)V", line = 56)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BIZLqa;)Lf;", line = 76)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)Z", line = 125)
    public final boolean method2673(int arg0) {
        field6275++;
        return arg0 == 0 ? this.field6279.field3173.method1294(this.field6278, (byte) -118) : false;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIB)B", line = 136)
