...
public class class451 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lda;)V", line = 57)
    public class451(class61 arg0) {
        this.field6664 = arg0;
    }

    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lda;Lhia;)V", line = 64)
