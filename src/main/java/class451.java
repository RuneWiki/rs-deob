...
public class class451 extends class201 implements class526 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IILr;)Lda;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIII)Lba;")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lvv;IIZLr;II)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZILr;I)Lfh;")
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(Lr;I)Lbca;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIILr;)Z")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILr;)Lcr;")
