...
public abstract class class451 extends class42 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IILjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(B)F", line = 55)
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(B)I", line = 81)
    ...
    @OriginalMember(owner = "client!or", name = "f", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(IIIIIF)V", line = 111)
