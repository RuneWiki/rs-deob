...
public class class451 extends class677 {
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(I)V", line = 3)
    public class451(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uf", name = "t", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IF)V", line = 25)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(IF)V", line = 41)
