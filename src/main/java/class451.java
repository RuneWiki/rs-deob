...
public class class451 extends class430 implements class29 {
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lto;Los;IIZ[BII)V", line = 14)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IF)F", line = 74)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 85)
    public final IDirect3DBaseTexture method575(byte arg0) {
        int var2 = -98 % ((-arg0 - 83) / 34);
        return this.field6777;
    }

    @OriginalMember(owner = "client!aa", name = "d", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)I", line = 104)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II[IIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lto;IIZ[III)V", line = 153)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Ldca;B)V", line = 210)
    public final void method246(class161 arg0, byte arg1) {
        super.method246(arg0, (byte) 123);
        int var3 = -15 / ((64 - arg1) / 39);
    }

    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lto;Los;Lmg;II)V", line = 218)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILos;II[BIIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FB)F", line = 280)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ZZB)V", line = 292)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(I)I", line = 301)
