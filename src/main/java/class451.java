...
public class class451 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 5)
    public static final byte[] method2673(String arg0, byte arg1) {
        if (arg1 != -60) {
            method2673(null, (byte) 69);
        }
        field6343++;
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(II)I", line = 144)
    public static final int method2674(int arg0, int arg1) {
        int var2 = -57 / ((9 - arg1) / 39);
        field6342++;
        return arg0 & 0xFF;
    }
}
