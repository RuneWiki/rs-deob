...
public class class451 extends class428 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Loj;ZII)Z", line = 11)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)V", line = 55)
