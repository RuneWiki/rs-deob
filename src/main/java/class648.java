...
public abstract class class648 extends class665 {
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!ed", name = "f", descriptor = "(I)V", line = 39)
