...
public class class648 extends class60 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Les;Z)V")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(ILhd;)V")
    public class648(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lhd;)V")
