...
public class class648 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IZ)I", line = 48)
