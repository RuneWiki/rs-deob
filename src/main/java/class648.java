...
public class class648 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BILr;)Luq;", line = 74)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 90)
