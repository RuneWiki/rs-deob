...
public class class648 extends class583 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)Lvg;", line = 8)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!bl", name = "e", descriptor = "(I)Lhha;", line = 35)
