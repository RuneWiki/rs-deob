...
public class class648 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(B)Z", line = 13)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(ILdc;)V", line = 24)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Ldc;ZI)V", line = 60)
