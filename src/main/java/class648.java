...
public class class648 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIIB[BII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(III)I", line = 56)
    ...
    @OriginalMember(owner = "client!pa", name = "toString", descriptor = "()Ljava/lang/String;", line = 81)
    public final String toString() {
        field9138++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lvc;ZI)V", line = 102)
