...
public class class648 extends class656 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(FI)F", line = 3)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lee;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "()V", line = 319)
    public class648() {
    }

    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(ZLkk;)V", line = 321)
