...
public class class648 {
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(III)V", line = 201)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BLmfa;)I", line = 16)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", line = 29)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)[[[I", line = 79)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IB)[[I", line = 130)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIZ)Ljava/lang/String;", line = 212)
