...
public class class648 extends class342 {
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)J", line = 19)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)J", line = 53)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)J", line = 69)
    public final long method1965(int arg0) {
        return arg0 == 1 ? this.field9199 : -74L;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(JI)I", line = 79)
