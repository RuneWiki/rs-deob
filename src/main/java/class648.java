...
public class class648 implements class441 {
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZJ)Z", line = 46)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(III)Z", line = 138)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Loia;Loja;)V", line = 152)
