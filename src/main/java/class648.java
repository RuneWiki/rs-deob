...
public class class648 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BLkv;[I[III)Lno;", line = 9)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILrv;B)V", line = 43)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILrv;)V", line = 89)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ZB)V", line = 115)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(I)V", line = 154)
