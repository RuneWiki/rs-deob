...
public abstract class class648 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Lwu;)V", line = 49)
    public class648(class373 arg0) {
        this.field9139 = arg0;
    }

    @OriginalMember(owner = "client!nia", name = "c", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!nia", name = "d", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Ljava/lang/String;CILjava/lang/String;)Ljava/lang/String;", line = 104)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!nia", name = "e", descriptor = "(Z)V", line = 170)
