...
public class class648 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "()V", line = 11)
    public void method470() {
        field9163++;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BLwi;I)V", line = 192)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BII)V", line = 221)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZII)Z", line = 236)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "()I", line = 248)
    public int method468() throws Exception {
        field9172++;
        return this.field9185;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)V", line = 258)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 276)
    public void method469(Component arg0) throws Exception {
        field9176++;
    }

    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)V", line = 286)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BLwi;)V", line = 297)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "([II)V", line = 312)
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "()V", line = 470)
    public void method466() throws Exception {
        field9161++;
    }

    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(I)V", line = 477)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZLjava/lang/Object;Z)[B", line = 502)
