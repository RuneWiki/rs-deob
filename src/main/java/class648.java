...
public class class648 extends class601 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!qr", name = "f", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lmc;II)V", line = 72)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Luaa;Z)Luaa;", line = 109)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "()V", line = 126)
    public class648() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(II)[[I", line = 169)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lr;III[Z)Z", line = 248)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lqf;IIZ)V", line = 285)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IILjava/lang/String;)V", line = 345)
