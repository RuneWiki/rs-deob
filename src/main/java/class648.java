...
public class class648 extends class462 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Lkf;IILkf;)V", line = 5)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 157)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIB)V", line = 168)
    ...
    @OriginalMember(owner = "client!kia", name = "c", descriptor = "(B)Z", line = 249)
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!kia", name = "c", descriptor = "(I)Z", line = 280)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ZZ[B)V", line = 323)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIII)V", line = 363)
    ...
    @OriginalMember(owner = "client!kia", name = "g", descriptor = "(I)I", line = 395)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(B)Z", line = 408)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(II)V", line = 418)
    ...
    @OriginalMember(owner = "client!kia", name = "j", descriptor = "(I)V", line = 439)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lhk;)V", line = 453)
