...
public class class648 implements Runnable {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/net/URL;I)Lvfa;", line = 7)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/io/File;[B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lvfa;", line = 42)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)V", line = 52)
    public final void method3627(int arg0) {
        field9142 = class571.method3150(124) + (long) arg0;
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IB)Lvfa;", line = 59)
    public final class264 method3628(int arg0, byte arg1) {
        return arg1 == 116 ? this.method3633(null, arg0, arg1 - 32814, 3, 0) : null;
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;B)Lcu;", line = 70)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)Lvfa;", line = 112)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;B)Lcu;", line = 123)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 700)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/String;)Lvfa;", line = 144)
    public final class264 method3632(int arg0, String arg1) {
        return arg0 == 0 ? this.method3633(arg1, 0, -32698, 16, 0) : null;
    }

    @OriginalMember(owner = "client!rj", name = "run", descriptor = "()V", line = 154)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lvfa;", line = 464)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;I)Lvfa;", line = 495)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)Z", line = 507)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IBZLjava/lang/String;)Lvfa;", line = 526)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 537)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lvfa;", line = 558)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "([ILjava/awt/Point;IIZLjava/awt/Component;)Lvfa;", line = 574)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(I)V", line = 592)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;BZ)Lvfa;", line = 647)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIBII)Lvfa;", line = 668)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/awt/Frame;B)Lvfa;", line = 681)
