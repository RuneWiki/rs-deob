...
public class class648 extends class518 {
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILjc;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!sv", name = "f", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "()V", line = 208)
    public class648() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Llga;ILd;)V", line = 147)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(DI)V", line = 160)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IBIIZIII)V", line = 191)
