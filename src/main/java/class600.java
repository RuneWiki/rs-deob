...
public class class600 {
    ...
    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljava/lang/Object;ZZ)[B", line = 19)
    ...
    @OriginalMember(owner = "client!fh", name = "e", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II)V", line = 74)
