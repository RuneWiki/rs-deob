...
public abstract class class600 implements class617 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILcea;)Lkh;", line = 44)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZLff;)V", line = 74)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BZ)V", line = 166)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lin;Lin;Lfn;)V", line = 189)
