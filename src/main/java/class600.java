...
public class class600 extends class38 {
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 7)
    public class600() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ke", name = "f", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILrg;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BI)[I", line = 131)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 273)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BLrg;)Lau;", line = 285)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(I)V", line = 319)
