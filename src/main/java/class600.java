...
public class class600 implements Runnable {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(III[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!jq", name = "run", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 171)
