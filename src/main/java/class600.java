...
public class class600 {
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)V", line = 3)
    public static final void method4459(String arg0, Applet arg1, int arg2) throws Throwable {
        int var3 = 127 % ((17 - arg2) / 33);
        JSObject.getWindow(arg1).eval(arg0);
    }

    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Ljava/lang/String;I[Ljava/lang/Object;Ljava/applet/Applet;)Ljava/lang/Object;", line = 14)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B)Ljava/lang/Object;", line = 24)
