...
public class class600 extends class165 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILpaa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZI)V", line = 44)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IBI)V", line = 54)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IZLhl;)V", line = 132)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lep;Lfa;)V", line = 151)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)Z", line = 185)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(B)V", line = 198)
