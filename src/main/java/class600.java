...
public class class600 extends class601 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BI)[I", line = 34)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "()V", line = 75)
    public class600() {
        super(1, true);
    }
}
