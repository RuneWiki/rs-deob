...
public class class600 extends class502 {
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(ILeka;)V")
    public class600(int arg0, class492 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Leka;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lmo;III)Lfp;")
