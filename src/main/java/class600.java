...
public class class600 implements class716 {
    ...
    @OriginalMember(owner = "client!wba", name = "d", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BILjaclib/memory/Source;I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 61)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IIZ)Z", line = 111)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lsga;Z)V", line = 147)
