...
public class class600 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!nea", name = "toString", descriptor = "()Ljava/lang/String;", line = 51)
    public final String toString() {
        field8553++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(I)V", line = 59)
    public class600(int arg0) {
        this.field8555 = arg0;
    }

    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Lkm;Z)V", line = 71)
