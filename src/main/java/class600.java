...
public class class600 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ZLwk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)Ltc;", line = 229)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Z)I", line = 254)
