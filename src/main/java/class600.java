...
public class class600 extends class682 {
    ...
    @OriginalMember(owner = "client!kfa", name = "d", descriptor = "(I)Lfd;")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Ltha;II)V")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZLtp;I)V")
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lnv;Lpr;)V")
