...
public class class600 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(JB)V", line = 18)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Z)Ljava/io/File;", line = 114)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lbaa;II)V", line = 566)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II[BI)V", line = 146)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 275)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)J", line = 287)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I[BIB)V", line = 361)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BI)V", line = 547)
