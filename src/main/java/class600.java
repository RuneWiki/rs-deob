...
public class class600 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)Llm;", line = 26)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILsba;II)V", line = 57)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(Z)Z", line = 148)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 167)
