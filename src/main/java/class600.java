...
public class class600 extends class417 {
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Llj;Lvn;[Lqga;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(CIIIZLua;II)V", line = 243)
    ...
    @OriginalMember(owner = "client!lc", name = "OA", descriptor = "(CIIIZ)V", line = 290)
