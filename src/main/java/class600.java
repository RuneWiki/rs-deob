...
public class class600 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIJI)V", line = 15)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIIIII)Z", line = 109)
