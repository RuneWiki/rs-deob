...
public class class600 extends class207 {
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(BLof;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(ILrd;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lrd;)V")
