...
public class class600 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lr;Llc;)V", line = 9)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIII)Z", line = 100)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(Lr;Llc;)V", line = 156)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(Lr;Llc;)Z", line = 247)
    public final boolean method3504(class167 arg0, class600 arg1) {
        return this.field8544 != null || this.method3510(arg0, arg1);
    }

    @OriginalMember(owner = "client!lc", name = "b", descriptor = "()V", line = 250)
    public final void method3505() {
        this.field8544 = null;
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lr;)V", line = 255)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(Lr;)V", line = 342)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lr;IIIIII)V", line = 403)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "()V", line = 429)
    ...
    @OriginalMember(owner = "client!lc", name = "d", descriptor = "(Lr;Llc;)Z", line = 443)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
