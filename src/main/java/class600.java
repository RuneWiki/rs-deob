...
public class class600 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILmc;)Laf;", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(B)V", line = 94)
