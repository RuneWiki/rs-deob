...
public class class600 extends class392 implements class65 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 21)
    public final void method690(boolean arg0) {
        this.method4429(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 24)
    public final int method1377() {
        return this.method4439(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIII)V", line = 46)
    public final void method1379(int arg0, int arg1, int arg2, int arg3) {
        this.method4435(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 49)
    public final void method1373(int[] arg0) {
        this.method4438(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 62)
    public final int method1378() {
        return this.method4440(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 65)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[IIIIIZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 79)
    public final void method877(int arg0, int arg1, int arg2) {
        this.method4432(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[I[B[BIIII)V", line = 81)
