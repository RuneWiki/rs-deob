...
public class class784 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(III[BZILkv;I)Lbo;", line = 17)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(BIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IILha;Lwq;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ZI)V", line = 149)
