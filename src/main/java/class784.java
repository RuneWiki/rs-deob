...
public class class784 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZZIJ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 86)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILso;)V", line = 160)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BILso;)V", line = 180)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BZILha;)Ljd;", line = 226)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZI)V", line = 283)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)Z", line = 314)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILjga;)V", line = 333)
