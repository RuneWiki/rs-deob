...
public class class784 extends class238 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[BIIIII[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)D", line = 57)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)Llja;", line = 125)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 137)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)V", line = 212)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IFIFFFFF)F", line = 225)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)I", line = 293)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BI)V", line = 305)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 344)
