...
public class class784 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Ljava/lang/String;IILpc;)Lvea;", line = 22)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILlc;Ljava/lang/String;ZZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILfha;I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lpc;)V", line = 205)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B[[I)V", line = 90)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZZBII)V", line = 144)
