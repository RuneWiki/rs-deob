...
public class class784 extends class659 {
    ...
    @OriginalMember(owner = "client!nca", name = "e", descriptor = "(B)J")
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "([II[ILee;II)Lqb;")
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "([[SD)V")
