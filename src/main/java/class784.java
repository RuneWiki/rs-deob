...
public class class784 extends class593 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lfl;I[[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIB)V", line = 60)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ldga;Llga;Ljd;)V", line = 126)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!ap", name = "h", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IBLah;)V", line = 173)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IZ)V", line = 193)
