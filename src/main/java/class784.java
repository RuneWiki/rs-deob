...
public class class784 extends class102 {
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(ILwm;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BII)B", line = 49)
    ...
    @OriginalMember(owner = "client!rf", name = "f", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZI)V", line = 84)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Lvn;", line = 110)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([BB)I", line = 147)
