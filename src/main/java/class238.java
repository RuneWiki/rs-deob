...
public class class238 extends class252 {
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lur;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lur;IIII)V")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lur;IIIII)V")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lur;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lur;IIIIZ[FI)V")
