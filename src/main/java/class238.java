...
public class class238 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(II)Lvu;", line = 3)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IIZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(Lpo;ILgda;Lgda;Lgda;)V", line = 122)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLha;)V", line = 147)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IB)Loe;", line = 255)
