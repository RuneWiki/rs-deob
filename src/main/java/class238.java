...
public class class238 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(III)Lkn;", line = 5)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)Z", line = 12)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 49)
