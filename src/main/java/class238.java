...
public class class238 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IILoa;ILlm;Llq;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(III[BII[BZI)V", line = 222)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Z[B)[B", line = 267)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)V", line = 328)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 344)
