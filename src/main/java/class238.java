...
public abstract class class238 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I[BIIII)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lsba;B)V", line = 99)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(II[S)[S", line = 140)
    ...
    @OriginalMember(owner = "client!ida", name = "c", descriptor = "(I)V", line = 154)
