...
public class class238 extends class42 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZI)Lii;")
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(Z)Lnn;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lj;III[Z)V")
