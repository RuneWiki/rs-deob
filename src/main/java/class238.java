...
public abstract class class238 extends class154 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lkh;Z)Lkh;")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILkka;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
