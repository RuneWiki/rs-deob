...
public class class238 extends class260 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(ILgn;)V")
    public class238(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lgn;)V")
