...
public class class238 extends class177 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(Lkb;IIIIZ)Z", line = 150)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)I", line = 162)
    public final int method371(int arg0, int arg1) {
        return this.field3134[arg0][arg1];
    }

    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Lkb;IIIIZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(III[[ZZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lcs;II)V", line = 310)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(II)I", line = 360)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(II)V", line = 379)
    public final void method374(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(III)V", line = 381)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "()V", line = 389)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lof;[I)V", line = 907)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lbf;IIII[[I[[II)V", line = 914)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IILkb;)Lkb;", line = 976)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1004)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lkb;IIIIZ)V", line = 1168)
