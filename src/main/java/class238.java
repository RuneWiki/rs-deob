...
public class class238 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(JI)V", line = 8)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILes;)V", line = 98)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(III)Z", line = 119)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BLes;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 178)
