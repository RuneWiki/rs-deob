...
public abstract class class238 extends class540 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
