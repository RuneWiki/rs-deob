...
public abstract class class238 implements class317 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lmw;IIIII)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Ljj;Z)V")
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lmh;IIIZ)V")
