...
public class class238 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIIZLqa;IZ)Lc;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIILc;ZILqa;B)V")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lqa;Lbo;IIIIIIZI)V")
