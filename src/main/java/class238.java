...
public class class238 extends class30 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIZI)Lic;", line = 11)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(BII)Z", line = 80)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!nn", name = "e", descriptor = "(B)Lln;", line = 109)
    ...
    @OriginalMember(owner = "client!nn", name = "f", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(III)Lcb;", line = 177)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Ljg;II)V", line = 184)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZII)Z", line = 262)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IB)[I", line = 284)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lkk;IIII)V", line = 337)
    ...
    @OriginalMember(owner = "client!nn", name = "g", descriptor = "(I)V", line = 394)
