...
public class class238 {
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!bja", name = "b", descriptor = "(B)V", line = 39)
