...
public class class238 extends class206 {
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lco;)V", line = 117)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BII)Z", line = 74)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Z[I[Ljava/lang/Object;)V", line = 99)
