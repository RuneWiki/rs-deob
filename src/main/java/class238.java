...
public class class238 extends class494 {
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(ILha;)Ljda;", line = 10)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(Z)I", line = 53)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lql;Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 84)
    ...
    @OriginalMember(owner = "client!lf", name = "finalize", descriptor = "()V", line = 97)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 523)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(III)I", line = 127)
    ...
    @OriginalMember(owner = "client!lf", name = "g", descriptor = "(I)Z", line = 150)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILwea;III)Ljava/awt/Frame;", line = 161)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BIIILha;ILd;)V", line = 238)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lha;IIB)Lka;", line = 320)
    ...
    @OriginalMember(owner = "client!lf", name = "e", descriptor = "(Z)V", line = 341)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)Z", line = 365)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lka;Lha;ILbca;)V", line = 380)
    ...
    @OriginalMember(owner = "client!lf", name = "i", descriptor = "(I)I", line = 406)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Lha;I)Lhw;", line = 418)
    ...
    @OriginalMember(owner = "client!lf", name = "j", descriptor = "(I)Z", line = 430)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(Lha;I)V", line = 445)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lha;III)Z", line = 467)
    public final boolean method42(class59 arg0, int arg1, int arg2, int arg3) {
        ++field3465;
        return arg3 != 0 ? false : false;
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 478)
    ...
    @OriginalMember(owner = "client!lf", name = "f", descriptor = "(Z)V", line = 512)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IB)V", line = 552)
