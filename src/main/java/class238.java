...
public class class238 extends class574 implements class134 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIIILiba;)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II[BIIIILsq;I)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lmr;Lsq;II[FII)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lmr;Lsq;Lrt;II)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lmr;II[III)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lmr;Lsq;II[BII)V")
