...
public class class238 extends class111 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZILvq;[[IZ)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IZLvq;ZJ)V")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lvq;Lhq;Lnl;J)V")
