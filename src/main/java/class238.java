...
public class class238 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lnq;II)Llg;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "([B)[Llg;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lnq;I)Llg;")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lnq;II)[Llg;")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lnq;I)[Llg;")
