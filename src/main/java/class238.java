...
public class class238 extends class84 {
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "()V", line = 3)
    public class238() {
        super(false);
    }

    @OriginalMember(owner = "client!et", name = "k", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([BZ)Ljava/lang/String;", line = 119)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILkn;B)V", line = 132)
    ...
    @OriginalMember(owner = "client!et", name = "j", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjj;[II[II)Lwga;", line = 158)
