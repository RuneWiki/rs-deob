...
public class class238 extends class509 {
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Ltt;Lmm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lpv;IZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BZ)V", line = 207)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZI)V", line = 219)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZIII)I", line = 250)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIZ)V", line = 286)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 320)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BILin;)V", line = 355)
