...
public class class238 extends class108 implements class534 {
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqa;ZIB)Lso;")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(Lqa;B)Lem;")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILqa;)Lnj;")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lqa;Lku;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILqa;ZLee;Z)V")
