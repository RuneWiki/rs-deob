...
public class class238 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ZIIIILwu;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IBIILaa;ILvfa;JI)V", line = 47)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 103)
