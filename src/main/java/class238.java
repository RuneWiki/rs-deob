...
public class class238 extends class720 {
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIIII)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIII[I)V")
    public class238(class417 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIII)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lnv;IIIZ[III)V")
