...
public class class238 {
    ...
    @OriginalMember(owner = "client!se", name = "exit", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!se", name = "listmodes", descriptor = "()[I", line = 31)
    ...
    @OriginalMember(owner = "client!se", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 154)
