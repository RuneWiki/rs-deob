...
public class class238 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIILuv;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IBILdc;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZILdc;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lha;IIIIIIII)V")
