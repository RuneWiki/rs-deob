...
public class class238 extends InputStream {
    ...
    @OriginalMember(owner = "client!em", name = "read", descriptor = "()I", line = 6)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Ldt;Lec;II)V", line = 116)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)V", line = 231)
