...
public class class238 {
    ...
    @OriginalMember(owner = "client!kk", name = "finalize", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ltc;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lji;JI)V", line = 45)
