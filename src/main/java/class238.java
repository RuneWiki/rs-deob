...
public class class238 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lr;Laba;)Z", line = 3)
    public final boolean method1469(class562 arg0, class238 arg1) {
        return this.field3151 != null || this.method1472(arg0, arg1);
    }

    @OriginalMember(owner = "client!aba", name = "a", descriptor = "()V", line = 13)
    public static final void method1470() {
        field3149 = null;
        field3146 = null;
    }

    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lr;)V", line = 17)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(Lr;Laba;)Z", line = 97)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "()V", line = 133)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(Lr;)V", line = 140)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lr;IIIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(Lr;Laba;)V", line = 230)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(Lr;Laba;)V", line = 324)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "()V", line = 410)
    public final void method1478() {
        this.field3151 = null;
    }

    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIII)Z", line = 417)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 476)
