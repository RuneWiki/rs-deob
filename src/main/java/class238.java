...
public class class238 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IB)Lgo;", line = 4)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lso;B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "()V", line = 124)
    public class238() {
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lfb;)V", line = 143)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lfb;I)V", line = 83)
