...
public class class238 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(II)Lpt;")
    ...
    @OriginalMember(owner = "client!du", name = "c", descriptor = "(II)Llp;")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lya;Z)V")
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Ljk;ILfs;Lfs;Lfs;)V")
