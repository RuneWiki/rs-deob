...
public class class238 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/awt/Frame;Lqn;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "([IIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(Z)V", line = 94)
