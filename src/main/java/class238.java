...
public class class238 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIBI)V", line = 61)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)V", line = 81)
