...
public class class238 extends class681 {
    ...
    @OriginalMember(owner = "client!mb", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)Z", line = 33)
    public final boolean method751(boolean arg0) {
        ++field3268;
        return !arg0 ? true : this.field3267;
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIB)V", line = 44)
    public final void method742(int arg0, int arg1, byte arg2) {
        ++field3272;
        int var4 = -41 / ((arg2 - -38) / 35);
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZI)V", line = 83)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IBI)Z", line = 94)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(ZI)V", line = 105)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Ltba;Lsea;)V", line = 145)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILrga;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!mb", name = "f", descriptor = "(I)V", line = 193)
