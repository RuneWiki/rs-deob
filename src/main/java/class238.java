...
public class class238 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "([BIIIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BI)Ltl;", line = 138)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 202)
