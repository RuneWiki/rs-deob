...
public class class238 {
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(II)Lch;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(F[BIIFIFFIILuv;IF)V")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lai;ILic;)V")
