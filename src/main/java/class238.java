...
public class class238 extends class407 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lcj;III)Ltc;")
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "()Lcv;")
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "()Lcv;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lcj;II)Ltc;")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lcj;II)V")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lcj;III)V")
