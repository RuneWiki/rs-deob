...
public class class238 {
    ...
    @OriginalMember(owner = "client!hu", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field3239++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIILjava/lang/Class;)Lhd;", line = 14)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)V", line = 45)
