...
public class class238 extends class86 implements class147 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZLoa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIIIBLoa;)V", line = 47)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)Z", line = 143)
    public final boolean method140(int arg0) {
        ++field3420;
        return arg0 != 0;
    }

    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Loa;Llt;IIIIIZIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(BLoa;)V", line = 164)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Loa;B)Lac;", line = 175)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILoa;)Lba;", line = 186)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(I)Z", line = 197)
    public final boolean method562(int arg0) {
        ++field3433;
        return arg0 != 29008 ? true : this.field3427.method1567((byte) -44);
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILoa;I)Z", line = 208)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 227)
    ...
    @OriginalMember(owner = "client!mb", name = "d", descriptor = "(I)I", line = 243)
    ...
    @OriginalMember(owner = "client!mb", name = "i", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)V", line = 269)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILoa;)Lwc;", line = 281)
    ...
    @OriginalMember(owner = "client!mb", name = "e", descriptor = "(I)I", line = 326)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLoa;)V", line = 338)
