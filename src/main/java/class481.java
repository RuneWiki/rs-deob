...
public abstract class class481 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILha;I)Loea;")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lqo;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lqo;ILjaclib/memory/Buffer;IZ)V")
