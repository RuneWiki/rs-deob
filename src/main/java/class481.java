...
public class class481 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZILha;I)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lha;BII)Z")
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(Lha;BII)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Len;Ldaa;)V")
