...
public class class481 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lcb;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II)V", line = 85)
