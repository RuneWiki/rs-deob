...
public abstract class class481 implements class492 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFIIIII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFFFIIIII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "c", descriptor = "(IIII)V")
    public final void method2766(int arg0, int arg1, int arg2, int arg3) {
        this.method138(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFFFFFIII)V")
