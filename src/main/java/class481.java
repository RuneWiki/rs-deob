...
public class class481 extends class349 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IB)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IILdga;)V", line = 63)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "([I[I[IILdw;)V", line = 91)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "()V", line = 194)
    public class481() {
        this(0);
    }

    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(I)V", line = 199)
    private class481(int arg0) {
        super(0, false);
        this.method2681(-7844, arg0);
    }

    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Ldga;I)V", line = 208)
