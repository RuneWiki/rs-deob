...
public class class481 extends class38 {
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IILrg;)V", line = 10)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BI)[I", line = 39)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "()V", line = 70)
    public class481() {
        this(4096);
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 79)
