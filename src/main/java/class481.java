...
public abstract class class481 extends class352 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lid;)V", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "(I)Lvo;", line = 100)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(B)V", line = 118)
    public static void method2902(byte arg0) {
        int var1 = 71 / ((-arg0 - 54) / 58);
        field7057 = null;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lfw;", line = 127)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZBLjava/lang/String;Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 938)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I[[[BIBII)V", line = 974)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(IIIIZZ)V", line = 1120)
