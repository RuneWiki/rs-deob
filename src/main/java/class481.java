...
public class class481 extends class77 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILfaa;Lfaa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vda", name = "h", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(BII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 46)
    public class481(Object arg0, int arg1) {
        super(arg1);
        this.field6410 = arg0;
    }

    @OriginalMember(owner = "client!vda", name = "i", descriptor = "(I)Ljava/lang/Object;", line = 58)
