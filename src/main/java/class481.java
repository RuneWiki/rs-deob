...
public class class481 extends class14 {
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!vm", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)[[I", line = 103)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IB)[I", line = 144)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IBLmd;)V", line = 181)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 195)
    public class481() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vm", name = "f", descriptor = "(I)V", line = 200)
