...
public class class481 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lbt;II)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)Llk;")
