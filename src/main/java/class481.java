...
public class class481 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZII)I", line = 68)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZ)Lfb;", line = 136)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)V", line = 176)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lnq;ILga;)V", line = 200)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(Z)V", line = 191)
