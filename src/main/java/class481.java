...
public class class481 extends class518 {
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(II)[I", line = 34)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "()V", line = 261)
    public class481() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILjc;I)V", line = 267)
    ...
    @OriginalMember(owner = "client!kh", name = "f", descriptor = "(I)V", line = 372)
