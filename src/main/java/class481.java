...
public abstract class class481 extends class8 {
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILqa;ZLto;III)V", line = 37)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIIZII)V", line = 68)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)V", line = 123)
