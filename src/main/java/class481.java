...
public class class481 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BI)Lfr;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)Lbs;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILti;)Lii;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILiv;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
