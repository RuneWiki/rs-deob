...
public class class481 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lwu;III)V", line = 197)
