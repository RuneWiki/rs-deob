...
public class class481 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ljava/lang/String;IIZ)Z", line = 24)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IZI)Z", line = 141)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIIZII)V", line = 171)
