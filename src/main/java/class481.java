...
public abstract class class481 extends class89 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lba;III[Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZLga;Lqn;)V", line = 52)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lhf;I)V", line = 64)
