...
public class class481 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lvh;Ldb;Lhn;Lhl;Ltj;Lje;Lvd;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)Lji;", line = 30)
    public static final class433 method2825(int arg0) {
        return (class433) field7033.method979((byte) 28, (long) arg0);
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([B[B[SII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;IIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lm;III)I", line = 545)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)Lcs;", line = 602)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(II)Lji;", line = 622)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;Lls;IIII)V", line = 634)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;IIIIIII[S[BZ)V", line = 638)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "()V", line = 801)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;)Lwo;", line = 829)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Lqa;IIII)Lwo;", line = 841)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lm;II)V", line = 853)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;II)V", line = 863)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;IIII[S[B)V", line = 1043)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "()V", line = 1103)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "()V", line = 1259)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Lqa;)V", line = 1271)
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "()V", line = 1283)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 1296)
    public static final void method2844(int arg0) {
        field7034 = (class433) field7033.method979((byte) 28, (long) arg0);
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIIIII)V", line = 1306)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;Llh;IIII[I[I)V", line = 1319)
