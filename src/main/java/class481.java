...
public abstract class class481 extends class417 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(II)Z", line = 87)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(III)Z", line = 106)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(II)I", line = 118)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BLgw;)V", line = 153)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 254)
