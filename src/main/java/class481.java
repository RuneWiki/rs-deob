...
public class class481 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILol;)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IBLol;)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Luf;Z)Ljava/lang/String;")
