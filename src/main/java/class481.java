...
public class class481 extends class37 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Luj;III)V")
    ...
    @OriginalMember(owner = "client!ni", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lhea;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ni", name = "v", descriptor = "(IILha;)Lha;")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ni", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lrc;[I)V")
