...
public class class481 extends class150 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Let;)V", line = 6)
    public final void method6(class179 arg0) {
        this.field2107.method2692(arg0);
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "()Z", line = 9)
    public final boolean method7() {
        return true;
    }

    @OriginalMember(owner = "client!an", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 26)
    public final void method1(int arg0) {
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)V", line = 28)
    public final void method3(boolean arg0) {
        this.field2107.method2702(8448, 7681);
    }

    @OriginalMember(owner = "client!an", name = "b", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lqi;)V", line = 56)
