...
public abstract class class481 extends class214 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Lha;Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!iga", name = "f", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(B[Luaa;)I", line = 29)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(IIIIII)V", line = 107)
