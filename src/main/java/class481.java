...
public class class481 extends class71 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILdc;I)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIILkea;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZIIIILjava/lang/String;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "()V", line = 139)
    public class481() {
    }

    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 141)
