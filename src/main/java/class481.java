...
public class class481 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(BIIIIIILje;)V", line = 51)
