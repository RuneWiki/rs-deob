...
public class class481 extends class136 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(IIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 136)
    public class481() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(IIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IILiv;)V", line = 194)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BI)[[I", line = 247)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)V", line = 327)
