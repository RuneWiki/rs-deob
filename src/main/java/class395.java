...
public class class395 extends class260 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "()[I", line = 5)
    public final int[] method2384() {
        return this.field5786;
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "()V", line = 53)
    public static void method2386() {
        field5789 = null;
    }

    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(II[IZ)V", line = 58)
