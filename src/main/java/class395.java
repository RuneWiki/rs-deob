...
public class class395 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IJLjava/lang/Object;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 56)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(I)Lcn;", line = 147)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BLow;)V", line = 189)
    ...
    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(I)I", line = 209)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZII)Z", line = 220)
    ...
    @OriginalMember(owner = "client!uaa", name = "d", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(JB)V", line = 245)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(B)V", line = 263)
    ...
    @OriginalMember(owner = "client!uaa", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 289)
    ...
    @OriginalMember(owner = "client!uaa", name = "f", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZJ)Ljava/lang/Object;", line = 343)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Ljava/lang/Object;JI)V", line = 385)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(I)V", line = 400)
