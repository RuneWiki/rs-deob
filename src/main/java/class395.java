...
public class class395 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "([IIIIIZILwd;IIZI[III)I", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILes;)V", line = 196)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIZI)I", line = 246)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILes;I)V", line = 393)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIBIILda;)Lda;", line = 553)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIB)Z", line = 686)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BLda;IIIIII)Lda;", line = 726)
