...
public class class395 extends class16 implements class103 {
    ...
    @OriginalMember(owner = "client!k", name = "t", descriptor = "(IIIIII)V", line = 6)
    public final void method119(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IILma;II)V", line = 11)
    public final void method128(int arg0, int arg1, class10 arg2, int arg3, int arg4) {
        this.method2416(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!k", name = "BA", descriptor = "(III)V", line = 15)
    public final void method112(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!k", name = "b", descriptor = "(FFFFFFLma;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!k", name = "finalize", descriptor = "()V", line = 30)
