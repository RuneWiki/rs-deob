...
public class class395 implements class365 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lfo;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!tv", name = "f", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZZLcl;)V", line = 47)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IB)V", line = 221)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILgb;I)V", line = 247)
    ...
    @OriginalMember(owner = "client!tv", name = "g", descriptor = "(I)I", line = 279)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(Z)I", line = 291)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lgl;IZI)V", line = 313)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lkd;)V", line = 508)
    ...
    @OriginalMember(owner = "client!tv", name = "h", descriptor = "(I)Z", line = 346)
    ...
    @OriginalMember(owner = "client!tv", name = "e", descriptor = "(I)V", line = 369)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 382)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IZ)V", line = 398)
    ...
    @OriginalMember(owner = "client!tv", name = "finalize", descriptor = "()V", line = 417)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(IB)V", line = 426)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IBLfo;)V", line = 446)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)V", line = 457)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IBILgl;I)V", line = 471)
