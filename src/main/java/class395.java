...
public class class395 extends class626 implements class245 {
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZLui;)V")
    public final void method616(boolean arg0, class308 arg1) {
        super.method616(arg0, arg1);
    }

    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lad;IZ[[I)V")
