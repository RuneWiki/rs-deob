...
public class class395 extends class140 {
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Lte;Lwq;)V", line = 38)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILjl;)V", line = 57)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lvp;BI)Ljava/lang/String;", line = 75)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ZB)V", line = 168)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)V", line = 198)
