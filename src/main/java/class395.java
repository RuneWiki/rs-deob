...
public class class395 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ldn;IIIZII)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILos;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILos;I)V")
