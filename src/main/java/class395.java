...
public class class395 {
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IZ)Law;", line = 31)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lwh;Ld;)V", line = 100)
