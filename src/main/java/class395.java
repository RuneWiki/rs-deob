...
public class class395 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZI)I", line = 19)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ZZIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!mea", name = "toString", descriptor = "()Ljava/lang/String;", line = 90)
    public final String toString() {
        field6143++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Lob;II)Z", line = 100)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "([Lf;I)V", line = 127)
