...
public class class395 extends class252 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!ss", name = "e", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZI)V", line = 73)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lbb;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(ZI)V", line = 124)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lhp;Lpu;Luk;)V", line = 134)
    ...
    @OriginalMember(owner = "client!ss", name = "h", descriptor = "(I)V", line = 157)
