...
public class class395 extends class55 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIIII[FFIIF[F)V", line = 8)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III[[ZB)V", line = 57)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IS)V", line = 314)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lac;Lok;Lcba;[I)V", line = 335)
