...
public class class395 extends class35 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lj;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IILcc;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lpe;[I)V")
    public final void method233(class432 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIZLcc;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "QA", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(III[[ZZ)V")
    ...
    @OriginalMember(owner = "client!wm", name = "SA", descriptor = "(Lj;IIIIZ)V")
    public final void method227(class378 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lra;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!wm", name = "O", descriptor = "(IILj;)Lj;")
    public final class378 method224(int arg0, int arg1, class378 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!wm", name = "U", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!wm", name = "JA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!wm", name = "I", descriptor = "(II)I")
    public final int method221(int arg0, int arg1) {
        return this.field5492[arg0][arg1];
    }

    @OriginalMember(owner = "client!wm", name = "va", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIIIIII[[ZLcc;[I[I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(IIIIIII[[ZLcc;[I[I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIIIIII[[Z)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V")
