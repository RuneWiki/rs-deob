...
public class class395 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(B)Les;", line = 30)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(III)Z", line = 63)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 129)
    public class395() {
        try {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILes;)V", line = 110)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)Les;", line = 142)
