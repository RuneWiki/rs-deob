...
public class class395 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIZIBILlt;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Ljava/awt/Component;I)Lts;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZI)Lkl;")
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lcm;ILlt;)V")
