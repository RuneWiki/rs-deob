...
public class class395 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "([I[[B[[BII[II[B)I", line = 30)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)Lae;", line = 88)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZI)V", line = 127)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 160)
