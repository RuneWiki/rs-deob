...
public class class395 extends class333 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(III[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "()Lofa;", line = 80)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!fu", name = "g", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!fu", name = "h", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(III)V", line = 192)
    ...
    @OriginalMember(owner = "client!fu", name = "d", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(III[I)V", line = 227)
    ...
    @OriginalMember(owner = "client!fu", name = "e", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "([I)V", line = 252)
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(III[I)V", line = 269)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lofa;)V", line = 282)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "()V", line = 303)
    ...
    @OriginalMember(owner = "client!fu", name = "f", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 345)
    public class395() {
        this.method1725();
    }
}
