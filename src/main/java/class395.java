...
public class class395 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lcv;B)I", line = 6)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIII)V", line = 67)
