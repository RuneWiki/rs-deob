...
public class class395 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIB[BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIILaj;Lru;Lfb;Ltq;Ldm;Lrg;Lqa;IB)Lc;", line = 78)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ZI)V", line = 276)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILta;Lfb;IZIZLdm;ILqa;IILrg;[Lhj;Ltq;Lru;Laj;Ltq;I)Lc;", line = 290)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(III)V", line = 792)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 811)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IZLdm;I)V", line = 831)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;BI)V", line = 851)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II[IIZ[I)V", line = 887)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ltq;ILdm;ILaj;Lqa;IIIIII)Lc;", line = 927)
