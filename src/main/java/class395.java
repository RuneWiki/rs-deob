...
public class class395 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)I", line = 10)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILnj;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lnj;II)V", line = 137)
