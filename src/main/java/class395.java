...
public abstract class class395 extends class287 {
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILjava/lang/String;)V", line = 50)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(I)V", line = 84)
