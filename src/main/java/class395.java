...
public class class395 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILgk;)V", line = 20)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)Lgk;", line = 52)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(I)Lgk;", line = 96)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(I)Lgk;", line = 119)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BII)V", line = 140)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([I[Ljava/lang/Object;I)V", line = 157)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(I)Lgk;", line = 168)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)I", line = 193)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(ILgk;)V", line = 214)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)Luq;", line = 233)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "()V", line = 342)
    public class395() {
        this.field5735.field3906 = this.field5735;
        this.field5735.field3908 = this.field5735;
    }

    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(B)Lgk;", line = 270)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLeb;Lgk;)V", line = 298)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILeb;)V", line = 324)
