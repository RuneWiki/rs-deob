...
public abstract class class395 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILmq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIBILi;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILofa;Lofa;IIIZ)V", line = 190)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILofa;)V", line = 227)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZIIIIII[IILofa;Lofa;)V", line = 278)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([ZZIIBLhba;I[IZILeq;Leq;)V", line = 318)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZLofa;ILofa;IILofa;ZLofa;IIII[ZI)V", line = 529)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 609)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)I", line = 635)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B[IIIIZIII[I)V", line = 649)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 755)
