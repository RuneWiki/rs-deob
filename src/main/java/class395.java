...
public class class395 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIZILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)Ljava/lang/String;", line = 158)
