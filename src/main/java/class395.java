...
public class class395 implements class578 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZLjava/awt/Component;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "()V", line = 164)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I[I)V", line = 49)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IB)V", line = 80)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)V", line = 131)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(IB)I", line = 187)
