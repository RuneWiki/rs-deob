...
public class class395 implements Runnable {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lan;BI)Lej;")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLrl;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IILan;[B)Lej;")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILej;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lbi;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lan;II)Lej;")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lbd;)V")
