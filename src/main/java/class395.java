...
public class class395 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lla;II)Lku;")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lib;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "()Lps;")
