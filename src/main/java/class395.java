...
public class class395 extends OutputStream {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IB)Lqh;", line = 8)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IBI)I", line = 41)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZI)Ltb;", line = 84)
    ...
    @OriginalMember(owner = "client!qp", name = "write", descriptor = "(I)V", line = 115)
