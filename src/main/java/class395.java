...
public class class395 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ILjava/net/Socket;I)Llda;", line = 5)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ILjava/lang/String;I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZI)V", line = 83)
