...
public class class395 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILfca;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IILfl;Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILfca;)V", line = 144)
