...
public class class395 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILv;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)Lsja;")
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)Lsja;")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lv;)V")
