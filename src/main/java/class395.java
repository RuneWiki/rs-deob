...
public class class395 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLil;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lqj;I)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZLvp;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(II)Lll;")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lil;II)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "([BZIILnr;I[Lbi;)V")
