...
public class class395 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "()V", line = 85)
    public class395() {
    }

    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lgca;)V", line = 87)
    public class395(class209 arg0) {
        this.field5486 = arg0;
    }

    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)Ltq;", line = 35)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Ltq;", line = 53)
