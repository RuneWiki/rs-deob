...
public class class395 extends class312 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILjd;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(FILij;ZI)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ljd;Z)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BLjd;)V")
