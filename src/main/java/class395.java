...
public class class395 extends class282 {
    ...
    @OriginalMember(owner = "client!lp", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!lp", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lvca;IBI)V")
    ...
    @OriginalMember(owner = "client!lp", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lij;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Llaa;[I)V")
