...
public class class395 extends class194 {
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "()V", line = 4)
    public class395() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gp", name = "f", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!gp", name = "h", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(II)[[I", line = 31)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)[I", line = 78)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IILbg;)V", line = 125)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lgd;Luo;B)V", line = 170)
