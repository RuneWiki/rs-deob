...
public class class395 extends class424 {
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 1336)
    public class395() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pj", name = "g", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lrg;BI)V", line = 279)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 316)
    ...
    @OriginalMember(owner = "client!pj", name = "h", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IZ)[[I", line = 433)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I[SI[Ljava/lang/String;I)V", line = 501)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "()V", line = 561)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIIIII)V", line = 789)
