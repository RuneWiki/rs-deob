...
public class class395 extends class247 {
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(Loa;I)Lew;", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Loa;B)Laca;", line = 16)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BLqb;)V", line = 95)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Loa;I)V", line = 128)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I[[[BIBII)V", line = 139)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(III)Lmf;", line = 278)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IILoa;I)Z", line = 286)
