...
public class class395 extends class175 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZI)[I", line = 8)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZILha;Ld;II)V", line = 146)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "()V", line = 228)
    public class395() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILdt;Z)V", line = 232)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)V", line = 293)
