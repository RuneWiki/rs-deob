...
public class class395 extends class160 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lbs;)V")
    public final synchronized void method2372(class160 arg0) {
        arg0.method876((byte) -96);
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "()Lbs;")
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!hw", name = "d", descriptor = "()Lbs;")
    public final class160 method1137() {
        return (class160) this.field5909.method2947(-88);
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lea;Lih;)V")
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(Lbs;)V")
