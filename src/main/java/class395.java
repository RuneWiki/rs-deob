...
public class class395 extends class667 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lud;II)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lbba;Z)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BIIIZILeq;)V")
