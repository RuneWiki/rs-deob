...
public class class395 extends class188 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lrja;Laj;Llja;)V", line = 76)
    ...
    @OriginalMember(owner = "client!om", name = "d", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IBLbm;)V", line = 187)
    public final void method959(int arg0, byte arg1, class123 arg2) {
        int var4 = -118 % ((60 - arg1) / 61);
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)Z", line = 194)
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(B)V", line = 204)
