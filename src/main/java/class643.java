...
public class class643 extends class601 {
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "()V", line = 3)
    public class643() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(IZ)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!rg", name = "e", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIZI)I", line = 93)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z[B)Ljava/lang/String;", line = 142)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lee;BI)V", line = 156)
