...
public class class643 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)Lpha;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Llk;Z)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BLgg;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lgg;I)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZLqe;)V")
