...
public class class643 extends class558 implements class512 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lqba;Llc;Z)V")
    public class643(class540 arg0, class629 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field9334 = arg1;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIIILuf;I)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)Llc;")
