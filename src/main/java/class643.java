...
public abstract class class643 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(JI)V", line = 49)
