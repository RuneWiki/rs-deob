...
public class class643 implements class556 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Leh;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILeh;Z)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Leh;[III)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILeh;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILeh;)V")
