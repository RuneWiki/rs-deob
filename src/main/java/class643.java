...
public class class643 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z)Li;", line = 4)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BI)Ltf;", line = 81)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(II)V", line = 94)
    public class643(int arg0, int arg1) {
        this.field9355 = arg1;
        this.field9348 = arg0;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z[FI)[F", line = 103)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Ltf;I)V", line = 116)
