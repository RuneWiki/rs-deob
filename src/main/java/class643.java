...
public class class643 extends class642 {
    ...
    @OriginalMember(owner = "client!ib", name = "f", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)[[I", line = 72)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "()V", line = 146)
    public class643() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILeh;Lr;I)V", line = 279)
    ...
    @OriginalMember(owner = "client!ib", name = "g", descriptor = "(I)V", line = 614)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILgk;B)V", line = 625)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IZ)Z", line = 675)
