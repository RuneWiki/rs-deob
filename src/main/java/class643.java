...
public class class643 extends class599 implements class57 {
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II)I", line = 28)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 46)
    ...
    @OriginalMember(owner = "client!wo", name = "e", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(Loa;I)Lew;", line = 68)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)Z", line = 82)
    public final boolean method93(int arg0) {
        ++field9263;
        return arg0 != -23445 ? false : this.field9258.method979(1597);
    }

    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Loa;I)V", line = 108)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IZLoa;)Lba;", line = 134)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(II)I", line = 146)
    public static int method3659(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Loa;Lqd;IIIIIZIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IILoa;Leea;I)V", line = 165)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Loa;B)Laca;", line = 198)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BLoa;)V", line = 244)
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IILoa;I)Z", line = 269)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(B)V", line = 297)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILoa;)V", line = 310)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(I)I", line = 323)
