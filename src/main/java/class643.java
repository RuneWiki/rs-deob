...
public class class643 extends class649 {
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)I", line = 3)
    public final int method3631(int arg0) {
        ++field9179;
        return arg0 != 3 ? -39 : super.field9223;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IB)V", line = 28)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lhs;)V", line = 41)
    public class643(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BZ)I", line = 58)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(ILhs;)V", line = 123)
