...
public class class643 implements class560 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIILq;)V", line = 26)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!rg", name = "f", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!rg", name = "g", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IBLq;II)V", line = 300)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IB)V", line = 335)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 349)
    ...
    @OriginalMember(owner = "client!rg", name = "h", descriptor = "(I)I", line = 363)
    ...
    @OriginalMember(owner = "client!rg", name = "e", descriptor = "(I)V", line = 384)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(II)V", line = 398)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILtp;II)V", line = 409)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 437)
    ...
    @OriginalMember(owner = "client!rg", name = "i", descriptor = "(I)Z", line = 450)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILkw;I)V", line = 469)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ltp;II)V", line = 502)
    public final void method3655(class533 arg0, int arg1, int arg2) {
        this.method3652(arg1, arg0, arg2, -1);
        field8848++;
    }

    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(I)V", line = 513)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lqo;)V", line = 560)
    ...
    @OriginalMember(owner = "client!rg", name = "finalize", descriptor = "()V", line = 534)
