...
public class class643 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(III)Lht;", line = 6)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 30)
