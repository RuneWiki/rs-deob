...
public class class643 {
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(I)Lmfa;", line = 17)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "([[F[[SB)[[S", line = 40)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILmfa;)V", line = 69)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(I)V", line = 112)
    public class643(int arg0) {
        this.field8911 = arg0;
    }

    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(IIIIII)V", line = 119)
