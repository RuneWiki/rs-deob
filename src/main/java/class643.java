...
public class class643 extends class1 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IBILjb;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIIZIII)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I[IBII)V")
