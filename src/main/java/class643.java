...
public class class643 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lrg;BI)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lha;BIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILrg;)V")
