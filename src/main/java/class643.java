...
public class class643 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "([BIIIIFFLkc;FBFIF)V", line = 5)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 46)
