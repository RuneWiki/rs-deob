...
public class class643 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(III)I", line = 13)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BI)Lih;", line = 49)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(IIII)V", line = 269)
