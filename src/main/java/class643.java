...
public class class643 extends class536 implements class249 {
    ...
    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILua;II)V", line = 15)
    public final void method153(int arg0, int arg1, class600 arg2, int arg3, int arg4) {
        this.method3593(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "(FFFFFFILua;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!va", name = "xa", descriptor = "(III)V", line = 37)
    public final void method158(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;[IIIII)V", line = 40)
