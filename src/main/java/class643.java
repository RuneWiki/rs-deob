...
public class class643 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZBI)V", line = 11)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lha;IIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "()V", line = 346)
    protected class643() {
        try {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lha;Lib;I)V", line = 374)
