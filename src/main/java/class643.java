...
public class class643 extends class140 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lqa;)V", line = 6)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(Lte;)V", line = 82)
    public class643(class527 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(III)V", line = 87)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ZB)V", line = 99)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IILjl;)V", line = 123)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "()V", line = 154)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IILjava/lang/String;)V", line = 327)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IZ)V", line = 357)
