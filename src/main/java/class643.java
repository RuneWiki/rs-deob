...
public class class643 implements Runnable {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!om", name = "run", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Ltq;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLjava/lang/String;)Lnga;", line = 93)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lsb;[Ljr;B)Lwga;", line = 113)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "()V", line = 591)
    public class643() {
