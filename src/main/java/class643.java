...
public class class643 extends class354 {
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(II)I", line = 23)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 38)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lwo;)V", line = 68)
    public class643(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIILkv;)V", line = 73)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(ILwo;)V", line = 119)
    public class643(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZII)V", line = 132)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)I", line = 157)
    ...
    @OriginalMember(owner = "client!ck", name = "d", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZII[Lria;II)V", line = 188)
