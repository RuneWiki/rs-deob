...
public class class643 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(I)[Lvk;")
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Lwia;)V")
