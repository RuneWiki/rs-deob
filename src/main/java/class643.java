...
public class class643 extends class163 {
    ...
    @OriginalMember(owner = "client!ww", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lr;ILkt;Llv;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)Lkm;", line = 173)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(B)I", line = 274)
    public final int method3574(byte arg0) {
        field8906++;
        return arg0 == -50 ? this.field8884 : 68;
    }

    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(B)I", line = 294)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BILjava/lang/Object;I)[B", line = 317)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(II)[B", line = 348)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(IB)V", line = 369)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BII)Lkw;", line = 399)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IB)I", line = 664)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lio;B)Lnga;", line = 688)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Z)V", line = 726)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(ILcr;Lcr;Lgb;Lqt;I[BIZ)V", line = 1090)
    ...
    @OriginalMember(owner = "client!ww", name = "e", descriptor = "(I)V", line = 918)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIIIII)V", line = 959)
    ...
    @OriginalMember(owner = "client!ww", name = "f", descriptor = "(I)I", line = 1005)
    ...
    @OriginalMember(owner = "client!ww", name = "g", descriptor = "(I)I", line = 1027)
    ...
    @OriginalMember(owner = "client!ww", name = "h", descriptor = "(I)V", line = 1047)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILdf;)V", line = 1058)
