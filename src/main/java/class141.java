...
public class class141 extends class298 {
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "()V", line = 3)
    public class141() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIB)V", line = 13)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILvt;)V", line = 27)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(II)[[I", line = 94)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)V", line = 204)
