...
public class class141 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!tca", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field1917++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IIILhk;Lhk;)V", line = 33)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Lio;B)Lfo;", line = 71)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(II)V", line = 92)
