...
public abstract class class141 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lgh;Ljava/lang/Object;B)V")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lrr;[Lada;)V")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(B)[Lkda;")
