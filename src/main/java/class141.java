...
public class class141 extends Callback {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Ljava/awt/Component;ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IBI)V", line = 49)
    public final void method1199(int arg0, byte arg1, int arg2) {
        User32.SetCursorPos(arg0, arg2);
        int var4 = -122 / ((arg1 + 19) / 46);
    }

    @OriginalMember(owner = "client!g", name = "callback", descriptor = "(IIII)I", line = 58)
