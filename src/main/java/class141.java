...
public class class141 extends class344 {
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lse;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lse;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lse;II)V")
