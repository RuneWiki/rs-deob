...
public class class141 extends class14 {
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "()V", line = 88)
    public class141() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IBLmd;)V", line = 96)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(I)V", line = 122)
