...
public class class141 {
    ...
    @OriginalMember(owner = "client!vf", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1692++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(IIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)I", line = 58)
