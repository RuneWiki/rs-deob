...
public class class141 extends class80 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZLm;Lvh;DII)[I", line = 16)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZLvh;BZLm;DI)[I", line = 157)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lm;ILvh;)Z", line = 298)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZJ)Ljava/lang/String;", line = 355)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "()V", line = 412)
    public class141() {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)V", line = 428)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Llh;)V", line = 438)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILm;ZIILvh;)[F", line = 524)
