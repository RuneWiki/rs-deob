...
public class class141 extends class370 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(BIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!nt", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(IIII)[B", line = 45)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "()V", line = 87)
    public class141() {
