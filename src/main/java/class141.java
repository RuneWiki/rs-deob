...
public class class141 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lr;BII)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILr;BI)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIILjava/lang/Class;)Lht;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILr;II)Z")
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Ldw;Lrq;)V")
