...
public class class141 implements Runnable {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BILht;)Lef;", line = 30)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!su", name = "run", descriptor = "()V", line = 82)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIZI[BILug;)Lnq;", line = 132)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILht;I)Lef;", line = 151)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lef;Z)V", line = 169)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "([BILht;I)Lef;", line = 181)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lpc;)V", line = 233)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)V", line = 214)
