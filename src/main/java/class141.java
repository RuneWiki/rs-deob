...
public abstract class class141 extends class324 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IFFIFIFFLqp;I[BBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I[J[Ljava/lang/Object;)V", line = 34)
    ...
    @OriginalMember(owner = "client!aq", name = "e", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!aq", name = "f", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!aq", name = "g", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BILjava/awt/Canvas;Lkea;Le;)Loa;", line = 79)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lad;)V", line = 135)
    public class141(class362 arg0) {
        this.field1741 = arg0;
    }

    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(Z)Z", line = 149)
