...
public class class141 {
    ...
    @OriginalMember(owner = "client!si", name = "finalize", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lmr;JI)V", line = 63)
