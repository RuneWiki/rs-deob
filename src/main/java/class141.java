...
public class class141 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fq", name = "toString", descriptor = "()Ljava/lang/String;", line = 21)
    public final String toString() {
        field1681++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(IIII)V", line = 44)
