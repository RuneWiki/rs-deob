...
public class class141 extends class499 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Z)Z", line = 95)
    public final boolean method200(boolean arg0) {
        ++field1841;
        return !arg0 ? true : true;
    }

    @OriginalMember(owner = "client!rp", name = "f", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!rp", name = "g", descriptor = "(I)Leka;", line = 122)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BII)V", line = 133)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILsfa;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!rp", name = "e", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lgd;)V", line = 185)
