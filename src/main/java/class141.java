...
public class class141 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILoa;J)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)Luaa;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)Lfaa;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lki;I)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)Lfaa;")
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lki;)V")
