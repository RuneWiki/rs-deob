...
public class class141 extends class362 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 882)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 1021)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(I)V", line = 1034)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(II)V", line = 1046)
