...
public class class141 extends class328 {
    ...
    @OriginalMember(owner = "client!wea", name = "c", descriptor = "(I)Lhda;")
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lhda;FILhda;)Z")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Llj;I)V")
