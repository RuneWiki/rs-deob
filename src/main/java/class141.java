...
public class class141 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lij;ILea;Lij;)V", line = 15)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "()V", line = 61)
    public class141() {
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lrg;)V", line = 90)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILrg;)V", line = 78)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILeq;)Z", line = 174)
