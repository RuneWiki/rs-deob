...
public class class141 extends class164 {
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(I)V", line = 19)
    public class141(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([II)V", line = 23)
    ...
    @OriginalMember(owner = "client!ik", name = "j", descriptor = "(B)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ik", name = "z", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I[BII)V", line = 120)
    ...
    @OriginalMember(owner = "client!ik", name = "o", descriptor = "(II)I", line = 140)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 151)
    ...
    @OriginalMember(owner = "client!ik", name = "p", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!ik", name = "A", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!ik", name = "q", descriptor = "(II)I", line = 188)
    ...
    @OriginalMember(owner = "client!ik", name = "B", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!ik", name = "C", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!ik", name = "D", descriptor = "(I)V", line = 246)
