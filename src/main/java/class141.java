...
public class class141 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II[Lvp;)V", line = 13)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(I)V", line = 105)
    public class141(int arg0) {
        this.field1992 = arg0;
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IZI)Z", line = 114)
    ...
    @OriginalMember(owner = "client!aq", name = "toString", descriptor = "()Ljava/lang/String;", line = 129)
