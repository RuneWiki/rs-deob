...
public class class141 extends class468 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BIIFFIFLfq;FFI)[B")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lno;IIZ)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lno;IIII)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lno;II[III)V")
