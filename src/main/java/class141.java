...
public class class141 {
    ...
    @OriginalMember(owner = "client!cga", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field1926++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIB)I", line = 13)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ILcs;)V", line = 58)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIII)Z", line = 91)
