...
public class class141 extends class456 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IBLre;)V", line = 7)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lfn;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)[[I", line = 115)
    ...
    @OriginalMember(owner = "client!iq", name = "h", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "()V", line = 223)
    public class141() {
        super(1, false);
    }

    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIBII)V", line = 269)
