...
public class class141 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([III)Lfk;", line = 8)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lrv;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II[IB)Lfk;", line = 39)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([IIB)Lfk;", line = 87)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I[III)Lfk;", line = 116)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lae;Lae;)V", line = 198)
    public class141(class283 arg0, class283 arg1) {
        this.field1801 = arg1;
        this.field1799 = arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lgga;I)Ldd;", line = 178)
