...
public class class141 extends class65 implements class585 {
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lqj;ILjaclib/memory/Buffer;IZ)V")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lqj;I[BIZ)V")
    public class141(class548 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1823 = arg1;
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lrj;Lpl;I)V")
