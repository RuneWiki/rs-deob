...
public class class141 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lha;Lls;)Z", line = 74)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "()V", line = 111)
    public final void method872() {
        this.field1820 = null;
    }

    @OriginalMember(owner = "client!ls", name = "b", descriptor = "()V", line = 114)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Lha;Lls;)V", line = 121)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lha;IIIIII)V", line = 204)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Lha;)V", line = 229)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIII)Z", line = 322)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(Lha;Lls;)V", line = 378)
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "(Lha;Lls;)Z", line = 462)
    public final boolean method879(class60 arg0, class141 arg1) {
        return this.field1820 != null || this.method871(arg0, arg1);
    }

    @OriginalMember(owner = "client!ls", name = "c", descriptor = "()V", line = 469)
    public static final void method880() {
        field1809 = null;
        field1808 = null;
    }

    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 472)
