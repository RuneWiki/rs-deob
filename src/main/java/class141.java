...
public class class141 extends class264 {
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lmfa;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(ILmfa;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "e", descriptor = "(I)Lmfa;")
