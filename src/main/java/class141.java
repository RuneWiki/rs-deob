...
public class class141 extends class337 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)[Le;", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "()V", line = 26)
    public class141() {
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lic;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 62)
