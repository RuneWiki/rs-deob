...
public class class141 extends class312 implements class164 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILya;B)Lt;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lya;Z)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lya;ZI)Lt;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lya;I)Lag;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BLya;II)Z")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IILya;ILor;IZ)V")
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lya;Ljt;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lya;ZII)Lpm;")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ZLya;)V")
