...
public class class141 extends class439 {
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lpo;IIIIZ[BIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lpo;IIIIZ[FI)V", line = 57)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lpo;IIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lpo;IIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lpo;IIIIZ[IZ)V", line = 217)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "()V", line = 126)
    public final void method460() {
        this.field6436.field4752.glFramebufferTexture2DEXT(36160, this.field1991, this.field6438, 0, 0);
        this.field1991 = -1;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIII[BIIIZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIII[IIIZ)V", line = 178)
