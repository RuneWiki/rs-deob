...
public class class141 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILjc;)V", line = 6)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 31)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 170)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Ljc;II)V", line = 184)
