...
public class class141 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lvd;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IZB)V", line = 24)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZZII)V", line = 43)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lhd;)V", line = 99)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II)Z", line = 85)
