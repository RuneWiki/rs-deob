...
public class class141 extends class739 {
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "()V", line = 3)
    public class141() {
        this(0);
    }

    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(I)V", line = 15)
    private class141(int arg0) {
        super(0, false);
        this.method1024(4080, arg0);
    }

    @OriginalMember(owner = "client!fn", name = "d", descriptor = "(III)I", line = 23)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lsl;II)V", line = 40)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BI)[[I", line = 96)
