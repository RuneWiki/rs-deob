...
public class class141 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II)Lqc;")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZLwt;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "([IJLjd;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(ILdn;Ldn;Lqj;)V")
