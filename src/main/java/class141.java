...
public class class141 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lkm;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lkm;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lkm;IZLjava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lkm;Ljava/lang/String;[IIIIZ)V")
