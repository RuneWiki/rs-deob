...
public class class141 extends class94 {
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)Lop;", line = 41)
    ...
    @OriginalMember(owner = "client!s", name = "e", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!s", name = "f", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!s", name = "g", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BI)V", line = 407)
    ...
    @OriginalMember(owner = "client!s", name = "h", descriptor = "(I)V", line = 437)
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(II)V", line = 450)
    ...
    @OriginalMember(owner = "client!s", name = "i", descriptor = "(I)I", line = 462)
    ...
    @OriginalMember(owner = "client!s", name = "j", descriptor = "(I)V", line = 489)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(Z)V", line = 522)
    ...
    @OriginalMember(owner = "client!s", name = "k", descriptor = "(I)I", line = 541)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(II)[B", line = 564)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)Lfm;", line = 584)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(ILpp;Lpp;Lsa;Lvm;IIZ)V", line = 922)
    ...
    @OriginalMember(owner = "client!s", name = "l", descriptor = "(I)I", line = 805)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IZ)I", line = 821)
    ...
    @OriginalMember(owner = "client!s", name = "m", descriptor = "(I)I", line = 840)
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(II)Lsp;", line = 871)
