...
public class class44 extends class496 implements class557 {
    ...
    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 12)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()Z", line = 17)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILqja;ZII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Lgv;", line = 44)
    public final class88[] method97() {
        return this.field555;
    }

    @OriginalMember(owner = "client!i", name = "e", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqja;Lag;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()[Loq;", line = 82)
    public final class378[] method103() {
        return this.field554;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 91)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqja;)V", line = 142)
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()V", line = 196)
    public final void method107() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILqja;ZI)Z", line = 200)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Ldba;IIII)V", line = 203)
