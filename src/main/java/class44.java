...
public class class44 extends class665 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lpj;Le;B)Z")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BZDIILpj;ZLe;)[I")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BI)Z")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Le;ZILpj;IDI)[I")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Ljr;)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIZLe;Lpj;I)[F")
