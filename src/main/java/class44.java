...
public class class44 implements Runnable {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lrn;I)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "([BILvm;I)Lrn;")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILvm;)Lrn;")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lvm;BI)Lrn;")
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lwv;)V")
