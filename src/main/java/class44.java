...
public class class44 extends class210 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILgt;IBLjava/awt/Component;)Lfr;", line = 19)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IB)[I", line = 102)
    ...
    @OriginalMember(owner = "client!wb", name = "e", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BI)V", line = 266)
    ...
    @OriginalMember(owner = "client!wb", name = "d", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "()V", line = 294)
    public class44() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IILat;)V", line = 317)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IZII)I", line = 361)
