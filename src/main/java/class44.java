...
public class class44 extends class56 {
    ...
    @OriginalMember(owner = "client!NLPNWUNL", name = "vb", descriptor = "LRBTWCHLG;")
    public class58 field1080;

    @OriginalMember(owner = "client!NLPNWUNL", name = "c", descriptor = "(I)LRTQSBWRH;")
    ...
    @OriginalMember(owner = "client!NLPNWUNL", name = "a", descriptor = "(I)LRTQSBWRH;")
