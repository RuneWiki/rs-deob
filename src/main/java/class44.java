...
public class class44 {
    ...
    @OriginalMember(owner = "client!OQTGDMNX", name = "f", descriptor = "[LOQTGDMNX;")
    public static class44[] field1169;

    @OriginalMember(owner = "client!OQTGDMNX", name = "a", descriptor = "(ILQKFGLETG;)V")
    ...
    @OriginalMember(owner = "client!OQTGDMNX", name = "a", descriptor = "(BLXJCNBMKS;)V")
    ...
    @OriginalMember(owner = "client!OQTGDMNX", name = "a", descriptor = "(I)LFUTAQMCE;")
    ...
    @OriginalMember(owner = "client!OQTGDMNX", name = "b", descriptor = "(B)LFUTAQMCE;")
