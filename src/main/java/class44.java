...
public class class44 extends class119 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lda;)V", line = 69)
    public static final void method461(class400 arg0) {
        class35.field332 = arg0;
    }

    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIBIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZII)V", line = 284)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(III)Z", line = 295)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(III)V", line = 310)
