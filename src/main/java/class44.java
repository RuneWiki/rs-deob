...
public class class44 {
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lfc;Lrb;Los;IIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IZLui;)V", line = 380)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 397)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(III)V", line = 412)
