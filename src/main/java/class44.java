...
public class class44 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(JILtda;[I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)Lqaa;", line = 30)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(ILkda;Lkda;Ljv;)V", line = 236)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 91)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lvp;B)V", line = 163)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)V", line = 202)
