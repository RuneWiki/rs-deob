...
@OriginalClass("client!MSKEMKWR")
public class class44 extends class18 {

    @OriginalMember(owner = "client!MSKEMKWR", name = "u", descriptor = "I")
    private int field1254;

    @OriginalMember(owner = "client!MSKEMKWR", name = "v", descriptor = "I")
    private int field1255;

    @OriginalMember(owner = "client!MSKEMKWR", name = "w", descriptor = "I")
    private int field1256;

    @OriginalMember(owner = "client!MSKEMKWR", name = "q", descriptor = "I")
    private int field1250;

    @OriginalMember(owner = "client!MSKEMKWR", name = "r", descriptor = "I")
    private int field1251;

    @OriginalMember(owner = "client!MSKEMKWR", name = "s", descriptor = "I")
    private int field1252;

    @OriginalMember(owner = "client!MSKEMKWR", name = "t", descriptor = "I")
    private int field1253;

    @OriginalMember(owner = "client!MSKEMKWR", name = "n", descriptor = "LKIRTNGZJ;")
    private class39 field1247;

    @OriginalMember(owner = "client!MSKEMKWR", name = "m", descriptor = "I")
    private int field1246;

    @OriginalMember(owner = "client!MSKEMKWR", name = "o", descriptor = "I")
    private int field1248;

    @OriginalMember(owner = "client!MSKEMKWR", name = "y", descriptor = "I")
    public int field1258;

    @OriginalMember(owner = "client!MSKEMKWR", name = "z", descriptor = "I")
    public int field1259;

    @OriginalMember(owner = "client!MSKEMKWR", name = "p", descriptor = "[I")
    public int[] field1249;

    @OriginalMember(owner = "client!MSKEMKWR", name = "x", descriptor = "Lclient;")
    public static client field1257;

    @OriginalMember(owner = "client!MSKEMKWR", name = "a", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!MSKEMKWR", name = "b", descriptor = "(I)LVCGOMUBN;")
    ...
    @OriginalMember(owner = "client!MSKEMKWR", name = "<init>", descriptor = "(IIIIIIIZII)V")
