...
public class class44 extends class497 implements class558 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILal;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILal;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lal;Lju;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILal;)V")
    private final void method257(int[] arg0, class109 arg1) {
        this.field466.method3978().method3558(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lal;Lju;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lal;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lal;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "()[Lvja;")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lrea;")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lgl;IIII)V")
