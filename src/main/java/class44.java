...
public class class44 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILvm;)Z")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lam;Lam;Lam;Ls;B)Z")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)Luh;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
