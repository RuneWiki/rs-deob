...
public class class44 extends class499 implements class560 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILsk;ZII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()Z", line = 24)
    public final boolean method288() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILsk;ZI)Z", line = 29)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lsk;IZ)V", line = 35)
    public final void method293(class650 arg0, int arg1, boolean arg2) {
        this.method321(((class294) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "()V", line = 39)
    public final void method294() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lsk;Leea;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 68)
    public final void method306(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Ldc;IIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lsk;Leea;II)V", line = 147)
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()[Loea;", line = 163)
    public final class624[] method311() {
        return this.field693;
    }

    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 166)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lsk;)V", line = 171)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILsk;)V", line = 226)
    private final void method313(int[] arg0, class650 arg1) {
        this.field694.method4008().method3599(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "d", descriptor = "()V", line = 230)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "()[Lqr;", line = 255)
    public final class72[] method322() {
        return this.field696;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 259)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()V", line = 266)
