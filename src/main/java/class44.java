...
public class class44 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Z[B)[B", line = 30)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIIIIIIIIIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)I", line = 202)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(II)I", line = 220)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(II)V", line = 233)
