...
public class class44 extends class290 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILza;IILvl;Z)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lza;II)Le;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLe;Lza;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(ILza;)Lsr;")
