...
public class class44 {
    ...
    @OriginalMember(owner = "client!RLHOXRLU", name = "q", descriptor = "LRFLXBNRG;")
    private class42 field1365;

    @OriginalMember(owner = "client!RLHOXRLU", name = "d", descriptor = "LVJXKRAVR;")
    private class59 field1352;

    @OriginalMember(owner = "client!RLHOXRLU", name = "e", descriptor = "LVJXKRAVR;")
    private class59 field1353;

    @OriginalMember(owner = "client!RLHOXRLU", name = "f", descriptor = "LVJXKRAVR;")
    private class59 field1354;

    @OriginalMember(owner = "client!RLHOXRLU", name = "g", descriptor = "LVJXKRAVR;")
    private class59 field1355;

    @OriginalMember(owner = "client!RLHOXRLU", name = "h", descriptor = "LVJXKRAVR;")
    private class59 field1356;

    @OriginalMember(owner = "client!RLHOXRLU", name = "i", descriptor = "LVJXKRAVR;")
    private class59 field1357;

    @OriginalMember(owner = "client!RLHOXRLU", name = "j", descriptor = "LVJXKRAVR;")
    private class59 field1358;

    @OriginalMember(owner = "client!RLHOXRLU", name = "k", descriptor = "LVJXKRAVR;")
    private class59 field1359;

    @OriginalMember(owner = "client!RLHOXRLU", name = "r", descriptor = "LVJXKRAVR;")
    ...
    @OriginalMember(owner = "client!RLHOXRLU", name = "a", descriptor = "(LMLYYHULT;B)V")
