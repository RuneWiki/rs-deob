...
public class class44 extends class498 implements class559 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnh;Lgca;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILnh;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILnh;)V")
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()[Lir;")
    public final class28[] method370() {
        return this.field596;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lmk;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILnh;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnh;Lgca;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnh;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnh;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lso;IIII)V")
