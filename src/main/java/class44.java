...
public class class44 extends class475 implements class105 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lt;IIIZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "()[Luj;", line = 25)
    public final class262[] method431() {
        return this.field561;
    }

    @OriginalMember(owner = "client!da", name = "finalize", descriptor = "()V", line = 31)
    protected final void finalize() {
        class438.method2701(-71, this);
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII)V", line = 36)
    public final void method434(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lju;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lju;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILc;Z)Z", line = 75)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILc;)V", line = 83)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "()Z", line = 136)
    public final boolean method445() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIZ)Lt;", line = 142)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "()V", line = 151)
    public final void method455() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "()[Ldv;", line = 154)
    public final class471[] method456() {
        return this.field559;
    }

    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lqa;Lna;Ltp;IIII)V", line = 158)
