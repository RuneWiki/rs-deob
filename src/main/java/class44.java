...
public class class44 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Loa;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Loa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "()V")
    public static void method273() {
        field606 = null;
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Loa;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Loa;IZLjava/awt/Component;)V")
