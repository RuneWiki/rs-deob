...
public class class44 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ILee;Z)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lee;B)V")
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(B)I")
