...
public class class44 extends class418 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lir;)Z")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lir;II)Lfo;")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([I)Lhh;")
