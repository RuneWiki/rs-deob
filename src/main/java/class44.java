...
public class class44 extends class497 implements class558 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILqq;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqq;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILqq;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILqq;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqq;Lng;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Ljk;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqq;Lng;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lhja;")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lju;IIII)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lqq;)V")
