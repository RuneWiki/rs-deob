...
public class class44 extends class260 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IBI)V", line = 19)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(CI)Z", line = 114)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "()V", line = 150)
    public class44() {
    }

    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(S)V", line = 152)
