...
public class class44 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIF)F", line = 12)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Liv;Lej;)V", line = 18)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IF)I", line = 85)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(IIF)F", line = 157)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(F)F", line = 169)
    private static final float method479(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "()V", line = 173)
