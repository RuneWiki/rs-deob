...
public class class44 extends class401 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lwp;BLvda;IIILlf;Lr;)V", line = 7)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(I[B)V", line = 90)
