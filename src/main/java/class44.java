...
public class class44 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)Lus;", line = 36)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIZILha;III)V", line = 64)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZLd;ILjava/awt/Canvas;I)Lha;", line = 93)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZII)V", line = 105)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 129)
