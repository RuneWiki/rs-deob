...
public class class44 extends class31 {
    ...
    @OriginalMember(owner = "client!PJUTMHMD", name = "k", descriptor = "Z")
    public static boolean field1125;

    @OriginalMember(owner = "client!PJUTMHMD", name = "i", descriptor = "[LDOBBTZYO;")
    ...
    @OriginalMember(owner = "client!PJUTMHMD", name = "a", descriptor = "(I)LVHYCWIPJ;")
