...
public class class44 extends class297 {
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(B)Lwaa;")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lnv;I)V")
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lqj;IIIIII)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
