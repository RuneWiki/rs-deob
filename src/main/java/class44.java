...
public class class44 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIB)V", line = 37)
