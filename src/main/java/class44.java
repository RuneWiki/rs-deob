...
public class class44 extends class495 implements class556 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Leh;)V", line = 8)
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()[Lrf;", line = 71)
    public final class92[] method116() {
        return this.field651;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lnha;", line = 81)
    public final class338[] method54() {
        return this.field652;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Leh;IZ)V", line = 128)
    public final void method110(class378 arg0, int arg1, boolean arg2) {
        this.method299(((class290) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Leh;Lsp;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()V", line = 151)
    public final void method76() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 160)
    public final void method106(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 164)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()Z", line = 170)
    public final boolean method99() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILeh;ZI)Z", line = 173)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lhm;IIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Leh;Lsp;I)V", line = 248)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILeh;ZII)Z", line = 264)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 269)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILeh;)V", line = 272)
