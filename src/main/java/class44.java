...
public class class44 extends class72 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!sca", name = "d", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(ILcq;)V")
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lcq;)V")
