...
public class class44 implements Runnable {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIIII)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ZLjava/awt/datatransfer/Transferable;)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLjava/awt/Frame;)Lit;")
    public final class439 method323(byte arg0, Frame arg1) {
        return arg0 == 25 ? this.method334(0, arg1, 7, 0, (byte) -20) : null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/Class;Z)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;Z)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I[IILjava/awt/Component;ILjava/awt/Point;)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lit;")
    public final class439 method332(Runnable arg0, int arg1, int arg2) {
        return arg1 == 2 ? this.method334(0, arg0, 2, arg2, (byte) -17) : null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IBLjava/lang/String;)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILjava/lang/Object;IIB)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(B)Lit;")
    public final class439 method335(byte arg0) {
        return arg0 == 59 ? this.method334(0, null, 18, 0, (byte) -127) : null;
    }

    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)Lcd;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/String;B)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;ILjava/lang/Class;)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLjava/net/URL;)Lit;")
    public final class439 method340(byte arg0, URL arg1) {
        return arg0 == 2 ? this.method334(0, arg1, 4, 0, (byte) -42) : null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ZBLjava/awt/Component;)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Ljava/lang/Class;B)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ILjava/lang/String;)Lit;")
    public final class439 method343(int arg0, String arg1) {
        return arg0 == 14 ? this.method334(0, arg1, 12, 0, (byte) -109) : null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIILjava/awt/Component;)Lit;")
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(I)Lit;")
