...
public class class44 extends class393 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lcaa;Lcaa;FLcaa;)Lcaa;")
    public final class275 method313(class275 arg0, class275 arg1, float arg2, class275 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!kaa", name = "h", descriptor = "()Lik;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IZ[[II)Lgi;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lcr;I)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZI)Lcda;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lf;Z)V")
    public final void method241(class701 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZIILfca;[BIZI)Lco;")
    ...
    @OriginalMember(owner = "client!kaa", name = "e", descriptor = "(II)Ljfa;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lfj;I)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lfca;ZLbv;)Z")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IZLuf;Z)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/naa;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Ltp;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Lfa;Ljn;I)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILdg;)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Ljagdx/D3DPRESENT_PARAMETERS;IBIILjagdx/IDirect3D;)Z")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lvn;B)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lfca;ILbv;)Z")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IILel;)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILfca;BILbv;)Lco;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "([BILfca;III)Lck;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lfw;I)I")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lgga;I)I")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B[Lmm;)Lfj;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILqea;)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IIILqf;)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Luf;I)I")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lfca;III[FIIZ)Lco;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZIILuf;Z)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(BZ)Lel;")
    ...
    @OriginalMember(owner = "client!kaa", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Lfa;Ljn;Ljava/lang/Integer;)Lr;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lqf;B)I")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lvg;I)I")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "([IIIIIZI)Lco;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILqf;IIILcda;B)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZLfca;Lbv;)I")
