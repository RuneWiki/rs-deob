...
public class class44 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILht;)Lfe;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IZII)Lmv;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)Lfi;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)Ldf;")
