...
public class class44 extends class40 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILvq;I)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IILlf;)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IILvq;Lbi;II)V")
