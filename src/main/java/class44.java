...
public class class44 extends class467 {
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)Lps;", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I[B)[B", line = 33)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILap;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "()V", line = 216)
    public class44() {
    }

    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 218)
