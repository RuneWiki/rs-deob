...
public class class44 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)[Lwba;", line = 3)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(III)I", line = 14)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wba", name = "toString", descriptor = "()Ljava/lang/String;", line = 54)
    public final String toString() {
        field360++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IIZLjava/lang/String;)I", line = 66)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(IILvp;)V", line = 168)
