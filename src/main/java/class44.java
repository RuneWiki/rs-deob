...
public class class44 extends class474 implements class103 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILc;Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lvs;II)V", line = 72)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lvs;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIZ)Lt;", line = 105)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII)V", line = 109)
    public final void method419(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!da", name = "c", descriptor = "()[Lfs;", line = 121)
    public final class390[] method427() {
        return this.field526;
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "()Z", line = 129)
    public final boolean method432() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lt;IIIZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "()V", line = 143)
    public final void method439() {
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "()[Lew;", line = 147)
    public final class342[] method441() {
        return this.field525;
    }

    @OriginalMember(owner = "client!da", name = "finalize", descriptor = "()V", line = 152)
    protected final void finalize() {
        class132.method921(this, false);
    }

    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lqa;Lna;Lmb;IIII)V", line = 158)
