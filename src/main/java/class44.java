...
public abstract class class44 extends class184 {
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IZI)Lbi;", line = 18)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(IIIZZ)V", line = 216)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!be", name = "g", descriptor = "(I)V", line = 189)
