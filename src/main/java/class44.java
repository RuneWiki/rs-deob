...
public class class44 extends class327 implements class225 {
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lfc;Lnea;II[FII)V")
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lfc;II[III)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IZLnea;I[BIIII)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ZLtd;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lfc;Lnea;Ldr;II)V")
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lfc;Lnea;II[BII)V")
