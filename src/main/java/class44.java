...
public class class44 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lbg;)V", line = 12)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(Lbg;)V", line = 39)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 56)
    public class44() {
        this.field514[0] = 0;
