...
public class class44 extends class601 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 14)
    public class44() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BLee;)Lgl;", line = 24)
    ...
    @OriginalMember(owner = "client!gs", name = "e", descriptor = "(I)V", line = 61)
