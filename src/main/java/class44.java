...
public class class44 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BI)Ljn;", line = 119)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lkr;ILok;Lok;)V", line = 166)
