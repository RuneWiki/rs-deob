...
public class class44 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BLja;)V", line = 28)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ldp;I)V", line = 232)
