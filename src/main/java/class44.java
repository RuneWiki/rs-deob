...
public class class44 extends class343 {
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(Lh;IIIIZ)V", line = 2)
    public final void method299(class452 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Llo;IIII[[I[[II)V", line = 6)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(III)V", line = 59)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIIIIII[[ZLb;[I[I)V", line = 67)
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field637[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field1644; ++var23) {
                            ...
                            } else if (var21.field1646 != null && var21.field1646[var23] != -1) {
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(Lh;IIIIZ)Z", line = 196)
    public final boolean method302(class452 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIIIIII[[Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lh;IIIIZ)V", line = 216)
    public final void method304(class452 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIZLb;[I[I[I)V", line = 220)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(II)V", line = 865)
    ...
    @OriginalMember(owner = "client!qn", name = "d", descriptor = "(II)I", line = 883)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "()V", line = 914)
    public final void method308() {
        this.field650 = null;
        this.field647 = null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILh;)Lh;", line = 922)
    public final class452 method309(int arg0, int arg1, class452 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 925)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1154)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(III[[ZZ)V", line = 1648)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(IIIIIII[[ZLb;[I[I)V", line = 1665)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(II)I", line = 1796)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IILb;[I[I[I)V", line = 1816)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lki;[I)V", line = 2169)
    public final void method316(class480 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)Z", line = 2173)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)I", line = 2188)
