...
public class class44 extends class398 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(II)Lfa;")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILnd;)V")
