...
public class class44 extends class61 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(CIIIZLde;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lmm;Lci;[Ljf;Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(CIIIZ)V", line = 256)
