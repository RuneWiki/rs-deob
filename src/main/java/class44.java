...
public class class44 implements Runnable {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZLjava/lang/String;)Lol;", line = 5)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(B)V", line = 73)
    public static void method227(byte arg0) {
        field428 = null;
        int var1 = -82 / ((12 - arg0) / 41);
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lgga;B)V", line = 83)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "()V", line = 99)
    public class44() {
        this.field426.setDaemon(true);
        this.field426.start();
    }

    @OriginalMember(owner = "client!rh", name = "run", descriptor = "()V", line = 111)
