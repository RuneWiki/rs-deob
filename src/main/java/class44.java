...
public class class44 extends class85 {
    ...
    @OriginalMember(owner = "client!ec", name = "Q", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ec", name = "T", descriptor = "Llf;")
    public static class109 field912 = field914;

    @OriginalMember(owner = "client!ec", name = "R", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ec", name = "W", descriptor = "Llf;")
    private static class109 field915 = class35.method275("button near the top of that page)3", 2);

    @OriginalMember(owner = "client!ec", name = "db", descriptor = "Llf;")
    public static class109 field922 = null;

    @OriginalMember(owner = "client!ec", name = "gb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lqe;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BILja;)V")
