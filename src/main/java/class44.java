...
public class class44 extends class305 {
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(ILhb;)V", line = 5)
    public class44(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)I", line = 34)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Lhb;)V", line = 45)
    public class44(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(II)I", line = 48)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(B)V", line = 77)
