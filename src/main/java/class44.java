...
@OriginalClass("client!MWRUKLPF")
public class class44 {

    @OriginalMember(owner = "client!MWRUKLPF", name = "a", descriptor = "I")
    private int field1286 = 654;

    @OriginalMember(owner = "client!MWRUKLPF", name = "h", descriptor = "Z")
    public boolean field1293 = false;

    @OriginalMember(owner = "client!MWRUKLPF", name = "i", descriptor = "I")
    public int field1294 = -1;

    @OriginalMember(owner = "client!MWRUKLPF", name = "b", descriptor = "I")
    public static int field1287;

    @OriginalMember(owner = "client!MWRUKLPF", name = "e", descriptor = "I")
    public int field1290;

    @OriginalMember(owner = "client!MWRUKLPF", name = "f", descriptor = "I")
    public int field1291;

    @OriginalMember(owner = "client!MWRUKLPF", name = "g", descriptor = "I")
    public int field1292;

    @OriginalMember(owner = "client!MWRUKLPF", name = "j", descriptor = "I")
    public int field1295;

    @OriginalMember(owner = "client!MWRUKLPF", name = "d", descriptor = "Ljava/lang/String;")
    public String field1289;

    @OriginalMember(owner = "client!MWRUKLPF", name = "c", descriptor = "[LMWRUKLPF;")
    public static class44[] field1288;

    @OriginalMember(owner = "client!MWRUKLPF", name = "a", descriptor = "(LDYBMLHQM;Z)V")
    ...
    @OriginalMember(owner = "client!MWRUKLPF", name = "a", descriptor = "(IILINLHDAGO;)V")
