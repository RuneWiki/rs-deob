...
public class class44 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLdd;Lnv;)V", line = 10)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ldd;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)Ldd;", line = 62)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILnv;)V", line = 84)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "()V", line = 254)
    public class44() {
        this.field690.field1936 = this.field690;
        this.field690.field1934 = this.field690;
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLdd;)V", line = 125)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)Z", line = 143)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)Ldd;", line = 160)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)Ldd;", line = 185)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(Z)Ldd;", line = 215)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(I)I", line = 236)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(I)Ldd;", line = 263)
