...
public class class44 extends class256 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dl", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 26)
    public final synchronized void focusLost(FocusEvent arg0) {
        field653++;
        this.method306('\u0000', -1, 18031, 0);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(CIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!dl", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 60)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!dl", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 132)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field641++;
        this.method308(arg0, (byte) 69, 1);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;BI)V", line = 141)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 191)
    ...
    @OriginalMember(owner = "client!dl", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 217)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method308(arg0, (byte) 69, 0);
        field640++;
    }

    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(B)Ldb;", line = 226)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZB)V", line = 265)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(B)V", line = 304)
    ...
    @OriginalMember(owner = "client!dl", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 332)
    public final void focusGained(FocusEvent arg0) {
        field651++;
    }

    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 345)
