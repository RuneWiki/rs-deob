...
public class class44 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILjava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BLjava/awt/Canvas;)Lnca;", line = 40)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(I)V", line = 81)
