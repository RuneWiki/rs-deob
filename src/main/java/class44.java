...
public class class44 extends class651 {
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "()I", line = 13)
    public final int method310() {
        return this.field645 - (this.field644.available() >> (class360.field4662 ? 2 : 1));
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 24)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "()V", line = 93)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 118)
