...
public class class44 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILr;ZI)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BILr;I)V")
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lgca;Lkb;)V")
