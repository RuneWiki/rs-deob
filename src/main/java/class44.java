...
public class class44 extends class117 implements class351 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IILqa;B)Z")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZIILqa;)Llp;")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lqa;Lkn;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(ILqa;)Lnf;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZIILer;Lqa;IB)V")
