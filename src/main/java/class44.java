...
public class class44 extends class60 implements class116 {
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(IIILva;)V")
    public class44(int arg0, int arg1, int arg2, class60 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field552 = arg3;
    }

    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(ILoj;)Lmg;")
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILoj;II)Z")
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIZLa;IBLoj;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILoj;B)Lqh;")
