...
@OriginalClass("client!SMQPXRFY")
public class class44 extends class62 implements Runnable {

    @OriginalMember(owner = "client!SMQPXRFY", name = "b", descriptor = "Z")
    private boolean field1326 = false;

    @OriginalMember(owner = "client!SMQPXRFY", name = "e", descriptor = "[B")
    private byte[] field1329 = new byte[500];

    @OriginalMember(owner = "client!SMQPXRFY", name = "o", descriptor = "Z")
    private boolean field1339 = false;

    @OriginalMember(owner = "client!SMQPXRFY", name = "r", descriptor = "LYSGENUJE;")
    private class66 field1342 = new class66(-41036);

    @OriginalMember(owner = "client!SMQPXRFY", name = "s", descriptor = "LYSGENUJE;")
    private class66 field1343 = new class66(-41036);

    @OriginalMember(owner = "client!SMQPXRFY", name = "w", descriptor = "Ljava/lang/String;")
    public String field1347 = "";

    @OriginalMember(owner = "client!SMQPXRFY", name = "y", descriptor = "LYSGENUJE;")
    private class66 field1349 = new class66(-41036);

    @OriginalMember(owner = "client!SMQPXRFY", name = "z", descriptor = "Z")
    private boolean field1350 = true;

    @OriginalMember(owner = "client!SMQPXRFY", name = "B", descriptor = "[[B")
    private byte[][] field1352 = new byte[4][];

    @OriginalMember(owner = "client!SMQPXRFY", name = "C", descriptor = "LYSGENUJE;")
    private class66 field1353 = new class66(-41036);

    @OriginalMember(owner = "client!SMQPXRFY", name = "E", descriptor = "B")
    private byte field1355 = -44;

    @OriginalMember(owner = "client!SMQPXRFY", name = "G", descriptor = "I")
    private int field1357 = 986;

    @OriginalMember(owner = "client!SMQPXRFY", name = "I", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1359 = new CRC32();

    @OriginalMember(owner = "client!SMQPXRFY", name = "J", descriptor = "[[I")
    private int[][] field1360 = new int[4][];

    @OriginalMember(owner = "client!SMQPXRFY", name = "K", descriptor = "I")
    private int field1361 = 5;

    @OriginalMember(owner = "client!SMQPXRFY", name = "L", descriptor = "LYSGENUJE;")
    private class66 field1362 = new class66(-41036);

    @OriginalMember(owner = "client!SMQPXRFY", name = "Q", descriptor = "LLOPREVUC;")
    private class28 field1367 = new class28(719);

    @OriginalMember(owner = "client!SMQPXRFY", name = "R", descriptor = "[B")
    private byte[] field1368 = new byte[65000];

    @OriginalMember(owner = "client!SMQPXRFY", name = "S", descriptor = "[[I")
    private int[][] field1369 = new int[4][];

    @OriginalMember(owner = "client!SMQPXRFY", name = "x", descriptor = "I")
    private static int field1348 = -302;

    @OriginalMember(owner = "client!SMQPXRFY", name = "g", descriptor = "I")
    private int field1331;

    @OriginalMember(owner = "client!SMQPXRFY", name = "i", descriptor = "I")
    private int field1333;

    @OriginalMember(owner = "client!SMQPXRFY", name = "j", descriptor = "I")
    private int field1334;

    @OriginalMember(owner = "client!SMQPXRFY", name = "m", descriptor = "I")
    private int field1337;

    @OriginalMember(owner = "client!SMQPXRFY", name = "n", descriptor = "I")
    private int field1338;

    @OriginalMember(owner = "client!SMQPXRFY", name = "t", descriptor = "I")
    private int field1344;

    @OriginalMember(owner = "client!SMQPXRFY", name = "A", descriptor = "I")
    private int field1351;

    @OriginalMember(owner = "client!SMQPXRFY", name = "D", descriptor = "I")
    private int field1354;

    @OriginalMember(owner = "client!SMQPXRFY", name = "F", descriptor = "I")
    public int field1356;

    @OriginalMember(owner = "client!SMQPXRFY", name = "N", descriptor = "I")
    public int field1364;

    @OriginalMember(owner = "client!SMQPXRFY", name = "O", descriptor = "I")
    private int field1365;

    @OriginalMember(owner = "client!SMQPXRFY", name = "u", descriptor = "J")
    private long field1345;

    @OriginalMember(owner = "client!SMQPXRFY", name = "c", descriptor = "LSMSHJBOZ;")
    private class45 field1327;

    @OriginalMember(owner = "client!SMQPXRFY", name = "d", descriptor = "Lclient;")
    private client field1328;

    @OriginalMember(owner = "client!SMQPXRFY", name = "H", descriptor = "Ljava/io/InputStream;")
    private InputStream field1358;

    @OriginalMember(owner = "client!SMQPXRFY", name = "p", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1340;

    @OriginalMember(owner = "client!SMQPXRFY", name = "v", descriptor = "Ljava/net/Socket;")
    private Socket field1346;

    @OriginalMember(owner = "client!SMQPXRFY", name = "q", descriptor = "[B")
    private byte[] field1341;

    @OriginalMember(owner = "client!SMQPXRFY", name = "f", descriptor = "[I")
    private int[] field1330;

    @OriginalMember(owner = "client!SMQPXRFY", name = "h", descriptor = "[I")
    private int[] field1332;

    @OriginalMember(owner = "client!SMQPXRFY", name = "k", descriptor = "[I")
    private int[] field1335;

    @OriginalMember(owner = "client!SMQPXRFY", name = "l", descriptor = "[I")
    private int[] field1336;

    @OriginalMember(owner = "client!SMQPXRFY", name = "M", descriptor = "[I")
    private int[] field1363;

    @OriginalMember(owner = "client!SMQPXRFY", name = "P", descriptor = "[I")
    private int[] field1366;

    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(ZIIB)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "()LSMSHJBOZ;")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(ZI)I")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "b", descriptor = "(ZI)Z")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "b", descriptor = "()V")
    public final void method398() {
        this.field1350 = false;
    }

    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(LLYZBHNJP;Lclient;)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(Z[BII)Z")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(II)I")
    public final int method402(int arg0, int arg1) {
        int var3 = 31 / arg0;
        return this.field1360[arg1].length;
    }

    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(ZB)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(ILSMSHJBOZ;)V")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "c", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(I)V")
    public final void method406(int arg0) {
        this.method409(0, arg0);
    }

    @OriginalMember(owner = "client!SMQPXRFY", name = "d", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "a", descriptor = "(IZ)Z")
    ...
    @OriginalMember(owner = "client!SMQPXRFY", name = "b", descriptor = "(II)V")
