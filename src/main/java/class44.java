...
public class class44 {
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "()Lok;")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lil;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lqj;II)Lbe;")
