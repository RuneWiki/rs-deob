...
public class class44 extends class100 implements class218 {
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BLtq;)V", line = 21)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ltq;III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)I", line = 72)
    public final int method244(byte arg0) {
        ++field620;
        return arg0 >= -8 ? 121 : this.field621;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(II)V", line = 102)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Ltq;Lvc;IIIIZIIZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(II)Lso;", line = 157)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(I)Z", line = 173)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILtq;)V", line = 184)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Ltq;I)Lcj;", line = 196)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(B)V", line = 224)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BILtq;)Lns;", line = 239)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ltq;I)V", line = 250)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)Z", line = 278)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BZLtq;Lhm;III)V", line = 289)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)I", line = 319)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILtq;I)Lns;", line = 333)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)V", line = 362)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ltq;ZII)Lri;", line = 383)
