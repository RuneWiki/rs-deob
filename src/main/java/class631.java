...
public class class631 extends class363 implements class231 {
    ...
    @OriginalMember(owner = "client!mv", name = "d", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z)Z", line = 15)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BLqa;II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(I)V", line = 59)
    public final void method270(int arg0) {
        int var2 = 103 / ((arg0 - -1) / 47);
        ++field8871;
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILqa;)V", line = 69)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)I", line = 84)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZLqa;)V", line = 96)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BZILqa;IILcea;)V", line = 108)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lqa;I)Lbi;", line = 119)
    ...
    @OriginalMember(owner = "client!mv", name = "g", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(ILqa;)Lkm;", line = 183)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lqa;B)V", line = 195)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)I", line = 217)
    public final int method264(int arg0) {
        ++field8858;
        return arg0 != -25792 ? 122 : this.field8855.field4455;
    }

    @OriginalMember(owner = "client!mv", name = "e", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILqa;Z)Lr;", line = 246)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lqa;Ltk;IIIIIZIII)V", line = 262)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)I", line = 271)
