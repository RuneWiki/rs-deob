...
public class class631 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lac;I)Lpp;", line = 10)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILnn;IIIIIIII)Z", line = 25)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(CZ)B", line = 273)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZI)Z", line = 399)
