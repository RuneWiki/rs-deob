...
public abstract class class631 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Leea;)V", line = 85)
