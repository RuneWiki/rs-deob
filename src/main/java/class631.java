...
public abstract class class631 {
    ...
    @OriginalMember(owner = "client!pda", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ZB)Z", line = 40)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIII)I", line = 80)
