...
public class class631 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)Lgh;", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Llaa;I)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ljk;ILae;)V", line = 87)
