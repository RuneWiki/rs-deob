...
public class class631 extends class663 implements class615 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ltd;B)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Llf;I[BI)V", line = 42)
    public class631(class250 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field8532 = arg1;
    }

    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)J", line = 51)
    public final long method3416(boolean arg0) {
        ++field8534;
        return arg0 ? -15L : super.field8911.getAddress();
    }

    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Llf;ILjaclib/memory/Buffer;)V", line = 63)
    public class631(class250 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field8532 = arg1;
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)V", line = 73)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)I", line = 134)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "([BIZI)V", line = 145)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IB)V", line = 158)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(IB)V", line = 191)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(I)V", line = 205)
