...
public class class631 extends class72 {
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(II)I", line = 4)
    public final int method58(int arg0, int arg1) {
        ++field9047;
        return arg1 != 11260 ? 86 : 1;
    }

    @OriginalMember(owner = "client!jk", name = "d", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(ILcq;)V", line = 34)
    public class631(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lcq;)V", line = 48)
    public class631(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(FIBFF)F", line = 91)
