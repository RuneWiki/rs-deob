...
public class class631 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Z)I", line = 24)
    ...
    @OriginalMember(owner = "client!cb", name = "toString", descriptor = "()Ljava/lang/String;", line = 36)
    public final String toString() {
        field8870++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(II)V", line = 80)
