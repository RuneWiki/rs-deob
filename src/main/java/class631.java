...
public class class631 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Ldaa;ILdaa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "()V", line = 24)
    public class631() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Ljava/lang/String;IB)I", line = 44)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lol;I[B)V", line = 61)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(B[B)[B", line = 85)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(III)Z", line = 104)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(III)V", line = 118)
