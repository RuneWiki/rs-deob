...
public class class631 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lkp;III)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)Lno;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILpk;)Z")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lr;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILr;IBIILfa;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lrf;ILpl;)V")
