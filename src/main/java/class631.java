...
public class class631 extends class43 implements class691 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lr;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IILr;)Lda;", line = 14)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Lr;Lfga;IIIIIZIIIIIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLr;)V", line = 81)
    ...
    @OriginalMember(owner = "client!ufa", name = "l", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ufa", name = "f", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)I", line = 133)
    ...
    @OriginalMember(owner = "client!ufa", name = "h", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lr;III)Z", line = 159)
    ...
    @OriginalMember(owner = "client!ufa", name = "d", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIZLr;ILub;I)V", line = 195)
    ...
    @OriginalMember(owner = "client!ufa", name = "g", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ufa", name = "e", descriptor = "(B)I", line = 245)
    ...
    @OriginalMember(owner = "client!ufa", name = "g", descriptor = "(B)I", line = 256)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ZILr;B)Lfe;", line = 270)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lr;B)Llt;", line = 303)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)Z", line = 333)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)I", line = 344)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILr;)V", line = 355)
    ...
    @OriginalMember(owner = "client!ufa", name = "f", descriptor = "(B)Z", line = 388)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(BLr;)Lsr;", line = 405)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(B)Z", line = 423)
