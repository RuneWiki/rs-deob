...
public class class631 extends class518 {
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "()V", line = 4)
    public class631() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bfa", name = "f", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(IIB)I", line = 20)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(II)[I", line = 33)
