...
public class class631 extends class12 implements class721 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IBLha;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!tq", name = "i", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lha;B)V", line = 60)
    ...
    @OriginalMember(owner = "client!tq", name = "h", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIIZ)V", line = 100)
    ...
    @OriginalMember(owner = "client!tq", name = "k", descriptor = "(B)Z", line = 135)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)I", line = 150)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZILha;)Lka;", line = 161)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Lha;B)Lc;", line = 186)
    ...
    @OriginalMember(owner = "client!tq", name = "j", descriptor = "(B)I", line = 213)
    ...
    @OriginalMember(owner = "client!tq", name = "e", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lha;Z)V", line = 240)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)Z", line = 250)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILha;)V", line = 263)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lha;IZI)Lqw;", line = 292)
    ...
    @OriginalMember(owner = "client!tq", name = "e", descriptor = "(B)Z", line = 326)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)I", line = 343)
    public final int method327(int arg0) {
        ++field8833;
        return arg0 > -116 ? -3 : this.field8805;
    }

    @OriginalMember(owner = "client!tq", name = "g", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILvs;ZILha;II)V", line = 365)
    ...
    @OriginalMember(owner = "client!tq", name = "h", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lha;I)Lria;", line = 408)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(CB)B", line = 423)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)V", line = 549)
