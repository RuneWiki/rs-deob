...
public class class631 extends class161 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILufa;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIIIILmf;Lvn;IIIIB)V", line = 73)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IZLr;)V", line = 99)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(JJ)J", line = 206)
