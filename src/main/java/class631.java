...
public class class631 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lmc;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lmc;I)V", line = 77)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)V", line = 102)
