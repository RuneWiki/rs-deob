...
public class class631 extends class45 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lwu;Lwu;Leja;)V", line = 77)
    public class631(class376 arg0, class376 arg1, class735 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIZI)V", line = 96)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 148)
