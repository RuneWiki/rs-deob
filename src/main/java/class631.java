...
public class class631 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lufa;Lpe;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)Lfs;", line = 59)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ZLfd;)V", line = 89)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILjava/lang/String;Lfd;)I", line = 114)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Z)V", line = 140)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lfd;II)V", line = 153)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Loa;BZI)Lxa;", line = 205)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)Z", line = 251)
