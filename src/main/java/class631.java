...
public class class631 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;)V", line = 22)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)V", line = 38)
