...
public class class631 extends class288 {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!qc", name = "e", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IB)I", line = 70)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II)V", line = 87)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!qc", name = "f", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)Lwh;", line = 195)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 292)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(ILes;Les;Lgq;Lbj;I[BIZ)V", line = 842)
    ...
    @OriginalMember(owner = "client!qc", name = "g", descriptor = "(I)I", line = 306)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIZ)I", line = 328)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IBI)Lrda;", line = 347)
    ...
    @OriginalMember(owner = "client!qc", name = "h", descriptor = "(I)V", line = 620)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BI)[B", line = 802)
