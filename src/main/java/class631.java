...
public class class631 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 3)
    ...
    @OriginalMember(owner = "client!iq", name = "toString", descriptor = "()Ljava/lang/String;", line = 14)
    public final String toString() {
        field8866++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BI)Liq;", line = 94)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(IILbja;)V", line = 190)
