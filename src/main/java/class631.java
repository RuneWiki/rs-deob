...
public class class631 extends class176 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Let;Z)Z")
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Ldba;Lpa;IIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)Lib;")
