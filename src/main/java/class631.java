...
public class class631 {
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IB)V", line = 61)
    ...
    @OriginalMember(owner = "client!cv", name = "e", descriptor = "(I)V", line = 74)
