...
public class class131 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Z)Lwt;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IILie;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lie;I)Lcb;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lie;B)V")
