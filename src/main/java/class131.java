...
public abstract class class131 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIII)I", line = 44)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)V", line = 62)
    public static void method982(byte arg0) {
        field1966 = null;
        int var1 = 110 % ((11 - arg0) / 36);
    }

    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)Z", line = 100)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)Z", line = 111)
