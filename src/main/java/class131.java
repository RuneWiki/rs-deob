...
public abstract class class131 extends class35 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIZZB)V", line = 9)
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IZIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!fl", name = "h", descriptor = "(I)V", line = 242)
