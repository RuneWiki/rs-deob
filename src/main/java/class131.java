...
public class class131 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "([BI[BII)V")
    public static final void method964(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    public static final void method965(int[] arg0, int arg1, int arg2) {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "([II[III)V")
