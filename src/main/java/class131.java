...
public class class131 extends class96 {
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IILbt;)V", line = 54)
    ...
    @OriginalMember(owner = "client!rt", name = "e", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "()V", line = 106)
    public class131() {
        super(3, false);
    }

    @OriginalMember(owner = "client!rt", name = "g", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)[[I", line = 129)
