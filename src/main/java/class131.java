...
public class class131 extends class512 implements class194 {
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III[I)V", line = 14)
    public final void method946(int arg0, int arg1, int arg2, int[] arg3) {
        this.method951(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()Lc;", line = 19)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 33)
    public class131() {
        this.method952();
    }
