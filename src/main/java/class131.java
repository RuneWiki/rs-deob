...
public class class131 extends class30 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "()V", line = 128)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "()V", line = 1163)
    public class131() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljg;II)V", line = 145)
    ...
    @OriginalMember(owner = "client!ig", name = "g", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IB)[I", line = 1168)
