...
public class class131 extends class40 {
    ...
    @OriginalMember(owner = "client!bj", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BIIIILqr;IIIII)Z")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BLlf;)Lgp;")
