...
public class class131 extends class210 implements class113 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIILbp;IZLeq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hi", name = "i", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Z)Z", line = 269)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILeq;BI)Z", line = 291)
    ...
    @OriginalMember(owner = "client!hi", name = "c", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(B)I", line = 320)
    public final int method362(byte arg0) {
        ++field1664;
        return arg0 != -72 ? -31 : this.field1660.field9;
    }

    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)I", line = 337)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Leq;Lhn;IIIIIZIIIIIII)V", line = 348)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Leq;I)V", line = 364)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)I", line = 379)
    ...
    @OriginalMember(owner = "client!hi", name = "d", descriptor = "(I)Z", line = 393)
    ...
    @OriginalMember(owner = "client!hi", name = "c", descriptor = "(B)I", line = 404)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(Leq;Z)Lgl;", line = 416)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Ldd;FIIFIFIIII[BFF)V", line = 449)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(III)I", line = 501)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ILeq;Z)Lva;", line = 520)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Leq;Z)V", line = 532)
    ...
    @OriginalMember(owner = "client!hi", name = "j", descriptor = "(I)V", line = 549)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BLeq;)V", line = 569)
