...
public class class131 extends class399 {
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "()Z", line = 3)
    public final boolean method375() {
        return true;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfl;)V", line = 6)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "()V", line = 62)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 68)
    public final void method378(boolean arg0) {
    }

    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lpo;Lde;)V", line = 85)
