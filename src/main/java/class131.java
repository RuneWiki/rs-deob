...
public class class131 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IB)I", line = 9)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I[Lvfa;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(J[I[S[S)V", line = 137)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "()V", line = 147)
    protected class131() {
    }
}
