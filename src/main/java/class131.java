...
public class class131 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IB)V", line = 21)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "()V", line = 54)
    public static final void method827() {
        class350.field4641 = class350.field4643;
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 125)
    public class131(class242 arg0, int arg1, class522 arg2) {
        this.field1690 = arg2;
        this.field1690.method2901(0, 30);
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(IB)Lql;", line = 82)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 113)
