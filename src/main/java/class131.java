...
public class class131 extends class221 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IFZILsa;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILdg;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLdg;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(ZI)Ldj;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Ldg;I)V")
