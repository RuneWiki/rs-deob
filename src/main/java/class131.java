...
public class class131 extends class426 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(JLr;I)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IJZLr;B)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lr;Lnba;Lau;J)V")
