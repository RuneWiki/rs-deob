...
public class class131 extends class267 implements class112 {
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Ltm;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BILvi;Lav;Lcn;III)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BIIILg;III[B)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lk;III[Z)V")
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Ltm;Lg;Lvp;II)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III[FIIILg;I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Ltm;Lg;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Ltm;Lg;IIZ[FII)V")
