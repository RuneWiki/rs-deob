...
public class class131 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IILba;III)Lba;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILjr;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIIIBILba;I)Lba;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Ljr;II)V")
