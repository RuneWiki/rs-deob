...
public class class131 extends class261 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lci;)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lci;I)V")
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "()Lbj;")
