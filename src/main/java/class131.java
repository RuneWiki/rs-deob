...
public class class131 extends class467 implements class278 {
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!bi", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILkm;IZILkj;B)V")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lkm;Lcj;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lcs;I)V")
