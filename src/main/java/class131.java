...
public class class131 extends class105 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lha;JI)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ZIBJLha;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lha;Lgi;Lf;J)V")
