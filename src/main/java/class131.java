...
public class class131 extends class171 implements class332 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)I", line = 4)
    public final int method878(byte arg0) {
        ++field2025;
        return arg0 != 24 ? 83 : 0;
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)J", line = 17)
    public final long method879(int arg0) {
        ++field2027;
        return arg0 < 124 ? -83L : super.field2533.method2633();
    }

    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lod;I[BI)V", line = 61)
    public class131(class349 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field2028 = arg1;
    }

    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BI[BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(IIIII)V", line = 98)
