...
public class class131 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILat;BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lat;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lfba;Z)Z", line = 151)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIII)Z", line = 189)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)Z", line = 235)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lqo;)V", line = 576)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 364)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(Lfba;Z)V", line = 374)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(B)V", line = 391)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)Z", line = 425)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(B)V", line = 445)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILha;IBIIII)V", line = 516)
