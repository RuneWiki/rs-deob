...
public class class131 extends class85 {
    ...
    @OriginalMember(owner = "client!oa", name = "bb", descriptor = "Llf;")
    public static class109 field2534 = class35.method275("Lade Konfiguration )2 ", 2);

    @OriginalMember(owner = "client!oa", name = "db", descriptor = "Llf;")
    private static class109 field2536 = class35.method275("Loaded update list", 2);

    @OriginalMember(owner = "client!oa", name = "X", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IILlf;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BILja;)V")
