...
public class class131 {
    ...
    @OriginalMember(owner = "client!iea", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(JB)V", line = 13)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lnp;B)Lwm;", line = 75)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lmr;II)V", line = 156)
