...
public class class131 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IILha;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)Z", line = 32)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIII)V", line = 341)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "()V", line = 363)
    protected class131() {
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lha;Ldc;I)V", line = 377)
