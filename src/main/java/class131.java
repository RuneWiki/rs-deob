...
public class class131 extends class172 {
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BLhia;)V", line = 16)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILgga;)V", line = 37)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 52)
