...
public class class131 extends class24 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjp;)V")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lke;I)V")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(JLha;B)V")
