...
public class class131 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IB)Lhq;", line = 142)
