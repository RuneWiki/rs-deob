...
public class class131 extends class11 implements class240 {
    ...
    @OriginalMember(owner = "client!qa", name = "x", descriptor = "()Z", line = 3)
    public final boolean method138() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)V", line = 7)
    public final void method96(int arg0) {
        this.field1954[arg0].method2345();
    }

    @OriginalMember(owner = "client!qa", name = "s", descriptor = "()Z", line = 14)
    public final boolean method118() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ldu;[Lul;Z)Lla;", line = 18)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lu;)V", line = 26)
    public final void method137(class346 arg0) {
        this.field1935 = (class253) arg0;
        this.method956(arg0);
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(IIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lio;IIII)Lt;", line = 34)
    ...
    @OriginalMember(owner = "client!qa", name = "o", descriptor = "()Z", line = 40)
    public final boolean method95() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "u", descriptor = "()Z", line = 45)
    public final boolean method125() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIZ)Ll;", line = 48)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 60)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Z)V", line = 87)
    public final void method130(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "h", descriptor = "()V", line = 90)
    public final void method74() {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[I[I)Lma;", line = 93)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpv;)V", line = 98)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(FFF)V", line = 103)
    public final void method63(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!qa", name = "n", descriptor = "()V", line = 106)
    public final void method88() {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(II)I", line = 120)
    public final int method120(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 124)
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 146)
    protected final void finalize() {
        this.method471();
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 151)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lt;Lpv;Lc;Lqb;I)V", line = 167)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIF)Lwr;", line = 188)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpv;Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(IIIIII)Lqs;", line = 222)
    public final class50 method158(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "z", descriptor = "()Z", line = 225)
    public final boolean method146() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(II)I", line = 229)
    ...
    @OriginalMember(owner = "client!qa", name = "R", descriptor = "(S)Z", line = 236)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "()V", line = 248)
    public final void method64() {
    }

    @OriginalMember(owner = "client!qa", name = "p", descriptor = "()Z", line = 254)
    public final boolean method97() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "k", descriptor = "()V", line = 256)
    public final void method86() {
    }

    @OriginalMember(owner = "client!qa", name = "h", descriptor = "(I)Lu;", line = 262)
    ...
    @OriginalMember(owner = "client!qa", name = "f", descriptor = "()Lc;", line = 268)
    public final class511 method66() {
        return this.field1952;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([IIIII)Ll;", line = 273)
    ...
    @OriginalMember(owner = "client!qa", name = "g", descriptor = "()I", line = 313)
    public final int method72() {
        return 4;
    }

    @OriginalMember(owner = "client!qa", name = "m", descriptor = "()Z", line = 316)
    public final boolean method87() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()V", line = 319)
    public final void method56() {
    }

    @OriginalMember(owner = "client!qa", name = "D", descriptor = "()Ln;", line = 324)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIIII)V", line = 344)
    ...
    @OriginalMember(owner = "client!qa", name = "f", descriptor = "(I)V", line = 350)
    public final void method145(int arg0) {
        this.field1954[arg0].method2358();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!qa", name = "sa", descriptor = "(S)Z", line = 367)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lul;Z)Ll;", line = 393)
    ...
    @OriginalMember(owner = "client!qa", name = "v", descriptor = "()Z", line = 470)
    public final boolean method126() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "q", descriptor = "()Z", line = 473)
    public final boolean method112() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "r", descriptor = "()Z", line = 479)
    public final boolean method113() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIII)V", line = 484)
    public final void method116(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I[Lwr;)V", line = 491)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIILma;II)V", line = 511)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Z)V", line = 513)
    public final void method57(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "d", descriptor = "()Z", line = 519)
    public final boolean method65() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "ha", descriptor = "()V", line = 522)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;Lec;)V", line = 609)
    ...
    @OriginalMember(owner = "client!qa", name = "B", descriptor = "()Z", line = 535)
    public final boolean method156() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "i", descriptor = "()Lc;", line = 538)
    public final class511 method75() {
        return new class198();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lpv;Lc;[Lqb;I)V", line = 542)
    ...
    @OriginalMember(owner = "client!qa", name = "C", descriptor = "()V", line = 589)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIIIIII)V", line = 601)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lqs;)V", line = 649)
    public final void method148(class50 arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIII)V", line = 652)
    ...
    @OriginalMember(owner = "client!qa", name = "t", descriptor = "()Z", line = 656)
    public final boolean method124() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "j", descriptor = "()Z", line = 661)
    public final boolean method77() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "A", descriptor = "()Z", line = 664)
    public final boolean method152() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "y", descriptor = "()V", line = 667)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 693)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Z)V", line = 723)
    public final void method134(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "SA", descriptor = "()Ljava/lang/Object;", line = 730)
    private final Object method971() {
        return new class186();
    }

    @OriginalMember(owner = "client!qa", name = "g", descriptor = "(I)V", line = 733)
    public final void method149(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lqs;Lqs;FLqs;)Lqs;", line = 739)
    public final class50 method117(class50 arg0, class50 arg1, float arg2, class50 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lc;[Lqb;I)V", line = 742)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[[I[[IIII)Lta;", line = 767)
