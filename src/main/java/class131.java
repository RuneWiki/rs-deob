...
public class class131 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BI)Ljj;", line = 6)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I[BIILjava/lang/String;I)I", line = 26)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILwa;Ljava/lang/Object;)V", line = 187)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILwa;)Ljava/lang/Object;", line = 218)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)V", line = 298)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(ILwa;)V", line = 312)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(II)V", line = 386)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(I)I", line = 434)
