...
public class class131 extends class607 {
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lgf;Lkea;)V", line = 32)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BIIIIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!ho", name = "e", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IBLiu;)V", line = 237)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ZB)V", line = 248)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ILd;)V", line = 261)
    public static final void method812(int arg0, class132 arg1) {
        class435.field6449[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(B)Z", line = 284)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(III)V", line = 297)
