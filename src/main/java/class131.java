...
public class class131 implements class105 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)Lwh;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BZIII)Lnc;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Loi;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Ljk;Ltda;IIIIIII)V")
