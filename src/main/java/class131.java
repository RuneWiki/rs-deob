...
public class class131 extends class331 {
    ...
    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IFIZIIII)[I", line = 18)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "([B)V", line = 77)
    public class131(byte[] arg0) {
        this.field1590 = arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ltq;Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IB)V", line = 97)
