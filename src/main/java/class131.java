...
public class class131 extends class517 implements class28 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()Lc;", line = 4)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 23)
    public class131() {
        this.method953();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III[I)V", line = 29)
    public final void method961(int arg0, int arg1, int arg2, int[] arg3) {
        this.method956(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 35)
