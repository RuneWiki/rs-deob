...
public class class131 extends class498 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "()V", line = 23)
    public class131() {
    }

    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(J)V", line = 33)
