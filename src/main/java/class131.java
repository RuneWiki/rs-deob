...
public class class131 implements Runnable {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II[BB)V", line = 3)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!hw", name = "run", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Loda;B)Llr;", line = 129)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lda;)V", line = 157)
    public static final void method931(class61 arg0) {
        class654.field9181 = arg0;
    }

    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 221)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B[Ljava/lang/String;)[Ljava/lang/String;", line = 166)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)V", line = 195)
