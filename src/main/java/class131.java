...
public class class131 extends Callback {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IZLjava/awt/Component;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fv", name = "callback", descriptor = "(IIII)I", line = 55)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(III)V", line = 98)
