...
public class class131 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILar;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)Luj;", line = 17)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIBII)V", line = 39)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III)Lhm;", line = 65)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "()V", line = 79)
    public class131() {
    }

    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lar;)V", line = 85)
    public class131(class479 arg0) {
        this.field1921 = arg0;
    }

    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)Luj;", line = 93)
