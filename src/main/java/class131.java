...
public abstract class class131 extends class439 {
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Z)I", line = 30)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!tj", name = "d", descriptor = "(I)F", line = 53)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(Z)I", line = 74)
    ...
    @OriginalMember(owner = "client!tj", name = "d", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(IIIIIF)V", line = 102)
