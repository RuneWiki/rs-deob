...
public abstract class class131 extends class116 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(FFFFFF)Z", line = 9)
    ...
    @OriginalMember(owner = "client!qaa", name = "ma", descriptor = "()I", line = 149)
    public final int method714() {
        return this.field1722 + this.field1719 + this.field1747;
    }

    @OriginalMember(owner = "client!qaa", name = "KA", descriptor = "(IIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "()I", line = 165)
    public final int method718() {
        return this.field1717;
    }

    @OriginalMember(owner = "client!qaa", name = "EA", descriptor = "()I", line = 176)
    public final int method722() {
        return this.field1726 + this.field1717 + this.field1721;
    }

    @OriginalMember(owner = "client!qaa", name = "i", descriptor = "(IIIIIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!qaa", name = "la", descriptor = "()I", line = 229)
    public final int method721() {
        return this.field1719;
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 251)
    ...
    @OriginalMember(owner = "client!qaa", name = "CA", descriptor = "(FFFFFFIII)V", line = 266)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lfg;II)V", line = 366)
