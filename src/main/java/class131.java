...
public class class131 implements class31 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljaclib/memory/Source;IBI)Z")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lgb;Z)V")
