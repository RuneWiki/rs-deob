...
public class class131 extends class337 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "()V", line = 199)
    public class131() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BILhp;)V", line = 118)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "()V", line = 195)
    public static final void method966() {
        class65.method558(1, class213.field3467);
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIZII)V", line = 202)
