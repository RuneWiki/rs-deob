...
public class class131 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(JI)V", line = 7)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ZLnq;)V", line = 28)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 45)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(JBLjava/lang/Object;)V", line = 159)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)I", line = 187)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ZJ)Ljava/lang/Object;", line = 197)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(I)I", line = 269)
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 280)
    ...
    @OriginalMember(owner = "client!bj", name = "f", descriptor = "(I)I", line = 311)
