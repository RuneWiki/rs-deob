...
public class class131 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Z)V", line = 57)
