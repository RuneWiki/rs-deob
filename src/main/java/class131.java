...
public class class131 implements class642 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 158)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILjava/awt/Component;ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I[I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(II)V", line = 181)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBI)V", line = 191)
