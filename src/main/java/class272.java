...
public class class272 extends class701 implements class199 {
    ...
    @OriginalMember(owner = "client!w", name = "xa", descriptor = "(III)V", line = 12)
    public final void method4(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IILua;II)V", line = 16)
    public final void method6(int arg0, int arg1, class616 arg2, int arg3, int arg4) {
        this.method1632(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Ll;Lm;[I[BIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(FFFFFFILua;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!w", name = "da", descriptor = "(IIIIII)V", line = 35)
