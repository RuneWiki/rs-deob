...
public class class272 {
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 48)
    ...
    @OriginalMember(owner = "client!nca", name = "listmodes", descriptor = "()[I", line = 91)
    ...
    @OriginalMember(owner = "client!nca", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!nca", name = "exit", descriptor = "()V", line = 177)
