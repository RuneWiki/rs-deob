...
public class class272 extends class17 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lwm;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "()V", line = 52)
    public class272() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IB)[[I", line = 56)
