...
public class class272 extends class649 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Llh;ZLlh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uia", name = "c", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!uia", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(Lhs;)V", line = 71)
    public class272(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(II)I", line = 75)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IB)V", line = 102)
    ...
    @OriginalMember(owner = "client!uia", name = "e", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!uia", name = "f", descriptor = "(I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(ILhs;)V", line = 170)
