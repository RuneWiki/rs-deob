...
public class class272 extends class4 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lsba;I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(ILdc;)Lcv;", line = 93)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lsba;B)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(B)V", line = 148)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 162)
