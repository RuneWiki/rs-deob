...
public class class272 implements Runnable {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLr;I)Lvn;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLsp;I)Law;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILsp;[BI)Law;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IILsp;)Law;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ZLaw;)V")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Llaa;)V")
