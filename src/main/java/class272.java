...
public class class272 extends class499 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)Leu;")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIILht;)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lja;Lmea;IIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILri;Ljava/awt/Canvas;ILfa;)Lr;")
