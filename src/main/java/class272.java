...
public class class272 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I[Lie;)I", line = 3)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)Lie;", line = 33)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)Lie;", line = 65)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(JZ)Lie;", line = 135)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(I)Lie;", line = 165)
    ...
    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "(I)Ljava/lang/String;", line = 231)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(JILie;)V", line = 262)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(I)V", line = 286)
