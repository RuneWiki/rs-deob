...
public class class272 extends class354 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lpga;IIIIIIIIIIIZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lha;J)V", line = 39)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(JI)V", line = 215)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "()V", line = 609)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lpga;IIIIIIIIIIIZZ)V", line = 616)
