...
public class class272 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILwca;)Lwca;", line = 29)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIZI)V", line = 71)
