...
public class class272 implements class444 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)Lhl;", line = 5)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLha;)V", line = 18)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(ILmp;Lfe;II)V", line = 212)
