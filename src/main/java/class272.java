...
public class class272 extends class148 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILdh;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "()V", line = 46)
    public class272() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sg", name = "e", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)[I", line = 76)
    ...
    @OriginalMember(owner = "client!sg", name = "e", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(ZI)V", line = 176)
