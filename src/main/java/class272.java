...
public class class272 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(II)Z", line = 94)
