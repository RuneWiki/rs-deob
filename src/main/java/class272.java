...
public class class272 extends class11 {
    ...
    @OriginalMember(owner = "client!mt", name = "c", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!mt", name = "d", descriptor = "(II)[I", line = 49)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lsi;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!mt", name = "f", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!mt", name = "d", descriptor = "(Z)V", line = 301)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IB)[I", line = 331)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "()V", line = 381)
    public class272() {
        super(1, true);
    }
}
