...
public class class272 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIIIZ)V", line = 111)
