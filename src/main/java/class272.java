...
public class class272 extends class314 {
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IBIIIILmj;IILen;I)Lmj;", line = 51)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILdn;)V", line = 96)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IB[B)I", line = 144)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ldn;B)V", line = 160)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BLfb;)V", line = 186)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IFLac;ZI)V", line = 353)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(I)V", line = 378)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)V", line = 409)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ldn;I)V", line = 433)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(II)V", line = 456)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BI)V", line = 482)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IZ)V", line = 530)
