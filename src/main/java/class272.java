...
public class class272 extends OutputStream {
    ...
    @OriginalMember(owner = "client!mb", name = "write", descriptor = "(I)V", line = 5)
    public final void write(int arg0) throws IOException {
        field3800++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(I)V", line = 242)
