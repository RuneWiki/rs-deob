...
public class class272 extends class325 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)J", line = 12)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)I", line = 71)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Z)J", line = 106)
