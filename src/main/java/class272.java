...
public class class272 extends class38 {
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "()V", line = 12)
    public class272() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(BI)[I", line = 17)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(I)V", line = 39)
