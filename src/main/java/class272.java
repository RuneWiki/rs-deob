...
public class class272 extends class479 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I[ILen;IZB)Lan;", line = 6)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)Lhs;", line = 38)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(ILfw;Ldg;III)V", line = 155)
