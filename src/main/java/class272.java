...
public class class272 implements class46 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILro;Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lbp;I)Z", line = 100)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)I", line = 145)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)J", line = 201)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 236)
