...
public class class272 implements class4 {
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)Lne;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lss;Lne;Z)V")
