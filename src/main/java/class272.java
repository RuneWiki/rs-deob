...
public class class272 extends class478 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Lmo;I)Lnd;", line = 4)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(IBI)Z", line = 75)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "(III)Z", line = 107)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IBI)V", line = 121)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(IIIIIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(III)V", line = 156)
