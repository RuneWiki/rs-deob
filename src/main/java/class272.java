...
public class class272 extends class60 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BI)V", line = 36)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(II)I", line = 50)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(ILhd;)V", line = 61)
    public class272(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lhd;)V", line = 64)
    public class272(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)I", line = 67)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)Z", line = 90)
