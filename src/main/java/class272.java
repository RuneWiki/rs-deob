...
public class class272 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(CI)C", line = 22)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(III)V", line = 50)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)[B", line = 65)
