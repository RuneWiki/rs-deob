...
public class class272 {
    ...
    @OriginalMember(owner = "client!wd", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(I)V", line = 27)
    public class272(int arg0) {
        this.field3357 = arg0;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIBII)V", line = 50)
