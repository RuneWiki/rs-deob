...
public class class272 implements Runnable {
    ...
    @OriginalMember(owner = "client!sg", name = "run", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BII)Z", line = 43)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILki;)V", line = 59)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILjava/lang/String;)Llm;", line = 218)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "()V", line = 242)
    public class272() {
