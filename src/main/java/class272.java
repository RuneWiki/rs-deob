...
public class class272 extends class548 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IIILcf;)V")
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILofa;IILha;)V")
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Lru;II)V")
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Llf;)V")
