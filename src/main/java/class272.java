...
public class class272 extends class513 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(IBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lpia;)V", line = 23)
    public class272(class104 arg0) {
        this.field3797 = arg0;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BI)V", line = 31)
