...
public abstract class class272 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IBI)I", line = 22)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIZ)I", line = 340)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(III[[I)V", line = 381)
