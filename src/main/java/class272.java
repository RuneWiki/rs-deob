...
public class class272 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)Lnk;", line = 5)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;Lrr;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(II)Ltg;", line = 208)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;IIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 565)
    public static final void method1936(int arg0) {
        field4070 = (class294) field4072.method1219((long) arg0, -128);
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIIIII)V", line = 568)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;Lec;IIII[I[I)V", line = 579)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;)V", line = 714)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ldp;)V", line = 724)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "()V", line = 744)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;IIII[S[B)V", line = 757)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)Ltg;", line = 815)
    public static final class294 method1943(int arg0) {
        return (class294) field4072.method1219((long) arg0, -89);
    }

    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lja;IIII)Lvq;", line = 820)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "()V", line = 831)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lja;)Lvq;", line = 846)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "()V", line = 861)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lja;IIIIIII[S[BZ)V", line = 885)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "()V", line = 1047)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "([B[B[SII)V", line = 1074)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lcj;III)I", line = 1218)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lcj;II)V", line = 1282)
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "()V", line = 1296)
