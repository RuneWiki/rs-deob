...
public class class272 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIILaq;Laq;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZLmo;Lmo;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BIZII)Lur;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BZLol;)V")
