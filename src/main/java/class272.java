...
public class class272 extends class450 {
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lup;)V", line = 4)
    public class272(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(Z)I", line = 22)
    public final int method1631(boolean arg0) {
        ++field3790;
        return !arg0 ? 77 : super.field6170;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IILfha;B)V", line = 36)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZI)V", line = 52)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)Z", line = 111)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)I", line = 137)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lwu;ZII)Lav;", line = 148)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(ILup;)V", line = 173)
