...
public class class272 extends class305 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "()V", line = 25)
    public class272() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jg", name = "f", descriptor = "(I)V", line = 30)
