...
public class class272 extends class406 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 42)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIIIIIIIBIII)V", line = 75)
