...
public class class272 extends class337 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "()V", line = 144)
    public class272() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BILhp;)V", line = 165)
    ...
    @OriginalMember(owner = "client!wj", name = "e", descriptor = "(III)V", line = 225)
    ...
    @OriginalMember(owner = "client!wj", name = "i", descriptor = "(I)V", line = 237)
