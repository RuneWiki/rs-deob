...
public class class272 implements Runnable {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lcka;B)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Ljn;I)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(B)Lsl;")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(BLsl;IJLjava/lang/String;)V")
