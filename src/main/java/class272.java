...
public class class272 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Lcaa;III)V", line = 35)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!na", name = "c", descriptor = "(B)V", line = 157)
