...
public class class272 extends class432 {
    ...
    @OriginalMember(owner = "client!sg", name = "d", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lkr;Ljava/lang/Object;I)V", line = 25)
