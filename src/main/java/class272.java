...
public class class272 extends class412 {
    ...
    @OriginalMember(owner = "client!saa", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Ltm;B[BI)Loi;", line = 15)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(III)I", line = 46)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "([BBI)[B", line = 67)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIIBZII)V", line = 88)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(III[BIZI)Z", line = 153)
