...
public abstract class class543 extends class140 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lw;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!gu", name = "FA", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(IILw;)Lw;")
    public final class279 method199(int arg0, int arg1, class279 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lbj;[I)V")
    ...
    @OriginalMember(owner = "client!gu", name = "aa", descriptor = "(Lw;IIIIZ)V")
    public final void method197(class279 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Llea;IIII[[I[[II)V")
