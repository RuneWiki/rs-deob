...
public class class543 extends class175 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILdt;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZI)[I", line = 93)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "()V", line = 227)
    public class543() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fo", name = "g", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!fo", name = "h", descriptor = "(I)V", line = 257)
