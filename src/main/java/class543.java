...
public abstract class class543 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ltd;I)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([IIIIIB)Ltd;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIZLjava/awt/Canvas;Lla;ILd;I)Lha;")
