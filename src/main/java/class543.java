...
public class class543 extends class172 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLhia;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Loq;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILgga;)V")
