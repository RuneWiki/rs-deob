...
public class class543 extends class195 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Luq;Led;[Laaa;[I[I)V", line = 100)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "([B[IIIIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!rj", name = "q", descriptor = "(CIIIZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(CIIIZLfa;II)V", line = 232)
