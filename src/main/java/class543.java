...
public class class543 extends class766 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lgga;)Z")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lgga;II)Lrw;")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lgga;I)Lrw;")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "([I)Lud;")
