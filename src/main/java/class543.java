...
public class class543 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ljb;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILjava/lang/String;)V", line = 18)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 80)
