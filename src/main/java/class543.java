...
public abstract class class543 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(JB)I", line = 10)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "()V", line = 45)
