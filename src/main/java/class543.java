...
public class class543 implements class679 {
    ...
    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 27)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!nw", name = "d", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lto;Lmg;Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BI)V", line = 86)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(I)Lmg;", line = 121)
