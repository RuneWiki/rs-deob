...
public abstract class class543 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IILps;)V", line = 57)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 79)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(III)V", line = 175)
