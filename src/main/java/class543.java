...
public class class543 extends class36 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lwt;I)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lwq;I)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIILlv;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lkha;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILip;)I")
