...
public class class543 extends class45 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)Z", line = 29)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 45)
