...
public class class543 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)Lii;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)Lso;")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Ldt;ILwia;Lwia;)V")
