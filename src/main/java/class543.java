...
public class class543 extends class493 implements class231 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BZILqa;IILcea;)V")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BLqa;II)Z")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lqa;I)Lbi;")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lqa;BI)Lr;")
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(Lqa;Ltk;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IBZLqa;)Lep;")
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(ILqa;)Lkm;")
