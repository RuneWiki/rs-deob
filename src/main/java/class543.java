...
public class class543 extends class540 {
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IBII)V", line = 16)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ZIIILaj;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IZLjava/lang/String;Z)I", line = 45)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(FB)V", line = 122)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(IIIIIF)V", line = 136)
    public class543(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(JI)V", line = 140)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Z)V", line = 219)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIZ)Z", line = 229)
