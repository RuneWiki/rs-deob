...
public class class543 extends class82 {
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Lfda;Laba;IIIIIIIIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(I)Lve;", line = 17)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(B)V", line = 37)
