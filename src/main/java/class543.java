...
public class class543 extends class370 {
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(B)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)F", line = 20)
    public final float method3040(int arg0) {
        ++field7187;
        return arg0 != 0 ? -0.24812438F : this.field7188;
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 43)
    public class543(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!lb", name = "d", descriptor = "(B)F", line = 143)
    public final float method3042(byte arg0) {
        ++field7190;
        return arg0 <= 48 ? -0.81959575F : this.field7178;
    }

    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(Z)Ljava/lang/String;", line = 155)
