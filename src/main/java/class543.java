...
public class class543 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lpj;I)Lkq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lpj;II)[Lkq;")
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(Lpj;I)[Lkq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "([B)[Lkq;")
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(Lpj;II)Lkq;")
