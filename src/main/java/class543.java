...
public class class543 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IC)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BII)Z", line = 62)
