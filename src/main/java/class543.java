...
public class class543 extends class434 {
    ...
    @OriginalMember(owner = "client!aca", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Ljava/net/Proxy;B)Ljava/net/Socket;")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)Ljava/net/Socket;")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
