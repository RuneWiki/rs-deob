...
public class class543 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lwm;II)Lpc;")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lmc;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "()Lnga;")
