...
public class class543 extends class635 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lor;IIIIIIIIIIIZZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lr;J)V", line = 46)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(JI)V", line = 220)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lor;IIIIIIIIIIIZZ)V", line = 616)
