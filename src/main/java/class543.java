...
public class class543 extends class72 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(ILcq;)V", line = 46)
    public class543(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([Lkr;B)V", line = 49)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)I", line = 78)
    public final int method60(int arg0) {
        ++field7652;
        return arg0 != -3271 ? 123 : 1;
    }

    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lcq;)V", line = 102)
    public class543(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!ea", name = "e", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)V", line = 144)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(II)I", line = 156)
