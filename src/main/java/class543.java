...
public abstract class class543 extends class55 {
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(I)Z", line = 48)
    public final boolean method3080(int arg0) {
        field7693++;
        return arg0 > -5 ? false : false;
    }

    @OriginalMember(owner = "client!lb", name = "e", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!lb", name = "e", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIII)I", line = 289)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lac;)V", line = 337)
