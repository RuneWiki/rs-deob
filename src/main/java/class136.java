...
public abstract class class136 extends class487 {
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILoa;ILni;ZZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IBIII)V", line = 44)
