...
public class class136 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZLgk;Lgk;)V", line = 21)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Ljp;I)Lkv;", line = 39)
