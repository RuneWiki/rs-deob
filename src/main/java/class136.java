...
public class class136 extends class252 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZII)V", line = 125)
