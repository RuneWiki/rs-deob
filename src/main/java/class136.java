...
public class class136 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([BIIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLha;)V", line = 53)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BF)F", line = 79)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 159)
