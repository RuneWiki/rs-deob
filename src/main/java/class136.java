...
public class class136 extends class213 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "()Lfq;", line = 4)
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "()I", line = 24)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BLnw;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILlba;I[III)V", line = 69)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BIII)I", line = 134)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "([III)V", line = 156)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BLlba;I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "()Lfq;", line = 237)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(I)[Lni;", line = 257)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lot;)V", line = 309)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 272)
