...
public class class136 extends class344 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(III)Lwm;", line = 21)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIIIBZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II)I", line = 239)
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIILcj;I)V", line = 276)
    ...
    @OriginalMember(owner = "client!ks", name = "e", descriptor = "(B)I", line = 318)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Llk;I)Lng;", line = 333)
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(II)[B", line = 524)
    ...
    @OriginalMember(owner = "client!ks", name = "f", descriptor = "(B)V", line = 546)
    ...
    @OriginalMember(owner = "client!ks", name = "e", descriptor = "(I)V", line = 574)
    ...
    @OriginalMember(owner = "client!ks", name = "g", descriptor = "(B)I", line = 621)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(II)V", line = 640)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)Lpo;", line = 668)
    ...
    @OriginalMember(owner = "client!ks", name = "f", descriptor = "(I)V", line = 767)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(III)Ldi;", line = 787)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(ILnk;Lnk;Lbo;Lfb;IIZ)V", line = 1036)
