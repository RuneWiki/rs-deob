...
public class class136 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLod;ZLjava/lang/String;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(FIBFLhj;IIFFFI)[B", line = 73)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILjava/lang/String;)V", line = 90)
