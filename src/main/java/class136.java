...
public class class136 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IIBI)I", line = 42)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BI)Loe;", line = 58)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 95)
