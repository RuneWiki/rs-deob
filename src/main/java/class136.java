...
public class class136 extends InputStream {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "read", descriptor = "()I", line = 15)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIIIIIBI)V", line = 26)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BI)I", line = 46)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 58)
