...
public class class136 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lco;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BILco;)V", line = 50)
