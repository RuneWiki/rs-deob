...
public class class136 extends class249 {
    ...
    @OriginalMember(owner = "client!wf", name = "d", descriptor = "(I)Lmi;")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lwh;Ljga;)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lme;ZI)V")
