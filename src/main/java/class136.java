...
public class class136 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lvk;B)I")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)Lhc;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Z)Lhc;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILhc;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "(I)Lhc;")
