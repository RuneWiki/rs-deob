...
public class class136 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ldn;II)Lne;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "([B)[Lne;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ldn;I)[Lne;")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Ldn;II)[Lne;")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Ldn;I)Lne;")
