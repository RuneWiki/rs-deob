...
public class class136 extends class739 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BI)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "()V", line = 130)
    public class136() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)[I", line = 170)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lsl;II)V", line = 194)
