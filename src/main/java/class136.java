...
public class class136 extends class476 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(J)V", line = 22)
    public class136(long arg0) {
        this.field2059 = arg0;
    }

    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(Z)V", line = 30)
