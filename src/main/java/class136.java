...
public class class136 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 165)
