...
public class class136 extends class226 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)I", line = 29)
    public static int method878(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ud", name = "h", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lep;)V", line = 49)
    public class136(class371 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ud", name = "k", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ud", name = "i", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ud", name = "j", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(III)V", line = 123)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BJLha;)V", line = 211)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZI)V", line = 247)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIZIIIII)V", line = 267)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lfq;ILfq;B)V", line = 279)
