...
public class class136 extends class670 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(FI)V", line = 4)
    ...
    @OriginalMember(owner = "client!qaa", name = "g", descriptor = "(B)V", line = 22)
    public static void method764(byte arg0) {
        int var1 = -125 % ((-80 - arg0) / 32);
        field1497 = null;
    }

    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(IIIIIF)V", line = 34)
    public class136(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IIIB)V", line = 37)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BILsp;)V", line = 49)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IIBII)V", line = 79)
