...
public abstract class class136 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIBIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILva;IIZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIII)I", line = 283)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIZI)Z", line = 316)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIZ)V", line = 339)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILth;IIIIIBIII)Z", line = 354)
