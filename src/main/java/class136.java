...
public class class136 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILnj;)V", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lnj;IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IILga;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)Lmn;", line = 127)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lnj;I)V", line = 159)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BIII)I", line = 179)
