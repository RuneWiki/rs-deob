...
public class class136 implements Runnable {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Ljava/lang/String;I)Llk;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILeu;)Ljava/lang/String;")
