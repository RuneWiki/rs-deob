...
public class class136 extends class118 {
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)[Lae;")
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Los;Lkm;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lbaa;IB)V")
