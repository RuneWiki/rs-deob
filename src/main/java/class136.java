...
public class class136 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lcg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(B)V", line = 133)
