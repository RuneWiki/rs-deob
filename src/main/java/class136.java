...
public class class136 extends class413 implements class276 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III[I)V", line = 14)
    public final void method997(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1001(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "()Lia;", line = 25)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 33)
    public class136() {
        this.method1006();
    }
