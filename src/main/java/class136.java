...
public class class136 extends class521 {
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lbda;)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILhv;I)V")
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(III)Lbq;")
