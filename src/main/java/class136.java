...
public class class136 extends class36 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Ljava/net/Proxy;Z)Ljava/net/Socket;", line = 12)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 45)
    ...
    @OriginalMember(owner = "client!vh", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 98)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 174)
