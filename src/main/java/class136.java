...
public class class136 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "([BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lic;[BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lic;Ljava/nio/ByteBuffer;)V", line = 29)
