...
public class class136 extends class415 implements class276 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III[I)V", line = 3)
    public final void method332(int arg0, int arg1, int arg2, int[] arg3) {
        this.method887(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 12)
    public class136() {
        this.method886();
    }

    @OriginalMember(owner = "client!sa", name = "finalize", descriptor = "()V", line = 22)
    protected final void finalize() {
        class390.method2237(true, this);
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "()Lia;", line = 34)
