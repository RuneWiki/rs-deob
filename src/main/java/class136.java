...
public class class136 extends class744 implements class2 {
    ...
    @OriginalMember(owner = "client!ja", name = "w", descriptor = "(Z)V", line = 33)
    public final void method12(boolean arg0) {
        this.method893(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()V", line = 37)
    public final void method889() {
        this.method901(this.nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ja", name = "e", descriptor = "(I)V", line = 50)
    public final void method895(int arg0) {
        this.method883(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)V", line = 53)
    public final void method896(int arg0) {
        this.method885(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lih;)V", line = 65)
    public final void method900(class744 arg0) {
        this.method892(this.nativeid, ((class136) arg0).nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "g", descriptor = "(I)V", line = 69)
    public final void method902(int arg0) {
        this.method904(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 73)
    public class136() {
        this.method886();
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III)V", line = 79)
    public final void method905(int arg0, int arg1, int arg2) {
        this.method891(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lih;", line = 83)
    ...
    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(III[I)V", line = 88)
