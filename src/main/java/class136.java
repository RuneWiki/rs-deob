...
public abstract class class136 extends class164 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)[Lhj;")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I[Ln;I)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lbe;I)V")
