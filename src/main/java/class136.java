...
public class class136 extends class583 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BII)I", line = 30)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZII)Z", line = 77)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "([B)V", line = 88)
    public class136(byte[] arg0) {
        this.field1981 = arg0;
    }

    @OriginalMember(owner = "client!cg", name = "d", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I[ILfp;Lfp;)V", line = 108)
