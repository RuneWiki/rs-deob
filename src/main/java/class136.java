...
public class class136 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZIIBIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!fg", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIIIIBZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 84)
