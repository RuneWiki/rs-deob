...
public class class136 extends class165 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BIB)V", line = 66)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZI)V", line = 97)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(IIIIIFFF)V", line = 140)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)V", line = 160)
