...
public class class136 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILoj;ILza;IIILvm;Lrq;IIB)Le;", line = 6)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lrq;BII)V", line = 156)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lvm;ILtb;Loj;Lro;Lrq;ILza;ILmk;IZ)Le;", line = 178)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILza;IIIII)Le;", line = 371)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IZ[II[II)V", line = 419)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)V", line = 447)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 460)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BZ)V", line = 477)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIBI)V", line = 530)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "([Lf;Lro;IILoj;Lza;ILvm;Lmk;IIILbg;ILrq;Loj;ILtb;Z)Le;", line = 546)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lfo;Lqm;ILfo;Lfo;)Z", line = 1053)
