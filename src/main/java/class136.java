...
public class class136 extends class454 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIIIIIIB)V", line = 11)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([Lnfa;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 71)
