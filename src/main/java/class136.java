...
public class class136 implements class279 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "()V", line = 5)
    public final void method889() {
        this.field1939.field198.glFramebufferRenderbufferEXT(36160, this.field1936, 36161, 0);
        this.field1936 = -1;
    }

    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lhd;III)V", line = 28)
    ...
    @OriginalMember(owner = "client!sr", name = "finalize", descriptor = "()V", line = 24)
    protected final void finalize() throws Throwable {
        this.method1079();
        super.finalize();
    }

    @OriginalMember(owner = "client!sr", name = "b", descriptor = "()V", line = 42)
