...
public class class136 extends class414 implements class276 {
    ...
    @OriginalMember(owner = "client!sa", name = "finalize", descriptor = "()V", line = 17)
    protected final void finalize() {
        class236.method1601(-98, this);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III[I)V", line = 20)
    public final void method908(int arg0, int arg1, int arg2, int[] arg3) {
        this.method899(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "()Lia;", line = 26)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 32)
    public class136() {
        this.method904();
    }
