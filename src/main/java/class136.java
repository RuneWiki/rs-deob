...
public class class136 extends class440 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILmo;I)V")
