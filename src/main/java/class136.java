...
public class class136 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILgv;[II)V", line = 499)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lmc;B)V", line = 585)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZZI)V", line = 602)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)Lmc;", line = 619)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(I)V", line = 649)
    public class136(int arg0) {
        this.field1733 = arg0;
    }

    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(IIIIII)V", line = 656)
