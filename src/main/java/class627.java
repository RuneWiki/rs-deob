...
public class class627 extends class18 implements class558 {
    ...
    @OriginalMember(owner = "client!gca", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)I", line = 39)
    public final int method2985(int arg0) {
        ++field9094;
        return arg0 != 17831 ? -111 : super.field357;
    }

    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)J", line = 63)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)Z", line = 74)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Luca;I[BIZ)V", line = 88)
    public class627(class287 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field9102 = arg1;
    }

    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Luca;ILjaclib/memory/Buffer;IZ)V", line = 98)
