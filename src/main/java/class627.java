...
public class class627 extends class461 {
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(ILaj;I)V")
    ...
    @OriginalMember(owner = "client!gl", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!gl", name = "l", descriptor = "(I)V")
