...
public class class627 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)Lmu;", line = 4)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)Lmu;", line = 17)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 75)
    public class627() {
    }

    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Ltq;)V", line = 77)
    public class627(class572 arg0) {
        this.field8900 = arg0;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)V", line = 65)
