...
public class class627 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Ljava/io/File;IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(BI)I", line = 27)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "([J[IBII)V", line = 46)
    ...
    @OriginalMember(owner = "client!nca", name = "toString", descriptor = "()Ljava/lang/String;", line = 102)
    public final String toString() {
        field8899++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Z)I", line = 111)
    public final int method3613(boolean arg0) {
        field8900++;
        return arg0 ? 26 : this.field8892;
    }

    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 122)
    public class627(String arg0, int arg1) {
        this.field8892 = arg1;
    }

    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(I)V", line = 132)
    public static void method3614(int arg0) {
        int var1 = -115 % ((arg0 + 8) / 58);
        field8893 = null;
    }

    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Lal;III)V", line = 143)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(CI)Z", line = 156)
