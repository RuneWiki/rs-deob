...
public class class627 extends class778 implements class362 {
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lkia;II[I)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lha;B)Lhq;")
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(Lha;B)Lpw;")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lcb;Lcb;Lcb;ILcb;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IZLha;I)Z")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILsf;Lha;BIIZ)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lpi;I)V")
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lha;Ldja;IIIIIZIIIIIII)V")
