...
public class class627 extends class118 implements class457 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lha;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eb", name = "h", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!eb", name = "g", descriptor = "(B)Z", line = 84)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(ILha;)V", line = 99)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(ILha;)Lwg;", line = 130)
    ...
    @OriginalMember(owner = "client!eb", name = "k", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(Lha;I)Ljk;", line = 155)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)Z", line = 180)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILha;)Lka;", line = 193)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(I)Z", line = 215)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILha;)V", line = 231)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 258)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)I", line = 286)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZIILha;)Lok;", line = 297)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIZ)V", line = 329)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Z)I", line = 362)
    public final int method758(boolean arg0) {
        ++field8616;
        return !arg0 ? -9 : 22;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BILha;I)Z", line = 373)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(I)Z", line = 395)
