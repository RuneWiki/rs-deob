...
public class class627 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "([Ljava/lang/Object;Ljava/applet/Applet;Ljava/lang/String;I)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Ljava/lang/String;ZLjava/applet/Applet;)V", line = 15)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)Ljava/lang/Object;", line = 25)
