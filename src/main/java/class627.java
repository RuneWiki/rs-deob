...
public class class627 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(II)Z", line = 16)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(IIIBI)V", line = 41)
