...
public class class627 extends class638 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "()Lmp;", line = 5)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "()V", line = 57)
    public final void method3548() {
        this.field8802 = true;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "([Lsn;Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!em", name = "d", descriptor = "()V", line = 150)
    private final void method3550() {
        this.field8791 = false;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(J)V", line = 153)
    public final void method3551(long arg0) {
        this.field8795 = arg0;
    }

    @OriginalMember(owner = "client!em", name = "e", descriptor = "()V", line = 156)
    public static void method3552() {
        field8792 = null;
        field8794 = null;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lha;)V", line = 163)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lha;J)Z", line = 176)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IZ)Lem;", line = 224)
    ...
    @OriginalMember(owner = "client!em", name = "f", descriptor = "()Lmp;", line = 237)
    public final class315 method3556() {
        return this.field8801;
    }

    @OriginalMember(owner = "client!em", name = "g", descriptor = "()V", line = 243)
    public final void method3557() {
        this.field8791 = true;
    }

    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class627(int arg0, boolean arg1) {
        this.method3558(arg0, arg1);
    }

    @OriginalMember(owner = "client!em", name = "b", descriptor = "(IZ)V", line = 250)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lha;[Lou;Z)V", line = 259)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIII)V", line = 334)
    public final void method3560(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field8799 = arg0;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lha;J[Lou;[Lsn;Z)V", line = 345)
