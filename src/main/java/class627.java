...
public class class627 extends class656 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lwu;I)Loo;", line = 7)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)F", line = 30)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "()I", line = 75)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([B)V", line = 84)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([I)Lct;", line = 131)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lwu;)Z", line = 191)
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "(I)[F", line = 206)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lwu;II)Loo;", line = 623)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([BI)V", line = 641)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "([B)V", line = 647)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "()V", line = 799)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "([B)V", line = 817)
