...
public class class627 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)[Leda;", line = 19)
    ...
    @OriginalMember(owner = "client!gca", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
