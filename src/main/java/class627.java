...
public class class627 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lna;B)Lrfa;", line = 20)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLio;ZILio;)I", line = 44)
