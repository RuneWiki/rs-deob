...
public class class627 extends class263 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIBIII[FIFI)V", line = 17)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(Z)V", line = 200)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IS)V", line = 216)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "([[ZIIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIIIIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lkea;Liq;Lbj;[I)V", line = 475)
