...
public class class627 extends class665 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(I)V", line = 78)
