...
public class class627 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZLlc;Ljava/lang/String;ILjava/lang/String;)Lpga;", line = 20)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BI)Ltea;", line = 159)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)Lida;", line = 188)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(II)V", line = 204)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lmja;ILbt;)V", line = 245)
