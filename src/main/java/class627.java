...
public class class627 implements Runnable {
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!gl", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!gl", name = "run", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I[BII)V", line = 97)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Ljava/net/Socket;Ltga;I)V", line = 297)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 207)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I[BII)V", line = 273)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)I", line = 312)
