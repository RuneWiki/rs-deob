...
public class class627 extends class62 {
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 4)
    public class627() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(FFFIILmba;FIIFI)[B", line = 7)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lgw;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IILvp;B)V", line = 108)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IB)[[I", line = 265)
