...
public class class627 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BI)Lica;")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(J[ILmha;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(ILwu;Lwu;Lph;)V")
