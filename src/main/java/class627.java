...
public class class627 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(FLui;ILui;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(III)Z", line = 104)
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Lpq;)V", line = 125)
