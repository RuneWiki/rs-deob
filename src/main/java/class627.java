...
public class class627 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z)Ljava/io/File;", line = 7)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I[BIB)V", line = 17)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)J", line = 36)
    ...
    @OriginalMember(owner = "client!ob", name = "finalize", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IJ)V", line = 60)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z[BII)I", line = 85)
