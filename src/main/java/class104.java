...
public class class104 extends class627 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "()[I", line = 6)
    public final int[] method721() {
        return this.field1286;
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(II[IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "()V", line = 212)
