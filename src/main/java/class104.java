...
public class class104 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)J", line = 9)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIIII)Z", line = 24)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 54)
