...
public class class104 extends class264 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(ILmfa;)V", line = 40)
    public class104(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lmfa;)V", line = 44)
    public class104(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IB)Z", line = 49)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)I", line = 59)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BI)I", line = 89)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIIII)V", line = 132)
