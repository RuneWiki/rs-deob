...
public class class104 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ljw;I)I")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)Lev;")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lcaa;)V")
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lsea;ILmv;Lmv;)V")
