...
public class class104 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lhd;[Lln;)Lge;", line = 5)
    ...
    @OriginalMember(owner = "client!ge", name = "finalize", descriptor = "()V", line = 71)
    protected final void finalize() throws Throwable {
        this.field1528.method132(this.field1527);
        super.finalize();
    }

    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lhd;I[Lln;)V", line = 74)
