...
public class class104 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IZZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IZLuu;)Ljava/lang/String;", line = 82)
