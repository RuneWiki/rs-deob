...
public class class104 extends class366 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 23)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(BII)V", line = 35)
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(IIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIZ)V", line = 79)
