...
public class class104 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lhs;Ljava/lang/Object;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "([I[Ljava/lang/Object;I)V", line = 57)
