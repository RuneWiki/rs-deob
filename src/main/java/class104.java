...
public class class104 extends class181 {
    ...
    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!jt", name = "h", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IBI)Z", line = 143)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIIIZI)V", line = 160)
    ...
    @OriginalMember(owner = "client!jt", name = "d", descriptor = "(B)V", line = 597)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lgt;II)V", line = 612)
