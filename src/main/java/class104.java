...
public abstract class class104 {
    ...
    @OriginalMember(owner = "client!pia", name = "g", descriptor = "(B)D", line = 3)
    ...
    @OriginalMember(owner = "client!pia", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(B)Ll;", line = 192)
    ...
    @OriginalMember(owner = "client!pia", name = "d", descriptor = "(B)Lsm;", line = 203)
    ...
    @OriginalMember(owner = "client!pia", name = "c", descriptor = "(B)Z", line = 325)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(B)V", line = 347)
    ...
    @OriginalMember(owner = "client!pia", name = "c", descriptor = "(I)V", line = 389)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(B[Ljava/lang/String;)[Ljava/lang/String;", line = 404)
    ...
    @OriginalMember(owner = "client!pia", name = "e", descriptor = "(I)V", line = 429)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BLjava/lang/String;)V", line = 450)
    ...
    @OriginalMember(owner = "client!pia", name = "f", descriptor = "(B)Liu;", line = 501)
    ...
    @OriginalMember(owner = "client!pia", name = "g", descriptor = "(I)V", line = 514)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IZ)V", line = 543)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Z)Z", line = 565)
    ...
    @OriginalMember(owner = "client!pia", name = "e", descriptor = "(B)Led;", line = 585)
    ...
    @OriginalMember(owner = "client!pia", name = "f", descriptor = "(I)Lsv;", line = 596)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)V", line = 616)
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "(I)V", line = 643)
