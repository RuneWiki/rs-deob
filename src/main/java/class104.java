...
public class class104 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)Lfa;")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lrb;ILpc;Lpc;)V")
