...
public class class104 extends class282 {
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "()V", line = 5)
    public class104() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(IIII)[B", line = 8)
    ...
    @OriginalMember(owner = "client!aa", name = "d", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!aa", name = "e", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IBB)V", line = 49)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lnp;I)Lig;", line = 74)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BI)Z", line = 111)
