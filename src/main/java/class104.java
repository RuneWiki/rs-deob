...
public class class104 {
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)Lhk;", line = 57)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIBIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(IIII)V", line = 89)
