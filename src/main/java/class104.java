...
public class class104 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZIII)Lvo;", line = 16)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lmn;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II[BI)V", line = 157)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZLufa;)I", line = 179)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIILis;)V", line = 264)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lkfa;Loi;Lfw;IIIII)V", line = 360)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 343)
