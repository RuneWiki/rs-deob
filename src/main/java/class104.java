...
public class class104 extends class170 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lsk;ILsk;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BLij;Lij;)I", line = 50)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 340)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(III[IB)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([IIZI)Z", line = 127)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!ge", name = "e", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!ge", name = "f", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZ)V", line = 294)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZI[II)Z", line = 313)
