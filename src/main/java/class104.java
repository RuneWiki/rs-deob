...
public class class104 {
    ...
    @OriginalMember(owner = "client!la", name = "i", descriptor = "J")
    public long field2054 = 0L;

    @OriginalMember(owner = "client!la", name = "h", descriptor = "Lhd;")
    public static class73 field2053 = new class73(0, 0);

    @OriginalMember(owner = "client!la", name = "n", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!la", name = "c", descriptor = "Lka;")
    public class95 field2048;

    @OriginalMember(owner = "client!la", name = "d", descriptor = "Lka;")
