...
public class class104 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Llt;II)Lhq;", line = 7)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "()Lgu;", line = 15)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "()I", line = 20)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "()[B", line = 64)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lha;)V", line = 128)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "()V", line = 149)
    private class104() {
    }
}
