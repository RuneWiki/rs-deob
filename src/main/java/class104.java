...
public class class104 implements class576 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!jt", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field1082++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILha;ZI)Lab;", line = 59)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 128)
