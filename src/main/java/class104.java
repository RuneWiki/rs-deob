...
public class class104 extends class503 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)V", line = 17)
    public final void method624(int arg0, int arg1, int arg2) {
        int var4 = -51 / (-arg0 / 59);
        ++field1406;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBLtu;)V", line = 38)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lrl;)V", line = 50)
    public class104(class487 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 83)
