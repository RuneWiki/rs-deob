...
public class class104 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BLza;)V", line = 93)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "([JII[II)V", line = 150)
    ...
    @OriginalMember(owner = "client!d", name = "toString", descriptor = "()Ljava/lang/String;", line = 206)
    public final String toString() {
        field1406++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lgp;I)V", line = 217)
    ...
    @OriginalMember(owner = "client!d", name = "c", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 247)
