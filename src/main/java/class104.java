...
public class class104 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lsi;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lt;IBIII)Lt;", line = 44)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 176)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBLsi;)V", line = 247)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZIII)I", line = 405)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BIIILt;IIB)Lt;", line = 541)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIIII)I", line = 621)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I[I[Ljava/lang/Object;BI)V", line = 680)
