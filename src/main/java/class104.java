...
public class class104 extends class597 {
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(Lha;B)Ldg;")
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(BLha;)Lhga;")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ILha;Lsk;Lka;)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Lha;Lcn;IIBZI)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIILha;)Lka;")
