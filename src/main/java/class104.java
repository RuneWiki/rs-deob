...
public class class104 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IB)Lti;", line = 13)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BII)I", line = 50)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI)Lu;", line = 95)
