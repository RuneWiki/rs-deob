...
public class class104 extends class443 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lfb;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(I)V", line = 627)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BI)I", line = 638)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lps;I)V", line = 651)
    ...
    @OriginalMember(owner = "client!il", name = "e", descriptor = "(B)I", line = 688)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)I", line = 701)
    ...
    @OriginalMember(owner = "client!il", name = "e", descriptor = "(I)Ljava/lang/String;", line = 719)
    ...
    @OriginalMember(owner = "client!il", name = "f", descriptor = "(I)V", line = 746)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(III)Lon;", line = 776)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILfb;[I)V", line = 790)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZILfb;)V", line = 828)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(Z)V", line = 897)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(Lfb;I)Ljava/lang/String;", line = 919)
