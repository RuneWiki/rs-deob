...
public class class104 {
    ...
    @OriginalMember(owner = "client!pk", name = "toString", descriptor = "()Ljava/lang/String;", line = 19)
    public final String toString() {
        field1395++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 40)
