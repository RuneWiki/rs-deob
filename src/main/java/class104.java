...
public class class104 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BI[Ljb;)V", line = 18)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IBLha;IILd;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 185)
