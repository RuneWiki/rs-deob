...
public class class104 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lcu;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "([J[Ljava/lang/Object;I)V", line = 30)
    public static final void method784(long[] arg0, Object[] arg1, int arg2) {
        class88.method690(arg1, arg0, arg2, arg0.length - 1, arg2 + 1);
        field1739++;
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILcu;IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILhu;[[B)V", line = 115)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 189)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lvj;BZ[BIIII)Lmk;", line = 241)
