...
public class class104 extends class173 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lmc;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lmc;I)Ljava/lang/String;", line = 68)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IB)Lgh;", line = 98)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BLmc;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 187)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(III)I", line = 305)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 322)
    ...
    @OriginalMember(owner = "client!dm", name = "e", descriptor = "(B)I", line = 340)
    ...
    @OriginalMember(owner = "client!dm", name = "e", descriptor = "(I)Ljava/lang/String;", line = 358)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lmc;[IZ)V", line = 390)
