...
public class class104 implements class630 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)Lag;", line = 30)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I[BIIIII)Z", line = 48)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ZLtq;Ltq;)V", line = 99)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(ILvfa;Lrq;II)V", line = 115)
