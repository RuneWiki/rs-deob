...
public class class104 extends class149 {
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "()V", line = 329)
    public class104() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIFIIFIIII[FF)V", line = 33)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IBLtl;)V", line = 118)
    ...
    @OriginalMember(owner = "client!mh", name = "d", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!mh", name = "d", descriptor = "(III)Z", line = 209)
    ...
    @OriginalMember(owner = "client!mh", name = "e", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILap;IIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)[I", line = 258)
    ...
    @OriginalMember(owner = "client!mh", name = "d", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIIIIII)V", line = 339)
    ...
    @OriginalMember(owner = "client!mh", name = "f", descriptor = "(I)V", line = 394)
