...
public class class104 implements Runnable {
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III[B)V", line = 38)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 312)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Ltd;IIIBI)Ljava/awt/Frame;", line = 116)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III)B", line = 185)
    ...
    @OriginalMember(owner = "client!qu", name = "d", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!qu", name = "run", descriptor = "()V", line = 235)
