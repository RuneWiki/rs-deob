...
public class class104 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([BZ)[B", line = 12)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IZ)I", line = 80)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IB)I", line = 95)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(II)V", line = 112)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 173)
