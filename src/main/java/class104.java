...
public class class104 extends class260 {
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfca;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIIILrh;)V")
