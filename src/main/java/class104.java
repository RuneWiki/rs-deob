...
public class class104 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lr;IIILsp;Llt;)Z", line = 15)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 230)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 249)
