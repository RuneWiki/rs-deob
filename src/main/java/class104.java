...
public class class104 extends class430 implements class2 {
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 24)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Loa;Ljava/awt/Canvas;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 74)
