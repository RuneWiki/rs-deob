...
public class class104 extends class236 {
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(I)V", line = 4)
    public class104(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ZF)V", line = 9)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IF)V", line = 24)
