...
public class class104 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lci;I)[Lho;")
    ...
    @OriginalMember(owner = "client!ho", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lci;II)[Lho;")
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(Lci;I)Lho;")
    public static final class104 method763(class320 arg0, int arg1) {
        byte[] var2 = arg0.method2029(arg1, false);
        return var2 == null ? null : method764(var2)[0];
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([B)[Lho;")
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(Lci;II)Lho;")
