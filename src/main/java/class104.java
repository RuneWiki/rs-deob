...
public class class104 extends class297 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(ILua;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "(I)V", line = 209)
    private class104(int arg0) {
        super(0, false);
        this.method952(-104, arg0);
    }

    @OriginalMember(owner = "client!qha", name = "d", descriptor = "(II)[[I", line = 219)
    ...
    @OriginalMember(owner = "client!qha", name = "e", descriptor = "(II)V", line = 260)
    ...
    @OriginalMember(owner = "client!qha", name = "f", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(Lcea;II)V", line = 287)
    ...
    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "()V", line = 318)
    public class104() {
        this(0);
    }
}
