...
public abstract class class104 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!qha", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(IIZ[I[Ljava/lang/Object;)V", line = 75)
