...
public class class104 extends class589 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Laf;B)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIBLha;)Z")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ZLofa;I)V")
