...
public class class385 extends class61 {
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lsq;Lci;[Ljf;[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([B[IIIIIIIIIIILde;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([B[IIIIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(CIIIZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(CIIIZLde;II)V", line = 212)
