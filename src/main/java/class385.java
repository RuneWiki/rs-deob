...
public class class385 extends class318 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIII)I", line = 16)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIZ)I", line = 94)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZ)V", line = 121)
    public final void method722(int arg0, boolean arg1) {
        ++field5781;
        int var3 = -62 / ((arg0 - -23) / 46);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILjava/lang/String;BII)V", line = 133)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(III)Z", line = 257)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lcl;I)V", line = 273)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZZ)V", line = 300)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lkd;Luo;)V", line = 346)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lav;IB)V", line = 367)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 383)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)V", line = 486)
