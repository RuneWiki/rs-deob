...
public abstract class class385 extends class329 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(B)[Lwp;", line = 20)
