...
public class class385 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IB)I", line = 33)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lfp;IIILeb;)V", line = 48)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B[B)[B", line = 83)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILct;)V", line = 156)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(II)V", line = 182)
