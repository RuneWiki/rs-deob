...
public class class385 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(III)Lpm;", line = 52)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "([I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)V", line = 116)
