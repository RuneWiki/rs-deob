...
public class class385 extends class726 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "()Lmda;", line = 3)
    public final class266 method2419() {
        return this.field5593;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IZ)Luj;", line = 7)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "()V", line = 22)
    public static void method2421() {
        field5586 = null;
        field5589 = null;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lha;)V", line = 28)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "()V", line = 43)
    public final void method2423() {
        this.field5596 = true;
    }

    @OriginalMember(owner = "client!uj", name = "d", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(IZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lha;[Lnn;Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIII)V", line = 168)
    public final void method2427(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field5595 = arg0;
    }

    @OriginalMember(owner = "client!uj", name = "e", descriptor = "()V", line = 180)
    public final void method2428() {
        this.field5585 = true;
    }

    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class385(int arg0, boolean arg1) {
        this.method2425(arg0, arg1);
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lha;J)Z", line = 187)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lha;J[Lnn;[Leca;Z)V", line = 235)
    ...
    @OriginalMember(owner = "client!uj", name = "f", descriptor = "()V", line = 243)
    private final void method2431() {
        this.field5585 = false;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([Leca;Z)V", line = 248)
    ...
    @OriginalMember(owner = "client!uj", name = "g", descriptor = "()Lmda;", line = 339)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(J)V", line = 368)
