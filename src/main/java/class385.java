...
public class class385 extends class406 {
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(I)V", line = 9)
    public static void method2451(int arg0) {
        int var1 = 32 / ((55 - arg0) / 44);
        field5672 = null;
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lza;ILjt;)I", line = 21)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)Lrh;", line = 46)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IB)I", line = 105)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Ltt;IIIIII)V", line = 116)
