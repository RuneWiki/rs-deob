...
public class class385 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)Lgca;", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BI)I", line = 26)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZII)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(I)Lgca;", line = 128)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 150)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZLgca;)V", line = 161)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "()V", line = 208)
    public class385() {
        this.field5393.field3250 = this.field5393;
        this.field5393.field3254 = this.field5393;
    }

    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(I)V", line = 185)
