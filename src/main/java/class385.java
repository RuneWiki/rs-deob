...
public class class385 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lml;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(I)V", line = 92)
    public class385(int arg0) {
        this.field5369 = arg0;
    }

    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(IIIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)Lml;", line = 36)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 70)
