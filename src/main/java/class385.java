...
public class class385 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lvda;IJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)Lvda;", line = 89)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(JI)Lvda;", line = 120)
