...
public class class385 extends Callback {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZZLjava/awt/Component;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ll", name = "callback", descriptor = "(IIII)I", line = 67)
