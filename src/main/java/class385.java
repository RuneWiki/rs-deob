...
public class class385 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIB)I", line = 20)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)I", line = 55)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)V", line = 73)
