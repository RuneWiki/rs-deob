...
public class class385 extends class134 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lda;)V", line = 3)
    public static final void method2388(class59 arg0) {
        class254.field3055 = arg0;
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(III)Z", line = 10)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lm;)V", line = 96)
    public class385(class191 arg0) {
        this.field5365 = arg0;
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 63)
