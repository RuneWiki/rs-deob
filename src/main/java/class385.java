...
public abstract class class385 extends class525 {
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Ltp;I)V", line = 67)
