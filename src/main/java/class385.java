...
public class class385 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILpm;IIILza;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILsv;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILql;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILsv;)V")
