...
public class class385 extends class292 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!nl", name = "g", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "([BZI)Ljava/lang/Object;", line = 185)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)Z", line = 241)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(IIIIIFFF)V", line = 279)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(BII)V", line = 293)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIZIII)V", line = 304)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(III)Z", line = 330)
