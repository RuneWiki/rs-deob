...
public class class385 extends class331 {
    ...
    @OriginalMember(owner = "client!rg", name = "e", descriptor = "(I)Lbj;", line = 6)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZBI)I", line = 27)
    ...
    @OriginalMember(owner = "client!rg", name = "f", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIIIII)I", line = 59)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!rg", name = "g", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Ldj;Lom;)V", line = 130)
