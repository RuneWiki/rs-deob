...
public class class385 extends class177 implements class232 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIZLoe;IIIIII)Z")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(IIIIILkg;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILqa;)Lbw;")
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(Lqa;I)V")
