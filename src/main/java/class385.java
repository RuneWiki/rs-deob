...
public class class385 extends class366 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(II)Z", line = 124)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(I)V", line = 151)
