...
public class class385 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Z)J", line = 21)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IB[BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lga;ILya;)V", line = 158)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IJ)V", line = 388)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 401)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(III)Z", line = 445)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lrp;II)V", line = 860)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)V", line = 463)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Z)V", line = 474)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(IB[BI)V", line = 550)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)V", line = 756)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(I)Ljava/io/File;", line = 846)
