...
public class class385 extends class440 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lok;Z)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lwt;B)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILmo;I)V")
