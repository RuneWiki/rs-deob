...
public abstract class class385 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(FFFFIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(FFFFIILvb;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIII)V", line = 55)
    public final void method2297(int arg0, int arg1, int arg2, int arg3) {
        this.method384(arg0, arg1, arg2, arg3, 0, 0, 1);
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(FFII)V", line = 59)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(FFIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(FFIILvb;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)V", line = 80)
