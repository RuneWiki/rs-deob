...
public class class385 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIIII)V", line = 76)
