...
public class class385 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IBILhw;)V", line = 52)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lek;I)Lfga;", line = 69)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)V", line = 91)
