...
public class class385 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)[Lok;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILgb;Z)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([ILql;[IZ[I)V")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lbo;Lts;Lui;IIIII)V")
