...
public class class385 implements class23 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(BI)I", line = 30)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZZ)I", line = 92)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BII)V", line = 181)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BI)I", line = 211)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 223)
