...
public class class385 extends class451 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!oka", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 6)
    ...
    @OriginalMember(owner = "client!oka", name = "c", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!oka", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(Ljava/awt/Canvas;III)V", line = 47)
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(IIIILjava/awt/Graphics;III)V", line = 69)
    ...
    @OriginalMember(owner = "client!oka", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 89)
    ...
    @OriginalMember(owner = "client!oka", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 99)
    ...
    @OriginalMember(owner = "client!oka", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 111)
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(BLjc;)V", line = 118)
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(IBIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(IIII[BZI)Z", line = 212)
