...
public class class385 extends class296 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(CIIIZLta;II)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lhj;Lqm;[Lwh;[I[I)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
