...
public class class385 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILya;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Z)V", line = 64)
