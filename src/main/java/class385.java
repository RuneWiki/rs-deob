...
public class class385 extends class149 implements class559 {
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "e", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lha;I)Lie;", line = 40)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IB)V", line = 67)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZLha;)V", line = 80)
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "(B)Z", line = 91)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILha;)V", line = 105)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIBLha;)Z", line = 138)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZBLha;I)Lsca;", line = 163)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lha;B)V", line = 196)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)I", line = 224)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(B)Z", line = 236)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(Lha;B)Lufa;", line = 270)
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "(I)I", line = 289)
    ...
    @OriginalMember(owner = "client!sb", name = "d", descriptor = "(B)Z", line = 300)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lha;IB)Lka;", line = 315)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 338)
