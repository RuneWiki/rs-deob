...
public class class385 implements class248 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oh", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lh;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "()V", line = 35)
