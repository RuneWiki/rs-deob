...
public class class385 extends class446 {
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lap;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Llt;I)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lap;IIII[I)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lap;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lap;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lap;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lap;IIIIZ[BI)V")
