...
public class class385 extends class86 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lga;IIB)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lnq;Lhl;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ldq;ILnj;B)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZLlr;I)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Luu;ZLuu;)V")
