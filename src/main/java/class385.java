...
public class class385 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IB)I", line = 30)
    public static final int method2391(int arg0, byte arg1) {
        field5586++;
        return arg1 >= -34 ? -119 : arg0 >>> 7;
    }

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)I", line = 57)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 77)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(II)Z", line = 104)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(II)Ljava/lang/String;", line = 132)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ldt;II)V", line = 180)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ldt;B)V", line = 288)
