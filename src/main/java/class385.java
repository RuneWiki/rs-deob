...
public class class385 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)Ltp;", line = 7)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/String;BIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)Ltp;", line = 156)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BCI)C", line = 173)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(B)I", line = 257)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)Ltp;", line = 280)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(B)Z", line = 339)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIIII)V", line = 359)
    ...
    @OriginalMember(owner = "client!lc", name = "d", descriptor = "(I)V", line = 387)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "()V", line = 486)
    public class385() {
        this.field5808.field4930 = this.field5808;
        this.field5808.field4929 = this.field5808;
    }

    @OriginalMember(owner = "client!lc", name = "d", descriptor = "(B)Ltp;", line = 415)
    ...
    @OriginalMember(owner = "client!lc", name = "e", descriptor = "(I)V", line = 440)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ltp;B)V", line = 453)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 470)
