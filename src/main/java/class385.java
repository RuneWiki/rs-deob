...
public class class385 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(JB)Lfu;")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lfu;JI)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)Lfu;")
