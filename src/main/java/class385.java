...
public class class385 extends class678 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 61)
