...
public class class632 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(I)V", line = 162)
    public class632(int arg0) {
        this.field8833 = arg0;
    }

    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(IIIIII)V", line = 173)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLsn;)Z", line = 78)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lufa;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(I)Lufa;", line = 144)
