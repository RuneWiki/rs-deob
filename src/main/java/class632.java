...
public class class632 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I[Lf;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/String;[Lf;III)I")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "([Lf;Ljava/lang/String;IB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILjava/lang/String;[Lf;B)I")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/String;I[Lf;[I[Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "([Lf;BLjava/lang/String;)I")
