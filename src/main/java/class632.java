...
public class class632 extends class56 {
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(B)Les;", line = 3)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)[I", line = 26)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BILes;)V", line = 81)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BI)[[I", line = 118)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "([I[ILvk;[IB)V", line = 187)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "()V", line = 310)
    public class632() {
        super(1, false);
    }
}
