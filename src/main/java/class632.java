...
public class class632 extends class385 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!pda", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 45)
    public final void focusGained(FocusEvent arg0) {
        field8835++;
    }

    @OriginalMember(owner = "client!pda", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 53)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!pda", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 119)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method3645(arg0, 1, false);
        field8848++;
    }

    @OriginalMember(owner = "client!pda", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 127)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method3645(arg0, 0, false);
        field8844++;
    }

    @OriginalMember(owner = "client!pda", name = "d", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;IZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(B[Lpga;)V", line = 289)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IB)Z", line = 319)
    ...
    @OriginalMember(owner = "client!pda", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 333)
    public final synchronized void focusLost(FocusEvent arg0) {
        field8853++;
        this.method3647(0, -1, '\u0000', 0);
    }

    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IICI)V", line = 341)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 392)
    public class632(Component arg0) {
        class225.method1521(32259);
        this.method3641(arg0, 26);
    }

    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(I)Loc;", line = 369)
