...
public class class632 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILrv;)V", line = 17)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lrv;B)V", line = 38)
