...
public class class632 extends class120 {
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)[Lvb;", line = 8)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIB)Z", line = 19)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIILha;IILd;)V", line = 41)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lr;III[Z)Z", line = 124)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 161)
