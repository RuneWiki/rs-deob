...
public class class632 extends class111 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lrh;Law;IIIII)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLjagdx/IDirect3DVertexShader;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILqda;IILns;)Ltr;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILjagdx/D3DPRESENT_PARAMETERS;ILjagdx/IDirect3D;I)Z")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLcga;)I")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLns;Lqda;)I")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II[BLqda;II)Lop;")
    ...
    @OriginalMember(owner = "client!mh", name = "d", descriptor = "(II)Lmj;")
    ...
    @OriginalMember(owner = "client!mh", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lwu;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILqt;ZZ)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILku;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "g", descriptor = "(II)Lul;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZII[BLqda;II)Ltr;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lkha;I)I")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ltea;Ltea;FLtea;)Ltea;")
    public final class241 method429(class241 arg0, class241 arg1, float arg2, class241 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lbd;B)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I[IIZIII)Ltr;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILam;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ZIILqt;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "e", descriptor = "(IZ)Lam;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Law;III)V")
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(IZ)Lrh;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;I)V")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/uca;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Ljia;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lwu;I)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Loi;B)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lnc;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILns;Lqda;)Z")
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "()Lkea;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lmj;Lbba;)Lnc;")
    public final class23 method463(class655 arg0, class115 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lqt;I)I")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)Lbba;")
    public final class115 method394(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lld;B)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Law;B)I")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIZLqda;IIB[F)Ltr;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B[Llm;)Lld;")
    public final class171 method899(byte arg0, class502[] arg1) {
        int var3 = -4 / ((arg0 + 66) / 53);
        return new dxVertexLayout(this, arg1);
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lns;Lqda;I)Z")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILaea;)I")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BZ[[II)Lnp;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lch;Z)V")
