...
public abstract class class632 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIIIIIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BII)Z", line = 139)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)V", line = 151)
