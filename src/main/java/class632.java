...
public class class632 extends class608 {
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(I)Ltc;", line = 8)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IC)Z", line = 73)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lnv;IIIIII)V", line = 121)
