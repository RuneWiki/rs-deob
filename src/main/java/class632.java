...
public class class632 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "()V", line = 20)
    public static final void method3677() {
        class480.method2913(1, class487.field7383);
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lps;Luf;ZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZIIIIIIII)Z", line = 137)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(BI)V", line = 168)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 194)
