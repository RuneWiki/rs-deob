...
public class class632 extends class303 {
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lmh;IIIZ[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lmh;IIIIIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILkj;I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lmh;IIII[I)V", line = 218)
    ...
    @OriginalMember(owner = "client!wo", name = "g", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIIIIIIIIB)V", line = 256)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IFI[BIIFFIFIFLtp;I)V", line = 281)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lmh;IIIIZ[BI)V", line = 334)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIIII)V", line = 357)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lmh;IIIII[BI)V", line = 372)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lmh;IIIIIIZ)V", line = 386)
