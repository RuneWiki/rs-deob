...
public class class632 {
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(II)Lud;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZJ[ILhj;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(ILlga;Llga;Llp;)V")
