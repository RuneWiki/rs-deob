...
public class class632 extends class175 {
    ...
    @OriginalMember(owner = "client!raa", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILdt;Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IB)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IIII)I", line = 82)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(I)V", line = 106)
    private class632(int arg0) {
        super(0, false);
        this.method3489((byte) -120, arg0);
    }

    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "()V", line = 114)
    public class632() {
        this(0);
    }

    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BI)V", line = 117)
