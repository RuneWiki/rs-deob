...
public class class632 extends class232 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lhu;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lhu;IIIIIIIIIIIZZ)V")
