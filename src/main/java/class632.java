...
public class class632 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IBIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)V", line = 114)
