...
public class class632 extends class366 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIZB)V", line = 16)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljava/lang/String;[BZI)I", line = 42)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lki;)V", line = 99)
    public class632(class651 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZLtt;)[Ll;", line = 104)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 147)
