...
public class class632 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BF)F", line = 6)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ZII)I", line = 49)
