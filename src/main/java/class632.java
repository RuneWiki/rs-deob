...
public class class632 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BIIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)Z", line = 23)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZLha;)V", line = 42)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(B)V", line = 148)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(B)V", line = 159)
