...
public class class632 extends class349 {
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!ms", name = "f", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IB)[[I", line = 90)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "()V", line = 134)
    public class632() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(BI)[I", line = 140)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILdga;)V", line = 173)
