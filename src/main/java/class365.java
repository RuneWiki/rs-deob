...
public class class365 extends class305 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IB)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(CB)B", line = 63)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "()V", line = 189)
    public class365() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILfh;B)V", line = 198)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)[I", line = 233)
    ...
    @OriginalMember(owner = "client!ph", name = "e", descriptor = "(B)V", line = 282)
    public static void method2329(byte arg0) {
        field5379 = null;
        int var1 = -68 % ((-82 - arg0) / 37);
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 293)
