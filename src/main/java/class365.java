...
public class class365 extends class316 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(BLmda;)V", line = 50)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(ILso;)V", line = 62)
