...
public class class365 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IBI)Z", line = 22)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IIIII)Z", line = 36)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(III)V", line = 193)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)[[I", line = 94)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(II)[I", line = 118)
