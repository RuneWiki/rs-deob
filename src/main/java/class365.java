...
public class class365 extends Exception {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IB[B)I", line = 9)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 51)
