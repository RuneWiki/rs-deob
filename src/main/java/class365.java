...
public class class365 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIIIILjava/awt/Frame;)V", line = 5)
    ...
    @OriginalMember(owner = "client!br", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 26)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZLjava/awt/Frame;)V", line = 42)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "()V", line = 52)
    public class365() {
        this.field4945.initialize(null);
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)[I", line = 61)
