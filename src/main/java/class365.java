...
public abstract class class365 implements class215 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZBLjaggl/MapBuffer;)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Ljaggl/MapBuffer;Z)Z")
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lno;IZ)V")
