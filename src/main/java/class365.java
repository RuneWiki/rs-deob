...
public class class365 extends class508 {
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(J)V", line = 101)
    public class365(long arg0) {
        this.field4698 = arg0;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BII)Z", line = 112)
