...
public class class365 implements Runnable {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILvaa;)V", line = 8)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILmda;I)Lqda;", line = 41)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "([BILmda;I)Lqda;", line = 58)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lvc;)V", line = 210)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!bc", name = "run", descriptor = "()V", line = 100)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lqda;I)V", line = 145)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IILmda;)Lqda;", line = 162)
