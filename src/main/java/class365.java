...
public class class365 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Loo;I)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lic;I)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lic;)V")
