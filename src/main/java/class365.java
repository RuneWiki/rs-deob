...
public class class365 extends class299 {
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(ILes;)V")
    public class365(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Les;)V")
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(BLrba;Lrba;)V")
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Lha;Ljc;I)I")
