...
public class class365 {
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)Ljt;")
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)Ljt;")
    ...
    @OriginalMember(owner = "client!um", name = "f", descriptor = "(I)Ljt;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)Ljt;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)Lah;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljt;I)V")
