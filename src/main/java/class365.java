...
public class class365 extends class436 {
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!te", name = "f", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILlh;)V", line = 59)
    ...
    @OriginalMember(owner = "client!te", name = "g", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIII)Z", line = 120)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "()V", line = 308)
    public class365() {
        super(1, false);
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(II)[I", line = 314)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIZII)V", line = 348)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ZII)V", line = 370)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IILeb;)V", line = 449)
