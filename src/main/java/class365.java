...
public class class365 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljava/lang/String;Lnp;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IZ)Lqp;", line = 72)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lqh;IZLtf;Ltf;)V", line = 255)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(IZ)V", line = 182)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(II)V", line = 219)
