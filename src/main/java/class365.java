...
public class class365 extends class269 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)Lve;")
    public final class527 method606(int arg0) {
        field5273++;
        return arg0 == 0 ? class681.field9674 : null;
    }

    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lfda;Laba;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IILli;IIII)V")
