...
public class class365 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)Ls;", line = 101)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)V", line = 133)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lgp;ILui;Lui;)V", line = 164)
