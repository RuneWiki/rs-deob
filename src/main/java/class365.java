...
public class class365 extends class59 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(CIIIZLaa;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!bc", name = "fa", descriptor = "(CIIIZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lnv;Lur;[Lg;Z)V", line = 72)
