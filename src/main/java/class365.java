...
public class class365 extends class498 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Loi;II)Lfo;", line = 7)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "()V", line = 120)
    public final void method2158() {
        this.field5215 = null;
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lwm;)V", line = 126)
