...
public class class365 extends class508 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIB)V", line = 16)
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BII)V", line = 66)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIILjava/lang/Class;)Lns;", line = 156)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(IIIIIF)V", line = 180)
    ...
    @OriginalMember(owner = "client!sf", name = "e", descriptor = "(I)V", line = 198)
