...
public class class365 extends class369 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)V", line = 26)
    ...
    @OriginalMember(owner = "client!uv", name = "e", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lud;BI)V", line = 54)
    ...
    @OriginalMember(owner = "client!uv", name = "f", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lqo;)V", line = 100)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZB)V", line = 138)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZIZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIB)V", line = 218)
