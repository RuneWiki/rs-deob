...
public class class365 extends class188 {
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lai;)V")
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(II)Leja;")
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IBLbm;)V")
