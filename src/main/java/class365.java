...
public class class365 extends class336 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BLmr;)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lhc;IIII)V")
    ...
    @OriginalMember(owner = "client!k", name = "d", descriptor = "(I)Llm;")
