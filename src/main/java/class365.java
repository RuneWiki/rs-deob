...
public class class365 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lda;)V", line = 86)
    public class365(class423 arg0) {
        this.field5177 = arg0;
    }

    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lda;Ltba;)V", line = 93)
    public class365(class423 arg0, class56 arg1) {
        this.field5177 = arg0;
        this.field5173 = arg1;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZI)V", line = 68)
