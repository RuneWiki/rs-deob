...
public class class365 extends class213 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "([Ljava/lang/String;B)[Ljava/lang/String;", line = 13)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ILmv;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lod;I)V", line = 227)
    public class365(class349 arg0, int arg1) {
        this.field5580 = arg0;
        this.field5582 = new class374(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(FILrc;Lrc;)Z", line = 236)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(B)Lrc;", line = 367)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)V", line = 378)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(I)I", line = 389)
