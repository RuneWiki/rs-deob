...
public class class365 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BI)Lvq;", line = 6)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIIII)I", line = 171)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(BI)V", line = 186)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "([J[Ljava/lang/Object;III)V", line = 208)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 279)
