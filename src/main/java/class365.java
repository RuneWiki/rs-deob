...
public class class365 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBLnc;IILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lnc;IILha;BZILs;IILs;II)Lka;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIILha;Ls;IZBLnc;IILs;I)Lka;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lsl;Z)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIBILnc;Lha;)Lka;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BILsl;)V")
