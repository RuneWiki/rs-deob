...
public abstract class class365 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILtq;II)Lth;", line = 4)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(I)V", line = 54)
