...
public class class365 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IILha;)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZIZII)Llt;")
