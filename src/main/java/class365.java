...
public class class365 extends class212 {
    ...
    @OriginalMember(owner = "client!qt", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(CI)B", line = 17)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIIIII)V", line = 142)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)V", line = 193)
