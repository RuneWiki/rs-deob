...
public class class365 extends class258 {
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(II)Ljava/lang/String;", line = 67)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ILkm;)V", line = 100)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BLmc;)V", line = 161)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lim;B)V", line = 171)
