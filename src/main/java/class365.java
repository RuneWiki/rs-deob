...
public class class365 extends class260 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLya;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lmg;Lmg;Lmg;ZLmg;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lba;III[Z)V")
