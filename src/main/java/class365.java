...
public abstract class class365 extends class47 {
    ...
    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lra;IZZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!rg", name = "g", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(I)V", line = 114)
