...
public abstract class class365 extends class443 {
    ...
    @OriginalMember(owner = "client!t", name = "e", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII)Lke;", line = 33)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lbc;)V", line = 52)
