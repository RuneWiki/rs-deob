...
public class class365 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BILwu;Lwu;)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLvj;)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILvj;I)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILjk;IILha;Lgfa;)Z")
