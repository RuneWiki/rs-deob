...
public class class365 extends class118 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ZB)V", line = 15)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lbaa;IB)V", line = 36)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILno;)V", line = 51)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IBI)V", line = 140)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Los;Lkm;)V", line = 216)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BZ)V", line = 251)
