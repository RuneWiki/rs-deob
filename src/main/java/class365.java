...
public class class365 implements class691 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILaaa;I)V")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILhw;II)V")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIILhw;)V")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILaaa;II)V")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BILis;)V")
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lac;)V")
