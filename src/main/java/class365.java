...
public class class365 extends class309 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILim;Lim;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "()Z", line = 153)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "()I", line = 181)
    public final int method1989() {
        return 1;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)V", line = 185)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Ltb;)V", line = 252)
    public class365(class227 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ji", name = "b", descriptor = "()Z", line = 256)
    public final boolean method1990() {
        return this.field5142 != null;
    }

    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "()V", line = 270)
    ...
    @OriginalMember(owner = "client!ji", name = "e", descriptor = "()Z", line = 296)
