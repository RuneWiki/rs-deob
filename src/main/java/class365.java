...
public class class365 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILao;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BB)C", line = 16)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILha;ZZB)Lka;", line = 59)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ZI)V", line = 193)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)I", line = 208)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIZI)V", line = 224)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lha;Lfw;IIIILrfa;ZI)V", line = 473)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(ILha;)V", line = 309)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILha;)V", line = 321)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILka;IIILha;ZILqa;)V", line = 339)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLrfa;)V", line = 379)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)I", line = 422)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)V", line = 432)
    ...
    @OriginalMember(owner = "client!mu", name = "finalize", descriptor = "()V", line = 451)
