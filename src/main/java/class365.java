...
public class class365 extends class344 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "([III)V", line = 7)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "()Lcb;", line = 47)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IILd;[III)V", line = 67)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "()I", line = 128)
    public final int method644() {
        field5485++;
        return 0;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IZLd;)V", line = 136)
    ...
    @OriginalMember(owner = "client!nd", name = "d", descriptor = "()Lcb;", line = 176)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lbk;)V", line = 241)
    public class365(class242 arg0) {
        this.field5492 = arg0;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 200)
