...
public class class365 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "()V", line = 4)
    public static final void method2237() {
        class119.method726(1, class87.field1079);
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILjava/lang/String;)V", line = 25)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IBI)Ljava/lang/String;", line = 41)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([[BZLm;)V", line = 82)
