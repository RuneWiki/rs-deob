...
public class class365 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "([III)V", line = 8)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "()V", line = 58)
    private static final void method2237() {
        field5014 = 0;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "()V", line = 140)
    public static void method2239() {
        field5015 = null;
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lea;[II)V", line = 146)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lea;[II[I[I)V", line = 149)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(II)V", line = 235)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lea;[IIII[I[I)V", line = 284)
