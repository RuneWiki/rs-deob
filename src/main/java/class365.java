...
public class class365 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lgga;Z)I", line = 17)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(B)Lgs;", line = 73)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "([BII)I", line = 100)
    ...
    @OriginalMember(owner = "client!hca", name = "d", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)Lgs;", line = 133)
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "()V", line = 201)
    public class365() {
        this.field4717.field4989 = this.field4717;
        this.field4717.field4988 = this.field4717;
    }

    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)Lgs;", line = 160)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(I)Lgs;", line = 179)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BLgs;)V", line = 210)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IB)V", line = 230)
