...
public class class365 extends class56 implements class269 {
    ...
    @OriginalMember(owner = "client!rba", name = "M", descriptor = "Lso;")
    private class398 field4802;

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lqa;Z)V")
    public final void method341(class206 arg0, boolean arg1) {
        ++field4791;
        this.field4803.method3669(arg0, 262144);
        if (arg1) {
            this.method332(33);
        }
    }

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILqa;Z)Lr;")
    public final class157 method335(int arg0, class206 arg1, boolean arg2) {
        if (!arg2) {
            field4789 = null;
        }
        ++field4794;
        return this.field4803.method3668(false, false, arg0, 0, arg1, 0, -3);
    }

    @OriginalMember(owner = "client!rba", name = "f", descriptor = "(I)I")
    public final int method315(int arg0) {
        ++field4793;
        return arg0 != 0 ? -5 : this.field4803.method3671(-29019);
    }

    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(ILqa;)Lso;")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILqa;)V")
    public final void method326(int arg0, class206 arg1) {
        ++field4805;
        if (arg0 == 29657) {
            class157 var3 = this.field4803.method3668(false, true, 262144, super.field491, arg1, super.field488, -3);
            if (var3 != null) {
                int var4 = super.field488 >> 7;
                int var5 = super.field491 >> 7;
                this.field4803.method3674(var4, var3, arg0 ^ 25216, arg1, var5, false, var5, var4);
            }
        }
    }

    @OriginalMember(owner = "client!rba", name = "g", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(BIIII)V")
    public static final void method2044(byte arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 < -22) {
            if (~(arg1 - arg2) <= ~class470.field6589 && ~(arg1 + arg2) >= ~class592.field8588 && arg4 - arg2 >= class563.field8282 && ~(arg4 - -arg2) >= ~class271.field3513) {
                class625.method3576(arg2, -113, arg4, arg1, arg3);
            } else {
                class516.method2956(arg1, arg4, arg3, 124, arg2);
            }
            ++field4797;
        }
    }
    ...
    public final int method342(int arg0) {
        ...
        ++field4798;
        return this.field4803.field9237;
    }
    ...
    public final int method337(boolean arg0) {
        ...
        ++field4800;
        return this.field4803.field9228;
    }

    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lqa;Lcn;IIIIIZIIIIII)V")
    public class365(class206 arg0, class437 arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        super(arg4, arg5, arg6, arg8, arg9, arg10, class143.method785(arg12, arg11, (byte) -93));
        this.field4803 = new class640(arg0, arg1, arg11, arg12, arg2, arg3, arg4, arg6, arg7, arg13);
        this.field4801 = ~arg1.field5972 != -1 && !arg7;
    }

    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(B)V")
    public final void method339(byte arg0) {
        if (arg0 >= -114) {
            method2044((byte) 60, 37, 52, 48, 114);
        }
        ++field4796;
    }

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZLqa;)V")
    public final void method336(boolean arg0, class206 arg1) {
        this.field4803.method3677(arg0, arg1);
        ++field4792;
    }
    ...
    public final boolean method332(int arg0) {
        ++field4788;
        int var2 = 67 % ((arg0 - 1) / 49);
        return this.field4803.method3675(false);
    }

    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(ILqa;)Loj;")
    public final class318 method320(int arg0, class206 arg1) {
        ++field4786;
        class157 var3 = this.field4803.method3668(false, true, 2048, super.field491, arg1, super.field488, arg0 + -2);
        if (var3 == null) {
            return null;
        } else {
            class163 var4 = arg1.method1126();
            var4.method661(super.field488 - -super.field487, super.field483, super.field494 + super.field491);
            class318 var5 = null;
            if (this.field4801) {
                var5 = class143.method788(0, 1);
            }
            if (this.field4803.field9229 == null) {
                var3.method69(var4, var5 == null ? null : var5.field4059[0], 0);
            } else {
                class400 var6 = this.field4803.field9229.method2650();
                arg1.method1177(var3, var6, var4, var5 == null ? null : var5.field4059[0], 0);
            }
            if (this.field4802 == null) {
                this.field4802 = class533.method3049(super.field483, super.field488, (byte) 97, var3, super.field491);
            } else {
                class642.method3698(super.field483, this.field4802, super.field491, var3, (byte) 117, super.field488);
            }
            int var7 = super.field488 >> 7;
            int var8 = super.field491 >> 7;
            this.field4803.method3674(var7, var3, 4441, arg1, var8, true, var8, var7);
            if (arg0 != -1) {
                this.method341((class206) null, true);
            }
            return var5;
        }
    }

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILqa;II)Z")
    public final boolean method318(int arg0, class206 arg1, int arg2, int arg3) {
        ++field4790;
        class157 var5 = this.field4803.method3668(false, false, 131072, super.field491, arg1, super.field488, -3);
        if (var5 == null) {
            return false;
        } else {
            ...
            var6.method661(super.field488 + super.field487, super.field483, super.field494 + super.field491);
    ...
    public final int method333(byte arg0) {
        if (arg0 != 70) {
            ...
            ++field4787;
            return this.field4803.field9207;
        }
    }
}
