...
public class class365 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "([I[I[I[[F)V", line = 54)
