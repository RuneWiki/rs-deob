...
public class class365 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BC)V", line = 4)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;)V", line = 20)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lpg;I)V", line = 96)
