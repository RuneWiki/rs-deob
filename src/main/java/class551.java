...
public class class551 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Loa;IIIILgba;IILfa;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BI)Lcr;", line = 163)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 199)
