...
public class class551 extends class755 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLib;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BII)Z", line = 28)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILwca;)V", line = 124)
