...
public class class551 extends class293 implements class289 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!vq", name = "h", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(ILoa;)V", line = 53)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Loa;B)Llt;", line = 64)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLoa;)Lvg;", line = 107)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(BLoa;)V", line = 119)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Loa;Luca;IIIIIZIIIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIILoa;)Z", line = 159)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)I", line = 183)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)I", line = 199)
    ...
    @OriginalMember(owner = "client!vq", name = "f", descriptor = "(I)I", line = 210)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ILoa;)V", line = 221)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)I", line = 234)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V", line = 250)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IILoa;)Lba;", line = 263)
