...
public class class551 extends class222 {
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Ljn;Lko;)V", line = 4)
    public class551(class668 arg0, class468 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BZ)V", line = 22)
