...
public class class551 extends class159 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLdha;)V", line = 7)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 99)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Ldt;)V", line = 333)
    public class551(class254 arg0) {
        this.method3171(false, arg0);
    }

    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)[I", line = 127)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II)V", line = 156)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(II)V", line = 171)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZLdt;)V", line = 196)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(II)V", line = 252)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIIIII)V", line = 283)
