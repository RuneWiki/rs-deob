...
public class class551 extends class215 implements class128 {
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(I)I", line = 3)
    public final int method960(int arg0) {
        ++field7692;
        return arg0 != -21047 ? 18 : 0;
    }

    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z)J", line = 30)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II)I", line = 43)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II[BB)V", line = 143)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lbi;I[BI)V", line = 156)
    public class551(class483 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field7695 = arg1;
    }

    @OriginalMember(owner = "client!gh", name = "d", descriptor = "(I)Liu;", line = 167)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lbi;ILjaclib/memory/Buffer;)V", line = 201)
