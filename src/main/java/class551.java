...
public class class551 extends class252 {
    ...
    @OriginalMember(owner = "client!rj", name = "g", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(ZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lbb;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!rj", name = "f", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(III)V", line = 136)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(I)Z", line = 181)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Ltb;Lpu;Luk;)V", line = 193)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)V", line = 210)
