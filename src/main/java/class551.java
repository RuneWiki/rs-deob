...
public class class551 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IIIIILsea;)Ltr;", line = 4)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BI)Lpc;", line = 84)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IB)V", line = 115)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Lmp;ILla;)V", line = 133)
    public class551(class315 arg0, int arg1, class423 arg2) {
        this.field8038 = arg2;
        this.field8038.method2616(29, 0);
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z)V", line = 148)
