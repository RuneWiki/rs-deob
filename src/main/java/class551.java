...
public class class551 extends class454 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!td", name = "h", descriptor = "(I)[Lmp;", line = 53)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 64)
    public class551(String arg0) {
        this.field7652 = arg0;
        this.field7645 = new class30();
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ZLm;)Z", line = 73)
    ...
    @OriginalMember(owner = "client!td", name = "i", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lm;I)Z", line = 115)
