...
public class class551 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)Lg;", line = 163)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 187)
