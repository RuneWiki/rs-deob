...
public class class551 extends class348 {
    ...
    @OriginalMember(owner = "client!eka", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eka", name = "c", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!eka", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(I)Ldm;", line = 96)
