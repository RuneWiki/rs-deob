...
public class class551 implements class617 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIB)I", line = 37)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIIB)V", line = 53)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 69)
    public static void method3176(int arg0) {
        field7593 = null;
        int var1 = -13 / ((arg0 - 57) / 47);
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lin;Lvr;)V", line = 99)
