...
public class class551 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ILlba;)V", line = 63)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(B)Llba;", line = 81)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(I)V", line = 99)
    public class551(int arg0) {
        this.field7856 = arg0;
    }

    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(IIIIII)V", line = 106)
