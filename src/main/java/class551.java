...
public class class551 extends class60 {
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(ILhd;)V", line = 18)
    public class551(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZIBZLjava/lang/String;Ljava/lang/String;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)Z", line = 175)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)I", line = 186)
    public final int method405(boolean arg0) {
        ++field7659;
        return arg0 ? 25 : 1;
    }

    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lhd;)V", line = 200)
