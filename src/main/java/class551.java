...
public class class551 extends class263 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "()V", line = 7)
    public final void method2945() {
        this.field6910 = null;
    }

    @OriginalMember(owner = "client!ia", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lpfa;II)Lia;", line = 120)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lji;)V", line = 126)
