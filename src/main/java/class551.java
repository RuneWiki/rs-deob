...
public class class551 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIIIIIIIZI)V", line = 10)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ZII)Z", line = 69)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIII)Z", line = 81)
