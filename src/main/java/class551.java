...
public class class551 {
    ...
    @OriginalMember(owner = "client!cba", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lrda;JI)V", line = 34)
