...
public class class551 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILqh;)Z")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BLqh;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILqi;Lks;II)V")
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lqj;)V")
