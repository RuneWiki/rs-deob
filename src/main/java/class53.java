...
public class class53 {
    ...
    @OriginalMember(owner = "client!UFJMYAXC", name = "d", descriptor = "[LUFJMYAXC;")
    public static class53[] field1444;

    @OriginalMember(owner = "client!UFJMYAXC", name = "a", descriptor = "(ILQDHHNYHL;)V")
    ...
    @OriginalMember(owner = "client!UFJMYAXC", name = "a", descriptor = "(LPGNBHFUF;I)V")
