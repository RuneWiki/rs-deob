...
public class class53 extends class235 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BLil;)V", line = 10)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BII)I", line = 56)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(II)I", line = 88)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lil;IB)V", line = 273)
    ...
    @OriginalMember(owner = "client!ie", name = "e", descriptor = "(Z)V", line = 340)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([IILil;)V", line = 361)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lil;I)Ljava/lang/String;", line = 392)
    ...
    @OriginalMember(owner = "client!ie", name = "e", descriptor = "(I)Ljava/lang/String;", line = 421)
