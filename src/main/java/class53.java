...
public abstract class class53 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!gv", name = "providesignlink", descriptor = "(Lqn;)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZLts;B)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZLhe;)V")
