...
public class class53 extends class518 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILjc;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 178)
    public class53() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nq", name = "d", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "([Lrfa;II)V", line = 181)
