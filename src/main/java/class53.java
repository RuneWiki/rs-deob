...
public class class53 extends class50 implements class612 {
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lad;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lad;Ljb;Lqda;II)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIILjb;II[FI)V")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lad;Ljb;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lad;Ljb;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "([BIIIIIIILjb;)V")
