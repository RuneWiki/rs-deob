...
public class class53 extends class382 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "()Lip;", line = 5)
    public final class502 method490() {
        return this.field1135;
    }

    @OriginalMember(owner = "client!oi", name = "b", descriptor = "()V", line = 8)
    public static void method491() {
        field1125 = null;
        field1123 = null;
    }

    @OriginalMember(owner = "client!oi", name = "c", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lza;J)Z", line = 45)
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "()V", line = 93)
    public final void method495() {
        this.field1137 = true;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(J)V", line = 97)
    public final void method496(long arg0) {
        this.field1130 = arg0;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lza;[Lfi;Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "([Lkh;Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!oi", name = "e", descriptor = "()V", line = 268)
    public final void method499() {
        this.field1126 = true;
    }

    @OriginalMember(owner = "client!oi", name = "f", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lza;J[Lfi;[Lkh;Z)V", line = 286)
    ...
    @OriginalMember(owner = "client!oi", name = "g", descriptor = "()V", line = 301)
