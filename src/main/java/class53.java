...
public class class53 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILr;IIIZLea;I)Lf;")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(II)Llo;")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILr;IZLla;ILea;ZBLr;II)Lf;")
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lqh;IZLhda;Ltf;Ltf;)V")
