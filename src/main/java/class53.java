...
public class class53 extends class435 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIIBIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 242)
    public class53() {
    }

    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 244)
