...
public class class53 {
    ...
    @OriginalMember(owner = "client!QCXYCZNF", name = "o", descriptor = "LLNMFPXZK;")
    private class38 field1146;

    @OriginalMember(owner = "client!QCXYCZNF", name = "b", descriptor = "LSSKEPHYP;")
    private class60 field1133;

    @OriginalMember(owner = "client!QCXYCZNF", name = "c", descriptor = "LSSKEPHYP;")
    private class60 field1134;

    @OriginalMember(owner = "client!QCXYCZNF", name = "d", descriptor = "LSSKEPHYP;")
    private class60 field1135;

    @OriginalMember(owner = "client!QCXYCZNF", name = "e", descriptor = "LSSKEPHYP;")
    private class60 field1136;

    @OriginalMember(owner = "client!QCXYCZNF", name = "f", descriptor = "LSSKEPHYP;")
    private class60 field1137;

    @OriginalMember(owner = "client!QCXYCZNF", name = "g", descriptor = "LSSKEPHYP;")
    private class60 field1138;

    @OriginalMember(owner = "client!QCXYCZNF", name = "h", descriptor = "LSSKEPHYP;")
    private class60 field1139;

    @OriginalMember(owner = "client!QCXYCZNF", name = "i", descriptor = "LSSKEPHYP;")
    private class60 field1140;

    @OriginalMember(owner = "client!QCXYCZNF", name = "p", descriptor = "LSSKEPHYP;")
    ...
    @OriginalMember(owner = "client!QCXYCZNF", name = "a", descriptor = "(LJHKSAGUC;I)V")
