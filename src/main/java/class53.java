...
public class class53 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lge;[Lhc;)Lie;", line = 11)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lge;I[Lhc;)V", line = 70)
    private class53(class104 arg0, int arg1, class366[] arg2) {
        this.field862 = arg0;
        this.field861 = arg1;
    }

    @OriginalMember(owner = "client!ie", name = "finalize", descriptor = "()V", line = 77)
