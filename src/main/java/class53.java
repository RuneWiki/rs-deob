...
public class class53 extends class71 {
    ...
    @OriginalMember(owner = "client!QAJCAYDZ", name = "Gb", descriptor = "LAKUDQPZE;")
    ...
    @OriginalMember(owner = "client!QAJCAYDZ", name = "Rb", descriptor = "LAUWOQLEO;")
    public class2 field1465;

    @OriginalMember(owner = "client!QAJCAYDZ", name = "Kb", descriptor = "LIGXVZOHI;")
    public class32 field1458;

    @OriginalMember(owner = "client!QAJCAYDZ", name = "Ob", descriptor = "Ljava/lang/String;")
    public String field1462;

    @OriginalMember(owner = "client!QAJCAYDZ", name = "c", descriptor = "(I)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!QAJCAYDZ", name = "a", descriptor = "(I)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!QAJCAYDZ", name = "a", descriptor = "(B)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!QAJCAYDZ", name = "a", descriptor = "(LEGCCHUZS;I)V")
