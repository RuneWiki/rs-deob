...
public class class53 extends class27 implements Runnable {
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "a", descriptor = "LPILILDKN;")
    private class38 field1365 = new class38(false);

    @OriginalMember(owner = "client!TDBJVJCU", name = "d", descriptor = "LPILILDKN;")
    private class38 field1368 = new class38(false);

    @OriginalMember(owner = "client!TDBJVJCU", name = "f", descriptor = "LPILILDKN;")
    private class38 field1370 = new class38(false);

    @OriginalMember(owner = "client!TDBJVJCU", name = "k", descriptor = "LVHKTMNAT;")
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "I", descriptor = "LPILILDKN;")
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "U", descriptor = "LPILILDKN;")
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "r", descriptor = "LKRPFBUJX;")
    private class33 field1382;

    @OriginalMember(owner = "client!TDBJVJCU", name = "E", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "a", descriptor = "(LBYZSQZUF;Lclient;)V")
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "a", descriptor = "(LKRPFBUJX;I)V")
    ...
    @OriginalMember(owner = "client!TDBJVJCU", name = "c", descriptor = "()LKRPFBUJX;")
