...
public class class53 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IILfo;)V")
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(II)Lnm;")
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Llo;IZLnl;Lnl;)V")
