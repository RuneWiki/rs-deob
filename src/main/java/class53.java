...
public class class53 extends class523 {
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(Lr;I)Lifa;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILr;I)Z")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILr;ILcaa;ZII)V")
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lr;I)Lhr;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lrda;B)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIZLr;)Z")
    ...
    @OriginalMember(owner = "client!u", name = "h", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lr;II)Lfo;")
