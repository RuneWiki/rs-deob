...
@OriginalClass("client!SMAWMDZY")
public class class53 extends class70 {

    @OriginalMember(owner = "client!SMAWMDZY", name = "j", descriptor = "I")
    public int field1340 = 1000;

    @OriginalMember(owner = "client!SMAWMDZY", name = "k", descriptor = "Z")
    public static boolean field1341;

    @OriginalMember(owner = "client!SMAWMDZY", name = "i", descriptor = "[LDATOXFLB;")
    public class10[] field1339;

    @OriginalMember(owner = "client!SMAWMDZY", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!SMAWMDZY", name = "a", descriptor = "(Z)LITSMSHJO;")
