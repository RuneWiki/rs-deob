...
public class class53 extends class15 {
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lgp;Lbt;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lg;IIBZI)V", line = 64)
