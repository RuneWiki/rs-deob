...
public class class53 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Leh;Z)V")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Ljw;)V")
