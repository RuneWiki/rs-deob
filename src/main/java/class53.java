...
public class class53 extends class508 {
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)I", line = 22)
    public static int method369(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IFLhg;Lhg;)Z", line = 47)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(I)I", line = 242)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lih;I)V", line = 253)
    public class53(class214 arg0, int arg1) {
        this.field850 = arg0;
        this.field851 = new class358(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)Lhg;", line = 263)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 275)
