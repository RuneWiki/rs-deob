...
public class class53 implements class16 {
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(II)Let;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(III)Lmm;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BI)Lmk;")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lci;Lci;Lci;)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lrg;I)Z")
