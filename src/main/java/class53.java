...
public class class53 extends class2 {
    ...
    @OriginalMember(owner = "client!SIDDBHEA", name = "w", descriptor = "LOXBPHQKK;")
    ...
    @OriginalMember(owner = "client!SIDDBHEA", name = "x", descriptor = "Lclient;")
    public static client field1505;

    @OriginalMember(owner = "client!SIDDBHEA", name = "a", descriptor = "(I)LJLNSJQDR;")
    ...
    @OriginalMember(owner = "client!SIDDBHEA", name = "b", descriptor = "(I)LKZRNPNVL;")
