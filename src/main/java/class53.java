...
public class class53 extends class128 {
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lpg;IIII[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lpg;IIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IBIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 70)
