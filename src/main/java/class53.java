...
public class class53 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ILqa;ZI)Laa;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IILnj;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lnj;I)V")
