...
@OriginalClass("client!RZUUVVSJ")
public class class53 {

    @OriginalMember(owner = "client!RZUUVVSJ", name = "a", descriptor = "I")
    private int field1383 = -10491;

    @OriginalMember(owner = "client!RZUUVVSJ", name = "b", descriptor = "I")
    private int field1384 = 2;

    @OriginalMember(owner = "client!RZUUVVSJ", name = "c", descriptor = "I")
    private int field1385;

    @OriginalMember(owner = "client!RZUUVVSJ", name = "d", descriptor = "[LOEHUIBBM;")
    private class37[] field1386;

    @OriginalMember(owner = "client!RZUUVVSJ", name = "<init>", descriptor = "(IB)V")
    ...
    @OriginalMember(owner = "client!RZUUVVSJ", name = "a", descriptor = "(J)LOEHUIBBM;")
    ...
    @OriginalMember(owner = "client!RZUUVVSJ", name = "a", descriptor = "(LOEHUIBBM;JZ)V")
