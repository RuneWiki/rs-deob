...
public abstract class class53 extends class383 {
    ...
    @OriginalMember(owner = "client!u", name = "e", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IZIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZIIIII)V", line = 101)
