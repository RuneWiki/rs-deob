...
public class class53 extends class418 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(II)V", line = 102)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(II)V", line = 131)
