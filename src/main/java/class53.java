...
public class class53 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lio;Z)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lio;II)V")
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)Lfea;")
