...
public class class53 extends class475 implements class784 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lmq;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lmfa;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgka;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(IIIIII)Lvr;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Llf;Ljk;)Lrs;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lrs;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgka;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgka;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Ldm;")
    public final class765 method457() {
        return this.field757;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvr;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lmq;")
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Lev;")
    public final class165 method108() {
        return new class165(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Ldm;")
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)Ljk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lde;Z)Lmq;")
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Ldm;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lrt;[Lde;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lmq;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lmfa;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lida;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Llf;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvr;Lvr;FLvr;)Lvr;")
