...
public class class53 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lao;Lgm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lao;I)V", line = 236)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lao;)V", line = 580)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(Lao;)V", line = 592)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(Lao;)V", line = 612)
