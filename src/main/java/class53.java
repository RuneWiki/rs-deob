...
public class class53 extends class629 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)Lhr;", line = 15)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Leda;Lcga;IIIIIIIIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(BZ)V", line = 49)
