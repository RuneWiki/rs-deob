...
public class class53 {
    ...
    @OriginalMember(owner = "client!gda", name = "toString", descriptor = "()Ljava/lang/String;")
    public final String toString() {
        field603++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ZLsi;)I")
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(II)V")
