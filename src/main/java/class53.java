...
public class class53 extends class194 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IILbg;)V", line = 6)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)[I", line = 23)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)[[I", line = 75)
    ...
    @OriginalMember(owner = "client!mq", name = "h", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "()V", line = 175)
    public class53() {
        super(3, false);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZLnh;Ljava/awt/Frame;)V", line = 182)
