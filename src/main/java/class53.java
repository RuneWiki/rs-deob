...
public class class53 extends class74 {
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZZ)V", line = 35)
    public final void method339(boolean arg0, boolean arg1) {
        this.field1011.method2550(class542.field7243, arg0, class88.field1235);
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIB)V", line = 43)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IILhfa;)V", line = 68)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lgaa;Lpl;Lbd;)V", line = 98)
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)Z", line = 164)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IZ)V", line = 175)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 193)
