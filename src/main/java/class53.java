...
public class class53 extends class108 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lgp;II)Lts;", line = 5)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lco;)V", line = 126)
