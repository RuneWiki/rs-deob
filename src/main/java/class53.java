...
public class class53 extends class239 {
    ...
    @OriginalMember(owner = "client!rn", name = "g", descriptor = "(I)[B", line = 8)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lfc;B)I", line = 27)
    ...
    @OriginalMember(owner = "client!rn", name = "h", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(B)I", line = 114)
