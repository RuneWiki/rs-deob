...
public class class53 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IB)[I", line = 67)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(III)V", line = 149)
