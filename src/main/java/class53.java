...
public class class53 extends class512 implements class401 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lya;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZIIIIFII)[[I", line = 13)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILya;B)Lt;", line = 48)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lya;Lpf;IIIIZIIZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Lya;I)Lmo;", line = 117)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lya;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILya;I)Lt;", line = 172)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLya;)V", line = 182)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!cl", name = "g", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 269)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BI)V", line = 297)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)I", line = 310)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)Z", line = 321)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)I", line = 332)
    public final int method240(int arg0) {
        ++field680;
        return arg0 != -15578 ? -44 : 65535 & this.field705;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILya;IZ)Lro;", line = 355)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILya;II)Z", line = 382)
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(I)Z", line = 407)
