...
public class class53 extends class267 implements class423 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Los;Z)Lhk;", line = 3)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BI)I", line = 32)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Ltm;IZ[[I)V", line = 67)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[[I)V", line = 111)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIIZII)V", line = 122)
