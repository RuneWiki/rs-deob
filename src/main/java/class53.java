...
public class class53 extends class551 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([IIIII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I[IIB)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIII[FFFIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 115)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 341)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BII)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(JI)V", line = 159)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([IIII)Z", line = 262)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 290)
