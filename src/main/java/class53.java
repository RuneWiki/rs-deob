...
public class class53 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BI)Lhr;", line = 8)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lgj;Le;)V", line = 81)
    public class53(class580 arg0, class489 arg1) {
        this.field754 = arg0;
        this.field753 = arg1;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Loa;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 116)
