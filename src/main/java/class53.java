...
public class class53 extends class23 {
    ...
    @OriginalMember(owner = "client!lp", name = "na", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lp", name = "E", descriptor = "(III[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!lp", name = "ZA", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!lp", name = "O", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!lp", name = "ba", descriptor = "(Lia;)V", line = 44)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(III[I)V", line = 61)
    ...
    @OriginalMember(owner = "client!lp", name = "R", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!lp", name = "Q", descriptor = "(IIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!lp", name = "ma", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "()Lia;", line = 120)
    ...
    @OriginalMember(owner = "client!lp", name = "HA", descriptor = "()V", line = 136)
    ...
    @OriginalMember(owner = "client!lp", name = "X", descriptor = "([I)V", line = 141)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!lp", name = "YA", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "()V", line = 182)
    public class53() {
        this.method189();
    }
}
