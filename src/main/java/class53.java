...
public class class53 implements class153 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BI)I", line = 32)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IZ)I", line = 56)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BZ)I", line = 115)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(III)V", line = 219)
