...
public abstract class class53 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFIILpa;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFIILpa;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFIIIII)V", line = 62)
