...
public class class53 extends class130 {
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(I)V", line = 263)
    public class53(int arg0) {
        this.field824 = arg0;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZILuu;)V", line = 44)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 67)
