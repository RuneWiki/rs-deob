...
public class class53 extends class619 {
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "()V", line = 5)
    public class53() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(BII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIZ)[B", line = 19)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BII)V", line = 214)
