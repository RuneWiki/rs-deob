...
@OriginalClass("client!SCUTTCOF")
public class class53 {

    @OriginalMember(owner = "client!SCUTTCOF", name = "a", descriptor = "LVOREJVXS;")
    private static class64 field1308 = new class64();

    @OriginalMember(owner = "client!SCUTTCOF", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!SCUTTCOF", name = "a", descriptor = "(LVOREJVXS;)V")
    ...
    @OriginalMember(owner = "client!SCUTTCOF", name = "b", descriptor = "(LVOREJVXS;)V")
    ...
    @OriginalMember(owner = "client!SCUTTCOF", name = "c", descriptor = "(LVOREJVXS;)B")
    private static byte method407(class64 arg0) {
        return (byte) method409(8, arg0);
    }

    @OriginalMember(owner = "client!SCUTTCOF", name = "d", descriptor = "(LVOREJVXS;)B")
    private static byte method408(class64 arg0) {
        return (byte) method409(1, arg0);
    }

    @OriginalMember(owner = "client!SCUTTCOF", name = "a", descriptor = "(ILVOREJVXS;)I")
    ...
    @OriginalMember(owner = "client!SCUTTCOF", name = "e", descriptor = "(LVOREJVXS;)V")
    ...
    @OriginalMember(owner = "client!SCUTTCOF", name = "a", descriptor = "([I[I[I[BIII)V")
