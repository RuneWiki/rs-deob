...
public class class53 extends class113 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lha;IZI)Z")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lkd;Lka;Lha;I)V")
    ...
    @OriginalMember(owner = "client!gda", name = "c", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ZI)Z")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lha;Z)Ltb;")
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(BLha;)Lvw;")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(BILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(BILha;Lgs;ZII)V")
