...
public class class53 extends class41 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)Lfl;", line = 6)
    public final class103 method318(int arg0) {
        field718++;
        return arg0 == -26207 ? class197.field2593 : null;
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IILpe;)Lxa;", line = 19)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)Lhea;", line = 34)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lffa;Loca;IIIIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 69)
