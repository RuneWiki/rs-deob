...
public class class720 extends class292 {
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lnv;IIIII)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lnv;IIII)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lnv;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lnv;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lnv;IIIIZ[FI)V")
