...
public class class720 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIBIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lso;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lso;II)V", line = 164)
