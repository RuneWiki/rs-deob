...
public class class720 extends class97 {
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "()Loia;", line = 11)
    public final class97 method745() {
        field10111++;
        return null;
    }

    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)I", line = 19)
    public final synchronized int method4071(int arg0) {
        field10098++;
        return arg0 > -101 ? -104 : this.field10119;
    }

    @OriginalMember(owner = "client!kb", name = "d", descriptor = "()Loia;", line = 35)
    public final class97 method763() {
        field10102++;
        return null;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lkka;Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IDB)Lkka;", line = 173)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "([III)V", line = 196)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "()I", line = 262)
    public final int method752() {
        field10104++;
        return 1;
    }

    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(I)D", line = 270)
    ...
    @OriginalMember(owner = "client!kb", name = "g", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IZ)V", line = 299)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(B)Lkka;", line = 310)
    private final synchronized class329 method4081(byte arg0) {
        field10109++;
        return arg0 == -103 ? (class329) this.field10110.method2725(37) : null;
    }

    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(I)V", line = 340)
