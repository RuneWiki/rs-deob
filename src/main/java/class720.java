...
public class class720 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([BZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lrs;Ltv;Lru;IIIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILsda;Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)V", line = 154)
