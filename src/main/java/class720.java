...
public class class720 implements class82 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIZZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(IIIIIIZZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lmca;BILjava/lang/String;)Lvd;", line = 40)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lcba;Lfs;Lcc;)V", line = 55)
