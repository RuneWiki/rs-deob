...
public class class720 extends class185 {
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lbja;Lbja;IF)Z", line = 20)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lfca;I)V", line = 219)
    ...
    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lhk;I)V", line = 284)
    public class720(class111 arg0, int arg1) {
        this.field9898 = arg0;
        this.field9891 = new class34(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)Lbja;", line = 294)
