...
public class class720 implements class681 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)Lwea;", line = 22)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lla;)V", line = 32)
