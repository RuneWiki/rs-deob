...
public class class720 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)Lsca;", line = 7)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BI)V", line = 35)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILfha;[Lpl;)Lrd;", line = 51)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)[Lfv;", line = 151)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIIJ)V", line = 162)
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 221)
