...
public class class720 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IILha;Z)Lkr;", line = 10)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILud;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Z)Z", line = 83)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BLud;)V", line = 119)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([IIII[I)V", line = 140)
