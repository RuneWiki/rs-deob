...
public class class720 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLwc;)I")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLdia;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(BIIIIIILwea;)V")
