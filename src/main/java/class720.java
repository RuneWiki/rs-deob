...
public class class720 extends class747 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILha;Ljo;IILto;)Z")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZIILuu;IZ)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lcea;Z)I")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ldc;II)V")
