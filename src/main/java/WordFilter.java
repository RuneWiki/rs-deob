...
public class WordFilter {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lyb;)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmb;Lmb;Lmb;Lmb;)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmb;Z)V")
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmb;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([[[BLmb;[[CI)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmb;[[CB)V")
