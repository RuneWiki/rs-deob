...
public class WordFilter {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lub;)V")
    public static final void method333(Jagfile arg0) {
        Packet var1 = new Packet(363, arg0.method257("fragmentsenc.txt", null, (byte) 2));
        Packet var2 = new Packet(363, arg0.method257("badenc.txt", null, (byte) 2));
        Packet var3 = new Packet(363, arg0.method257("domainenc.txt", null, (byte) 2));
        Packet var4 = new Packet(363, arg0.method257("tldlist.txt", null, (byte) 2));
        method334(var1, var2, var3, var4);
    }

    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lkb;Lkb;Lkb;Lkb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZLkb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILkb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lkb;I)V")
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(ILkb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "([[[B[[CLkb;B)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILkb;[[C)V")
