...
public class WordFilter {
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(ILmb;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lmb;[[[B[[CI)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z[[CLmb;)V")
