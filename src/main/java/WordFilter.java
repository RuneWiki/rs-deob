...
public class WordFilter {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILlb;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Llb;Z)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Llb;B[[[B[[C)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "([[CZLlb;)V")
