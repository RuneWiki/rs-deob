...
public class class635 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Loaa;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(I)J", line = 58)
