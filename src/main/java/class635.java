...
public class class635 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILer;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(ILer;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILr;Lega;)I")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZILer;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILer;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ltt;Ler;BI)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ler;B)V")
