...
public class class635 extends class36 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lqo;IIII[BI)V", line = 32)
    ...
    @OriginalMember(owner = "client!gj", name = "f", descriptor = "(I)V", line = 48)
    public static void method3619(int arg0) {
        int var1 = -121 / ((-52 - arg0) / 60);
        field8727 = null;
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lqo;IIII)V", line = 338)
