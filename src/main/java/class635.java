...
public class class635 extends class322 {
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lch;)V")
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(ILch;)V")
    public class635(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lbg;Lha;III)V")
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZIILjava/lang/String;ZIZIJJLjava/lang/String;II)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II[II[II[FIII[FII)V")
