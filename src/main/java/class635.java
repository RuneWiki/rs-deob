...
public class class635 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IZILmn;)V", line = 18)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(BII)V", line = 41)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Laca;Lec;I[IILqg;ILjn;Lbaa;II[Loi;Lha;Lmn;IIILec;ILffa;Z)Lka;", line = 53)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZZ)V", line = 605)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Ljn;IIIIIILbaa;ILec;Lha;I)Lka;", line = 622)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)V", line = 783)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILbaa;II)V", line = 822)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II[I[IIZ)V", line = 836)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lbaa;Lha;Lmn;ILaca;IBILec;ILjn;Lffa;)Lka;", line = 863)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Leaa;Z)Z", line = 1063)
