...
public class class635 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILnp;)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BZILlb;III)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IILnp;)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILtf;)V")
