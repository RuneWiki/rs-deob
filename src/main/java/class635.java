...
public class class635 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILsa;)V")
    public static final void method3669(int arg0, class542 arg1) {
        class88.field1594[arg0] = arg1;
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IZ)Lad;")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Ljc;ILgp;)V")
