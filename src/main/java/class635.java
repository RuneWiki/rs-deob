...
public class class635 extends class656 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lkf;ZZ)V", line = 90)
