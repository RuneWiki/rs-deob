...
public class class635 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(JI)Lpaa;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILlj;IIII)Lnea;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lac;B)Lkp;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(JILpaa;)V")
