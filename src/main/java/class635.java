...
public class class635 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(ILjava/lang/String;)V", line = 61)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 134)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)V", line = 180)
