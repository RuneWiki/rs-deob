...
public class class635 extends class73 {
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lhr;)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lac;[Lnh;)Lnh;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BIZ)Lr;")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lhr;Lei;IIII)V")
    public class635(class446 arg0, class152 arg1, int arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lhr;[Lnh;)V")
