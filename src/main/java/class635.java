...
public class class635 extends class417 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I[B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IBLqa;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 524)
