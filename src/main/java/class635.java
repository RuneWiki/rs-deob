...
public class class635 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lji;I)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B)[Lvg;")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILji;I)V")
