...
public class class635 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "()V", line = 7)
    public void method2279() throws Exception {
        field8982++;
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lfja;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 49)
    public void method2282(int arg0) throws Exception {
        field8962++;
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLfja;)V", line = 56)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "()V", line = 69)
    public void method2280() {
        field8963++;
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([II)V", line = 78)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BI)V", line = 354)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(B)V", line = 380)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(B)V", line = 400)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 422)
    public void method2283(Component arg0) throws Exception {
        field8956++;
    }

    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(B)V", line = 432)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "()I", line = 477)
    public int method2281() throws Exception {
        field8957++;
        return this.field8984;
    }

    @OriginalMember(owner = "client!iv", name = "d", descriptor = "()V", line = 485)
