...
public class class635 extends class577 implements Runnable {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BIILuea;I)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILjr;I)V")
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lkr;)V")
