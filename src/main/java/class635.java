...
public class class635 extends class330 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Ljava/io/File;II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(BLgga;)Lrl;", line = 25)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "()V", line = 46)
    public class635() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Lgga;IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IZ)[I", line = 85)
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(I)V", line = 125)
