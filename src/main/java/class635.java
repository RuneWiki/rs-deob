...
public class class635 extends class681 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIILha;)Z", line = 48)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILria;)Ljava/lang/String;", line = 86)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)I", line = 111)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lcs;ILup;Lcv;ILha;IIZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BI)I", line = 175)
