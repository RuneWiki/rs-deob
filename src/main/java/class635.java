...
public class class635 extends class642 {
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "()V", line = 54)
    public class635() {
        super(1, true);
    }
}
