...
public class class635 extends class36 implements class350 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lpt;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IBI)V", line = 86)
    ...
    @OriginalMember(owner = "client!pg", name = "finalize", descriptor = "()V", line = 99)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lad;III)V", line = 177)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lad;IIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!pg", name = "g", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIB)V", line = 140)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)V", line = 159)
