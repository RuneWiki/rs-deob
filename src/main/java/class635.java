...
public class class635 extends class600 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lr;[Lkw;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "()Lqg;", line = 81)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "()V", line = 96)
    private final void method3575() {
        this.field8980 = false;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(J)V", line = 100)
    public final void method3576(long arg0) {
        this.field8981 = arg0;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lr;)V", line = 103)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lr;J[Lkw;[Lcea;Z)V", line = 152)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IZ)Lhda;", line = 160)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "()Lqg;", line = 174)
    public final class272 method3581() {
        return this.field8991;
    }

    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(IZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!hda", name = "e", descriptor = "()V", line = 184)
    public final void method3583() {
        this.field8995 = true;
    }

    @OriginalMember(owner = "client!hda", name = "f", descriptor = "()V", line = 187)
    public final void method3584() {
        this.field8980 = true;
    }

    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class635(int arg0, boolean arg1) {
        this.method3582(arg0, arg1);
    }

    @OriginalMember(owner = "client!hda", name = "g", descriptor = "()V", line = 195)
    public static void method3585() {
        field8983 = null;
        field8988 = null;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "([Lcea;Z)V", line = 201)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIIII)V", line = 289)
    public final void method3587(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field8993 = arg0;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lr;J)Z", line = 308)
