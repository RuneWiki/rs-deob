...
public class class635 extends class529 {
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lcba;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lcba;II)V")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lcba;[III)V")
