...
public class class635 implements class522 {
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZI)Z", line = 20)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(ZI)Ldv;", line = 30)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IZIFII)[F", line = 58)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I)I", line = 70)
    public final int method2962(int arg0) {
        field8781++;
        return arg0 < 69 ? -92 : this.field8782;
    }

    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILio;)Lcaa;", line = 82)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IBIZFI)[I", line = 99)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)Lcea;", line = 114)
    public final class105 method2959(int arg0, int arg1) {
        field8776++;
        return arg0 < 61 ? null : this.field8772[arg1];
    }

    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZIZIFI)[I", line = 126)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lga;Lga;Lga;)V", line = 144)
