...
public class class635 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vd", name = "toString", descriptor = "()Ljava/lang/String;", line = 14)
    public final String toString() {
        field8838++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIIIIIIBI)V", line = 50)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 89)
