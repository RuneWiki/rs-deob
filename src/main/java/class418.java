...
public class class418 {
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IIIIILjn;IILnha;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IIII)I", line = 89)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(I)V", line = 112)
