...
public class class418 extends class34 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIB)I", line = 4)
    ...
    @OriginalMember(owner = "client!gq", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 26)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field6053;
        return this.field6062 == arg0;
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 73)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILjava/awt/Graphics;IIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IB)V", line = 119)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 151)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 174)
    ...
    @OriginalMember(owner = "client!gq", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 186)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field6049;
    }

    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!gq", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 213)
    ...
    @OriginalMember(owner = "client!gq", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 224)
    ...
    @OriginalMember(owner = "client!gq", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 252)
