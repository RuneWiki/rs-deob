...
public class class418 extends class172 implements Runnable {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lmd;)V", line = 94)
    public class418(class496 arg0) {
        this.field5554 = arg0;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IZ)I", line = 48)
    ...
    @OriginalMember(owner = "client!sl", name = "run", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III)Z", line = 83)
