...
public abstract class class418 extends class363 {
    ...
    @OriginalMember(owner = "client!ci", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 58)
    ...
    @OriginalMember(owner = "client!ci", name = "f", descriptor = "(I)I", line = 78)
