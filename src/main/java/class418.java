...
public class class418 extends class310 {
    ...
    @OriginalMember(owner = "client!oj", name = "B", descriptor = "(CIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(CIIIZLta;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 125)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lqf;Lap;[Lrr;[I[I)V", line = 221)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "([B[IIIIIIII)V", line = 246)
