...
public class class418 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)Lcg;", line = 6)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lfe;)V", line = 21)
    public class418(class384 arg0) {
        this.field6197 = arg0;
    }

    @OriginalMember(owner = "client!te", name = "b", descriptor = "(B)Lcg;", line = 32)
