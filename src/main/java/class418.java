...
public class class418 extends Canvas {
    ...
    @OriginalMember(owner = "client!no", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        field6053++;
        this.field6052.paint(arg0);
    }

    @OriginalMember(owner = "client!no", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        field6048++;
        this.field6052.update(arg0);
    }

    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
