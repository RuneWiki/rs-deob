...
public class class418 extends class243 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BLfha;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILji;B)V")
