...
public class class418 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(II)Lqi;", line = 64)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lci;ILg;)V", line = 120)
