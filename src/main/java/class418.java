...
public class class418 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BI)Lhc;", line = 31)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BILjava/lang/String;)V", line = 77)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 116)
