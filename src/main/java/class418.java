...
public class class418 extends class116 implements class503 {

    @OriginalMember(owner = "client!nu", name = "z", descriptor = "Lgg;")
    public class116 field6066;

    @OriginalMember(owner = "client!nu", name = "s", descriptor = "Lwj;")
    public static class270 field6059 = new class270(60, 3);

    @OriginalMember(owner = "client!nu", name = "F", descriptor = "[I")
    public static int[] field6072 = new int[25];
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lya;B)Lmf;", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZILya;I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BLya;I)Lt;", line = 27)
    public final class471 method488(byte arg0, class38 arg1, int arg2) {
        if (arg0 != 124) {
            method2485(null, -74, -59);
        }
        field6076++;
        return null;
    }

    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(ILya;)V", line = 50)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(Z)I", line = 63)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(I)Z", line = 74)
    public final boolean method489(int arg0) {
        int var2 = 39 % ((arg0 - 23) / 62);
        field6063++;
        return false;
    }

    @OriginalMember(owner = "client!nu", name = "f", descriptor = "(I)Z", line = 84)
    public final boolean method492(int arg0) {
        field6071++;
        if (arg0 != -1) {
            this.method500(true, 56, null, 81);
        }
        return false;
    }

    @OriginalMember(owner = "client!nu", name = "h", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(ILya;)V", line = 111)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lya;IZLij;III)V", line = 123)
    ...
    @OriginalMember(owner = "client!nu", name = "j", descriptor = "(I)V", line = 134)
    public static void method2484(int arg0) {
        if (arg0 >= -39) {
            method2485(null, 61, -90);
        }
        field6059 = null;
        field6072 = null;
    }

    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(I)I", line = 155)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([SII)[S", line = 169)
    public static final short[] method2485(short[] arg0, int arg1, int arg2) {
        if (arg2 == -22395) {
            field6060++;
            short[] var3 = new short[arg1];
            class91.method676(arg0, 0, var3, 0, arg1);
            return var3;
        } else {
            return null;
        }
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILya;)V", line = 183)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)I", line = 196)
    public final int method496(int arg0) {
        field6075++;
        int var2 = 127 / ((arg0 + 4) / 61);
        return 0;
    }

    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(IIIIIIIIIILgg;)V", line = 208)
    public class418(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, class116 arg10) {
        super(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, false, class431.method2554(arg0, arg1, (byte) 50));
        this.field6066 = arg10;
    }
}
