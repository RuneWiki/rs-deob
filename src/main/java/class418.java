...
public class class418 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(JLds;I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(JI)Lds;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI)Lga;")
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(II)Lcm;")
