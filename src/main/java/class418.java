...
public class class418 extends class86 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZB)V", line = 16)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILcd;III)V", line = 27)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZLlr;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(B)Z", line = 114)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lnq;)V", line = 125)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IBI)V", line = 164)
    public final void method239(int arg0, byte arg1, int arg2) {
        ++field6369;
        int var4 = 7 / ((-50 - arg1) / 53);
    }

    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IZ)V", line = 187)
