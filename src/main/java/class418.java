...
public abstract class class418 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)I", line = 23)
    public static int method2558(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIZ)V", line = 40)
