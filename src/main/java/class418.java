...
public class class418 extends class16 implements class105 {
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(FFFFFFLma;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!ia", name = "finalize", descriptor = "()V", line = 18)
    protected final void finalize() {
        class438.method2701(-88, this);
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IILma;II)V", line = 25)
    public final void method127(int arg0, int arg1, class10 arg2, int arg3, int arg4) {
        this.method2620(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ia", name = "BA", descriptor = "(III)V", line = 29)
    public final void method133(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lqa;Lna;[IIIII)V", line = 37)
