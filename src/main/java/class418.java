...
public class class418 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILrg;)Lms;", line = 34)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)I", line = 85)
