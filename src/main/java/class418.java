...
public class class418 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)Lnu;", line = 21)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lkha;IIIZII)V", line = 108)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ZI)V", line = 129)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Ldh;ILkha;Lkha;)V", line = 149)
