...
public class class418 extends class180 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIII)I", line = 76)
