...
public class class418 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IIZBI)Lud;", line = 28)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(I)I", line = 85)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(Z)I", line = 96)
    ...
    @OriginalMember(owner = "client!hca", name = "d", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILde;Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BZ)V", line = 212)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)Z", line = 239)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(B)V", line = 520)
    ...
    @OriginalMember(owner = "client!hca", name = "e", descriptor = "(I)V", line = 533)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(B)V", line = 568)
