...
public class class418 extends class348 implements class147 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IILuea;I)V")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Loa;Llt;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILoa;)Lwc;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IILgfa;IIZLoa;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I[I[I[ILuea;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Loa;B)Lac;")
