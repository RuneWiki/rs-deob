...
public class class418 extends class698 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(I)V", line = 69)
