...
public class class418 {
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(II)Lqga;", line = 36)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(ILlga;Llga;)V", line = 86)
