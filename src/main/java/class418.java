...
public class class418 extends class301 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "([B[I[IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ww", name = "q", descriptor = "(CIIIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V", line = 124)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "([B[I[IIIIIIIIIIILfa;II)V", line = 210)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "([B[IIIIIIII)V", line = 301)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Lkb;Lil;[Lme;[I[I)V", line = 356)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(CIIIZLfa;II)V", line = 379)
