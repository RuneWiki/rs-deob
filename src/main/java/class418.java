...
public class class418 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I[BZLjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)I", line = 49)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(II)I", line = 76)
