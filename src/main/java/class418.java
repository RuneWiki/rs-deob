...
public class class418 extends class337 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(FZ)F", line = 16)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIFII)V", line = 48)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIII)V", line = 161)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)V", line = 176)
    public static void method2509(int arg0) {
        field6279 = null;
        int var1 = 7 % ((arg0 - 36) / 32);
    }

    @OriginalMember(owner = "client!kq", name = "e", descriptor = "(I)Lcn;", line = 187)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IB)V", line = 226)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I[II)V", line = 240)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lon;IIIII)V", line = 368)
