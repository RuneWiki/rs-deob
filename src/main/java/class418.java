...
public class class418 extends class156 {
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Ldt;Ljava/lang/Object;I)V", line = 4)
    public class418(class431 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6253 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)Z", line = 13)
    public final boolean method1005(boolean arg0) {
        return arg0 ? true : true;
    }

    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 24)
