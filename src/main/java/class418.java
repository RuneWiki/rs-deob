...
public class class418 extends class260 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lha;Lor;Z)V")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lfca;)V")
