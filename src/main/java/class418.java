...
public class class418 extends class428 {
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "()I", line = 10)
    public final int method2410() {
        return field5747.method1875(this.field5748, (byte) -102);
    }

    @OriginalMember(owner = "client!kq", name = "c", descriptor = "()V", line = 14)
    public final void method2411() {
        field5747.method1873(this.field5748, (byte) 39);
    }

    @OriginalMember(owner = "client!kq", name = "e", descriptor = "()V", line = 17)
    public static void method2412() {
        field5747 = null;
    }

    @OriginalMember(owner = "client!kq", name = "b", descriptor = "()V", line = 20)
    public final void method2413() {
        field5747.method1876(-123, this.field5748);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "()V", line = 23)
    public final void method2414() {
        field5747.method1878(this.field5748, super.field5858);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 26)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Ljs;I)V", line = 28)
