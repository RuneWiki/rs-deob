...
public class class418 extends class367 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "(I)Lnm;", line = 19)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ls", name = "e", descriptor = "(I)V", line = 51)
