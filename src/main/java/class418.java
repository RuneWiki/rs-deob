...
public class class418 extends class386 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IBLun;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILdc;)I")
