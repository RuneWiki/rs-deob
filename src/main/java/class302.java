...
public class class302 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)Lqv;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ldv;[[BZ)V")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lwv;ILqs;)V")
