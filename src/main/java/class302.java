...
public class class302 extends class364 {
    ...
    @OriginalMember(owner = "client!ws", name = "P", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ws", name = "R", descriptor = "(III[I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ws", name = "la", descriptor = "(Lq;)V", line = 47)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BLq;)V", line = 69)
    ...
    @OriginalMember(owner = "client!ws", name = "G", descriptor = "(III)V", line = 102)
    ...
    @OriginalMember(owner = "client!ws", name = "S", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(FFIBIFI)V", line = 141)
    ...
    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(I)[F", line = 182)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIZ)I", line = 202)
    ...
    @OriginalMember(owner = "client!ws", name = "ra", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!ws", name = "d", descriptor = "(I)Llq;", line = 230)
    ...
    @OriginalMember(owner = "client!ws", name = "e", descriptor = "(I)[F", line = 257)
    ...
    @OriginalMember(owner = "client!ws", name = "GA", descriptor = "(III)V", line = 280)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)V", line = 292)
    ...
    @OriginalMember(owner = "client!ws", name = "O", descriptor = "([I)V", line = 303)
    ...
    @OriginalMember(owner = "client!ws", name = "XA", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III[I)V", line = 338)
    ...
    @OriginalMember(owner = "client!ws", name = "pa", descriptor = "(IIIIII)V", line = 353)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "()V", line = 388)
    public class302() {
        this.method2021();
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "()Lq;", line = 396)
    ...
    @OriginalMember(owner = "client!ws", name = "Y", descriptor = "()V", line = 419)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZII)V", line = 429)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 509)
