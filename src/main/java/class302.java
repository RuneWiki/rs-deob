...
public class class302 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IB)V", line = 36)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lda;)V", line = 69)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lci;ILg;Lg;)V", line = 228)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)Lso;", line = 187)
