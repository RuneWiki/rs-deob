...
public class class302 extends class337 {
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 4)
    public class302() {
        super(1, true);
    }

    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IB)[I", line = 60)
