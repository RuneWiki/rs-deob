...
public class class302 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II)Ljha;")
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IILgi;III)Lfh;")
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Lsaa;ILfp;)V")
