...
public class class302 extends class405 {
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(IIIZ)V", line = 4)
    public class302(int arg0, int arg1, int arg2, boolean arg3) {
        super(arg0, arg1, arg2, arg3, class534.field7800, class176.field2178);
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILun;Lr;[IIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIB[ILr;Lun;)V", line = 302)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILga;IIIILr;)V", line = 668)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lr;[Lga;III[B)V", line = 768)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 842)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILun;)Ljava/lang/String;", line = 863)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II[Lga;[BILr;IIIII)V", line = 890)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(I)V", line = 974)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lga;IIIIILr;IIII)V", line = 984)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILr;Z)V", line = 1601)
