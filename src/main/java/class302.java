...
public class class302 extends class383 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIB)[B", line = 6)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z[B)V", line = 19)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)[B", line = 32)
