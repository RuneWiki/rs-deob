...
public class class302 extends class406 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BLjava/lang/String;)I", line = 9)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IBI)I", line = 59)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIB)Z", line = 98)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 167)
