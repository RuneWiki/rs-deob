...
public class class302 extends class118 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lbaa;IB)V")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Los;Lkm;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILdda;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILqa;B)Z")
