...
public class class302 implements Runnable {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!nba", name = "run", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([BIII)I", line = 105)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 242)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(II)Z", line = 155)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([BI)[B", line = 187)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(BIIII)V", line = 216)
