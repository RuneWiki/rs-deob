...
public class class302 extends class478 {
    ...
    @OriginalMember(owner = "client!gaa", name = "ya", descriptor = "()V", line = 5)
    public final void method1031() {
        this.method2594(true, (byte) -25);
        this.field3716.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!gaa", name = "B", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!gaa", name = "h", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljava/lang/Object;BLjava/awt/Canvas;)V", line = 41)
    public final void method1672(Object arg0, byte arg1, Canvas arg2) {
        this.field3726 = (class41) arg0;
        int var4 = 124 / ((arg1 - 8) / 55);
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([IIZIIII)Lls;", line = 50)
    ...
    @OriginalMember(owner = "client!gaa", name = "z", descriptor = "()Z", line = 60)
    public final boolean method1006() {
        return false;
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZILgb;Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!gaa", name = "s", descriptor = "()V", line = 112)
    public final void method1052() {
    }

    @OriginalMember(owner = "client!gaa", name = "o", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZLgb;IZB)V", line = 128)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lrca;I)V", line = 176)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILmv;)I", line = 198)
    ...
    @OriginalMember(owner = "client!gaa", name = "v", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(ZI)Lhh;", line = 254)
    ...
    @OriginalMember(owner = "client!gaa", name = "s", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!gaa", name = "d", descriptor = "(ZB)V", line = 273)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)V", line = 283)
    public final void method1038(boolean arg0) {
    }

    @OriginalMember(owner = "client!gaa", name = "M", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!gaa", name = "F", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!gaa", name = "k", descriptor = "(Z)V", line = 333)
    ...
    @OriginalMember(owner = "client!gaa", name = "I", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILbt;Lec;)Z", line = 374)
    ...
    @OriginalMember(owner = "client!gaa", name = "r", descriptor = "(B)F", line = 386)
    public final float method1688(byte arg0) {
        int var2 = 79 % ((1 - arg0) / 37);
        return -0.5F;
    }

    @OriginalMember(owner = "client!gaa", name = "u", descriptor = "(I)V", line = 394)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 406)
    ...
    @OriginalMember(owner = "client!gaa", name = "k", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lf;Z)V", line = 440)
    public final void method976(class536 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!gaa", name = "g", descriptor = "(Z)V", line = 443)
    ...
    @OriginalMember(owner = "client!gaa", name = "i", descriptor = "(Z)V", line = 453)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lep;Z)V", line = 462)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BLnba;I)V", line = 485)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZZI[[I)Loq;", line = 497)
    ...
    @OriginalMember(owner = "client!gaa", name = "n", descriptor = "(B)V", line = 507)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([FIIIZIILec;)Lls;", line = 538)
    ...
    @OriginalMember(owner = "client!gaa", name = "y", descriptor = "()Loa;", line = 549)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BLgb;)I", line = 557)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILlt;IIIILhh;)V", line = 585)
    ...
    @OriginalMember(owner = "client!gaa", name = "u", descriptor = "()V", line = 602)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIII)V", line = 626)
    public final void method1078(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!gaa", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Lfa;Lpl;Ljava/lang/Integer;)Lr;", line = 631)
    ...
    @OriginalMember(owner = "client!gaa", name = "i", descriptor = "()Z", line = 730)
    public final boolean method1032() {
        return false;
    }

    @OriginalMember(owner = "client!gaa", name = "u", descriptor = "(B)V", line = 739)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILqo;)V", line = 778)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Llt;B)I", line = 819)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILnw;)I", line = 852)
    ...
    @OriginalMember(owner = "client!gaa", name = "d", descriptor = "(II)V", line = 883)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljava/awt/Canvas;I)Ljava/lang/Object;", line = 894)
    ...
    @OriginalMember(owner = "client!gaa", name = "W", descriptor = "(I)V", line = 905)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIILjagdx/D3DPRESENT_PARAMETERS;Ljagdx/IDirect3D;)Z", line = 916)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZLmq;)V", line = 1021)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lgt;I)V", line = 1032)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/am;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Loo;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Lfa;Lpl;I)V", line = 1056)
    ...
    @OriginalMember(owner = "client!gaa", name = "A", descriptor = "()V", line = 1097)
    public final void method1069() {
        this.field3721.method3441((byte) -62);
        super.method1069();
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 1105)
    public final synchronized void method1051(int arg0) {
        this.field3721.method3438((byte) -108);
        super.method1051(arg0);
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BLjava/awt/Canvas;Ljava/lang/Object;)V", line = 1114)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lec;Lbt;I)Z", line = 1126)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILec;IILbt;)Lls;", line = 1135)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([BLec;IIZZII)Lls;", line = 1145)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljt;Ljt;FLjt;)Ljt;", line = 1155)
    public final class533 method1064(class533 arg0, class533 arg1, float arg2, class533 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Llt;III)V", line = 1166)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZZ)Lnba;", line = 1177)
    public final class401 method1716(boolean arg0, boolean arg1) {
        return arg0 ? (class401) null : new class379(this, arg1);
    }

    @OriginalMember(owner = "client!gaa", name = "DA", descriptor = "()I", line = 1187)
    public final int method1045() {
        return 0;
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 1194)
    public final void method987(Rectangle[] arg0, int arg1) throws class180 {
        this.method988();
    }

    @OriginalMember(owner = "client!gaa", name = "X", descriptor = "(I)V", line = 1201)
    ...
    @OriginalMember(owner = "client!gaa", name = "c", descriptor = "(B)V", line = 1211)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(FFF)V", line = 1221)
    public final void method1014(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!gaa", name = "ab", descriptor = "(I)Z", line = 1225)
    ...
    @OriginalMember(owner = "client!gaa", name = "q", descriptor = "()V", line = 1260)
    public final void method1082() {
    }

    @OriginalMember(owner = "client!gaa", name = "k", descriptor = "()V", line = 1264)
    ...
    @OriginalMember(owner = "client!gaa", name = "ja", descriptor = "(I)V", line = 1287)
    public final void method1028(int arg0) {
        this.field3716.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lec;Lbt;Z)I", line = 1294)
    ...
    @OriginalMember(owner = "client!gaa", name = "j", descriptor = "(I)V", line = 1333)
    ...
    @OriginalMember(owner = "client!gaa", name = "D", descriptor = "(I)V", line = 1346)
    ...
    @OriginalMember(owner = "client!gaa", name = "A", descriptor = "(I)V", line = 1370)
    ...
    @OriginalMember(owner = "client!gaa", name = "v", descriptor = "(I)V", line = 1379)
    ...
    @OriginalMember(owner = "client!gaa", name = "h", descriptor = "(IIII)[I", line = 1402)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(BI)Lcl;", line = 1445)
    ...
    @OriginalMember(owner = "client!gaa", name = "K", descriptor = "(I)V", line = 1488)
    ...
    @OriginalMember(owner = "client!gaa", name = "x", descriptor = "(I)V", line = 1506)
    ...
    @OriginalMember(owner = "client!gaa", name = "P", descriptor = "(I)V", line = 1521)
    public final void method1728(int arg0) {
        int var2 = -78 % ((arg0 - 6) / 53);
        this.field3716.SetTransform(3, this.field6317);
    }

    @OriginalMember(owner = "client!gaa", name = "l", descriptor = "(I)V", line = 1532)
    ...
    @OriginalMember(owner = "client!gaa", name = "j", descriptor = "()V", line = 1542)
    public final void method983() {
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([Leda;Z)Lmq;", line = 1552)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(B)V", line = 1562)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I[BIILec;I)Lfl;", line = 1600)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "()V", line = 1609)
    public final void method1089() {
    }

    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(ILki;)I", line = 1612)
