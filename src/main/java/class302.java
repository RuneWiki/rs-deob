...
public class class302 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B[Ljava/lang/Object;)Ljava/lang/Object;", line = 25)
