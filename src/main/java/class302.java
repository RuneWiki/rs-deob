...
public class class302 extends class476 {
    ...
    @OriginalMember(owner = "client!qaa", name = "d", descriptor = "()Lkm;")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I[IILeu;II)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "()Lkm;")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Leu;II)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Leka;)V")
