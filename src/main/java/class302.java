...
public class class302 extends class133 {
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Luo;IIZ)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(Luo;B)Lkj;", line = 88)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILuo;I)Lge;", line = 117)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BI)Lkc;", line = 132)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Luo;Lge;I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZLla;)Ljava/lang/String;", line = 221)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLuo;)V", line = 237)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Luo;IIIZBLpc;)V", line = 257)
    ...
    @OriginalMember(owner = "client!ps", name = "finalize", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!ps", name = "f", descriptor = "(I)V", line = 304)
