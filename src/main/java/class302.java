...
public abstract class class302 extends class287 {
    ...
    @OriginalMember(owner = "client!tk", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "g", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)Z", line = 39)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(II)Lho;", line = 63)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(II)V", line = 101)
