...
public class class302 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BI)Z", line = 31)
