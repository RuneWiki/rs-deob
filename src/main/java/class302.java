...
public class class302 {
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lwd;ZLjava/lang/String;ZB)V", line = 67)
