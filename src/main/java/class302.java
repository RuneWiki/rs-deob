...
public class class302 extends class702 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BI[BLhp;)Lwq;")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lhea;IIZ)V")
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lhea;II[III)V")
