...
public class class302 extends class703 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)Ltca;", line = 106)
    public final class141 method421(int arg0) {
        field3991++;
        return arg0 == 4 ? class104.field1230 : null;
    }

    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(ILtl;Lfn;III)V", line = 120)
    public class302(int arg0, class566 arg1, class286 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field3996 = arg5;
    }

    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILio;)Loi;", line = 130)
