...
public class class302 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(JJ)J", line = 8)
    public static long method1853(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 40)
