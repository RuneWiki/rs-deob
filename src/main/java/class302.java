...
public class class302 extends class205 implements class185 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BI)Let;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lqq;ZI)Lcd;")
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lqq;Lin;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lqq;BII)Z")
