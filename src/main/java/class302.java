...
public class class302 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ZBI)V", line = 53)
