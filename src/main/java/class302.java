...
public class class302 extends class204 {
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(JI)I", line = 27)
    ...
    @OriginalMember(owner = "client!iba", name = "d", descriptor = "(I)J", line = 63)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "()V", line = 117)
    public class302() {
        this.field4131 = System.nanoTime();
        this.field4132 = System.nanoTime();
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)J", line = 99)
