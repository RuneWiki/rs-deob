...
public class class302 extends class377 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(FBIZLuh;)V", line = 48)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILls;)V", line = 83)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lls;Z)V", line = 156)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lls;B)V", line = 183)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(II)V", line = 211)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Z)V", line = 237)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIII)V", line = 270)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(III)V", line = 282)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IB)V", line = 295)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Ltm;I)V", line = 330)
