...
public class class302 {
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lbt;)V")
    public class302(class33 arg0) {
        this.field4476 = arg0;
    }

    @OriginalMember(owner = "client!li", name = "b", descriptor = "(III)Log;")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILgh;Lgh;F)Z")
