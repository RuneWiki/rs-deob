...
public class class302 extends class333 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "()V", line = 65)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BLkca;)Z", line = 290)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "()V", line = 317)
    public class302() {
    }

    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 319)
