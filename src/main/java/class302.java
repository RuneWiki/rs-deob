...
public class class302 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Z)I", line = 117)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IZIIBII)V", line = 569)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(I)V", line = 604)
