...
public class class302 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZI)V", line = 77)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILsq;)I", line = 99)
