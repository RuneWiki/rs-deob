...
public class class302 {
    ...
    @OriginalMember(owner = "client!st", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(JB)V", line = 16)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IB[BI)I", line = 32)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)J", line = 48)
    public final long method1843(int arg0) throws IOException {
        return arg0 <= 15 ? 55L : this.field4417.length();
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(BII[B)V", line = 73)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(B)Ljava/io/File;", line = 92)
