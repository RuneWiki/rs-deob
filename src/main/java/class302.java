...
public class class302 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lat;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lat;IZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILat;)V", line = 115)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BI)[B", line = 350)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIIIBLfp;)Lbi;", line = 443)
