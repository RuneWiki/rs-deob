...
public class class4 extends class367 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)Lwv;", line = 46)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZ)[B", line = 179)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(B)I", line = 196)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(ILvs;Lvs;Lsn;Lqj;IIZ)V", line = 798)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(B)V", line = 212)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(B)I", line = 230)
    ...
    @OriginalMember(owner = "client!ft", name = "f", descriptor = "(B)V", line = 254)
    ...
    @OriginalMember(owner = "client!ft", name = "g", descriptor = "(B)V", line = 298)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IB)V", line = 309)
    ...
    @OriginalMember(owner = "client!ft", name = "h", descriptor = "(B)V", line = 337)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)I", line = 516)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IBI)Lhi;", line = 541)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(IB)I", line = 754)
