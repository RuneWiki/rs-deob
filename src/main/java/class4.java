...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILmd;IB)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lmd;IZ)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZLsl;I)Lsj;")
