...
public class class4 extends class450 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(ILup;)V", line = 17)
    public class4(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILjava/lang/String;)V", line = 66)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILaea;)I", line = 80)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(Z)I", line = 129)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lup;)V", line = 143)
    public class4(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)I", line = 146)
