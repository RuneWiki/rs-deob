...
public class class4 extends class148 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILdh;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(II)[I", line = 64)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZI)[[I", line = 166)
