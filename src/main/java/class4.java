...
public class class4 implements class126 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lrg;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(CB)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)Lgj;", line = 102)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 225)
    public class4(String arg0) {
        this.field44 = arg0;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/io/File;I)[B", line = 239)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)I", line = 254)
