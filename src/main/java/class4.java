...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZILjava/lang/String;Ljava/lang/String;)V", line = 105)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(III)V", line = 134)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)I", line = 149)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)Z", line = 161)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BII)Z", line = 174)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)I", line = 188)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(ZIIZ)V", line = 198)
