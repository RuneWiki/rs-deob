...
public class class4 extends class351 {
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "()I", line = 26)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 36)
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 77)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "()V", line = 123)
