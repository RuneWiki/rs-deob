...
public class class4 extends class129 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)[B")
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(IBI)[B")
