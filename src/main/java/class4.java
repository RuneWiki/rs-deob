...
public class class4 extends class322 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(II[JI[I)V")
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(FIILts;IIFFIFF)[B")
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(ILch;)V")
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lch;)V")
