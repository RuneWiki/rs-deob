...
public class class4 extends class422 implements class438 {
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfp;II)Lbi;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfp;Lje;ZIIII)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lfp;Lgn;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfp;Z)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfp;I)V")
