...
public abstract class class4 extends class161 {
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "()I", line = 21)
    public int method75() {
        return 0;
    }

    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(Z)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lsq;)V", line = 38)
    public class4(class96 arg0) {
        this.field82 = arg0;
    }

    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)Z", line = 47)
