...
public class class4 implements Runnable {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;B)Lem;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;I)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZLjava/lang/String;I)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZI)Lpga;")
    public final class494 method15(boolean arg0, int arg1) {
        return arg0 ? this.method19(arg1, 87, 0, 3, null) : null;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIIII)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjava/net/URL;)Lpga;")
    public final class494 method18(int arg0, URL arg1) {
        return arg0 > -21 ? null : this.method19(0, 118, 0, 4, arg1);
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIIILjava/lang/Object;)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjava/lang/String;IZ)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Lpga;")
    public final class494 method22(Runnable arg0, int arg1, byte arg2) {
        return arg2 >= -117 ? null : this.method19(arg1, 79, 0, 2, arg0);
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;BILjava/lang/String;)Lem;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;I[Ljava/lang/Class;Ljava/lang/Class;)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/awt/Point;IILjava/awt/Component;[II)Lpga;")
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(B)Lpga;")
    public final class494 method29(byte arg0) {
        int var2 = -1 / ((47 - arg0) / 47);
        return this.method19(0, -128, 0, 5, null);
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjava/awt/Frame;)Lpga;")
