...
public class class4 extends class397 {
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ft", name = "f", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "()V", line = 251)
    public class4() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZ)Lts;", line = 257)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(B)[Lag;", line = 283)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IBLae;)V", line = 295)
    ...
    @OriginalMember(owner = "client!ft", name = "g", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(BI)[I", line = 472)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(IZ)I", line = 491)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(II)[I", line = 512)
