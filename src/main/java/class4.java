...
public class class4 extends class133 {
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIIII)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIII)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lqj;IIII[I)V")
    public class4(class548 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
