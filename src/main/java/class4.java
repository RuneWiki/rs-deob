...
public class class4 extends class45 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZFIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIIIB)V", line = 136)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)V", line = 220)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(II)V", line = 233)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IBIII)V", line = 249)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(II)V", line = 277)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "([III)V", line = 290)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 412)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lal;IIIII)V", line = 425)
