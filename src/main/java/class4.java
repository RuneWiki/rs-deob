...
public class class4 extends class88 {
    ...
    @OriginalMember(owner = "client!ft", name = "i", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(ILgj;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ft", name = "j", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZI)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I[B)I", line = 76)
