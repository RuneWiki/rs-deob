...
public class class4 extends class510 {
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(FB[FIFFIIFII)V", line = 30)
