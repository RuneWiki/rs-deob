...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(III)Lqt;", line = 22)
    ...
    @OriginalMember(owner = "client!ft", name = "toString", descriptor = "()Ljava/lang/String;", line = 43)
