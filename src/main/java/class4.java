...
public class class4 {
    ...
    @OriginalMember(owner = "client!BCUFZZFO", name = "b", descriptor = "[LBCUFZZFO;")
    public static class4[] field27;

    @OriginalMember(owner = "client!BCUFZZFO", name = "a", descriptor = "(ILTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!BCUFZZFO", name = "a", descriptor = "(ILPKHWFJLM;I)V")
