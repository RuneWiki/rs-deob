...
public class class4 extends class334 {
    ...
    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "()V", line = 3)
    public class4() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jja", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!jja", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(II)[I", line = 110)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(IZLol;)V", line = 183)
    ...
    @OriginalMember(owner = "client!jja", name = "g", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!jja", name = "c", descriptor = "(B)V", line = 258)
