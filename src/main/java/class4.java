...
public class class4 extends class81 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/Object;ILdq;)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lnj;I)V")
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)Lnj;")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ldq;I)V")
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Ldq;)V")
