...
public class class4 extends class10 {
    ...
    @OriginalMember(owner = "client!BXTJETAB", name = "k", descriptor = "Z")
    public static boolean field64;

    @OriginalMember(owner = "client!BXTJETAB", name = "i", descriptor = "[LCKROTWSG;")
    ...
    @OriginalMember(owner = "client!BXTJETAB", name = "a", descriptor = "(I)LIGXVZOHI;")
