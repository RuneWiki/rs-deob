...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Loa;Lvv;Loa;ZIIIZBIILta;)Lxa;", line = 97)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BILrt;)V", line = 161)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lvv;IIIIIILoa;)Lxa;", line = 208)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lcda;IZLhg;Lkea;Lkea;)V", line = 450)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(II)V", line = 230)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(II)Lbea;", line = 249)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIIIII)V", line = 332)
