...
public class class4 extends class147 {
    ...
    @OriginalMember(owner = "client!ac", name = "Z", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ac", name = "L", descriptor = "Llf;")
    public static class109 field43 = class35.method275("swe", 2);

    @OriginalMember(owner = "client!ac", name = "Y", descriptor = "Llf;")
    private static class109 field55 = class35.method275("glow2:", 2);

    @OriginalMember(owner = "client!ac", name = "V", descriptor = "Llf;")
    public static class109 field52 = class35.method275("und die Schaltfl-=che (WSpielkonto erstellen(W am", 2);

    @OriginalMember(owner = "client!ac", name = "J", descriptor = "Llf;")
    public static class109 field42 = field55;

    @OriginalMember(owner = "client!ac", name = "T", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ac", name = "db", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ac", name = "N", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLvg;)Lvg;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLja;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IBLja;)V")
