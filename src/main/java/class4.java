...
public class class4 extends class634 {
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "()V", line = 5)
    public class4() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(BI)[I", line = 10)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lgh;IIIII)Ljava/awt/Frame;", line = 21)
    ...
    @OriginalMember(owner = "client!ft", name = "f", descriptor = "(I)V", line = 92)
