...
public class class4 extends class326 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIILjava/lang/Class;)Lhb;", line = 11)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILbt;I)V", line = 300)
    ...
    @OriginalMember(owner = "client!ft", name = "f", descriptor = "(I)V", line = 372)
