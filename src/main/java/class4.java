...
public class class4 extends class626 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILrca;)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIIIFFIFLse;IFFI[B)V")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lud;Z)V")
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(ZLvk;)V")
