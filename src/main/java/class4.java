...
public class class4 extends class390 {
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([I)Lvj;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lnq;II)Lie;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lnq;)Z")
