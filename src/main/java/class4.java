...
public class class4 extends class61 {
    ...
    @OriginalMember(owner = "client!AOBGXKOU", name = "m", descriptor = "Z")
    public static boolean field38;

    @OriginalMember(owner = "client!AOBGXKOU", name = "k", descriptor = "[LKCBBJKUN;")
    ...
    @OriginalMember(owner = "client!AOBGXKOU", name = "a", descriptor = "(Z)LYABPKWWG;")
