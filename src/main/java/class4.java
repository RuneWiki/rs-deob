...
public class class4 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(II)Lvt;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IILmr;III)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lwj;ILwu;)V")
