...
public abstract class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(III)V", line = 38)
