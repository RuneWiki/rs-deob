...
public class class4 {
    ...
    @OriginalMember(owner = "client!BRGDZOWQ", name = "p", descriptor = "LLSQNLJTA;")
    ...
    @OriginalMember(owner = "client!BRGDZOWQ", name = "h", descriptor = "LIUTBNGPH;")
    public class32 field19;

    @OriginalMember(owner = "client!BRGDZOWQ", name = "d", descriptor = "[LBRGDZOWQ;")
    public static class4[] field15;

    @OriginalMember(owner = "client!BRGDZOWQ", name = "a", descriptor = "(LVSUYIIVA;I)V")
    ...
    @OriginalMember(owner = "client!BRGDZOWQ", name = "a", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!BRGDZOWQ", name = "a", descriptor = "()LLFTMDGKK;")
