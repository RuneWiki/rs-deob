...
public class class4 extends class363 implements class529 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIILpn;)Lae;", line = 16)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lya;II)Lt;", line = 86)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IILfi;BZLya;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZLya;)V", line = 118)
    public final void method26(boolean arg0, class38 arg1) {
        ++field63;
        this.field61.method2052(arg0, arg1);
    }

    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)I", line = 136)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lya;Lrd;IIIIIZII)V", line = 158)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)Z", line = 167)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lya;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(B)Z", line = 190)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IILya;I)Z", line = 221)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(Lya;I)V", line = 249)
    ...
    @OriginalMember(owner = "client!ft", name = "f", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIII)V", line = 317)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(Lya;I)Lfk;", line = 332)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)V", line = 372)
