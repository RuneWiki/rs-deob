...
public class class4 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILfb;)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILjava/awt/Canvas;)Llb;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIBLtj;IIII)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lfb;BI)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IB)Luh;")
