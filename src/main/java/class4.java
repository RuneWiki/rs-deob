...
public class class4 {
    ...
    @OriginalMember(owner = "client!CDEGFOQA", name = "b", descriptor = "LCDEGFOQA;")
    public class4 field55;

    @OriginalMember(owner = "client!CDEGFOQA", name = "c", descriptor = "LCDEGFOQA;")
    public class4 field56;

    @OriginalMember(owner = "client!CDEGFOQA", name = "d", descriptor = "Z")
