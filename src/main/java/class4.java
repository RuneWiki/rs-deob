...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "toString", descriptor = "()Ljava/lang/String;", line = 12)
    public final String toString() {
        field22++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(II)V", line = 21)
    public class4(int arg0, int arg1) {
        this.field19 = arg0;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 31)
