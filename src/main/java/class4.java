...
public class class4 extends class219 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lnba;I)Z")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lnba;Z)Z")
