...
public class class4 extends class424 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lrg;BI)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lvg;BIILwn;Lde;II)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lgg;IIIII)V")
