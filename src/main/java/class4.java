...
public class class4 extends class83 implements class116 {
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(ILoj;)V")
    public final void method18(int arg0, class280 arg1) {
        int var3 = 122 / ((arg0 - 62) / 63);
        field40++;
    }

    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(IIIIIIIIIILmt;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(ILoj;)Lmg;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILoj;B)Lqh;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IIZLa;IBLoj;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILoj;II)Z")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BLab;)Lab;")
