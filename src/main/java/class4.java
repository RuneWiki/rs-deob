...
@OriginalClass("client!BXXPAJNW")
public class class4 {

    @OriginalMember(owner = "client!BXXPAJNW", name = "a", descriptor = "Z")
    public boolean field67 = false;

    @OriginalMember(owner = "client!BXXPAJNW", name = "b", descriptor = "I")
    public int field68 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "d", descriptor = "I")
    public int field70 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "e", descriptor = "I")
    private int field71 = 128;

    @OriginalMember(owner = "client!BXXPAJNW", name = "h", descriptor = "I")
    public int field74 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "i", descriptor = "I")
    public int field75 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "k", descriptor = "I")
    public int field77 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "n", descriptor = "I")
    public int field80 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "o", descriptor = "I")
    public int field81 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "q", descriptor = "J")
    public long field83 = -1L;

    @OriginalMember(owner = "client!BXXPAJNW", name = "u", descriptor = "I")
    public int field87 = 32;

    @OriginalMember(owner = "client!BXXPAJNW", name = "v", descriptor = "I")
    private int field88 = 128;

    @OriginalMember(owner = "client!BXXPAJNW", name = "w", descriptor = "I")
    public int field89 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "x", descriptor = "B")
    public byte field90 = 1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "F", descriptor = "I")
    public int field98 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "G", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "L", descriptor = "I")
    public int field104 = -1;

    @OriginalMember(owner = "client!BXXPAJNW", name = "f", descriptor = "LASORKPAH;")
    public static class2 field72 = new class2(48975, 30);

    @OriginalMember(owner = "client!BXXPAJNW", name = "D", descriptor = "Z")
    private static boolean field96 = true;

    @OriginalMember(owner = "client!BXXPAJNW", name = "g", descriptor = "I")
    private int field73;

    @OriginalMember(owner = "client!BXXPAJNW", name = "j", descriptor = "I")
    public static int field76;

    @OriginalMember(owner = "client!BXXPAJNW", name = "l", descriptor = "I")
    private int field78;

    @OriginalMember(owner = "client!BXXPAJNW", name = "r", descriptor = "I")
    private static int field84;

    @OriginalMember(owner = "client!BXXPAJNW", name = "y", descriptor = "I")
    private int field91;

    @OriginalMember(owner = "client!BXXPAJNW", name = "t", descriptor = "LCKBTFRZM;")
    private static class5 field86;

    @OriginalMember(owner = "client!BXXPAJNW", name = "s", descriptor = "Lclient;")
    public static client field85;

    @OriginalMember(owner = "client!BXXPAJNW", name = "E", descriptor = "Ljava/lang/String;")
    public String field97;

    @OriginalMember(owner = "client!BXXPAJNW", name = "m", descriptor = "[B")
    public byte[] field79;
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "p", descriptor = "[I")
    public int[] field82;

    @OriginalMember(owner = "client!BXXPAJNW", name = "z", descriptor = "[I")
    private int[] field92;

    @OriginalMember(owner = "client!BXXPAJNW", name = "A", descriptor = "[I")
    private int[] field93;

    @OriginalMember(owner = "client!BXXPAJNW", name = "B", descriptor = "[I")
    private int[] field94;

    @OriginalMember(owner = "client!BXXPAJNW", name = "C", descriptor = "[LBXXPAJNW;")
    private static class4[] field95;

    @OriginalMember(owner = "client!BXXPAJNW", name = "c", descriptor = "[Ljava/lang/String;")
    public String[] field69;

    @OriginalMember(owner = "client!BXXPAJNW", name = "a", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "a", descriptor = "(BII[I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "b", descriptor = "(I)LBXXPAJNW;")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "a", descriptor = "(LEAXVDNXA;)V")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "a", descriptor = "(BLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!BXXPAJNW", name = "d", descriptor = "(I)LBXXPAJNW;")
