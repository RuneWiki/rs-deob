...
public class class4 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(II)Lli;", line = 82)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 115)
    public class4(class559 arg0, int arg1, class597 arg2) {
        this.field38 = arg2;
        this.field38.method3462(1, -90);
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 133)
