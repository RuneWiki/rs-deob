...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIFIFFII)[F", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(I)V", line = 150)
    public class4(int arg0) {
        this.field62 = arg0;
    }

    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(IIIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)Lft;", line = 113)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lft;I)V", line = 128)
