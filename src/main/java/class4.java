...
public class class4 {
    ...
    @OriginalMember(owner = "client!BIGJGRMT", name = "b", descriptor = "[LBIGJGRMT;")
    public static class4[] field95;

    @OriginalMember(owner = "client!BIGJGRMT", name = "a", descriptor = "(ZLXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!BIGJGRMT", name = "a", descriptor = "(ZILGLMIQHJI;)V")
