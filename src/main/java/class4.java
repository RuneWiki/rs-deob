...
@OriginalClass("client!BKYZHYRW")
public class class4 extends class53 {

    @OriginalMember(owner = "client!BKYZHYRW", name = "A", descriptor = "I")
    private int field28 = -210;

    @OriginalMember(owner = "client!BKYZHYRW", name = "B", descriptor = "Z")
    private boolean field29 = true;

    @OriginalMember(owner = "client!BKYZHYRW", name = "C", descriptor = "Z")
    private boolean field30 = true;

    @OriginalMember(owner = "client!BKYZHYRW", name = "D", descriptor = "Z")
    private boolean field31 = true;

    @OriginalMember(owner = "client!BKYZHYRW", name = "K", descriptor = "I")
    public int field38;

    @OriginalMember(owner = "client!BKYZHYRW", name = "L", descriptor = "I")
    public int field39;

    @OriginalMember(owner = "client!BKYZHYRW", name = "F", descriptor = "[I")
    public int[] field33;

    @OriginalMember(owner = "client!BKYZHYRW", name = "I", descriptor = "I")
    public int field36;

    @OriginalMember(owner = "client!BKYZHYRW", name = "J", descriptor = "I")
    public int field37;

    @OriginalMember(owner = "client!BKYZHYRW", name = "G", descriptor = "I")
    public int field34;

    @OriginalMember(owner = "client!BKYZHYRW", name = "H", descriptor = "I")
    public int field35;

    @OriginalMember(owner = "client!BKYZHYRW", name = "E", descriptor = "[B")
    public byte[] field32;

    @OriginalMember(owner = "client!BKYZHYRW", name = "<init>", descriptor = "(LDYBMLHQM;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "a", descriptor = "(IZI)V")
    ...
    @OriginalMember(owner = "client!BKYZHYRW", name = "a", descriptor = "([IIIIIIII[I[B)V")
