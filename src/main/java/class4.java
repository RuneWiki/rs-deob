...
public class class4 extends class456 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILje;IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIBIIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(II)[I", line = 152)
    ...
    @OriginalMember(owner = "client!ck", name = "h", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "()V", line = 207)
    public class4() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILjava/lang/String;)V", line = 220)
