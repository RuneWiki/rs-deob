...
public class class4 extends class190 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BIB)V", line = 20)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(IIIIIFFF)V", line = 79)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(I)V", line = 133)
