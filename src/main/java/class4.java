...
public class class4 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I[I[Ljava/lang/String;Ljava/lang/String;[Lf;)I", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "([Lf;ILjava/lang/String;II)I", line = 251)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B[Lf;ILjava/lang/String;)I", line = 273)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I[Lf;Ljava/lang/String;I)I", line = 284)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(CII)I", line = 310)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IB)I", line = 327)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I[Lf;ILjava/lang/String;)Ljava/lang/String;", line = 341)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BLjava/lang/String;[Lf;)I", line = 466)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lqa;IILia;III[[[B[I[I[I[I[IIBIIZ)V", line = 584)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 741)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 757)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "([B)V", line = 768)
