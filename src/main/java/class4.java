...
public class class4 extends class476 {
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I[B)[B", line = 118)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)Z", line = 135)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZJLjava/lang/String;)V", line = 173)
