...
public class class4 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lig;[Lbd;)Lie;", line = 7)
    ...
    @OriginalMember(owner = "client!ie", name = "finalize", descriptor = "()V", line = 65)
    protected final void finalize() throws Throwable {
        this.field68.method881(this.field67);
        super.finalize();
    }

    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lig;I[Lbd;)V", line = 74)
