...
public class class4 extends class381 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B[I[J)V", line = 6)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(II[I[I)V", line = 25)
    public class4(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field105 = arg2;
        this.field107 = arg3;
    }

    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(II)I", line = 40)
    public static final int method33(int arg0, int arg1) {
        return class407.field6111 == null ? 0 : class407.field6111[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 46)
