...
public class class4 extends class280 implements class392 {
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!ft", name = "h", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(Lha;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!ft", name = "k", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILha;)Ldfa;", line = 70)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!ft", name = "m", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILhj;)V", line = 158)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lha;B)Lel;", line = 170)
    ...
    @OriginalMember(owner = "client!ft", name = "l", descriptor = "(I)I", line = 182)
    ...
    @OriginalMember(owner = "client!ft", name = "p", descriptor = "(I)[Lmm;", line = 198)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(I)Z", line = 210)
    public final boolean method30(int arg0) {
        ++field41;
        return arg0 <= 59 ? true : this.field36.method3065(-1);
    }

    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)I", line = 221)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BLha;)V", line = 232)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIILha;)Z", line = 260)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lha;I)V", line = 290)
