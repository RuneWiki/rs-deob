...
public class class4 extends class127 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!ie", name = "e", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!ie", name = "f", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!ie", name = "i", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 58)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ltq;Ltq;ILgp;)V", line = 84)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 104)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field37++;
        this.method25(arg0, (byte) 123);
    }

    @OriginalMember(owner = "client!ie", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 112)
    ...
    @OriginalMember(owner = "client!ie", name = "j", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 169)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method25(arg0, (byte) 123);
        field35++;
    }

    @OriginalMember(owner = "client!ie", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 178)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(I)Z", line = 207)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 219)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)V", line = 234)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II)Ljava/lang/String;", line = 254)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 265)
    ...
    @OriginalMember(owner = "client!ie", name = "h", descriptor = "(I)Lka;", line = 302)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 314)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method25(arg0, (byte) 123);
        field57++;
    }

    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 322)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIII)V", line = 333)
    ...
    @OriginalMember(owner = "client!ie", name = "k", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(Z)Z", line = 380)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 421)
    public class4(Component arg0, boolean arg1) {
        this.method20(arg0, 8827);
        this.field69 = arg1;
    }

    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)V", line = 402)
