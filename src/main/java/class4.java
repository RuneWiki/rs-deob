...
public class class4 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IBII)I", line = 30)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lso;B)V", line = 70)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(FIFF)F", line = 118)
    public static final float method29(float arg0, int arg1, float arg2, float arg3) {
        field26++;
        return arg1 <= 97 ? -1.3833F : (arg3 - arg2) * arg0 + arg2;
    }

    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "([I)V", line = 131)
