...
public class class4 {
    ...
    @OriginalMember(owner = "client!CZWVRQJW", name = "e", descriptor = "LIYPTVTAD;")
    private class30 field526 = new class30();

    @OriginalMember(owner = "client!CZWVRQJW", name = "i", descriptor = "LDTFBSXNF;")
    ...
    @OriginalMember(owner = "client!CZWVRQJW", name = "h", descriptor = "LRXQASTJV;")
    ...
    @OriginalMember(owner = "client!CZWVRQJW", name = "a", descriptor = "(J)LIYPTVTAD;")
    ...
    @OriginalMember(owner = "client!CZWVRQJW", name = "a", descriptor = "(LIYPTVTAD;ZJ)V")
