...
public class class4 extends class213 {
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lsv;)V", line = 24)
    public class4(class312 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILaw;)V", line = 28)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 54)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(B)Z", line = 77)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(ZI)V", line = 90)
    ...
    @OriginalMember(owner = "client!kc", name = "e", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(III)Z", line = 113)
    ...
    @OriginalMember(owner = "client!kc", name = "e", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(II)V", line = 140)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(III)V", line = 153)
