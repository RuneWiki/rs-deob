...
public class class4 extends class302 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lpea;)Lft;", line = 6)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
