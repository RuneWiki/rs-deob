...
public class class298 extends class193 {
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(ZZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 227)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILqn;Z)Lli;", line = 258)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIZ)V", line = 278)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lug;)V", line = 305)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)Ljava/lang/String;", line = 418)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lsq;II)V", line = 431)
