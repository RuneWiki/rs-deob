...
public class class298 {
    ...
    @OriginalMember(owner = "client!ci", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILts;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(II)Lvg;", line = 96)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 131)
