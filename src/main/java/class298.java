...
public class class298 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lnc;II)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILul;)I")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lhk;Lpk;Lvca;IIIII)V")
