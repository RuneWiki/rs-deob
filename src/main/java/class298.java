...
public abstract class class298 extends class206 {
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 8)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILtia;IIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IZ)V", line = 56)
