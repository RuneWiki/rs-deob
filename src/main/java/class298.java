...
public class class298 {
    ...
    @OriginalMember(owner = "client!c", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!c", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!c", name = "movemouse", descriptor = "(II)V")
