...
public class class298 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ZIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)Lsd;", line = 24)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILdg;I)V", line = 77)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)Z", line = 156)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)Ltr;", line = 180)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(ZIII)I", line = 236)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)Ltr;", line = 259)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ldg;B)V", line = 320)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(I)Z", line = 340)
