...
public class class298 implements class360 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "([Ljava/lang/String;III)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(JII[I)Ljava/lang/String;", line = 113)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)Z", line = 152)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(Z)V", line = 179)
