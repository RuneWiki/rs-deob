...
public class class298 extends class354 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lnj;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "()V", line = 116)
    public class298() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIII)I", line = 119)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(BI)[I", line = 145)
    ...
    @OriginalMember(owner = "client!wg", name = "g", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(B)V", line = 382)
