...
public class class298 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIII)V", line = 173)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(III)V", line = 263)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "()V", line = 285)
    private class298() {
    }

    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "([I)V", line = 287)
