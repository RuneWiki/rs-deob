...
public class class298 extends class349 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)J", line = 14)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZJ)I", line = 30)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "()V", line = 114)
    public class298() {
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(B)J", line = 69)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)V", line = 102)
