...
public class class298 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I[BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I[B)V", line = 16)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 223)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIB)I", line = 239)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IZIIIII)V", line = 272)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BIII)Z", line = 314)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "([BI[B)V", line = 333)
