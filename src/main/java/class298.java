...
public abstract class class298 extends class147 {
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IZ)[I", line = 17)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(III)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILhg;IILab;IBILoj;)V", line = 106)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILvt;)V", line = 212)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!aa", name = "d", descriptor = "(B)I", line = 247)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(IZ)V", line = 256)
    public class298(int arg0, boolean arg1) {
        this.field4449 = arg1;
        this.field4441 = new class298[arg0];
    }

    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(III)V", line = 285)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(III)[I", line = 308)
