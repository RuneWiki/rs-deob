...
public abstract class class298 implements class106 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(FFIILaa;II)V")
