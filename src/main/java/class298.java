...
public class class298 {
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lgk;)V")
    public class298(class463 arg0) {
        this.field3863 = arg0;
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIIILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lrg;FILrg;)Z")
