...
public class class298 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIIIIZIIF)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 89)
