...
public class class298 extends class574 implements class134 {
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lmr;Lsq;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lmr;Lsq;Lrt;II)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II[BIIIILsq;I)V")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lmr;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lmr;Lsq;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IILsq;I[FIIII)V")
