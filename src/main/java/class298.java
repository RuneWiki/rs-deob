...
public class class298 extends class277 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)[B", line = 6)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "([BB)V", line = 17)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)[B", line = 30)
