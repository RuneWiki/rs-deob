...
public class class298 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IIB)I", line = 12)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(JJ)J", line = 48)
    public static long method1860(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "([BZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "([BI[B)V", line = 273)
