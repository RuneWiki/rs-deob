...
public class class298 extends class284 {
    ...
    @OriginalMember(owner = "client!rp", name = "g", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)[B", line = 20)
    ...
    @OriginalMember(owner = "client!rp", name = "e", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BZ)Z", line = 54)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljava/lang/String;ZII)I", line = 94)
