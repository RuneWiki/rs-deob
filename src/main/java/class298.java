...
public class class298 extends class264 {
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZB)V", line = 34)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(III)I", line = 46)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(B)V", line = 66)
