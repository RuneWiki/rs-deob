...
public class class298 extends class204 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILuo;)Z")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lvq;I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(Luo;B)Lkj;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Luo;IIIZBLpc;)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Luo;IIZ)Z")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lwo;I)V")
