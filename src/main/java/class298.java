...
public abstract class class298 extends class424 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(CB)Z", line = 16)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZIZLhw;)V", line = 81)
