...
public class class298 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILqa;Lwi;)I", line = 56)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)Lfp;", line = 95)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 131)
