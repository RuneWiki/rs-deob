...
public abstract class class298 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)Z", line = 38)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(B)Z", line = 63)
