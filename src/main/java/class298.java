...
public class class298 extends class529 {
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "()V", line = 130)
    public class298() {
        super(3, false);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)[[I", line = 22)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IBLtn;)V", line = 79)
    ...
    @OriginalMember(owner = "client!cj", name = "e", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IB)[I", line = 133)
