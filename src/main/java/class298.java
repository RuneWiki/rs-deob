...
public class class298 extends class42 {
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Z)V", line = 21)
    public final void method288(boolean arg0) {
        this.field582.method926(260, 8448);
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lee;)V", line = 25)
    public final void method286(class404 arg0) {
    }

    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lig;Lfg;)V", line = 27)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "()Z", line = 141)
