...
public class class298 extends class197 {
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lkga;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lkga;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!saa", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IILn;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lkga;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lkga;IIIII)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lkga;IIII)V")
