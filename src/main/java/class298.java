...
public class class298 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([SI)[S", line = 11)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BI)I", line = 81)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)I", line = 100)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([BI)[B", line = 115)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(II)V", line = 184)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)V", line = 246)
