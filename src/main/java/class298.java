...
public class class298 extends class30 {
    ...
    @OriginalMember(owner = "client!jq", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "()V", line = 32)
    public class298() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ljr;)V", line = 49)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(IB)V", line = 100)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(BI)V", line = 144)
    ...
    @OriginalMember(owner = "client!jq", name = "e", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!jq", name = "g", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!jq", name = "f", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)V", line = 223)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IB)[I", line = 243)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "([II[I[ILsd;)V", line = 315)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ljg;II)V", line = 435)
