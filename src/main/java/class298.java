...
public class class298 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILsi;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIILem;Lya;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IILsi;)V")
