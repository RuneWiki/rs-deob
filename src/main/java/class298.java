...
public class class298 extends class179 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Ltq;Z)V", line = 41)
