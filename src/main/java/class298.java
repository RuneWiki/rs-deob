...
public class class298 extends class38 {
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "()V", line = 4)
    public class298() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BI)[I", line = 28)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IILrg;)V", line = 96)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)[Lnd;", line = 154)
