...
public class class298 extends class204 {
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lfs;)V", line = 19)
    public class298(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(ILfs;)V", line = 38)
    public class298(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(B)I", line = 68)
    public final int method1947(byte arg0) {
        ++field4331;
        return arg0 != -98 ? 57 : super.field2852;
    }

    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(I)Lhv;", line = 80)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Lpja;I)Ljava/lang/String;", line = 109)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(II)V", line = 136)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)I", line = 147)
