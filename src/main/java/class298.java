...
public class class298 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Ljava/lang/String;IB)Lhaa;")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IILmo;)V")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lmo;III)V")
