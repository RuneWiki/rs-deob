...
public class class298 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIZIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I[Lkb;)V", line = 80)
