...
public abstract class class298 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([BII[Lao;ZILtj;)V", line = 23)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(IIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIZI)V", line = 114)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!tj", name = "finalize", descriptor = "()V", line = 165)
    protected final void finalize() {
        field4495++;
        this.method2019(0);
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IBIII)V", line = 193)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!tj", name = "e", descriptor = "(I)V", line = 242)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 279)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BIIIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lir;I)V", line = 391)
    ...
    @OriginalMember(owner = "client!tj", name = "g", descriptor = "(IIIIII)V", line = 410)
