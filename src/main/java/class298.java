...
public class class298 extends class165 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(ILmia;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Ljava/lang/Object;III)[B", line = 36)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Lrv;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I[B)[B", line = 84)
