...
public abstract class class298 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)Lkw;")
    ...
    @OriginalMember(owner = "client!nba", name = "d", descriptor = "(I)D")
    ...
    @OriginalMember(owner = "client!nba", name = "e", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!nba", name = "f", descriptor = "(I)Lpv;")
    ...
    @OriginalMember(owner = "client!nba", name = "g", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nba", name = "h", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!nba", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nba", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(B)Luga;")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Z)Loca;")
