...
public class class298 extends class673 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IIIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IIIIB)V", line = 101)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IZZI)V", line = 121)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(III)Z", line = 153)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lwm;Lwm;Liv;)V", line = 176)
