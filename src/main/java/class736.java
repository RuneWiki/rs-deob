...
public class class736 extends class667 {
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BI)[I", line = 22)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "()V", line = 67)
    public class736() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IB)[I", line = 72)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(IB)Z", line = 89)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lud;II)V", line = 312)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(Z)V", line = 339)
