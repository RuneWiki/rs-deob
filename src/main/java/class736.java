...
public class class736 extends class42 implements class320 {
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lfha;Lbda;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II[IIZIII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZF)F")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BF)F")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIIILbda;II[F)V")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lfha;Lbda;Lwt;II)V")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lfha;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lfha;Lbda;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILbda;III[BZII)V")
