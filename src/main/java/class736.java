...
public class class736 extends class67 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lcba;Llq;[Liga;[I[I)V")
