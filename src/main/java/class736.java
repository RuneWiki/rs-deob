...
public class class736 implements class219 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I[Lpaa;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BII)V", line = 124)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IBI)V", line = 152)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BZI)V", line = 175)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III)V", line = 187)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IB)I", line = 216)
    public final int method1434(int arg0, byte arg1) {
        field10301++;
        return arg1 == 94 ? this.field10302[arg0] : -56;
    }

    @OriginalMember(owner = "client!le", name = "b", descriptor = "(III)V", line = 227)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BI)I", line = 254)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZ)I", line = 298)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(Z)V", line = 337)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(III)Z", line = 368)
