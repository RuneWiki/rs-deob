...
public class class736 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Z)Z", line = 9)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Z)V", line = 33)
    public class736(boolean arg0) {
        this.field10172 = arg0;
    }

    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(B)V", line = 50)
