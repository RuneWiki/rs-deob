...
public abstract class class736 extends class547 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z[Ljw;)I")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([Ljava/lang/String;[SI)V")
    public static final void method4124(String[] arg0, short[] arg1, int arg2) {
        class228.method1574(arg0.length + -1, arg0, arg2, arg1, 8);
        ++field10285;
    }

    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(ILha;)Z")
