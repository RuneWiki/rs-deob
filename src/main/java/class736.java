...
public class class736 extends class532 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZILgaa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lus;Lbt;Lrfa;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(B)Z", line = 105)
    public final boolean method703(byte arg0) {
        return arg0 <= 126 ? true : this.field10277;
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IBI)V", line = 115)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZI)V", line = 142)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZB)V", line = 213)
