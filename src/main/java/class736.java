...
public class class736 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lgv;I[I[I[I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZILji;)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIIILic;)V")
