...
public class class736 extends class461 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(FB)V", line = 5)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(I)V", line = 21)
    public class736(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fm", name = "u", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IF)V", line = 34)
