...
public class class736 implements class418 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IZ[S)[S", line = 4)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)Lcca;", line = 62)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Luu;Ljava/lang/String;)V", line = 72)
