...
public class class736 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lha;IIIZLka;Lwc;IZ)V")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILha;)V")
    public final void method4125(int arg0, class454 arg1) {
        field10314++;
        this.method4126(true, arg1, arg0, true, (byte) -121);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZLha;IZB)Lka;")
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lab;ILab;)V")
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lha;Lqg;IIIILmb;ZI)V")
