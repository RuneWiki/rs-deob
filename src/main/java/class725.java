...
public class class725 extends class224 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IBI)Z", line = 9)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 212)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(B[III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IIZ)Z", line = 67)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(II[II)Z", line = 101)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(III[II)Z", line = 138)
    ...
    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(B)V", line = 168)
