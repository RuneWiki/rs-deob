...
public class class725 extends class400 implements class2 {
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Loa;Lya;Lqt;[Lffa;[Ltd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(CIIIZLaa;II)V", line = 38)
