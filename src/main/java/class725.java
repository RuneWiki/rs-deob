...
public class class725 extends class63 implements class560 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkc;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsn;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lel;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkaa;[Luh;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsia;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsn;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Lsj;")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Ltq;")
    public final class657 method223(int arg0, int arg1) {
        return new class529(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Llia;")
    public final class505 method235(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Llia;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Lsj;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lel;Ltq;)Lsia;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lhk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lhk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Llia;Llia;FLlia;)Llia;")
    public final class505 method249(class505 arg0, class505 arg1, float arg2, class505 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lhk;")
    ...
    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Lwaa;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lih;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Luh;Z)Lhk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsj;)V")
    public final void method254(class486 arg0) {
        this.field10636 = arg0;
        this.method5257(((class291) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lih;")
