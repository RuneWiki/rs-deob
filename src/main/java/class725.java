...
public class class725 extends class766 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "()V", line = 19)
    public class725() {
    }

    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(I)V", line = 21)
