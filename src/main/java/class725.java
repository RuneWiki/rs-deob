...
public class class725 extends class751 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/util/Random;[[IIIII)V", line = 272)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)V", line = 470)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "()V", line = 646)
    public class725() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIZI)V", line = 494)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILrv;I)V", line = 526)
    ...
    @OriginalMember(owner = "client!dq", name = "g", descriptor = "(I)V", line = 627)
