...
public class class725 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(II)Lao;", line = 20)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 117)
