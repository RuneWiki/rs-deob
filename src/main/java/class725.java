...
public class class725 extends class221 {
    ...
    @OriginalMember(owner = "client!pea", name = "d", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IZII)Lni;", line = 43)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lac;II[BI)V", line = 62)
