...
public class class725 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(II)Lvp;")
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IIFIIIF[BILkc;FIFF)V")
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Ljka;I)I")
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Lfs;ILlga;)V")
