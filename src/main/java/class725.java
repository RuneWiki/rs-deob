...
public class class725 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;I)V")
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
