...
public class class725 implements Runnable {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLm;)V", line = 6)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!hb", name = "run", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 239)
    public class725() {
        this.field10115.setDaemon(true);
        this.field10115.start();
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lbe;I)Ljava/lang/String;", line = 146)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljava/lang/String;B)Lla;", line = 191)
