...
public class class725 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILvfa;B)I", line = 3)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZBIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)I", line = 46)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lkn;II)V", line = 64)
