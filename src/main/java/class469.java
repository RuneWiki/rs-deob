...
public class class469 implements class374 {
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BIII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Object;", line = 108)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;Ljava/lang/Object;)I", line = 126)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 142)
    public final void method2151(byte arg0) {
        int var2 = 34 % ((arg0 + 33) / 38);
        field6482++;
    }

    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(IZ)I", line = 184)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IBILhd;)V", line = 203)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZI)I", line = 217)
    ...
    @OriginalMember(owner = "client!ek", name = "d", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)I", line = 244)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZJ)Z", line = 258)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IC)I", line = 269)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IZ)V", line = 292)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Z)I", line = 482)
