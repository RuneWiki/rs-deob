...
public class class469 extends class251 implements class241 {
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lh;Lba;II[[I[[IIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIIII[[Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lve;[I)V", line = 143)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)V", line = 147)
    public final void method1174(int arg0, int arg1) {
        this.field6871.method2183().method1548(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III[[ZZ)V", line = 157)
