...
public class class469 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lek;)V", line = 13)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(II)[I", line = 151)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(III)I", line = 443)
