...
public class class469 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II[II[Ljava/lang/Object;)V", line = 5)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)V", line = 258)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)I", line = 300)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIZIZ)V", line = 315)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "()V", line = 529)
    public class469() {
    }

    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lvj;)V", line = 531)
