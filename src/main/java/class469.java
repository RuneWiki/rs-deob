...
public class class469 implements class526 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Lhp;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)Lvca;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZILqi;)V")
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lpl;Lpl;Lpl;)V")
