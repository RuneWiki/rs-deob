...
public class class469 implements Runnable {
    ...
    @OriginalMember(owner = "client!mt", name = "run", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BI)Lhka;", line = 107)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)I", line = 122)
