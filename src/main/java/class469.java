...
public class class469 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(J[BB)V", line = 59)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IZ)Lqq;", line = 144)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(I)V", line = 339)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ldj;I)I", line = 385)
