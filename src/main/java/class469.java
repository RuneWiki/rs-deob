...
public class class469 implements Runnable {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(B)Lgq;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(B[Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/net/URL;)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/lang/Object;III)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(Ljava/lang/String;I)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IILjava/lang/Object;ZI)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "d", descriptor = "(Ljava/lang/String;I)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "([IILjava/awt/Point;Ljava/awt/Component;II)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ljava/lang/Class;I)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIBI)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(Ljava/lang/Class;I)Lhh;")
    public final class125 method2811(Class arg0, int arg1) {
        return arg1 == 0 ? this.method2803(arg1 ^ 0x2710, arg0, 0, 0, 20) : null;
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ZLjava/awt/Frame;)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ljava/lang/String;B)Lhh;")
    public final class125 method2813(String arg0, byte arg1) {
        int var3 = -111 / ((arg1 + 32) / 60);
        return this.method2803(10000, arg0, 0, 0, 12);
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/lang/String;I)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/awt/Component;II)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)Lhh;")
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(I)Lhh;")
