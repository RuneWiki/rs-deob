...
public class class469 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(BI)Lbd;")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lae;IB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(IB)Lqp;")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lci;ILhe;)V")
