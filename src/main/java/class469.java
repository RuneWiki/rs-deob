...
public class class469 extends class162 implements class276 {
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(IIIIII)Lto;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lre;[Lfq;Z)Loa;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lto;Lto;FLto;)Lto;")
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Ljs;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lc;Lpm;Lia;Lfo;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lwp;IIII)Lc;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lto;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lfq;Z)Lf;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Lor;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lpm;Z)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lpm;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Lfo;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Lor;")
