...
public class class469 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)Lhq;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lrl;I)I")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lal;ILnd;)V")
