...
public class class469 extends class135 {
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Loh;Loh;Lgo;)V", line = 9)
    public class469(class404 arg0, class404 arg1, class626 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!maa", name = "f", descriptor = "(I)Ldba;", line = 15)
    public static final class92 method2835(int arg0) {
        ++field6704;
        return arg0 <= 110 ? null : class656.field9357;
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IIIBI)V", line = 27)
    ...
    @OriginalMember(owner = "client!maa", name = "g", descriptor = "(I)V", line = 45)
