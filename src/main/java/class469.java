...
public class class469 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lr;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IILr;I)V", line = 217)
    ...
    @OriginalMember(owner = "client!ps", name = "toString", descriptor = "()Ljava/lang/String;", line = 703)
    public final String toString() {
        field6704++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)V", line = 712)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 728)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(II)V", line = 757)
