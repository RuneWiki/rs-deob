...
public class class469 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IBI)V", line = 22)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BZIILqa;IZ)Lr;", line = 124)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IZLqa;IBLr;II)V", line = 250)
    ...
    @OriginalMember(owner = "client!el", name = "finalize", descriptor = "()V", line = 300)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 310)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)Z", line = 325)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lqa;Luh;IIIIIIZI)V", line = 539)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II)V", line = 343)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(II)V", line = 360)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lqa;I)V", line = 372)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(II)V", line = 409)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(Lqa;I)V", line = 526)
