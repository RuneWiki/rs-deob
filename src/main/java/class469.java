...
public class class469 extends class236 implements class463 {
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIB[B)V", line = 14)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lkd;I[BI)V", line = 25)
    public class469(class188 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6771 = arg1;
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)J", line = 117)
