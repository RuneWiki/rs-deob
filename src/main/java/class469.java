...
public class class469 extends class353 {
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!gba", name = "f", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILqda;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(B)Z", line = 87)
    public final boolean method493(byte arg0) {
        return arg0 >= -20 ? true : this.field6747;
    }

    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lik;Lmv;Lgb;)V", line = 97)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!gba", name = "e", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Z)V", line = 218)
