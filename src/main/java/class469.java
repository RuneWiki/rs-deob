...
public class class469 extends class285 implements class194 {
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lrr;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(IIII)V", line = 31)
    public final void method707(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Le;IIIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!xa", name = "b", descriptor = "()V", line = 38)
    public final void method687() {
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "()[Lmf;", line = 42)
    public final class51[] method715() {
        return this.field6771;
    }

    @OriginalMember(owner = "client!xa", name = "d", descriptor = "()Z", line = 50)
    public final boolean method696() {
        return true;
    }

    @OriginalMember(owner = "client!xa", name = "c", descriptor = "()[Lqe;", line = 59)
    public final class502[] method709() {
        return this.field6774;
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(BIZ)Le;", line = 67)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(IILc;Z)Z", line = 70)
    ...
    @OriginalMember(owner = "client!xa", name = "finalize", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lrr;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;Lg;Lqq;IIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;)V", line = 168)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(ILc;)V", line = 177)
