...
public class class469 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)Lwca;", line = 27)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Lim;ILgj;Lgj;)V", line = 110)
