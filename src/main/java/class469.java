...
public class class469 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)Lad;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BI)Lku;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IILjea;III)Lmd;")
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Ler;ILjn;)V")
