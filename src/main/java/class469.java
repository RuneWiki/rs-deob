...
public class class469 extends class206 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qv", name = "h", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!qv", name = "g", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IC)Z", line = 66)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)I", line = 92)
