...
public class class469 extends class152 implements class620 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IBLpe;I)Ldga;")
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(Loa;I)Lcd;")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(IIILpga;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(BLoi;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILoa;ILcq;ZI)V")
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Loa;II)Lba;")
