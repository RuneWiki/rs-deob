...
public class class469 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(BI)Lsi;", line = 52)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(IIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(BLui;)I", line = 140)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Ljc;ILgp;)V", line = 224)
    public class469(class584 arg0, int arg1, class561 arg2) {
        this.field6750 = arg2;
        this.field6750.method3164(31, true);
    }

    @OriginalMember(owner = "client!iaa", name = "c", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ILqa;)V", line = 258)
