...
public class class469 extends class162 implements class276 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lsh;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lsh;Lia;[Llc;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lbi;Lbi;FLbi;)Lbi;")
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Lli;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Leu;[Lwe;Z)Loa;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lwe;Z)Lf;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Llc;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "v", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(IIIIII)Lbi;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Lfk;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lbi;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lsh;Z)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Lfk;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lnd;IIII)Lc;")
