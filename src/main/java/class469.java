...
public class class469 extends class224 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Lrea;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Z)Z", line = 48)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(BII)V", line = 105)
    ...
    @OriginalMember(owner = "client!taa", name = "d", descriptor = "(Z)I", line = 182)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Lfba;ILfba;I)V", line = 218)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Ldw;)V", line = 369)
    public class469(class664 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Luu;ZLrp;)V", line = 372)
    ...
    @OriginalMember(owner = "client!taa", name = "f", descriptor = "(I)Z", line = 423)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "([Luv;BI)V", line = 435)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(B)Z", line = 504)
