...
public class class469 extends class162 implements class276 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)I", line = 5)
    public final int method1051(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIZ)Lf;", line = 13)
    ...
    @OriginalMember(owner = "client!h", name = "r", descriptor = "()Z", line = 28)
    public final boolean method1096() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lc;Lpo;Lia;Lvk;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(Z)V", line = 51)
    public final void method1110(boolean arg0) {
    }

    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Lji;)V", line = 737)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "()V", line = 61)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(II)I", line = 77)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(IIIIII)Ltl;", line = 84)
    public final class436 method1065(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ll;)V", line = 88)
    public final void method1117(class16 arg0) {
        this.field6904 = (class262) arg0;
        this.method2805(arg0);
    }

    @OriginalMember(owner = "client!h", name = "h", descriptor = "()V", line = 91)
    public final void method1041() {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Lkt;", line = 94)
    ...
    @OriginalMember(owner = "client!h", name = "v", descriptor = "()Z", line = 97)
    public final boolean method1109() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "f", descriptor = "()Z", line = 107)
    public final boolean method1037() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 112)
    ...
    @OriginalMember(owner = "client!h", name = "B", descriptor = "()Z", line = 132)
    public final boolean method1125() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lpo;Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!h", name = "E", descriptor = "()Lma;", line = 171)
    ...
    @OriginalMember(owner = "client!h", name = "u", descriptor = "()Z", line = 184)
    public final boolean method1107() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "g", descriptor = "(I)V", line = 187)
    public final void method1123(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 193)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(I)V", line = 258)
    public final void method1100(int arg0) {
        this.field6925[arg0].method57();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lgu;Z)Lf;", line = 262)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Lkt;)V", line = 338)
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "()V", line = 356)
    public final void method1032() {
    }

    @OriginalMember(owner = "client!h", name = "l", descriptor = "()Z", line = 361)
    public final boolean method1075() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II[I[I)Lea;", line = 365)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Lvk;I)V", line = 369)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Z)V", line = 388)
    public final void method1070(boolean arg0) {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIIIIII)V", line = 396)
    public final void method1101(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!h", name = "ZA", descriptor = "()V", line = 400)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ltl;)V", line = 407)
    public final void method1083(class436 arg0) {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lje;[Lgu;Z)Loa;", line = 413)
    ...
    @OriginalMember(owner = "client!h", name = "y", descriptor = "()Z", line = 421)
    public final boolean method1119() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lqc;IIII)Lc;", line = 427)
    ...
    @OriginalMember(owner = "client!h", name = "x", descriptor = "()Lia;", line = 433)
    public final class414 method1115() {
        return this.field6916;
    }

    @OriginalMember(owner = "client!h", name = "q", descriptor = "()V", line = 438)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ltl;Ltl;FLtl;)Ltl;", line = 455)
    public final class436 method1086(class436 arg0, class436 arg1, float arg2, class436 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "MA", descriptor = "(S)Z", line = 458)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([IIIII)Lf;", line = 483)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(FFF)V", line = 518)
    public final void method1040(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Z)V", line = 522)
    public final void method1053(boolean arg0) {
    }

    @OriginalMember(owner = "client!h", name = "j", descriptor = "()I", line = 525)
    public final int method1056() {
        return 4;
    }

    @OriginalMember(owner = "client!h", name = "o", descriptor = "()V", line = 527)
    public final void method1089() {
    }

    @OriginalMember(owner = "client!h", name = "A", descriptor = "()Ljava/lang/Object;", line = 530)
    private final Object method2810() {
        return new class328();
    }

    @OriginalMember(owner = "client!h", name = "i", descriptor = "()V", line = 534)
    public final void method1054() {
    }

    @OriginalMember(owner = "client!h", name = "t", descriptor = "()Z", line = 540)
    public final boolean method1106() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 543)
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(IIIIII)V", line = 555)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 561)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIII)V", line = 580)
    ...
    @OriginalMember(owner = "client!h", name = "p", descriptor = "()Z", line = 584)
    public final boolean method1091() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "b", descriptor = "()V", line = 593)
    public final void method1024() {
    }

    @OriginalMember(owner = "client!h", name = "finalize", descriptor = "()V", line = 600)
    protected final void finalize() {
        this.method60();
    }

    @OriginalMember(owner = "client!h", name = "z", descriptor = "()Z", line = 605)
    public final boolean method1121() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIII)V", line = 614)
    public final void method1033(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lpo;)V", line = 617)
    ...
    @OriginalMember(owner = "client!h", name = "m", descriptor = "()Z", line = 621)
    public final boolean method1079() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I)Ll;", line = 625)
    ...
    @OriginalMember(owner = "client!h", name = "k", descriptor = "()Z", line = 632)
    public final boolean method1073() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "c", descriptor = "(I)V", line = 639)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lpo;Lia;[Lvk;I)V", line = 652)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 699)
    ...
    @OriginalMember(owner = "client!h", name = "C", descriptor = "()Lia;", line = 711)
    public final class414 method1126() {
        return new class136();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II[[I[[IIII)Lna;", line = 715)
    ...
    @OriginalMember(owner = "client!h", name = "n", descriptor = "()Z", line = 723)
    public final boolean method1088() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "EA", descriptor = "(S)Z", line = 726)
    ...
    @OriginalMember(owner = "client!h", name = "s", descriptor = "()Z", line = 781)
    public final boolean method1097() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "e", descriptor = "(IIIIII)V", line = 788)
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "(I)V", line = 794)
    public final void method1103(int arg0) {
        this.field6925[arg0].method66();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIILea;II)V", line = 797)
