...
public class class469 extends class528 {
    ...
    @OriginalMember(owner = "client!h", name = "f", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IB)V", line = 31)
    ...
    @OriginalMember(owner = "client!h", name = "h", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!h", name = "i", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Lem;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "(I)I", line = 155)
    public final int method2747(int arg0) {
        field6862++;
        return arg0 == 5 ? this.field6854 : -83;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(III)I", line = 167)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIBII)V", line = 196)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIZZ)V", line = 220)
    ...
    @OriginalMember(owner = "client!h", name = "g", descriptor = "(I)J", line = 283)
