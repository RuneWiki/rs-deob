...
public abstract class class469 extends class544 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "(B)F", line = 64)
    ...
    @OriginalMember(owner = "client!cba", name = "d", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!cba", name = "e", descriptor = "(B)I", line = 95)
    ...
    @OriginalMember(owner = "client!cba", name = "f", descriptor = "(B)I", line = 107)
    public final int method2737(byte arg0) {
        field6550++;
        return arg0 == -86 ? this.field6554 : -2;
    }

    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(IIIIIF)V", line = 117)
