...
public class class469 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IZ)Lkm;")
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BILmga;)V")
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lsaa;IZLfp;Lfp;)V")
