...
public class class469 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lno;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lno;Ljaclib/memory/Buffer;)V", line = 21)
