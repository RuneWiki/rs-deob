...
public abstract class class469 implements class377 {
    ...
    @OriginalMember(owner = "client!ica", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lml;IIIZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!ica", name = "finalize", descriptor = "()V", line = 92)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(IZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(I)V", line = 142)
