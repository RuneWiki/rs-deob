...
public abstract class class469 extends class487 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(Z)[Lrj;", line = 44)
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(BII)Z", line = 77)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(IIIIIII)V", line = 99)
