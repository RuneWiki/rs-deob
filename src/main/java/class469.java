...
public class class469 extends class79 implements Runnable {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([BZ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lgj;)V", line = 281)
    public class469(class70 arg0) {
        this.field6877 = arg0;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIIZ)Lvj;", line = 94)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([BIIIIIB)V", line = 130)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(Z)V", line = 228)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!vs", name = "run", descriptor = "()V", line = 255)
