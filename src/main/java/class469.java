...
public class class469 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)Lev;", line = 5)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)Lev;", line = 51)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lqi;)V", line = 74)
