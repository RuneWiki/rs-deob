...
public class class469 {
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "()V", line = 79)
    public class469() {
        this.field6955 = -50;
        this.field6959 = -50;
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lnn;)V", line = 95)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILnn;)V", line = 18)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)I", line = 40)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lpb;I)Z", line = 67)
