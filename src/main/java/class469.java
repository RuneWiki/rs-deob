...
public class class469 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IILha;)Z")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(CI)C")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIIIIILha;III)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(I[Lls;IIII)V")
