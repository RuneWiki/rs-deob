...
public class class469 extends Callback {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IZLjava/awt/Component;)V", line = 6)
    ...
    @OriginalMember(owner = "client!hca", name = "callback", descriptor = "(IIII)I", line = 48)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(III)V", line = 90)
