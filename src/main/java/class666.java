...
public class class666 extends class749 implements class9 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Loea;I[BIZ)V", line = 17)
    public class666(class594 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field9339 = arg1;
    }

    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)J", line = 40)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III[B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 72)
    public static void method3739(int arg0) {
        int var1 = -50 / ((43 - arg0) / 35);
        field9341 = null;
    }

    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Z)I", line = 98)
