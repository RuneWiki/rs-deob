...
public class class666 extends class748 {
    ...
    @OriginalMember(owner = "client!dt", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dt", name = "g", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IZLvj;)V", line = 53)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "()V", line = 100)
    public class666() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(II)[[I", line = 130)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(II)[I", line = 177)
