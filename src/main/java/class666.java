...
public class class666 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(B)Leh;")
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(B)Leh;")
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Leq;)V")
