...
public class class666 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lgca;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IILjava/lang/String;)V", line = 27)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)Lrp;", line = 125)
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(I)Lrp;", line = 148)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "()V", line = 170)
    public class666() {
    }

    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Lgca;)V", line = 173)
