...
public class class666 extends class86 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lsf;)V", line = 27)
    public class666(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(ILsf;)V", line = 63)
    public class666(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(II)I", line = 71)
