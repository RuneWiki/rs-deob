...
public class class666 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ZLwt;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(I)Lpca;")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ZBLvq;)V")
    ...
    @OriginalMember(owner = "client!jga", name = "d", descriptor = "(I)Lpca;")
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Lkea;)V")
