...
public class class666 extends class379 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IB)V", line = 13)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BIIIF)V", line = 33)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IB[I)V", line = 155)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(II)V", line = 289)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(II)V", line = 302)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIII)V", line = 314)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IBI)V", line = 326)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)[Lbja;", line = 345)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Lcea;IIIII)V", line = 366)
