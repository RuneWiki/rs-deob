...
public class class666 extends class385 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lha;Lcn;IIBZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!wda", name = "m", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!wda", name = "n", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!wda", name = "h", descriptor = "(B)Z", line = 158)
    private final boolean method3763(byte arg0) {
        ++field9244;
        return arg0 >= -74 ? true : this.field9253.field8073;
    }

    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILac;)V", line = 169)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Ld;ILjava/awt/Canvas;I)Lha;", line = 189)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(BLha;)Lhga;", line = 201)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(Lha;B)Ldg;", line = 333)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)I", line = 344)
    ...
    @OriginalMember(owner = "client!wda", name = "i", descriptor = "(I)Z", line = 365)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(IIIIIZ)V", line = 378)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Z)I", line = 463)
    ...
    @OriginalMember(owner = "client!wda", name = "k", descriptor = "(I)I", line = 483)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lha;III)Z", line = 509)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLha;I)Z", line = 574)
    ...
    @OriginalMember(owner = "client!wda", name = "d", descriptor = "(I)V", line = 636)
    ...
    @OriginalMember(owner = "client!wda", name = "c", descriptor = "(III)V", line = 647)
    ...
    @OriginalMember(owner = "client!wda", name = "d", descriptor = "(B)I", line = 662)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLha;)V", line = 680)
