...
public class class666 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(CI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BZ)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 68)
