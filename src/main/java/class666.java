...
public class class666 extends class349 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!fg", name = "f", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BII[B)[B", line = 78)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(BI)[I", line = 113)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IILdga;)V", line = 174)
