...
public class class666 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Luh;JB[I)Ljava/lang/String;", line = 21)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IB)Lvda;", line = 43)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIZI)V", line = 138)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(ILwia;Lwia;Lwc;)V", line = 225)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 169)
