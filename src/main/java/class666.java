...
public abstract class class666 extends class270 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Loa;ZII)Lta;", line = 3)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)[[I", line = 22)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)[I", line = 43)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIII)Z", line = 70)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(III)[[I", line = 85)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(III)[I", line = 144)
    ...
    @OriginalMember(owner = "client!cc", name = "d", descriptor = "(III)V", line = 165)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILiaa;Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!cc", name = "d", descriptor = "(I)I", line = 230)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(IZ)V", line = 244)
