...
public class class666 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(BC)B", line = 11)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIB)I", line = 142)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!tda", name = "toString", descriptor = "()Ljava/lang/String;", line = 177)
