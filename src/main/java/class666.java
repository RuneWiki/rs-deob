...
public class class666 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IZLjp;)V", line = 9)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(BLjp;)V", line = 42)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILjava/lang/String;Ljava/io/File;)V", line = 78)
