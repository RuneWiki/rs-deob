...
public class class666 extends class331 {
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(ILts;)V", line = 28)
    public class666(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(II)I", line = 33)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(II)Z", line = 122)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lts;)V", line = 180)
    public class666(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(Z)V", line = 183)
