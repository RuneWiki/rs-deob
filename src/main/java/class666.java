...
public class class666 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lji;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIIIIII)Lip;", line = 45)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILjaa;III)Lhq;", line = 93)
