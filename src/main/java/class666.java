...
public class class666 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([III[ILnh;I)Ljg;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IILis;)I")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([Lvj;II)V")
