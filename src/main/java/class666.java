...
public class class666 extends class134 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "(II)I", line = 47)
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lkda;)V", line = 61)
    public class666(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(ILkda;)V", line = 76)
    public class666(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(II)V", line = 81)
