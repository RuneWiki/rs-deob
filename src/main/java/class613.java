...
public class class613 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "([I[Ljava/lang/Object;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILwu;)V", line = 32)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(I)V", line = 48)
