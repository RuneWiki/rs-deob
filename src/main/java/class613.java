...
public class class613 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(II)Lbs;", line = 14)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BILri;I)Lufa;", line = 43)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IIII)Z", line = 59)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lei;ILri;)V", line = 138)
