...
public class class613 extends class602 {
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IBI)V", line = 15)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(III)Lld;", line = 36)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(III)V", line = 52)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZII)V", line = 71)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 99)
