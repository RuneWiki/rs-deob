...
public class class613 extends class464 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IJLoa;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(B)Lul;")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lej;IIIIII)V")
