...
public class class613 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Les;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(B)Z", line = 73)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILes;)V", line = 87)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(B)V", line = 134)
