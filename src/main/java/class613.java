...
public class class613 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I)Lal;", line = 16)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BLal;)V", line = 37)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(IIIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIIIIIB)V", line = 61)
