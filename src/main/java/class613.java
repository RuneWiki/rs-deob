...
public abstract class class613 extends class421 {
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I[Lqm;)I")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lje;Z[[[BIB)Z")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ZLtd;ILjava/lang/String;Z)V")
