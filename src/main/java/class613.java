...
public class class613 extends class548 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lru;II)V")
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Llf;Ltf;)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lha;ILd;)V")
