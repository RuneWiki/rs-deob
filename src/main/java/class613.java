...
public class class613 extends class601 {
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Lgn;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lrr;III)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(ILgn;)V")
