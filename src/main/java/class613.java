...
public class class613 implements Runnable {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/awt/Frame;Z)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/lang/String;ZIZ)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIBII)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/String;Ljava/lang/Class;)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BLjava/net/URL;)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Lel;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILjava/lang/Object;IBI)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/awt/Point;[IIILjava/awt/Component;I)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BLjava/lang/String;)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(I)Lfg;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILjava/lang/String;)Lel;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BLjava/lang/String;Z)Lfg;")
