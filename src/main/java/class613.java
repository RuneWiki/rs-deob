...
public class class613 extends class505 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)V", line = 271)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(Z)Lmg;", line = 281)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(JJ)J", line = 305)
