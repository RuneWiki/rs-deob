...
public class class613 extends class182 {
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lag;Lica;)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ILvfa;B)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "([Lir;II)V")
