...
public class class613 extends class642 {
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(II)[I", line = 61)
    ...
    @OriginalMember(owner = "client!vp", name = "f", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!vp", name = "g", descriptor = "(I)V", line = 98)
