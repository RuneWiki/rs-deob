...
public class class613 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IBI)Z")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IB)Ljg;")
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lcda;ILkea;Lkea;)V")
