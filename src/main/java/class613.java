...
public class class613 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "([[BLdga;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BLjp;)Lgn;", line = 147)
