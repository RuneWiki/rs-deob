...
public class class613 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Lg;", line = 10)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)Z", line = 26)
    public final boolean method3570(int arg0) {
        field8758++;
        return arg0 <= 108 ? false : class19.field179 == this | class38.field426 == this;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!wg", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
