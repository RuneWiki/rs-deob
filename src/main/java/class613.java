...
public abstract class class613 extends class383 {
    ...
    @OriginalMember(owner = "client!et", name = "k", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!et", name = "l", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!et", name = "f", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I[Leq;)I", line = 91)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 267)
