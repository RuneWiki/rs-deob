...
public class class613 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(II)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILgl;[[B)V", line = 41)
