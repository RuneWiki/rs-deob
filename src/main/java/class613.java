...
public class class613 implements class141 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()V", line = 3)
    public final void method3379() {
        this.field8497 = Thread.currentThread();
        this.method3391();
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 10)
    public final void method3383() {
        this.field8497 = null;
        this.method3387();
    }

    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lda;II)V", line = 90)
